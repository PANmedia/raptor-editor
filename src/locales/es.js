...
registerLocale('es', 'Español', {
    ...
    linkTypeExternalInfo:
        '<h2>¿No está seguro de qué poner en la caja anterior?</h2>' +
        '<ol>' +
        '    <li>Busque la página web a la que desee enlazar</li>' +
        '    <li>Copie la dirección web desde la barra de dirección de su navegador y péguela en la caja superior.</li>' +
        '</ol>',
