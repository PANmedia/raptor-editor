...
registerLocale('de', 'Deutsch', {
    ...
    linkTypeExternalInfo:
        '<h2>Nicht sicher was in die Box oberhalb gehört?</h2>' +
        '<ol>' +
        '    <li>Finden Sie die Seite im Web welche Sie verlinken wollen.</li>' +
        '    <li>Kopieren Sie die URL von der Adressleiste ihres Browser und fügen Sie diese in der Box oberhalb ein.</li>' +
        '</ol>',
