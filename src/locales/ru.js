...
registerLocale('ru', 'Russian', {
    ...
    linkTypeExternalInfo:
        '<h2>Не знаете что ввести в это поле?</h2>' +
        '<ol>' +
        '    <li>Найдите страницу, на которую вы хотите сделать ссылку</li>' +
        '    <li>Скопируйте адрес из строки браузера и вставьте в поле выше</li>' +
        '</ol>',
    ...
    linkTypeDocumentInfo:
        '<h2>Не знаете что ввести в это поле?</h2>' +
        '<ol>' +
        '    <li>Удостоверьтесь, что файл был загружен на ваш сайт.</li>' +
        '    <li>Откройте файл в браузере.</li>' +
        '    <li>Скопируйте адрес из строки браузера в поле выше.</li>' +
        '</ol>',
    ...
    linkTypeInternalInfo:
        '<h2>Не знаете что ввести в это поле?</h2>' +
        '<ol>' +
        '    <li>Выберите страницу на сайте, на которую хотите сделать ссылку.</li>' +
        '    <li>Скопируйте адрес из строки браузера, исключив "{{domain}}" и вставьте его в поле выше.</li>' +
        '</ol>',
