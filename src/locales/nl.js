...
extendLocale('nl', 'Nederlands', {
    ...
    linkTypeExternalInfo:
        '<h2>Onzeker over wat er in het veld moet staan hierboven?</h2>' +
        '<ol>' +
        '    <li>Vind de pagina op het internet waar u naartoe wilt linken.</li>' +
        '    <li>Kopieër het internetadres uit de adresbalk van uw browser en plak het in het veld hierboven.</li>' +
        '</ol>',
