...
registerLocale('de', 'Deutsch', {
  ...
  "Clear Formatting": "Formattierung löschen",
  ...
  "Click to select all editable content": "Klicken um alle bearbeitbaren Elemente zu selektieren",
  "Click to select the contents of the '{{element}}' element": "Klicken um den Inhalt des '{{element}}' Element zu selektieren",
  "Close": "Schliessen",
  ...
  "Formatted &amp; Cleaned": "Formattiert &amp; Bereinigt",
  ...
  "Remove unnecessary markup from editor content": "Unnötige Markierungen im Inhalt entfernen",
  ...
  "\nThere are unsaved changes on this page. \nIf you navigate away from this page you will lose your unsaved changes": "\nEs gibt ungespeicherte Änderungen auf dieser Seite. \nWenn Sie von dieser Seite wegnavigieren, werden Sie die ungespeicherten Änderungen verlieren",
  "root": '',
