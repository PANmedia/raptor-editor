...
registerLocale('es', 'Español', {
    ...
    "Are you sure you want to stop editing?": "¿Está seguro de que quiere parar de editar?",
    ...
    "Copy the file's URL from your browser's address bar and paste it into the box above": "Copie la URL de tu archivo desde la barra de dirección de tu navegador y pégala en la caja superior.",
    "Copy the web address from your browser's address bar and paste it into the box above": "Copie la dirección web desde la barra de dirección de tu navegador y pégala en la caja superior.",
    "Decrease Font Size": "Disminuir Tamaño de Fuente",
    "Destroy": "DestruiUncleanr",
    "Divider": "Dividir",
    ...
    "Find the page on the web you want to link to": "Encuentre la página web a la que quiera enlazar",
    "Float Image Left": "Float Image Left",
    "Float Image Right": "Float Image Right",
    "Formatted &amp; Cleaned": "Formateado &amp; Limpiado",
    ...
    "Increase Font Size": "Incrementar el Tamaño de Fuente",
    ...
    "Italic": "Cursiva",
    "Justify": "Justificar",
    "Learn More About the Raptor WYSIWYG Editor": "Saber más sobre Raptor WYSIWYG Editor",
    ...
    "Not sure what to put in the box above?": "¿No sabe qué poner en la caja anterior?",
    "OK": "Aceptar",
    ...
    "Remaining characters before the recommended character limit is reached": "Carácteres restantes antes de que el límite de cáracteres recomendado sea alcanzado",
    ...
    "Successfully saved saved content block(s).": "Guardado exitosamente saved el/los contenido de lo(s) bloque(s).",
    ...
    "The url for the file you inserted doesn't look well formed": "La URL del archivo que has introducido no parece bien formada",
    "The url for the link you inserted doesn't look well formed": "La URL del enlace que has introducido no parece bien formada",
    ...
    "Updated link: link": "Actualizar enlace: link",
    "View / Edit Source": "Ver / Editar Código Fuente",
    "View Source": "Ver Código Fuente",
    "nThere are unsaved changes on this page. nIf you navigate away from this page you will lose your unsaved changes": "nHay cambios sin guardar en esta página. nSi sales de esta página, perderas todos los cambios sin guardar",
    "ctrl + b": "ctrl + b",
    "ctrl + i": "ctrl + i",
    "ctrl + s": "ctrl + s",
    "ctrl + u": "ctrl + u",
    ...
    "characters characters, charactersRemaining remaining": "characters carácteres, quedan charactersRemaining",
