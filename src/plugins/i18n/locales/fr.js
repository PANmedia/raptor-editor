...
registerLocale('en', 'English', {
    ...
    "Ensure the file has been uploaded to your website": "Vérfiez que le fichier a été transféré vers votre site",
    ...
    "Failed to save {{failed}} content block(s).": "Échec d'enregistrement de(s) bloc(s) de contenu {{failed}}.",
    ...
    "Link to a page on this or another website": "Lier une page un autre site",
    "Link to an email address": "Lier une adresse e-mail",
    "Location": "Emplacement",
    "N/A": "N/A",
    "New window": "Nouvelle fenêtre",
    "No changes detected to save...": "Pas de modification détectée à enregistrer...",
    ...
    "Remaining characters before the recommended character limit is reached": "Caractères restant avant que la limite de caractère recommandée ne soit atteinte",
    ...
    "The image \"{{image}}\" is too large for the element being edited.<br/>It has been resized with CSS.": "L'image \"{{image}}\" est trop grande pour l'élément en cours de modification.<br/>Elle a été redimensionnée avec CSS.",
    ...
    "{{charactersRemaining}} characters remaining": "{{charactersRemaining}} caractères restant",
    ...
    "{{characters}} characters, {{charactersRemaining}} remaining": "{{characters}} caractères, {{charactersRemaining}} restant",
