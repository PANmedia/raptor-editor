...
<body class="simple">
    ...
    <script type="text/javascript">
        testEditor('.test-1', function(input) {
            var alignLeftButton = input.find('.editible').data('raptor').getLayout().getElement().find('.raptor-ui-align-left');
    ...
    <script type="text/javascript">
        testEditor('.test-9', function(input) {
            var alignCenterButton = input.find('.editible').data('raptor').getLayout().getElement().find('.raptor-ui-align-left');
