...
<body class="simple">
    ...
    <div class="test-1">
        <h1>Superscript Button 1: Word Group Selection</h1>
    ...
    <div class="test-2">
        <h1>Superscript Button 2: Single Word Selection</h1>
        <div class="test-input">
            <div class="editable">
                <p>
                    Lorem ipsum dolor sit amet, consectetur {adipiscing} elit. Maecenas
    ...
    <div class="test-3">
        <h1>Superscript Button 3: Part Word Selection</h1>
        <div class="test-input">
            <div class="editable">
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas
    ...
    <script type="text/javascript">
     ...
     <div class="test-4">
        <h1>Superscript Button 4: Multi-Paragraph Selection</h1>
        <div class="test-input">
            <div class="editable">
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas
    ...
    <div class="test-5">
        <h1>Superscript Button 5: Paragraph Selection</h1>
        <div class="test-input">
            <div class="editable">
                <p>
                    {Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas
    ...
    <div class="test-6">
        <h1>Superscript Button 6: Empty Selection in Word</h1>
        <div class="test-input">
            <div class="editable">
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas
        ...
        <div class="test-expected">
            <div class="editable">
                <p>
                    ...
                    Aliquam gravida mauris at
                    ligula venenatis rhoncus. <sup class="cms-sup">{Suspendisse}</sup> interdum, nisi nec consectetur
                    pulvinar, lorem augue ornare felis, vel lacinia erat nibh in velit.
                </p>
            </div>
        </div>
    ...
    <div class="test-7">
        <h1>Superscript Button 7: Empty Selection at the Beginning of a Word</h1>
        <div class="test-input">
            <div class="editable">
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas
