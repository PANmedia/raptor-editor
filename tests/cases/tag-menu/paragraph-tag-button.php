...
<body class="simple">
    ...
    <script type="text/javascript">
        testEditor('.test-1', function(input) {
            ...
            var paragraphTagButton = input.find('.editible').data('raptor').getLayout().getElement().find('#ui-id-3');
            paragraphTagButton.trigger('click');
            rangesToTokens(rangy.getSelection().getAllRanges());
            
//            if (!paragraphTagButton.is('.ui-state-highlight')){
