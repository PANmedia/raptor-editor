...
<body class="simple">
    ...
    <div class="test-1">
        <h1>Toggle Wrapper 1: Word Group Selection</h1>
    ...
    <div class="test-2">
        <h1>Toggle Wrapper 2: Single Word Selection</h1>
        <div class="test-input">
            <div class="editible">
                <p>
                    Lorem ipsum dolor sit amet, consectetur {adipiscing} elit. Maecenas
    ...
    <div class="test-3">
        <h1>Toggle Wrapper 3: Part Word Selection</h1>
        <div class="test-input">
            <div class="editible">
            <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas
    ...
    <script type="text/javascript">
        testEditor('.test-3', function() {
            input.find('.editible').data('editor').getLayout().getElement().find('.raptor-ui-text-bold').trigger('click');
        });
    </script>
    
     <div class="test-4">
        <h1>Toggle Wrapper 4: Multi-Paragraph Selection</h1>
        <div class="test-input">
            <div class="editible">
            <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas
