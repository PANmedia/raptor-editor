...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(c){return a.isHostObject(c,"body")?c.body:c.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var c;c=a.parentNode;)a=c;return a},comparePoints:function(a,c,b,d){var q;if(a==b)return c===d?0:c<d?-1:1;if(q=r(b,a,!0))return c<=n(q)?-1:1;if(q=r(a,b,!0))return n(q)<d?-1:1;c=t(a,b);a=a===c?c:r(a,c,!0);b=b===c?c:r(b,c,!0);if(a===b)throw Error("comparePoints got to case 4 and childA and childB are the same!");
for(c=c.firstChild;c;){if(c===a)return-1;if(c===b)return 1;c=c.nextSibling}throw Error("Should not be here!");},inspectNode:q,fragmentFromNodeChildren:function(a){for(var c=w(a).createDocumentFragment(),b;b=a.firstChild;)c.appendChild(b);return c},createIterator:function(a){return new p(a)},DomPosition:i};d.DOMException=l});
rangy.createModule("DomRange",function(d){function o(a,c){return 3!=a.nodeType&&(j.isAncestorOf(a,c.startContainer,!0)||j.isAncestorOf(a,c.endContainer,!0))}function n(a){return j.getDocument(a.startContainer)}function t(a,c,b){if(c=a._listeners[c])for(var d=0,e=c.length;d<e;++d)c[d].call(a,{target:a,args:b})}function r(a){return new J(a.parentNode,j.getNodeIndex(a))}function s(a){return new J(a.parentNode,j.getNodeIndex(a)+1)}function f(a,c,b){var d=11==a.nodeType?a.firstChild:a;j.isCharacterDataNode(c)?
b==c.length?j.insertAfter(a,c):c.parentNode.insertBefore(a,0==b?c:j.splitDataNode(c,b)):b>=c.childNodes.length?c.appendChild(a):c.insertBefore(a,c.childNodes[b]);return d}function w(a){for(var c,b,d=n(a.range).createDocumentFragment();b=a.next();){c=a.isPartiallySelectedSubtree();b=b.cloneNode(!c);c&&(c=a.getSubtreeIterator(),b.appendChild(w(c)),c.detach(!0));if(10==b.nodeType)throw new C("HIERARCHY_REQUEST_ERR");d.appendChild(b)}return d}function q(a,c,b){for(var d,e,b=b||{stop:!1};d=a.next();)if(a.isPartiallySelectedSubtree())if(!1===
c(d)){b.stop=!0;break}else{if(d=a.getSubtreeIterator(),q(d,c,b),d.detach(!0),b.stop)break}else for(d=j.createIterator(d);e=d.next();)if(!1===c(e)){b.stop=!0;return}}function p(a){for(var c;a.next();)a.isPartiallySelectedSubtree()?(c=a.getSubtreeIterator(),p(c),c.detach(!0)):a.remove()}function i(a){for(var c,b=n(a.range).createDocumentFragment(),d;c=a.next();){a.isPartiallySelectedSubtree()?(c=c.cloneNode(!1),d=a.getSubtreeIterator(),c.appendChild(i(d)),d.detach(!0)):a.remove();if(10==c.nodeType)throw new C("HIERARCHY_REQUEST_ERR");
b.appendChild(c)}return b}function l(c,b,d){var e=!(!b||!b.length),u,g=!!d;e&&(u=RegExp("^("+b.join("|")+")$"));var v=[];q(new a(c,!1),function(a){(!e||u.test(a.nodeType))&&(!g||d(a))&&v.push(a)});return v}function k(a){return"["+("undefined"==typeof a.getName?"Range":a.getName())+"("+j.inspectNode(a.startContainer)+":"+a.startOffset+", "+j.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function a(a,c){this.range=a;this.clonePartiallySelectedTextNodes=c;if(!a.collapsed){this.sc=a.startContainer;
...
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function c(a,c,b){this.nodes=l(a,c,b);this._next=this.nodes[0];this._position=0}function e(a){return function(c,b){for(var d,e=b?c:c.parentNode;e;){d=e.nodeType;if(j.arrayContains(a,d))return e;e=e.parentNode}return null}}function g(a,c){if(aa(a,c))throw new b("INVALID_NODE_TYPE_ERR");}function h(a){if(!a.startContainer)throw new C("INVALID_STATE_ERR");}function m(a,c){if(!j.arrayContains(c,a.nodeType))throw new b("INVALID_NODE_TYPE_ERR");
}function D(a,c){if(0>c||c>(j.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new C("INDEX_SIZE_ERR");}function B(a,c){if(Q(a,!0)!==Q(c,!0))throw new C("WRONG_DOCUMENT_ERR");}function z(a){if(ba(a,!0))throw new C("NO_MODIFICATION_ALLOWED_ERR");}function y(a,c){if(!a)throw new C(c);}function F(a){return!!a.startContainer&&!!a.endContainer&&!(!j.arrayContains(M,a.startContainer.nodeType)&&!Q(a.startContainer,!0))&&!(!j.arrayContains(M,a.endContainer.nodeType)&&!Q(a.endContainer,!0))&&a.startOffset<=
...
c){this._listeners[a].push(c)},compareBoundaryPoints:function(a,c){x(this);B(this.startContainer,c.startContainer);var b=a==W||a==R?"start":"end",d=a==V||a==R?"start":"end";return j.comparePoints(this[b+"Container"],this[b+"Offset"],c[d+"Container"],c[d+"Offset"])},insertNode:function(a){x(this);m(a,L);z(this.startContainer);if(j.isAncestorOf(a,this.startContainer,!0))throw new C("HIERARCHY_REQUEST_ERR");this.setStartBefore(f(a,this.startContainer,this.startOffset))},cloneContents:function(){x(this);
var c,b;if(this.collapsed)return n(this).createDocumentFragment();if(this.startContainer===this.endContainer&&j.isCharacterDataNode(this.startContainer))return c=this.startContainer.cloneNode(!0),c.data=c.data.slice(this.startOffset,this.endOffset),b=n(this).createDocumentFragment(),b.appendChild(c),b;b=new a(this,!0);c=w(b);b.detach();return c},canSurroundContents:function(){x(this);z(this.startContainer);z(this.endContainer);var c=new a(this,!0),b=c._first&&o(c._first,this)||c._last&&o(c._last,
this);c.detach();return!b},surroundContents:function(a){m(a,u);if(!this.canSurroundContents())throw new b("BAD_BOUNDARYPOINTS_ERR");var c=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);f(a,this.startContainer,this.startOffset);a.appendChild(c);this.selectNode(a)},cloneRange:function(){x(this);for(var a=new A(n(this)),c=U.length,b;c--;)b=U[c],a[b]=this[b];return a},toString:function(){x(this);var c=this.startContainer;if(c===this.endContainer&&j.isCharacterDataNode(c))return 3==
c.nodeType||4==c.nodeType?c.data.slice(this.startOffset,this.endOffset):"";var b=[],c=new a(this,!0);q(c,function(a){(3==a.nodeType||4==a.nodeType)&&b.push(a.data)});c.detach();return b.join("")},compareNode:function(a){x(this);var c=a.parentNode,b=j.getNodeIndex(a);if(!c)throw new C("NOT_FOUND_ERR");a=this.comparePoint(c,b);c=this.comparePoint(c,b+1);return 0>a?0<c?Z:X:0<c?Y:S},comparePoint:function(a,c){x(this);y(a,"HIERARCHY_REQUEST_ERR");B(a,this.startContainer);return 0>j.comparePoints(a,c,this.startContainer,
this.startOffset)?-1:0<j.comparePoints(a,c,this.endContainer,this.endOffset)?1:0},createContextualFragment:T?function(a){var c=this.startContainer,b=j.getDocument(c);if(!c)throw new C("INVALID_STATE_ERR");var d=null;1==c.nodeType?d=c:j.isCharacterDataNode(c)&&(d=j.parentElement(c));d=null===d||"HTML"==d.nodeName&&j.isHtmlNamespace(j.getDocument(d).documentElement)&&j.isHtmlNamespace(d)?b.createElement("body"):d.cloneNode(!1);d.innerHTML=a;return j.fragmentFromNodeChildren(d)}:function(a){h(this);
...
b:0>e&&0<b},isPointInRange:function(a,c){x(this);y(a,"HIERARCHY_REQUEST_ERR");B(a,this.startContainer);return 0<=j.comparePoints(a,c,this.startContainer,this.startOffset)&&0>=j.comparePoints(a,c,this.endContainer,this.endOffset)},intersectsRange:function(a,c){x(this);if(n(a)!=n(this))throw new C("WRONG_DOCUMENT_ERR");var b=j.comparePoints(this.startContainer,this.startOffset,a.endContainer,a.endOffset),d=j.comparePoints(this.endContainer,this.endOffset,a.startContainer,a.startOffset);return c?0>=
...
rangy.createModule("WrappedRange",function(d){function o(d,f,i,l){var k=d.duplicate();k.collapse(i);var a=k.parentElement();r.isAncestorOf(f,a,!0)||(a=f);if(!a.canHaveHTML)return new s(a.parentNode,r.getNodeIndex(a));var f=r.getDocument(a).createElement("span"),b,c=i?"StartToStart":"StartToEnd";do a.insertBefore(f,f.previousSibling),k.moveToElementText(f);while(0<(b=k.compareEndPoints(c,d))&&f.previousSibling);c=f.nextSibling;if(-1==b&&c&&r.isCharacterDataNode(c)){k.setEndPoint(i?"EndToStart":"EndToEnd",
d);if(/[\r\n]/.test(c.data)){a=k.duplicate();i=a.text.replace(/\r\n/g,"\r").length;for(i=a.moveStart("character",i);-1==a.compareEndPoints("StartToEnd",a);)i++,a.moveStart("character",1)}else i=k.text.length;a=new s(c,i)}else c=(l||!i)&&f.previousSibling,a=(i=(l||i)&&f.nextSibling)&&r.isCharacterDataNode(i)?new s(i,0):c&&r.isCharacterDataNode(c)?new s(c,c.length):new s(a,r.getNodeIndex(f));f.parentNode.removeChild(f);return a}function n(d,f){var i,l,k=d.offset,a=r.getDocument(d.node),b=a.body.createTextRange(),
c=r.isCharacterDataNode(d.node);c?(i=d.node,l=i.parentNode):(i=d.node.childNodes,i=k<i.length?i[k]:null,l=d.node);a=a.createElement("span");a.innerHTML="&#feff;";i?l.insertBefore(a,i):l.appendChild(a);b.moveToElementText(a);b.collapse(!f);l.removeChild(a);if(c)b[f?"moveStart":"moveEnd"]("character",k);return b}d.requireModules(["DomUtil","DomRange"]);var t,r=d.dom,s=r.DomPosition,f=d.DomRange;if(d.features.implementsDomRange&&(!d.features.implementsTextRange||!d.config.preferTextRange))(function(){function q(a){for(var b=
i.length,d;b--;)d=i[b],a[d]=a.nativeRange[d]}var p,i=f.rangeProperties,l;t=function(a){if(!a)throw Error("Range must be specified");this.nativeRange=a;q(this)};f.createPrototypeRange(t,function(a,b,d,h,f){var q=a.endContainer!==h||a.endOffset!=f;if(a.startContainer!==b||a.startOffset!=d||q)a.setEnd(h,f),a.setStart(b,d)},function(a){a.nativeRange.detach();a.detached=!0;for(var b=i.length,d;b--;)d=i[b],a[d]=null});p=t.prototype;p.selectNode=function(a){this.nativeRange.selectNode(a);q(this)};p.deleteContents=
function(){this.nativeRange.deleteContents();q(this)};p.extractContents=function(){var a=this.nativeRange.extractContents();q(this);return a};p.cloneContents=function(){return this.nativeRange.cloneContents()};p.surroundContents=function(a){this.nativeRange.surroundContents(a);q(this)};p.collapse=function(a){this.nativeRange.collapse(a);q(this)};p.cloneRange=function(){return new t(this.nativeRange.cloneRange())};p.refresh=function(){q(this)};p.toString=function(){return this.nativeRange.toString()};
var k=document.createTextNode("test");r.getBody(document).appendChild(k);var a=document.createRange();a.setStart(k,0);a.setEnd(k,0);try{a.setStart(k,1),p.setStart=function(a,b){this.nativeRange.setStart(a,b);q(this)},p.setEnd=function(a,b){this.nativeRange.setEnd(a,b);q(this)},l=function(a){return function(b){this.nativeRange[a](b);q(this)}}}catch(b){p.setStart=function(a,b){try{this.nativeRange.setStart(a,b)}catch(d){this.nativeRange.setEnd(a,b),this.nativeRange.setStart(a,b)}q(this)},p.setEnd=function(a,
b){try{this.nativeRange.setEnd(a,b)}catch(d){this.nativeRange.setStart(a,b),this.nativeRange.setEnd(a,b)}q(this)},l=function(a,b){return function(d){try{this.nativeRange[a](d)}catch(h){this.nativeRange[b](d),this.nativeRange[a](d)}q(this)}}}p.setStartBefore=l("setStartBefore","setEndBefore");p.setStartAfter=l("setStartAfter","setEndAfter");p.setEndBefore=l("setEndBefore","setStartBefore");p.setEndAfter=l("setEndAfter","setStartAfter");a.selectNodeContents(k);p.selectNodeContents=a.startContainer==
k&&a.endContainer==k&&0==a.startOffset&&a.endOffset==k.length?function(a){this.nativeRange.selectNodeContents(a);q(this)}:function(a){this.setStart(a,0);this.setEnd(a,f.getEndOffset(a))};a.selectNodeContents(k);a.setEnd(k,3);l=document.createRange();l.selectNodeContents(k);l.setEnd(k,4);l.setStart(k,2);p.compareBoundaryPoints=-1==a.compareBoundaryPoints(a.START_TO_END,l)&1==a.compareBoundaryPoints(a.END_TO_START,l)?function(a,b){b=b.nativeRange||b;a==b.START_TO_END?a=b.END_TO_START:a==b.END_TO_START&&
(a=b.START_TO_END);return this.nativeRange.compareBoundaryPoints(a,b)}:function(a,b){return this.nativeRange.compareBoundaryPoints(a,b.nativeRange||b)};d.util.isHostMethod(a,"createContextualFragment")&&(p.createContextualFragment=function(a){return this.nativeRange.createContextualFragment(a)});r.getBody(document).removeChild(k);a.detach();l.detach()})(),d.createNativeRange=function(d){return(d||document).createRange()};else if(d.features.implementsTextRange){t=function(d){this.textRange=d;this.refresh()};
t.prototype=new f(document);t.prototype.refresh=function(){var d,f,i=this.textRange;d=i.parentElement();var l=i.duplicate();l.collapse(!0);f=l.parentElement();l=i.duplicate();l.collapse(!1);i=l.parentElement();f=f==i?f:r.getCommonAncestor(f,i);f=f==d?f:r.getCommonAncestor(d,f);0==this.textRange.compareEndPoints("StartToEnd",this.textRange)?f=d=o(this.textRange,f,!0,!0):(d=o(this.textRange,f,!0,!1),f=o(this.textRange,f,!1,!1));this.setStart(d.node,d.offset);this.setEnd(f.node,f.offset)};f.copyComparisonConstants(t);
var w=function(){return this}();"undefined"==typeof w.Range&&(w.Range=t);d.createNativeRange=function(d){return(d||document).body.createTextRange()}}d.features.implementsTextRange&&(t.rangeToTextRange=function(d){if(d.collapsed)return n(new s(d.startContainer,d.startOffset),!0);var f=n(new s(d.startContainer,d.startOffset),!0),i=n(new s(d.endContainer,d.endOffset),!1),d=r.getDocument(d.startContainer).body.createTextRange();d.setEndPoint("StartToStart",f);d.setEndPoint("EndToEnd",i);return d});t.prototype.getName=
...
!1;break a}d=!0}if(!d)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function q(a,c){var b=new h(c);a._ranges=[b];r(a,b,!1);a.rangeCount=1;a.isCollapsed=b.collapsed}function p(a){a._ranges.length=0;if("None"==a.docSelection.type)s(a);else{var b=a.docSelection.createRange();if(b&&"undefined"!=typeof b.text)q(a,b);else{a.rangeCount=b.length;for(var e,g=c.getDocument(b.item(0)),v=0;v<a.rangeCount;++v)e=d.createRange(g),e.selectNode(b.item(v)),
a._ranges.push(e);a.isCollapsed=1==a.rangeCount&&a._ranges[0].collapsed;r(a,a._ranges[a.rangeCount-1],!1)}}}function i(a,b){for(var d=a.docSelection.createRange(),e=w(b),g=c.getDocument(d.item(0)),g=c.getBody(g).createControlRange(),v=0,h=d.length;v<h;++v)g.add(d.item(v));try{g.add(e)}catch(f){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}g.select();p(a)}function l(a,c,b){this.nativeSelection=a;this.docSelection=c;this._ranges=
[];this.win=b;this.refresh()}function k(a,b){for(var d=c.getDocument(b[0].startContainer),d=c.getBody(d).createControlRange(),e=0,g;e<rangeCount;++e){g=w(b[e]);try{d.add(g)}catch(v){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();p(a)}function a(a,b){if(a.anchorNode&&c.getDocument(a.anchorNode)!==c.getDocument(b))throw new m("WRONG_DOCUMENT_ERR");}function b(a){var c=[],b=new D(a.anchorNode,a.anchorOffset),
d=new D(a.focusNode,a.focusOffset),e="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var v=0,h=a.rangeCount;v<h;++v)c[v]=g.inspect(a.getRangeAt(v));return"["+e+"(Ranges: "+c.join(", ")+")(anchor: "+b.inspect()+", focus: "+d.inspect()+"]"}d.requireModules(["DomUtil","DomRange","WrappedRange"]);d.config.checkSelectionRanges=!0;var c=d.dom,e=d.util,g=d.DomRange,h=d.WrappedRange,m=d.DOMException,D=c.DomPosition,B,z,y=d.util.isHostMethod(window,"getSelection"),
...
s(this)};var C=function(a,b){var c=g.getRangeDocument(b),c=d.createRange(c);c.collapseToPoint(b.endContainer,b.endOffset);a.nativeSelection.addRange(f(c));a.nativeSelection.extend(b.startContainer,b.startOffset);a.refresh()};j.addRange=I?function(a,b){if(A&&F&&this.docSelection.type=="Control")i(this,a);else if(b&&v)C(this,a);else{var c;if(N)c=this.rangeCount;else{this.removeAllRanges();c=0}this.nativeSelection.addRange(f(a));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==c+1){if(d.config.checkSelectionRanges)(c=
J(this.nativeSelection,this.rangeCount-1))&&!g.rangesEqual(c,a)&&(a=new h(c));this._ranges[this.rangeCount-1]=a;r(this,a,L(this.nativeSelection));this.isCollapsed=z(this)}else this.refresh()}}:function(a,b){if(b&&v)C(this,a);else{this.nativeSelection.addRange(f(a));this.refresh()}};j.setRanges=function(a){if(A&&a.length>1)k(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(e.isHostMethod(y,"empty")&&e.isHostMethod(H,"select")&&A&&x)j.removeAllRanges=
...
a(b.nextSibling)}function c(a,b,d,e){var g,h=0==d;if(m.isAncestorOf(b,a))return a;if(m.isCharacterDataNode(b))if(0==d)d=m.getNodeIndex(b),b=b.parentNode;else if(d==b.length)d=m.getNodeIndex(b)+1,b=b.parentNode;else throw o.createError("splitNodeAt should not be called with offset in the middle of a data node ("+d+" in "+b.data);if(m.isCharacterDataNode(b)?0==d?b.previousSibling:d==b.length?b.nextSibling:1:0<d&&d<b.childNodes.length){if(!g){g=b.cloneNode(!1);for(g.id&&g.removeAttribute("id");h=b.childNodes[d];)g.appendChild(h);
...
rangy.createModule("SaveRestore",function(d,o){function n(d,p){var i="selectionBoundary_"+ +new Date+"_"+(""+Math.random()).slice(2),l,k=f.getDocument(d.startContainer),a=d.cloneRange();a.collapse(p);l=k.createElement("span");l.id=i;l.style.lineHeight="0";l.style.display="none";l.className="rangySelectionBoundary";l.appendChild(k.createTextNode(w));a.insertNode(l);a.detach();return l}function t(d,f,i,l){(d=(d||document).getElementById(i))?(f[l?"setStartBefore":"setEndBefore"](d),d.parentNode.removeChild(d)):
...
g+") do not match");e=s(a[1],b,c);b=s(a[2],b,c);c=d.createRange(c);c.setStart(e.node,e.offset);c.setEnd(b.node,b.offset);return c}function q(a,b,c){b?c||k.getDocument(b):b=(c||document).documentElement;a=/^([^,]+),([^,]+)({([^}]+)})?$/.exec(a)[3];return!a||a===t(b)}function p(a,b,c){for(var a=a||d.getSelection(),a=a.getAllRanges(),e=[],g=0,h=a.length;g<h;++g)e[g]=f(a[g],b,c);return e.join("|")}function i(a,b,c){b?c=c||k.getWindow(b):(c=c||window,b=c.document.documentElement);for(var a=a.split("|"),
e=d.getSelection(c),g=[],f=0,m=a.length;f<m;++f)g[f]=w(a[f],b,c.document);e.setRanges(g);return e}d.requireModules(["WrappedSelection","WrappedRange"]);("undefined"==typeof encodeURIComponent||"undefined"==typeof decodeURIComponent)&&o.fail("Global object is missing encodeURIComponent and/or decodeURIComponent method");var l=function(){var a=null;return function(b){for(var c=[],d=0,g=b.length,f;d<g;++d)f=b.charCodeAt(d),128>f?c.push(f):2048>f?c.push(f>>6|192,f&63|128):c.push(f>>12|224,f>>6&63|128,
f&63|128);b=-1;if(!a){for(var d=[],g=0,m;256>g;++g){m=g;for(f=8;f--;)m=1==(m&1)?m>>>1^3988292384:m>>>1;d[g]=m>>>0}a=d}d=a;g=0;for(f=c.length;g<f;++g)m=(b^c[g])&255,b=b>>>8^d[m];return(b^-1)>>>0}}(),k=d.dom;d.serializePosition=r;d.deserializePosition=s;d.serializeRange=f;d.deserializeRange=w;d.canDeserializeRange=q;d.serializeSelection=p;d.deserializeSelection=i;d.canDeserializeSelection=function(a,b,c){var d;b?d=c?c.document:k.getDocument(b):b=(c||window).document.documentElement;for(var a=a.split("|"),
c=0,g=a.length;c<g;++c)if(!q(a[c],b,d))return!1;return!0};d.restoreSelectionFromCookie=function(a){var a=a||window,b;a:{b=a.document.cookie.split(/[;,]/);for(var c=0,d=b.length,g;c<d;++c)if(g=b[c].split("="),"rangySerializedSelection"==g[0].replace(/^\s+/,"")&&(g=g[1])){b=decodeURIComponent(g.replace(/\s+$/,""));break a}b=null}b&&i(b,a.doc)};d.saveSelectionCookie=function(a,b){var a=a||window,b="object"==typeof b?b:{},c=b.expires?";expires="+b.expires.toUTCString():"",e=b.path?";path="+b.path:"",
g=b.domain?";domain="+b.domain:"",f=b.secure?";secure":"",m=p(d.getSelection(a));a.document.cookie=encodeURIComponent("rangySerializedSelection")+"="+encodeURIComponent(m)+c+e+g+f};d.getElementChecksum=t});
(function(d){d.fn.raptorize=function(o){o=d.extend({enterOn:"click",delayTime:5E3},o);return this.each(function(){function n(){s=!0;r&&document.getElementById("elRaptorShriek").play();f.animate({bottom:"0"},function(){d(this).animate({bottom:"-30px"},100,function(){var n=d(this).position().left+400;d(this).delay(300).animate({right:n},2200,function(){f=d("#elRaptor").css({bottom:"-700px",right:"0"});s=!1})})})}var t=d(this),r=!1;if(d.browser.mozilla&&"1.9.2"<=d.browser.version.substr(0,5)||d.browser.webkit)r=
...
var f=d("#elRaptor").css({position:"fixed",bottom:"-700px",right:"0",display:"block"});if("timer"==o.enterOn)setTimeout(n,o.delayTime);else if("click"==o.enterOn)t.bind("click",function(d){d.preventDefault();s||n()});else if("konami-code"==o.enterOn){var w=[];d(window).bind("keydown.raptorz",function(f){w.push(f.keyCode);0<=w.toString().indexOf("38,38,40,40,37,39,37,39,66,65")&&(n(),d(window).unbind("keydown.raptorz"))},!0)}})}})(jQuery);
(function(d,o,n,t){function r(a,b,c){p[a]=c;i[a]=b;q||(q=a)}function s(a){q!==a&&(q=a,d.ui.editor.eachInstance(function(){this.reinit()}))}function f(a,b){q&&p[q]&&p[q][a]&&(a=p[q][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function w(a){if(l===t){l=!0;if(k=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))d("html").addClass(a.options.baseClass+"-ios"),k&&d(document).bind("scroll",function(){setInterval(function(){d("body").css("height","+=1").css("height",
"-=1")},0)});d.browser.mozilla&&d("html").addClass(a.options.baseClass+"-ff");if(d.browser.msie&&9>d.browser.version){l=!1;var b=d("<div></div>").addClass(a.options.baseClass+"-unsupported").html(a.getTemplate("unsupported")).appendTo("body"),c=1;b.siblings().each(function(){var a=d(this).css("z-index");!isNaN(a)&&a>c&&(c=a+1)});b.css("z-index",c);b.find("."+a.options.baseClass+"-unsupported-close").click(function(){b.remove()})}}return l}var q=null,p={},i={};d(function(){n.initialized||n.init();
...
null;e.hide()},c.delay,this)},hide:function(){this.timer&&(o.clearTimeout(this.timer),this.timer=null);this.element.stop().slideUp(d.proxy(function(){d.isFunction(c.hide)&&c.hide.call(this);this.element.remove()},this))}};e.element=d(this.getTemplate("message",{type:a,message:b})).hide().appendTo(this.messages).find(".ui-editor-message-close").click(function(){e.hide()}).end();e.show();return e},showLoading:function(a,b){return this.showMessage("clock",a,b)},showInfo:function(a,b){return this.showMessage("info",
...
b;a++){for(var c=this.options.uiOrder[a],e=d("<div/>"),g=0,f=c.length;g<f;g++)if(this.uiEnabled(c[g])){var m=c[g].replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});if(d.ui.editor.ui[c[g]]){var i=d.extend({},d.ui.editor.ui[c[g]]),m=d.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-ui-"+m},i.options,this.options.ui[c[g]]);i.editor=this;i.options=m;i.ui=i.init(this,m);i.ui.init(c[g],this,m,i).appendTo(e);this.uiObjects[c[g]]=i}}e.addClass("ui-buttonset").addClass(this.options.baseClass+
...
a).attr("title",this.title).val(a);e.classes&&this.button.addClass(e.classes);this.button.bind("mousedown."+g.editor.widgetName,function(a){a.preventDefault()});var m=this;this.button.bind("mouseup."+g.editor.widgetName,function(a){a.preventDefault();m.click.apply(g,arguments)});c.bind("destroy",d.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+h},disabled:e.disabled?!0:!1,text:this.text||!1,label:this.label||null});this.ready.call(g);
...
a.uiButton({title:f("Step Forward"),disabled:!0,click:function(){a.historyForward()}})},change:function(){this.editor.present===this.editor.history.length-1?this.ui.disable():this.ui.enable()}}});d.ui.editor.registerPlugin("hotkeys",{options:{actions:[{ui:"textBold",key:"b",label:f("ctrl + b")},{ui:"textItalic",key:"i",label:f("ctrl + i")},{ui:"textUnderline",key:"u",label:f("ctrl + u")},{ui:"undo",key:"z",label:f("ctrl + z")},{ui:"redo",key:"y",label:f("ctrl + y")},{ui:"cancel",meta:!1,key:27,label:f("esc")},
{ui:"save",key:"s",label:f("ctrl + s")}]},indexedActions:{},keyUpEventSignature:null,keyDownEventSignature:null,init:function(a){this.keyUpEventSignature="keyup."+this.options.baseClass;this.keyDownEventSignature="keydown."+this.options.baseClass;a.bind("enabled",this.enabled,this);a.bind("disabled",this.disabled,this)},disabled:function(){d(o).unbind(this.keyUpEventSignature);d(o).unbind(this.keyDownEventSignature);this.indexedActions={}},enabled:function(){for(var a,b=0;b<this.options.actions.length;b++)if(a=
this.options.actions[b],this.indexedActions[this.isNumeric(a.key)?a.key:a.key.charCodeAt(0)]=a,"undefined"!==typeof a.ui){var c=this.editor.getUi(a.ui);c.ui.button.attr("title",c.ui.title+" ("+a.label+")")}var e=this;d(o).bind(this.keyDownEventSignature,function(a){e.actionForKeyCombination.call(e,a)&&a.preventDefault()});d(o).bind(this.keyUpEventSignature,function(a){var b=e.actionForKeyCombination.call(e,a);b&&((d.isFunction(b.callback)?b.callback:function(){e.triggerUiAction(b.ui)}).call(e,a),
a.preventDefault())})},actionForKeyCombination:function(a){var b=a.which;65<=b&&90>=b&&(b+=32);var c=this.indexedActions[b];if("undefined"===typeof c||!(!1===c.meta||a.ctrlKey||a.metaKey))return!1;a=!1;return(a=this.isNumeric(c.key)?b===c.key:String.fromCharCode(b).toLowerCase()===c.key)?c:!1},triggerUiAction:function(a,b){var c=this.editor.getUi(a);"undefined"!==typeof c&&c.ui.click.apply(c,b)},isNumeric:function(a){return!isNaN(a-0)}});d.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:f("Insert Horizontal Rule"),
click:function(){a.replaceSelection("<hr/>")}})}}});d.ui.editor.registerUi({i18n:{init:function(a){var b=this,c=this.persist("locale");c&&s(c);var c=d('<select autocomplete="off" name="i18n"/>'),e;for(e in p){var g=d('<option value="'+e+'" class="'+e+'"/>');g.html(i[e]);q===e&&g.attr("selected","selected");c.append(g)}return a.uiSelectMenu({title:f("Change Language"),select:c,change:function(a){s(b.persist("locale",a))}})}}});r("en","English",{});r("zh_CN","\u7b80\u4f53\u4e2d\u6587",{"Added link: {{link}}":"Added link: {{link}}",
...
a.newValue.match(/width|height/)&&(this.options.resizeAjax&&b.addClass(this.options.resizeAjaxClass),this.editor.fire("change"))},scanImages:function(){var a=this.editor.getElement(),b=[];d(a.find("img")).each(function(){(a.height()<d(this).outerHeight()||a.width()<d(this).outerWidth())&&b.push(d(this))});b.length&&this.resizeImageElements(b,a.width(),a.height())},resizeImageElements:function(a,b,c){for(var e=d("<a>",{href:"",target:"_blank"}),f=0;f<a.length;f++){var h=a[f],m=h.outerWidth(),i=h.outerHeight(),
k=Math.min(b/m,c/i),m=Math.abs(k*(m-(h.outerWidth()-h.width()))),i=Math.abs(k*(i-(h.outerHeight()-h.height())));h.addClass(this.options.resizingClass);e=e.html(h.attr("title")||h.attr("src").substr(h.attr("src").lastIndexOf("/")+1)).attr("href",h.attr("src"));d(h).css({width:m,height:i}).attr("height",i).attr("width",m);this.options.resizeAjax&&h.addClass(this.options.resizeAjaxClass);var l=this;this.showOversizeWarning(this.editor.outerHtml(e),{hide:function(){h.removeClass(l.options.resizingClass)}})}},
