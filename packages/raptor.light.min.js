/*! VERSION: 0.0.1 *//*
 ...
 Build date: 26 February 2012
*/
window.rangy=function(){function d(a,c){var b=typeof a[c];return b==p||!!(b==n&&a[c])||"unknown"==b}function q(a,c){return!!(typeof a[c]==n&&a[c])}function k(a,c){return typeof a[c]!=h}function t(a){return function(c,b){for(var d=b.length;d--;)if(!a(c,b[d]))return!1;return!0}}function r(d){return d&&c(d,b)&&g(d,a)}function s(a){window.alert("Rangy not supported in your browser. Reason: "+a);i.initialized=!0;i.supported=!1}function f(){if(!i.initialized){var a,b=!1,e=!1;d(document,"createRange")&&
(a=document.createRange(),c(a,l)&&g(a,m)&&(b=!0),a.detach());if((a=q(document,"body")?document.body:document.getElementsByTagName("body")[0])&&d(a,"createTextRange"))a=a.createTextRange(),r(a)&&(e=!0);!b&&!e&&s("Neither Range nor TextRange are implemented");i.initialized=!0;i.features={implementsDomRange:b,implementsTextRange:e};b=C.concat(o);e=0;for(a=b.length;e<a;++e)try{b[e](i)}catch(n){q(window,"console")&&d(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
n)}}}function w(a){this.name=a;this.supported=this.initialized=!1}var n="object",p="function",h="undefined",m="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer,START_TO_START,START_TO_END,END_TO_START,END_TO_END".split(","),l="setStart,setStartBefore,setStartAfter,setEnd,setEndBefore,setEndAfter,collapse,selectNode,selectNodeContents,compareBoundaryPoints,deleteContents,extractContents,cloneContents,insertNode,surroundContents,cloneRange,toString,detach".split(","),
a="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),b="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),c=t(d),e=t(q),g=t(k),i={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:d,isHostObject:q,isHostProperty:k,areHostMethods:c,areHostObjects:e,areHostProperties:g,isTextRange:r},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
...
for(var c=0,b=B.length;c<b;++c)B[c](a)};w.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};w.prototype.warn=function(a){i.warn("Module "+this.name+": "+a)};w.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};i.createModule=function(a,c){var b=new w(a);i.modules[a]=b;C.push(function(a){c(a,b);b.initialized=!0;b.supported=!0})};i.requireModules=function(a){for(var c=0,b=a.length,d,e;c<
b;++c){e=a[c];d=i.modules[e];if(!d||!(d instanceof w))throw Error("Module '"+e+"' not found");if(!d.supported)throw Error("Module '"+e+"' not supported");}};var z=!1,e=function(){z||(z=!0,i.initialized||f())};if(typeof window==h)s("No window found");else if(typeof document==h)s("No document found");else return d(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",e,!1),d(window,"addEventListener")?window.addEventListener("load",e,!1):d(window,"attachEvent")?window.attachEvent("onload",
e):s("Window does not have required addEventListener or attachEvent method"),i}();
rangy.createModule("DomUtil",function(d,q){function k(a){for(var c=0;a=a.previousSibling;)c++;return c}function t(a,b){var d=[],n;for(n=a;n;n=n.parentNode)d.push(n);for(n=b;n;n=n.parentNode)if(c(d,n))return n;return null}function r(a,c,b){for(b=b?a:a.parentNode;b;){a=b.parentNode;if(a===c)return b;b=a}return null}function s(a){a=a.nodeType;return 3==a||4==a||8==a}function f(a,c){var b=c.nextSibling,d=c.parentNode;b?d.insertBefore(a,b):d.appendChild(a);return a}function w(a){if(9==a.nodeType)return a;
if(typeof a.ownerDocument!=l)return a.ownerDocument;if(typeof a.document!=l)return a.document;if(a.parentNode)return w(a.parentNode);throw Error("getDocument: no document found for node");}function n(a){return!a?"[No node]":s(a)?'"'+a.data+'"':1==a.nodeType?"<"+a.nodeName+(a.id?' id="'+a.id+'"':"")+">["+a.childNodes.length+"]":a.nodeName}function p(a){this._next=this.root=a}function h(a,c){this.node=a;this.offset=c}function m(a){this.code=this[a];this.codeName=a;this.message="DOMException: "+this.codeName}
var l="undefined",a=d.util;a.areHostMethods(document,["createDocumentFragment","createElement","createTextNode"])||q.fail("document missing a Node creation method");a.isHostMethod(document,"getElementsByTagName")||q.fail("document missing getElementsByTagName method");var b=document.createElement("div");a.areHostMethods(b,["insertBefore","appendChild","cloneNode"])||q.fail("Incomplete Element implementation");a.isHostProperty(b,"innerHTML")||q.fail("Element is missing innerHTML property");b=document.createTextNode("test");
a.areHostMethods(b,["splitText","deleteData","insertData","appendData","cloneNode"])||q.fail("Incomplete Text Node implementation");var c=function(a,c){for(var b=a.length;b--;)if(a[b]===c)return!0;return!1};p.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){var a=this._current=this._next,c;if(this._current){c=a.firstChild;if(!c)for(c=null;a!==this.root&&!(c=a.nextSibling);)a=a.parentNode;this._next=c}return this._current},detach:function(){this._current=this._next=this.root=
null}};h.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+n(this.node)+":"+this.offset+")]"}};m.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};m.prototype.toString=function(){return this.message};d.dom={arrayContains:c,isHtmlNamespace:function(a){var c;return typeof a.namespaceURI==l||null===(c=a.namespaceURI)||"http://www.w3.org/1999/xhtml"==
c},parentElement:function(a){a=a.parentNode;return 1==a.nodeType?a:null},getNodeIndex:k,getNodeLength:function(a){var c;return s(a)?a.length:(c=a.childNodes)?c.length:0},getCommonAncestor:t,isAncestorOf:function(a,c,b){for(c=b?c:c.parentNode;c;){if(c===a)return!0;c=c.parentNode}return!1},getClosestAncestorIn:r,isCharacterDataNode:s,insertAfter:f,splitDataNode:function(a,c){var b=a.cloneNode(!1);b.deleteData(0,c);a.deleteData(c,a.length-c);f(b,a);return b},getDocument:w,getWindow:function(a){a=w(a);
...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(c){return a.isHostObject(c,"body")?c.body:c.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var c;c=a.parentNode;)a=c;return a},comparePoints:function(a,c,b,d){var n;if(a==b)return c===d?0:c<d?-1:1;if(n=r(b,a,!0))return c<=k(n)?-1:1;if(n=r(a,b,!0))return k(n)<d?-1:1;c=t(a,b);a=a===c?c:r(a,c,!0);b=b===c?c:r(b,c,!0);if(a===b)throw Error("comparePoints got to case 4 and childA and childB are the same!");
for(c=c.firstChild;c;){if(c===a)return-1;if(c===b)return 1;c=c.nextSibling}throw Error("Should not be here!");},inspectNode:n,fragmentFromNodeChildren:function(a){for(var c=w(a).createDocumentFragment(),b;b=a.firstChild;)c.appendChild(b);return c},createIterator:function(a){return new p(a)},DomPosition:h};d.DOMException=m});
rangy.createModule("DomRange",function(d){function q(a,c){return 3!=a.nodeType&&(j.isAncestorOf(a,c.startContainer,!0)||j.isAncestorOf(a,c.endContainer,!0))}function k(a){return j.getDocument(a.startContainer)}function t(a,c,b){if(c=a._listeners[c])for(var d=0,e=c.length;d<e;++d)c[d].call(a,{target:a,args:b})}function r(a){return new J(a.parentNode,j.getNodeIndex(a))}function s(a){return new J(a.parentNode,j.getNodeIndex(a)+1)}function f(a,c,b){var d=11==a.nodeType?a.firstChild:a;j.isCharacterDataNode(c)?
b==c.length?j.insertAfter(a,c):c.parentNode.insertBefore(a,0==b?c:j.splitDataNode(c,b)):b>=c.childNodes.length?c.appendChild(a):c.insertBefore(a,c.childNodes[b]);return d}function w(a){for(var c,b,d=k(a.range).createDocumentFragment();b=a.next();){c=a.isPartiallySelectedSubtree();b=b.cloneNode(!c);c&&(c=a.getSubtreeIterator(),b.appendChild(w(c)),c.detach(!0));if(10==b.nodeType)throw new D("HIERARCHY_REQUEST_ERR");d.appendChild(b)}return d}function n(a,c,b){for(var d,e,b=b||{stop:!1};d=a.next();)if(a.isPartiallySelectedSubtree())if(!1===
c(d)){b.stop=!0;break}else{if(d=a.getSubtreeIterator(),n(d,c,b),d.detach(!0),b.stop)break}else for(d=j.createIterator(d);e=d.next();)if(!1===c(e)){b.stop=!0;return}}function p(a){for(var c;a.next();)a.isPartiallySelectedSubtree()?(c=a.getSubtreeIterator(),p(c),c.detach(!0)):a.remove()}function h(a){for(var c,b=k(a.range).createDocumentFragment(),d;c=a.next();){a.isPartiallySelectedSubtree()?(c=c.cloneNode(!1),d=a.getSubtreeIterator(),c.appendChild(h(d)),d.detach(!0)):a.remove();if(10==c.nodeType)throw new D("HIERARCHY_REQUEST_ERR");
b.appendChild(c)}return b}function m(c,b,d){var e=!(!b||!b.length),u,g=!!d;e&&(u=RegExp("^("+b.join("|")+")$"));var v=[];n(new a(c,!1),function(a){(!e||u.test(a.nodeType))&&(!g||d(a))&&v.push(a)});return v}function l(a){return"["+("undefined"==typeof a.getName?"Range":a.getName())+"("+j.inspectNode(a.startContainer)+":"+a.startOffset+", "+j.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function a(a,c){this.range=a;this.clonePartiallySelectedTextNodes=c;if(!a.collapsed){this.sc=a.startContainer;
...
(j.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(j.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function x(a){i(a);if(!F(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function H(){}function G(a){a.START_TO_START=R;a.START_TO_END=V;a.END_TO_END=ca;a.END_TO_START=W;a.NODE_BEFORE=X;a.NODE_AFTER=Y;a.NODE_BEFORE_AND_AFTER=Z;a.NODE_INSIDE=S}function E(a){G(a);
G(a.prototype)}function v(c,b){return function(){x(this);var d=this.startContainer,e=this.startOffset,u=this.commonAncestorContainer,g=new a(this,!0);d!==u&&(d=j.getClosestAncestorIn(d,u,!0),e=s(d),d=e.node,e=e.offset);n(g,z);g.reset();u=c(g);g.detach();b(this,d,e,d,e);return u}}function I(c,b,e){function u(a,c){return function(b){i(this);o(b,K);o(O(b),M);b=(a?r:s)(b);(c?n:I)(this,b.node,b.offset)}}function n(a,c,d){var e=a.endContainer,u=a.endOffset;if(c!==a.startContainer||d!==a.startOffset){if(O(c)!=
O(e)||1==j.comparePoints(c,d,e,u))e=c,u=d;b(a,c,d,e,u)}}function I(a,c,d){var e=a.startContainer,u=a.startOffset;if(c!==a.endContainer||d!==a.endOffset){if(O(c)!=O(e)||-1==j.comparePoints(c,d,e,u))e=c,u=d;b(a,e,u,c,d)}}c.prototype=new H;d.util.extend(c.prototype,{setStart:function(a,c){i(this);g(a,!0);C(a,c);n(this,a,c)},setEnd:function(a,c){i(this);g(a,!0);C(a,c);I(this,a,c)},setStartBefore:u(!0,!0),setStartAfter:u(!1,!0),setEndBefore:u(!0,!1),setEndAfter:u(!1,!1),collapse:function(a){x(this);a?
b(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):b(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){i(this);g(a,!0);b(this,a,0,a,j.getNodeLength(a))},selectNode:function(a){i(this);g(a,!1);o(a,K);var c=r(a),a=s(a);b(this,c.node,c.offset,a.node,a.offset)},extractContents:v(h,b),deleteContents:v(p,b),canSurroundContents:function(){x(this);z(this.startContainer);z(this.endContainer);var c=new a(this,!0),b=c._first&&
q(c._first,this)||c._last&&q(c._last,this);c.detach();return!b},detach:function(){e(this)},splitBoundaries:function(){x(this);var a=this.startContainer,c=this.startOffset,d=this.endContainer,e=this.endOffset,u=a===d;j.isCharacterDataNode(d)&&0<e&&e<d.length&&j.splitDataNode(d,e);j.isCharacterDataNode(a)&&0<c&&c<a.length&&(a=j.splitDataNode(a,c),u?(e-=c,d=a):d==a.parentNode&&e>=j.getNodeIndex(a)&&e++,c=0);b(this,a,c,d,e)},normalizeBoundaries:function(){x(this);var a=this.startContainer,c=this.startOffset,
d=this.endContainer,e=this.endOffset,u=function(a){var c=a.nextSibling;c&&c.nodeType==a.nodeType&&(d=a,e=a.length,a.appendData(c.data),c.parentNode.removeChild(c))},g=function(b){var u=b.previousSibling;if(u&&u.nodeType==b.nodeType){a=b;var g=b.length;c=u.length;b.insertData(0,u.data);u.parentNode.removeChild(u);a==d?(e+=c,d=a):d==b.parentNode&&(u=j.getNodeIndex(b),e==u?(d=b,e=g):e>u&&e--)}},v=!0;j.isCharacterDataNode(d)?d.length==e&&u(d):(0<e&&(v=d.childNodes[e-1])&&j.isCharacterDataNode(v)&&u(v),
v=!this.collapsed);v?j.isCharacterDataNode(a)?0==c&&g(a):c<a.childNodes.length&&(u=a.childNodes[c])&&j.isCharacterDataNode(u)&&g(u):(a=d,c=e);b(this,a,c,d,e)},collapseToPoint:function(a,c){i(this);g(a,!0);C(a,c);(a!==this.startContainer||c!==this.startOffset||a!==this.endContainer||c!==this.endOffset)&&b(this,a,c,a,c)}});E(c)}function N(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:j.getCommonAncestor(a.startContainer,
a.endContainer)}function P(a,c,b,d,e){var u=a.startContainer!==c||a.startOffset!==b,g=a.endContainer!==d||a.endOffset!==e;a.startContainer=c;a.startOffset=b;a.endContainer=d;a.endOffset=e;N(a);t(a,"boundarychange",{startMoved:u,endMoved:g})}function A(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};N(this)}d.requireModules(["DomUtil"]);var j=d.dom,J=j.DomPosition,D=d.DOMException;a.prototype={_current:null,_next:null,_first:null,
...
c){this._listeners[a].push(c)},compareBoundaryPoints:function(a,c){x(this);B(this.startContainer,c.startContainer);var b=a==W||a==R?"start":"end",d=a==V||a==R?"start":"end";return j.comparePoints(this[b+"Container"],this[b+"Offset"],c[d+"Container"],c[d+"Offset"])},insertNode:function(a){x(this);o(a,L);z(this.startContainer);if(j.isAncestorOf(a,this.startContainer,!0))throw new D("HIERARCHY_REQUEST_ERR");this.setStartBefore(f(a,this.startContainer,this.startOffset))},cloneContents:function(){x(this);
var c,b;if(this.collapsed)return k(this).createDocumentFragment();if(this.startContainer===this.endContainer&&j.isCharacterDataNode(this.startContainer))return c=this.startContainer.cloneNode(!0),c.data=c.data.slice(this.startOffset,this.endOffset),b=k(this).createDocumentFragment(),b.appendChild(c),b;b=new a(this,!0);c=w(b);b.detach();return c},canSurroundContents:function(){x(this);z(this.startContainer);z(this.endContainer);var c=new a(this,!0),b=c._first&&q(c._first,this)||c._last&&q(c._last,
this);c.detach();return!b},surroundContents:function(a){o(a,u);if(!this.canSurroundContents())throw new b("BAD_BOUNDARYPOINTS_ERR");var c=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);f(a,this.startContainer,this.startOffset);a.appendChild(c);this.selectNode(a)},cloneRange:function(){x(this);for(var a=new A(k(this)),c=U.length,b;c--;)b=U[c],a[b]=this[b];return a},toString:function(){x(this);var c=this.startContainer;if(c===this.endContainer&&j.isCharacterDataNode(c))return 3==
c.nodeType||4==c.nodeType?c.data.slice(this.startOffset,this.endOffset):"";var b=[],c=new a(this,!0);n(c,function(a){(3==a.nodeType||4==a.nodeType)&&b.push(a.data)});c.detach();return b.join("")},compareNode:function(a){x(this);var c=a.parentNode,b=j.getNodeIndex(a);if(!c)throw new D("NOT_FOUND_ERR");a=this.comparePoint(c,b);c=this.comparePoint(c,b+1);return 0>a?0<c?Z:X:0<c?Y:S},comparePoint:function(a,c){x(this);y(a,"HIERARCHY_REQUEST_ERR");B(a,this.startContainer);return 0>j.comparePoints(a,c,this.startContainer,
this.startOffset)?-1:0<j.comparePoints(a,c,this.endContainer,this.endOffset)?1:0},createContextualFragment:T?function(a){var c=this.startContainer,b=j.getDocument(c);if(!c)throw new D("INVALID_STATE_ERR");var d=null;1==c.nodeType?d=c:j.isCharacterDataNode(c)&&(d=j.parentElement(c));d=null===d||"HTML"==d.nodeName&&j.isHtmlNamespace(j.getDocument(d).documentElement)&&j.isHtmlNamespace(d)?b.createElement("body"):d.cloneNode(!1);d.innerHTML=a;return j.fragmentFromNodeChildren(d)}:function(a){i(this);
var c=k(this).createElement("body");c.innerHTML=a;return j.fragmentFromNodeChildren(c)},toHtml:function(){x(this);var a=k(this).createElement("div");a.appendChild(this.cloneContents());return a.innerHTML},intersectsNode:function(a,c){x(this);y(a,"NOT_FOUND_ERR");if(j.getDocument(a)!==k(this))return!1;var b=a.parentNode,d=j.getNodeIndex(a);y(b,"NOT_FOUND_ERR");var e=j.comparePoints(b,d,this.endContainer,this.endOffset),b=j.comparePoints(b,d+1,this.startContainer,this.startOffset);return c?0>=e&&0<=
b:0>e&&0<b},isPointInRange:function(a,c){x(this);y(a,"HIERARCHY_REQUEST_ERR");B(a,this.startContainer);return 0<=j.comparePoints(a,c,this.startContainer,this.startOffset)&&0>=j.comparePoints(a,c,this.endContainer,this.endOffset)},intersectsRange:function(a,c){x(this);if(k(a)!=k(this))throw new D("WRONG_DOCUMENT_ERR");var b=j.comparePoints(this.startContainer,this.startOffset,a.endContainer,a.endOffset),d=j.comparePoints(this.endContainer,this.endOffset,a.startContainer,a.startOffset);return c?0>=
...
this.cloneRange();c.selectNode(a);var b=c.getNodes([3]);return 0<b.length?(c.setStart(b[0],0),a=b.pop(),c.setEnd(a,a.length),a=this.containsRange(c),c.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){x(this);return new c(this,a,b)},getNodes:function(a,c){x(this);return m(this,a,c)},getDocument:function(){return k(this)},collapseBefore:function(a){i(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){i(this);this.setStartAfter(a);this.collapse(!0)},getName:function(){return"DomRange"},
equals:function(a){return A.rangesEqual(this,a)},isValid:function(){return F(this)},inspect:function(){return l(this)}};I(A,P,function(a){i(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;t(a,"detach",null);a._listeners=null});d.rangePrototype=H.prototype;A.rangeProperties=U;A.RangeIterator=a;A.copyComparisonConstants=E;A.createPrototypeRange=I;A.inspect=l;A.getRangeDocument=k;A.rangesEqual=function(a,c){return a.startContainer===c.startContainer&&
a.startOffset===c.startOffset&&a.endContainer===c.endContainer&&a.endOffset===c.endOffset};d.DomRange=A;d.RangeException=b});
rangy.createModule("WrappedRange",function(d){function q(d,f,h,m){var l=d.duplicate();l.collapse(h);var a=l.parentElement();r.isAncestorOf(f,a,!0)||(a=f);if(!a.canHaveHTML)return new s(a.parentNode,r.getNodeIndex(a));var f=r.getDocument(a).createElement("span"),b,c=h?"StartToStart":"StartToEnd";do a.insertBefore(f,f.previousSibling),l.moveToElementText(f);while(0<(b=l.compareEndPoints(c,d))&&f.previousSibling);c=f.nextSibling;if(-1==b&&c&&r.isCharacterDataNode(c)){l.setEndPoint(h?"EndToStart":"EndToEnd",
d);if(/[\r\n]/.test(c.data)){a=l.duplicate();h=a.text.replace(/\r\n/g,"\r").length;for(h=a.moveStart("character",h);-1==a.compareEndPoints("StartToEnd",a);)h++,a.moveStart("character",1)}else h=l.text.length;a=new s(c,h)}else c=(m||!h)&&f.previousSibling,a=(h=(m||h)&&f.nextSibling)&&r.isCharacterDataNode(h)?new s(h,0):c&&r.isCharacterDataNode(c)?new s(c,c.length):new s(a,r.getNodeIndex(f));f.parentNode.removeChild(f);return a}function k(d,f){var h,m,l=d.offset,a=r.getDocument(d.node),b=a.body.createTextRange(),
...
h.length,d;b--;)d=h[b],a[d]=a.nativeRange[d]}var p,h=f.rangeProperties,m;t=function(a){if(!a)throw Error("Range must be specified");this.nativeRange=a;n(this)};f.createPrototypeRange(t,function(a,b,d,i,n){var f=a.endContainer!==i||a.endOffset!=n;if(a.startContainer!==b||a.startOffset!=d||f)a.setEnd(i,n),a.setStart(b,d)},function(a){a.nativeRange.detach();a.detached=!0;for(var b=h.length,d;b--;)d=h[b],a[d]=null});p=t.prototype;p.selectNode=function(a){this.nativeRange.selectNode(a);n(this)};p.deleteContents=
...
(a=b.START_TO_END);return this.nativeRange.compareBoundaryPoints(a,b)}:function(a,b){return this.nativeRange.compareBoundaryPoints(a,b.nativeRange||b)};d.util.isHostMethod(a,"createContextualFragment")&&(p.createContextualFragment=function(a){return this.nativeRange.createContextualFragment(a)});r.getBody(document).removeChild(l);a.detach();m.detach()})(),d.createNativeRange=function(d){return(d||document).createRange()};else if(d.features.implementsTextRange){t=function(d){this.textRange=d;this.refresh()};
t.prototype=new f(document);t.prototype.refresh=function(){var d,f,h=this.textRange;d=h.parentElement();var m=h.duplicate();m.collapse(!0);f=m.parentElement();m=h.duplicate();m.collapse(!1);h=m.parentElement();f=f==h?f:r.getCommonAncestor(f,h);f=f==d?f:r.getCommonAncestor(d,f);0==this.textRange.compareEndPoints("StartToEnd",this.textRange)?f=d=q(this.textRange,f,!0,!0):(d=q(this.textRange,f,!0,!1),f=q(this.textRange,f,!1,!1));this.setStart(d.node,d.offset);this.setEnd(f.node,f.offset)};f.copyComparisonConstants(t);
var w=function(){return this}();"undefined"==typeof w.Range&&(w.Range=t);d.createNativeRange=function(d){return(d||document).body.createTextRange()}}d.features.implementsTextRange&&(t.rangeToTextRange=function(d){if(d.collapsed)return k(new s(d.startContainer,d.startOffset),!0);var f=k(new s(d.startContainer,d.startOffset),!0),h=k(new s(d.endContainer,d.endOffset),!1),d=r.getDocument(d.startContainer).body.createTextRange();d.setEndPoint("StartToStart",f);d.setEndPoint("EndToEnd",h);return d});t.prototype.getName=
...
(b=d.createNativeRange(c.getDocument(a.startContainer)),b.setEnd(a.endContainer,a.endOffset),b.setStart(a.startContainer,a.startOffset),a._selectionNativeRange=b,a.attachListener("detach",function(){this._selectionNativeRange=null}))):a instanceof i?b=a.nativeRange:d.features.implementsDomRange&&a instanceof c.getWindow(a.startContainer).Range&&(b=a);return b}function w(a){var b=a.getNodes(),d;a:if(!b.length||1!=b[0].nodeType)d=!1;else{d=1;for(var e=b.length;d<e;++d)if(!c.isAncestorOf(b[0],b[d])){d=
!1;break a}d=!0}if(!d)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function n(a,c){var b=new i(c);a._ranges=[b];r(a,b,!1);a.rangeCount=1;a.isCollapsed=b.collapsed}function p(a){a._ranges.length=0;if("None"==a.docSelection.type)s(a);else{var b=a.docSelection.createRange();if(b&&"undefined"!=typeof b.text)n(a,b);else{a.rangeCount=b.length;for(var e,g=c.getDocument(b.item(0)),v=0;v<a.rangeCount;++v)e=d.createRange(g),e.selectNode(b.item(v)),
a._ranges.push(e);a.isCollapsed=1==a.rangeCount&&a._ranges[0].collapsed;r(a,a._ranges[a.rangeCount-1],!1)}}}function h(a,b){for(var d=a.docSelection.createRange(),e=w(b),g=c.getDocument(d.item(0)),g=c.getBody(g).createControlRange(),v=0,i=d.length;v<i;++v)g.add(d.item(v));try{g.add(e)}catch(f){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}g.select();p(a)}function m(a,c,b){this.nativeSelection=a;this.docSelection=c;this._ranges=
[];this.win=b;this.refresh()}function l(a,b){for(var d=c.getDocument(b[0].startContainer),d=c.getBody(d).createControlRange(),e=0,g;e<rangeCount;++e){g=w(b[e]);try{d.add(g)}catch(v){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();p(a)}function a(a,b){if(a.anchorNode&&c.getDocument(a.anchorNode)!==c.getDocument(b))throw new o("WRONG_DOCUMENT_ERR");}function b(a){var c=[],b=new C(a.anchorNode,a.anchorOffset),
d=new C(a.focusNode,a.focusOffset),e="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var v=0,i=a.rangeCount;v<i;++v)c[v]=g.inspect(a.getRangeAt(v));return"["+e+"(Ranges: "+c.join(", ")+")(anchor: "+b.inspect()+", focus: "+d.inspect()+"]"}d.requireModules(["DomUtil","DomRange","WrappedRange"]);d.config.checkSelectionRanges=!0;var c=d.dom,e=d.util,g=d.DomRange,i=d.WrappedRange,o=d.DOMException,C=c.DomPosition,B,z,y=d.util.isHostMethod(window,"getSelection"),
F=d.util.isHostObject(document,"selection"),x=F&&(!y||d.config.preferTextRange);x?(B=t,d.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return"None"!=b.type||c.getDocument(b.createRange().parentElement())==a}):y?(B=k,d.isSelectionValid=function(){return!0}):q.fail("Neither document.selection or window.getSelection() detected.");d.getNativeSelection=B;var y=B(),H=d.createNativeRange(document),G=c.getBody(document),E=e.areHostObjects(y,e.areHostProperties(y,["anchorOffset","focusOffset"]));
d.features.selectionHasAnchorAndFocus=E;var v=e.isHostMethod(y,"extend");d.features.selectionHasExtend=v;var I="number"==typeof y.rangeCount;d.features.selectionHasRangeCount=I;var N=!1,P=!0;e.areHostMethods(y,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof y.rangeCount&&d.features.implementsDomRange&&function(){var a=document.createElement("iframe");a.frameBorder=0;a.style.position="absolute";a.style.left="-10000px";G.appendChild(a);var b=c.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");
...
b;d.Selection=m;d.selectionPrototype=j;d.addCreateMissingNativeApiListener(function(a){if(typeof a.getSelection=="undefined")a.getSelection=function(){return d.getSelection(this)};a=null})});
...
d=d?d.toString():"";c.detach();return""!=d}function n(a){return a.getNodes([3],function(b){return w(a,b)})}function p(a,b){if(a.attributes.length!=b.attributes.length)return!1;for(var c=0,d=a.attributes.length,e,g;c<d;++c)if(e=a.attributes[c],g=e.name,"class"!=g&&(g=b.attributes.getNamedItem(g),e.specified!=g.specified||e.specified&&e.nodeValue!==g.nodeValue))return!1;return!0}function h(a,b){for(var c=0,d=a.attributes.length,e;c<d;++c)if(e=a.attributes[c].name,(!b||!o.arrayContains(b,e))&&a.attributes[c].specified&&
...
a(b.nextSibling)}function c(a,b,d,e){var g,i=0==d;if(o.isAncestorOf(b,a))return a;if(o.isCharacterDataNode(b))if(0==d)d=o.getNodeIndex(b),b=b.parentNode;else if(d==b.length)d=o.getNodeIndex(b)+1,b=b.parentNode;else throw q.createError("splitNodeAt should not be called with offset in the middle of a data node ("+d+" in "+b.data);if(o.isCharacterDataNode(b)?0==d?b.previousSibling:d==b.length?b.nextSibling:1:0<d&&d<b.childNodes.length){if(!g){g=b.cloneNode(!1);for(g.id&&g.removeAttribute("id");i=b.childNodes[d];)g.appendChild(i);
o.insertAfter(g,b)}return b==a?g:c(a,g.parentNode,o.getNodeIndex(g),e)}return a!=b?(g=b.parentNode,b=o.getNodeIndex(b),i||b++,c(a,g,b,e)):a}function e(a){var b=a?"nextSibling":"previousSibling";return function(c,d){var e=c.parentNode,g=c[b];if(g){if(g&&3==g.nodeType)return g}else if(d&&(g=e[b])&&1==g.nodeType&&e.tagName==g.tagName&&s(e,g)&&p(e,g))return g[a?"firstChild":"lastChild"];return null}}function g(a){this.firstTextNode=(this.isElementMerge=1==a.nodeType)?a.lastChild:a;this.textNodes=[this.firstTextNode]}
function i(a,b,c){this.cssClass=a;var d,e,g=null;if("object"==typeof b&&null!==b){c=b.tagNames;g=b.elementProperties;for(d=0;e=G[d++];)b.hasOwnProperty(e)&&(this[e]=b[e]);d=b.normalize}else d=b;this.normalize="undefined"==typeof d?!0:d;this.attrExceptions=[];d=document.createElement(this.elementTagName);this.elementProperties={};for(var i in g)g.hasOwnProperty(i)&&(E.hasOwnProperty(i)&&(i=E[i]),d[i]=g[i],this.elementProperties[i]=d[i],this.attrExceptions.push(i));this.elementSortedClassName=this.elementProperties.hasOwnProperty("className")?
r(this.elementProperties.className+" "+a):a;this.applyToAnyTagName=!1;a=typeof c;if("string"==a)"*"==c?this.applyToAnyTagName=!0:this.tagNames=c.toLowerCase().replace(/^\s\s*/,"").replace(/\s\s*$/,"").split(/\s*,\s*/);else if("object"==a&&"number"==typeof c.length){this.tagNames=[];d=0;for(a=c.length;d<a;++d)"*"==c[d]?this.applyToAnyTagName=!0:this.tagNames.push(c[d].toLowerCase())}else this.tagNames=[this.elementTagName]}d.requireModules(["WrappedSelection","WrappedRange"]);var o=d.dom,C=function(){function a(b,
c,d){return c&&d?" ":""}return function(b,c){b.className&&(b.className=b.className.replace(RegExp("(?:^|\\s)"+c+"(?:\\s|$)"),a))}}(),B;"undefined"!=typeof window.getComputedStyle?B=function(a,b){return o.getWindow(a).getComputedStyle(a,null)[b]}:"undefined"!=typeof document.documentElement.currentStyle?B=function(a,b){return a.currentStyle[b]}:q.fail("No means of obtaining computed style properties found");var z;(function(){z="boolean"==typeof document.createElement("div").isContentEditable?function(a){return a&&
1==a.nodeType&&a.isContentEditable}:function(a){return!a||1!=a.nodeType||"false"==a.contentEditable?!1:"true"==a.contentEditable||z(a.parentNode)}})();var y=/^inline(-block|-table)?$/i,F=/[^\r\n\t\f \u200B]/,x=e(!1),H=e(!0);g.prototype={doMerge:function(){for(var a=[],b,c,d=0,e=this.textNodes.length;d<e;++d)b=this.textNodes[d],c=b.parentNode,a[d]=b.data,d&&(c.removeChild(b),c.hasChildNodes()||c.parentNode.removeChild(c));return this.firstTextNode.data=a=a.join("")},getLength:function(){for(var a=
this.textNodes.length,b=0;a--;)b+=this.textNodes[a].length;return b},toString:function(){for(var a=[],b=0,c=this.textNodes.length;b<c;++b)a[b]="'"+this.textNodes[b].data+"'";return"[Merge("+a.join(",")+")]"}};var G=["elementTagName","ignoreWhiteSpace","applyToEditableOnly"],E={"class":"className"};i.prototype={elementTagName:"span",elementProperties:{},ignoreWhiteSpace:!0,applyToEditableOnly:!1,hasClass:function(a){return 1==a.nodeType&&o.arrayContains(this.tagNames,a.tagName.toLowerCase())&&k(a,
this.cssClass)},getSelfOrAncestorWithClass:function(a){for(;a;){if(this.hasClass(a,this.cssClass))return a;a=a.parentNode}return null},isModifiable:function(a){return!this.applyToEditableOnly||l(a)},isIgnorableWhiteSpaceNode:function(a){return this.ignoreWhiteSpace&&a&&3==a.nodeType&&b(a)},postApply:function(a,b,c){for(var d=a[0],e=a[a.length-1],i=[],f,n=d,o=e,h=0,l=e.length,m,C,k=0,p=a.length;k<p;++k)if(m=a[k],C=x(m,!c)){if(f||(f=new g(C),i.push(f)),f.textNodes.push(m),m===d&&(n=f.firstTextNode,
h=n.length),m===e)o=f.firstTextNode,l=f.getLength()}else f=null;if(a=H(e,!c))f||(f=new g(e),i.push(f)),f.textNodes.push(a);if(i.length){k=0;for(p=i.length;k<p;++k)i[k].doMerge();b.setStart(n,h);b.setEnd(o,l)}},createContainer:function(a){a=a.createElement(this.elementTagName);d.util.extend(a,this.elementProperties);t(a,this.cssClass);return a},applyToTextNode:function(a){var b=a.parentNode;1==b.childNodes.length&&o.arrayContains(this.tagNames,b.tagName.toLowerCase())?t(b,this.cssClass):(b=this.createContainer(o.getDocument(a)),
a.parentNode.insertBefore(b,a),b.appendChild(a))},isRemovable:function(a){var b;if(b=a.tagName.toLowerCase()==this.elementTagName)if(b=r(a.className)==this.elementSortedClassName){var c;a:{b=this.elementProperties;for(c in b)if(b.hasOwnProperty(c)&&a[c]!==b[c]){c=!1;break a}c=!0}b=c&&!h(a,this.attrExceptions)&&this.isModifiable(a)}return b},undoToTextNode:function(a,b,d){b.containsNode(d)||(a=b.cloneRange(),a.selectNode(d),a.isPointInRange(b.endContainer,b.endOffset)&&(c(d,b.endContainer,b.endOffset,
...
d.getSelection(a||window),b,c=a.getAllRanges();a.removeAllRanges();for(var e=c.length;e--;)b=c[e],this.applyToRange(b),a.addRange(b)},undoToRange:function(a){a.splitBoundaries();var b=n(a),c,d,e=b[b.length-1];if(b.length){for(var g=0,i=b.length;g<i;++g)c=b[g],(d=this.getSelfOrAncestorWithClass(c))&&this.isModifiable(c)&&this.undoToTextNode(c,a,d),a.setStart(b[0],0),a.setEnd(e,e.length);this.normalize&&this.postApply(b,a,!0)}},undoToSelection:function(a){var a=d.getSelection(a||window),b=a.getAllRanges(),
c;a.removeAllRanges();for(var e=0,g=b.length;e<g;++e)c=b[e],this.undoToRange(c),a.addRange(c)},getTextSelectedByRange:function(a,b){var c=b.cloneRange();c.selectNodeContents(a);var d=c.intersection(b),d=d?d.toString():"";c.detach();return d},isAppliedToRange:function(a){if(a.collapsed)return!!this.getSelfOrAncestorWithClass(a.commonAncestorContainer);for(var b=a.getNodes([3]),c=0,d;d=b[c++];)if(!this.isIgnorableWhiteSpaceNode(d)&&w(a,d)&&this.isModifiable(d)&&!this.getSelfOrAncestorWithClass(d))return!1;
return!0},isAppliedToSelection:function(a){for(var a=d.getSelection(a||window).getAllRanges(),b=a.length;b--;)if(!this.isAppliedToRange(a[b]))return!1;return!0},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)},toggleSelection:function(a){this.isAppliedToSelection(a)?this.undoToSelection(a):this.applyToSelection(a)},detach:function(){}};i.util={hasClass:k,addClass:t,removeClass:C,hasSameClasses:s,replaceWithOwnChildren:f,elementsHaveSameNonClassAttributes:p,
elementHasNonClassAttributes:h,splitNodeAt:c,isEditableElement:z,isEditingHost:m,isEditable:l};d.CssClassApplier=i;d.createCssClassApplier=function(a,b,c){return new i(a,b,c)}});
...
!1),l.push({markerId:b.id,collapsed:!0})):(b=k(a,!1),a=k(a,!0),l[c]={startMarkerId:a.id,endMarkerId:b.id,collapsed:!1,backwards:1==m.length&&h.isBackwards()});for(c=e-1;0<=c;--c)a=m[c],a.collapsed?a.collapseBefore((p||document).getElementById(l[c].markerId)):(a.setEndBefore((p||document).getElementById(l[c].endMarkerId)),a.setStartAfter((p||document).getElementById(l[c].startMarkerId)));h.setRanges(m);return{win:f,doc:p,rangeInfos:l,restored:!1}}q.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
d.restoreSelection=function(f,k){if(!f.restored){for(var h=f.rangeInfos,m=d.getSelection(f.win),l=[],a=h.length,b=a-1,c,e;0<=b;--b){c=h[b];e=d.createRange(f.doc);if(c.collapsed)if(c=(f.doc||document).getElementById(c.markerId)){c.style.display="inline";var g=c.previousSibling;g&&3==g.nodeType?(c.parentNode.removeChild(c),e.collapseToPoint(g,g.length)):(e.collapseBefore(c),c.parentNode.removeChild(c))}else q.warn("Marker element has been removed. Cannot restore selection.");else t(f.doc,e,c.startMarkerId,
!0),t(f.doc,e,c.endMarkerId,!1);1==a&&e.normalizeBoundaries();l[b]=e}1==a&&k&&d.features.selectionHasExtend&&h[0].backwards?(m.removeAllRanges(),m.addRange(l[0],!0)):m.setRanges(l);f.restored=!0}};d.removeMarkerElement=s;d.removeMarkers=function(d){for(var f=d.rangeInfos,h=0,k=f.length,l;h<k;++h)l=f[h],l.collapsed?s(d.doc,l.markerId):(s(d.doc,l.startMarkerId),s(d.doc,l.endMarkerId))}});
...
var f=d("#elRaptor").css({position:"fixed",bottom:"-700px",right:"0",display:"block"});if("timer"==q.enterOn)setTimeout(k,q.delayTime);else if("click"==q.enterOn)t.bind("click",function(d){d.preventDefault();s||k()});else if("konami-code"==q.enterOn){var w=[];d(window).bind("keydown.raptorz",function(f){w.push(f.keyCode);0<=w.toString().indexOf("38,38,40,40,37,39,37,39,66,65")&&(k(),d(window).unbind("keydown.raptorz"))},!0)}})}})(jQuery);
(function(d,q,k,t){function r(a,b,c){p[a]=c;h[a]=b;n||(n=a)}function s(a){n!==a&&(n=a,d.ui.editor.eachInstance(function(){this.reinit()}))}function f(a,b){n&&p[n]&&p[n][a]&&(a=p[n][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function w(a){if(m===t){if(l=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))d("html").addClass(a.options.baseClass+"-ios"),l&&d(document).bind("scroll",function(){setInterval(function(){d("body").css("height","+=1").css("height","-=1")},
0)});d.browser.mozilla&&d("html").addClass(a.options.baseClass+"-ff");if(d.browser.msie){m=!1;var b=d("<div></div>").addClass(a.options.baseClass+"-unsupported").html(a.getTemplate("unsupported")).appendTo("body"),c=1;b.siblings().each(function(){var a=d(this).css("z-index");!isNaN(a)&&a>c&&(c=a+1)});b.css("z-index",c);b.find("."+a.options.baseClass+"-unsupported-close").click(function(){b.remove()})}else m=!0}return m}var n=null,p={},h={};d(function(){k.initialized||k.init();d.isFunction(k.rangePrototype.insertNodeAtEnd)||
(k.rangePrototype.insertNodeAtEnd=function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});d("html").click(function(a){var b=d(a.target).parents(".ui-editor-selectmenu");d(".ui-editor-selectmenu-menu").each(function(){d(this).parent()[0]!==b[0]&&d(this).closest(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")})});d.widget("ui.editor",{_init:function(){-1===d.inArray(this,d.ui.editor.instances)&&d.ui.editor.instances.push(this);
var a=this;d.ui.editor.eachInstance(function(b){a!=b&&a.element.closest(b.element).length&&handleError("Nesting editors is unsupported",a.element,b.element)});this.options=d.extend({},d.ui.editor.defaults,this.options);this.options.uiOrder=this.options.uiOrder||[["logo"],["save","cancel"],["dock","showGuides","clean"],["viewSource"],["undo","redo"],["alignLeft","alignCenter","alignJustify","alignRight"],["textBold","textItalic","textUnderline","textStrike"],["textSuper","textSub"],["listUnordered",
"listOrdered"],["hr","quoteBlock"],["fontSizeInc","fontSizeDec"],["link","unlink"],["embed"],["floatLeft","floatNone","floatRight"],["tagMenu"],["i18n"],["raptorize"],["length"],["debugReinit","debugDestroy"]];this.element.attr("id")||this.element.attr("id",this.getUniqueId());this.ready=!1;this.events={};this.ui={};this.plugins={};this.templates=d.extend({},d.ui.editor.templates);this.path=this.toolbarWrapper=this.toolbar=this.wrapper=null;this.visible=this.enabled=!1;this.uiObjects={};for(var b in this.options.bind)this.bind(b,
this.options.bind[b]);this.history=[];this.present=0;this.historyEnabled=!0;w(this)&&(this.cloneDomTools(),this.setOriginalHtml(this.element.is(":input")?this.element.val():this.element.html()),this.options.replace&&(this.replaceOriginal(),this.options.replace=!1),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,this.ready=!0,this.fire("ready"),this.options.autoEnable&&d(function(){a.enableEditing();a.showToolbar()}))},attach:function(){this.bind("change",
...
this.select.val()+"]").html();this.button.find(".ui-selectmenu-text").html(a)},val:function(){var a=this.select.val.apply(this.select,arguments);this.update();return a},change:function(){}},a)},getPlugin:function(a){return this.plugins[a]},loadPlugins:function(){this.options.plugins||(this.options.plugins={});for(var a in d.ui.editor.plugins)if(!(!1===this.options.enablePlugins&&"undefined"===typeof this.options.plugins[a]||!1===this.options.plugins[a])&&-1===d.inArray(a,this.options.disabledPlugins)){var b=
...
this.events;d.each(a.split(","),function(a,f){f=d.trim(f);e[f]||(e[f]=[]);e[f].push({context:c,callback:b})})},unbind:function(a,b,c){for(var d=0,g=this.events[a].length;d<g;d++)this.events[a][d]&&this.events[a][d].callback===b&&this.events[a][d].context===c&&this.events[a].splice(d,1)},fire:function(a,b,c){c||this.fire("before:"+a,b,!0);if(this.events[a])for(var e=0,g=this.events[a].length;e<g;e++){var f=this.events[a][e];f.callback.call(f.context||this)}!1!==b&&d.ui.editor.fire(a);c||this.fire("after:"+
a,b,!0)}});d.extend(d.ui.editor,{defaults:{plugins:{},ui:{},bind:{},domTools:{savedSelection:!1,saveSelection:function(){this.savedSelection=k.saveSelection()},restoreSelection:function(){this.savedSelection&&(k.restoreSelection(this.savedSelection),this.savedSelection=!1)},eachRange:function(a,b,c){for(var b=b||k.getSelection(),c=c||this,d,g=0;d=b.getAllRanges()[g++];)a.call(c,d)},constrainSelection:function(a,b){var a=d(a)[0],b=b||k.getSelection(),c;d(b.getAllRanges()).each(function(e,g){c=3===
this.commonAncestorContainer.nodeType?d(g.commonAncestorContainer).parent()[0]:g.commonAncestorContainer;a!==c&&!d.contains(a,c)&&b.removeRange(g)})},getSelectedElements:function(){var a=new jQuery;this.eachRange(function(b){a.push(this.getSelectedElement(b)[0])});return a},getSelectedElement:function(a){return d(3===a.commonAncestorContainer.nodeType?a.commonAncestorContainer.parentNode:a.commonAncestorContainer)},unwrapParentTag:function(a){this.getSelectedElements().each(function(){d(this).is(a)&&
...
change:function(){this.editor.present===this.editor.history.length-1?this.ui.disable():this.ui.enable()}}});d.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:f("Insert Horizontal Rule"),click:function(){a.replaceSelection("<hr/>")}})}}});d.ui.editor.registerUi({i18n:{init:function(a){var b=this,c=this.persist("locale");c&&s(c);var c=d('<select autocomplete="off" name="i18n"/>'),e;for(e in p){var g=d('<option value="'+e+'" class="'+e+'"/>');g.html(h[e]);n===e&&g.attr("selected",
"selected");c.append(g)}return a.uiSelectMenu({title:f("Change Language"),select:c,change:function(a){s(b.persist("locale",a))}})}}});r("en","English",{});r("zh_CN","\u7b80\u4f53\u4e2d\u6587",{"Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"\u5e94\u7528\u6e90\u4ee3\u7801","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",Blockquote:"\u5927\u6bb5\u5f15\u7528",Bold:"\u7c97\u4f53",Cancel:"\u53d6\u6d88",
...
cancel:function(){this.removeClasses();this.editor.unbind("change",this.scanImages,this);var a=this;this.editor.getElement().find("img").each(function(){this.removeEventListener&&this.addEventListener("DOMAttrModified",a.resized,!1);this.detachEvent&&this.detachEvent("onpropertychange",a.resized)})},destroy:function(){this.cancel()},save:function(){this.removeClasses(this.options.resizingClass);this.options.resizeAjax&&this.resizeImagesAjax()},resizeImagesAjax:function(){var a=this,b=[];d("."+this.options.resizeAjaxClass).each(function(){d(this).attr("id")||
d(this).attr("id",a.editor.getUniqueId());b.push({id:d(this).attr("id"),src:this.src,width:d(this).width(),height:d(this).height()})});if(b.length){var c=this.editor.showLoading(f("Resizing image(s)")),e=this.options.ajax;e.data={images:b};e.async=!1;d.ajax(e).done(function(e){d(e).each(function(){d("#"+this.id).attr("src",this.src).removeAttr("id")});a.editor.fire("change");c.hide();a.editor.showConfirm(f("{{images}} image(s) have been replaced with resized versions",{images:b.length}))}).fail(function(b){c.hide();
a.editor.showError(f("Failed to resize images (error {{error}})",{error:b.status}))}).always(function(){a.removeClasses([a.options.resizeAjaxClass])})}},showOversizeWarning:function(a,b){this.options.resizeAjax?this.editor.showInfo(f('The image "{{image}}" is too large for the element being edited.<br/>It will be replaced with a resized copy when your edits are saved.',{image:a}),b):this.editor.showInfo(f('The image "{{image}}" is too large for the element being edited.<br/>It has been resized with CSS.',
...
label:f("Initializing"),text:!0,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var a=this.options.length-d("<div></div>").html(this.editor.getCleanHtml()).text().length,b=this.ui.button,c=null,c=0<=a?f("{{charactersRemaining}} characters remaining",{charactersRemaining:a}):f("{{charactersRemaining}} characters over limit",{charactersRemaining:-1*a});b.button("option","label",c);b.button("option","text",!0);0>a?b.addClass("ui-state-error"):0<=a&&15>=a?b.addClass("ui-state-highlight").removeClass("ui-state-error"):
b.removeClass("ui-state-highlight ui-state-error")},showStatistics:function(){this.processTemplate().dialog({modal:!0,resizable:!1,title:f("Content Statistics"),dialogClass:this.editor.options.dialogClass+" "+this.editor.options.baseClass,show:this.editor.options.dialogShowAnimation,hide:this.editor.options.dialogHideAnimation,buttons:[{text:f("OK"),click:function(){d(this).dialog("close")}}],open:function(){d(this).parent().find(".ui-dialog-buttonpane").find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}})},
close:function(){d(this).dialog("destroy").remove()}})},processTemplate:function(){var a=d("<div></div>").html(this.editor.getCleanHtml()).text(),b=null,c=this.options.length-a.length,b=0>c?f("Content contains more than {{limit}} characters and may be truncated",{limit:this.options.length}):f("Content will not be truncated"),e=null,e=a.split(" ").length,e=1==e?f("{{words}} word",{words:e}):f("{{words}} words",{words:e}),g=null,g=a.split(". ").length,g=f("{{sentences}} sentences",{sentences:g}),i=
null,i=0<=c?f("{{characters}} characters, {{charactersRemaining}} remaining",{characters:a.length,charactersRemaining:c}):f("{{characters}} characters, {{charactersRemaining}} over the recommended limit",{characters:a.length,charactersRemaining:-1*c});return d(this.editor.getTemplate("length.dialog",{characters:i,words:e,sentences:g,truncation:b}))}}});d.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:f("Page on this or another website"),
...
a.find('input[name="blank"]').is(":checked")&&(b.target="_blank");this.options.regexLink.test(b.href)||this.plugin.editor.showWarning(f("The url for the link you inserted doesn't look well formed"));return b},validate:function(a){var b="."+this.options.baseClass+"-error-message-url",c=!0;this.options.regexLink.test(a.find('input[name="location"]').val())?a.find(b).has(":visible").hide():(a.find(b).size()||a.find('input[name="location"]').after(this.plugin.editor.getTemplate("link.error",d.extend({},
...
change:function(b){a.tagSelection(b)}})},change:function(){var a=this.editor.getSelectedElements()[0];a&&(a=a.tagName.toLowerCase(),this.ui.selectMenu.find("option[value="+a+"]").length?this.ui.val(a):this.ui.val("na"))}}});(function(){var a=null,b=0;d.ui.editor.registerPlugin("unsavedEditWarning",{options:{},init:function(c){a||(a=d(c.getTemplate("unsavededitwarning.warning",this.options)).attr("id",c.getUniqueId()).appendTo("body"));var e=this;c.bind("dirty",function(){b++;0<b&&a.addClass(e.options.baseClass+
"-visible")});c.bind("cleaned",function(){b--;0===b&&a.removeClass(e.options.baseClass+"-visible")})},show:function(){},hide:function(){},reposition:function(){}})})();d.ui.editor.registerUi({viewSource:{dialog:null,init:function(a){a.bind("hide",this.hide,this);return a.uiButton({title:f("View / Edit Source"),click:function(){this.show()}})},tab:function(){return"    "},highlightSource:function(){return"undefined"!==typeof q.Rainbow},untidyHtml:function(a){a=d("<div/>").html(a);d(a).find("span.support").each(function(){d(this).contents().unwrap()});
a=a.html();a=a.replace(/&lt;/g,"<");a=a.replace(/&gt;/g,">");return a=a.replace(/&amp;/g,"&")},tidyHtml:function(a){if("undefined"===typeof HTMLParser)return a;var b=0,c="",d=this;HTMLParser(a,{start:function(a,f,h){for(var k=0;k<b;k++)c+=d.tab();c+="<"+a;for(k=0;k<f.length;k++)c+=" "+f[k].name+'="'+f[k].escaped+'"';c+=(h?"/":"")+">";b++},end:function(a){c+="</"+a+">";b--},chars:function(a){c+=a},comment:function(a){c+="<\!--"+a+"--\>"}});return c},prepareSource:function(a){if(this.highlightSource()){var b=
this.tidyHtml(d.trim(this.editor.getHtml())),a=d(a).find("."+this.options.baseClass+"-highlighted"),c=function(a,b,f){var a=d(a),h=a.find("code:first");h.unbind("keydown keyup");h.attr("contenteditable",!0);Rainbow.color(b,"html",function(b){h.html(b);a.show();var g=function(){var a=k.getSelection();return a.rangeCount?a.getRangeAt(0):null},l="";h.bind("keydown",function(a){l=h.html();switch(a.keyCode){case 13:var b=g(),c=!1,d=document.createTextNode("\r\n");b&&(b.insertNode(d),b.setEndAfter(d),b.setStartAfter(d),
c=k.getSelection(),c.setSingleRange(b),c=!0);c&&a.preventDefault();return!1;case 9:return b=g(),a=document.createTextNode(f.tab()),b&&(b.insertNode(a),c=k.getSelection(),b.setEndAfter(a),b.setStartAfter(a),c.setSingleRange(b)),!1}});var m=!1;h.bind("keydown",function(){m=!0});h.bind("keyup",function(){m=!1;q.setTimeout(function(){if(!m){if(l==h.html())return!0;try{var b=f.untidyHtml(h.html());d("<div/>").html(b).html()==b&&c(a,b,f)}catch(g){console.log("error")}}},5E3)})})};c(a,b,this)}else d(a).find("textarea").val(d.trim(this.editor.getHtml())),
d(a).find("."+this.options.baseClass+"-plain-text").show()},hide:function(){this.dialog&&d(this.dialog).dialog("destroy").remove();this.dialog=null;d(this.ui.button).button("option","disabled",!1)},show:function(){if(!this.dialog){d(this.ui.button).button("option","disabled",!0);var a=this;this.dialog=d(this.editor.getTemplate("viewsource.dialog",{baseClass:a.options.baseClass}));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:f("View Source"),autoOpen:!0,dialogClass:a.options.baseClass+
" "+a.options.dialogClass,buttons:[{text:f("Apply Source"),click:function(){var b;a.highlightSource()?(b=d(this).find("."+a.options.baseClass+"-highlighted pre code:first").html(),b=a.untidyHtml(b)):b=d(this).find("textarea").val();a.editor.setHtml(b)}},{text:f("Close"),click:function(){a.hide()}}],open:function(){var b=d(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});
