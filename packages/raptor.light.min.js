/*! VERSION: 0.0.1 *//*
 ...
 Build date: 26 February 2012
*/
window.rangy=function(){function d(a,c){var b=typeof a[c];return b==o||!!(b==m&&a[c])||b=="unknown"}function q(a,c){return!!(typeof a[c]==m&&a[c])}function n(a,c){return typeof a[c]!=h}function t(a){return function(c,b){for(var d=b.length;d--;)if(!a(c,b[d]))return false;return true}}function r(d){return d&&c(d,b)&&g(d,a)}function s(a){window.alert("Rangy not supported in your browser. Reason: "+a);i.initialized=true;i.supported=false}function f(){if(!i.initialized){var a,b=false,e=false;d(document,
"createRange")&&(a=document.createRange(),c(a,k)&&g(a,l)&&(b=true),a.detach());if((a=q(document,"body")?document.body:document.getElementsByTagName("body")[0])&&d(a,"createTextRange"))a=a.createTextRange(),r(a)&&(e=true);!b&&!e&&s("Neither Range nor TextRange are implemented");i.initialized=true;i.features={implementsDomRange:b,implementsTextRange:e};b=C.concat(p);e=0;for(a=b.length;e<a;++e)try{b[e](i)}catch(m){q(window,"console")&&d(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
m)}}}function w(a){this.name=a;this.supported=this.initialized=false}var m="object",o="function",h="undefined",l="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer,START_TO_START,START_TO_END,END_TO_START,END_TO_END".split(","),k="setStart,setStartBefore,setStartAfter,setEnd,setEndBefore,setEndAfter,collapse,selectNode,selectNodeContents,compareBoundaryPoints,deleteContents,extractContents,cloneContents,insertNode,surroundContents,cloneRange,toString,detach".split(","),
a="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),b="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),c=t(d),e=t(q),g=t(n),i={version:"1.2.3",initialized:false,supported:true,util:{isHostMethod:d,isHostObject:q,isHostProperty:n,areHostMethods:c,areHostObjects:e,areHostProperties:g,isTextRange:r},features:{},modules:{},config:{alertOnWarn:false,preferTextRange:false}};
i.fail=s;i.warn=function(a){a="Rangy warning: "+a;i.config.alertOnWarn?window.alert(a):typeof window.console!=h&&typeof window.console.log!=h&&window.console.log(a)};({}).hasOwnProperty?i.util.extend=function(a,c){for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b])}:s("hasOwnProperty not supported");var p=[],C=[];i.init=f;i.addInitListener=function(a){i.initialized?a(i):p.push(a)};var B=[];i.addCreateMissingNativeApiListener=function(a){B.push(a)};i.createMissingNativeApi=function(a){a=a||window;f();
for(var c=0,b=B.length;c<b;++c)B[c](a)};w.prototype.fail=function(a){this.initialized=true;this.supported=false;throw Error("Module '"+this.name+"' failed to load: "+a);};w.prototype.warn=function(a){i.warn("Module "+this.name+": "+a)};w.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};i.createModule=function(a,c){var b=new w(a);i.modules[a]=b;C.push(function(a){c(a,b);b.initialized=true;b.supported=true})};i.requireModules=function(a){for(var c=0,b=a.length,
d,e;c<b;++c){e=a[c];d=i.modules[e];if(!d||!(d instanceof w))throw Error("Module '"+e+"' not found");if(!d.supported)throw Error("Module '"+e+"' not supported");}};var z=false,e=function(){z||(z=true,i.initialized||f())};if(typeof window==h)s("No window found");else if(typeof document==h)s("No document found");else return d(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",e,false),d(window,"addEventListener")?window.addEventListener("load",e,false):d(window,"attachEvent")?
window.attachEvent("onload",e):s("Window does not have required addEventListener or attachEvent method"),i}();
rangy.createModule("DomUtil",function(d,q){function n(a){for(var c=0;a=a.previousSibling;)c++;return c}function t(a,b){var d=[],m;for(m=a;m;m=m.parentNode)d.push(m);for(m=b;m;m=m.parentNode)if(c(d,m))return m;return null}function r(a,c,b){for(b=b?a:a.parentNode;b;){a=b.parentNode;if(a===c)return b;b=a}return null}function s(a){a=a.nodeType;return a==3||a==4||a==8}function f(a,c){var b=c.nextSibling,d=c.parentNode;b?d.insertBefore(a,b):d.appendChild(a);return a}function w(a){if(a.nodeType==9)return a;
else if(typeof a.ownerDocument!=k)return a.ownerDocument;else if(typeof a.document!=k)return a.document;else if(a.parentNode)return w(a.parentNode);else throw Error("getDocument: no document found for node");}function m(a){return!a?"[No node]":s(a)?'"'+a.data+'"':a.nodeType==1?"<"+a.nodeName+(a.id?' id="'+a.id+'"':"")+">["+a.childNodes.length+"]":a.nodeName}function o(a){this._next=this.root=a}function h(a,c){this.node=a;this.offset=c}function l(a){this.code=this[a];this.codeName=a;this.message="DOMException: "+
this.codeName}var k="undefined",a=d.util;a.areHostMethods(document,["createDocumentFragment","createElement","createTextNode"])||q.fail("document missing a Node creation method");a.isHostMethod(document,"getElementsByTagName")||q.fail("document missing getElementsByTagName method");var b=document.createElement("div");a.areHostMethods(b,["insertBefore","appendChild","cloneNode"])||q.fail("Incomplete Element implementation");a.isHostProperty(b,"innerHTML")||q.fail("Element is missing innerHTML property");
b=document.createTextNode("test");a.areHostMethods(b,["splitText","deleteData","insertData","appendData","cloneNode"])||q.fail("Incomplete Text Node implementation");var c=function(a,c){for(var b=a.length;b--;)if(a[b]===c)return true;return false};o.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){var a=this._current=this._next,c;if(this._current){c=a.firstChild;if(!c)for(c=null;a!==this.root&&!(c=a.nextSibling);)a=a.parentNode;this._next=c}return this._current},detach:function(){this._current=
this._next=this.root=null}};h.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+m(this.node)+":"+this.offset+")]"}};l.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};l.prototype.toString=function(){return this.message};d.dom={arrayContains:c,isHtmlNamespace:function(a){var c;return typeof a.namespaceURI==k||(c=a.namespaceURI)===
null||c=="http://www.w3.org/1999/xhtml"},parentElement:function(a){a=a.parentNode;return a.nodeType==1?a:null},getNodeIndex:n,getNodeLength:function(a){var c;return s(a)?a.length:(c=a.childNodes)?c.length:0},getCommonAncestor:t,isAncestorOf:function(a,c,b){for(c=b?c:c.parentNode;c;)if(c===a)return true;else c=c.parentNode;return false},getClosestAncestorIn:r,isCharacterDataNode:s,insertAfter:f,splitDataNode:function(a,c){var b=a.cloneNode(false);b.deleteData(0,c);a.deleteData(c,a.length-c);f(b,a);
return b},getDocument:w,getWindow:function(a){a=w(a);if(typeof a.defaultView!=k)return a.defaultView;else if(typeof a.parentWindow!=k)return a.parentWindow;else throw Error("Cannot get a window object for node");},getIframeWindow:function(a){if(typeof a.contentWindow!=k)return a.contentWindow;else if(typeof a.contentDocument!=k)return a.contentDocument.defaultView;else throw Error("getIframeWindow: No Window object found for iframe element");},getIframeDocument:function(a){if(typeof a.contentDocument!=
k)return a.contentDocument;else if(typeof a.contentWindow!=k)return a.contentWindow.document;else throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(c){return a.isHostObject(c,"body")?c.body:c.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var c;c=a.parentNode;)a=c;return a},comparePoints:function(a,c,b,d){var m;if(a==b)return c===d?0:c<d?-1:1;else if(m=r(b,a,true))return c<=n(m)?-1:1;else if(m=r(a,b,true))return n(m)<d?-1:1;else if(c=
t(a,b),a=a===c?c:r(a,c,true),b=b===c?c:r(b,c,true),a===b)throw Error("comparePoints got to case 4 and childA and childB are the same!");else{for(c=c.firstChild;c;){if(c===a)return-1;else if(c===b)return 1;c=c.nextSibling}throw Error("Should not be here!");}},inspectNode:m,fragmentFromNodeChildren:function(a){for(var c=w(a).createDocumentFragment(),b;b=a.firstChild;)c.appendChild(b);return c},createIterator:function(a){return new o(a)},DomPosition:h};d.DOMException=l});
rangy.createModule("DomRange",function(d){function q(a,c){return a.nodeType!=3&&(j.isAncestorOf(a,c.startContainer,true)||j.isAncestorOf(a,c.endContainer,true))}function n(a){return j.getDocument(a.startContainer)}function t(a,c,b){if(c=a._listeners[c])for(var d=0,e=c.length;d<e;++d)c[d].call(a,{target:a,args:b})}function r(a){return new J(a.parentNode,j.getNodeIndex(a))}function s(a){return new J(a.parentNode,j.getNodeIndex(a)+1)}function f(a,c,b){var d=a.nodeType==11?a.firstChild:a;j.isCharacterDataNode(c)?
b==c.length?j.insertAfter(a,c):c.parentNode.insertBefore(a,b==0?c:j.splitDataNode(c,b)):b>=c.childNodes.length?c.appendChild(a):c.insertBefore(a,c.childNodes[b]);return d}function w(a){for(var c,b,d=n(a.range).createDocumentFragment();b=a.next();){c=a.isPartiallySelectedSubtree();b=b.cloneNode(!c);c&&(c=a.getSubtreeIterator(),b.appendChild(w(c)),c.detach(true));if(b.nodeType==10)throw new D("HIERARCHY_REQUEST_ERR");d.appendChild(b)}return d}function m(a,c,b){for(var d,e,b=b||{stop:false};d=a.next();)if(a.isPartiallySelectedSubtree())if(c(d)===
false){b.stop=true;break}else{if(d=a.getSubtreeIterator(),m(d,c,b),d.detach(true),b.stop)break}else for(d=j.createIterator(d);e=d.next();)if(c(e)===false){b.stop=true;return}}function o(a){for(var c;a.next();)a.isPartiallySelectedSubtree()?(c=a.getSubtreeIterator(),o(c),c.detach(true)):a.remove()}function h(a){for(var c,b=n(a.range).createDocumentFragment(),d;c=a.next();){a.isPartiallySelectedSubtree()?(c=c.cloneNode(false),d=a.getSubtreeIterator(),c.appendChild(h(d)),d.detach(true)):a.remove();if(c.nodeType==
10)throw new D("HIERARCHY_REQUEST_ERR");b.appendChild(c)}return b}function l(c,b,d){var e=!(!b||!b.length),u,g=!!d;e&&(u=RegExp("^("+b.join("|")+")$"));var v=[];m(new a(c,false),function(a){(!e||u.test(a.nodeType))&&(!g||d(a))&&v.push(a)});return v}function k(a){return"["+(typeof a.getName=="undefined"?"Range":a.getName())+"("+j.inspectNode(a.startContainer)+":"+a.startOffset+", "+j.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function a(a,c){this.range=a;this.clonePartiallySelectedTextNodes=
c;if(!a.collapsed){this.sc=a.startContainer;this.so=a.startOffset;this.ec=a.endContainer;this.eo=a.endOffset;var b=a.commonAncestorContainer;this.sc===this.ec&&j.isCharacterDataNode(this.sc)?(this.isSingleCharacterDataNode=true,this._first=this._last=this._next=this.sc):(this._first=this._next=this.sc===b&&!j.isCharacterDataNode(this.sc)?this.sc.childNodes[this.so]:j.getClosestAncestorIn(this.sc,b,true),this._last=this.ec===b&&!j.isCharacterDataNode(this.ec)?this.ec.childNodes[this.eo-1]:j.getClosestAncestorIn(this.ec,
b,true))}}function b(a){this.code=this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function c(a,c,b){this.nodes=l(a,c,b);this._next=this.nodes[0];this._position=0}function e(a){return function(c,b){for(var d,e=b?c:c.parentNode;e;){d=e.nodeType;if(j.arrayContains(a,d))return e;e=e.parentNode}return null}}function g(a,c){if(aa(a,c))throw new b("INVALID_NODE_TYPE_ERR");}function i(a){if(!a.startContainer)throw new D("INVALID_STATE_ERR");}function p(a,c){if(!j.arrayContains(c,a.nodeType))throw new b("INVALID_NODE_TYPE_ERR");
}function C(a,c){if(c<0||c>(j.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new D("INDEX_SIZE_ERR");}function B(a,c){if(Q(a,true)!==Q(c,true))throw new D("WRONG_DOCUMENT_ERR");}function z(a){if(ba(a,true))throw new D("NO_MODIFICATION_ALLOWED_ERR");}function y(a,c){if(!a)throw new D(c);}function F(a){return!!a.startContainer&&!!a.endContainer&&!(!j.arrayContains(M,a.startContainer.nodeType)&&!Q(a.startContainer,true))&&!(!j.arrayContains(M,a.endContainer.nodeType)&&!Q(a.endContainer,true))&&
a.startOffset<=(j.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(j.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function x(a){i(a);if(!F(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function H(){}function G(a){a.START_TO_START=R;a.START_TO_END=V;a.END_TO_END=ca;a.END_TO_START=W;a.NODE_BEFORE=X;a.NODE_AFTER=Y;a.NODE_BEFORE_AND_AFTER=Z;a.NODE_INSIDE=
S}function E(a){G(a);G(a.prototype)}function v(c,b){return function(){x(this);var d=this.startContainer,e=this.startOffset,u=this.commonAncestorContainer,g=new a(this,true);if(d!==u)d=j.getClosestAncestorIn(d,u,true),e=s(d),d=e.node,e=e.offset;m(g,z);g.reset();u=c(g);g.detach();b(this,d,e,d,e);return u}}function I(c,b,e){function u(a,c){return function(b){i(this);p(b,K);p(O(b),M);b=(a?r:s)(b);(c?m:I)(this,b.node,b.offset)}}function m(a,c,d){var e=a.endContainer,u=a.endOffset;if(c!==a.startContainer||
d!==a.startOffset){if(O(c)!=O(e)||j.comparePoints(c,d,e,u)==1)e=c,u=d;b(a,c,d,e,u)}}function I(a,c,d){var e=a.startContainer,u=a.startOffset;if(c!==a.endContainer||d!==a.endOffset){if(O(c)!=O(e)||j.comparePoints(c,d,e,u)==-1)e=c,u=d;b(a,e,u,c,d)}}c.prototype=new H;d.util.extend(c.prototype,{setStart:function(a,c){i(this);g(a,true);C(a,c);m(this,a,c)},setEnd:function(a,c){i(this);g(a,true);C(a,c);I(this,a,c)},setStartBefore:u(true,true),setStartAfter:u(false,true),setEndBefore:u(true,false),setEndAfter:u(false,
false),collapse:function(a){x(this);a?b(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):b(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){i(this);g(a,true);b(this,a,0,a,j.getNodeLength(a))},selectNode:function(a){i(this);g(a,false);p(a,K);var c=r(a),a=s(a);b(this,c.node,c.offset,a.node,a.offset)},extractContents:v(h,b),deleteContents:v(o,b),canSurroundContents:function(){x(this);z(this.startContainer);z(this.endContainer);
var c=new a(this,true),b=c._first&&q(c._first,this)||c._last&&q(c._last,this);c.detach();return!b},detach:function(){e(this)},splitBoundaries:function(){x(this);var a=this.startContainer,c=this.startOffset,d=this.endContainer,e=this.endOffset,u=a===d;j.isCharacterDataNode(d)&&e>0&&e<d.length&&j.splitDataNode(d,e);j.isCharacterDataNode(a)&&c>0&&c<a.length&&(a=j.splitDataNode(a,c),u?(e-=c,d=a):d==a.parentNode&&e>=j.getNodeIndex(a)&&e++,c=0);b(this,a,c,d,e)},normalizeBoundaries:function(){x(this);var a=
this.startContainer,c=this.startOffset,d=this.endContainer,e=this.endOffset,u=function(a){var c=a.nextSibling;if(c&&c.nodeType==a.nodeType)d=a,e=a.length,a.appendData(c.data),c.parentNode.removeChild(c)},g=function(b){var u=b.previousSibling;if(u&&u.nodeType==b.nodeType){a=b;var g=b.length;c=u.length;b.insertData(0,u.data);u.parentNode.removeChild(u);a==d?(e+=c,d=a):d==b.parentNode&&(u=j.getNodeIndex(b),e==u?(d=b,e=g):e>u&&e--)}},v=true;j.isCharacterDataNode(d)?d.length==e&&u(d):(e>0&&(v=d.childNodes[e-
1])&&j.isCharacterDataNode(v)&&u(v),v=!this.collapsed);v?j.isCharacterDataNode(a)?c==0&&g(a):c<a.childNodes.length&&(u=a.childNodes[c])&&j.isCharacterDataNode(u)&&g(u):(a=d,c=e);b(this,a,c,d,e)},collapseToPoint:function(a,c){i(this);g(a,true);C(a,c);(a!==this.startContainer||c!==this.startOffset||a!==this.endContainer||c!==this.endOffset)&&b(this,a,c,a,c)}});E(c)}function N(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:
j.getCommonAncestor(a.startContainer,a.endContainer)}function P(a,c,b,d,e){var u=a.startContainer!==c||a.startOffset!==b,g=a.endContainer!==d||a.endOffset!==e;a.startContainer=c;a.startOffset=b;a.endContainer=d;a.endOffset=e;N(a);t(a,"boundarychange",{startMoved:u,endMoved:g})}function A(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};N(this)}d.requireModules(["DomUtil"]);var j=d.dom,J=j.DomPosition,D=d.DOMException;a.prototype=
...
this._current,c,b;j.isCharacterDataNode(a)&&(a===this.sc||a===this.ec)?(c=a===this.sc?this.so:0,b=a===this.ec?this.eo:a.length,c!=b&&a.deleteData(c,b-c)):a.parentNode&&a.parentNode.removeChild(a)},isPartiallySelectedSubtree:function(){return q(this._current,this.range)},getSubtreeIterator:function(){var c;if(this.isSingleCharacterDataNode)c=this.range.cloneRange(),c.collapse();else{c=new A(n(this.range));var b=this._current,d=b,e=0,u=b,g=j.getNodeLength(b);if(j.isAncestorOf(b,this.sc,true))d=this.sc,
e=this.so;if(j.isAncestorOf(b,this.ec,true))u=this.ec,g=this.eo;P(c,d,e,u,g)}return new a(c,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};b.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};b.prototype.toString=function(){return this.message};c.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=
this.nodes[++this._position];return this._current},detach:function(){this._current=this._next=this.nodes=null}};var K=[1,3,4,5,7,8,10],M=[2,9,11],L=[1,3,4,5,7,8,10,11],u=[1,3,4,5,7,8],O=j.getRootContainer,Q=e([9,11]),ba=e([5,6,10,12]),aa=e([6,10,12]),$=document.createElement("style"),T=false;try{$.innerHTML="<b>x</b>",T=$.firstChild.nodeType==3}catch(da){}d.features.htmlParsingConforms=T;var U="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),R=0,V=1,
ca=2,W=3,X=0,Y=1,Z=2,S=3;H.prototype={attachListener:function(a,c){this._listeners[a].push(c)},compareBoundaryPoints:function(a,c){x(this);B(this.startContainer,c.startContainer);var b=a==W||a==R?"start":"end",d=a==V||a==R?"start":"end";return j.comparePoints(this[b+"Container"],this[b+"Offset"],c[d+"Container"],c[d+"Offset"])},insertNode:function(a){x(this);p(a,L);z(this.startContainer);if(j.isAncestorOf(a,this.startContainer,true))throw new D("HIERARCHY_REQUEST_ERR");this.setStartBefore(f(a,this.startContainer,
this.startOffset))},cloneContents:function(){x(this);var c,b;if(this.collapsed)return n(this).createDocumentFragment();else{if(this.startContainer===this.endContainer&&j.isCharacterDataNode(this.startContainer))return c=this.startContainer.cloneNode(true),c.data=c.data.slice(this.startOffset,this.endOffset),b=n(this).createDocumentFragment(),b.appendChild(c),b;else b=new a(this,true),c=w(b),b.detach();return c}},canSurroundContents:function(){x(this);z(this.startContainer);z(this.endContainer);var c=
new a(this,true),b=c._first&&q(c._first,this)||c._last&&q(c._last,this);c.detach();return!b},surroundContents:function(a){p(a,u);if(!this.canSurroundContents())throw new b("BAD_BOUNDARYPOINTS_ERR");var c=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);f(a,this.startContainer,this.startOffset);a.appendChild(c);this.selectNode(a)},cloneRange:function(){x(this);for(var a=new A(n(this)),c=U.length,b;c--;)b=U[c],a[b]=this[b];return a},toString:function(){x(this);
var c=this.startContainer;if(c===this.endContainer&&j.isCharacterDataNode(c))return c.nodeType==3||c.nodeType==4?c.data.slice(this.startOffset,this.endOffset):"";else{var b=[],c=new a(this,true);m(c,function(a){(a.nodeType==3||a.nodeType==4)&&b.push(a.data)});c.detach();return b.join("")}},compareNode:function(a){x(this);var c=a.parentNode,b=j.getNodeIndex(a);if(!c)throw new D("NOT_FOUND_ERR");a=this.comparePoint(c,b);c=this.comparePoint(c,b+1);return a<0?c>0?Z:X:c>0?Y:S},comparePoint:function(a,
c){x(this);y(a,"HIERARCHY_REQUEST_ERR");B(a,this.startContainer);if(j.comparePoints(a,c,this.startContainer,this.startOffset)<0)return-1;else if(j.comparePoints(a,c,this.endContainer,this.endOffset)>0)return 1;return 0},createContextualFragment:T?function(a){var c=this.startContainer,b=j.getDocument(c);if(!c)throw new D("INVALID_STATE_ERR");var d=null;c.nodeType==1?d=c:j.isCharacterDataNode(c)&&(d=j.parentElement(c));d=d===null||d.nodeName=="HTML"&&j.isHtmlNamespace(j.getDocument(d).documentElement)&&
j.isHtmlNamespace(d)?b.createElement("body"):d.cloneNode(false);d.innerHTML=a;return j.fragmentFromNodeChildren(d)}:function(a){i(this);var c=n(this).createElement("body");c.innerHTML=a;return j.fragmentFromNodeChildren(c)},toHtml:function(){x(this);var a=n(this).createElement("div");a.appendChild(this.cloneContents());return a.innerHTML},intersectsNode:function(a,c){x(this);y(a,"NOT_FOUND_ERR");if(j.getDocument(a)!==n(this))return false;var b=a.parentNode,d=j.getNodeIndex(a);y(b,"NOT_FOUND_ERR");
var e=j.comparePoints(b,d,this.endContainer,this.endOffset),b=j.comparePoints(b,d+1,this.startContainer,this.startOffset);return c?e<=0&&b>=0:e<0&&b>0},isPointInRange:function(a,c){x(this);y(a,"HIERARCHY_REQUEST_ERR");B(a,this.startContainer);return j.comparePoints(a,c,this.startContainer,this.startOffset)>=0&&j.comparePoints(a,c,this.endContainer,this.endOffset)<=0},intersectsRange:function(a,c){x(this);if(n(a)!=n(this))throw new D("WRONG_DOCUMENT_ERR");var b=j.comparePoints(this.startContainer,
this.startOffset,a.endContainer,a.endOffset),d=j.comparePoints(this.endContainer,this.endOffset,a.startContainer,a.startOffset);return c?b<=0&&d>=0:b<0&&d>0},intersection:function(a){if(this.intersectsRange(a)){var c=j.comparePoints(this.startContainer,this.startOffset,a.startContainer,a.startOffset),b=j.comparePoints(this.endContainer,this.endOffset,a.endContainer,a.endOffset),d=this.cloneRange();c==-1&&d.setStart(a.startContainer,a.startOffset);b==1&&d.setEnd(a.endContainer,a.endOffset);return d}return null},
union:function(a){if(this.intersectsRange(a,true)){var c=this.cloneRange();j.comparePoints(a.startContainer,a.startOffset,this.startContainer,this.startOffset)==-1&&c.setStart(a.startContainer,a.startOffset);j.comparePoints(a.endContainer,a.endOffset,this.endContainer,this.endOffset)==1&&c.setEnd(a.endContainer,a.endOffset);return c}else throw new b("Ranges do not intersect");},containsNode:function(a,c){return c?this.intersectsNode(a,false):this.compareNode(a)==S},containsNodeContents:function(a){return this.comparePoint(a,
0)>=0&&this.comparePoint(a,j.getNodeLength(a))<=0},containsRange:function(a){return this.intersection(a).equals(a)},containsNodeText:function(a){var c=this.cloneRange();c.selectNode(a);var b=c.getNodes([3]);return b.length>0?(c.setStart(b[0],0),a=b.pop(),c.setEnd(a,a.length),a=this.containsRange(c),c.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){x(this);return new c(this,a,b)},getNodes:function(a,c){x(this);return l(this,a,c)},getDocument:function(){return n(this)},collapseBefore:function(a){i(this);
this.setEndBefore(a);this.collapse(false)},collapseAfter:function(a){i(this);this.setStartAfter(a);this.collapse(true)},getName:function(){return"DomRange"},equals:function(a){return A.rangesEqual(this,a)},isValid:function(){return F(this)},inspect:function(){return k(this)}};I(A,P,function(a){i(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;t(a,"detach",null);a._listeners=null});d.rangePrototype=H.prototype;A.rangeProperties=U;A.RangeIterator=
a;A.copyComparisonConstants=E;A.createPrototypeRange=I;A.inspect=k;A.getRangeDocument=n;A.rangesEqual=function(a,c){return a.startContainer===c.startContainer&&a.startOffset===c.startOffset&&a.endContainer===c.endContainer&&a.endOffset===c.endOffset};d.DomRange=A;d.RangeException=b});
rangy.createModule("WrappedRange",function(d){function q(d,f,h,l){var k=d.duplicate();k.collapse(h);var a=k.parentElement();r.isAncestorOf(f,a,true)||(a=f);if(!a.canHaveHTML)return new s(a.parentNode,r.getNodeIndex(a));var f=r.getDocument(a).createElement("span"),b,c=h?"StartToStart":"StartToEnd";do a.insertBefore(f,f.previousSibling),k.moveToElementText(f);while((b=k.compareEndPoints(c,d))>0&&f.previousSibling);c=f.nextSibling;if(b==-1&&c&&r.isCharacterDataNode(c)){k.setEndPoint(h?"EndToStart":"EndToEnd",
d);if(/[\r\n]/.test(c.data)){a=k.duplicate();h=a.text.replace(/\r\n/g,"\r").length;for(h=a.moveStart("character",h);a.compareEndPoints("StartToEnd",a)==-1;)h++,a.moveStart("character",1)}else h=k.text.length;a=new s(c,h)}else c=(l||!h)&&f.previousSibling,a=(h=(l||h)&&f.nextSibling)&&r.isCharacterDataNode(h)?new s(h,0):c&&r.isCharacterDataNode(c)?new s(c,c.length):new s(a,r.getNodeIndex(f));f.parentNode.removeChild(f);return a}function n(d,f){var h,l,k=d.offset,a=r.getDocument(d.node),b=a.body.createTextRange(),
c=r.isCharacterDataNode(d.node);c?(h=d.node,l=h.parentNode):(h=d.node.childNodes,h=k<h.length?h[k]:null,l=d.node);a=a.createElement("span");a.innerHTML="&#feff;";h?l.insertBefore(a,h):l.appendChild(a);b.moveToElementText(a);b.collapse(!f);l.removeChild(a);if(c)b[f?"moveStart":"moveEnd"]("character",k);return b}d.requireModules(["DomUtil","DomRange"]);var t,r=d.dom,s=r.DomPosition,f=d.DomRange;if(d.features.implementsDomRange&&(!d.features.implementsTextRange||!d.config.preferTextRange))(function(){function m(a){for(var b=
h.length,d;b--;)d=h[b],a[d]=a.nativeRange[d]}var o,h=f.rangeProperties,l;t=function(a){if(!a)throw Error("Range must be specified");this.nativeRange=a;m(this)};f.createPrototypeRange(t,function(a,b,d,i,m){var f=a.endContainer!==i||a.endOffset!=m;if(a.startContainer!==b||a.startOffset!=d||f)a.setEnd(i,m),a.setStart(b,d)},function(a){a.nativeRange.detach();a.detached=true;for(var b=h.length,d;b--;)d=h[b],a[d]=null});o=t.prototype;o.selectNode=function(a){this.nativeRange.selectNode(a);m(this)};o.deleteContents=
function(){this.nativeRange.deleteContents();m(this)};o.extractContents=function(){var a=this.nativeRange.extractContents();m(this);return a};o.cloneContents=function(){return this.nativeRange.cloneContents()};o.surroundContents=function(a){this.nativeRange.surroundContents(a);m(this)};o.collapse=function(a){this.nativeRange.collapse(a);m(this)};o.cloneRange=function(){return new t(this.nativeRange.cloneRange())};o.refresh=function(){m(this)};o.toString=function(){return this.nativeRange.toString()};
var k=document.createTextNode("test");r.getBody(document).appendChild(k);var a=document.createRange();a.setStart(k,0);a.setEnd(k,0);try{a.setStart(k,1),o.setStart=function(a,b){this.nativeRange.setStart(a,b);m(this)},o.setEnd=function(a,b){this.nativeRange.setEnd(a,b);m(this)},l=function(a){return function(b){this.nativeRange[a](b);m(this)}}}catch(b){o.setStart=function(a,b){try{this.nativeRange.setStart(a,b)}catch(d){this.nativeRange.setEnd(a,b),this.nativeRange.setStart(a,b)}m(this)},o.setEnd=function(a,
b){try{this.nativeRange.setEnd(a,b)}catch(d){this.nativeRange.setStart(a,b),this.nativeRange.setEnd(a,b)}m(this)},l=function(a,b){return function(d){try{this.nativeRange[a](d)}catch(i){this.nativeRange[b](d),this.nativeRange[a](d)}m(this)}}}o.setStartBefore=l("setStartBefore","setEndBefore");o.setStartAfter=l("setStartAfter","setEndAfter");o.setEndBefore=l("setEndBefore","setStartBefore");o.setEndAfter=l("setEndAfter","setStartAfter");a.selectNodeContents(k);o.selectNodeContents=a.startContainer==
k&&a.endContainer==k&&a.startOffset==0&&a.endOffset==k.length?function(a){this.nativeRange.selectNodeContents(a);m(this)}:function(a){this.setStart(a,0);this.setEnd(a,f.getEndOffset(a))};a.selectNodeContents(k);a.setEnd(k,3);l=document.createRange();l.selectNodeContents(k);l.setEnd(k,4);l.setStart(k,2);o.compareBoundaryPoints=a.compareBoundaryPoints(a.START_TO_END,l)==-1&a.compareBoundaryPoints(a.END_TO_START,l)==1?function(a,b){b=b.nativeRange||b;if(a==b.START_TO_END)a=b.END_TO_START;else if(a==
b.END_TO_START)a=b.START_TO_END;return this.nativeRange.compareBoundaryPoints(a,b)}:function(a,b){return this.nativeRange.compareBoundaryPoints(a,b.nativeRange||b)};if(d.util.isHostMethod(a,"createContextualFragment"))o.createContextualFragment=function(a){return this.nativeRange.createContextualFragment(a)};r.getBody(document).removeChild(k);a.detach();l.detach()})(),d.createNativeRange=function(d){return(d||document).createRange()};else if(d.features.implementsTextRange){t=function(d){this.textRange=
d;this.refresh()};t.prototype=new f(document);t.prototype.refresh=function(){var d,f,h=this.textRange;d=h.parentElement();var l=h.duplicate();l.collapse(true);f=l.parentElement();l=h.duplicate();l.collapse(false);h=l.parentElement();f=f==h?f:r.getCommonAncestor(f,h);f=f==d?f:r.getCommonAncestor(d,f);this.textRange.compareEndPoints("StartToEnd",this.textRange)==0?f=d=q(this.textRange,f,true,true):(d=q(this.textRange,f,true,false),f=q(this.textRange,f,false,false));this.setStart(d.node,d.offset);this.setEnd(f.node,
f.offset)};f.copyComparisonConstants(t);var w=function(){return this}();if(typeof w.Range=="undefined")w.Range=t;d.createNativeRange=function(d){return(d||document).body.createTextRange()}}if(d.features.implementsTextRange)t.rangeToTextRange=function(d){if(d.collapsed)return n(new s(d.startContainer,d.startOffset),true);else{var f=n(new s(d.startContainer,d.startOffset),true),h=n(new s(d.endContainer,d.endOffset),false),d=r.getDocument(d.startContainer).body.createTextRange();d.setEndPoint("StartToStart",
f);d.setEndPoint("EndToEnd",h);return d}};t.prototype.getName=function(){return"WrappedRange"};d.WrappedRange=t;d.createRange=function(f){return new t(d.createNativeRange(f||document))};d.createRangyRange=function(d){return new f(d||document)};d.createIframeRange=function(f){return d.createRange(r.getIframeDocument(f))};d.createIframeRangyRange=function(f){return d.createRangyRange(r.getIframeDocument(f))};d.addCreateMissingNativeApiListener(function(f){f=f.document;if(typeof f.createRange=="undefined")f.createRange=
function(){return d.createRange(this)};f=f=null})});
rangy.createModule("WrappedSelection",function(d,q){function n(a){return(a||window).getSelection()}function t(a){return(a||window).document.selection}function r(a,c,b){var d=b?"end":"start",b=b?"start":"end";a.anchorNode=c[d+"Container"];a.anchorOffset=c[d+"Offset"];a.focusNode=c[b+"Container"];a.focusOffset=c[b+"Offset"]}function s(a){a.anchorNode=a.focusNode=null;a.anchorOffset=a.focusOffset=0;a.rangeCount=0;a.isCollapsed=true;a._ranges.length=0}function f(a){var b;if(a instanceof g){if(b=a._selectionNativeRange,
!b)b=d.createNativeRange(c.getDocument(a.startContainer)),b.setEnd(a.endContainer,a.endOffset),b.setStart(a.startContainer,a.startOffset),a._selectionNativeRange=b,a.attachListener("detach",function(){this._selectionNativeRange=null})}else a instanceof i?b=a.nativeRange:d.features.implementsDomRange&&a instanceof c.getWindow(a.startContainer).Range&&(b=a);return b}function w(a){var b=a.getNodes(),d;a:if(!b.length||b[0].nodeType!=1)d=false;else{d=1;for(var e=b.length;d<e;++d)if(!c.isAncestorOf(b[0],
b[d])){d=false;break a}d=true}if(!d)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function m(a,c){var b=new i(c);a._ranges=[b];r(a,b,false);a.rangeCount=1;a.isCollapsed=b.collapsed}function o(a){a._ranges.length=0;if(a.docSelection.type=="None")s(a);else{var b=a.docSelection.createRange();if(b&&typeof b.text!="undefined")m(a,b);else{a.rangeCount=b.length;for(var e,g=c.getDocument(b.item(0)),v=0;v<a.rangeCount;++v)e=d.createRange(g),
e.selectNode(b.item(v)),a._ranges.push(e);a.isCollapsed=a.rangeCount==1&&a._ranges[0].collapsed;r(a,a._ranges[a.rangeCount-1],false)}}}function h(a,b){for(var d=a.docSelection.createRange(),e=w(b),g=c.getDocument(d.item(0)),g=c.getBody(g).createControlRange(),v=0,f=d.length;v<f;++v)g.add(d.item(v));try{g.add(e)}catch(i){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}g.select();o(a)}function l(a,c,b){this.nativeSelection=
a;this.docSelection=c;this._ranges=[];this.win=b;this.refresh()}function k(a,b){for(var d=c.getDocument(b[0].startContainer),d=c.getBody(d).createControlRange(),e=0,g;e<rangeCount;++e){g=w(b[e]);try{d.add(g)}catch(v){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();o(a)}function a(a,b){if(a.anchorNode&&c.getDocument(a.anchorNode)!==c.getDocument(b))throw new p("WRONG_DOCUMENT_ERR");}function b(a){var c=
[],b=new C(a.anchorNode,a.anchorOffset),d=new C(a.focusNode,a.focusOffset),e=typeof a.getName=="function"?a.getName():"Selection";if(typeof a.rangeCount!="undefined")for(var v=0,f=a.rangeCount;v<f;++v)c[v]=g.inspect(a.getRangeAt(v));return"["+e+"(Ranges: "+c.join(", ")+")(anchor: "+b.inspect()+", focus: "+d.inspect()+"]"}d.requireModules(["DomUtil","DomRange","WrappedRange"]);d.config.checkSelectionRanges=true;var c=d.dom,e=d.util,g=d.DomRange,i=d.WrappedRange,p=d.DOMException,C=c.DomPosition,B,z,
y=d.util.isHostMethod(window,"getSelection"),F=d.util.isHostObject(document,"selection"),x=F&&(!y||d.config.preferTextRange);x?(B=t,d.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return b.type!="None"||c.getDocument(b.createRange().parentElement())==a}):y?(B=n,d.isSelectionValid=function(){return true}):q.fail("Neither document.selection or window.getSelection() detected.");d.getNativeSelection=B;var y=B(),H=d.createNativeRange(document),G=c.getBody(document),E=e.areHostObjects(y,
e.areHostProperties(y,["anchorOffset","focusOffset"]));d.features.selectionHasAnchorAndFocus=E;var v=e.isHostMethod(y,"extend");d.features.selectionHasExtend=v;var I=typeof y.rangeCount=="number";d.features.selectionHasRangeCount=I;var N=false,P=true;e.areHostMethods(y,["addRange","getRangeAt","removeAllRanges"])&&typeof y.rangeCount=="number"&&d.features.implementsDomRange&&function(){var a=document.createElement("iframe");a.frameBorder=0;a.style.position="absolute";a.style.left="-10000px";G.appendChild(a);
var b=c.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");b.close();var d=c.getIframeWindow(a).getSelection(),e=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(e,1);b.collapse(true);d.addRange(b);P=d.rangeCount==1;d.removeAllRanges();var g=b.cloneRange();b.setStart(e,0);g.setEnd(e,2);d.addRange(b);d.addRange(g);N=d.rangeCount==2;b.detach();g.detach();G.removeChild(a)}();d.features.selectionSupportsMultipleRanges=N;d.features.collapsedNonEditableSelectionsSupported=
P;var A=false,j;G&&e.isHostMethod(G,"createControlRange")&&(j=G.createControlRange(),e.areHostProperties(j,["item","add"])&&(A=true));d.features.implementsControlRange=A;z=E?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:false};var J;e.isHostMethod(y,"getRangeAt")?J=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:E&&(J=function(a){var b=c.getDocument(a.anchorNode),b=d.createRange(b);
b.setStart(a.anchorNode,a.anchorOffset);b.setEnd(a.focusNode,a.focusOffset);b.collapsed!==this.isCollapsed&&(b.setStart(a.focusNode,a.focusOffset),b.setEnd(a.anchorNode,a.anchorOffset));return b});d.getSelection=function(a){var a=a||window,b=a._rangySelection,c=B(a),d=F?t(a):null;b?(b.nativeSelection=c,b.docSelection=d,b.refresh(a)):(b=new l(c,d,a),a._rangySelection=b);return b};d.getIframeSelection=function(a){return d.getSelection(c.getIframeWindow(a))};j=l.prototype;if(!x&&E&&e.areHostMethods(y,
["removeAllRanges","addRange"])){j.removeAllRanges=function(){this.nativeSelection.removeAllRanges();s(this)};var D=function(a,b){var c=g.getRangeDocument(b),c=d.createRange(c);c.collapseToPoint(b.endContainer,b.endOffset);a.nativeSelection.addRange(f(c));a.nativeSelection.extend(b.startContainer,b.startOffset);a.refresh()};j.addRange=I?function(a,b){if(A&&F&&this.docSelection.type=="Control")h(this,a);else if(b&&v)D(this,a);else{var c;N?c=this.rangeCount:(this.removeAllRanges(),c=0);this.nativeSelection.addRange(f(a));
this.rangeCount=this.nativeSelection.rangeCount;this.rangeCount==c+1?(d.config.checkSelectionRanges&&(c=J(this.nativeSelection,this.rangeCount-1))&&!g.rangesEqual(c,a)&&(a=new i(c)),this._ranges[this.rangeCount-1]=a,r(this,a,L(this.nativeSelection)),this.isCollapsed=z(this)):this.refresh()}}:function(a,b){b&&v?D(this,a):(this.nativeSelection.addRange(f(a)),this.refresh())};j.setRanges=function(a){if(A&&a.length>1)k(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(e.isHostMethod(y,
"empty")&&e.isHostMethod(H,"select")&&A&&x)j.removeAllRanges=function(){try{if(this.docSelection.empty(),this.docSelection.type!="None"){var a;if(this.anchorNode)a=c.getDocument(this.anchorNode);else if(this.docSelection.type=="Control"){var b=this.docSelection.createRange();b.length&&(a=c.getDocument(b.item(0)).body.createTextRange())}a&&(a.body.createTextRange().select(),this.docSelection.empty())}}catch(d){}s(this)},j.addRange=function(a){this.docSelection.type=="Control"?h(this,a):(i.rangeToTextRange(a).select(),
this._ranges[0]=a,this.rangeCount=1,this.isCollapsed=this._ranges[0].collapsed,r(this,a,false))},j.setRanges=function(a){this.removeAllRanges();var b=a.length;b>1?k(this,a):b&&this.addRange(a[0])};else return q.fail("No means of selecting a Range or TextRange was found"),false;j.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new p("INDEX_SIZE_ERR");else return this._ranges[a]};var K;if(x)K=function(a){var b;d.isSelectionValid(a.win)?b=a.docSelection.createRange():(b=c.getBody(a.win.document).createTextRange(),
b.collapse(true));a.docSelection.type=="Control"?o(a):b&&typeof b.text!="undefined"?m(a,b):s(a)};else if(e.isHostMethod(y,"getRangeAt")&&typeof y.rangeCount=="number")K=function(a){if(A&&F&&a.docSelection.type=="Control")o(a);else if(a._ranges.length=a.rangeCount=a.nativeSelection.rangeCount,a.rangeCount){for(var b=0,c=a.rangeCount;b<c;++b)a._ranges[b]=new d.WrappedRange(a.nativeSelection.getRangeAt(b));r(a,a._ranges[a.rangeCount-1],L(a.nativeSelection));a.isCollapsed=z(a)}else s(a)};else if(E&&typeof y.isCollapsed==
"boolean"&&typeof H.collapsed=="boolean"&&d.features.implementsDomRange)K=function(a){var b;b=a.nativeSelection;b.anchorNode?(b=J(b,0),a._ranges=[b],a.rangeCount=1,b=a.nativeSelection,a.anchorNode=b.anchorNode,a.anchorOffset=b.anchorOffset,a.focusNode=b.focusNode,a.focusOffset=b.focusOffset,a.isCollapsed=z(a)):s(a)};else return q.fail("No means of obtaining a Range or TextRange from the user's selection was found"),false;j.refresh=function(a){var b=a?this._ranges.slice(0):null;K(this);if(a){a=b.length;
if(a!=this._ranges.length)return false;for(;a--;)if(!g.rangesEqual(b[a],this._ranges[a]))return false;return true}};var M=function(a,b){var c=a.getAllRanges(),d=false;a.removeAllRanges();for(var e=0,g=c.length;e<g;++e)d||b!==c[e]?a.addRange(c[e]):d=true;a.rangeCount||s(a)};j.removeRange=A?function(a){if(this.docSelection.type=="Control"){for(var b=this.docSelection.createRange(),a=w(a),d=c.getDocument(b.item(0)),d=c.getBody(d).createControlRange(),e,g=false,v=0,f=b.length;v<f;++v)e=b.item(v),e!==
a||g?d.add(b.item(v)):g=true;d.select();o(this)}else M(this,a)}:function(a){M(this,a)};var L;!x&&E&&d.features.implementsDomRange?(L=function(a){var b=false;a.anchorNode&&(b=c.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset)==1);return b},j.isBackwards=function(){return L(this)}):L=j.isBackwards=function(){return false};j.toString=function(){for(var a=[],b=0,c=this.rangeCount;b<c;++b)a[b]=""+this._ranges[b];return a.join("")};j.collapse=function(b,e){a(this,b);var g=d.createRange(c.getDocument(b));
g.collapseToPoint(b,e);this.removeAllRanges();this.addRange(g);this.isCollapsed=true};j.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new p("INVALID_STATE_ERR");};j.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new p("INVALID_STATE_ERR");};j.selectAllChildren=function(b){a(this,b);var e=d.createRange(c.getDocument(b));e.selectNodeContents(b);
this.removeAllRanges();this.addRange(e)};j.deleteFromDocument=function(){if(A&&F&&this.docSelection.type=="Control"){for(var a=this.docSelection.createRange(),b;a.length;)b=a.item(0),a.remove(b),b.parentNode.removeChild(b);this.refresh()}else if(this.rangeCount){a=this.getAllRanges();this.removeAllRanges();b=0;for(var c=a.length;b<c;++b)a[b].deleteContents();this.addRange(a[c-1])}};j.getAllRanges=function(){return this._ranges.slice(0)};j.setSingleRange=function(a){this.setRanges([a])};j.containsNode=
...
c=0;c<this.options.replaceStyle.length;c++)a.css(this.options.replaceStyle[c],b[this.options.replaceStyle[c]]);this.element.hide();this.bind("change",function(){this.element.is("input")?this.element.val(this.getHtml()):this.element.html(this.getHtml())});this.target=a}},cloneDomTools:function(){for(var a in this.options.domTools)this[a]||(this[a]=function(a){return function(){this.options.domTools.constrainSelection(this.getElement());var c=this.getHtml(),d=this.options.domTools[a].apply(this.options.domTools,
arguments);c!==this.getHtml()&&this.change();return d}}(a))},checkChange:function(){var a=n.serializeSelection();this.previousSelection!=a&&this.fire("selectionChange");this.previousSelection=a;var a=this.getCleanHtml(),b=this.dirty;this.dirty=this.getOriginalHtml()!=a;if(this.previousHtml!=a)this.previousHtml=a,this.change(),b!=this.dirty&&(this.dirty?this.fire("dirty"):this.fire("cleaned"))},change:function(){this.fire("change")},destruct:function(){this.hideToolbar();this.disableEditing();this.fire("destroy",
false);this.events={};this.getElement().unbind("."+this.widgetName);this.wrapper&&this.wrapper.remove()},destroy:function(){this.destruct();d.Widget.prototype.destroy.call(this)},persist:function(a,b){return!this.options.persistence?null:d.ui.editor.persist(a,b,this.options.namespace)},enableEditing:function(){this.isToolbarLoaded()||this.loadToolbar();if(!this.enabled){this.enabled=true;this.getElement().addClass(this.options.baseClass+"-editing");this.options.partialEdit?this.getElement().find(this.options.partialEdit).attr("contenteditable",
true):this.getElement().attr("contenteditable",true);try{document.execCommand("enableInlineTableEditing",false,false),document.execCommand("styleWithCSS",true,true)}catch(a){}this.fire("enabled");this.fire("resize")}},disableEditing:function(){if(this.enabled)this.enabled=false,this.getElement().attr("contenteditable",false).removeClass(this.options.baseClass+"-editing"),this.fire("disabled")},isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var a=this,b="",
c=[],e=0;this.eachRange(function(g){var g=g.commonAncestorContainer,f;f=g.nodeType===3?d(g).parent():d(g);g=[];for(c.push(g);f[0]&&!a.isRoot(f)&&f[0].tagName.toLowerCase()!=="body";)g.push(f),f=f.parent();g.reverse();b&&(b+=" | ");b+=this.getTemplate("root");for(f=0;f<g.length;f++)b+=this.getTemplate("tag",{element:g[f][0].tagName.toLowerCase(),data:"["+e+","+f+"]"});e++},null,this);b||(b=this.getTemplate("root"));this.path.html(b).find("a").click(function(){var b=d(this).data("ui-editor-selection");
b?(a.selectOuter(c[b[0]][b[1]]),a.updateTagTree()):a.selectOuter(a.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(a){return this.getElement()[0]===d(a)[0]},unify:function(a,b){b!==false&&a(this);if(this.options.unify)for(var c=d.ui.editor.getInstances(),e=0;e<c.length;e++)c[e]!==this&&c[e].options.unify&&a(c[e])},getUniqueId:function(){return d.ui.editor.getUniqueId()},loadMessages:function(){this.messages=d(this.getTemplate("messages")).appendTo(this.wrapper)},showMessage:function(a,
b,c){var c=d.extend({},this.options.message,c),e={timer:null,editor:this,show:function(){this.element.slideDown();this.timer=q.setTimeout(function(a){this.timer=null;a.hide()},c.delay,this)},hide:function(){if(this.timer)q.clearTimeout(this.timer),this.timer=null;this.element.stop().slideUp(d.proxy(function(){d.isFunction(c.hide)&&c.hide.call(this);this.element.remove()},this))}};e.element=d(this.getTemplate("message",{type:a,message:b})).hide().appendTo(this.messages).find(".ui-editor-message-close").click(function(){e.hide()}).end();
e.show();return e},showLoading:function(a,b){return this.showMessage("clock",a,b)},showInfo:function(a,b){return this.showMessage("info",a,b)},showError:function(a,b){return this.showMessage("circle-close",a,b)},showConfirm:function(a,b){return this.showMessage("circle-check",a,b)},showWarning:function(a,b){return this.showMessage("alert",a,b)},loadToolbar:function(){var a=this.toolbar=d("<div/>").addClass(this.options.baseClass+"-toolbar"),a=this.toolbarWrapper=d("<div/>").addClass(this.options.baseClass+
"-toolbar-wrapper").append(a),b=this.path=d("<div/>").addClass(this.options.baseClass+"-path").addClass("ui-widget-header").html(this.getTemplate("root")),c=this.wrapper=d("<div/>").addClass(this.options.baseClass+"-wrapper").addClass("ui-widget-content").css("display","none").append(b).append(a);d.fn.draggable&&this.options.draggable&&(c.draggable({cancel:"a, button",cursor:"move",handle:".ui-editor-path",stop:d.proxy(function(){var a=this.persist("position",[c.css("top"),c.css("left")]);c.css({top:Math.abs(a[0]),
left:Math.abs(a[1])})},this)}),c.css("position",""),(a=this.persist("position")||this.options.dialogPosition)||(a=[10,10]),parseInt(a[0],10)+c.outerHeight()>d(q).height()&&(a[0]=d(q).height()-c.outerHeight()),parseInt(a[1],10)+c.outerWidth()>d(q).width()&&(a[1]=d(q).width()-c.outerWidth()),c.css({top:Math.abs(parseInt(a[0])),left:Math.abs(parseInt(a[1]))}));d(function(){c.appendTo("body")});this.loadUi()},isToolbarLoaded:function(){return this.wrapper!==null},showToolbar:function(a){this.isToolbarLoaded()||
this.loadToolbar();if(!this.visible){this.options.unify&&this.hideOtherToolbars(true);this.visible=true;this.wrapper.css("display","");this.fire("resize");typeof this.getElement().attr("tabindex")==="undefined"&&this.getElement().attr("tabindex",-1);if(a)if(a.select)a.select();else{var b=q.getSelection();b.removeAllRanges();b.addRange(a)}var c=this;d(function(){c.fire("show");c.getElement().focus()})}},hideToolbar:function(){if(this.visible)this.visible=false,this.wrapper.hide(),this.fire("hide"),
this.fire("resize")},hideOtherToolbars:function(a){this.unify(function(b){b.hideToolbar(a)},false)},isVisible:function(){return this.visible},getTemplate:function(a,b){var c;c=this.templates[a]?this.templates[a]:d.ui.editor.getTemplate(a,this.options.urlPrefix);c=c.replace(/_\('(.*?)'\)/g,function(a,b){b=b.replace(/\\(.?)/g,function(a,b){switch(b){case "\\":return"\\";case "0":return"\x00";case "":return"";default:return b}});return f(b)});b=d.extend({},this.options,b||{});b=this.getTemplateVars(b);
return c=c.replace(/\{\{(.*?)\}\}/g,function(a,c){return b[c]})},getTemplateVars:function(a,b,c){b=b?b+".":"";c||(c=1);var d={},g;for(g in a)if(typeof a[g]==="object"&&c<5){var f=this.getTemplateVars(a[g],b+g,++c),p;for(p in f)d[p]=f[p]}else d[b+g]=a[g];return d},historyPush:function(){if(this.historyEnabled&&this.getHtml()!==this.historyPeak()){if(this.present!==this.history.length-1)this.history=this.history.splice(0,this.present+1);this.history.push(this.getHtml());this.present=this.history.length-
1}},historyPeak:function(){return!this.history.length?null:this.history[this.present]},historyBack:function(){if(this.present>0)this.present--,this.setHtml(this.history[this.present]),this.historyEnabled=false,this.change(),this.historyEnabled=true},historyForward:function(){if(this.present<this.history.length-1)this.present++,this.setHtml(this.history[this.present]),this.historyEnabled=false,this.change(),this.historyEnabled=true},loadUi:function(){for(var a=0,b=this.options.uiOrder.length;a<b;a++){for(var c=
this.options.uiOrder[a],e=d("<div/>"),g=0,f=c.length;g<f;g++)if(!(this.options.enableUi===false&&typeof this.options.ui[c[g]]==="undefined"||this.options.ui[c[g]]===false)&&d.inArray(c[g],this.options.disabledUi)===-1){var p=c[g].replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});if(d.ui.editor.ui[c[g]]){var h=d.extend({},d.ui.editor.ui[c[g]]),p=d.extend(true,{},this.options,{baseClass:this.options.baseClass+"-ui-"+p},h.options,this.options.ui[c[g]]);h.editor=this;h.options=p;h.ui=h.init(this,
p);h.ui.init(c[g],this,p,h).appendTo(e);this.uiObjects[c[g]]=h}}e.addClass("ui-buttonset").addClass(this.options.baseClass+"-buttonset");e.children().length>0&&e.appendTo(this.toolbar)}d("<div/>").css("clear","both").appendTo(this.toolbar)},uiButton:function(a){return d.extend({button:null,options:{},init:function(a,c,e,g){var i=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),e=d.extend({},c.options,{baseClass:c.options.baseClass+"-"+i+"-button"},this.options,c.options.ui[a]);if(!this.title)this.title=
f("Unnamed Button");this.button=d("<div/>").html(this.label||this.title).addClass(e.baseClass).attr("name",a).attr("title",this.title).val(a);e.classes&&this.button.addClass(e.classes);this.button.bind("mousedown."+g.editor.widgetName,function(a){a.preventDefault()});var p=this;this.button.bind("mouseup."+g.editor.widgetName,function(a){a.preventDefault();p.click.apply(g,arguments)});c.bind("destroy",d.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||
"ui-icon-"+i},disabled:e.disabled?true:false,text:this.text||false,label:this.label||null});this.ready.call(g);return this.button},disable:function(){this.button.button("option","disabled",true)},enable:function(){this.button.button("option","disabled",false)},ready:function(){},click:function(){}},a)},uiSelectMenu:function(a){return d.extend({select:null,selectMenu:null,button:null,menu:null,options:{},init:function(a,c){var e=this,g=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});d.extend({},
c.options,{baseClass:c.options.baseClass+g+"-select-menu"},e.options,c.options.ui[a]);if(!e.title)e.title=f("Unnamed Select Menu");e.selectMenu=d('<div class="ui-selectmenu ui-editor-selectmenu"/>');e.selectMenu.append(e.select.hide());e.menu=d('<div class="ui-selectmenu-menu ui-editor-selectmenu-menu ui-widget-content ui-corner-bottom ui-corner-tr"/>');e.select.find("option").each(function(){d("<div/>").addClass("ui-selectmenu-menu-item ui-editor-selectmenu-menu-item").addClass("ui-corner-all").html(d(this).html()).appendTo(e.menu).bind("mouseenter."+
c.widgetName,function(){d(this).addClass("ui-state-focus")}).bind("mouseleave."+c.widgetName,function(){d(this).removeClass("ui-state-focus")}).bind("click."+c.widgetName,function(){var a=e.select.find("option").eq(d(this).index());e.select.val(a.val());e.update();e.selectMenu.removeClass("ui-editor-selectmenu-visible");e.button.addClass("ui-corner-all").removeClass("ui-corner-top");e.change(e.select.val());return false})});var g=d("<div/>").addClass("ui-selectmenu-text"),i=d("<div/>").addClass("ui-icon ui-icon-triangle-1-s");
e.button=d("<div/>").addClass("ui-selectmenu-button ui-editor-selectmenu-button ui-button ui-state-default").attr("title",e.title).append(g).append(i).append(e.select).append(e.menu).prependTo(e.selectMenu);e.button.bind("click."+c.widgetName,function(){e.menu.css("min-width",e.button.outerWidth()+10);e.selectMenu.toggleClass("ui-editor-selectmenu-visible");return false});g=e.select.find("option[value="+e.select.val()+"]").html();e.button.find(".ui-selectmenu-text").html(g);return e.selectMenu},update:function(){var a=
this.select.find("option[value="+this.select.val()+"]").html();this.button.find(".ui-selectmenu-text").html(a)},val:function(){var a=this.select.val.apply(this.select,arguments);this.update();return a},change:function(){}},a)},getPlugin:function(a){return this.plugins[a]},loadPlugins:function(){if(!this.options.plugins)this.options.plugins={};for(var a in d.ui.editor.plugins)if(!(this.options.enablePlugins===false&&typeof this.options.plugins[a]==="undefined"||this.options.plugins[a]===false)&&d.inArray(a,
this.options.disabledPlugins)===-1){var b=d.extend({},d.ui.editor.plugins[a]),c=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),c=d.extend(true,{},this.options,{baseClass:this.options.baseClass+"-"+c},b.options,this.options.plugins[a]);b.editor=this;b.options=c;b.init(this,c);this.plugins[a]=b}},isDirty:function(){return this.dirty},getHtml:function(){var a=this.getElement().html(),a=d("<div/>").html(a);a.find(".rangySelectionBoundary").remove();return a=a.html()},getCleanHtml:function(){this.fire("clean");
var a=this.getElement().html();this.fire("restore");a=d("<div/>").html(a);a.find(".rangySelectionBoundary").remove();return a=a.html()},setHtml:function(a){this.getElement().html(a);this.fire("html");this.change()},resetHtml:function(){this.setHtml(this.getOriginalHtml())},getOriginalHtml:function(){return this.originalHtml},save:function(){var a=this.getCleanHtml();this.fire("save");this.setOriginalHtml(a);this.fire("saved");this.fire("change");return a},setOriginalHtml:function(a){this.originalHtml=
a},bind:function(a,b,c){var e=this.events;d.each(a.split(","),function(a,f){f=d.trim(f);e[f]||(e[f]=[]);e[f].push({context:c,callback:b})})},unbind:function(a,b,c){for(var d=0,g=this.events[a].length;d<g;d++)this.events[a][d]&&this.events[a][d].callback===b&&this.events[a][d].context===c&&this.events[a].splice(d,1)},fire:function(a,b,c){c||this.fire("before:"+a,b,true);if(this.events[a])for(var e=0,g=this.events[a].length;e<g;e++){var f=this.events[a][e];f.callback.call(f.context||this)}b!==false&&
d.ui.editor.fire(a);c||this.fire("after:"+a,b,true)}});d.extend(d.ui.editor,{defaults:{plugins:{},ui:{},bind:{},domTools:{savedSelection:false,saveSelection:function(){this.savedSelection=n.saveSelection()},restoreSelection:function(){if(this.savedSelection)n.restoreSelection(this.savedSelection),this.savedSelection=false},eachRange:function(a,b,c){for(var b=b||n.getSelection(),c=c||this,d,g=0;d=b.getAllRanges()[g++];)a.call(c,d)},constrainSelection:function(a,b){var a=d(a)[0],b=b||n.getSelection(),
c;d(b.getAllRanges()).each(function(e,g){c=this.commonAncestorContainer.nodeType===3?d(g.commonAncestorContainer).parent()[0]:g.commonAncestorContainer;a!==c&&!d.contains(a,c)&&b.removeRange(g)})},getSelectedElements:function(){var a=new jQuery;this.eachRange(function(b){a.push(this.getSelectedElement(b)[0])});return a},getSelectedElement:function(a){return d(a.commonAncestorContainer.nodeType===3?a.commonAncestorContainer.parentNode:a.commonAncestorContainer)},unwrapParentTag:function(a){this.getSelectedElements().each(function(){d(this).is(a)&&
d(this).replaceWith(d(this).html())})},wrapTagWithAttribute:function(a,b,c){this.eachRange(function(d){d=this.getSelectedElement(d);d.is(a)?d.attr(b):this.toggleWrapper(a,{classes:c,attributes:b})})},selectInner:function(a,b){b=b||n.getSelection();b.removeAllRanges();d(a).focus().contents().each(function(){var a=n.createRange();a.selectNodeContents(this);b.addRange(a)})},selectOuter:function(a,b){b=b||n.getSelection();b.removeAllRanges();d(a).each(function(){var a=n.createRange();a.selectNode(this);
b.addRange(a)}).focus()},toggleWrapper:function(a,b){var b=b||{},c=n.createCssClassApplier(b.classes||"",{normalize:true,elementTagName:a,elementProperties:b.attributes||{}});this.eachRange(function(e){this.rangeEmptyTag(e)?this.replaceRange(d("<"+a+"/>").addClass(b.classes).attr(b.attributes||{}).append(this.domFragmentToHtml(e.cloneContents())),e):c.toggleRange(e)})},rangeEmptyTag:function(a){a=this.domFragmentToHtml(a.cloneContents());typeof a==="string"&&(a=a.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,
"\\$1"));return d(a).is(":empty")?true:false},execCommand:function(a,b,c){document.execCommand(a,b,c)},insertTag:function(a,b){this.eachRange(function(b){b.insertNode(d("<"+a+"/>")[0])},b)},insertTagAtEnd:function(a,b){this.eachRange(function(b){b.insertNodeAtEnd(d("<"+a+"/>")[0])},b)},insertElement:function(a,b,c){this.eachRange(function(c){d(a).each(function(){c.insertNode(b===false?this:this.cloneNode(true))})},c)},insertElementAtEnd:function(a,b,c){this.eachRange(function(c){d(a).each(function(){c.insertNodeAtEnd(b===
false?this:this.cloneNode(true))})},c)},toggleBlockStyle:function(a,b){this.eachRange(function(c){for(c=d(c.commonAncestorContainer);c.length&&c[0]!==b[0]&&(c[0].nodeType===3||c.css("display")==="inline");)c=c.parent();c[0]===b[0]&&b.css("display")!=="inline"&&(this.wrapInner(b,"div"),c=b.children().first());this.toggleStyle(c,a)})},wrapInner:function(a,b){this.saveSelection();d(a).each(function(){var c=d("<"+b+"/>").html(d(this).html());a.html(c)});this.restoreSelection()},wrapRange:function(a){a.replaceContents()},
inverseWrapWithTagClass:function(a,b,c,e){this.saveSelection();var g="domTools"+Math.ceil(Math.random()*1E7);this.eachRange(function(a){var d=n.createCssClassApplier(e,{elementTagName:c});d.isAppliedToRange(a)?d.toggleSelection():n.createCssClassApplier(b,{elementTagName:g}).toggleSelection()});d(g).each(function(){d(this).replaceWith(d("<"+a+"/>").addClass(b).html(d(this).html()))});this.restoreSelection()},toggleStyle:function(a,b){d.each(b,function(b,e){d(a).css(b)===e?d(a).css(b,""):d(a).css(b,
e)})},getStyles:function(a){for(var b={},a=q.getComputedStyle(a[0],null),c=0;c<a.length;c++)b[a.item(c)]=a.getPropertyValue(a.item(c));return b},swapStyles:function(a,b,c){for(var d in c)a.css(d,b.css(d)),b.css(d,c[d])},replaceSelection:function(a,b){this.eachRange(function(b){this.replaceRange(a,b)},b)},replaceRange:function(a,b){var c=d("<div></div>").append(a)[0].childNodes;b.deleteContents();c.length===t||c.length===1?b.insertNode(c[0].cloneNode(true)):d.each(c,function(a,c){b.insertNodeAtEnd(c.cloneNode(true))})},
insertDomFragmentBefore:function(a,b,c){for(var e=0,g=a.childNodes.length;e<g;e++){var f=a.childNodes.item(e);(f=f.nodeType===3?f.nodeValue:d(f).html())&&d("<"+c+"/>").html(d.trim(f)).insertBefore(b)}},domFragmentToHtml:function(a,b){for(var c="",e=0,g=a.childNodes.length;e<g;e++){var f=a.childNodes.item(e);(f=f.nodeType===3?f.nodeValue:this.outerHtml(f))&&(c+=f)}b&&(c=d("<"+b+">"+c+"</"+b+">"),c.find("p").wrapInner("<"+b+"/>"),c.find("p > *").unwrap(),c=d("<div></div>").html(c).html());return c},
selectionExists:function(a){var b=false;this.eachRange(function(a){this.isEmpty(a)||(b=true)},a);return b},isEmpty:function(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer},expandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},changeTag:function(a,b){this.insertDomFragmentBefore(a.extractContents(),a.startContainer,b);d(a.startContainer).remove()},tagSelection:function(a,b){this.eachRange(function(b){this.isEmpty(b)?(this.expandToParent(b),
this.changeTag(b,a)):this.replaceRange(this.domFragmentToHtml(b.extractContents(),a),b)},b)},outerHtml:function(a){return d(a).clone().wrap("<div></div>").parent().html()}},namespace:null,unify:true,persistence:true,persistenceName:"uiEditor",unloadWarning:true,autoEnable:false,partialEdit:false,enablePlugins:true,disabledPlugins:[],uiOrder:null,enableUi:true,disabledUi:[],message:{delay:5E3},replace:false,replaceStyle:"display,position,float,width,padding-left,padding-right,padding-top,padding-bottom,margin-left,margin-right,margin-top,margin-bottom".split(","),
...
getTemplate:function(a,b){var c;if(this.templates[a])c=this.templates[a];else{var e=b||this.urlPrefix,f=a.split(".");e+=f.length===1?"templates/"+f[0]+".html":"plugins/"+f[0]+"/templates/"+f.splice(1).join("/")+".html";d.ajax({url:e,type:"GET",async:false,timeout:15E3,error:function(){c=null},success:function(a){c=a}});this.templates[a]=c}return c},getUniqueId:function(){for(var a=d.ui.editor.defaults.baseClass+"-uid-"+(new Date).getTime()+"-"+Math.floor(Math.random()*1E5);d("#"+a).length;)a=d.ui.editor.defaults.baseClass+
"-uid-"+(new Date).getTime()+"-"+Math.floor(Math.random()*1E5);return a},isDirty:function(){for(var a=this.getInstances(),b=0;b<a.length;b++)if(a[b].isDirty())return true;return false},unloadWarning:function(){for(var a=this.getInstances(),b=0;b<a.length;b++)if(a[b].isDirty()&&a[b].isEditing()&&a[b].options.unloadWarning)return f("\nThere are unsaved changes on this page. \nIf you navigate away from this page you will lose your unsaved changes")},defaultUi:{ui:null,editor:null,options:null,init:function(){},
persist:function(a,b){return this.editor.persist(a,b)},bind:function(a,b,c){this.editor.bind(a,b,c||this)},unbind:function(a,b,c){this.editor.unbind(a,b,c||this)}},registerUi:function(a,b){if(typeof a==="string")this.ui[a]=d.extend({},this.defaultUi,b);else for(var c in a)this.registerUi(c,a[c])},defaultPlugin:{editor:null,options:null,init:function(){},persist:function(a,b){return this.editor.persist(a,b)},bind:function(a,b,c){this.editor.bind(a,b,c||this)},unbind:function(a,b,c){this.editor.unbind(a,
b,c||this)}},registerPlugin:function(a,b){if(typeof a==="string")this.plugins[a]=d.extend({},this.defaultPlugin,b);else for(var c in a)this.registerPlugin(c,a[c])},bind:function(a,b){this.events[a]||(this.events[a]=[]);this.events[a].push(b)},unbind:function(a){d.each(this.events,function(b){for(var c=0;c<this.length;c++)this[c]===a&&this.events[b].splice(c,1)})},fire:function(a){if(this.events[a])for(var b=0,c=this.events[a].length;b<c;b++)this.events[a][b].call(this)},persist:function(a,b,c){a=
...
click:function(){a.toggleWrapper("sub",{classes:b.classes||b.cssPrefix+"sub"})}})}},textSuper:{init:function(a,b){return a.uiButton({title:f("Super script"),click:function(){a.toggleWrapper("sup",{classes:b.classes||b.cssPrefix+"super"})}})}}});d.ui.editor.registerUi({quoteBlock:{init:function(a,b){return a.uiButton({title:f("Blockquote"),icon:"ui-icon-quote",click:function(){a.toggleWrapper("blockquote",{classes:b.classes||b.cssPrefix+"blockquote"})}})}}});d.ui.editor.registerUi({cancel:{init:function(a){return a.uiButton({name:"cancel",
title:f("Cancel"),icons:{primary:"ui-icon-cancel"},dialog:null,click:function(){this.confirm()}})},confirm:function(){var a=this.editor.getPlugin("cancel"),b=this.editor;if(b.isDirty()){if(!this.dialog)this.dialog=d(b.getTemplate("cancel.dialog"));this.dialog.dialog({modal:true,resizable:false,title:f("Confirm Cancel Editing"),dialogClass:b.options.dialogClass+" "+b.options.baseClass,show:b.options.dialogShowAnimation,hide:b.options.dialogHideAnimation,buttons:[{text:f("OK"),click:function(){a.cancel();
d(this).dialog("close")}},{text:f("Cancel"),click:function(){d(this).dialog("close")}}],open:function(){var a=d(this).parent().find(".ui-dialog-buttonpane");a.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});a.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){d(this).dialog("destroy").remove()}})}else a.cancel()}}});d.ui.editor.registerPlugin({cancel:{cancel:function(){this.editor.unify(function(a){a.fire("cancel");a.resetHtml();a.hideToolbar();
a.disableEditing()})}}});d.ui.editor.registerPlugin("clean",{options:{stripAttrs:["_moz_dirty"],stripAttrContent:{type:"_moz"},stripEmptyTags:"h1,h2,h3,h4,h5,h6,p,b,i,u,strong,em,big,small,div,span".split(","),stripEmptyAttrs:["class","id","style"]},init:function(a){a.bind("change",this.clean,this)},clean:function(){var a,b=this.editor;for(a=0;a<this.options.stripAttrs.length;a++)b.getElement().find("["+this.options.stripAttrs[a]+"]").removeAttr(this.options.stripAttrs[a]);for(a=0;a<this.options.stripAttrContent.length;a++)b.getElement().find("["+
a+'="'+this.options.stripAttrs[a]+'"]').removeAttr(this.options.stripAttrs[a]);for(a=0;a<this.options.stripEmptyTags.length;a++)b.getElement().find(this.options.stripEmptyTags[a]).filter(function(){if(d.trim(d(this).html())!=="")return false;if(!d(this).hasClass("rangySelectionBoundary"))return true;if(b.savedSelection!==false)return false}).remove();for(a=0;a<this.options.stripEmptyAttrs.length;a++){var c=this.options.stripEmptyAttrs[a];b.getElement().find("["+this.options.stripEmptyAttrs[a]+"]").filter(function(){return d.trim(d(this).attr(c))===
""}).removeAttr(this.options.stripEmptyAttrs[a])}}});d.ui.editor.registerUi({clean:{init:function(a){return a.uiButton({title:f("Remove unnecessary markup from editor content"),click:function(){a.getPlugin("clean").clean()}})}}});d.ui.editor.registerPlugin("clickToEdit",{init:function(a,b){var c=this,e=d(a.getTemplate("clicktoedit.message",b)).appendTo("body"),b=d.extend({},{obscureLinks:false,position:{at:"center center",of:a.getElement(),my:"center center",using:function(a){d(this).css({position:"absolute",
top:a.top,left:a.left})}}},b);this.selection=function(){var a;document.selection?a=document.selection.createRange():document.getSelection().rangeCount&&(a=document.getSelection().getRangeAt(0));return a};this.show=function(){a.isEditing()||(a.getElement().addClass(b.baseClass+"-highlight"),a.getElement().addClass(b.baseClass+"-hover"),e.position(b.position),e.addClass(b.baseClass+"-visible"))};this.hide=function(){a.getElement().removeClass(b.baseClass+"-highlight");a.getElement().removeClass(b.baseClass+
"-hover");e.removeClass(b.baseClass+"-visible")};this.edit=function(){c.hide();a.isEditing()||a.enableEditing();a.isVisible()||a.showToolbar(c.selection())};e.position(b.position);b.obscureLinks||(a.getElement().find("a").bind("mouseenter."+a.widgetName,c.hide),a.getElement().find("a").bind("mouseleave."+a.widgetName,c.show));a.getElement().bind("mouseenter."+a.widgetName,c.show);a.getElement().bind("mouseleave."+a.widgetName,c.hide);a.getElement().bind("click."+a.widgetName,function(a){(b.obscureLinks||
!d(a.target).is("a")&&!d(a.target).parents("a").length)&&c.edit()});a.bind("destroy",function(){e.remove();a.getElement().unbind("mouseenter."+a.widgetName,c.show);a.getElement().unbind("mouseleave."+a.widgetName,c.hide);a.getElement().unbind("click."+a.widgetName,c.edit)})}});d.ui.editor.registerPlugin("dock",{enabled:false,docked:false,topSpacer:null,bottomSpacer:null,options:{docked:false,dockToElement:false,dockUnder:false,persist:true,persistID:null},init:function(){this.bind("show",this.show);
this.bind("hide",this.hide);this.bind("disabled",this.disable);this.bind("destroy",this.destroy,this)},show:function(){this.enabled?this.isDocked()&&this.showSpacers():((this.loadState()||this.options.docked)&&this.dock(),this.enabled=true)},hide:function(){this.hideSpacers();this.editor.toolbar.css("width","auto")},showSpacers:function(){if(!this.options.dockToElement&&this.editor.toolbar.is(":visible"))this.topSpacer=d("<div/>").addClass(this.options.baseClass+"-top-spacer").height(this.editor.toolbar.outerHeight()).prependTo("body"),
this.bottomSpacer=d("<div/>").addClass(this.options.baseClass+"-bottom-spacer").height(this.editor.path.outerHeight()).appendTo("body"),this.editor.fire("resize")},hideSpacers:function(){if(this.topSpacer)this.topSpacer.remove(),this.topSpacer=null;if(this.bottomSpacer)this.bottomSpacer.remove(),this.bottomSpacer=null;this.editor.fire("resize")},swapStyle:function(a,b,c){var d={},f;for(f in c)a.css(f,b.css(f)),d[f]=b.css(f),b.css(f,c[f]);return d},revertStyle:function(a,b){for(var c in b)a.css(c,
b[c])},dockToElement:function(){var a=d("<div/>").insertBefore(this.editor.getElement()).addClass(this.options.baseClass+"-docked-to-element-wrapper");this.editor.wrapper.appendTo(a);this.previousStyle=this.swapStyle(a,this.editor.getElement(),{display:"block","float":"none",clear:"none",position:"static","margin-left":0,"margin-right":0,"margin-top":0,"margin-bottom":0,outline:0,width:"auto"});a.css("width",a.width()+parseInt(this.editor.getElement().css("padding-left"),10)+parseInt(this.editor.getElement().css("padding-right"),
10));this.editor.getElement().appendTo(this.editor.wrapper).addClass(this.options.baseClass+"-docked-element")},undockFromElement:function(){this.editor.getElement().insertAfter(this.editor.wrapper).removeClass(this.options.baseClass+"-docked-element");this.editor.wrapper.appendTo("body").removeClass(this.options.baseClass+"-docked-to-element")},dockToBody:function(){var a=0;d(this.options.dockUnder).length&&(a=d(this.options.dockUnder).outerHeight());this.top=this.editor.toolbarWrapper.css("top");
this.editor.toolbarWrapper.css("top",a);this.editor.wrapper.addClass(this.options.baseClass+"-docked")},undockFromBody:function(){this.editor.toolbarWrapper.css("top",this.top);this.editor.wrapper.removeClass(this.options.baseClass+"-docked");this.hideSpacers()},dock:function(){if(!this.docked)this.docked=this.saveState(true),this.options.dockToElement?this.dockToElement():this.dockToBody(),this.editor.wrapper.find("."+this.options.baseClass+"-button").button({icons:{primary:"ui-icon-pin-w"}}).attr("title",
...
true;this.undock()}});d.ui.editor.registerUi({dock:{init:function(a){return a.uiButton({title:a.getPlugin("dock").getTitle(),icon:a.getPlugin("dock").isDocked()?"ui-icon-pin-w":"ui-icon-pin-s",click:function(){var b=a.getPlugin("dock");b.isDocked()?b.undock():b.dock();a.unify(function(a){b.isDocked()?a.getPlugin("dock").dock():a.getPlugin("dock").undock()})}})}}});d.ui.editor.registerUi({embed:{dialog:null,init:function(a){a.bind("hide",this.hide,this);return a.uiButton({icon:"ui-icon-youtube",title:f("Embed object"),
click:function(){this.show()}})},hide:function(){this.dialog&&d(this.dialog).dialog("destroy").remove();this.dialog=null;d(this.ui.button).button("option","disabled",false)},show:function(){if(!this.dialog){d(this.ui.button).button("option","disabled",true);var a=this;a.editor.saveSelection();this.dialog=d(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:false,width:600,height:400,resizable:true,title:f("Paste Embed Code"),autoOpen:true,dialogClass:a.options.baseClass+" "+a.options.dialogClass,
buttons:[{text:f("Embed Object"),click:function(){a.editor.restoreSelection();a.editor.replaceSelection(d(this).find("textarea").val());d(this).dialog("close")}},{text:f("Close"),click:function(){a.hide()}}],open:function(){var a=d(this).parent().find(".ui-dialog-buttonpane");a.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});a.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});var c=d(this).find(".ui-editor-embed-panel-tabs");c.find("ul li").click(function(){c.find("ul li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
d(this).addClass("ui-state-active").addClass("ui-tabs-selected");c.children("div").hide().eq(d(this).index()).show()});var e=d(this).find(".ui-editor-embed-preview");d(this).find("textarea").change(function(){d(e).html(d(this).val())})},close:function(){a.hide()}})}}}});d.ui.editor.registerUi({floatLeft:{init:function(a){return a.uiButton({title:f("Float Left"),click:function(){a.applyStyle({"float":"left"})}})}},floatRight:{init:function(a){return a.uiButton({title:f("Float Right"),click:function(){a.applyStyle({"float":"right"})}})}},
floatNone:{init:function(a){return a.uiButton({title:f("Float None"),click:function(){a.applyStyle({"float":"none"})}})}}});d.ui.editor.registerUi({fontSizeInc:{init:function(a,b){return a.uiButton({title:f("Increase Font Size"),click:function(){a.inverseWrapWithTagClass("big",b.cssPrefix+"big","small",b.cssPrefix+"small")}})}},fontSizeDec:{init:function(a,b){return a.uiButton({title:f("Decrease Font Size"),click:function(){a.inverseWrapWithTagClass("small",b.cssPrefix+"small","big",b.cssPrefix+"big")}})}}});
d.ui.editor.registerUi({showGuides:{init:function(a,b){a.bind("cancel",this.cancel,this);a.bind("destroy",this.cancel,this);return a.uiButton({title:f("Show Guides"),icon:"ui-icon-pencil",click:function(){a.getElement().toggleClass(b.baseClass+"-visible")}})},cancel:function(){this.editor.getElement().removeClass(this.options.baseClass+"-visible")}}});d.ui.editor.registerUi({undo:{init:function(a){a.bind("change",this.change,this);return a.uiButton({title:f("Step Back"),disabled:true,click:function(){a.historyBack()}})},
change:function(){this.editor.present===0?this.ui.disable():this.ui.enable()}},redo:{init:function(a){a.bind("change",this.change,this);return this.ui=a.uiButton({title:f("Step Forward"),disabled:true,click:function(){a.historyForward()}})},change:function(){this.editor.present===this.editor.history.length-1?this.ui.disable():this.ui.enable()}}});d.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:f("Insert Horizontal Rule"),click:function(){a.replaceSelection("<hr/>")}})}}});d.ui.editor.registerUi({i18n:{init:function(a){var b=
this,c=this.persist("locale");c&&s(c);var c=d('<select autocomplete="off" name="i18n"/>'),e;for(e in o){var g=d('<option value="'+e+'" class="'+e+'"/>');g.html(h[e]);m===e&&g.attr("selected","selected");c.append(g)}return a.uiSelectMenu({title:f("Change Language"),select:c,change:function(a){s(b.persist("locale",a))}})}}});r("en","English",{});r("zh_CN","\u7b80\u4f53\u4e2d\u6587",{"Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"\u5e94\u7528\u6e90\u4ee3\u7801",
...
root:"\u672c","{{images}} image(s) have been replaced with resized versions":"{{images}} image(s) have been replaced with resized versions"});d.ui.editor.registerPlugin("imageResize",{options:{resizeAjax:false,resizingClass:"",resizeAjaxClass:"",ajax:{url:"/",type:"post",cache:false}},init:function(a){this.options=d.extend(this.options,{resizingClass:this.options.baseClass+"-in-progress",resizeAjaxClass:this.options.baseClass+"-on-save"});a.bind("enabled",this.bind,this);this.resized=d.proxy(this.imageResized,
this);var b=this;a.getElement().find("img").each(function(){this.addEventListener&&this.addEventListener("DOMAttrModified",b.resized,false);this.attachEvent&&this.attachEvent("onpropertychange",b.resized)})},bind:function(){this.editor.bind("change",this.scanImages,this);this.editor.bind("destroy",this.destroy,this);this.editor.bind("save",this.save,this);this.editor.bind("cancel",this.cancel,this)},imageResized:function(a){var b=d(a.target);b.is("img")&&b.attr("_moz_resizing")&&a.attrName=="style"&&
a.newValue.match(/width|height/)&&(this.options.resizeAjax&&b.addClass(this.options.resizeAjaxClass),this.editor.fire("change"))},scanImages:function(){var a=this.editor.getElement(),b=[];d(a.find("img")).each(function(){(a.height()<d(this).outerHeight()||a.width()<d(this).outerWidth())&&b.push(d(this))});b.length&&this.resizeImageElements(b,a.width(),a.height())},resizeImageElements:function(a,b,c){for(var e=d("<a>",{href:"",target:"_blank"}),f=0;f<a.length;f++){var i=a[f],h=i.outerWidth(),k=i.outerHeight(),
l=Math.min(b/h,c/k),h=Math.abs(l*(h-(i.outerWidth()-i.width()))),k=Math.abs(l*(k-(i.outerHeight()-i.height())));i.addClass(this.options.resizingClass);e=e.html(i.attr("title")||i.attr("src").substr(i.attr("src").lastIndexOf("/")+1)).attr("href",i.attr("src"));d(i).css({width:h,height:k}).attr("height",k).attr("width",h);this.options.resizeAjax&&i.addClass(this.options.resizeAjaxClass);var m=this;this.showOversizeWarning(this.editor.outerHtml(e),{hide:function(){i.removeClass(m.options.resizingClass)}})}},
cancel:function(){this.removeClasses();this.editor.unbind("change",this.scanImages,this);var a=this;this.editor.getElement().find("img").each(function(){this.removeEventListener&&this.addEventListener("DOMAttrModified",a.resized,false);this.detachEvent&&this.detachEvent("onpropertychange",a.resized)})},destroy:function(){this.cancel()},save:function(){this.removeClasses(this.options.resizingClass);this.options.resizeAjax&&this.resizeImagesAjax()},resizeImagesAjax:function(){var a=this,b=[];d("."+
this.options.resizeAjaxClass).each(function(){d(this).attr("id")||d(this).attr("id",a.editor.getUniqueId());b.push({id:d(this).attr("id"),src:this.src,width:d(this).width(),height:d(this).height()})});if(b.length){var c=this.editor.showLoading(f("Resizing image(s)")),e=this.options.ajax;e.data={images:b};e.async=false;d.ajax(e).done(function(e){d(e).each(function(){d("#"+this.id).attr("src",this.src).removeAttr("id")});a.editor.fire("change");c.hide();a.editor.showConfirm(f("{{images}} image(s) have been replaced with resized versions",
...
{image:a}),b)},removeClasses:function(a){a||(a=[this.options.resizingClass,this.options.resizeAjaxClass]);d.isArray(a)||(a=[a]);for(var b=0;b<a.length;b++)this.editor.getElement().find("img."+a[b]).removeClass(a[b])}});d.ui.editor.registerUi({length:{ui:null,options:{length:150},init:function(a){a.bind("show",d.proxy(this.updateCount,this));a.bind("change",d.proxy(this.updateCount,this));return this.ui=this.editor.uiButton({title:f("Remaining characters before the recommended character limit is reached"),
label:f("Initializing"),text:true,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var a=this.options.length-d("<div></div>").html(this.editor.getCleanHtml()).text().length,b=this.ui.button,c=null,c=a>=0?f("{{charactersRemaining}} characters remaining",{charactersRemaining:a}):f("{{charactersRemaining}} characters over limit",{charactersRemaining:a*-1});b.button("option","label",c);b.button("option","text",true);a<0?b.addClass("ui-state-error"):a>=0&&a<=15?
b.addClass("ui-state-highlight").removeClass("ui-state-error"):b.removeClass("ui-state-highlight ui-state-error")},showStatistics:function(){this.processTemplate().dialog({modal:true,resizable:false,title:f("Content Statistics"),dialogClass:this.editor.options.dialogClass+" "+this.editor.options.baseClass,show:this.editor.options.dialogShowAnimation,hide:this.editor.options.dialogHideAnimation,buttons:[{text:f("OK"),click:function(){d(this).dialog("close")}}],open:function(){d(this).parent().find(".ui-dialog-buttonpane").find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}})},
close:function(){d(this).dialog("destroy").remove()}})},processTemplate:function(){var a=d("<div></div>").html(this.editor.getCleanHtml()).text(),b=null,c=this.options.length-a.length,b=c<0?f("Content contains more than {{limit}} characters and may be truncated",{limit:this.options.length}):f("Content will not be truncated"),e=null,e=a.split(" ").length,e=e==1?f("{{words}} word",{words:e}):f("{{words}} words",{words:e}),g=null,g=a.split(". ").length,g=f("{{sentences}} sentences",{sentences:g}),i=
null,i=c>=0?f("{{characters}} characters, {{charactersRemaining}} remaining",{characters:a.length,charactersRemaining:c}):f("{{characters}} characters, {{charactersRemaining}} over the recommended limit",{characters:a.length,charactersRemaining:c*-1});return d(this.editor.getTemplate("length.dialog",{characters:i,words:e,sentences:g,truncation:b}))}}});d.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:f("Page on this or another website"),
...
this.plugin.editor.showWarning(f("The url for the file you inserted doesn't look well formed"));return b},validate:function(a){var b="."+this.options.baseClass+"-error-message-file-url",c=true;this.options.regexLink.test(a.find('input[name="location"]').val())?a.find(b).has(":visible").hide():(a.find(b).size()||a.find('input[name="location"]').after(this.plugin.editor.getTemplate("link.error",d.extend({},this.options,{messageClass:this.options.baseClass+"-error-message-file-url",message:f("The URL does not look well formed")}))),
a.find(b).not(":visible").show(),c=false);return c}}],init:function(a,b){this.options=d.extend({},{panelAnimation:"fade",replaceTypes:false,customTypes:[],typeDataName:"uiWidgetEditorLinkType",dialogWidth:750,dialogHeight:"auto",dialogMinWidth:670,regexLink:/^(http|https|ftp):\/\/[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/i,regexEmail:/[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/},b);a.bind("save",
this.repairLinks,this);a.bind("cancel",this.cancel,this)},initTypes:function(){this.types={};for(var a={type:null,title:null,content:null,plugin:this,options:this.options,attributes:function(){},init:function(){return this},show:function(){},editing:function(a){if(a.attr("class"))for(var b=this.classes.split(/\s/gi),c=0;c<b.length;c++)if(b[c].trim()&&d(a).hasClass(b[c]))return true;return false},focusSelector:null,focus:function(){if(this.focusSelector){var a=d(this.focusSelector),b=a.val();a.val("");
a.focus().val(b)}}},b=null,b=this.options.replaceTypes?this.options.customTypes:d.merge(this.defaultLinkTypes,this.options.customTypes),c,e=0;e<b.length;e++)c=d.extend({},a,b[e],{classes:this.options.baseClass+"-"+b[e].type}).init(),this.types[c.type]=c},show:function(){if(!this.visible){this.selectedElement=this.editor.getSelectedElements().first();var a=this.selectedElement.is("a"),b=this.options,c=n.saveSelection(),e=this,g=this.dialog=d(this.editor.getTemplate("link.dialog",b)).appendTo("body");
this.initTypes();var i=this.dialog.find("fieldset"),h;for(h in this.types)d(this.editor.getTemplate("link.label",this.types[h])).appendTo(i);i.find('input[type="radio"]').bind("change."+this.editor.widgetName,function(){e.typeChange(e.types[d(this).val()],a)});g.dialog({autoOpen:false,modal:true,resizable:true,width:b.dialogWidth,minWidth:b.dialogMinWidth,height:b.dialogHeight,title:a?f("Edit Link"):f("Insert Link"),dialogClass:b.baseClass+" "+b.dialogClass,buttons:[{text:a?f("Update Link"):f("Insert Link"),
click:function(){n.restoreSelection(c);e.apply(a)?d(this).dialog("close"):c=n.saveSelection()}},{text:f("Cancel"),click:function(){n.restoreSelection(c);d(this).dialog("close")}}],beforeopen:function(){e.dialog.find("."+e.options.baseClass+"-content").hide()},open:function(){e.visible=true;var b=g.parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});var c=g.find('.ui-editor-link-menu input[type="radio"]');
c.first().attr("checked","checked");var f=false;if(a)for(var i in e.types)if(f=e.types[i].editing(e.selectedElement)){c.filter('[value="'+i+'"]').attr("checked","checked");e.typeChange(e.types[i],a);break}(!a||a&&!f)&&e.typeChange(e.types[c.filter(":checked").val()],a);d(this).unbind("keyup."+e.editor.widgetName).bind("keyup."+e.editor.widgetName,function(a){a.keyCode==13&&(a=e.types[c.filter(":checked").val()],(!d.isFunction(a.validate)||a.validate(e.dialog.find("."+e.options.baseClass+"-content")))&&
b.find("button:eq(0)").trigger("click"))})},close:function(){e.visible=false;g.find("."+b.baseClass+"-content").hide();d(this).dialog("destroy")}}).dialog("open")}},apply:function(a){var b=this.types[this.dialog.find('input[type="radio"]:checked').val()],c=b.attributes(this.dialog.find("."+this.options.baseClass+"-content"),a);if(!c)return true;var e=this.editor.outerHtml(d("<a>"+(c.title?c.title:c.href)+"</a>").attr(d.extend({},c,{target:"_blank"})));a?(this.selectedElement[0].className=this.selectedElement[0].className.replace(RegExp(this.options.baseClass+
"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(b.classes).attr(c),this.editor.showConfirm(f("Updated link: {{link}}",{link:e}))):(this.editor.wrapTagWithAttribute("a",d.extend(c,{id:this.editor.getUniqueId()}),b.classes),this.editor.showConfirm(f("Added link: {{link}}",{link:e})),this.selectedElement=d("#"+c.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",c.href);return true},typeChange:function(a,b){var c=this.dialog.find("."+this.options.baseClass+"-content"),
e=c.closest("."+this.options.baseClass+"-wrap"),f=a.ajaxUri&&!this.types[a.type].content;f&&e.addClass(this.options.baseClass+"-loading");var i=this;c.hide(this.options.panelAnimation,function(){f?d.ajax({url:a.ajaxUri,type:"get",success:function(f){c.html(f);i.types[a.type].content=f;e.removeClass(i.options.baseClass+"-loading");a.show(c,b);c.show(i.options.panelAnimation,d.proxy(a.focus,a))}}):(c.html(a.content),a.show(c,b),c.show(i.options.panelAnimation,d.proxy(a.focus,a)))})},remove:function(){this.editor.unwrapParentTag("a")},
repairLinks:function(){var a=this;this.editor.getElement().find('a[class^="'+this.options.baseClass+'"]').each(function(){d(this).data(a.options.baseClass+"-href")&&d(this).attr("href",d(this).data(a.options.baseClass+"-href"))})},cancel:function(){this.dialog&&d(this.dialog.dialog("close"))}});d.ui.editor.registerUi({link:{init:function(a){a.bind("selectionChange",this.change,this);return a.uiButton({title:f("Insert Link"),click:function(){a.getPlugin("link").show()}})},change:function(){this.editor.getSelectedElements().length?
...
a.toggleWrapper("li")):a.insertElement("<ul><li>First list item</li></ul>")}})}},listOrdered:{init:function(a){return a.uiButton({title:f("Ordered List"),click:function(){a.selectionExists(n.getSelection())?(a.toggleWrapper("ol"),a.toggleWrapper("li")):a.insertElement("<ol><li>First list item</li></ol>")}})}}});d.ui.editor.registerUi({logo:{ui:null,init:function(){return this.ui=this.editor.uiButton({title:f("Learn More About the Raptor WYSIWYG Editor"),click:function(){q.open("http://www.jquery-raptor.com/about/editors/",
"_blank")},ready:function(){var a=function(b){var c=typeof b;if(c!="object"||b===null)return c=="string"&&(b='"'+b+'"'),String(b);else{var e=[],f=b&&d.isArray(b);d.each(b,function(b,d){c=typeof d;c=="string"?d='"'+d+'"':c=="object"&d!==null&&(d=a(d));e.push((f?"":'"'+b+'":')+String(d))});return(f?"[":"{")+String(e)+(f?"]":"}")}},b={enableUi:this.options.enableUi,enablePlugins:this.options.enablePlugins,disabledPlugins:a(this.options.disabledPlugins),ui:a(this.options.ui),t:(new Date).getTime()},c=
[],e;for(e in b)c.push(e+"="+encodeURIComponent(b[e]));this.ui.button.find(".ui-button-icon-primary").css({"background-image":"url(http://www.jquery-raptor.com/logo/0.0.1?"+c.join("&")+")"})}})}}});d.ui.editor.registerPlugin("paste",{init:function(a,b){var c=false,e=false,g=this;a.getElement().bind("paste."+a.widgetName,d.proxy(function(){if(c)return false;c=true;var i=n.saveSelection();d(".uiWidgetEditorPasteBin").length&&d(".uiWidgetEditorPasteBin").remove();d('<div class="uiWidgetEditorPasteBin" contenteditable="true" style="width: 1px; height: 1px; overflow: hidden; position: fixed; top: -1px;" />').appendTo("body");
d(".uiWidgetEditorPasteBin").focus();q.setTimeout(function(){var h=d(".uiWidgetEditorPasteBin").html(),h=g.filterAttributes(h),h=g.filterChars(h),h={html:h,plain:d("<div/>").html(h).text(),markup:g.stripAttributes(h)};e=d(a.getTemplate("paste.dialog",h));e.find(".ui-editor-paste-area").bind("keyup."+a.widgetname,function(){g.updateAreas(this,e)});d(e).dialog({modal:true,width:650,height:500,resizable:true,title:"Paste",position:"center",show:b.dialogShowAnimation,hide:b.dialogHideAnimation,dialogClass:b.baseClass+
" "+b.dialogClass,buttons:[{text:f("Insert"),click:function(){var b=null,b=d(this).find(".ui-editor-paste-area:visible"),b=b.hasClass("ui-editor-paste-plain")||b.hasClass("ui-editor-paste-source")?b.val():b.html(),b=g.filterAttributes(b),b=g.filterChars(b);n.restoreSelection(i);a.replaceSelection(b);c=false;d(this).dialog("close")}},{text:f("Cancel"),click:function(){n.restoreSelection(i);c=false;d(this).dialog("close")}}],open:function(){var a=d(this).find(".ui-editor-paste-panel-tabs");a.find("ul li").click(function(){a.find("ul li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
d(this).addClass("ui-state-active").addClass("ui-tabs-selected");a.children("div").hide().eq(d(this).index()).show()});var b=e.parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){c=false;d(this).dialog("destroy").remove()}});d(".uiWidgetEditorPasteBin").remove()},0);return true},this))},filterAttributes:function(a){d.each([{regexp:/(<meta\s*[^>]*\s*>)|(<\s*link\s* href="file:[^>]*\s*>)|(<\/?\s*\w+:[^>]*\s*>)/gi,
...
" ")},stripAttributes:function(a){a=d("<div/>").html(a);d(a.find("*")).each(function(){var a=d.map(this.attributes,function(a){return a.name}),c=d(this);d.each(a,function(a,b){c.removeAttr(b)})});return a.html()},updateAreas:function(a,b){var c=b.find('.ui-editor-paste-synchronize-text input[type="checkbox"]'),e=d(a).is("textarea")?d(a).val():d(a).html();c.attr("checked")&&(d(a).hasClass("ui-editor-paste-plain")||b.find(".ui-editor-paste-plain").val(d("<div/>").html(e).text()),d(a).hasClass("ui-editor-paste-rich")||
b.find(".ui-editor-paste-rich").html(e),d(a).hasClass("ui-editor-paste-source")||b.find(".ui-editor-paste-source").html(e),d(a).hasClass("ui-editor-paste-markup")||b.find(".ui-editor-paste-markup").html(this.stripAttributes(e)))}});d.ui.editor.registerPlugin("placeholder",{init:function(a,b){b=d.extend({},{content:"[Your content here]",tag:"p",select:true},b);this.show=function(){if(!d.trim(a.getElement().html())){var c=d(document.createElement(b.tag)).html(b.content);a.getElement().html(c);b.select&&
a.selectInner(c)}};a.bind("show",this.show)}});d.ui.editor.registerUi({raptorize:{init:function(a){var b=a.uiButton({title:f("Raptorize"),ready:function(){b.button.raptorize&&b.button.raptorize()}});return b}}});d.ui.editor.registerPlugin("saveJson",{options:{id:{attr:"name"},postName:"content",showResponse:false,appendId:false,ajax:{url:"/",type:"post",cache:false}},init:function(){},getId:function(){if(typeof this.options.id==="string")return this.options.id;else if(typeof this.options.id==="function")return this.options.id.apply(this,
...
var f=d("<button/>").addClass(c.options.baseClass).addClass(c.options.baseClass+"-button").addClass(c.options.baseClass+"-button-"+a.name).addClass(e).text("Add").click(function(){c.insertSnippet.call(c,a,b,this)}),h=a.buttonAfter||b.getElement();d.isFunction(h)?h.call(this,f,a):f.insertAfter(h);d("."+e).button({icons:{primary:"ui-icon-plusthick"}})}},removeButtons:function(){if(this.enabled){for(var a=0,b=this.ids.length;a<b;a++)d("."+this.ids[a]).remove();for(a=0,b=this.options.snippets.length;a<
b;a++){var c=this.options.snippets[a];d.isFunction(c.clean)&&c.clean.call(c,this,this.editor)}}},insertSnippet:function(a,b,c){var e=d(a.template).html(),f=a.appendTo||b.getElement();d.isFunction(f)?f.call(this,e,a,c):d(e).appendTo(f);b.disableEditing();b.enableEditing()}}});d.ui.editor.registerUi({tagMenu:{init:function(a){a.bind("selectionChange",this.change,this);a.bind("show",this.change,this);return a.uiSelectMenu({name:"tagMenu",title:f("Change HTML tag of selected element"),select:d(a.getTemplate("tagmenu.menu")),
change:function(b){a.tagSelection(b)}})},change:function(){var a=this.editor.getSelectedElements()[0];a&&(a=a.tagName.toLowerCase(),this.ui.selectMenu.find("option[value="+a+"]").length?this.ui.val(a):this.ui.val("na"))}}});d.ui.editor.registerPlugin("toolbarTip",{init:function(){this.bind("show, tagTreeUpdated",function(){d(".ui-editor-wrapper [title]").each(function(){d(this).attr("data-title",d(this).attr("title"));d(this).removeAttr("title")})})}});(function(){var a=null,b=0;d.ui.editor.registerPlugin("unsavedEditWarning",
{options:{},init:function(c){a||(a=d(c.getTemplate("unsavededitwarning.warning",this.options)).attr("id",c.getUniqueId()).appendTo("body"));var e=this;c.bind("dirty",function(){b++;b>0&&a.addClass(e.options.baseClass+"-visible")});c.bind("cleaned",function(){b--;b===0&&a.removeClass(e.options.baseClass+"-visible")})},show:function(){},hide:function(){},reposition:function(){}})})();d.ui.editor.registerUi({viewSource:{dialog:null,init:function(a){a.bind("hide",this.hide,this);return a.uiButton({title:f("View / Edit Source"),
click:function(){this.show()}})},hide:function(){this.dialog&&d(this.dialog).dialog("destroy").remove();this.dialog=null;d(this.ui.button).button("option","disabled",false)},show:function(){if(!this.dialog){d(this.ui.button).button("option","disabled",true);var a=this;this.dialog=d(this.editor.getTemplate("viewsource.dialog"));this.dialog.dialog({modal:false,width:600,height:400,resizable:true,title:f("View Source"),autoOpen:true,dialogClass:a.options.baseClass+" "+a.options.dialogClass,buttons:[{text:f("Apply Source"),
click:function(){a.editor.setHtml(d(this).find("textarea").val())}},{text:f("Close"),click:function(){a.hide()}}],open:function(){var b=d(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});d(this).find("textarea").val(d.trim(a.editor.getHtml()))},close:function(){a.hide()}})}}}})})(jQuery,window,rangy);
