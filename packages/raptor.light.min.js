...
d(this).outerWidth())&&b.push(d(this))});b.length&&this.resizeImageElements(b,a.width(),a.height())},resizeImageElements:function(a,b,c){for(var e=d("<a>",{href:"",target:"_blank"}),g=0;g<a.length;g++){var f=a[g],n=f.outerWidth(),i=f.outerHeight(),k=Math.min(b/n,c/i),n=Math.abs(k*(n-(f.outerWidth()-f.width()))),i=Math.abs(k*(i-(f.outerHeight()-f.height())));f.addClass(this.options.resizingClass);e=e.html(f.attr("title")||f.attr("src").substr(f.attr("src").lastIndexOf("/")+1)).attr("href",f.attr("src"));
...
{link:e})),this.selectedElement=d("#"+c.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",c.href);return!0},typeChange:function(a,b){var c=this.dialog.find("."+this.options.baseClass+"-content"),e=c.closest("."+this.options.baseClass+"-wrap"),g=a.ajaxUri&&!this.types[a.type].content;g&&e.addClass(this.options.baseClass+"-loading");var f=this;c.hide(this.options.panelAnimation,function(){g?d.ajax({url:a.ajaxUri,type:"get",success:function(g){c.html(g);f.types[a.type].content=
g;e.removeClass(f.options.baseClass+"-loading");a.show(c,b);c.show(f.options.panelAnimation,d.proxy(a.focus,a))}}):(c.html(a.content),a.show(c,b),c.show(f.options.panelAnimation,d.proxy(a.focus,a)))})},remove:function(){this.editor.unwrapParentTag("a")},repairLinks:function(){var a=this;this.editor.getElement().find('a[class^="'+this.options.baseClass+'"]').each(function(){d(this).data(a.options.baseClass+"-href")&&d(this).attr("href",d(this).data(a.options.baseClass+"-href"))})},cancel:function(){this.dialog&&
...
change:function(){this.editor.getSelectedElements().is("a")?this.ui.enable():this.ui.disable()}}});d.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),toggleList:function(a){d(this.editor.getSelectedElements()).is("li")&&
d(this.editor.getSelectedElements()).parent().is(a)?this.unwrapList():this.wrapList(a);this.editor.fire("selectionChange");this.editor.fire("change")},unwrapList:function(){this.editor.saveSelection();var a=[],b=[],c=this.editor.getSelectionStartElement(),e=this.editor.getSelectionEndElement();a.push(d(c).html());b.push(c);if(d(c)[0]!==d(e)[0]){var g=c;do g=d(g).next(),a.push(d(g).html()),b.push(g);while(d(g)[0]!==d(e)[0])}g=0===d(c).prev().length;e=0===d(e).next().length;c=d(c).parent();for(listElementsIndex=
0;listElementsIndex<b.length;listElementsIndex++)d(b[listElementsIndex]).remove();for(b=0;b<a.length;b++)c.parent().is("li")||(a[b]="<p>"+a[b]+"</p>");g&&e?(this.editor.selectOuter(c),this.editor.replaceSelection(a.join(""))):(g?d(c).before(a.join("")):e?d(c).after(a.join("")):this.editor.replaceSelectionSplittingSelectedElement(a.join("")),this.editor.restoreSelection())},wrapList:function(a){var b=d("<div>").html(this.editor.getSelectedHtml()),c=[],e=this;d(b).contents().each(function(){var a;a=
"block"===e.getElementDefaultDisplay(this.tagName)?e.editor.stripTags(d(this).html(),e.validChildren):e.editor.stripTags(e.editor.outerHtml(d(this)),e.validChildren);a=d("<li>"+a+"</li>");""!==d.trim(a.text())&&c.push(e.editor.outerHtml(a))});c.length||c.push("<li>List element content</li>");b=this.options.baseClass+"-selection";a="<"+a+' class="'+b+'">'+c.join("")+"</"+a+">";this.editor.restoreSelection();this.editor.replaceSelectionWithinValidTags(a,this.validParents);this.editor.selectInner(d(this.editor.getElement().find("."+
...
b;a++){var c=this.options.snippets[a];d.isFunction(c.clean)&&c.clean.call(c,this,this.editor)}}},insertSnippet:function(a,b,c){var e=d(a.template).html(),g=a.appendTo||b.getElement();d.isFunction(g)?g.call(this,e,a,c):d(e).appendTo(g);b.disableEditing();b.enableEditing()}}});d.ui.editor.registerUi({tagMenu:{init:function(a){a.bind("selectionChange",this.change,this);a.bind("show",this.change,this);var b=this;return a.uiSelectMenu({name:"tagMenu",title:f("Change HTML tag of selected element"),select:d(a.getTemplate("tagmenu.menu")),
