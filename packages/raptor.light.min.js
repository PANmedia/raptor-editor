...
(h=document.createRange(),e(h,k)&&u(h,p)&&(c=!0),h.detach());if((h=r(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(h,"createTextRange"))h=h.createTextRange(),t(h)&&(m=!0);!c&&!m&&v("Neither Range nor TextRange are implemented");s.initialized=!0;s.features={implementsDomRange:c,implementsTextRange:m};c=F.concat(w);m=0;for(h=c.length;m<h;++m)try{c[m](s)}catch(d){r(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
d)}}}function y(a){this.name=a;this.supported=this.initialized=!1}var m="object",o="function",q="undefined",p="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer,START_TO_START,START_TO_END,END_TO_START,END_TO_END".split(","),k="setStart,setStartBefore,setStartAfter,setEnd,setEndBefore,setEndAfter,collapse,selectNode,selectNodeContents,compareBoundaryPoints,deleteContents,extractContents,cloneContents,insertNode,surroundContents,cloneRange,toString,detach".split(","),
c="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),l="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),e=x(a),h=x(r),u=x(g),s={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:a,isHostObject:r,isHostProperty:g,areHostMethods:e,areHostObjects:h,areHostProperties:u,isTextRange:t},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
s.fail=v;s.warn=function(a){a="Rangy warning: "+a;s.config.alertOnWarn?window.alert(a):typeof window.console!=q&&typeof window.console.log!=q&&window.console.log(a)};({}).hasOwnProperty?s.util.extend=function(a,h){for(var e in h)h.hasOwnProperty(e)&&(a[e]=h[e])}:v("hasOwnProperty not supported");var w=[],F=[];s.init=d;s.addInitListener=function(a){s.initialized?a(s):w.push(a)};var G=[];s.addCreateMissingNativeApiListener=function(a){G.push(a)};s.createMissingNativeApi=function(a){a=a||window;d();
for(var h=0,e=G.length;h<e;++h)G[h](a)};y.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};y.prototype.warn=function(a){s.warn("Module "+this.name+": "+a)};y.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};s.createModule=function(a,h){var e=new y(a);s.modules[a]=e;F.push(function(a){h(a,e);e.initialized=!0;e.supported=!0})};s.requireModules=function(a){for(var h=0,e=a.length,c,u;h<
e;++h){u=a[h];c=s.modules[u];if(!c||!(c instanceof y))throw Error("Module '"+u+"' not found");if(!c.supported)throw Error("Module '"+u+"' not supported");}};var C=!1,h=function(){C||(C=!0,s.initialized||d())};if(typeof window==q)v("No window found");else if(typeof document==q)v("No document found");else return a(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",h,!1),a(window,"addEventListener")?window.addEventListener("load",h,!1):a(window,"attachEvent")?window.attachEvent("onload",
h):v("Window does not have required addEventListener or attachEvent method"),s}();
rangy.createModule("DomUtil",function(a,r){function g(a){for(var e=0;a=a.previousSibling;)e++;return e}function x(a,c){var m=[],d;for(d=a;d;d=d.parentNode)m.push(d);for(d=c;d;d=d.parentNode)if(e(m,d))return d;return null}function t(a,e,c){for(c=c?a:a.parentNode;c;){a=c.parentNode;if(a===e)return c;c=a}return null}function v(a){a=a.nodeType;return 3==a||4==a||8==a}function d(a,e){var c=e.nextSibling,m=e.parentNode;c?m.insertBefore(a,c):m.appendChild(a);return a}function y(a){if(9==a.nodeType)return a;
if(typeof a.ownerDocument!=k)return a.ownerDocument;if(typeof a.document!=k)return a.document;if(a.parentNode)return y(a.parentNode);throw Error("getDocument: no document found for node");}function m(a){return!a?"[No node]":v(a)?'"'+a.data+'"':1==a.nodeType?"<"+a.nodeName+(a.id?' id="'+a.id+'"':"")+">["+a.childNodes.length+"]":a.nodeName}function o(a){this._next=this.root=a}function q(a,e){this.node=a;this.offset=e}function p(a){this.code=this[a];this.codeName=a;this.message="DOMException: "+this.codeName}
var k="undefined",c=a.util;c.areHostMethods(document,["createDocumentFragment","createElement","createTextNode"])||r.fail("document missing a Node creation method");c.isHostMethod(document,"getElementsByTagName")||r.fail("document missing getElementsByTagName method");var l=document.createElement("div");c.areHostMethods(l,["insertBefore","appendChild","cloneNode"])||r.fail("Incomplete Element implementation");c.isHostProperty(l,"innerHTML")||r.fail("Element is missing innerHTML property");l=document.createTextNode("test");
c.areHostMethods(l,["splitText","deleteData","insertData","appendData","cloneNode"])||r.fail("Incomplete Text Node implementation");var e=function(a,e){for(var c=a.length;c--;)if(a[c]===e)return!0;return!1};o.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){var a=this._current=this._next,e;if(this._current){e=a.firstChild;if(!e)for(e=null;a!==this.root&&!(e=a.nextSibling);)a=a.parentNode;this._next=e}return this._current},detach:function(){this._current=this._next=this.root=
null}};q.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+m(this.node)+":"+this.offset+")]"}};p.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};p.prototype.toString=function(){return this.message};a.dom={arrayContains:e,isHtmlNamespace:function(a){var e;return typeof a.namespaceURI==k||null===(e=a.namespaceURI)||"http://www.w3.org/1999/xhtml"==
e},parentElement:function(a){a=a.parentNode;return 1==a.nodeType?a:null},getNodeIndex:g,getNodeLength:function(a){var e;return v(a)?a.length:(e=a.childNodes)?e.length:0},getCommonAncestor:x,isAncestorOf:function(a,e,c){for(e=c?e:e.parentNode;e;){if(e===a)return!0;e=e.parentNode}return!1},getClosestAncestorIn:t,isCharacterDataNode:v,insertAfter:d,splitDataNode:function(a,e){var c=a.cloneNode(!1);c.deleteData(0,e);a.deleteData(e,a.length-e);d(c,a);return c},getDocument:y,getWindow:function(a){a=y(a);
...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(a){return c.isHostObject(a,"body")?a.body:a.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var e;e=a.parentNode;)a=e;return a},comparePoints:function(a,e,c,m){var d;if(a==c)return e===m?0:e<m?-1:1;if(d=t(c,a,!0))return e<=g(d)?-1:1;if(d=t(a,c,!0))return g(d)<m?-1:1;e=x(a,c);a=a===e?e:t(a,e,!0);c=c===e?e:t(c,e,!0);if(a===c)throw Error("comparePoints got to case 4 and childA and childB are the same!");
for(e=e.firstChild;e;){if(e===a)return-1;if(e===c)return 1;e=e.nextSibling}throw Error("Should not be here!");},inspectNode:m,fragmentFromNodeChildren:function(a){for(var e=y(a).createDocumentFragment(),c;c=a.firstChild;)e.appendChild(c);return e},createIterator:function(a){return new o(a)},DomPosition:q};a.DOMException=p});
rangy.createModule("DomRange",function(a){function r(b,a){return 3!=b.nodeType&&(j.isAncestorOf(b,a.startContainer,!0)||j.isAncestorOf(b,a.endContainer,!0))}function g(b){return j.getDocument(b.startContainer)}function x(b,a,f){if(a=b._listeners[a])for(var i=0,n=a.length;i<n;++i)a[i].call(b,{target:b,args:f})}function t(b){return new Q(b.parentNode,j.getNodeIndex(b))}function v(b){return new Q(b.parentNode,j.getNodeIndex(b)+1)}function d(b,a,f){var i=11==b.nodeType?b.firstChild:b;j.isCharacterDataNode(a)?
f==a.length?j.insertAfter(b,a):a.parentNode.insertBefore(b,0==f?a:j.splitDataNode(a,f)):f>=a.childNodes.length?a.appendChild(b):a.insertBefore(b,a.childNodes[f]);return i}function y(b){for(var a,f,i=g(b.range).createDocumentFragment();f=b.next();){a=b.isPartiallySelectedSubtree();f=f.cloneNode(!a);a&&(a=b.getSubtreeIterator(),f.appendChild(y(a)),a.detach(!0));if(10==f.nodeType)throw new H("HIERARCHY_REQUEST_ERR");i.appendChild(f)}return i}function m(b,a,f){for(var i,n,f=f||{stop:!1};i=b.next();)if(b.isPartiallySelectedSubtree())if(!1===
a(i)){f.stop=!0;break}else{if(i=b.getSubtreeIterator(),m(i,a,f),i.detach(!0),f.stop)break}else for(i=j.createIterator(i);n=i.next();)if(!1===a(n)){f.stop=!0;return}}function o(b){for(var a;b.next();)b.isPartiallySelectedSubtree()?(a=b.getSubtreeIterator(),o(a),a.detach(!0)):b.remove()}function q(b){for(var a,f=g(b.range).createDocumentFragment(),i;a=b.next();){b.isPartiallySelectedSubtree()?(a=a.cloneNode(!1),i=b.getSubtreeIterator(),a.appendChild(q(i)),i.detach(!0)):b.remove();if(10==a.nodeType)throw new H("HIERARCHY_REQUEST_ERR");
f.appendChild(a)}return f}function p(b,a,f){var i=!(!a||!a.length),n,e=!!f;i&&(n=RegExp("^("+a.join("|")+")$"));var z=[];m(new c(b,!1),function(b){(!i||n.test(b.nodeType))&&(!e||f(b))&&z.push(b)});return z}function k(b){return"["+("undefined"==typeof b.getName?"Range":b.getName())+"("+j.inspectNode(b.startContainer)+":"+b.startOffset+", "+j.inspectNode(b.endContainer)+":"+b.endOffset+")]"}function c(b,a){this.range=b;this.clonePartiallySelectedTextNodes=a;if(!b.collapsed){this.sc=b.startContainer;
this.so=b.startOffset;this.ec=b.endContainer;this.eo=b.endOffset;var f=b.commonAncestorContainer;this.sc===this.ec&&j.isCharacterDataNode(this.sc)?(this.isSingleCharacterDataNode=!0,this._first=this._last=this._next=this.sc):(this._first=this._next=this.sc===f&&!j.isCharacterDataNode(this.sc)?this.sc.childNodes[this.so]:j.getClosestAncestorIn(this.sc,f,!0),this._last=this.ec===f&&!j.isCharacterDataNode(this.ec)?this.ec.childNodes[this.eo-1]:j.getClosestAncestorIn(this.ec,f,!0))}}function l(b){this.code=
this[b];this.codeName=b;this.message="RangeException: "+this.codeName}function e(b,a,f){this.nodes=p(b,a,f);this._next=this.nodes[0];this._position=0}function h(b){return function(a,f){for(var i,n=f?a:a.parentNode;n;){i=n.nodeType;if(j.arrayContains(b,i))return n;n=n.parentNode}return null}}function u(b,a){if(i(b,a))throw new l("INVALID_NODE_TYPE_ERR");}function s(b){if(!b.startContainer)throw new H("INVALID_STATE_ERR");}function w(b,a){if(!j.arrayContains(a,b.nodeType))throw new l("INVALID_NODE_TYPE_ERR");
}function F(b,a){if(0>a||a>(j.isCharacterDataNode(b)?b.length:b.childNodes.length))throw new H("INDEX_SIZE_ERR");}function G(a,f){if(b(a,!0)!==b(f,!0))throw new H("WRONG_DOCUMENT_ERR");}function C(b){if(f(b,!0))throw new H("NO_MODIFICATION_ALLOWED_ERR");}function D(b,a){if(!b)throw new H(a);}function M(a){return!!a.startContainer&&!!a.endContainer&&!(!j.arrayContains(S,a.startContainer.nodeType)&&!b(a.startContainer,!0))&&!(!j.arrayContains(S,a.endContainer.nodeType)&&!b(a.endContainer,!0))&&a.startOffset<=
(j.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(j.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function A(b){s(b);if(!M(b))throw Error("Range error: Range is no longer valid after DOM mutation ("+b.inspect()+")");}function J(){}function N(b){b.START_TO_START=V;b.START_TO_END=Y;b.END_TO_END=ca;b.END_TO_START=Z;b.NODE_BEFORE=$;b.NODE_AFTER=aa;b.NODE_BEFORE_AND_AFTER=ba;b.NODE_INSIDE=W}
function B(b){N(b);N(b.prototype)}function K(b,a){return function(){A(this);var f=this.startContainer,i=this.startOffset,n=this.commonAncestorContainer,e=new c(this,!0);f!==n&&(f=j.getClosestAncestorIn(f,n,!0),i=v(f),f=i.node,i=i.offset);m(e,C);e.reset();n=b(e);e.detach();a(this,f,i,f,i);return n}}function T(b,f,i){function n(b,a){return function(f){s(this);w(f,O);w(L(f),S);f=(b?t:v)(f);(a?e:z)(this,f.node,f.offset)}}function e(b,a,i){var n=b.endContainer,z=b.endOffset;if(a!==b.startContainer||i!==
b.startOffset){if(L(a)!=L(n)||1==j.comparePoints(a,i,n,z))n=a,z=i;f(b,a,i,n,z)}}function z(b,a,i){var n=b.startContainer,e=b.startOffset;if(a!==b.endContainer||i!==b.endOffset){if(L(a)!=L(n)||-1==j.comparePoints(a,i,n,e))n=a,e=i;f(b,n,e,a,i)}}b.prototype=new J;a.util.extend(b.prototype,{setStart:function(b,a){s(this);u(b,!0);F(b,a);e(this,b,a)},setEnd:function(b,a){s(this);u(b,!0);F(b,a);z(this,b,a)},setStartBefore:n(!0,!0),setStartAfter:n(!1,!0),setEndBefore:n(!0,!1),setEndAfter:n(!1,!1),collapse:function(b){A(this);
b?f(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):f(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(b){s(this);u(b,!0);f(this,b,0,b,j.getNodeLength(b))},selectNode:function(b){s(this);u(b,!1);w(b,O);var a=t(b),b=v(b);f(this,a.node,a.offset,b.node,b.offset)},extractContents:K(q,f),deleteContents:K(o,f),canSurroundContents:function(){A(this);C(this.startContainer);C(this.endContainer);var b=new c(this,!0),a=b._first&&
r(b._first,this)||b._last&&r(b._last,this);b.detach();return!a},detach:function(){i(this)},splitBoundaries:function(){A(this);var b=this.startContainer,a=this.startOffset,i=this.endContainer,n=this.endOffset,e=b===i;j.isCharacterDataNode(i)&&0<n&&n<i.length&&j.splitDataNode(i,n);j.isCharacterDataNode(b)&&0<a&&a<b.length&&(b=j.splitDataNode(b,a),e?(n-=a,i=b):i==b.parentNode&&n>=j.getNodeIndex(b)&&n++,a=0);f(this,b,a,i,n)},normalizeBoundaries:function(){A(this);var b=this.startContainer,a=this.startOffset,
i=this.endContainer,n=this.endOffset,e=function(b){var a=b.nextSibling;a&&a.nodeType==b.nodeType&&(i=b,n=b.length,b.appendData(a.data),a.parentNode.removeChild(a))},z=function(f){var e=f.previousSibling;if(e&&e.nodeType==f.nodeType){b=f;var z=f.length;a=e.length;f.insertData(0,e.data);e.parentNode.removeChild(e);b==i?(n+=a,i=b):i==f.parentNode&&(e=j.getNodeIndex(f),n==e?(i=f,n=z):n>e&&n--)}},P=!0;j.isCharacterDataNode(i)?i.length==n&&e(i):(0<n&&(P=i.childNodes[n-1])&&j.isCharacterDataNode(P)&&e(P),
P=!this.collapsed);P?j.isCharacterDataNode(b)?0==a&&z(b):a<b.childNodes.length&&(e=b.childNodes[a])&&j.isCharacterDataNode(e)&&z(e):(b=i,a=n);f(this,b,a,i,n)},collapseToPoint:function(b,a){s(this);u(b,!0);F(b,a);(b!==this.startContainer||a!==this.startOffset||b!==this.endContainer||a!==this.endOffset)&&f(this,b,a,b,a)}});B(b)}function I(b){b.collapsed=b.startContainer===b.endContainer&&b.startOffset===b.endOffset;b.commonAncestorContainer=b.collapsed?b.startContainer:j.getCommonAncestor(b.startContainer,
b.endContainer)}function U(b,a,f,i,n){var e=b.startContainer!==a||b.startOffset!==f,z=b.endContainer!==i||b.endOffset!==n;b.startContainer=a;b.startOffset=f;b.endContainer=i;b.endOffset=n;I(b);x(b,"boundarychange",{startMoved:e,endMoved:z})}function E(b){this.startContainer=b;this.startOffset=0;this.endContainer=b;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};I(this)}a.requireModules(["DomUtil"]);var j=a.dom,Q=j.DomPosition,H=a.DOMException;c.prototype={_current:null,_next:null,_first:null,
_last:null,isSingleCharacterDataNode:!1,reset:function(){this._current=null;this._next=this._first},hasNext:function(){return!!this._next},next:function(){var b=this._current=this._next;b&&(this._next=b!==this._last?b.nextSibling:null,j.isCharacterDataNode(b)&&this.clonePartiallySelectedTextNodes&&(b===this.ec&&(b=b.cloneNode(!0)).deleteData(this.eo,b.length-this.eo),this._current===this.sc&&(b=b.cloneNode(!0)).deleteData(0,this.so)));return b},remove:function(){var b=this._current,a,f;j.isCharacterDataNode(b)&&
(b===this.sc||b===this.ec)?(a=b===this.sc?this.so:0,f=b===this.ec?this.eo:b.length,a!=f&&b.deleteData(a,f-a)):b.parentNode&&b.parentNode.removeChild(b)},isPartiallySelectedSubtree:function(){return r(this._current,this.range)},getSubtreeIterator:function(){var b;if(this.isSingleCharacterDataNode)b=this.range.cloneRange(),b.collapse();else{b=new E(g(this.range));var a=this._current,f=a,i=0,n=a,e=j.getNodeLength(a);j.isAncestorOf(a,this.sc,!0)&&(f=this.sc,i=this.so);j.isAncestorOf(a,this.ec,!0)&&(n=
this.ec,e=this.eo);U(b,f,i,n,e)}return new c(b,this.clonePartiallySelectedTextNodes)},detach:function(b){b&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};l.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};l.prototype.toString=function(){return this.message};e.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
detach:function(){this._current=this._next=this.nodes=null}};var O=[1,3,4,5,7,8,10],S=[2,9,11],R=[1,3,4,5,7,8,10,11],z=[1,3,4,5,7,8],L=j.getRootContainer,b=h([9,11]),f=h([5,6,10,12]),i=h([6,10,12]),n=document.createElement("style"),P=!1;try{n.innerHTML="<b>x</b>",P=3==n.firstChild.nodeType}catch(da){}a.features.htmlParsingConforms=P;var X="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),V=0,Y=1,ca=2,Z=3,$=0,aa=1,ba=2,W=3;J.prototype={attachListener:function(b,
a){this._listeners[b].push(a)},compareBoundaryPoints:function(b,a){A(this);G(this.startContainer,a.startContainer);var f=b==Z||b==V?"start":"end",i=b==Y||b==V?"start":"end";return j.comparePoints(this[f+"Container"],this[f+"Offset"],a[i+"Container"],a[i+"Offset"])},insertNode:function(b){A(this);w(b,R);C(this.startContainer);if(j.isAncestorOf(b,this.startContainer,!0))throw new H("HIERARCHY_REQUEST_ERR");this.setStartBefore(d(b,this.startContainer,this.startOffset))},cloneContents:function(){A(this);
var b,a;if(this.collapsed)return g(this).createDocumentFragment();if(this.startContainer===this.endContainer&&j.isCharacterDataNode(this.startContainer))return b=this.startContainer.cloneNode(!0),b.data=b.data.slice(this.startOffset,this.endOffset),a=g(this).createDocumentFragment(),a.appendChild(b),a;a=new c(this,!0);b=y(a);a.detach();return b},canSurroundContents:function(){A(this);C(this.startContainer);C(this.endContainer);var b=new c(this,!0),a=b._first&&r(b._first,this)||b._last&&r(b._last,
this);b.detach();return!a},surroundContents:function(b){w(b,z);if(!this.canSurroundContents())throw new l("BAD_BOUNDARYPOINTS_ERR");var a=this.extractContents();if(b.hasChildNodes())for(;b.lastChild;)b.removeChild(b.lastChild);d(b,this.startContainer,this.startOffset);b.appendChild(a);this.selectNode(b)},cloneRange:function(){A(this);for(var b=new E(g(this)),a=X.length,f;a--;)f=X[a],b[f]=this[f];return b},toString:function(){A(this);var b=this.startContainer;if(b===this.endContainer&&j.isCharacterDataNode(b))return 3==
b.nodeType||4==b.nodeType?b.data.slice(this.startOffset,this.endOffset):"";var a=[],b=new c(this,!0);m(b,function(b){(3==b.nodeType||4==b.nodeType)&&a.push(b.data)});b.detach();return a.join("")},compareNode:function(b){A(this);var a=b.parentNode,f=j.getNodeIndex(b);if(!a)throw new H("NOT_FOUND_ERR");b=this.comparePoint(a,f);a=this.comparePoint(a,f+1);return 0>b?0<a?ba:$:0<a?aa:W},comparePoint:function(b,a){A(this);D(b,"HIERARCHY_REQUEST_ERR");G(b,this.startContainer);return 0>j.comparePoints(b,a,
this.startContainer,this.startOffset)?-1:0<j.comparePoints(b,a,this.endContainer,this.endOffset)?1:0},createContextualFragment:P?function(b){var a=this.startContainer,f=j.getDocument(a);if(!a)throw new H("INVALID_STATE_ERR");var i=null;1==a.nodeType?i=a:j.isCharacterDataNode(a)&&(i=j.parentElement(a));i=null===i||"HTML"==i.nodeName&&j.isHtmlNamespace(j.getDocument(i).documentElement)&&j.isHtmlNamespace(i)?f.createElement("body"):i.cloneNode(!1);i.innerHTML=b;return j.fragmentFromNodeChildren(i)}:
function(b){s(this);var a=g(this).createElement("body");a.innerHTML=b;return j.fragmentFromNodeChildren(a)},toHtml:function(){A(this);var b=g(this).createElement("div");b.appendChild(this.cloneContents());return b.innerHTML},intersectsNode:function(b,a){A(this);D(b,"NOT_FOUND_ERR");if(j.getDocument(b)!==g(this))return!1;var f=b.parentNode,i=j.getNodeIndex(b);D(f,"NOT_FOUND_ERR");var n=j.comparePoints(f,i,this.endContainer,this.endOffset),f=j.comparePoints(f,i+1,this.startContainer,this.startOffset);
return a?0>=n&&0<=f:0>n&&0<f},isPointInRange:function(b,a){A(this);D(b,"HIERARCHY_REQUEST_ERR");G(b,this.startContainer);return 0<=j.comparePoints(b,a,this.startContainer,this.startOffset)&&0>=j.comparePoints(b,a,this.endContainer,this.endOffset)},intersectsRange:function(b,a){A(this);if(g(b)!=g(this))throw new H("WRONG_DOCUMENT_ERR");var f=j.comparePoints(this.startContainer,this.startOffset,b.endContainer,b.endOffset),i=j.comparePoints(this.endContainer,this.endOffset,b.startContainer,b.startOffset);
return a?0>=f&&0<=i:0>f&&0<i},intersection:function(b){if(this.intersectsRange(b)){var a=j.comparePoints(this.startContainer,this.startOffset,b.startContainer,b.startOffset),f=j.comparePoints(this.endContainer,this.endOffset,b.endContainer,b.endOffset),i=this.cloneRange();-1==a&&i.setStart(b.startContainer,b.startOffset);1==f&&i.setEnd(b.endContainer,b.endOffset);return i}return null},union:function(b){if(this.intersectsRange(b,!0)){var a=this.cloneRange();-1==j.comparePoints(b.startContainer,b.startOffset,
this.startContainer,this.startOffset)&&a.setStart(b.startContainer,b.startOffset);1==j.comparePoints(b.endContainer,b.endOffset,this.endContainer,this.endOffset)&&a.setEnd(b.endContainer,b.endOffset);return a}throw new l("Ranges do not intersect");},containsNode:function(b,a){return a?this.intersectsNode(b,!1):this.compareNode(b)==W},containsNodeContents:function(b){return 0<=this.comparePoint(b,0)&&0>=this.comparePoint(b,j.getNodeLength(b))},containsRange:function(b){return this.intersection(b).equals(b)},
containsNodeText:function(b){var a=this.cloneRange();a.selectNode(b);var f=a.getNodes([3]);return 0<f.length?(a.setStart(f[0],0),b=f.pop(),a.setEnd(b,b.length),b=this.containsRange(a),a.detach(),b):this.containsNodeContents(b)},createNodeIterator:function(b,a){A(this);return new e(this,b,a)},getNodes:function(b,a){A(this);return p(this,b,a)},getDocument:function(){return g(this)},collapseBefore:function(b){s(this);this.setEndBefore(b);this.collapse(!1)},collapseAfter:function(b){s(this);this.setStartAfter(b);
this.collapse(!0)},getName:function(){return"DomRange"},equals:function(b){return E.rangesEqual(this,b)},isValid:function(){return M(this)},inspect:function(){return k(this)}};T(E,U,function(b){s(b);b.startContainer=b.startOffset=b.endContainer=b.endOffset=null;b.collapsed=b.commonAncestorContainer=null;x(b,"detach",null);b._listeners=null});a.rangePrototype=J.prototype;E.rangeProperties=X;E.RangeIterator=c;E.copyComparisonConstants=B;E.createPrototypeRange=T;E.inspect=k;E.getRangeDocument=g;E.rangesEqual=
function(b,a){return b.startContainer===a.startContainer&&b.startOffset===a.startOffset&&b.endContainer===a.endContainer&&b.endOffset===a.endOffset};a.DomRange=E;a.RangeException=l});
rangy.createModule("WrappedRange",function(a){function r(a,d,q,g){var k=a.duplicate();k.collapse(q);var c=k.parentElement();t.isAncestorOf(d,c,!0)||(c=d);if(!c.canHaveHTML)return new v(c.parentNode,t.getNodeIndex(c));var d=t.getDocument(c).createElement("span"),l,e=q?"StartToStart":"StartToEnd";do c.insertBefore(d,d.previousSibling),k.moveToElementText(d);while(0<(l=k.compareEndPoints(e,a))&&d.previousSibling);e=d.nextSibling;if(-1==l&&e&&t.isCharacterDataNode(e)){k.setEndPoint(q?"EndToStart":"EndToEnd",
a);if(/[\r\n]/.test(e.data)){c=k.duplicate();q=c.text.replace(/\r\n/g,"\r").length;for(q=c.moveStart("character",q);-1==c.compareEndPoints("StartToEnd",c);)q++,c.moveStart("character",1)}else q=k.text.length;c=new v(e,q)}else e=(g||!q)&&d.previousSibling,c=(q=(g||q)&&d.nextSibling)&&t.isCharacterDataNode(q)?new v(q,0):e&&t.isCharacterDataNode(e)?new v(e,e.length):new v(c,t.getNodeIndex(d));d.parentNode.removeChild(d);return c}function g(a,d){var q,g,k=a.offset,c=t.getDocument(a.node),l=c.body.createTextRange(),
e=t.isCharacterDataNode(a.node);e?(q=a.node,g=q.parentNode):(q=a.node.childNodes,q=k<q.length?q[k]:null,g=a.node);c=c.createElement("span");c.innerHTML="&#feff;";q?g.insertBefore(c,q):g.appendChild(c);l.moveToElementText(c);l.collapse(!d);g.removeChild(c);if(e)l[d?"moveStart":"moveEnd"]("character",k);return l}a.requireModules(["DomUtil","DomRange"]);var x,t=a.dom,v=t.DomPosition,d=a.DomRange;if(a.features.implementsDomRange&&(!a.features.implementsTextRange||!a.config.preferTextRange))(function(){function m(a){for(var c=
g.length,d;c--;)d=g[c],a[d]=a.nativeRange[d]}var o,g=d.rangeProperties,p;x=function(a){if(!a)throw Error("Range must be specified");this.nativeRange=a;m(this)};d.createPrototypeRange(x,function(a,c,d,m,l){var o=a.endContainer!==m||a.endOffset!=l;if(a.startContainer!==c||a.startOffset!=d||o)a.setEnd(m,l),a.setStart(c,d)},function(a){a.nativeRange.detach();a.detached=!0;for(var c=g.length,d;c--;)d=g[c],a[d]=null});o=x.prototype;o.selectNode=function(a){this.nativeRange.selectNode(a);m(this)};o.deleteContents=
function(){this.nativeRange.deleteContents();m(this)};o.extractContents=function(){var a=this.nativeRange.extractContents();m(this);return a};o.cloneContents=function(){return this.nativeRange.cloneContents()};o.surroundContents=function(a){this.nativeRange.surroundContents(a);m(this)};o.collapse=function(a){this.nativeRange.collapse(a);m(this)};o.cloneRange=function(){return new x(this.nativeRange.cloneRange())};o.refresh=function(){m(this)};o.toString=function(){return this.nativeRange.toString()};
var k=document.createTextNode("test");t.getBody(document).appendChild(k);var c=document.createRange();c.setStart(k,0);c.setEnd(k,0);try{c.setStart(k,1),o.setStart=function(a,c){this.nativeRange.setStart(a,c);m(this)},o.setEnd=function(a,c){this.nativeRange.setEnd(a,c);m(this)},p=function(a){return function(c){this.nativeRange[a](c);m(this)}}}catch(l){o.setStart=function(a,c){try{this.nativeRange.setStart(a,c)}catch(d){this.nativeRange.setEnd(a,c),this.nativeRange.setStart(a,c)}m(this)},o.setEnd=function(a,
c){try{this.nativeRange.setEnd(a,c)}catch(d){this.nativeRange.setStart(a,c),this.nativeRange.setEnd(a,c)}m(this)},p=function(a,c){return function(d){try{this.nativeRange[a](d)}catch(l){this.nativeRange[c](d),this.nativeRange[a](d)}m(this)}}}o.setStartBefore=p("setStartBefore","setEndBefore");o.setStartAfter=p("setStartAfter","setEndAfter");o.setEndBefore=p("setEndBefore","setStartBefore");o.setEndAfter=p("setEndAfter","setStartAfter");c.selectNodeContents(k);o.selectNodeContents=c.startContainer==
k&&c.endContainer==k&&0==c.startOffset&&c.endOffset==k.length?function(a){this.nativeRange.selectNodeContents(a);m(this)}:function(a){this.setStart(a,0);this.setEnd(a,d.getEndOffset(a))};c.selectNodeContents(k);c.setEnd(k,3);p=document.createRange();p.selectNodeContents(k);p.setEnd(k,4);p.setStart(k,2);o.compareBoundaryPoints=-1==c.compareBoundaryPoints(c.START_TO_END,p)&1==c.compareBoundaryPoints(c.END_TO_START,p)?function(a,c){c=c.nativeRange||c;a==c.START_TO_END?a=c.END_TO_START:a==c.END_TO_START&&
(a=c.START_TO_END);return this.nativeRange.compareBoundaryPoints(a,c)}:function(a,c){return this.nativeRange.compareBoundaryPoints(a,c.nativeRange||c)};a.util.isHostMethod(c,"createContextualFragment")&&(o.createContextualFragment=function(a){return this.nativeRange.createContextualFragment(a)});t.getBody(document).removeChild(k);c.detach();p.detach()})(),a.createNativeRange=function(a){return(a||document).createRange()};else if(a.features.implementsTextRange){x=function(a){this.textRange=a;this.refresh()};
x.prototype=new d(document);x.prototype.refresh=function(){var a,d,g=this.textRange;a=g.parentElement();var p=g.duplicate();p.collapse(!0);d=p.parentElement();p=g.duplicate();p.collapse(!1);g=p.parentElement();d=d==g?d:t.getCommonAncestor(d,g);d=d==a?d:t.getCommonAncestor(a,d);0==this.textRange.compareEndPoints("StartToEnd",this.textRange)?d=a=r(this.textRange,d,!0,!0):(a=r(this.textRange,d,!0,!1),d=r(this.textRange,d,!1,!1));this.setStart(a.node,a.offset);this.setEnd(d.node,d.offset)};d.copyComparisonConstants(x);
var y=function(){return this}();"undefined"==typeof y.Range&&(y.Range=x);a.createNativeRange=function(a){return(a||document).body.createTextRange()}}a.features.implementsTextRange&&(x.rangeToTextRange=function(a){if(a.collapsed)return g(new v(a.startContainer,a.startOffset),!0);var d=g(new v(a.startContainer,a.startOffset),!0),q=g(new v(a.endContainer,a.endOffset),!1),a=t.getDocument(a.startContainer).body.createTextRange();a.setEndPoint("StartToStart",d);a.setEndPoint("EndToEnd",q);return a});x.prototype.getName=
...
d=null})});
rangy.createModule("WrappedSelection",function(a,r){function g(a){return(a||window).getSelection()}function x(a){return(a||window).document.selection}function t(a,e,b){var f=b?"end":"start",b=b?"start":"end";a.anchorNode=e[f+"Container"];a.anchorOffset=e[f+"Offset"];a.focusNode=e[b+"Container"];a.focusOffset=e[b+"Offset"]}function v(a){a.anchorNode=a.focusNode=null;a.anchorOffset=a.focusOffset=0;a.rangeCount=0;a.isCollapsed=!0;a._ranges.length=0}function d(z){var c;z instanceof u?(c=z._selectionNativeRange,c||
(c=a.createNativeRange(e.getDocument(z.startContainer)),c.setEnd(z.endContainer,z.endOffset),c.setStart(z.startContainer,z.startOffset),z._selectionNativeRange=c,z.attachListener("detach",function(){this._selectionNativeRange=null}))):z instanceof s?c=z.nativeRange:a.features.implementsDomRange&&z instanceof e.getWindow(z.startContainer).Range&&(c=z);return c}function y(a){var c=a.getNodes(),b;a:if(!c.length||1!=c[0].nodeType)b=!1;else{b=1;for(var f=c.length;b<f;++b)if(!e.isAncestorOf(c[0],c[b])){b=
!1;break a}b=!0}if(!b)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return c[0]}function m(a,e){var b=new s(e);a._ranges=[b];t(a,b,!1);a.rangeCount=1;a.isCollapsed=b.collapsed}function o(c){c._ranges.length=0;if("None"==c.docSelection.type)v(c);else{var d=c.docSelection.createRange();if(d&&"undefined"!=typeof d.text)m(c,d);else{c.rangeCount=d.length;for(var b,f=e.getDocument(d.item(0)),i=0;i<c.rangeCount;++i)b=a.createRange(f),b.selectNode(d.item(i)),
c._ranges.push(b);c.isCollapsed=1==c.rangeCount&&c._ranges[0].collapsed;t(c,c._ranges[c.rangeCount-1],!1)}}}function q(a,c){for(var b=a.docSelection.createRange(),f=y(c),i=e.getDocument(b.item(0)),i=e.getBody(i).createControlRange(),n=0,P=b.length;n<P;++n)i.add(b.item(n));try{i.add(f)}catch(d){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}i.select();o(a)}function p(a,c,b){this.nativeSelection=a;this.docSelection=c;this._ranges=
[];this.win=b;this.refresh()}function k(a,c){for(var b=e.getDocument(c[0].startContainer),b=e.getBody(b).createControlRange(),f=0,i;f<rangeCount;++f){i=y(c[f]);try{b.add(i)}catch(n){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}b.select();o(a)}function c(a,c){if(a.anchorNode&&e.getDocument(a.anchorNode)!==e.getDocument(c))throw new w("WRONG_DOCUMENT_ERR");}function l(a){var c=[],b=new F(a.anchorNode,a.anchorOffset),
f=new F(a.focusNode,a.focusOffset),i="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var n=0,e=a.rangeCount;n<e;++n)c[n]=u.inspect(a.getRangeAt(n));return"["+i+"(Ranges: "+c.join(", ")+")(anchor: "+b.inspect()+", focus: "+f.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var e=a.dom,h=a.util,u=a.DomRange,s=a.WrappedRange,w=a.DOMException,F=e.DomPosition,G,C,D=a.util.isHostMethod(window,"getSelection"),
M=a.util.isHostObject(document,"selection"),A=M&&(!D||a.config.preferTextRange);A?(G=x,a.isSelectionValid=function(a){var a=(a||window).document,c=a.selection;return"None"!=c.type||e.getDocument(c.createRange().parentElement())==a}):D?(G=g,a.isSelectionValid=function(){return!0}):r.fail("Neither document.selection or window.getSelection() detected.");a.getNativeSelection=G;var D=G(),J=a.createNativeRange(document),N=e.getBody(document),B=h.areHostObjects(D,h.areHostProperties(D,["anchorOffset","focusOffset"]));
a.features.selectionHasAnchorAndFocus=B;var K=h.isHostMethod(D,"extend");a.features.selectionHasExtend=K;var T="number"==typeof D.rangeCount;a.features.selectionHasRangeCount=T;var I=!1,U=!0;h.areHostMethods(D,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof D.rangeCount&&a.features.implementsDomRange&&function(){var a=document.createElement("iframe");a.frameBorder=0;a.style.position="absolute";a.style.left="-10000px";N.appendChild(a);var c=e.getIframeDocument(a);c.open();c.write("<html><head></head><body>12</body></html>");
c.close();var b=e.getIframeWindow(a).getSelection(),f=c.documentElement.lastChild.firstChild,c=c.createRange();c.setStart(f,1);c.collapse(true);b.addRange(c);U=b.rangeCount==1;b.removeAllRanges();var i=c.cloneRange();c.setStart(f,0);i.setEnd(f,2);b.addRange(c);b.addRange(i);I=b.rangeCount==2;c.detach();i.detach();N.removeChild(a)}();a.features.selectionSupportsMultipleRanges=I;a.features.collapsedNonEditableSelectionsSupported=U;var E=!1,j;N&&h.isHostMethod(N,"createControlRange")&&(j=N.createControlRange(),
h.areHostProperties(j,["item","add"])&&(E=!0));a.features.implementsControlRange=E;C=B?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:false};var Q;h.isHostMethod(D,"getRangeAt")?Q=function(a,c){try{return a.getRangeAt(c)}catch(b){return null}}:B&&(Q=function(c){var d=e.getDocument(c.anchorNode),d=a.createRange(d);d.setStart(c.anchorNode,c.anchorOffset);d.setEnd(c.focusNode,c.focusOffset);if(d.collapsed!==
this.isCollapsed){d.setStart(c.focusNode,c.focusOffset);d.setEnd(c.anchorNode,c.anchorOffset)}return d});a.getSelection=function(a){var a=a||window,c=a._rangySelection,b=G(a),f=M?x(a):null;if(c){c.nativeSelection=b;c.docSelection=f;c.refresh(a)}else{c=new p(b,f,a);a._rangySelection=c}return c};a.getIframeSelection=function(c){return a.getSelection(e.getIframeWindow(c))};j=p.prototype;if(!A&&B&&h.areHostMethods(D,["removeAllRanges","addRange"])){j.removeAllRanges=function(){this.nativeSelection.removeAllRanges();
v(this)};var H=function(c,e){var b=u.getRangeDocument(e),b=a.createRange(b);b.collapseToPoint(e.endContainer,e.endOffset);c.nativeSelection.addRange(d(b));c.nativeSelection.extend(e.startContainer,e.startOffset);c.refresh()};j.addRange=T?function(c,e){if(E&&M&&this.docSelection.type=="Control")q(this,c);else if(e&&K)H(this,c);else{var b;if(I)b=this.rangeCount;else{this.removeAllRanges();b=0}this.nativeSelection.addRange(d(c));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==b+1){if(a.config.checkSelectionRanges)(b=
Q(this.nativeSelection,this.rangeCount-1))&&!u.rangesEqual(b,c)&&(c=new s(b));this._ranges[this.rangeCount-1]=c;t(this,c,R(this.nativeSelection));this.isCollapsed=C(this)}else this.refresh()}}:function(a,c){if(c&&K)H(this,a);else{this.nativeSelection.addRange(d(a));this.refresh()}};j.setRanges=function(a){if(E&&a.length>1)k(this,a);else{this.removeAllRanges();for(var c=0,b=a.length;c<b;++c)this.addRange(a[c])}}}else if(h.isHostMethod(D,"empty")&&h.isHostMethod(J,"select")&&E&&A)j.removeAllRanges=
function(){try{this.docSelection.empty();if(this.docSelection.type!="None"){var a;if(this.anchorNode)a=e.getDocument(this.anchorNode);else if(this.docSelection.type=="Control"){var c=this.docSelection.createRange();c.length&&(a=e.getDocument(c.item(0)).body.createTextRange())}if(a){a.body.createTextRange().select();this.docSelection.empty()}}}catch(b){}v(this)},j.addRange=function(a){if(this.docSelection.type=="Control")q(this,a);else{s.rangeToTextRange(a).select();this._ranges[0]=a;this.rangeCount=
1;this.isCollapsed=this._ranges[0].collapsed;t(this,a,false)}},j.setRanges=function(a){this.removeAllRanges();var c=a.length;c>1?k(this,a):c&&this.addRange(a[0])};else return r.fail("No means of selecting a Range or TextRange was found"),!1;j.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new w("INDEX_SIZE_ERR");return this._ranges[a]};var O;if(A)O=function(c){var d;if(a.isSelectionValid(c.win))d=c.docSelection.createRange();else{d=e.getBody(c.win.document).createTextRange();d.collapse(true)}c.docSelection.type==
"Control"?o(c):d&&typeof d.text!="undefined"?m(c,d):v(c)};else if(h.isHostMethod(D,"getRangeAt")&&"number"==typeof D.rangeCount)O=function(c){if(E&&M&&c.docSelection.type=="Control")o(c);else{c._ranges.length=c.rangeCount=c.nativeSelection.rangeCount;if(c.rangeCount){for(var e=0,b=c.rangeCount;e<b;++e)c._ranges[e]=new a.WrappedRange(c.nativeSelection.getRangeAt(e));t(c,c._ranges[c.rangeCount-1],R(c.nativeSelection));c.isCollapsed=C(c)}else v(c)}};else if(B&&"boolean"==typeof D.isCollapsed&&"boolean"==
typeof J.collapsed&&a.features.implementsDomRange)O=function(a){var c;c=a.nativeSelection;if(c.anchorNode){c=Q(c,0);a._ranges=[c];a.rangeCount=1;c=a.nativeSelection;a.anchorNode=c.anchorNode;a.anchorOffset=c.anchorOffset;a.focusNode=c.focusNode;a.focusOffset=c.focusOffset;a.isCollapsed=C(a)}else v(a)};else return r.fail("No means of obtaining a Range or TextRange from the user's selection was found"),!1;j.refresh=function(a){var c=a?this._ranges.slice(0):null;O(this);if(a){a=c.length;if(a!=this._ranges.length)return false;
for(;a--;)if(!u.rangesEqual(c[a],this._ranges[a]))return false;return true}};var S=function(a,c){var b=a.getAllRanges(),f=false;a.removeAllRanges();for(var i=0,n=b.length;i<n;++i)f||c!==b[i]?a.addRange(b[i]):f=true;a.rangeCount||v(a)};j.removeRange=E?function(a){if(this.docSelection.type=="Control"){for(var c=this.docSelection.createRange(),a=y(a),b=e.getDocument(c.item(0)),b=e.getBody(b).createControlRange(),f,i=false,n=0,P=c.length;n<P;++n){f=c.item(n);f!==a||i?b.add(c.item(n)):i=true}b.select();
o(this)}else S(this,a)}:function(a){S(this,a)};var R;!A&&B&&a.features.implementsDomRange?(R=function(a){var c=false;a.anchorNode&&(c=e.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset)==1);return c},j.isBackwards=function(){return R(this)}):R=j.isBackwards=function(){return false};j.toString=function(){for(var a=[],c=0,b=this.rangeCount;c<b;++c)a[c]=""+this._ranges[c];return a.join("")};j.collapse=function(d,K){c(this,d);var b=a.createRange(e.getDocument(d));b.collapseToPoint(d,
K);this.removeAllRanges();this.addRange(b);this.isCollapsed=true};j.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new w("INVALID_STATE_ERR");};j.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new w("INVALID_STATE_ERR");};j.selectAllChildren=function(d){c(this,d);var K=a.createRange(e.getDocument(d));K.selectNodeContents(d);this.removeAllRanges();
this.addRange(K)};j.deleteFromDocument=function(){if(E&&M&&this.docSelection.type=="Control"){for(var a=this.docSelection.createRange(),c;a.length;){c=a.item(0);a.remove(c);c.parentNode.removeChild(c)}this.refresh()}else if(this.rangeCount){a=this.getAllRanges();this.removeAllRanges();c=0;for(var b=a.length;c<b;++c)a[c].deleteContents();this.addRange(a[b-1])}};j.getAllRanges=function(){return this._ranges.slice(0)};j.setSingleRange=function(a){this.setRanges([a])};j.containsNode=function(a,c){for(var b=
0,f=this._ranges.length;b<f;++b)if(this._ranges[b].containsNode(a,c))return true;return false};j.toHtml=function(){var a="";if(this.rangeCount){for(var a=u.getRangeDocument(this._ranges[0]).createElement("div"),c=0,b=this._ranges.length;c<b;++c)a.appendChild(this._ranges[c].cloneContents());a=a.innerHTML}return a};j.getName=function(){return"WrappedSelection"};j.inspect=function(){return l(this)};j.detach=function(){this.win=this.anchorNode=this.focusNode=this.win._rangySelection=null};p.inspect=
l;a.Selection=p;a.selectionPrototype=j;a.addCreateMissingNativeApiListener(function(c){if(typeof c.getSelection=="undefined")c.getSelection=function(){return a.getSelection(this)};c=null})});
rangy.createModule("CssClassApplier",function(a,r){function g(a,c){return a.className&&RegExp("(?:^|\\s)"+c+"(?:\\s|$)").test(a.className)}function x(a,c){a.className?g(a,c)||(a.className+=" "+c):a.className=c}function t(a){return a.split(/\s+/).sort().join(" ")}function v(a,c){return t(a.className)==t(c.className)}function d(a){for(var c=a.parentNode;a.hasChildNodes();)c.insertBefore(a.firstChild,a);c.removeChild(a)}function y(a,c){var e=a.cloneRange();e.selectNodeContents(c);var d=e.intersection(a),
d=d?d.toString():"";e.detach();return""!=d}function m(a){return a.getNodes([3],function(c){return y(a,c)})}function o(a,c){if(a.attributes.length!=c.attributes.length)return!1;for(var e=0,d=a.attributes.length,h,j;e<d;++e)if(h=a.attributes[e],j=h.name,"class"!=j&&(j=c.attributes.getNamedItem(j),h.specified!=j.specified||h.specified&&h.nodeValue!==j.nodeValue))return!1;return!0}function q(a,c){for(var e=0,d=a.attributes.length,h;e<d;++e)if(h=a.attributes[e].name,(!c||!w.arrayContains(c,h))&&a.attributes[e].specified&&
"class"!=h)return!0;return!1}function p(a){var c;return a&&1==a.nodeType&&((c=a.parentNode)&&9==c.nodeType&&"on"==c.designMode||C(a)&&!C(a.parentNode))}function k(a){return(C(a)||1!=a.nodeType&&C(a.parentNode))&&!p(a)}function c(a){return a&&1==a.nodeType&&!D.test(G(a,"display"))}function l(a){if(0==a.data.length)return!0;if(M.test(a.data))return!1;switch(G(a.parentNode,"whiteSpace")){case "pre":case "pre-wrap":case "-moz-pre-wrap":return!1;case "pre-line":if(/[\r\n]/.test(a.data))return!1}return c(a.previousSibling)||
c(a.nextSibling)}function e(a,c,d,h){var l,j=0==d;if(w.isAncestorOf(c,a))return a;if(w.isCharacterDataNode(c))if(0==d)d=w.getNodeIndex(c),c=c.parentNode;else if(d==c.length)d=w.getNodeIndex(c)+1,c=c.parentNode;else throw r.createError("splitNodeAt should not be called with offset in the middle of a data node ("+d+" in "+c.data);if(w.isCharacterDataNode(c)?0==d?c.previousSibling:d==c.length?c.nextSibling:1:0<d&&d<c.childNodes.length){if(!l){l=c.cloneNode(!1);for(l.id&&l.removeAttribute("id");j=c.childNodes[d];)l.appendChild(j);
w.insertAfter(l,c)}return c==a?l:e(a,l.parentNode,w.getNodeIndex(l),h)}return a!=c?(l=c.parentNode,c=w.getNodeIndex(c),j||c++,e(a,l,c,h)):a}function h(a){var c=a?"nextSibling":"previousSibling";return function(e,d){var h=e.parentNode,j=e[c];if(j){if(j&&3==j.nodeType)return j}else if(d&&(j=h[c])&&1==j.nodeType&&h.tagName==j.tagName&&v(h,j)&&o(h,j))return j[a?"firstChild":"lastChild"];return null}}function u(a){this.firstTextNode=(this.isElementMerge=1==a.nodeType)?a.lastChild:a;this.textNodes=[this.firstTextNode]}
function s(a,c,e){this.cssClass=a;var d,h,j=null;if("object"==typeof c&&null!==c){e=c.tagNames;j=c.elementProperties;for(d=0;h=N[d++];)c.hasOwnProperty(h)&&(this[h]=c[h]);d=c.normalize}else d=c;this.normalize="undefined"==typeof d?!0:d;this.attrExceptions=[];d=document.createElement(this.elementTagName);this.elementProperties={};for(var l in j)j.hasOwnProperty(l)&&(B.hasOwnProperty(l)&&(l=B[l]),d[l]=j[l],this.elementProperties[l]=d[l],this.attrExceptions.push(l));this.elementSortedClassName=this.elementProperties.hasOwnProperty("className")?
t(this.elementProperties.className+" "+a):a;this.applyToAnyTagName=!1;a=typeof e;if("string"==a)"*"==e?this.applyToAnyTagName=!0:this.tagNames=e.toLowerCase().replace(/^\s\s*/,"").replace(/\s\s*$/,"").split(/\s*,\s*/);else if("object"==a&&"number"==typeof e.length){this.tagNames=[];d=0;for(a=e.length;d<a;++d)"*"==e[d]?this.applyToAnyTagName=!0:this.tagNames.push(e[d].toLowerCase())}else this.tagNames=[this.elementTagName]}a.requireModules(["WrappedSelection","WrappedRange"]);var w=a.dom,F=function(){function a(c,
e,d){return e&&d?" ":""}return function(c,e){c.className&&(c.className=c.className.replace(RegExp("(?:^|\\s)"+e+"(?:\\s|$)"),a))}}(),G;"undefined"!=typeof window.getComputedStyle?G=function(a,c){return w.getWindow(a).getComputedStyle(a,null)[c]}:"undefined"!=typeof document.documentElement.currentStyle?G=function(a,c){return a.currentStyle[c]}:r.fail("No means of obtaining computed style properties found");var C;(function(){C="boolean"==typeof document.createElement("div").isContentEditable?function(a){return a&&
1==a.nodeType&&a.isContentEditable}:function(a){return!a||1!=a.nodeType||"false"==a.contentEditable?!1:"true"==a.contentEditable||C(a.parentNode)}})();var D=/^inline(-block|-table)?$/i,M=/[^\r\n\t\f \u200B]/,A=h(!1),J=h(!0);u.prototype={doMerge:function(){for(var a=[],c,e,d=0,h=this.textNodes.length;d<h;++d)c=this.textNodes[d],e=c.parentNode,a[d]=c.data,d&&(e.removeChild(c),e.hasChildNodes()||e.parentNode.removeChild(e));return this.firstTextNode.data=a=a.join("")},getLength:function(){for(var a=
this.textNodes.length,c=0;a--;)c+=this.textNodes[a].length;return c},toString:function(){for(var a=[],c=0,e=this.textNodes.length;c<e;++c)a[c]="'"+this.textNodes[c].data+"'";return"[Merge("+a.join(",")+")]"}};var N=["elementTagName","ignoreWhiteSpace","applyToEditableOnly"],B={"class":"className"};s.prototype={elementTagName:"span",elementProperties:{},ignoreWhiteSpace:!0,applyToEditableOnly:!1,hasClass:function(a){return 1==a.nodeType&&w.arrayContains(this.tagNames,a.tagName.toLowerCase())&&g(a,
this.cssClass)},getSelfOrAncestorWithClass:function(a){for(;a;){if(this.hasClass(a,this.cssClass))return a;a=a.parentNode}return null},isModifiable:function(a){return!this.applyToEditableOnly||k(a)},isIgnorableWhiteSpaceNode:function(a){return this.ignoreWhiteSpace&&a&&3==a.nodeType&&l(a)},postApply:function(a,c,e){for(var d=a[0],h=a[a.length-1],j=[],l,m=d,g=h,k=0,o=h.length,s,q,b=0,f=a.length;b<f;++b)if(s=a[b],q=A(s,!e)){if(l||(l=new u(q),j.push(l)),l.textNodes.push(s),s===d&&(m=l.firstTextNode,
k=m.length),s===h)g=l.firstTextNode,o=l.getLength()}else l=null;if(a=J(h,!e))l||(l=new u(h),j.push(l)),l.textNodes.push(a);if(j.length){b=0;for(f=j.length;b<f;++b)j[b].doMerge();c.setStart(m,k);c.setEnd(g,o)}},createContainer:function(c){c=c.createElement(this.elementTagName);a.util.extend(c,this.elementProperties);x(c,this.cssClass);return c},applyToTextNode:function(a){var c=a.parentNode;1==c.childNodes.length&&w.arrayContains(this.tagNames,c.tagName.toLowerCase())?x(c,this.cssClass):(c=this.createContainer(w.getDocument(a)),
a.parentNode.insertBefore(c,a),c.appendChild(a))},isRemovable:function(a){var c;if(c=a.tagName.toLowerCase()==this.elementTagName)if(c=t(a.className)==this.elementSortedClassName){var e;a:{c=this.elementProperties;for(e in c)if(c.hasOwnProperty(e)&&a[e]!==c[e]){e=!1;break a}e=!0}c=e&&!q(a,this.attrExceptions)&&this.isModifiable(a)}return c},undoToTextNode:function(a,c,l){c.containsNode(l)||(a=c.cloneRange(),a.selectNode(l),a.isPointInRange(c.endContainer,c.endOffset)&&(e(l,c.endContainer,c.endOffset,
[c]),c.setEndAfter(l)),a.isPointInRange(c.startContainer,c.startOffset)&&(l=e(l,c.startContainer,c.startOffset,[c])));this.isRemovable(l)?d(l):F(l,this.cssClass)},applyToRange:function(a){a.splitBoundaries();var c=m(a);if(c.length){for(var e,d=0,l=c.length;d<l;++d)e=c[d],!this.isIgnorableWhiteSpaceNode(e)&&!this.getSelfOrAncestorWithClass(e)&&this.isModifiable(e)&&this.applyToTextNode(e);a.setStart(c[0],0);e=c[c.length-1];a.setEnd(e,e.length);this.normalize&&this.postApply(c,a,!1)}},applyToSelection:function(c){var c=
a.getSelection(c||window),e,d=c.getAllRanges();c.removeAllRanges();for(var l=d.length;l--;)e=d[l],this.applyToRange(e),c.addRange(e)},undoToRange:function(a){a.splitBoundaries();var c=m(a),e,d,l=c[c.length-1];if(c.length){for(var h=0,g=c.length;h<g;++h)e=c[h],(d=this.getSelfOrAncestorWithClass(e))&&this.isModifiable(e)&&this.undoToTextNode(e,a,d),a.setStart(c[0],0),a.setEnd(l,l.length);this.normalize&&this.postApply(c,a,!0)}},undoToSelection:function(c){var c=a.getSelection(c||window),e=c.getAllRanges(),
d;c.removeAllRanges();for(var l=0,h=e.length;l<h;++l)d=e[l],this.undoToRange(d),c.addRange(d)},getTextSelectedByRange:function(a,c){var e=c.cloneRange();e.selectNodeContents(a);var d=e.intersection(c),d=d?d.toString():"";e.detach();return d},isAppliedToRange:function(a){if(a.collapsed)return!!this.getSelfOrAncestorWithClass(a.commonAncestorContainer);for(var c=a.getNodes([3]),e=0,d;d=c[e++];)if(!this.isIgnorableWhiteSpaceNode(d)&&y(a,d)&&this.isModifiable(d)&&!this.getSelfOrAncestorWithClass(d))return!1;
return!0},isAppliedToSelection:function(c){for(var c=a.getSelection(c||window).getAllRanges(),e=c.length;e--;)if(!this.isAppliedToRange(c[e]))return!1;return!0},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)},toggleSelection:function(a){this.isAppliedToSelection(a)?this.undoToSelection(a):this.applyToSelection(a)},detach:function(){}};s.util={hasClass:g,addClass:x,removeClass:F,hasSameClasses:v,replaceWithOwnChildren:d,elementsHaveSameNonClassAttributes:o,
elementHasNonClassAttributes:q,splitNodeAt:e,isEditableElement:C,isEditingHost:p,isEditable:k};a.CssClassApplier=s;a.createCssClassApplier=function(a,c,e){return new s(a,c,e)}});
rangy.createModule("SaveRestore",function(a,r){function g(a,g){var q="selectionBoundary_"+ +new Date+"_"+(""+Math.random()).slice(2),p,k=d.getDocument(a.startContainer),c=a.cloneRange();c.collapse(g);p=k.createElement("span");p.id=q;p.style.lineHeight="0";p.style.display="none";p.className="rangySelectionBoundary";p.appendChild(k.createTextNode(y));c.insertNode(p);c.detach();return p}function x(a,d,g,p){(a=(a||document).getElementById(g))?(d[p?"setStartBefore":"setEndBefore"](a),a.parentNode.removeChild(a)):
r.warn("Marker element has been removed. Cannot restore selection.")}function t(a,d){return d.compareBoundaryPoints(a.START_TO_START,a)}function v(a,d){var g=(a||document).getElementById(d);g&&g.parentNode.removeChild(g)}a.requireModules(["DomUtil","DomRange","WrappedRange"]);var d=a.dom,y="\ufeff";a.saveSelection=function(d){var d=d||window,o=d.document;if(a.isSelectionValid(d)){var q=a.getSelection(d),p=q.getAllRanges(),k=[],c,l;p.sort(t);for(var e=0,h=p.length;e<h;++e)c=p[e],c.collapsed?(l=g(c,
!1),k.push({markerId:l.id,collapsed:!0})):(l=g(c,!1),c=g(c,!0),k[e]={startMarkerId:c.id,endMarkerId:l.id,collapsed:!1,backwards:1==p.length&&q.isBackwards()});for(e=h-1;0<=e;--e)c=p[e],c.collapsed?c.collapseBefore((o||document).getElementById(k[e].markerId)):(c.setEndBefore((o||document).getElementById(k[e].endMarkerId)),c.setStartAfter((o||document).getElementById(k[e].startMarkerId)));q.setRanges(p);return{win:d,doc:o,rangeInfos:k,restored:!1}}r.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
a.restoreSelection=function(d,g){if(!d.restored){for(var q=d.rangeInfos,p=a.getSelection(d.win),k=[],c=q.length,l=c-1,e,h;0<=l;--l){e=q[l];h=a.createRange(d.doc);if(e.collapsed)if(e=(d.doc||document).getElementById(e.markerId)){e.style.display="inline";var u=e.previousSibling;u&&3==u.nodeType?(e.parentNode.removeChild(e),h.collapseToPoint(u,u.length)):(h.collapseBefore(e),e.parentNode.removeChild(e))}else r.warn("Marker element has been removed. Cannot restore selection.");else x(d.doc,h,e.startMarkerId,
!0),x(d.doc,h,e.endMarkerId,!1);1==c&&h.normalizeBoundaries();k[l]=h}1==c&&g&&a.features.selectionHasExtend&&q[0].backwards?(p.removeAllRanges(),p.addRange(k[0],!0)):p.setRanges(k);d.restored=!0}};a.removeMarkerElement=v;a.removeMarkers=function(a){for(var d=a.rangeInfos,g=0,p=d.length,k;g<p;++g)k=d[g],k.collapsed?v(a.doc,k.markerId):(v(a.doc,k.startMarkerId),v(a.doc,k.endMarkerId))}});
rangy.createModule("Serializer",function(a,r){function g(a,d){var d=d||[],e=a.nodeType,h=a.childNodes,u=h.length,k=[e,a.nodeName,u].join(":"),m="",o="";switch(e){case 3:m=a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;");break;case 8:m="<\!--"+a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;")+"--\>";break;default:m="<"+k+">",o="</>"}m&&d.push(m);for(e=0;e<u;++e)g(h[e],d);o&&d.push(o);return d}function x(a){a=g(a).join("");return p(a).toString(16)}function t(a,d,e){for(var h=[],g=a,e=e||k.getDocument(a).documentElement;g&&
g!=e;)h.push(k.getNodeIndex(g,!0)),g=g.parentNode;return h.join("/")+":"+d}function v(a,d,e){d?e||k.getDocument(d):d=(e||document).documentElement;for(var a=a.split(":"),e=a[0]?a[0].split("/"):[],h=e.length,g;h--;)if(g=parseInt(e[h],10),g<d.childNodes.length)d=d.childNodes[parseInt(e[h],10)];else throw r.createError("deserializePosition failed: node "+k.inspectNode(d)+" has no child with index "+g+", "+h);return new k.DomPosition(d,parseInt(a[1],10))}function d(c,d,e){e=e||a.DomRange.getRangeDocument(c).documentElement;
if(!k.isAncestorOf(e,c.commonAncestorContainer,!0))throw Error("serializeRange: range is not wholly contained within specified root node");c=t(c.startContainer,c.startOffset,e)+","+t(c.endContainer,c.endOffset,e);d||(c+="{"+x(e)+"}");return c}function y(c,d,e){d?e=e||k.getDocument(d):(e=e||document,d=e.documentElement);var c=/^([^,]+),([^,\{]+)({([^}]+)})?$/.exec(c),h=c[4],g=x(d);if(h&&h!==x(d))throw Error("deserializeRange: checksums of serialized range root node ("+h+") and target root node ("+
g+") do not match");h=v(c[1],d,e);d=v(c[2],d,e);e=a.createRange(e);e.setStart(h.node,h.offset);e.setEnd(d.node,d.offset);return e}function m(a,d,e){d?e||k.getDocument(d):d=(e||document).documentElement;a=/^([^,]+),([^,]+)({([^}]+)})?$/.exec(a)[3];return!a||a===x(d)}function o(c,l,e){for(var c=c||a.getSelection(),c=c.getAllRanges(),h=[],g=0,k=c.length;g<k;++g)h[g]=d(c[g],l,e);return h.join("|")}function q(c,d,e){d?e=e||k.getWindow(d):(e=e||window,d=e.document.documentElement);for(var c=c.split("|"),
h=a.getSelection(e),g=[],m=0,o=c.length;m<o;++m)g[m]=y(c[m],d,e.document);h.setRanges(g);return h}a.requireModules(["WrappedSelection","WrappedRange"]);("undefined"==typeof encodeURIComponent||"undefined"==typeof decodeURIComponent)&&r.fail("Global object is missing encodeURIComponent and/or decodeURIComponent method");var p=function(){var a=null;return function(d){for(var e=[],h=0,g=d.length,k;h<g;++h)k=d.charCodeAt(h),128>k?e.push(k):2048>k?e.push(k>>6|192,k&63|128):e.push(k>>12|224,k>>6&63|128,
k&63|128);d=-1;if(!a){for(var h=[],g=0,m;256>g;++g){m=g;for(k=8;k--;)m=1==(m&1)?m>>>1^3988292384:m>>>1;h[g]=m>>>0}a=h}h=a;g=0;for(k=e.length;g<k;++g)m=(d^e[g])&255,d=d>>>8^h[m];return(d^-1)>>>0}}(),k=a.dom;a.serializePosition=t;a.deserializePosition=v;a.serializeRange=d;a.deserializeRange=y;a.canDeserializeRange=m;a.serializeSelection=o;a.deserializeSelection=q;a.canDeserializeSelection=function(a,d,e){var h;d?h=e?e.document:k.getDocument(d):d=(e||window).document.documentElement;for(var a=a.split("|"),
e=0,g=a.length;e<g;++e)if(!m(a[e],d,h))return!1;return!0};a.restoreSelectionFromCookie=function(a){var a=a||window,d;a:{d=a.document.cookie.split(/[;,]/);for(var e=0,h=d.length,g;e<h;++e)if(g=d[e].split("="),"rangySerializedSelection"==g[0].replace(/^\s+/,"")&&(g=g[1])){d=decodeURIComponent(g.replace(/\s+$/,""));break a}d=null}d&&q(d,a.doc)};a.saveSelectionCookie=function(c,d){var c=c||window,d="object"==typeof d?d:{},e=d.expires?";expires="+d.expires.toUTCString():"",h=d.path?";path="+d.path:"",
g=d.domain?";domain="+d.domain:"",k=d.secure?";secure":"",m=o(a.getSelection(c));c.document.cookie=encodeURIComponent("rangySerializedSelection")+"="+encodeURIComponent(m)+e+h+g+k};a.getElementChecksum=x});
(function(a){function r(g){if("string"===typeof g.data){var r=g.handler,t=g.data.toLowerCase().split(" ");g.handler=function(g){if(!(this!==g.target&&(/textarea|select/i.test(g.target.nodeName)||"text"===g.target.type))){var d="keypress"!==g.type&&a.hotkeys.specialKeys[g.which],y=String.fromCharCode(g.which).toLowerCase(),m="",o={};g.altKey&&"alt"!==d&&(m+="alt+");g.ctrlKey&&"ctrl"!==d&&(m+="ctrl+");g.metaKey&&!g.ctrlKey&&"meta"!==d&&(m+="meta+");g.shiftKey&&"shift"!==d&&(m+="shift+");d?o[m+d]=!0:
(o[m+y]=!0,o[m+a.hotkeys.shiftNums[y]]=!0,"shift+"===m&&(o[a.hotkeys.shiftNums[y]]=!0));d=0;for(y=t.length;d<y;d++)if(o[t[d]])return r.apply(this,arguments)}}}}a.hotkeys={version:"0.8",specialKeys:{8:"backspace",9:"tab",13:"return",16:"shift",17:"ctrl",18:"alt",19:"pause",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"insert",46:"del",96:"0",97:"1",98:"2",99:"3",100:"4",101:"5",102:"6",103:"7",104:"8",105:"9",106:"*",107:"+",
...
(function(a,r,g,x){function t(a,f,i){O[a]=i;S[a]=f;H||(H=a)}function v(b){H!==b&&(H=b,a.ui.editor.eachInstance(function(){this.reinit()}))}function d(a,f){H&&O[H]&&O[H][a]&&(a=O[H][a]);if(!f)return a;for(var i in f)a=a.replace("{{"+i+"}}",f[i]);return a}function y(b){if(R===x){R=!0;if(z=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(b.options.baseClass+"-ios"),z&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height",
"-=1")},0)});a.browser.mozilla&&a("html").addClass(b.options.baseClass+"-ff");if(a.browser.msie&&9>a.browser.version){R=!1;var f=a("<div/>").addClass(b.options.baseClass+"-unsupported").html(b.getTemplate("unsupported")).appendTo("body");m(f);f.find("."+b.options.baseClass+"-unsupported-close").click(function(){f.remove()})}}return R}function m(b){var f=1;b.siblings().each(function(){var b=a(this).css("z-index");!isNaN(b)&&b>f&&(f=b+1)});b.css("z-index",f)}function o(a){return a.clone().wrap("<div/>").parent().html()}
function q(a){var f,a=document.createElement(a);f="getComputedStyle"in r;document.body.appendChild(a);f=(f?r.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return f}function p(b,f){return-1!==a.inArray(a(b)[0].tagName.toLowerCase(),f)}function k(b,f){for(var i="",c=0,d=b.childNodes.length;c<d;c++){var e=b.childNodes.item(c);(e=3===e.nodeType?e.nodeValue:o(a(e)))&&(i+=e)}f&&(i=a("<"+f+">"+i+"</"+f+">"),i.find("p").wrapInner("<"+f+"/>"),i.find("p > *").unwrap(),i=a("<div/>").html(i).html());
return i}function c(b,f){var i=a("<div/>").append(b)[0].childNodes;f.deleteContents();i.length===x||1===i.length?f.insertNode(i[0].cloneNode(!0)):a.each(i,function(a,b){f.insertNodeAtEnd(b.cloneNode(!0))})}function l(b){var b=b||g.getSelection(),f;a(b.getAllRanges()).each(function(b,c){f=3===this.commonAncestorContainer.nodeType?a(c.commonAncestorContainer).parent()[0]:c.commonAncestorContainer});return f}function e(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer}function h(a){if(!L||
a)L=g.saveSelection()}function u(){L&&(g.restoreSelection(L),L=!1)}function s(){L&&g.removeMarkers(L);L=!1}function w(a,f,i){for(var f=f||g.getSelection(),c,d=0;c=f.getAllRanges()[d++];)a.call(i,c)}function F(a,f){w(function(f){c(a,f)},f,this)}function G(b,f){f=f||g.getSelection();f.removeAllRanges();a(b).focus().contents().each(function(){var a=g.createRange();a.selectNodeContents(this);f.addRange(a)})}function C(b,f){f=f||g.getSelection();f.removeAllRanges();a(b).each(function(){var a=g.createRange();
a.selectNode(this);f.addRange(a)}).focus()}function D(b,f,i){f=f||g.getSelection();f.removeAllRanges();a(b).each(function(){var a=g.createRange();a.selectNodeContents(this);a.collapse(i);f.addRange(a)})}function M(a,f){D(a,f,!1)}function A(a,f){D(a,f,!0)}function J(a){a=a||g.getSelection();return a.toHtml()}function N(b){b=b||g.getSelection().getRangeAt(0);return a(3===b.commonAncestorContainer.nodeType?b.commonAncestorContainer.parentNode:b.commonAncestorContainer)}function B(a){var f=new jQuery;
w(function(a){f.push(N(a)[0])},a,this);return f}function K(){var b=g.getSelection();if(null===b.anchorNode)return null;if(b.isBackwards())return 3===b.focusNode.nodeType?a(b.focusNode.parentElement):a(b.focusNode);b.anchorNode||console.trace();return 3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode)}function T(){var b=g.getSelection();return null===b.anchorNode?null:b.isBackwards()?3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode):3===b.focusNode.nodeType?
a(b.focusNode.parentElement):a(b.focusNode)}function I(b,f){var f=f||{},i=g.createCssClassApplier(f.classes||"",{normalize:!0,elementTagName:b,elementProperties:f.attributes||{}});w(function(d){var e=d.cloneContents(),e=k(e);"string"===typeof e&&(e=e.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));a(e).is(":empty")?(e=a("<"+b+"/>").addClass(f.classes).attr(f.attributes||{}).append(k(d.cloneContents())),c(e,d)):i.toggleRange(d)},null,this)}function U(a,f,i){w(function(c){c=N(c);c.is(a)?c.attr(f):
I(a,{classes:i,attributes:f})},null,this)}function E(b,f){var f=f||g.getSelection(),i=f.getRangeAt(0),c=B()[0],d=g.createRange();d.setStartBefore(c);d.setEnd(i.startContainer,i.startOffset);var d=d.cloneContents(),e=g.createRange();e.setStart(i.endContainer,i.endOffset);e.setEndAfter(c);i=e.cloneContents();d=o(a(k(d)));d+=o(a(b));d+=o(a(k(i)));a(c).replaceWith(a(d))}function j(a,f,i){var i=i||g.getSelection(),c=K()[0],d=T()[0],e=B()[0],e=p(e,f),c=p(c,f),f=p(d,f);e&&c&&f?F(a):E(a,i)}function Q(a,f){allowed=
[];for(var i=0;i<f.length;i++)f[i].match(/[a-z][a-z0-9]{0,}/g)&&allowed.push(f[i]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,b){return-1<allowed.indexOf(b.toLowerCase())?a:""})}var H=null,O={},S={};a(function(){g.initialized||g.init();a.isFunction(g.rangePrototype.insertNodeAtEnd)||(g.rangePrototype.insertNodeAtEnd=function(a){var f=this.cloneRange();f.collapse(!1);f.insertNode(a);f.detach();this.setEndAfter(a)})});a("html").click(function(){a(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});
a.widget("ui.editor",{_init:function(){-1===a.inArray(this,a.ui.editor.instances)&&a.ui.editor.instances.push(this);var b=this;a.ui.editor.eachInstance(function(a){b!=a&&b.element.closest(a.element).length&&handleError("Nesting editors is unsupported",b.element,a.element)});this.options=a.extend({},a.ui.editor.defaults,this.options);this.options.uiOrder=this.options.uiOrder||[["logo"],["save","cancel"],["dock","showGuides","clean"],["viewSource"],["undo","redo"],["alignLeft","alignCenter","alignJustify",
...
a.extend({},a.ui.editor.templates);this.path=this.toolbarWrapper=this.toolbar=this.wrapper=null;this.visible=this.enabled=!1;this.uiObjects={};this.hotkeys={};this.options.enableHotkeys&&this.registerHotkey(this.hotkeys);for(var f in this.options.bind)this.bind(f,this.options.bind[f]);this.history=[];this.present=0;this.historyEnabled=!0;y(this)&&(this.cloneDomTools(),this.setOriginalHtml(this.element.is(":input")?this.element.val():this.element.html()),this.options.replace&&(this.replaceOriginal(),
this.options.replace=!1),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,this.ready=!0,this.fire("ready"),this.options.autoEnable&&a(function(){b.enableEditing();b.showToolbar()}))},attach:function(){this.bind("change",this.historyPush);this.bind("selectionChange",this.updateTagTree);this.bind("show",this.updateTagTree);var b=a.proxy(this.checkChange,this);this.getElement().find("img").bind("click."+this.widgetName,a.proxy(function(a){C(a.target)},this));
this.getElement().bind("mouseup."+this.widgetName,b);this.getElement().bind("keyup."+this.widgetName,b);a(r).bind("beforeunload",a.proxy(a.ui.editor.unloadWarning,a.ui.editor))},reinit:function(){if(this.ready){var a=this.enabled,f=this.visible;this.destruct();this._init();a&&this.enableEditing();f&&this.showToolbar()}else{var i;i=function(){this.unbind("ready",i);this.reinit()};this.bind("ready",i)}},getElement:function(){return this.target?this.target:this.element},getOriginalElement:function(){return this.element},
replaceOriginal:function(){if(!this.target){for(var b=a("<div/>").html(this.element.is(":input")?this.element.val():this.element.html()).insertBefore(this.element).attr("id",this.getUniqueId()).addClass(this.element.attr("class")),f=this.options.domTools.getStyles(this.element),i=0;i<this.options.replaceStyle.length;i++)b.css(this.options.replaceStyle[i],f[this.options.replaceStyle[i]]);this.element.hide();this.bind("change",function(){this.element.is("input, textarea")?this.element.val(this.getHtml()):
this.element.html(this.getHtml())});this.target=b}},cloneDomTools:function(){for(var a in this.options.domTools)this[a]||(this[a]=function(a){return function(){this.options.domTools.constrainSelection(this.getElement());var b=this.getHtml(),c=this.options.domTools[a].apply(this.options.domTools,arguments);b!==this.getHtml()&&this.change();return c}}(a))},checkChange:function(){var a=g.serializeSelection();this.previousSelection!==a&&this.fire("selectionChange");this.previousSelection=a;var a=this.getCleanHtml(),
f=this.dirty;this.dirty=this.getOriginalHtml()!==a;this.previousHtml!==a&&(this.previousHtml=a,this.change(),f!==this.dirty&&(this.dirty?this.fire("dirty"):this.fire("cleaned")))},change:function(){this.fire("change")},destruct:function(){this.hideToolbar();this.disableEditing();this.fire("destroy",!1);this.events={};this.getElement().unbind("."+this.widgetName);this.wrapper&&this.wrapper.remove()},destroy:function(){this.destruct();a.Widget.prototype.destroy.call(this)},persist:function(b,f){return!this.options.persistence?
null:a.ui.editor.persist(b,f,this.options.namespace)},enableEditing:function(){this.isToolbarLoaded()||this.loadToolbar();this.enabled||(this.enabled=!0,this.getElement().addClass(this.options.baseClass+"-editing"),this.options.partialEdit?this.getElement().find(this.options.partialEdit).attr("contenteditable",!0):this.getElement().attr("contenteditable",!0),this.execCommand("enableInlineTableEditing",!1,!1),this.execCommand("styleWithCSS",!0,!0),this.bindHotkeys(),this.fire("enabled"),this.fire("resize"))},
disableEditing:function(){this.enabled&&(this.enabled=!1,this.getElement().attr("contenteditable",!1).removeClass(this.options.baseClass+"-editing"),g.getSelection().removeAllRanges(),this.fire("disabled"))},isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var b=this,f="",i=[],c=0;w(function(d){var d=d.commonAncestorContainer,e;e=3===d.nodeType?a(d).parent():a(d);d=[];for(i.push(d);e[0]&&!b.isRoot(e)&&"body"!==e[0].tagName.toLowerCase();)d.push(e),e=e.parent();
d.reverse();f&&(f+=" | ");f+=this.getTemplate("root");for(e=0;e<d.length;e++)f+=this.getTemplate("tag",{element:d[e][0].tagName.toLowerCase(),data:"["+c+","+e+"]"});c++},null,this);f||(f=this.getTemplate("root"));this.path.html(f).find("a").click(function(){var f=a(this).data("ui-editor-selection");f?(C(i[f[0]][f[1]]),b.updateTagTree()):C(b.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(b){return this.getElement()[0]===a(b)[0]},unify:function(b,f){!1!==f&&b(this);if(this.options.unify)for(var i=
a.ui.editor.getInstances(),c=0;c<i.length;c++)i[c]!==this&&i[c].options.unify&&b(i[c])},getUniqueId:function(){return a.ui.editor.getUniqueId()},loadMessages:function(){this.messages=a(this.getTemplate("messages")).appendTo(this.wrapper)},showMessage:function(b,f,i){var i=a.extend({},this.options.message,i),c;c={timer:null,editor:this,show:function(){this.element.slideDown();this.timer=r.setTimeout(function(){this.timer=null;c.hide()},i.delay,this)},hide:function(){this.timer&&(r.clearTimeout(this.timer),
this.timer=null);this.element.stop().slideUp(a.proxy(function(){a.isFunction(i.hide)&&i.hide.call(this);this.element.remove()},this))}};c.element=a(this.getTemplate("message",{type:b,message:f})).hide().appendTo(this.messages).find(".ui-editor-message-close").click(function(){c.hide()}).end();c.show();return c},showLoading:function(a,f){return this.showMessage("clock",a,f)},showInfo:function(a,f){return this.showMessage("info",a,f)},showError:function(a,f){return this.showMessage("circle-close",a,
f)},showConfirm:function(a,f){return this.showMessage("circle-check",a,f)},showWarning:function(a,f){return this.showMessage("alert",a,f)},loadToolbar:function(){var b=this.toolbar=a("<div/>").addClass(this.options.baseClass+"-toolbar"),b=this.toolbarWrapper=a("<div/>").addClass(this.options.baseClass+"-toolbar-wrapper").addClass("ui-widget-content").append(b),f=this.path=a("<div/>").addClass(this.options.baseClass+"-path").addClass("ui-widget-header").html(this.getTemplate("root")),i=this.wrapper=
a("<div/>").addClass(this.options.baseClass+"-wrapper").css("display","none").append(f).append(b);a.fn.draggable&&this.options.draggable&&(i.draggable({cancel:"a, button",cursor:"move",handle:".ui-editor-path",stop:a.proxy(function(){var a=this.persist("position",[i.css("top"),i.css("left")]);i.css({top:Math.abs(a[0]),left:Math.abs(a[1])})},this)}),i.css("position",""),(b=this.persist("position")||this.options.dialogPosition)||(b=[10,10]),parseInt(b[0],10)+i.outerHeight()>a(r).height()&&(b[0]=a(r).height()-
i.outerHeight()),parseInt(b[1],10)+i.outerWidth()>a(r).width()&&(b[1]=a(r).width()-i.outerWidth()),i.css({top:Math.abs(parseInt(b[0],10)),left:Math.abs(parseInt(b[1],10))}),this.loadMessages());a(function(){i.appendTo("body")});this.loadUi()},isToolbarLoaded:function(){return null!==this.wrapper},showToolbar:function(b){this.isToolbarLoaded()||this.loadToolbar();if(!this.visible){this.options.unify&&this.hideOtherToolbars(!0);this.visible=!0;this.wrapper.css("display","");this.fire("resize");"undefined"===
typeof this.getElement().attr("tabindex")&&this.getElement().attr("tabindex",-1);if(b)if(b.select)b.select();else{var f=r.getSelection();f.removeAllRanges();f.addRange(b)}var i=this;a(function(){i.fire("show");i.getElement().focus()})}},hideToolbar:function(){this.visible&&(this.visible=!1,this.wrapper.hide(),this.fire("hide"),this.fire("resize"))},hideOtherToolbars:function(a){this.unify(function(f){f.hideToolbar(a)},!1)},isVisible:function(){return this.visible},getTemplate:function(b,f){var i;
i=this.templates[b]?this.templates[b]:a.ui.editor.getTemplate(b,this.options.urlPrefix);i=i.replace(/_\(['"]{1}(.*?)['"]{1}\)/g,function(a,b){b=b.replace(/\\(.?)/g,function(a,b){switch(b){case "\\":return"\\";case "0":return"\x00";case "":return"";default:return b}});return d(b)});f=a.extend({},this.options,f||{});f=this.getTemplateVars(f);return i=i.replace(/\{\{(.*?)\}\}/g,function(a,b){return f[b]})},getTemplateVars:function(a,f,i){f=f?f+".":"";i||(i=1);var c={},d;for(d in a)if("object"===typeof a[d]&&
5>i){var e=this.getTemplateVars(a[d],f+d,++i),g;for(g in e)c[g]=e[g]}else c[f+d]=a[d];return c},historyPush:function(){this.historyEnabled&&this.getHtml()!==this.historyPeak()&&(this.present!==this.history.length-1&&(this.history=this.history.splice(0,this.present+1)),this.history.push(this.getHtml()),this.present=this.history.length-1)},historyPeak:function(){return!this.history.length?null:this.history[this.present]},historyBack:function(){0<this.present&&(this.present--,this.setHtml(this.history[this.present]),
this.historyEnabled=!1,this.change(),this.historyEnabled=!0)},historyForward:function(){this.present<this.history.length-1&&(this.present++,this.setHtml(this.history[this.present]),this.historyEnabled=!1,this.change(),this.historyEnabled=!0)},registerHotkey:function(b,f,i){if("string"===typeof b)this.hotkeys[b]=a.extend({},{context:i,restoreSelection:!0},f);else for(var c in b)this.registerHotkey(c,b[c],i)},bindHotkeys:function(){for(var a in this.hotkeys){var f=this,i=this.hotkeys[a].force||!1;(this.options.enableHotkeys||
i)&&this.getElement().bind("keydown."+this.widgetName,a,function(a){h();var b=f.hotkeys[a.data];!0!==b.action.call(b.context)&&a.preventDefault();b.restoreSelection&&u();f.checkChange()})}},uiEnabled:function(b){return!1===this.options.enableUi&&"undefined"===typeof this.options.ui[b]||!1===this.options.ui[b]||-1!==a.inArray(b,this.options.disabledUi)?!1:!0},getUi:function(a){return this.uiObjects[a]},loadUi:function(){for(var b=0,f=this.options.uiOrder.length;b<f;b++){for(var i=this.options.uiOrder[b],
c=a("<div/>"),d=0,e=i.length;d<e;d++)if(this.uiEnabled(i[d])){var g=i[d].replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});if(a.ui.editor.ui[i[d]]){var h=a.extend({},a.ui.editor.ui[i[d]]),g=a.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-ui-"+g},h.options,this.options.ui[i[d]]);h.editor=this;h.options=g;h.ui=h.init(this,g);h.hotkeys&&(this.registerHotkey(h.hotkeys,null,h),h.ui.title+=" ("+a.map(h.hotkeys,function(a,b){return b})[0]+")");h.ui.init(i[d],this,g,h).appendTo(c);
this.uiObjects[i[d]]=h}}c.addClass("ui-buttonset").addClass(this.options.baseClass+"-buttonset");0<c.children().length&&c.appendTo(this.toolbar)}a("<div/>").css("clear","both").appendTo(this.toolbar)},uiButton:function(b){return a.extend({button:null,options:{},init:function(b,i,c,e){var g=b.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),c=a.extend({},i.options,{baseClass:i.options.baseClass+"-"+g+"-button"},this.options,i.options.ui[b]);this.title||(this.title=d("Unnamed Button"));this.button=
a("<div/>").html(this.label||this.title).addClass(c.baseClass).attr("name",b).attr("title",this.title).val(b);c.classes&&this.button.addClass(c.classes);this.button.bind("mousedown."+e.editor.widgetName,function(a){a.preventDefault()});var h=this;this.button.bind("mouseup."+e.editor.widgetName,function(a){a.preventDefault();h.click.apply(e,arguments)});i.bind("destroy",a.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+g},disabled:c.disabled?
!0:!1,text:this.text||!1,label:this.label||null});this.ready.call(e);return this.button},disable:function(){this.button.button("option","disabled",!0)},enable:function(){this.button.button("option","disabled",!1)},ready:function(){},click:function(){}},b)},uiSelectMenu:function(b){return a.extend({select:null,selectMenu:null,button:null,menu:null,options:{},init:function(b,c){var e=this,g=b.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});a.extend({},c.options,{baseClass:c.options.baseClass+
g+"-select-menu"},e.options,c.options.ui[b]);e.title||(e.title=d("Unnamed Select Menu"));e.wrapper=a('<div class="ui-editor-selectmenu-wrapper"/>').append(e.select.hide()).addClass(e.select.attr("class"));e.selectMenu=a('<div class="ui-editor-selectmenu"/>').appendTo(e.wrapper);e.menu=a('<div class="ui-editor-selectmenu-menu ui-widget-content ui-corner-bottom ui-corner-tr"/>').appendTo(e.wrapper);e.select.find("option, .ui-editor-selectmenu-option").each(function(){a("<div/>").addClass("ui-editor-selectmenu-menu-item").addClass("ui-corner-all").html(a(this).html()).appendTo(e.menu).bind("mouseenter."+
c.widgetName,function(){a(this).addClass("ui-state-focus")}).bind("mouseleave."+c.widgetName,function(){a(this).removeClass("ui-state-focus")}).bind("mousedown."+c.widgetName,function(){return false}).bind("click."+c.widgetName,function(){var b=e.select.find("option, .ui-editor-selectmenu-option").eq(a(this).index()),b=b.attr("value")||b.val();e.select.val(b);e.update();e.wrapper.removeClass("ui-editor-selectmenu-visible");e.button.addClass("ui-corner-all").removeClass("ui-corner-top");e.change(b);
return false})});var g=a("<div/>").addClass("ui-editor-selectmenu-text"),h=a("<div/>").addClass("ui-icon ui-icon-triangle-1-s");e.button=a("<div/>").addClass("ui-editor-selectmenu-button ui-editor-selectmenu-button ui-button ui-state-default").attr("title",e.title).append(g).append(h).prependTo(e.selectMenu);e.button.bind("mousedown."+c.widgetName,function(){return false}).bind("click."+c.widgetName,function(){if(!a(this).hasClass("ui-state-disabled")){parseInt(e.menu.css("min-width"),10)<e.button.outerWidth()+
10&&e.menu.css("min-width",e.button.outerWidth()+10);e.wrapper.toggleClass("ui-editor-selectmenu-visible");return false}}).bind("mouseenter."+c.widgetName,function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover",a(this).hasClass("ui-state-disabled"))}).bind("mouseleave."+c.widgetName,function(){a(this).removeClass("ui-state-hover")});g=e.select.find("option[value="+this.select.val()+"], .ui-editor-selectmenu-option[value="+this.select.val()+"]").html()||e.select.find("option, .ui-editor-selectmenu-option").first().html();
e.button.find(".ui-editor-selectmenu-text").html(g);return e.wrapper},update:function(){var a=this.select.find("option[value="+this.select.val()+"], .ui-editor-selectmenu-option[value="+this.select.val()+"]").html();this.button.find(".ui-editor-selectmenu-text").html(a)},val:function(){var a=this.select.val.apply(this.select,arguments);this.update();return a},change:function(){}},b)},getPlugin:function(a){return this.plugins[a]},loadPlugins:function(){this.options.plugins||(this.options.plugins={});
for(var b in a.ui.editor.plugins)if(!(!1===this.options.enablePlugins&&"undefined"===typeof this.options.plugins[b]||!1===this.options.plugins[b])&&-1===a.inArray(b,this.options.disabledPlugins)){var f=a.extend({},a.ui.editor.plugins[b]),c=b.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),c=a.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-"+c},f.options,this.options.plugins[b]);f.editor=this;f.options=c;f.init(this,c);f.hotkeys&&this.registerHotkey(f.hotkeys,null,f);this.plugins[b]=
f}},isDirty:function(){return this.dirty},getHtml:function(){var b=this.getElement().html(),b=a("<div/>").html(b);b.find(".rangySelectionBoundary").remove();return b=b.html()},getCleanHtml:function(){this.fire("clean");var b=this.getElement().html();this.fire("restore");b=a("<div/>").html(b);b.find(".rangySelectionBoundary").remove();return b=b.html()},setHtml:function(a){this.getElement().html(a);this.fire("html");this.change()},resetHtml:function(){this.setHtml(this.getOriginalHtml());this.fire("cleaned")},
getOriginalHtml:function(){return this.originalHtml},save:function(){var a=this.getCleanHtml();this.fire("save");this.setOriginalHtml(a);this.fire("saved");this.fire("cleaned");return a},setOriginalHtml:function(a){this.originalHtml=a},bind:function(b,f,c){var d=this.events;a.each(b.split(","),function(b,e){e=a.trim(e);d[e]||(d[e]=[]);d[e].push({context:c,callback:f})})},unbind:function(a,f,c){for(var d=0,e=this.events[a].length;d<e;d++)this.events[a][d]&&this.events[a][d].callback===f&&this.events[a][d].context===
c&&this.events[a].splice(d,1)},fire:function(b,f,c){c||this.fire("before:"+b,f,!0);if(this.events[b])for(var d=0,e=this.events[b].length;d<e;d++){var g=this.events[b][d];"undefined"!==typeof g.callback&&g.callback.call(g.context||this)}!1!==f&&a.ui.editor.fire(b);c||this.fire("after:"+b,f,!0)}});a.extend(a.ui.editor,{elementRemoveComments:function(b){b.contents().each(function(){8==this.nodeType&&a(this).remove()});b.children().each(function(){element.removeComments(a(this))});return b},elementRemoveAttributes:function(b,
f){b.children().each(function(){var b=a.map(this.attributes,function(b){if(-1===a.inArray(b.name,f))return b.name}),c=a(this);a.each(b,function(a,b){c.removeAttr(b)});element.removeAttributes(a(this),f)});return b},elementBringToTop:m,elementOuterHtml:o,elementOuterText:function(a){return a.clone().wrap("<div/>").parent().text()},elementIsBlock:function(a){return"block"===q(a.tagName)},elementDefaultDisplay:q,elementIsValid:p,fragmentToHtml:k,fragmentInsertBefore:function(b,f,c){for(var d=0,e=b.childNodes.length;d<
e;d++){var g=b.childNodes.item(d);(g=3===g.nodeType?g.nodeValue:a(g).html())&&a("<"+c+"/>").html(a.trim(g)).insertBefore(f)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},rangeGetCommonAncestor:l,rangeIsEmpty:e,selectionSave:h,selectionRestore:u,selectionDestroy:s,selectionEachRange:w,selectionReplace:F,selectionSelectInner:G,selectionSelectOuter:C,selectionSelectEdge:D,selectionSelectEnd:M,selectionSelectStart:A,selectionGetHtml:J,selectionGetElements:B,
selectionToggleWrapper:I,selectionExists:function(a){var f=!1;w(function(a){e(a)||(f=!0)},a,this);return f},selectionReplaceSplittingSelectedElement:E,selectionReplaceWithinValidTags:j,stringStripTags:Q,defaults:{plugins:{},ui:{},bind:{},domTools:{constrainSelection:function(b,f){var b=a(b)[0],f=f||g.getSelection(),c;a(f.getAllRanges()).each(function(d,e){c=3===this.commonAncestorContainer.nodeType?a(e.commonAncestorContainer).parent()[0]:e.commonAncestorContainer;b!==c&&!a.contains(b,c)&&f.removeRange(e)})},
unwrapParentTag:function(b){B().each(function(){a(this).is(b)&&a(this).replaceWith(a(this).html())})},execCommand:function(a,f,c){try{document.execCommand(a,f,c)}catch(d){}},insertTag:function(b,f){w(function(f){f.insertNode(a("<"+b+"/>")[0])},f,this)},insertTagAtEnd:function(b,f){w(function(f){f.insertNodeAtEnd(a("<"+b+"/>")[0])},f,this)},insertElement:function(b,f,c){w(function(c){a(b).each(function(){c.insertNode(!1===f?this:this.cloneNode(!0))})},c,this)},insertElementAtEnd:function(b,f,c){w(function(c){a(b).each(function(){c.insertNodeAtEnd(!1===
f?this:this.cloneNode(!0))})},c,this)},toggleBlockStyle:function(b,f){w(function(c){for(c=a(c.commonAncestorContainer);c.length&&c[0]!==f[0]&&(3===c[0].nodeType||"inline"===c.css("display"));)c=c.parent();c[0]===f[0]&&"inline"!==f.css("display")&&(this.wrapInner(f,"div"),c=f.children().first());this.toggleStyle(c,b)},null,this)},wrapInner:function(b,f){h();a(b).each(function(){var c=a("<"+f+"/>").html(a(this).html());b.html(c)});u()},inverseWrapWithTagClass:function(b,f,c,d){h();var e="domTools"+
Math.ceil(1E7*Math.random());w(function(a){var b=g.createCssClassApplier(d,{elementTagName:c});b.isAppliedToRange(a)?b.toggleSelection():g.createCssClassApplier(f,{elementTagName:e}).toggleSelection()},null,this);a(e).each(function(){a(this).replaceWith(a("<"+b+"/>").addClass(f).html(a(this).html()))});u()},toggleStyle:function(b,f){a.each(f,function(f,c){a(b).css(f)===c?a(b).css(f,""):a(b).css(f,c)})},getStyles:function(a){for(var f={},a=r.getComputedStyle(a[0],null),c=0;c<a.length;c++)f[a.item(c)]=
a.getPropertyValue(a.item(c));return f},swapStyles:function(a,f,c){for(var d in c)a.css(d,f.css(d)),f.css(d,c[d])}},namespace:null,unify:!0,persistence:!0,persistenceName:"uiEditor",unloadWarning:!0,autoEnable:!1,partialEdit:!1,enablePlugins:!0,disabledPlugins:[],uiOrder:null,enableUi:!0,disabledUi:[],message:{delay:5E3},replace:!1,replaceStyle:"display,position,float,width,padding-left,padding-right,padding-top,padding-bottom,margin-left,margin-right,margin-top,margin-bottom".split(","),baseClass:"ui-editor",
cssPrefix:"cms-",draggable:!0,enableHotkeys:!0,hotkeys:{},supplementaryClass:"supplementary-element-class"},events:{},plugins:{},ui:{},instances:[],getInstances:function(){return this.instances},eachInstance:function(a){for(var f=0;f<this.instances.length;f++)a.call(this.instances[f],this.instances[f])},urlPrefix:"/raptor/",templates:{"paste.dialog":'<div class="ui-editor-paste-panel ui-dialog-content ui-widget-content">\n    <div class="ui-editor-paste-panel-tabs ui-tabs ui-widget ui-widget-content ui-corner-all">\n        <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">\n            <li class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active"><a>_(\'Plain Text\')</a></li>\n            <li class="ui-state-default ui-corner-top"><a>_(\'Formatted &amp; Cleaned\')</a></li>\n            <li class="ui-state-default ui-corner-top"><a>_(\'Formatted Unclean\')</a></li>\n            <li class="ui-state-default ui-corner-top"><a>_(\'Source Code\')</a></li>\n        </ul>\n        <div class="ui-editor-paste-plain-tab">\n            <textarea class="ui-editor-paste-area ui-editor-paste-plain">{{plain}}</textarea>\n        </div>\n        <div class="ui-editor-paste-markup-tab" style="display: none">\n            <div contenteditable="true" class="ui-editor-paste-area ui-editor-paste-markup">{{markup}}</div>\n        </div>\n        <div class="ui-editor-paste-rich-tab" style="display: none">\n            <div contenteditable="true" class="ui-editor-paste-area ui-editor-paste-rich">{{html}}</div>\n        </div>\n        <div class="ui-editor-paste-source-tab" style="display: none">\n            <textarea class="ui-editor-paste-area ui-editor-paste-source">{{html}}</textarea>\n        </div>\n    </div>\n</div>\n',
...
messages:'<div class="{{baseClass}}-messages" />\n'},getTemplate:function(b,f){var c;if(this.templates[b])c=this.templates[b];else{var d=f||this.urlPrefix,e=b.split("."),d=1===e.length?d+("templates/"+e[0]+".html"):d+("plugins/"+e[0]+"/templates/"+e.splice(1).join("/")+".html");a.ajax({url:d,type:"GET",async:!1,timeout:15E3,error:function(){c=null},success:function(a){c=a}});this.templates[b]=c}return c},getUniqueId:function(){for(var b=a.ui.editor.defaults.baseClass+"-uid-"+(new Date).getTime()+
"-"+Math.floor(1E5*Math.random());a("#"+b).length;)b=a.ui.editor.defaults.baseClass+"-uid-"+(new Date).getTime()+"-"+Math.floor(1E5*Math.random());return b},isDirty:function(){for(var a=this.getInstances(),f=0;f<a.length;f++)if(a[f].isDirty())return!0;return!1},unloadWarning:function(){for(var a=this.getInstances(),f=0;f<a.length;f++)if(a[f].isDirty()&&a[f].isEditing()&&a[f].options.unloadWarning)return d("\nThere are unsaved changes on this page. \nIf you navigate away from this page you will lose your unsaved changes")},
defaultUi:{ui:null,editor:null,options:null,init:function(){},persist:function(a,f){return this.editor.persist(a,f)},bind:function(a,f,c){this.editor.bind(a,f,c||this)},unbind:function(a,f,c){this.editor.unbind(a,f,c||this)}},registerUi:function(b,f){if("string"===typeof b)this.ui[b]=a.extend({},this.defaultUi,f);else for(var c in b)this.registerUi(c,b[c])},defaultPlugin:{editor:null,options:null,init:function(){},persist:function(a,f){return this.editor.persist(a,f)},bind:function(a,f,c){this.editor.bind(a,
f,c||this)},unbind:function(a,f,c){this.editor.unbind(a,f,c||this)}},registerPlugin:function(b,f){if("string"===typeof b)this.plugins[b]=a.extend({},this.defaultPlugin,f);else for(var c in b)this.registerPlugin(c,b[c])},bind:function(a,f){this.events[a]||(this.events[a]=[]);this.events[a].push(f)},unbind:function(b){a.each(this.events,function(a){for(var c=0;c<this.length;c++)this[c]===b&&this.events[a].splice(c,1)})},fire:function(a){if(this.events[a])for(var f=0,c=this.events[a].length;f<c;f++)this.events[a][f].call(this)},
persist:function(a,f,c){a=c?c+"."+a:a;if(localStorage){c=localStorage.uiWidgetEditor?JSON.parse(localStorage.uiWidgetEditor):{};if(f===x)return c[a];c[a]=f;localStorage.uiWidgetEditor=JSON.stringify(c)}return f}});var R,z;a.ui.editor.registerUi({alignLeft:{init:function(a){return a.uiButton({title:d("Left Align"),click:function(){a.toggleBlockStyle({"text-align":"left"},a.getElement())}})}},alignJustify:{init:function(a){return a.uiButton({title:d("Justify"),click:function(){a.toggleBlockStyle({"text-align":"justify"},
a.getElement())}})}},alignCenter:{init:function(a){return a.uiButton({title:d("Center Align"),click:function(){a.toggleBlockStyle({"text-align":"center"},a.getElement())}})}},alignRight:{init:function(a){return a.uiButton({title:d("Right Align"),click:function(){a.toggleBlockStyle({"text-align":"right"},a.getElement())}})}}});a.ui.editor.registerUi({textBold:{hotkeys:{"ctrl+b":{action:function(){this.ui.click()}}},init:function(a,f){return this.editor.uiButton({title:d("Bold"),click:function(){I("strong",
{classes:f.classes||f.cssPrefix+"bold"})}})}},textItalic:{hotkeys:{"ctrl+i":{action:function(){this.ui.click()}}},init:function(a,f){return a.uiButton({title:d("Italic"),click:function(){I("em",{classes:f.classes||f.cssPrefix+"italic"})}})}},textUnderline:{hotkeys:{"ctrl+u":{action:function(){this.ui.click()}}},init:function(a,f){return a.uiButton({title:d("Underline"),click:function(){I("u",{classes:f.classes||f.cssPrefix+"underline"})}})}},textStrike:{hotkeys:{"ctrl+k":{action:function(){this.ui.click()}}},
init:function(a,f){return a.uiButton({title:d("Strikethrough"),click:function(){I("del",{classes:f.classes||f.cssPrefix+"strike"})}})}},textSub:{init:function(a,f){return a.uiButton({title:d("Sub script"),click:function(){I("sub",{classes:f.classes||f.cssPrefix+"sub"})}})}},textSuper:{init:function(a,f){return a.uiButton({title:d("Super script"),click:function(){I("sup",{classes:f.classes||f.cssPrefix+"super"})}})}}});a.ui.editor.registerUi({quoteBlock:{init:function(a,f){return a.uiButton({title:d("Blockquote"),
icon:"ui-icon-quote",click:function(){I("blockquote",{classes:f.classes||f.cssPrefix+"blockquote"})}})}}});a.ui.editor.registerUi({cancel:{hotkeys:{esc:{action:function(){this.confirm()}}},init:function(a){return a.uiButton({name:"cancel",title:d("Cancel"),icons:{primary:"ui-icon-cancel"},dialog:null,click:function(){this.confirm()}})},confirm:function(){var b=this.editor.getPlugin("cancel"),f=this.editor;f.isDirty()?(this.dialog||(this.dialog=a(f.getTemplate("cancel.dialog"))),this.dialog.dialog({modal:!0,
resizable:!1,title:d("Confirm Cancel Editing"),dialogClass:f.options.dialogClass+" "+f.options.baseClass,show:f.options.dialogShowAnimation,hide:f.options.dialogHideAnimation,buttons:[{text:d("OK"),click:function(){b.cancel();a(this).dialog("close")}},{text:d("Cancel"),click:function(){a(this).dialog("close")}}],open:function(){var b=a(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},
close:function(){a(this).dialog("destroy").remove()}})):b.cancel()}}});a.ui.editor.registerPlugin({cancel:{cancel:function(){this.editor.unify(function(a){a.fire("cancel");a.resetHtml();a.hideToolbar();a.disableEditing();s()})}}});a.ui.editor.registerPlugin("clean",{options:{stripAttrs:["_moz_dirty"],stripAttrContent:{type:"_moz"},stripEmptyTags:"span,h1,h2,h3,h4,h5,h6,p,b,i,u,strong,em,big,small,div".split(","),stripEmptyAttrs:["class","id","style"],stripDomains:[{selector:"a",attributes:["href"]},
{selector:"img",attributes:["src"]}]},init:function(a){a.bind("change",this.clean,this)},clean:function(){var b,f=this.editor;for(b=0;b<this.options.stripAttrs.length;b++)f.getElement().find("["+this.options.stripAttrs[b]+"]").removeAttr(this.options.stripAttrs[b]);for(b=0;b<this.options.stripAttrContent.length;b++)f.getElement().find("["+b+'="'+this.options.stripAttrs[b]+'"]').removeAttr(this.options.stripAttrs[b]);for(b=0;b<this.options.stripEmptyTags.length;b++)f.getElement().find(this.options.stripEmptyTags[b]).filter(function(){if(a(this).hasClass(f.options.supplementaryClass))return!1;
...
for(f=c.commonAncestorContainer;f&&f.parentNode!=b.getElement().get(0);)f=f.parentNode;if(f){c.setEndAfter(f);var e=c.extractContents();c.collapseAfter(f);c.insertNode(e);c.collapseAfter(f)}c.insertNode(document.createTextNode(d))}b.checkChange()}})}}});a.ui.editor.registerPlugin("clickButtonToEdit",{hovering:!1,button:!1,options:{button:{text:!0,icons:{primary:"ui-icon-pencil"}}},init:function(b,c){var d=this;this.selection=function(){var a;document.selection?a=document.selection.createRange():document.getSelection().rangeCount&&
(a=document.getSelection().getRangeAt(0));return a};this.show=function(){if(!b.isEditing()){b.getElement().addClass(c.baseClass+"-highlight");b.getElement().addClass(c.baseClass+"-hover");var e=d.getButton();var g=b.getElement(),g=a(g),h=Math.round(g.offset().top),j=Math.round(g.offset().left),k=Math.round(g.outerWidth()),g=Math.round(g.outerHeight()),l=a(r).scrollTop(),m=a(r).height(),o=l+m,p=Math.round(g+h);l<h&&o>p||(l>h&&(h=l),g=o<p?o-h:m-(o-p));e.css({position:"absolute",top:h+(g/2-a(e).outerHeight()/
2),left:j+k/2-a(e).outerWidth()/2});e.addClass(c.baseClass+"-visible")}};this.hide=function(e){var g=d.getButton();if(!e||!(e.relatedTarget===g.get(0)||g.get(0)===a(e.relatedTarget).parent().get(0)))b.getElement().removeClass(c.baseClass+"-highlight"),b.getElement().removeClass(c.baseClass+"-hover"),g.removeClass(c.baseClass+"-visible")};this.edit=function(){d.hide();b.isEditing()||b.enableEditing();b.isVisible()||b.showToolbar(d.selection())};this.buttonOut=function(){d.getButton().hasClass(c.baseClass+
"-visible")||(r.clearTimeout(d.timeoutId),d.timeoutId=r.setTimeout(d.hide,350))};b.getElement().addClass("ui-editor-click-button-to-edit");b.bind("ready, hide, cancel",function(){b.getElement().bind("mouseenter."+b.widgetName,d.show);b.getElement().bind("mouseleave."+b.widgetName,d.hide)});b.bind("show",function(){d.destroyButton();b.getElement().unbind("mouseenter."+b.widgetName,d.show);b.getElement().unbind("mouseleave."+b.widgetName,d.hide)})},getButton:function(){!1===this.button&&(this.button=
...
this.dialog=null;a(this.ui.button).button("option","disabled",!1)},show:function(){if(!this.dialog){a(this.ui.button).button("option","disabled",!0);var b=this;h();this.dialog=a(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:d("Paste Embed Code"),autoOpen:!0,dialogClass:b.options.baseClass+" "+b.options.dialogClass,buttons:[{text:d("Embed Object"),click:function(){u();F(a(this).find("textarea").val());a(this).dialog("close")}},{text:d("Close"),
...
d.data=d.data.apply(this,[c,b]):this.options.postName&&(d.data={},d.data[this.options.postName]=JSON.stringify(b));a.isFunction(d.url)&&(d.url=d.url.apply(this,[c]));this.requests++;a.ajax(d).done(a.proxy(this.done,this)).fail(a.proxy(this.fail,this)).always(a.proxy(this.always,this))}});a.ui.editor.registerPlugin("saveRest",{options:{showResponse:!1,ajax:{url:"/",type:"post",cache:!1}},init:function(){},getId:function(){if("string"===typeof this.options.id)return this.options.id;if(this.options.id.attr){var a=
this.editor.getOriginalElement().attr(this.options.id.attr);if(a)return a}return null},getData:function(){this.getId();this.editor.save();return this.editor.save()},save:function(){this.message=this.editor.showLoading(d("Saving changes..."));var a=this.requests=this.failed=this.saved=0;this.editor.unify(function(c){if(c.isDirty()){a++;var c=c.getPlugin("saveRest"),d=c.editor.save();c.ajax(d)}});this.dirty=a;0===a&&(this.message.hide(),this.editor.showInfo(d("No changes detected to save...")))},done:function(a){this.options.multiple?
this.saved++:this.saved=this.dirty;this.options.showResponse&&this.editor.showConfirm(a,{delay:1E3,hide:function(){this.editor.unify(function(a){a.disableEditing();a.hideToolbar()})}})},fail:function(a){this.options.multiple?this.failed++:this.failed=this.dirty;this.options.showResponse&&this.editor.showError(a.responseText)},always:function(){this.dirty===this.saved+this.failed&&(this.options.showResponse||(0<this.failed&&0===this.saved?this.editor.showError(d("Failed to save {{failed}} content block(s).",
this)):0<this.failed?this.editor.showError(d("Saved {{saved}} out of {{dirty}} content blocks.",this)):this.editor.showConfirm(d("Successfully saved {{saved}} content block(s).",this),{delay:1E3,hide:function(){this.editor.unify(function(a){a.disableEditing();a.hideToolbar()})}})),this.message.hide(),this.message=null)},ajax:function(b,c){var d=a.extend(!0,{},this.options.ajax);a.isFunction(d.data)?d.data=d.data.apply(this,[c,b]):this.options.postName&&(d.data={},d.data[this.options.postName]=JSON.stringify(b));
a.isFunction(d.url)&&(d.url=d.url.apply(this,[c]));this.requests++;a.ajax(d).done(a.proxy(this.done,this)).fail(a.proxy(this.fail,this)).always(a.proxy(this.always,this))}});a.ui.editor.registerUi({save:{options:{plugin:"saveJson"},init:function(a){return a.uiButton({title:d("Save"),icon:"ui-icon-save",click:function(){a.checkChange();a.getPlugin(this.options.plugin).save()}})}}});a.ui.editor.registerPlugin({snippet:{ids:[],enabled:!1,init:function(a,c){if(c.snippets){for(var d=0,e=c.snippets.length;d<
e;d++)this.createSnippet(c.snippets[d],a);a.bind("restore",this.createButtons,this);a.bind("save",this.disable,this);a.bind("cancel",this.disable,this);a.bind("enabled",this.enable,this);a.bind("disabled",this.disable,this)}},createSnippet:function(){},enable:function(){this.enabled=!0;this.createButtons()},disable:function(){this.removeButtons();this.enabled=!1},createButtons:function(){for(var a=this.editor,c=0,d=this.options.snippets.length;c<d;c++){var e=this.options.snippets[c];e.repeatable&&
this.createButton(e,a)}},createButton:function(b,c){if(this.enabled){var d=this,e=c.getUniqueId();this.ids.push(e);var g=a("<button/>").addClass(d.options.baseClass).addClass(d.options.baseClass+"-button").addClass(d.options.baseClass+"-button-"+b.name).addClass(e).text("Add").click(function(){d.insertSnippet.call(d,b,c,this)}),h=b.buttonAfter||c.getElement();a.isFunction(h)?h.call(this,g,b):g.insertAfter(h);a("."+e).button({icons:{primary:"ui-icon-plusthick"}})}},removeButtons:function(){if(this.enabled){for(var b=
0,c=this.ids.length;b<c;b++)a("."+this.ids[b]).remove();b=0;for(c=this.options.snippets.length;b<c;b++){var d=this.options.snippets[b];a.isFunction(d.clean)&&d.clean.call(d,this,this.editor)}}},insertSnippet:function(b,c,d){var e=a(b.template).html(),g=b.appendTo||c.getElement();a.isFunction(g)?g.call(this,e,b,d):a(e).appendTo(g);c.disableEditing();c.enableEditing()}}});a.ui.editor.registerUi({statistics:{options:{maximum:null},init:function(b){b.bind("show",a.proxy(this.updateCount,this));b.bind("change",
a.proxy(this.updateCount,this));return this.editor.uiButton({title:d("Remaining characters before the recommended character limit is reached"),label:d("Initializing"),text:!0,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var b=this.options.maximum-a("<div/>").html(this.editor.getCleanHtml()).text().length,c=this.ui.button;if(!1===this.options.maximum)c.button("option","text",!1);else{var e=null,e=0<=b?d("{{charactersRemaining}} characters remaining",{charactersRemaining:b}):
d("{{charactersRemaining}} characters over limit",{charactersRemaining:-1*b});c.button("option","label",e);c.button("option","text",!0);0>b?c.addClass("ui-state-error"):0<=b&&15>=b?c.addClass("ui-state-highlight").removeClass("ui-state-error"):c.removeClass("ui-state-highlight ui-state-error")}},showStatistics:function(){this.processTemplate().dialog({modal:!0,resizable:!1,title:d("Content Statistics"),dialogClass:this.editor.options.dialogClass+" "+this.editor.options.baseClass,show:this.editor.options.dialogShowAnimation,
hide:this.editor.options.dialogHideAnimation,buttons:[{text:d("OK"),click:function(){a(this).dialog("close")}}],open:function(){a(this).parent().find(".ui-dialog-buttonpane").find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}})},close:function(){a(this).dialog("destroy").remove()}})},processTemplate:function(){var b=a("<div/>").html(this.editor.getCleanHtml()).text(),c=null,e=this.options.maximum-b.length,c=0>e?d("Content contains more than {{limit}} characters and may be truncated",
{limit:this.options.maximum}):d("Content will not be truncated"),g=null,g=b.split(" ").length,g=1==g?d("{{words}} word",{words:g}):d("{{words}} words",{words:g}),h=null,h=b.split(". ").length,h=d("{{sentences}} sentences",{sentences:h}),j=null,j=0<=e?d("{{characters}} characters, {{charactersRemaining}} remaining",{characters:b.length,charactersRemaining:e}):d("{{characters}} characters, {{charactersRemaining}} over the recommended limit",{characters:b.length,charactersRemaining:-1*e});return a(this.editor.getTemplate("statistics.dialog",
{characters:j,words:g,sentences:h,truncation:c}))}}});a.ui.editor.registerUi({tagMenu:{validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),init:function(b){b.bind("selectionChange",this.change,this);b.bind("show",this.change,this);return b.uiSelectMenu({name:"tagMenu",title:d("Change HTML tag of selected element"),select:a(b.getTemplate("tagmenu.menu")),change:function(c){if(!("undefined"===typeof c||"na"===c)){var d=b.getElement()[0],
e=B();if(!J()||""===J()){if(a(e)[0]===a(d)[0])return;h();d=a("<"+c+">").html(e.html());e.replaceWith(d);u()}else{var e=a(B()[0]).parent(),g=this.options.baseClass+"-selection",c=a("<"+c+">").html(J()).addClass(g);e===d||B()[0]===d?F(c):j(c,this.validParents);G(b.getElement().find("."+g).removeClass(g))}b.checkChange()}}})},change:function(){var b=B()[0];b?(b=b.tagName.toLowerCase(),this.ui.select.find("option[value="+b+"]").length?this.ui.val(b):this.ui.val("na"),a(this.ui.button).toggleClass("ui-state-disabled",
this.editor.getElement()[0]===B()[0])):a(this.ui.button).toggleClass("ui-state-disabled",!0)}}});a.ui.editor.registerPlugin("toolbarTip",{init:function(){a.browser.msie||this.bind("show, tagTreeUpdated",function(){a(".ui-editor-wrapper [title]").each(function(){a(this).attr("data-title",a(this).attr("title"));a(this).removeAttr("title")})})}});(function(){var b=null,c=0;a.ui.editor.registerPlugin("unsavedEditWarning",{init:function(d){var e=this;b||(b=a(d.getTemplate("unsavededitwarning.warning",
this.options)).attr("id",d.getUniqueId()).appendTo("body").bind("mouseenter."+d.widgetName,function(){a.ui.editor.eachInstance(function(a){a.isDirty()&&a.getElement().addClass(e.options.baseClass+"-dirty")})}).bind("mouseleave."+d.widgetName,function(){a("."+e.options.baseClass+"-dirty").removeClass(e.options.baseClass+"-dirty")}));d.bind("dirty",function(){c++;0<c&&(m(b),b.addClass(e.options.baseClass+"-visible"))});d.bind("cleaned",function(){c--;0===c&&b.removeClass(e.options.baseClass+"-visible")})}})})();
