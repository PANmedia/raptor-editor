/*! VERSION: 0.0.2 *//*
 ...
 Build date: 26 February 2012
*/
window.rangy=function(){function d(a,c){var b=typeof a[c];return b==p||!!(b==n&&a[c])||b=="unknown"}function q(a,c){return!!(typeof a[c]==n&&a[c])}function k(a,c){return typeof a[c]!=h}function t(a){return function(c,b){for(var d=b.length;d--;)if(!a(c,b[d]))return false;return true}}function r(d){return d&&c(d,b)&&g(d,a)}function s(a){window.alert("Rangy not supported in your browser. Reason: "+a);i.initialized=true;i.supported=false}function f(){if(!i.initialized){var a,b=false,e=false;d(document,
"createRange")&&(a=document.createRange(),c(a,l)&&g(a,m)&&(b=true),a.detach());if((a=q(document,"body")?document.body:document.getElementsByTagName("body")[0])&&d(a,"createTextRange"))a=a.createTextRange(),r(a)&&(e=true);!b&&!e&&s("Neither Range nor TextRange are implemented");i.initialized=true;i.features={implementsDomRange:b,implementsTextRange:e};b=C.concat(o);e=0;for(a=b.length;e<a;++e)try{b[e](i)}catch(n){q(window,"console")&&d(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
n)}}}function w(a){this.name=a;this.supported=this.initialized=false}var n="object",p="function",h="undefined",m="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer,START_TO_START,START_TO_END,END_TO_START,END_TO_END".split(","),l="setStart,setStartBefore,setStartAfter,setEnd,setEndBefore,setEndAfter,collapse,selectNode,selectNodeContents,compareBoundaryPoints,deleteContents,extractContents,cloneContents,insertNode,surroundContents,cloneRange,toString,detach".split(","),
a="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),b="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),c=t(d),e=t(q),g=t(k),i={version:"1.2.3",initialized:false,supported:true,util:{isHostMethod:d,isHostObject:q,isHostProperty:k,areHostMethods:c,areHostObjects:e,areHostProperties:g,isTextRange:r},features:{},modules:{},config:{alertOnWarn:false,preferTextRange:false}};
i.fail=s;i.warn=function(a){a="Rangy warning: "+a;i.config.alertOnWarn?window.alert(a):typeof window.console!=h&&typeof window.console.log!=h&&window.console.log(a)};({}).hasOwnProperty?i.util.extend=function(a,c){for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b])}:s("hasOwnProperty not supported");var o=[],C=[];i.init=f;i.addInitListener=function(a){i.initialized?a(i):o.push(a)};var B=[];i.addCreateMissingNativeApiListener=function(a){B.push(a)};i.createMissingNativeApi=function(a){a=a||window;f();
...
rangy.createModule("DomUtil",function(d,q){function k(a){for(var c=0;a=a.previousSibling;)c++;return c}function t(a,b){var d=[],n;for(n=a;n;n=n.parentNode)d.push(n);for(n=b;n;n=n.parentNode)if(c(d,n))return n;return null}function r(a,c,b){for(b=b?a:a.parentNode;b;){a=b.parentNode;if(a===c)return b;b=a}return null}function s(a){a=a.nodeType;return a==3||a==4||a==8}function f(a,c){var b=c.nextSibling,d=c.parentNode;b?d.insertBefore(a,b):d.appendChild(a);return a}function w(a){if(a.nodeType==9)return a;
else if(typeof a.ownerDocument!=l)return a.ownerDocument;else if(typeof a.document!=l)return a.document;else if(a.parentNode)return w(a.parentNode);else throw Error("getDocument: no document found for node");}function n(a){return!a?"[No node]":s(a)?'"'+a.data+'"':a.nodeType==1?"<"+a.nodeName+(a.id?' id="'+a.id+'"':"")+">["+a.childNodes.length+"]":a.nodeName}function p(a){this._next=this.root=a}function h(a,c){this.node=a;this.offset=c}function m(a){this.code=this[a];this.codeName=a;this.message="DOMException: "+
this.codeName}var l="undefined",a=d.util;a.areHostMethods(document,["createDocumentFragment","createElement","createTextNode"])||q.fail("document missing a Node creation method");a.isHostMethod(document,"getElementsByTagName")||q.fail("document missing getElementsByTagName method");var b=document.createElement("div");a.areHostMethods(b,["insertBefore","appendChild","cloneNode"])||q.fail("Incomplete Element implementation");a.isHostProperty(b,"innerHTML")||q.fail("Element is missing innerHTML property");
b=document.createTextNode("test");a.areHostMethods(b,["splitText","deleteData","insertData","appendData","cloneNode"])||q.fail("Incomplete Text Node implementation");var c=function(a,c){for(var b=a.length;b--;)if(a[b]===c)return true;return false};p.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){var a=this._current=this._next,c;if(this._current){c=a.firstChild;if(!c)for(c=null;a!==this.root&&!(c=a.nextSibling);)a=a.parentNode;this._next=c}return this._current},detach:function(){this._current=
this._next=this.root=null}};h.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+n(this.node)+":"+this.offset+")]"}};m.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};m.prototype.toString=function(){return this.message};d.dom={arrayContains:c,isHtmlNamespace:function(a){var c;return typeof a.namespaceURI==l||(c=a.namespaceURI)===
null||c=="http://www.w3.org/1999/xhtml"},parentElement:function(a){a=a.parentNode;return a.nodeType==1?a:null},getNodeIndex:k,getNodeLength:function(a){var c;return s(a)?a.length:(c=a.childNodes)?c.length:0},getCommonAncestor:t,isAncestorOf:function(a,c,b){for(c=b?c:c.parentNode;c;)if(c===a)return true;else c=c.parentNode;return false},getClosestAncestorIn:r,isCharacterDataNode:s,insertAfter:f,splitDataNode:function(a,c){var b=a.cloneNode(false);b.deleteData(0,c);a.deleteData(c,a.length-c);f(b,a);
return b},getDocument:w,getWindow:function(a){a=w(a);if(typeof a.defaultView!=l)return a.defaultView;else if(typeof a.parentWindow!=l)return a.parentWindow;else throw Error("Cannot get a window object for node");},getIframeWindow:function(a){if(typeof a.contentWindow!=l)return a.contentWindow;else if(typeof a.contentDocument!=l)return a.contentDocument.defaultView;else throw Error("getIframeWindow: No Window object found for iframe element");},getIframeDocument:function(a){if(typeof a.contentDocument!=
l)return a.contentDocument;else if(typeof a.contentWindow!=l)return a.contentWindow.document;else throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(c){return a.isHostObject(c,"body")?c.body:c.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var c;c=a.parentNode;)a=c;return a},comparePoints:function(a,c,b,d){var n;if(a==b)return c===d?0:c<d?-1:1;else if(n=r(b,a,true))return c<=k(n)?-1:1;else if(n=r(a,b,true))return k(n)<d?-1:1;else if(c=
t(a,b),a=a===c?c:r(a,c,true),b=b===c?c:r(b,c,true),a===b)throw Error("comparePoints got to case 4 and childA and childB are the same!");else{for(c=c.firstChild;c;){if(c===a)return-1;else if(c===b)return 1;c=c.nextSibling}throw Error("Should not be here!");}},inspectNode:n,fragmentFromNodeChildren:function(a){for(var c=w(a).createDocumentFragment(),b;b=a.firstChild;)c.appendChild(b);return c},createIterator:function(a){return new p(a)},DomPosition:h};d.DOMException=m});
rangy.createModule("DomRange",function(d){function q(a,c){return a.nodeType!=3&&(j.isAncestorOf(a,c.startContainer,true)||j.isAncestorOf(a,c.endContainer,true))}function k(a){return j.getDocument(a.startContainer)}function t(a,c,b){if(c=a._listeners[c])for(var d=0,e=c.length;d<e;++d)c[d].call(a,{target:a,args:b})}function r(a){return new J(a.parentNode,j.getNodeIndex(a))}function s(a){return new J(a.parentNode,j.getNodeIndex(a)+1)}function f(a,c,b){var d=a.nodeType==11?a.firstChild:a;j.isCharacterDataNode(c)?
b==c.length?j.insertAfter(a,c):c.parentNode.insertBefore(a,b==0?c:j.splitDataNode(c,b)):b>=c.childNodes.length?c.appendChild(a):c.insertBefore(a,c.childNodes[b]);return d}function w(a){for(var c,b,d=k(a.range).createDocumentFragment();b=a.next();){c=a.isPartiallySelectedSubtree();b=b.cloneNode(!c);c&&(c=a.getSubtreeIterator(),b.appendChild(w(c)),c.detach(true));if(b.nodeType==10)throw new D("HIERARCHY_REQUEST_ERR");d.appendChild(b)}return d}function n(a,c,b){for(var d,e,b=b||{stop:false};d=a.next();)if(a.isPartiallySelectedSubtree())if(c(d)===
false){b.stop=true;break}else{if(d=a.getSubtreeIterator(),n(d,c,b),d.detach(true),b.stop)break}else for(d=j.createIterator(d);e=d.next();)if(c(e)===false){b.stop=true;return}}function p(a){for(var c;a.next();)a.isPartiallySelectedSubtree()?(c=a.getSubtreeIterator(),p(c),c.detach(true)):a.remove()}function h(a){for(var c,b=k(a.range).createDocumentFragment(),d;c=a.next();){a.isPartiallySelectedSubtree()?(c=c.cloneNode(false),d=a.getSubtreeIterator(),c.appendChild(h(d)),d.detach(true)):a.remove();if(c.nodeType==
10)throw new D("HIERARCHY_REQUEST_ERR");b.appendChild(c)}return b}function m(c,b,d){var e=!(!b||!b.length),u,g=!!d;e&&(u=RegExp("^("+b.join("|")+")$"));var v=[];n(new a(c,false),function(a){(!e||u.test(a.nodeType))&&(!g||d(a))&&v.push(a)});return v}function l(a){return"["+(typeof a.getName=="undefined"?"Range":a.getName())+"("+j.inspectNode(a.startContainer)+":"+a.startOffset+", "+j.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function a(a,c){this.range=a;this.clonePartiallySelectedTextNodes=
...
ca=2,W=3,X=0,Y=1,Z=2,S=3;H.prototype={attachListener:function(a,c){this._listeners[a].push(c)},compareBoundaryPoints:function(a,c){x(this);B(this.startContainer,c.startContainer);var b=a==W||a==R?"start":"end",d=a==V||a==R?"start":"end";return j.comparePoints(this[b+"Container"],this[b+"Offset"],c[d+"Container"],c[d+"Offset"])},insertNode:function(a){x(this);o(a,L);z(this.startContainer);if(j.isAncestorOf(a,this.startContainer,true))throw new D("HIERARCHY_REQUEST_ERR");this.setStartBefore(f(a,this.startContainer,
this.startOffset))},cloneContents:function(){x(this);var c,b;if(this.collapsed)return k(this).createDocumentFragment();else{if(this.startContainer===this.endContainer&&j.isCharacterDataNode(this.startContainer))return c=this.startContainer.cloneNode(true),c.data=c.data.slice(this.startOffset,this.endOffset),b=k(this).createDocumentFragment(),b.appendChild(c),b;else b=new a(this,true),c=w(b),b.detach();return c}},canSurroundContents:function(){x(this);z(this.startContainer);z(this.endContainer);var c=
new a(this,true),b=c._first&&q(c._first,this)||c._last&&q(c._last,this);c.detach();return!b},surroundContents:function(a){o(a,u);if(!this.canSurroundContents())throw new b("BAD_BOUNDARYPOINTS_ERR");var c=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);f(a,this.startContainer,this.startOffset);a.appendChild(c);this.selectNode(a)},cloneRange:function(){x(this);for(var a=new A(k(this)),c=U.length,b;c--;)b=U[c],a[b]=this[b];return a},toString:function(){x(this);
var c=this.startContainer;if(c===this.endContainer&&j.isCharacterDataNode(c))return c.nodeType==3||c.nodeType==4?c.data.slice(this.startOffset,this.endOffset):"";else{var b=[],c=new a(this,true);n(c,function(a){(a.nodeType==3||a.nodeType==4)&&b.push(a.data)});c.detach();return b.join("")}},compareNode:function(a){x(this);var c=a.parentNode,b=j.getNodeIndex(a);if(!c)throw new D("NOT_FOUND_ERR");a=this.comparePoint(c,b);c=this.comparePoint(c,b+1);return a<0?c>0?Z:X:c>0?Y:S},comparePoint:function(a,
...
j.isHtmlNamespace(d)?b.createElement("body"):d.cloneNode(false);d.innerHTML=a;return j.fragmentFromNodeChildren(d)}:function(a){i(this);var c=k(this).createElement("body");c.innerHTML=a;return j.fragmentFromNodeChildren(c)},toHtml:function(){x(this);var a=k(this).createElement("div");a.appendChild(this.cloneContents());return a.innerHTML},intersectsNode:function(a,c){x(this);y(a,"NOT_FOUND_ERR");if(j.getDocument(a)!==k(this))return false;var b=a.parentNode,d=j.getNodeIndex(a);y(b,"NOT_FOUND_ERR");
var e=j.comparePoints(b,d,this.endContainer,this.endOffset),b=j.comparePoints(b,d+1,this.startContainer,this.startOffset);return c?e<=0&&b>=0:e<0&&b>0},isPointInRange:function(a,c){x(this);y(a,"HIERARCHY_REQUEST_ERR");B(a,this.startContainer);return j.comparePoints(a,c,this.startContainer,this.startOffset)>=0&&j.comparePoints(a,c,this.endContainer,this.endOffset)<=0},intersectsRange:function(a,c){x(this);if(k(a)!=k(this))throw new D("WRONG_DOCUMENT_ERR");var b=j.comparePoints(this.startContainer,
...
0)>=0&&this.comparePoint(a,j.getNodeLength(a))<=0},containsRange:function(a){return this.intersection(a).equals(a)},containsNodeText:function(a){var c=this.cloneRange();c.selectNode(a);var b=c.getNodes([3]);return b.length>0?(c.setStart(b[0],0),a=b.pop(),c.setEnd(a,a.length),a=this.containsRange(c),c.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){x(this);return new c(this,a,b)},getNodes:function(a,c){x(this);return m(this,a,c)},getDocument:function(){return k(this)},collapseBefore:function(a){i(this);
this.setEndBefore(a);this.collapse(false)},collapseAfter:function(a){i(this);this.setStartAfter(a);this.collapse(true)},getName:function(){return"DomRange"},equals:function(a){return A.rangesEqual(this,a)},isValid:function(){return F(this)},inspect:function(){return l(this)}};I(A,P,function(a){i(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;t(a,"detach",null);a._listeners=null});d.rangePrototype=H.prototype;A.rangeProperties=U;A.RangeIterator=
a;A.copyComparisonConstants=E;A.createPrototypeRange=I;A.inspect=l;A.getRangeDocument=k;A.rangesEqual=function(a,c){return a.startContainer===c.startContainer&&a.startOffset===c.startOffset&&a.endContainer===c.endContainer&&a.endOffset===c.endOffset};d.DomRange=A;d.RangeException=b});
rangy.createModule("WrappedRange",function(d){function q(d,f,h,m){var l=d.duplicate();l.collapse(h);var a=l.parentElement();r.isAncestorOf(f,a,true)||(a=f);if(!a.canHaveHTML)return new s(a.parentNode,r.getNodeIndex(a));var f=r.getDocument(a).createElement("span"),b,c=h?"StartToStart":"StartToEnd";do a.insertBefore(f,f.previousSibling),l.moveToElementText(f);while((b=l.compareEndPoints(c,d))>0&&f.previousSibling);c=f.nextSibling;if(b==-1&&c&&r.isCharacterDataNode(c)){l.setEndPoint(h?"EndToStart":"EndToEnd",
d);if(/[\r\n]/.test(c.data)){a=l.duplicate();h=a.text.replace(/\r\n/g,"\r").length;for(h=a.moveStart("character",h);a.compareEndPoints("StartToEnd",a)==-1;)h++,a.moveStart("character",1)}else h=l.text.length;a=new s(c,h)}else c=(m||!h)&&f.previousSibling,a=(h=(m||h)&&f.nextSibling)&&r.isCharacterDataNode(h)?new s(h,0):c&&r.isCharacterDataNode(c)?new s(c,c.length):new s(a,r.getNodeIndex(f));f.parentNode.removeChild(f);return a}function k(d,f){var h,m,l=d.offset,a=r.getDocument(d.node),b=a.body.createTextRange(),
c=r.isCharacterDataNode(d.node);c?(h=d.node,m=h.parentNode):(h=d.node.childNodes,h=l<h.length?h[l]:null,m=d.node);a=a.createElement("span");a.innerHTML="&#feff;";h?m.insertBefore(a,h):m.appendChild(a);b.moveToElementText(a);b.collapse(!f);m.removeChild(a);if(c)b[f?"moveStart":"moveEnd"]("character",l);return b}d.requireModules(["DomUtil","DomRange"]);var t,r=d.dom,s=r.DomPosition,f=d.DomRange;if(d.features.implementsDomRange&&(!d.features.implementsTextRange||!d.config.preferTextRange))(function(){function n(a){for(var b=
h.length,d;b--;)d=h[b],a[d]=a.nativeRange[d]}var p,h=f.rangeProperties,m;t=function(a){if(!a)throw Error("Range must be specified");this.nativeRange=a;n(this)};f.createPrototypeRange(t,function(a,b,d,i,n){var f=a.endContainer!==i||a.endOffset!=n;if(a.startContainer!==b||a.startOffset!=d||f)a.setEnd(i,n),a.setStart(b,d)},function(a){a.nativeRange.detach();a.detached=true;for(var b=h.length,d;b--;)d=h[b],a[d]=null});p=t.prototype;p.selectNode=function(a){this.nativeRange.selectNode(a);n(this)};p.deleteContents=
function(){this.nativeRange.deleteContents();n(this)};p.extractContents=function(){var a=this.nativeRange.extractContents();n(this);return a};p.cloneContents=function(){return this.nativeRange.cloneContents()};p.surroundContents=function(a){this.nativeRange.surroundContents(a);n(this)};p.collapse=function(a){this.nativeRange.collapse(a);n(this)};p.cloneRange=function(){return new t(this.nativeRange.cloneRange())};p.refresh=function(){n(this)};p.toString=function(){return this.nativeRange.toString()};
var l=document.createTextNode("test");r.getBody(document).appendChild(l);var a=document.createRange();a.setStart(l,0);a.setEnd(l,0);try{a.setStart(l,1),p.setStart=function(a,b){this.nativeRange.setStart(a,b);n(this)},p.setEnd=function(a,b){this.nativeRange.setEnd(a,b);n(this)},m=function(a){return function(b){this.nativeRange[a](b);n(this)}}}catch(b){p.setStart=function(a,b){try{this.nativeRange.setStart(a,b)}catch(d){this.nativeRange.setEnd(a,b),this.nativeRange.setStart(a,b)}n(this)},p.setEnd=function(a,
b){try{this.nativeRange.setEnd(a,b)}catch(d){this.nativeRange.setStart(a,b),this.nativeRange.setEnd(a,b)}n(this)},m=function(a,b){return function(d){try{this.nativeRange[a](d)}catch(i){this.nativeRange[b](d),this.nativeRange[a](d)}n(this)}}}p.setStartBefore=m("setStartBefore","setEndBefore");p.setStartAfter=m("setStartAfter","setEndAfter");p.setEndBefore=m("setEndBefore","setStartBefore");p.setEndAfter=m("setEndAfter","setStartAfter");a.selectNodeContents(l);p.selectNodeContents=a.startContainer==
l&&a.endContainer==l&&a.startOffset==0&&a.endOffset==l.length?function(a){this.nativeRange.selectNodeContents(a);n(this)}:function(a){this.setStart(a,0);this.setEnd(a,f.getEndOffset(a))};a.selectNodeContents(l);a.setEnd(l,3);m=document.createRange();m.selectNodeContents(l);m.setEnd(l,4);m.setStart(l,2);p.compareBoundaryPoints=a.compareBoundaryPoints(a.START_TO_END,m)==-1&a.compareBoundaryPoints(a.END_TO_START,m)==1?function(a,b){b=b.nativeRange||b;if(a==b.START_TO_END)a=b.END_TO_START;else if(a==
b.END_TO_START)a=b.START_TO_END;return this.nativeRange.compareBoundaryPoints(a,b)}:function(a,b){return this.nativeRange.compareBoundaryPoints(a,b.nativeRange||b)};if(d.util.isHostMethod(a,"createContextualFragment"))p.createContextualFragment=function(a){return this.nativeRange.createContextualFragment(a)};r.getBody(document).removeChild(l);a.detach();m.detach()})(),d.createNativeRange=function(d){return(d||document).createRange()};else if(d.features.implementsTextRange){t=function(d){this.textRange=
d;this.refresh()};t.prototype=new f(document);t.prototype.refresh=function(){var d,f,h=this.textRange;d=h.parentElement();var m=h.duplicate();m.collapse(true);f=m.parentElement();m=h.duplicate();m.collapse(false);h=m.parentElement();f=f==h?f:r.getCommonAncestor(f,h);f=f==d?f:r.getCommonAncestor(d,f);this.textRange.compareEndPoints("StartToEnd",this.textRange)==0?f=d=q(this.textRange,f,true,true):(d=q(this.textRange,f,true,false),f=q(this.textRange,f,false,false));this.setStart(d.node,d.offset);this.setEnd(f.node,
f.offset)};f.copyComparisonConstants(t);var w=function(){return this}();if(typeof w.Range=="undefined")w.Range=t;d.createNativeRange=function(d){return(d||document).body.createTextRange()}}if(d.features.implementsTextRange)t.rangeToTextRange=function(d){if(d.collapsed)return k(new s(d.startContainer,d.startOffset),true);else{var f=k(new s(d.startContainer,d.startOffset),true),h=k(new s(d.endContainer,d.endOffset),false),d=r.getDocument(d.startContainer).body.createTextRange();d.setEndPoint("StartToStart",
...
b[d])){d=false;break a}d=true}if(!d)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function n(a,c){var b=new i(c);a._ranges=[b];r(a,b,false);a.rangeCount=1;a.isCollapsed=b.collapsed}function p(a){a._ranges.length=0;if(a.docSelection.type=="None")s(a);else{var b=a.docSelection.createRange();if(b&&typeof b.text!="undefined")n(a,b);else{a.rangeCount=b.length;for(var e,g=c.getDocument(b.item(0)),v=0;v<a.rangeCount;++v)e=d.createRange(g),
e.selectNode(b.item(v)),a._ranges.push(e);a.isCollapsed=a.rangeCount==1&&a._ranges[0].collapsed;r(a,a._ranges[a.rangeCount-1],false)}}}function h(a,b){for(var d=a.docSelection.createRange(),e=w(b),g=c.getDocument(d.item(0)),g=c.getBody(g).createControlRange(),v=0,i=d.length;v<i;++v)g.add(d.item(v));try{g.add(e)}catch(f){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}g.select();p(a)}function m(a,c,b){this.nativeSelection=
a;this.docSelection=c;this._ranges=[];this.win=b;this.refresh()}function l(a,b){for(var d=c.getDocument(b[0].startContainer),d=c.getBody(d).createControlRange(),e=0,g;e<rangeCount;++e){g=w(b[e]);try{d.add(g)}catch(v){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();p(a)}function a(a,b){if(a.anchorNode&&c.getDocument(a.anchorNode)!==c.getDocument(b))throw new o("WRONG_DOCUMENT_ERR");}function b(a){var c=
[],b=new C(a.anchorNode,a.anchorOffset),d=new C(a.focusNode,a.focusOffset),e=typeof a.getName=="function"?a.getName():"Selection";if(typeof a.rangeCount!="undefined")for(var v=0,i=a.rangeCount;v<i;++v)c[v]=g.inspect(a.getRangeAt(v));return"["+e+"(Ranges: "+c.join(", ")+")(anchor: "+b.inspect()+", focus: "+d.inspect()+"]"}d.requireModules(["DomUtil","DomRange","WrappedRange"]);d.config.checkSelectionRanges=true;var c=d.dom,e=d.util,g=d.DomRange,i=d.WrappedRange,o=d.DOMException,C=c.DomPosition,B,z,
y=d.util.isHostMethod(window,"getSelection"),F=d.util.isHostObject(document,"selection"),x=F&&(!y||d.config.preferTextRange);x?(B=t,d.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return b.type!="None"||c.getDocument(b.createRange().parentElement())==a}):y?(B=k,d.isSelectionValid=function(){return true}):q.fail("Neither document.selection or window.getSelection() detected.");d.getNativeSelection=B;var y=B(),H=d.createNativeRange(document),G=c.getBody(document),E=e.areHostObjects(y,
...
b.setStart(a.anchorNode,a.anchorOffset);b.setEnd(a.focusNode,a.focusOffset);b.collapsed!==this.isCollapsed&&(b.setStart(a.focusNode,a.focusOffset),b.setEnd(a.anchorNode,a.anchorOffset));return b});d.getSelection=function(a){var a=a||window,b=a._rangySelection,c=B(a),d=F?t(a):null;b?(b.nativeSelection=c,b.docSelection=d,b.refresh(a)):(b=new m(c,d,a),a._rangySelection=b);return b};d.getIframeSelection=function(a){return d.getSelection(c.getIframeWindow(a))};j=m.prototype;if(!x&&E&&e.areHostMethods(y,
...
null};m.inspect=b;d.Selection=m;d.selectionPrototype=j;d.addCreateMissingNativeApiListener(function(a){if(typeof a.getSelection=="undefined")a.getSelection=function(){return d.getSelection(this)};a=null})});
rangy.createModule("CssClassApplier",function(d,q){function k(a,b){return a.className&&RegExp("(?:^|\\s)"+b+"(?:\\s|$)").test(a.className)}function t(a,b){a.className?k(a,b)||(a.className+=" "+b):a.className=b}function r(a){return a.split(/\s+/).sort().join(" ")}function s(a,b){return r(a.className)==r(b.className)}function f(a){for(var b=a.parentNode;a.hasChildNodes();)b.insertBefore(a.firstChild,a);b.removeChild(a)}function w(a,b){var c=a.cloneRange();c.selectNodeContents(b);var d=c.intersection(a),
d=d?d.toString():"";c.detach();return d!=""}function n(a){return a.getNodes([3],function(b){return w(a,b)})}function p(a,b){if(a.attributes.length!=b.attributes.length)return false;for(var c=0,d=a.attributes.length,e,g;c<d;++c)if(e=a.attributes[c],g=e.name,g!="class"){g=b.attributes.getNamedItem(g);if(e.specified!=g.specified)return false;if(e.specified&&e.nodeValue!==g.nodeValue)return false}return true}function h(a,b){for(var c=0,d=a.attributes.length,e;c<d;++c)if(e=a.attributes[c].name,(!b||!o.arrayContains(b,
e))&&a.attributes[c].specified&&e!="class")return true;return false}function m(a){var b;return a&&a.nodeType==1&&((b=a.parentNode)&&b.nodeType==9&&b.designMode=="on"||z(a)&&!z(a.parentNode))}function l(a){return(z(a)||a.nodeType!=1&&z(a.parentNode))&&!m(a)}function a(a){return a&&a.nodeType==1&&!y.test(B(a,"display"))}function b(b){if(b.data.length==0)return true;if(F.test(b.data))return false;switch(B(b.parentNode,"whiteSpace")){case "pre":case "pre-wrap":case "-moz-pre-wrap":return false;case "pre-line":if(/[\r\n]/.test(b.data))return false}return a(b.previousSibling)||
a(b.nextSibling)}function c(a,b,d,e){var g,i=d==0;if(o.isAncestorOf(b,a))return a;if(o.isCharacterDataNode(b))if(d==0)d=o.getNodeIndex(b),b=b.parentNode;else if(d==b.length)d=o.getNodeIndex(b)+1,b=b.parentNode;else throw q.createError("splitNodeAt should not be called with offset in the middle of a data node ("+d+" in "+b.data);if(o.isCharacterDataNode(b)?d==0?b.previousSibling:d==b.length?b.nextSibling:1:d>0&&d<b.childNodes.length){if(!g){g=b.cloneNode(false);for(g.id&&g.removeAttribute("id");i=
b.childNodes[d];)g.appendChild(i);o.insertAfter(g,b)}return b==a?g:c(a,g.parentNode,o.getNodeIndex(g),e)}else if(a!=b)return g=b.parentNode,b=o.getNodeIndex(b),i||b++,c(a,g,b,e);return a}function e(a){var b=a?"nextSibling":"previousSibling";return function(c,d){var e=c.parentNode,g=c[b];if(g){if(g&&g.nodeType==3)return g}else if(d&&(g=e[b])&&g.nodeType==1&&e.tagName==g.tagName&&s(e,g)&&p(e,g))return g[a?"firstChild":"lastChild"];return null}}function g(a){this.firstTextNode=(this.isElementMerge=a.nodeType==
1)?a.lastChild:a;this.textNodes=[this.firstTextNode]}function i(a,b,c){this.cssClass=a;var d,e,g=null;if(typeof b=="object"&&b!==null){c=b.tagNames;g=b.elementProperties;for(d=0;e=G[d++];)b.hasOwnProperty(e)&&(this[e]=b[e]);d=b.normalize}else d=b;this.normalize=typeof d=="undefined"?true:d;this.attrExceptions=[];d=document.createElement(this.elementTagName);this.elementProperties={};for(var i in g)g.hasOwnProperty(i)&&(E.hasOwnProperty(i)&&(i=E[i]),d[i]=g[i],this.elementProperties[i]=d[i],this.attrExceptions.push(i));
...
d.requireModules(["WrappedSelection","WrappedRange"]);var o=d.dom,C=function(){function a(b,c,d){return c&&d?" ":""}return function(b,c){if(b.className)b.className=b.className.replace(RegExp("(?:^|\\s)"+c+"(?:\\s|$)"),a)}}(),B;typeof window.getComputedStyle!="undefined"?B=function(a,b){return o.getWindow(a).getComputedStyle(a,null)[b]}:typeof document.documentElement.currentStyle!="undefined"?B=function(a,b){return a.currentStyle[b]}:q.fail("No means of obtaining computed style properties found");
...
detach:function(){}};i.util={hasClass:k,addClass:t,removeClass:C,hasSameClasses:s,replaceWithOwnChildren:f,elementsHaveSameNonClassAttributes:p,elementHasNonClassAttributes:h,splitNodeAt:c,isEditableElement:z,isEditingHost:m,isEditable:l};d.CssClassApplier=i;d.createCssClassApplier=function(a,b,c){return new i(a,b,c)}});
rangy.createModule("SaveRestore",function(d,q){function k(d,k){var h="selectionBoundary_"+ +new Date+"_"+(""+Math.random()).slice(2),m,l=f.getDocument(d.startContainer),a=d.cloneRange();a.collapse(k);m=l.createElement("span");m.id=h;m.style.lineHeight="0";m.style.display="none";m.className="rangySelectionBoundary";m.appendChild(l.createTextNode(w));a.insertNode(m);a.detach();return m}function t(d,f,h,m){(d=(d||document).getElementById(h))?(f[m?"setStartBefore":"setEndBefore"](d),d.parentNode.removeChild(d)):
q.warn("Marker element has been removed. Cannot restore selection.")}function r(d,f){return f.compareBoundaryPoints(d.START_TO_START,d)}function s(d,f){var h=(d||document).getElementById(f);h&&h.parentNode.removeChild(h)}d.requireModules(["DomUtil","DomRange","WrappedRange"]);var f=d.dom,w="\ufeff";d.saveSelection=function(f){var f=f||window,p=f.document;if(d.isSelectionValid(f)){var h=d.getSelection(f),m=h.getAllRanges(),l=[],a,b;m.sort(r);for(var c=0,e=m.length;c<e;++c)a=m[c],a.collapsed?(b=k(a,
false),l.push({markerId:b.id,collapsed:true})):(b=k(a,false),a=k(a,true),l[c]={startMarkerId:a.id,endMarkerId:b.id,collapsed:false,backwards:m.length==1&&h.isBackwards()});for(c=e-1;c>=0;--c)a=m[c],a.collapsed?a.collapseBefore((p||document).getElementById(l[c].markerId)):(a.setEndBefore((p||document).getElementById(l[c].endMarkerId)),a.setStartAfter((p||document).getElementById(l[c].startMarkerId)));h.setRanges(m);return{win:f,doc:p,rangeInfos:l,restored:false}}else q.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
d.restoreSelection=function(f,k){if(!f.restored){for(var h=f.rangeInfos,m=d.getSelection(f.win),l=[],a=h.length,b=a-1,c,e;b>=0;--b){c=h[b];e=d.createRange(f.doc);if(c.collapsed)if(c=(f.doc||document).getElementById(c.markerId)){c.style.display="inline";var g=c.previousSibling;g&&g.nodeType==3?(c.parentNode.removeChild(c),e.collapseToPoint(g,g.length)):(e.collapseBefore(c),c.parentNode.removeChild(c))}else q.warn("Marker element has been removed. Cannot restore selection.");else t(f.doc,e,c.startMarkerId,
true),t(f.doc,e,c.endMarkerId,false);a==1&&e.normalizeBoundaries();l[b]=e}a==1&&k&&d.features.selectionHasExtend&&h[0].backwards?(m.removeAllRanges(),m.addRange(l[0],true)):m.setRanges(l);f.restored=true}};d.removeMarkerElement=s;d.removeMarkers=function(d){for(var f=d.rangeInfos,h=0,k=f.length,l;h<k;++h)l=f[h],l.collapsed?s(d.doc,l.markerId):(s(d.doc,l.startMarkerId),s(d.doc,l.endMarkerId))}});
rangy.createModule("Serializer",function(d,q){function k(a,b){var b=b||[],c=a.nodeType,d=a.childNodes,g=d.length,f=[c,a.nodeName,g].join(":"),o="",h="";switch(c){case 3:o=a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;");break;case 8:o="<\!--"+a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;")+"--\>";break;default:o="<"+f+">",h="</>"}o&&b.push(o);for(c=0;c<g;++c)k(d[c],b);h&&b.push(h);return b}function t(a){a=k(a).join("");return m(a).toString(16)}function r(a,b,c){for(var d=[],g=a,c=c||l.getDocument(a).documentElement;g&&
g!=c;)d.push(l.getNodeIndex(g,true)),g=g.parentNode;return d.join("/")+":"+b}function s(a,b,c){b?c||l.getDocument(b):b=(c||document).documentElement;for(var a=a.split(":"),c=a[0]?a[0].split("/"):[],d=c.length,g;d--;)if(g=parseInt(c[d],10),g<b.childNodes.length)b=b.childNodes[parseInt(c[d],10)];else throw q.createError("deserializePosition failed: node "+l.inspectNode(b)+" has no child with index "+g+", "+d);return new l.DomPosition(b,parseInt(a[1],10))}function f(a,b,c){c=c||d.DomRange.getRangeDocument(a).documentElement;
if(!l.isAncestorOf(c,a.commonAncestorContainer,true))throw Error("serializeRange: range is not wholly contained within specified root node");a=r(a.startContainer,a.startOffset,c)+","+r(a.endContainer,a.endOffset,c);b||(a+="{"+t(c)+"}");return a}function w(a,b,c){b?c=c||l.getDocument(b):(c=c||document,b=c.documentElement);var a=/^([^,]+),([^,\{]+)({([^}]+)})?$/.exec(a),e=a[4],g=t(b);if(e&&e!==t(b))throw Error("deserializeRange: checksums of serialized range root node ("+e+") and target root node ("+
g+") do not match");e=s(a[1],b,c);b=s(a[2],b,c);c=d.createRange(c);c.setStart(e.node,e.offset);c.setEnd(b.node,b.offset);return c}function n(a,b,c){b?c||l.getDocument(b):b=(c||document).documentElement;a=/^([^,]+),([^,]+)({([^}]+)})?$/.exec(a)[3];return!a||a===t(b)}function p(a,b,c){for(var a=a||d.getSelection(),a=a.getAllRanges(),e=[],g=0,i=a.length;g<i;++g)e[g]=f(a[g],b,c);return e.join("|")}function h(a,b,c){b?c=c||l.getWindow(b):(c=c||window,b=c.document.documentElement);for(var a=a.split("|"),
e=d.getSelection(c),g=[],f=0,o=a.length;f<o;++f)g[f]=w(a[f],b,c.document);e.setRanges(g);return e}d.requireModules(["WrappedSelection","WrappedRange"]);(typeof encodeURIComponent=="undefined"||typeof decodeURIComponent=="undefined")&&q.fail("Global object is missing encodeURIComponent and/or decodeURIComponent method");var m=function(){var a=null;return function(b){for(var c=[],d=0,g=b.length,f;d<g;++d)f=b.charCodeAt(d),f<128?c.push(f):f<2048?c.push(f>>6|192,f&63|128):c.push(f>>12|224,f>>6&63|128,
f&63|128);b=-1;if(!a){for(var d=[],g=0,o;g<256;++g){o=g;for(f=8;f--;)(o&1)==1?o=o>>>1^3988292384:o>>>=1;d[g]=o>>>0}a=d}d=a;g=0;for(f=c.length;g<f;++g)o=(b^c[g])&255,b=b>>>8^d[o];return(b^-1)>>>0}}(),l=d.dom;d.serializePosition=r;d.deserializePosition=s;d.serializeRange=f;d.deserializeRange=w;d.canDeserializeRange=n;d.serializeSelection=p;d.deserializeSelection=h;d.canDeserializeSelection=function(a,b,c){var d;b?d=c?c.document:l.getDocument(b):b=(c||window).document.documentElement;for(var a=a.split("|"),
c=0,g=a.length;c<g;++c)if(!n(a[c],b,d))return false;return true};d.restoreSelectionFromCookie=function(a){var a=a||window,b;a:{b=a.document.cookie.split(/[;,]/);for(var c=0,d=b.length,g;c<d;++c)if(g=b[c].split("="),g[0].replace(/^\s+/,"")=="rangySerializedSelection"&&(g=g[1])){b=decodeURIComponent(g.replace(/\s+$/,""));break a}b=null}b&&h(b,a.doc)};d.saveSelectionCookie=function(a,b){var a=a||window,b=typeof b=="object"?b:{},c=b.expires?";expires="+b.expires.toUTCString():"",e=b.path?";path="+b.path:
"",g=b.domain?";domain="+b.domain:"",f=b.secure?";secure":"",o=p(d.getSelection(a));a.document.cookie=encodeURIComponent("rangySerializedSelection")+"="+encodeURIComponent(o)+c+e+g+f};d.getElementChecksum=t});
(function(d){d.fn.raptorize=function(q){q=d.extend({enterOn:"click",delayTime:5E3},q);return this.each(function(){function k(){s=true;r&&document.getElementById("elRaptorShriek").play();f.animate({bottom:"0"},function(){d(this).animate({bottom:"-30px"},100,function(){var k=d(this).position().left+400;d(this).delay(300).animate({right:k},2200,function(){f=d("#elRaptor").css({bottom:"-700px",right:"0"});s=false})})})}var t=d(this),r=false;if(d.browser.mozilla&&d.browser.version.substr(0,5)>="1.9.2"||
...
var f=d("#elRaptor").css({position:"fixed",bottom:"-700px",right:"0",display:"block"});if(q.enterOn=="timer")setTimeout(k,q.delayTime);else if(q.enterOn=="click")t.bind("click",function(d){d.preventDefault();s||k()});else if(q.enterOn=="konami-code"){var w=[];d(window).bind("keydown.raptorz",function(f){w.push(f.keyCode);w.toString().indexOf("38,38,40,40,37,39,37,39,66,65")>=0&&(k(),d(window).unbind("keydown.raptorz"))},true)}})}})(jQuery);
(function(d,q,k,t){function r(a,b,c){p[a]=c;h[a]=b;n||(n=a)}function s(a){n!==a&&(n=a,d.ui.editor.eachInstance(function(){this.reinit()}))}function f(a,b){n&&p[n]&&p[n][a]&&(a=p[n][a]);if(b)for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function w(a){if(m===t){if(l=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))d("html").addClass(a.options.baseClass+"-ios"),l&&d(document).bind("scroll",function(){setInterval(function(){d("body").css("height","+=1").css("height","-=1")},0)});d.browser.mozilla&&
d("html").addClass(a.options.baseClass+"-ff");if(d.browser.msie){m=false;var b=d("<div></div>").addClass(a.options.baseClass+"-unsupported").html(a.getTemplate("unsupported")).appendTo("body"),c=1;b.siblings().each(function(){var a=d(this).css("z-index");!isNaN(a)&&a>c&&(c=a+1)});b.css("z-index",c);b.find("."+a.options.baseClass+"-unsupported-close").click(function(){b.remove()})}else m=true}return m}var n=null,p={},h={};d(function(){k.initialized||k.init();if(!d.isFunction(k.rangePrototype.insertNodeAtEnd))k.rangePrototype.insertNodeAtEnd=
function(a){var b=this.cloneRange();b.collapse(false);b.insertNode(a);b.detach();this.setEndAfter(a)}});d("html").click(function(){d(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});d.widget("ui.editor",{_init:function(){d.inArray(this,d.ui.editor.instances)===-1&&d.ui.editor.instances.push(this);var a=this;d.ui.editor.eachInstance(function(b){a!=b&&a.element.closest(b.element).length&&handleError("Nesting editors is unsupported",a.element,b.element)});this.options=d.extend({},
...
"debugDestroy"]];this.element.attr("id")||this.element.attr("id",this.getUniqueId());this.ready=false;this.events={};this.ui={};this.plugins={};this.templates=d.extend({},d.ui.editor.templates);this.path=this.toolbarWrapper=this.toolbar=this.wrapper=null;this.visible=this.enabled=false;this.uiObjects={};for(var b in this.options.bind)this.bind(b,this.options.bind[b]);this.history=[];this.present=0;this.historyEnabled=true;if(w(this)){this.cloneDomTools();this.setOriginalHtml(this.element.is(":input")?
this.element.val():this.element.html());if(this.options.replace)this.replaceOriginal(),this.options.replace=false;this.attach();this.loadPlugins();this.dirty=false;this.previousSelection=this.previousContent=null;this.ready=true;this.fire("ready");this.options.autoEnable&&d(function(){a.enableEditing();a.showToolbar()})}},attach:function(){this.bind("change",this.historyPush);this.bind("selectionChange",this.updateTagTree);this.bind("show",this.updateTagTree);var a=d.proxy(this.checkChange,this);
this.getElement().find("img").bind("click."+this.widgetName,d.proxy(function(a){this.selectOuter(a.target)},this));this.getElement().bind("mouseup."+this.widgetName,a);this.getElement().bind("keyup."+this.widgetName,a);d(q).bind("beforeunload",d.proxy(d.ui.editor.unloadWarning,d.ui.editor))},reinit:function(){if(this.ready){var a=this.enabled,b=this.visible;this.destruct();this._init();a&&this.enableEditing();b&&this.showToolbar()}else{var c;c=function(){this.unbind("ready",c);this.reinit()};this.bind("ready",
...
false,false),document.execCommand("styleWithCSS",true,true)}catch(a){}this.fire("enabled");this.fire("resize")}},disableEditing:function(){if(this.enabled)this.enabled=false,this.getElement().attr("contenteditable",false).removeClass(this.options.baseClass+"-editing"),this.fire("disabled")},isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var a=this,b="",c=[],e=0;this.eachRange(function(g){var g=g.commonAncestorContainer,f;f=g.nodeType===3?d(g).parent():d(g);
g=[];for(c.push(g);f[0]&&!a.isRoot(f)&&f[0].tagName.toLowerCase()!=="body";)g.push(f),f=f.parent();g.reverse();b&&(b+=" | ");b+=this.getTemplate("root");for(f=0;f<g.length;f++)b+=this.getTemplate("tag",{element:g[f][0].tagName.toLowerCase(),data:"["+e+","+f+"]"});e++},null,this);b||(b=this.getTemplate("root"));this.path.html(b).find("a").click(function(){var b=d(this).data("ui-editor-selection");b?(a.selectOuter(c[b[0]][b[1]]),a.updateTagTree()):a.selectOuter(a.getElement())});this.fire("tagTreeUpdated")}},
isRoot:function(a){return this.getElement()[0]===d(a)[0]},unify:function(a,b){b!==false&&a(this);if(this.options.unify)for(var c=d.ui.editor.getInstances(),e=0;e<c.length;e++)c[e]!==this&&c[e].options.unify&&a(c[e])},getUniqueId:function(){return d.ui.editor.getUniqueId()},loadMessages:function(){this.messages=d(this.getTemplate("messages")).appendTo(this.wrapper)},showMessage:function(a,b,c){var c=d.extend({},this.options.message,c),e={timer:null,editor:this,show:function(){this.element.slideDown();
this.timer=q.setTimeout(function(a){this.timer=null;a.hide()},c.delay,this)},hide:function(){if(this.timer)q.clearTimeout(this.timer),this.timer=null;this.element.stop().slideUp(d.proxy(function(){d.isFunction(c.hide)&&c.hide.call(this);this.element.remove()},this))}};e.element=d(this.getTemplate("message",{type:a,message:b})).hide().appendTo(this.messages).find(".ui-editor-message-close").click(function(){e.hide()}).end();e.show();return e},showLoading:function(a,b){return this.showMessage("clock",
...
d("<div/>").addClass(this.options.baseClass+"-path").addClass("ui-widget-header").html(this.getTemplate("root")),c=this.wrapper=d("<div/>").addClass(this.options.baseClass+"-wrapper").css("display","none").append(b).append(a);d.fn.draggable&&this.options.draggable&&(c.draggable({cancel:"a, button",cursor:"move",handle:".ui-editor-path",stop:d.proxy(function(){var a=this.persist("position",[c.css("top"),c.css("left")]);c.css({top:Math.abs(a[0]),left:Math.abs(a[1])})},this)}),c.css("position",""),(a=
this.persist("position")||this.options.dialogPosition)||(a=[10,10]),parseInt(a[0],10)+c.outerHeight()>d(q).height()&&(a[0]=d(q).height()-c.outerHeight()),parseInt(a[1],10)+c.outerWidth()>d(q).width()&&(a[1]=d(q).width()-c.outerWidth()),c.css({top:Math.abs(parseInt(a[0])),left:Math.abs(parseInt(a[1]))}),this.loadMessages());d(function(){c.appendTo("body")});this.loadUi()},isToolbarLoaded:function(){return this.wrapper!==null},showToolbar:function(a){this.isToolbarLoaded()||this.loadToolbar();if(!this.visible){this.options.unify&&
this.hideOtherToolbars(true);this.visible=true;this.wrapper.css("display","");this.fire("resize");typeof this.getElement().attr("tabindex")==="undefined"&&this.getElement().attr("tabindex",-1);if(a)if(a.select)a.select();else{var b=q.getSelection();b.removeAllRanges();b.addRange(a)}var c=this;d(function(){c.fire("show");c.getElement().focus()})}},hideToolbar:function(){if(this.visible)this.visible=false,this.wrapper.hide(),this.fire("hide"),this.fire("resize")},hideOtherToolbars:function(a){this.unify(function(b){b.hideToolbar(a)},
false)},isVisible:function(){return this.visible},getTemplate:function(a,b){var c;c=this.templates[a]?this.templates[a]:d.ui.editor.getTemplate(a,this.options.urlPrefix);c=c.replace(/_\('(.*?)'\)/g,function(a,b){b=b.replace(/\\(.?)/g,function(a,b){switch(b){case "\\":return"\\";case "0":return"\x00";case "":return"";default:return b}});return f(b)});b=d.extend({},this.options,b||{});b=this.getTemplateVars(b);return c=c.replace(/\{\{(.*?)\}\}/g,function(a,c){return b[c]})},getTemplateVars:function(a,
b,c){b=b?b+".":"";c||(c=1);var d={},g;for(g in a)if(typeof a[g]==="object"&&c<5){var f=this.getTemplateVars(a[g],b+g,++c),o;for(o in f)d[o]=f[o]}else d[b+g]=a[g];return d},historyPush:function(){if(this.historyEnabled&&this.getHtml()!==this.historyPeak()){if(this.present!==this.history.length-1)this.history=this.history.splice(0,this.present+1);this.history.push(this.getHtml());this.present=this.history.length-1}},historyPeak:function(){return!this.history.length?null:this.history[this.present]},
historyBack:function(){if(this.present>0)this.present--,this.setHtml(this.history[this.present]),this.historyEnabled=false,this.change(),this.historyEnabled=true},historyForward:function(){if(this.present<this.history.length-1)this.present++,this.setHtml(this.history[this.present]),this.historyEnabled=false,this.change(),this.historyEnabled=true},loadUi:function(){for(var a=0,b=this.options.uiOrder.length;a<b;a++){for(var c=this.options.uiOrder[a],e=d("<div/>"),g=0,f=c.length;g<f;g++)if(!(this.options.enableUi===
false&&typeof this.options.ui[c[g]]==="undefined"||this.options.ui[c[g]]===false)&&d.inArray(c[g],this.options.disabledUi)===-1){var o=c[g].replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});if(d.ui.editor.ui[c[g]]){var h=d.extend({},d.ui.editor.ui[c[g]]),o=d.extend(true,{},this.options,{baseClass:this.options.baseClass+"-ui-"+o},h.options,this.options.ui[c[g]]);h.editor=this;h.options=o;h.ui=h.init(this,o);h.ui.init(c[g],this,o,h).appendTo(e);this.uiObjects[c[g]]=h}}e.addClass("ui-buttonset").addClass(this.options.baseClass+
"-buttonset");e.children().length>0&&e.appendTo(this.toolbar)}d("<div/>").css("clear","both").appendTo(this.toolbar)},uiButton:function(a){return d.extend({button:null,options:{},init:function(a,c,e,g){var i=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),e=d.extend({},c.options,{baseClass:c.options.baseClass+"-"+i+"-button"},this.options,c.options.ui[a]);if(!this.title)this.title=f("Unnamed Button");this.button=d("<div/>").html(this.label||this.title).addClass(e.baseClass).attr("name",
a).attr("title",this.title).val(a);e.classes&&this.button.addClass(e.classes);this.button.bind("mousedown."+g.editor.widgetName,function(a){a.preventDefault()});var o=this;this.button.bind("mouseup."+g.editor.widgetName,function(a){a.preventDefault();o.click.apply(g,arguments)});c.bind("destroy",d.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+i},disabled:e.disabled?true:false,text:this.text||false,label:this.label||null});
this.ready.call(g);return this.button},disable:function(){this.button.button("option","disabled",true)},enable:function(){this.button.button("option","disabled",false)},ready:function(){},click:function(){}},a)},uiSelectMenu:function(a){return d.extend({select:null,selectMenu:null,button:null,menu:null,options:{},init:function(a,c){var e=this,g=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});d.extend({},c.options,{baseClass:c.options.baseClass+g+"-select-menu"},e.options,c.options.ui[a]);
if(!e.title)e.title=f("Unnamed Select Menu");e.wrapper=d('<div class="ui-editor-selectmenu-wrapper"/>').append(e.select.hide());e.selectMenu=d('<div class="ui-selectmenu ui-editor-selectmenu"/>').appendTo(e.wrapper);e.menu=d('<div class="ui-selectmenu-menu ui-editor-selectmenu-menu ui-widget-content ui-corner-bottom ui-corner-tr"/>').appendTo(e.wrapper);e.select.find("option").each(function(){d("<div/>").addClass("ui-selectmenu-menu-item ui-editor-selectmenu-menu-item").addClass("ui-corner-all").html(d(this).html()).appendTo(e.menu).bind("mouseenter."+
...
e.button=d("<div/>").addClass("ui-selectmenu-button ui-editor-selectmenu-button ui-button ui-state-default").attr("title",e.title).append(g).append(i).prependTo(e.selectMenu);e.button.bind("click."+c.widgetName,function(){e.menu.css("min-width",e.button.outerWidth()+10);e.wrapper.toggleClass("ui-editor-selectmenu-visible");return false});g=e.select.find("option[value="+e.select.val()+"]").html();e.button.find(".ui-selectmenu-text").html(g);return e.wrapper},update:function(){var a=this.select.find("option[value="+
this.select.val()+"]").html();this.button.find(".ui-selectmenu-text").html(a)},val:function(){var a=this.select.val.apply(this.select,arguments);this.update();return a},change:function(){}},a)},getPlugin:function(a){return this.plugins[a]},loadPlugins:function(){if(!this.options.plugins)this.options.plugins={};for(var a in d.ui.editor.plugins)if(!(this.options.enablePlugins===false&&typeof this.options.plugins[a]==="undefined"||this.options.plugins[a]===false)&&d.inArray(a,this.options.disabledPlugins)===
-1){var b=d.extend({},d.ui.editor.plugins[a]),c=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),c=d.extend(true,{},this.options,{baseClass:this.options.baseClass+"-"+c},b.options,this.options.plugins[a]);b.editor=this;b.options=c;b.init(this,c);this.plugins[a]=b}},isDirty:function(){return this.dirty},getHtml:function(){var a=this.getElement().html(),a=d("<div/>").html(a);a.find(".rangySelectionBoundary").remove();return a=a.html()},getCleanHtml:function(){this.fire("clean");var a=this.getElement().html();
this.fire("restore");a=d("<div/>").html(a);a.find(".rangySelectionBoundary").remove();return a=a.html()},setHtml:function(a){this.getElement().html(a);this.fire("html");this.change()},resetHtml:function(){this.setHtml(this.getOriginalHtml())},getOriginalHtml:function(){return this.originalHtml},save:function(){var a=this.getCleanHtml();this.fire("save");this.setOriginalHtml(a);this.fire("saved");this.fire("change");return a},setOriginalHtml:function(a){this.originalHtml=a},bind:function(a,b,c){var e=
this.events;d.each(a.split(","),function(a,f){f=d.trim(f);e[f]||(e[f]=[]);e[f].push({context:c,callback:b})})},unbind:function(a,b,c){for(var d=0,g=this.events[a].length;d<g;d++)this.events[a][d]&&this.events[a][d].callback===b&&this.events[a][d].context===c&&this.events[a].splice(d,1)},fire:function(a,b,c){c||this.fire("before:"+a,b,true);if(this.events[a])for(var e=0,g=this.events[a].length;e<g;e++){var f=this.events[a][e];f.callback.call(f.context||this)}b!==false&&d.ui.editor.fire(a);c||this.fire("after:"+
a,b,true)}});d.extend(d.ui.editor,{defaults:{plugins:{},ui:{},bind:{},domTools:{savedSelection:false,saveSelection:function(){this.savedSelection=k.saveSelection()},restoreSelection:function(){if(this.savedSelection)k.restoreSelection(this.savedSelection),this.savedSelection=false},eachRange:function(a,b,c){for(var b=b||k.getSelection(),c=c||this,d,g=0;d=b.getAllRanges()[g++];)a.call(c,d)},constrainSelection:function(a,b){var a=d(a)[0],b=b||k.getSelection(),c;d(b.getAllRanges()).each(function(e,g){c=
this.commonAncestorContainer.nodeType===3?d(g.commonAncestorContainer).parent()[0]:g.commonAncestorContainer;a!==c&&!d.contains(a,c)&&b.removeRange(g)})},getSelectedElements:function(){var a=new jQuery;this.eachRange(function(b){a.push(this.getSelectedElement(b)[0])});return a},getSelectedElement:function(a){return d(a.commonAncestorContainer.nodeType===3?a.commonAncestorContainer.parentNode:a.commonAncestorContainer)},unwrapParentTag:function(a){this.getSelectedElements().each(function(){d(this).is(a)&&
d(this).replaceWith(d(this).html())})},wrapTagWithAttribute:function(a,b,c){this.eachRange(function(d){d=this.getSelectedElement(d);d.is(a)?d.attr(b):this.toggleWrapper(a,{classes:c,attributes:b})})},selectInner:function(a,b){b=b||k.getSelection();b.removeAllRanges();d(a).focus().contents().each(function(){var a=k.createRange();a.selectNodeContents(this);b.addRange(a)})},selectOuter:function(a,b){b=b||k.getSelection();b.removeAllRanges();d(a).each(function(){var a=k.createRange();a.selectNode(this);
b.addRange(a)}).focus()},toggleWrapper:function(a,b){var b=b||{},c=k.createCssClassApplier(b.classes||"",{normalize:true,elementTagName:a,elementProperties:b.attributes||{}});this.eachRange(function(e){this.rangeEmptyTag(e)?this.replaceRange(d("<"+a+"/>").addClass(b.classes).attr(b.attributes||{}).append(this.domFragmentToHtml(e.cloneContents())),e):c.toggleRange(e)})},rangeEmptyTag:function(a){a=this.domFragmentToHtml(a.cloneContents());typeof a==="string"&&(a=a.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,
...
inverseWrapWithTagClass:function(a,b,c,e){this.saveSelection();var g="domTools"+Math.ceil(Math.random()*1E7);this.eachRange(function(a){var d=k.createCssClassApplier(e,{elementTagName:c});d.isAppliedToRange(a)?d.toggleSelection():k.createCssClassApplier(b,{elementTagName:g}).toggleSelection()});d(g).each(function(){d(this).replaceWith(d("<"+a+"/>").addClass(b).html(d(this).html()))});this.restoreSelection()},toggleStyle:function(a,b){d.each(b,function(b,e){d(a).css(b)===e?d(a).css(b,""):d(a).css(b,
...
getTemplate:function(a,b){var c;if(this.templates[a])c=this.templates[a];else{var e=b||this.urlPrefix,g=a.split(".");e+=g.length===1?"templates/"+g[0]+".html":"plugins/"+g[0]+"/templates/"+g.splice(1).join("/")+".html";d.ajax({url:e,type:"GET",async:false,timeout:15E3,error:function(){c=null},success:function(a){c=a}});this.templates[a]=c}return c},getUniqueId:function(){for(var a=d.ui.editor.defaults.baseClass+"-uid-"+(new Date).getTime()+"-"+Math.floor(Math.random()*1E5);d("#"+a).length;)a=d.ui.editor.defaults.baseClass+
...
this.ui.enable()}}});d.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:f("Insert Horizontal Rule"),click:function(){a.replaceSelection("<hr/>")}})}}});d.ui.editor.registerUi({i18n:{init:function(a){var b=this,c=this.persist("locale");c&&s(c);var c=d('<select autocomplete="off" name="i18n"/>'),e;for(e in p){var g=d('<option value="'+e+'" class="'+e+'"/>');g.html(h[e]);n===e&&g.attr("selected","selected");c.append(g)}return a.uiSelectMenu({title:f("Change Language"),select:c,change:function(a){s(b.persist("locale",
a))}})}}});r("en","English",{});r("zh_CN","\u7b80\u4f53\u4e2d\u6587",{"Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"\u5e94\u7528\u6e90\u4ee3\u7801","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",Blockquote:"\u5927\u6bb5\u5f15\u7528",Bold:"\u7c97\u4f53",Cancel:"\u53d6\u6d88","Center Align":"\u4e2d\u5fc3\u5bf9\u9f50\u6587\u672c","Change HTML tag of selected element":"Change HTML tag of selected element",
...
a.newValue.match(/width|height/)&&(this.options.resizeAjax&&b.addClass(this.options.resizeAjaxClass),this.editor.fire("change"))},scanImages:function(){var a=this.editor.getElement(),b=[];d(a.find("img")).each(function(){(a.height()<d(this).outerHeight()||a.width()<d(this).outerWidth())&&b.push(d(this))});b.length&&this.resizeImageElements(b,a.width(),a.height())},resizeImageElements:function(a,b,c){for(var e=d("<a>",{href:"",target:"_blank"}),g=0;g<a.length;g++){var f=a[g],o=f.outerWidth(),h=f.outerHeight(),
k=Math.min(b/o,c/h),o=Math.abs(k*(o-(f.outerWidth()-f.width()))),h=Math.abs(k*(h-(f.outerHeight()-f.height())));f.addClass(this.options.resizingClass);e=e.html(f.attr("title")||f.attr("src").substr(f.attr("src").lastIndexOf("/")+1)).attr("href",f.attr("src"));d(f).css({width:o,height:h}).attr("height",h).attr("width",o);this.options.resizeAjax&&f.addClass(this.options.resizeAjaxClass);var l=this;this.showOversizeWarning(this.editor.outerHtml(e),{hide:function(){f.removeClass(l.options.resizingClass)}})}},
...
click:function(){this.show()}})},tab:function(){return"    "},highlightSource:function(){return typeof q.Rainbow!=="undefined"},untidyHtml:function(a){a=d("<div/>").html(a);d(a).find("span.support").each(function(){d(this).contents().unwrap()});a=a.html();a=a.replace(/&lt;/g,"<");a=a.replace(/&gt;/g,">");return a=a.replace(/&amp;/g,"&")},tidyHtml:function(a){if(typeof HTMLParser==="undefined")return a;var b=0,c="",d=this;HTMLParser(a,{start:function(a,f,h){for(var k=0;k<b;k++)c+=d.tab();c+="<"+a;
for(k=0;k<f.length;k++)c+=" "+f[k].name+'="'+f[k].escaped+'"';c+=(h?"/":"")+">";b++},end:function(a){c+="</"+a+">";b--},chars:function(a){c+=a},comment:function(a){c+="<\!--"+a+"--\>"}});return c},prepareSource:function(a){if(this.highlightSource()){var b=this.tidyHtml(d.trim(this.editor.getHtml())),a=d(a).find("."+this.options.baseClass+"-highlighted"),c=function(a,b,f){var a=d(a),h=a.find("code:first");h.unbind("keydown keyup");h.attr("contenteditable",true);Rainbow.color(b,"html",function(b){h.html(b);
a.show();var g=function(){var a=k.getSelection();return a.rangeCount?a.getRangeAt(0):null},l="";h.bind("keydown",function(a){l=h.html();switch(a.keyCode){case 13:var b=g(),c=false,d=document.createTextNode("\r\n");b&&(b.insertNode(d),b.setEndAfter(d),b.setStartAfter(d),c=k.getSelection(),c.setSingleRange(b),c=true);c&&a.preventDefault();return false;case 9:return b=g(),a=document.createTextNode(f.tab()),b&&(b.insertNode(a),c=k.getSelection(),b.setEndAfter(a),b.setStartAfter(a),c.setSingleRange(b)),
false}});var m=false;h.bind("keydown",function(){m=true});h.bind("keyup",function(){m=false;q.setTimeout(function(){if(!m){if(l==h.html())return true;try{var b=f.untidyHtml(h.html());d("<div/>").html(b).html()==b&&c(a,b,f)}catch(g){console.log("error")}}},5E3)})})};c(a,b,this)}else d(a).find("textarea").val(d.trim(this.editor.getHtml())),d(a).find("."+this.options.baseClass+"-plain-text").show()},hide:function(){this.dialog&&d(this.dialog).dialog("destroy").remove();this.dialog=null;d(this.ui.button).button("option",
"disabled",false)},show:function(){if(!this.dialog){d(this.ui.button).button("option","disabled",true);var a=this;this.dialog=d(this.editor.getTemplate("viewsource.dialog",{baseClass:a.options.baseClass}));this.dialog.dialog({modal:false,width:600,height:400,resizable:true,title:f("View Source"),autoOpen:true,dialogClass:a.options.baseClass+" "+a.options.dialogClass,buttons:[{text:f("Apply Source"),click:function(){var b;a.highlightSource()?(b=d(this).find("."+a.options.baseClass+"-highlighted pre code:first").html(),
b=a.untidyHtml(b)):b=d(this).find("textarea").val();a.editor.setHtml(b)}},{text:f("Close"),click:function(){a.hide()}}],open:function(){var b=d(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});a.prepareSource.call(a,this)},close:function(){a.hide()}})}}}})})(jQuery,window,rangy);
