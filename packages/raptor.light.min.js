...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(c){return a.isHostObject(c,"body")?c.body:c.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var c;c=a.parentNode;)a=c;return a},comparePoints:function(a,c,b,d){var p;if(a==b)return c===d?0:c<d?-1:1;if(p=r(b,a,!0))return c<=n(p)?-1:1;if(p=r(a,b,!0))return n(p)<d?-1:1;c=t(a,b);a=a===c?c:r(a,c,!0);b=b===c?c:r(b,c,!0);if(a===b)throw Error("comparePoints got to case 4 and childA and childB are the same!");
for(c=c.firstChild;c;){if(c===a)return-1;if(c===b)return 1;c=c.nextSibling}throw Error("Should not be here!");},inspectNode:p,fragmentFromNodeChildren:function(a){for(var c=w(a).createDocumentFragment(),b;b=a.firstChild;)c.appendChild(b);return c},createIterator:function(a){return new o(a)},DomPosition:i};d.DOMException=l});
...
!1;break a}d=!0}if(!d)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function p(a,c){var b=new h(c);a._ranges=[b];r(a,b,!1);a.rangeCount=1;a.isCollapsed=b.collapsed}function o(a){a._ranges.length=0;if("None"==a.docSelection.type)s(a);else{var b=a.docSelection.createRange();if(b&&"undefined"!=typeof b.text)p(a,b);else{a.rangeCount=b.length;for(var e,g=c.getDocument(b.item(0)),v=0;v<a.rangeCount;++v)e=d.createRange(g),e.selectNode(b.item(v)),
a._ranges.push(e);a.isCollapsed=1==a.rangeCount&&a._ranges[0].collapsed;r(a,a._ranges[a.rangeCount-1],!1)}}}function i(a,b){for(var d=a.docSelection.createRange(),e=w(b),g=c.getDocument(d.item(0)),g=c.getBody(g).createControlRange(),v=0,h=d.length;v<h;++v)g.add(d.item(v));try{g.add(e)}catch(f){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}g.select();o(a)}function l(a,c,b){this.nativeSelection=a;this.docSelection=c;this._ranges=
[];this.win=b;this.refresh()}function k(a,b){for(var d=c.getDocument(b[0].startContainer),d=c.getBody(d).createControlRange(),e=0,g;e<rangeCount;++e){g=w(b[e]);try{d.add(g)}catch(v){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();o(a)}function a(a,b){if(a.anchorNode&&c.getDocument(a.anchorNode)!==c.getDocument(b))throw new m("WRONG_DOCUMENT_ERR");}function b(a){var c=[],b=new C(a.anchorNode,a.anchorOffset),
...
J(this.nativeSelection,this.rangeCount-1))&&!g.rangesEqual(c,a)&&(a=new h(c));this._ranges[this.rangeCount-1]=a;r(this,a,L(this.nativeSelection));this.isCollapsed=z(this)}else this.refresh()}}:function(a,b){if(b&&v)D(this,a);else{this.nativeSelection.addRange(f(a));this.refresh()}};j.setRanges=function(a){if(A&&a.length>1)k(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(e.isHostMethod(y,"empty")&&e.isHostMethod(H,"select")&&A&&x)j.removeAllRanges=
...
a(b.nextSibling)}function c(a,b,d,e){var g,h=0==d;if(m.isAncestorOf(b,a))return a;if(m.isCharacterDataNode(b))if(0==d)d=m.getNodeIndex(b),b=b.parentNode;else if(d==b.length)d=m.getNodeIndex(b)+1,b=b.parentNode;else throw q.createError("splitNodeAt should not be called with offset in the middle of a data node ("+d+" in "+b.data);if(m.isCharacterDataNode(b)?0==d?b.previousSibling:d==b.length?b.nextSibling:1:0<d&&d<b.childNodes.length){if(!g){g=b.cloneNode(!1);for(g.id&&g.removeAttribute("id");h=b.childNodes[d];)g.appendChild(h);
...
rangy.createModule("SaveRestore",function(d,q){function n(d,o){var i="selectionBoundary_"+ +new Date+"_"+(""+Math.random()).slice(2),l,k=f.getDocument(d.startContainer),a=d.cloneRange();a.collapse(o);l=k.createElement("span");l.id=i;l.style.lineHeight="0";l.style.display="none";l.className="rangySelectionBoundary";l.appendChild(k.createTextNode(w));a.insertNode(l);a.detach();return l}function t(d,f,i,l){(d=(d||document).getElementById(i))?(f[l?"setStartBefore":"setEndBefore"](d),d.parentNode.removeChild(d)):
q.warn("Marker element has been removed. Cannot restore selection.")}function r(d,f){return f.compareBoundaryPoints(d.START_TO_START,d)}function s(d,f){var i=(d||document).getElementById(f);i&&i.parentNode.removeChild(i)}d.requireModules(["DomUtil","DomRange","WrappedRange"]);var f=d.dom,w="\ufeff";d.saveSelection=function(f){var f=f||window,o=f.document;if(d.isSelectionValid(f)){var i=d.getSelection(f),l=i.getAllRanges(),k=[],a,b;l.sort(r);for(var c=0,e=l.length;c<e;++c)a=l[c],a.collapsed?(b=n(a,
...
g=b.domain?";domain="+b.domain:"",f=b.secure?";secure":"",m=o(d.getSelection(a));a.document.cookie=encodeURIComponent("rangySerializedSelection")+"="+encodeURIComponent(m)+c+e+g+f};d.getElementChecksum=t});
(function(d){d.fn.raptorize=function(q){q=d.extend({enterOn:"click",delayTime:5E3},q);return this.each(function(){function n(){s=!0;r&&document.getElementById("elRaptorShriek").play();f.animate({bottom:"0"},function(){d(this).animate({bottom:"-30px"},100,function(){var n=d(this).position().left+400;d(this).delay(300).animate({right:n},2200,function(){f=d("#elRaptor").css({bottom:"-700px",right:"0"});s=!1})})})}var t=d(this),r=!1;if(d.browser.mozilla&&"1.9.2"<=d.browser.version.substr(0,5)||d.browser.webkit)r=
...
var f=d("#elRaptor").css({position:"fixed",bottom:"-700px",right:"0",display:"block"});if("timer"==q.enterOn)setTimeout(n,q.delayTime);else if("click"==q.enterOn)t.bind("click",function(d){d.preventDefault();s||n()});else if("konami-code"==q.enterOn){var w=[];d(window).bind("keydown.raptorz",function(f){w.push(f.keyCode);0<=w.toString().indexOf("38,38,40,40,37,39,37,39,66,65")&&(n(),d(window).unbind("keydown.raptorz"))},!0)}})}})(jQuery);
(function(d,q,n,t){function r(a,b,c){o[a]=c;i[a]=b;p||(p=a)}function s(a){p!==a&&(p=a,d.ui.editor.eachInstance(function(){this.reinit()}))}function f(a,b){p&&o[p]&&o[p][a]&&(a=o[p][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function w(a){if(l===t){l=!0;if(k=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))d("html").addClass(a.options.baseClass+"-ios"),k&&d(document).bind("scroll",function(){setInterval(function(){d("body").css("height","+=1").css("height",
"-=1")},0)});d.browser.mozilla&&d("html").addClass(a.options.baseClass+"-ff");if(d.browser.msie&&9>d.browser.version){l=!1;var b=d("<div></div>").addClass(a.options.baseClass+"-unsupported").html(a.getTemplate("unsupported")).appendTo("body"),c=1;b.siblings().each(function(){var a=d(this).css("z-index");!isNaN(a)&&a>c&&(c=a+1)});b.css("z-index",c);b.find("."+a.options.baseClass+"-unsupported-close").click(function(){b.remove()})}}return l}var p=null,o={},i={};d(function(){n.initialized||n.init();
...
a.uiButton({title:f("Step Forward"),disabled:!0,click:function(){a.historyForward()}})},change:function(){this.editor.present===this.editor.history.length-1?this.ui.disable():this.ui.enable()}}});d.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:f("Insert Horizontal Rule"),click:function(){a.replaceSelection("<hr/>")}})}}});d.ui.editor.registerUi({i18n:{init:function(a){var b=this,c=this.persist("locale");c&&s(c);var c=d('<select autocomplete="off" name="i18n"/>'),e;for(e in o){var g=
d('<option value="'+e+'" class="'+e+'"/>');g.html(i[e]);p===e&&g.attr("selected","selected");c.append(g)}return a.uiSelectMenu({title:f("Change Language"),select:c,change:function(a){s(b.persist("locale",a))}})}}});r("en","English",{});r("zh_CN","\u7b80\u4f53\u4e2d\u6587",{"Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"\u5e94\u7528\u6e90\u4ee3\u7801","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",
