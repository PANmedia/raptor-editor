...
*/
window.rangy=function(){function a(a,i){var d=typeof a[i];return d==o||!!(d==m&&a[i])||"unknown"==d}function q(a,i){return!!(typeof a[i]==m&&a[i])}function h(a,i){return typeof a[i]!=p}function v(a){return function(i,d){for(var b=d.length;b--;)if(!a(i,d[b]))return!1;return!0}}function r(a){return a&&d(a,l)&&D(a,b)}function t(a){window.alert("Rangy not supported in your browser. Reason: "+a);s.initialized=!0;s.supported=!1}function e(){if(!s.initialized){var i,b=!1,m=!1;a(document,"createRange")&&
(i=document.createRange(),d(i,k)&&D(i,n)&&(b=!0),i.detach());if((i=q(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(i,"createTextRange"))i=i.createTextRange(),r(i)&&(m=!0);!b&&!m&&t("Neither Range nor TextRange are implemented");s.initialized=!0;s.features={implementsDomRange:b,implementsTextRange:m};b=H.concat(z);m=0;for(i=b.length;m<i;++m)try{b[m](s)}catch(e){q(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
...
b="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),l="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),d=v(a),i=v(q),D=v(h),s={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:a,isHostObject:q,isHostProperty:h,areHostMethods:d,areHostObjects:i,areHostProperties:D,isTextRange:r},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
s.fail=t;s.warn=function(a){a="Rangy warning: "+a;s.config.alertOnWarn?window.alert(a):typeof window.console!=p&&typeof window.console.log!=p&&window.console.log(a)};({}).hasOwnProperty?s.util.extend=function(a,i){for(var d in i)i.hasOwnProperty(d)&&(a[d]=i[d])}:t("hasOwnProperty not supported");var z=[],H=[];s.init=e;s.addInitListener=function(a){s.initialized?a(s):z.push(a)};var J=[];s.addCreateMissingNativeApiListener=function(a){J.push(a)};s.createMissingNativeApi=function(a){a=a||window;e();
for(var i=0,d=J.length;i<d;++i)J[i](a)};B.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};B.prototype.warn=function(a){s.warn("Module "+this.name+": "+a)};B.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};s.createModule=function(a,i){var d=new B(a);s.modules[a]=d;H.push(function(a){i(a,d);d.initialized=!0;d.supported=!0})};s.requireModules=function(a){for(var i=0,d=a.length,b,D;i<
d;++i){D=a[i];b=s.modules[D];if(!b||!(b instanceof B))throw Error("Module '"+D+"' not found");if(!b.supported)throw Error("Module '"+D+"' not supported");}};var x=!1,i=function(){x||(x=!0,s.initialized||e())};if(typeof window==p)t("No window found");else if(typeof document==p)t("No document found");else return a(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",i,!1),a(window,"addEventListener")?window.addEventListener("load",i,!1):a(window,"attachEvent")?window.attachEvent("onload",
...
g.appendChild(a)}return g}function n(c,a,g){var j=!(!a||!a.length),d,y=!!g;j&&(d=RegExp("^("+a.join("|")+")$"));var A=[];m(new b(c,!1),function(c){(!j||d.test(c.nodeType))&&(!y||g(c))&&A.push(c)});return A}function k(c){return"["+("undefined"==typeof c.getName?"Range":c.getName())+"("+f.inspectNode(c.startContainer)+":"+c.startOffset+", "+f.inspectNode(c.endContainer)+":"+c.endOffset+")]"}function b(c,a){this.range=c;this.clonePartiallySelectedTextNodes=a;if(!c.collapsed){this.sc=c.startContainer;
this.so=c.startOffset;this.ec=c.endContainer;this.eo=c.endOffset;var g=c.commonAncestorContainer;this.sc===this.ec&&f.isCharacterDataNode(this.sc)?(this.isSingleCharacterDataNode=!0,this._first=this._last=this._next=this.sc):(this._first=this._next=this.sc===g&&!f.isCharacterDataNode(this.sc)?this.sc.childNodes[this.so]:f.getClosestAncestorIn(this.sc,g,!0),this._last=this.ec===g&&!f.isCharacterDataNode(this.ec)?this.ec.childNodes[this.eo-1]:f.getClosestAncestorIn(this.ec,g,!0))}}function l(c){this.code=
this[c];this.codeName=c;this.message="RangeException: "+this.codeName}function d(c,a,g){this.nodes=n(c,a,g);this._next=this.nodes[0];this._position=0}function i(c){return function(a,g){for(var j,d=g?a:a.parentNode;d;){j=d.nodeType;if(f.arrayContains(c,j))return d;d=d.parentNode}return null}}function D(c,a){if(X(c,a))throw new l("INVALID_NODE_TYPE_ERR");}function s(c){if(!c.startContainer)throw new L("INVALID_STATE_ERR");}function z(c,a){if(!f.arrayContains(a,c.nodeType))throw new l("INVALID_NODE_TYPE_ERR");
}function H(c,a){if(0>a||a>(f.isCharacterDataNode(c)?c.length:c.childNodes.length))throw new L("INDEX_SIZE_ERR");}function J(c,a){if(T(c,!0)!==T(a,!0))throw new L("WRONG_DOCUMENT_ERR");}function x(c){if(Z(c,!0))throw new L("NO_MODIFICATION_ALLOWED_ERR");}function E(c,a){if(!c)throw new L(a);}function M(c){return!!c.startContainer&&!!c.endContainer&&!(!f.arrayContains(S,c.startContainer.nodeType)&&!T(c.startContainer,!0))&&!(!f.arrayContains(S,c.endContainer.nodeType)&&!T(c.endContainer,!0))&&c.startOffset<=
(f.isCharacterDataNode(c.startContainer)?c.startContainer.length:c.startContainer.childNodes.length)&&c.endOffset<=(f.isCharacterDataNode(c.endContainer)?c.endContainer.length:c.endContainer.childNodes.length)}function C(c){s(c);if(!M(c))throw Error("Range error: Range is no longer valid after DOM mutation ("+c.inspect()+")");}function R(){}function O(c){c.START_TO_START=j;c.START_TO_END=y;c.END_TO_END=G;c.END_TO_START=aa;c.NODE_BEFORE=ba;c.NODE_AFTER=ca;c.NODE_BEFORE_AND_AFTER=da;c.NODE_INSIDE=$}
function K(c){O(c);O(c.prototype)}function u(c,a){return function(){C(this);var g=this.startContainer,j=this.startOffset,d=this.commonAncestorContainer,y=new b(this,!0);g!==d&&(g=f.getClosestAncestorIn(g,d,!0),j=t(g),g=j.node,j=j.offset);m(y,x);y.reset();d=c(y);y.detach();a(this,g,j,g,j);return d}}function w(c,g,j){function d(c,a){return function(g){s(this);z(g,P);z(N(g),S);g=(c?r:t)(g);(a?y:A)(this,g.node,g.offset)}}function y(c,a,j){var d=c.endContainer,A=c.endOffset;if(a!==c.startContainer||j!==
c.startOffset){if(N(a)!=N(d)||1==f.comparePoints(a,j,d,A))d=a,A=j;g(c,a,j,d,A)}}function A(c,a,j){var d=c.startContainer,y=c.startOffset;if(a!==c.endContainer||j!==c.endOffset){if(N(a)!=N(d)||-1==f.comparePoints(a,j,d,y))d=a,y=j;g(c,d,y,a,j)}}c.prototype=new R;a.util.extend(c.prototype,{setStart:function(c,a){s(this);D(c,!0);H(c,a);y(this,c,a)},setEnd:function(c,a){s(this);D(c,!0);H(c,a);A(this,c,a)},setStartBefore:d(!0,!0),setStartAfter:d(!1,!0),setEndBefore:d(!0,!1),setEndAfter:d(!1,!1),collapse:function(c){C(this);
c?g(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):g(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(c){s(this);D(c,!0);g(this,c,0,c,f.getNodeLength(c))},selectNode:function(c){s(this);D(c,!1);z(c,P);var a=r(c),c=t(c);g(this,a.node,a.offset,c.node,c.offset)},extractContents:u(p,g),deleteContents:u(o,g),canSurroundContents:function(){C(this);x(this.startContainer);x(this.endContainer);var c=new b(this,!0),a=c._first&&
q(c._first,this)||c._last&&q(c._last,this);c.detach();return!a},detach:function(){j(this)},splitBoundaries:function(){C(this);var c=this.startContainer,a=this.startOffset,j=this.endContainer,d=this.endOffset,y=c===j;f.isCharacterDataNode(j)&&0<d&&d<j.length&&f.splitDataNode(j,d);f.isCharacterDataNode(c)&&0<a&&a<c.length&&(c=f.splitDataNode(c,a),y?(d-=a,j=c):j==c.parentNode&&d>=f.getNodeIndex(c)&&d++,a=0);g(this,c,a,j,d)},normalizeBoundaries:function(){C(this);var c=this.startContainer,a=this.startOffset,
j=this.endContainer,d=this.endOffset,y=function(c){var a=c.nextSibling;a&&a.nodeType==c.nodeType&&(j=c,d=c.length,c.appendData(a.data),a.parentNode.removeChild(a))},A=function(g){var y=g.previousSibling;if(y&&y.nodeType==g.nodeType){c=g;var A=g.length;a=y.length;g.insertData(0,y.data);y.parentNode.removeChild(y);c==j?(d+=a,j=c):j==g.parentNode&&(y=f.getNodeIndex(g),d==y?(j=g,d=A):d>y&&d--)}},G=!0;f.isCharacterDataNode(j)?j.length==d&&y(j):(0<d&&(G=j.childNodes[d-1])&&f.isCharacterDataNode(G)&&y(G),
G=!this.collapsed);G?f.isCharacterDataNode(c)?0==a&&A(c):a<c.childNodes.length&&(y=c.childNodes[a])&&f.isCharacterDataNode(y)&&A(y):(c=j,a=d);g(this,c,a,j,d)},collapseToPoint:function(c,a){s(this);D(c,!0);H(c,a);(c!==this.startContainer||a!==this.startOffset||c!==this.endContainer||a!==this.endOffset)&&g(this,c,a,c,a)}});K(c)}function F(c){c.collapsed=c.startContainer===c.endContainer&&c.startOffset===c.endOffset;c.commonAncestorContainer=c.collapsed?c.startContainer:f.getCommonAncestor(c.startContainer,
c.endContainer)}function W(c,a,g,j,d){var y=c.startContainer!==a||c.startOffset!==g,A=c.endContainer!==j||c.endOffset!==d;c.startContainer=a;c.startOffset=g;c.endContainer=j;c.endOffset=d;F(c);v(c,"boundarychange",{startMoved:y,endMoved:A})}function I(c){this.startContainer=c;this.startOffset=0;this.endContainer=c;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};F(this)}a.requireModules(["DomUtil"]);var f=a.dom,V=f.DomPosition,L=a.DOMException;b.prototype={_current:null,_next:null,_first:null,
...
(c===this.sc||c===this.ec)?(a=c===this.sc?this.so:0,g=c===this.ec?this.eo:c.length,a!=g&&c.deleteData(a,g-a)):c.parentNode&&c.parentNode.removeChild(c)},isPartiallySelectedSubtree:function(){return q(this._current,this.range)},getSubtreeIterator:function(){var c;if(this.isSingleCharacterDataNode)c=this.range.cloneRange(),c.collapse();else{c=new I(h(this.range));var a=this._current,g=a,j=0,d=a,y=f.getNodeLength(a);f.isAncestorOf(a,this.sc,!0)&&(g=this.sc,j=this.so);f.isAncestorOf(a,this.ec,!0)&&(d=
this.ec,y=this.eo);W(c,g,j,d,y)}return new b(c,this.clonePartiallySelectedTextNodes)},detach:function(c){c&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};l.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};l.prototype.toString=function(){return this.message};d.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
detach:function(){this._current=this._next=this.nodes=null}};var P=[1,3,4,5,7,8,10],S=[2,9,11],U=[1,3,4,5,7,8,10,11],A=[1,3,4,5,7,8],N=f.getRootContainer,T=i([9,11]),Z=i([5,6,10,12]),X=i([6,10,12]),Y=document.createElement("style"),Q=!1;try{Y.innerHTML="<b>x</b>",Q=3==Y.firstChild.nodeType}catch(c){}a.features.htmlParsingConforms=Q;var g="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),j=0,y=1,G=2,aa=3,ba=0,ca=1,da=2,$=3;R.prototype={attachListener:function(c,
a){this._listeners[c].push(a)},compareBoundaryPoints:function(c,a){C(this);J(this.startContainer,a.startContainer);var g=c==aa||c==j?"start":"end",d=c==y||c==j?"start":"end";return f.comparePoints(this[g+"Container"],this[g+"Offset"],a[d+"Container"],a[d+"Offset"])},insertNode:function(c){C(this);z(c,U);x(this.startContainer);if(f.isAncestorOf(c,this.startContainer,!0))throw new L("HIERARCHY_REQUEST_ERR");this.setStartBefore(e(c,this.startContainer,this.startOffset))},cloneContents:function(){C(this);
var c,a;if(this.collapsed)return h(this).createDocumentFragment();if(this.startContainer===this.endContainer&&f.isCharacterDataNode(this.startContainer))return c=this.startContainer.cloneNode(!0),c.data=c.data.slice(this.startOffset,this.endOffset),a=h(this).createDocumentFragment(),a.appendChild(c),a;a=new b(this,!0);c=B(a);a.detach();return c},canSurroundContents:function(){C(this);x(this.startContainer);x(this.endContainer);var c=new b(this,!0),a=c._first&&q(c._first,this)||c._last&&q(c._last,
this);c.detach();return!a},surroundContents:function(c){z(c,A);if(!this.canSurroundContents())throw new l("BAD_BOUNDARYPOINTS_ERR");var a=this.extractContents();if(c.hasChildNodes())for(;c.lastChild;)c.removeChild(c.lastChild);e(c,this.startContainer,this.startOffset);c.appendChild(a);this.selectNode(c)},cloneRange:function(){C(this);for(var c=new I(h(this)),a=g.length,j;a--;)j=g[a],c[j]=this[j];return c},toString:function(){C(this);var c=this.startContainer;if(c===this.endContainer&&f.isCharacterDataNode(c))return 3==
c.nodeType||4==c.nodeType?c.data.slice(this.startOffset,this.endOffset):"";var a=[],c=new b(this,!0);m(c,function(c){(3==c.nodeType||4==c.nodeType)&&a.push(c.data)});c.detach();return a.join("")},compareNode:function(c){C(this);var a=c.parentNode,g=f.getNodeIndex(c);if(!a)throw new L("NOT_FOUND_ERR");c=this.comparePoint(a,g);a=this.comparePoint(a,g+1);return 0>c?0<a?da:ba:0<a?ca:$},comparePoint:function(c,a){C(this);E(c,"HIERARCHY_REQUEST_ERR");J(c,this.startContainer);return 0>f.comparePoints(c,
a,this.startContainer,this.startOffset)?-1:0<f.comparePoints(c,a,this.endContainer,this.endOffset)?1:0},createContextualFragment:Q?function(c){var a=this.startContainer,g=f.getDocument(a);if(!a)throw new L("INVALID_STATE_ERR");var j=null;1==a.nodeType?j=a:f.isCharacterDataNode(a)&&(j=f.parentElement(a));j=null===j||"HTML"==j.nodeName&&f.isHtmlNamespace(f.getDocument(j).documentElement)&&f.isHtmlNamespace(j)?g.createElement("body"):j.cloneNode(!1);j.innerHTML=c;return f.fragmentFromNodeChildren(j)}:
...
this.startContainer,this.startOffset)&&a.setStart(c.startContainer,c.startOffset);1==f.comparePoints(c.endContainer,c.endOffset,this.endContainer,this.endOffset)&&a.setEnd(c.endContainer,c.endOffset);return a}throw new l("Ranges do not intersect");},containsNode:function(c,a){return a?this.intersectsNode(c,!1):this.compareNode(c)==$},containsNodeContents:function(c){return 0<=this.comparePoint(c,0)&&0>=this.comparePoint(c,f.getNodeLength(c))},containsRange:function(c){return this.intersection(c).equals(c)},
...
this.collapse(!0)},getName:function(){return"DomRange"},equals:function(c){return I.rangesEqual(this,c)},isValid:function(){return M(this)},inspect:function(){return k(this)}};w(I,W,function(c){s(c);c.startContainer=c.startOffset=c.endContainer=c.endOffset=null;c.collapsed=c.commonAncestorContainer=null;v(c,"detach",null);c._listeners=null});a.rangePrototype=R.prototype;I.rangeProperties=g;I.RangeIterator=b;I.copyComparisonConstants=K;I.createPrototypeRange=w;I.inspect=k;I.getRangeDocument=h;I.rangesEqual=
function(c,a){return c.startContainer===a.startContainer&&c.startOffset===a.startOffset&&c.endContainer===a.endContainer&&c.endOffset===a.endOffset};a.DomRange=I;a.RangeException=l});
rangy.createModule("WrappedRange",function(a){function q(a,e,p,h){var k=a.duplicate();k.collapse(p);var b=k.parentElement();r.isAncestorOf(e,b,!0)||(b=e);if(!b.canHaveHTML)return new t(b.parentNode,r.getNodeIndex(b));var e=r.getDocument(b).createElement("span"),l,d=p?"StartToStart":"StartToEnd";do b.insertBefore(e,e.previousSibling),k.moveToElementText(e);while(0<(l=k.compareEndPoints(d,a))&&e.previousSibling);d=e.nextSibling;if(-1==l&&d&&r.isCharacterDataNode(d)){k.setEndPoint(p?"EndToStart":"EndToEnd",
a);if(/[\r\n]/.test(d.data)){b=k.duplicate();p=b.text.replace(/\r\n/g,"\r").length;for(p=b.moveStart("character",p);-1==b.compareEndPoints("StartToEnd",b);)p++,b.moveStart("character",1)}else p=k.text.length;b=new t(d,p)}else d=(h||!p)&&e.previousSibling,b=(p=(h||p)&&e.nextSibling)&&r.isCharacterDataNode(p)?new t(p,0):d&&r.isCharacterDataNode(d)?new t(d,d.length):new t(b,r.getNodeIndex(e));e.parentNode.removeChild(e);return b}function h(a,e){var p,h,k=a.offset,b=r.getDocument(a.node),l=b.body.createTextRange(),
d=r.isCharacterDataNode(a.node);d?(p=a.node,h=p.parentNode):(p=a.node.childNodes,p=k<p.length?p[k]:null,h=a.node);b=b.createElement("span");b.innerHTML="&#feff;";p?h.insertBefore(b,p):h.appendChild(b);l.moveToElementText(b);l.collapse(!e);h.removeChild(b);if(d)l[e?"moveStart":"moveEnd"]("character",k);return l}a.requireModules(["DomUtil","DomRange"]);var v,r=a.dom,t=r.DomPosition,e=a.DomRange;if(a.features.implementsDomRange&&(!a.features.implementsTextRange||!a.config.preferTextRange))(function(){function m(a){for(var b=
h.length,e;b--;)e=h[b],a[e]=a.nativeRange[e]}var o,h=e.rangeProperties,n;v=function(a){if(!a)throw Error("Range must be specified");this.nativeRange=a;m(this)};e.createPrototypeRange(v,function(a,b,e,m,l){var o=a.endContainer!==m||a.endOffset!=l;if(a.startContainer!==b||a.startOffset!=e||o)a.setEnd(m,l),a.setStart(b,e)},function(a){a.nativeRange.detach();a.detached=!0;for(var b=h.length,e;b--;)e=h[b],a[e]=null});o=v.prototype;o.selectNode=function(a){this.nativeRange.selectNode(a);m(this)};o.deleteContents=
...
var k=document.createTextNode("test");r.getBody(document).appendChild(k);var b=document.createRange();b.setStart(k,0);b.setEnd(k,0);try{b.setStart(k,1),o.setStart=function(a,b){this.nativeRange.setStart(a,b);m(this)},o.setEnd=function(a,b){this.nativeRange.setEnd(a,b);m(this)},n=function(a){return function(b){this.nativeRange[a](b);m(this)}}}catch(l){o.setStart=function(a,b){try{this.nativeRange.setStart(a,b)}catch(e){this.nativeRange.setEnd(a,b),this.nativeRange.setStart(a,b)}m(this)},o.setEnd=function(a,
b){try{this.nativeRange.setEnd(a,b)}catch(e){this.nativeRange.setStart(a,b),this.nativeRange.setEnd(a,b)}m(this)},n=function(a,b){return function(e){try{this.nativeRange[a](e)}catch(l){this.nativeRange[b](e),this.nativeRange[a](e)}m(this)}}}o.setStartBefore=n("setStartBefore","setEndBefore");o.setStartAfter=n("setStartAfter","setEndAfter");o.setEndBefore=n("setEndBefore","setStartBefore");o.setEndAfter=n("setEndAfter","setStartAfter");b.selectNodeContents(k);o.selectNodeContents=b.startContainer==
k&&b.endContainer==k&&0==b.startOffset&&b.endOffset==k.length?function(a){this.nativeRange.selectNodeContents(a);m(this)}:function(a){this.setStart(a,0);this.setEnd(a,e.getEndOffset(a))};b.selectNodeContents(k);b.setEnd(k,3);n=document.createRange();n.selectNodeContents(k);n.setEnd(k,4);n.setStart(k,2);o.compareBoundaryPoints=-1==b.compareBoundaryPoints(b.START_TO_END,n)&1==b.compareBoundaryPoints(b.END_TO_START,n)?function(a,b){b=b.nativeRange||b;a==b.START_TO_END?a=b.END_TO_START:a==b.END_TO_START&&
(a=b.START_TO_END);return this.nativeRange.compareBoundaryPoints(a,b)}:function(a,b){return this.nativeRange.compareBoundaryPoints(a,b.nativeRange||b)};a.util.isHostMethod(b,"createContextualFragment")&&(o.createContextualFragment=function(a){return this.nativeRange.createContextualFragment(a)});r.getBody(document).removeChild(k);b.detach();n.detach()})(),a.createNativeRange=function(a){return(a||document).createRange()};else if(a.features.implementsTextRange){v=function(a){this.textRange=a;this.refresh()};
...
e=null})});
rangy.createModule("WrappedSelection",function(a,q){function h(a){return(a||window).getSelection()}function v(a){return(a||window).document.selection}function r(a,d,b){var e=b?"end":"start",b=b?"start":"end";a.anchorNode=d[e+"Container"];a.anchorOffset=d[e+"Offset"];a.focusNode=d[b+"Container"];a.focusOffset=d[b+"Offset"]}function t(a){a.anchorNode=a.focusNode=null;a.anchorOffset=a.focusOffset=0;a.rangeCount=0;a.isCollapsed=!0;a._ranges.length=0}function e(A){var b;A instanceof D?(b=A._selectionNativeRange,b||
(b=a.createNativeRange(d.getDocument(A.startContainer)),b.setEnd(A.endContainer,A.endOffset),b.setStart(A.startContainer,A.startOffset),A._selectionNativeRange=b,A.attachListener("detach",function(){this._selectionNativeRange=null}))):A instanceof s?b=A.nativeRange:a.features.implementsDomRange&&A instanceof d.getWindow(A.startContainer).Range&&(b=A);return b}function B(a){var b=a.getNodes(),e;a:if(!b.length||1!=b[0].nodeType)e=!1;else{e=1;for(var u=b.length;e<u;++e)if(!d.isAncestorOf(b[0],b[e])){e=
...
b._ranges.push(u);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;r(b,b._ranges[b.rangeCount-1],!1)}}}function p(a,b){for(var e=a.docSelection.createRange(),u=B(b),w=d.getDocument(e.item(0)),w=d.getBody(w).createControlRange(),f=0,F=e.length;f<F;++f)w.add(e.item(f));try{w.add(u)}catch(c){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}w.select();o(a)}function n(a,d,b){this.nativeSelection=a;this.docSelection=d;this._ranges=
[];this.win=b;this.refresh()}function k(a,b){for(var e=d.getDocument(b[0].startContainer),e=d.getBody(e).createControlRange(),u=0,w;u<rangeCount;++u){w=B(b[u]);try{e.add(w)}catch(f){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}e.select();o(a)}function b(a,b){if(a.anchorNode&&d.getDocument(a.anchorNode)!==d.getDocument(b))throw new z("WRONG_DOCUMENT_ERR");}function l(a){var d=[],b=new H(a.anchorNode,a.anchorOffset),
e=new H(a.focusNode,a.focusOffset),u="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var w=0,f=a.rangeCount;w<f;++w)d[w]=D.inspect(a.getRangeAt(w));return"["+u+"(Ranges: "+d.join(", ")+")(anchor: "+b.inspect()+", focus: "+e.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var d=a.dom,i=a.util,D=a.DomRange,s=a.WrappedRange,z=a.DOMException,H=d.DomPosition,J,x,E=a.util.isHostMethod(window,"getSelection"),
M=a.util.isHostObject(document,"selection"),C=M&&(!E||a.config.preferTextRange);C?(J=v,a.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return"None"!=b.type||d.getDocument(b.createRange().parentElement())==a}):E?(J=h,a.isSelectionValid=function(){return!0}):q.fail("Neither document.selection or window.getSelection() detected.");a.getNativeSelection=J;var E=J(),R=a.createNativeRange(document),O=d.getBody(document),K=i.areHostObjects(E,i.areHostProperties(E,["anchorOffset","focusOffset"]));
...
u);this.removeAllRanges();this.addRange(w);this.isCollapsed=true};f.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new z("INVALID_STATE_ERR");};f.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new z("INVALID_STATE_ERR");};f.selectAllChildren=function(e){b(this,e);var u=a.createRange(d.getDocument(e));u.selectNodeContents(e);this.removeAllRanges();
this.addRange(u)};f.deleteFromDocument=function(){if(I&&M&&this.docSelection.type=="Control"){for(var a=this.docSelection.createRange(),b;a.length;){b=a.item(0);a.remove(b);b.parentNode.removeChild(b)}this.refresh()}else if(this.rangeCount){a=this.getAllRanges();this.removeAllRanges();b=0;for(var d=a.length;b<d;++b)a[b].deleteContents();this.addRange(a[d-1])}};f.getAllRanges=function(){return this._ranges.slice(0)};f.setSingleRange=function(a){this.setRanges([a])};f.containsNode=function(a,b){for(var d=
0,e=this._ranges.length;d<e;++d)if(this._ranges[d].containsNode(a,b))return true;return false};f.toHtml=function(){var a="";if(this.rangeCount){for(var a=D.getRangeDocument(this._ranges[0]).createElement("div"),b=0,d=this._ranges.length;b<d;++b)a.appendChild(this._ranges[b].cloneContents());a=a.innerHTML}return a};f.getName=function(){return"WrappedSelection"};f.inspect=function(){return l(this)};f.detach=function(){this.win=this.anchorNode=this.focusNode=this.win._rangySelection=null};n.inspect=
l;a.Selection=n;a.selectionPrototype=f;a.addCreateMissingNativeApiListener(function(b){if(typeof b.getSelection=="undefined")b.getSelection=function(){return a.getSelection(this)};b=null})});
...
e=e?e.toString():"";d.detach();return""!=e}function m(a){return a.getNodes([3],function(b){return B(a,b)})}function o(a,b){if(a.attributes.length!=b.attributes.length)return!1;for(var d=0,e=a.attributes.length,l,f;d<e;++d)if(l=a.attributes[d],f=l.name,"class"!=f&&(f=b.attributes.getNamedItem(f),l.specified!=f.specified||l.specified&&l.nodeValue!==f.nodeValue))return!1;return!0}function p(a,b){for(var d=0,e=a.attributes.length,l;d<e;++d)if(l=a.attributes[d].name,(!b||!z.arrayContains(b,l))&&a.attributes[d].specified&&
"class"!=l)return!0;return!1}function n(a){var b;return a&&1==a.nodeType&&((b=a.parentNode)&&9==b.nodeType&&"on"==b.designMode||x(a)&&!x(a.parentNode))}function k(a){return(x(a)||1!=a.nodeType&&x(a.parentNode))&&!n(a)}function b(a){return a&&1==a.nodeType&&!E.test(J(a,"display"))}function l(a){if(0==a.data.length)return!0;if(M.test(a.data))return!1;switch(J(a.parentNode,"whiteSpace")){case "pre":case "pre-wrap":case "-moz-pre-wrap":return!1;case "pre-line":if(/[\r\n]/.test(a.data))return!1}return b(a.previousSibling)||
b(a.nextSibling)}function d(a,b,e,l){var i,f=0==e;if(z.isAncestorOf(b,a))return a;if(z.isCharacterDataNode(b))if(0==e)e=z.getNodeIndex(b),b=b.parentNode;else if(e==b.length)e=z.getNodeIndex(b)+1,b=b.parentNode;else throw q.createError("splitNodeAt should not be called with offset in the middle of a data node ("+e+" in "+b.data);if(z.isCharacterDataNode(b)?0==e?b.previousSibling:e==b.length?b.nextSibling:1:0<e&&e<b.childNodes.length){if(!i){i=b.cloneNode(!1);for(i.id&&i.removeAttribute("id");f=b.childNodes[e];)i.appendChild(f);
z.insertAfter(i,b)}return b==a?i:d(a,i.parentNode,z.getNodeIndex(i),l)}return a!=b?(i=b.parentNode,b=z.getNodeIndex(b),f||b++,d(a,i,b,l)):a}function i(a){var b=a?"nextSibling":"previousSibling";return function(d,e){var l=d.parentNode,f=d[b];if(f){if(f&&3==f.nodeType)return f}else if(e&&(f=l[b])&&1==f.nodeType&&l.tagName==f.tagName&&t(l,f)&&o(l,f))return f[a?"firstChild":"lastChild"];return null}}function D(a){this.firstTextNode=(this.isElementMerge=1==a.nodeType)?a.lastChild:a;this.textNodes=[this.firstTextNode]}
function s(a,b,d){this.cssClass=a;var e,l,f=null;if("object"==typeof b&&null!==b){d=b.tagNames;f=b.elementProperties;for(e=0;l=O[e++];)b.hasOwnProperty(l)&&(this[l]=b[l]);e=b.normalize}else e=b;this.normalize="undefined"==typeof e?!0:e;this.attrExceptions=[];e=document.createElement(this.elementTagName);this.elementProperties={};for(var i in f)f.hasOwnProperty(i)&&(K.hasOwnProperty(i)&&(i=K[i]),e[i]=f[i],this.elementProperties[i]=e[i],this.attrExceptions.push(i));this.elementSortedClassName=this.elementProperties.hasOwnProperty("className")?
r(this.elementProperties.className+" "+a):a;this.applyToAnyTagName=!1;a=typeof d;if("string"==a)"*"==d?this.applyToAnyTagName=!0:this.tagNames=d.toLowerCase().replace(/^\s\s*/,"").replace(/\s\s*$/,"").split(/\s*,\s*/);else if("object"==a&&"number"==typeof d.length){this.tagNames=[];e=0;for(a=d.length;e<a;++e)"*"==d[e]?this.applyToAnyTagName=!0:this.tagNames.push(d[e].toLowerCase())}else this.tagNames=[this.elementTagName]}a.requireModules(["WrappedSelection","WrappedRange"]);var z=a.dom,H=function(){function a(b,
d,e){return d&&e?" ":""}return function(b,d){b.className&&(b.className=b.className.replace(RegExp("(?:^|\\s)"+d+"(?:\\s|$)"),a))}}(),J;"undefined"!=typeof window.getComputedStyle?J=function(a,b){return z.getWindow(a).getComputedStyle(a,null)[b]}:"undefined"!=typeof document.documentElement.currentStyle?J=function(a,b){return a.currentStyle[b]}:q.fail("No means of obtaining computed style properties found");var x;(function(){x="boolean"==typeof document.createElement("div").isContentEditable?function(a){return a&&
1==a.nodeType&&a.isContentEditable}:function(a){return!a||1!=a.nodeType||"false"==a.contentEditable?!1:"true"==a.contentEditable||x(a.parentNode)}})();var E=/^inline(-block|-table)?$/i,M=/[^\r\n\t\f \u200B]/,C=i(!1),R=i(!0);D.prototype={doMerge:function(){for(var a=[],b,d,e=0,l=this.textNodes.length;e<l;++e)b=this.textNodes[e],d=b.parentNode,a[e]=b.data,e&&(d.removeChild(b),d.hasChildNodes()||d.parentNode.removeChild(d));return this.firstTextNode.data=a=a.join("")},getLength:function(){for(var a=
...
this.cssClass)},getSelfOrAncestorWithClass:function(a){for(;a;){if(this.hasClass(a,this.cssClass))return a;a=a.parentNode}return null},isModifiable:function(a){return!this.applyToEditableOnly||k(a)},isIgnorableWhiteSpaceNode:function(a){return this.ignoreWhiteSpace&&a&&3==a.nodeType&&l(a)},postApply:function(a,b,d){for(var e=a[0],l=a[a.length-1],f=[],i,m=e,h=l,k=0,o=l.length,s,p,n=0,t=a.length;n<t;++n)if(s=a[n],p=C(s,!d)){if(i||(i=new D(p),f.push(i)),i.textNodes.push(s),s===e&&(m=i.firstTextNode,
k=m.length),s===l)h=i.firstTextNode,o=i.getLength()}else i=null;if(a=R(l,!d))i||(i=new D(l),f.push(i)),i.textNodes.push(a);if(f.length){n=0;for(t=f.length;n<t;++n)f[n].doMerge();b.setStart(m,k);b.setEnd(h,o)}},createContainer:function(b){b=b.createElement(this.elementTagName);a.util.extend(b,this.elementProperties);v(b,this.cssClass);return b},applyToTextNode:function(a){var b=a.parentNode;1==b.childNodes.length&&z.arrayContains(this.tagNames,b.tagName.toLowerCase())?v(b,this.cssClass):(b=this.createContainer(z.getDocument(a)),
a.parentNode.insertBefore(b,a),b.appendChild(a))},isRemovable:function(a){var b;if(b=a.tagName.toLowerCase()==this.elementTagName)if(b=r(a.className)==this.elementSortedClassName){var d;a:{b=this.elementProperties;for(d in b)if(b.hasOwnProperty(d)&&a[d]!==b[d]){d=!1;break a}d=!0}b=d&&!p(a,this.attrExceptions)&&this.isModifiable(a)}return b},undoToTextNode:function(a,b,l){b.containsNode(l)||(a=b.cloneRange(),a.selectNode(l),a.isPointInRange(b.endContainer,b.endOffset)&&(d(l,b.endContainer,b.endOffset,
[b]),b.setEndAfter(l)),a.isPointInRange(b.startContainer,b.startOffset)&&(l=d(l,b.startContainer,b.startOffset,[b])));this.isRemovable(l)?e(l):H(l,this.cssClass)},applyToRange:function(a){a.splitBoundaries();var b=m(a);if(b.length){for(var d,e=0,l=b.length;e<l;++e)d=b[e],!this.isIgnorableWhiteSpaceNode(d)&&!this.getSelfOrAncestorWithClass(d)&&this.isModifiable(d)&&this.applyToTextNode(d);a.setStart(b[0],0);d=b[b.length-1];a.setEnd(d,d.length);this.normalize&&this.postApply(b,a,!1)}},applyToSelection:function(b){var b=
a.getSelection(b||window),d,e=b.getAllRanges();b.removeAllRanges();for(var l=e.length;l--;)d=e[l],this.applyToRange(d),b.addRange(d)},undoToRange:function(a){a.splitBoundaries();var b=m(a),d,e,l=b[b.length-1];if(b.length){for(var f=0,i=b.length;f<i;++f)d=b[f],(e=this.getSelfOrAncestorWithClass(d))&&this.isModifiable(d)&&this.undoToTextNode(d,a,e),a.setStart(b[0],0),a.setEnd(l,l.length);this.normalize&&this.postApply(b,a,!0)}},undoToSelection:function(b){var b=a.getSelection(b||window),d=b.getAllRanges(),
e;b.removeAllRanges();for(var l=0,i=d.length;l<i;++l)e=d[l],this.undoToRange(e),b.addRange(e)},getTextSelectedByRange:function(a,b){var d=b.cloneRange();d.selectNodeContents(a);var e=d.intersection(b),e=e?e.toString():"";d.detach();return e},isAppliedToRange:function(a){if(a.collapsed)return!!this.getSelfOrAncestorWithClass(a.commonAncestorContainer);for(var b=a.getNodes([3]),d=0,e;e=b[d++];)if(!this.isIgnorableWhiteSpaceNode(e)&&B(a,e)&&this.isModifiable(e)&&!this.getSelfOrAncestorWithClass(e))return!1;
return!0},isAppliedToSelection:function(b){for(var b=a.getSelection(b||window).getAllRanges(),d=b.length;d--;)if(!this.isAppliedToRange(b[d]))return!1;return!0},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)},toggleSelection:function(a){this.isAppliedToSelection(a)?this.undoToSelection(a):this.applyToSelection(a)},detach:function(){}};s.util={hasClass:h,addClass:v,removeClass:H,hasSameClasses:t,replaceWithOwnChildren:e,elementsHaveSameNonClassAttributes:o,
elementHasNonClassAttributes:p,splitNodeAt:d,isEditableElement:x,isEditingHost:n,isEditable:k};a.CssClassApplier=s;a.createCssClassApplier=function(a,b,d){return new s(a,b,d)}});
rangy.createModule("SaveRestore",function(a,q){function h(a,h){var p="selectionBoundary_"+ +new Date+"_"+(""+Math.random()).slice(2),n,k=e.getDocument(a.startContainer),b=a.cloneRange();b.collapse(h);n=k.createElement("span");n.id=p;n.style.lineHeight="0";n.style.display="none";n.className="rangySelectionBoundary";n.appendChild(k.createTextNode(B));b.insertNode(n);b.detach();return n}function v(a,e,h,n){(a=(a||document).getElementById(h))?(e[n?"setStartBefore":"setEndBefore"](a),a.parentNode.removeChild(a)):
q.warn("Marker element has been removed. Cannot restore selection.")}function r(a,e){return e.compareBoundaryPoints(a.START_TO_START,a)}function t(a,e){var h=(a||document).getElementById(e);h&&h.parentNode.removeChild(h)}a.requireModules(["DomUtil","DomRange","WrappedRange"]);var e=a.dom,B="\ufeff";a.saveSelection=function(e){var e=e||window,o=e.document;if(a.isSelectionValid(e)){var p=a.getSelection(e),n=p.getAllRanges(),k=[],b,l;n.sort(r);for(var d=0,i=n.length;d<i;++d)b=n[d],b.collapsed?(l=h(b,
!1),k.push({markerId:l.id,collapsed:!0})):(l=h(b,!1),b=h(b,!0),k[d]={startMarkerId:b.id,endMarkerId:l.id,collapsed:!1,backwards:1==n.length&&p.isBackwards()});for(d=i-1;0<=d;--d)b=n[d],b.collapsed?b.collapseBefore((o||document).getElementById(k[d].markerId)):(b.setEndBefore((o||document).getElementById(k[d].endMarkerId)),b.setStartAfter((o||document).getElementById(k[d].startMarkerId)));p.setRanges(n);return{win:e,doc:o,rangeInfos:k,restored:!1}}q.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
a.restoreSelection=function(e,h){if(!e.restored){for(var p=e.rangeInfos,n=a.getSelection(e.win),k=[],b=p.length,l=b-1,d,i;0<=l;--l){d=p[l];i=a.createRange(e.doc);if(d.collapsed)if(d=(e.doc||document).getElementById(d.markerId)){d.style.display="inline";var D=d.previousSibling;D&&3==D.nodeType?(d.parentNode.removeChild(d),i.collapseToPoint(D,D.length)):(i.collapseBefore(d),d.parentNode.removeChild(d))}else q.warn("Marker element has been removed. Cannot restore selection.");else v(e.doc,i,d.startMarkerId,
!0),v(e.doc,i,d.endMarkerId,!1);1==b&&i.normalizeBoundaries();k[l]=i}1==b&&h&&a.features.selectionHasExtend&&p[0].backwards?(n.removeAllRanges(),n.addRange(k[0],!0)):n.setRanges(k);e.restored=!0}};a.removeMarkerElement=t;a.removeMarkers=function(a){for(var e=a.rangeInfos,h=0,n=e.length,k;h<n;++h)k=e[h],k.collapsed?t(a.doc,k.markerId):(t(a.doc,k.startMarkerId),t(a.doc,k.endMarkerId))}});
rangy.createModule("Serializer",function(a,q){function h(a,e){var e=e||[],d=a.nodeType,i=a.childNodes,k=i.length,s=[d,a.nodeName,k].join(":"),m="",n="";switch(d){case 3:m=a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;");break;case 8:m="<\!--"+a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;")+"--\>";break;default:m="<"+s+">",n="</>"}m&&e.push(m);for(d=0;d<k;++d)h(i[d],e);n&&e.push(n);return e}function v(a){a=h(a).join("");return n(a).toString(16)}function r(a,e,d){for(var i=[],h=a,d=d||k.getDocument(a).documentElement;h&&
h!=d;)i.push(k.getNodeIndex(h,!0)),h=h.parentNode;return i.join("/")+":"+e}function t(a,e,d){e?d||k.getDocument(e):e=(d||document).documentElement;for(var a=a.split(":"),d=a[0]?a[0].split("/"):[],i=d.length,h;i--;)if(h=parseInt(d[i],10),h<e.childNodes.length)e=e.childNodes[parseInt(d[i],10)];else throw q.createError("deserializePosition failed: node "+k.inspectNode(e)+" has no child with index "+h+", "+i);return new k.DomPosition(e,parseInt(a[1],10))}function e(b,e,d){d=d||a.DomRange.getRangeDocument(b).documentElement;
if(!k.isAncestorOf(d,b.commonAncestorContainer,!0))throw Error("serializeRange: range is not wholly contained within specified root node");b=r(b.startContainer,b.startOffset,d)+","+r(b.endContainer,b.endOffset,d);e||(b+="{"+v(d)+"}");return b}function B(b,e,d){e?d=d||k.getDocument(e):(d=d||document,e=d.documentElement);var b=/^([^,]+),([^,\{]+)({([^}]+)})?$/.exec(b),i=b[4],h=v(e);if(i&&i!==v(e))throw Error("deserializeRange: checksums of serialized range root node ("+i+") and target root node ("+
h+") do not match");i=t(b[1],e,d);e=t(b[2],e,d);d=a.createRange(d);d.setStart(i.node,i.offset);d.setEnd(e.node,e.offset);return d}function m(a,e,d){e?d||k.getDocument(e):e=(d||document).documentElement;a=/^([^,]+),([^,]+)({([^}]+)})?$/.exec(a)[3];return!a||a===v(e)}function o(b,l,d){for(var b=b||a.getSelection(),b=b.getAllRanges(),i=[],h=0,k=b.length;h<k;++h)i[h]=e(b[h],l,d);return i.join("|")}function p(b,e,d){e?d=d||k.getWindow(e):(d=d||window,e=d.document.documentElement);for(var b=b.split("|"),
i=a.getSelection(d),h=[],m=0,n=b.length;m<n;++m)h[m]=B(b[m],e,d.document);i.setRanges(h);return i}a.requireModules(["WrappedSelection","WrappedRange"]);("undefined"==typeof encodeURIComponent||"undefined"==typeof decodeURIComponent)&&q.fail("Global object is missing encodeURIComponent and/or decodeURIComponent method");var n=function(){var a=null;return function(e){for(var d=[],i=0,h=e.length,k;i<h;++i)k=e.charCodeAt(i),128>k?d.push(k):2048>k?d.push(k>>6|192,k&63|128):d.push(k>>12|224,k>>6&63|128,
k&63|128);e=-1;if(!a){for(var i=[],h=0,m;256>h;++h){m=h;for(k=8;k--;)m=1==(m&1)?m>>>1^3988292384:m>>>1;i[h]=m>>>0}a=i}i=a;h=0;for(k=d.length;h<k;++h)m=(e^d[h])&255,e=e>>>8^i[m];return(e^-1)>>>0}}(),k=a.dom;a.serializePosition=r;a.deserializePosition=t;a.serializeRange=e;a.deserializeRange=B;a.canDeserializeRange=m;a.serializeSelection=o;a.deserializeSelection=p;a.canDeserializeSelection=function(a,e,d){var i;e?i=d?d.document:k.getDocument(e):e=(d||window).document.documentElement;for(var a=a.split("|"),
...
k=e.domain?";domain="+e.domain:"",m=e.secure?";secure":"",n=o(a.getSelection(b));b.document.cookie=encodeURIComponent("rangySerializedSelection")+"="+encodeURIComponent(n)+d+h+k+m};a.getElementChecksum=v});
...
(function(a,q,h,v){function r(a,g,j){T[a]=j;Z[a]=g;N||(N=a)}function t(c){N!==c&&(N=c,a.ui.editor.eachInstance(function(){this.reinit()}))}function e(a,g){N&&T[N]&&T[N][a]&&(a=T[N][a]);if(!g)return a;for(var j in g)a=a.replace("{{"+j+"}}",g[j]);return a}function B(c){if(X===v){X=!0;if(Y=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(c.options.baseClass+"-ios"),Y&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height",
"-=1")},0)});a.browser.mozilla&&a("html").addClass(c.options.baseClass+"-ff");if(a.browser.msie&&9>a.browser.version){X=!1;var g=a("<div/>").addClass(c.options.baseClass+"-unsupported").html(c.getTemplate("unsupported")).appendTo("body");m(g);g.find("."+c.options.baseClass+"-unsupported-close").click(function(){g.remove()})}}return X}function m(c){var g=1;c.siblings().each(function(){var c=a(this).css("z-index");!isNaN(c)&&c>g&&(g=c+1)});c.css("z-index",g)}function o(a){return a.clone().wrap("<div/>").parent().html()}
function p(a){var g,a=document.createElement(a);g="getComputedStyle"in q;document.body.appendChild(a);g=(g?q.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return g}function n(c,g){return-1!==a.inArray(a(c)[0].tagName.toLowerCase(),g)}function k(a){for(var g={},a=q.getComputedStyle(a[0],null),j=0;j<a.length;j++)g[a.item(j)]=a.getPropertyValue(a.item(j));return g}function b(c,g){z();a(c).each(function(){var j=a("<"+g+"/>").html(a(this).html());c.html(j)});H()}function l(c,
...
function D(c){var c=c||h.getSelection(),g;a(c.getAllRanges()).each(function(c,b){g=3===this.commonAncestorContainer.nodeType?a(b.commonAncestorContainer).parent()[0]:b.commonAncestorContainer});return g}function s(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer}function z(a){if(!Q||a)Q=h.saveSelection()}function H(){Q&&(h.restoreSelection(Q),Q=!1)}function J(){Q&&h.removeMarkers(Q);Q=!1}function x(a,g,j){for(var g=g||h.getSelection(),b,e=0;b=g.getAllRanges()[e++];)a.call(j,
b)}function E(a,g){x(function(g){i(a,g)},g,this)}function M(c,g){g=g||h.getSelection();g.removeAllRanges();a(c).focus().contents().each(function(){var a=h.createRange();a.selectNodeContents(this);g.addRange(a)})}function C(c,g){g=g||h.getSelection();g.removeAllRanges();a(c).each(function(){var a=h.createRange();a.selectNode(this);g.addRange(a)}).focus()}function R(c,g,b){g=g||h.getSelection();g.removeAllRanges();a(c).each(function(){var a=h.createRange();a.selectNodeContents(this);a.collapse(b);g.addRange(a)})}
function O(a,g){R(a,g,!1)}function K(a,g){R(a,g,!0)}function u(a){a=a||h.getSelection();return a.toHtml()}function w(c){c=c||h.getSelection().getRangeAt(0);return a(3===c.commonAncestorContainer.nodeType?c.commonAncestorContainer.parentNode:c.commonAncestorContainer)}function F(a){var g=new jQuery;x(function(a){g.push(w(a)[0])},a,this);return g}function W(){var c=h.getSelection();if(null===c.anchorNode)return null;if(c.isBackwards())return 3===c.focusNode.nodeType?a(c.focusNode.parentElement):a(c.focusNode);
c.anchorNode||console.trace();return 3===c.anchorNode.nodeType?a(c.anchorNode.parentElement):a(c.anchorNode)}function I(){var c=h.getSelection();return null===c.anchorNode?null:c.isBackwards()?3===c.anchorNode.nodeType?a(c.anchorNode.parentElement):a(c.anchorNode):3===c.focusNode.nodeType?a(c.focusNode.parentElement):a(c.focusNode)}function f(c,g){var g=g||{},b=h.createCssClassApplier(g.classes||"",{normalize:!0,elementTagName:c,elementProperties:g.attributes||{}});x(function(e){var G=e.cloneContents(),
G=d(G);"string"===typeof G&&(G=G.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));a(G).is(":empty")?(G=a("<"+c+"/>").addClass(g.classes).attr(g.attributes||{}).append(d(e.cloneContents())),i(G,e)):b.toggleRange(e)},null,this)}function V(a,g,b){x(function(e){e=w(e);e.is(a)?e.attr(g):f(a,{classes:b,attributes:g})},null,this)}function L(c,g){var g=g||h.getSelection(),b=g.getRangeAt(0),e=F()[0],G=h.createRange();G.setStartBefore(e);G.setEnd(b.startContainer,b.startOffset);var G=G.cloneContents(),f=
h.createRange();f.setStart(b.endContainer,b.endOffset);f.setEndAfter(e);b=f.cloneContents();G=o(a(d(G)));G+=o(a(c));G+=o(a(d(b)));a(e).replaceWith(a(G))}function P(a,g,b){var b=b||h.getSelection(),e=W()[0],d=I()[0],f=F()[0],f=n(f,g),e=n(e,g),g=n(d,g);f&&e&&g?E(a):L(a,b)}function S(c,g){x(function(j){for(j=a(j.commonAncestorContainer);j.length&&j[0]!==g[0]&&(3===j[0].nodeType||"inline"===j.css("display"));)j=j.parent();j[0]===g[0]&&"inline"!==g.css("display")&&(b(g,"div"),j=g.children().first());l(j,
c)},null,this)}function U(c,g){c=a(c)[0];if(g=g||h?h.getSelection():null){var b;a(g.getAllRanges()).each(function(e,d){b=3===this.commonAncestorContainer.nodeType?a(d.commonAncestorContainer).parent()[0]:d.commonAncestorContainer;c!==b&&!a.contains(c,b)&&g.removeRange(d)})}}function A(a,g){allowed=[];for(var b=0;b<g.length;b++)g[b].match(/[a-z][a-z0-9]{0,}/g)&&allowed.push(g[b]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,
c){return-1<allowed.indexOf(c.toLowerCase())?a:""})}var N=null,T={},Z={};a(function(){h.initialized||h.init();a.isFunction(h.rangePrototype.insertNodeAtEnd)||(h.rangePrototype.insertNodeAtEnd=function(a){var g=this.cloneRange();g.collapse(!1);g.insertNode(a);g.detach();this.setEndAfter(a)})});a("html").click(function(){a(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});a.widget("ui.editor",{_init:function(){-1===a.inArray(this,a.ui.editor.instances)&&a.ui.editor.instances.push(this);
...
"floatNone","floatRight"],["tagMenu"],["i18n"],["raptorize"],["statistics"],["debugReinit","debugDestroy"]];this.element.attr("id")||this.element.attr("id",this.getUniqueId());this.ready=!1;this.events={};this.ui={};this.plugins={};this.templates=a.extend({},a.ui.editor.templates);this.path=this.toolbarWrapper=this.toolbar=this.wrapper=null;this.visible=this.enabled=!1;this.uiObjects={};this.hotkeys={};this.options.enableHotkeys&&this.registerHotkey(this.hotkeys);for(var g in this.options.bind)this.bind(g,
this.options.bind[g]);this.history=[];this.present=0;this.historyEnabled=!0;B(this)&&(this.cloneDomTools(),this.setOriginalHtml(this.element.is(":input")?this.element.val():this.element.html()),this.element.is("textarea, input")&&this.replaceOriginal(),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,g=this.persist("locale")||this.options.initialLocale,t(g),this.ready=!0,this.fire("ready"),this.options.autoEnable&&a(function(){c.enableEditing();c.showToolbar()}))},
...
this.getUniqueId()).addClass(this.element.attr("class")),g=k(this.element),b=0;b<this.options.replaceStyle.length;b++)c.css(this.options.replaceStyle[b],g[this.options.replaceStyle[b]]);this.element.hide();this.bind("change",function(){this.element.is("input, textarea")?this.element.val(this.getHtml()):this.element.html(this.getHtml())});this.target=c}},cloneDomTools:function(){for(var a in this.options.domTools)this[a]||(this[a]=function(a){return function(){U(this.getElement());var c=this.getHtml(),
b=this.options.domTools[a].apply(this.options.domTools,arguments);c!==this.getHtml()&&this.change();return b}}(a))},checkChange:function(){var a=h.serializeSelection();this.previousSelection!==a&&this.fire("selectionChange");this.previousSelection=a;var a=this.getCleanHtml(),g=this.dirty;this.dirty=this.getOriginalHtml()!==a;this.previousHtml!==a&&(this.previousHtml=a,this.change(),g!==this.dirty&&(this.dirty?this.fire("dirty"):this.fire("cleaned")))},change:function(){this.fire("change")},destruct:function(a){a||
...
this.options.partialEdit?this.getElement().find(this.options.partialEdit).attr("contenteditable",!0):this.getElement().attr("contenteditable",!0),this.execCommand("enableInlineTableEditing",!1,!1),this.execCommand("styleWithCSS",!0,!0),this.bindHotkeys(),this.fire("enabled"),this.fire("resize"))},disableEditing:function(){this.enabled&&(this.enabled=!1,this.getElement().attr("contenteditable",!1).removeClass(this.options.baseClass+"-editing"),h.getSelection().removeAllRanges(),this.fire("disabled"))},
isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var c=this,g="",b=[],e=0;x(function(d){var d=d.commonAncestorContainer,f;f=3===d.nodeType?a(d).parent():a(d);!c.isRoot(f)&&!a.contains(c.getElement().get(0),f.get(0))&&(f=c.getElement());d=[];for(b.push(d);f[0]&&!c.isRoot(f)&&"body"!==f[0].tagName.toLowerCase();)d.push(f),f=f.parent();d.reverse();g&&(g+=" | ");g+=this.getTemplate("root");for(f=0;f<d.length;f++)g+=this.getTemplate("tag",{element:d[f][0].tagName.toLowerCase(),
data:"["+e+","+f+"]"});e++},null,this);g||(g=this.getTemplate("root"));this.path.html(g).find("a").click(function(){var g=a(this).data("ui-editor-selection");g?(C(b[g[0]][g[1]]),c.updateTagTree()):C(c.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(c){return this.getElement()[0]===a(c)[0]},unify:function(c,g){!1!==g&&c(this);if(this.options.unify){var b=this;a.ui.editor.eachInstance(function(a){a!==b&&a.options.unify&&c(a)})}},getUniqueId:function(){return a.ui.editor.getUniqueId()},
loadMessages:function(){this.messages=a(this.getTemplate("messages")).appendTo(this.wrapper)},showMessage:function(c,g,b){var b=a.extend({},this.options.message,b),e;e={timer:null,editor:this,show:function(){this.element.slideDown();this.timer=q.setTimeout(function(){this.timer=null;e.hide()},b.delay,this)},hide:function(){this.timer&&(q.clearTimeout(this.timer),this.timer=null);this.element.stop().slideUp(a.proxy(function(){a.isFunction(b.hide)&&b.hide.call(this);this.element.remove()},this))}};
e.element=a(this.getTemplate("message",{type:c,message:g})).hide().appendTo(this.messages).find(".ui-editor-message-close").click(function(){e.hide()}).end();e.show();return e},showLoading:function(a,g){return this.showMessage("clock",a,g)},showInfo:function(a,g){return this.showMessage("info",a,g)},showError:function(a,g){return this.showMessage("circle-close",a,g)},showConfirm:function(a,g){return this.showMessage("circle-check",a,g)},showWarning:function(a,g){return this.showMessage("alert",a,
...
d&&this.events[a].splice(e,1)},fire:function(c,b,d){d||this.fire("before:"+c,b,!0);if(this.events[c])for(var e=0,f=this.events[c].length;e<f;e++){var h=this.events[c][e];"undefined"!==typeof h.callback&&h.callback.call(h.context||this)}!1!==b&&a.ui.editor.fire(c);d||this.fire("after:"+c,b,!0)}});a.extend(a.ui.editor,{elementRemoveComments:function(c){c.contents().each(function(){8==this.nodeType&&a(this).remove()});c.children().each(function(){element.removeComments(a(this))});return c},elementRemoveAttributes:function(c,
b){c.children().each(function(){var c=a.map(this.attributes,function(c){if(-1===a.inArray(c.name,b))return c.name}),d=a(this);a.each(c,function(a,c){d.removeAttr(c)});element.removeAttributes(a(this),b)});return c},elementBringToTop:m,elementOuterHtml:o,elementOuterText:function(a){return a.clone().wrap("<div/>").parent().text()},elementIsBlock:function(a){return"block"===p(a.tagName)},elementDefaultDisplay:p,elementIsValid:n,elementGetStyles:k,elementWrapInner:b,elementToggleStyle:l,elementSwapStyles:function(a,
b,d){for(var e in d)a.css(e,b.css(e)),b.css(e,d[e])},fragmentToHtml:d,fragmentInsertBefore:function(c,b,d){for(var e=0,f=c.childNodes.length;e<f;e++){var h=c.childNodes.item(e);(h=3===h.nodeType?h.nodeValue:a(h).html())&&a("<"+d+"/>").html(a.trim(h)).insertBefore(b)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},rangeGetCommonAncestor:D,rangeIsEmpty:s,selectionSave:z,selectionRestore:H,selectionDestroy:J,selectionEachRange:x,selectionReplace:E,
selectionSelectInner:M,selectionSelectOuter:C,selectionSelectEdge:R,selectionSelectEnd:O,selectionSelectStart:K,selectionGetHtml:u,selectionGetElements:F,selectionToggleWrapper:f,selectionExists:function(a){var b=!1;x(function(a){s(a)||(b=!0)},a,this);return b},selectionReplaceSplittingSelectedElement:L,selectionReplaceWithinValidTags:P,selectionToggleBlockStyle:S,stringStripTags:A,defaults:{plugins:{},ui:{},bind:{},domTools:{unwrapParentTag:function(c){F().each(function(){a(this).is(c)&&a(this).replaceWith(a(this).html())})},
execCommand:function(a,b,d){try{document.execCommand(a,b,d)}catch(e){}},insertTag:function(c,b){x(function(b){b.insertNode(a("<"+c+"/>")[0])},b,this)},insertTagAtEnd:function(c,b){x(function(b){b.insertNodeAtEnd(a("<"+c+"/>")[0])},b,this)},insertElement:function(c,b,d){x(function(d){a(c).each(function(){d.insertNode(!1===b?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(c,b,d){x(function(d){a(c).each(function(){d.insertNodeAtEnd(!1===b?this:this.cloneNode(!0))})},d,this)},inverseWrapWithTagClass:function(c,
b,d,e){z();var f="domTools"+Math.ceil(1E7*Math.random());x(function(a){var c=h.createCssClassApplier(e,{elementTagName:d});c.isAppliedToRange(a)?c.toggleSelection():h.createCssClassApplier(b,{elementTagName:f}).toggleSelection()},null,this);a(f).each(function(){a(this).replaceWith(a("<"+c+"/>").addClass(b).html(a(this).html()))});H()}},namespace:null,unify:!0,persistence:!0,persistenceName:"uiEditor",unloadWarning:!0,autoEnable:!1,partialEdit:!1,enablePlugins:!0,disabledPlugins:[],uiOrder:null,enableUi:!0,
...
if(a(this).hasClass("rangySelectionBoundary")&&!1===(!1!==Q)||""===a.trim(a(this).html()))return!0}).remove();for(c=0;c<this.options.stripEmptyAttrs.length;c++){var d=this.options.stripEmptyAttrs[c];b.getElement().find("["+this.options.stripEmptyAttrs[c]+"]").filter(function(){return""===a.trim(a(this).attr(d))}).removeAttr(this.options.stripEmptyAttrs[c])}var e=q.location.protocol+"//"+q.location.host,f="//"+q.location.host;for(c=0;c<this.options.stripDomains.length;c++){var h=this.options.stripDomains[c];
this.editor.getElement().find(h.selector).each(function(){for(var c=0;c<h.attributes.length;c++){var b=a(this).attr(h.attributes[c]);"undefined"!==typeof b&&(0===b.indexOf(e)?a(this).attr(h.attributes[c],b.substr(e.length)):0===b.indexOf(f)&&a(this).attr(h.attributes[c],b.substr(f.length)))}})}this.editor.getElement().find("ul, ol").each(function(){a(this).find(" > :not(li)").each(function(){p(a(this).attr("tag"))?a(this).replaceWith(a("<li>"+a(this).html()+"</li>").appendTo("body")):a(this).wrap(a("<li>"))})})}});
a.ui.editor.registerUi({clean:{init:function(a){return a.uiButton({title:e("Remove unnecessary markup from editor content"),click:function(){a.getPlugin("clean").clean()}})}}});a.ui.editor.registerUi({clearFormatting:{init:function(c){return this.editor.uiButton({title:e("Clear Formatting"),click:function(){var b=h.getSelection();if(0<b.rangeCount){var e=b.getRangeAt(0).cloneRange(),f=e.extractContents();""==d(f)&&(c.expandToParent(e),b.setSingleRange(e),f=e.extractContents());f=a("<div/>").append(d(f)).text();
for(b=e.commonAncestorContainer;b&&b.parentNode!=c.getElement().get(0);)b=b.parentNode;if(b){e.setEndAfter(b);var i=e.extractContents();e.collapseAfter(b);e.insertNode(i);e.collapseAfter(b)}e.insertNode(document.createTextNode(f))}c.checkChange()}})}}});a.ui.editor.registerPlugin("clickButtonToEdit",{hovering:!1,buttonClass:null,buttonSelector:null,button:!1,options:{button:{text:!0,icons:{primary:"ui-icon-pencil"}}},init:function(c,b){var d=this;this.buttonClass=this.options.baseClass+"-button-element";
this.buttonSelector="."+this.buttonClass;this.selection=function(){var a;document.selection?a=document.selection.createRange():document.getSelection().rangeCount&&(a=document.getSelection().getRangeAt(0));return a};this.show=function(){if(!c.isEditing()){c.getElement().addClass(b.baseClass+"-highlight");c.getElement().addClass(b.baseClass+"-hover");var e=d.getButton();var f=c.getElement(),f=a(f),h=Math.round(f.offset().top),i=Math.round(f.offset().left),k=Math.round(f.outerWidth()),f=Math.round(f.outerHeight()),
l=a(q).scrollTop(),m=a(q).height(),n=l+m,o=Math.round(f+h);l<h&&n>o||(l>h&&(h=l),f=n<o?n-h:m-(n-o));e.css({position:"absolute",top:h+(f/2-a(e).outerHeight()/2),left:i+k/2-a(e).outerWidth()/2})}};this.hide=function(e){var f=d.getButton();if(!e||!(e.relatedTarget===f.get(0)||f.get(0)===a(e.relatedTarget).parent().get(0)))c.getElement().removeClass(b.baseClass+"-highlight"),c.getElement().removeClass(b.baseClass+"-hover"),d.destroyButton()};this.edit=function(){d.hide();c.isEditing()||c.enableEditing();
...
a(this.dialog).dialog("destroy").remove();this.dialog=null;a(this.ui.button).button("option","disabled",!1)},show:function(){if(!this.dialog){a(this.ui.button).button("option","disabled",!0);var c=this;z();this.dialog=a(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:e("Paste Embed Code"),autoOpen:!0,dialogClass:c.options.baseClass+" "+c.options.dialogClass,buttons:[{text:e("Embed Object"),click:function(){H();E(a(this).find("textarea").val());
...
this.nodeType&&a.trim(this.nodeValue).length})}});a.ui.editor.registerUi({floatLeft:{init:function(c){return c.uiButton({title:e("Float Image Left"),click:function(){x(function(c){a(c.commonAncestorContainer).find("img").css("float","left")})}})}},floatRight:{init:function(c){return c.uiButton({title:e("Float Image Right"),click:function(){x(function(c){a(c.commonAncestorContainer).find("img").css("float","right")})}})}},floatNone:{init:function(c){return c.uiButton({title:e("Remove Image Float"),
click:function(){x(function(c){a(c.commonAncestorContainer).find("img").css("float","none")})}})}}});a.ui.editor.registerUi({fontSizeInc:{init:function(a,b){return a.uiButton({title:e("Increase Font Size"),click:function(){a.inverseWrapWithTagClass("big",b.cssPrefix+"big","small",b.cssPrefix+"small")}})}},fontSizeDec:{init:function(a,b){return a.uiButton({title:e("Decrease Font Size"),click:function(){a.inverseWrapWithTagClass("small",b.cssPrefix+"small","big",b.cssPrefix+"big")}})}}});a.ui.editor.registerUi({showGuides:{init:function(a,
...
"{{characters}} characters, {{charactersRemaining}} remaining":"{{characters}} Zeichen, {{charactersRemaining}} verbleibend","{{sentences}} sentences":"{{sentences}} S\u00e4tze","{{words}} word":"{{words}} Wort","{{words}} words":"{{words}} W\u00f6rter"});r("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"Apply Source",
...
"{{words}} word":"{{words}} woord","{{words}} words":"{{words}} woorden"});r("zh-CN","\u7b80\u4f53\u4e2d\u6587",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"\u5e94\u7528\u6e90\u4ee3\u7801","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",Blockquote:"\u5927\u6bb5\u5f15\u7528",Bold:"\u7c97\u4f53",
...
c&&!g)&&d.typeChange(d.types[e.filter(":checked").val()],c);a(this).unbind("keyup."+d.editor.widgetName).bind("keyup."+d.editor.widgetName,function(c){13==c.keyCode&&(c=d.types[e.filter(":checked").val()],(!a.isFunction(c.validate)||c.validate(d.dialog.find("."+d.options.baseClass+"-content")))&&b.find("button:eq(0)").trigger("click"))})},close:function(){H();d.visible=!1;f.find("."+b.baseClass+"-content").hide();a(this).dialog("destroy")}}).dialog("open")}},apply:function(c){var b=this.types[this.dialog.find('input[type="radio"]:checked').val()],
d=b.attributes(this.dialog.find("."+this.options.baseClass+"-content"),c);if(!d)return!0;H();var f=o(a("<a>"+(d.title?d.title:d.href)+"</a>").attr(a.extend({},d,{target:"_blank"})));c?(this.selectedElement[0].className=this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(b.classes).attr(d),this.editor.showConfirm(e("Updated link: {{link}}",{link:f}))):(V("a",a.extend(d,{id:this.editor.getUniqueId()}),b.classes),this.editor.showConfirm(e("Added link: {{link}}",
{link:f})),this.selectedElement=a("#"+d.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",d.href);C(this.selectedElement);z();return!0},typeChange:function(c,b){var d=this.dialog.find("."+this.options.baseClass+"-content"),e=d.closest("."+this.options.baseClass+"-wrap"),f=c.ajaxUri&&!this.types[c.type].content;f&&e.addClass(this.options.baseClass+"-loading");var h=this;d.hide(this.options.panelAnimation,function(){f?a.ajax({url:c.ajaxUri,type:"get",success:function(f){d.html(f);
...
this.change,this);a.bind("show",this.change,this);return a.uiButton({title:e("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){F().is("a")?this.ui.enable():this.ui.disable()}}});a.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),
toggleList:function(c){a(F()).is("li")&&a(F()).parent().is(c)?this.unwrapList():this.wrapList(c);this.editor.fire("selectionChange");this.editor.fire("change")},unwrapList:function(){z();var c=[],b=[],d=W(),e=I();c.push(a(d).html());b.push(d);if(a(d)[0]!==a(e)[0]){var f=d;do f=a(f).next(),c.push(a(f).html()),b.push(f);while(a(f)[0]!==a(e)[0])}f=0===a(d).prev().length;e=0===a(e).next().length;d=a(d).parent();for(listElementsIndex=0;listElementsIndex<b.length;listElementsIndex++)a(b[listElementsIndex]).remove();
for(b=0;b<c.length;b++)d.parent().is("li")||(c[b]="<p>"+c[b]+"</p>");f&&e?(d.replaceWith(c.join("")),H(),c=F()[0],C(c)):(f?a(d).before(c.join("")):e?a(d).after(c.join("")):L(c.join("")),H(),this.editor.checkChange())},wrapList:function(c){U(this.editor.getElement());""===a.trim(u())&&M(F());var b=a("<div>").html(u()),d=[],e=this;a(b).contents().each(function(){var c;c="block"===p(this.tagName)?A(a(this).html(),e.validChildren):A(o(a(this)),e.validChildren);c=a("<li>"+c+"</li>");""!==a.trim(c.text())&&
d.push(o(c))});b=this.options.baseClass+"-selection";c="<"+c+' class="'+b+'">'+d.join("")+"</"+c+">";H();var f=a(F()[0]).parent(),h=this.editor.getElement()[0];f===h||F()[0]===h?E(c):P(c,this.validParents);b=a(this.editor.getElement().find("."+b).removeClass(b));M(b.find("li:first")[0]);this.editor.checkChange()},toggleButtonState:function(c,b){var d=function(a){b.button.toggleClass("ui-state-highlight",a).toggleClass("ui-state-default",!a)},e=W();if(null===e||!e.length)e=this.editor.getElement();
var f=I();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(a(e).is(c)&&a(f).is(c)&&e===f)return d(!0);var h=a(e).parentsUntil(i,c).first()&&a(f).parentsUntil(i,c).first(),i="#"+this.editor.getElement().attr("id"),k=a(e).is(c+" > li")||a(e).parentsUntil(i,c+" > li").length,l=a(f).is(c+" > li")||a(f).parentsUntil(i,c+" > li").length;if(k&&l&&h){h=a(D());h.is(c)||(h=a(h).parentsUntil(i,c).first());i=h.find("ul, ol");if(!i.length)return d(!0);for(h=0;h<i.length;h++)if(a.contains(i[h],
e)&&a.contains(i[h],f))return d(!1);return d(!0)}return d(!1)}});a.ui.editor.registerUi({listUnordered:{init:function(a){var b=a.uiButton({title:e("Unordered List"),click:function(){a.getPlugin("list").toggleList("ul")}});a.bind("selectionChange",function(){a.getPlugin("list").toggleButtonState("ul",b)});return b}},listOrdered:{init:function(a){var b=a.uiButton({title:e("Ordered List"),click:function(){a.getPlugin("list").toggleList("ol")}});a.bind("selectionChange",function(){a.getPlugin("list").toggleButtonState("ol",
...
shiftEnter:"<br/>",shiftEnterValidTags:"a,abbr,acronym,address,applet,b,bdo,big,blockquote,body,button,caption,center,cite,code,dd,del,dfn,div,dt,em,fieldset,font,form,h1,h2,h3,h4,h5,h6,i,iframe,ins,kbd,label,legend,li,noframes,noscript,object,p,pres,q,s,samp,small,span,strike,strong,sub,sup,td,th,tt,u,var".split(",")},hotkeys:{"return":{action:function(){J();var c=""===h.getSelection().toHtml(),b;b=h.getSelection();var d=b.isBackwards()?b.focusNode:b.anchorNode;(b.isBackwards()?b.focusOffset:0!==
b.anchorOffset)?b=!1:(b=d.previousSibling,b=!b||""===a(b).html()?!0:!1);var e;d=h.getSelection();e=d.isBackwards()?d.anchorNode:d.focusNode;(d.isBackwards()?d.focusOffset:d.anchorOffset)!==e.textContent.length?e=!1:(d=e.nextSibling,e=!d||""===a(d).html()?!0:!1);var f=this.options.baseClass+"-enter-break",d=a(this.options.enter).attr("id",f);P(d,this.options.enterValidTags);d=a("#"+f).removeAttr("id");c?b?K(d.next()):e?K(d):(K(d.next()),(c=d.prev())&&""!==a.trim(c.html())&&o(c)!==this.options.enter&&
d.remove()):(K(d.next()),d.remove())},restoreSelection:!1},"return+shift":{action:function(){J();var c=this.options.baseClass+"-enter-break",b=a(this.shiftEnter).attr("id",c).appendTo("body");this.options.shiftEnterValidTags?P(this.options.shiftEnter,this.options.shiftEnterValidTags):E(b);c=a("#"+c).removeAttr("id").next();K(c)},restoreSelection:!1}}});a.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span,hr,br".split(","),allowedAttributes:["href",
"title"],allowedEmptyTags:["hr","br"]},init:function(c,b){var d=!1,f=!1,h=this;c.getElement().bind("paste."+c.widgetName,a.proxy(function(){if(d)return!1;d=!0;z();a(".uiWidgetEditorPasteBin").length&&a(".uiWidgetEditorPasteBin").remove();a('<div class="uiWidgetEditorPasteBin" contenteditable="true" style="width: 1px; height: 1px; overflow: hidden; position: fixed; top: -1px;" />').appendTo("body");a(".uiWidgetEditorPasteBin").focus();q.setTimeout(function(){var i=a(".uiWidgetEditorPasteBin").html(),
i=h.filterAttributes(i),i=h.filterChars(i),i=h.stripEmpty(i),i=h.stripAttributes(i),i=A(i,h.options.allowedTags),i={plain:a("<div/>").html(a(".uiWidgetEditorPasteBin").html()).text(),markup:i,html:a(".uiWidgetEditorPasteBin").html()};f=a(c.getTemplate("paste.dialog",i));a(f).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:b.dialogShowAnimation,hide:b.dialogHideAnimation,dialogClass:b.baseClass+" "+b.dialogClass,buttons:[{text:e("Insert"),click:function(){var b=
null,b=a(this).find(".ui-editor-paste-area:visible"),b=b.hasClass("ui-editor-paste-plain")||b.hasClass("ui-editor-paste-source")?b.val():b.html(),b=h.filterAttributes(b),b=h.filterChars(b);H();E(b);c.checkChange();d=!1;a(this).dialog("close")}},{text:e("Cancel"),click:function(){H();d=!1;a(this).dialog("close")}}],open:function(){var c=a(this).find(".ui-editor-paste-panel-tabs");c.find("ul.ui-tabs-nav li").click(function(){c.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
...
{init:function(c,b){b=a.extend({},{content:"[Your content here]",tag:"p",select:!0},b);this.show=function(){if(!a.trim(c.getElement().html())){var d=a(document.createElement(b.tag)).html(b.content);c.getElement().html(d);b.select&&M(d)}};c.bind("show",this.show)}});a.ui.editor.registerPlugin("saveJson",{options:{id:{attr:"name"},postName:"content",showResponse:!1,appendId:!1,ajax:{url:"/",type:"post",cache:!1}},init:function(){},getId:function(){if("string"===typeof this.options.id)return this.options.id;
...
f=F();if(!u()||""===u()){if(a(f)[0]===a(e)[0])return;z();e=a("<"+d+">").html(f.html());f.replaceWith(e);H()}else{var f=a(F()[0]).parent(),h=this.options.baseClass+"-selection",d=a("<"+d+">").html(u()).addClass(h);f===e||F()[0]===e?E(d):P(d,this.validParents);M(b.getElement().find("."+h).removeClass(h))}b.checkChange()}}})},change:function(){var b=F()[0];b?(b=b.tagName.toLowerCase(),this.ui.select.find("option[value="+b+"]").length?this.ui.val(b):this.ui.val("na"),a(this.ui.button).toggleClass("ui-state-disabled",
