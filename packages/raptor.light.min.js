...
*/
window.rangy=function(){function a(a,h){var d=typeof a[h];return d==p||!!(d==n&&a[h])||"unknown"==d}function s(a,h){return!!(typeof a[h]==n&&a[h])}function f(a,h){return typeof a[h]!=r}function w(a){return function(h,d){for(var b=d.length;b--;)if(!a(h,d[b]))return!1;return!0}}function t(a){return a&&d(a,m)&&v(a,b)}function u(a){window.alert("Rangy not supported in your browser. Reason: "+a);q.initialized=!0;q.supported=!1}function e(){if(!q.initialized){var h,b=!1,n=!1;a(document,"createRange")&&
(h=document.createRange(),d(h,l)&&v(h,o)&&(b=!0),h.detach());if((h=s(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(h,"createTextRange"))h=h.createTextRange(),t(h)&&(n=!0);!b&&!n&&u("Neither Range nor TextRange are implemented");q.initialized=!0;q.features={implementsDomRange:b,implementsTextRange:n};b=D.concat(A);n=0;for(h=b.length;n<h;++n)try{b[n](q)}catch(e){s(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
e)}}}function y(a){this.name=a;this.supported=this.initialized=!1}var n="object",p="function",r="undefined",o="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer,START_TO_START,START_TO_END,END_TO_START,END_TO_END".split(","),l="setStart,setStartBefore,setStartAfter,setEnd,setEndBefore,setEndAfter,collapse,selectNode,selectNodeContents,compareBoundaryPoints,deleteContents,extractContents,cloneContents,insertNode,surroundContents,cloneRange,toString,detach".split(","),
b="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),m="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),d=w(a),h=w(s),v=w(f),q={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:a,isHostObject:s,isHostProperty:f,areHostMethods:d,areHostObjects:h,areHostProperties:v,isTextRange:t},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
q.fail=u;q.warn=function(a){a="Rangy warning: "+a;q.config.alertOnWarn?window.alert(a):typeof window.console!=r&&typeof window.console.log!=r&&window.console.log(a)};({}).hasOwnProperty?q.util.extend=function(a,h){for(var d in h)h.hasOwnProperty(d)&&(a[d]=h[d])}:u("hasOwnProperty not supported");var A=[],D=[];q.init=e;q.addInitListener=function(a){q.initialized?a(q):A.push(a)};var F=[];q.addCreateMissingNativeApiListener=function(a){F.push(a)};q.createMissingNativeApi=function(a){a=a||window;e();
for(var h=0,d=F.length;h<d;++h)F[h](a)};y.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};y.prototype.warn=function(a){q.warn("Module "+this.name+": "+a)};y.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};q.createModule=function(a,h){var d=new y(a);q.modules[a]=d;D.push(function(a){h(a,d);d.initialized=!0;d.supported=!0})};q.requireModules=function(a){for(var h=0,d=a.length,b,v;h<
d;++h){v=a[h];b=q.modules[v];if(!b||!(b instanceof y))throw Error("Module '"+v+"' not found");if(!b.supported)throw Error("Module '"+v+"' not supported");}};var E=!1,h=function(){E||(E=!0,q.initialized||e())};if(typeof window==r)u("No window found");else if(typeof document==r)u("No document found");else return a(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",h,!1),a(window,"addEventListener")?window.addEventListener("load",h,!1):a(window,"attachEvent")?window.attachEvent("onload",
h):u("Window does not have required addEventListener or attachEvent method"),q}();
rangy.createModule("DomUtil",function(a,s){function f(a){for(var d=0;a=a.previousSibling;)d++;return d}function w(a,b){var n=[],e;for(e=a;e;e=e.parentNode)n.push(e);for(e=b;e;e=e.parentNode)if(d(n,e))return e;return null}function t(a,d,b){for(b=b?a:a.parentNode;b;){a=b.parentNode;if(a===d)return b;b=a}return null}function u(a){a=a.nodeType;return 3==a||4==a||8==a}function e(a,d){var b=d.nextSibling,n=d.parentNode;b?n.insertBefore(a,b):n.appendChild(a);return a}function y(a){if(9==a.nodeType)return a;
if(typeof a.ownerDocument!=l)return a.ownerDocument;if(typeof a.document!=l)return a.document;if(a.parentNode)return y(a.parentNode);throw Error("getDocument: no document found for node");}function n(a){return!a?"[No node]":u(a)?'"'+a.data+'"':1==a.nodeType?"<"+a.nodeName+(a.id?' id="'+a.id+'"':"")+">["+a.childNodes.length+"]":a.nodeName}function p(a){this._next=this.root=a}function r(a,d){this.node=a;this.offset=d}function o(a){this.code=this[a];this.codeName=a;this.message="DOMException: "+this.codeName}
var l="undefined",b=a.util;b.areHostMethods(document,["createDocumentFragment","createElement","createTextNode"])||s.fail("document missing a Node creation method");b.isHostMethod(document,"getElementsByTagName")||s.fail("document missing getElementsByTagName method");var m=document.createElement("div");b.areHostMethods(m,["insertBefore","appendChild","cloneNode"])||s.fail("Incomplete Element implementation");b.isHostProperty(m,"innerHTML")||s.fail("Element is missing innerHTML property");m=document.createTextNode("test");
b.areHostMethods(m,["splitText","deleteData","insertData","appendData","cloneNode"])||s.fail("Incomplete Text Node implementation");var d=function(a,d){for(var b=a.length;b--;)if(a[b]===d)return!0;return!1};p.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){var a=this._current=this._next,d;if(this._current){d=a.firstChild;if(!d)for(d=null;a!==this.root&&!(d=a.nextSibling);)a=a.parentNode;this._next=d}return this._current},detach:function(){this._current=this._next=this.root=
null}};r.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+n(this.node)+":"+this.offset+")]"}};o.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};o.prototype.toString=function(){return this.message};a.dom={arrayContains:d,isHtmlNamespace:function(a){var d;return typeof a.namespaceURI==l||null===(d=a.namespaceURI)||"http://www.w3.org/1999/xhtml"==
d},parentElement:function(a){a=a.parentNode;return 1==a.nodeType?a:null},getNodeIndex:f,getNodeLength:function(a){var d;return u(a)?a.length:(d=a.childNodes)?d.length:0},getCommonAncestor:w,isAncestorOf:function(a,d,b){for(d=b?d:d.parentNode;d;){if(d===a)return!0;d=d.parentNode}return!1},getClosestAncestorIn:t,isCharacterDataNode:u,insertAfter:e,splitDataNode:function(a,d){var b=a.cloneNode(!1);b.deleteData(0,d);a.deleteData(d,a.length-d);e(b,a);return b},getDocument:y,getWindow:function(a){a=y(a);
...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(a){return b.isHostObject(a,"body")?a.body:a.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var d;d=a.parentNode;)a=d;return a},comparePoints:function(a,d,b,n){var e;if(a==b)return d===n?0:d<n?-1:1;if(e=t(b,a,!0))return d<=f(e)?-1:1;if(e=t(a,b,!0))return f(e)<n?-1:1;d=w(a,b);a=a===d?d:t(a,d,!0);b=b===d?d:t(b,d,!0);if(a===b)throw Error("comparePoints got to case 4 and childA and childB are the same!");
for(d=d.firstChild;d;){if(d===a)return-1;if(d===b)return 1;d=d.nextSibling}throw Error("Should not be here!");},inspectNode:n,fragmentFromNodeChildren:function(a){for(var d=y(a).createDocumentFragment(),b;b=a.firstChild;)d.appendChild(b);return d},createIterator:function(a){return new p(a)},DomPosition:r};a.DOMException=o});
rangy.createModule("DomRange",function(a){function s(c,a){return 3!=c.nodeType&&(i.isAncestorOf(c,a.startContainer,!0)||i.isAncestorOf(c,a.endContainer,!0))}function f(c){return i.getDocument(c.startContainer)}function w(c,a,g){if(a=c._listeners[a])for(var j=0,d=a.length;j<d;++j)a[j].call(c,{target:c,args:g})}function t(c){return new P(c.parentNode,i.getNodeIndex(c))}function u(c){return new P(c.parentNode,i.getNodeIndex(c)+1)}function e(c,a,g){var j=11==c.nodeType?c.firstChild:c;i.isCharacterDataNode(a)?
g==a.length?i.insertAfter(c,a):a.parentNode.insertBefore(c,0==g?a:i.splitDataNode(a,g)):g>=a.childNodes.length?a.appendChild(c):a.insertBefore(c,a.childNodes[g]);return j}function y(c){for(var a,g,j=f(c.range).createDocumentFragment();g=c.next();){a=c.isPartiallySelectedSubtree();g=g.cloneNode(!a);a&&(a=c.getSubtreeIterator(),g.appendChild(y(a)),a.detach(!0));if(10==g.nodeType)throw new I("HIERARCHY_REQUEST_ERR");j.appendChild(g)}return j}function n(c,a,g){for(var j,d,g=g||{stop:!1};j=c.next();)if(c.isPartiallySelectedSubtree())if(!1===
a(j)){g.stop=!0;break}else{if(j=c.getSubtreeIterator(),n(j,a,g),j.detach(!0),g.stop)break}else for(j=i.createIterator(j);d=j.next();)if(!1===a(d)){g.stop=!0;return}}function p(c){for(var a;c.next();)c.isPartiallySelectedSubtree()?(a=c.getSubtreeIterator(),p(a),a.detach(!0)):c.remove()}function r(c){for(var a,g=f(c.range).createDocumentFragment(),j;a=c.next();){c.isPartiallySelectedSubtree()?(a=a.cloneNode(!1),j=c.getSubtreeIterator(),a.appendChild(r(j)),j.detach(!0)):c.remove();if(10==a.nodeType)throw new I("HIERARCHY_REQUEST_ERR");
g.appendChild(a)}return g}function o(c,a,g){var j=!(!a||!a.length),d,x=!!g;j&&(d=RegExp("^("+a.join("|")+")$"));var z=[];n(new b(c,!1),function(c){(!j||d.test(c.nodeType))&&(!x||g(c))&&z.push(c)});return z}function l(c){return"["+("undefined"==typeof c.getName?"Range":c.getName())+"("+i.inspectNode(c.startContainer)+":"+c.startOffset+", "+i.inspectNode(c.endContainer)+":"+c.endOffset+")]"}function b(c,a){this.range=c;this.clonePartiallySelectedTextNodes=a;if(!c.collapsed){this.sc=c.startContainer;
...
this[c];this.codeName=c;this.message="RangeException: "+this.codeName}function d(c,a,g){this.nodes=o(c,a,g);this._next=this.nodes[0];this._position=0}function h(c){return function(a,g){for(var j,d=g?a:a.parentNode;d;){j=d.nodeType;if(i.arrayContains(c,j))return d;d=d.parentNode}return null}}function v(a,g){if(c(a,g))throw new m("INVALID_NODE_TYPE_ERR");}function q(c){if(!c.startContainer)throw new I("INVALID_STATE_ERR");}function A(c,a){if(!i.arrayContains(a,c.nodeType))throw new m("INVALID_NODE_TYPE_ERR");
}function D(c,a){if(0>a||a>(i.isCharacterDataNode(c)?c.length:c.childNodes.length))throw new I("INDEX_SIZE_ERR");}function F(c,a){if(W(c,!0)!==W(a,!0))throw new I("WRONG_DOCUMENT_ERR");}function E(c){if(S(c,!0))throw new I("NO_MODIFICATION_ALLOWED_ERR");}function C(c,a){if(!c)throw new I(a);}function O(c){return!!c.startContainer&&!!c.endContainer&&!(!i.arrayContains(K,c.startContainer.nodeType)&&!W(c.startContainer,!0))&&!(!i.arrayContains(K,c.endContainer.nodeType)&&!W(c.endContainer,!0))&&c.startOffset<=
(i.isCharacterDataNode(c.startContainer)?c.startContainer.length:c.startContainer.childNodes.length)&&c.endOffset<=(i.isCharacterDataNode(c.endContainer)?c.endContainer.length:c.endContainer.childNodes.length)}function B(c){q(c);if(!O(c))throw Error("Range error: Range is no longer valid after DOM mutation ("+c.inspect()+")");}function L(){}function J(c){c.START_TO_START=X;c.START_TO_END=Z;c.END_TO_END=da;c.END_TO_START=$;c.NODE_BEFORE=aa;c.NODE_AFTER=ba;c.NODE_BEFORE_AND_AFTER=ca;c.NODE_INSIDE=Y}
function M(c){J(c);J(c.prototype)}function k(c,a){return function(){B(this);var g=this.startContainer,j=this.startOffset,d=this.commonAncestorContainer,x=new b(this,!0);g!==d&&(g=i.getClosestAncestorIn(g,d,!0),j=u(g),g=j.node,j=j.offset);n(x,E);x.reset();d=c(x);x.detach();a(this,g,j,g,j);return d}}function H(c,g,j){function d(c,a){return function(g){q(this);A(g,R);A(T(g),K);g=(c?t:u)(g);(a?x:z)(this,g.node,g.offset)}}function x(c,a,j){var d=c.endContainer,z=c.endOffset;if(a!==c.startContainer||j!==
c.startOffset){if(T(a)!=T(d)||1==i.comparePoints(a,j,d,z))d=a,z=j;g(c,a,j,d,z)}}function z(c,a,j){var d=c.startContainer,x=c.startOffset;if(a!==c.endContainer||j!==c.endOffset){if(T(a)!=T(d)||-1==i.comparePoints(a,j,d,x))d=a,x=j;g(c,d,x,a,j)}}c.prototype=new L;a.util.extend(c.prototype,{setStart:function(c,a){q(this);v(c,!0);D(c,a);x(this,c,a)},setEnd:function(c,a){q(this);v(c,!0);D(c,a);z(this,c,a)},setStartBefore:d(!0,!0),setStartAfter:d(!1,!0),setEndBefore:d(!0,!1),setEndAfter:d(!1,!1),collapse:function(c){B(this);
c?g(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):g(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(c){q(this);v(c,!0);g(this,c,0,c,i.getNodeLength(c))},selectNode:function(c){q(this);v(c,!1);A(c,R);var a=t(c),c=u(c);g(this,a.node,a.offset,c.node,c.offset)},extractContents:k(r,g),deleteContents:k(p,g),canSurroundContents:function(){B(this);E(this.startContainer);E(this.endContainer);var c=new b(this,!0),a=c._first&&
s(c._first,this)||c._last&&s(c._last,this);c.detach();return!a},detach:function(){j(this)},splitBoundaries:function(){B(this);var c=this.startContainer,a=this.startOffset,j=this.endContainer,d=this.endOffset,x=c===j;i.isCharacterDataNode(j)&&0<d&&d<j.length&&i.splitDataNode(j,d);i.isCharacterDataNode(c)&&0<a&&a<c.length&&(c=i.splitDataNode(c,a),x?(d-=a,j=c):j==c.parentNode&&d>=i.getNodeIndex(c)&&d++,a=0);g(this,c,a,j,d)},normalizeBoundaries:function(){B(this);var c=this.startContainer,a=this.startOffset,
j=this.endContainer,d=this.endOffset,x=function(c){var a=c.nextSibling;a&&a.nodeType==c.nodeType&&(j=c,d=c.length,c.appendData(a.data),a.parentNode.removeChild(a))},z=function(g){var x=g.previousSibling;if(x&&x.nodeType==g.nodeType){c=g;var z=g.length;a=x.length;g.insertData(0,x.data);x.parentNode.removeChild(x);c==j?(d+=a,j=c):j==g.parentNode&&(x=i.getNodeIndex(g),d==x?(j=g,d=z):d>x&&d--)}},V=!0;i.isCharacterDataNode(j)?j.length==d&&x(j):(0<d&&(V=j.childNodes[d-1])&&i.isCharacterDataNode(V)&&x(V),
V=!this.collapsed);V?i.isCharacterDataNode(c)?0==a&&z(c):a<c.childNodes.length&&(x=c.childNodes[a])&&i.isCharacterDataNode(x)&&z(x):(c=j,a=d);g(this,c,a,j,d)},collapseToPoint:function(c,a){q(this);v(c,!0);D(c,a);(c!==this.startContainer||a!==this.startOffset||c!==this.endContainer||a!==this.endOffset)&&g(this,c,a,c,a)}});M(c)}function U(c){c.collapsed=c.startContainer===c.endContainer&&c.startOffset===c.endOffset;c.commonAncestorContainer=c.collapsed?c.startContainer:i.getCommonAncestor(c.startContainer,
c.endContainer)}function N(c,a,g,j,d){var x=c.startContainer!==a||c.startOffset!==g,z=c.endContainer!==j||c.endOffset!==d;c.startContainer=a;c.startOffset=g;c.endContainer=j;c.endOffset=d;U(c);w(c,"boundarychange",{startMoved:x,endMoved:z})}function G(c){this.startContainer=c;this.startOffset=0;this.endContainer=c;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};U(this)}a.requireModules(["DomUtil"]);var i=a.dom,P=i.DomPosition,I=a.DOMException;b.prototype={_current:null,_next:null,_first:null,
...
(c===this.sc||c===this.ec)?(a=c===this.sc?this.so:0,g=c===this.ec?this.eo:c.length,a!=g&&c.deleteData(a,g-a)):c.parentNode&&c.parentNode.removeChild(c)},isPartiallySelectedSubtree:function(){return s(this._current,this.range)},getSubtreeIterator:function(){var c;if(this.isSingleCharacterDataNode)c=this.range.cloneRange(),c.collapse();else{c=new G(f(this.range));var a=this._current,g=a,j=0,d=a,x=i.getNodeLength(a);i.isAncestorOf(a,this.sc,!0)&&(g=this.sc,j=this.so);i.isAncestorOf(a,this.ec,!0)&&(d=
this.ec,x=this.eo);N(c,g,j,d,x)}return new b(c,this.clonePartiallySelectedTextNodes)},detach:function(c){c&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};m.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};m.prototype.toString=function(){return this.message};d.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
detach:function(){this._current=this._next=this.nodes=null}};var R=[1,3,4,5,7,8,10],K=[2,9,11],Q=[1,3,4,5,7,8,10,11],z=[1,3,4,5,7,8],T=i.getRootContainer,W=h([9,11]),S=h([5,6,10,12]),c=h([6,10,12]),g=document.createElement("style"),j=!1;try{g.innerHTML="<b>x</b>",j=3==g.firstChild.nodeType}catch(x){}a.features.htmlParsingConforms=j;var V="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),X=0,Z=1,da=2,$=3,aa=0,ba=1,ca=2,Y=3;L.prototype={attachListener:function(c,
a){this._listeners[c].push(a)},compareBoundaryPoints:function(c,a){B(this);F(this.startContainer,a.startContainer);var g=c==$||c==X?"start":"end",j=c==Z||c==X?"start":"end";return i.comparePoints(this[g+"Container"],this[g+"Offset"],a[j+"Container"],a[j+"Offset"])},insertNode:function(c){B(this);A(c,Q);E(this.startContainer);if(i.isAncestorOf(c,this.startContainer,!0))throw new I("HIERARCHY_REQUEST_ERR");this.setStartBefore(e(c,this.startContainer,this.startOffset))},cloneContents:function(){B(this);
var c,a;if(this.collapsed)return f(this).createDocumentFragment();if(this.startContainer===this.endContainer&&i.isCharacterDataNode(this.startContainer))return c=this.startContainer.cloneNode(!0),c.data=c.data.slice(this.startOffset,this.endOffset),a=f(this).createDocumentFragment(),a.appendChild(c),a;a=new b(this,!0);c=y(a);a.detach();return c},canSurroundContents:function(){B(this);E(this.startContainer);E(this.endContainer);var c=new b(this,!0),a=c._first&&s(c._first,this)||c._last&&s(c._last,
this);c.detach();return!a},surroundContents:function(c){A(c,z);if(!this.canSurroundContents())throw new m("BAD_BOUNDARYPOINTS_ERR");var a=this.extractContents();if(c.hasChildNodes())for(;c.lastChild;)c.removeChild(c.lastChild);e(c,this.startContainer,this.startOffset);c.appendChild(a);this.selectNode(c)},cloneRange:function(){B(this);for(var c=new G(f(this)),a=V.length,g;a--;)g=V[a],c[g]=this[g];return c},toString:function(){B(this);var c=this.startContainer;if(c===this.endContainer&&i.isCharacterDataNode(c))return 3==
c.nodeType||4==c.nodeType?c.data.slice(this.startOffset,this.endOffset):"";var a=[],c=new b(this,!0);n(c,function(c){(3==c.nodeType||4==c.nodeType)&&a.push(c.data)});c.detach();return a.join("")},compareNode:function(c){B(this);var a=c.parentNode,g=i.getNodeIndex(c);if(!a)throw new I("NOT_FOUND_ERR");c=this.comparePoint(a,g);a=this.comparePoint(a,g+1);return 0>c?0<a?ca:aa:0<a?ba:Y},comparePoint:function(c,a){B(this);C(c,"HIERARCHY_REQUEST_ERR");F(c,this.startContainer);return 0>i.comparePoints(c,
a,this.startContainer,this.startOffset)?-1:0<i.comparePoints(c,a,this.endContainer,this.endOffset)?1:0},createContextualFragment:j?function(c){var a=this.startContainer,g=i.getDocument(a);if(!a)throw new I("INVALID_STATE_ERR");var j=null;1==a.nodeType?j=a:i.isCharacterDataNode(a)&&(j=i.parentElement(a));j=null===j||"HTML"==j.nodeName&&i.isHtmlNamespace(i.getDocument(j).documentElement)&&i.isHtmlNamespace(j)?g.createElement("body"):j.cloneNode(!1);j.innerHTML=c;return i.fragmentFromNodeChildren(j)}:
function(c){q(this);var a=f(this).createElement("body");a.innerHTML=c;return i.fragmentFromNodeChildren(a)},toHtml:function(){B(this);var c=f(this).createElement("div");c.appendChild(this.cloneContents());return c.innerHTML},intersectsNode:function(c,a){B(this);C(c,"NOT_FOUND_ERR");if(i.getDocument(c)!==f(this))return!1;var g=c.parentNode,j=i.getNodeIndex(c);C(g,"NOT_FOUND_ERR");var d=i.comparePoints(g,j,this.endContainer,this.endOffset),g=i.comparePoints(g,j+1,this.startContainer,this.startOffset);
return a?0>=d&&0<=g:0>d&&0<g},isPointInRange:function(c,a){B(this);C(c,"HIERARCHY_REQUEST_ERR");F(c,this.startContainer);return 0<=i.comparePoints(c,a,this.startContainer,this.startOffset)&&0>=i.comparePoints(c,a,this.endContainer,this.endOffset)},intersectsRange:function(c,a){B(this);if(f(c)!=f(this))throw new I("WRONG_DOCUMENT_ERR");var g=i.comparePoints(this.startContainer,this.startOffset,c.endContainer,c.endOffset),j=i.comparePoints(this.endContainer,this.endOffset,c.startContainer,c.startOffset);
...
this.startContainer,this.startOffset)&&a.setStart(c.startContainer,c.startOffset);1==i.comparePoints(c.endContainer,c.endOffset,this.endContainer,this.endOffset)&&a.setEnd(c.endContainer,c.endOffset);return a}throw new m("Ranges do not intersect");},containsNode:function(c,a){return a?this.intersectsNode(c,!1):this.compareNode(c)==Y},containsNodeContents:function(c){return 0<=this.comparePoint(c,0)&&0>=this.comparePoint(c,i.getNodeLength(c))},containsRange:function(c){return this.intersection(c).equals(c)},
containsNodeText:function(c){var a=this.cloneRange();a.selectNode(c);var g=a.getNodes([3]);return 0<g.length?(a.setStart(g[0],0),c=g.pop(),a.setEnd(c,c.length),c=this.containsRange(a),a.detach(),c):this.containsNodeContents(c)},createNodeIterator:function(c,a){B(this);return new d(this,c,a)},getNodes:function(c,a){B(this);return o(this,c,a)},getDocument:function(){return f(this)},collapseBefore:function(c){q(this);this.setEndBefore(c);this.collapse(!1)},collapseAfter:function(c){q(this);this.setStartAfter(c);
this.collapse(!0)},getName:function(){return"DomRange"},equals:function(c){return G.rangesEqual(this,c)},isValid:function(){return O(this)},inspect:function(){return l(this)}};H(G,N,function(c){q(c);c.startContainer=c.startOffset=c.endContainer=c.endOffset=null;c.collapsed=c.commonAncestorContainer=null;w(c,"detach",null);c._listeners=null});a.rangePrototype=L.prototype;G.rangeProperties=V;G.RangeIterator=b;G.copyComparisonConstants=M;G.createPrototypeRange=H;G.inspect=l;G.getRangeDocument=f;G.rangesEqual=
function(c,a){return c.startContainer===a.startContainer&&c.startOffset===a.startOffset&&c.endContainer===a.endContainer&&c.endOffset===a.endOffset};a.DomRange=G;a.RangeException=m});
rangy.createModule("WrappedRange",function(a){function s(a,e,r,f){var l=a.duplicate();l.collapse(r);var b=l.parentElement();t.isAncestorOf(e,b,!0)||(b=e);if(!b.canHaveHTML)return new u(b.parentNode,t.getNodeIndex(b));var e=t.getDocument(b).createElement("span"),m,d=r?"StartToStart":"StartToEnd";do b.insertBefore(e,e.previousSibling),l.moveToElementText(e);while(0<(m=l.compareEndPoints(d,a))&&e.previousSibling);d=e.nextSibling;if(-1==m&&d&&t.isCharacterDataNode(d)){l.setEndPoint(r?"EndToStart":"EndToEnd",
a);if(/[\r\n]/.test(d.data)){b=l.duplicate();r=b.text.replace(/\r\n/g,"\r").length;for(r=b.moveStart("character",r);-1==b.compareEndPoints("StartToEnd",b);)r++,b.moveStart("character",1)}else r=l.text.length;b=new u(d,r)}else d=(f||!r)&&e.previousSibling,b=(r=(f||r)&&e.nextSibling)&&t.isCharacterDataNode(r)?new u(r,0):d&&t.isCharacterDataNode(d)?new u(d,d.length):new u(b,t.getNodeIndex(e));e.parentNode.removeChild(e);return b}function f(a,e){var r,f,l=a.offset,b=t.getDocument(a.node),m=b.body.createTextRange(),
d=t.isCharacterDataNode(a.node);d?(r=a.node,f=r.parentNode):(r=a.node.childNodes,r=l<r.length?r[l]:null,f=a.node);b=b.createElement("span");b.innerHTML="&#feff;";r?f.insertBefore(b,r):f.appendChild(b);m.moveToElementText(b);m.collapse(!e);f.removeChild(b);if(d)m[e?"moveStart":"moveEnd"]("character",l);return m}a.requireModules(["DomUtil","DomRange"]);var w,t=a.dom,u=t.DomPosition,e=a.DomRange;if(a.features.implementsDomRange&&(!a.features.implementsTextRange||!a.config.preferTextRange))(function(){function n(a){for(var b=
f.length,e;b--;)e=f[b],a[e]=a.nativeRange[e]}var p,f=e.rangeProperties,o;w=function(a){if(!a)throw Error("Range must be specified");this.nativeRange=a;n(this)};e.createPrototypeRange(w,function(a,b,e,n,m){var p=a.endContainer!==n||a.endOffset!=m;if(a.startContainer!==b||a.startOffset!=e||p)a.setEnd(n,m),a.setStart(b,e)},function(a){a.nativeRange.detach();a.detached=!0;for(var b=f.length,e;b--;)e=f[b],a[e]=null});p=w.prototype;p.selectNode=function(a){this.nativeRange.selectNode(a);n(this)};p.deleteContents=
function(){this.nativeRange.deleteContents();n(this)};p.extractContents=function(){var a=this.nativeRange.extractContents();n(this);return a};p.cloneContents=function(){return this.nativeRange.cloneContents()};p.surroundContents=function(a){this.nativeRange.surroundContents(a);n(this)};p.collapse=function(a){this.nativeRange.collapse(a);n(this)};p.cloneRange=function(){return new w(this.nativeRange.cloneRange())};p.refresh=function(){n(this)};p.toString=function(){return this.nativeRange.toString()};
var l=document.createTextNode("test");t.getBody(document).appendChild(l);var b=document.createRange();b.setStart(l,0);b.setEnd(l,0);try{b.setStart(l,1),p.setStart=function(a,b){this.nativeRange.setStart(a,b);n(this)},p.setEnd=function(a,b){this.nativeRange.setEnd(a,b);n(this)},o=function(a){return function(b){this.nativeRange[a](b);n(this)}}}catch(m){p.setStart=function(a,b){try{this.nativeRange.setStart(a,b)}catch(e){this.nativeRange.setEnd(a,b),this.nativeRange.setStart(a,b)}n(this)},p.setEnd=function(a,
b){try{this.nativeRange.setEnd(a,b)}catch(e){this.nativeRange.setStart(a,b),this.nativeRange.setEnd(a,b)}n(this)},o=function(a,b){return function(e){try{this.nativeRange[a](e)}catch(m){this.nativeRange[b](e),this.nativeRange[a](e)}n(this)}}}p.setStartBefore=o("setStartBefore","setEndBefore");p.setStartAfter=o("setStartAfter","setEndAfter");p.setEndBefore=o("setEndBefore","setStartBefore");p.setEndAfter=o("setEndAfter","setStartAfter");b.selectNodeContents(l);p.selectNodeContents=b.startContainer==
l&&b.endContainer==l&&0==b.startOffset&&b.endOffset==l.length?function(a){this.nativeRange.selectNodeContents(a);n(this)}:function(a){this.setStart(a,0);this.setEnd(a,e.getEndOffset(a))};b.selectNodeContents(l);b.setEnd(l,3);o=document.createRange();o.selectNodeContents(l);o.setEnd(l,4);o.setStart(l,2);p.compareBoundaryPoints=-1==b.compareBoundaryPoints(b.START_TO_END,o)&1==b.compareBoundaryPoints(b.END_TO_START,o)?function(a,b){b=b.nativeRange||b;a==b.START_TO_END?a=b.END_TO_START:a==b.END_TO_START&&
(a=b.START_TO_END);return this.nativeRange.compareBoundaryPoints(a,b)}:function(a,b){return this.nativeRange.compareBoundaryPoints(a,b.nativeRange||b)};a.util.isHostMethod(b,"createContextualFragment")&&(p.createContextualFragment=function(a){return this.nativeRange.createContextualFragment(a)});t.getBody(document).removeChild(l);b.detach();o.detach()})(),a.createNativeRange=function(a){return(a||document).createRange()};else if(a.features.implementsTextRange){w=function(a){this.textRange=a;this.refresh()};
w.prototype=new e(document);w.prototype.refresh=function(){var a,e,f=this.textRange;a=f.parentElement();var o=f.duplicate();o.collapse(!0);e=o.parentElement();o=f.duplicate();o.collapse(!1);f=o.parentElement();e=e==f?e:t.getCommonAncestor(e,f);e=e==a?e:t.getCommonAncestor(a,e);0==this.textRange.compareEndPoints("StartToEnd",this.textRange)?e=a=s(this.textRange,e,!0,!0):(a=s(this.textRange,e,!0,!1),e=s(this.textRange,e,!1,!1));this.setStart(a.node,a.offset);this.setEnd(e.node,e.offset)};e.copyComparisonConstants(w);
var y=function(){return this}();"undefined"==typeof y.Range&&(y.Range=w);a.createNativeRange=function(a){return(a||document).body.createTextRange()}}a.features.implementsTextRange&&(w.rangeToTextRange=function(a){if(a.collapsed)return f(new u(a.startContainer,a.startOffset),!0);var e=f(new u(a.startContainer,a.startOffset),!0),r=f(new u(a.endContainer,a.endOffset),!1),a=t.getDocument(a.startContainer).body.createTextRange();a.setEndPoint("StartToStart",e);a.setEndPoint("EndToEnd",r);return a});w.prototype.getName=
function(){return"WrappedRange"};a.WrappedRange=w;a.createRange=function(e){return new w(a.createNativeRange(e||document))};a.createRangyRange=function(a){return new e(a||document)};a.createIframeRange=function(e){return a.createRange(t.getIframeDocument(e))};a.createIframeRangyRange=function(e){return a.createRangyRange(t.getIframeDocument(e))};a.addCreateMissingNativeApiListener(function(e){e=e.document;if(typeof e.createRange=="undefined")e.createRange=function(){return a.createRange(this)};e=
e=null})});
rangy.createModule("WrappedSelection",function(a,s){function f(a){return(a||window).getSelection()}function w(a){return(a||window).document.selection}function t(a,d,b){var k=b?"end":"start",b=b?"start":"end";a.anchorNode=d[k+"Container"];a.anchorOffset=d[k+"Offset"];a.focusNode=d[b+"Container"];a.focusOffset=d[b+"Offset"]}function u(a){a.anchorNode=a.focusNode=null;a.anchorOffset=a.focusOffset=0;a.rangeCount=0;a.isCollapsed=!0;a._ranges.length=0}function e(z){var b;z instanceof v?(b=z._selectionNativeRange,b||
(b=a.createNativeRange(d.getDocument(z.startContainer)),b.setEnd(z.endContainer,z.endOffset),b.setStart(z.startContainer,z.startOffset),z._selectionNativeRange=b,z.attachListener("detach",function(){this._selectionNativeRange=null}))):z instanceof q?b=z.nativeRange:a.features.implementsDomRange&&z instanceof d.getWindow(z.startContainer).Range&&(b=z);return b}function y(a){var b=a.getNodes(),k;a:if(!b.length||1!=b[0].nodeType)k=!1;else{k=1;for(var e=b.length;k<e;++k)if(!d.isAncestorOf(b[0],b[k])){k=
!1;break a}k=!0}if(!k)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function n(a,d){var b=new q(d);a._ranges=[b];t(a,b,!1);a.rangeCount=1;a.isCollapsed=b.collapsed}function p(b){b._ranges.length=0;if("None"==b.docSelection.type)u(b);else{var k=b.docSelection.createRange();if(k&&"undefined"!=typeof k.text)n(b,k);else{b.rangeCount=k.length;for(var e,H=d.getDocument(k.item(0)),c=0;c<b.rangeCount;++c)e=a.createRange(H),e.selectNode(k.item(c)),
b._ranges.push(e);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;t(b,b._ranges[b.rangeCount-1],!1)}}}function r(a,b){for(var k=a.docSelection.createRange(),e=y(b),c=d.getDocument(k.item(0)),c=d.getBody(c).createControlRange(),g=0,j=k.length;g<j;++g)c.add(k.item(g));try{c.add(e)}catch(x){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}c.select();p(a)}function o(a,d,b){this.nativeSelection=a;this.docSelection=d;this._ranges=
[];this.win=b;this.refresh()}function l(a,b){for(var k=d.getDocument(b[0].startContainer),k=d.getBody(k).createControlRange(),e=0,c;e<rangeCount;++e){c=y(b[e]);try{k.add(c)}catch(g){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}k.select();p(a)}function b(a,b){if(a.anchorNode&&d.getDocument(a.anchorNode)!==d.getDocument(b))throw new A("WRONG_DOCUMENT_ERR");}function m(a){var d=[],b=new D(a.anchorNode,a.anchorOffset),
k=new D(a.focusNode,a.focusOffset),c="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var g=0,j=a.rangeCount;g<j;++g)d[g]=v.inspect(a.getRangeAt(g));return"["+c+"(Ranges: "+d.join(", ")+")(anchor: "+b.inspect()+", focus: "+k.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var d=a.dom,h=a.util,v=a.DomRange,q=a.WrappedRange,A=a.DOMException,D=d.DomPosition,F,E,C=a.util.isHostMethod(window,"getSelection"),
O=a.util.isHostObject(document,"selection"),B=O&&(!C||a.config.preferTextRange);B?(F=w,a.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return"None"!=b.type||d.getDocument(b.createRange().parentElement())==a}):C?(F=f,a.isSelectionValid=function(){return!0}):s.fail("Neither document.selection or window.getSelection() detected.");a.getNativeSelection=F;var C=F(),L=a.createNativeRange(document),J=d.getBody(document),M=h.areHostObjects(C,h.areHostProperties(C,["anchorOffset","focusOffset"]));
a.features.selectionHasAnchorAndFocus=M;var k=h.isHostMethod(C,"extend");a.features.selectionHasExtend=k;var H="number"==typeof C.rangeCount;a.features.selectionHasRangeCount=H;var U=!1,N=!0;h.areHostMethods(C,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof C.rangeCount&&a.features.implementsDomRange&&function(){var a=document.createElement("iframe");a.frameBorder=0;a.style.position="absolute";a.style.left="-10000px";J.appendChild(a);var b=d.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");
b.close();var k=d.getIframeWindow(a).getSelection(),e=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(e,1);b.collapse(true);k.addRange(b);N=k.rangeCount==1;k.removeAllRanges();var c=b.cloneRange();b.setStart(e,0);c.setEnd(e,2);k.addRange(b);k.addRange(c);U=k.rangeCount==2;b.detach();c.detach();J.removeChild(a)}();a.features.selectionSupportsMultipleRanges=U;a.features.collapsedNonEditableSelectionsSupported=N;var G=!1,i;J&&h.isHostMethod(J,"createControlRange")&&(i=J.createControlRange(),
h.areHostProperties(i,["item","add"])&&(G=!0));a.features.implementsControlRange=G;E=M?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:false};var P;h.isHostMethod(C,"getRangeAt")?P=function(a,b){try{return a.getRangeAt(b)}catch(d){return null}}:M&&(P=function(b){var k=d.getDocument(b.anchorNode),k=a.createRange(k);k.setStart(b.anchorNode,b.anchorOffset);k.setEnd(b.focusNode,b.focusOffset);if(k.collapsed!==
this.isCollapsed){k.setStart(b.focusNode,b.focusOffset);k.setEnd(b.anchorNode,b.anchorOffset)}return k});a.getSelection=function(a){var a=a||window,b=a._rangySelection,d=F(a),k=O?w(a):null;if(b){b.nativeSelection=d;b.docSelection=k;b.refresh(a)}else{b=new o(d,k,a);a._rangySelection=b}return b};a.getIframeSelection=function(b){return a.getSelection(d.getIframeWindow(b))};i=o.prototype;if(!B&&M&&h.areHostMethods(C,["removeAllRanges","addRange"])){i.removeAllRanges=function(){this.nativeSelection.removeAllRanges();
u(this)};var I=function(b,d){var k=v.getRangeDocument(d),k=a.createRange(k);k.collapseToPoint(d.endContainer,d.endOffset);b.nativeSelection.addRange(e(k));b.nativeSelection.extend(d.startContainer,d.startOffset);b.refresh()};i.addRange=H?function(b,d){if(G&&O&&this.docSelection.type=="Control")r(this,b);else if(d&&k)I(this,b);else{var H;if(U)H=this.rangeCount;else{this.removeAllRanges();H=0}this.nativeSelection.addRange(e(b));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==H+1){if(a.config.checkSelectionRanges)(H=
P(this.nativeSelection,this.rangeCount-1))&&!v.rangesEqual(H,b)&&(b=new q(H));this._ranges[this.rangeCount-1]=b;t(this,b,Q(this.nativeSelection));this.isCollapsed=E(this)}else this.refresh()}}:function(a,b){if(b&&k)I(this,a);else{this.nativeSelection.addRange(e(a));this.refresh()}};i.setRanges=function(a){if(G&&a.length>1)l(this,a);else{this.removeAllRanges();for(var b=0,d=a.length;b<d;++b)this.addRange(a[b])}}}else if(h.isHostMethod(C,"empty")&&h.isHostMethod(L,"select")&&G&&B)i.removeAllRanges=
function(){try{this.docSelection.empty();if(this.docSelection.type!="None"){var a;if(this.anchorNode)a=d.getDocument(this.anchorNode);else if(this.docSelection.type=="Control"){var b=this.docSelection.createRange();b.length&&(a=d.getDocument(b.item(0)).body.createTextRange())}if(a){a.body.createTextRange().select();this.docSelection.empty()}}}catch(k){}u(this)},i.addRange=function(a){if(this.docSelection.type=="Control")r(this,a);else{q.rangeToTextRange(a).select();this._ranges[0]=a;this.rangeCount=
1;this.isCollapsed=this._ranges[0].collapsed;t(this,a,false)}},i.setRanges=function(a){this.removeAllRanges();var b=a.length;b>1?l(this,a):b&&this.addRange(a[0])};else return s.fail("No means of selecting a Range or TextRange was found"),!1;i.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new A("INDEX_SIZE_ERR");return this._ranges[a]};var R;if(B)R=function(b){var k;if(a.isSelectionValid(b.win))k=b.docSelection.createRange();else{k=d.getBody(b.win.document).createTextRange();k.collapse(true)}b.docSelection.type==
"Control"?p(b):k&&typeof k.text!="undefined"?n(b,k):u(b)};else if(h.isHostMethod(C,"getRangeAt")&&"number"==typeof C.rangeCount)R=function(b){if(G&&O&&b.docSelection.type=="Control")p(b);else{b._ranges.length=b.rangeCount=b.nativeSelection.rangeCount;if(b.rangeCount){for(var d=0,k=b.rangeCount;d<k;++d)b._ranges[d]=new a.WrappedRange(b.nativeSelection.getRangeAt(d));t(b,b._ranges[b.rangeCount-1],Q(b.nativeSelection));b.isCollapsed=E(b)}else u(b)}};else if(M&&"boolean"==typeof C.isCollapsed&&"boolean"==
typeof L.collapsed&&a.features.implementsDomRange)R=function(a){var b;b=a.nativeSelection;if(b.anchorNode){b=P(b,0);a._ranges=[b];a.rangeCount=1;b=a.nativeSelection;a.anchorNode=b.anchorNode;a.anchorOffset=b.anchorOffset;a.focusNode=b.focusNode;a.focusOffset=b.focusOffset;a.isCollapsed=E(a)}else u(a)};else return s.fail("No means of obtaining a Range or TextRange from the user's selection was found"),!1;i.refresh=function(a){var b=a?this._ranges.slice(0):null;R(this);if(a){a=b.length;if(a!=this._ranges.length)return false;
for(;a--;)if(!v.rangesEqual(b[a],this._ranges[a]))return false;return true}};var K=function(a,b){var d=a.getAllRanges(),k=false;a.removeAllRanges();for(var c=0,g=d.length;c<g;++c)k||b!==d[c]?a.addRange(d[c]):k=true;a.rangeCount||u(a)};i.removeRange=G?function(a){if(this.docSelection.type=="Control"){for(var b=this.docSelection.createRange(),a=y(a),k=d.getDocument(b.item(0)),k=d.getBody(k).createControlRange(),e,c=false,g=0,j=b.length;g<j;++g){e=b.item(g);e!==a||c?k.add(b.item(g)):c=true}k.select();
p(this)}else K(this,a)}:function(a){K(this,a)};var Q;!B&&M&&a.features.implementsDomRange?(Q=function(a){var b=false;a.anchorNode&&(b=d.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset)==1);return b},i.isBackwards=function(){return Q(this)}):Q=i.isBackwards=function(){return false};i.toString=function(){for(var a=[],b=0,d=this.rangeCount;b<d;++b)a[b]=""+this._ranges[b];return a.join("")};i.collapse=function(k,e){b(this,k);var H=a.createRange(d.getDocument(k));H.collapseToPoint(k,
e);this.removeAllRanges();this.addRange(H);this.isCollapsed=true};i.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new A("INVALID_STATE_ERR");};i.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new A("INVALID_STATE_ERR");};i.selectAllChildren=function(k){b(this,k);var e=a.createRange(d.getDocument(k));e.selectNodeContents(k);this.removeAllRanges();
this.addRange(e)};i.deleteFromDocument=function(){if(G&&O&&this.docSelection.type=="Control"){for(var a=this.docSelection.createRange(),b;a.length;){b=a.item(0);a.remove(b);b.parentNode.removeChild(b)}this.refresh()}else if(this.rangeCount){a=this.getAllRanges();this.removeAllRanges();b=0;for(var d=a.length;b<d;++b)a[b].deleteContents();this.addRange(a[d-1])}};i.getAllRanges=function(){return this._ranges.slice(0)};i.setSingleRange=function(a){this.setRanges([a])};i.containsNode=function(a,b){for(var d=
0,k=this._ranges.length;d<k;++d)if(this._ranges[d].containsNode(a,b))return true;return false};i.toHtml=function(){var a="";if(this.rangeCount){for(var a=v.getRangeDocument(this._ranges[0]).createElement("div"),b=0,d=this._ranges.length;b<d;++b)a.appendChild(this._ranges[b].cloneContents());a=a.innerHTML}return a};i.getName=function(){return"WrappedSelection"};i.inspect=function(){return m(this)};i.detach=function(){this.win=this.anchorNode=this.focusNode=this.win._rangySelection=null};o.inspect=
m;a.Selection=o;a.selectionPrototype=i;a.addCreateMissingNativeApiListener(function(b){if(typeof b.getSelection=="undefined")b.getSelection=function(){return a.getSelection(this)};b=null})});
rangy.createModule("CssClassApplier",function(a,s){function f(a,b){return a.className&&RegExp("(?:^|\\s)"+b+"(?:\\s|$)").test(a.className)}function w(a,b){a.className?f(a,b)||(a.className+=" "+b):a.className=b}function t(a){return a.split(/\s+/).sort().join(" ")}function u(a,b){return t(a.className)==t(b.className)}function e(a){for(var b=a.parentNode;a.hasChildNodes();)b.insertBefore(a.firstChild,a);b.removeChild(a)}function y(a,b){var d=a.cloneRange();d.selectNodeContents(b);var e=d.intersection(a),
e=e?e.toString():"";d.detach();return""!=e}function n(a){return a.getNodes([3],function(b){return y(a,b)})}function p(a,b){if(a.attributes.length!=b.attributes.length)return!1;for(var d=0,e=a.attributes.length,m,i;d<e;++d)if(m=a.attributes[d],i=m.name,"class"!=i&&(i=b.attributes.getNamedItem(i),m.specified!=i.specified||m.specified&&m.nodeValue!==i.nodeValue))return!1;return!0}function r(a,b){for(var d=0,e=a.attributes.length,m;d<e;++d)if(m=a.attributes[d].name,(!b||!A.arrayContains(b,m))&&a.attributes[d].specified&&
"class"!=m)return!0;return!1}function o(a){var b;return a&&1==a.nodeType&&((b=a.parentNode)&&9==b.nodeType&&"on"==b.designMode||E(a)&&!E(a.parentNode))}function l(a){return(E(a)||1!=a.nodeType&&E(a.parentNode))&&!o(a)}function b(a){return a&&1==a.nodeType&&!C.test(F(a,"display"))}function m(a){if(0==a.data.length)return!0;if(O.test(a.data))return!1;switch(F(a.parentNode,"whiteSpace")){case "pre":case "pre-wrap":case "-moz-pre-wrap":return!1;case "pre-line":if(/[\r\n]/.test(a.data))return!1}return b(a.previousSibling)||
b(a.nextSibling)}function d(a,b,e,m){var h,i=0==e;if(A.isAncestorOf(b,a))return a;if(A.isCharacterDataNode(b))if(0==e)e=A.getNodeIndex(b),b=b.parentNode;else if(e==b.length)e=A.getNodeIndex(b)+1,b=b.parentNode;else throw s.createError("splitNodeAt should not be called with offset in the middle of a data node ("+e+" in "+b.data);if(A.isCharacterDataNode(b)?0==e?b.previousSibling:e==b.length?b.nextSibling:1:0<e&&e<b.childNodes.length){if(!h){h=b.cloneNode(!1);for(h.id&&h.removeAttribute("id");i=b.childNodes[e];)h.appendChild(i);
A.insertAfter(h,b)}return b==a?h:d(a,h.parentNode,A.getNodeIndex(h),m)}return a!=b?(h=b.parentNode,b=A.getNodeIndex(b),i||b++,d(a,h,b,m)):a}function h(a){var b=a?"nextSibling":"previousSibling";return function(d,e){var m=d.parentNode,i=d[b];if(i){if(i&&3==i.nodeType)return i}else if(e&&(i=m[b])&&1==i.nodeType&&m.tagName==i.tagName&&u(m,i)&&p(m,i))return i[a?"firstChild":"lastChild"];return null}}function v(a){this.firstTextNode=(this.isElementMerge=1==a.nodeType)?a.lastChild:a;this.textNodes=[this.firstTextNode]}
function q(a,b,d){this.cssClass=a;var e,m,i=null;if("object"==typeof b&&null!==b){d=b.tagNames;i=b.elementProperties;for(e=0;m=J[e++];)b.hasOwnProperty(m)&&(this[m]=b[m]);e=b.normalize}else e=b;this.normalize="undefined"==typeof e?!0:e;this.attrExceptions=[];e=document.createElement(this.elementTagName);this.elementProperties={};for(var h in i)i.hasOwnProperty(h)&&(M.hasOwnProperty(h)&&(h=M[h]),e[h]=i[h],this.elementProperties[h]=e[h],this.attrExceptions.push(h));this.elementSortedClassName=this.elementProperties.hasOwnProperty("className")?
t(this.elementProperties.className+" "+a):a;this.applyToAnyTagName=!1;a=typeof d;if("string"==a)"*"==d?this.applyToAnyTagName=!0:this.tagNames=d.toLowerCase().replace(/^\s\s*/,"").replace(/\s\s*$/,"").split(/\s*,\s*/);else if("object"==a&&"number"==typeof d.length){this.tagNames=[];e=0;for(a=d.length;e<a;++e)"*"==d[e]?this.applyToAnyTagName=!0:this.tagNames.push(d[e].toLowerCase())}else this.tagNames=[this.elementTagName]}a.requireModules(["WrappedSelection","WrappedRange"]);var A=a.dom,D=function(){function a(b,
d,e){return d&&e?" ":""}return function(b,d){b.className&&(b.className=b.className.replace(RegExp("(?:^|\\s)"+d+"(?:\\s|$)"),a))}}(),F;"undefined"!=typeof window.getComputedStyle?F=function(a,b){return A.getWindow(a).getComputedStyle(a,null)[b]}:"undefined"!=typeof document.documentElement.currentStyle?F=function(a,b){return a.currentStyle[b]}:s.fail("No means of obtaining computed style properties found");var E;(function(){E="boolean"==typeof document.createElement("div").isContentEditable?function(a){return a&&
1==a.nodeType&&a.isContentEditable}:function(a){return!a||1!=a.nodeType||"false"==a.contentEditable?!1:"true"==a.contentEditable||E(a.parentNode)}})();var C=/^inline(-block|-table)?$/i,O=/[^\r\n\t\f \u200B]/,B=h(!1),L=h(!0);v.prototype={doMerge:function(){for(var a=[],b,d,e=0,m=this.textNodes.length;e<m;++e)b=this.textNodes[e],d=b.parentNode,a[e]=b.data,e&&(d.removeChild(b),d.hasChildNodes()||d.parentNode.removeChild(d));return this.firstTextNode.data=a=a.join("")},getLength:function(){for(var a=
this.textNodes.length,b=0;a--;)b+=this.textNodes[a].length;return b},toString:function(){for(var a=[],b=0,d=this.textNodes.length;b<d;++b)a[b]="'"+this.textNodes[b].data+"'";return"[Merge("+a.join(",")+")]"}};var J=["elementTagName","ignoreWhiteSpace","applyToEditableOnly"],M={"class":"className"};q.prototype={elementTagName:"span",elementProperties:{},ignoreWhiteSpace:!0,applyToEditableOnly:!1,hasClass:function(a){return 1==a.nodeType&&A.arrayContains(this.tagNames,a.tagName.toLowerCase())&&f(a,
this.cssClass)},getSelfOrAncestorWithClass:function(a){for(;a;){if(this.hasClass(a,this.cssClass))return a;a=a.parentNode}return null},isModifiable:function(a){return!this.applyToEditableOnly||l(a)},isIgnorableWhiteSpaceNode:function(a){return this.ignoreWhiteSpace&&a&&3==a.nodeType&&m(a)},postApply:function(a,b,d){for(var e=a[0],m=a[a.length-1],i=[],h,n=e,f=m,q=0,l=m.length,p,r,o=0,u=a.length;o<u;++o)if(p=a[o],r=B(p,!d)){if(h||(h=new v(r),i.push(h)),h.textNodes.push(p),p===e&&(n=h.firstTextNode,
q=n.length),p===m)f=h.firstTextNode,l=h.getLength()}else h=null;if(a=L(m,!d))h||(h=new v(m),i.push(h)),h.textNodes.push(a);if(i.length){o=0;for(u=i.length;o<u;++o)i[o].doMerge();b.setStart(n,q);b.setEnd(f,l)}},createContainer:function(b){b=b.createElement(this.elementTagName);a.util.extend(b,this.elementProperties);w(b,this.cssClass);return b},applyToTextNode:function(a){var b=a.parentNode;1==b.childNodes.length&&A.arrayContains(this.tagNames,b.tagName.toLowerCase())?w(b,this.cssClass):(b=this.createContainer(A.getDocument(a)),
a.parentNode.insertBefore(b,a),b.appendChild(a))},isRemovable:function(a){var b;if(b=a.tagName.toLowerCase()==this.elementTagName)if(b=t(a.className)==this.elementSortedClassName){var d;a:{b=this.elementProperties;for(d in b)if(b.hasOwnProperty(d)&&a[d]!==b[d]){d=!1;break a}d=!0}b=d&&!r(a,this.attrExceptions)&&this.isModifiable(a)}return b},undoToTextNode:function(a,b,m){b.containsNode(m)||(a=b.cloneRange(),a.selectNode(m),a.isPointInRange(b.endContainer,b.endOffset)&&(d(m,b.endContainer,b.endOffset,
[b]),b.setEndAfter(m)),a.isPointInRange(b.startContainer,b.startOffset)&&(m=d(m,b.startContainer,b.startOffset,[b])));this.isRemovable(m)?e(m):D(m,this.cssClass)},applyToRange:function(a){a.splitBoundaries();var b=n(a);if(b.length){for(var d,e=0,m=b.length;e<m;++e)d=b[e],!this.isIgnorableWhiteSpaceNode(d)&&!this.getSelfOrAncestorWithClass(d)&&this.isModifiable(d)&&this.applyToTextNode(d);a.setStart(b[0],0);d=b[b.length-1];a.setEnd(d,d.length);this.normalize&&this.postApply(b,a,!1)}},applyToSelection:function(b){var b=
a.getSelection(b||window),d,e=b.getAllRanges();b.removeAllRanges();for(var m=e.length;m--;)d=e[m],this.applyToRange(d),b.addRange(d)},undoToRange:function(a){a.splitBoundaries();var b=n(a),d,e,m=b[b.length-1];if(b.length){for(var h=0,f=b.length;h<f;++h)d=b[h],(e=this.getSelfOrAncestorWithClass(d))&&this.isModifiable(d)&&this.undoToTextNode(d,a,e),a.setStart(b[0],0),a.setEnd(m,m.length);this.normalize&&this.postApply(b,a,!0)}},undoToSelection:function(b){var b=a.getSelection(b||window),d=b.getAllRanges(),
e;b.removeAllRanges();for(var m=0,h=d.length;m<h;++m)e=d[m],this.undoToRange(e),b.addRange(e)},getTextSelectedByRange:function(a,b){var d=b.cloneRange();d.selectNodeContents(a);var e=d.intersection(b),e=e?e.toString():"";d.detach();return e},isAppliedToRange:function(a){if(a.collapsed)return!!this.getSelfOrAncestorWithClass(a.commonAncestorContainer);for(var b=a.getNodes([3]),d=0,e;e=b[d++];)if(!this.isIgnorableWhiteSpaceNode(e)&&y(a,e)&&this.isModifiable(e)&&!this.getSelfOrAncestorWithClass(e))return!1;
return!0},isAppliedToSelection:function(b){for(var b=a.getSelection(b||window).getAllRanges(),d=b.length;d--;)if(!this.isAppliedToRange(b[d]))return!1;return!0},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)},toggleSelection:function(a){this.isAppliedToSelection(a)?this.undoToSelection(a):this.applyToSelection(a)},detach:function(){}};q.util={hasClass:f,addClass:w,removeClass:D,hasSameClasses:u,replaceWithOwnChildren:e,elementsHaveSameNonClassAttributes:p,
elementHasNonClassAttributes:r,splitNodeAt:d,isEditableElement:E,isEditingHost:o,isEditable:l};a.CssClassApplier=q;a.createCssClassApplier=function(a,b,d){return new q(a,b,d)}});
rangy.createModule("SaveRestore",function(a,s){function f(a,f){var r="selectionBoundary_"+ +new Date+"_"+(""+Math.random()).slice(2),o,l=e.getDocument(a.startContainer),b=a.cloneRange();b.collapse(f);o=l.createElement("span");o.id=r;o.style.lineHeight="0";o.style.display="none";o.className="rangySelectionBoundary";o.appendChild(l.createTextNode(y));b.insertNode(o);b.detach();return o}function w(a,e,f,o){(a=(a||document).getElementById(f))?(e[o?"setStartBefore":"setEndBefore"](a),a.parentNode.removeChild(a)):
s.warn("Marker element has been removed. Cannot restore selection.")}function t(a,e){return e.compareBoundaryPoints(a.START_TO_START,a)}function u(a,e){var f=(a||document).getElementById(e);f&&f.parentNode.removeChild(f)}a.requireModules(["DomUtil","DomRange","WrappedRange"]);var e=a.dom,y="\ufeff";a.saveSelection=function(e){var e=e||window,p=e.document;if(a.isSelectionValid(e)){var r=a.getSelection(e),o=r.getAllRanges(),l=[],b,m;o.sort(t);for(var d=0,h=o.length;d<h;++d)b=o[d],b.collapsed?(m=f(b,
!1),l.push({markerId:m.id,collapsed:!0})):(m=f(b,!1),b=f(b,!0),l[d]={startMarkerId:b.id,endMarkerId:m.id,collapsed:!1,backwards:1==o.length&&r.isBackwards()});for(d=h-1;0<=d;--d)b=o[d],b.collapsed?b.collapseBefore((p||document).getElementById(l[d].markerId)):(b.setEndBefore((p||document).getElementById(l[d].endMarkerId)),b.setStartAfter((p||document).getElementById(l[d].startMarkerId)));r.setRanges(o);return{win:e,doc:p,rangeInfos:l,restored:!1}}s.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
a.restoreSelection=function(e,f){if(!e.restored){for(var r=e.rangeInfos,o=a.getSelection(e.win),l=[],b=r.length,m=b-1,d,h;0<=m;--m){d=r[m];h=a.createRange(e.doc);if(d.collapsed)if(d=(e.doc||document).getElementById(d.markerId)){d.style.display="inline";var v=d.previousSibling;v&&3==v.nodeType?(d.parentNode.removeChild(d),h.collapseToPoint(v,v.length)):(h.collapseBefore(d),d.parentNode.removeChild(d))}else s.warn("Marker element has been removed. Cannot restore selection.");else w(e.doc,h,d.startMarkerId,
!0),w(e.doc,h,d.endMarkerId,!1);1==b&&h.normalizeBoundaries();l[m]=h}1==b&&f&&a.features.selectionHasExtend&&r[0].backwards?(o.removeAllRanges(),o.addRange(l[0],!0)):o.setRanges(l);e.restored=!0}};a.removeMarkerElement=u;a.removeMarkers=function(a){for(var e=a.rangeInfos,f=0,o=e.length,l;f<o;++f)l=e[f],l.collapsed?u(a.doc,l.markerId):(u(a.doc,l.startMarkerId),u(a.doc,l.endMarkerId))}});
rangy.createModule("Serializer",function(a,s){function f(a,e){var e=e||[],d=a.nodeType,h=a.childNodes,v=h.length,q=[d,a.nodeName,v].join(":"),l="",n="";switch(d){case 3:l=a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;");break;case 8:l="<\!--"+a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;")+"--\>";break;default:l="<"+q+">",n="</>"}l&&e.push(l);for(d=0;d<v;++d)f(h[d],e);n&&e.push(n);return e}function w(a){a=f(a).join("");return o(a).toString(16)}function t(a,e,d){for(var h=[],f=a,d=d||l.getDocument(a).documentElement;f&&
f!=d;)h.push(l.getNodeIndex(f,!0)),f=f.parentNode;return h.join("/")+":"+e}function u(a,e,d){e?d||l.getDocument(e):e=(d||document).documentElement;for(var a=a.split(":"),d=a[0]?a[0].split("/"):[],h=d.length,f;h--;)if(f=parseInt(d[h],10),f<e.childNodes.length)e=e.childNodes[parseInt(d[h],10)];else throw s.createError("deserializePosition failed: node "+l.inspectNode(e)+" has no child with index "+f+", "+h);return new l.DomPosition(e,parseInt(a[1],10))}function e(b,e,d){d=d||a.DomRange.getRangeDocument(b).documentElement;
if(!l.isAncestorOf(d,b.commonAncestorContainer,!0))throw Error("serializeRange: range is not wholly contained within specified root node");b=t(b.startContainer,b.startOffset,d)+","+t(b.endContainer,b.endOffset,d);e||(b+="{"+w(d)+"}");return b}function y(b,e,d){e?d=d||l.getDocument(e):(d=d||document,e=d.documentElement);var b=/^([^,]+),([^,\{]+)({([^}]+)})?$/.exec(b),h=b[4],f=w(e);if(h&&h!==w(e))throw Error("deserializeRange: checksums of serialized range root node ("+h+") and target root node ("+
f+") do not match");h=u(b[1],e,d);e=u(b[2],e,d);d=a.createRange(d);d.setStart(h.node,h.offset);d.setEnd(e.node,e.offset);return d}function n(a,e,d){e?d||l.getDocument(e):e=(d||document).documentElement;a=/^([^,]+),([^,]+)({([^}]+)})?$/.exec(a)[3];return!a||a===w(e)}function p(b,m,d){for(var b=b||a.getSelection(),b=b.getAllRanges(),h=[],f=0,l=b.length;f<l;++f)h[f]=e(b[f],m,d);return h.join("|")}function r(b,e,d){e?d=d||l.getWindow(e):(d=d||window,e=d.document.documentElement);for(var b=b.split("|"),
h=a.getSelection(d),f=[],q=0,n=b.length;q<n;++q)f[q]=y(b[q],e,d.document);h.setRanges(f);return h}a.requireModules(["WrappedSelection","WrappedRange"]);("undefined"==typeof encodeURIComponent||"undefined"==typeof decodeURIComponent)&&s.fail("Global object is missing encodeURIComponent and/or decodeURIComponent method");var o=function(){var a=null;return function(e){for(var d=[],h=0,f=e.length,l;h<f;++h)l=e.charCodeAt(h),128>l?d.push(l):2048>l?d.push(l>>6|192,l&63|128):d.push(l>>12|224,l>>6&63|128,
l&63|128);e=-1;if(!a){for(var h=[],f=0,n;256>f;++f){n=f;for(l=8;l--;)n=1==(n&1)?n>>>1^3988292384:n>>>1;h[f]=n>>>0}a=h}h=a;f=0;for(l=d.length;f<l;++f)n=(e^d[f])&255,e=e>>>8^h[n];return(e^-1)>>>0}}(),l=a.dom;a.serializePosition=t;a.deserializePosition=u;a.serializeRange=e;a.deserializeRange=y;a.canDeserializeRange=n;a.serializeSelection=p;a.deserializeSelection=r;a.canDeserializeSelection=function(a,e,d){var h;e?h=d?d.document:l.getDocument(e):e=(d||window).document.documentElement;for(var a=a.split("|"),
d=0,f=a.length;d<f;++d)if(!n(a[d],e,h))return!1;return!0};a.restoreSelectionFromCookie=function(a){var a=a||window,e;a:{e=a.document.cookie.split(/[;,]/);for(var d=0,h=e.length,f;d<h;++d)if(f=e[d].split("="),"rangySerializedSelection"==f[0].replace(/^\s+/,"")&&(f=f[1])){e=decodeURIComponent(f.replace(/\s+$/,""));break a}e=null}e&&r(e,a.doc)};a.saveSelectionCookie=function(b,e){var b=b||window,e="object"==typeof e?e:{},d=e.expires?";expires="+e.expires.toUTCString():"",f=e.path?";path="+e.path:"",
l=e.domain?";domain="+e.domain:"",n=e.secure?";secure":"",o=p(a.getSelection(b));b.document.cookie=encodeURIComponent("rangySerializedSelection")+"="+encodeURIComponent(o)+d+f+l+n};a.getElementChecksum=w});
(function(a){function s(f){if("string"===typeof f.data){var s=f.handler,t=f.data.toLowerCase().split(" ");f.handler=function(f){if(!(this!==f.target&&(/textarea|select/i.test(f.target.nodeName)||"text"===f.target.type))){var e="keypress"!==f.type&&a.hotkeys.specialKeys[f.which],y=String.fromCharCode(f.which).toLowerCase(),n="",p={};f.altKey&&"alt"!==e&&(n+="alt+");f.ctrlKey&&"ctrl"!==e&&(n+="ctrl+");f.metaKey&&!f.ctrlKey&&"meta"!==e&&(n+="meta+");f.shiftKey&&"shift"!==e&&(n+="shift+");e?p[n+e]=!0:
(p[n+y]=!0,p[n+a.hotkeys.shiftNums[y]]=!0,"shift+"===n&&(p[a.hotkeys.shiftNums[y]]=!0));e=0;for(y=t.length;e<y;e++)if(p[t[e]])return s.apply(this,arguments)}}}}a.hotkeys={version:"0.8",specialKeys:{8:"backspace",9:"tab",13:"return",16:"shift",17:"ctrl",18:"alt",19:"pause",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"insert",46:"del",96:"0",97:"1",98:"2",99:"3",100:"4",101:"5",102:"6",103:"7",104:"8",105:"9",106:"*",107:"+",
109:"-",110:".",111:"/",112:"f1",113:"f2",114:"f3",115:"f4",116:"f5",117:"f6",118:"f7",119:"f8",120:"f9",121:"f10",122:"f11",123:"f12",144:"numlock",145:"scroll",191:"/",224:"meta"},shiftNums:{"`":"~",1:"!",2:"@",3:"#",4:"$",5:"%",6:"^",7:"&",8:"*",9:"(","0":")","-":"_","=":"+",";":": ","'":'"',",":"<",".":">","/":"?","\\":"|"}};a.each(["keydown","keyup","keypress"],function(){a.event.special[this]={add:s}})})(jQuery);
(function(a,s,f,w){function t(a,g,j){Q[a]=j;z[a]=g;K||(K=a)}function u(c){K!==c&&(K=c,a.ui.editor.eachInstance(function(){this.reinit()}))}function e(a,g){K&&Q[K]&&Q[K][a]&&(a=Q[K][a]);if(!g)return a;for(var j in g)a=a.replace("{{"+j+"}}",g[j]);return a}function y(c){if(T===w){T=!0;if(W=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(c.options.baseClass+"-ios"),W&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height",
"-=1")},0)});a.browser.mozilla&&a("html").addClass(c.options.baseClass+"-ff");if(a.browser.msie&&9>a.browser.version){T=!1;var g=a("<div/>").addClass(c.options.baseClass+"-unsupported").html(c.getTemplate("unsupported")).appendTo("body");n(g);g.find("."+c.options.baseClass+"-unsupported-close").click(function(){g.remove()})}}return T}function n(c){var g=1;c.siblings().each(function(){var c=a(this).css("z-index");!isNaN(c)&&c>g&&(g=c+1)});c.css("z-index",g)}function p(a){return a.clone().wrap("<div/>").parent().html()}
function r(a){var g,a=document.createElement(a);g="getComputedStyle"in s;document.body.appendChild(a);g=(g?s.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return g}function o(c,g){return-1!==a.inArray(a(c)[0].tagName.toLowerCase(),g)}function l(a){for(var g={},a=s.getComputedStyle(a[0],null),j=0;j<a.length;j++)g[a.item(j)]=a.getPropertyValue(a.item(j));return g}function b(c,g){for(var j="",b=0,d=c.childNodes.length;b<d;b++){var e=c.childNodes.item(b);(e=3===e.nodeType?
e.nodeValue:p(a(e)))&&(j+=e)}g&&(j=a("<"+g+">"+j+"</"+g+">"),j.find("p").wrapInner("<"+g+"/>"),j.find("p > *").unwrap(),j=a("<div/>").html(j).html());return j}function m(c,g){var j=a("<div/>").append(c)[0].childNodes;g.deleteContents();j.length===w||1===j.length?g.insertNode(j[0].cloneNode(!0)):a.each(j,function(a,c){g.insertNodeAtEnd(c.cloneNode(!0))})}function d(c){var c=c||f.getSelection(),g;a(c.getAllRanges()).each(function(c,b){g=3===this.commonAncestorContainer.nodeType?a(b.commonAncestorContainer).parent()[0]:
b.commonAncestorContainer});return g}function h(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer}function v(a){if(!S||a)S=f.saveSelection()}function q(){S&&(f.restoreSelection(S),S=!1)}function A(){S&&f.removeMarkers(S);S=!1}function D(a,g,j){for(var g=g||f.getSelection(),b,d=0;b=g.getAllRanges()[d++];)a.call(j,b)}function F(a,g){D(function(g){m(a,g)},g,this)}function E(c,g){g=g||f.getSelection();g.removeAllRanges();a(c).focus().contents().each(function(){var a=f.createRange();
a.selectNodeContents(this);g.addRange(a)})}function C(c,g){g=g||f.getSelection();g.removeAllRanges();a(c).each(function(){var a=f.createRange();a.selectNode(this);g.addRange(a)}).focus()}function O(c,g,j){g=g||f.getSelection();g.removeAllRanges();a(c).each(function(){var a=f.createRange();a.selectNodeContents(this);a.collapse(j);g.addRange(a)})}function B(a,g){O(a,g,!1)}function L(a,g){O(a,g,!0)}function J(a){a=a||f.getSelection();return a.toHtml()}function M(c){c=c||f.getSelection().getRangeAt(0);
return a(3===c.commonAncestorContainer.nodeType?c.commonAncestorContainer.parentNode:c.commonAncestorContainer)}function k(a){var g=new jQuery;D(function(a){g.push(M(a)[0])},a,this);return g}function H(){var c=f.getSelection();if(null===c.anchorNode)return null;if(c.isBackwards())return 3===c.focusNode.nodeType?a(c.focusNode.parentElement):a(c.focusNode);c.anchorNode||console.trace();return 3===c.anchorNode.nodeType?a(c.anchorNode.parentElement):a(c.anchorNode)}function U(){var c=f.getSelection();
return null===c.anchorNode?null:c.isBackwards()?3===c.anchorNode.nodeType?a(c.anchorNode.parentElement):a(c.anchorNode):3===c.focusNode.nodeType?a(c.focusNode.parentElement):a(c.focusNode)}function N(c,g){var g=g||{},j=f.createCssClassApplier(g.classes||"",{normalize:!0,elementTagName:c,elementProperties:g.attributes||{}});D(function(d){var e=d.cloneContents(),e=b(e);"string"===typeof e&&(e=e.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));a(e).is(":empty")?(e=a("<"+c+"/>").addClass(g.classes).attr(g.attributes||
{}).append(b(d.cloneContents())),m(e,d)):j.toggleRange(d)},null,this)}function G(a,g,j){D(function(b){b=M(b);b.is(a)?b.attr(g):N(a,{classes:j,attributes:g})},null,this)}function i(c,g){var g=g||f.getSelection(),j=g.getRangeAt(0),d=k()[0],e=f.createRange();e.setStartBefore(d);e.setEnd(j.startContainer,j.startOffset);var e=e.cloneContents(),h=f.createRange();h.setStart(j.endContainer,j.endOffset);h.setEndAfter(d);j=h.cloneContents();e=p(a(b(e)));e+=p(a(c));e+=p(a(b(j)));a(d).replaceWith(a(e))}function P(a,
g,b){var b=b||f.getSelection(),d=H()[0],e=U()[0],h=k()[0],h=o(h,g),d=o(d,g),g=o(e,g);h&&d&&g?F(a):i(a,b)}function I(c,g){D(function(b){for(b=a(b.commonAncestorContainer);b.length&&b[0]!==g[0]&&(3===b[0].nodeType||"inline"===b.css("display"));)b=b.parent();b[0]===g[0]&&"inline"!==g.css("display")&&(this.wrapInner(g,"div"),b=g.children().first());this.toggleStyle(b,c)},null,this)}function R(a,g){allowed=[];for(var b=0;b<g.length;b++)g[b].match(/[a-z][a-z0-9]{0,}/g)&&allowed.push(g[b]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,
"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,c){return-1<allowed.indexOf(c.toLowerCase())?a:""})}var K=null,Q={},z={};a(function(){f.initialized||f.init();a.isFunction(f.rangePrototype.insertNodeAtEnd)||(f.rangePrototype.insertNodeAtEnd=function(a){var g=this.cloneRange();g.collapse(!1);g.insertNode(a);g.detach();this.setEndAfter(a)})});a("html").click(function(){a(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});a.widget("ui.editor",{_init:function(){-1===
...
for(var g in this.options.bind)this.bind(g,this.options.bind[g]);this.history=[];this.present=0;this.historyEnabled=!0;y(this)&&(this.cloneDomTools(),this.setOriginalHtml(this.element.is(":input")?this.element.val():this.element.html()),this.element.is("textarea, input")&&this.replaceOriginal(),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,this.ready=!0,this.fire("ready"),this.options.autoEnable&&a(function(){c.enableEditing();c.showToolbar()}))},
attach:function(){this.bind("change",this.historyPush);this.bind("selectionChange",this.updateTagTree);this.bind("show",this.updateTagTree);var c=a.proxy(this.checkChange,this);this.getElement().find("img").bind("click."+this.widgetName,a.proxy(function(a){C(a.target)},this));this.getElement().bind("mouseup."+this.widgetName,c);this.getElement().bind("keyup."+this.widgetName,c);a(s).bind("beforeunload",a.proxy(a.ui.editor.unloadWarning,a.ui.editor));var g=this;a(s).resize(function(){g.fire("resize")})},
reinit:function(){if(this.ready){var a=this.enabled,g=this.visible;this.destruct(!0);this._init();a&&this.enableEditing();g&&this.showToolbar()}else{var b;b=function(){this.unbind("ready",b);this.reinit()};this.bind("ready",b)}},getElement:function(){return this.target?this.target:this.element},getOriginalElement:function(){return this.element},replaceOriginal:function(){if(!this.target){for(var c=a("<div/>").html(this.element.is(":input")?this.element.val():this.element.html()).insertBefore(this.element).attr("id",
this.getUniqueId()).addClass(this.element.attr("class")),g=l(this.element),b=0;b<this.options.replaceStyle.length;b++)c.css(this.options.replaceStyle[b],g[this.options.replaceStyle[b]]);this.element.hide();this.bind("change",function(){this.element.is("input, textarea")?this.element.val(this.getHtml()):this.element.html(this.getHtml())});this.target=c}},cloneDomTools:function(){for(var a in this.options.domTools)this[a]||(this[a]=function(a){return function(){this.options.domTools.constrainSelection(this.getElement());
var c=this.getHtml(),b=this.options.domTools[a].apply(this.options.domTools,arguments);c!==this.getHtml()&&this.change();return b}}(a))},checkChange:function(){var a=f.serializeSelection();this.previousSelection!==a&&this.fire("selectionChange");this.previousSelection=a;var a=this.getCleanHtml(),g=this.dirty;this.dirty=this.getOriginalHtml()!==a;this.previousHtml!==a&&(this.previousHtml=a,this.change(),g!==this.dirty&&(this.dirty?this.fire("dirty"):this.fire("cleaned")))},change:function(){this.fire("change")},
...
"-editing"),this.options.partialEdit?this.getElement().find(this.options.partialEdit).attr("contenteditable",!0):this.getElement().attr("contenteditable",!0),this.execCommand("enableInlineTableEditing",!1,!1),this.execCommand("styleWithCSS",!0,!0),this.bindHotkeys(),this.fire("enabled"),this.fire("resize"))},disableEditing:function(){this.enabled&&(this.enabled=!1,this.getElement().attr("contenteditable",!1).removeClass(this.options.baseClass+"-editing"),f.getSelection().removeAllRanges(),this.fire("disabled"))},
isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var c=this,g="",b=[],d=0;D(function(e){var e=e.commonAncestorContainer,f;f=3===e.nodeType?a(e).parent():a(e);e=[];for(b.push(e);f[0]&&!c.isRoot(f)&&"body"!==f[0].tagName.toLowerCase();)e.push(f),f=f.parent();e.reverse();g&&(g+=" | ");g+=this.getTemplate("root");for(f=0;f<e.length;f++)g+=this.getTemplate("tag",{element:e[f][0].tagName.toLowerCase(),data:"["+d+","+f+"]"});d++},null,this);g||(g=this.getTemplate("root"));
this.path.html(g).find("a").click(function(){var g=a(this).data("ui-editor-selection");g?(C(b[g[0]][g[1]]),c.updateTagTree()):C(c.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(c){return this.getElement()[0]===a(c)[0]},unify:function(c,g){!1!==g&&c(this);if(this.options.unify){var b=this;a.ui.editor.eachInstance(function(a){a!==b&&a.options.unify&&c(a)})}},getUniqueId:function(){return a.ui.editor.getUniqueId()},loadMessages:function(){this.messages=a(this.getTemplate("messages")).appendTo(this.wrapper)},
showMessage:function(c,g,b){var b=a.extend({},this.options.message,b),e;e={timer:null,editor:this,show:function(){this.element.slideDown();this.timer=s.setTimeout(function(){this.timer=null;e.hide()},b.delay,this)},hide:function(){this.timer&&(s.clearTimeout(this.timer),this.timer=null);this.element.stop().slideUp(a.proxy(function(){a.isFunction(b.hide)&&b.hide.call(this);this.element.remove()},this))}};e.element=a(this.getTemplate("message",{type:c,message:g})).hide().appendTo(this.messages).find(".ui-editor-message-close").click(function(){e.hide()}).end();
e.show();return e},showLoading:function(a,g){return this.showMessage("clock",a,g)},showInfo:function(a,g){return this.showMessage("info",a,g)},showError:function(a,g){return this.showMessage("circle-close",a,g)},showConfirm:function(a,g){return this.showMessage("circle-check",a,g)},showWarning:function(a,g){return this.showMessage("alert",a,g)},loadToolbar:function(){var c=this.toolbar=a("<div/>").addClass(this.options.baseClass+"-toolbar"),c=this.toolbarWrapper=a("<div/>").addClass(this.options.baseClass+
"-toolbar-wrapper").addClass("ui-widget-content").append(c),g=this.path=a("<div/>").addClass(this.options.baseClass+"-path").addClass("ui-widget-header").html(this.getTemplate("root")),b=this.wrapper=a("<div/>").addClass(this.options.baseClass+"-wrapper").css("display","none").append(g).append(c);a.fn.draggable&&this.options.draggable&&(b.draggable({cancel:"a, button",cursor:"move",handle:".ui-editor-path",stop:a.proxy(function(){var a=this.persist("position",[b.css("top"),b.css("left")]);b.css({top:Math.abs(a[0]),
left:Math.abs(a[1])})},this)}),b.css("position",""),(c=this.persist("position")||this.options.dialogPosition)||(c=[10,10]),parseInt(c[0],10)+b.outerHeight()>a(s).height()&&(c[0]=a(s).height()-b.outerHeight()),parseInt(c[1],10)+b.outerWidth()>a(s).width()&&(c[1]=a(s).width()-b.outerWidth()),b.css({top:Math.abs(parseInt(c[0],10)),left:Math.abs(parseInt(c[1],10))}),this.loadMessages());a(function(){b.appendTo("body")});this.loadUi()},isToolbarLoaded:function(){return null!==this.wrapper},showToolbar:function(c){this.isToolbarLoaded()||
this.loadToolbar();if(!this.visible){this.options.unify&&this.hideOtherToolbars(!0);this.visible=!0;this.wrapper.css("display","");this.fire("resize");"undefined"===typeof this.getElement().attr("tabindex")&&this.getElement().attr("tabindex",-1);if(c)if(c.select)c.select();else{var g=s.getSelection();g.removeAllRanges();g.addRange(c)}var b=this;a(function(){b.fire("show");b.element.is("textarea, input")||b.getElement().focus()})}},hideToolbar:function(){this.visible&&(this.visible=!1,this.wrapper.hide(),
this.element.is("textarea, input")&&this.element.show(),this.fire("hide"),this.fire("resize"))},hideOtherToolbars:function(){this.unify(function(a){a.hideToolbar()},!1)},isVisible:function(){return this.visible},getTemplate:function(c,g){var b;b=this.templates[c]?this.templates[c]:a.ui.editor.getTemplate(c,this.options.urlPrefix);b=b.replace(/_\(['"]{1}(.*?)['"]{1}\)/g,function(a,c){c=c.replace(/\\(.?)/g,function(a,c){switch(c){case "\\":return"\\";case "0":return"\x00";case "":return"";default:return c}});
return e(c)});g=a.extend({},this.options,g||{});g=this.getTemplateVars(g);return b=b.replace(/\{\{(.*?)\}\}/g,function(a,c){return g[c]})},getTemplateVars:function(a,g,b){g=g?g+".":"";b||(b=1);var e={},d;for(d in a)if("object"===typeof a[d]&&5>b){var f=this.getTemplateVars(a[d],g+d,++b),h;for(h in f)e[h]=f[h]}else e[g+d]=a[d];return e},historyPush:function(){this.historyEnabled&&this.getHtml()!==this.historyPeak()&&(this.present!==this.history.length-1&&(this.history=this.history.splice(0,this.present+
1)),this.history.push(this.getHtml()),this.present=this.history.length-1)},historyPeak:function(){return!this.history.length?null:this.history[this.present]},historyBack:function(){0<this.present&&(this.present--,this.setHtml(this.history[this.present]),this.historyEnabled=!1,this.change(),this.historyEnabled=!0)},historyForward:function(){this.present<this.history.length-1&&(this.present++,this.setHtml(this.history[this.present]),this.historyEnabled=!1,this.change(),this.historyEnabled=!0)},registerHotkey:function(c,
g,b){if("string"===typeof c)this.hotkeys[c]=a.extend({},{context:b,restoreSelection:!0},g);else for(var e in c)this.registerHotkey(e,c[e],b)},bindHotkeys:function(){for(var a in this.hotkeys){var g=this,b=this.hotkeys[a].force||!1;(this.options.enableHotkeys||b)&&this.getElement().bind("keydown."+this.widgetName,a,function(a){v();var c=g.hotkeys[a.data];!0!==c.action.call(c.context)&&a.preventDefault();c.restoreSelection&&q();g.checkChange()})}},uiEnabled:function(c){return!1===this.options.enableUi&&
"undefined"===typeof this.options.ui[c]||!1===this.options.ui[c]||-1!==a.inArray(c,this.options.disabledUi)?!1:!0},getUi:function(a){return this.uiObjects[a]},loadUi:function(){for(var c=0,g=this.options.uiOrder.length;c<g;c++){for(var b=this.options.uiOrder[c],e=a("<div/>"),d=0,f=b.length;d<f;d++)if(this.uiEnabled(b[d])){var h=b[d].replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});if(a.ui.editor.ui[b[d]]){var i=a.extend({},a.ui.editor.ui[b[d]]),h=a.extend(!0,{},this.options,{baseClass:this.options.baseClass+
"-ui-"+h},i.options,this.options.ui[b[d]]);i.editor=this;i.options=h;i.ui=i.init(this,h);i.hotkeys&&(this.registerHotkey(i.hotkeys,null,i),i.ui.title+=" ("+a.map(i.hotkeys,function(a,c){return c})[0]+")");i.ui.init(b[d],this,h,i).appendTo(e);this.uiObjects[b[d]]=i}}e.addClass("ui-buttonset").addClass(this.options.baseClass+"-buttonset");0<e.children().length&&e.appendTo(this.toolbar)}a("<div/>").css("clear","both").appendTo(this.toolbar)},uiButton:function(c){return a.extend({button:null,options:{},
init:function(c,b,d,f){var h=c.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),d=a.extend({},b.options,{baseClass:b.options.baseClass+"-"+h+"-button"},this.options,b.options.ui[c]);this.title||(this.title=e("Unnamed Button"));this.button=a("<div/>").html(this.label||this.title).addClass(d.baseClass).attr("name",c).attr("title",this.title).val(c);d.classes&&this.button.addClass(d.classes);this.button.bind("mousedown."+f.editor.widgetName,function(a){a.preventDefault()});var i=this;this.button.bind("mouseup."+
f.editor.widgetName,function(a){a.preventDefault();i.click.apply(f,arguments);b.checkChange()});b.bind("destroy",a.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+h},disabled:d.disabled?!0:!1,text:this.text||!1,label:this.label||null});this.ready.call(f);return this.button},disable:function(){this.button.button("option","disabled",!0)},enable:function(){this.button.button("option","disabled",!1)},ready:function(){},click:function(){}},
c)},uiSelectMenu:function(c){return a.extend({select:null,selectMenu:null,button:null,menu:null,options:{},init:function(c,b){var d=this;d.select.attr("disabled","disabled");var f=c.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});a.extend({},b.options,{baseClass:b.options.baseClass+f+"-select-menu"},d.options,b.options.ui[c]);d.title||(d.title=e("Unnamed Select Menu"));d.wrapper=a('<div class="ui-editor-selectmenu-wrapper"/>').append(d.select.hide()).addClass(d.select.attr("class"));d.selectMenu=
a('<div class="ui-editor-selectmenu"/>').appendTo(d.wrapper);d.menu=a('<div class="ui-editor-selectmenu-menu ui-widget-content ui-corner-bottom ui-corner-tr"/>').appendTo(d.wrapper);d.select.find("option, .ui-editor-selectmenu-option").each(function(){a("<div/>").addClass("ui-editor-selectmenu-menu-item").addClass("ui-corner-all").html(a(this).html()).appendTo(d.menu).bind("mouseenter."+b.widgetName,function(){a(this).addClass("ui-state-focus")}).bind("mouseleave."+b.widgetName,function(){a(this).removeClass("ui-state-focus")}).bind("mousedown."+
b.widgetName,function(){return false}).bind("click."+b.widgetName,function(){var c=d.select.find("option, .ui-editor-selectmenu-option").eq(a(this).index()),c=c.attr("value")||c.val();d.select.val(c);d.update();d.wrapper.removeClass("ui-editor-selectmenu-visible");d.button.addClass("ui-corner-all").removeClass("ui-corner-top");d.change(c);return false})});var f=a("<div/>").addClass("ui-editor-selectmenu-text"),h=a("<div/>").addClass("ui-icon ui-icon-triangle-1-s");d.button=a("<div/>").addClass("ui-editor-selectmenu-button ui-editor-selectmenu-button ui-button ui-state-default").attr("title",
d.title).append(f).append(h).prependTo(d.selectMenu);d.button.bind("mousedown."+b.widgetName,function(){return false}).bind("click."+b.widgetName,function(){if(!a(this).hasClass("ui-state-disabled")){parseInt(d.menu.css("min-width"),10)<d.button.outerWidth()+10&&d.menu.css("min-width",d.button.outerWidth()+10);d.wrapper.toggleClass("ui-editor-selectmenu-visible");return false}}).bind("mouseenter."+b.widgetName,function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover",a(this).hasClass("ui-state-disabled"))}).bind("mouseleave."+
...
val:function(){var a=this.select.val.apply(this.select,arguments);this.update();return a},change:function(){}},c)},getPlugin:function(a){return this.plugins[a]},loadPlugins:function(){this.options.plugins||(this.options.plugins={});for(var c in a.ui.editor.plugins)if(!(!1===this.options.enablePlugins&&"undefined"===typeof this.options.plugins[c]||!1===this.options.plugins[c])&&-1===a.inArray(c,this.options.disabledPlugins)){var b=a.extend({},a.ui.editor.plugins[c]),d=c.replace(/([A-Z])/g,function(a){return"-"+
a.toLowerCase()}),d=a.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-"+d},b.options,this.options.plugins[c]);b.editor=this;b.options=d;b.init(this,d);b.hotkeys&&this.registerHotkey(b.hotkeys,null,b);this.plugins[c]=b}},isDirty:function(){return this.dirty},getHtml:function(){var c=this.getElement().html(),c=a("<div/>").html(c);c.find(".rangySelectionBoundary").remove();return c=c.html()},getCleanHtml:function(){this.fire("clean");var c=this.getElement().html();this.fire("restore");
c=a("<div/>").html(c);c.find(".rangySelectionBoundary").remove();return c=c.html()},setHtml:function(a){this.getElement().html(a);this.fire("html");this.change()},resetHtml:function(){this.setHtml(this.getOriginalHtml());this.fire("cleaned")},getOriginalHtml:function(){return this.originalHtml},save:function(){var a=this.getCleanHtml();this.fire("save");this.setOriginalHtml(a);this.fire("saved");this.fire("cleaned");return a},setOriginalHtml:function(a){this.originalHtml=a},bind:function(c,b,d){var e=
this.events;a.each(c.split(","),function(c,f){f=a.trim(f);e[f]||(e[f]=[]);e[f].push({context:d,callback:b})})},unbind:function(a,b,d){for(var e=0,f=this.events[a].length;e<f;e++)this.events[a][e]&&this.events[a][e].callback===b&&this.events[a][e].context===d&&this.events[a].splice(e,1)},fire:function(c,b,d){d||this.fire("before:"+c,b,!0);if(this.events[c])for(var e=0,f=this.events[c].length;e<f;e++){var h=this.events[c][e];"undefined"!==typeof h.callback&&h.callback.call(h.context||this)}!1!==b&&
a.ui.editor.fire(c);d||this.fire("after:"+c,b,!0)}});a.extend(a.ui.editor,{elementRemoveComments:function(c){c.contents().each(function(){8==this.nodeType&&a(this).remove()});c.children().each(function(){element.removeComments(a(this))});return c},elementRemoveAttributes:function(c,b){c.children().each(function(){var c=a.map(this.attributes,function(c){if(-1===a.inArray(c.name,b))return c.name}),d=a(this);a.each(c,function(a,c){d.removeAttr(c)});element.removeAttributes(a(this),b)});return c},elementBringToTop:n,
elementOuterHtml:p,elementOuterText:function(a){return a.clone().wrap("<div/>").parent().text()},elementIsBlock:function(a){return"block"===r(a.tagName)},elementDefaultDisplay:r,elementIsValid:o,elementGetStyles:l,fragmentToHtml:b,fragmentInsertBefore:function(c,b,d){for(var e=0,f=c.childNodes.length;e<f;e++){var h=c.childNodes.item(e);(h=3===h.nodeType?h.nodeValue:a(h).html())&&a("<"+d+"/>").html(a.trim(h)).insertBefore(b)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},
rangeGetCommonAncestor:d,rangeIsEmpty:h,selectionSave:v,selectionRestore:q,selectionDestroy:A,selectionEachRange:D,selectionReplace:F,selectionSelectInner:E,selectionSelectOuter:C,selectionSelectEdge:O,selectionSelectEnd:B,selectionSelectStart:L,selectionGetHtml:J,selectionGetElements:k,selectionToggleWrapper:N,selectionExists:function(a){var b=!1;D(function(a){h(a)||(b=!0)},a,this);return b},selectionReplaceSplittingSelectedElement:i,selectionReplaceWithinValidTags:P,selectionToggleBlockStyle:I,
stringStripTags:R,defaults:{plugins:{},ui:{},bind:{},domTools:{constrainSelection:function(c,b){var c=a(c)[0],b=b||f.getSelection(),d;a(b.getAllRanges()).each(function(e,f){d=3===this.commonAncestorContainer.nodeType?a(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;c!==d&&!a.contains(c,d)&&b.removeRange(f)})},unwrapParentTag:function(c){k().each(function(){a(this).is(c)&&a(this).replaceWith(a(this).html())})},execCommand:function(a,b,d){try{document.execCommand(a,b,d)}catch(e){}},
insertTag:function(c,b){D(function(b){b.insertNode(a("<"+c+"/>")[0])},b,this)},insertTagAtEnd:function(c,b){D(function(b){b.insertNodeAtEnd(a("<"+c+"/>")[0])},b,this)},insertElement:function(c,b,d){D(function(d){a(c).each(function(){d.insertNode(!1===b?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(c,b,d){D(function(d){a(c).each(function(){d.insertNodeAtEnd(!1===b?this:this.cloneNode(!0))})},d,this)},wrapInner:function(c,b){v();a(c).each(function(){var d=a("<"+b+"/>").html(a(this).html());
c.html(d)});q()},inverseWrapWithTagClass:function(c,b,d,e){v();var h="domTools"+Math.ceil(1E7*Math.random());D(function(a){var c=f.createCssClassApplier(e,{elementTagName:d});c.isAppliedToRange(a)?c.toggleSelection():f.createCssClassApplier(b,{elementTagName:h}).toggleSelection()},null,this);a(h).each(function(){a(this).replaceWith(a("<"+c+"/>").addClass(b).html(a(this).html()))});q()},toggleStyle:function(c,b){a.each(b,function(b,g){a(c).css(b)===g?a(c).css(b,""):a(c).css(b,g)})},swapStyles:function(a,
b,d){for(var e in d)a.css(e,b.css(e)),b.css(e,d[e])}},namespace:null,unify:!0,persistence:!0,persistenceName:"uiEditor",unloadWarning:!0,autoEnable:!1,partialEdit:!1,enablePlugins:!0,disabledPlugins:[],uiOrder:null,enableUi:!0,disabledUi:[],message:{delay:5E3},replaceStyle:"display,position,float,width,padding-left,padding-right,padding-top,padding-bottom,margin-left,margin-right,margin-top,margin-bottom".split(","),baseClass:"ui-editor",cssPrefix:"cms-",draggable:!0,enableHotkeys:!0,hotkeys:{},supplementaryClass:"supplementary-element-class"},
...
dialogClass:b.options.dialogClass+" "+b.options.baseClass,show:b.options.dialogShowAnimation,hide:b.options.dialogHideAnimation,buttons:[{text:e("OK"),click:function(){c.cancel();a(this).dialog("close")}},{text:e("Cancel"),click:function(){a(this).dialog("close")}}],open:function(){var c=a(this).parent().find(".ui-dialog-buttonpane");c.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});c.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){a(this).dialog("destroy").remove()}})):
...
this.clean,this)},clean:function(){var c,b=this.editor;for(c=0;c<this.options.stripAttrs.length;c++)b.getElement().find("["+this.options.stripAttrs[c]+"]").removeAttr(this.options.stripAttrs[c]);for(c=0;c<this.options.stripAttrContent.length;c++)b.getElement().find("["+c+'="'+this.options.stripAttrs[c]+'"]').removeAttr(this.options.stripAttrs[c]);for(c=0;c<this.options.stripEmptyTags.length;c++)b.getElement().find(this.options.stripEmptyTags[c]).filter(function(){if(a(this).hasClass(b.options.supplementaryClass))return!1;
if(a(this).hasClass("rangySelectionBoundary")&&!1===(!1!==S)||""===a.trim(a(this).html()))return!0}).remove();for(c=0;c<this.options.stripEmptyAttrs.length;c++){var d=this.options.stripEmptyAttrs[c];b.getElement().find("["+this.options.stripEmptyAttrs[c]+"]").filter(function(){return""===a.trim(a(this).attr(d))}).removeAttr(this.options.stripEmptyAttrs[c])}var e=s.location.protocol+"//"+s.location.host,f="//"+s.location.host;for(c=0;c<this.options.stripDomains.length;c++){var h=this.options.stripDomains[c];
this.editor.getElement().find(h.selector).each(function(){for(var c=0;c<h.attributes.length;c++){var b=a(this).attr(h.attributes[c]);"undefined"!==typeof b&&(0===b.indexOf(e)?a(this).attr(h.attributes[c],b.substr(e.length)):0===b.indexOf(f)&&a(this).attr(h.attributes[c],b.substr(f.length)))}})}this.editor.getElement().find("ul, ol").each(function(){a(this).find(" > :not(li)").each(function(){r(a(this).attr("tag"))?a(this).replaceWith(a("<li>"+a(this).html()+"</li>").appendTo("body")):a(this).wrap(a("<li>"))})})}});
a.ui.editor.registerUi({clean:{init:function(a){return a.uiButton({title:e("Remove unnecessary markup from editor content"),click:function(){a.getPlugin("clean").clean()}})}}});a.ui.editor.registerUi({clearFormatting:{init:function(c){return this.editor.uiButton({title:e("Clear Formatting"),click:function(){var d=f.getSelection();if(0<d.rangeCount){var e=d.getRangeAt(0).cloneRange(),h=e.extractContents();""==b(h)&&(c.expandToParent(e),d.setSingleRange(e),h=e.extractContents());h=a("<div/>").append(b(h)).text();
for(d=e.commonAncestorContainer;d&&d.parentNode!=c.getElement().get(0);)d=d.parentNode;if(d){e.setEndAfter(d);var i=e.extractContents();e.collapseAfter(d);e.insertNode(i);e.collapseAfter(d)}e.insertNode(document.createTextNode(h))}c.checkChange()}})}}});a.ui.editor.registerPlugin("clickButtonToEdit",{hovering:!1,buttonClass:null,buttonSelector:null,button:!1,options:{button:{text:!0,icons:{primary:"ui-icon-pencil"}}},init:function(c,b){var d=this;this.buttonClass=this.options.baseClass+"-button-element";
this.buttonSelector="."+this.buttonClass;this.selection=function(){var a;document.selection?a=document.selection.createRange():document.getSelection().rangeCount&&(a=document.getSelection().getRangeAt(0));return a};this.show=function(){if(!c.isEditing()){c.getElement().addClass(b.baseClass+"-highlight");c.getElement().addClass(b.baseClass+"-hover");var e=d.getButton();var f=c.getElement(),f=a(f),h=Math.round(f.offset().top),i=Math.round(f.offset().left),l=Math.round(f.outerWidth()),f=Math.round(f.outerHeight()),
k=a(s).scrollTop(),m=a(s).height(),n=k+m,o=Math.round(f+h);k<h&&n>o||(k>h&&(h=k),f=n<o?n-h:m-(n-o));e.css({position:"absolute",top:h+(f/2-a(e).outerHeight()/2),left:i+l/2-a(e).outerWidth()/2})}};this.hide=function(e){var f=d.getButton();if(!e||!(e.relatedTarget===f.get(0)||f.get(0)===a(e.relatedTarget).parent().get(0)))c.getElement().removeClass(b.baseClass+"-highlight"),c.getElement().removeClass(b.baseClass+"-hover"),d.destroyButton()};this.edit=function(){d.hide();c.isEditing()||c.enableEditing();
c.isVisible()||c.showToolbar(d.selection())};this.buttonOut=function(b){b.relatedTarget===d.getButton().get(0)||b.relatedTarget===c.getElement().get(0)||a.contains(c.getElement().get(0),b.relatedTarget)||d.hide()};c.getElement().addClass("ui-editor-click-button-to-edit");c.bind("ready, hide, cancel",function(){c.getElement().bind("mouseenter."+c.widgetName,d.show);c.getElement().bind("mouseleave."+c.widgetName,d.hide)});c.bind("show",function(){d.destroyButton();c.getElement().unbind("mouseenter."+
...
a(this.dialog).dialog("destroy").remove();this.dialog=null;a(this.ui.button).button("option","disabled",!1)},show:function(){if(!this.dialog){a(this.ui.button).button("option","disabled",!0);var c=this;v();this.dialog=a(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:e("Paste Embed Code"),autoOpen:!0,dialogClass:c.options.baseClass+" "+c.options.dialogClass,buttons:[{text:e("Embed Object"),click:function(){q();F(a(this).find("textarea").val());
...
this.ui.enable()}}});a.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:e("Insert Horizontal Rule"),click:function(){F("<hr/>")}})}}});a.ui.editor.registerUi({i18n:{init:function(c){var b=this,d=this.persist("locale");d&&u(d);var d=a('<select autocomplete="off" name="i18n"/>'),f;for(f in Q){var h=a('<option value="'+f+'" class="'+f+'"/>');h.html(z[f]);K===f&&h.attr("selected","selected");d.append(h)}return c.uiSelectMenu({title:e("Change Language"),select:d,change:function(a){u(b.persist("locale",
a))}})}}});t("de","Deutsch",{"A preview of your embedded object is displayed below.":"Eine Vorschau ihres eingebundenen Objekts wird unterhalb angezeigt.","Added link: {{link}}":"Link hinzugef\u00fcgt: {{link}}","All changes will be lost!":"Alle \u00c4nderungen gehen verloren!","Apply Source":"Quellcode anwenden","Are you sure you want to stop editing?":"Wollen Sie wirklich mit der Bearbeitung aufh\u00f6ren?",Blockquote:"Zitat",Bold:"Fett",Cancel:"Abbrechen","Center Align":"Zentrieren","Change HTML tag of selected element":"HTML Tag des selektierten Elements \u00e4ndern",
...
"{{characters}} characters, {{charactersRemaining}} remaining":"{{characters}} Zeichen, {{charactersRemaining}} verbleibend","{{sentences}} sentences":"{{sentences}} S\u00e4tze","{{words}} word":"{{words}} Wort","{{words}} words":"{{words}} W\u00f6rter"});t("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"Apply Source",
...
resizeButtonClass:null,resizingClass:null},init:function(c){this.options=a.extend({},this.options,{manuallyResizingClass:this.options.baseClass+"-manually-resize",resizeButtonClass:this.options.baseClass+"-resize-button",resizingClass:this.options.baseClass+"-in-progress"});c.bind("enabled",this.bind,this)},bind:function(){this.options.allowOversizeImages||(this.addImageListeners(),this.editor.bind("change",this.scanForOversizedImages,this),this.editor.bind("save",this.save,this));this.editor.bind("destroy",
...
this.detachEvent("onpropertychange",a.resized)})},imageResizedByUser:function(c){var b=a(c.target);b.is("img")&&b.attr("_moz_resizing")&&"style"==c.attrName&&c.newValue.match(/width|height/)&&this.editor.fire("change")},scanForOversizedImages:function(){var c=this.editor.getElement(),b=[];a(c.find("img")).each(function(){c.width()<a(this).outerWidth()&&b.push(a(this))});b.length&&this.resizeOversizedImages(b,c.width())},resizeOversizedImages:function(c,b){for(var d=a("<a>",{href:"",target:"_blank"}),
...
this.removeToolsButtons();this.unbind()},showOversizeWarning:function(a,b){this.editor.showInfo(e("The image '{{image}}' is too wide for the element being edited.<br/>It will be resized to fit.",{image:a}),b)},removeClasses:function(c){c||(c=[this.options.resizingClass,this.options.manuallyResizingClass]);a.isArray(c)||(c=[c]);for(var b=0;b<c.length;b++)this.editor.getElement().find("img."+c[b]).removeClass(c[b])},manuallyResizeImage:function(c){this.removeToolsButtons();var b=this.editor.getElement().find("img."+
this.options.manuallyResizingClass),d=a(b).innerWidth(),f=a(b).innerHeight(),h="#"+this.options.baseClass+"-width",i="#"+this.options.baseClass+"-height",k=this,l=function(c){c=Math.round(c||a(h).val())+"px";a(b).css({width:c})},m=a(this.editor.getTemplate("imageresize.manually-resize-image",{width:d,height:f,baseClass:this.options.baseClass}));m.dialog({modal:!0,resizable:!1,title:e("Modify Image Size"),autoOpen:!0,buttons:[{text:e("Resize Image"),click:function(){l(a(this).find(h).val());a(this).dialog("close")}},
{text:e("Cancel"),click:function(){l(d);a(this).dialog("close")}}],close:function(){k.editor.checkChange();a(m).remove()},open:function(){var c=a(this).find(h),b=a(this).find(i);c.keyup(function(){b.val(Math.round(Math.abs(f/d*a(this).val())));l()});b.keyup(function(){c.val(Math.round(Math.abs(d/f*a(this).val())));l()})}});c.preventDefault();return!1},displayToolsButtonRelativeToImage:function(c){var b=a("<button>"+e("Click to edit the image")+"</button>").appendTo("body").addClass(this.options.resizeButtonClass).button({text:!1,
icons:{primary:"ui-icon-tools"}});b.css({position:"absolute",left:a(c).position().left+a(c).innerWidth()-a(b).outerWidth()-10+"px",top:a(c).position().top+10+"px"}).attr("contenteditable",!1).click(a.proxy(this.manuallyResizeImage,this));b.addClass(this.editor.options.supplementaryClass).find("span").addClass(this.editor.options.supplementaryClass);a(c).before(b)},removeToolsButtons:function(){this.editor.getElement().find("."+this.options.resizeButtonClass).each(function(){a(this).remove()})},imageMouseEnter:function(c){a(c.target).addClass(this.options.manuallyResizingClass);
this.displayToolsButtonRelativeToImage(c.target)},imageMouseLeave:function(c){a(c.relatedTarget).hasClass(this.options.resizeButtonClass)||(a(c.target).removeClass(this.options.manuallyResizingClass),this.removeToolsButtons())}});a.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:e("Page on this or another website"),focusSelector:'input[name="location"]',init:function(){this.content=this.plugin.editor.getTemplate("link.external",this.options);
return this},show:function(a,b){var d=this;a.find('input[name="location"]').bind("keyup",function(){d.validate(a)});b&&(a.find('input[name="location"]').val(this.plugin.selectedElement.attr("href")).trigger("keyup"),"_blank"===this.plugin.selectedElement.attr("target")&&a.find('input[name="blank"]').attr("checked","checked"));return this},attributes:function(a){var b={href:a.find('input[name="location"]').val()};a.find('input[name="blank"]').is(":checked")&&(b.target="_blank");this.options.regexLink.test(b.href)||
...
c.find(b).not(":visible").show(),d=!1);return d}},{type:"email",title:e("Email address"),focusSelector:'input[name="email"]',init:function(){this.content=this.plugin.editor.getTemplate("link.email",this.options);return this},show:function(a,b){var d=this;a.find('input[name="email"]').bind("keyup",function(){d.validate(a)});b&&(a.find('input[name="email"]').val(this.plugin.selectedElement.attr("href").replace(/(mailto:)|(\?Subject.*)/gi,"")).trigger("keyup"),/\?Subject\=/i.test(this.plugin.selectedElement.attr("href"))&&
a.find('input[name="subject"]').val(decodeURIComponent(this.plugin.selectedElement.attr("href").replace(/(.*\?Subject=)/i,""))));return this},attributes:function(a){var b={href:"mailto:"+a.find('input[name="email"]').val()};if(a=a.find('input[name="subject"]').val())b.href=b.href+"?Subject="+encodeURIComponent(a);return b},validate:function(c){var b="."+this.options.baseClass+"-error-message-email",d=!0;this.options.regexEmail.test(c.find('input[name="email"]').val())?c.find(b).has(":visible").hide():
(c.find(b).size()||c.find('input[name="email"]').after(this.plugin.editor.getTemplate("link.error",a.extend({},this.options,{messageClass:this.options.baseClass+"-error-message-email",message:e("The email address does not look well formed")}))),c.find(b).not(":visible").show(),d=!1);return d}},{type:"fileUrl",title:e("Document or other file"),focusSelector:'input[name="location"]',init:function(){this.content=this.plugin.editor.getTemplate("link.file-url",this.options);return this},show:function(a,
b){var d=this;a.find('input[name="location"]').bind("keyup",function(){d.validate(a)});b&&(a.find('input[name="location"]').val(this.plugin.selectedElement.attr("href")).trigger("click"),"_blank"===this.plugin.selectedElement.attr("target")&&a.find('input[name="blank"]').attr("checked","checked"));return this},attributes:function(a){var b={href:a.find('input[name="location"]').val()};a.find('input[name="blank"]').is(":checked")&&(b.target="_blank");this.options.regexLink.test(b.href)||this.plugin.editor.showWarning(e("The url for the file you inserted doesn't look well formed"));
...
b){this.options=a.extend({},{panelAnimation:"fade",replaceTypes:!1,customTypes:[],typeDataName:"uiWidgetEditorLinkType",dialogWidth:750,dialogHeight:"auto",dialogMinWidth:670,regexLink:/^(http|https|ftp):\/\/[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/i,regexEmail:/[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/},b);c.bind("save",this.repairLinks,this);c.bind("cancel",this.cancel,this)},initTypes:function(){this.types=
{};for(var c={type:null,title:null,content:null,plugin:this,options:this.options,attributes:function(){},init:function(){return this},show:function(){},editing:function(c){if(c.attr("class"))for(var b=this.classes.split(/\s/gi),d=0;d<b.length;d++)if(b[d].trim()&&a(c).hasClass(b[d]))return!0;return!1},focusSelector:null,focus:function(){if(this.focusSelector){var c=a(this.focusSelector),b=c.val();c.val("");c.focus().val(b)}}},b=null,b=this.options.replaceTypes?this.options.customTypes:a.merge(this.defaultLinkTypes,
this.options.customTypes),d,e=0;e<b.length;e++)d=a.extend({},c,b[e],{classes:this.options.baseClass+"-"+b[e].type}).init(),this.types[d.type]=d},show:function(){if(!this.visible){v();this.selectedElement=k().first();var c=this.selectedElement.is("a"),b=this.options,d=this,f=this.dialog=a(this.editor.getTemplate("link.dialog",b)).appendTo("body");this.initTypes();var h=this.dialog.find("fieldset"),i;for(i in this.types)a(this.editor.getTemplate("link.label",this.types[i])).appendTo(h);h.find('input[type="radio"]').bind("change."+
this.editor.widgetName,function(){d.typeChange(d.types[a(this).val()],c)});f.dialog({autoOpen:!1,modal:!0,resizable:!0,width:b.dialogWidth,minWidth:b.dialogMinWidth,height:b.dialogHeight,title:c?e("Edit Link"):e("Insert Link"),dialogClass:b.baseClass+" "+b.dialogClass,buttons:[{text:c?e("Update Link"):e("Insert Link"),click:function(){q();d.apply(c)&&a(this).dialog("close")}},{text:e("Cancel"),click:function(){a(this).dialog("close")}}],beforeopen:function(){d.dialog.find("."+d.options.baseClass+
"-content").hide()},open:function(){d.visible=!0;var b=f.parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});var e=f.find('.ui-editor-link-menu input[type="radio"]');e.first().attr("checked","checked");var g=!1;if(c)for(var h in d.types)if(g=d.types[h].editing(d.selectedElement)){e.filter('[value="'+h+'"]').attr("checked","checked");d.typeChange(d.types[h],c);break}(!c||
c&&!g)&&d.typeChange(d.types[e.filter(":checked").val()],c);a(this).unbind("keyup."+d.editor.widgetName).bind("keyup."+d.editor.widgetName,function(c){13==c.keyCode&&(c=d.types[e.filter(":checked").val()],(!a.isFunction(c.validate)||c.validate(d.dialog.find("."+d.options.baseClass+"-content")))&&b.find("button:eq(0)").trigger("click"))})},close:function(){q();d.visible=!1;f.find("."+b.baseClass+"-content").hide();a(this).dialog("destroy")}}).dialog("open")}},apply:function(c){var b=this.types[this.dialog.find('input[type="radio"]:checked').val()],
d=b.attributes(this.dialog.find("."+this.options.baseClass+"-content"),c);if(!d)return!0;q();var f=p(a("<a>"+(d.title?d.title:d.href)+"</a>").attr(a.extend({},d,{target:"_blank"})));c?(this.selectedElement[0].className=this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(b.classes).attr(d),this.editor.showConfirm(e("Updated link: {{link}}",{link:f}))):(G("a",a.extend(d,{id:this.editor.getUniqueId()}),b.classes),this.editor.showConfirm(e("Added link: {{link}}",
{link:f})),this.selectedElement=a("#"+d.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",d.href);C(this.selectedElement);v();return!0},typeChange:function(c,b){var d=this.dialog.find("."+this.options.baseClass+"-content"),e=d.closest("."+this.options.baseClass+"-wrap"),f=c.ajaxUri&&!this.types[c.type].content;f&&e.addClass(this.options.baseClass+"-loading");var h=this;d.hide(this.options.panelAnimation,function(){f?a.ajax({url:c.ajaxUri,type:"get",success:function(f){d.html(f);
h.types[c.type].content=f;e.removeClass(h.options.baseClass+"-loading");c.show(d,b);d.show(h.options.panelAnimation,a.proxy(c.focus,c))}}):(d.html(c.content),c.show(d,b),d.show(h.options.panelAnimation,a.proxy(c.focus,c)))})},remove:function(){this.editor.unwrapParentTag("a")},repairLinks:function(){var c=this;this.editor.getElement().find('a[class^="'+this.options.baseClass+'"]').each(function(){a(this).data(c.options.baseClass+"-href")&&a(this).attr("href",a(this).data(c.options.baseClass+"-href"))})},
...
this.change,this);a.bind("show",this.change,this);return a.uiButton({title:e("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){k().is("a")?this.ui.enable():this.ui.disable()}}});a.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),
toggleList:function(c){a(k()).is("li")&&a(k()).parent().is(c)?this.unwrapList():this.wrapList(c);this.editor.fire("selectionChange");this.editor.fire("change")},unwrapList:function(){v();var c=[],b=[],d=H(),e=U();c.push(a(d).html());b.push(d);if(a(d)[0]!==a(e)[0]){var f=d;do f=a(f).next(),c.push(a(f).html()),b.push(f);while(a(f)[0]!==a(e)[0])}f=0===a(d).prev().length;e=0===a(e).next().length;d=a(d).parent();for(listElementsIndex=0;listElementsIndex<b.length;listElementsIndex++)a(b[listElementsIndex]).remove();
for(b=0;b<c.length;b++)d.parent().is("li")||(c[b]="<p>"+c[b]+"</p>");f&&e?(d.replaceWith(c.join("")),q(),c=k()[0],C(c)):(f?a(d).before(c.join("")):e?a(d).after(c.join("")):i(c.join("")),q(),this.editor.checkChange())},wrapList:function(c){this.editor.constrainSelection(this.editor.getElement());""===a.trim(J())&&E(k());var b=a("<div>").html(J()),d=[],e=this;a(b).contents().each(function(){var c;c="block"===r(this.tagName)?R(a(this).html(),e.validChildren):R(p(a(this)),e.validChildren);c=a("<li>"+
c+"</li>");""!==a.trim(c.text())&&d.push(p(c))});b=this.options.baseClass+"-selection";c="<"+c+' class="'+b+'">'+d.join("")+"</"+c+">";q();var f=a(k()[0]).parent(),h=this.editor.getElement()[0];f===h||k()[0]===h?F(c):P(c,this.validParents);b=a(this.editor.getElement().find("."+b).removeClass(b));E(b.find("li:first")[0]);this.editor.checkChange()},toggleButtonState:function(c,b){var e=function(a){b.button.toggleClass("ui-state-highlight",a).toggleClass("ui-state-default",!a)},f=H();if(null===f||!f.length)f=
this.editor.getElement();var h=U();if(null===h||!h.length)h=this.editor.getElement();f=f[0];h=h[0];if(a(f).is(c)&&a(h).is(c)&&f===h)return e(!0);var i=a(f).parentsUntil(k,c).first()&&a(h).parentsUntil(k,c).first(),k="#"+this.editor.getElement().attr("id"),l=a(f).is(c+" > li")||a(f).parentsUntil(k,c+" > li").length,m=a(h).is(c+" > li")||a(h).parentsUntil(k,c+" > li").length;if(l&&m&&i){i=a(d());i.is(c)||(i=a(i).parentsUntil(k,c).first());k=i.find("ul, ol");if(!k.length)return e(!0);for(i=0;i<k.length;i++)if(a.contains(k[i],
f)&&a.contains(k[i],h))return e(!1);return e(!0)}return e(!1)}});a.ui.editor.registerUi({listUnordered:{init:function(a){var b=a.uiButton({title:e("Unordered List"),click:function(){a.getPlugin("list").toggleList("ul")}});a.bind("selectionChange",function(){a.getPlugin("list").toggleButtonState("ul",b)});return b}},listOrdered:{init:function(a){var b=a.uiButton({title:e("Ordered List"),click:function(){a.getPlugin("list").toggleList("ol")}});a.bind("selectionChange",function(){a.getPlugin("list").toggleButtonState("ol",
b)});return b}}});a.ui.editor.registerUi({logo:{ui:null,init:function(){return this.ui=this.editor.uiButton({title:e("Learn More About the Raptor WYSIWYG Editor"),click:function(){s.open("http://www.jquery-raptor.com/about/editors/","_blank")},ready:function(){var c=function(b){var d=typeof b;if("object"!=d||null===b)return"string"==d&&(b='"'+b+'"'),""+b;var e=[],g=b&&a.isArray(b);a.each(b,function(a,b){d=typeof b;"string"==d?b='"'+b+'"':"object"==d&null!==b&&(b=c(b));e.push((g?"":'"'+a+'":')+(""+
b))});return(g?"[":"{")+(""+e)+(g?"]":"}")},b={enableUi:this.options.enableUi,enablePlugins:this.options.enablePlugins,disabledPlugins:c(this.options.disabledPlugins),ui:c(this.options.ui),t:(new Date).getTime()},d=[],e;for(e in b)d.push(e+"="+encodeURIComponent(b[e]));this.ui.button.find(".ui-button-icon-primary").css({"background-image":"url(http://www.jquery-raptor.com/logo/0.0.24?"+d.join("&")+")"})}})}}});a.ui.editor.registerPlugin("normaliseLineBreaks",{options:{enter:"<p><br/></p>",enterValidTags:"address,blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),
shiftEnter:"<br/>",shiftEnterValidTags:"a,abbr,acronym,address,applet,b,bdo,big,blockquote,body,button,caption,center,cite,code,dd,del,dfn,div,dt,em,fieldset,font,form,h1,h2,h3,h4,h5,h6,i,iframe,ins,kbd,label,legend,li,noframes,noscript,object,p,pres,q,s,samp,small,span,strike,strong,sub,sup,td,th,tt,u,var".split(",")},hotkeys:{"return":{action:function(){A();var c=""===f.getSelection().toHtml(),b;b=f.getSelection();var d=b.isBackwards()?b.focusNode:b.anchorNode;(b.isBackwards()?b.focusOffset:0!==
b.anchorOffset)?b=!1:(b=d.previousSibling,b=!b||""===a(b).html()?!0:!1);var e;d=f.getSelection();e=d.isBackwards()?d.anchorNode:d.focusNode;(d.isBackwards()?d.focusOffset:d.anchorOffset)!==e.textContent.length?e=!1:(d=e.nextSibling,e=!d||""===a(d).html()?!0:!1);var h=this.options.baseClass+"-enter-break",d=a(this.options.enter).attr("id",h);P(d,this.options.enterValidTags);d=a("#"+h).removeAttr("id");c?b?L(d.next()):e?L(d):(L(d.next()),(c=d.prev())&&""!==a.trim(c.html())&&p(c)!==this.options.enter&&
d.remove()):(L(d.next()),d.remove())},restoreSelection:!1},"return+shift":{action:function(){A();var c=this.options.baseClass+"-enter-break",b=a(this.shiftEnter).attr("id",c).appendTo("body");this.options.shiftEnterValidTags?P(this.options.shiftEnter,this.options.shiftEnterValidTags):F(b);c=a("#"+c).removeAttr("id").next();L(c)},restoreSelection:!1}}});a.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span,hr,br".split(","),allowedAttributes:["href",
"title"],allowedEmptyTags:["hr","br"]},init:function(c,b){var d=!1,f=!1,h=this;c.getElement().bind("paste."+c.widgetName,a.proxy(function(){if(d)return!1;d=!0;v();a(".uiWidgetEditorPasteBin").length&&a(".uiWidgetEditorPasteBin").remove();a('<div class="uiWidgetEditorPasteBin" contenteditable="true" style="width: 1px; height: 1px; overflow: hidden; position: fixed; top: -1px;" />').appendTo("body");a(".uiWidgetEditorPasteBin").focus();s.setTimeout(function(){var i=a(".uiWidgetEditorPasteBin").html(),
i=h.filterAttributes(i),i=h.filterChars(i),i=h.stripEmpty(i),i=h.stripAttributes(i),i=R(i,h.options.allowedTags),i={plain:a("<div/>").html(a(".uiWidgetEditorPasteBin").html()).text(),markup:i,html:a(".uiWidgetEditorPasteBin").html()};f=a(c.getTemplate("paste.dialog",i));a(f).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:b.dialogShowAnimation,hide:b.dialogHideAnimation,dialogClass:b.baseClass+" "+b.dialogClass,buttons:[{text:e("Insert"),click:function(){var b=
null,b=a(this).find(".ui-editor-paste-area:visible"),b=b.hasClass("ui-editor-paste-plain")||b.hasClass("ui-editor-paste-source")?b.val():b.html(),b=h.filterAttributes(b),b=h.filterChars(b);q();F(b);c.checkChange();d=!1;a(this).dialog("close")}},{text:e("Cancel"),click:function(){q();d=!1;a(this).dialog("close")}}],open:function(){var c=a(this).find(".ui-editor-paste-panel-tabs");c.find("ul.ui-tabs-nav li").click(function(){c.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
...
{init:function(c,b){b=a.extend({},{content:"[Your content here]",tag:"p",select:!0},b);this.show=function(){if(!a.trim(c.getElement().html())){var d=a(document.createElement(b.tag)).html(b.content);c.getElement().html(d);b.select&&E(d)}};c.bind("show",this.show)}});a.ui.editor.registerPlugin("saveJson",{options:{id:{attr:"name"},postName:"content",showResponse:!1,appendId:!1,ajax:{url:"/",type:"post",cache:!1}},init:function(){},getId:function(){if("string"===typeof this.options.id)return this.options.id;
...
(0<this.failed&&0===this.saved?this.editor.showError(e("Failed to save {{failed}} content block(s).",this)):0<this.failed?this.editor.showError(e("Saved {{saved}} out of {{dirty}} content blocks.",this)):this.editor.showConfirm(e("Successfully saved {{saved}} content block(s).",this),{delay:1E3,hide:function(){this.editor.unify(function(a){a.disableEditing();a.hideToolbar()})}})),this.message.hide(),this.message=null)},ajax:function(c,b){var d=a.extend(!0,{},this.options.ajax);a.isFunction(d.data)?
d.data=d.data.apply(this,[b,c]):this.options.postName&&(d.data={},d.data[this.options.postName]=JSON.stringify(c));a.isFunction(d.url)&&(d.url=d.url.apply(this,[b]));this.requests++;a.ajax(d).done(a.proxy(this.done,this)).fail(a.proxy(this.fail,this)).always(a.proxy(this.always,this))}});a.ui.editor.registerPlugin("saveRest",{options:{showResponse:!1,ajax:{url:"/",type:"post",cache:!1}},init:function(){},getId:function(){if("string"===typeof this.options.id)return this.options.id;if(this.options.id.attr){var a=
this.editor.getOriginalElement().attr(this.options.id.attr);if(a)return a}return null},getData:function(){this.getId();this.editor.save();return this.editor.save()},save:function(){this.message=this.editor.showLoading(e("Saving changes..."));var a=this.requests=this.failed=this.saved=0;this.editor.unify(function(b){if(b.isDirty()){a++;var b=b.getPlugin("saveRest"),d=b.editor.save();b.ajax(d)}});this.dirty=a;0===a&&(this.message.hide(),this.editor.showInfo(e("No changes detected to save...")))},done:function(a){this.options.multiple?
this.saved++:this.saved=this.dirty;this.options.showResponse&&this.editor.showConfirm(a,{delay:1E3,hide:function(){this.editor.unify(function(a){a.disableEditing();a.hideToolbar()})}})},fail:function(a){this.options.multiple?this.failed++:this.failed=this.dirty;this.options.showResponse&&this.editor.showError(a.responseText)},always:function(){this.dirty===this.saved+this.failed&&(this.options.showResponse||(0<this.failed&&0===this.saved?this.editor.showError(e("Failed to save {{failed}} content block(s).",
this)):0<this.failed?this.editor.showError(e("Saved {{saved}} out of {{dirty}} content blocks.",this)):this.editor.showConfirm(e("Successfully saved {{saved}} content block(s).",this),{delay:1E3,hide:function(){this.editor.unify(function(a){a.disableEditing();a.hideToolbar()})}})),this.message.hide(),this.message=null)},ajax:function(b,d){var e=a.extend(!0,{},this.options.ajax);a.isFunction(e.data)?e.data=e.data.apply(this,[d,b]):this.options.postName&&(e.data={},e.data[this.options.postName]=JSON.stringify(b));
a.isFunction(e.url)&&(e.url=e.url.apply(this,[d]));this.requests++;a.ajax(e).done(a.proxy(this.done,this)).fail(a.proxy(this.fail,this)).always(a.proxy(this.always,this))}});a.ui.editor.registerUi({save:{options:{plugin:"saveJson"},init:function(a){return a.uiButton({title:e("Save"),icon:"ui-icon-save",click:function(){a.checkChange();a.getPlugin(this.options.plugin).save()}})}}});a.ui.editor.registerPlugin({snippet:{ids:[],enabled:!1,init:function(a,b){if(b.snippets){for(var d=0,e=b.snippets.length;d<
e;d++)this.createSnippet(b.snippets[d],a);a.bind("restore",this.createButtons,this);a.bind("save",this.disable,this);a.bind("cancel",this.disable,this);a.bind("enabled",this.enable,this);a.bind("disabled",this.disable,this)}},createSnippet:function(){},enable:function(){this.enabled=!0;this.createButtons()},disable:function(){this.removeButtons();this.enabled=!1},createButtons:function(){for(var a=this.editor,b=0,d=this.options.snippets.length;b<d;b++){var e=this.options.snippets[b];e.repeatable&&
this.createButton(e,a)}},createButton:function(b,d){if(this.enabled){var e=this,f=d.getUniqueId();this.ids.push(f);var h=a("<button/>").addClass(e.options.baseClass).addClass(e.options.baseClass+"-button").addClass(e.options.baseClass+"-button-"+b.name).addClass(f).text("Add").click(function(){e.insertSnippet.call(e,b,d,this)}),i=b.buttonAfter||d.getElement();a.isFunction(i)?i.call(this,h,b):h.insertAfter(i);a("."+f).button({icons:{primary:"ui-icon-plusthick"}})}},removeButtons:function(){if(this.enabled){for(var b=
0,d=this.ids.length;b<d;b++)a("."+this.ids[b]).remove();b=0;for(d=this.options.snippets.length;b<d;b++){var e=this.options.snippets[b];a.isFunction(e.clean)&&e.clean.call(e,this,this.editor)}}},insertSnippet:function(b,d,e){var f=a(b.template).html(),h=b.appendTo||d.getElement();a.isFunction(h)?h.call(this,f,b,e):a(f).appendTo(h);d.disableEditing();d.enableEditing()}}});a.ui.editor.registerUi({statistics:{options:{maximum:null},init:function(b){b.bind("show",a.proxy(this.updateCount,this));b.bind("change",
a.proxy(this.updateCount,this));return this.editor.uiButton({title:e("Remaining characters before the recommended character limit is reached"),label:e("Initializing"),text:!0,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var b=this.options.maximum-a("<div/>").html(this.editor.getCleanHtml()).text().length,d=this.ui.button;if(!1===this.options.maximum)d.button("option","text",!1);else{var f=null,f=0<=b?e("{{charactersRemaining}} characters remaining",{charactersRemaining:b}):
e("{{charactersRemaining}} characters over limit",{charactersRemaining:-1*b});d.button("option","label",f);d.button("option","text",!0);0>b?d.addClass("ui-state-error"):0<=b&&15>=b?d.addClass("ui-state-highlight").removeClass("ui-state-error"):d.removeClass("ui-state-highlight ui-state-error")}},showStatistics:function(){this.processTemplate().dialog({modal:!0,resizable:!1,title:e("Content Statistics"),dialogClass:this.editor.options.dialogClass+" "+this.editor.options.baseClass,show:this.editor.options.dialogShowAnimation,
hide:this.editor.options.dialogHideAnimation,buttons:[{text:e("OK"),click:function(){a(this).dialog("close")}}],open:function(){a(this).parent().find(".ui-dialog-buttonpane").find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}})},close:function(){a(this).dialog("destroy").remove()}})},processTemplate:function(){var b=a("<div/>").html(this.editor.getCleanHtml()).text(),d=null,f=this.options.maximum-b.length,d=0>f?e("Content contains more than {{limit}} characters and may be truncated",
{limit:this.options.maximum}):e("Content will not be truncated"),h=null,h=b.split(" ").length,h=1==h?e("{{words}} word",{words:h}):e("{{words}} words",{words:h}),i=null,i=b.split(". ").length,i=e("{{sentences}} sentences",{sentences:i}),k=null,k=0<=f?e("{{characters}} characters, {{charactersRemaining}} remaining",{characters:b.length,charactersRemaining:f}):e("{{characters}} characters, {{charactersRemaining}} over the recommended limit",{characters:b.length,charactersRemaining:-1*f});return a(this.editor.getTemplate("statistics.dialog",
