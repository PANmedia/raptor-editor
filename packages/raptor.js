...
registerLocale('es', 'Español', {
    ...
    "Click to view statistics": "Haga clic para ver las estadísticas",
    "Close": "Cerrar",
    ...
    "Remaining characters before the recommended character limit is reached. Click to view statistics": "Carácteres restantes hasta que se alcance el límite de carácteres. Haga clic para ver las estadísticas",
    ...
    "The image '{{image}}' is too wide for the element being edited.<br/>It will be resized to fit.": "La imagen '{{image}}' es demasiado ancha para el elemento que está siendo editado.<br/>Será redimensionada para que se adapte.",
    ...
    "{{characters}} characters": "{{characters}} carácteres",
