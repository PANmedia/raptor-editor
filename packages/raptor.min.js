/*! VERSION: 0.0.5 *//*
 ...
 Build date: 26 February 2012
*/
window.rangy=function(){function d(a,c){var b=typeof a[c];return b==o||!!(b==p&&a[c])||"unknown"==b}function q(a,c){return!!(typeof a[c]==p&&a[c])}function n(a,c){return typeof a[c]!=i}function u(a){return function(c,b){for(var d=b.length;d--;)if(!a(c,b[d]))return!1;return!0}}function r(d){return d&&c(d,b)&&g(d,a)}function s(a){window.alert("Rangy not supported in your browser. Reason: "+a);h.initialized=!0;h.supported=!1}function f(){if(!h.initialized){var a,b=!1,e=!1;d(document,"createRange")&&
...
q(c._first,this)||c._last&&q(c._last,this);c.detach();return!b},detach:function(){e(this)},splitBoundaries:function(){x(this);var a=this.startContainer,c=this.startOffset,d=this.endContainer,e=this.endOffset,t=a===d;j.isCharacterDataNode(d)&&0<e&&e<d.length&&j.splitDataNode(d,e);j.isCharacterDataNode(a)&&0<c&&c<a.length&&(a=j.splitDataNode(a,c),t?(e-=c,d=a):d==a.parentNode&&e>=j.getNodeIndex(a)&&e++,c=0);b(this,a,c,d,e)},normalizeBoundaries:function(){x(this);var a=this.startContainer,c=this.startOffset,
...
c=r.isCharacterDataNode(d.node);c?(i=d.node,l=i.parentNode):(i=d.node.childNodes,i=k<i.length?i[k]:null,l=d.node);a=a.createElement("span");a.innerHTML="&#feff;";i?l.insertBefore(a,i):l.appendChild(a);b.moveToElementText(a);b.collapse(!f);l.removeChild(a);if(c)b[f?"moveStart":"moveEnd"]("character",k);return b}d.requireModules(["DomUtil","DomRange"]);var u,r=d.dom,s=r.DomPosition,f=d.DomRange;if(d.features.implementsDomRange&&(!d.features.implementsTextRange||!d.config.preferTextRange))(function(){function p(a){for(var b=
i.length,d;b--;)d=i[b],a[d]=a.nativeRange[d]}var o,i=f.rangeProperties,l;u=function(a){if(!a)throw Error("Range must be specified");this.nativeRange=a;p(this)};f.createPrototypeRange(u,function(a,b,d,h,f){var p=a.endContainer!==h||a.endOffset!=f;if(a.startContainer!==b||a.startOffset!=d||p)a.setEnd(h,f),a.setStart(b,d)},function(a){a.nativeRange.detach();a.detached=!0;for(var b=i.length,d;b--;)d=i[b],a[d]=null});o=u.prototype;o.selectNode=function(a){this.nativeRange.selectNode(a);p(this)};o.deleteContents=
function(){this.nativeRange.deleteContents();p(this)};o.extractContents=function(){var a=this.nativeRange.extractContents();p(this);return a};o.cloneContents=function(){return this.nativeRange.cloneContents()};o.surroundContents=function(a){this.nativeRange.surroundContents(a);p(this)};o.collapse=function(a){this.nativeRange.collapse(a);p(this)};o.cloneRange=function(){return new u(this.nativeRange.cloneRange())};o.refresh=function(){p(this)};o.toString=function(){return this.nativeRange.toString()};
...
(a=b.START_TO_END);return this.nativeRange.compareBoundaryPoints(a,b)}:function(a,b){return this.nativeRange.compareBoundaryPoints(a,b.nativeRange||b)};d.util.isHostMethod(a,"createContextualFragment")&&(o.createContextualFragment=function(a){return this.nativeRange.createContextualFragment(a)});r.getBody(document).removeChild(k);a.detach();l.detach()})(),d.createNativeRange=function(d){return(d||document).createRange()};else if(d.features.implementsTextRange){u=function(d){this.textRange=d;this.refresh()};
u.prototype=new f(document);u.prototype.refresh=function(){var d,f,i=this.textRange;d=i.parentElement();var l=i.duplicate();l.collapse(!0);f=l.parentElement();l=i.duplicate();l.collapse(!1);i=l.parentElement();f=f==i?f:r.getCommonAncestor(f,i);f=f==d?f:r.getCommonAncestor(d,f);0==this.textRange.compareEndPoints("StartToEnd",this.textRange)?f=d=q(this.textRange,f,!0,!0):(d=q(this.textRange,f,!0,!1),f=q(this.textRange,f,!1,!1));this.setStart(d.node,d.offset);this.setEnd(f.node,f.offset)};f.copyComparisonConstants(u);
var w=function(){return this}();"undefined"==typeof w.Range&&(w.Range=u);d.createNativeRange=function(d){return(d||document).body.createTextRange()}}d.features.implementsTextRange&&(u.rangeToTextRange=function(d){if(d.collapsed)return n(new s(d.startContainer,d.startOffset),!0);var f=n(new s(d.startContainer,d.startOffset),!0),i=n(new s(d.endContainer,d.endOffset),!1),d=r.getDocument(d.startContainer).body.createTextRange();d.setEndPoint("StartToStart",f);d.setEndPoint("EndToEnd",i);return d});u.prototype.getName=
function(){return"WrappedRange"};d.WrappedRange=u;d.createRange=function(f){return new u(d.createNativeRange(f||document))};d.createRangyRange=function(d){return new f(d||document)};d.createIframeRange=function(f){return d.createRange(r.getIframeDocument(f))};d.createIframeRangyRange=function(f){return d.createRangyRange(r.getIframeDocument(f))};d.addCreateMissingNativeApiListener(function(f){f=f.document;if(typeof f.createRange=="undefined")f.createRange=function(){return d.createRange(this)};f=
f=null})});
...
g+") do not match");e=s(a[1],b,c);b=s(a[2],b,c);c=d.createRange(c);c.setStart(e.node,e.offset);c.setEnd(b.node,b.offset);return c}function p(a,b,c){b?c||k.getDocument(b):b=(c||document).documentElement;a=/^([^,]+),([^,]+)({([^}]+)})?$/.exec(a)[3];return!a||a===u(b)}function o(a,b,c){for(var a=a||d.getSelection(),a=a.getAllRanges(),e=[],g=0,h=a.length;g<h;++g)e[g]=f(a[g],b,c);return e.join("|")}function i(a,b,c){b?c=c||k.getWindow(b):(c=c||window,b=c.document.documentElement);for(var a=a.split("|"),
...
g=b.domain?";domain="+b.domain:"",f=b.secure?";secure":"",m=o(d.getSelection(a));a.document.cookie=encodeURIComponent("rangySerializedSelection")+"="+encodeURIComponent(m)+c+e+g+f};d.getElementChecksum=u});
(function(d,q,n,u){function r(a,b,c){o[a]=c;i[a]=b;p||(p=a)}function s(a){p!==a&&(p=a,d.ui.editor.eachInstance(function(){this.reinit()}))}function f(a,b){p&&o[p]&&o[p][a]&&(a=o[p][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function w(a){if(l===u){l=!0;if(k=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))d("html").addClass(a.options.baseClass+"-ios"),k&&d(document).bind("scroll",function(){setInterval(function(){d("body").css("height","+=1").css("height",
...
c[0].nodeType||"inline"===c.css("display"));)c=c.parent();c[0]===b[0]&&"inline"!==b.css("display")&&(this.wrapInner(b,"div"),c=b.children().first());this.toggleStyle(c,a)})},wrapInner:function(a,b){this.saveSelection();d(a).each(function(){var c=d("<"+b+"/>").html(d(this).html());a.html(c)});this.restoreSelection()},inverseWrapWithTagClass:function(a,b,c,e){this.saveSelection();var g="domTools"+Math.ceil(1E7*Math.random());this.eachRange(function(a){var d=n.createCssClassApplier(e,{elementTagName:c});
d.isAppliedToRange(a)?d.toggleSelection():n.createCssClassApplier(b,{elementTagName:g}).toggleSelection()});d(g).each(function(){d(this).replaceWith(d("<"+a+"/>").addClass(b).html(d(this).html()))});this.restoreSelection()},toggleStyle:function(a,b){d.each(b,function(b,e){d(a).css(b)===e?d(a).css(b,""):d(a).css(b,e)})},getStyles:function(a){for(var b={},a=q.getComputedStyle(a[0],null),c=0;c<a.length;c++)b[a.item(c)]=a.getPropertyValue(a.item(c));return b},swapStyles:function(a,b,c){for(var d in c)a.css(d,
b.css(d)),b.css(d,c[d])},replaceSelection:function(a,b){this.eachRange(function(b){this.replaceRange(a,b)},b)},replaceRange:function(a,b){var c=d("<div></div>").append(a)[0].childNodes;b.deleteContents();c.length===u||1===c.length?b.insertNode(c[0].cloneNode(!0)):d.each(c,function(a,c){b.insertNodeAtEnd(c.cloneNode(!0))})},insertDomFragmentBefore:function(a,b,c){for(var e=0,g=a.childNodes.length;e<g;e++){var f=a.childNodes.item(e);(f=3===f.nodeType?f.nodeValue:d(f).html())&&d("<"+c+"/>").html(d.trim(f)).insertBefore(b)}},
...
c&&s(c);var c=d('<select autocomplete="off" name="i18n"/>'),e;for(e in o){var g=d('<option value="'+e+'" class="'+e+'"/>');g.html(i[e]);p===e&&g.attr("selected","selected");c.append(g)}return a.uiSelectMenu({title:f("Change Language"),select:c,change:function(a){s(b.persist("locale",a))}})}}});r("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!",
...
"{{sentences}} sentences":"{{sentences}} sentences","{{words}} word":"{{words}} word","{{words}} words":"{{words}} words"});r("zh_CN","\u7b80\u4f53\u4e2d\u6587",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"\u5e94\u7528\u6e90\u4ee3\u7801","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",
...
cache:!1}},init:function(a){this.options=d.extend(this.options,{resizingClass:this.options.baseClass+"-in-progress",resizeAjaxClass:this.options.baseClass+"-on-save"});a.bind("enabled",this.bind,this);this.resized=d.proxy(this.imageResized,this);var b=this;a.getElement().find("img").each(function(){this.addEventListener&&this.addEventListener("DOMAttrModified",b.resized,!1);this.attachEvent&&this.attachEvent("onpropertychange",b.resized)})},bind:function(){this.editor.bind("change",this.scanImages,
this);this.editor.bind("destroy",this.destroy,this);this.editor.bind("save",this.save,this);this.editor.bind("cancel",this.cancel,this)},imageResized:function(a){var b=d(a.target);b.is("img")&&b.attr("_moz_resizing")&&"style"==a.attrName&&a.newValue.match(/width|height/)&&(this.options.resizeAjax&&b.addClass(this.options.resizeAjaxClass),this.editor.fire("change"))},scanImages:function(){var a=this.editor.getElement(),b=[];d(a.find("img")).each(function(){(a.height()<d(this).outerHeight()||a.width()<
d(this).outerWidth())&&b.push(d(this))});b.length&&this.resizeImageElements(b,a.width(),a.height())},resizeImageElements:function(a,b,c){for(var e=d("<a>",{href:"",target:"_blank"}),g=0;g<a.length;g++){var f=a[g],m=f.outerWidth(),i=f.outerHeight(),k=Math.min(b/m,c/i),m=Math.abs(k*(m-(f.outerWidth()-f.width()))),i=Math.abs(k*(i-(f.outerHeight()-f.height())));f.addClass(this.options.resizingClass);e=e.html(f.attr("title")||f.attr("src").substr(f.attr("src").lastIndexOf("/")+1)).attr("href",f.attr("src"));
d(f).css({width:m,height:i}).attr("height",i).attr("width",m);this.options.resizeAjax&&f.addClass(this.options.resizeAjaxClass);var l=this;this.showOversizeWarning(this.editor.outerHtml(e),{hide:function(){f.removeClass(l.options.resizingClass)}})}},cancel:function(){this.removeClasses();this.editor.unbind("change",this.scanImages,this);var a=this;this.editor.getElement().find("img").each(function(){this.removeEventListener&&this.addEventListener("DOMAttrModified",a.resized,!1);this.detachEvent&&
this.detachEvent("onpropertychange",a.resized)})},destroy:function(){this.cancel()},save:function(){this.removeClasses(this.options.resizingClass);this.options.resizeAjax&&this.resizeImagesAjax()},resizeImagesAjax:function(){var a=this,b=[];d("."+this.options.resizeAjaxClass).each(function(){d(this).attr("id")||d(this).attr("id",a.editor.getUniqueId());b.push({id:d(this).attr("id"),src:this.src,width:d(this).width(),height:d(this).height()})});if(b.length){var c=this.editor.showLoading(f("Resizing image(s)")),
e=this.options.ajax;e.data={images:b};e.async=!1;d.ajax(e).done(function(e){d(e).each(function(){d("#"+this.id).attr("src",this.src).removeAttr("id")});a.editor.fire("change");c.hide();a.editor.showConfirm(f("{{images}} image(s) have been replaced with resized versions",{images:b.length}))}).fail(function(b){c.hide();a.editor.showError(f("Failed to resize images (error {{error}})",{error:b.status}))}).always(function(){a.removeClasses([a.options.resizeAjaxClass])})}},showOversizeWarning:function(a,
...
a[b]).removeClass(a[b])}});d.ui.editor.registerUi({length:{ui:null,options:{length:150},init:function(a){a.bind("show",d.proxy(this.updateCount,this));a.bind("change",d.proxy(this.updateCount,this));return this.ui=this.editor.uiButton({title:f("Remaining characters before the recommended character limit is reached"),label:f("Initializing"),text:!0,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var a=this.options.length-d("<div></div>").html(this.editor.getCleanHtml()).text().length,
b=this.ui.button,c=null,c=0<=a?f("{{charactersRemaining}} characters remaining",{charactersRemaining:a}):f("{{charactersRemaining}} characters over limit",{charactersRemaining:-1*a});b.button("option","label",c);b.button("option","text",!0);0>a?b.addClass("ui-state-error"):0<=a&&15>=a?b.addClass("ui-state-highlight").removeClass("ui-state-error"):b.removeClass("ui-state-highlight ui-state-error")},showStatistics:function(){this.processTemplate().dialog({modal:!0,resizable:!1,title:f("Content Statistics"),
dialogClass:this.editor.options.dialogClass+" "+this.editor.options.baseClass,show:this.editor.options.dialogShowAnimation,hide:this.editor.options.dialogHideAnimation,buttons:[{text:f("OK"),click:function(){d(this).dialog("close")}}],open:function(){d(this).parent().find(".ui-dialog-buttonpane").find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}})},close:function(){d(this).dialog("destroy").remove()}})},processTemplate:function(){var a=d("<div></div>").html(this.editor.getCleanHtml()).text(),
b=null,c=this.options.length-a.length,b=0>c?f("Content contains more than {{limit}} characters and may be truncated",{limit:this.options.length}):f("Content will not be truncated"),e=null,e=a.split(" ").length,e=1==e?f("{{words}} word",{words:e}):f("{{words}} words",{words:e}),g=null,g=a.split(". ").length,g=f("{{sentences}} sentences",{sentences:g}),h=null,h=0<=c?f("{{characters}} characters, {{charactersRemaining}} remaining",{characters:a.length,charactersRemaining:c}):f("{{characters}} characters, {{charactersRemaining}} over the recommended limit",
{characters:a.length,charactersRemaining:-1*c});return d(this.editor.getTemplate("length.dialog",{characters:h,words:e,sentences:g,truncation:b}))}}});d.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:f("Page on this or another website"),focusSelector:'input[name="location"]',init:function(){this.content=this.plugin.editor.getTemplate("link.external",this.options);return this},show:function(a,b){var c=this;a.find('input[name="location"]').bind("keyup",
...
q.setTimeout(function(){var h=d(".uiWidgetEditorPasteBin").html(),h=g.filterAttributes(h),h=g.filterChars(h),h=g.stripTags(h),h=g.stripEmpty(h),h={html:h,plain:d("<div/>").html(h).text(),markup:g.stripAttributes(h)};e=d(a.getTemplate("paste.dialog",h));e.find(".ui-editor-paste-area").bind("keyup."+a.widgetname,function(){g.updateAreas(this,e)});d(e).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:b.dialogShowAnimation,hide:b.dialogHideAnimation,dialogClass:b.baseClass+
" "+b.dialogClass,buttons:[{text:f("Insert"),click:function(){var b=null,b=d(this).find(".ui-editor-paste-area:visible"),b=b.hasClass("ui-editor-paste-plain")||b.hasClass("ui-editor-paste-source")?b.val():b.html(),b=g.filterAttributes(b),b=g.filterChars(b);a.restoreSelection();a.replaceSelection(b);c=!1;d(this).dialog("close")}},{text:f("Cancel"),click:function(){n.restoreSelection(selection);c=!1;d(this).dialog("close")}}],open:function(){var a=d(this).find(".ui-editor-paste-panel-tabs");a.find("ul li").click(function(){a.find("ul li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
...
{baseClass:a.options.baseClass}));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:f("View Source"),autoOpen:!0,dialogClass:a.options.baseClass+" "+a.options.dialogClass,buttons:[{text:f("Apply Source"),click:function(){var b;a.highlightSource()?(b=d(this).find("."+a.options.baseClass+"-highlighted pre code:first").html(),b=a.untidyHtml(b)):b=d(this).find("textarea").val();a.editor.setHtml(b);d(this).find("textarea").val(a.editor.getHtml())}},{text:f("Close"),click:function(){a.hide()}}],
open:function(){var b=d(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});a.prepareSource.call(a,this)},close:function(){a.hide()}})}}}})})(jQuery,window,rangy);
