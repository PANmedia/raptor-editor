...
*/
(function(c,l,i,I){function v(a,b,d){z[a]=d;P[a]=b;q||(q=a)}function Q(a){q!==a&&(q=a,c.ui.editor.eachInstance(function(){this.reinit()}))}function g(a,b){q&&z[q]&&z[q][a]&&(a=z[q][a]);if(!b)return a;for(var d in b)a=a.replace("{{"+d+"}}",b[d]);return a}function ba(a){if(D===I){D=!0;if(R=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))c("html").addClass(a.options.baseClass+"-ios"),R&&c(document).bind("scroll",function(){setInterval(function(){c("body").css("height","+=1").css("height",
...
function E(a){var b,a=document.createElement(a);b="getComputedStyle"in l;document.body.appendChild(a);b=(b?l.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return b}function F(a,b){return-1!==c.inArray(c(a)[0].tagName.toLowerCase(),b)}function S(a){for(var b={},a=l.getComputedStyle(a[0],null),d=0;d<a.length;d++)b[a.item(d)]=a.getPropertyValue(a.item(d));return b}function T(a,b){p();c(a).each(function(){var d=c("<"+b+"/>").html(c(this).html());a.html(d)});n()}function U(a,
b){c.each(b,function(b,e){c(a).css(b)===e?c(a).css(b,""):c(a).css(b,e)})}function u(a,b){for(var d="",e=0,f=a.childNodes.length;e<f;e++){var h=a.childNodes.item(e);(h=3===h.nodeType?h.nodeValue:o(c(h)))&&(d+=h)}b&&(d=c("<"+b+">"+d+"</"+b+">"),d.find("p").wrapInner("<"+b+"/>"),d.find("p > *").unwrap(),d=c("<div/>").html(d).html());return d}function V(a,b){var d=c("<div/>").append(a)[0].childNodes;b.deleteContents();d.length===I||1===d.length?b.insertNode(d[0].cloneNode(!0)):c.each(d,function(a,d){b.insertNodeAtEnd(d.cloneNode(!0))})}
function W(a){var a=a||i.getSelection(),b;c(a.getAllRanges()).each(function(a,e){b=3===this.commonAncestorContainer.nodeType?c(e.commonAncestorContainer).parent()[0]:e.commonAncestorContainer});return b}function X(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer}function p(a){if(!r||a)r=i.saveSelection()}function n(){r&&(i.restoreSelection(r),r=!1)}function G(){r&&i.removeMarkers(r);r=!1}function k(a,b,d){for(var b=b||i.getSelection(),c,f=0;c=b.getAllRanges()[f++];)a.call(d,
c)}function t(a,b){k(function(b){V(a,b)},b,this)}function A(a,b){b=b||i.getSelection();b.removeAllRanges();c(a).focus().contents().each(function(){var a=i.createRange();a.selectNodeContents(this);b.addRange(a)})}function w(a,b){b=b||i.getSelection();b.removeAllRanges();c(a).each(function(){var a=i.createRange();a.selectNode(this);b.addRange(a)}).focus()}function K(a,b,d){b=b||i.getSelection();b.removeAllRanges();c(a).each(function(){var a=i.createRange();a.selectNodeContents(this);a.collapse(d);b.addRange(a)})}
function Y(a,b){K(a,b,!1)}function x(a,b){K(a,b,!0)}function y(a){a=a||i.getSelection();return a.toHtml()}function Z(a){a=a||i.getSelection().getRangeAt(0);return c(3===a.commonAncestorContainer.nodeType?a.commonAncestorContainer.parentNode:a.commonAncestorContainer)}function j(a){var b=new jQuery;k(function(a){b.push(Z(a)[0])},a,this);return b}function L(){var a=i.getSelection();if(null===a.anchorNode)return null;if(a.isBackwards())return 3===a.focusNode.nodeType?c(a.focusNode.parentElement):c(a.focusNode);
a.anchorNode||console.trace();return 3===a.anchorNode.nodeType?c(a.anchorNode.parentElement):c(a.anchorNode)}function M(){var a=i.getSelection();return null===a.anchorNode?null:a.isBackwards()?3===a.anchorNode.nodeType?c(a.anchorNode.parentElement):c(a.anchorNode):3===a.focusNode.nodeType?c(a.focusNode.parentElement):c(a.focusNode)}function s(a,b){var b=b||{},d=i.createCssClassApplier(b.classes||"",{normalize:!0,elementTagName:a,elementProperties:b.attributes||{}});k(function(e){var f=e.cloneContents(),
f=u(f);"string"===typeof f&&(f=f.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));c(f).is(":empty")?(f=c("<"+a+"/>").addClass(b.classes).attr(b.attributes||{}).append(u(e.cloneContents())),V(f,e)):d.toggleRange(e)},null,this)}function ca(a,b,c){k(function(e){e=Z(e);e.is(a)?e.attr(b):s(a,{classes:c,attributes:b})},null,this)}function N(a,b){var b=b||i.getSelection(),d=b.getRangeAt(0),e=j()[0],f=i.createRange();f.setStartBefore(e);f.setEnd(d.startContainer,d.startOffset);var f=f.cloneContents(),
h=i.createRange();h.setStart(d.endContainer,d.endOffset);h.setEndAfter(e);d=h.cloneContents();f=o(c(u(f)));f+=o(c(a));f+=o(c(u(d)));c(e).replaceWith(c(f))}function B(a,b,c){var c=c||i.getSelection(),e=L()[0],f=M()[0],h=j()[0],h=F(h,b),e=F(e,b),b=F(f,b);h&&e&&b?t(a):N(a,c)}function C(a,b){k(function(d){for(d=c(d.commonAncestorContainer);d.length&&d[0]!==b[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===b[0]&&"inline"!==b.css("display")&&(T(b,"div"),d=b.children().first());
U(d,a)},null,this)}function $(a,b){a=c(a)[0];if(b=b||i?i.getSelection():null){var d;c(b.getAllRanges()).each(function(e,f){d=3===this.commonAncestorContainer.nodeType?c(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;a!==d&&!c.contains(a,d)&&b.removeRange(f)})}}function H(a,b){allowed=[];for(var c=0;c<b.length;c++)b[c].match(/[a-z][a-z0-9]{0,}/g)&&allowed.push(b[c]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,
b){return-1<allowed.indexOf(b.toLowerCase())?a:""})}var q=null,z={},P={};c(function(){i.initialized||i.init();c.isFunction(i.rangePrototype.insertNodeAtEnd)||(i.rangePrototype.insertNodeAtEnd=function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});c("html").click(function(){c(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});c.widget("ui.editor",{_init:function(){-1===c.inArray(this,c.ui.editor.instances)&&c.ui.editor.instances.push(this);
var a=this;this.options=c.extend({},c.ui.editor.defaults,this.options);this.options.uiOrder=this.options.uiOrder||[["logo"],["save","cancel"],["dock","showGuides","clean"],["viewSource"],["undo","redo"],["alignLeft","alignCenter","alignJustify","alignRight"],["textBold","textItalic","textUnderline","textStrike"],["textSuper","textSub"],["listUnordered","listOrdered"],["hr","quoteBlock"],["fontSizeInc","fontSizeDec"],["colorPickerBasic"],["clearFormatting"],["link","unlink"],["embed"],["floatLeft",
"floatNone","floatRight"],["tagMenu"],["i18n"],["raptorize"],["statistics"],["debugReinit","debugDestroy"]];this.element.attr("id")||this.element.attr("id",this.getUniqueId());this.ready=!1;this.events={};this.ui={};this.plugins={};this.templates=c.extend({},c.ui.editor.templates);this.path=this.toolbarWrapper=this.toolbar=this.wrapper=null;this.visible=this.enabled=!1;this.uiObjects={};this.hotkeys={};this.options.enableHotkeys&&this.registerHotkey(this.hotkeys);for(var b in this.options.bind)this.bind(b,
this.options.bind[b]);this.history=[];this.present=0;this.historyEnabled=!0;ba(this)&&(this.cloneDomTools(),this.setOriginalHtml(this.element.is(":input")?this.element.val():this.element.html()),this.element.is("textarea, input")&&this.replaceOriginal(),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,b=this.persist("locale")||this.options.initialLocale,Q(b),this.ready=!0,this.fire("ready"),this.options.autoEnable&&c(function(){a.enableEditing();a.showToolbar()}))},
...
e=this.options.domTools[a].apply(this.options.domTools,arguments);c!==this.getHtml()&&this.change();return e}}(a))},checkChange:function(){var a=i.serializeSelection();this.previousSelection!==a&&this.fire("selectionChange");this.previousSelection=a;var a=this.getCleanHtml(),b=this.dirty;this.dirty=this.getOriginalHtml()!==a;this.previousHtml!==a&&(this.previousHtml=a,this.change(),b!==this.dirty&&(this.dirty?this.fire("dirty"):this.fire("cleaned")))},change:function(){this.fire("change")},destruct:function(a){a||
...
h;f++)if(this.uiEnabled(d[f])){var g=d[f].replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});if(c.ui.editor.ui[d[f]]){var m=c.extend({},c.ui.editor.ui[d[f]]),g=c.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-ui-"+g},m.options,this.options.ui[d[f]]);m.editor=this;m.options=g;m.ui=m.init(this,g);m.hotkeys&&(this.registerHotkey(m.hotkeys,null,m),m.ui.title+=" ("+c.map(m.hotkeys,function(a,b){return b})[0]+")");m.ui.init(d[f],this,g,m).appendTo(e);this.uiObjects[d[f]]=m}}e.addClass("ui-buttonset").addClass(this.options.baseClass+
...
a).attr("title",this.title).val(a);e.classes&&this.button.addClass(e.classes);this.button.bind("mousedown."+f.editor.widgetName,function(a){a.preventDefault()});var O=this;this.button.bind("mouseup."+f.editor.widgetName,function(a){a.preventDefault();O.click.apply(f,arguments);d.checkChange()});d.bind("destroy",c.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+h},disabled:e.disabled?!0:!1,text:this.text||!1,label:this.label||
...
b){a.children().each(function(){var a=c.map(this.attributes,function(a){if(-1===c.inArray(a.name,b))return a.name}),e=c(this);c.each(a,function(a,b){e.removeAttr(b)});element.removeAttributes(c(this),b)});return a},elementBringToTop:J,elementOuterHtml:o,elementOuterText:function(a){return a.clone().wrap("<div/>").parent().text()},elementIsBlock:function(a){return"block"===E(a.tagName)},elementDefaultDisplay:E,elementIsValid:F,elementGetStyles:S,elementWrapInner:T,elementToggleStyle:U,elementSwapStyles:function(a,
b,c){for(var e in c)a.css(e,b.css(e)),b.css(e,c[e])},fragmentToHtml:u,fragmentInsertBefore:function(a,b,d){for(var e=0,f=a.childNodes.length;e<f;e++){var h=a.childNodes.item(e);(h=3===h.nodeType?h.nodeValue:c(h).html())&&c("<"+d+"/>").html(c.trim(h)).insertBefore(b)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},rangeGetCommonAncestor:W,rangeIsEmpty:X,selectionSave:p,selectionRestore:n,selectionDestroy:G,selectionEachRange:k,selectionReplace:t,
selectionSelectInner:A,selectionSelectOuter:w,selectionSelectEdge:K,selectionSelectEnd:Y,selectionSelectStart:x,selectionGetHtml:y,selectionGetElements:j,selectionToggleWrapper:s,selectionExists:function(a){var b=!1;k(function(a){X(a)||(b=!0)},a,this);return b},selectionReplaceSplittingSelectedElement:N,selectionReplaceWithinValidTags:B,selectionToggleBlockStyle:C,stringStripTags:H,defaults:{plugins:{},ui:{},bind:{},domTools:{unwrapParentTag:function(a){j().each(function(){c(this).is(a)&&c(this).replaceWith(c(this).html())})},
execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(e){}},insertTag:function(a,b){k(function(b){b.insertNode(c("<"+a+"/>")[0])},b,this)},insertTagAtEnd:function(a,b){k(function(b){b.insertNodeAtEnd(c("<"+a+"/>")[0])},b,this)},insertElement:function(a,b,d){k(function(d){c(a).each(function(){d.insertNode(!1===b?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(a,b,d){k(function(d){c(a).each(function(){d.insertNodeAtEnd(!1===b?this:this.cloneNode(!0))})},d,this)},inverseWrapWithTagClass:function(a,
b,d,e){p();var f="domTools"+Math.ceil(1E7*Math.random());k(function(a){var c=i.createCssClassApplier(e,{elementTagName:d});c.isAppliedToRange(a)?c.toggleSelection():i.createCssClassApplier(b,{elementTagName:f}).toggleSelection()},null,this);c(f).each(function(){c(this).replaceWith(c("<"+a+"/>").addClass(b).html(c(this).html()))});n()}},namespace:null,unify:!0,persistence:!0,persistenceName:"uiEditor",unloadWarning:!0,autoEnable:!1,partialEdit:!1,enablePlugins:!0,disabledPlugins:[],uiOrder:null,enableUi:!0,
...
this.ui.enable()}}});c.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:g("Insert Horizontal Rule"),click:function(){t("<hr/>")}})}}});c.ui.editor.registerUi({i18n:{init:function(a){var b=this,d=c('<select autocomplete="off" name="i18n"/>'),e;for(e in z){var f=c('<option value="'+e+'" class="'+e+'"/>');f.html(P[e]);q===e&&f.attr("selected","selected");d.append(f)}return a.uiSelectMenu({title:g("Change Language"),select:d,change:function(a){Q(b.persist("locale",a))}})}}});v("de",
...
d=b.attributes(this.dialog.find("."+this.options.baseClass+"-content"),a);if(!d)return!0;n();var e=o(c("<a>"+(d.title?d.title:d.href)+"</a>").attr(c.extend({},d,{target:"_blank"})));a?(this.selectedElement[0].className=this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(b.classes).attr(d),this.editor.showConfirm(g("Updated link: {{link}}",{link:e}))):(ca("a",c.extend(d,{id:this.editor.getUniqueId()}),b.classes),this.editor.showConfirm(g("Added link: {{link}}",
