/*! VERSION: 0.0.7 */(function(c){c.fn.raptorize=function(j){j=c.extend({enterOn:"click",delayTime:5E3},j);return this.each(function(){function i(){o=!0;m&&document.getElementById("elRaptorShriek").play();f.animate({bottom:"0"},function(){c(this).animate({bottom:"-30px"},100,function(){var i=c(this).position().left+400;c(this).delay(300).animate({right:i},2200,function(){f=c("#elRaptor").css({bottom:"-700px",right:"0"});o=!1})})})}var p=c(this),m=!1;if(c.browser.mozilla&&"1.9.2"<=c.browser.version.substr(0,5)||c.browser.webkit)m=
...
(function(c,j,i,p){function m(a,b,d){q[a]=d;t[a]=b;l||(l=a)}function o(a){l!==a&&(l=a,c.ui.editor.eachInstance(function(){this.reinit()}))}function f(a,b){l&&q[l]&&q[l][a]&&(a=q[l][a]);if(!b)return a;for(var d in b)a=a.replace("{{"+d+"}}",b[d]);return a}function r(a){if(s===p){s=!0;if(u=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))c("html").addClass(a.options.baseClass+"-ios"),u&&c(document).bind("scroll",function(){setInterval(function(){c("body").css("height","+=1").css("height",
"-=1")},0)});c.browser.mozilla&&c("html").addClass(a.options.baseClass+"-ff");if(c.browser.msie&&9>c.browser.version){s=!1;var b=c("<div></div>").addClass(a.options.baseClass+"-unsupported").html(a.getTemplate("unsupported")).appendTo("body"),d=1;b.siblings().each(function(){var a=c(this).css("z-index");!isNaN(a)&&a>d&&(d=a+1)});b.css("z-index",d);b.find("."+a.options.baseClass+"-unsupported-close").click(function(){b.remove()})}}return s}var l=null,q={},t={};c(function(){i.initialized||i.init();
...
save:function(){var a=this.getCleanHtml();this.fire("save");this.setOriginalHtml(a);this.fire("saved");this.fire("change");return a},setOriginalHtml:function(a){this.originalHtml=a},bind:function(a,b,d){var e=this.events;c.each(a.split(","),function(a,h){h=c.trim(h);e[h]||(e[h]=[]);e[h].push({context:d,callback:b})})},unbind:function(a,b,c){for(var e=0,g=this.events[a].length;e<g;e++)this.events[a][e]&&this.events[a][e].callback===b&&this.events[a][e].context===c&&this.events[a].splice(e,1)},fire:function(a,
...
b,c){for(var b=b||i.getSelection(),c=c||this,e,g=0;e=b.getAllRanges()[g++];)a.call(c,e)},constrainSelection:function(a,b){var a=c(a)[0],b=b||i.getSelection(),d;c(b.getAllRanges()).each(function(e,g){d=3===this.commonAncestorContainer.nodeType?c(g.commonAncestorContainer).parent()[0]:g.commonAncestorContainer;a!==d&&!c.contains(a,d)&&b.removeRange(g)})},getSelectedElements:function(){var a=new jQuery;this.eachRange(function(b){a.push(this.getSelectedElement(b)[0])});return a},getSelectedElement:function(a){a=
a||i.getSelection().getRangeAt(0);return c(3===a.commonAncestorContainer.nodeType?a.commonAncestorContainer.parentNode:a.commonAncestorContainer)},getSelectedHtml:function(a){a=a||i.getSelection();return a.toHtml()},getSelectionStartElement:function(){var a=i.getSelection();return a.isBackwards()?3===a.focusNode.nodeType?c(a.focusNode.parentElement):c(a.focusNode):3===a.anchorNode.nodeType?c(a.anchorNode.parentElement):c(a.anchorNode)},getSelectionEndElement:function(){var a=i.getSelection();return a.isBackwards()?
3===a.anchorNode.nodeType?c(a.anchorNode.parentElement):c(a.anchorNode):3===a.focusNode.nodeType?c(a.focusNode.parentElement):c(a.focusNode)},unwrapParentTag:function(a){this.getSelectedElements().each(function(){c(this).is(a)&&c(this).replaceWith(c(this).html())})},wrapTagWithAttribute:function(a,b,c){this.eachRange(function(e){e=this.getSelectedElement(e);e.is(a)?e.attr(b):this.toggleWrapper(a,{classes:c,attributes:b})})},selectInner:function(a,b){b=b||i.getSelection();b.removeAllRanges();c(a).focus().contents().each(function(){var a=
...
b.css(e)),b.css(e,c[e])},replaceSelectionWithinValidTags:function(a,b,c){var c=c||i.getSelection(),e=this.getSelectionStartElement()[0],g=this.getSelectionEndElement()[0],h=this.isElementValid(this.getSelectedElements()[0],b),e=this.isElementValid(e,b),b=this.isElementValid(g,b);h&&e&&b?this.replaceSelection(a):this.replaceSelectionSplittingSelectedElement(a,c)},replaceSelectionSplittingSelectedElement:function(a,b){var b=b||i.getSelection(),d=b.getRangeAt(0),e=this.getSelectedElements()[0],g=i.createRange();
g.setStartBefore(e);g.setEnd(d.startContainer,d.startOffset);var g=g.cloneContents(),h=i.createRange();h.setStart(d.endContainer,d.endOffset);h.setEndAfter(e);d=h.cloneContents();g=this.outerHtml(c(this.domFragmentToHtml(g)));g+=this.outerHtml(c(a));g+=this.outerHtml(c(this.domFragmentToHtml(d)));c(e).replaceWith(c(g))},replaceSelection:function(a,b){this.eachRange(function(b){this.replaceRange(a,b)},b)},replaceRange:function(a,b){var d=c("<div></div>").append(a)[0].childNodes;b.deleteContents();
d.length===p||1===d.length?b.insertNode(d[0].cloneNode(!0)):c.each(d,function(a,c){b.insertNodeAtEnd(c.cloneNode(!0))})},insertDomFragmentBefore:function(a,b,d){for(var e=0,g=a.childNodes.length;e<g;e++){var h=a.childNodes.item(e);(h=3===h.nodeType?h.nodeValue:c(h).html())&&c("<"+d+"/>").html(c.trim(h)).insertBefore(b)}},domFragmentToHtml:function(a,b){for(var d="",e=0,g=a.childNodes.length;e<g;e++){var h=a.childNodes.item(e);(h=3===h.nodeType?h.nodeValue:this.outerHtml(h))&&(d+=h)}b&&(d=c("<"+b+
...
this,d=this.persist("locale");d&&o(d);var d=c('<select autocomplete="off" name="i18n"/>'),e;for(e in q){var g=c('<option value="'+e+'" class="'+e+'"/>');g.html(t[e]);l===e&&g.attr("selected","selected");d.append(g)}return a.uiSelectMenu({title:f("Change Language"),select:d,change:function(a){o(b.persist("locale",a))}})}}});m("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}",
...
"{{sentences}} sentences":"{{sentences}} sentences","{{words}} word":"{{words}} word","{{words}} words":"{{words}} words"});m("fr","Fran\u00e7ais",{"A preview of your embedded object is displayed below.":"Un aper\u00e7u de votre objet int\u00e9gr\u00e9 est affich\u00e9 ci-dessous.","Added link: {{link}}":"Lien ajout\u00e9 : {{link}}","All changes will be lost!":"Toutes les modifications seront perdues !","Apply Source":"Appliquer la source","Are you sure you want to stop editing?":"\u00cates-vous s\u00fbr(e) de vouloir arr\u00eater la modification ?",
...
c(this).outerWidth())&&b.push(c(this))});b.length&&this.resizeOversizedImages(b,a.width(),a.height())},resizeOversizedImages:function(a,b,d){for(var e=c("<a>",{href:"",target:"_blank"}),g=0;g<a.length;g++){var f=a[g],k=f.outerWidth(),i=f.outerHeight(),j=Math.min(b/k,d/i),k=Math.abs(j*(k-(f.outerWidth()-f.width()))),i=Math.abs(j*(i-(f.outerHeight()-f.height())));f.addClass(this.options.resizingClass);e=e.html(f.attr("title")||f.attr("src").substr(f.attr("src").lastIndexOf("/")+1)).attr("href",f.attr("src"));
c(f).css({width:k,height:i}).attr("height",i).attr("width",k);this.options.resizeAjax&&f.addClass(this.options.resizeAjaxClass);var v=this;this.showOversizeWarning(this.editor.outerHtml(e),{hide:function(){f.removeClass(v.options.resizingClass)}})}},cancel:function(){this.removeClasses();this.removeToolsButtons();this.unbind()},save:function(){this.removeClasses(this.options.resizingClass);this.options.resizeAjax&&this.resizeImagesAjax();this.removeToolsButtons();this.unbind()},resizeImagesAjax:function(){var a=
this,b=[];c("."+this.options.resizeAjaxClass).each(function(){c(this).attr("id")||c(this).attr("id",a.editor.getUniqueId());b.push({id:c(this).attr("id"),src:this.src,width:c(this).width(),height:c(this).height()})});if(b.length){var d=this.editor.showLoading(f("Resizing image(s)")),e=this.options.ajax;e.data={images:b};e.async=!1;c.ajax(e).done(function(e){c(e).each(function(){c("#"+this.id).attr("src",this.src).removeAttr("id")});a.editor.fire("change");d.hide();a.editor.showConfirm(f("{{images}} image(s) have been replaced with resized versions",
...
h=this,k=function(){c(a).css({width:Math.round(c(e).val())+"px",height:Math.round(c(g).val())+"px"})};c(this.editor.getTemplate("imageresize.manually-resize-image",{width:b,height:d,baseClass:this.options.baseClass})).dialog({modal:!0,resizable:!1,title:f("Modify Image Size"),buttons:[{text:f("Resize Image"),click:function(){k();c(this).dialog("close")}},{text:f("Cancel"),click:function(){c(this).dialog("close")}}],close:function(){h.editor.fire("change")},open:function(){var a=c(this).find(e),f=
c(this).find(g);a.keyup(function(){f.val(Math.round(Math.abs(d/b*c(this).val())));k()});f.keyup(function(){a.val(Math.round(Math.abs(b/d*c(this).val())));k()})}}).dialog("open")},displayToolsButtonRelativeToImage:function(a){var b=c("<button/>").appendTo("body").addClass(this.options.resizeButtonClass).button({text:!1,icons:{primary:"ui-icon-tools"}});b.css({position:"absolute",left:c(a).innerWidth()-c(b).outerWidth()-20+"px",marginTop:"20px"}).click(c.proxy(this.manuallyResizeImage,this));c(a).before(b)},
...
init:function(a){a.bind("show",c.proxy(this.updateCount,this));a.bind("change",c.proxy(this.updateCount,this));return this.ui=this.editor.uiButton({title:f("Remaining characters before the recommended character limit is reached"),label:f("Initializing"),text:!0,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var a=this.options.length-c("<div></div>").html(this.editor.getCleanHtml()).text().length,b=this.ui.button,d=null,d=0<=a?f("{{charactersRemaining}} characters remaining",
...
(a=e.types[d.filter(":checked").val()],(!c.isFunction(a.validate)||a.validate(e.dialog.find("."+e.options.baseClass+"-content")))&&b.find("button:eq(0)").trigger("click"))})},close:function(){e.visible=!1;g.find("."+b.baseClass+"-content").hide();c(this).dialog("destroy")}}).dialog("open")}},apply:function(a){var b=this.types[this.dialog.find('input[type="radio"]:checked').val()],d=b.attributes(this.dialog.find("."+this.options.baseClass+"-content"),a);if(!d)return!0;var e=this.editor.outerHtml(c("<a>"+
(d.title?d.title:d.href)+"</a>").attr(c.extend({},d,{target:"_blank"})));a?(this.selectedElement[0].className=this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(b.classes).attr(d),this.editor.showConfirm(f("Updated link: {{link}}",{link:e}))):(this.editor.wrapTagWithAttribute("a",c.extend(d,{id:this.editor.getUniqueId()}),b.classes),this.editor.showConfirm(f("Added link: {{link}}",{link:e})),this.selectedElement=c("#"+d.id).removeAttr("id"));
...
(a[b]="<p>"+a[b]+"</p>");g&&e?(this.editor.selectOuter(d),this.editor.replaceSelection(a.join(""))):(g?c(d).before(a.join("")):e?c(d).after(a.join("")):this.editor.replaceSelectionSplittingSelectedElement(a.join("")),this.editor.restoreSelection())},wrapList:function(a){var b=c("<div>").html(this.editor.getSelectedHtml()),d=[],e=this;c(b).contents().each(function(){var a;a="block"===e.getElementDefaultDisplay(this.tagName)?e.editor.stripTags(c(this).html(),e.validChildren):e.editor.stripTags(e.editor.outerHtml(c(this)),
e.validChildren);a=c("<li>"+a+"</li>");""!==c.trim(a.text())&&d.push(e.editor.outerHtml(a))});d.length||d.push("<li>List element content</li>");b=this.options.baseClass+"-selection";a="<"+a+' class="'+b+'">'+d.join("")+"</"+a+">";this.editor.restoreSelection();this.editor.replaceSelectionWithinValidTags(a,this.validParents);this.editor.selectInner(c(this.editor.getElement().find("."+b).removeClass(b)).find("li:first")[0])},getElementDefaultDisplay:function(a){var b,a=document.createElement(a);b="getComputedStyle"in
j;document.body.appendChild(a);b=(b?j.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return b}});c.ui.editor.registerUi({listUnordered:{init:function(a){return a.uiButton({title:f("Unordered List"),click:function(){a.getPlugin("list").toggleList("ul")}})}},listOrdered:{init:function(a){return a.uiButton({title:f("Ordered List"),click:function(){a.getPlugin("list").toggleList("ol")}})}}});c.ui.editor.registerUi({logo:{ui:null,init:function(){return this.ui=this.editor.uiButton({title:f("Learn More About the Raptor WYSIWYG Editor"),
click:function(){j.open("http://www.jquery-raptor.com/about/editors/","_blank")},ready:function(){var a=function(b){var d=typeof b;if("object"!=d||null===b)return"string"==d&&(b='"'+b+'"'),""+b;var e=[],f=b&&c.isArray(b);c.each(b,function(b,c){d=typeof c;"string"==d?c='"'+c+'"':"object"==d&null!==c&&(c=a(c));e.push((f?"":'"'+b+'":')+(""+c))});return(f?"[":"{")+(""+e)+(f?"]":"}")},b={enableUi:this.options.enableUi,enablePlugins:this.options.enablePlugins,disabledPlugins:a(this.options.disabledPlugins),
ui:a(this.options.ui),t:(new Date).getTime()},d=[],e;for(e in b)d.push(e+"="+encodeURIComponent(b[e]));this.ui.button.find(".ui-button-icon-primary").css({"background-image":"url(http://www.jquery-raptor.com/logo/0.0.7?"+d.join("&")+")"})}})}}});c.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span".split(",")},init:function(a,b){var d=!1,e=!1,g=this;a.getElement().bind("paste."+a.widgetName,c.proxy(function(){if(d)return!1;d=!0;a.saveSelection();
c(".uiWidgetEditorPasteBin").length&&c(".uiWidgetEditorPasteBin").remove();c('<div class="uiWidgetEditorPasteBin" contenteditable="true" style="width: 1px; height: 1px; overflow: hidden; position: fixed; top: -1px;" />').appendTo("body");c(".uiWidgetEditorPasteBin").focus();j.setTimeout(function(){var h=c(".uiWidgetEditorPasteBin").html(),h=g.filterAttributes(h),h=g.filterChars(h),h=g.editor.stripTags(h,g.options.allowedTags),h=g.stripEmpty(h),h={html:h,plain:c("<div/>").html(h).text(),markup:g.stripAttributes(h)};
e=c(a.getTemplate("paste.dialog",h));e.find(".ui-editor-paste-area").bind("keyup."+a.widgetname,function(){g.updateAreas(this,e)});c(e).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:b.dialogShowAnimation,hide:b.dialogHideAnimation,dialogClass:b.baseClass+" "+b.dialogClass,buttons:[{text:f("Insert"),click:function(){var b=null,b=c(this).find(".ui-editor-paste-area:visible"),b=b.hasClass("ui-editor-paste-plain")||b.hasClass("ui-editor-paste-source")?b.val():
