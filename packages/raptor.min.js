...
var f=c("#elRaptor").css({position:"fixed",bottom:"-700px",right:"0",display:"block"});if("timer"==j.enterOn)setTimeout(i,j.delayTime);else if("click"==j.enterOn)p.bind("click",function(c){c.preventDefault();o||i()});else if("konami-code"==j.enterOn){var r=[];c(window).bind("keydown.raptorz",function(f){r.push(f.keyCode);0<=r.toString().indexOf("38,38,40,40,37,39,37,39,66,65")&&(i(),c(window).unbind("keydown.raptorz"))},!0)}})}})(jQuery);
(function(c,j,i,p){function n(a,b,d){q[a]=d;t[a]=b;m||(m=a)}function o(a){m!==a&&(m=a,c.ui.editor.eachInstance(function(){this.reinit()}))}function f(a,b){m&&q[m]&&q[m][a]&&(a=q[m][a]);if(!b)return a;for(var d in b)a=a.replace("{{"+d+"}}",b[d]);return a}function r(a){if(s===p){s=!0;if(u=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))c("html").addClass(a.options.baseClass+"-ios"),u&&c(document).bind("scroll",function(){setInterval(function(){c("body").css("height","+=1").css("height",
"-=1")},0)});c.browser.mozilla&&c("html").addClass(a.options.baseClass+"-ff");if(c.browser.msie&&9>c.browser.version){s=!1;var b=c("<div></div>").addClass(a.options.baseClass+"-unsupported").html(a.getTemplate("unsupported")).appendTo("body"),d=1;b.siblings().each(function(){var a=c(this).css("z-index");!isNaN(a)&&a>d&&(d=a+1)});b.css("z-index",d);b.find("."+a.options.baseClass+"-unsupported-close").click(function(){b.remove()})}}return s}var m=null,q={},t={};c(function(){i.initialized||i.init();
c.isFunction(i.rangePrototype.insertNodeAtEnd)||(i.rangePrototype.insertNodeAtEnd=function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});c("html").click(function(){c(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});c.widget("ui.editor",{_init:function(){-1===c.inArray(this,c.ui.editor.instances)&&c.ui.editor.instances.push(this);var a=this;c.ui.editor.eachInstance(function(b){a!=b&&a.element.closest(b.element).length&&handleError("Nesting editors is unsupported",
...
!1,!1),document.execCommand("styleWithCSS",!0,!0)}catch(a){}this.fire("enabled");this.fire("resize")}},disableEditing:function(){this.enabled&&(this.enabled=!1,this.getElement().attr("contenteditable",!1).removeClass(this.options.baseClass+"-editing"),this.fire("disabled"))},isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var a=this,b="",d=[],e=0;this.eachRange(function(g){var g=g.commonAncestorContainer,h;h=3===g.nodeType?c(g).parent():c(g);g=[];for(d.push(g);h[0]&&
...
a).attr("title",this.title).val(a);e.classes&&this.button.addClass(e.classes);this.button.bind("mousedown."+g.editor.widgetName,function(a){a.preventDefault()});var k=this;this.button.bind("mouseup."+g.editor.widgetName,function(a){a.preventDefault();k.click.apply(g,arguments)});d.bind("destroy",c.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+h},disabled:e.disabled?!0:!1,text:this.text||!1,label:this.label||null});this.ready.call(g);
...
b,d){d||this.fire("before:"+a,b,!0);if(this.events[a])for(var e=0,g=this.events[a].length;e<g;e++){var h=this.events[a][e];h.callback.call(h.context||this)}!1!==b&&c.ui.editor.fire(a);d||this.fire("after:"+a,b,!0)}});c.extend(c.ui.editor,{defaults:{plugins:{},ui:{},bind:{},domTools:{savedSelection:!1,saveSelection:function(){this.savedSelection=i.saveSelection()},restoreSelection:function(){this.savedSelection&&(i.restoreSelection(this.savedSelection),this.savedSelection=!1)},eachRange:function(a,
b,d){for(var b=b||i.getSelection(),d=d||this,c,g=0;c=b.getAllRanges()[g++];)a.call(d,c)},constrainSelection:function(a,b){var a=c(a)[0],b=b||i.getSelection(),d;c(b.getAllRanges()).each(function(e,g){d=3===this.commonAncestorContainer.nodeType?c(g.commonAncestorContainer).parent()[0]:g.commonAncestorContainer;a!==d&&!c.contains(a,d)&&b.removeRange(g)})},getSelectedElements:function(){var a=new jQuery;this.eachRange(function(b){a.push(this.getSelectedElement(b)[0])});return a},getSelectedElement:function(a){return c(3===
a.commonAncestorContainer.nodeType?a.commonAncestorContainer.parentNode:a.commonAncestorContainer)},unwrapParentTag:function(a){this.getSelectedElements().each(function(){c(this).is(a)&&c(this).replaceWith(c(this).html())})},wrapTagWithAttribute:function(a,b,d){this.eachRange(function(c){c=this.getSelectedElement(c);c.is(a)?c.attr(b):this.toggleWrapper(a,{classes:d,attributes:b})})},selectInner:function(a,b){b=b||i.getSelection();b.removeAllRanges();c(a).focus().contents().each(function(){var a=i.createRange();
a.selectNodeContents(this);b.addRange(a)})},selectOuter:function(a,b){b=b||i.getSelection();b.removeAllRanges();c(a).each(function(){var a=i.createRange();a.selectNode(this);b.addRange(a)}).focus()},selectEnd:function(a,b){b=b||i.getSelection();b.removeAllRanges();c(a).each(function(){var a=i.createRange();a.selectNodeContents(this);a.collapse();b.addRange(a)})},toggleWrapper:function(a,b){var b=b||{},d=i.createCssClassApplier(b.classes||"",{normalize:!0,elementTagName:a,elementProperties:b.attributes||
...
d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===b[0]&&"inline"!==b.css("display")&&(this.wrapInner(b,"div"),d=b.children().first());this.toggleStyle(d,a)})},wrapInner:function(a,b){this.saveSelection();c(a).each(function(){var d=c("<"+b+"/>").html(c(this).html());a.html(d)});this.restoreSelection()},inverseWrapWithTagClass:function(a,b,d,e){this.saveSelection();var g="domTools"+Math.ceil(1E7*Math.random());this.eachRange(function(a){var c=i.createCssClassApplier(e,{elementTagName:d});
c.isAppliedToRange(a)?c.toggleSelection():i.createCssClassApplier(b,{elementTagName:g}).toggleSelection()});c(g).each(function(){c(this).replaceWith(c("<"+a+"/>").addClass(b).html(c(this).html()))});this.restoreSelection()},toggleStyle:function(a,b){c.each(b,function(b,e){c(a).css(b)===e?c(a).css(b,""):c(a).css(b,e)})},getStyles:function(a){for(var b={},a=j.getComputedStyle(a[0],null),c=0;c<a.length;c++)b[a.item(c)]=a.getPropertyValue(a.item(c));return b},swapStyles:function(a,b,c){for(var e in c)a.css(e,
b.css(e)),b.css(e,c[e])},replaceSelection:function(a,b){this.eachRange(function(b){this.replaceRange(a,b)},b)},replaceRange:function(a,b){var d=c("<div></div>").append(a)[0].childNodes;b.deleteContents();d.length===p||1===d.length?b.insertNode(d[0].cloneNode(!0)):c.each(d,function(a,c){b.insertNodeAtEnd(c.cloneNode(!0))})},insertDomFragmentBefore:function(a,b,d){for(var e=0,g=a.childNodes.length;e<g;e++){var h=a.childNodes.item(e);(h=3===h.nodeType?h.nodeValue:c(h).html())&&c("<"+d+"/>").html(c.trim(h)).insertBefore(b)}},
domFragmentToHtml:function(a,b){for(var d="",e=0,g=a.childNodes.length;e<g;e++){var h=a.childNodes.item(e);(h=3===h.nodeType?h.nodeValue:this.outerHtml(h))&&(d+=h)}b&&(d=c("<"+b+">"+d+"</"+b+">"),d.find("p").wrapInner("<"+b+"/>"),d.find("p > *").unwrap(),d=c("<div></div>").html(d).html());return d},selectionExists:function(a){var b=!1;this.eachRange(function(a){this.isEmpty(a)||(b=!0)},a);return b},isEmpty:function(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer},expandToParent:function(a){a.setStartBefore(a.startContainer);
a.setEndAfter(a.endContainer)},changeTag:function(a,b){this.insertDomFragmentBefore(a.extractContents(),a.startContainer,b);c(a.startContainer).remove()},tagSelection:function(a,b){this.tagSelectionWithin(a,null,b)},tagSelectionWithin:function(a,b,d){this.eachRange(function(d){this.isEmpty(d)?(this.expandToParent(d),b=c(b)[0],"undefined"!==typeof b&&d.startContainer===b&&d.endContainer===b?this.wrapInner(c(b),a):this.changeTag(d,a)):this.replaceRange(this.domFragmentToHtml(d.extractContents(),a),
d)},d)},outerHtml:function(a){return c(a).clone().wrap("<div></div>").parent().html()}},namespace:null,unify:!0,persistence:!0,persistenceName:"uiEditor",unloadWarning:!0,autoEnable:!1,partialEdit:!1,enablePlugins:!0,disabledPlugins:[],uiOrder:null,enableUi:!0,disabledUi:[],message:{delay:5E3},replace:!1,replaceStyle:"display,position,float,width,padding-left,padding-right,padding-top,padding-bottom,margin-left,margin-right,margin-top,margin-bottom".split(","),baseClass:"ui-editor",cssPrefix:"cms-",
...
d&&o(d);var d=c('<select autocomplete="off" name="i18n"/>'),e;for(e in q){var g=c('<option value="'+e+'" class="'+e+'"/>');g.html(t[e]);m===e&&g.attr("selected","selected");d.append(g)}return a.uiSelectMenu({title:f("Change Language"),select:d,change:function(a){o(b.persist("locale",a))}})}}});n("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!",
...
"{{sentences}} sentences":"{{sentences}} sentences","{{words}} word":"{{words}} word","{{words}} words":"{{words}} words"});n("fr","Fran\u00e7ais",{"A preview of your embedded object is displayed below.":"Un aper\u00e7u de votre objet int\u00e9gr\u00e9 est affich\u00e9 ci-dessous.","Added link: {{link}}":"Lien ajout\u00e9 : {{link}}","All changes will be lost!":"Toutes les modifications seront perdues !","Apply Source":"Appliquer la source","Are you sure you want to stop editing?":"\u00cates-vous s\u00fbr(e) de vouloir arr\u00eater la modification ?",
...
c(this).outerWidth())&&b.push(c(this))});b.length&&this.resizeImageElements(b,a.width(),a.height())},resizeImageElements:function(a,b,d){for(var e=c("<a>",{href:"",target:"_blank"}),g=0;g<a.length;g++){var f=a[g],k=f.outerWidth(),l=f.outerHeight(),i=Math.min(b/k,d/l),k=Math.abs(i*(k-(f.outerWidth()-f.width()))),l=Math.abs(i*(l-(f.outerHeight()-f.height())));f.addClass(this.options.resizingClass);e=e.html(f.attr("title")||f.attr("src").substr(f.attr("src").lastIndexOf("/")+1)).attr("href",f.attr("src"));
c(f).css({width:k,height:l}).attr("height",l).attr("width",k);this.options.resizeAjax&&f.addClass(this.options.resizeAjaxClass);var j=this;this.showOversizeWarning(this.editor.outerHtml(e),{hide:function(){f.removeClass(j.options.resizingClass)}})}},cancel:function(){this.removeClasses();this.editor.unbind("change",this.scanImages,this);var a=this;this.editor.getElement().find("img").each(function(){this.removeEventListener&&this.addEventListener("DOMAttrModified",a.resized,!1);this.detachEvent&&
...
{link:e})),this.selectedElement=c("#"+d.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",d.href);return!0},typeChange:function(a,b){var d=this.dialog.find("."+this.options.baseClass+"-content"),e=d.closest("."+this.options.baseClass+"-wrap"),f=a.ajaxUri&&!this.types[a.type].content;f&&e.addClass(this.options.baseClass+"-loading");var h=this;d.hide(this.options.panelAnimation,function(){f?c.ajax({url:a.ajaxUri,type:"get",success:function(f){d.html(f);h.types[a.type].content=
f;e.removeClass(h.options.baseClass+"-loading");a.show(d,b);d.show(h.options.panelAnimation,c.proxy(a.focus,a))}}):(d.html(a.content),a.show(d,b),d.show(h.options.panelAnimation,c.proxy(a.focus,a)))})},remove:function(){this.editor.unwrapParentTag("a")},repairLinks:function(){var a=this;this.editor.getElement().find('a[class^="'+this.options.baseClass+'"]').each(function(){c(this).data(a.options.baseClass+"-href")&&c(this).attr("href",c(this).data(a.options.baseClass+"-href"))})},cancel:function(){this.dialog&&
...
" ")},stripAttributes:function(a){a=c("<div/>").html(a);c(a.find("*")).each(function(){var a=c.map(this.attributes,function(a){return a.name}),d=c(this);c.each(a,function(a,b){try{d.removeAttr(b)}catch(c){}})});return a.html()},stripTags:function(a){allowed=(((this.options.allowedTags||"")+"").toLowerCase().match(/<[a-z][a-z0-9]*>/g)||[]).join("");return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*>/gi,function(a,c){return-1<allowed.indexOf("<"+c.toLowerCase()+
">")?a:""})},stripEmpty:function(a){a=c("<div/>").html(a);a.find("*").filter(function(){return""===c.trim(c(this).text())}).remove();return a.html()},updateAreas:function(a,b){var d=b.find('.ui-editor-paste-synchronize-text input[type="checkbox"]'),e=c(a).is("textarea")?c(a).val():c(a).html();d.attr("checked")&&(c(a).hasClass("ui-editor-paste-plain")||b.find(".ui-editor-paste-plain").val(c("<div/>").html(e).text()),c(a).hasClass("ui-editor-paste-rich")||b.find(".ui-editor-paste-rich").html(e),c(a).hasClass("ui-editor-paste-source")||
b.find(".ui-editor-paste-source").html(e),c(a).hasClass("ui-editor-paste-markup")||b.find(".ui-editor-paste-markup").html(this.stripAttributes(e)))}});c.ui.editor.registerPlugin("placeholder",{init:function(a,b){b=c.extend({},{content:"[Your content here]",tag:"p",select:!0},b);this.show=function(){if(!c.trim(a.getElement().html())){var d=c(document.createElement(b.tag)).html(b.content);a.getElement().html(d);b.select&&a.selectInner(d)}};a.bind("show",this.show)}});c.ui.editor.registerUi({raptorize:{init:function(a){var b=
a.uiButton({title:f("Raptorize"),ready:function(){b.button.raptorize&&b.button.raptorize()}});return b}}});c.ui.editor.registerPlugin("saveJson",{options:{id:{attr:"name"},postName:"content",showResponse:!1,appendId:!1,ajax:{url:"/",type:"post",cache:!1}},init:function(){},getId:function(){if("string"===typeof this.options.id)return this.options.id;if("function"===typeof this.options.id)return this.options.id.apply(this,[this.editor.getOriginalElement()]);if(this.options.id.attr){var a=this.editor.getOriginalElement().attr(this.options.id.attr);
...
d.getUniqueId()).appendTo("body"));var e=this;d.bind("dirty",function(){b++;0<b&&a.addClass(e.options.baseClass+"-visible")});d.bind("cleaned",function(){b--;0===b&&a.removeClass(e.options.baseClass+"-visible")})},show:function(){},hide:function(){},reposition:function(){}})})();c.ui.editor.registerUi({viewSource:{dialog:null,init:function(a){a.bind("hide",this.hide,this);return a.uiButton({title:f("View / Edit Source"),click:function(){this.show()}})},tab:function(){return"    "},highlightSource:function(){return"undefined"!==
typeof j.Rainbow},untidyHtml:function(a){a=c("<div/>").html(a);c(a).find("span.support").each(function(){c(this).contents().unwrap()});a=a.html();a=a.replace(/&lt;/g,"<");a=a.replace(/&gt;/g,">");return a=a.replace(/&amp;/g,"&")},tidyHtml:function(a){if("undefined"===typeof HTMLParser)return a;var b=0,c="",e=this;HTMLParser(a,{start:function(a,f,i){for(var j=0;j<b;j++)c+=e.tab();c+="<"+a;for(j=0;j<f.length;j++)c+=" "+f[j].name+'="'+f[j].escaped+'"';c+=(i?"/":"")+">";b++},end:function(a){c+="</"+a+
">";b--},chars:function(a){c+=a},comment:function(a){c+="<\!--"+a+"--\>"}});return c},prepareSource:function(a){if(this.highlightSource()){var b=this.tidyHtml(c.trim(this.editor.getHtml())),a=c(a).find("."+this.options.baseClass+"-highlighted"),d=function(a,b,f){var a=c(a),k=a.find("code:first");k.unbind("keydown keyup");k.attr("contenteditable",!0);Rainbow.color(b,"html",function(b){k.html(b);a.show();var g=function(){var a=i.getSelection();return a.rangeCount?a.getRangeAt(0):null},m="";k.bind("keydown",
function(a){m=k.html();switch(a.keyCode){case 13:var b=g(),c=!1,d=document.createTextNode("\r\n");b&&(b.insertNode(d),b.setEndAfter(d),b.setStartAfter(d),c=i.getSelection(),c.setSingleRange(b),c=!0);c&&a.preventDefault();return!1;case 9:return b=g(),a=document.createTextNode(f.tab()),b&&(b.insertNode(a),c=i.getSelection(),b.setEndAfter(a),b.setStartAfter(a),c.setSingleRange(b)),!1}});var n=!1;k.bind("keydown",function(){n=!0});k.bind("keyup",function(){n=!1;j.setTimeout(function(){if(!n){if(m==k.html())return!0;
try{var b=f.untidyHtml(k.html());c("<div/>").html(b).html()==b&&d(a,b,f)}catch(g){console.log("error")}}},5E3)})})};d(a,b,this)}else c(a).find("textarea").val(c.trim(this.editor.getHtml())),c(a).find("."+this.options.baseClass+"-plain-text").show()},hide:function(){this.dialog&&c(this.dialog).dialog("destroy").remove();this.dialog=null;c(this.ui.button).button("option","disabled",!1)},show:function(){if(!this.dialog){c(this.ui.button).button("option","disabled",!0);var a=this;this.dialog=c(this.editor.getTemplate("viewsource.dialog",
{baseClass:a.options.baseClass}));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:f("View Source"),autoOpen:!0,dialogClass:a.options.baseClass+" "+a.options.dialogClass,buttons:[{text:f("Apply Source"),click:function(){var b;a.highlightSource()?(b=c(this).find("."+a.options.baseClass+"-highlighted pre code:first").html(),b=a.untidyHtml(b)):b=c(this).find("textarea").val();a.editor.setHtml(b);c(this).find("textarea").val(a.editor.getHtml())}},{text:f("Close"),click:function(){a.hide()}}],
open:function(){var b=c(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});a.prepareSource.call(a,this)},close:function(){a.hide()}})}}}})})(jQuery,window,rangy);
