/*! VERSION: 0.0.6 *//*
 ...
 Build date: 26 February 2012
*/
window.rangy=function(){function c(a,d){var b=typeof a[d];return b==p||!!(b==n&&a[d])||"unknown"==b}function o(a,d){return!!(typeof a[d]==n&&a[d])}function k(a,d){return typeof a[d]!=i}function t(a){return function(d,b){for(var c=b.length;c--;)if(!a(d,b[c]))return!1;return!0}}function r(c){return c&&d(c,b)&&g(c,a)}function s(a){window.alert("Rangy not supported in your browser. Reason: "+a);h.initialized=!0;h.supported=!1}function f(){if(!h.initialized){var a,b=!1,e=!1;c(document,"createRange")&&
(a=document.createRange(),d(a,l)&&g(a,m)&&(b=!0),a.detach());if((a=o(document,"body")?document.body:document.getElementsByTagName("body")[0])&&c(a,"createTextRange"))a=a.createTextRange(),r(a)&&(e=!0);!b&&!e&&s("Neither Range nor TextRange are implemented");h.initialized=!0;h.features={implementsDomRange:b,implementsTextRange:e};b=D.concat(q);e=0;for(a=b.length;e<a;++e)try{b[e](h)}catch(n){o(window,"console")&&c(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
n)}}}function v(a){this.name=a;this.supported=this.initialized=!1}var n="object",p="function",i="undefined",m="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer,START_TO_START,START_TO_END,END_TO_START,END_TO_END".split(","),l="setStart,setStartBefore,setStartAfter,setEnd,setEndBefore,setEndAfter,collapse,selectNode,selectNodeContents,compareBoundaryPoints,deleteContents,extractContents,cloneContents,insertNode,surroundContents,cloneRange,toString,detach".split(","),
a="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),b="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),d=t(c),e=t(o),g=t(k),h={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:c,isHostObject:o,isHostProperty:k,areHostMethods:d,areHostObjects:e,areHostProperties:g,isTextRange:r},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
h.fail=s;h.warn=function(a){a="Rangy warning: "+a;h.config.alertOnWarn?window.alert(a):typeof window.console!=i&&typeof window.console.log!=i&&window.console.log(a)};({}).hasOwnProperty?h.util.extend=function(a,d){for(var b in d)d.hasOwnProperty(b)&&(a[b]=d[b])}:s("hasOwnProperty not supported");var q=[],D=[];h.init=f;h.addInitListener=function(a){h.initialized?a(h):q.push(a)};var B=[];h.addCreateMissingNativeApiListener=function(a){B.push(a)};h.createMissingNativeApi=function(a){a=a||window;f();
for(var d=0,b=B.length;d<b;++d)B[d](a)};v.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};v.prototype.warn=function(a){h.warn("Module "+this.name+": "+a)};v.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};h.createModule=function(a,d){var b=new v(a);h.modules[a]=b;D.push(function(a){d(a,b);b.initialized=!0;b.supported=!0})};h.requireModules=function(a){for(var d=0,b=a.length,c,e;d<
b;++d){e=a[d];c=h.modules[e];if(!c||!(c instanceof v))throw Error("Module '"+e+"' not found");if(!c.supported)throw Error("Module '"+e+"' not supported");}};var z=!1,e=function(){z||(z=!0,h.initialized||f())};if(typeof window==i)s("No window found");else if(typeof document==i)s("No document found");else return c(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",e,!1),c(window,"addEventListener")?window.addEventListener("load",e,!1):c(window,"attachEvent")?window.attachEvent("onload",
e):s("Window does not have required addEventListener or attachEvent method"),h}();
rangy.createModule("DomUtil",function(c,o){function k(a){for(var d=0;a=a.previousSibling;)d++;return d}function t(a,b){var c=[],n;for(n=a;n;n=n.parentNode)c.push(n);for(n=b;n;n=n.parentNode)if(d(c,n))return n;return null}function r(a,d,b){for(b=b?a:a.parentNode;b;){a=b.parentNode;if(a===d)return b;b=a}return null}function s(a){a=a.nodeType;return 3==a||4==a||8==a}function f(a,b){var d=b.nextSibling,c=b.parentNode;d?c.insertBefore(a,d):c.appendChild(a);return a}function v(a){if(9==a.nodeType)return a;
if(typeof a.ownerDocument!=l)return a.ownerDocument;if(typeof a.document!=l)return a.document;if(a.parentNode)return v(a.parentNode);throw Error("getDocument: no document found for node");}function n(a){return!a?"[No node]":s(a)?'"'+a.data+'"':1==a.nodeType?"<"+a.nodeName+(a.id?' id="'+a.id+'"':"")+">["+a.childNodes.length+"]":a.nodeName}function p(a){this._next=this.root=a}function i(a,b){this.node=a;this.offset=b}function m(a){this.code=this[a];this.codeName=a;this.message="DOMException: "+this.codeName}
var l="undefined",a=c.util;a.areHostMethods(document,["createDocumentFragment","createElement","createTextNode"])||o.fail("document missing a Node creation method");a.isHostMethod(document,"getElementsByTagName")||o.fail("document missing getElementsByTagName method");var b=document.createElement("div");a.areHostMethods(b,["insertBefore","appendChild","cloneNode"])||o.fail("Incomplete Element implementation");a.isHostProperty(b,"innerHTML")||o.fail("Element is missing innerHTML property");b=document.createTextNode("test");
a.areHostMethods(b,["splitText","deleteData","insertData","appendData","cloneNode"])||o.fail("Incomplete Text Node implementation");var d=function(a,b){for(var d=a.length;d--;)if(a[d]===b)return!0;return!1};p.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){var a=this._current=this._next,b;if(this._current){b=a.firstChild;if(!b)for(b=null;a!==this.root&&!(b=a.nextSibling);)a=a.parentNode;this._next=b}return this._current},detach:function(){this._current=this._next=this.root=
null}};i.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+n(this.node)+":"+this.offset+")]"}};m.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};m.prototype.toString=function(){return this.message};c.dom={arrayContains:d,isHtmlNamespace:function(a){var b;return typeof a.namespaceURI==l||null===(b=a.namespaceURI)||"http://www.w3.org/1999/xhtml"==
b},parentElement:function(a){a=a.parentNode;return 1==a.nodeType?a:null},getNodeIndex:k,getNodeLength:function(a){var b;return s(a)?a.length:(b=a.childNodes)?b.length:0},getCommonAncestor:t,isAncestorOf:function(a,b,d){for(b=d?b:b.parentNode;b;){if(b===a)return!0;b=b.parentNode}return!1},getClosestAncestorIn:r,isCharacterDataNode:s,insertAfter:f,splitDataNode:function(a,b){var d=a.cloneNode(!1);d.deleteData(0,b);a.deleteData(b,a.length-b);f(d,a);return d},getDocument:v,getWindow:function(a){a=v(a);
...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(b){return a.isHostObject(b,"body")?b.body:b.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var b;b=a.parentNode;)a=b;return a},comparePoints:function(a,b,d,c){var n;if(a==d)return b===c?0:b<c?-1:1;if(n=r(d,a,!0))return b<=k(n)?-1:1;if(n=r(a,d,!0))return k(n)<c?-1:1;b=t(a,d);a=a===b?b:r(a,b,!0);d=d===b?b:r(d,b,!0);if(a===d)throw Error("comparePoints got to case 4 and childA and childB are the same!");
for(b=b.firstChild;b;){if(b===a)return-1;if(b===d)return 1;b=b.nextSibling}throw Error("Should not be here!");},inspectNode:n,fragmentFromNodeChildren:function(a){for(var b=v(a).createDocumentFragment(),d;d=a.firstChild;)b.appendChild(d);return b},createIterator:function(a){return new p(a)},DomPosition:i};c.DOMException=m});
rangy.createModule("DomRange",function(c){function o(a,b){return 3!=a.nodeType&&(j.isAncestorOf(a,b.startContainer,!0)||j.isAncestorOf(a,b.endContainer,!0))}function k(a){return j.getDocument(a.startContainer)}function t(a,b,d){if(b=a._listeners[b])for(var c=0,e=b.length;c<e;++c)b[c].call(a,{target:a,args:d})}function r(a){return new J(a.parentNode,j.getNodeIndex(a))}function s(a){return new J(a.parentNode,j.getNodeIndex(a)+1)}function f(a,b,d){var c=11==a.nodeType?a.firstChild:a;j.isCharacterDataNode(b)?
d==b.length?j.insertAfter(a,b):b.parentNode.insertBefore(a,0==d?b:j.splitDataNode(b,d)):d>=b.childNodes.length?b.appendChild(a):b.insertBefore(a,b.childNodes[d]);return c}function v(a){for(var b,d,c=k(a.range).createDocumentFragment();d=a.next();){b=a.isPartiallySelectedSubtree();d=d.cloneNode(!b);b&&(b=a.getSubtreeIterator(),d.appendChild(v(b)),b.detach(!0));if(10==d.nodeType)throw new C("HIERARCHY_REQUEST_ERR");c.appendChild(d)}return c}function n(a,b,d){for(var c,e,d=d||{stop:!1};c=a.next();)if(a.isPartiallySelectedSubtree())if(!1===
b(c)){d.stop=!0;break}else{if(c=a.getSubtreeIterator(),n(c,b,d),c.detach(!0),d.stop)break}else for(c=j.createIterator(c);e=c.next();)if(!1===b(e)){d.stop=!0;return}}function p(a){for(var b;a.next();)a.isPartiallySelectedSubtree()?(b=a.getSubtreeIterator(),p(b),b.detach(!0)):a.remove()}function i(a){for(var b,d=k(a.range).createDocumentFragment(),c;b=a.next();){a.isPartiallySelectedSubtree()?(b=b.cloneNode(!1),c=a.getSubtreeIterator(),b.appendChild(i(c)),c.detach(!0)):a.remove();if(10==b.nodeType)throw new C("HIERARCHY_REQUEST_ERR");
d.appendChild(b)}return d}function m(b,d,c){var e=!(!d||!d.length),g,x=!!c;e&&(g=RegExp("^("+d.join("|")+")$"));var u=[];n(new a(b,!1),function(a){(!e||g.test(a.nodeType))&&(!x||c(a))&&u.push(a)});return u}function l(a){return"["+("undefined"==typeof a.getName?"Range":a.getName())+"("+j.inspectNode(a.startContainer)+":"+a.startOffset+", "+j.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function a(a,b){this.range=a;this.clonePartiallySelectedTextNodes=b;if(!a.collapsed){this.sc=a.startContainer;
this.so=a.startOffset;this.ec=a.endContainer;this.eo=a.endOffset;var d=a.commonAncestorContainer;this.sc===this.ec&&j.isCharacterDataNode(this.sc)?(this.isSingleCharacterDataNode=!0,this._first=this._last=this._next=this.sc):(this._first=this._next=this.sc===d&&!j.isCharacterDataNode(this.sc)?this.sc.childNodes[this.so]:j.getClosestAncestorIn(this.sc,d,!0),this._last=this.ec===d&&!j.isCharacterDataNode(this.ec)?this.ec.childNodes[this.eo-1]:j.getClosestAncestorIn(this.ec,d,!0))}}function b(a){this.code=
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function d(a,b,d){this.nodes=m(a,b,d);this._next=this.nodes[0];this._position=0}function e(a){return function(b,d){for(var c,e=d?b:b.parentNode;e;){c=e.nodeType;if(j.arrayContains(a,c))return e;e=e.parentNode}return null}}function g(a,d){if(aa(a,d))throw new b("INVALID_NODE_TYPE_ERR");}function h(a){if(!a.startContainer)throw new C("INVALID_STATE_ERR");}function q(a,d){if(!j.arrayContains(d,a.nodeType))throw new b("INVALID_NODE_TYPE_ERR");
}function D(a,b){if(0>b||b>(j.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new C("INDEX_SIZE_ERR");}function B(a,b){if(Q(a,!0)!==Q(b,!0))throw new C("WRONG_DOCUMENT_ERR");}function z(a){if(ba(a,!0))throw new C("NO_MODIFICATION_ALLOWED_ERR");}function y(a,b){if(!a)throw new C(b);}function F(a){return!!a.startContainer&&!!a.endContainer&&!(!j.arrayContains(M,a.startContainer.nodeType)&&!Q(a.startContainer,!0))&&!(!j.arrayContains(M,a.endContainer.nodeType)&&!Q(a.endContainer,!0))&&a.startOffset<=
...
G(a.prototype)}function u(b,d){return function(){w(this);var c=this.startContainer,e=this.startOffset,g=this.commonAncestorContainer,x=new a(this,!0);c!==g&&(c=j.getClosestAncestorIn(c,g,!0),e=s(c),c=e.node,e=e.offset);n(x,z);x.reset();g=b(x);x.detach();d(this,c,e,c,e);return g}}function I(b,d,e){function x(a,b){return function(d){h(this);q(d,K);q(O(d),M);d=(a?r:s)(d);(b?n:I)(this,d.node,d.offset)}}function n(a,b,c){var e=a.endContainer,g=a.endOffset;if(b!==a.startContainer||c!==a.startOffset){if(O(b)!=
O(e)||1==j.comparePoints(b,c,e,g))e=b,g=c;d(a,b,c,e,g)}}function I(a,b,c){var e=a.startContainer,g=a.startOffset;if(b!==a.endContainer||c!==a.endOffset){if(O(b)!=O(e)||-1==j.comparePoints(b,c,e,g))e=b,g=c;d(a,e,g,b,c)}}b.prototype=new H;c.util.extend(b.prototype,{setStart:function(a,b){h(this);g(a,!0);D(a,b);n(this,a,b)},setEnd:function(a,b){h(this);g(a,!0);D(a,b);I(this,a,b)},setStartBefore:x(!0,!0),setStartAfter:x(!1,!0),setEndBefore:x(!0,!1),setEndAfter:x(!1,!1),collapse:function(a){w(this);a?
d(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):d(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){h(this);g(a,!0);d(this,a,0,a,j.getNodeLength(a))},selectNode:function(a){h(this);g(a,!1);q(a,K);var b=r(a),a=s(a);d(this,b.node,b.offset,a.node,a.offset)},extractContents:u(i,d),deleteContents:u(p,d),canSurroundContents:function(){w(this);z(this.startContainer);z(this.endContainer);var b=new a(this,!0),d=b._first&&
o(b._first,this)||b._last&&o(b._last,this);b.detach();return!d},detach:function(){e(this)},splitBoundaries:function(){w(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,e=this.endOffset,g=a===c;j.isCharacterDataNode(c)&&0<e&&e<c.length&&j.splitDataNode(c,e);j.isCharacterDataNode(a)&&0<b&&b<a.length&&(a=j.splitDataNode(a,b),g?(e-=b,c=a):c==a.parentNode&&e>=j.getNodeIndex(a)&&e++,b=0);d(this,a,b,c,e)},normalizeBoundaries:function(){w(this);var a=this.startContainer,b=this.startOffset,
c=this.endContainer,e=this.endOffset,g=function(a){var b=a.nextSibling;b&&b.nodeType==a.nodeType&&(c=a,e=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},x=function(d){var g=d.previousSibling;if(g&&g.nodeType==d.nodeType){a=d;var x=d.length;b=g.length;d.insertData(0,g.data);g.parentNode.removeChild(g);a==c?(e+=b,c=a):c==d.parentNode&&(g=j.getNodeIndex(d),e==g?(c=d,e=x):e>g&&e--)}},u=!0;j.isCharacterDataNode(c)?c.length==e&&g(c):(0<e&&(u=c.childNodes[e-1])&&j.isCharacterDataNode(u)&&g(u),
u=!this.collapsed);u?j.isCharacterDataNode(a)?0==b&&x(a):b<a.childNodes.length&&(g=a.childNodes[b])&&j.isCharacterDataNode(g)&&x(g):(a=c,b=e);d(this,a,b,c,e)},collapseToPoint:function(a,b){h(this);g(a,!0);D(a,b);(a!==this.startContainer||b!==this.startOffset||a!==this.endContainer||b!==this.endOffset)&&d(this,a,b,a,b)}});E(b)}function N(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:j.getCommonAncestor(a.startContainer,
a.endContainer)}function P(a,b,d,c,e){var g=a.startContainer!==b||a.startOffset!==d,x=a.endContainer!==c||a.endOffset!==e;a.startContainer=b;a.startOffset=d;a.endContainer=c;a.endOffset=e;N(a);t(a,"boundarychange",{startMoved:g,endMoved:x})}function A(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};N(this)}c.requireModules(["DomUtil"]);var j=c.dom,J=j.DomPosition,C=c.DOMException;a.prototype={_current:null,_next:null,_first:null,
_last:null,isSingleCharacterDataNode:!1,reset:function(){this._current=null;this._next=this._first},hasNext:function(){return!!this._next},next:function(){var a=this._current=this._next;a&&(this._next=a!==this._last?a.nextSibling:null,j.isCharacterDataNode(a)&&this.clonePartiallySelectedTextNodes&&(a===this.ec&&(a=a.cloneNode(!0)).deleteData(this.eo,a.length-this.eo),this._current===this.sc&&(a=a.cloneNode(!0)).deleteData(0,this.so)));return a},remove:function(){var a=this._current,b,d;j.isCharacterDataNode(a)&&
(a===this.sc||a===this.ec)?(b=a===this.sc?this.so:0,d=a===this.ec?this.eo:a.length,b!=d&&a.deleteData(b,d-b)):a.parentNode&&a.parentNode.removeChild(a)},isPartiallySelectedSubtree:function(){return o(this._current,this.range)},getSubtreeIterator:function(){var b;if(this.isSingleCharacterDataNode)b=this.range.cloneRange(),b.collapse();else{b=new A(k(this.range));var d=this._current,c=d,e=0,g=d,x=j.getNodeLength(d);j.isAncestorOf(d,this.sc,!0)&&(c=this.sc,e=this.so);j.isAncestorOf(d,this.ec,!0)&&(g=
this.ec,x=this.eo);P(b,c,e,g,x)}return new a(b,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};b.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};b.prototype.toString=function(){return this.message};d.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
detach:function(){this._current=this._next=this.nodes=null}};var K=[1,3,4,5,7,8,10],M=[2,9,11],L=[1,3,4,5,7,8,10,11],x=[1,3,4,5,7,8],O=j.getRootContainer,Q=e([9,11]),ba=e([5,6,10,12]),aa=e([6,10,12]),$=document.createElement("style"),T=!1;try{$.innerHTML="<b>x</b>",T=3==$.firstChild.nodeType}catch(da){}c.features.htmlParsingConforms=T;var U="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),R=0,V=1,ca=2,W=3,X=0,Y=1,Z=2,S=3;H.prototype={attachListener:function(a,
b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){w(this);B(this.startContainer,b.startContainer);var d=a==W||a==R?"start":"end",c=a==V||a==R?"start":"end";return j.comparePoints(this[d+"Container"],this[d+"Offset"],b[c+"Container"],b[c+"Offset"])},insertNode:function(a){w(this);q(a,L);z(this.startContainer);if(j.isAncestorOf(a,this.startContainer,!0))throw new C("HIERARCHY_REQUEST_ERR");this.setStartBefore(f(a,this.startContainer,this.startOffset))},cloneContents:function(){w(this);
var b,d;if(this.collapsed)return k(this).createDocumentFragment();if(this.startContainer===this.endContainer&&j.isCharacterDataNode(this.startContainer))return b=this.startContainer.cloneNode(!0),b.data=b.data.slice(this.startOffset,this.endOffset),d=k(this).createDocumentFragment(),d.appendChild(b),d;d=new a(this,!0);b=v(d);d.detach();return b},canSurroundContents:function(){w(this);z(this.startContainer);z(this.endContainer);var b=new a(this,!0),d=b._first&&o(b._first,this)||b._last&&o(b._last,
this);b.detach();return!d},surroundContents:function(a){q(a,x);if(!this.canSurroundContents())throw new b("BAD_BOUNDARYPOINTS_ERR");var d=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);f(a,this.startContainer,this.startOffset);a.appendChild(d);this.selectNode(a)},cloneRange:function(){w(this);for(var a=new A(k(this)),b=U.length,d;b--;)d=U[b],a[d]=this[d];return a},toString:function(){w(this);var b=this.startContainer;if(b===this.endContainer&&j.isCharacterDataNode(b))return 3==
b.nodeType||4==b.nodeType?b.data.slice(this.startOffset,this.endOffset):"";var d=[],b=new a(this,!0);n(b,function(a){(3==a.nodeType||4==a.nodeType)&&d.push(a.data)});b.detach();return d.join("")},compareNode:function(a){w(this);var b=a.parentNode,d=j.getNodeIndex(a);if(!b)throw new C("NOT_FOUND_ERR");a=this.comparePoint(b,d);b=this.comparePoint(b,d+1);return 0>a?0<b?Z:X:0<b?Y:S},comparePoint:function(a,b){w(this);y(a,"HIERARCHY_REQUEST_ERR");B(a,this.startContainer);return 0>j.comparePoints(a,b,this.startContainer,
this.startOffset)?-1:0<j.comparePoints(a,b,this.endContainer,this.endOffset)?1:0},createContextualFragment:T?function(a){var b=this.startContainer,d=j.getDocument(b);if(!b)throw new C("INVALID_STATE_ERR");var c=null;1==b.nodeType?c=b:j.isCharacterDataNode(b)&&(c=j.parentElement(b));c=null===c||"HTML"==c.nodeName&&j.isHtmlNamespace(j.getDocument(c).documentElement)&&j.isHtmlNamespace(c)?d.createElement("body"):c.cloneNode(!1);c.innerHTML=a;return j.fragmentFromNodeChildren(c)}:function(a){h(this);
var b=k(this).createElement("body");b.innerHTML=a;return j.fragmentFromNodeChildren(b)},toHtml:function(){w(this);var a=k(this).createElement("div");a.appendChild(this.cloneContents());return a.innerHTML},intersectsNode:function(a,b){w(this);y(a,"NOT_FOUND_ERR");if(j.getDocument(a)!==k(this))return!1;var d=a.parentNode,c=j.getNodeIndex(a);y(d,"NOT_FOUND_ERR");var e=j.comparePoints(d,c,this.endContainer,this.endOffset),d=j.comparePoints(d,c+1,this.startContainer,this.startOffset);return b?0>=e&&0<=
d:0>e&&0<d},isPointInRange:function(a,b){w(this);y(a,"HIERARCHY_REQUEST_ERR");B(a,this.startContainer);return 0<=j.comparePoints(a,b,this.startContainer,this.startOffset)&&0>=j.comparePoints(a,b,this.endContainer,this.endOffset)},intersectsRange:function(a,b){w(this);if(k(a)!=k(this))throw new C("WRONG_DOCUMENT_ERR");var d=j.comparePoints(this.startContainer,this.startOffset,a.endContainer,a.endOffset),c=j.comparePoints(this.endContainer,this.endOffset,a.startContainer,a.startOffset);return b?0>=
d&&0<=c:0>d&&0<c},intersection:function(a){if(this.intersectsRange(a)){var b=j.comparePoints(this.startContainer,this.startOffset,a.startContainer,a.startOffset),d=j.comparePoints(this.endContainer,this.endOffset,a.endContainer,a.endOffset),c=this.cloneRange();-1==b&&c.setStart(a.startContainer,a.startOffset);1==d&&c.setEnd(a.endContainer,a.endOffset);return c}return null},union:function(a){if(this.intersectsRange(a,!0)){var d=this.cloneRange();-1==j.comparePoints(a.startContainer,a.startOffset,this.startContainer,
this.startOffset)&&d.setStart(a.startContainer,a.startOffset);1==j.comparePoints(a.endContainer,a.endOffset,this.endContainer,this.endOffset)&&d.setEnd(a.endContainer,a.endOffset);return d}throw new b("Ranges do not intersect");},containsNode:function(a,b){return b?this.intersectsNode(a,!1):this.compareNode(a)==S},containsNodeContents:function(a){return 0<=this.comparePoint(a,0)&&0>=this.comparePoint(a,j.getNodeLength(a))},containsRange:function(a){return this.intersection(a).equals(a)},containsNodeText:function(a){var b=
this.cloneRange();b.selectNode(a);var d=b.getNodes([3]);return 0<d.length?(b.setStart(d[0],0),a=d.pop(),b.setEnd(a,a.length),a=this.containsRange(b),b.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){w(this);return new d(this,a,b)},getNodes:function(a,b){w(this);return m(this,a,b)},getDocument:function(){return k(this)},collapseBefore:function(a){h(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){h(this);this.setStartAfter(a);this.collapse(!0)},getName:function(){return"DomRange"},
equals:function(a){return A.rangesEqual(this,a)},isValid:function(){return F(this)},inspect:function(){return l(this)}};I(A,P,function(a){h(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;t(a,"detach",null);a._listeners=null});c.rangePrototype=H.prototype;A.rangeProperties=U;A.RangeIterator=a;A.copyComparisonConstants=E;A.createPrototypeRange=I;A.inspect=l;A.getRangeDocument=k;A.rangesEqual=function(a,b){return a.startContainer===b.startContainer&&
a.startOffset===b.startOffset&&a.endContainer===b.endContainer&&a.endOffset===b.endOffset};c.DomRange=A;c.RangeException=b});
rangy.createModule("WrappedRange",function(c){function o(c,f,i,m){var l=c.duplicate();l.collapse(i);var a=l.parentElement();r.isAncestorOf(f,a,!0)||(a=f);if(!a.canHaveHTML)return new s(a.parentNode,r.getNodeIndex(a));var f=r.getDocument(a).createElement("span"),b,d=i?"StartToStart":"StartToEnd";do a.insertBefore(f,f.previousSibling),l.moveToElementText(f);while(0<(b=l.compareEndPoints(d,c))&&f.previousSibling);d=f.nextSibling;if(-1==b&&d&&r.isCharacterDataNode(d)){l.setEndPoint(i?"EndToStart":"EndToEnd",
c);if(/[\r\n]/.test(d.data)){a=l.duplicate();i=a.text.replace(/\r\n/g,"\r").length;for(i=a.moveStart("character",i);-1==a.compareEndPoints("StartToEnd",a);)i++,a.moveStart("character",1)}else i=l.text.length;a=new s(d,i)}else d=(m||!i)&&f.previousSibling,a=(i=(m||i)&&f.nextSibling)&&r.isCharacterDataNode(i)?new s(i,0):d&&r.isCharacterDataNode(d)?new s(d,d.length):new s(a,r.getNodeIndex(f));f.parentNode.removeChild(f);return a}function k(c,f){var i,m,l=c.offset,a=r.getDocument(c.node),b=a.body.createTextRange(),
d=r.isCharacterDataNode(c.node);d?(i=c.node,m=i.parentNode):(i=c.node.childNodes,i=l<i.length?i[l]:null,m=c.node);a=a.createElement("span");a.innerHTML="&#feff;";i?m.insertBefore(a,i):m.appendChild(a);b.moveToElementText(a);b.collapse(!f);m.removeChild(a);if(d)b[f?"moveStart":"moveEnd"]("character",l);return b}c.requireModules(["DomUtil","DomRange"]);var t,r=c.dom,s=r.DomPosition,f=c.DomRange;if(c.features.implementsDomRange&&(!c.features.implementsTextRange||!c.config.preferTextRange))(function(){function n(a){for(var b=
i.length,c;b--;)c=i[b],a[c]=a.nativeRange[c]}var p,i=f.rangeProperties,m;t=function(a){if(!a)throw Error("Range must be specified");this.nativeRange=a;n(this)};f.createPrototypeRange(t,function(a,b,c,h,n){var f=a.endContainer!==h||a.endOffset!=n;if(a.startContainer!==b||a.startOffset!=c||f)a.setEnd(h,n),a.setStart(b,c)},function(a){a.nativeRange.detach();a.detached=!0;for(var b=i.length,c;b--;)c=i[b],a[c]=null});p=t.prototype;p.selectNode=function(a){this.nativeRange.selectNode(a);n(this)};p.deleteContents=
...
b;a++){for(var d=this.options.uiOrder[a],e=c("<div/>"),g=0,f=d.length;g<f;g++)if(this.uiEnabled(d[g])){var q=d[g].replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});if(c.ui.editor.ui[d[g]]){var i=c.extend({},c.ui.editor.ui[d[g]]),q=c.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-ui-"+q},i.options,this.options.ui[d[g]]);i.editor=this;i.options=q;i.ui=i.init(this,q);i.ui.init(d[g],this,q,i).appendTo(e);this.uiObjects[d[g]]=i}}e.addClass("ui-buttonset").addClass(this.options.baseClass+
"-buttonset");0<e.children().length&&e.appendTo(this.toolbar)}c("<div/>").css("clear","both").appendTo(this.toolbar)},uiButton:function(a){return c.extend({button:null,options:{},init:function(a,d,e,g){var h=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),e=c.extend({},d.options,{baseClass:d.options.baseClass+"-"+h+"-button"},this.options,d.options.ui[a]);this.title||(this.title=f("Unnamed Button"));this.button=c("<div/>").html(this.label||this.title).addClass(e.baseClass).attr("name",
a).attr("title",this.title).val(a);e.classes&&this.button.addClass(e.classes);this.button.bind("mousedown."+g.editor.widgetName,function(a){a.preventDefault()});var q=this;this.button.bind("mouseup."+g.editor.widgetName,function(a){a.preventDefault();q.click.apply(g,arguments)});d.bind("destroy",c.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+h},disabled:e.disabled?!0:!1,text:this.text||!1,label:this.label||null});this.ready.call(g);
return this.button},disable:function(){this.button.button("option","disabled",!0)},enable:function(){this.button.button("option","disabled",!1)},ready:function(){},click:function(){}},a)},uiSelectMenu:function(a){return c.extend({select:null,selectMenu:null,button:null,menu:null,options:{},init:function(a,d){var e=this,g=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});c.extend({},d.options,{baseClass:d.options.baseClass+g+"-select-menu"},e.options,d.options.ui[a]);e.title||(e.title=f("Unnamed Select Menu"));
e.wrapper=c('<div class="ui-editor-selectmenu-wrapper"/>').append(e.select.hide());e.selectMenu=c('<div class="ui-selectmenu ui-editor-selectmenu"/>').appendTo(e.wrapper);e.menu=c('<div class="ui-selectmenu-menu ui-editor-selectmenu-menu ui-widget-content ui-corner-bottom ui-corner-tr"/>').appendTo(e.wrapper);e.select.find("option").each(function(){c("<div/>").addClass("ui-selectmenu-menu-item ui-editor-selectmenu-menu-item").addClass("ui-corner-all").html(c(this).html()).appendTo(e.menu).bind("mouseenter."+
d.widgetName,function(){c(this).addClass("ui-state-focus")}).bind("mouseleave."+d.widgetName,function(){c(this).removeClass("ui-state-focus")}).bind("mousedown."+d.widgetName,function(){return false}).bind("click."+d.widgetName,function(){var a=e.select.find("option").eq(c(this).index());e.select.val(a.val());e.update();e.wrapper.removeClass("ui-editor-selectmenu-visible");e.button.addClass("ui-corner-all").removeClass("ui-corner-top");e.change(e.select.val());return false})});var g=c("<div/>").addClass("ui-selectmenu-text"),
h=c("<div/>").addClass("ui-icon ui-icon-triangle-1-s");e.button=c("<div/>").addClass("ui-selectmenu-button ui-editor-selectmenu-button ui-button ui-state-default").attr("title",e.title).append(g).append(h).prependTo(e.selectMenu);e.button.bind("mousedown."+d.widgetName,function(){return false}).bind("click."+d.widgetName,function(){c(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible");e.menu.css("min-width",e.button.outerWidth()+10);e.wrapper.toggleClass("ui-editor-selectmenu-visible");
...
{});for(var a in c.ui.editor.plugins)if(!(!1===this.options.enablePlugins&&"undefined"===typeof this.options.plugins[a]||!1===this.options.plugins[a])&&-1===c.inArray(a,this.options.disabledPlugins)){var b=c.extend({},c.ui.editor.plugins[a]),d=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),d=c.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-"+d},b.options,this.options.plugins[a]);b.editor=this;b.options=d;b.init(this,d);this.plugins[a]=b}},isDirty:function(){return this.dirty},
getHtml:function(){var a=this.getElement().html(),a=c("<div/>").html(a);a.find(".rangySelectionBoundary").remove();return a=a.html()},getCleanHtml:function(){this.fire("clean");var a=this.getElement().html();this.fire("restore");a=c("<div/>").html(a);a.find(".rangySelectionBoundary").remove();return a=a.html()},setHtml:function(a){this.getElement().html(a);this.fire("html");this.change()},resetHtml:function(){this.setHtml(this.getOriginalHtml())},getOriginalHtml:function(){return this.originalHtml},
save:function(){var a=this.getCleanHtml();this.fire("save");this.setOriginalHtml(a);this.fire("saved");this.fire("change");return a},setOriginalHtml:function(a){this.originalHtml=a},bind:function(a,b,d){var e=this.events;c.each(a.split(","),function(a,f){f=c.trim(f);e[f]||(e[f]=[]);e[f].push({context:d,callback:b})})},unbind:function(a,b,d){for(var c=0,g=this.events[a].length;c<g;c++)this.events[a][c]&&this.events[a][c].callback===b&&this.events[a][c].context===d&&this.events[a].splice(c,1)},fire:function(a,
b,d){d||this.fire("before:"+a,b,!0);if(this.events[a])for(var e=0,g=this.events[a].length;e<g;e++){var f=this.events[a][e];f.callback.call(f.context||this)}!1!==b&&c.ui.editor.fire(a);d||this.fire("after:"+a,b,!0)}});c.extend(c.ui.editor,{defaults:{plugins:{},ui:{},bind:{},domTools:{savedSelection:!1,saveSelection:function(){this.savedSelection=k.saveSelection()},restoreSelection:function(){this.savedSelection&&(k.restoreSelection(this.savedSelection),this.savedSelection=!1)},eachRange:function(a,
b,d){for(var b=b||k.getSelection(),d=d||this,c,g=0;c=b.getAllRanges()[g++];)a.call(d,c)},constrainSelection:function(a,b){var a=c(a)[0],b=b||k.getSelection(),d;c(b.getAllRanges()).each(function(e,g){d=3===this.commonAncestorContainer.nodeType?c(g.commonAncestorContainer).parent()[0]:g.commonAncestorContainer;a!==d&&!c.contains(a,d)&&b.removeRange(g)})},getSelectedElements:function(){var a=new jQuery;this.eachRange(function(b){a.push(this.getSelectedElement(b)[0])});return a},getSelectedElement:function(a){a=
a||k.getSelection().getRangeAt(0);return c(3===a.commonAncestorContainer.nodeType?a.commonAncestorContainer.parentNode:a.commonAncestorContainer)},getSelectedHtml:function(a){a=a||k.getSelection();return a.toHtml()},getSelectionStartElement:function(){var a=k.getSelection();return a.isBackwards()?3===a.focusNode.nodeType?c(a.focusNode.parentElement):c(a.focusNode):3===a.anchorNode.nodeType?c(a.anchorNode.parentElement):c(a.anchorNode)},getSelectionEndElement:function(){var a=k.getSelection();return a.isBackwards()?
3===a.anchorNode.nodeType?c(a.anchorNode.parentElement):c(a.anchorNode):3===a.focusNode.nodeType?c(a.focusNode.parentElement):c(a.focusNode)},unwrapParentTag:function(a){this.getSelectedElements().each(function(){c(this).is(a)&&c(this).replaceWith(c(this).html())})},wrapTagWithAttribute:function(a,b,d){this.eachRange(function(c){c=this.getSelectedElement(c);c.is(a)?c.attr(b):this.toggleWrapper(a,{classes:d,attributes:b})})},selectInner:function(a,b){b=b||k.getSelection();b.removeAllRanges();c(a).focus().contents().each(function(){var a=
k.createRange();a.selectNodeContents(this);b.addRange(a)})},selectOuter:function(a,b){b=b||k.getSelection();b.removeAllRanges();c(a).each(function(){var a=k.createRange();a.selectNode(this);b.addRange(a)}).focus()},selectEnd:function(a,b){b=b||k.getSelection();b.removeAllRanges();c(a).each(function(){var a=k.createRange();a.selectNodeContents(this);a.collapse();b.addRange(a)})},toggleWrapper:function(a,b){var b=b||{},d=k.createCssClassApplier(b.classes||"",{normalize:!0,elementTagName:a,elementProperties:b.attributes||
{}});this.eachRange(function(e){this.rangeEmptyTag(e)?this.replaceRange(c("<"+a+"/>").addClass(b.classes).attr(b.attributes||{}).append(this.domFragmentToHtml(e.cloneContents())),e):d.toggleRange(e)})},rangeEmptyTag:function(a){a=this.domFragmentToHtml(a.cloneContents());"string"===typeof a&&(a=a.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));return c(a).is(":empty")?!0:!1},execCommand:function(a,b,c){document.execCommand(a,b,c)},insertTag:function(a,b){this.eachRange(function(b){b.insertNode(c("<"+
a+"/>")[0])},b)},insertTagAtEnd:function(a,b){this.eachRange(function(b){b.insertNodeAtEnd(c("<"+a+"/>")[0])},b)},insertElement:function(a,b,d){this.eachRange(function(d){c(a).each(function(){d.insertNode(!1===b?this:this.cloneNode(!0))})},d)},insertElementAtEnd:function(a,b,d){this.eachRange(function(d){c(a).each(function(){d.insertNodeAtEnd(!1===b?this:this.cloneNode(!0))})},d)},toggleBlockStyle:function(a,b){this.eachRange(function(d){for(d=c(d.commonAncestorContainer);d.length&&d[0]!==b[0]&&(3===
d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===b[0]&&"inline"!==b.css("display")&&(this.wrapInner(b,"div"),d=b.children().first());this.toggleStyle(d,a)})},wrapInner:function(a,b){this.saveSelection();c(a).each(function(){var d=c("<"+b+"/>").html(c(this).html());a.html(d)});this.restoreSelection()},inverseWrapWithTagClass:function(a,b,d,e){this.saveSelection();var g="domTools"+Math.ceil(1E7*Math.random());this.eachRange(function(a){var c=k.createCssClassApplier(e,{elementTagName:d});
c.isAppliedToRange(a)?c.toggleSelection():k.createCssClassApplier(b,{elementTagName:g}).toggleSelection()});c(g).each(function(){c(this).replaceWith(c("<"+a+"/>").addClass(b).html(c(this).html()))});this.restoreSelection()},toggleStyle:function(a,b){c.each(b,function(b,e){c(a).css(b)===e?c(a).css(b,""):c(a).css(b,e)})},getStyles:function(a){for(var b={},a=o.getComputedStyle(a[0],null),c=0;c<a.length;c++)b[a.item(c)]=a.getPropertyValue(a.item(c));return b},swapStyles:function(a,b,c){for(var e in c)a.css(e,
b.css(e)),b.css(e,c[e])},replaceSelectionWithinValidTags:function(a,b,c){var c=c||k.getSelection(),e=this.getSelectionStartElement()[0],g=this.getSelectionEndElement()[0],f=this.isElementValid(this.getSelectedElements()[0],b),e=this.isElementValid(e,b),b=this.isElementValid(g,b);f&&e&&b?this.replaceSelection(a):this.replaceSelectionSplittingSelectedElement(a,c)},replaceSelectionSplittingSelectedElement:function(a,b){var b=b||k.getSelection(),d=b.getRangeAt(0),e=this.getSelectedElements()[0],g=k.createRange();
g.setStartBefore(e);g.setEnd(d.startContainer,d.startOffset);var g=g.cloneContents(),f=k.createRange();f.setStart(d.endContainer,d.endOffset);f.setEndAfter(e);d=f.cloneContents();g=this.outerHtml(c(this.domFragmentToHtml(g)));g+=this.outerHtml(c(a));g+=this.outerHtml(c(this.domFragmentToHtml(d)));c(e).replaceWith(c(g))},replaceSelection:function(a,b){this.eachRange(function(b){this.replaceRange(a,b)},b)},replaceRange:function(a,b){var d=c("<div></div>").append(a)[0].childNodes;b.deleteContents();
d.length===t||1===d.length?b.insertNode(d[0].cloneNode(!0)):c.each(d,function(a,c){b.insertNodeAtEnd(c.cloneNode(!0))})},insertDomFragmentBefore:function(a,b,d){for(var e=0,g=a.childNodes.length;e<g;e++){var f=a.childNodes.item(e);(f=3===f.nodeType?f.nodeValue:c(f).html())&&c("<"+d+"/>").html(c.trim(f)).insertBefore(b)}},domFragmentToHtml:function(a,b){for(var d="",e=0,g=a.childNodes.length;e<g;e++){var f=a.childNodes.item(e);(f=3===f.nodeType?f.nodeValue:this.outerHtml(f))&&(d+=f)}b&&(d=c("<"+b+
">"+d+"</"+b+">"),d.find("p").wrapInner("<"+b+"/>"),d.find("p > *").unwrap(),d=c("<div></div>").html(d).html());return d},selectionExists:function(a){var b=!1;this.eachRange(function(a){this.isEmpty(a)||(b=!0)},a);return b},isEmpty:function(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer},expandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},changeTag:function(a,b){this.insertDomFragmentBefore(a.extractContents(),a.startContainer,b);
c(a.startContainer).remove()},tagSelection:function(a,b){this.tagSelectionWithin(a,null,b)},tagSelectionWithin:function(a,b,d){this.eachRange(function(d){this.isEmpty(d)?(this.expandToParent(d),b=c(b)[0],"undefined"!==typeof b&&d.startContainer===b&&d.endContainer===b?this.wrapInner(c(b),a):this.changeTag(d,a)):this.replaceRange(this.domFragmentToHtml(d.extractContents(),a),d)},d)},isElementValid:function(a,b){return-1!==c.inArray(c(a)[0].tagName.toLowerCase(),b)},outerHtml:function(a){return c(a).clone().wrap("<div></div>").parent().html()},
...
b){return a.uiButton({title:f("Sub script"),click:function(){a.toggleWrapper("sub",{classes:b.classes||b.cssPrefix+"sub"})}})}},textSuper:{init:function(a,b){return a.uiButton({title:f("Super script"),click:function(){a.toggleWrapper("sup",{classes:b.classes||b.cssPrefix+"super"})}})}}});c.ui.editor.registerUi({quoteBlock:{init:function(a,b){return a.uiButton({title:f("Blockquote"),icon:"ui-icon-quote",click:function(){a.toggleWrapper("blockquote",{classes:b.classes||b.cssPrefix+"blockquote"})}})}}});
...
buttons:[{text:f("OK"),click:function(){a.cancel();c(this).dialog("close")}},{text:f("Cancel"),click:function(){c(this).dialog("close")}}],open:function(){var a=c(this).parent().find(".ui-dialog-buttonpane");a.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});a.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){c(this).dialog("destroy").remove()}})):a.cancel()}}});c.ui.editor.registerPlugin({cancel:{cancel:function(){this.editor.unify(function(a){a.fire("cancel");
a.resetHtml();a.hideToolbar();a.disableEditing()})}}});c.ui.editor.registerPlugin("clean",{options:{stripAttrs:["_moz_dirty"],stripAttrContent:{type:"_moz"},stripEmptyTags:"h1,h2,h3,h4,h5,h6,p,b,i,u,strong,em,big,small,div,span".split(","),stripEmptyAttrs:["class","id","style"]},init:function(a){a.bind("change",this.clean,this)},clean:function(){var a,b=this.editor;for(a=0;a<this.options.stripAttrs.length;a++)b.getElement().find("["+this.options.stripAttrs[a]+"]").removeAttr(this.options.stripAttrs[a]);
for(a=0;a<this.options.stripAttrContent.length;a++)b.getElement().find("["+a+'="'+this.options.stripAttrs[a]+'"]').removeAttr(this.options.stripAttrs[a]);for(a=0;a<this.options.stripEmptyTags.length;a++)b.getElement().find(this.options.stripEmptyTags[a]).filter(function(){if(""!==c.trim(c(this).html()))return!1;if(!c(this).hasClass("rangySelectionBoundary"))return!0;if(!1!==b.savedSelection)return!1}).remove();for(a=0;a<this.options.stripEmptyAttrs.length;a++){var d=this.options.stripEmptyAttrs[a];
b.getElement().find("["+this.options.stripEmptyAttrs[a]+"]").filter(function(){return""===c.trim(c(this).attr(d))}).removeAttr(this.options.stripEmptyAttrs[a])}}});c.ui.editor.registerUi({clean:{init:function(a){return a.uiButton({title:f("Remove unnecessary markup from editor content"),click:function(){a.getPlugin("clean").clean()}})}}});c.ui.editor.registerPlugin("clickToEdit",{init:function(a,b){var d=this,e=c(a.getTemplate("clicktoedit.message",b)).appendTo("body"),b=c.extend({},{obscureLinks:!1,
position:{at:"center center",of:a.getElement(),my:"center center",using:function(a){c(this).css({position:"absolute",top:a.top,left:a.left})}}},b);this.selection=function(){var a;document.selection?a=document.selection.createRange():document.getSelection().rangeCount&&(a=document.getSelection().getRangeAt(0));return a};this.show=function(){a.isEditing()||(a.getElement().addClass(b.baseClass+"-highlight"),a.getElement().addClass(b.baseClass+"-hover"),e.position(b.position),e.addClass(b.baseClass+"-visible"))};
this.hide=function(){a.getElement().removeClass(b.baseClass+"-highlight");a.getElement().removeClass(b.baseClass+"-hover");e.removeClass(b.baseClass+"-visible")};this.edit=function(){d.hide();a.isEditing()||a.enableEditing();a.isVisible()||a.showToolbar(d.selection())};e.position(b.position);b.obscureLinks||(a.getElement().find("a").bind("mouseenter."+a.widgetName,d.hide),a.getElement().find("a").bind("mouseleave."+a.widgetName,d.show));a.getElement().bind("mouseenter."+a.widgetName,d.show);a.getElement().bind("mouseleave."+
a.widgetName,d.hide);a.getElement().bind("click."+a.widgetName,function(a){(b.obscureLinks||!c(a.target).is("a")&&!c(a.target).parents("a").length)&&d.edit()});a.bind("destroy",function(){e.remove();a.getElement().unbind("mouseenter."+a.widgetName,d.show);a.getElement().unbind("mouseleave."+a.widgetName,d.hide);a.getElement().unbind("click."+a.widgetName,d.edit)})}});c.ui.editor.registerPlugin("dock",{enabled:!1,docked:!1,topSpacer:null,bottomSpacer:null,options:{docked:!1,dockToElement:!1,dockUnder:!1,
persist:!0,persistID:null},init:function(){this.bind("show",this.show);this.bind("hide",this.hide);this.bind("disabled",this.disable);this.bind("destroy",this.destroy,this)},show:function(){this.enabled?this.isDocked()&&this.showSpacers():((this.loadState()||this.options.docked)&&this.dock(),this.enabled=!0)},hide:function(){this.hideSpacers();this.editor.toolbar.css("width","auto")},showSpacers:function(){!this.options.dockToElement&&this.editor.toolbar.is(":visible")&&(this.topSpacer=c("<div/>").addClass(this.options.baseClass+
"-top-spacer").height(this.editor.toolbar.outerHeight()).prependTo("body"),this.bottomSpacer=c("<div/>").addClass(this.options.baseClass+"-bottom-spacer").height(this.editor.path.outerHeight()).appendTo("body"),this.editor.fire("resize"))},hideSpacers:function(){this.topSpacer&&(this.topSpacer.remove(),this.topSpacer=null);this.bottomSpacer&&(this.bottomSpacer.remove(),this.bottomSpacer=null);this.editor.fire("resize")},swapStyle:function(a,b,c){var e={},g;for(g in c)a.css(g,b.css(g)),e[g]=b.css(g),
b.css(g,c[g]);return e},revertStyle:function(a,b){for(var c in b)a.css(c,b[c])},dockToElement:function(){var a=c("<div/>").insertBefore(this.editor.getElement()).addClass(this.options.baseClass+"-docked-to-element-wrapper");this.editor.wrapper.appendTo(a);this.previousStyle=this.swapStyle(a,this.editor.getElement(),{display:"block","float":"none",clear:"none",position:"static","margin-left":0,"margin-right":0,"margin-top":0,"margin-bottom":0,outline:0,width:"auto"});a.css("width",a.width()+parseInt(this.editor.getElement().css("padding-left"),
10)+parseInt(this.editor.getElement().css("padding-right"),10));this.editor.getElement().appendTo(this.editor.wrapper).addClass(this.options.baseClass+"-docked-element")},undockFromElement:function(){this.editor.getElement().insertAfter(this.editor.wrapper).removeClass(this.options.baseClass+"-docked-element");this.editor.wrapper.appendTo("body").removeClass(this.options.baseClass+"-docked-to-element")},dockToBody:function(){var a=0;c(this.options.dockUnder).length&&(a=c(this.options.dockUnder).outerHeight());
...
b.isDocked()?b.undock():b.dock();a.unify(function(a){b.isDocked()?a.getPlugin("dock").dock():a.getPlugin("dock").undock()})}})}}});c.ui.editor.registerUi({embed:{dialog:null,init:function(a){a.bind("hide",this.hide,this);return a.uiButton({icon:"ui-icon-youtube",title:f("Embed object"),click:function(){this.show()}})},hide:function(){this.dialog&&c(this.dialog).dialog("destroy").remove();this.dialog=null;c(this.ui.button).button("option","disabled",!1)},show:function(){if(!this.dialog){c(this.ui.button).button("option",
"disabled",!0);var a=this;a.editor.saveSelection();this.dialog=c(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:f("Paste Embed Code"),autoOpen:!0,dialogClass:a.options.baseClass+" "+a.options.dialogClass,buttons:[{text:f("Embed Object"),click:function(){a.editor.restoreSelection();a.editor.replaceSelection(c(this).find("textarea").val());c(this).dialog("close")}},{text:f("Close"),click:function(){a.hide()}}],open:function(){var a=c(this).parent().find(".ui-dialog-buttonpane");
...
close:function(){a.hide()}})}}}});c.ui.editor.registerPlugin("emptyElement",{options:{tag:"<p/>"},init:function(){this.bind("change",this.change)},change:function(){var a=this;this.textNodes(this.editor.getElement()).each(function(){c(this).wrap(c(a.options.tag));a.editor.selectEnd(this)})},textNodes:function(a){return c(a).contents().filter(function(){return 3==this.nodeType&&c.trim(this.nodeValue).length})}});c.ui.editor.registerUi({floatLeft:{init:function(a){return a.uiButton({title:f("Float Left"),
...
this.ui.enable()}}});c.ui.editor.registerPlugin("hotkeys",{options:{actions:[{ui:"textBold",key:"b",label:f("ctrl + b")},{ui:"textItalic",key:"i",label:f("ctrl + i")},{ui:"textUnderline",key:"u",label:f("ctrl + u")},{ui:"undo",key:"z",label:f("ctrl + z")},{ui:"redo",key:"y",label:f("ctrl + y")},{ui:"cancel",meta:!1,key:27,label:f("esc")},{ui:"save",key:"s",label:f("ctrl + s")}]},indexedActions:{},keyUpEventSignature:null,keyDownEventSignature:null,init:function(a){this.keyUpEventSignature="keyup."+
this.options.baseClass;this.keyDownEventSignature="keydown."+this.options.baseClass;a.bind("enabled",this.enabled,this);a.bind("disabled",this.disabled,this)},disabled:function(){c(o).unbind(this.keyUpEventSignature);c(o).unbind(this.keyDownEventSignature);this.indexedActions={}},enabled:function(){for(var a,b=0;b<this.options.actions.length;b++)if(a=this.options.actions[b],this.indexedActions[this.isNumeric(a.key)?a.key:a.key.charCodeAt(0)]=a,"undefined"!==typeof a.ui){var d=this.editor.getUi(a.ui);
"undefined"!==typeof d&&d.ui.button.attr("title",d.ui.title+" ("+a.label+")")}var e=this;c(o).bind(this.keyDownEventSignature,function(a){e.actionForKeyCombination.call(e,a)&&a.preventDefault()});c(o).bind(this.keyUpEventSignature,function(a){var b=e.actionForKeyCombination.call(e,a);b&&((c.isFunction(b.callback)?b.callback:function(){e.triggerUiAction(b.ui)}).call(e,a),a.preventDefault())})},actionForKeyCombination:function(a){var b=a.which;65<=b&&90>=b&&(b+=32);var c=this.indexedActions[b];if("undefined"===
typeof c||!(!1===c.meta||a.ctrlKey||a.metaKey))return!1;a=!1;return(a=this.isNumeric(c.key)?b===c.key:String.fromCharCode(b).toLowerCase()===c.key)?c:!1},triggerUiAction:function(a,b){var c=this.editor.getUi(a);"undefined"!==typeof c&&c.ui.click.apply(c,b)},isNumeric:function(a){return!isNaN(a-0)}});c.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:f("Insert Horizontal Rule"),click:function(){a.replaceSelection("<hr/>")}})}}});c.ui.editor.registerUi({i18n:{init:function(a){var b=
this,d=this.persist("locale");d&&s(d);var d=c('<select autocomplete="off" name="i18n"/>'),e;for(e in p){var g=c('<option value="'+e+'" class="'+e+'"/>');g.html(i[e]);n===e&&g.attr("selected","selected");d.append(g)}return a.uiSelectMenu({title:f("Change Language"),select:d,change:function(a){s(b.persist("locale",a))}})}}});r("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}",
...
"{{characters}} characters, {{charactersRemaining}} remaining":"{{characters}} characters, {{charactersRemaining}} remaining","{{images}} image(s) have been replaced with resized versions":"{{images}} image(s) have been replaced with resized versions","{{sentences}} sentences":"{{sentences}} sentences","{{words}} word":"{{words}} word","{{words}} words":"{{words}} words"});c.ui.editor.registerPlugin("imageResize",{options:{resizeAjax:!1,resizingClass:"",resizeAjaxClass:"",ajax:{url:"/",type:"post",
cache:!1}},init:function(a){this.options=c.extend(this.options,{resizingClass:this.options.baseClass+"-in-progress",resizeAjaxClass:this.options.baseClass+"-on-save"});a.bind("enabled",this.bind,this);this.resized=c.proxy(this.imageResized,this);var b=this;a.getElement().find("img").each(function(){this.addEventListener&&this.addEventListener("DOMAttrModified",b.resized,!1);this.attachEvent&&this.attachEvent("onpropertychange",b.resized)})},bind:function(){this.editor.bind("change",this.scanImages,
this);this.editor.bind("destroy",this.destroy,this);this.editor.bind("save",this.save,this);this.editor.bind("cancel",this.cancel,this)},imageResized:function(a){var b=c(a.target);b.is("img")&&b.attr("_moz_resizing")&&"style"==a.attrName&&a.newValue.match(/width|height/)&&(this.options.resizeAjax&&b.addClass(this.options.resizeAjaxClass),this.editor.fire("change"))},scanImages:function(){var a=this.editor.getElement(),b=[];c(a.find("img")).each(function(){(a.height()<c(this).outerHeight()||a.width()<
c(this).outerWidth())&&b.push(c(this))});b.length&&this.resizeImageElements(b,a.width(),a.height())},resizeImageElements:function(a,b,d){for(var e=c("<a>",{href:"",target:"_blank"}),g=0;g<a.length;g++){var f=a[g],q=f.outerWidth(),i=f.outerHeight(),k=Math.min(b/q,d/i),q=Math.abs(k*(q-(f.outerWidth()-f.width()))),i=Math.abs(k*(i-(f.outerHeight()-f.height())));f.addClass(this.options.resizingClass);e=e.html(f.attr("title")||f.attr("src").substr(f.attr("src").lastIndexOf("/")+1)).attr("href",f.attr("src"));
c(f).css({width:q,height:i}).attr("height",i).attr("width",q);this.options.resizeAjax&&f.addClass(this.options.resizeAjaxClass);var l=this;this.showOversizeWarning(this.editor.outerHtml(e),{hide:function(){f.removeClass(l.options.resizingClass)}})}},cancel:function(){this.removeClasses();this.editor.unbind("change",this.scanImages,this);var a=this;this.editor.getElement().find("img").each(function(){this.removeEventListener&&this.addEventListener("DOMAttrModified",a.resized,!1);this.detachEvent&&
this.detachEvent("onpropertychange",a.resized)})},destroy:function(){this.cancel()},save:function(){this.removeClasses(this.options.resizingClass);this.options.resizeAjax&&this.resizeImagesAjax()},resizeImagesAjax:function(){var a=this,b=[];c("."+this.options.resizeAjaxClass).each(function(){c(this).attr("id")||c(this).attr("id",a.editor.getUniqueId());b.push({id:c(this).attr("id"),src:this.src,width:c(this).width(),height:c(this).height()})});if(b.length){var d=this.editor.showLoading(f("Resizing image(s)")),
e=this.options.ajax;e.data={images:b};e.async=!1;c.ajax(e).done(function(e){c(e).each(function(){c("#"+this.id).attr("src",this.src).removeAttr("id")});a.editor.fire("change");d.hide();a.editor.showConfirm(f("{{images}} image(s) have been replaced with resized versions",{images:b.length}))}).fail(function(b){d.hide();a.editor.showError(f("Failed to resize images (error {{error}})",{error:b.status}))}).always(function(){a.removeClasses([a.options.resizeAjaxClass])})}},showOversizeWarning:function(a,
b){this.options.resizeAjax?this.editor.showInfo(f('The image "{{image}}" is too large for the element being edited.<br/>It will be replaced with a resized copy when your edits are saved.',{image:a}),b):this.editor.showInfo(f('The image "{{image}}" is too large for the element being edited.<br/>It has been resized with CSS.',{image:a}),b)},removeClasses:function(a){a||(a=[this.options.resizingClass,this.options.resizeAjaxClass]);c.isArray(a)||(a=[a]);for(var b=0;b<a.length;b++)this.editor.getElement().find("img."+
a[b]).removeClass(a[b])}});c.ui.editor.registerUi({length:{ui:null,options:{length:150},init:function(a){a.bind("show",c.proxy(this.updateCount,this));a.bind("change",c.proxy(this.updateCount,this));return this.ui=this.editor.uiButton({title:f("Remaining characters before the recommended character limit is reached"),label:f("Initializing"),text:!0,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var a=this.options.length-c("<div></div>").html(this.editor.getCleanHtml()).text().length,
b=this.ui.button,d=null,d=0<=a?f("{{charactersRemaining}} characters remaining",{charactersRemaining:a}):f("{{charactersRemaining}} characters over limit",{charactersRemaining:-1*a});b.button("option","label",d);b.button("option","text",!0);0>a?b.addClass("ui-state-error"):0<=a&&15>=a?b.addClass("ui-state-highlight").removeClass("ui-state-error"):b.removeClass("ui-state-highlight ui-state-error")},showStatistics:function(){this.processTemplate().dialog({modal:!0,resizable:!1,title:f("Content Statistics"),
dialogClass:this.editor.options.dialogClass+" "+this.editor.options.baseClass,show:this.editor.options.dialogShowAnimation,hide:this.editor.options.dialogHideAnimation,buttons:[{text:f("OK"),click:function(){c(this).dialog("close")}}],open:function(){c(this).parent().find(".ui-dialog-buttonpane").find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}})},close:function(){c(this).dialog("destroy").remove()}})},processTemplate:function(){var a=c("<div></div>").html(this.editor.getCleanHtml()).text(),
b=null,d=this.options.length-a.length,b=0>d?f("Content contains more than {{limit}} characters and may be truncated",{limit:this.options.length}):f("Content will not be truncated"),e=null,e=a.split(" ").length,e=1==e?f("{{words}} word",{words:e}):f("{{words}} words",{words:e}),g=null,g=a.split(". ").length,g=f("{{sentences}} sentences",{sentences:g}),h=null,h=0<=d?f("{{characters}} characters, {{charactersRemaining}} remaining",{characters:a.length,charactersRemaining:d}):f("{{characters}} characters, {{charactersRemaining}} over the recommended limit",
{characters:a.length,charactersRemaining:-1*d});return c(this.editor.getTemplate("length.dialog",{characters:h,words:e,sentences:g,truncation:b}))}}});c.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:f("Page on this or another website"),focusSelector:'input[name="location"]',init:function(){this.content=this.plugin.editor.getTemplate("link.external",this.options);return this},show:function(a,b){var c=this;a.find('input[name="location"]').bind("keyup",
function(){c.validate(a)});b&&(a.find('input[name="location"]').val(this.plugin.selectedElement.attr("href")).trigger("keyup"),"_blank"===this.plugin.selectedElement.attr("target")&&a.find('input[name="blank"]').attr("checked","checked"));return this},attributes:function(a){var b={href:a.find('input[name="location"]').val()};a.find('input[name="blank"]').is(":checked")&&(b.target="_blank");this.options.regexLink.test(b.href)||this.plugin.editor.showWarning(f("The url for the link you inserted doesn't look well formed"));
return b},validate:function(a){var b="."+this.options.baseClass+"-error-message-url",d=!0;this.options.regexLink.test(a.find('input[name="location"]').val())?a.find(b).has(":visible").hide():(a.find(b).size()||a.find('input[name="location"]').after(this.plugin.editor.getTemplate("link.error",c.extend({},this.options,{messageClass:this.options.baseClass+"-error-message-url",message:f("The URL does not look well formed")}))),a.find(b).not(":visible").show(),d=!1);return d}},{type:"email",title:f("Email address"),
...
regexLink:/^(http|https|ftp):\/\/[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/i,regexEmail:/[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/},b);a.bind("save",this.repairLinks,this);a.bind("cancel",this.cancel,this)},initTypes:function(){this.types={};for(var a={type:null,title:null,content:null,plugin:this,options:this.options,attributes:function(){},init:function(){return this},show:function(){},
editing:function(a){if(a.attr("class"))for(var b=this.classes.split(/\s/gi),d=0;d<b.length;d++)if(b[d].trim()&&c(a).hasClass(b[d]))return!0;return!1},focusSelector:null,focus:function(){if(this.focusSelector){var a=c(this.focusSelector),b=a.val();a.val("");a.focus().val(b)}}},b=null,b=this.options.replaceTypes?this.options.customTypes:c.merge(this.defaultLinkTypes,this.options.customTypes),d,e=0;e<b.length;e++)d=c.extend({},a,b[e],{classes:this.options.baseClass+"-"+b[e].type}).init(),this.types[d.type]=
d},show:function(){if(!this.visible){this.selectedElement=this.editor.getSelectedElements().first();var a=this.selectedElement.is("a"),b=this.options,d=k.saveSelection(),e=this,g=this.dialog=c(this.editor.getTemplate("link.dialog",b)).appendTo("body");this.initTypes();var h=this.dialog.find("fieldset"),i;for(i in this.types)c(this.editor.getTemplate("link.label",this.types[i])).appendTo(h);h.find('input[type="radio"]').bind("change."+this.editor.widgetName,function(){e.typeChange(e.types[c(this).val()],
a)});g.dialog({autoOpen:!1,modal:!0,resizable:!0,width:b.dialogWidth,minWidth:b.dialogMinWidth,height:b.dialogHeight,title:a?f("Edit Link"):f("Insert Link"),dialogClass:b.baseClass+" "+b.dialogClass,buttons:[{text:a?f("Update Link"):f("Insert Link"),click:function(){k.restoreSelection(d);e.apply(a)?c(this).dialog("close"):d=k.saveSelection()}},{text:f("Cancel"),click:function(){k.restoreSelection(d);c(this).dialog("close")}}],beforeopen:function(){e.dialog.find("."+e.options.baseClass+"-content").hide()},
open:function(){e.visible=!0;var b=g.parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});var d=g.find('.ui-editor-link-menu input[type="radio"]');d.first().attr("checked","checked");var f=!1;if(a)for(var h in e.types)if(f=e.types[h].editing(e.selectedElement)){d.filter('[value="'+h+'"]').attr("checked","checked");e.typeChange(e.types[h],a);break}(!a||a&&!f)&&e.typeChange(e.types[d.filter(":checked").val()],
a);c(this).unbind("keyup."+e.editor.widgetName).bind("keyup."+e.editor.widgetName,function(a){13==a.keyCode&&(a=e.types[d.filter(":checked").val()],(!c.isFunction(a.validate)||a.validate(e.dialog.find("."+e.options.baseClass+"-content")))&&b.find("button:eq(0)").trigger("click"))})},close:function(){e.visible=!1;g.find("."+b.baseClass+"-content").hide();c(this).dialog("destroy")}}).dialog("open")}},apply:function(a){var b=this.types[this.dialog.find('input[type="radio"]:checked').val()],d=b.attributes(this.dialog.find("."+
this.options.baseClass+"-content"),a);if(!d)return!0;var e=this.editor.outerHtml(c("<a>"+(d.title?d.title:d.href)+"</a>").attr(c.extend({},d,{target:"_blank"})));a?(this.selectedElement[0].className=this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(b.classes).attr(d),this.editor.showConfirm(f("Updated link: {{link}}",{link:e}))):(this.editor.wrapTagWithAttribute("a",c.extend(d,{id:this.editor.getUniqueId()}),b.classes),this.editor.showConfirm(f("Added link: {{link}}",
{link:e})),this.selectedElement=c("#"+d.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",d.href);return!0},typeChange:function(a,b){var d=this.dialog.find("."+this.options.baseClass+"-content"),e=d.closest("."+this.options.baseClass+"-wrap"),g=a.ajaxUri&&!this.types[a.type].content;g&&e.addClass(this.options.baseClass+"-loading");var f=this;d.hide(this.options.panelAnimation,function(){g?c.ajax({url:a.ajaxUri,type:"get",success:function(g){d.html(g);f.types[a.type].content=
g;e.removeClass(f.options.baseClass+"-loading");a.show(d,b);d.show(f.options.panelAnimation,c.proxy(a.focus,a))}}):(d.html(a.content),a.show(d,b),d.show(f.options.panelAnimation,c.proxy(a.focus,a)))})},remove:function(){this.editor.unwrapParentTag("a")},repairLinks:function(){var a=this;this.editor.getElement().find('a[class^="'+this.options.baseClass+'"]').each(function(){c(this).data(a.options.baseClass+"-href")&&c(this).attr("href",c(this).data(a.options.baseClass+"-href"))})},cancel:function(){this.dialog&&
c(this.dialog.dialog("close"))}});c.ui.editor.registerUi({link:{init:function(a){a.bind("selectionChange",this.change,this);return a.uiButton({title:f("Insert Link"),click:function(){a.getPlugin("link").show()}})},change:function(){this.editor.getSelectedElements().length?this.ui.enable():this.ui.disable()}},unlink:{init:function(a){a.bind("selectionChange",this.change,this);a.bind("show",this.change,this);return a.uiButton({title:f("Remove Link"),click:function(){a.getPlugin("link").remove()}})},
change:function(){this.editor.getSelectedElements().is("a")?this.ui.enable():this.ui.disable()}}});c.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),toggleList:function(a){c(this.editor.getSelectedElements()).is("li")&&
c(this.editor.getSelectedElements()).parent().is(a)?this.unwrapList():this.wrapList(a);this.editor.fire("selectionChange");this.editor.fire("change")},unwrapList:function(){this.editor.saveSelection();var a=[],b=[],d=this.editor.getSelectionStartElement(),e=this.editor.getSelectionEndElement();a.push(c(d).html());b.push(d);if(c(d)[0]!==c(e)[0]){var g=d;do g=c(g).next(),a.push(c(g).html()),b.push(g);while(c(g)[0]!==c(e)[0])}g=0===c(d).prev().length;e=0===c(e).next().length;d=c(d).parent();for(listElementsIndex=
0;listElementsIndex<b.length;listElementsIndex++)c(b[listElementsIndex]).remove();for(b=0;b<a.length;b++)d.parent().is("li")||(a[b]="<p>"+a[b]+"</p>");g&&e?(this.editor.selectOuter(d),this.editor.replaceSelection(a.join(""))):(g?c(d).before(a.join("")):e?c(d).after(a.join("")):this.editor.replaceSelectionSplittingSelectedElement(a.join("")),this.editor.restoreSelection())},wrapList:function(a){var b=c("<div>").html(this.editor.getSelectedHtml()),d=[],e=this;c(b).contents().each(function(){var a;a=
"block"===e.getElementDefaultDisplay(this.tagName)?e.editor.stripTags(c(this).html(),e.validChildren):e.editor.stripTags(e.editor.outerHtml(c(this)),e.validChildren);a=c("<li>"+a+"</li>");""!==c.trim(a.text())&&d.push(e.editor.outerHtml(a))});d.length||d.push("<li>List element content</li>");b=this.options.baseClass+"-selection";a="<"+a+' class="'+b+'">'+d.join("")+"</"+a+">";this.editor.restoreSelection();this.editor.replaceSelectionWithinValidTags(a,this.validParents);this.editor.selectInner(c(this.editor.getElement().find("."+
b).removeClass(b)).find("li:first")[0])},getElementDefaultDisplay:function(a){var b,a=document.createElement(a);b="getComputedStyle"in o;document.body.appendChild(a);b=(b?o.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return b}});c.ui.editor.registerUi({listUnordered:{init:function(a){return a.uiButton({title:f("Unordered List"),click:function(){a.getPlugin("list").toggleList("ul")}})}},listOrdered:{init:function(a){return a.uiButton({title:f("Ordered List"),click:function(){a.getPlugin("list").toggleList("ol")}})}}});
c.ui.editor.registerUi({logo:{ui:null,init:function(){return this.ui=this.editor.uiButton({title:f("Learn More About the Raptor WYSIWYG Editor"),click:function(){o.open("http://www.jquery-raptor.com/about/editors/","_blank")},ready:function(){var a=function(b){var d=typeof b;if("object"!=d||null===b)return"string"==d&&(b='"'+b+'"'),""+b;var e=[],f=b&&c.isArray(b);c.each(b,function(b,c){d=typeof c;"string"==d?c='"'+c+'"':"object"==d&null!==c&&(c=a(c));e.push((f?"":'"'+b+'":')+(""+c))});return(f?"[":
"{")+(""+e)+(f?"]":"}")},b={enableUi:this.options.enableUi,enablePlugins:this.options.enablePlugins,disabledPlugins:a(this.options.disabledPlugins),ui:a(this.options.ui),t:(new Date).getTime()},d=[],e;for(e in b)d.push(e+"="+encodeURIComponent(b[e]));this.ui.button.find(".ui-button-icon-primary").css({"background-image":"url(http://www.jquery-raptor.com/logo/0.0.6?"+d.join("&")+")"})}})}}});c.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span".split(",")},
init:function(a,b){var d=!1,e=!1,g=this;a.getElement().bind("paste."+a.widgetName,c.proxy(function(){if(d)return!1;d=!0;a.saveSelection();c(".uiWidgetEditorPasteBin").length&&c(".uiWidgetEditorPasteBin").remove();c('<div class="uiWidgetEditorPasteBin" contenteditable="true" style="width: 1px; height: 1px; overflow: hidden; position: fixed; top: -1px;" />').appendTo("body");c(".uiWidgetEditorPasteBin").focus();o.setTimeout(function(){var h=c(".uiWidgetEditorPasteBin").html(),h=g.filterAttributes(h),
h=g.filterChars(h),h=g.editor.stripTags(h,g.options.allowedTags),h=g.stripEmpty(h),h={html:h,plain:c("<div/>").html(h).text(),markup:g.stripAttributes(h)};e=c(a.getTemplate("paste.dialog",h));e.find(".ui-editor-paste-area").bind("keyup."+a.widgetname,function(){g.updateAreas(this,e)});c(e).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:b.dialogShowAnimation,hide:b.dialogHideAnimation,dialogClass:b.baseClass+" "+b.dialogClass,buttons:[{text:f("Insert"),click:function(){var b=
null,b=c(this).find(".ui-editor-paste-area:visible"),b=b.hasClass("ui-editor-paste-plain")||b.hasClass("ui-editor-paste-source")?b.val():b.html(),b=g.filterAttributes(b),b=g.filterChars(b);a.restoreSelection();a.replaceSelection(b);d=!1;c(this).dialog("close")}},{text:f("Cancel"),click:function(){a.restoreSelection();d=!1;c(this).dialog("close")}}],open:function(){var a=c(this).find(".ui-editor-paste-panel-tabs");a.find("ul li").click(function(){a.find("ul li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
...
" ")},stripAttributes:function(a){a=c("<div/>").html(a);c(a.find("*")).each(function(){var a=c.map(this.attributes,function(a){return a.name}),d=c(this);c.each(a,function(a,b){try{d.removeAttr(b)}catch(c){}})});return a.html()},stripEmpty:function(a){a=c("<div/>").html(a);a.find("*").filter(function(){return""===c.trim(c(this).text())}).remove();return a.html()},updateAreas:function(a,b){var d=b.find('.ui-editor-paste-synchronize-text input[type="checkbox"]'),e=c(a).is("textarea")?c(a).val():c(a).html();
d.attr("checked")&&(c(a).hasClass("ui-editor-paste-plain")||b.find(".ui-editor-paste-plain").val(c("<div/>").html(e).text()),c(a).hasClass("ui-editor-paste-rich")||b.find(".ui-editor-paste-rich").html(e),c(a).hasClass("ui-editor-paste-source")||b.find(".ui-editor-paste-source").html(e),c(a).hasClass("ui-editor-paste-markup")||b.find(".ui-editor-paste-markup").html(this.stripAttributes(e)))}});c.ui.editor.registerPlugin("placeholder",{init:function(a,b){b=c.extend({},{content:"[Your content here]",
tag:"p",select:!0},b);this.show=function(){if(!c.trim(a.getElement().html())){var d=c(document.createElement(b.tag)).html(b.content);a.getElement().html(d);b.select&&a.selectInner(d)}};a.bind("show",this.show)}});c.ui.editor.registerUi({raptorize:{init:function(a){var b=a.uiButton({title:f("Raptorize"),ready:function(){b.button.raptorize&&b.button.raptorize()}});return b}}});c.ui.editor.registerPlugin("saveJson",{options:{id:{attr:"name"},postName:"content",showResponse:!1,appendId:!1,ajax:{url:"/",
...
{},this.options.ajax);c.isFunction(d.data)?d.data=d.data.apply(this,[b,a]):this.options.postName&&(d.data={},d.data[this.options.postName]=JSON.stringify(a));c.isFunction(d.url)&&(d.url=d.url.apply(this,[b]));this.requests++;c.ajax(d).done(c.proxy(this.done,this)).fail(c.proxy(this.fail,this)).always(c.proxy(this.always,this))}});c.ui.editor.registerUi({save:{options:{plugin:"saveJson"},init:function(a){return a.uiButton({title:f("Save"),icon:"ui-icon-save",click:function(){a.getPlugin(this.options.plugin).save()}})}}});
...
this.change,this);a.bind("show",this.change,this);var b=this;return a.uiSelectMenu({name:"tagMenu",title:f("Change HTML tag of selected element"),select:c(a.getTemplate("tagmenu.menu")),change:function(c){"undefined"===typeof c||"na"===c?b.change():a.tagSelectionWithin(c,a.getElement())}})},change:function(){var a=this.editor.getSelectedElements()[0];a&&(a=a.tagName.toLowerCase(),this.ui.select.find("option[value="+a+"]").length?this.ui.val(a):this.ui.val("na"))}}});c.ui.editor.registerPlugin("toolbarTip",
{init:function(){c.browser.msie||this.bind("show, tagTreeUpdated",function(){c(".ui-editor-wrapper [title]").each(function(){c(this).attr("data-title",c(this).attr("title"));c(this).removeAttr("title")})})}});(function(){var a=null,b=0;c.ui.editor.registerPlugin("unsavedEditWarning",{options:{},init:function(d){a||(a=c(d.getTemplate("unsavededitwarning.warning",this.options)).attr("id",d.getUniqueId()).appendTo("body"));var e=this;d.bind("dirty",function(){b++;0<b&&a.addClass(e.options.baseClass+
"-visible")});d.bind("cleaned",function(){b--;0===b&&a.removeClass(e.options.baseClass+"-visible")})},show:function(){},hide:function(){},reposition:function(){}})})();c.ui.editor.registerUi({viewSource:{dialog:null,init:function(a){a.bind("hide",this.hide,this);return a.uiButton({title:f("View / Edit Source"),click:function(){this.show()}})},tab:function(){return"    "},highlightSource:function(){return"undefined"!==typeof o.Rainbow},untidyHtml:function(a){a=c("<div/>").html(a);c(a).find("span.support").each(function(){c(this).contents().unwrap()});
a=a.html();a=a.replace(/&lt;/g,"<");a=a.replace(/&gt;/g,">");return a=a.replace(/&amp;/g,"&")},tidyHtml:function(a){if("undefined"===typeof HTMLParser)return a;var b=0,c="",e=this;HTMLParser(a,{start:function(a,f,i){for(var k=0;k<b;k++)c+=e.tab();c+="<"+a;for(k=0;k<f.length;k++)c+=" "+f[k].name+'="'+f[k].escaped+'"';c+=(i?"/":"")+">";b++},end:function(a){c+="</"+a+">";b--},chars:function(a){c+=a},comment:function(a){c+="<\!--"+a+"--\>"}});return c},prepareSource:function(a){if(this.highlightSource()){var b=
this.tidyHtml(c.trim(this.editor.getHtml())),a=c(a).find("."+this.options.baseClass+"-highlighted"),d=function(a,b,f){var a=c(a),i=a.find("code:first");i.unbind("keydown keyup");i.attr("contenteditable",!0);Rainbow.color(b,"html",function(b){i.html(b);a.show();var g=function(){var a=k.getSelection();return a.rangeCount?a.getRangeAt(0):null},l="";i.bind("keydown",function(a){l=i.html();switch(a.keyCode){case 13:var b=g(),c=!1,d=document.createTextNode("\r\n");b&&(b.insertNode(d),b.setEndAfter(d),b.setStartAfter(d),
c=k.getSelection(),c.setSingleRange(b),c=!0);c&&a.preventDefault();return!1;case 9:return b=g(),a=document.createTextNode(f.tab()),b&&(b.insertNode(a),c=k.getSelection(),b.setEndAfter(a),b.setStartAfter(a),c.setSingleRange(b)),!1}});var m=!1;i.bind("keydown",function(){m=!0});i.bind("keyup",function(){m=!1;o.setTimeout(function(){if(!m){if(l==i.html())return!0;try{var b=f.untidyHtml(i.html());c("<div/>").html(b).html()==b&&d(a,b,f)}catch(g){console.log("error")}}},5E3)})})};d(a,b,this)}else c(a).find("textarea").val(c.trim(this.editor.getHtml())),
c(a).find("."+this.options.baseClass+"-plain-text").show()},hide:function(){this.dialog&&c(this.dialog).dialog("destroy").remove();this.dialog=null;c(this.ui.button).button("option","disabled",!1)},show:function(){if(!this.dialog){c(this.ui.button).button("option","disabled",!0);var a=this;this.dialog=c(this.editor.getTemplate("viewsource.dialog",{baseClass:a.options.baseClass}));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:f("View Source"),autoOpen:!0,dialogClass:a.options.baseClass+
" "+a.options.dialogClass,buttons:[{text:f("Apply Source"),click:function(){var b;a.highlightSource()?(b=c(this).find("."+a.options.baseClass+"-highlighted pre code:first").html(),b=a.untidyHtml(b)):b=c(this).find("textarea").val();a.editor.setHtml(b);c(this).find("textarea").val(a.editor.getHtml())}},{text:f("Close"),click:function(){a.hide()}}],open:function(){var b=c(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});
a.prepareSource.call(a,this)},close:function(){a.hide()}})}}}})})(jQuery,window,rangy);
