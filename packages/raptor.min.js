...
b;a++){for(var d=this.options.uiOrder[a],e=c("<div/>"),f=0,h=d.length;f<h;f++)if(this.uiEnabled(d[f])){var g=d[f].replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});if(c.ui.editor.ui[d[f]]){var i=c.extend({},c.ui.editor.ui[d[f]]),g=c.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-ui-"+g},i.options,this.options.ui[d[f]]);i.editor=this;i.options=g;i.ui=i.init(this,g);i.ui.init(d[f],this,g,i).appendTo(e);this.uiObjects[d[f]]=i}}e.addClass("ui-buttonset").addClass(this.options.baseClass+
...
a).attr("title",this.title).val(a);e.classes&&this.button.addClass(e.classes);this.button.bind("mousedown."+f.editor.widgetName,function(a){a.preventDefault()});var x=this;this.button.bind("mouseup."+f.editor.widgetName,function(a){a.preventDefault();x.click.apply(f,arguments)});d.bind("destroy",c.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+h},disabled:e.disabled?!0:!1,text:this.text||!1,label:this.label||null});this.ready.call(f);
return this.button},disable:function(){this.button.button("option","disabled",!0)},enable:function(){this.button.button("option","disabled",!1)},ready:function(){},click:function(){}},a)},uiSelectMenu:function(a){return c.extend({select:null,selectMenu:null,button:null,menu:null,options:{},init:function(a,d){var e=this,f=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});c.extend({},d.options,{baseClass:d.options.baseClass+f+"-select-menu"},e.options,d.options.ui[a]);e.title||(e.title=g("Unnamed Select Menu"));
...
d.widgetName,function(){c(this).removeClass("ui-state-focus")}).bind("mousedown."+d.widgetName,function(){return false}).bind("click."+d.widgetName,function(){var a=e.select.find("option").eq(c(this).index());e.select.val(a.val());e.update();e.wrapper.removeClass("ui-editor-selectmenu-visible");e.button.addClass("ui-corner-all").removeClass("ui-corner-top");e.change(e.select.val());return false})});var f=c("<div/>").addClass("ui-editor-selectmenu-text"),h=c("<div/>").addClass("ui-icon ui-icon-triangle-1-s");
e.button=c("<div/>").addClass("ui-editor-selectmenu-button ui-editor-selectmenu-button ui-button ui-state-default").attr("title",e.title).append(f).append(h).prependTo(e.selectMenu);e.button.bind("mousedown."+d.widgetName,function(){return false}).bind("click."+d.widgetName,function(){if(!c(this).hasClass("ui-state-disabled")){e.menu.css("min-width",e.button.outerWidth()+10);e.wrapper.toggleClass("ui-editor-selectmenu-visible");return false}}).bind("mouseenter."+d.widgetName,function(){c(this).hasClass("ui-state-disabled")||
c(this).addClass("ui-state-hover",c(this).hasClass("ui-state-disabled"))}).bind("mouseleave."+d.widgetName,function(){c(this).removeClass("ui-state-hover")});f=e.select.find("option[value="+e.select.val()+"]").html();e.button.find(".ui-editor-selectmenu-text").html(f);return e.wrapper},update:function(){var a=this.select.find("option[value="+this.select.val()+"]").html();this.button.find(".ui-editor-selectmenu-text").html(a)},val:function(){var a=this.select.val.apply(this.select,arguments);this.update();
return a},change:function(){}},a)},getPlugin:function(a){return this.plugins[a]},loadPlugins:function(){this.options.plugins||(this.options.plugins={});for(var a in c.ui.editor.plugins)if(!(!1===this.options.enablePlugins&&"undefined"===typeof this.options.plugins[a]||!1===this.options.plugins[a])&&-1===c.inArray(a,this.options.disabledPlugins)){var b=c.extend({},c.ui.editor.plugins[a]),d=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),d=c.extend(!0,{},this.options,{baseClass:this.options.baseClass+
"-"+d},b.options,this.options.plugins[a]);b.editor=this;b.options=d;b.init(this,d);this.plugins[a]=b}},isDirty:function(){return this.dirty},getHtml:function(){var a=this.getElement().html(),a=c("<div/>").html(a);a.find(".rangySelectionBoundary").remove();return a=a.html()},getCleanHtml:function(){this.fire("clean");var a=this.getElement().html();this.fire("restore");a=c("<div/>").html(a);a.find(".rangySelectionBoundary").remove();return a=a.html()},setHtml:function(a){this.getElement().html(a);this.fire("html");
this.change()},resetHtml:function(){this.setHtml(this.getOriginalHtml());this.fire("cleaned")},getOriginalHtml:function(){return this.originalHtml},save:function(){var a=this.getCleanHtml();this.fire("save");this.setOriginalHtml(a);this.fire("saved");this.fire("cleaned");return a},setOriginalHtml:function(a){this.originalHtml=a},bind:function(a,b,d){var e=this.events;c.each(a.split(","),function(a,h){h=c.trim(h);e[h]||(e[h]=[]);e[h].push({context:d,callback:b})})},unbind:function(a,b,c){for(var e=
0,f=this.events[a].length;e<f;e++)this.events[a][e]&&this.events[a][e].callback===b&&this.events[a][e].context===c&&this.events[a].splice(e,1)},fire:function(a,b,d){d||this.fire("before:"+a,b,!0);if(this.events[a])for(var e=0,f=this.events[a].length;e<f;e++){var h=this.events[a][e];"undefined"!==typeof h.callback&&h.callback.call(h.context||this)}!1!==b&&c.ui.editor.fire(a);d||this.fire("after:"+a,b,!0)}});c.extend(c.ui.editor,{defaults:{plugins:{},ui:{},bind:{},domTools:{savedSelection:!1,saveSelection:function(){this.savedSelection=
i.saveSelection()},restoreSelection:function(){this.savedSelection&&(i.restoreSelection(this.savedSelection),this.savedSelection=!1)},constrainSelection:function(a,b){var a=c(a)[0],b=b||i.getSelection(),d;c(b.getAllRanges()).each(function(e,f){d=3===this.commonAncestorContainer.nodeType?c(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;a!==d&&!c.contains(a,d)&&b.removeRange(f)})},getSelectedElements:function(a){var b=new jQuery;k(function(a){b.push(this.getSelectedElement(a)[0])},
a,this);return b},getSelectedElement:function(a){a=a||i.getSelection().getRangeAt(0);return c(3===a.commonAncestorContainer.nodeType?a.commonAncestorContainer.parentNode:a.commonAncestorContainer)},getSelectedHtml:function(a){a=a||i.getSelection();return a.toHtml()},getSelectionStartElement:function(){var a=i.getSelection();return a.isBackwards()?3===a.focusNode.nodeType?c(a.focusNode.parentElement):c(a.focusNode):3===a.anchorNode.nodeType?c(a.anchorNode.parentElement):c(a.anchorNode)},getSelectionEndElement:function(){var a=
i.getSelection();return a.isBackwards()?3===a.anchorNode.nodeType?c(a.anchorNode.parentElement):c(a.anchorNode):3===a.focusNode.nodeType?c(a.focusNode.parentElement):c(a.focusNode)},unwrapParentTag:function(a){this.getSelectedElements().each(function(){c(this).is(a)&&c(this).replaceWith(c(this).html())})},wrapTagWithAttribute:function(a,b,c){k(function(e){e=this.getSelectedElement(e);e.is(a)?e.attr(b):this.toggleWrapper(a,{classes:c,attributes:b})},null,this)},selectInner:function(a,b){b=b||i.getSelection();
b.removeAllRanges();c(a).focus().contents().each(function(){var a=i.createRange();a.selectNodeContents(this);b.addRange(a)})},selectOuter:function(a,b){b=b||i.getSelection();b.removeAllRanges();c(a).each(function(){var a=i.createRange();a.selectNode(this);b.addRange(a)}).focus()},selectEnd:function(a,b){b=b||i.getSelection();b.removeAllRanges();c(a).each(function(){var a=i.createRange();a.selectNodeContents(this);a.collapse();b.addRange(a)})},toggleWrapper:function(a,b){var b=b||{},d=i.createCssClassApplier(b.classes||
"",{normalize:!0,elementTagName:a,elementProperties:b.attributes||{}});k(function(e){this.rangeEmptyTag(e)?this.replaceRange(c("<"+a+"/>").addClass(b.classes).attr(b.attributes||{}).append(p(e.cloneContents())),e):d.toggleRange(e)},null,this)},rangeEmptyTag:function(a){a=a.cloneContents();a=p(a);"string"===typeof a&&(a=a.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));return c(a).is(":empty")?!0:!1},execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(e){}},insertTag:function(a,b){k(function(b){b.insertNode(c("<"+
a+"/>")[0])},b,this)},insertTagAtEnd:function(a,b){k(function(b){b.insertNodeAtEnd(c("<"+a+"/>")[0])},b,this)},insertElement:function(a,b,d){k(function(d){c(a).each(function(){d.insertNode(!1===b?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(a,b,d){k(function(d){c(a).each(function(){d.insertNodeAtEnd(!1===b?this:this.cloneNode(!0))})},d,this)},toggleBlockStyle:function(a,b){k(function(d){for(d=c(d.commonAncestorContainer);d.length&&d[0]!==b[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=
d.parent();d[0]===b[0]&&"inline"!==b.css("display")&&(this.wrapInner(b,"div"),d=b.children().first());this.toggleStyle(d,a)},null,this)},wrapInner:function(a,b){this.saveSelection();c(a).each(function(){var d=c("<"+b+"/>").html(c(this).html());a.html(d)});this.restoreSelection()},inverseWrapWithTagClass:function(a,b,d,e){this.saveSelection();var f="domTools"+Math.ceil(1E7*Math.random());k(function(a){var c=i.createCssClassApplier(e,{elementTagName:d});c.isAppliedToRange(a)?c.toggleSelection():i.createCssClassApplier(b,
{elementTagName:f}).toggleSelection()},null,this);c(f).each(function(){c(this).replaceWith(c("<"+a+"/>").addClass(b).html(c(this).html()))});this.restoreSelection()},toggleStyle:function(a,b){c.each(b,function(b,e){c(a).css(b)===e?c(a).css(b,""):c(a).css(b,e)})},getStyles:function(a){for(var b={},a=j.getComputedStyle(a[0],null),c=0;c<a.length;c++)b[a.item(c)]=a.getPropertyValue(a.item(c));return b},swapStyles:function(a,b,c){for(var e in c)a.css(e,b.css(e)),b.css(e,c[e])},replaceSelectionWithinValidTags:function(a,
b,c){var c=c||i.getSelection(),e=this.getSelectionStartElement()[0],f=this.getSelectionEndElement()[0],h=this.isElementValid(this.getSelectedElements()[0],b),e=this.isElementValid(e,b),b=this.isElementValid(f,b);h&&e&&b?this.replaceSelection(a):this.replaceSelectionSplittingSelectedElement(a,c)},replaceSelectionSplittingSelectedElement:function(a,b){var b=b||i.getSelection(),d=b.getRangeAt(0),e=this.getSelectedElements()[0],f=i.createRange();f.setStartBefore(e);f.setEnd(d.startContainer,d.startOffset);
var f=f.cloneContents(),h=i.createRange();h.setStart(d.endContainer,d.endOffset);h.setEndAfter(e);d=h.cloneContents();f=m(c(p(f)));f+=m(c(a));f+=m(c(p(d)));c(e).replaceWith(c(f))},replaceSelection:function(a,b){k(function(b){this.replaceRange(a,b)},b,this)},replaceRange:function(a,b){var d=c("<div/>").append(a)[0].childNodes;b.deleteContents();d.length===q||1===d.length?b.insertNode(d[0].cloneNode(!0)):c.each(d,function(a,c){b.insertNodeAtEnd(c.cloneNode(!0))})},insertDomFragmentBefore:function(a,
b,d){for(var e=0,f=a.childNodes.length;e<f;e++){var h=a.childNodes.item(e);(h=3===h.nodeType?h.nodeValue:c(h).html())&&c("<"+d+"/>").html(c.trim(h)).insertBefore(b)}},selectionExists:function(a){var b=!1;k(function(a){this.isEmpty(a)||(b=!0)},a,this);return b},isEmpty:function(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer},isElementValid:function(a,b){return-1!==c.inArray(c(a)[0].tagName.toLowerCase(),b)},stripTags:function(a,b){allowed=[];for(var c=0;c<b.length;c++)b[c].match(/[a-z][a-z0-9]{0,}/g)&&
...
persist:function(a,b,c){a=c?c+"."+a:a;if(localStorage){c=localStorage.uiWidgetEditor?JSON.parse(localStorage.uiWidgetEditor):{};if(b===q)return c[a];c[a]=b;localStorage.uiWidgetEditor=JSON.stringify(c)}return b}});var t,w;c.ui.editor.registerUi({alignLeft:{init:function(a){return a.uiButton({title:g("Left Align"),click:function(){a.toggleBlockStyle({"text-align":"left"},a.getElement())}})}},alignJustify:{init:function(a){return a.uiButton({title:g("Justify"),click:function(){a.toggleBlockStyle({"text-align":"justify"},
a.getElement())}})}},alignCenter:{init:function(a){return a.uiButton({title:g("Center Align"),click:function(){a.toggleBlockStyle({"text-align":"center"},a.getElement())}})}},alignRight:{init:function(a){return a.uiButton({title:g("Right Align"),click:function(){a.toggleBlockStyle({"text-align":"right"},a.getElement())}})}}});c.ui.editor.registerUi({textBold:{init:function(a,b){return this.editor.uiButton({title:g("Bold"),click:function(){a.toggleWrapper("strong",{classes:b.classes||b.cssPrefix+"bold"})}})}},
textItalic:{init:function(a,b){return a.uiButton({title:g("Italic"),click:function(){a.toggleWrapper("em",{classes:b.classes||b.cssPrefix+"italic"})}})}},textUnderline:{init:function(a,b){return a.uiButton({title:g("Underline"),click:function(){a.toggleWrapper("u",{classes:b.classes||b.cssPrefix+"underline"})}})}},textStrike:{init:function(a,b){return a.uiButton({title:g("Strikethrough"),click:function(){a.toggleWrapper("del",{classes:b.classes||b.cssPrefix+"strike"})}})}},textSub:{init:function(a,
b){return a.uiButton({title:g("Sub script"),click:function(){a.toggleWrapper("sub",{classes:b.classes||b.cssPrefix+"sub"})}})}},textSuper:{init:function(a,b){return a.uiButton({title:g("Super script"),click:function(){a.toggleWrapper("sup",{classes:b.classes||b.cssPrefix+"super"})}})}}});c.ui.editor.registerUi({quoteBlock:{init:function(a,b){return a.uiButton({title:g("Blockquote"),icon:"ui-icon-quote",click:function(){a.toggleWrapper("blockquote",{classes:b.classes||b.cssPrefix+"blockquote"})}})}}});
...
buttons:[{text:g("OK"),click:function(){a.cancel();c(this).dialog("close")}},{text:g("Cancel"),click:function(){c(this).dialog("close")}}],open:function(){var a=c(this).parent().find(".ui-dialog-buttonpane");a.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});a.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){c(this).dialog("destroy").remove()}})):a.cancel()}}});c.ui.editor.registerPlugin({cancel:{cancel:function(){this.editor.unify(function(a){a.fire("cancel");
...
this.options.stripEmptyAttrs[a];b.getElement().find("["+this.options.stripEmptyAttrs[a]+"]").filter(function(){return""===c.trim(c(this).attr(d))}).removeAttr(this.options.stripEmptyAttrs[a])}var e=j.location.protocol+"//"+j.location.host,f="//"+j.location.host;for(a=0;a<this.options.stripDomains.length;a++){var h=this.options.stripDomains[a];this.editor.getElement().find(h.selector).each(function(){for(var a=0;a<h.attributes.length;a++){var b=c(this).attr(h.attributes[a]);"undefined"!==typeof b&&
(0===b.indexOf(e)?c(this).attr(h.attributes[a],b.substr(e.length)):0===b.indexOf(f)&&c(this).attr(h.attributes[a],b.substr(f.length)))}})}}});c.ui.editor.registerUi({clean:{init:function(a){return a.uiButton({title:g("Remove unnecessary markup from editor content"),click:function(){a.getPlugin("clean").clean()}})}}});c.ui.editor.registerUi({clearFormatting:{init:function(a){return this.editor.uiButton({title:g("Clear Formatting"),click:function(){var b=i.getSelection();if(0<b.rangeCount){var d=b.getRangeAt(0).cloneRange(),
...
b,c){var e={},f;for(f in c)a.css(f,b.css(f)),e[f]=b.css(f),b.css(f,c[f]);return e},revertStyle:function(a,b){for(var c in b)a.css(c,b[c])},dockToElement:function(){var a=c("<div/>").insertBefore(this.editor.getElement()).addClass(this.options.baseClass+"-docked-to-element-wrapper");this.editor.wrapper.appendTo(a);this.previousStyle=this.swapStyle(a,this.editor.getElement(),{display:"block","float":"none",clear:"none",position:"static","margin-left":0,"margin-right":0,"margin-top":0,"margin-bottom":0,
...
b){a.bind("cancel",this.cancel,this);a.bind("destroy",this.cancel,this);return a.uiButton({title:g("Show Guides"),icon:"ui-icon-pencil",click:function(){a.getElement().toggleClass(b.baseClass+"-visible")}})},cancel:function(){this.editor.getElement().removeClass(this.options.baseClass+"-visible")}}});c.ui.editor.registerUi({undo:{init:function(a){a.bind("change",this.change,this);return a.uiButton({title:g("Step Back"),disabled:!0,click:function(){a.historyBack()}})},change:function(){0===this.editor.present?
this.ui.disable():this.ui.enable()}},redo:{init:function(a){a.bind("change",this.change,this);return this.ui=a.uiButton({title:g("Step Forward"),disabled:!0,click:function(){a.historyForward()}})},change:function(){this.editor.present===this.editor.history.length-1?this.ui.disable():this.ui.enable()}}});c.ui.editor.registerPlugin("hotkeys",{options:{actions:[{ui:"textBold",key:"b",label:g("ctrl + b")},{ui:"textItalic",key:"i",label:g("ctrl + i")},{ui:"textUnderline",key:"u",label:g("ctrl + u")},{ui:"undo",
key:"z",label:g("ctrl + z")},{ui:"redo",key:"y",label:g("ctrl + y")},{ui:"cancel",meta:!1,key:27,label:g("esc")},{ui:"save",key:"s",label:g("ctrl + s")}]},indexedActions:{},keyUpEventSignature:null,keyDownEventSignature:null,init:function(a){this.keyUpEventSignature="keyup."+this.options.baseClass;this.keyDownEventSignature="keydown."+this.options.baseClass;a.bind("enabled",this.enabled,this);a.bind("disabled",this.disabled,this)},disabled:function(){c(j).unbind(this.keyUpEventSignature);c(j).unbind(this.keyDownEventSignature);
...
0)}});c.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:g("Insert Horizontal Rule"),click:function(){a.replaceSelection("<hr/>")}})}}});c.ui.editor.registerUi({i18n:{init:function(a){var b=this,d=this.persist("locale");d&&o(d);var d=c('<select autocomplete="off" name="i18n"/>'),e;for(e in r){var f=c('<option value="'+e+'" class="'+e+'"/>');f.html(v[e]);l===e&&f.attr("selected","selected");d.append(f)}return a.uiSelectMenu({title:g("Change Language"),select:d,change:function(a){o(b.persist("locale",
a))}})}}});n("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"Apply Source","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",Blockquote:"Blockquote",Bold:"Bold",Cancel:"Cancel","Center Align":"Center Align","Change HTML tag of selected element":"Change HTML tag of selected element",
...
"{{images}} image(s) have been replaced with resized versions":"{{images}} image(s) a(ont) \u00e9t\u00e9 remplac\u00e9e(s) par une version redimensionn\u00e9e","{{sentences}} sentences":"{{sentences}} phrases","{{words}} word":"{{words}} mot","{{words}} words":"{{words}} mots"});n("zh_CN","\u7b80\u4f53\u4e2d\u6587",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!",
...
"{{characters}} characters, {{charactersRemaining}} remaining":"{{characters}} characters, {{charactersRemaining}} remaining","{{images}} image(s) have been replaced with resized versions":"{{images}} image(s) have been replaced with resized versions","{{sentences}} sentences":"{{sentences}} sentences","{{words}} word":"{{words}} word","{{words}} words":"{{words}} words"});c.ui.editor.registerPlugin("imageResize",{options:{allowOversizeImages:!1,manuallyResizingClass:"",resizeButtonClass:"",resizingClass:""},
init:function(a){this.options=c.extend(this.options,{manuallyResizingClass:this.options.baseClass+"-manually-resize",resizeButtonClass:this.options.baseClass+"-resize-button",resizingClass:this.options.baseClass+"-in-progress"});a.bind("enabled",this.bind,this)},bind:function(){this.options.allowOversizeImages||(this.addImageListeners(),this.editor.bind("change",this.scanForOversizedImages,this),this.editor.bind("save",this.save,this));this.editor.bind("destroy",this.cancel,this);this.editor.bind("cancel",
this.cancel,this);this.editor.getElement().on("mouseenter."+this.options.baseClass,"img",c.proxy(this.imageMouseEnter,this));this.editor.getElement().on("mouseleave."+this.options.baseClass,"img",c.proxy(this.imageMouseLeave,this))},unbind:function(){this.options.allowOversizeImages||(this.removeImageListeners(),this.editor.unbind("change",this.scanForOversizedImages,this));this.editor.getElement().off("mouseenter."+this.options.baseClass,"img");this.editor.getElement().off("mouseleave."+this.options.baseClass,
...
a.resized)})},imageResizedByUser:function(a){var b=c(a.target);b.is("img")&&b.attr("_moz_resizing")&&"style"==a.attrName&&a.newValue.match(/width|height/)&&this.editor.fire("change")},scanForOversizedImages:function(){var a=this.editor.getElement(),b=[];c(a.find("img")).each(function(){a.width()<c(this).outerWidth()&&b.push(c(this))});b.length&&this.resizeOversizedImages(b,a.width())},resizeOversizedImages:function(a,b){for(var d=c("<a>",{href:"",target:"_blank"}),e=0;e<a.length;e++){var f=a[e],g=
f.outerWidth();f.outerHeight();var i=Math.min(b/g),g=Math.round(Math.abs(i*(g-(f.outerWidth()-f.width()))));f.addClass(this.options.resizingClass);d=d.html(f.attr("title")||f.attr("src").substr(f.attr("src").lastIndexOf("/")+1)).attr("href",f.attr("src"));c(f).css({width:g});var j=this;this.showOversizeWarning(m(c(d)),{hide:function(){f.removeClass(j.options.resizingClass)}})}},cancel:function(){this.removeClasses();this.removeToolsButtons();this.unbind()},save:function(){this.removeClasses(this.options.resizingClass);
this.removeToolsButtons();this.unbind()},showOversizeWarning:function(a,b){this.editor.showInfo(g('The image "{{image}}" is too large for the element being edited.<br/>It will be replaced with a resized copy when your edits are saved.',{image:a}),b)},removeClasses:function(a){a||(a=[this.options.resizingClass,this.options.manuallyResizingClass]);c.isArray(a)||(a=[a]);for(var b=0;b<a.length;b++)this.editor.getElement().find("img."+a[b]).removeClass(a[b])},manuallyResizeImage:function(){this.removeToolsButtons();
var a=this.editor.getElement().find("img."+this.options.manuallyResizingClass),b=c(a).innerWidth(),d=c(a).innerHeight(),e="#"+this.options.baseClass+"-width",f="#"+this.options.baseClass+"-height",h=this,i=function(b){b=Math.round(b||c(e).val())+"px";c(a).css({width:b})},j=c(this.editor.getTemplate("imageresize.manually-resize-image",{width:b,height:d,baseClass:this.options.baseClass}));j.dialog({modal:!0,resizable:!1,title:g("Modify Image Size"),autoOpen:!0,buttons:[{text:g("Resize Image"),click:function(){i();
c(this).dialog("close")}},{text:g("Cancel"),click:function(){c(this).dialog("close")}}],close:function(){i(b);h.editor.checkChange();c(j).remove()},open:function(){var a=c(this).find(e),g=c(this).find(f);a.keyup(function(){g.val(Math.round(Math.abs(d/b*c(this).val())));i()});g.keyup(function(){a.val(Math.round(Math.abs(b/d*c(this).val())));i()})}})},displayToolsButtonRelativeToImage:function(a){var b=c("<button/>").appendTo("body").addClass(this.options.resizeButtonClass).button({text:!1,icons:{primary:"ui-icon-tools"}});
b.css({position:"absolute",left:c(a).position().left+c(a).innerWidth()-c(b).outerWidth()-10+"px",marginTop:"10px"}).click(c.proxy(this.manuallyResizeImage,this));c(a).before(b)},removeToolsButtons:function(){this.editor.getElement().find("."+this.options.resizeButtonClass).each(function(){c(this).remove()})},imageMouseEnter:function(a){c(a.target).addClass(this.options.manuallyResizingClass);this.displayToolsButtonRelativeToImage(a.target)},imageMouseLeave:function(a){c(a.relatedTarget).hasClass(this.options.resizeButtonClass)||
(c(a.target).removeClass(this.options.manuallyResizingClass),this.removeToolsButtons())}});c.ui.editor.registerUi({length:{ui:null,options:{length:150},init:function(a){a.bind("show",c.proxy(this.updateCount,this));a.bind("change",c.proxy(this.updateCount,this));return this.ui=this.editor.uiButton({title:g("Remaining characters before the recommended character limit is reached"),label:g("Initializing"),text:!0,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var a=
this.options.length-c("<div/>").html(this.editor.getCleanHtml()).text().length,b=this.ui.button,d=null,d=0<=a?g("{{charactersRemaining}} characters remaining",{charactersRemaining:a}):g("{{charactersRemaining}} characters over limit",{charactersRemaining:-1*a});b.button("option","label",d);b.button("option","text",!0);0>a?b.addClass("ui-state-error"):0<=a&&15>=a?b.addClass("ui-state-highlight").removeClass("ui-state-error"):b.removeClass("ui-state-highlight ui-state-error")},showStatistics:function(){this.processTemplate().dialog({modal:!0,
resizable:!1,title:g("Content Statistics"),dialogClass:this.editor.options.dialogClass+" "+this.editor.options.baseClass,show:this.editor.options.dialogShowAnimation,hide:this.editor.options.dialogHideAnimation,buttons:[{text:g("OK"),click:function(){c(this).dialog("close")}}],open:function(){c(this).parent().find(".ui-dialog-buttonpane").find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}})},close:function(){c(this).dialog("destroy").remove()}})},processTemplate:function(){var a=
c("<div/>").html(this.editor.getCleanHtml()).text(),b=null,d=this.options.length-a.length,b=0>d?g("Content contains more than {{limit}} characters and may be truncated",{limit:this.options.length}):g("Content will not be truncated"),e=null,e=a.split(" ").length,e=1==e?g("{{words}} word",{words:e}):g("{{words}} words",{words:e}),f=null,f=a.split(". ").length,f=g("{{sentences}} sentences",{sentences:f}),h=null,h=0<=d?g("{{characters}} characters, {{charactersRemaining}} remaining",{characters:a.length,
charactersRemaining:d}):g("{{characters}} characters, {{charactersRemaining}} over the recommended limit",{characters:a.length,charactersRemaining:-1*d});return c(this.editor.getTemplate("length.dialog",{characters:h,words:e,sentences:f,truncation:b}))}}});c.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:g("Page on this or another website"),focusSelector:'input[name="location"]',init:function(){this.content=this.plugin.editor.getTemplate("link.external",
...
this.options.customTypes),d,e=0;e<b.length;e++)d=c.extend({},a,b[e],{classes:this.options.baseClass+"-"+b[e].type}).init(),this.types[d.type]=d},show:function(){if(!this.visible){this.selectedElement=this.editor.getSelectedElements().first();var a=this.selectedElement.is("a"),b=this.options,d=i.saveSelection(),e=this,f=this.dialog=c(this.editor.getTemplate("link.dialog",b)).appendTo("body");this.initTypes();var h=this.dialog.find("fieldset"),j;for(j in this.types)c(this.editor.getTemplate("link.label",
this.types[j])).appendTo(h);h.find('input[type="radio"]').bind("change."+this.editor.widgetName,function(){e.typeChange(e.types[c(this).val()],a)});f.dialog({autoOpen:!1,modal:!0,resizable:!0,width:b.dialogWidth,minWidth:b.dialogMinWidth,height:b.dialogHeight,title:a?g("Edit Link"):g("Insert Link"),dialogClass:b.baseClass+" "+b.dialogClass,buttons:[{text:a?g("Update Link"):g("Insert Link"),click:function(){i.restoreSelection(d);e.apply(a)?c(this).dialog("close"):d=i.saveSelection()}},{text:g("Cancel"),
click:function(){i.restoreSelection(d);c(this).dialog("close")}}],beforeopen:function(){e.dialog.find("."+e.options.baseClass+"-content").hide()},open:function(){e.visible=!0;var b=f.parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});var d=f.find('.ui-editor-link-menu input[type="radio"]');d.first().attr("checked","checked");var g=!1;if(a)for(var h in e.types)if(g=e.types[h].editing(e.selectedElement)){d.filter('[value="'+
h+'"]').attr("checked","checked");e.typeChange(e.types[h],a);break}(!a||a&&!g)&&e.typeChange(e.types[d.filter(":checked").val()],a);c(this).unbind("keyup."+e.editor.widgetName).bind("keyup."+e.editor.widgetName,function(a){13==a.keyCode&&(a=e.types[d.filter(":checked").val()],(!c.isFunction(a.validate)||a.validate(e.dialog.find("."+e.options.baseClass+"-content")))&&b.find("button:eq(0)").trigger("click"))})},close:function(){e.visible=!1;f.find("."+b.baseClass+"-content").hide();c(this).dialog("destroy")}}).dialog("open")}},
apply:function(a){var b=this.types[this.dialog.find('input[type="radio"]:checked').val()],d=b.attributes(this.dialog.find("."+this.options.baseClass+"-content"),a);if(!d)return!0;var e=m(c("<a>"+(d.title?d.title:d.href)+"</a>").attr(c.extend({},d,{target:"_blank"})));a?(this.selectedElement[0].className=this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(b.classes).attr(d),this.editor.showConfirm(g("Updated link: {{link}}",{link:e}))):
(this.editor.wrapTagWithAttribute("a",c.extend(d,{id:this.editor.getUniqueId()}),b.classes),this.editor.showConfirm(g("Added link: {{link}}",{link:e})),this.selectedElement=c("#"+d.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",d.href);return!0},typeChange:function(a,b){var d=this.dialog.find("."+this.options.baseClass+"-content"),e=d.closest("."+this.options.baseClass+"-wrap"),f=a.ajaxUri&&!this.types[a.type].content;f&&e.addClass(this.options.baseClass+"-loading");
var g=this;d.hide(this.options.panelAnimation,function(){f?c.ajax({url:a.ajaxUri,type:"get",success:function(f){d.html(f);g.types[a.type].content=f;e.removeClass(g.options.baseClass+"-loading");a.show(d,b);d.show(g.options.panelAnimation,c.proxy(a.focus,a))}}):(d.html(a.content),a.show(d,b),d.show(g.options.panelAnimation,c.proxy(a.focus,a)))})},remove:function(){this.editor.unwrapParentTag("a")},repairLinks:function(){var a=this;this.editor.getElement().find('a[class^="'+this.options.baseClass+'"]').each(function(){c(this).data(a.options.baseClass+
"-href")&&c(this).attr("href",c(this).data(a.options.baseClass+"-href"))})},cancel:function(){this.dialog&&c(this.dialog.dialog("close"))}});c.ui.editor.registerUi({link:{init:function(a){a.bind("selectionChange",this.change,this);return a.uiButton({title:g("Insert Link"),click:function(){a.getPlugin("link").show()}})},change:function(){this.editor.getSelectedElements().length?this.ui.enable():this.ui.disable()}},unlink:{init:function(a){a.bind("selectionChange",this.change,this);a.bind("show",this.change,
this);return a.uiButton({title:g("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){this.editor.getSelectedElements().is("a")?this.ui.enable():this.ui.disable()}}});c.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),
toggleList:function(a){c(this.editor.getSelectedElements()).is("li")&&c(this.editor.getSelectedElements()).parent().is(a)?this.unwrapList():this.wrapList(a);this.editor.fire("selectionChange");this.editor.fire("change")},unwrapList:function(){this.editor.saveSelection();var a=[],b=[],d=this.editor.getSelectionStartElement(),e=this.editor.getSelectionEndElement();a.push(c(d).html());b.push(d);if(c(d)[0]!==c(e)[0]){var f=d;do f=c(f).next(),a.push(c(f).html()),b.push(f);while(c(f)[0]!==c(e)[0])}f=0===
c(d).prev().length;e=0===c(e).next().length;d=c(d).parent();for(listElementsIndex=0;listElementsIndex<b.length;listElementsIndex++)c(b[listElementsIndex]).remove();for(b=0;b<a.length;b++)d.parent().is("li")||(a[b]="<p>"+a[b]+"</p>");f&&e?(d.replaceWith(a.join("")),this.editor.restoreSelection(),this.editor.selectOuter(this.editor.getSelectedElements()[0])):(f?c(d).before(a.join("")):e?c(d).after(a.join("")):this.editor.replaceSelectionSplittingSelectedElement(a.join("")),this.editor.restoreSelection(),
this.editor.checkChange())},wrapList:function(a){this.editor.constrainSelection(this.editor.getElement());""===c.trim(this.editor.getSelectedHtml())&&this.editor.selectInner(this.editor.getSelectedElements());var b=c("<div>").html(this.editor.getSelectedHtml()),d=[],e=this;c(b).contents().each(function(){var a;a="block"===e.getElementDefaultDisplay(this.tagName)?e.editor.stripTags(c(this).html(),e.validChildren):e.editor.stripTags(m(c(this)),e.validChildren);a=c("<li>"+a+"</li>");""!==c.trim(a.text())&&
d.push(m(a))});b=this.options.baseClass+"-selection";a="<"+a+' class="'+b+'">'+d.join("")+"</"+a+">";this.editor.restoreSelection();var f=c(this.editor.getSelectedElements()[0]).parent(),g=this.editor.getElement()[0];f===g||this.editor.getSelectedElements()[0]===g?this.editor.replaceSelection(a):this.editor.replaceSelectionWithinValidTags(a,this.validParents);this.editor.selectInner(c(this.editor.getElement().find("."+b).removeClass(b)).find("li:first")[0]);this.editor.checkChange()},getElementDefaultDisplay:function(a){var b,
a=document.createElement(a);b="getComputedStyle"in j;document.body.appendChild(a);b=(b?j.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return b}});c.ui.editor.registerUi({listUnordered:{init:function(a){return a.uiButton({title:g("Unordered List"),click:function(){a.getPlugin("list").toggleList("ul")}})}},listOrdered:{init:function(a){return a.uiButton({title:g("Ordered List"),click:function(){a.getPlugin("list").toggleList("ol")}})}}});c.ui.editor.registerUi({logo:{ui:null,
init:function(){return this.ui=this.editor.uiButton({title:g("Learn More About the Raptor WYSIWYG Editor"),click:function(){j.open("http://www.jquery-raptor.com/about/editors/","_blank")},ready:function(){var a=function(b){var d=typeof b;if("object"!=d||null===b)return"string"==d&&(b='"'+b+'"'),""+b;var e=[],g=b&&c.isArray(b);c.each(b,function(b,c){d=typeof c;"string"==d?c='"'+c+'"':"object"==d&null!==c&&(c=a(c));e.push((g?"":'"'+b+'":')+(""+c))});return(g?"[":"{")+(""+e)+(g?"]":"}")},b={enableUi:this.options.enableUi,
enablePlugins:this.options.enablePlugins,disabledPlugins:a(this.options.disabledPlugins),ui:a(this.options.ui),t:(new Date).getTime()},d=[],e;for(e in b)d.push(e+"="+encodeURIComponent(b[e]));this.ui.button.find(".ui-button-icon-primary").css({"background-image":"url(http://www.jquery-raptor.com/logo/0.0.9?"+d.join("&")+")"})}})}}});c.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span,hr,br".split(","),allowedAttributes:["href","title"],allowedEmptyTags:["hr",
"br"]},init:function(a,b){var d=!1,e=!1,f=this;a.getElement().bind("paste."+a.widgetName,c.proxy(function(){if(d)return!1;d=!0;a.saveSelection();c(".uiWidgetEditorPasteBin").length&&c(".uiWidgetEditorPasteBin").remove();c('<div class="uiWidgetEditorPasteBin" contenteditable="true" style="width: 1px; height: 1px; overflow: hidden; position: fixed; top: -1px;" />').appendTo("body");c(".uiWidgetEditorPasteBin").focus();j.setTimeout(function(){var h=c(".uiWidgetEditorPasteBin").html(),h=f.filterAttributes(h),
h=f.filterChars(h),h=f.stripEmpty(h),h=f.stripAttributes(h),h=f.editor.stripTags(h,f.options.allowedTags),h={plain:c("<div/>").html(c(".uiWidgetEditorPasteBin").html()).text(),markup:h,html:c(".uiWidgetEditorPasteBin").html()};e=c(a.getTemplate("paste.dialog",h));e.find(".ui-editor-paste-area").bind("keyup."+a.widgetname,function(){f.updateAreas(this,e)});c(e).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:b.dialogShowAnimation,hide:b.dialogHideAnimation,dialogClass:b.baseClass+
" "+b.dialogClass,buttons:[{text:g("Insert"),click:function(){var b=null,b=c(this).find(".ui-editor-paste-area:visible"),b=b.hasClass("ui-editor-paste-plain")||b.hasClass("ui-editor-paste-source")?b.val():b.html(),b=f.filterAttributes(b),b=f.filterChars(b);a.restoreSelection();a.replaceSelection(b);d=!1;c(this).dialog("close")}},{text:g("Cancel"),click:function(){a.restoreSelection();d=!1;c(this).dialog("close")}}],open:function(){var a=c(this).find(".ui-editor-paste-panel-tabs");a.find("ul.ui-tabs-nav li").click(function(){a.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
...
init:function(a){a.bind("selectionChange",this.change,this);a.bind("show",this.change,this);return a.uiSelectMenu({name:"tagMenu",title:g("Change HTML tag of selected element"),select:c(a.getTemplate("tagmenu.menu")),change:function(b){if(!("undefined"===typeof b||"na"===b)){var d=a.getElement()[0],e=a.getSelectedElements();if(!a.getSelectedHtml()||""===a.getSelectedHtml()){if(c(e)[0]===c(d)[0])return;a.saveSelection();d=c("<"+b+">").html(e.html());e.replaceWith(d);a.restoreSelection()}else{var e=
c(a.getSelectedElements()[0]).parent(),f=this.options.baseClass+"-selection",b=c("<"+b+">").html(a.getSelectedHtml()).addClass(f);e===d||a.getSelectedElements()[0]===d?a.replaceSelection(b):a.replaceSelectionWithinValidTags(b,this.validParents);a.selectInner(a.getElement().find("."+f).removeClass(f))}a.checkChange()}}})},change:function(){var a=this.editor.getSelectedElements()[0];a?(a=a.tagName.toLowerCase(),this.ui.select.find("option[value="+a+"]").length?this.ui.val(a):this.ui.val("na"),c(this.ui.button).toggleClass("ui-state-disabled",
this.editor.getElement()[0]===this.editor.getSelectedElements()[0])):c(this.ui.button).toggleClass("ui-state-disabled",!0)}}});c.ui.editor.registerPlugin("toolbarTip",{init:function(){c.browser.msie||this.bind("show, tagTreeUpdated",function(){c(".ui-editor-wrapper [title]").each(function(){c(this).attr("data-title",c(this).attr("title"));c(this).removeAttr("title")})})}});(function(){var a=null,b=0;c.ui.editor.registerPlugin("unsavedEditWarning",{init:function(d){var e=this;a||(a=c(d.getTemplate("unsavededitwarning.warning",
this.options)).attr("id",d.getUniqueId()).appendTo("body").bind("mouseenter."+d.widgetName,function(){c.ui.editor.eachInstance(function(a){a.isDirty()&&a.getElement().addClass(e.options.baseClass+"-dirty")})}).bind("mouseleave."+d.widgetName,function(){c("."+e.options.baseClass+"-dirty").removeClass(e.options.baseClass+"-dirty")}));d.bind("dirty",function(){b++;0<b&&(u(a),a.addClass(e.options.baseClass+"-visible"))});d.bind("cleaned",function(){b--;0===b&&a.removeClass(e.options.baseClass+"-visible")})}})})();
c.ui.editor.registerUi({viewSource:{init:function(a){return a.uiButton({title:g("View / Edit Source"),click:function(){this.show()}})},show:function(){var a=this,b=c(this.editor.getTemplate("viewsource.dialog",{baseClass:a.options.baseClass,source:a.editor.getHtml()})),d=this.ui.button;c(d).button("option","disabled",!0);b.dialog({modal:!1,width:600,height:400,resizable:!0,title:g("View Source"),autoOpen:!0,dialogClass:a.options.baseClass+" "+a.options.dialogClass,buttons:[{text:g("Apply Source"),
click:function(){var b=c(this).find("textarea").val();a.editor.setHtml(b);c(this).find("textarea").val(a.editor.getHtml())}},{text:g("Close"),click:function(){c(this).dialog("close")}}],open:function(){var a=c(this).parent().find(".ui-dialog-buttonpane");a.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});a.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){c(this).dialog("destroy").remove();c(d).button("option","disabled",!1);a.editor.checkChange()}})}}})})(jQuery,
window,rangy);
