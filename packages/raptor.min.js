...
*/
(function(c,l,i,H){function v(a,b,d){z[a]=d;O[a]=b;q||(q=a)}function P(a){q!==a&&(q=a,c.ui.editor.eachInstance(function(){this.reinit()}))}function g(a,b){q&&z[q]&&z[q][a]&&(a=z[q][a]);if(!b)return a;for(var d in b)a=a.replace("{{"+d+"}}",b[d]);return a}function Y(a){if(C===H){C=!0;if(Q=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))c("html").addClass(a.options.baseClass+"-ios"),Q&&c(document).bind("scroll",function(){setInterval(function(){c("body").css("height","+=1").css("height",
"-=1")},0)});c.browser.mozilla&&c("html").addClass(a.options.baseClass+"-ff");if(c.browser.msie&&9>c.browser.version){C=!1;var b=c("<div/>").addClass(a.options.baseClass+"-unsupported").html(a.getTemplate("unsupported")).appendTo("body");I(b);b.find("."+a.options.baseClass+"-unsupported-close").click(function(){b.remove()})}}return C}function I(a){var b=1;a.siblings().each(function(){var a=c(this).css("z-index");!isNaN(a)&&a>b&&(b=a+1)});a.css("z-index",b)}function o(a){return a.clone().wrap("<div/>").parent().html()}
function D(a){var b,a=document.createElement(a);b="getComputedStyle"in l;document.body.appendChild(a);b=(b?l.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return b}function E(a,b){return-1!==c.inArray(c(a)[0].tagName.toLowerCase(),b)}function R(a){for(var b={},a=l.getComputedStyle(a[0],null),d=0;d<a.length;d++)b[a.item(d)]=a.getPropertyValue(a.item(d));return b}function u(a,b){for(var d="",e=0,f=a.childNodes.length;e<f;e++){var h=a.childNodes.item(e);(h=3===h.nodeType?
h.nodeValue:o(c(h)))&&(d+=h)}b&&(d=c("<"+b+">"+d+"</"+b+">"),d.find("p").wrapInner("<"+b+"/>"),d.find("p > *").unwrap(),d=c("<div/>").html(d).html());return d}function S(a,b){var d=c("<div/>").append(a)[0].childNodes;b.deleteContents();d.length===H||1===d.length?b.insertNode(d[0].cloneNode(!0)):c.each(d,function(a,d){b.insertNodeAtEnd(d.cloneNode(!0))})}function T(a){var a=a||i.getSelection(),b;c(a.getAllRanges()).each(function(a,e){b=3===this.commonAncestorContainer.nodeType?c(e.commonAncestorContainer).parent()[0]:
e.commonAncestorContainer});return b}function U(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer}function p(a){if(!r||a)r=i.saveSelection()}function n(){r&&(i.restoreSelection(r),r=!1)}function F(){r&&i.removeMarkers(r);r=!1}function k(a,b,d){for(var b=b||i.getSelection(),c,f=0;c=b.getAllRanges()[f++];)a.call(d,c)}function t(a,b){k(function(b){S(a,b)},b,this)}function A(a,b){b=b||i.getSelection();b.removeAllRanges();c(a).focus().contents().each(function(){var a=i.createRange();
a.selectNodeContents(this);b.addRange(a)})}function w(a,b){b=b||i.getSelection();b.removeAllRanges();c(a).each(function(){var a=i.createRange();a.selectNode(this);b.addRange(a)}).focus()}function J(a,b,d){b=b||i.getSelection();b.removeAllRanges();c(a).each(function(){var a=i.createRange();a.selectNodeContents(this);a.collapse(d);b.addRange(a)})}function V(a,b){J(a,b,!1)}function x(a,b){J(a,b,!0)}function y(a){a=a||i.getSelection();return a.toHtml()}function W(a){a=a||i.getSelection().getRangeAt(0);
return c(3===a.commonAncestorContainer.nodeType?a.commonAncestorContainer.parentNode:a.commonAncestorContainer)}function j(a){var b=new jQuery;k(function(a){b.push(W(a)[0])},a,this);return b}function K(){var a=i.getSelection();if(null===a.anchorNode)return null;if(a.isBackwards())return 3===a.focusNode.nodeType?c(a.focusNode.parentElement):c(a.focusNode);a.anchorNode||console.trace();return 3===a.anchorNode.nodeType?c(a.anchorNode.parentElement):c(a.anchorNode)}function L(){var a=i.getSelection();
...
{}).append(u(e.cloneContents())),S(f,e)):d.toggleRange(e)},null,this)}function Z(a,b,d){k(function(c){c=W(c);c.is(a)?c.attr(b):s(a,{classes:d,attributes:b})},null,this)}function M(a,b){var b=b||i.getSelection(),d=b.getRangeAt(0),e=j()[0],f=i.createRange();f.setStartBefore(e);f.setEnd(d.startContainer,d.startOffset);var f=f.cloneContents(),h=i.createRange();h.setStart(d.endContainer,d.endOffset);h.setEndAfter(e);d=h.cloneContents();f=o(c(u(f)));f+=o(c(a));f+=o(c(u(d)));c(e).replaceWith(c(f))}function B(a,
b,c){var c=c||i.getSelection(),e=K()[0],f=L()[0],h=j()[0],h=E(h,b),e=E(e,b),b=E(f,b);h&&e&&b?t(a):M(a,c)}function G(a,b){allowed=[];for(var c=0;c<b.length;c++)b[c].match(/[a-z][a-z0-9]{0,}/g)&&allowed.push(b[c]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,b){return-1<allowed.indexOf(b.toLowerCase())?a:""})}var q=null,z={},O={};c(function(){i.initialized||i.init();c.isFunction(i.rangePrototype.insertNodeAtEnd)||(i.rangePrototype.insertNodeAtEnd=
function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});c("html").click(function(){c(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});c.widget("ui.editor",{_init:function(){-1===c.inArray(this,c.ui.editor.instances)&&c.ui.editor.instances.push(this);var a=this;this.options=c.extend({},c.ui.editor.defaults,this.options);this.options.uiOrder=this.options.uiOrder||[["logo"],["save","cancel"],["dock","showGuides","clean"],["viewSource"],
...
!1;this.events={};this.ui={};this.plugins={};this.templates=c.extend({},c.ui.editor.templates);this.path=this.toolbarWrapper=this.toolbar=this.wrapper=null;this.visible=this.enabled=!1;this.uiObjects={};this.hotkeys={};this.options.enableHotkeys&&this.registerHotkey(this.hotkeys);for(var b in this.options.bind)this.bind(b,this.options.bind[b]);this.history=[];this.present=0;this.historyEnabled=!0;Y(this)&&(this.cloneDomTools(),this.setOriginalHtml(this.element.is(":input")?this.element.val():this.element.html()),
this.element.is("textarea, input")&&this.replaceOriginal(),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,this.ready=!0,this.fire("ready"),this.options.autoEnable&&c(function(){a.enableEditing();a.showToolbar()}))},attach:function(){this.bind("change",this.historyPush);this.bind("selectionChange",this.updateTagTree);this.bind("show",this.updateTagTree);var a=c.proxy(this.checkChange,this);this.getElement().find("img").bind("click."+this.widgetName,
c.proxy(function(a){w(a.target)},this));this.getElement().bind("mouseup."+this.widgetName,a);this.getElement().bind("keyup."+this.widgetName,a);c(l).bind("beforeunload",c.proxy(c.ui.editor.unloadWarning,c.ui.editor))},reinit:function(){if(this.ready){var a=this.enabled,b=this.visible;this.destruct(!0);this._init();a&&this.enableEditing();b&&this.showToolbar()}else{var c;c=function(){this.unbind("ready",c);this.reinit()};this.bind("ready",c)}},getElement:function(){return this.target?this.target:this.element},
getOriginalElement:function(){return this.element},replaceOriginal:function(){if(!this.target){for(var a=c("<div/>").html(this.element.is(":input")?this.element.val():this.element.html()).insertBefore(this.element).attr("id",this.getUniqueId()).addClass(this.element.attr("class")),b=R(this.element),d=0;d<this.options.replaceStyle.length;d++)a.css(this.options.replaceStyle[d],b[this.options.replaceStyle[d]]);this.element.hide();this.bind("change",function(){this.element.is("input, textarea")?this.element.val(this.getHtml()):
...
b){a.children().each(function(){var a=c.map(this.attributes,function(a){if(-1===c.inArray(a.name,b))return a.name}),e=c(this);c.each(a,function(a,b){e.removeAttr(b)});element.removeAttributes(c(this),b)});return a},elementBringToTop:I,elementOuterHtml:o,elementOuterText:function(a){return a.clone().wrap("<div/>").parent().text()},elementIsBlock:function(a){return"block"===D(a.tagName)},elementDefaultDisplay:D,elementIsValid:E,elementGetStyles:R,fragmentToHtml:u,fragmentInsertBefore:function(a,b,d){for(var e=
0,f=a.childNodes.length;e<f;e++){var h=a.childNodes.item(e);(h=3===h.nodeType?h.nodeValue:c(h).html())&&c("<"+d+"/>").html(c.trim(h)).insertBefore(b)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},rangeGetCommonAncestor:T,rangeIsEmpty:U,selectionSave:p,selectionRestore:n,selectionDestroy:F,selectionEachRange:k,selectionReplace:t,selectionSelectInner:A,selectionSelectOuter:w,selectionSelectEdge:J,selectionSelectEnd:V,selectionSelectStart:x,selectionGetHtml:y,
selectionGetElements:j,selectionToggleWrapper:s,selectionExists:function(a){var b=!1;k(function(a){U(a)||(b=!0)},a,this);return b},selectionReplaceSplittingSelectedElement:M,selectionReplaceWithinValidTags:B,stringStripTags:G,defaults:{plugins:{},ui:{},bind:{},domTools:{constrainSelection:function(a,b){var a=c(a)[0],b=b||i.getSelection(),d;c(b.getAllRanges()).each(function(e,f){d=3===this.commonAncestorContainer.nodeType?c(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;a!==d&&!c.contains(a,
d)&&b.removeRange(f)})},unwrapParentTag:function(a){j().each(function(){c(this).is(a)&&c(this).replaceWith(c(this).html())})},execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(e){}},insertTag:function(a,b){k(function(b){b.insertNode(c("<"+a+"/>")[0])},b,this)},insertTagAtEnd:function(a,b){k(function(b){b.insertNodeAtEnd(c("<"+a+"/>")[0])},b,this)},insertElement:function(a,b,d){k(function(d){c(a).each(function(){d.insertNode(!1===b?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(a,
b,d){k(function(d){c(a).each(function(){d.insertNodeAtEnd(!1===b?this:this.cloneNode(!0))})},d,this)},toggleBlockStyle:function(a,b){k(function(d){for(d=c(d.commonAncestorContainer);d.length&&d[0]!==b[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===b[0]&&"inline"!==b.css("display")&&(this.wrapInner(b,"div"),d=b.children().first());this.toggleStyle(d,a)},null,this)},wrapInner:function(a,b){p();c(a).each(function(){var d=c("<"+b+"/>").html(c(this).html());a.html(d)});n()},
inverseWrapWithTagClass:function(a,b,d,e){p();var f="domTools"+Math.ceil(1E7*Math.random());k(function(a){var c=i.createCssClassApplier(e,{elementTagName:d});c.isAppliedToRange(a)?c.toggleSelection():i.createCssClassApplier(b,{elementTagName:f}).toggleSelection()},null,this);c(f).each(function(){c(this).replaceWith(c("<"+a+"/>").addClass(b).html(c(this).html()))});n()},toggleStyle:function(a,b){c.each(b,function(b,e){c(a).css(b)===e?c(a).css(b,""):c(a).css(b,e)})},swapStyles:function(a,b,c){for(var e in c)a.css(e,
...
this.destroy,this)},show:function(){this.enabled?this.isDocked()&&this.showSpacers():((this.loadState()||this.options.docked)&&this.dock(),this.enabled=!0)},hide:function(){this.hideSpacers();this.editor.toolbar.css("width","auto")},showSpacers:function(){!this.options.dockToElement&&this.editor.toolbar.is(":visible")&&(this.topSpacer=c("<div/>").addClass(this.options.baseClass+"-top-spacer").height(this.editor.toolbar.outerHeight()).prependTo("body"),this.bottomSpacer=c("<div/>").addClass(this.options.baseClass+
"-bottom-spacer").height(this.editor.path.outerHeight()).appendTo("body"),this.editor.fire("resize"))},hideSpacers:function(){this.topSpacer&&(this.topSpacer.remove(),this.topSpacer=null);this.bottomSpacer&&(this.bottomSpacer.remove(),this.bottomSpacer=null);this.editor.fire("resize")},swapStyle:function(a,b,c){var e={},f;for(f in c)a.css(f,b.css(f)),e[f]=b.css(f),b.css(f,c[f]);return e},revertStyle:function(a,b){for(var c in b)a.css(c,b[c])},getDockToElementWrapper:function(){var a=this.options.baseClass+
"-docked-to-element-wrapper-"+this.editor.getElement().attr("id");wrapper=c("#"+a);wrapper.length||(wrapper=c("<div/>").insertBefore(this.editor.getElement()).addClass(this.options.baseClass+"-docked-to-element-wrapper").attr("id",a));return wrapper},dockToElement:function(){wrapper=this.getDockToElementWrapper();this.editor.wrapper.appendTo(wrapper);this.swapStyle(wrapper,this.editor.getElement(),{display:this.editor.getElement().css("display")||"block","float":this.editor.getElement().css("float")||
...
10));this.editor.getElement().appendTo(this.editor.wrapper).addClass(this.options.baseClass+"-docked-element")},undockFromElement:function(){this.editor.getElement().insertAfter(this.editor.wrapper).removeClass(this.options.baseClass+"-docked-element");this.editor.wrapper.appendTo("body").removeClass(this.options.baseClass+"-docked-to-element");this.editor.wrapper.css("width","auto")},dockToBody:function(){var a=0;c(this.options.dockUnder).length&&(a=c(this.options.dockUnder).outerHeight());this.top=
this.editor.toolbarWrapper.css("top");this.editor.toolbarWrapper.css("top",a);this.editor.wrapper.addClass(this.options.baseClass+"-docked");this.editor.messages.css("top",a+this.editor.toolbar.outerHeight())},undockFromBody:function(){this.editor.toolbarWrapper.css("top",this.top);this.editor.wrapper.removeClass(this.options.baseClass+"-docked");this.hideSpacers()},dock:function(){if(!this.docked){this.docked=this.saveState(!0);this.options.dockToElement?this.dockToElement():this.dockToBody();var a=
...
"ui-icon-pin-w":"ui-icon-pin-s",click:function(){var b=a.getPlugin("dock");b.isDocked()?b.undock():b.dock();a.unify(function(a){a=a.getPlugin("dock");a.isDocked()?a.dock():a.undock()})}})}}});c.ui.editor.registerUi({embed:{dialog:null,init:function(a){a.bind("hide",this.hide,this);return a.uiButton({icon:"ui-icon-youtube",title:g("Embed object"),click:function(){this.show()}})},hide:function(){this.dialog&&c(this.dialog).dialog("destroy").remove();this.dialog=null;c(this.ui.button).button("option",
"disabled",!1)},show:function(){if(!this.dialog){c(this.ui.button).button("option","disabled",!0);var a=this;p();this.dialog=c(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:g("Paste Embed Code"),autoOpen:!0,dialogClass:a.options.baseClass+" "+a.options.dialogClass,buttons:[{text:g("Embed Object"),click:function(){n();t(c(this).find("textarea").val());c(this).dialog("close")}},{text:g("Close"),click:function(){a.hide()}}],open:function(){var a=
c(this).parent().find(".ui-dialog-buttonpane");a.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});a.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});var d=c(this).find(".ui-editor-embed-panel-tabs");d.find("ul li").click(function(){d.find("ul li").removeClass("ui-state-active").removeClass("ui-tabs-selected");c(this).addClass("ui-state-active").addClass("ui-tabs-selected");d.children("div").hide().eq(c(this).index()).show()});var e=c(this).find(".ui-editor-embed-preview");
c(this).find("textarea").change(function(){c(e).html(c(this).val())})},close:function(){a.hide()}})}}}});c.ui.editor.registerPlugin("emptyElement",{options:{tag:"<p/>"},init:function(){this.bind("change",this.change)},change:function(){var a=this;this.textNodes(this.editor.getElement()).each(function(){c(this).wrap(c(a.options.tag));V(this)});this.editor.checkChange()},textNodes:function(a){return c(a).contents().filter(function(){return 3==this.nodeType&&c.trim(this.nodeValue).length})}});c.ui.editor.registerUi({floatLeft:{init:function(a){return a.uiButton({title:g("Float Image Left"),
click:function(){k(function(a){c(a.commonAncestorContainer).find("img").css("float","left")})}})}},floatRight:{init:function(a){return a.uiButton({title:g("Float Image Right"),click:function(){k(function(a){c(a.commonAncestorContainer).find("img").css("float","right")})}})}},floatNone:{init:function(a){return a.uiButton({title:g("Remove Image Float"),click:function(){k(function(a){c(a.commonAncestorContainer).find("img").css("float","none")})}})}}});c.ui.editor.registerUi({fontSizeInc:{init:function(a,
...
click:function(){t("<hr/>")}})}}});c.ui.editor.registerUi({i18n:{init:function(a){var b=this,d=this.persist("locale");d&&P(d);var d=c('<select autocomplete="off" name="i18n"/>'),e;for(e in z){var f=c('<option value="'+e+'" class="'+e+'"/>');f.html(O[e]);q===e&&f.attr("selected","selected");d.append(f)}return a.uiSelectMenu({title:g("Change Language"),select:d,change:function(a){P(b.persist("locale",a))}})}}});v("de","Deutsch",{"A preview of your embedded object is displayed below.":"Eine Vorschau ihres eingebundenen Objekts wird unterhalb angezeigt.",
...
"{{words}} word":"{{words}} Wort","{{words}} words":"{{words}} W\u00f6rter"});v("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"Apply Source","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",Blockquote:"Blockquote",Bold:"Bold",Cancel:"Cancel","Center Align":"Center Align",
...
this.options.manuallyResizingClass),d=c(b).innerWidth(),e=c(b).innerHeight(),f="#"+this.options.baseClass+"-width",h="#"+this.options.baseClass+"-height",N=this,i=function(a){a=Math.round(a||c(f).val())+"px";c(b).css({width:a})},j=c(this.editor.getTemplate("imageresize.manually-resize-image",{width:d,height:e,baseClass:this.options.baseClass}));j.dialog({modal:!0,resizable:!1,title:g("Modify Image Size"),autoOpen:!0,buttons:[{text:g("Resize Image"),click:function(){i(c(this).find(f).val());c(this).dialog("close")}},
{text:g("Cancel"),click:function(){i(d);c(this).dialog("close")}}],close:function(){N.editor.checkChange();c(j).remove()},open:function(){var a=c(this).find(f),b=c(this).find(h);a.keyup(function(){b.val(Math.round(Math.abs(e/d*c(this).val())));i()});b.keyup(function(){a.val(Math.round(Math.abs(d/e*c(this).val())));i()})}});a.preventDefault();return!1},displayToolsButtonRelativeToImage:function(a){var b=c("<button>"+g("Click to edit the image")+"</button>").appendTo("body").addClass(this.options.resizeButtonClass).button({text:!1,
...
d=b.attributes(this.dialog.find("."+this.options.baseClass+"-content"),a);if(!d)return!0;n();var e=o(c("<a>"+(d.title?d.title:d.href)+"</a>").attr(c.extend({},d,{target:"_blank"})));a?(this.selectedElement[0].className=this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(b.classes).attr(d),this.editor.showConfirm(g("Updated link: {{link}}",{link:e}))):(Z("a",c.extend(d,{id:this.editor.getUniqueId()}),b.classes),this.editor.showConfirm(g("Added link: {{link}}",
...
h=f.filterAttributes(h),h=f.filterChars(h),h=f.stripEmpty(h),h=f.stripAttributes(h),h=G(h,f.options.allowedTags),h={plain:c("<div/>").html(c(".uiWidgetEditorPasteBin").html()).text(),markup:h,html:c(".uiWidgetEditorPasteBin").html()};e=c(a.getTemplate("paste.dialog",h));c(e).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:b.dialogShowAnimation,hide:b.dialogHideAnimation,dialogClass:b.baseClass+" "+b.dialogClass,buttons:[{text:g("Insert"),click:function(){var b=
