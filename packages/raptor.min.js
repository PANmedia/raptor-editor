...
var f=c("#elRaptor").css({position:"fixed",bottom:"-700px",right:"0",display:"block"});if("timer"==k.enterOn)setTimeout(i,k.delayTime);else if("click"==k.enterOn)p.bind("click",function(c){c.preventDefault();n||i()});else if("konami-code"==k.enterOn){var r=[];c(window).bind("keydown.raptorz",function(f){r.push(f.keyCode);0<=r.toString().indexOf("38,38,40,40,37,39,37,39,66,65")&&(i(),c(window).unbind("keydown.raptorz"))},!0)}})}})(jQuery);
(function(c,k,i,p){function o(a,b,d){q[a]=d;t[a]=b;m||(m=a)}function n(a){m!==a&&(m=a,c.ui.editor.eachInstance(function(){this.reinit()}))}function f(a,b){m&&q[m]&&q[m][a]&&(a=q[m][a]);if(!b)return a;for(var d in b)a=a.replace("{{"+d+"}}",b[d]);return a}function r(a){if(s===p){if(u=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))c("html").addClass(a.options.baseClass+"-ios"),u&&c(document).bind("scroll",function(){setInterval(function(){c("body").css("height","+=1").css("height","-=1")},
0)});c.browser.mozilla&&c("html").addClass(a.options.baseClass+"-ff");if(c.browser.msie){s=!1;var b=c("<div></div>").addClass(a.options.baseClass+"-unsupported").html(a.getTemplate("unsupported")).appendTo("body"),d=1;b.siblings().each(function(){var a=c(this).css("z-index");!isNaN(a)&&a>d&&(d=a+1)});b.css("z-index",d);b.find("."+a.options.baseClass+"-unsupported-close").click(function(){b.remove()})}else s=!0}return s}var m=null,q={},t={};c(function(){i.initialized||i.init();c.isFunction(i.rangePrototype.insertNodeAtEnd)||
(i.rangePrototype.insertNodeAtEnd=function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});c("html").click(function(a){var b=c(a.target).parents(".ui-editor-selectmenu");c(".ui-editor-selectmenu-menu").each(function(){c(this).parent()[0]!==b[0]&&c(this).closest(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")})});c.widget("ui.editor",{_init:function(){-1===c.inArray(this,c.ui.editor.instances)&&c.ui.editor.instances.push(this);
var a=this;c.ui.editor.eachInstance(function(b){a!=b&&a.element.closest(b.element).length&&handleError("Nesting editors is unsupported",a.element,b.element)});this.options=c.extend({},c.ui.editor.defaults,this.options);this.options.uiOrder=this.options.uiOrder||[["logo"],["save","cancel"],["dock","showGuides","clean"],["viewSource"],["undo","redo"],["alignLeft","alignCenter","alignJustify","alignRight"],["textBold","textItalic","textUnderline","textStrike"],["textSuper","textSub"],["listUnordered",
"listOrdered"],["hr","quoteBlock"],["fontSizeInc","fontSizeDec"],["link","unlink"],["embed"],["floatLeft","floatNone","floatRight"],["tagMenu"],["i18n"],["raptorize"],["length"],["debugReinit","debugDestroy"]];this.element.attr("id")||this.element.attr("id",this.getUniqueId());this.ready=!1;this.events={};this.ui={};this.plugins={};this.templates=c.extend({},c.ui.editor.templates);this.path=this.toolbarWrapper=this.toolbar=this.wrapper=null;this.visible=this.enabled=!1;this.uiObjects={};for(var b in this.options.bind)this.bind(b,
this.options.bind[b]);this.history=[];this.present=0;this.historyEnabled=!0;r(this)&&(this.cloneDomTools(),this.setOriginalHtml(this.element.is(":input")?this.element.val():this.element.html()),this.options.replace&&(this.replaceOriginal(),this.options.replace=!1),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,this.ready=!0,this.fire("ready"),this.options.autoEnable&&c(function(){a.enableEditing();a.showToolbar()}))},attach:function(){this.bind("change",
...
!0):this.getElement().attr("contenteditable",!0);try{document.execCommand("enableInlineTableEditing",!1,!1),document.execCommand("styleWithCSS",!0,!0)}catch(a){}this.fire("enabled");this.fire("resize")}},disableEditing:function(){this.enabled&&(this.enabled=!1,this.getElement().attr("contenteditable",!1).removeClass(this.options.baseClass+"-editing"),this.fire("disabled"))},isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var a=this,b="",d=[],e=0;this.eachRange(function(g){var g=
g.commonAncestorContainer,h;h=3===g.nodeType?c(g).parent():c(g);g=[];for(d.push(g);h[0]&&!a.isRoot(h)&&"body"!==h[0].tagName.toLowerCase();)g.push(h),h=h.parent();g.reverse();b&&(b+=" | ");b+=this.getTemplate("root");for(h=0;h<g.length;h++)b+=this.getTemplate("tag",{element:g[h][0].tagName.toLowerCase(),data:"["+e+","+h+"]"});e++},null,this);b||(b=this.getTemplate("root"));this.path.html(b).find("a").click(function(){var b=c(this).data("ui-editor-selection");b?(a.selectOuter(d[b[0]][b[1]]),a.updateTagTree()):
a.selectOuter(a.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(a){return this.getElement()[0]===c(a)[0]},unify:function(a,b){!1!==b&&a(this);if(this.options.unify)for(var d=c.ui.editor.getInstances(),e=0;e<d.length;e++)d[e]!==this&&d[e].options.unify&&a(d[e])},getUniqueId:function(){return c.ui.editor.getUniqueId()},loadMessages:function(){this.messages=c(this.getTemplate("messages")).appendTo(this.wrapper)},showMessage:function(a,b,d){var d=c.extend({},this.options.message,d),e={timer:null,
editor:this,show:function(){this.element.slideDown();this.timer=k.setTimeout(function(a){this.timer=null;a.hide()},d.delay,this)},hide:function(){this.timer&&(k.clearTimeout(this.timer),this.timer=null);this.element.stop().slideUp(c.proxy(function(){c.isFunction(d.hide)&&d.hide.call(this);this.element.remove()},this))}};e.element=c(this.getTemplate("message",{type:a,message:b})).hide().appendTo(this.messages).find(".ui-editor-message-close").click(function(){e.hide()}).end();e.show();return e},showLoading:function(a,
b){return this.showMessage("clock",a,b)},showInfo:function(a,b){return this.showMessage("info",a,b)},showError:function(a,b){return this.showMessage("circle-close",a,b)},showConfirm:function(a,b){return this.showMessage("circle-check",a,b)},showWarning:function(a,b){return this.showMessage("alert",a,b)},loadToolbar:function(){var a=this.toolbar=c("<div/>").addClass(this.options.baseClass+"-toolbar"),a=this.toolbarWrapper=c("<div/>").addClass(this.options.baseClass+"-toolbar-wrapper").addClass("ui-widget-content").append(a),
...
this.events;c.each(a.split(","),function(a,f){f=c.trim(f);e[f]||(e[f]=[]);e[f].push({context:d,callback:b})})},unbind:function(a,b,d){for(var c=0,g=this.events[a].length;c<g;c++)this.events[a][c]&&this.events[a][c].callback===b&&this.events[a][c].context===d&&this.events[a].splice(c,1)},fire:function(a,b,d){d||this.fire("before:"+a,b,!0);if(this.events[a])for(var e=0,g=this.events[a].length;e<g;e++){var f=this.events[a][e];f.callback.call(f.context||this)}!1!==b&&c.ui.editor.fire(a);d||this.fire("after:"+
a,b,!0)}});c.extend(c.ui.editor,{defaults:{plugins:{},ui:{},bind:{},domTools:{savedSelection:!1,saveSelection:function(){this.savedSelection=i.saveSelection()},restoreSelection:function(){this.savedSelection&&(i.restoreSelection(this.savedSelection),this.savedSelection=!1)},eachRange:function(a,b,d){for(var b=b||i.getSelection(),d=d||this,c,g=0;c=b.getAllRanges()[g++];)a.call(d,c)},constrainSelection:function(a,b){var a=c(a)[0],b=b||i.getSelection(),d;c(b.getAllRanges()).each(function(e,g){d=3===
this.commonAncestorContainer.nodeType?c(g.commonAncestorContainer).parent()[0]:g.commonAncestorContainer;a!==d&&!c.contains(a,d)&&b.removeRange(g)})},getSelectedElements:function(){var a=new jQuery;this.eachRange(function(b){a.push(this.getSelectedElement(b)[0])});return a},getSelectedElement:function(a){return c(3===a.commonAncestorContainer.nodeType?a.commonAncestorContainer.parentNode:a.commonAncestorContainer)},unwrapParentTag:function(a){this.getSelectedElements().each(function(){c(this).is(a)&&
...
b.addRange(a)}).focus()},toggleWrapper:function(a,b){var b=b||{},d=i.createCssClassApplier(b.classes||"",{normalize:!0,elementTagName:a,elementProperties:b.attributes||{}});this.eachRange(function(e){this.rangeEmptyTag(e)?this.replaceRange(c("<"+a+"/>").addClass(b.classes).attr(b.attributes||{}).append(this.domFragmentToHtml(e.cloneContents())),e):d.toggleRange(e)})},rangeEmptyTag:function(a){a=this.domFragmentToHtml(a.cloneContents());"string"===typeof a&&(a=a.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,
"\\$1"));return c(a).is(":empty")?!0:!1},execCommand:function(a,b,d){document.execCommand(a,b,d)},insertTag:function(a,b){this.eachRange(function(b){b.insertNode(c("<"+a+"/>")[0])},b)},insertTagAtEnd:function(a,b){this.eachRange(function(b){b.insertNodeAtEnd(c("<"+a+"/>")[0])},b)},insertElement:function(a,b,d){this.eachRange(function(d){c(a).each(function(){d.insertNode(!1===b?this:this.cloneNode(!0))})},d)},insertElementAtEnd:function(a,b,d){this.eachRange(function(d){c(a).each(function(){d.insertNodeAtEnd(!1===
b?this:this.cloneNode(!0))})},d)},toggleBlockStyle:function(a,b){this.eachRange(function(d){for(d=c(d.commonAncestorContainer);d.length&&d[0]!==b[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===b[0]&&"inline"!==b.css("display")&&(this.wrapInner(b,"div"),d=b.children().first());this.toggleStyle(d,a)})},wrapInner:function(a,b){this.saveSelection();c(a).each(function(){var d=c("<"+b+"/>").html(c(this).html());a.html(d)});this.restoreSelection()},wrapRange:function(a){a.replaceContents()},
inverseWrapWithTagClass:function(a,b,d,e){this.saveSelection();var g="domTools"+Math.ceil(1E7*Math.random());this.eachRange(function(a){var c=i.createCssClassApplier(e,{elementTagName:d});c.isAppliedToRange(a)?c.toggleSelection():i.createCssClassApplier(b,{elementTagName:g}).toggleSelection()});c(g).each(function(){c(this).replaceWith(c("<"+a+"/>").addClass(b).html(c(this).html()))});this.restoreSelection()},toggleStyle:function(a,b){c.each(b,function(b,e){c(a).css(b)===e?c(a).css(b,""):c(a).css(b,
e)})},getStyles:function(a){for(var b={},a=k.getComputedStyle(a[0],null),c=0;c<a.length;c++)b[a.item(c)]=a.getPropertyValue(a.item(c));return b},swapStyles:function(a,b,c){for(var e in c)a.css(e,b.css(e)),b.css(e,c[e])},replaceSelection:function(a,b){this.eachRange(function(b){this.replaceRange(a,b)},b)},replaceRange:function(a,b){var d=c("<div></div>").append(a)[0].childNodes;b.deleteContents();d.length===p||1===d.length?b.insertNode(d[0].cloneNode(!0)):c.each(d,function(a,c){b.insertNodeAtEnd(c.cloneNode(!0))})},
insertDomFragmentBefore:function(a,b,d){for(var e=0,g=a.childNodes.length;e<g;e++){var f=a.childNodes.item(e);(f=3===f.nodeType?f.nodeValue:c(f).html())&&c("<"+d+"/>").html(c.trim(f)).insertBefore(b)}},domFragmentToHtml:function(a,b){for(var d="",e=0,g=a.childNodes.length;e<g;e++){var f=a.childNodes.item(e);(f=3===f.nodeType?f.nodeValue:this.outerHtml(f))&&(d+=f)}b&&(d=c("<"+b+">"+d+"</"+b+">"),d.find("p").wrapInner("<"+b+"/>"),d.find("p > *").unwrap(),d=c("<div></div>").html(d).html());return d},
...
change:function(){this.editor.present===this.editor.history.length-1?this.ui.disable():this.ui.enable()}}});c.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:f("Insert Horizontal Rule"),click:function(){a.replaceSelection("<hr/>")}})}}});c.ui.editor.registerUi({i18n:{init:function(a){var b=this,d=this.persist("locale");d&&n(d);var d=c('<select autocomplete="off" name="i18n"/>'),e;for(e in q){var g=c('<option value="'+e+'" class="'+e+'"/>');g.html(t[e]);m===e&&g.attr("selected",
"selected");d.append(g)}return a.uiSelectMenu({title:f("Change Language"),select:d,change:function(a){n(b.persist("locale",a))}})}}});o("en","English",{});o("zh_CN","\u7b80\u4f53\u4e2d\u6587",{"Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"\u5e94\u7528\u6e90\u4ee3\u7801","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",Blockquote:"\u5927\u6bb5\u5f15\u7528",Bold:"\u7c97\u4f53",Cancel:"\u53d6\u6d88",
...
root:"\u672c","{{images}} image(s) have been replaced with resized versions":"{{images}} image(s) have been replaced with resized versions"});c.ui.editor.registerPlugin("imageResize",{options:{resizeAjax:!1,resizingClass:"",resizeAjaxClass:"",ajax:{url:"/",type:"post",cache:!1}},init:function(a){this.options=c.extend(this.options,{resizingClass:this.options.baseClass+"-in-progress",resizeAjaxClass:this.options.baseClass+"-on-save"});a.bind("enabled",this.bind,this);this.resized=c.proxy(this.imageResized,
this);var b=this;a.getElement().find("img").each(function(){this.addEventListener&&this.addEventListener("DOMAttrModified",b.resized,!1);this.attachEvent&&this.attachEvent("onpropertychange",b.resized)})},bind:function(){this.editor.bind("change",this.scanImages,this);this.editor.bind("destroy",this.destroy,this);this.editor.bind("save",this.save,this);this.editor.bind("cancel",this.cancel,this)},imageResized:function(a){var b=c(a.target);b.is("img")&&b.attr("_moz_resizing")&&"style"==a.attrName&&
...
cancel:function(){this.removeClasses();this.editor.unbind("change",this.scanImages,this);var a=this;this.editor.getElement().find("img").each(function(){this.removeEventListener&&this.addEventListener("DOMAttrModified",a.resized,!1);this.detachEvent&&this.detachEvent("onpropertychange",a.resized)})},destroy:function(){this.cancel()},save:function(){this.removeClasses(this.options.resizingClass);this.options.resizeAjax&&this.resizeImagesAjax()},resizeImagesAjax:function(){var a=this,b=[];c("."+this.options.resizeAjaxClass).each(function(){c(this).attr("id")||
c(this).attr("id",a.editor.getUniqueId());b.push({id:c(this).attr("id"),src:this.src,width:c(this).width(),height:c(this).height()})});if(b.length){var d=this.editor.showLoading(f("Resizing image(s)")),e=this.options.ajax;e.data={images:b};e.async=!1;c.ajax(e).done(function(e){c(e).each(function(){c("#"+this.id).attr("src",this.src).removeAttr("id")});a.editor.fire("change");d.hide();a.editor.showConfirm(f("{{images}} image(s) have been replaced with resized versions",{images:b.length}))}).fail(function(b){d.hide();
...
label:f("Initializing"),text:!0,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var a=this.options.length-c("<div></div>").html(this.editor.getCleanHtml()).text().length,b=this.ui.button,d=null,d=0<=a?f("{{charactersRemaining}} characters remaining",{charactersRemaining:a}):f("{{charactersRemaining}} characters over limit",{charactersRemaining:-1*a});b.button("option","label",d);b.button("option","text",!0);0>a?b.addClass("ui-state-error"):0<=a&&15>=a?b.addClass("ui-state-highlight").removeClass("ui-state-error"):
b.removeClass("ui-state-highlight ui-state-error")},showStatistics:function(){this.processTemplate().dialog({modal:!0,resizable:!1,title:f("Content Statistics"),dialogClass:this.editor.options.dialogClass+" "+this.editor.options.baseClass,show:this.editor.options.dialogShowAnimation,hide:this.editor.options.dialogHideAnimation,buttons:[{text:f("OK"),click:function(){c(this).dialog("close")}}],open:function(){c(this).parent().find(".ui-dialog-buttonpane").find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}})},
close:function(){c(this).dialog("destroy").remove()}})},processTemplate:function(){var a=c("<div></div>").html(this.editor.getCleanHtml()).text(),b=null,d=this.options.length-a.length,b=0>d?f("Content contains more than {{limit}} characters and may be truncated",{limit:this.options.length}):f("Content will not be truncated"),e=null,e=a.split(" ").length,e=1==e?f("{{words}} word",{words:e}):f("{{words}} words",{words:e}),g=null,g=a.split(". ").length,g=f("{{sentences}} sentences",{sentences:g}),h=
null,h=0<=d?f("{{characters}} characters, {{charactersRemaining}} remaining",{characters:a.length,charactersRemaining:d}):f("{{characters}} characters, {{charactersRemaining}} over the recommended limit",{characters:a.length,charactersRemaining:-1*d});return c(this.editor.getTemplate("length.dialog",{characters:h,words:e,sentences:g,truncation:b}))}}});c.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:f("Page on this or another website"),
...
a.selectInner(d)}};a.bind("show",this.show)}});c.ui.editor.registerUi({raptorize:{init:function(a){var b=a.uiButton({title:f("Raptorize"),ready:function(){b.button.raptorize&&b.button.raptorize()}});return b}}});c.ui.editor.registerPlugin("saveJson",{options:{id:{attr:"name"},postName:"content",showResponse:!1,appendId:!1,ajax:{url:"/",type:"post",cache:!1}},init:function(){},getId:function(){if("string"===typeof this.options.id)return this.options.id;if("function"===typeof this.options.id)return this.options.id.apply(this,
...
this)).fail(c.proxy(this.fail,this)).always(c.proxy(this.always,this))}});c.ui.editor.registerUi({save:{options:{plugin:"saveJson"},init:function(a){return a.uiButton({title:f("Save"),icon:"ui-icon-save",click:function(){a.getPlugin(this.options.plugin).save()}})}}});c.ui.editor.registerPlugin({snippet:{ids:[],enabled:!1,init:function(a,b){if(b.snippets){for(var c=0,e=b.snippets.length;c<e;c++)this.createSnippet(b.snippets[c],a);a.bind("restore",this.createButtons,this);a.bind("save",this.disable,
...
change:function(b){a.tagSelection(b)}})},change:function(){var a=this.editor.getSelectedElements()[0];a&&(a=a.tagName.toLowerCase(),this.ui.selectMenu.find("option[value="+a+"]").length?this.ui.val(a):this.ui.val("na"))}}});(function(){var a=null,b=0;c.ui.editor.registerPlugin("unsavedEditWarning",{options:{},init:function(d){a||(a=c(d.getTemplate("unsavededitwarning.warning",this.options)).attr("id",d.getUniqueId()).appendTo("body"));var e=this;d.bind("dirty",function(){b++;0<b&&a.addClass(e.options.baseClass+
"-visible")});d.bind("cleaned",function(){b--;0===b&&a.removeClass(e.options.baseClass+"-visible")})},show:function(){},hide:function(){},reposition:function(){}})})();c.ui.editor.registerUi({viewSource:{dialog:null,init:function(a){a.bind("hide",this.hide,this);return a.uiButton({title:f("View / Edit Source"),click:function(){this.show()}})},tab:function(){return"    "},highlightSource:function(){return"undefined"!==typeof k.Rainbow},untidyHtml:function(a){a=c("<div/>").html(a);c(a).find("span.support").each(function(){c(this).contents().unwrap()});
a=a.html();a=a.replace(/&lt;/g,"<");a=a.replace(/&gt;/g,">");return a=a.replace(/&amp;/g,"&")},tidyHtml:function(a){if("undefined"===typeof HTMLParser)return a;var b=0,c="",e=this;HTMLParser(a,{start:function(a,f,i){for(var l=0;l<b;l++)c+=e.tab();c+="<"+a;for(l=0;l<f.length;l++)c+=" "+f[l].name+'="'+f[l].escaped+'"';c+=(i?"/":"")+">";b++},end:function(a){c+="</"+a+">";b--},chars:function(a){c+=a},comment:function(a){c+="<\!--"+a+"--\>"}});return c},prepareSource:function(a){if(this.highlightSource()){var b=
this.tidyHtml(c.trim(this.editor.getHtml())),a=c(a).find("."+this.options.baseClass+"-highlighted"),d=function(a,b,f){var a=c(a),j=a.find("code:first");j.unbind("keydown keyup");j.attr("contenteditable",!0);Rainbow.color(b,"html",function(b){j.html(b);a.show();var g=function(){var a=i.getSelection();return a.rangeCount?a.getRangeAt(0):null},m="";j.bind("keydown",function(a){m=j.html();switch(a.keyCode){case 13:var b=g(),c=!1,d=document.createTextNode("\r\n");b&&(b.insertNode(d),b.setEndAfter(d),b.setStartAfter(d),
c=i.getSelection(),c.setSingleRange(b),c=!0);c&&a.preventDefault();return!1;case 9:return b=g(),a=document.createTextNode(f.tab()),b&&(b.insertNode(a),c=i.getSelection(),b.setEndAfter(a),b.setStartAfter(a),c.setSingleRange(b)),!1}});var n=!1;j.bind("keydown",function(){n=!0});j.bind("keyup",function(){n=!1;k.setTimeout(function(){if(!n){if(m==j.html())return!0;try{var b=f.untidyHtml(j.html());c("<div/>").html(b).html()==b&&d(a,b,f)}catch(g){console.log("error")}}},5E3)})})};d(a,b,this)}else c(a).find("textarea").val(c.trim(this.editor.getHtml())),
...
" "+a.options.dialogClass,buttons:[{text:f("Apply Source"),click:function(){var b;a.highlightSource()?(b=c(this).find("."+a.options.baseClass+"-highlighted pre code:first").html(),b=a.untidyHtml(b)):b=c(this).find("textarea").val();a.editor.setHtml(b)}},{text:f("Close"),click:function(){a.hide()}}],open:function(){var b=c(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});
