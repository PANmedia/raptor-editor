...
*/
(function(c,k,i,H){function y(a,b,d){z[a]=d;O[a]=b;q||(q=a)}function P(a){q!==a&&(q=a,c.ui.editor.eachInstance(function(){this.reinit()}))}function g(a,b){q&&z[q]&&z[q][a]&&(a=z[q][a]);if(!b)return a;for(var d in b)a=a.replace("{{"+d+"}}",b[d]);return a}function W(a){if(C===H){C=!0;if(Q=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))c("html").addClass(a.options.baseClass+"-ios"),Q&&c(document).bind("scroll",function(){setInterval(function(){c("body").css("height","+=1").css("height",
...
c(a.focusNode.parentElement):c(a.focusNode)}function s(a,b){var b=b||{},d=i.createCssClassApplier(b.classes||"",{normalize:!0,elementTagName:a,elementProperties:b.attributes||{}});m(function(e){var f=e.cloneContents(),f=u(f);"string"===typeof f&&(f=f.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));c(f).is(":empty")?(f=c("<"+a+"/>").addClass(b.classes).attr(b.attributes||{}).append(u(e.cloneContents())),R(f,e)):d.toggleRange(e)},null,this)}function X(a,b,d){m(function(c){c=V(c);c.is(a)?c.attr(b):
s(a,{classes:d,attributes:b})},null,this)}function M(a,b){var b=b||i.getSelection(),d=b.getRangeAt(0),e=l()[0],f=i.createRange();f.setStartBefore(e);f.setEnd(d.startContainer,d.startOffset);var f=f.cloneContents(),h=i.createRange();h.setStart(d.endContainer,d.endOffset);h.setEndAfter(e);d=h.cloneContents();f=o(c(u(f)));f+=o(c(a));f+=o(c(u(d)));c(e).replaceWith(c(f))}function B(a,b,d){var d=d||i.getSelection(),c=K()[0],f=L()[0],h=l()[0],h=E(h,b),c=E(c,b),b=E(f,b);h&&c&&b?t(a):M(a,d)}function G(a,b){allowed=
[];for(var c=0;c<b.length;c++)b[c].match(/[a-z][a-z0-9]{0,}/g)&&allowed.push(b[c]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,b){return-1<allowed.indexOf(b.toLowerCase())?a:""})}var q=null,z={},O={};c(function(){i.initialized||i.init();c.isFunction(i.rangePrototype.insertNodeAtEnd)||(i.rangePrototype.insertNodeAtEnd=function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});c("html").click(function(){c(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});
...
(this.enabled=!1,this.getElement().attr("contenteditable",!1).removeClass(this.options.baseClass+"-editing"),i.getSelection().removeAllRanges(),this.fire("disabled"))},isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var a=this,b="",d=[],e=0;m(function(f){var f=f.commonAncestorContainer,h;h=3===f.nodeType?c(f).parent():c(f);f=[];for(d.push(f);h[0]&&!a.isRoot(h)&&"body"!==h[0].tagName.toLowerCase();)f.push(h),h=h.parent();f.reverse();b&&(b+=" | ");b+=this.getTemplate("root");
...
b){a.children().each(function(){var a=c.map(this.attributes,function(a){if(-1===c.inArray(a.name,b))return a.name}),e=c(this);c.each(a,function(a,b){e.removeAttr(b)});element.removeAttributes(c(this),b)});return a},elementBringToTop:I,elementOuterHtml:o,elementOuterText:function(a){return a.clone().wrap("<div/>").parent().text()},elementIsBlock:function(a){return"block"===D(a.tagName)},elementDefaultDisplay:D,elementIsValid:E,fragmentToHtml:u,fragmentInsertBefore:function(a,b,d){for(var e=0,f=a.childNodes.length;e<
f;e++){var h=a.childNodes.item(e);(h=3===h.nodeType?h.nodeValue:c(h).html())&&c("<"+d+"/>").html(c.trim(h)).insertBefore(b)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},rangeGetCommonAncestor:S,rangeIsEmpty:T,selectionSave:p,selectionRestore:n,selectionDestroy:F,selectionEachRange:m,selectionReplace:t,selectionSelectInner:A,selectionSelectOuter:v,selectionSelectEdge:J,selectionSelectEnd:U,selectionSelectStart:w,selectionGetHtml:x,selectionGetElements:l,
selectionToggleWrapper:s,selectionExists:function(a){var b=!1;m(function(a){T(a)||(b=!0)},a,this);return b},selectionReplaceSplittingSelectedElement:M,selectionReplaceWithinValidTags:B,stringStripTags:G,defaults:{plugins:{},ui:{},bind:{},domTools:{constrainSelection:function(a,b){var a=c(a)[0],b=b||i.getSelection(),d;c(b.getAllRanges()).each(function(e,f){d=3===this.commonAncestorContainer.nodeType?c(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;a!==d&&!c.contains(a,d)&&b.removeRange(f)})},
unwrapParentTag:function(a){l().each(function(){c(this).is(a)&&c(this).replaceWith(c(this).html())})},execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(e){}},insertTag:function(a,b){m(function(b){b.insertNode(c("<"+a+"/>")[0])},b,this)},insertTagAtEnd:function(a,b){m(function(b){b.insertNodeAtEnd(c("<"+a+"/>")[0])},b,this)},insertElement:function(a,b,d){m(function(d){c(a).each(function(){d.insertNode(!1===b?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(a,b,d){m(function(d){c(a).each(function(){d.insertNodeAtEnd(!1===
b?this:this.cloneNode(!0))})},d,this)},toggleBlockStyle:function(a,b){m(function(d){for(d=c(d.commonAncestorContainer);d.length&&d[0]!==b[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===b[0]&&"inline"!==b.css("display")&&(this.wrapInner(b,"div"),d=b.children().first());this.toggleStyle(d,a)},null,this)},wrapInner:function(a,b){p();c(a).each(function(){var d=c("<"+b+"/>").html(c(this).html());a.html(d)});n()},inverseWrapWithTagClass:function(a,b,d,e){p();var f="domTools"+
Math.ceil(1E7*Math.random());m(function(a){var c=i.createCssClassApplier(e,{elementTagName:d});c.isAppliedToRange(a)?c.toggleSelection():i.createCssClassApplier(b,{elementTagName:f}).toggleSelection()},null,this);c(f).each(function(){c(this).replaceWith(c("<"+a+"/>").addClass(b).html(c(this).html()))});n()},toggleStyle:function(a,b){c.each(b,function(b,e){c(a).css(b)===e?c(a).css(b,""):c(a).css(b,e)})},getStyles:function(a){for(var b={},a=k.getComputedStyle(a[0],null),c=0;c<a.length;c++)b[a.item(c)]=
...
if(c(this).hasClass("rangySelectionBoundary")&&!1===(!1!==r)||""===c.trim(c(this).html()))return!0}).remove();for(a=0;a<this.options.stripEmptyAttrs.length;a++){var d=this.options.stripEmptyAttrs[a];b.getElement().find("["+this.options.stripEmptyAttrs[a]+"]").filter(function(){return""===c.trim(c(this).attr(d))}).removeAttr(this.options.stripEmptyAttrs[a])}var e=k.location.protocol+"//"+k.location.host,f="//"+k.location.host;for(a=0;a<this.options.stripDomains.length;a++){var h=this.options.stripDomains[a];
...
"-top-spacer").height(this.editor.toolbar.outerHeight()).prependTo("body"),this.bottomSpacer=c("<div/>").addClass(this.options.baseClass+"-bottom-spacer").height(this.editor.path.outerHeight()).appendTo("body"),this.editor.fire("resize"))},hideSpacers:function(){this.topSpacer&&(this.topSpacer.remove(),this.topSpacer=null);this.bottomSpacer&&(this.bottomSpacer.remove(),this.bottomSpacer=null);this.editor.fire("resize")},swapStyle:function(a,b,c){var e={},f;for(f in c)a.css(f,b.css(f)),e[f]=b.css(f),
b.css(f,c[f]);return e},revertStyle:function(a,b){for(var c in b)a.css(c,b[c])},dockToElement:function(){var a=c("<div/>").insertBefore(this.editor.getElement()).addClass(this.options.baseClass+"-docked-to-element-wrapper");this.editor.wrapper.appendTo(a);this.previousStyle=this.swapStyle(a,this.editor.getElement(),{display:"block","float":"none",clear:"none",position:"static","margin-left":0,"margin-right":0,"margin-top":0,"margin-bottom":0,outline:0,width:"auto"});a.css("width",a.width()+parseInt(this.editor.getElement().css("padding-left"),
...
click:function(){var b=a.getPlugin("dock");b.isDocked()?b.undock():b.dock();a.unify(function(a){b.isDocked()?a.getPlugin("dock").dock():a.getPlugin("dock").undock()})}})}}});c.ui.editor.registerUi({embed:{dialog:null,init:function(a){a.bind("hide",this.hide,this);return a.uiButton({icon:"ui-icon-youtube",title:g("Embed object"),click:function(){this.show()}})},hide:function(){this.dialog&&c(this.dialog).dialog("destroy").remove();this.dialog=null;c(this.ui.button).button("option","disabled",!1)},
show:function(){if(!this.dialog){c(this.ui.button).button("option","disabled",!0);var a=this;p();this.dialog=c(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:g("Paste Embed Code"),autoOpen:!0,dialogClass:a.options.baseClass+" "+a.options.dialogClass,buttons:[{text:g("Embed Object"),click:function(){n();t(c(this).find("textarea").val());c(this).dialog("close")}},{text:g("Close"),click:function(){a.hide()}}],open:function(){var a=c(this).parent().find(".ui-dialog-buttonpane");
...
click:function(){m(function(a){c(a.commonAncestorContainer).find("img").css("float","left")})}})}},floatRight:{init:function(a){return a.uiButton({title:g("Float Image Right"),click:function(){m(function(a){c(a.commonAncestorContainer).find("img").css("float","right")})}})}},floatNone:{init:function(a){return a.uiButton({title:g("Remove Image Float"),click:function(){m(function(a){c(a.commonAncestorContainer).find("img").css("float","none")})}})}}});c.ui.editor.registerUi({fontSizeInc:{init:function(a,
...
click:function(){t("<hr/>")}})}}});c.ui.editor.registerUi({i18n:{init:function(a){var b=this,d=this.persist("locale");d&&P(d);var d=c('<select autocomplete="off" name="i18n"/>'),e;for(e in z){var f=c('<option value="'+e+'" class="'+e+'"/>');f.html(O[e]);q===e&&f.attr("selected","selected");d.append(f)}return a.uiSelectMenu({title:g("Change Language"),select:d,change:function(a){P(b.persist("locale",a))}})}}});y("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.",
...
c(a).hasClass(b[d]))return!0;return!1},focusSelector:null,focus:function(){if(this.focusSelector){var a=c(this.focusSelector),b=a.val();a.val("");a.focus().val(b)}}},b=null,b=this.options.replaceTypes?this.options.customTypes:c.merge(this.defaultLinkTypes,this.options.customTypes),d,e=0;e<b.length;e++)d=c.extend({},a,b[e],{classes:this.options.baseClass+"-"+b[e].type}).init(),this.types[d.type]=d},show:function(){if(!this.visible){p();this.selectedElement=l().first();var a=this.selectedElement.is("a"),
...
this.change,this);return a.uiButton({title:g("Insert Link"),click:function(){a.getPlugin("link").show()}})},change:function(){l().length?this.ui.enable():this.ui.disable()}},unlink:{hotkeys:{"ctrl+shift+l":{action:function(){this.ui.click()},restoreSelection:!1}},init:function(a){a.bind("selectionChange",this.change,this);a.bind("show",this.change,this);return a.uiButton({title:g("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){l().is("a")?this.ui.enable():this.ui.disable()}}});
c.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),toggleList:function(a){c(l()).is("li")&&c(l()).parent().is(a)?this.unwrapList():this.wrapList(a);this.editor.fire("selectionChange");
this.editor.fire("change")},unwrapList:function(){p();var a=[],b=[],d=K(),e=L();a.push(c(d).html());b.push(d);if(c(d)[0]!==c(e)[0]){var f=d;do f=c(f).next(),a.push(c(f).html()),b.push(f);while(c(f)[0]!==c(e)[0])}f=0===c(d).prev().length;e=0===c(e).next().length;d=c(d).parent();for(listElementsIndex=0;listElementsIndex<b.length;listElementsIndex++)c(b[listElementsIndex]).remove();for(b=0;b<a.length;b++)d.parent().is("li")||(a[b]="<p>"+a[b]+"</p>");f&&e?(d.replaceWith(a.join("")),n(),a=l()[0],v(a)):
(f?c(d).before(a.join("")):e?c(d).after(a.join("")):M(a.join("")),n(),this.editor.checkChange())},wrapList:function(a){this.editor.constrainSelection(this.editor.getElement());""===c.trim(x())&&A(l());var b=c("<div>").html(x()),d=[],e=this;c(b).contents().each(function(){var a;a="block"===D(this.tagName)?G(c(this).html(),e.validChildren):G(o(c(this)),e.validChildren);a=c("<li>"+a+"</li>");""!==c.trim(a.text())&&d.push(o(a))});b=this.options.baseClass+"-selection";a="<"+a+' class="'+b+'">'+d.join("")+
"</"+a+">";n();var f=c(l()[0]).parent(),h=this.editor.getElement()[0];f===h||l()[0]===h?t(a):B(a,this.validParents);b=c(this.editor.getElement().find("."+b).removeClass(b));A(b.find("li:first")[0]);this.editor.checkChange()},toggleButtonState:function(a,b){var d=function(a){b.button.toggleClass("ui-state-highlight",a).toggleClass("ui-state-default",!a)},e=K();if(null===e||!e.length)e=this.editor.getElement();var f=L();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(c(e).is(a)&&
...
c(".uiWidgetEditorPasteBin").focus();k.setTimeout(function(){var h=c(".uiWidgetEditorPasteBin").html(),h=f.filterAttributes(h),h=f.filterChars(h),h=f.stripEmpty(h),h=f.stripAttributes(h),h=G(h,f.options.allowedTags),h={plain:c("<div/>").html(c(".uiWidgetEditorPasteBin").html()).text(),markup:h,html:c(".uiWidgetEditorPasteBin").html()};e=c(a.getTemplate("paste.dialog",h));c(e).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:b.dialogShowAnimation,hide:b.dialogHideAnimation,
dialogClass:b.baseClass+" "+b.dialogClass,buttons:[{text:g("Insert"),click:function(){var a=null,a=c(this).find(".ui-editor-paste-area:visible"),a=a.hasClass("ui-editor-paste-plain")||a.hasClass("ui-editor-paste-source")?a.val():a.html(),a=f.filterAttributes(a),a=f.filterChars(a);n();t(a);d=!1;c(this).dialog("close")}},{text:g("Cancel"),click:function(){n();d=!1;c(this).dialog("close")}}],open:function(){var a=c(this).find(".ui-editor-paste-panel-tabs");a.find("ul.ui-tabs-nav li").click(function(){a.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
...
init:function(a){a.bind("selectionChange",this.change,this);a.bind("show",this.change,this);return a.uiSelectMenu({name:"tagMenu",title:g("Change HTML tag of selected element"),select:c(a.getTemplate("tagmenu.menu")),change:function(b){if(!("undefined"===typeof b||"na"===b)){var d=a.getElement()[0],e=l();if(!x()||""===x()){if(c(e)[0]===c(d)[0])return;p();d=c("<"+b+">").html(e.html());e.replaceWith(d);n()}else{var e=c(l()[0]).parent(),f=this.options.baseClass+"-selection",b=c("<"+b+">").html(x()).addClass(f);
e===d||l()[0]===d?t(b):B(b,this.validParents);A(a.getElement().find("."+f).removeClass(f))}a.checkChange()}}})},change:function(){var a=l()[0];a?(a=a.tagName.toLowerCase(),this.ui.select.find("option[value="+a+"]").length?this.ui.val(a):this.ui.val("na"),c(this.ui.button).toggleClass("ui-state-disabled",this.editor.getElement()[0]===l()[0])):c(this.ui.button).toggleClass("ui-state-disabled",!0)}}});c.ui.editor.registerPlugin("toolbarTip",{init:function(){c.browser.msie||this.bind("show, tagTreeUpdated",
...
a.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});a.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){c(this).dialog("destroy").remove();c(d).button("option","disabled",!1);a.editor.checkChange()}})}}});var r=!1})(jQuery,window,rangy);
