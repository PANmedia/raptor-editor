...
*/
(function(c,l,i,I){function v(a,b,d){z[a]=d;P[a]=b;q||(q=a)}function Q(a){q!==a&&(q=a,c.ui.editor.eachInstance(function(){this.reinit()}))}function g(a,b){q&&z[q]&&z[q][a]&&(a=z[q][a]);if(!b)return a;for(var d in b)a=a.replace("{{"+d+"}}",b[d]);return a}function Z(a){if(D===I){D=!0;if(R=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))c("html").addClass(a.options.baseClass+"-ios"),R&&c(document).bind("scroll",function(){setInterval(function(){c("body").css("height","+=1").css("height",
"-=1")},0)});c.browser.mozilla&&c("html").addClass(a.options.baseClass+"-ff");if(c.browser.msie&&9>c.browser.version){D=!1;var b=c("<div/>").addClass(a.options.baseClass+"-unsupported").html(a.getTemplate("unsupported")).appendTo("body");J(b);b.find("."+a.options.baseClass+"-unsupported-close").click(function(){b.remove()})}}return D}function J(a){var b=1;a.siblings().each(function(){var a=c(this).css("z-index");!isNaN(a)&&a>b&&(b=a+1)});a.css("z-index",b)}function o(a){return a.clone().wrap("<div/>").parent().html()}
function E(a){var b,a=document.createElement(a);b="getComputedStyle"in l;document.body.appendChild(a);b=(b?l.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return b}function F(a,b){return-1!==c.inArray(c(a)[0].tagName.toLowerCase(),b)}function S(a){for(var b={},a=l.getComputedStyle(a[0],null),d=0;d<a.length;d++)b[a.item(d)]=a.getPropertyValue(a.item(d));return b}function u(a,b){for(var d="",e=0,f=a.childNodes.length;e<f;e++){var h=a.childNodes.item(e);(h=3===h.nodeType?
h.nodeValue:o(c(h)))&&(d+=h)}b&&(d=c("<"+b+">"+d+"</"+b+">"),d.find("p").wrapInner("<"+b+"/>"),d.find("p > *").unwrap(),d=c("<div/>").html(d).html());return d}function T(a,b){var d=c("<div/>").append(a)[0].childNodes;b.deleteContents();d.length===I||1===d.length?b.insertNode(d[0].cloneNode(!0)):c.each(d,function(a,d){b.insertNodeAtEnd(d.cloneNode(!0))})}function U(a){var a=a||i.getSelection(),b;c(a.getAllRanges()).each(function(a,e){b=3===this.commonAncestorContainer.nodeType?c(e.commonAncestorContainer).parent()[0]:
e.commonAncestorContainer});return b}function V(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer}function p(a){if(!r||a)r=i.saveSelection()}function n(){r&&(i.restoreSelection(r),r=!1)}function G(){r&&i.removeMarkers(r);r=!1}function k(a,b,d){for(var b=b||i.getSelection(),c,f=0;c=b.getAllRanges()[f++];)a.call(d,c)}function t(a,b){k(function(b){T(a,b)},b,this)}function A(a,b){b=b||i.getSelection();b.removeAllRanges();c(a).focus().contents().each(function(){var a=i.createRange();
a.selectNodeContents(this);b.addRange(a)})}function w(a,b){b=b||i.getSelection();b.removeAllRanges();c(a).each(function(){var a=i.createRange();a.selectNode(this);b.addRange(a)}).focus()}function K(a,b,d){b=b||i.getSelection();b.removeAllRanges();c(a).each(function(){var a=i.createRange();a.selectNodeContents(this);a.collapse(d);b.addRange(a)})}function W(a,b){K(a,b,!1)}function x(a,b){K(a,b,!0)}function y(a){a=a||i.getSelection();return a.toHtml()}function X(a){a=a||i.getSelection().getRangeAt(0);
return c(3===a.commonAncestorContainer.nodeType?a.commonAncestorContainer.parentNode:a.commonAncestorContainer)}function j(a){var b=new jQuery;k(function(a){b.push(X(a)[0])},a,this);return b}function L(){var a=i.getSelection();if(null===a.anchorNode)return null;if(a.isBackwards())return 3===a.focusNode.nodeType?c(a.focusNode.parentElement):c(a.focusNode);a.anchorNode||console.trace();return 3===a.anchorNode.nodeType?c(a.anchorNode.parentElement):c(a.anchorNode)}function M(){var a=i.getSelection();
return null===a.anchorNode?null:a.isBackwards()?3===a.anchorNode.nodeType?c(a.anchorNode.parentElement):c(a.anchorNode):3===a.focusNode.nodeType?c(a.focusNode.parentElement):c(a.focusNode)}function s(a,b){var b=b||{},d=i.createCssClassApplier(b.classes||"",{normalize:!0,elementTagName:a,elementProperties:b.attributes||{}});k(function(e){var f=e.cloneContents(),f=u(f);"string"===typeof f&&(f=f.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));c(f).is(":empty")?(f=c("<"+a+"/>").addClass(b.classes).attr(b.attributes||
{}).append(u(e.cloneContents())),T(f,e)):d.toggleRange(e)},null,this)}function $(a,b,d){k(function(c){c=X(c);c.is(a)?c.attr(b):s(a,{classes:d,attributes:b})},null,this)}function N(a,b){var b=b||i.getSelection(),d=b.getRangeAt(0),e=j()[0],f=i.createRange();f.setStartBefore(e);f.setEnd(d.startContainer,d.startOffset);var f=f.cloneContents(),h=i.createRange();h.setStart(d.endContainer,d.endOffset);h.setEndAfter(e);d=h.cloneContents();f=o(c(u(f)));f+=o(c(a));f+=o(c(u(d)));c(e).replaceWith(c(f))}function B(a,
b,c){var c=c||i.getSelection(),e=L()[0],f=M()[0],h=j()[0],h=F(h,b),e=F(e,b),b=F(f,b);h&&e&&b?t(a):N(a,c)}function C(a,b){k(function(d){for(d=c(d.commonAncestorContainer);d.length&&d[0]!==b[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===b[0]&&"inline"!==b.css("display")&&(this.wrapInner(b,"div"),d=b.children().first());this.toggleStyle(d,a)},null,this)}function H(a,b){allowed=[];for(var c=0;c<b.length;c++)b[c].match(/[a-z][a-z0-9]{0,}/g)&&allowed.push(b[c]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,
"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,b){return-1<allowed.indexOf(b.toLowerCase())?a:""})}var q=null,z={},P={};c(function(){i.initialized||i.init();c.isFunction(i.rangePrototype.insertNodeAtEnd)||(i.rangePrototype.insertNodeAtEnd=function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});c("html").click(function(){c(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});c.widget("ui.editor",{_init:function(){-1===
c.inArray(this,c.ui.editor.instances)&&c.ui.editor.instances.push(this);var a=this;this.options=c.extend({},c.ui.editor.defaults,this.options);this.options.uiOrder=this.options.uiOrder||[["logo"],["save","cancel"],["dock","showGuides","clean"],["viewSource"],["undo","redo"],["alignLeft","alignCenter","alignJustify","alignRight"],["textBold","textItalic","textUnderline","textStrike"],["textSuper","textSub"],["listUnordered","listOrdered"],["hr","quoteBlock"],["fontSizeInc","fontSizeDec"],["colorPickerBasic"],
["clearFormatting"],["link","unlink"],["embed"],["floatLeft","floatNone","floatRight"],["tagMenu"],["i18n"],["raptorize"],["statistics"],["debugReinit","debugDestroy"]];this.element.attr("id")||this.element.attr("id",this.getUniqueId());this.ready=!1;this.events={};this.ui={};this.plugins={};this.templates=c.extend({},c.ui.editor.templates);this.path=this.toolbarWrapper=this.toolbar=this.wrapper=null;this.visible=this.enabled=!1;this.uiObjects={};this.hotkeys={};this.options.enableHotkeys&&this.registerHotkey(this.hotkeys);
for(var b in this.options.bind)this.bind(b,this.options.bind[b]);this.history=[];this.present=0;this.historyEnabled=!0;Z(this)&&(this.cloneDomTools(),this.setOriginalHtml(this.element.is(":input")?this.element.val():this.element.html()),this.element.is("textarea, input")&&this.replaceOriginal(),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,this.ready=!0,this.fire("ready"),this.options.autoEnable&&c(function(){a.enableEditing();a.showToolbar()}))},
attach:function(){this.bind("change",this.historyPush);this.bind("selectionChange",this.updateTagTree);this.bind("show",this.updateTagTree);var a=c.proxy(this.checkChange,this);this.getElement().find("img").bind("click."+this.widgetName,c.proxy(function(a){w(a.target)},this));this.getElement().bind("mouseup."+this.widgetName,a);this.getElement().bind("keyup."+this.widgetName,a);c(l).bind("beforeunload",c.proxy(c.ui.editor.unloadWarning,c.ui.editor));var b=this;c(l).resize(function(){b.fire("resize")})},
reinit:function(){if(this.ready){var a=this.enabled,b=this.visible;this.destruct(!0);this._init();a&&this.enableEditing();b&&this.showToolbar()}else{var c;c=function(){this.unbind("ready",c);this.reinit()};this.bind("ready",c)}},getElement:function(){return this.target?this.target:this.element},getOriginalElement:function(){return this.element},replaceOriginal:function(){if(!this.target){for(var a=c("<div/>").html(this.element.is(":input")?this.element.val():this.element.html()).insertBefore(this.element).attr("id",
this.getUniqueId()).addClass(this.element.attr("class")),b=S(this.element),d=0;d<this.options.replaceStyle.length;d++)a.css(this.options.replaceStyle[d],b[this.options.replaceStyle[d]]);this.element.hide();this.bind("change",function(){this.element.is("input, textarea")?this.element.val(this.getHtml()):this.element.html(this.getHtml())});this.target=a}},cloneDomTools:function(){for(var a in this.options.domTools)this[a]||(this[a]=function(a){return function(){this.options.domTools.constrainSelection(this.getElement());
var c=this.getHtml(),e=this.options.domTools[a].apply(this.options.domTools,arguments);c!==this.getHtml()&&this.change();return e}}(a))},checkChange:function(){var a=i.serializeSelection();this.previousSelection!==a&&this.fire("selectionChange");this.previousSelection=a;var a=this.getCleanHtml(),b=this.dirty;this.dirty=this.getOriginalHtml()!==a;this.previousHtml!==a&&(this.previousHtml=a,this.change(),b!==this.dirty&&(this.dirty?this.fire("dirty"):this.fire("cleaned")))},change:function(){this.fire("change")},
...
"-editing"),this.options.partialEdit?this.getElement().find(this.options.partialEdit).attr("contenteditable",!0):this.getElement().attr("contenteditable",!0),this.execCommand("enableInlineTableEditing",!1,!1),this.execCommand("styleWithCSS",!0,!0),this.bindHotkeys(),this.fire("enabled"),this.fire("resize"))},disableEditing:function(){this.enabled&&(this.enabled=!1,this.getElement().attr("contenteditable",!1).removeClass(this.options.baseClass+"-editing"),i.getSelection().removeAllRanges(),this.fire("disabled"))},
isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var a=this,b="",d=[],e=0;k(function(f){var f=f.commonAncestorContainer,h;h=3===f.nodeType?c(f).parent():c(f);f=[];for(d.push(f);h[0]&&!a.isRoot(h)&&"body"!==h[0].tagName.toLowerCase();)f.push(h),h=h.parent();f.reverse();b&&(b+=" | ");b+=this.getTemplate("root");for(h=0;h<f.length;h++)b+=this.getTemplate("tag",{element:f[h][0].tagName.toLowerCase(),data:"["+e+","+h+"]"});e++},null,this);b||(b=this.getTemplate("root"));
this.path.html(b).find("a").click(function(){var b=c(this).data("ui-editor-selection");b?(w(d[b[0]][b[1]]),a.updateTagTree()):w(a.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(a){return this.getElement()[0]===c(a)[0]},unify:function(a,b){!1!==b&&a(this);if(this.options.unify){var d=this;c.ui.editor.eachInstance(function(b){b!==d&&b.options.unify&&a(b)})}},getUniqueId:function(){return c.ui.editor.getUniqueId()},loadMessages:function(){this.messages=c(this.getTemplate("messages")).appendTo(this.wrapper)},
showMessage:function(a,b,d){var d=c.extend({},this.options.message,d),e;e={timer:null,editor:this,show:function(){this.element.slideDown();this.timer=l.setTimeout(function(){this.timer=null;e.hide()},d.delay,this)},hide:function(){this.timer&&(l.clearTimeout(this.timer),this.timer=null);this.element.stop().slideUp(c.proxy(function(){c.isFunction(d.hide)&&d.hide.call(this);this.element.remove()},this))}};e.element=c(this.getTemplate("message",{type:a,message:b})).hide().appendTo(this.messages).find(".ui-editor-message-close").click(function(){e.hide()}).end();
...
left:Math.abs(a[1])})},this)}),d.css("position",""),(a=this.persist("position")||this.options.dialogPosition)||(a=[10,10]),parseInt(a[0],10)+d.outerHeight()>c(l).height()&&(a[0]=c(l).height()-d.outerHeight()),parseInt(a[1],10)+d.outerWidth()>c(l).width()&&(a[1]=c(l).width()-d.outerWidth()),d.css({top:Math.abs(parseInt(a[0],10)),left:Math.abs(parseInt(a[1],10))}),this.loadMessages());c(function(){d.appendTo("body")});this.loadUi()},isToolbarLoaded:function(){return null!==this.wrapper},showToolbar:function(a){this.isToolbarLoaded()||
this.loadToolbar();if(!this.visible){this.options.unify&&this.hideOtherToolbars(!0);this.visible=!0;this.wrapper.css("display","");this.fire("resize");"undefined"===typeof this.getElement().attr("tabindex")&&this.getElement().attr("tabindex",-1);if(a)if(a.select)a.select();else{var b=l.getSelection();b.removeAllRanges();b.addRange(a)}var d=this;c(function(){d.fire("show");d.element.is("textarea, input")||d.getElement().focus()})}},hideToolbar:function(){this.visible&&(this.visible=!1,this.wrapper.hide(),
this.element.is("textarea, input")&&this.element.show(),this.fire("hide"),this.fire("resize"))},hideOtherToolbars:function(){this.unify(function(a){a.hideToolbar()},!1)},isVisible:function(){return this.visible},getTemplate:function(a,b){var d;d=this.templates[a]?this.templates[a]:c.ui.editor.getTemplate(a,this.options.urlPrefix);d=d.replace(/_\(['"]{1}(.*?)['"]{1}\)/g,function(a,b){b=b.replace(/\\(.?)/g,function(a,b){switch(b){case "\\":return"\\";case "0":return"\x00";case "":return"";default:return b}});
return g(b)});b=c.extend({},this.options,b||{});b=this.getTemplateVars(b);return d=d.replace(/\{\{(.*?)\}\}/g,function(a,c){return b[c]})},getTemplateVars:function(a,b,c){b=b?b+".":"";c||(c=1);var e={},f;for(f in a)if("object"===typeof a[f]&&5>c){var h=this.getTemplateVars(a[f],b+f,++c),g;for(g in h)e[g]=h[g]}else e[b+f]=a[f];return e},historyPush:function(){this.historyEnabled&&this.getHtml()!==this.historyPeak()&&(this.present!==this.history.length-1&&(this.history=this.history.splice(0,this.present+
1)),this.history.push(this.getHtml()),this.present=this.history.length-1)},historyPeak:function(){return!this.history.length?null:this.history[this.present]},historyBack:function(){0<this.present&&(this.present--,this.setHtml(this.history[this.present]),this.historyEnabled=!1,this.change(),this.historyEnabled=!0)},historyForward:function(){this.present<this.history.length-1&&(this.present++,this.setHtml(this.history[this.present]),this.historyEnabled=!1,this.change(),this.historyEnabled=!0)},registerHotkey:function(a,
b,d){if("string"===typeof a)this.hotkeys[a]=c.extend({},{context:d,restoreSelection:!0},b);else for(var e in a)this.registerHotkey(e,a[e],d)},bindHotkeys:function(){for(var a in this.hotkeys){var b=this,c=this.hotkeys[a].force||!1;(this.options.enableHotkeys||c)&&this.getElement().bind("keydown."+this.widgetName,a,function(a){p();var c=b.hotkeys[a.data];!0!==c.action.call(c.context)&&a.preventDefault();c.restoreSelection&&n();b.checkChange()})}},uiEnabled:function(a){return!1===this.options.enableUi&&
"undefined"===typeof this.options.ui[a]||!1===this.options.ui[a]||-1!==c.inArray(a,this.options.disabledUi)?!1:!0},getUi:function(a){return this.uiObjects[a]},loadUi:function(){for(var a=0,b=this.options.uiOrder.length;a<b;a++){for(var d=this.options.uiOrder[a],e=c("<div/>"),f=0,h=d.length;f<h;f++)if(this.uiEnabled(d[f])){var g=d[f].replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});if(c.ui.editor.ui[d[f]]){var m=c.extend({},c.ui.editor.ui[d[f]]),g=c.extend(!0,{},this.options,{baseClass:this.options.baseClass+
"-ui-"+g},m.options,this.options.ui[d[f]]);m.editor=this;m.options=g;m.ui=m.init(this,g);m.hotkeys&&(this.registerHotkey(m.hotkeys,null,m),m.ui.title+=" ("+c.map(m.hotkeys,function(a,b){return b})[0]+")");m.ui.init(d[f],this,g,m).appendTo(e);this.uiObjects[d[f]]=m}}e.addClass("ui-buttonset").addClass(this.options.baseClass+"-buttonset");0<e.children().length&&e.appendTo(this.toolbar)}c("<div/>").css("clear","both").appendTo(this.toolbar)},uiButton:function(a){return c.extend({button:null,options:{},
init:function(a,d,e,f){var h=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),e=c.extend({},d.options,{baseClass:d.options.baseClass+"-"+h+"-button"},this.options,d.options.ui[a]);this.title||(this.title=g("Unnamed Button"));this.button=c("<div/>").html(this.label||this.title).addClass(e.baseClass).attr("name",a).attr("title",this.title).val(a);e.classes&&this.button.addClass(e.classes);this.button.bind("mousedown."+f.editor.widgetName,function(a){a.preventDefault()});var O=this;this.button.bind("mouseup."+
f.editor.widgetName,function(a){a.preventDefault();O.click.apply(f,arguments);d.checkChange()});d.bind("destroy",c.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+h},disabled:e.disabled?!0:!1,text:this.text||!1,label:this.label||null});this.ready.call(f);return this.button},disable:function(){this.button.button("option","disabled",!0)},enable:function(){this.button.button("option","disabled",!1)},ready:function(){},click:function(){}},
a)},uiSelectMenu:function(a){return c.extend({select:null,selectMenu:null,button:null,menu:null,options:{},init:function(a,d){var e=this;e.select.attr("disabled","disabled");var f=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});c.extend({},d.options,{baseClass:d.options.baseClass+f+"-select-menu"},e.options,d.options.ui[a]);e.title||(e.title=g("Unnamed Select Menu"));e.wrapper=c('<div class="ui-editor-selectmenu-wrapper"/>').append(e.select.hide()).addClass(e.select.attr("class"));e.selectMenu=
c('<div class="ui-editor-selectmenu"/>').appendTo(e.wrapper);e.menu=c('<div class="ui-editor-selectmenu-menu ui-widget-content ui-corner-bottom ui-corner-tr"/>').appendTo(e.wrapper);e.select.find("option, .ui-editor-selectmenu-option").each(function(){c("<div/>").addClass("ui-editor-selectmenu-menu-item").addClass("ui-corner-all").html(c(this).html()).appendTo(e.menu).bind("mouseenter."+d.widgetName,function(){c(this).addClass("ui-state-focus")}).bind("mouseleave."+d.widgetName,function(){c(this).removeClass("ui-state-focus")}).bind("mousedown."+
d.widgetName,function(){return false}).bind("click."+d.widgetName,function(){var a=e.select.find("option, .ui-editor-selectmenu-option").eq(c(this).index()),a=a.attr("value")||a.val();e.select.val(a);e.update();e.wrapper.removeClass("ui-editor-selectmenu-visible");e.button.addClass("ui-corner-all").removeClass("ui-corner-top");e.change(a);return false})});var f=c("<div/>").addClass("ui-editor-selectmenu-text"),h=c("<div/>").addClass("ui-icon ui-icon-triangle-1-s");e.button=c("<div/>").addClass("ui-editor-selectmenu-button ui-editor-selectmenu-button ui-button ui-state-default").attr("title",
e.title).append(f).append(h).prependTo(e.selectMenu);e.button.bind("mousedown."+d.widgetName,function(){return false}).bind("click."+d.widgetName,function(){if(!c(this).hasClass("ui-state-disabled")){parseInt(e.menu.css("min-width"),10)<e.button.outerWidth()+10&&e.menu.css("min-width",e.button.outerWidth()+10);e.wrapper.toggleClass("ui-editor-selectmenu-visible");return false}}).bind("mouseenter."+d.widgetName,function(){c(this).hasClass("ui-state-disabled")||c(this).addClass("ui-state-hover",c(this).hasClass("ui-state-disabled"))}).bind("mouseleave."+
d.widgetName,function(){c(this).removeClass("ui-state-hover")});f=e.select.find("option[value="+this.select.val()+"], .ui-editor-selectmenu-option[value="+this.select.val()+"]").html()||e.select.find("option, .ui-editor-selectmenu-option").first().html();e.button.find(".ui-editor-selectmenu-text").html(f);return e.wrapper},update:function(){var a=this.select.find("option[value="+this.select.val()+"], .ui-editor-selectmenu-option[value="+this.select.val()+"]").html();this.button.find(".ui-editor-selectmenu-text").html(a)},
val:function(){var a=this.select.val.apply(this.select,arguments);this.update();return a},change:function(){}},a)},getPlugin:function(a){return this.plugins[a]},loadPlugins:function(){this.options.plugins||(this.options.plugins={});for(var a in c.ui.editor.plugins)if(!(!1===this.options.enablePlugins&&"undefined"===typeof this.options.plugins[a]||!1===this.options.plugins[a])&&-1===c.inArray(a,this.options.disabledPlugins)){var b=c.extend({},c.ui.editor.plugins[a]),d=a.replace(/([A-Z])/g,function(a){return"-"+
a.toLowerCase()}),d=c.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-"+d},b.options,this.options.plugins[a]);b.editor=this;b.options=d;b.init(this,d);b.hotkeys&&this.registerHotkey(b.hotkeys,null,b);this.plugins[a]=b}},isDirty:function(){return this.dirty},getHtml:function(){var a=this.getElement().html(),a=c("<div/>").html(a);a.find(".rangySelectionBoundary").remove();return a=a.html()},getCleanHtml:function(){this.fire("clean");var a=this.getElement().html();this.fire("restore");
a=c("<div/>").html(a);a.find(".rangySelectionBoundary").remove();return a=a.html()},setHtml:function(a){this.getElement().html(a);this.fire("html");this.change()},resetHtml:function(){this.setHtml(this.getOriginalHtml());this.fire("cleaned")},getOriginalHtml:function(){return this.originalHtml},save:function(){var a=this.getCleanHtml();this.fire("save");this.setOriginalHtml(a);this.fire("saved");this.fire("cleaned");return a},setOriginalHtml:function(a){this.originalHtml=a},bind:function(a,b,d){var e=
this.events;c.each(a.split(","),function(a,h){h=c.trim(h);e[h]||(e[h]=[]);e[h].push({context:d,callback:b})})},unbind:function(a,b,c){for(var e=0,f=this.events[a].length;e<f;e++)this.events[a][e]&&this.events[a][e].callback===b&&this.events[a][e].context===c&&this.events[a].splice(e,1)},fire:function(a,b,d){d||this.fire("before:"+a,b,!0);if(this.events[a])for(var e=0,f=this.events[a].length;e<f;e++){var h=this.events[a][e];"undefined"!==typeof h.callback&&h.callback.call(h.context||this)}!1!==b&&
c.ui.editor.fire(a);d||this.fire("after:"+a,b,!0)}});c.extend(c.ui.editor,{elementRemoveComments:function(a){a.contents().each(function(){8==this.nodeType&&c(this).remove()});a.children().each(function(){element.removeComments(c(this))});return a},elementRemoveAttributes:function(a,b){a.children().each(function(){var a=c.map(this.attributes,function(a){if(-1===c.inArray(a.name,b))return a.name}),e=c(this);c.each(a,function(a,b){e.removeAttr(b)});element.removeAttributes(c(this),b)});return a},elementBringToTop:J,
elementOuterHtml:o,elementOuterText:function(a){return a.clone().wrap("<div/>").parent().text()},elementIsBlock:function(a){return"block"===E(a.tagName)},elementDefaultDisplay:E,elementIsValid:F,elementGetStyles:S,fragmentToHtml:u,fragmentInsertBefore:function(a,b,d){for(var e=0,f=a.childNodes.length;e<f;e++){var h=a.childNodes.item(e);(h=3===h.nodeType?h.nodeValue:c(h).html())&&c("<"+d+"/>").html(c.trim(h)).insertBefore(b)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},
rangeGetCommonAncestor:U,rangeIsEmpty:V,selectionSave:p,selectionRestore:n,selectionDestroy:G,selectionEachRange:k,selectionReplace:t,selectionSelectInner:A,selectionSelectOuter:w,selectionSelectEdge:K,selectionSelectEnd:W,selectionSelectStart:x,selectionGetHtml:y,selectionGetElements:j,selectionToggleWrapper:s,selectionExists:function(a){var b=!1;k(function(a){V(a)||(b=!0)},a,this);return b},selectionReplaceSplittingSelectedElement:N,selectionReplaceWithinValidTags:B,selectionToggleBlockStyle:C,
stringStripTags:H,defaults:{plugins:{},ui:{},bind:{},domTools:{constrainSelection:function(a,b){var a=c(a)[0],b=b||i.getSelection(),d;c(b.getAllRanges()).each(function(e,f){d=3===this.commonAncestorContainer.nodeType?c(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;a!==d&&!c.contains(a,d)&&b.removeRange(f)})},unwrapParentTag:function(a){j().each(function(){c(this).is(a)&&c(this).replaceWith(c(this).html())})},execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(e){}},
insertTag:function(a,b){k(function(b){b.insertNode(c("<"+a+"/>")[0])},b,this)},insertTagAtEnd:function(a,b){k(function(b){b.insertNodeAtEnd(c("<"+a+"/>")[0])},b,this)},insertElement:function(a,b,d){k(function(d){c(a).each(function(){d.insertNode(!1===b?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(a,b,d){k(function(d){c(a).each(function(){d.insertNodeAtEnd(!1===b?this:this.cloneNode(!0))})},d,this)},wrapInner:function(a,b){p();c(a).each(function(){var d=c("<"+b+"/>").html(c(this).html());
a.html(d)});n()},inverseWrapWithTagClass:function(a,b,d,e){p();var f="domTools"+Math.ceil(1E7*Math.random());k(function(a){var c=i.createCssClassApplier(e,{elementTagName:d});c.isAppliedToRange(a)?c.toggleSelection():i.createCssClassApplier(b,{elementTagName:f}).toggleSelection()},null,this);c(f).each(function(){c(this).replaceWith(c("<"+a+"/>").addClass(b).html(c(this).html()))});n()},toggleStyle:function(a,b){c.each(b,function(b,e){c(a).css(b)===e?c(a).css(b,""):c(a).css(b,e)})},swapStyles:function(a,
...
this.ui.enable()}}});c.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:g("Insert Horizontal Rule"),click:function(){t("<hr/>")}})}}});c.ui.editor.registerUi({i18n:{init:function(a){var b=this,d=this.persist("locale");d&&Q(d);var d=c('<select autocomplete="off" name="i18n"/>'),e;for(e in z){var f=c('<option value="'+e+'" class="'+e+'"/>');f.html(P[e]);q===e&&f.attr("selected","selected");d.append(f)}return a.uiSelectMenu({title:g("Change Language"),select:d,change:function(a){Q(b.persist("locale",
a))}})}}});v("de","Deutsch",{"A preview of your embedded object is displayed below.":"Eine Vorschau ihres eingebundenen Objekts wird unterhalb angezeigt.","Added link: {{link}}":"Link hinzugef\u00fcgt: {{link}}","All changes will be lost!":"Alle \u00c4nderungen gehen verloren!","Apply Source":"Quellcode anwenden","Are you sure you want to stop editing?":"Wollen Sie wirklich mit der Bearbeitung aufh\u00f6ren?",Blockquote:"Zitat",Bold:"Fett",Cancel:"Abbrechen","Center Align":"Zentrieren","Change HTML tag of selected element":"HTML Tag des selektierten Elements \u00e4ndern",
...
"{{characters}} characters, {{charactersRemaining}} remaining":"{{characters}} Zeichen, {{charactersRemaining}} verbleibend","{{sentences}} sentences":"{{sentences}} S\u00e4tze","{{words}} word":"{{words}} Wort","{{words}} words":"{{words}} W\u00f6rter"});v("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"Apply Source",
...
"{{sentences}} sentences":"{{sentences}} oraciones","{{words}} word":"{{words}} palabra","{{words}} words":"{{words}} palabras"});v("fr","Fran\u00e7ais",{"A preview of your embedded object is displayed below.":"Un aper\u00e7u de votre objet int\u00e9gr\u00e9 est affich\u00e9 ci-dessous.","Added link: {{link}}":"Lien ajout\u00e9 : {{link}}","All changes will be lost!":"Toutes les modifications seront perdues !","Apply Source":"Appliquer la source","Are you sure you want to stop editing?":"\u00cates-vous s\u00fbr(e) de vouloir arr\u00eater la modification ?",
...
"{{words}} word":"{{words}} woord","{{words}} words":"{{words}} woorden"});v("zh-CN","\u7b80\u4f53\u4e2d\u6587",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"\u5e94\u7528\u6e90\u4ee3\u7801","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",Blockquote:"\u5927\u6bb5\u5f15\u7528",Bold:"\u7c97\u4f53",
...
this.options.manuallyResizingClass),d=c(b).innerWidth(),e=c(b).innerHeight(),f="#"+this.options.baseClass+"-width",h="#"+this.options.baseClass+"-height",O=this,i=function(a){a=Math.round(a||c(f).val())+"px";c(b).css({width:a})},j=c(this.editor.getTemplate("imageresize.manually-resize-image",{width:d,height:e,baseClass:this.options.baseClass}));j.dialog({modal:!0,resizable:!1,title:g("Modify Image Size"),autoOpen:!0,buttons:[{text:g("Resize Image"),click:function(){i(c(this).find(f).val());c(this).dialog("close")}},
{text:g("Cancel"),click:function(){i(d);c(this).dialog("close")}}],close:function(){O.editor.checkChange();c(j).remove()},open:function(){var a=c(this).find(f),b=c(this).find(h);a.keyup(function(){b.val(Math.round(Math.abs(e/d*c(this).val())));i()});b.keyup(function(){a.val(Math.round(Math.abs(d/e*c(this).val())));i()})}});a.preventDefault();return!1},displayToolsButtonRelativeToImage:function(a){var b=c("<button>"+g("Click to edit the image")+"</button>").appendTo("body").addClass(this.options.resizeButtonClass).button({text:!1,
...
this.displayToolsButtonRelativeToImage(a.target)},imageMouseLeave:function(a){c(a.relatedTarget).hasClass(this.options.resizeButtonClass)||(c(a.target).removeClass(this.options.manuallyResizingClass),this.removeToolsButtons())}});c.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:g("Page on this or another website"),focusSelector:'input[name="location"]',init:function(){this.content=this.plugin.editor.getTemplate("link.external",this.options);
...
this.change,this);a.bind("show",this.change,this);return a.uiButton({title:g("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){j().is("a")?this.ui.enable():this.ui.disable()}}});c.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),
toggleList:function(a){c(j()).is("li")&&c(j()).parent().is(a)?this.unwrapList():this.wrapList(a);this.editor.fire("selectionChange");this.editor.fire("change")},unwrapList:function(){p();var a=[],b=[],d=L(),e=M();a.push(c(d).html());b.push(d);if(c(d)[0]!==c(e)[0]){var f=d;do f=c(f).next(),a.push(c(f).html()),b.push(f);while(c(f)[0]!==c(e)[0])}f=0===c(d).prev().length;e=0===c(e).next().length;d=c(d).parent();for(listElementsIndex=0;listElementsIndex<b.length;listElementsIndex++)c(b[listElementsIndex]).remove();
for(b=0;b<a.length;b++)d.parent().is("li")||(a[b]="<p>"+a[b]+"</p>");f&&e?(d.replaceWith(a.join("")),n(),a=j()[0],w(a)):(f?c(d).before(a.join("")):e?c(d).after(a.join("")):N(a.join("")),n(),this.editor.checkChange())},wrapList:function(a){this.editor.constrainSelection(this.editor.getElement());""===c.trim(y())&&A(j());var b=c("<div>").html(y()),d=[],e=this;c(b).contents().each(function(){var a;a="block"===E(this.tagName)?H(c(this).html(),e.validChildren):H(o(c(this)),e.validChildren);a=c("<li>"+
a+"</li>");""!==c.trim(a.text())&&d.push(o(a))});b=this.options.baseClass+"-selection";a="<"+a+' class="'+b+'">'+d.join("")+"</"+a+">";n();var f=c(j()[0]).parent(),h=this.editor.getElement()[0];f===h||j()[0]===h?t(a):B(a,this.validParents);b=c(this.editor.getElement().find("."+b).removeClass(b));A(b.find("li:first")[0]);this.editor.checkChange()},toggleButtonState:function(a,b){var d=function(a){b.button.toggleClass("ui-state-highlight",a).toggleClass("ui-state-default",!a)},e=L();if(null===e||!e.length)e=
this.editor.getElement();var f=M();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(c(e).is(a)&&c(f).is(a)&&e===f)return d(!0);var h=c(e).parentsUntil(g,a).first()&&c(f).parentsUntil(g,a).first(),g="#"+this.editor.getElement().attr("id"),i=c(e).is(a+" > li")||c(e).parentsUntil(g,a+" > li").length,j=c(f).is(a+" > li")||c(f).parentsUntil(g,a+" > li").length;if(i&&j&&h){h=c(U());h.is(a)||(h=c(h).parentsUntil(g,a).first());g=h.find("ul, ol");if(!g.length)return d(!0);for(h=0;h<g.length;h++)if(c.contains(g[h],
...
c))});return(g?"[":"{")+(""+e)+(g?"]":"}")},b={enableUi:this.options.enableUi,enablePlugins:this.options.enablePlugins,disabledPlugins:a(this.options.disabledPlugins),ui:a(this.options.ui),t:(new Date).getTime()},d=[],e;for(e in b)d.push(e+"="+encodeURIComponent(b[e]));this.ui.button.find(".ui-button-icon-primary").css({"background-image":"url(http://www.jquery-raptor.com/logo/0.0.24?"+d.join("&")+")"})}})}}});c.ui.editor.registerPlugin("normaliseLineBreaks",{options:{enter:"<p><br/></p>",enterValidTags:"address,blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),
shiftEnter:"<br/>",shiftEnterValidTags:"a,abbr,acronym,address,applet,b,bdo,big,blockquote,body,button,caption,center,cite,code,dd,del,dfn,div,dt,em,fieldset,font,form,h1,h2,h3,h4,h5,h6,i,iframe,ins,kbd,label,legend,li,noframes,noscript,object,p,pres,q,s,samp,small,span,strike,strong,sub,sup,td,th,tt,u,var".split(",")},hotkeys:{"return":{action:function(){G();var a=""===i.getSelection().toHtml(),b;b=i.getSelection();var d=b.isBackwards()?b.focusNode:b.anchorNode;(b.isBackwards()?b.focusOffset:0!==
b.anchorOffset)?b=!1:(b=d.previousSibling,b=!b||""===c(b).html()?!0:!1);var e;d=i.getSelection();e=d.isBackwards()?d.anchorNode:d.focusNode;(d.isBackwards()?d.focusOffset:d.anchorOffset)!==e.textContent.length?e=!1:(d=e.nextSibling,e=!d||""===c(d).html()?!0:!1);var f=this.options.baseClass+"-enter-break",d=c(this.options.enter).attr("id",f);B(d,this.options.enterValidTags);d=c("#"+f).removeAttr("id");a?b?x(d.next()):e?x(d):(x(d.next()),(a=d.prev())&&""!==c.trim(a.html())&&o(a)!==this.options.enter&&
d.remove()):(x(d.next()),d.remove())},restoreSelection:!1},"return+shift":{action:function(){G();var a=this.options.baseClass+"-enter-break",b=c(this.shiftEnter).attr("id",a).appendTo("body");this.options.shiftEnterValidTags?B(this.options.shiftEnter,this.options.shiftEnterValidTags):t(b);a=c("#"+a).removeAttr("id").next();x(a)},restoreSelection:!1}}});c.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span,hr,br".split(","),allowedAttributes:["href",
"title"],allowedEmptyTags:["hr","br"]},init:function(a,b){var d=!1,e=!1,f=this;a.getElement().bind("paste."+a.widgetName,c.proxy(function(){if(d)return!1;d=!0;p();c(".uiWidgetEditorPasteBin").length&&c(".uiWidgetEditorPasteBin").remove();c('<div class="uiWidgetEditorPasteBin" contenteditable="true" style="width: 1px; height: 1px; overflow: hidden; position: fixed; top: -1px;" />').appendTo("body");c(".uiWidgetEditorPasteBin").focus();l.setTimeout(function(){var h=c(".uiWidgetEditorPasteBin").html(),
h=f.filterAttributes(h),h=f.filterChars(h),h=f.stripEmpty(h),h=f.stripAttributes(h),h=H(h,f.options.allowedTags),h={plain:c("<div/>").html(c(".uiWidgetEditorPasteBin").html()).text(),markup:h,html:c(".uiWidgetEditorPasteBin").html()};e=c(a.getTemplate("paste.dialog",h));c(e).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:b.dialogShowAnimation,hide:b.dialogHideAnimation,dialogClass:b.baseClass+" "+b.dialogClass,buttons:[{text:g("Insert"),click:function(){var b=
