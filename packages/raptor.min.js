...
var f=c("#elRaptor").css({position:"fixed",bottom:"-700px",right:"0",display:"block"});if("timer"==j.enterOn)setTimeout(i,j.delayTime);else if("click"==j.enterOn)r.bind("click",function(c){c.preventDefault();q||i()});else if("konami-code"==j.enterOn){var t=[];c(window).bind("keydown.raptorz",function(f){t.push(f.keyCode);0<=t.toString().indexOf("38,38,40,40,37,39,37,39,66,65")&&(i(),c(window).unbind("keydown.raptorz"))},!0)}})}})(jQuery);
(function(c,j,i,r){function o(a,b,c){s[a]=c;w[a]=b;l||(l=a)}function q(a){l!==a&&(l=a,c.ui.editor.eachInstance(function(){this.reinit()}))}function f(a,b){l&&s[l]&&s[l][a]&&(a=s[l][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function t(a){if(u===r){u=!0;if(x=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))c("html").addClass(a.options.baseClass+"-ios"),x&&c(document).bind("scroll",function(){setInterval(function(){c("body").css("height","+=1").css("height",
"-=1")},0)});c.browser.mozilla&&c("html").addClass(a.options.baseClass+"-ff");if(c.browser.msie&&9>c.browser.version){u=!1;var b=c("<div/>").addClass(a.options.baseClass+"-unsupported").html(a.getTemplate("unsupported")).appendTo("body");v(b);b.find("."+a.options.baseClass+"-unsupported-close").click(function(){b.remove()})}}return u}function v(a){var b=1;a.siblings().each(function(){var a=c(this).css("z-index");!isNaN(a)&&a>b&&(b=a+1)});a.css("z-index",b)}function m(a){return a.clone().wrap("<div/>").parent().html()}
function p(a,b){for(var d="",e=0,g=a.childNodes.length;e<g;e++){var h=a.childNodes.item(e);(h=3===h.nodeType?h.nodeValue:m(c(h)))&&(d+=h)}b&&(d=c("<"+b+">"+d+"</"+b+">"),d.find("p").wrapInner("<"+b+"/>"),d.find("p > *").unwrap(),d=c("<div/>").html(d).html());return d}function k(a,b,c){for(var b=b||i.getSelection(),e,g=0;e=b.getAllRanges()[g++];)a.call(c,e)}var l=null,s={},w={};c(function(){i.initialized||i.init();c.isFunction(i.rangePrototype.insertNodeAtEnd)||(i.rangePrototype.insertNodeAtEnd=function(a){var b=
this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});c("html").click(function(){c(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});c.widget("ui.editor",{_init:function(){-1===c.inArray(this,c.ui.editor.instances)&&c.ui.editor.instances.push(this);var a=this;c.ui.editor.eachInstance(function(b){a!=b&&a.element.closest(b.element).length&&handleError("Nesting editors is unsupported",a.element,b.element)});this.options=c.extend({},c.ui.editor.defaults,
...
"debugDestroy"]];this.element.attr("id")||this.element.attr("id",this.getUniqueId());this.ready=!1;this.events={};this.ui={};this.plugins={};this.templates=c.extend({},c.ui.editor.templates);this.path=this.toolbarWrapper=this.toolbar=this.wrapper=null;this.visible=this.enabled=!1;this.uiObjects={};for(var b in this.options.bind)this.bind(b,this.options.bind[b]);this.history=[];this.present=0;this.historyEnabled=!0;t(this)&&(this.cloneDomTools(),this.setOriginalHtml(this.element.is(":input")?this.element.val():
this.element.html()),this.options.replace&&(this.replaceOriginal(),this.options.replace=!1),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,this.ready=!0,this.fire("ready"),this.options.autoEnable&&c(function(){a.enableEditing();a.showToolbar()}))},attach:function(){this.bind("change",this.historyPush);this.bind("selectionChange",this.updateTagTree);this.bind("show",this.updateTagTree);var a=c.proxy(this.checkChange,this);this.getElement().find("img").bind("click."+
this.widgetName,c.proxy(function(a){this.selectOuter(a.target)},this));this.getElement().bind("mouseup."+this.widgetName,a);this.getElement().bind("keyup."+this.widgetName,a);c(j).bind("beforeunload",c.proxy(c.ui.editor.unloadWarning,c.ui.editor))},reinit:function(){if(this.ready){var a=this.enabled,b=this.visible;this.destruct();this._init();a&&this.enableEditing();b&&this.showToolbar()}else{var c;c=function(){this.unbind("ready",c);this.reinit()};this.bind("ready",c)}},getElement:function(){return this.target?
...
b;a++){for(var d=this.options.uiOrder[a],e=c("<div/>"),g=0,h=d.length;g<h;g++)if(this.uiEnabled(d[g])){var f=d[g].replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});if(c.ui.editor.ui[d[g]]){var n=c.extend({},c.ui.editor.ui[d[g]]),f=c.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-ui-"+f},n.options,this.options.ui[d[g]]);n.editor=this;n.options=f;n.ui=n.init(this,f);n.ui.init(d[g],this,f,n).appendTo(e);this.uiObjects[d[g]]=n}}e.addClass("ui-buttonset").addClass(this.options.baseClass+
...
a).attr("title",this.title).val(a);e.classes&&this.button.addClass(e.classes);this.button.bind("mousedown."+g.editor.widgetName,function(a){a.preventDefault()});var y=this;this.button.bind("mouseup."+g.editor.widgetName,function(a){a.preventDefault();y.click.apply(g,arguments)});d.bind("destroy",c.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+h},disabled:e.disabled?!0:!1,text:this.text||!1,label:this.label||null});this.ready.call(g);
...
e.wrapper=c('<div class="ui-editor-selectmenu-wrapper"/>').append(e.select.hide());e.selectMenu=c('<div class="ui-editor-selectmenu"/>').appendTo(e.wrapper);e.menu=c('<div class="ui-editor-selectmenu-menu ui-widget-content ui-corner-bottom ui-corner-tr"/>').appendTo(e.wrapper);e.select.find("option").each(function(){c("<div/>").addClass("ui-editor-selectmenu-menu-item").addClass("ui-corner-all").html(c(this).html()).appendTo(e.menu).bind("mouseenter."+d.widgetName,function(){c(this).addClass("ui-state-focus")}).bind("mouseleave."+
d.widgetName,function(){c(this).removeClass("ui-state-focus")}).bind("mousedown."+d.widgetName,function(){return false}).bind("click."+d.widgetName,function(){var a=e.select.find("option").eq(c(this).index());e.select.val(a.val());e.update();e.wrapper.removeClass("ui-editor-selectmenu-visible");e.button.addClass("ui-corner-all").removeClass("ui-corner-top");e.change(e.select.val());return false})});var g=c("<div/>").addClass("ui-editor-selectmenu-text"),h=c("<div/>").addClass("ui-icon ui-icon-triangle-1-s");
e.button=c("<div/>").addClass("ui-editor-selectmenu-button ui-editor-selectmenu-button ui-button ui-state-default").attr("title",e.title).append(g).append(h).prependTo(e.selectMenu);e.button.bind("mousedown."+d.widgetName,function(){return false}).bind("click."+d.widgetName,function(){e.menu.css("min-width",e.button.outerWidth()+10);e.wrapper.toggleClass("ui-editor-selectmenu-visible");return false});g=e.select.find("option[value="+e.select.val()+"]").html();e.button.find(".ui-editor-selectmenu-text").html(g);
return e.wrapper},update:function(){var a=this.select.find("option[value="+this.select.val()+"]").html();this.button.find(".ui-editor-selectmenu-text").html(a)},val:function(){var a=this.select.val.apply(this.select,arguments);this.update();return a},change:function(){}},a)},getPlugin:function(a){return this.plugins[a]},loadPlugins:function(){this.options.plugins||(this.options.plugins={});for(var a in c.ui.editor.plugins)if(!(!1===this.options.enablePlugins&&"undefined"===typeof this.options.plugins[a]||
!1===this.options.plugins[a])&&-1===c.inArray(a,this.options.disabledPlugins)){var b=c.extend({},c.ui.editor.plugins[a]),d=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),d=c.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-"+d},b.options,this.options.plugins[a]);b.editor=this;b.options=d;b.init(this,d);this.plugins[a]=b}},isDirty:function(){return this.dirty},getHtml:function(){var a=this.getElement().html(),a=c("<div/>").html(a);a.find(".rangySelectionBoundary").remove();
...
this.fire("cleaned");return a},setOriginalHtml:function(a){this.originalHtml=a},bind:function(a,b,d){var e=this.events;c.each(a.split(","),function(a,h){h=c.trim(h);e[h]||(e[h]=[]);e[h].push({context:d,callback:b})})},unbind:function(a,b,c){for(var e=0,g=this.events[a].length;e<g;e++)this.events[a][e]&&this.events[a][e].callback===b&&this.events[a][e].context===c&&this.events[a].splice(e,1)},fire:function(a,b,d){d||this.fire("before:"+a,b,!0);if(this.events[a])for(var e=0,g=this.events[a].length;e<
g;e++){var h=this.events[a][e];"undefined"!==typeof h.callback&&h.callback.call(h.context||this)}!1!==b&&c.ui.editor.fire(a);d||this.fire("after:"+a,b,!0)}});c.extend(c.ui.editor,{defaults:{plugins:{},ui:{},bind:{},domTools:{savedSelection:!1,saveSelection:function(){this.savedSelection=i.saveSelection()},restoreSelection:function(){this.savedSelection&&(i.restoreSelection(this.savedSelection),this.savedSelection=!1)},constrainSelection:function(a,b){var a=c(a)[0],b=b||i.getSelection(),d;c(b.getAllRanges()).each(function(e,
g){d=3===this.commonAncestorContainer.nodeType?c(g.commonAncestorContainer).parent()[0]:g.commonAncestorContainer;a!==d&&!c.contains(a,d)&&b.removeRange(g)})},getSelectedElements:function(a){var b=new jQuery;k(function(a){b.push(this.getSelectedElement(a)[0])},a,this);return b},getSelectedElement:function(a){a=a||i.getSelection().getRangeAt(0);return c(3===a.commonAncestorContainer.nodeType?a.commonAncestorContainer.parentNode:a.commonAncestorContainer)},getSelectedHtml:function(a){a=a||i.getSelection();
return a.toHtml()},getSelectionStartElement:function(){var a=i.getSelection();return a.isBackwards()?3===a.focusNode.nodeType?c(a.focusNode.parentElement):c(a.focusNode):3===a.anchorNode.nodeType?c(a.anchorNode.parentElement):c(a.anchorNode)},getSelectionEndElement:function(){var a=i.getSelection();return a.isBackwards()?3===a.anchorNode.nodeType?c(a.anchorNode.parentElement):c(a.anchorNode):3===a.focusNode.nodeType?c(a.focusNode.parentElement):c(a.focusNode)},unwrapParentTag:function(a){this.getSelectedElements().each(function(){c(this).is(a)&&
c(this).replaceWith(c(this).html())})},wrapTagWithAttribute:function(a,b,c){k(function(e){e=this.getSelectedElement(e);e.is(a)?e.attr(b):this.toggleWrapper(a,{classes:c,attributes:b})},null,this)},selectInner:function(a,b){b=b||i.getSelection();b.removeAllRanges();c(a).focus().contents().each(function(){var a=i.createRange();a.selectNodeContents(this);b.addRange(a)})},selectOuter:function(a,b){b=b||i.getSelection();b.removeAllRanges();c(a).each(function(){var a=i.createRange();a.selectNode(this);
b.addRange(a)}).focus()},selectEnd:function(a,b){b=b||i.getSelection();b.removeAllRanges();c(a).each(function(){var a=i.createRange();a.selectNodeContents(this);a.collapse();b.addRange(a)})},toggleWrapper:function(a,b){var b=b||{},d=i.createCssClassApplier(b.classes||"",{normalize:!0,elementTagName:a,elementProperties:b.attributes||{}});k(function(e){this.rangeEmptyTag(e)?this.replaceRange(c("<"+a+"/>").addClass(b.classes).attr(b.attributes||{}).append(p(e.cloneContents())),e):d.toggleRange(e)},null,
this)},rangeEmptyTag:function(a){a=a.cloneContents();a=p(a);"string"===typeof a&&(a=a.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));return c(a).is(":empty")?!0:!1},execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(e){}},insertTag:function(a,b){k(function(b){b.insertNode(c("<"+a+"/>")[0])},b,this)},insertTagAtEnd:function(a,b){k(function(b){b.insertNodeAtEnd(c("<"+a+"/>")[0])},b,this)},insertElement:function(a,b,d){k(function(d){c(a).each(function(){d.insertNode(!1===b?this:this.cloneNode(!0))})},
d,this)},insertElementAtEnd:function(a,b,d){k(function(d){c(a).each(function(){d.insertNodeAtEnd(!1===b?this:this.cloneNode(!0))})},d,this)},toggleBlockStyle:function(a,b){k(function(d){for(d=c(d.commonAncestorContainer);d.length&&d[0]!==b[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===b[0]&&"inline"!==b.css("display")&&(this.wrapInner(b,"div"),d=b.children().first());this.toggleStyle(d,a)},null,this)},wrapInner:function(a,b){this.saveSelection();c(a).each(function(){var d=
c("<"+b+"/>").html(c(this).html());a.html(d)});this.restoreSelection()},inverseWrapWithTagClass:function(a,b,d,e){this.saveSelection();var g="domTools"+Math.ceil(1E7*Math.random());k(function(a){var c=i.createCssClassApplier(e,{elementTagName:d});c.isAppliedToRange(a)?c.toggleSelection():i.createCssClassApplier(b,{elementTagName:g}).toggleSelection()},null,this);c(g).each(function(){c(this).replaceWith(c("<"+a+"/>").addClass(b).html(c(this).html()))});this.restoreSelection()},toggleStyle:function(a,
b){c.each(b,function(b,e){c(a).css(b)===e?c(a).css(b,""):c(a).css(b,e)})},getStyles:function(a){for(var b={},a=j.getComputedStyle(a[0],null),c=0;c<a.length;c++)b[a.item(c)]=a.getPropertyValue(a.item(c));return b},swapStyles:function(a,b,c){for(var e in c)a.css(e,b.css(e)),b.css(e,c[e])},replaceSelectionWithinValidTags:function(a,b,c){var c=c||i.getSelection(),e=this.getSelectionStartElement()[0],g=this.getSelectionEndElement()[0],h=this.isElementValid(this.getSelectedElements()[0],b),e=this.isElementValid(e,
b),b=this.isElementValid(g,b);h&&e&&b?this.replaceSelection(a):this.replaceSelectionSplittingSelectedElement(a,c)},replaceSelectionSplittingSelectedElement:function(a,b){var b=b||i.getSelection(),d=b.getRangeAt(0),e=this.getSelectedElements()[0],g=i.createRange();g.setStartBefore(e);g.setEnd(d.startContainer,d.startOffset);var g=g.cloneContents(),h=i.createRange();h.setStart(d.endContainer,d.endOffset);h.setEndAfter(e);d=h.cloneContents();g=m(c(p(g)));g+=m(c(a));g+=m(c(p(d)));c(e).replaceWith(c(g))},
replaceSelection:function(a,b){k(function(b){this.replaceRange(a,b)},b,this)},replaceRange:function(a,b){var d=c("<div/>").append(a)[0].childNodes;b.deleteContents();d.length===r||1===d.length?b.insertNode(d[0].cloneNode(!0)):c.each(d,function(a,c){b.insertNodeAtEnd(c.cloneNode(!0))})},insertDomFragmentBefore:function(a,b,d){for(var e=0,g=a.childNodes.length;e<g;e++){var h=a.childNodes.item(e);(h=3===h.nodeType?h.nodeValue:c(h).html())&&c("<"+d+"/>").html(c.trim(h)).insertBefore(b)}},selectionExists:function(a){var b=
!1;k(function(a){this.isEmpty(a)||(b=!0)},a,this);return b},isEmpty:function(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer},changeTag:function(a,b){this.insertDomFragmentBefore(a.extractContents(),a.startContainer,b);c(a.startContainer).remove()},tagSelection:function(a,b){this.tagSelectionWithin(a,null,b)},tagSelectionWithin:function(a,b,d){k(function(d){if(this.isEmpty(d))d.setStartBefore(d.startContainer),d.setEndAfter(d.endContainer),b=c(b)[0],"undefined"!==typeof b&&
d.startContainer===b&&d.endContainer===b?this.wrapInner(c(b),a):this.changeTag(d,a);else{var g=d.extractContents();this.replaceRange(p(g,a),d)}},d,this)},isElementValid:function(a,b){return-1!==c.inArray(c(a)[0].tagName.toLowerCase(),b)},stripTags:function(a,b){allowed=[];for(var c=0;c<b.length;c++)b[c].match(/[a-z][a-z0-9]{0,}/g)&&allowed.push(b[c]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,b){return-1<allowed.indexOf(b.toLowerCase())?
...
a.resetHtml();a.hideToolbar();a.disableEditing()})}}});c.ui.editor.registerPlugin("clean",{options:{stripAttrs:["_moz_dirty"],stripAttrContent:{type:"_moz"},stripEmptyTags:"h1,h2,h3,h4,h5,h6,p,b,i,u,strong,em,big,small,div,span".split(","),stripEmptyAttrs:["class","id","style"],stripDomains:[{selector:"a",attributes:["href"]},{selector:"img",attributes:["src"]}]},init:function(a){a.bind("change",this.clean,this)},clean:function(){var a,b=this.editor;for(a=0;a<this.options.stripAttrs.length;a++)b.getElement().find("["+
this.options.stripAttrs[a]+"]").removeAttr(this.options.stripAttrs[a]);for(a=0;a<this.options.stripAttrContent.length;a++)b.getElement().find("["+a+'="'+this.options.stripAttrs[a]+'"]').removeAttr(this.options.stripAttrs[a]);for(a=0;a<this.options.stripEmptyTags.length;a++)b.getElement().find(this.options.stripEmptyTags[a]).filter(function(){if(""!==c.trim(c(this).html()))return!1;if(!c(this).hasClass("rangySelectionBoundary"))return!0;if(!1!==b.savedSelection)return!1}).remove();for(a=0;a<this.options.stripEmptyAttrs.length;a++){var d=
this.options.stripEmptyAttrs[a];b.getElement().find("["+this.options.stripEmptyAttrs[a]+"]").filter(function(){return""===c.trim(c(this).attr(d))}).removeAttr(this.options.stripEmptyAttrs[a])}var e=j.location.protocol+"//"+j.location.host,g="//"+j.location.host;for(a=0;a<this.options.stripDomains.length;a++){var h=this.options.stripDomains[a];this.editor.getElement().find(h.selector).each(function(){for(var a=0;a<h.attributes.length;a++){var b=c(this).attr(h.attributes[a]);"undefined"!==typeof b&&
(0===b.indexOf(e)?c(this).attr(h.attributes[a],b.substr(e.length)):0===b.indexOf(g)&&c(this).attr(h.attributes[a],b.substr(g.length)))}})}}});c.ui.editor.registerUi({clean:{init:function(a){return a.uiButton({title:f("Remove unnecessary markup from editor content"),click:function(){a.getPlugin("clean").clean()}})}}});c.ui.editor.registerUi({clearFormatting:{init:function(a){return this.editor.uiButton({title:f("Clear Formatting"),click:function(){var b=i.getSelection();if(0<b.rangeCount){var d=b.getRangeAt(0).cloneRange(),
e=d.extractContents();""==p(e)&&(a.expandToParent(d),b.setSingleRange(d),e=d.extractContents());e=c("<div/>").append(p(e)).text();for(b=d.commonAncestorContainer;b&&b.parentNode!=a.getElement().get(0);)b=b.parentNode;if(b){d.setEndAfter(b);var g=d.extractContents();d.collapseAfter(b);d.insertNode(g);d.collapseAfter(b)}d.insertNode(document.createTextNode(e))}a.checkChange()}})}}});c.ui.editor.registerPlugin("clickToEdit",{init:function(a,b){var d=this,e=c(a.getTemplate("clicktoedit.message",b)).appendTo("body"),
b=c.extend({},{obscureLinks:!1,position:{at:"center center",of:a.getElement(),my:"center center",using:function(a){c(this).css({position:"absolute",top:a.top,left:a.left})}}},b);this.selection=function(){var a;document.selection?a=document.selection.createRange():document.getSelection().rangeCount&&(a=document.getSelection().getRangeAt(0));return a};this.show=function(){a.isEditing()||(a.getElement().addClass(b.baseClass+"-highlight"),a.getElement().addClass(b.baseClass+"-hover"),e.position(b.position),
e.addClass(b.baseClass+"-visible"))};this.hide=function(){a.getElement().removeClass(b.baseClass+"-highlight");a.getElement().removeClass(b.baseClass+"-hover");e.removeClass(b.baseClass+"-visible")};this.edit=function(){d.hide();a.isEditing()||a.enableEditing();a.isVisible()||a.showToolbar(d.selection())};e.position(b.position);b.obscureLinks||(a.getElement().find("a").bind("mouseenter."+a.widgetName,d.hide),a.getElement().find("a").bind("mouseleave."+a.widgetName,d.show));a.getElement().bind("mouseenter."+
a.widgetName,d.show);a.getElement().bind("mouseleave."+a.widgetName,d.hide);a.getElement().bind("click."+a.widgetName,function(a){(b.obscureLinks||!c(a.target).is("a")&&!c(a.target).parents("a").length)&&d.edit()});a.bind("destroy",function(){e.remove();a.getElement().unbind("mouseenter."+a.widgetName,d.show);a.getElement().unbind("mouseleave."+a.widgetName,d.hide);a.getElement().unbind("click."+a.widgetName,d.edit)})}});c.ui.editor.registerPlugin("dock",{enabled:!1,docked:!1,topSpacer:null,bottomSpacer:null,
...
(this.topSpacer=c("<div/>").addClass(this.options.baseClass+"-top-spacer").height(this.editor.toolbar.outerHeight()).prependTo("body"),this.bottomSpacer=c("<div/>").addClass(this.options.baseClass+"-bottom-spacer").height(this.editor.path.outerHeight()).appendTo("body"),this.editor.fire("resize"))},hideSpacers:function(){this.topSpacer&&(this.topSpacer.remove(),this.topSpacer=null);this.bottomSpacer&&(this.bottomSpacer.remove(),this.bottomSpacer=null);this.editor.fire("resize")},swapStyle:function(a,
b,c){var e={},g;for(g in c)a.css(g,b.css(g)),e[g]=b.css(g),b.css(g,c[g]);return e},revertStyle:function(a,b){for(var c in b)a.css(c,b[c])},dockToElement:function(){var a=c("<div/>").insertBefore(this.editor.getElement()).addClass(this.options.baseClass+"-docked-to-element-wrapper");this.editor.wrapper.appendTo(a);this.previousStyle=this.swapStyle(a,this.editor.getElement(),{display:"block","float":"none",clear:"none",position:"static","margin-left":0,"margin-right":0,"margin-top":0,"margin-bottom":0,
outline:0,width:"auto"});a.css("width",a.width()+parseInt(this.editor.getElement().css("padding-left"),10)+parseInt(this.editor.getElement().css("padding-right"),10));this.editor.getElement().appendTo(this.editor.wrapper).addClass(this.options.baseClass+"-docked-element")},undockFromElement:function(){this.editor.getElement().insertAfter(this.editor.wrapper).removeClass(this.options.baseClass+"-docked-element");this.editor.wrapper.appendTo("body").removeClass(this.options.baseClass+"-docked-to-element")},
dockToBody:function(){var a=0;c(this.options.dockUnder).length&&(a=c(this.options.dockUnder).outerHeight());this.top=this.editor.toolbarWrapper.css("top");this.editor.toolbarWrapper.css("top",a);this.editor.wrapper.addClass(this.options.baseClass+"-docked");this.editor.messages.css("top",a+this.editor.toolbar.outerHeight())},undockFromBody:function(){this.editor.toolbarWrapper.css("top",this.top);this.editor.wrapper.removeClass(this.options.baseClass+"-docked");this.hideSpacers()},dock:function(){if(!this.docked){this.docked=
...
"ui-icon-pin-s",click:function(){var b=a.getPlugin("dock");b.isDocked()?b.undock():b.dock();a.unify(function(a){b.isDocked()?a.getPlugin("dock").dock():a.getPlugin("dock").undock()})}})}}});c.ui.editor.registerUi({embed:{dialog:null,init:function(a){a.bind("hide",this.hide,this);return a.uiButton({icon:"ui-icon-youtube",title:f("Embed object"),click:function(){this.show()}})},hide:function(){this.dialog&&c(this.dialog).dialog("destroy").remove();this.dialog=null;c(this.ui.button).button("option",
"disabled",!1)},show:function(){if(!this.dialog){c(this.ui.button).button("option","disabled",!0);var a=this;a.editor.saveSelection();this.dialog=c(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:f("Paste Embed Code"),autoOpen:!0,dialogClass:a.options.baseClass+" "+a.options.dialogClass,buttons:[{text:f("Embed Object"),click:function(){a.editor.restoreSelection();a.editor.replaceSelection(c(this).find("textarea").val());c(this).dialog("close")}},
{text:f("Close"),click:function(){a.hide()}}],open:function(){var a=c(this).parent().find(".ui-dialog-buttonpane");a.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});a.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});var d=c(this).find(".ui-editor-embed-panel-tabs");d.find("ul li").click(function(){d.find("ul li").removeClass("ui-state-active").removeClass("ui-tabs-selected");c(this).addClass("ui-state-active").addClass("ui-tabs-selected");d.children("div").hide().eq(c(this).index()).show()});
var e=c(this).find(".ui-editor-embed-preview");c(this).find("textarea").change(function(){c(e).html(c(this).val())})},close:function(){a.hide()}})}}}});c.ui.editor.registerPlugin("emptyElement",{options:{tag:"<p/>"},init:function(){this.bind("change",this.change)},change:function(){var a=this;this.textNodes(this.editor.getElement()).each(function(){c(this).wrap(c(a.options.tag));a.editor.selectEnd(this)});this.editor.checkChange()},textNodes:function(a){return c(a).contents().filter(function(){return 3==
this.nodeType&&c.trim(this.nodeValue).length})}});c.ui.editor.registerUi({floatLeft:{init:function(a){return a.uiButton({title:f("Float Image Left"),click:function(){k(function(a){c(a.commonAncestorContainer).find("img").css("float","left")})}})}},floatRight:{init:function(a){return a.uiButton({title:f("Float Image Right"),click:function(){k(function(a){c(a.commonAncestorContainer).find("img").css("float","right")})}})}},floatNone:{init:function(a){return a.uiButton({title:f("Remove Image Float"),
...
b){a.bind("cancel",this.cancel,this);a.bind("destroy",this.cancel,this);return a.uiButton({title:f("Show Guides"),icon:"ui-icon-pencil",click:function(){a.getElement().toggleClass(b.baseClass+"-visible")}})},cancel:function(){this.editor.getElement().removeClass(this.options.baseClass+"-visible")}}});c.ui.editor.registerUi({undo:{init:function(a){a.bind("change",this.change,this);return a.uiButton({title:f("Step Back"),disabled:!0,click:function(){a.historyBack()}})},change:function(){0===this.editor.present?
this.ui.disable():this.ui.enable()}},redo:{init:function(a){a.bind("change",this.change,this);return this.ui=a.uiButton({title:f("Step Forward"),disabled:!0,click:function(){a.historyForward()}})},change:function(){this.editor.present===this.editor.history.length-1?this.ui.disable():this.ui.enable()}}});c.ui.editor.registerPlugin("hotkeys",{options:{actions:[{ui:"textBold",key:"b",label:f("ctrl + b")},{ui:"textItalic",key:"i",label:f("ctrl + i")},{ui:"textUnderline",key:"u",label:f("ctrl + u")},{ui:"undo",
key:"z",label:f("ctrl + z")},{ui:"redo",key:"y",label:f("ctrl + y")},{ui:"cancel",meta:!1,key:27,label:f("esc")},{ui:"save",key:"s",label:f("ctrl + s")}]},indexedActions:{},keyUpEventSignature:null,keyDownEventSignature:null,init:function(a){this.keyUpEventSignature="keyup."+this.options.baseClass;this.keyDownEventSignature="keydown."+this.options.baseClass;a.bind("enabled",this.enabled,this);a.bind("disabled",this.disabled,this)},disabled:function(){c(j).unbind(this.keyUpEventSignature);c(j).unbind(this.keyDownEventSignature);
this.indexedActions={}},enabled:function(){for(var a,b=0;b<this.options.actions.length;b++)if(a=this.options.actions[b],this.indexedActions[this.isNumeric(a.key)?a.key:a.key.charCodeAt(0)]=a,"undefined"!==typeof a.ui){var d=this.editor.getUi(a.ui);"undefined"!==typeof d&&d.ui.button.attr("title",d.ui.title+" ("+a.label+")")}var e=this;c(j).bind(this.keyDownEventSignature,function(a){e.actionForKeyCombination.call(e,a)&&a.preventDefault()});c(j).bind(this.keyUpEventSignature,function(a){var b=e.actionForKeyCombination.call(e,
a);b&&((c.isFunction(b.callback)?b.callback:function(){e.triggerUiAction(b.ui)}).call(e,a),a.preventDefault())})},actionForKeyCombination:function(a){var b=a.which;65<=b&&90>=b&&(b+=32);var c=this.indexedActions[b];if("undefined"===typeof c||!(!1===c.meta||a.ctrlKey||a.metaKey))return!1;a=!1;return(a=this.isNumeric(c.key)?b===c.key:String.fromCharCode(b).toLowerCase()===c.key)?c:!1},triggerUiAction:function(a,b){var c=this.editor.getUi(a);"undefined"!==typeof c&&c.ui.click.apply(c,b)},isNumeric:function(a){return!isNaN(a-
0)}});c.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:f("Insert Horizontal Rule"),click:function(){a.replaceSelection("<hr/>")}})}}});c.ui.editor.registerUi({i18n:{init:function(a){var b=this,d=this.persist("locale");d&&q(d);var d=c('<select autocomplete="off" name="i18n"/>'),e;for(e in s){var g=c('<option value="'+e+'" class="'+e+'"/>');g.html(w[e]);l===e&&g.attr("selected","selected");d.append(g)}return a.uiSelectMenu({title:f("Change Language"),select:d,change:function(a){q(b.persist("locale",
a))}})}}});o("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"Apply Source","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",Blockquote:"Blockquote",Bold:"Bold",Cancel:"Cancel","Center Align":"Center Align","Change HTML tag of selected element":"Change HTML tag of selected element",
...
"{{images}} image(s) have been replaced with resized versions":"{{images}} image(s) a(ont) \u00e9t\u00e9 remplac\u00e9e(s) par une version redimensionn\u00e9e","{{sentences}} sentences":"{{sentences}} phrases","{{words}} word":"{{words}} mot","{{words}} words":"{{words}} mots"});o("zh_CN","\u7b80\u4f53\u4e2d\u6587",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!",
...
"{{characters}} characters, {{charactersRemaining}} remaining":"{{characters}} characters, {{charactersRemaining}} remaining","{{images}} image(s) have been replaced with resized versions":"{{images}} image(s) have been replaced with resized versions","{{sentences}} sentences":"{{sentences}} sentences","{{words}} word":"{{words}} word","{{words}} words":"{{words}} words"});c.ui.editor.registerPlugin("imageResize",{options:{allowOversizeImages:!1,manuallyResizingClass:"",resizeButtonClass:"",resizeAjax:!1,
resizingClass:"",resizeAjaxClass:"",ajax:{url:"/",type:"post",cache:!1}},init:function(a){this.options=c.extend(this.options,{manuallyResizingClass:this.options.baseClass+"-manually-resize",resizeButtonClass:this.options.baseClass+"-resize-button",resizingClass:this.options.baseClass+"-in-progress",resizeAjaxClass:this.options.baseClass+"-on-save"});a.bind("enabled",this.bind,this)},bind:function(){this.options.allowOversizeImages||(this.addImageListeners(),this.editor.bind("change",this.scanForOversizedImages,
this),this.editor.bind("save",this.save,this));this.editor.bind("destroy",this.cancel,this);this.editor.bind("cancel",this.cancel,this);this.editor.getElement().on("mouseenter."+this.options.baseClass,"img",c.proxy(this.imageMouseEnter,this));this.editor.getElement().on("mouseleave."+this.options.baseClass,"img",c.proxy(this.imageMouseLeave,this))},unbind:function(){this.options.allowOversizeImages||(this.removeImageListeners(),this.editor.unbind("change",this.scanForOversizedImages,this));this.editor.getElement().off("mouseenter."+
...
this.addEventListener("DOMAttrModified",a.resized,!1);this.detachEvent&&this.detachEvent("onpropertychange",a.resized)})},imageResizedByUser:function(a){var b=c(a.target);b.is("img")&&b.attr("_moz_resizing")&&"style"==a.attrName&&a.newValue.match(/width|height/)&&(this.options.resizeAjax&&b.addClass(this.options.resizeAjaxClass),this.editor.fire("change"))},scanForOversizedImages:function(){var a=this.editor.getElement(),b=[];c(a.find("img")).each(function(){(a.height()<c(this).outerHeight()||a.width()<
c(this).outerWidth())&&b.push(c(this))});b.length&&this.resizeOversizedImages(b,a.width(),a.height())},resizeOversizedImages:function(a,b,d){for(var e=c("<a>",{href:"",target:"_blank"}),g=0;g<a.length;g++){var h=a[g],f=h.outerWidth(),i=h.outerHeight(),j=Math.min(b/f,d/i),f=Math.abs(j*(f-(h.outerWidth()-h.width()))),i=Math.abs(j*(i-(h.outerHeight()-h.height())));h.addClass(this.options.resizingClass);e=e.html(h.attr("title")||h.attr("src").substr(h.attr("src").lastIndexOf("/")+1)).attr("href",h.attr("src"));
c(h).css({width:f,height:i}).attr("height",i).attr("width",f);this.options.resizeAjax&&h.addClass(this.options.resizeAjaxClass);var z=this;this.showOversizeWarning(m(c(e)),{hide:function(){h.removeClass(z.options.resizingClass)}})}},cancel:function(){this.removeClasses();this.removeToolsButtons();this.unbind()},save:function(){this.removeClasses(this.options.resizingClass);this.options.resizeAjax&&this.resizeImagesAjax();this.removeToolsButtons();this.unbind()},resizeImagesAjax:function(){var a=this,
b=[];c("."+this.options.resizeAjaxClass).each(function(){c(this).attr("id")||c(this).attr("id",a.editor.getUniqueId());b.push({id:c(this).attr("id"),src:this.src,width:c(this).width(),height:c(this).height()})});if(b.length){var d=this.editor.showLoading(f("Resizing image(s)")),e=this.options.ajax;e.data={images:b};e.async=!1;c.ajax(e).done(function(e){c(e).each(function(){c("#"+this.id).attr("src",this.src).removeAttr("id")});a.editor.fire("change");d.hide();a.editor.showConfirm(f("{{images}} image(s) have been replaced with resized versions",
...
{image:a}),b)},removeClasses:function(a){a||(a=[this.options.resizingClass,this.options.resizeAjaxClass,this.options.manuallyResizingClass]);c.isArray(a)||(a=[a]);for(var b=0;b<a.length;b++)this.editor.getElement().find("img."+a[b]).removeClass(a[b])},manuallyResizeImage:function(){this.removeToolsButtons();var a=this.editor.getElement().find("img."+this.options.manuallyResizingClass),b=c(a).innerWidth(),d=c(a).innerHeight(),e="#"+this.options.baseClass+"-width",g="#"+this.options.baseClass+"-height",
h=this,i=function(b,d){c(a).css({width:b||Math.round(c(e).val())+"px",height:d||Math.round(c(g).val())+"px"})},j=c(this.editor.getTemplate("imageresize.manually-resize-image",{width:b,height:d,baseClass:this.options.baseClass}));j.dialog({modal:!0,resizable:!1,title:f("Modify Image Size"),autoOpen:!0,buttons:[{text:f("Resize Image"),click:function(){i();c(this).dialog("close")}},{text:f("Cancel"),click:function(){i(b,d);c(this).dialog("close")}}],close:function(){h.editor.checkChange();c(j).remove()},
open:function(){var a=c(this).find(e),f=c(this).find(g);a.keyup(function(){f.val(Math.round(Math.abs(d/b*c(this).val())));i()});f.keyup(function(){a.val(Math.round(Math.abs(b/d*c(this).val())));i()})}})},displayToolsButtonRelativeToImage:function(a){var b=c("<button/>").appendTo("body").addClass(this.options.resizeButtonClass).button({text:!1,icons:{primary:"ui-icon-tools"}});b.css({position:"absolute",left:c(a).position().left+c(a).innerWidth()-c(b).outerWidth()-10+"px",marginTop:"10px"}).click(c.proxy(this.manuallyResizeImage,
this));c(a).before(b)},removeToolsButtons:function(){this.editor.getElement().find("."+this.options.resizeButtonClass).each(function(){c(this).remove()})},imageMouseEnter:function(a){c(a.target).addClass(this.options.manuallyResizingClass);this.displayToolsButtonRelativeToImage(a.target)},imageMouseLeave:function(a){c(a.relatedTarget).hasClass(this.options.resizeButtonClass)||(c(a.target).removeClass(this.options.manuallyResizingClass),this.removeToolsButtons())}});c.ui.editor.registerUi({length:{ui:null,
options:{length:150},init:function(a){a.bind("show",c.proxy(this.updateCount,this));a.bind("change",c.proxy(this.updateCount,this));return this.ui=this.editor.uiButton({title:f("Remaining characters before the recommended character limit is reached"),label:f("Initializing"),text:!0,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var a=this.options.length-c("<div/>").html(this.editor.getCleanHtml()).text().length,b=this.ui.button,d=null,d=0<=a?f("{{charactersRemaining}} characters remaining",
{charactersRemaining:a}):f("{{charactersRemaining}} characters over limit",{charactersRemaining:-1*a});b.button("option","label",d);b.button("option","text",!0);0>a?b.addClass("ui-state-error"):0<=a&&15>=a?b.addClass("ui-state-highlight").removeClass("ui-state-error"):b.removeClass("ui-state-highlight ui-state-error")},showStatistics:function(){this.processTemplate().dialog({modal:!0,resizable:!1,title:f("Content Statistics"),dialogClass:this.editor.options.dialogClass+" "+this.editor.options.baseClass,
show:this.editor.options.dialogShowAnimation,hide:this.editor.options.dialogHideAnimation,buttons:[{text:f("OK"),click:function(){c(this).dialog("close")}}],open:function(){c(this).parent().find(".ui-dialog-buttonpane").find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}})},close:function(){c(this).dialog("destroy").remove()}})},processTemplate:function(){var a=c("<div/>").html(this.editor.getCleanHtml()).text(),b=null,d=this.options.length-a.length,b=0>d?f("Content contains more than {{limit}} characters and may be truncated",
{limit:this.options.length}):f("Content will not be truncated"),e=null,e=a.split(" ").length,e=1==e?f("{{words}} word",{words:e}):f("{{words}} words",{words:e}),g=null,g=a.split(". ").length,g=f("{{sentences}} sentences",{sentences:g}),h=null,h=0<=d?f("{{characters}} characters, {{charactersRemaining}} remaining",{characters:a.length,charactersRemaining:d}):f("{{characters}} characters, {{charactersRemaining}} over the recommended limit",{characters:a.length,charactersRemaining:-1*d});return c(this.editor.getTemplate("length.dialog",
{characters:h,words:e,sentences:g,truncation:b}))}}});c.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:f("Page on this or another website"),focusSelector:'input[name="location"]',init:function(){this.content=this.plugin.editor.getTemplate("link.external",this.options);return this},show:function(a,b){var c=this;a.find('input[name="location"]').bind("keyup",function(){c.validate(a)});b&&(a.find('input[name="location"]').val(this.plugin.selectedElement.attr("href")).trigger("keyup"),
"_blank"===this.plugin.selectedElement.attr("target")&&a.find('input[name="blank"]').attr("checked","checked"));return this},attributes:function(a){var b={href:a.find('input[name="location"]').val()};a.find('input[name="blank"]').is(":checked")&&(b.target="_blank");this.options.regexLink.test(b.href)||this.plugin.editor.showWarning(f("The url for the link you inserted doesn't look well formed"));return b},validate:function(a){var b="."+this.options.baseClass+"-error-message-url",d=!0;this.options.regexLink.test(a.find('input[name="location"]').val())?
...
(a[b]="<p>"+a[b]+"</p>");g&&e?(d.replaceWith(a.join("")),this.editor.restoreSelection(),this.editor.selectOuter(this.editor.getSelectedElements()[0])):(g?c(d).before(a.join("")):e?c(d).after(a.join("")):this.editor.replaceSelectionSplittingSelectedElement(a.join("")),this.editor.restoreSelection(),this.editor.checkChange())},wrapList:function(a){this.editor.constrainSelection(this.editor.getElement());""===c.trim(this.editor.getSelectedHtml())&&this.editor.selectInner(this.editor.getSelectedElements());
var b=c("<div>").html(this.editor.getSelectedHtml()),d=[],e=this;c(b).contents().each(function(){var a;a="block"===e.getElementDefaultDisplay(this.tagName)?e.editor.stripTags(c(this).html(),e.validChildren):e.editor.stripTags(m(c(this)),e.validChildren);a=c("<li>"+a+"</li>");""!==c.trim(a.text())&&d.push(m(a))});b=this.options.baseClass+"-selection";a="<"+a+' class="'+b+'">'+d.join("")+"</"+a+">";this.editor.restoreSelection();var g=c(this.editor.getSelectedElements()[0]).parent(),f=this.editor.getElement()[0];
g===f||this.editor.getSelectedElements()[0]===f?this.editor.replaceSelection(a):this.editor.replaceSelectionWithinValidTags(a,this.validParents);this.editor.selectInner(c(this.editor.getElement().find("."+b).removeClass(b)).find("li:first")[0]);this.editor.checkChange()},getElementDefaultDisplay:function(a){var b,a=document.createElement(a);b="getComputedStyle"in j;document.body.appendChild(a);b=(b?j.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return b}});c.ui.editor.registerUi({listUnordered:{init:function(a){return a.uiButton({title:f("Unordered List"),
click:function(){a.getPlugin("list").toggleList("ul")}})}},listOrdered:{init:function(a){return a.uiButton({title:f("Ordered List"),click:function(){a.getPlugin("list").toggleList("ol")}})}}});c.ui.editor.registerUi({logo:{ui:null,init:function(){return this.ui=this.editor.uiButton({title:f("Learn More About the Raptor WYSIWYG Editor"),click:function(){j.open("http://www.jquery-raptor.com/about/editors/","_blank")},ready:function(){var a=function(b){var d=typeof b;if("object"!=d||null===b)return"string"==
d&&(b='"'+b+'"'),""+b;var e=[],f=b&&c.isArray(b);c.each(b,function(b,c){d=typeof c;"string"==d?c='"'+c+'"':"object"==d&null!==c&&(c=a(c));e.push((f?"":'"'+b+'":')+(""+c))});return(f?"[":"{")+(""+e)+(f?"]":"}")},b={enableUi:this.options.enableUi,enablePlugins:this.options.enablePlugins,disabledPlugins:a(this.options.disabledPlugins),ui:a(this.options.ui),t:(new Date).getTime()},d=[],e;for(e in b)d.push(e+"="+encodeURIComponent(b[e]));this.ui.button.find(".ui-button-icon-primary").css({"background-image":"url(http://www.jquery-raptor.com/logo/0.0.8?"+
d.join("&")+")"})}})}}});c.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span,hr,br".split(","),allowedAttributes:["href","title"],allowedEmptyTags:["hr","br"]},init:function(a,b){var d=!1,e=!1,g=this;a.getElement().bind("paste."+a.widgetName,c.proxy(function(){if(d)return!1;d=!0;a.saveSelection();c(".uiWidgetEditorPasteBin").length&&c(".uiWidgetEditorPasteBin").remove();c('<div class="uiWidgetEditorPasteBin" contenteditable="true" style="width: 1px; height: 1px; overflow: hidden; position: fixed; top: -1px;" />').appendTo("body");
c(".uiWidgetEditorPasteBin").focus();j.setTimeout(function(){var h=c(".uiWidgetEditorPasteBin").html(),h=g.filterAttributes(h),h=g.filterChars(h),h=g.stripEmpty(h),h=g.stripAttributes(h),h=g.editor.stripTags(h,g.options.allowedTags),h={plain:c("<div/>").html(c(".uiWidgetEditorPasteBin").html()).text(),markup:h,html:c(".uiWidgetEditorPasteBin").html()};e=c(a.getTemplate("paste.dialog",h));e.find(".ui-editor-paste-area").bind("keyup."+a.widgetname,function(){g.updateAreas(this,e)});c(e).dialog({modal:!0,
width:650,height:500,resizable:!0,title:"Paste",position:"center",show:b.dialogShowAnimation,hide:b.dialogHideAnimation,dialogClass:b.baseClass+" "+b.dialogClass,buttons:[{text:f("Insert"),click:function(){var b=null,b=c(this).find(".ui-editor-paste-area:visible"),b=b.hasClass("ui-editor-paste-plain")||b.hasClass("ui-editor-paste-source")?b.val():b.html(),b=g.filterAttributes(b),b=g.filterChars(b);a.restoreSelection();a.replaceSelection(b);d=!1;c(this).dialog("close")}},{text:f("Cancel"),click:function(){a.restoreSelection();
d=!1;c(this).dialog("close")}}],open:function(){var a=c(this).find(".ui-editor-paste-panel-tabs");a.find("ul.ui-tabs-nav li").click(function(){a.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");c(this).addClass("ui-state-active").addClass("ui-tabs-selected");a.children("div").hide().eq(c(this).index()).show()});var b=e.parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},
close:function(){d=!1;c(this).dialog("destroy").remove()}});c(".uiWidgetEditorPasteBin").remove()},0);return!0},this))},filterAttributes:function(a){c.each([{regexp:/(<meta\s*[^>]*\s*>)|(<\s*link\s* href="file:[^>]*\s*>)|(<\/?\s*\w+:[^>]*\s*>)/gi,handler:""},{regexp:/(class="Mso[^"]*")|(<\!--(.|\s){1,}?--\>)/gi,handler:""},{regexp:/(class="Apple-(style|converted)-[a-z]+\s?[^"]+")/,handle:""},{regexp:/id="internal-source-marker_[^"]+"|dir="[rtl]{3}"/,handle:""},{regexp:/(<p[^>]*>\s*(\&nbsp;|\u00A0)*\s*<\/p[^>]*>)|(<p[^>]*>\s*<font[^>]*>\s*(\&nbsp;|\u00A0)*\s*<\/\s*font\s*>\s<\/p[^>]*>)/ig,
handler:""},{regexp:/(style="[^"]*mso-[^;][^"]*")|(style="margin:\s*[^;"]*;")/gi,handler:""},{regexp:/(?:<style([^>]*)>([\s\S]*?)<\/style>|<link\s+(?=[^>]*rel=['"]?stylesheet)([^>]*?href=(['"])([^>]*?)\4[^>\/]*)\/?>)/gi,handler:""},{regexp:/(<\s*script[^>]*>((.|\s)*?)<\\?\/\s*script\s*>)|(<\s*script\b([^<>]|\s)*>?)|(<[^>]*=(\s|)*[("|')]javascript:[^$1][(\s|.)]*[$1][^>]*>)/ig,handler:""}],function(b,c){a=a.replace(c.regexp,c.handler)});return a},filterChars:function(a){a=a.replace(/[\u2018|\u2019|\u201A]/g,
"'");a=a.replace(/[\u201C|\u201D|\u201E]/g,'"');a=a.replace(/\u2026/g,"...");a=a.replace(/[\u2013|\u2014]/g,"-");a=a.replace(/\u02C6/g,"^");a=a.replace(/\u2039/g,"<");a=a.replace(/\u203A/g,">");return a=a.replace(/[\u02DC|\u00A0]/g," ")},stripAttributes:function(a){var a=c("<div/>").html(a),b=this.options.allowedAttributes;c(a.find("*")).each(function(){var a=[];c.each(this.attributes,function(e,f){-1===c.inArray(f.nodeName,b)&&a.push(f.nodeName)});for(var e=0;e<a.length;e++)c(this).attr(a[e],null)});
return a.html()},stripEmpty:function(a){var a=c("<div/>").html(a),b=this.options.allowedEmptyTags;a.find("*").filter(function(){return-1!==c.inArray(this.tagName.toLowerCase(),b)||c(this).find(b.join(",")).length?!1:""===c.trim(c(this).text())}).remove();return a.html()},updateAreas:function(a,b){var d=b.find('.ui-editor-paste-synchronize-text input[type="checkbox"]'),e=c(a).is("textarea")?c(a).val():c(a).html();d.attr("checked")&&(c(a).hasClass("ui-editor-paste-plain")||b.find(".ui-editor-paste-plain").val(c("<div/>").html(e).text()),
c(a).hasClass("ui-editor-paste-rich")||b.find(".ui-editor-paste-rich").html(e),c(a).hasClass("ui-editor-paste-source")||b.find(".ui-editor-paste-source").html(e),c(a).hasClass("ui-editor-paste-markup")||b.find(".ui-editor-paste-markup").html(this.stripAttributes(e)))}});c.ui.editor.registerPlugin("placeholder",{init:function(a,b){b=c.extend({},{content:"[Your content here]",tag:"p",select:!0},b);this.show=function(){if(!c.trim(a.getElement().html())){var d=c(document.createElement(b.tag)).html(b.content);
a.getElement().html(d);b.select&&a.selectInner(d)}};a.bind("show",this.show)}});c.ui.editor.registerUi({raptorize:{init:function(a){var b=a.uiButton({title:f("Raptorize"),ready:function(){b.button.raptorize&&b.button.raptorize()}});return b}}});c.ui.editor.registerPlugin("saveJson",{options:{id:{attr:"name"},postName:"content",showResponse:!1,appendId:!1,ajax:{url:"/",type:"post",cache:!1}},init:function(){},getId:function(){if("string"===typeof this.options.id)return this.options.id;if("function"===
...
this.failed=this.saved=0;this.ajax(a)},done:function(a){this.options.multiple?this.saved++:this.saved=this.dirty;this.options.showResponse&&this.editor.showConfirm(a,{delay:1E3,hide:function(){this.editor.unify(function(a){a.disableEditing();a.hideToolbar()})}})},fail:function(a){this.options.multiple?this.failed++:this.failed=this.dirty;this.options.showResponse&&this.editor.showError(a.responseText)},always:function(){this.dirty===this.saved+this.failed&&(this.options.showResponse||(0<this.failed&&
0===this.saved?this.editor.showError(f("Failed to save {{failed}} content block(s).",this)):0<this.failed?this.editor.showError(f("Saved {{saved}} out of {{dirty}} content blocks.",this)):this.editor.showConfirm(f("Successfully saved {{saved}} content block(s).",this),{delay:1E3,hide:function(){this.editor.unify(function(a){a.disableEditing();a.hideToolbar()})}})),this.message.hide(),this.message=null)},ajax:function(a,b){var d=c.extend(!0,{},this.options.ajax);c.isFunction(d.data)?d.data=d.data.apply(this,
[b,a]):this.options.postName&&(d.data={},d.data[this.options.postName]=JSON.stringify(a));c.isFunction(d.url)&&(d.url=d.url.apply(this,[b]));this.requests++;c.ajax(d).done(c.proxy(this.done,this)).fail(c.proxy(this.fail,this)).always(c.proxy(this.always,this))}});c.ui.editor.registerPlugin("saveRest",{options:{showResponse:!1,ajax:{url:"/",type:"post",cache:!1}},init:function(){},getId:function(){if("string"===typeof this.options.id)return this.options.id;if(this.options.id.attr){var a=this.editor.getOriginalElement().attr(this.options.id.attr);
if(a)return a}return null},getData:function(){this.getId();this.editor.save();return this.editor.save()},save:function(){this.message=this.editor.showLoading(f("Saving changes..."));var a=this.requests=this.failed=this.saved=0;this.editor.unify(function(b){if(b.isDirty()){a++;var b=b.getPlugin("saveRest"),c=b.editor.save();b.ajax(c)}});this.dirty=a;0===a&&(this.message.hide(),this.editor.showInfo(f("No changes detected to save...")))},done:function(a){this.options.multiple?this.saved++:this.saved=
this.dirty;this.options.showResponse&&this.editor.showConfirm(a,{delay:1E3,hide:function(){this.editor.unify(function(a){a.disableEditing();a.hideToolbar()})}})},fail:function(a){this.options.multiple?this.failed++:this.failed=this.dirty;this.options.showResponse&&this.editor.showError(a.responseText)},always:function(){this.dirty===this.saved+this.failed&&(this.options.showResponse||(0<this.failed&&0===this.saved?this.editor.showError(f("Failed to save {{failed}} content block(s).",this)):0<this.failed?
this.editor.showError(f("Saved {{saved}} out of {{dirty}} content blocks.",this)):this.editor.showConfirm(f("Successfully saved {{saved}} content block(s).",this),{delay:1E3,hide:function(){this.editor.unify(function(a){a.disableEditing();a.hideToolbar()})}})),this.message.hide(),this.message=null)},ajax:function(a,b){var d=c.extend(!0,{},this.options.ajax);c.isFunction(d.data)?d.data=d.data.apply(this,[b,a]):this.options.postName&&(d.data={},d.data[this.options.postName]=JSON.stringify(a));c.isFunction(d.url)&&
(d.url=d.url.apply(this,[b]));this.requests++;c.ajax(d).done(c.proxy(this.done,this)).fail(c.proxy(this.fail,this)).always(c.proxy(this.always,this))}});c.ui.editor.registerUi({save:{options:{plugin:"saveJson"},init:function(a){return a.uiButton({title:f("Save"),icon:"ui-icon-save",click:function(){a.checkChange();a.getPlugin(this.options.plugin).save()}})}}});c.ui.editor.registerPlugin({snippet:{ids:[],enabled:!1,init:function(a,b){if(b.snippets){for(var c=0,e=b.snippets.length;c<e;c++)this.createSnippet(b.snippets[c],
a);a.bind("restore",this.createButtons,this);a.bind("save",this.disable,this);a.bind("cancel",this.disable,this);a.bind("enabled",this.enable,this);a.bind("disabled",this.disable,this)}},createSnippet:function(){},enable:function(){this.enabled=!0;this.createButtons()},disable:function(){this.removeButtons();this.enabled=!1},createButtons:function(){for(var a=this.editor,b=0,c=this.options.snippets.length;b<c;b++){var e=this.options.snippets[b];e.repeatable&&this.createButton(e,a)}},createButton:function(a,
b){if(this.enabled){var d=this,e=b.getUniqueId();this.ids.push(e);var g=c("<button/>").addClass(d.options.baseClass).addClass(d.options.baseClass+"-button").addClass(d.options.baseClass+"-button-"+a.name).addClass(e).text("Add").click(function(){d.insertSnippet.call(d,a,b,this)}),f=a.buttonAfter||b.getElement();c.isFunction(f)?f.call(this,g,a):g.insertAfter(f);c("."+e).button({icons:{primary:"ui-icon-plusthick"}})}},removeButtons:function(){if(this.enabled){for(var a=0,b=this.ids.length;a<b;a++)c("."+
this.ids[a]).remove();a=0;for(b=this.options.snippets.length;a<b;a++){var d=this.options.snippets[a];c.isFunction(d.clean)&&d.clean.call(d,this,this.editor)}}},insertSnippet:function(a,b,d){var e=c(a.template).html(),f=a.appendTo||b.getElement();c.isFunction(f)?f.call(this,e,a,d):c(e).appendTo(f);b.disableEditing();b.enableEditing()}}});c.ui.editor.registerUi({tagMenu:{init:function(a){a.bind("selectionChange",this.change,this);a.bind("show",this.change,this);var b=this;return a.uiSelectMenu({name:"tagMenu",
title:f("Change HTML tag of selected element"),select:c(a.getTemplate("tagmenu.menu")),change:function(c){"undefined"===typeof c||"na"===c?b.change():a.tagSelectionWithin(c,a.getElement())}})},change:function(){var a=this.editor.getSelectedElements()[0];a&&(a=a.tagName.toLowerCase(),this.ui.select.find("option[value="+a+"]").length?this.ui.val(a):this.ui.val("na"))}}});c.ui.editor.registerPlugin("toolbarTip",{init:function(){c.browser.msie||this.bind("show, tagTreeUpdated",function(){c(".ui-editor-wrapper [title]").each(function(){c(this).attr("data-title",
c(this).attr("title"));c(this).removeAttr("title")})})}});(function(){var a=null,b=0;c.ui.editor.registerPlugin("unsavedEditWarning",{init:function(d){var e=this;a||(a=c(d.getTemplate("unsavededitwarning.warning",this.options)).attr("id",d.getUniqueId()).appendTo("body").bind("mouseenter."+d.widgetName,function(){c.ui.editor.eachInstance(function(a){a.isDirty()&&a.getElement().addClass(e.options.baseClass+"-dirty")})}).bind("mouseleave."+d.widgetName,function(){c("."+e.options.baseClass+"-dirty").removeClass(e.options.baseClass+
"-dirty")}));d.bind("dirty",function(){b++;0<b&&(v(a),a.addClass(e.options.baseClass+"-visible"))});d.bind("cleaned",function(){b--;0===b&&a.removeClass(e.options.baseClass+"-visible")})}})})();c.ui.editor.registerUi({viewSource:{init:function(a){return a.uiButton({title:f("View / Edit Source"),click:function(){this.show()}})},show:function(){var a=this,b=c(this.editor.getTemplate("viewsource.dialog",{baseClass:a.options.baseClass,source:a.editor.getHtml()})),d=this.ui.button;c(d).button("option",
"disabled",!0);b.dialog({modal:!1,width:600,height:400,resizable:!0,title:f("View Source"),autoOpen:!0,dialogClass:a.options.baseClass+" "+a.options.dialogClass,buttons:[{text:f("Apply Source"),click:function(){var b=c(this).find("textarea").val();a.editor.setHtml(b);c(this).find("textarea").val(a.editor.getHtml())}},{text:f("Close"),click:function(){c(this).dialog("close")}}],open:function(){var a=c(this).parent().find(".ui-dialog-buttonpane");a.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});
a.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){c(this).dialog("destroy").remove();c(d).button("option","disabled",!1);a.editor.checkChange()}})}}})})(jQuery,window,rangy);
