...
e(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):e(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(b){u(this);w(b,!0);e(this,b,0,b,j.getNodeLength(b))},selectNode:function(b){u(this);w(b,!1);z(b,K);var a=t(b),b=v(b);e(this,a.node,a.offset,b.node,b.offset)},extractContents:G(s,e),deleteContents:G(q,e),canSurroundContents:function(){A(this);C(this.startContainer);C(this.endContainer);var b=new c(this,!0),a=b._first&&
...
equals:function(b){return D.rangesEqual(this,b)},isValid:function(){return B(this)},inspect:function(){return l(this)}};N(D,L,function(b){u(b);b.startContainer=b.startOffset=b.endContainer=b.endOffset=null;b.collapsed=b.commonAncestorContainer=null;x(b,"detach",null);b._listeners=null});a.rangePrototype=O.prototype;D.rangeProperties=V;D.RangeIterator=c;D.copyComparisonConstants=M;D.createPrototypeRange=N;D.inspect=l;D.getRangeDocument=h;D.rangesEqual=function(b,a){return b.startContainer===a.startContainer&&
...
b._ranges.push(n);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;t(b,b._ranges[b.rangeCount-1],!1)}}}function s(b,a){for(var e=b.docSelection.createRange(),c=y(a),d=f.getDocument(e.item(0)),d=f.getBody(d).createControlRange(),G=0,N=e.length;G<N;++G)d.add(e.item(G));try{d.add(c)}catch(j){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}d.select();q(b)}function o(b,a,e){this.nativeSelection=b;this.docSelection=a;this._ranges=
...
B=a.util.isHostObject(document,"selection"),A=B&&(!E||a.config.preferTextRange);A?(F=x,a.isSelectionValid=function(b){var b=(b||window).document,a=b.selection;return"None"!=a.type||f.getDocument(a.createRange().parentElement())==b}):E?(F=h,a.isSelectionValid=function(){return!0}):r.fail("Neither document.selection or window.getSelection() detected.");a.getNativeSelection=F;var E=F(),O=a.createNativeRange(document),H=f.getBody(document),M=i.areHostObjects(E,i.areHostProperties(E,["anchorOffset","focusOffset"]));
a.features.selectionHasAnchorAndFocus=M;var G=i.isHostMethod(E,"extend");a.features.selectionHasExtend=G;var N="number"==typeof E.rangeCount;a.features.selectionHasRangeCount=N;var Q=!1,L=!0;i.areHostMethods(E,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof E.rangeCount&&a.features.implementsDomRange&&function(){var b=document.createElement("iframe");b.frameBorder=0;b.style.position="absolute";b.style.left="-10000px";H.appendChild(b);var a=f.getIframeDocument(b);a.open();a.write("<html><head></head><body>12</body></html>");
a.close();var e=f.getIframeWindow(b).getSelection(),c=a.documentElement.lastChild.firstChild,a=a.createRange();a.setStart(c,1);a.collapse(true);e.addRange(a);L=e.rangeCount==1;e.removeAllRanges();var d=a.cloneRange();a.setStart(c,0);d.setEnd(c,2);e.addRange(a);e.addRange(d);Q=e.rangeCount==2;a.detach();d.detach();H.removeChild(b)}();a.features.selectionSupportsMultipleRanges=Q;a.features.collapsedNonEditableSelectionsSupported=L;var D=!1,j;H&&i.isHostMethod(H,"createControlRange")&&(j=H.createControlRange(),
i.areHostProperties(j,["item","add"])&&(D=!0));a.features.implementsControlRange=D;C=M?function(b){return b.anchorNode===b.focusNode&&b.anchorOffset===b.focusOffset}:function(b){return b.rangeCount?b.getRangeAt(b.rangeCount-1).collapsed:false};var P;i.isHostMethod(E,"getRangeAt")?P=function(b,a){try{return b.getRangeAt(a)}catch(e){return null}}:M&&(P=function(b){var e=f.getDocument(b.anchorNode),e=a.createRange(e);e.setStart(b.anchorNode,b.anchorOffset);e.setEnd(b.focusNode,b.focusOffset);if(e.collapsed!==
this.isCollapsed){e.setStart(b.focusNode,b.focusOffset);e.setEnd(b.anchorNode,b.anchorOffset)}return e});a.getSelection=function(b){var b=b||window,a=b._rangySelection,e=F(b),c=B?x(b):null;if(a){a.nativeSelection=e;a.docSelection=c;a.refresh(b)}else{a=new o(e,c,b);b._rangySelection=a}return a};a.getIframeSelection=function(b){return a.getSelection(f.getIframeWindow(b))};j=o.prototype;if(!A&&M&&i.areHostMethods(E,["removeAllRanges","addRange"])){j.removeAllRanges=function(){this.nativeSelection.removeAllRanges();
v(this)};var J=function(b,e){var n=w.getRangeDocument(e),n=a.createRange(n);n.collapseToPoint(e.endContainer,e.endOffset);b.nativeSelection.addRange(d(n));b.nativeSelection.extend(e.startContainer,e.startOffset);b.refresh()};j.addRange=N?function(b,p){if(D&&B&&this.docSelection.type=="Control")s(this,b);else if(p&&G)J(this,b);else{var n;if(Q)n=this.rangeCount;else{this.removeAllRanges();n=0}this.nativeSelection.addRange(d(b));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==n+1){if(a.config.checkSelectionRanges)(n=
...
function u(a,c,f){this.cssClass=a;var d,i,j=null;if("object"==typeof c&&null!==c){f=c.tagNames;j=c.elementProperties;for(d=0;i=H[d++];)c.hasOwnProperty(i)&&(this[i]=c[i]);d=c.normalize}else d=c;this.normalize="undefined"==typeof d?!0:d;this.attrExceptions=[];d=document.createElement(this.elementTagName);this.elementProperties={};for(var m in j)j.hasOwnProperty(m)&&(M.hasOwnProperty(m)&&(m=M[m]),d[m]=j[m],this.elementProperties[m]=d[m],this.attrExceptions.push(m));this.elementSortedClassName=this.elementProperties.hasOwnProperty("className")?
...
(function(a,r,h,x){function t(b,a,g){D[b]=g;j[b]=a;L||(L=b)}function v(b){L!==b&&(L=b,a.ui.editor.eachInstance(function(){this.reinit()}))}function d(b,a){L&&D[L]&&D[L][b]&&(b=D[L][b]);if(!a)return b;for(var g in a)b=b.replace("{{"+g+"}}",a[g]);return b}function y(b){if(P===x){P=!0;if(J=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(b.options.baseClass+"-ios"),J&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height",
...
return g}function c(b,e){var g=a("<div/>").append(b)[0].childNodes;e.deleteContents();g.length===x||1===g.length?e.insertNode(g[0].cloneNode(!0)):a.each(g,function(b,a){e.insertNodeAtEnd(a.cloneNode(!0))})}function m(b){var b=b||h.getSelection(),e;a(b.getAllRanges()).each(function(b,d){e=3===this.commonAncestorContainer.nodeType?a(d.commonAncestorContainer).parent()[0]:d.commonAncestorContainer});return e}function f(b){if(!K||b)K=h.saveSelection()}function i(){K&&(h.restoreSelection(K),K=!1)}function w(b,
a,g){for(var a=a||h.getSelection(),d,c=0;d=a.getAllRanges()[c++];)b.call(g,d)}function u(b,a){w(function(a){c(b,a)},a,this)}function z(b,e){e=e||h.getSelection();e.removeAllRanges();a(b).focus().contents().each(function(){var b=h.createRange();b.selectNodeContents(this);e.addRange(b)})}function I(b,e){e=e||h.getSelection();e.removeAllRanges();a(b).each(function(){var b=h.createRange();b.selectNode(this);e.addRange(b)}).focus()}function F(b,e,g){e=e||h.getSelection();e.removeAllRanges();a(b).each(function(){var b=
h.createRange();b.selectNodeContents(this);b.collapse(g);e.addRange(b)})}function C(b){b=b||h.getSelection();return b.toHtml()}function E(b){b=b||h.getSelection().getRangeAt(0);return a(3===b.commonAncestorContainer.nodeType?b.commonAncestorContainer.parentNode:b.commonAncestorContainer)}function B(b){var a=new jQuery;w(function(b){a.push(E(b)[0])},b,this);return a}function A(){var b=h.getSelection();if(null===b.anchorNode)return null;if(b.isBackwards())return 3===b.focusNode.nodeType?a(b.focusNode.parentElement):
...
e.push(a(this))});e.length&&this.resizeOversizedImages(e,b.width())},resizeOversizedImages:function(b,e){for(var g=a("<a>",{href:"",target:"_blank"}),c=0;c<b.length;c++){var d=b[c],f=d.outerWidth();d.outerHeight();var i=Math.min(e/f),f=Math.round(Math.abs(i*(f-(d.outerWidth()-d.width()))));d.addClass(this.options.resizingClass);g=g.html(d.attr("title")||d.attr("src").substr(d.attr("src").lastIndexOf("/")+1)).attr("href",d.attr("src"));a(d).css({width:f});var h=this;this.showOversizeWarning(q(a(g)),
{hide:function(){d.removeClass(h.options.resizingClass)}})}},cancel:function(){this.removeClasses();this.removeToolsButtons();this.unbind()},save:function(){this.removeClasses(this.options.resizingClass);this.removeToolsButtons();this.unbind()},showOversizeWarning:function(a,e){this.editor.showInfo(d("The image '{{image}}' is too large for the element being edited.<br/>It will be replaced with a resized copy when your edits are saved.",{image:a}),e)},removeClasses:function(b){b||(b=[this.options.resizingClass,
...
this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(e.classes).attr(c),this.editor.showConfirm(d("Updated link: {{link}}",{link:h}))):(M("a",a.extend(c,{id:this.editor.getUniqueId()}),e.classes),this.editor.showConfirm(d("Added link: {{link}}",{link:h})),this.selectedElement=a("#"+c.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",c.href);I(this.selectedElement);f();return!0},typeChange:function(b,
...
b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){a(this).dialog("destroy").remove();a(f).button("option","disabled",!1);b.editor.checkChange()}})}}});var K=!1})(jQuery,window,rangy);
