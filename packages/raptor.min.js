/*! VERSION: 0.0.4 *//*
 ...
 Build date: 26 February 2012
*/
window.rangy=function(){function d(a,c){var b=typeof a[c];return b==p||!!(b==o&&a[c])||"unknown"==b}function r(a,c){return!!(typeof a[c]==o&&a[c])}function n(a,c){return typeof a[c]!=i}function u(a){return function(c,b){for(var d=b.length;d--;)if(!a(c,b[d]))return!1;return!0}}function q(d){return d&&c(d,b)&&g(d,a)}function s(a){window.alert("Rangy not supported in your browser. Reason: "+a);h.initialized=!0;h.supported=!1}function f(){if(!h.initialized){var a,b=!1,e=!1;d(document,"createRange")&&
(a=document.createRange(),c(a,k)&&g(a,l)&&(b=!0),a.detach());if((a=r(document,"body")?document.body:document.getElementsByTagName("body")[0])&&d(a,"createTextRange"))a=a.createTextRange(),q(a)&&(e=!0);!b&&!e&&s("Neither Range nor TextRange are implemented");h.initialized=!0;h.features={implementsDomRange:b,implementsTextRange:e};b=C.concat(m);e=0;for(a=b.length;e<a;++e)try{b[e](h)}catch(o){r(window,"console")&&d(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
o)}}}function w(a){this.name=a;this.supported=this.initialized=!1}var o="object",p="function",i="undefined",l="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer,START_TO_START,START_TO_END,END_TO_START,END_TO_END".split(","),k="setStart,setStartBefore,setStartAfter,setEnd,setEndBefore,setEndAfter,collapse,selectNode,selectNodeContents,compareBoundaryPoints,deleteContents,extractContents,cloneContents,insertNode,surroundContents,cloneRange,toString,detach".split(","),
a="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),b="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),c=u(d),e=u(r),g=u(n),h={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:d,isHostObject:r,isHostProperty:n,areHostMethods:c,areHostObjects:e,areHostProperties:g,isTextRange:q},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
...
for(var c=0,b=B.length;c<b;++c)B[c](a)};w.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};w.prototype.warn=function(a){h.warn("Module "+this.name+": "+a)};w.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};h.createModule=function(a,c){var b=new w(a);h.modules[a]=b;C.push(function(a){c(a,b);b.initialized=!0;b.supported=!0})};h.requireModules=function(a){for(var c=0,b=a.length,d,e;c<
b;++c){e=a[c];d=h.modules[e];if(!d||!(d instanceof w))throw Error("Module '"+e+"' not found");if(!d.supported)throw Error("Module '"+e+"' not supported");}};var z=!1,e=function(){z||(z=!0,h.initialized||f())};if(typeof window==i)s("No window found");else if(typeof document==i)s("No document found");else return d(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",e,!1),d(window,"addEventListener")?window.addEventListener("load",e,!1):d(window,"attachEvent")?window.attachEvent("onload",
e):s("Window does not have required addEventListener or attachEvent method"),h}();
rangy.createModule("DomUtil",function(d,r){function n(a){for(var c=0;a=a.previousSibling;)c++;return c}function u(a,b){var d=[],m;for(m=a;m;m=m.parentNode)d.push(m);for(m=b;m;m=m.parentNode)if(c(d,m))return m;return null}function q(a,c,b){for(b=b?a:a.parentNode;b;){a=b.parentNode;if(a===c)return b;b=a}return null}function s(a){a=a.nodeType;return 3==a||4==a||8==a}function f(a,c){var b=c.nextSibling,d=c.parentNode;b?d.insertBefore(a,b):d.appendChild(a);return a}function w(a){if(9==a.nodeType)return a;
if(typeof a.ownerDocument!=k)return a.ownerDocument;if(typeof a.document!=k)return a.document;if(a.parentNode)return w(a.parentNode);throw Error("getDocument: no document found for node");}function o(a){return!a?"[No node]":s(a)?'"'+a.data+'"':1==a.nodeType?"<"+a.nodeName+(a.id?' id="'+a.id+'"':"")+">["+a.childNodes.length+"]":a.nodeName}function p(a){this._next=this.root=a}function i(a,c){this.node=a;this.offset=c}function l(a){this.code=this[a];this.codeName=a;this.message="DOMException: "+this.codeName}
var k="undefined",a=d.util;a.areHostMethods(document,["createDocumentFragment","createElement","createTextNode"])||r.fail("document missing a Node creation method");a.isHostMethod(document,"getElementsByTagName")||r.fail("document missing getElementsByTagName method");var b=document.createElement("div");a.areHostMethods(b,["insertBefore","appendChild","cloneNode"])||r.fail("Incomplete Element implementation");a.isHostProperty(b,"innerHTML")||r.fail("Element is missing innerHTML property");b=document.createTextNode("test");
a.areHostMethods(b,["splitText","deleteData","insertData","appendData","cloneNode"])||r.fail("Incomplete Text Node implementation");var c=function(a,c){for(var b=a.length;b--;)if(a[b]===c)return!0;return!1};p.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){var a=this._current=this._next,c;if(this._current){c=a.firstChild;if(!c)for(c=null;a!==this.root&&!(c=a.nextSibling);)a=a.parentNode;this._next=c}return this._current},detach:function(){this._current=this._next=this.root=
null}};i.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+o(this.node)+":"+this.offset+")]"}};l.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};l.prototype.toString=function(){return this.message};d.dom={arrayContains:c,isHtmlNamespace:function(a){var c;return typeof a.namespaceURI==k||null===(c=a.namespaceURI)||"http://www.w3.org/1999/xhtml"==
c},parentElement:function(a){a=a.parentNode;return 1==a.nodeType?a:null},getNodeIndex:n,getNodeLength:function(a){var c;return s(a)?a.length:(c=a.childNodes)?c.length:0},getCommonAncestor:u,isAncestorOf:function(a,c,b){for(c=b?c:c.parentNode;c;){if(c===a)return!0;c=c.parentNode}return!1},getClosestAncestorIn:q,isCharacterDataNode:s,insertAfter:f,splitDataNode:function(a,c){var b=a.cloneNode(!1);b.deleteData(0,c);a.deleteData(c,a.length-c);f(b,a);return b},getDocument:w,getWindow:function(a){a=w(a);
...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(c){return a.isHostObject(c,"body")?c.body:c.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var c;c=a.parentNode;)a=c;return a},comparePoints:function(a,c,b,d){var o;if(a==b)return c===d?0:c<d?-1:1;if(o=q(b,a,!0))return c<=n(o)?-1:1;if(o=q(a,b,!0))return n(o)<d?-1:1;c=u(a,b);a=a===c?c:q(a,c,!0);b=b===c?c:q(b,c,!0);if(a===b)throw Error("comparePoints got to case 4 and childA and childB are the same!");
for(c=c.firstChild;c;){if(c===a)return-1;if(c===b)return 1;c=c.nextSibling}throw Error("Should not be here!");},inspectNode:o,fragmentFromNodeChildren:function(a){for(var c=w(a).createDocumentFragment(),b;b=a.firstChild;)c.appendChild(b);return c},createIterator:function(a){return new p(a)},DomPosition:i};d.DOMException=l});
rangy.createModule("DomRange",function(d){function r(a,c){return 3!=a.nodeType&&(j.isAncestorOf(a,c.startContainer,!0)||j.isAncestorOf(a,c.endContainer,!0))}function n(a){return j.getDocument(a.startContainer)}function u(a,c,b){if(c=a._listeners[c])for(var d=0,e=c.length;d<e;++d)c[d].call(a,{target:a,args:b})}function q(a){return new J(a.parentNode,j.getNodeIndex(a))}function s(a){return new J(a.parentNode,j.getNodeIndex(a)+1)}function f(a,c,b){var d=11==a.nodeType?a.firstChild:a;j.isCharacterDataNode(c)?
b==c.length?j.insertAfter(a,c):c.parentNode.insertBefore(a,0==b?c:j.splitDataNode(c,b)):b>=c.childNodes.length?c.appendChild(a):c.insertBefore(a,c.childNodes[b]);return d}function w(a){for(var c,b,d=n(a.range).createDocumentFragment();b=a.next();){c=a.isPartiallySelectedSubtree();b=b.cloneNode(!c);c&&(c=a.getSubtreeIterator(),b.appendChild(w(c)),c.detach(!0));if(10==b.nodeType)throw new D("HIERARCHY_REQUEST_ERR");d.appendChild(b)}return d}function o(a,c,b){for(var d,e,b=b||{stop:!1};d=a.next();)if(a.isPartiallySelectedSubtree())if(!1===
c(d)){b.stop=!0;break}else{if(d=a.getSubtreeIterator(),o(d,c,b),d.detach(!0),b.stop)break}else for(d=j.createIterator(d);e=d.next();)if(!1===c(e)){b.stop=!0;return}}function p(a){for(var c;a.next();)a.isPartiallySelectedSubtree()?(c=a.getSubtreeIterator(),p(c),c.detach(!0)):a.remove()}function i(a){for(var c,b=n(a.range).createDocumentFragment(),d;c=a.next();){a.isPartiallySelectedSubtree()?(c=c.cloneNode(!1),d=a.getSubtreeIterator(),c.appendChild(i(d)),d.detach(!0)):a.remove();if(10==c.nodeType)throw new D("HIERARCHY_REQUEST_ERR");
b.appendChild(c)}return b}function l(c,b,d){var e=!(!b||!b.length),t,g=!!d;e&&(t=RegExp("^("+b.join("|")+")$"));var v=[];o(new a(c,!1),function(a){(!e||t.test(a.nodeType))&&(!g||d(a))&&v.push(a)});return v}function k(a){return"["+("undefined"==typeof a.getName?"Range":a.getName())+"("+j.inspectNode(a.startContainer)+":"+a.startOffset+", "+j.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function a(a,c){this.range=a;this.clonePartiallySelectedTextNodes=c;if(!a.collapsed){this.sc=a.startContainer;
...
(j.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(j.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function x(a){h(a);if(!F(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function H(){}function G(a){a.START_TO_START=R;a.START_TO_END=V;a.END_TO_END=ca;a.END_TO_START=W;a.NODE_BEFORE=X;a.NODE_AFTER=Y;a.NODE_BEFORE_AND_AFTER=Z;a.NODE_INSIDE=S}function E(a){G(a);
G(a.prototype)}function v(c,b){return function(){x(this);var d=this.startContainer,e=this.startOffset,t=this.commonAncestorContainer,g=new a(this,!0);d!==t&&(d=j.getClosestAncestorIn(d,t,!0),e=s(d),d=e.node,e=e.offset);o(g,z);g.reset();t=c(g);g.detach();b(this,d,e,d,e);return t}}function I(c,b,e){function t(a,c){return function(b){h(this);m(b,K);m(O(b),M);b=(a?q:s)(b);(c?I:o)(this,b.node,b.offset)}}function I(a,c,d){var e=a.endContainer,t=a.endOffset;if(c!==a.startContainer||d!==a.startOffset){if(O(c)!=
O(e)||1==j.comparePoints(c,d,e,t))e=c,t=d;b(a,c,d,e,t)}}function o(a,c,d){var e=a.startContainer,t=a.startOffset;if(c!==a.endContainer||d!==a.endOffset){if(O(c)!=O(e)||-1==j.comparePoints(c,d,e,t))e=c,t=d;b(a,e,t,c,d)}}c.prototype=new H;d.util.extend(c.prototype,{setStart:function(a,c){h(this);g(a,!0);C(a,c);I(this,a,c)},setEnd:function(a,c){h(this);g(a,!0);C(a,c);o(this,a,c)},setStartBefore:t(!0,!0),setStartAfter:t(!1,!0),setEndBefore:t(!0,!1),setEndAfter:t(!1,!1),collapse:function(a){x(this);a?
b(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):b(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){h(this);g(a,!0);b(this,a,0,a,j.getNodeLength(a))},selectNode:function(a){h(this);g(a,!1);m(a,K);var c=q(a),a=s(a);b(this,c.node,c.offset,a.node,a.offset)},extractContents:v(i,b),deleteContents:v(p,b),canSurroundContents:function(){x(this);z(this.startContainer);z(this.endContainer);var c=new a(this,!0),b=c._first&&
r(c._first,this)||c._last&&r(c._last,this);c.detach();return!b},detach:function(){e(this)},splitBoundaries:function(){x(this);var a=this.startContainer,c=this.startOffset,d=this.endContainer,e=this.endOffset,t=a===d;j.isCharacterDataNode(d)&&0<e&&e<d.length&&j.splitDataNode(d,e);j.isCharacterDataNode(a)&&0<c&&c<a.length&&(a=j.splitDataNode(a,c),t?(e-=c,d=a):d==a.parentNode&&e>=j.getNodeIndex(a)&&e++,c=0);b(this,a,c,d,e)},normalizeBoundaries:function(){x(this);var a=this.startContainer,c=this.startOffset,
d=this.endContainer,e=this.endOffset,t=function(a){var c=a.nextSibling;c&&c.nodeType==a.nodeType&&(d=a,e=a.length,a.appendData(c.data),c.parentNode.removeChild(c))},g=function(b){var t=b.previousSibling;if(t&&t.nodeType==b.nodeType){a=b;var g=b.length;c=t.length;b.insertData(0,t.data);t.parentNode.removeChild(t);a==d?(e+=c,d=a):d==b.parentNode&&(t=j.getNodeIndex(b),e==t?(d=b,e=g):e>t&&e--)}},v=!0;j.isCharacterDataNode(d)?d.length==e&&t(d):(0<e&&(v=d.childNodes[e-1])&&j.isCharacterDataNode(v)&&t(v),
...
a.endContainer)}function P(a,c,b,d,e){var t=a.startContainer!==c||a.startOffset!==b,g=a.endContainer!==d||a.endOffset!==e;a.startContainer=c;a.startOffset=b;a.endContainer=d;a.endOffset=e;N(a);u(a,"boundarychange",{startMoved:t,endMoved:g})}function A(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};N(this)}d.requireModules(["DomUtil"]);var j=d.dom,J=j.DomPosition,D=d.DOMException;a.prototype={_current:null,_next:null,_first:null,
...
(a===this.sc||a===this.ec)?(c=a===this.sc?this.so:0,b=a===this.ec?this.eo:a.length,c!=b&&a.deleteData(c,b-c)):a.parentNode&&a.parentNode.removeChild(a)},isPartiallySelectedSubtree:function(){return r(this._current,this.range)},getSubtreeIterator:function(){var c;if(this.isSingleCharacterDataNode)c=this.range.cloneRange(),c.collapse();else{c=new A(n(this.range));var b=this._current,d=b,e=0,t=b,g=j.getNodeLength(b);j.isAncestorOf(b,this.sc,!0)&&(d=this.sc,e=this.so);j.isAncestorOf(b,this.ec,!0)&&(t=
...
c){this._listeners[a].push(c)},compareBoundaryPoints:function(a,c){x(this);B(this.startContainer,c.startContainer);var b=a==W||a==R?"start":"end",d=a==V||a==R?"start":"end";return j.comparePoints(this[b+"Container"],this[b+"Offset"],c[d+"Container"],c[d+"Offset"])},insertNode:function(a){x(this);m(a,L);z(this.startContainer);if(j.isAncestorOf(a,this.startContainer,!0))throw new D("HIERARCHY_REQUEST_ERR");this.setStartBefore(f(a,this.startContainer,this.startOffset))},cloneContents:function(){x(this);
var c,b;if(this.collapsed)return n(this).createDocumentFragment();if(this.startContainer===this.endContainer&&j.isCharacterDataNode(this.startContainer))return c=this.startContainer.cloneNode(!0),c.data=c.data.slice(this.startOffset,this.endOffset),b=n(this).createDocumentFragment(),b.appendChild(c),b;b=new a(this,!0);c=w(b);b.detach();return c},canSurroundContents:function(){x(this);z(this.startContainer);z(this.endContainer);var c=new a(this,!0),b=c._first&&r(c._first,this)||c._last&&r(c._last,
this);c.detach();return!b},surroundContents:function(a){m(a,t);if(!this.canSurroundContents())throw new b("BAD_BOUNDARYPOINTS_ERR");var c=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);f(a,this.startContainer,this.startOffset);a.appendChild(c);this.selectNode(a)},cloneRange:function(){x(this);for(var a=new A(n(this)),c=U.length,b;c--;)b=U[c],a[b]=this[b];return a},toString:function(){x(this);var c=this.startContainer;if(c===this.endContainer&&j.isCharacterDataNode(c))return 3==
c.nodeType||4==c.nodeType?c.data.slice(this.startOffset,this.endOffset):"";var b=[],c=new a(this,!0);o(c,function(a){(3==a.nodeType||4==a.nodeType)&&b.push(a.data)});c.detach();return b.join("")},compareNode:function(a){x(this);var c=a.parentNode,b=j.getNodeIndex(a);if(!c)throw new D("NOT_FOUND_ERR");a=this.comparePoint(c,b);c=this.comparePoint(c,b+1);return 0>a?0<c?Z:X:0<c?Y:S},comparePoint:function(a,c){x(this);y(a,"HIERARCHY_REQUEST_ERR");B(a,this.startContainer);return 0>j.comparePoints(a,c,this.startContainer,
...
var c=n(this).createElement("body");c.innerHTML=a;return j.fragmentFromNodeChildren(c)},toHtml:function(){x(this);var a=n(this).createElement("div");a.appendChild(this.cloneContents());return a.innerHTML},intersectsNode:function(a,c){x(this);y(a,"NOT_FOUND_ERR");if(j.getDocument(a)!==n(this))return!1;var b=a.parentNode,d=j.getNodeIndex(a);y(b,"NOT_FOUND_ERR");var e=j.comparePoints(b,d,this.endContainer,this.endOffset),b=j.comparePoints(b,d+1,this.startContainer,this.startOffset);return c?0>=e&&0<=
b:0>e&&0<b},isPointInRange:function(a,c){x(this);y(a,"HIERARCHY_REQUEST_ERR");B(a,this.startContainer);return 0<=j.comparePoints(a,c,this.startContainer,this.startOffset)&&0>=j.comparePoints(a,c,this.endContainer,this.endOffset)},intersectsRange:function(a,c){x(this);if(n(a)!=n(this))throw new D("WRONG_DOCUMENT_ERR");var b=j.comparePoints(this.startContainer,this.startOffset,a.endContainer,a.endOffset),d=j.comparePoints(this.endContainer,this.endOffset,a.startContainer,a.startOffset);return c?0>=
...
this.cloneRange();c.selectNode(a);var b=c.getNodes([3]);return 0<b.length?(c.setStart(b[0],0),a=b.pop(),c.setEnd(a,a.length),a=this.containsRange(c),c.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){x(this);return new c(this,a,b)},getNodes:function(a,c){x(this);return l(this,a,c)},getDocument:function(){return n(this)},collapseBefore:function(a){h(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){h(this);this.setStartAfter(a);this.collapse(!0)},getName:function(){return"DomRange"},
equals:function(a){return A.rangesEqual(this,a)},isValid:function(){return F(this)},inspect:function(){return k(this)}};I(A,P,function(a){h(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;u(a,"detach",null);a._listeners=null});d.rangePrototype=H.prototype;A.rangeProperties=U;A.RangeIterator=a;A.copyComparisonConstants=E;A.createPrototypeRange=I;A.inspect=k;A.getRangeDocument=n;A.rangesEqual=function(a,c){return a.startContainer===c.startContainer&&
a.startOffset===c.startOffset&&a.endContainer===c.endContainer&&a.endOffset===c.endOffset};d.DomRange=A;d.RangeException=b});
rangy.createModule("WrappedRange",function(d){function r(d,f,i,l){var k=d.duplicate();k.collapse(i);var a=k.parentElement();q.isAncestorOf(f,a,!0)||(a=f);if(!a.canHaveHTML)return new s(a.parentNode,q.getNodeIndex(a));var f=q.getDocument(a).createElement("span"),b,c=i?"StartToStart":"StartToEnd";do a.insertBefore(f,f.previousSibling),k.moveToElementText(f);while(0<(b=k.compareEndPoints(c,d))&&f.previousSibling);c=f.nextSibling;if(-1==b&&c&&q.isCharacterDataNode(c)){k.setEndPoint(i?"EndToStart":"EndToEnd",
d);if(/[\r\n]/.test(c.data)){a=k.duplicate();i=a.text.replace(/\r\n/g,"\r").length;for(i=a.moveStart("character",i);-1==a.compareEndPoints("StartToEnd",a);)i++,a.moveStart("character",1)}else i=k.text.length;a=new s(c,i)}else c=(l||!i)&&f.previousSibling,a=(i=(l||i)&&f.nextSibling)&&q.isCharacterDataNode(i)?new s(i,0):c&&q.isCharacterDataNode(c)?new s(c,c.length):new s(a,q.getNodeIndex(f));f.parentNode.removeChild(f);return a}function n(d,f){var i,l,k=d.offset,a=q.getDocument(d.node),b=a.body.createTextRange(),
c=q.isCharacterDataNode(d.node);c?(i=d.node,l=i.parentNode):(i=d.node.childNodes,i=k<i.length?i[k]:null,l=d.node);a=a.createElement("span");a.innerHTML="&#feff;";i?l.insertBefore(a,i):l.appendChild(a);b.moveToElementText(a);b.collapse(!f);l.removeChild(a);if(c)b[f?"moveStart":"moveEnd"]("character",k);return b}d.requireModules(["DomUtil","DomRange"]);var u,q=d.dom,s=q.DomPosition,f=d.DomRange;if(d.features.implementsDomRange&&(!d.features.implementsTextRange||!d.config.preferTextRange))(function(){function o(a){for(var b=
i.length,d;b--;)d=i[b],a[d]=a.nativeRange[d]}var p,i=f.rangeProperties,l;u=function(a){if(!a)throw Error("Range must be specified");this.nativeRange=a;o(this)};f.createPrototypeRange(u,function(a,b,d,h,f){var o=a.endContainer!==h||a.endOffset!=f;if(a.startContainer!==b||a.startOffset!=d||o)a.setEnd(h,f),a.setStart(b,d)},function(a){a.nativeRange.detach();a.detached=!0;for(var b=i.length,d;b--;)d=i[b],a[d]=null});p=u.prototype;p.selectNode=function(a){this.nativeRange.selectNode(a);o(this)};p.deleteContents=
...
k&&a.endContainer==k&&0==a.startOffset&&a.endOffset==k.length?function(a){this.nativeRange.selectNodeContents(a);o(this)}:function(a){this.setStart(a,0);this.setEnd(a,f.getEndOffset(a))};a.selectNodeContents(k);a.setEnd(k,3);l=document.createRange();l.selectNodeContents(k);l.setEnd(k,4);l.setStart(k,2);p.compareBoundaryPoints=-1==a.compareBoundaryPoints(a.START_TO_END,l)&1==a.compareBoundaryPoints(a.END_TO_START,l)?function(a,b){b=b.nativeRange||b;a==b.START_TO_END?a=b.END_TO_START:a==b.END_TO_START&&
(a=b.START_TO_END);return this.nativeRange.compareBoundaryPoints(a,b)}:function(a,b){return this.nativeRange.compareBoundaryPoints(a,b.nativeRange||b)};d.util.isHostMethod(a,"createContextualFragment")&&(p.createContextualFragment=function(a){return this.nativeRange.createContextualFragment(a)});q.getBody(document).removeChild(k);a.detach();l.detach()})(),d.createNativeRange=function(d){return(d||document).createRange()};else if(d.features.implementsTextRange){u=function(d){this.textRange=d;this.refresh()};
u.prototype=new f(document);u.prototype.refresh=function(){var d,f,i=this.textRange;d=i.parentElement();var l=i.duplicate();l.collapse(!0);f=l.parentElement();l=i.duplicate();l.collapse(!1);i=l.parentElement();f=f==i?f:q.getCommonAncestor(f,i);f=f==d?f:q.getCommonAncestor(d,f);0==this.textRange.compareEndPoints("StartToEnd",this.textRange)?f=d=r(this.textRange,f,!0,!0):(d=r(this.textRange,f,!0,!1),f=r(this.textRange,f,!1,!1));this.setStart(d.node,d.offset);this.setEnd(f.node,f.offset)};f.copyComparisonConstants(u);
var w=function(){return this}();"undefined"==typeof w.Range&&(w.Range=u);d.createNativeRange=function(d){return(d||document).body.createTextRange()}}d.features.implementsTextRange&&(u.rangeToTextRange=function(d){if(d.collapsed)return n(new s(d.startContainer,d.startOffset),!0);var f=n(new s(d.startContainer,d.startOffset),!0),i=n(new s(d.endContainer,d.endOffset),!1),d=q.getDocument(d.startContainer).body.createTextRange();d.setEndPoint("StartToStart",f);d.setEndPoint("EndToEnd",i);return d});u.prototype.getName=
function(){return"WrappedRange"};d.WrappedRange=u;d.createRange=function(f){return new u(d.createNativeRange(f||document))};d.createRangyRange=function(d){return new f(d||document)};d.createIframeRange=function(f){return d.createRange(q.getIframeDocument(f))};d.createIframeRangyRange=function(f){return d.createRangyRange(q.getIframeDocument(f))};d.addCreateMissingNativeApiListener(function(f){f=f.document;if(typeof f.createRange=="undefined")f.createRange=function(){return d.createRange(this)};f=
f=null})});
rangy.createModule("WrappedSelection",function(d,r){function n(a){return(a||window).getSelection()}function u(a){return(a||window).document.selection}function q(a,c,b){var d=b?"end":"start",b=b?"start":"end";a.anchorNode=c[d+"Container"];a.anchorOffset=c[d+"Offset"];a.focusNode=c[b+"Container"];a.focusOffset=c[b+"Offset"]}function s(a){a.anchorNode=a.focusNode=null;a.anchorOffset=a.focusOffset=0;a.rangeCount=0;a.isCollapsed=!0;a._ranges.length=0}function f(a){var b;a instanceof g?(b=a._selectionNativeRange,b||
(b=d.createNativeRange(c.getDocument(a.startContainer)),b.setEnd(a.endContainer,a.endOffset),b.setStart(a.startContainer,a.startOffset),a._selectionNativeRange=b,a.attachListener("detach",function(){this._selectionNativeRange=null}))):a instanceof h?b=a.nativeRange:d.features.implementsDomRange&&a instanceof c.getWindow(a.startContainer).Range&&(b=a);return b}function w(a){var b=a.getNodes(),d;a:if(!b.length||1!=b[0].nodeType)d=!1;else{d=1;for(var e=b.length;d<e;++d)if(!c.isAncestorOf(b[0],b[d])){d=
!1;break a}d=!0}if(!d)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function o(a,c){var b=new h(c);a._ranges=[b];q(a,b,!1);a.rangeCount=1;a.isCollapsed=b.collapsed}function p(a){a._ranges.length=0;if("None"==a.docSelection.type)s(a);else{var b=a.docSelection.createRange();if(b&&"undefined"!=typeof b.text)o(a,b);else{a.rangeCount=b.length;for(var e,g=c.getDocument(b.item(0)),v=0;v<a.rangeCount;++v)e=d.createRange(g),e.selectNode(b.item(v)),
a._ranges.push(e);a.isCollapsed=1==a.rangeCount&&a._ranges[0].collapsed;q(a,a._ranges[a.rangeCount-1],!1)}}}function i(a,b){for(var d=a.docSelection.createRange(),e=w(b),g=c.getDocument(d.item(0)),g=c.getBody(g).createControlRange(),v=0,h=d.length;v<h;++v)g.add(d.item(v));try{g.add(e)}catch(f){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}g.select();p(a)}function l(a,c,b){this.nativeSelection=a;this.docSelection=c;this._ranges=
[];this.win=b;this.refresh()}function k(a,b){for(var d=c.getDocument(b[0].startContainer),d=c.getBody(d).createControlRange(),e=0,g;e<rangeCount;++e){g=w(b[e]);try{d.add(g)}catch(v){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();p(a)}function a(a,b){if(a.anchorNode&&c.getDocument(a.anchorNode)!==c.getDocument(b))throw new m("WRONG_DOCUMENT_ERR");}function b(a){var c=[],b=new C(a.anchorNode,a.anchorOffset),
d=new C(a.focusNode,a.focusOffset),e="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var v=0,h=a.rangeCount;v<h;++v)c[v]=g.inspect(a.getRangeAt(v));return"["+e+"(Ranges: "+c.join(", ")+")(anchor: "+b.inspect()+", focus: "+d.inspect()+"]"}d.requireModules(["DomUtil","DomRange","WrappedRange"]);d.config.checkSelectionRanges=!0;var c=d.dom,e=d.util,g=d.DomRange,h=d.WrappedRange,m=d.DOMException,C=c.DomPosition,B,z,y=d.util.isHostMethod(window,"getSelection"),
F=d.util.isHostObject(document,"selection"),x=F&&(!y||d.config.preferTextRange);x?(B=u,d.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return"None"!=b.type||c.getDocument(b.createRange().parentElement())==a}):y?(B=n,d.isSelectionValid=function(){return!0}):r.fail("Neither document.selection or window.getSelection() detected.");d.getNativeSelection=B;var y=B(),H=d.createNativeRange(document),G=c.getBody(document),E=e.areHostObjects(y,e.areHostProperties(y,["anchorOffset","focusOffset"]));
...
1;this.isCollapsed=this._ranges[0].collapsed;q(this,a,false)}},j.setRanges=function(a){this.removeAllRanges();var b=a.length;b>1?k(this,a):b&&this.addRange(a[0])};else return r.fail("No means of selecting a Range or TextRange was found"),!1;j.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new m("INDEX_SIZE_ERR");return this._ranges[a]};var K;if(x)K=function(a){var b;if(d.isSelectionValid(a.win))b=a.docSelection.createRange();else{b=c.getBody(a.win.document).createTextRange();b.collapse(true)}a.docSelection.type==
"Control"?p(a):b&&typeof b.text!="undefined"?o(a,b):s(a)};else if(e.isHostMethod(y,"getRangeAt")&&"number"==typeof y.rangeCount)K=function(a){if(A&&F&&a.docSelection.type=="Control")p(a);else{a._ranges.length=a.rangeCount=a.nativeSelection.rangeCount;if(a.rangeCount){for(var b=0,c=a.rangeCount;b<c;++b)a._ranges[b]=new d.WrappedRange(a.nativeSelection.getRangeAt(b));q(a,a._ranges[a.rangeCount-1],L(a.nativeSelection));a.isCollapsed=z(a)}else s(a)}};else if(E&&"boolean"==typeof y.isCollapsed&&"boolean"==
typeof H.collapsed&&d.features.implementsDomRange)K=function(a){var b;b=a.nativeSelection;if(b.anchorNode){b=J(b,0);a._ranges=[b];a.rangeCount=1;b=a.nativeSelection;a.anchorNode=b.anchorNode;a.anchorOffset=b.anchorOffset;a.focusNode=b.focusNode;a.focusOffset=b.focusOffset;a.isCollapsed=z(a)}else s(a)};else return r.fail("No means of obtaining a Range or TextRange from the user's selection was found"),!1;j.refresh=function(a){var b=a?this._ranges.slice(0):null;K(this);if(a){a=b.length;if(a!=this._ranges.length)return false;
for(;a--;)if(!g.rangesEqual(b[a],this._ranges[a]))return false;return true}};var M=function(a,b){var c=a.getAllRanges(),d=false;a.removeAllRanges();for(var e=0,g=c.length;e<g;++e)d||b!==c[e]?a.addRange(c[e]):d=true;a.rangeCount||s(a)};j.removeRange=A?function(a){if(this.docSelection.type=="Control"){for(var b=this.docSelection.createRange(),a=w(a),d=c.getDocument(b.item(0)),d=c.getBody(d).createControlRange(),e,g=false,v=0,h=b.length;v<h;++v){e=b.item(v);e!==a||g?d.add(b.item(v)):g=true}d.select();
...
rangy.createModule("CssClassApplier",function(d,r){function n(a,b){return a.className&&RegExp("(?:^|\\s)"+b+"(?:\\s|$)").test(a.className)}function u(a,b){a.className?n(a,b)||(a.className+=" "+b):a.className=b}function q(a){return a.split(/\s+/).sort().join(" ")}function s(a,b){return q(a.className)==q(b.className)}function f(a){for(var b=a.parentNode;a.hasChildNodes();)b.insertBefore(a.firstChild,a);b.removeChild(a)}function w(a,b){var c=a.cloneRange();c.selectNodeContents(b);var d=c.intersection(a),
d=d?d.toString():"";c.detach();return""!=d}function o(a){return a.getNodes([3],function(b){return w(a,b)})}function p(a,b){if(a.attributes.length!=b.attributes.length)return!1;for(var c=0,d=a.attributes.length,e,g;c<d;++c)if(e=a.attributes[c],g=e.name,"class"!=g&&(g=b.attributes.getNamedItem(g),e.specified!=g.specified||e.specified&&e.nodeValue!==g.nodeValue))return!1;return!0}function i(a,b){for(var c=0,d=a.attributes.length,e;c<d;++c)if(e=a.attributes[c].name,(!b||!m.arrayContains(b,e))&&a.attributes[c].specified&&
...
a(b.nextSibling)}function c(a,b,d,e){var g,h=0==d;if(m.isAncestorOf(b,a))return a;if(m.isCharacterDataNode(b))if(0==d)d=m.getNodeIndex(b),b=b.parentNode;else if(d==b.length)d=m.getNodeIndex(b)+1,b=b.parentNode;else throw r.createError("splitNodeAt should not be called with offset in the middle of a data node ("+d+" in "+b.data);if(m.isCharacterDataNode(b)?0==d?b.previousSibling:d==b.length?b.nextSibling:1:0<d&&d<b.childNodes.length){if(!g){g=b.cloneNode(!1);for(g.id&&g.removeAttribute("id");h=b.childNodes[d];)g.appendChild(h);
m.insertAfter(g,b)}return b==a?g:c(a,g.parentNode,m.getNodeIndex(g),e)}return a!=b?(g=b.parentNode,b=m.getNodeIndex(b),h||b++,c(a,g,b,e)):a}function e(a){var b=a?"nextSibling":"previousSibling";return function(c,d){var e=c.parentNode,g=c[b];if(g){if(g&&3==g.nodeType)return g}else if(d&&(g=e[b])&&1==g.nodeType&&e.tagName==g.tagName&&s(e,g)&&p(e,g))return g[a?"firstChild":"lastChild"];return null}}function g(a){this.firstTextNode=(this.isElementMerge=1==a.nodeType)?a.lastChild:a;this.textNodes=[this.firstTextNode]}
...
q(this.elementProperties.className+" "+a):a;this.applyToAnyTagName=!1;a=typeof c;if("string"==a)"*"==c?this.applyToAnyTagName=!0:this.tagNames=c.toLowerCase().replace(/^\s\s*/,"").replace(/\s\s*$/,"").split(/\s*,\s*/);else if("object"==a&&"number"==typeof c.length){this.tagNames=[];d=0;for(a=c.length;d<a;++d)"*"==c[d]?this.applyToAnyTagName=!0:this.tagNames.push(c[d].toLowerCase())}else this.tagNames=[this.elementTagName]}d.requireModules(["WrappedSelection","WrappedRange"]);var m=d.dom,C=function(){function a(b,
c,d){return c&&d?" ":""}return function(b,c){b.className&&(b.className=b.className.replace(RegExp("(?:^|\\s)"+c+"(?:\\s|$)"),a))}}(),B;"undefined"!=typeof window.getComputedStyle?B=function(a,b){return m.getWindow(a).getComputedStyle(a,null)[b]}:"undefined"!=typeof document.documentElement.currentStyle?B=function(a,b){return a.currentStyle[b]}:r.fail("No means of obtaining computed style properties found");var z;(function(){z="boolean"==typeof document.createElement("div").isContentEditable?function(a){return a&&
...
return!0},isAppliedToSelection:function(a){for(var a=d.getSelection(a||window).getAllRanges(),b=a.length;b--;)if(!this.isAppliedToRange(a[b]))return!1;return!0},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)},toggleSelection:function(a){this.isAppliedToSelection(a)?this.undoToSelection(a):this.applyToSelection(a)},detach:function(){}};h.util={hasClass:n,addClass:u,removeClass:C,hasSameClasses:s,replaceWithOwnChildren:f,elementsHaveSameNonClassAttributes:p,
...
rangy.createModule("SaveRestore",function(d,r){function n(d,n){var i="selectionBoundary_"+ +new Date+"_"+(""+Math.random()).slice(2),l,k=f.getDocument(d.startContainer),a=d.cloneRange();a.collapse(n);l=k.createElement("span");l.id=i;l.style.lineHeight="0";l.style.display="none";l.className="rangySelectionBoundary";l.appendChild(k.createTextNode(w));a.insertNode(l);a.detach();return l}function u(d,f,i,l){(d=(d||document).getElementById(i))?(f[l?"setStartBefore":"setEndBefore"](d),d.parentNode.removeChild(d)):
r.warn("Marker element has been removed. Cannot restore selection.")}function q(d,f){return f.compareBoundaryPoints(d.START_TO_START,d)}function s(d,f){var i=(d||document).getElementById(f);i&&i.parentNode.removeChild(i)}d.requireModules(["DomUtil","DomRange","WrappedRange"]);var f=d.dom,w="\ufeff";d.saveSelection=function(f){var f=f||window,p=f.document;if(d.isSelectionValid(f)){var i=d.getSelection(f),l=i.getAllRanges(),k=[],a,b;l.sort(q);for(var c=0,e=l.length;c<e;++c)a=l[c],a.collapsed?(b=n(a,
!1),k.push({markerId:b.id,collapsed:!0})):(b=n(a,!1),a=n(a,!0),k[c]={startMarkerId:a.id,endMarkerId:b.id,collapsed:!1,backwards:1==l.length&&i.isBackwards()});for(c=e-1;0<=c;--c)a=l[c],a.collapsed?a.collapseBefore((p||document).getElementById(k[c].markerId)):(a.setEndBefore((p||document).getElementById(k[c].endMarkerId)),a.setStartAfter((p||document).getElementById(k[c].startMarkerId)));i.setRanges(l);return{win:f,doc:p,rangeInfos:k,restored:!1}}r.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
d.restoreSelection=function(f,n){if(!f.restored){for(var i=f.rangeInfos,l=d.getSelection(f.win),k=[],a=i.length,b=a-1,c,e;0<=b;--b){c=i[b];e=d.createRange(f.doc);if(c.collapsed)if(c=(f.doc||document).getElementById(c.markerId)){c.style.display="inline";var g=c.previousSibling;g&&3==g.nodeType?(c.parentNode.removeChild(c),e.collapseToPoint(g,g.length)):(e.collapseBefore(c),c.parentNode.removeChild(c))}else r.warn("Marker element has been removed. Cannot restore selection.");else u(f.doc,e,c.startMarkerId,
!0),u(f.doc,e,c.endMarkerId,!1);1==a&&e.normalizeBoundaries();k[b]=e}1==a&&n&&d.features.selectionHasExtend&&i[0].backwards?(l.removeAllRanges(),l.addRange(k[0],!0)):l.setRanges(k);f.restored=!0}};d.removeMarkerElement=s;d.removeMarkers=function(d){for(var f=d.rangeInfos,i=0,l=f.length,k;i<l;++i)k=f[i],k.collapsed?s(d.doc,k.markerId):(s(d.doc,k.startMarkerId),s(d.doc,k.endMarkerId))}});
rangy.createModule("Serializer",function(d,r){function n(a,b){var b=b||[],c=a.nodeType,d=a.childNodes,g=d.length,h=[c,a.nodeName,g].join(":"),f="",i="";switch(c){case 3:f=a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;");break;case 8:f="<\!--"+a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;")+"--\>";break;default:f="<"+h+">",i="</>"}f&&b.push(f);for(c=0;c<g;++c)n(d[c],b);i&&b.push(i);return b}function u(a){a=n(a).join("");return l(a).toString(16)}function q(a,b,c){for(var d=[],g=a,c=c||k.getDocument(a).documentElement;g&&
g!=c;)d.push(k.getNodeIndex(g,!0)),g=g.parentNode;return d.join("/")+":"+b}function s(a,b,c){b?c||k.getDocument(b):b=(c||document).documentElement;for(var a=a.split(":"),c=a[0]?a[0].split("/"):[],d=c.length,g;d--;)if(g=parseInt(c[d],10),g<b.childNodes.length)b=b.childNodes[parseInt(c[d],10)];else throw r.createError("deserializePosition failed: node "+k.inspectNode(b)+" has no child with index "+g+", "+d);return new k.DomPosition(b,parseInt(a[1],10))}function f(a,b,c){c=c||d.DomRange.getRangeDocument(a).documentElement;
if(!k.isAncestorOf(c,a.commonAncestorContainer,!0))throw Error("serializeRange: range is not wholly contained within specified root node");a=q(a.startContainer,a.startOffset,c)+","+q(a.endContainer,a.endOffset,c);b||(a+="{"+u(c)+"}");return a}function w(a,b,c){b?c=c||k.getDocument(b):(c=c||document,b=c.documentElement);var a=/^([^,]+),([^,\{]+)({([^}]+)})?$/.exec(a),e=a[4],g=u(b);if(e&&e!==u(b))throw Error("deserializeRange: checksums of serialized range root node ("+e+") and target root node ("+
...
(function(d,r,n,u){function q(a,b,c){p[a]=c;i[a]=b;o||(o=a)}function s(a){o!==a&&(o=a,d.ui.editor.eachInstance(function(){this.reinit()}))}function f(a,b){o&&p[o]&&p[o][a]&&(a=p[o][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function w(a){if(l===u){l=!0;if(k=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))d("html").addClass(a.options.baseClass+"-ios"),k&&d(document).bind("scroll",function(){setInterval(function(){d("body").css("height","+=1").css("height",
"-=1")},0)});d.browser.mozilla&&d("html").addClass(a.options.baseClass+"-ff");if(d.browser.msie&&9>d.browser.version){l=!1;var b=d("<div></div>").addClass(a.options.baseClass+"-unsupported").html(a.getTemplate("unsupported")).appendTo("body"),c=1;b.siblings().each(function(){var a=d(this).css("z-index");!isNaN(a)&&a>c&&(c=a+1)});b.css("z-index",c);b.find("."+a.options.baseClass+"-unsupported-close").click(function(){b.remove()})}}return l}var o=null,p={},i={};d(function(){n.initialized||n.init();
d.isFunction(n.rangePrototype.insertNodeAtEnd)||(n.rangePrototype.insertNodeAtEnd=function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});d("html").click(function(){d(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});d.widget("ui.editor",{_init:function(){-1===d.inArray(this,d.ui.editor.instances)&&d.ui.editor.instances.push(this);var a=this;d.ui.editor.eachInstance(function(b){a!=b&&a.element.closest(b.element).length&&handleError("Nesting editors is unsupported",
...
null;e.hide()},c.delay,this)},hide:function(){this.timer&&(r.clearTimeout(this.timer),this.timer=null);this.element.stop().slideUp(d.proxy(function(){d.isFunction(c.hide)&&c.hide.call(this);this.element.remove()},this))}};e.element=d(this.getTemplate("message",{type:a,message:b})).hide().appendTo(this.messages).find(".ui-editor-message-close").click(function(){e.hide()}).end();e.show();return e},showLoading:function(a,b){return this.showMessage("clock",a,b)},showInfo:function(a,b){return this.showMessage("info",
...
5>c){var f=this.getTemplateVars(a[g],b+g,++c),m;for(m in f)d[m]=f[m]}else d[b+g]=a[g];return d},historyPush:function(){this.historyEnabled&&this.getHtml()!==this.historyPeak()&&(this.present!==this.history.length-1&&(this.history=this.history.splice(0,this.present+1)),this.history.push(this.getHtml()),this.present=this.history.length-1)},historyPeak:function(){return!this.history.length?null:this.history[this.present]},historyBack:function(){0<this.present&&(this.present--,this.setHtml(this.history[this.present]),
this.historyEnabled=!1,this.change(),this.historyEnabled=!0)},historyForward:function(){this.present<this.history.length-1&&(this.present++,this.setHtml(this.history[this.present]),this.historyEnabled=!1,this.change(),this.historyEnabled=!0)},loadUi:function(){for(var a=0,b=this.options.uiOrder.length;a<b;a++){for(var c=this.options.uiOrder[a],e=d("<div/>"),g=0,f=c.length;g<f;g++)if(!(!1===this.options.enableUi&&"undefined"===typeof this.options.ui[c[g]]||!1===this.options.ui[c[g]])&&-1===d.inArray(c[g],
this.options.disabledUi)){var m=c[g].replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});if(d.ui.editor.ui[c[g]]){var i=d.extend({},d.ui.editor.ui[c[g]]),m=d.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-ui-"+m},i.options,this.options.ui[c[g]]);i.editor=this;i.options=m;i.ui=i.init(this,m);i.ui.init(c[g],this,m,i).appendTo(e);this.uiObjects[c[g]]=i}}e.addClass("ui-buttonset").addClass(this.options.baseClass+"-buttonset");0<e.children().length&&e.appendTo(this.toolbar)}d("<div/>").css("clear",
"both").appendTo(this.toolbar)},uiButton:function(a){return d.extend({button:null,options:{},init:function(a,c,e,g){var h=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),e=d.extend({},c.options,{baseClass:c.options.baseClass+"-"+h+"-button"},this.options,c.options.ui[a]);this.title||(this.title=f("Unnamed Button"));this.button=d("<div/>").html(this.label||this.title).addClass(e.baseClass).attr("name",a).attr("title",this.title).val(a);e.classes&&this.button.addClass(e.classes);this.button.bind("mousedown."+
g.editor.widgetName,function(a){a.preventDefault()});var m=this;this.button.bind("mouseup."+g.editor.widgetName,function(a){a.preventDefault();m.click.apply(g,arguments)});c.bind("destroy",d.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+h},disabled:e.disabled?!0:!1,text:this.text||!1,label:this.label||null});this.ready.call(g);return this.button},disable:function(){this.button.button("option","disabled",!0)},enable:function(){this.button.button("option",
"disabled",!1)},ready:function(){},click:function(){}},a)},uiSelectMenu:function(a){return d.extend({select:null,selectMenu:null,button:null,menu:null,options:{},init:function(a,c){var e=this,g=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});d.extend({},c.options,{baseClass:c.options.baseClass+g+"-select-menu"},e.options,c.options.ui[a]);e.title||(e.title=f("Unnamed Select Menu"));e.wrapper=d('<div class="ui-editor-selectmenu-wrapper"/>').append(e.select.hide());e.selectMenu=d('<div class="ui-selectmenu ui-editor-selectmenu"/>').appendTo(e.wrapper);
e.menu=d('<div class="ui-selectmenu-menu ui-editor-selectmenu-menu ui-widget-content ui-corner-bottom ui-corner-tr"/>').appendTo(e.wrapper);e.select.find("option").each(function(){d("<div/>").addClass("ui-selectmenu-menu-item ui-editor-selectmenu-menu-item").addClass("ui-corner-all").html(d(this).html()).appendTo(e.menu).bind("mouseenter."+c.widgetName,function(){d(this).addClass("ui-state-focus")}).bind("mouseleave."+c.widgetName,function(){d(this).removeClass("ui-state-focus")}).bind("mousedown."+
c.widgetName,function(){return false}).bind("click."+c.widgetName,function(){var a=e.select.find("option").eq(d(this).index());e.select.val(a.val());e.update();e.button.addClass("ui-corner-all").removeClass("ui-corner-top");e.change(e.select.val());e.menu.hide();return false})});var g=d("<div/>").addClass("ui-selectmenu-text"),h=d("<div/>").addClass("ui-icon ui-icon-triangle-1-s");e.button=d("<div/>").addClass("ui-selectmenu-button ui-editor-selectmenu-button ui-button ui-state-default").attr("title",
e.title).append(g).append(h).prependTo(e.selectMenu);e.button.bind("mousedown."+c.widgetName,function(){return false}).bind("click."+c.widgetName,function(){var a=e.menu;d(".ui-selectmenu-menu").each(function(){this!==a&&d(this).hide()});if(!a.is(":animated"))if(a.is(":visible"))a.stop().slideUp(250,function(){e.button.addClass("ui-corner-all").removeClass("ui-corner-top")});else{a.css("min-width",e.button.width()+10);a.stop().slideDown(250);e.button.removeClass("ui-corner-all").addClass("ui-corner-top")}return false});
...
this.options.enablePlugins&&"undefined"===typeof this.options.plugins[a]||!1===this.options.plugins[a])&&-1===d.inArray(a,this.options.disabledPlugins)){var b=d.extend({},d.ui.editor.plugins[a]),c=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),c=d.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-"+c},b.options,this.options.plugins[a]);b.editor=this;b.options=c;b.init(this,c);this.plugins[a]=b}},isDirty:function(){return this.dirty},getHtml:function(){var a=this.getElement().html(),
a=d("<div/>").html(a);a.find(".rangySelectionBoundary").remove();return a=a.html()},getCleanHtml:function(){this.fire("clean");var a=this.getElement().html();this.fire("restore");a=d("<div/>").html(a);a.find(".rangySelectionBoundary").remove();return a=a.html()},setHtml:function(a){this.getElement().html(a);this.fire("html");this.change()},resetHtml:function(){this.setHtml(this.getOriginalHtml())},getOriginalHtml:function(){return this.originalHtml},save:function(){var a=this.getCleanHtml();this.fire("save");
this.setOriginalHtml(a);this.fire("saved");this.fire("change");return a},setOriginalHtml:function(a){this.originalHtml=a},bind:function(a,b,c){var e=this.events;d.each(a.split(","),function(a,f){f=d.trim(f);e[f]||(e[f]=[]);e[f].push({context:c,callback:b})})},unbind:function(a,b,c){for(var d=0,g=this.events[a].length;d<g;d++)this.events[a][d]&&this.events[a][d].callback===b&&this.events[a][d].context===c&&this.events[a].splice(d,1)},fire:function(a,b,c){c||this.fire("before:"+a,b,!0);if(this.events[a])for(var e=
0,g=this.events[a].length;e<g;e++){var f=this.events[a][e];f.callback.call(f.context||this)}!1!==b&&d.ui.editor.fire(a);c||this.fire("after:"+a,b,!0)}});d.extend(d.ui.editor,{defaults:{plugins:{},ui:{},bind:{},domTools:{savedSelection:!1,saveSelection:function(){this.savedSelection=n.saveSelection()},restoreSelection:function(){this.savedSelection&&(n.restoreSelection(this.savedSelection),this.savedSelection=!1)},eachRange:function(a,b,c){for(var b=b||n.getSelection(),c=c||this,d,g=0;d=b.getAllRanges()[g++];)a.call(c,
d)},constrainSelection:function(a,b){var a=d(a)[0],b=b||n.getSelection(),c;d(b.getAllRanges()).each(function(e,g){c=3===this.commonAncestorContainer.nodeType?d(g.commonAncestorContainer).parent()[0]:g.commonAncestorContainer;a!==c&&!d.contains(a,c)&&b.removeRange(g)})},getSelectedElements:function(){var a=new jQuery;this.eachRange(function(b){a.push(this.getSelectedElement(b)[0])});return a},getSelectedElement:function(a){return d(3===a.commonAncestorContainer.nodeType?a.commonAncestorContainer.parentNode:
a.commonAncestorContainer)},unwrapParentTag:function(a){this.getSelectedElements().each(function(){d(this).is(a)&&d(this).replaceWith(d(this).html())})},wrapTagWithAttribute:function(a,b,c){this.eachRange(function(d){d=this.getSelectedElement(d);d.is(a)?d.attr(b):this.toggleWrapper(a,{classes:c,attributes:b})})},selectInner:function(a,b){b=b||n.getSelection();b.removeAllRanges();d(a).focus().contents().each(function(){var a=n.createRange();a.selectNodeContents(this);b.addRange(a)})},selectOuter:function(a,
b){b=b||n.getSelection();b.removeAllRanges();d(a).each(function(){var a=n.createRange();a.selectNode(this);b.addRange(a)}).focus()},toggleWrapper:function(a,b){var b=b||{},c=n.createCssClassApplier(b.classes||"",{normalize:!0,elementTagName:a,elementProperties:b.attributes||{}});this.eachRange(function(e){this.rangeEmptyTag(e)?this.replaceRange(d("<"+a+"/>").addClass(b.classes).attr(b.attributes||{}).append(this.domFragmentToHtml(e.cloneContents())),e):c.toggleRange(e)})},rangeEmptyTag:function(a){a=
this.domFragmentToHtml(a.cloneContents());"string"===typeof a&&(a=a.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));return d(a).is(":empty")?!0:!1},execCommand:function(a,b,c){document.execCommand(a,b,c)},insertTag:function(a,b){this.eachRange(function(b){b.insertNode(d("<"+a+"/>")[0])},b)},insertTagAtEnd:function(a,b){this.eachRange(function(b){b.insertNodeAtEnd(d("<"+a+"/>")[0])},b)},insertElement:function(a,b,c){this.eachRange(function(c){d(a).each(function(){c.insertNode(!1===b?this:this.cloneNode(!0))})},
c)},insertElementAtEnd:function(a,b,c){this.eachRange(function(c){d(a).each(function(){c.insertNodeAtEnd(!1===b?this:this.cloneNode(!0))})},c)},toggleBlockStyle:function(a,b){this.eachRange(function(c){for(c=d(c.commonAncestorContainer);c.length&&c[0]!==b[0]&&(3===c[0].nodeType||"inline"===c.css("display"));)c=c.parent();c[0]===b[0]&&"inline"!==b.css("display")&&(this.wrapInner(b,"div"),c=b.children().first());this.toggleStyle(c,a)})},wrapInner:function(a,b){this.saveSelection();d(a).each(function(){var c=
d("<"+b+"/>").html(d(this).html());a.html(c)});this.restoreSelection()},inverseWrapWithTagClass:function(a,b,c,e){this.saveSelection();var g="domTools"+Math.ceil(1E7*Math.random());this.eachRange(function(a){var d=n.createCssClassApplier(e,{elementTagName:c});d.isAppliedToRange(a)?d.toggleSelection():n.createCssClassApplier(b,{elementTagName:g}).toggleSelection()});d(g).each(function(){d(this).replaceWith(d("<"+a+"/>").addClass(b).html(d(this).html()))});this.restoreSelection()},toggleStyle:function(a,
b){d.each(b,function(b,e){d(a).css(b)===e?d(a).css(b,""):d(a).css(b,e)})},getStyles:function(a){for(var b={},a=r.getComputedStyle(a[0],null),c=0;c<a.length;c++)b[a.item(c)]=a.getPropertyValue(a.item(c));return b},swapStyles:function(a,b,c){for(var d in c)a.css(d,b.css(d)),b.css(d,c[d])},replaceSelection:function(a,b){this.eachRange(function(b){this.replaceRange(a,b)},b)},replaceRange:function(a,b){var c=d("<div></div>").append(a)[0].childNodes;b.deleteContents();c.length===u||1===c.length?b.insertNode(c[0].cloneNode(!0)):
d.each(c,function(a,c){b.insertNodeAtEnd(c.cloneNode(!0))})},insertDomFragmentBefore:function(a,b,c){for(var e=0,g=a.childNodes.length;e<g;e++){var f=a.childNodes.item(e);(f=3===f.nodeType?f.nodeValue:d(f).html())&&d("<"+c+"/>").html(d.trim(f)).insertBefore(b)}},domFragmentToHtml:function(a,b){for(var c="",e=0,g=a.childNodes.length;e<g;e++){var f=a.childNodes.item(e);(f=3===f.nodeType?f.nodeValue:this.outerHtml(f))&&(c+=f)}b&&(c=d("<"+b+">"+c+"</"+b+">"),c.find("p").wrapInner("<"+b+"/>"),c.find("p > *").unwrap(),
...
null,b)},tagSelectionWithin:function(a,b,c){this.eachRange(function(c){this.isEmpty(c)?(this.expandToParent(c),b=d(b)[0],"undefined"!==typeof b&&c.startContainer===b&&c.endContainer===b?this.wrapInner(d(b),a):this.changeTag(c,a)):this.replaceRange(this.domFragmentToHtml(c.extractContents(),a),c)},c)},outerHtml:function(a){return d(a).clone().wrap("<div></div>").parent().html()}},namespace:null,unify:!0,persistence:!0,persistenceName:"uiEditor",unloadWarning:!0,autoEnable:!1,partialEdit:!1,enablePlugins:!0,
...
a.uiButton({title:f("Step Forward"),disabled:!0,click:function(){a.historyForward()}})},change:function(){this.editor.present===this.editor.history.length-1?this.ui.disable():this.ui.enable()}}});d.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:f("Insert Horizontal Rule"),click:function(){a.replaceSelection("<hr/>")}})}}});d.ui.editor.registerUi({i18n:{init:function(a){var b=this,c=this.persist("locale");c&&s(c);var c=d('<select autocomplete="off" name="i18n"/>'),e;for(e in p){var g=
d('<option value="'+e+'" class="'+e+'"/>');g.html(i[e]);o===e&&g.attr("selected","selected");c.append(g)}return a.uiSelectMenu({title:f("Change Language"),select:c,change:function(a){s(b.persist("locale",a))}})}}});q("en","English",{});q("zh_CN","\u7b80\u4f53\u4e2d\u6587",{"Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"\u5e94\u7528\u6e90\u4ee3\u7801","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",
...
close:function(){d(this).dialog("destroy").remove()}})},processTemplate:function(){var a=d("<div></div>").html(this.editor.getCleanHtml()).text(),b=null,c=this.options.length-a.length,b=0>c?f("Content contains more than {{limit}} characters and may be truncated",{limit:this.options.length}):f("Content will not be truncated"),e=null,e=a.split(" ").length,e=1==e?f("{{words}} word",{words:e}):f("{{words}} words",{words:e}),g=null,g=a.split(". ").length,g=f("{{sentences}} sentences",{sentences:g}),h=
null,h=0<=c?f("{{characters}} characters, {{charactersRemaining}} remaining",{characters:a.length,charactersRemaining:c}):f("{{characters}} characters, {{charactersRemaining}} over the recommended limit",{characters:a.length,charactersRemaining:-1*c});return d(this.editor.getTemplate("length.dialog",{characters:h,words:e,sentences:g,truncation:b}))}}});d.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:f("Page on this or another website"),
...
this.tidyHtml(d.trim(this.editor.getHtml())),a=d(a).find("."+this.options.baseClass+"-highlighted"),c=function(a,b,f){var a=d(a),i=a.find("code:first");i.unbind("keydown keyup");i.attr("contenteditable",!0);Rainbow.color(b,"html",function(b){i.html(b);a.show();var g=function(){var a=n.getSelection();return a.rangeCount?a.getRangeAt(0):null},k="";i.bind("keydown",function(a){k=i.html();switch(a.keyCode){case 13:var b=g(),c=!1,d=document.createTextNode("\r\n");b&&(b.insertNode(d),b.setEndAfter(d),b.setStartAfter(d),
c=n.getSelection(),c.setSingleRange(b),c=!0);c&&a.preventDefault();return!1;case 9:return b=g(),a=document.createTextNode(f.tab()),b&&(b.insertNode(a),c=n.getSelection(),b.setEndAfter(a),b.setStartAfter(a),c.setSingleRange(b)),!1}});var l=!1;i.bind("keydown",function(){l=!0});i.bind("keyup",function(){l=!1;r.setTimeout(function(){if(!l){if(k==i.html())return!0;try{var b=f.untidyHtml(i.html());d("<div/>").html(b).html()==b&&c(a,b,f)}catch(g){console.log("error")}}},5E3)})})};c(a,b,this)}else d(a).find("textarea").val(d.trim(this.editor.getHtml())),
