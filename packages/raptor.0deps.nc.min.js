...
rangy.createModule("DomRange",function(m){function w(a,b){return 3!=a.nodeType&&(s.isAncestorOf(a,b.startContainer,!0)||s.isAncestorOf(a,b.endContainer,!0))}function a(a){return s.getDocument(a.startContainer)}function c(a,b,c){if(b=a._listeners[b])for(var d=0,j=b.length;d<j;++d)b[d].call(a,{target:a,args:c})}function d(a){return new R(a.parentNode,s.getNodeIndex(a))}function f(a){return new R(a.parentNode,s.getNodeIndex(a)+1)}function e(a,b,c){var d=11==a.nodeType?a.firstChild:a;s.isCharacterDataNode(b)?
...
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function r(a,b,c){this.nodes=l(a,b,c);this._next=this.nodes[0];this._position=0}function v(a){return function(b,c){for(var d,j=c?b:b.parentNode;j;){d=j.nodeType;if(s.arrayContains(a,d))return j;j=j.parentNode}return null}}function x(a,b){if(j(a,b))throw new p("INVALID_NODE_TYPE_ERR");}function q(a){if(!a.startContainer)throw new P("INVALID_STATE_ERR");}function B(a,b){if(!s.arrayContains(b,a.nodeType))throw new p("INVALID_NODE_TYPE_ERR");
}function A(a,b){if(0>b||b>(s.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new P("INDEX_SIZE_ERR");}function C(a,b){if(Y(a,!0)!==Y(b,!0))throw new P("WRONG_DOCUMENT_ERR");}function F(a){if(S(a,!0))throw new P("NO_MODIFICATION_ALLOWED_ERR");}function y(a,b){if(!a)throw new P(b);}function G(a){return!!a.startContainer&&!!a.endContainer&&!(!s.arrayContains(H,a.startContainer.nodeType)&&!Y(a.startContainer,!0))&&!(!s.arrayContains(H,a.endContainer.nodeType)&&!Y(a.endContainer,!0))&&a.startOffset<=
(s.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(s.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function D(a){q(a);if(!G(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function Q(){}function L(a){a.START_TO_START=T;a.START_TO_END=$;a.END_TO_END=aa;a.END_TO_START=ka;a.NODE_BEFORE=na;a.NODE_AFTER=oa;a.NODE_BEFORE_AND_AFTER=la;a.NODE_INSIDE=
ma}function u(a){L(a);L(a.prototype)}function W(a,b){return function(){D(this);var c=this.startContainer,d=this.startOffset,j=this.commonAncestorContainer,e=new n(this,!0);c!==j&&(c=s.getClosestAncestorIn(c,j,!0),d=f(c),c=d.node,d=d.offset);g(e,F);e.reset();j=a(e);e.detach();b(this,c,d,c,d);return j}}function N(a,c,j){function g(a,b){return function(c){q(this);B(c,J);B(X(c),H);c=(a?d:f)(c);(b?e:i)(this,c.node,c.offset)}}function e(a,b,d){var j=a.endContainer,g=a.endOffset;if(b!==a.startContainer||
d!==a.startOffset){if(X(b)!=X(j)||1==s.comparePoints(b,d,j,g))j=b,g=d;c(a,b,d,j,g)}}function i(a,b,d){var j=a.startContainer,g=a.startOffset;if(b!==a.endContainer||d!==a.endOffset){if(X(b)!=X(j)||-1==s.comparePoints(b,d,j,g))j=b,g=d;c(a,j,g,b,d)}}a.prototype=new Q;m.util.extend(a.prototype,{setStart:function(a,b){q(this);x(a,!0);A(a,b);e(this,a,b)},setEnd:function(a,b){q(this);x(a,!0);A(a,b);i(this,a,b)},setStartBefore:g(!0,!0),setStartAfter:g(!1,!0),setEndBefore:g(!0,!1),setEndAfter:g(!1,!1),collapse:function(a){D(this);
a?c(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):c(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){q(this);x(a,!0);c(this,a,0,a,s.getNodeLength(a))},selectNode:function(a){q(this);x(a,!1);B(a,J);var b=d(a),a=f(a);c(this,b.node,b.offset,a.node,a.offset)},extractContents:W(k,c),deleteContents:W(b,c),canSurroundContents:function(){D(this);F(this.startContainer);F(this.endContainer);var a=new n(this,!0),b=a._first&&
w(a._first,this)||a._last&&w(a._last,this);a.detach();return!b},detach:function(){j(this)},splitBoundaries:function(){D(this);var a=this.startContainer,b=this.startOffset,d=this.endContainer,j=this.endOffset,g=a===d;s.isCharacterDataNode(d)&&0<j&&j<d.length&&s.splitDataNode(d,j);s.isCharacterDataNode(a)&&0<b&&b<a.length&&(a=s.splitDataNode(a,b),g?(j-=b,d=a):d==a.parentNode&&j>=s.getNodeIndex(a)&&j++,b=0);c(this,a,b,d,j)},normalizeBoundaries:function(){D(this);var a=this.startContainer,b=this.startOffset,
d=this.endContainer,j=this.endOffset,g=function(a){var b=a.nextSibling;b&&b.nodeType==a.nodeType&&(d=a,j=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},e=function(c){var g=c.previousSibling;if(g&&g.nodeType==c.nodeType){a=c;var e=c.length;b=g.length;c.insertData(0,g.data);g.parentNode.removeChild(g);a==d?(j+=b,d=a):d==c.parentNode&&(g=s.getNodeIndex(c),j==g?(d=c,j=e):j>g&&j--)}},f=!0;s.isCharacterDataNode(d)?d.length==j&&g(d):(0<j&&(f=d.childNodes[j-1])&&s.isCharacterDataNode(f)&&g(f),
f=!this.collapsed);f?s.isCharacterDataNode(a)?0==b&&e(a):b<a.childNodes.length&&(g=a.childNodes[b])&&s.isCharacterDataNode(g)&&e(g):(a=d,b=j);c(this,a,b,d,j)},collapseToPoint:function(a,b){q(this);x(a,!0);A(a,b);(a!==this.startContainer||b!==this.startOffset||a!==this.endContainer||b!==this.endOffset)&&c(this,a,b,a,b)}});u(a)}function i(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:s.getCommonAncestor(a.startContainer,
a.endContainer)}function U(a,b,d,j,g){var e=a.startContainer!==b||a.startOffset!==d,f=a.endContainer!==j||a.endOffset!==g;a.startContainer=b;a.startOffset=d;a.endContainer=j;a.endOffset=g;i(a);c(a,"boundarychange",{startMoved:e,endMoved:f})}function I(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};i(this)}m.requireModules(["DomUtil"]);var s=m.dom,R=s.DomPosition,P=m.DOMException;n.prototype={_current:null,_next:null,_first:null,
...
(a===this.sc||a===this.ec)?(b=a===this.sc?this.so:0,c=a===this.ec?this.eo:a.length,b!=c&&a.deleteData(b,c-b)):a.parentNode&&a.parentNode.removeChild(a)},isPartiallySelectedSubtree:function(){return w(this._current,this.range)},getSubtreeIterator:function(){var b;if(this.isSingleCharacterDataNode)b=this.range.cloneRange(),b.collapse();else{b=new I(a(this.range));var c=this._current,d=c,j=0,g=c,e=s.getNodeLength(c);s.isAncestorOf(c,this.sc,!0)&&(d=this.sc,j=this.so);s.isAncestorOf(c,this.ec,!0)&&(g=
this.ec,e=this.eo);U(b,d,j,g,e)}return new n(b,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};p.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};p.prototype.toString=function(){return this.message};r.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
detach:function(){this._current=this._next=this.nodes=null}};var J=[1,3,4,5,7,8,10],H=[2,9,11],O=[1,3,4,5,7,8,10,11],M=[1,3,4,5,7,8],X=s.getRootContainer,Y=v([9,11]),S=v([5,6,10,12]),j=v([6,10,12]),t=document.createElement("style"),z=!1;try{t.innerHTML="<b>x</b>",z=3==t.firstChild.nodeType}catch(K){}m.features.htmlParsingConforms=z;var V="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),T=0,$=1,aa=2,ka=3,na=0,oa=1,la=2,ma=3;Q.prototype={attachListener:function(a,
b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){D(this);C(this.startContainer,b.startContainer);var c=a==ka||a==T?"start":"end",d=a==$||a==T?"start":"end";return s.comparePoints(this[c+"Container"],this[c+"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){D(this);B(a,O);F(this.startContainer);if(s.isAncestorOf(a,this.startContainer,!0))throw new P("HIERARCHY_REQUEST_ERR");this.setStartBefore(e(a,this.startContainer,this.startOffset))},cloneContents:function(){D(this);
var b,c;if(this.collapsed)return a(this).createDocumentFragment();if(this.startContainer===this.endContainer&&s.isCharacterDataNode(this.startContainer))return b=this.startContainer.cloneNode(!0),b.data=b.data.slice(this.startOffset,this.endOffset),c=a(this).createDocumentFragment(),c.appendChild(b),c;c=new n(this,!0);b=h(c);c.detach();return b},canSurroundContents:function(){D(this);F(this.startContainer);F(this.endContainer);var a=new n(this,!0),b=a._first&&w(a._first,this)||a._last&&w(a._last,
this);a.detach();return!b},surroundContents:function(a){B(a,M);if(!this.canSurroundContents())throw new p("BAD_BOUNDARYPOINTS_ERR");var b=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);e(a,this.startContainer,this.startOffset);a.appendChild(b);this.selectNode(a)},cloneRange:function(){D(this);for(var b=new I(a(this)),c=V.length,d;c--;)d=V[c],b[d]=this[d];return b},toString:function(){D(this);var a=this.startContainer;if(a===this.endContainer&&s.isCharacterDataNode(a))return 3==
a.nodeType||4==a.nodeType?a.data.slice(this.startOffset,this.endOffset):"";var b=[],a=new n(this,!0);g(a,function(a){(3==a.nodeType||4==a.nodeType)&&b.push(a.data)});a.detach();return b.join("")},compareNode:function(a){D(this);var b=a.parentNode,c=s.getNodeIndex(a);if(!b)throw new P("NOT_FOUND_ERR");a=this.comparePoint(b,c);b=this.comparePoint(b,c+1);return 0>a?0<b?la:na:0<b?oa:ma},comparePoint:function(a,b){D(this);y(a,"HIERARCHY_REQUEST_ERR");C(a,this.startContainer);return 0>s.comparePoints(a,
...
this.collapse(!0)},getName:function(){return"DomRange"},equals:function(a){return I.rangesEqual(this,a)},isValid:function(){return G(this)},inspect:function(){return o(this)}};N(I,U,function(a){q(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;c(a,"detach",null);a._listeners=null});m.rangePrototype=Q.prototype;I.rangeProperties=V;I.RangeIterator=n;I.copyComparisonConstants=u;I.createPrototypeRange=N;I.inspect=o;I.getRangeDocument=a;I.rangesEqual=
...
d=new A(a.focusNode,a.focusOffset),j="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var e=0,g=a.rangeCount;e<g;++e)b[e]=x.inspect(a.getRangeAt(e));return"["+j+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}m.requireModules(["DomUtil","DomRange","WrappedRange"]);m.config.checkSelectionRanges=!0;var r=m.dom,v=m.util,x=m.DomRange,q=m.WrappedRange,B=m.DOMException,A=r.DomPosition,C,F,y=m.util.isHostMethod(window,"getSelection"),
G=m.util.isHostObject(document,"selection"),D=G&&(!y||m.config.preferTextRange);D?(C=c,m.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return"None"!=b.type||r.getDocument(b.createRange().parentElement())==a}):y?(C=a,m.isSelectionValid=function(){return!0}):w.fail("Neither document.selection or window.getSelection() detected.");m.getNativeSelection=C;var y=C(),Q=m.createNativeRange(document),L=r.getBody(document),u=v.areHostObjects(y,v.areHostProperties(y,["anchorOffset","focusOffset"]));
m.features.selectionHasAnchorAndFocus=u;var W=v.isHostMethod(y,"extend");m.features.selectionHasExtend=W;var N="number"==typeof y.rangeCount;m.features.selectionHasRangeCount=N;var i=!1,U=!0;v.areHostMethods(y,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof y.rangeCount&&m.features.implementsDomRange&&function(){var a=document.createElement("iframe");a.frameBorder=0;a.style.position="absolute";a.style.left="-10000px";L.appendChild(a);var b=r.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");
b.close();var c=r.getIframeWindow(a).getSelection(),d=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(d,1);b.collapse(true);c.addRange(b);U=c.rangeCount==1;c.removeAllRanges();var j=b.cloneRange();b.setStart(d,0);j.setEnd(d,2);c.addRange(b);c.addRange(j);i=c.rangeCount==2;b.detach();j.detach();L.removeChild(a)}();m.features.selectionSupportsMultipleRanges=i;m.features.collapsedNonEditableSelectionsSupported=U;var I=!1,s;L&&v.isHostMethod(L,"createControlRange")&&(s=L.createControlRange(),
v.areHostProperties(s,["item","add"])&&(I=!0));m.features.implementsControlRange=I;F=u?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:false};var R;v.isHostMethod(y,"getRangeAt")?R=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:u&&(R=function(a){var b=r.getDocument(a.anchorNode),b=m.createRange(b);b.setStart(a.anchorNode,a.anchorOffset);b.setEnd(a.focusNode,a.focusOffset);if(b.collapsed!==
this.isCollapsed){b.setStart(a.focusNode,a.focusOffset);b.setEnd(a.anchorNode,a.anchorOffset)}return b});m.getSelection=function(a){var a=a||window,b=a._rangySelection,d=C(a),e=G?c(a):null;if(b){b.nativeSelection=d;b.docSelection=e;b.refresh(a)}else{b=new l(d,e,a);a._rangySelection=b}return b};m.getIframeSelection=function(a){return m.getSelection(r.getIframeWindow(a))};s=l.prototype;if(!D&&u&&v.areHostMethods(y,["removeAllRanges","addRange"])){s.removeAllRanges=function(){this.nativeSelection.removeAllRanges();
f(this)};var P=function(a,b){var c=x.getRangeDocument(b),c=m.createRange(c);c.collapseToPoint(b.endContainer,b.endOffset);a.nativeSelection.addRange(e(c));a.nativeSelection.extend(b.startContainer,b.startOffset);a.refresh()};s.addRange=N?function(a,b){if(I&&G&&this.docSelection.type=="Control")k(this,a);else if(b&&W)P(this,a);else{var c;if(i)c=this.rangeCount;else{this.removeAllRanges();c=0}this.nativeSelection.addRange(e(a));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==c+1){if(m.config.checkSelectionRanges)(c=
R(this.nativeSelection,this.rangeCount-1))&&!x.rangesEqual(c,a)&&(a=new q(c));this._ranges[this.rangeCount-1]=a;d(this,a,O(this.nativeSelection));this.isCollapsed=F(this)}else this.refresh()}}:function(a,b){if(b&&W)P(this,a);else{this.nativeSelection.addRange(e(a));this.refresh()}};s.setRanges=function(a){if(I&&a.length>1)o(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(v.isHostMethod(y,"empty")&&v.isHostMethod(Q,"select")&&I&&D)s.removeAllRanges=
...
1;this.isCollapsed=this._ranges[0].collapsed;d(this,a,false)}},s.setRanges=function(a){this.removeAllRanges();var b=a.length;b>1?o(this,a):b&&this.addRange(a[0])};else return w.fail("No means of selecting a Range or TextRange was found"),!1;s.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new B("INDEX_SIZE_ERR");return this._ranges[a]};var J;if(D)J=function(a){var c;if(m.isSelectionValid(a.win))c=a.docSelection.createRange();else{c=r.getBody(a.win.document).createTextRange();c.collapse(true)}a.docSelection.type==
"Control"?b(a):c&&typeof c.text!="undefined"?g(a,c):f(a)};else if(v.isHostMethod(y,"getRangeAt")&&"number"==typeof y.rangeCount)J=function(a){if(I&&G&&a.docSelection.type=="Control")b(a);else{a._ranges.length=a.rangeCount=a.nativeSelection.rangeCount;if(a.rangeCount){for(var c=0,e=a.rangeCount;c<e;++c)a._ranges[c]=new m.WrappedRange(a.nativeSelection.getRangeAt(c));d(a,a._ranges[a.rangeCount-1],O(a.nativeSelection));a.isCollapsed=F(a)}else f(a)}};else if(u&&"boolean"==typeof y.isCollapsed&&"boolean"==
typeof Q.collapsed&&m.features.implementsDomRange)J=function(a){var b;b=a.nativeSelection;if(b.anchorNode){b=R(b,0);a._ranges=[b];a.rangeCount=1;b=a.nativeSelection;a.anchorNode=b.anchorNode;a.anchorOffset=b.anchorOffset;a.focusNode=b.focusNode;a.focusOffset=b.focusOffset;a.isCollapsed=F(a)}else f(a)};else return w.fail("No means of obtaining a Range or TextRange from the user's selection was found"),!1;s.refresh=function(a){var b=a?this._ranges.slice(0):null;J(this);if(a){a=b.length;if(a!=this._ranges.length)return false;
for(;a--;)if(!x.rangesEqual(b[a],this._ranges[a]))return false;return true}};var H=function(a,b){var c=a.getAllRanges(),d=false;a.removeAllRanges();for(var j=0,e=c.length;j<e;++j)d||b!==c[j]?a.addRange(c[j]):d=true;a.rangeCount||f(a)};s.removeRange=I?function(a){if(this.docSelection.type=="Control"){for(var c=this.docSelection.createRange(),a=h(a),d=r.getDocument(c.item(0)),d=r.getBody(d).createControlRange(),e,j=false,g=0,f=c.length;g<f;++g){e=c.item(g);e!==a||j?d.add(c.item(g)):j=true}d.select();
b(this)}else H(this,a)}:function(a){H(this,a)};var O;!D&&u&&m.features.implementsDomRange?(O=function(a){var b=false;a.anchorNode&&(b=r.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset)==1);return b},s.isBackwards=function(){return O(this)}):O=s.isBackwards=function(){return false};s.toString=function(){for(var a=[],b=0,c=this.rangeCount;b<c;++b)a[b]=""+this._ranges[b];return a.join("")};s.collapse=function(a,b){n(this,a);var c=m.createRange(r.getDocument(a));c.collapseToPoint(a,
b);this.removeAllRanges();this.addRange(c);this.isCollapsed=true};s.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new B("INVALID_STATE_ERR");};s.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new B("INVALID_STATE_ERR");};s.selectAllChildren=function(a){n(this,a);var b=m.createRange(r.getDocument(a));b.selectNodeContents(a);this.removeAllRanges();
...
"class"!=e)return!0;return!1}function l(a){var b;return a&&1==a.nodeType&&((b=a.parentNode)&&9==b.nodeType&&"on"==b.designMode||F(a)&&!F(a.parentNode))}function o(a){return(F(a)||1!=a.nodeType&&F(a.parentNode))&&!l(a)}function n(a){return a&&1==a.nodeType&&!y.test(C(a,"display"))}function p(a){if(0==a.data.length)return!0;if(G.test(a.data))return!1;switch(C(a.parentNode,"whiteSpace")){case "pre":case "pre-wrap":case "-moz-pre-wrap":return!1;case "pre-line":if(/[\r\n]/.test(a.data))return!1}return n(a.previousSibling)||
...
c,d){return c&&d?" ":""}return function(b,c){b.className&&(b.className=b.className.replace(RegExp("(?:^|\\s)"+c+"(?:\\s|$)"),a))}}(),C;"undefined"!=typeof window.getComputedStyle?C=function(a,b){return B.getWindow(a).getComputedStyle(a,null)[b]}:"undefined"!=typeof document.documentElement.currentStyle?C=function(a,b){return a.currentStyle[b]}:w.fail("No means of obtaining computed style properties found");var F;(function(){F="boolean"==typeof document.createElement("div").isContentEditable?function(a){return a&&
1==a.nodeType&&a.isContentEditable}:function(a){return!a||1!=a.nodeType||"false"==a.contentEditable?!1:"true"==a.contentEditable||F(a.parentNode)}})();var y=/^inline(-block|-table)?$/i,G=/[^\r\n\t\f \u200B]/,D=v(!1),Q=v(!0);x.prototype={doMerge:function(){for(var a=[],b,c,d=0,e=this.textNodes.length;d<e;++d)b=this.textNodes[d],c=b.parentNode,a[d]=b.data,d&&(c.removeChild(b),c.hasChildNodes()||c.parentNode.removeChild(c));return this.firstTextNode.data=a=a.join("")},getLength:function(){for(var a=
...
elementHasNonClassAttributes:k,splitNodeAt:r,isEditableElement:F,isEditingHost:l,isEditable:o};m.CssClassApplier=q;m.createCssClassApplier=function(a,b,c){return new q(a,b,c)}});
...
c)for(;4>e;e+=2)c||(d-=parseFloat(i.css(a,"padding"+da[e]))||0),d="margin"===c?d+(parseFloat(i.css(a,c+da[e]))||0):d-(parseFloat(i.css(a,"border"+da[e]+"Width"))||0);return d+"px"}d=ga(a,b);if(0>d||null==d)d=a.style[b];if(wa.test(d))return d;d=parseFloat(d)||0;if(c)for(;4>e;e+=2)d+=parseFloat(i.css(a,"padding"+da[e]))||0,"padding"!==c&&(d+=parseFloat(i.css(a,"border"+da[e]+"Width"))||0),"margin"===c&&(d+=parseFloat(i.css(a,c+da[e]))||0);return d+"px"}function q(a){return function(b,c){"string"!==
...
{};for(d in b)b[d]!==c&&((j[d]?a:e||(e={}))[d]=b[d]);e&&i.extend(!0,a,e)}function C(a,b,c,d){if(i.isArray(b))i.each(b,function(b,e){c||fb.test(a)?d(a,e):C(a+"["+("object"===typeof e?b:"")+"]",e,c,d)});else if(!c&&"object"===i.type(b))for(var e in b)C(a+"["+e+"]",b[e],c,d);else d(a,b)}function F(){try{return new a.XMLHttpRequest}catch(b){}}function y(){setTimeout(w,0);return pa=i.now()}function w(){pa=c}function D(a,b){var c={};i.each(qa.concat.apply([],qa.slice(0,b)),function(){c[this]=a});return c}
function Q(a){if(!ya[a]){var b=u.body,c=i("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d){ba||(ba=u.createElement("iframe"),ba.frameBorder=ba.width=ba.height=0);b.appendChild(ba);if(!ha||!ba.createElement)ha=(ba.contentWindow||ba.contentDocument).document,ha.write((i.support.boxModel?"<!doctype html>":"")+"<html><body>"),ha.close();c=ha.createElement(a);ha.body.appendChild(c);d=i.css(c,"display");b.removeChild(ba)}ya[a]=d}return ya[a]}function L(a){return i.isWindow(a)?
a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var u=a.document,W=a.navigator,N=a.location,i=function(){function b(){if(!d.isReady){try{u.documentElement.doScroll("left")}catch(a){setTimeout(b,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,f)},e=a.jQuery,j=a.$,f,g=/^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,h=/\S/,k=/^\s+/,i=/\s+$/,t=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,n=/^[\],:{}\s]*$/,l=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,z=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
p=/(?:^|:|,)(?:\s*\[)+/g,o=/(webkit)[ \/]([\w.]+)/,r=/(opera)(?:.*version)?[ \/]([\w.]+)/,v=/(msie) ([\w.]+)/,K=/(mozilla)(?:.*? rv:([\w.]+))?/,V=/-([a-z]|[0-9])/ig,x=/^-ms-/,q=function(a,b){return(b+"").toUpperCase()},m=W.userAgent,ra,ia,gb=Object.prototype.toString,za=Object.prototype.hasOwnProperty,Aa=Array.prototype.push,T=Array.prototype.slice,B=String.prototype.trim,s=Array.prototype.indexOf,A={};d.fn=d.prototype={constructor:d,init:function(a,b,e){var E;if(!a)return this;if(a.nodeType)return this.context=
this[0]=a,this.length=1,this;if("body"===a&&!b&&u.body)return this.context=u,this[0]=u.body,this.selector=a,this.length=1,this;if("string"===typeof a){if((E="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:g.exec(a))&&(E[1]||!b)){if(E[1])return e=(b=b instanceof d?b[0]:b)?b.ownerDocument||b:u,(a=t.exec(a))?d.isPlainObject(b)?(a=[u.createElement(a[1])],d.fn.attr.call(a,b,!0)):a=[e.createElement(a[1])]:(a=d.buildFragment([E[1]],[e]),a=(a.cacheable?d.clone(a.fragment):a.fragment).childNodes),
d.merge(this,a);if((b=u.getElementById(E[2]))&&b.parentNode){if(b.id!==E[2])return e.find(a);this.length=1;this[0]=b}this.context=u;this.selector=a;return this}return!b||b.jquery?(b||e).find(a):this.constructor(b).find(a)}if(d.isFunction(a))return e.ready(a);a.selector!==c&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,this)},selector:"",jquery:"1.7.2",length:0,size:function(){return this.length},toArray:function(){return T.call(this,0)},get:function(a){return null==a?this.toArray():
...
slice:function(){return this.pushStack(T.apply(this,arguments),"slice",T.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:Aa,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,b,e,E,j,f=arguments[0]||{},g=1,h=arguments.length,k=!1;"boolean"===typeof f&&(k=f,f=arguments[1]||{},g=2);"object"!==typeof f&&!d.isFunction(f)&&(f=
{});h===g&&(f=this,--g);for(;g<h;g++)if(null!=(a=arguments[g]))for(b in a)e=f[b],E=a[b],f!==E&&(k&&E&&(d.isPlainObject(E)||(j=d.isArray(E)))?(j?(j=!1,e=e&&d.isArray(e)?e:[]):e=e&&d.isPlainObject(e)?e:{},f[b]=d.extend(k,e,E)):E!==c&&(f[b]=E));return f};d.extend({noConflict:function(b){a.$===d&&(a.$=j);b&&a.jQuery===d&&(a.jQuery=e);return d},isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!u.body)return setTimeout(d.ready,
1);d.isReady=!0;!0!==a&&0<--d.readyWait||(ra.fireWith(u,[d]),d.fn.trigger&&d(u).trigger("ready").off("ready"))}},bindReady:function(){if(!ra){ra=d.Callbacks("once memory");if("complete"===u.readyState)return setTimeout(d.ready,1);if(u.addEventListener)u.addEventListener("DOMContentLoaded",ia,!1),a.addEventListener("load",d.ready,!1);else if(u.attachEvent){u.attachEvent("onreadystatechange",ia);a.attachEvent("onload",d.ready);var c=!1;try{c=null==a.frameElement}catch(e){}u.documentElement.doScroll&&
...
return e===c||za.call(a,e)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(n.test(b.replace(l,"@").replace(z,"]").replace(p,"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b){if("string"!==typeof b||!b)return null;var e,E;try{a.DOMParser?(E=new DOMParser,e=E.parseFromString(b,"text/xml")):
(e=new ActiveXObject("Microsoft.XMLDOM"),e.async="false",e.loadXML(b))}catch(j){e=c}(!e||!e.documentElement||e.getElementsByTagName("parsererror").length)&&d.error("Invalid XML: "+b);return e},noop:function(){},globalEval:function(b){b&&h.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(x,"ms-").replace(V,q)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,b,e){var E,j=0,f=a.length,g=f===c||d.isFunction(a);
if(e)if(g)for(E in a){if(!1===b.apply(a[E],e))break}else for(;j<f&&!1!==b.apply(a[j++],e););else if(g)for(E in a){if(!1===b.call(a[E],E,a[E]))break}else for(;j<f&&!1!==b.call(a[j],j,a[j++]););return a},trim:B?function(a){return null==a?"":B.call(a)}:function(a){return null==a?"":a.toString().replace(k,"").replace(i,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var e=d.type(a);null==a.length||"string"===e||"function"===e||"regexp"===e||d.isWindow(a)?Aa.call(c,a):d.merge(c,a)}return c},inArray:function(a,
b,c){var d;if(b){if(s)return s.call(b,a,c);d=b.length;for(c=c?0>c?Math.max(0,d+c):c:0;c<d;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,b){var d=a.length,e=0;if("number"===typeof b.length)for(var E=b.length;e<E;e++)a[d++]=b[e];else for(;b[e]!==c;)a[d++]=b[e++];a.length=d;return a},grep:function(a,b,c){for(var d=[],e,c=!!c,E=0,j=a.length;E<j;E++)e=!!b(a[E],E),c!==e&&d.push(a[E]);return d},map:function(a,b,e){var E,j,f=[],g=0,h=a.length;if(a instanceof d||h!==c&&"number"===typeof h&&(0<
h&&a[0]&&a[h-1]||0===h||d.isArray(a)))for(;g<h;g++)E=b(a[g],g,e),null!=E&&(f[f.length]=E);else for(j in a)E=b(a[j],j,e),null!=E&&(f[f.length]=E);return f.concat.apply([],f)},guid:1,proxy:function(a,b){if("string"===typeof b)var e=a[b],b=a,a=e;if(!d.isFunction(a))return c;var E=T.call(arguments,2),e=function(){return a.apply(b,E.concat(T.call(arguments)))};e.guid=a.guid=a.guid||e.guid||d.guid++;return e},access:function(a,b,e,E,j,f,g){var h,k=null==e,i=0,t=a.length;if(e&&"object"===typeof e){for(i in e)d.access(a,
b,i,e[i],1,f,E);j=1}else if(E!==c){h=g===c&&d.isFunction(E);k&&(h?(h=b,b=function(a,b,c){return h.call(d(a),c)}):(b.call(a,E),b=null));if(b)for(;i<t;i++)b(a[i],e,h?E.call(a[i],i,b(a[i],e)):E,g);j=1}return j?a:k?b.call(a):t?b(a[0],e):f},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=o.exec(a)||r.exec(a)||v.exec(a)||0>a.indexOf("compatible")&&K.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,
...
(k=/^[\s\xA0]+/,i=/[\s\xA0]+$/);f=d(u);u.addEventListener?ia=function(){u.removeEventListener("DOMContentLoaded",ia,false);d.ready()}:u.attachEvent&&(ia=function(){if(u.readyState==="complete"){u.detachEvent("onreadystatechange",ia);d.ready()}});return d}(),U={};i.Callbacks=function(a){var a=a?U[a]||d(a):{},b=[],e=[],j,f,g,h,k,t,n=function(c){var d,e,j,f;d=0;for(e=c.length;d<e;d++)j=c[d],f=i.type(j),"array"===f?n(j):"function"===f&&(!a.unique||!z.has(j))&&b.push(j)},l=function(c,d){d=d||[];j=!a.memory||
...
d,j.val()):a,null==d?d="":"number"===typeof d?d+="":i.isArray(d)&&(d=i.map(d,function(a){return a==null?"":a+""})),b=i.valHooks[this.type]||i.valHooks[this.nodeName.toLowerCase()],!b||!("set"in b)||b.set(this,d,"value")===c))this.value=d});if(j){if((b=i.valHooks[j.type]||i.valHooks[j.nodeName.toLowerCase()])&&"get"in b&&(d=b.get(j,"value"))!==c)return d;d=j.value;return"string"===typeof d?d.replace(H,""):null==d?"":d}}});i.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||
...
{set:function(a,b){if(i.isArray(b))return a.checked=i.inArray(i(a).val(),b)>=0}})});var K=/^(?:textarea|input|select)$/i,V=/^([^\.]*)?(?:\.(.+))?$/,T=/(?:^|\s)hover(\.\S+)?\b/,$=/^key/,aa=/^(?:mouse|contextmenu)|click/,ka=/^(?:focusinfocus|focusoutblur)$/,na=/^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/,oa=function(a){if(a=na.exec(a)){a[1]=(a[1]||"").toLowerCase();a[3]=a[3]&&RegExp("(?:^|\\s)"+a[3]+"(?:\\s|$)")}return a},la=function(a){return i.event.special.hover?a:a.replace(T,"mouseenter$1 mouseleave$1")};
i.event={add:function(a,b,d,e,j){var f,g,h,k,t,n,l,z,p;if(!(a.nodeType===3||a.nodeType===8||!b||!d||!(f=i._data(a)))){if(d.handler){l=d;d=l.handler;j=l.selector}if(!d.guid)d.guid=i.guid++;h=f.events;if(!h)f.events=h={};g=f.handle;if(!g){f.handle=g=function(a){return typeof i!=="undefined"&&(!a||i.event.triggered!==a.type)?i.event.dispatch.apply(g.elem,arguments):c};g.elem=a}b=i.trim(la(b)).split(" ");for(f=0;f<b.length;f++){k=V.exec(b[f])||[];t=k[1];n=(k[2]||"").split(".").sort();p=i.event.special[t]||
{};t=(j?p.delegateType:p.bindType)||t;p=i.event.special[t]||{};k=i.extend({type:t,origType:k[1],data:e,handler:d,guid:d.guid,selector:j,quick:j&&oa(j),namespace:n.join(".")},l);z=h[t];if(!z){z=h[t]=[];z.delegateCount=0;if(!p.setup||p.setup.call(a,e,n,g)===false)a.addEventListener?a.addEventListener(t,g,false):a.attachEvent&&a.attachEvent("on"+t,g)}if(p.add){p.add.call(a,k);if(!k.handler.guid)k.handler.guid=d.guid}j?z.splice(z.delegateCount++,0,k):z.push(k);i.event.global[t]=true}a=null}},global:{},
remove:function(a,b,c,d,e){var j=i.hasData(a)&&i._data(a),f,g,h,k,t,n,l,z,p,o;if(j&&(l=j.events)){b=i.trim(la(b||"")).split(" ");for(f=0;f<b.length;f++){g=V.exec(b[f])||[];h=k=g[1];g=g[2];if(h){z=i.event.special[h]||{};h=(d?z.delegateType:z.bindType)||h;p=l[h]||[];t=p.length;g=g?RegExp("(^|\\.)"+g.split(".").sort().join("\\.(?:.*\\.)?")+"(\\.|$)"):null;for(n=0;n<p.length;n++){o=p[n];if((e||k===o.origType)&&(!c||c.guid===o.guid)&&(!g||g.test(o.namespace))&&(!d||d===o.selector||d==="**"&&o.selector)){p.splice(n--,
1);o.selector&&p.delegateCount--;z.remove&&z.remove.call(a,o)}}if(p.length===0&&t!==p.length){(!z.teardown||z.teardown.call(a,g)===false)&&i.removeEvent(a,h,j.handle);delete l[h]}}else for(h in l)i.event.remove(a,h+b[f],c,d,true)}if(i.isEmptyObject(l)){if(b=j.handle)b.elem=null;i.removeData(a,["events","handle"],true)}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(b,d,e,j){if(!e||!(e.nodeType===3||e.nodeType===8)){var f=b.type||b,g=[],h,k,t,n,l;if(!ka.test(f+i.event.triggered)){if(f.indexOf("!")>=
...
j=[].slice.call(arguments,0),f=!b.exclusive&&!b.namespace,g=i.event.special[b.type]||{},h=[],k,t,n,l,z,p,o;j[0]=b;b.delegateTarget=this;if(!(g.preDispatch&&g.preDispatch.call(this,b)===false)){if(e&&!(b.button&&b.type==="click")){n=i(this);n.context=this.ownerDocument||this;for(t=b.target;t!=this;t=t.parentNode||this)if(t.disabled!==true){z={};p=[];n[0]=t;for(k=0;k<e;k++){l=d[k];o=l.selector;if(z[o]===c){var r=z,v=o,K;if(l.quick){K=l.quick;var V=t.attributes||{};K=(!K[1]||t.nodeName.toLowerCase()===
K[1])&&(!K[2]||(V.id||{}).value===K[2])&&(!K[3]||K[3].test((V["class"]||{}).value))}else K=n.is(o);r[v]=K}z[o]&&p.push(l)}p.length&&h.push({elem:t,matches:p})}}d.length>e&&h.push({elem:this,matches:d.slice(e)});for(k=0;k<h.length&&!b.isPropagationStopped();k++){e=h[k];b.currentTarget=e.elem;for(d=0;d<e.matches.length&&!b.isImmediatePropagationStopped();d++){l=e.matches[d];if(f||!b.namespace&&!l.namespace||b.namespace_re&&b.namespace_re.test(l.namespace)){b.data=l.data;b.handleObj=l;l=((i.event.special[l.origType]||
...
postDispatch:function(a){if(a._submit_bubble){delete a._submit_bubble;this.parentNode&&!a.isTrigger&&i.event.simulate("submit",this.parentNode,a,true)}},teardown:function(){if(i.nodeName(this,"form"))return false;i.event.remove(this,"._submit")}});i.support.changeBubbles||(i.event.special.change={setup:function(){if(K.test(this.nodeName)){if(this.type==="checkbox"||this.type==="radio"){i.event.add(this,"propertychange._change",function(a){if(a.originalEvent.propertyName==="checked")this._just_changed=
true});i.event.add(this,"click._change",function(a){if(this._just_changed&&!a.isTrigger){this._just_changed=false;i.event.simulate("change",this,a,true)}})}return false}i.event.add(this,"beforeactivate._change",function(a){a=a.target;if(K.test(a.nodeName)&&!a._change_attached){i.event.add(a,"change._change",function(a){this.parentNode&&!a.isSimulated&&!a.isTrigger&&i.event.simulate("change",this.parentNode,a,true)});a._change_attached=true}})},handle:function(a){var b=a.target;if(this!==b||a.isSimulated||
a.isTrigger||b.type!=="radio"&&b.type!=="checkbox")return a.handleObj.handler.apply(this,arguments)},teardown:function(){i.event.remove(this,"._change");return K.test(this.nodeName)}});i.support.focusinBubbles||i.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){i.event.simulate(b,a.target,i.event.fix(a),true)};i.event.special[b]={setup:function(){c++===0&&u.addEventListener(a,d,true)},teardown:function(){--c===0&&u.removeEventListener(a,d,true)}}});i.fn.extend({on:function(a,
...
var l=function(a,b,c,e){var c=c||[],j=b=b||u;if(b.nodeType!==1&&b.nodeType!==9)return[];if(!a||typeof a!=="string")return c;var g,h,k,i,t,E=true,n=l.isXML(b),z=[],r=a;do{d.exec("");if(g=d.exec(r)){r=g[3];z.push(g[1]);if(g[2]){i=g[3];break}}}while(g);if(z.length>1&&o.exec(a))if(z.length===2&&p.relative[z[0]])h=m(z[0]+z[1],b,e);else for(h=p.relative[z[0]]?[b]:l(z.shift(),b);z.length;){a=z.shift();p.relative[a]&&(a=a+z.shift());h=m(a,h,e)}else{if(!e&&z.length>1&&b.nodeType===9&&!n&&p.match.ID.test(z[0])&&
!p.match.ID.test(z[z.length-1])){g=l.find(z.shift(),b,n);b=g.expr?l.filter(g.expr,g.set)[0]:g.set[0]}if(b){g=e?{expr:z.pop(),set:K(e)}:l.find(z.pop(),z.length===1&&(z[0]==="~"||z[0]==="+")&&b.parentNode?b.parentNode:b,n);h=g.expr?l.filter(g.expr,g.set):g.set;for(z.length>0?k=K(h):E=false;z.length;){g=t=z.pop();p.relative[t]?g=z.pop():t="";g==null&&(g=b);p.relative[t](k,g,n)}}else k=[]}k||(k=h);k||l.error(t||a);if(f.call(k)==="[object Array]")if(E)if(b&&b.nodeType===1)for(a=0;k[a]!=null;a++)k[a]&&
(k[a]===true||k[a].nodeType===1&&l.contains(b,k[a]))&&c.push(h[a]);else for(a=0;k[a]!=null;a++)k[a]&&k[a].nodeType===1&&c.push(h[a]);else c.push.apply(c,k);else K(k,c);if(i){l(i,j,c,e);l.uniqueSort(c)}return c};l.uniqueSort=function(a){if(x){g=h;a.sort(x);if(g)for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1)}return a};l.matches=function(a,b){return l(a,null,null,b)};l.matchesSelector=function(a,b){return l(b,null,null,[a]).length>0};l.find=function(a,b,c){var d,e,j,f,g,h;if(!a)return[];e=
0;for(j=p.order.length;e<j;e++){g=p.order[e];if(f=p.leftMatch[g].exec(a)){h=f[1];f.splice(1,1);if(h.substr(h.length-1)!=="\\"){f[1]=(f[1]||"").replace(k,"");d=p.find[g](f,b,c);if(d!=null){a=a.replace(p.match[g],"");break}}}}d||(d=typeof b.getElementsByTagName!=="undefined"?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};l.filter=function(a,b,d,e){for(var j,f,g,h,k,i,t,E,n=a,z=[],o=b,r=b&&b[0]&&l.isXML(b[0]);a&&b.length;){for(g in p.filter)if((j=p.leftMatch[g].exec(a))!=null&&j[2]){i=p.filter[g];
k=j[1];f=false;j.splice(1,1);if(k.substr(k.length-1)!=="\\"){o===z&&(z=[]);if(p.preFilter[g])if(j=p.preFilter[g](j,o,d,z,e,r)){if(j===true)continue}else f=h=true;if(j)for(t=0;(k=o[t])!=null;t++)if(k){h=i(k,j,t,o);E=e^h;if(d&&h!=null)E?f=true:o[t]=false;else if(E){z.push(k);f=true}}if(h!==c){d||(o=z);a=a.replace(p.match[g],"");if(!f)return[];break}}}if(a===n)if(f==null)l.error(a);else break;n=a}return o};l.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};var z=l.getText=
...
v;for(v in p.match){p.match[v]=RegExp(p.match[v].source+/(?![^\[]*\])(?![^\(]*\))/.source);p.leftMatch[v]=RegExp(/(^(?:.|\r|\n)*?)/.source+p.match[v].source.replace(/\\(\d+)/g,r))}p.match.globalPOS=o;var K=function(a,b){a=Array.prototype.slice.call(a,0);if(b){b.push.apply(b,a);return b}return a};try{Array.prototype.slice.call(u.documentElement.childNodes,0)[0].nodeType}catch(V){K=function(a,b){var c=0,d=b||[];if(f.call(a)==="[object Array]")Array.prototype.push.apply(d,a);else if(typeof a.length===
"number")for(var e=a.length;c<e;c++)d.push(a[c]);else for(;a[c];c++)d.push(a[c]);return d}}var x,q;if(u.documentElement.compareDocumentPosition)x=function(a,b){if(a===b){g=true;return 0}return!a.compareDocumentPosition||!b.compareDocumentPosition?a.compareDocumentPosition?-1:1:a.compareDocumentPosition(b)&4?-1:1};else{x=function(a,b){if(a===b){g=true;return 0}if(a.sourceIndex&&b.sourceIndex)return a.sourceIndex-b.sourceIndex;var c,d,e=[],j=[];c=a.parentNode;d=b.parentNode;var f=c;if(c===d)return q(a,
...
function(b,c,d,e){c=c||u;if(!e&&!l.isXML(c)){var j=/^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(b);if(j&&(c.nodeType===1||c.nodeType===9)){if(j[1])return K(c.getElementsByTagName(b),d);if(j[2]&&p.find.CLASS&&c.getElementsByClassName)return K(c.getElementsByClassName(j[2]),d)}if(c.nodeType===9){if(b==="body"&&c.body)return K([c.body],d);if(j&&j[3]){var f=c.getElementById(j[3]);if(f&&f.parentNode){if(f.id===j[3])return K([f],d)}else return K([],d)}try{return K(c.querySelectorAll(b),d)}catch(g){}}else if(c.nodeType===
1&&c.nodeName.toLowerCase()!=="object"){var j=c,h=(f=c.getAttribute("id"))||"__sizzle__",k=c.parentNode,i=/^\s*[+~]/.test(b);f?h=h.replace(/'/g,"\\$&"):c.setAttribute("id",h);if(i&&k)c=c.parentNode;try{if(!i||k)return K(c.querySelectorAll("[id='"+h+"'] "+b),d)}catch(t){}finally{f||j.removeAttribute("id")}}}return a(b,c,d,e)};for(var c in a)l[c]=a[c];b=null}}();(function(){var a=u.documentElement,b=a.matchesSelector||a.mozMatchesSelector||a.webkitMatchesSelector||a.msMatchesSelector;if(b){var c=!b.call(u.createElement("div"),
"div"),d=false;try{b.call(u.documentElement,"[test!='']:sizzle")}catch(e){d=true}l.matchesSelector=function(a,e){e=e.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!l.isXML(a))try{if(d||!p.match.PSEUDO.test(e)&&!/!=/.test(e)){var j=b.call(a,e);if(j||!c||a.document&&a.document.nodeType!==11)return j}}catch(f){}return l(e,null,null,[a]).length>0}}})();(function(){var a=u.createElement("div");a.innerHTML="<div class='test e'></div><div class='test'></div>";if(a.getElementsByClassName&&a.getElementsByClassName("e").length!==
...
a:0).documentElement)?a.nodeName!=="HTML":false};var m=function(a,b,c){for(var d,e=[],j="",b=b.nodeType?[b]:b;d=p.match.PSEUDO.exec(a);){j=j+d[0];a=a.replace(p.match.PSEUDO,"")}a=p.relative[a]?a+"*":a;d=0;for(var f=b.length;d<f;d++)l(a,b[d],e,c);return l.filter(j,e)};l.attr=i.attr;l.selectors.attrMap={};i.find=l;i.expr=l.selectors;i.expr[":"]=i.expr.filters;i.unique=l.uniqueSort;i.text=l.getText;i.isXMLDoc=l.isXML;i.contains=l.contains})();var ma=/Until$/,Wa=/^(?:parents|prevUntil|prevAll)/,Xa=/,/,
...
ua=/^\s+/,Ga=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Ha=/<([\w:]+)/,db=/<tbody/i,eb=/<|&#?\w+;/,bb=/<(?:script|style)/i,cb=/<(?:script|object|embed|option|style)/i,Ia=RegExp("<(?:"+Fa+")[\\s/>]","i"),Ka=/checked\s*(?:[^=]|=\s*.checked.)/i,La=/\/(java|ecma)script/i,hb=/^\s*<!(?:\[CDATA\[|\-\-)/,Z={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,
"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]},Ba=l(u);Z.optgroup=Z.option;Z.tbody=Z.tfoot=Z.colgroup=Z.caption=Z.thead;Z.th=Z.td;i.support.htmlSerialize||(Z._default=[1,"div<div>","</div>"]);i.fn.extend({text:function(a){return i.access(this,function(a){return a===c?i.text(this):this.empty().append((this[0]&&this[0].ownerDocument||u).createTextNode(a))},null,a,arguments.length)},wrapAll:function(a){if(i.isFunction(a))return this.each(function(b){i(this).wrapAll(a.call(this,
...
1])&&t.parentNode&&t.parentNode.removeChild(t)}}else g=b.createTextNode(g);var z;if(!i.support.appendChecked)if(g[0]&&typeof(z=g.length)==="number")for(e=0;e<z;e++)v(g[e]);else v(g);g.nodeType?j.push(g):j=i.merge(j,g)}}if(c){a=function(a){return!a.type||La.test(a.type)};for(f=0;j[f];f++){b=j[f];if(d&&i.nodeName(b,"script")&&(!b.type||La.test(b.type)))d.push(b.parentNode?b.parentNode.removeChild(b):b);else{if(b.nodeType===1){g=i.grep(b.getElementsByTagName("script"),a);j.splice.apply(j,[f+1,0].concat(g))}c.appendChild(b)}}}return j},
...
""?"auto":e});ga=Ma||Na;i.each(["height","width"],function(a,b){i.cssHooks[b]={get:function(a,c,d){if(c)return a.offsetWidth!==0?x(a,b,d):i.swap(a,nb,function(){return x(a,b,d)})},set:function(a,b){return kb.test(b)?b+"px":b}}});i.support.opacity||(i.cssHooks.opacity={get:function(a,b){return ib.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,e=i.isNumeric(b)?"alpha(opacity="+b*100+")":"",j=
d&&d.filter||c.filter||"";c.zoom=1;if(b>=1&&i.trim(j.replace(Ca,""))===""){c.removeAttribute("filter");if(d&&!d.filter)return}c.filter=Ca.test(j)?j.replace(Ca,e):j+" "+e}});i(function(){if(!i.support.reliableMarginRight)i.cssHooks.marginRight={get:function(a,b){return i.swap(a,{display:"inline-block"},function(){return b?ga(a,"margin-right"):a.style.marginRight})}}});i.expr&&i.expr.filters&&(i.expr.filters.hidden=function(a){var b=a.offsetHeight;return a.offsetWidth===0&&b===0||!i.support.reliableHiddenOffsets&&
(a.style&&a.style.display||i.css(a,"display"))==="none"},i.expr.filters.visible=function(a){return!i.expr.filters.hidden(a)});i.each({margin:"",padding:"",border:"Width"},function(a,b){i.cssHooks[a+b]={expand:function(c){for(var d=typeof c==="string"?c.split(" "):[c],e={},c=0;c<4;c++)e[a+da[c]+b]=d[c]||d[c-2]||d[0];return e}}});var ob=/%20/g,fb=/\[\]$/,Oa=/\r?\n/g,pb=/#.*$/,qb=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,rb=/^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
sb=/^(?:GET|HEAD)$/,tb=/^\/\//,Pa=/\?/,ub=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,vb=/^(?:select|textarea)/i,Ja=/\s+/,wb=/([?&])_=[^&]*/,Qa=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Ra=i.fn.load,xa={},Sa={},ea,fa,Ta=["*/"]+["*"];try{ea=N.href}catch(Cb){ea=u.createElement("a"),ea.href="",ea=ea.href}fa=Qa.exec(ea.toLowerCase())||[];i.fn.extend({load:function(a,b,d){if(typeof a!=="string"&&Ra)return Ra.apply(this,arguments);if(!this.length)return this;var e=a.indexOf(" ");if(e>=
...
processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Ta},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":i.parseJSON,"text xml":i.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:q(xa),ajaxTransport:q(Sa),ajax:function(a,b){function d(a,b,l,n){if(v!==2){v=2;r&&clearTimeout(r);o=c;z=n||"";q.readyState=
a>0?4:0;var p,K,E,n=b;if(l){var x=e,m=q,T=x.contents,ca=x.dataTypes,B=x.responseFields,u,s,A,va;for(s in B)s in l&&(m[B[s]]=l[s]);for(;ca[0]==="*";){ca.shift();u===c&&(u=x.mimeType||m.getResponseHeader("content-type"))}if(u)for(s in T)if(T[s]&&T[s].test(u)){ca.unshift(s);break}if(ca[0]in l)A=ca[0];else{for(s in l){if(!ca[0]||x.converters[s+" "+ca[0]]){A=s;break}va||(va=s)}A=A||va}if(A){A!==ca[0]&&ca.unshift(A);l=l[A]}else l=void 0}else l=c;if(a>=200&&a<300||a===304){if(e.ifModified){if(u=q.getResponseHeader("Last-Modified"))i.lastModified[t]=
u;if(u=q.getResponseHeader("Etag"))i.etag[t]=u}if(a===304){n="notmodified";p=true}else try{u=e;u.dataFilter&&(l=u.dataFilter(l,u.dataType));var C=u.dataTypes;s={};var $,y,F=C.length,w,D=C[0],aa,I,G,H,J;for($=1;$<F;$++){if($===1)for(y in u.converters)typeof y==="string"&&(s[y.toLowerCase()]=u.converters[y]);aa=D;D=C[$];if(D==="*")D=aa;else if(aa!=="*"&&aa!==D){I=aa+" "+D;G=s[I]||s["* "+D];if(!G){J=c;for(H in s){w=H.split(" ");if(w[0]===aa||w[0]==="*")if(J=s[w[1]+" "+D]){H=s[H];H===true?G=J:J===true&&
(G=H);break}}}!G&&!J&&i.error("No conversion from "+I.replace(" "," to "));G!==true&&(l=G?G(l):J(H(l)))}}K=l;n="success";p=true}catch(L){n="parsererror";E=L}}else{E=n;if(!n||a){n="error";a<0&&(a=0)}}q.status=a;q.statusText=""+(b||n);p?g.resolveWith(j,[K,n,q]):g.rejectWith(j,[q,n,E]);q.statusCode(k);k=c;V&&f.trigger("ajax"+(p?"Success":"Error"),[q,e,p?K:E]);h.fireWith(j,[q,n]);if(V){f.trigger("ajaxComplete",[q,e]);--i.active||i.event.trigger("ajaxStop")}}}if(typeof a==="object"){b=a;a=c}var b=b||{},
e=i.ajaxSetup({},b),j=e.context||e,f=j!==e&&(j.nodeType||j instanceof i)?i(j):i.event,g=i.Deferred(),h=i.Callbacks("once memory"),k=e.statusCode||{},t,l={},n={},z,p,o,r,K,v=0,V,x,q={readyState:0,setRequestHeader:function(a,b){if(!v){var c=a.toLowerCase(),a=n[c]=n[c]||a;l[a]=b}return this},getAllResponseHeaders:function(){return v===2?z:null},getResponseHeader:function(a){var b;if(v===2){if(!p)for(p={};b=qb.exec(z);)p[b[1].toLowerCase()]=b[2];b=p[a.toLowerCase()]}return b===c?null:b},overrideMimeType:function(a){if(!v)e.mimeType=
a;return this},abort:function(a){a=a||"abort";o&&o.abort(a);d(0,a);return this}};g.promise(q);q.success=q.done;q.error=q.fail;q.complete=h.add;q.statusCode=function(a){if(a){var b;if(v<2)for(b in a)k[b]=[k[b],a[b]];else{b=a[q.status];q.then(b,b)}}return this};e.url=((a||e.url)+"").replace(pb,"").replace(tb,fa[1]+"//");e.dataTypes=i.trim(e.dataType||"*").toLowerCase().split(Ja);if(e.crossDomain==null){K=Qa.exec(e.url.toLowerCase());e.crossDomain=!(!K||!(K[1]!=fa[1]||K[2]!=fa[2]||(K[3]||(K[1]==="http:"?
80:443))!=(fa[3]||(fa[1]==="http:"?80:443))))}if(e.data&&e.processData&&typeof e.data!=="string")e.data=i.param(e.data,e.traditional);m(xa,e,b,q);if(v===2)return false;V=e.global;e.type=e.type.toUpperCase();e.hasContent=!sb.test(e.type);V&&i.active++===0&&i.event.trigger("ajaxStart");if(!e.hasContent){if(e.data){e.url=e.url+((Pa.test(e.url)?"&":"?")+e.data);delete e.data}t=e.url;if(e.cache===false){K=i.now();var T=e.url.replace(wb,"$1_="+K);e.url=T+(T===e.url?(Pa.test(e.url)?"&":"?")+"_="+K:"")}}(e.data&&
e.hasContent&&e.contentType!==false||b.contentType)&&q.setRequestHeader("Content-Type",e.contentType);if(e.ifModified){t=t||e.url;i.lastModified[t]&&q.setRequestHeader("If-Modified-Since",i.lastModified[t]);i.etag[t]&&q.setRequestHeader("If-None-Match",i.etag[t])}q.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+(e.dataTypes[0]!=="*"?", "+Ta+"; q=0.01":""):e.accepts["*"]);for(x in e.headers)q.setRequestHeader(x,e.headers[x]);if(e.beforeSend&&(e.beforeSend.call(j,
q,e)===false||v===2)){q.abort();return false}for(x in{success:1,error:1,complete:1})q[x](e[x]);if(o=m(Sa,e,b,q)){q.readyState=1;V&&f.trigger("ajaxSend",[q,e]);e.async&&e.timeout>0&&(r=setTimeout(function(){q.abort("timeout")},e.timeout));try{v=1;o.send(l,d)}catch(u){if(v<2)d(-1,u);else throw u;}}else d(-1,"No Transport");return q},param:function(a,b){var d=[],e=function(a,b){b=i.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(b===c)b=i.ajaxSettings.traditional;
...
j){b=u.createElement("script");b.async="async";if(a.scriptCharset)b.charset=a.scriptCharset;b.src=a.url;b.onload=b.onreadystatechange=function(a,e){if(e||!b.readyState||/loaded|complete/.test(b.readyState)){b.onload=b.onreadystatechange=null;d&&b.parentNode&&d.removeChild(b);b=c;e||j(200,"success")}};d.insertBefore(b,d.firstChild)},abort:function(){if(b)b.onload(0,1)}}}});var Da=a.ActiveXObject?function(){for(var a in ja)ja[a](0,1)}:!1,yb=0,ja;i.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=
!this.isLocal&&F()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:F;(function(a){i.extend(i.support,{ajax:!!a,cors:!!a&&"withCredentials"in a})})(i.ajaxSettings.xhr());i.support.ajax&&i.ajaxTransport(function(b){if(!b.crossDomain||i.support.cors){var d;return{send:function(e,j){var f=b.xhr(),g,h;b.username?f.open(b.type,b.url,b.async,b.username,b.password):f.open(b.type,b.url,b.async);if(b.xhrFields)for(h in b.xhrFields)f[h]=b.xhrFields[h];b.mimeType&&f.overrideMimeType&&
f.overrideMimeType(b.mimeType);!b.crossDomain&&!e["X-Requested-With"]&&(e["X-Requested-With"]="XMLHttpRequest");try{for(h in e)f.setRequestHeader(h,e[h])}catch(k){}f.send(b.hasContent&&b.data||null);d=function(a,e){var h,k,t,l,n;try{if(d&&(e||f.readyState===4)){d=c;if(g){f.onreadystatechange=i.noop;Da&&delete ja[g]}if(e)f.readyState!==4&&f.abort();else{h=f.status;t=f.getAllResponseHeaders();l={};if((n=f.responseXML)&&n.documentElement)l.xml=n;try{l.text=f.responseText}catch(z){}try{k=f.statusText}catch(p){k=
""}!h&&b.isLocal&&!b.crossDomain?h=l.text?200:404:h===1223&&(h=204)}}}catch(o){e||j(-1,o)}l&&j(h,k,l,t)};if(!b.async||f.readyState===4)d();else{g=++yb;if(Da){if(!ja){ja={};i(a).unload(Da)}ja[g]=d}f.onreadystatechange=d}},abort:function(){d&&d(0,1)}}}});var ya={},ba,ha,zb=/^(?:toggle|show|hide)$/,Ab=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,ta,qa=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],pa;i.fn.extend({show:function(a,
...
{}}});i.fx.prototype={update:function(){this.options.step&&this.options.step.call(this.elem,this.now,this);(i.fx.step[this.prop]||i.fx.step._default)(this)},cur:function(){if(this.elem[this.prop]!=null&&(!this.elem.style||this.elem.style[this.prop]==null))return this.elem[this.prop];var a,b=i.css(this.elem,this.prop);return isNaN(a=parseFloat(b))?!b||b==="auto"?0:b:a},custom:function(a,b,d){function e(a){return j.step(a)}var j=this,f=i.fx;this.startTime=pa||y();this.end=b;this.now=this.start=a;this.pos=
...
d.from.height)*p.y,d.from.left=(r.width-d.from.width)*p.x,d.to.top=(r.height-d.to.height)*p.y,d.to.left=(r.width-d.to.width)*p.x);var m=d.from.height/r.height,x=d.from.width/r.width,q=d.to.height/r.height,B=d.to.width/r.width;if("box"==n||"both"==n)if(m!=q&&(f=f.concat(b),d.from=a.effects.setTransition(d,b,m,d.from),d.to=a.effects.setTransition(d,b,q,d.to)),x!=B)f=f.concat(k),d.from=a.effects.setTransition(d,k,x,d.from),d.to=a.effects.setTransition(d,k,B,d.to);if(("content"==n||"both"==n)&&m!=q)f=
f.concat(g),d.from=a.effects.setTransition(d,g,m,d.from),d.to=a.effects.setTransition(d,g,q,d.to);a.effects.save(d,o?f:e);d.show();a.effects.createWrapper(d);d.css("overflow","hidden").css(d.from);if("content"==n||"both"==n)b=b.concat(["marginTop","marginBottom"]).concat(g),k=k.concat(["marginLeft","marginRight"]),h=f.concat(b).concat(k),d.find("*[width]").each(function(){var d=a(this);o&&a.effects.save(d,h);var e=d.height(),f=d.width();d.from={height:e*m,width:f*x};d.to={height:e*q,width:f*B};if(m!=
q){d.from=a.effects.setTransition(d,b,m,d.from);d.to=a.effects.setTransition(d,b,q,d.to)}if(x!=B){d.from=a.effects.setTransition(d,k,x,d.from);d.to=a.effects.setTransition(d,k,B,d.to)}d.css(d.from);d.animate(d.to,c.duration,c.options.easing,function(){o&&a.effects.restore(d,h)})});d.animate(d.to,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){d.to.opacity===0&&d.css("opacity",d.from.opacity);l=="hide"&&d.hide();a.effects.restore(d,o?f:e);a.effects.removeWrapper(d);c.callback&&
...
b.charAt(Q))throw"Unexpected literal at position "+D;D++},D=0,Q=0;Q<b.length;Q++)if(A)"'"==b.charAt(Q)&&!C("'")?A=!1:G();else switch(b.charAt(Q)){case "d":q=w("d");break;case "D":y("D",f,g);break;case "o":B=w("o");break;case "m":x=w("m");break;case "M":x=y("M",h,m);break;case "y":d=w("y");break;case "@":var L=new Date(w("@")),d=L.getFullYear(),x=L.getMonth()+1,q=L.getDate();break;case "!":L=new Date((w("!")-this._ticksTo1970)/1E4);d=L.getFullYear();x=L.getMonth()+1;q=L.getDate();break;case "'":C("'")?
G():A=!0;break;default:G()}if(D<c.length)throw"Extra/unparsed characters found in date: "+c.substring(D);-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-(new Date).getFullYear()%100+(d<=e?0:-100));if(-1<B){x=1;q=B;do{e=this._getDaysInMonth(d,x-1);if(q<=e)break;x++;q-=e}while(1)}L=this._daylightSavingAdjust(new Date(d,x-1,q));if(L.getFullYear()!=d||L.getMonth()+1!=x||L.getDate()!=q)throw"Invalid date";return L},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",
...
c.getMonth(),c.getDate())),d=this._get(b,"isRTL"),e=this._get(b,"showButtonPanel"),f=this._get(b,"hideIfNoPrevNext"),g=this._get(b,"navigationAsDateFormat"),m=this._getNumberOfMonths(b),v=this._get(b,"showCurrentAtPos"),x=this._get(b,"stepMonths"),q=1!=m[0]||1!=m[1],B=this._daylightSavingAdjust(!b.currentDay?new Date(9999,9,9):new Date(b.currentYear,b.currentMonth,b.currentDay)),A=this._getMinMaxDate(b,"min"),w=this._getMinMaxDate(b,"max"),v=b.drawMonth-v,F=b.drawYear;0>v&&(v+=12,F--);if(w)for(var y=
this._daylightSavingAdjust(new Date(w.getFullYear(),w.getMonth()-m[0]*m[1]+1,w.getDate())),y=A&&y<A?A:y;this._daylightSavingAdjust(new Date(F,v,1))>y;)v--,0>v&&(v=11,F--);b.drawMonth=v;b.drawYear=F;var y=this._get(b,"prevText"),y=!g?y:this.formatDate(y,this._daylightSavingAdjust(new Date(F,v-x,1)),this._getFormatConfig(b)),y=this._canAdjustMonth(b,-1,F,v)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+h+".datepicker._adjustDate('#"+b.id+"', -"+x+", 'M');\" title=\""+y+'"><span class="ui-icon ui-icon-circle-triangle-'+
(d?"e":"w")+'">'+y+"</span></a>":f?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+y+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+y+"</span></a>",G=this._get(b,"nextText"),G=!g?G:this.formatDate(G,this._daylightSavingAdjust(new Date(F,v+x,1)),this._getFormatConfig(b)),f=this._canAdjustMonth(b,1,F,v)?'<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'+h+".datepicker._adjustDate('#"+b.id+"', +"+x+", 'M');\" title=\""+G+'"><span class="ui-icon ui-icon-circle-triangle-'+
(d?"w":"e")+'">'+G+"</span></a>":f?"":'<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+G+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+G+"</span></a>",x=this._get(b,"currentText"),G=this._get(b,"gotoCurrent")&&b.currentDay?B:c,x=!g?x:this.formatDate(x,G,this._getFormatConfig(b)),g=!b.inline?'<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_'+h+'.datepicker._hideDatepicker();">'+this._get(b,
"closeText")+"</button>":"",e=e?'<div class="ui-datepicker-buttonpane ui-widget-content">'+(d?g:"")+(this._isInRange(b,G)?'<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_'+h+".datepicker._gotoToday('#"+b.id+"');\">"+x+"</button>":"")+(d?"":g)+"</div>":"",g=parseInt(this._get(b,"firstDay"),10),g=isNaN(g)?0:g,x=this._get(b,"showWeek"),G=this._get(b,"dayNames");this._get(b,"dayNamesShort");var D=this._get(b,"dayNamesMin"),Q=
this._get(b,"monthNames"),L=this._get(b,"monthNamesShort"),u=this._get(b,"beforeShowDay"),W=this._get(b,"showOtherMonths"),N=this._get(b,"selectOtherMonths");this._get(b,"calculateWeek");for(var i=this._getDefaultDate(b),U="",I=0;I<m[0];I++){var s="";this.maxRows=4;for(var R=0;R<m[1];R++){var P=this._daylightSavingAdjust(new Date(F,v,b.selectedDay)),J=" ui-corner-all",H="";if(q){H+='<div class="ui-datepicker-group';if(1<m[1])switch(R){case 0:H+=" ui-datepicker-group-first";J=" ui-corner-"+(d?"right":
"left");break;case m[1]-1:H+=" ui-datepicker-group-last";J=" ui-corner-"+(d?"left":"right");break;default:H+=" ui-datepicker-group-middle",J=""}H+='">'}for(var H=H+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+J+'">'+(/all|left/.test(J)&&0==I?d?f:y:"")+(/all|right/.test(J)&&0==I?d?y:f:"")+this._generateMonthYearHeader(b,v,F,A,w,0<I||0<R,Q,L)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),O=x?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":
"",J=0;7>J;J++)var M=(J+g)%7,O=O+("<th"+(5<=(J+g+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+G[M]+'">'+D[M]+"</span></th>");H+=O+"</tr></thead><tbody>";O=this._getDaysInMonth(F,v);F==b.selectedYear&&v==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,O));J=(this._getFirstDayOfMonth(F,v)-g+7)%7;O=Math.ceil((J+O)/7);this.maxRows=O=q?this.maxRows>O?this.maxRows:O:O;for(var M=this._daylightSavingAdjust(new Date(F,v,1-J)),X=0;X<O;X++){for(var H=H+"<tr>",Y=!x?"":'<td class="ui-datepicker-week-col">'+
this._get(b,"calculateWeek")(M)+"</td>",J=0;7>J;J++){var S=u?u.apply(b.input?b.input[0]:null,[M]):[!0,""],j=M.getMonth()!=v,t=j&&!N||!S[0]||A&&M<A||w&&M>w,Y=Y+('<td class="'+(5<=(J+g+6)%7?" ui-datepicker-week-end":"")+(j?" ui-datepicker-other-month":"")+(M.getTime()==P.getTime()&&v==b.selectedMonth&&b._keyEvent||i.getTime()==M.getTime()&&i.getTime()==P.getTime()?" "+this._dayOverClass:"")+(t?" "+this._unselectableClass+" ui-state-disabled":"")+(j&&!W?"":" "+S[1]+(M.getTime()==B.getTime()?" "+this._currentClass:
"")+(M.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!j||W)&&S[2]?' title="'+S[2]+'"':"")+(t?"":' onclick="DP_jQuery_'+h+".datepicker._selectDay('#"+b.id+"',"+M.getMonth()+","+M.getFullYear()+', this);return false;"')+">"+(j&&!W?"&#xa0;":t?'<span class="ui-state-default">'+M.getDate()+"</span>":'<a class="ui-state-default'+(M.getTime()==c.getTime()?" ui-state-highlight":"")+(M.getTime()==B.getTime()?" ui-state-active":"")+(j?" ui-priority-secondary":"")+'" href="#">'+M.getDate()+"</a>")+
"</td>");M.setDate(M.getDate()+1);M=this._daylightSavingAdjust(M)}H+=Y+"</tr>"}v++;11<v&&(v=0,F++);H+="</tbody></table>"+(q?"</div>"+(0<m[0]&&R==m[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");s+=H}U+=s}U+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return U},_generateMonthYearHeader:function(a,c,d,e,f,g,m,v){var x=this._get(a,"changeMonth"),q=this._get(a,"changeYear"),
w=this._get(a,"showMonthAfterYear"),A='<div class="ui-datepicker-title">',C="";if(g||!x)C+='<span class="ui-datepicker-month">'+m[c]+"</span>";else{for(var m=e&&e.getFullYear()==d,F=f&&f.getFullYear()==d,C=C+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+h+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),y=0;12>y;y++)if((!m||y>=e.getMonth())&&(!F||y<=f.getMonth()))C+='<option value="'+y+'"'+(y==c?' selected="selected"':"")+">"+v[y]+"</option>";C+="</select>"}w||(A+=C+(g||
!x||!q?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",g||!q)A+='<span class="ui-datepicker-year">'+d+"</span>";else{var v=this._get(a,"yearRange").split(":"),G=(new Date).getFullYear(),m=function(a){a=a.match(/c[+-].*/)?d+parseInt(a.substring(1),10):a.match(/[+-].*/)?G+parseInt(a,10):parseInt(a,10);return isNaN(a)?G:a},c=m(v[0]),v=Math.max(c,m(v[1]||"")),c=e?Math.max(c,e.getFullYear()):c,v=f?Math.min(v,f.getFullYear()):v;for(a.yearshtml+='<select class="ui-datepicker-year" onchange="DP_jQuery_'+
...
(parseInt(a.curCSS(this,"marginRight",true))||0),w=d+h+(parseInt(a.curCSS(this,"marginBottom",true))||0),y=a.extend({},r),G;if(g.my[0]==="right")y.left=y.left-c;else if(g.my[0]==="center")y.left=y.left-c/2;if(g.my[1]==="bottom")y.top=y.top-d;else if(g.my[1]==="center")y.top=y.top-d/2;if(!f){y.left=Math.round(y.left);y.top=Math.round(y.top)}G={left:y.left-e,top:y.top-h};a.each(["left","top"],function(b,e){if(a.ui.position[l[b]])a.ui.position[l[b]][e](y,{targetWidth:n,targetHeight:m,elemWidth:c,elemHeight:d,
collisionPosition:G,collisionWidth:k,collisionHeight:w,offset:o,my:g.my,at:g.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(y,{using:g.using}))})};a.ui.position={fit:{left:function(c,b){var d=a(m),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft();c.left=0<d?c.left-d:Math.max(c.left-b.collisionPosition.left,c.left)},top:function(c,b){var d=a(m),d=b.collisionPosition.top+b.collisionHeight-d.height()-d.scrollTop();c.top=0<d?c.top-d:Math.max(c.top-b.collisionPosition.top,c.top)}},
...
var g=a("#elRaptor").css({position:"fixed",bottom:"-700px",right:"0",display:"block"});if("timer"==c.enterOn)setTimeout(d,c.delayTime);else if("click"==c.enterOn)f.bind("click",function(a){a.preventDefault();h||d()});else if("konami-code"==c.enterOn){var b=[];a(m).bind("keydown.raptorz",function(c){b.push(c.keyCode);0<=b.toString().indexOf("38,38,40,40,37,39,37,39,66,65")&&(d(),a(m).unbind("keydown.raptorz"))},!0)}})}})(w);(function(a,c,d,f){function e(a,b,c){O[a]=c;M[a]=b;H||(H=a)}function h(b){H!==
b&&(H=b,a.ui.editor.eachInstance(function(){this.reinit()}))}function g(a,b){H&&O[H]&&O[H][a]&&(a=O[H][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function b(b){if(X===f){X=!0;if(Y=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(b.options.baseClass+"-ios"),Y&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height","-=1")},0)});a.browser.mozilla&&a("html").addClass(b.options.baseClass+"-ff");
if(a.browser.msie&&9>a.browser.version){X=!1;var c=a("<div/>").addClass(b.options.baseClass+"-unsupported").html(b.getTemplate("unsupported")).appendTo("body");k(c);c.find("."+b.options.baseClass+"-unsupported-close").click(function(){c.remove()})}}return X}function k(b){var c=1;b.siblings().each(function(){var b=a(this).css("z-index");!isNaN(b)&&b>c&&(c=b+1)});b.css("z-index",c)}function l(a){return a.clone().wrap("<div/>").parent().html()}function m(a){var b,a=document.createElement(a);b="getComputedStyle"in
...
c.deleteContents();d.length===f||1===d.length?c.insertNode(d[0].cloneNode(!0)):a.each(d,function(a,b){c.insertNodeAtEnd(b.cloneNode(!0))})}function v(b){var b=b||d.getSelection(),c;a(b.getAllRanges()).each(function(b,d){c=3===this.commonAncestorContainer.nodeType?a(d.commonAncestorContainer).parent()[0]:d.commonAncestorContainer});return c}function x(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer}function q(a){if(!S||a)S=d.saveSelection()}function B(){S&&(d.restoreSelection(S),
S=!1)}function A(){S&&d.removeMarkers(S);S=!1}function C(a,b,c){for(var b=b||d.getSelection(),e,f=0;e=b.getAllRanges()[f++];)a.call(c,e)}function F(a,b){C(function(b){r(a,b)},b,this)}function y(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).focus().contents().each(function(){var a=d.createRange();a.selectNodeContents(this);c.addRange(a)})}function G(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNode(this);c.addRange(a)}).focus()}function D(b,
c,e){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNodeContents(this);a.collapse(e);c.addRange(a)})}function Q(a,b){D(a,b,!1)}function L(a,b){D(a,b,!0)}function u(a){a=a||d.getSelection();return a.toHtml()}function W(b){b=b||d.getSelection().getRangeAt(0);return a(3===b.commonAncestorContainer.nodeType?b.commonAncestorContainer.parentNode:b.commonAncestorContainer)}function N(a){var b=new w;C(function(a){b.push(W(a)[0])},a,this);return b}function i(){var b=
d.getSelection();if(null===b.anchorNode)return null;if(b.isBackwards())return 3===b.focusNode.nodeType?a(b.focusNode.parentElement):a(b.focusNode);b.anchorNode||console.trace();return 3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode)}function U(){var b=d.getSelection();return null===b.anchorNode?null:b.isBackwards()?3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode):3===b.focusNode.nodeType?a(b.focusNode.parentElement):a(b.focusNode)}function I(b,c){var c=
c||{},e=d.createCssClassApplier(c.classes||"",{normalize:!0,elementTagName:b,elementProperties:c.attributes||{}});C(function(d){var f=d.cloneContents(),f=p(f);"string"===typeof f&&(f=f.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));a(f).is(":empty")?(f=a("<"+b+"/>").addClass(c.classes).attr(c.attributes||{}).append(p(d.cloneContents())),r(f,d)):e.toggleRange(d)},null,this)}function s(a,b,c){C(function(d){d=W(d);d.is(a)?d.attr(b):I(a,{classes:c,attributes:b})},null,this)}function R(b,c){var c=
c||d.getSelection(),e=c.getRangeAt(0),f=N()[0],g=d.createRange();g.setStartBefore(f);g.setEnd(e.startContainer,e.startOffset);var g=g.cloneContents(),h=d.createRange();h.setStart(e.endContainer,e.endOffset);h.setEndAfter(f);e=h.cloneContents();g=l(a(p(g)));g+=l(a(b));g+=l(a(p(e)));a(f).replaceWith(a(g))}function P(a,b,c){var c=c||d.getSelection(),e=i()[0],f=U()[0],g=N()[0],g=n(g,b),e=n(e,b),b=n(f,b);g&&e&&b?F(a):R(a,c)}function J(a,b){allowed=[];for(var c=0;c<b.length;c++)b[c].match(/[a-z][a-z0-9]{0,}/g)&&
allowed.push(b[c]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,b){return-1<allowed.indexOf(b.toLowerCase())?a:""})}var H=null,O={},M={};a(function(){d.initialized||d.init();a.isFunction(d.rangePrototype.insertNodeAtEnd)||(d.rangePrototype.insertNodeAtEnd=function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});a("html").click(function(){a(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});
...
!1),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,this.ready=!0,this.fire("ready"),this.options.autoEnable&&a(function(){c.enableEditing();c.showToolbar()}))},attach:function(){this.bind("change",this.historyPush);this.bind("selectionChange",this.updateTagTree);this.bind("show",this.updateTagTree);var b=a.proxy(this.checkChange,this);this.getElement().find("img").bind("click."+this.widgetName,a.proxy(function(a){G(a.target)},this));this.getElement().bind("mouseup."+
...
(this.enabled=!1,this.getElement().attr("contenteditable",!1).removeClass(this.options.baseClass+"-editing"),d.getSelection().removeAllRanges(),this.fire("disabled"))},isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var b=this,c="",d=[],e=0;C(function(f){var f=f.commonAncestorContainer,g;g=3===f.nodeType?a(f).parent():a(f);f=[];for(d.push(f);g[0]&&!b.isRoot(g)&&"body"!==g[0].tagName.toLowerCase();)f.push(g),g=g.parent();f.reverse();c&&(c+=" | ");c+=this.getTemplate("root");
for(g=0;g<f.length;g++)c+=this.getTemplate("tag",{element:f[g][0].tagName.toLowerCase(),data:"["+e+","+g+"]"});e++},null,this);c||(c=this.getTemplate("root"));this.path.html(c).find("a").click(function(){var c=a(this).data("ui-editor-selection");c?(G(d[c[0]][c[1]]),b.updateTagTree()):G(b.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(b){return this.getElement()[0]===a(b)[0]},unify:function(b,c){!1!==c&&b(this);if(this.options.unify)for(var d=a.ui.editor.getInstances(),e=0;e<d.length;e++)d[e]!==
...
this.title).val(b);d.classes&&this.button.addClass(d.classes);this.button.bind("mousedown."+e.editor.widgetName,function(a){a.preventDefault()});var j=this;this.button.bind("mouseup."+e.editor.widgetName,function(a){a.preventDefault();j.click.apply(e,arguments)});c.bind("destroy",a.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+f},disabled:d.disabled?!0:!1,text:this.text||!1,label:this.label||null});this.ready.call(e);return this.button},
...
f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?g.nodeValue:a(g).html())&&a("<"+d+"/>").html(a.trim(g)).insertBefore(c)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},rangeGetCommonAncestor:v,rangeIsEmpty:x,selectionSave:q,selectionRestore:B,selectionDestroy:A,selectionEachRange:C,selectionReplace:F,selectionSelectInner:y,selectionSelectOuter:G,selectionSelectEdge:D,selectionSelectEnd:Q,selectionSelectStart:L,selectionGetHtml:u,selectionGetElements:N,
selectionToggleWrapper:I,selectionExists:function(a){var b=!1;C(function(a){x(a)||(b=!0)},a,this);return b},selectionReplaceSplittingSelectedElement:R,selectionReplaceWithinValidTags:P,stringStripTags:J,defaults:{plugins:{},ui:{},bind:{},domTools:{constrainSelection:function(b,c){var b=a(b)[0],c=c||d.getSelection(),e;a(c.getAllRanges()).each(function(d,f){e=3===this.commonAncestorContainer.nodeType?a(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;b!==e&&!a.contains(b,e)&&c.removeRange(f)})},
unwrapParentTag:function(b){N().each(function(){a(this).is(b)&&a(this).replaceWith(a(this).html())})},execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(d){}},insertTag:function(b,c){C(function(c){c.insertNode(a("<"+b+"/>")[0])},c,this)},insertTagAtEnd:function(b,c){C(function(c){c.insertNodeAtEnd(a("<"+b+"/>")[0])},c,this)},insertElement:function(b,c,d){C(function(d){a(b).each(function(){d.insertNode(!1===c?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(b,c,d){C(function(d){a(b).each(function(){d.insertNodeAtEnd(!1===
...
persist:function(a,b,c){a=c?c+"."+a:a;if(localStorage){c=localStorage.uiWidgetEditor?JSON.parse(localStorage.uiWidgetEditor):{};if(b===f)return c[a];c[a]=b;localStorage.uiWidgetEditor=JSON.stringify(c)}return b}});var X,Y;a.ui.editor.registerUi({alignLeft:{init:function(a){return a.uiButton({title:g("Left Align"),click:function(){a.toggleBlockStyle({"text-align":"left"},a.getElement())}})}},alignJustify:{init:function(a){return a.uiButton({title:g("Justify"),click:function(){a.toggleBlockStyle({"text-align":"justify"},
a.getElement())}})}},alignCenter:{init:function(a){return a.uiButton({title:g("Center Align"),click:function(){a.toggleBlockStyle({"text-align":"center"},a.getElement())}})}},alignRight:{init:function(a){return a.uiButton({title:g("Right Align"),click:function(){a.toggleBlockStyle({"text-align":"right"},a.getElement())}})}}});a.ui.editor.registerUi({textBold:{hotkeys:{"ctrl+b":{action:function(){this.ui.click()}}},init:function(a,b){return this.editor.uiButton({title:g("Bold"),click:function(){I("strong",
{classes:b.classes||b.cssPrefix+"bold"})}})}},textItalic:{hotkeys:{"ctrl+i":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:g("Italic"),click:function(){I("em",{classes:b.classes||b.cssPrefix+"italic"})}})}},textUnderline:{hotkeys:{"ctrl+u":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:g("Underline"),click:function(){I("u",{classes:b.classes||b.cssPrefix+"underline"})}})}},textStrike:{hotkeys:{"ctrl+k":{action:function(){this.ui.click()}}},
init:function(a,b){return a.uiButton({title:g("Strikethrough"),click:function(){I("del",{classes:b.classes||b.cssPrefix+"strike"})}})}},textSub:{init:function(a,b){return a.uiButton({title:g("Sub script"),click:function(){I("sub",{classes:b.classes||b.cssPrefix+"sub"})}})}},textSuper:{init:function(a,b){return a.uiButton({title:g("Super script"),click:function(){I("sup",{classes:b.classes||b.cssPrefix+"super"})}})}}});a.ui.editor.registerUi({quoteBlock:{init:function(a,b){return a.uiButton({title:g("Blockquote"),
...
show:function(){if(!this.dialog){a(this.ui.button).button("option","disabled",!0);var b=this;q();this.dialog=a(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:g("Paste Embed Code"),autoOpen:!0,dialogClass:b.options.baseClass+" "+b.options.dialogClass,buttons:[{text:g("Embed Object"),click:function(){B();F(a(this).find("textarea").val());a(this).dialog("close")}},{text:g("Close"),click:function(){b.hide()}}],open:function(){var b=a(this).parent().find(".ui-dialog-buttonpane");
...
click:function(){F("<hr/>")}})}}});a.ui.editor.registerUi({i18n:{init:function(b){var c=this,d=this.persist("locale");d&&h(d);var d=a('<select autocomplete="off" name="i18n"/>'),e;for(e in O){var f=a('<option value="'+e+'" class="'+e+'"/>');f.html(M[e]);H===e&&f.attr("selected","selected");d.append(f)}return b.uiSelectMenu({title:g("Change Language"),select:d,change:function(a){h(c.persist("locale",a))}})}}});e("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.",
...
a.isArray(b)||(b=[b]);for(var c=0;c<b.length;c++)this.editor.getElement().find("img."+b[c]).removeClass(b[c])},manuallyResizeImage:function(b){this.removeToolsButtons();var c=this.editor.getElement().find("img."+this.options.manuallyResizingClass),d=a(c).innerWidth(),e=a(c).innerHeight(),f="#"+this.options.baseClass+"-width",h="#"+this.options.baseClass+"-height",i=this,k=function(b){b=Math.round(b||a(f).val())+"px";a(c).css({width:b})},l=a(this.editor.getTemplate("imageresize.manually-resize-image",
{width:d,height:e,baseClass:this.options.baseClass}));l.dialog({modal:!0,resizable:!1,title:g("Modify Image Size"),autoOpen:!0,buttons:[{text:g("Resize Image"),click:function(){k(a(this).find(f).val());a(this).dialog("close")}},{text:g("Cancel"),click:function(){k(d);a(this).dialog("close")}}],close:function(){i.editor.checkChange();a(l).remove()},open:function(){var b=a(this).find(f),c=a(this).find(h);b.keyup(function(){c.val(Math.round(Math.abs(e/d*a(this).val())));k()});c.keyup(function(){b.val(Math.round(Math.abs(d/
e*a(this).val())));k()})}});b.preventDefault();return!1},displayToolsButtonRelativeToImage:function(b){var c=a("<button>"+g("Click to edit the image")+"</button>").appendTo("body").addClass(this.options.resizeButtonClass).button({text:!1,icons:{primary:"ui-icon-tools"}});c.css({position:"absolute",left:a(b).position().left+a(b).innerWidth()-a(c).outerWidth()-10+"px",top:a(b).position().top+10+"px"}).attr("contenteditable",!1).click(a.proxy(this.manuallyResizeImage,this));c.addClass(this.editor.options.supplementaryClass).find("span").addClass(this.editor.options.supplementaryClass);
...
options:{length:150},init:function(b){b.bind("show",a.proxy(this.updateCount,this));b.bind("change",a.proxy(this.updateCount,this));return this.ui=this.editor.uiButton({title:g("Remaining characters before the recommended character limit is reached"),label:g("Initializing"),text:!0,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var b=this.options.length-a("<div/>").html(this.editor.getCleanHtml()).text().length,c=this.ui.button,d=null,d=0<=b?g("{{charactersRemaining}} characters remaining",
{charactersRemaining:b}):g("{{charactersRemaining}} characters over limit",{charactersRemaining:-1*b});c.button("option","label",d);c.button("option","text",!0);0>b?c.addClass("ui-state-error"):0<=b&&15>=b?c.addClass("ui-state-highlight").removeClass("ui-state-error"):c.removeClass("ui-state-highlight ui-state-error")},showStatistics:function(){this.processTemplate().dialog({modal:!0,resizable:!1,title:g("Content Statistics"),dialogClass:this.editor.options.dialogClass+" "+this.editor.options.baseClass,
show:this.editor.options.dialogShowAnimation,hide:this.editor.options.dialogHideAnimation,buttons:[{text:g("OK"),click:function(){a(this).dialog("close")}}],open:function(){a(this).parent().find(".ui-dialog-buttonpane").find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}})},close:function(){a(this).dialog("destroy").remove()}})},processTemplate:function(){var b=a("<div/>").html(this.editor.getCleanHtml()).text(),c=null,d=this.options.length-b.length,c=0>d?g("Content contains more than {{limit}} characters and may be truncated",
{limit:this.options.length}):g("Content will not be truncated"),e=null,e=b.split(" ").length,e=1==e?g("{{words}} word",{words:e}):g("{{words}} words",{words:e}),f=null,f=b.split(". ").length,f=g("{{sentences}} sentences",{sentences:f}),h=null,h=0<=d?g("{{characters}} characters, {{charactersRemaining}} remaining",{characters:b.length,charactersRemaining:d}):g("{{characters}} characters, {{charactersRemaining}} over the recommended limit",{characters:b.length,charactersRemaining:-1*d});return a(this.editor.getTemplate("length.dialog",
{characters:h,words:e,sentences:f,truncation:c}))}}});a.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:g("Page on this or another website"),focusSelector:'input[name="location"]',init:function(){this.content=this.plugin.editor.getTemplate("link.external",this.options);return this},show:function(a,b){var c=this;a.find('input[name="location"]').bind("keyup",function(){c.validate(a)});b&&(a.find('input[name="location"]').val(this.plugin.selectedElement.attr("href")).trigger("keyup"),
"_blank"===this.plugin.selectedElement.attr("target")&&a.find('input[name="blank"]').attr("checked","checked"));return this},attributes:function(a){var b={href:a.find('input[name="location"]').val()};a.find('input[name="blank"]').is(":checked")&&(b.target="_blank");this.options.regexLink.test(b.href)||this.plugin.editor.showWarning(g("The url for the link you inserted doesn't look well formed"));return b},validate:function(b){var c="."+this.options.baseClass+"-error-message-url",d=!0;this.options.regexLink.test(b.find('input[name="location"]').val())?
...
dialogClass:c.baseClass+" "+c.dialogClass,buttons:[{text:b?g("Update Link"):g("Insert Link"),click:function(){B();d.apply(b)&&a(this).dialog("close")}},{text:g("Cancel"),click:function(){a(this).dialog("close")}}],beforeopen:function(){d.dialog.find("."+d.options.baseClass+"-content").hide()},open:function(){d.visible=!0;var c=e.parent().find(".ui-dialog-buttonpane");c.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});c.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});
...
d.options.baseClass+"-content")))&&c.find("button:eq(0)").trigger("click"))})},close:function(){B();d.visible=!1;e.find("."+c.baseClass+"-content").hide();a(this).dialog("destroy")}}).dialog("open")}},apply:function(b){var c=this.types[this.dialog.find('input[type="radio"]:checked').val()],d=c.attributes(this.dialog.find("."+this.options.baseClass+"-content"),b);if(!d)return!0;B();var e=l(a("<a>"+(d.title?d.title:d.href)+"</a>").attr(a.extend({},d,{target:"_blank"})));b?(this.selectedElement[0].className=
this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(c.classes).attr(d),this.editor.showConfirm(g("Updated link: {{link}}",{link:e}))):(s("a",a.extend(d,{id:this.editor.getUniqueId()}),c.classes),this.editor.showConfirm(g("Added link: {{link}}",{link:e})),this.selectedElement=a("#"+d.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",d.href);G(this.selectedElement);q();return!0},typeChange:function(b,
...
this.change,this);return a.uiButton({title:g("Insert Link"),click:function(){a.getPlugin("link").show()}})},change:function(){N().length?this.ui.enable():this.ui.disable()}},unlink:{hotkeys:{"ctrl+shift+l":{action:function(){this.ui.click()},restoreSelection:!1}},init:function(a){a.bind("selectionChange",this.change,this);a.bind("show",this.change,this);return a.uiButton({title:g("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){N().is("a")?this.ui.enable():this.ui.disable()}}});
a.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),toggleList:function(b){a(N()).is("li")&&a(N()).parent().is(b)?this.unwrapList():this.wrapList(b);this.editor.fire("selectionChange");
this.editor.fire("change")},unwrapList:function(){q();var b=[],c=[],d=i(),e=U();b.push(a(d).html());c.push(d);if(a(d)[0]!==a(e)[0]){var f=d;do f=a(f).next(),b.push(a(f).html()),c.push(f);while(a(f)[0]!==a(e)[0])}f=0===a(d).prev().length;e=0===a(e).next().length;d=a(d).parent();for(listElementsIndex=0;listElementsIndex<c.length;listElementsIndex++)a(c[listElementsIndex]).remove();for(c=0;c<b.length;c++)d.parent().is("li")||(b[c]="<p>"+b[c]+"</p>");f&&e?(d.replaceWith(b.join("")),B(),b=N()[0],G(b)):
(f?a(d).before(b.join("")):e?a(d).after(b.join("")):R(b.join("")),B(),this.editor.checkChange())},wrapList:function(b){this.editor.constrainSelection(this.editor.getElement());""===a.trim(u())&&y(N());var c=a("<div>").html(u()),d=[],e=this;a(c).contents().each(function(){var b;b="block"===m(this.tagName)?J(a(this).html(),e.validChildren):J(l(a(this)),e.validChildren);b=a("<li>"+b+"</li>");""!==a.trim(b.text())&&d.push(l(b))});c=this.options.baseClass+"-selection";b="<"+b+' class="'+c+'">'+d.join("")+
"</"+b+">";B();var f=a(N()[0]).parent(),g=this.editor.getElement()[0];f===g||N()[0]===g?F(b):P(b,this.validParents);c=a(this.editor.getElement().find("."+c).removeClass(c));y(c.find("li:first")[0]);this.editor.checkChange()},toggleButtonState:function(b,c){var d=function(a){c.button.toggleClass("ui-state-highlight",a).toggleClass("ui-state-default",!a)},e=i();if(null===e||!e.length)e=this.editor.getElement();var f=U();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(a(e).is(b)&&
a(f).is(b)&&e===f)return d(!0);var g=a(e).parentsUntil(h,b).first()&&a(f).parentsUntil(h,b).first(),h="#"+this.editor.getElement().attr("id"),k=a(e).is(b+" > li")||a(e).parentsUntil(h,b+" > li").length,l=a(f).is(b+" > li")||a(f).parentsUntil(h,b+" > li").length;if(k&&l&&g){g=a(v());g.is(b)||(g=a(g).parentsUntil(h,b).first());h=g.find("ul, ol");if(!h.length)return d(!0);for(g=0;g<h.length;g++)if(a.contains(h[g],e)&&a.contains(h[g],f))return d(!1);return d(!0)}return d(!1)}});a.ui.editor.registerUi({listUnordered:{init:function(a){var b=
...
a(".uiWidgetEditorPasteBin").focus();c.setTimeout(function(){var c=a(".uiWidgetEditorPasteBin").html(),c=h.filterAttributes(c),c=h.filterChars(c),c=h.stripEmpty(c),c=h.stripAttributes(c),c=J(c,h.options.allowedTags),c={plain:a("<div/>").html(a(".uiWidgetEditorPasteBin").html()).text(),markup:c,html:a(".uiWidgetEditorPasteBin").html()};f=a(b.getTemplate("paste.dialog",c));a(f).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:d.dialogShowAnimation,hide:d.dialogHideAnimation,
dialogClass:d.baseClass+" "+d.dialogClass,buttons:[{text:g("Insert"),click:function(){var b=null,b=a(this).find(".ui-editor-paste-area:visible"),b=b.hasClass("ui-editor-paste-plain")||b.hasClass("ui-editor-paste-source")?b.val():b.html(),b=h.filterAttributes(b),b=h.filterChars(b);B();F(b);e=!1;a(this).dialog("close")}},{text:g("Cancel"),click:function(){B();e=!1;a(this).dialog("close")}}],open:function(){var b=a(this).find(".ui-editor-paste-panel-tabs");b.find("ul.ui-tabs-nav li").click(function(){b.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
...
init:function(b){b.bind("selectionChange",this.change,this);b.bind("show",this.change,this);return b.uiSelectMenu({name:"tagMenu",title:g("Change HTML tag of selected element"),select:a(b.getTemplate("tagmenu.menu")),change:function(c){if(!("undefined"===typeof c||"na"===c)){var d=b.getElement()[0],e=N();if(!u()||""===u()){if(a(e)[0]===a(d)[0])return;q();d=a("<"+c+">").html(e.html());e.replaceWith(d);B()}else{var e=a(N()[0]).parent(),f=this.options.baseClass+"-selection",c=a("<"+c+">").html(u()).addClass(f);
e===d||N()[0]===d?F(c):P(c,this.validParents);y(b.getElement().find("."+f).removeClass(f))}b.checkChange()}}})},change:function(){var b=N()[0];b?(b=b.tagName.toLowerCase(),this.ui.select.find("option[value="+b+"]").length?this.ui.val(b):this.ui.val("na"),a(this.ui.button).toggleClass("ui-state-disabled",this.editor.getElement()[0]===N()[0])):a(this.ui.button).toggleClass("ui-state-disabled",!0)}}});a.ui.editor.registerPlugin("toolbarTip",{init:function(){a.browser.msie||this.bind("show, tagTreeUpdated",
...
b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){a(this).dialog("destroy").remove();a(d).button("option","disabled",!1);b.editor.checkChange()}})}}});var S=!1})(w,m,rangy)})(window);
