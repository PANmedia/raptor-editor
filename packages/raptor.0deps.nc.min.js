...
n="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),p="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),r=c(m),u=c(w),x=c(a),q={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:m,isHostObject:w,isHostProperty:a,areHostMethods:r,areHostObjects:u,areHostProperties:x,isTextRange:d},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
...
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function r(a,b,c){this.nodes=l(a,b,c);this._next=this.nodes[0];this._position=0}function u(a){return function(b,c){for(var d,j=c?b:b.parentNode;j;){d=j.nodeType;if(s.arrayContains(a,d))return j;j=j.parentNode}return null}}function x(a,b){if(j(a,b))throw new p("INVALID_NODE_TYPE_ERR");}function q(a){if(!a.startContainer)throw new P("INVALID_STATE_ERR");}function B(a,b){if(!s.arrayContains(b,a.nodeType))throw new p("INVALID_NODE_TYPE_ERR");
}function A(a,b){if(0>b||b>(s.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new P("INDEX_SIZE_ERR");}function C(a,b){if(Y(a,!0)!==Y(b,!0))throw new P("WRONG_DOCUMENT_ERR");}function E(a){if(S(a,!0))throw new P("NO_MODIFICATION_ALLOWED_ERR");}function y(a,b){if(!a)throw new P(b);}function F(a){return!!a.startContainer&&!!a.endContainer&&!(!s.arrayContains(G,a.startContainer.nodeType)&&!Y(a.startContainer,!0))&&!(!s.arrayContains(G,a.endContainer.nodeType)&&!Y(a.endContainer,!0))&&a.startOffset<=
(s.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(s.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function D(a){q(a);if(!F(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function Q(){}function J(a){a.START_TO_START=V;a.START_TO_END=ca;a.END_TO_END=$;a.END_TO_START=ka;a.NODE_BEFORE=oa;a.NODE_AFTER=pa;a.NODE_BEFORE_AND_AFTER=la;a.NODE_INSIDE=
ma}function v(a){J(a);J(a.prototype)}function W(a,b){return function(){D(this);var c=this.startContainer,d=this.startOffset,j=this.commonAncestorContainer,e=new n(this,!0);c!==j&&(c=s.getClosestAncestorIn(c,j,!0),d=f(c),c=d.node,d=d.offset);g(e,E);e.reset();j=a(e);e.detach();b(this,c,d,c,d);return j}}function M(a,c,j){function g(a,b){return function(c){q(this);B(c,I);B(X(c),G);c=(a?d:f)(c);(b?e:i)(this,c.node,c.offset)}}function e(a,b,d){var j=a.endContainer,g=a.endOffset;if(b!==a.startContainer||
...
f=!this.collapsed);f?s.isCharacterDataNode(a)?0==b&&e(a):b<a.childNodes.length&&(g=a.childNodes[b])&&s.isCharacterDataNode(g)&&e(g):(a=d,b=j);c(this,a,b,d,j)},collapseToPoint:function(a,b){q(this);x(a,!0);A(a,b);(a!==this.startContainer||b!==this.startOffset||a!==this.endContainer||b!==this.endOffset)&&c(this,a,b,a,b)}});v(a)}function i(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:s.getCommonAncestor(a.startContainer,
a.endContainer)}function T(a,b,d,j,g){var e=a.startContainer!==b||a.startOffset!==d,f=a.endContainer!==j||a.endOffset!==g;a.startContainer=b;a.startOffset=d;a.endContainer=j;a.endOffset=g;i(a);c(a,"boundarychange",{startMoved:e,endMoved:f})}function H(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};i(this)}m.requireModules(["DomUtil"]);var s=m.dom,R=s.DomPosition,P=m.DOMException;n.prototype={_current:null,_next:null,_first:null,
...
detach:function(){this._current=this._next=this.nodes=null}};var I=[1,3,4,5,7,8,10],G=[2,9,11],O=[1,3,4,5,7,8,10,11],N=[1,3,4,5,7,8],X=s.getRootContainer,Y=u([9,11]),S=u([5,6,10,12]),j=u([6,10,12]),t=document.createElement("style"),z=!1;try{t.innerHTML="<b>x</b>",z=3==t.firstChild.nodeType}catch(K){}m.features.htmlParsingConforms=z;var U="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),V=0,ca=1,$=2,ka=3,oa=0,pa=1,la=2,ma=3;Q.prototype={attachListener:function(a,
b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){D(this);C(this.startContainer,b.startContainer);var c=a==ka||a==V?"start":"end",d=a==ca||a==V?"start":"end";return s.comparePoints(this[c+"Container"],this[c+"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){D(this);B(a,O);E(this.startContainer);if(s.isAncestorOf(a,this.startContainer,!0))throw new P("HIERARCHY_REQUEST_ERR");this.setStartBefore(e(a,this.startContainer,this.startOffset))},cloneContents:function(){D(this);
...
B.insertAfter(e,b)}return b==a?e:r(a,e.parentNode,B.getNodeIndex(e),d)}return a!=b?(e=b.parentNode,b=B.getNodeIndex(b),g||b++,r(a,e,b,d)):a}function u(a){var c=a?"nextSibling":"previousSibling";return function(d,e){var g=d.parentNode,h=d[c];if(h){if(h&&3==h.nodeType)return h}else if(e&&(h=g[c])&&1==h.nodeType&&g.tagName==h.tagName&&f(g,h)&&b(g,h))return h[a?"firstChild":"lastChild"];return null}}function x(a){this.firstTextNode=(this.isElementMerge=1==a.nodeType)?a.lastChild:a;this.textNodes=[this.firstTextNode]}
...
1==a.nodeType&&a.isContentEditable}:function(a){return!a||1!=a.nodeType||"false"==a.contentEditable?!1:"true"==a.contentEditable||E(a.parentNode)}})();var y=/^inline(-block|-table)?$/i,F=/[^\r\n\t\f \u200B]/,D=u(!1),Q=u(!0);x.prototype={doMerge:function(){for(var a=[],b,c,d=0,e=this.textNodes.length;d<e;++d)b=this.textNodes[d],c=b.parentNode,a[d]=b.data,d&&(c.removeChild(b),c.hasChildNodes()||c.parentNode.removeChild(c));return this.firstTextNode.data=a=a.join("")},getLength:function(){for(var a=
...
typeof b&&(c=b,b="*");if(i.isFunction(c))for(var d=b.toLowerCase().split(Ja),e=0,j=d.length,f,g;e<j;e++)f=d[e],(g=/^\+/.test(f))&&(f=f.substr(1)||"*"),f=a[f]=a[f]||[],f[g?"unshift":"push"](c)}}function m(a,b,d,e,j,f){j=j||b.dataTypes[0];f=f||{};f[j]=!0;for(var j=a[j],g=0,h=j?j.length:0,k=a===ya,i;g<h&&(k||!i);g++)i=j[g](b,d,e),"string"===typeof i&&(!k||f[i]?i=c:(b.dataTypes.unshift(i),i=m(a,b,d,e,i,f)));if((k||!i)&&!f["*"])i=m(a,b,d,e,"*",f);return i}function A(a,b){var d,e,j=i.ajaxSettings.flatOptions||
...
a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var v=a.document,W=a.navigator,M=a.location,i=function(){function b(){if(!d.isReady){try{v.documentElement.doScroll("left")}catch(a){setTimeout(b,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,f)},e=a.jQuery,j=a.$,f,g=/^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,h=/\S/,k=/^\s+/,i=/\s+$/,t=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,n=/^[\],:{}\s]*$/,l=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,z=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
p=/(?:^|:|,)(?:\s*\[)+/g,o=/(webkit)[ \/]([\w.]+)/,r=/(opera)(?:.*version)?[ \/]([\w.]+)/,u=/(msie) ([\w.]+)/,K=/(mozilla)(?:.*? rv:([\w.]+))?/,U=/-([a-z]|[0-9])/ig,x=/^-ms-/,q=function(a,b){return(b+"").toUpperCase()},m=W.userAgent,sa,ia,gb=Object.prototype.toString,V=Object.prototype.hasOwnProperty,Aa=Array.prototype.push,na=Array.prototype.slice,B=String.prototype.trim,s=Array.prototype.indexOf,A={};d.fn=d.prototype={constructor:d,init:function(a,b,e){var j;if(!a)return this;if(a.nodeType)return this.context=
...
slice:function(){return this.pushStack(na.apply(this,arguments),"slice",na.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:Aa,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,b,e,j,L,f=arguments[0]||{},g=1,h=arguments.length,k=!1;"boolean"===typeof f&&(k=f,f=arguments[1]||{},g=2);"object"!==typeof f&&!d.isFunction(f)&&
(f={});h===g&&(f=this,--g);for(;g<h;g++)if(null!=(a=arguments[g]))for(b in a)e=f[b],j=a[b],f!==j&&(k&&j&&(d.isPlainObject(j)||(L=d.isArray(j)))?(L?(L=!1,e=e&&d.isArray(e)?e:[]):e=e&&d.isPlainObject(e)?e:{},f[b]=d.extend(k,e,j)):j!==c&&(f[b]=j));return f};d.extend({noConflict:function(b){a.$===d&&(a.$=j);b&&a.jQuery===d&&(a.jQuery=e);return d},isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!v.body)return setTimeout(d.ready,
...
return e===c||V.call(a,e)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(n.test(b.replace(l,"@").replace(z,"]").replace(p,"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b){if("string"!==typeof b||!b)return null;var e,j;try{a.DOMParser?(j=new DOMParser,e=j.parseFromString(b,"text/xml")):(e=
new ActiveXObject("Microsoft.XMLDOM"),e.async="false",e.loadXML(b))}catch(L){e=c}(!e||!e.documentElement||e.getElementsByTagName("parsererror").length)&&d.error("Invalid XML: "+b);return e},noop:function(){},globalEval:function(b){b&&h.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(x,"ms-").replace(U,q)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,b,e){var j,L=0,f=a.length,g=f===c||d.isFunction(a);
if(e)if(g)for(j in a){if(!1===b.apply(a[j],e))break}else for(;L<f&&!1!==b.apply(a[L++],e););else if(g)for(j in a){if(!1===b.call(a[j],j,a[j]))break}else for(;L<f&&!1!==b.call(a[L],L,a[L++]););return a},trim:B?function(a){return null==a?"":B.call(a)}:function(a){return null==a?"":a.toString().replace(k,"").replace(i,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var e=d.type(a);null==a.length||"string"===e||"function"===e||"regexp"===e||d.isWindow(a)?Aa.call(c,a):d.merge(c,a)}return c},inArray:function(a,
...
h&&a[0]&&a[h-1]||0===h||d.isArray(a)))for(;g<h;g++)j=b(a[g],g,e),null!=j&&(f[f.length]=j);else for(L in a)j=b(a[L],L,e),null!=j&&(f[f.length]=j);return f.concat.apply([],f)},guid:1,proxy:function(a,b){if("string"===typeof b)var e=a[b],b=a,a=e;if(!d.isFunction(a))return c;var j=na.call(arguments,2),e=function(){return a.apply(b,j.concat(na.call(arguments)))};e.guid=a.guid=a.guid||e.guid||d.guid++;return e},access:function(a,b,e,j,L,f,g){var h,k=null==e,i=0,t=a.length;if(e&&"object"===typeof e){for(i in e)d.access(a,
b,i,e[i],1,f,j);L=1}else if(j!==c){h=g===c&&d.isFunction(j);k&&(h?(h=b,b=function(a,b,c){return h.call(d(a),c)}):(b.call(a,j),b=null));if(b)for(;i<t;i++)b(a[i],e,h?j.call(a[i],i,b(a[i],e)):j,g);L=1}return L?a:k?b.call(a):t?b(a[0],e):f},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=o.exec(a)||r.exec(a)||u.exec(a)||0>a.indexOf("compatible")&&K.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,
...
pixelMargin:!0};i.boxModel=b.boxModel="CSS1Compat"===v.compatMode;c.checked=!0;b.noCloneChecked=c.cloneNode(!0).checked;e.disabled=!0;b.optDisabled=!j.disabled;try{delete k.test}catch(t){b.deleteExpando=!1}!k.addEventListener&&k.attachEvent&&k.fireEvent&&(k.attachEvent("onclick",function(){b.noCloneEvent=!1}),k.cloneNode(!0).fireEvent("onclick"));c=v.createElement("input");c.value="t";c.setAttribute("type","radio");b.radioValue="t"===c.value;c.setAttribute("checked","checked");c.setAttribute("name",
...
{set:function(a,b){if(i.isArray(b))return a.checked=i.inArray(i(a).val(),b)>=0}})});var K=/^(?:textarea|input|select)$/i,U=/^([^\.]*)?(?:\.(.+))?$/,V=/(?:^|\s)hover(\.\S+)?\b/,ca=/^key/,$=/^(?:mouse|contextmenu)|click/,ka=/^(?:focusinfocus|focusoutblur)$/,oa=/^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/,pa=function(a){if(a=oa.exec(a)){a[1]=(a[1]||"").toLowerCase();a[3]=a[3]&&RegExp("(?:^|\\s)"+a[3]+"(?:\\s|$)")}return a},la=function(a){return i.event.special.hover?a:a.replace(V,"mouseenter$1 mouseleave$1")};
i.event={add:function(a,b,d,e,j){var f,g,h,k,t,n,l,z,p;if(!(a.nodeType===3||a.nodeType===8||!b||!d||!(f=i._data(a)))){if(d.handler){l=d;d=l.handler;j=l.selector}if(!d.guid)d.guid=i.guid++;h=f.events;if(!h)f.events=h={};g=f.handle;if(!g){f.handle=g=function(a){return typeof i!=="undefined"&&(!a||i.event.triggered!==a.type)?i.event.dispatch.apply(g.elem,arguments):c};g.elem=a}b=i.trim(la(b)).split(" ");for(f=0;f<b.length;f++){k=U.exec(b[f])||[];t=k[1];n=(k[2]||"").split(".").sort();p=i.event.special[t]||
{};t=(j?p.delegateType:p.bindType)||t;p=i.event.special[t]||{};k=i.extend({type:t,origType:k[1],data:e,handler:d,guid:d.guid,selector:j,quick:j&&pa(j),namespace:n.join(".")},l);z=h[t];if(!z){z=h[t]=[];z.delegateCount=0;if(!p.setup||p.setup.call(a,e,n,g)===false)a.addEventListener?a.addEventListener(t,g,false):a.attachEvent&&a.attachEvent("on"+t,g)}if(p.add){p.add.call(a,k);if(!k.handler.guid)k.handler.guid=d.guid}j?z.splice(z.delegateCount++,0,k):z.push(k);i.event.global[t]=true}a=null}},global:{},
remove:function(a,b,c,d,e){var j=i.hasData(a)&&i._data(a),f,g,h,k,t,n,l,z,p,o;if(j&&(l=j.events)){b=i.trim(la(b||"")).split(" ");for(f=0;f<b.length;f++){g=U.exec(b[f])||[];h=k=g[1];g=g[2];if(h){z=i.event.special[h]||{};h=(d?z.delegateType:z.bindType)||h;p=l[h]||[];t=p.length;g=g?RegExp("(^|\\.)"+g.split(".").sort().join("\\.(?:.*\\.)?")+"(\\.|$)"):null;for(n=0;n<p.length;n++){o=p[n];if((e||k===o.origType)&&(!c||c.guid===o.guid)&&(!g||g.test(o.namespace))&&(!d||d===o.selector||d==="**"&&o.selector)){p.splice(n--,
...
a.isTrigger||b.type!=="radio"&&b.type!=="checkbox")return a.handleObj.handler.apply(this,arguments)},teardown:function(){i.event.remove(this,"._change");return K.test(this.nodeName)}});i.support.focusinBubbles||i.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){i.event.simulate(b,a.target,i.event.fix(a),true)};i.event.special[b]={setup:function(){c++===0&&v.addEventListener(a,d,true)},teardown:function(){--c===0&&v.removeEventListener(a,d,true)}}});i.fn.extend({on:function(a,
...
var l=function(a,b,c,e){var c=c||[],j=b=b||v;if(b.nodeType!==1&&b.nodeType!==9)return[];if(!a||typeof a!=="string")return c;var g,h,k,i,t,n=true,L=l.isXML(b),z=[],r=a;do{d.exec("");if(g=d.exec(r)){r=g[3];z.push(g[1]);if(g[2]){i=g[3];break}}}while(g);if(z.length>1&&o.exec(a))if(z.length===2&&p.relative[z[0]])h=m(z[0]+z[1],b,e);else for(h=p.relative[z[0]]?[b]:l(z.shift(),b);z.length;){a=z.shift();p.relative[a]&&(a=a+z.shift());h=m(a,h,e)}else{if(!e&&z.length>1&&b.nodeType===9&&!L&&p.match.ID.test(z[0])&&
!p.match.ID.test(z[z.length-1])){g=l.find(z.shift(),b,L);b=g.expr?l.filter(g.expr,g.set)[0]:g.set[0]}if(b){g=e?{expr:z.pop(),set:u(e)}:l.find(z.pop(),z.length===1&&(z[0]==="~"||z[0]==="+")&&b.parentNode?b.parentNode:b,L);h=g.expr?l.filter(g.expr,g.set):g.set;for(z.length>0?k=u(h):n=false;z.length;){g=t=z.pop();p.relative[t]?g=z.pop():t="";g==null&&(g=b);p.relative[t](k,g,L)}}else k=[]}k||(k=h);k||l.error(t||a);if(f.call(k)==="[object Array]")if(n)if(b&&b.nodeType===1)for(a=0;k[a]!=null;a++)k[a]&&
(k[a]===true||k[a].nodeType===1&&l.contains(b,k[a]))&&c.push(h[a]);else for(a=0;k[a]!=null;a++)k[a]&&k[a].nodeType===1&&c.push(h[a]);else c.push.apply(c,k);else u(k,c);if(i){l(i,j,c,e);l.uniqueSort(c)}return c};l.uniqueSort=function(a){if(x){g=h;a.sort(x);if(g)for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1)}return a};l.matches=function(a,b){return l(a,null,null,b)};l.matchesSelector=function(a,b){return l(b,null,null,[a]).length>0};l.find=function(a,b,c){var d,e,j,f,g,h;if(!a)return[];e=
0;for(j=p.order.length;e<j;e++){g=p.order[e];if(f=p.leftMatch[g].exec(a)){h=f[1];f.splice(1,1);if(h.substr(h.length-1)!=="\\"){f[1]=(f[1]||"").replace(k,"");d=p.find[g](f,b,c);if(d!=null){a=a.replace(p.match[g],"");break}}}}d||(d=typeof b.getElementsByTagName!=="undefined"?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};l.filter=function(a,b,d,e){for(var j,f,g,h,k,i,t,n,z=a,L=[],o=b,r=b&&b[0]&&l.isXML(b[0]);a&&b.length;){for(g in p.filter)if((j=p.leftMatch[g].exec(a))!=null&&j[2]){i=p.filter[g];
k=j[1];f=false;j.splice(1,1);if(k.substr(k.length-1)!=="\\"){o===L&&(L=[]);if(p.preFilter[g])if(j=p.preFilter[g](j,o,d,L,e,r)){if(j===true)continue}else f=h=true;if(j)for(t=0;(k=o[t])!=null;t++)if(k){h=i(k,j,t,o);n=e^h;if(d&&h!=null)n?f=true:o[t]=false;else if(n){L.push(k);f=true}}if(h!==c){d||(o=L);a=a.replace(p.match[g],"");if(!f)return[];break}}}if(a===z)if(f==null)l.error(a);else break;z=a}return o};l.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};var z=l.getText=
...
K;for(K in p.match){p.match[K]=RegExp(p.match[K].source+/(?![^\[]*\])(?![^\(]*\))/.source);p.leftMatch[K]=RegExp(/(^(?:.|\r|\n)*?)/.source+p.match[K].source.replace(/\\(\d+)/g,r))}p.match.globalPOS=o;var u=function(a,b){a=Array.prototype.slice.call(a,0);if(b){b.push.apply(b,a);return b}return a};try{Array.prototype.slice.call(v.documentElement.childNodes,0)[0].nodeType}catch(U){u=function(a,b){var c=0,d=b||[];if(f.call(a)==="[object Array]")Array.prototype.push.apply(d,a);else if(typeof a.length===
...
"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]},Ba=l(v);Z.optgroup=Z.option;Z.tbody=Z.tfoot=Z.colgroup=Z.caption=Z.thead;Z.th=Z.td;i.support.htmlSerialize||(Z._default=[1,"div<div>","</div>"]);i.fn.extend({text:function(a){return i.access(this,function(a){return a===c?i.text(this):this.empty().append((this[0]&&this[0].ownerDocument||v).createTextNode(a))},null,a,arguments.length)},wrapAll:function(a){if(i.isFunction(a))return this.each(function(b){i(this).wrapAll(a.call(this,
...
1){c[b](this[0]);return this}for(var e=0,j=c.length;e<j;e++){var f=(e>0?this.clone(true):this).get();i(c[e])[b](f);d=d.concat(f)}return this.pushStack(d,a,c.selector)}});i.extend({clone:function(a,b,c){var d,e,j;if(i.support.html5Clone||i.isXMLDoc(a)||!Ia.test("<"+a.nodeName+">"))d=a.cloneNode(true);else{d=v.createElement("div");Ba.appendChild(d);d.innerHTML=a.outerHTML;d=d.firstChild}var f=d;if((!i.support.noCloneEvent||!i.support.noCloneChecked)&&(a.nodeType===1||a.nodeType===11)&&!i.isXMLDoc(a)){n(a,
...
sb=/^(?:GET|HEAD)$/,tb=/^\/\//,Pa=/\?/,ub=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,vb=/^(?:select|textarea)/i,Ja=/\s+/,wb=/([?&])_=[^&]*/,Qa=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Ra=i.fn.load,ya={},Sa={},ea,fa,Ta=["*/"]+["*"];try{ea=M.href}catch(Cb){ea=v.createElement("a"),ea.href="",ea=ea.href}fa=Qa.exec(ea.toLowerCase())||[];i.fn.extend({load:function(a,b,d){if(typeof a!=="string"&&Ra)return Ra.apply(this,arguments);if(!this.length)return this;var e=a.indexOf(" ");if(e>=
...
processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Ta},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":i.parseJSON,"text xml":i.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:q(ya),ajaxTransport:q(Sa),ajax:function(a,b){function d(a,b,l,n){if(u!==2){u=2;r&&clearTimeout(r);o=c;z=n||"";q.readyState=
a>0?4:0;var p,K,L,n=b;if(l){var x=e,m=q,V=x.contents,ba=x.dataTypes,B=x.responseFields,v,s,A,wa;for(s in B)s in l&&(m[B[s]]=l[s]);for(;ba[0]==="*";){ba.shift();v===c&&(v=x.mimeType||m.getResponseHeader("content-type"))}if(v)for(s in V)if(V[s]&&V[s].test(v)){ba.unshift(s);break}if(ba[0]in l)A=ba[0];else{for(s in l){if(!ba[0]||x.converters[s+" "+ba[0]]){A=s;break}wa||(wa=s)}A=A||wa}if(A){A!==ba[0]&&ba.unshift(A);l=l[A]}else l=void 0}else l=c;if(a>=200&&a<300||a===304){if(e.ifModified){if(v=q.getResponseHeader("Last-Modified"))i.lastModified[t]=
v;if(v=q.getResponseHeader("Etag"))i.etag[t]=v}if(a===304){n="notmodified";p=true}else try{v=e;v.dataFilter&&(l=v.dataFilter(l,v.dataType));var ca=v.dataTypes;s={};var C,y,E=ca.length,w,D=ca[0],$,H,F,G,I;for(C=1;C<E;C++){if(C===1)for(y in v.converters)typeof y==="string"&&(s[y.toLowerCase()]=v.converters[y]);$=D;D=ca[C];if(D==="*")D=$;else if($!=="*"&&$!==D){H=$+" "+D;F=s[H]||s["* "+D];if(!F){I=c;for(G in s){w=G.split(" ");if(w[0]===$||w[0]==="*")if(I=s[w[1]+" "+D]){G=s[G];G===true?F=I:I===true&&
(F=G);break}}}!F&&!I&&i.error("No conversion from "+H.replace(" "," to "));F!==true&&(l=F?F(l):I(G(l)))}}K=l;n="success";p=true}catch(J){n="parsererror";L=J}}else{L=n;if(!n||a){n="error";a<0&&(a=0)}}q.status=a;q.statusText=""+(b||n);p?g.resolveWith(j,[K,n,q]):g.rejectWith(j,[q,n,L]);q.statusCode(k);k=c;U&&f.trigger("ajax"+(p?"Success":"Error"),[q,e,p?K:L]);h.fireWith(j,[q,n]);if(U){f.trigger("ajaxComplete",[q,e]);--i.active||i.event.trigger("ajaxStop")}}}if(typeof a==="object"){b=a;a=c}var b=b||{},
e=i.ajaxSetup({},b),j=e.context||e,f=j!==e&&(j.nodeType||j instanceof i)?i(j):i.event,g=i.Deferred(),h=i.Callbacks("once memory"),k=e.statusCode||{},t,l={},n={},z,p,o,r,K,u=0,U,x,q={readyState:0,setRequestHeader:function(a,b){if(!u){var c=a.toLowerCase(),a=n[c]=n[c]||a;l[a]=b}return this},getAllResponseHeaders:function(){return u===2?z:null},getResponseHeader:function(a){var b;if(u===2){if(!p)for(p={};b=qb.exec(z);)p[b[1].toLowerCase()]=b[2];b=p[a.toLowerCase()]}return b===c?null:b},overrideMimeType:function(a){if(!u)e.mimeType=
a;return this},abort:function(a){a=a||"abort";o&&o.abort(a);d(0,a);return this}};g.promise(q);q.success=q.done;q.error=q.fail;q.complete=h.add;q.statusCode=function(a){if(a){var b;if(u<2)for(b in a)k[b]=[k[b],a[b]];else{b=a[q.status];q.then(b,b)}}return this};e.url=((a||e.url)+"").replace(pb,"").replace(tb,fa[1]+"//");e.dataTypes=i.trim(e.dataType||"*").toLowerCase().split(Ja);if(e.crossDomain==null){K=Qa.exec(e.url.toLowerCase());e.crossDomain=!(!K||!(K[1]!=fa[1]||K[2]!=fa[2]||(K[3]||(K[1]==="http:"?
80:443))!=(fa[3]||(fa[1]==="http:"?80:443))))}if(e.data&&e.processData&&typeof e.data!=="string")e.data=i.param(e.data,e.traditional);m(ya,e,b,q);if(u===2)return false;U=e.global;e.type=e.type.toUpperCase();e.hasContent=!sb.test(e.type);U&&i.active++===0&&i.event.trigger("ajaxStart");if(!e.hasContent){if(e.data){e.url=e.url+((Pa.test(e.url)?"&":"?")+e.data);delete e.data}t=e.url;if(e.cache===false){K=i.now();var V=e.url.replace(wb,"$1_="+K);e.url=V+(V===e.url?(Pa.test(e.url)?"&":"?")+"_="+K:"")}}(e.data&&
...
q,e)===false||u===2)){q.abort();return false}for(x in{success:1,error:1,complete:1})q[x](e[x]);if(o=m(Sa,e,b,q)){q.readyState=1;U&&f.trigger("ajaxSend",[q,e]);e.async&&e.timeout>0&&(r=setTimeout(function(){q.abort("timeout")},e.timeout));try{u=1;o.send(l,d)}catch(v){if(u<2)d(-1,v);else throw v;}}else d(-1,"No Transport");return q},param:function(a,b){var d=[],e=function(a,b){b=i.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(b===c)b=i.ajaxSettings.traditional;
...
""}!h&&b.isLocal&&!b.crossDomain?h=l.text?200:404:h===1223&&(h=204)}}}catch(o){e||j(-1,o)}l&&j(h,k,l,t)};if(!b.async||f.readyState===4)d();else{g=++yb;if(Da){if(!ja){ja={};i(a).unload(Da)}ja[g]=d}f.onreadystatechange=d}},abort:function(){d&&d(0,1)}}}});var za={},aa,ha,zb=/^(?:toggle|show|hide)$/,Ab=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,ua,ra=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],qa;i.fn.extend({show:function(a,
...
a(this),e=d.offset();this!=c.element[0]&&c.snapElements.push({item:this,width:d.outerWidth(),height:d.outerHeight(),top:e.top,left:e.left})})},drag:function(c,d){for(var f=a(this).data("draggable"),e=f.options,h=e.snapTolerance,g=d.offset.left,b=g+f.helperProportions.width,k=d.offset.top,l=k+f.helperProportions.height,o=f.snapElements.length-1;0<=o;o--){var n=f.snapElements[o].left,p=n+f.snapElements[o].width,r=f.snapElements[o].top,u=r+f.snapElements[o].height;if(n-h<g&&g<p+h&&r-h<k&&k<u+h||n-h<
g&&g<p+h&&r-h<l&&l<u+h||n-h<b&&b<p+h&&r-h<k&&k<u+h||n-h<b&&b<p+h&&r-h<l&&l<u+h){if("inner"!=e.snapMode){var x=Math.abs(r-l)<=h,q=Math.abs(u-k)<=h,m=Math.abs(n-b)<=h,A=Math.abs(p-g)<=h;x&&(d.position.top=f._convertPositionTo("relative",{top:r-f.helperProportions.height,left:0}).top-f.margins.top);q&&(d.position.top=f._convertPositionTo("relative",{top:u,left:0}).top-f.margins.top);m&&(d.position.left=f._convertPositionTo("relative",{top:0,left:n-f.helperProportions.width}).left-f.margins.left);A&&
(d.position.left=f._convertPositionTo("relative",{top:0,left:p}).left-f.margins.left)}var C=x||q||m||A;if("outer"!=e.snapMode&&(x=Math.abs(r-k)<=h,q=Math.abs(u-l)<=h,m=Math.abs(n-g)<=h,A=Math.abs(p-b)<=h,x&&(d.position.top=f._convertPositionTo("relative",{top:r,left:0}).top-f.margins.top),q&&(d.position.top=f._convertPositionTo("relative",{top:u-f.helperProportions.height,left:0}).top-f.margins.top),m&&(d.position.left=f._convertPositionTo("relative",{top:0,left:n}).left-f.margins.left),A))d.position.left=
...
c.getMonth(),c.getDate())),d=this._get(b,"isRTL"),e=this._get(b,"showButtonPanel"),f=this._get(b,"hideIfNoPrevNext"),g=this._get(b,"navigationAsDateFormat"),m=this._getNumberOfMonths(b),u=this._get(b,"showCurrentAtPos"),x=this._get(b,"stepMonths"),q=1!=m[0]||1!=m[1],B=this._daylightSavingAdjust(!b.currentDay?new Date(9999,9,9):new Date(b.currentYear,b.currentMonth,b.currentDay)),A=this._getMinMaxDate(b,"min"),w=this._getMinMaxDate(b,"max"),u=b.drawMonth-u,E=b.drawYear;0>u&&(u+=12,E--);if(w)for(var y=
this._daylightSavingAdjust(new Date(w.getFullYear(),w.getMonth()-m[0]*m[1]+1,w.getDate())),y=A&&y<A?A:y;this._daylightSavingAdjust(new Date(E,u,1))>y;)u--,0>u&&(u=11,E--);b.drawMonth=u;b.drawYear=E;var y=this._get(b,"prevText"),y=!g?y:this.formatDate(y,this._daylightSavingAdjust(new Date(E,u-x,1)),this._getFormatConfig(b)),y=this._canAdjustMonth(b,-1,E,u)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+h+".datepicker._adjustDate('#"+b.id+"', -"+x+", 'M');\" title=\""+y+'"><span class="ui-icon ui-icon-circle-triangle-'+
(d?"e":"w")+'">'+y+"</span></a>":f?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+y+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+y+"</span></a>",F=this._get(b,"nextText"),F=!g?F:this.formatDate(F,this._daylightSavingAdjust(new Date(E,u+x,1)),this._getFormatConfig(b)),f=this._canAdjustMonth(b,1,E,u)?'<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'+h+".datepicker._adjustDate('#"+b.id+"', +"+x+", 'M');\" title=\""+F+'"><span class="ui-icon ui-icon-circle-triangle-'+
...
this._get(b,"monthNames"),J=this._get(b,"monthNamesShort"),v=this._get(b,"beforeShowDay"),W=this._get(b,"showOtherMonths"),M=this._get(b,"selectOtherMonths");this._get(b,"calculateWeek");for(var i=this._getDefaultDate(b),T="",H=0;H<m[0];H++){var s="";this.maxRows=4;for(var R=0;R<m[1];R++){var P=this._daylightSavingAdjust(new Date(E,u,b.selectedDay)),I=" ui-corner-all",G="";if(q){G+='<div class="ui-datepicker-group';if(1<m[1])switch(R){case 0:G+=" ui-datepicker-group-first";I=" ui-corner-"+(d?"right":
"left");break;case m[1]-1:G+=" ui-datepicker-group-last";I=" ui-corner-"+(d?"left":"right");break;default:G+=" ui-datepicker-group-middle",I=""}G+='">'}for(var G=G+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+I+'">'+(/all|left/.test(I)&&0==H?d?f:y:"")+(/all|right/.test(I)&&0==H?d?y:f:"")+this._generateMonthYearHeader(b,u,E,A,w,0<H||0<R,Q,J)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),O=x?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":
"",I=0;7>I;I++)var N=(I+g)%7,O=O+("<th"+(5<=(I+g+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+F[N]+'">'+D[N]+"</span></th>");G+=O+"</tr></thead><tbody>";O=this._getDaysInMonth(E,u);E==b.selectedYear&&u==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,O));I=(this._getFirstDayOfMonth(E,u)-g+7)%7;O=Math.ceil((I+O)/7);this.maxRows=O=q?this.maxRows>O?this.maxRows:O:O;for(var N=this._daylightSavingAdjust(new Date(E,u,1-I)),X=0;X<O;X++){for(var G=G+"<tr>",Y=!x?"":'<td class="ui-datepicker-week-col">'+
this._get(b,"calculateWeek")(N)+"</td>",I=0;7>I;I++){var S=v?v.apply(b.input?b.input[0]:null,[N]):[!0,""],j=N.getMonth()!=u,t=j&&!M||!S[0]||A&&N<A||w&&N>w,Y=Y+('<td class="'+(5<=(I+g+6)%7?" ui-datepicker-week-end":"")+(j?" ui-datepicker-other-month":"")+(N.getTime()==P.getTime()&&u==b.selectedMonth&&b._keyEvent||i.getTime()==N.getTime()&&i.getTime()==P.getTime()?" "+this._dayOverClass:"")+(t?" "+this._unselectableClass+" ui-state-disabled":"")+(j&&!W?"":" "+S[1]+(N.getTime()==B.getTime()?" "+this._currentClass:
"")+(N.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!j||W)&&S[2]?' title="'+S[2]+'"':"")+(t?"":' onclick="DP_jQuery_'+h+".datepicker._selectDay('#"+b.id+"',"+N.getMonth()+","+N.getFullYear()+', this);return false;"')+">"+(j&&!W?"&#xa0;":t?'<span class="ui-state-default">'+N.getDate()+"</span>":'<a class="ui-state-default'+(N.getTime()==c.getTime()?" ui-state-highlight":"")+(N.getTime()==B.getTime()?" ui-state-active":"")+(j?" ui-priority-secondary":"")+'" href="#">'+N.getDate()+"</a>")+
"</td>");N.setDate(N.getDate()+1);N=this._daylightSavingAdjust(N)}G+=Y+"</tr>"}u++;11<u&&(u=0,E++);G+="</tbody></table>"+(q?"</div>"+(0<m[0]&&R==m[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");s+=G}T+=s}T+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return T},_generateMonthYearHeader:function(a,c,d,e,f,g,m,u){var x=this._get(a,"changeMonth"),q=this._get(a,"changeYear"),
w=this._get(a,"showMonthAfterYear"),A='<div class="ui-datepicker-title">',C="";if(g||!x)C+='<span class="ui-datepicker-month">'+m[c]+"</span>";else{for(var m=e&&e.getFullYear()==d,E=f&&f.getFullYear()==d,C=C+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+h+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),y=0;12>y;y++)if((!m||y>=e.getMonth())&&(!E||y<=f.getMonth()))C+='<option value="'+y+'"'+(y==c?' selected="selected"':"")+">"+u[y]+"</option>";C+="</select>"}w||(A+=C+(g||
!x||!q?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",g||!q)A+='<span class="ui-datepicker-year">'+d+"</span>";else{var u=this._get(a,"yearRange").split(":"),F=(new Date).getFullYear(),m=function(a){a=a.match(/c[+-].*/)?d+parseInt(a.substring(1),10):a.match(/[+-].*/)?F+parseInt(a,10):parseInt(a,10);return isNaN(a)?F:a},c=m(u[0]),u=Math.max(c,m(u[1]||"")),c=e?Math.max(c,e.getFullYear()):c,u=f?Math.min(u,f.getFullYear()):u;for(a.yearshtml+='<select class="ui-datepicker-year" onchange="DP_jQuery_'+
...
function(){f(c,p);g._trigger("show",null,g._ui(b,c[0]))})}:function(b,c){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");c.removeClass("ui-tabs-hide");g._trigger("show",null,g._ui(b,c[0]))},u=n?function(a,b){b.animate(n,n.duration||"normal",function(){g.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");f(b,n);g.element.dequeue("tabs")})}:function(a,b){g.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");g.element.dequeue("tabs")};
...
-1;b.cookie&&g._cookie(b.selected,b.cookie);g.element.queue("tabs",function(){u(c,e)}).dequeue("tabs");this.blur();return false}if(!e.length){b.cookie&&g._cookie(b.selected,b.cookie);g.element.queue("tabs",function(){r(c,f)});g.load(g.anchors.index(this));this.blur();return false}}b.cookie&&g._cookie(b.selected,b.cookie);if(f.length){e.length&&g.element.queue("tabs",function(){u(c,e)});g.element.queue("tabs",function(){r(c,f)});g.load(g.anchors.index(this))}else throw"jQuery UI Tabs: Mismatching fragment identifier.";
...
b&&(G=b,a.ui.editor.eachInstance(function(){this.reinit()}))}function g(a,b){G&&O[G]&&O[G][a]&&(a=O[G][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function b(b){if(X===f){X=!0;if(Y=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(b.options.baseClass+"-ios"),Y&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height","-=1")},0)});a.browser.mozilla&&a("html").addClass(b.options.baseClass+"-ff");
...
c.deleteContents();d.length===f||1===d.length?c.insertNode(d[0].cloneNode(!0)):a.each(d,function(a,b){c.insertNodeAtEnd(b.cloneNode(!0))})}function u(b){var b=b||d.getSelection(),c;a(b.getAllRanges()).each(function(b,d){c=3===this.commonAncestorContainer.nodeType?a(d.commonAncestorContainer).parent()[0]:d.commonAncestorContainer});return c}function x(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer}function q(a){if(!S||a)S=d.saveSelection()}function B(){S&&(d.restoreSelection(S),
...
c,e){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNodeContents(this);a.collapse(e);c.addRange(a)})}function Q(a,b){D(a,b,!1)}function J(a,b){D(a,b,!0)}function v(a){a=a||d.getSelection();return a.toHtml()}function W(b){b=b||d.getSelection().getRangeAt(0);return a(3===b.commonAncestorContainer.nodeType?b.commonAncestorContainer.parentNode:b.commonAncestorContainer)}function M(a){var b=new w;C(function(a){b.push(W(a)[0])},a,this);return b}function i(){var b=
...
!1),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,this.ready=!0,this.fire("ready"),this.options.autoEnable&&a(function(){c.enableEditing();c.showToolbar()}))},attach:function(){this.bind("change",this.historyPush);this.bind("selectionChange",this.updateTagTree);this.bind("show",this.updateTagTree);var b=a.proxy(this.checkChange,this);this.getElement().find("img").bind("click."+this.widgetName,a.proxy(function(a){F(a.target)},this));this.getElement().bind("mouseup."+
...
for(g=0;g<f.length;g++)c+=this.getTemplate("tag",{element:f[g][0].tagName.toLowerCase(),data:"["+e+","+g+"]"});e++},null,this);c||(c=this.getTemplate("root"));this.path.html(c).find("a").click(function(){var c=a(this).data("ui-editor-selection");c?(F(d[c[0]][c[1]]),b.updateTagTree()):F(b.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(b){return this.getElement()[0]===a(b)[0]},unify:function(b,c){!1!==c&&b(this);if(this.options.unify)for(var d=a.ui.editor.getInstances(),e=0;e<d.length;e++)d[e]!==
...
var c=this;return b.uiSelectMenu({name:"colorPickerBasic",title:g("Change the color of the selected text."),select:a(b.getTemplate("color-picker-basic.menu")),change:function(b){"automatic"===b?M().parents("."+c.options.cssPrefix+"color").andSelf().each(function(){var b=a(this),c=a(this).attr("class").match(/(cms-(.*?))( |$)/ig);a.each(c,function(c,d){d=a.trim(d);b.removeClass(d)})}):H("span",{classes:c.options.classes||c.options.cssPrefix+"color "+c.options.cssPrefix+b})}})},change:function(){this.ui.val("automatic");
var b=M()[0];if(b&&(b=a(b).closest("."+this.options.cssPrefix+"color"))){var c=b.attr("class");c&&(c=b.attr("class").replace(RegExp(this.options.cssPrefix+"color","g"),""),b=c.match(/cms-(.*?)( |$)/i)[1],this.ui.select.find(".ui-editor-selectmenu-option[value="+b+"]").length&&this.ui.val(b))}}});a.ui.editor.registerPlugin("dock",{enabled:!1,docked:!1,topSpacer:null,bottomSpacer:null,options:{docked:!1,dockToElement:!1,dockUnder:!1,persist:!0,persistID:null},init:function(){this.bind("show",this.show);
...
a(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:g("Paste Embed Code"),autoOpen:!0,dialogClass:b.options.baseClass+" "+b.options.dialogClass,buttons:[{text:g("Embed Object"),click:function(){B();E(a(this).find("textarea").val());a(this).dialog("close")}},{text:g("Close"),click:function(){b.hide()}}],open:function(){var b=a(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});
...
c){return b.uiButton({title:"Insert image or uploaded file",icon:"ui-icon-image",click:function(){var b=this;q();null===this.fileManager&&(this.fileManager=a.ui.filemanager.create({enablePlugins:!1,plugins:{datatables:!XMod.FileManager.Permissions.insert?!1:{ajaxSource:"/filemanager/admin/datatables",insertionCallback:function(d){B();if(!d.length)return true;var e=function(){b.editor.fire("change");return true};if(d.length===1){var f=d[0];if(b.isImage(f)){E(b.createImage(f,c.cssPrefix+f.type));return e()}if(b.editor.selectionExists()){s("a",
{href:f.url,className:b.options.cssPrefix+"file "+b.options.cssPrefix+f.type});return e()}E(b.createAnchor(f,b.options.cssPrefix+"file "+b.options.cssPrefix+f.type));return e()}for(var g=[],j=0;j<d.length;j++){f=d[j];b.isImage(f)?g.push(a("<div/>").html(b.createImage(f,c.cssPrefix+f.type)).html()):g.push(a("<div/>").html(b.createAnchor(f,b.options.cssPrefix+"file "+b.options.cssPrefix+f.type)).html())}E(g.join(", "));return e()}},plupload:!XMod.FileManager.Permissions.upload?!1:{url:"/filemanager/admin/plupload"}}}));
...
init:function(a){a.bind("change",this.change,this);return this.ui=a.uiButton({title:g("Step Forward"),click:function(){a.historyForward()}})},change:function(){this.editor.present===this.editor.history.length-1?this.ui.disable():this.ui.enable()}}});a.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:g("Insert Horizontal Rule"),click:function(){E("<hr/>")}})}}});a.ui.editor.registerUi({i18n:{init:function(b){var c=this,d=this.persist("locale");d&&h(d);var d=a('<select autocomplete="off" name="i18n"/>'),
e;for(e in O){var f=a('<option value="'+e+'" class="'+e+'"/>');f.html(N[e]);G===e&&f.attr("selected","selected");d.append(f)}return b.uiSelectMenu({title:g("Change Language"),select:d,change:function(a){h(c.persist("locale",a))}})}}});e("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"Apply Source","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",
...
e*a(this).val())));k()})}});b.preventDefault();return!1},displayToolsButtonRelativeToImage:function(b){var c=a("<button>"+g("Click to edit the image")+"</button>").appendTo("body").addClass(this.options.resizeButtonClass+" "+this.options.supplementaryClass).button({text:!1,icons:{primary:"ui-icon-tools"}});c.css({position:"absolute",left:a(b).position().left+a(b).innerWidth()-a(c).outerWidth()-10+"px",top:a(b).position().top+10+"px"}).attr("contenteditable",!1).click(a.proxy(this.manuallyResizeImage,
...
this.change,this);return a.uiButton({title:g("Insert Link"),click:function(){a.getPlugin("link").show()}})},change:function(){M().length?this.ui.enable():this.ui.disable()}},unlink:{hotkeys:{"ctrl+shift+l":{action:function(){this.ui.click()},restoreSelection:!1}},init:function(a){a.bind("selectionChange",this.change,this);a.bind("show",this.change,this);return a.uiButton({title:g("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){M().is("a")?this.ui.enable():this.ui.disable()}}});
a.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),toggleList:function(b){a(M()).is("li")&&a(M()).parent().is(b)?this.unwrapList():this.wrapList(b);this.editor.fire("selectionChange");
this.editor.fire("change")},unwrapList:function(){q();var b=[],c=[],d=i(),e=T();b.push(a(d).html());c.push(d);if(a(d)[0]!==a(e)[0]){var f=d;do f=a(f).next(),b.push(a(f).html()),c.push(f);while(a(f)[0]!==a(e)[0])}f=0===a(d).prev().length;e=0===a(e).next().length;d=a(d).parent();for(listElementsIndex=0;listElementsIndex<c.length;listElementsIndex++)a(c[listElementsIndex]).remove();for(c=0;c<b.length;c++)d.parent().is("li")||(b[c]="<p>"+b[c]+"</p>");f&&e?(d.replaceWith(b.join("")),B(),b=M()[0],F(b)):
...
"</"+b+">";B();var f=a(M()[0]).parent(),g=this.editor.getElement()[0];f===g||M()[0]===g?E(b):P(b,this.validParents);c=a(this.editor.getElement().find("."+c).removeClass(c));y(c.find("li:first")[0]);this.editor.checkChange()},toggleButtonState:function(b,c){var d=function(a){c.button.toggleClass("ui-state-highlight",a).toggleClass("ui-state-default",!a)},e=i();if(null===e||!e.length)e=this.editor.getElement();var f=T();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(a(e).is(b)&&
a(f).is(b)&&e===f)return d(!0);var g=a(e).parentsUntil(h,b).first()&&a(f).parentsUntil(h,b).first(),h="#"+this.editor.getElement().attr("id"),k=a(e).is(b+" > li")||a(e).parentsUntil(h,b+" > li").length,l=a(f).is(b+" > li")||a(f).parentsUntil(h,b+" > li").length;if(k&&l&&g){g=a(u());g.is(b)||(g=a(g).parentsUntil(h,b).first());h=g.find("ul, ol");if(!h.length)return d(!0);for(g=0;g<h.length;g++)if(a.contains(h[g],e)&&a.contains(h[g],f))return d(!1);return d(!0)}return d(!1)}});a.ui.editor.registerUi({listUnordered:{init:function(a){var b=
...
g);P(e,this.options.enterValidTags);e=a("#"+g).removeAttr("id");b?c?J(e.next()):f?J(e):(J(e.next()),(b=e.prev())&&""!==a.trim(b.html())&&l(b)!==this.options.enter&&e.remove()):(J(e.next()),e.remove())},restoreSelection:!1},"return+shift":{action:function(){A();var b=this.options.baseClass+"-enter-break",c=a(breakHtml).attr("id",b).appendTo("body");this.options.shiftEnterValidTags?P(this.options.shiftEnter,this.options.shiftEnterValidTags):E(c);b=a("#"+b).removeAttr("id").next();J(b)},restoreSelection:!1}}});
...
a(".uiWidgetEditorPasteBin").focus();c.setTimeout(function(){var c=a(".uiWidgetEditorPasteBin").html(),c=h.filterAttributes(c),c=h.filterChars(c),c=h.stripEmpty(c),c=h.stripAttributes(c),c=I(c,h.options.allowedTags),c={plain:a("<div/>").html(a(".uiWidgetEditorPasteBin").html()).text(),markup:c,html:a(".uiWidgetEditorPasteBin").html()};f=a(b.getTemplate("paste.dialog",c));a(f).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:d.dialogShowAnimation,hide:d.dialogHideAnimation,
