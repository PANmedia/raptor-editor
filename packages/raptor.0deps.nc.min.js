...
ma}function v(a){J(a);J(a.prototype)}function V(a,b){return function(){D(this);var c=this.startContainer,d=this.startOffset,j=this.commonAncestorContainer,e=new n(this,!0);c!==j&&(c=s.getClosestAncestorIn(c,j,!0),d=f(c),c=d.node,d=d.offset);g(e,E);e.reset();j=a(e);e.detach();b(this,c,d,c,d);return j}}function M(a,c,j){function g(a,b){return function(c){q(this);B(c,I);B(W(c),G);c=(a?d:f)(c);(b?e:i)(this,c.node,c.offset)}}function e(a,b,d){var j=a.endContainer,g=a.endOffset;if(b!==a.startContainer||
d!==a.startOffset){if(W(b)!=W(j)||1==s.comparePoints(b,d,j,g))j=b,g=d;c(a,b,d,j,g)}}function i(a,b,d){var j=a.startContainer,g=a.startOffset;if(b!==a.endContainer||d!==a.endOffset){if(W(b)!=W(j)||-1==s.comparePoints(b,d,j,g))j=b,g=d;c(a,j,g,b,d)}}a.prototype=new Q;m.util.extend(a.prototype,{setStart:function(a,b){q(this);x(a,!0);A(a,b);e(this,a,b)},setEnd:function(a,b){q(this);x(a,!0);A(a,b);i(this,a,b)},setStartBefore:g(!0,!0),setStartAfter:g(!1,!0),setEndBefore:g(!0,!1),setEndAfter:g(!1,!1),collapse:function(a){D(this);
a?c(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):c(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){q(this);x(a,!0);c(this,a,0,a,s.getNodeLength(a))},selectNode:function(a){q(this);x(a,!1);B(a,I);var b=d(a),a=f(a);c(this,b.node,b.offset,a.node,a.offset)},extractContents:V(k,c),deleteContents:V(b,c),canSurroundContents:function(){D(this);E(this.startContainer);E(this.endContainer);var a=new n(this,!0),b=a._first&&
...
detach:function(){this._current=this._next=this.nodes=null}};var I=[1,3,4,5,7,8,10],G=[2,9,11],O=[1,3,4,5,7,8,10,11],N=[1,3,4,5,7,8],W=s.getRootContainer,X=u([9,11]),S=u([5,6,10,12]),j=u([6,10,12]),t=document.createElement("style"),z=!1;try{t.innerHTML="<b>x</b>",z=3==t.firstChild.nodeType}catch(K){}m.features.htmlParsingConforms=z;var U="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),Y=0,ca=1,$=2,ka=3,oa=0,pa=1,la=2,ma=3;Q.prototype={attachListener:function(a,
b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){D(this);C(this.startContainer,b.startContainer);var c=a==ka||a==Y?"start":"end",d=a==ca||a==Y?"start":"end";return s.comparePoints(this[c+"Container"],this[c+"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){D(this);B(a,O);E(this.startContainer);if(s.isAncestorOf(a,this.startContainer,!0))throw new P("HIERARCHY_REQUEST_ERR");this.setStartBefore(e(a,this.startContainer,this.startOffset))},cloneContents:function(){D(this);
...
f(this)};var P=function(a,b){var c=x.getRangeDocument(b),c=m.createRange(c);c.collapseToPoint(b.endContainer,b.endOffset);a.nativeSelection.addRange(e(c));a.nativeSelection.extend(b.startContainer,b.startOffset);a.refresh()};s.addRange=M?function(a,b){if(H&&F&&this.docSelection.type=="Control")k(this,a);else if(b&&V)P(this,a);else{var c;if(i)c=this.rangeCount;else{this.removeAllRanges();c=0}this.nativeSelection.addRange(e(a));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==c+1){if(m.config.checkSelectionRanges)(c=
R(this.nativeSelection,this.rangeCount-1))&&!x.rangesEqual(c,a)&&(a=new q(c));this._ranges[this.rangeCount-1]=a;d(this,a,O(this.nativeSelection));this.isCollapsed=E(this)}else this.refresh()}}:function(a,b){if(b&&V)P(this,a);else{this.nativeSelection.addRange(e(a));this.refresh()}};s.setRanges=function(a){if(H&&a.length>1)o(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(u.isHostMethod(y,"empty")&&u.isHostMethod(Q,"select")&&H&&D)s.removeAllRanges=
...
p=/(?:^|:|,)(?:\s*\[)+/g,o=/(webkit)[ \/]([\w.]+)/,r=/(opera)(?:.*version)?[ \/]([\w.]+)/,u=/(msie) ([\w.]+)/,K=/(mozilla)(?:.*? rv:([\w.]+))?/,U=/-([a-z]|[0-9])/ig,x=/^-ms-/,q=function(a,b){return(b+"").toUpperCase()},m=V.userAgent,sa,ia,Y=Object.prototype.toString,Aa=Object.prototype.hasOwnProperty,Ba=Array.prototype.push,na=Array.prototype.slice,B=String.prototype.trim,s=Array.prototype.indexOf,A={};d.fn=d.prototype={constructor:d,init:function(a,b,e){var j;if(!a)return this;if(a.nodeType)return this.context=
...
slice:function(){return this.pushStack(na.apply(this,arguments),"slice",na.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:Ba,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,b,e,j,L,f=arguments[0]||{},g=1,h=arguments.length,k=!1;"boolean"===typeof f&&(k=f,f=arguments[1]||{},g=2);"object"!==typeof f&&!d.isFunction(f)&&
...
if(e)if(g)for(j in a){if(!1===b.apply(a[j],e))break}else for(;L<f&&!1!==b.apply(a[L++],e););else if(g)for(j in a){if(!1===b.call(a[j],j,a[j]))break}else for(;L<f&&!1!==b.call(a[L],L,a[L++]););return a},trim:B?function(a){return null==a?"":B.call(a)}:function(a){return null==a?"":a.toString().replace(k,"").replace(i,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var e=d.type(a);null==a.length||"string"===e||"function"===e||"regexp"===e||d.isWindow(a)?Ba.call(c,a):d.merge(c,a)}return c},inArray:function(a,
...
f);d=p(a);e=p(f);for(j=0;d[j];++j)e[j]&&n(d[j],e[j])}if(b){o(a,f);if(c){d=p(a);e=p(f);for(j=0;d[j];++j)o(d[j],e[j])}}return f},clean:function(a,b,c,d){var e,j=[],b=b||v;typeof b.createElement==="undefined"&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||v);for(var f=0,g;(g=a[f])!=null;f++){typeof g==="number"&&(g=g+"");if(g){if(typeof g==="string")if(fb.test(g)){g=g.replace(Ha,"<$1></$2>");e=(Ia.exec(g)||["",""])[1].toLowerCase();var h=Z[e]||Z._default,k=h[0],t=b.createElement("div"),n=Ca.childNodes;
b===v?Ca.appendChild(t):l(b).appendChild(t);for(t.innerHTML=h[1]+g+h[2];k--;)t=t.lastChild;if(!i.support.tbody){k=eb.test(g);h=e==="table"&&!k?t.firstChild&&t.firstChild.childNodes:h[1]==="<table>"&&!k?t.childNodes:[];for(e=h.length-1;e>=0;--e)i.nodeName(h[e],"tbody")&&!h[e].childNodes.length&&h[e].parentNode.removeChild(h[e])}!i.support.leadingWhitespace&&va.test(g)&&t.insertBefore(b.createTextNode(va.exec(g)[0]),t.firstChild);g=t.childNodes;if(t){t.parentNode.removeChild(t);if(n.length>0)(t=n[n.length-
1])&&t.parentNode&&t.parentNode.removeChild(t)}}else g=b.createTextNode(g);var z;if(!i.support.appendChecked)if(g[0]&&typeof(z=g.length)==="number")for(e=0;e<z;e++)u(g[e]);else u(g);g.nodeType?j.push(g):j=i.merge(j,g)}}if(c){a=function(a){return!a.type||Ma.test(a.type)};for(f=0;j[f];f++){b=j[f];if(d&&i.nodeName(b,"script")&&(!b.type||Ma.test(b.type)))d.push(b.parentNode?b.parentNode.removeChild(b):b);else{if(b.nodeType===1){g=i.grep(b.getElementsByTagName("script"),a);j.splice.apply(j,[f+1,0].concat(g))}c.appendChild(b)}}}return j},
...
a>0?4:0;var p,K,L,n=b;if(l){var x=e,m=q,Y=x.contents,ba=x.dataTypes,B=x.responseFields,v,s,A,wa;for(s in B)s in l&&(m[B[s]]=l[s]);for(;ba[0]==="*";){ba.shift();v===c&&(v=x.mimeType||m.getResponseHeader("content-type"))}if(v)for(s in Y)if(Y[s]&&Y[s].test(v)){ba.unshift(s);break}if(ba[0]in l)A=ba[0];else{for(s in l){if(!ba[0]||x.converters[s+" "+ba[0]]){A=s;break}wa||(wa=s)}A=A||wa}if(A){A!==ba[0]&&ba.unshift(A);l=l[A]}else l=void 0}else l=c;if(a>=200&&a<300||a===304){if(e.ifModified){if(v=q.getResponseHeader("Last-Modified"))i.lastModified[t]=
...
a;return this},abort:function(a){a=a||"abort";o&&o.abort(a);d(0,a);return this}};g.promise(q);q.success=q.done;q.error=q.fail;q.complete=h.add;q.statusCode=function(a){if(a){var b;if(u<2)for(b in a)k[b]=[k[b],a[b]];else{b=a[q.status];q.then(b,b)}}return this};e.url=((a||e.url)+"").replace(pb,"").replace(tb,fa[1]+"//");e.dataTypes=i.trim(e.dataType||"*").toLowerCase().split(Ka);if(e.crossDomain==null){K=Ra.exec(e.url.toLowerCase());e.crossDomain=!(!K||!(K[1]!=fa[1]||K[2]!=fa[2]||(K[3]||(K[1]==="http:"?
80:443))!=(fa[3]||(fa[1]==="http:"?80:443))))}if(e.data&&e.processData&&typeof e.data!=="string")e.data=i.param(e.data,e.traditional);m(ya,e,b,q);if(u===2)return false;U=e.global;e.type=e.type.toUpperCase();e.hasContent=!sb.test(e.type);U&&i.active++===0&&i.event.trigger("ajaxStart");if(!e.hasContent){if(e.data){e.url=e.url+((Qa.test(e.url)?"&":"?")+e.data);delete e.data}t=e.url;if(e.cache===false){K=i.now();var Y=e.url.replace(wb,"$1_="+K);e.url=Y+(Y===e.url?(Qa.test(e.url)?"&":"?")+"_="+K:"")}}(e.data&&
e.hasContent&&e.contentType!==false||b.contentType)&&q.setRequestHeader("Content-Type",e.contentType);if(e.ifModified){t=t||e.url;i.lastModified[t]&&q.setRequestHeader("If-Modified-Since",i.lastModified[t]);i.etag[t]&&q.setRequestHeader("If-None-Match",i.etag[t])}q.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+(e.dataTypes[0]!=="*"?", "+Ua+"; q=0.01":""):e.accepts["*"]);for(x in e.headers)q.setRequestHeader(x,e.headers[x]);if(e.beforeSend&&(e.beforeSend.call(j,
q,e)===false||u===2)){q.abort();return false}for(x in{success:1,error:1,complete:1})q[x](e[x]);if(o=m(Ta,e,b,q)){q.readyState=1;U&&f.trigger("ajaxSend",[q,e]);e.async&&e.timeout>0&&(r=setTimeout(function(){q.abort("timeout")},e.timeout));try{u=1;o.send(l,d)}catch(v){if(u<2)d(-1,v);else throw v;}}else d(-1,"No Transport");return q},param:function(a,b){var d=[],e=function(a,b){b=i.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(b===c)b=i.ajaxSettings.traditional;
...
f.overrideMimeType(b.mimeType);!b.crossDomain&&!e["X-Requested-With"]&&(e["X-Requested-With"]="XMLHttpRequest");try{for(h in e)f.setRequestHeader(h,e[h])}catch(k){}f.send(b.hasContent&&b.data||null);d=function(a,e){var h,k,t,l,n;try{if(d&&(e||f.readyState===4)){d=c;if(g){f.onreadystatechange=i.noop;Ea&&delete ja[g]}if(e)f.readyState!==4&&f.abort();else{h=f.status;t=f.getAllResponseHeaders();l={};if((n=f.responseXML)&&n.documentElement)l.xml=n;try{l.text=f.responseText}catch(z){}try{k=f.statusText}catch(p){k=
""}!h&&b.isLocal&&!b.crossDomain?h=l.text?200:404:h===1223&&(h=204)}}}catch(o){e||j(-1,o)}l&&j(h,k,l,t)};if(!b.async||f.readyState===4)d();else{g=++yb;if(Ea){if(!ja){ja={};i(a).unload(Ea)}ja[g]=d}f.onreadystatechange=d}},abort:function(){d&&d(0,1)}}}});var za={},aa,ha,zb=/^(?:toggle|show|hide)$/,Ab=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,ua,ra=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],qa;i.fn.extend({show:function(a,
...
this._get(b,"monthNames"),J=this._get(b,"monthNamesShort"),v=this._get(b,"beforeShowDay"),V=this._get(b,"showOtherMonths"),M=this._get(b,"selectOtherMonths");this._get(b,"calculateWeek");for(var i=this._getDefaultDate(b),T="",H=0;H<m[0];H++){var s="";this.maxRows=4;for(var R=0;R<m[1];R++){var P=this._daylightSavingAdjust(new Date(E,u,b.selectedDay)),I=" ui-corner-all",G="";if(q){G+='<div class="ui-datepicker-group';if(1<m[1])switch(R){case 0:G+=" ui-datepicker-group-first";I=" ui-corner-"+(d?"right":
...
"",I=0;7>I;I++)var N=(I+g)%7,O=O+("<th"+(5<=(I+g+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+F[N]+'">'+D[N]+"</span></th>");G+=O+"</tr></thead><tbody>";O=this._getDaysInMonth(E,u);E==b.selectedYear&&u==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,O));I=(this._getFirstDayOfMonth(E,u)-g+7)%7;O=Math.ceil((I+O)/7);this.maxRows=O=q?this.maxRows>O?this.maxRows:O:O;for(var N=this._daylightSavingAdjust(new Date(E,u,1-I)),W=0;W<O;W++){for(var G=G+"<tr>",X=!x?"":'<td class="ui-datepicker-week-col">'+
this._get(b,"calculateWeek")(N)+"</td>",I=0;7>I;I++){var S=v?v.apply(b.input?b.input[0]:null,[N]):[!0,""],j=N.getMonth()!=u,t=j&&!M||!S[0]||A&&N<A||w&&N>w,X=X+('<td class="'+(5<=(I+g+6)%7?" ui-datepicker-week-end":"")+(j?" ui-datepicker-other-month":"")+(N.getTime()==P.getTime()&&u==b.selectedMonth&&b._keyEvent||i.getTime()==N.getTime()&&i.getTime()==P.getTime()?" "+this._dayOverClass:"")+(t?" "+this._unselectableClass+" ui-state-disabled":"")+(j&&!V?"":" "+S[1]+(N.getTime()==B.getTime()?" "+this._currentClass:
"")+(N.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!j||V)&&S[2]?' title="'+S[2]+'"':"")+(t?"":' onclick="DP_jQuery_'+h+".datepicker._selectDay('#"+b.id+"',"+N.getMonth()+","+N.getFullYear()+', this);return false;"')+">"+(j&&!V?"&#xa0;":t?'<span class="ui-state-default">'+N.getDate()+"</span>":'<a class="ui-state-default'+(N.getTime()==c.getTime()?" ui-state-highlight":"")+(N.getTime()==B.getTime()?" ui-state-active":"")+(j?" ui-priority-secondary":"")+'" href="#">'+N.getDate()+"</a>")+
"</td>");N.setDate(N.getDate()+1);N=this._daylightSavingAdjust(N)}G+=X+"</tr>"}u++;11<u&&(u=0,E++);G+="</tbody></table>"+(q?"</div>"+(0<m[0]&&R==m[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");s+=G}T+=s}T+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return T},_generateMonthYearHeader:function(a,c,d,e,f,g,m,u){var x=this._get(a,"changeMonth"),q=this._get(a,"changeYear"),
...
this.dialog=null;a(this.ui.button).button("option","disabled",!1)},show:function(){if(!this.dialog){a(this.ui.button).button("option","disabled",!0);var b=this;q();this.dialog=a(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:g("Paste Embed Code"),autoOpen:!0,dialogClass:b.options.baseClass+" "+b.options.dialogClass,buttons:[{text:g("Embed Object"),click:function(){B();E(a(this).find("textarea").val());a(this).dialog("close")}},{text:g("Close"),
...
this.editor.getElement();var f=T();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(a(e).is(b)&&a(f).is(b)&&e===f)return d(!0);var g=a(e).parentsUntil(h,b).first()&&a(f).parentsUntil(h,b).first(),h="#"+this.editor.getElement().attr("id"),k=a(e).is(b+" > li")||a(e).parentsUntil(h,b+" > li").length,l=a(f).is(b+" > li")||a(f).parentsUntil(h,b+" > li").length;if(k&&l&&g){g=a(u());g.is(b)||(g=a(g).parentsUntil(h,b).first());h=g.find("ul, ol");if(!h.length)return d(!0);for(g=0;g<h.length;g++)if(a.contains(h[g],
