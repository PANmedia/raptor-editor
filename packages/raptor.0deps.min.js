...
s="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),q="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),r=e(a),p=e(c),y=e(d),x={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:a,isHostObject:c,isHostProperty:d,areHostMethods:r,areHostObjects:p,areHostProperties:y,isTextRange:g},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
...
var m="undefined",s=a.util;s.areHostMethods(document,["createDocumentFragment","createElement","createTextNode"])||c.fail("document missing a Node creation method");s.isHostMethod(document,"getElementsByTagName")||c.fail("document missing getElementsByTagName method");var q=document.createElement("div");s.areHostMethods(q,["insertBefore","appendChild","cloneNode"])||c.fail("Incomplete Element implementation");s.isHostProperty(q,"innerHTML")||c.fail("Element is missing innerHTML property");q=document.createTextNode("test");
...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(a){return s.isHostObject(a,"body")?a.body:a.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var b;b=a.parentNode;)a=b;return a},comparePoints:function(a,b,c,k){var f;if(a==c)return b===k?0:b<k?-1:1;if(f=g(c,a,!0))return b<=d(f)?-1:1;if(f=g(a,c,!0))return d(f)<k?-1:1;b=e(a,c);a=a===b?b:g(a,b,!0);c=c===b?b:g(c,b,!0);if(a===c)throw Error("comparePoints got to case 4 and childA and childB are the same!");
...
c.appendChild(b)}return c}function n(a,b,c){var j=!(!b||!b.length),d,h=!!c;j&&(d=RegExp("^("+b.join("|")+")$"));var g=[];k(new s(a,!1),function(a){(!j||d.test(a.nodeType))&&(!h||c(a))&&g.push(a)});return g}function m(a){return"["+("undefined"==typeof a.getName?"Range":a.getName())+"("+t.inspectNode(a.startContainer)+":"+a.startOffset+", "+t.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function s(a,b){this.range=a;this.clonePartiallySelectedTextNodes=b;if(!a.collapsed){this.sc=a.startContainer;
...
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function r(a,b,c){this.nodes=n(a,b,c);this._next=this.nodes[0];this._position=0}function p(a){return function(b,c){for(var j,d=c?b:b.parentNode;d;){j=d.nodeType;if(t.arrayContains(a,j))return d;d=d.parentNode}return null}}function y(a,b){if(v(a,b))throw new q("INVALID_NODE_TYPE_ERR");}function x(a){if(!a.startContainer)throw new E("INVALID_STATE_ERR");}function z(a,b){if(!t.arrayContains(b,a.nodeType))throw new q("INVALID_NODE_TYPE_ERR");
...
la}function G(a){R(a);R(a.prototype)}function h(a,b){return function(){C(this);var c=this.startContainer,j=this.startOffset,d=this.commonAncestorContainer,h=new s(this,!0);c!==d&&(c=t.getClosestAncestorIn(c,d,!0),j=i(c),c=j.node,j=j.offset);k(h,B);h.reset();d=a(h);h.detach();b(this,c,j,c,j);return d}}function S(b,j,d){function e(a,b){return function(c){x(this);z(c,M);z(Q(c),I);c=(a?g:i)(c);(b?k:f)(this,c.node,c.offset)}}function k(a,b,c){var d=a.endContainer,h=a.endOffset;if(b!==a.startContainer||
...
a?j(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):j(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){x(this);y(a,!0);j(this,a,0,a,t.getNodeLength(a))},selectNode:function(a){x(this);y(a,!1);z(a,M);var b=g(a),a=i(a);j(this,b.node,b.offset,a.node,a.offset)},extractContents:h(o,j),deleteContents:h(l,j),canSurroundContents:function(){C(this);B(this.startContainer);B(this.endContainer);var a=new s(this,!0),b=a._first&&
...
e=!this.collapsed);e?t.isCharacterDataNode(a)?0==b&&g(a):b<a.childNodes.length&&(h=a.childNodes[b])&&t.isCharacterDataNode(h)&&g(h):(a=c,b=d);j(this,a,b,c,d)},collapseToPoint:function(a,b){x(this);y(a,!0);D(a,b);(a!==this.startContainer||b!==this.startOffset||a!==this.endContainer||b!==this.endOffset)&&j(this,a,b,a,b)}});G(b)}function L(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:t.getCommonAncestor(a.startContainer,
a.endContainer)}function V(a,b,c,j,d){var h=a.startContainer!==b||a.startOffset!==c,g=a.endContainer!==j||a.endOffset!==d;a.startContainer=b;a.startOffset=c;a.endContainer=j;a.endOffset=d;L(a);e(a,"boundarychange",{startMoved:h,endMoved:g})}function K(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};L(this)}a.requireModules(["DomUtil"]);var t=a.dom,H=t.DomPosition,E=a.DOMException;s.prototype={_current:null,_next:null,_first:null,
...
this.ec,g=this.eo);V(a,c,j,h,g)}return new s(a,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};q.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};q.prototype.toString=function(){return this.message};r.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
detach:function(){this._current=this._next=this.nodes=null}};var M=[1,3,4,5,7,8,10],I=[2,9,11],T=[1,3,4,5,7,8,10,11],Y=[1,3,4,5,7,8],Q=t.getRootContainer,j=p([9,11]),u=p([5,6,10,12]),v=p([6,10,12]),N=document.createElement("style"),P=!1;try{N.innerHTML="<b>x</b>",P=3==N.firstChild.nodeType}catch(U){}a.features.htmlParsingConforms=P;var X="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),Z=0,ja=1,va=2,ma=3,ka=0,na=1,oa=2,la=3;w.prototype={attachListener:function(a,
...
containsNodeText:function(a){var b=this.cloneRange();b.selectNode(a);var c=b.getNodes([3]);return 0<c.length?(b.setStart(c[0],0),a=c.pop(),b.setEnd(a,a.length),a=this.containsRange(b),b.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){C(this);return new r(this,a,b)},getNodes:function(a,b){C(this);return n(this,a,b)},getDocument:function(){return d(this)},collapseBefore:function(a){x(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){x(this);this.setStartAfter(a);
this.collapse(!0)},getName:function(){return"DomRange"},equals:function(a){return K.rangesEqual(this,a)},isValid:function(){return O(this)},inspect:function(){return m(this)}};S(K,V,function(a){x(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;e(a,"detach",null);a._listeners=null});a.rangePrototype=w.prototype;K.rangeProperties=X;K.RangeIterator=s;K.copyComparisonConstants=G;K.createPrototypeRange=S;K.inspect=m;K.getRangeDocument=d;K.rangesEqual=
function(a,b){return a.startContainer===b.startContainer&&a.startOffset===b.startOffset&&a.endContainer===b.endContainer&&a.endOffset===b.endOffset};a.DomRange=K;a.RangeException=q});
rangy.createModule("WrappedRange",function(a){function c(a,b,c,d){var e=a.duplicate();e.collapse(c);var f=e.parentElement();g.isAncestorOf(b,f,!0)||(f=b);if(!f.canHaveHTML)return new i(f.parentNode,g.getNodeIndex(f));var b=g.getDocument(f).createElement("span"),q,r=c?"StartToStart":"StartToEnd";do f.insertBefore(b,b.previousSibling),e.moveToElementText(b);while(0<(q=e.compareEndPoints(r,a))&&b.previousSibling);r=b.nextSibling;if(-1==q&&r&&g.isCharacterDataNode(r)){e.setEndPoint(c?"EndToStart":"EndToEnd",
a);if(/[\r\n]/.test(r.data)){f=e.duplicate();c=f.text.replace(/\r\n/g,"\r").length;for(c=f.moveStart("character",c);-1==f.compareEndPoints("StartToEnd",f);)c++,f.moveStart("character",1)}else c=e.text.length;f=new i(r,c)}else r=(d||!c)&&b.previousSibling,f=(c=(d||c)&&b.nextSibling)&&g.isCharacterDataNode(c)?new i(c,0):r&&g.isCharacterDataNode(r)?new i(r,r.length):new i(f,g.getNodeIndex(b));b.parentNode.removeChild(b);return f}function d(a,b){var c,d,e=a.offset,f=g.getDocument(a.node),i=f.body.createTextRange(),
r=g.isCharacterDataNode(a.node);r?(c=a.node,d=c.parentNode):(c=a.node.childNodes,c=e<c.length?c[e]:null,d=a.node);f=f.createElement("span");f.innerHTML="&#feff;";c?d.insertBefore(f,c):d.appendChild(f);i.moveToElementText(f);i.collapse(!b);d.removeChild(f);if(r)i[b?"moveStart":"moveEnd"]("character",e);return i}a.requireModules(["DomUtil","DomRange"]);var e,g=a.dom,i=g.DomPosition,f=a.DomRange;if(a.features.implementsDomRange&&(!a.features.implementsTextRange||!a.config.preferTextRange))(function(){function b(a){for(var c=
...
var m=document.createTextNode("test");g.getBody(document).appendChild(m);var s=document.createRange();s.setStart(m,0);s.setEnd(m,0);try{s.setStart(m,1),c.setStart=function(a,c){this.nativeRange.setStart(a,c);b(this)},c.setEnd=function(a,c){this.nativeRange.setEnd(a,c);b(this)},i=function(a){return function(c){this.nativeRange[a](c);b(this)}}}catch(q){c.setStart=function(a,c){try{this.nativeRange.setStart(a,c)}catch(d){this.nativeRange.setEnd(a,c),this.nativeRange.setStart(a,c)}b(this)},c.setEnd=function(a,
c){try{this.nativeRange.setEnd(a,c)}catch(d){this.nativeRange.setStart(a,c),this.nativeRange.setEnd(a,c)}b(this)},i=function(a,c){return function(d){try{this.nativeRange[a](d)}catch(g){this.nativeRange[c](d),this.nativeRange[a](d)}b(this)}}}c.setStartBefore=i("setStartBefore","setEndBefore");c.setStartAfter=i("setStartAfter","setEndAfter");c.setEndBefore=i("setEndBefore","setStartBefore");c.setEndAfter=i("setEndAfter","setStartAfter");s.selectNodeContents(m);c.selectNodeContents=s.startContainer==
m&&s.endContainer==m&&0==s.startOffset&&s.endOffset==m.length?function(a){this.nativeRange.selectNodeContents(a);b(this)}:function(a){this.setStart(a,0);this.setEnd(a,f.getEndOffset(a))};s.selectNodeContents(m);s.setEnd(m,3);i=document.createRange();i.selectNodeContents(m);i.setEnd(m,4);i.setStart(m,2);c.compareBoundaryPoints=-1==s.compareBoundaryPoints(s.START_TO_END,i)&1==s.compareBoundaryPoints(s.END_TO_START,i)?function(a,b){b=b.nativeRange||b;a==b.START_TO_END?a=b.END_TO_START:a==b.END_TO_START&&
(a=b.START_TO_END);return this.nativeRange.compareBoundaryPoints(a,b)}:function(a,b){return this.nativeRange.compareBoundaryPoints(a,b.nativeRange||b)};a.util.isHostMethod(s,"createContextualFragment")&&(c.createContextualFragment=function(a){return this.nativeRange.createContextualFragment(a)});g.getBody(document).removeChild(m);s.detach();i.detach()})(),a.createNativeRange=function(a){return(a||document).createRange()};else if(a.features.implementsTextRange){e=function(a){this.textRange=a;this.refresh()};
...
(c=a.createNativeRange(r.getDocument(b.startContainer)),c.setEnd(b.endContainer,b.endOffset),c.setStart(b.startContainer,b.startOffset),b._selectionNativeRange=c,b.attachListener("detach",function(){this._selectionNativeRange=null}))):b instanceof x?c=b.nativeRange:a.features.implementsDomRange&&b instanceof r.getWindow(b.startContainer).Range&&(c=b);return c}function b(a){var b=a.getNodes(),c;a:if(!b.length||1!=b[0].nodeType)c=!1;else{c=1;for(var d=b.length;c<d;++c)if(!r.isAncestorOf(b[0],b[c])){c=
!1;break a}c=!0}if(!c)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function k(a,b){var c=new x(b);a._ranges=[c];g(a,c,!1);a.rangeCount=1;a.isCollapsed=c.collapsed}function l(b){b._ranges.length=0;if("None"==b.docSelection.type)i(b);else{var c=b.docSelection.createRange();if(c&&"undefined"!=typeof c.text)k(b,c);else{b.rangeCount=c.length;for(var d,h=r.getDocument(c.item(0)),e=0;e<b.rangeCount;++e)d=a.createRange(h),d.selectNode(c.item(e)),
b._ranges.push(d);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;g(b,b._ranges[b.rangeCount-1],!1)}}}function o(a,c){for(var d=a.docSelection.createRange(),h=b(c),g=r.getDocument(d.item(0)),g=r.getBody(g).createControlRange(),e=0,f=d.length;e<f;++e)g.add(d.item(e));try{g.add(h)}catch(i){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}g.select();l(a)}function n(a,b,c){this.nativeSelection=a;this.docSelection=b;this._ranges=
[];this.win=c;this.refresh()}function m(a,c){for(var d=r.getDocument(c[0].startContainer),d=r.getBody(d).createControlRange(),h=0,g;h<rangeCount;++h){g=b(c[h]);try{d.add(g)}catch(e){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();l(a)}function s(a,b){if(a.anchorNode&&r.getDocument(a.anchorNode)!==r.getDocument(b))throw new z("WRONG_DOCUMENT_ERR");}function q(a){var b=[],c=new D(a.anchorNode,a.anchorOffset),
d=new D(a.focusNode,a.focusOffset),h="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var g=0,e=a.rangeCount;g<e;++g)b[g]=y.inspect(a.getRangeAt(g));return"["+h+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var r=a.dom,p=a.util,y=a.DomRange,x=a.WrappedRange,z=a.DOMException,D=r.DomPosition,A,B,F=a.util.isHostMethod(window,"getSelection"),
O=a.util.isHostObject(document,"selection"),C=O&&(!F||a.config.preferTextRange);C?(A=e,a.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return"None"!=b.type||r.getDocument(b.createRange().parentElement())==a}):F?(A=d,a.isSelectionValid=function(){return!0}):c.fail("Neither document.selection or window.getSelection() detected.");a.getNativeSelection=A;var F=A(),w=a.createNativeRange(document),R=r.getBody(document),G=p.areHostObjects(F,p.areHostProperties(F,["anchorOffset","focusOffset"]));
a.features.selectionHasAnchorAndFocus=G;var h=p.isHostMethod(F,"extend");a.features.selectionHasExtend=h;var S="number"==typeof F.rangeCount;a.features.selectionHasRangeCount=S;var L=!1,V=!0;p.areHostMethods(F,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof F.rangeCount&&a.features.implementsDomRange&&function(){var a=document.createElement("iframe");a.frameBorder=0;a.style.position="absolute";a.style.left="-10000px";R.appendChild(a);var b=r.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");
b.close();var c=r.getIframeWindow(a).getSelection(),d=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(d,1);b.collapse(true);c.addRange(b);V=c.rangeCount==1;c.removeAllRanges();var h=b.cloneRange();b.setStart(d,0);h.setEnd(d,2);c.addRange(b);c.addRange(h);L=c.rangeCount==2;b.detach();h.detach();R.removeChild(a)}();a.features.selectionSupportsMultipleRanges=L;a.features.collapsedNonEditableSelectionsSupported=V;var K=!1,t;R&&p.isHostMethod(R,"createControlRange")&&(t=R.createControlRange(),
p.areHostProperties(t,["item","add"])&&(K=!0));a.features.implementsControlRange=K;B=G?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:false};var H;p.isHostMethod(F,"getRangeAt")?H=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:G&&(H=function(b){var c=r.getDocument(b.anchorNode),c=a.createRange(c);c.setStart(b.anchorNode,b.anchorOffset);c.setEnd(b.focusNode,b.focusOffset);if(c.collapsed!==
this.isCollapsed){c.setStart(b.focusNode,b.focusOffset);c.setEnd(b.anchorNode,b.anchorOffset)}return c});a.getSelection=function(a){var a=a||window,b=a._rangySelection,c=A(a),d=O?e(a):null;if(b){b.nativeSelection=c;b.docSelection=d;b.refresh(a)}else{b=new n(c,d,a);a._rangySelection=b}return b};a.getIframeSelection=function(b){return a.getSelection(r.getIframeWindow(b))};t=n.prototype;if(!C&&G&&p.areHostMethods(F,["removeAllRanges","addRange"])){t.removeAllRanges=function(){this.nativeSelection.removeAllRanges();
i(this)};var E=function(b,c){var d=y.getRangeDocument(c),d=a.createRange(d);d.collapseToPoint(c.endContainer,c.endOffset);b.nativeSelection.addRange(f(d));b.nativeSelection.extend(c.startContainer,c.startOffset);b.refresh()};t.addRange=S?function(b,c){if(K&&O&&this.docSelection.type=="Control")o(this,b);else if(c&&h)E(this,b);else{var d;if(L)d=this.rangeCount;else{this.removeAllRanges();d=0}this.nativeSelection.addRange(f(b));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==d+1){if(a.config.checkSelectionRanges)(d=
H(this.nativeSelection,this.rangeCount-1))&&!y.rangesEqual(d,b)&&(b=new x(d));this._ranges[this.rangeCount-1]=b;g(this,b,T(this.nativeSelection));this.isCollapsed=B(this)}else this.refresh()}}:function(a,b){if(b&&h)E(this,a);else{this.nativeSelection.addRange(f(a));this.refresh()}};t.setRanges=function(a){if(K&&a.length>1)m(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(p.isHostMethod(F,"empty")&&p.isHostMethod(w,"select")&&K&&C)t.removeAllRanges=
function(){try{this.docSelection.empty();if(this.docSelection.type!="None"){var a;if(this.anchorNode)a=r.getDocument(this.anchorNode);else if(this.docSelection.type=="Control"){var b=this.docSelection.createRange();b.length&&(a=r.getDocument(b.item(0)).body.createTextRange())}if(a){a.body.createTextRange().select();this.docSelection.empty()}}}catch(c){}i(this)},t.addRange=function(a){if(this.docSelection.type=="Control")o(this,a);else{x.rangeToTextRange(a).select();this._ranges[0]=a;this.rangeCount=
1;this.isCollapsed=this._ranges[0].collapsed;g(this,a,false)}},t.setRanges=function(a){this.removeAllRanges();var b=a.length;b>1?m(this,a):b&&this.addRange(a[0])};else return c.fail("No means of selecting a Range or TextRange was found"),!1;t.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new z("INDEX_SIZE_ERR");return this._ranges[a]};var M;if(C)M=function(b){var c;if(a.isSelectionValid(b.win))c=b.docSelection.createRange();else{c=r.getBody(b.win.document).createTextRange();c.collapse(true)}b.docSelection.type==
"Control"?l(b):c&&typeof c.text!="undefined"?k(b,c):i(b)};else if(p.isHostMethod(F,"getRangeAt")&&"number"==typeof F.rangeCount)M=function(b){if(K&&O&&b.docSelection.type=="Control")l(b);else{b._ranges.length=b.rangeCount=b.nativeSelection.rangeCount;if(b.rangeCount){for(var c=0,d=b.rangeCount;c<d;++c)b._ranges[c]=new a.WrappedRange(b.nativeSelection.getRangeAt(c));g(b,b._ranges[b.rangeCount-1],T(b.nativeSelection));b.isCollapsed=B(b)}else i(b)}};else if(G&&"boolean"==typeof F.isCollapsed&&"boolean"==
...
for(;a--;)if(!y.rangesEqual(b[a],this._ranges[a]))return false;return true}};var I=function(a,b){var c=a.getAllRanges(),d=false;a.removeAllRanges();for(var h=0,g=c.length;h<g;++h)d||b!==c[h]?a.addRange(c[h]):d=true;a.rangeCount||i(a)};t.removeRange=K?function(a){if(this.docSelection.type=="Control"){for(var c=this.docSelection.createRange(),a=b(a),d=r.getDocument(c.item(0)),d=r.getBody(d).createControlRange(),h,g=false,e=0,f=c.length;e<f;++e){h=c.item(e);h!==a||g?d.add(c.item(e)):g=true}d.select();
l(this)}else I(this,a)}:function(a){I(this,a)};var T;!C&&G&&a.features.implementsDomRange?(T=function(a){var b=false;a.anchorNode&&(b=r.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset)==1);return b},t.isBackwards=function(){return T(this)}):T=t.isBackwards=function(){return false};t.toString=function(){for(var a=[],b=0,c=this.rangeCount;b<c;++b)a[b]=""+this._ranges[b];return a.join("")};t.collapse=function(b,c){s(this,b);var d=a.createRange(r.getDocument(b));d.collapseToPoint(b,
c);this.removeAllRanges();this.addRange(d);this.isCollapsed=true};t.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new z("INVALID_STATE_ERR");};t.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new z("INVALID_STATE_ERR");};t.selectAllChildren=function(b){s(this,b);var c=a.createRange(r.getDocument(b));c.selectNodeContents(b);this.removeAllRanges();
this.addRange(c)};t.deleteFromDocument=function(){if(K&&O&&this.docSelection.type=="Control"){for(var a=this.docSelection.createRange(),b;a.length;){b=a.item(0);a.remove(b);b.parentNode.removeChild(b)}this.refresh()}else if(this.rangeCount){a=this.getAllRanges();this.removeAllRanges();b=0;for(var c=a.length;b<c;++b)a[b].deleteContents();this.addRange(a[c-1])}};t.getAllRanges=function(){return this._ranges.slice(0)};t.setSingleRange=function(a){this.setRanges([a])};t.containsNode=function(a,b){for(var c=
...
q;a.Selection=n;a.selectionPrototype=t;a.addCreateMissingNativeApiListener(function(b){if(typeof b.getSelection=="undefined")b.getSelection=function(){return a.getSelection(this)};b=null})});
...
elementHasNonClassAttributes:o,splitNodeAt:r,isEditableElement:B,isEditingHost:n,isEditable:m};a.CssClassApplier=x;a.createCssClassApplier=function(a,b,c){return new x(a,b,c)}});
...
c.warn("Marker element has been removed. Cannot restore selection.")}function g(a,b){return b.compareBoundaryPoints(a.START_TO_START,a)}function i(a,b){var c=(a||document).getElementById(b);c&&c.parentNode.removeChild(c)}a.requireModules(["DomUtil","DomRange","WrappedRange"]);var f=a.dom,b="\ufeff";a.saveSelection=function(b){var b=b||window,e=b.document;if(a.isSelectionValid(b)){var f=a.getSelection(b),i=f.getAllRanges(),m=[],s,q;i.sort(g);for(var r=0,p=i.length;r<p;++r)s=i[r],s.collapsed?(q=d(s,
!1),m.push({markerId:q.id,collapsed:!0})):(q=d(s,!1),s=d(s,!0),m[r]={startMarkerId:s.id,endMarkerId:q.id,collapsed:!1,backwards:1==i.length&&f.isBackwards()});for(r=p-1;0<=r;--r)s=i[r],s.collapsed?s.collapseBefore((e||document).getElementById(m[r].markerId)):(s.setEndBefore((e||document).getElementById(m[r].endMarkerId)),s.setStartAfter((e||document).getElementById(m[r].startMarkerId)));f.setRanges(i);return{win:b,doc:e,rangeInfos:m,restored:!1}}c.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
a.restoreSelection=function(b,d){if(!b.restored){for(var g=b.rangeInfos,f=a.getSelection(b.win),i=[],s=g.length,q=s-1,r,p;0<=q;--q){r=g[q];p=a.createRange(b.doc);if(r.collapsed)if(r=(b.doc||document).getElementById(r.markerId)){r.style.display="inline";var y=r.previousSibling;y&&3==y.nodeType?(r.parentNode.removeChild(r),p.collapseToPoint(y,y.length)):(p.collapseBefore(r),r.parentNode.removeChild(r))}else c.warn("Marker element has been removed. Cannot restore selection.");else e(b.doc,p,r.startMarkerId,
!0),e(b.doc,p,r.endMarkerId,!1);1==s&&p.normalizeBoundaries();i[q]=p}1==s&&d&&a.features.selectionHasExtend&&g[0].backwards?(f.removeAllRanges(),f.addRange(i[0],!0)):f.setRanges(i);b.restored=!0}};a.removeMarkerElement=i;a.removeMarkers=function(a){for(var b=a.rangeInfos,c=0,d=b.length,e;c<d;++c)e=b[c],e.collapsed?i(a.doc,e.markerId):(i(a.doc,e.startMarkerId),i(a.doc,e.endMarkerId))}});
...
(function(a,c){function d(a){var b=S[a]={},c,d,a=a.split(/\s+/);c=0;for(d=a.length;c<d;c++)b[a[c]]=!0;return b}function e(a,b,d){if(d===c&&1===a.nodeType)if(d="data-"+b.replace(K,"-$1").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:h.isNumeric(d)?+d:V.test(d)?h.parseJSON(d):d}catch(j){}h.data(a,b,d)}else d=c;return d}function g(a){for(var b in a)if(!("data"===b&&h.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function i(a,b,c){var d=
...
function m(a){return"undefined"!==typeof a.getElementsByTagName?a.getElementsByTagName("*"):"undefined"!==typeof a.querySelectorAll?a.querySelectorAll("*"):[]}function s(a){if("checkbox"===a.type||"radio"===a.type)a.defaultChecked=a.checked}function q(a){var b=(a.nodeName||"").toLowerCase();"input"===b?s(a):"script"!==b&&"undefined"!==typeof a.getElementsByTagName&&h.grep(a.getElementsByTagName("input"),s)}function r(a,b,c){var d="width"===b?a.offsetWidth:a.offsetHeight,j="width"===b?1:0;if(0<d){if("border"!==
...
slice:function(){return this.pushStack(x.apply(this,arguments),"slice",x.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:Aa,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,b,j,e,J,g=arguments[0]||{},f=1,i=arguments.length,h=!1;"boolean"===typeof g&&(h=g,g=arguments[1]||{},f=2);"object"!==typeof g&&!d.isFunction(g)&&(g=
{});i===f&&(g=this,--f);for(;f<i;f++)if(null!=(a=arguments[f]))for(b in a)j=g[b],e=a[b],g!==e&&(h&&e&&(d.isPlainObject(e)||(J=d.isArray(e)))?(J?(J=!1,j=j&&d.isArray(j)?j:[]):j=j&&d.isPlainObject(j)?j:{},g[b]=d.extend(h,j,e)):e!==c&&(g[b]=e));return g};d.extend({noConflict:function(b){a.$===d&&(a.$=e);b&&a.jQuery===d&&(a.jQuery=j);return d},isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!w.body)return setTimeout(d.ready,
...
(j=new ActiveXObject("Microsoft.XMLDOM"),j.async="false",j.loadXML(b))}catch(J){j=c}(!j||!j.documentElement||j.getElementsByTagName("parsererror").length)&&d.error("Invalid XML: "+b);return j},noop:function(){},globalEval:function(b){b&&i.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(P,"ms-").replace(r,p)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,b,j){var e,J=0,g=a.length,f=g===c||d.isFunction(a);
if(j)if(f)for(e in a){if(!1===b.apply(a[e],j))break}else for(;J<g&&!1!==b.apply(a[J++],j););else if(f)for(e in a){if(!1===b.call(a[e],e,a[e]))break}else for(;J<g&&!1!==b.call(a[J],J,a[J++]););return a},trim:y?function(a){return null==a?"":y.call(a)}:function(a){return null==a?"":a.toString().replace(h,"").replace(k,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var j=d.type(a);null==a.length||"string"===j||"function"===j||"regexp"===j||d.isWindow(a)?Aa.call(c,a):d.merge(c,a)}return c},inArray:function(a,
b,c){var d;if(b){if(t)return t.call(b,a,c);d=b.length;for(c=c?0>c?Math.max(0,d+c):c:0;c<d;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,b){var d=a.length,j=0;if("number"===typeof b.length)for(var e=b.length;j<e;j++)a[d++]=b[j];else for(;b[j]!==c;)a[d++]=b[j++];a.length=d;return a},grep:function(a,b,c){for(var d=[],j,c=!!c,e=0,J=a.length;e<J;e++)j=!!b(a[e],e),c!==j&&d.push(a[e]);return d},map:function(a,b,j){var e,J,g=[],f=0,i=a.length;if(a instanceof d||i!==c&&"number"===typeof i&&(0<
i&&a[0]&&a[i-1]||0===i||d.isArray(a)))for(;f<i;f++)e=b(a[f],f,j),null!=e&&(g[g.length]=e);else for(J in a)e=b(a[J],J,j),null!=e&&(g[g.length]=e);return g.concat.apply([],g)},guid:1,proxy:function(a,b){if("string"===typeof b)var j=a[b],b=a,a=j;if(!d.isFunction(a))return c;var e=x.call(arguments,2),j=function(){return a.apply(b,e.concat(x.call(arguments)))};j.guid=a.guid=a.guid||j.guid||d.guid++;return j},access:function(a,b,j,e,J,g,f){var i,h=null==j,k=0,u=a.length;if(j&&"object"===typeof j){for(k in j)d.access(a,
b,k,j[k],1,g,e);J=1}else if(e!==c){i=f===c&&d.isFunction(e);h&&(i?(i=b,b=function(a,b,c){return i.call(d(a),c)}):(b.call(a,e),b=null));if(b)for(;k<u;k++)b(a[k],j,i?e.call(a[k],k,b(a[k],j)):e,f);J=1}return J?a:h?b.call(a):u?b(a[0],j):g},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=o.exec(a)||s.exec(a)||N.exec(a)||0>a.indexOf("compatible")&&q.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,
...
L.call(arguments,0):b;--f||i.resolveWith(i,d)}}function c(a){return function(b){g[a]=1<arguments.length?L.call(arguments,0):b;i.notifyWith(k,g)}}var d=L.call(arguments,0),j=0,e=d.length,g=Array(e),f=e,i=1>=e&&a&&h.isFunction(a.promise)?a:h.Deferred(),k=i.promise();if(1<e){for(;j<e;j++)d[j]&&d[j].promise&&h.isFunction(d[j].promise)?d[j].promise().then(b(j),i.reject,c(j)):--f;f||i.resolveWith(i,d)}else i!==a&&i.resolveWith(i,e?[a]:[]);return k}});h.support=function(){var b,c,d,j,e,g,f,i,k=w.createElement("div");
...
{set:function(a,b){if(h.isArray(b))return a.checked=h.inArray(h(a).val(),b)>=0}})});var N=/^(?:textarea|input|select)$/i,P=/^([^\.]*)?(?:\.(.+))?$/,U=/(?:^|\s)hover(\.\S+)?\b/,X=/^key/,Z=/^(?:mouse|contextmenu)|click/,ja=/^(?:focusinfocus|focusoutblur)$/,va=/^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/,ma=function(a){if(a=va.exec(a)){a[1]=(a[1]||"").toLowerCase();a[3]=a[3]&&RegExp("(?:^|\\s)"+a[3]+"(?:\\s|$)")}return a},ka=function(a){return h.event.special.hover?a:a.replace(U,"mouseenter$1 mouseleave$1")};
...
e=[].slice.call(arguments,0),g=!b.exclusive&&!b.namespace,f=h.event.special[b.type]||{},i=[],k,u,l,v,m,n,o;e[0]=b;b.delegateTarget=this;if(!(f.preDispatch&&f.preDispatch.call(this,b)===false)){if(j&&!(b.button&&b.type==="click")){l=h(this);l.context=this.ownerDocument||this;for(u=b.target;u!=this;u=u.parentNode||this)if(u.disabled!==true){m={};n=[];l[0]=u;for(k=0;k<j;k++){v=d[k];o=v.selector;if(m[o]===c){var s=m,N=o,q;if(v.quick){q=v.quick;var r=u.attributes||{};q=(!q[1]||u.nodeName.toLowerCase()===
q[1])&&(!q[2]||(r.id||{}).value===q[2])&&(!q[3]||q[3].test((r["class"]||{}).value))}else q=l.is(o);s[N]=q}m[o]&&n.push(v)}n.length&&i.push({elem:u,matches:n})}}d.length>j&&i.push({elem:this,matches:d.slice(j)});for(k=0;k<i.length&&!b.isPropagationStopped();k++){j=i[k];b.currentTarget=j.elem;for(d=0;d<j.matches.length&&!b.isImmediatePropagationStopped();d++){v=j.matches[d];if(g||!b.namespace&&!v.namespace||b.namespace_re&&b.namespace_re.test(v.namespace)){b.data=v.data;b.handleObj=v;v=((h.event.special[v.origType]||
...
postDispatch:function(a){if(a._submit_bubble){delete a._submit_bubble;this.parentNode&&!a.isTrigger&&h.event.simulate("submit",this.parentNode,a,true)}},teardown:function(){if(h.nodeName(this,"form"))return false;h.event.remove(this,"._submit")}});h.support.changeBubbles||(h.event.special.change={setup:function(){if(N.test(this.nodeName)){if(this.type==="checkbox"||this.type==="radio"){h.event.add(this,"propertychange._change",function(a){if(a.originalEvent.propertyName==="checked")this._just_changed=
true});h.event.add(this,"click._change",function(a){if(this._just_changed&&!a.isTrigger){this._just_changed=false;h.event.simulate("change",this,a,true)}})}return false}h.event.add(this,"beforeactivate._change",function(a){a=a.target;if(N.test(a.nodeName)&&!a._change_attached){h.event.add(a,"change._change",function(a){this.parentNode&&!a.isSimulated&&!a.isTrigger&&h.event.simulate("change",this.parentNode,a,true)});a._change_attached=true}})},handle:function(a){var b=a.target;if(this!==b||a.isSimulated||
a.isTrigger||b.type!=="radio"&&b.type!=="checkbox")return a.handleObj.handler.apply(this,arguments)},teardown:function(){h.event.remove(this,"._change");return N.test(this.nodeName)}});h.support.focusinBubbles||h.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){h.event.simulate(b,a.target,h.event.fix(a),true)};h.event.special[b]={setup:function(){c++===0&&w.addEventListener(a,d,true)},teardown:function(){--c===0&&w.removeEventListener(a,d,true)}}});h.fn.extend({on:function(a,
...
function(a,b,c,j){var c=c||[],e=b=b||w;if(b.nodeType!==1&&b.nodeType!==9)return[];if(!a||typeof a!=="string")return c;var f,i,k,h,u,l=true,J=v.isXML(b),m=[],s=a;do{d.exec("");if(f=d.exec(s)){s=f[3];m.push(f[1]);if(f[2]){h=f[3];break}}}while(f);if(m.length>1&&o.exec(a))if(m.length===2&&n.relative[m[0]])i=U(m[0]+m[1],b,j);else for(i=n.relative[m[0]]?[b]:v(m.shift(),b);m.length;){a=m.shift();n.relative[a]&&(a=a+m.shift());i=U(a,i,j)}else{if(!j&&m.length>1&&b.nodeType===9&&!J&&n.match.ID.test(m[0])&&
!n.match.ID.test(m[m.length-1])){f=v.find(m.shift(),b,J);b=f.expr?v.filter(f.expr,f.set)[0]:f.set[0]}if(b){f=j?{expr:m.pop(),set:q(j)}:v.find(m.pop(),m.length===1&&(m[0]==="~"||m[0]==="+")&&b.parentNode?b.parentNode:b,J);i=f.expr?v.filter(f.expr,f.set):f.set;for(m.length>0?k=q(i):l=false;m.length;){f=u=m.pop();n.relative[u]?f=m.pop():u="";f==null&&(f=b);n.relative[u](k,f,J)}}else k=[]}k||(k=i);k||v.error(u||a);if(g.call(k)==="[object Array]")if(l)if(b&&b.nodeType===1)for(a=0;k[a]!=null;a++)k[a]&&
(k[a]===true||k[a].nodeType===1&&v.contains(b,k[a]))&&c.push(i[a]);else for(a=0;k[a]!=null;a++)k[a]&&k[a].nodeType===1&&c.push(i[a]);else c.push.apply(c,k);else q(k,c);if(h){v(h,e,c,j);v.uniqueSort(c)}return c};v.uniqueSort=function(a){if(P){f=i;a.sort(P);if(f)for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1)}return a};v.matches=function(a,b){return v(a,null,null,b)};v.matchesSelector=function(a,b){return v(b,null,null,[a]).length>0};v.find=function(a,b,c){var d,j,e,g,f,i;if(!a)return[];j=
0;for(e=n.order.length;j<e;j++){f=n.order[j];if(g=n.leftMatch[f].exec(a)){i=g[1];g.splice(1,1);if(i.substr(i.length-1)!=="\\"){g[1]=(g[1]||"").replace(k,"");d=n.find[f](g,b,c);if(d!=null){a=a.replace(n.match[f],"");break}}}}d||(d=typeof b.getElementsByTagName!=="undefined"?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};v.filter=function(a,b,d,j){for(var e,g,f,i,k,h,u,l,J=a,m=[],o=b,s=b&&b[0]&&v.isXML(b[0]);a&&b.length;){for(f in n.filter)if((e=n.leftMatch[f].exec(a))!=null&&e[2]){h=n.filter[f];
k=e[1];g=false;e.splice(1,1);if(k.substr(k.length-1)!=="\\"){o===m&&(m=[]);if(n.preFilter[f])if(e=n.preFilter[f](e,o,d,m,j,s)){if(e===true)continue}else g=i=true;if(e)for(u=0;(k=o[u])!=null;u++)if(k){i=h(k,e,u,o);l=j^i;if(d&&i!=null)l?g=true:o[u]=false;else if(l){m.push(k);g=true}}if(i!==c){d||(o=m);a=a.replace(n.match[f],"");if(!g)return[];break}}}if(a===J)if(g==null)v.error(a);else break;J=a}return o};v.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};var m=v.getText=
...
c=v.attr?v.attr(a,c):n.attrHandle[c]?n.attrHandle[c](a):a[c]!=null?a[c]:a.getAttribute(c),d=c+"",j=b[2],e=b[4];return c==null?j==="!=":!j&&v.attr?c!=null:j==="="?d===e:j==="*="?d.indexOf(e)>=0:j==="~="?(" "+d+" ").indexOf(e)>=0:!e?d&&c!==false:j==="!="?d!==e:j==="^="?d.indexOf(e)===0:j==="$="?d.substr(d.length-e.length)===e:j==="|="?d===e||d.substr(0,e.length+1)===e+"-":false},POS:function(a,b,c,d){var j=n.setFilters[b[2]];if(j)return j(a,c,b,d)}}},o=n.match.POS,s=function(a,b){return"\\"+(b-0+1)},
N;for(N in n.match){n.match[N]=RegExp(n.match[N].source+/(?![^\[]*\])(?![^\(]*\))/.source);n.leftMatch[N]=RegExp(/(^(?:.|\r|\n)*?)/.source+n.match[N].source.replace(/\\(\d+)/g,s))}n.match.globalPOS=o;var q=function(a,b){a=Array.prototype.slice.call(a,0);if(b){b.push.apply(b,a);return b}return a};try{Array.prototype.slice.call(w.documentElement.childNodes,0)[0].nodeType}catch(r){q=function(a,b){var c=0,d=b||[];if(g.call(a)==="[object Array]")Array.prototype.push.apply(d,a);else if(typeof a.length===
...
1])&&u.parentNode&&u.parentNode.removeChild(u)}}else f=b.createTextNode(f);var m;if(!h.support.appendChecked)if(f[0]&&typeof(m=f.length)==="number")for(j=0;j<m;j++)q(f[j]);else q(f);f.nodeType?e.push(f):e=h.merge(e,f)}}if(c){a=function(a){return!a.type||Ka.test(a.type)};for(g=0;e[g];g++){b=e[g];if(d&&h.nodeName(b,"script")&&(!b.type||Ka.test(b.type)))d.push(b.parentNode?b.parentNode.removeChild(b):b);else{if(b.nodeType===1){f=h.grep(b.getElementsByTagName("script"),a);e.splice.apply(e,[g+1,0].concat(f))}c.appendChild(b)}}}return e},
...
""?"auto":j});fa=Ma||Na;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){if(c)return a.offsetWidth!==0?r(a,b,d):h.swap(a,lb,function(){return r(a,b,d)})},set:function(a,b){return ib.test(b)?b+"px":b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return gb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,j=h.isNumeric(b)?"alpha(opacity="+b*100+")":"",e=
...
break}}}!G&&!I&&h.error("No conversion from "+E.replace(" "," to "));G!==true&&(v=G?G(v):I(H(v)))}}q=v;l="success";n=true}catch(L){l="parsererror";J=L}}else{J=l;if(!l||a){l="error";a<0&&(a=0)}}p.status=a;p.statusText=""+(b||l);n?f.resolveWith(e,[q,l,p]):f.rejectWith(e,[p,l,J]);p.statusCode(k);k=c;r&&g.trigger("ajax"+(n?"Success":"Error"),[p,j,n?q:J]);i.fireWith(e,[p,l]);if(r){g.trigger("ajaxComplete",[p,j]);--h.active||h.event.trigger("ajaxStop")}}}if(typeof a==="object"){b=a;a=c}var b=b||{},j=h.ajaxSetup({},
b),e=j.context||j,g=e!==j&&(e.nodeType||e instanceof h)?h(e):h.event,f=h.Deferred(),i=h.Callbacks("once memory"),k=j.statusCode||{},u,v={},l={},m,n,o,s,q,N=0,r,P,p={readyState:0,setRequestHeader:function(a,b){if(!N){var c=a.toLowerCase(),a=l[c]=l[c]||a;v[a]=b}return this},getAllResponseHeaders:function(){return N===2?m:null},getResponseHeader:function(a){var b;if(N===2){if(!n)for(n={};b=ob.exec(m);)n[b[1].toLowerCase()]=b[2];b=n[a.toLowerCase()]}return b===c?null:b},overrideMimeType:function(a){if(!N)j.mimeType=
a;return this},abort:function(a){a=a||"abort";o&&o.abort(a);d(0,a);return this}};f.promise(p);p.success=p.done;p.error=p.fail;p.complete=i.add;p.statusCode=function(a){if(a){var b;if(N<2)for(b in a)k[b]=[k[b],a[b]];else{b=a[p.status];p.then(b,b)}}return this};j.url=((a||j.url)+"").replace(nb,"").replace(rb,ea[1]+"//");j.dataTypes=h.trim(j.dataType||"*").toLowerCase().split(La);if(j.crossDomain==null){q=Qa.exec(j.url.toLowerCase());j.crossDomain=!(!q||!(q[1]!=ea[1]||q[2]!=ea[2]||(q[3]||(q[1]==="http:"?
80:443))!=(ea[3]||(ea[1]==="http:"?80:443))))}if(j.data&&j.processData&&typeof j.data!=="string")j.data=h.param(j.data,j.traditional);y(xa,j,b,p);if(N===2)return false;r=j.global;j.type=j.type.toUpperCase();j.hasContent=!qb.test(j.type);r&&h.active++===0&&h.event.trigger("ajaxStart");if(!j.hasContent){if(j.data){j.url=j.url+((Pa.test(j.url)?"&":"?")+j.data);delete j.data}u=j.url;if(j.cache===false){q=h.now();var U=j.url.replace(ub,"$1_="+q);j.url=U+(U===j.url?(Pa.test(j.url)?"&":"?")+"_="+q:"")}}(j.data&&
...
p,j)===false||N===2)){p.abort();return false}for(P in{success:1,error:1,complete:1})p[P](j[P]);if(o=y(Sa,j,b,p)){p.readyState=1;r&&g.trigger("ajaxSend",[p,j]);j.async&&j.timeout>0&&(s=setTimeout(function(){p.abort("timeout")},j.timeout));try{N=1;o.send(v,d)}catch(x){if(N<2)d(-1,x);else throw x;}}else d(-1,"No Transport");return p},param:function(a,b){var d=[],j=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(b===c)b=h.ajaxSettings.traditional;
...
f=d.offset.left,b=f+e.helperProportions.width,k=d.offset.top,l=k+e.helperProportions.height,o=e.snapElements.length-1;0<=o;o--){var n=e.snapElements[o].left,m=n+e.snapElements[o].width,s=e.snapElements[o].top,q=s+e.snapElements[o].height;if(n-i<f&&f<m+i&&s-i<k&&k<q+i||n-i<f&&f<m+i&&s-i<l&&l<q+i||n-i<b&&b<m+i&&s-i<k&&k<q+i||n-i<b&&b<m+i&&s-i<l&&l<q+i){if("inner"!=g.snapMode){var r=Math.abs(s-l)<=i,p=Math.abs(q-k)<=i,y=Math.abs(n-b)<=i,x=Math.abs(m-f)<=i;r&&(d.position.top=e._convertPositionTo("relative",
{top:s-e.helperProportions.height,left:0}).top-e.margins.top);p&&(d.position.top=e._convertPositionTo("relative",{top:q,left:0}).top-e.margins.top);y&&(d.position.left=e._convertPositionTo("relative",{top:0,left:n-e.helperProportions.width}).left-e.margins.left);x&&(d.position.left=e._convertPositionTo("relative",{top:0,left:m}).left-e.margins.left)}var z=r||p||y||x;if("outer"!=g.snapMode&&(r=Math.abs(s-k)<=i,p=Math.abs(q-l)<=i,y=Math.abs(n-f)<=i,x=Math.abs(m-b)<=i,r&&(d.position.top=e._convertPositionTo("relative",
{top:s,left:0}).top-e.margins.top),p&&(d.position.top=e._convertPositionTo("relative",{top:q-e.helperProportions.height,left:0}).top-e.margins.top),y&&(d.position.left=e._convertPositionTo("relative",{top:0,left:n}).left-e.margins.left),x))d.position.left=e._convertPositionTo("relative",{top:0,left:m-e.helperProportions.width}).left-e.margins.left;!e.snapElements[o].snapping&&(r||p||y||x||z)&&e.options.snap.snap&&e.options.snap.snap.call(e.element,c,a.extend(e._uiHash(),{snapItem:e.snapElements[o].item}));
e.snapElements[o].snapping=r||p||y||x||z}else e.snapElements[o].snapping&&e.options.snap.release&&e.options.snap.release.call(e.element,c,a.extend(e._uiHash(),{snapItem:e.snapElements[o].item})),e.snapElements[o].snapping=!1}}});a.ui.plugin.add("draggable","stack",{start:function(){var c=a(this).data("draggable").options,c=a.makeArray(a(c.stack)).sort(function(c,d){return(parseInt(a(c).css("zIndex"),10)||0)-(parseInt(a(d).css("zIndex"),10)||0)});if(c.length){var d=parseInt(c[0].style.zIndex)||0;a(c).each(function(a){this.style.zIndex=
...
c.options.mode||"effect"),o=c.options.restore||!1,n=c.options.scale||"both",m=c.options.origin,s={height:d.height(),width:d.width()};d.from=c.options.from||s;d.to=c.options.to||s;m&&(m=a.effects.getBaseline(m,s),d.from.top=(s.height-d.from.height)*m.y,d.from.left=(s.width-d.from.width)*m.x,d.to.top=(s.height-d.to.height)*m.y,d.to.left=(s.width-d.to.width)*m.x);var q=d.from.height/s.height,r=d.from.width/s.width,p=d.to.height/s.height,y=d.to.width/s.width;if("box"==n||"both"==n)if(q!=p&&(e=e.concat(b),
d.from=a.effects.setTransition(d,b,q,d.from),d.to=a.effects.setTransition(d,b,p,d.to)),r!=y)e=e.concat(k),d.from=a.effects.setTransition(d,k,r,d.from),d.to=a.effects.setTransition(d,k,y,d.to);if(("content"==n||"both"==n)&&q!=p)e=e.concat(f),d.from=a.effects.setTransition(d,f,q,d.from),d.to=a.effects.setTransition(d,f,p,d.to);a.effects.save(d,o?e:g);d.show();a.effects.createWrapper(d);d.css("overflow","hidden").css(d.from);if("content"==n||"both"==n)b=b.concat(["marginTop","marginBottom"]).concat(f),
k=k.concat(["marginLeft","marginRight"]),i=e.concat(b).concat(k),d.find("*[width]").each(function(){var d=a(this);o&&a.effects.save(d,i);var e=d.height(),f=d.width();d.from={height:e*q,width:f*r};d.to={height:e*p,width:f*y};if(q!=p){d.from=a.effects.setTransition(d,b,q,d.from);d.to=a.effects.setTransition(d,b,p,d.to)}if(r!=y){d.from=a.effects.setTransition(d,k,r,d.from);d.to=a.effects.setTransition(d,k,y,d.to)}d.css(d.from);d.animate(d.to,c.duration,c.options.easing,function(){o&&a.effects.restore(d,
...
(i={},i[d]=e);if(f){this._curInst==f&&this._hideDatepicker();var m=this._getDateDatepicker(b,!0),s=this._getMinMaxDate(f,"min"),q=this._getMinMaxDate(f,"max");g(f.settings,i);null!==s&&i.dateFormat!==c&&i.minDate===c&&(f.settings.minDate=this._formatDate(f,s));null!==q&&i.dateFormat!==c&&i.maxDate===c&&(f.settings.maxDate=this._formatDate(f,q));this._attachments(a(b),f);this._autoSize(f);this._setDate(f,m);this._updateAlternate(f);this._updateDatepicker(f)}},_changeDatepicker:function(a,c,d){this._optionDatepicker(a,
...
b.yearshtml;setTimeout(function(){e===b.yearshtml&&b.yearshtml&&b.dpDiv.find("select.ui-datepicker-year:first").replaceWith(b.yearshtml);e=b.yearshtml=null},0)}},_getBorders:function(a){var c=function(a){return{thin:1,medium:2,thick:3}[a]||a};return[parseFloat(c(a.css("border-left-width"))),parseFloat(c(a.css("border-top-width")))]},_checkOffset:function(b,c,d){var e=b.dpDiv.outerWidth(),f=b.dpDiv.outerHeight(),g=b.input?b.input.outerWidth():0,i=b.input?b.input.outerHeight():0,q=document.documentElement.clientWidth+
a(document).scrollLeft(),r=document.documentElement.clientHeight+a(document).scrollTop();c.left-=this._get(b,"isRTL")?e-g:0;c.left-=d&&c.left==b.input.offset().left?a(document).scrollLeft():0;c.top-=d&&c.top==b.input.offset().top+i?a(document).scrollTop():0;c.left-=Math.min(c.left,c.left+e>q&&q>e?Math.abs(c.left+e-q):0);c.top-=Math.min(c.top,c.top+f>r&&r>f?Math.abs(f+i):0);return c},_findPos:function(b){for(var c=this._get(this._getInst(b),"isRTL");b&&("hidden"==b.type||1!=b.nodeType||a.expr.filters.hidden(b));)b=
...
e="string"!=typeof e?e:(new Date).getFullYear()%100+parseInt(e,10),f=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,g=(d?d.dayNames:null)||this._defaults.dayNames,i=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,q=(d?d.monthNames:null)||this._defaults.monthNames,r=d=-1,p=-1,y=-1,x=!1,z=function(a){(a=O+1<b.length&&b.charAt(O+1)==a)&&O++;return a},D=function(a){var b=z(a),a=c.substring(F).match(RegExp("^\\d{1,"+("@"==a?14:"!"==a?20:"y"==a&&b?4:"o"==a?3:2)+"}"));if(!a)throw"Missing number at position "+
...
D("d");break;case "D":A("D",f,g);break;case "o":y=D("o");break;case "m":r=D("m");break;case "M":r=A("M",i,q);break;case "y":d=D("y");break;case "@":var C=new Date(D("@")),d=C.getFullYear(),r=C.getMonth()+1,p=C.getDate();break;case "!":C=new Date((D("!")-this._ticksTo1970)/1E4);d=C.getFullYear();r=C.getMonth()+1;p=C.getDate();break;case "'":z("'")?B():x=!0;break;default:B()}if(F<c.length)throw"Extra/unparsed characters found in date: "+c.substring(F);-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-
(new Date).getFullYear()%100+(d<=e?0:-100));if(-1<y){r=1;p=y;do{e=this._getDaysInMonth(d,r-1);if(p<=e)break;r++;p-=e}while(1)}C=this._daylightSavingAdjust(new Date(d,r-1,p));if(C.getFullYear()!=d||C.getMonth()+1!=r||C.getDate()!=p)throw"Invalid date";return C},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:864E9*(718685+Math.floor(492.5)-
Math.floor(19.7)+Math.floor(4.925)),formatDate:function(a,c,d){if(!c)return"";var e=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,f=(d?d.dayNames:null)||this._defaults.dayNames,g=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,d=(d?d.monthNames:null)||this._defaults.monthNames,i=function(c){(c=x+1<a.length&&a.charAt(x+1)==c)&&x++;return c},q=function(a,b,c){b=""+b;if(i(a))for(;b.length<c;)b="0"+b;return b},r=function(a,b,c,d){return i(a)?d[b]:c[b]},p="",y=!1;if(c)for(var x=0;x<
a.length;x++)if(y)"'"==a.charAt(x)&&!i("'")?y=!1:p+=a.charAt(x);else switch(a.charAt(x)){case "d":p+=q("d",c.getDate(),2);break;case "D":p+=r("D",c.getDay(),e,f);break;case "o":p+=q("o",Math.round(((new Date(c.getFullYear(),c.getMonth(),c.getDate())).getTime()-(new Date(c.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":p+=q("m",c.getMonth()+1,2);break;case "M":p+=r("M",c.getMonth(),g,d);break;case "y":p+=i("y")?c.getFullYear():(10>c.getYear()%100?"0":"")+c.getYear()%100;break;case "@":p+=
...
g=this._get(b,"navigationAsDateFormat"),s=this._getNumberOfMonths(b),q=this._get(b,"showCurrentAtPos"),r=this._get(b,"stepMonths"),p=1!=s[0]||1!=s[1],y=this._daylightSavingAdjust(!b.currentDay?new Date(9999,9,9):new Date(b.currentYear,b.currentMonth,b.currentDay)),x=this._getMinMaxDate(b,"min"),z=this._getMinMaxDate(b,"max"),q=b.drawMonth-q,D=b.drawYear;0>q&&(q+=12,D--);if(z)for(var A=this._daylightSavingAdjust(new Date(z.getFullYear(),z.getMonth()-s[0]*s[1]+1,z.getDate())),A=x&&A<x?x:A;this._daylightSavingAdjust(new Date(D,
q,1))>A;)q--,0>q&&(q=11,D--);b.drawMonth=q;b.drawYear=D;var A=this._get(b,"prevText"),A=!g?A:this.formatDate(A,this._daylightSavingAdjust(new Date(D,q-r,1)),this._getFormatConfig(b)),A=this._canAdjustMonth(b,-1,D,q)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', -"+r+", 'M');\" title=\""+A+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+A+"</span></a>":f?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+
A+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+A+"</span></a>",B=this._get(b,"nextText"),B=!g?B:this.formatDate(B,this._daylightSavingAdjust(new Date(D,q+r,1)),this._getFormatConfig(b)),f=this._canAdjustMonth(b,1,D,q)?'<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', +"+r+", 'M');\" title=\""+B+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+B+"</span></a>":f?"":'<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+
B+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+B+"</span></a>",r=this._get(b,"currentText"),B=this._get(b,"gotoCurrent")&&b.currentDay?y:c,r=!g?r:this.formatDate(r,B,this._getFormatConfig(b)),g=!b.inline?'<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_'+i+'.datepicker._hideDatepicker();">'+this._get(b,"closeText")+"</button>":"",e=e?'<div class="ui-datepicker-buttonpane ui-widget-content">'+(d?g:"")+(this._isInRange(b,
B)?'<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._gotoToday('#"+b.id+"');\">"+r+"</button>":"")+(d?"":g)+"</div>":"",g=parseInt(this._get(b,"firstDay"),10),g=isNaN(g)?0:g,r=this._get(b,"showWeek"),B=this._get(b,"dayNames");this._get(b,"dayNamesShort");var F=this._get(b,"dayNamesMin"),O=this._get(b,"monthNames"),C=this._get(b,"monthNamesShort"),w=this._get(b,"beforeShowDay"),R=this._get(b,"showOtherMonths"),
G=this._get(b,"selectOtherMonths");this._get(b,"calculateWeek");for(var h=this._getDefaultDate(b),S="",L=0;L<s[0];L++){var V="";this.maxRows=4;for(var K=0;K<s[1];K++){var t=this._daylightSavingAdjust(new Date(D,q,b.selectedDay)),H=" ui-corner-all",E="";if(p){E+='<div class="ui-datepicker-group';if(1<s[1])switch(K){case 0:E+=" ui-datepicker-group-first";H=" ui-corner-"+(d?"right":"left");break;case s[1]-1:E+=" ui-datepicker-group-last";H=" ui-corner-"+(d?"left":"right");break;default:E+=" ui-datepicker-group-middle",
H=""}E+='">'}for(var E=E+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+H+'">'+(/all|left/.test(H)&&0==L?d?f:A:"")+(/all|right/.test(H)&&0==L?d?A:f:"")+this._generateMonthYearHeader(b,q,D,x,z,0<L||0<K,O,C)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),M=r?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":"",H=0;7>H;H++)var I=(H+g)%7,M=M+("<th"+(5<=(H+g+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+B[I]+'">'+F[I]+"</span></th>");
E+=M+"</tr></thead><tbody>";M=this._getDaysInMonth(D,q);D==b.selectedYear&&q==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,M));H=(this._getFirstDayOfMonth(D,q)-g+7)%7;M=Math.ceil((H+M)/7);this.maxRows=M=p?this.maxRows>M?this.maxRows:M:M;for(var I=this._daylightSavingAdjust(new Date(D,q,1-H)),T=0;T<M;T++){for(var E=E+"<tr>",Y=!r?"":'<td class="ui-datepicker-week-col">'+this._get(b,"calculateWeek")(I)+"</td>",H=0;7>H;H++){var Q=w?w.apply(b.input?b.input[0]:null,[I]):[!0,""],j=I.getMonth()!=
q,u=j&&!G||!Q[0]||x&&I<x||z&&I>z,Y=Y+('<td class="'+(5<=(H+g+6)%7?" ui-datepicker-week-end":"")+(j?" ui-datepicker-other-month":"")+(I.getTime()==t.getTime()&&q==b.selectedMonth&&b._keyEvent||h.getTime()==I.getTime()&&h.getTime()==t.getTime()?" "+this._dayOverClass:"")+(u?" "+this._unselectableClass+" ui-state-disabled":"")+(j&&!R?"":" "+Q[1]+(I.getTime()==y.getTime()?" "+this._currentClass:"")+(I.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!j||R)&&Q[2]?' title="'+Q[2]+'"':"")+(u?"":
' onclick="DP_jQuery_'+i+".datepicker._selectDay('#"+b.id+"',"+I.getMonth()+","+I.getFullYear()+', this);return false;"')+">"+(j&&!R?"&#xa0;":u?'<span class="ui-state-default">'+I.getDate()+"</span>":'<a class="ui-state-default'+(I.getTime()==c.getTime()?" ui-state-highlight":"")+(I.getTime()==y.getTime()?" ui-state-active":"")+(j?" ui-priority-secondary":"")+'" href="#">'+I.getDate()+"</a>")+"</td>");I.setDate(I.getDate()+1);I=this._daylightSavingAdjust(I)}E+=Y+"</tr>"}q++;11<q&&(q=0,D++);E+="</tbody></table>"+
(p?"</div>"+(0<s[0]&&K==s[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");V+=E}S+=V}S+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return S},_generateMonthYearHeader:function(a,c,d,e,f,g,s,q){var r=this._get(a,"changeMonth"),p=this._get(a,"changeYear"),y=this._get(a,"showMonthAfterYear"),x='<div class="ui-datepicker-title">',z="";if(g||!r)z+='<span class="ui-datepicker-month">'+
s[c]+"</span>";else{for(var s=e&&e.getFullYear()==d,D=f&&f.getFullYear()==d,z=z+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),A=0;12>A;A++)if((!s||A>=e.getMonth())&&(!D||A<=f.getMonth()))z+='<option value="'+A+'"'+(A==c?' selected="selected"':"")+">"+q[A]+"</option>";z+="</select>"}y||(x+=z+(g||!r||!p?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",g||!p)x+='<span class="ui-datepicker-year">'+d+"</span>";else{var q=this._get(a,
"yearRange").split(":"),B=(new Date).getFullYear(),s=function(a){a=a.match(/c[+-].*/)?d+parseInt(a.substring(1),10):a.match(/[+-].*/)?B+parseInt(a,10):parseInt(a,10);return isNaN(a)?B:a},c=s(q[0]),q=Math.max(c,s(q[1]||"")),c=e?Math.max(c,e.getFullYear()):c,q=f?Math.min(q,f.getFullYear()):q;for(a.yearshtml+='<select class="ui-datepicker-year" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'Y');\" >";c<=q;c++)a.yearshtml+='<option value="'+c+'"'+(c==d?' selected="selected"':
"")+">"+c+"</option>";a.yearshtml+="</select>";x+=a.yearshtml;a.yearshtml=null}x+=this._get(a,"yearSuffix");y&&(x+=(g||!r||!p?"&#xa0;":"")+z);return x+"</div>"},_adjustInstDate:function(a,c,d){var e=a.drawYear+("Y"==d?c:0),f=a.drawMonth+("M"==d?c:0),c=Math.min(a.selectedDay,this._getDaysInMonth(e,f))+("D"==d?c:0),e=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(e,f,c)));a.selectedDay=e.getDate();a.drawMonth=a.selectedMonth=e.getMonth();a.drawYear=a.selectedYear=e.getFullYear();("M"==d||
...
(function(a){a.ui=a.ui||{};var c=/left|center|right/,d=/top|center|bottom/,e,g=a.fn.position,i=a.fn.offset;a.fn.position=function(f){if(!f||!f.of)return g.apply(this,arguments);var f=a.extend({},f),b=a(f.of),i=b[0],l=(f.collision||"flip").split(" "),o=f.offset?f.offset.split(" "):[0,0],n,m,s;9===i.nodeType?(n=b.width(),m=b.height(),s={top:0,left:0}):i.setTimeout?(n=b.width(),m=b.height(),s={top:b.scrollTop(),left:b.scrollLeft()}):i.preventDefault?(f.at="left top",n=m=0,s={top:f.of.pageY,left:f.of.pageX}):
(n=b.outerWidth(),m=b.outerHeight(),s=b.offset());a.each(["my","at"],function(){var a=(f[this]||"").split(" ");a.length===1&&(a=c.test(a[0])?a.concat(["center"]):d.test(a[0])?["center"].concat(a):["center","center"]);a[0]=c.test(a[0])?a[0]:"center";a[1]=d.test(a[1])?a[1]:"center";f[this]=a});1===l.length&&(l[1]=l[0]);o[0]=parseInt(o[0],10)||0;1===o.length&&(o[1]=o[0]);o[1]=parseInt(o[1],10)||0;"right"===f.at[0]?s.left+=n:"center"===f.at[0]&&(s.left+=n/2);"bottom"===f.at[1]?s.top+=m:"center"===f.at[1]&&
(s.top+=m/2);s.left+=o[0];s.top+=o[1];return this.each(function(){var b=a(this),c=b.outerWidth(),d=b.outerHeight(),g=parseInt(a.curCSS(this,"marginLeft",true))||0,i=parseInt(a.curCSS(this,"marginTop",true))||0,k=c+g+(parseInt(a.curCSS(this,"marginRight",true))||0),D=d+i+(parseInt(a.curCSS(this,"marginBottom",true))||0),A=a.extend({},s),B;if(f.my[0]==="right")A.left=A.left-c;else if(f.my[0]==="center")A.left=A.left-c/2;if(f.my[1]==="bottom")A.top=A.top-d;else if(f.my[1]==="center")A.top=A.top-d/2;
...
-1;b.cookie&&f._cookie(b.selected,b.cookie);f.element.queue("tabs",function(){q(c,e)}).dequeue("tabs");this.blur();return false}if(!e.length){b.cookie&&f._cookie(b.selected,b.cookie);f.element.queue("tabs",function(){s(c,g)});f.load(f.anchors.index(this));this.blur();return false}}b.cookie&&f._cookie(b.selected,b.cookie);if(g.length){e.length&&f.element.queue("tabs",function(){q(c,e)});f.element.queue("tabs",function(){s(c,g)});f.load(f.anchors.index(this))}else throw"jQuery UI Tabs: Mismatching fragment identifier.";
...
(function(a,c,d,e){function g(a,b,c){M[a]=c;I[a]=b;E||(E=a)}function i(b){E!==b&&(E=b,a.ui.editor.eachInstance(function(){this.reinit()}))}function f(a,b){E&&M[E]&&M[E][a]&&(a=M[E][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function b(b){if(T===e){T=!0;if(Y=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(b.options.baseClass+"-ios"),Y&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height",
...
return d}function s(b,c){var d=a("<div/>").append(b)[0].childNodes;c.deleteContents();d.length===e||1===d.length?c.insertNode(d[0].cloneNode(!0)):a.each(d,function(a,b){c.insertNodeAtEnd(b.cloneNode(!0))})}function q(b){var b=b||d.getSelection(),c;a(b.getAllRanges()).each(function(b,d){c=3===this.commonAncestorContainer.nodeType?a(d.commonAncestorContainer).parent()[0]:d.commonAncestorContainer});return c}function r(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer}function p(a){if(!Q||
a)Q=d.saveSelection()}function y(){Q&&(d.restoreSelection(Q),Q=!1)}function x(){Q&&d.removeMarkers(Q);Q=!1}function z(a,b,c){for(var b=b||d.getSelection(),e,f=0;e=b.getAllRanges()[f++];)a.call(c,e)}function D(a,b){z(function(b){s(a,b)},b,this)}function A(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).focus().contents().each(function(){var a=d.createRange();a.selectNodeContents(this);c.addRange(a)})}function B(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();
...
a.getElement())}})}},alignCenter:{init:function(a){return a.uiButton({title:f("Center Align"),click:function(){a.toggleBlockStyle({"text-align":"center"},a.getElement())}})}},alignRight:{init:function(a){return a.uiButton({title:f("Right Align"),click:function(){a.toggleBlockStyle({"text-align":"right"},a.getElement())}})}}});a.ui.editor.registerUi({textBold:{hotkeys:{"ctrl+b":{action:function(){this.ui.click()}}},init:function(a,b){return this.editor.uiButton({title:f("Bold"),click:function(){L("strong",
{classes:b.classes||b.cssPrefix+"bold"})}})}},textItalic:{hotkeys:{"ctrl+i":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:f("Italic"),click:function(){L("em",{classes:b.classes||b.cssPrefix+"italic"})}})}},textUnderline:{hotkeys:{"ctrl+u":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:f("Underline"),click:function(){L("u",{classes:b.classes||b.cssPrefix+"underline"})}})}},textStrike:{hotkeys:{"ctrl+k":{action:function(){this.ui.click()}}},
init:function(a,b){return a.uiButton({title:f("Strikethrough"),click:function(){L("del",{classes:b.classes||b.cssPrefix+"strike"})}})}},textSub:{init:function(a,b){return a.uiButton({title:f("Sub script"),click:function(){L("sub",{classes:b.classes||b.cssPrefix+"sub"})}})}},textSuper:{init:function(a,b){return a.uiButton({title:f("Super script"),click:function(){L("sup",{classes:b.classes||b.cssPrefix+"super"})}})}}});a.ui.editor.registerUi({quoteBlock:{init:function(a,b){return a.uiButton({title:f("Blockquote"),
icon:"ui-icon-quote",click:function(){L("blockquote",{classes:b.classes||b.cssPrefix+"blockquote"})}})}}});a.ui.editor.registerUi({cancel:{hotkeys:{esc:{action:function(){this.confirm()}}},init:function(a){return a.uiButton({name:"cancel",title:f("Cancel"),icons:{primary:"ui-icon-cancel"},dialog:null,click:function(){this.confirm()}})},confirm:function(){var b=this.editor.getPlugin("cancel"),c=this.editor;c.isDirty()?(this.dialog||(this.dialog=a(c.getTemplate("cancel.dialog"))),this.dialog.dialog({modal:!0,
...
this.editor.widgetName,this.buttonOut);return this.button},destroyButton:function(){"undefined"===typeof this.button||!1===this.button||(this.button.button("destroy").remove(),this.button=!1)}});a.ui.editor.registerUi("colorPickerBasic",{init:function(b){b.bind("selectionChange",this.change,this);b.bind("show",this.change,this);var c=this;return b.uiSelectMenu({name:"colorPickerBasic",title:f("Change the color of the selected text."),select:a(b.getTemplate("color-picker-basic.menu")),change:function(b){"automatic"===
b?G().parents("."+c.options.cssPrefix+"color").andSelf().each(function(){var b=a(this),c=a(this).attr("class").match(/(cms-(.*?))( |$)/ig);a.each(c,function(c,d){d=a.trim(d);b.removeClass(d)})}):L("span",{classes:c.options.classes||c.options.cssPrefix+"color "+c.options.cssPrefix+b})}})},change:function(){this.ui.val("automatic");var b=G()[0];if(b&&(b=a(b).closest("."+this.options.cssPrefix+"color"))){var c=b.attr("class");c&&(c=b.attr("class").replace(RegExp(this.options.cssPrefix+"color","g"),""),
...
click:function(){D("<hr/>")}})}}});a.ui.editor.registerUi({i18n:{init:function(b){var c=this,d=this.persist("locale");d&&i(d);var d=a('<select autocomplete="off" name="i18n"/>'),e;for(e in M){var g=a('<option value="'+e+'" class="'+e+'"/>');g.html(I[e]);E===e&&g.attr("selected","selected");d.append(g)}return b.uiSelectMenu({title:f("Change Language"),select:d,change:function(a){i(c.persist("locale",a))}})}}});g("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.",
...
this.editor.getElement();var f=S();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(a(e).is(b)&&a(f).is(b)&&e===f)return d(!0);var g=a(e).parentsUntil(i,b).first()&&a(f).parentsUntil(i,b).first(),i="#"+this.editor.getElement().attr("id"),k=a(e).is(b+" > li")||a(e).parentsUntil(i,b+" > li").length,l=a(f).is(b+" > li")||a(f).parentsUntil(i,b+" > li").length;if(k&&l&&g){g=a(q());g.is(b)||(g=a(g).parentsUntil(i,b).first());i=g.find("ul, ol");if(!i.length)return d(!0);for(g=0;g<i.length;g++)if(a.contains(i[g],
