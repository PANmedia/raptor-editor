/*! VERSION: 0.0.10 *//*
 ...
 Build date: 26 February 2012
*/
window.rangy=function(){function a(a,b){var c=typeof a[b];return c==l||!!(c==k&&a[b])||"unknown"==c}function c(a,b){return!!(typeof a[b]==k&&a[b])}function d(a,b){return typeof a[b]!=p}function e(a){return function(b,c){for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0}}function f(a){return a&&q(a,r)&&x(a,t)}function j(a){window.alert("Rangy not supported in your browser. Reason: "+a);v.initialized=!0;v.supported=!1}function g(){if(!v.initialized){var b,d=!1,e=!1;a(document,"createRange")&&
(b=document.createRange(),q(b,m)&&x(b,o)&&(d=!0),b.detach());if((b=c(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(b,"createTextRange"))b=b.createTextRange(),f(b)&&(e=!0);!d&&!e&&j("Neither Range nor TextRange are implemented");v.initialized=!0;v.features={implementsDomRange:d,implementsTextRange:e};d=E.concat(y);e=0;for(b=d.length;e<b;++e)try{d[e](v)}catch(k){c(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
...
t="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),r="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),q=e(a),s=e(c),x=e(d),v={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:a,isHostObject:c,isHostProperty:d,areHostMethods:q,areHostObjects:s,areHostProperties:x,isTextRange:f},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
v.fail=j;v.warn=function(a){a="Rangy warning: "+a;v.config.alertOnWarn?window.alert(a):typeof window.console!=p&&typeof window.console.log!=p&&window.console.log(a)};({}).hasOwnProperty?v.util.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])}:j("hasOwnProperty not supported");var y=[],E=[];v.init=g;v.addInitListener=function(a){v.initialized?a(v):y.push(a)};var z=[];v.addCreateMissingNativeApiListener=function(a){z.push(a)};v.createMissingNativeApi=function(a){a=a||window;g();
for(var b=0,c=z.length;b<c;++b)z[b](a)};b.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};b.prototype.warn=function(a){v.warn("Module "+this.name+": "+a)};b.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};v.createModule=function(a,c){var d=new b(a);v.modules[a]=d;E.push(function(a){c(a,d);d.initialized=!0;d.supported=!0})};v.requireModules=function(a){for(var c=0,d=a.length,f,e;c<
d;++c){e=a[c];f=v.modules[e];if(!f||!(f instanceof b))throw Error("Module '"+e+"' not found");if(!f.supported)throw Error("Module '"+e+"' not supported");}};var A=!1,s=function(){A||(A=!0,v.initialized||g())};if(typeof window==p)j("No window found");else if(typeof document==p)j("No document found");else return a(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",s,!1),a(window,"addEventListener")?window.addEventListener("load",s,!1):a(window,"attachEvent")?window.attachEvent("onload",
s):j("Window does not have required addEventListener or attachEvent method"),v}();
...
if(typeof a.ownerDocument!=m)return a.ownerDocument;if(typeof a.document!=m)return a.document;if(a.parentNode)return b(a.parentNode);throw Error("getDocument: no document found for node");}function k(a){return!a?"[No node]":j(a)?'"'+a.data+'"':1==a.nodeType?"<"+a.nodeName+(a.id?' id="'+a.id+'"':"")+">["+a.childNodes.length+"]":a.nodeName}function l(a){this._next=this.root=a}function p(a,b){this.node=a;this.offset=b}function o(a){this.code=this[a];this.codeName=a;this.message="DOMException: "+this.codeName}
var m="undefined",t=a.util;t.areHostMethods(document,["createDocumentFragment","createElement","createTextNode"])||c.fail("document missing a Node creation method");t.isHostMethod(document,"getElementsByTagName")||c.fail("document missing getElementsByTagName method");var r=document.createElement("div");t.areHostMethods(r,["insertBefore","appendChild","cloneNode"])||c.fail("Incomplete Element implementation");t.isHostProperty(r,"innerHTML")||c.fail("Element is missing innerHTML property");r=document.createTextNode("test");
t.areHostMethods(r,["splitText","deleteData","insertData","appendData","cloneNode"])||c.fail("Incomplete Text Node implementation");var q=function(a,b){for(var c=a.length;c--;)if(a[c]===b)return!0;return!1};l.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){var a=this._current=this._next,b;if(this._current){b=a.firstChild;if(!b)for(b=null;a!==this.root&&!(b=a.nextSibling);)a=a.parentNode;this._next=b}return this._current},detach:function(){this._current=this._next=this.root=
null}};p.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+k(this.node)+":"+this.offset+")]"}};o.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};o.prototype.toString=function(){return this.message};a.dom={arrayContains:q,isHtmlNamespace:function(a){var b;return typeof a.namespaceURI==m||null===(b=a.namespaceURI)||"http://www.w3.org/1999/xhtml"==
b},parentElement:function(a){a=a.parentNode;return 1==a.nodeType?a:null},getNodeIndex:d,getNodeLength:function(a){var b;return j(a)?a.length:(b=a.childNodes)?b.length:0},getCommonAncestor:e,isAncestorOf:function(a,b,c){for(b=c?b:b.parentNode;b;){if(b===a)return!0;b=b.parentNode}return!1},getClosestAncestorIn:f,isCharacterDataNode:j,insertAfter:g,splitDataNode:function(a,b){var c=a.cloneNode(!1);c.deleteData(0,b);a.deleteData(b,a.length-b);g(c,a);return c},getDocument:b,getWindow:function(a){a=b(a);
...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(a){return t.isHostObject(a,"body")?a.body:a.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var b;b=a.parentNode;)a=b;return a},comparePoints:function(a,b,c,k){var g;if(a==c)return b===k?0:b<k?-1:1;if(g=f(c,a,!0))return b<=d(g)?-1:1;if(g=f(a,c,!0))return d(g)<k?-1:1;b=e(a,c);a=a===b?b:f(a,b,!0);c=c===b?b:f(c,b,!0);if(a===c)throw Error("comparePoints got to case 4 and childA and childB are the same!");
for(b=b.firstChild;b;){if(b===a)return-1;if(b===c)return 1;b=b.nextSibling}throw Error("Should not be here!");},inspectNode:k,fragmentFromNodeChildren:function(a){for(var c=b(a).createDocumentFragment(),d;d=a.firstChild;)c.appendChild(d);return c},createIterator:function(a){return new l(a)},DomPosition:p};a.DOMException=o});
rangy.createModule("DomRange",function(a){function c(a,b){return 3!=a.nodeType&&(n.isAncestorOf(a,b.startContainer,!0)||n.isAncestorOf(a,b.endContainer,!0))}function d(a){return n.getDocument(a.startContainer)}function e(a,b,c){if(b=a._listeners[b])for(var d=0,i=b.length;d<i;++d)b[d].call(a,{target:a,args:c})}function f(a){return new w(a.parentNode,n.getNodeIndex(a))}function j(a){return new w(a.parentNode,n.getNodeIndex(a)+1)}function g(a,b,c){var d=11==a.nodeType?a.firstChild:a;n.isCharacterDataNode(b)?
c==b.length?n.insertAfter(a,b):b.parentNode.insertBefore(a,0==c?b:n.splitDataNode(b,c)):c>=b.childNodes.length?b.appendChild(a):b.insertBefore(a,b.childNodes[c]);return d}function b(a){for(var c,i,h=d(a.range).createDocumentFragment();i=a.next();){c=a.isPartiallySelectedSubtree();i=i.cloneNode(!c);c&&(c=a.getSubtreeIterator(),i.appendChild(b(c)),c.detach(!0));if(10==i.nodeType)throw new C("HIERARCHY_REQUEST_ERR");h.appendChild(i)}return h}function k(a,b,c){for(var d,i,c=c||{stop:!1};d=a.next();)if(a.isPartiallySelectedSubtree())if(!1===
b(d)){c.stop=!0;break}else{if(d=a.getSubtreeIterator(),k(d,b,c),d.detach(!0),c.stop)break}else for(d=n.createIterator(d);i=d.next();)if(!1===b(i)){c.stop=!0;return}}function l(a){for(var b;a.next();)a.isPartiallySelectedSubtree()?(b=a.getSubtreeIterator(),l(b),b.detach(!0)):a.remove()}function p(a){for(var b,c=d(a.range).createDocumentFragment(),i;b=a.next();){a.isPartiallySelectedSubtree()?(b=b.cloneNode(!1),i=a.getSubtreeIterator(),b.appendChild(p(i)),i.detach(!0)):a.remove();if(10==b.nodeType)throw new C("HIERARCHY_REQUEST_ERR");
c.appendChild(b)}return c}function o(a,b,c){var d=!(!b||!b.length),i,h=!!c;d&&(i=RegExp("^("+b.join("|")+")$"));var f=[];k(new t(a,!1),function(a){(!d||i.test(a.nodeType))&&(!h||c(a))&&f.push(a)});return f}function m(a){return"["+("undefined"==typeof a.getName?"Range":a.getName())+"("+n.inspectNode(a.startContainer)+":"+a.startOffset+", "+n.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function t(a,b){this.range=a;this.clonePartiallySelectedTextNodes=b;if(!a.collapsed){this.sc=a.startContainer;
...
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function q(a,b,c){this.nodes=o(a,b,c);this._next=this.nodes[0];this._position=0}function s(a){return function(b,c){for(var d,i=c?b:b.parentNode;i;){d=i.nodeType;if(n.arrayContains(a,d))return i;i=i.parentNode}return null}}function x(a,b){if(la(a,b))throw new r("INVALID_NODE_TYPE_ERR");}function v(a){if(!a.startContainer)throw new C("INVALID_STATE_ERR");}function y(a,b){if(!n.arrayContains(b,a.nodeType))throw new r("INVALID_NODE_TYPE_ERR");
}function E(a,b){if(0>b||b>(n.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new C("INDEX_SIZE_ERR");}function z(a,b){if(K(a,!0)!==K(b,!0))throw new C("WRONG_DOCUMENT_ERR");}function A(a){if(W(a,!0))throw new C("NO_MODIFICATION_ALLOWED_ERR");}function F(a,b){if(!a)throw new C(b);}function J(a){return!!a.startContainer&&!!a.endContainer&&!(!n.arrayContains(G,a.startContainer.nodeType)&&!K(a.startContainer,!0))&&!(!n.arrayContains(G,a.endContainer.nodeType)&&!K(a.endContainer,!0))&&a.startOffset<=
(n.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(n.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function D(a){v(a);if(!J(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function u(){}function I(a){a.START_TO_START=ga;a.START_TO_END=ha;a.END_TO_END=va;a.END_TO_START=ma;a.NODE_BEFORE=ia;a.NODE_AFTER=na;a.NODE_BEFORE_AND_AFTER=oa;a.NODE_INSIDE=
ja}function M(a){I(a);I(a.prototype)}function h(a,b){return function(){D(this);var c=this.startContainer,d=this.startOffset,i=this.commonAncestorContainer,h=new t(this,!0);c!==i&&(c=n.getClosestAncestorIn(c,i,!0),d=j(c),c=d.node,d=d.offset);k(h,A);h.reset();i=a(h);h.detach();b(this,c,d,c,d);return i}}function P(b,d,i){function e(a,b){return function(c){v(this);y(c,H);y(N(c),G);c=(a?f:j)(c);(b?k:g)(this,c.node,c.offset)}}function k(a,b,c){var i=a.endContainer,h=a.endOffset;if(b!==a.startContainer||
c!==a.startOffset){if(N(b)!=N(i)||1==n.comparePoints(b,c,i,h))i=b,h=c;d(a,b,c,i,h)}}function g(a,b,c){var i=a.startContainer,h=a.startOffset;if(b!==a.endContainer||c!==a.endOffset){if(N(b)!=N(i)||-1==n.comparePoints(b,c,i,h))i=b,h=c;d(a,i,h,b,c)}}b.prototype=new u;a.util.extend(b.prototype,{setStart:function(a,b){v(this);x(a,!0);E(a,b);k(this,a,b)},setEnd:function(a,b){v(this);x(a,!0);E(a,b);g(this,a,b)},setStartBefore:e(!0,!0),setStartAfter:e(!1,!0),setEndBefore:e(!0,!1),setEndAfter:e(!1,!1),collapse:function(a){D(this);
a?d(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):d(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){v(this);x(a,!0);d(this,a,0,a,n.getNodeLength(a))},selectNode:function(a){v(this);x(a,!1);y(a,H);var b=f(a),a=j(a);d(this,b.node,b.offset,a.node,a.offset)},extractContents:h(p,d),deleteContents:h(l,d),canSurroundContents:function(){D(this);A(this.startContainer);A(this.endContainer);var a=new t(this,!0),b=a._first&&
c(a._first,this)||a._last&&c(a._last,this);a.detach();return!b},detach:function(){i(this)},splitBoundaries:function(){D(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,i=this.endOffset,h=a===c;n.isCharacterDataNode(c)&&0<i&&i<c.length&&n.splitDataNode(c,i);n.isCharacterDataNode(a)&&0<b&&b<a.length&&(a=n.splitDataNode(a,b),h?(i-=b,c=a):c==a.parentNode&&i>=n.getNodeIndex(a)&&i++,b=0);d(this,a,b,c,i)},normalizeBoundaries:function(){D(this);var a=this.startContainer,b=this.startOffset,
c=this.endContainer,i=this.endOffset,h=function(a){var b=a.nextSibling;b&&b.nodeType==a.nodeType&&(c=a,i=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},f=function(d){var h=d.previousSibling;if(h&&h.nodeType==d.nodeType){a=d;var f=d.length;b=h.length;d.insertData(0,h.data);h.parentNode.removeChild(h);a==c?(i+=b,c=a):c==d.parentNode&&(h=n.getNodeIndex(d),i==h?(c=d,i=f):i>h&&i--)}},e=!0;n.isCharacterDataNode(c)?c.length==i&&h(c):(0<i&&(e=c.childNodes[i-1])&&n.isCharacterDataNode(e)&&h(e),
e=!this.collapsed);e?n.isCharacterDataNode(a)?0==b&&f(a):b<a.childNodes.length&&(h=a.childNodes[b])&&n.isCharacterDataNode(h)&&f(h):(a=c,b=i);d(this,a,b,c,i)},collapseToPoint:function(a,b){v(this);x(a,!0);E(a,b);(a!==this.startContainer||b!==this.startOffset||a!==this.endContainer||b!==this.endOffset)&&d(this,a,b,a,b)}});M(b)}function O(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:n.getCommonAncestor(a.startContainer,
a.endContainer)}function R(a,b,c,d,i){var h=a.startContainer!==b||a.startOffset!==c,f=a.endContainer!==d||a.endOffset!==i;a.startContainer=b;a.startOffset=c;a.endContainer=d;a.endOffset=i;O(a);e(a,"boundarychange",{startMoved:h,endMoved:f})}function i(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};O(this)}a.requireModules(["DomUtil"]);var n=a.dom,w=n.DomPosition,C=a.DOMException;t.prototype={_current:null,_next:null,_first:null,
...
(a===this.sc||a===this.ec)?(b=a===this.sc?this.so:0,c=a===this.ec?this.eo:a.length,b!=c&&a.deleteData(b,c-b)):a.parentNode&&a.parentNode.removeChild(a)},isPartiallySelectedSubtree:function(){return c(this._current,this.range)},getSubtreeIterator:function(){var a;if(this.isSingleCharacterDataNode)a=this.range.cloneRange(),a.collapse();else{a=new i(d(this.range));var b=this._current,c=b,h=0,f=b,e=n.getNodeLength(b);n.isAncestorOf(b,this.sc,!0)&&(c=this.sc,h=this.so);n.isAncestorOf(b,this.ec,!0)&&(f=
this.ec,e=this.eo);R(a,c,h,f,e)}return new t(a,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};r.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};r.prototype.toString=function(){return this.message};q.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
detach:function(){this._current=this._next=this.nodes=null}};var H=[1,3,4,5,7,8,10],G=[2,9,11],L=[1,3,4,5,7,8,10,11],S=[1,3,4,5,7,8],N=n.getRootContainer,K=s([9,11]),W=s([5,6,10,12]),la=s([6,10,12]),$=document.createElement("style"),aa=!1;try{$.innerHTML="<b>x</b>",aa=3==$.firstChild.nodeType}catch(La){}a.features.htmlParsingConforms=aa;var ka="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),ga=0,ha=1,va=2,ma=3,ia=0,na=1,oa=2,ja=3;u.prototype={attachListener:function(a,
b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){D(this);z(this.startContainer,b.startContainer);var c=a==ma||a==ga?"start":"end",d=a==ha||a==ga?"start":"end";return n.comparePoints(this[c+"Container"],this[c+"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){D(this);y(a,L);A(this.startContainer);if(n.isAncestorOf(a,this.startContainer,!0))throw new C("HIERARCHY_REQUEST_ERR");this.setStartBefore(g(a,this.startContainer,this.startOffset))},cloneContents:function(){D(this);
var a,c;if(this.collapsed)return d(this).createDocumentFragment();if(this.startContainer===this.endContainer&&n.isCharacterDataNode(this.startContainer))return a=this.startContainer.cloneNode(!0),a.data=a.data.slice(this.startOffset,this.endOffset),c=d(this).createDocumentFragment(),c.appendChild(a),c;c=new t(this,!0);a=b(c);c.detach();return a},canSurroundContents:function(){D(this);A(this.startContainer);A(this.endContainer);var a=new t(this,!0),b=a._first&&c(a._first,this)||a._last&&c(a._last,
this);a.detach();return!b},surroundContents:function(a){y(a,S);if(!this.canSurroundContents())throw new r("BAD_BOUNDARYPOINTS_ERR");var b=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);g(a,this.startContainer,this.startOffset);a.appendChild(b);this.selectNode(a)},cloneRange:function(){D(this);for(var a=new i(d(this)),b=ka.length,c;b--;)c=ka[b],a[c]=this[c];return a},toString:function(){D(this);var a=this.startContainer;if(a===this.endContainer&&n.isCharacterDataNode(a))return 3==
a.nodeType||4==a.nodeType?a.data.slice(this.startOffset,this.endOffset):"";var b=[],a=new t(this,!0);k(a,function(a){(3==a.nodeType||4==a.nodeType)&&b.push(a.data)});a.detach();return b.join("")},compareNode:function(a){D(this);var b=a.parentNode,c=n.getNodeIndex(a);if(!b)throw new C("NOT_FOUND_ERR");a=this.comparePoint(b,c);b=this.comparePoint(b,c+1);return 0>a?0<b?oa:ia:0<b?na:ja},comparePoint:function(a,b){D(this);F(a,"HIERARCHY_REQUEST_ERR");z(a,this.startContainer);return 0>n.comparePoints(a,
b,this.startContainer,this.startOffset)?-1:0<n.comparePoints(a,b,this.endContainer,this.endOffset)?1:0},createContextualFragment:aa?function(a){var b=this.startContainer,c=n.getDocument(b);if(!b)throw new C("INVALID_STATE_ERR");var d=null;1==b.nodeType?d=b:n.isCharacterDataNode(b)&&(d=n.parentElement(b));d=null===d||"HTML"==d.nodeName&&n.isHtmlNamespace(n.getDocument(d).documentElement)&&n.isHtmlNamespace(d)?c.createElement("body"):d.cloneNode(!1);d.innerHTML=a;return n.fragmentFromNodeChildren(d)}:
function(a){v(this);var b=d(this).createElement("body");b.innerHTML=a;return n.fragmentFromNodeChildren(b)},toHtml:function(){D(this);var a=d(this).createElement("div");a.appendChild(this.cloneContents());return a.innerHTML},intersectsNode:function(a,b){D(this);F(a,"NOT_FOUND_ERR");if(n.getDocument(a)!==d(this))return!1;var c=a.parentNode,i=n.getNodeIndex(a);F(c,"NOT_FOUND_ERR");var h=n.comparePoints(c,i,this.endContainer,this.endOffset),c=n.comparePoints(c,i+1,this.startContainer,this.startOffset);
return b?0>=h&&0<=c:0>h&&0<c},isPointInRange:function(a,b){D(this);F(a,"HIERARCHY_REQUEST_ERR");z(a,this.startContainer);return 0<=n.comparePoints(a,b,this.startContainer,this.startOffset)&&0>=n.comparePoints(a,b,this.endContainer,this.endOffset)},intersectsRange:function(a,b){D(this);if(d(a)!=d(this))throw new C("WRONG_DOCUMENT_ERR");var c=n.comparePoints(this.startContainer,this.startOffset,a.endContainer,a.endOffset),i=n.comparePoints(this.endContainer,this.endOffset,a.startContainer,a.startOffset);
return b?0>=c&&0<=i:0>c&&0<i},intersection:function(a){if(this.intersectsRange(a)){var b=n.comparePoints(this.startContainer,this.startOffset,a.startContainer,a.startOffset),c=n.comparePoints(this.endContainer,this.endOffset,a.endContainer,a.endOffset),d=this.cloneRange();-1==b&&d.setStart(a.startContainer,a.startOffset);1==c&&d.setEnd(a.endContainer,a.endOffset);return d}return null},union:function(a){if(this.intersectsRange(a,!0)){var b=this.cloneRange();-1==n.comparePoints(a.startContainer,a.startOffset,
this.startContainer,this.startOffset)&&b.setStart(a.startContainer,a.startOffset);1==n.comparePoints(a.endContainer,a.endOffset,this.endContainer,this.endOffset)&&b.setEnd(a.endContainer,a.endOffset);return b}throw new r("Ranges do not intersect");},containsNode:function(a,b){return b?this.intersectsNode(a,!1):this.compareNode(a)==ja},containsNodeContents:function(a){return 0<=this.comparePoint(a,0)&&0>=this.comparePoint(a,n.getNodeLength(a))},containsRange:function(a){return this.intersection(a).equals(a)},
containsNodeText:function(a){var b=this.cloneRange();b.selectNode(a);var c=b.getNodes([3]);return 0<c.length?(b.setStart(c[0],0),a=c.pop(),b.setEnd(a,a.length),a=this.containsRange(b),b.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){D(this);return new q(this,a,b)},getNodes:function(a,b){D(this);return o(this,a,b)},getDocument:function(){return d(this)},collapseBefore:function(a){v(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){v(this);this.setStartAfter(a);
this.collapse(!0)},getName:function(){return"DomRange"},equals:function(a){return i.rangesEqual(this,a)},isValid:function(){return J(this)},inspect:function(){return m(this)}};P(i,R,function(a){v(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;e(a,"detach",null);a._listeners=null});a.rangePrototype=u.prototype;i.rangeProperties=ka;i.RangeIterator=t;i.copyComparisonConstants=M;i.createPrototypeRange=P;i.inspect=m;i.getRangeDocument=d;i.rangesEqual=
function(a,b){return a.startContainer===b.startContainer&&a.startOffset===b.startOffset&&a.endContainer===b.endContainer&&a.endOffset===b.endOffset};a.DomRange=i;a.RangeException=r});
rangy.createModule("WrappedRange",function(a){function c(a,b,c,d){var e=a.duplicate();e.collapse(c);var g=e.parentElement();f.isAncestorOf(b,g,!0)||(g=b);if(!g.canHaveHTML)return new j(g.parentNode,f.getNodeIndex(g));var b=f.getDocument(g).createElement("span"),r,q=c?"StartToStart":"StartToEnd";do g.insertBefore(b,b.previousSibling),e.moveToElementText(b);while(0<(r=e.compareEndPoints(q,a))&&b.previousSibling);q=b.nextSibling;if(-1==r&&q&&f.isCharacterDataNode(q)){e.setEndPoint(c?"EndToStart":"EndToEnd",
a);if(/[\r\n]/.test(q.data)){g=e.duplicate();c=g.text.replace(/\r\n/g,"\r").length;for(c=g.moveStart("character",c);-1==g.compareEndPoints("StartToEnd",g);)c++,g.moveStart("character",1)}else c=e.text.length;g=new j(q,c)}else q=(d||!c)&&b.previousSibling,g=(c=(d||c)&&b.nextSibling)&&f.isCharacterDataNode(c)?new j(c,0):q&&f.isCharacterDataNode(q)?new j(q,q.length):new j(g,f.getNodeIndex(b));b.parentNode.removeChild(b);return g}function d(a,b){var c,d,e=a.offset,g=f.getDocument(a.node),j=g.body.createTextRange(),
q=f.isCharacterDataNode(a.node);q?(c=a.node,d=c.parentNode):(c=a.node.childNodes,c=e<c.length?c[e]:null,d=a.node);g=g.createElement("span");g.innerHTML="&#feff;";c?d.insertBefore(g,c):d.appendChild(g);j.moveToElementText(g);j.collapse(!b);d.removeChild(g);if(q)j[b?"moveStart":"moveEnd"]("character",e);return j}a.requireModules(["DomUtil","DomRange"]);var e,f=a.dom,j=f.DomPosition,g=a.DomRange;if(a.features.implementsDomRange&&(!a.features.implementsTextRange||!a.config.preferTextRange))(function(){function b(a){for(var c=
d.length,f;c--;)f=d[c],a[f]=a.nativeRange[f]}var c,d=g.rangeProperties,j;e=function(a){if(!a)throw Error("Range must be specified");this.nativeRange=a;b(this)};g.createPrototypeRange(e,function(a,b,c,d,f){var e=a.endContainer!==d||a.endOffset!=f;if(a.startContainer!==b||a.startOffset!=c||e)a.setEnd(d,f),a.setStart(b,c)},function(a){a.nativeRange.detach();a.detached=!0;for(var b=d.length,c;b--;)c=d[b],a[c]=null});c=e.prototype;c.selectNode=function(a){this.nativeRange.selectNode(a);b(this)};c.deleteContents=
...
var m=document.createTextNode("test");f.getBody(document).appendChild(m);var t=document.createRange();t.setStart(m,0);t.setEnd(m,0);try{t.setStart(m,1),c.setStart=function(a,c){this.nativeRange.setStart(a,c);b(this)},c.setEnd=function(a,c){this.nativeRange.setEnd(a,c);b(this)},j=function(a){return function(c){this.nativeRange[a](c);b(this)}}}catch(r){c.setStart=function(a,c){try{this.nativeRange.setStart(a,c)}catch(d){this.nativeRange.setEnd(a,c),this.nativeRange.setStart(a,c)}b(this)},c.setEnd=function(a,
c){try{this.nativeRange.setEnd(a,c)}catch(d){this.nativeRange.setStart(a,c),this.nativeRange.setEnd(a,c)}b(this)},j=function(a,c){return function(d){try{this.nativeRange[a](d)}catch(f){this.nativeRange[c](d),this.nativeRange[a](d)}b(this)}}}c.setStartBefore=j("setStartBefore","setEndBefore");c.setStartAfter=j("setStartAfter","setEndAfter");c.setEndBefore=j("setEndBefore","setStartBefore");c.setEndAfter=j("setEndAfter","setStartAfter");t.selectNodeContents(m);c.selectNodeContents=t.startContainer==
m&&t.endContainer==m&&0==t.startOffset&&t.endOffset==m.length?function(a){this.nativeRange.selectNodeContents(a);b(this)}:function(a){this.setStart(a,0);this.setEnd(a,g.getEndOffset(a))};t.selectNodeContents(m);t.setEnd(m,3);j=document.createRange();j.selectNodeContents(m);j.setEnd(m,4);j.setStart(m,2);c.compareBoundaryPoints=-1==t.compareBoundaryPoints(t.START_TO_END,j)&1==t.compareBoundaryPoints(t.END_TO_START,j)?function(a,b){b=b.nativeRange||b;a==b.START_TO_END?a=b.END_TO_START:a==b.END_TO_START&&
(a=b.START_TO_END);return this.nativeRange.compareBoundaryPoints(a,b)}:function(a,b){return this.nativeRange.compareBoundaryPoints(a,b.nativeRange||b)};a.util.isHostMethod(t,"createContextualFragment")&&(c.createContextualFragment=function(a){return this.nativeRange.createContextualFragment(a)});f.getBody(document).removeChild(m);t.detach();j.detach()})(),a.createNativeRange=function(a){return(a||document).createRange()};else if(a.features.implementsTextRange){e=function(a){this.textRange=a;this.refresh()};
e.prototype=new g(document);e.prototype.refresh=function(){var a,b,d=this.textRange;a=d.parentElement();var e=d.duplicate();e.collapse(!0);b=e.parentElement();e=d.duplicate();e.collapse(!1);d=e.parentElement();b=b==d?b:f.getCommonAncestor(b,d);b=b==a?b:f.getCommonAncestor(a,b);0==this.textRange.compareEndPoints("StartToEnd",this.textRange)?b=a=c(this.textRange,b,!0,!0):(a=c(this.textRange,b,!0,!1),b=c(this.textRange,b,!1,!1));this.setStart(a.node,a.offset);this.setEnd(b.node,b.offset)};g.copyComparisonConstants(e);
var b=function(){return this}();"undefined"==typeof b.Range&&(b.Range=e);a.createNativeRange=function(a){return(a||document).body.createTextRange()}}a.features.implementsTextRange&&(e.rangeToTextRange=function(a){if(a.collapsed)return d(new j(a.startContainer,a.startOffset),!0);var b=d(new j(a.startContainer,a.startOffset),!0),c=d(new j(a.endContainer,a.endOffset),!1),a=f.getDocument(a.startContainer).body.createTextRange();a.setEndPoint("StartToStart",b);a.setEndPoint("EndToEnd",c);return a});e.prototype.getName=
function(){return"WrappedRange"};a.WrappedRange=e;a.createRange=function(b){return new e(a.createNativeRange(b||document))};a.createRangyRange=function(a){return new g(a||document)};a.createIframeRange=function(b){return a.createRange(f.getIframeDocument(b))};a.createIframeRangyRange=function(b){return a.createRangyRange(f.getIframeDocument(b))};a.addCreateMissingNativeApiListener(function(b){b=b.document;if(typeof b.createRange=="undefined")b.createRange=function(){return a.createRange(this)};b=
b=null})});
rangy.createModule("WrappedSelection",function(a,c){function d(a){return(a||window).getSelection()}function e(a){return(a||window).document.selection}function f(a,b,c){var d=c?"end":"start",c=c?"start":"end";a.anchorNode=b[d+"Container"];a.anchorOffset=b[d+"Offset"];a.focusNode=b[c+"Container"];a.focusOffset=b[c+"Offset"]}function j(a){a.anchorNode=a.focusNode=null;a.anchorOffset=a.focusOffset=0;a.rangeCount=0;a.isCollapsed=!0;a._ranges.length=0}function g(b){var c;b instanceof x?(c=b._selectionNativeRange,c||
(c=a.createNativeRange(q.getDocument(b.startContainer)),c.setEnd(b.endContainer,b.endOffset),c.setStart(b.startContainer,b.startOffset),b._selectionNativeRange=c,b.attachListener("detach",function(){this._selectionNativeRange=null}))):b instanceof v?c=b.nativeRange:a.features.implementsDomRange&&b instanceof q.getWindow(b.startContainer).Range&&(c=b);return c}function b(a){var b=a.getNodes(),c;a:if(!b.length||1!=b[0].nodeType)c=!1;else{c=1;for(var d=b.length;c<d;++c)if(!q.isAncestorOf(b[0],b[c])){c=
!1;break a}c=!0}if(!c)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function k(a,b){var c=new v(b);a._ranges=[c];f(a,c,!1);a.rangeCount=1;a.isCollapsed=c.collapsed}function l(b){b._ranges.length=0;if("None"==b.docSelection.type)j(b);else{var c=b.docSelection.createRange();if(c&&"undefined"!=typeof c.text)k(b,c);else{b.rangeCount=c.length;for(var d,i=q.getDocument(c.item(0)),h=0;h<b.rangeCount;++h)d=a.createRange(i),d.selectNode(c.item(h)),
b._ranges.push(d);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;f(b,b._ranges[b.rangeCount-1],!1)}}}function p(a,c){for(var d=a.docSelection.createRange(),i=b(c),h=q.getDocument(d.item(0)),h=q.getBody(h).createControlRange(),f=0,e=d.length;f<e;++f)h.add(d.item(f));try{h.add(i)}catch(g){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}h.select();l(a)}function o(a,b,c){this.nativeSelection=a;this.docSelection=b;this._ranges=
[];this.win=c;this.refresh()}function m(a,c){for(var d=q.getDocument(c[0].startContainer),d=q.getBody(d).createControlRange(),i=0,h;i<rangeCount;++i){h=b(c[i]);try{d.add(h)}catch(f){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();l(a)}function t(a,b){if(a.anchorNode&&q.getDocument(a.anchorNode)!==q.getDocument(b))throw new y("WRONG_DOCUMENT_ERR");}function r(a){var b=[],c=new E(a.anchorNode,a.anchorOffset),
d=new E(a.focusNode,a.focusOffset),i="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var h=0,f=a.rangeCount;h<f;++h)b[h]=x.inspect(a.getRangeAt(h));return"["+i+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var q=a.dom,s=a.util,x=a.DomRange,v=a.WrappedRange,y=a.DOMException,E=q.DomPosition,z,A,F=a.util.isHostMethod(window,"getSelection"),
J=a.util.isHostObject(document,"selection"),D=J&&(!F||a.config.preferTextRange);D?(z=e,a.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return"None"!=b.type||q.getDocument(b.createRange().parentElement())==a}):F?(z=d,a.isSelectionValid=function(){return!0}):c.fail("Neither document.selection or window.getSelection() detected.");a.getNativeSelection=z;var F=z(),u=a.createNativeRange(document),I=q.getBody(document),M=s.areHostObjects(F,s.areHostProperties(F,["anchorOffset","focusOffset"]));
a.features.selectionHasAnchorAndFocus=M;var h=s.isHostMethod(F,"extend");a.features.selectionHasExtend=h;var P="number"==typeof F.rangeCount;a.features.selectionHasRangeCount=P;var O=!1,R=!0;s.areHostMethods(F,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof F.rangeCount&&a.features.implementsDomRange&&function(){var a=document.createElement("iframe");a.frameBorder=0;a.style.position="absolute";a.style.left="-10000px";I.appendChild(a);var b=q.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");
b.close();var c=q.getIframeWindow(a).getSelection(),d=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(d,1);b.collapse(true);c.addRange(b);R=c.rangeCount==1;c.removeAllRanges();var i=b.cloneRange();b.setStart(d,0);i.setEnd(d,2);c.addRange(b);c.addRange(i);O=c.rangeCount==2;b.detach();i.detach();I.removeChild(a)}();a.features.selectionSupportsMultipleRanges=O;a.features.collapsedNonEditableSelectionsSupported=R;var i=!1,n;I&&s.isHostMethod(I,"createControlRange")&&(n=I.createControlRange(),
s.areHostProperties(n,["item","add"])&&(i=!0));a.features.implementsControlRange=i;A=M?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:false};var w;s.isHostMethod(F,"getRangeAt")?w=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:M&&(w=function(b){var c=q.getDocument(b.anchorNode),c=a.createRange(c);c.setStart(b.anchorNode,b.anchorOffset);c.setEnd(b.focusNode,b.focusOffset);if(c.collapsed!==
this.isCollapsed){c.setStart(b.focusNode,b.focusOffset);c.setEnd(b.anchorNode,b.anchorOffset)}return c});a.getSelection=function(a){var a=a||window,b=a._rangySelection,c=z(a),d=J?e(a):null;if(b){b.nativeSelection=c;b.docSelection=d;b.refresh(a)}else{b=new o(c,d,a);a._rangySelection=b}return b};a.getIframeSelection=function(b){return a.getSelection(q.getIframeWindow(b))};n=o.prototype;if(!D&&M&&s.areHostMethods(F,["removeAllRanges","addRange"])){n.removeAllRanges=function(){this.nativeSelection.removeAllRanges();
j(this)};var C=function(b,c){var d=x.getRangeDocument(c),d=a.createRange(d);d.collapseToPoint(c.endContainer,c.endOffset);b.nativeSelection.addRange(g(d));b.nativeSelection.extend(c.startContainer,c.startOffset);b.refresh()};n.addRange=P?function(b,c){if(i&&J&&this.docSelection.type=="Control")p(this,b);else if(c&&h)C(this,b);else{var d;if(O)d=this.rangeCount;else{this.removeAllRanges();d=0}this.nativeSelection.addRange(g(b));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==d+1){if(a.config.checkSelectionRanges)(d=
w(this.nativeSelection,this.rangeCount-1))&&!x.rangesEqual(d,b)&&(b=new v(d));this._ranges[this.rangeCount-1]=b;f(this,b,L(this.nativeSelection));this.isCollapsed=A(this)}else this.refresh()}}:function(a,b){if(b&&h)C(this,a);else{this.nativeSelection.addRange(g(a));this.refresh()}};n.setRanges=function(a){if(i&&a.length>1)m(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(s.isHostMethod(F,"empty")&&s.isHostMethod(u,"select")&&i&&D)n.removeAllRanges=
function(){try{this.docSelection.empty();if(this.docSelection.type!="None"){var a;if(this.anchorNode)a=q.getDocument(this.anchorNode);else if(this.docSelection.type=="Control"){var b=this.docSelection.createRange();b.length&&(a=q.getDocument(b.item(0)).body.createTextRange())}if(a){a.body.createTextRange().select();this.docSelection.empty()}}}catch(c){}j(this)},n.addRange=function(a){if(this.docSelection.type=="Control")p(this,a);else{v.rangeToTextRange(a).select();this._ranges[0]=a;this.rangeCount=
1;this.isCollapsed=this._ranges[0].collapsed;f(this,a,false)}},n.setRanges=function(a){this.removeAllRanges();var b=a.length;b>1?m(this,a):b&&this.addRange(a[0])};else return c.fail("No means of selecting a Range or TextRange was found"),!1;n.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new y("INDEX_SIZE_ERR");return this._ranges[a]};var H;if(D)H=function(b){var c;if(a.isSelectionValid(b.win))c=b.docSelection.createRange();else{c=q.getBody(b.win.document).createTextRange();c.collapse(true)}b.docSelection.type==
"Control"?l(b):c&&typeof c.text!="undefined"?k(b,c):j(b)};else if(s.isHostMethod(F,"getRangeAt")&&"number"==typeof F.rangeCount)H=function(b){if(i&&J&&b.docSelection.type=="Control")l(b);else{b._ranges.length=b.rangeCount=b.nativeSelection.rangeCount;if(b.rangeCount){for(var c=0,d=b.rangeCount;c<d;++c)b._ranges[c]=new a.WrappedRange(b.nativeSelection.getRangeAt(c));f(b,b._ranges[b.rangeCount-1],L(b.nativeSelection));b.isCollapsed=A(b)}else j(b)}};else if(M&&"boolean"==typeof F.isCollapsed&&"boolean"==
typeof u.collapsed&&a.features.implementsDomRange)H=function(a){var b;b=a.nativeSelection;if(b.anchorNode){b=w(b,0);a._ranges=[b];a.rangeCount=1;b=a.nativeSelection;a.anchorNode=b.anchorNode;a.anchorOffset=b.anchorOffset;a.focusNode=b.focusNode;a.focusOffset=b.focusOffset;a.isCollapsed=A(a)}else j(a)};else return c.fail("No means of obtaining a Range or TextRange from the user's selection was found"),!1;n.refresh=function(a){var b=a?this._ranges.slice(0):null;H(this);if(a){a=b.length;if(a!=this._ranges.length)return false;
for(;a--;)if(!x.rangesEqual(b[a],this._ranges[a]))return false;return true}};var G=function(a,b){var c=a.getAllRanges(),d=false;a.removeAllRanges();for(var i=0,h=c.length;i<h;++i)d||b!==c[i]?a.addRange(c[i]):d=true;a.rangeCount||j(a)};n.removeRange=i?function(a){if(this.docSelection.type=="Control"){for(var c=this.docSelection.createRange(),a=b(a),d=q.getDocument(c.item(0)),d=q.getBody(d).createControlRange(),i,h=false,f=0,e=c.length;f<e;++f){i=c.item(f);i!==a||h?d.add(c.item(f)):h=true}d.select();
l(this)}else G(this,a)}:function(a){G(this,a)};var L;!D&&M&&a.features.implementsDomRange?(L=function(a){var b=false;a.anchorNode&&(b=q.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset)==1);return b},n.isBackwards=function(){return L(this)}):L=n.isBackwards=function(){return false};n.toString=function(){for(var a=[],b=0,c=this.rangeCount;b<c;++b)a[b]=""+this._ranges[b];return a.join("")};n.collapse=function(b,c){t(this,b);var d=a.createRange(q.getDocument(b));d.collapseToPoint(b,
c);this.removeAllRanges();this.addRange(d);this.isCollapsed=true};n.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new y("INVALID_STATE_ERR");};n.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new y("INVALID_STATE_ERR");};n.selectAllChildren=function(b){t(this,b);var c=a.createRange(q.getDocument(b));c.selectNodeContents(b);this.removeAllRanges();
this.addRange(c)};n.deleteFromDocument=function(){if(i&&J&&this.docSelection.type=="Control"){for(var a=this.docSelection.createRange(),b;a.length;){b=a.item(0);a.remove(b);b.parentNode.removeChild(b)}this.refresh()}else if(this.rangeCount){a=this.getAllRanges();this.removeAllRanges();b=0;for(var c=a.length;b<c;++b)a[b].deleteContents();this.addRange(a[c-1])}};n.getAllRanges=function(){return this._ranges.slice(0)};n.setSingleRange=function(a){this.setRanges([a])};n.containsNode=function(a,b){for(var c=
0,d=this._ranges.length;c<d;++c)if(this._ranges[c].containsNode(a,b))return true;return false};n.toHtml=function(){var a="";if(this.rangeCount){for(var a=x.getRangeDocument(this._ranges[0]).createElement("div"),b=0,c=this._ranges.length;b<c;++b)a.appendChild(this._ranges[b].cloneContents());a=a.innerHTML}return a};n.getName=function(){return"WrappedSelection"};n.inspect=function(){return r(this)};n.detach=function(){this.win=this.anchorNode=this.focusNode=this.win._rangySelection=null};o.inspect=
r;a.Selection=o;a.selectionPrototype=n;a.addCreateMissingNativeApiListener(function(b){if(typeof b.getSelection=="undefined")b.getSelection=function(){return a.getSelection(this)};b=null})});
rangy.createModule("CssClassApplier",function(a,c){function d(a,b){return a.className&&RegExp("(?:^|\\s)"+b+"(?:\\s|$)").test(a.className)}function e(a,b){a.className?d(a,b)||(a.className+=" "+b):a.className=b}function f(a){return a.split(/\s+/).sort().join(" ")}function j(a,b){return f(a.className)==f(b.className)}function g(a){for(var b=a.parentNode;a.hasChildNodes();)b.insertBefore(a.firstChild,a);b.removeChild(a)}function b(a,b){var c=a.cloneRange();c.selectNodeContents(b);var d=c.intersection(a),
d=d?d.toString():"";c.detach();return""!=d}function k(a){return a.getNodes([3],function(c){return b(a,c)})}function l(a,b){if(a.attributes.length!=b.attributes.length)return!1;for(var c=0,d=a.attributes.length,i,f;c<d;++c)if(i=a.attributes[c],f=i.name,"class"!=f&&(f=b.attributes.getNamedItem(f),i.specified!=f.specified||i.specified&&i.nodeValue!==f.nodeValue))return!1;return!0}function p(a,b){for(var c=0,d=a.attributes.length,i;c<d;++c)if(i=a.attributes[c].name,(!b||!y.arrayContains(b,i))&&a.attributes[c].specified&&
"class"!=i)return!0;return!1}function o(a){var b;return a&&1==a.nodeType&&((b=a.parentNode)&&9==b.nodeType&&"on"==b.designMode||A(a)&&!A(a.parentNode))}function m(a){return(A(a)||1!=a.nodeType&&A(a.parentNode))&&!o(a)}function t(a){return a&&1==a.nodeType&&!F.test(z(a,"display"))}function r(a){if(0==a.data.length)return!0;if(J.test(a.data))return!1;switch(z(a.parentNode,"whiteSpace")){case "pre":case "pre-wrap":case "-moz-pre-wrap":return!1;case "pre-line":if(/[\r\n]/.test(a.data))return!1}return t(a.previousSibling)||
t(a.nextSibling)}function q(a,b,d,f){var i,e=0==d;if(y.isAncestorOf(b,a))return a;if(y.isCharacterDataNode(b))if(0==d)d=y.getNodeIndex(b),b=b.parentNode;else if(d==b.length)d=y.getNodeIndex(b)+1,b=b.parentNode;else throw c.createError("splitNodeAt should not be called with offset in the middle of a data node ("+d+" in "+b.data);if(y.isCharacterDataNode(b)?0==d?b.previousSibling:d==b.length?b.nextSibling:1:0<d&&d<b.childNodes.length){if(!i){i=b.cloneNode(!1);for(i.id&&i.removeAttribute("id");e=b.childNodes[d];)i.appendChild(e);
y.insertAfter(i,b)}return b==a?i:q(a,i.parentNode,y.getNodeIndex(i),f)}return a!=b?(i=b.parentNode,b=y.getNodeIndex(b),e||b++,q(a,i,b,f)):a}function s(a){var b=a?"nextSibling":"previousSibling";return function(c,d){var i=c.parentNode,f=c[b];if(f){if(f&&3==f.nodeType)return f}else if(d&&(f=i[b])&&1==f.nodeType&&i.tagName==f.tagName&&j(i,f)&&l(i,f))return f[a?"firstChild":"lastChild"];return null}}function x(a){this.firstTextNode=(this.isElementMerge=1==a.nodeType)?a.lastChild:a;this.textNodes=[this.firstTextNode]}
function v(a,b,c){this.cssClass=a;var d,i,e=null;if("object"==typeof b&&null!==b){c=b.tagNames;e=b.elementProperties;for(d=0;i=I[d++];)b.hasOwnProperty(i)&&(this[i]=b[i]);d=b.normalize}else d=b;this.normalize="undefined"==typeof d?!0:d;this.attrExceptions=[];d=document.createElement(this.elementTagName);this.elementProperties={};for(var g in e)e.hasOwnProperty(g)&&(M.hasOwnProperty(g)&&(g=M[g]),d[g]=e[g],this.elementProperties[g]=d[g],this.attrExceptions.push(g));this.elementSortedClassName=this.elementProperties.hasOwnProperty("className")?
f(this.elementProperties.className+" "+a):a;this.applyToAnyTagName=!1;a=typeof c;if("string"==a)"*"==c?this.applyToAnyTagName=!0:this.tagNames=c.toLowerCase().replace(/^\s\s*/,"").replace(/\s\s*$/,"").split(/\s*,\s*/);else if("object"==a&&"number"==typeof c.length){this.tagNames=[];d=0;for(a=c.length;d<a;++d)"*"==c[d]?this.applyToAnyTagName=!0:this.tagNames.push(c[d].toLowerCase())}else this.tagNames=[this.elementTagName]}a.requireModules(["WrappedSelection","WrappedRange"]);var y=a.dom,E=function(){function a(b,
c,d){return c&&d?" ":""}return function(b,c){b.className&&(b.className=b.className.replace(RegExp("(?:^|\\s)"+c+"(?:\\s|$)"),a))}}(),z;"undefined"!=typeof window.getComputedStyle?z=function(a,b){return y.getWindow(a).getComputedStyle(a,null)[b]}:"undefined"!=typeof document.documentElement.currentStyle?z=function(a,b){return a.currentStyle[b]}:c.fail("No means of obtaining computed style properties found");var A;(function(){A="boolean"==typeof document.createElement("div").isContentEditable?function(a){return a&&
1==a.nodeType&&a.isContentEditable}:function(a){return!a||1!=a.nodeType||"false"==a.contentEditable?!1:"true"==a.contentEditable||A(a.parentNode)}})();var F=/^inline(-block|-table)?$/i,J=/[^\r\n\t\f \u200B]/,D=s(!1),u=s(!0);x.prototype={doMerge:function(){for(var a=[],b,c,d=0,i=this.textNodes.length;d<i;++d)b=this.textNodes[d],c=b.parentNode,a[d]=b.data,d&&(c.removeChild(b),c.hasChildNodes()||c.parentNode.removeChild(c));return this.firstTextNode.data=a=a.join("")},getLength:function(){for(var a=
this.textNodes.length,b=0;a--;)b+=this.textNodes[a].length;return b},toString:function(){for(var a=[],b=0,c=this.textNodes.length;b<c;++b)a[b]="'"+this.textNodes[b].data+"'";return"[Merge("+a.join(",")+")]"}};var I=["elementTagName","ignoreWhiteSpace","applyToEditableOnly"],M={"class":"className"};v.prototype={elementTagName:"span",elementProperties:{},ignoreWhiteSpace:!0,applyToEditableOnly:!1,hasClass:function(a){return 1==a.nodeType&&y.arrayContains(this.tagNames,a.tagName.toLowerCase())&&d(a,
this.cssClass)},getSelfOrAncestorWithClass:function(a){for(;a;){if(this.hasClass(a,this.cssClass))return a;a=a.parentNode}return null},isModifiable:function(a){return!this.applyToEditableOnly||m(a)},isIgnorableWhiteSpaceNode:function(a){return this.ignoreWhiteSpace&&a&&3==a.nodeType&&r(a)},postApply:function(a,b,c){for(var d=a[0],i=a[a.length-1],f=[],e,g=d,j=i,k=0,l=i.length,m,o,t=0,p=a.length;t<p;++t)if(m=a[t],o=D(m,!c)){if(e||(e=new x(o),f.push(e)),e.textNodes.push(m),m===d&&(g=e.firstTextNode,
k=g.length),m===i)j=e.firstTextNode,l=e.getLength()}else e=null;if(a=u(i,!c))e||(e=new x(i),f.push(e)),e.textNodes.push(a);if(f.length){t=0;for(p=f.length;t<p;++t)f[t].doMerge();b.setStart(g,k);b.setEnd(j,l)}},createContainer:function(b){b=b.createElement(this.elementTagName);a.util.extend(b,this.elementProperties);e(b,this.cssClass);return b},applyToTextNode:function(a){var b=a.parentNode;1==b.childNodes.length&&y.arrayContains(this.tagNames,b.tagName.toLowerCase())?e(b,this.cssClass):(b=this.createContainer(y.getDocument(a)),
a.parentNode.insertBefore(b,a),b.appendChild(a))},isRemovable:function(a){var b;if(b=a.tagName.toLowerCase()==this.elementTagName)if(b=f(a.className)==this.elementSortedClassName){var c;a:{b=this.elementProperties;for(c in b)if(b.hasOwnProperty(c)&&a[c]!==b[c]){c=!1;break a}c=!0}b=c&&!p(a,this.attrExceptions)&&this.isModifiable(a)}return b},undoToTextNode:function(a,b,c){b.containsNode(c)||(a=b.cloneRange(),a.selectNode(c),a.isPointInRange(b.endContainer,b.endOffset)&&(q(c,b.endContainer,b.endOffset,
[b]),b.setEndAfter(c)),a.isPointInRange(b.startContainer,b.startOffset)&&(c=q(c,b.startContainer,b.startOffset,[b])));this.isRemovable(c)?g(c):E(c,this.cssClass)},applyToRange:function(a){a.splitBoundaries();var b=k(a);if(b.length){for(var c,d=0,i=b.length;d<i;++d)c=b[d],!this.isIgnorableWhiteSpaceNode(c)&&!this.getSelfOrAncestorWithClass(c)&&this.isModifiable(c)&&this.applyToTextNode(c);a.setStart(b[0],0);c=b[b.length-1];a.setEnd(c,c.length);this.normalize&&this.postApply(b,a,!1)}},applyToSelection:function(b){var b=
a.getSelection(b||window),c,d=b.getAllRanges();b.removeAllRanges();for(var f=d.length;f--;)c=d[f],this.applyToRange(c),b.addRange(c)},undoToRange:function(a){a.splitBoundaries();var b=k(a),c,d,i=b[b.length-1];if(b.length){for(var f=0,e=b.length;f<e;++f)c=b[f],(d=this.getSelfOrAncestorWithClass(c))&&this.isModifiable(c)&&this.undoToTextNode(c,a,d),a.setStart(b[0],0),a.setEnd(i,i.length);this.normalize&&this.postApply(b,a,!0)}},undoToSelection:function(b){var b=a.getSelection(b||window),c=b.getAllRanges(),
d;b.removeAllRanges();for(var f=0,i=c.length;f<i;++f)d=c[f],this.undoToRange(d),b.addRange(d)},getTextSelectedByRange:function(a,b){var c=b.cloneRange();c.selectNodeContents(a);var d=c.intersection(b),d=d?d.toString():"";c.detach();return d},isAppliedToRange:function(a){if(a.collapsed)return!!this.getSelfOrAncestorWithClass(a.commonAncestorContainer);for(var c=a.getNodes([3]),d=0,f;f=c[d++];)if(!this.isIgnorableWhiteSpaceNode(f)&&b(a,f)&&this.isModifiable(f)&&!this.getSelfOrAncestorWithClass(f))return!1;
return!0},isAppliedToSelection:function(b){for(var b=a.getSelection(b||window).getAllRanges(),c=b.length;c--;)if(!this.isAppliedToRange(b[c]))return!1;return!0},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)},toggleSelection:function(a){this.isAppliedToSelection(a)?this.undoToSelection(a):this.applyToSelection(a)},detach:function(){}};v.util={hasClass:d,addClass:e,removeClass:E,hasSameClasses:j,replaceWithOwnChildren:g,elementsHaveSameNonClassAttributes:l,
elementHasNonClassAttributes:p,splitNodeAt:q,isEditableElement:A,isEditingHost:o,isEditable:m};a.CssClassApplier=v;a.createCssClassApplier=function(a,b,c){return new v(a,b,c)}});
rangy.createModule("SaveRestore",function(a,c){function d(a,c){var d="selectionBoundary_"+ +new Date+"_"+(""+Math.random()).slice(2),f,e=g.getDocument(a.startContainer),j=a.cloneRange();j.collapse(c);f=e.createElement("span");f.id=d;f.style.lineHeight="0";f.style.display="none";f.className="rangySelectionBoundary";f.appendChild(e.createTextNode(b));j.insertNode(f);j.detach();return f}function e(a,b,d,f){(a=(a||document).getElementById(d))?(b[f?"setStartBefore":"setEndBefore"](a),a.parentNode.removeChild(a)):
c.warn("Marker element has been removed. Cannot restore selection.")}function f(a,b){return b.compareBoundaryPoints(a.START_TO_START,a)}function j(a,b){var c=(a||document).getElementById(b);c&&c.parentNode.removeChild(c)}a.requireModules(["DomUtil","DomRange","WrappedRange"]);var g=a.dom,b="\ufeff";a.saveSelection=function(b){var b=b||window,e=b.document;if(a.isSelectionValid(b)){var g=a.getSelection(b),j=g.getAllRanges(),m=[],t,r;j.sort(f);for(var q=0,s=j.length;q<s;++q)t=j[q],t.collapsed?(r=d(t,
!1),m.push({markerId:r.id,collapsed:!0})):(r=d(t,!1),t=d(t,!0),m[q]={startMarkerId:t.id,endMarkerId:r.id,collapsed:!1,backwards:1==j.length&&g.isBackwards()});for(q=s-1;0<=q;--q)t=j[q],t.collapsed?t.collapseBefore((e||document).getElementById(m[q].markerId)):(t.setEndBefore((e||document).getElementById(m[q].endMarkerId)),t.setStartAfter((e||document).getElementById(m[q].startMarkerId)));g.setRanges(j);return{win:b,doc:e,rangeInfos:m,restored:!1}}c.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
a.restoreSelection=function(b,d){if(!b.restored){for(var f=b.rangeInfos,g=a.getSelection(b.win),j=[],t=f.length,r=t-1,q,s;0<=r;--r){q=f[r];s=a.createRange(b.doc);if(q.collapsed)if(q=(b.doc||document).getElementById(q.markerId)){q.style.display="inline";var x=q.previousSibling;x&&3==x.nodeType?(q.parentNode.removeChild(q),s.collapseToPoint(x,x.length)):(s.collapseBefore(q),q.parentNode.removeChild(q))}else c.warn("Marker element has been removed. Cannot restore selection.");else e(b.doc,s,q.startMarkerId,
!0),e(b.doc,s,q.endMarkerId,!1);1==t&&s.normalizeBoundaries();j[r]=s}1==t&&d&&a.features.selectionHasExtend&&f[0].backwards?(g.removeAllRanges(),g.addRange(j[0],!0)):g.setRanges(j);b.restored=!0}};a.removeMarkerElement=j;a.removeMarkers=function(a){for(var b=a.rangeInfos,c=0,d=b.length,f;c<d;++c)f=b[c],f.collapsed?j(a.doc,f.markerId):(j(a.doc,f.startMarkerId),j(a.doc,f.endMarkerId))}});
rangy.createModule("Serializer",function(a,c){function d(a,b){var b=b||[],c=a.nodeType,f=a.childNodes,e=f.length,g=[c,a.nodeName,e].join(":"),j="",k="";switch(c){case 3:j=a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;");break;case 8:j="<\!--"+a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;")+"--\>";break;default:j="<"+g+">",k="</>"}j&&b.push(j);for(c=0;c<e;++c)d(f[c],b);k&&b.push(k);return b}function e(a){a=d(a).join("");return o(a).toString(16)}function f(a,b,c){for(var d=[],f=a,c=c||m.getDocument(a).documentElement;f&&
f!=c;)d.push(m.getNodeIndex(f,!0)),f=f.parentNode;return d.join("/")+":"+b}function j(a,b,d){b?d||m.getDocument(b):b=(d||document).documentElement;for(var a=a.split(":"),d=a[0]?a[0].split("/"):[],f=d.length,e;f--;)if(e=parseInt(d[f],10),e<b.childNodes.length)b=b.childNodes[parseInt(d[f],10)];else throw c.createError("deserializePosition failed: node "+m.inspectNode(b)+" has no child with index "+e+", "+f);return new m.DomPosition(b,parseInt(a[1],10))}function g(b,c,d){d=d||a.DomRange.getRangeDocument(b).documentElement;
if(!m.isAncestorOf(d,b.commonAncestorContainer,!0))throw Error("serializeRange: range is not wholly contained within specified root node");b=f(b.startContainer,b.startOffset,d)+","+f(b.endContainer,b.endOffset,d);c||(b+="{"+e(d)+"}");return b}function b(b,c,d){c?d=d||m.getDocument(c):(d=d||document,c=d.documentElement);var b=/^([^,]+),([^,\{]+)({([^}]+)})?$/.exec(b),f=b[4],g=e(c);if(f&&f!==e(c))throw Error("deserializeRange: checksums of serialized range root node ("+f+") and target root node ("+
g+") do not match");f=j(b[1],c,d);c=j(b[2],c,d);d=a.createRange(d);d.setStart(f.node,f.offset);d.setEnd(c.node,c.offset);return d}function k(a,b,c){b?c||m.getDocument(b):b=(c||document).documentElement;a=/^([^,]+),([^,]+)({([^}]+)})?$/.exec(a)[3];return!a||a===e(b)}function l(b,c,d){for(var b=b||a.getSelection(),b=b.getAllRanges(),f=[],e=0,j=b.length;e<j;++e)f[e]=g(b[e],c,d);return f.join("|")}function p(c,d,f){d?f=f||m.getWindow(d):(f=f||window,d=f.document.documentElement);for(var c=c.split("|"),
e=a.getSelection(f),g=[],j=0,k=c.length;j<k;++j)g[j]=b(c[j],d,f.document);e.setRanges(g);return e}a.requireModules(["WrappedSelection","WrappedRange"]);("undefined"==typeof encodeURIComponent||"undefined"==typeof decodeURIComponent)&&c.fail("Global object is missing encodeURIComponent and/or decodeURIComponent method");var o=function(){var a=null;return function(b){for(var c=[],d=0,f=b.length,e;d<f;++d)e=b.charCodeAt(d),128>e?c.push(e):2048>e?c.push(e>>6|192,e&63|128):c.push(e>>12|224,e>>6&63|128,
e&63|128);b=-1;if(!a){for(var d=[],f=0,g;256>f;++f){g=f;for(e=8;e--;)g=1==(g&1)?g>>>1^3988292384:g>>>1;d[f]=g>>>0}a=d}d=a;f=0;for(e=c.length;f<e;++f)g=(b^c[f])&255,b=b>>>8^d[g];return(b^-1)>>>0}}(),m=a.dom;a.serializePosition=f;a.deserializePosition=j;a.serializeRange=g;a.deserializeRange=b;a.canDeserializeRange=k;a.serializeSelection=l;a.deserializeSelection=p;a.canDeserializeSelection=function(a,b,c){var d;b?d=c?c.document:m.getDocument(b):b=(c||window).document.documentElement;for(var a=a.split("|"),
...
e=c.domain?";domain="+c.domain:"",g=c.secure?";secure":"",j=l(a.getSelection(b));b.document.cookie=encodeURIComponent("rangySerializedSelection")+"="+encodeURIComponent(j)+d+f+e+g};a.getElementChecksum=e});
(function(a,c){function d(a){var b=P[a]={},c,d,a=a.split(/\s+/);c=0;for(d=a.length;c<d;c++)b[a[c]]=!0;return b}function e(a,b,d){if(d===c&&1===a.nodeType)if(d="data-"+b.replace(i,"-$1").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:h.isNumeric(d)?+d:R.test(d)?h.parseJSON(d):d}catch(f){}h.data(a,b,d)}else d=c;return d}function f(a){for(var b in a)if(!("data"===b&&h.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function j(a,b,c){var d=
b+"defer",i=b+"queue",f=b+"mark",e=h._data(a,d);e&&("queue"===c||!h._data(a,i))&&("mark"===c||!h._data(a,f))&&setTimeout(function(){!h._data(a,i)&&!h._data(a,f)&&(h.removeData(a,d,!0),e.fire())},0)}function g(){return!1}function b(){return!0}function k(a,b,c){b=b||0;if(h.isFunction(b))return h.grep(a,function(a,d){return!!b.call(a,d,a)===c});if(b.nodeType)return h.grep(a,function(a){return a===b===c});if("string"===typeof b){var d=h.grep(a,function(a){return 1===a.nodeType});if(Xa.test(b))return h.filter(b,
d,!c);b=h.filter(b,d)}return h.grep(a,function(a){return 0<=h.inArray(a,b)===c})}function l(a){var b=Fa.split("|"),a=a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());return a}function p(a,b){if(1===b.nodeType&&h.hasData(a)){var c,d,i;d=h._data(a);var f=h._data(b,d),e=d.events;if(e)for(c in delete f.handle,f.events={},e){d=0;for(i=e[c].length;d<i;d++)h.event.add(b,c,e[c][d])}f.data&&(f.data=h.extend({},f.data))}}function o(a,b){var c;if(1===b.nodeType){b.clearAttributes&&
...
function m(a){return"undefined"!==typeof a.getElementsByTagName?a.getElementsByTagName("*"):"undefined"!==typeof a.querySelectorAll?a.querySelectorAll("*"):[]}function t(a){if("checkbox"===a.type||"radio"===a.type)a.defaultChecked=a.checked}function r(a){var b=(a.nodeName||"").toLowerCase();"input"===b?t(a):"script"!==b&&"undefined"!==typeof a.getElementsByTagName&&h.grep(a.getElementsByTagName("input"),t)}function q(a,b,c){var d="width"===b?a.offsetWidth:a.offsetHeight,i="width"===b?1:0;if(0<d){if("border"!==
c)for(;4>i;i+=2)c||(d-=parseFloat(h.css(a,"padding"+X[i]))||0),d="margin"===c?d+(parseFloat(h.css(a,c+X[i]))||0):d-(parseFloat(h.css(a,"border"+X[i]+"Width"))||0);return d+"px"}d=ba(a,b);if(0>d||null==d)d=a.style[b];if(wa.test(d))return d;d=parseFloat(d)||0;if(c)for(;4>i;i+=2)d+=parseFloat(h.css(a,"padding"+X[i]))||0,"padding"!==c&&(d+=parseFloat(h.css(a,"border"+X[i]+"Width"))||0),"margin"===c&&(d+=parseFloat(h.css(a,c+X[i]))||0);return d+"px"}function s(a){return function(b,c){"string"!==typeof b&&
(c=b,b="*");if(h.isFunction(c))for(var d=b.toLowerCase().split(Ma),i=0,f=d.length,e,g;i<f;i++)e=d[i],(g=/^\+/.test(e))&&(e=e.substr(1)||"*"),e=a[e]=a[e]||[],e[g?"unshift":"push"](c)}}function x(a,b,d,i,f,e){f=f||b.dataTypes[0];e=e||{};e[f]=!0;for(var f=a[f],g=0,j=f?f.length:0,h=a===xa,k;g<j&&(h||!k);g++)k=f[g](b,d,i),"string"===typeof k&&(!h||e[k]?k=c:(b.dataTypes.unshift(k),k=x(a,b,d,i,k,e)));if((h||!k)&&!e["*"])k=x(a,b,d,i,"*",e);return k}function v(a,b){var d,i,f=h.ajaxSettings.flatOptions||{};
for(d in b)b[d]!==c&&((f[d]?a:i||(i={}))[d]=b[d]);i&&h.extend(!0,a,i)}function y(a,b,c,d){if(h.isArray(b))h.each(b,function(b,i){c||eb.test(a)?d(a,i):y(a+"["+("object"===typeof i?b:"")+"]",i,c,d)});else if(!c&&"object"===h.type(b))for(var i in b)y(a+"["+i+"]",b[i],c,d);else d(a,b)}function E(){try{return new a.XMLHttpRequest}catch(b){}}function z(){setTimeout(A,0);return pa=h.now()}function A(){pa=c}function F(a,b){var c={};h.each(qa.concat.apply([],qa.slice(0,b)),function(){c[this]=a});return c}
function J(a){if(!ya[a]){var b=u.body,c=h("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d){U||(U=u.createElement("iframe"),U.frameBorder=U.width=U.height=0);b.appendChild(U);if(!ca||!U.createElement)ca=(U.contentWindow||U.contentDocument).document,ca.write((h.support.boxModel?"<!doctype html>":"")+"<html><body>"),ca.close();c=ca.createElement(a);ca.body.appendChild(c);d=h.css(c,"display");b.removeChild(U)}ya[a]=d}return ya[a]}function D(a){return h.isWindow(a)?a:9===a.nodeType?
a.defaultView||a.parentWindow:!1}var u=a.document,I=a.navigator,M=a.location,h=function(){function b(){if(!d.isReady){try{u.documentElement.doScroll("left")}catch(a){setTimeout(b,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,e)},i=a.jQuery,f=a.$,e,g=/^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,j=/\S/,h=/^\s+/,k=/\s+$/,n=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,l=/^[\],:{}\s]*$/,w=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,m=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,o=/(?:^|:|,)(?:\s*\[)+/g,
p=/(webkit)[ \/]([\w.]+)/,t=/(opera)(?:.*version)?[ \/]([\w.]+)/,C=/(msie) ([\w.]+)/,r=/(mozilla)(?:.*? rv:([\w.]+))?/,q=/-([a-z]|[0-9])/ig,H=/^-ms-/,s=function(a,b){return(b+"").toUpperCase()},G=I.userAgent,ra,ea,fb=Object.prototype.toString,za=Object.prototype.hasOwnProperty,Aa=Array.prototype.push,v=Array.prototype.slice,x=String.prototype.trim,L=Array.prototype.indexOf,y={};d.fn=d.prototype={constructor:d,init:function(a,b,i){var B;if(!a)return this;if(a.nodeType)return this.context=this[0]=a,
this.length=1,this;if("body"===a&&!b&&u.body)return this.context=u,this[0]=u.body,this.selector=a,this.length=1,this;if("string"===typeof a){if((B="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:g.exec(a))&&(B[1]||!b)){if(B[1])return i=(b=b instanceof d?b[0]:b)?b.ownerDocument||b:u,(a=n.exec(a))?d.isPlainObject(b)?(a=[u.createElement(a[1])],d.fn.attr.call(a,b,!0)):a=[i.createElement(a[1])]:(a=d.buildFragment([B[1]],[i]),a=(a.cacheable?d.clone(a.fragment):a.fragment).childNodes),
d.merge(this,a);if((b=u.getElementById(B[2]))&&b.parentNode){if(b.id!==B[2])return i.find(a);this.length=1;this[0]=b}this.context=u;this.selector=a;return this}return!b||b.jquery?(b||i).find(a):this.constructor(b).find(a)}if(d.isFunction(a))return i.ready(a);a.selector!==c&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,this)},selector:"",jquery:"1.7.2",length:0,size:function(){return this.length},toArray:function(){return v.call(this,0)},get:function(a){return null==a?this.toArray():
0>a?this[this.length+a]:this[a]},pushStack:function(a,b,c){var i=this.constructor();d.isArray(a)?Aa.apply(i,a):d.merge(i,a);i.prevObject=this;i.context=this.context;"find"===b?i.selector=this.selector+(this.selector?" ":"")+c:b&&(i.selector=this.selector+"."+b+"("+c+")");return i},each:function(a,b){return d.each(this,a,b)},ready:function(a){d.bindReady();ra.add(a);return this},eq:function(a){a=+a;return-1===a?this.slice(a):this.slice(a,a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},
slice:function(){return this.pushStack(v.apply(this,arguments),"slice",v.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:Aa,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,b,i,B,f,e=arguments[0]||{},g=1,j=arguments.length,h=!1;"boolean"===typeof e&&(h=e,e=arguments[1]||{},g=2);"object"!==typeof e&&!d.isFunction(e)&&(e=
{});j===g&&(e=this,--g);for(;g<j;g++)if(null!=(a=arguments[g]))for(b in a)i=e[b],B=a[b],e!==B&&(h&&B&&(d.isPlainObject(B)||(f=d.isArray(B)))?(f?(f=!1,i=i&&d.isArray(i)?i:[]):i=i&&d.isPlainObject(i)?i:{},e[b]=d.extend(h,i,B)):B!==c&&(e[b]=B));return e};d.extend({noConflict:function(b){a.$===d&&(a.$=f);b&&a.jQuery===d&&(a.jQuery=i);return d},isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!u.body)return setTimeout(d.ready,
1);d.isReady=!0;!0!==a&&0<--d.readyWait||(ra.fireWith(u,[d]),d.fn.trigger&&d(u).trigger("ready").off("ready"))}},bindReady:function(){if(!ra){ra=d.Callbacks("once memory");if("complete"===u.readyState)return setTimeout(d.ready,1);if(u.addEventListener)u.addEventListener("DOMContentLoaded",ea,!1),a.addEventListener("load",d.ready,!1);else if(u.attachEvent){u.attachEvent("onreadystatechange",ea);a.attachEvent("onload",d.ready);var c=!1;try{c=null==a.frameElement}catch(i){}u.documentElement.doScroll&&
c&&b()}}},isFunction:function(a){return"function"===d.type(a)},isArray:Array.isArray||function(a){return"array"===d.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!isNaN(parseFloat(a))&&isFinite(a)},type:function(a){return null==a?""+a:y[fb.call(a)]||"object"},isPlainObject:function(a){if(!a||"object"!==d.type(a)||a.nodeType||d.isWindow(a))return!1;try{if(a.constructor&&!za.call(a,"constructor")&&!za.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(b){return!1}for(var i in a);
return i===c||za.call(a,i)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(l.test(b.replace(w,"@").replace(m,"]").replace(o,"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b){if("string"!==typeof b||!b)return null;var i,B;try{a.DOMParser?(B=new DOMParser,i=B.parseFromString(b,"text/xml")):
(i=new ActiveXObject("Microsoft.XMLDOM"),i.async="false",i.loadXML(b))}catch(f){i=c}(!i||!i.documentElement||i.getElementsByTagName("parsererror").length)&&d.error("Invalid XML: "+b);return i},noop:function(){},globalEval:function(b){b&&j.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(H,"ms-").replace(q,s)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,b,i){var B,f=0,e=a.length,g=e===c||d.isFunction(a);
if(i)if(g)for(B in a){if(!1===b.apply(a[B],i))break}else for(;f<e&&!1!==b.apply(a[f++],i););else if(g)for(B in a){if(!1===b.call(a[B],B,a[B]))break}else for(;f<e&&!1!==b.call(a[f],f,a[f++]););return a},trim:x?function(a){return null==a?"":x.call(a)}:function(a){return null==a?"":a.toString().replace(h,"").replace(k,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var i=d.type(a);null==a.length||"string"===i||"function"===i||"regexp"===i||d.isWindow(a)?Aa.call(c,a):d.merge(c,a)}return c},inArray:function(a,
b,c){var d;if(b){if(L)return L.call(b,a,c);d=b.length;for(c=c?0>c?Math.max(0,d+c):c:0;c<d;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,b){var d=a.length,i=0;if("number"===typeof b.length)for(var B=b.length;i<B;i++)a[d++]=b[i];else for(;b[i]!==c;)a[d++]=b[i++];a.length=d;return a},grep:function(a,b,c){for(var d=[],i,c=!!c,B=0,f=a.length;B<f;B++)i=!!b(a[B],B),c!==i&&d.push(a[B]);return d},map:function(a,b,i){var B,f,e=[],g=0,j=a.length;if(a instanceof d||j!==c&&"number"===typeof j&&(0<
j&&a[0]&&a[j-1]||0===j||d.isArray(a)))for(;g<j;g++)B=b(a[g],g,i),null!=B&&(e[e.length]=B);else for(f in a)B=b(a[f],f,i),null!=B&&(e[e.length]=B);return e.concat.apply([],e)},guid:1,proxy:function(a,b){if("string"===typeof b)var i=a[b],b=a,a=i;if(!d.isFunction(a))return c;var B=v.call(arguments,2),i=function(){return a.apply(b,B.concat(v.call(arguments)))};i.guid=a.guid=a.guid||i.guid||d.guid++;return i},access:function(a,b,i,B,f,e,g){var j,h=null==i,k=0,n=a.length;if(i&&"object"===typeof i){for(k in i)d.access(a,
b,k,i[k],1,e,B);f=1}else if(B!==c){j=g===c&&d.isFunction(B);h&&(j?(j=b,b=function(a,b,c){return j.call(d(a),c)}):(b.call(a,B),b=null));if(b)for(;k<n;k++)b(a[k],i,j?B.call(a[k],k,b(a[k],i)):B,g);f=1}return f?a:h?b.call(a):n?b(a[0],i):e},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=p.exec(a)||t.exec(a)||C.exec(a)||0>a.indexOf("compatible")&&r.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,
a,this);a.superclass=this;a.fn=a.prototype=this();a.fn.constructor=a;a.sub=this.sub;a.fn.init=function(c,i){i&&i instanceof d&&!(i instanceof a)&&(i=a(i));return d.fn.init.call(this,c,i,b)};a.fn.init.prototype=a.fn;var b=a(u);return a},browser:{}});d.each("Boolean,Number,String,Function,Array,Date,RegExp,Object".split(","),function(a,b){y["[object "+b+"]"]=b.toLowerCase()});G=d.uaMatch(G);G.browser&&(d.browser[G.browser]=!0,d.browser.version=G.version);d.browser.webkit&&(d.browser.safari=!0);j.test("\u00a0")&&
(h=/^[\s\xA0]+/,k=/[\s\xA0]+$/);e=d(u);u.addEventListener?ea=function(){u.removeEventListener("DOMContentLoaded",ea,false);d.ready()}:u.attachEvent&&(ea=function(){if(u.readyState==="complete"){u.detachEvent("onreadystatechange",ea);d.ready()}});return d}(),P={};h.Callbacks=function(a){var a=a?P[a]||d(a):{},b=[],i=[],f,e,g,j,k,n,l=function(c){var d,i,f,e;d=0;for(i=c.length;d<i;d++)f=c[d],e=h.type(f),"array"===e?l(f):"function"===e&&(!a.unique||!m.has(f))&&b.push(f)},w=function(c,d){d=d||[];f=!a.memory||
[c,d];g=e=!0;n=j||0;j=0;for(k=b.length;b&&n<k;n++)if(!1===b[n].apply(c,d)&&a.stopOnFalse){f=!0;break}g=!1;b&&(a.once?!0===f?m.disable():b=[]:i&&i.length&&(f=i.shift(),m.fireWith(f[0],f[1])))},m={add:function(){if(b){var a=b.length;l(arguments);g?k=b.length:f&&!0!==f&&(j=a,w(f[0],f[1]))}return this},remove:function(){if(b)for(var c=arguments,d=0,i=c.length;d<i;d++)for(var f=0;f<b.length&&!(c[d]===b[f]&&(g&&f<=k&&(k--,f<=n&&n--),b.splice(f--,1),a.unique));f++);return this},has:function(a){if(b)for(var c=
0,d=b.length;c<d;c++)if(a===b[c])return!0;return!1},empty:function(){b=[];return this},disable:function(){b=i=f=c;return this},disabled:function(){return!b},lock:function(){i=c;(!f||!0===f)&&m.disable();return this},locked:function(){return!i},fireWith:function(b,c){i&&(g?a.once||i.push([b,c]):(!a.once||!f)&&w(b,c));return this},fire:function(){m.fireWith(this,arguments);return this},fired:function(){return!!e}};return m};var O=[].slice;h.extend({Deferred:function(a){var b=h.Callbacks("once memory"),
c=h.Callbacks("once memory"),d=h.Callbacks("memory"),i="pending",f={resolve:b,reject:c,notify:d},e={done:b.add,fail:c.add,progress:d.add,state:function(){return i},isResolved:b.fired,isRejected:c.fired,then:function(a,b,c){g.done(a).fail(b).progress(c);return this},always:function(){g.done.apply(g,arguments).fail.apply(g,arguments);return this},pipe:function(a,b,c){return h.Deferred(function(d){h.each({done:[a,"resolve"],fail:[b,"reject"],progress:[c,"notify"]},function(a,b){var c=b[0],i=b[1],f;if(h.isFunction(c))g[a](function(){if((f=
c.apply(this,arguments))&&h.isFunction(f.promise))f.promise().then(d.resolve,d.reject,d.notify);else d[i+"With"](this===g?d:this,[f])});else g[a](d[i])})}).promise()},promise:function(a){if(null==a)a=e;else for(var b in e)a[b]=e[b];return a}},g=e.promise({}),j;for(j in f)g[j]=f[j].fire,g[j+"With"]=f[j].fireWith;g.done(function(){i="resolved"},c.disable,d.lock).fail(function(){i="rejected"},b.disable,d.lock);a&&a.call(g,g);return g},when:function(a){function b(a){return function(b){d[a]=1<arguments.length?
O.call(arguments,0):b;--g||j.resolveWith(j,d)}}function c(a){return function(b){e[a]=1<arguments.length?O.call(arguments,0):b;j.notifyWith(k,e)}}var d=O.call(arguments,0),i=0,f=d.length,e=Array(f),g=f,j=1>=f&&a&&h.isFunction(a.promise)?a:h.Deferred(),k=j.promise();if(1<f){for(;i<f;i++)d[i]&&d[i].promise&&h.isFunction(d[i].promise)?d[i].promise().then(b(i),j.reject,c(i)):--g;g||j.resolveWith(j,d)}else j!==a&&j.resolveWith(j,f?[a]:[]);return k}});h.support=function(){var b,c,d,i,f,e,g,j,k=u.createElement("div");
k.setAttribute("className","t");k.innerHTML="   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>";c=k.getElementsByTagName("*");d=k.getElementsByTagName("a")[0];if(!c||!c.length||!d)return{};i=u.createElement("select");f=i.appendChild(u.createElement("option"));c=k.getElementsByTagName("input")[0];b={leadingWhitespace:3===k.firstChild.nodeType,tbody:!k.getElementsByTagName("tbody").length,htmlSerialize:!!k.getElementsByTagName("link").length,
...
pixelMargin:!0};h.boxModel=b.boxModel="CSS1Compat"===u.compatMode;c.checked=!0;b.noCloneChecked=c.cloneNode(!0).checked;i.disabled=!0;b.optDisabled=!f.disabled;try{delete k.test}catch(n){b.deleteExpando=!1}!k.addEventListener&&k.attachEvent&&k.fireEvent&&(k.attachEvent("onclick",function(){b.noCloneEvent=!1}),k.cloneNode(!0).fireEvent("onclick"));c=u.createElement("input");c.value="t";c.setAttribute("type","radio");b.radioValue="t"===c.value;c.setAttribute("checked","checked");c.setAttribute("name",
"t");k.appendChild(c);d=u.createDocumentFragment();d.appendChild(k.lastChild);b.checkClone=d.cloneNode(!0).cloneNode(!0).lastChild.checked;b.appendChecked=c.checked;d.removeChild(c);d.appendChild(k);if(k.attachEvent)for(g in{submit:1,change:1,focusin:1})c="on"+g,j=c in k,j||(k.setAttribute(c,"return;"),j="function"===typeof k[c]),b[g+"Bubbles"]=j;d.removeChild(k);d=i=f=k=c=null;h(function(){var c,d,i,f,g=u.getElementsByTagName("body")[0];if(g){c=u.createElement("div");c.style.cssText="padding:0;margin:0;border:0;visibility:hidden;width:0;height:0;position:static;top:0;margin-top:1px";
g.insertBefore(c,g.firstChild);k=u.createElement("div");c.appendChild(k);k.innerHTML="<table><tr><td style='padding:0;margin:0;border:0;display:none'></td><td>t</td></tr></table>";e=k.getElementsByTagName("td");j=e[0].offsetHeight===0;e[0].style.display="";e[1].style.display="none";b.reliableHiddenOffsets=j&&e[0].offsetHeight===0;if(a.getComputedStyle){k.innerHTML="";d=u.createElement("div");d.style.width="0";d.style.marginRight="0";k.style.width="2px";k.appendChild(d);b.reliableMarginRight=(parseInt((a.getComputedStyle(d,
...
k.innerHTML="<div style='position:absolute;top:0;left:0;width:1px;height:1px;padding:0;margin:0;border:5px solid #000;display:block;'><div style='padding:0;margin:0;border:0;display:block;overflow:hidden;'></div></div><table style='position:absolute;top:0;left:0;width:1px;height:1px;padding:0;margin:0;border:5px solid #000;' cellpadding='0' cellspacing='0'><tr><td></td></tr></table>";d=k.firstChild;i=d.firstChild;f={doesNotAddBorder:i.offsetTop!==5,doesAddBorderForTableAndCells:d.nextSibling.firstChild.firstChild.offsetTop===
5};i.style.position="fixed";i.style.top="20px";f.fixedPosition=i.offsetTop===20||i.offsetTop===15;i.style.position=i.style.top="";d.style.overflow="hidden";d.style.position="relative";f.subtractsBorderForOverflowNotVisible=i.offsetTop===-5;f.doesNotIncludeMarginInBodyOffset=g.offsetTop!==1;if(a.getComputedStyle){k.style.marginTop="1%";b.pixelMargin=(a.getComputedStyle(k,null)||{marginTop:0}).marginTop!=="1%"}if(typeof c.style.zoom!=="undefined")c.style.zoom=1;g.removeChild(c);k=null;h.extend(b,f)}});
return b}();var R=/^(?:\{.*\}|\[.*\])$/,i=/([A-Z])/g;h.extend({cache:{},uuid:0,expando:"jQuery"+(h.fn.jquery+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(a){a=a.nodeType?h.cache[a[h.expando]]:a[h.expando];return!!a&&!f(a)},data:function(a,b,d,i){if(h.acceptData(a)){var f;f=h.expando;var e="string"===typeof b,g=a.nodeType,j=g?h.cache:a,k=g?a[f]:a[f]&&f,n="events"===b;if(k&&j[k]&&(n||i||j[k].data)||!(e&&d===c)){k||
(g?a[f]=k=++h.uuid:k=f);j[k]||(j[k]={},g||(j[k].toJSON=h.noop));if("object"===typeof b||"function"===typeof b)i?j[k]=h.extend(j[k],b):j[k].data=h.extend(j[k].data,b);f=a=j[k];i||(a.data||(a.data={}),a=a.data);d!==c&&(a[h.camelCase(b)]=d);if(n&&!a[b])return f.events;e?(d=a[b],null==d&&(d=a[h.camelCase(b)])):d=a;return d}}},removeData:function(a,b,c){if(h.acceptData(a)){var d,i,e,g=h.expando,j=a.nodeType,k=j?h.cache:a,n=j?a[g]:g;if(k[n]){if(b&&(d=c?k[n]:k[n].data)){h.isArray(b)||(b in d?b=[b]:(b=h.camelCase(b),
b=b in d?[b]:b.split(" ")));i=0;for(e=b.length;i<e;i++)delete d[b[i]];if(!(c?f:h.isEmptyObject)(d))return}if(!c&&(delete k[n].data,!f(k[n])))return;h.support.deleteExpando||!k.setInterval?delete k[n]:k[n]=null;j&&(h.support.deleteExpando?delete a[g]:a.removeAttribute?a.removeAttribute(g):a[g]=null)}}},_data:function(a,b,c){return h.data(a,b,c,!0)},acceptData:function(a){if(a.nodeName){var b=h.noData[a.nodeName.toLowerCase()];if(b)return!(!0===b||a.getAttribute("classid")!==b)}return!0}});h.fn.extend({data:function(a,
b){var d,i,f,g,j,k=this[0],n=0,l=null;if(a===c){if(this.length&&(l=h.data(k),1===k.nodeType&&!h._data(k,"parsedAttrs"))){f=k.attributes;for(j=f.length;n<j;n++)g=f[n].name,0===g.indexOf("data-")&&(g=h.camelCase(g.substring(5)),e(k,g,l[g]));h._data(k,"parsedAttrs",!0)}return l}if("object"===typeof a)return this.each(function(){h.data(this,a)});d=a.split(".",2);d[1]=d[1]?"."+d[1]:"";i=d[1]+"!";return h.access(this,function(b){if(b===c)return l=this.triggerHandler("getData"+i,[d[0]]),l===c&&k&&(l=h.data(k,
a),l=e(k,a,l)),l===c&&d[1]?this.data(d[0]):l;d[1]=b;this.each(function(){var c=h(this);c.triggerHandler("setData"+i,d);h.data(this,a,b);c.triggerHandler("changeData"+i,d)})},null,b,1<arguments.length,null,!1)},removeData:function(a){return this.each(function(){h.removeData(this,a)})}});h.extend({_mark:function(a,b){a&&(b=(b||"fx")+"mark",h._data(a,b,(h._data(a,b)||0)+1))},_unmark:function(a,b,c){!0!==a&&(c=b,b=a,a=!1);if(b){var c=c||"fx",d=c+"mark";(a=a?0:(h._data(b,d)||1)-1)?h._data(b,d,a):(h.removeData(b,
d,!0),j(b,c,"mark"))}},queue:function(a,b,c){var d;if(a)return b=(b||"fx")+"queue",d=h._data(a,b),c&&(!d||h.isArray(c)?d=h._data(a,b,h.makeArray(c)):d.push(c)),d||[]},dequeue:function(a,b){var b=b||"fx",c=h.queue(a,b),d=c.shift(),i={};"inprogress"===d&&(d=c.shift());d&&("fx"===b&&c.unshift("inprogress"),h._data(a,b+".run",i),d.call(a,function(){h.dequeue(a,b)},i));c.length||(h.removeData(a,b+"queue "+b+".run",!0),j(a,b,"queue"))}});h.fn.extend({queue:function(a,b){var d=2;"string"!==typeof a&&(b=
a,a="fx",d--);return arguments.length<d?h.queue(this[0],a):b===c?this:this.each(function(){var c=h.queue(this,a,b);a==="fx"&&c[0]!=="inprogress"&&h.dequeue(this,a)})},dequeue:function(a){return this.each(function(){h.dequeue(this,a)})},delay:function(a,b){a=h.fx?h.fx.speeds[a]||a:a;return this.queue(b||"fx",function(b,c){var d=setTimeout(b,a);c.stop=function(){clearTimeout(d)}})},clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,b){function d(){--g||i.resolveWith(f,[f])}"string"!==
typeof a&&(b=a,a=c);for(var a=a||"fx",i=h.Deferred(),f=this,e=f.length,g=1,j=a+"defer",k=a+"queue",n=a+"mark",l;e--;)if(l=h.data(f[e],j,c,!0)||(h.data(f[e],k,c,!0)||h.data(f[e],n,c,!0))&&h.data(f[e],j,h.Callbacks("once memory"),!0))g++,l.add(d);d();return i.promise(b)}});var n=/[\n\t\r]/g,w=/\s+/,C=/\r/g,H=/^(?:button|input)$/i,G=/^(?:button|input|object|select|textarea)$/i,L=/^a(?:rea)?$/i,S=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,
N=h.support.getSetAttribute,K,W,la;h.fn.extend({attr:function(a,b){return h.access(this,h.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){h.removeAttr(this,a)})},prop:function(a,b){return h.access(this,h.prop,a,b,1<arguments.length)},removeProp:function(a){a=h.propFix[a]||a;return this.each(function(){try{this[a]=c,delete this[a]}catch(b){}})},addClass:function(a){var b,c,d,i,f,e,g;if(h.isFunction(a))return this.each(function(b){h(this).addClass(a.call(this,b,this.className))});
if(a&&"string"===typeof a){b=a.split(w);c=0;for(d=this.length;c<d;c++)if(i=this[c],1===i.nodeType)if(!i.className&&1===b.length)i.className=a;else{f=" "+i.className+" ";e=0;for(g=b.length;e<g;e++)~f.indexOf(" "+b[e]+" ")||(f+=b[e]+" ");i.className=h.trim(f)}}return this},removeClass:function(a){var b,d,i,f,e,g,j;if(h.isFunction(a))return this.each(function(b){h(this).removeClass(a.call(this,b,this.className))});if(a&&"string"===typeof a||a===c){b=(a||"").split(w);d=0;for(i=this.length;d<i;d++)if(f=
this[d],1===f.nodeType&&f.className)if(a){e=(" "+f.className+" ").replace(n," ");g=0;for(j=b.length;g<j;g++)e=e.replace(" "+b[g]+" "," ");f.className=h.trim(e)}else f.className=""}return this},toggleClass:function(a,b){var c=typeof a,d="boolean"===typeof b;return h.isFunction(a)?this.each(function(c){h(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===c)for(var i,f=0,e=h(this),g=b,j=a.split(w);i=j[f++];)g=d?g:!e.hasClass(i),e[g?"addClass":"removeClass"](i);
else if("undefined"===c||"boolean"===c)this.className&&h._data(this,"__className__",this.className),this.className=this.className||!1===a?"":h._data(this,"__className__")||""})},hasClass:function(a){for(var a=" "+a+" ",b=0,c=this.length;b<c;b++)if(1===this[b].nodeType&&-1<(" "+this[b].className+" ").replace(n," ").indexOf(a))return!0;return!1},val:function(a){var b,d,i,f=this[0];if(arguments.length)return i=h.isFunction(a),this.each(function(d){var f=h(this);if(1===this.nodeType&&(d=i?a.call(this,
d,f.val()):a,null==d?d="":"number"===typeof d?d+="":h.isArray(d)&&(d=h.map(d,function(a){return a==null?"":a+""})),b=h.valHooks[this.type]||h.valHooks[this.nodeName.toLowerCase()],!b||!("set"in b)||b.set(this,d,"value")===c))this.value=d});if(f){if((b=h.valHooks[f.type]||h.valHooks[f.nodeName.toLowerCase()])&&"get"in b&&(d=b.get(f,"value"))!==c)return d;d=f.value;return"string"===typeof d?d.replace(C,""):null==d?"":d}}});h.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||
b.specified?a.value:a.text}},select:{get:function(a){var b,c,d=a.selectedIndex,i=[],f=a.options,e="select-one"===a.type;if(0>d)return null;a=e?d:0;for(c=e?d+1:f.length;a<c;a++)if(b=f[a],b.selected&&(h.support.optDisabled?!b.disabled:null===b.getAttribute("disabled"))&&(!b.parentNode.disabled||!h.nodeName(b.parentNode,"optgroup"))){b=h(b).val();if(e)return b;i.push(b)}return e&&!i.length&&f.length?h(f[d]).val():i},set:function(a,b){var c=h.makeArray(b);h(a).find("option").each(function(){this.selected=
0<=h.inArray(h(this).val(),c)});c.length||(a.selectedIndex=-1);return c}}},attrFn:{val:!0,css:!0,html:!0,text:!0,data:!0,width:!0,height:!0,offset:!0},attr:function(a,b,d,i){var f,e,g=a.nodeType;if(a&&!(3===g||8===g||2===g)){if(i&&b in h.attrFn)return h(a)[b](d);if("undefined"===typeof a.getAttribute)return h.prop(a,b,d);if(i=1!==g||!h.isXMLDoc(a))b=b.toLowerCase(),e=h.attrHooks[b]||(S.test(b)?W:K);if(d!==c)if(null===d)h.removeAttr(a,b);else{if(e&&"set"in e&&i&&(f=e.set(a,d,b))!==c)return f;a.setAttribute(b,
""+d);return d}else{if(e&&"get"in e&&i&&null!==(f=e.get(a,b)))return f;f=a.getAttribute(b);return null===f?c:f}}},removeAttr:function(a,b){var c,d,i,f,e,g=0;if(b&&1===a.nodeType){d=b.toLowerCase().split(w);for(f=d.length;g<f;g++)if(i=d[g])c=h.propFix[i]||i,(e=S.test(i))||h.attr(a,i,""),a.removeAttribute(N?i:c),e&&c in a&&(a[c]=!1)}},attrHooks:{type:{set:function(a,b){if(H.test(a.nodeName)&&a.parentNode)h.error("type property can't be changed");else if(!h.support.radioValue&&"radio"===b&&h.nodeName(a,
...
prop:function(a,b,d){var i,f,e=a.nodeType;if(a&&!(3===e||8===e||2===e)){if(1!==e||!h.isXMLDoc(a))b=h.propFix[b]||b,f=h.propHooks[b];return d!==c?f&&"set"in f&&(i=f.set(a,d,b))!==c?i:a[b]=d:f&&"get"in f&&null!==(i=f.get(a,b))?i:a[b]}},propHooks:{tabIndex:{get:function(a){var b=a.getAttributeNode("tabindex");return b&&b.specified?parseInt(b.value,10):G.test(a.nodeName)||L.test(a.nodeName)&&a.href?0:c}}}});h.attrHooks.tabindex=h.propHooks.tabIndex;W={get:function(a,b){var d,i=h.prop(a,b);return!0===
i||"boolean"!==typeof i&&(d=a.getAttributeNode(b))&&!1!==d.nodeValue?b.toLowerCase():c},set:function(a,b,c){!1===b?h.removeAttr(a,c):(b=h.propFix[c]||c,b in a&&(a[b]=!0),a.setAttribute(c,c.toLowerCase()));return c}};N||(la={name:!0,id:!0,coords:!0},K=h.valHooks.button={get:function(a,b){var d;return(d=a.getAttributeNode(b))&&(la[b]?""!==d.nodeValue:d.specified)?d.nodeValue:c},set:function(a,b,c){var d=a.getAttributeNode(c);d||(d=u.createAttribute(c),a.setAttributeNode(d));return d.nodeValue=b+""}},
...
{set:function(a,b){if(h.isArray(b))return a.checked=h.inArray(h(a).val(),b)>=0}})});var $=/^(?:textarea|input|select)$/i,aa=/^([^\.]*)?(?:\.(.+))?$/,La=/(?:^|\s)hover(\.\S+)?\b/,ka=/^key/,ga=/^(?:mouse|contextmenu)|click/,ha=/^(?:focusinfocus|focusoutblur)$/,va=/^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/,ma=function(a){if(a=va.exec(a)){a[1]=(a[1]||"").toLowerCase();a[3]=a[3]&&RegExp("(?:^|\\s)"+a[3]+"(?:\\s|$)")}return a},ia=function(a){return h.event.special.hover?a:a.replace(La,"mouseenter$1 mouseleave$1")};
h.event={add:function(a,b,d,i,f){var e,g,j,k,n,l,m,w,o;if(!(a.nodeType===3||a.nodeType===8||!b||!d||!(e=h._data(a)))){if(d.handler){m=d;d=m.handler;f=m.selector}if(!d.guid)d.guid=h.guid++;j=e.events;if(!j)e.events=j={};g=e.handle;if(!g){e.handle=g=function(a){return typeof h!=="undefined"&&(!a||h.event.triggered!==a.type)?h.event.dispatch.apply(g.elem,arguments):c};g.elem=a}b=h.trim(ia(b)).split(" ");for(e=0;e<b.length;e++){k=aa.exec(b[e])||[];n=k[1];l=(k[2]||"").split(".").sort();o=h.event.special[n]||
{};n=(f?o.delegateType:o.bindType)||n;o=h.event.special[n]||{};k=h.extend({type:n,origType:k[1],data:i,handler:d,guid:d.guid,selector:f,quick:f&&ma(f),namespace:l.join(".")},m);w=j[n];if(!w){w=j[n]=[];w.delegateCount=0;if(!o.setup||o.setup.call(a,i,l,g)===false)a.addEventListener?a.addEventListener(n,g,false):a.attachEvent&&a.attachEvent("on"+n,g)}if(o.add){o.add.call(a,k);if(!k.handler.guid)k.handler.guid=d.guid}f?w.splice(w.delegateCount++,0,k):w.push(k);h.event.global[n]=true}a=null}},global:{},
remove:function(a,b,c,d,i){var f=h.hasData(a)&&h._data(a),e,g,j,k,n,l,w,m,o,p;if(f&&(w=f.events)){b=h.trim(ia(b||"")).split(" ");for(e=0;e<b.length;e++){g=aa.exec(b[e])||[];j=k=g[1];g=g[2];if(j){m=h.event.special[j]||{};j=(d?m.delegateType:m.bindType)||j;o=w[j]||[];n=o.length;g=g?RegExp("(^|\\.)"+g.split(".").sort().join("\\.(?:.*\\.)?")+"(\\.|$)"):null;for(l=0;l<o.length;l++){p=o[l];if((i||k===p.origType)&&(!c||c.guid===p.guid)&&(!g||g.test(p.namespace))&&(!d||d===p.selector||d==="**"&&p.selector)){o.splice(l--,
1);p.selector&&o.delegateCount--;m.remove&&m.remove.call(a,p)}}if(o.length===0&&n!==o.length){(!m.teardown||m.teardown.call(a,g)===false)&&h.removeEvent(a,j,f.handle);delete w[j]}}else for(j in w)h.event.remove(a,j+b[e],c,d,true)}if(h.isEmptyObject(w)){if(b=f.handle)b.elem=null;h.removeData(a,["events","handle"],true)}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(b,d,i,f){if(!i||!(i.nodeType===3||i.nodeType===8)){var e=b.type||b,g=[],j,k,n,l,m;if(!ha.test(e+h.event.triggered)){if(e.indexOf("!")>=
0){e=e.slice(0,-1);j=true}if(e.indexOf(".")>=0){g=e.split(".");e=g.shift();g.sort()}if(i&&!h.event.customEvent[e]||h.event.global[e]){b=typeof b==="object"?b[h.expando]?b:new h.Event(e,b):new h.Event(e);b.type=e;b.isTrigger=true;b.exclusive=j;b.namespace=g.join(".");b.namespace_re=b.namespace?RegExp("(^|\\.)"+g.join("\\.(?:.*\\.)?")+"(\\.|$)"):null;j=e.indexOf(":")<0?"on"+e:"";if(i){b.result=c;if(!b.target)b.target=i;d=d!=null?h.makeArray(d):[];d.unshift(b);n=h.event.special[e]||{};if(!(n.trigger&&
n.trigger.apply(i,d)===false)){m=[[i,n.bindType||e]];if(!f&&!n.noBubble&&!h.isWindow(i)){l=n.delegateType||e;g=ha.test(l+e)?i:i.parentNode;for(k=null;g;g=g.parentNode){m.push([g,l]);k=g}k&&k===i.ownerDocument&&m.push([k.defaultView||k.parentWindow||a,l])}for(k=0;k<m.length&&!b.isPropagationStopped();k++){g=m[k][0];b.type=m[k][1];(l=(h._data(g,"events")||{})[b.type]&&h._data(g,"handle"))&&l.apply(g,d);(l=j&&g[j])&&h.acceptData(g)&&l.apply(g,d)===false&&b.preventDefault()}b.type=e;if(!f&&!b.isDefaultPrevented()&&
(!n._default||n._default.apply(i.ownerDocument,d)===false)&&!(e==="click"&&h.nodeName(i,"a"))&&h.acceptData(i))if(j&&i[e]&&(e!=="focus"&&e!=="blur"||b.target.offsetWidth!==0)&&!h.isWindow(i)){(k=i[j])&&(i[j]=null);h.event.triggered=e;i[e]();h.event.triggered=c;k&&(i[j]=k)}return b.result}}else{i=h.cache;for(k in i)i[k].events&&i[k].events[e]&&h.event.trigger(b,d,i[k].handle.elem,true)}}}}},dispatch:function(b){var b=h.event.fix(b||a.event),d=(h._data(this,"events")||{})[b.type]||[],i=d.delegateCount,
f=[].slice.call(arguments,0),e=!b.exclusive&&!b.namespace,g=h.event.special[b.type]||{},j=[],k,n,l,m,w,o,p;f[0]=b;b.delegateTarget=this;if(!(g.preDispatch&&g.preDispatch.call(this,b)===false)){if(i&&!(b.button&&b.type==="click")){l=h(this);l.context=this.ownerDocument||this;for(n=b.target;n!=this;n=n.parentNode||this)if(n.disabled!==true){w={};o=[];l[0]=n;for(k=0;k<i;k++){m=d[k];p=m.selector;if(w[p]===c){var t=w,C=p,r;if(m.quick){r=m.quick;var q=n.attributes||{};r=(!r[1]||n.nodeName.toLowerCase()===
r[1])&&(!r[2]||(q.id||{}).value===r[2])&&(!r[3]||r[3].test((q["class"]||{}).value))}else r=l.is(p);t[C]=r}w[p]&&o.push(m)}o.length&&j.push({elem:n,matches:o})}}d.length>i&&j.push({elem:this,matches:d.slice(i)});for(k=0;k<j.length&&!b.isPropagationStopped();k++){i=j[k];b.currentTarget=i.elem;for(d=0;d<i.matches.length&&!b.isImmediatePropagationStopped();d++){m=i.matches[d];if(e||!b.namespace&&!m.namespace||b.namespace_re&&b.namespace_re.test(m.namespace)){b.data=m.data;b.handleObj=m;m=((h.event.special[m.origType]||
{}).handle||m.handler).apply(i.elem,f);if(m!==c){b.result=m;if(m===false){b.preventDefault();b.stopPropagation()}}}}}g.postDispatch&&g.postDispatch.call(this,b);return b.result}},props:"attrChange,attrName,relatedNode,srcElement,altKey,bubbles,cancelable,ctrlKey,currentTarget,eventPhase,metaKey,relatedTarget,shiftKey,target,timeStamp,view,which".split(","),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){if(a.which==null)a.which=b.charCode!=null?b.charCode:b.keyCode;
return a}},mouseHooks:{props:"button,buttons,clientX,clientY,fromElement,offsetX,offsetY,pageX,pageY,screenX,screenY,toElement".split(","),filter:function(a,b){var d,i,f=b.button,e=b.fromElement;if(a.pageX==null&&b.clientX!=null){d=a.target.ownerDocument||u;i=d.documentElement;d=d.body;a.pageX=b.clientX+(i&&i.scrollLeft||d&&d.scrollLeft||0)-(i&&i.clientLeft||d&&d.clientLeft||0);a.pageY=b.clientY+(i&&i.scrollTop||d&&d.scrollTop||0)-(i&&i.clientTop||d&&d.clientTop||0)}if(!a.relatedTarget&&e)a.relatedTarget=
e===a.target?b.toElement:e;if(!a.which&&f!==c)a.which=f&1?1:f&2?3:f&4?2:0;return a}},fix:function(a){if(a[h.expando])return a;var b,d,i=a,f=h.event.fixHooks[a.type]||{},e=f.props?this.props.concat(f.props):this.props,a=h.Event(i);for(b=e.length;b;){d=e[--b];a[d]=i[d]}if(!a.target)a.target=i.srcElement||u;if(a.target.nodeType===3)a.target=a.target.parentNode;if(a.metaKey===c)a.metaKey=a.ctrlKey;return f.filter?f.filter(a,i):a},special:{ready:{setup:h.bindReady},load:{noBubble:!0},focus:{delegateType:"focusin"},
...
c,false)}:function(a,b,c){a.detachEvent&&a.detachEvent("on"+b,c)};h.Event=function(a,c){if(!(this instanceof h.Event))return new h.Event(a,c);if(a&&a.type){this.originalEvent=a;this.type=a.type;this.isDefaultPrevented=a.defaultPrevented||a.returnValue===false||a.getPreventDefault&&a.getPreventDefault()?b:g}else this.type=a;c&&h.extend(this,c);this.timeStamp=a&&a.timeStamp||h.now();this[h.expando]=true};h.Event.prototype={preventDefault:function(){this.isDefaultPrevented=b;var a=this.originalEvent;
if(a)a.preventDefault?a.preventDefault():a.returnValue=false},stopPropagation:function(){this.isPropagationStopped=b;var a=this.originalEvent;if(a){a.stopPropagation&&a.stopPropagation();a.cancelBubble=true}},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=b;this.stopPropagation()},isDefaultPrevented:g,isPropagationStopped:g,isImmediatePropagationStopped:g};h.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(a,b){h.event.special[a]={delegateType:b,bindType:b,handle:function(a){var c=
a.relatedTarget,d=a.handleObj,i;if(!c||c!==this&&!h.contains(this,c)){a.type=d.origType;i=d.handler.apply(this,arguments);a.type=b}return i}}});h.support.submitBubbles||(h.event.special.submit={setup:function(){if(h.nodeName(this,"form"))return false;h.event.add(this,"click._submit keypress._submit",function(a){a=a.target;if((a=h.nodeName(a,"input")||h.nodeName(a,"button")?a.form:c)&&!a._submit_attached){h.event.add(a,"submit._submit",function(a){a._submit_bubble=true});a._submit_attached=true}})},
postDispatch:function(a){if(a._submit_bubble){delete a._submit_bubble;this.parentNode&&!a.isTrigger&&h.event.simulate("submit",this.parentNode,a,true)}},teardown:function(){if(h.nodeName(this,"form"))return false;h.event.remove(this,"._submit")}});h.support.changeBubbles||(h.event.special.change={setup:function(){if($.test(this.nodeName)){if(this.type==="checkbox"||this.type==="radio"){h.event.add(this,"propertychange._change",function(a){if(a.originalEvent.propertyName==="checked")this._just_changed=
true});h.event.add(this,"click._change",function(a){if(this._just_changed&&!a.isTrigger){this._just_changed=false;h.event.simulate("change",this,a,true)}})}return false}h.event.add(this,"beforeactivate._change",function(a){a=a.target;if($.test(a.nodeName)&&!a._change_attached){h.event.add(a,"change._change",function(a){this.parentNode&&!a.isSimulated&&!a.isTrigger&&h.event.simulate("change",this.parentNode,a,true)});a._change_attached=true}})},handle:function(a){var b=a.target;if(this!==b||a.isSimulated||
a.isTrigger||b.type!=="radio"&&b.type!=="checkbox")return a.handleObj.handler.apply(this,arguments)},teardown:function(){h.event.remove(this,"._change");return $.test(this.nodeName)}});h.support.focusinBubbles||h.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){h.event.simulate(b,a.target,h.event.fix(a),true)};h.event.special[b]={setup:function(){c++===0&&u.addEventListener(a,d,true)},teardown:function(){--c===0&&u.removeEventListener(a,d,true)}}});h.fn.extend({on:function(a,
b,d,i,f){var e,j;if(typeof a==="object"){if(typeof b!=="string"){d=d||b;b=c}for(j in a)this.on(j,b,d,a[j],f);return this}if(d==null&&i==null){i=b;d=b=c}else if(i==null)if(typeof b==="string"){i=d;d=c}else{i=d;d=b;b=c}if(i===false)i=g;else if(!i)return this;if(f===1){e=i;i=function(a){h().off(a);return e.apply(this,arguments)};i.guid=e.guid||(e.guid=h.guid++)}return this.each(function(){h.event.add(this,a,i,d,b)})},one:function(a,b,c,d){return this.on(a,b,c,d,1)},off:function(a,b,d){if(a&&a.preventDefault&&
a.handleObj){var i=a.handleObj;h(a.delegateTarget).off(i.namespace?i.origType+"."+i.namespace:i.origType,i.selector,i.handler);return this}if(typeof a==="object"){for(i in a)this.off(i,b,a[i]);return this}if(b===false||typeof b==="function"){d=b;b=c}d===false&&(d=g);return this.each(function(){h.event.remove(this,a,d,b)})},bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,null,b)},live:function(a,b,c){h(this.context).on(a,this.selector,b,c);return this},die:function(a,
b){h(this.context).off(a,this.selector||"**",b);return this},delegate:function(a,b,c,d){return this.on(b,a,c,d)},undelegate:function(a,b,c){return arguments.length==1?this.off(a,"**"):this.off(b,a,c)},trigger:function(a,b){return this.each(function(){h.event.trigger(a,b,this)})},triggerHandler:function(a,b){if(this[0])return h.event.trigger(a,b,this[0],true)},toggle:function(a){var b=arguments,c=a.guid||h.guid++,d=0,i=function(c){var i=(h._data(this,"lastToggle"+a.guid)||0)%d;h._data(this,"lastToggle"+
a.guid,i+1);c.preventDefault();return b[i].apply(this,arguments)||false};for(i.guid=c;d<b.length;)b[d++].guid=c;return this.click(i)},hover:function(a,b){return this.mouseenter(a).mouseleave(b||a)}});h.each("blur,focus,focusin,focusout,load,resize,scroll,unload,click,dblclick,mousedown,mouseup,mousemove,mouseover,mouseout,mouseenter,mouseleave,change,select,submit,keydown,keypress,keyup,error,contextmenu".split(","),function(a,b){h.fn[b]=function(a,c){if(c==null){c=a;a=null}return arguments.length>
0?this.on(b,null,a,c):this.trigger(b)};h.attrFn&&(h.attrFn[b]=true);if(ka.test(b))h.event.fixHooks[b]=h.event.keyHooks;if(ga.test(b))h.event.fixHooks[b]=h.event.mouseHooks});(function(){function a(b,c,d,f,e,g){for(var e=0,j=f.length;e<j;e++){var k=f[e];if(k){for(var h=false,k=k[b];k;){if(k[i]===d){h=f[k.sizset];break}if(k.nodeType===1&&!g){k[i]=d;k.sizset=e}if(k.nodeName.toLowerCase()===c){h=k;break}k=k[b]}f[e]=h}}}function b(a,c,d,f,e,g){for(var e=0,j=f.length;e<j;e++){var k=f[e];if(k){for(var h=
false,k=k[a];k;){if(k[i]===d){h=f[k.sizset];break}if(k.nodeType===1){if(!g){k[i]=d;k.sizset=e}if(typeof c!=="string"){if(k===c){h=true;break}}else if(m.filter(c,[k]).length>0){h=k;break}}k=k[a]}f[e]=h}}}var d=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,i="sizcache"+(Math.random()+"").replace(".",""),f=0,e=Object.prototype.toString,g=false,j=true,k=/\\/g,n=/\r\n/g,l=/\W/;[0,0].sort(function(){j=false;return 0});
var m=function(a,b,c,i){var c=c||[],f=b=b||u;if(b.nodeType!==1&&b.nodeType!==9)return[];if(!a||typeof a!=="string")return c;var g,j,k,h,n,B=true,l=m.isXML(b),w=[],t=a;do{d.exec("");if(g=d.exec(t)){t=g[3];w.push(g[1]);if(g[2]){h=g[3];break}}}while(g);if(w.length>1&&p.exec(a))if(w.length===2&&o.relative[w[0]])j=G(w[0]+w[1],b,i);else for(j=o.relative[w[0]]?[b]:m(w.shift(),b);w.length;){a=w.shift();o.relative[a]&&(a=a+w.shift());j=G(a,j,i)}else{if(!i&&w.length>1&&b.nodeType===9&&!l&&o.match.ID.test(w[0])&&
!o.match.ID.test(w[w.length-1])){g=m.find(w.shift(),b,l);b=g.expr?m.filter(g.expr,g.set)[0]:g.set[0]}if(b){g=i?{expr:w.pop(),set:r(i)}:m.find(w.pop(),w.length===1&&(w[0]==="~"||w[0]==="+")&&b.parentNode?b.parentNode:b,l);j=g.expr?m.filter(g.expr,g.set):g.set;for(w.length>0?k=r(j):B=false;w.length;){g=n=w.pop();o.relative[n]?g=w.pop():n="";g==null&&(g=b);o.relative[n](k,g,l)}}else k=[]}k||(k=j);k||m.error(n||a);if(e.call(k)==="[object Array]")if(B)if(b&&b.nodeType===1)for(a=0;k[a]!=null;a++)k[a]&&
(k[a]===true||k[a].nodeType===1&&m.contains(b,k[a]))&&c.push(j[a]);else for(a=0;k[a]!=null;a++)k[a]&&k[a].nodeType===1&&c.push(j[a]);else c.push.apply(c,k);else r(k,c);if(h){m(h,f,c,i);m.uniqueSort(c)}return c};m.uniqueSort=function(a){if(H){g=j;a.sort(H);if(g)for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1)}return a};m.matches=function(a,b){return m(a,null,null,b)};m.matchesSelector=function(a,b){return m(b,null,null,[a]).length>0};m.find=function(a,b,c){var d,i,f,e,g,j;if(!a)return[];i=
0;for(f=o.order.length;i<f;i++){g=o.order[i];if(e=o.leftMatch[g].exec(a)){j=e[1];e.splice(1,1);if(j.substr(j.length-1)!=="\\"){e[1]=(e[1]||"").replace(k,"");d=o.find[g](e,b,c);if(d!=null){a=a.replace(o.match[g],"");break}}}}d||(d=typeof b.getElementsByTagName!=="undefined"?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};m.filter=function(a,b,d,i){for(var f,e,g,k,j,h,n,B,l=a,w=[],p=b,t=b&&b[0]&&m.isXML(b[0]);a&&b.length;){for(g in o.filter)if((f=o.leftMatch[g].exec(a))!=null&&f[2]){h=o.filter[g];
j=f[1];e=false;f.splice(1,1);if(j.substr(j.length-1)!=="\\"){p===w&&(w=[]);if(o.preFilter[g])if(f=o.preFilter[g](f,p,d,w,i,t)){if(f===true)continue}else e=k=true;if(f)for(n=0;(j=p[n])!=null;n++)if(j){k=h(j,f,n,p);B=i^k;if(d&&k!=null)B?e=true:p[n]=false;else if(B){w.push(j);e=true}}if(k!==c){d||(p=w);a=a.replace(o.match[g],"");if(!e)return[];break}}}if(a===l)if(e==null)m.error(a);else break;l=a}return p};m.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};var w=m.getText=
function(a){var b,c;b=a.nodeType;var d="";if(b)if(b===1||b===9||b===11){if(typeof a.textContent==="string")return a.textContent;if(typeof a.innerText==="string")return a.innerText.replace(n,"");for(a=a.firstChild;a;a=a.nextSibling)d=d+w(a)}else{if(b===3||b===4)return a.nodeValue}else for(b=0;c=a[b];b++)c.nodeType!==8&&(d=d+w(c));return d},o=m.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,
ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/,TAG:/^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/,CHILD:/:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/,POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/,PSEUDO:/:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/},leftMatch:{},attrMap:{"class":"className","for":"htmlFor"},attrHandle:{href:function(a){return a.getAttribute("href")},
type:function(a){return a.getAttribute("type")}},relative:{"+":function(a,b){var c=typeof b==="string",d=c&&!l.test(b),c=c&&!d;d&&(b=b.toLowerCase());for(var d=0,i=a.length,f;d<i;d++)if(f=a[d]){for(;(f=f.previousSibling)&&f.nodeType!==1;);a[d]=c||f&&f.nodeName.toLowerCase()===b?f||false:f===b}c&&m.filter(b,a,true)},">":function(a,b){var c,d=typeof b==="string",i=0,f=a.length;if(d&&!l.test(b))for(b=b.toLowerCase();i<f;i++){if(c=a[i]){c=c.parentNode;a[i]=c.nodeName.toLowerCase()===b?c:false}}else{for(;i<
f;i++)(c=a[i])&&(a[i]=d?c.parentNode:c.parentNode===b);d&&m.filter(b,a,true)}},"":function(c,d,i){var e,g=f++,j=b;if(typeof d==="string"&&!l.test(d)){e=d=d.toLowerCase();j=a}j("parentNode",d,g,c,e,i)},"~":function(c,d,i){var e,g=f++,j=b;if(typeof d==="string"&&!l.test(d)){e=d=d.toLowerCase();j=a}j("previousSibling",d,g,c,e,i)}},find:{ID:function(a,b,c){if(typeof b.getElementById!=="undefined"&&!c)return(a=b.getElementById(a[1]))&&a.parentNode?[a]:[]},NAME:function(a,b){if(typeof b.getElementsByName!==
"undefined"){for(var c=[],d=b.getElementsByName(a[1]),i=0,f=d.length;i<f;i++)d[i].getAttribute("name")===a[1]&&c.push(d[i]);return c.length===0?null:c}},TAG:function(a,b){if(typeof b.getElementsByTagName!=="undefined")return b.getElementsByTagName(a[1])}},preFilter:{CLASS:function(a,b,c,d,i,f){a=" "+a[1].replace(k,"")+" ";if(f)return a;for(var f=0,e;(e=b[f])!=null;f++)e&&(i^(e.className&&(" "+e.className+" ").replace(/[\t\n\r]/g," ").indexOf(a)>=0)?c||d.push(e):c&&(b[f]=false));return false},ID:function(a){return a[1].replace(k,
"")},TAG:function(a){return a[1].replace(k,"").toLowerCase()},CHILD:function(a){if(a[1]==="nth"){a[2]||m.error(a[0]);a[2]=a[2].replace(/^\+|\s*/g,"");var b=/(-?)(\d*)(?:n([+\-]?\d*))?/.exec(a[2]==="even"&&"2n"||a[2]==="odd"&&"2n+1"||!/\D/.test(a[2])&&"0n+"+a[2]||a[2]);a[2]=b[1]+(b[2]||1)-0;a[3]=b[3]-0}else a[2]&&m.error(a[0]);a[0]=f++;return a},ATTR:function(a,b,c,d,i,f){b=a[1]=a[1].replace(k,"");!f&&o.attrMap[b]&&(a[1]=o.attrMap[b]);a[4]=(a[4]||a[5]||"").replace(k,"");a[2]==="~="&&(a[4]=" "+a[4]+
" ");return a},PSEUDO:function(a,b,c,i,f){if(a[1]==="not")if((d.exec(a[3])||"").length>1||/^\w/.test(a[3]))a[3]=m(a[3],null,null,b);else{a=m.filter(a[3],b,c,1^f);c||i.push.apply(i,a);return false}else if(o.match.POS.test(a[0])||o.match.CHILD.test(a[0]))return true;return a},POS:function(a){a.unshift(true);return a}},filters:{enabled:function(a){return a.disabled===false&&a.type!=="hidden"},disabled:function(a){return a.disabled===true},checked:function(a){return a.checked===true},selected:function(a){a.parentNode&&
...
b,c,d){var i=b[1],f=o.filters[i];if(f)return f(a,c,b,d);if(i==="contains")return(a.textContent||a.innerText||w([a])||"").indexOf(b[3])>=0;if(i==="not"){b=b[3];c=0;for(d=b.length;c<d;c++)if(b[c]===a)return false;return true}m.error(i)},CHILD:function(a,b){var c,d,f,e,g,j;c=b[1];j=a;switch(c){case "only":case "first":for(;j=j.previousSibling;)if(j.nodeType===1)return false;if(c==="first")return true;j=a;case "last":for(;j=j.nextSibling;)if(j.nodeType===1)return false;return true;case "nth":c=b[2];d=
b[3];if(c===1&&d===0)return true;f=b[0];if((e=a.parentNode)&&(e[i]!==f||!a.nodeIndex)){g=0;for(j=e.firstChild;j;j=j.nextSibling)if(j.nodeType===1)j.nodeIndex=++g;e[i]=f}j=a.nodeIndex-d;return c===0?j===0:j%c===0&&j/c>=0}},ID:function(a,b){return a.nodeType===1&&a.getAttribute("id")===b},TAG:function(a,b){return b==="*"&&a.nodeType===1||!!a.nodeName&&a.nodeName.toLowerCase()===b},CLASS:function(a,b){return(" "+(a.className||a.getAttribute("class"))+" ").indexOf(b)>-1},ATTR:function(a,b){var c=b[1],
c=m.attr?m.attr(a,c):o.attrHandle[c]?o.attrHandle[c](a):a[c]!=null?a[c]:a.getAttribute(c),d=c+"",i=b[2],f=b[4];return c==null?i==="!=":!i&&m.attr?c!=null:i==="="?d===f:i==="*="?d.indexOf(f)>=0:i==="~="?(" "+d+" ").indexOf(f)>=0:!f?d&&c!==false:i==="!="?d!==f:i==="^="?d.indexOf(f)===0:i==="$="?d.substr(d.length-f.length)===f:i==="|="?d===f||d.substr(0,f.length+1)===f+"-":false},POS:function(a,b,c,d){var i=o.setFilters[b[2]];if(i)return i(a,c,b,d)}}},p=o.match.POS,t=function(a,b){return"\\"+(b-0+1)},
C;for(C in o.match){o.match[C]=RegExp(o.match[C].source+/(?![^\[]*\])(?![^\(]*\))/.source);o.leftMatch[C]=RegExp(/(^(?:.|\r|\n)*?)/.source+o.match[C].source.replace(/\\(\d+)/g,t))}o.match.globalPOS=p;var r=function(a,b){a=Array.prototype.slice.call(a,0);if(b){b.push.apply(b,a);return b}return a};try{Array.prototype.slice.call(u.documentElement.childNodes,0)[0].nodeType}catch(q){r=function(a,b){var c=0,d=b||[];if(e.call(a)==="[object Array]")Array.prototype.push.apply(d,a);else if(typeof a.length===
"number")for(var i=a.length;c<i;c++)d.push(a[c]);else for(;a[c];c++)d.push(a[c]);return d}}var H,s;if(u.documentElement.compareDocumentPosition)H=function(a,b){if(a===b){g=true;return 0}return!a.compareDocumentPosition||!b.compareDocumentPosition?a.compareDocumentPosition?-1:1:a.compareDocumentPosition(b)&4?-1:1};else{H=function(a,b){if(a===b){g=true;return 0}if(a.sourceIndex&&b.sourceIndex)return a.sourceIndex-b.sourceIndex;var c,d,i=[],f=[];c=a.parentNode;d=b.parentNode;var e=c;if(c===d)return s(a,
b);if(c){if(!d)return 1}else return-1;for(;e;){i.unshift(e);e=e.parentNode}for(e=d;e;){f.unshift(e);e=e.parentNode}c=i.length;d=f.length;for(e=0;e<c&&e<d;e++)if(i[e]!==f[e])return s(i[e],f[e]);return e===c?s(a,f[e],-1):s(i[e],b,1)};s=function(a,b,c){if(a===b)return c;for(a=a.nextSibling;a;){if(a===b)return-1;a=a.nextSibling}return 1}}(function(){var a=u.createElement("div"),b="script"+(new Date).getTime(),d=u.documentElement;a.innerHTML="<a name='"+b+"'/>";d.insertBefore(a,d.firstChild);if(u.getElementById(b)){o.find.ID=
function(a,b,d){if(typeof b.getElementById!=="undefined"&&!d)return(b=b.getElementById(a[1]))?b.id===a[1]||typeof b.getAttributeNode!=="undefined"&&b.getAttributeNode("id").nodeValue===a[1]?[b]:c:[]};o.filter.ID=function(a,b){var c=typeof a.getAttributeNode!=="undefined"&&a.getAttributeNode("id");return a.nodeType===1&&c&&c.nodeValue===b}}d.removeChild(a);d=a=null})();(function(){var a=u.createElement("div");a.appendChild(u.createComment(""));if(a.getElementsByTagName("*").length>0)o.find.TAG=function(a,
b){var c=b.getElementsByTagName(a[1]);if(a[1]==="*"){for(var d=[],i=0;c[i];i++)c[i].nodeType===1&&d.push(c[i]);c=d}return c};a.innerHTML="<a href='#'></a>";if(a.firstChild&&typeof a.firstChild.getAttribute!=="undefined"&&a.firstChild.getAttribute("href")!=="#")o.attrHandle.href=function(a){return a.getAttribute("href",2)};a=null})();u.querySelectorAll&&function(){var a=m,b=u.createElement("div");b.innerHTML="<p class='TEST'></p>";if(!(b.querySelectorAll&&b.querySelectorAll(".TEST").length===0)){m=
function(b,c,d,i){c=c||u;if(!i&&!m.isXML(c)){var f=/^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(b);if(f&&(c.nodeType===1||c.nodeType===9)){if(f[1])return r(c.getElementsByTagName(b),d);if(f[2]&&o.find.CLASS&&c.getElementsByClassName)return r(c.getElementsByClassName(f[2]),d)}if(c.nodeType===9){if(b==="body"&&c.body)return r([c.body],d);if(f&&f[3]){var e=c.getElementById(f[3]);if(e&&e.parentNode){if(e.id===f[3])return r([e],d)}else return r([],d)}try{return r(c.querySelectorAll(b),d)}catch(g){}}else if(c.nodeType===
1&&c.nodeName.toLowerCase()!=="object"){var f=c,j=(e=c.getAttribute("id"))||"__sizzle__",k=c.parentNode,h=/^\s*[+~]/.test(b);e?j=j.replace(/'/g,"\\$&"):c.setAttribute("id",j);if(h&&k)c=c.parentNode;try{if(!h||k)return r(c.querySelectorAll("[id='"+j+"'] "+b),d)}catch(n){}finally{e||f.removeAttribute("id")}}}return a(b,c,d,i)};for(var c in a)m[c]=a[c];b=null}}();(function(){var a=u.documentElement,b=a.matchesSelector||a.mozMatchesSelector||a.webkitMatchesSelector||a.msMatchesSelector;if(b){var c=!b.call(u.createElement("div"),
"div"),d=false;try{b.call(u.documentElement,"[test!='']:sizzle")}catch(i){d=true}m.matchesSelector=function(a,i){i=i.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!m.isXML(a))try{if(d||!o.match.PSEUDO.test(i)&&!/!=/.test(i)){var f=b.call(a,i);if(f||!c||a.document&&a.document.nodeType!==11)return f}}catch(e){}return m(i,null,null,[a]).length>0}}})();(function(){var a=u.createElement("div");a.innerHTML="<div class='test e'></div><div class='test'></div>";if(a.getElementsByClassName&&a.getElementsByClassName("e").length!==
0){a.lastChild.className="e";if(a.getElementsByClassName("e").length!==1){o.order.splice(1,0,"CLASS");o.find.CLASS=function(a,b,c){if(typeof b.getElementsByClassName!=="undefined"&&!c)return b.getElementsByClassName(a[1])};a=null}}})();m.contains=u.documentElement.contains?function(a,b){return a!==b&&(a.contains?a.contains(b):true)}:u.documentElement.compareDocumentPosition?function(a,b){return!!(a.compareDocumentPosition(b)&16)}:function(){return false};m.isXML=function(a){return(a=(a?a.ownerDocument||
a:0).documentElement)?a.nodeName!=="HTML":false};var G=function(a,b,c){for(var d,i=[],f="",b=b.nodeType?[b]:b;d=o.match.PSEUDO.exec(a);){f=f+d[0];a=a.replace(o.match.PSEUDO,"")}a=o.relative[a]?a+"*":a;d=0;for(var e=b.length;d<e;d++)m(a,b[d],i,c);return m.filter(f,i)};m.attr=h.attr;m.selectors.attrMap={};h.find=m;h.expr=m.selectors;h.expr[":"]=h.expr.filters;h.unique=m.uniqueSort;h.text=m.getText;h.isXMLDoc=m.isXML;h.contains=m.contains})();var na=/Until$/,oa=/^(?:parents|prevUntil|prevAll)/,ja=/,/,
Xa=/^.[^:#\[\.,]*$/,Ya=Array.prototype.slice,Ea=h.expr.match.globalPOS,Za={children:!0,contents:!0,next:!0,prev:!0};h.fn.extend({find:function(a){var b=this,c,d;if(typeof a!=="string")return h(a).filter(function(){c=0;for(d=b.length;c<d;c++)if(h.contains(b[c],this))return true});var i=this.pushStack("","find",a),f,e,g;c=0;for(d=this.length;c<d;c++){f=i.length;h.find(a,this[c],i);if(c>0)for(e=f;e<i.length;e++)for(g=0;g<f;g++)if(i[g]===i[e]){i.splice(e--,1);break}}return i},has:function(a){var b=h(a);
return this.filter(function(){for(var a=0,c=b.length;a<c;a++)if(h.contains(this,b[a]))return true})},not:function(a){return this.pushStack(k(this,a,false),"not",a)},filter:function(a){return this.pushStack(k(this,a,true),"filter",a)},is:function(a){return!!a&&(typeof a==="string"?Ea.test(a)?h(a,this.context).index(this[0])>=0:h.filter(a,this).length>0:this.filter(a).length>0)},closest:function(a,b){var c=[],d,i,f=this[0];if(h.isArray(a)){for(i=1;f&&f.ownerDocument&&f!==b;){for(d=0;d<a.length;d++)h(f).is(a[d])&&
c.push({selector:a[d],elem:f,level:i});f=f.parentNode;i++}return c}var e=Ea.test(a)||typeof a!=="string"?h(a,b||this.context):0;d=0;for(i=this.length;d<i;d++)for(f=this[d];f;)if(e?e.index(f)>-1:h.find.matchesSelector(f,a)){c.push(f);break}else{f=f.parentNode;if(!f||!f.ownerDocument||f===b||f.nodeType===11)break}c=c.length>1?h.unique(c):c;return this.pushStack(c,"closest",a)},index:function(a){return!a?this[0]&&this[0].parentNode?this.prevAll().length:-1:typeof a==="string"?h.inArray(this[0],h(a)):
...
"iframe")?a.contentDocument||a.contentWindow.document:h.makeArray(a.childNodes)}},function(a,b){h.fn[a]=function(c,d){var i=h.map(this,b,c);na.test(a)||(d=c);d&&typeof d==="string"&&(i=h.filter(d,i));i=this.length>1&&!Za[a]?h.unique(i):i;if((this.length>1||ja.test(d))&&oa.test(a))i=i.reverse();return this.pushStack(i,a,Ya.call(arguments).join(","))}});h.extend({filter:function(a,b,c){c&&(a=":not("+a+")");return b.length===1?h.find.matchesSelector(b[0],a)?[b[0]]:[]:h.find.matches(a,b)},dir:function(a,
b,d){for(var i=[],a=a[b];a&&a.nodeType!==9&&(d===c||a.nodeType!==1||!h(a).is(d));){a.nodeType===1&&i.push(a);a=a[b]}return i},nth:function(a,b,c){for(var b=b||1,d=0;a;a=a[c])if(a.nodeType===1&&++d===b)break;return a},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)a.nodeType===1&&a!==b&&c.push(a);return c}});var Fa="abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",$a=/ jQuery\d+="(?:\d+|null)"/g,
ua=/^\s+/,Ga=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Ha=/<([\w:]+)/,ab=/<tbody/i,bb=/<|&#?\w+;/,cb=/<(?:script|style)/i,db=/<(?:script|object|embed|option|style)/i,Ia=RegExp("<(?:"+Fa+")[\\s/>]","i"),Ja=/checked\s*(?:[^=]|=\s*.checked.)/i,Ka=/\/(java|ecma)script/i,gb=/^\s*<!(?:\[CDATA\[|\-\-)/,T={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,
"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]},Ba=l(u);T.optgroup=T.option;T.tbody=T.tfoot=T.colgroup=T.caption=T.thead;T.th=T.td;h.support.htmlSerialize||(T._default=[1,"div<div>","</div>"]);h.fn.extend({text:function(a){return h.access(this,function(a){return a===c?h.text(this):this.empty().append((this[0]&&this[0].ownerDocument||u).createTextNode(a))},null,a,arguments.length)},wrapAll:function(a){if(h.isFunction(a))return this.each(function(b){h(this).wrapAll(a.call(this,
...
h.cleanData([d])}d.parentNode&&d.parentNode.removeChild(d)}return this},empty:function(){for(var a=0,b;(b=this[a])!=null;a++)for(b.nodeType===1&&h.cleanData(b.getElementsByTagName("*"));b.firstChild;)b.removeChild(b.firstChild);return this},clone:function(a,b){a=a==null?false:a;b=b==null?a:b;return this.map(function(){return h.clone(this,a,b)})},html:function(a){return h.access(this,function(a){var b=this[0]||{},d=0,i=this.length;if(a===c)return b.nodeType===1?b.innerHTML.replace($a,""):null;if(typeof a===
"string"&&!cb.test(a)&&(h.support.leadingWhitespace||!ua.test(a))&&!T[(Ha.exec(a)||["",""])[1].toLowerCase()]){a=a.replace(Ga,"<$1></$2>");try{for(;d<i;d++){b=this[d]||{};if(b.nodeType===1){h.cleanData(b.getElementsByTagName("*"));b.innerHTML=a}}b=0}catch(f){}}b&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){if(this[0]&&this[0].parentNode){if(h.isFunction(a))return this.each(function(b){var c=h(this),d=c.html();c.replaceWith(a.call(this,b,d))});typeof a!=="string"&&(a=
h(a).detach());return this.each(function(){var b=this.nextSibling,c=this.parentNode;h(this).remove();b?h(b).before(a):h(c).append(a)})}return this.length?this.pushStack(h(h.isFunction(a)?a():a),"replaceWith",a):this},detach:function(a){return this.remove(a,true)},domManip:function(a,b,d){var i,f,e,g=a[0],j=[];if(!h.support.checkClone&&arguments.length===3&&typeof g==="string"&&Ja.test(g))return this.each(function(){h(this).domManip(a,b,d,true)});if(h.isFunction(g))return this.each(function(i){var f=
h(this);a[0]=g.call(this,i,b?f.html():c);f.domManip(a,b,d)});if(this[0]){i=g&&g.parentNode;i=h.support.parentNode&&i&&i.nodeType===11&&i.childNodes.length===this.length?{fragment:i}:h.buildFragment(a,this,j);e=i.fragment;if(f=e.childNodes.length===1?e=e.firstChild:e.firstChild){b=b&&h.nodeName(f,"tr");f=0;for(var k=this.length,n=k-1;f<k;f++)d.call(b?h.nodeName(this[f],"table")?this[f].getElementsByTagName("tbody")[0]||this[f].appendChild(this[f].ownerDocument.createElement("tbody")):this[f]:this[f],
i.cacheable||k>1&&f<n?h.clone(e,true,true):e)}j.length&&h.each(j,function(a,b){b.src?h.ajax({type:"GET",global:false,url:b.src,async:false,dataType:"script"}):h.globalEval((b.text||b.textContent||b.innerHTML||"").replace(gb,"/*$0*/"));b.parentNode&&b.parentNode.removeChild(b)})}return this}});h.buildFragment=function(a,b,c){var d,i,f,e,g=a[0];b&&b[0]&&(e=b[0].ownerDocument||b[0]);e.createDocumentFragment||(e=u);if(a.length===1&&typeof g==="string"&&g.length<512&&e===u&&g.charAt(0)==="<"&&!db.test(g)&&
(h.support.checkClone||!Ja.test(g))&&(h.support.html5Clone||!Ia.test(g))){i=true;(f=h.fragments[g])&&f!==1&&(d=f)}if(!d){d=e.createDocumentFragment();h.clean(a,e,d,c)}i&&(h.fragments[g]=f?d:1);return{fragment:d,cacheable:i}};h.fragments={};h.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){h.fn[a]=function(c){var d=[],c=h(c),i=this.length===1&&this[0].parentNode;if(i&&i.nodeType===11&&i.childNodes.length===1&&c.length===
1){c[b](this[0]);return this}for(var i=0,f=c.length;i<f;i++){var e=(i>0?this.clone(true):this).get();h(c[i])[b](e);d=d.concat(e)}return this.pushStack(d,a,c.selector)}});h.extend({clone:function(a,b,c){var d,i,f;if(h.support.html5Clone||h.isXMLDoc(a)||!Ia.test("<"+a.nodeName+">"))d=a.cloneNode(true);else{d=u.createElement("div");Ba.appendChild(d);d.innerHTML=a.outerHTML;d=d.firstChild}var e=d;if((!h.support.noCloneEvent||!h.support.noCloneChecked)&&(a.nodeType===1||a.nodeType===11)&&!h.isXMLDoc(a)){o(a,
e);d=m(a);i=m(e);for(f=0;d[f];++f)i[f]&&o(d[f],i[f])}if(b){p(a,e);if(c){d=m(a);i=m(e);for(f=0;d[f];++f)p(d[f],i[f])}}return e},clean:function(a,b,c,d){var i,f=[],b=b||u;typeof b.createElement==="undefined"&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||u);for(var e=0,g;(g=a[e])!=null;e++){typeof g==="number"&&(g=g+"");if(g){if(typeof g==="string")if(bb.test(g)){g=g.replace(Ga,"<$1></$2>");i=(Ha.exec(g)||["",""])[1].toLowerCase();var j=T[i]||T._default,k=j[0],n=b.createElement("div"),m=Ba.childNodes;
b===u?Ba.appendChild(n):l(b).appendChild(n);for(n.innerHTML=j[1]+g+j[2];k--;)n=n.lastChild;if(!h.support.tbody){k=ab.test(g);j=i==="table"&&!k?n.firstChild&&n.firstChild.childNodes:j[1]==="<table>"&&!k?n.childNodes:[];for(i=j.length-1;i>=0;--i)h.nodeName(j[i],"tbody")&&!j[i].childNodes.length&&j[i].parentNode.removeChild(j[i])}!h.support.leadingWhitespace&&ua.test(g)&&n.insertBefore(b.createTextNode(ua.exec(g)[0]),n.firstChild);g=n.childNodes;if(n){n.parentNode.removeChild(n);if(m.length>0)(n=m[m.length-
1])&&n.parentNode&&n.parentNode.removeChild(n)}}else g=b.createTextNode(g);var w;if(!h.support.appendChecked)if(g[0]&&typeof(w=g.length)==="number")for(i=0;i<w;i++)r(g[i]);else r(g);g.nodeType?f.push(g):f=h.merge(f,g)}}if(c){a=function(a){return!a.type||Ka.test(a.type)};for(e=0;f[e];e++){b=f[e];if(d&&h.nodeName(b,"script")&&(!b.type||Ka.test(b.type)))d.push(b.parentNode?b.parentNode.removeChild(b):b);else{if(b.nodeType===1){g=h.grep(b.getElementsByTagName("script"),a);f.splice.apply(f,[e+1,0].concat(g))}c.appendChild(b)}}}return f},
cleanData:function(a){for(var b,c,d=h.cache,i=h.event.special,f=h.support.deleteExpando,e=0,g;(g=a[e])!=null;e++)if(!g.nodeName||!h.noData[g.nodeName.toLowerCase()])if(c=g[h.expando]){if((b=d[c])&&b.events){for(var j in b.events)i[j]?h.event.remove(g,j):h.removeEvent(g,j,b.handle);if(b.handle)b.handle.elem=null}f?delete g[h.expando]:g.removeAttribute&&g.removeAttribute(h.expando);delete d[c]}}});var Ca=/alpha\([^)]*\)/i,hb=/opacity=([^)]*)/,ib=/([A-Z]|^ms)/g,jb=/^[\-+]?(?:\d*\.)?\d+$/i,wa=/^-?(?:\d*\.)?\d+(?!px)[^\d\s]+$/i,
kb=/^([\-+])=([\-+.\de]+)/,lb=/^margin/,mb={position:"absolute",visibility:"hidden",display:"block"},X=["Top","Right","Bottom","Left"],ba,Na,Oa;h.fn.css=function(a,b){return h.access(this,function(a,b,d){return d!==c?h.style(a,b,d):h.css(a,b)},a,b,arguments.length>1)};h.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=ba(a,"opacity");return c===""?"1":c}return a.style.opacity}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":h.support.cssFloat?
"cssFloat":"styleFloat"},style:function(a,b,d,i){if(a&&!(a.nodeType===3||a.nodeType===8||!a.style)){var f,e=h.camelCase(b),g=a.style,j=h.cssHooks[e],b=h.cssProps[e]||e;if(d!==c){i=typeof d;if(i==="string"&&(f=kb.exec(d))){d=+(f[1]+1)*+f[2]+parseFloat(h.css(a,b));i="number"}if(!(d==null||i==="number"&&isNaN(d))){i==="number"&&!h.cssNumber[e]&&(d=d+"px");if(!j||!("set"in j)||(d=j.set(a,d))!==c)try{g[b]=d}catch(k){}}}else return j&&"get"in j&&(f=j.get(a,false,i))!==c?f:g[b]}},css:function(a,b,d){var i,
f,b=h.camelCase(b);f=h.cssHooks[b];b=h.cssProps[b]||b;b==="cssFloat"&&(b="float");if(f&&"get"in f&&(i=f.get(a,true,d))!==c)return i;if(ba)return ba(a,b)},swap:function(a,b,c){var d={},i;for(i in b){d[i]=a.style[i];a.style[i]=b[i]}c=c.call(a);for(i in b)a.style[i]=d[i];return c}});h.curCSS=h.css;u.defaultView&&u.defaultView.getComputedStyle&&(Na=function(a,b){var c,d,i,f=a.style,b=b.replace(ib,"-$1").toLowerCase();if((d=a.ownerDocument.defaultView)&&(i=d.getComputedStyle(a,null))){c=i.getPropertyValue(b);
c===""&&!h.contains(a.ownerDocument.documentElement,a)&&(c=h.style(a,b))}if(!h.support.pixelMargin&&i&&lb.test(b)&&wa.test(c)){d=f.width;f.width=c;c=i.width;f.width=d}return c});u.documentElement.currentStyle&&(Oa=function(a,b){var c,d,i=a.currentStyle&&a.currentStyle[b],f=a.style;if(i==null&&f&&(c=f[b]))i=c;if(wa.test(i)){c=f.left;if(d=a.runtimeStyle&&a.runtimeStyle.left)a.runtimeStyle.left=a.currentStyle.left;f.left=b==="fontSize"?"1em":i;i=f.pixelLeft+"px";f.left=c;if(d)a.runtimeStyle.left=d}return i===
""?"auto":i});ba=Na||Oa;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){if(c)return a.offsetWidth!==0?q(a,b,d):h.swap(a,mb,function(){return q(a,b,d)})},set:function(a,b){return jb.test(b)?b+"px":b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return hb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,i=h.isNumeric(b)?"alpha(opacity="+b*100+")":"",f=
d&&d.filter||c.filter||"";c.zoom=1;if(b>=1&&h.trim(f.replace(Ca,""))===""){c.removeAttribute("filter");if(d&&!d.filter)return}c.filter=Ca.test(f)?f.replace(Ca,i):f+" "+i}});h(function(){if(!h.support.reliableMarginRight)h.cssHooks.marginRight={get:function(a,b){return h.swap(a,{display:"inline-block"},function(){return b?ba(a,"margin-right"):a.style.marginRight})}}});h.expr&&h.expr.filters&&(h.expr.filters.hidden=function(a){var b=a.offsetHeight;return a.offsetWidth===0&&b===0||!h.support.reliableHiddenOffsets&&
(a.style&&a.style.display||h.css(a,"display"))==="none"},h.expr.filters.visible=function(a){return!h.expr.filters.hidden(a)});h.each({margin:"",padding:"",border:"Width"},function(a,b){h.cssHooks[a+b]={expand:function(c){for(var d=typeof c==="string"?c.split(" "):[c],i={},c=0;c<4;c++)i[a+X[c]+b]=d[c]||d[c-2]||d[0];return i}}});var nb=/%20/g,eb=/\[\]$/,Pa=/\r?\n/g,ob=/#.*$/,pb=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,qb=/^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
rb=/^(?:GET|HEAD)$/,sb=/^\/\//,Qa=/\?/,tb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,ub=/^(?:select|textarea)/i,Ma=/\s+/,vb=/([?&])_=[^&]*/,Ra=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Sa=h.fn.load,xa={},Ta={},Y,Z,Ua=["*/"]+["*"];try{Y=M.href}catch(Bb){Y=u.createElement("a"),Y.href="",Y=Y.href}Z=Ra.exec(Y.toLowerCase())||[];h.fn.extend({load:function(a,b,d){if(typeof a!=="string"&&Sa)return Sa.apply(this,arguments);if(!this.length)return this;var i=a.indexOf(" ");if(i>=0)var f=a.slice(i,
a.length),a=a.slice(0,i);i="GET";if(b)if(h.isFunction(b)){d=b;b=c}else if(typeof b==="object"){b=h.param(b,h.ajaxSettings.traditional);i="POST"}var e=this;h.ajax({url:a,type:i,dataType:"html",data:b,complete:function(a,b,c){c=a.responseText;if(a.isResolved()){a.done(function(a){c=a});e.html(f?h("<div>").append(c.replace(tb,"")).find(f):c)}d&&e.each(d,[c,b,a])}});return this},serialize:function(){return h.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?
h.makeArray(this.elements):this}).filter(function(){return this.name&&!this.disabled&&(this.checked||ub.test(this.nodeName)||qb.test(this.type))}).map(function(a,b){var c=h(this).val();return c==null?null:h.isArray(c)?h.map(c,function(a){return{name:b.name,value:a.replace(Pa,"\r\n")}}):{name:b.name,value:c.replace(Pa,"\r\n")}}).get()}});h.each("ajaxStart,ajaxStop,ajaxComplete,ajaxError,ajaxSuccess,ajaxSend".split(","),function(a,b){h.fn[b]=function(a){return this.on(b,a)}});h.each(["get","post"],
function(a,b){h[b]=function(a,d,i,f){if(h.isFunction(d)){f=f||i;i=d;d=c}return h.ajax({type:b,url:a,data:d,success:i,dataType:f})}});h.extend({getScript:function(a,b){return h.get(a,c,b,"script")},getJSON:function(a,b,c){return h.get(a,b,c,"json")},ajaxSetup:function(a,b){if(b)v(a,h.ajaxSettings);else{b=a;a=h.ajaxSettings}v(a,b);return a},ajaxSettings:{url:Y,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/.test(Z[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",
processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Ua},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:s(xa),ajaxTransport:s(Ta),ajax:function(a,b){function d(a,b,m,l){if(C!==2){C=2;t&&clearTimeout(t);p=c;w=l||"";s.readyState=
a>0?4:0;var o,r,B,l=b;if(m){var H=i,G=s,v=H.contents,V=H.dataTypes,x=H.responseFields,u,Q,L,y;for(Q in x)Q in m&&(G[x[Q]]=m[Q]);for(;V[0]==="*";){V.shift();u===c&&(u=H.mimeType||G.getResponseHeader("content-type"))}if(u)for(Q in v)if(v[Q]&&v[Q].test(u)){V.unshift(Q);break}if(V[0]in m)L=V[0];else{for(Q in m){if(!V[0]||H.converters[Q+" "+V[0]]){L=Q;break}y||(y=Q)}L=L||y}if(L){L!==V[0]&&V.unshift(L);m=m[L]}else m=void 0}else m=c;if(a>=200&&a<300||a===304){if(i.ifModified){if(u=s.getResponseHeader("Last-Modified"))h.lastModified[n]=
u;if(u=s.getResponseHeader("Etag"))h.etag[n]=u}if(a===304){l="notmodified";o=true}else try{u=i;u.dataFilter&&(m=u.dataFilter(m,u.dataType));var z=u.dataTypes;Q={};var A,E,F=z.length,D,S=z[0],K,J,I,N,da;for(A=1;A<F;A++){if(A===1)for(E in u.converters)typeof E==="string"&&(Q[E.toLowerCase()]=u.converters[E]);K=S;S=z[A];if(S==="*")S=K;else if(K!=="*"&&K!==S){J=K+" "+S;I=Q[J]||Q["* "+S];if(!I){da=c;for(N in Q){D=N.split(" ");if(D[0]===K||D[0]==="*")if(da=Q[D[1]+" "+S]){N=Q[N];N===true?I=da:da===true&&
(I=N);break}}}!I&&!da&&h.error("No conversion from "+J.replace(" "," to "));I!==true&&(m=I?I(m):da(N(m)))}}r=m;l="success";o=true}catch(O){l="parsererror";B=O}}else{B=l;if(!l||a){l="error";a<0&&(a=0)}}s.status=a;s.statusText=""+(b||l);o?g.resolveWith(f,[r,l,s]):g.rejectWith(f,[s,l,B]);s.statusCode(k);k=c;q&&e.trigger("ajax"+(o?"Success":"Error"),[s,i,o?r:B]);j.fireWith(f,[s,l]);if(q){e.trigger("ajaxComplete",[s,i]);--h.active||h.event.trigger("ajaxStop")}}}if(typeof a==="object"){b=a;a=c}var b=b||
{},i=h.ajaxSetup({},b),f=i.context||i,e=f!==i&&(f.nodeType||f instanceof h)?h(f):h.event,g=h.Deferred(),j=h.Callbacks("once memory"),k=i.statusCode||{},n,m={},l={},w,o,p,t,r,C=0,q,H,s={readyState:0,setRequestHeader:function(a,b){if(!C){var c=a.toLowerCase(),a=l[c]=l[c]||a;m[a]=b}return this},getAllResponseHeaders:function(){return C===2?w:null},getResponseHeader:function(a){var b;if(C===2){if(!o)for(o={};b=pb.exec(w);)o[b[1].toLowerCase()]=b[2];b=o[a.toLowerCase()]}return b===c?null:b},overrideMimeType:function(a){if(!C)i.mimeType=
a;return this},abort:function(a){a=a||"abort";p&&p.abort(a);d(0,a);return this}};g.promise(s);s.success=s.done;s.error=s.fail;s.complete=j.add;s.statusCode=function(a){if(a){var b;if(C<2)for(b in a)k[b]=[k[b],a[b]];else{b=a[s.status];s.then(b,b)}}return this};i.url=((a||i.url)+"").replace(ob,"").replace(sb,Z[1]+"//");i.dataTypes=h.trim(i.dataType||"*").toLowerCase().split(Ma);if(i.crossDomain==null){r=Ra.exec(i.url.toLowerCase());i.crossDomain=!(!r||!(r[1]!=Z[1]||r[2]!=Z[2]||(r[3]||(r[1]==="http:"?
80:443))!=(Z[3]||(Z[1]==="http:"?80:443))))}if(i.data&&i.processData&&typeof i.data!=="string")i.data=h.param(i.data,i.traditional);x(xa,i,b,s);if(C===2)return false;q=i.global;i.type=i.type.toUpperCase();i.hasContent=!rb.test(i.type);q&&h.active++===0&&h.event.trigger("ajaxStart");if(!i.hasContent){if(i.data){i.url=i.url+((Qa.test(i.url)?"&":"?")+i.data);delete i.data}n=i.url;if(i.cache===false){r=h.now();var G=i.url.replace(vb,"$1_="+r);i.url=G+(G===i.url?(Qa.test(i.url)?"&":"?")+"_="+r:"")}}(i.data&&
i.hasContent&&i.contentType!==false||b.contentType)&&s.setRequestHeader("Content-Type",i.contentType);if(i.ifModified){n=n||i.url;h.lastModified[n]&&s.setRequestHeader("If-Modified-Since",h.lastModified[n]);h.etag[n]&&s.setRequestHeader("If-None-Match",h.etag[n])}s.setRequestHeader("Accept",i.dataTypes[0]&&i.accepts[i.dataTypes[0]]?i.accepts[i.dataTypes[0]]+(i.dataTypes[0]!=="*"?", "+Ua+"; q=0.01":""):i.accepts["*"]);for(H in i.headers)s.setRequestHeader(H,i.headers[H]);if(i.beforeSend&&(i.beforeSend.call(f,
s,i)===false||C===2)){s.abort();return false}for(H in{success:1,error:1,complete:1})s[H](i[H]);if(p=x(Ta,i,b,s)){s.readyState=1;q&&e.trigger("ajaxSend",[s,i]);i.async&&i.timeout>0&&(t=setTimeout(function(){s.abort("timeout")},i.timeout));try{C=1;p.send(m,d)}catch(v){if(C<2)d(-1,v);else throw v;}}else d(-1,"No Transport");return s},param:function(a,b){var d=[],i=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(b===c)b=h.ajaxSettings.traditional;
if(h.isArray(a)||a.jquery&&!h.isPlainObject(a))h.each(a,function(){i(this.name,this.value)});else for(var f in a)y(f,a[f],b,i);return d.join("&").replace(nb,"+")}});h.extend({active:0,lastModified:{},etag:{}});var wb=h.now(),sa=/(\=)\?(&|$)|\?\?/i;h.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return h.expando+"_"+wb++}});h.ajaxPrefilter("json jsonp",function(b,c,d){c=typeof b.data==="string"&&/^application\/x\-www\-form\-urlencoded/.test(b.contentType);if(b.dataTypes[0]==="jsonp"||b.jsonp!==
false&&(sa.test(b.url)||c&&sa.test(b.data))){var i,f=b.jsonpCallback=h.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,e=a[f],g=b.url,j=b.data,k="$1"+f+"$2";if(b.jsonp!==false){g=g.replace(sa,k);if(b.url===g){c&&(j=j.replace(sa,k));b.data===j&&(g=g+((/\?/.test(g)?"&":"?")+b.jsonp+"="+f))}}b.url=g;b.data=j;a[f]=function(a){i=[a]};d.always(function(){a[f]=e;if(i&&h.isFunction(e))a[f](i[0])});b.converters["script json"]=function(){i||h.error(f+" was not called");return i[0]};b.dataTypes[0]=
"json";return"script"}});h.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/javascript|ecmascript/},converters:{"text script":function(a){h.globalEval(a);return a}}});h.ajaxPrefilter("script",function(a){if(a.cache===c)a.cache=false;if(a.crossDomain){a.type="GET";a.global=false}});h.ajaxTransport("script",function(a){if(a.crossDomain){var b,d=u.head||u.getElementsByTagName("head")[0]||u.documentElement;return{send:function(i,
f){b=u.createElement("script");b.async="async";if(a.scriptCharset)b.charset=a.scriptCharset;b.src=a.url;b.onload=b.onreadystatechange=function(a,i){if(i||!b.readyState||/loaded|complete/.test(b.readyState)){b.onload=b.onreadystatechange=null;d&&b.parentNode&&d.removeChild(b);b=c;i||f(200,"success")}};d.insertBefore(b,d.firstChild)},abort:function(){if(b)b.onload(0,1)}}}});var Da=a.ActiveXObject?function(){for(var a in fa)fa[a](0,1)}:!1,xb=0,fa;h.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=
!this.isLocal&&E()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:E;(function(a){h.extend(h.support,{ajax:!!a,cors:!!a&&"withCredentials"in a})})(h.ajaxSettings.xhr());h.support.ajax&&h.ajaxTransport(function(b){if(!b.crossDomain||h.support.cors){var d;return{send:function(i,f){var e=b.xhr(),g,j;b.username?e.open(b.type,b.url,b.async,b.username,b.password):e.open(b.type,b.url,b.async);if(b.xhrFields)for(j in b.xhrFields)e[j]=b.xhrFields[j];b.mimeType&&e.overrideMimeType&&
e.overrideMimeType(b.mimeType);!b.crossDomain&&!i["X-Requested-With"]&&(i["X-Requested-With"]="XMLHttpRequest");try{for(j in i)e.setRequestHeader(j,i[j])}catch(k){}e.send(b.hasContent&&b.data||null);d=function(a,i){var j,k,n,m,l;try{if(d&&(i||e.readyState===4)){d=c;if(g){e.onreadystatechange=h.noop;Da&&delete fa[g]}if(i)e.readyState!==4&&e.abort();else{j=e.status;n=e.getAllResponseHeaders();m={};if((l=e.responseXML)&&l.documentElement)m.xml=l;try{m.text=e.responseText}catch(w){}try{k=e.statusText}catch(o){k=
""}!j&&b.isLocal&&!b.crossDomain?j=m.text?200:404:j===1223&&(j=204)}}}catch(p){i||f(-1,p)}m&&f(j,k,m,n)};if(!b.async||e.readyState===4)d();else{g=++xb;if(Da){if(!fa){fa={};h(a).unload(Da)}fa[g]=d}e.onreadystatechange=d}},abort:function(){d&&d(0,1)}}}});var ya={},U,ca,yb=/^(?:toggle|show|hide)$/,zb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,ta,qa=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],pa;h.fn.extend({show:function(a,
b,c){if(a||a===0)return this.animate(F("show",3),a,b,c);for(var c=0,d=this.length;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(!h._data(a,"olddisplay")&&b==="none")b=a.style.display="";(b===""&&h.css(a,"display")==="none"||!h.contains(a.ownerDocument.documentElement,a))&&h._data(a,"olddisplay",J(a.nodeName))}}for(c=0;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(b===""||b==="none")a.style.display=h._data(a,"olddisplay")||""}}return this},hide:function(a,b,c){if(a||a===0)return this.animate(F("hide",
...
fadeTo:function(a,b,c,d){return this.filter(":hidden").css("opacity",0).show().end().animate({opacity:b},a,c,d)},animate:function(a,b,c,d){function i(){f.queue===false&&h._mark(this);var b=h.extend({},f),c=this.nodeType===1,d=c&&h(this).is(":hidden"),e,g,j,k,n;b.animatedProperties={};for(j in a){e=h.camelCase(j);if(j!==e){a[e]=a[j];delete a[j]}if((g=h.cssHooks[e])&&"expand"in g){k=g.expand(a[e]);delete a[e];for(j in k)j in a||(a[j]=k[j])}}for(e in a){g=a[e];if(h.isArray(g)){b.animatedProperties[e]=
g[1];g=a[e]=g[0]}else b.animatedProperties[e]=b.specialEasing&&b.specialEasing[e]||b.easing||"swing";if(g==="hide"&&d||g==="show"&&!d)return b.complete.call(this);if(c&&(e==="height"||e==="width")){b.overflow=[this.style.overflow,this.style.overflowX,this.style.overflowY];if(h.css(this,"display")==="inline"&&h.css(this,"float")==="none")!h.support.inlineBlockNeedsLayout||J(this.nodeName)==="inline"?this.style.display="inline-block":this.style.zoom=1}}if(b.overflow!=null)this.style.overflow="hidden";
for(j in a){c=new h.fx(this,b,j);g=a[j];if(yb.test(g))if(e=h._data(this,"toggle"+j)||(g==="toggle"?d?"show":"hide":0)){h._data(this,"toggle"+j,e==="show"?"hide":"show");c[e]()}else c[g]();else{e=zb.exec(g);k=c.cur();if(e){g=parseFloat(e[2]);n=e[3]||(h.cssNumber[j]?"":"px");if(n!=="px"){h.style(this,j,(g||1)+n);k=(g||1)/c.cur()*k;h.style(this,j,k+n)}e[1]&&(g=(e[1]==="-="?-1:1)*g+k);c.custom(k,g,n)}else c.custom(k,g,"")}}return true}var f=h.speed(b,c,d);if(h.isEmptyObject(a))return this.each(f.complete,
[false]);a=h.extend({},a);return f.queue===false?this.each(i):this.queue(f.queue,i)},stop:function(a,b,d){if(typeof a!=="string"){d=b;b=a;a=c}b&&a!==false&&this.queue(a||"fx",[]);return this.each(function(){var b,c=false,i=h.timers,f=h._data(this);d||h._unmark(true,this);if(a==null)for(b in f){if(f[b]&&f[b].stop&&b.indexOf(".run")===b.length-4){var e=f[b];h.removeData(this,b,true);e.stop(d)}}else if(f[b=a+".run"]&&f[b].stop){f=f[b];h.removeData(this,b,true);f.stop(d)}for(b=i.length;b--;)if(i[b].elem===
this&&(a==null||i[b].queue===a)){if(d)i[b](true);else i[b].saveState();c=true;i.splice(b,1)}(!d||!c)&&h.dequeue(this,a)})}});h.each({slideDown:F("show",1),slideUp:F("hide",1),slideToggle:F("toggle",1),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){h.fn[a]=function(a,c,d){return this.animate(b,a,c,d)}});h.extend({speed:function(a,b,c){var d=a&&typeof a==="object"?h.extend({},a):{complete:c||!c&&b||h.isFunction(a)&&a,duration:a,easing:c&&b||b&&!h.isFunction(b)&&
...
{}}});h.fx.prototype={update:function(){this.options.step&&this.options.step.call(this.elem,this.now,this);(h.fx.step[this.prop]||h.fx.step._default)(this)},cur:function(){if(this.elem[this.prop]!=null&&(!this.elem.style||this.elem.style[this.prop]==null))return this.elem[this.prop];var a,b=h.css(this.elem,this.prop);return isNaN(a=parseFloat(b))?!b||b==="auto"?0:b:a},custom:function(a,b,d){function i(a){return f.step(a)}var f=this,e=h.fx;this.startTime=pa||z();this.end=b;this.now=this.start=a;this.pos=
this.state=0;this.unit=d||this.unit||(h.cssNumber[this.prop]?"":"px");i.queue=this.options.queue;i.elem=this.elem;i.saveState=function(){h._data(f.elem,"fxshow"+f.prop)===c&&(f.options.hide?h._data(f.elem,"fxshow"+f.prop,f.start):f.options.show&&h._data(f.elem,"fxshow"+f.prop,f.end))};i()&&h.timers.push(i)&&!ta&&(ta=setInterval(e.tick,e.interval))},show:function(){var a=h._data(this.elem,"fxshow"+this.prop);this.options.orig[this.prop]=a||h.style(this.elem,this.prop);this.options.show=true;a!==c?
this.custom(this.cur(),a):this.custom(this.prop==="width"||this.prop==="height"?1:0,this.cur());h(this.elem).show()},hide:function(){this.options.orig[this.prop]=h._data(this.elem,"fxshow"+this.prop)||h.style(this.elem,this.prop);this.options.hide=true;this.custom(this.cur(),0)},step:function(a){var b,c=pa||z(),d=true,i=this.elem,f=this.options;if(a||c>=f.duration+this.startTime){this.now=this.end;this.pos=this.state=1;this.update();f.animatedProperties[this.prop]=true;for(b in f.animatedProperties)f.animatedProperties[b]!==
true&&(d=false);if(d){f.overflow!=null&&!h.support.shrinkWrapBlocks&&h.each(["","X","Y"],function(a,b){i.style["overflow"+b]=f.overflow[a]});f.hide&&h(i).hide();if(f.hide||f.show)for(b in f.animatedProperties){h.style(i,b,f.orig[b]);h.removeData(i,"fxshow"+b,true);h.removeData(i,"toggle"+b,true)}if(a=f.complete){f.complete=false;a.call(i)}}return false}if(f.duration==Infinity)this.now=c;else{a=c-this.startTime;this.state=a/f.duration;this.pos=h.easing[f.animatedProperties[this.prop]](this.state,a,
0,1,f.duration);this.now=this.start+(this.end-this.start)*this.pos}this.update();return true}};h.extend(h.fx,{tick:function(){for(var a,b=h.timers,c=0;c<b.length;c++){a=b[c];!a()&&b[c]===a&&b.splice(c--,1)}b.length||h.fx.stop()},interval:13,stop:function(){clearInterval(ta);ta=null},speeds:{slow:600,fast:200,_default:400},step:{opacity:function(a){h.style(a.elem,"opacity",a.now)},_default:function(a){a.elem.style&&a.elem.style[a.prop]!=null?a.elem.style[a.prop]=a.now+a.unit:a.elem[a.prop]=a.now}}});
h.each(qa.concat.apply([],qa),function(a,b){b.indexOf("margin")&&(h.fx.step[b]=function(a){h.style(a.elem,b,Math.max(0,a.now)+a.unit)})});h.expr&&h.expr.filters&&(h.expr.filters.animated=function(a){return h.grep(h.timers,function(b){return a===b.elem}).length});var Va,Ab=/^t(?:able|d|h)$/i,Wa=/^(?:body|html)$/i;Va="getBoundingClientRect"in u.documentElement?function(a,b,c,d){try{d=a.getBoundingClientRect()}catch(i){}if(!d||!h.contains(c,a))return d?{top:d.top,left:d.left}:{top:0,left:0};a=b.body;
b=D(b);return{top:d.top+(b.pageYOffset||h.support.boxModel&&c.scrollTop||a.scrollTop)-(c.clientTop||a.clientTop||0),left:d.left+(b.pageXOffset||h.support.boxModel&&c.scrollLeft||a.scrollLeft)-(c.clientLeft||a.clientLeft||0)}}:function(a,b,c){var d,i=a.offsetParent,f=b.body;d=(b=b.defaultView)?b.getComputedStyle(a,null):a.currentStyle;for(var e=a.offsetTop,g=a.offsetLeft;(a=a.parentNode)&&a!==f&&a!==c;){if(h.support.fixedPosition&&d.position==="fixed")break;d=b?b.getComputedStyle(a,null):a.currentStyle;
e=e-a.scrollTop;g=g-a.scrollLeft;if(a===i){e=e+a.offsetTop;g=g+a.offsetLeft;if(h.support.doesNotAddBorder&&(!h.support.doesAddBorderForTableAndCells||!Ab.test(a.nodeName))){e=e+(parseFloat(d.borderTopWidth)||0);g=g+(parseFloat(d.borderLeftWidth)||0)}i=a.offsetParent}if(h.support.subtractsBorderForOverflowNotVisible&&d.overflow!=="visible"){e=e+(parseFloat(d.borderTopWidth)||0);g=g+(parseFloat(d.borderLeftWidth)||0)}}if(d.position==="relative"||d.position==="static"){e=e+f.offsetTop;g=g+f.offsetLeft}if(h.support.fixedPosition&&
d.position==="fixed"){e=e+Math.max(c.scrollTop,f.scrollTop);g=g+Math.max(c.scrollLeft,f.scrollLeft)}return{top:e,left:g}};h.fn.offset=function(a){if(arguments.length)return a===c?this:this.each(function(b){h.offset.setOffset(this,a,b)});var b=this[0],d=b&&b.ownerDocument;return!d?null:b===d.body?h.offset.bodyOffset(b):Va(b,d,d.documentElement)};h.offset={bodyOffset:function(a){var b=a.offsetTop,c=a.offsetLeft;if(h.support.doesNotIncludeMarginInBodyOffset){b=b+(parseFloat(h.css(a,"marginTop"))||0);
c=c+(parseFloat(h.css(a,"marginLeft"))||0)}return{top:b,left:c}},setOffset:function(a,b,c){var d=h.css(a,"position");if(d==="static")a.style.position="relative";var i=h(a),f=i.offset(),e=h.css(a,"top"),g=h.css(a,"left"),j={},k={};if((d==="absolute"||d==="fixed")&&h.inArray("auto",[e,g])>-1){k=i.position();d=k.top;g=k.left}else{d=parseFloat(e)||0;g=parseFloat(g)||0}h.isFunction(b)&&(b=b.call(a,c,f));if(b.top!=null)j.top=b.top-f.top+d;if(b.left!=null)j.left=b.left-f.left+g;"using"in b?b.using.call(a,
j):i.css(j)}};h.fn.extend({position:function(){if(!this[0])return null;var a=this[0],b=this.offsetParent(),c=this.offset(),d=Wa.test(b[0].nodeName)?{top:0,left:0}:b.offset();c.top=c.top-(parseFloat(h.css(a,"marginTop"))||0);c.left=c.left-(parseFloat(h.css(a,"marginLeft"))||0);d.top=d.top+(parseFloat(h.css(b[0],"borderTopWidth"))||0);d.left=d.left+(parseFloat(h.css(b[0],"borderLeftWidth"))||0);return{top:c.top-d.top,left:c.left-d.left}},offsetParent:function(){return this.map(function(){for(var a=
this.offsetParent||u.body;a&&!Wa.test(a.nodeName)&&h.css(a,"position")==="static";)a=a.offsetParent;return a})}});h.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(a,b){var d=/Y/.test(b);h.fn[a]=function(i){return h.access(this,function(a,i,f){var e=D(a);if(f===c)return e?b in e?e[b]:h.support.boxModel&&e.document.documentElement[i]||e.document.body[i]:a[i];e?e.scrollTo(!d?f:h(e).scrollLeft(),d?f:h(e).scrollTop()):a[i]=f},a,i,arguments.length,null)}});h.each({Height:"height",Width:"width"},
function(a,b){var d="client"+a,i="scroll"+a,f="offset"+a;h.fn["inner"+a]=function(){var a=this[0];return a?a.style?parseFloat(h.css(a,b,"padding")):this[b]():null};h.fn["outer"+a]=function(a){var c=this[0];return c?c.style?parseFloat(h.css(c,b,a?"margin":"border")):this[b]():null};h.fn[b]=function(a){return h.access(this,function(a,b,e){if(h.isWindow(a)){b=a.document;a=b.documentElement[d];return h.support.boxModel&&a||b.body&&b.body[d]||a}if(a.nodeType===9){b=a.documentElement;return b[d]>=b[i]?
b[d]:Math.max(a.body[i],b[i],a.body[f],b[f])}if(e===c){a=h.css(a,b);b=parseFloat(a);return h.isNumeric(b)?b:a}h(a).css(b,e)},b,a,arguments.length,null)}});a.jQuery=a.$=h;"function"===typeof define&&define.amd&&define.amd.jQuery&&define("jquery",[],function(){return h})})(window);
(function(a,c){function d(c,d){var g=c.nodeName.toLowerCase();if("area"===g){var g=c.parentNode,b=g.name;if(!c.href||!b||"map"!==g.nodeName.toLowerCase())return!1;g=a("img[usemap=#"+b+"]")[0];return!!g&&e(g)}return(/input|select|textarea|button|object/.test(g)?!c.disabled:"a"==g?c.href||d:d)&&e(c)}function e(c){return!a(c).parents().andSelf().filter(function(){return"hidden"===a.curCSS(this,"visibility")||a.expr.filters.hidden(this)}).length}a.ui=a.ui||{};a.ui.version||(a.extend(a.ui,{version:"1.8.20",
...
"-disabled ui-state-disabled")},widget:function(){return this.element},option:function(d,e){var g=d;if(0===arguments.length)return a.extend({},this.options);if("string"===typeof d){if(e===c)return this.options[d];g={};g[d]=e}this._setOptions(g);return this},_setOptions:function(c){var d=this;a.each(c,function(a,b){d._setOption(a,b)});return this},_setOption:function(a,c){this.options[a]=c;"disabled"===a&&this.widget()[c?"addClass":"removeClass"](this.widgetBaseClass+"-disabled ui-state-disabled").attr("aria-disabled",
c);return this},enable:function(){return this._setOption("disabled",!1)},disable:function(){return this._setOption("disabled",!0)},_trigger:function(c,d,e){var b,k=this.options[c],e=e||{},d=a.Event(d);d.type=(c===this.widgetEventPrefix?c:this.widgetEventPrefix+c).toLowerCase();d.target=this.element[0];if(c=d.originalEvent)for(b in c)b in d||(d[b]=c[b]);this.element.trigger(d,e);return!(a.isFunction(k)&&!1===k.call(this.element[0],d,e)||d.isDefaultPrevented())}}})(jQuery);
...
this.margins.top-this.margins.bottom];this.relative_container=c}}else c.containment.constructor==Array&&(this.containment=c.containment)},_convertPositionTo:function(c,d){d||(d=this.position);var e="absolute"==c?1:-1,f="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,j=/(html|body)/i.test(f[0].tagName);return{top:d.top+this.offset.relative.top*e+this.offset.parent.top*e-(a.browser.safari&&
526>a.browser.version&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollTop():j?0:f.scrollTop())*e),left:d.left+this.offset.relative.left*e+this.offset.parent.left*e-(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollLeft():j?0:f.scrollLeft())*e)}},_generatePosition:function(c){var d=this.options,e="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],
this.offsetParent[0]))?this.offsetParent:this.scrollParent,f=/(html|body)/i.test(e[0].tagName),j=c.pageX,g=c.pageY;if(this.originalPosition){var b;this.containment&&(this.relative_container?(b=this.relative_container.offset(),b=[this.containment[0]+b.left,this.containment[1]+b.top,this.containment[2]+b.left,this.containment[3]+b.top]):b=this.containment,c.pageX-this.offset.click.left<b[0]&&(j=b[0]+this.offset.click.left),c.pageY-this.offset.click.top<b[1]&&(g=b[1]+this.offset.click.top),c.pageX-this.offset.click.left>
b[2]&&(j=b[2]+this.offset.click.left),c.pageY-this.offset.click.top>b[3]&&(g=b[3]+this.offset.click.top));d.grid&&(g=d.grid[1]?this.originalPageY+Math.round((g-this.originalPageY)/d.grid[1])*d.grid[1]:this.originalPageY,g=b?!(g-this.offset.click.top<b[1]||g-this.offset.click.top>b[3])?g:!(g-this.offset.click.top<b[1])?g-d.grid[1]:g+d.grid[1]:g,j=d.grid[0]?this.originalPageX+Math.round((j-this.originalPageX)/d.grid[0])*d.grid[0]:this.originalPageX,j=b?!(j-this.offset.click.left<b[0]||j-this.offset.click.left>
b[2])?j:!(j-this.offset.click.left<b[0])?j-d.grid[0]:j+d.grid[0]:j)}return{top:g-this.offset.click.top-this.offset.relative.top-this.offset.parent.top+(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?-this.scrollParent.scrollTop():f?0:e.scrollTop()),left:j-this.offset.click.left-this.offset.relative.left-this.offset.parent.left+(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?-this.scrollParent.scrollLeft():
...
a("body"),d=a(this).data("draggable").options;c.css("cursor")&&(d._cursor=c.css("cursor"));c.css("cursor",d.cursor)},stop:function(){var c=a(this).data("draggable").options;c._cursor&&a("body").css("cursor",c._cursor)}});a.ui.plugin.add("draggable","opacity",{start:function(c,d){var e=a(d.helper),f=a(this).data("draggable").options;e.css("opacity")&&(f._opacity=e.css("opacity"));e.css("opacity",f.opacity)},stop:function(c,d){var e=a(this).data("draggable").options;e._opacity&&a(d.helper).css("opacity",
e._opacity)}});a.ui.plugin.add("draggable","scroll",{start:function(){var c=a(this).data("draggable");c.scrollParent[0]!=document&&"HTML"!=c.scrollParent[0].tagName&&(c.overflowOffset=c.scrollParent.offset())},drag:function(c){var d=a(this).data("draggable"),e=d.options,f=!1;if(d.scrollParent[0]!=document&&"HTML"!=d.scrollParent[0].tagName){if(!e.axis||"x"!=e.axis)d.overflowOffset.top+d.scrollParent[0].offsetHeight-c.pageY<e.scrollSensitivity?d.scrollParent[0].scrollTop=f=d.scrollParent[0].scrollTop+
...
e.scrollSensitivity?f=a(document).scrollTop(a(document).scrollTop()-e.scrollSpeed):a(window).height()-(c.pageY-a(document).scrollTop())<e.scrollSensitivity&&(f=a(document).scrollTop(a(document).scrollTop()+e.scrollSpeed));if(!e.axis||"y"!=e.axis)c.pageX-a(document).scrollLeft()<e.scrollSensitivity?f=a(document).scrollLeft(a(document).scrollLeft()-e.scrollSpeed):a(window).width()-(c.pageX-a(document).scrollLeft())<e.scrollSensitivity&&(f=a(document).scrollLeft(a(document).scrollLeft()+e.scrollSpeed))}!1!==
f&&a.ui.ddmanager&&!e.dropBehaviour&&a.ui.ddmanager.prepareOffsets(d,c)}});a.ui.plugin.add("draggable","snap",{start:function(){var c=a(this).data("draggable"),d=c.options;c.snapElements=[];a(d.snap.constructor!=String?d.snap.items||":data(draggable)":d.snap).each(function(){var d=a(this),f=d.offset();this!=c.element[0]&&c.snapElements.push({item:this,width:d.outerWidth(),height:d.outerHeight(),top:f.top,left:f.left})})},drag:function(c,d){for(var e=a(this).data("draggable"),f=e.options,j=f.snapTolerance,
g=d.offset.left,b=g+e.helperProportions.width,k=d.offset.top,l=k+e.helperProportions.height,p=e.snapElements.length-1;0<=p;p--){var o=e.snapElements[p].left,m=o+e.snapElements[p].width,t=e.snapElements[p].top,r=t+e.snapElements[p].height;if(o-j<g&&g<m+j&&t-j<k&&k<r+j||o-j<g&&g<m+j&&t-j<l&&l<r+j||o-j<b&&b<m+j&&t-j<k&&k<r+j||o-j<b&&b<m+j&&t-j<l&&l<r+j){if("inner"!=f.snapMode){var q=Math.abs(t-l)<=j,s=Math.abs(r-k)<=j,x=Math.abs(o-b)<=j,v=Math.abs(m-g)<=j;q&&(d.position.top=e._convertPositionTo("relative",
{top:t-e.helperProportions.height,left:0}).top-e.margins.top);s&&(d.position.top=e._convertPositionTo("relative",{top:r,left:0}).top-e.margins.top);x&&(d.position.left=e._convertPositionTo("relative",{top:0,left:o-e.helperProportions.width}).left-e.margins.left);v&&(d.position.left=e._convertPositionTo("relative",{top:0,left:m}).left-e.margins.left)}var y=q||s||x||v;if("outer"!=f.snapMode&&(q=Math.abs(t-k)<=j,s=Math.abs(r-l)<=j,x=Math.abs(o-g)<=j,v=Math.abs(m-b)<=j,q&&(d.position.top=e._convertPositionTo("relative",
{top:t,left:0}).top-e.margins.top),s&&(d.position.top=e._convertPositionTo("relative",{top:r-e.helperProportions.height,left:0}).top-e.margins.top),x&&(d.position.left=e._convertPositionTo("relative",{top:0,left:o}).left-e.margins.left),v))d.position.left=e._convertPositionTo("relative",{top:0,left:m-e.helperProportions.width}).left-e.margins.left;!e.snapElements[p].snapping&&(q||s||x||v||y)&&e.options.snap.snap&&e.options.snap.snap.call(e.element,c,a.extend(e._uiHash(),{snapItem:e.snapElements[p].item}));
e.snapElements[p].snapping=q||s||x||v||y}else e.snapElements[p].snapping&&e.options.snap.release&&e.options.snap.release.call(e.element,c,a.extend(e._uiHash(),{snapItem:e.snapElements[p].item})),e.snapElements[p].snapping=!1}}});a.ui.plugin.add("draggable","stack",{start:function(){var c=a(this).data("draggable").options,c=a.makeArray(a(c.stack)).sort(function(c,d){return(parseInt(a(c).css("zIndex"),10)||0)-(parseInt(a(d).css("zIndex"),10)||0)});if(c.length){var d=parseInt(c[0].style.zIndex)||0;a(c).each(function(a){this.style.zIndex=
d+a});this[0].style.zIndex=d+c.length}}});a.ui.plugin.add("draggable","zIndex",{start:function(c,d){var e=a(d.helper),f=a(this).data("draggable").options;e.css("zIndex")&&(f._zIndex=e.css("zIndex"));e.css("zIndex",f.zIndex)},stop:function(c,d){var e=a(this).data("draggable").options;e._zIndex&&a(d.helper).css("zIndex",e._zIndex)}})})(jQuery);
...
"droppable");if(c.options.greedy&&!c.options.disabled&&c.options.scope==e.options.scope&&c.accept.call(c.element[0],e.currentItem||e.element)&&a.ui.intersect(e,a.extend(c,{offset:c.element.offset()}),c.options.tolerance))return f=!0,!1});return f?!1:this.accept.call(this.element[0],e.currentItem||e.element)?(this.options.activeClass&&this.element.removeClass(this.options.activeClass),this.options.hoverClass&&this.element.removeClass(this.options.hoverClass),this._trigger("drop",c,this.ui(e)),this.element):
!1},ui:function(a){return{draggable:a.currentItem||a.element,helper:a.helper,position:a.position,offset:a.positionAbs}}});a.extend(a.ui.droppable,{version:"1.8.20"});a.ui.intersect=function(c,d,e){if(!d.offset)return!1;var f=(c.positionAbs||c.position.absolute).left,j=f+c.helperProportions.width,g=(c.positionAbs||c.position.absolute).top,b=g+c.helperProportions.height,k=d.offset.left,l=k+d.proportions.width,p=d.offset.top,o=p+d.proportions.height;switch(e){case "fit":return k<=f&&j<=l&&p<=g&&b<=o;
case "intersect":return k<f+c.helperProportions.width/2&&j-c.helperProportions.width/2<l&&p<g+c.helperProportions.height/2&&b-c.helperProportions.height/2<o;case "pointer":return a.ui.isOver((c.positionAbs||c.position.absolute).top+(c.clickOffset||c.offset.click).top,(c.positionAbs||c.position.absolute).left+(c.clickOffset||c.offset.click).left,p,k,d.proportions.height,d.proportions.width);case "touch":return(g>=p&&g<=o||b>=p&&b<=o||g<p&&b>o)&&(f>=k&&f<=l||j>=k&&j<=l||f<k&&j>l);default:return!1}};
a.ui.ddmanager={current:null,droppables:{"default":[]},prepareOffsets:function(c,d){var e=a.ui.ddmanager.droppables[c.options.scope]||[],f=d?d.type:null,j=(c.currentItem||c.element).find(":data(droppable)").andSelf(),g=0;a:for(;g<e.length;g++)if(!(e[g].options.disabled||c&&!e[g].accept.call(e[g].element[0],c.currentItem||c.element))){for(var b=0;b<j.length;b++)if(j[b]==e[g].element[0]){e[g].proportions.height=0;continue a}e[g].visible="none"!=e[g].element.css("display");e[g].visible&&("mousedown"==
f&&e[g]._activate.call(e[g],d),e[g].offset=e[g].element.offset(),e[g].proportions={width:e[g].element[0].offsetWidth,height:e[g].element[0].offsetHeight})}},drop:function(c,d){var e=!1;a.each(a.ui.ddmanager.droppables[c.options.scope]||[],function(){if(this.options&&(!this.options.disabled&&this.visible&&a.ui.intersect(c,this,this.options.tolerance)&&(e=this._drop.call(this,d)||e),!this.options.disabled&&this.visible&&this.accept.call(this.element[0],c.currentItem||c.element)))this.isout=1,this.isover=
...
if(this.elementIsWrapper){c(this.element);var d=this.element;d.after(this.originalElement.css({position:d.css("position"),width:d.outerWidth(),height:d.outerHeight(),top:d.css("top"),left:d.css("left")})).remove()}this.originalElement.css("resize",this.originalResizeStyle);c(this.originalElement);return this},_mouseCapture:function(c){var d=!1,j;for(j in this.handles)a(this.handles[j])[0]==c.target&&(d=!0);return!this.options.disabled&&d},_mouseStart:function(d){var f=this.options,j=this.element.position(),
g=this.element;this.resizing=!0;this.documentScroll={top:a(document).scrollTop(),left:a(document).scrollLeft()};(g.is(".ui-draggable")||/absolute/.test(g.css("position")))&&g.css({position:"absolute",top:j.top,left:j.left});this._renderProxy();var j=c(this.helper.css("left")),b=c(this.helper.css("top"));f.containment&&(j+=a(f.containment).scrollLeft()||0,b+=a(f.containment).scrollTop()||0);this.offset=this.helper.offset();this.position={left:j,top:b};this.size=this._helper?{width:g.outerWidth(),height:g.outerHeight()}:
{width:g.width(),height:g.height()};this.originalSize=this._helper?{width:g.outerWidth(),height:g.outerHeight()}:{width:g.width(),height:g.height()};this.originalPosition={left:j,top:b};this.sizeDiff={width:g.outerWidth()-g.width(),height:g.outerHeight()-g.height()};this.originalMousePosition={left:d.pageX,top:d.pageY};this.aspectRatio="number"==typeof f.aspectRatio?f.aspectRatio:this.originalSize.width/this.originalSize.height||1;f=a(".ui-resizable-"+this.axis).css("cursor");a("body").css("cursor",
"auto"==f?this.axis+"-resize":f);g.addClass("ui-resizable-resizing");this._propagate("start",d);return!0},_mouseDrag:function(a){var c=this.helper,d=this.originalMousePosition,g=this._change[this.axis];if(!g)return!1;d=g.apply(this,[a,a.pageX-d.left||0,a.pageY-d.top||0]);this._updateVirtualBoundaries(a.shiftKey);if(this._aspectRatio||a.shiftKey)d=this._updateRatio(d,a);d=this._respectSize(d,a);this._propagate("resize",a);c.css({top:this.position.top+"px",left:this.position.left+"px",width:this.size.width+
"px",height:this.size.height+"px"});!this._helper&&this._proportionallyResizeElements.length&&this._proportionallyResize();this._updateCache(d);this._trigger("resize",a,this.ui());return!1},_mouseStop:function(c){this.resizing=!1;var d=this.options;if(this._helper){var j=this._proportionallyResizeElements,g=j.length&&/textarea/i.test(j[0].nodeName),j=g&&a.ui.hasScroll(j[0],"left")?0:this.sizeDiff.height,g=g?0:this.sizeDiff.width,g={width:this.helper.width()-g,height:this.helper.height()-j},j=parseInt(this.element.css("left"),
10)+(this.position.left-this.originalPosition.left)||null,b=parseInt(this.element.css("top"),10)+(this.position.top-this.originalPosition.top)||null;d.animate||this.element.css(a.extend(g,{top:b,left:j}));this.helper.height(this.size.height);this.helper.width(this.size.width);this._helper&&!d.animate&&this._proportionallyResize()}a("body").css("cursor","auto");this.element.removeClass("ui-resizable-resizing");this._propagate("stop",c);this._helper&&this.helper.remove();return!1},_updateVirtualBoundaries:function(a){var c=
this.options,j,g,b,c={minWidth:d(c.minWidth)?c.minWidth:0,maxWidth:d(c.maxWidth)?c.maxWidth:Infinity,minHeight:d(c.minHeight)?c.minHeight:0,maxHeight:d(c.maxHeight)?c.maxHeight:Infinity};if(this._aspectRatio||a)if(a=c.minHeight*this.aspectRatio,g=c.minWidth/this.aspectRatio,j=c.maxHeight*this.aspectRatio,b=c.maxWidth/this.aspectRatio,a>c.minWidth&&(c.minWidth=a),g>c.minHeight&&(c.minHeight=g),j<c.maxWidth&&(c.maxWidth=j),b<c.maxHeight)c.maxHeight=b;this._vBoundaries=c},_updateCache:function(a){this.offset=
this.helper.offset();d(a.left)&&(this.position.left=a.left);d(a.top)&&(this.position.top=a.top);d(a.height)&&(this.size.height=a.height);d(a.width)&&(this.size.width=a.width)},_updateRatio:function(a){var c=this.position,j=this.size,g=this.axis;d(a.height)?a.width=a.height*this.aspectRatio:d(a.width)&&(a.height=a.width/this.aspectRatio);"sw"==g&&(a.left=c.left+(j.width-a.width),a.top=null);"nw"==g&&(a.top=c.top+(j.height-a.height),a.left=c.left+(j.width-a.width));return a},_respectSize:function(a){var c=
this._vBoundaries,j=this.axis,g=d(a.width)&&c.maxWidth&&c.maxWidth<a.width,b=d(a.height)&&c.maxHeight&&c.maxHeight<a.height,k=d(a.width)&&c.minWidth&&c.minWidth>a.width,l=d(a.height)&&c.minHeight&&c.minHeight>a.height;k&&(a.width=c.minWidth);l&&(a.height=c.minHeight);g&&(a.width=c.maxWidth);b&&(a.height=c.maxHeight);var p=this.originalPosition.left+this.originalSize.width,o=this.position.top+this.size.height,m=/sw|nw|w/.test(j),j=/nw|ne|n/.test(j);k&&m&&(a.left=p-c.minWidth);g&&m&&(a.left=p-c.maxWidth);
l&&j&&(a.top=o-c.minHeight);b&&j&&(a.top=o-c.maxHeight);(c=!a.width&&!a.height)&&!a.left&&a.top?a.top=null:c&&!a.top&&a.left&&(a.left=null);return a},_proportionallyResize:function(){if(this._proportionallyResizeElements.length)for(var c=this.helper||this.element,d=0;d<this._proportionallyResizeElements.length;d++){var j=this._proportionallyResizeElements[d];if(!this.borderDif){var g=[j.css("borderTopWidth"),j.css("borderRightWidth"),j.css("borderBottomWidth"),j.css("borderLeftWidth")],b=[j.css("paddingTop"),
j.css("paddingRight"),j.css("paddingBottom"),j.css("paddingLeft")];this.borderDif=a.map(g,function(a,c){var d=parseInt(a,10)||0,f=parseInt(b[c],10)||0;return d+f})}if(!a.browser.msie||!a(c).is(":hidden")&&!a(c).parents(":hidden").length)j.css({height:c.height()-this.borderDif[0]-this.borderDif[2]||0,width:c.width()-this.borderDif[1]-this.borderDif[3]||0})}},_renderProxy:function(){var c=this.options;this.elementOffset=this.element.offset();if(this._helper){this.helper=this.helper||a('<div style="overflow:hidden;"></div>');
...
"containment",{start:function(){var d=a(this).data("resizable"),f=d.element,j=d.options.containment;if(f=j instanceof a?j.get(0):/parent/.test(j)?f.parent().get(0):j)if(d.containerElement=a(f),/document/.test(j)||j==document)d.containerOffset={left:0,top:0},d.containerPosition={left:0,top:0},d.parentData={element:a(document),left:0,top:0,width:a(document).width(),height:a(document).height()||document.body.parentNode.scrollHeight};else{var g=a(f),b=[];a(["Top","Right","Left","Bottom"]).each(function(a,
d){b[a]=c(g.css("padding"+d))});d.containerOffset=g.offset();d.containerPosition=g.position();d.containerSize={height:g.innerHeight()-b[3],width:g.innerWidth()-b[1]};var j=d.containerOffset,k=d.containerSize.height,l=d.containerSize.width,l=a.ui.hasScroll(f,"left")?f.scrollWidth:l,k=a.ui.hasScroll(f)?f.scrollHeight:k;d.parentData={element:f,left:j.left,top:j.top,width:l,height:k}}},resize:function(c){var d=a(this).data("resizable"),j=d.options,g=d.containerOffset,b=d.position,c=d._aspectRatio||c.shiftKey,
k={top:0,left:0},l=d.containerElement;l[0]!=document&&/static/.test(l.css("position"))&&(k=g);if(b.left<(d._helper?g.left:0))d.size.width+=d._helper?d.position.left-g.left:d.position.left-k.left,c&&(d.size.height=d.size.width/d.aspectRatio),d.position.left=j.helper?g.left:0;if(b.top<(d._helper?g.top:0))d.size.height+=d._helper?d.position.top-g.top:d.position.top,c&&(d.size.width=d.size.height*d.aspectRatio),d.position.top=d._helper?g.top:0;d.offset.left=d.parentData.left+d.position.left;d.offset.top=
d.parentData.top+d.position.top;j=Math.abs(d.offset.left-k.left+d.sizeDiff.width);g=Math.abs((d._helper?d.offset.top-k.top:d.offset.top-g.top)+d.sizeDiff.height);b=d.containerElement.get(0)==d.element.parent().get(0);k=/relative|absolute/.test(d.containerElement.css("position"));b&&k&&(j-=d.parentData.left);j+d.size.width>=d.parentData.width&&(d.size.width=d.parentData.width-j,c&&(d.size.height=d.size.width/d.aspectRatio));g+d.size.height>=d.parentData.height&&(d.size.height=d.parentData.height-g,
c&&(d.size.width=d.size.height*d.aspectRatio))},stop:function(){var c=a(this).data("resizable"),d=c.options,j=c.containerOffset,g=c.containerPosition,b=c.containerElement,k=a(c.helper),l=k.offset(),p=k.outerWidth()-c.sizeDiff.width,k=k.outerHeight()-c.sizeDiff.height;c._helper&&!d.animate&&/relative/.test(b.css("position"))&&a(this).css({left:l.left-g.left-j.left,width:p,height:k});c._helper&&!d.animate&&/static/.test(b.css("position"))&&a(this).css({left:l.left-g.left-j.left,width:p,height:k})}});
...
a(this).data("resizable");c.ghost&&c.helper&&c.helper.get(0).removeChild(c.ghost.get(0))}});a.ui.plugin.add("resizable","grid",{resize:function(){var c=a(this).data("resizable"),d=c.options,j=c.size,g=c.originalSize,b=c.originalPosition,k=c.axis;d.grid="number"==typeof d.grid?[d.grid,d.grid]:d.grid;var l=Math.round((j.width-g.width)/(d.grid[0]||1))*(d.grid[0]||1),d=Math.round((j.height-g.height)/(d.grid[1]||1))*(d.grid[1]||1);/^(se|s|e)$/.test(k)?(c.size.width=g.width+l,c.size.height=g.height+d):
/^(ne)$/.test(k)?(c.size.width=g.width+l,c.size.height=g.height+d,c.position.top=b.top-d):(/^(sw)$/.test(k)?(c.size.width=g.width+l,c.size.height=g.height+d):(c.size.width=g.width+l,c.size.height=g.height+d,c.position.top=b.top-d),c.position.left=b.left-l)}});var c=function(a){return parseInt(a,10)||0},d=function(a){return!isNaN(parseInt(a,10))}})(jQuery);
...
e.unselecting=!0,d._trigger("unselecting",c,{unselecting:e.element}))});a(c.target).parents().andSelf().each(function(){var e=a.data(this,"selectable-item");if(e){var j=!c.metaKey&&!c.ctrlKey||!e.$element.hasClass("ui-selected");e.$element.removeClass(j?"ui-unselecting":"ui-selected").addClass(j?"ui-selecting":"ui-unselecting");e.unselecting=!j;e.selecting=j;(e.selected=j)?d._trigger("selecting",c,{selecting:e.element}):d._trigger("unselecting",c,{unselecting:e.element});return!1}})}},_mouseDrag:function(c){var d=
this;this.dragged=!0;if(!this.options.disabled){var e=this.options,f=this.opos[0],j=this.opos[1],g=c.pageX,b=c.pageY;if(f>g)var k=g,g=f,f=k;j>b&&(k=b,b=j,j=k);this.helper.css({left:f,top:j,width:g-f,height:b-j});this.selectees.each(function(){var k=a.data(this,"selectable-item");if(k&&k.element!=d.element[0]){var p=false;e.tolerance=="touch"?p=!(k.left>g||k.right<f||k.top>b||k.bottom<j):e.tolerance=="fit"&&(p=k.left>f&&k.right<g&&k.top>j&&k.bottom<b);if(p){if(k.selected){k.$element.removeClass("ui-selected");
...
this._convertPositionTo("absolute");if(!this.options.axis||"y"!=this.options.axis)this.helper[0].style.left=this.position.left+"px";if(!this.options.axis||"x"!=this.options.axis)this.helper[0].style.top=this.position.top+"px";for(d=this.items.length-1;0<=d;d--){var e=this.items[d],f=e.item[0],j=this._intersectsWithPointer(e);if(j&&f!=this.currentItem[0]&&this.placeholder[1==j?"next":"prev"]()[0]!=f&&!a.ui.contains(this.placeholder[0],f)&&("semi-dynamic"==this.options.type?!a.ui.contains(this.element[0],
f):1)){this.direction=1==j?"down":"up";if("pointer"==this.options.tolerance||this._intersectsWithSides(e))this._rearrange(c,e);else break;this._trigger("change",c,this._uiHash());break}}this._contactContainers(c);a.ui.ddmanager&&a.ui.ddmanager.drag(this,c);this._trigger("sort",c,this._uiHash());this.lastPositionAbs=this.positionAbs;return!1},_mouseStop:function(c,d){if(c){a.ui.ddmanager&&!this.options.dropBehaviour&&a.ui.ddmanager.drop(this,c);if(this.options.revert){var e=this,f=e.placeholder.offset();
...
this._getItemsAsjQuery(c&&c.connected),e=[],c=c||{};d.each(function(){e.push(a(c.item||this).attr(c.attribute||"id")||"")});return e},_intersectsWith:function(a){var d=this.positionAbs.left,e=d+this.helperProportions.width,f=this.positionAbs.top,j=f+this.helperProportions.height,g=a.left,b=g+a.width,k=a.top,l=k+a.height,p=this.offset.click.top,o=this.offset.click.left;return"pointer"==this.options.tolerance||this.options.forcePointerForContainers||"pointer"!=this.options.tolerance&&this.helperProportions[this.floating?
"width":"height"]>a[this.floating?"width":"height"]?f+p>k&&f+p<l&&d+o>g&&d+o<b:g<d+this.helperProportions.width/2&&e-this.helperProportions.width/2<b&&k<f+this.helperProportions.height/2&&j-this.helperProportions.height/2<l},_intersectsWithPointer:function(c){var d="x"===this.options.axis||a.ui.isOverAxis(this.positionAbs.top+this.offset.click.top,c.top,c.height),c="y"===this.options.axis||a.ui.isOverAxis(this.positionAbs.left+this.offset.click.left,c.left,c.width),d=d&&c,c=this._getDragVerticalDirection(),
...
this.positionAbs.top-this.lastPositionAbs.top;return 0!=a&&(0<a?"down":"up")},_getDragHorizontalDirection:function(){var a=this.positionAbs.left-this.lastPositionAbs.left;return 0!=a&&(0<a?"right":"left")},refresh:function(a){this._refreshItems(a);this.refreshPositions();return this},_connectWith:function(){var a=this.options;return a.connectWith.constructor==String?[a.connectWith]:a.connectWith},_getItemsAsjQuery:function(c){var d=[],e=[],f=this._connectWith();if(f&&c)for(c=f.length-1;0<=c;c--)for(var j=
a(f[c]),g=j.length-1;0<=g;g--){var b=a.data(j[g],this.widgetName);b&&b!=this&&!b.options.disabled&&e.push([a.isFunction(b.options.items)?b.options.items.call(b.element):a(b.options.items,b.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),b])}e.push([a.isFunction(this.options.items)?this.options.items.call(this.element,null,{options:this.options,item:this.currentItem}):a(this.options.items,this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),this]);for(c=e.length-
1;0<=c;c--)e[c][0].each(function(){d.push(this)});return a(d)},_removeCurrentsFromItems:function(){for(var a=this.currentItem.find(":data("+this.widgetName+"-item)"),d=0;d<this.items.length;d++)for(var e=0;e<a.length;e++)a[e]==this.items[d].item[0]&&this.items.splice(d,1)},_refreshItems:function(c){this.items=[];this.containers=[this];var d=this.items,e=[[a.isFunction(this.options.items)?this.options.items.call(this.element[0],c,{item:this.currentItem}):a(this.options.items,this.element),this]],f=
this._connectWith();if(f&&this.ready)for(var j=f.length-1;0<=j;j--)for(var g=a(f[j]),b=g.length-1;0<=b;b--){var k=a.data(g[b],this.widgetName);k&&k!=this&&!k.options.disabled&&(e.push([a.isFunction(k.options.items)?k.options.items.call(k.element[0],c,{item:this.currentItem}):a(k.options.items,k.element),k]),this.containers.push(k))}for(j=e.length-1;0<=j;j--){c=e[j][1];f=e[j][0];b=0;for(g=f.length;b<g;b++)k=a(f[b]),k.data(this.widgetName+"-item",c),d.push({item:k,instance:c,width:0,height:0,left:0,
...
a(document.createElement(d.currentItem[0].nodeName)).addClass(f||d.currentItem[0].className+" ui-sortable-placeholder").removeClass("ui-sortable-helper")[0];f||(c.style.visibility="hidden");return c},update:function(a,c){if(!f||e.forcePlaceholderSize)c.height()||c.height(d.currentItem.innerHeight()-parseInt(d.currentItem.css("paddingTop")||0,10)-parseInt(d.currentItem.css("paddingBottom")||0,10)),c.width()||c.width(d.currentItem.innerWidth()-parseInt(d.currentItem.css("paddingLeft")||0,10)-parseInt(d.currentItem.css("paddingRight")||
0,10))}}}d.placeholder=a(e.placeholder.element.call(d.element,d.currentItem));d.currentItem.after(d.placeholder);e.placeholder.update(d,d.placeholder)},_contactContainers:function(c){for(var d=null,e=null,f=this.containers.length-1;0<=f;f--)if(!a.ui.contains(this.currentItem[0],this.containers[f].element[0]))if(this._intersectsWith(this.containers[f].containerCache)){if(!d||!a.ui.contains(this.containers[f].element[0],d.element[0]))d=this.containers[f],e=f}else this.containers[f].containerCache.over&&
(this.containers[f]._trigger("out",c,this._uiHash(this)),this.containers[f].containerCache.over=0);if(d)if(1===this.containers.length)this.containers[e]._trigger("over",c,this._uiHash(this)),this.containers[e].containerCache.over=1;else if(this.currentContainer!=this.containers[e]){for(var d=1E4,f=null,j=this.positionAbs[this.containers[e].floating?"left":"top"],g=this.items.length-1;0<=g;g--)if(a.ui.contains(this.containers[e].element[0],this.items[g].item[0])){var b=this.items[g][this.containers[e].floating?
"left":"top"];Math.abs(b-j)<d&&(d=Math.abs(b-j),f=this.items[g])}if(f||this.options.dropOnEmpty)this.currentContainer=this.containers[e],f?this._rearrange(c,f,null,!0):this._rearrange(c,null,this.containers[e].element,!0),this._trigger("change",c,this._uiHash()),this.containers[e]._trigger("change",c,this._uiHash(this)),this.options.placeholder.update(this.currentContainer,this.placeholder),this.containers[e]._trigger("over",c,this._uiHash(this)),this.containers[e].containerCache.over=1}},_createHelper:function(c){var d=
...
this.margins.top]}},_convertPositionTo:function(c,d){d||(d=this.position);var e="absolute"==c?1:-1,f="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,j=/(html|body)/i.test(f[0].tagName);return{top:d.top+this.offset.relative.top*e+this.offset.parent.top*e-(a.browser.safari&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollTop():j?0:f.scrollTop())*e),left:d.left+
this.offset.relative.left*e+this.offset.parent.left*e-(a.browser.safari&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollLeft():j?0:f.scrollLeft())*e)}},_generatePosition:function(c){var d=this.options,e="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,f=/(html|body)/i.test(e[0].tagName);"relative"==this.cssPosition&&!(this.scrollParent[0]!=document&&this.scrollParent[0]!=
this.offsetParent[0])&&(this.offset.relative=this._getRelativeOffset());var j=c.pageX,g=c.pageY;if(this.originalPosition&&(this.containment&&(c.pageX-this.offset.click.left<this.containment[0]&&(j=this.containment[0]+this.offset.click.left),c.pageY-this.offset.click.top<this.containment[1]&&(g=this.containment[1]+this.offset.click.top),c.pageX-this.offset.click.left>this.containment[2]&&(j=this.containment[2]+this.offset.click.left),c.pageY-this.offset.click.top>this.containment[3]&&(g=this.containment[3]+
this.offset.click.top)),d.grid))g=this.originalPageY+Math.round((g-this.originalPageY)/d.grid[1])*d.grid[1],g=this.containment?!(g-this.offset.click.top<this.containment[1]||g-this.offset.click.top>this.containment[3])?g:!(g-this.offset.click.top<this.containment[1])?g-d.grid[1]:g+d.grid[1]:g,j=this.originalPageX+Math.round((j-this.originalPageX)/d.grid[0])*d.grid[0],j=this.containment?!(j-this.offset.click.left<this.containment[0]||j-this.offset.click.left>this.containment[2])?j:!(j-this.offset.click.left<
this.containment[0])?j-d.grid[0]:j+d.grid[0]:j;return{top:g-this.offset.click.top-this.offset.relative.top-this.offset.parent.top+(a.browser.safari&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?-this.scrollParent.scrollTop():f?0:e.scrollTop()),left:j-this.offset.click.left-this.offset.relative.left-this.offset.parent.left+(a.browser.safari&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?-this.scrollParent.scrollLeft():f?0:e.scrollLeft())}},_rearrange:function(a,d,e,f){e?e[0].appendChild(this.placeholder[0]):
d.item[0].parentNode.insertBefore(this.placeholder[0],"down"==this.direction?d.item[0]:d.item[0].nextSibling);this.counter=this.counter?++this.counter:1;var j=this,g=this.counter;window.setTimeout(function(){g==j.counter&&j.refreshPositions(!f)},0)},_clear:function(c,d){this.reverting=!1;var e=[];!this._noFinalSort&&this.currentItem.parent().length&&this.placeholder.before(this.currentItem);this._noFinalSort=null;if(this.helper[0]==this.currentItem[0]){for(var f in this._storedCSS)if("auto"==this._storedCSS[f]||
"static"==this._storedCSS[f])this._storedCSS[f]="";this.currentItem.css(this._storedCSS).removeClass("ui-sortable-helper")}else this.currentItem.show();this.fromOutside&&!d&&e.push(function(a){this._trigger("receive",a,this._uiHash(this.fromOutside))});(this.fromOutside||this.domPosition.prev!=this.currentItem.prev().not(".ui-sortable-helper")[0]||this.domPosition.parent!=this.currentItem.parent()[0])&&!d&&e.push(function(a){this._trigger("update",a,this._uiHash())});if(!a.ui.contains(this.element[0],
this.currentItem[0])){d||e.push(function(a){this._trigger("remove",a,this._uiHash())});for(f=this.containers.length-1;0<=f;f--)a.ui.contains(this.containers[f].element[0],this.currentItem[0])&&!d&&(e.push(function(a){return function(c){a._trigger("receive",c,this._uiHash(this))}}.call(this,this.containers[f])),e.push(function(a){return function(c){a._trigger("update",c,this._uiHash(this))}}.call(this,this.containers[f])))}for(f=this.containers.length-1;0<=f;f--)d||e.push(function(a){return function(c){a._trigger("deactivate",
...
d:d in a.fx.speeds?a.fx.speeds[d]:a.fx.speeds._default;e=e||c.complete;return[b,c,d,e]}function b(b){return!b||"number"===typeof b||a.fx.speeds[b]||"string"===typeof b&&!a.effects[b]?!0:!1}a.effects={};a.each("backgroundColor,borderBottomColor,borderLeftColor,borderRightColor,borderTopColor,borderColor,color,outlineColor".split(","),function(b,c){a.fx.step[c]=function(b){if(!b.colorInit){var e;e=b.elem;var f=c,g;do{g=a.curCSS(e,f);if(g!=""&&g!="transparent"||a.nodeName(e,"body"))break;f="backgroundColor"}while(e=
e.parentNode);e=d(g);b.start=e;b.end=d(b.end);b.colorInit=true}b.elem.style[c]="rgb("+Math.max(Math.min(parseInt(b.pos*(b.end[0]-b.start[0])+b.start[0],10),255),0)+","+Math.max(Math.min(parseInt(b.pos*(b.end[1]-b.start[1])+b.start[1],10),255),0)+","+Math.max(Math.min(parseInt(b.pos*(b.end[2]-b.start[2])+b.start[2],10),255),0)+")"}});var k={aqua:[0,255,255],azure:[240,255,255],beige:[245,245,220],black:[0,0,0],blue:[0,0,255],brown:[165,42,42],cyan:[0,255,255],darkblue:[0,0,139],darkcyan:[0,139,139],
darkgrey:[169,169,169],darkgreen:[0,100,0],darkkhaki:[189,183,107],darkmagenta:[139,0,139],darkolivegreen:[85,107,47],darkorange:[255,140,0],darkorchid:[153,50,204],darkred:[139,0,0],darksalmon:[233,150,122],darkviolet:[148,0,211],fuchsia:[255,0,255],gold:[255,215,0],green:[0,128,0],indigo:[75,0,130],khaki:[240,230,140],lightblue:[173,216,230],lightcyan:[224,255,255],lightgreen:[144,238,144],lightgrey:[211,211,211],lightpink:[255,182,193],lightyellow:[255,255,224],lime:[0,255,0],magenta:[255,0,255],
maroon:[128,0,0],navy:[0,0,128],olive:[128,128,0],orange:[255,165,0],pink:[255,192,203],purple:[128,0,128],violet:[128,0,128],red:[255,0,0],silver:[192,192,192],white:[255,255,255],yellow:[255,255,0],transparent:[255,255,255]},l=["add","remove","toggle"],p={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};a.effects.animateClass=function(b,c,d,g){a.isFunction(d)&&(g=d,d=null);return this.queue(function(){var k=a(this),p=k.attr("style")||
" ",x=f(e.call(this)),v,y=k.attr("class")||"";a.each(l,function(a,c){if(b[c])k[c+"Class"](b[c])});v=f(e.call(this));k.attr("class",y);k.animate(j(x,v),{queue:false,duration:c,easing:d,complete:function(){a.each(l,function(a,c){if(b[c])k[c+"Class"](b[c])});if(typeof k.attr("style")=="object"){k.attr("style").cssText="";k.attr("style").cssText=p}else k.attr("style",p);g&&g.apply(this,arguments);a.dequeue(this)}})})};a.fn.extend({_addClass:a.fn.addClass,addClass:function(b,c,d,e){return c?a.effects.animateClass.apply(this,
...
c):b},setTransition:function(b,c,d,e){e=e||{};a.each(c,function(a,c){var f=b.cssUnit(c);0<f[0]&&(e[c]=f[0]*d+f[1])});return e}});a.fn.extend({effect:function(b,c,d,e){var f=g.apply(this,arguments),k={options:f[1],duration:f[2],callback:f[3]},f=k.options.mode,j=a.effects[b];return a.fx.off||!j?f?this[f](k.duration,k.callback):this.each(function(){k.callback&&k.callback.call(this)}):j.call(this,k)},_show:a.fn.show,show:function(a){if(b(a))return this._show.apply(this,arguments);var c=g.apply(this,arguments);
c[1].mode="show";return this.effect.apply(this,c)},_hide:a.fn.hide,hide:function(a){if(b(a))return this._hide.apply(this,arguments);var c=g.apply(this,arguments);c[1].mode="hide";return this.effect.apply(this,c)},__toggle:a.fn.toggle,toggle:function(c){if(b(c)||"boolean"===typeof c||a.isFunction(c))return this.__toggle.apply(this,arguments);var d=g.apply(this,arguments);d[1].mode="toggle";return this.effect.apply(this,d)},cssUnit:function(b){var c=this.css(b),d=[];a.each(["em","px","%","pt"],function(a,
...
f)+d+c},easeInBack:function(a,b,d,e,f,g){g==c&&(g=1.70158);return e*(b/=f)*b*((g+1)*b-g)+d},easeOutBack:function(a,b,d,e,f,g){g==c&&(g=1.70158);return e*((b=b/f-1)*b*((g+1)*b+g)+1)+d},easeInOutBack:function(a,b,d,e,f,g){g==c&&(g=1.70158);return 1>(b/=f/2)?e/2*b*b*(((g*=1.525)+1)*b-g)+d:e/2*((b-=2)*b*(((g*=1.525)+1)*b+g)+2)+d},easeInBounce:function(b,c,d,e,f){return e-a.easing.easeOutBounce(b,f-c,0,e,f)+d},easeOutBounce:function(a,b,c,d,e){return(b/=e)<1/2.75?d*7.5625*b*b+c:b<2/2.75?d*(7.5625*(b-=
...
(function(a){a.effects.blind=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],f=a.effects.setMode(d,c.options.mode||"hide"),j=c.options.direction||"vertical";a.effects.save(d,e);d.show();var g=a.effects.createWrapper(d).css({overflow:"hidden"}),b="vertical"==j?"height":"width",j="vertical"==j?g.height():g.width();"show"==f&&g.css(b,0);var k={};k[b]="show"==f?j:0;g.animate(k,c.duration,c.options.easing,function(){"hide"==f&&d.hide();a.effects.restore(d,
e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
(function(a){a.effects.bounce=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],f=a.effects.setMode(d,c.options.mode||"effect"),j=c.options.direction||"up",g=c.options.distance||20,b=c.options.times||5,k=c.duration||250;/show|hide/.test(f)&&e.push("opacity");a.effects.save(d,e);d.show();a.effects.createWrapper(d);var l="up"==j||"down"==j?"top":"left",j="up"==j||"left"==j?"pos":"neg",g=c.options.distance||("top"==l?d.outerHeight({margin:!0})/3:d.outerWidth({margin:!0})/
3);"show"==f&&d.css("opacity",0).css(l,"pos"==j?-g:g);"hide"==f&&(g/=2*b);"hide"!=f&&b--;if("show"==f){var p={opacity:1};p[l]=("pos"==j?"+=":"-=")+g;d.animate(p,k/2,c.options.easing);g/=2;b--}for(p=0;p<b;p++){var o={},m={};o[l]=("pos"==j?"-=":"+=")+g;m[l]=("pos"==j?"+=":"-=")+g;d.animate(o,k/2,c.options.easing).animate(m,k/2,c.options.easing);g="hide"==f?2*g:g/2}"hide"==f?(p={opacity:0},p[l]=("pos"==j?"-=":"+=")+g,d.animate(p,k/2,c.options.easing,function(){d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);
c.callback&&c.callback.apply(this,arguments)})):(o={},m={},o[l]=("pos"==j?"-=":"+=")+g,m[l]=("pos"==j?"+=":"-=")+g,d.animate(o,k/2,c.options.easing).animate(m,k/2,c.options.easing,function(){a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)}));d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(jQuery);
(function(a){a.effects.clip=function(c){return this.queue(function(){var d=a(this),e="position,top,bottom,left,right,height,width".split(","),f=a.effects.setMode(d,c.options.mode||"hide"),j=c.options.direction||"vertical";a.effects.save(d,e);d.show();var g=a.effects.createWrapper(d).css({overflow:"hidden"}),g="IMG"==d[0].tagName?g:d,b="vertical"==j?"height":"width",k="vertical"==j?"top":"left",j="vertical"==j?g.height():g.width();"show"==f&&(g.css(b,0),g.css(k,j/2));var l={};l[b]="show"==f?j:0;l[k]=
"show"==f?0:j/2;g.animate(l,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){f=="hide"&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.drop=function(c){return this.queue(function(){var d=a(this),e="position,top,bottom,left,right,opacity".split(","),f=a.effects.setMode(d,c.options.mode||"hide"),j=c.options.direction||"left";a.effects.save(d,e);d.show();a.effects.createWrapper(d);var g="up"==j||"down"==j?"top":"left",j="up"==j||"left"==j?"pos":"neg",b=c.options.distance||("top"==g?d.outerHeight({margin:!0})/2:d.outerWidth({margin:!0})/2);"show"==f&&d.css("opacity",0).css(g,"pos"==j?-b:b);var k={opacity:"show"==
f?1:0};k[g]=("show"==f?"pos"==j?"+=":"-=":"pos"==j?"-=":"+=")+b;d.animate(k,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){"hide"==f&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.explode=function(c){return this.queue(function(){var d=c.options.pieces?Math.round(Math.sqrt(c.options.pieces)):3,e=c.options.pieces?Math.round(Math.sqrt(c.options.pieces)):3;c.options.mode="toggle"==c.options.mode?a(this).is(":visible")?"hide":"show":c.options.mode;var f=a(this).show().css("visibility","hidden"),j=f.offset();j.top-=parseInt(f.css("marginTop"),10)||0;j.left-=parseInt(f.css("marginLeft"),10)||0;for(var g=f.outerWidth(!0),b=f.outerHeight(!0),k=0;k<d;k++)for(var l=
0;l<e;l++)f.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-l*(g/e),top:-k*(b/d)}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:g/e,height:b/d,left:j.left+l*(g/e)+("show"==c.options.mode?(l-Math.floor(e/2))*(g/e):0),top:j.top+k*(b/d)+("show"==c.options.mode?(k-Math.floor(d/2))*(b/d):0),opacity:"show"==c.options.mode?0:1}).animate({left:j.left+l*(g/e)+("show"==c.options.mode?0:(l-Math.floor(e/2))*(g/e)),top:j.top+
k*(b/d)+("show"==c.options.mode?0:(k-Math.floor(d/2))*(b/d)),opacity:"show"==c.options.mode?1:0},c.duration||500);setTimeout(function(){"show"==c.options.mode?f.css({visibility:"visible"}):f.css({visibility:"visible"}).hide();c.callback&&c.callback.apply(f[0]);f.dequeue();a("div.ui-effects-explode").remove()},c.duration||500)})}})(jQuery);
...
(function(a){a.effects.fold=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],f=a.effects.setMode(d,c.options.mode||"hide"),j=c.options.size||15,g=!!c.options.horizFirst,b=c.duration?c.duration/2:a.fx.speeds._default/2;a.effects.save(d,e);d.show();var k=a.effects.createWrapper(d).css({overflow:"hidden"}),l="show"==f!=g,p=l?["width","height"]:["height","width"],l=l?[k.width(),k.height()]:[k.height(),k.width()],o=/([0-9]+)%/.exec(j);o&&(j=parseInt(o[1],
10)/100*l["hide"==f?0:1]);"show"==f&&k.css(g?{height:0,width:j}:{height:j,width:0});g={};o={};g[p[0]]="show"==f?l[0]:j;o[p[1]]="show"==f?l[1]:0;k.animate(g,b,c.options.easing).animate(o,b,c.options.easing,function(){"hide"==f&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
(function(a){a.effects.highlight=function(c){return this.queue(function(){var d=a(this),e=["backgroundImage","backgroundColor","opacity"],f=a.effects.setMode(d,c.options.mode||"show"),j={backgroundColor:d.css("backgroundColor")};"hide"==f&&(j.opacity=0);a.effects.save(d,e);d.show().css({backgroundImage:"none",backgroundColor:c.options.color||"#ffff99"}).animate(j,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){f=="hide"&&d.hide();a.effects.restore(d,e);f=="show"&&!a.support.opacity&&
this.style.removeAttribute("filter");c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.pulsate=function(c){return this.queue(function(){var d=a(this),e=a.effects.setMode(d,c.options.mode||"show"),f=2*(c.options.times||5)-1,j=c.duration?c.duration/2:a.fx.speeds._default/2,g=d.is(":visible"),b=0;g||(d.css("opacity",0).show(),b=1);("hide"==e&&g||"show"==e&&!g)&&f--;for(e=0;e<f;e++)d.animate({opacity:b},j,c.options.easing),b=(b+1)%2;d.animate({opacity:b},j,c.options.easing,function(){b==0&&d.hide();c.callback&&c.callback.apply(this,arguments)});d.queue("fx",function(){d.dequeue()}).dequeue()})}})(jQuery);
(function(a){a.effects.puff=function(c){return this.queue(function(){var d=a(this),e=a.effects.setMode(d,c.options.mode||"hide"),f=parseInt(c.options.percent,10)||150,j=f/100,g={height:d.height(),width:d.width()};a.extend(c.options,{fade:!0,mode:e,percent:"hide"==e?f:100,from:"hide"==e?g:{height:g.height*j,width:g.width*j}});d.effect("scale",c.options,c.duration,c.callback);d.dequeue()})};a.effects.scale=function(c){return this.queue(function(){var d=a(this),e=a.extend(!0,{},c.options),f=a.effects.setMode(d,
c.options.mode||"effect"),j=parseInt(c.options.percent,10)||(0==parseInt(c.options.percent,10)?0:"hide"==f?0:100),g=c.options.direction||"both",b=c.options.origin;"effect"!=f&&(e.origin=b||["middle","center"],e.restore=!0);b={height:d.height(),width:d.width()};d.from=c.options.from||("show"==f?{height:0,width:0}:b);d.to={height:b.height*("horizontal"!=g?j/100:1),width:b.width*("vertical"!=g?j/100:1)};if(c.options.fade&&("show"==f&&(d.from.opacity=0,d.to.opacity=1),"hide"==f))d.from.opacity=1,d.to.opacity=
0;e.from=d.from;e.to=d.to;e.mode=f;d.effect("size",e,c.duration,c.callback);d.dequeue()})};a.effects.size=function(c){return this.queue(function(){var d=a(this),e="position,top,bottom,left,right,width,height,overflow,opacity".split(","),f="position,top,bottom,left,right,overflow,opacity".split(","),j=["width","height","overflow"],g=["fontSize"],b=["borderTopWidth","borderBottomWidth","paddingTop","paddingBottom"],k=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"],l=a.effects.setMode(d,
c.options.mode||"effect"),p=c.options.restore||!1,o=c.options.scale||"both",m=c.options.origin,t={height:d.height(),width:d.width()};d.from=c.options.from||t;d.to=c.options.to||t;m&&(m=a.effects.getBaseline(m,t),d.from.top=(t.height-d.from.height)*m.y,d.from.left=(t.width-d.from.width)*m.x,d.to.top=(t.height-d.to.height)*m.y,d.to.left=(t.width-d.to.width)*m.x);var r=d.from.height/t.height,q=d.from.width/t.width,s=d.to.height/t.height,x=d.to.width/t.width;if("box"==o||"both"==o)if(r!=s&&(e=e.concat(b),
d.from=a.effects.setTransition(d,b,r,d.from),d.to=a.effects.setTransition(d,b,s,d.to)),q!=x)e=e.concat(k),d.from=a.effects.setTransition(d,k,q,d.from),d.to=a.effects.setTransition(d,k,x,d.to);if(("content"==o||"both"==o)&&r!=s)e=e.concat(g),d.from=a.effects.setTransition(d,g,r,d.from),d.to=a.effects.setTransition(d,g,s,d.to);a.effects.save(d,p?e:f);d.show();a.effects.createWrapper(d);d.css("overflow","hidden").css(d.from);if("content"==o||"both"==o)b=b.concat(["marginTop","marginBottom"]).concat(g),
k=k.concat(["marginLeft","marginRight"]),j=e.concat(b).concat(k),d.find("*[width]").each(function(){var d=a(this);p&&a.effects.save(d,j);var e=d.height(),f=d.width();d.from={height:e*r,width:f*q};d.to={height:e*s,width:f*x};if(r!=s){d.from=a.effects.setTransition(d,b,r,d.from);d.to=a.effects.setTransition(d,b,s,d.to)}if(q!=x){d.from=a.effects.setTransition(d,k,q,d.from);d.to=a.effects.setTransition(d,k,x,d.to)}d.css(d.from);d.animate(d.to,c.duration,c.options.easing,function(){p&&a.effects.restore(d,
j)})});d.animate(d.to,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){d.to.opacity===0&&d.css("opacity",d.from.opacity);l=="hide"&&d.hide();a.effects.restore(d,p?e:f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.shake=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"];a.effects.setMode(d,c.options.mode||"effect");var f=c.options.direction||"left",j=c.options.distance||20,g=c.options.times||3,b=c.duration||c.options.duration||140;a.effects.save(d,e);d.show();a.effects.createWrapper(d);var k="up"==f||"down"==f?"top":"left",l="up"==f||"left"==f?"pos":"neg",f={},p={},o={};f[k]=("pos"==l?"-=":"+=")+j;p[k]=("pos"==l?"+=":"-=")+2*j;o[k]=("pos"==
l?"-=":"+=")+2*j;d.animate(f,b,c.options.easing);for(j=1;j<g;j++)d.animate(p,b,c.options.easing).animate(o,b,c.options.easing);d.animate(p,b,c.options.easing).animate(f,b/2,c.options.easing,function(){a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)});d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(jQuery);
(function(a){a.effects.slide=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],f=a.effects.setMode(d,c.options.mode||"show"),j=c.options.direction||"left";a.effects.save(d,e);d.show();a.effects.createWrapper(d).css({overflow:"hidden"});var g="up"==j||"down"==j?"top":"left",j="up"==j||"left"==j?"pos":"neg",b=c.options.distance||("top"==g?d.outerHeight({margin:!0}):d.outerWidth({margin:!0}));"show"==f&&d.css(g,"pos"==j?isNaN(b)?"-"+b:-b:b);var k={};
k[g]=("show"==f?"pos"==j?"+=":"-=":"pos"==j?"-=":"+=")+b;d.animate(k,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){"hide"==f&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.transfer=function(c){return this.queue(function(){var d=a(this),e=a(c.options.to),f=e.offset(),e={top:f.top,left:f.left,height:e.innerHeight(),width:e.innerWidth()},f=d.offset(),j=a('<div class="ui-effects-transfer"></div>').appendTo(document.body).addClass(c.options.className).css({top:f.top,left:f.left,height:d.innerHeight(),width:d.innerWidth(),position:"absolute"}).animate(e,c.duration,c.options.easing,function(){j.remove();c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
...
d&&this._createIcons());if("disabled"==c)this.headers.add(this.headers.next())[d?"addClass":"removeClass"]("ui-accordion-disabled ui-state-disabled")},_keydown:function(c){if(!this.options.disabled&&!c.altKey&&!c.ctrlKey){var d=a.ui.keyCode,e=this.headers.length,f=this.headers.index(c.target),j=!1;switch(c.keyCode){case d.RIGHT:case d.DOWN:j=this.headers[(f+1)%e];break;case d.LEFT:case d.UP:j=this.headers[(f-1+e)%e];break;case d.SPACE:case d.ENTER:this._clickHandler({target:c.target},c.target),c.preventDefault()}return j?
(a(c.target).attr("tabIndex",-1),a(j).attr("tabIndex",0),j.focus(),!1):!0}},resize:function(){var c=this.options,d;if(c.fillSpace){if(a.browser.msie){var e=this.element.parent().css("overflow");this.element.parent().css("overflow","hidden")}d=this.element.parent().height();a.browser.msie&&this.element.parent().css("overflow",e);this.headers.each(function(){d-=a(this).outerHeight(!0)});this.headers.next().each(function(){a(this).height(Math.max(0,d-a(this).innerHeight()+a(this).height()))}).css("overflow",
...
d),j=f[0]===this.active[0];e.active=e.collapsible&&j?!1:this.headers.index(f);if(!(this.running||!e.collapsible&&j)){var g=this.active,b=f.next(),k=this.active.next(),l={options:e,newHeader:j&&e.collapsible?a([]):f,oldHeader:this.active,newContent:j&&e.collapsible?a([]):b,oldContent:k},p=this.headers.index(this.active[0])>this.headers.index(f[0]);this.active=j?a([]):f;this._toggle(b,k,l,j,p);g.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").children(".ui-icon").removeClass(e.icons.headerSelected).addClass(e.icons.header);
j||(f.removeClass("ui-state-default ui-corner-all").addClass("ui-state-active ui-corner-top").children(".ui-icon").removeClass(e.icons.header).addClass(e.icons.headerSelected),f.next().addClass("ui-accordion-content-active"))}}else if(e.collapsible){this.active.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").children(".ui-icon").removeClass(e.icons.headerSelected).addClass(e.icons.header);this.active.next().addClass("ui-accordion-content-active");var k=this.active.next(),
l={options:e,newHeader:a([]),oldHeader:e.active,newContent:a([]),oldContent:k},b=this.active=a([]);this._toggle(b,k,l)}},_toggle:function(c,d,e,f,j){var g=this,b=g.options;g.toShow=c;g.toHide=d;g.data=e;var k=function(){return!g?void 0:g._completed.apply(g,arguments)};g._trigger("changestart",null,g.data);g.running=0===d.size()?c.size():d.size();if(b.animated){e={};e=b.collapsible&&f?{toShow:a([]),toHide:d,complete:k,down:j,autoHeight:b.autoHeight||b.fillSpace}:{toShow:c,toHide:d,complete:k,down:j,
autoHeight:b.autoHeight||b.fillSpace};b.proxied||(b.proxied=b.animated);b.proxiedDuration||(b.proxiedDuration=b.duration);b.animated=a.isFunction(b.proxied)?b.proxied(e):b.proxied;b.duration=a.isFunction(b.proxiedDuration)?b.proxiedDuration(e):b.proxiedDuration;var f=a.ui.accordion.animations,l=b.duration,p=b.animated;p&&!f[p]&&!a.easing[p]&&(p="slide");f[p]||(f[p]=function(a){this.slide(a,{easing:p,duration:l||700})});f[p](e)}else b.collapsible&&f?c.toggle():(d.hide(),c.show()),k(!0);d.prev().attr({"aria-expanded":"false",
...
animations:{slide:function(c,d){c=a.extend({easing:"swing",duration:300},c,d);if(c.toHide.size())if(c.toShow.size()){var e=c.toShow.css("overflow"),f=0,j={},g={},b,k=c.toShow;b=k[0].style.width;k.width(k.parent().width()-parseFloat(k.css("paddingLeft"))-parseFloat(k.css("paddingRight"))-(parseFloat(k.css("borderLeftWidth"))||0)-(parseFloat(k.css("borderRightWidth"))||0));a.each(["height","paddingTop","paddingBottom"],function(b,d){g[d]="hide";var e=(""+a.css(c.toShow[0],d)).match(/^([\d+-.]+)(.*)$/);
j[d]={value:e[1],unit:e[2]||"px"}});c.toShow.css({height:0,overflow:"hidden"}).show();c.toHide.filter(":hidden").each(c.complete).end().filter(":visible").animate(g,{step:function(a,b){"height"==b.prop&&(f=0===b.end-b.start?0:(b.now-b.start)/(b.end-b.start));c.toShow[0].style[b.prop]=f*j[b.prop].value+j[b.prop].unit},duration:c.duration,easing:c.easing,complete:function(){c.autoHeight||c.toShow.css("height","");c.toShow.css({width:b,overflow:e});c.complete()}})}else c.toHide.animate({height:"hide",
...
(function(a){var c=0;a.widget("ui.autocomplete",{options:{appendTo:"body",autoFocus:!1,delay:300,minLength:1,position:{my:"left top",at:"left bottom",collision:"none"},source:null},pending:0,_create:function(){var c=this,e=this.element[0].ownerDocument,f;this.isMultiLine=this.element.is("textarea");this.element.addClass("ui-autocomplete-input").attr("autocomplete","off").attr({role:"textbox","aria-autocomplete":"list","aria-haspopup":"true"}).bind("keydown.autocomplete",function(e){if(!c.options.disabled&&
!c.element.propAttr("readOnly")){f=!1;var g=a.ui.keyCode;switch(e.keyCode){case g.PAGE_UP:c._move("previousPage",e);break;case g.PAGE_DOWN:c._move("nextPage",e);break;case g.UP:c._keyEvent("previous",e);break;case g.DOWN:c._keyEvent("next",e);break;case g.ENTER:case g.NUMPAD_ENTER:c.menu.active&&(f=!0,e.preventDefault());case g.TAB:if(!c.menu.active)break;c.menu.select(e);break;case g.ESCAPE:c.element.val(c.term);c.close(e);break;default:clearTimeout(c.searching),c.searching=setTimeout(function(){c.term!=
c.element.val()&&(c.selectedItem=null,c.search(null,e))},c.options.delay)}}}).bind("keypress.autocomplete",function(a){f&&(f=!1,a.preventDefault())}).bind("focus.autocomplete",function(){c.options.disabled||(c.selectedItem=null,c.previous=c.element.val())}).bind("blur.autocomplete",function(a){c.options.disabled||(clearTimeout(c.searching),c.closing=setTimeout(function(){c.close(a);c._change(a)},150))});this._initSource();this.menu=a("<ul></ul>").addClass("ui-autocomplete").appendTo(a(this.options.appendTo||
...
k=c.previous;c.element[0]!==e.activeElement&&(c.element.focus(),c.previous=k,setTimeout(function(){c.previous=k;c.selectedItem=b},1));!1!==c._trigger("select",a,{item:b})&&c.element.val(b.value);c.term=c.element.val();c.close(a);c.selectedItem=b},blur:function(){c.menu.element.is(":visible")&&c.element.val()!==c.term&&c.element.val(c.term)}}).zIndex(this.element.zIndex()+1).css({top:0,left:0}).hide().data("menu");a.fn.bgiframe&&this.menu.element.bgiframe();c.beforeunloadHandler=function(){c.element.removeAttr("autocomplete")};
...
"body",this.element[0].ownerDocument)[0]);"disabled"===c&&e&&this.xhr&&this.xhr.abort()},_initSource:function(){var c=this,e,f;a.isArray(this.options.source)?(e=this.options.source,this.source=function(c,d){d(a.ui.autocomplete.filter(e,c.term))}):"string"===typeof this.options.source?(f=this.options.source,this.source=function(e,g){c.xhr&&c.xhr.abort();c.xhr=a.ajax({url:f,data:e,dataType:"json",success:function(a){g(a)},error:function(){g([])}})}):this.source=this.options.source},search:function(a,
c){a=null!=a?a:this.element.val();this.term=this.element.val();if(a.length<this.options.minLength)return this.close(c);clearTimeout(this.closing);return!1===this._trigger("search",c)?void 0:this._search(a)},_search:function(a){this.pending++;this.element.addClass("ui-autocomplete-loading");this.source({term:a},this._response())},_response:function(){var a=this,e=++c;return function(f){e===c&&a.__response(f);a.pending--;a.pending||a.element.removeClass("ui-autocomplete-loading")}},__response:function(a){!this.options.disabled&&
...
-1).mouseenter(function(d){c.activate(d,a(this).parent())}).mouseleave(function(){c.deactivate()})},activate:function(a,d){this.deactivate();if(this.hasScroll()){var e=d.offset().top-this.element.offset().top,f=this.element.scrollTop(),j=this.element.height();0>e?this.element.scrollTop(f+e):e>=j&&this.element.scrollTop(f+e-j+d.height())}this.active=d.eq(0).children("a").addClass("ui-state-hover").attr("id","ui-active-menuitem").end();this._trigger("focus",a,{item:d})},deactivate:function(){this.active&&
...
a):this.activate(e,this.element.children(d))):this.activate(e,this.element.children(d))},nextPage:function(c){if(this.hasScroll())if(!this.active||this.last())this.activate(c,this.element.children(".ui-menu-item:first"));else{var d=this.active.offset().top,e=this.element.height(),f=this.element.children(".ui-menu-item").filter(function(){var c=a(this).offset().top-d-e+a(this).height();return 10>c&&-10<c});f.length||(f=this.element.children(".ui-menu-item:last"));this.activate(c,f)}else this.activate(c,
this.element.children(".ui-menu-item").filter(!this.active||this.last()?":first":":last"))},previousPage:function(c){if(this.hasScroll())if(!this.active||this.first())this.activate(c,this.element.children(".ui-menu-item:last"));else{var d=this.active.offset().top,e=this.element.height(),f=this.element.children(".ui-menu-item").filter(function(){var c=a(this).offset().top-d+e-a(this).height();return 10>c&&-10<c});f.length||(f=this.element.children(".ui-menu-item:first"));this.activate(c,f)}else this.activate(c,
...
this===c&&a(this).addClass("ui-state-active")}}).bind("mouseleave.button",function(){k.disabled||a(this).removeClass(p)}).bind("click.button",function(a){if(k.disabled){a.preventDefault();a.stopImmediatePropagation()}});this.element.bind("focus.button",function(){b.buttonElement.addClass("ui-state-focus")}).bind("blur.button",function(){b.buttonElement.removeClass("ui-state-focus")});l&&(this.element.bind("change.button",function(){f||b.refresh()}),this.buttonElement.bind("mousedown.button",function(a){if(!k.disabled){f=
false;d=a.pageX;e=a.pageY}}).bind("mouseup.button",function(a){if(!k.disabled&&(d!==a.pageX||e!==a.pageY))f=true}));"checkbox"===this.type?this.buttonElement.bind("click.button",function(){if(k.disabled||f)return false;a(this).toggleClass("ui-state-active");b.buttonElement.attr("aria-pressed",b.element[0].checked)}):"radio"===this.type?this.buttonElement.bind("click.button",function(){if(k.disabled||f)return false;a(this).addClass("ui-state-active");b.buttonElement.attr("aria-pressed","true");var c=
b.element[0];g(c).not(c).map(function(){return a(this).button("widget")[0]}).removeClass("ui-state-active").attr("aria-pressed","false")}):(this.buttonElement.bind("mousedown.button",function(){if(k.disabled)return false;a(this).addClass("ui-state-active");c=this;a(document).one("mouseup",function(){c=null})}).bind("mouseup.button",function(){if(k.disabled)return false;a(this).removeClass("ui-state-active")}).bind("keydown.button",function(b){if(k.disabled)return false;(b.keyCode==a.ui.keyCode.SPACE||
...
b.length&&b.removeClass("ui-state-hover ui-datepicker-prev-hover ui-datepicker-next-hover")}).bind("mouseover",function(c){c=a(c.target).closest("button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a");if(!a.datepicker._isDisabledDatepicker(g.inline?b.parent()[0]:g.input[0])&&c.length)c.parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),c.addClass("ui-state-hover"),c.hasClass("ui-datepicker-prev")&&c.addClass("ui-datepicker-prev-hover"),c.hasClass("ui-datepicker-next")&&
c.addClass("ui-datepicker-next-hover")})}function f(b,d){a.extend(b,d);for(var e in d)if(null==d[e]||d[e]==c)b[e]=d[e];return b}a.extend(a.ui,{datepicker:{version:"1.8.20"}});var j=(new Date).getTime(),g;a.extend(d.prototype,{markerClassName:"hasDatepicker",maxRows:4,log:function(){this.debug&&console.log.apply("",arguments)},_widgetDatepicker:function(){return this.dpDiv},setDefaults:function(a){f(this._defaults,a||{});return this},_attachDatepicker:function(b,c){var d=null,e;for(e in this._defaults){var f=
b.getAttribute("date:"+e);if(f){d=d||{};try{d[e]=eval(f)}catch(g){d[e]=f}}}e=b.nodeName.toLowerCase();f="div"==e||"span"==e;b.id||(this.uuid+=1,b.id="dp"+this.uuid);var j=this._newInst(a(b),f);j.settings=a.extend({},c||{},d||{});"input"==e?this._connectDatepicker(b,j):f&&this._inlineDatepicker(b,j)},_newInst:function(b,c){return{id:b[0].id.replace(/([^A-Za-z0-9_-])/g,"\\\\$1"),input:b,selectedDay:0,selectedMonth:0,selectedYear:0,drawMonth:0,drawYear:0,inline:c,dpDiv:!c?this.dpDiv:e(a('<div class="'+
...
'" style="position: absolute; top: -100px; width: 0px; z-index: -10;"/>'),this._dialogInput.keydown(this._doKeyDown),a("body").append(this._dialogInput),b=this._dialogInst=this._newInst(this._dialogInput,!1),b.settings={},a.data(this._dialogInput[0],"datepicker",b));f(b.settings,e||{});c=c&&c.constructor==Date?this._formatDate(b,c):c;this._dialogInput.val(c);this._pos=g?g.length?g:[g.pageX,g.pageY]:null;this._pos||(this._pos=[document.documentElement.clientWidth/2-100+(document.documentElement.scrollLeft||
...
b}},_isDisabledDatepicker:function(a){if(!a)return!1;for(var c=0;c<this._disabledInputs.length;c++)if(this._disabledInputs[c]==a)return!0;return!1},_getInst:function(b){try{return a.data(b,"datepicker")}catch(c){throw"Missing instance data for this datepicker";}},_optionDatepicker:function(b,d,e){var g=this._getInst(b);if(2==arguments.length&&"string"==typeof d)return"defaults"==d?a.extend({},a.datepicker._defaults):g?"all"==d?a.extend({},g.settings):this._get(g,d):null;var j=d||{};"string"==typeof d&&
(j={},j[d]=e);if(g){this._curInst==g&&this._hideDatepicker();var m=this._getDateDatepicker(b,!0),t=this._getMinMaxDate(g,"min"),r=this._getMinMaxDate(g,"max");f(g.settings,j);null!==t&&j.dateFormat!==c&&j.minDate===c&&(g.settings.minDate=this._formatDate(g,t));null!==r&&j.dateFormat!==c&&j.maxDate===c&&(g.settings.maxDate=this._formatDate(g,r));this._attachments(a(b),g);this._autoSize(g);this._setDate(g,m);this._updateAlternate(g);this._updateDatepicker(g)}},_changeDatepicker:function(a,c,d){this._optionDatepicker(a,
...
a.datepicker._curInst&&a.datepicker._curInst!=c&&(a.datepicker._curInst.dpDiv.stop(!0,!0),c&&a.datepicker._datepickerShowing&&a.datepicker._hideDatepicker(a.datepicker._curInst.input[0]));var d=a.datepicker._get(c,"beforeShow"),d=d?d.apply(b,[b,c]):{};if(!1!==d){f(c.settings,d);c.lastVal=null;a.datepicker._lastInput=b;a.datepicker._setDateFromField(c);a.datepicker._inDialog&&(b.value="");a.datepicker._pos||(a.datepicker._pos=a.datepicker._findPos(b),a.datepicker._pos[1]+=b.offsetHeight);var e=!1;
...
e?"fixed":"absolute",display:"none",left:d.left+"px",top:d.top+"px"});if(!c.inline){var d=a.datepicker._get(c,"showAnim"),g=a.datepicker._get(c,"duration"),j=function(){var b=c.dpDiv.find("iframe.ui-datepicker-cover");if(b.length){var d=a.datepicker._getBorders(c.dpDiv);b.css({left:-d[0],top:-d[1],width:c.dpDiv.outerWidth(),height:c.dpDiv.outerHeight()})}};c.dpDiv.zIndex(a(b).zIndex()+1);a.datepicker._datepickerShowing=!0;if(a.effects&&a.effects[d])c.dpDiv.show(d,a.datepicker._get(c,"showOptions"),
g,j);else c.dpDiv[d||"show"](d?g:null,j);(!d||!g)&&j();c.input.is(":visible")&&!c.input.is(":disabled")&&c.input.focus();a.datepicker._curInst=c}}}},_updateDatepicker:function(b){this.maxRows=4;var c=a.datepicker._getBorders(b.dpDiv);g=b;b.dpDiv.empty().append(this._generateHTML(b));var d=b.dpDiv.find("iframe.ui-datepicker-cover");d.length&&d.css({left:-c[0],top:-c[1],width:b.dpDiv.outerWidth(),height:b.dpDiv.outerHeight()});b.dpDiv.find("."+this._dayOverClass+" a").mouseover();c=this._getNumberOfMonths(b);
...
b.yearshtml;setTimeout(function(){e===b.yearshtml&&b.yearshtml&&b.dpDiv.find("select.ui-datepicker-year:first").replaceWith(b.yearshtml);e=b.yearshtml=null},0)}},_getBorders:function(a){var c=function(a){return{thin:1,medium:2,thick:3}[a]||a};return[parseFloat(c(a.css("border-left-width"))),parseFloat(c(a.css("border-top-width")))]},_checkOffset:function(b,c,d){var e=b.dpDiv.outerWidth(),f=b.dpDiv.outerHeight(),g=b.input?b.input.outerWidth():0,j=b.input?b.input.outerHeight():0,r=document.documentElement.clientWidth+
a(document).scrollLeft(),q=document.documentElement.clientHeight+a(document).scrollTop();c.left-=this._get(b,"isRTL")?e-g:0;c.left-=d&&c.left==b.input.offset().left?a(document).scrollLeft():0;c.top-=d&&c.top==b.input.offset().top+j?a(document).scrollTop():0;c.left-=Math.min(c.left,c.left+e>r&&r>e?Math.abs(c.left+e-r):0);c.top-=Math.min(c.top,c.top+f>q&&q>f?Math.abs(f+j):0);return c},_findPos:function(b){for(var c=this._get(this._getInst(b),"isRTL");b&&("hidden"==b.type||1!=b.nodeType||a.expr.filters.hidden(b));)b=
...
e="string"!=typeof e?e:(new Date).getFullYear()%100+parseInt(e,10),f=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,g=(d?d.dayNames:null)||this._defaults.dayNames,j=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,r=(d?d.monthNames:null)||this._defaults.monthNames,q=d=-1,s=-1,x=-1,v=!1,y=function(a){(a=J+1<b.length&&b.charAt(J+1)==a)&&J++;return a},E=function(a){var b=y(a),a=c.substring(F).match(RegExp("^\\d{1,"+("@"==a?14:"!"==a?20:"y"==a&&b?4:"o"==a?3:2)+"}"));if(!a)throw"Missing number at position "+
F;F+=a[0].length;return parseInt(a[0],10)},z=function(b,d,e){var b=a.map(y(b)?e:d,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)}),f=-1;a.each(b,function(a,b){var d=b[1];if(c.substr(F,d.length).toLowerCase()==d.toLowerCase())return f=b[0],F+=d.length,!1});if(-1!=f)return f+1;throw"Unknown name at position "+F;},A=function(){if(c.charAt(F)!=b.charAt(J))throw"Unexpected literal at position "+F;F++},F=0,J=0;J<b.length;J++)if(v)"'"==b.charAt(J)&&!y("'")?v=!1:A();else switch(b.charAt(J)){case "d":s=
E("d");break;case "D":z("D",f,g);break;case "o":x=E("o");break;case "m":q=E("m");break;case "M":q=z("M",j,r);break;case "y":d=E("y");break;case "@":var D=new Date(E("@")),d=D.getFullYear(),q=D.getMonth()+1,s=D.getDate();break;case "!":D=new Date((E("!")-this._ticksTo1970)/1E4);d=D.getFullYear();q=D.getMonth()+1;s=D.getDate();break;case "'":y("'")?A():v=!0;break;default:A()}if(F<c.length)throw"Extra/unparsed characters found in date: "+c.substring(F);-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-
(new Date).getFullYear()%100+(d<=e?0:-100));if(-1<x){q=1;s=x;do{e=this._getDaysInMonth(d,q-1);if(s<=e)break;q++;s-=e}while(1)}D=this._daylightSavingAdjust(new Date(d,q-1,s));if(D.getFullYear()!=d||D.getMonth()+1!=q||D.getDate()!=s)throw"Invalid date";return D},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:864E9*(718685+Math.floor(492.5)-
Math.floor(19.7)+Math.floor(4.925)),formatDate:function(a,c,d){if(!c)return"";var e=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,f=(d?d.dayNames:null)||this._defaults.dayNames,g=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,d=(d?d.monthNames:null)||this._defaults.monthNames,j=function(c){(c=v+1<a.length&&a.charAt(v+1)==c)&&v++;return c},r=function(a,b,c){b=""+b;if(j(a))for(;b.length<c;)b="0"+b;return b},q=function(a,b,c,d){return j(a)?d[b]:c[b]},s="",x=!1;if(c)for(var v=0;v<
a.length;v++)if(x)"'"==a.charAt(v)&&!j("'")?x=!1:s+=a.charAt(v);else switch(a.charAt(v)){case "d":s+=r("d",c.getDate(),2);break;case "D":s+=q("D",c.getDay(),e,f);break;case "o":s+=r("o",Math.round(((new Date(c.getFullYear(),c.getMonth(),c.getDate())).getTime()-(new Date(c.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":s+=r("m",c.getMonth()+1,2);break;case "M":s+=q("M",c.getMonth(),g,d);break;case "y":s+=j("y")?c.getFullYear():(10>c.getYear()%100?"0":"")+c.getYear()%100;break;case "@":s+=
c.getTime();break;case "!":s+=1E4*c.getTime()+this._ticksTo1970;break;case "'":j("'")?s+="'":x=!0;break;default:s+=a.charAt(v)}return s},_possibleChars:function(a){for(var c="",d=!1,e=function(c){(c=f+1<a.length&&a.charAt(f+1)==c)&&f++;return c},f=0;f<a.length;f++)if(d)"'"==a.charAt(f)&&!e("'")?d=!1:c+=a.charAt(f);else switch(a.charAt(f)){case "d":case "m":case "y":case "@":c+="0123456789";break;case "D":case "M":return null;case "'":e("'")?c+="'":d=!0;break;default:c+=a.charAt(f)}return c},_get:function(a,
d){return a.settings[d]!==c?a.settings[d]:this._defaults[d]},_setDateFromField:function(a,c){if(a.input.val()!=a.lastVal){var d=this._get(a,"dateFormat"),e=a.lastVal=a.input?a.input.val():null,f,g;f=g=this._getDefaultDate(a);var j=this._getFormatConfig(a);try{f=this.parseDate(d,e,j)||g}catch(r){this.log(r),e=c?"":e}a.selectedDay=f.getDate();a.drawMonth=a.selectedMonth=f.getMonth();a.drawYear=a.selectedYear=f.getFullYear();a.currentDay=e?f.getDate():0;a.currentMonth=e?f.getMonth():0;a.currentYear=
...
new Date,f=e.getFullYear(),g=e.getMonth(),e=e.getDate(),j=/([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g,k=j.exec(c);k;){switch(k[2]||"d"){case "d":case "D":e+=parseInt(k[1],10);break;case "w":case "W":e+=7*parseInt(k[1],10);break;case "m":case "M":g+=parseInt(k[1],10);e=Math.min(e,a.datepicker._getDaysInMonth(f,g));break;case "y":case "Y":f+=parseInt(k[1],10),e=Math.min(e,a.datepicker._getDaysInMonth(f,g))}k=j.exec(c)}return new Date(f,g,e)}(c):"number"==typeof c?isNaN(c)?d:e(c):new Date(c.getTime()))&&"Invalid Date"==
...
g=this._get(b,"navigationAsDateFormat"),t=this._getNumberOfMonths(b),r=this._get(b,"showCurrentAtPos"),q=this._get(b,"stepMonths"),s=1!=t[0]||1!=t[1],x=this._daylightSavingAdjust(!b.currentDay?new Date(9999,9,9):new Date(b.currentYear,b.currentMonth,b.currentDay)),v=this._getMinMaxDate(b,"min"),y=this._getMinMaxDate(b,"max"),r=b.drawMonth-r,E=b.drawYear;0>r&&(r+=12,E--);if(y)for(var z=this._daylightSavingAdjust(new Date(y.getFullYear(),y.getMonth()-t[0]*t[1]+1,y.getDate())),z=v&&z<v?v:z;this._daylightSavingAdjust(new Date(E,
r,1))>z;)r--,0>r&&(r=11,E--);b.drawMonth=r;b.drawYear=E;var z=this._get(b,"prevText"),z=!g?z:this.formatDate(z,this._daylightSavingAdjust(new Date(E,r-q,1)),this._getFormatConfig(b)),z=this._canAdjustMonth(b,-1,E,r)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+j+".datepicker._adjustDate('#"+b.id+"', -"+q+", 'M');\" title=\""+z+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+z+"</span></a>":f?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+
z+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+z+"</span></a>",A=this._get(b,"nextText"),A=!g?A:this.formatDate(A,this._daylightSavingAdjust(new Date(E,r+q,1)),this._getFormatConfig(b)),f=this._canAdjustMonth(b,1,E,r)?'<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'+j+".datepicker._adjustDate('#"+b.id+"', +"+q+", 'M');\" title=\""+A+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+A+"</span></a>":f?"":'<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+
A+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+A+"</span></a>",q=this._get(b,"currentText"),A=this._get(b,"gotoCurrent")&&b.currentDay?x:c,q=!g?q:this.formatDate(q,A,this._getFormatConfig(b)),g=!b.inline?'<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_'+j+'.datepicker._hideDatepicker();">'+this._get(b,"closeText")+"</button>":"",e=e?'<div class="ui-datepicker-buttonpane ui-widget-content">'+(d?g:"")+(this._isInRange(b,
A)?'<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_'+j+".datepicker._gotoToday('#"+b.id+"');\">"+q+"</button>":"")+(d?"":g)+"</div>":"",g=parseInt(this._get(b,"firstDay"),10),g=isNaN(g)?0:g,q=this._get(b,"showWeek"),A=this._get(b,"dayNames");this._get(b,"dayNamesShort");var F=this._get(b,"dayNamesMin"),J=this._get(b,"monthNames"),D=this._get(b,"monthNamesShort"),u=this._get(b,"beforeShowDay"),I=this._get(b,"showOtherMonths"),
M=this._get(b,"selectOtherMonths");this._get(b,"calculateWeek");for(var h=this._getDefaultDate(b),P="",O=0;O<t[0];O++){var R="";this.maxRows=4;for(var i=0;i<t[1];i++){var n=this._daylightSavingAdjust(new Date(E,r,b.selectedDay)),w=" ui-corner-all",C="";if(s){C+='<div class="ui-datepicker-group';if(1<t[1])switch(i){case 0:C+=" ui-datepicker-group-first";w=" ui-corner-"+(d?"right":"left");break;case t[1]-1:C+=" ui-datepicker-group-last";w=" ui-corner-"+(d?"left":"right");break;default:C+=" ui-datepicker-group-middle",
w=""}C+='">'}for(var C=C+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+w+'">'+(/all|left/.test(w)&&0==O?d?f:z:"")+(/all|right/.test(w)&&0==O?d?z:f:"")+this._generateMonthYearHeader(b,r,E,v,y,0<O||0<i,J,D)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),H=q?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":"",w=0;7>w;w++)var G=(w+g)%7,H=H+("<th"+(5<=(w+g+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+A[G]+'">'+F[G]+"</span></th>");
C+=H+"</tr></thead><tbody>";H=this._getDaysInMonth(E,r);E==b.selectedYear&&r==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,H));w=(this._getFirstDayOfMonth(E,r)-g+7)%7;H=Math.ceil((w+H)/7);this.maxRows=H=s?this.maxRows>H?this.maxRows:H:H;for(var G=this._daylightSavingAdjust(new Date(E,r,1-w)),L=0;L<H;L++){for(var C=C+"<tr>",S=!q?"":'<td class="ui-datepicker-week-col">'+this._get(b,"calculateWeek")(G)+"</td>",w=0;7>w;w++){var N=u?u.apply(b.input?b.input[0]:null,[G]):[!0,""],K=G.getMonth()!=
r,W=K&&!M||!N[0]||v&&G<v||y&&G>y,S=S+('<td class="'+(5<=(w+g+6)%7?" ui-datepicker-week-end":"")+(K?" ui-datepicker-other-month":"")+(G.getTime()==n.getTime()&&r==b.selectedMonth&&b._keyEvent||h.getTime()==G.getTime()&&h.getTime()==n.getTime()?" "+this._dayOverClass:"")+(W?" "+this._unselectableClass+" ui-state-disabled":"")+(K&&!I?"":" "+N[1]+(G.getTime()==x.getTime()?" "+this._currentClass:"")+(G.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!K||I)&&N[2]?' title="'+N[2]+'"':"")+(W?"":
' onclick="DP_jQuery_'+j+".datepicker._selectDay('#"+b.id+"',"+G.getMonth()+","+G.getFullYear()+', this);return false;"')+">"+(K&&!I?"&#xa0;":W?'<span class="ui-state-default">'+G.getDate()+"</span>":'<a class="ui-state-default'+(G.getTime()==c.getTime()?" ui-state-highlight":"")+(G.getTime()==x.getTime()?" ui-state-active":"")+(K?" ui-priority-secondary":"")+'" href="#">'+G.getDate()+"</a>")+"</td>");G.setDate(G.getDate()+1);G=this._daylightSavingAdjust(G)}C+=S+"</tr>"}r++;11<r&&(r=0,E++);C+="</tbody></table>"+
(s?"</div>"+(0<t[0]&&i==t[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");R+=C}P+=R}P+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return P},_generateMonthYearHeader:function(a,c,d,e,f,g,t,r){var q=this._get(a,"changeMonth"),s=this._get(a,"changeYear"),x=this._get(a,"showMonthAfterYear"),v='<div class="ui-datepicker-title">',y="";if(g||!q)y+='<span class="ui-datepicker-month">'+
t[c]+"</span>";else{for(var t=e&&e.getFullYear()==d,E=f&&f.getFullYear()==d,y=y+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+j+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),z=0;12>z;z++)if((!t||z>=e.getMonth())&&(!E||z<=f.getMonth()))y+='<option value="'+z+'"'+(z==c?' selected="selected"':"")+">"+r[z]+"</option>";y+="</select>"}x||(v+=y+(g||!q||!s?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",g||!s)v+='<span class="ui-datepicker-year">'+d+"</span>";else{var r=this._get(a,
"yearRange").split(":"),A=(new Date).getFullYear(),t=function(a){a=a.match(/c[+-].*/)?d+parseInt(a.substring(1),10):a.match(/[+-].*/)?A+parseInt(a,10):parseInt(a,10);return isNaN(a)?A:a},c=t(r[0]),r=Math.max(c,t(r[1]||"")),c=e?Math.max(c,e.getFullYear()):c,r=f?Math.min(r,f.getFullYear()):r;for(a.yearshtml+='<select class="ui-datepicker-year" onchange="DP_jQuery_'+j+".datepicker._selectMonthYear('#"+a.id+"', this, 'Y');\" >";c<=r;c++)a.yearshtml+='<option value="'+c+'"'+(c==d?' selected="selected"':
"")+">"+c+"</option>";a.yearshtml+="</select>";v+=a.yearshtml;a.yearshtml=null}v+=this._get(a,"yearSuffix");x&&(v+=(g||!q||!s?"&#xa0;":"")+y);return v+"</div>"},_adjustInstDate:function(a,c,d){var e=a.drawYear+("Y"==d?c:0),f=a.drawMonth+("M"==d?c:0),c=Math.min(a.selectedDay,this._getDaysInMonth(e,f))+("D"==d?c:0),e=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(e,f,c)));a.selectedDay=e.getDate();a.drawMonth=a.selectedMonth=e.getMonth();a.drawYear=a.selectedYear=e.getFullYear();("M"==d||
...
null!==c&&a.each(c,function(){return!(b=!0)});b&&(a.each(c,function(b,c){var c=a.isFunction(c)?{click:c,text:b}:c,e=a('<button type="button"></button>').click(function(){c.click.apply(d.element[0],arguments)}).appendTo(l);a.each(c,function(a,b){if("click"!==a)if(a in f)e[a](b);else e.attr(a,b)});a.fn.button&&e.button()}),e.appendTo(d.uiDialog))},_makeDraggable:function(){function c(a){return{position:a.position,offset:a.offset}}var d=this,b=d.options,e=a(document),f;d.uiDialog.draggable({cancel:".ui-dialog-content, .ui-dialog-titlebar-close",
handle:".ui-dialog-titlebar",containment:"document",start:function(e,k){f="auto"===b.height?"auto":a(this).height();a(this).height(a(this).height()).addClass("ui-dialog-dragging");d._trigger("dragStart",e,c(k))},drag:function(a,b){d._trigger("drag",a,c(b))},stop:function(p,o){b.position=[o.position.left-e.scrollLeft(),o.position.top-e.scrollTop()];a(this).removeClass("ui-dialog-dragging").height(f);d._trigger("dragStop",p,c(o));a.ui.dialog.overlay.resize()}})},_makeResizable:function(d){function e(a){return{originalPosition:a.originalPosition,
...
(function(a){a.ui=a.ui||{};var c=/left|center|right/,d=/top|center|bottom/,e,f=a.fn.position,j=a.fn.offset;a.fn.position=function(g){if(!g||!g.of)return f.apply(this,arguments);var g=a.extend({},g),b=a(g.of),j=b[0],l=(g.collision||"flip").split(" "),p=g.offset?g.offset.split(" "):[0,0],o,m,t;9===j.nodeType?(o=b.width(),m=b.height(),t={top:0,left:0}):j.setTimeout?(o=b.width(),m=b.height(),t={top:b.scrollTop(),left:b.scrollLeft()}):j.preventDefault?(g.at="left top",o=m=0,t={top:g.of.pageY,left:g.of.pageX}):
(o=b.outerWidth(),m=b.outerHeight(),t=b.offset());a.each(["my","at"],function(){var a=(g[this]||"").split(" ");a.length===1&&(a=c.test(a[0])?a.concat(["center"]):d.test(a[0])?["center"].concat(a):["center","center"]);a[0]=c.test(a[0])?a[0]:"center";a[1]=d.test(a[1])?a[1]:"center";g[this]=a});1===l.length&&(l[1]=l[0]);p[0]=parseInt(p[0],10)||0;1===p.length&&(p[1]=p[0]);p[1]=parseInt(p[1],10)||0;"right"===g.at[0]?t.left+=o:"center"===g.at[0]&&(t.left+=o/2);"bottom"===g.at[1]?t.top+=m:"center"===g.at[1]&&
(t.top+=m/2);t.left+=p[0];t.top+=p[1];return this.each(function(){var b=a(this),c=b.outerWidth(),d=b.outerHeight(),f=parseInt(a.curCSS(this,"marginLeft",true))||0,j=parseInt(a.curCSS(this,"marginTop",true))||0,k=c+f+(parseInt(a.curCSS(this,"marginRight",true))||0),E=d+j+(parseInt(a.curCSS(this,"marginBottom",true))||0),z=a.extend({},t),A;if(g.my[0]==="right")z.left=z.left-c;else if(g.my[0]==="center")z.left=z.left-c/2;if(g.my[1]==="bottom")z.top=z.top-d;else if(g.my[1]==="center")z.top=z.top-d/2;
if(!e){z.left=Math.round(z.left);z.top=Math.round(z.top)}A={left:z.left-f,top:z.top-j};a.each(["left","top"],function(b,e){if(a.ui.position[l[b]])a.ui.position[l[b]][e](z,{targetWidth:o,targetHeight:m,elemWidth:c,elemHeight:d,collisionPosition:A,collisionWidth:k,collisionHeight:E,offset:p,my:g.my,at:g.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(z,{using:g.using}))})};a.ui.position={fit:{left:function(c,b){var d=a(window),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft();
c.left=0<d?c.left-d:Math.max(c.left-b.collisionPosition.left,c.left)},top:function(c,b){var d=a(window),d=b.collisionPosition.top+b.collisionHeight-d.height()-d.scrollTop();c.top=0<d?c.top-d:Math.max(c.top-b.collisionPosition.top,c.top)}},flip:{left:function(c,b){if("center"!==b.at[0]){var d=a(window),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft(),e="left"===b.my[0]?-b.elemWidth:"right"===b.my[0]?b.elemWidth:0,f="left"===b.at[0]?b.targetWidth:-b.targetWidth,j=-2*b.offset[0];
c.left+=0>b.collisionPosition.left?e+f+j:0<d?e+f+j:0}},top:function(c,b){if("center"!==b.at[1]){var d=a(window),d=b.collisionPosition.top+b.collisionHeight-d.height()-d.scrollTop(),e="top"===b.my[1]?-b.elemHeight:"bottom"===b.my[1]?b.elemHeight:0,f="top"===b.at[1]?b.targetHeight:-b.targetHeight,j=-2*b.offset[1];c.top+=0>b.collisionPosition.top?e+f+j:0<d?e+f+j:0}}}};a.offset.setOffset||(a.offset.setOffset=function(c,b){/static/.test(a.curCSS(c,"position"))&&(c.style.position="relative");var d=a(c),
e=d.offset(),f=parseInt(a.curCSS(c,"top",!0),10)||0,j=parseInt(a.curCSS(c,"left",!0),10)||0,e={top:b.top-e.top+f,left:b.left-e.left+j};"using"in b?b.using.call(c,e):d.css(e)},a.fn.offset=function(c){var b=this[0];return!b||!b.ownerDocument?null:c?this.each(function(){a.offset.setOffset(this,c)}):j.call(this)});(function(){var c=document.getElementsByTagName("body")[0],b=document.createElement("div"),d,f;d=document.createElement(c?"div":"body");f={visibility:"hidden",width:0,height:0,border:0,margin:0,
background:"none"};c&&a.extend(f,{position:"absolute",left:"-1000px",top:"-1000px"});for(var j in f)d.style[j]=f[j];d.appendChild(b);f=c||document.documentElement;f.insertBefore(d,f.firstChild);b.style.cssText="position: absolute; left: 10.7432222px; top: 10.432325px; height: 30px; width: 201px;";b=a(b).offset(function(a,b){return b}).offset();d.innerHTML="";f.removeChild(d);c=b.top+b.left+(c?2E3:0);e=c>21&&c<22})()})(jQuery);
...
(function(a){a.widget("ui.slider",a.ui.mouse,{widgetEventPrefix:"slide",options:{animate:!1,distance:0,max:100,min:0,orientation:"horizontal",range:!1,step:1,value:0,values:null},_create:function(){var c=this,d=this.options,e=this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"),f=d.values&&d.values.length||1,j=[];this._mouseSliding=this._keySliding=!1;this._animateOff=!0;this._handleIndex=null;this._detectOrientation();this._mouseInit();this.element.addClass("ui-slider ui-slider-"+
this.orientation+" ui-widget ui-widget-content ui-corner-all"+(d.disabled?" ui-slider-disabled ui-disabled":""));this.range=a([]);if(d.range){if(!0===d.range&&(d.values||(d.values=[this._valueMin(),this._valueMin()]),d.values.length&&2!==d.values.length))d.values=[d.values[0],d.values[0]];this.range=a("<div></div>").appendTo(this.element).addClass("ui-slider-range ui-widget-header"+("min"===d.range||"max"===d.range?" ui-slider-range-"+d.range:""))}for(var g=e.length;g<f;g+=1)j.push("<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'></a>");
this.handles=e.add(a(j.join("")).appendTo(c.element));this.handle=this.handles.eq(0);this.handles.add(this.range).filter("a").click(function(a){a.preventDefault()}).hover(function(){d.disabled||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}).focus(function(){d.disabled?a(this).blur():(a(".ui-slider .ui-state-focus").removeClass("ui-state-focus"),a(this).addClass("ui-state-focus"))}).blur(function(){a(this).removeClass("ui-state-focus")});this.handles.each(function(b){a(this).data("index.ui-slider-handle",
...
_mouseCapture:function(c){var d=this.options,e,f,j,g,b;if(d.disabled)return!1;this.elementSize={width:this.element.outerWidth(),height:this.element.outerHeight()};this.elementOffset=this.element.offset();e=this._normValueFromMouse({x:c.pageX,y:c.pageY});f=this._valueMax()-this._valueMin()+1;g=this;this.handles.each(function(c){var d=Math.abs(e-g.values(c));f>d&&(f=d,j=a(this),b=c)});!0===d.range&&this.values(1)===d.min&&(b+=1,j=a(this.handles[b]));if(!1===this._start(c,b))return!1;this._mouseSliding=
!0;g._handleIndex=b;j.addClass("ui-state-active").focus();d=j.offset();this._clickOffset=!a(c.target).parents().andSelf().is(".ui-slider-handle")?{left:0,top:0}:{left:c.pageX-d.left-j.width()/2,top:c.pageY-d.top-j.height()/2-(parseInt(j.css("borderTopWidth"),10)||0)-(parseInt(j.css("borderBottomWidth"),10)||0)+(parseInt(j.css("marginTop"),10)||0)};this.handles.hasClass("ui-state-hover")||this._slide(c,b,e);return this._animateOff=!0},_mouseStart:function(){return!0},_mouseDrag:function(a){var d=this._normValueFromMouse({x:a.pageX,
...
0);else return this._value()},values:function(c,d){var e,f,j;if(1<arguments.length)this.options.values[c]=this._trimAlignValue(d),this._refreshValue(),this._change(null,c);else if(arguments.length)if(a.isArray(arguments[0])){e=this.options.values;f=arguments[0];for(j=0;j<e.length;j+=1)e[j]=this._trimAlignValue(f[j]),this._change(null,j);this._refreshValue()}else return this.options.values&&this.options.values.length?this._values(c):this.value();else return this._values()},_setOption:function(c,d){var e,
...
this._trimAlignValue(d[e]);return d},_trimAlignValue:function(a){if(a<=this._valueMin())return this._valueMin();if(a>=this._valueMax())return this._valueMax();var d=0<this.options.step?this.options.step:1,e=(a-this._valueMin())%d,a=a-e;2*Math.abs(e)>=d&&(a+=0<e?d:-d);return parseFloat(a.toFixed(5))},_valueMin:function(){return this.options.min},_valueMax:function(){return this.options.max},_refreshValue:function(){var c=this.options.range,d=this.options,e=this,f=!this._animateOff?d.animate:!1,j,g=
{},b,k,l,p;if(this.options.values&&this.options.values.length)this.handles.each(function(c){j=100*((e.values(c)-e._valueMin())/(e._valueMax()-e._valueMin()));g["horizontal"===e.orientation?"left":"bottom"]=j+"%";a(this).stop(1,1)[f?"animate":"css"](g,d.animate);if(!0===e.options.range)if("horizontal"===e.orientation){if(0===c)e.range.stop(1,1)[f?"animate":"css"]({left:j+"%"},d.animate);if(1===c)e.range[f?"animate":"css"]({width:j-b+"%"},{queue:!1,duration:d.animate})}else{if(0===c)e.range.stop(1,
1)[f?"animate":"css"]({bottom:j+"%"},d.animate);if(1===c)e.range[f?"animate":"css"]({height:j-b+"%"},{queue:!1,duration:d.animate})}b=j});else{k=this.value();l=this._valueMin();p=this._valueMax();j=p!==l?100*((k-l)/(p-l)):0;g["horizontal"===e.orientation?"left":"bottom"]=j+"%";this.handle.stop(1,1)[f?"animate":"css"](g,d.animate);if("min"===c&&"horizontal"===this.orientation)this.range.stop(1,1)[f?"animate":"css"]({width:j+"%"},d.animate);if("max"===c&&"horizontal"===this.orientation)this.range[f?
"animate":"css"]({width:100-j+"%"},{queue:!1,duration:d.animate});if("min"===c&&"vertical"===this.orientation)this.range.stop(1,1)[f?"animate":"css"]({height:j+"%"},d.animate);if("max"===c&&"vertical"===this.orientation)this.range[f?"animate":"css"]({height:100-j+"%"},{queue:!1,duration:d.animate})}}});a.extend(a.ui.slider,{version:"1.8.20"})})(jQuery);
...
a(this);c.html(c.data("label.tabs")).removeData("label.tabs")})},_tabify:function(d){function e(b,c){b.css("display","");!a.support.opacity&&c.opacity&&b[0].style.removeAttribute("filter")}var g=this,b=this.options,k=/^#.+/;this.list=this.element.find("ol,ul").eq(0);this.lis=a(" > li:has(a[href])",this.list);this.anchors=this.lis.map(function(){return a("a",this)[0]});this.panels=a([]);this.anchors.each(function(c,d){var e=a(d).attr("href"),f=e.split("#")[0],j;if(f&&(f===location.toString().split("#")[0]||
(j=a("base")[0])&&f===j.href))e=d.hash,d.href=e;k.test(e)?g.panels=g.panels.add(g.element.find(g._sanitizeSelector(e))):e&&"#"!==e?(a.data(d,"href.tabs",e),a.data(d,"load.tabs",e.replace(/#.*$/,"")),e=g._tabId(d),d.href="#"+e,f=g.element.find("#"+e),f.length||(f=a(b.panelTemplate).attr("id",e).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(g.panels[c-1]||g.list),f.data("destroy.tabs",!0)),g.panels=g.panels.add(f)):b.disabled.push(c)});d?(this.element.addClass("ui-tabs ui-widget ui-widget-content ui-corner-all"),
...
0<=b.selected&&this.anchors.length&&(g.element.find(g._sanitizeSelector(g.anchors[b.selected].hash)).removeClass("ui-tabs-hide"),this.lis.eq(b.selected).addClass("ui-tabs-selected ui-state-active"),g.element.queue("tabs",function(){g._trigger("show",null,g._ui(g.anchors[b.selected],g.element.find(g._sanitizeSelector(g.anchors[b.selected].hash))[0]))}),this.load(b.selected)),a(window).bind("unload",function(){g.lis.add(g.anchors).unbind(".tabs");g.lis=g.anchors=g.panels=null})):b.selected=this.lis.index(this.lis.filter(".ui-tabs-selected"));
...
function(){p("hover",a(this))});this.lis.bind("mouseout.tabs",function(){a(this).removeClass("ui-state-hover")});this.anchors.bind("focus.tabs",function(){p("focus",a(this).closest("li"))});this.anchors.bind("blur.tabs",function(){a(this).closest("li").removeClass("ui-state-focus")})}var o,m;b.fx&&(a.isArray(b.fx)?(o=b.fx[0],m=b.fx[1]):o=m=b.fx);var t=m?function(b,c){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");c.hide().removeClass("ui-tabs-hide").animate(m,m.duration||"normal",
function(){e(c,m);g._trigger("show",null,g._ui(b,c[0]))})}:function(b,c){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");c.removeClass("ui-tabs-hide");g._trigger("show",null,g._ui(b,c[0]))},r=o?function(a,b){b.animate(o,o.duration||"normal",function(){g.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");e(b,o);g.element.dequeue("tabs")})}:function(a,b){g.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");g.element.dequeue("tabs")};
...
-1;b.cookie&&g._cookie(b.selected,b.cookie);g.element.queue("tabs",function(){r(c,e)}).dequeue("tabs");this.blur();return false}if(!e.length){b.cookie&&g._cookie(b.selected,b.cookie);g.element.queue("tabs",function(){t(c,f)});g.load(g.anchors.index(this));this.blur();return false}}b.cookie&&g._cookie(b.selected,b.cookie);if(f.length){e.length&&g.element.queue("tabs",function(){r(c,e)});g.element.queue("tabs",function(){t(c,f)});g.load(g.anchors.index(this))}else throw"jQuery UI Tabs: Mismatching fragment identifier.";
...
e,g){g===c&&(g=this.anchors.length);var b=this,k=this.options,e=a(k.tabTemplate.replace(/#\{href\}/g,d).replace(/#\{label\}/g,e)),d=!d.indexOf("#")?d.replace("#",""):this._tabId(a("a",e)[0]);e.addClass("ui-state-default ui-corner-top").data("destroy.tabs",!0);var l=b.element.find("#"+d);l.length||(l=a(k.panelTemplate).attr("id",d).data("destroy.tabs",!0));l.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide");g>=this.lis.length?(e.appendTo(this.list),l.appendTo(this.list[0].parentNode)):
(e.insertBefore(this.lis[g]),l.insertBefore(this.panels[g]));k.disabled=a.map(k.disabled,function(a){return a>=g?++a:a});this._tabify();1==this.anchors.length&&(k.selected=0,e.addClass("ui-tabs-selected ui-state-active"),l.removeClass("ui-tabs-hide"),this.element.queue("tabs",function(){b._trigger("show",null,b._ui(b.anchors[0],b.panels[0]))}),this.load(0));this._trigger("add",null,this._ui(this.anchors[g],this.panels[g]));return this},remove:function(c){var c=this._getIndex(c),d=this.options,e=this.lis.eq(c).remove(),
...
".tabs");return this},load:function(c){var c=this._getIndex(c),d=this,e=this.options,b=this.anchors.eq(c)[0],k=a.data(b,"load.tabs");this.abort();if(!k||0!==this.element.queue("tabs").length&&a.data(b,"cache.tabs"))this.element.dequeue("tabs");else{this.lis.eq(c).addClass("ui-state-processing");if(e.spinner){var l=a("span",b);l.data("label.tabs",l.html()).html(e.spinner)}this.xhr=a.ajax(a.extend({},e.ajaxOptions,{url:k,success:function(k,l){d.element.find(d._sanitizeSelector(b.hash)).html(k);d._cleanup();
e.cache&&a.data(b,"cache.tabs",!0);d._trigger("load",null,d._ui(d.anchors[c],d.panels[c]));try{e.ajaxOptions.success(k,l)}catch(m){}},error:function(a,k){d._cleanup();d._trigger("load",null,d._ui(d.anchors[c],d.panels[c]));try{e.ajaxOptions.error(a,k,c,b)}catch(l){}}}));d.element.dequeue("tabs");return this}},abort:function(){this.element.queue([]);this.panels.stop(!1,!0);this.element.queue("tabs",this.element.queue("tabs").splice(-2,2));this.xhr&&(this.xhr.abort(),delete this.xhr);this._cleanup();
...
(function(a){function c(c){if("string"===typeof c.data){var e=c.handler,f=c.data.toLowerCase().split(" ");c.handler=function(c){if(!(this!==c.target&&(/textarea|select/i.test(c.target.nodeName)||"text"===c.target.type))){var d="keypress"!==c.type&&a.hotkeys.specialKeys[c.which],b=String.fromCharCode(c.which).toLowerCase(),k="",l={};c.altKey&&"alt"!==d&&(k+="alt+");c.ctrlKey&&"ctrl"!==d&&(k+="ctrl+");c.metaKey&&!c.ctrlKey&&"meta"!==d&&(k+="meta+");c.shiftKey&&"shift"!==d&&(k+="shift+");d?l[k+d]=!0:
(l[k+b]=!0,l[k+a.hotkeys.shiftNums[b]]=!0,"shift+"===k&&(l[a.hotkeys.shiftNums[b]]=!0));d=0;for(b=f.length;d<b;d++)if(l[f[d]])return e.apply(this,arguments)}}}}a.hotkeys={version:"0.8",specialKeys:{8:"backspace",9:"tab",13:"return",16:"shift",17:"ctrl",18:"alt",19:"pause",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"insert",46:"del",96:"0",97:"1",98:"2",99:"3",100:"4",101:"5",102:"6",103:"7",104:"8",105:"9",106:"*",107:"+",
...
(function(a){a.fn.raptorize=function(c){c=a.extend({enterOn:"click",delayTime:5E3},c);return this.each(function(){function d(){j=!0;f&&document.getElementById("elRaptorShriek").play();g.animate({bottom:"0"},function(){a(this).animate({bottom:"-30px"},100,function(){var b=a(this).position().left+400;a(this).delay(300).animate({right:b},2200,function(){g=a("#elRaptor").css({bottom:"-700px",right:"0"});j=!1})})})}var e=a(this),f=!1;if(a.browser.mozilla&&"1.9.2"<=a.browser.version.substr(0,5)||a.browser.webkit)f=
...
var g=a("#elRaptor").css({position:"fixed",bottom:"-700px",right:"0",display:"block"});if("timer"==c.enterOn)setTimeout(d,c.delayTime);else if("click"==c.enterOn)e.bind("click",function(a){a.preventDefault();j||d()});else if("konami-code"==c.enterOn){var b=[];a(window).bind("keydown.raptorz",function(c){b.push(c.keyCode);0<=b.toString().indexOf("38,38,40,40,37,39,37,39,66,65")&&(d(),a(window).unbind("keydown.raptorz"))},!0)}})}})(jQuery);
(function(a,c,d,e){function f(a,b,c){M[a]=c;h[a]=b;I||(I=a)}function j(b){I!==b&&(I=b,a.ui.editor.eachInstance(function(){this.reinit()}))}function g(a,b){I&&M[I]&&M[I][a]&&(a=M[I][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function b(b){if(P===e){P=!0;if(O=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(b.options.baseClass+"-ios"),O&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height",
"-=1")},0)});a.browser.mozilla&&a("html").addClass(b.options.baseClass+"-ff");if(a.browser.msie&&9>a.browser.version){P=!1;var c=a("<div/>").addClass(b.options.baseClass+"-unsupported").html(b.getTemplate("unsupported")).appendTo("body");k(c);c.find("."+b.options.baseClass+"-unsupported-close").click(function(){c.remove()})}}return P}function k(b){var c=1;b.siblings().each(function(){var b=a(this).css("z-index");!isNaN(b)&&b>c&&(c=b+1)});b.css("z-index",c)}function l(a){return a.clone().wrap("<div/>").parent().html()}
function p(a){var b,a=document.createElement(a);b="getComputedStyle"in c;document.body.appendChild(a);b=(b?c.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return b}function o(b,c){for(var d="",e=0,f=b.childNodes.length;e<f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?g.nodeValue:l(a(g)))&&(d+=g)}c&&(d=a("<"+c+">"+d+"</"+c+">"),d.find("p").wrapInner("<"+c+"/>"),d.find("p > *").unwrap(),d=a("<div/>").html(d).html());return d}function m(b,c){var d=a("<div/>").append(b)[0].childNodes;
c.deleteContents();d.length===e||1===d.length?c.insertNode(d[0].cloneNode(!0)):a.each(d,function(a,b){c.insertNodeAtEnd(b.cloneNode(!0))})}function t(b){var b=b||d.getSelection(),c;a(b.getAllRanges()).each(function(b,d){c=3===this.commonAncestorContainer.nodeType?a(d.commonAncestorContainer).parent()[0]:d.commonAncestorContainer});return c}function r(a){if(!R||a)R=d.saveSelection()}function q(){R&&(d.restoreSelection(R),R=!1)}function s(a,b,c){for(var b=b||d.getSelection(),e,f=0;e=b.getAllRanges()[f++];)a.call(c,
e)}function x(a,b){s(function(b){m(a,b)},b,this)}function v(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).focus().contents().each(function(){var a=d.createRange();a.selectNodeContents(this);c.addRange(a)})}function y(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNode(this);c.addRange(a)}).focus()}function E(a){a=a||d.getSelection();return a.toHtml()}function z(b){b=b||d.getSelection().getRangeAt(0);return a(3===b.commonAncestorContainer.nodeType?
b.commonAncestorContainer.parentNode:b.commonAncestorContainer)}function A(a){var b=new jQuery;s(function(a){b.push(z(a)[0])},a,this);return b}function F(){var b=d.getSelection();if(null===b.anchorNode)return null;if(b.isBackwards())return 3===b.focusNode.nodeType?a(b.focusNode.parentElement):a(b.focusNode);b.anchorNode||console.trace();return 3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode)}function J(){var b=d.getSelection();return null===b.anchorNode?null:b.isBackwards()?
3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode):3===b.focusNode.nodeType?a(b.focusNode.parentElement):a(b.focusNode)}function D(b,c){var c=c||{},e=d.createCssClassApplier(c.classes||"",{normalize:!0,elementTagName:b,elementProperties:c.attributes||{}});s(function(d){var f=d.cloneContents(),f=o(f);"string"===typeof f&&(f=f.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));a(f).is(":empty")?(f=a("<"+b+"/>").addClass(c.classes).attr(c.attributes||{}).append(o(d.cloneContents())),
m(f,d)):e.toggleRange(d)},null,this)}function u(a,b,c){s(function(d){d=z(d);d.is(a)?d.attr(b):D(a,{classes:c,attributes:b})},null,this)}var I=null,M={},h={};a(function(){d.initialized||d.init();a.isFunction(d.rangePrototype.insertNodeAtEnd)||(d.rangePrototype.insertNodeAtEnd=function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});a("html").click(function(){a(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});a.widget("ui.editor",
{_init:function(){-1===a.inArray(this,a.ui.editor.instances)&&a.ui.editor.instances.push(this);var c=this;a.ui.editor.eachInstance(function(a){c!=a&&c.element.closest(a.element).length&&handleError("Nesting editors is unsupported",c.element,a.element)});this.options=a.extend({},a.ui.editor.defaults,this.options);this.options.uiOrder=this.options.uiOrder||[["logo"],["save","cancel"],["dock","showGuides","clean"],["viewSource"],["undo","redo"],["alignLeft","alignCenter","alignJustify","alignRight"],
["textBold","textItalic","textUnderline","textStrike"],["textSuper","textSub"],["listUnordered","listOrdered"],["hr","quoteBlock"],["fontSizeInc","fontSizeDec"],["colorPickerBasic"],["clearFormatting"],["link","unlink"],["embed"],["floatLeft","floatNone","floatRight"],["tagMenu"],["i18n"],["raptorize"],["length"],["debugReinit","debugDestroy"]];this.element.attr("id")||this.element.attr("id",this.getUniqueId());this.ready=!1;this.events={};this.ui={};this.plugins={};this.templates=a.extend({},a.ui.editor.templates);
this.path=this.toolbarWrapper=this.toolbar=this.wrapper=null;this.visible=this.enabled=!1;this.uiObjects={};this.hotkeys={};this.options.enableHotkeys&&this.registerHotkey(this.hotkeys);for(var d in this.options.bind)this.bind(d,this.options.bind[d]);this.history=[];this.present=0;this.historyEnabled=!0;b(this)&&(this.cloneDomTools(),this.setOriginalHtml(this.element.is(":input")?this.element.val():this.element.html()),this.options.replace&&(this.replaceOriginal(),this.options.replace=!1),this.attach(),
this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,this.ready=!0,this.fire("ready"),this.options.autoEnable&&a(function(){c.enableEditing();c.showToolbar()}))},attach:function(){this.bind("change",this.historyPush);this.bind("selectionChange",this.updateTagTree);this.bind("show",this.updateTagTree);var b=a.proxy(this.checkChange,this);this.getElement().find("img").bind("click."+this.widgetName,a.proxy(function(a){y(a.target)},this));this.getElement().bind("mouseup."+
this.widgetName,b);this.getElement().bind("keyup."+this.widgetName,b);a(c).bind("beforeunload",a.proxy(a.ui.editor.unloadWarning,a.ui.editor))},reinit:function(){if(this.ready){var a=this.enabled,b=this.visible;this.destruct();this._init();a&&this.enableEditing();b&&this.showToolbar()}else{var c;c=function(){this.unbind("ready",c);this.reinit()};this.bind("ready",c)}},getElement:function(){return this.target?this.target:this.element},getOriginalElement:function(){return this.element},replaceOriginal:function(){if(!this.target){for(var b=
a("<div/>").html(this.element.is(":input")?this.element.val():this.element.html()).insertBefore(this.element).attr("id",this.getUniqueId()).addClass(this.element.attr("class")),c=this.options.domTools.getStyles(this.element),d=0;d<this.options.replaceStyle.length;d++)b.css(this.options.replaceStyle[d],c[this.options.replaceStyle[d]]);this.element.hide();this.bind("change",function(){this.element.is("input, textarea")?this.element.val(this.getHtml()):this.element.html(this.getHtml())});this.target=
b}},cloneDomTools:function(){for(var a in this.options.domTools)this[a]||(this[a]=function(a){return function(){this.options.domTools.constrainSelection(this.getElement());var b=this.getHtml(),c=this.options.domTools[a].apply(this.options.domTools,arguments);b!==this.getHtml()&&this.change();return c}}(a))},checkChange:function(){var a=d.serializeSelection();this.previousSelection!==a&&this.fire("selectionChange");this.previousSelection=a;var a=this.getCleanHtml(),b=this.dirty;this.dirty=this.getOriginalHtml()!==
a;this.previousHtml!==a&&(this.previousHtml=a,this.change(),b!==this.dirty&&(this.dirty?this.fire("dirty"):this.fire("cleaned")))},change:function(){this.fire("change")},destruct:function(){this.hideToolbar();this.disableEditing();this.fire("destroy",!1);this.events={};this.getElement().unbind("."+this.widgetName);this.wrapper&&this.wrapper.remove()},destroy:function(){this.destruct();a.Widget.prototype.destroy.call(this)},persist:function(b,c){return!this.options.persistence?null:a.ui.editor.persist(b,
c,this.options.namespace)},enableEditing:function(){this.isToolbarLoaded()||this.loadToolbar();this.enabled||(this.enabled=!0,this.getElement().addClass(this.options.baseClass+"-editing"),this.options.partialEdit?this.getElement().find(this.options.partialEdit).attr("contenteditable",!0):this.getElement().attr("contenteditable",!0),this.execCommand("enableInlineTableEditing",!1,!1),this.execCommand("styleWithCSS",!0,!0),this.bindHotkeys(),this.fire("enabled"),this.fire("resize"))},disableEditing:function(){this.enabled&&
(this.enabled=!1,this.getElement().attr("contenteditable",!1).removeClass(this.options.baseClass+"-editing"),d.getSelection().removeAllRanges(),this.fire("disabled"))},isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var b=this,c="",d=[],e=0;s(function(f){var f=f.commonAncestorContainer,g;g=3===f.nodeType?a(f).parent():a(f);f=[];for(d.push(f);g[0]&&!b.isRoot(g)&&"body"!==g[0].tagName.toLowerCase();)f.push(g),g=g.parent();f.reverse();c&&(c+=" | ");c+=this.getTemplate("root");
for(g=0;g<f.length;g++)c+=this.getTemplate("tag",{element:f[g][0].tagName.toLowerCase(),data:"["+e+","+g+"]"});e++},null,this);c||(c=this.getTemplate("root"));this.path.html(c).find("a").click(function(){var c=a(this).data("ui-editor-selection");c?(y(d[c[0]][c[1]]),b.updateTagTree()):y(b.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(b){return this.getElement()[0]===a(b)[0]},unify:function(b,c){!1!==c&&b(this);if(this.options.unify)for(var d=a.ui.editor.getInstances(),e=0;e<d.length;e++)d[e]!==
this&&d[e].options.unify&&b(d[e])},getUniqueId:function(){return a.ui.editor.getUniqueId()},loadMessages:function(){this.messages=a(this.getTemplate("messages")).appendTo(this.wrapper)},showMessage:function(b,d,e){var e=a.extend({},this.options.message,e),f;f={timer:null,editor:this,show:function(){this.element.slideDown();this.timer=c.setTimeout(function(){this.timer=null;f.hide()},e.delay,this)},hide:function(){this.timer&&(c.clearTimeout(this.timer),this.timer=null);this.element.stop().slideUp(a.proxy(function(){a.isFunction(e.hide)&&
...
return false})});var e=a("<div/>").addClass("ui-editor-selectmenu-text"),i=a("<div/>").addClass("ui-icon ui-icon-triangle-1-s");d.button=a("<div/>").addClass("ui-editor-selectmenu-button ui-editor-selectmenu-button ui-button ui-state-default").attr("title",d.title).append(e).append(i).prependTo(d.selectMenu);d.button.bind("mousedown."+c.widgetName,function(){return false}).bind("click."+c.widgetName,function(){if(!a(this).hasClass("ui-state-disabled")){parseInt(d.menu.css("min-width"),10)<d.button.outerWidth()+
...
a(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;b!==e&&!a.contains(b,e)&&c.removeRange(f)})},unwrapParentTag:function(b){A().each(function(){a(this).is(b)&&a(this).replaceWith(a(this).html())})},selectEnd:function(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNodeContents(this);a.collapse();c.addRange(a)})},execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(d){}},insertTag:function(b,c){s(function(c){c.insertNode(a("<"+
b+"/>")[0])},c,this)},insertTagAtEnd:function(b,c){s(function(c){c.insertNodeAtEnd(a("<"+b+"/>")[0])},c,this)},insertElement:function(b,c,d){s(function(d){a(b).each(function(){d.insertNode(!1===c?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(b,c,d){s(function(d){a(b).each(function(){d.insertNodeAtEnd(!1===c?this:this.cloneNode(!0))})},d,this)},toggleBlockStyle:function(b,c){s(function(d){for(d=a(d.commonAncestorContainer);d.length&&d[0]!==c[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=
d.parent();d[0]===c[0]&&"inline"!==c.css("display")&&(this.wrapInner(c,"div"),d=c.children().first());this.toggleStyle(d,b)},null,this)},wrapInner:function(b,c){r();a(b).each(function(){var d=a("<"+c+"/>").html(a(this).html());b.html(d)});q()},inverseWrapWithTagClass:function(b,c,e,f){r();var g="domTools"+Math.ceil(1E7*Math.random());s(function(a){var b=d.createCssClassApplier(f,{elementTagName:e});b.isAppliedToRange(a)?b.toggleSelection():d.createCssClassApplier(c,{elementTagName:g}).toggleSelection()},
null,this);a(g).each(function(){a(this).replaceWith(a("<"+b+"/>").addClass(c).html(a(this).html()))});q()},toggleStyle:function(b,c){a.each(c,function(c,d){a(b).css(c)===d?a(b).css(c,""):a(b).css(c,d)})},getStyles:function(a){for(var b={},a=c.getComputedStyle(a[0],null),d=0;d<a.length;d++)b[a.item(d)]=a.getPropertyValue(a.item(d));return b},swapStyles:function(a,b,c){for(var d in c)a.css(d,b.css(d)),b.css(d,c[d])},replaceSelectionWithinValidTags:function(a,b,c){var c=c||d.getSelection(),e=F()[0],
f=J()[0],g=this.isElementValid(A()[0],b),e=this.isElementValid(e,b),b=this.isElementValid(f,b);g&&e&&b?x(a):this.replaceSelectionSplittingSelectedElement(a,c)},replaceSelectionSplittingSelectedElement:function(b,c){var c=c||d.getSelection(),e=c.getRangeAt(0),f=A()[0],g=d.createRange();g.setStartBefore(f);g.setEnd(e.startContainer,e.startOffset);var g=g.cloneContents(),h=d.createRange();h.setStart(e.endContainer,e.endOffset);h.setEndAfter(f);e=h.cloneContents();g=l(a(o(g)));g+=l(a(b));g+=l(a(o(e)));
a(f).replaceWith(a(g))},insertDomFragmentBefore:function(b,c,d){for(var e=0,f=b.childNodes.length;e<f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?g.nodeValue:a(g).html())&&a("<"+d+"/>").html(a.trim(g)).insertBefore(c)}},selectionExists:function(a){var b=!1;s(function(a){this.isEmpty(a)||(b=!0)},a,this);return b},isEmpty:function(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer},isElementValid:function(b,c){return-1!==a.inArray(a(b)[0].tagName.toLowerCase(),c)},stripTags:function(a,
b){allowed=[];for(var c=0;c<b.length;c++)b[c].match(/[a-z][a-z0-9]{0,}/g)&&allowed.push(b[c]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,b){return-1<allowed.indexOf(b.toLowerCase())?a:""})}},namespace:null,unify:!0,persistence:!0,persistenceName:"uiEditor",unloadWarning:!0,autoEnable:!1,partialEdit:!1,enablePlugins:!0,disabledPlugins:[],uiOrder:null,enableUi:!0,disabledUi:[],message:{delay:5E3},replace:!1,replaceStyle:"display,position,float,width,padding-left,padding-right,padding-top,padding-bottom,margin-left,margin-right,margin-top,margin-bottom".split(","),
...
persist:function(a,b,c){a=c?c+"."+a:a;if(localStorage){c=localStorage.uiWidgetEditor?JSON.parse(localStorage.uiWidgetEditor):{};if(b===e)return c[a];c[a]=b;localStorage.uiWidgetEditor=JSON.stringify(c)}return b}});var P,O;a.ui.editor.registerUi({alignLeft:{init:function(a){return a.uiButton({title:g("Left Align"),click:function(){a.toggleBlockStyle({"text-align":"left"},a.getElement())}})}},alignJustify:{init:function(a){return a.uiButton({title:g("Justify"),click:function(){a.toggleBlockStyle({"text-align":"justify"},
a.getElement())}})}},alignCenter:{init:function(a){return a.uiButton({title:g("Center Align"),click:function(){a.toggleBlockStyle({"text-align":"center"},a.getElement())}})}},alignRight:{init:function(a){return a.uiButton({title:g("Right Align"),click:function(){a.toggleBlockStyle({"text-align":"right"},a.getElement())}})}}});a.ui.editor.registerUi({textBold:{hotkeys:{"ctrl+b":{action:function(){this.ui.click()}}},init:function(a,b){return this.editor.uiButton({title:g("Bold"),click:function(){D("strong",
{classes:b.classes||b.cssPrefix+"bold"})}})}},textItalic:{hotkeys:{"ctrl+i":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:g("Italic"),click:function(){D("em",{classes:b.classes||b.cssPrefix+"italic"})}})}},textUnderline:{hotkeys:{"ctrl+u":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:g("Underline"),click:function(){D("u",{classes:b.classes||b.cssPrefix+"underline"})}})}},textStrike:{hotkeys:{"ctrl+k":{action:function(){this.ui.click()}}},
init:function(a,b){return a.uiButton({title:g("Strikethrough"),click:function(){D("del",{classes:b.classes||b.cssPrefix+"strike"})}})}},textSub:{init:function(a,b){return a.uiButton({title:g("Sub script"),click:function(){D("sub",{classes:b.classes||b.cssPrefix+"sub"})}})}},textSuper:{init:function(a,b){return a.uiButton({title:g("Super script"),click:function(){D("sup",{classes:b.classes||b.cssPrefix+"super"})}})}}});a.ui.editor.registerUi({quoteBlock:{init:function(a,b){return a.uiButton({title:g("Blockquote"),
icon:"ui-icon-quote",click:function(){D("blockquote",{classes:b.classes||b.cssPrefix+"blockquote"})}})}}});a.ui.editor.registerUi({cancel:{hotkeys:{"ctrl+k":{action:function(){this.ui.click()}}},init:function(a){return a.uiButton({name:"cancel",title:g("Cancel"),icons:{primary:"ui-icon-cancel"},dialog:null,click:function(){this.confirm()}})},confirm:function(){var b=this.editor.getPlugin("cancel"),c=this.editor;c.isDirty()?(this.dialog||(this.dialog=a(c.getTemplate("cancel.dialog"))),this.dialog.dialog({modal:!0,
...
a(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:g("Paste Embed Code"),autoOpen:!0,dialogClass:b.options.baseClass+" "+b.options.dialogClass,buttons:[{text:g("Embed Object"),click:function(){q();x(a(this).find("textarea").val());a(this).dialog("close")}},{text:g("Close"),click:function(){b.hide()}}],open:function(){var b=a(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});
...
a.ui.editor.registerPlugin("emptyElement",{options:{tag:"<p/>"},init:function(){this.bind("change",this.change)},change:function(){var b=this;this.textNodes(this.editor.getElement()).each(function(){a(this).wrap(a(b.options.tag));b.editor.selectEnd(this)});this.editor.checkChange()},textNodes:function(b){return a(b).contents().filter(function(){return 3==this.nodeType&&a.trim(this.nodeValue).length})}});a.ui.editor.registerUi({floatLeft:{init:function(b){return b.uiButton({title:g("Float Image Left"),
click:function(){s(function(b){a(b.commonAncestorContainer).find("img").css("float","left")})}})}},floatRight:{init:function(b){return b.uiButton({title:g("Float Image Right"),click:function(){s(function(b){a(b.commonAncestorContainer).find("img").css("float","right")})}})}},floatNone:{init:function(b){return b.uiButton({title:g("Remove Image Float"),click:function(){s(function(b){a(b.commonAncestorContainer).find("img").css("float","none")})}})}}});a.ui.editor.registerUi({fontSizeInc:{init:function(a,
b){return a.uiButton({title:g("Increase Font Size"),click:function(){a.inverseWrapWithTagClass("big",b.cssPrefix+"big","small",b.cssPrefix+"small")}})}},fontSizeDec:{init:function(a,b){return a.uiButton({title:g("Decrease Font Size"),click:function(){a.inverseWrapWithTagClass("small",b.cssPrefix+"small","big",b.cssPrefix+"big")}})}}});a.ui.editor.registerUi({showGuides:{init:function(a,b){a.bind("cancel",this.cancel,this);a.bind("destroy",this.cancel,this);return a.uiButton({title:g("Show Guides"),
icon:"ui-icon-pencil",click:function(){a.getElement().toggleClass(b.baseClass+"-visible")}})},cancel:function(){this.editor.getElement().removeClass(this.options.baseClass+"-visible")}}});a.ui.editor.registerUi({undo:{options:{disabled:!0},hotkeys:{"ctrl+z":{action:function(){this.editor.historyBack()}}},init:function(a){a.bind("change",this.change,this);return a.uiButton({title:g("Step Back"),click:function(){a.historyBack()}})},change:function(){0===this.editor.present?this.ui.disable():this.ui.enable()}},
...
click:function(){x("<hr/>")}})}}});a.ui.editor.registerUi({i18n:{init:function(b){var c=this,d=this.persist("locale");d&&j(d);var d=a('<select autocomplete="off" name="i18n"/>'),e;for(e in M){var f=a('<option value="'+e+'" class="'+e+'"/>');f.html(h[e]);I===e&&f.attr("selected","selected");d.append(f)}return b.uiSelectMenu({title:g("Change Language"),select:d,change:function(a){j(c.persist("locale",a))}})}}});f("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.",
"Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"Apply Source","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",Blockquote:"Blockquote",Bold:"Bold",Cancel:"Cancel","Center Align":"Center Align","Change HTML tag of selected element":"Change HTML tag of selected element","Change Language":"Change Language","Check this box to have the file open in a new browser window":"Check this box to have the file open in a new browser window",
...
"Enter subject":"Introduzca un sujeto","Enter your URL":"Introduzca su URL","Failed to save {{failed}} content block(s).":"Fall\u00f3 al guardar los bloques del cotenido de {{failed}}.","Find the page on the web you want to link to":"Busque la p\u00e1gina web a la que desee enlazar","Float Image Left":"Float Image Left","Float Image Right":"Float Image Right","Formatted &amp; Cleaned":"Formateado y Limpiado","Formatted Unclean":"Formateado Sucio","Heading&nbsp;1":"Encabezado&nbsp;1","Heading&nbsp;2":"Encabezado&nbsp;2",
"Heading&nbsp;3":"Encabezado&nbsp;3","Image height":"Image height","Image width":"Image width","Increase Font Size":"Incrementar Tama\u00f1o de Fuente",Initializing:"Inicializando",Insert:"Insertar","Insert Horizontal Rule":"Insertar L\u00ednea Horizontal","Insert Link":"Insertar Enlace","Insert Snippet":"Insertar Snippet",Italic:"Cursiva",Justify:"Justificar","Learn More About the Raptor WYSIWYG Editor":"Saber m\u00e1s sobre el editor WYSIWYG Raptor","Left Align":"Alinear a la Izquierda","Link to a document or other file":"Enlazar a un documento o a otro archivo",
"Link to a page on this or another website":"Enlazar a una p\u00e1gina en esta u otra p\u00e1gina web","Link to an email address":"Enlazar a una direcci\u00f3n de correo electr\u00f3nico",Location:"Localizaci\u00f3n","Modify Image Size":"Modify Image Size","N/A":"N/A","New window":"Nueva ventana","No changes detected to save...":"No se detectaron cambios para guardar...","Not sure what to put in the box above?":"\u00bfNo est\u00e1 seguro de qu\u00e9 poner en la caja anterior?",OK:"Aceptar","Open the uploaded file in your browser":"Abra el archivo cargado en su navegador",
"Ordered List":"Lista Ordenada","Page on this or another website":"P\u00e1gina en \u00e9sta u otra p\u00e1gina web",Paragraph:"P\u00e1rrafo","Paste Embed Code":"Pegar C\u00f3digo Incrustado","Paste your embed code into the text area below.":"Pegue su c\u00f3digo incrustado en la caja de texto posterior.","Plain Text":"Texto Llano",Preview:"Previsualizar",Raptorize:"Raptorizar",Reinitialise:"Reinicializar","Remaining characters before the recommended character limit is reached":"Car\u00e1cteres restantes antes de que se alcance el l\u00edmite de c\u00e1racteres recomendado",
"Remove Image Float":"Remove Image Float","Remove Link":"Eliminar enlace","Remove unnecessary markup from editor content":"Eliminar marcado innecesario del editor de contenido","Resize Image":"Resize Image","Right Align":"Alinear a la Derecha",Save:"Guardar","Saved {{saved}} out of {{dirty}} content blocks.":"Guardados {{saved}} de {{dirty}} bloques de contenido.","Saving changes...":"Guardando cambios...","Select all editable content":"Seleccionar todo el contenido editable","Select {{element}} element":"Seleccionar el elemento {{element}}",
...
"The image '{{image}}' is too large for the element being edited.<br/>It will be replaced with a resized copy when your edits are saved.":"The image '{{image}}' is too large for the element being edited.<br/>It will be replaced with a resized copy when your edits are saved.","The url for the file you inserted doesn't look well formed":"La URL del archivo que ha introducido no parece bien formada","The url for the link you inserted doesn't look well formed":"La URL del enlace que ha introducido no parece bien formada",
"This block contains unsaved changes":"Este bloque tiene cambios sin guardar",Underline:"Subrayar","Unnamed Button":"Bot\u00f3n sin Nombre","Unnamed Select Menu":"Men\u00fa de Selecci\u00f3n sin Nombre","Unordered List":"Lista Desordenada","Update Link":"Actualizar Enlace","Updated link: {{link}}":"Enlace actualizado: {{link}}","View / Edit Source":"Ver / Editar C\u00f3digo Fuente","View Source":"Ver C\u00f3digo Fuente","\nThere are unsaved changes on this page. \nIf you navigate away from this page you will lose your unsaved changes":"\nHay cambios sin guardar en esta p\u00e1gina. \nSi sale de esta p\u00e1gina, perder\u00e1 todos los cambios sin guardar",
root:"or\u00edgen","{{charactersRemaining}} characters over limit":"{{charactersRemaining}} car\u00e1cter(es) sobre el l\u00edmite","{{charactersRemaining}} characters remaining":"Queda(n) {{charactersRemaining}} car\u00e1cter(es)","{{characters}} characters, {{charactersRemaining}} over the recommended limit":"{{characters}} car\u00e1cter(es), {{charactersRemaining}} sobre el l\u00edmite recomendado","{{characters}} characters, {{charactersRemaining}} remaining":"{{characters}} car\u00e1cter(es), queda(n) {{charactersRemaining}}",
...
"Choose a link type:":"Choisissez un type de lien :","Clear Formatting":"Clear Formatting","Click to begin editing":"Cliquer pour commencer la modification","Click to detach the toolbar":"Cliquer pour d\u00e9tacher la barre d'outils","Click to dock the toolbar":"Cliquer pour ancrer la barre d'outils","Click to select all editable content":"Cliquer pour s\u00e9lectionner tout le contenu modifiable","Click to select the contents of the '{{element}}' element":"Cliquer pour s\u00e9lectionner le contenu de l'\u00e9l\u00e9ment '{{element}}'",
...
"Plain Text":"Texte brut",Preview:"Aper\u00e7u",Raptorize:"Raptoriser",Reinitialise:"R\u00e9initialiser","Remaining characters before the recommended character limit is reached":"Caract\u00e8res restants avant que la limite de caract\u00e8re recommand\u00e9e ne soit atteinte","Remove Image Float":"Remove Image Float","Remove Link":"Retirer le lien","Remove unnecessary markup from editor content":"Retirer le balisage non n\u00e9cessaire du contenu de l'\u00e9diteur","Resize Image":"Resize Image","Right Align":"Aligner \u00e0 droite",
...
"Subject (optional)":"Sujet (facultatif)","Successfully saved {{saved}} content block(s).":"{{saved}} bloc(s) de contenu enregistr\u00e9(s) avec succ\u00e8s.","Super script":"Exposant","The URL does not look well formed":"L'URL para\u00eet malform\u00e9e","The email address does not look well formed":"L'adresse e-mail para\u00eet malform\u00e9e","The image '{{image}}' is too large for the element being edited.<br/>It will be replaced with a resized copy when your edits are saved.":"The image '{{image}}' is too large for the element being edited.<br/>It will be replaced with a resized copy when your edits are saved.",
...
"{{charactersRemaining}} characters remaining":"{{charactersRemaining}} caract\u00e8res restants","{{characters}} characters, {{charactersRemaining}} over the recommended limit":"{{characters}} caract\u00e8res, {{charactersRemaining}} au-dessus de la limite","{{characters}} characters, {{charactersRemaining}} remaining":"{{characters}} caract\u00e8res, {{charactersRemaining}} restants","{{sentences}} sentences":"{{sentences}} phrases","{{words}} word":"{{words}} mot","{{words}} words":"{{words}} mots"});
f("zh_CN","\u7b80\u4f53\u4e2d\u6587",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"\u5e94\u7528\u6e90\u4ee3\u7801","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",Blockquote:"\u5927\u6bb5\u5f15\u7528",Bold:"\u7c97\u4f53",Cancel:"\u53d6\u6d88","Center Align":"\u4e2d\u5fc3\u5bf9\u9f50\u6587\u672c",
"Change HTML tag of selected element":"Change HTML tag of selected element","Change Language":"\u6539\u53d8\u8bed\u8a00","Check this box to have the file open in a new browser window":"Check this box to have the file open in a new browser window","Check this box to have the link open in a new browser window":"Check this box to have the link open in a new browser window","Choose a link type:":"Choose a link type:","Clear Formatting":"Clear Formatting","Click to begin editing":"Click to begin editing",
"Click to detach the toolbar":"Click to detach the toolbar","Click to dock the toolbar":"Click to dock the toolbar","Click to select all editable content":"Click to select all editable content","Click to select the contents of the '{{element}}' element":"Click to select the contents of the '{{element}}' element",Close:"Close","Confirm Cancel Editing":"\u786e\u8ba4\u53d6\u6d88\u7f16\u8f91","Content Statistics":"Content Statistics","Content contains more than {{limit}} characters and may be truncated":"Content contains more than {{limit}} characters and may be truncated",
...
c.push(a(this))});c.length&&this.resizeOversizedImages(c,b.width())},resizeOversizedImages:function(b,c){for(var d=a("<a>",{href:"",target:"_blank"}),e=0;e<b.length;e++){var f=b[e],g=f.outerWidth();f.outerHeight();var h=Math.min(c/g),g=Math.round(Math.abs(h*(g-(f.outerWidth()-f.width()))));f.addClass(this.options.resizingClass);d=d.html(f.attr("title")||f.attr("src").substr(f.attr("src").lastIndexOf("/")+1)).attr("href",f.attr("src"));a(f).css({width:g});var j=this;this.showOversizeWarning(l(a(d)),
{hide:function(){f.removeClass(j.options.resizingClass)}})}},cancel:function(){this.removeClasses();this.removeToolsButtons();this.unbind()},save:function(){this.removeClasses(this.options.resizingClass);this.removeToolsButtons();this.unbind()},showOversizeWarning:function(a,b){this.editor.showInfo(g("The image '{{image}}' is too large for the element being edited.<br/>It will be replaced with a resized copy when your edits are saved.",{image:a}),b)},removeClasses:function(b){b||(b=[this.options.resizingClass,
this.options.manuallyResizingClass]);a.isArray(b)||(b=[b]);for(var c=0;c<b.length;c++)this.editor.getElement().find("img."+b[c]).removeClass(b[c])},manuallyResizeImage:function(){this.removeToolsButtons();var b=this.editor.getElement().find("img."+this.options.manuallyResizingClass),c=a(b).innerWidth(),d=a(b).innerHeight(),e="#"+this.options.baseClass+"-width",f="#"+this.options.baseClass+"-height",h=this,j=function(c){c=Math.round(c||a(e).val())+"px";a(b).css({width:c})},k=a(this.editor.getTemplate("imageresize.manually-resize-image",
{width:c,height:d,baseClass:this.options.baseClass}));k.dialog({modal:!0,resizable:!1,title:g("Modify Image Size"),autoOpen:!0,buttons:[{text:g("Resize Image"),click:function(){j();a(this).dialog("close")}},{text:g("Cancel"),click:function(){a(this).dialog("close")}}],close:function(){j(c);h.editor.checkChange();a(k).remove()},open:function(){var b=a(this).find(e),i=a(this).find(f);b.keyup(function(){i.val(Math.round(Math.abs(d/c*a(this).val())));j()});i.keyup(function(){b.val(Math.round(Math.abs(c/
d*a(this).val())));j()})}})},displayToolsButtonRelativeToImage:function(b){var c=a("<button/>").appendTo("body").addClass(this.options.resizeButtonClass).button({text:!1,icons:{primary:"ui-icon-tools"}});c.css({position:"absolute",left:a(b).position().left+a(b).innerWidth()-a(c).outerWidth()-10+"px",marginTop:"10px"}).click(a.proxy(this.manuallyResizeImage,this));a(b).before(c)},removeToolsButtons:function(){this.editor.getElement().find("."+this.options.resizeButtonClass).each(function(){a(this).remove()})},
imageMouseEnter:function(b){a(b.target).addClass(this.options.manuallyResizingClass);this.displayToolsButtonRelativeToImage(b.target)},imageMouseLeave:function(b){a(b.relatedTarget).hasClass(this.options.resizeButtonClass)||(a(b.target).removeClass(this.options.manuallyResizingClass),this.removeToolsButtons())}});a.ui.editor.registerUi({length:{ui:null,options:{length:150},init:function(b){b.bind("show",a.proxy(this.updateCount,this));b.bind("change",a.proxy(this.updateCount,this));return this.ui=
this.editor.uiButton({title:g("Remaining characters before the recommended character limit is reached"),label:g("Initializing"),text:!0,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var b=this.options.length-a("<div/>").html(this.editor.getCleanHtml()).text().length,c=this.ui.button,d=null,d=0<=b?g("{{charactersRemaining}} characters remaining",{charactersRemaining:b}):g("{{charactersRemaining}} characters over limit",{charactersRemaining:-1*b});c.button("option",
"label",d);c.button("option","text",!0);0>b?c.addClass("ui-state-error"):0<=b&&15>=b?c.addClass("ui-state-highlight").removeClass("ui-state-error"):c.removeClass("ui-state-highlight ui-state-error")},showStatistics:function(){this.processTemplate().dialog({modal:!0,resizable:!1,title:g("Content Statistics"),dialogClass:this.editor.options.dialogClass+" "+this.editor.options.baseClass,show:this.editor.options.dialogShowAnimation,hide:this.editor.options.dialogHideAnimation,buttons:[{text:g("OK"),click:function(){a(this).dialog("close")}}],
open:function(){a(this).parent().find(".ui-dialog-buttonpane").find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}})},close:function(){a(this).dialog("destroy").remove()}})},processTemplate:function(){var b=a("<div/>").html(this.editor.getCleanHtml()).text(),c=null,d=this.options.length-b.length,c=0>d?g("Content contains more than {{limit}} characters and may be truncated",{limit:this.options.length}):g("Content will not be truncated"),e=null,e=b.split(" ").length,e=1==e?g("{{words}} word",
{words:e}):g("{{words}} words",{words:e}),f=null,f=b.split(". ").length,f=g("{{sentences}} sentences",{sentences:f}),h=null,h=0<=d?g("{{characters}} characters, {{charactersRemaining}} remaining",{characters:b.length,charactersRemaining:d}):g("{{characters}} characters, {{charactersRemaining}} over the recommended limit",{characters:b.length,charactersRemaining:-1*d});return a(this.editor.getTemplate("length.dialog",{characters:h,words:e,sentences:f,truncation:c}))}}});a.ui.editor.registerPlugin("link",
{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:g("Page on this or another website"),focusSelector:'input[name="location"]',init:function(){this.content=this.plugin.editor.getTemplate("link.external",this.options);return this},show:function(a,b){var c=this;a.find('input[name="location"]').bind("keyup",function(){c.validate(a)});b&&(a.find('input[name="location"]').val(this.plugin.selectedElement.attr("href")).trigger("keyup"),"_blank"===this.plugin.selectedElement.attr("target")&&
a.find('input[name="blank"]').attr("checked","checked"));return this},attributes:function(a){var b={href:a.find('input[name="location"]').val()};a.find('input[name="blank"]').is(":checked")&&(b.target="_blank");this.options.regexLink.test(b.href)||this.plugin.editor.showWarning(g("The url for the link you inserted doesn't look well formed"));return b},validate:function(b){var c="."+this.options.baseClass+"-error-message-url",d=!0;this.options.regexLink.test(b.find('input[name="location"]').val())?
...
"checked"));return this},attributes:function(a){var b={href:a.find('input[name="location"]').val()};a.find('input[name="blank"]').is(":checked")&&(b.target="_blank");this.options.regexLink.test(b.href)||this.plugin.editor.showWarning(g("The url for the file you inserted doesn't look well formed"));return b},validate:function(b){var c="."+this.options.baseClass+"-error-message-file-url",d=!0;this.options.regexLink.test(b.find('input[name="location"]').val())?b.find(c).has(":visible").hide():(b.find(c).size()||
...
a(b).hasClass(c[d]))return!0;return!1},focusSelector:null,focus:function(){if(this.focusSelector){var b=a(this.focusSelector),c=b.val();b.val("");b.focus().val(c)}}},c=null,c=this.options.replaceTypes?this.options.customTypes:a.merge(this.defaultLinkTypes,this.options.customTypes),d,e=0;e<c.length;e++)d=a.extend({},b,c[e],{classes:this.options.baseClass+"-"+c[e].type}).init(),this.types[d.type]=d},show:function(){if(!this.visible){r();this.selectedElement=A().first();var b=this.selectedElement.is("a"),
c=this.options,d=this,e=this.dialog=a(this.editor.getTemplate("link.dialog",c)).appendTo("body");this.initTypes();var f=this.dialog.find("fieldset"),h;for(h in this.types)a(this.editor.getTemplate("link.label",this.types[h])).appendTo(f);f.find('input[type="radio"]').bind("change."+this.editor.widgetName,function(){d.typeChange(d.types[a(this).val()],b)});e.dialog({autoOpen:!1,modal:!0,resizable:!0,width:c.dialogWidth,minWidth:c.dialogMinWidth,height:c.dialogHeight,title:b?g("Edit Link"):g("Insert Link"),
dialogClass:c.baseClass+" "+c.dialogClass,buttons:[{text:b?g("Update Link"):g("Insert Link"),click:function(){q();d.apply(b)&&a(this).dialog("close")}},{text:g("Cancel"),click:function(){a(this).dialog("close")}}],beforeopen:function(){d.dialog.find("."+d.options.baseClass+"-content").hide()},open:function(){d.visible=!0;var c=e.parent().find(".ui-dialog-buttonpane");c.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});c.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});
var f=e.find('.ui-editor-link-menu input[type="radio"]');f.first().attr("checked","checked");var g=!1;if(b)for(var h in d.types)if(g=d.types[h].editing(d.selectedElement)){f.filter('[value="'+h+'"]').attr("checked","checked");d.typeChange(d.types[h],b);break}(!b||b&&!g)&&d.typeChange(d.types[f.filter(":checked").val()],b);a(this).unbind("keyup."+d.editor.widgetName).bind("keyup."+d.editor.widgetName,function(b){13==b.keyCode&&(b=d.types[f.filter(":checked").val()],(!a.isFunction(b.validate)||b.validate(d.dialog.find("."+
d.options.baseClass+"-content")))&&c.find("button:eq(0)").trigger("click"))})},close:function(){q();d.visible=!1;e.find("."+c.baseClass+"-content").hide();a(this).dialog("destroy")}}).dialog("open")}},apply:function(b){var c=this.types[this.dialog.find('input[type="radio"]:checked').val()],d=c.attributes(this.dialog.find("."+this.options.baseClass+"-content"),b);if(!d)return!0;q();var e=l(a("<a>"+(d.title?d.title:d.href)+"</a>").attr(a.extend({},d,{target:"_blank"})));b?(this.selectedElement[0].className=
this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(c.classes).attr(d),this.editor.showConfirm(g("Updated link: {{link}}",{link:e}))):(u("a",a.extend(d,{id:this.editor.getUniqueId()}),c.classes),this.editor.showConfirm(g("Added link: {{link}}",{link:e})),this.selectedElement=a("#"+d.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",d.href);y(this.selectedElement);r();return!0},typeChange:function(b,
c){var d=this.dialog.find("."+this.options.baseClass+"-content"),e=d.closest("."+this.options.baseClass+"-wrap"),f=b.ajaxUri&&!this.types[b.type].content;f&&e.addClass(this.options.baseClass+"-loading");var g=this;d.hide(this.options.panelAnimation,function(){f?a.ajax({url:b.ajaxUri,type:"get",success:function(f){d.html(f);g.types[b.type].content=f;e.removeClass(g.options.baseClass+"-loading");b.show(d,c);d.show(g.options.panelAnimation,a.proxy(b.focus,b))}}):(d.html(b.content),b.show(d,c),d.show(g.options.panelAnimation,
...
this.change,this);return a.uiButton({title:g("Insert Link"),click:function(){a.getPlugin("link").show()}})},change:function(){A().length?this.ui.enable():this.ui.disable()}},unlink:{hotkeys:{"ctrl+shift+l":{action:function(){this.ui.click()}},restoreSelection:!1},init:function(a){a.bind("selectionChange",this.change,this);a.bind("show",this.change,this);return a.uiButton({title:g("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){A().is("a")?this.ui.enable():this.ui.disable()}}});
a.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),toggleList:function(b){a(A()).is("li")&&a(A()).parent().is(b)?this.unwrapList():this.wrapList(b);this.editor.fire("selectionChange");
this.editor.fire("change")},unwrapList:function(){r();var b=[],c=[],d=F(),e=J();b.push(a(d).html());c.push(d);if(a(d)[0]!==a(e)[0]){var f=d;do f=a(f).next(),b.push(a(f).html()),c.push(f);while(a(f)[0]!==a(e)[0])}f=0===a(d).prev().length;e=0===a(e).next().length;d=a(d).parent();for(listElementsIndex=0;listElementsIndex<c.length;listElementsIndex++)a(c[listElementsIndex]).remove();for(c=0;c<b.length;c++)d.parent().is("li")||(b[c]="<p>"+b[c]+"</p>");f&&e?(d.replaceWith(b.join("")),q(),b=A()[0],y(b)):
(f?a(d).before(b.join("")):e?a(d).after(b.join("")):this.editor.replaceSelectionSplittingSelectedElement(b.join("")),q(),this.editor.checkChange())},wrapList:function(b){this.editor.constrainSelection(this.editor.getElement());""===a.trim(E())&&v(A());var c=a("<div>").html(E()),d=[],e=this;a(c).contents().each(function(){var b;b="block"===p(this.tagName)?e.editor.stripTags(a(this).html(),e.validChildren):e.editor.stripTags(l(a(this)),e.validChildren);b=a("<li>"+b+"</li>");""!==a.trim(b.text())&&d.push(l(b))});
c=this.options.baseClass+"-selection";b="<"+b+' class="'+c+'">'+d.join("")+"</"+b+">";q();var f=a(A()[0]).parent(),g=this.editor.getElement()[0];f===g||A()[0]===g?x(b):this.editor.replaceSelectionWithinValidTags(b,this.validParents);c=a(this.editor.getElement().find("."+c).removeClass(c));v(c.find("li:first")[0]);this.editor.checkChange()},toggleButtonState:function(b,c){var d=function(a){c.button.toggleClass("ui-state-highlight",a).toggleClass("ui-state-default",!a)},e=F();if(null===e||!e.length)e=
this.editor.getElement();var f=J();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(a(e).is(b)&&a(f).is(b)&&e===f)return d(!0);var g=a(e).parentsUntil(h,b).first()&&a(f).parentsUntil(h,b).first(),h="#"+this.editor.getElement().attr("id"),j=a(e).is(b+" > li")||a(e).parentsUntil(h,b+" > li").length,k=a(f).is(b+" > li")||a(f).parentsUntil(h,b+" > li").length;if(j&&k&&g){g=a(t());g.is(b)||(g=a(g).parentsUntil(h,b).first());h=g.find("ul, ol");if(!h.length)return d(!0);for(g=0;g<h.length;g++)if(a.contains(h[g],
...
c))});return(f?"[":"{")+(""+e)+(f?"]":"}")},c={enableUi:this.options.enableUi,enablePlugins:this.options.enablePlugins,disabledPlugins:b(this.options.disabledPlugins),ui:b(this.options.ui),t:(new Date).getTime()},d=[],e;for(e in c)d.push(e+"="+encodeURIComponent(c[e]));this.ui.button.find(".ui-button-icon-primary").css({"background-image":"url(http://www.jquery-raptor.com/logo/0.0.10?"+d.join("&")+")"})}})}}});a.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span,hr,br".split(","),
allowedAttributes:["href","title"],allowedEmptyTags:["hr","br"]},init:function(b,d){var e=!1,f=!1,h=this;b.getElement().bind("paste."+b.widgetName,a.proxy(function(){if(e)return!1;e=!0;r();a(".uiWidgetEditorPasteBin").length&&a(".uiWidgetEditorPasteBin").remove();a('<div class="uiWidgetEditorPasteBin" contenteditable="true" style="width: 1px; height: 1px; overflow: hidden; position: fixed; top: -1px;" />').appendTo("body");a(".uiWidgetEditorPasteBin").focus();c.setTimeout(function(){var c=a(".uiWidgetEditorPasteBin").html(),
c=h.filterAttributes(c),c=h.filterChars(c),c=h.stripEmpty(c),c=h.stripAttributes(c),c=h.editor.stripTags(c,h.options.allowedTags),c={plain:a("<div/>").html(a(".uiWidgetEditorPasteBin").html()).text(),markup:c,html:a(".uiWidgetEditorPasteBin").html()};f=a(b.getTemplate("paste.dialog",c));f.find(".ui-editor-paste-area").bind("keyup."+b.widgetname,function(){h.updateAreas(this,f)});a(f).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:d.dialogShowAnimation,hide:d.dialogHideAnimation,
dialogClass:d.baseClass+" "+d.dialogClass,buttons:[{text:g("Insert"),click:function(){var b=null,b=a(this).find(".ui-editor-paste-area:visible"),b=b.hasClass("ui-editor-paste-plain")||b.hasClass("ui-editor-paste-source")?b.val():b.html(),b=h.filterAttributes(b),b=h.filterChars(b);q();x(b);e=!1;a(this).dialog("close")}},{text:g("Cancel"),click:function(){q();e=!1;a(this).dialog("close")}}],open:function(){var b=a(this).find(".ui-editor-paste-panel-tabs");b.find("ul.ui-tabs-nav li").click(function(){b.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
...
a.ui.editor.registerPlugin("placeholder",{init:function(b,c){c=a.extend({},{content:"[Your content here]",tag:"p",select:!0},c);this.show=function(){if(!a.trim(b.getElement().html())){var d=a(document.createElement(c.tag)).html(c.content);b.getElement().html(d);c.select&&v(d)}};b.bind("show",this.show)}});a.ui.editor.registerUi({raptorize:{init:function(a){var b=a.uiButton({title:g("Raptorize"),ready:function(){b.button.raptorize&&b.button.raptorize()}});return b}}});a.ui.editor.registerPlugin("saveJson",
...
init:function(b){b.bind("selectionChange",this.change,this);b.bind("show",this.change,this);return b.uiSelectMenu({name:"tagMenu",title:g("Change HTML tag of selected element"),select:a(b.getTemplate("tagmenu.menu")),change:function(c){if(!("undefined"===typeof c||"na"===c)){var d=b.getElement()[0],e=A();if(!E()||""===E()){if(a(e)[0]===a(d)[0])return;r();d=a("<"+c+">").html(e.html());e.replaceWith(d);q()}else{var e=a(A()[0]).parent(),f=this.options.baseClass+"-selection",c=a("<"+c+">").html(E()).addClass(f);
e===d||A()[0]===d?x(c):b.replaceSelectionWithinValidTags(c,this.validParents);v(b.getElement().find("."+f).removeClass(f))}b.checkChange()}}})},change:function(){var b=A()[0];b?(b=b.tagName.toLowerCase(),this.ui.select.find("option[value="+b+"]").length?this.ui.val(b):this.ui.val("na"),a(this.ui.button).toggleClass("ui-state-disabled",this.editor.getElement()[0]===A()[0])):a(this.ui.button).toggleClass("ui-state-disabled",!0)}}});a.ui.editor.registerPlugin("toolbarTip",{init:function(){a.browser.msie||
this.bind("show, tagTreeUpdated",function(){a(".ui-editor-wrapper [title]").each(function(){a(this).attr("data-title",a(this).attr("title"));a(this).removeAttr("title")})})}});(function(){var b=null,c=0;a.ui.editor.registerPlugin("unsavedEditWarning",{init:function(d){var e=this;b||(b=a(d.getTemplate("unsavededitwarning.warning",this.options)).attr("id",d.getUniqueId()).appendTo("body").bind("mouseenter."+d.widgetName,function(){a.ui.editor.eachInstance(function(a){a.isDirty()&&a.getElement().addClass(e.options.baseClass+
"-dirty")})}).bind("mouseleave."+d.widgetName,function(){a("."+e.options.baseClass+"-dirty").removeClass(e.options.baseClass+"-dirty")}));d.bind("dirty",function(){c++;0<c&&(k(b),b.addClass(e.options.baseClass+"-visible"))});d.bind("cleaned",function(){c--;0===c&&b.removeClass(e.options.baseClass+"-visible")})}})})();a.ui.editor.registerUi({viewSource:{init:function(a){return a.uiButton({title:g("View / Edit Source"),click:function(){this.show()}})},show:function(){var b=this,c=a(this.editor.getTemplate("viewsource.dialog",
{baseClass:b.options.baseClass,source:b.editor.getHtml()})),d=this.ui.button;a(d).button("option","disabled",!0);c.dialog({modal:!1,width:600,height:400,resizable:!0,title:g("View Source"),autoOpen:!0,dialogClass:b.options.baseClass+" "+b.options.dialogClass,buttons:[{text:g("Apply Source"),click:function(){var c=a(this).find("textarea").val();b.editor.setHtml(c);a(this).find("textarea").val(b.editor.getHtml())}},{text:g("Close"),click:function(){a(this).dialog("close")}}],open:function(){var b=a(this).parent().find(".ui-dialog-buttonpane");
b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){a(this).dialog("destroy").remove();a(d).button("option","disabled",!1);b.editor.checkChange()}})}}});var R=!1})(jQuery,window,rangy);
