...
*/
window.rangy=function(){function a(a,b){var c=typeof a[b];return c==l||!!(c==j&&a[b])||"unknown"==c}function c(a,b){return!!(typeof a[b]==j&&a[b])}function d(a,b){return typeof a[b]!=o}function e(a){return function(b,c){for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0}}function f(a){return a&&p(a,r)&&A(a,q)}function i(a){window.alert("Rangy not supported in your browser. Reason: "+a);w.initialized=!0;w.supported=!1}function g(){if(!w.initialized){var b,d=!1,e=!1;a(document,"createRange")&&
(b=document.createRange(),p(b,m)&&A(b,n)&&(d=!0),b.detach());if((b=c(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(b,"createTextRange"))b=b.createTextRange(),f(b)&&(e=!0);!d&&!e&&i("Neither Range nor TextRange are implemented");w.initialized=!0;w.features={implementsDomRange:d,implementsTextRange:e};d=D.concat(x);e=0;for(b=d.length;e<b;++e)try{d[e](w)}catch(j){c(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
...
q="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),r="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),p=e(a),s=e(c),A=e(d),w={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:a,isHostObject:c,isHostProperty:d,areHostMethods:p,areHostObjects:s,areHostProperties:A,isTextRange:f},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
w.fail=i;w.warn=function(a){a="Rangy warning: "+a;w.config.alertOnWarn?window.alert(a):typeof window.console!=o&&typeof window.console.log!=o&&window.console.log(a)};({}).hasOwnProperty?w.util.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])}:i("hasOwnProperty not supported");var x=[],D=[];w.init=g;w.addInitListener=function(a){w.initialized?a(w):x.push(a)};var y=[];w.addCreateMissingNativeApiListener=function(a){y.push(a)};w.createMissingNativeApi=function(a){a=a||window;g();
for(var b=0,c=y.length;b<c;++b)y[b](a)};b.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};b.prototype.warn=function(a){w.warn("Module "+this.name+": "+a)};b.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};w.createModule=function(a,c){var d=new b(a);w.modules[a]=d;D.push(function(a){c(a,d);d.initialized=!0;d.supported=!0})};w.requireModules=function(a){for(var c=0,d=a.length,f,e;c<
d;++c){e=a[c];f=w.modules[e];if(!f||!(f instanceof b))throw Error("Module '"+e+"' not found");if(!f.supported)throw Error("Module '"+e+"' not supported");}};var B=!1,s=function(){B||(B=!0,w.initialized||g())};if(typeof window==o)i("No window found");else if(typeof document==o)i("No document found");else return a(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",s,!1),a(window,"addEventListener")?window.addEventListener("load",s,!1):a(window,"attachEvent")?window.attachEvent("onload",
s):i("Window does not have required addEventListener or attachEvent method"),w}();
...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(a){return q.isHostObject(a,"body")?a.body:a.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var b;b=a.parentNode;)a=b;return a},comparePoints:function(a,b,c,j){var g;if(a==c)return b===j?0:b<j?-1:1;if(g=f(c,a,!0))return b<=d(g)?-1:1;if(g=f(a,c,!0))return d(g)<j?-1:1;b=e(a,c);a=a===b?b:f(a,b,!0);c=c===b?b:f(c,b,!0);if(a===c)throw Error("comparePoints got to case 4 and childA and childB are the same!");
...
rangy.createModule("DomRange",function(a){function c(a,b){return 3!=a.nodeType&&(t.isAncestorOf(a,b.startContainer,!0)||t.isAncestorOf(a,b.endContainer,!0))}function d(a){return t.getDocument(a.startContainer)}function e(a,b,c){if(b=a._listeners[b])for(var d=0,h=b.length;d<h;++d)b[d].call(a,{target:a,args:c})}function f(a){return new J(a.parentNode,t.getNodeIndex(a))}function i(a){return new J(a.parentNode,t.getNodeIndex(a)+1)}function g(a,b,c){var d=11==a.nodeType?a.firstChild:a;t.isCharacterDataNode(b)?
...
c.appendChild(b)}return c}function n(a,b,c){var d=!(!b||!b.length),h,k=!!c;d&&(h=RegExp("^("+b.join("|")+")$"));var f=[];j(new q(a,!1),function(a){(!d||h.test(a.nodeType))&&(!k||c(a))&&f.push(a)});return f}function m(a){return"["+("undefined"==typeof a.getName?"Range":a.getName())+"("+t.inspectNode(a.startContainer)+":"+a.startOffset+", "+t.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function q(a,b){this.range=a;this.clonePartiallySelectedTextNodes=b;if(!a.collapsed){this.sc=a.startContainer;
...
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function p(a,b,c){this.nodes=n(a,b,c);this._next=this.nodes[0];this._position=0}function s(a){return function(b,c){for(var d,h=c?b:b.parentNode;h;){d=h.nodeType;if(t.arrayContains(a,d))return h;h=h.parentNode}return null}}function A(a,b){if(ca(a,b))throw new r("INVALID_NODE_TYPE_ERR");}function w(a){if(!a.startContainer)throw new G("INVALID_STATE_ERR");}function x(a,b){if(!t.arrayContains(b,a.nodeType))throw new r("INVALID_NODE_TYPE_ERR");
}function D(a,b){if(0>b||b>(t.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new G("INDEX_SIZE_ERR");}function y(a,b){if(O(a,!0)!==O(b,!0))throw new G("WRONG_DOCUMENT_ERR");}function B(a){if(aa(a,!0))throw new G("NO_MODIFICATION_ALLOWED_ERR");}function F(a,b){if(!a)throw new G(b);}function M(a){return!!a.startContainer&&!!a.endContainer&&!(!t.arrayContains(H,a.startContainer.nodeType)&&!O(a.startContainer,!0))&&!(!t.arrayContains(H,a.endContainer.nodeType)&&!O(a.endContainer,!0))&&a.startOffset<=
(t.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(t.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function E(a){w(a);if(!M(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function v(){}function S(a){a.START_TO_START=z;a.START_TO_END=K;a.END_TO_END=P;a.END_TO_START=T;a.NODE_BEFORE=da;a.NODE_AFTER=Y;a.NODE_BEFORE_AND_AFTER=pa;a.NODE_INSIDE=oa}
function Q(a){S(a);S(a.prototype)}function h(a,b){return function(){E(this);var c=this.startContainer,d=this.startOffset,h=this.commonAncestorContainer,k=new q(this,!0);c!==h&&(c=t.getClosestAncestorIn(c,h,!0),d=i(c),c=d.node,d=d.offset);j(k,B);k.reset();h=a(k);k.detach();b(this,c,d,c,d);return h}}function U(b,d,k){function e(a,b){return function(c){w(this);x(c,N);x(R(c),H);c=(a?f:i)(c);(b?j:g)(this,c.node,c.offset)}}function j(a,b,c){var h=a.endContainer,k=a.endOffset;if(b!==a.startContainer||c!==
a.startOffset){if(R(b)!=R(h)||1==t.comparePoints(b,c,h,k))h=b,k=c;d(a,b,c,h,k)}}function g(a,b,c){var h=a.startContainer,k=a.startOffset;if(b!==a.endContainer||c!==a.endOffset){if(R(b)!=R(h)||-1==t.comparePoints(b,c,h,k))h=b,k=c;d(a,h,k,b,c)}}b.prototype=new v;a.util.extend(b.prototype,{setStart:function(a,b){w(this);A(a,!0);D(a,b);j(this,a,b)},setEnd:function(a,b){w(this);A(a,!0);D(a,b);g(this,a,b)},setStartBefore:e(!0,!0),setStartAfter:e(!1,!0),setEndBefore:e(!0,!1),setEndAfter:e(!1,!1),collapse:function(a){E(this);
a?d(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):d(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){w(this);A(a,!0);d(this,a,0,a,t.getNodeLength(a))},selectNode:function(a){w(this);A(a,!1);x(a,N);var b=f(a),a=i(a);d(this,b.node,b.offset,a.node,a.offset)},extractContents:h(o,d),deleteContents:h(l,d),canSurroundContents:function(){E(this);B(this.startContainer);B(this.endContainer);var a=new q(this,!0),b=a._first&&
...
c=this.endContainer,h=this.endOffset,k=function(a){var b=a.nextSibling;b&&b.nodeType==a.nodeType&&(c=a,h=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},f=function(d){var k=d.previousSibling;if(k&&k.nodeType==d.nodeType){a=d;var f=d.length;b=k.length;d.insertData(0,k.data);k.parentNode.removeChild(k);a==c?(h+=b,c=a):c==d.parentNode&&(k=t.getNodeIndex(d),h==k?(c=d,h=f):h>k&&h--)}},e=!0;t.isCharacterDataNode(c)?c.length==h&&k(c):(0<h&&(e=c.childNodes[h-1])&&t.isCharacterDataNode(e)&&k(e),
e=!this.collapsed);e?t.isCharacterDataNode(a)?0==b&&f(a):b<a.childNodes.length&&(k=a.childNodes[b])&&t.isCharacterDataNode(k)&&f(k):(a=c,b=h);d(this,a,b,c,h)},collapseToPoint:function(a,b){w(this);A(a,!0);D(a,b);(a!==this.startContainer||b!==this.startOffset||a!==this.endContainer||b!==this.endOffset)&&d(this,a,b,a,b)}});Q(b)}function I(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:t.getCommonAncestor(a.startContainer,
a.endContainer)}function W(a,b,c,d,h){var k=a.startContainer!==b||a.startOffset!==c,f=a.endContainer!==d||a.endOffset!==h;a.startContainer=b;a.startOffset=c;a.endContainer=d;a.endOffset=h;I(a);e(a,"boundarychange",{startMoved:k,endMoved:f})}function L(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};I(this)}a.requireModules(["DomUtil"]);var t=a.dom,J=t.DomPosition,G=a.DOMException;q.prototype={_current:null,_next:null,_first:null,
...
(a===this.sc||a===this.ec)?(b=a===this.sc?this.so:0,c=a===this.ec?this.eo:a.length,b!=c&&a.deleteData(b,c-b)):a.parentNode&&a.parentNode.removeChild(a)},isPartiallySelectedSubtree:function(){return c(this._current,this.range)},getSubtreeIterator:function(){var a;if(this.isSingleCharacterDataNode)a=this.range.cloneRange(),a.collapse();else{a=new L(d(this.range));var b=this._current,c=b,h=0,k=b,f=t.getNodeLength(b);t.isAncestorOf(b,this.sc,!0)&&(c=this.sc,h=this.so);t.isAncestorOf(b,this.ec,!0)&&(k=
this.ec,f=this.eo);W(a,c,h,k,f)}return new q(a,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};r.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};r.prototype.toString=function(){return this.message};p.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
detach:function(){this._current=this._next=this.nodes=null}};var N=[1,3,4,5,7,8,10],H=[2,9,11],X=[1,3,4,5,7,8,10,11],Z=[1,3,4,5,7,8],R=t.getRootContainer,O=s([9,11]),aa=s([5,6,10,12]),ca=s([6,10,12]),ea=document.createElement("style"),V=!1;try{ea.innerHTML="<b>x</b>",V=3==ea.firstChild.nodeType}catch(k){}a.features.htmlParsingConforms=V;var u="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),z=0,K=1,P=2,T=3,da=0,Y=1,pa=2,oa=3;v.prototype={attachListener:function(a,
b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){E(this);y(this.startContainer,b.startContainer);var c=a==T||a==z?"start":"end",d=a==K||a==z?"start":"end";return t.comparePoints(this[c+"Container"],this[c+"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){E(this);x(a,X);B(this.startContainer);if(t.isAncestorOf(a,this.startContainer,!0))throw new G("HIERARCHY_REQUEST_ERR");this.setStartBefore(g(a,this.startContainer,this.startOffset))},cloneContents:function(){E(this);
var a,c;if(this.collapsed)return d(this).createDocumentFragment();if(this.startContainer===this.endContainer&&t.isCharacterDataNode(this.startContainer))return a=this.startContainer.cloneNode(!0),a.data=a.data.slice(this.startOffset,this.endOffset),c=d(this).createDocumentFragment(),c.appendChild(a),c;c=new q(this,!0);a=b(c);c.detach();return a},canSurroundContents:function(){E(this);B(this.startContainer);B(this.endContainer);var a=new q(this,!0),b=a._first&&c(a._first,this)||a._last&&c(a._last,
this);a.detach();return!b},surroundContents:function(a){x(a,Z);if(!this.canSurroundContents())throw new r("BAD_BOUNDARYPOINTS_ERR");var b=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);g(a,this.startContainer,this.startOffset);a.appendChild(b);this.selectNode(a)},cloneRange:function(){E(this);for(var a=new L(d(this)),b=u.length,c;b--;)c=u[b],a[c]=this[c];return a},toString:function(){E(this);var a=this.startContainer;if(a===this.endContainer&&t.isCharacterDataNode(a))return 3==
a.nodeType||4==a.nodeType?a.data.slice(this.startOffset,this.endOffset):"";var b=[],a=new q(this,!0);j(a,function(a){(3==a.nodeType||4==a.nodeType)&&b.push(a.data)});a.detach();return b.join("")},compareNode:function(a){E(this);var b=a.parentNode,c=t.getNodeIndex(a);if(!b)throw new G("NOT_FOUND_ERR");a=this.comparePoint(b,c);b=this.comparePoint(b,c+1);return 0>a?0<b?pa:da:0<b?Y:oa},comparePoint:function(a,b){E(this);F(a,"HIERARCHY_REQUEST_ERR");y(a,this.startContainer);return 0>t.comparePoints(a,
...
return b?0>=k&&0<=c:0>k&&0<c},isPointInRange:function(a,b){E(this);F(a,"HIERARCHY_REQUEST_ERR");y(a,this.startContainer);return 0<=t.comparePoints(a,b,this.startContainer,this.startOffset)&&0>=t.comparePoints(a,b,this.endContainer,this.endOffset)},intersectsRange:function(a,b){E(this);if(d(a)!=d(this))throw new G("WRONG_DOCUMENT_ERR");var c=t.comparePoints(this.startContainer,this.startOffset,a.endContainer,a.endOffset),h=t.comparePoints(this.endContainer,this.endOffset,a.startContainer,a.startOffset);
...
this.startContainer,this.startOffset)&&b.setStart(a.startContainer,a.startOffset);1==t.comparePoints(a.endContainer,a.endOffset,this.endContainer,this.endOffset)&&b.setEnd(a.endContainer,a.endOffset);return b}throw new r("Ranges do not intersect");},containsNode:function(a,b){return b?this.intersectsNode(a,!1):this.compareNode(a)==oa},containsNodeContents:function(a){return 0<=this.comparePoint(a,0)&&0>=this.comparePoint(a,t.getNodeLength(a))},containsRange:function(a){return this.intersection(a).equals(a)},
containsNodeText:function(a){var b=this.cloneRange();b.selectNode(a);var c=b.getNodes([3]);return 0<c.length?(b.setStart(c[0],0),a=c.pop(),b.setEnd(a,a.length),a=this.containsRange(b),b.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){E(this);return new p(this,a,b)},getNodes:function(a,b){E(this);return n(this,a,b)},getDocument:function(){return d(this)},collapseBefore:function(a){w(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){w(this);this.setStartAfter(a);
this.collapse(!0)},getName:function(){return"DomRange"},equals:function(a){return L.rangesEqual(this,a)},isValid:function(){return M(this)},inspect:function(){return m(this)}};U(L,W,function(a){w(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;e(a,"detach",null);a._listeners=null});a.rangePrototype=v.prototype;L.rangeProperties=u;L.RangeIterator=q;L.copyComparisonConstants=Q;L.createPrototypeRange=U;L.inspect=m;L.getRangeDocument=d;L.rangesEqual=
function(a,b){return a.startContainer===b.startContainer&&a.startOffset===b.startOffset&&a.endContainer===b.endContainer&&a.endOffset===b.endOffset};a.DomRange=L;a.RangeException=r});
rangy.createModule("WrappedRange",function(a){function c(a,b,c,d){var e=a.duplicate();e.collapse(c);var g=e.parentElement();f.isAncestorOf(b,g,!0)||(g=b);if(!g.canHaveHTML)return new i(g.parentNode,f.getNodeIndex(g));var b=f.getDocument(g).createElement("span"),r,p=c?"StartToStart":"StartToEnd";do g.insertBefore(b,b.previousSibling),e.moveToElementText(b);while(0<(r=e.compareEndPoints(p,a))&&b.previousSibling);p=b.nextSibling;if(-1==r&&p&&f.isCharacterDataNode(p)){e.setEndPoint(c?"EndToStart":"EndToEnd",
...
!1;break a}c=!0}if(!c)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function j(a,b){var c=new w(b);a._ranges=[c];f(a,c,!1);a.rangeCount=1;a.isCollapsed=c.collapsed}function l(b){b._ranges.length=0;if("None"==b.docSelection.type)i(b);else{var c=b.docSelection.createRange();if(c&&"undefined"!=typeof c.text)j(b,c);else{b.rangeCount=c.length;for(var d,h=p.getDocument(c.item(0)),e=0;e<b.rangeCount;++e)d=a.createRange(h),d.selectNode(c.item(e)),
b._ranges.push(d);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;f(b,b._ranges[b.rangeCount-1],!1)}}}function o(a,c){for(var d=a.docSelection.createRange(),h=b(c),f=p.getDocument(d.item(0)),f=p.getBody(f).createControlRange(),e=0,g=d.length;e<g;++e)f.add(d.item(e));try{f.add(h)}catch(k){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}f.select();l(a)}function n(a,b,c){this.nativeSelection=a;this.docSelection=b;this._ranges=
[];this.win=c;this.refresh()}function m(a,c){for(var d=p.getDocument(c[0].startContainer),d=p.getBody(d).createControlRange(),h=0,f;h<rangeCount;++h){f=b(c[h]);try{d.add(f)}catch(e){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();l(a)}function q(a,b){if(a.anchorNode&&p.getDocument(a.anchorNode)!==p.getDocument(b))throw new x("WRONG_DOCUMENT_ERR");}function r(a){var b=[],c=new D(a.anchorNode,a.anchorOffset),
d=new D(a.focusNode,a.focusOffset),h="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var f=0,e=a.rangeCount;f<e;++f)b[f]=A.inspect(a.getRangeAt(f));return"["+h+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var p=a.dom,s=a.util,A=a.DomRange,w=a.WrappedRange,x=a.DOMException,D=p.DomPosition,y,B,F=a.util.isHostMethod(window,"getSelection"),
M=a.util.isHostObject(document,"selection"),E=M&&(!F||a.config.preferTextRange);E?(y=e,a.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return"None"!=b.type||p.getDocument(b.createRange().parentElement())==a}):F?(y=d,a.isSelectionValid=function(){return!0}):c.fail("Neither document.selection or window.getSelection() detected.");a.getNativeSelection=y;var F=y(),v=a.createNativeRange(document),S=p.getBody(document),Q=s.areHostObjects(F,s.areHostProperties(F,["anchorOffset","focusOffset"]));
a.features.selectionHasAnchorAndFocus=Q;var h=s.isHostMethod(F,"extend");a.features.selectionHasExtend=h;var U="number"==typeof F.rangeCount;a.features.selectionHasRangeCount=U;var I=!1,W=!0;s.areHostMethods(F,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof F.rangeCount&&a.features.implementsDomRange&&function(){var a=document.createElement("iframe");a.frameBorder=0;a.style.position="absolute";a.style.left="-10000px";S.appendChild(a);var b=p.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");
b.close();var c=p.getIframeWindow(a).getSelection(),d=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(d,1);b.collapse(true);c.addRange(b);W=c.rangeCount==1;c.removeAllRanges();var h=b.cloneRange();b.setStart(d,0);h.setEnd(d,2);c.addRange(b);c.addRange(h);I=c.rangeCount==2;b.detach();h.detach();S.removeChild(a)}();a.features.selectionSupportsMultipleRanges=I;a.features.collapsedNonEditableSelectionsSupported=W;var L=!1,t;S&&s.isHostMethod(S,"createControlRange")&&(t=S.createControlRange(),
s.areHostProperties(t,["item","add"])&&(L=!0));a.features.implementsControlRange=L;B=Q?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:false};var J;s.isHostMethod(F,"getRangeAt")?J=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:Q&&(J=function(b){var c=p.getDocument(b.anchorNode),c=a.createRange(c);c.setStart(b.anchorNode,b.anchorOffset);c.setEnd(b.focusNode,b.focusOffset);if(c.collapsed!==
this.isCollapsed){c.setStart(b.focusNode,b.focusOffset);c.setEnd(b.anchorNode,b.anchorOffset)}return c});a.getSelection=function(a){var a=a||window,b=a._rangySelection,c=y(a),d=M?e(a):null;if(b){b.nativeSelection=c;b.docSelection=d;b.refresh(a)}else{b=new n(c,d,a);a._rangySelection=b}return b};a.getIframeSelection=function(b){return a.getSelection(p.getIframeWindow(b))};t=n.prototype;if(!E&&Q&&s.areHostMethods(F,["removeAllRanges","addRange"])){t.removeAllRanges=function(){this.nativeSelection.removeAllRanges();
i(this)};var G=function(b,c){var d=A.getRangeDocument(c),d=a.createRange(d);d.collapseToPoint(c.endContainer,c.endOffset);b.nativeSelection.addRange(g(d));b.nativeSelection.extend(c.startContainer,c.startOffset);b.refresh()};t.addRange=U?function(b,c){if(L&&M&&this.docSelection.type=="Control")o(this,b);else if(c&&h)G(this,b);else{var d;if(I)d=this.rangeCount;else{this.removeAllRanges();d=0}this.nativeSelection.addRange(g(b));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==d+1){if(a.config.checkSelectionRanges)(d=
J(this.nativeSelection,this.rangeCount-1))&&!A.rangesEqual(d,b)&&(b=new w(d));this._ranges[this.rangeCount-1]=b;f(this,b,X(this.nativeSelection));this.isCollapsed=B(this)}else this.refresh()}}:function(a,b){if(b&&h)G(this,a);else{this.nativeSelection.addRange(g(a));this.refresh()}};t.setRanges=function(a){if(L&&a.length>1)m(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(s.isHostMethod(F,"empty")&&s.isHostMethod(v,"select")&&L&&E)t.removeAllRanges=
function(){try{this.docSelection.empty();if(this.docSelection.type!="None"){var a;if(this.anchorNode)a=p.getDocument(this.anchorNode);else if(this.docSelection.type=="Control"){var b=this.docSelection.createRange();b.length&&(a=p.getDocument(b.item(0)).body.createTextRange())}if(a){a.body.createTextRange().select();this.docSelection.empty()}}}catch(c){}i(this)},t.addRange=function(a){if(this.docSelection.type=="Control")o(this,a);else{w.rangeToTextRange(a).select();this._ranges[0]=a;this.rangeCount=
1;this.isCollapsed=this._ranges[0].collapsed;f(this,a,false)}},t.setRanges=function(a){this.removeAllRanges();var b=a.length;b>1?m(this,a):b&&this.addRange(a[0])};else return c.fail("No means of selecting a Range or TextRange was found"),!1;t.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new x("INDEX_SIZE_ERR");return this._ranges[a]};var N;if(E)N=function(b){var c;if(a.isSelectionValid(b.win))c=b.docSelection.createRange();else{c=p.getBody(b.win.document).createTextRange();c.collapse(true)}b.docSelection.type==
"Control"?l(b):c&&typeof c.text!="undefined"?j(b,c):i(b)};else if(s.isHostMethod(F,"getRangeAt")&&"number"==typeof F.rangeCount)N=function(b){if(L&&M&&b.docSelection.type=="Control")l(b);else{b._ranges.length=b.rangeCount=b.nativeSelection.rangeCount;if(b.rangeCount){for(var c=0,d=b.rangeCount;c<d;++c)b._ranges[c]=new a.WrappedRange(b.nativeSelection.getRangeAt(c));f(b,b._ranges[b.rangeCount-1],X(b.nativeSelection));b.isCollapsed=B(b)}else i(b)}};else if(Q&&"boolean"==typeof F.isCollapsed&&"boolean"==
typeof v.collapsed&&a.features.implementsDomRange)N=function(a){var b;b=a.nativeSelection;if(b.anchorNode){b=J(b,0);a._ranges=[b];a.rangeCount=1;b=a.nativeSelection;a.anchorNode=b.anchorNode;a.anchorOffset=b.anchorOffset;a.focusNode=b.focusNode;a.focusOffset=b.focusOffset;a.isCollapsed=B(a)}else i(a)};else return c.fail("No means of obtaining a Range or TextRange from the user's selection was found"),!1;t.refresh=function(a){var b=a?this._ranges.slice(0):null;N(this);if(a){a=b.length;if(a!=this._ranges.length)return false;
for(;a--;)if(!A.rangesEqual(b[a],this._ranges[a]))return false;return true}};var H=function(a,b){var c=a.getAllRanges(),d=false;a.removeAllRanges();for(var h=0,f=c.length;h<f;++h)d||b!==c[h]?a.addRange(c[h]):d=true;a.rangeCount||i(a)};t.removeRange=L?function(a){if(this.docSelection.type=="Control"){for(var c=this.docSelection.createRange(),a=b(a),d=p.getDocument(c.item(0)),d=p.getBody(d).createControlRange(),h,f=false,e=0,g=c.length;e<g;++e){h=c.item(e);h!==a||f?d.add(c.item(e)):f=true}d.select();
l(this)}else H(this,a)}:function(a){H(this,a)};var X;!E&&Q&&a.features.implementsDomRange?(X=function(a){var b=false;a.anchorNode&&(b=p.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset)==1);return b},t.isBackwards=function(){return X(this)}):X=t.isBackwards=function(){return false};t.toString=function(){for(var a=[],b=0,c=this.rangeCount;b<c;++b)a[b]=""+this._ranges[b];return a.join("")};t.collapse=function(b,c){q(this,b);var d=a.createRange(p.getDocument(b));d.collapseToPoint(b,
c);this.removeAllRanges();this.addRange(d);this.isCollapsed=true};t.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new x("INVALID_STATE_ERR");};t.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new x("INVALID_STATE_ERR");};t.selectAllChildren=function(b){q(this,b);var c=a.createRange(p.getDocument(b));c.selectNodeContents(b);this.removeAllRanges();
this.addRange(c)};t.deleteFromDocument=function(){if(L&&M&&this.docSelection.type=="Control"){for(var a=this.docSelection.createRange(),b;a.length;){b=a.item(0);a.remove(b);b.parentNode.removeChild(b)}this.refresh()}else if(this.rangeCount){a=this.getAllRanges();this.removeAllRanges();b=0;for(var c=a.length;b<c;++b)a[b].deleteContents();this.addRange(a[c-1])}};t.getAllRanges=function(){return this._ranges.slice(0)};t.setSingleRange=function(a){this.setRanges([a])};t.containsNode=function(a,b){for(var c=
0,d=this._ranges.length;c<d;++c)if(this._ranges[c].containsNode(a,b))return true;return false};t.toHtml=function(){var a="";if(this.rangeCount){for(var a=A.getRangeDocument(this._ranges[0]).createElement("div"),b=0,c=this._ranges.length;b<c;++b)a.appendChild(this._ranges[b].cloneContents());a=a.innerHTML}return a};t.getName=function(){return"WrappedSelection"};t.inspect=function(){return r(this)};t.detach=function(){this.win=this.anchorNode=this.focusNode=this.win._rangySelection=null};n.inspect=
r;a.Selection=n;a.selectionPrototype=t;a.addCreateMissingNativeApiListener(function(b){if(typeof b.getSelection=="undefined")b.getSelection=function(){return a.getSelection(this)};b=null})});
...
d=d?d.toString():"";c.detach();return""!=d}function j(a){return a.getNodes([3],function(c){return b(a,c)})}function l(a,b){if(a.attributes.length!=b.attributes.length)return!1;for(var c=0,d=a.attributes.length,f,e;c<d;++c)if(f=a.attributes[c],e=f.name,"class"!=e&&(e=b.attributes.getNamedItem(e),f.specified!=e.specified||f.specified&&f.nodeValue!==e.nodeValue))return!1;return!0}function o(a,b){for(var c=0,d=a.attributes.length,f;c<d;++c)if(f=a.attributes[c].name,(!b||!x.arrayContains(b,f))&&a.attributes[c].specified&&
"class"!=f)return!0;return!1}function n(a){var b;return a&&1==a.nodeType&&((b=a.parentNode)&&9==b.nodeType&&"on"==b.designMode||B(a)&&!B(a.parentNode))}function m(a){return(B(a)||1!=a.nodeType&&B(a.parentNode))&&!n(a)}function q(a){return a&&1==a.nodeType&&!F.test(y(a,"display"))}function r(a){if(0==a.data.length)return!0;if(M.test(a.data))return!1;switch(y(a.parentNode,"whiteSpace")){case "pre":case "pre-wrap":case "-moz-pre-wrap":return!1;case "pre-line":if(/[\r\n]/.test(a.data))return!1}return q(a.previousSibling)||
q(a.nextSibling)}function p(a,b,d,f){var e,g=0==d;if(x.isAncestorOf(b,a))return a;if(x.isCharacterDataNode(b))if(0==d)d=x.getNodeIndex(b),b=b.parentNode;else if(d==b.length)d=x.getNodeIndex(b)+1,b=b.parentNode;else throw c.createError("splitNodeAt should not be called with offset in the middle of a data node ("+d+" in "+b.data);if(x.isCharacterDataNode(b)?0==d?b.previousSibling:d==b.length?b.nextSibling:1:0<d&&d<b.childNodes.length){if(!e){e=b.cloneNode(!1);for(e.id&&e.removeAttribute("id");g=b.childNodes[d];)e.appendChild(g);
x.insertAfter(e,b)}return b==a?e:p(a,e.parentNode,x.getNodeIndex(e),f)}return a!=b?(e=b.parentNode,b=x.getNodeIndex(b),g||b++,p(a,e,b,f)):a}function s(a){var b=a?"nextSibling":"previousSibling";return function(c,d){var f=c.parentNode,e=c[b];if(e){if(e&&3==e.nodeType)return e}else if(d&&(e=f[b])&&1==e.nodeType&&f.tagName==e.tagName&&i(f,e)&&l(f,e))return e[a?"firstChild":"lastChild"];return null}}function A(a){this.firstTextNode=(this.isElementMerge=1==a.nodeType)?a.lastChild:a;this.textNodes=[this.firstTextNode]}
function w(a,b,c){this.cssClass=a;var d,e,g=null;if("object"==typeof b&&null!==b){c=b.tagNames;g=b.elementProperties;for(d=0;e=S[d++];)b.hasOwnProperty(e)&&(this[e]=b[e]);d=b.normalize}else d=b;this.normalize="undefined"==typeof d?!0:d;this.attrExceptions=[];d=document.createElement(this.elementTagName);this.elementProperties={};for(var i in g)g.hasOwnProperty(i)&&(Q.hasOwnProperty(i)&&(i=Q[i]),d[i]=g[i],this.elementProperties[i]=d[i],this.attrExceptions.push(i));this.elementSortedClassName=this.elementProperties.hasOwnProperty("className")?
f(this.elementProperties.className+" "+a):a;this.applyToAnyTagName=!1;a=typeof c;if("string"==a)"*"==c?this.applyToAnyTagName=!0:this.tagNames=c.toLowerCase().replace(/^\s\s*/,"").replace(/\s\s*$/,"").split(/\s*,\s*/);else if("object"==a&&"number"==typeof c.length){this.tagNames=[];d=0;for(a=c.length;d<a;++d)"*"==c[d]?this.applyToAnyTagName=!0:this.tagNames.push(c[d].toLowerCase())}else this.tagNames=[this.elementTagName]}a.requireModules(["WrappedSelection","WrappedRange"]);var x=a.dom,D=function(){function a(b,
c,d){return c&&d?" ":""}return function(b,c){b.className&&(b.className=b.className.replace(RegExp("(?:^|\\s)"+c+"(?:\\s|$)"),a))}}(),y;"undefined"!=typeof window.getComputedStyle?y=function(a,b){return x.getWindow(a).getComputedStyle(a,null)[b]}:"undefined"!=typeof document.documentElement.currentStyle?y=function(a,b){return a.currentStyle[b]}:c.fail("No means of obtaining computed style properties found");var B;(function(){B="boolean"==typeof document.createElement("div").isContentEditable?function(a){return a&&
1==a.nodeType&&a.isContentEditable}:function(a){return!a||1!=a.nodeType||"false"==a.contentEditable?!1:"true"==a.contentEditable||B(a.parentNode)}})();var F=/^inline(-block|-table)?$/i,M=/[^\r\n\t\f \u200B]/,E=s(!1),v=s(!0);A.prototype={doMerge:function(){for(var a=[],b,c,d=0,e=this.textNodes.length;d<e;++d)b=this.textNodes[d],c=b.parentNode,a[d]=b.data,d&&(c.removeChild(b),c.hasChildNodes()||c.parentNode.removeChild(c));return this.firstTextNode.data=a=a.join("")},getLength:function(){for(var a=
this.textNodes.length,b=0;a--;)b+=this.textNodes[a].length;return b},toString:function(){for(var a=[],b=0,c=this.textNodes.length;b<c;++b)a[b]="'"+this.textNodes[b].data+"'";return"[Merge("+a.join(",")+")]"}};var S=["elementTagName","ignoreWhiteSpace","applyToEditableOnly"],Q={"class":"className"};w.prototype={elementTagName:"span",elementProperties:{},ignoreWhiteSpace:!0,applyToEditableOnly:!1,hasClass:function(a){return 1==a.nodeType&&x.arrayContains(this.tagNames,a.tagName.toLowerCase())&&d(a,
this.cssClass)},getSelfOrAncestorWithClass:function(a){for(;a;){if(this.hasClass(a,this.cssClass))return a;a=a.parentNode}return null},isModifiable:function(a){return!this.applyToEditableOnly||m(a)},isIgnorableWhiteSpaceNode:function(a){return this.ignoreWhiteSpace&&a&&3==a.nodeType&&r(a)},postApply:function(a,b,c){for(var d=a[0],e=a[a.length-1],f=[],g,i=d,j=e,l=0,m=e.length,n,q,o=0,r=a.length;o<r;++o)if(n=a[o],q=E(n,!c)){if(g||(g=new A(q),f.push(g)),g.textNodes.push(n),n===d&&(i=g.firstTextNode,
l=i.length),n===e)j=g.firstTextNode,m=g.getLength()}else g=null;if(a=v(e,!c))g||(g=new A(e),f.push(g)),g.textNodes.push(a);if(f.length){o=0;for(r=f.length;o<r;++o)f[o].doMerge();b.setStart(i,l);b.setEnd(j,m)}},createContainer:function(b){b=b.createElement(this.elementTagName);a.util.extend(b,this.elementProperties);e(b,this.cssClass);return b},applyToTextNode:function(a){var b=a.parentNode;1==b.childNodes.length&&x.arrayContains(this.tagNames,b.tagName.toLowerCase())?e(b,this.cssClass):(b=this.createContainer(x.getDocument(a)),
...
return!0},isAppliedToSelection:function(b){for(var b=a.getSelection(b||window).getAllRanges(),c=b.length;c--;)if(!this.isAppliedToRange(b[c]))return!1;return!0},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)},toggleSelection:function(a){this.isAppliedToSelection(a)?this.undoToSelection(a):this.applyToSelection(a)},detach:function(){}};w.util={hasClass:d,addClass:e,removeClass:D,hasSameClasses:i,replaceWithOwnChildren:g,elementsHaveSameNonClassAttributes:l,
elementHasNonClassAttributes:o,splitNodeAt:p,isEditableElement:B,isEditingHost:n,isEditable:m};a.CssClassApplier=w;a.createCssClassApplier=function(a,b,c){return new w(a,b,c)}});
...
c.warn("Marker element has been removed. Cannot restore selection.")}function f(a,b){return b.compareBoundaryPoints(a.START_TO_START,a)}function i(a,b){var c=(a||document).getElementById(b);c&&c.parentNode.removeChild(c)}a.requireModules(["DomUtil","DomRange","WrappedRange"]);var g=a.dom,b="\ufeff";a.saveSelection=function(b){var b=b||window,e=b.document;if(a.isSelectionValid(b)){var g=a.getSelection(b),i=g.getAllRanges(),m=[],q,r;i.sort(f);for(var p=0,s=i.length;p<s;++p)q=i[p],q.collapsed?(r=d(q,
!1),m.push({markerId:r.id,collapsed:!0})):(r=d(q,!1),q=d(q,!0),m[p]={startMarkerId:q.id,endMarkerId:r.id,collapsed:!1,backwards:1==i.length&&g.isBackwards()});for(p=s-1;0<=p;--p)q=i[p],q.collapsed?q.collapseBefore((e||document).getElementById(m[p].markerId)):(q.setEndBefore((e||document).getElementById(m[p].endMarkerId)),q.setStartAfter((e||document).getElementById(m[p].startMarkerId)));g.setRanges(i);return{win:b,doc:e,rangeInfos:m,restored:!1}}c.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
a.restoreSelection=function(b,d){if(!b.restored){for(var f=b.rangeInfos,g=a.getSelection(b.win),i=[],q=f.length,r=q-1,p,s;0<=r;--r){p=f[r];s=a.createRange(b.doc);if(p.collapsed)if(p=(b.doc||document).getElementById(p.markerId)){p.style.display="inline";var A=p.previousSibling;A&&3==A.nodeType?(p.parentNode.removeChild(p),s.collapseToPoint(A,A.length)):(s.collapseBefore(p),p.parentNode.removeChild(p))}else c.warn("Marker element has been removed. Cannot restore selection.");else e(b.doc,s,p.startMarkerId,
!0),e(b.doc,s,p.endMarkerId,!1);1==q&&s.normalizeBoundaries();i[r]=s}1==q&&d&&a.features.selectionHasExtend&&f[0].backwards?(g.removeAllRanges(),g.addRange(i[0],!0)):g.setRanges(i);b.restored=!0}};a.removeMarkerElement=i;a.removeMarkers=function(a){for(var b=a.rangeInfos,c=0,d=b.length,e;c<d;++c)e=b[c],e.collapsed?i(a.doc,e.markerId):(i(a.doc,e.startMarkerId),i(a.doc,e.endMarkerId))}});
...
(function(a,c){function d(a){var b=U[a]={},c,d,a=a.split(/\s+/);c=0;for(d=a.length;c<d;c++)b[a[c]]=!0;return b}function e(a,b,d){if(d===c&&1===a.nodeType)if(d="data-"+b.replace(L,"-$1").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:h.isNumeric(d)?+d:W.test(d)?h.parseJSON(d):d}catch(e){}h.data(a,b,d)}else d=c;return d}function f(a){for(var b in a)if(!("data"===b&&h.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function i(a,b,c){var d=
...
function m(a){return"undefined"!==typeof a.getElementsByTagName?a.getElementsByTagName("*"):"undefined"!==typeof a.querySelectorAll?a.querySelectorAll("*"):[]}function q(a){if("checkbox"===a.type||"radio"===a.type)a.defaultChecked=a.checked}function r(a){var b=(a.nodeName||"").toLowerCase();"input"===b?q(a):"script"!==b&&"undefined"!==typeof a.getElementsByTagName&&h.grep(a.getElementsByTagName("input"),q)}function p(a,b,c){var d="width"===b?a.offsetWidth:a.offsetHeight,e="width"===b?1:0;if(0<d){if("border"!==
c)for(;4>e;e+=2)c||(d-=parseFloat(h.css(a,"padding"+ha[e]))||0),d="margin"===c?d+(parseFloat(h.css(a,c+ha[e]))||0):d-(parseFloat(h.css(a,"border"+ha[e]+"Width"))||0);return d+"px"}d=ka(a,b);if(0>d||null==d)d=a.style[b];if(wa.test(d))return d;d=parseFloat(d)||0;if(c)for(;4>e;e+=2)d+=parseFloat(h.css(a,"padding"+ha[e]))||0,"padding"!==c&&(d+=parseFloat(h.css(a,"border"+ha[e]+"Width"))||0),"margin"===c&&(d+=parseFloat(h.css(a,c+ha[e]))||0);return d+"px"}function s(a){return function(b,c){"string"!==
typeof b&&(c=b,b="*");if(h.isFunction(c))for(var d=b.toLowerCase().split(La),e=0,f=d.length,k,g;e<f;e++)k=d[e],(g=/^\+/.test(k))&&(k=k.substr(1)||"*"),k=a[k]=a[k]||[],k[g?"unshift":"push"](c)}}function A(a,b,d,e,f,k){f=f||b.dataTypes[0];k=k||{};k[f]=!0;for(var f=a[f],g=0,i=f?f.length:0,h=a===xa,j;g<i&&(h||!j);g++)j=f[g](b,d,e),"string"===typeof j&&(!h||k[j]?j=c:(b.dataTypes.unshift(j),j=A(a,b,d,e,j,k)));if((h||!j)&&!k["*"])j=A(a,b,d,e,"*",k);return j}function w(a,b){var d,e,f=h.ajaxSettings.flatOptions||
{};for(d in b)b[d]!==c&&((f[d]?a:e||(e={}))[d]=b[d]);e&&h.extend(!0,a,e)}function x(a,b,c,d){if(h.isArray(b))h.each(b,function(b,e){c||db.test(a)?d(a,e):x(a+"["+("object"===typeof e?b:"")+"]",e,c,d)});else if(!c&&"object"===h.type(b))for(var e in b)x(a+"["+e+"]",b[e],c,d);else d(a,b)}function D(){try{return new a.XMLHttpRequest}catch(b){}}function y(){setTimeout(B,0);return qa=h.now()}function B(){qa=c}function F(a,b){var c={};h.each(ra.concat.apply([],ra.slice(0,b)),function(){c[this]=a});return c}
function M(a){if(!ya[a]){var b=v.body,c=h("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d){ba||(ba=v.createElement("iframe"),ba.frameBorder=ba.width=ba.height=0);b.appendChild(ba);if(!la||!ba.createElement)la=(ba.contentWindow||ba.contentDocument).document,la.write((h.support.boxModel?"<!doctype html>":"")+"<html><body>"),la.close();c=la.createElement(a);la.body.appendChild(c);d=h.css(c,"display");b.removeChild(ba)}ya[a]=d}return ya[a]}function E(a){return h.isWindow(a)?
a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var v=a.document,S=a.navigator,Q=a.location,h=function(){function b(){if(!d.isReady){try{v.documentElement.doScroll("left")}catch(a){setTimeout(b,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,k)},e=a.jQuery,f=a.$,k,g=/^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,i=/\S/,h=/^\s+/,j=/\s+$/,u=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,l=/^[\],:{}\s]*$/,z=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,m=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
n=/(?:^|:|,)(?:\s*\[)+/g,o=/(webkit)[ \/]([\w.]+)/,q=/(opera)(?:.*version)?[ \/]([\w.]+)/,r=/(msie) ([\w.]+)/,K=/(mozilla)(?:.*? rv:([\w.]+))?/,p=/-([a-z]|[0-9])/ig,P=/^-ms-/,s=function(a,b){return(b+"").toUpperCase()},T=S.userAgent,sa,ma,eb=Object.prototype.toString,za=Object.prototype.hasOwnProperty,Aa=Array.prototype.push,w=Array.prototype.slice,A=String.prototype.trim,t=Array.prototype.indexOf,x={};d.fn=d.prototype={constructor:d,init:function(a,b,e){var C;if(!a)return this;if(a.nodeType)return this.context=
this[0]=a,this.length=1,this;if("body"===a&&!b&&v.body)return this.context=v,this[0]=v.body,this.selector=a,this.length=1,this;if("string"===typeof a){if((C="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:g.exec(a))&&(C[1]||!b)){if(C[1])return e=(b=b instanceof d?b[0]:b)?b.ownerDocument||b:v,(a=u.exec(a))?d.isPlainObject(b)?(a=[v.createElement(a[1])],d.fn.attr.call(a,b,!0)):a=[e.createElement(a[1])]:(a=d.buildFragment([C[1]],[e]),a=(a.cacheable?d.clone(a.fragment):a.fragment).childNodes),
d.merge(this,a);if((b=v.getElementById(C[2]))&&b.parentNode){if(b.id!==C[2])return e.find(a);this.length=1;this[0]=b}this.context=v;this.selector=a;return this}return!b||b.jquery?(b||e).find(a):this.constructor(b).find(a)}if(d.isFunction(a))return e.ready(a);a.selector!==c&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,this)},selector:"",jquery:"1.7.2",length:0,size:function(){return this.length},toArray:function(){return w.call(this,0)},get:function(a){return null==a?this.toArray():
...
slice:function(){return this.pushStack(w.apply(this,arguments),"slice",w.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:Aa,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,b,e,C,f,k=arguments[0]||{},g=1,i=arguments.length,h=!1;"boolean"===typeof k&&(h=k,k=arguments[1]||{},g=2);"object"!==typeof k&&!d.isFunction(k)&&(k=
{});i===g&&(k=this,--g);for(;g<i;g++)if(null!=(a=arguments[g]))for(b in a)e=k[b],C=a[b],k!==C&&(h&&C&&(d.isPlainObject(C)||(f=d.isArray(C)))?(f?(f=!1,e=e&&d.isArray(e)?e:[]):e=e&&d.isPlainObject(e)?e:{},k[b]=d.extend(h,e,C)):C!==c&&(k[b]=C));return k};d.extend({noConflict:function(b){a.$===d&&(a.$=f);b&&a.jQuery===d&&(a.jQuery=e);return d},isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!v.body)return setTimeout(d.ready,
1);d.isReady=!0;!0!==a&&0<--d.readyWait||(sa.fireWith(v,[d]),d.fn.trigger&&d(v).trigger("ready").off("ready"))}},bindReady:function(){if(!sa){sa=d.Callbacks("once memory");if("complete"===v.readyState)return setTimeout(d.ready,1);if(v.addEventListener)v.addEventListener("DOMContentLoaded",ma,!1),a.addEventListener("load",d.ready,!1);else if(v.attachEvent){v.attachEvent("onreadystatechange",ma);a.attachEvent("onload",d.ready);var c=!1;try{c=null==a.frameElement}catch(e){}v.documentElement.doScroll&&
...
return e===c||za.call(a,e)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(l.test(b.replace(z,"@").replace(m,"]").replace(n,"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b){if("string"!==typeof b||!b)return null;var e,C;try{a.DOMParser?(C=new DOMParser,e=C.parseFromString(b,"text/xml")):
(e=new ActiveXObject("Microsoft.XMLDOM"),e.async="false",e.loadXML(b))}catch(f){e=c}(!e||!e.documentElement||e.getElementsByTagName("parsererror").length)&&d.error("Invalid XML: "+b);return e},noop:function(){},globalEval:function(b){b&&i.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(P,"ms-").replace(p,s)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,b,e){var C,f=0,k=a.length,g=k===c||d.isFunction(a);
if(e)if(g)for(C in a){if(!1===b.apply(a[C],e))break}else for(;f<k&&!1!==b.apply(a[f++],e););else if(g)for(C in a){if(!1===b.call(a[C],C,a[C]))break}else for(;f<k&&!1!==b.call(a[f],f,a[f++]););return a},trim:A?function(a){return null==a?"":A.call(a)}:function(a){return null==a?"":a.toString().replace(h,"").replace(j,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var e=d.type(a);null==a.length||"string"===e||"function"===e||"regexp"===e||d.isWindow(a)?Aa.call(c,a):d.merge(c,a)}return c},inArray:function(a,
b,c){var d;if(b){if(t)return t.call(b,a,c);d=b.length;for(c=c?0>c?Math.max(0,d+c):c:0;c<d;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,b){var d=a.length,e=0;if("number"===typeof b.length)for(var C=b.length;e<C;e++)a[d++]=b[e];else for(;b[e]!==c;)a[d++]=b[e++];a.length=d;return a},grep:function(a,b,c){for(var d=[],e,c=!!c,C=0,f=a.length;C<f;C++)e=!!b(a[C],C),c!==e&&d.push(a[C]);return d},map:function(a,b,e){var C,f,k=[],g=0,i=a.length;if(a instanceof d||i!==c&&"number"===typeof i&&(0<
i&&a[0]&&a[i-1]||0===i||d.isArray(a)))for(;g<i;g++)C=b(a[g],g,e),null!=C&&(k[k.length]=C);else for(f in a)C=b(a[f],f,e),null!=C&&(k[k.length]=C);return k.concat.apply([],k)},guid:1,proxy:function(a,b){if("string"===typeof b)var e=a[b],b=a,a=e;if(!d.isFunction(a))return c;var C=w.call(arguments,2),e=function(){return a.apply(b,C.concat(w.call(arguments)))};e.guid=a.guid=a.guid||e.guid||d.guid++;return e},access:function(a,b,e,C,f,k,g){var i,h=null==e,j=0,u=a.length;if(e&&"object"===typeof e){for(j in e)d.access(a,
b,j,e[j],1,k,C);f=1}else if(C!==c){i=g===c&&d.isFunction(C);h&&(i?(i=b,b=function(a,b,c){return i.call(d(a),c)}):(b.call(a,C),b=null));if(b)for(;j<u;j++)b(a[j],e,i?C.call(a[j],j,b(a[j],e)):C,g);f=1}return f?a:h?b.call(a):u?b(a[0],e):k},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=o.exec(a)||q.exec(a)||r.exec(a)||0>a.indexOf("compatible")&&K.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,
a,this);a.superclass=this;a.fn=a.prototype=this();a.fn.constructor=a;a.sub=this.sub;a.fn.init=function(c,e){e&&e instanceof d&&!(e instanceof a)&&(e=a(e));return d.fn.init.call(this,c,e,b)};a.fn.init.prototype=a.fn;var b=a(v);return a},browser:{}});d.each("Boolean,Number,String,Function,Array,Date,RegExp,Object".split(","),function(a,b){x["[object "+b+"]"]=b.toLowerCase()});T=d.uaMatch(T);T.browser&&(d.browser[T.browser]=!0,d.browser.version=T.version);d.browser.webkit&&(d.browser.safari=!0);i.test("\u00a0")&&
(h=/^[\s\xA0]+/,j=/[\s\xA0]+$/);k=d(v);v.addEventListener?ma=function(){v.removeEventListener("DOMContentLoaded",ma,false);d.ready()}:v.attachEvent&&(ma=function(){if(v.readyState==="complete"){v.detachEvent("onreadystatechange",ma);d.ready()}});return d}(),U={};h.Callbacks=function(a){var a=a?U[a]||d(a):{},b=[],e=[],f,k,g,i,j,u,l=function(c){var d,e,f,k;d=0;for(e=c.length;d<e;d++)f=c[d],k=h.type(f),"array"===k?l(f):"function"===k&&(!a.unique||!m.has(f))&&b.push(f)},z=function(c,d){d=d||[];f=!a.memory||
...
pixelMargin:!0};h.boxModel=b.boxModel="CSS1Compat"===v.compatMode;c.checked=!0;b.noCloneChecked=c.cloneNode(!0).checked;e.disabled=!0;b.optDisabled=!f.disabled;try{delete j.test}catch(u){b.deleteExpando=!1}!j.addEventListener&&j.attachEvent&&j.fireEvent&&(j.attachEvent("onclick",function(){b.noCloneEvent=!1}),j.cloneNode(!0).fireEvent("onclick"));c=v.createElement("input");c.value="t";c.setAttribute("type","radio");b.radioValue="t"===c.value;c.setAttribute("checked","checked");c.setAttribute("name",
...
(g?a[f]=j=++h.uuid:j=f);i[j]||(i[j]={},g||(i[j].toJSON=h.noop));if("object"===typeof b||"function"===typeof b)e?i[j]=h.extend(i[j],b):i[j].data=h.extend(i[j].data,b);f=a=i[j];e||(a.data||(a.data={}),a=a.data);d!==c&&(a[h.camelCase(b)]=d);if(u&&!a[b])return f.events;k?(d=a[b],null==d&&(d=a[h.camelCase(b)])):d=a;return d}}},removeData:function(a,b,c){if(h.acceptData(a)){var d,e,k,g=h.expando,i=a.nodeType,j=i?h.cache:a,u=i?a[g]:g;if(j[u]){if(b&&(d=c?j[u]:j[u].data)){h.isArray(b)||(b in d?b=[b]:(b=h.camelCase(b),
b=b in d?[b]:b.split(" ")));e=0;for(k=b.length;e<k;e++)delete d[b[e]];if(!(c?f:h.isEmptyObject)(d))return}if(!c&&(delete j[u].data,!f(j[u])))return;h.support.deleteExpando||!j.setInterval?delete j[u]:j[u]=null;i&&(h.support.deleteExpando?delete a[g]:a.removeAttribute?a.removeAttribute(g):a[g]=null)}}},_data:function(a,b,c){return h.data(a,b,c,!0)},acceptData:function(a){if(a.nodeName){var b=h.noData[a.nodeName.toLowerCase()];if(b)return!(!0===b||a.getAttribute("classid")!==b)}return!0}});h.fn.extend({data:function(a,
b){var d,f,k,g,i,j=this[0],u=0,l=null;if(a===c){if(this.length&&(l=h.data(j),1===j.nodeType&&!h._data(j,"parsedAttrs"))){k=j.attributes;for(i=k.length;u<i;u++)g=k[u].name,0===g.indexOf("data-")&&(g=h.camelCase(g.substring(5)),e(j,g,l[g]));h._data(j,"parsedAttrs",!0)}return l}if("object"===typeof a)return this.each(function(){h.data(this,a)});d=a.split(".",2);d[1]=d[1]?"."+d[1]:"";f=d[1]+"!";return h.access(this,function(b){if(b===c)return l=this.triggerHandler("getData"+f,[d[0]]),l===c&&j&&(l=h.data(j,
...
{set:function(a,b){if(h.isArray(b))return a.checked=h.inArray(h(a).val(),b)>=0}})});var ea=/^(?:textarea|input|select)$/i,V=/^([^\.]*)?(?:\.(.+))?$/,k=/(?:^|\s)hover(\.\S+)?\b/,u=/^key/,z=/^(?:mouse|contextmenu)|click/,K=/^(?:focusinfocus|focusoutblur)$/,P=/^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/,T=function(a){if(a=P.exec(a)){a[1]=(a[1]||"").toLowerCase();a[3]=a[3]&&RegExp("(?:^|\\s)"+a[3]+"(?:\\s|$)")}return a},da=function(a){return h.event.special.hover?a:a.replace(k,"mouseenter$1 mouseleave$1")};
h.event={add:function(a,b,d,e,f){var k,g,i,j,u,l,m,z,n;if(!(a.nodeType===3||a.nodeType===8||!b||!d||!(k=h._data(a)))){if(d.handler){m=d;d=m.handler;f=m.selector}if(!d.guid)d.guid=h.guid++;i=k.events;if(!i)k.events=i={};g=k.handle;if(!g){k.handle=g=function(a){return typeof h!=="undefined"&&(!a||h.event.triggered!==a.type)?h.event.dispatch.apply(g.elem,arguments):c};g.elem=a}b=h.trim(da(b)).split(" ");for(k=0;k<b.length;k++){j=V.exec(b[k])||[];u=j[1];l=(j[2]||"").split(".").sort();n=h.event.special[u]||
{};u=(f?n.delegateType:n.bindType)||u;n=h.event.special[u]||{};j=h.extend({type:u,origType:j[1],data:e,handler:d,guid:d.guid,selector:f,quick:f&&T(f),namespace:l.join(".")},m);z=i[u];if(!z){z=i[u]=[];z.delegateCount=0;if(!n.setup||n.setup.call(a,e,l,g)===false)a.addEventListener?a.addEventListener(u,g,false):a.attachEvent&&a.attachEvent("on"+u,g)}if(n.add){n.add.call(a,j);if(!j.handler.guid)j.handler.guid=d.guid}f?z.splice(z.delegateCount++,0,j):z.push(j);h.event.global[u]=true}a=null}},global:{},
remove:function(a,b,c,d,e){var f=h.hasData(a)&&h._data(a),k,g,i,j,u,l,z,m,n,o;if(f&&(z=f.events)){b=h.trim(da(b||"")).split(" ");for(k=0;k<b.length;k++){g=V.exec(b[k])||[];i=j=g[1];g=g[2];if(i){m=h.event.special[i]||{};i=(d?m.delegateType:m.bindType)||i;n=z[i]||[];u=n.length;g=g?RegExp("(^|\\.)"+g.split(".").sort().join("\\.(?:.*\\.)?")+"(\\.|$)"):null;for(l=0;l<n.length;l++){o=n[l];if((e||j===o.origType)&&(!c||c.guid===o.guid)&&(!g||g.test(o.namespace))&&(!d||d===o.selector||d==="**"&&o.selector)){n.splice(l--,
1);o.selector&&n.delegateCount--;m.remove&&m.remove.call(a,o)}}if(n.length===0&&u!==n.length){(!m.teardown||m.teardown.call(a,g)===false)&&h.removeEvent(a,i,f.handle);delete z[i]}}else for(i in z)h.event.remove(a,i+b[k],c,d,true)}if(h.isEmptyObject(z)){if(b=f.handle)b.elem=null;h.removeData(a,["events","handle"],true)}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(b,d,e,f){if(!e||!(e.nodeType===3||e.nodeType===8)){var k=b.type||b,g=[],i,j,u,l,m;if(!K.test(k+h.event.triggered)){if(k.indexOf("!")>=
...
u.trigger.apply(e,d)===false)){m=[[e,u.bindType||k]];if(!f&&!u.noBubble&&!h.isWindow(e)){l=u.delegateType||k;g=K.test(l+k)?e:e.parentNode;for(j=null;g;g=g.parentNode){m.push([g,l]);j=g}j&&j===e.ownerDocument&&m.push([j.defaultView||j.parentWindow||a,l])}for(j=0;j<m.length&&!b.isPropagationStopped();j++){g=m[j][0];b.type=m[j][1];(l=(h._data(g,"events")||{})[b.type]&&h._data(g,"handle"))&&l.apply(g,d);(l=i&&g[i])&&h.acceptData(g)&&l.apply(g,d)===false&&b.preventDefault()}b.type=k;if(!f&&!b.isDefaultPrevented()&&
...
f=[].slice.call(arguments,0),k=!b.exclusive&&!b.namespace,g=h.event.special[b.type]||{},i=[],j,u,l,m,z,n,o;f[0]=b;b.delegateTarget=this;if(!(g.preDispatch&&g.preDispatch.call(this,b)===false)){if(e&&!(b.button&&b.type==="click")){l=h(this);l.context=this.ownerDocument||this;for(u=b.target;u!=this;u=u.parentNode||this)if(u.disabled!==true){z={};n=[];l[0]=u;for(j=0;j<e;j++){m=d[j];o=m.selector;if(z[o]===c){var q=z,r=o,K;if(m.quick){K=m.quick;var p=u.attributes||{};K=(!K[1]||u.nodeName.toLowerCase()===
K[1])&&(!K[2]||(p.id||{}).value===K[2])&&(!K[3]||K[3].test((p["class"]||{}).value))}else K=l.is(o);q[r]=K}z[o]&&n.push(m)}n.length&&i.push({elem:u,matches:n})}}d.length>e&&i.push({elem:this,matches:d.slice(e)});for(j=0;j<i.length&&!b.isPropagationStopped();j++){e=i[j];b.currentTarget=e.elem;for(d=0;d<e.matches.length&&!b.isImmediatePropagationStopped();d++){m=e.matches[d];if(k||!b.namespace&&!m.namespace||b.namespace_re&&b.namespace_re.test(m.namespace)){b.data=m.data;b.handleObj=m;m=((h.event.special[m.origType]||
...
postDispatch:function(a){if(a._submit_bubble){delete a._submit_bubble;this.parentNode&&!a.isTrigger&&h.event.simulate("submit",this.parentNode,a,true)}},teardown:function(){if(h.nodeName(this,"form"))return false;h.event.remove(this,"._submit")}});h.support.changeBubbles||(h.event.special.change={setup:function(){if(ea.test(this.nodeName)){if(this.type==="checkbox"||this.type==="radio"){h.event.add(this,"propertychange._change",function(a){if(a.originalEvent.propertyName==="checked")this._just_changed=
true});h.event.add(this,"click._change",function(a){if(this._just_changed&&!a.isTrigger){this._just_changed=false;h.event.simulate("change",this,a,true)}})}return false}h.event.add(this,"beforeactivate._change",function(a){a=a.target;if(ea.test(a.nodeName)&&!a._change_attached){h.event.add(a,"change._change",function(a){this.parentNode&&!a.isSimulated&&!a.isTrigger&&h.event.simulate("change",this.parentNode,a,true)});a._change_attached=true}})},handle:function(a){var b=a.target;if(this!==b||a.isSimulated||
a.isTrigger||b.type!=="radio"&&b.type!=="checkbox")return a.handleObj.handler.apply(this,arguments)},teardown:function(){h.event.remove(this,"._change");return ea.test(this.nodeName)}});h.support.focusinBubbles||h.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){h.event.simulate(b,a.target,h.event.fix(a),true)};h.event.special[b]={setup:function(){c++===0&&v.addEventListener(a,d,true)},teardown:function(){--c===0&&v.removeEventListener(a,d,true)}}});h.fn.extend({on:function(a,
...
function(a,b,c,e){var c=c||[],f=b=b||v;if(b.nodeType!==1&&b.nodeType!==9)return[];if(!a||typeof a!=="string")return c;var g,i,j,h,u,C=true,l=m.isXML(b),z=[],q=a;do{d.exec("");if(g=d.exec(q)){q=g[3];z.push(g[1]);if(g[2]){h=g[3];break}}}while(g);if(z.length>1&&o.exec(a))if(z.length===2&&n.relative[z[0]])i=T(z[0]+z[1],b,e);else for(i=n.relative[z[0]]?[b]:m(z.shift(),b);z.length;){a=z.shift();n.relative[a]&&(a=a+z.shift());i=T(a,i,e)}else{if(!e&&z.length>1&&b.nodeType===9&&!l&&n.match.ID.test(z[0])&&
!n.match.ID.test(z[z.length-1])){g=m.find(z.shift(),b,l);b=g.expr?m.filter(g.expr,g.set)[0]:g.set[0]}if(b){g=e?{expr:z.pop(),set:r(e)}:m.find(z.pop(),z.length===1&&(z[0]==="~"||z[0]==="+")&&b.parentNode?b.parentNode:b,l);i=g.expr?m.filter(g.expr,g.set):g.set;for(z.length>0?j=r(i):C=false;z.length;){g=u=z.pop();n.relative[u]?g=z.pop():u="";g==null&&(g=b);n.relative[u](j,g,l)}}else j=[]}j||(j=i);j||m.error(u||a);if(k.call(j)==="[object Array]")if(C)if(b&&b.nodeType===1)for(a=0;j[a]!=null;a++)j[a]&&
...
"iframe")?a.contentDocument||a.contentWindow.document:h.makeArray(a.childNodes)}},function(a,b){h.fn[a]=function(c,d){var e=h.map(this,b,c);Y.test(a)||(d=c);d&&typeof d==="string"&&(e=h.filter(d,e));e=this.length>1&&!Ya[a]?h.unique(e):e;if((this.length>1||oa.test(d))&&pa.test(a))e=e.reverse();return this.pushStack(e,a,Xa.call(arguments).join(","))}});h.extend({filter:function(a,b,c){c&&(a=":not("+a+")");return b.length===1?h.find.matchesSelector(b[0],a)?[b[0]]:[]:h.find.matches(a,b)},dir:function(a,
...
va=/^\s+/,Ga=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Ha=/<([\w:]+)/,$a=/<tbody/i,ab=/<|&#?\w+;/,bb=/<(?:script|style)/i,cb=/<(?:script|object|embed|option|style)/i,Ia=RegExp("<(?:"+Fa+")[\\s/>]","i"),Ja=/checked\s*(?:[^=]|=\s*.checked.)/i,Ka=/\/(java|ecma)script/i,fb=/^\s*<!(?:\[CDATA\[|\-\-)/,$={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,
"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]},Ba=l(v);$.optgroup=$.option;$.tbody=$.tfoot=$.colgroup=$.caption=$.thead;$.th=$.td;h.support.htmlSerialize||($._default=[1,"div<div>","</div>"]);h.fn.extend({text:function(a){return h.access(this,function(a){return a===c?h.text(this):this.empty().append((this[0]&&this[0].ownerDocument||v).createTextNode(a))},null,a,arguments.length)},wrapAll:function(a){if(h.isFunction(a))return this.each(function(b){h(this).wrapAll(a.call(this,
...
f,b=h.camelCase(b);f=h.cssHooks[b];b=h.cssProps[b]||b;b==="cssFloat"&&(b="float");if(f&&"get"in f&&(e=f.get(a,true,d))!==c)return e;if(ka)return ka(a,b)},swap:function(a,b,c){var d={},e;for(e in b){d[e]=a.style[e];a.style[e]=b[e]}c=c.call(a);for(e in b)a.style[e]=d[e];return c}});h.curCSS=h.css;v.defaultView&&v.defaultView.getComputedStyle&&(Ma=function(a,b){var c,d,e,f=a.style,b=b.replace(hb,"-$1").toLowerCase();if((d=a.ownerDocument.defaultView)&&(e=d.getComputedStyle(a,null))){c=e.getPropertyValue(b);
c===""&&!h.contains(a.ownerDocument.documentElement,a)&&(c=h.style(a,b))}if(!h.support.pixelMargin&&e&&kb.test(b)&&wa.test(c)){d=f.width;f.width=c;c=e.width;f.width=d}return c});v.documentElement.currentStyle&&(Na=function(a,b){var c,d,e=a.currentStyle&&a.currentStyle[b],f=a.style;if(e==null&&f&&(c=f[b]))e=c;if(wa.test(e)){c=f.left;if(d=a.runtimeStyle&&a.runtimeStyle.left)a.runtimeStyle.left=a.currentStyle.left;f.left=b==="fontSize"?"1em":e;e=f.pixelLeft+"px";f.left=c;if(d)a.runtimeStyle.left=d}return e===
""?"auto":e});ka=Ma||Na;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){if(c)return a.offsetWidth!==0?p(a,b,d):h.swap(a,lb,function(){return p(a,b,d)})},set:function(a,b){return ib.test(b)?b+"px":b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return gb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,e=h.isNumeric(b)?"alpha(opacity="+b*100+")":"",f=
d&&d.filter||c.filter||"";c.zoom=1;if(b>=1&&h.trim(f.replace(Ca,""))===""){c.removeAttribute("filter");if(d&&!d.filter)return}c.filter=Ca.test(f)?f.replace(Ca,e):f+" "+e}});h(function(){if(!h.support.reliableMarginRight)h.cssHooks.marginRight={get:function(a,b){return h.swap(a,{display:"inline-block"},function(){return b?ka(a,"margin-right"):a.style.marginRight})}}});h.expr&&h.expr.filters&&(h.expr.filters.hidden=function(a){var b=a.offsetHeight;return a.offsetWidth===0&&b===0||!h.support.reliableHiddenOffsets&&
(a.style&&a.style.display||h.css(a,"display"))==="none"},h.expr.filters.visible=function(a){return!h.expr.filters.hidden(a)});h.each({margin:"",padding:"",border:"Width"},function(a,b){h.cssHooks[a+b]={expand:function(c){for(var d=typeof c==="string"?c.split(" "):[c],e={},c=0;c<4;c++)e[a+ha[c]+b]=d[c]||d[c-2]||d[0];return e}}});var mb=/%20/g,db=/\[\]$/,Oa=/\r?\n/g,nb=/#.*$/,ob=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,pb=/^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
qb=/^(?:GET|HEAD)$/,rb=/^\/\//,Pa=/\?/,sb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,tb=/^(?:select|textarea)/i,La=/\s+/,ub=/([?&])_=[^&]*/,Qa=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Ra=h.fn.load,xa={},Sa={},ia,ja,Ta=["*/"]+["*"];try{ia=Q.href}catch(Ab){ia=v.createElement("a"),ia.href="",ia=ia.href}ja=Qa.exec(ia.toLowerCase())||[];h.fn.extend({load:function(a,b,d){if(typeof a!=="string"&&Ra)return Ra.apply(this,arguments);if(!this.length)return this;var e=a.indexOf(" ");if(e>=
...
function(a,b){h[b]=function(a,d,e,f){if(h.isFunction(d)){f=f||e;e=d;d=c}return h.ajax({type:b,url:a,data:d,success:e,dataType:f})}});h.extend({getScript:function(a,b){return h.get(a,c,b,"script")},getJSON:function(a,b,c){return h.get(a,b,c,"json")},ajaxSetup:function(a,b){if(b)w(a,h.ajaxSettings);else{b=a;a=h.ajaxSettings}w(a,b);return a},ajaxSettings:{url:ia,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/.test(ja[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",
processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Ta},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:s(xa),ajaxTransport:s(Sa),ajax:function(a,b){function d(a,b,m,l){if(K!==2){K=2;q&&clearTimeout(q);o=c;z=l||"";s.readyState=
a>0?4:0;var n,r,C,l=b;if(m){var P=e,T=s,w=P.contents,fa=P.dataTypes,A=P.responseFields,t,v,ga,x;for(v in A)v in m&&(T[A[v]]=m[v]);for(;fa[0]==="*";){fa.shift();t===c&&(t=P.mimeType||T.getResponseHeader("content-type"))}if(t)for(v in w)if(w[v]&&w[v].test(t)){fa.unshift(v);break}if(fa[0]in m)ga=fa[0];else{for(v in m){if(!fa[0]||P.converters[v+" "+fa[0]]){ga=v;break}x||(x=v)}ga=ga||x}if(ga){ga!==fa[0]&&fa.unshift(ga);m=m[ga]}else m=void 0}else m=c;if(a>=200&&a<300||a===304){if(e.ifModified){if(t=s.getResponseHeader("Last-Modified"))h.lastModified[u]=
t;if(t=s.getResponseHeader("Etag"))h.etag[u]=t}if(a===304){l="notmodified";n=true}else try{t=e;t.dataFilter&&(m=t.dataFilter(m,t.dataType));var da=t.dataTypes;v={};var y,D,F=da.length,B,Y=da[0],E,G,I,H,J;for(y=1;y<F;y++){if(y===1)for(D in t.converters)typeof D==="string"&&(v[D.toLowerCase()]=t.converters[D]);E=Y;Y=da[y];if(Y==="*")Y=E;else if(E!=="*"&&E!==Y){G=E+" "+Y;I=v[G]||v["* "+Y];if(!I){J=c;for(H in v){B=H.split(" ");if(B[0]===E||B[0]==="*")if(J=v[B[1]+" "+Y]){H=v[H];H===true?I=J:J===true&&
(I=H);break}}}!I&&!J&&h.error("No conversion from "+G.replace(" "," to "));I!==true&&(m=I?I(m):J(H(m)))}}r=m;l="success";n=true}catch(L){l="parsererror";C=L}}else{C=l;if(!l||a){l="error";a<0&&(a=0)}}s.status=a;s.statusText=""+(b||l);n?g.resolveWith(f,[r,l,s]):g.rejectWith(f,[s,l,C]);s.statusCode(j);j=c;p&&k.trigger("ajax"+(n?"Success":"Error"),[s,e,n?r:C]);i.fireWith(f,[s,l]);if(p){k.trigger("ajaxComplete",[s,e]);--h.active||h.event.trigger("ajaxStop")}}}if(typeof a==="object"){b=a;a=c}var b=b||{},
e=h.ajaxSetup({},b),f=e.context||e,k=f!==e&&(f.nodeType||f instanceof h)?h(f):h.event,g=h.Deferred(),i=h.Callbacks("once memory"),j=e.statusCode||{},u,m={},l={},z,n,o,q,r,K=0,p,P,s={readyState:0,setRequestHeader:function(a,b){if(!K){var c=a.toLowerCase(),a=l[c]=l[c]||a;m[a]=b}return this},getAllResponseHeaders:function(){return K===2?z:null},getResponseHeader:function(a){var b;if(K===2){if(!n)for(n={};b=ob.exec(z);)n[b[1].toLowerCase()]=b[2];b=n[a.toLowerCase()]}return b===c?null:b},overrideMimeType:function(a){if(!K)e.mimeType=
a;return this},abort:function(a){a=a||"abort";o&&o.abort(a);d(0,a);return this}};g.promise(s);s.success=s.done;s.error=s.fail;s.complete=i.add;s.statusCode=function(a){if(a){var b;if(K<2)for(b in a)j[b]=[j[b],a[b]];else{b=a[s.status];s.then(b,b)}}return this};e.url=((a||e.url)+"").replace(nb,"").replace(rb,ja[1]+"//");e.dataTypes=h.trim(e.dataType||"*").toLowerCase().split(La);if(e.crossDomain==null){r=Qa.exec(e.url.toLowerCase());e.crossDomain=!(!r||!(r[1]!=ja[1]||r[2]!=ja[2]||(r[3]||(r[1]==="http:"?
80:443))!=(ja[3]||(ja[1]==="http:"?80:443))))}if(e.data&&e.processData&&typeof e.data!=="string")e.data=h.param(e.data,e.traditional);A(xa,e,b,s);if(K===2)return false;p=e.global;e.type=e.type.toUpperCase();e.hasContent=!qb.test(e.type);p&&h.active++===0&&h.event.trigger("ajaxStart");if(!e.hasContent){if(e.data){e.url=e.url+((Pa.test(e.url)?"&":"?")+e.data);delete e.data}u=e.url;if(e.cache===false){r=h.now();var T=e.url.replace(ub,"$1_="+r);e.url=T+(T===e.url?(Pa.test(e.url)?"&":"?")+"_="+r:"")}}(e.data&&
e.hasContent&&e.contentType!==false||b.contentType)&&s.setRequestHeader("Content-Type",e.contentType);if(e.ifModified){u=u||e.url;h.lastModified[u]&&s.setRequestHeader("If-Modified-Since",h.lastModified[u]);h.etag[u]&&s.setRequestHeader("If-None-Match",h.etag[u])}s.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+(e.dataTypes[0]!=="*"?", "+Ta+"; q=0.01":""):e.accepts["*"]);for(P in e.headers)s.setRequestHeader(P,e.headers[P]);if(e.beforeSend&&(e.beforeSend.call(f,
s,e)===false||K===2)){s.abort();return false}for(P in{success:1,error:1,complete:1})s[P](e[P]);if(o=A(Sa,e,b,s)){s.readyState=1;p&&k.trigger("ajaxSend",[s,e]);e.async&&e.timeout>0&&(q=setTimeout(function(){s.abort("timeout")},e.timeout));try{K=1;o.send(m,d)}catch(w){if(K<2)d(-1,w);else throw w;}}else d(-1,"No Transport");return s},param:function(a,b){var d=[],e=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(b===c)b=h.ajaxSettings.traditional;
if(h.isArray(a)||a.jquery&&!h.isPlainObject(a))h.each(a,function(){e(this.name,this.value)});else for(var f in a)x(f,a[f],b,e);return d.join("&").replace(mb,"+")}});h.extend({active:0,lastModified:{},etag:{}});var vb=h.now(),ta=/(\=)\?(&|$)|\?\?/i;h.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return h.expando+"_"+vb++}});h.ajaxPrefilter("json jsonp",function(b,c,d){c=typeof b.data==="string"&&/^application\/x\-www\-form\-urlencoded/.test(b.contentType);if(b.dataTypes[0]==="jsonp"||b.jsonp!==
...
f){b=v.createElement("script");b.async="async";if(a.scriptCharset)b.charset=a.scriptCharset;b.src=a.url;b.onload=b.onreadystatechange=function(a,e){if(e||!b.readyState||/loaded|complete/.test(b.readyState)){b.onload=b.onreadystatechange=null;d&&b.parentNode&&d.removeChild(b);b=c;e||f(200,"success")}};d.insertBefore(b,d.firstChild)},abort:function(){if(b)b.onload(0,1)}}}});var Da=a.ActiveXObject?function(){for(var a in na)na[a](0,1)}:!1,wb=0,na;h.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=
!this.isLocal&&D()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:D;(function(a){h.extend(h.support,{ajax:!!a,cors:!!a&&"withCredentials"in a})})(h.ajaxSettings.xhr());h.support.ajax&&h.ajaxTransport(function(b){if(!b.crossDomain||h.support.cors){var d;return{send:function(e,f){var k=b.xhr(),g,i;b.username?k.open(b.type,b.url,b.async,b.username,b.password):k.open(b.type,b.url,b.async);if(b.xhrFields)for(i in b.xhrFields)k[i]=b.xhrFields[i];b.mimeType&&k.overrideMimeType&&
k.overrideMimeType(b.mimeType);!b.crossDomain&&!e["X-Requested-With"]&&(e["X-Requested-With"]="XMLHttpRequest");try{for(i in e)k.setRequestHeader(i,e[i])}catch(j){}k.send(b.hasContent&&b.data||null);d=function(a,e){var i,j,u,m,l;try{if(d&&(e||k.readyState===4)){d=c;if(g){k.onreadystatechange=h.noop;Da&&delete na[g]}if(e)k.readyState!==4&&k.abort();else{i=k.status;u=k.getAllResponseHeaders();m={};if((l=k.responseXML)&&l.documentElement)m.xml=l;try{m.text=k.responseText}catch(z){}try{j=k.statusText}catch(n){j=
""}!i&&b.isLocal&&!b.crossDomain?i=m.text?200:404:i===1223&&(i=204)}}}catch(o){e||f(-1,o)}m&&f(i,j,m,u)};if(!b.async||k.readyState===4)d();else{g=++wb;if(Da){if(!na){na={};h(a).unload(Da)}na[g]=d}k.onreadystatechange=d}},abort:function(){d&&d(0,1)}}}});var ya={},ba,la,xb=/^(?:toggle|show|hide)$/,yb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,ua,ra=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],qa;h.fn.extend({show:function(a,
b,c){if(a||a===0)return this.animate(F("show",3),a,b,c);for(var c=0,d=this.length;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(!h._data(a,"olddisplay")&&b==="none")b=a.style.display="";(b===""&&h.css(a,"display")==="none"||!h.contains(a.ownerDocument.documentElement,a))&&h._data(a,"olddisplay",M(a.nodeName))}}for(c=0;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(b===""||b==="none")a.style.display=h._data(a,"olddisplay")||""}}return this},hide:function(a,b,c){if(a||a===0)return this.animate(F("hide",
...
g[1];g=a[k]=g[0]}else b.animatedProperties[k]=b.specialEasing&&b.specialEasing[k]||b.easing||"swing";if(g==="hide"&&d||g==="show"&&!d)return b.complete.call(this);if(c&&(k==="height"||k==="width")){b.overflow=[this.style.overflow,this.style.overflowX,this.style.overflowY];if(h.css(this,"display")==="inline"&&h.css(this,"float")==="none")!h.support.inlineBlockNeedsLayout||M(this.nodeName)==="inline"?this.style.display="inline-block":this.style.zoom=1}}if(b.overflow!=null)this.style.overflow="hidden";
...
g=d.offset.left,b=g+e.helperProportions.width,j=d.offset.top,l=j+e.helperProportions.height,o=e.snapElements.length-1;0<=o;o--){var n=e.snapElements[o].left,m=n+e.snapElements[o].width,q=e.snapElements[o].top,r=q+e.snapElements[o].height;if(n-i<g&&g<m+i&&q-i<j&&j<r+i||n-i<g&&g<m+i&&q-i<l&&l<r+i||n-i<b&&b<m+i&&q-i<j&&j<r+i||n-i<b&&b<m+i&&q-i<l&&l<r+i){if("inner"!=f.snapMode){var p=Math.abs(q-l)<=i,s=Math.abs(r-j)<=i,A=Math.abs(n-b)<=i,w=Math.abs(m-g)<=i;p&&(d.position.top=e._convertPositionTo("relative",
{top:q-e.helperProportions.height,left:0}).top-e.margins.top);s&&(d.position.top=e._convertPositionTo("relative",{top:r,left:0}).top-e.margins.top);A&&(d.position.left=e._convertPositionTo("relative",{top:0,left:n-e.helperProportions.width}).left-e.margins.left);w&&(d.position.left=e._convertPositionTo("relative",{top:0,left:m}).left-e.margins.left)}var x=p||s||A||w;if("outer"!=f.snapMode&&(p=Math.abs(q-j)<=i,s=Math.abs(r-l)<=i,A=Math.abs(n-g)<=i,w=Math.abs(m-b)<=i,p&&(d.position.top=e._convertPositionTo("relative",
{top:q,left:0}).top-e.margins.top),s&&(d.position.top=e._convertPositionTo("relative",{top:r-e.helperProportions.height,left:0}).top-e.margins.top),A&&(d.position.left=e._convertPositionTo("relative",{top:0,left:n}).left-e.margins.left),w))d.position.left=e._convertPositionTo("relative",{top:0,left:m-e.helperProportions.width}).left-e.margins.left;!e.snapElements[o].snapping&&(p||s||A||w||x)&&e.options.snap.snap&&e.options.snap.snap.call(e.element,c,a.extend(e._uiHash(),{snapItem:e.snapElements[o].item}));
e.snapElements[o].snapping=p||s||A||w||x}else e.snapElements[o].snapping&&e.options.snap.release&&e.options.snap.release.call(e.element,c,a.extend(e._uiHash(),{snapItem:e.snapElements[o].item})),e.snapElements[o].snapping=!1}}});a.ui.plugin.add("draggable","stack",{start:function(){var c=a(this).data("draggable").options,c=a.makeArray(a(c.stack)).sort(function(c,d){return(parseInt(a(c).css("zIndex"),10)||0)-(parseInt(a(d).css("zIndex"),10)||0)});if(c.length){var d=parseInt(c[0].style.zIndex)||0;a(c).each(function(a){this.style.zIndex=
...
" ",A=f(e.call(this)),w,x=j.attr("class")||"";a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});w=f(e.call(this));j.attr("class",x);j.animate(i(A,w),{queue:false,duration:c,easing:d,complete:function(){a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});if(typeof j.attr("style")=="object"){j.attr("style").cssText="";j.attr("style").cssText=o}else j.attr("style",o);g&&g.apply(this,arguments);a.dequeue(this)}})})};a.fn.extend({_addClass:a.fn.addClass,addClass:function(b,c,d,e){return c?a.effects.animateClass.apply(this,
...
c.options.mode||"effect"),o=c.options.restore||!1,n=c.options.scale||"both",m=c.options.origin,q={height:d.height(),width:d.width()};d.from=c.options.from||q;d.to=c.options.to||q;m&&(m=a.effects.getBaseline(m,q),d.from.top=(q.height-d.from.height)*m.y,d.from.left=(q.width-d.from.width)*m.x,d.to.top=(q.height-d.to.height)*m.y,d.to.left=(q.width-d.to.width)*m.x);var r=d.from.height/q.height,p=d.from.width/q.width,s=d.to.height/q.height,A=d.to.width/q.width;if("box"==n||"both"==n)if(r!=s&&(e=e.concat(b),
d.from=a.effects.setTransition(d,b,r,d.from),d.to=a.effects.setTransition(d,b,s,d.to)),p!=A)e=e.concat(j),d.from=a.effects.setTransition(d,j,p,d.from),d.to=a.effects.setTransition(d,j,A,d.to);if(("content"==n||"both"==n)&&r!=s)e=e.concat(g),d.from=a.effects.setTransition(d,g,r,d.from),d.to=a.effects.setTransition(d,g,s,d.to);a.effects.save(d,o?e:f);d.show();a.effects.createWrapper(d);d.css("overflow","hidden").css(d.from);if("content"==n||"both"==n)b=b.concat(["marginTop","marginBottom"]).concat(g),
j=j.concat(["marginLeft","marginRight"]),i=e.concat(b).concat(j),d.find("*[width]").each(function(){var d=a(this);o&&a.effects.save(d,i);var e=d.height(),g=d.width();d.from={height:e*r,width:g*p};d.to={height:e*s,width:g*A};if(r!=s){d.from=a.effects.setTransition(d,b,r,d.from);d.to=a.effects.setTransition(d,b,s,d.to)}if(p!=A){d.from=a.effects.setTransition(d,j,p,d.from);d.to=a.effects.setTransition(d,j,A,d.to)}d.css(d.from);d.animate(d.to,c.duration,c.options.easing,function(){o&&a.effects.restore(d,
...
(i={},i[d]=e);if(g){this._curInst==g&&this._hideDatepicker();var m=this._getDateDatepicker(b,!0),q=this._getMinMaxDate(g,"min"),r=this._getMinMaxDate(g,"max");f(g.settings,i);null!==q&&i.dateFormat!==c&&i.minDate===c&&(g.settings.minDate=this._formatDate(g,q));null!==r&&i.dateFormat!==c&&i.maxDate===c&&(g.settings.maxDate=this._formatDate(g,r));this._attachments(a(b),g);this._autoSize(g);this._setDate(g,m);this._updateAlternate(g);this._updateDatepicker(g)}},_changeDatepicker:function(a,c,d){this._optionDatepicker(a,
...
b.yearshtml;setTimeout(function(){e===b.yearshtml&&b.yearshtml&&b.dpDiv.find("select.ui-datepicker-year:first").replaceWith(b.yearshtml);e=b.yearshtml=null},0)}},_getBorders:function(a){var c=function(a){return{thin:1,medium:2,thick:3}[a]||a};return[parseFloat(c(a.css("border-left-width"))),parseFloat(c(a.css("border-top-width")))]},_checkOffset:function(b,c,d){var e=b.dpDiv.outerWidth(),g=b.dpDiv.outerHeight(),f=b.input?b.input.outerWidth():0,i=b.input?b.input.outerHeight():0,r=document.documentElement.clientWidth+
a(document).scrollLeft(),p=document.documentElement.clientHeight+a(document).scrollTop();c.left-=this._get(b,"isRTL")?e-f:0;c.left-=d&&c.left==b.input.offset().left?a(document).scrollLeft():0;c.top-=d&&c.top==b.input.offset().top+i?a(document).scrollTop():0;c.left-=Math.min(c.left,c.left+e>r&&r>e?Math.abs(c.left+e-r):0);c.top-=Math.min(c.top,c.top+g>p&&p>g?Math.abs(g+i):0);return c},_findPos:function(b){for(var c=this._get(this._getInst(b),"isRTL");b&&("hidden"==b.type||1!=b.nodeType||a.expr.filters.hidden(b));)b=
...
e="string"!=typeof e?e:(new Date).getFullYear()%100+parseInt(e,10),g=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,f=(d?d.dayNames:null)||this._defaults.dayNames,i=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,r=(d?d.monthNames:null)||this._defaults.monthNames,p=d=-1,s=-1,A=-1,w=!1,x=function(a){(a=M+1<b.length&&b.charAt(M+1)==a)&&M++;return a},D=function(a){var b=x(a),a=c.substring(F).match(RegExp("^\\d{1,"+("@"==a?14:"!"==a?20:"y"==a&&b?4:"o"==a?3:2)+"}"));if(!a)throw"Missing number at position "+
F;F+=a[0].length;return parseInt(a[0],10)},y=function(b,d,e){var b=a.map(x(b)?e:d,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)}),g=-1;a.each(b,function(a,b){var d=b[1];if(c.substr(F,d.length).toLowerCase()==d.toLowerCase())return g=b[0],F+=d.length,!1});if(-1!=g)return g+1;throw"Unknown name at position "+F;},B=function(){if(c.charAt(F)!=b.charAt(M))throw"Unexpected literal at position "+F;F++},F=0,M=0;M<b.length;M++)if(w)"'"==b.charAt(M)&&!x("'")?w=!1:B();else switch(b.charAt(M)){case "d":s=
D("d");break;case "D":y("D",g,f);break;case "o":A=D("o");break;case "m":p=D("m");break;case "M":p=y("M",i,r);break;case "y":d=D("y");break;case "@":var E=new Date(D("@")),d=E.getFullYear(),p=E.getMonth()+1,s=E.getDate();break;case "!":E=new Date((D("!")-this._ticksTo1970)/1E4);d=E.getFullYear();p=E.getMonth()+1;s=E.getDate();break;case "'":x("'")?B():w=!0;break;default:B()}if(F<c.length)throw"Extra/unparsed characters found in date: "+c.substring(F);-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-
(new Date).getFullYear()%100+(d<=e?0:-100));if(-1<A){p=1;s=A;do{e=this._getDaysInMonth(d,p-1);if(s<=e)break;p++;s-=e}while(1)}E=this._daylightSavingAdjust(new Date(d,p-1,s));if(E.getFullYear()!=d||E.getMonth()+1!=p||E.getDate()!=s)throw"Invalid date";return E},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:864E9*(718685+Math.floor(492.5)-
Math.floor(19.7)+Math.floor(4.925)),formatDate:function(a,c,d){if(!c)return"";var e=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,g=(d?d.dayNames:null)||this._defaults.dayNames,f=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,d=(d?d.monthNames:null)||this._defaults.monthNames,i=function(c){(c=w+1<a.length&&a.charAt(w+1)==c)&&w++;return c},r=function(a,b,c){b=""+b;if(i(a))for(;b.length<c;)b="0"+b;return b},p=function(a,b,c,d){return i(a)?d[b]:c[b]},s="",A=!1;if(c)for(var w=0;w<
a.length;w++)if(A)"'"==a.charAt(w)&&!i("'")?A=!1:s+=a.charAt(w);else switch(a.charAt(w)){case "d":s+=r("d",c.getDate(),2);break;case "D":s+=p("D",c.getDay(),e,g);break;case "o":s+=r("o",Math.round(((new Date(c.getFullYear(),c.getMonth(),c.getDate())).getTime()-(new Date(c.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":s+=r("m",c.getMonth()+1,2);break;case "M":s+=p("M",c.getMonth(),f,d);break;case "y":s+=i("y")?c.getFullYear():(10>c.getYear()%100?"0":"")+c.getYear()%100;break;case "@":s+=
c.getTime();break;case "!":s+=1E4*c.getTime()+this._ticksTo1970;break;case "'":i("'")?s+="'":A=!0;break;default:s+=a.charAt(w)}return s},_possibleChars:function(a){for(var c="",d=!1,e=function(c){(c=g+1<a.length&&a.charAt(g+1)==c)&&g++;return c},g=0;g<a.length;g++)if(d)"'"==a.charAt(g)&&!e("'")?d=!1:c+=a.charAt(g);else switch(a.charAt(g)){case "d":case "m":case "y":case "@":c+="0123456789";break;case "D":case "M":return null;case "'":e("'")?c+="'":d=!0;break;default:c+=a.charAt(g)}return c},_get:function(a,
d){return a.settings[d]!==c?a.settings[d]:this._defaults[d]},_setDateFromField:function(a,c){if(a.input.val()!=a.lastVal){var d=this._get(a,"dateFormat"),e=a.lastVal=a.input?a.input.val():null,g,f;g=f=this._getDefaultDate(a);var i=this._getFormatConfig(a);try{g=this.parseDate(d,e,i)||f}catch(r){this.log(r),e=c?"":e}a.selectedDay=g.getDate();a.drawMonth=a.selectedMonth=g.getMonth();a.drawYear=a.selectedYear=g.getFullYear();a.currentDay=e?g.getDate():0;a.currentMonth=e?g.getMonth():0;a.currentYear=
...
f=this._get(b,"navigationAsDateFormat"),q=this._getNumberOfMonths(b),r=this._get(b,"showCurrentAtPos"),p=this._get(b,"stepMonths"),s=1!=q[0]||1!=q[1],A=this._daylightSavingAdjust(!b.currentDay?new Date(9999,9,9):new Date(b.currentYear,b.currentMonth,b.currentDay)),w=this._getMinMaxDate(b,"min"),x=this._getMinMaxDate(b,"max"),r=b.drawMonth-r,D=b.drawYear;0>r&&(r+=12,D--);if(x)for(var y=this._daylightSavingAdjust(new Date(x.getFullYear(),x.getMonth()-q[0]*q[1]+1,x.getDate())),y=w&&y<w?w:y;this._daylightSavingAdjust(new Date(D,
r,1))>y;)r--,0>r&&(r=11,D--);b.drawMonth=r;b.drawYear=D;var y=this._get(b,"prevText"),y=!f?y:this.formatDate(y,this._daylightSavingAdjust(new Date(D,r-p,1)),this._getFormatConfig(b)),y=this._canAdjustMonth(b,-1,D,r)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', -"+p+", 'M');\" title=\""+y+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+y+"</span></a>":g?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+
y+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+y+"</span></a>",B=this._get(b,"nextText"),B=!f?B:this.formatDate(B,this._daylightSavingAdjust(new Date(D,r+p,1)),this._getFormatConfig(b)),g=this._canAdjustMonth(b,1,D,r)?'<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', +"+p+", 'M');\" title=\""+B+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+B+"</span></a>":g?"":'<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+
B+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+B+"</span></a>",p=this._get(b,"currentText"),B=this._get(b,"gotoCurrent")&&b.currentDay?A:c,p=!f?p:this.formatDate(p,B,this._getFormatConfig(b)),f=!b.inline?'<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_'+i+'.datepicker._hideDatepicker();">'+this._get(b,"closeText")+"</button>":"",e=e?'<div class="ui-datepicker-buttonpane ui-widget-content">'+(d?f:"")+(this._isInRange(b,
B)?'<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._gotoToday('#"+b.id+"');\">"+p+"</button>":"")+(d?"":f)+"</div>":"",f=parseInt(this._get(b,"firstDay"),10),f=isNaN(f)?0:f,p=this._get(b,"showWeek"),B=this._get(b,"dayNames");this._get(b,"dayNamesShort");var F=this._get(b,"dayNamesMin"),M=this._get(b,"monthNames"),E=this._get(b,"monthNamesShort"),v=this._get(b,"beforeShowDay"),S=this._get(b,"showOtherMonths"),
Q=this._get(b,"selectOtherMonths");this._get(b,"calculateWeek");for(var h=this._getDefaultDate(b),U="",I=0;I<q[0];I++){var W="";this.maxRows=4;for(var L=0;L<q[1];L++){var t=this._daylightSavingAdjust(new Date(D,r,b.selectedDay)),J=" ui-corner-all",G="";if(s){G+='<div class="ui-datepicker-group';if(1<q[1])switch(L){case 0:G+=" ui-datepicker-group-first";J=" ui-corner-"+(d?"right":"left");break;case q[1]-1:G+=" ui-datepicker-group-last";J=" ui-corner-"+(d?"left":"right");break;default:G+=" ui-datepicker-group-middle",
J=""}G+='">'}for(var G=G+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+J+'">'+(/all|left/.test(J)&&0==I?d?g:y:"")+(/all|right/.test(J)&&0==I?d?y:g:"")+this._generateMonthYearHeader(b,r,D,w,x,0<I||0<L,M,E)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),N=p?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":"",J=0;7>J;J++)var H=(J+f)%7,N=N+("<th"+(5<=(J+f+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+B[H]+'">'+F[H]+"</span></th>");
G+=N+"</tr></thead><tbody>";N=this._getDaysInMonth(D,r);D==b.selectedYear&&r==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,N));J=(this._getFirstDayOfMonth(D,r)-f+7)%7;N=Math.ceil((J+N)/7);this.maxRows=N=s?this.maxRows>N?this.maxRows:N:N;for(var H=this._daylightSavingAdjust(new Date(D,r,1-J)),X=0;X<N;X++){for(var G=G+"<tr>",Z=!p?"":'<td class="ui-datepicker-week-col">'+this._get(b,"calculateWeek")(H)+"</td>",J=0;7>J;J++){var R=v?v.apply(b.input?b.input[0]:null,[H]):[!0,""],O=H.getMonth()!=
r,aa=O&&!Q||!R[0]||w&&H<w||x&&H>x,Z=Z+('<td class="'+(5<=(J+f+6)%7?" ui-datepicker-week-end":"")+(O?" ui-datepicker-other-month":"")+(H.getTime()==t.getTime()&&r==b.selectedMonth&&b._keyEvent||h.getTime()==H.getTime()&&h.getTime()==t.getTime()?" "+this._dayOverClass:"")+(aa?" "+this._unselectableClass+" ui-state-disabled":"")+(O&&!S?"":" "+R[1]+(H.getTime()==A.getTime()?" "+this._currentClass:"")+(H.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!O||S)&&R[2]?' title="'+R[2]+'"':"")+(aa?
"":' onclick="DP_jQuery_'+i+".datepicker._selectDay('#"+b.id+"',"+H.getMonth()+","+H.getFullYear()+', this);return false;"')+">"+(O&&!S?"&#xa0;":aa?'<span class="ui-state-default">'+H.getDate()+"</span>":'<a class="ui-state-default'+(H.getTime()==c.getTime()?" ui-state-highlight":"")+(H.getTime()==A.getTime()?" ui-state-active":"")+(O?" ui-priority-secondary":"")+'" href="#">'+H.getDate()+"</a>")+"</td>");H.setDate(H.getDate()+1);H=this._daylightSavingAdjust(H)}G+=Z+"</tr>"}r++;11<r&&(r=0,D++);G+=
"</tbody></table>"+(s?"</div>"+(0<q[0]&&L==q[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");W+=G}U+=W}U+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return U},_generateMonthYearHeader:function(a,c,d,e,g,f,q,r){var p=this._get(a,"changeMonth"),s=this._get(a,"changeYear"),A=this._get(a,"showMonthAfterYear"),w='<div class="ui-datepicker-title">',x="";if(f||!p)x+='<span class="ui-datepicker-month">'+
q[c]+"</span>";else{for(var q=e&&e.getFullYear()==d,D=g&&g.getFullYear()==d,x=x+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),y=0;12>y;y++)if((!q||y>=e.getMonth())&&(!D||y<=g.getMonth()))x+='<option value="'+y+'"'+(y==c?' selected="selected"':"")+">"+r[y]+"</option>";x+="</select>"}A||(w+=x+(f||!p||!s?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",f||!s)w+='<span class="ui-datepicker-year">'+d+"</span>";else{var r=this._get(a,
"yearRange").split(":"),B=(new Date).getFullYear(),q=function(a){a=a.match(/c[+-].*/)?d+parseInt(a.substring(1),10):a.match(/[+-].*/)?B+parseInt(a,10):parseInt(a,10);return isNaN(a)?B:a},c=q(r[0]),r=Math.max(c,q(r[1]||"")),c=e?Math.max(c,e.getFullYear()):c,r=g?Math.min(r,g.getFullYear()):r;for(a.yearshtml+='<select class="ui-datepicker-year" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'Y');\" >";c<=r;c++)a.yearshtml+='<option value="'+c+'"'+(c==d?' selected="selected"':
"")+">"+c+"</option>";a.yearshtml+="</select>";w+=a.yearshtml;a.yearshtml=null}w+=this._get(a,"yearSuffix");A&&(w+=(f||!p||!s?"&#xa0;":"")+x);return w+"</div>"},_adjustInstDate:function(a,c,d){var e=a.drawYear+("Y"==d?c:0),g=a.drawMonth+("M"==d?c:0),c=Math.min(a.selectedDay,this._getDaysInMonth(e,g))+("D"==d?c:0),e=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(e,g,c)));a.selectedDay=e.getDate();a.drawMonth=a.selectedMonth=e.getMonth();a.drawYear=a.selectedYear=e.getFullYear();("M"==d||
...
(function(a){a.ui=a.ui||{};var c=/left|center|right/,d=/top|center|bottom/,e,f=a.fn.position,i=a.fn.offset;a.fn.position=function(g){if(!g||!g.of)return f.apply(this,arguments);var g=a.extend({},g),b=a(g.of),i=b[0],l=(g.collision||"flip").split(" "),o=g.offset?g.offset.split(" "):[0,0],n,m,q;9===i.nodeType?(n=b.width(),m=b.height(),q={top:0,left:0}):i.setTimeout?(n=b.width(),m=b.height(),q={top:b.scrollTop(),left:b.scrollLeft()}):i.preventDefault?(g.at="left top",n=m=0,q={top:g.of.pageY,left:g.of.pageX}):
(n=b.outerWidth(),m=b.outerHeight(),q=b.offset());a.each(["my","at"],function(){var a=(g[this]||"").split(" ");a.length===1&&(a=c.test(a[0])?a.concat(["center"]):d.test(a[0])?["center"].concat(a):["center","center"]);a[0]=c.test(a[0])?a[0]:"center";a[1]=d.test(a[1])?a[1]:"center";g[this]=a});1===l.length&&(l[1]=l[0]);o[0]=parseInt(o[0],10)||0;1===o.length&&(o[1]=o[0]);o[1]=parseInt(o[1],10)||0;"right"===g.at[0]?q.left+=n:"center"===g.at[0]&&(q.left+=n/2);"bottom"===g.at[1]?q.top+=m:"center"===g.at[1]&&
(q.top+=m/2);q.left+=o[0];q.top+=o[1];return this.each(function(){var b=a(this),c=b.outerWidth(),d=b.outerHeight(),f=parseInt(a.curCSS(this,"marginLeft",true))||0,i=parseInt(a.curCSS(this,"marginTop",true))||0,j=c+f+(parseInt(a.curCSS(this,"marginRight",true))||0),D=d+i+(parseInt(a.curCSS(this,"marginBottom",true))||0),y=a.extend({},q),B;if(g.my[0]==="right")y.left=y.left-c;else if(g.my[0]==="center")y.left=y.left-c/2;if(g.my[1]==="bottom")y.top=y.top-d;else if(g.my[1]==="center")y.top=y.top-d/2;
if(!e){y.left=Math.round(y.left);y.top=Math.round(y.top)}B={left:y.left-f,top:y.top-i};a.each(["left","top"],function(b,e){if(a.ui.position[l[b]])a.ui.position[l[b]][e](y,{targetWidth:n,targetHeight:m,elemWidth:c,elemHeight:d,collisionPosition:B,collisionWidth:j,collisionHeight:D,offset:o,my:g.my,at:g.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(y,{using:g.using}))})};a.ui.position={fit:{left:function(c,b){var d=a(window),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft();
...
function(){o("hover",a(this))});this.lis.bind("mouseout.tabs",function(){a(this).removeClass("ui-state-hover")});this.anchors.bind("focus.tabs",function(){o("focus",a(this).closest("li"))});this.anchors.bind("blur.tabs",function(){a(this).closest("li").removeClass("ui-state-focus")})}var n,m;b.fx&&(a.isArray(b.fx)?(n=b.fx[0],m=b.fx[1]):n=m=b.fx);var q=m?function(b,c){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");c.hide().removeClass("ui-tabs-hide").animate(m,m.duration||"normal",
function(){e(c,m);g._trigger("show",null,g._ui(b,c[0]))})}:function(b,c){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");c.removeClass("ui-tabs-hide");g._trigger("show",null,g._ui(b,c[0]))},r=n?function(a,b){b.animate(n,n.duration||"normal",function(){g.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");e(b,n);g.element.dequeue("tabs")})}:function(a,b){g.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");g.element.dequeue("tabs")};
...
-1;b.cookie&&g._cookie(b.selected,b.cookie);g.element.queue("tabs",function(){r(c,e)}).dequeue("tabs");this.blur();return false}if(!e.length){b.cookie&&g._cookie(b.selected,b.cookie);g.element.queue("tabs",function(){q(c,f)});g.load(g.anchors.index(this));this.blur();return false}}b.cookie&&g._cookie(b.selected,b.cookie);if(f.length){e.length&&g.element.queue("tabs",function(){r(c,e)});g.element.queue("tabs",function(){q(c,f)});g.load(g.anchors.index(this))}else throw"jQuery UI Tabs: Mismatching fragment identifier.";
...
(function(a,c,d,e){function f(a,b,c){O[a]=c;aa[a]=b;R||(R=a)}function i(b){R!==b&&(R=b,a.ui.editor.eachInstance(function(){this.reinit()}))}function g(a,b){R&&O[R]&&O[R][a]&&(a=O[R][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function b(b){if(ca===e){ca=!0;if(ea=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(b.options.baseClass+"-ios"),ea&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height",
"-=1")},0)});a.browser.mozilla&&a("html").addClass(b.options.baseClass+"-ff");if(a.browser.msie&&9>a.browser.version){ca=!1;var c=a("<div/>").addClass(b.options.baseClass+"-unsupported").html(b.getTemplate("unsupported")).appendTo("body");j(c);c.find("."+b.options.baseClass+"-unsupported-close").click(function(){c.remove()})}}return ca}function j(b){var c=1;b.siblings().each(function(){var b=a(this).css("z-index");!isNaN(b)&&b>c&&(c=b+1)});b.css("z-index",c)}function l(a){return a.clone().wrap("<div/>").parent().html()}
function o(a){var b,a=document.createElement(a);b="getComputedStyle"in c;document.body.appendChild(a);b=(b?c.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return b}function n(b,c){return-1!==a.inArray(a(b)[0].tagName.toLowerCase(),c)}function m(a){for(var b={},a=c.getComputedStyle(a[0],null),d=0;d<a.length;d++)b[a.item(d)]=a.getPropertyValue(a.item(d));return b}function q(b,c){x();a(b).each(function(){var d=a("<"+c+"/>").html(a(this).html());b.html(d)});D()}function r(b,
c){a.each(c,function(c,d){a(b).css(c)===d?a(b).css(c,""):a(b).css(c,d)})}function p(b,c){for(var d="",e=0,f=b.childNodes.length;e<f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?g.nodeValue:l(a(g)))&&(d+=g)}c&&(d=a("<"+c+">"+d+"</"+c+">"),d.find("p").wrapInner("<"+c+"/>"),d.find("p > *").unwrap(),d=a("<div/>").html(d).html());return d}function s(b,c){var d=a("<div/>").append(b)[0].childNodes;c.deleteContents();d.length===e||1===d.length?c.insertNode(d[0].cloneNode(!0)):a.each(d,function(a,b){c.insertNodeAtEnd(b.cloneNode(!0))})}
function A(b){var b=b||d.getSelection(),c;a(b.getAllRanges()).each(function(b,d){c=3===this.commonAncestorContainer.nodeType?a(d.commonAncestorContainer).parent()[0]:d.commonAncestorContainer});return c}function w(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer}function x(a){if(!V||a)V=d.saveSelection()}function D(){V&&(d.restoreSelection(V),V=!1)}function y(){V&&d.removeMarkers(V);V=!1}function B(a,b,c){for(var b=b||d.getSelection(),e,f=0;e=b.getAllRanges()[f++];)a.call(c,
e)}function F(a,b){B(function(b){s(a,b)},b,this)}function M(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).focus().contents().each(function(){var a=d.createRange();a.selectNodeContents(this);c.addRange(a)})}function E(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNode(this);c.addRange(a)}).focus()}function v(b,c,e){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNodeContents(this);a.collapse(e);c.addRange(a)})}
function S(a,b){v(a,b,!1)}function Q(a,b){v(a,b,!0)}function h(a){a=a||d.getSelection();return a.toHtml()}function U(b){b=b||d.getSelection().getRangeAt(0);return a(3===b.commonAncestorContainer.nodeType?b.commonAncestorContainer.parentNode:b.commonAncestorContainer)}function I(a){var b=new jQuery;B(function(a){b.push(U(a)[0])},a,this);return b}function W(){var b=d.getSelection();if(null===b.anchorNode)return null;if(b.isBackwards())return 3===b.focusNode.nodeType?a(b.focusNode.parentElement):a(b.focusNode);
b.anchorNode||console.trace();return 3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode)}function L(){var b=d.getSelection();return null===b.anchorNode?null:b.isBackwards()?3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode):3===b.focusNode.nodeType?a(b.focusNode.parentElement):a(b.focusNode)}function t(b,c){var c=c||{},e=d.createCssClassApplier(c.classes||"",{normalize:!0,elementTagName:b,elementProperties:c.attributes||{}});B(function(d){var f=d.cloneContents(),
f=p(f);"string"===typeof f&&(f=f.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));a(f).is(":empty")?(f=a("<"+b+"/>").addClass(c.classes).attr(c.attributes||{}).append(p(d.cloneContents())),s(f,d)):e.toggleRange(d)},null,this)}function J(a,b,c){B(function(d){d=U(d);d.is(a)?d.attr(b):t(a,{classes:c,attributes:b})},null,this)}function G(b,c){var c=c||d.getSelection(),e=c.getRangeAt(0),f=I()[0],g=d.createRange();g.setStartBefore(f);g.setEnd(e.startContainer,e.startOffset);var g=g.cloneContents(),h=
d.createRange();h.setStart(e.endContainer,e.endOffset);h.setEndAfter(f);e=h.cloneContents();g=l(a(p(g)));g+=l(a(b));g+=l(a(p(e)));a(f).replaceWith(a(g))}function N(a,b,c){var c=c||d.getSelection(),e=W()[0],f=L()[0],g=I()[0],g=n(g,b),e=n(e,b),b=n(f,b);g&&e&&b?F(a):G(a,c)}function H(b,c){B(function(d){for(d=a(d.commonAncestorContainer);d.length&&d[0]!==c[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===c[0]&&"inline"!==c.css("display")&&(q(c,"div"),d=c.children().first());r(d,
b)},null,this)}function X(b,c){b=a(b)[0];if(c=c||d?d.getSelection():null){var e;a(c.getAllRanges()).each(function(d,f){e=3===this.commonAncestorContainer.nodeType?a(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;b!==e&&!a.contains(b,e)&&c.removeRange(f)})}}function Z(a,b){allowed=[];for(var c=0;c<b.length;c++)b[c].match(/[a-z][a-z0-9]{0,}/g)&&allowed.push(b[c]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,
b){return-1<allowed.indexOf(b.toLowerCase())?a:""})}var R=null,O={},aa={};a(function(){d.initialized||d.init();a.isFunction(d.rangePrototype.insertNodeAtEnd)||(d.rangePrototype.insertNodeAtEnd=function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});a("html").click(function(){a(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});a.widget("ui.editor",{_init:function(){-1===a.inArray(this,a.ui.editor.instances)&&a.ui.editor.instances.push(this);
...
"floatNone","floatRight"],["tagMenu"],["i18n"],["raptorize"],["statistics"],["debugReinit","debugDestroy"]];this.element.attr("id")||this.element.attr("id",this.getUniqueId());this.ready=!1;this.events={};this.ui={};this.plugins={};this.templates=a.extend({},a.ui.editor.templates);this.path=this.toolbarWrapper=this.toolbar=this.wrapper=null;this.visible=this.enabled=!1;this.uiObjects={};this.hotkeys={};this.options.enableHotkeys&&this.registerHotkey(this.hotkeys);for(var d in this.options.bind)this.bind(d,
this.options.bind[d]);this.history=[];this.present=0;this.historyEnabled=!0;b(this)&&(this.cloneDomTools(),this.setOriginalHtml(this.element.is(":input")?this.element.val():this.element.html()),this.element.is("textarea, input")&&this.replaceOriginal(),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,d=this.persist("locale")||this.options.initialLocale,i(d),this.ready=!0,this.fire("ready"),this.options.autoEnable&&a(function(){c.enableEditing();c.showToolbar()}))},
...
this.getUniqueId()).addClass(this.element.attr("class")),c=m(this.element),d=0;d<this.options.replaceStyle.length;d++)b.css(this.options.replaceStyle[d],c[this.options.replaceStyle[d]]);this.element.hide();this.bind("change",function(){this.element.is("input, textarea")?this.element.val(this.getHtml()):this.element.html(this.getHtml())});this.target=b}},cloneDomTools:function(){for(var a in this.options.domTools)this[a]||(this[a]=function(a){return function(){X(this.getElement());var b=this.getHtml(),
c=this.options.domTools[a].apply(this.options.domTools,arguments);b!==this.getHtml()&&this.change();return c}}(a))},checkChange:function(){var a=d.serializeSelection();this.previousSelection!==a&&this.fire("selectionChange");this.previousSelection=a;var a=this.getCleanHtml(),b=this.dirty;this.dirty=this.getOriginalHtml()!==a;this.previousHtml!==a&&(this.previousHtml=a,this.change(),b!==this.dirty&&(this.dirty?this.fire("dirty"):this.fire("cleaned")))},change:function(){this.fire("change")},destruct:function(a){a||
this.hideToolbar();this.disableEditing();this.fire("destroy",!1);this.events={};this.getElement().unbind("."+this.widgetName);this.wrapper&&this.wrapper.remove()},destroy:function(){this.destruct();a.Widget.prototype.destroy.call(this)},persist:function(b,c){return!this.options.persistence?null:a.ui.editor.persist(b,c,this.options.namespace)},enableEditing:function(){this.isToolbarLoaded()||this.loadToolbar();this.enabled||(this.enabled=!0,this.getElement().addClass(this.options.baseClass+"-editing"),
this.options.partialEdit?this.getElement().find(this.options.partialEdit).attr("contenteditable",!0):this.getElement().attr("contenteditable",!0),this.execCommand("enableInlineTableEditing",!1,!1),this.execCommand("styleWithCSS",!0,!0),this.bindHotkeys(),this.fire("enabled"),this.fire("resize"))},disableEditing:function(){this.enabled&&(this.enabled=!1,this.getElement().attr("contenteditable",!1).removeClass(this.options.baseClass+"-editing"),d.getSelection().removeAllRanges(),this.fire("disabled"))},
isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var b=this,c="",d=[],e=0;B(function(f){var f=f.commonAncestorContainer,g;g=3===f.nodeType?a(f).parent():a(f);!b.isRoot(g)&&!a.contains(b.getElement().get(0),g.get(0))&&(g=b.getElement());f=[];for(d.push(f);g[0]&&!b.isRoot(g)&&"body"!==g[0].tagName.toLowerCase();)f.push(g),g=g.parent();f.reverse();c&&(c+=" | ");c+=this.getTemplate("root");for(g=0;g<f.length;g++)c+=this.getTemplate("tag",{element:f[g][0].tagName.toLowerCase(),
data:"["+e+","+g+"]"});e++},null,this);c||(c=this.getTemplate("root"));this.path.html(c).find("a").click(function(){var c=a(this).data("ui-editor-selection");c?(E(d[c[0]][c[1]]),b.updateTagTree()):E(b.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(b){return this.getElement()[0]===a(b)[0]},unify:function(b,c){!1!==c&&b(this);if(this.options.unify){var d=this;a.ui.editor.eachInstance(function(a){a!==d&&a.options.unify&&b(a)})}},getUniqueId:function(){return a.ui.editor.getUniqueId()},
...
this.options.urlPrefix);d=d.replace(/_\(['"]{1}(.*?)['"]{1}\)/g,function(a,b){b=b.replace(/\\(.?)/g,function(a,b){switch(b){case "\\":return"\\";case "0":return"\x00";case "":return"";default:return b}});return g(b)});c=a.extend({},this.options,c||{});c=this.getTemplateVars(c);return d=d.replace(/\{\{(.*?)\}\}/g,function(a,b){return c[b]})},getTemplateVars:function(a,b,c){b=b?b+".":"";c||(c=1);var d={},e;for(e in a)if("object"===typeof a[e]&&5>c){var f=this.getTemplateVars(a[e],b+e,++c),g;for(g in f)d[g]=
...
b).attr("title",this.title).val(b);d.classes&&this.button.addClass(d.classes);this.button.bind("mousedown."+e.editor.widgetName,function(a){a.preventDefault()});var k=this;this.button.bind("mouseup."+e.editor.widgetName,function(a){a.preventDefault();k.click.apply(e,arguments);c.checkChange()});c.bind("destroy",a.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+f},disabled:d.disabled?!0:!1,text:this.text||!1,label:this.label||
null});this.ready.call(e);return this.button},disable:function(){this.button.button("option","disabled",!0)},enable:function(){this.button.button("option","disabled",!1)},ready:function(){},click:function(){}},b)},uiSelectMenu:function(b){return a.extend({select:null,selectMenu:null,button:null,menu:null,options:{},init:function(b,c){var d=this;d.select.attr("disabled","disabled");var e=b.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});a.extend({},c.options,{baseClass:c.options.baseClass+
...
c){b.children().each(function(){var b=a.map(this.attributes,function(b){if(-1===a.inArray(b.name,c))return b.name}),d=a(this);a.each(b,function(a,b){d.removeAttr(b)});element.removeAttributes(a(this),c)});return b},elementBringToTop:j,elementOuterHtml:l,elementOuterText:function(a){return a.clone().wrap("<div/>").parent().text()},elementIsBlock:function(a){return"block"===o(a.tagName)},elementDefaultDisplay:o,elementIsValid:n,elementGetStyles:m,elementWrapInner:q,elementToggleStyle:r,elementSwapStyles:function(a,
b,c){for(var d in c)a.css(d,b.css(d)),b.css(d,c[d])},fragmentToHtml:p,fragmentInsertBefore:function(b,c,d){for(var e=0,f=b.childNodes.length;e<f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?g.nodeValue:a(g).html())&&a("<"+d+"/>").html(a.trim(g)).insertBefore(c)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},rangeGetCommonAncestor:A,rangeIsEmpty:w,selectionSave:x,selectionRestore:D,selectionDestroy:y,selectionEachRange:B,selectionReplace:F,
selectionSelectInner:M,selectionSelectOuter:E,selectionSelectEdge:v,selectionSelectEnd:S,selectionSelectStart:Q,selectionGetHtml:h,selectionGetElements:I,selectionToggleWrapper:t,selectionExists:function(a){var b=!1;B(function(a){w(a)||(b=!0)},a,this);return b},selectionReplaceSplittingSelectedElement:G,selectionReplaceWithinValidTags:N,selectionToggleBlockStyle:H,stringStripTags:Z,defaults:{plugins:{},ui:{},bind:{},domTools:{unwrapParentTag:function(b){I().each(function(){a(this).is(b)&&a(this).replaceWith(a(this).html())})},
execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(d){}},insertTag:function(b,c){B(function(c){c.insertNode(a("<"+b+"/>")[0])},c,this)},insertTagAtEnd:function(b,c){B(function(c){c.insertNodeAtEnd(a("<"+b+"/>")[0])},c,this)},insertElement:function(b,c,d){B(function(d){a(b).each(function(){d.insertNode(!1===c?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(b,c,d){B(function(d){a(b).each(function(){d.insertNodeAtEnd(!1===c?this:this.cloneNode(!0))})},d,this)},inverseWrapWithTagClass:function(b,
c,e,f){x();var g="domTools"+Math.ceil(1E7*Math.random());B(function(a){var b=d.createCssClassApplier(f,{elementTagName:e});b.isAppliedToRange(a)?b.toggleSelection():d.createCssClassApplier(c,{elementTagName:g}).toggleSelection()},null,this);a(g).each(function(){a(this).replaceWith(a("<"+b+"/>").addClass(c).html(a(this).html()))});D()}},namespace:null,unify:!0,persistence:!0,persistenceName:"uiEditor",unloadWarning:!0,autoEnable:!1,partialEdit:!1,enablePlugins:!0,disabledPlugins:[],uiOrder:null,enableUi:!0,
...
persist:function(a,b,c){a=c?c+"."+a:a;if(localStorage){c=localStorage.uiWidgetEditor?JSON.parse(localStorage.uiWidgetEditor):{};if(b===e)return c[a];c[a]=b;localStorage.uiWidgetEditor=JSON.stringify(c)}return b}});var ca,ea;a.ui.editor.registerUi({alignLeft:{init:function(a){return a.uiButton({title:g("Left Align"),click:function(){H({"text-align":"left"},a.getElement())}})}},alignJustify:{init:function(a){return a.uiButton({title:g("Justify"),click:function(){H({"text-align":"justify"},a.getElement())}})}},
alignCenter:{init:function(a){return a.uiButton({title:g("Center Align"),click:function(){H({"text-align":"center"},a.getElement())}})}},alignRight:{init:function(a){return a.uiButton({title:g("Right Align"),click:function(){H({"text-align":"right"},a.getElement())}})}}});a.ui.editor.registerUi({textBold:{hotkeys:{"ctrl+b":{action:function(){this.ui.click()}}},init:function(a,b){return this.editor.uiButton({title:g("Bold"),click:function(){t("strong",{classes:b.classes||b.cssPrefix+"bold"})}})}},
textItalic:{hotkeys:{"ctrl+i":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:g("Italic"),click:function(){t("em",{classes:b.classes||b.cssPrefix+"italic"})}})}},textUnderline:{hotkeys:{"ctrl+u":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:g("Underline"),click:function(){t("u",{classes:b.classes||b.cssPrefix+"underline"})}})}},textStrike:{hotkeys:{"ctrl+k":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:g("Strikethrough"),
click:function(){t("del",{classes:b.classes||b.cssPrefix+"strike"})}})}},textSub:{init:function(a,b){return a.uiButton({title:g("Sub script"),click:function(){t("sub",{classes:b.classes||b.cssPrefix+"sub"})}})}},textSuper:{init:function(a,b){return a.uiButton({title:g("Super script"),click:function(){t("sup",{classes:b.classes||b.cssPrefix+"super"})}})}}});a.ui.editor.registerUi({quoteBlock:{init:function(a,b){return a.uiButton({title:g("Blockquote"),icon:"ui-icon-quote",click:function(){t("blockquote",
...
a(this.dialog).dialog("destroy").remove();this.dialog=null;a(this.ui.button).button("option","disabled",!1)},show:function(){if(!this.dialog){a(this.ui.button).button("option","disabled",!0);var b=this;x();this.dialog=a(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:g("Paste Embed Code"),autoOpen:!0,dialogClass:b.options.baseClass+" "+b.options.dialogClass,buttons:[{text:g("Embed Object"),click:function(){D();F(a(this).find("textarea").val());
...
this.ui.enable()}}});a.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:g("Insert Horizontal Rule"),click:function(){F("<hr/>")}})}}});a.ui.editor.registerUi({i18n:{init:function(b){var c=this,d=a('<select autocomplete="off" name="i18n"/>'),e;for(e in O){var f=a('<option value="'+e+'" class="'+e+'"/>');f.html(aa[e]);R===e&&f.attr("selected","selected");d.append(f)}return b.uiSelectMenu({title:g("Change Language"),select:d,change:function(a){i(c.persist("locale",a))}})}}});f("de",
...
"{{characters}} characters, {{charactersRemaining}} remaining":"{{characters}} Zeichen, {{charactersRemaining}} verbleibend","{{sentences}} sentences":"{{sentences}} S\u00e4tze","{{words}} word":"{{words}} Wort","{{words}} words":"{{words}} W\u00f6rter"});f("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"Apply Source",
...
"{{words}} word":"{{words}} woord","{{words}} words":"{{words}} woorden"});f("zh-CN","\u7b80\u4f53\u4e2d\u6587",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"\u5e94\u7528\u6e90\u4ee3\u7801","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",Blockquote:"\u5927\u6bb5\u5f15\u7528",Bold:"\u7c97\u4f53",
...
this.change,this);a.bind("show",this.change,this);return a.uiButton({title:g("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){I().is("a")?this.ui.enable():this.ui.disable()}}});a.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),
toggleList:function(b){a(I()).is("li")&&a(I()).parent().is(b)?this.unwrapList():this.wrapList(b);this.editor.fire("selectionChange");this.editor.fire("change")},unwrapList:function(){x();var b=[],c=[],d=W(),e=L();b.push(a(d).html());c.push(d);if(a(d)[0]!==a(e)[0]){var f=d;do f=a(f).next(),b.push(a(f).html()),c.push(f);while(a(f)[0]!==a(e)[0])}f=0===a(d).prev().length;e=0===a(e).next().length;d=a(d).parent();for(listElementsIndex=0;listElementsIndex<c.length;listElementsIndex++)a(c[listElementsIndex]).remove();
for(c=0;c<b.length;c++)d.parent().is("li")||(b[c]="<p>"+b[c]+"</p>");f&&e?(d.replaceWith(b.join("")),D(),b=I()[0],E(b)):(f?a(d).before(b.join("")):e?a(d).after(b.join("")):G(b.join("")),D(),this.editor.checkChange())},wrapList:function(b){X(this.editor.getElement());""===a.trim(h())&&M(I());var c=a("<div>").html(h()),d=[],e=this;a(c).contents().each(function(){var b;b="block"===o(this.tagName)?Z(a(this).html(),e.validChildren):Z(l(a(this)),e.validChildren);b=a("<li>"+b+"</li>");""!==a.trim(b.text())&&
d.push(l(b))});c=this.options.baseClass+"-selection";b="<"+b+' class="'+c+'">'+d.join("")+"</"+b+">";D();var f=a(I()[0]).parent(),g=this.editor.getElement()[0];f===g||I()[0]===g?F(b):N(b,this.validParents);c=a(this.editor.getElement().find("."+c).removeClass(c));M(c.find("li:first")[0]);this.editor.checkChange()},toggleButtonState:function(b,c){var d=function(a){c.button.toggleClass("ui-state-highlight",a).toggleClass("ui-state-default",!a)},e=W();if(null===e||!e.length)e=this.editor.getElement();
var f=L();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(a(e).is(b)&&a(f).is(b)&&e===f)return d(!0);var g=a(e).parentsUntil(h,b).first()&&a(f).parentsUntil(h,b).first(),h="#"+this.editor.getElement().attr("id"),i=a(e).is(b+" > li")||a(e).parentsUntil(h,b+" > li").length,j=a(f).is(b+" > li")||a(f).parentsUntil(h,b+" > li").length;if(i&&j&&g){g=a(A());g.is(b)||(g=a(g).parentsUntil(h,b).first());h=g.find("ul, ol");if(!h.length)return d(!0);for(g=0;g<h.length;g++)if(a.contains(h[g],
...
c))});return(f?"[":"{")+(""+e)+(f?"]":"}")},c={enableUi:this.options.enableUi,enablePlugins:this.options.enablePlugins,disabledPlugins:b(this.options.disabledPlugins),ui:b(this.options.ui),t:(new Date).getTime()},d=[],e;for(e in c)d.push(e+"="+encodeURIComponent(c[e]));this.ui.button.find(".ui-button-icon-primary").css({"background-image":"url(http://www.jquery-raptor.com/logo/0.0.25?"+d.join("&")+")"})}})}}});a.ui.editor.registerPlugin("normaliseLineBreaks",{options:{enter:"<p><br/></p>",enterValidTags:"address,blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),
shiftEnter:"<br/>",shiftEnterValidTags:"a,abbr,acronym,address,applet,b,bdo,big,blockquote,body,button,caption,center,cite,code,dd,del,dfn,div,dt,em,fieldset,font,form,h1,h2,h3,h4,h5,h6,i,iframe,ins,kbd,label,legend,li,noframes,noscript,object,p,pres,q,s,samp,small,span,strike,strong,sub,sup,td,th,tt,u,var".split(",")},hotkeys:{"return":{action:function(){y();var b=""===d.getSelection().toHtml(),c;c=d.getSelection();var e=c.isBackwards()?c.focusNode:c.anchorNode;(c.isBackwards()?c.focusOffset:0!==
c.anchorOffset)?c=!1:(c=e.previousSibling,c=!c||""===a(c).html()?!0:!1);var f;e=d.getSelection();f=e.isBackwards()?e.anchorNode:e.focusNode;(e.isBackwards()?e.focusOffset:e.anchorOffset)!==f.textContent.length?f=!1:(e=f.nextSibling,f=!e||""===a(e).html()?!0:!1);var g=this.options.baseClass+"-enter-break",e=a(this.options.enter).attr("id",g);N(e,this.options.enterValidTags);e=a("#"+g).removeAttr("id");b?c?Q(e.next()):f?Q(e):(Q(e.next()),(b=e.prev())&&""!==a.trim(b.html())&&l(b)!==this.options.enter&&
e.remove()):(Q(e.next()),e.remove())},restoreSelection:!1},"return+shift":{action:function(){y();var b=this.options.baseClass+"-enter-break",c=a(this.shiftEnter).attr("id",b).appendTo("body");this.options.shiftEnterValidTags?N(this.options.shiftEnter,this.options.shiftEnterValidTags):F(c);b=a("#"+b).removeAttr("id").next();Q(b)},restoreSelection:!1}}});a.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span,hr,br".split(","),allowedAttributes:["href",
"title"],allowedEmptyTags:["hr","br"]},init:function(b,d){var e=!1,f=!1,h=this;b.getElement().bind("paste."+b.widgetName,a.proxy(function(){if(e)return!1;e=!0;x();a(".uiWidgetEditorPasteBin").length&&a(".uiWidgetEditorPasteBin").remove();a('<div class="uiWidgetEditorPasteBin" contenteditable="true" style="width: 1px; height: 1px; overflow: hidden; position: fixed; top: -1px;" />').appendTo("body");a(".uiWidgetEditorPasteBin").focus();c.setTimeout(function(){var c=a(".uiWidgetEditorPasteBin").html(),
c=h.filterAttributes(c),c=h.filterChars(c),c=h.stripEmpty(c),c=h.stripAttributes(c),c=Z(c,h.options.allowedTags),c={plain:a("<div/>").html(a(".uiWidgetEditorPasteBin").html()).text(),markup:c,html:a(".uiWidgetEditorPasteBin").html()};f=a(b.getTemplate("paste.dialog",c));a(f).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:d.dialogShowAnimation,hide:d.dialogHideAnimation,dialogClass:d.baseClass+" "+d.dialogClass,buttons:[{text:g("Insert"),click:function(){var c=
null,c=a(this).find(".ui-editor-paste-area:visible"),c=c.hasClass("ui-editor-paste-plain")||c.hasClass("ui-editor-paste-source")?c.val():c.html(),c=h.filterAttributes(c),c=h.filterChars(c);D();F(c);b.checkChange();e=!1;a(this).dialog("close")}},{text:g("Cancel"),click:function(){D();e=!1;a(this).dialog("close")}}],open:function(){var b=a(this).find(".ui-editor-paste-panel-tabs");b.find("ul.ui-tabs-nav li").click(function(){b.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
...
change:function(c){if(!("undefined"===typeof c||"na"===c)){var d=b.getElement()[0],e=I();if(!h()||""===h()){if(a(e)[0]===a(d)[0])return;x();d=a("<"+c+">").html(e.html());e.replaceWith(d);D()}else{var e=a(I()[0]).parent(),f=this.options.baseClass+"-selection",c=a("<"+c+">").html(h()).addClass(f);e===d||I()[0]===d?F(c):N(c,this.validParents);M(b.getElement().find("."+f).removeClass(f))}b.checkChange()}}})},change:function(){var b=I()[0];b?(b=b.tagName.toLowerCase(),this.ui.select.find("option[value="+
...
a(d).button("option","disabled",!1);b.editor.checkChange()}})}}});var V=!1})(jQuery,window,rangy);
