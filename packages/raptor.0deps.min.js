...
*/
window.rangy=function(){function a(a,b){var c=typeof a[b];return c==l||!!(c==j&&a[b])||"unknown"==c}function c(a,b){return!!(typeof a[b]==j&&a[b])}function d(a,b){return typeof a[b]!=n}function f(a){return function(b,c){for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0}}function e(a){return a&&q(a,r)&&y(a,p)}function i(a){window.alert("Rangy not supported in your browser. Reason: "+a);v.initialized=!0;v.supported=!1}function g(){if(!v.initialized){var b,d=!1,f=!1;a(document,"createRange")&&
(b=document.createRange(),q(b,m)&&y(b,o)&&(d=!0),b.detach());if((b=c(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(b,"createTextRange"))b=b.createTextRange(),e(b)&&(f=!0);!d&&!f&&i("Neither Range nor TextRange are implemented");v.initialized=!0;v.features={implementsDomRange:d,implementsTextRange:f};d=B.concat(z);f=0;for(b=d.length;f<b;++f)try{d[f](v)}catch(j){c(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
j)}}}function b(a){this.name=a;this.supported=this.initialized=!1}var j="object",l="function",n="undefined",o="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer,START_TO_START,START_TO_END,END_TO_START,END_TO_END".split(","),m="setStart,setStartBefore,setStartAfter,setEnd,setEndBefore,setEndAfter,collapse,selectNode,selectNodeContents,compareBoundaryPoints,deleteContents,extractContents,cloneContents,insertNode,surroundContents,cloneRange,toString,detach".split(","),
p="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),r="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),q=f(a),s=f(c),y=f(d),v={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:a,isHostObject:c,isHostProperty:d,areHostMethods:q,areHostObjects:s,areHostProperties:y,isTextRange:e},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
v.fail=i;v.warn=function(a){a="Rangy warning: "+a;v.config.alertOnWarn?window.alert(a):typeof window.console!=n&&typeof window.console.log!=n&&window.console.log(a)};({}).hasOwnProperty?v.util.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])}:i("hasOwnProperty not supported");var z=[],B=[];v.init=g;v.addInitListener=function(a){v.initialized?a(v):z.push(a)};var x=[];v.addCreateMissingNativeApiListener=function(a){x.push(a)};v.createMissingNativeApi=function(a){a=a||window;g();
for(var b=0,c=x.length;b<c;++b)x[b](a)};b.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};b.prototype.warn=function(a){v.warn("Module "+this.name+": "+a)};b.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};v.createModule=function(a,c){var d=new b(a);v.modules[a]=d;B.push(function(a){c(a,d);d.initialized=!0;d.supported=!0})};v.requireModules=function(a){for(var c=0,d=a.length,e,f;c<
d;++c){f=a[c];e=v.modules[f];if(!e||!(e instanceof b))throw Error("Module '"+f+"' not found");if(!e.supported)throw Error("Module '"+f+"' not supported");}};var D=!1,s=function(){D||(D=!0,v.initialized||g())};if(typeof window==n)i("No window found");else if(typeof document==n)i("No document found");else return a(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",s,!1),a(window,"addEventListener")?window.addEventListener("load",s,!1):a(window,"attachEvent")?window.attachEvent("onload",
s):i("Window does not have required addEventListener or attachEvent method"),v}();
rangy.createModule("DomUtil",function(a,c){function d(a){for(var b=0;a=a.previousSibling;)b++;return b}function f(a,b){var c=[],d;for(d=a;d;d=d.parentNode)c.push(d);for(d=b;d;d=d.parentNode)if(q(c,d))return d;return null}function e(a,b,c){for(c=c?a:a.parentNode;c;){a=c.parentNode;if(a===b)return c;c=a}return null}function i(a){a=a.nodeType;return 3==a||4==a||8==a}function g(a,b){var c=b.nextSibling,d=b.parentNode;c?d.insertBefore(a,c):d.appendChild(a);return a}function b(a){if(9==a.nodeType)return a;
if(typeof a.ownerDocument!=m)return a.ownerDocument;if(typeof a.document!=m)return a.document;if(a.parentNode)return b(a.parentNode);throw Error("getDocument: no document found for node");}function j(a){return!a?"[No node]":i(a)?'"'+a.data+'"':1==a.nodeType?"<"+a.nodeName+(a.id?' id="'+a.id+'"':"")+">["+a.childNodes.length+"]":a.nodeName}function l(a){this._next=this.root=a}function n(a,b){this.node=a;this.offset=b}function o(a){this.code=this[a];this.codeName=a;this.message="DOMException: "+this.codeName}
var m="undefined",p=a.util;p.areHostMethods(document,["createDocumentFragment","createElement","createTextNode"])||c.fail("document missing a Node creation method");p.isHostMethod(document,"getElementsByTagName")||c.fail("document missing getElementsByTagName method");var r=document.createElement("div");p.areHostMethods(r,["insertBefore","appendChild","cloneNode"])||c.fail("Incomplete Element implementation");p.isHostProperty(r,"innerHTML")||c.fail("Element is missing innerHTML property");r=document.createTextNode("test");
...
null}};n.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+j(this.node)+":"+this.offset+")]"}};o.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};o.prototype.toString=function(){return this.message};a.dom={arrayContains:q,isHtmlNamespace:function(a){var b;return typeof a.namespaceURI==m||null===(b=a.namespaceURI)||"http://www.w3.org/1999/xhtml"==
b},parentElement:function(a){a=a.parentNode;return 1==a.nodeType?a:null},getNodeIndex:d,getNodeLength:function(a){var b;return i(a)?a.length:(b=a.childNodes)?b.length:0},getCommonAncestor:f,isAncestorOf:function(a,b,c){for(b=c?b:b.parentNode;b;){if(b===a)return!0;b=b.parentNode}return!1},getClosestAncestorIn:e,isCharacterDataNode:i,insertAfter:g,splitDataNode:function(a,b){var c=a.cloneNode(!1);c.deleteData(0,b);a.deleteData(b,a.length-b);g(c,a);return c},getDocument:b,getWindow:function(a){a=b(a);
...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(a){return p.isHostObject(a,"body")?a.body:a.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var b;b=a.parentNode;)a=b;return a},comparePoints:function(a,b,c,j){var g;if(a==c)return b===j?0:b<j?-1:1;if(g=e(c,a,!0))return b<=d(g)?-1:1;if(g=e(a,c,!0))return d(g)<j?-1:1;b=f(a,c);a=a===b?b:e(a,b,!0);c=c===b?b:e(c,b,!0);if(a===c)throw Error("comparePoints got to case 4 and childA and childB are the same!");
for(b=b.firstChild;b;){if(b===a)return-1;if(b===c)return 1;b=b.nextSibling}throw Error("Should not be here!");},inspectNode:j,fragmentFromNodeChildren:function(a){for(var c=b(a).createDocumentFragment(),d;d=a.firstChild;)c.appendChild(d);return c},createIterator:function(a){return new l(a)},DomPosition:n};a.DOMException=o});
rangy.createModule("DomRange",function(a){function c(a,b){return 3!=a.nodeType&&(t.isAncestorOf(a,b.startContainer,!0)||t.isAncestorOf(a,b.endContainer,!0))}function d(a){return t.getDocument(a.startContainer)}function f(a,b,c){if(b=a._listeners[b])for(var d=0,h=b.length;d<h;++d)b[d].call(a,{target:a,args:c})}function e(a){return new I(a.parentNode,t.getNodeIndex(a))}function i(a){return new I(a.parentNode,t.getNodeIndex(a)+1)}function g(a,b,c){var d=11==a.nodeType?a.firstChild:a;t.isCharacterDataNode(b)?
c==b.length?t.insertAfter(a,b):b.parentNode.insertBefore(a,0==c?b:t.splitDataNode(b,c)):c>=b.childNodes.length?b.appendChild(a):b.insertBefore(a,b.childNodes[c]);return d}function b(a){for(var c,h,k=d(a.range).createDocumentFragment();h=a.next();){c=a.isPartiallySelectedSubtree();h=h.cloneNode(!c);c&&(c=a.getSubtreeIterator(),h.appendChild(b(c)),c.detach(!0));if(10==h.nodeType)throw new H("HIERARCHY_REQUEST_ERR");k.appendChild(h)}return k}function j(a,b,c){for(var d,h,c=c||{stop:!1};d=a.next();)if(a.isPartiallySelectedSubtree())if(!1===
b(d)){c.stop=!0;break}else{if(d=a.getSubtreeIterator(),j(d,b,c),d.detach(!0),c.stop)break}else for(d=t.createIterator(d);h=d.next();)if(!1===b(h)){c.stop=!0;return}}function l(a){for(var b;a.next();)a.isPartiallySelectedSubtree()?(b=a.getSubtreeIterator(),l(b),b.detach(!0)):a.remove()}function n(a){for(var b,c=d(a.range).createDocumentFragment(),h;b=a.next();){a.isPartiallySelectedSubtree()?(b=b.cloneNode(!1),h=a.getSubtreeIterator(),b.appendChild(n(h)),h.detach(!0)):a.remove();if(10==b.nodeType)throw new H("HIERARCHY_REQUEST_ERR");
c.appendChild(b)}return c}function o(a,b,c){var d=!(!b||!b.length),h,k=!!c;d&&(h=RegExp("^("+b.join("|")+")$"));var e=[];j(new p(a,!1),function(a){(!d||h.test(a.nodeType))&&(!k||c(a))&&e.push(a)});return e}function m(a){return"["+("undefined"==typeof a.getName?"Range":a.getName())+"("+t.inspectNode(a.startContainer)+":"+a.startOffset+", "+t.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function p(a,b){this.range=a;this.clonePartiallySelectedTextNodes=b;if(!a.collapsed){this.sc=a.startContainer;
...
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function q(a,b,c){this.nodes=o(a,b,c);this._next=this.nodes[0];this._position=0}function s(a){return function(b,c){for(var d,h=c?b:b.parentNode;h;){d=h.nodeType;if(t.arrayContains(a,d))return h;h=h.parentNode}return null}}function y(a,b){if(k(a,b))throw new r("INVALID_NODE_TYPE_ERR");}function v(a){if(!a.startContainer)throw new H("INVALID_STATE_ERR");}function z(a,b){if(!t.arrayContains(b,a.nodeType))throw new r("INVALID_NODE_TYPE_ERR");
}function B(a,b){if(0>b||b>(t.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new H("INDEX_SIZE_ERR");}function x(a,b){if(O(a,!0)!==O(b,!0))throw new H("WRONG_DOCUMENT_ERR");}function D(a){if(T(a,!0))throw new H("NO_MODIFICATION_ALLOWED_ERR");}function F(a,b){if(!a)throw new H(b);}function L(a){return!!a.startContainer&&!!a.endContainer&&!(!t.arrayContains(G,a.startContainer.nodeType)&&!O(a.startContainer,!0))&&!(!t.arrayContains(G,a.endContainer.nodeType)&&!O(a.endContainer,!0))&&a.startOffset<=
(t.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(t.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function E(a){v(a);if(!L(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function w(){}function P(a){a.START_TO_START=X;a.START_TO_END=Z;a.END_TO_END=$;a.END_TO_START=oa;a.NODE_BEFORE=aa;a.NODE_AFTER=pa;a.NODE_BEFORE_AND_AFTER=qa;a.NODE_INSIDE=ma}
function S(a){P(a);P(a.prototype)}function h(a,b){return function(){E(this);var c=this.startContainer,d=this.startOffset,h=this.commonAncestorContainer,k=new p(this,!0);c!==h&&(c=t.getClosestAncestorIn(c,h,!0),d=i(c),c=d.node,d=d.offset);j(k,D);k.reset();h=a(k);k.detach();b(this,c,d,c,d);return h}}function U(b,d,k){function f(a,b){return function(c){v(this);z(c,M);z(V(c),G);c=(a?e:i)(c);(b?j:g)(this,c.node,c.offset)}}function j(a,b,c){var h=a.endContainer,k=a.endOffset;if(b!==a.startContainer||c!==
a.startOffset){if(V(b)!=V(h)||1==t.comparePoints(b,c,h,k))h=b,k=c;d(a,b,c,h,k)}}function g(a,b,c){var h=a.startContainer,k=a.startOffset;if(b!==a.endContainer||c!==a.endOffset){if(V(b)!=V(h)||-1==t.comparePoints(b,c,h,k))h=b,k=c;d(a,h,k,b,c)}}b.prototype=new w;a.util.extend(b.prototype,{setStart:function(a,b){v(this);y(a,!0);B(a,b);j(this,a,b)},setEnd:function(a,b){v(this);y(a,!0);B(a,b);g(this,a,b)},setStartBefore:f(!0,!0),setStartAfter:f(!1,!0),setEndBefore:f(!0,!1),setEndAfter:f(!1,!1),collapse:function(a){E(this);
a?d(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):d(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){v(this);y(a,!0);d(this,a,0,a,t.getNodeLength(a))},selectNode:function(a){v(this);y(a,!1);z(a,M);var b=e(a),a=i(a);d(this,b.node,b.offset,a.node,a.offset)},extractContents:h(n,d),deleteContents:h(l,d),canSurroundContents:function(){E(this);D(this.startContainer);D(this.endContainer);var a=new p(this,!0),b=a._first&&
c(a._first,this)||a._last&&c(a._last,this);a.detach();return!b},detach:function(){k(this)},splitBoundaries:function(){E(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,h=this.endOffset,k=a===c;t.isCharacterDataNode(c)&&0<h&&h<c.length&&t.splitDataNode(c,h);t.isCharacterDataNode(a)&&0<b&&b<a.length&&(a=t.splitDataNode(a,b),k?(h-=b,c=a):c==a.parentNode&&h>=t.getNodeIndex(a)&&h++,b=0);d(this,a,b,c,h)},normalizeBoundaries:function(){E(this);var a=this.startContainer,b=this.startOffset,
c=this.endContainer,h=this.endOffset,k=function(a){var b=a.nextSibling;b&&b.nodeType==a.nodeType&&(c=a,h=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},e=function(d){var k=d.previousSibling;if(k&&k.nodeType==d.nodeType){a=d;var e=d.length;b=k.length;d.insertData(0,k.data);k.parentNode.removeChild(k);a==c?(h+=b,c=a):c==d.parentNode&&(k=t.getNodeIndex(d),h==k?(c=d,h=e):h>k&&h--)}},f=!0;t.isCharacterDataNode(c)?c.length==h&&k(c):(0<h&&(f=c.childNodes[h-1])&&t.isCharacterDataNode(f)&&k(f),
f=!this.collapsed);f?t.isCharacterDataNode(a)?0==b&&e(a):b<a.childNodes.length&&(k=a.childNodes[b])&&t.isCharacterDataNode(k)&&e(k):(a=c,b=h);d(this,a,b,c,h)},collapseToPoint:function(a,b){v(this);y(a,!0);B(a,b);(a!==this.startContainer||b!==this.startOffset||a!==this.endContainer||b!==this.endOffset)&&d(this,a,b,a,b)}});S(b)}function R(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:t.getCommonAncestor(a.startContainer,
a.endContainer)}function Q(a,b,c,d,h){var k=a.startContainer!==b||a.startOffset!==c,e=a.endContainer!==d||a.endOffset!==h;a.startContainer=b;a.startOffset=c;a.endContainer=d;a.endOffset=h;R(a);f(a,"boundarychange",{startMoved:k,endMoved:e})}function J(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};R(this)}a.requireModules(["DomUtil"]);var t=a.dom,I=t.DomPosition,H=a.DOMException;p.prototype={_current:null,_next:null,_first:null,
...
(a===this.sc||a===this.ec)?(b=a===this.sc?this.so:0,c=a===this.ec?this.eo:a.length,b!=c&&a.deleteData(b,c-b)):a.parentNode&&a.parentNode.removeChild(a)},isPartiallySelectedSubtree:function(){return c(this._current,this.range)},getSubtreeIterator:function(){var a;if(this.isSingleCharacterDataNode)a=this.range.cloneRange(),a.collapse();else{a=new J(d(this.range));var b=this._current,c=b,h=0,k=b,e=t.getNodeLength(b);t.isAncestorOf(b,this.sc,!0)&&(c=this.sc,h=this.so);t.isAncestorOf(b,this.ec,!0)&&(k=
this.ec,e=this.eo);Q(a,c,h,k,e)}return new p(a,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};r.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};r.prototype.toString=function(){return this.message};q.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
detach:function(){this._current=this._next=this.nodes=null}};var M=[1,3,4,5,7,8,10],G=[2,9,11],W=[1,3,4,5,7,8,10,11],ba=[1,3,4,5,7,8],V=t.getRootContainer,O=s([9,11]),T=s([5,6,10,12]),k=s([6,10,12]),u=document.createElement("style"),C=!1;try{u.innerHTML="<b>x</b>",C=3==u.firstChild.nodeType}catch(K){}a.features.htmlParsingConforms=C;var N="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),X=0,Z=1,$=2,oa=3,aa=0,pa=1,qa=2,ma=3;w.prototype={attachListener:function(a,
b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){E(this);x(this.startContainer,b.startContainer);var c=a==oa||a==X?"start":"end",d=a==Z||a==X?"start":"end";return t.comparePoints(this[c+"Container"],this[c+"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){E(this);z(a,W);D(this.startContainer);if(t.isAncestorOf(a,this.startContainer,!0))throw new H("HIERARCHY_REQUEST_ERR");this.setStartBefore(g(a,this.startContainer,this.startOffset))},cloneContents:function(){E(this);
var a,c;if(this.collapsed)return d(this).createDocumentFragment();if(this.startContainer===this.endContainer&&t.isCharacterDataNode(this.startContainer))return a=this.startContainer.cloneNode(!0),a.data=a.data.slice(this.startOffset,this.endOffset),c=d(this).createDocumentFragment(),c.appendChild(a),c;c=new p(this,!0);a=b(c);c.detach();return a},canSurroundContents:function(){E(this);D(this.startContainer);D(this.endContainer);var a=new p(this,!0),b=a._first&&c(a._first,this)||a._last&&c(a._last,
this);a.detach();return!b},surroundContents:function(a){z(a,ba);if(!this.canSurroundContents())throw new r("BAD_BOUNDARYPOINTS_ERR");var b=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);g(a,this.startContainer,this.startOffset);a.appendChild(b);this.selectNode(a)},cloneRange:function(){E(this);for(var a=new J(d(this)),b=N.length,c;b--;)c=N[b],a[c]=this[c];return a},toString:function(){E(this);var a=this.startContainer;if(a===this.endContainer&&t.isCharacterDataNode(a))return 3==
a.nodeType||4==a.nodeType?a.data.slice(this.startOffset,this.endOffset):"";var b=[],a=new p(this,!0);j(a,function(a){(3==a.nodeType||4==a.nodeType)&&b.push(a.data)});a.detach();return b.join("")},compareNode:function(a){E(this);var b=a.parentNode,c=t.getNodeIndex(a);if(!b)throw new H("NOT_FOUND_ERR");a=this.comparePoint(b,c);b=this.comparePoint(b,c+1);return 0>a?0<b?qa:aa:0<b?pa:ma},comparePoint:function(a,b){E(this);F(a,"HIERARCHY_REQUEST_ERR");x(a,this.startContainer);return 0>t.comparePoints(a,
b,this.startContainer,this.startOffset)?-1:0<t.comparePoints(a,b,this.endContainer,this.endOffset)?1:0},createContextualFragment:C?function(a){var b=this.startContainer,c=t.getDocument(b);if(!b)throw new H("INVALID_STATE_ERR");var d=null;1==b.nodeType?d=b:t.isCharacterDataNode(b)&&(d=t.parentElement(b));d=null===d||"HTML"==d.nodeName&&t.isHtmlNamespace(t.getDocument(d).documentElement)&&t.isHtmlNamespace(d)?c.createElement("body"):d.cloneNode(!1);d.innerHTML=a;return t.fragmentFromNodeChildren(d)}:
function(a){v(this);var b=d(this).createElement("body");b.innerHTML=a;return t.fragmentFromNodeChildren(b)},toHtml:function(){E(this);var a=d(this).createElement("div");a.appendChild(this.cloneContents());return a.innerHTML},intersectsNode:function(a,b){E(this);F(a,"NOT_FOUND_ERR");if(t.getDocument(a)!==d(this))return!1;var c=a.parentNode,h=t.getNodeIndex(a);F(c,"NOT_FOUND_ERR");var k=t.comparePoints(c,h,this.endContainer,this.endOffset),c=t.comparePoints(c,h+1,this.startContainer,this.startOffset);
return b?0>=k&&0<=c:0>k&&0<c},isPointInRange:function(a,b){E(this);F(a,"HIERARCHY_REQUEST_ERR");x(a,this.startContainer);return 0<=t.comparePoints(a,b,this.startContainer,this.startOffset)&&0>=t.comparePoints(a,b,this.endContainer,this.endOffset)},intersectsRange:function(a,b){E(this);if(d(a)!=d(this))throw new H("WRONG_DOCUMENT_ERR");var c=t.comparePoints(this.startContainer,this.startOffset,a.endContainer,a.endOffset),h=t.comparePoints(this.endContainer,this.endOffset,a.startContainer,a.startOffset);
...
this.startContainer,this.startOffset)&&b.setStart(a.startContainer,a.startOffset);1==t.comparePoints(a.endContainer,a.endOffset,this.endContainer,this.endOffset)&&b.setEnd(a.endContainer,a.endOffset);return b}throw new r("Ranges do not intersect");},containsNode:function(a,b){return b?this.intersectsNode(a,!1):this.compareNode(a)==ma},containsNodeContents:function(a){return 0<=this.comparePoint(a,0)&&0>=this.comparePoint(a,t.getNodeLength(a))},containsRange:function(a){return this.intersection(a).equals(a)},
containsNodeText:function(a){var b=this.cloneRange();b.selectNode(a);var c=b.getNodes([3]);return 0<c.length?(b.setStart(c[0],0),a=c.pop(),b.setEnd(a,a.length),a=this.containsRange(b),b.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){E(this);return new q(this,a,b)},getNodes:function(a,b){E(this);return o(this,a,b)},getDocument:function(){return d(this)},collapseBefore:function(a){v(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){v(this);this.setStartAfter(a);
this.collapse(!0)},getName:function(){return"DomRange"},equals:function(a){return J.rangesEqual(this,a)},isValid:function(){return L(this)},inspect:function(){return m(this)}};U(J,Q,function(a){v(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;f(a,"detach",null);a._listeners=null});a.rangePrototype=w.prototype;J.rangeProperties=N;J.RangeIterator=p;J.copyComparisonConstants=S;J.createPrototypeRange=U;J.inspect=m;J.getRangeDocument=d;J.rangesEqual=
function(a,b){return a.startContainer===b.startContainer&&a.startOffset===b.startOffset&&a.endContainer===b.endContainer&&a.endOffset===b.endOffset};a.DomRange=J;a.RangeException=r});
rangy.createModule("WrappedRange",function(a){function c(a,b,c,d){var f=a.duplicate();f.collapse(c);var g=f.parentElement();e.isAncestorOf(b,g,!0)||(g=b);if(!g.canHaveHTML)return new i(g.parentNode,e.getNodeIndex(g));var b=e.getDocument(g).createElement("span"),r,q=c?"StartToStart":"StartToEnd";do g.insertBefore(b,b.previousSibling),f.moveToElementText(b);while(0<(r=f.compareEndPoints(q,a))&&b.previousSibling);q=b.nextSibling;if(-1==r&&q&&e.isCharacterDataNode(q)){f.setEndPoint(c?"EndToStart":"EndToEnd",
a);if(/[\r\n]/.test(q.data)){g=f.duplicate();c=g.text.replace(/\r\n/g,"\r").length;for(c=g.moveStart("character",c);-1==g.compareEndPoints("StartToEnd",g);)c++,g.moveStart("character",1)}else c=f.text.length;g=new i(q,c)}else q=(d||!c)&&b.previousSibling,g=(c=(d||c)&&b.nextSibling)&&e.isCharacterDataNode(c)?new i(c,0):q&&e.isCharacterDataNode(q)?new i(q,q.length):new i(g,e.getNodeIndex(b));b.parentNode.removeChild(b);return g}function d(a,b){var c,d,f=a.offset,g=e.getDocument(a.node),i=g.body.createTextRange(),
q=e.isCharacterDataNode(a.node);q?(c=a.node,d=c.parentNode):(c=a.node.childNodes,c=f<c.length?c[f]:null,d=a.node);g=g.createElement("span");g.innerHTML="&#feff;";c?d.insertBefore(g,c):d.appendChild(g);i.moveToElementText(g);i.collapse(!b);d.removeChild(g);if(q)i[b?"moveStart":"moveEnd"]("character",f);return i}a.requireModules(["DomUtil","DomRange"]);var f,e=a.dom,i=e.DomPosition,g=a.DomRange;if(a.features.implementsDomRange&&(!a.features.implementsTextRange||!a.config.preferTextRange))(function(){function b(a){for(var c=
d.length,e;c--;)e=d[c],a[e]=a.nativeRange[e]}var c,d=g.rangeProperties,i;f=function(a){if(!a)throw Error("Range must be specified");this.nativeRange=a;b(this)};g.createPrototypeRange(f,function(a,b,c,d,e){var f=a.endContainer!==d||a.endOffset!=e;if(a.startContainer!==b||a.startOffset!=c||f)a.setEnd(d,e),a.setStart(b,c)},function(a){a.nativeRange.detach();a.detached=!0;for(var b=d.length,c;b--;)c=d[b],a[c]=null});c=f.prototype;c.selectNode=function(a){this.nativeRange.selectNode(a);b(this)};c.deleteContents=
function(){this.nativeRange.deleteContents();b(this)};c.extractContents=function(){var a=this.nativeRange.extractContents();b(this);return a};c.cloneContents=function(){return this.nativeRange.cloneContents()};c.surroundContents=function(a){this.nativeRange.surroundContents(a);b(this)};c.collapse=function(a){this.nativeRange.collapse(a);b(this)};c.cloneRange=function(){return new f(this.nativeRange.cloneRange())};c.refresh=function(){b(this)};c.toString=function(){return this.nativeRange.toString()};
var m=document.createTextNode("test");e.getBody(document).appendChild(m);var p=document.createRange();p.setStart(m,0);p.setEnd(m,0);try{p.setStart(m,1),c.setStart=function(a,c){this.nativeRange.setStart(a,c);b(this)},c.setEnd=function(a,c){this.nativeRange.setEnd(a,c);b(this)},i=function(a){return function(c){this.nativeRange[a](c);b(this)}}}catch(r){c.setStart=function(a,c){try{this.nativeRange.setStart(a,c)}catch(d){this.nativeRange.setEnd(a,c),this.nativeRange.setStart(a,c)}b(this)},c.setEnd=function(a,
c){try{this.nativeRange.setEnd(a,c)}catch(d){this.nativeRange.setStart(a,c),this.nativeRange.setEnd(a,c)}b(this)},i=function(a,c){return function(d){try{this.nativeRange[a](d)}catch(e){this.nativeRange[c](d),this.nativeRange[a](d)}b(this)}}}c.setStartBefore=i("setStartBefore","setEndBefore");c.setStartAfter=i("setStartAfter","setEndAfter");c.setEndBefore=i("setEndBefore","setStartBefore");c.setEndAfter=i("setEndAfter","setStartAfter");p.selectNodeContents(m);c.selectNodeContents=p.startContainer==
m&&p.endContainer==m&&0==p.startOffset&&p.endOffset==m.length?function(a){this.nativeRange.selectNodeContents(a);b(this)}:function(a){this.setStart(a,0);this.setEnd(a,g.getEndOffset(a))};p.selectNodeContents(m);p.setEnd(m,3);i=document.createRange();i.selectNodeContents(m);i.setEnd(m,4);i.setStart(m,2);c.compareBoundaryPoints=-1==p.compareBoundaryPoints(p.START_TO_END,i)&1==p.compareBoundaryPoints(p.END_TO_START,i)?function(a,b){b=b.nativeRange||b;a==b.START_TO_END?a=b.END_TO_START:a==b.END_TO_START&&
(a=b.START_TO_END);return this.nativeRange.compareBoundaryPoints(a,b)}:function(a,b){return this.nativeRange.compareBoundaryPoints(a,b.nativeRange||b)};a.util.isHostMethod(p,"createContextualFragment")&&(c.createContextualFragment=function(a){return this.nativeRange.createContextualFragment(a)});e.getBody(document).removeChild(m);p.detach();i.detach()})(),a.createNativeRange=function(a){return(a||document).createRange()};else if(a.features.implementsTextRange){f=function(a){this.textRange=a;this.refresh()};
f.prototype=new g(document);f.prototype.refresh=function(){var a,b,d=this.textRange;a=d.parentElement();var f=d.duplicate();f.collapse(!0);b=f.parentElement();f=d.duplicate();f.collapse(!1);d=f.parentElement();b=b==d?b:e.getCommonAncestor(b,d);b=b==a?b:e.getCommonAncestor(a,b);0==this.textRange.compareEndPoints("StartToEnd",this.textRange)?b=a=c(this.textRange,b,!0,!0):(a=c(this.textRange,b,!0,!1),b=c(this.textRange,b,!1,!1));this.setStart(a.node,a.offset);this.setEnd(b.node,b.offset)};g.copyComparisonConstants(f);
var b=function(){return this}();"undefined"==typeof b.Range&&(b.Range=f);a.createNativeRange=function(a){return(a||document).body.createTextRange()}}a.features.implementsTextRange&&(f.rangeToTextRange=function(a){if(a.collapsed)return d(new i(a.startContainer,a.startOffset),!0);var b=d(new i(a.startContainer,a.startOffset),!0),c=d(new i(a.endContainer,a.endOffset),!1),a=e.getDocument(a.startContainer).body.createTextRange();a.setEndPoint("StartToStart",b);a.setEndPoint("EndToEnd",c);return a});f.prototype.getName=
function(){return"WrappedRange"};a.WrappedRange=f;a.createRange=function(b){return new f(a.createNativeRange(b||document))};a.createRangyRange=function(a){return new g(a||document)};a.createIframeRange=function(b){return a.createRange(e.getIframeDocument(b))};a.createIframeRangyRange=function(b){return a.createRangyRange(e.getIframeDocument(b))};a.addCreateMissingNativeApiListener(function(b){b=b.document;if(typeof b.createRange=="undefined")b.createRange=function(){return a.createRange(this)};b=
b=null})});
rangy.createModule("WrappedSelection",function(a,c){function d(a){return(a||window).getSelection()}function f(a){return(a||window).document.selection}function e(a,b,c){var d=c?"end":"start",c=c?"start":"end";a.anchorNode=b[d+"Container"];a.anchorOffset=b[d+"Offset"];a.focusNode=b[c+"Container"];a.focusOffset=b[c+"Offset"]}function i(a){a.anchorNode=a.focusNode=null;a.anchorOffset=a.focusOffset=0;a.rangeCount=0;a.isCollapsed=!0;a._ranges.length=0}function g(b){var c;b instanceof y?(c=b._selectionNativeRange,c||
...
!1;break a}c=!0}if(!c)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function j(a,b){var c=new v(b);a._ranges=[c];e(a,c,!1);a.rangeCount=1;a.isCollapsed=c.collapsed}function l(b){b._ranges.length=0;if("None"==b.docSelection.type)i(b);else{var c=b.docSelection.createRange();if(c&&"undefined"!=typeof c.text)j(b,c);else{b.rangeCount=c.length;for(var d,h=q.getDocument(c.item(0)),k=0;k<b.rangeCount;++k)d=a.createRange(h),d.selectNode(c.item(k)),
b._ranges.push(d);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;e(b,b._ranges[b.rangeCount-1],!1)}}}function n(a,c){for(var d=a.docSelection.createRange(),h=b(c),k=q.getDocument(d.item(0)),k=q.getBody(k).createControlRange(),e=0,f=d.length;e<f;++e)k.add(d.item(e));try{k.add(h)}catch(g){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}k.select();l(a)}function o(a,b,c){this.nativeSelection=a;this.docSelection=b;this._ranges=
[];this.win=c;this.refresh()}function m(a,c){for(var d=q.getDocument(c[0].startContainer),d=q.getBody(d).createControlRange(),h=0,k;h<rangeCount;++h){k=b(c[h]);try{d.add(k)}catch(e){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();l(a)}function p(a,b){if(a.anchorNode&&q.getDocument(a.anchorNode)!==q.getDocument(b))throw new z("WRONG_DOCUMENT_ERR");}function r(a){var b=[],c=new B(a.anchorNode,a.anchorOffset),
d=new B(a.focusNode,a.focusOffset),h="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var e=0,f=a.rangeCount;e<f;++e)b[e]=y.inspect(a.getRangeAt(e));return"["+h+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var q=a.dom,s=a.util,y=a.DomRange,v=a.WrappedRange,z=a.DOMException,B=q.DomPosition,x,D,F=a.util.isHostMethod(window,"getSelection"),
L=a.util.isHostObject(document,"selection"),E=L&&(!F||a.config.preferTextRange);E?(x=f,a.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return"None"!=b.type||q.getDocument(b.createRange().parentElement())==a}):F?(x=d,a.isSelectionValid=function(){return!0}):c.fail("Neither document.selection or window.getSelection() detected.");a.getNativeSelection=x;var F=x(),w=a.createNativeRange(document),P=q.getBody(document),S=s.areHostObjects(F,s.areHostProperties(F,["anchorOffset","focusOffset"]));
a.features.selectionHasAnchorAndFocus=S;var h=s.isHostMethod(F,"extend");a.features.selectionHasExtend=h;var U="number"==typeof F.rangeCount;a.features.selectionHasRangeCount=U;var R=!1,Q=!0;s.areHostMethods(F,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof F.rangeCount&&a.features.implementsDomRange&&function(){var a=document.createElement("iframe");a.frameBorder=0;a.style.position="absolute";a.style.left="-10000px";P.appendChild(a);var b=q.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");
b.close();var c=q.getIframeWindow(a).getSelection(),d=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(d,1);b.collapse(true);c.addRange(b);Q=c.rangeCount==1;c.removeAllRanges();var h=b.cloneRange();b.setStart(d,0);h.setEnd(d,2);c.addRange(b);c.addRange(h);R=c.rangeCount==2;b.detach();h.detach();P.removeChild(a)}();a.features.selectionSupportsMultipleRanges=R;a.features.collapsedNonEditableSelectionsSupported=Q;var J=!1,t;P&&s.isHostMethod(P,"createControlRange")&&(t=P.createControlRange(),
s.areHostProperties(t,["item","add"])&&(J=!0));a.features.implementsControlRange=J;D=S?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:false};var I;s.isHostMethod(F,"getRangeAt")?I=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:S&&(I=function(b){var c=q.getDocument(b.anchorNode),c=a.createRange(c);c.setStart(b.anchorNode,b.anchorOffset);c.setEnd(b.focusNode,b.focusOffset);if(c.collapsed!==
this.isCollapsed){c.setStart(b.focusNode,b.focusOffset);c.setEnd(b.anchorNode,b.anchorOffset)}return c});a.getSelection=function(a){var a=a||window,b=a._rangySelection,c=x(a),d=L?f(a):null;if(b){b.nativeSelection=c;b.docSelection=d;b.refresh(a)}else{b=new o(c,d,a);a._rangySelection=b}return b};a.getIframeSelection=function(b){return a.getSelection(q.getIframeWindow(b))};t=o.prototype;if(!E&&S&&s.areHostMethods(F,["removeAllRanges","addRange"])){t.removeAllRanges=function(){this.nativeSelection.removeAllRanges();
i(this)};var H=function(b,c){var d=y.getRangeDocument(c),d=a.createRange(d);d.collapseToPoint(c.endContainer,c.endOffset);b.nativeSelection.addRange(g(d));b.nativeSelection.extend(c.startContainer,c.startOffset);b.refresh()};t.addRange=U?function(b,c){if(J&&L&&this.docSelection.type=="Control")n(this,b);else if(c&&h)H(this,b);else{var d;if(R)d=this.rangeCount;else{this.removeAllRanges();d=0}this.nativeSelection.addRange(g(b));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==d+1){if(a.config.checkSelectionRanges)(d=
I(this.nativeSelection,this.rangeCount-1))&&!y.rangesEqual(d,b)&&(b=new v(d));this._ranges[this.rangeCount-1]=b;e(this,b,W(this.nativeSelection));this.isCollapsed=D(this)}else this.refresh()}}:function(a,b){if(b&&h)H(this,a);else{this.nativeSelection.addRange(g(a));this.refresh()}};t.setRanges=function(a){if(J&&a.length>1)m(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(s.isHostMethod(F,"empty")&&s.isHostMethod(w,"select")&&J&&E)t.removeAllRanges=
function(){try{this.docSelection.empty();if(this.docSelection.type!="None"){var a;if(this.anchorNode)a=q.getDocument(this.anchorNode);else if(this.docSelection.type=="Control"){var b=this.docSelection.createRange();b.length&&(a=q.getDocument(b.item(0)).body.createTextRange())}if(a){a.body.createTextRange().select();this.docSelection.empty()}}}catch(c){}i(this)},t.addRange=function(a){if(this.docSelection.type=="Control")n(this,a);else{v.rangeToTextRange(a).select();this._ranges[0]=a;this.rangeCount=
1;this.isCollapsed=this._ranges[0].collapsed;e(this,a,false)}},t.setRanges=function(a){this.removeAllRanges();var b=a.length;b>1?m(this,a):b&&this.addRange(a[0])};else return c.fail("No means of selecting a Range or TextRange was found"),!1;t.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new z("INDEX_SIZE_ERR");return this._ranges[a]};var M;if(E)M=function(b){var c;if(a.isSelectionValid(b.win))c=b.docSelection.createRange();else{c=q.getBody(b.win.document).createTextRange();c.collapse(true)}b.docSelection.type==
"Control"?l(b):c&&typeof c.text!="undefined"?j(b,c):i(b)};else if(s.isHostMethod(F,"getRangeAt")&&"number"==typeof F.rangeCount)M=function(b){if(J&&L&&b.docSelection.type=="Control")l(b);else{b._ranges.length=b.rangeCount=b.nativeSelection.rangeCount;if(b.rangeCount){for(var c=0,d=b.rangeCount;c<d;++c)b._ranges[c]=new a.WrappedRange(b.nativeSelection.getRangeAt(c));e(b,b._ranges[b.rangeCount-1],W(b.nativeSelection));b.isCollapsed=D(b)}else i(b)}};else if(S&&"boolean"==typeof F.isCollapsed&&"boolean"==
typeof w.collapsed&&a.features.implementsDomRange)M=function(a){var b;b=a.nativeSelection;if(b.anchorNode){b=I(b,0);a._ranges=[b];a.rangeCount=1;b=a.nativeSelection;a.anchorNode=b.anchorNode;a.anchorOffset=b.anchorOffset;a.focusNode=b.focusNode;a.focusOffset=b.focusOffset;a.isCollapsed=D(a)}else i(a)};else return c.fail("No means of obtaining a Range or TextRange from the user's selection was found"),!1;t.refresh=function(a){var b=a?this._ranges.slice(0):null;M(this);if(a){a=b.length;if(a!=this._ranges.length)return false;
for(;a--;)if(!y.rangesEqual(b[a],this._ranges[a]))return false;return true}};var G=function(a,b){var c=a.getAllRanges(),d=false;a.removeAllRanges();for(var h=0,e=c.length;h<e;++h)d||b!==c[h]?a.addRange(c[h]):d=true;a.rangeCount||i(a)};t.removeRange=J?function(a){if(this.docSelection.type=="Control"){for(var c=this.docSelection.createRange(),a=b(a),d=q.getDocument(c.item(0)),d=q.getBody(d).createControlRange(),h,k=false,e=0,f=c.length;e<f;++e){h=c.item(e);h!==a||k?d.add(c.item(e)):k=true}d.select();
l(this)}else G(this,a)}:function(a){G(this,a)};var W;!E&&S&&a.features.implementsDomRange?(W=function(a){var b=false;a.anchorNode&&(b=q.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset)==1);return b},t.isBackwards=function(){return W(this)}):W=t.isBackwards=function(){return false};t.toString=function(){for(var a=[],b=0,c=this.rangeCount;b<c;++b)a[b]=""+this._ranges[b];return a.join("")};t.collapse=function(b,c){p(this,b);var d=a.createRange(q.getDocument(b));d.collapseToPoint(b,
c);this.removeAllRanges();this.addRange(d);this.isCollapsed=true};t.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new z("INVALID_STATE_ERR");};t.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new z("INVALID_STATE_ERR");};t.selectAllChildren=function(b){p(this,b);var c=a.createRange(q.getDocument(b));c.selectNodeContents(b);this.removeAllRanges();
this.addRange(c)};t.deleteFromDocument=function(){if(J&&L&&this.docSelection.type=="Control"){for(var a=this.docSelection.createRange(),b;a.length;){b=a.item(0);a.remove(b);b.parentNode.removeChild(b)}this.refresh()}else if(this.rangeCount){a=this.getAllRanges();this.removeAllRanges();b=0;for(var c=a.length;b<c;++b)a[b].deleteContents();this.addRange(a[c-1])}};t.getAllRanges=function(){return this._ranges.slice(0)};t.setSingleRange=function(a){this.setRanges([a])};t.containsNode=function(a,b){for(var c=
...
r;a.Selection=o;a.selectionPrototype=t;a.addCreateMissingNativeApiListener(function(b){if(typeof b.getSelection=="undefined")b.getSelection=function(){return a.getSelection(this)};b=null})});
rangy.createModule("CssClassApplier",function(a,c){function d(a,b){return a.className&&RegExp("(?:^|\\s)"+b+"(?:\\s|$)").test(a.className)}function f(a,b){a.className?d(a,b)||(a.className+=" "+b):a.className=b}function e(a){return a.split(/\s+/).sort().join(" ")}function i(a,b){return e(a.className)==e(b.className)}function g(a){for(var b=a.parentNode;a.hasChildNodes();)b.insertBefore(a.firstChild,a);b.removeChild(a)}function b(a,b){var c=a.cloneRange();c.selectNodeContents(b);var d=c.intersection(a),
d=d?d.toString():"";c.detach();return""!=d}function j(a){return a.getNodes([3],function(c){return b(a,c)})}function l(a,b){if(a.attributes.length!=b.attributes.length)return!1;for(var c=0,d=a.attributes.length,e,f;c<d;++c)if(e=a.attributes[c],f=e.name,"class"!=f&&(f=b.attributes.getNamedItem(f),e.specified!=f.specified||e.specified&&e.nodeValue!==f.nodeValue))return!1;return!0}function n(a,b){for(var c=0,d=a.attributes.length,e;c<d;++c)if(e=a.attributes[c].name,(!b||!z.arrayContains(b,e))&&a.attributes[c].specified&&
"class"!=e)return!0;return!1}function o(a){var b;return a&&1==a.nodeType&&((b=a.parentNode)&&9==b.nodeType&&"on"==b.designMode||D(a)&&!D(a.parentNode))}function m(a){return(D(a)||1!=a.nodeType&&D(a.parentNode))&&!o(a)}function p(a){return a&&1==a.nodeType&&!F.test(x(a,"display"))}function r(a){if(0==a.data.length)return!0;if(L.test(a.data))return!1;switch(x(a.parentNode,"whiteSpace")){case "pre":case "pre-wrap":case "-moz-pre-wrap":return!1;case "pre-line":if(/[\r\n]/.test(a.data))return!1}return p(a.previousSibling)||
p(a.nextSibling)}function q(a,b,d,e){var f,g=0==d;if(z.isAncestorOf(b,a))return a;if(z.isCharacterDataNode(b))if(0==d)d=z.getNodeIndex(b),b=b.parentNode;else if(d==b.length)d=z.getNodeIndex(b)+1,b=b.parentNode;else throw c.createError("splitNodeAt should not be called with offset in the middle of a data node ("+d+" in "+b.data);if(z.isCharacterDataNode(b)?0==d?b.previousSibling:d==b.length?b.nextSibling:1:0<d&&d<b.childNodes.length){if(!f){f=b.cloneNode(!1);for(f.id&&f.removeAttribute("id");g=b.childNodes[d];)f.appendChild(g);
z.insertAfter(f,b)}return b==a?f:q(a,f.parentNode,z.getNodeIndex(f),e)}return a!=b?(f=b.parentNode,b=z.getNodeIndex(b),g||b++,q(a,f,b,e)):a}function s(a){var b=a?"nextSibling":"previousSibling";return function(c,d){var e=c.parentNode,f=c[b];if(f){if(f&&3==f.nodeType)return f}else if(d&&(f=e[b])&&1==f.nodeType&&e.tagName==f.tagName&&i(e,f)&&l(e,f))return f[a?"firstChild":"lastChild"];return null}}function y(a){this.firstTextNode=(this.isElementMerge=1==a.nodeType)?a.lastChild:a;this.textNodes=[this.firstTextNode]}
function v(a,b,c){this.cssClass=a;var d,f,g=null;if("object"==typeof b&&null!==b){c=b.tagNames;g=b.elementProperties;for(d=0;f=P[d++];)b.hasOwnProperty(f)&&(this[f]=b[f]);d=b.normalize}else d=b;this.normalize="undefined"==typeof d?!0:d;this.attrExceptions=[];d=document.createElement(this.elementTagName);this.elementProperties={};for(var i in g)g.hasOwnProperty(i)&&(S.hasOwnProperty(i)&&(i=S[i]),d[i]=g[i],this.elementProperties[i]=d[i],this.attrExceptions.push(i));this.elementSortedClassName=this.elementProperties.hasOwnProperty("className")?
e(this.elementProperties.className+" "+a):a;this.applyToAnyTagName=!1;a=typeof c;if("string"==a)"*"==c?this.applyToAnyTagName=!0:this.tagNames=c.toLowerCase().replace(/^\s\s*/,"").replace(/\s\s*$/,"").split(/\s*,\s*/);else if("object"==a&&"number"==typeof c.length){this.tagNames=[];d=0;for(a=c.length;d<a;++d)"*"==c[d]?this.applyToAnyTagName=!0:this.tagNames.push(c[d].toLowerCase())}else this.tagNames=[this.elementTagName]}a.requireModules(["WrappedSelection","WrappedRange"]);var z=a.dom,B=function(){function a(b,
c,d){return c&&d?" ":""}return function(b,c){b.className&&(b.className=b.className.replace(RegExp("(?:^|\\s)"+c+"(?:\\s|$)"),a))}}(),x;"undefined"!=typeof window.getComputedStyle?x=function(a,b){return z.getWindow(a).getComputedStyle(a,null)[b]}:"undefined"!=typeof document.documentElement.currentStyle?x=function(a,b){return a.currentStyle[b]}:c.fail("No means of obtaining computed style properties found");var D;(function(){D="boolean"==typeof document.createElement("div").isContentEditable?function(a){return a&&
1==a.nodeType&&a.isContentEditable}:function(a){return!a||1!=a.nodeType||"false"==a.contentEditable?!1:"true"==a.contentEditable||D(a.parentNode)}})();var F=/^inline(-block|-table)?$/i,L=/[^\r\n\t\f \u200B]/,E=s(!1),w=s(!0);y.prototype={doMerge:function(){for(var a=[],b,c,d=0,e=this.textNodes.length;d<e;++d)b=this.textNodes[d],c=b.parentNode,a[d]=b.data,d&&(c.removeChild(b),c.hasChildNodes()||c.parentNode.removeChild(c));return this.firstTextNode.data=a=a.join("")},getLength:function(){for(var a=
this.textNodes.length,b=0;a--;)b+=this.textNodes[a].length;return b},toString:function(){for(var a=[],b=0,c=this.textNodes.length;b<c;++b)a[b]="'"+this.textNodes[b].data+"'";return"[Merge("+a.join(",")+")]"}};var P=["elementTagName","ignoreWhiteSpace","applyToEditableOnly"],S={"class":"className"};v.prototype={elementTagName:"span",elementProperties:{},ignoreWhiteSpace:!0,applyToEditableOnly:!1,hasClass:function(a){return 1==a.nodeType&&z.arrayContains(this.tagNames,a.tagName.toLowerCase())&&d(a,
this.cssClass)},getSelfOrAncestorWithClass:function(a){for(;a;){if(this.hasClass(a,this.cssClass))return a;a=a.parentNode}return null},isModifiable:function(a){return!this.applyToEditableOnly||m(a)},isIgnorableWhiteSpaceNode:function(a){return this.ignoreWhiteSpace&&a&&3==a.nodeType&&r(a)},postApply:function(a,b,c){for(var d=a[0],e=a[a.length-1],f=[],g,i=d,j=e,l=0,m=e.length,o,p,n=0,r=a.length;n<r;++n)if(o=a[n],p=E(o,!c)){if(g||(g=new y(p),f.push(g)),g.textNodes.push(o),o===d&&(i=g.firstTextNode,
l=i.length),o===e)j=g.firstTextNode,m=g.getLength()}else g=null;if(a=w(e,!c))g||(g=new y(e),f.push(g)),g.textNodes.push(a);if(f.length){n=0;for(r=f.length;n<r;++n)f[n].doMerge();b.setStart(i,l);b.setEnd(j,m)}},createContainer:function(b){b=b.createElement(this.elementTagName);a.util.extend(b,this.elementProperties);f(b,this.cssClass);return b},applyToTextNode:function(a){var b=a.parentNode;1==b.childNodes.length&&z.arrayContains(this.tagNames,b.tagName.toLowerCase())?f(b,this.cssClass):(b=this.createContainer(z.getDocument(a)),
a.parentNode.insertBefore(b,a),b.appendChild(a))},isRemovable:function(a){var b;if(b=a.tagName.toLowerCase()==this.elementTagName)if(b=e(a.className)==this.elementSortedClassName){var c;a:{b=this.elementProperties;for(c in b)if(b.hasOwnProperty(c)&&a[c]!==b[c]){c=!1;break a}c=!0}b=c&&!n(a,this.attrExceptions)&&this.isModifiable(a)}return b},undoToTextNode:function(a,b,c){b.containsNode(c)||(a=b.cloneRange(),a.selectNode(c),a.isPointInRange(b.endContainer,b.endOffset)&&(q(c,b.endContainer,b.endOffset,
[b]),b.setEndAfter(c)),a.isPointInRange(b.startContainer,b.startOffset)&&(c=q(c,b.startContainer,b.startOffset,[b])));this.isRemovable(c)?g(c):B(c,this.cssClass)},applyToRange:function(a){a.splitBoundaries();var b=j(a);if(b.length){for(var c,d=0,e=b.length;d<e;++d)c=b[d],!this.isIgnorableWhiteSpaceNode(c)&&!this.getSelfOrAncestorWithClass(c)&&this.isModifiable(c)&&this.applyToTextNode(c);a.setStart(b[0],0);c=b[b.length-1];a.setEnd(c,c.length);this.normalize&&this.postApply(b,a,!1)}},applyToSelection:function(b){var b=
...
return!0},isAppliedToSelection:function(b){for(var b=a.getSelection(b||window).getAllRanges(),c=b.length;c--;)if(!this.isAppliedToRange(b[c]))return!1;return!0},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)},toggleSelection:function(a){this.isAppliedToSelection(a)?this.undoToSelection(a):this.applyToSelection(a)},detach:function(){}};v.util={hasClass:d,addClass:f,removeClass:B,hasSameClasses:i,replaceWithOwnChildren:g,elementsHaveSameNonClassAttributes:l,
elementHasNonClassAttributes:n,splitNodeAt:q,isEditableElement:D,isEditingHost:o,isEditable:m};a.CssClassApplier=v;a.createCssClassApplier=function(a,b,c){return new v(a,b,c)}});
rangy.createModule("SaveRestore",function(a,c){function d(a,c){var d="selectionBoundary_"+ +new Date+"_"+(""+Math.random()).slice(2),e,f=g.getDocument(a.startContainer),i=a.cloneRange();i.collapse(c);e=f.createElement("span");e.id=d;e.style.lineHeight="0";e.style.display="none";e.className="rangySelectionBoundary";e.appendChild(f.createTextNode(b));i.insertNode(e);i.detach();return e}function f(a,b,d,e){(a=(a||document).getElementById(d))?(b[e?"setStartBefore":"setEndBefore"](a),a.parentNode.removeChild(a)):
c.warn("Marker element has been removed. Cannot restore selection.")}function e(a,b){return b.compareBoundaryPoints(a.START_TO_START,a)}function i(a,b){var c=(a||document).getElementById(b);c&&c.parentNode.removeChild(c)}a.requireModules(["DomUtil","DomRange","WrappedRange"]);var g=a.dom,b="\ufeff";a.saveSelection=function(b){var b=b||window,f=b.document;if(a.isSelectionValid(b)){var g=a.getSelection(b),i=g.getAllRanges(),m=[],p,r;i.sort(e);for(var q=0,s=i.length;q<s;++q)p=i[q],p.collapsed?(r=d(p,
!1),m.push({markerId:r.id,collapsed:!0})):(r=d(p,!1),p=d(p,!0),m[q]={startMarkerId:p.id,endMarkerId:r.id,collapsed:!1,backwards:1==i.length&&g.isBackwards()});for(q=s-1;0<=q;--q)p=i[q],p.collapsed?p.collapseBefore((f||document).getElementById(m[q].markerId)):(p.setEndBefore((f||document).getElementById(m[q].endMarkerId)),p.setStartAfter((f||document).getElementById(m[q].startMarkerId)));g.setRanges(i);return{win:b,doc:f,rangeInfos:m,restored:!1}}c.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
a.restoreSelection=function(b,d){if(!b.restored){for(var e=b.rangeInfos,g=a.getSelection(b.win),i=[],p=e.length,r=p-1,q,s;0<=r;--r){q=e[r];s=a.createRange(b.doc);if(q.collapsed)if(q=(b.doc||document).getElementById(q.markerId)){q.style.display="inline";var y=q.previousSibling;y&&3==y.nodeType?(q.parentNode.removeChild(q),s.collapseToPoint(y,y.length)):(s.collapseBefore(q),q.parentNode.removeChild(q))}else c.warn("Marker element has been removed. Cannot restore selection.");else f(b.doc,s,q.startMarkerId,
!0),f(b.doc,s,q.endMarkerId,!1);1==p&&s.normalizeBoundaries();i[r]=s}1==p&&d&&a.features.selectionHasExtend&&e[0].backwards?(g.removeAllRanges(),g.addRange(i[0],!0)):g.setRanges(i);b.restored=!0}};a.removeMarkerElement=i;a.removeMarkers=function(a){for(var b=a.rangeInfos,c=0,d=b.length,e;c<d;++c)e=b[c],e.collapsed?i(a.doc,e.markerId):(i(a.doc,e.startMarkerId),i(a.doc,e.endMarkerId))}});
rangy.createModule("Serializer",function(a,c){function d(a,b){var b=b||[],c=a.nodeType,e=a.childNodes,f=e.length,g=[c,a.nodeName,f].join(":"),i="",j="";switch(c){case 3:i=a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;");break;case 8:i="<\!--"+a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;")+"--\>";break;default:i="<"+g+">",j="</>"}i&&b.push(i);for(c=0;c<f;++c)d(e[c],b);j&&b.push(j);return b}function f(a){a=d(a).join("");return o(a).toString(16)}function e(a,b,c){for(var d=[],e=a,c=c||m.getDocument(a).documentElement;e&&
...
f&63|128);b=-1;if(!a){for(var d=[],e=0,g;256>e;++e){g=e;for(f=8;f--;)g=1==(g&1)?g>>>1^3988292384:g>>>1;d[e]=g>>>0}a=d}d=a;e=0;for(f=c.length;e<f;++e)g=(b^c[e])&255,b=b>>>8^d[g];return(b^-1)>>>0}}(),m=a.dom;a.serializePosition=e;a.deserializePosition=i;a.serializeRange=g;a.deserializeRange=b;a.canDeserializeRange=j;a.serializeSelection=l;a.deserializeSelection=n;a.canDeserializeSelection=function(a,b,c){var d;b?d=c?c.document:m.getDocument(b):b=(c||window).document.documentElement;for(var a=a.split("|"),
c=0,e=a.length;c<e;++c)if(!j(a[c],b,d))return!1;return!0};a.restoreSelectionFromCookie=function(a){var a=a||window,b;a:{b=a.document.cookie.split(/[;,]/);for(var c=0,d=b.length,e;c<d;++c)if(e=b[c].split("="),"rangySerializedSelection"==e[0].replace(/^\s+/,"")&&(e=e[1])){b=decodeURIComponent(e.replace(/\s+$/,""));break a}b=null}b&&n(b,a.doc)};a.saveSelectionCookie=function(b,c){var b=b||window,c="object"==typeof c?c:{},d=c.expires?";expires="+c.expires.toUTCString():"",e=c.path?";path="+c.path:"",
f=c.domain?";domain="+c.domain:"",g=c.secure?";secure":"",i=l(a.getSelection(b));b.document.cookie=encodeURIComponent("rangySerializedSelection")+"="+encodeURIComponent(i)+d+e+f+g};a.getElementChecksum=f});
(function(a,c){function d(a){var b=U[a]={},c,d,a=a.split(/\s+/);c=0;for(d=a.length;c<d;c++)b[a[c]]=!0;return b}function f(a,b,d){if(d===c&&1===a.nodeType)if(d="data-"+b.replace(J,"-$1").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:h.isNumeric(d)?+d:Q.test(d)?h.parseJSON(d):d}catch(e){}h.data(a,b,d)}else d=c;return d}function e(a){for(var b in a)if(!("data"===b&&h.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function i(a,b,c){var d=
...
function m(a){return"undefined"!==typeof a.getElementsByTagName?a.getElementsByTagName("*"):"undefined"!==typeof a.querySelectorAll?a.querySelectorAll("*"):[]}function p(a){if("checkbox"===a.type||"radio"===a.type)a.defaultChecked=a.checked}function r(a){var b=(a.nodeName||"").toLowerCase();"input"===b?p(a):"script"!==b&&"undefined"!==typeof a.getElementsByTagName&&h.grep(a.getElementsByTagName("input"),p)}function q(a,b,c){var d="width"===b?a.offsetWidth:a.offsetHeight,e="width"===b?1:0;if(0<d){if("border"!==
c)for(;4>e;e+=2)c||(d-=parseFloat(h.css(a,"padding"+fa[e]))||0),d="margin"===c?d+(parseFloat(h.css(a,c+fa[e]))||0):d-(parseFloat(h.css(a,"border"+fa[e]+"Width"))||0);return d+"px"}d=ia(a,b);if(0>d||null==d)d=a.style[b];if(xa.test(d))return d;d=parseFloat(d)||0;if(c)for(;4>e;e+=2)d+=parseFloat(h.css(a,"padding"+fa[e]))||0,"padding"!==c&&(d+=parseFloat(h.css(a,"border"+fa[e]+"Width"))||0),"margin"===c&&(d+=parseFloat(h.css(a,c+fa[e]))||0);return d+"px"}function s(a){return function(b,c){"string"!==
typeof b&&(c=b,b="*");if(h.isFunction(c))for(var d=b.toLowerCase().split(La),e=0,f=d.length,k,g;e<f;e++)k=d[e],(g=/^\+/.test(k))&&(k=k.substr(1)||"*"),k=a[k]=a[k]||[],k[g?"unshift":"push"](c)}}function y(a,b,d,e,f,k){f=f||b.dataTypes[0];k=k||{};k[f]=!0;for(var f=a[f],g=0,i=f?f.length:0,h=a===ya,j;g<i&&(h||!j);g++)j=f[g](b,d,e),"string"===typeof j&&(!h||k[j]?j=c:(b.dataTypes.unshift(j),j=y(a,b,d,e,j,k)));if((h||!j)&&!k["*"])j=y(a,b,d,e,"*",k);return j}function v(a,b){var d,e,f=h.ajaxSettings.flatOptions||
{};for(d in b)b[d]!==c&&((f[d]?a:e||(e={}))[d]=b[d]);e&&h.extend(!0,a,e)}function z(a,b,c,d){if(h.isArray(b))h.each(b,function(b,e){c||db.test(a)?d(a,e):z(a+"["+("object"===typeof e?b:"")+"]",e,c,d)});else if(!c&&"object"===h.type(b))for(var e in b)z(a+"["+e+"]",b[e],c,d);else d(a,b)}function B(){try{return new a.XMLHttpRequest}catch(b){}}function x(){setTimeout(D,0);return ra=h.now()}function D(){ra=c}function F(a,b){var c={};h.each(sa.concat.apply([],sa.slice(0,b)),function(){c[this]=a});return c}
function L(a){if(!za[a]){var b=w.body,c=h("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d){ca||(ca=w.createElement("iframe"),ca.frameBorder=ca.width=ca.height=0);b.appendChild(ca);if(!ja||!ca.createElement)ja=(ca.contentWindow||ca.contentDocument).document,ja.write((h.support.boxModel?"<!doctype html>":"")+"<html><body>"),ja.close();c=ja.createElement(a);ja.body.appendChild(c);d=h.css(c,"display");b.removeChild(ca)}za[a]=d}return za[a]}function E(a){return h.isWindow(a)?
a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var w=a.document,P=a.navigator,S=a.location,h=function(){function b(){if(!d.isReady){try{w.documentElement.doScroll("left")}catch(a){setTimeout(b,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,k)},e=a.jQuery,f=a.$,k,g=/^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,i=/\S/,h=/^\s+/,j=/\s+$/,u=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,l=/^[\],:{}\s]*$/,C=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,m=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
o=/(?:^|:|,)(?:\s*\[)+/g,n=/(webkit)[ \/]([\w.]+)/,p=/(opera)(?:.*version)?[ \/]([\w.]+)/,r=/(msie) ([\w.]+)/,K=/(mozilla)(?:.*? rv:([\w.]+))?/,q=/-([a-z]|[0-9])/ig,N=/^-ms-/,s=function(a,b){return(b+"").toUpperCase()},v=P.userAgent,ta,ka,eb=Object.prototype.toString,Aa=Object.prototype.hasOwnProperty,X=Array.prototype.push,na=Array.prototype.slice,y=String.prototype.trim,t=Array.prototype.indexOf,Z={};d.fn=d.prototype={constructor:d,init:function(a,b,e){var A;if(!a)return this;if(a.nodeType)return this.context=
this[0]=a,this.length=1,this;if("body"===a&&!b&&w.body)return this.context=w,this[0]=w.body,this.selector=a,this.length=1,this;if("string"===typeof a){if((A="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:g.exec(a))&&(A[1]||!b)){if(A[1])return e=(b=b instanceof d?b[0]:b)?b.ownerDocument||b:w,(a=u.exec(a))?d.isPlainObject(b)?(a=[w.createElement(a[1])],d.fn.attr.call(a,b,!0)):a=[e.createElement(a[1])]:(a=d.buildFragment([A[1]],[e]),a=(a.cacheable?d.clone(a.fragment):a.fragment).childNodes),
d.merge(this,a);if((b=w.getElementById(A[2]))&&b.parentNode){if(b.id!==A[2])return e.find(a);this.length=1;this[0]=b}this.context=w;this.selector=a;return this}return!b||b.jquery?(b||e).find(a):this.constructor(b).find(a)}if(d.isFunction(a))return e.ready(a);a.selector!==c&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,this)},selector:"",jquery:"1.7.2",length:0,size:function(){return this.length},toArray:function(){return na.call(this,0)},get:function(a){return null==a?this.toArray():
0>a?this[this.length+a]:this[a]},pushStack:function(a,b,c){var e=this.constructor();d.isArray(a)?X.apply(e,a):d.merge(e,a);e.prevObject=this;e.context=this.context;"find"===b?e.selector=this.selector+(this.selector?" ":"")+c:b&&(e.selector=this.selector+"."+b+"("+c+")");return e},each:function(a,b){return d.each(this,a,b)},ready:function(a){d.bindReady();ta.add(a);return this},eq:function(a){a=+a;return-1===a?this.slice(a):this.slice(a,a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},
slice:function(){return this.pushStack(na.apply(this,arguments),"slice",na.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:X,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,b,e,A,f,k=arguments[0]||{},g=1,i=arguments.length,h=!1;"boolean"===typeof k&&(h=k,k=arguments[1]||{},g=2);"object"!==typeof k&&!d.isFunction(k)&&(k=
{});i===g&&(k=this,--g);for(;g<i;g++)if(null!=(a=arguments[g]))for(b in a)e=k[b],A=a[b],k!==A&&(h&&A&&(d.isPlainObject(A)||(f=d.isArray(A)))?(f?(f=!1,e=e&&d.isArray(e)?e:[]):e=e&&d.isPlainObject(e)?e:{},k[b]=d.extend(h,e,A)):A!==c&&(k[b]=A));return k};d.extend({noConflict:function(b){a.$===d&&(a.$=f);b&&a.jQuery===d&&(a.jQuery=e);return d},isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!w.body)return setTimeout(d.ready,
1);d.isReady=!0;!0!==a&&0<--d.readyWait||(ta.fireWith(w,[d]),d.fn.trigger&&d(w).trigger("ready").off("ready"))}},bindReady:function(){if(!ta){ta=d.Callbacks("once memory");if("complete"===w.readyState)return setTimeout(d.ready,1);if(w.addEventListener)w.addEventListener("DOMContentLoaded",ka,!1),a.addEventListener("load",d.ready,!1);else if(w.attachEvent){w.attachEvent("onreadystatechange",ka);a.attachEvent("onload",d.ready);var c=!1;try{c=null==a.frameElement}catch(e){}w.documentElement.doScroll&&
c&&b()}}},isFunction:function(a){return"function"===d.type(a)},isArray:Array.isArray||function(a){return"array"===d.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!isNaN(parseFloat(a))&&isFinite(a)},type:function(a){return null==a?""+a:Z[eb.call(a)]||"object"},isPlainObject:function(a){if(!a||"object"!==d.type(a)||a.nodeType||d.isWindow(a))return!1;try{if(a.constructor&&!Aa.call(a,"constructor")&&!Aa.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(b){return!1}for(var e in a);
return e===c||Aa.call(a,e)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(l.test(b.replace(C,"@").replace(m,"]").replace(o,"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b){if("string"!==typeof b||!b)return null;var e,A;try{a.DOMParser?(A=new DOMParser,e=A.parseFromString(b,"text/xml")):
(e=new ActiveXObject("Microsoft.XMLDOM"),e.async="false",e.loadXML(b))}catch(f){e=c}(!e||!e.documentElement||e.getElementsByTagName("parsererror").length)&&d.error("Invalid XML: "+b);return e},noop:function(){},globalEval:function(b){b&&i.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(N,"ms-").replace(q,s)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,b,e){var A,f=0,k=a.length,g=k===c||d.isFunction(a);
if(e)if(g)for(A in a){if(!1===b.apply(a[A],e))break}else for(;f<k&&!1!==b.apply(a[f++],e););else if(g)for(A in a){if(!1===b.call(a[A],A,a[A]))break}else for(;f<k&&!1!==b.call(a[f],f,a[f++]););return a},trim:y?function(a){return null==a?"":y.call(a)}:function(a){return null==a?"":a.toString().replace(h,"").replace(j,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var e=d.type(a);null==a.length||"string"===e||"function"===e||"regexp"===e||d.isWindow(a)?X.call(c,a):d.merge(c,a)}return c},inArray:function(a,
b,c){var d;if(b){if(t)return t.call(b,a,c);d=b.length;for(c=c?0>c?Math.max(0,d+c):c:0;c<d;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,b){var d=a.length,e=0;if("number"===typeof b.length)for(var A=b.length;e<A;e++)a[d++]=b[e];else for(;b[e]!==c;)a[d++]=b[e++];a.length=d;return a},grep:function(a,b,c){for(var d=[],e,c=!!c,A=0,f=a.length;A<f;A++)e=!!b(a[A],A),c!==e&&d.push(a[A]);return d},map:function(a,b,e){var A,f,k=[],g=0,i=a.length;if(a instanceof d||i!==c&&"number"===typeof i&&(0<
i&&a[0]&&a[i-1]||0===i||d.isArray(a)))for(;g<i;g++)A=b(a[g],g,e),null!=A&&(k[k.length]=A);else for(f in a)A=b(a[f],f,e),null!=A&&(k[k.length]=A);return k.concat.apply([],k)},guid:1,proxy:function(a,b){if("string"===typeof b)var e=a[b],b=a,a=e;if(!d.isFunction(a))return c;var A=na.call(arguments,2),e=function(){return a.apply(b,A.concat(na.call(arguments)))};e.guid=a.guid=a.guid||e.guid||d.guid++;return e},access:function(a,b,e,A,f,k,g){var i,h=null==e,j=0,u=a.length;if(e&&"object"===typeof e){for(j in e)d.access(a,
b,j,e[j],1,k,A);f=1}else if(A!==c){i=g===c&&d.isFunction(A);h&&(i?(i=b,b=function(a,b,c){return i.call(d(a),c)}):(b.call(a,A),b=null));if(b)for(;j<u;j++)b(a[j],e,i?A.call(a[j],j,b(a[j],e)):A,g);f=1}return f?a:h?b.call(a):u?b(a[0],e):k},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=n.exec(a)||p.exec(a)||r.exec(a)||0>a.indexOf("compatible")&&K.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,
a,this);a.superclass=this;a.fn=a.prototype=this();a.fn.constructor=a;a.sub=this.sub;a.fn.init=function(c,e){e&&e instanceof d&&!(e instanceof a)&&(e=a(e));return d.fn.init.call(this,c,e,b)};a.fn.init.prototype=a.fn;var b=a(w);return a},browser:{}});d.each("Boolean,Number,String,Function,Array,Date,RegExp,Object".split(","),function(a,b){Z["[object "+b+"]"]=b.toLowerCase()});v=d.uaMatch(v);v.browser&&(d.browser[v.browser]=!0,d.browser.version=v.version);d.browser.webkit&&(d.browser.safari=!0);i.test("\u00a0")&&
(h=/^[\s\xA0]+/,j=/[\s\xA0]+$/);k=d(w);w.addEventListener?ka=function(){w.removeEventListener("DOMContentLoaded",ka,false);d.ready()}:w.attachEvent&&(ka=function(){if(w.readyState==="complete"){w.detachEvent("onreadystatechange",ka);d.ready()}});return d}(),U={};h.Callbacks=function(a){var a=a?U[a]||d(a):{},b=[],e=[],f,k,g,i,j,u,l=function(c){var d,e,f,k;d=0;for(e=c.length;d<e;d++)f=c[d],k=h.type(f),"array"===k?l(f):"function"===k&&(!a.unique||!m.has(f))&&b.push(f)},C=function(c,d){d=d||[];f=!a.memory||
[c,d];g=k=!0;u=i||0;i=0;for(j=b.length;b&&u<j;u++)if(!1===b[u].apply(c,d)&&a.stopOnFalse){f=!0;break}g=!1;b&&(a.once?!0===f?m.disable():b=[]:e&&e.length&&(f=e.shift(),m.fireWith(f[0],f[1])))},m={add:function(){if(b){var a=b.length;l(arguments);g?j=b.length:f&&!0!==f&&(i=a,C(f[0],f[1]))}return this},remove:function(){if(b)for(var c=arguments,d=0,e=c.length;d<e;d++)for(var f=0;f<b.length&&!(c[d]===b[f]&&(g&&f<=j&&(j--,f<=u&&u--),b.splice(f--,1),a.unique));f++);return this},has:function(a){if(b)for(var c=
0,d=b.length;c<d;c++)if(a===b[c])return!0;return!1},empty:function(){b=[];return this},disable:function(){b=e=f=c;return this},disabled:function(){return!b},lock:function(){e=c;(!f||!0===f)&&m.disable();return this},locked:function(){return!e},fireWith:function(b,c){e&&(g?a.once||e.push([b,c]):(!a.once||!f)&&C(b,c));return this},fire:function(){m.fireWith(this,arguments);return this},fired:function(){return!!k}};return m};var R=[].slice;h.extend({Deferred:function(a){var b=h.Callbacks("once memory"),
c=h.Callbacks("once memory"),d=h.Callbacks("memory"),e="pending",f={resolve:b,reject:c,notify:d},k={done:b.add,fail:c.add,progress:d.add,state:function(){return e},isResolved:b.fired,isRejected:c.fired,then:function(a,b,c){g.done(a).fail(b).progress(c);return this},always:function(){g.done.apply(g,arguments).fail.apply(g,arguments);return this},pipe:function(a,b,c){return h.Deferred(function(d){h.each({done:[a,"resolve"],fail:[b,"reject"],progress:[c,"notify"]},function(a,b){var c=b[0],e=b[1],A;if(h.isFunction(c))g[a](function(){if((A=
c.apply(this,arguments))&&h.isFunction(A.promise))A.promise().then(d.resolve,d.reject,d.notify);else d[e+"With"](this===g?d:this,[A])});else g[a](d[e])})}).promise()},promise:function(a){if(null==a)a=k;else for(var b in k)a[b]=k[b];return a}},g=k.promise({}),i;for(i in f)g[i]=f[i].fire,g[i+"With"]=f[i].fireWith;g.done(function(){e="resolved"},c.disable,d.lock).fail(function(){e="rejected"},b.disable,d.lock);a&&a.call(g,g);return g},when:function(a){function b(a){return function(b){d[a]=1<arguments.length?
R.call(arguments,0):b;--g||i.resolveWith(i,d)}}function c(a){return function(b){k[a]=1<arguments.length?R.call(arguments,0):b;i.notifyWith(j,k)}}var d=R.call(arguments,0),e=0,f=d.length,k=Array(f),g=f,i=1>=f&&a&&h.isFunction(a.promise)?a:h.Deferred(),j=i.promise();if(1<f){for(;e<f;e++)d[e]&&d[e].promise&&h.isFunction(d[e].promise)?d[e].promise().then(b(e),i.reject,c(e)):--g;g||i.resolveWith(i,d)}else i!==a&&i.resolveWith(i,f?[a]:[]);return j}});h.support=function(){var b,c,d,e,f,k,g,i,j=w.createElement("div");
j.setAttribute("className","t");j.innerHTML="   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>";c=j.getElementsByTagName("*");d=j.getElementsByTagName("a")[0];if(!c||!c.length||!d)return{};e=w.createElement("select");f=e.appendChild(w.createElement("option"));c=j.getElementsByTagName("input")[0];b={leadingWhitespace:3===j.firstChild.nodeType,tbody:!j.getElementsByTagName("tbody").length,htmlSerialize:!!j.getElementsByTagName("link").length,
style:/top/.test(d.getAttribute("style")),hrefNormalized:"/a"===d.getAttribute("href"),opacity:/^0.55/.test(d.style.opacity),cssFloat:!!d.style.cssFloat,checkOn:"on"===c.value,optSelected:f.selected,getSetAttribute:"t"!==j.className,enctype:!!w.createElement("form").enctype,html5Clone:"<:nav></:nav>"!==w.createElement("nav").cloneNode(!0).outerHTML,submitBubbles:!0,changeBubbles:!0,focusinBubbles:!1,deleteExpando:!0,noCloneEvent:!0,inlineBlockNeedsLayout:!1,shrinkWrapBlocks:!1,reliableMarginRight:!0,
pixelMargin:!0};h.boxModel=b.boxModel="CSS1Compat"===w.compatMode;c.checked=!0;b.noCloneChecked=c.cloneNode(!0).checked;e.disabled=!0;b.optDisabled=!f.disabled;try{delete j.test}catch(u){b.deleteExpando=!1}!j.addEventListener&&j.attachEvent&&j.fireEvent&&(j.attachEvent("onclick",function(){b.noCloneEvent=!1}),j.cloneNode(!0).fireEvent("onclick"));c=w.createElement("input");c.value="t";c.setAttribute("type","radio");b.radioValue="t"===c.value;c.setAttribute("checked","checked");c.setAttribute("name",
"t");j.appendChild(c);d=w.createDocumentFragment();d.appendChild(j.lastChild);b.checkClone=d.cloneNode(!0).cloneNode(!0).lastChild.checked;b.appendChecked=c.checked;d.removeChild(c);d.appendChild(j);if(j.attachEvent)for(g in{submit:1,change:1,focusin:1})c="on"+g,i=c in j,i||(j.setAttribute(c,"return;"),i="function"===typeof j[c]),b[g+"Bubbles"]=i;d.removeChild(j);d=e=f=j=c=null;h(function(){var c,d,e,f,g=w.getElementsByTagName("body")[0];if(g){c=w.createElement("div");c.style.cssText="padding:0;margin:0;border:0;visibility:hidden;width:0;height:0;position:static;top:0;margin-top:1px";
g.insertBefore(c,g.firstChild);j=w.createElement("div");c.appendChild(j);j.innerHTML="<table><tr><td style='padding:0;margin:0;border:0;display:none'></td><td>t</td></tr></table>";k=j.getElementsByTagName("td");i=k[0].offsetHeight===0;k[0].style.display="";k[1].style.display="none";b.reliableHiddenOffsets=i&&k[0].offsetHeight===0;if(a.getComputedStyle){j.innerHTML="";d=w.createElement("div");d.style.width="0";d.style.marginRight="0";j.style.width="2px";j.appendChild(d);b.reliableMarginRight=(parseInt((a.getComputedStyle(d,
...
return b}();var Q=/^(?:\{.*\}|\[.*\])$/,J=/([A-Z])/g;h.extend({cache:{},uuid:0,expando:"jQuery"+(h.fn.jquery+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(a){a=a.nodeType?h.cache[a[h.expando]]:a[h.expando];return!!a&&!e(a)},data:function(a,b,d,e){if(h.acceptData(a)){var f;f=h.expando;var k="string"===typeof b,g=a.nodeType,i=g?h.cache:a,j=g?a[f]:a[f]&&f,u="events"===b;if(j&&i[j]&&(u||e||i[j].data)||!(k&&d===c)){j||
(g?a[f]=j=++h.uuid:j=f);i[j]||(i[j]={},g||(i[j].toJSON=h.noop));if("object"===typeof b||"function"===typeof b)e?i[j]=h.extend(i[j],b):i[j].data=h.extend(i[j].data,b);f=a=i[j];e||(a.data||(a.data={}),a=a.data);d!==c&&(a[h.camelCase(b)]=d);if(u&&!a[b])return f.events;k?(d=a[b],null==d&&(d=a[h.camelCase(b)])):d=a;return d}}},removeData:function(a,b,c){if(h.acceptData(a)){var d,f,k,g=h.expando,i=a.nodeType,j=i?h.cache:a,u=i?a[g]:g;if(j[u]){if(b&&(d=c?j[u]:j[u].data)){h.isArray(b)||(b in d?b=[b]:(b=h.camelCase(b),
b=b in d?[b]:b.split(" ")));f=0;for(k=b.length;f<k;f++)delete d[b[f]];if(!(c?e:h.isEmptyObject)(d))return}if(!c&&(delete j[u].data,!e(j[u])))return;h.support.deleteExpando||!j.setInterval?delete j[u]:j[u]=null;i&&(h.support.deleteExpando?delete a[g]:a.removeAttribute?a.removeAttribute(g):a[g]=null)}}},_data:function(a,b,c){return h.data(a,b,c,!0)},acceptData:function(a){if(a.nodeName){var b=h.noData[a.nodeName.toLowerCase()];if(b)return!(!0===b||a.getAttribute("classid")!==b)}return!0}});h.fn.extend({data:function(a,
b){var d,e,k,g,i,j=this[0],u=0,l=null;if(a===c){if(this.length&&(l=h.data(j),1===j.nodeType&&!h._data(j,"parsedAttrs"))){k=j.attributes;for(i=k.length;u<i;u++)g=k[u].name,0===g.indexOf("data-")&&(g=h.camelCase(g.substring(5)),f(j,g,l[g]));h._data(j,"parsedAttrs",!0)}return l}if("object"===typeof a)return this.each(function(){h.data(this,a)});d=a.split(".",2);d[1]=d[1]?"."+d[1]:"";e=d[1]+"!";return h.access(this,function(b){if(b===c)return l=this.triggerHandler("getData"+e,[d[0]]),l===c&&j&&(l=h.data(j,
a),l=f(j,a,l)),l===c&&d[1]?this.data(d[0]):l;d[1]=b;this.each(function(){var c=h(this);c.triggerHandler("setData"+e,d);h.data(this,a,b);c.triggerHandler("changeData"+e,d)})},null,b,1<arguments.length,null,!1)},removeData:function(a){return this.each(function(){h.removeData(this,a)})}});h.extend({_mark:function(a,b){a&&(b=(b||"fx")+"mark",h._data(a,b,(h._data(a,b)||0)+1))},_unmark:function(a,b,c){!0!==a&&(c=b,b=a,a=!1);if(b){var c=c||"fx",d=c+"mark";(a=a?0:(h._data(b,d)||1)-1)?h._data(b,d,a):(h.removeData(b,
...
typeof a&&(b=a,a=c);for(var a=a||"fx",e=h.Deferred(),f=this,k=f.length,g=1,i=a+"defer",j=a+"queue",u=a+"mark",l;k--;)if(l=h.data(f[k],i,c,!0)||(h.data(f[k],j,c,!0)||h.data(f[k],u,c,!0))&&h.data(f[k],i,h.Callbacks("once memory"),!0))g++,l.add(d);d();return e.promise(b)}});var t=/[\n\t\r]/g,I=/\s+/,H=/\r/g,M=/^(?:button|input)$/i,G=/^(?:button|input|object|select|textarea)$/i,W=/^a(?:rea)?$/i,ba=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,
V=h.support.getSetAttribute,O,T,k;h.fn.extend({attr:function(a,b){return h.access(this,h.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){h.removeAttr(this,a)})},prop:function(a,b){return h.access(this,h.prop,a,b,1<arguments.length)},removeProp:function(a){a=h.propFix[a]||a;return this.each(function(){try{this[a]=c,delete this[a]}catch(b){}})},addClass:function(a){var b,c,d,e,f,k,g;if(h.isFunction(a))return this.each(function(b){h(this).addClass(a.call(this,b,this.className))});
...
this[d],1===f.nodeType&&f.className)if(a){k=(" "+f.className+" ").replace(t," ");g=0;for(i=b.length;g<i;g++)k=k.replace(" "+b[g]+" "," ");f.className=h.trim(k)}else f.className=""}return this},toggleClass:function(a,b){var c=typeof a,d="boolean"===typeof b;return h.isFunction(a)?this.each(function(c){h(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===c)for(var e,f=0,k=h(this),g=b,i=a.split(I);e=i[f++];)g=d?g:!k.hasClass(e),k[g?"addClass":"removeClass"](e);
...
d,f.val()):a,null==d?d="":"number"===typeof d?d+="":h.isArray(d)&&(d=h.map(d,function(a){return a==null?"":a+""})),b=h.valHooks[this.type]||h.valHooks[this.nodeName.toLowerCase()],!b||!("set"in b)||b.set(this,d,"value")===c))this.value=d});if(f){if((b=h.valHooks[f.type]||h.valHooks[f.nodeName.toLowerCase()])&&"get"in b&&(d=b.get(f,"value"))!==c)return d;d=f.value;return"string"===typeof d?d.replace(H,""):null==d?"":d}}});h.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||
...
0<=h.inArray(h(this).val(),c)});c.length||(a.selectedIndex=-1);return c}}},attrFn:{val:!0,css:!0,html:!0,text:!0,data:!0,width:!0,height:!0,offset:!0},attr:function(a,b,d,e){var f,k,g=a.nodeType;if(a&&!(3===g||8===g||2===g)){if(e&&b in h.attrFn)return h(a)[b](d);if("undefined"===typeof a.getAttribute)return h.prop(a,b,d);if(e=1!==g||!h.isXMLDoc(a))b=b.toLowerCase(),k=h.attrHooks[b]||(ba.test(b)?T:O);if(d!==c)if(null===d)h.removeAttr(a,b);else{if(k&&"set"in k&&e&&(f=k.set(a,d,b))!==c)return f;a.setAttribute(b,
""+d);return d}else{if(k&&"get"in k&&e&&null!==(f=k.get(a,b)))return f;f=a.getAttribute(b);return null===f?c:f}}},removeAttr:function(a,b){var c,d,e,f,k,g=0;if(b&&1===a.nodeType){d=b.toLowerCase().split(I);for(f=d.length;g<f;g++)if(e=d[g])c=h.propFix[e]||e,(k=ba.test(e))||h.attr(a,e,""),a.removeAttribute(V?e:c),k&&c in a&&(a[c]=!1)}},attrHooks:{type:{set:function(a,b){if(M.test(a.nodeName)&&a.parentNode)h.error("type property can't be changed");else if(!h.support.radioValue&&"radio"===b&&h.nodeName(a,
"input")){var c=a.value;a.setAttribute("type",b);c&&(a.value=c);return b}}},value:{get:function(a,b){return O&&h.nodeName(a,"button")?O.get(a,b):b in a?a.value:null},set:function(a,b,c){if(O&&h.nodeName(a,"button"))return O.set(a,b,c);a.value=b}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},
prop:function(a,b,d){var e,f,k=a.nodeType;if(a&&!(3===k||8===k||2===k)){if(1!==k||!h.isXMLDoc(a))b=h.propFix[b]||b,f=h.propHooks[b];return d!==c?f&&"set"in f&&(e=f.set(a,d,b))!==c?e:a[b]=d:f&&"get"in f&&null!==(e=f.get(a,b))?e:a[b]}},propHooks:{tabIndex:{get:function(a){var b=a.getAttributeNode("tabindex");return b&&b.specified?parseInt(b.value,10):G.test(a.nodeName)||W.test(a.nodeName)&&a.href?0:c}}}});h.attrHooks.tabindex=h.propHooks.tabIndex;T={get:function(a,b){var d,e=h.prop(a,b);return!0===
e||"boolean"!==typeof e&&(d=a.getAttributeNode(b))&&!1!==d.nodeValue?b.toLowerCase():c},set:function(a,b,c){!1===b?h.removeAttr(a,c):(b=h.propFix[c]||c,b in a&&(a[b]=!0),a.setAttribute(c,c.toLowerCase()));return c}};V||(k={name:!0,id:!0,coords:!0},O=h.valHooks.button={get:function(a,b){var d;return(d=a.getAttributeNode(b))&&(k[b]?""!==d.nodeValue:d.specified)?d.nodeValue:c},set:function(a,b,c){var d=a.getAttributeNode(c);d||(d=w.createAttribute(c),a.setAttributeNode(d));return d.nodeValue=b+""}},
h.attrHooks.tabindex.set=O.set,h.each(["width","height"],function(a,b){h.attrHooks[b]=h.extend(h.attrHooks[b],{set:function(a,c){if(""===c)return a.setAttribute(b,"auto"),c}})}),h.attrHooks.contenteditable={get:O.get,set:function(a,b,c){""===b&&(b="false");O.set(a,b,c)}});h.support.hrefNormalized||h.each(["href","src","width","height"],function(a,b){h.attrHooks[b]=h.extend(h.attrHooks[b],{get:function(a){a=a.getAttribute(b,2);return a===null?c:a}})});h.support.style||(h.attrHooks.style={get:function(a){return a.style.cssText.toLowerCase()||
...
{set:function(a,b){if(h.isArray(b))return a.checked=h.inArray(h(a).val(),b)>=0}})});var u=/^(?:textarea|input|select)$/i,C=/^([^\.]*)?(?:\.(.+))?$/,K=/(?:^|\s)hover(\.\S+)?\b/,N=/^key/,X=/^(?:mouse|contextmenu)|click/,Z=/^(?:focusinfocus|focusoutblur)$/,$=/^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/,oa=function(a){if(a=$.exec(a)){a[1]=(a[1]||"").toLowerCase();a[3]=a[3]&&RegExp("(?:^|\\s)"+a[3]+"(?:\\s|$)")}return a},aa=function(a){return h.event.special.hover?a:a.replace(K,"mouseenter$1 mouseleave$1")};
h.event={add:function(a,b,d,e,f){var k,g,i,j,u,l,m,o,n;if(!(a.nodeType===3||a.nodeType===8||!b||!d||!(k=h._data(a)))){if(d.handler){m=d;d=m.handler;f=m.selector}if(!d.guid)d.guid=h.guid++;i=k.events;if(!i)k.events=i={};g=k.handle;if(!g){k.handle=g=function(a){return typeof h!=="undefined"&&(!a||h.event.triggered!==a.type)?h.event.dispatch.apply(g.elem,arguments):c};g.elem=a}b=h.trim(aa(b)).split(" ");for(k=0;k<b.length;k++){j=C.exec(b[k])||[];u=j[1];l=(j[2]||"").split(".").sort();n=h.event.special[u]||
{};u=(f?n.delegateType:n.bindType)||u;n=h.event.special[u]||{};j=h.extend({type:u,origType:j[1],data:e,handler:d,guid:d.guid,selector:f,quick:f&&oa(f),namespace:l.join(".")},m);o=i[u];if(!o){o=i[u]=[];o.delegateCount=0;if(!n.setup||n.setup.call(a,e,l,g)===false)a.addEventListener?a.addEventListener(u,g,false):a.attachEvent&&a.attachEvent("on"+u,g)}if(n.add){n.add.call(a,j);if(!j.handler.guid)j.handler.guid=d.guid}f?o.splice(o.delegateCount++,0,j):o.push(j);h.event.global[u]=true}a=null}},global:{},
remove:function(a,b,c,d,e){var f=h.hasData(a)&&h._data(a),k,g,i,j,u,l,m,o,n,p;if(f&&(m=f.events)){b=h.trim(aa(b||"")).split(" ");for(k=0;k<b.length;k++){g=C.exec(b[k])||[];i=j=g[1];g=g[2];if(i){o=h.event.special[i]||{};i=(d?o.delegateType:o.bindType)||i;n=m[i]||[];u=n.length;g=g?RegExp("(^|\\.)"+g.split(".").sort().join("\\.(?:.*\\.)?")+"(\\.|$)"):null;for(l=0;l<n.length;l++){p=n[l];if((e||j===p.origType)&&(!c||c.guid===p.guid)&&(!g||g.test(p.namespace))&&(!d||d===p.selector||d==="**"&&p.selector)){n.splice(l--,
1);p.selector&&n.delegateCount--;o.remove&&o.remove.call(a,p)}}if(n.length===0&&u!==n.length){(!o.teardown||o.teardown.call(a,g)===false)&&h.removeEvent(a,i,f.handle);delete m[i]}}else for(i in m)h.event.remove(a,i+b[k],c,d,true)}if(h.isEmptyObject(m)){if(b=f.handle)b.elem=null;h.removeData(a,["events","handle"],true)}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(b,d,e,f){if(!e||!(e.nodeType===3||e.nodeType===8)){var k=b.type||b,g=[],i,j,u,l,m;if(!Z.test(k+h.event.triggered)){if(k.indexOf("!")>=
0){k=k.slice(0,-1);i=true}if(k.indexOf(".")>=0){g=k.split(".");k=g.shift();g.sort()}if(e&&!h.event.customEvent[k]||h.event.global[k]){b=typeof b==="object"?b[h.expando]?b:new h.Event(k,b):new h.Event(k);b.type=k;b.isTrigger=true;b.exclusive=i;b.namespace=g.join(".");b.namespace_re=b.namespace?RegExp("(^|\\.)"+g.join("\\.(?:.*\\.)?")+"(\\.|$)"):null;i=k.indexOf(":")<0?"on"+k:"";if(e){b.result=c;if(!b.target)b.target=e;d=d!=null?h.makeArray(d):[];d.unshift(b);u=h.event.special[k]||{};if(!(u.trigger&&
u.trigger.apply(e,d)===false)){m=[[e,u.bindType||k]];if(!f&&!u.noBubble&&!h.isWindow(e)){l=u.delegateType||k;g=Z.test(l+k)?e:e.parentNode;for(j=null;g;g=g.parentNode){m.push([g,l]);j=g}j&&j===e.ownerDocument&&m.push([j.defaultView||j.parentWindow||a,l])}for(j=0;j<m.length&&!b.isPropagationStopped();j++){g=m[j][0];b.type=m[j][1];(l=(h._data(g,"events")||{})[b.type]&&h._data(g,"handle"))&&l.apply(g,d);(l=i&&g[i])&&h.acceptData(g)&&l.apply(g,d)===false&&b.preventDefault()}b.type=k;if(!f&&!b.isDefaultPrevented()&&
(!u._default||u._default.apply(e.ownerDocument,d)===false)&&!(k==="click"&&h.nodeName(e,"a"))&&h.acceptData(e))if(i&&e[k]&&(k!=="focus"&&k!=="blur"||b.target.offsetWidth!==0)&&!h.isWindow(e)){(j=e[i])&&(e[i]=null);h.event.triggered=k;e[k]();h.event.triggered=c;j&&(e[i]=j)}return b.result}}else{e=h.cache;for(j in e)e[j].events&&e[j].events[k]&&h.event.trigger(b,d,e[j].handle.elem,true)}}}}},dispatch:function(b){var b=h.event.fix(b||a.event),d=(h._data(this,"events")||{})[b.type]||[],e=d.delegateCount,
f=[].slice.call(arguments,0),k=!b.exclusive&&!b.namespace,g=h.event.special[b.type]||{},i=[],j,u,l,m,C,o,n;f[0]=b;b.delegateTarget=this;if(!(g.preDispatch&&g.preDispatch.call(this,b)===false)){if(e&&!(b.button&&b.type==="click")){l=h(this);l.context=this.ownerDocument||this;for(u=b.target;u!=this;u=u.parentNode||this)if(u.disabled!==true){C={};o=[];l[0]=u;for(j=0;j<e;j++){m=d[j];n=m.selector;if(C[n]===c){var p=C,r=n,K;if(m.quick){K=m.quick;var q=u.attributes||{};K=(!K[1]||u.nodeName.toLowerCase()===
K[1])&&(!K[2]||(q.id||{}).value===K[2])&&(!K[3]||K[3].test((q["class"]||{}).value))}else K=l.is(n);p[r]=K}C[n]&&o.push(m)}o.length&&i.push({elem:u,matches:o})}}d.length>e&&i.push({elem:this,matches:d.slice(e)});for(j=0;j<i.length&&!b.isPropagationStopped();j++){e=i[j];b.currentTarget=e.elem;for(d=0;d<e.matches.length&&!b.isImmediatePropagationStopped();d++){m=e.matches[d];if(k||!b.namespace&&!m.namespace||b.namespace_re&&b.namespace_re.test(m.namespace)){b.data=m.data;b.handleObj=m;m=((h.event.special[m.origType]||
...
postDispatch:function(a){if(a._submit_bubble){delete a._submit_bubble;this.parentNode&&!a.isTrigger&&h.event.simulate("submit",this.parentNode,a,true)}},teardown:function(){if(h.nodeName(this,"form"))return false;h.event.remove(this,"._submit")}});h.support.changeBubbles||(h.event.special.change={setup:function(){if(u.test(this.nodeName)){if(this.type==="checkbox"||this.type==="radio"){h.event.add(this,"propertychange._change",function(a){if(a.originalEvent.propertyName==="checked")this._just_changed=
true});h.event.add(this,"click._change",function(a){if(this._just_changed&&!a.isTrigger){this._just_changed=false;h.event.simulate("change",this,a,true)}})}return false}h.event.add(this,"beforeactivate._change",function(a){a=a.target;if(u.test(a.nodeName)&&!a._change_attached){h.event.add(a,"change._change",function(a){this.parentNode&&!a.isSimulated&&!a.isTrigger&&h.event.simulate("change",this.parentNode,a,true)});a._change_attached=true}})},handle:function(a){var b=a.target;if(this!==b||a.isSimulated||
a.isTrigger||b.type!=="radio"&&b.type!=="checkbox")return a.handleObj.handler.apply(this,arguments)},teardown:function(){h.event.remove(this,"._change");return u.test(this.nodeName)}});h.support.focusinBubbles||h.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){h.event.simulate(b,a.target,h.event.fix(a),true)};h.event.special[b]={setup:function(){c++===0&&w.addEventListener(a,d,true)},teardown:function(){--c===0&&w.removeEventListener(a,d,true)}}});h.fn.extend({on:function(a,
...
0?this.on(b,null,a,c):this.trigger(b)};h.attrFn&&(h.attrFn[b]=true);if(N.test(b))h.event.fixHooks[b]=h.event.keyHooks;if(X.test(b))h.event.fixHooks[b]=h.event.mouseHooks});(function(){function a(b,c,d,f,k,g){for(var k=0,i=f.length;k<i;k++){var j=f[k];if(j){for(var h=false,j=j[b];j;){if(j[e]===d){h=f[j.sizset];break}if(j.nodeType===1&&!g){j[e]=d;j.sizset=k}if(j.nodeName.toLowerCase()===c){h=j;break}j=j[b]}f[k]=h}}}function b(a,c,d,f,k,g){for(var k=0,i=f.length;k<i;k++){var j=f[k];if(j){for(var h=false,
j=j[a];j;){if(j[e]===d){h=f[j.sizset];break}if(j.nodeType===1){if(!g){j[e]=d;j.sizset=k}if(typeof c!=="string"){if(j===c){h=true;break}}else if(m.filter(c,[j]).length>0){h=j;break}}j=j[a]}f[k]=h}}}var d=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,e="sizcache"+(Math.random()+"").replace(".",""),f=0,k=Object.prototype.toString,g=false,i=true,j=/\\/g,u=/\r\n/g,l=/\W/;[0,0].sort(function(){i=false;return 0});var m=
function(a,b,c,e){var c=c||[],f=b=b||w;if(b.nodeType!==1&&b.nodeType!==9)return[];if(!a||typeof a!=="string")return c;var g,i,j,h,u,A=true,l=m.isXML(b),C=[],p=a;do{d.exec("");if(g=d.exec(p)){p=g[3];C.push(g[1]);if(g[2]){h=g[3];break}}}while(g);if(C.length>1&&n.exec(a))if(C.length===2&&o.relative[C[0]])i=v(C[0]+C[1],b,e);else for(i=o.relative[C[0]]?[b]:m(C.shift(),b);C.length;){a=C.shift();o.relative[a]&&(a=a+C.shift());i=v(a,i,e)}else{if(!e&&C.length>1&&b.nodeType===9&&!l&&o.match.ID.test(C[0])&&
!o.match.ID.test(C[C.length-1])){g=m.find(C.shift(),b,l);b=g.expr?m.filter(g.expr,g.set)[0]:g.set[0]}if(b){g=e?{expr:C.pop(),set:r(e)}:m.find(C.pop(),C.length===1&&(C[0]==="~"||C[0]==="+")&&b.parentNode?b.parentNode:b,l);i=g.expr?m.filter(g.expr,g.set):g.set;for(C.length>0?j=r(i):A=false;C.length;){g=u=C.pop();o.relative[u]?g=C.pop():u="";g==null&&(g=b);o.relative[u](j,g,l)}}else j=[]}j||(j=i);j||m.error(u||a);if(k.call(j)==="[object Array]")if(A)if(b&&b.nodeType===1)for(a=0;j[a]!=null;a++)j[a]&&
(j[a]===true||j[a].nodeType===1&&m.contains(b,j[a]))&&c.push(i[a]);else for(a=0;j[a]!=null;a++)j[a]&&j[a].nodeType===1&&c.push(i[a]);else c.push.apply(c,j);else r(j,c);if(h){m(h,f,c,e);m.uniqueSort(c)}return c};m.uniqueSort=function(a){if(N){g=i;a.sort(N);if(g)for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1)}return a};m.matches=function(a,b){return m(a,null,null,b)};m.matchesSelector=function(a,b){return m(b,null,null,[a]).length>0};m.find=function(a,b,c){var d,e,f,k,g,i;if(!a)return[];e=
0;for(f=o.order.length;e<f;e++){g=o.order[e];if(k=o.leftMatch[g].exec(a)){i=k[1];k.splice(1,1);if(i.substr(i.length-1)!=="\\"){k[1]=(k[1]||"").replace(j,"");d=o.find[g](k,b,c);if(d!=null){a=a.replace(o.match[g],"");break}}}}d||(d=typeof b.getElementsByTagName!=="undefined"?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};m.filter=function(a,b,d,e){for(var f,k,g,i,j,h,u,A,l=a,C=[],n=b,p=b&&b[0]&&m.isXML(b[0]);a&&b.length;){for(g in o.filter)if((f=o.leftMatch[g].exec(a))!=null&&f[2]){h=o.filter[g];
j=f[1];k=false;f.splice(1,1);if(j.substr(j.length-1)!=="\\"){n===C&&(C=[]);if(o.preFilter[g])if(f=o.preFilter[g](f,n,d,C,e,p)){if(f===true)continue}else k=i=true;if(f)for(u=0;(j=n[u])!=null;u++)if(j){i=h(j,f,u,n);A=e^i;if(d&&i!=null)A?k=true:n[u]=false;else if(A){C.push(j);k=true}}if(i!==c){d||(n=C);a=a.replace(o.match[g],"");if(!k)return[];break}}}if(a===l)if(k==null)m.error(a);else break;l=a}return n};m.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};var C=m.getText=
function(a){var b,c;b=a.nodeType;var d="";if(b)if(b===1||b===9||b===11){if(typeof a.textContent==="string")return a.textContent;if(typeof a.innerText==="string")return a.innerText.replace(u,"");for(a=a.firstChild;a;a=a.nextSibling)d=d+C(a)}else{if(b===3||b===4)return a.nodeValue}else for(b=0;c=a[b];b++)c.nodeType!==8&&(d=d+C(c));return d},o=m.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,
...
c=m.attr?m.attr(a,c):o.attrHandle[c]?o.attrHandle[c](a):a[c]!=null?a[c]:a.getAttribute(c),d=c+"",e=b[2],f=b[4];return c==null?e==="!=":!e&&m.attr?c!=null:e==="="?d===f:e==="*="?d.indexOf(f)>=0:e==="~="?(" "+d+" ").indexOf(f)>=0:!f?d&&c!==false:e==="!="?d!==f:e==="^="?d.indexOf(f)===0:e==="$="?d.substr(d.length-f.length)===f:e==="|="?d===f||d.substr(0,f.length+1)===f+"-":false},POS:function(a,b,c,d){var e=o.setFilters[b[2]];if(e)return e(a,c,b,d)}}},n=o.match.POS,p=function(a,b){return"\\"+(b-0+1)},
K;for(K in o.match){o.match[K]=RegExp(o.match[K].source+/(?![^\[]*\])(?![^\(]*\))/.source);o.leftMatch[K]=RegExp(/(^(?:.|\r|\n)*?)/.source+o.match[K].source.replace(/\\(\d+)/g,p))}o.match.globalPOS=n;var r=function(a,b){a=Array.prototype.slice.call(a,0);if(b){b.push.apply(b,a);return b}return a};try{Array.prototype.slice.call(w.documentElement.childNodes,0)[0].nodeType}catch(q){r=function(a,b){var c=0,d=b||[];if(k.call(a)==="[object Array]")Array.prototype.push.apply(d,a);else if(typeof a.length===
"number")for(var e=a.length;c<e;c++)d.push(a[c]);else for(;a[c];c++)d.push(a[c]);return d}}var N,s;if(w.documentElement.compareDocumentPosition)N=function(a,b){if(a===b){g=true;return 0}return!a.compareDocumentPosition||!b.compareDocumentPosition?a.compareDocumentPosition?-1:1:a.compareDocumentPosition(b)&4?-1:1};else{N=function(a,b){if(a===b){g=true;return 0}if(a.sourceIndex&&b.sourceIndex)return a.sourceIndex-b.sourceIndex;var c,d,e=[],f=[];c=a.parentNode;d=b.parentNode;var k=c;if(c===d)return s(a,
b);if(c){if(!d)return 1}else return-1;for(;k;){e.unshift(k);k=k.parentNode}for(k=d;k;){f.unshift(k);k=k.parentNode}c=e.length;d=f.length;for(k=0;k<c&&k<d;k++)if(e[k]!==f[k])return s(e[k],f[k]);return k===c?s(a,f[k],-1):s(e[k],b,1)};s=function(a,b,c){if(a===b)return c;for(a=a.nextSibling;a;){if(a===b)return-1;a=a.nextSibling}return 1}}(function(){var a=w.createElement("div"),b="script"+(new Date).getTime(),d=w.documentElement;a.innerHTML="<a name='"+b+"'/>";d.insertBefore(a,d.firstChild);if(w.getElementById(b)){o.find.ID=
function(a,b,d){if(typeof b.getElementById!=="undefined"&&!d)return(b=b.getElementById(a[1]))?b.id===a[1]||typeof b.getAttributeNode!=="undefined"&&b.getAttributeNode("id").nodeValue===a[1]?[b]:c:[]};o.filter.ID=function(a,b){var c=typeof a.getAttributeNode!=="undefined"&&a.getAttributeNode("id");return a.nodeType===1&&c&&c.nodeValue===b}}d.removeChild(a);d=a=null})();(function(){var a=w.createElement("div");a.appendChild(w.createComment(""));if(a.getElementsByTagName("*").length>0)o.find.TAG=function(a,
b){var c=b.getElementsByTagName(a[1]);if(a[1]==="*"){for(var d=[],e=0;c[e];e++)c[e].nodeType===1&&d.push(c[e]);c=d}return c};a.innerHTML="<a href='#'></a>";if(a.firstChild&&typeof a.firstChild.getAttribute!=="undefined"&&a.firstChild.getAttribute("href")!=="#")o.attrHandle.href=function(a){return a.getAttribute("href",2)};a=null})();w.querySelectorAll&&function(){var a=m,b=w.createElement("div");b.innerHTML="<p class='TEST'></p>";if(!(b.querySelectorAll&&b.querySelectorAll(".TEST").length===0)){m=
function(b,c,d,e){c=c||w;if(!e&&!m.isXML(c)){var f=/^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(b);if(f&&(c.nodeType===1||c.nodeType===9)){if(f[1])return r(c.getElementsByTagName(b),d);if(f[2]&&o.find.CLASS&&c.getElementsByClassName)return r(c.getElementsByClassName(f[2]),d)}if(c.nodeType===9){if(b==="body"&&c.body)return r([c.body],d);if(f&&f[3]){var k=c.getElementById(f[3]);if(k&&k.parentNode){if(k.id===f[3])return r([k],d)}else return r([],d)}try{return r(c.querySelectorAll(b),d)}catch(g){}}else if(c.nodeType===
1&&c.nodeName.toLowerCase()!=="object"){var f=c,i=(k=c.getAttribute("id"))||"__sizzle__",j=c.parentNode,h=/^\s*[+~]/.test(b);k?i=i.replace(/'/g,"\\$&"):c.setAttribute("id",i);if(h&&j)c=c.parentNode;try{if(!h||j)return r(c.querySelectorAll("[id='"+i+"'] "+b),d)}catch(u){}finally{k||f.removeAttribute("id")}}}return a(b,c,d,e)};for(var c in a)m[c]=a[c];b=null}}();(function(){var a=w.documentElement,b=a.matchesSelector||a.mozMatchesSelector||a.webkitMatchesSelector||a.msMatchesSelector;if(b){var c=!b.call(w.createElement("div"),
"div"),d=false;try{b.call(w.documentElement,"[test!='']:sizzle")}catch(e){d=true}m.matchesSelector=function(a,e){e=e.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!m.isXML(a))try{if(d||!o.match.PSEUDO.test(e)&&!/!=/.test(e)){var f=b.call(a,e);if(f||!c||a.document&&a.document.nodeType!==11)return f}}catch(k){}return m(e,null,null,[a]).length>0}}})();(function(){var a=w.createElement("div");a.innerHTML="<div class='test e'></div><div class='test'></div>";if(a.getElementsByClassName&&a.getElementsByClassName("e").length!==
0){a.lastChild.className="e";if(a.getElementsByClassName("e").length!==1){o.order.splice(1,0,"CLASS");o.find.CLASS=function(a,b,c){if(typeof b.getElementsByClassName!=="undefined"&&!c)return b.getElementsByClassName(a[1])};a=null}}})();m.contains=w.documentElement.contains?function(a,b){return a!==b&&(a.contains?a.contains(b):true)}:w.documentElement.compareDocumentPosition?function(a,b){return!!(a.compareDocumentPosition(b)&16)}:function(){return false};m.isXML=function(a){return(a=(a?a.ownerDocument||
a:0).documentElement)?a.nodeName!=="HTML":false};var v=function(a,b,c){for(var d,e=[],f="",b=b.nodeType?[b]:b;d=o.match.PSEUDO.exec(a);){f=f+d[0];a=a.replace(o.match.PSEUDO,"")}a=o.relative[a]?a+"*":a;d=0;for(var k=b.length;d<k;d++)m(a,b[d],e,c);return m.filter(f,e)};m.attr=h.attr;m.selectors.attrMap={};h.find=m;h.expr=m.selectors;h.expr[":"]=h.expr.filters;h.unique=m.uniqueSort;h.text=m.getText;h.isXMLDoc=m.isXML;h.contains=m.contains})();var pa=/Until$/,qa=/^(?:parents|prevUntil|prevAll)/,ma=/,/,
...
"iframe")?a.contentDocument||a.contentWindow.document:h.makeArray(a.childNodes)}},function(a,b){h.fn[a]=function(c,d){var e=h.map(this,b,c);pa.test(a)||(d=c);d&&typeof d==="string"&&(e=h.filter(d,e));e=this.length>1&&!Ya[a]?h.unique(e):e;if((this.length>1||ma.test(d))&&qa.test(a))e=e.reverse();return this.pushStack(e,a,Xa.call(arguments).join(","))}});h.extend({filter:function(a,b,c){c&&(a=":not("+a+")");return b.length===1?h.find.matchesSelector(b[0],a)?[b[0]]:[]:h.find.matches(a,b)},dir:function(a,
...
wa=/^\s+/,Ga=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Ha=/<([\w:]+)/,$a=/<tbody/i,ab=/<|&#?\w+;/,bb=/<(?:script|style)/i,cb=/<(?:script|object|embed|option|style)/i,Ia=RegExp("<(?:"+Fa+")[\\s/>]","i"),Ja=/checked\s*(?:[^=]|=\s*.checked.)/i,Ka=/\/(java|ecma)script/i,fb=/^\s*<!(?:\[CDATA\[|\-\-)/,Y={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,
"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]},Ba=l(w);Y.optgroup=Y.option;Y.tbody=Y.tfoot=Y.colgroup=Y.caption=Y.thead;Y.th=Y.td;h.support.htmlSerialize||(Y._default=[1,"div<div>","</div>"]);h.fn.extend({text:function(a){return h.access(this,function(a){return a===c?h.text(this):this.empty().append((this[0]&&this[0].ownerDocument||w).createTextNode(a))},null,a,arguments.length)},wrapAll:function(a){if(h.isFunction(a))return this.each(function(b){h(this).wrapAll(a.call(this,
...
"string"&&!bb.test(a)&&(h.support.leadingWhitespace||!wa.test(a))&&!Y[(Ha.exec(a)||["",""])[1].toLowerCase()]){a=a.replace(Ga,"<$1></$2>");try{for(;d<e;d++){b=this[d]||{};if(b.nodeType===1){h.cleanData(b.getElementsByTagName("*"));b.innerHTML=a}}b=0}catch(f){}}b&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){if(this[0]&&this[0].parentNode){if(h.isFunction(a))return this.each(function(b){var c=h(this),d=c.html();c.replaceWith(a.call(this,b,d))});typeof a!=="string"&&(a=
h(a).detach());return this.each(function(){var b=this.nextSibling,c=this.parentNode;h(this).remove();b?h(b).before(a):h(c).append(a)})}return this.length?this.pushStack(h(h.isFunction(a)?a():a),"replaceWith",a):this},detach:function(a){return this.remove(a,true)},domManip:function(a,b,d){var e,f,k,g=a[0],i=[];if(!h.support.checkClone&&arguments.length===3&&typeof g==="string"&&Ja.test(g))return this.each(function(){h(this).domManip(a,b,d,true)});if(h.isFunction(g))return this.each(function(e){var f=
h(this);a[0]=g.call(this,e,b?f.html():c);f.domManip(a,b,d)});if(this[0]){e=g&&g.parentNode;e=h.support.parentNode&&e&&e.nodeType===11&&e.childNodes.length===this.length?{fragment:e}:h.buildFragment(a,this,i);k=e.fragment;if(f=k.childNodes.length===1?k=k.firstChild:k.firstChild){b=b&&h.nodeName(f,"tr");f=0;for(var j=this.length,u=j-1;f<j;f++)d.call(b?h.nodeName(this[f],"table")?this[f].getElementsByTagName("tbody")[0]||this[f].appendChild(this[f].ownerDocument.createElement("tbody")):this[f]:this[f],
e.cacheable||j>1&&f<u?h.clone(k,true,true):k)}i.length&&h.each(i,function(a,b){b.src?h.ajax({type:"GET",global:false,url:b.src,async:false,dataType:"script"}):h.globalEval((b.text||b.textContent||b.innerHTML||"").replace(fb,"/*$0*/"));b.parentNode&&b.parentNode.removeChild(b)})}return this}});h.buildFragment=function(a,b,c){var d,e,f,k,g=a[0];b&&b[0]&&(k=b[0].ownerDocument||b[0]);k.createDocumentFragment||(k=w);if(a.length===1&&typeof g==="string"&&g.length<512&&k===w&&g.charAt(0)==="<"&&!cb.test(g)&&
(h.support.checkClone||!Ja.test(g))&&(h.support.html5Clone||!Ia.test(g))){e=true;(f=h.fragments[g])&&f!==1&&(d=f)}if(!d){d=k.createDocumentFragment();h.clean(a,k,d,c)}e&&(h.fragments[g]=f?d:1);return{fragment:d,cacheable:e}};h.fragments={};h.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){h.fn[a]=function(c){var d=[],c=h(c),e=this.length===1&&this[0].parentNode;if(e&&e.nodeType===11&&e.childNodes.length===1&&c.length===
1){c[b](this[0]);return this}for(var e=0,f=c.length;e<f;e++){var k=(e>0?this.clone(true):this).get();h(c[e])[b](k);d=d.concat(k)}return this.pushStack(d,a,c.selector)}});h.extend({clone:function(a,b,c){var d,e,f;if(h.support.html5Clone||h.isXMLDoc(a)||!Ia.test("<"+a.nodeName+">"))d=a.cloneNode(true);else{d=w.createElement("div");Ba.appendChild(d);d.innerHTML=a.outerHTML;d=d.firstChild}var k=d;if((!h.support.noCloneEvent||!h.support.noCloneChecked)&&(a.nodeType===1||a.nodeType===11)&&!h.isXMLDoc(a)){o(a,
k);d=m(a);e=m(k);for(f=0;d[f];++f)e[f]&&o(d[f],e[f])}if(b){n(a,k);if(c){d=m(a);e=m(k);for(f=0;d[f];++f)n(d[f],e[f])}}return k},clean:function(a,b,c,d){var e,f=[],b=b||w;typeof b.createElement==="undefined"&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||w);for(var k=0,g;(g=a[k])!=null;k++){typeof g==="number"&&(g=g+"");if(g){if(typeof g==="string")if(ab.test(g)){g=g.replace(Ga,"<$1></$2>");e=(Ha.exec(g)||["",""])[1].toLowerCase();var i=Y[e]||Y._default,j=i[0],u=b.createElement("div"),m=Ba.childNodes;
b===w?Ba.appendChild(u):l(b).appendChild(u);for(u.innerHTML=i[1]+g+i[2];j--;)u=u.lastChild;if(!h.support.tbody){j=$a.test(g);i=e==="table"&&!j?u.firstChild&&u.firstChild.childNodes:i[1]==="<table>"&&!j?u.childNodes:[];for(e=i.length-1;e>=0;--e)h.nodeName(i[e],"tbody")&&!i[e].childNodes.length&&i[e].parentNode.removeChild(i[e])}!h.support.leadingWhitespace&&wa.test(g)&&u.insertBefore(b.createTextNode(wa.exec(g)[0]),u.firstChild);g=u.childNodes;if(u){u.parentNode.removeChild(u);if(m.length>0)(u=m[m.length-
1])&&u.parentNode&&u.parentNode.removeChild(u)}}else g=b.createTextNode(g);var C;if(!h.support.appendChecked)if(g[0]&&typeof(C=g.length)==="number")for(e=0;e<C;e++)r(g[e]);else r(g);g.nodeType?f.push(g):f=h.merge(f,g)}}if(c){a=function(a){return!a.type||Ka.test(a.type)};for(k=0;f[k];k++){b=f[k];if(d&&h.nodeName(b,"script")&&(!b.type||Ka.test(b.type)))d.push(b.parentNode?b.parentNode.removeChild(b):b);else{if(b.nodeType===1){g=h.grep(b.getElementsByTagName("script"),a);f.splice.apply(f,[k+1,0].concat(g))}c.appendChild(b)}}}return f},
cleanData:function(a){for(var b,c,d=h.cache,e=h.event.special,f=h.support.deleteExpando,k=0,g;(g=a[k])!=null;k++)if(!g.nodeName||!h.noData[g.nodeName.toLowerCase()])if(c=g[h.expando]){if((b=d[c])&&b.events){for(var i in b.events)e[i]?h.event.remove(g,i):h.removeEvent(g,i,b.handle);if(b.handle)b.handle.elem=null}f?delete g[h.expando]:g.removeAttribute&&g.removeAttribute(h.expando);delete d[c]}}});var Ca=/alpha\([^)]*\)/i,gb=/opacity=([^)]*)/,hb=/([A-Z]|^ms)/g,ib=/^[\-+]?(?:\d*\.)?\d+$/i,xa=/^-?(?:\d*\.)?\d+(?!px)[^\d\s]+$/i,
jb=/^([\-+])=([\-+.\de]+)/,kb=/^margin/,lb={position:"absolute",visibility:"hidden",display:"block"},fa=["Top","Right","Bottom","Left"],ia,Ma,Na;h.fn.css=function(a,b){return h.access(this,function(a,b,d){return d!==c?h.style(a,b,d):h.css(a,b)},a,b,arguments.length>1)};h.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=ia(a,"opacity");return c===""?"1":c}return a.style.opacity}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":h.support.cssFloat?
...
f,b=h.camelCase(b);f=h.cssHooks[b];b=h.cssProps[b]||b;b==="cssFloat"&&(b="float");if(f&&"get"in f&&(e=f.get(a,true,d))!==c)return e;if(ia)return ia(a,b)},swap:function(a,b,c){var d={},e;for(e in b){d[e]=a.style[e];a.style[e]=b[e]}c=c.call(a);for(e in b)a.style[e]=d[e];return c}});h.curCSS=h.css;w.defaultView&&w.defaultView.getComputedStyle&&(Ma=function(a,b){var c,d,e,f=a.style,b=b.replace(hb,"-$1").toLowerCase();if((d=a.ownerDocument.defaultView)&&(e=d.getComputedStyle(a,null))){c=e.getPropertyValue(b);
c===""&&!h.contains(a.ownerDocument.documentElement,a)&&(c=h.style(a,b))}if(!h.support.pixelMargin&&e&&kb.test(b)&&xa.test(c)){d=f.width;f.width=c;c=e.width;f.width=d}return c});w.documentElement.currentStyle&&(Na=function(a,b){var c,d,e=a.currentStyle&&a.currentStyle[b],f=a.style;if(e==null&&f&&(c=f[b]))e=c;if(xa.test(e)){c=f.left;if(d=a.runtimeStyle&&a.runtimeStyle.left)a.runtimeStyle.left=a.currentStyle.left;f.left=b==="fontSize"?"1em":e;e=f.pixelLeft+"px";f.left=c;if(d)a.runtimeStyle.left=d}return e===
""?"auto":e});ia=Ma||Na;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){if(c)return a.offsetWidth!==0?q(a,b,d):h.swap(a,lb,function(){return q(a,b,d)})},set:function(a,b){return ib.test(b)?b+"px":b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return gb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,e=h.isNumeric(b)?"alpha(opacity="+b*100+")":"",f=
d&&d.filter||c.filter||"";c.zoom=1;if(b>=1&&h.trim(f.replace(Ca,""))===""){c.removeAttribute("filter");if(d&&!d.filter)return}c.filter=Ca.test(f)?f.replace(Ca,e):f+" "+e}});h(function(){if(!h.support.reliableMarginRight)h.cssHooks.marginRight={get:function(a,b){return h.swap(a,{display:"inline-block"},function(){return b?ia(a,"margin-right"):a.style.marginRight})}}});h.expr&&h.expr.filters&&(h.expr.filters.hidden=function(a){var b=a.offsetHeight;return a.offsetWidth===0&&b===0||!h.support.reliableHiddenOffsets&&
(a.style&&a.style.display||h.css(a,"display"))==="none"},h.expr.filters.visible=function(a){return!h.expr.filters.hidden(a)});h.each({margin:"",padding:"",border:"Width"},function(a,b){h.cssHooks[a+b]={expand:function(c){for(var d=typeof c==="string"?c.split(" "):[c],e={},c=0;c<4;c++)e[a+fa[c]+b]=d[c]||d[c-2]||d[0];return e}}});var mb=/%20/g,db=/\[\]$/,Oa=/\r?\n/g,nb=/#.*$/,ob=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,pb=/^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
qb=/^(?:GET|HEAD)$/,rb=/^\/\//,Pa=/\?/,sb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,tb=/^(?:select|textarea)/i,La=/\s+/,ub=/([?&])_=[^&]*/,Qa=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Ra=h.fn.load,ya={},Sa={},ga,ha,Ta=["*/"]+["*"];try{ga=S.href}catch(Ab){ga=w.createElement("a"),ga.href="",ga=ga.href}ha=Qa.exec(ga.toLowerCase())||[];h.fn.extend({load:function(a,b,d){if(typeof a!=="string"&&Ra)return Ra.apply(this,arguments);if(!this.length)return this;var e=a.indexOf(" ");if(e>=
0)var f=a.slice(e,a.length),a=a.slice(0,e);e="GET";if(b)if(h.isFunction(b)){d=b;b=c}else if(typeof b==="object"){b=h.param(b,h.ajaxSettings.traditional);e="POST"}var k=this;h.ajax({url:a,type:e,dataType:"html",data:b,complete:function(a,b,c){c=a.responseText;if(a.isResolved()){a.done(function(a){c=a});k.html(f?h("<div>").append(c.replace(sb,"")).find(f):c)}d&&k.each(d,[c,b,a])}});return this},serialize:function(){return h.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?
...
function(a,b){h[b]=function(a,d,e,f){if(h.isFunction(d)){f=f||e;e=d;d=c}return h.ajax({type:b,url:a,data:d,success:e,dataType:f})}});h.extend({getScript:function(a,b){return h.get(a,c,b,"script")},getJSON:function(a,b,c){return h.get(a,b,c,"json")},ajaxSetup:function(a,b){if(b)v(a,h.ajaxSettings);else{b=a;a=h.ajaxSettings}v(a,b);return a},ajaxSettings:{url:ga,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/.test(ha[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",
processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Ta},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:s(ya),ajaxTransport:s(Sa),ajax:function(a,b){function d(a,b,m,l){if(K!==2){K=2;p&&clearTimeout(p);n=c;C=l||"";s.readyState=
a>0?4:0;var o,r,A,l=b;if(m){var N=e,v=s,X=N.contents,da=N.dataTypes,y=N.responseFields,w,t,ea,Z;for(t in y)t in m&&(v[y[t]]=m[t]);for(;da[0]==="*";){da.shift();w===c&&(w=N.mimeType||v.getResponseHeader("content-type"))}if(w)for(t in X)if(X[t]&&X[t].test(w)){da.unshift(t);break}if(da[0]in m)ea=da[0];else{for(t in m){if(!da[0]||N.converters[t+" "+da[0]]){ea=t;break}Z||(Z=t)}ea=ea||Z}if(ea){ea!==da[0]&&da.unshift(ea);m=m[ea]}else m=void 0}else m=c;if(a>=200&&a<300||a===304){if(e.ifModified){if(w=s.getResponseHeader("Last-Modified"))h.lastModified[u]=
w;if(w=s.getResponseHeader("Etag"))h.etag[u]=w}if(a===304){l="notmodified";o=true}else try{w=e;w.dataFilter&&(m=w.dataFilter(m,w.dataType));var x=w.dataTypes;t={};var z,B,F=x.length,D,$=x[0],E,H,G,I,aa;for(z=1;z<F;z++){if(z===1)for(B in w.converters)typeof B==="string"&&(t[B.toLowerCase()]=w.converters[B]);E=$;$=x[z];if($==="*")$=E;else if(E!=="*"&&E!==$){H=E+" "+$;G=t[H]||t["* "+$];if(!G){aa=c;for(I in t){D=I.split(" ");if(D[0]===E||D[0]==="*")if(aa=t[D[1]+" "+$]){I=t[I];I===true?G=aa:aa===true&&
(G=I);break}}}!G&&!aa&&h.error("No conversion from "+H.replace(" "," to "));G!==true&&(m=G?G(m):aa(I(m)))}}r=m;l="success";o=true}catch(J){l="parsererror";A=J}}else{A=l;if(!l||a){l="error";a<0&&(a=0)}}s.status=a;s.statusText=""+(b||l);o?g.resolveWith(f,[r,l,s]):g.rejectWith(f,[s,l,A]);s.statusCode(j);j=c;q&&k.trigger("ajax"+(o?"Success":"Error"),[s,e,o?r:A]);i.fireWith(f,[s,l]);if(q){k.trigger("ajaxComplete",[s,e]);--h.active||h.event.trigger("ajaxStop")}}}if(typeof a==="object"){b=a;a=c}var b=b||
{},e=h.ajaxSetup({},b),f=e.context||e,k=f!==e&&(f.nodeType||f instanceof h)?h(f):h.event,g=h.Deferred(),i=h.Callbacks("once memory"),j=e.statusCode||{},u,m={},l={},C,o,n,p,r,K=0,q,N,s={readyState:0,setRequestHeader:function(a,b){if(!K){var c=a.toLowerCase(),a=l[c]=l[c]||a;m[a]=b}return this},getAllResponseHeaders:function(){return K===2?C:null},getResponseHeader:function(a){var b;if(K===2){if(!o)for(o={};b=ob.exec(C);)o[b[1].toLowerCase()]=b[2];b=o[a.toLowerCase()]}return b===c?null:b},overrideMimeType:function(a){if(!K)e.mimeType=
a;return this},abort:function(a){a=a||"abort";n&&n.abort(a);d(0,a);return this}};g.promise(s);s.success=s.done;s.error=s.fail;s.complete=i.add;s.statusCode=function(a){if(a){var b;if(K<2)for(b in a)j[b]=[j[b],a[b]];else{b=a[s.status];s.then(b,b)}}return this};e.url=((a||e.url)+"").replace(nb,"").replace(rb,ha[1]+"//");e.dataTypes=h.trim(e.dataType||"*").toLowerCase().split(La);if(e.crossDomain==null){r=Qa.exec(e.url.toLowerCase());e.crossDomain=!(!r||!(r[1]!=ha[1]||r[2]!=ha[2]||(r[3]||(r[1]==="http:"?
80:443))!=(ha[3]||(ha[1]==="http:"?80:443))))}if(e.data&&e.processData&&typeof e.data!=="string")e.data=h.param(e.data,e.traditional);y(ya,e,b,s);if(K===2)return false;q=e.global;e.type=e.type.toUpperCase();e.hasContent=!qb.test(e.type);q&&h.active++===0&&h.event.trigger("ajaxStart");if(!e.hasContent){if(e.data){e.url=e.url+((Pa.test(e.url)?"&":"?")+e.data);delete e.data}u=e.url;if(e.cache===false){r=h.now();var v=e.url.replace(ub,"$1_="+r);e.url=v+(v===e.url?(Pa.test(e.url)?"&":"?")+"_="+r:"")}}(e.data&&
e.hasContent&&e.contentType!==false||b.contentType)&&s.setRequestHeader("Content-Type",e.contentType);if(e.ifModified){u=u||e.url;h.lastModified[u]&&s.setRequestHeader("If-Modified-Since",h.lastModified[u]);h.etag[u]&&s.setRequestHeader("If-None-Match",h.etag[u])}s.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+(e.dataTypes[0]!=="*"?", "+Ta+"; q=0.01":""):e.accepts["*"]);for(N in e.headers)s.setRequestHeader(N,e.headers[N]);if(e.beforeSend&&(e.beforeSend.call(f,
s,e)===false||K===2)){s.abort();return false}for(N in{success:1,error:1,complete:1})s[N](e[N]);if(n=y(Sa,e,b,s)){s.readyState=1;q&&k.trigger("ajaxSend",[s,e]);e.async&&e.timeout>0&&(p=setTimeout(function(){s.abort("timeout")},e.timeout));try{K=1;n.send(m,d)}catch(X){if(K<2)d(-1,X);else throw X;}}else d(-1,"No Transport");return s},param:function(a,b){var d=[],e=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(b===c)b=h.ajaxSettings.traditional;
if(h.isArray(a)||a.jquery&&!h.isPlainObject(a))h.each(a,function(){e(this.name,this.value)});else for(var f in a)z(f,a[f],b,e);return d.join("&").replace(mb,"+")}});h.extend({active:0,lastModified:{},etag:{}});var vb=h.now(),ua=/(\=)\?(&|$)|\?\?/i;h.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return h.expando+"_"+vb++}});h.ajaxPrefilter("json jsonp",function(b,c,d){c=typeof b.data==="string"&&/^application\/x\-www\-form\-urlencoded/.test(b.contentType);if(b.dataTypes[0]==="jsonp"||b.jsonp!==
false&&(ua.test(b.url)||c&&ua.test(b.data))){var e,f=b.jsonpCallback=h.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,k=a[f],g=b.url,i=b.data,j="$1"+f+"$2";if(b.jsonp!==false){g=g.replace(ua,j);if(b.url===g){c&&(i=i.replace(ua,j));b.data===i&&(g=g+((/\?/.test(g)?"&":"?")+b.jsonp+"="+f))}}b.url=g;b.data=i;a[f]=function(a){e=[a]};d.always(function(){a[f]=k;if(e&&h.isFunction(k))a[f](e[0])});b.converters["script json"]=function(){e||h.error(f+" was not called");return e[0]};b.dataTypes[0]=
...
f){b=w.createElement("script");b.async="async";if(a.scriptCharset)b.charset=a.scriptCharset;b.src=a.url;b.onload=b.onreadystatechange=function(a,e){if(e||!b.readyState||/loaded|complete/.test(b.readyState)){b.onload=b.onreadystatechange=null;d&&b.parentNode&&d.removeChild(b);b=c;e||f(200,"success")}};d.insertBefore(b,d.firstChild)},abort:function(){if(b)b.onload(0,1)}}}});var Da=a.ActiveXObject?function(){for(var a in la)la[a](0,1)}:!1,wb=0,la;h.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=
!this.isLocal&&B()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:B;(function(a){h.extend(h.support,{ajax:!!a,cors:!!a&&"withCredentials"in a})})(h.ajaxSettings.xhr());h.support.ajax&&h.ajaxTransport(function(b){if(!b.crossDomain||h.support.cors){var d;return{send:function(e,f){var k=b.xhr(),g,i;b.username?k.open(b.type,b.url,b.async,b.username,b.password):k.open(b.type,b.url,b.async);if(b.xhrFields)for(i in b.xhrFields)k[i]=b.xhrFields[i];b.mimeType&&k.overrideMimeType&&
k.overrideMimeType(b.mimeType);!b.crossDomain&&!e["X-Requested-With"]&&(e["X-Requested-With"]="XMLHttpRequest");try{for(i in e)k.setRequestHeader(i,e[i])}catch(j){}k.send(b.hasContent&&b.data||null);d=function(a,e){var i,j,u,m,l;try{if(d&&(e||k.readyState===4)){d=c;if(g){k.onreadystatechange=h.noop;Da&&delete la[g]}if(e)k.readyState!==4&&k.abort();else{i=k.status;u=k.getAllResponseHeaders();m={};if((l=k.responseXML)&&l.documentElement)m.xml=l;try{m.text=k.responseText}catch(o){}try{j=k.statusText}catch(C){j=
""}!i&&b.isLocal&&!b.crossDomain?i=m.text?200:404:i===1223&&(i=204)}}}catch(n){e||f(-1,n)}m&&f(i,j,m,u)};if(!b.async||k.readyState===4)d();else{g=++wb;if(Da){if(!la){la={};h(a).unload(Da)}la[g]=d}k.onreadystatechange=d}},abort:function(){d&&d(0,1)}}}});var za={},ca,ja,xb=/^(?:toggle|show|hide)$/,yb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,va,sa=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],ra;h.fn.extend({show:function(a,
b,c){if(a||a===0)return this.animate(F("show",3),a,b,c);for(var c=0,d=this.length;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(!h._data(a,"olddisplay")&&b==="none")b=a.style.display="";(b===""&&h.css(a,"display")==="none"||!h.contains(a.ownerDocument.documentElement,a))&&h._data(a,"olddisplay",L(a.nodeName))}}for(c=0;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(b===""||b==="none")a.style.display=h._data(a,"olddisplay")||""}}return this},hide:function(a,b,c){if(a||a===0)return this.animate(F("hide",
...
this;setTimeout(function(){a(f).focus();d&&d.call(f)},c)}):this._focus.apply(this,arguments)},scrollParent:function(){var c;c=a.browser.msie&&/(static|relative)/.test(this.css("position"))||/absolute/.test(this.css("position"))?this.parents().filter(function(){return/(relative|absolute|fixed)/.test(a.curCSS(this,"position",1))&&/(auto|scroll)/.test(a.curCSS(this,"overflow",1)+a.curCSS(this,"overflow-y",1)+a.curCSS(this,"overflow-x",1))}).eq(0):this.parents().filter(function(){return/(auto|scroll)/.test(a.curCSS(this,
"overflow",1)+a.curCSS(this,"overflow-y",1)+a.curCSS(this,"overflow-x",1))}).eq(0);return/fixed/.test(this.css("position"))||!c.length?a(document):c},zIndex:function(d){if(d!==c)return this.css("zIndex",d);if(this.length)for(var d=a(this[0]),f;d.length&&d[0]!==document;){f=d.css("position");if("absolute"===f||"relative"===f||"fixed"===f)if(f=parseInt(d.css("zIndex"),10),!isNaN(f)&&0!==f)return f;d=d.parent()}return 0},disableSelection:function(){return this.bind((a.support.selectstart?"selectstart":
"mousedown")+".ui-disableSelection",function(a){a.preventDefault()})},enableSelection:function(){return this.unbind(".ui-disableSelection")}}),a.each(["Width","Height"],function(d,f){function g(c,d,e,f){a.each(b,function(){d-=parseFloat(a.curCSS(c,"padding"+this,!0))||0;e&&(d-=parseFloat(a.curCSS(c,"border"+this+"Width",!0))||0);f&&(d-=parseFloat(a.curCSS(c,"margin"+this,!0))||0)});return d}var b="Width"===f?["Left","Right"]:["Top","Bottom"],j=f.toLowerCase(),l={innerWidth:a.fn.innerWidth,innerHeight:a.fn.innerHeight,
outerWidth:a.fn.outerWidth,outerHeight:a.fn.outerHeight};a.fn["inner"+f]=function(b){return b===c?l["inner"+f].call(this):this.each(function(){a(this).css(j,g(this,b)+"px")})};a.fn["outer"+f]=function(b,c){return"number"!==typeof b?l["outer"+f].call(this,b):this.each(function(){a(this).css(j,g(this,b,!0,c)+"px")})}}),a.extend(a.expr[":"],{data:function(c,d,f){return!!a.data(c,f[3])},focusable:function(c){return d(c,!isNaN(a.attr(c,"tabindex")))},tabbable:function(c){var f=a.attr(c,"tabindex"),g=isNaN(f);
return(g||0<=f)&&d(c,!g)}}),a(function(){var c=document.body,d=c.appendChild(d=document.createElement("div"));d.offsetHeight;a.extend(d.style,{minHeight:"100px",height:"auto",padding:0,borderWidth:0});a.support.minHeight=100===d.offsetHeight;a.support.selectstart="onselectstart"in d;c.removeChild(d).style.display="none"}),a.extend(a.ui,{plugin:{add:function(c,d,f){var c=a.ui[c].prototype,b;for(b in f)c.plugins[b]=c.plugins[b]||[],c.plugins[b].push([d,f[b]])},call:function(a,c,d){if((c=a.plugins[c])&&
a.element[0].parentNode)for(var b=0;b<c.length;b++)a.options[c[b][0]]&&c[b][1].apply(a.element,d)}},contains:function(a,c){return document.compareDocumentPosition?a.compareDocumentPosition(c)&16:a!==c&&a.contains(c)},hasScroll:function(c,d){if("hidden"===a(c).css("overflow"))return!1;var f=d&&"left"===d?"scrollLeft":"scrollTop",b=!1;if(0<c[f])return!0;c[f]=1;b=0<c[f];c[f]=0;return b},isOverAxis:function(a,c,d){return a>c&&a<c+d},isOver:function(c,d,f,b,j,l){return a.ui.isOverAxis(c,f,j)&&a.ui.isOverAxis(d,
b,l)}}))})(jQuery);
(function(a,c){if(a.cleanData){var d=a.cleanData;a.cleanData=function(c){for(var f=0,g;null!=(g=c[f]);f++)try{a(g).triggerHandler("remove")}catch(b){}d(c)}}else{var f=a.fn.remove;a.fn.remove=function(c,d){return this.each(function(){d||(!c||a.filter(c,[this]).length)&&a("*",this).add([this]).each(function(){try{a(this).triggerHandler("remove")}catch(c){}});return f.call(a(this),c,d)})}}a.widget=function(c,d,f){var b=c.split(".")[0],j,c=c.split(".")[1];j=b+"-"+c;f||(f=d,d=a.Widget);a.expr[":"][j]=
function(b){return!!a.data(b,c)};a[b]=a[b]||{};a[b][c]=function(a,b){arguments.length&&this._createWidget(a,b)};d=new d;d.options=a.extend(!0,{},d.options);a[b][c].prototype=a.extend(!0,d,{namespace:b,widgetName:c,widgetEventPrefix:a[b][c].prototype.widgetEventPrefix||c,widgetBaseClass:j},f);a.widget.bridge(c,a[b][c])};a.widget.bridge=function(d,f){a.fn[d]=function(g){var b="string"===typeof g,j=Array.prototype.slice.call(arguments,1),l=this,g=!b&&j.length?a.extend.apply(null,[!0,g].concat(j)):g;
if(b&&"_"===g.charAt(0))return l;b?this.each(function(){var b=a.data(this,d),f=b&&a.isFunction(b[g])?b[g].apply(b,j):b;if(f!==b&&f!==c)return l=f,!1}):this.each(function(){var b=a.data(this,d);b?b.option(g||{})._init():a.data(this,d,new f(g,this))});return l}};a.Widget=function(a,c){arguments.length&&this._createWidget(a,c)};a.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",options:{disabled:!1},_createWidget:function(c,d){a.data(d,this.widgetName,this);this.element=a(d);this.options=a.extend(!0,
{},this.options,this._getCreateOptions(),c);var f=this;this.element.bind("remove."+this.widgetName,function(){f.destroy()});this._create();this._trigger("create");this._init()},_getCreateOptions:function(){return a.metadata&&a.metadata.get(this.element[0])[this.widgetName]},_create:function(){},_init:function(){},destroy:function(){this.element.unbind("."+this.widgetName).removeData(this.widgetName);this.widget().unbind("."+this.widgetName).removeAttr("aria-disabled").removeClass(this.widgetBaseClass+
"-disabled ui-state-disabled")},widget:function(){return this.element},option:function(d,f){var g=d;if(0===arguments.length)return a.extend({},this.options);if("string"===typeof d){if(f===c)return this.options[d];g={};g[d]=f}this._setOptions(g);return this},_setOptions:function(c){var d=this;a.each(c,function(a,b){d._setOption(a,b)});return this},_setOption:function(a,c){this.options[a]=c;"disabled"===a&&this.widget()[c?"addClass":"removeClass"](this.widgetBaseClass+"-disabled ui-state-disabled").attr("aria-disabled",
c);return this},enable:function(){return this._setOption("disabled",!1)},disable:function(){return this._setOption("disabled",!0)},_trigger:function(c,d,f){var b,j=this.options[c],f=f||{},d=a.Event(d);d.type=(c===this.widgetEventPrefix?c:this.widgetEventPrefix+c).toLowerCase();d.target=this.element[0];if(c=d.originalEvent)for(b in c)b in d||(d[b]=c[b]);this.element.trigger(d,f);return!(a.isFunction(j)&&!1===j.call(this.element[0],d,f)||d.isDefaultPrevented())}}})(jQuery);
(function(a){var c=!1;a(document).mouseup(function(){c=!1});a.widget("ui.mouse",{options:{cancel:":input,option",distance:1,delay:0},_mouseInit:function(){var c=this;this.element.bind("mousedown."+this.widgetName,function(a){return c._mouseDown(a)}).bind("click."+this.widgetName,function(f){if(!0===a.data(f.target,c.widgetName+".preventClickEvent"))return a.removeData(f.target,c.widgetName+".preventClickEvent"),f.stopImmediatePropagation(),!1});this.started=!1},_mouseDestroy:function(){this.element.unbind("."+
this.widgetName);a(document).unbind("mousemove."+this.widgetName,this._mouseMoveDelegate).unbind("mouseup."+this.widgetName,this._mouseUpDelegate)},_mouseDown:function(d){if(!c){this._mouseStarted&&this._mouseUp(d);this._mouseDownEvent=d;var f=this,e=1==d.which,i="string"==typeof this.options.cancel&&d.target.nodeName?a(d.target).closest(this.options.cancel).length:!1;if(!e||i||!this._mouseCapture(d))return!0;this.mouseDelayMet=!this.options.delay;this.mouseDelayMet||(this._mouseDelayTimer=setTimeout(function(){f.mouseDelayMet=
...
if(!d){var f=this._uiHash();if(!1===this._trigger("drag",c,f))return this._mouseUp({}),!1;this.position=f.position}if(!this.options.axis||"y"!=this.options.axis)this.helper[0].style.left=this.position.left+"px";if(!this.options.axis||"x"!=this.options.axis)this.helper[0].style.top=this.position.top+"px";a.ui.ddmanager&&a.ui.ddmanager.drag(this,c);return!1},_mouseStop:function(c){var d=!1;a.ui.ddmanager&&!this.options.dropBehaviour&&(d=a.ui.ddmanager.drop(this,c));this.dropped&&(d=this.dropped,this.dropped=
...
526>a.browser.version&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollTop():i?0:e.scrollTop())*f),left:d.left+this.offset.relative.left*f+this.offset.parent.left*f-(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollLeft():i?0:e.scrollLeft())*f)}},_generatePosition:function(c){var d=this.options,f="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],
this.offsetParent[0]))?this.offsetParent:this.scrollParent,e=/(html|body)/i.test(f[0].tagName),i=c.pageX,g=c.pageY;if(this.originalPosition){var b;this.containment&&(this.relative_container?(b=this.relative_container.offset(),b=[this.containment[0]+b.left,this.containment[1]+b.top,this.containment[2]+b.left,this.containment[3]+b.top]):b=this.containment,c.pageX-this.offset.click.left<b[0]&&(i=b[0]+this.offset.click.left),c.pageY-this.offset.click.top<b[1]&&(g=b[1]+this.offset.click.top),c.pageX-this.offset.click.left>
...
f._opacity)}});a.ui.plugin.add("draggable","scroll",{start:function(){var c=a(this).data("draggable");c.scrollParent[0]!=document&&"HTML"!=c.scrollParent[0].tagName&&(c.overflowOffset=c.scrollParent.offset())},drag:function(c){var d=a(this).data("draggable"),f=d.options,e=!1;if(d.scrollParent[0]!=document&&"HTML"!=d.scrollParent[0].tagName){if(!f.axis||"x"!=f.axis)d.overflowOffset.top+d.scrollParent[0].offsetHeight-c.pageY<f.scrollSensitivity?d.scrollParent[0].scrollTop=e=d.scrollParent[0].scrollTop+
f.scrollSpeed:c.pageY-d.overflowOffset.top<f.scrollSensitivity&&(d.scrollParent[0].scrollTop=e=d.scrollParent[0].scrollTop-f.scrollSpeed);if(!f.axis||"y"!=f.axis)d.overflowOffset.left+d.scrollParent[0].offsetWidth-c.pageX<f.scrollSensitivity?d.scrollParent[0].scrollLeft=e=d.scrollParent[0].scrollLeft+f.scrollSpeed:c.pageX-d.overflowOffset.left<f.scrollSensitivity&&(d.scrollParent[0].scrollLeft=e=d.scrollParent[0].scrollLeft-f.scrollSpeed)}else{if(!f.axis||"x"!=f.axis)c.pageY-a(document).scrollTop()<
f.scrollSensitivity?e=a(document).scrollTop(a(document).scrollTop()-f.scrollSpeed):a(window).height()-(c.pageY-a(document).scrollTop())<f.scrollSensitivity&&(e=a(document).scrollTop(a(document).scrollTop()+f.scrollSpeed));if(!f.axis||"y"!=f.axis)c.pageX-a(document).scrollLeft()<f.scrollSensitivity?e=a(document).scrollLeft(a(document).scrollLeft()-f.scrollSpeed):a(window).width()-(c.pageX-a(document).scrollLeft())<f.scrollSensitivity&&(e=a(document).scrollLeft(a(document).scrollLeft()+f.scrollSpeed))}!1!==
e&&a.ui.ddmanager&&!f.dropBehaviour&&a.ui.ddmanager.prepareOffsets(d,c)}});a.ui.plugin.add("draggable","snap",{start:function(){var c=a(this).data("draggable"),d=c.options;c.snapElements=[];a(d.snap.constructor!=String?d.snap.items||":data(draggable)":d.snap).each(function(){var d=a(this),e=d.offset();this!=c.element[0]&&c.snapElements.push({item:this,width:d.outerWidth(),height:d.outerHeight(),top:e.top,left:e.left})})},drag:function(c,d){for(var f=a(this).data("draggable"),e=f.options,i=e.snapTolerance,
g=d.offset.left,b=g+f.helperProportions.width,j=d.offset.top,l=j+f.helperProportions.height,n=f.snapElements.length-1;0<=n;n--){var o=f.snapElements[n].left,m=o+f.snapElements[n].width,p=f.snapElements[n].top,r=p+f.snapElements[n].height;if(o-i<g&&g<m+i&&p-i<j&&j<r+i||o-i<g&&g<m+i&&p-i<l&&l<r+i||o-i<b&&b<m+i&&p-i<j&&j<r+i||o-i<b&&b<m+i&&p-i<l&&l<r+i){if("inner"!=e.snapMode){var q=Math.abs(p-l)<=i,s=Math.abs(r-j)<=i,y=Math.abs(o-b)<=i,v=Math.abs(m-g)<=i;q&&(d.position.top=f._convertPositionTo("relative",
{top:p-f.helperProportions.height,left:0}).top-f.margins.top);s&&(d.position.top=f._convertPositionTo("relative",{top:r,left:0}).top-f.margins.top);y&&(d.position.left=f._convertPositionTo("relative",{top:0,left:o-f.helperProportions.width}).left-f.margins.left);v&&(d.position.left=f._convertPositionTo("relative",{top:0,left:m}).left-f.margins.left)}var z=q||s||y||v;if("outer"!=e.snapMode&&(q=Math.abs(p-j)<=i,s=Math.abs(r-l)<=i,y=Math.abs(o-g)<=i,v=Math.abs(m-b)<=i,q&&(d.position.top=f._convertPositionTo("relative",
{top:p,left:0}).top-f.margins.top),s&&(d.position.top=f._convertPositionTo("relative",{top:r-f.helperProportions.height,left:0}).top-f.margins.top),y&&(d.position.left=f._convertPositionTo("relative",{top:0,left:o}).left-f.margins.left),v))d.position.left=f._convertPositionTo("relative",{top:0,left:m-f.helperProportions.width}).left-f.margins.left;!f.snapElements[n].snapping&&(q||s||y||v||z)&&f.options.snap.snap&&f.options.snap.snap.call(f.element,c,a.extend(f._uiHash(),{snapItem:f.snapElements[n].item}));
f.snapElements[n].snapping=q||s||y||v||z}else f.snapElements[n].snapping&&f.options.snap.release&&f.options.snap.release.call(f.element,c,a.extend(f._uiHash(),{snapItem:f.snapElements[n].item})),f.snapElements[n].snapping=!1}}});a.ui.plugin.add("draggable","stack",{start:function(){var c=a(this).data("draggable").options,c=a.makeArray(a(c.stack)).sort(function(c,d){return(parseInt(a(c).css("zIndex"),10)||0)-(parseInt(a(d).css("zIndex"),10)||0)});if(c.length){var d=parseInt(c[0].style.zIndex)||0;a(c).each(function(a){this.style.zIndex=
d+a});this[0].style.zIndex=d+c.length}}});a.ui.plugin.add("draggable","zIndex",{start:function(c,d){var f=a(d.helper),e=a(this).data("draggable").options;f.css("zIndex")&&(e._zIndex=f.css("zIndex"));f.css("zIndex",e.zIndex)},stop:function(c,d){var f=a(this).data("draggable").options;f._zIndex&&a(d.helper).css("zIndex",f._zIndex)}})})(jQuery);
...
c,this.ui(d))},_out:function(c){var d=a.ui.ddmanager.current;if(d&&(d.currentItem||d.element)[0]!=this.element[0])if(this.accept.call(this.element[0],d.currentItem||d.element))this.options.hoverClass&&this.element.removeClass(this.options.hoverClass),this._trigger("out",c,this.ui(d))},_drop:function(c,d){var f=d||a.ui.ddmanager.current;if(!f||(f.currentItem||f.element)[0]==this.element[0])return!1;var e=!1;this.element.find(":data(droppable)").not(".ui-draggable-dragging").each(function(){var c=a.data(this,
"droppable");if(c.options.greedy&&!c.options.disabled&&c.options.scope==f.options.scope&&c.accept.call(c.element[0],f.currentItem||f.element)&&a.ui.intersect(f,a.extend(c,{offset:c.element.offset()}),c.options.tolerance))return e=!0,!1});return e?!1:this.accept.call(this.element[0],f.currentItem||f.element)?(this.options.activeClass&&this.element.removeClass(this.options.activeClass),this.options.hoverClass&&this.element.removeClass(this.options.hoverClass),this._trigger("drop",c,this.ui(f)),this.element):
!1},ui:function(a){return{draggable:a.currentItem||a.element,helper:a.helper,position:a.position,offset:a.positionAbs}}});a.extend(a.ui.droppable,{version:"1.8.20"});a.ui.intersect=function(c,d,f){if(!d.offset)return!1;var e=(c.positionAbs||c.position.absolute).left,i=e+c.helperProportions.width,g=(c.positionAbs||c.position.absolute).top,b=g+c.helperProportions.height,j=d.offset.left,l=j+d.proportions.width,n=d.offset.top,o=n+d.proportions.height;switch(f){case "fit":return j<=e&&i<=l&&n<=g&&b<=o;
case "intersect":return j<e+c.helperProportions.width/2&&i-c.helperProportions.width/2<l&&n<g+c.helperProportions.height/2&&b-c.helperProportions.height/2<o;case "pointer":return a.ui.isOver((c.positionAbs||c.position.absolute).top+(c.clickOffset||c.offset.click).top,(c.positionAbs||c.position.absolute).left+(c.clickOffset||c.offset.click).left,n,j,d.proportions.height,d.proportions.width);case "touch":return(g>=n&&g<=o||b>=n&&b<=o||g<n&&b>o)&&(e>=j&&e<=l||i>=j&&i<=l||e<j&&i>l);default:return!1}};
a.ui.ddmanager={current:null,droppables:{"default":[]},prepareOffsets:function(c,d){var f=a.ui.ddmanager.droppables[c.options.scope]||[],e=d?d.type:null,i=(c.currentItem||c.element).find(":data(droppable)").andSelf(),g=0;a:for(;g<f.length;g++)if(!(f[g].options.disabled||c&&!f[g].accept.call(f[g].element[0],c.currentItem||c.element))){for(var b=0;b<i.length;b++)if(i[b]==f[g].element[0]){f[g].proportions.height=0;continue a}f[g].visible="none"!=f[g].element.css("display");f[g].visible&&("mousedown"==
e&&f[g]._activate.call(f[g],d),f[g].offset=f[g].element.offset(),f[g].proportions={width:f[g].element[0].offsetWidth,height:f[g].element[0].offsetHeight})}},drop:function(c,d){var f=!1;a.each(a.ui.ddmanager.droppables[c.options.scope]||[],function(){if(this.options&&(!this.options.disabled&&this.visible&&a.ui.intersect(c,this,this.options.tolerance)&&(f=this._drop.call(this,d)||f),!this.options.disabled&&this.visible&&this.accept.call(this.element[0],c.currentItem||c.element)))this.isout=1,this.isover=
0,this._deactivate.call(this,d)});return f},dragStart:function(c,d){c.element.parents(":not(body,html)").bind("scroll.droppable",function(){c.options.refreshPositions||a.ui.ddmanager.prepareOffsets(c,d)})},drag:function(c,d){c.options.refreshPositions&&a.ui.ddmanager.prepareOffsets(c,d);a.each(a.ui.ddmanager.droppables[c.options.scope]||[],function(){if(!this.options.disabled&&!this.greedyChild&&this.visible){var f=a.ui.intersect(c,this,this.options.tolerance);if(f=!f&&1==this.isover?"isout":f&&0==
this.isover?"isover":null){var e;if(this.options.greedy){var i=this.element.parents(":data(droppable):eq(0)");i.length&&(e=a.data(i[0],"droppable"),e.greedyChild="isover"==f?1:0)}e&&"isover"==f&&(e.isover=0,e.isout=1,e._out.call(e,d));this[f]=1;this["isout"==f?"isover":"isout"]=0;this["isover"==f?"_over":"_out"].call(this,d);e&&"isout"==f&&(e.isout=0,e.isover=1,e._over.call(e,d))}}})},dragStop:function(c,d){c.element.parents(":not(body,html)").unbind("scroll.droppable");c.options.refreshPositions||
...
g=this.element;this.resizing=!0;this.documentScroll={top:a(document).scrollTop(),left:a(document).scrollLeft()};(g.is(".ui-draggable")||/absolute/.test(g.css("position")))&&g.css({position:"absolute",top:i.top,left:i.left});this._renderProxy();var i=c(this.helper.css("left")),b=c(this.helper.css("top"));e.containment&&(i+=a(e.containment).scrollLeft()||0,b+=a(e.containment).scrollTop()||0);this.offset=this.helper.offset();this.position={left:i,top:b};this.size=this._helper?{width:g.outerWidth(),height:g.outerHeight()}:
...
this._vBoundaries,i=this.axis,g=d(a.width)&&c.maxWidth&&c.maxWidth<a.width,b=d(a.height)&&c.maxHeight&&c.maxHeight<a.height,j=d(a.width)&&c.minWidth&&c.minWidth>a.width,l=d(a.height)&&c.minHeight&&c.minHeight>a.height;j&&(a.width=c.minWidth);l&&(a.height=c.minHeight);g&&(a.width=c.maxWidth);b&&(a.height=c.maxHeight);var n=this.originalPosition.left+this.originalSize.width,o=this.position.top+this.size.height,m=/sw|nw|w/.test(i),i=/nw|ne|n/.test(i);j&&m&&(a.left=n-c.minWidth);g&&m&&(a.left=n-c.maxWidth);
l&&i&&(a.top=o-c.minHeight);b&&i&&(a.top=o-c.maxHeight);(c=!a.width&&!a.height)&&!a.left&&a.top?a.top=null:c&&!a.top&&a.left&&(a.left=null);return a},_proportionallyResize:function(){if(this._proportionallyResizeElements.length)for(var c=this.helper||this.element,d=0;d<this._proportionallyResizeElements.length;d++){var i=this._proportionallyResizeElements[d];if(!this.borderDif){var g=[i.css("borderTopWidth"),i.css("borderRightWidth"),i.css("borderBottomWidth"),i.css("borderLeftWidth")],b=[i.css("paddingTop"),
...
"containment",{start:function(){var d=a(this).data("resizable"),e=d.element,i=d.options.containment;if(e=i instanceof a?i.get(0):/parent/.test(i)?e.parent().get(0):i)if(d.containerElement=a(e),/document/.test(i)||i==document)d.containerOffset={left:0,top:0},d.containerPosition={left:0,top:0},d.parentData={element:a(document),left:0,top:0,width:a(document).width(),height:a(document).height()||document.body.parentNode.scrollHeight};else{var g=a(e),b=[];a(["Top","Right","Left","Bottom"]).each(function(a,
d){b[a]=c(g.css("padding"+d))});d.containerOffset=g.offset();d.containerPosition=g.position();d.containerSize={height:g.innerHeight()-b[3],width:g.innerWidth()-b[1]};var i=d.containerOffset,j=d.containerSize.height,l=d.containerSize.width,l=a.ui.hasScroll(e,"left")?e.scrollWidth:l,j=a.ui.hasScroll(e)?e.scrollHeight:j;d.parentData={element:e,left:i.left,top:i.top,width:l,height:j}}},resize:function(c){var d=a(this).data("resizable"),i=d.options,g=d.containerOffset,b=d.position,c=d._aspectRatio||c.shiftKey,
...
c&&(d.size.width=d.size.height*d.aspectRatio))},stop:function(){var c=a(this).data("resizable"),d=c.options,i=c.containerOffset,g=c.containerPosition,b=c.containerElement,j=a(c.helper),l=j.offset(),n=j.outerWidth()-c.sizeDiff.width,j=j.outerHeight()-c.sizeDiff.height;c._helper&&!d.animate&&/relative/.test(b.css("position"))&&a(this).css({left:l.left-g.left-i.left,width:n,height:j});c._helper&&!d.animate&&/static/.test(b.css("position"))&&a(this).css({left:l.left-g.left-i.left,width:n,height:j})}});
...
this;this.opos=[c.pageX,c.pageY];if(!this.options.disabled){var f=this.options;this.selectees=a(f.filter,this.element[0]);this._trigger("start",c);a(f.appendTo).append(this.helper);this.helper.css({left:c.clientX,top:c.clientY,width:0,height:0});f.autoRefresh&&this.refresh();this.selectees.filter(".ui-selected").each(function(){var e=a.data(this,"selectable-item");e.startselected=!0;!c.metaKey&&!c.ctrlKey&&(e.$element.removeClass("ui-selected"),e.selected=!1,e.$element.addClass("ui-unselecting"),
...
this;this.dragged=!0;if(!this.options.disabled){var f=this.options,e=this.opos[0],i=this.opos[1],g=c.pageX,b=c.pageY;if(e>g)var j=g,g=e,e=j;i>b&&(j=b,b=i,i=j);this.helper.css({left:e,top:i,width:g-e,height:b-i});this.selectees.each(function(){var j=a.data(this,"selectable-item");if(j&&j.element!=d.element[0]){var n=false;f.tolerance=="touch"?n=!(j.left>g||j.right<e||j.top>b||j.bottom<i):f.tolerance=="fit"&&(n=j.left>e&&j.right<g&&j.top>i&&j.bottom<b);if(n){if(j.selected){j.$element.removeClass("ui-selected");
...
!1;f.startselected=!1;d._trigger("unselected",c,{unselected:f.element})});a(".ui-selecting",this.element[0]).each(function(){var f=a.data(this,"selectable-item");f.$element.removeClass("ui-selecting").addClass("ui-selected");f.selecting=!1;f.selected=!0;f.startselected=!0;d._trigger("selected",c,{selected:f.element})});this._trigger("stop",c);this.helper.remove();return!1}});a.extend(a.ui.selectable,{version:"1.8.20"})})(jQuery);
...
return!0},_mouseDrag:function(c){this.position=this._generatePosition(c);this.positionAbs=this._convertPositionTo("absolute");this.lastPositionAbs||(this.lastPositionAbs=this.positionAbs);if(this.options.scroll){var d=this.options,f=!1;this.scrollParent[0]!=document&&"HTML"!=this.scrollParent[0].tagName?(this.overflowOffset.top+this.scrollParent[0].offsetHeight-c.pageY<d.scrollSensitivity?this.scrollParent[0].scrollTop=f=this.scrollParent[0].scrollTop+d.scrollSpeed:c.pageY-this.overflowOffset.top<
d.scrollSensitivity&&(this.scrollParent[0].scrollTop=f=this.scrollParent[0].scrollTop-d.scrollSpeed),this.overflowOffset.left+this.scrollParent[0].offsetWidth-c.pageX<d.scrollSensitivity)?this.scrollParent[0].scrollLeft=f=this.scrollParent[0].scrollLeft+d.scrollSpeed:c.pageX-this.overflowOffset.left<d.scrollSensitivity&&(this.scrollParent[0].scrollLeft=f=this.scrollParent[0].scrollLeft-d.scrollSpeed):(c.pageY-a(document).scrollTop()<d.scrollSensitivity?f=a(document).scrollTop(a(document).scrollTop()-
d.scrollSpeed):a(window).height()-(c.pageY-a(document).scrollTop())<d.scrollSensitivity&&(f=a(document).scrollTop(a(document).scrollTop()+d.scrollSpeed)),c.pageX-a(document).scrollLeft()<d.scrollSensitivity?f=a(document).scrollLeft(a(document).scrollLeft()-d.scrollSpeed):a(window).width()-(c.pageX-a(document).scrollLeft())<d.scrollSensitivity&&(f=a(document).scrollLeft(a(document).scrollLeft()+d.scrollSpeed)));!1!==f&&a.ui.ddmanager&&!d.dropBehaviour&&a.ui.ddmanager.prepareOffsets(this,c)}this.positionAbs=
this._convertPositionTo("absolute");if(!this.options.axis||"y"!=this.options.axis)this.helper[0].style.left=this.position.left+"px";if(!this.options.axis||"x"!=this.options.axis)this.helper[0].style.top=this.position.top+"px";for(d=this.items.length-1;0<=d;d--){var f=this.items[d],e=f.item[0],i=this._intersectsWithPointer(f);if(i&&e!=this.currentItem[0]&&this.placeholder[1==i?"next":"prev"]()[0]!=e&&!a.ui.contains(this.placeholder[0],e)&&("semi-dynamic"==this.options.type?!a.ui.contains(this.element[0],
e):1)){this.direction=1==i?"down":"up";if("pointer"==this.options.tolerance||this._intersectsWithSides(f))this._rearrange(c,f);else break;this._trigger("change",c,this._uiHash());break}}this._contactContainers(c);a.ui.ddmanager&&a.ui.ddmanager.drag(this,c);this._trigger("sort",c,this._uiHash());this.lastPositionAbs=this.positionAbs;return!1},_mouseStop:function(c,d){if(c){a.ui.ddmanager&&!this.options.dropBehaviour&&a.ui.ddmanager.drop(this,c);if(this.options.revert){var f=this,e=f.placeholder.offset();
...
dragging:!1,reverting:!1,_noFinalSort:null}),this.domPosition.prev?a(this.domPosition.prev).after(this.currentItem):a(this.domPosition.parent).prepend(this.currentItem));return this},serialize:function(c){var d=this._getItemsAsjQuery(c&&c.connected),f=[],c=c||{};a(d).each(function(){var d=(a(c.item||this).attr(c.attribute||"id")||"").match(c.expression||/(.+)[-=_](.+)/);d&&f.push((c.key||d[1]+"[]")+"="+(c.key&&c.expression?d[1]:d[2]))});!f.length&&c.key&&f.push(c.key+"=");return f.join("&")},toArray:function(c){var d=
this._getItemsAsjQuery(c&&c.connected),f=[],c=c||{};d.each(function(){f.push(a(c.item||this).attr(c.attribute||"id")||"")});return f},_intersectsWith:function(a){var d=this.positionAbs.left,f=d+this.helperProportions.width,e=this.positionAbs.top,i=e+this.helperProportions.height,g=a.left,b=g+a.width,j=a.top,l=j+a.height,n=this.offset.click.top,o=this.offset.click.left;return"pointer"==this.options.tolerance||this.options.forcePointerForContainers||"pointer"!=this.options.tolerance&&this.helperProportions[this.floating?
"width":"height"]>a[this.floating?"width":"height"]?e+n>j&&e+n<l&&d+o>g&&d+o<b:g<d+this.helperProportions.width/2&&f-this.helperProportions.width/2<b&&j<e+this.helperProportions.height/2&&i-this.helperProportions.height/2<l},_intersectsWithPointer:function(c){var d="x"===this.options.axis||a.ui.isOverAxis(this.positionAbs.top+this.offset.click.top,c.top,c.height),c="y"===this.options.axis||a.ui.isOverAxis(this.positionAbs.left+this.offset.click.left,c.left,c.width),d=d&&c,c=this._getDragVerticalDirection(),
...
this.positionAbs.top-this.lastPositionAbs.top;return 0!=a&&(0<a?"down":"up")},_getDragHorizontalDirection:function(){var a=this.positionAbs.left-this.lastPositionAbs.left;return 0!=a&&(0<a?"right":"left")},refresh:function(a){this._refreshItems(a);this.refreshPositions();return this},_connectWith:function(){var a=this.options;return a.connectWith.constructor==String?[a.connectWith]:a.connectWith},_getItemsAsjQuery:function(c){var d=[],f=[],e=this._connectWith();if(e&&c)for(c=e.length-1;0<=c;c--)for(var i=
a(e[c]),g=i.length-1;0<=g;g--){var b=a.data(i[g],this.widgetName);b&&b!=this&&!b.options.disabled&&f.push([a.isFunction(b.options.items)?b.options.items.call(b.element):a(b.options.items,b.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),b])}f.push([a.isFunction(this.options.items)?this.options.items.call(this.element,null,{options:this.options,item:this.currentItem}):a(this.options.items,this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),this]);for(c=f.length-
1;0<=c;c--)f[c][0].each(function(){d.push(this)});return a(d)},_removeCurrentsFromItems:function(){for(var a=this.currentItem.find(":data("+this.widgetName+"-item)"),d=0;d<this.items.length;d++)for(var f=0;f<a.length;f++)a[f]==this.items[d].item[0]&&this.items.splice(d,1)},_refreshItems:function(c){this.items=[];this.containers=[this];var d=this.items,f=[[a.isFunction(this.options.items)?this.options.items.call(this.element[0],c,{item:this.currentItem}):a(this.options.items,this.element),this]],e=
this._connectWith();if(e&&this.ready)for(var i=e.length-1;0<=i;i--)for(var g=a(e[i]),b=g.length-1;0<=b;b--){var j=a.data(g[b],this.widgetName);j&&j!=this&&!j.options.disabled&&(f.push([a.isFunction(j.options.items)?j.options.items.call(j.element[0],c,{item:this.currentItem}):a(j.options.items,j.element),j]),this.containers.push(j))}for(i=f.length-1;0<=i;i--){c=f[i][1];e=f[i][0];b=0;for(g=e.length;b<g;b++)j=a(e[b]),j.data(this.widgetName+"-item",c),d.push({item:j,instance:c,width:0,height:0,left:0,
top:0})}},refreshPositions:function(c){this.offsetParent&&this.helper&&(this.offset.parent=this._getParentOffset());for(var d=this.items.length-1;0<=d;d--){var f=this.items[d];if(!(f.instance!=this.currentContainer&&this.currentContainer&&f.item[0]!=this.currentItem[0])){var e=this.options.toleranceElement?a(this.options.toleranceElement,f.item):f.item;c||(f.width=e.outerWidth(),f.height=e.outerHeight());e=e.offset();f.left=e.left;f.top=e.top}}if(this.options.custom&&this.options.custom.refreshContainers)this.options.custom.refreshContainers.call(this);
...
a(document.createElement(d.currentItem[0].nodeName)).addClass(e||d.currentItem[0].className+" ui-sortable-placeholder").removeClass("ui-sortable-helper")[0];e||(c.style.visibility="hidden");return c},update:function(a,c){if(!e||f.forcePlaceholderSize)c.height()||c.height(d.currentItem.innerHeight()-parseInt(d.currentItem.css("paddingTop")||0,10)-parseInt(d.currentItem.css("paddingBottom")||0,10)),c.width()||c.width(d.currentItem.innerWidth()-parseInt(d.currentItem.css("paddingLeft")||0,10)-parseInt(d.currentItem.css("paddingRight")||
0,10))}}}d.placeholder=a(f.placeholder.element.call(d.element,d.currentItem));d.currentItem.after(d.placeholder);f.placeholder.update(d,d.placeholder)},_contactContainers:function(c){for(var d=null,f=null,e=this.containers.length-1;0<=e;e--)if(!a.ui.contains(this.currentItem[0],this.containers[e].element[0]))if(this._intersectsWith(this.containers[e].containerCache)){if(!d||!a.ui.contains(this.containers[e].element[0],d.element[0]))d=this.containers[e],f=e}else this.containers[e].containerCache.over&&
(this.containers[e]._trigger("out",c,this._uiHash(this)),this.containers[e].containerCache.over=0);if(d)if(1===this.containers.length)this.containers[f]._trigger("over",c,this._uiHash(this)),this.containers[f].containerCache.over=1;else if(this.currentContainer!=this.containers[f]){for(var d=1E4,e=null,i=this.positionAbs[this.containers[f].floating?"left":"top"],g=this.items.length-1;0<=g;g--)if(a.ui.contains(this.containers[f].element[0],this.items[g].item[0])){var b=this.items[g][this.containers[f].floating?
"left":"top"];Math.abs(b-i)<d&&(d=Math.abs(b-i),e=this.items[g])}if(e||this.options.dropOnEmpty)this.currentContainer=this.containers[f],e?this._rearrange(c,e,null,!0):this._rearrange(c,null,this.containers[f].element,!0),this._trigger("change",c,this._uiHash()),this.containers[f]._trigger("change",c,this._uiHash(this)),this.options.placeholder.update(this.currentContainer,this.placeholder),this.containers[f]._trigger("over",c,this._uiHash(this)),this.containers[f].containerCache.over=1}},_createHelper:function(c){var d=
...
this.margins.top]}},_convertPositionTo:function(c,d){d||(d=this.position);var f="absolute"==c?1:-1,e="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,i=/(html|body)/i.test(e[0].tagName);return{top:d.top+this.offset.relative.top*f+this.offset.parent.top*f-(a.browser.safari&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollTop():i?0:e.scrollTop())*f),left:d.left+
this.offset.relative.left*f+this.offset.parent.left*f-(a.browser.safari&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollLeft():i?0:e.scrollLeft())*f)}},_generatePosition:function(c){var d=this.options,f="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,e=/(html|body)/i.test(f[0].tagName);"relative"==this.cssPosition&&!(this.scrollParent[0]!=document&&this.scrollParent[0]!=
...
this.containment[0])?i-d.grid[0]:i+d.grid[0]:i;return{top:g-this.offset.click.top-this.offset.relative.top-this.offset.parent.top+(a.browser.safari&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?-this.scrollParent.scrollTop():e?0:f.scrollTop()),left:i-this.offset.click.left-this.offset.relative.left-this.offset.parent.left+(a.browser.safari&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?-this.scrollParent.scrollLeft():e?0:f.scrollLeft())}},_rearrange:function(a,d,f,e){f?f[0].appendChild(this.placeholder[0]):
d.item[0].parentNode.insertBefore(this.placeholder[0],"down"==this.direction?d.item[0]:d.item[0].nextSibling);this.counter=this.counter?++this.counter:1;var i=this,g=this.counter;window.setTimeout(function(){g==i.counter&&i.refreshPositions(!e)},0)},_clear:function(c,d){this.reverting=!1;var f=[];!this._noFinalSort&&this.currentItem.parent().length&&this.placeholder.before(this.currentItem);this._noFinalSort=null;if(this.helper[0]==this.currentItem[0]){for(var e in this._storedCSS)if("auto"==this._storedCSS[e]||
"static"==this._storedCSS[e])this._storedCSS[e]="";this.currentItem.css(this._storedCSS).removeClass("ui-sortable-helper")}else this.currentItem.show();this.fromOutside&&!d&&f.push(function(a){this._trigger("receive",a,this._uiHash(this.fromOutside))});(this.fromOutside||this.domPosition.prev!=this.currentItem.prev().not(".ui-sortable-helper")[0]||this.domPosition.parent!=this.currentItem.parent()[0])&&!d&&f.push(function(a){this._trigger("update",a,this._uiHash())});if(!a.ui.contains(this.element[0],
this.currentItem[0])){d||f.push(function(a){this._trigger("remove",a,this._uiHash())});for(e=this.containers.length-1;0<=e;e--)a.ui.contains(this.containers[e].element[0],this.currentItem[0])&&!d&&(f.push(function(a){return function(c){a._trigger("receive",c,this._uiHash(this))}}.call(this,this.containers[e])),f.push(function(a){return function(c){a._trigger("update",c,this._uiHash(this))}}.call(this,this.containers[e])))}for(e=this.containers.length-1;0<=e;e--)d||f.push(function(a){return function(c){a._trigger("deactivate",
...
c,this._uiHash());for(e=0;e<f.length;e++)f[e].call(this,c);this._trigger("stop",c,this._uiHash())}return!1}d||this._trigger("beforeStop",c,this._uiHash());this.placeholder[0].parentNode.removeChild(this.placeholder[0]);this.helper[0]!=this.currentItem[0]&&this.helper.remove();this.helper=null;if(!d){for(e=0;e<f.length;e++)f[e].call(this,c);this._trigger("stop",c,this._uiHash())}this.fromOutside=!1;return!0},_trigger:function(){!1===a.Widget.prototype._trigger.apply(this,arguments)&&this.cancel()},
...
e.parentNode);e=d(g);b.start=e;b.end=d(b.end);b.colorInit=true}b.elem.style[c]="rgb("+Math.max(Math.min(parseInt(b.pos*(b.end[0]-b.start[0])+b.start[0],10),255),0)+","+Math.max(Math.min(parseInt(b.pos*(b.end[1]-b.start[1])+b.start[1],10),255),0)+","+Math.max(Math.min(parseInt(b.pos*(b.end[2]-b.start[2])+b.start[2],10),255),0)+")"}});var j={aqua:[0,255,255],azure:[240,255,255],beige:[245,245,220],black:[0,0,0],blue:[0,0,255],brown:[165,42,42],cyan:[0,255,255],darkblue:[0,0,139],darkcyan:[0,139,139],
darkgrey:[169,169,169],darkgreen:[0,100,0],darkkhaki:[189,183,107],darkmagenta:[139,0,139],darkolivegreen:[85,107,47],darkorange:[255,140,0],darkorchid:[153,50,204],darkred:[139,0,0],darksalmon:[233,150,122],darkviolet:[148,0,211],fuchsia:[255,0,255],gold:[255,215,0],green:[0,128,0],indigo:[75,0,130],khaki:[240,230,140],lightblue:[173,216,230],lightcyan:[224,255,255],lightgreen:[144,238,144],lightgrey:[211,211,211],lightpink:[255,182,193],lightyellow:[255,255,224],lime:[0,255,0],magenta:[255,0,255],
maroon:[128,0,0],navy:[0,0,128],olive:[128,128,0],orange:[255,165,0],pink:[255,192,203],purple:[128,0,128],violet:[128,0,128],red:[255,0,0],silver:[192,192,192],white:[255,255,255],yellow:[255,255,0],transparent:[255,255,255]},l=["add","remove","toggle"],n={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};a.effects.animateClass=function(b,c,d,g){a.isFunction(d)&&(g=d,d=null);return this.queue(function(){var j=a(this),n=j.attr("style")||
" ",y=e(f.call(this)),v,z=j.attr("class")||"";a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});v=e(f.call(this));j.attr("class",z);j.animate(i(y,v),{queue:false,duration:c,easing:d,complete:function(){a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});if(typeof j.attr("style")=="object"){j.attr("style").cssText="";j.attr("style").cssText=n}else j.attr("style",n);g&&g.apply(this,arguments);a.dequeue(this)}})})};a.fn.extend({_addClass:a.fn.addClass,addClass:function(b,c,d,e){return c?a.effects.animateClass.apply(this,
...
(function(a){a.effects.blind=function(c){return this.queue(function(){var d=a(this),f=["position","top","bottom","left","right"],e=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.direction||"vertical";a.effects.save(d,f);d.show();var g=a.effects.createWrapper(d).css({overflow:"hidden"}),b="vertical"==i?"height":"width",i="vertical"==i?g.height():g.width();"show"==e&&g.css(b,0);var j={};j[b]="show"==e?i:0;g.animate(j,c.duration,c.options.easing,function(){"hide"==e&&d.hide();a.effects.restore(d,
f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
(function(a){a.effects.bounce=function(c){return this.queue(function(){var d=a(this),f=["position","top","bottom","left","right"],e=a.effects.setMode(d,c.options.mode||"effect"),i=c.options.direction||"up",g=c.options.distance||20,b=c.options.times||5,j=c.duration||250;/show|hide/.test(e)&&f.push("opacity");a.effects.save(d,f);d.show();a.effects.createWrapper(d);var l="up"==i||"down"==i?"top":"left",i="up"==i||"left"==i?"pos":"neg",g=c.options.distance||("top"==l?d.outerHeight({margin:!0})/3:d.outerWidth({margin:!0})/
3);"show"==e&&d.css("opacity",0).css(l,"pos"==i?-g:g);"hide"==e&&(g/=2*b);"hide"!=e&&b--;if("show"==e){var n={opacity:1};n[l]=("pos"==i?"+=":"-=")+g;d.animate(n,j/2,c.options.easing);g/=2;b--}for(n=0;n<b;n++){var o={},m={};o[l]=("pos"==i?"-=":"+=")+g;m[l]=("pos"==i?"+=":"-=")+g;d.animate(o,j/2,c.options.easing).animate(m,j/2,c.options.easing);g="hide"==e?2*g:g/2}"hide"==e?(n={opacity:0},n[l]=("pos"==i?"-=":"+=")+g,d.animate(n,j/2,c.options.easing,function(){d.hide();a.effects.restore(d,f);a.effects.removeWrapper(d);
c.callback&&c.callback.apply(this,arguments)})):(o={},m={},o[l]=("pos"==i?"-=":"+=")+g,m[l]=("pos"==i?"+=":"-=")+g,d.animate(o,j/2,c.options.easing).animate(m,j/2,c.options.easing,function(){a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)}));d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(jQuery);
(function(a){a.effects.clip=function(c){return this.queue(function(){var d=a(this),f="position,top,bottom,left,right,height,width".split(","),e=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.direction||"vertical";a.effects.save(d,f);d.show();var g=a.effects.createWrapper(d).css({overflow:"hidden"}),g="IMG"==d[0].tagName?g:d,b="vertical"==i?"height":"width",j="vertical"==i?"top":"left",i="vertical"==i?g.height():g.width();"show"==e&&(g.css(b,0),g.css(j,i/2));var l={};l[b]="show"==e?i:0;l[j]=
"show"==e?0:i/2;g.animate(l,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){e=="hide"&&d.hide();a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.drop=function(c){return this.queue(function(){var d=a(this),f="position,top,bottom,left,right,opacity".split(","),e=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.direction||"left";a.effects.save(d,f);d.show();a.effects.createWrapper(d);var g="up"==i||"down"==i?"top":"left",i="up"==i||"left"==i?"pos":"neg",b=c.options.distance||("top"==g?d.outerHeight({margin:!0})/2:d.outerWidth({margin:!0})/2);"show"==e&&d.css("opacity",0).css(g,"pos"==i?-b:b);var j={opacity:"show"==
e?1:0};j[g]=("show"==e?"pos"==i?"+=":"-=":"pos"==i?"-=":"+=")+b;d.animate(j,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){"hide"==e&&d.hide();a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.explode=function(c){return this.queue(function(){var d=c.options.pieces?Math.round(Math.sqrt(c.options.pieces)):3,f=c.options.pieces?Math.round(Math.sqrt(c.options.pieces)):3;c.options.mode="toggle"==c.options.mode?a(this).is(":visible")?"hide":"show":c.options.mode;var e=a(this).show().css("visibility","hidden"),i=e.offset();i.top-=parseInt(e.css("marginTop"),10)||0;i.left-=parseInt(e.css("marginLeft"),10)||0;for(var g=e.outerWidth(!0),b=e.outerHeight(!0),j=0;j<d;j++)for(var l=
0;l<f;l++)e.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-l*(g/f),top:-j*(b/d)}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:g/f,height:b/d,left:i.left+l*(g/f)+("show"==c.options.mode?(l-Math.floor(f/2))*(g/f):0),top:i.top+j*(b/d)+("show"==c.options.mode?(j-Math.floor(d/2))*(b/d):0),opacity:"show"==c.options.mode?0:1}).animate({left:i.left+l*(g/f)+("show"==c.options.mode?0:(l-Math.floor(f/2))*(g/f)),top:i.top+
j*(b/d)+("show"==c.options.mode?0:(j-Math.floor(d/2))*(b/d)),opacity:"show"==c.options.mode?1:0},c.duration||500);setTimeout(function(){"show"==c.options.mode?e.css({visibility:"visible"}):e.css({visibility:"visible"}).hide();c.callback&&c.callback.apply(e[0]);e.dequeue();a("div.ui-effects-explode").remove()},c.duration||500)})}})(jQuery);
(function(a){a.effects.fade=function(c){return this.queue(function(){var d=a(this),f=a.effects.setMode(d,c.options.mode||"hide");d.animate({opacity:f},{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.fold=function(c){return this.queue(function(){var d=a(this),f=["position","top","bottom","left","right"],e=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.size||15,g=!!c.options.horizFirst,b=c.duration?c.duration/2:a.fx.speeds._default/2;a.effects.save(d,f);d.show();var j=a.effects.createWrapper(d).css({overflow:"hidden"}),l="show"==e!=g,n=l?["width","height"]:["height","width"],l=l?[j.width(),j.height()]:[j.height(),j.width()],o=/([0-9]+)%/.exec(i);o&&(i=parseInt(o[1],
10)/100*l["hide"==e?0:1]);"show"==e&&j.css(g?{height:0,width:i}:{height:i,width:0});g={};o={};g[n[0]]="show"==e?l[0]:i;o[n[1]]="show"==e?l[1]:0;j.animate(g,b,c.options.easing).animate(o,b,c.options.easing,function(){"hide"==e&&d.hide();a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
(function(a){a.effects.highlight=function(c){return this.queue(function(){var d=a(this),f=["backgroundImage","backgroundColor","opacity"],e=a.effects.setMode(d,c.options.mode||"show"),i={backgroundColor:d.css("backgroundColor")};"hide"==e&&(i.opacity=0);a.effects.save(d,f);d.show().css({backgroundImage:"none",backgroundColor:c.options.color||"#ffff99"}).animate(i,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){e=="hide"&&d.hide();a.effects.restore(d,f);e=="show"&&!a.support.opacity&&
this.style.removeAttribute("filter");c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.pulsate=function(c){return this.queue(function(){var d=a(this),f=a.effects.setMode(d,c.options.mode||"show"),e=2*(c.options.times||5)-1,i=c.duration?c.duration/2:a.fx.speeds._default/2,g=d.is(":visible"),b=0;g||(d.css("opacity",0).show(),b=1);("hide"==f&&g||"show"==f&&!g)&&e--;for(f=0;f<e;f++)d.animate({opacity:b},i,c.options.easing),b=(b+1)%2;d.animate({opacity:b},i,c.options.easing,function(){b==0&&d.hide();c.callback&&c.callback.apply(this,arguments)});d.queue("fx",function(){d.dequeue()}).dequeue()})}})(jQuery);
(function(a){a.effects.puff=function(c){return this.queue(function(){var d=a(this),f=a.effects.setMode(d,c.options.mode||"hide"),e=parseInt(c.options.percent,10)||150,i=e/100,g={height:d.height(),width:d.width()};a.extend(c.options,{fade:!0,mode:f,percent:"hide"==f?e:100,from:"hide"==f?g:{height:g.height*i,width:g.width*i}});d.effect("scale",c.options,c.duration,c.callback);d.dequeue()})};a.effects.scale=function(c){return this.queue(function(){var d=a(this),f=a.extend(!0,{},c.options),e=a.effects.setMode(d,
c.options.mode||"effect"),i=parseInt(c.options.percent,10)||(0==parseInt(c.options.percent,10)?0:"hide"==e?0:100),g=c.options.direction||"both",b=c.options.origin;"effect"!=e&&(f.origin=b||["middle","center"],f.restore=!0);b={height:d.height(),width:d.width()};d.from=c.options.from||("show"==e?{height:0,width:0}:b);d.to={height:b.height*("horizontal"!=g?i/100:1),width:b.width*("vertical"!=g?i/100:1)};if(c.options.fade&&("show"==e&&(d.from.opacity=0,d.to.opacity=1),"hide"==e))d.from.opacity=1,d.to.opacity=
0;f.from=d.from;f.to=d.to;f.mode=e;d.effect("size",f,c.duration,c.callback);d.dequeue()})};a.effects.size=function(c){return this.queue(function(){var d=a(this),f="position,top,bottom,left,right,width,height,overflow,opacity".split(","),e="position,top,bottom,left,right,overflow,opacity".split(","),i=["width","height","overflow"],g=["fontSize"],b=["borderTopWidth","borderBottomWidth","paddingTop","paddingBottom"],j=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"],l=a.effects.setMode(d,
c.options.mode||"effect"),n=c.options.restore||!1,o=c.options.scale||"both",m=c.options.origin,p={height:d.height(),width:d.width()};d.from=c.options.from||p;d.to=c.options.to||p;m&&(m=a.effects.getBaseline(m,p),d.from.top=(p.height-d.from.height)*m.y,d.from.left=(p.width-d.from.width)*m.x,d.to.top=(p.height-d.to.height)*m.y,d.to.left=(p.width-d.to.width)*m.x);var r=d.from.height/p.height,q=d.from.width/p.width,s=d.to.height/p.height,y=d.to.width/p.width;if("box"==o||"both"==o)if(r!=s&&(f=f.concat(b),
d.from=a.effects.setTransition(d,b,r,d.from),d.to=a.effects.setTransition(d,b,s,d.to)),q!=y)f=f.concat(j),d.from=a.effects.setTransition(d,j,q,d.from),d.to=a.effects.setTransition(d,j,y,d.to);if(("content"==o||"both"==o)&&r!=s)f=f.concat(g),d.from=a.effects.setTransition(d,g,r,d.from),d.to=a.effects.setTransition(d,g,s,d.to);a.effects.save(d,n?f:e);d.show();a.effects.createWrapper(d);d.css("overflow","hidden").css(d.from);if("content"==o||"both"==o)b=b.concat(["marginTop","marginBottom"]).concat(g),
j=j.concat(["marginLeft","marginRight"]),i=f.concat(b).concat(j),d.find("*[width]").each(function(){var d=a(this);n&&a.effects.save(d,i);var e=d.height(),f=d.width();d.from={height:e*r,width:f*q};d.to={height:e*s,width:f*y};if(r!=s){d.from=a.effects.setTransition(d,b,r,d.from);d.to=a.effects.setTransition(d,b,s,d.to)}if(q!=y){d.from=a.effects.setTransition(d,j,q,d.from);d.to=a.effects.setTransition(d,j,y,d.to)}d.css(d.from);d.animate(d.to,c.duration,c.options.easing,function(){n&&a.effects.restore(d,
i)})});d.animate(d.to,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){d.to.opacity===0&&d.css("opacity",d.from.opacity);l=="hide"&&d.hide();a.effects.restore(d,n?f:e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.shake=function(c){return this.queue(function(){var d=a(this),f=["position","top","bottom","left","right"];a.effects.setMode(d,c.options.mode||"effect");var e=c.options.direction||"left",i=c.options.distance||20,g=c.options.times||3,b=c.duration||c.options.duration||140;a.effects.save(d,f);d.show();a.effects.createWrapper(d);var j="up"==e||"down"==e?"top":"left",l="up"==e||"left"==e?"pos":"neg",e={},n={},o={};e[j]=("pos"==l?"-=":"+=")+i;n[j]=("pos"==l?"+=":"-=")+2*i;o[j]=("pos"==
l?"-=":"+=")+2*i;d.animate(e,b,c.options.easing);for(i=1;i<g;i++)d.animate(n,b,c.options.easing).animate(o,b,c.options.easing);d.animate(n,b,c.options.easing).animate(e,b/2,c.options.easing,function(){a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)});d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(jQuery);
(function(a){a.effects.slide=function(c){return this.queue(function(){var d=a(this),f=["position","top","bottom","left","right"],e=a.effects.setMode(d,c.options.mode||"show"),i=c.options.direction||"left";a.effects.save(d,f);d.show();a.effects.createWrapper(d).css({overflow:"hidden"});var g="up"==i||"down"==i?"top":"left",i="up"==i||"left"==i?"pos":"neg",b=c.options.distance||("top"==g?d.outerHeight({margin:!0}):d.outerWidth({margin:!0}));"show"==e&&d.css(g,"pos"==i?isNaN(b)?"-"+b:-b:b);var j={};
j[g]=("show"==e?"pos"==i?"+=":"-=":"pos"==i?"-=":"+=")+b;d.animate(j,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){"hide"==e&&d.hide();a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.transfer=function(c){return this.queue(function(){var d=a(this),f=a(c.options.to),e=f.offset(),f={top:e.top,left:e.left,height:f.innerHeight(),width:f.innerWidth()},e=d.offset(),i=a('<div class="ui-effects-transfer"></div>').appendTo(document.body).addClass(c.options.className).css({top:e.top,left:e.left,height:d.innerHeight(),width:d.innerWidth(),position:"absolute"}).animate(f,c.duration,c.options.easing,function(){i.remove();c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
...
(a(c.target).attr("tabIndex",-1),a(i).attr("tabIndex",0),i.focus(),!1):!0}},resize:function(){var c=this.options,d;if(c.fillSpace){if(a.browser.msie){var f=this.element.parent().css("overflow");this.element.parent().css("overflow","hidden")}d=this.element.parent().height();a.browser.msie&&this.element.parent().css("overflow",f);this.headers.each(function(){d-=a(this).outerHeight(!0)});this.headers.next().each(function(){a(this).height(Math.max(0,d-a(this).innerHeight()+a(this).height()))}).css("overflow",
...
d),i=e[0]===this.active[0];f.active=f.collapsible&&i?!1:this.headers.index(e);if(!(this.running||!f.collapsible&&i)){var g=this.active,b=e.next(),j=this.active.next(),l={options:f,newHeader:i&&f.collapsible?a([]):e,oldHeader:this.active,newContent:i&&f.collapsible?a([]):b,oldContent:j},n=this.headers.index(this.active[0])>this.headers.index(e[0]);this.active=i?a([]):e;this._toggle(b,j,l,i,n);g.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").children(".ui-icon").removeClass(f.icons.headerSelected).addClass(f.icons.header);
...
l={options:f,newHeader:a([]),oldHeader:f.active,newContent:a([]),oldContent:j},b=this.active=a([]);this._toggle(b,j,l)}},_toggle:function(c,d,f,e,i){var g=this,b=g.options;g.toShow=c;g.toHide=d;g.data=f;var j=function(){return!g?void 0:g._completed.apply(g,arguments)};g._trigger("changestart",null,g.data);g.running=0===d.size()?c.size():d.size();if(b.animated){f={};f=b.collapsible&&e?{toShow:a([]),toHide:d,complete:j,down:i,autoHeight:b.autoHeight||b.fillSpace}:{toShow:c,toHide:d,complete:j,down:i,
autoHeight:b.autoHeight||b.fillSpace};b.proxied||(b.proxied=b.animated);b.proxiedDuration||(b.proxiedDuration=b.duration);b.animated=a.isFunction(b.proxied)?b.proxied(f):b.proxied;b.duration=a.isFunction(b.proxiedDuration)?b.proxiedDuration(f):b.proxiedDuration;var e=a.ui.accordion.animations,l=b.duration,n=b.animated;n&&!e[n]&&!a.easing[n]&&(n="slide");e[n]||(e[n]=function(a){this.slide(a,{easing:n,duration:l||700})});e[n](f)}else b.collapsible&&e?c.toggle():(d.hide(),c.show()),j(!0);d.prev().attr({"aria-expanded":"false",
...
animations:{slide:function(c,d){c=a.extend({easing:"swing",duration:300},c,d);if(c.toHide.size())if(c.toShow.size()){var f=c.toShow.css("overflow"),e=0,i={},g={},b,j=c.toShow;b=j[0].style.width;j.width(j.parent().width()-parseFloat(j.css("paddingLeft"))-parseFloat(j.css("paddingRight"))-(parseFloat(j.css("borderLeftWidth"))||0)-(parseFloat(j.css("borderRightWidth"))||0));a.each(["height","paddingTop","paddingBottom"],function(b,d){g[d]="hide";var e=(""+a.css(c.toShow[0],d)).match(/^([\d+-.]+)(.*)$/);
i[d]={value:e[1],unit:e[2]||"px"}});c.toShow.css({height:0,overflow:"hidden"}).show();c.toHide.filter(":hidden").each(c.complete).end().filter(":visible").animate(g,{step:function(a,b){"height"==b.prop&&(e=0===b.end-b.start?0:(b.now-b.start)/(b.end-b.start));c.toShow[0].style[b.prop]=e*i[b.prop].value+i[b.prop].unit},duration:c.duration,easing:c.easing,complete:function(){c.autoHeight||c.toShow.css("height","");c.toShow.css({width:b,overflow:f});c.complete()}})}else c.toHide.animate({height:"hide",
...
(function(a){var c=0;a.widget("ui.autocomplete",{options:{appendTo:"body",autoFocus:!1,delay:300,minLength:1,position:{my:"left top",at:"left bottom",collision:"none"},source:null},pending:0,_create:function(){var c=this,f=this.element[0].ownerDocument,e;this.isMultiLine=this.element.is("textarea");this.element.addClass("ui-autocomplete-input").attr("autocomplete","off").attr({role:"textbox","aria-autocomplete":"list","aria-haspopup":"true"}).bind("keydown.autocomplete",function(f){if(!c.options.disabled&&
!c.element.propAttr("readOnly")){e=!1;var g=a.ui.keyCode;switch(f.keyCode){case g.PAGE_UP:c._move("previousPage",f);break;case g.PAGE_DOWN:c._move("nextPage",f);break;case g.UP:c._keyEvent("previous",f);break;case g.DOWN:c._keyEvent("next",f);break;case g.ENTER:case g.NUMPAD_ENTER:c.menu.active&&(e=!0,f.preventDefault());case g.TAB:if(!c.menu.active)break;c.menu.select(f);break;case g.ESCAPE:c.element.val(c.term);c.close(f);break;default:clearTimeout(c.searching),c.searching=setTimeout(function(){c.term!=
...
c.value,value:c.value||c.label},c)})},_suggest:function(c){var f=this.menu.element.empty().zIndex(this.element.zIndex()+1);this._renderMenu(f,c);this.menu.deactivate();this.menu.refresh();f.show();this._resizeMenu();f.position(a.extend({of:this.element},this.options.position));this.options.autoFocus&&this.menu.next(new a.Event("mouseover"))},_resizeMenu:function(){var a=this.menu.element;a.outerWidth(Math.max(a.width("").outerWidth()+1,this.element.outerWidth()))},_renderMenu:function(c,f){var e=
this;a.each(f,function(a,f){e._renderItem(c,f)})},_renderItem:function(c,f){return a("<li></li>").data("item.autocomplete",f).append(a("<a></a>").text(f.label)).appendTo(c)},_move:function(a,c){if(this.menu.element.is(":visible"))if(this.menu.first()&&/^previous/.test(a)||this.menu.last()&&/^next/.test(a))this.element.val(this.term),this.menu.deactivate();else this.menu[a](c);else this.search(null,c)},widget:function(){return this.menu.element},_keyEvent:function(a,c){if(!this.isMultiLine||this.menu.element.is(":visible"))this._move(a,
c),c.preventDefault()}});a.extend(a.ui.autocomplete,{escapeRegex:function(a){return a.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,"\\$&")},filter:function(c,f){var e=RegExp(a.ui.autocomplete.escapeRegex(f),"i");return a.grep(c,function(a){return e.test(a.label||a.value||a)})}})})(jQuery);
...
-1).mouseenter(function(d){c.activate(d,a(this).parent())}).mouseleave(function(){c.deactivate()})},activate:function(a,d){this.deactivate();if(this.hasScroll()){var f=d.offset().top-this.element.offset().top,e=this.element.scrollTop(),i=this.element.height();0>f?this.element.scrollTop(e+f):f>=i&&this.element.scrollTop(e+f-i+d.height())}this.active=d.eq(0).children("a").addClass("ui-state-hover").attr("id","ui-active-menuitem").end();this._trigger("focus",a,{item:d})},deactivate:function(){this.active&&
...
a):this.activate(f,this.element.children(d))):this.activate(f,this.element.children(d))},nextPage:function(c){if(this.hasScroll())if(!this.active||this.last())this.activate(c,this.element.children(".ui-menu-item:first"));else{var d=this.active.offset().top,f=this.element.height(),e=this.element.children(".ui-menu-item").filter(function(){var c=a(this).offset().top-d-f+a(this).height();return 10>c&&-10<c});e.length||(e=this.element.children(".ui-menu-item:last"));this.activate(c,e)}else this.activate(c,
this.element.children(".ui-menu-item").filter(!this.active||this.last()?":first":":last"))},previousPage:function(c){if(this.hasScroll())if(!this.active||this.first())this.activate(c,this.element.children(".ui-menu-item:last"));else{var d=this.active.offset().top,f=this.element.height(),e=this.element.children(".ui-menu-item").filter(function(){var c=a(this).offset().top-d+f-a(this).height();return 10>c&&-10<c});e.length||(e=this.element.children(".ui-menu-item:first"));this.activate(c,e)}else this.activate(c,
...
(function(a){var c,d,f,e,i=function(){var b=a(this).find(":ui-button");setTimeout(function(){b.button("refresh")},1)},g=function(b){var c=b.name,d=b.form,e=a([]);c&&(e=d?a(d).find("[name='"+c+"']"):a("[name='"+c+"']",b.ownerDocument).filter(function(){return!this.form}));return e};a.widget("ui.button",{options:{disabled:null,text:!0,label:null,icons:{primary:null,secondary:null}},_create:function(){this.element.closest("form").unbind("reset.button").bind("reset.button",i);"boolean"!==typeof this.options.disabled?
this.options.disabled=!!this.element.propAttr("disabled"):this.element.propAttr("disabled",this.options.disabled);this._determineButtonType();this.hasTitle=!!this.buttonElement.attr("title");var b=this,j=this.options,l="checkbox"===this.type||"radio"===this.type,n="ui-state-hover"+(!l?" ui-state-active":"");null===j.label&&(j.label=this.buttonElement.html());this.buttonElement.addClass("ui-button ui-widget ui-state-default ui-corner-all").attr("role","button").bind("mouseenter.button",function(){if(!j.disabled){a(this).addClass("ui-state-hover");
this===c&&a(this).addClass("ui-state-active")}}).bind("mouseleave.button",function(){j.disabled||a(this).removeClass(n)}).bind("click.button",function(a){if(j.disabled){a.preventDefault();a.stopImmediatePropagation()}});this.element.bind("focus.button",function(){b.buttonElement.addClass("ui-state-focus")}).bind("blur.button",function(){b.buttonElement.removeClass("ui-state-focus")});l&&(this.element.bind("change.button",function(){e||b.refresh()}),this.buttonElement.bind("mousedown.button",function(a){if(!j.disabled){e=
false;d=a.pageX;f=a.pageY}}).bind("mouseup.button",function(a){if(!j.disabled&&(d!==a.pageX||f!==a.pageY))e=true}));"checkbox"===this.type?this.buttonElement.bind("click.button",function(){if(j.disabled||e)return false;a(this).toggleClass("ui-state-active");b.buttonElement.attr("aria-pressed",b.element[0].checked)}):"radio"===this.type?this.buttonElement.bind("click.button",function(){if(j.disabled||e)return false;a(this).addClass("ui-state-active");b.buttonElement.attr("aria-pressed","true");var c=
...
(i={},i[d]=f);if(g){this._curInst==g&&this._hideDatepicker();var m=this._getDateDatepicker(b,!0),p=this._getMinMaxDate(g,"min"),r=this._getMinMaxDate(g,"max");e(g.settings,i);null!==p&&i.dateFormat!==c&&i.minDate===c&&(g.settings.minDate=this._formatDate(g,p));null!==r&&i.dateFormat!==c&&i.maxDate===c&&(g.settings.maxDate=this._formatDate(g,r));this._attachments(a(b),g);this._autoSize(g);this._setDate(g,m);this._updateAlternate(g);this._updateDatepicker(g)}},_changeDatepicker:function(a,c,d){this._optionDatepicker(a,
...
a(b).parents().each(function(){f=f|a(this).css("position")=="fixed";return!f});f&&a.browser.opera&&(a.datepicker._pos[0]-=document.documentElement.scrollLeft,a.datepicker._pos[1]-=document.documentElement.scrollTop);d={left:a.datepicker._pos[0],top:a.datepicker._pos[1]};a.datepicker._pos=null;c.dpDiv.empty();c.dpDiv.css({position:"absolute",display:"block",top:"-1000px"});a.datepicker._updateDatepicker(c);d=a.datepicker._checkOffset(c,d,f);c.dpDiv.css({position:a.datepicker._inDialog&&a.blockUI?"static":
...
b.yearshtml;setTimeout(function(){e===b.yearshtml&&b.yearshtml&&b.dpDiv.find("select.ui-datepicker-year:first").replaceWith(b.yearshtml);e=b.yearshtml=null},0)}},_getBorders:function(a){var c=function(a){return{thin:1,medium:2,thick:3}[a]||a};return[parseFloat(c(a.css("border-left-width"))),parseFloat(c(a.css("border-top-width")))]},_checkOffset:function(b,c,d){var e=b.dpDiv.outerWidth(),f=b.dpDiv.outerHeight(),g=b.input?b.input.outerWidth():0,i=b.input?b.input.outerHeight():0,r=document.documentElement.clientWidth+
a(document).scrollLeft(),q=document.documentElement.clientHeight+a(document).scrollTop();c.left-=this._get(b,"isRTL")?e-g:0;c.left-=d&&c.left==b.input.offset().left?a(document).scrollLeft():0;c.top-=d&&c.top==b.input.offset().top+i?a(document).scrollTop():0;c.left-=Math.min(c.left,c.left+e>r&&r>e?Math.abs(c.left+e-r):0);c.top-=Math.min(c.top,c.top+f>q&&q>f?Math.abs(f+i):0);return c},_findPos:function(b){for(var c=this._get(this._getInst(b),"isRTL");b&&("hidden"==b.type||1!=b.nodeType||a.expr.filters.hidden(b));)b=
...
e="string"!=typeof e?e:(new Date).getFullYear()%100+parseInt(e,10),f=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,g=(d?d.dayNames:null)||this._defaults.dayNames,i=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,r=(d?d.monthNames:null)||this._defaults.monthNames,q=d=-1,s=-1,y=-1,v=!1,z=function(a){(a=L+1<b.length&&b.charAt(L+1)==a)&&L++;return a},B=function(a){var b=z(a),a=c.substring(F).match(RegExp("^\\d{1,"+("@"==a?14:"!"==a?20:"y"==a&&b?4:"o"==a?3:2)+"}"));if(!a)throw"Missing number at position "+
F;F+=a[0].length;return parseInt(a[0],10)},x=function(b,d,e){var b=a.map(z(b)?e:d,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)}),f=-1;a.each(b,function(a,b){var d=b[1];if(c.substr(F,d.length).toLowerCase()==d.toLowerCase())return f=b[0],F+=d.length,!1});if(-1!=f)return f+1;throw"Unknown name at position "+F;},D=function(){if(c.charAt(F)!=b.charAt(L))throw"Unexpected literal at position "+F;F++},F=0,L=0;L<b.length;L++)if(v)"'"==b.charAt(L)&&!z("'")?v=!1:D();else switch(b.charAt(L)){case "d":s=
B("d");break;case "D":x("D",f,g);break;case "o":y=B("o");break;case "m":q=B("m");break;case "M":q=x("M",i,r);break;case "y":d=B("y");break;case "@":var E=new Date(B("@")),d=E.getFullYear(),q=E.getMonth()+1,s=E.getDate();break;case "!":E=new Date((B("!")-this._ticksTo1970)/1E4);d=E.getFullYear();q=E.getMonth()+1;s=E.getDate();break;case "'":z("'")?D():v=!0;break;default:D()}if(F<c.length)throw"Extra/unparsed characters found in date: "+c.substring(F);-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-
(new Date).getFullYear()%100+(d<=e?0:-100));if(-1<y){q=1;s=y;do{e=this._getDaysInMonth(d,q-1);if(s<=e)break;q++;s-=e}while(1)}E=this._daylightSavingAdjust(new Date(d,q-1,s));if(E.getFullYear()!=d||E.getMonth()+1!=q||E.getDate()!=s)throw"Invalid date";return E},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:864E9*(718685+Math.floor(492.5)-
Math.floor(19.7)+Math.floor(4.925)),formatDate:function(a,c,d){if(!c)return"";var e=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,f=(d?d.dayNames:null)||this._defaults.dayNames,g=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,d=(d?d.monthNames:null)||this._defaults.monthNames,i=function(c){(c=v+1<a.length&&a.charAt(v+1)==c)&&v++;return c},r=function(a,b,c){b=""+b;if(i(a))for(;b.length<c;)b="0"+b;return b},q=function(a,b,c,d){return i(a)?d[b]:c[b]},s="",y=!1;if(c)for(var v=0;v<
a.length;v++)if(y)"'"==a.charAt(v)&&!i("'")?y=!1:s+=a.charAt(v);else switch(a.charAt(v)){case "d":s+=r("d",c.getDate(),2);break;case "D":s+=q("D",c.getDay(),e,f);break;case "o":s+=r("o",Math.round(((new Date(c.getFullYear(),c.getMonth(),c.getDate())).getTime()-(new Date(c.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":s+=r("m",c.getMonth()+1,2);break;case "M":s+=q("M",c.getMonth(),g,d);break;case "y":s+=i("y")?c.getFullYear():(10>c.getYear()%100?"0":"")+c.getYear()%100;break;case "@":s+=
c.getTime();break;case "!":s+=1E4*c.getTime()+this._ticksTo1970;break;case "'":i("'")?s+="'":y=!0;break;default:s+=a.charAt(v)}return s},_possibleChars:function(a){for(var c="",d=!1,e=function(c){(c=f+1<a.length&&a.charAt(f+1)==c)&&f++;return c},f=0;f<a.length;f++)if(d)"'"==a.charAt(f)&&!e("'")?d=!1:c+=a.charAt(f);else switch(a.charAt(f)){case "d":case "m":case "y":case "@":c+="0123456789";break;case "D":case "M":return null;case "'":e("'")?c+="'":d=!0;break;default:c+=a.charAt(f)}return c},_get:function(a,
d){return a.settings[d]!==c?a.settings[d]:this._defaults[d]},_setDateFromField:function(a,c){if(a.input.val()!=a.lastVal){var d=this._get(a,"dateFormat"),e=a.lastVal=a.input?a.input.val():null,f,g;f=g=this._getDefaultDate(a);var i=this._getFormatConfig(a);try{f=this.parseDate(d,e,i)||g}catch(r){this.log(r),e=c?"":e}a.selectedDay=f.getDate();a.drawMonth=a.selectedMonth=f.getMonth();a.drawYear=a.selectedYear=f.getFullYear();a.currentDay=e?f.getDate():0;a.currentMonth=e?f.getMonth():0;a.currentYear=
...
g=this._get(b,"navigationAsDateFormat"),p=this._getNumberOfMonths(b),r=this._get(b,"showCurrentAtPos"),q=this._get(b,"stepMonths"),s=1!=p[0]||1!=p[1],y=this._daylightSavingAdjust(!b.currentDay?new Date(9999,9,9):new Date(b.currentYear,b.currentMonth,b.currentDay)),v=this._getMinMaxDate(b,"min"),z=this._getMinMaxDate(b,"max"),r=b.drawMonth-r,B=b.drawYear;0>r&&(r+=12,B--);if(z)for(var x=this._daylightSavingAdjust(new Date(z.getFullYear(),z.getMonth()-p[0]*p[1]+1,z.getDate())),x=v&&x<v?v:x;this._daylightSavingAdjust(new Date(B,
r,1))>x;)r--,0>r&&(r=11,B--);b.drawMonth=r;b.drawYear=B;var x=this._get(b,"prevText"),x=!g?x:this.formatDate(x,this._daylightSavingAdjust(new Date(B,r-q,1)),this._getFormatConfig(b)),x=this._canAdjustMonth(b,-1,B,r)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', -"+q+", 'M');\" title=\""+x+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+x+"</span></a>":f?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+
x+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+x+"</span></a>",D=this._get(b,"nextText"),D=!g?D:this.formatDate(D,this._daylightSavingAdjust(new Date(B,r+q,1)),this._getFormatConfig(b)),f=this._canAdjustMonth(b,1,B,r)?'<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', +"+q+", 'M');\" title=\""+D+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+D+"</span></a>":f?"":'<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+
D+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+D+"</span></a>",q=this._get(b,"currentText"),D=this._get(b,"gotoCurrent")&&b.currentDay?y:c,q=!g?q:this.formatDate(q,D,this._getFormatConfig(b)),g=!b.inline?'<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_'+i+'.datepicker._hideDatepicker();">'+this._get(b,"closeText")+"</button>":"",e=e?'<div class="ui-datepicker-buttonpane ui-widget-content">'+(d?g:"")+(this._isInRange(b,
D)?'<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._gotoToday('#"+b.id+"');\">"+q+"</button>":"")+(d?"":g)+"</div>":"",g=parseInt(this._get(b,"firstDay"),10),g=isNaN(g)?0:g,q=this._get(b,"showWeek"),D=this._get(b,"dayNames");this._get(b,"dayNamesShort");var F=this._get(b,"dayNamesMin"),L=this._get(b,"monthNames"),E=this._get(b,"monthNamesShort"),w=this._get(b,"beforeShowDay"),P=this._get(b,"showOtherMonths"),
S=this._get(b,"selectOtherMonths");this._get(b,"calculateWeek");for(var h=this._getDefaultDate(b),U="",R=0;R<p[0];R++){var Q="";this.maxRows=4;for(var J=0;J<p[1];J++){var t=this._daylightSavingAdjust(new Date(B,r,b.selectedDay)),I=" ui-corner-all",H="";if(s){H+='<div class="ui-datepicker-group';if(1<p[1])switch(J){case 0:H+=" ui-datepicker-group-first";I=" ui-corner-"+(d?"right":"left");break;case p[1]-1:H+=" ui-datepicker-group-last";I=" ui-corner-"+(d?"left":"right");break;default:H+=" ui-datepicker-group-middle",
I=""}H+='">'}for(var H=H+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+I+'">'+(/all|left/.test(I)&&0==R?d?f:x:"")+(/all|right/.test(I)&&0==R?d?x:f:"")+this._generateMonthYearHeader(b,r,B,v,z,0<R||0<J,L,E)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),M=q?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":"",I=0;7>I;I++)var G=(I+g)%7,M=M+("<th"+(5<=(I+g+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+D[G]+'">'+F[G]+"</span></th>");
H+=M+"</tr></thead><tbody>";M=this._getDaysInMonth(B,r);B==b.selectedYear&&r==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,M));I=(this._getFirstDayOfMonth(B,r)-g+7)%7;M=Math.ceil((I+M)/7);this.maxRows=M=s?this.maxRows>M?this.maxRows:M:M;for(var G=this._daylightSavingAdjust(new Date(B,r,1-I)),W=0;W<M;W++){for(var H=H+"<tr>",ba=!q?"":'<td class="ui-datepicker-week-col">'+this._get(b,"calculateWeek")(G)+"</td>",I=0;7>I;I++){var V=w?w.apply(b.input?b.input[0]:null,[G]):[!0,""],O=G.getMonth()!=
r,T=O&&!S||!V[0]||v&&G<v||z&&G>z,ba=ba+('<td class="'+(5<=(I+g+6)%7?" ui-datepicker-week-end":"")+(O?" ui-datepicker-other-month":"")+(G.getTime()==t.getTime()&&r==b.selectedMonth&&b._keyEvent||h.getTime()==G.getTime()&&h.getTime()==t.getTime()?" "+this._dayOverClass:"")+(T?" "+this._unselectableClass+" ui-state-disabled":"")+(O&&!P?"":" "+V[1]+(G.getTime()==y.getTime()?" "+this._currentClass:"")+(G.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!O||P)&&V[2]?' title="'+V[2]+'"':"")+(T?"":
' onclick="DP_jQuery_'+i+".datepicker._selectDay('#"+b.id+"',"+G.getMonth()+","+G.getFullYear()+', this);return false;"')+">"+(O&&!P?"&#xa0;":T?'<span class="ui-state-default">'+G.getDate()+"</span>":'<a class="ui-state-default'+(G.getTime()==c.getTime()?" ui-state-highlight":"")+(G.getTime()==y.getTime()?" ui-state-active":"")+(O?" ui-priority-secondary":"")+'" href="#">'+G.getDate()+"</a>")+"</td>");G.setDate(G.getDate()+1);G=this._daylightSavingAdjust(G)}H+=ba+"</tr>"}r++;11<r&&(r=0,B++);H+="</tbody></table>"+
(s?"</div>"+(0<p[0]&&J==p[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");Q+=H}U+=Q}U+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return U},_generateMonthYearHeader:function(a,c,d,e,f,g,p,r){var q=this._get(a,"changeMonth"),s=this._get(a,"changeYear"),y=this._get(a,"showMonthAfterYear"),v='<div class="ui-datepicker-title">',z="";if(g||!q)z+='<span class="ui-datepicker-month">'+
p[c]+"</span>";else{for(var p=e&&e.getFullYear()==d,B=f&&f.getFullYear()==d,z=z+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),x=0;12>x;x++)if((!p||x>=e.getMonth())&&(!B||x<=f.getMonth()))z+='<option value="'+x+'"'+(x==c?' selected="selected"':"")+">"+r[x]+"</option>";z+="</select>"}y||(v+=z+(g||!q||!s?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",g||!s)v+='<span class="ui-datepicker-year">'+d+"</span>";else{var r=this._get(a,
"yearRange").split(":"),D=(new Date).getFullYear(),p=function(a){a=a.match(/c[+-].*/)?d+parseInt(a.substring(1),10):a.match(/[+-].*/)?D+parseInt(a,10):parseInt(a,10);return isNaN(a)?D:a},c=p(r[0]),r=Math.max(c,p(r[1]||"")),c=e?Math.max(c,e.getFullYear()):c,r=f?Math.min(r,f.getFullYear()):r;for(a.yearshtml+='<select class="ui-datepicker-year" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'Y');\" >";c<=r;c++)a.yearshtml+='<option value="'+c+'"'+(c==d?' selected="selected"':
"")+">"+c+"</option>";a.yearshtml+="</select>";v+=a.yearshtml;a.yearshtml=null}v+=this._get(a,"yearSuffix");y&&(v+=(g||!q||!s?"&#xa0;":"")+z);return v+"</div>"},_adjustInstDate:function(a,c,d){var e=a.drawYear+("Y"==d?c:0),f=a.drawMonth+("M"==d?c:0),c=Math.min(a.selectedDay,this._getDaysInMonth(e,f))+("D"==d?c:0),e=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(e,f,c)));a.selectedDay=e.getDate();a.drawMonth=a.selectedMonth=e.getMonth();a.drawYear=a.selectedYear=e.getFullYear();("M"==d||
...
(function(a,c){var d={buttons:!0,height:!0,maxHeight:!0,maxWidth:!0,minHeight:!0,minWidth:!0,width:!0},f={maxHeight:!0,maxWidth:!0,minHeight:!0,minWidth:!0},e=a.attrFn||{val:!0,css:!0,html:!0,text:!0,data:!0,width:!0,height:!0,offset:!0,click:!0};a.widget("ui.dialog",{options:{autoOpen:!0,buttons:{},closeOnEscape:!0,closeText:"close",dialogClass:"",draggable:!0,hide:null,height:"auto",maxHeight:!1,maxWidth:!1,minHeight:150,minWidth:150,modal:!1,position:{my:"center",at:"center",collision:"fit",using:function(c){var d=
...
d.dialogClass).css({zIndex:d.zIndex}).attr("tabIndex",-1).css("outline",0).keydown(function(b){if(d.closeOnEscape&&!b.isDefaultPrevented()&&b.keyCode&&b.keyCode===a.ui.keyCode.ESCAPE){c.close(b);b.preventDefault()}}).attr({role:"dialog","aria-labelledby":e}).mousedown(function(a){c.moveToTop(false,a)});c.element.show().removeAttr("title").addClass("ui-dialog-content ui-widget-content").appendTo(f);var n=(c.uiDialogTitlebar=a("<div></div>")).addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(f),
o=a('<a href="#"></a>').addClass("ui-dialog-titlebar-close ui-corner-all").attr("role","button").hover(function(){o.addClass("ui-state-hover")},function(){o.removeClass("ui-state-hover")}).focus(function(){o.addClass("ui-state-focus")}).blur(function(){o.removeClass("ui-state-focus")}).click(function(a){c.close(a);return false}).appendTo(n);(c.uiDialogTitlebarCloseText=a("<span></span>")).addClass("ui-icon ui-icon-closethick").text(d.closeText).appendTo(o);a("<span></span>").addClass("ui-dialog-title").attr("id",
e).html(b).prependTo(n);a.isFunction(d.beforeclose)&&!a.isFunction(d.beforeClose)&&(d.beforeClose=d.beforeclose);n.find("*").add(n).disableSelection();d.draggable&&a.fn.draggable&&c._makeDraggable();d.resizable&&a.fn.resizable&&c._makeResizable();c._createButtons(d.buttons);c._isOpen=!1;a.fn.bgiframe&&f.bgiframe()},_init:function(){this.options.autoOpen&&this.open()},destroy:function(){this.overlay&&this.overlay.destroy();this.uiDialog.hide();this.element.unbind(".dialog").removeData("dialog").removeClass("ui-dialog-content ui-widget-content").hide().appendTo("body");
...
handle:".ui-dialog-titlebar",containment:"document",start:function(e,j){f="auto"===b.height?"auto":a(this).height();a(this).height(a(this).height()).addClass("ui-dialog-dragging");d._trigger("dragStart",e,c(j))},drag:function(a,b){d._trigger("drag",a,c(b))},stop:function(n,o){b.position=[o.position.left-e.scrollLeft(),o.position.top-e.scrollTop()];a(this).removeClass("ui-dialog-dragging").height(f);d._trigger("dragStop",n,c(o));a.ui.dialog.overlay.resize()}})},_makeResizable:function(d){function e(a){return{originalPosition:a.originalPosition,
...
(function(a){a.ui=a.ui||{};var c=/left|center|right/,d=/top|center|bottom/,f,e=a.fn.position,i=a.fn.offset;a.fn.position=function(g){if(!g||!g.of)return e.apply(this,arguments);var g=a.extend({},g),b=a(g.of),i=b[0],l=(g.collision||"flip").split(" "),n=g.offset?g.offset.split(" "):[0,0],o,m,p;9===i.nodeType?(o=b.width(),m=b.height(),p={top:0,left:0}):i.setTimeout?(o=b.width(),m=b.height(),p={top:b.scrollTop(),left:b.scrollLeft()}):i.preventDefault?(g.at="left top",o=m=0,p={top:g.of.pageY,left:g.of.pageX}):
(o=b.outerWidth(),m=b.outerHeight(),p=b.offset());a.each(["my","at"],function(){var a=(g[this]||"").split(" ");a.length===1&&(a=c.test(a[0])?a.concat(["center"]):d.test(a[0])?["center"].concat(a):["center","center"]);a[0]=c.test(a[0])?a[0]:"center";a[1]=d.test(a[1])?a[1]:"center";g[this]=a});1===l.length&&(l[1]=l[0]);n[0]=parseInt(n[0],10)||0;1===n.length&&(n[1]=n[0]);n[1]=parseInt(n[1],10)||0;"right"===g.at[0]?p.left+=o:"center"===g.at[0]&&(p.left+=o/2);"bottom"===g.at[1]?p.top+=m:"center"===g.at[1]&&
(p.top+=m/2);p.left+=n[0];p.top+=n[1];return this.each(function(){var b=a(this),c=b.outerWidth(),d=b.outerHeight(),e=parseInt(a.curCSS(this,"marginLeft",true))||0,i=parseInt(a.curCSS(this,"marginTop",true))||0,j=c+e+(parseInt(a.curCSS(this,"marginRight",true))||0),B=d+i+(parseInt(a.curCSS(this,"marginBottom",true))||0),x=a.extend({},p),D;if(g.my[0]==="right")x.left=x.left-c;else if(g.my[0]==="center")x.left=x.left-c/2;if(g.my[1]==="bottom")x.top=x.top-d;else if(g.my[1]==="center")x.top=x.top-d/2;
if(!f){x.left=Math.round(x.left);x.top=Math.round(x.top)}D={left:x.left-e,top:x.top-i};a.each(["left","top"],function(b,e){if(a.ui.position[l[b]])a.ui.position[l[b]][e](x,{targetWidth:o,targetHeight:m,elemWidth:c,elemHeight:d,collisionPosition:D,collisionWidth:j,collisionHeight:B,offset:n,my:g.my,at:g.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(x,{using:g.using}))})};a.ui.position={fit:{left:function(c,b){var d=a(window),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft();
...
e=d.offset(),f=parseInt(a.curCSS(c,"top",!0),10)||0,i=parseInt(a.curCSS(c,"left",!0),10)||0,e={top:b.top-e.top+f,left:b.left-e.left+i};"using"in b?b.using.call(c,e):d.css(e)},a.fn.offset=function(c){var b=this[0];return!b||!b.ownerDocument?null:c?this.each(function(){a.offset.setOffset(this,c)}):i.call(this)});(function(){var c=document.getElementsByTagName("body")[0],b=document.createElement("div"),d,e;d=document.createElement(c?"div":"body");e={visibility:"hidden",width:0,height:0,border:0,margin:0,
background:"none"};c&&a.extend(e,{position:"absolute",left:"-1000px",top:"-1000px"});for(var i in e)d.style[i]=e[i];d.appendChild(b);e=c||document.documentElement;e.insertBefore(d,e.firstChild);b.style.cssText="position: absolute; left: 10.7432222px; top: 10.432325px; height: 30px; width: 201px;";b=a(b).offset(function(a,b){return b}).offset();d.innerHTML="";e.removeChild(d);c=b.top+b.left+(c?2E3:0);f=c>21&&c<22})()})(jQuery);
(function(a,c){a.widget("ui.progressbar",{options:{value:0,max:100},min:0,_create:function(){this.element.addClass("ui-progressbar ui-widget ui-widget-content ui-corner-all").attr({role:"progressbar","aria-valuemin":this.min,"aria-valuemax":this.options.max,"aria-valuenow":this._value()});this.valueDiv=a("<div class='ui-progressbar-value ui-widget-header ui-corner-left'></div>").appendTo(this.element);this.oldValue=this._value();this._refreshValue()},destroy:function(){this.element.removeClass("ui-progressbar ui-widget ui-widget-content ui-corner-all").removeAttr("role").removeAttr("aria-valuemin").removeAttr("aria-valuemax").removeAttr("aria-valuenow");
this.valueDiv.remove();a.Widget.prototype.destroy.apply(this,arguments)},value:function(a){if(a===c)return this._value();this._setOption("value",a);return this},_setOption:function(c,f){"value"===c&&(this.options.value=f,this._refreshValue(),this._value()===this.options.max&&this._trigger("complete"));a.Widget.prototype._setOption.apply(this,arguments)},_value:function(){var a=this.options.value;"number"!==typeof a&&(a=0);return Math.min(this.options.max,Math.max(this.min,a))},_percentage:function(){return 100*
...
(function(a){a.widget("ui.slider",a.ui.mouse,{widgetEventPrefix:"slide",options:{animate:!1,distance:0,max:100,min:0,orientation:"horizontal",range:!1,step:1,value:0,values:null},_create:function(){var c=this,d=this.options,f=this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"),e=d.values&&d.values.length||1,i=[];this._mouseSliding=this._keySliding=!1;this._animateOff=!0;this._handleIndex=null;this._detectOrientation();this._mouseInit();this.element.addClass("ui-slider ui-slider-"+
this.orientation+" ui-widget ui-widget-content ui-corner-all"+(d.disabled?" ui-slider-disabled ui-disabled":""));this.range=a([]);if(d.range){if(!0===d.range&&(d.values||(d.values=[this._valueMin(),this._valueMin()]),d.values.length&&2!==d.values.length))d.values=[d.values[0],d.values[0]];this.range=a("<div></div>").appendTo(this.element).addClass("ui-slider-range ui-widget-header"+("min"===d.range||"max"===d.range?" ui-slider-range-"+d.range:""))}for(var g=f.length;g<e;g+=1)i.push("<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'></a>");
this.handles=f.add(a(i.join("")).appendTo(c.element));this.handle=this.handles.eq(0);this.handles.add(this.range).filter("a").click(function(a){a.preventDefault()}).hover(function(){d.disabled||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}).focus(function(){d.disabled?a(this).blur():(a(".ui-slider .ui-state-focus").removeClass("ui-state-focus"),a(this).addClass("ui-state-focus"))}).blur(function(){a(this).removeClass("ui-state-focus")});this.handles.each(function(b){a(this).data("index.ui-slider-handle",
...
_mouseCapture:function(c){var d=this.options,f,e,i,g,b;if(d.disabled)return!1;this.elementSize={width:this.element.outerWidth(),height:this.element.outerHeight()};this.elementOffset=this.element.offset();f=this._normValueFromMouse({x:c.pageX,y:c.pageY});e=this._valueMax()-this._valueMin()+1;g=this;this.handles.each(function(c){var d=Math.abs(f-g.values(c));e>d&&(e=d,i=a(this),b=c)});!0===d.range&&this.values(1)===d.min&&(b+=1,i=a(this.handles[b]));if(!1===this._start(c,b))return!1;this._mouseSliding=
...
_slide:function(a,d,f){var e;if(this.options.values&&this.options.values.length){e=this.values(d?0:1);if(2===this.options.values.length&&!0===this.options.range&&(0===d&&f>e||1===d&&f<e))f=e;f!==this.values(d)&&(e=this.values(),e[d]=f,a=this._trigger("slide",a,{handle:this.handles[d],value:f,values:e}),this.values(d?0:1),!1!==a&&this.values(d,f,!0))}else f!==this.value()&&(a=this._trigger("slide",a,{handle:this.handles[d],value:f}),!1!==a&&this.value(f))},_stop:function(a,d){var f={handle:this.handles[d],
...
0);else return this._value()},values:function(c,d){var f,e,i;if(1<arguments.length)this.options.values[c]=this._trimAlignValue(d),this._refreshValue(),this._change(null,c);else if(arguments.length)if(a.isArray(arguments[0])){f=this.options.values;e=arguments[0];for(i=0;i<f.length;i+=1)f[i]=this._trimAlignValue(e[i]),this._change(null,i);this._refreshValue()}else return this.options.values&&this.options.values.length?this._values(c):this.value();else return this._values()},_setOption:function(c,d){var f,
...
this.orientation);this._refreshValue();break;case "value":this._animateOff=!0;this._refreshValue();this._change(null,0);this._animateOff=!1;break;case "values":this._animateOff=!0;this._refreshValue();for(f=0;f<e;f+=1)this._change(null,f);this._animateOff=!1}},_value:function(){var a=this.options.value;return a=this._trimAlignValue(a)},_values:function(a){var d,f;if(arguments.length)return d=this.options.values[a],d=this._trimAlignValue(d);d=this.options.values.slice();for(f=0;f<d.length;f+=1)d[f]=
this._trimAlignValue(d[f]);return d},_trimAlignValue:function(a){if(a<=this._valueMin())return this._valueMin();if(a>=this._valueMax())return this._valueMax();var d=0<this.options.step?this.options.step:1,f=(a-this._valueMin())%d,a=a-f;2*Math.abs(f)>=d&&(a+=0<f?d:-d);return parseFloat(a.toFixed(5))},_valueMin:function(){return this.options.min},_valueMax:function(){return this.options.max},_refreshValue:function(){var c=this.options.range,d=this.options,f=this,e=!this._animateOff?d.animate:!1,i,g=
{},b,j,l,n;if(this.options.values&&this.options.values.length)this.handles.each(function(c){i=100*((f.values(c)-f._valueMin())/(f._valueMax()-f._valueMin()));g["horizontal"===f.orientation?"left":"bottom"]=i+"%";a(this).stop(1,1)[e?"animate":"css"](g,d.animate);if(!0===f.options.range)if("horizontal"===f.orientation){if(0===c)f.range.stop(1,1)[e?"animate":"css"]({left:i+"%"},d.animate);if(1===c)f.range[e?"animate":"css"]({width:i-b+"%"},{queue:!1,duration:d.animate})}else{if(0===c)f.range.stop(1,
1)[e?"animate":"css"]({bottom:i+"%"},d.animate);if(1===c)f.range[e?"animate":"css"]({height:i-b+"%"},{queue:!1,duration:d.animate})}b=i});else{j=this.value();l=this._valueMin();n=this._valueMax();i=n!==l?100*((j-l)/(n-l)):0;g["horizontal"===f.orientation?"left":"bottom"]=i+"%";this.handle.stop(1,1)[e?"animate":"css"](g,d.animate);if("min"===c&&"horizontal"===this.orientation)this.range.stop(1,1)[e?"animate":"css"]({width:i+"%"},d.animate);if("max"===c&&"horizontal"===this.orientation)this.range[e?
"animate":"css"]({width:100-i+"%"},{queue:!1,duration:d.animate});if("min"===c&&"vertical"===this.orientation)this.range.stop(1,1)[e?"animate":"css"]({height:i+"%"},d.animate);if("max"===c&&"vertical"===this.orientation)this.range[e?"animate":"css"]({height:100-i+"%"},{queue:!1,duration:d.animate})}}});a.extend(a.ui.slider,{version:"1.8.20"})})(jQuery);
(function(a,c){var d=0,f=0;a.widget("ui.tabs",{options:{add:null,ajaxOptions:null,cache:!1,cookie:null,collapsible:!1,disable:null,disabled:[],enable:null,event:"click",fx:null,idPrefix:"ui-tabs-",load:null,panelTemplate:"<div></div>",remove:null,select:null,show:null,spinner:"<em>Loading&#8230;</em>",tabTemplate:"<li><a href='#{href}'><span>#{label}</span></a></li>"},_create:function(){this._tabify(!0)},_setOption:function(a,c){"selected"==a?this.options.collapsible&&c==this.options.selected||this.select(c):
(this.options[a]=c,this._tabify())},_tabId:function(a){return a.title&&a.title.replace(/\s/g,"_").replace(/[^\w\u00c0-\uFFFF-]/g,"")||this.options.idPrefix+ ++d},_sanitizeSelector:function(a){return a.replace(/:/g,"\\:")},_cookie:function(){var c=this.cookie||(this.cookie=this.options.cookie.name||"ui-tabs-"+ ++f);return a.cookie.apply(null,[c].concat(a.makeArray(arguments)))},_ui:function(a,c){return{tab:a,panel:c,index:this.anchors.index(a)}},_cleanup:function(){this.lis.filter(".ui-state-processing").removeClass("ui-state-processing").find("span:data(label.tabs)").each(function(){var c=
...
this.element[b.collapsible?"addClass":"removeClass"]("ui-tabs-collapsible");b.cookie&&this._cookie(b.selected,b.cookie);for(var d=0,l;l=this.lis[d];d++)a(l)[-1!=a.inArray(d,b.disabled)&&!a(l).hasClass("ui-tabs-selected")?"addClass":"removeClass"]("ui-state-disabled");!1===b.cache&&this.anchors.removeData("cache.tabs");this.lis.add(this.anchors).unbind(".tabs");if("mouseover"!==b.event){var n=function(a,b){b.is(":not(.ui-state-disabled)")&&b.addClass("ui-state-"+a)};this.lis.bind("mouseover.tabs",
function(){n("hover",a(this))});this.lis.bind("mouseout.tabs",function(){a(this).removeClass("ui-state-hover")});this.anchors.bind("focus.tabs",function(){n("focus",a(this).closest("li"))});this.anchors.bind("blur.tabs",function(){a(this).closest("li").removeClass("ui-state-focus")})}var o,m;b.fx&&(a.isArray(b.fx)?(o=b.fx[0],m=b.fx[1]):o=m=b.fx);var p=m?function(b,c){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");c.hide().removeClass("ui-tabs-hide").animate(m,m.duration||"normal",
function(){f(c,m);g._trigger("show",null,g._ui(b,c[0]))})}:function(b,c){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");c.removeClass("ui-tabs-hide");g._trigger("show",null,g._ui(b,c[0]))},r=o?function(a,b){b.animate(o,o.duration||"normal",function(){g.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");f(b,o);g.element.dequeue("tabs")})}:function(a,b){g.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");g.element.dequeue("tabs")};
...
-1;b.cookie&&g._cookie(b.selected,b.cookie);g.element.queue("tabs",function(){r(c,e)}).dequeue("tabs");this.blur();return false}if(!e.length){b.cookie&&g._cookie(b.selected,b.cookie);g.element.queue("tabs",function(){p(c,f)});g.load(g.anchors.index(this));this.blur();return false}}b.cookie&&g._cookie(b.selected,b.cookie);if(f.length){e.length&&g.element.queue("tabs",function(){r(c,e)});g.element.queue("tabs",function(){p(c,f)});g.load(g.anchors.index(this))}else throw"jQuery UI Tabs: Mismatching fragment identifier.";
...
".tabs");return this},load:function(c){var c=this._getIndex(c),d=this,f=this.options,b=this.anchors.eq(c)[0],j=a.data(b,"load.tabs");this.abort();if(!j||0!==this.element.queue("tabs").length&&a.data(b,"cache.tabs"))this.element.dequeue("tabs");else{this.lis.eq(c).addClass("ui-state-processing");if(f.spinner){var l=a("span",b);l.data("label.tabs",l.html()).html(f.spinner)}this.xhr=a.ajax(a.extend({},f.ajaxOptions,{url:j,success:function(j,l){d.element.find(d._sanitizeSelector(b.hash)).html(j);d._cleanup();
f.cache&&a.data(b,"cache.tabs",!0);d._trigger("load",null,d._ui(d.anchors[c],d.panels[c]));try{f.ajaxOptions.success(j,l)}catch(m){}},error:function(a,j){d._cleanup();d._trigger("load",null,d._ui(d.anchors[c],d.panels[c]));try{f.ajaxOptions.error(a,j,c,b)}catch(l){}}}));d.element.dequeue("tabs");return this}},abort:function(){this.element.queue([]);this.panels.stop(!1,!0);this.element.queue("tabs",this.element.queue("tabs").splice(-2,2));this.xhr&&(this.xhr.abort(),delete this.xhr);this._cleanup();
...
d.rotate(null)}:function(){f()});a?(this.element.bind("tabsshow",f),this.anchors.bind(b.event+".tabs",l),f()):(clearTimeout(d.rotation),this.element.unbind("tabsshow",f),this.anchors.unbind(b.event+".tabs",l),delete this._rotate,delete this._unrotate);return this}})})(jQuery);
(function(a){function c(c){if("string"===typeof c.data){var f=c.handler,e=c.data.toLowerCase().split(" ");c.handler=function(c){if(!(this!==c.target&&(/textarea|select/i.test(c.target.nodeName)||"text"===c.target.type))){var d="keypress"!==c.type&&a.hotkeys.specialKeys[c.which],b=String.fromCharCode(c.which).toLowerCase(),j="",l={};c.altKey&&"alt"!==d&&(j+="alt+");c.ctrlKey&&"ctrl"!==d&&(j+="ctrl+");c.metaKey&&!c.ctrlKey&&"meta"!==d&&(j+="meta+");c.shiftKey&&"shift"!==d&&(j+="shift+");d?l[j+d]=!0:
(l[j+b]=!0,l[j+a.hotkeys.shiftNums[b]]=!0,"shift+"===j&&(l[a.hotkeys.shiftNums[b]]=!0));d=0;for(b=e.length;d<b;d++)if(l[e[d]])return f.apply(this,arguments)}}}}a.hotkeys={version:"0.8",specialKeys:{8:"backspace",9:"tab",13:"return",16:"shift",17:"ctrl",18:"alt",19:"pause",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"insert",46:"del",96:"0",97:"1",98:"2",99:"3",100:"4",101:"5",102:"6",103:"7",104:"8",105:"9",106:"*",107:"+",
...
(function(a){a.fn.raptorize=function(c){c=a.extend({enterOn:"click",delayTime:5E3},c);return this.each(function(){function d(){i=!0;e&&document.getElementById("elRaptorShriek").play();g.animate({bottom:"0"},function(){a(this).animate({bottom:"-30px"},100,function(){var b=a(this).position().left+400;a(this).delay(300).animate({right:b},2200,function(){g=a("#elRaptor").css({bottom:"-700px",right:"0"});i=!1})})})}var f=a(this),e=!1;if(a.browser.mozilla&&"1.9.2"<=a.browser.version.substr(0,5)||a.browser.webkit)e=
...
(function(a,c,d,f){function e(a,b,c){W[a]=c;ba[a]=b;G||(G=a)}function i(b){G!==b&&(G=b,a.ui.editor.eachInstance(function(){this.reinit()}))}function g(a,b){G&&W[G]&&W[G][a]&&(a=W[G][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function b(b){if(V===f){V=!0;if(O=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(b.options.baseClass+"-ios"),O&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height",
"-=1")},0)});a.browser.mozilla&&a("html").addClass(b.options.baseClass+"-ff");if(a.browser.msie&&9>a.browser.version){V=!1;var c=a("<div/>").addClass(b.options.baseClass+"-unsupported").html(b.getTemplate("unsupported")).appendTo("body");j(c);c.find("."+b.options.baseClass+"-unsupported-close").click(function(){c.remove()})}}return V}function j(b){var c=1;b.siblings().each(function(){var b=a(this).css("z-index");!isNaN(b)&&b>c&&(c=b+1)});b.css("z-index",c)}function l(a){return a.clone().wrap("<div/>").parent().html()}
function n(a){var b,a=document.createElement(a);b="getComputedStyle"in c;document.body.appendChild(a);b=(b?c.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return b}function o(b,c){return-1!==a.inArray(a(b)[0].tagName.toLowerCase(),c)}function m(a){for(var b={},a=c.getComputedStyle(a[0],null),d=0;d<a.length;d++)b[a.item(d)]=a.getPropertyValue(a.item(d));return b}function p(b,c){for(var d="",e=0,f=b.childNodes.length;e<f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?
g.nodeValue:l(a(g)))&&(d+=g)}c&&(d=a("<"+c+">"+d+"</"+c+">"),d.find("p").wrapInner("<"+c+"/>"),d.find("p > *").unwrap(),d=a("<div/>").html(d).html());return d}function r(b,c){var d=a("<div/>").append(b)[0].childNodes;c.deleteContents();d.length===f||1===d.length?c.insertNode(d[0].cloneNode(!0)):a.each(d,function(a,b){c.insertNodeAtEnd(b.cloneNode(!0))})}function q(b){var b=b||d.getSelection(),c;a(b.getAllRanges()).each(function(b,d){c=3===this.commonAncestorContainer.nodeType?a(d.commonAncestorContainer).parent()[0]:
d.commonAncestorContainer});return c}function s(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer}function y(a){if(!T||a)T=d.saveSelection()}function v(){T&&(d.restoreSelection(T),T=!1)}function z(){T&&d.removeMarkers(T);T=!1}function B(a,b,c){for(var b=b||d.getSelection(),e,f=0;e=b.getAllRanges()[f++];)a.call(c,e)}function x(a,b){B(function(b){r(a,b)},b,this)}function D(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).focus().contents().each(function(){var a=d.createRange();
a.selectNodeContents(this);c.addRange(a)})}function F(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNode(this);c.addRange(a)}).focus()}function L(b,c,e){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNodeContents(this);a.collapse(e);c.addRange(a)})}function E(a,b){L(a,b,!1)}function w(a,b){L(a,b,!0)}function P(a){a=a||d.getSelection();return a.toHtml()}function S(b){b=b||d.getSelection().getRangeAt(0);
return a(3===b.commonAncestorContainer.nodeType?b.commonAncestorContainer.parentNode:b.commonAncestorContainer)}function h(a){var b=new jQuery;B(function(a){b.push(S(a)[0])},a,this);return b}function U(){var b=d.getSelection();if(null===b.anchorNode)return null;if(b.isBackwards())return 3===b.focusNode.nodeType?a(b.focusNode.parentElement):a(b.focusNode);b.anchorNode||console.trace();return 3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode)}function R(){var b=d.getSelection();
return null===b.anchorNode?null:b.isBackwards()?3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode):3===b.focusNode.nodeType?a(b.focusNode.parentElement):a(b.focusNode)}function Q(b,c){var c=c||{},e=d.createCssClassApplier(c.classes||"",{normalize:!0,elementTagName:b,elementProperties:c.attributes||{}});B(function(d){var f=d.cloneContents(),f=p(f);"string"===typeof f&&(f=f.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));a(f).is(":empty")?(f=a("<"+b+"/>").addClass(c.classes).attr(c.attributes||
{}).append(p(d.cloneContents())),r(f,d)):e.toggleRange(d)},null,this)}function J(a,b,c){B(function(d){d=S(d);d.is(a)?d.attr(b):Q(a,{classes:c,attributes:b})},null,this)}function t(b,c){var c=c||d.getSelection(),e=c.getRangeAt(0),f=h()[0],g=d.createRange();g.setStartBefore(f);g.setEnd(e.startContainer,e.startOffset);var g=g.cloneContents(),i=d.createRange();i.setStart(e.endContainer,e.endOffset);i.setEndAfter(f);e=i.cloneContents();g=l(a(p(g)));g+=l(a(b));g+=l(a(p(e)));a(f).replaceWith(a(g))}function I(a,
b,c){var c=c||d.getSelection(),e=U()[0],f=R()[0],g=h()[0],g=o(g,b),e=o(e,b),b=o(f,b);g&&e&&b?x(a):t(a,c)}function H(b,c){B(function(d){for(d=a(d.commonAncestorContainer);d.length&&d[0]!==c[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===c[0]&&"inline"!==c.css("display")&&(this.wrapInner(c,"div"),d=c.children().first());this.toggleStyle(d,b)},null,this)}function M(a,b){allowed=[];for(var c=0;c<b.length;c++)b[c].match(/[a-z][a-z0-9]{0,}/g)&&allowed.push(b[c]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,
"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,b){return-1<allowed.indexOf(b.toLowerCase())?a:""})}var G=null,W={},ba={};a(function(){d.initialized||d.init();a.isFunction(d.rangePrototype.insertNodeAtEnd)||(d.rangePrototype.insertNodeAtEnd=function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});a("html").click(function(){a(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});a.widget("ui.editor",{_init:function(){-1===
a.inArray(this,a.ui.editor.instances)&&a.ui.editor.instances.push(this);var c=this;this.options=a.extend({},a.ui.editor.defaults,this.options);this.options.uiOrder=this.options.uiOrder||[["logo"],["save","cancel"],["dock","showGuides","clean"],["viewSource"],["undo","redo"],["alignLeft","alignCenter","alignJustify","alignRight"],["textBold","textItalic","textUnderline","textStrike"],["textSuper","textSub"],["listUnordered","listOrdered"],["hr","quoteBlock"],["fontSizeInc","fontSizeDec"],["colorPickerBasic"],
["clearFormatting"],["link","unlink"],["embed"],["floatLeft","floatNone","floatRight"],["tagMenu"],["i18n"],["raptorize"],["statistics"],["debugReinit","debugDestroy"]];this.element.attr("id")||this.element.attr("id",this.getUniqueId());this.ready=!1;this.events={};this.ui={};this.plugins={};this.templates=a.extend({},a.ui.editor.templates);this.path=this.toolbarWrapper=this.toolbar=this.wrapper=null;this.visible=this.enabled=!1;this.uiObjects={};this.hotkeys={};this.options.enableHotkeys&&this.registerHotkey(this.hotkeys);
for(var d in this.options.bind)this.bind(d,this.options.bind[d]);this.history=[];this.present=0;this.historyEnabled=!0;b(this)&&(this.cloneDomTools(),this.setOriginalHtml(this.element.is(":input")?this.element.val():this.element.html()),this.element.is("textarea, input")&&this.replaceOriginal(),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,this.ready=!0,this.fire("ready"),this.options.autoEnable&&a(function(){c.enableEditing();c.showToolbar()}))},
attach:function(){this.bind("change",this.historyPush);this.bind("selectionChange",this.updateTagTree);this.bind("show",this.updateTagTree);var b=a.proxy(this.checkChange,this);this.getElement().find("img").bind("click."+this.widgetName,a.proxy(function(a){F(a.target)},this));this.getElement().bind("mouseup."+this.widgetName,b);this.getElement().bind("keyup."+this.widgetName,b);a(c).bind("beforeunload",a.proxy(a.ui.editor.unloadWarning,a.ui.editor));var d=this;a(c).resize(function(){d.fire("resize")})},
reinit:function(){if(this.ready){var a=this.enabled,b=this.visible;this.destruct(!0);this._init();a&&this.enableEditing();b&&this.showToolbar()}else{var c;c=function(){this.unbind("ready",c);this.reinit()};this.bind("ready",c)}},getElement:function(){return this.target?this.target:this.element},getOriginalElement:function(){return this.element},replaceOriginal:function(){if(!this.target){for(var b=a("<div/>").html(this.element.is(":input")?this.element.val():this.element.html()).insertBefore(this.element).attr("id",
this.getUniqueId()).addClass(this.element.attr("class")),c=m(this.element),d=0;d<this.options.replaceStyle.length;d++)b.css(this.options.replaceStyle[d],c[this.options.replaceStyle[d]]);this.element.hide();this.bind("change",function(){this.element.is("input, textarea")?this.element.val(this.getHtml()):this.element.html(this.getHtml())});this.target=b}},cloneDomTools:function(){for(var a in this.options.domTools)this[a]||(this[a]=function(a){return function(){this.options.domTools.constrainSelection(this.getElement());
...
destruct:function(a){a||this.hideToolbar();this.disableEditing();this.fire("destroy",!1);this.events={};this.getElement().unbind("."+this.widgetName);this.wrapper&&this.wrapper.remove()},destroy:function(){this.destruct();a.Widget.prototype.destroy.call(this)},persist:function(b,c){return!this.options.persistence?null:a.ui.editor.persist(b,c,this.options.namespace)},enableEditing:function(){this.isToolbarLoaded()||this.loadToolbar();this.enabled||(this.enabled=!0,this.getElement().addClass(this.options.baseClass+
"-editing"),this.options.partialEdit?this.getElement().find(this.options.partialEdit).attr("contenteditable",!0):this.getElement().attr("contenteditable",!0),this.execCommand("enableInlineTableEditing",!1,!1),this.execCommand("styleWithCSS",!0,!0),this.bindHotkeys(),this.fire("enabled"),this.fire("resize"))},disableEditing:function(){this.enabled&&(this.enabled=!1,this.getElement().attr("contenteditable",!1).removeClass(this.options.baseClass+"-editing"),d.getSelection().removeAllRanges(),this.fire("disabled"))},
isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var b=this,c="",d=[],e=0;B(function(f){var f=f.commonAncestorContainer,g;g=3===f.nodeType?a(f).parent():a(f);f=[];for(d.push(f);g[0]&&!b.isRoot(g)&&"body"!==g[0].tagName.toLowerCase();)f.push(g),g=g.parent();f.reverse();c&&(c+=" | ");c+=this.getTemplate("root");for(g=0;g<f.length;g++)c+=this.getTemplate("tag",{element:f[g][0].tagName.toLowerCase(),data:"["+e+","+g+"]"});e++},null,this);c||(c=this.getTemplate("root"));
this.path.html(c).find("a").click(function(){var c=a(this).data("ui-editor-selection");c?(F(d[c[0]][c[1]]),b.updateTagTree()):F(b.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(b){return this.getElement()[0]===a(b)[0]},unify:function(b,c){!1!==c&&b(this);if(this.options.unify){var d=this;a.ui.editor.eachInstance(function(a){a!==d&&a.options.unify&&b(a)})}},getUniqueId:function(){return a.ui.editor.getUniqueId()},loadMessages:function(){this.messages=a(this.getTemplate("messages")).appendTo(this.wrapper)},
showMessage:function(b,d,e){var e=a.extend({},this.options.message,e),f;f={timer:null,editor:this,show:function(){this.element.slideDown();this.timer=c.setTimeout(function(){this.timer=null;f.hide()},e.delay,this)},hide:function(){this.timer&&(c.clearTimeout(this.timer),this.timer=null);this.element.stop().slideUp(a.proxy(function(){a.isFunction(e.hide)&&e.hide.call(this);this.element.remove()},this))}};f.element=a(this.getTemplate("message",{type:b,message:d})).hide().appendTo(this.messages).find(".ui-editor-message-close").click(function(){f.hide()}).end();
f.show();return f},showLoading:function(a,b){return this.showMessage("clock",a,b)},showInfo:function(a,b){return this.showMessage("info",a,b)},showError:function(a,b){return this.showMessage("circle-close",a,b)},showConfirm:function(a,b){return this.showMessage("circle-check",a,b)},showWarning:function(a,b){return this.showMessage("alert",a,b)},loadToolbar:function(){var b=this.toolbar=a("<div/>").addClass(this.options.baseClass+"-toolbar"),b=this.toolbarWrapper=a("<div/>").addClass(this.options.baseClass+
"-toolbar-wrapper").addClass("ui-widget-content").append(b),d=this.path=a("<div/>").addClass(this.options.baseClass+"-path").addClass("ui-widget-header").html(this.getTemplate("root")),e=this.wrapper=a("<div/>").addClass(this.options.baseClass+"-wrapper").css("display","none").append(d).append(b);a.fn.draggable&&this.options.draggable&&(e.draggable({cancel:"a, button",cursor:"move",handle:".ui-editor-path",stop:a.proxy(function(){var a=this.persist("position",[e.css("top"),e.css("left")]);e.css({top:Math.abs(a[0]),
left:Math.abs(a[1])})},this)}),e.css("position",""),(b=this.persist("position")||this.options.dialogPosition)||(b=[10,10]),parseInt(b[0],10)+e.outerHeight()>a(c).height()&&(b[0]=a(c).height()-e.outerHeight()),parseInt(b[1],10)+e.outerWidth()>a(c).width()&&(b[1]=a(c).width()-e.outerWidth()),e.css({top:Math.abs(parseInt(b[0],10)),left:Math.abs(parseInt(b[1],10))}),this.loadMessages());a(function(){e.appendTo("body")});this.loadUi()},isToolbarLoaded:function(){return null!==this.wrapper},showToolbar:function(b){this.isToolbarLoaded()||
this.loadToolbar();if(!this.visible){this.options.unify&&this.hideOtherToolbars(!0);this.visible=!0;this.wrapper.css("display","");this.fire("resize");"undefined"===typeof this.getElement().attr("tabindex")&&this.getElement().attr("tabindex",-1);if(b)if(b.select)b.select();else{var d=c.getSelection();d.removeAllRanges();d.addRange(b)}var e=this;a(function(){e.fire("show");e.element.is("textarea, input")||e.getElement().focus()})}},hideToolbar:function(){this.visible&&(this.visible=!1,this.wrapper.hide(),
this.element.is("textarea, input")&&this.element.show(),this.fire("hide"),this.fire("resize"))},hideOtherToolbars:function(){this.unify(function(a){a.hideToolbar()},!1)},isVisible:function(){return this.visible},getTemplate:function(b,c){var d;d=this.templates[b]?this.templates[b]:a.ui.editor.getTemplate(b,this.options.urlPrefix);d=d.replace(/_\(['"]{1}(.*?)['"]{1}\)/g,function(a,b){b=b.replace(/\\(.?)/g,function(a,b){switch(b){case "\\":return"\\";case "0":return"\x00";case "":return"";default:return b}});
return g(b)});c=a.extend({},this.options,c||{});c=this.getTemplateVars(c);return d=d.replace(/\{\{(.*?)\}\}/g,function(a,b){return c[b]})},getTemplateVars:function(a,b,c){b=b?b+".":"";c||(c=1);var d={},e;for(e in a)if("object"===typeof a[e]&&5>c){var f=this.getTemplateVars(a[e],b+e,++c),g;for(g in f)d[g]=f[g]}else d[b+e]=a[e];return d},historyPush:function(){this.historyEnabled&&this.getHtml()!==this.historyPeak()&&(this.present!==this.history.length-1&&(this.history=this.history.splice(0,this.present+
1)),this.history.push(this.getHtml()),this.present=this.history.length-1)},historyPeak:function(){return!this.history.length?null:this.history[this.present]},historyBack:function(){0<this.present&&(this.present--,this.setHtml(this.history[this.present]),this.historyEnabled=!1,this.change(),this.historyEnabled=!0)},historyForward:function(){this.present<this.history.length-1&&(this.present++,this.setHtml(this.history[this.present]),this.historyEnabled=!1,this.change(),this.historyEnabled=!0)},registerHotkey:function(b,
c,d){if("string"===typeof b)this.hotkeys[b]=a.extend({},{context:d,restoreSelection:!0},c);else for(var e in b)this.registerHotkey(e,b[e],d)},bindHotkeys:function(){for(var a in this.hotkeys){var b=this,c=this.hotkeys[a].force||!1;(this.options.enableHotkeys||c)&&this.getElement().bind("keydown."+this.widgetName,a,function(a){y();var c=b.hotkeys[a.data];!0!==c.action.call(c.context)&&a.preventDefault();c.restoreSelection&&v();b.checkChange()})}},uiEnabled:function(b){return!1===this.options.enableUi&&
...
"-ui-"+h},i.options,this.options.ui[d[f]]);i.editor=this;i.options=h;i.ui=i.init(this,h);i.hotkeys&&(this.registerHotkey(i.hotkeys,null,i),i.ui.title+=" ("+a.map(i.hotkeys,function(a,b){return b})[0]+")");i.ui.init(d[f],this,h,i).appendTo(e);this.uiObjects[d[f]]=i}}e.addClass("ui-buttonset").addClass(this.options.baseClass+"-buttonset");0<e.children().length&&e.appendTo(this.toolbar)}a("<div/>").css("clear","both").appendTo(this.toolbar)},uiButton:function(b){return a.extend({button:null,options:{},
init:function(b,c,d,e){var f=b.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),d=a.extend({},c.options,{baseClass:c.options.baseClass+"-"+f+"-button"},this.options,c.options.ui[b]);this.title||(this.title=g("Unnamed Button"));this.button=a("<div/>").html(this.label||this.title).addClass(d.baseClass).attr("name",b).attr("title",this.title).val(b);d.classes&&this.button.addClass(d.classes);this.button.bind("mousedown."+e.editor.widgetName,function(a){a.preventDefault()});var k=this;this.button.bind("mouseup."+
e.editor.widgetName,function(a){a.preventDefault();k.click.apply(e,arguments);c.checkChange()});c.bind("destroy",a.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+f},disabled:d.disabled?!0:!1,text:this.text||!1,label:this.label||null});this.ready.call(e);return this.button},disable:function(){this.button.button("option","disabled",!0)},enable:function(){this.button.button("option","disabled",!1)},ready:function(){},click:function(){}},
b)},uiSelectMenu:function(b){return a.extend({select:null,selectMenu:null,button:null,menu:null,options:{},init:function(b,c){var d=this;d.select.attr("disabled","disabled");var e=b.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});a.extend({},c.options,{baseClass:c.options.baseClass+e+"-select-menu"},d.options,c.options.ui[b]);d.title||(d.title=g("Unnamed Select Menu"));d.wrapper=a('<div class="ui-editor-selectmenu-wrapper"/>').append(d.select.hide()).addClass(d.select.attr("class"));d.selectMenu=
a('<div class="ui-editor-selectmenu"/>').appendTo(d.wrapper);d.menu=a('<div class="ui-editor-selectmenu-menu ui-widget-content ui-corner-bottom ui-corner-tr"/>').appendTo(d.wrapper);d.select.find("option, .ui-editor-selectmenu-option").each(function(){a("<div/>").addClass("ui-editor-selectmenu-menu-item").addClass("ui-corner-all").html(a(this).html()).appendTo(d.menu).bind("mouseenter."+c.widgetName,function(){a(this).addClass("ui-state-focus")}).bind("mouseleave."+c.widgetName,function(){a(this).removeClass("ui-state-focus")}).bind("mousedown."+
c.widgetName,function(){return false}).bind("click."+c.widgetName,function(){var b=d.select.find("option, .ui-editor-selectmenu-option").eq(a(this).index()),b=b.attr("value")||b.val();d.select.val(b);d.update();d.wrapper.removeClass("ui-editor-selectmenu-visible");d.button.addClass("ui-corner-all").removeClass("ui-corner-top");d.change(b);return false})});var e=a("<div/>").addClass("ui-editor-selectmenu-text"),f=a("<div/>").addClass("ui-icon ui-icon-triangle-1-s");d.button=a("<div/>").addClass("ui-editor-selectmenu-button ui-editor-selectmenu-button ui-button ui-state-default").attr("title",
d.title).append(e).append(f).prependTo(d.selectMenu);d.button.bind("mousedown."+c.widgetName,function(){return false}).bind("click."+c.widgetName,function(){if(!a(this).hasClass("ui-state-disabled")){parseInt(d.menu.css("min-width"),10)<d.button.outerWidth()+10&&d.menu.css("min-width",d.button.outerWidth()+10);d.wrapper.toggleClass("ui-editor-selectmenu-visible");return false}}).bind("mouseenter."+c.widgetName,function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover",a(this).hasClass("ui-state-disabled"))}).bind("mouseleave."+
c.widgetName,function(){a(this).removeClass("ui-state-hover")});e=d.select.find("option[value="+this.select.val()+"], .ui-editor-selectmenu-option[value="+this.select.val()+"]").html()||d.select.find("option, .ui-editor-selectmenu-option").first().html();d.button.find(".ui-editor-selectmenu-text").html(e);return d.wrapper},update:function(){var a=this.select.find("option[value="+this.select.val()+"], .ui-editor-selectmenu-option[value="+this.select.val()+"]").html();this.button.find(".ui-editor-selectmenu-text").html(a)},
...
a.toLowerCase()}),d=a.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-"+d},c.options,this.options.plugins[b]);c.editor=this;c.options=d;c.init(this,d);c.hotkeys&&this.registerHotkey(c.hotkeys,null,c);this.plugins[b]=c}},isDirty:function(){return this.dirty},getHtml:function(){var b=this.getElement().html(),b=a("<div/>").html(b);b.find(".rangySelectionBoundary").remove();return b=b.html()},getCleanHtml:function(){this.fire("clean");var b=this.getElement().html();this.fire("restore");
b=a("<div/>").html(b);b.find(".rangySelectionBoundary").remove();return b=b.html()},setHtml:function(a){this.getElement().html(a);this.fire("html");this.change()},resetHtml:function(){this.setHtml(this.getOriginalHtml());this.fire("cleaned")},getOriginalHtml:function(){return this.originalHtml},save:function(){var a=this.getCleanHtml();this.fire("save");this.setOriginalHtml(a);this.fire("saved");this.fire("cleaned");return a},setOriginalHtml:function(a){this.originalHtml=a},bind:function(b,c,d){var e=
this.events;a.each(b.split(","),function(b,f){f=a.trim(f);e[f]||(e[f]=[]);e[f].push({context:d,callback:c})})},unbind:function(a,b,c){for(var d=0,e=this.events[a].length;d<e;d++)this.events[a][d]&&this.events[a][d].callback===b&&this.events[a][d].context===c&&this.events[a].splice(d,1)},fire:function(b,c,d){d||this.fire("before:"+b,c,!0);if(this.events[b])for(var e=0,f=this.events[b].length;e<f;e++){var g=this.events[b][e];"undefined"!==typeof g.callback&&g.callback.call(g.context||this)}!1!==c&&
a.ui.editor.fire(b);d||this.fire("after:"+b,c,!0)}});a.extend(a.ui.editor,{elementRemoveComments:function(b){b.contents().each(function(){8==this.nodeType&&a(this).remove()});b.children().each(function(){element.removeComments(a(this))});return b},elementRemoveAttributes:function(b,c){b.children().each(function(){var b=a.map(this.attributes,function(b){if(-1===a.inArray(b.name,c))return b.name}),d=a(this);a.each(b,function(a,b){d.removeAttr(b)});element.removeAttributes(a(this),c)});return b},elementBringToTop:j,
elementOuterHtml:l,elementOuterText:function(a){return a.clone().wrap("<div/>").parent().text()},elementIsBlock:function(a){return"block"===n(a.tagName)},elementDefaultDisplay:n,elementIsValid:o,elementGetStyles:m,fragmentToHtml:p,fragmentInsertBefore:function(b,c,d){for(var e=0,f=b.childNodes.length;e<f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?g.nodeValue:a(g).html())&&a("<"+d+"/>").html(a.trim(g)).insertBefore(c)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},
rangeGetCommonAncestor:q,rangeIsEmpty:s,selectionSave:y,selectionRestore:v,selectionDestroy:z,selectionEachRange:B,selectionReplace:x,selectionSelectInner:D,selectionSelectOuter:F,selectionSelectEdge:L,selectionSelectEnd:E,selectionSelectStart:w,selectionGetHtml:P,selectionGetElements:h,selectionToggleWrapper:Q,selectionExists:function(a){var b=!1;B(function(a){s(a)||(b=!0)},a,this);return b},selectionReplaceSplittingSelectedElement:t,selectionReplaceWithinValidTags:I,selectionToggleBlockStyle:H,
stringStripTags:M,defaults:{plugins:{},ui:{},bind:{},domTools:{constrainSelection:function(b,c){var b=a(b)[0],c=c||d.getSelection(),e;a(c.getAllRanges()).each(function(d,f){e=3===this.commonAncestorContainer.nodeType?a(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;b!==e&&!a.contains(b,e)&&c.removeRange(f)})},unwrapParentTag:function(b){h().each(function(){a(this).is(b)&&a(this).replaceWith(a(this).html())})},execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(d){}},
insertTag:function(b,c){B(function(c){c.insertNode(a("<"+b+"/>")[0])},c,this)},insertTagAtEnd:function(b,c){B(function(c){c.insertNodeAtEnd(a("<"+b+"/>")[0])},c,this)},insertElement:function(b,c,d){B(function(d){a(b).each(function(){d.insertNode(!1===c?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(b,c,d){B(function(d){a(b).each(function(){d.insertNodeAtEnd(!1===c?this:this.cloneNode(!0))})},d,this)},wrapInner:function(b,c){y();a(b).each(function(){var d=a("<"+c+"/>").html(a(this).html());
b.html(d)});v()},inverseWrapWithTagClass:function(b,c,e,f){y();var g="domTools"+Math.ceil(1E7*Math.random());B(function(a){var b=d.createCssClassApplier(f,{elementTagName:e});b.isAppliedToRange(a)?b.toggleSelection():d.createCssClassApplier(c,{elementTagName:g}).toggleSelection()},null,this);a(g).each(function(){a(this).replaceWith(a("<"+b+"/>").addClass(c).html(a(this).html()))});v()},toggleStyle:function(b,c){a.each(c,function(c,d){a(b).css(c)===d?a(b).css(c,""):a(b).css(c,d)})},swapStyles:function(a,
b,c){for(var d in c)a.css(d,b.css(d)),b.css(d,c[d])}},namespace:null,unify:!0,persistence:!0,persistenceName:"uiEditor",unloadWarning:!0,autoEnable:!1,partialEdit:!1,enablePlugins:!0,disabledPlugins:[],uiOrder:null,enableUi:!0,disabledUi:[],message:{delay:5E3},replaceStyle:"display,position,float,width,padding-left,padding-right,padding-top,padding-bottom,margin-left,margin-right,margin-top,margin-bottom".split(","),baseClass:"ui-editor",cssPrefix:"cms-",draggable:!0,enableHotkeys:!0,hotkeys:{},supplementaryClass:"supplementary-element-class"},
events:{},plugins:{},ui:{},instances:[],getInstances:function(){return this.instances},eachInstance:function(a){for(var b=0;b<this.instances.length;b++)a.call(this.instances[b],this.instances[b])},urlPrefix:"/raptor/",templates:{"paste.dialog":'<div class="ui-editor-paste-panel ui-dialog-content ui-widget-content">\n    <div class="ui-editor-paste-panel-tabs ui-tabs ui-widget ui-widget-content ui-corner-all">\n        <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">\n            <li class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active"><a>_(\'Plain Text\')</a></li>\n            <li class="ui-state-default ui-corner-top"><a>_(\'Formatted &amp; Cleaned\')</a></li>\n            <li class="ui-state-default ui-corner-top"><a>_(\'Formatted Unclean\')</a></li>\n            <li class="ui-state-default ui-corner-top"><a>_(\'Source Code\')</a></li>\n        </ul>\n        <div class="ui-editor-paste-plain-tab">\n            <textarea class="ui-editor-paste-area ui-editor-paste-plain">{{plain}}</textarea>\n        </div>\n        <div class="ui-editor-paste-markup-tab" style="display: none">\n            <div contenteditable="true" class="ui-editor-paste-area ui-editor-paste-markup">{{markup}}</div>\n        </div>\n        <div class="ui-editor-paste-rich-tab" style="display: none">\n            <div contenteditable="true" class="ui-editor-paste-area ui-editor-paste-rich">{{html}}</div>\n        </div>\n        <div class="ui-editor-paste-source-tab" style="display: none">\n            <textarea class="ui-editor-paste-area ui-editor-paste-source">{{html}}</textarea>\n        </div>\n    </div>\n</div>\n',
...
persist:function(a,b,c){a=c?c+"."+a:a;if(localStorage){c=localStorage.uiWidgetEditor?JSON.parse(localStorage.uiWidgetEditor):{};if(b===f)return c[a];c[a]=b;localStorage.uiWidgetEditor=JSON.stringify(c)}return b}});var V,O;a.ui.editor.registerUi({alignLeft:{init:function(a){return a.uiButton({title:g("Left Align"),click:function(){H({"text-align":"left"},a.getElement())}})}},alignJustify:{init:function(a){return a.uiButton({title:g("Justify"),click:function(){H({"text-align":"justify"},a.getElement())}})}},
alignCenter:{init:function(a){return a.uiButton({title:g("Center Align"),click:function(){H({"text-align":"center"},a.getElement())}})}},alignRight:{init:function(a){return a.uiButton({title:g("Right Align"),click:function(){H({"text-align":"right"},a.getElement())}})}}});a.ui.editor.registerUi({textBold:{hotkeys:{"ctrl+b":{action:function(){this.ui.click()}}},init:function(a,b){return this.editor.uiButton({title:g("Bold"),click:function(){Q("strong",{classes:b.classes||b.cssPrefix+"bold"})}})}},
textItalic:{hotkeys:{"ctrl+i":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:g("Italic"),click:function(){Q("em",{classes:b.classes||b.cssPrefix+"italic"})}})}},textUnderline:{hotkeys:{"ctrl+u":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:g("Underline"),click:function(){Q("u",{classes:b.classes||b.cssPrefix+"underline"})}})}},textStrike:{hotkeys:{"ctrl+k":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:g("Strikethrough"),
click:function(){Q("del",{classes:b.classes||b.cssPrefix+"strike"})}})}},textSub:{init:function(a,b){return a.uiButton({title:g("Sub script"),click:function(){Q("sub",{classes:b.classes||b.cssPrefix+"sub"})}})}},textSuper:{init:function(a,b){return a.uiButton({title:g("Super script"),click:function(){Q("sup",{classes:b.classes||b.cssPrefix+"super"})}})}}});a.ui.editor.registerUi({quoteBlock:{init:function(a,b){return a.uiButton({title:g("Blockquote"),icon:"ui-icon-quote",click:function(){Q("blockquote",
{classes:b.classes||b.cssPrefix+"blockquote"})}})}}});a.ui.editor.registerUi({cancel:{hotkeys:{esc:{action:function(){this.confirm()}}},init:function(a){return a.uiButton({name:"cancel",title:g("Cancel"),icons:{primary:"ui-icon-cancel"},dialog:null,click:function(){this.confirm()}})},confirm:function(){var b=this.editor.getPlugin("cancel"),c=this.editor;c.isDirty()?(this.dialog||(this.dialog=a(c.getTemplate("cancel.dialog"))),this.dialog.dialog({modal:!0,resizable:!1,title:g("Confirm Cancel Editing"),
dialogClass:c.options.dialogClass+" "+c.options.baseClass,show:c.options.dialogShowAnimation,hide:c.options.dialogHideAnimation,buttons:[{text:g("OK"),click:function(){b.cancel();a(this).dialog("close")}},{text:g("Cancel"),click:function(){a(this).dialog("close")}}],open:function(){var b=a(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){a(this).dialog("destroy").remove()}})):
...
this.ui.enable()}}});a.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:g("Insert Horizontal Rule"),click:function(){x("<hr/>")}})}}});a.ui.editor.registerUi({i18n:{init:function(b){var c=this,d=this.persist("locale");d&&i(d);var d=a('<select autocomplete="off" name="i18n"/>'),e;for(e in W){var f=a('<option value="'+e+'" class="'+e+'"/>');f.html(ba[e]);G===e&&f.attr("selected","selected");d.append(f)}return b.uiSelectMenu({title:g("Change Language"),select:d,change:function(a){i(c.persist("locale",
a))}})}}});e("de","Deutsch",{"A preview of your embedded object is displayed below.":"Eine Vorschau ihres eingebundenen Objekts wird unterhalb angezeigt.","Added link: {{link}}":"Link hinzugef\u00fcgt: {{link}}","All changes will be lost!":"Alle \u00c4nderungen gehen verloren!","Apply Source":"Quellcode anwenden","Are you sure you want to stop editing?":"Wollen Sie wirklich mit der Bearbeitung aufh\u00f6ren?",Blockquote:"Zitat",Bold:"Fett",Cancel:"Abbrechen","Center Align":"Zentrieren","Change HTML tag of selected element":"HTML Tag des selektierten Elements \u00e4ndern",
...
"Click to begin editing":"Zum Bearbeiten klicken","Click to detach the toolbar":"Zum L\u00f6sen der Werkzeugleiste klicken","Click to dock the toolbar":"Zum Befestigen der Werkzeugleiste klicken","Click to edit the image":"Um das Bild zu bearbeiten klicken","Click to select all editable content":"Um alle bearbeitbaren Elemente zu selektieren klicken","Click to select the contents of the '{{element}}' element":"Um den Inhalt des '{{element}}' Element zu selektieren klicken",Close:"Schliessen","Confirm Cancel Editing":"Bearbeitung abbrechen best\u00e4tigen",
"Content Statistics":"Inhaltsstatistik","Content contains more than {{limit}} characters and may be truncated":"Der Inhalt hat mehr als {{limit}} Zeichen und kann gek\u00fcrzt werden","Content will not be truncated":"Der Inhalt wird nicht gek\u00fcrzt","Copy the file's URL from your browser's address bar and paste it into the box above":"Kopieren Sie die URL der Datei von der Adressleiste ihres Browser und f\u00fcgen Sie diese in der Box oberhalb ein","Copy the web address from your browser's address bar and paste it into the box above":"Kopieren Sie die Web Adresse von der Adressleiste ihres Browser und f\u00fcgen Sie diese in der Box oberhalb ein",
...
"Enter subject":"Betreff eingeben","Enter your URL":"Ihre URL eingeben","Failed to save {{failed}} content block(s).":"{{failed}} Inhaltsbl\u00f6cke konnten nicht gespeichert werden.","Find the page on the web you want to link to":"Finden Sie die Seite im Web welche Sie verlinken wollen","Float Image Left":"Bild nach links stellen","Float Image Right":"Bild nach rechts stellen","Formatted &amp; Cleaned":"Formatiert &amp; Bereinigt","Formatted Unclean":"Formatiert &amp; Unbereinigt","Heading&nbsp;1":"Titel&nbsp;1",
"Heading&nbsp;2":"Titel&nbsp;2","Heading&nbsp;3":"Titel&nbsp;3","Image height":"Bildh\u00f6he","Image width":"Bildbreite","Increase Font Size":"Schriftgr\u00f6sse vergr\u00f6ssern",Initializing:"Initialisieren",Insert:"Einf\u00fcgen","Insert Horizontal Rule":"Horizontale Trennlinie einf\u00fcgen","Insert Link":"Link einf\u00fcgen","Insert Snippet":"Schnipsel einf\u00fcgen",Italic:"Kursiv",Justify:"B\u00fcndig","Learn More About the Raptor WYSIWYG Editor":"Erfahren Sie mehr \u00fcber dem Raptor WYSIWYG Editor",
"Left Align":"Links ausrichten","Link to a document or other file":"Ein Dokument oder eine Datei verlinken","Link to a page on this or another website":"Eine Seite auf dieser oder einer anderen Webseite verlinken","Link to an email address":"Eine E-Mail Adresse verlinken",Location:"Ort","Modify Image Size":"Bildgr\u00f6sse \u00e4ndern","N/A":"k.A.","New window":"Neues Fenster","No changes detected to save...":"Keine \u00c4nderungen zum Speichern erkannt...","Not sure what to put in the box above?":"Nicht sicher was in die Box oberhalb geh\u00f6rt?",
OK:!1,"Open the uploaded file in your browser":"Die hochgeladene Datei in ihrem Browser \u00f6ffnen","Ordered List":"Geordnete Liste","Page on this or another website":"Seite auf dieser oder einer anderen Webseite",Paragraph:"Paragraph","Paste Embed Code":"Quellcode einf\u00fcgen","Paste your embed code into the text area below.":"F\u00fcgen Sie ihren Quellcode zum Einbetten in das Textfeld unterhalb ein.","Plain Text":"Einfacher Text",Preview:"Vorschau",Raptorize:!1,Reinitialise:"Reinitialisieren",
"Remaining characters before the recommended character limit is reached":"Verbleibende Zeichen bis die empfohlene Limite erreicht ist","Remove Image Float":"Bildausrichtung entfernen","Remove Link":"Link entfernen","Remove unnecessary markup from editor content":"Unn\u00f6tige Markierungselemente im Inhalt entfernen","Resize Image":"Bildgr\u00f6sse anpassen","Right Align":"Rechts ausrichten",Save:"Speichern","Saved {{saved}} out of {{dirty}} content blocks.":"{{saved}} von {{dirty}} Inhaltsbl\u00f6cken gespeichert.",
"Saving changes...":"\u00c4nderungen speichern...","Select all editable content":"Alle editierbaren Inhalte ausw\u00e4hlen","Select {{element}} element":"{{element}} Element ausw\u00e4hlen","Show Guides":"Hilfslinien anzeigen","Source Code":"Quelltext","Step Back":"Schritt zur\u00fcck","Step Forward":"Schritt vorw\u00e4rts",Strikethrough:"Durchstreichen","Sub script":"Unterstreichen","Subject (optional)":"Betreff (optional)","Successfully saved {{saved}} content block(s).":"{{saved}} Inhaltsbl\u00f6cke erfolgreich gespeichert.",
"Super script":"Hochstellen","The URL does not look well formed":"Die URL scheint nicht g\u00fcltig zu sein","The email address does not look well formed":"Die E-Mail Adresse scheint nicht g\u00fcltig zu sein","The image '{{image}}' is too wide for the element being edited.<br/>It will be resized to fit.":"Das Bild '{{image}}' ist zu breit f\u00fcr das gerade editierte Element.<br/>Es wird so ge\u00e4ndert, dass es passt.","The url for the file you inserted doesn't look well formed":"Die URL der Datei scheint nicht g\u00fcltig zu sein",
"The url for the link you inserted doesn't look well formed":"Die URL des Links scheint nicht g\u00fcltig zu sein","This block contains unsaved changes":"Dieser Block enth\u00e4lt ungespeicherte \u00c4nderungen",Underline:"Unterstreichen","Unnamed Button":"Knopf ohne Name","Unnamed Select Menu":"Auswahlmenu ohne Name","Unordered List":"Ungeordnete Liste","Update Link":"Link aktualisieren","Updated link: {{link}}":"Link aktualisiert: {{link}}","View / Edit Source":"Quellcode anschauen/editieren","View Source":"Quellcode anschauen",
"\nThere are unsaved changes on this page. \nIf you navigate away from this page you will lose your unsaved changes":"\nEs gibt ungespeicherte \u00c4nderungen auf dieser Seite. \nWenn Sie diese Seite verlassen, werden Sie die ungespeicherten \u00c4nderungen verlieren",root:"","{{charactersRemaining}} characters over limit":"{{charactersRemaining}} Zeichen \u00fcber der Limite","{{charactersRemaining}} characters remaining":"{{charactersRemaining}} Zeichen verbleibend","{{characters}} characters, {{charactersRemaining}} over the recommended limit":"{{characters}} Zeichen, {{charactersRemaining}} \u00fcber der empfohlenen Limite",
"{{characters}} characters, {{charactersRemaining}} remaining":"{{characters}} Zeichen, {{charactersRemaining}} verbleibend","{{sentences}} sentences":"{{sentences}} S\u00e4tze","{{words}} word":"{{words}} Wort","{{words}} words":"{{words}} W\u00f6rter"});e("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"Apply Source",
"Are you sure you want to stop editing?":"Are you sure you want to stop editing?",Blockquote:"Blockquote",Bold:"Bold",Cancel:"Cancel","Center Align":"Center Align","Change HTML tag of selected element":"Change HTML tag of selected element","Change Language":"Change Language","Change the color of the selected text.":"Change the color of the selected text.","Check this box to have the file open in a new browser window":"Check this box to have the file open in a new browser window","Check this box to have the link open in a new browser window":"Check this box to have the link open in a new browser window",
...
"Confirm Cancel Editing":"Confirm Cancel Editing","Content Statistics":"Content Statistics","Content contains more than {{limit}} characters and may be truncated":"Content contains more than {{limit}} characters and may be truncated","Content will not be truncated":"Content will not be truncated","Copy the file's URL from your browser's address bar and paste it into the box above":"Copy the file's URL from your browser's address bar and paste it into the box above","Copy the web address from your browser's address bar and paste it into the box above":"Copy the web address from your browser's address bar and paste it into the box above",
...
"The email address does not look well formed":"The email address does not look well formed","The image '{{image}}' is too wide for the element being edited.<br/>It will be resized to fit.":"The image '{{image}}' is too wide for the element being edited.<br/>It will be resized to fit.","The url for the file you inserted doesn't look well formed":"The url for the file you inserted doesn't look well formed","The url for the link you inserted doesn't look well formed":"The url for the link you inserted doesn't look well formed",
...
"{{words}} word":"{{words}} word","{{words}} words":"{{words}} words"});e("es","Espa\u00f1ol",{"A preview of your embedded object is displayed below.":"A continuaci\u00f3n se muestra una vista previa de su objeto incrustado.","Added link: {{link}}":"Enlace a\u00f1adido: {{link}}","All changes will be lost!":"\u00a1Todos los cambios ser\u00e1n perdidos!","Apply Source":"Aplicar Fuente","Are you sure you want to stop editing?":"\u00bfEst\u00e1 seguro de que desea detener la edici\u00f3n?",Blockquote:"Cita en bloque",
Bold:"Negrita",Cancel:"Cancelar","Center Align":"Centrar","Change HTML tag of selected element":"Cambiar la etiqueta HTML del elemento seleccionado","Change Language":"Cambiar Idioma","Change the color of the selected text.":"Change the color of the selected text.","Check this box to have the file open in a new browser window":"Marque esta casilla para que el archivo se abra en una nueva ventana","Check this box to have the link open in a new browser window":"Marque esta casilla para que el enlace se abra en una nueva ventana",
"Choose a link type:":"Escoja un tipo de enlace:","Clear Formatting":"Limpiar Formato","Click to begin editing":"Haga clic para empezar a editar","Click to detach the toolbar":"Haga clic para desanclar la barra de herramientas","Click to dock the toolbar":"Haga clic para anclar la barra de herramientas","Click to edit the image":"Click to edit the image","Click to select all editable content":"Haga clic para seleccionar todo el contenido editable","Click to select the contents of the '{{element}}' element":"Haga clic para selecionar el contenido del elemento '{{element}}'",
Close:"Cerrar","Confirm Cancel Editing":"Confirme Cancelar la Edici\u00f3n ","Content Statistics":"Contenidos Estad\u00edsticos","Content contains more than {{limit}} characters and may be truncated":"El contenido contiene m\u00e1s de {{limit}} car\u00e1cteres y debe ser truncado","Content will not be truncated":"El contenido no ser\u00e1 truncado","Copy the file's URL from your browser's address bar and paste it into the box above":"Copie la URL de su archivo desde la barra de direcci\u00f3n de su navegador y p\u00e9guela en la caja superior",
...
"The image '{{image}}' is too wide for the element being edited.<br/>It will be resized to fit.":"The image '{{image}}' is too wide for the element being edited.<br/>It will be resized to fit.","The url for the file you inserted doesn't look well formed":"La URL del archivo que ha introducido no parece bien formada","The url for the link you inserted doesn't look well formed":"La URL del enlace que ha introducido no parece bien formada","This block contains unsaved changes":"Este bloque tiene cambios sin guardar",
...
"{{sentences}} sentences":"{{sentences}} oraciones","{{words}} word":"{{words}} palabra","{{words}} words":"{{words}} palabras"});e("fr","Fran\u00e7ais",{"A preview of your embedded object is displayed below.":"Un aper\u00e7u de votre objet int\u00e9gr\u00e9 est affich\u00e9 ci-dessous.","Added link: {{link}}":"Lien ajout\u00e9 : {{link}}","All changes will be lost!":"Toutes les modifications seront perdues !","Apply Source":"Appliquer la source","Are you sure you want to stop editing?":"\u00cates-vous s\u00fbr(e) de vouloir arr\u00eater la modification ?",
...
e("nl","Nederlands",{"A preview of your embedded object is displayed below.":"Een voorbeeldweergave van uw ingenestelde object is hieronder weergeven.","Added link: {{link}}":"Link toegevoegd:: {{link}}","All changes will be lost!":"Alle aanpassingen zullen verloren gaan!","Apply Source":"Broncode toepassen","Are you sure you want to stop editing?":"Weet u zeker dat u wilt stoppen met aanpassen? ",Blockquote:"Blokcitaat",Bold:"Vetgedrukt",Cancel:"Annuleren","Center Align":"Centreren","Change HTML tag of selected element":"Verander type van geselecteerd element",
"Change Language":"Taal veranderen","Change the color of the selected text.":"Verander de kleur van de geselecteerde tekst.","Check this box to have the file open in a new browser window":"Vink dit aan om het bestand te laten opnenen in een nieuw browser venster","Check this box to have the link open in a new browser window":"Vink dit aan om de link te laten opnenen in een nieuw browser venster","Choose a link type:":"Kies het type link:","Clear Formatting":"Verwijder opmaak","Click to begin editing":"Klik hier voor het beginnen met bewerken",
"Click to detach the toolbar":"Klik om de werkbalk los te maken","Click to dock the toolbar":"Klik om de werkbalk vast te maken","Click to edit the image":"Klik om de afbeelding te bewerken","Click to select all editable content":"Klik om alle bewerkbare inhoud te selecteren","Click to select the contents of the '{{element}}' element":"Klik om de inhoud te selecteren van het '{{element}}' element",Close:"Sluiten","Confirm Cancel Editing":"Bevestig annuleren van bewerken","Content Statistics":"Inhoud Statistieken",
"Content contains more than {{limit}} characters and may be truncated":"Inhoud bevat meer dan {{limit}} tekens en kan worden ingekort.","Content will not be truncated":"Inhoud wordt niet ingekort","Copy the file's URL from your browser's address bar and paste it into the box above":"Kopie\u00ebr het internetadres van het bestand uit de adresbalk van uw browser en plak het in het veld hierboven","Copy the web address from your browser's address bar and paste it into the box above":"Kopie\u00ebr het internetadres uit de adresbalk van uw browser en plak het in het veld hierboven",
...
"Enter your URL":"Voeg het internetadres in","Failed to save {{failed}} content block(s).":"Kon {{failed}} inhoud blok(ken) niet opslaan.","Find the page on the web you want to link to":"Vind de pagina op het internet waar u naartoe wilt linken","Float Image Left":"Tekst omsluiten rechts van afbeelding","Float Image Right":"Tekst omsluiten links van afbeelding","Formatted &amp; Cleaned":"Geformatteerd &amp; Opgeruimd","Formatted Unclean":"Rommel Opgeruimd","Heading&nbsp;1":"Kopniveau&nbsp;1","Heading&nbsp;2":"Kopniveau&nbsp;2",
"Heading&nbsp;3":"Kopniveau&nbsp;3","Image height":"Hoogte afbeelding","Image width":"Breedte afbeelding","Increase Font Size":"Kleiner Lettertype",Initializing:"Initialiseren",Insert:"Invoegen","Insert Horizontal Rule":"Horizontale Regel Invoegen","Insert Link":"Link Invoegen","Insert Snippet":"Snippertekst Invoegen",Italic:"Schuingedrukt",Justify:"Uitlijnen aan beide kanten","Learn More About the Raptor WYSIWYG Editor":"Meer leren over Rapor WYSIWYG Editor","Left Align":"Links uitlijnen","Link to a document or other file":"Link naar een document of ander bestand",
"Link to a page on this or another website":"Link naar een pagina op deze of een andere website","Link to an email address":"Link naar een emailadres",Location:"Locatie","Modify Image Size":"Afbeeldingsgrootte aanpassen","N/A":"n.v.t.","New window":"Nieuw venster","No changes detected to save...":"Er zijn geen aanpassingen om op te slaan...","Not sure what to put in the box above?":"Onzeker over wat er in het veld moet staan hierboven?",OK:!1,"Open the uploaded file in your browser":"Open het ge\u00fcploade bestand in uw browser",
"Ordered List":"Genummerde lijst","Page on this or another website":"Pagina op deze of een andere website",Paragraph:"Alinea","Paste Embed Code":"Plak de insluitcode","Paste your embed code into the text area below.":"Plak de insluitcode in het tekstveld hieronder.","Plain Text":"Tekst zonder opmaak",Preview:"Voorbeeldweergave",Raptorize:!1,Reinitialise:"Herinitialiseren","Remaining characters before the recommended character limit is reached":"Aantal karakters over voordat het limiet is bereikt",
...
"{{words}} word":"{{words}} woord","{{words}} words":"{{words}} woorden"});e("zh-CN","\u7b80\u4f53\u4e2d\u6587",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"\u5e94\u7528\u6e90\u4ee3\u7801","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",Blockquote:"\u5927\u6bb5\u5f15\u7528",Bold:"\u7c97\u4f53",
Cancel:"\u53d6\u6d88","Center Align":"\u4e2d\u5fc3\u5bf9\u9f50\u6587\u672c","Change HTML tag of selected element":"Change HTML tag of selected element","Change Language":"\u6539\u53d8\u8bed\u8a00","Change the color of the selected text.":"Change the color of the selected text.","Check this box to have the file open in a new browser window":"Check this box to have the file open in a new browser window","Check this box to have the link open in a new browser window":"Check this box to have the link open in a new browser window",
"Choose a link type:":"Choose a link type:","Clear Formatting":"Clear Formatting","Click to begin editing":"Click to begin editing","Click to detach the toolbar":"Click to detach the toolbar","Click to dock the toolbar":"Click to dock the toolbar","Click to edit the image":"Click to edit the image","Click to select all editable content":"Click to select all editable content","Click to select the contents of the '{{element}}' element":"Click to select the contents of the '{{element}}' element",Close:"Close",
"Confirm Cancel Editing":"\u786e\u8ba4\u53d6\u6d88\u7f16\u8f91","Content Statistics":"Content Statistics","Content contains more than {{limit}} characters and may be truncated":"Content contains more than {{limit}} characters and may be truncated","Content will not be truncated":"Content will not be truncated","Copy the file's URL from your browser's address bar and paste it into the box above":"Copy the file's URL from your browser's address bar and paste it into the box above","Copy the web address from your browser's address bar and paste it into the box above":"Copy the web address from your browser's address bar and paste it into the box above",
...
this.options.manuallyResizingClass),d=a(c).innerWidth(),e=a(c).innerHeight(),f="#"+this.options.baseClass+"-width",h="#"+this.options.baseClass+"-height",i=this,j=function(b){b=Math.round(b||a(f).val())+"px";a(c).css({width:b})},l=a(this.editor.getTemplate("imageresize.manually-resize-image",{width:d,height:e,baseClass:this.options.baseClass}));l.dialog({modal:!0,resizable:!1,title:g("Modify Image Size"),autoOpen:!0,buttons:[{text:g("Resize Image"),click:function(){j(a(this).find(f).val());a(this).dialog("close")}},
{text:g("Cancel"),click:function(){j(d);a(this).dialog("close")}}],close:function(){i.editor.checkChange();a(l).remove()},open:function(){var b=a(this).find(f),c=a(this).find(h);b.keyup(function(){c.val(Math.round(Math.abs(e/d*a(this).val())));j()});c.keyup(function(){b.val(Math.round(Math.abs(d/e*a(this).val())));j()})}});b.preventDefault();return!1},displayToolsButtonRelativeToImage:function(b){var c=a("<button>"+g("Click to edit the image")+"</button>").appendTo("body").addClass(this.options.resizeButtonClass).button({text:!1,
...
this.options.customTypes),d,e=0;e<c.length;e++)d=a.extend({},b,c[e],{classes:this.options.baseClass+"-"+c[e].type}).init(),this.types[d.type]=d},show:function(){if(!this.visible){y();this.selectedElement=h().first();var b=this.selectedElement.is("a"),c=this.options,d=this,e=this.dialog=a(this.editor.getTemplate("link.dialog",c)).appendTo("body");this.initTypes();var f=this.dialog.find("fieldset"),i;for(i in this.types)a(this.editor.getTemplate("link.label",this.types[i])).appendTo(f);f.find('input[type="radio"]').bind("change."+
this.editor.widgetName,function(){d.typeChange(d.types[a(this).val()],b)});e.dialog({autoOpen:!1,modal:!0,resizable:!0,width:c.dialogWidth,minWidth:c.dialogMinWidth,height:c.dialogHeight,title:b?g("Edit Link"):g("Insert Link"),dialogClass:c.baseClass+" "+c.dialogClass,buttons:[{text:b?g("Update Link"):g("Insert Link"),click:function(){v();d.apply(b)&&a(this).dialog("close")}},{text:g("Cancel"),click:function(){a(this).dialog("close")}}],beforeopen:function(){d.dialog.find("."+d.options.baseClass+
...
b&&!g)&&d.typeChange(d.types[f.filter(":checked").val()],b);a(this).unbind("keyup."+d.editor.widgetName).bind("keyup."+d.editor.widgetName,function(b){13==b.keyCode&&(b=d.types[f.filter(":checked").val()],(!a.isFunction(b.validate)||b.validate(d.dialog.find("."+d.options.baseClass+"-content")))&&c.find("button:eq(0)").trigger("click"))})},close:function(){v();d.visible=!1;e.find("."+c.baseClass+"-content").hide();a(this).dialog("destroy")}}).dialog("open")}},apply:function(b){var c=this.types[this.dialog.find('input[type="radio"]:checked').val()],
d=c.attributes(this.dialog.find("."+this.options.baseClass+"-content"),b);if(!d)return!0;v();var e=l(a("<a>"+(d.title?d.title:d.href)+"</a>").attr(a.extend({},d,{target:"_blank"})));b?(this.selectedElement[0].className=this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(c.classes).attr(d),this.editor.showConfirm(g("Updated link: {{link}}",{link:e}))):(J("a",a.extend(d,{id:this.editor.getUniqueId()}),c.classes),this.editor.showConfirm(g("Added link: {{link}}",
{link:e})),this.selectedElement=a("#"+d.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",d.href);F(this.selectedElement);y();return!0},typeChange:function(b,c){var d=this.dialog.find("."+this.options.baseClass+"-content"),e=d.closest("."+this.options.baseClass+"-wrap"),f=b.ajaxUri&&!this.types[b.type].content;f&&e.addClass(this.options.baseClass+"-loading");var g=this;d.hide(this.options.panelAnimation,function(){f?a.ajax({url:b.ajaxUri,type:"get",success:function(f){d.html(f);
...
this.change,this);a.bind("show",this.change,this);return a.uiButton({title:g("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){h().is("a")?this.ui.enable():this.ui.disable()}}});a.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),
toggleList:function(b){a(h()).is("li")&&a(h()).parent().is(b)?this.unwrapList():this.wrapList(b);this.editor.fire("selectionChange");this.editor.fire("change")},unwrapList:function(){y();var b=[],c=[],d=U(),e=R();b.push(a(d).html());c.push(d);if(a(d)[0]!==a(e)[0]){var f=d;do f=a(f).next(),b.push(a(f).html()),c.push(f);while(a(f)[0]!==a(e)[0])}f=0===a(d).prev().length;e=0===a(e).next().length;d=a(d).parent();for(listElementsIndex=0;listElementsIndex<c.length;listElementsIndex++)a(c[listElementsIndex]).remove();
for(c=0;c<b.length;c++)d.parent().is("li")||(b[c]="<p>"+b[c]+"</p>");f&&e?(d.replaceWith(b.join("")),v(),b=h()[0],F(b)):(f?a(d).before(b.join("")):e?a(d).after(b.join("")):t(b.join("")),v(),this.editor.checkChange())},wrapList:function(b){this.editor.constrainSelection(this.editor.getElement());""===a.trim(P())&&D(h());var c=a("<div>").html(P()),d=[],e=this;a(c).contents().each(function(){var b;b="block"===n(this.tagName)?M(a(this).html(),e.validChildren):M(l(a(this)),e.validChildren);b=a("<li>"+
b+"</li>");""!==a.trim(b.text())&&d.push(l(b))});c=this.options.baseClass+"-selection";b="<"+b+' class="'+c+'">'+d.join("")+"</"+b+">";v();var f=a(h()[0]).parent(),g=this.editor.getElement()[0];f===g||h()[0]===g?x(b):I(b,this.validParents);c=a(this.editor.getElement().find("."+c).removeClass(c));D(c.find("li:first")[0]);this.editor.checkChange()},toggleButtonState:function(b,c){var d=function(a){c.button.toggleClass("ui-state-highlight",a).toggleClass("ui-state-default",!a)},e=U();if(null===e||!e.length)e=
this.editor.getElement();var f=R();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(a(e).is(b)&&a(f).is(b)&&e===f)return d(!0);var g=a(e).parentsUntil(h,b).first()&&a(f).parentsUntil(h,b).first(),h="#"+this.editor.getElement().attr("id"),i=a(e).is(b+" > li")||a(e).parentsUntil(h,b+" > li").length,j=a(f).is(b+" > li")||a(f).parentsUntil(h,b+" > li").length;if(i&&j&&g){g=a(q());g.is(b)||(g=a(g).parentsUntil(h,b).first());h=g.find("ul, ol");if(!h.length)return d(!0);for(g=0;g<h.length;g++)if(a.contains(h[g],
...
c))});return(f?"[":"{")+(""+e)+(f?"]":"}")},c={enableUi:this.options.enableUi,enablePlugins:this.options.enablePlugins,disabledPlugins:b(this.options.disabledPlugins),ui:b(this.options.ui),t:(new Date).getTime()},d=[],e;for(e in c)d.push(e+"="+encodeURIComponent(c[e]));this.ui.button.find(".ui-button-icon-primary").css({"background-image":"url(http://www.jquery-raptor.com/logo/0.0.24?"+d.join("&")+")"})}})}}});a.ui.editor.registerPlugin("normaliseLineBreaks",{options:{enter:"<p><br/></p>",enterValidTags:"address,blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),
shiftEnter:"<br/>",shiftEnterValidTags:"a,abbr,acronym,address,applet,b,bdo,big,blockquote,body,button,caption,center,cite,code,dd,del,dfn,div,dt,em,fieldset,font,form,h1,h2,h3,h4,h5,h6,i,iframe,ins,kbd,label,legend,li,noframes,noscript,object,p,pres,q,s,samp,small,span,strike,strong,sub,sup,td,th,tt,u,var".split(",")},hotkeys:{"return":{action:function(){z();var b=""===d.getSelection().toHtml(),c;c=d.getSelection();var e=c.isBackwards()?c.focusNode:c.anchorNode;(c.isBackwards()?c.focusOffset:0!==
c.anchorOffset)?c=!1:(c=e.previousSibling,c=!c||""===a(c).html()?!0:!1);var f;e=d.getSelection();f=e.isBackwards()?e.anchorNode:e.focusNode;(e.isBackwards()?e.focusOffset:e.anchorOffset)!==f.textContent.length?f=!1:(e=f.nextSibling,f=!e||""===a(e).html()?!0:!1);var g=this.options.baseClass+"-enter-break",e=a(this.options.enter).attr("id",g);I(e,this.options.enterValidTags);e=a("#"+g).removeAttr("id");b?c?w(e.next()):f?w(e):(w(e.next()),(b=e.prev())&&""!==a.trim(b.html())&&l(b)!==this.options.enter&&
e.remove()):(w(e.next()),e.remove())},restoreSelection:!1},"return+shift":{action:function(){z();var b=this.options.baseClass+"-enter-break",c=a(this.shiftEnter).attr("id",b).appendTo("body");this.options.shiftEnterValidTags?I(this.options.shiftEnter,this.options.shiftEnterValidTags):x(c);b=a("#"+b).removeAttr("id").next();w(b)},restoreSelection:!1}}});a.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span,hr,br".split(","),allowedAttributes:["href",
"title"],allowedEmptyTags:["hr","br"]},init:function(b,d){var e=!1,f=!1,h=this;b.getElement().bind("paste."+b.widgetName,a.proxy(function(){if(e)return!1;e=!0;y();a(".uiWidgetEditorPasteBin").length&&a(".uiWidgetEditorPasteBin").remove();a('<div class="uiWidgetEditorPasteBin" contenteditable="true" style="width: 1px; height: 1px; overflow: hidden; position: fixed; top: -1px;" />').appendTo("body");a(".uiWidgetEditorPasteBin").focus();c.setTimeout(function(){var c=a(".uiWidgetEditorPasteBin").html(),
c=h.filterAttributes(c),c=h.filterChars(c),c=h.stripEmpty(c),c=h.stripAttributes(c),c=M(c,h.options.allowedTags),c={plain:a("<div/>").html(a(".uiWidgetEditorPasteBin").html()).text(),markup:c,html:a(".uiWidgetEditorPasteBin").html()};f=a(b.getTemplate("paste.dialog",c));a(f).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:d.dialogShowAnimation,hide:d.dialogHideAnimation,dialogClass:d.baseClass+" "+d.dialogClass,buttons:[{text:g("Insert"),click:function(){var c=
null,c=a(this).find(".ui-editor-paste-area:visible"),c=c.hasClass("ui-editor-paste-plain")||c.hasClass("ui-editor-paste-source")?c.val():c.html(),c=h.filterAttributes(c),c=h.filterChars(c);v();x(c);b.checkChange();e=!1;a(this).dialog("close")}},{text:g("Cancel"),click:function(){v();e=!1;a(this).dialog("close")}}],open:function(){var b=a(this).find(".ui-editor-paste-panel-tabs");b.find("ul.ui-tabs-nav li").click(function(){b.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
...
change:function(c){if(!("undefined"===typeof c||"na"===c)){var d=b.getElement()[0],e=h();if(!P()||""===P()){if(a(e)[0]===a(d)[0])return;y();d=a("<"+c+">").html(e.html());e.replaceWith(d);v()}else{var e=a(h()[0]).parent(),f=this.options.baseClass+"-selection",c=a("<"+c+">").html(P()).addClass(f);e===d||h()[0]===d?x(c):I(c,this.validParents);D(b.getElement().find("."+f).removeClass(f))}b.checkChange()}}})},change:function(){var b=h()[0];b?(b=b.tagName.toLowerCase(),this.ui.select.find("option[value="+
...
a(d).button("option","disabled",!1);b.editor.checkChange()}})}}});var T=!1})(jQuery,window,rangy);
