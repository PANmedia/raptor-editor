...
r="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),s="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),p=e(a),q=e(c),y=e(d),w={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:a,isHostObject:c,isHostProperty:d,areHostMethods:p,areHostObjects:q,areHostProperties:y,isTextRange:f},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
w.fail=i;w.warn=function(a){a="Rangy warning: "+a;w.config.alertOnWarn?window.alert(a):typeof window.console!=o&&typeof window.console.log!=o&&window.console.log(a)};({}).hasOwnProperty?w.util.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])}:i("hasOwnProperty not supported");var A=[],E=[];w.init=g;w.addInitListener=function(a){w.initialized?a(w):A.push(a)};var z=[];w.addCreateMissingNativeApiListener=function(a){z.push(a)};w.createMissingNativeApi=function(a){a=a||window;g();
...
}function E(a,b){if(0>b||b>(u.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new G("INDEX_SIZE_ERR");}function z(a,b){if(L(a,!0)!==L(b,!0))throw new G("WRONG_DOCUMENT_ERR");}function C(a){if(N(a,!0))throw new G("NO_MODIFICATION_ALLOWED_ERR");}function F(a,b){if(!a)throw new G(b);}function H(a){return!!a.startContainer&&!!a.endContainer&&!(!u.arrayContains(k,a.startContainer.nodeType)&&!L(a.startContainer,!0))&&!(!u.arrayContains(k,a.endContainer.nodeType)&&!L(a.endContainer,!0))&&a.startOffset<=
(u.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(u.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function D(a){w(a);if(!H(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function v(){}function O(a){a.START_TO_START=fa;a.START_TO_END=ga;a.END_TO_END=ta;a.END_TO_START=ka;a.NODE_BEFORE=ha;a.NODE_AFTER=la;a.NODE_BEFORE_AND_AFTER=ma;a.NODE_INSIDE=
ia}function R(a){O(a);O(a.prototype)}function h(a,b){return function(){D(this);var c=this.startContainer,d=this.startOffset,h=this.commonAncestorContainer,k=new r(this,!0);c!==h&&(c=u.getClosestAncestorIn(c,h,!0),d=i(c),c=d.node,d=d.offset);j(k,C);k.reset();h=a(k);k.detach();b(this,c,d,c,d);return h}}function S(b,d,e){function j(a,b){return function(c){w(this);A(c,M);A(J(c),k);c=(a?f:i)(c);(b?g:x)(this,c.node,c.offset)}}function g(a,b,c){var h=a.endContainer,k=a.endOffset;if(b!==a.startContainer||
c!==a.startOffset){if(J(b)!=J(h)||1==u.comparePoints(b,c,h,k))h=b,k=c;d(a,b,c,h,k)}}function x(a,b,c){var h=a.startContainer,k=a.startOffset;if(b!==a.endContainer||c!==a.endOffset){if(J(b)!=J(h)||-1==u.comparePoints(b,c,h,k))h=b,k=c;d(a,h,k,b,c)}}b.prototype=new v;a.util.extend(b.prototype,{setStart:function(a,b){w(this);y(a,!0);E(a,b);g(this,a,b)},setEnd:function(a,b){w(this);y(a,!0);E(a,b);x(this,a,b)},setStartBefore:j(!0,!0),setStartAfter:j(!1,!0),setEndBefore:j(!0,!1),setEndAfter:j(!1,!1),collapse:function(a){D(this);
a?d(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):d(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){w(this);y(a,!0);d(this,a,0,a,u.getNodeLength(a))},selectNode:function(a){w(this);y(a,!1);A(a,M);var b=f(a),a=i(a);d(this,b.node,b.offset,a.node,a.offset)},extractContents:h(o,d),deleteContents:h(l,d),canSurroundContents:function(){D(this);C(this.startContainer);C(this.endContainer);var a=new r(this,!0),b=a._first&&
...
a.endContainer)}function P(a,b,c,d,h){var k=a.startContainer!==b||a.startOffset!==c,f=a.endContainer!==d||a.endOffset!==h;a.startContainer=b;a.startOffset=c;a.endContainer=d;a.endOffset=h;Q(a);e(a,"boundarychange",{startMoved:k,endMoved:f})}function K(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};Q(this)}a.requireModules(["DomUtil"]);var u=a.dom,I=u.DomPosition,G=a.DOMException;r.prototype={_current:null,_next:null,_first:null,
...
detach:function(){this._current=this._next=this.nodes=null}};var M=[1,3,4,5,7,8,10],k=[2,9,11],t=[1,3,4,5,7,8,10,11],x=[1,3,4,5,7,8],J=u.getRootContainer,L=q([9,11]),N=q([5,6,10,12]),V=q([6,10,12]),T=document.createElement("style"),aa=!1;try{T.innerHTML="<b>x</b>",aa=3==T.firstChild.nodeType}catch(Ka){}a.features.htmlParsingConforms=aa;var ja="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),fa=0,ga=1,ta=2,ka=3,ha=0,la=1,ma=2,ia=3;v.prototype={attachListener:function(a,
...
this);a.detach();return!b},surroundContents:function(a){A(a,x);if(!this.canSurroundContents())throw new s("BAD_BOUNDARYPOINTS_ERR");var b=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);g(a,this.startContainer,this.startOffset);a.appendChild(b);this.selectNode(a)},cloneRange:function(){D(this);for(var a=new K(d(this)),b=ja.length,c;b--;)c=ja[b],a[c]=this[c];return a},toString:function(){D(this);var a=this.startContainer;if(a===this.endContainer&&u.isCharacterDataNode(a))return 3==
...
this.collapse(!0)},getName:function(){return"DomRange"},equals:function(a){return K.rangesEqual(this,a)},isValid:function(){return H(this)},inspect:function(){return m(this)}};S(K,P,function(a){w(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;e(a,"detach",null);a._listeners=null});a.rangePrototype=v.prototype;K.rangeProperties=ja;K.RangeIterator=r;K.copyComparisonConstants=R;K.createPrototypeRange=S;K.inspect=m;K.getRangeDocument=d;K.rangesEqual=
function(a,b){return a.startContainer===b.startContainer&&a.startOffset===b.startOffset&&a.endContainer===b.endContainer&&a.endOffset===b.endOffset};a.DomRange=K;a.RangeException=s});
rangy.createModule("WrappedRange",function(a){function c(a,b,c,d){var e=a.duplicate();e.collapse(c);var g=e.parentElement();f.isAncestorOf(b,g,!0)||(g=b);if(!g.canHaveHTML)return new i(g.parentNode,f.getNodeIndex(g));var b=f.getDocument(g).createElement("span"),s,p=c?"StartToStart":"StartToEnd";do g.insertBefore(b,b.previousSibling),e.moveToElementText(b);while(0<(s=e.compareEndPoints(p,a))&&b.previousSibling);p=b.nextSibling;if(-1==s&&p&&f.isCharacterDataNode(p)){e.setEndPoint(c?"EndToStart":"EndToEnd",
a);if(/[\r\n]/.test(p.data)){g=e.duplicate();c=g.text.replace(/\r\n/g,"\r").length;for(c=g.moveStart("character",c);-1==g.compareEndPoints("StartToEnd",g);)c++,g.moveStart("character",1)}else c=e.text.length;g=new i(p,c)}else p=(d||!c)&&b.previousSibling,g=(c=(d||c)&&b.nextSibling)&&f.isCharacterDataNode(c)?new i(c,0):p&&f.isCharacterDataNode(p)?new i(p,p.length):new i(g,f.getNodeIndex(b));b.parentNode.removeChild(b);return g}function d(a,b){var c,d,e=a.offset,g=f.getDocument(a.node),i=g.body.createTextRange(),
p=f.isCharacterDataNode(a.node);p?(c=a.node,d=c.parentNode):(c=a.node.childNodes,c=e<c.length?c[e]:null,d=a.node);g=g.createElement("span");g.innerHTML="&#feff;";c?d.insertBefore(g,c):d.appendChild(g);i.moveToElementText(g);i.collapse(!b);d.removeChild(g);if(p)i[b?"moveStart":"moveEnd"]("character",e);return i}a.requireModules(["DomUtil","DomRange"]);var e,f=a.dom,i=f.DomPosition,g=a.DomRange;if(a.features.implementsDomRange&&(!a.features.implementsTextRange||!a.config.preferTextRange))(function(){function b(a){for(var c=
...
i(this)};var G=function(b,c){var d=y.getRangeDocument(c),d=a.createRange(d);d.collapseToPoint(c.endContainer,c.endOffset);b.nativeSelection.addRange(g(d));b.nativeSelection.extend(c.startContainer,c.startOffset);b.refresh()};u.addRange=S?function(b,c){if(K&&H&&this.docSelection.type=="Control")o(this,b);else if(c&&h)G(this,b);else{var d;if(Q)d=this.rangeCount;else{this.removeAllRanges();d=0}this.nativeSelection.addRange(g(b));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==d+1){if(a.config.checkSelectionRanges)(d=
I(this.nativeSelection,this.rangeCount-1))&&!y.rangesEqual(d,b)&&(b=new w(d));this._ranges[this.rangeCount-1]=b;f(this,b,t(this.nativeSelection));this.isCollapsed=C(this)}else this.refresh()}}:function(a,b){if(b&&h)G(this,a);else{this.nativeSelection.addRange(g(a));this.refresh()}};u.setRanges=function(a){if(K&&a.length>1)m(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(q.isHostMethod(F,"empty")&&q.isHostMethod(v,"select")&&K&&D)u.removeAllRanges=
...
for(;a--;)if(!y.rangesEqual(b[a],this._ranges[a]))return false;return true}};var k=function(a,b){var c=a.getAllRanges(),d=false;a.removeAllRanges();for(var h=0,k=c.length;h<k;++h)d||b!==c[h]?a.addRange(c[h]):d=true;a.rangeCount||i(a)};u.removeRange=K?function(a){if(this.docSelection.type=="Control"){for(var c=this.docSelection.createRange(),a=b(a),d=p.getDocument(c.item(0)),d=p.getBody(d).createControlRange(),h,f=false,e=0,g=c.length;e<g;++e){h=c.item(e);h!==a||f?d.add(c.item(e)):f=true}d.select();
...
this.addRange(c)};u.deleteFromDocument=function(){if(K&&H&&this.docSelection.type=="Control"){for(var a=this.docSelection.createRange(),b;a.length;){b=a.item(0);a.remove(b);b.parentNode.removeChild(b)}this.refresh()}else if(this.rangeCount){a=this.getAllRanges();this.removeAllRanges();b=0;for(var c=a.length;b<c;++b)a[b].deleteContents();this.addRange(a[c-1])}};u.getAllRanges=function(){return this._ranges.slice(0)};u.setSingleRange=function(a){this.setRanges([a])};u.containsNode=function(a,b){for(var c=
...
c.warn("Marker element has been removed. Cannot restore selection.")}function f(a,b){return b.compareBoundaryPoints(a.START_TO_START,a)}function i(a,b){var c=(a||document).getElementById(b);c&&c.parentNode.removeChild(c)}a.requireModules(["DomUtil","DomRange","WrappedRange"]);var g=a.dom,b="\ufeff";a.saveSelection=function(b){var b=b||window,e=b.document;if(a.isSelectionValid(b)){var g=a.getSelection(b),i=g.getAllRanges(),m=[],r,s;i.sort(f);for(var p=0,q=i.length;p<q;++p)r=i[p],r.collapsed?(s=d(r,
!1),m.push({markerId:s.id,collapsed:!0})):(s=d(r,!1),r=d(r,!0),m[p]={startMarkerId:r.id,endMarkerId:s.id,collapsed:!1,backwards:1==i.length&&g.isBackwards()});for(p=q-1;0<=p;--p)r=i[p],r.collapsed?r.collapseBefore((e||document).getElementById(m[p].markerId)):(r.setEndBefore((e||document).getElementById(m[p].endMarkerId)),r.setStartAfter((e||document).getElementById(m[p].startMarkerId)));g.setRanges(i);return{win:b,doc:e,rangeInfos:m,restored:!1}}c.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
a.restoreSelection=function(b,d){if(!b.restored){for(var f=b.rangeInfos,g=a.getSelection(b.win),i=[],r=f.length,s=r-1,p,q;0<=s;--s){p=f[s];q=a.createRange(b.doc);if(p.collapsed)if(p=(b.doc||document).getElementById(p.markerId)){p.style.display="inline";var y=p.previousSibling;y&&3==y.nodeType?(p.parentNode.removeChild(p),q.collapseToPoint(y,y.length)):(q.collapseBefore(p),p.parentNode.removeChild(p))}else c.warn("Marker element has been removed. Cannot restore selection.");else e(b.doc,q,p.startMarkerId,
!0),e(b.doc,q,p.endMarkerId,!1);1==r&&q.normalizeBoundaries();i[s]=q}1==r&&d&&a.features.selectionHasExtend&&f[0].backwards?(g.removeAllRanges(),g.addRange(i[0],!0)):g.setRanges(i);b.restored=!0}};a.removeMarkerElement=i;a.removeMarkers=function(a){for(var b=a.rangeInfos,c=0,d=b.length,e;c<d;++c)e=b[c],e.collapsed?i(a.doc,e.markerId):(i(a.doc,e.startMarkerId),i(a.doc,e.endMarkerId))}});
...
(function(a,c){function d(a){var b=S[a]={},c,d,a=a.split(/\s+/);c=0;for(d=a.length;c<d;c++)b[a[c]]=!0;return b}function e(a,b,d){if(d===c&&1===a.nodeType)if(d="data-"+b.replace(K,"-$1").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:h.isNumeric(d)?+d:P.test(d)?h.parseJSON(d):d}catch(e){}h.data(a,b,d)}else d=c;return d}function f(a){for(var b in a)if(!("data"===b&&h.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function i(a,b,c){var d=
...
(e=new ActiveXObject("Microsoft.XMLDOM"),e.async="false",e.loadXML(b))}catch(f){e=c}(!e||!e.documentElement||e.getElementsByTagName("parsererror").length)&&d.error("Invalid XML: "+b);return e},noop:function(){},globalEval:function(b){b&&i.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(L,"ms-").replace(p,q)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,b,e){var B,f=0,k=a.length,g=k===c||d.isFunction(a);
...
b,j,e[j],1,k,B);f=1}else if(B!==c){i=g===c&&d.isFunction(B);h&&(i?(i=b,b=function(a,b,c){return i.call(d(a),c)}):(b.call(a,B),b=null));if(b)for(;j<W;j++)b(a[j],e,i?B.call(a[j],j,b(a[j],e)):B,g);f=1}return f?a:h?b.call(a):W?b(a[0],e):k},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=o.exec(a)||r.exec(a)||s.exec(a)||0>a.indexOf("compatible")&&J.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,
...
0<=h.inArray(h(this).val(),c)});c.length||(a.selectedIndex=-1);return c}}},attrFn:{val:!0,css:!0,html:!0,text:!0,data:!0,width:!0,height:!0,offset:!0},attr:function(a,b,d,e){var f,k,g=a.nodeType;if(a&&!(3===g||8===g||2===g)){if(e&&b in h.attrFn)return h(a)[b](d);if("undefined"===typeof a.getAttribute)return h.prop(a,b,d);if(e=1!==g||!h.isXMLDoc(a))b=b.toLowerCase(),k=h.attrHooks[b]||(x.test(b)?N:L);if(d!==c)if(null===d)h.removeAttr(a,b);else{if(k&&"set"in k&&e&&(f=k.set(a,d,b))!==c)return f;a.setAttribute(b,
""+d);return d}else{if(k&&"get"in k&&e&&null!==(f=k.get(a,b)))return f;f=a.getAttribute(b);return null===f?c:f}}},removeAttr:function(a,b){var c,d,e,f,k,g=0;if(b&&1===a.nodeType){d=b.toLowerCase().split(I);for(f=d.length;g<f;g++)if(e=d[g])c=h.propFix[e]||e,(k=x.test(e))||h.attr(a,e,""),a.removeAttribute(J?e:c),k&&c in a&&(a[c]=!1)}},attrHooks:{type:{set:function(a,b){if(M.test(a.nodeName)&&a.parentNode)h.error("type property can't be changed");else if(!h.support.radioValue&&"radio"===b&&h.nodeName(a,
"input")){var c=a.value;a.setAttribute("type",b);c&&(a.value=c);return b}}},value:{get:function(a,b){return L&&h.nodeName(a,"button")?L.get(a,b):b in a?a.value:null},set:function(a,b,c){if(L&&h.nodeName(a,"button"))return L.set(a,b,c);a.value=b}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},
...
e||"boolean"!==typeof e&&(d=a.getAttributeNode(b))&&!1!==d.nodeValue?b.toLowerCase():c},set:function(a,b,c){!1===b?h.removeAttr(a,c):(b=h.propFix[c]||c,b in a&&(a[b]=!0),a.setAttribute(c,c.toLowerCase()));return c}};J||(V={name:!0,id:!0,coords:!0},L=h.valHooks.button={get:function(a,b){var d;return(d=a.getAttributeNode(b))&&(V[b]?""!==d.nodeValue:d.specified)?d.nodeValue:c},set:function(a,b,c){var d=a.getAttributeNode(c);d||(d=v.createAttribute(c),a.setAttributeNode(d));return d.nodeValue=b+""}},
h.attrHooks.tabindex.set=L.set,h.each(["width","height"],function(a,b){h.attrHooks[b]=h.extend(h.attrHooks[b],{set:function(a,c){if(""===c)return a.setAttribute(b,"auto"),c}})}),h.attrHooks.contenteditable={get:L.get,set:function(a,b,c){""===b&&(b="false");L.set(a,b,c)}});h.support.hrefNormalized||h.each(["href","src","width","height"],function(a,b){h.attrHooks[b]=h.extend(h.attrHooks[b],{get:function(a){a=a.getAttribute(b,2);return a===null?c:a}})});h.support.style||(h.attrHooks.style={get:function(a){return a.style.cssText.toLowerCase()||
...
remove:function(a,b,c,d,e){var f=h.hasData(a)&&h._data(a),k,g,i,j,t,l,m,n,x,o;if(f&&(m=f.events)){b=h.trim(ha(b||"")).split(" ");for(k=0;k<b.length;k++){g=aa.exec(b[k])||[];i=j=g[1];g=g[2];if(i){n=h.event.special[i]||{};i=(d?n.delegateType:n.bindType)||i;x=m[i]||[];t=x.length;g=g?RegExp("(^|\\.)"+g.split(".").sort().join("\\.(?:.*\\.)?")+"(\\.|$)"):null;for(l=0;l<x.length;l++){o=x[l];if((e||j===o.origType)&&(!c||c.guid===o.guid)&&(!g||g.test(o.namespace))&&(!d||d===o.selector||d==="**"&&o.selector)){x.splice(l--,
1);o.selector&&x.delegateCount--;n.remove&&n.remove.call(a,o)}}if(x.length===0&&t!==x.length){(!n.teardown||n.teardown.call(a,g)===false)&&h.removeEvent(a,i,f.handle);delete m[i]}}else for(i in m)h.event.remove(a,i+b[k],c,d,true)}if(h.isEmptyObject(m)){if(b=f.handle)b.elem=null;h.removeData(a,["events","handle"],true)}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(b,d,e,f){if(!e||!(e.nodeType===3||e.nodeType===8)){var k=b.type||b,g=[],i,j,t,l,m;if(!ga.test(k+h.event.triggered)){if(k.indexOf("!")>=
...
f=[].slice.call(arguments,0),k=!b.exclusive&&!b.namespace,g=h.event.special[b.type]||{},i=[],j,t,l,m,n,x,o;f[0]=b;b.delegateTarget=this;if(!(g.preDispatch&&g.preDispatch.call(this,b)===false)){if(e&&!(b.button&&b.type==="click")){l=h(this);l.context=this.ownerDocument||this;for(t=b.target;t!=this;t=t.parentNode||this)if(t.disabled!==true){n={};x=[];l[0]=t;for(j=0;j<e;j++){m=d[j];o=m.selector;if(n[o]===c){var r=n,s=o,J;if(m.quick){J=m.quick;var p=t.attributes||{};J=(!J[1]||t.nodeName.toLowerCase()===
J[1])&&(!J[2]||(p.id||{}).value===J[2])&&(!J[3]||J[3].test((p["class"]||{}).value))}else J=l.is(o);r[s]=J}n[o]&&x.push(m)}x.length&&i.push({elem:t,matches:x})}}d.length>e&&i.push({elem:this,matches:d.slice(e)});for(j=0;j<i.length&&!b.isPropagationStopped();j++){e=i[j];b.currentTarget=e.elem;for(d=0;d<e.matches.length&&!b.isImmediatePropagationStopped();d++){m=e.matches[d];if(k||!b.namespace&&!m.namespace||b.namespace_re&&b.namespace_re.test(m.namespace)){b.data=m.data;b.handleObj=m;m=((h.event.special[m.origType]||
...
c=m.attr?m.attr(a,c):x.attrHandle[c]?x.attrHandle[c](a):a[c]!=null?a[c]:a.getAttribute(c),d=c+"",e=b[2],f=b[4];return c==null?e==="!=":!e&&m.attr?c!=null:e==="="?d===f:e==="*="?d.indexOf(f)>=0:e==="~="?(" "+d+" ").indexOf(f)>=0:!f?d&&c!==false:e==="!="?d!==f:e==="^="?d.indexOf(f)===0:e==="$="?d.substr(d.length-f.length)===f:e==="|="?d===f||d.substr(0,f.length+1)===f+"-":false},POS:function(a,b,c,d){var e=x.setFilters[b[2]];if(e)return e(a,c,b,d)}}},o=x.match.POS,r=function(a,b){return"\\"+(b-0+1)},
J;for(J in x.match){x.match[J]=RegExp(x.match[J].source+/(?![^\[]*\])(?![^\(]*\))/.source);x.leftMatch[J]=RegExp(/(^(?:.|\r|\n)*?)/.source+x.match[J].source.replace(/\\(\d+)/g,r))}x.match.globalPOS=o;var s=function(a,b){a=Array.prototype.slice.call(a,0);if(b){b.push.apply(b,a);return b}return a};try{Array.prototype.slice.call(v.documentElement.childNodes,0)[0].nodeType}catch(p){s=function(a,b){var c=0,d=b||[];if(k.call(a)==="[object Array]")Array.prototype.push.apply(d,a);else if(typeof a.length===
"number")for(var e=a.length;c<e;c++)d.push(a[c]);else for(;a[c];c++)d.push(a[c]);return d}}var L,q;if(v.documentElement.compareDocumentPosition)L=function(a,b){if(a===b){g=true;return 0}return!a.compareDocumentPosition||!b.compareDocumentPosition?a.compareDocumentPosition?-1:1:a.compareDocumentPosition(b)&4?-1:1};else{L=function(a,b){if(a===b){g=true;return 0}if(a.sourceIndex&&b.sourceIndex)return a.sourceIndex-b.sourceIndex;var c,d,e=[],f=[];c=a.parentNode;d=b.parentNode;var k=c;if(c===d)return q(a,
...
""?"auto":e});ba=Ma||Na;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){if(c)return a.offsetWidth!==0?p(a,b,d):h.swap(a,lb,function(){return p(a,b,d)})},set:function(a,b){return ib.test(b)?b+"px":b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return gb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,e=h.isNumeric(b)?"alpha(opacity="+b*100+")":"",f=
...
processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Ta},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:q(wa),ajaxTransport:q(Sa),ajax:function(a,b){function d(a,b,m,l){if(J!==2){J=2;r&&clearTimeout(r);o=c;x=l||"";q.readyState=
a>0?4:0;var n,s,B,l=b;if(m){var L=e,w=q,ua=L.contents,N=L.dataTypes,y=L.responseFields,u,v,W,V;for(v in y)v in m&&(w[y[v]]=m[v]);for(;N[0]==="*";){N.shift();u===c&&(u=L.mimeType||w.getResponseHeader("content-type"))}if(u)for(v in ua)if(ua[v]&&ua[v].test(u)){N.unshift(v);break}if(N[0]in m)W=N[0];else{for(v in m){if(!N[0]||L.converters[v+" "+N[0]]){W=v;break}V||(V=v)}W=W||V}if(W){W!==N[0]&&N.unshift(W);m=m[W]}else m=void 0}else m=c;if(a>=200&&a<300||a===304){if(e.ifModified){if(u=q.getResponseHeader("Last-Modified"))h.lastModified[t]=
u;if(u=q.getResponseHeader("Etag"))h.etag[t]=u}if(a===304){l="notmodified";n=true}else try{u=e;u.dataFilter&&(m=u.dataFilter(m,u.dataType));var A=u.dataTypes;v={};var z,E,F=A.length,C,T=A[0],D,H,G,I,K;for(z=1;z<F;z++){if(z===1)for(E in u.converters)typeof E==="string"&&(v[E.toLowerCase()]=u.converters[E]);D=T;T=A[z];if(T==="*")T=D;else if(D!=="*"&&D!==T){H=D+" "+T;G=v[H]||v["* "+T];if(!G){K=c;for(I in v){C=I.split(" ");if(C[0]===D||C[0]==="*")if(K=v[C[1]+" "+T]){I=v[I];I===true?G=K:K===true&&(G=I);
break}}}!G&&!K&&h.error("No conversion from "+H.replace(" "," to "));G!==true&&(m=G?G(m):K(I(m)))}}s=m;l="success";n=true}catch(M){l="parsererror";B=M}}else{B=l;if(!l||a){l="error";a<0&&(a=0)}}q.status=a;q.statusText=""+(b||l);n?g.resolveWith(f,[s,l,q]):g.rejectWith(f,[q,l,B]);q.statusCode(j);j=c;p&&k.trigger("ajax"+(n?"Success":"Error"),[q,e,n?s:B]);i.fireWith(f,[q,l]);if(p){k.trigger("ajaxComplete",[q,e]);--h.active||h.event.trigger("ajaxStop")}}}if(typeof a==="object"){b=a;a=c}var b=b||{},e=h.ajaxSetup({},
b),f=e.context||e,k=f!==e&&(f.nodeType||f instanceof h)?h(f):h.event,g=h.Deferred(),i=h.Callbacks("once memory"),j=e.statusCode||{},t,m={},l={},x,n,o,r,s,J=0,p,L,q={readyState:0,setRequestHeader:function(a,b){if(!J){var c=a.toLowerCase(),a=l[c]=l[c]||a;m[a]=b}return this},getAllResponseHeaders:function(){return J===2?x:null},getResponseHeader:function(a){var b;if(J===2){if(!n)for(n={};b=ob.exec(x);)n[b[1].toLowerCase()]=b[2];b=n[a.toLowerCase()]}return b===c?null:b},overrideMimeType:function(a){if(!J)e.mimeType=
a;return this},abort:function(a){a=a||"abort";o&&o.abort(a);d(0,a);return this}};g.promise(q);q.success=q.done;q.error=q.fail;q.complete=i.add;q.statusCode=function(a){if(a){var b;if(J<2)for(b in a)j[b]=[j[b],a[b]];else{b=a[q.status];q.then(b,b)}}return this};e.url=((a||e.url)+"").replace(nb,"").replace(rb,$[1]+"//");e.dataTypes=h.trim(e.dataType||"*").toLowerCase().split(La);if(e.crossDomain==null){s=Qa.exec(e.url.toLowerCase());e.crossDomain=!(!s||!(s[1]!=$[1]||s[2]!=$[2]||(s[3]||(s[1]==="http:"?
80:443))!=($[3]||($[1]==="http:"?80:443))))}if(e.data&&e.processData&&typeof e.data!=="string")e.data=h.param(e.data,e.traditional);y(wa,e,b,q);if(J===2)return false;p=e.global;e.type=e.type.toUpperCase();e.hasContent=!qb.test(e.type);p&&h.active++===0&&h.event.trigger("ajaxStart");if(!e.hasContent){if(e.data){e.url=e.url+((Pa.test(e.url)?"&":"?")+e.data);delete e.data}t=e.url;if(e.cache===false){s=h.now();var w=e.url.replace(ub,"$1_="+s);e.url=w+(w===e.url?(Pa.test(e.url)?"&":"?")+"_="+s:"")}}(e.data&&
e.hasContent&&e.contentType!==false||b.contentType)&&q.setRequestHeader("Content-Type",e.contentType);if(e.ifModified){t=t||e.url;h.lastModified[t]&&q.setRequestHeader("If-Modified-Since",h.lastModified[t]);h.etag[t]&&q.setRequestHeader("If-None-Match",h.etag[t])}q.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+(e.dataTypes[0]!=="*"?", "+Ta+"; q=0.01":""):e.accepts["*"]);for(L in e.headers)q.setRequestHeader(L,e.headers[L]);if(e.beforeSend&&(e.beforeSend.call(f,
q,e)===false||J===2)){q.abort();return false}for(L in{success:1,error:1,complete:1})q[L](e[L]);if(o=y(Sa,e,b,q)){q.readyState=1;p&&k.trigger("ajaxSend",[q,e]);e.async&&e.timeout>0&&(r=setTimeout(function(){q.abort("timeout")},e.timeout));try{J=1;o.send(m,d)}catch(N){if(J<2)d(-1,N);else throw N;}}else d(-1,"No Transport");return q},param:function(a,b){var d=[],e=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(b===c)b=h.ajaxSettings.traditional;
...
""}!i&&b.isLocal&&!b.crossDomain?i=m.text?200:404:i===1223&&(i=204)}}}catch(o){e||f(-1,o)}m&&f(i,j,m,t)};if(!b.async||k.readyState===4)d();else{g=++wb;if(Ca){if(!ea){ea={};h(a).unload(Ca)}ea[g]=d}k.onreadystatechange=d}},abort:function(){d&&d(0,1)}}}});var xa={},X,ca,xb=/^(?:toggle|show|hide)$/,yb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,ra,oa=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],na;h.fn.extend({show:function(a,
...
!1},ui:function(a){return{draggable:a.currentItem||a.element,helper:a.helper,position:a.position,offset:a.positionAbs}}});a.extend(a.ui.droppable,{version:"1.8.20"});a.ui.intersect=function(c,d,e){if(!d.offset)return!1;var f=(c.positionAbs||c.position.absolute).left,i=f+c.helperProportions.width,g=(c.positionAbs||c.position.absolute).top,b=g+c.helperProportions.height,j=d.offset.left,l=j+d.proportions.width,o=d.offset.top,n=o+d.proportions.height;switch(e){case "fit":return j<=f&&i<=l&&o<=g&&b<=n;
case "intersect":return j<f+c.helperProportions.width/2&&i-c.helperProportions.width/2<l&&o<g+c.helperProportions.height/2&&b-c.helperProportions.height/2<n;case "pointer":return a.ui.isOver((c.positionAbs||c.position.absolute).top+(c.clickOffset||c.offset.click).top,(c.positionAbs||c.position.absolute).left+(c.clickOffset||c.offset.click).left,o,j,d.proportions.height,d.proportions.width);case "touch":return(g>=o&&g<=n||b>=o&&b<=n||g<o&&b>n)&&(f>=j&&f<=l||i>=j&&i<=l||f<j&&i>l);default:return!1}};
...
this._vBoundaries,i=this.axis,g=d(a.width)&&c.maxWidth&&c.maxWidth<a.width,b=d(a.height)&&c.maxHeight&&c.maxHeight<a.height,j=d(a.width)&&c.minWidth&&c.minWidth>a.width,l=d(a.height)&&c.minHeight&&c.minHeight>a.height;j&&(a.width=c.minWidth);l&&(a.height=c.minHeight);g&&(a.width=c.maxWidth);b&&(a.height=c.maxHeight);var o=this.originalPosition.left+this.originalSize.width,n=this.position.top+this.size.height,m=/sw|nw|w/.test(i),i=/nw|ne|n/.test(i);j&&m&&(a.left=o-c.minWidth);g&&m&&(a.left=o-c.maxWidth);
...
c&&(d.size.width=d.size.height*d.aspectRatio))},stop:function(){var c=a(this).data("resizable"),d=c.options,i=c.containerOffset,g=c.containerPosition,b=c.containerElement,j=a(c.helper),l=j.offset(),o=j.outerWidth()-c.sizeDiff.width,j=j.outerHeight()-c.sizeDiff.height;c._helper&&!d.animate&&/relative/.test(b.css("position"))&&a(this).css({left:l.left-g.left-i.left,width:o,height:j});c._helper&&!d.animate&&/static/.test(b.css("position"))&&a(this).css({left:l.left-g.left-i.left,width:o,height:j})}});
...
this;this.dragged=!0;if(!this.options.disabled){var e=this.options,f=this.opos[0],i=this.opos[1],g=c.pageX,b=c.pageY;if(f>g)var j=g,g=f,f=j;i>b&&(j=b,b=i,i=j);this.helper.css({left:f,top:i,width:g-f,height:b-i});this.selectees.each(function(){var j=a.data(this,"selectable-item");if(j&&j.element!=d.element[0]){var o=false;e.tolerance=="touch"?o=!(j.left>g||j.right<f||j.top>b||j.bottom<i):e.tolerance=="fit"&&(o=j.left>f&&j.right<g&&j.top>i&&j.bottom<b);if(o){if(j.selected){j.$element.removeClass("ui-selected");
...
maroon:[128,0,0],navy:[0,0,128],olive:[128,128,0],orange:[255,165,0],pink:[255,192,203],purple:[128,0,128],violet:[128,0,128],red:[255,0,0],silver:[192,192,192],white:[255,255,255],yellow:[255,255,0],transparent:[255,255,255]},l=["add","remove","toggle"],o={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};a.effects.animateClass=function(b,c,d,g){a.isFunction(d)&&(g=d,d=null);return this.queue(function(){var j=a(this),o=j.attr("style")||
" ",y=f(e.call(this)),w,A=j.attr("class")||"";a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});w=f(e.call(this));j.attr("class",A);j.animate(i(y,w),{queue:false,duration:c,easing:d,complete:function(){a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});if(typeof j.attr("style")=="object"){j.attr("style").cssText="";j.attr("style").cssText=o}else j.attr("style",o);g&&g.apply(this,arguments);a.dequeue(this)}})})};a.fn.extend({_addClass:a.fn.addClass,addClass:function(b,c,d,e){return c?a.effects.animateClass.apply(this,
...
3);"show"==f&&d.css("opacity",0).css(l,"pos"==i?-g:g);"hide"==f&&(g/=2*b);"hide"!=f&&b--;if("show"==f){var o={opacity:1};o[l]=("pos"==i?"+=":"-=")+g;d.animate(o,j/2,c.options.easing);g/=2;b--}for(o=0;o<b;o++){var n={},m={};n[l]=("pos"==i?"-=":"+=")+g;m[l]=("pos"==i?"+=":"-=")+g;d.animate(n,j/2,c.options.easing).animate(m,j/2,c.options.easing);g="hide"==f?2*g:g/2}"hide"==f?(o={opacity:0},o[l]=("pos"==i?"-=":"+=")+g,d.animate(o,j/2,c.options.easing,function(){d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);
...
(function(a){a.effects.fold=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],f=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.size||15,g=!!c.options.horizFirst,b=c.duration?c.duration/2:a.fx.speeds._default/2;a.effects.save(d,e);d.show();var j=a.effects.createWrapper(d).css({overflow:"hidden"}),l="show"==f!=g,o=l?["width","height"]:["height","width"],l=l?[j.width(),j.height()]:[j.height(),j.width()],n=/([0-9]+)%/.exec(i);n&&(i=parseInt(n[1],
10)/100*l["hide"==f?0:1]);"show"==f&&j.css(g?{height:0,width:i}:{height:i,width:0});g={};n={};g[o[0]]="show"==f?l[0]:i;n[o[1]]="show"==f?l[1]:0;j.animate(g,b,c.options.easing).animate(n,b,c.options.easing,function(){"hide"==f&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
...
c.options.mode||"effect"),o=c.options.restore||!1,n=c.options.scale||"both",m=c.options.origin,r={height:d.height(),width:d.width()};d.from=c.options.from||r;d.to=c.options.to||r;m&&(m=a.effects.getBaseline(m,r),d.from.top=(r.height-d.from.height)*m.y,d.from.left=(r.width-d.from.width)*m.x,d.to.top=(r.height-d.to.height)*m.y,d.to.left=(r.width-d.to.width)*m.x);var s=d.from.height/r.height,p=d.from.width/r.width,q=d.to.height/r.height,y=d.to.width/r.width;if("box"==n||"both"==n)if(s!=q&&(e=e.concat(b),
d.from=a.effects.setTransition(d,b,s,d.from),d.to=a.effects.setTransition(d,b,q,d.to)),p!=y)e=e.concat(j),d.from=a.effects.setTransition(d,j,p,d.from),d.to=a.effects.setTransition(d,j,y,d.to);if(("content"==n||"both"==n)&&s!=q)e=e.concat(g),d.from=a.effects.setTransition(d,g,s,d.from),d.to=a.effects.setTransition(d,g,q,d.to);a.effects.save(d,o?e:f);d.show();a.effects.createWrapper(d);d.css("overflow","hidden").css(d.from);if("content"==n||"both"==n)b=b.concat(["marginTop","marginBottom"]).concat(g),
j=j.concat(["marginLeft","marginRight"]),i=e.concat(b).concat(j),d.find("*[width]").each(function(){var d=a(this);o&&a.effects.save(d,i);var e=d.height(),g=d.width();d.from={height:e*s,width:g*p};d.to={height:e*q,width:g*y};if(s!=q){d.from=a.effects.setTransition(d,b,s,d.from);d.to=a.effects.setTransition(d,b,q,d.to)}if(p!=y){d.from=a.effects.setTransition(d,j,p,d.from);d.to=a.effects.setTransition(d,j,y,d.to)}d.css(d.from);d.animate(d.to,c.duration,c.options.easing,function(){o&&a.effects.restore(d,
i)})});d.animate(d.to,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){d.to.opacity===0&&d.css("opacity",d.from.opacity);l=="hide"&&d.hide();a.effects.restore(d,o?e:f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.shake=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"];a.effects.setMode(d,c.options.mode||"effect");var f=c.options.direction||"left",i=c.options.distance||20,g=c.options.times||3,b=c.duration||c.options.duration||140;a.effects.save(d,e);d.show();a.effects.createWrapper(d);var j="up"==f||"down"==f?"top":"left",l="up"==f||"left"==f?"pos":"neg",f={},o={},n={};f[j]=("pos"==l?"-=":"+=")+i;o[j]=("pos"==l?"+=":"-=")+2*i;n[j]=("pos"==
l?"-=":"+=")+2*i;d.animate(f,b,c.options.easing);for(i=1;i<g;i++)d.animate(o,b,c.options.easing).animate(n,b,c.options.easing);d.animate(o,b,c.options.easing).animate(f,b/2,c.options.easing,function(){a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)});d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(jQuery);
...
d),i=f[0]===this.active[0];e.active=e.collapsible&&i?!1:this.headers.index(f);if(!(this.running||!e.collapsible&&i)){var g=this.active,b=f.next(),j=this.active.next(),l={options:e,newHeader:i&&e.collapsible?a([]):f,oldHeader:this.active,newContent:i&&e.collapsible?a([]):b,oldContent:j},o=this.headers.index(this.active[0])>this.headers.index(f[0]);this.active=i?a([]):f;this._toggle(b,j,l,i,o);g.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").children(".ui-icon").removeClass(e.icons.headerSelected).addClass(e.icons.header);
...
autoHeight:b.autoHeight||b.fillSpace};b.proxied||(b.proxied=b.animated);b.proxiedDuration||(b.proxiedDuration=b.duration);b.animated=a.isFunction(b.proxied)?b.proxied(e):b.proxied;b.duration=a.isFunction(b.proxiedDuration)?b.proxiedDuration(e):b.proxiedDuration;var f=a.ui.accordion.animations,l=b.duration,o=b.animated;o&&!f[o]&&!a.easing[o]&&(o="slide");f[o]||(f[o]=function(a){this.slide(a,{easing:o,duration:l||700})});f[o](e)}else b.collapsible&&f?c.toggle():(d.hide(),c.show()),j(!0);d.prev().attr({"aria-expanded":"false",
...
a(document).scrollLeft(),p=document.documentElement.clientHeight+a(document).scrollTop();c.left-=this._get(b,"isRTL")?e-f:0;c.left-=d&&c.left==b.input.offset().left?a(document).scrollLeft():0;c.top-=d&&c.top==b.input.offset().top+i?a(document).scrollTop():0;c.left-=Math.min(c.left,c.left+e>s&&s>e?Math.abs(c.left+e-s):0);c.top-=Math.min(c.top,c.top+g>p&&p>g?Math.abs(g+i):0);return c},_findPos:function(b){for(var c=this._get(this._getInst(b),"isRTL");b&&("hidden"==b.type||1!=b.nodeType||a.expr.filters.hidden(b));)b=
...
e="string"!=typeof e?e:(new Date).getFullYear()%100+parseInt(e,10),g=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,f=(d?d.dayNames:null)||this._defaults.dayNames,i=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,s=(d?d.monthNames:null)||this._defaults.monthNames,p=d=-1,q=-1,y=-1,w=!1,A=function(a){(a=H+1<b.length&&b.charAt(H+1)==a)&&H++;return a},E=function(a){var b=A(a),a=c.substring(F).match(RegExp("^\\d{1,"+("@"==a?14:"!"==a?20:"y"==a&&b?4:"o"==a?3:2)+"}"));if(!a)throw"Missing number at position "+
...
E("d");break;case "D":z("D",g,f);break;case "o":y=E("o");break;case "m":p=E("m");break;case "M":p=z("M",i,s);break;case "y":d=E("y");break;case "@":var D=new Date(E("@")),d=D.getFullYear(),p=D.getMonth()+1,q=D.getDate();break;case "!":D=new Date((E("!")-this._ticksTo1970)/1E4);d=D.getFullYear();p=D.getMonth()+1;q=D.getDate();break;case "'":A("'")?C():w=!0;break;default:C()}if(F<c.length)throw"Extra/unparsed characters found in date: "+c.substring(F);-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-
(new Date).getFullYear()%100+(d<=e?0:-100));if(-1<y){p=1;q=y;do{e=this._getDaysInMonth(d,p-1);if(q<=e)break;p++;q-=e}while(1)}D=this._daylightSavingAdjust(new Date(d,p-1,q));if(D.getFullYear()!=d||D.getMonth()+1!=p||D.getDate()!=q)throw"Invalid date";return D},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:864E9*(718685+Math.floor(492.5)-
Math.floor(19.7)+Math.floor(4.925)),formatDate:function(a,c,d){if(!c)return"";var e=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,g=(d?d.dayNames:null)||this._defaults.dayNames,f=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,d=(d?d.monthNames:null)||this._defaults.monthNames,i=function(c){(c=w+1<a.length&&a.charAt(w+1)==c)&&w++;return c},s=function(a,b,c){b=""+b;if(i(a))for(;b.length<c;)b="0"+b;return b},p=function(a,b,c,d){return i(a)?d[b]:c[b]},q="",y=!1;if(c)for(var w=0;w<
a.length;w++)if(y)"'"==a.charAt(w)&&!i("'")?y=!1:q+=a.charAt(w);else switch(a.charAt(w)){case "d":q+=s("d",c.getDate(),2);break;case "D":q+=p("D",c.getDay(),e,g);break;case "o":q+=s("o",Math.round(((new Date(c.getFullYear(),c.getMonth(),c.getDate())).getTime()-(new Date(c.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":q+=s("m",c.getMonth()+1,2);break;case "M":q+=p("M",c.getMonth(),f,d);break;case "y":q+=i("y")?c.getFullYear():(10>c.getYear()%100?"0":"")+c.getYear()%100;break;case "@":q+=
...
f=this._get(b,"navigationAsDateFormat"),r=this._getNumberOfMonths(b),s=this._get(b,"showCurrentAtPos"),p=this._get(b,"stepMonths"),q=1!=r[0]||1!=r[1],y=this._daylightSavingAdjust(!b.currentDay?new Date(9999,9,9):new Date(b.currentYear,b.currentMonth,b.currentDay)),w=this._getMinMaxDate(b,"min"),A=this._getMinMaxDate(b,"max"),s=b.drawMonth-s,E=b.drawYear;0>s&&(s+=12,E--);if(A)for(var z=this._daylightSavingAdjust(new Date(A.getFullYear(),A.getMonth()-r[0]*r[1]+1,A.getDate())),z=w&&z<w?w:z;this._daylightSavingAdjust(new Date(E,
s,1))>z;)s--,0>s&&(s=11,E--);b.drawMonth=s;b.drawYear=E;var z=this._get(b,"prevText"),z=!f?z:this.formatDate(z,this._daylightSavingAdjust(new Date(E,s-p,1)),this._getFormatConfig(b)),z=this._canAdjustMonth(b,-1,E,s)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', -"+p+", 'M');\" title=\""+z+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+z+"</span></a>":g?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+
z+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+z+"</span></a>",C=this._get(b,"nextText"),C=!f?C:this.formatDate(C,this._daylightSavingAdjust(new Date(E,s+p,1)),this._getFormatConfig(b)),g=this._canAdjustMonth(b,1,E,s)?'<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', +"+p+", 'M');\" title=\""+C+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+C+"</span></a>":g?"":'<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+
C+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+C+"</span></a>",p=this._get(b,"currentText"),C=this._get(b,"gotoCurrent")&&b.currentDay?y:c,p=!f?p:this.formatDate(p,C,this._getFormatConfig(b)),f=!b.inline?'<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_'+i+'.datepicker._hideDatepicker();">'+this._get(b,"closeText")+"</button>":"",e=e?'<div class="ui-datepicker-buttonpane ui-widget-content">'+(d?f:"")+(this._isInRange(b,
C)?'<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._gotoToday('#"+b.id+"');\">"+p+"</button>":"")+(d?"":f)+"</div>":"",f=parseInt(this._get(b,"firstDay"),10),f=isNaN(f)?0:f,p=this._get(b,"showWeek"),C=this._get(b,"dayNames");this._get(b,"dayNamesShort");var F=this._get(b,"dayNamesMin"),H=this._get(b,"monthNames"),D=this._get(b,"monthNamesShort"),v=this._get(b,"beforeShowDay"),O=this._get(b,"showOtherMonths"),
R=this._get(b,"selectOtherMonths");this._get(b,"calculateWeek");for(var h=this._getDefaultDate(b),S="",Q=0;Q<r[0];Q++){var P="";this.maxRows=4;for(var K=0;K<r[1];K++){var u=this._daylightSavingAdjust(new Date(E,s,b.selectedDay)),I=" ui-corner-all",G="";if(q){G+='<div class="ui-datepicker-group';if(1<r[1])switch(K){case 0:G+=" ui-datepicker-group-first";I=" ui-corner-"+(d?"right":"left");break;case r[1]-1:G+=" ui-datepicker-group-last";I=" ui-corner-"+(d?"left":"right");break;default:G+=" ui-datepicker-group-middle",
I=""}G+='">'}for(var G=G+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+I+'">'+(/all|left/.test(I)&&0==Q?d?g:z:"")+(/all|right/.test(I)&&0==Q?d?z:g:"")+this._generateMonthYearHeader(b,s,E,w,A,0<Q||0<K,H,D)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),M=p?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":"",I=0;7>I;I++)var k=(I+f)%7,M=M+("<th"+(5<=(I+f+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+C[k]+'">'+F[k]+"</span></th>");
G+=M+"</tr></thead><tbody>";M=this._getDaysInMonth(E,s);E==b.selectedYear&&s==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,M));I=(this._getFirstDayOfMonth(E,s)-f+7)%7;M=Math.ceil((I+M)/7);this.maxRows=M=q?this.maxRows>M?this.maxRows:M:M;for(var k=this._daylightSavingAdjust(new Date(E,s,1-I)),t=0;t<M;t++){for(var G=G+"<tr>",x=!p?"":'<td class="ui-datepicker-week-col">'+this._get(b,"calculateWeek")(k)+"</td>",I=0;7>I;I++){var J=v?v.apply(b.input?b.input[0]:null,[k]):[!0,""],L=k.getMonth()!=
s,N=L&&!R||!J[0]||w&&k<w||A&&k>A,x=x+('<td class="'+(5<=(I+f+6)%7?" ui-datepicker-week-end":"")+(L?" ui-datepicker-other-month":"")+(k.getTime()==u.getTime()&&s==b.selectedMonth&&b._keyEvent||h.getTime()==k.getTime()&&h.getTime()==u.getTime()?" "+this._dayOverClass:"")+(N?" "+this._unselectableClass+" ui-state-disabled":"")+(L&&!O?"":" "+J[1]+(k.getTime()==y.getTime()?" "+this._currentClass:"")+(k.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!L||O)&&J[2]?' title="'+J[2]+'"':"")+(N?"":
' onclick="DP_jQuery_'+i+".datepicker._selectDay('#"+b.id+"',"+k.getMonth()+","+k.getFullYear()+', this);return false;"')+">"+(L&&!O?"&#xa0;":N?'<span class="ui-state-default">'+k.getDate()+"</span>":'<a class="ui-state-default'+(k.getTime()==c.getTime()?" ui-state-highlight":"")+(k.getTime()==y.getTime()?" ui-state-active":"")+(L?" ui-priority-secondary":"")+'" href="#">'+k.getDate()+"</a>")+"</td>");k.setDate(k.getDate()+1);k=this._daylightSavingAdjust(k)}G+=x+"</tr>"}s++;11<s&&(s=0,E++);G+="</tbody></table>"+
(q?"</div>"+(0<r[0]&&K==r[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");P+=G}S+=P}S+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return S},_generateMonthYearHeader:function(a,c,d,e,g,f,r,s){var p=this._get(a,"changeMonth"),q=this._get(a,"changeYear"),y=this._get(a,"showMonthAfterYear"),w='<div class="ui-datepicker-title">',A="";if(f||!p)A+='<span class="ui-datepicker-month">'+
r[c]+"</span>";else{for(var r=e&&e.getFullYear()==d,E=g&&g.getFullYear()==d,A=A+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),z=0;12>z;z++)if((!r||z>=e.getMonth())&&(!E||z<=g.getMonth()))A+='<option value="'+z+'"'+(z==c?' selected="selected"':"")+">"+s[z]+"</option>";A+="</select>"}y||(w+=A+(f||!p||!q?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",f||!q)w+='<span class="ui-datepicker-year">'+d+"</span>";else{var s=this._get(a,
...
handle:".ui-dialog-titlebar",containment:"document",start:function(e,j){f="auto"===b.height?"auto":a(this).height();a(this).height(a(this).height()).addClass("ui-dialog-dragging");d._trigger("dragStart",e,c(j))},drag:function(a,b){d._trigger("drag",a,c(b))},stop:function(o,n){b.position=[n.position.left-e.scrollLeft(),n.position.top-e.scrollTop()];a(this).removeClass("ui-dialog-dragging").height(f);d._trigger("dragStop",o,c(n));a.ui.dialog.overlay.resize()}})},_makeResizable:function(d){function e(a){return{originalPosition:a.originalPosition,
...
(function(a){a.ui=a.ui||{};var c=/left|center|right/,d=/top|center|bottom/,e,f=a.fn.position,i=a.fn.offset;a.fn.position=function(g){if(!g||!g.of)return f.apply(this,arguments);var g=a.extend({},g),b=a(g.of),i=b[0],l=(g.collision||"flip").split(" "),o=g.offset?g.offset.split(" "):[0,0],n,m,r;9===i.nodeType?(n=b.width(),m=b.height(),r={top:0,left:0}):i.setTimeout?(n=b.width(),m=b.height(),r={top:b.scrollTop(),left:b.scrollLeft()}):i.preventDefault?(g.at="left top",n=m=0,r={top:g.of.pageY,left:g.of.pageX}):
(n=b.outerWidth(),m=b.outerHeight(),r=b.offset());a.each(["my","at"],function(){var a=(g[this]||"").split(" ");a.length===1&&(a=c.test(a[0])?a.concat(["center"]):d.test(a[0])?["center"].concat(a):["center","center"]);a[0]=c.test(a[0])?a[0]:"center";a[1]=d.test(a[1])?a[1]:"center";g[this]=a});1===l.length&&(l[1]=l[0]);o[0]=parseInt(o[0],10)||0;1===o.length&&(o[1]=o[0]);o[1]=parseInt(o[1],10)||0;"right"===g.at[0]?r.left+=n:"center"===g.at[0]&&(r.left+=n/2);"bottom"===g.at[1]?r.top+=m:"center"===g.at[1]&&
...
if(!e){z.left=Math.round(z.left);z.top=Math.round(z.top)}C={left:z.left-f,top:z.top-i};a.each(["left","top"],function(b,e){if(a.ui.position[l[b]])a.ui.position[l[b]][e](z,{targetWidth:n,targetHeight:m,elemWidth:c,elemHeight:d,collisionPosition:C,collisionWidth:j,collisionHeight:E,offset:o,my:g.my,at:g.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(z,{using:g.using}))})};a.ui.position={fit:{left:function(c,b){var d=a(window),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft();
...
(function(a,c,d,e){function f(a,b,c){K[a]=c;u[a]=b;P||(P=a)}function i(b){P!==b&&(P=b,a.ui.editor.eachInstance(function(){this.reinit()}))}function g(a,b){P&&K[P]&&K[P][a]&&(a=K[P][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function b(b){if(I===e){I=!0;if(G=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(b.options.baseClass+"-ios"),G&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height",
...
return d}function r(b,c){var d=a("<div/>").append(b)[0].childNodes;c.deleteContents();d.length===e||1===d.length?c.insertNode(d[0].cloneNode(!0)):a.each(d,function(a,b){c.insertNodeAtEnd(b.cloneNode(!0))})}function s(b){var b=b||d.getSelection(),c;a(b.getAllRanges()).each(function(b,d){c=3===this.commonAncestorContainer.nodeType?a(d.commonAncestorContainer).parent()[0]:d.commonAncestorContainer});return c}function p(a){if(!M||a)M=d.saveSelection()}function q(){M&&(d.restoreSelection(M),M=!1)}function y(a,
...
d.createRange();a.selectNodeContents(this);a.collapse(e);c.addRange(a)})}function C(a){a=a||d.getSelection();return a.toHtml()}function F(b){b=b||d.getSelection().getRangeAt(0);return a(3===b.commonAncestorContainer.nodeType?b.commonAncestorContainer.parentNode:b.commonAncestorContainer)}function H(a){var b=new jQuery;y(function(a){b.push(F(a)[0])},a,this);return b}function D(){var b=d.getSelection();if(null===b.anchorNode)return null;if(b.isBackwards())return 3===b.focusNode.nodeType?a(b.focusNode.parentElement):
...
c?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(b,c,d){y(function(d){a(b).each(function(){d.insertNodeAtEnd(!1===c?this:this.cloneNode(!0))})},d,this)},toggleBlockStyle:function(b,c){y(function(d){for(d=a(d.commonAncestorContainer);d.length&&d[0]!==c[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===c[0]&&"inline"!==c.css("display")&&(this.wrapInner(c,"div"),d=c.children().first());this.toggleStyle(d,b)},null,this)},wrapInner:function(b,c){p();a(b).each(function(){var d=
a("<"+c+"/>").html(a(this).html());b.html(d)});q()},inverseWrapWithTagClass:function(b,c,e,f){p();var g="domTools"+Math.ceil(1E7*Math.random());y(function(a){var b=d.createCssClassApplier(f,{elementTagName:e});b.isAppliedToRange(a)?b.toggleSelection():d.createCssClassApplier(c,{elementTagName:g}).toggleSelection()},null,this);a(g).each(function(){a(this).replaceWith(a("<"+b+"/>").addClass(c).html(a(this).html()))});q()},toggleStyle:function(b,c){a.each(c,function(c,d){a(b).css(c)===d?a(b).css(c,""):
...
a.getElement())}})}},alignCenter:{init:function(a){return a.uiButton({title:g("Center Align"),click:function(){a.toggleBlockStyle({"text-align":"center"},a.getElement())}})}},alignRight:{init:function(a){return a.uiButton({title:g("Right Align"),click:function(){a.toggleBlockStyle({"text-align":"right"},a.getElement())}})}}});a.ui.editor.registerUi({textBold:{hotkeys:{"ctrl+b":{action:function(){this.ui.click()}}},init:function(a,b){return this.editor.uiButton({title:g("Bold"),click:function(){O("strong",
{classes:b.classes||b.cssPrefix+"bold"})}})}},textItalic:{hotkeys:{"ctrl+i":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:g("Italic"),click:function(){O("em",{classes:b.classes||b.cssPrefix+"italic"})}})}},textUnderline:{hotkeys:{"ctrl+u":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:g("Underline"),click:function(){O("u",{classes:b.classes||b.cssPrefix+"underline"})}})}},textStrike:{hotkeys:{"ctrl+k":{action:function(){this.ui.click()}}},
init:function(a,b){return a.uiButton({title:g("Strikethrough"),click:function(){O("del",{classes:b.classes||b.cssPrefix+"strike"})}})}},textSub:{init:function(a,b){return a.uiButton({title:g("Sub script"),click:function(){O("sub",{classes:b.classes||b.cssPrefix+"sub"})}})}},textSuper:{init:function(a,b){return a.uiButton({title:g("Super script"),click:function(){O("sup",{classes:b.classes||b.cssPrefix+"super"})}})}}});a.ui.editor.registerUi({quoteBlock:{init:function(a,b){return a.uiButton({title:g("Blockquote"),
icon:"ui-icon-quote",click:function(){O("blockquote",{classes:b.classes||b.cssPrefix+"blockquote"})}})}}});a.ui.editor.registerUi({cancel:{hotkeys:{"ctrl+k":{action:function(){this.ui.click()}}},init:function(a){return a.uiButton({name:"cancel",title:g("Cancel"),icons:{primary:"ui-icon-cancel"},dialog:null,click:function(){this.confirm()}})},confirm:function(){var b=this.editor.getPlugin("cancel"),c=this.editor;c.isDirty()?(this.dialog||(this.dialog=a(c.getTemplate("cancel.dialog"))),this.dialog.dialog({modal:!0,
...
e;for(e in K){var f=a('<option value="'+e+'" class="'+e+'"/>');f.html(u[e]);P===e&&f.attr("selected","selected");d.append(f)}return b.uiSelectMenu({title:g("Change Language"),select:d,change:function(a){i(c.persist("locale",a))}})}}});f("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"Apply Source","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",
