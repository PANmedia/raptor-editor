...
*/
window.rangy=function(){function a(a,b){var c=typeof a[b];return c==l||!!(c==k&&a[b])||"unknown"==c}function c(a,b){return!!(typeof a[b]==k&&a[b])}function d(a,b){return typeof a[b]!=o}function e(a){return function(b,c){for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0}}function g(a){return a&&q(a,s)&&y(a,r)}function i(a){window.alert("Rangy not supported in your browser. Reason: "+a);x.initialized=!0;x.supported=!1}function f(){if(!x.initialized){var b,d=!1,e=!1;a(document,"createRange")&&
(b=document.createRange(),q(b,m)&&y(b,n)&&(d=!0),b.detach());if((b=c(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(b,"createTextRange"))b=b.createTextRange(),g(b)&&(e=!0);!d&&!e&&i("Neither Range nor TextRange are implemented");x.initialized=!0;x.features={implementsDomRange:d,implementsTextRange:e};d=D.concat(z);e=0;for(b=d.length;e<b;++e)try{d[e](x)}catch(k){c(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
...
r="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),s="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),q=e(a),p=e(c),y=e(d),x={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:a,isHostObject:c,isHostProperty:d,areHostMethods:q,areHostObjects:p,areHostProperties:y,isTextRange:g},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
x.fail=i;x.warn=function(a){a="Rangy warning: "+a;x.config.alertOnWarn?window.alert(a):typeof window.console!=o&&typeof window.console.log!=o&&window.console.log(a)};({}).hasOwnProperty?x.util.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])}:i("hasOwnProperty not supported");var z=[],D=[];x.init=f;x.addInitListener=function(a){x.initialized?a(x):z.push(a)};var A=[];x.addCreateMissingNativeApiListener=function(a){A.push(a)};x.createMissingNativeApi=function(a){a=a||window;f();
...
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function q(a,b,c){this.nodes=n(a,b,c);this._next=this.nodes[0];this._position=0}function p(a){return function(b,c){for(var j,d=c?b:b.parentNode;d;){j=d.nodeType;if(t.arrayContains(a,j))return d;d=d.parentNode}return null}}function y(a,b){if(v(a,b))throw new s("INVALID_NODE_TYPE_ERR");}function x(a){if(!a.startContainer)throw new E("INVALID_STATE_ERR");}function z(a,b){if(!t.arrayContains(b,a.nodeType))throw new s("INVALID_NODE_TYPE_ERR");
...
detach:function(){this._current=this._next=this.nodes=null}};var N=[1,3,4,5,7,8,10],I=[2,9,11],T=[1,3,4,5,7,8,10,11],Y=[1,3,4,5,7,8],Q=t.getRootContainer,j=p([9,11]),u=p([5,6,10,12]),v=p([6,10,12]),J=document.createElement("style"),P=!1;try{J.innerHTML="<b>x</b>",P=3==J.firstChild.nodeType}catch(U){}a.features.htmlParsingConforms=P;var X="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),Z=0,ja=1,va=2,ma=3,ka=0,na=1,oa=2,la=3;w.prototype={attachListener:function(a,
b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){C(this);A(this.startContainer,b.startContainer);var c=a==ma||a==Z?"start":"end",j=a==ja||a==Z?"start":"end";return t.comparePoints(this[c+"Container"],this[c+"Offset"],b[j+"Container"],b[j+"Offset"])},insertNode:function(a){C(this);z(a,T);B(this.startContainer);if(t.isAncestorOf(a,this.startContainer,!0))throw new E("HIERARCHY_REQUEST_ERR");this.setStartBefore(f(a,this.startContainer,this.startOffset))},cloneContents:function(){C(this);
...
this);a.detach();return!b},surroundContents:function(a){z(a,Y);if(!this.canSurroundContents())throw new s("BAD_BOUNDARYPOINTS_ERR");var b=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);f(a,this.startContainer,this.startOffset);a.appendChild(b);this.selectNode(a)},cloneRange:function(){C(this);for(var a=new L(d(this)),b=X.length,c;b--;)c=X[b],a[c]=this[c];return a},toString:function(){C(this);var a=this.startContainer;if(a===this.endContainer&&t.isCharacterDataNode(a))return 3==
...
this.collapse(!0)},getName:function(){return"DomRange"},equals:function(a){return L.rangesEqual(this,a)},isValid:function(){return O(this)},inspect:function(){return m(this)}};S(L,V,function(a){x(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;e(a,"detach",null);a._listeners=null});a.rangePrototype=w.prototype;L.rangeProperties=X;L.RangeIterator=r;L.copyComparisonConstants=G;L.createPrototypeRange=S;L.inspect=m;L.getRangeDocument=d;L.rangesEqual=
...
[];this.win=c;this.refresh()}function m(a,c){for(var d=q.getDocument(c[0].startContainer),d=q.getBody(d).createControlRange(),h=0,g;h<rangeCount;++h){g=b(c[h]);try{d.add(g)}catch(e){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();l(a)}function r(a,b){if(a.anchorNode&&q.getDocument(a.anchorNode)!==q.getDocument(b))throw new z("WRONG_DOCUMENT_ERR");}function s(a){var b=[],c=new D(a.anchorNode,a.anchorOffset),
d=new D(a.focusNode,a.focusOffset),h="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var g=0,e=a.rangeCount;g<e;++g)b[g]=y.inspect(a.getRangeAt(g));return"["+h+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var q=a.dom,p=a.util,y=a.DomRange,x=a.WrappedRange,z=a.DOMException,D=q.DomPosition,A,B,F=a.util.isHostMethod(window,"getSelection"),
...
for(;a--;)if(!y.rangesEqual(b[a],this._ranges[a]))return false;return true}};var I=function(a,b){var c=a.getAllRanges(),d=false;a.removeAllRanges();for(var h=0,g=c.length;h<g;++h)d||b!==c[h]?a.addRange(c[h]):d=true;a.rangeCount||i(a)};t.removeRange=L?function(a){if(this.docSelection.type=="Control"){for(var c=this.docSelection.createRange(),a=b(a),d=q.getDocument(c.item(0)),d=q.getBody(d).createControlRange(),h,g=false,e=0,f=c.length;e<f;++e){h=c.item(e);h!==a||g?d.add(c.item(e)):g=true}d.select();
...
c);this.removeAllRanges();this.addRange(d);this.isCollapsed=true};t.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new z("INVALID_STATE_ERR");};t.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new z("INVALID_STATE_ERR");};t.selectAllChildren=function(b){r(this,b);var c=a.createRange(q.getDocument(b));c.selectNodeContents(b);this.removeAllRanges();
...
0,d=this._ranges.length;c<d;++c)if(this._ranges[c].containsNode(a,b))return true;return false};t.toHtml=function(){var a="";if(this.rangeCount){for(var a=y.getRangeDocument(this._ranges[0]).createElement("div"),b=0,c=this._ranges.length;b<c;++b)a.appendChild(this._ranges[b].cloneContents());a=a.innerHTML}return a};t.getName=function(){return"WrappedSelection"};t.inspect=function(){return s(this)};t.detach=function(){this.win=this.anchorNode=this.focusNode=this.win._rangySelection=null};n.inspect=
...
r(a.nextSibling)}function q(a,b,d,g){var e,f=0==d;if(z.isAncestorOf(b,a))return a;if(z.isCharacterDataNode(b))if(0==d)d=z.getNodeIndex(b),b=b.parentNode;else if(d==b.length)d=z.getNodeIndex(b)+1,b=b.parentNode;else throw c.createError("splitNodeAt should not be called with offset in the middle of a data node ("+d+" in "+b.data);if(z.isCharacterDataNode(b)?0==d?b.previousSibling:d==b.length?b.nextSibling:1:0<d&&d<b.childNodes.length){if(!e){e=b.cloneNode(!1);for(e.id&&e.removeAttribute("id");f=b.childNodes[d];)e.appendChild(f);
z.insertAfter(e,b)}return b==a?e:q(a,e.parentNode,z.getNodeIndex(e),g)}return a!=b?(e=b.parentNode,b=z.getNodeIndex(b),f||b++,q(a,e,b,g)):a}function p(a){var b=a?"nextSibling":"previousSibling";return function(c,d){var g=c.parentNode,e=c[b];if(e){if(e&&3==e.nodeType)return e}else if(d&&(e=g[b])&&1==e.nodeType&&g.tagName==e.tagName&&i(g,e)&&l(g,e))return e[a?"firstChild":"lastChild"];return null}}function y(a){this.firstTextNode=(this.isElementMerge=1==a.nodeType)?a.lastChild:a;this.textNodes=[this.firstTextNode]}
...
a.restoreSelection=function(b,d){if(!b.restored){for(var g=b.rangeInfos,f=a.getSelection(b.win),i=[],r=g.length,s=r-1,q,p;0<=s;--s){q=g[s];p=a.createRange(b.doc);if(q.collapsed)if(q=(b.doc||document).getElementById(q.markerId)){q.style.display="inline";var y=q.previousSibling;y&&3==y.nodeType?(q.parentNode.removeChild(q),p.collapseToPoint(y,y.length)):(p.collapseBefore(q),q.parentNode.removeChild(q))}else c.warn("Marker element has been removed. Cannot restore selection.");else e(b.doc,p,q.startMarkerId,
...
typeof b&&(c=b,b="*");if(h.isFunction(c))for(var d=b.toLowerCase().split(La),j=0,e=d.length,g,f;j<e;j++)g=d[j],(f=/^\+/.test(g))&&(g=g.substr(1)||"*"),g=a[g]=a[g]||[],g[f?"unshift":"push"](c)}}function y(a,b,d,j,e,g){e=e||b.dataTypes[0];g=g||{};g[e]=!0;for(var e=a[e],f=0,i=e?e.length:0,h=a===xa,k;f<i&&(h||!k);f++)k=e[f](b,d,j),"string"===typeof k&&(!h||g[k]?k=c:(b.dataTypes.unshift(k),k=y(a,b,d,j,k,g)));if((h||!k)&&!g["*"])k=y(a,b,d,j,"*",g);return k}function x(a,b){var d,j,e=h.ajaxSettings.flatOptions||
{};for(d in b)b[d]!==c&&((e[d]?a:j||(j={}))[d]=b[d]);j&&h.extend(!0,a,j)}function z(a,b,c,d){if(h.isArray(b))h.each(b,function(b,j){c||db.test(a)?d(a,j):z(a+"["+("object"===typeof j?b:"")+"]",j,c,d)});else if(!c&&"object"===h.type(b))for(var j in b)z(a+"["+j+"]",b[j],c,d);else d(a,b)}function D(){try{return new a.XMLHttpRequest}catch(b){}}function A(){setTimeout(B,0);return pa=h.now()}function B(){pa=c}function F(a,b){var c={};h.each(qa.concat.apply([],qa.slice(0,b)),function(){c[this]=a});return c}
function O(a){if(!ya[a]){var b=w.body,c=h("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d){$||($=w.createElement("iframe"),$.frameBorder=$.width=$.height=0);b.appendChild($);if(!ga||!$.createElement)ga=($.contentWindow||$.contentDocument).document,ga.write((h.support.boxModel?"<!doctype html>":"")+"<html><body>"),ga.close();c=ga.createElement(a);ga.body.appendChild(c);d=h.css(c,"display");b.removeChild($)}ya[a]=d}return ya[a]}function C(a){return h.isWindow(a)?a:9===a.nodeType?
...
o=/(webkit)[ \/]([\w.]+)/,r=/(opera)(?:.*version)?[ \/]([\w.]+)/,J=/(msie) ([\w.]+)/,s=/(mozilla)(?:.*? rv:([\w.]+))?/,q=/-([a-z]|[0-9])/ig,P=/^-ms-/,p=function(a,b){return(b+"").toUpperCase()},U=R.userAgent,ra,ha,eb=Object.prototype.toString,za=Object.prototype.hasOwnProperty,Aa=Array.prototype.push,x=Array.prototype.slice,y=String.prototype.trim,t=Array.prototype.indexOf,X={};d.fn=d.prototype={constructor:d,init:function(a,b,j){var e;if(!a)return this;if(a.nodeType)return this.context=this[0]=a,
...
c&&b()}}},isFunction:function(a){return"function"===d.type(a)},isArray:Array.isArray||function(a){return"array"===d.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!isNaN(parseFloat(a))&&isFinite(a)},type:function(a){return null==a?""+a:X[eb.call(a)]||"object"},isPlainObject:function(a){if(!a||"object"!==d.type(a)||a.nodeType||d.isWindow(a))return!1;try{if(a.constructor&&!za.call(a,"constructor")&&!za.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(b){return!1}for(var j in a);
...
if(j)if(f)for(e in a){if(!1===b.apply(a[e],j))break}else for(;K<g&&!1!==b.apply(a[K++],j););else if(f)for(e in a){if(!1===b.call(a[e],e,a[e]))break}else for(;K<g&&!1!==b.call(a[K],K,a[K++]););return a},trim:y?function(a){return null==a?"":y.call(a)}:function(a){return null==a?"":a.toString().replace(h,"").replace(k,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var j=d.type(a);null==a.length||"string"===j||"function"===j||"regexp"===j||d.isWindow(a)?Aa.call(c,a):d.merge(c,a)}return c},inArray:function(a,
...
{set:function(a,b){if(h.isArray(b))return a.checked=h.inArray(h(a).val(),b)>=0}})});var J=/^(?:textarea|input|select)$/i,P=/^([^\.]*)?(?:\.(.+))?$/,U=/(?:^|\s)hover(\.\S+)?\b/,X=/^key/,Z=/^(?:mouse|contextmenu)|click/,ja=/^(?:focusinfocus|focusoutblur)$/,va=/^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/,ma=function(a){if(a=va.exec(a)){a[1]=(a[1]||"").toLowerCase();a[3]=a[3]&&RegExp("(?:^|\\s)"+a[3]+"(?:\\s|$)")}return a},ka=function(a){return h.event.special.hover?a:a.replace(U,"mouseenter$1 mouseleave$1")};
...
a>0?4:0;var n,J,K,l=b;if(v){var P=j,U=p,x=P.contents,aa=P.dataTypes,y=P.responseFields,t,w,ba,X;for(w in y)w in v&&(U[y[w]]=v[w]);for(;aa[0]==="*";){aa.shift();t===c&&(t=P.mimeType||U.getResponseHeader("content-type"))}if(t)for(w in x)if(x[w]&&x[w].test(t)){aa.unshift(w);break}if(aa[0]in v)ba=aa[0];else{for(w in v){if(!aa[0]||P.converters[w+" "+aa[0]]){ba=w;break}X||(X=w)}ba=ba||X}if(ba){ba!==aa[0]&&aa.unshift(ba);v=v[ba]}else v=void 0}else v=c;if(a>=200&&a<300||a===304){if(j.ifModified){if(t=p.getResponseHeader("Last-Modified"))h.lastModified[u]=
t;if(t=p.getResponseHeader("Etag"))h.etag[u]=t}if(a===304){l="notmodified";n=true}else try{t=j;t.dataFilter&&(v=t.dataFilter(v,t.dataType));var z=t.dataTypes;w={};var A,D,F=z.length,Z,B=z[0],C,E,G,H,I;for(A=1;A<F;A++){if(A===1)for(D in t.converters)typeof D==="string"&&(w[D.toLowerCase()]=t.converters[D]);C=B;B=z[A];if(B==="*")B=C;else if(C!=="*"&&C!==B){E=C+" "+B;G=w[E]||w["* "+B];if(!G){I=c;for(H in w){Z=H.split(" ");if(Z[0]===C||Z[0]==="*")if(I=w[Z[1]+" "+B]){H=w[H];H===true?G=I:I===true&&(G=H);
...
80:443))!=(ea[3]||(ea[1]==="http:"?80:443))))}if(j.data&&j.processData&&typeof j.data!=="string")j.data=h.param(j.data,j.traditional);y(xa,j,b,p);if(s===2)return false;q=j.global;j.type=j.type.toUpperCase();j.hasContent=!qb.test(j.type);q&&h.active++===0&&h.event.trigger("ajaxStart");if(!j.hasContent){if(j.data){j.url=j.url+((Pa.test(j.url)?"&":"?")+j.data);delete j.data}u=j.url;if(j.cache===false){J=h.now();var U=j.url.replace(ub,"$1_="+J);j.url=U+(U===j.url?(Pa.test(j.url)?"&":"?")+"_="+J:"")}}(j.data&&
...
""}!i&&b.isLocal&&!b.crossDomain?i=v.text?200:404:i===1223&&(i=204)}}}catch(o){j||e(-1,o)}v&&e(i,k,v,u)};if(!b.async||g.readyState===4)d();else{f=++wb;if(Da){if(!ia){ia={};h(a).unload(Da)}ia[f]=d}g.onreadystatechange=d}},abort:function(){d&&d(0,1)}}}});var ya={},$,ga,xb=/^(?:toggle|show|hide)$/,yb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,ta,qa=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],pa;h.fn.extend({show:function(a,
...
f=d.offset.left,b=f+e.helperProportions.width,k=d.offset.top,l=k+e.helperProportions.height,o=e.snapElements.length-1;0<=o;o--){var n=e.snapElements[o].left,m=n+e.snapElements[o].width,r=e.snapElements[o].top,s=r+e.snapElements[o].height;if(n-i<f&&f<m+i&&r-i<k&&k<s+i||n-i<f&&f<m+i&&r-i<l&&l<s+i||n-i<b&&b<m+i&&r-i<k&&k<s+i||n-i<b&&b<m+i&&r-i<l&&l<s+i){if("inner"!=g.snapMode){var q=Math.abs(r-l)<=i,p=Math.abs(s-k)<=i,y=Math.abs(n-b)<=i,x=Math.abs(m-f)<=i;q&&(d.position.top=e._convertPositionTo("relative",
{top:r-e.helperProportions.height,left:0}).top-e.margins.top);p&&(d.position.top=e._convertPositionTo("relative",{top:s,left:0}).top-e.margins.top);y&&(d.position.left=e._convertPositionTo("relative",{top:0,left:n-e.helperProportions.width}).left-e.margins.left);x&&(d.position.left=e._convertPositionTo("relative",{top:0,left:m}).left-e.margins.left)}var z=q||p||y||x;if("outer"!=g.snapMode&&(q=Math.abs(r-k)<=i,p=Math.abs(s-l)<=i,y=Math.abs(n-f)<=i,x=Math.abs(m-b)<=i,q&&(d.position.top=e._convertPositionTo("relative",
{top:r,left:0}).top-e.margins.top),p&&(d.position.top=e._convertPositionTo("relative",{top:s-e.helperProportions.height,left:0}).top-e.margins.top),y&&(d.position.left=e._convertPositionTo("relative",{top:0,left:n}).left-e.margins.left),x))d.position.left=e._convertPositionTo("relative",{top:0,left:m-e.helperProportions.width}).left-e.margins.left;!e.snapElements[o].snapping&&(q||p||y||x||z)&&e.options.snap.snap&&e.options.snap.snap.call(e.element,c,a.extend(e._uiHash(),{snapItem:e.snapElements[o].item}));
e.snapElements[o].snapping=q||p||y||x||z}else e.snapElements[o].snapping&&e.options.snap.release&&e.options.snap.release.call(e.element,c,a.extend(e._uiHash(),{snapItem:e.snapElements[o].item})),e.snapElements[o].snapping=!1}}});a.ui.plugin.add("draggable","stack",{start:function(){var c=a(this).data("draggable").options,c=a.makeArray(a(c.stack)).sort(function(c,d){return(parseInt(a(c).css("zIndex"),10)||0)-(parseInt(a(d).css("zIndex"),10)||0)});if(c.length){var d=parseInt(c[0].style.zIndex)||0;a(c).each(function(a){this.style.zIndex=
...
" ",y=g(e.call(this)),x,z=k.attr("class")||"";a.each(l,function(a,c){if(b[c])k[c+"Class"](b[c])});x=g(e.call(this));k.attr("class",z);k.animate(i(y,x),{queue:false,duration:c,easing:d,complete:function(){a.each(l,function(a,c){if(b[c])k[c+"Class"](b[c])});if(typeof k.attr("style")=="object"){k.attr("style").cssText="";k.attr("style").cssText=o}else k.attr("style",o);f&&f.apply(this,arguments);a.dequeue(this)}})})};a.fn.extend({_addClass:a.fn.addClass,addClass:function(b,c,d,e){return c?a.effects.animateClass.apply(this,
...
c.options.mode||"effect"),o=c.options.restore||!1,n=c.options.scale||"both",m=c.options.origin,r={height:d.height(),width:d.width()};d.from=c.options.from||r;d.to=c.options.to||r;m&&(m=a.effects.getBaseline(m,r),d.from.top=(r.height-d.from.height)*m.y,d.from.left=(r.width-d.from.width)*m.x,d.to.top=(r.height-d.to.height)*m.y,d.to.left=(r.width-d.to.width)*m.x);var s=d.from.height/r.height,q=d.from.width/r.width,p=d.to.height/r.height,y=d.to.width/r.width;if("box"==n||"both"==n)if(s!=p&&(e=e.concat(b),
d.from=a.effects.setTransition(d,b,s,d.from),d.to=a.effects.setTransition(d,b,p,d.to)),q!=y)e=e.concat(k),d.from=a.effects.setTransition(d,k,q,d.from),d.to=a.effects.setTransition(d,k,y,d.to);if(("content"==n||"both"==n)&&s!=p)e=e.concat(f),d.from=a.effects.setTransition(d,f,s,d.from),d.to=a.effects.setTransition(d,f,p,d.to);a.effects.save(d,o?e:g);d.show();a.effects.createWrapper(d);d.css("overflow","hidden").css(d.from);if("content"==n||"both"==n)b=b.concat(["marginTop","marginBottom"]).concat(f),
k=k.concat(["marginLeft","marginRight"]),i=e.concat(b).concat(k),d.find("*[width]").each(function(){var d=a(this);o&&a.effects.save(d,i);var e=d.height(),f=d.width();d.from={height:e*s,width:f*q};d.to={height:e*p,width:f*y};if(s!=p){d.from=a.effects.setTransition(d,b,s,d.from);d.to=a.effects.setTransition(d,b,p,d.to)}if(q!=y){d.from=a.effects.setTransition(d,k,q,d.from);d.to=a.effects.setTransition(d,k,y,d.to)}d.css(d.from);d.animate(d.to,c.duration,c.options.easing,function(){o&&a.effects.restore(d,
...
e="string"!=typeof e?e:(new Date).getFullYear()%100+parseInt(e,10),f=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,g=(d?d.dayNames:null)||this._defaults.dayNames,i=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,s=(d?d.monthNames:null)||this._defaults.monthNames,q=d=-1,p=-1,y=-1,x=!1,z=function(a){(a=O+1<b.length&&b.charAt(O+1)==a)&&O++;return a},D=function(a){var b=z(a),a=c.substring(F).match(RegExp("^\\d{1,"+("@"==a?14:"!"==a?20:"y"==a&&b?4:"o"==a?3:2)+"}"));if(!a)throw"Missing number at position "+
F;F+=a[0].length;return parseInt(a[0],10)},A=function(b,d,e){var b=a.map(z(b)?e:d,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)}),f=-1;a.each(b,function(a,b){var d=b[1];if(c.substr(F,d.length).toLowerCase()==d.toLowerCase())return f=b[0],F+=d.length,!1});if(-1!=f)return f+1;throw"Unknown name at position "+F;},B=function(){if(c.charAt(F)!=b.charAt(O))throw"Unexpected literal at position "+F;F++},F=0,O=0;O<b.length;O++)if(x)"'"==b.charAt(O)&&!z("'")?x=!1:B();else switch(b.charAt(O)){case "d":p=
D("d");break;case "D":A("D",f,g);break;case "o":y=D("o");break;case "m":q=D("m");break;case "M":q=A("M",i,s);break;case "y":d=D("y");break;case "@":var C=new Date(D("@")),d=C.getFullYear(),q=C.getMonth()+1,p=C.getDate();break;case "!":C=new Date((D("!")-this._ticksTo1970)/1E4);d=C.getFullYear();q=C.getMonth()+1;p=C.getDate();break;case "'":z("'")?B():x=!0;break;default:B()}if(F<c.length)throw"Extra/unparsed characters found in date: "+c.substring(F);-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-
(new Date).getFullYear()%100+(d<=e?0:-100));if(-1<y){q=1;p=y;do{e=this._getDaysInMonth(d,q-1);if(p<=e)break;q++;p-=e}while(1)}C=this._daylightSavingAdjust(new Date(d,q-1,p));if(C.getFullYear()!=d||C.getMonth()+1!=q||C.getDate()!=p)throw"Invalid date";return C},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:864E9*(718685+Math.floor(492.5)-
Math.floor(19.7)+Math.floor(4.925)),formatDate:function(a,c,d){if(!c)return"";var e=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,f=(d?d.dayNames:null)||this._defaults.dayNames,g=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,d=(d?d.monthNames:null)||this._defaults.monthNames,i=function(c){(c=x+1<a.length&&a.charAt(x+1)==c)&&x++;return c},s=function(a,b,c){b=""+b;if(i(a))for(;b.length<c;)b="0"+b;return b},q=function(a,b,c,d){return i(a)?d[b]:c[b]},p="",y=!1;if(c)for(var x=0;x<
a.length;x++)if(y)"'"==a.charAt(x)&&!i("'")?y=!1:p+=a.charAt(x);else switch(a.charAt(x)){case "d":p+=s("d",c.getDate(),2);break;case "D":p+=q("D",c.getDay(),e,f);break;case "o":p+=s("o",Math.round(((new Date(c.getFullYear(),c.getMonth(),c.getDate())).getTime()-(new Date(c.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":p+=s("m",c.getMonth()+1,2);break;case "M":p+=q("M",c.getMonth(),g,d);break;case "y":p+=i("y")?c.getFullYear():(10>c.getYear()%100?"0":"")+c.getYear()%100;break;case "@":p+=
c.getTime();break;case "!":p+=1E4*c.getTime()+this._ticksTo1970;break;case "'":i("'")?p+="'":y=!0;break;default:p+=a.charAt(x)}return p},_possibleChars:function(a){for(var c="",d=!1,e=function(c){(c=f+1<a.length&&a.charAt(f+1)==c)&&f++;return c},f=0;f<a.length;f++)if(d)"'"==a.charAt(f)&&!e("'")?d=!1:c+=a.charAt(f);else switch(a.charAt(f)){case "d":case "m":case "y":case "@":c+="0123456789";break;case "D":case "M":return null;case "'":e("'")?c+="'":d=!0;break;default:c+=a.charAt(f)}return c},_get:function(a,
...
g=this._get(b,"navigationAsDateFormat"),r=this._getNumberOfMonths(b),s=this._get(b,"showCurrentAtPos"),q=this._get(b,"stepMonths"),p=1!=r[0]||1!=r[1],y=this._daylightSavingAdjust(!b.currentDay?new Date(9999,9,9):new Date(b.currentYear,b.currentMonth,b.currentDay)),x=this._getMinMaxDate(b,"min"),z=this._getMinMaxDate(b,"max"),s=b.drawMonth-s,D=b.drawYear;0>s&&(s+=12,D--);if(z)for(var A=this._daylightSavingAdjust(new Date(z.getFullYear(),z.getMonth()-r[0]*r[1]+1,z.getDate())),A=x&&A<x?x:A;this._daylightSavingAdjust(new Date(D,
...
H=""}E+='">'}for(var E=E+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+H+'">'+(/all|left/.test(H)&&0==M?d?f:A:"")+(/all|right/.test(H)&&0==M?d?A:f:"")+this._generateMonthYearHeader(b,s,D,x,z,0<M||0<L,O,C)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),N=q?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":"",H=0;7>H;H++)var I=(H+g)%7,N=N+("<th"+(5<=(H+g+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+B[I]+'">'+F[I]+"</span></th>");
E+=N+"</tr></thead><tbody>";N=this._getDaysInMonth(D,s);D==b.selectedYear&&s==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,N));H=(this._getFirstDayOfMonth(D,s)-g+7)%7;N=Math.ceil((H+N)/7);this.maxRows=N=p?this.maxRows>N?this.maxRows:N:N;for(var I=this._daylightSavingAdjust(new Date(D,s,1-H)),T=0;T<N;T++){for(var E=E+"<tr>",Y=!q?"":'<td class="ui-datepicker-week-col">'+this._get(b,"calculateWeek")(I)+"</td>",H=0;7>H;H++){var Q=w?w.apply(b.input?b.input[0]:null,[I]):[!0,""],j=I.getMonth()!=
s,u=j&&!G||!Q[0]||x&&I<x||z&&I>z,Y=Y+('<td class="'+(5<=(H+g+6)%7?" ui-datepicker-week-end":"")+(j?" ui-datepicker-other-month":"")+(I.getTime()==t.getTime()&&s==b.selectedMonth&&b._keyEvent||h.getTime()==I.getTime()&&h.getTime()==t.getTime()?" "+this._dayOverClass:"")+(u?" "+this._unselectableClass+" ui-state-disabled":"")+(j&&!R?"":" "+Q[1]+(I.getTime()==y.getTime()?" "+this._currentClass:"")+(I.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!j||R)&&Q[2]?' title="'+Q[2]+'"':"")+(u?"":
' onclick="DP_jQuery_'+i+".datepicker._selectDay('#"+b.id+"',"+I.getMonth()+","+I.getFullYear()+', this);return false;"')+">"+(j&&!R?"&#xa0;":u?'<span class="ui-state-default">'+I.getDate()+"</span>":'<a class="ui-state-default'+(I.getTime()==c.getTime()?" ui-state-highlight":"")+(I.getTime()==y.getTime()?" ui-state-active":"")+(j?" ui-priority-secondary":"")+'" href="#">'+I.getDate()+"</a>")+"</td>");I.setDate(I.getDate()+1);I=this._daylightSavingAdjust(I)}E+=Y+"</tr>"}s++;11<s&&(s=0,D++);E+="</tbody></table>"+
(p?"</div>"+(0<r[0]&&L==r[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");V+=E}S+=V}S+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return S},_generateMonthYearHeader:function(a,c,d,e,f,g,r,s){var q=this._get(a,"changeMonth"),p=this._get(a,"changeYear"),y=this._get(a,"showMonthAfterYear"),x='<div class="ui-datepicker-title">',z="";if(g||!q)z+='<span class="ui-datepicker-month">'+
r[c]+"</span>";else{for(var r=e&&e.getFullYear()==d,D=f&&f.getFullYear()==d,z=z+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),A=0;12>A;A++)if((!r||A>=e.getMonth())&&(!D||A<=f.getMonth()))z+='<option value="'+A+'"'+(A==c?' selected="selected"':"")+">"+s[A]+"</option>";z+="</select>"}y||(x+=z+(g||!q||!p?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",g||!p)x+='<span class="ui-datepicker-year">'+d+"</span>";else{var s=this._get(a,
...
(function(a,c,d,e){function g(a,b,c){N[a]=c;I[a]=b;E||(E=a)}function i(b){E!==b&&(E=b,a.ui.editor.eachInstance(function(){this.reinit()}))}function f(a,b){E&&N[E]&&N[E][a]&&(a=N[E][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function b(b){if(T===e){T=!0;if(Y=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(b.options.baseClass+"-ios"),Y&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height",
...
this.options.replace=!1),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,this.ready=!0,this.fire("ready"),this.options.autoEnable&&a(function(){c.enableEditing();c.showToolbar()}))},attach:function(){this.bind("change",this.historyPush);this.bind("selectionChange",this.updateTagTree);this.bind("show",this.updateTagTree);var b=a.proxy(this.checkChange,this);this.getElement().find("img").bind("click."+this.widgetName,a.proxy(function(a){B(a.target)},this));
...
disableEditing:function(){this.enabled&&(this.enabled=!1,this.getElement().attr("contenteditable",!1).removeClass(this.options.baseClass+"-editing"),d.getSelection().removeAllRanges(),this.fire("disabled"))},isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var b=this,c="",d=[],e=0;z(function(f){var f=f.commonAncestorContainer,g;g=3===f.nodeType?a(f).parent():a(f);f=[];for(d.push(f);g[0]&&!b.isRoot(g)&&"body"!==g[0].tagName.toLowerCase();)f.push(g),g=g.parent();
f.reverse();c&&(c+=" | ");c+=this.getTemplate("root");for(g=0;g<f.length;g++)c+=this.getTemplate("tag",{element:f[g][0].tagName.toLowerCase(),data:"["+e+","+g+"]"});e++},null,this);c||(c=this.getTemplate("root"));this.path.html(c).find("a").click(function(){var c=a(this).data("ui-editor-selection");c?(B(d[c[0]][c[1]]),b.updateTagTree()):B(b.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(b){return this.getElement()[0]===a(b)[0]},unify:function(b,c){!1!==c&&b(this);if(this.options.unify)for(var d=
...
d=this.templates[b]?this.templates[b]:a.ui.editor.getTemplate(b,this.options.urlPrefix);d=d.replace(/_\(['"]{1}(.*?)['"]{1}\)/g,function(a,b){b=b.replace(/\\(.?)/g,function(a,b){switch(b){case "\\":return"\\";case "0":return"\x00";case "":return"";default:return b}});return f(b)});c=a.extend({},this.options,c||{});c=this.getTemplateVars(c);return d=d.replace(/\{\{(.*?)\}\}/g,function(a,b){return c[b]})},getTemplateVars:function(a,b,c){b=b?b+".":"";c||(c=1);var d={},e;for(e in a)if("object"===typeof a[e]&&
...
c)&&this.getElement().bind("keydown."+this.widgetName,a,function(a){p();var c=b.hotkeys[a.data];!0!==c.action.call(c.context)&&a.preventDefault();c.restoreSelection&&y();b.checkChange()})}},uiEnabled:function(b){return!1===this.options.enableUi&&"undefined"===typeof this.options.ui[b]||!1===this.options.ui[b]||-1!==a.inArray(b,this.options.disabledUi)?!1:!0},getUi:function(a){return this.uiObjects[a]},loadUi:function(){for(var b=0,c=this.options.uiOrder.length;b<c;b++){for(var d=this.options.uiOrder[b],
...
this.uiObjects[d[f]]=i}}e.addClass("ui-buttonset").addClass(this.options.baseClass+"-buttonset");0<e.children().length&&e.appendTo(this.toolbar)}a("<div/>").css("clear","both").appendTo(this.toolbar)},uiButton:function(b){return a.extend({button:null,options:{},init:function(b,c,d,e){var j=b.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),d=a.extend({},c.options,{baseClass:c.options.baseClass+"-"+j+"-button"},this.options,c.options.ui[b]);this.title||(this.title=f("Unnamed Button"));this.button=
a("<div/>").html(this.label||this.title).addClass(d.baseClass).attr("name",b).attr("title",this.title).val(b);d.classes&&this.button.addClass(d.classes);this.button.bind("mousedown."+e.editor.widgetName,function(a){a.preventDefault()});var g=this;this.button.bind("mouseup."+e.editor.widgetName,function(a){a.preventDefault();g.click.apply(e,arguments)});c.bind("destroy",a.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+j},disabled:d.disabled?
...
e+"-select-menu"},d.options,c.options.ui[b]);d.title||(d.title=f("Unnamed Select Menu"));d.wrapper=a('<div class="ui-editor-selectmenu-wrapper"/>').append(d.select.hide()).addClass(d.select.attr("class"));d.selectMenu=a('<div class="ui-editor-selectmenu"/>').appendTo(d.wrapper);d.menu=a('<div class="ui-editor-selectmenu-menu ui-widget-content ui-corner-bottom ui-corner-tr"/>').appendTo(d.wrapper);d.select.find("option, .ui-editor-selectmenu-option").each(function(){a("<div/>").addClass("ui-editor-selectmenu-menu-item").addClass("ui-corner-all").html(a(this).html()).appendTo(d.menu).bind("mouseenter."+
...
f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?g.nodeValue:a(g).html())&&a("<"+d+"/>").html(a.trim(g)).insertBefore(c)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},rangeGetCommonAncestor:s,rangeIsEmpty:q,selectionSave:p,selectionRestore:y,selectionDestroy:x,selectionEachRange:z,selectionReplace:D,selectionSelectInner:A,selectionSelectOuter:B,selectionSelectEdge:F,selectionSelectEnd:O,selectionSelectStart:C,selectionGetHtml:w,selectionGetElements:G,
selectionToggleWrapper:M,selectionExists:function(a){var b=!1;z(function(a){q(a)||(b=!0)},a,this);return b},selectionReplaceSplittingSelectedElement:L,selectionReplaceWithinValidTags:t,stringStripTags:H,defaults:{plugins:{},ui:{},bind:{},domTools:{constrainSelection:function(b,c){var b=a(b)[0],c=c||d.getSelection(),e;a(c.getAllRanges()).each(function(d,f){e=3===this.commonAncestorContainer.nodeType?a(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;b!==e&&!a.contains(b,e)&&c.removeRange(f)})},
unwrapParentTag:function(b){G().each(function(){a(this).is(b)&&a(this).replaceWith(a(this).html())})},execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(d){}},insertTag:function(b,c){z(function(c){c.insertNode(a("<"+b+"/>")[0])},c,this)},insertTagAtEnd:function(b,c){z(function(c){c.insertNodeAtEnd(a("<"+b+"/>")[0])},c,this)},insertElement:function(b,c,d){z(function(d){a(b).each(function(){d.insertNode(!1===c?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(b,c,d){z(function(d){a(b).each(function(){d.insertNodeAtEnd(!1===
c?this:this.cloneNode(!0))})},d,this)},toggleBlockStyle:function(b,c){z(function(d){for(d=a(d.commonAncestorContainer);d.length&&d[0]!==c[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===c[0]&&"inline"!==c.css("display")&&(this.wrapInner(c,"div"),d=c.children().first());this.toggleStyle(d,b)},null,this)},wrapInner:function(b,c){p();a(b).each(function(){var d=a("<"+c+"/>").html(a(this).html());b.html(d)});y()},inverseWrapWithTagClass:function(b,c,e,f){p();var g="domTools"+
Math.ceil(1E7*Math.random());z(function(a){var b=d.createCssClassApplier(f,{elementTagName:e});b.isAppliedToRange(a)?b.toggleSelection():d.createCssClassApplier(c,{elementTagName:g}).toggleSelection()},null,this);a(g).each(function(){a(this).replaceWith(a("<"+b+"/>").addClass(c).html(a(this).html()))});y()},toggleStyle:function(b,c){a.each(c,function(c,d){a(b).css(c)===d?a(b).css(c,""):a(b).css(c,d)})},getStyles:function(a){for(var b={},a=c.getComputedStyle(a[0],null),d=0;d<a.length;d++)b[a.item(d)]=
...
for(c=e.commonAncestorContainer;c&&c.parentNode!=b.getElement().get(0);)c=c.parentNode;if(c){e.setEndAfter(c);var g=e.extractContents();e.collapseAfter(c);e.insertNode(g);e.collapseAfter(c)}e.insertNode(document.createTextNode(f))}b.checkChange()}})}}});a.ui.editor.registerPlugin("clickButtonToEdit",{hovering:!1,button:!1,options:{button:{text:!0,icons:{primary:"ui-icon-pencil"}}},init:function(b,d){var e=this;this.selection=function(){var a;document.selection?a=document.selection.createRange():document.getSelection().rangeCount&&
(a=document.getSelection().getRangeAt(0));return a};this.show=function(){if(!b.isEditing()){b.getElement().addClass(d.baseClass+"-highlight");b.getElement().addClass(d.baseClass+"-hover");var f=e.getButton();var g=b.getElement(),g=a(g),h=Math.round(g.offset().top),i=Math.round(g.offset().left),k=Math.round(g.outerWidth()),g=Math.round(g.outerHeight()),l=a(c).scrollTop(),m=a(c).height(),n=l+m,o=Math.round(g+h);l<h&&n>o||(l>h&&(h=l),g=n<o?n-h:m-(n-o));f.css({position:"absolute",top:h+(g/2-a(f).outerHeight()/
2),left:i+k/2-a(f).outerWidth()/2});f.addClass(d.baseClass+"-visible")}};this.hide=function(c){var f=e.getButton();if(!c||!(c.relatedTarget===f.get(0)||f.get(0)===a(c.relatedTarget).parent().get(0)))b.getElement().removeClass(d.baseClass+"-highlight"),b.getElement().removeClass(d.baseClass+"-hover"),f.removeClass(d.baseClass+"-visible")};this.edit=function(){e.hide();b.isEditing()||b.enableEditing();b.isVisible()||b.showToolbar(e.selection())};this.buttonOut=function(){e.getButton().hasClass(d.baseClass+
"-visible")||(c.clearTimeout(e.timeoutId),e.timeoutId=c.setTimeout(e.hide,350))};b.getElement().addClass("ui-editor-click-button-to-edit");b.bind("ready, hide, cancel",function(){b.getElement().bind("mouseenter."+b.widgetName,e.show);b.getElement().bind("mouseleave."+b.widgetName,e.hide)});b.bind("show",function(){e.destroyButton();b.getElement().unbind("mouseenter."+b.widgetName,e.show);b.getElement().unbind("mouseleave."+b.widgetName,e.hide)})},getButton:function(){!1===this.button&&(this.button=
a(this.editor.getTemplate("clickbuttontoedit.edit-button",this.options)).appendTo("body").removeClass(this.options.baseClass+"-visible"),this.button.button(this.options.button));this.button.unbind("click."+this.editor.widgetName).bind("click."+this.editor.widgetName,this.edit);this.button.unbind("mouseleave."+this.editor.widgetName).bind("mouseleave."+this.editor.widgetName,this.buttonOut);return this.button},destroyButton:function(){this.button.button("destroy").remove();this.button=!1}});a.ui.editor.registerUi("colorPickerBasic",
{init:function(b){b.bind("selectionChange",this.change,this);b.bind("show",this.change,this);var c=this;return b.uiSelectMenu({name:"colorPickerBasic",title:f("Change the color of the selected text."),select:a(b.getTemplate("color-picker-basic.menu")),change:function(b){"automatic"===b?G().parents("."+c.options.cssPrefix+"color").andSelf().each(function(){var b=a(this),c=a(this).attr("class").match(/(cms-(.*?))( |$)/ig);a.each(c,function(c,d){d=a.trim(d);b.removeClass(d)})}):M("span",{classes:c.options.classes||
c.options.cssPrefix+"color "+c.options.cssPrefix+b})}})},change:function(){this.ui.val("automatic");var b=G()[0];if(b&&(b=a(b).closest("."+this.options.cssPrefix+"color"))){var c=b.attr("class");c&&(c=b.attr("class").replace(RegExp(this.options.cssPrefix+"color","g"),""),b=c.match(/cms-(.*?)( |$)/i)[1],this.ui.select.find(".ui-editor-selectmenu-option[value="+b+"]").length&&this.ui.val(b))}}});a.ui.editor.registerPlugin("dock",{enabled:!1,docked:!1,topSpacer:null,bottomSpacer:null,options:{docked:!1,
dockToElement:!1,dockUnder:!1,persist:!0,persistID:null},init:function(){this.bind("show",this.show);this.bind("hide",this.hide);this.bind("disabled",this.disable);this.bind("destroy",this.destroy,this)},show:function(){this.enabled?this.isDocked()&&this.showSpacers():((this.loadState()||this.options.docked)&&this.dock(),this.enabled=!0)},hide:function(){this.hideSpacers();this.editor.toolbar.css("width","auto")},showSpacers:function(){!this.options.dockToElement&&this.editor.toolbar.is(":visible")&&
...
icon:a.getPlugin("dock").isDocked()?"ui-icon-pin-w":"ui-icon-pin-s",click:function(){var b=a.getPlugin("dock");b.isDocked()?b.undock():b.dock();a.unify(function(a){b.isDocked()?a.getPlugin("dock").dock():a.getPlugin("dock").undock()})}})}}});a.ui.editor.registerUi({embed:{dialog:null,init:function(a){a.bind("hide",this.hide,this);return a.uiButton({icon:"ui-icon-youtube",title:f("Embed object"),click:function(){this.show()}})},hide:function(){this.dialog&&a(this.dialog).dialog("destroy").remove();
this.dialog=null;a(this.ui.button).button("option","disabled",!1)},show:function(){if(!this.dialog){a(this.ui.button).button("option","disabled",!0);var b=this;p();this.dialog=a(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:f("Paste Embed Code"),autoOpen:!0,dialogClass:b.options.baseClass+" "+b.options.dialogClass,buttons:[{text:f("Embed Object"),click:function(){y();D(a(this).find("textarea").val());a(this).dialog("close")}},{text:f("Close"),
click:function(){b.hide()}}],open:function(){var b=a(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});var c=a(this).find(".ui-editor-embed-panel-tabs");c.find("ul li").click(function(){c.find("ul li").removeClass("ui-state-active").removeClass("ui-tabs-selected");a(this).addClass("ui-state-active").addClass("ui-tabs-selected");c.children("div").hide().eq(a(this).index()).show()});
var d=a(this).find(".ui-editor-embed-preview");a(this).find("textarea").change(function(){a(d).html(a(this).val())})},close:function(){b.hide()}})}}}});a.ui.editor.registerPlugin("emptyElement",{options:{tag:"<p/>"},init:function(){this.bind("change",this.change)},change:function(){var b=this;this.textNodes(this.editor.getElement()).each(function(){a(this).wrap(a(b.options.tag));O(this)});this.editor.checkChange()},textNodes:function(b){return a(b).contents().filter(function(){return 3==this.nodeType&&
a.trim(this.nodeValue).length})}});a(function(){a.ui.editor.registerUi({insertFile:{fileManager:null,imageTypes:["jpg","jpeg","png","gif"],init:function(b,c){return b.uiButton({title:"Insert image or uploaded file",icon:"ui-icon-image",click:function(){var b=this;p();null===this.fileManager&&(this.fileManager=a.ui.filemanager.create({enablePlugins:!1,plugins:{datatables:!XMod.FileManager.Permissions.insert?!1:{ajaxSource:"/filemanager/admin/datatables",insertionCallback:function(d){y();if(!d.length)return true;
var e=function(){b.editor.fire("change");return true};if(d.length===1){var f=d[0];if(b.isImage(f)){D(b.createImage(f,c.cssPrefix+f.type));return e()}if(b.editor.selectionExists()){V("a",{href:f.url,className:b.options.cssPrefix+"file "+b.options.cssPrefix+f.type});return e()}D(b.createAnchor(f,b.options.cssPrefix+"file "+b.options.cssPrefix+f.type));return e()}for(var j=[],g=0;g<d.length;g++){f=d[g];b.isImage(f)?j.push(a("<div/>").html(b.createImage(f,c.cssPrefix+f.type)).html()):j.push(a("<div/>").html(b.createAnchor(f,
b.options.cssPrefix+"file "+b.options.cssPrefix+f.type)).html())}D(j.join(", "));return e()}},plupload:!XMod.FileManager.Permissions.upload?!1:{url:"/filemanager/admin/plupload"}}}));a(this.fileManager).filemanager("show")}})},isImage:function(b){return-1!==a.inArray(b.type.toLowerCase(),this.imageTypes)?!0:!1},createImage:function(b,c){return a("<img/>").attr({src:b.url,title:b.name,"class":c})},createAnchor:function(b,c){return a("<a/>").attr({href:b.url,title:b.name,"class":c}).html(b.name)}}})});
a.ui.editor.registerUi({floatLeft:{init:function(b){return b.uiButton({title:f("Float Image Left"),click:function(){z(function(b){a(b.commonAncestorContainer).find("img").css("float","left")})}})}},floatRight:{init:function(b){return b.uiButton({title:f("Float Image Right"),click:function(){z(function(b){a(b.commonAncestorContainer).find("img").css("float","right")})}})}},floatNone:{init:function(b){return b.uiButton({title:f("Remove Image Float"),click:function(){z(function(b){a(b.commonAncestorContainer).find("img").css("float",
"none")})}})}}});a.ui.editor.registerUi({fontSizeInc:{init:function(a,b){return a.uiButton({title:f("Increase Font Size"),click:function(){a.inverseWrapWithTagClass("big",b.cssPrefix+"big","small",b.cssPrefix+"small")}})}},fontSizeDec:{init:function(a,b){return a.uiButton({title:f("Decrease Font Size"),click:function(){a.inverseWrapWithTagClass("small",b.cssPrefix+"small","big",b.cssPrefix+"big")}})}}});a.ui.editor.registerUi({showGuides:{init:function(a,b){a.bind("cancel",this.cancel,this);a.bind("destroy",
this.cancel,this);return a.uiButton({title:f("Show Guides"),icon:"ui-icon-pencil",click:function(){a.getElement().toggleClass(b.baseClass+"-visible")}})},cancel:function(){this.editor.getElement().removeClass(this.options.baseClass+"-visible")}}});a.ui.editor.registerUi({undo:{options:{disabled:!0},hotkeys:{"ctrl+z":{action:function(){this.editor.historyBack()}}},init:function(a){a.bind("change",this.change,this);return a.uiButton({title:f("Step Back"),click:function(){a.historyBack()}})},change:function(){0===
this.editor.present?this.ui.disable():this.ui.enable()}},redo:{options:{disabled:!0},hotkeys:{"ctrl+shift+z":{action:function(){this.editor.historyForward()}},"ctrl+y":{action:function(){this.editor.historyForward()}}},init:function(a){a.bind("change",this.change,this);return this.ui=a.uiButton({title:f("Step Forward"),click:function(){a.historyForward()}})},change:function(){this.editor.present===this.editor.history.length-1?this.ui.disable():this.ui.enable()}}});a.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:f("Insert Horizontal Rule"),
click:function(){D("<hr/>")}})}}});a.ui.editor.registerUi({i18n:{init:function(b){var c=this,d=this.persist("locale");d&&i(d);var d=a('<select autocomplete="off" name="i18n"/>'),e;for(e in N){var g=a('<option value="'+e+'" class="'+e+'"/>');g.html(I[e]);E===e&&g.attr("selected","selected");d.append(g)}return b.uiSelectMenu({title:f("Change Language"),select:d,change:function(a){i(c.persist("locale",a))}})}}});g("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.",
...
"{{characters}} characters, {{charactersRemaining}} over the recommended limit":"{{characters}} characters, {{charactersRemaining}} over the recommended limit","{{characters}} characters, {{charactersRemaining}} remaining":"{{characters}} characters, {{charactersRemaining}} remaining","{{sentences}} sentences":"{{sentences}} sentences","{{words}} word":"{{words}} word","{{words}} words":"{{words}} words"});g("es","Espa\u00f1ol",{"A preview of your embedded object is displayed below.":"A continuaci\u00f3n se muestra una vista previa de su objeto incrustado.",
...
"{{characters}} characters, {{charactersRemaining}} over the recommended limit":"{{characters}} car\u00e1cter(es), {{charactersRemaining}} sobre el l\u00edmite recomendado","{{characters}} characters, {{charactersRemaining}} remaining":"{{characters}} car\u00e1cter(es), queda(n) {{charactersRemaining}}","{{sentences}} sentences":"{{sentences}} oraciones","{{words}} word":"{{words}} palabra","{{words}} words":"{{words}} palabras"});g("fr","Fran\u00e7ais",{"A preview of your embedded object is displayed below.":"Un aper\u00e7u de votre objet int\u00e9gr\u00e9 est affich\u00e9 ci-dessous.",
...
"Sub script":"Subscript","Subject (optional)":"Onderwerp (optioneel)","Successfully saved {{saved}} content block(s).":"{{saved}} inhoudsblok(ken) succesvol opgeslagen.","Super script":"Superscript","The URL does not look well formed":"Het lijkt er op dat het internetadres niet correct is","The email address does not look well formed":"Het e-mail adres is incorrect","The image '{{image}}' is too wide for the element being edited.<br/>It will be resized to fit.":"The image '{{image}}' is too wide for the element being edited.<br/>It will be resized to fit.",
...
this.options.manuallyResizingClass),d=a(c).innerWidth(),e=a(c).innerHeight(),g="#"+this.options.baseClass+"-width",h="#"+this.options.baseClass+"-height",i=this,k=function(b){b=Math.round(b||a(g).val())+"px";a(c).css({width:b})},l=a(this.editor.getTemplate("imageresize.manually-resize-image",{width:d,height:e,baseClass:this.options.baseClass}));l.dialog({modal:!0,resizable:!1,title:f("Modify Image Size"),autoOpen:!0,buttons:[{text:f("Resize Image"),click:function(){k(a(this).find(g).val());a(this).dialog("close")}},
{text:f("Cancel"),click:function(){k(d);a(this).dialog("close")}}],close:function(){i.editor.checkChange();a(l).remove()},open:function(){var b=a(this).find(g),c=a(this).find(h);b.keyup(function(){c.val(Math.round(Math.abs(e/d*a(this).val())));k()});c.keyup(function(){b.val(Math.round(Math.abs(d/e*a(this).val())));k()})}});b.preventDefault();return!1},displayToolsButtonRelativeToImage:function(b){var c=a("<button>"+f("Click to edit the image")+"</button>").appendTo("body").addClass(this.options.resizeButtonClass).button({text:!1,
...
this.displayToolsButtonRelativeToImage(b.target)},imageMouseLeave:function(b){a(b.relatedTarget).hasClass(this.options.resizeButtonClass)||(a(b.target).removeClass(this.options.manuallyResizingClass),this.removeToolsButtons())}});a.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:f("Page on this or another website"),focusSelector:'input[name="location"]',init:function(){this.content=this.plugin.editor.getTemplate("link.external",this.options);
...
this.editor.widgetName,function(){d.typeChange(d.types[a(this).val()],b)});e.dialog({autoOpen:!1,modal:!0,resizable:!0,width:c.dialogWidth,minWidth:c.dialogMinWidth,height:c.dialogHeight,title:b?f("Edit Link"):f("Insert Link"),dialogClass:c.baseClass+" "+c.dialogClass,buttons:[{text:b?f("Update Link"):f("Insert Link"),click:function(){y();d.apply(b)&&a(this).dialog("close")}},{text:f("Cancel"),click:function(){a(this).dialog("close")}}],beforeopen:function(){d.dialog.find("."+d.options.baseClass+
...
this.change,this);a.bind("show",this.change,this);return a.uiButton({title:f("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){G().is("a")?this.ui.enable():this.ui.disable()}}});a.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),
toggleList:function(b){a(G()).is("li")&&a(G()).parent().is(b)?this.unwrapList():this.wrapList(b);this.editor.fire("selectionChange");this.editor.fire("change")},unwrapList:function(){p();var b=[],c=[],d=h(),e=S();b.push(a(d).html());c.push(d);if(a(d)[0]!==a(e)[0]){var f=d;do f=a(f).next(),b.push(a(f).html()),c.push(f);while(a(f)[0]!==a(e)[0])}f=0===a(d).prev().length;e=0===a(e).next().length;d=a(d).parent();for(listElementsIndex=0;listElementsIndex<c.length;listElementsIndex++)a(c[listElementsIndex]).remove();
for(c=0;c<b.length;c++)d.parent().is("li")||(b[c]="<p>"+b[c]+"</p>");f&&e?(d.replaceWith(b.join("")),y(),b=G()[0],B(b)):(f?a(d).before(b.join("")):e?a(d).after(b.join("")):L(b.join("")),y(),this.editor.checkChange())},wrapList:function(b){this.editor.constrainSelection(this.editor.getElement());""===a.trim(w())&&A(G());var c=a("<div>").html(w()),d=[],e=this;a(c).contents().each(function(){var b;b="block"===o(this.tagName)?H(a(this).html(),e.validChildren):H(l(a(this)),e.validChildren);b=a("<li>"+
b+"</li>");""!==a.trim(b.text())&&d.push(l(b))});c=this.options.baseClass+"-selection";b="<"+b+' class="'+c+'">'+d.join("")+"</"+b+">";y();var f=a(G()[0]).parent(),g=this.editor.getElement()[0];f===g||G()[0]===g?D(b):t(b,this.validParents);c=a(this.editor.getElement().find("."+c).removeClass(c));A(c.find("li:first")[0]);this.editor.checkChange()},toggleButtonState:function(b,c){var d=function(a){c.button.toggleClass("ui-state-highlight",a).toggleClass("ui-state-default",!a)},e=h();if(null===e||!e.length)e=
this.editor.getElement();var f=S();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(a(e).is(b)&&a(f).is(b)&&e===f)return d(!0);var g=a(e).parentsUntil(i,b).first()&&a(f).parentsUntil(i,b).first(),i="#"+this.editor.getElement().attr("id"),k=a(e).is(b+" > li")||a(e).parentsUntil(i,b+" > li").length,l=a(f).is(b+" > li")||a(f).parentsUntil(i,b+" > li").length;if(k&&l&&g){g=a(s());g.is(b)||(g=a(g).parentsUntil(i,b).first());i=g.find("ul, ol");if(!i.length)return d(!0);for(g=0;g<i.length;g++)if(a.contains(i[g],
e)&&a.contains(i[g],f))return d(!1);return d(!0)}return d(!1)}});a.ui.editor.registerUi({listUnordered:{init:function(a){var b=a.uiButton({title:f("Unordered List"),click:function(){a.getPlugin("list").toggleList("ul")}});a.bind("selectionChange",function(){a.getPlugin("list").toggleButtonState("ul",b)});return b}},listOrdered:{init:function(a){var b=a.uiButton({title:f("Ordered List"),click:function(){a.getPlugin("list").toggleList("ol")}});a.bind("selectionChange",function(){a.getPlugin("list").toggleButtonState("ol",
...
c))});return(f?"[":"{")+(""+e)+(f?"]":"}")},c={enableUi:this.options.enableUi,enablePlugins:this.options.enablePlugins,disabledPlugins:b(this.options.disabledPlugins),ui:b(this.options.ui),t:(new Date).getTime()},d=[],e;for(e in c)d.push(e+"="+encodeURIComponent(c[e]));this.ui.button.find(".ui-button-icon-primary").css({"background-image":"url(http://www.jquery-raptor.com/logo/0.0.20?"+d.join("&")+")"})}})}}});a.ui.editor.registerPlugin("normaliseLineBreaks",{options:{enter:"<p><br/></p>",enterValidTags:"address,blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),
shiftEnter:"<br/>",shiftEnterValidTags:"a,abbr,acronym,address,applet,b,bdo,big,blockquote,body,button,caption,center,cite,code,dd,del,dfn,div,dt,em,fieldset,font,form,h1,h2,h3,h4,h5,h6,i,iframe,ins,kbd,label,legend,li,noframes,noscript,object,p,pres,q,s,samp,small,span,strike,strong,sub,sup,td,th,tt,u,var".split(",")},hotkeys:{"return":{action:function(){x();var b=""===d.getSelection().toHtml(),c;c=d.getSelection();var e=c.isBackwards()?c.focusNode:c.anchorNode;(c.isBackwards()?c.focusOffset:0!==
c.anchorOffset)?c=!1:(c=e.previousSibling,c=!c||""===a(c).html()?!0:!1);var f;e=d.getSelection();f=e.isBackwards()?e.anchorNode:e.focusNode;(e.isBackwards()?e.focusOffset:e.anchorOffset)!==f.textContent.length?f=!1:(e=f.nextSibling,f=!e||""===a(e).html()?!0:!1);var g=this.options.baseClass+"-enter-break",e=a(this.options.enter).attr("id",g);t(e,this.options.enterValidTags);e=a("#"+g).removeAttr("id");b?c?C(e.next()):f?C(e):(C(e.next()),(b=e.prev())&&""!==a.trim(b.html())&&l(b)!==this.options.enter&&
e.remove()):(C(e.next()),e.remove())},restoreSelection:!1},"return+shift":{action:function(){x();var b=this.options.baseClass+"-enter-break",c=a(breakHtml).attr("id",b).appendTo("body");this.options.shiftEnterValidTags?t(this.options.shiftEnter,this.options.shiftEnterValidTags):D(c);b=a("#"+b).removeAttr("id").next();C(b)},restoreSelection:!1}}});a.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span,hr,br".split(","),allowedAttributes:["href",
...
c=h.filterAttributes(c),c=h.filterChars(c),c=h.stripEmpty(c),c=h.stripAttributes(c),c=H(c,h.options.allowedTags),c={plain:a("<div/>").html(a(".uiWidgetEditorPasteBin").html()).text(),markup:c,html:a(".uiWidgetEditorPasteBin").html()};g=a(b.getTemplate("paste.dialog",c));a(g).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:d.dialogShowAnimation,hide:d.dialogHideAnimation,dialogClass:d.baseClass+" "+d.dialogClass,buttons:[{text:f("Insert"),click:function(){var b=
null,b=a(this).find(".ui-editor-paste-area:visible"),b=b.hasClass("ui-editor-paste-plain")||b.hasClass("ui-editor-paste-source")?b.val():b.html(),b=h.filterAttributes(b),b=h.filterChars(b);y();D(b);e=!1;a(this).dialog("close")}},{text:f("Cancel"),click:function(){y();e=!1;a(this).dialog("close")}}],open:function(){var b=a(this).find(".ui-editor-paste-panel-tabs");b.find("ul.ui-tabs-nav li").click(function(){b.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
...
init:function(b){b.bind("show",a.proxy(this.updateCount,this));b.bind("change",a.proxy(this.updateCount,this));return this.editor.uiButton({title:f("Remaining characters before the recommended character limit is reached"),label:f("Initializing"),text:!0,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var b=this.options.maximum-a("<div/>").html(this.editor.getCleanHtml()).text().length,c=this.ui.button;if(!1===this.options.maximum)c.button("option","text",
!1);else{var d=null,d=0<=b?f("{{charactersRemaining}} characters remaining",{charactersRemaining:b}):f("{{charactersRemaining}} characters over limit",{charactersRemaining:-1*b});c.button("option","label",d);c.button("option","text",!0);0>b?c.addClass("ui-state-error"):0<=b&&15>=b?c.addClass("ui-state-highlight").removeClass("ui-state-error"):c.removeClass("ui-state-highlight ui-state-error")}},showStatistics:function(){this.processTemplate().dialog({modal:!0,resizable:!1,title:f("Content Statistics"),
dialogClass:this.editor.options.dialogClass+" "+this.editor.options.baseClass,show:this.editor.options.dialogShowAnimation,hide:this.editor.options.dialogHideAnimation,buttons:[{text:f("OK"),click:function(){a(this).dialog("close")}}],open:function(){a(this).parent().find(".ui-dialog-buttonpane").find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}})},close:function(){a(this).dialog("destroy").remove()}})},processTemplate:function(){var b=a("<div/>").html(this.editor.getCleanHtml()).text(),
c=null,d=this.options.maximum-b.length,c=0>d?f("Content contains more than {{limit}} characters and may be truncated",{limit:this.options.maximum}):f("Content will not be truncated"),e=null,e=b.split(" ").length,e=1==e?f("{{words}} word",{words:e}):f("{{words}} words",{words:e}),g=null,g=b.split(". ").length,g=f("{{sentences}} sentences",{sentences:g}),h=null,h=0<=d?f("{{characters}} characters, {{charactersRemaining}} remaining",{characters:b.length,charactersRemaining:d}):f("{{characters}} characters, {{charactersRemaining}} over the recommended limit",
{characters:b.length,charactersRemaining:-1*d});return a(this.editor.getTemplate("statistics.dialog",{characters:h,words:e,sentences:g,truncation:c}))}}});a.ui.editor.registerUi({tagMenu:{validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),init:function(b){b.bind("selectionChange",this.change,this);b.bind("show",this.change,this);return b.uiSelectMenu({name:"tagMenu",title:f("Change HTML tag of selected element"),select:a(b.getTemplate("tagmenu.menu")),
change:function(c){if(!("undefined"===typeof c||"na"===c)){var d=b.getElement()[0],e=G();if(!w()||""===w()){if(a(e)[0]===a(d)[0])return;p();d=a("<"+c+">").html(e.html());e.replaceWith(d);y()}else{var e=a(G()[0]).parent(),f=this.options.baseClass+"-selection",c=a("<"+c+">").html(w()).addClass(f);e===d||G()[0]===d?D(c):t(c,this.validParents);A(b.getElement().find("."+f).removeClass(f))}b.checkChange()}}})},change:function(){var b=G()[0];b?(b=b.tagName.toLowerCase(),this.ui.select.find("option[value="+
