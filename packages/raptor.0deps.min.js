...
*/
window.rangy=function(){function a(a,b){var c=typeof a[b];return c==l||!!(c==j&&a[b])||"unknown"==c}function c(a,b){return!!(typeof a[b]==j&&a[b])}function d(a,b){return typeof a[b]!=o}function e(a){return function(b,c){for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0}}function f(a){return a&&p(a,r)&&A(a,q)}function i(a){window.alert("Rangy not supported in your browser. Reason: "+a);x.initialized=!0;x.supported=!1}function g(){if(!x.initialized){var b,d=!1,e=!1;a(document,"createRange")&&
(b=document.createRange(),p(b,m)&&A(b,n)&&(d=!0),b.detach());if((b=c(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(b,"createTextRange"))b=b.createTextRange(),f(b)&&(e=!0);!d&&!e&&i("Neither Range nor TextRange are implemented");x.initialized=!0;x.features={implementsDomRange:d,implementsTextRange:e};d=D.concat(y);e=0;for(b=d.length;e<b;++e)try{d[e](x)}catch(j){c(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
...
q="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),r="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),p=e(a),s=e(c),A=e(d),x={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:a,isHostObject:c,isHostProperty:d,areHostMethods:p,areHostObjects:s,areHostProperties:A,isTextRange:f},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
x.fail=i;x.warn=function(a){a="Rangy warning: "+a;x.config.alertOnWarn?window.alert(a):typeof window.console!=o&&typeof window.console.log!=o&&window.console.log(a)};({}).hasOwnProperty?x.util.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])}:i("hasOwnProperty not supported");var y=[],D=[];x.init=g;x.addInitListener=function(a){x.initialized?a(x):y.push(a)};var z=[];x.addCreateMissingNativeApiListener=function(a){z.push(a)};x.createMissingNativeApi=function(a){a=a||window;g();
for(var b=0,c=z.length;b<c;++b)z[b](a)};b.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};b.prototype.warn=function(a){x.warn("Module "+this.name+": "+a)};b.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};x.createModule=function(a,c){var d=new b(a);x.modules[a]=d;D.push(function(a){c(a,d);d.initialized=!0;d.supported=!0})};x.requireModules=function(a){for(var c=0,d=a.length,f,e;c<
d;++c){e=a[c];f=x.modules[e];if(!f||!(f instanceof b))throw Error("Module '"+e+"' not found");if(!f.supported)throw Error("Module '"+e+"' not supported");}};var B=!1,s=function(){B||(B=!0,x.initialized||g())};if(typeof window==o)i("No window found");else if(typeof document==o)i("No document found");else return a(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",s,!1),a(window,"addEventListener")?window.addEventListener("load",s,!1):a(window,"attachEvent")?window.attachEvent("onload",
s):i("Window does not have required addEventListener or attachEvent method"),x}();
...
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function p(a,b,c){this.nodes=n(a,b,c);this._next=this.nodes[0];this._position=0}function s(a){return function(b,c){for(var d,h=c?b:b.parentNode;h;){d=h.nodeType;if(t.arrayContains(a,d))return h;h=h.parentNode}return null}}function A(a,b){if(ha(a,b))throw new r("INVALID_NODE_TYPE_ERR");}function x(a){if(!a.startContainer)throw new G("INVALID_STATE_ERR");}function y(a,b){if(!t.arrayContains(b,a.nodeType))throw new r("INVALID_NODE_TYPE_ERR");
}function D(a,b){if(0>b||b>(t.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new G("INDEX_SIZE_ERR");}function z(a,b){if(M(a,!0)!==M(b,!0))throw new G("WRONG_DOCUMENT_ERR");}function B(a){if(Y(a,!0))throw new G("NO_MODIFICATION_ALLOWED_ERR");}function F(a,b){if(!a)throw new G(b);}function N(a){return!!a.startContainer&&!!a.endContainer&&!(!t.arrayContains(H,a.startContainer.nodeType)&&!M(a.startContainer,!0))&&!(!t.arrayContains(H,a.endContainer.nodeType)&&!M(a.endContainer,!0))&&a.startOffset<=
(t.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(t.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function E(a){x(a);if(!N(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function v(){}function S(a){a.START_TO_START=k;a.START_TO_END=w;a.END_TO_END=u;a.END_TO_START=K;a.NODE_BEFORE=P;a.NODE_AFTER=T;a.NODE_BEFORE_AND_AFTER=fa;a.NODE_INSIDE=Z}function Q(a){S(a);
S(a.prototype)}function h(a,b){return function(){E(this);var c=this.startContainer,d=this.startOffset,h=this.commonAncestorContainer,k=new q(this,!0);c!==h&&(c=t.getClosestAncestorIn(c,h,!0),d=i(c),c=d.node,d=d.offset);j(k,B);k.reset();h=a(k);k.detach();b(this,c,d,c,d);return h}}function U(b,d,k){function e(a,b){return function(c){x(this);y(c,O);y(R(c),H);c=(a?f:i)(c);(b?j:g)(this,c.node,c.offset)}}function j(a,b,c){var h=a.endContainer,k=a.endOffset;if(b!==a.startContainer||c!==a.startOffset){if(R(b)!=
R(h)||1==t.comparePoints(b,c,h,k))h=b,k=c;d(a,b,c,h,k)}}function g(a,b,c){var h=a.startContainer,k=a.startOffset;if(b!==a.endContainer||c!==a.endOffset){if(R(b)!=R(h)||-1==t.comparePoints(b,c,h,k))h=b,k=c;d(a,h,k,b,c)}}b.prototype=new v;a.util.extend(b.prototype,{setStart:function(a,b){x(this);A(a,!0);D(a,b);j(this,a,b)},setEnd:function(a,b){x(this);A(a,!0);D(a,b);g(this,a,b)},setStartBefore:e(!0,!0),setStartAfter:e(!1,!0),setEndBefore:e(!0,!1),setEndAfter:e(!1,!1),collapse:function(a){E(this);a?
d(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):d(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){x(this);A(a,!0);d(this,a,0,a,t.getNodeLength(a))},selectNode:function(a){x(this);A(a,!1);y(a,O);var b=f(a),a=i(a);d(this,b.node,b.offset,a.node,a.offset)},extractContents:h(o,d),deleteContents:h(l,d),canSurroundContents:function(){E(this);B(this.startContainer);B(this.endContainer);var a=new q(this,!0),b=a._first&&
...
this.ec,f=this.eo);V(a,c,h,k,f)}return new q(a,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};r.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};r.prototype.toString=function(){return this.message};p.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
detach:function(){this._current=this._next=this.nodes=null}};var O=[1,3,4,5,7,8,10],H=[2,9,11],W=[1,3,4,5,7,8,10,11],$=[1,3,4,5,7,8],R=t.getRootContainer,M=s([9,11]),Y=s([5,6,10,12]),ha=s([6,10,12]),ba=document.createElement("style"),da=!1;try{ba.innerHTML="<b>x</b>",da=3==ba.firstChild.nodeType}catch(pa){}a.features.htmlParsingConforms=da;var X="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),k=0,w=1,u=2,K=3,P=0,T=1,fa=2,Z=3;v.prototype={attachListener:function(a,
b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){E(this);z(this.startContainer,b.startContainer);var c=a==K||a==k?"start":"end",d=a==w||a==k?"start":"end";return t.comparePoints(this[c+"Container"],this[c+"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){E(this);y(a,W);B(this.startContainer);if(t.isAncestorOf(a,this.startContainer,!0))throw new G("HIERARCHY_REQUEST_ERR");this.setStartBefore(g(a,this.startContainer,this.startOffset))},cloneContents:function(){E(this);
...
return!0},isAppliedToSelection:function(b){for(var b=a.getSelection(b||window).getAllRanges(),c=b.length;c--;)if(!this.isAppliedToRange(b[c]))return!1;return!0},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)},toggleSelection:function(a){this.isAppliedToSelection(a)?this.undoToSelection(a):this.applyToSelection(a)},detach:function(){}};x.util={hasClass:d,addClass:e,removeClass:D,hasSameClasses:i,replaceWithOwnChildren:g,elementsHaveSameNonClassAttributes:l,
elementHasNonClassAttributes:o,splitNodeAt:p,isEditableElement:B,isEditingHost:n,isEditable:m};a.CssClassApplier=x;a.createCssClassApplier=function(a,b,c){return new x(a,b,c)}});
...
(function(a,c){function d(a){var b=U[a]={},c,d,a=a.split(/\s+/);c=0;for(d=a.length;c<d;c++)b[a[c]]=!0;return b}function e(a,b,d){if(d===c&&1===a.nodeType)if(d="data-"+b.replace(L,"-$1").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:h.isNumeric(d)?+d:V.test(d)?h.parseJSON(d):d}catch(e){}h.data(a,b,d)}else d=c;return d}function f(a){for(var b in a)if(!("data"===b&&h.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function i(a,b,c){var d=
...
c)for(;4>e;e+=2)c||(d-=parseFloat(h.css(a,"padding"+ia[e]))||0),d="margin"===c?d+(parseFloat(h.css(a,c+ia[e]))||0):d-(parseFloat(h.css(a,"border"+ia[e]+"Width"))||0);return d+"px"}d=la(a,b);if(0>d||null==d)d=a.style[b];if(wa.test(d))return d;d=parseFloat(d)||0;if(c)for(;4>e;e+=2)d+=parseFloat(h.css(a,"padding"+ia[e]))||0,"padding"!==c&&(d+=parseFloat(h.css(a,"border"+ia[e]+"Width"))||0),"margin"===c&&(d+=parseFloat(h.css(a,c+ia[e]))||0);return d+"px"}function s(a){return function(b,c){"string"!==
typeof b&&(c=b,b="*");if(h.isFunction(c))for(var d=b.toLowerCase().split(La),e=0,f=d.length,k,g;e<f;e++)k=d[e],(g=/^\+/.test(k))&&(k=k.substr(1)||"*"),k=a[k]=a[k]||[],k[g?"unshift":"push"](c)}}function A(a,b,d,e,f,k){f=f||b.dataTypes[0];k=k||{};k[f]=!0;for(var f=a[f],g=0,i=f?f.length:0,h=a===xa,j;g<i&&(h||!j);g++)j=f[g](b,d,e),"string"===typeof j&&(!h||k[j]?j=c:(b.dataTypes.unshift(j),j=A(a,b,d,e,j,k)));if((h||!j)&&!k["*"])j=A(a,b,d,e,"*",k);return j}function x(a,b){var d,e,f=h.ajaxSettings.flatOptions||
{};for(d in b)b[d]!==c&&((f[d]?a:e||(e={}))[d]=b[d]);e&&h.extend(!0,a,e)}function y(a,b,c,d){if(h.isArray(b))h.each(b,function(b,e){c||db.test(a)?d(a,e):y(a+"["+("object"===typeof e?b:"")+"]",e,c,d)});else if(!c&&"object"===h.type(b))for(var e in b)y(a+"["+e+"]",b[e],c,d);else d(a,b)}function D(){try{return new a.XMLHttpRequest}catch(b){}}function z(){setTimeout(B,0);return qa=h.now()}function B(){qa=c}function F(a,b){var c={};h.each(ra.concat.apply([],ra.slice(0,b)),function(){c[this]=a});return c}
function N(a){if(!ya[a]){var b=v.body,c=h("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d){ca||(ca=v.createElement("iframe"),ca.frameBorder=ca.width=ca.height=0);b.appendChild(ca);if(!ma||!ca.createElement)ma=(ca.contentWindow||ca.contentDocument).document,ma.write((h.support.boxModel?"<!doctype html>":"")+"<html><body>"),ma.close();c=ma.createElement(a);ma.body.appendChild(c);d=h.css(c,"display");b.removeChild(ca)}ya[a]=d}return ya[a]}function E(a){return h.isWindow(a)?
a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var v=a.document,S=a.navigator,Q=a.location,h=function(){function b(){if(!d.isReady){try{v.documentElement.doScroll("left")}catch(a){setTimeout(b,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,k)},e=a.jQuery,f=a.$,k,g=/^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,i=/\S/,h=/^\s+/,j=/\s+$/,w=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,l=/^[\],:{}\s]*$/,u=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,m=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
n=/(?:^|:|,)(?:\s*\[)+/g,o=/(webkit)[ \/]([\w.]+)/,q=/(opera)(?:.*version)?[ \/]([\w.]+)/,r=/(msie) ([\w.]+)/,K=/(mozilla)(?:.*? rv:([\w.]+))?/,p=/-([a-z]|[0-9])/ig,P=/^-ms-/,s=function(a,b){return(b+"").toUpperCase()},T=S.userAgent,sa,na,eb=Object.prototype.toString,za=Object.prototype.hasOwnProperty,Aa=Array.prototype.push,x=Array.prototype.slice,A=String.prototype.trim,t=Array.prototype.indexOf,y={};d.fn=d.prototype={constructor:d,init:function(a,b,e){var C;if(!a)return this;if(a.nodeType)return this.context=
this[0]=a,this.length=1,this;if("body"===a&&!b&&v.body)return this.context=v,this[0]=v.body,this.selector=a,this.length=1,this;if("string"===typeof a){if((C="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:g.exec(a))&&(C[1]||!b)){if(C[1])return e=(b=b instanceof d?b[0]:b)?b.ownerDocument||b:v,(a=w.exec(a))?d.isPlainObject(b)?(a=[v.createElement(a[1])],d.fn.attr.call(a,b,!0)):a=[e.createElement(a[1])]:(a=d.buildFragment([C[1]],[e]),a=(a.cacheable?d.clone(a.fragment):a.fragment).childNodes),
...
slice:function(){return this.pushStack(x.apply(this,arguments),"slice",x.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:Aa,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,b,e,C,f,k=arguments[0]||{},g=1,i=arguments.length,h=!1;"boolean"===typeof k&&(h=k,k=arguments[1]||{},g=2);"object"!==typeof k&&!d.isFunction(k)&&(k=
...
1);d.isReady=!0;!0!==a&&0<--d.readyWait||(sa.fireWith(v,[d]),d.fn.trigger&&d(v).trigger("ready").off("ready"))}},bindReady:function(){if(!sa){sa=d.Callbacks("once memory");if("complete"===v.readyState)return setTimeout(d.ready,1);if(v.addEventListener)v.addEventListener("DOMContentLoaded",na,!1),a.addEventListener("load",d.ready,!1);else if(v.attachEvent){v.attachEvent("onreadystatechange",na);a.attachEvent("onload",d.ready);var c=!1;try{c=null==a.frameElement}catch(e){}v.documentElement.doScroll&&
...
i&&a[0]&&a[i-1]||0===i||d.isArray(a)))for(;g<i;g++)C=b(a[g],g,e),null!=C&&(k[k.length]=C);else for(f in a)C=b(a[f],f,e),null!=C&&(k[k.length]=C);return k.concat.apply([],k)},guid:1,proxy:function(a,b){if("string"===typeof b)var e=a[b],b=a,a=e;if(!d.isFunction(a))return c;var C=x.call(arguments,2),e=function(){return a.apply(b,C.concat(x.call(arguments)))};e.guid=a.guid=a.guid||e.guid||d.guid++;return e},access:function(a,b,e,C,f,k,g){var i,h=null==e,j=0,w=a.length;if(e&&"object"===typeof e){for(j in e)d.access(a,
b,j,e[j],1,k,C);f=1}else if(C!==c){i=g===c&&d.isFunction(C);h&&(i?(i=b,b=function(a,b,c){return i.call(d(a),c)}):(b.call(a,C),b=null));if(b)for(;j<w;j++)b(a[j],e,i?C.call(a[j],j,b(a[j],e)):C,g);f=1}return f?a:h?b.call(a):w?b(a[0],e):k},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=o.exec(a)||q.exec(a)||r.exec(a)||0>a.indexOf("compatible")&&K.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,
...
(h=/^[\s\xA0]+/,j=/[\s\xA0]+$/);k=d(v);v.addEventListener?na=function(){v.removeEventListener("DOMContentLoaded",na,false);d.ready()}:v.attachEvent&&(na=function(){if(v.readyState==="complete"){v.detachEvent("onreadystatechange",na);d.ready()}});return d}(),U={};h.Callbacks=function(a){var a=a?U[a]||d(a):{},b=[],e=[],f,k,g,i,j,w,l=function(c){var d,e,f,k;d=0;for(e=c.length;d<e;d++)f=c[d],k=h.type(f),"array"===k?l(f):"function"===k&&(!a.unique||!m.has(f))&&b.push(f)},u=function(c,d){d=d||[];f=!a.memory||
[c,d];g=k=!0;w=i||0;i=0;for(j=b.length;b&&w<j;w++)if(!1===b[w].apply(c,d)&&a.stopOnFalse){f=!0;break}g=!1;b&&(a.once?!0===f?m.disable():b=[]:e&&e.length&&(f=e.shift(),m.fireWith(f[0],f[1])))},m={add:function(){if(b){var a=b.length;l(arguments);g?j=b.length:f&&!0!==f&&(i=a,u(f[0],f[1]))}return this},remove:function(){if(b)for(var c=arguments,d=0,e=c.length;d<e;d++)for(var f=0;f<b.length&&!(c[d]===b[f]&&(g&&f<=j&&(j--,f<=w&&w--),b.splice(f--,1),a.unique));f++);return this},has:function(a){if(b)for(var c=
0,d=b.length;c<d;c++)if(a===b[c])return!0;return!1},empty:function(){b=[];return this},disable:function(){b=e=f=c;return this},disabled:function(){return!b},lock:function(){e=c;(!f||!0===f)&&m.disable();return this},locked:function(){return!e},fireWith:function(b,c){e&&(g?a.once||e.push([b,c]):(!a.once||!f)&&u(b,c));return this},fire:function(){m.fireWith(this,arguments);return this},fired:function(){return!!k}};return m};var I=[].slice;h.extend({Deferred:function(a){var b=h.Callbacks("once memory"),
...
pixelMargin:!0};h.boxModel=b.boxModel="CSS1Compat"===v.compatMode;c.checked=!0;b.noCloneChecked=c.cloneNode(!0).checked;e.disabled=!0;b.optDisabled=!f.disabled;try{delete j.test}catch(w){b.deleteExpando=!1}!j.addEventListener&&j.attachEvent&&j.fireEvent&&(j.attachEvent("onclick",function(){b.noCloneEvent=!1}),j.cloneNode(!0).fireEvent("onclick"));c=v.createElement("input");c.value="t";c.setAttribute("type","radio");b.radioValue="t"===c.value;c.setAttribute("checked","checked");c.setAttribute("name",
...
return b}();var V=/^(?:\{.*\}|\[.*\])$/,L=/([A-Z])/g;h.extend({cache:{},uuid:0,expando:"jQuery"+(h.fn.jquery+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(a){a=a.nodeType?h.cache[a[h.expando]]:a[h.expando];return!!a&&!f(a)},data:function(a,b,d,e){if(h.acceptData(a)){var f;f=h.expando;var k="string"===typeof b,g=a.nodeType,i=g?h.cache:a,j=g?a[f]:a[f]&&f,w="events"===b;if(j&&i[j]&&(w||e||i[j].data)||!(k&&d===c)){j||
(g?a[f]=j=++h.uuid:j=f);i[j]||(i[j]={},g||(i[j].toJSON=h.noop));if("object"===typeof b||"function"===typeof b)e?i[j]=h.extend(i[j],b):i[j].data=h.extend(i[j].data,b);f=a=i[j];e||(a.data||(a.data={}),a=a.data);d!==c&&(a[h.camelCase(b)]=d);if(w&&!a[b])return f.events;k?(d=a[b],null==d&&(d=a[h.camelCase(b)])):d=a;return d}}},removeData:function(a,b,c){if(h.acceptData(a)){var d,e,k,g=h.expando,i=a.nodeType,j=i?h.cache:a,w=i?a[g]:g;if(j[w]){if(b&&(d=c?j[w]:j[w].data)){h.isArray(b)||(b in d?b=[b]:(b=h.camelCase(b),
b=b in d?[b]:b.split(" ")));e=0;for(k=b.length;e<k;e++)delete d[b[e]];if(!(c?f:h.isEmptyObject)(d))return}if(!c&&(delete j[w].data,!f(j[w])))return;h.support.deleteExpando||!j.setInterval?delete j[w]:j[w]=null;i&&(h.support.deleteExpando?delete a[g]:a.removeAttribute?a.removeAttribute(g):a[g]=null)}}},_data:function(a,b,c){return h.data(a,b,c,!0)},acceptData:function(a){if(a.nodeName){var b=h.noData[a.nodeName.toLowerCase()];if(b)return!(!0===b||a.getAttribute("classid")!==b)}return!0}});h.fn.extend({data:function(a,
b){var d,f,k,g,i,j=this[0],w=0,l=null;if(a===c){if(this.length&&(l=h.data(j),1===j.nodeType&&!h._data(j,"parsedAttrs"))){k=j.attributes;for(i=k.length;w<i;w++)g=k[w].name,0===g.indexOf("data-")&&(g=h.camelCase(g.substring(5)),e(j,g,l[g]));h._data(j,"parsedAttrs",!0)}return l}if("object"===typeof a)return this.each(function(){h.data(this,a)});d=a.split(".",2);d[1]=d[1]?"."+d[1]:"";f=d[1]+"!";return h.access(this,function(b){if(b===c)return l=this.triggerHandler("getData"+f,[d[0]]),l===c&&j&&(l=h.data(j,
...
typeof a&&(b=a,a=c);for(var a=a||"fx",e=h.Deferred(),f=this,k=f.length,g=1,i=a+"defer",j=a+"queue",w=a+"mark",l;k--;)if(l=h.data(f[k],i,c,!0)||(h.data(f[k],j,c,!0)||h.data(f[k],w,c,!0))&&h.data(f[k],i,h.Callbacks("once memory"),!0))g++,l.add(d);d();return e.promise(b)}});var t=/[\n\t\r]/g,J=/\s+/,G=/\r/g,O=/^(?:button|input)$/i,H=/^(?:button|input|object|select|textarea)$/i,W=/^a(?:rea)?$/i,$=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,
R=h.support.getSetAttribute,M,Y,ha;h.fn.extend({attr:function(a,b){return h.access(this,h.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){h.removeAttr(this,a)})},prop:function(a,b){return h.access(this,h.prop,a,b,1<arguments.length)},removeProp:function(a){a=h.propFix[a]||a;return this.each(function(){try{this[a]=c,delete this[a]}catch(b){}})},addClass:function(a){var b,c,d,e,f,k,g;if(h.isFunction(a))return this.each(function(b){h(this).addClass(a.call(this,b,this.className))});
...
0<=h.inArray(h(this).val(),c)});c.length||(a.selectedIndex=-1);return c}}},attrFn:{val:!0,css:!0,html:!0,text:!0,data:!0,width:!0,height:!0,offset:!0},attr:function(a,b,d,e){var f,k,g=a.nodeType;if(a&&!(3===g||8===g||2===g)){if(e&&b in h.attrFn)return h(a)[b](d);if("undefined"===typeof a.getAttribute)return h.prop(a,b,d);if(e=1!==g||!h.isXMLDoc(a))b=b.toLowerCase(),k=h.attrHooks[b]||($.test(b)?Y:M);if(d!==c)if(null===d)h.removeAttr(a,b);else{if(k&&"set"in k&&e&&(f=k.set(a,d,b))!==c)return f;a.setAttribute(b,
""+d);return d}else{if(k&&"get"in k&&e&&null!==(f=k.get(a,b)))return f;f=a.getAttribute(b);return null===f?c:f}}},removeAttr:function(a,b){var c,d,e,f,k,g=0;if(b&&1===a.nodeType){d=b.toLowerCase().split(J);for(f=d.length;g<f;g++)if(e=d[g])c=h.propFix[e]||e,(k=$.test(e))||h.attr(a,e,""),a.removeAttribute(R?e:c),k&&c in a&&(a[c]=!1)}},attrHooks:{type:{set:function(a,b){if(O.test(a.nodeName)&&a.parentNode)h.error("type property can't be changed");else if(!h.support.radioValue&&"radio"===b&&h.nodeName(a,
"input")){var c=a.value;a.setAttribute("type",b);c&&(a.value=c);return b}}},value:{get:function(a,b){return M&&h.nodeName(a,"button")?M.get(a,b):b in a?a.value:null},set:function(a,b,c){if(M&&h.nodeName(a,"button"))return M.set(a,b,c);a.value=b}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},
prop:function(a,b,d){var e,f,k=a.nodeType;if(a&&!(3===k||8===k||2===k)){if(1!==k||!h.isXMLDoc(a))b=h.propFix[b]||b,f=h.propHooks[b];return d!==c?f&&"set"in f&&(e=f.set(a,d,b))!==c?e:a[b]=d:f&&"get"in f&&null!==(e=f.get(a,b))?e:a[b]}},propHooks:{tabIndex:{get:function(a){var b=a.getAttributeNode("tabindex");return b&&b.specified?parseInt(b.value,10):H.test(a.nodeName)||W.test(a.nodeName)&&a.href?0:c}}}});h.attrHooks.tabindex=h.propHooks.tabIndex;Y={get:function(a,b){var d,e=h.prop(a,b);return!0===
e||"boolean"!==typeof e&&(d=a.getAttributeNode(b))&&!1!==d.nodeValue?b.toLowerCase():c},set:function(a,b,c){!1===b?h.removeAttr(a,c):(b=h.propFix[c]||c,b in a&&(a[b]=!0),a.setAttribute(c,c.toLowerCase()));return c}};R||(ha={name:!0,id:!0,coords:!0},M=h.valHooks.button={get:function(a,b){var d;return(d=a.getAttributeNode(b))&&(ha[b]?""!==d.nodeValue:d.specified)?d.nodeValue:c},set:function(a,b,c){var d=a.getAttributeNode(c);d||(d=v.createAttribute(c),a.setAttributeNode(d));return d.nodeValue=b+""}},
h.attrHooks.tabindex.set=M.set,h.each(["width","height"],function(a,b){h.attrHooks[b]=h.extend(h.attrHooks[b],{set:function(a,c){if(""===c)return a.setAttribute(b,"auto"),c}})}),h.attrHooks.contenteditable={get:M.get,set:function(a,b,c){""===b&&(b="false");M.set(a,b,c)}});h.support.hrefNormalized||h.each(["href","src","width","height"],function(a,b){h.attrHooks[b]=h.extend(h.attrHooks[b],{get:function(a){a=a.getAttribute(b,2);return a===null?c:a}})});h.support.style||(h.attrHooks.style={get:function(a){return a.style.cssText.toLowerCase()||
...
{set:function(a,b){if(h.isArray(b))return a.checked=h.inArray(h(a).val(),b)>=0}})});var ba=/^(?:textarea|input|select)$/i,da=/^([^\.]*)?(?:\.(.+))?$/,pa=/(?:^|\s)hover(\.\S+)?\b/,X=/^key/,k=/^(?:mouse|contextmenu)|click/,w=/^(?:focusinfocus|focusoutblur)$/,u=/^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/,K=function(a){if(a=u.exec(a)){a[1]=(a[1]||"").toLowerCase();a[3]=a[3]&&RegExp("(?:^|\\s)"+a[3]+"(?:\\s|$)")}return a},P=function(a){return h.event.special.hover?a:a.replace(pa,"mouseenter$1 mouseleave$1")};
h.event={add:function(a,b,d,e,f){var k,g,i,j,w,l,u,m,n;if(!(a.nodeType===3||a.nodeType===8||!b||!d||!(k=h._data(a)))){if(d.handler){u=d;d=u.handler;f=u.selector}if(!d.guid)d.guid=h.guid++;i=k.events;if(!i)k.events=i={};g=k.handle;if(!g){k.handle=g=function(a){return typeof h!=="undefined"&&(!a||h.event.triggered!==a.type)?h.event.dispatch.apply(g.elem,arguments):c};g.elem=a}b=h.trim(P(b)).split(" ");for(k=0;k<b.length;k++){j=da.exec(b[k])||[];w=j[1];l=(j[2]||"").split(".").sort();n=h.event.special[w]||
{};w=(f?n.delegateType:n.bindType)||w;n=h.event.special[w]||{};j=h.extend({type:w,origType:j[1],data:e,handler:d,guid:d.guid,selector:f,quick:f&&K(f),namespace:l.join(".")},u);m=i[w];if(!m){m=i[w]=[];m.delegateCount=0;if(!n.setup||n.setup.call(a,e,l,g)===false)a.addEventListener?a.addEventListener(w,g,false):a.attachEvent&&a.attachEvent("on"+w,g)}if(n.add){n.add.call(a,j);if(!j.handler.guid)j.handler.guid=d.guid}f?m.splice(m.delegateCount++,0,j):m.push(j);h.event.global[w]=true}a=null}},global:{},
remove:function(a,b,c,d,e){var f=h.hasData(a)&&h._data(a),k,g,i,j,w,l,u,m,n,o;if(f&&(u=f.events)){b=h.trim(P(b||"")).split(" ");for(k=0;k<b.length;k++){g=da.exec(b[k])||[];i=j=g[1];g=g[2];if(i){m=h.event.special[i]||{};i=(d?m.delegateType:m.bindType)||i;n=u[i]||[];w=n.length;g=g?RegExp("(^|\\.)"+g.split(".").sort().join("\\.(?:.*\\.)?")+"(\\.|$)"):null;for(l=0;l<n.length;l++){o=n[l];if((e||j===o.origType)&&(!c||c.guid===o.guid)&&(!g||g.test(o.namespace))&&(!d||d===o.selector||d==="**"&&o.selector)){n.splice(l--,
1);o.selector&&n.delegateCount--;m.remove&&m.remove.call(a,o)}}if(n.length===0&&w!==n.length){(!m.teardown||m.teardown.call(a,g)===false)&&h.removeEvent(a,i,f.handle);delete u[i]}}else for(i in u)h.event.remove(a,i+b[k],c,d,true)}if(h.isEmptyObject(u)){if(b=f.handle)b.elem=null;h.removeData(a,["events","handle"],true)}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(b,d,e,f){if(!e||!(e.nodeType===3||e.nodeType===8)){var k=b.type||b,g=[],i,j,l,u,m;if(!w.test(k+h.event.triggered)){if(k.indexOf("!")>=
0){k=k.slice(0,-1);i=true}if(k.indexOf(".")>=0){g=k.split(".");k=g.shift();g.sort()}if(e&&!h.event.customEvent[k]||h.event.global[k]){b=typeof b==="object"?b[h.expando]?b:new h.Event(k,b):new h.Event(k);b.type=k;b.isTrigger=true;b.exclusive=i;b.namespace=g.join(".");b.namespace_re=b.namespace?RegExp("(^|\\.)"+g.join("\\.(?:.*\\.)?")+"(\\.|$)"):null;i=k.indexOf(":")<0?"on"+k:"";if(e){b.result=c;if(!b.target)b.target=e;d=d!=null?h.makeArray(d):[];d.unshift(b);l=h.event.special[k]||{};if(!(l.trigger&&
l.trigger.apply(e,d)===false)){m=[[e,l.bindType||k]];if(!f&&!l.noBubble&&!h.isWindow(e)){u=l.delegateType||k;g=w.test(u+k)?e:e.parentNode;for(j=null;g;g=g.parentNode){m.push([g,u]);j=g}j&&j===e.ownerDocument&&m.push([j.defaultView||j.parentWindow||a,u])}for(j=0;j<m.length&&!b.isPropagationStopped();j++){g=m[j][0];b.type=m[j][1];(u=(h._data(g,"events")||{})[b.type]&&h._data(g,"handle"))&&u.apply(g,d);(u=i&&g[i])&&h.acceptData(g)&&u.apply(g,d)===false&&b.preventDefault()}b.type=k;if(!f&&!b.isDefaultPrevented()&&
(!l._default||l._default.apply(e.ownerDocument,d)===false)&&!(k==="click"&&h.nodeName(e,"a"))&&h.acceptData(e))if(i&&e[k]&&(k!=="focus"&&k!=="blur"||b.target.offsetWidth!==0)&&!h.isWindow(e)){(j=e[i])&&(e[i]=null);h.event.triggered=k;e[k]();h.event.triggered=c;j&&(e[i]=j)}return b.result}}else{e=h.cache;for(j in e)e[j].events&&e[j].events[k]&&h.event.trigger(b,d,e[j].handle.elem,true)}}}}},dispatch:function(b){var b=h.event.fix(b||a.event),d=(h._data(this,"events")||{})[b.type]||[],e=d.delegateCount,
f=[].slice.call(arguments,0),k=!b.exclusive&&!b.namespace,g=h.event.special[b.type]||{},i=[],j,w,l,u,m,n,o;f[0]=b;b.delegateTarget=this;if(!(g.preDispatch&&g.preDispatch.call(this,b)===false)){if(e&&!(b.button&&b.type==="click")){l=h(this);l.context=this.ownerDocument||this;for(w=b.target;w!=this;w=w.parentNode||this)if(w.disabled!==true){m={};n=[];l[0]=w;for(j=0;j<e;j++){u=d[j];o=u.selector;if(m[o]===c){var q=m,r=o,K;if(u.quick){K=u.quick;var p=w.attributes||{};K=(!K[1]||w.nodeName.toLowerCase()===
K[1])&&(!K[2]||(p.id||{}).value===K[2])&&(!K[3]||K[3].test((p["class"]||{}).value))}else K=l.is(o);q[r]=K}m[o]&&n.push(u)}n.length&&i.push({elem:w,matches:n})}}d.length>e&&i.push({elem:this,matches:d.slice(e)});for(j=0;j<i.length&&!b.isPropagationStopped();j++){e=i[j];b.currentTarget=e.elem;for(d=0;d<e.matches.length&&!b.isImmediatePropagationStopped();d++){u=e.matches[d];if(k||!b.namespace&&!u.namespace||b.namespace_re&&b.namespace_re.test(u.namespace)){b.data=u.data;b.handleObj=u;u=((h.event.special[u.origType]||
{}).handle||u.handler).apply(e.elem,f);if(u!==c){b.result=u;if(u===false){b.preventDefault();b.stopPropagation()}}}}}g.postDispatch&&g.postDispatch.call(this,b);return b.result}},props:"attrChange,attrName,relatedNode,srcElement,altKey,bubbles,cancelable,ctrlKey,currentTarget,eventPhase,metaKey,relatedTarget,shiftKey,target,timeStamp,view,which".split(","),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){if(a.which==null)a.which=b.charCode!=null?b.charCode:b.keyCode;
...
postDispatch:function(a){if(a._submit_bubble){delete a._submit_bubble;this.parentNode&&!a.isTrigger&&h.event.simulate("submit",this.parentNode,a,true)}},teardown:function(){if(h.nodeName(this,"form"))return false;h.event.remove(this,"._submit")}});h.support.changeBubbles||(h.event.special.change={setup:function(){if(ba.test(this.nodeName)){if(this.type==="checkbox"||this.type==="radio"){h.event.add(this,"propertychange._change",function(a){if(a.originalEvent.propertyName==="checked")this._just_changed=
true});h.event.add(this,"click._change",function(a){if(this._just_changed&&!a.isTrigger){this._just_changed=false;h.event.simulate("change",this,a,true)}})}return false}h.event.add(this,"beforeactivate._change",function(a){a=a.target;if(ba.test(a.nodeName)&&!a._change_attached){h.event.add(a,"change._change",function(a){this.parentNode&&!a.isSimulated&&!a.isTrigger&&h.event.simulate("change",this.parentNode,a,true)});a._change_attached=true}})},handle:function(a){var b=a.target;if(this!==b||a.isSimulated||
a.isTrigger||b.type!=="radio"&&b.type!=="checkbox")return a.handleObj.handler.apply(this,arguments)},teardown:function(){h.event.remove(this,"._change");return ba.test(this.nodeName)}});h.support.focusinBubbles||h.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){h.event.simulate(b,a.target,h.event.fix(a),true)};h.event.special[b]={setup:function(){c++===0&&v.addEventListener(a,d,true)},teardown:function(){--c===0&&v.removeEventListener(a,d,true)}}});h.fn.extend({on:function(a,
...
0?this.on(b,null,a,c):this.trigger(b)};h.attrFn&&(h.attrFn[b]=true);if(X.test(b))h.event.fixHooks[b]=h.event.keyHooks;if(k.test(b))h.event.fixHooks[b]=h.event.mouseHooks});(function(){function a(b,c,d,f,k,g){for(var k=0,i=f.length;k<i;k++){var j=f[k];if(j){for(var h=false,j=j[b];j;){if(j[e]===d){h=f[j.sizset];break}if(j.nodeType===1&&!g){j[e]=d;j.sizset=k}if(j.nodeName.toLowerCase()===c){h=j;break}j=j[b]}f[k]=h}}}function b(a,c,d,f,k,g){for(var k=0,i=f.length;k<i;k++){var j=f[k];if(j){for(var h=false,
j=j[a];j;){if(j[e]===d){h=f[j.sizset];break}if(j.nodeType===1){if(!g){j[e]=d;j.sizset=k}if(typeof c!=="string"){if(j===c){h=true;break}}else if(u.filter(c,[j]).length>0){h=j;break}}j=j[a]}f[k]=h}}}var d=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,e="sizcache"+(Math.random()+"").replace(".",""),f=0,k=Object.prototype.toString,g=false,i=true,j=/\\/g,w=/\r\n/g,l=/\W/;[0,0].sort(function(){i=false;return 0});var u=
function(a,b,c,e){var c=c||[],f=b=b||v;if(b.nodeType!==1&&b.nodeType!==9)return[];if(!a||typeof a!=="string")return c;var g,i,j,h,w,C=true,l=u.isXML(b),m=[],q=a;do{d.exec("");if(g=d.exec(q)){q=g[3];m.push(g[1]);if(g[2]){h=g[3];break}}}while(g);if(m.length>1&&o.exec(a))if(m.length===2&&n.relative[m[0]])i=T(m[0]+m[1],b,e);else for(i=n.relative[m[0]]?[b]:u(m.shift(),b);m.length;){a=m.shift();n.relative[a]&&(a=a+m.shift());i=T(a,i,e)}else{if(!e&&m.length>1&&b.nodeType===9&&!l&&n.match.ID.test(m[0])&&
!n.match.ID.test(m[m.length-1])){g=u.find(m.shift(),b,l);b=g.expr?u.filter(g.expr,g.set)[0]:g.set[0]}if(b){g=e?{expr:m.pop(),set:r(e)}:u.find(m.pop(),m.length===1&&(m[0]==="~"||m[0]==="+")&&b.parentNode?b.parentNode:b,l);i=g.expr?u.filter(g.expr,g.set):g.set;for(m.length>0?j=r(i):C=false;m.length;){g=w=m.pop();n.relative[w]?g=m.pop():w="";g==null&&(g=b);n.relative[w](j,g,l)}}else j=[]}j||(j=i);j||u.error(w||a);if(k.call(j)==="[object Array]")if(C)if(b&&b.nodeType===1)for(a=0;j[a]!=null;a++)j[a]&&
(j[a]===true||j[a].nodeType===1&&u.contains(b,j[a]))&&c.push(i[a]);else for(a=0;j[a]!=null;a++)j[a]&&j[a].nodeType===1&&c.push(i[a]);else c.push.apply(c,j);else r(j,c);if(h){u(h,f,c,e);u.uniqueSort(c)}return c};u.uniqueSort=function(a){if(P){g=i;a.sort(P);if(g)for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1)}return a};u.matches=function(a,b){return u(a,null,null,b)};u.matchesSelector=function(a,b){return u(b,null,null,[a]).length>0};u.find=function(a,b,c){var d,e,f,k,g,i;if(!a)return[];e=
0;for(f=n.order.length;e<f;e++){g=n.order[e];if(k=n.leftMatch[g].exec(a)){i=k[1];k.splice(1,1);if(i.substr(i.length-1)!=="\\"){k[1]=(k[1]||"").replace(j,"");d=n.find[g](k,b,c);if(d!=null){a=a.replace(n.match[g],"");break}}}}d||(d=typeof b.getElementsByTagName!=="undefined"?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};u.filter=function(a,b,d,e){for(var f,k,g,i,j,h,w,C,l=a,m=[],o=b,q=b&&b[0]&&u.isXML(b[0]);a&&b.length;){for(g in n.filter)if((f=n.leftMatch[g].exec(a))!=null&&f[2]){h=n.filter[g];
j=f[1];k=false;f.splice(1,1);if(j.substr(j.length-1)!=="\\"){o===m&&(m=[]);if(n.preFilter[g])if(f=n.preFilter[g](f,o,d,m,e,q)){if(f===true)continue}else k=i=true;if(f)for(w=0;(j=o[w])!=null;w++)if(j){i=h(j,f,w,o);C=e^i;if(d&&i!=null)C?k=true:o[w]=false;else if(C){m.push(j);k=true}}if(i!==c){d||(o=m);a=a.replace(n.match[g],"");if(!k)return[];break}}}if(a===l)if(k==null)u.error(a);else break;l=a}return o};u.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};var m=u.getText=
function(a){var b,c;b=a.nodeType;var d="";if(b)if(b===1||b===9||b===11){if(typeof a.textContent==="string")return a.textContent;if(typeof a.innerText==="string")return a.innerText.replace(w,"");for(a=a.firstChild;a;a=a.nextSibling)d=d+m(a)}else{if(b===3||b===4)return a.nodeValue}else for(b=0;c=a[b];b++)c.nodeType!==8&&(d=d+m(c));return d},n=u.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,
ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/,TAG:/^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/,CHILD:/:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/,POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/,PSEUDO:/:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/},leftMatch:{},attrMap:{"class":"className","for":"htmlFor"},attrHandle:{href:function(a){return a.getAttribute("href")},
type:function(a){return a.getAttribute("type")}},relative:{"+":function(a,b){var c=typeof b==="string",d=c&&!l.test(b),c=c&&!d;d&&(b=b.toLowerCase());for(var d=0,e=a.length,f;d<e;d++)if(f=a[d]){for(;(f=f.previousSibling)&&f.nodeType!==1;);a[d]=c||f&&f.nodeName.toLowerCase()===b?f||false:f===b}c&&u.filter(b,a,true)},">":function(a,b){var c,d=typeof b==="string",e=0,f=a.length;if(d&&!l.test(b))for(b=b.toLowerCase();e<f;e++){if(c=a[e]){c=c.parentNode;a[e]=c.nodeName.toLowerCase()===b?c:false}}else{for(;e<
f;e++)(c=a[e])&&(a[e]=d?c.parentNode:c.parentNode===b);d&&u.filter(b,a,true)}},"":function(c,d,e){var k,g=f++,i=b;if(typeof d==="string"&&!l.test(d)){k=d=d.toLowerCase();i=a}i("parentNode",d,g,c,k,e)},"~":function(c,d,e){var k,g=f++,i=b;if(typeof d==="string"&&!l.test(d)){k=d=d.toLowerCase();i=a}i("previousSibling",d,g,c,k,e)}},find:{ID:function(a,b,c){if(typeof b.getElementById!=="undefined"&&!c)return(a=b.getElementById(a[1]))&&a.parentNode?[a]:[]},NAME:function(a,b){if(typeof b.getElementsByName!==
...
"")},TAG:function(a){return a[1].replace(j,"").toLowerCase()},CHILD:function(a){if(a[1]==="nth"){a[2]||u.error(a[0]);a[2]=a[2].replace(/^\+|\s*/g,"");var b=/(-?)(\d*)(?:n([+\-]?\d*))?/.exec(a[2]==="even"&&"2n"||a[2]==="odd"&&"2n+1"||!/\D/.test(a[2])&&"0n+"+a[2]||a[2]);a[2]=b[1]+(b[2]||1)-0;a[3]=b[3]-0}else a[2]&&u.error(a[0]);a[0]=f++;return a},ATTR:function(a,b,c,d,e,f){b=a[1]=a[1].replace(j,"");!f&&n.attrMap[b]&&(a[1]=n.attrMap[b]);a[4]=(a[4]||a[5]||"").replace(j,"");a[2]==="~="&&(a[4]=" "+a[4]+
...
c=u.attr?u.attr(a,c):n.attrHandle[c]?n.attrHandle[c](a):a[c]!=null?a[c]:a.getAttribute(c),d=c+"",e=b[2],f=b[4];return c==null?e==="!=":!e&&u.attr?c!=null:e==="="?d===f:e==="*="?d.indexOf(f)>=0:e==="~="?(" "+d+" ").indexOf(f)>=0:!f?d&&c!==false:e==="!="?d!==f:e==="^="?d.indexOf(f)===0:e==="$="?d.substr(d.length-f.length)===f:e==="|="?d===f||d.substr(0,f.length+1)===f+"-":false},POS:function(a,b,c,d){var e=n.setFilters[b[2]];if(e)return e(a,c,b,d)}}},o=n.match.POS,q=function(a,b){return"\\"+(b-0+1)},
...
b){var c=b.getElementsByTagName(a[1]);if(a[1]==="*"){for(var d=[],e=0;c[e];e++)c[e].nodeType===1&&d.push(c[e]);c=d}return c};a.innerHTML="<a href='#'></a>";if(a.firstChild&&typeof a.firstChild.getAttribute!=="undefined"&&a.firstChild.getAttribute("href")!=="#")n.attrHandle.href=function(a){return a.getAttribute("href",2)};a=null})();v.querySelectorAll&&function(){var a=u,b=v.createElement("div");b.innerHTML="<p class='TEST'></p>";if(!(b.querySelectorAll&&b.querySelectorAll(".TEST").length===0)){u=
function(b,c,d,e){c=c||v;if(!e&&!u.isXML(c)){var f=/^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(b);if(f&&(c.nodeType===1||c.nodeType===9)){if(f[1])return r(c.getElementsByTagName(b),d);if(f[2]&&n.find.CLASS&&c.getElementsByClassName)return r(c.getElementsByClassName(f[2]),d)}if(c.nodeType===9){if(b==="body"&&c.body)return r([c.body],d);if(f&&f[3]){var k=c.getElementById(f[3]);if(k&&k.parentNode){if(k.id===f[3])return r([k],d)}else return r([],d)}try{return r(c.querySelectorAll(b),d)}catch(g){}}else if(c.nodeType===
1&&c.nodeName.toLowerCase()!=="object"){var f=c,i=(k=c.getAttribute("id"))||"__sizzle__",j=c.parentNode,h=/^\s*[+~]/.test(b);k?i=i.replace(/'/g,"\\$&"):c.setAttribute("id",i);if(h&&j)c=c.parentNode;try{if(!h||j)return r(c.querySelectorAll("[id='"+i+"'] "+b),d)}catch(w){}finally{k||f.removeAttribute("id")}}}return a(b,c,d,e)};for(var c in a)u[c]=a[c];b=null}}();(function(){var a=v.documentElement,b=a.matchesSelector||a.mozMatchesSelector||a.webkitMatchesSelector||a.msMatchesSelector;if(b){var c=!b.call(v.createElement("div"),
"div"),d=false;try{b.call(v.documentElement,"[test!='']:sizzle")}catch(e){d=true}u.matchesSelector=function(a,e){e=e.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!u.isXML(a))try{if(d||!n.match.PSEUDO.test(e)&&!/!=/.test(e)){var f=b.call(a,e);if(f||!c||a.document&&a.document.nodeType!==11)return f}}catch(k){}return u(e,null,null,[a]).length>0}}})();(function(){var a=v.createElement("div");a.innerHTML="<div class='test e'></div><div class='test'></div>";if(a.getElementsByClassName&&a.getElementsByClassName("e").length!==
0){a.lastChild.className="e";if(a.getElementsByClassName("e").length!==1){n.order.splice(1,0,"CLASS");n.find.CLASS=function(a,b,c){if(typeof b.getElementsByClassName!=="undefined"&&!c)return b.getElementsByClassName(a[1])};a=null}}})();u.contains=v.documentElement.contains?function(a,b){return a!==b&&(a.contains?a.contains(b):true)}:v.documentElement.compareDocumentPosition?function(a,b){return!!(a.compareDocumentPosition(b)&16)}:function(){return false};u.isXML=function(a){return(a=(a?a.ownerDocument||
a:0).documentElement)?a.nodeName!=="HTML":false};var T=function(a,b,c){for(var d,e=[],f="",b=b.nodeType?[b]:b;d=n.match.PSEUDO.exec(a);){f=f+d[0];a=a.replace(n.match.PSEUDO,"")}a=n.relative[a]?a+"*":a;d=0;for(var k=b.length;d<k;d++)u(a,b[d],e,c);return u.filter(f,e)};u.attr=h.attr;u.selectors.attrMap={};h.find=u;h.expr=u.selectors;h.expr[":"]=h.expr.filters;h.unique=u.uniqueSort;h.text=u.getText;h.isXMLDoc=u.isXML;h.contains=u.contains})();var T=/Until$/,fa=/^(?:parents|prevUntil|prevAll)/,Z=/,/,
...
"iframe")?a.contentDocument||a.contentWindow.document:h.makeArray(a.childNodes)}},function(a,b){h.fn[a]=function(c,d){var e=h.map(this,b,c);T.test(a)||(d=c);d&&typeof d==="string"&&(e=h.filter(d,e));e=this.length>1&&!Ya[a]?h.unique(e):e;if((this.length>1||Z.test(d))&&fa.test(a))e=e.reverse();return this.pushStack(e,a,Xa.call(arguments).join(","))}});h.extend({filter:function(a,b,c){c&&(a=":not("+a+")");return b.length===1?h.find.matchesSelector(b[0],a)?[b[0]]:[]:h.find.matches(a,b)},dir:function(a,
...
va=/^\s+/,Ga=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Ha=/<([\w:]+)/,$a=/<tbody/i,ab=/<|&#?\w+;/,bb=/<(?:script|style)/i,cb=/<(?:script|object|embed|option|style)/i,Ia=RegExp("<(?:"+Fa+")[\\s/>]","i"),Ja=/checked\s*(?:[^=]|=\s*.checked.)/i,Ka=/\/(java|ecma)script/i,fb=/^\s*<!(?:\[CDATA\[|\-\-)/,aa={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,
"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]},Ba=l(v);aa.optgroup=aa.option;aa.tbody=aa.tfoot=aa.colgroup=aa.caption=aa.thead;aa.th=aa.td;h.support.htmlSerialize||(aa._default=[1,"div<div>","</div>"]);h.fn.extend({text:function(a){return h.access(this,function(a){return a===c?h.text(this):this.empty().append((this[0]&&this[0].ownerDocument||v).createTextNode(a))},null,a,arguments.length)},
wrapAll:function(a){if(h.isFunction(a))return this.each(function(b){h(this).wrapAll(a.call(this,b))});if(this[0]){var b=h(a,this[0].ownerDocument).eq(0).clone(true);this[0].parentNode&&b.insertBefore(this[0]);b.map(function(){for(var a=this;a.firstChild&&a.firstChild.nodeType===1;)a=a.firstChild;return a}).append(this)}return this},wrapInner:function(a){return h.isFunction(a)?this.each(function(b){h(this).wrapInner(a.call(this,b))}):this.each(function(){var b=h(this),c=b.contents();c.length?c.wrapAll(a):
...
b){for(var c=0,d;(d=this[c])!=null;c++)if(!a||h.filter(a,[d]).length){if(!b&&d.nodeType===1){h.cleanData(d.getElementsByTagName("*"));h.cleanData([d])}d.parentNode&&d.parentNode.removeChild(d)}return this},empty:function(){for(var a=0,b;(b=this[a])!=null;a++)for(b.nodeType===1&&h.cleanData(b.getElementsByTagName("*"));b.firstChild;)b.removeChild(b.firstChild);return this},clone:function(a,b){a=a==null?false:a;b=b==null?a:b;return this.map(function(){return h.clone(this,a,b)})},html:function(a){return h.access(this,
function(a){var b=this[0]||{},d=0,e=this.length;if(a===c)return b.nodeType===1?b.innerHTML.replace(Za,""):null;if(typeof a==="string"&&!bb.test(a)&&(h.support.leadingWhitespace||!va.test(a))&&!aa[(Ha.exec(a)||["",""])[1].toLowerCase()]){a=a.replace(Ga,"<$1></$2>");try{for(;d<e;d++){b=this[d]||{};if(b.nodeType===1){h.cleanData(b.getElementsByTagName("*"));b.innerHTML=a}}b=0}catch(f){}}b&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){if(this[0]&&this[0].parentNode){if(h.isFunction(a))return this.each(function(b){var c=
h(this),d=c.html();c.replaceWith(a.call(this,b,d))});typeof a!=="string"&&(a=h(a).detach());return this.each(function(){var b=this.nextSibling,c=this.parentNode;h(this).remove();b?h(b).before(a):h(c).append(a)})}return this.length?this.pushStack(h(h.isFunction(a)?a():a),"replaceWith",a):this},detach:function(a){return this.remove(a,true)},domManip:function(a,b,d){var e,f,k,g=a[0],i=[];if(!h.support.checkClone&&arguments.length===3&&typeof g==="string"&&Ja.test(g))return this.each(function(){h(this).domManip(a,
b,d,true)});if(h.isFunction(g))return this.each(function(e){var f=h(this);a[0]=g.call(this,e,b?f.html():c);f.domManip(a,b,d)});if(this[0]){e=g&&g.parentNode;e=h.support.parentNode&&e&&e.nodeType===11&&e.childNodes.length===this.length?{fragment:e}:h.buildFragment(a,this,i);k=e.fragment;if(f=k.childNodes.length===1?k=k.firstChild:k.firstChild){b=b&&h.nodeName(f,"tr");f=0;for(var j=this.length,w=j-1;f<j;f++)d.call(b?h.nodeName(this[f],"table")?this[f].getElementsByTagName("tbody")[0]||this[f].appendChild(this[f].ownerDocument.createElement("tbody")):
this[f]:this[f],e.cacheable||j>1&&f<w?h.clone(k,true,true):k)}i.length&&h.each(i,function(a,b){b.src?h.ajax({type:"GET",global:false,url:b.src,async:false,dataType:"script"}):h.globalEval((b.text||b.textContent||b.innerHTML||"").replace(fb,"/*$0*/"));b.parentNode&&b.parentNode.removeChild(b)})}return this}});h.buildFragment=function(a,b,c){var d,e,f,k,g=a[0];b&&b[0]&&(k=b[0].ownerDocument||b[0]);k.createDocumentFragment||(k=v);if(a.length===1&&typeof g==="string"&&g.length<512&&k===v&&g.charAt(0)===
"<"&&!cb.test(g)&&(h.support.checkClone||!Ja.test(g))&&(h.support.html5Clone||!Ia.test(g))){e=true;(f=h.fragments[g])&&f!==1&&(d=f)}if(!d){d=k.createDocumentFragment();h.clean(a,k,d,c)}e&&(h.fragments[g]=f?d:1);return{fragment:d,cacheable:e}};h.fragments={};h.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){h.fn[a]=function(c){var d=[],c=h(c),e=this.length===1&&this[0].parentNode;if(e&&e.nodeType===11&&e.childNodes.length===
...
!h.isXMLDoc(a)){n(a,k);d=m(a);e=m(k);for(f=0;d[f];++f)e[f]&&n(d[f],e[f])}if(b){o(a,k);if(c){d=m(a);e=m(k);for(f=0;d[f];++f)o(d[f],e[f])}}return k},clean:function(a,b,c,d){var e,f=[],b=b||v;typeof b.createElement==="undefined"&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||v);for(var k=0,g;(g=a[k])!=null;k++){typeof g==="number"&&(g=g+"");if(g){if(typeof g==="string")if(ab.test(g)){g=g.replace(Ga,"<$1></$2>");e=(Ha.exec(g)||["",""])[1].toLowerCase();var i=aa[e]||aa._default,j=i[0],w=b.createElement("div"),
u=Ba.childNodes;b===v?Ba.appendChild(w):l(b).appendChild(w);for(w.innerHTML=i[1]+g+i[2];j--;)w=w.lastChild;if(!h.support.tbody){j=$a.test(g);i=e==="table"&&!j?w.firstChild&&w.firstChild.childNodes:i[1]==="<table>"&&!j?w.childNodes:[];for(e=i.length-1;e>=0;--e)h.nodeName(i[e],"tbody")&&!i[e].childNodes.length&&i[e].parentNode.removeChild(i[e])}!h.support.leadingWhitespace&&va.test(g)&&w.insertBefore(b.createTextNode(va.exec(g)[0]),w.firstChild);g=w.childNodes;if(w){w.parentNode.removeChild(w);if(u.length>
0)(w=u[u.length-1])&&w.parentNode&&w.parentNode.removeChild(w)}}else g=b.createTextNode(g);var m;if(!h.support.appendChecked)if(g[0]&&typeof(m=g.length)==="number")for(e=0;e<m;e++)r(g[e]);else r(g);g.nodeType?f.push(g):f=h.merge(f,g)}}if(c){a=function(a){return!a.type||Ka.test(a.type)};for(k=0;f[k];k++){b=f[k];if(d&&h.nodeName(b,"script")&&(!b.type||Ka.test(b.type)))d.push(b.parentNode?b.parentNode.removeChild(b):b);else{if(b.nodeType===1){g=h.grep(b.getElementsByTagName("script"),a);f.splice.apply(f,
[k+1,0].concat(g))}c.appendChild(b)}}}return f},cleanData:function(a){for(var b,c,d=h.cache,e=h.event.special,f=h.support.deleteExpando,k=0,g;(g=a[k])!=null;k++)if(!g.nodeName||!h.noData[g.nodeName.toLowerCase()])if(c=g[h.expando]){if((b=d[c])&&b.events){for(var i in b.events)e[i]?h.event.remove(g,i):h.removeEvent(g,i,b.handle);if(b.handle)b.handle.elem=null}f?delete g[h.expando]:g.removeAttribute&&g.removeAttribute(h.expando);delete d[c]}}});var Ca=/alpha\([^)]*\)/i,gb=/opacity=([^)]*)/,hb=/([A-Z]|^ms)/g,
ib=/^[\-+]?(?:\d*\.)?\d+$/i,wa=/^-?(?:\d*\.)?\d+(?!px)[^\d\s]+$/i,jb=/^([\-+])=([\-+.\de]+)/,kb=/^margin/,lb={position:"absolute",visibility:"hidden",display:"block"},ia=["Top","Right","Bottom","Left"],la,Ma,Na;h.fn.css=function(a,b){return h.access(this,function(a,b,d){return d!==c?h.style(a,b,d):h.css(a,b)},a,b,arguments.length>1)};h.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=la(a,"opacity");return c===""?"1":c}return a.style.opacity}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,
opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":h.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,b,d,e){if(a&&!(a.nodeType===3||a.nodeType===8||!a.style)){var f,k=h.camelCase(b),g=a.style,i=h.cssHooks[k],b=h.cssProps[k]||k;if(d!==c){e=typeof d;if(e==="string"&&(f=jb.exec(d))){d=+(f[1]+1)*+f[2]+parseFloat(h.css(a,b));e="number"}if(!(d==null||e==="number"&&isNaN(d))){e==="number"&&!h.cssNumber[k]&&(d=d+"px");if(!i||!("set"in i)||(d=i.set(a,d))!==c)try{g[b]=d}catch(j){}}}else return i&&
"get"in i&&(f=i.get(a,false,e))!==c?f:g[b]}},css:function(a,b,d){var e,f,b=h.camelCase(b);f=h.cssHooks[b];b=h.cssProps[b]||b;b==="cssFloat"&&(b="float");if(f&&"get"in f&&(e=f.get(a,true,d))!==c)return e;if(la)return la(a,b)},swap:function(a,b,c){var d={},e;for(e in b){d[e]=a.style[e];a.style[e]=b[e]}c=c.call(a);for(e in b)a.style[e]=d[e];return c}});h.curCSS=h.css;v.defaultView&&v.defaultView.getComputedStyle&&(Ma=function(a,b){var c,d,e,f=a.style,b=b.replace(hb,"-$1").toLowerCase();if((d=a.ownerDocument.defaultView)&&
(e=d.getComputedStyle(a,null))){c=e.getPropertyValue(b);c===""&&!h.contains(a.ownerDocument.documentElement,a)&&(c=h.style(a,b))}if(!h.support.pixelMargin&&e&&kb.test(b)&&wa.test(c)){d=f.width;f.width=c;c=e.width;f.width=d}return c});v.documentElement.currentStyle&&(Na=function(a,b){var c,d,e=a.currentStyle&&a.currentStyle[b],f=a.style;if(e==null&&f&&(c=f[b]))e=c;if(wa.test(e)){c=f.left;if(d=a.runtimeStyle&&a.runtimeStyle.left)a.runtimeStyle.left=a.currentStyle.left;f.left=b==="fontSize"?"1em":e;
e=f.pixelLeft+"px";f.left=c;if(d)a.runtimeStyle.left=d}return e===""?"auto":e});la=Ma||Na;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){if(c)return a.offsetWidth!==0?p(a,b,d):h.swap(a,lb,function(){return p(a,b,d)})},set:function(a,b){return ib.test(b)?b+"px":b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return gb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,
d=a.currentStyle,e=h.isNumeric(b)?"alpha(opacity="+b*100+")":"",f=d&&d.filter||c.filter||"";c.zoom=1;if(b>=1&&h.trim(f.replace(Ca,""))===""){c.removeAttribute("filter");if(d&&!d.filter)return}c.filter=Ca.test(f)?f.replace(Ca,e):f+" "+e}});h(function(){if(!h.support.reliableMarginRight)h.cssHooks.marginRight={get:function(a,b){return h.swap(a,{display:"inline-block"},function(){return b?la(a,"margin-right"):a.style.marginRight})}}});h.expr&&h.expr.filters&&(h.expr.filters.hidden=function(a){var b=
a.offsetHeight;return a.offsetWidth===0&&b===0||!h.support.reliableHiddenOffsets&&(a.style&&a.style.display||h.css(a,"display"))==="none"},h.expr.filters.visible=function(a){return!h.expr.filters.hidden(a)});h.each({margin:"",padding:"",border:"Width"},function(a,b){h.cssHooks[a+b]={expand:function(c){for(var d=typeof c==="string"?c.split(" "):[c],e={},c=0;c<4;c++)e[a+ia[c]+b]=d[c]||d[c-2]||d[0];return e}}});var mb=/%20/g,db=/\[\]$/,Oa=/\r?\n/g,nb=/#.*$/,ob=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,pb=/^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
qb=/^(?:GET|HEAD)$/,rb=/^\/\//,Pa=/\?/,sb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,tb=/^(?:select|textarea)/i,La=/\s+/,ub=/([?&])_=[^&]*/,Qa=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Ra=h.fn.load,xa={},Sa={},ja,ka,Ta=["*/"]+["*"];try{ja=Q.href}catch(Ab){ja=v.createElement("a"),ja.href="",ja=ja.href}ka=Qa.exec(ja.toLowerCase())||[];h.fn.extend({load:function(a,b,d){if(typeof a!=="string"&&Ra)return Ra.apply(this,arguments);if(!this.length)return this;var e=a.indexOf(" ");if(e>=
...
function(a,b){h[b]=function(a,d,e,f){if(h.isFunction(d)){f=f||e;e=d;d=c}return h.ajax({type:b,url:a,data:d,success:e,dataType:f})}});h.extend({getScript:function(a,b){return h.get(a,c,b,"script")},getJSON:function(a,b,c){return h.get(a,b,c,"json")},ajaxSetup:function(a,b){if(b)x(a,h.ajaxSettings);else{b=a;a=h.ajaxSettings}x(a,b);return a},ajaxSettings:{url:ja,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/.test(ka[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",
processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Ta},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:s(xa),ajaxTransport:s(Sa),ajax:function(a,b){function d(a,b,u,l){if(K!==2){K=2;q&&clearTimeout(q);o=c;m=l||"";s.readyState=
a>0?4:0;var n,r,C,l=b;if(u){var P=e,T=s,x=P.contents,ea=P.dataTypes,A=P.responseFields,t,v,ga,y;for(v in A)v in u&&(T[A[v]]=u[v]);for(;ea[0]==="*";){ea.shift();t===c&&(t=P.mimeType||T.getResponseHeader("content-type"))}if(t)for(v in x)if(x[v]&&x[v].test(t)){ea.unshift(v);break}if(ea[0]in u)ga=ea[0];else{for(v in u){if(!ea[0]||P.converters[v+" "+ea[0]]){ga=v;break}y||(y=v)}ga=ga||y}if(ga){ga!==ea[0]&&ea.unshift(ga);u=u[ga]}else u=void 0}else u=c;if(a>=200&&a<300||a===304){if(e.ifModified){if(t=s.getResponseHeader("Last-Modified"))h.lastModified[w]=
t;if(t=s.getResponseHeader("Etag"))h.etag[w]=t}if(a===304){l="notmodified";n=true}else try{t=e;t.dataFilter&&(u=t.dataFilter(u,t.dataType));var fa=t.dataTypes;v={};var z,D,F=fa.length,B,Z=fa[0],E,G,I,H,J;for(z=1;z<F;z++){if(z===1)for(D in t.converters)typeof D==="string"&&(v[D.toLowerCase()]=t.converters[D]);E=Z;Z=fa[z];if(Z==="*")Z=E;else if(E!=="*"&&E!==Z){G=E+" "+Z;I=v[G]||v["* "+Z];if(!I){J=c;for(H in v){B=H.split(" ");if(B[0]===E||B[0]==="*")if(J=v[B[1]+" "+Z]){H=v[H];H===true?I=J:J===true&&
(I=H);break}}}!I&&!J&&h.error("No conversion from "+G.replace(" "," to "));I!==true&&(u=I?I(u):J(H(u)))}}r=u;l="success";n=true}catch(L){l="parsererror";C=L}}else{C=l;if(!l||a){l="error";a<0&&(a=0)}}s.status=a;s.statusText=""+(b||l);n?g.resolveWith(f,[r,l,s]):g.rejectWith(f,[s,l,C]);s.statusCode(j);j=c;p&&k.trigger("ajax"+(n?"Success":"Error"),[s,e,n?r:C]);i.fireWith(f,[s,l]);if(p){k.trigger("ajaxComplete",[s,e]);--h.active||h.event.trigger("ajaxStop")}}}if(typeof a==="object"){b=a;a=c}var b=b||{},
e=h.ajaxSetup({},b),f=e.context||e,k=f!==e&&(f.nodeType||f instanceof h)?h(f):h.event,g=h.Deferred(),i=h.Callbacks("once memory"),j=e.statusCode||{},w,u={},l={},m,n,o,q,r,K=0,p,P,s={readyState:0,setRequestHeader:function(a,b){if(!K){var c=a.toLowerCase(),a=l[c]=l[c]||a;u[a]=b}return this},getAllResponseHeaders:function(){return K===2?m:null},getResponseHeader:function(a){var b;if(K===2){if(!n)for(n={};b=ob.exec(m);)n[b[1].toLowerCase()]=b[2];b=n[a.toLowerCase()]}return b===c?null:b},overrideMimeType:function(a){if(!K)e.mimeType=
a;return this},abort:function(a){a=a||"abort";o&&o.abort(a);d(0,a);return this}};g.promise(s);s.success=s.done;s.error=s.fail;s.complete=i.add;s.statusCode=function(a){if(a){var b;if(K<2)for(b in a)j[b]=[j[b],a[b]];else{b=a[s.status];s.then(b,b)}}return this};e.url=((a||e.url)+"").replace(nb,"").replace(rb,ka[1]+"//");e.dataTypes=h.trim(e.dataType||"*").toLowerCase().split(La);if(e.crossDomain==null){r=Qa.exec(e.url.toLowerCase());e.crossDomain=!(!r||!(r[1]!=ka[1]||r[2]!=ka[2]||(r[3]||(r[1]==="http:"?
80:443))!=(ka[3]||(ka[1]==="http:"?80:443))))}if(e.data&&e.processData&&typeof e.data!=="string")e.data=h.param(e.data,e.traditional);A(xa,e,b,s);if(K===2)return false;p=e.global;e.type=e.type.toUpperCase();e.hasContent=!qb.test(e.type);p&&h.active++===0&&h.event.trigger("ajaxStart");if(!e.hasContent){if(e.data){e.url=e.url+((Pa.test(e.url)?"&":"?")+e.data);delete e.data}w=e.url;if(e.cache===false){r=h.now();var T=e.url.replace(ub,"$1_="+r);e.url=T+(T===e.url?(Pa.test(e.url)?"&":"?")+"_="+r:"")}}(e.data&&
e.hasContent&&e.contentType!==false||b.contentType)&&s.setRequestHeader("Content-Type",e.contentType);if(e.ifModified){w=w||e.url;h.lastModified[w]&&s.setRequestHeader("If-Modified-Since",h.lastModified[w]);h.etag[w]&&s.setRequestHeader("If-None-Match",h.etag[w])}s.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+(e.dataTypes[0]!=="*"?", "+Ta+"; q=0.01":""):e.accepts["*"]);for(P in e.headers)s.setRequestHeader(P,e.headers[P]);if(e.beforeSend&&(e.beforeSend.call(f,
s,e)===false||K===2)){s.abort();return false}for(P in{success:1,error:1,complete:1})s[P](e[P]);if(o=A(Sa,e,b,s)){s.readyState=1;p&&k.trigger("ajaxSend",[s,e]);e.async&&e.timeout>0&&(q=setTimeout(function(){s.abort("timeout")},e.timeout));try{K=1;o.send(u,d)}catch(x){if(K<2)d(-1,x);else throw x;}}else d(-1,"No Transport");return s},param:function(a,b){var d=[],e=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(b===c)b=h.ajaxSettings.traditional;
if(h.isArray(a)||a.jquery&&!h.isPlainObject(a))h.each(a,function(){e(this.name,this.value)});else for(var f in a)y(f,a[f],b,e);return d.join("&").replace(mb,"+")}});h.extend({active:0,lastModified:{},etag:{}});var vb=h.now(),ta=/(\=)\?(&|$)|\?\?/i;h.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return h.expando+"_"+vb++}});h.ajaxPrefilter("json jsonp",function(b,c,d){c=typeof b.data==="string"&&/^application\/x\-www\-form\-urlencoded/.test(b.contentType);if(b.dataTypes[0]==="jsonp"||b.jsonp!==
...
k.overrideMimeType(b.mimeType);!b.crossDomain&&!e["X-Requested-With"]&&(e["X-Requested-With"]="XMLHttpRequest");try{for(i in e)k.setRequestHeader(i,e[i])}catch(j){}k.send(b.hasContent&&b.data||null);d=function(a,e){var i,j,w,u,l;try{if(d&&(e||k.readyState===4)){d=c;if(g){k.onreadystatechange=h.noop;Da&&delete oa[g]}if(e)k.readyState!==4&&k.abort();else{i=k.status;w=k.getAllResponseHeaders();u={};if((l=k.responseXML)&&l.documentElement)u.xml=l;try{u.text=k.responseText}catch(m){}try{j=k.statusText}catch(n){j=
""}!i&&b.isLocal&&!b.crossDomain?i=u.text?200:404:i===1223&&(i=204)}}}catch(o){e||f(-1,o)}u&&f(i,j,u,w)};if(!b.async||k.readyState===4)d();else{g=++wb;if(Da){if(!oa){oa={};h(a).unload(Da)}oa[g]=d}k.onreadystatechange=d}},abort:function(){d&&d(0,1)}}}});var ya={},ca,ma,xb=/^(?:toggle|show|hide)$/,yb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,ua,ra=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],qa;h.fn.extend({show:function(a,
...
" ",A=f(e.call(this)),x,y=j.attr("class")||"";a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});x=f(e.call(this));j.attr("class",y);j.animate(i(A,x),{queue:false,duration:c,easing:d,complete:function(){a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});if(typeof j.attr("style")=="object"){j.attr("style").cssText="";j.attr("style").cssText=o}else j.attr("style",o);g&&g.apply(this,arguments);a.dequeue(this)}})})};a.fn.extend({_addClass:a.fn.addClass,addClass:function(b,c,d,e){return c?a.effects.animateClass.apply(this,
...
e="string"!=typeof e?e:(new Date).getFullYear()%100+parseInt(e,10),g=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,f=(d?d.dayNames:null)||this._defaults.dayNames,i=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,r=(d?d.monthNames:null)||this._defaults.monthNames,p=d=-1,s=-1,A=-1,x=!1,y=function(a){(a=N+1<b.length&&b.charAt(N+1)==a)&&N++;return a},D=function(a){var b=y(a),a=c.substring(F).match(RegExp("^\\d{1,"+("@"==a?14:"!"==a?20:"y"==a&&b?4:"o"==a?3:2)+"}"));if(!a)throw"Missing number at position "+
F;F+=a[0].length;return parseInt(a[0],10)},z=function(b,d,e){var b=a.map(y(b)?e:d,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)}),g=-1;a.each(b,function(a,b){var d=b[1];if(c.substr(F,d.length).toLowerCase()==d.toLowerCase())return g=b[0],F+=d.length,!1});if(-1!=g)return g+1;throw"Unknown name at position "+F;},B=function(){if(c.charAt(F)!=b.charAt(N))throw"Unexpected literal at position "+F;F++},F=0,N=0;N<b.length;N++)if(x)"'"==b.charAt(N)&&!y("'")?x=!1:B();else switch(b.charAt(N)){case "d":s=
D("d");break;case "D":z("D",g,f);break;case "o":A=D("o");break;case "m":p=D("m");break;case "M":p=z("M",i,r);break;case "y":d=D("y");break;case "@":var E=new Date(D("@")),d=E.getFullYear(),p=E.getMonth()+1,s=E.getDate();break;case "!":E=new Date((D("!")-this._ticksTo1970)/1E4);d=E.getFullYear();p=E.getMonth()+1;s=E.getDate();break;case "'":y("'")?B():x=!0;break;default:B()}if(F<c.length)throw"Extra/unparsed characters found in date: "+c.substring(F);-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-
...
Math.floor(19.7)+Math.floor(4.925)),formatDate:function(a,c,d){if(!c)return"";var e=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,g=(d?d.dayNames:null)||this._defaults.dayNames,f=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,d=(d?d.monthNames:null)||this._defaults.monthNames,i=function(c){(c=x+1<a.length&&a.charAt(x+1)==c)&&x++;return c},r=function(a,b,c){b=""+b;if(i(a))for(;b.length<c;)b="0"+b;return b},p=function(a,b,c,d){return i(a)?d[b]:c[b]},s="",A=!1;if(c)for(var x=0;x<
a.length;x++)if(A)"'"==a.charAt(x)&&!i("'")?A=!1:s+=a.charAt(x);else switch(a.charAt(x)){case "d":s+=r("d",c.getDate(),2);break;case "D":s+=p("D",c.getDay(),e,g);break;case "o":s+=r("o",Math.round(((new Date(c.getFullYear(),c.getMonth(),c.getDate())).getTime()-(new Date(c.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":s+=r("m",c.getMonth()+1,2);break;case "M":s+=p("M",c.getMonth(),f,d);break;case "y":s+=i("y")?c.getFullYear():(10>c.getYear()%100?"0":"")+c.getYear()%100;break;case "@":s+=
c.getTime();break;case "!":s+=1E4*c.getTime()+this._ticksTo1970;break;case "'":i("'")?s+="'":A=!0;break;default:s+=a.charAt(x)}return s},_possibleChars:function(a){for(var c="",d=!1,e=function(c){(c=g+1<a.length&&a.charAt(g+1)==c)&&g++;return c},g=0;g<a.length;g++)if(d)"'"==a.charAt(g)&&!e("'")?d=!1:c+=a.charAt(g);else switch(a.charAt(g)){case "d":case "m":case "y":case "@":c+="0123456789";break;case "D":case "M":return null;case "'":e("'")?c+="'":d=!0;break;default:c+=a.charAt(g)}return c},_get:function(a,
...
f=this._get(b,"navigationAsDateFormat"),q=this._getNumberOfMonths(b),r=this._get(b,"showCurrentAtPos"),p=this._get(b,"stepMonths"),s=1!=q[0]||1!=q[1],A=this._daylightSavingAdjust(!b.currentDay?new Date(9999,9,9):new Date(b.currentYear,b.currentMonth,b.currentDay)),x=this._getMinMaxDate(b,"min"),y=this._getMinMaxDate(b,"max"),r=b.drawMonth-r,D=b.drawYear;0>r&&(r+=12,D--);if(y)for(var z=this._daylightSavingAdjust(new Date(y.getFullYear(),y.getMonth()-q[0]*q[1]+1,y.getDate())),z=x&&z<x?x:z;this._daylightSavingAdjust(new Date(D,
r,1))>z;)r--,0>r&&(r=11,D--);b.drawMonth=r;b.drawYear=D;var z=this._get(b,"prevText"),z=!f?z:this.formatDate(z,this._daylightSavingAdjust(new Date(D,r-p,1)),this._getFormatConfig(b)),z=this._canAdjustMonth(b,-1,D,r)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', -"+p+", 'M');\" title=\""+z+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+z+"</span></a>":g?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+
...
B)?'<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._gotoToday('#"+b.id+"');\">"+p+"</button>":"")+(d?"":f)+"</div>":"",f=parseInt(this._get(b,"firstDay"),10),f=isNaN(f)?0:f,p=this._get(b,"showWeek"),B=this._get(b,"dayNames");this._get(b,"dayNamesShort");var F=this._get(b,"dayNamesMin"),N=this._get(b,"monthNames"),E=this._get(b,"monthNamesShort"),v=this._get(b,"beforeShowDay"),S=this._get(b,"showOtherMonths"),
Q=this._get(b,"selectOtherMonths");this._get(b,"calculateWeek");for(var h=this._getDefaultDate(b),U="",I=0;I<q[0];I++){var V="";this.maxRows=4;for(var L=0;L<q[1];L++){var t=this._daylightSavingAdjust(new Date(D,r,b.selectedDay)),J=" ui-corner-all",G="";if(s){G+='<div class="ui-datepicker-group';if(1<q[1])switch(L){case 0:G+=" ui-datepicker-group-first";J=" ui-corner-"+(d?"right":"left");break;case q[1]-1:G+=" ui-datepicker-group-last";J=" ui-corner-"+(d?"left":"right");break;default:G+=" ui-datepicker-group-middle",
J=""}G+='">'}for(var G=G+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+J+'">'+(/all|left/.test(J)&&0==I?d?g:z:"")+(/all|right/.test(J)&&0==I?d?z:g:"")+this._generateMonthYearHeader(b,r,D,x,y,0<I||0<L,N,E)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),O=p?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":"",J=0;7>J;J++)var H=(J+f)%7,O=O+("<th"+(5<=(J+f+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+B[H]+'">'+F[H]+"</span></th>");
G+=O+"</tr></thead><tbody>";O=this._getDaysInMonth(D,r);D==b.selectedYear&&r==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,O));J=(this._getFirstDayOfMonth(D,r)-f+7)%7;O=Math.ceil((J+O)/7);this.maxRows=O=s?this.maxRows>O?this.maxRows:O:O;for(var H=this._daylightSavingAdjust(new Date(D,r,1-J)),W=0;W<O;W++){for(var G=G+"<tr>",$=!p?"":'<td class="ui-datepicker-week-col">'+this._get(b,"calculateWeek")(H)+"</td>",J=0;7>J;J++){var R=v?v.apply(b.input?b.input[0]:null,[H]):[!0,""],M=H.getMonth()!=
r,Y=M&&!Q||!R[0]||x&&H<x||y&&H>y,$=$+('<td class="'+(5<=(J+f+6)%7?" ui-datepicker-week-end":"")+(M?" ui-datepicker-other-month":"")+(H.getTime()==t.getTime()&&r==b.selectedMonth&&b._keyEvent||h.getTime()==H.getTime()&&h.getTime()==t.getTime()?" "+this._dayOverClass:"")+(Y?" "+this._unselectableClass+" ui-state-disabled":"")+(M&&!S?"":" "+R[1]+(H.getTime()==A.getTime()?" "+this._currentClass:"")+(H.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!M||S)&&R[2]?' title="'+R[2]+'"':"")+(Y?"":
' onclick="DP_jQuery_'+i+".datepicker._selectDay('#"+b.id+"',"+H.getMonth()+","+H.getFullYear()+', this);return false;"')+">"+(M&&!S?"&#xa0;":Y?'<span class="ui-state-default">'+H.getDate()+"</span>":'<a class="ui-state-default'+(H.getTime()==c.getTime()?" ui-state-highlight":"")+(H.getTime()==A.getTime()?" ui-state-active":"")+(M?" ui-priority-secondary":"")+'" href="#">'+H.getDate()+"</a>")+"</td>");H.setDate(H.getDate()+1);H=this._daylightSavingAdjust(H)}G+=$+"</tr>"}r++;11<r&&(r=0,D++);G+="</tbody></table>"+
(s?"</div>"+(0<q[0]&&L==q[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");V+=G}U+=V}U+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return U},_generateMonthYearHeader:function(a,c,d,e,g,f,q,r){var p=this._get(a,"changeMonth"),s=this._get(a,"changeYear"),A=this._get(a,"showMonthAfterYear"),x='<div class="ui-datepicker-title">',y="";if(f||!p)y+='<span class="ui-datepicker-month">'+
q[c]+"</span>";else{for(var q=e&&e.getFullYear()==d,D=g&&g.getFullYear()==d,y=y+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),z=0;12>z;z++)if((!q||z>=e.getMonth())&&(!D||z<=g.getMonth()))y+='<option value="'+z+'"'+(z==c?' selected="selected"':"")+">"+r[z]+"</option>";y+="</select>"}A||(x+=y+(f||!p||!s?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",f||!s)x+='<span class="ui-datepicker-year">'+d+"</span>";else{var r=this._get(a,
...
(function(a,c,d,e){function f(a,b,c){Y[a]=c;ha[a]=b;M||(M=a)}function i(b){M!==b&&(M=b,a.ui.editor.eachInstance(function(){this.reinit()}))}function g(a,b){M&&Y[M]&&Y[M][a]&&(a=Y[M][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function b(b){if(ba===e){ba=!0;if(da=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(b.options.baseClass+"-ios"),da&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height",
"-=1")},0)});a.browser.mozilla&&a("html").addClass(b.options.baseClass+"-ff");if(a.browser.msie&&9>a.browser.version){ba=!1;var c=a("<div/>").addClass(b.options.baseClass+"-unsupported").html(b.getTemplate("unsupported")).appendTo("body");j(c);c.find("."+b.options.baseClass+"-unsupported-close").click(function(){c.remove()})}pa=jQuery.hotkeys!==e}return ba}function j(b){var c=1;b.siblings().each(function(){var b=a(this).css("z-index");!isNaN(b)&&b>c&&(c=b+1)});b.css("z-index",c)}function l(a){return a.clone().wrap("<div/>").parent().html()}
function o(a){var b,a=document.createElement(a);b="getComputedStyle"in c;document.body.appendChild(a);b=(b?c.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return b}function n(b,c){return-1!==a.inArray(a(b)[0].tagName.toLowerCase(),c)}function m(a){for(var b={},a=c.getComputedStyle(a[0],null),d=0;d<a.length;d++)b[a.item(d)]=a.getPropertyValue(a.item(d));return b}function q(b,c){y();a(b).each(function(){var d=a("<"+c+"/>").html(a(this).html());b.html(d)});D()}function r(b,
...
function A(b){var b=b||d.getSelection(),c;a(b.getAllRanges()).each(function(b,d){c=3===this.commonAncestorContainer.nodeType?a(d.commonAncestorContainer).parent()[0]:d.commonAncestorContainer});return c}function x(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer}function y(a){if(!X||a)X=d.saveSelection()}function D(){X&&(d.restoreSelection(X),X=!1)}function z(){X&&d.removeMarkers(X);X=!1}function B(a,b,c){for(var b=b||d.getSelection(),e,f=0;e=b.getAllRanges()[f++];)a.call(c,
e)}function F(a,b){B(function(b){s(a,b)},b,this)}function N(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).focus().contents().each(function(){var a=d.createRange();a.selectNodeContents(this);c.addRange(a)})}function E(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNode(this);c.addRange(a)}).focus()}function v(b,c,e){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNodeContents(this);a.collapse(e);c.addRange(a)})}
function S(a,b){v(a,b,!1)}function Q(a,b){v(a,b,!0)}function h(a){a=a||d.getSelection();return a.toHtml()}function U(b){b=b||d.getSelection().getRangeAt(0);return a(3===b.commonAncestorContainer.nodeType?b.commonAncestorContainer.parentNode:b.commonAncestorContainer)}function I(a){var b=new jQuery;B(function(a){b.push(U(a)[0])},a,this);return b}function V(){var b=d.getSelection();if(null===b.anchorNode)return null;if(b.isBackwards())return 3===b.focusNode.nodeType?a(b.focusNode.parentElement):a(b.focusNode);
...
d.createRange();h.setStart(e.endContainer,e.endOffset);h.setEndAfter(f);e=h.cloneContents();g=l(a(p(g)));g+=l(a(b));g+=l(a(p(e)));a(f).replaceWith(a(g))}function O(a,b,c){var c=c||d.getSelection(),e=V()[0],f=L()[0],g=I()[0],g=n(g,b),e=n(e,b),b=n(f,b);g&&e&&b?F(a):G(a,c)}function H(b,c){B(function(d){for(d=a(d.commonAncestorContainer);d.length&&d[0]!==c[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===c[0]&&"inline"!==c.css("display")&&(q(c,"div"),d=c.children().first());r(d,
b)},null,this)}function W(b,c){b=a(b)[0];if(c=c||d.getSelection()){var e;a(c.getAllRanges()).each(function(d,f){e=3===this.commonAncestorContainer.nodeType?a(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;b!==e&&!a.contains(b,e)&&c.removeRange(f)})}else Q(b)}function $(a,b){allowed=[];for(var c=0;c<b.length;c++)b[c].match(/[a-z][a-z0-9]{0,}/g)&&allowed.push(b[c]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,
b){return-1<allowed.indexOf(b.toLowerCase())?a:""})}function R(a){return!isNaN(a-0)&&null!==a}var M=null,Y={},ha={};a(function(){d.initialized||d.init();a.isFunction(d.rangePrototype.insertNodeAtEnd)||(d.rangePrototype.insertNodeAtEnd=function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});a("html").click(function(){a(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});a.widget("ui.editor",{_init:function(){-1===a.inArray(this,
...
c=m(this.element),d=0;d<this.options.replaceStyle.length;d++)b.css(this.options.replaceStyle[d],c[this.options.replaceStyle[d]]);this.element.hide();this.bind("change",function(){this.getOriginalElement().is(":input")?this.getOriginalElement().val(this.getHtml()):this.getOriginalElement().html(this.getHtml())});this.target=b}},cloneDomTools:function(){for(var a in this.options.domTools)this[a]||(this[a]=function(a){return function(){W(this.getElement());var b=this.getHtml(),c=this.options.domTools[a].apply(this.options.domTools,
...
d.getSelection().removeAllRanges(),this.fire("disabled"))},isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var b=this,c="",d=[],e=0;B(function(f){var f=f.commonAncestorContainer,g;g=3===f.nodeType?a(f).parent():a(f);!b.isRoot(g)&&!a.contains(b.getElement().get(0),g.get(0))&&(g=b.getElement());f=[];for(d.push(f);g[0]&&!b.isRoot(g)&&"body"!==g[0].tagName.toLowerCase();)f.push(g),g=g.parent();f.reverse();c&&(c+=" | ");c+=this.getTemplate("root");for(g=0;g<f.length;g++)c+=
this.getTemplate("tag",{element:f[g][0].tagName.toLowerCase(),data:"["+e+","+g+"]"});e++},null,this);c||(c=this.getTemplate("root"));this.path.html(c).find("a").click(function(){var c=a(this).data("ui-editor-selection");c?(E(d[c[0]][c[1]]),b.updateTagTree()):E(b.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(b){return this.getElement()[0]===a(b)[0]},unify:function(b,c){!1!==c&&b(this);if(this.options.unify){var d=this;a.ui.editor.eachInstance(function(a){a!==d&&a.options.unify&&b(a)})}},
...
b,c){for(var d in c)a.css(d,b.css(d)),b.css(d,c[d])},fragmentToHtml:p,fragmentInsertBefore:function(b,c,d){for(var e=0,f=b.childNodes.length;e<f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?g.nodeValue:a(g).html())&&a("<"+d+"/>").html(a.trim(g)).insertBefore(c)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},rangeGetCommonAncestor:A,rangeIsEmpty:x,selectionSave:y,selectionRestore:D,selectionDestroy:z,selectionEachRange:B,selectionReplace:F,
selectionSelectInner:N,selectionSelectOuter:E,selectionSelectEdge:v,selectionSelectEnd:S,selectionSelectStart:Q,selectionGetHtml:h,selectionGetElements:I,selectionToggleWrapper:t,selectionExists:function(a){var b=!1;B(function(a){x(a)||(b=!0)},a,this);return b},selectionReplaceSplittingSelectedElement:G,selectionReplaceWithinValidTags:O,selectionToggleBlockStyle:H,stringStripTags:$,typeIsNumber:R,defaults:{plugins:{},ui:{},bind:{},domTools:{unwrapParentTag:function(b){I().each(function(){a(this).is(b)&&
...
this.ui.enable()}}});a.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:g("Insert Horizontal Rule"),click:function(){F("<hr/>")}})}}});a.ui.editor.registerUi({i18n:{init:function(b){var c=this,d=a('<select autocomplete="off" name="i18n"/>'),e;for(e in Y){var f=a('<option value="'+e+'" class="'+e+'"/>');f.html(ha[e]);M===e&&f.attr("selected","selected");d.append(f)}return b.uiSelectMenu({title:g("Change Language"),select:d,change:function(a){i(c.persist("locale",a))}})}}});f("de",
...
manuallyResizeImage:function(b){this.removeToolsButtons();var c=this.editor.getElement().find("img."+this.options.manuallyResizingClass),d=a(c).innerWidth(),e=a(c).innerHeight(),f="#"+this.options.baseClass+"-width",h="#"+this.options.baseClass+"-height",i=this,j=function(b){b=Math.round(b||a(f).val())+"px";a(c).css({width:b})},l=a(this.editor.getTemplate("imageresize.manually-resize-image",{width:d,height:e,baseClass:this.options.baseClass}));l.dialog({modal:!0,resizable:!1,title:g("Modify Image Size"),
autoOpen:!0,buttons:[{text:g("Resize Image"),click:function(){j(a(this).find(f).val());a(this).dialog("close")}},{text:g("Cancel"),click:function(){j(d);a(this).dialog("close")}}],close:function(){i.editor.checkChange();a(l).remove()},open:function(){var b=a(this).find(f),c=a(this).find(h);b.keyup(function(){c.val(Math.round(Math.abs(e/d*a(this).val())));j()});c.keyup(function(){b.val(Math.round(Math.abs(d/e*a(this).val())));j()})}});b.preventDefault();return!1},displayToolsButtonRelativeToImage:function(b){var c=
a("<button>"+g("Click to edit the image")+"</button>").appendTo("body").addClass(this.options.resizeButtonClass).button({text:!1,icons:{primary:"ui-icon-tools"}});c.css({position:"absolute",left:a(b).position().left+a(b).innerWidth()-a(c).outerWidth()-10+"px",top:a(b).position().top+10+"px"}).attr("contenteditable",!1).click(a.proxy(this.manuallyResizeImage,this));c.addClass(this.editor.options.supplementaryClass).find("span").addClass(this.editor.options.supplementaryClass);a(b).before(c)},removeToolsButtons:function(){this.editor.getElement().find("."+
this.options.resizeButtonClass).each(function(){a(this).remove()})},imageMouseEnter:function(b){a(b.target).addClass(this.options.manuallyResizingClass);this.displayToolsButtonRelativeToImage(b.target)},imageMouseLeave:function(b){a(b.relatedTarget).hasClass(this.options.resizeButtonClass)||(a(b.target).removeClass(this.options.manuallyResizingClass),this.removeToolsButtons())}});a.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:function(){return g("Page on this or another website")},
...
this.plugin.editor.showWarning(g("The url for the file you inserted doesn't look well formed"));return b},validate:function(b){var c="."+this.options.baseClass+"-error-message-file-url",d=!0;this.options.regexLink.test(b.find('input[name="location"]').val())?b.find(c).has(":visible").hide():(b.find(c).size()||b.find('input[name="location"]').after(this.plugin.editor.getTemplate("link.error",a.extend({},this.options,{messageClass:this.options.baseClass+"-error-message-file-url",message:g("The URL does not look well formed")}))),
...
c=null,c=this.options.replaceTypes?this.options.customTypes:a.merge(this.defaultLinkTypes,this.options.customTypes),d,e=0;e<c.length;e++)d=a.extend({},b,c[e],{classes:this.options.baseClass+"-"+c[e].type}).init(),this.types[d.type]=d},show:function(){if(!this.visible){y();this.selectedElement=I().first();var b=this.selectedElement.is("a"),c=this.options,d=this,e=this.dialog=a(this.editor.getTemplate("link.dialog",c)).appendTo("body");this.initTypes();var f=this.dialog.find("fieldset"),h;for(h in this.types){var i=
a.extend({},this.types[h],{title:this.types[h].title()});a(this.editor.getTemplate("link.label",i)).appendTo(f)}f.find('input[type="radio"]').bind("change."+this.editor.widgetName,function(){d.typeChange(d.types[a(this).val()],b)});e.dialog({autoOpen:!1,modal:!0,resizable:!0,width:c.dialogWidth,minWidth:c.dialogMinWidth,height:c.dialogHeight,title:b?g("Edit Link"):g("Insert Link"),dialogClass:c.baseClass+" "+c.dialogClass,buttons:[{text:b?g("Update Link"):g("Insert Link"),click:function(){D();d.apply(b)&&
a(this).dialog("close")}},{text:g("Cancel"),click:function(){a(this).dialog("close")}}],beforeopen:function(){d.dialog.find("."+d.options.baseClass+"-content").hide()},open:function(){d.visible=!0;var c=e.parent().find(".ui-dialog-buttonpane");c.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});c.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}});var f=e.find('.ui-editor-link-menu input[type="radio"]');f.first().attr("checked","checked");var g=!1;if(b)for(var h in d.types)if(g=
d.types[h].editing(d.selectedElement)){f.filter('[value="'+h+'"]').attr("checked","checked");d.typeChange(d.types[h],b);break}(!b||b&&!g)&&d.typeChange(d.types[f.filter(":checked").val()],b);a(this).unbind("keyup."+d.editor.widgetName).bind("keyup."+d.editor.widgetName,function(b){13==b.keyCode&&(b=d.types[f.filter(":checked").val()],(!a.isFunction(b.validate)||b.validate(d.dialog.find("."+d.options.baseClass+"-content")))&&c.find("button:eq(0)").trigger("click"))})},close:function(){D();d.visible=
!1;e.find("."+c.baseClass+"-content").hide();a(this).dialog("destroy")}}).dialog("open")}},apply:function(b){var c=this.types[this.dialog.find('input[type="radio"]:checked').val()],d=c.attributes(this.dialog.find("."+this.options.baseClass+"-content"),b);if(!d)return!0;D();var e=l(a("<a>"+(d.title?d.title:d.href)+"</a>").attr(a.extend({},d,{target:"_blank"})));b?(this.selectedElement[0].className=this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(c.classes).attr(d),
this.editor.showConfirm(g("Updated link: {{link}}",{link:e}))):(J("a",a.extend(d,{id:this.editor.getUniqueId()}),c.classes),this.editor.showConfirm(g("Added link: {{link}}",{link:e})),this.selectedElement=a("#"+d.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",d.href);E(this.selectedElement);y();return!0},typeChange:function(b,c){var d=this.dialog.find("."+this.options.baseClass+"-content"),e=d.closest("."+this.options.baseClass+"-wrap"),f=b.ajaxUri&&!this.types[b.type].content;
...
g);O(e,this.options.enterValidTags);e=a("#"+g).removeAttr("id");b?c?Q(e.next()):f?Q(e):(Q(e.next()),(b=e.prev())&&""!==a.trim(b.html())&&l(b)!==this.options.enter&&e.remove()):(Q(e.next()),e.remove())},restoreSelection:!1},"return+shift":{action:function(){z();var b=this.options.baseClass+"-enter-break",c=a(this.shiftEnter).attr("id",b).appendTo("body");this.options.shiftEnterValidTags?O(this.options.shiftEnter,this.options.shiftEnterValidTags):F(c);b=a("#"+b).removeAttr("id").next();Q(b)},restoreSelection:!1}}});
...
a(".uiWidgetEditorPasteBin").focus();c.setTimeout(function(){var c=a(".uiWidgetEditorPasteBin").html(),c=h.filterAttributes(c),c=h.filterChars(c),c=h.stripEmpty(c),c=h.stripAttributes(c),c=$(c,h.options.allowedTags),c={plain:a("<div/>").html(a(".uiWidgetEditorPasteBin").html()).text(),markup:c,html:a(".uiWidgetEditorPasteBin").html()};f=a(b.getTemplate("paste.dialog",c));a(f).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:d.dialogShowAnimation,hide:d.dialogHideAnimation,
dialogClass:d.baseClass+" "+d.dialogClass,buttons:[{text:g("Insert"),click:function(){var c=null,c=a(this).find(".ui-editor-paste-area:visible"),c=c.hasClass("ui-editor-paste-plain")||c.hasClass("ui-editor-paste-source")?c.val():c.html(),c=h.filterAttributes(c),c=h.filterChars(c);D();F(c);b.checkChange();e=!1;a(this).dialog("close")}},{text:g("Cancel"),click:function(){D();e=!1;a(this).dialog("close")}}],open:function(){var b=a(this).find(".ui-editor-paste-panel-tabs");b.find("ul.ui-tabs-nav li").click(function(){b.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
...
e,b,d):a(e).appendTo(f);c.disableEditing();c.enableEditing()}}});a.ui.editor.registerUi({statistics:{options:{maximum:null,showCountInButton:!0,characterLimitTitle:g("Remaining characters before the recommended character limit is reached. Click to view statistics"),characterCountTitle:g("Click to view statistics")},init:function(b){b.bind("show",a.proxy(this.updateCount,this));b.bind("change",a.proxy(this.updateCount,this));return this.editor.uiButton({title:R(this.options.maximum)?this.options.characterLimitTitle:
this.options.characterCountTitle,label:g("Initializing"),text:!0,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var b=null,c=null,c=a("<div/>").html(this.editor.getCleanHtml()).text().length;R(this.options.maximum)?(b=this.options.maximum-c,c=0<=b?g("{{charactersRemaining}} characters remaining",{charactersRemaining:b}):g("{{charactersRemaining}} characters over limit",{charactersRemaining:-1*b})):c=g("{{characters}} characters",{characters:c});var d=this.ui.button;
!1===this.options.showCountInButton&&d.button("option","text",!1);d.button("option","label",c);d.button("option","text",!0);R(this.options.maximum)&&(0>b?d.addClass("ui-state-error").removeClass("ui-state-default"):0<=b&&15>=b?d.addClass("ui-state-highlight").removeClass("ui-state-error ui-state-default"):d.removeClass("ui-state-highlight ui-state-error").addClass("ui-state-default"))},showStatistics:function(){this.processTemplate().dialog({modal:!0,resizable:!1,title:g("Content Statistics"),dialogClass:this.editor.options.dialogClass+
" "+this.editor.options.baseClass,show:this.editor.options.dialogShowAnimation,hide:this.editor.options.dialogHideAnimation,buttons:[{text:g("OK"),click:function(){a(this).dialog("close")}}],open:function(){a(this).parent().find(".ui-dialog-buttonpane").find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}})},close:function(){a(this).dialog("destroy").remove()}})},processTemplate:function(){var b=a("<div/>").html(this.editor.getCleanHtml()).text(),c=null,d=this.options.maximum?this.options.maximum-
b.length:"&infin;",c=R(d)?g("Content contains more than {{limit}} characters and may be truncated",{limit:this.options.maximum}):g("Content will not be truncated"),e=null,e=b.split(" ").length,e=1==e?g("{{words}} word",{words:e}):g("{{words}} words",{words:e}),f=null,f=b.split(". ").length,f=g("{{sentences}} sentences",{sentences:f}),h=null,h=0<=d||!R(d)?g("{{characters}} characters, {{charactersRemaining}} remaining",{characters:b.length,charactersRemaining:d}):g("{{characters}} characters, {{charactersRemaining}} over the recommended limit",
...
change:function(c){if(!("undefined"===typeof c||"na"===c)){var d=b.getElement()[0],e=I();if(!h()||""===h()){if(a(e)[0]===a(d)[0])return;y();d=a("<"+c+">").html(e.html());e.replaceWith(d);D()}else{var e=a(I()[0]).parent(),f=this.options.baseClass+"-selection",c=a("<"+c+">").html(h()).addClass(f);e===d||I()[0]===d?F(c):O(c,this.validParents);N(b.getElement().find("."+f).removeClass(f))}b.checkChange()}}})},change:function(){var b=I()[0];b?(b=b.tagName.toLowerCase(),this.ui.select.find("option[value="+
...
a(d).button("option","disabled",!1);b.editor.checkChange()}})}}});var X=!1})(jQuery,window,rangy);
