...
c)&&this.getElement().bind("keydown."+this.widgetName,a,function(a){p();var c=b.hotkeys[a.data];!0!==c.action.call(c.context)&&a.preventDefault();c.restoreSelection&&z();b.checkChange()})}},uiEnabled:function(b){return!1===this.options.enableUi&&"undefined"===typeof this.options.ui[b]||!1===this.options.ui[b]||-1!==a.inArray(b,this.options.disabledUi)?!1:!0},getUi:function(a){return this.uiObjects[a]},loadUi:function(){for(var b=0,c=this.options.uiOrder.length;b<c;b++){for(var d=this.options.uiOrder[b],
...
dialog:null,types:{},defaultLinkTypes:[{type:"external",title:f("Page on this or another website"),focusSelector:'input[name="location"]',init:function(){this.content=this.plugin.editor.getTemplate("link.external",this.options);return this},show:function(a,b){var c=this;a.find('input[name="location"]').bind("keyup",function(){c.validate(a)});b&&(a.find('input[name="location"]').val(this.plugin.selectedElement.attr("href")).trigger("keyup"),"_blank"===this.plugin.selectedElement.attr("target")&&a.find('input[name="blank"]').attr("checked",
"checked"));return this},attributes:function(a){var b={href:a.find('input[name="location"]').val()};a.find('input[name="blank"]').is(":checked")&&(b.target="_blank");this.options.regexLink.test(b.href)||this.plugin.editor.showWarning(f("The url for the link you inserted doesn't look well formed"));return b},validate:function(b){var c="."+this.options.baseClass+"-error-message-url",d=!0;this.options.regexLink.test(b.find('input[name="location"]').val())?b.find(c).has(":visible").hide():(b.find(c).size()||
...
change:function(c){if(!("undefined"===typeof c||"na"===c)){var d=b.getElement()[0],e=G();if(!w()||""===w()){if(a(e)[0]===a(d)[0])return;p();d=a("<"+c+">").html(e.html());e.replaceWith(d);z()}else{var e=a(G()[0]).parent(),f=this.options.baseClass+"-selection",c=a("<"+c+">").html(w()).addClass(f);e===d||G()[0]===d?D(c):t(c,this.validParents);A(b.getElement().find("."+f).removeClass(f))}b.checkChange()}}})},change:function(){var b=G()[0];b?(b=b.tagName.toLowerCase(),this.ui.select.find("option[value="+
