...
(b=document.createRange(),q(b,n)&&z(b,m)&&(d=!0),b.detach());if((b=c(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(b,"createTextRange"))b=b.createTextRange(),g(b)&&(e=!0);!d&&!e&&i("Neither Range nor TextRange are implemented");x.initialized=!0;x.features={implementsDomRange:d,implementsTextRange:e};d=E.concat(y);e=0;for(b=d.length;e<b;++e)try{d[e](x)}catch(j){c(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
j)}}}function b(a){this.name=a;this.supported=this.initialized=!1}var j="object",l="function",o="undefined",m="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer,START_TO_START,START_TO_END,END_TO_START,END_TO_END".split(","),n="setStart,setStartBefore,setStartAfter,setEnd,setEndBefore,setEndAfter,collapse,selectNode,selectNodeContents,compareBoundaryPoints,deleteContents,extractContents,cloneContents,insertNode,surroundContents,cloneRange,toString,detach".split(","),
...
null}};o.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+j(this.node)+":"+this.offset+")]"}};m.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};m.prototype.toString=function(){return this.message};a.dom={arrayContains:q,isHtmlNamespace:function(a){var b;return typeof a.namespaceURI==n||null===(b=a.namespaceURI)||"http://www.w3.org/1999/xhtml"==
...
for(b=b.firstChild;b;){if(b===a)return-1;if(b===c)return 1;b=b.nextSibling}throw Error("Should not be here!");},inspectNode:j,fragmentFromNodeChildren:function(a){for(var c=b(a).createDocumentFragment(),d;d=a.firstChild;)c.appendChild(d);return c},createIterator:function(a){return new l(a)},DomPosition:o};a.DOMException=m});
rangy.createModule("DomRange",function(a){function c(a,b){return 3!=a.nodeType&&(u.isAncestorOf(a,b.startContainer,!0)||u.isAncestorOf(a,b.endContainer,!0))}function d(a){return u.getDocument(a.startContainer)}function e(a,b,c){if(b=a._listeners[b])for(var d=0,k=b.length;d<k;++d)b[d].call(a,{target:a,args:c})}function g(a){return new H(a.parentNode,u.getNodeIndex(a))}function i(a){return new H(a.parentNode,u.getNodeIndex(a)+1)}function f(a,b,c){var d=11==a.nodeType?a.firstChild:a;u.isCharacterDataNode(b)?
c==b.length?u.insertAfter(a,b):b.parentNode.insertBefore(a,0==c?b:u.splitDataNode(b,c)):c>=b.childNodes.length?b.appendChild(a):b.insertBefore(a,b.childNodes[c]);return d}function b(a){for(var c,k,h=d(a.range).createDocumentFragment();k=a.next();){c=a.isPartiallySelectedSubtree();k=k.cloneNode(!c);c&&(c=a.getSubtreeIterator(),k.appendChild(b(c)),c.detach(!0));if(10==k.nodeType)throw new F("HIERARCHY_REQUEST_ERR");h.appendChild(k)}return h}function j(a,b,c){for(var d,k,c=c||{stop:!1};d=a.next();)if(a.isPartiallySelectedSubtree())if(!1===
b(d)){c.stop=!0;break}else{if(d=a.getSubtreeIterator(),j(d,b,c),d.detach(!0),c.stop)break}else for(d=u.createIterator(d);k=d.next();)if(!1===b(k)){c.stop=!0;return}}function l(a){for(var b;a.next();)a.isPartiallySelectedSubtree()?(b=a.getSubtreeIterator(),l(b),b.detach(!0)):a.remove()}function o(a){for(var b,c=d(a.range).createDocumentFragment(),k;b=a.next();){a.isPartiallySelectedSubtree()?(b=b.cloneNode(!1),k=a.getSubtreeIterator(),b.appendChild(o(k)),k.detach(!0)):a.remove();if(10==b.nodeType)throw new F("HIERARCHY_REQUEST_ERR");
c.appendChild(b)}return c}function m(a,b,c){var d=!(!b||!b.length),k,h=!!c;d&&(k=RegExp("^("+b.join("|")+")$"));var g=[];j(new r(a,!1),function(a){(!d||k.test(a.nodeType))&&(!h||c(a))&&g.push(a)});return g}function n(a){return"["+("undefined"==typeof a.getName?"Range":a.getName())+"("+u.inspectNode(a.startContainer)+":"+a.startOffset+", "+u.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function r(a,b){this.range=a;this.clonePartiallySelectedTextNodes=b;if(!a.collapsed){this.sc=a.startContainer;
...
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function q(a,b,c){this.nodes=m(a,b,c);this._next=this.nodes[0];this._position=0}function p(a){return function(b,c){for(var d,k=c?b:b.parentNode;k;){d=k.nodeType;if(u.arrayContains(a,d))return k;k=k.parentNode}return null}}function z(a,b){if(t(a,b))throw new s("INVALID_NODE_TYPE_ERR");}function x(a){if(!a.startContainer)throw new F("INVALID_STATE_ERR");}function y(a,b){if(!u.arrayContains(b,a.nodeType))throw new s("INVALID_NODE_TYPE_ERR");
}function E(a,b){if(0>b||b>(u.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new F("INDEX_SIZE_ERR");}function A(a,b){if(k(a,!0)!==k(b,!0))throw new F("WRONG_DOCUMENT_ERR");}function D(a){if(v(a,!0))throw new F("NO_MODIFICATION_ALLOWED_ERR");}function G(a,b){if(!a)throw new F(b);}function O(a){return!!a.startContainer&&!!a.endContainer&&!(!u.arrayContains(J,a.startContainer.nodeType)&&!k(a.startContainer,!0))&&!(!u.arrayContains(J,a.endContainer.nodeType)&&!k(a.endContainer,!0))&&a.startOffset<=
(u.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(u.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function C(a){x(a);if(!O(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function w(){}function S(a){a.START_TO_START=V;a.START_TO_END=ia;a.END_TO_END=ua;a.END_TO_START=la;a.NODE_BEFORE=ja;a.NODE_AFTER=ma;a.NODE_BEFORE_AND_AFTER=na;a.NODE_INSIDE=
ka}function I(a){S(a);S(a.prototype)}function h(a,b){return function(){C(this);var c=this.startContainer,d=this.startOffset,k=this.commonAncestorContainer,h=new r(this,!0);c!==k&&(c=u.getClosestAncestorIn(c,k,!0),d=i(c),c=d.node,d=d.offset);j(h,D);h.reset();k=a(h);h.detach();b(this,c,d,c,d);return k}}function T(b,d,k){function e(a,b){return function(c){x(this);y(c,M);y(Q(c),J);c=(a?g:i)(c);(b?j:f)(this,c.node,c.offset)}}function j(a,b,c){var k=a.endContainer,h=a.endOffset;if(b!==a.startContainer||
c!==a.startOffset){if(Q(b)!=Q(k)||1==u.comparePoints(b,c,k,h))k=b,h=c;d(a,b,c,k,h)}}function f(a,b,c){var k=a.startContainer,h=a.startOffset;if(b!==a.endContainer||c!==a.endOffset){if(Q(b)!=Q(k)||-1==u.comparePoints(b,c,k,h))k=b,h=c;d(a,k,h,b,c)}}b.prototype=new w;a.util.extend(b.prototype,{setStart:function(a,b){x(this);z(a,!0);E(a,b);j(this,a,b)},setEnd:function(a,b){x(this);z(a,!0);E(a,b);f(this,a,b)},setStartBefore:e(!0,!0),setStartAfter:e(!1,!0),setEndBefore:e(!0,!1),setEndAfter:e(!1,!1),collapse:function(a){C(this);
a?d(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):d(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){x(this);z(a,!0);d(this,a,0,a,u.getNodeLength(a))},selectNode:function(a){x(this);z(a,!1);y(a,M);var b=g(a),a=i(a);d(this,b.node,b.offset,a.node,a.offset)},extractContents:h(o,d),deleteContents:h(l,d),canSurroundContents:function(){C(this);D(this.startContainer);D(this.endContainer);var a=new r(this,!0),b=a._first&&
c(a._first,this)||a._last&&c(a._last,this);a.detach();return!b},detach:function(){k(this)},splitBoundaries:function(){C(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,k=this.endOffset,h=a===c;u.isCharacterDataNode(c)&&0<k&&k<c.length&&u.splitDataNode(c,k);u.isCharacterDataNode(a)&&0<b&&b<a.length&&(a=u.splitDataNode(a,b),h?(k-=b,c=a):c==a.parentNode&&k>=u.getNodeIndex(a)&&k++,b=0);d(this,a,b,c,k)},normalizeBoundaries:function(){C(this);var a=this.startContainer,b=this.startOffset,
c=this.endContainer,k=this.endOffset,h=function(a){var b=a.nextSibling;b&&b.nodeType==a.nodeType&&(c=a,k=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},g=function(d){var h=d.previousSibling;if(h&&h.nodeType==d.nodeType){a=d;var g=d.length;b=h.length;d.insertData(0,h.data);h.parentNode.removeChild(h);a==c?(k+=b,c=a):c==d.parentNode&&(h=u.getNodeIndex(d),k==h?(c=d,k=g):k>h&&k--)}},e=!0;u.isCharacterDataNode(c)?c.length==k&&h(c):(0<k&&(e=c.childNodes[k-1])&&u.isCharacterDataNode(e)&&h(e),
e=!this.collapsed);e?u.isCharacterDataNode(a)?0==b&&g(a):b<a.childNodes.length&&(h=a.childNodes[b])&&u.isCharacterDataNode(h)&&g(h):(a=c,b=k);d(this,a,b,c,k)},collapseToPoint:function(a,b){x(this);z(a,!0);E(a,b);(a!==this.startContainer||b!==this.startOffset||a!==this.endContainer||b!==this.endOffset)&&d(this,a,b,a,b)}});I(b)}function N(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:u.getCommonAncestor(a.startContainer,
a.endContainer)}function W(a,b,c,d,k){var h=a.startContainer!==b||a.startOffset!==c,g=a.endContainer!==d||a.endOffset!==k;a.startContainer=b;a.startOffset=c;a.endContainer=d;a.endOffset=k;N(a);e(a,"boundarychange",{startMoved:h,endMoved:g})}function L(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};N(this)}a.requireModules(["DomUtil"]);var u=a.dom,H=u.DomPosition,F=a.DOMException;r.prototype={_current:null,_next:null,_first:null,
...
(a===this.sc||a===this.ec)?(b=a===this.sc?this.so:0,c=a===this.ec?this.eo:a.length,b!=c&&a.deleteData(b,c-b)):a.parentNode&&a.parentNode.removeChild(a)},isPartiallySelectedSubtree:function(){return c(this._current,this.range)},getSubtreeIterator:function(){var a;if(this.isSingleCharacterDataNode)a=this.range.cloneRange(),a.collapse();else{a=new L(d(this.range));var b=this._current,c=b,k=0,h=b,g=u.getNodeLength(b);u.isAncestorOf(b,this.sc,!0)&&(c=this.sc,k=this.so);u.isAncestorOf(b,this.ec,!0)&&(h=
this.ec,g=this.eo);W(a,c,k,h,g)}return new r(a,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};s.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};s.prototype.toString=function(){return this.message};q.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
detach:function(){this._current=this._next=this.nodes=null}};var M=[1,3,4,5,7,8,10],J=[2,9,11],U=[1,3,4,5,7,8,10,11],Y=[1,3,4,5,7,8],Q=u.getRootContainer,k=p([9,11]),v=p([5,6,10,12]),t=p([6,10,12]),K=document.createElement("style"),P=!1;try{K.innerHTML="<b>x</b>",P=3==K.firstChild.nodeType}catch(R){}a.features.htmlParsingConforms=P;var $="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),V=0,ia=1,ua=2,la=3,ja=0,ma=1,na=2,ka=3;w.prototype={attachListener:function(a,
b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){C(this);A(this.startContainer,b.startContainer);var c=a==la||a==V?"start":"end",d=a==ia||a==V?"start":"end";return u.comparePoints(this[c+"Container"],this[c+"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){C(this);y(a,U);D(this.startContainer);if(u.isAncestorOf(a,this.startContainer,!0))throw new F("HIERARCHY_REQUEST_ERR");this.setStartBefore(f(a,this.startContainer,this.startOffset))},cloneContents:function(){C(this);
var a,c;if(this.collapsed)return d(this).createDocumentFragment();if(this.startContainer===this.endContainer&&u.isCharacterDataNode(this.startContainer))return a=this.startContainer.cloneNode(!0),a.data=a.data.slice(this.startOffset,this.endOffset),c=d(this).createDocumentFragment(),c.appendChild(a),c;c=new r(this,!0);a=b(c);c.detach();return a},canSurroundContents:function(){C(this);D(this.startContainer);D(this.endContainer);var a=new r(this,!0),b=a._first&&c(a._first,this)||a._last&&c(a._last,
this);a.detach();return!b},surroundContents:function(a){y(a,Y);if(!this.canSurroundContents())throw new s("BAD_BOUNDARYPOINTS_ERR");var b=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);f(a,this.startContainer,this.startOffset);a.appendChild(b);this.selectNode(a)},cloneRange:function(){C(this);for(var a=new L(d(this)),b=$.length,c;b--;)c=$[b],a[c]=this[c];return a},toString:function(){C(this);var a=this.startContainer;if(a===this.endContainer&&u.isCharacterDataNode(a))return 3==
a.nodeType||4==a.nodeType?a.data.slice(this.startOffset,this.endOffset):"";var b=[],a=new r(this,!0);j(a,function(a){(3==a.nodeType||4==a.nodeType)&&b.push(a.data)});a.detach();return b.join("")},compareNode:function(a){C(this);var b=a.parentNode,c=u.getNodeIndex(a);if(!b)throw new F("NOT_FOUND_ERR");a=this.comparePoint(b,c);b=this.comparePoint(b,c+1);return 0>a?0<b?na:ja:0<b?ma:ka},comparePoint:function(a,b){C(this);G(a,"HIERARCHY_REQUEST_ERR");A(a,this.startContainer);return 0>u.comparePoints(a,
b,this.startContainer,this.startOffset)?-1:0<u.comparePoints(a,b,this.endContainer,this.endOffset)?1:0},createContextualFragment:P?function(a){var b=this.startContainer,c=u.getDocument(b);if(!b)throw new F("INVALID_STATE_ERR");var d=null;1==b.nodeType?d=b:u.isCharacterDataNode(b)&&(d=u.parentElement(b));d=null===d||"HTML"==d.nodeName&&u.isHtmlNamespace(u.getDocument(d).documentElement)&&u.isHtmlNamespace(d)?c.createElement("body"):d.cloneNode(!1);d.innerHTML=a;return u.fragmentFromNodeChildren(d)}:
function(a){x(this);var b=d(this).createElement("body");b.innerHTML=a;return u.fragmentFromNodeChildren(b)},toHtml:function(){C(this);var a=d(this).createElement("div");a.appendChild(this.cloneContents());return a.innerHTML},intersectsNode:function(a,b){C(this);G(a,"NOT_FOUND_ERR");if(u.getDocument(a)!==d(this))return!1;var c=a.parentNode,k=u.getNodeIndex(a);G(c,"NOT_FOUND_ERR");var h=u.comparePoints(c,k,this.endContainer,this.endOffset),c=u.comparePoints(c,k+1,this.startContainer,this.startOffset);
return b?0>=h&&0<=c:0>h&&0<c},isPointInRange:function(a,b){C(this);G(a,"HIERARCHY_REQUEST_ERR");A(a,this.startContainer);return 0<=u.comparePoints(a,b,this.startContainer,this.startOffset)&&0>=u.comparePoints(a,b,this.endContainer,this.endOffset)},intersectsRange:function(a,b){C(this);if(d(a)!=d(this))throw new F("WRONG_DOCUMENT_ERR");var c=u.comparePoints(this.startContainer,this.startOffset,a.endContainer,a.endOffset),k=u.comparePoints(this.endContainer,this.endOffset,a.startContainer,a.startOffset);
...
this.startContainer,this.startOffset)&&b.setStart(a.startContainer,a.startOffset);1==u.comparePoints(a.endContainer,a.endOffset,this.endContainer,this.endOffset)&&b.setEnd(a.endContainer,a.endOffset);return b}throw new s("Ranges do not intersect");},containsNode:function(a,b){return b?this.intersectsNode(a,!1):this.compareNode(a)==ka},containsNodeContents:function(a){return 0<=this.comparePoint(a,0)&&0>=this.comparePoint(a,u.getNodeLength(a))},containsRange:function(a){return this.intersection(a).equals(a)},
containsNodeText:function(a){var b=this.cloneRange();b.selectNode(a);var c=b.getNodes([3]);return 0<c.length?(b.setStart(c[0],0),a=c.pop(),b.setEnd(a,a.length),a=this.containsRange(b),b.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){C(this);return new q(this,a,b)},getNodes:function(a,b){C(this);return m(this,a,b)},getDocument:function(){return d(this)},collapseBefore:function(a){x(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){x(this);this.setStartAfter(a);
this.collapse(!0)},getName:function(){return"DomRange"},equals:function(a){return L.rangesEqual(this,a)},isValid:function(){return O(this)},inspect:function(){return n(this)}};T(L,W,function(a){x(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;e(a,"detach",null);a._listeners=null});a.rangePrototype=w.prototype;L.rangeProperties=$;L.RangeIterator=r;L.copyComparisonConstants=I;L.createPrototypeRange=T;L.inspect=n;L.getRangeDocument=d;L.rangesEqual=
...
!1;break a}c=!0}if(!c)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function j(a,b){var c=new x(b);a._ranges=[c];g(a,c,!1);a.rangeCount=1;a.isCollapsed=c.collapsed}function l(b){b._ranges.length=0;if("None"==b.docSelection.type)i(b);else{var c=b.docSelection.createRange();if(c&&"undefined"!=typeof c.text)j(b,c);else{b.rangeCount=c.length;for(var d,h=q.getDocument(c.item(0)),e=0;e<b.rangeCount;++e)d=a.createRange(h),d.selectNode(c.item(e)),
b._ranges.push(d);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;g(b,b._ranges[b.rangeCount-1],!1)}}}function o(a,c){for(var d=a.docSelection.createRange(),h=b(c),g=q.getDocument(d.item(0)),g=q.getBody(g).createControlRange(),e=0,f=d.length;e<f;++e)g.add(d.item(e));try{g.add(h)}catch(i){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}g.select();l(a)}function m(a,b,c){this.nativeSelection=a;this.docSelection=b;this._ranges=
[];this.win=c;this.refresh()}function n(a,c){for(var d=q.getDocument(c[0].startContainer),d=q.getBody(d).createControlRange(),h=0,g;h<rangeCount;++h){g=b(c[h]);try{d.add(g)}catch(e){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();l(a)}function r(a,b){if(a.anchorNode&&q.getDocument(a.anchorNode)!==q.getDocument(b))throw new y("WRONG_DOCUMENT_ERR");}function s(a){var b=[],c=new E(a.anchorNode,a.anchorOffset),
d=new E(a.focusNode,a.focusOffset),h="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var g=0,e=a.rangeCount;g<e;++g)b[g]=z.inspect(a.getRangeAt(g));return"["+h+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var q=a.dom,p=a.util,z=a.DomRange,x=a.WrappedRange,y=a.DOMException,E=q.DomPosition,A,D,G=a.util.isHostMethod(window,"getSelection"),
O=a.util.isHostObject(document,"selection"),C=O&&(!G||a.config.preferTextRange);C?(A=e,a.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return"None"!=b.type||q.getDocument(b.createRange().parentElement())==a}):G?(A=d,a.isSelectionValid=function(){return!0}):c.fail("Neither document.selection or window.getSelection() detected.");a.getNativeSelection=A;var G=A(),w=a.createNativeRange(document),S=q.getBody(document),I=p.areHostObjects(G,p.areHostProperties(G,["anchorOffset","focusOffset"]));
a.features.selectionHasAnchorAndFocus=I;var h=p.isHostMethod(G,"extend");a.features.selectionHasExtend=h;var T="number"==typeof G.rangeCount;a.features.selectionHasRangeCount=T;var N=!1,W=!0;p.areHostMethods(G,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof G.rangeCount&&a.features.implementsDomRange&&function(){var a=document.createElement("iframe");a.frameBorder=0;a.style.position="absolute";a.style.left="-10000px";S.appendChild(a);var b=q.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");
b.close();var c=q.getIframeWindow(a).getSelection(),d=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(d,1);b.collapse(true);c.addRange(b);W=c.rangeCount==1;c.removeAllRanges();var h=b.cloneRange();b.setStart(d,0);h.setEnd(d,2);c.addRange(b);c.addRange(h);N=c.rangeCount==2;b.detach();h.detach();S.removeChild(a)}();a.features.selectionSupportsMultipleRanges=N;a.features.collapsedNonEditableSelectionsSupported=W;var L=!1,u;S&&p.isHostMethod(S,"createControlRange")&&(u=S.createControlRange(),
p.areHostProperties(u,["item","add"])&&(L=!0));a.features.implementsControlRange=L;D=I?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:false};var H;p.isHostMethod(G,"getRangeAt")?H=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:I&&(H=function(b){var c=q.getDocument(b.anchorNode),c=a.createRange(c);c.setStart(b.anchorNode,b.anchorOffset);c.setEnd(b.focusNode,b.focusOffset);if(c.collapsed!==
this.isCollapsed){c.setStart(b.focusNode,b.focusOffset);c.setEnd(b.anchorNode,b.anchorOffset)}return c});a.getSelection=function(a){var a=a||window,b=a._rangySelection,c=A(a),d=O?e(a):null;if(b){b.nativeSelection=c;b.docSelection=d;b.refresh(a)}else{b=new m(c,d,a);a._rangySelection=b}return b};a.getIframeSelection=function(b){return a.getSelection(q.getIframeWindow(b))};u=m.prototype;if(!C&&I&&p.areHostMethods(G,["removeAllRanges","addRange"])){u.removeAllRanges=function(){this.nativeSelection.removeAllRanges();
i(this)};var F=function(b,c){var d=z.getRangeDocument(c),d=a.createRange(d);d.collapseToPoint(c.endContainer,c.endOffset);b.nativeSelection.addRange(f(d));b.nativeSelection.extend(c.startContainer,c.startOffset);b.refresh()};u.addRange=T?function(b,c){if(L&&O&&this.docSelection.type=="Control")o(this,b);else if(c&&h)F(this,b);else{var d;if(N)d=this.rangeCount;else{this.removeAllRanges();d=0}this.nativeSelection.addRange(f(b));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==d+1){if(a.config.checkSelectionRanges)(d=
H(this.nativeSelection,this.rangeCount-1))&&!z.rangesEqual(d,b)&&(b=new x(d));this._ranges[this.rangeCount-1]=b;g(this,b,U(this.nativeSelection));this.isCollapsed=D(this)}else this.refresh()}}:function(a,b){if(b&&h)F(this,a);else{this.nativeSelection.addRange(f(a));this.refresh()}};u.setRanges=function(a){if(L&&a.length>1)n(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(p.isHostMethod(G,"empty")&&p.isHostMethod(w,"select")&&L&&C)u.removeAllRanges=
function(){try{this.docSelection.empty();if(this.docSelection.type!="None"){var a;if(this.anchorNode)a=q.getDocument(this.anchorNode);else if(this.docSelection.type=="Control"){var b=this.docSelection.createRange();b.length&&(a=q.getDocument(b.item(0)).body.createTextRange())}if(a){a.body.createTextRange().select();this.docSelection.empty()}}}catch(c){}i(this)},u.addRange=function(a){if(this.docSelection.type=="Control")o(this,a);else{x.rangeToTextRange(a).select();this._ranges[0]=a;this.rangeCount=
1;this.isCollapsed=this._ranges[0].collapsed;g(this,a,false)}},u.setRanges=function(a){this.removeAllRanges();var b=a.length;b>1?n(this,a):b&&this.addRange(a[0])};else return c.fail("No means of selecting a Range or TextRange was found"),!1;u.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new y("INDEX_SIZE_ERR");return this._ranges[a]};var M;if(C)M=function(b){var c;if(a.isSelectionValid(b.win))c=b.docSelection.createRange();else{c=q.getBody(b.win.document).createTextRange();c.collapse(true)}b.docSelection.type==
"Control"?l(b):c&&typeof c.text!="undefined"?j(b,c):i(b)};else if(p.isHostMethod(G,"getRangeAt")&&"number"==typeof G.rangeCount)M=function(b){if(L&&O&&b.docSelection.type=="Control")l(b);else{b._ranges.length=b.rangeCount=b.nativeSelection.rangeCount;if(b.rangeCount){for(var c=0,d=b.rangeCount;c<d;++c)b._ranges[c]=new a.WrappedRange(b.nativeSelection.getRangeAt(c));g(b,b._ranges[b.rangeCount-1],U(b.nativeSelection));b.isCollapsed=D(b)}else i(b)}};else if(I&&"boolean"==typeof G.isCollapsed&&"boolean"==
typeof w.collapsed&&a.features.implementsDomRange)M=function(a){var b;b=a.nativeSelection;if(b.anchorNode){b=H(b,0);a._ranges=[b];a.rangeCount=1;b=a.nativeSelection;a.anchorNode=b.anchorNode;a.anchorOffset=b.anchorOffset;a.focusNode=b.focusNode;a.focusOffset=b.focusOffset;a.isCollapsed=D(a)}else i(a)};else return c.fail("No means of obtaining a Range or TextRange from the user's selection was found"),!1;u.refresh=function(a){var b=a?this._ranges.slice(0):null;M(this);if(a){a=b.length;if(a!=this._ranges.length)return false;
for(;a--;)if(!z.rangesEqual(b[a],this._ranges[a]))return false;return true}};var J=function(a,b){var c=a.getAllRanges(),d=false;a.removeAllRanges();for(var h=0,g=c.length;h<g;++h)d||b!==c[h]?a.addRange(c[h]):d=true;a.rangeCount||i(a)};u.removeRange=L?function(a){if(this.docSelection.type=="Control"){for(var c=this.docSelection.createRange(),a=b(a),d=q.getDocument(c.item(0)),d=q.getBody(d).createControlRange(),h,g=false,e=0,f=c.length;e<f;++e){h=c.item(e);h!==a||g?d.add(c.item(e)):g=true}d.select();
l(this)}else J(this,a)}:function(a){J(this,a)};var U;!C&&I&&a.features.implementsDomRange?(U=function(a){var b=false;a.anchorNode&&(b=q.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset)==1);return b},u.isBackwards=function(){return U(this)}):U=u.isBackwards=function(){return false};u.toString=function(){for(var a=[],b=0,c=this.rangeCount;b<c;++b)a[b]=""+this._ranges[b];return a.join("")};u.collapse=function(b,c){r(this,b);var d=a.createRange(q.getDocument(b));d.collapseToPoint(b,
c);this.removeAllRanges();this.addRange(d);this.isCollapsed=true};u.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new y("INVALID_STATE_ERR");};u.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new y("INVALID_STATE_ERR");};u.selectAllChildren=function(b){r(this,b);var c=a.createRange(q.getDocument(b));c.selectNodeContents(b);this.removeAllRanges();
this.addRange(c)};u.deleteFromDocument=function(){if(L&&O&&this.docSelection.type=="Control"){for(var a=this.docSelection.createRange(),b;a.length;){b=a.item(0);a.remove(b);b.parentNode.removeChild(b)}this.refresh()}else if(this.rangeCount){a=this.getAllRanges();this.removeAllRanges();b=0;for(var c=a.length;b<c;++b)a[b].deleteContents();this.addRange(a[c-1])}};u.getAllRanges=function(){return this._ranges.slice(0)};u.setSingleRange=function(a){this.setRanges([a])};u.containsNode=function(a,b){for(var c=
0,d=this._ranges.length;c<d;++c)if(this._ranges[c].containsNode(a,b))return true;return false};u.toHtml=function(){var a="";if(this.rangeCount){for(var a=z.getRangeDocument(this._ranges[0]).createElement("div"),b=0,c=this._ranges.length;b<c;++b)a.appendChild(this._ranges[b].cloneContents());a=a.innerHTML}return a};u.getName=function(){return"WrappedSelection"};u.inspect=function(){return s(this)};u.detach=function(){this.win=this.anchorNode=this.focusNode=this.win._rangySelection=null};m.inspect=
s;a.Selection=m;a.selectionPrototype=u;a.addCreateMissingNativeApiListener(function(b){if(typeof b.getSelection=="undefined")b.getSelection=function(){return a.getSelection(this)};b=null})});
...
"class"!=g)return!0;return!1}function m(a){var b;return a&&1==a.nodeType&&((b=a.parentNode)&&9==b.nodeType&&"on"==b.designMode||D(a)&&!D(a.parentNode))}function n(a){return(D(a)||1!=a.nodeType&&D(a.parentNode))&&!m(a)}function r(a){return a&&1==a.nodeType&&!G.test(A(a,"display"))}function s(a){if(0==a.data.length)return!0;if(O.test(a.data))return!1;switch(A(a.parentNode,"whiteSpace")){case "pre":case "pre-wrap":case "-moz-pre-wrap":return!1;case "pre-line":if(/[\r\n]/.test(a.data))return!1}return r(a.previousSibling)||
...
function x(a,b,c){this.cssClass=a;var d,e,f=null;if("object"==typeof b&&null!==b){c=b.tagNames;f=b.elementProperties;for(d=0;e=S[d++];)b.hasOwnProperty(e)&&(this[e]=b[e]);d=b.normalize}else d=b;this.normalize="undefined"==typeof d?!0:d;this.attrExceptions=[];d=document.createElement(this.elementTagName);this.elementProperties={};for(var i in f)f.hasOwnProperty(i)&&(I.hasOwnProperty(i)&&(i=I[i]),d[i]=f[i],this.elementProperties[i]=d[i],this.attrExceptions.push(i));this.elementSortedClassName=this.elementProperties.hasOwnProperty("className")?
...
return!0},isAppliedToSelection:function(b){for(var b=a.getSelection(b||window).getAllRanges(),c=b.length;c--;)if(!this.isAppliedToRange(b[c]))return!1;return!0},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)},toggleSelection:function(a){this.isAppliedToSelection(a)?this.undoToSelection(a):this.applyToSelection(a)},detach:function(){}};x.util={hasClass:d,addClass:e,removeClass:E,hasSameClasses:i,replaceWithOwnChildren:f,elementsHaveSameNonClassAttributes:l,
elementHasNonClassAttributes:o,splitNodeAt:q,isEditableElement:D,isEditingHost:m,isEditable:n};a.CssClassApplier=x;a.createCssClassApplier=function(a,b,c){return new x(a,b,c)}});
...
c.warn("Marker element has been removed. Cannot restore selection.")}function g(a,b){return b.compareBoundaryPoints(a.START_TO_START,a)}function i(a,b){var c=(a||document).getElementById(b);c&&c.parentNode.removeChild(c)}a.requireModules(["DomUtil","DomRange","WrappedRange"]);var f=a.dom,b="\ufeff";a.saveSelection=function(b){var b=b||window,e=b.document;if(a.isSelectionValid(b)){var f=a.getSelection(b),i=f.getAllRanges(),n=[],r,s;i.sort(g);for(var q=0,p=i.length;q<p;++q)r=i[q],r.collapsed?(s=d(r,
!1),n.push({markerId:s.id,collapsed:!0})):(s=d(r,!1),r=d(r,!0),n[q]={startMarkerId:r.id,endMarkerId:s.id,collapsed:!1,backwards:1==i.length&&f.isBackwards()});for(q=p-1;0<=q;--q)r=i[q],r.collapsed?r.collapseBefore((e||document).getElementById(n[q].markerId)):(r.setEndBefore((e||document).getElementById(n[q].endMarkerId)),r.setStartAfter((e||document).getElementById(n[q].startMarkerId)));f.setRanges(i);return{win:b,doc:e,rangeInfos:n,restored:!1}}c.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
...
(function(a,c){function d(a){var b=T[a]={},c,d,a=a.split(/\s+/);c=0;for(d=a.length;c<d;c++)b[a[c]]=!0;return b}function e(a,b,d){if(d===c&&1===a.nodeType)if(d="data-"+b.replace(L,"-$1").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:h.isNumeric(d)?+d:W.test(d)?h.parseJSON(d):d}catch(e){}h.data(a,b,d)}else d=c;return d}function g(a){for(var b in a)if(!("data"===b&&h.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function i(a,b,c){var d=
b+"defer",e=b+"queue",k=b+"mark",g=h._data(a,d);g&&("queue"===c||!h._data(a,e))&&("mark"===c||!h._data(a,k))&&setTimeout(function(){!h._data(a,e)&&!h._data(a,k)&&(h.removeData(a,d,!0),g.fire())},0)}function f(){return!1}function b(){return!0}function j(a,b,c){b=b||0;if(h.isFunction(b))return h.grep(a,function(a,d){return!!b.call(a,d,a)===c});if(b.nodeType)return h.grep(a,function(a){return a===b===c});if("string"===typeof b){var d=h.grep(a,function(a){return 1===a.nodeType});if(Wa.test(b))return h.filter(b,
d,!c);b=h.filter(b,d)}return h.grep(a,function(a){return 0<=h.inArray(a,b)===c})}function l(a){var b=Fa.split("|"),a=a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());return a}function o(a,b){if(1===b.nodeType&&h.hasData(a)){var c,d,e;d=h._data(a);var k=h._data(b,d),g=d.events;if(g)for(c in delete k.handle,k.events={},g){d=0;for(e=g[c].length;d<e;d++)h.event.add(b,c,g[c][d])}k.data&&(k.data=h.extend({},k.data))}}function m(a,b){var c;if(1===b.nodeType){b.clearAttributes&&
...
c)for(;4>e;e+=2)c||(d-=parseFloat(h.css(a,"padding"+ba[e]))||0),d="margin"===c?d+(parseFloat(h.css(a,c+ba[e]))||0):d-(parseFloat(h.css(a,"border"+ba[e]+"Width"))||0);return d+"px"}d=ea(a,b);if(0>d||null==d)d=a.style[b];if(wa.test(d))return d;d=parseFloat(d)||0;if(c)for(;4>e;e+=2)d+=parseFloat(h.css(a,"padding"+ba[e]))||0,"padding"!==c&&(d+=parseFloat(h.css(a,"border"+ba[e]+"Width"))||0),"margin"===c&&(d+=parseFloat(h.css(a,c+ba[e]))||0);return d+"px"}function p(a){return function(b,c){"string"!==
typeof b&&(c=b,b="*");if(h.isFunction(c))for(var d=b.toLowerCase().split(La),e=0,k=d.length,g,f;e<k;e++)g=d[e],(f=/^\+/.test(g))&&(g=g.substr(1)||"*"),g=a[g]=a[g]||[],g[f?"unshift":"push"](c)}}function z(a,b,d,e,g,k){g=g||b.dataTypes[0];k=k||{};k[g]=!0;for(var g=a[g],f=0,i=g?g.length:0,h=a===xa,j;f<i&&(h||!j);f++)j=g[f](b,d,e),"string"===typeof j&&(!h||k[j]?j=c:(b.dataTypes.unshift(j),j=z(a,b,d,e,j,k)));if((h||!j)&&!k["*"])j=z(a,b,d,e,"*",k);return j}function x(a,b){var d,e,g=h.ajaxSettings.flatOptions||
{};for(d in b)b[d]!==c&&((g[d]?a:e||(e={}))[d]=b[d]);e&&h.extend(!0,a,e)}function y(a,b,c,d){if(h.isArray(b))h.each(b,function(b,e){c||db.test(a)?d(a,e):y(a+"["+("object"===typeof e?b:"")+"]",e,c,d)});else if(!c&&"object"===h.type(b))for(var e in b)y(a+"["+e+"]",b[e],c,d);else d(a,b)}function E(){try{return new a.XMLHttpRequest}catch(b){}}function A(){setTimeout(D,0);return oa=h.now()}function D(){oa=c}function G(a,b){var c={};h.each(pa.concat.apply([],pa.slice(0,b)),function(){c[this]=a});return c}
function O(a){if(!ya[a]){var b=w.body,c=h("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d){Z||(Z=w.createElement("iframe"),Z.frameBorder=Z.width=Z.height=0);b.appendChild(Z);if(!fa||!Z.createElement)fa=(Z.contentWindow||Z.contentDocument).document,fa.write((h.support.boxModel?"<!doctype html>":"")+"<html><body>"),fa.close();c=fa.createElement(a);fa.body.appendChild(c);d=h.css(c,"display");b.removeChild(Z)}ya[a]=d}return ya[a]}function C(a){return h.isWindow(a)?a:9===a.nodeType?
a.defaultView||a.parentWindow:!1}var w=a.document,S=a.navigator,I=a.location,h=function(){function b(){if(!d.isReady){try{w.documentElement.doScroll("left")}catch(a){setTimeout(b,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,k)},e=a.jQuery,g=a.$,k,f=/^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,i=/\S/,h=/^\s+/,j=/\s+$/,v=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,l=/^[\],:{}\s]*$/,n=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,t=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,m=/(?:^|:|,)(?:\s*\[)+/g,
o=/(webkit)[ \/]([\w.]+)/,r=/(opera)(?:.*version)?[ \/]([\w.]+)/,s=/(msie) ([\w.]+)/,K=/(mozilla)(?:.*? rv:([\w.]+))?/,q=/-([a-z]|[0-9])/ig,P=/^-ms-/,p=function(a,b){return(b+"").toUpperCase()},x=S.userAgent,qa,ga,eb=Object.prototype.toString,za=Object.prototype.hasOwnProperty,Aa=Array.prototype.push,R=Array.prototype.slice,z=String.prototype.trim,u=Array.prototype.indexOf,y={};d.fn=d.prototype={constructor:d,init:function(a,b,e){var B;if(!a)return this;if(a.nodeType)return this.context=this[0]=a,
this.length=1,this;if("body"===a&&!b&&w.body)return this.context=w,this[0]=w.body,this.selector=a,this.length=1,this;if("string"===typeof a){if((B="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:f.exec(a))&&(B[1]||!b)){if(B[1])return e=(b=b instanceof d?b[0]:b)?b.ownerDocument||b:w,(a=v.exec(a))?d.isPlainObject(b)?(a=[w.createElement(a[1])],d.fn.attr.call(a,b,!0)):a=[e.createElement(a[1])]:(a=d.buildFragment([B[1]],[e]),a=(a.cacheable?d.clone(a.fragment):a.fragment).childNodes),
d.merge(this,a);if((b=w.getElementById(B[2]))&&b.parentNode){if(b.id!==B[2])return e.find(a);this.length=1;this[0]=b}this.context=w;this.selector=a;return this}return!b||b.jquery?(b||e).find(a):this.constructor(b).find(a)}if(d.isFunction(a))return e.ready(a);a.selector!==c&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,this)},selector:"",jquery:"1.7.2",length:0,size:function(){return this.length},toArray:function(){return R.call(this,0)},get:function(a){return null==a?this.toArray():
0>a?this[this.length+a]:this[a]},pushStack:function(a,b,c){var e=this.constructor();d.isArray(a)?Aa.apply(e,a):d.merge(e,a);e.prevObject=this;e.context=this.context;"find"===b?e.selector=this.selector+(this.selector?" ":"")+c:b&&(e.selector=this.selector+"."+b+"("+c+")");return e},each:function(a,b){return d.each(this,a,b)},ready:function(a){d.bindReady();qa.add(a);return this},eq:function(a){a=+a;return-1===a?this.slice(a):this.slice(a,a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},
slice:function(){return this.pushStack(R.apply(this,arguments),"slice",R.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:Aa,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,b,e,B,g,k=arguments[0]||{},f=1,i=arguments.length,h=!1;"boolean"===typeof k&&(h=k,k=arguments[1]||{},f=2);"object"!==typeof k&&!d.isFunction(k)&&(k=
...
1);d.isReady=!0;!0!==a&&0<--d.readyWait||(qa.fireWith(w,[d]),d.fn.trigger&&d(w).trigger("ready").off("ready"))}},bindReady:function(){if(!qa){qa=d.Callbacks("once memory");if("complete"===w.readyState)return setTimeout(d.ready,1);if(w.addEventListener)w.addEventListener("DOMContentLoaded",ga,!1),a.addEventListener("load",d.ready,!1);else if(w.attachEvent){w.attachEvent("onreadystatechange",ga);a.attachEvent("onload",d.ready);var c=!1;try{c=null==a.frameElement}catch(e){}w.documentElement.doScroll&&
...
return e===c||za.call(a,e)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(l.test(b.replace(n,"@").replace(t,"]").replace(m,"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b){if("string"!==typeof b||!b)return null;var e,B;try{a.DOMParser?(B=new DOMParser,e=B.parseFromString(b,"text/xml")):
(e=new ActiveXObject("Microsoft.XMLDOM"),e.async="false",e.loadXML(b))}catch(k){e=c}(!e||!e.documentElement||e.getElementsByTagName("parsererror").length)&&d.error("Invalid XML: "+b);return e},noop:function(){},globalEval:function(b){b&&i.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(P,"ms-").replace(q,p)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,b,e){var B,k=0,g=a.length,f=g===c||d.isFunction(a);
if(e)if(f)for(B in a){if(!1===b.apply(a[B],e))break}else for(;k<g&&!1!==b.apply(a[k++],e););else if(f)for(B in a){if(!1===b.call(a[B],B,a[B]))break}else for(;k<g&&!1!==b.call(a[k],k,a[k++]););return a},trim:z?function(a){return null==a?"":z.call(a)}:function(a){return null==a?"":a.toString().replace(h,"").replace(j,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var e=d.type(a);null==a.length||"string"===e||"function"===e||"regexp"===e||d.isWindow(a)?Aa.call(c,a):d.merge(c,a)}return c},inArray:function(a,
b,c){var d;if(b){if(u)return u.call(b,a,c);d=b.length;for(c=c?0>c?Math.max(0,d+c):c:0;c<d;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,b){var d=a.length,e=0;if("number"===typeof b.length)for(var B=b.length;e<B;e++)a[d++]=b[e];else for(;b[e]!==c;)a[d++]=b[e++];a.length=d;return a},grep:function(a,b,c){for(var d=[],e,c=!!c,B=0,k=a.length;B<k;B++)e=!!b(a[B],B),c!==e&&d.push(a[B]);return d},map:function(a,b,e){var B,k,g=[],f=0,i=a.length;if(a instanceof d||i!==c&&"number"===typeof i&&(0<
i&&a[0]&&a[i-1]||0===i||d.isArray(a)))for(;f<i;f++)B=b(a[f],f,e),null!=B&&(g[g.length]=B);else for(k in a)B=b(a[k],k,e),null!=B&&(g[g.length]=B);return g.concat.apply([],g)},guid:1,proxy:function(a,b){if("string"===typeof b)var e=a[b],b=a,a=e;if(!d.isFunction(a))return c;var B=R.call(arguments,2),e=function(){return a.apply(b,B.concat(R.call(arguments)))};e.guid=a.guid=a.guid||e.guid||d.guid++;return e},access:function(a,b,e,B,k,g,f){var i,h=null==e,j=0,v=a.length;if(e&&"object"===typeof e){for(j in e)d.access(a,
b,j,e[j],1,g,B);k=1}else if(B!==c){i=f===c&&d.isFunction(B);h&&(i?(i=b,b=function(a,b,c){return i.call(d(a),c)}):(b.call(a,B),b=null));if(b)for(;j<v;j++)b(a[j],e,i?B.call(a[j],j,b(a[j],e)):B,f);k=1}return k?a:h?b.call(a):v?b(a[0],e):g},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=o.exec(a)||r.exec(a)||s.exec(a)||0>a.indexOf("compatible")&&K.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,
a,this);a.superclass=this;a.fn=a.prototype=this();a.fn.constructor=a;a.sub=this.sub;a.fn.init=function(c,e){e&&e instanceof d&&!(e instanceof a)&&(e=a(e));return d.fn.init.call(this,c,e,b)};a.fn.init.prototype=a.fn;var b=a(w);return a},browser:{}});d.each("Boolean,Number,String,Function,Array,Date,RegExp,Object".split(","),function(a,b){y["[object "+b+"]"]=b.toLowerCase()});x=d.uaMatch(x);x.browser&&(d.browser[x.browser]=!0,d.browser.version=x.version);d.browser.webkit&&(d.browser.safari=!0);i.test("\u00a0")&&
(h=/^[\s\xA0]+/,j=/[\s\xA0]+$/);k=d(w);w.addEventListener?ga=function(){w.removeEventListener("DOMContentLoaded",ga,false);d.ready()}:w.attachEvent&&(ga=function(){if(w.readyState==="complete"){w.detachEvent("onreadystatechange",ga);d.ready()}});return d}(),T={};h.Callbacks=function(a){var a=a?T[a]||d(a):{},b=[],e=[],k,g,f,i,j,v,l=function(c){var d,e,k,g;d=0;for(e=c.length;d<e;d++)k=c[d],g=h.type(k),"array"===g?l(k):"function"===g&&(!a.unique||!t.has(k))&&b.push(k)},n=function(c,d){d=d||[];k=!a.memory||
[c,d];f=g=!0;v=i||0;i=0;for(j=b.length;b&&v<j;v++)if(!1===b[v].apply(c,d)&&a.stopOnFalse){k=!0;break}f=!1;b&&(a.once?!0===k?t.disable():b=[]:e&&e.length&&(k=e.shift(),t.fireWith(k[0],k[1])))},t={add:function(){if(b){var a=b.length;l(arguments);f?j=b.length:k&&!0!==k&&(i=a,n(k[0],k[1]))}return this},remove:function(){if(b)for(var c=arguments,d=0,e=c.length;d<e;d++)for(var k=0;k<b.length&&!(c[d]===b[k]&&(f&&k<=j&&(j--,k<=v&&v--),b.splice(k--,1),a.unique));k++);return this},has:function(a){if(b)for(var c=
0,d=b.length;c<d;c++)if(a===b[c])return!0;return!1},empty:function(){b=[];return this},disable:function(){b=e=k=c;return this},disabled:function(){return!b},lock:function(){e=c;(!k||!0===k)&&t.disable();return this},locked:function(){return!e},fireWith:function(b,c){e&&(f?a.once||e.push([b,c]):(!a.once||!k)&&n(b,c));return this},fire:function(){t.fireWith(this,arguments);return this},fired:function(){return!!g}};return t};var N=[].slice;h.extend({Deferred:function(a){var b=h.Callbacks("once memory"),
...
N.call(arguments,0):b;--f||i.resolveWith(i,d)}}function c(a){return function(b){g[a]=1<arguments.length?N.call(arguments,0):b;i.notifyWith(j,g)}}var d=N.call(arguments,0),e=0,k=d.length,g=Array(k),f=k,i=1>=k&&a&&h.isFunction(a.promise)?a:h.Deferred(),j=i.promise();if(1<k){for(;e<k;e++)d[e]&&d[e].promise&&h.isFunction(d[e].promise)?d[e].promise().then(b(e),i.reject,c(e)):--f;f||i.resolveWith(i,d)}else i!==a&&i.resolveWith(i,k?[a]:[]);return j}});h.support=function(){var b,c,d,e,k,g,f,i,j=w.createElement("div");
j.setAttribute("className","t");j.innerHTML="   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>";c=j.getElementsByTagName("*");d=j.getElementsByTagName("a")[0];if(!c||!c.length||!d)return{};e=w.createElement("select");k=e.appendChild(w.createElement("option"));c=j.getElementsByTagName("input")[0];b={leadingWhitespace:3===j.firstChild.nodeType,tbody:!j.getElementsByTagName("tbody").length,htmlSerialize:!!j.getElementsByTagName("link").length,
style:/top/.test(d.getAttribute("style")),hrefNormalized:"/a"===d.getAttribute("href"),opacity:/^0.55/.test(d.style.opacity),cssFloat:!!d.style.cssFloat,checkOn:"on"===c.value,optSelected:k.selected,getSetAttribute:"t"!==j.className,enctype:!!w.createElement("form").enctype,html5Clone:"<:nav></:nav>"!==w.createElement("nav").cloneNode(!0).outerHTML,submitBubbles:!0,changeBubbles:!0,focusinBubbles:!1,deleteExpando:!0,noCloneEvent:!0,inlineBlockNeedsLayout:!1,shrinkWrapBlocks:!1,reliableMarginRight:!0,
pixelMargin:!0};h.boxModel=b.boxModel="CSS1Compat"===w.compatMode;c.checked=!0;b.noCloneChecked=c.cloneNode(!0).checked;e.disabled=!0;b.optDisabled=!k.disabled;try{delete j.test}catch(v){b.deleteExpando=!1}!j.addEventListener&&j.attachEvent&&j.fireEvent&&(j.attachEvent("onclick",function(){b.noCloneEvent=!1}),j.cloneNode(!0).fireEvent("onclick"));c=w.createElement("input");c.value="t";c.setAttribute("type","radio");b.radioValue="t"===c.value;c.setAttribute("checked","checked");c.setAttribute("name",
"t");j.appendChild(c);d=w.createDocumentFragment();d.appendChild(j.lastChild);b.checkClone=d.cloneNode(!0).cloneNode(!0).lastChild.checked;b.appendChecked=c.checked;d.removeChild(c);d.appendChild(j);if(j.attachEvent)for(f in{submit:1,change:1,focusin:1})c="on"+f,i=c in j,i||(j.setAttribute(c,"return;"),i="function"===typeof j[c]),b[f+"Bubbles"]=i;d.removeChild(j);d=e=k=j=c=null;h(function(){var c,d,e,k,f=w.getElementsByTagName("body")[0];if(f){c=w.createElement("div");c.style.cssText="padding:0;margin:0;border:0;visibility:hidden;width:0;height:0;position:static;top:0;margin-top:1px";
f.insertBefore(c,f.firstChild);j=w.createElement("div");c.appendChild(j);j.innerHTML="<table><tr><td style='padding:0;margin:0;border:0;display:none'></td><td>t</td></tr></table>";g=j.getElementsByTagName("td");i=g[0].offsetHeight===0;g[0].style.display="";g[1].style.display="none";b.reliableHiddenOffsets=i&&g[0].offsetHeight===0;if(a.getComputedStyle){j.innerHTML="";d=w.createElement("div");d.style.width="0";d.style.marginRight="0";j.style.width="2px";j.appendChild(d);b.reliableMarginRight=(parseInt((a.getComputedStyle(d,
...
return b}();var W=/^(?:\{.*\}|\[.*\])$/,L=/([A-Z])/g;h.extend({cache:{},uuid:0,expando:"jQuery"+(h.fn.jquery+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(a){a=a.nodeType?h.cache[a[h.expando]]:a[h.expando];return!!a&&!g(a)},data:function(a,b,d,e){if(h.acceptData(a)){var k;k=h.expando;var g="string"===typeof b,f=a.nodeType,i=f?h.cache:a,j=f?a[k]:a[k]&&k,v="events"===b;if(j&&i[j]&&(v||e||i[j].data)||!(g&&d===c)){j||
(f?a[k]=j=++h.uuid:j=k);i[j]||(i[j]={},f||(i[j].toJSON=h.noop));if("object"===typeof b||"function"===typeof b)e?i[j]=h.extend(i[j],b):i[j].data=h.extend(i[j].data,b);k=a=i[j];e||(a.data||(a.data={}),a=a.data);d!==c&&(a[h.camelCase(b)]=d);if(v&&!a[b])return k.events;g?(d=a[b],null==d&&(d=a[h.camelCase(b)])):d=a;return d}}},removeData:function(a,b,c){if(h.acceptData(a)){var d,e,k,f=h.expando,i=a.nodeType,j=i?h.cache:a,v=i?a[f]:f;if(j[v]){if(b&&(d=c?j[v]:j[v].data)){h.isArray(b)||(b in d?b=[b]:(b=h.camelCase(b),
b=b in d?[b]:b.split(" ")));e=0;for(k=b.length;e<k;e++)delete d[b[e]];if(!(c?g:h.isEmptyObject)(d))return}if(!c&&(delete j[v].data,!g(j[v])))return;h.support.deleteExpando||!j.setInterval?delete j[v]:j[v]=null;i&&(h.support.deleteExpando?delete a[f]:a.removeAttribute?a.removeAttribute(f):a[f]=null)}}},_data:function(a,b,c){return h.data(a,b,c,!0)},acceptData:function(a){if(a.nodeName){var b=h.noData[a.nodeName.toLowerCase()];if(b)return!(!0===b||a.getAttribute("classid")!==b)}return!0}});h.fn.extend({data:function(a,
b){var d,k,g,f,i,j=this[0],v=0,l=null;if(a===c){if(this.length&&(l=h.data(j),1===j.nodeType&&!h._data(j,"parsedAttrs"))){g=j.attributes;for(i=g.length;v<i;v++)f=g[v].name,0===f.indexOf("data-")&&(f=h.camelCase(f.substring(5)),e(j,f,l[f]));h._data(j,"parsedAttrs",!0)}return l}if("object"===typeof a)return this.each(function(){h.data(this,a)});d=a.split(".",2);d[1]=d[1]?"."+d[1]:"";k=d[1]+"!";return h.access(this,function(b){if(b===c)return l=this.triggerHandler("getData"+k,[d[0]]),l===c&&j&&(l=h.data(j,
...
d,k.val()):a,null==d?d="":"number"===typeof d?d+="":h.isArray(d)&&(d=h.map(d,function(a){return a==null?"":a+""})),b=h.valHooks[this.type]||h.valHooks[this.nodeName.toLowerCase()],!b||!("set"in b)||b.set(this,d,"value")===c))this.value=d});if(k){if((b=h.valHooks[k.type]||h.valHooks[k.nodeName.toLowerCase()])&&"get"in b&&(d=b.get(k,"value"))!==c)return d;d=k.value;return"string"===typeof d?d.replace(F,""):null==d?"":d}}});h.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||
...
{set:function(a,b){if(h.isArray(b))return a.checked=h.inArray(h(a).val(),b)>=0}})});var K=/^(?:textarea|input|select)$/i,P=/^([^\.]*)?(?:\.(.+))?$/,R=/(?:^|\s)hover(\.\S+)?\b/,$=/^key/,V=/^(?:mouse|contextmenu)|click/,ia=/^(?:focusinfocus|focusoutblur)$/,ua=/^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/,la=function(a){if(a=ua.exec(a)){a[1]=(a[1]||"").toLowerCase();a[3]=a[3]&&RegExp("(?:^|\\s)"+a[3]+"(?:\\s|$)")}return a},ja=function(a){return h.event.special.hover?a:a.replace(R,"mouseenter$1 mouseleave$1")};
h.event={add:function(a,b,d,e,k){var g,f,i,j,v,l,t,n,m;if(!(a.nodeType===3||a.nodeType===8||!b||!d||!(g=h._data(a)))){if(d.handler){t=d;d=t.handler;k=t.selector}if(!d.guid)d.guid=h.guid++;i=g.events;if(!i)g.events=i={};f=g.handle;if(!f){g.handle=f=function(a){return typeof h!=="undefined"&&(!a||h.event.triggered!==a.type)?h.event.dispatch.apply(f.elem,arguments):c};f.elem=a}b=h.trim(ja(b)).split(" ");for(g=0;g<b.length;g++){j=P.exec(b[g])||[];v=j[1];l=(j[2]||"").split(".").sort();m=h.event.special[v]||
{};v=(k?m.delegateType:m.bindType)||v;m=h.event.special[v]||{};j=h.extend({type:v,origType:j[1],data:e,handler:d,guid:d.guid,selector:k,quick:k&&la(k),namespace:l.join(".")},t);n=i[v];if(!n){n=i[v]=[];n.delegateCount=0;if(!m.setup||m.setup.call(a,e,l,f)===false)a.addEventListener?a.addEventListener(v,f,false):a.attachEvent&&a.attachEvent("on"+v,f)}if(m.add){m.add.call(a,j);if(!j.handler.guid)j.handler.guid=d.guid}k?n.splice(n.delegateCount++,0,j):n.push(j);h.event.global[v]=true}a=null}},global:{},
remove:function(a,b,c,d,e){var k=h.hasData(a)&&h._data(a),g,f,i,j,v,l,n,t,m,o;if(k&&(n=k.events)){b=h.trim(ja(b||"")).split(" ");for(g=0;g<b.length;g++){f=P.exec(b[g])||[];i=j=f[1];f=f[2];if(i){t=h.event.special[i]||{};i=(d?t.delegateType:t.bindType)||i;m=n[i]||[];v=m.length;f=f?RegExp("(^|\\.)"+f.split(".").sort().join("\\.(?:.*\\.)?")+"(\\.|$)"):null;for(l=0;l<m.length;l++){o=m[l];if((e||j===o.origType)&&(!c||c.guid===o.guid)&&(!f||f.test(o.namespace))&&(!d||d===o.selector||d==="**"&&o.selector)){m.splice(l--,
1);o.selector&&m.delegateCount--;t.remove&&t.remove.call(a,o)}}if(m.length===0&&v!==m.length){(!t.teardown||t.teardown.call(a,f)===false)&&h.removeEvent(a,i,k.handle);delete n[i]}}else for(i in n)h.event.remove(a,i+b[g],c,d,true)}if(h.isEmptyObject(n)){if(b=k.handle)b.elem=null;h.removeData(a,["events","handle"],true)}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(b,d,e,k){if(!e||!(e.nodeType===3||e.nodeType===8)){var g=b.type||b,f=[],i,j,v,l,t;if(!ia.test(g+h.event.triggered)){if(g.indexOf("!")>=
0){g=g.slice(0,-1);i=true}if(g.indexOf(".")>=0){f=g.split(".");g=f.shift();f.sort()}if(e&&!h.event.customEvent[g]||h.event.global[g]){b=typeof b==="object"?b[h.expando]?b:new h.Event(g,b):new h.Event(g);b.type=g;b.isTrigger=true;b.exclusive=i;b.namespace=f.join(".");b.namespace_re=b.namespace?RegExp("(^|\\.)"+f.join("\\.(?:.*\\.)?")+"(\\.|$)"):null;i=g.indexOf(":")<0?"on"+g:"";if(e){b.result=c;if(!b.target)b.target=e;d=d!=null?h.makeArray(d):[];d.unshift(b);v=h.event.special[g]||{};if(!(v.trigger&&
v.trigger.apply(e,d)===false)){t=[[e,v.bindType||g]];if(!k&&!v.noBubble&&!h.isWindow(e)){l=v.delegateType||g;f=ia.test(l+g)?e:e.parentNode;for(j=null;f;f=f.parentNode){t.push([f,l]);j=f}j&&j===e.ownerDocument&&t.push([j.defaultView||j.parentWindow||a,l])}for(j=0;j<t.length&&!b.isPropagationStopped();j++){f=t[j][0];b.type=t[j][1];(l=(h._data(f,"events")||{})[b.type]&&h._data(f,"handle"))&&l.apply(f,d);(l=i&&f[i])&&h.acceptData(f)&&l.apply(f,d)===false&&b.preventDefault()}b.type=g;if(!k&&!b.isDefaultPrevented()&&
(!v._default||v._default.apply(e.ownerDocument,d)===false)&&!(g==="click"&&h.nodeName(e,"a"))&&h.acceptData(e))if(i&&e[g]&&(g!=="focus"&&g!=="blur"||b.target.offsetWidth!==0)&&!h.isWindow(e)){(j=e[i])&&(e[i]=null);h.event.triggered=g;e[g]();h.event.triggered=c;j&&(e[i]=j)}return b.result}}else{e=h.cache;for(j in e)e[j].events&&e[j].events[g]&&h.event.trigger(b,d,e[j].handle.elem,true)}}}}},dispatch:function(b){var b=h.event.fix(b||a.event),d=(h._data(this,"events")||{})[b.type]||[],e=d.delegateCount,
k=[].slice.call(arguments,0),g=!b.exclusive&&!b.namespace,f=h.event.special[b.type]||{},i=[],j,v,l,t,n,m,o;k[0]=b;b.delegateTarget=this;if(!(f.preDispatch&&f.preDispatch.call(this,b)===false)){if(e&&!(b.button&&b.type==="click")){l=h(this);l.context=this.ownerDocument||this;for(v=b.target;v!=this;v=v.parentNode||this)if(v.disabled!==true){n={};m=[];l[0]=v;for(j=0;j<e;j++){t=d[j];o=t.selector;if(n[o]===c){var r=n,s=o,K;if(t.quick){K=t.quick;var q=v.attributes||{};K=(!K[1]||v.nodeName.toLowerCase()===
K[1])&&(!K[2]||(q.id||{}).value===K[2])&&(!K[3]||K[3].test((q["class"]||{}).value))}else K=l.is(o);r[s]=K}n[o]&&m.push(t)}m.length&&i.push({elem:v,matches:m})}}d.length>e&&i.push({elem:this,matches:d.slice(e)});for(j=0;j<i.length&&!b.isPropagationStopped();j++){e=i[j];b.currentTarget=e.elem;for(d=0;d<e.matches.length&&!b.isImmediatePropagationStopped();d++){t=e.matches[d];if(g||!b.namespace&&!t.namespace||b.namespace_re&&b.namespace_re.test(t.namespace)){b.data=t.data;b.handleObj=t;t=((h.event.special[t.origType]||
{}).handle||t.handler).apply(e.elem,k);if(t!==c){b.result=t;if(t===false){b.preventDefault();b.stopPropagation()}}}}}f.postDispatch&&f.postDispatch.call(this,b);return b.result}},props:"attrChange,attrName,relatedNode,srcElement,altKey,bubbles,cancelable,ctrlKey,currentTarget,eventPhase,metaKey,relatedTarget,shiftKey,target,timeStamp,view,which".split(","),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){if(a.which==null)a.which=b.charCode!=null?b.charCode:b.keyCode;
return a}},mouseHooks:{props:"button,buttons,clientX,clientY,fromElement,offsetX,offsetY,pageX,pageY,screenX,screenY,toElement".split(","),filter:function(a,b){var d,e,k=b.button,g=b.fromElement;if(a.pageX==null&&b.clientX!=null){d=a.target.ownerDocument||w;e=d.documentElement;d=d.body;a.pageX=b.clientX+(e&&e.scrollLeft||d&&d.scrollLeft||0)-(e&&e.clientLeft||d&&d.clientLeft||0);a.pageY=b.clientY+(e&&e.scrollTop||d&&d.scrollTop||0)-(e&&e.clientTop||d&&d.clientTop||0)}if(!a.relatedTarget&&g)a.relatedTarget=
g===a.target?b.toElement:g;if(!a.which&&k!==c)a.which=k&1?1:k&2?3:k&4?2:0;return a}},fix:function(a){if(a[h.expando])return a;var b,d,e=a,k=h.event.fixHooks[a.type]||{},g=k.props?this.props.concat(k.props):this.props,a=h.Event(e);for(b=g.length;b;){d=g[--b];a[d]=e[d]}if(!a.target)a.target=e.srcElement||w;if(a.target.nodeType===3)a.target=a.target.parentNode;if(a.metaKey===c)a.metaKey=a.ctrlKey;return k.filter?k.filter(a,e):a},special:{ready:{setup:h.bindReady},load:{noBubble:!0},focus:{delegateType:"focusin"},
...
postDispatch:function(a){if(a._submit_bubble){delete a._submit_bubble;this.parentNode&&!a.isTrigger&&h.event.simulate("submit",this.parentNode,a,true)}},teardown:function(){if(h.nodeName(this,"form"))return false;h.event.remove(this,"._submit")}});h.support.changeBubbles||(h.event.special.change={setup:function(){if(K.test(this.nodeName)){if(this.type==="checkbox"||this.type==="radio"){h.event.add(this,"propertychange._change",function(a){if(a.originalEvent.propertyName==="checked")this._just_changed=
true});h.event.add(this,"click._change",function(a){if(this._just_changed&&!a.isTrigger){this._just_changed=false;h.event.simulate("change",this,a,true)}})}return false}h.event.add(this,"beforeactivate._change",function(a){a=a.target;if(K.test(a.nodeName)&&!a._change_attached){h.event.add(a,"change._change",function(a){this.parentNode&&!a.isSimulated&&!a.isTrigger&&h.event.simulate("change",this.parentNode,a,true)});a._change_attached=true}})},handle:function(a){var b=a.target;if(this!==b||a.isSimulated||
a.isTrigger||b.type!=="radio"&&b.type!=="checkbox")return a.handleObj.handler.apply(this,arguments)},teardown:function(){h.event.remove(this,"._change");return K.test(this.nodeName)}});h.support.focusinBubbles||h.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){h.event.simulate(b,a.target,h.event.fix(a),true)};h.event.special[b]={setup:function(){c++===0&&w.addEventListener(a,d,true)},teardown:function(){--c===0&&w.removeEventListener(a,d,true)}}});h.fn.extend({on:function(a,
...
0?this.on(b,null,a,c):this.trigger(b)};h.attrFn&&(h.attrFn[b]=true);if($.test(b))h.event.fixHooks[b]=h.event.keyHooks;if(V.test(b))h.event.fixHooks[b]=h.event.mouseHooks});(function(){function a(b,c,d,k,g,f){for(var g=0,i=k.length;g<i;g++){var j=k[g];if(j){for(var h=false,j=j[b];j;){if(j[e]===d){h=k[j.sizset];break}if(j.nodeType===1&&!f){j[e]=d;j.sizset=g}if(j.nodeName.toLowerCase()===c){h=j;break}j=j[b]}k[g]=h}}}function b(a,c,d,k,g,f){for(var g=0,i=k.length;g<i;g++){var j=k[g];if(j){for(var h=false,
j=j[a];j;){if(j[e]===d){h=k[j.sizset];break}if(j.nodeType===1){if(!f){j[e]=d;j.sizset=g}if(typeof c!=="string"){if(j===c){h=true;break}}else if(t.filter(c,[j]).length>0){h=j;break}}j=j[a]}k[g]=h}}}var d=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,e="sizcache"+(Math.random()+"").replace(".",""),k=0,g=Object.prototype.toString,f=false,i=true,j=/\\/g,v=/\r\n/g,l=/\W/;[0,0].sort(function(){i=false;return 0});var t=
function(a,b,c,e){var c=c||[],k=b=b||w;if(b.nodeType!==1&&b.nodeType!==9)return[];if(!a||typeof a!=="string")return c;var f,i,j,h,v,B=true,l=t.isXML(b),n=[],r=a;do{d.exec("");if(f=d.exec(r)){r=f[3];n.push(f[1]);if(f[2]){h=f[3];break}}}while(f);if(n.length>1&&o.exec(a))if(n.length===2&&m.relative[n[0]])i=x(n[0]+n[1],b,e);else for(i=m.relative[n[0]]?[b]:t(n.shift(),b);n.length;){a=n.shift();m.relative[a]&&(a=a+n.shift());i=x(a,i,e)}else{if(!e&&n.length>1&&b.nodeType===9&&!l&&m.match.ID.test(n[0])&&
!m.match.ID.test(n[n.length-1])){f=t.find(n.shift(),b,l);b=f.expr?t.filter(f.expr,f.set)[0]:f.set[0]}if(b){f=e?{expr:n.pop(),set:s(e)}:t.find(n.pop(),n.length===1&&(n[0]==="~"||n[0]==="+")&&b.parentNode?b.parentNode:b,l);i=f.expr?t.filter(f.expr,f.set):f.set;for(n.length>0?j=s(i):B=false;n.length;){f=v=n.pop();m.relative[v]?f=n.pop():v="";f==null&&(f=b);m.relative[v](j,f,l)}}else j=[]}j||(j=i);j||t.error(v||a);if(g.call(j)==="[object Array]")if(B)if(b&&b.nodeType===1)for(a=0;j[a]!=null;a++)j[a]&&
(j[a]===true||j[a].nodeType===1&&t.contains(b,j[a]))&&c.push(i[a]);else for(a=0;j[a]!=null;a++)j[a]&&j[a].nodeType===1&&c.push(i[a]);else c.push.apply(c,j);else s(j,c);if(h){t(h,k,c,e);t.uniqueSort(c)}return c};t.uniqueSort=function(a){if(P){f=i;a.sort(P);if(f)for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1)}return a};t.matches=function(a,b){return t(a,null,null,b)};t.matchesSelector=function(a,b){return t(b,null,null,[a]).length>0};t.find=function(a,b,c){var d,e,k,g,f,i;if(!a)return[];e=
0;for(k=m.order.length;e<k;e++){f=m.order[e];if(g=m.leftMatch[f].exec(a)){i=g[1];g.splice(1,1);if(i.substr(i.length-1)!=="\\"){g[1]=(g[1]||"").replace(j,"");d=m.find[f](g,b,c);if(d!=null){a=a.replace(m.match[f],"");break}}}}d||(d=typeof b.getElementsByTagName!=="undefined"?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};t.filter=function(a,b,d,e){for(var k,g,f,i,j,h,v,B,l=a,n=[],o=b,r=b&&b[0]&&t.isXML(b[0]);a&&b.length;){for(f in m.filter)if((k=m.leftMatch[f].exec(a))!=null&&k[2]){h=m.filter[f];
j=k[1];g=false;k.splice(1,1);if(j.substr(j.length-1)!=="\\"){o===n&&(n=[]);if(m.preFilter[f])if(k=m.preFilter[f](k,o,d,n,e,r)){if(k===true)continue}else g=i=true;if(k)for(v=0;(j=o[v])!=null;v++)if(j){i=h(j,k,v,o);B=e^i;if(d&&i!=null)B?g=true:o[v]=false;else if(B){n.push(j);g=true}}if(i!==c){d||(o=n);a=a.replace(m.match[f],"");if(!g)return[];break}}}if(a===l)if(g==null)t.error(a);else break;l=a}return o};t.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};var n=t.getText=
function(a){var b,c;b=a.nodeType;var d="";if(b)if(b===1||b===9||b===11){if(typeof a.textContent==="string")return a.textContent;if(typeof a.innerText==="string")return a.innerText.replace(v,"");for(a=a.firstChild;a;a=a.nextSibling)d=d+n(a)}else{if(b===3||b===4)return a.nodeValue}else for(b=0;c=a[b];b++)c.nodeType!==8&&(d=d+n(c));return d},m=t.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,
ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/,TAG:/^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/,CHILD:/:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/,POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/,PSEUDO:/:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/},leftMatch:{},attrMap:{"class":"className","for":"htmlFor"},attrHandle:{href:function(a){return a.getAttribute("href")},
type:function(a){return a.getAttribute("type")}},relative:{"+":function(a,b){var c=typeof b==="string",d=c&&!l.test(b),c=c&&!d;d&&(b=b.toLowerCase());for(var d=0,e=a.length,k;d<e;d++)if(k=a[d]){for(;(k=k.previousSibling)&&k.nodeType!==1;);a[d]=c||k&&k.nodeName.toLowerCase()===b?k||false:k===b}c&&t.filter(b,a,true)},">":function(a,b){var c,d=typeof b==="string",e=0,k=a.length;if(d&&!l.test(b))for(b=b.toLowerCase();e<k;e++){if(c=a[e]){c=c.parentNode;a[e]=c.nodeName.toLowerCase()===b?c:false}}else{for(;e<
k;e++)(c=a[e])&&(a[e]=d?c.parentNode:c.parentNode===b);d&&t.filter(b,a,true)}},"":function(c,d,e){var g,f=k++,i=b;if(typeof d==="string"&&!l.test(d)){g=d=d.toLowerCase();i=a}i("parentNode",d,f,c,g,e)},"~":function(c,d,e){var g,f=k++,i=b;if(typeof d==="string"&&!l.test(d)){g=d=d.toLowerCase();i=a}i("previousSibling",d,f,c,g,e)}},find:{ID:function(a,b,c){if(typeof b.getElementById!=="undefined"&&!c)return(a=b.getElementById(a[1]))&&a.parentNode?[a]:[]},NAME:function(a,b){if(typeof b.getElementsByName!==
...
"")},TAG:function(a){return a[1].replace(j,"").toLowerCase()},CHILD:function(a){if(a[1]==="nth"){a[2]||t.error(a[0]);a[2]=a[2].replace(/^\+|\s*/g,"");var b=/(-?)(\d*)(?:n([+\-]?\d*))?/.exec(a[2]==="even"&&"2n"||a[2]==="odd"&&"2n+1"||!/\D/.test(a[2])&&"0n+"+a[2]||a[2]);a[2]=b[1]+(b[2]||1)-0;a[3]=b[3]-0}else a[2]&&t.error(a[0]);a[0]=k++;return a},ATTR:function(a,b,c,d,e,k){b=a[1]=a[1].replace(j,"");!k&&m.attrMap[b]&&(a[1]=m.attrMap[b]);a[4]=(a[4]||a[5]||"").replace(j,"");a[2]==="~="&&(a[4]=" "+a[4]+
" ");return a},PSEUDO:function(a,b,c,e,k){if(a[1]==="not")if((d.exec(a[3])||"").length>1||/^\w/.test(a[3]))a[3]=t(a[3],null,null,b);else{a=t.filter(a[3],b,c,1^k);c||e.push.apply(e,a);return false}else if(m.match.POS.test(a[0])||m.match.CHILD.test(a[0]))return true;return a},POS:function(a){a.unshift(true);return a}},filters:{enabled:function(a){return a.disabled===false&&a.type!=="hidden"},disabled:function(a){return a.disabled===true},checked:function(a){return a.checked===true},selected:function(a){a.parentNode&&
...
c=t.attr?t.attr(a,c):m.attrHandle[c]?m.attrHandle[c](a):a[c]!=null?a[c]:a.getAttribute(c),d=c+"",e=b[2],k=b[4];return c==null?e==="!=":!e&&t.attr?c!=null:e==="="?d===k:e==="*="?d.indexOf(k)>=0:e==="~="?(" "+d+" ").indexOf(k)>=0:!k?d&&c!==false:e==="!="?d!==k:e==="^="?d.indexOf(k)===0:e==="$="?d.substr(d.length-k.length)===k:e==="|="?d===k||d.substr(0,k.length+1)===k+"-":false},POS:function(a,b,c,d){var e=m.setFilters[b[2]];if(e)return e(a,c,b,d)}}},o=m.match.POS,r=function(a,b){return"\\"+(b-0+1)},
K;for(K in m.match){m.match[K]=RegExp(m.match[K].source+/(?![^\[]*\])(?![^\(]*\))/.source);m.leftMatch[K]=RegExp(/(^(?:.|\r|\n)*?)/.source+m.match[K].source.replace(/\\(\d+)/g,r))}m.match.globalPOS=o;var s=function(a,b){a=Array.prototype.slice.call(a,0);if(b){b.push.apply(b,a);return b}return a};try{Array.prototype.slice.call(w.documentElement.childNodes,0)[0].nodeType}catch(q){s=function(a,b){var c=0,d=b||[];if(g.call(a)==="[object Array]")Array.prototype.push.apply(d,a);else if(typeof a.length===
...
b);if(c){if(!d)return 1}else return-1;for(;g;){e.unshift(g);g=g.parentNode}for(g=d;g;){k.unshift(g);g=g.parentNode}c=e.length;d=k.length;for(g=0;g<c&&g<d;g++)if(e[g]!==k[g])return p(e[g],k[g]);return g===c?p(a,k[g],-1):p(e[g],b,1)};p=function(a,b,c){if(a===b)return c;for(a=a.nextSibling;a;){if(a===b)return-1;a=a.nextSibling}return 1}}(function(){var a=w.createElement("div"),b="script"+(new Date).getTime(),d=w.documentElement;a.innerHTML="<a name='"+b+"'/>";d.insertBefore(a,d.firstChild);if(w.getElementById(b)){m.find.ID=
function(a,b,d){if(typeof b.getElementById!=="undefined"&&!d)return(b=b.getElementById(a[1]))?b.id===a[1]||typeof b.getAttributeNode!=="undefined"&&b.getAttributeNode("id").nodeValue===a[1]?[b]:c:[]};m.filter.ID=function(a,b){var c=typeof a.getAttributeNode!=="undefined"&&a.getAttributeNode("id");return a.nodeType===1&&c&&c.nodeValue===b}}d.removeChild(a);d=a=null})();(function(){var a=w.createElement("div");a.appendChild(w.createComment(""));if(a.getElementsByTagName("*").length>0)m.find.TAG=function(a,
b){var c=b.getElementsByTagName(a[1]);if(a[1]==="*"){for(var d=[],e=0;c[e];e++)c[e].nodeType===1&&d.push(c[e]);c=d}return c};a.innerHTML="<a href='#'></a>";if(a.firstChild&&typeof a.firstChild.getAttribute!=="undefined"&&a.firstChild.getAttribute("href")!=="#")m.attrHandle.href=function(a){return a.getAttribute("href",2)};a=null})();w.querySelectorAll&&function(){var a=t,b=w.createElement("div");b.innerHTML="<p class='TEST'></p>";if(!(b.querySelectorAll&&b.querySelectorAll(".TEST").length===0)){t=
function(b,c,d,e){c=c||w;if(!e&&!t.isXML(c)){var k=/^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(b);if(k&&(c.nodeType===1||c.nodeType===9)){if(k[1])return s(c.getElementsByTagName(b),d);if(k[2]&&m.find.CLASS&&c.getElementsByClassName)return s(c.getElementsByClassName(k[2]),d)}if(c.nodeType===9){if(b==="body"&&c.body)return s([c.body],d);if(k&&k[3]){var g=c.getElementById(k[3]);if(g&&g.parentNode){if(g.id===k[3])return s([g],d)}else return s([],d)}try{return s(c.querySelectorAll(b),d)}catch(f){}}else if(c.nodeType===
1&&c.nodeName.toLowerCase()!=="object"){var k=c,i=(g=c.getAttribute("id"))||"__sizzle__",j=c.parentNode,h=/^\s*[+~]/.test(b);g?i=i.replace(/'/g,"\\$&"):c.setAttribute("id",i);if(h&&j)c=c.parentNode;try{if(!h||j)return s(c.querySelectorAll("[id='"+i+"'] "+b),d)}catch(v){}finally{g||k.removeAttribute("id")}}}return a(b,c,d,e)};for(var c in a)t[c]=a[c];b=null}}();(function(){var a=w.documentElement,b=a.matchesSelector||a.mozMatchesSelector||a.webkitMatchesSelector||a.msMatchesSelector;if(b){var c=!b.call(w.createElement("div"),
"div"),d=false;try{b.call(w.documentElement,"[test!='']:sizzle")}catch(e){d=true}t.matchesSelector=function(a,e){e=e.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!t.isXML(a))try{if(d||!m.match.PSEUDO.test(e)&&!/!=/.test(e)){var k=b.call(a,e);if(k||!c||a.document&&a.document.nodeType!==11)return k}}catch(g){}return t(e,null,null,[a]).length>0}}})();(function(){var a=w.createElement("div");a.innerHTML="<div class='test e'></div><div class='test'></div>";if(a.getElementsByClassName&&a.getElementsByClassName("e").length!==
0){a.lastChild.className="e";if(a.getElementsByClassName("e").length!==1){m.order.splice(1,0,"CLASS");m.find.CLASS=function(a,b,c){if(typeof b.getElementsByClassName!=="undefined"&&!c)return b.getElementsByClassName(a[1])};a=null}}})();t.contains=w.documentElement.contains?function(a,b){return a!==b&&(a.contains?a.contains(b):true)}:w.documentElement.compareDocumentPosition?function(a,b){return!!(a.compareDocumentPosition(b)&16)}:function(){return false};t.isXML=function(a){return(a=(a?a.ownerDocument||
a:0).documentElement)?a.nodeName!=="HTML":false};var x=function(a,b,c){for(var d,e=[],k="",b=b.nodeType?[b]:b;d=m.match.PSEUDO.exec(a);){k=k+d[0];a=a.replace(m.match.PSEUDO,"")}a=m.relative[a]?a+"*":a;d=0;for(var g=b.length;d<g;d++)t(a,b[d],e,c);return t.filter(k,e)};t.attr=h.attr;t.selectors.attrMap={};h.find=t;h.expr=t.selectors;h.expr[":"]=h.expr.filters;h.unique=t.uniqueSort;h.text=t.getText;h.isXMLDoc=t.isXML;h.contains=t.contains})();var ma=/Until$/,na=/^(?:parents|prevUntil|prevAll)/,ka=/,/,
...
"iframe")?a.contentDocument||a.contentWindow.document:h.makeArray(a.childNodes)}},function(a,b){h.fn[a]=function(c,d){var e=h.map(this,b,c);ma.test(a)||(d=c);d&&typeof d==="string"&&(e=h.filter(d,e));e=this.length>1&&!Ya[a]?h.unique(e):e;if((this.length>1||ka.test(d))&&na.test(a))e=e.reverse();return this.pushStack(e,a,Xa.call(arguments).join(","))}});h.extend({filter:function(a,b,c){c&&(a=":not("+a+")");return b.length===1?h.find.matchesSelector(b[0],a)?[b[0]]:[]:h.find.matches(a,b)},dir:function(a,
...
ta=/^\s+/,Ga=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Ha=/<([\w:]+)/,$a=/<tbody/i,ab=/<|&#?\w+;/,bb=/<(?:script|style)/i,cb=/<(?:script|object|embed|option|style)/i,Ia=RegExp("<(?:"+Fa+")[\\s/>]","i"),Ja=/checked\s*(?:[^=]|=\s*.checked.)/i,Ka=/\/(java|ecma)script/i,fb=/^\s*<!(?:\[CDATA\[|\-\-)/,X={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,
"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]},Ba=l(w);X.optgroup=X.option;X.tbody=X.tfoot=X.colgroup=X.caption=X.thead;X.th=X.td;h.support.htmlSerialize||(X._default=[1,"div<div>","</div>"]);h.fn.extend({text:function(a){return h.access(this,function(a){return a===c?h.text(this):this.empty().append((this[0]&&this[0].ownerDocument||w).createTextNode(a))},null,a,arguments.length)},wrapAll:function(a){if(h.isFunction(a))return this.each(function(b){h(this).wrapAll(a.call(this,
...
"string"&&!bb.test(a)&&(h.support.leadingWhitespace||!ta.test(a))&&!X[(Ha.exec(a)||["",""])[1].toLowerCase()]){a=a.replace(Ga,"<$1></$2>");try{for(;d<e;d++){b=this[d]||{};if(b.nodeType===1){h.cleanData(b.getElementsByTagName("*"));b.innerHTML=a}}b=0}catch(k){}}b&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){if(this[0]&&this[0].parentNode){if(h.isFunction(a))return this.each(function(b){var c=h(this),d=c.html();c.replaceWith(a.call(this,b,d))});typeof a!=="string"&&(a=
h(a).detach());return this.each(function(){var b=this.nextSibling,c=this.parentNode;h(this).remove();b?h(b).before(a):h(c).append(a)})}return this.length?this.pushStack(h(h.isFunction(a)?a():a),"replaceWith",a):this},detach:function(a){return this.remove(a,true)},domManip:function(a,b,d){var e,k,g,f=a[0],i=[];if(!h.support.checkClone&&arguments.length===3&&typeof f==="string"&&Ja.test(f))return this.each(function(){h(this).domManip(a,b,d,true)});if(h.isFunction(f))return this.each(function(e){var k=
h(this);a[0]=f.call(this,e,b?k.html():c);k.domManip(a,b,d)});if(this[0]){e=f&&f.parentNode;e=h.support.parentNode&&e&&e.nodeType===11&&e.childNodes.length===this.length?{fragment:e}:h.buildFragment(a,this,i);g=e.fragment;if(k=g.childNodes.length===1?g=g.firstChild:g.firstChild){b=b&&h.nodeName(k,"tr");k=0;for(var j=this.length,v=j-1;k<j;k++)d.call(b?h.nodeName(this[k],"table")?this[k].getElementsByTagName("tbody")[0]||this[k].appendChild(this[k].ownerDocument.createElement("tbody")):this[k]:this[k],
e.cacheable||j>1&&k<v?h.clone(g,true,true):g)}i.length&&h.each(i,function(a,b){b.src?h.ajax({type:"GET",global:false,url:b.src,async:false,dataType:"script"}):h.globalEval((b.text||b.textContent||b.innerHTML||"").replace(fb,"/*$0*/"));b.parentNode&&b.parentNode.removeChild(b)})}return this}});h.buildFragment=function(a,b,c){var d,e,k,g,f=a[0];b&&b[0]&&(g=b[0].ownerDocument||b[0]);g.createDocumentFragment||(g=w);if(a.length===1&&typeof f==="string"&&f.length<512&&g===w&&f.charAt(0)==="<"&&!cb.test(f)&&
(h.support.checkClone||!Ja.test(f))&&(h.support.html5Clone||!Ia.test(f))){e=true;(k=h.fragments[f])&&k!==1&&(d=k)}if(!d){d=g.createDocumentFragment();h.clean(a,g,d,c)}e&&(h.fragments[f]=k?d:1);return{fragment:d,cacheable:e}};h.fragments={};h.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){h.fn[a]=function(c){var d=[],c=h(c),e=this.length===1&&this[0].parentNode;if(e&&e.nodeType===11&&e.childNodes.length===1&&c.length===
1){c[b](this[0]);return this}for(var e=0,k=c.length;e<k;e++){var g=(e>0?this.clone(true):this).get();h(c[e])[b](g);d=d.concat(g)}return this.pushStack(d,a,c.selector)}});h.extend({clone:function(a,b,c){var d,e,k;if(h.support.html5Clone||h.isXMLDoc(a)||!Ia.test("<"+a.nodeName+">"))d=a.cloneNode(true);else{d=w.createElement("div");Ba.appendChild(d);d.innerHTML=a.outerHTML;d=d.firstChild}var g=d;if((!h.support.noCloneEvent||!h.support.noCloneChecked)&&(a.nodeType===1||a.nodeType===11)&&!h.isXMLDoc(a)){m(a,
g);d=n(a);e=n(g);for(k=0;d[k];++k)e[k]&&m(d[k],e[k])}if(b){o(a,g);if(c){d=n(a);e=n(g);for(k=0;d[k];++k)o(d[k],e[k])}}return g},clean:function(a,b,c,d){var e,k=[],b=b||w;typeof b.createElement==="undefined"&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||w);for(var g=0,f;(f=a[g])!=null;g++){typeof f==="number"&&(f=f+"");if(f){if(typeof f==="string")if(ab.test(f)){f=f.replace(Ga,"<$1></$2>");e=(Ha.exec(f)||["",""])[1].toLowerCase();var i=X[e]||X._default,j=i[0],v=b.createElement("div"),t=Ba.childNodes;
b===w?Ba.appendChild(v):l(b).appendChild(v);for(v.innerHTML=i[1]+f+i[2];j--;)v=v.lastChild;if(!h.support.tbody){j=$a.test(f);i=e==="table"&&!j?v.firstChild&&v.firstChild.childNodes:i[1]==="<table>"&&!j?v.childNodes:[];for(e=i.length-1;e>=0;--e)h.nodeName(i[e],"tbody")&&!i[e].childNodes.length&&i[e].parentNode.removeChild(i[e])}!h.support.leadingWhitespace&&ta.test(f)&&v.insertBefore(b.createTextNode(ta.exec(f)[0]),v.firstChild);f=v.childNodes;if(v){v.parentNode.removeChild(v);if(t.length>0)(v=t[t.length-
1])&&v.parentNode&&v.parentNode.removeChild(v)}}else f=b.createTextNode(f);var n;if(!h.support.appendChecked)if(f[0]&&typeof(n=f.length)==="number")for(e=0;e<n;e++)s(f[e]);else s(f);f.nodeType?k.push(f):k=h.merge(k,f)}}if(c){a=function(a){return!a.type||Ka.test(a.type)};for(g=0;k[g];g++){b=k[g];if(d&&h.nodeName(b,"script")&&(!b.type||Ka.test(b.type)))d.push(b.parentNode?b.parentNode.removeChild(b):b);else{if(b.nodeType===1){f=h.grep(b.getElementsByTagName("script"),a);k.splice.apply(k,[g+1,0].concat(f))}c.appendChild(b)}}}return k},
cleanData:function(a){for(var b,c,d=h.cache,e=h.event.special,k=h.support.deleteExpando,g=0,f;(f=a[g])!=null;g++)if(!f.nodeName||!h.noData[f.nodeName.toLowerCase()])if(c=f[h.expando]){if((b=d[c])&&b.events){for(var i in b.events)e[i]?h.event.remove(f,i):h.removeEvent(f,i,b.handle);if(b.handle)b.handle.elem=null}k?delete f[h.expando]:f.removeAttribute&&f.removeAttribute(h.expando);delete d[c]}}});var Ca=/alpha\([^)]*\)/i,gb=/opacity=([^)]*)/,hb=/([A-Z]|^ms)/g,ib=/^[\-+]?(?:\d*\.)?\d+$/i,wa=/^-?(?:\d*\.)?\d+(?!px)[^\d\s]+$/i,
jb=/^([\-+])=([\-+.\de]+)/,kb=/^margin/,lb={position:"absolute",visibility:"hidden",display:"block"},ba=["Top","Right","Bottom","Left"],ea,Ma,Na;h.fn.css=function(a,b){return h.access(this,function(a,b,d){return d!==c?h.style(a,b,d):h.css(a,b)},a,b,arguments.length>1)};h.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=ea(a,"opacity");return c===""?"1":c}return a.style.opacity}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":h.support.cssFloat?
...
k,b=h.camelCase(b);k=h.cssHooks[b];b=h.cssProps[b]||b;b==="cssFloat"&&(b="float");if(k&&"get"in k&&(e=k.get(a,true,d))!==c)return e;if(ea)return ea(a,b)},swap:function(a,b,c){var d={},e;for(e in b){d[e]=a.style[e];a.style[e]=b[e]}c=c.call(a);for(e in b)a.style[e]=d[e];return c}});h.curCSS=h.css;w.defaultView&&w.defaultView.getComputedStyle&&(Ma=function(a,b){var c,d,e,k=a.style,b=b.replace(hb,"-$1").toLowerCase();if((d=a.ownerDocument.defaultView)&&(e=d.getComputedStyle(a,null))){c=e.getPropertyValue(b);
c===""&&!h.contains(a.ownerDocument.documentElement,a)&&(c=h.style(a,b))}if(!h.support.pixelMargin&&e&&kb.test(b)&&wa.test(c)){d=k.width;k.width=c;c=e.width;k.width=d}return c});w.documentElement.currentStyle&&(Na=function(a,b){var c,d,e=a.currentStyle&&a.currentStyle[b],k=a.style;if(e==null&&k&&(c=k[b]))e=c;if(wa.test(e)){c=k.left;if(d=a.runtimeStyle&&a.runtimeStyle.left)a.runtimeStyle.left=a.currentStyle.left;k.left=b==="fontSize"?"1em":e;e=k.pixelLeft+"px";k.left=c;if(d)a.runtimeStyle.left=d}return e===
""?"auto":e});ea=Ma||Na;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){if(c)return a.offsetWidth!==0?q(a,b,d):h.swap(a,lb,function(){return q(a,b,d)})},set:function(a,b){return ib.test(b)?b+"px":b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return gb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,e=h.isNumeric(b)?"alpha(opacity="+b*100+")":"",k=
d&&d.filter||c.filter||"";c.zoom=1;if(b>=1&&h.trim(k.replace(Ca,""))===""){c.removeAttribute("filter");if(d&&!d.filter)return}c.filter=Ca.test(k)?k.replace(Ca,e):k+" "+e}});h(function(){if(!h.support.reliableMarginRight)h.cssHooks.marginRight={get:function(a,b){return h.swap(a,{display:"inline-block"},function(){return b?ea(a,"margin-right"):a.style.marginRight})}}});h.expr&&h.expr.filters&&(h.expr.filters.hidden=function(a){var b=a.offsetHeight;return a.offsetWidth===0&&b===0||!h.support.reliableHiddenOffsets&&
(a.style&&a.style.display||h.css(a,"display"))==="none"},h.expr.filters.visible=function(a){return!h.expr.filters.hidden(a)});h.each({margin:"",padding:"",border:"Width"},function(a,b){h.cssHooks[a+b]={expand:function(c){for(var d=typeof c==="string"?c.split(" "):[c],e={},c=0;c<4;c++)e[a+ba[c]+b]=d[c]||d[c-2]||d[0];return e}}});var mb=/%20/g,db=/\[\]$/,Oa=/\r?\n/g,nb=/#.*$/,ob=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,pb=/^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
qb=/^(?:GET|HEAD)$/,rb=/^\/\//,Pa=/\?/,sb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,tb=/^(?:select|textarea)/i,La=/\s+/,ub=/([?&])_=[^&]*/,Qa=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Ra=h.fn.load,xa={},Sa={},ca,da,Ta=["*/"]+["*"];try{ca=I.href}catch(Ab){ca=w.createElement("a"),ca.href="",ca=ca.href}da=Qa.exec(ca.toLowerCase())||[];h.fn.extend({load:function(a,b,d){if(typeof a!=="string"&&Ra)return Ra.apply(this,arguments);if(!this.length)return this;var e=a.indexOf(" ");if(e>=
0)var k=a.slice(e,a.length),a=a.slice(0,e);e="GET";if(b)if(h.isFunction(b)){d=b;b=c}else if(typeof b==="object"){b=h.param(b,h.ajaxSettings.traditional);e="POST"}var g=this;h.ajax({url:a,type:e,dataType:"html",data:b,complete:function(a,b,c){c=a.responseText;if(a.isResolved()){a.done(function(a){c=a});g.html(k?h("<div>").append(c.replace(sb,"")).find(k):c)}d&&g.each(d,[c,b,a])}});return this},serialize:function(){return h.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?
...
function(a,b){h[b]=function(a,d,e,k){if(h.isFunction(d)){k=k||e;e=d;d=c}return h.ajax({type:b,url:a,data:d,success:e,dataType:k})}});h.extend({getScript:function(a,b){return h.get(a,c,b,"script")},getJSON:function(a,b,c){return h.get(a,b,c,"json")},ajaxSetup:function(a,b){if(b)x(a,h.ajaxSettings);else{b=a;a=h.ajaxSettings}x(a,b);return a},ajaxSettings:{url:ca,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/.test(da[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",
processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Ta},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:p(xa),ajaxTransport:p(Sa),ajax:function(a,b){function d(a,b,t,l){if(s!==2){s=2;r&&clearTimeout(r);o=c;n=l||"";p.readyState=
a>0?4:0;var m,K,B,l=b;if(t){var P=e,x=p,va=P.contents,R=P.dataTypes,z=P.responseFields,u,w,aa,y;for(w in z)w in t&&(x[z[w]]=t[w]);for(;R[0]==="*";){R.shift();u===c&&(u=P.mimeType||x.getResponseHeader("content-type"))}if(u)for(w in va)if(va[w]&&va[w].test(u)){R.unshift(w);break}if(R[0]in t)aa=R[0];else{for(w in t){if(!R[0]||P.converters[w+" "+R[0]]){aa=w;break}y||(y=w)}aa=aa||y}if(aa){aa!==R[0]&&R.unshift(aa);t=t[aa]}else t=void 0}else t=c;if(a>=200&&a<300||a===304){if(e.ifModified){if(u=p.getResponseHeader("Last-Modified"))h.lastModified[v]=
u;if(u=p.getResponseHeader("Etag"))h.etag[v]=u}if(a===304){l="notmodified";m=true}else try{u=e;u.dataFilter&&(t=u.dataFilter(t,u.dataType));var $=u.dataTypes;w={};var A,E,G=$.length,D,V=$[0],C,F,I,H,J;for(A=1;A<G;A++){if(A===1)for(E in u.converters)typeof E==="string"&&(w[E.toLowerCase()]=u.converters[E]);C=V;V=$[A];if(V==="*")V=C;else if(C!=="*"&&C!==V){F=C+" "+V;I=w[F]||w["* "+V];if(!I){J=c;for(H in w){D=H.split(" ");if(D[0]===C||D[0]==="*")if(J=w[D[1]+" "+V]){H=w[H];H===true?I=J:J===true&&(I=H);
break}}}!I&&!J&&h.error("No conversion from "+F.replace(" "," to "));I!==true&&(t=I?I(t):J(H(t)))}}K=t;l="success";m=true}catch(N){l="parsererror";B=N}}else{B=l;if(!l||a){l="error";a<0&&(a=0)}}p.status=a;p.statusText=""+(b||l);m?f.resolveWith(k,[K,l,p]):f.rejectWith(k,[p,l,B]);p.statusCode(j);j=c;q&&g.trigger("ajax"+(m?"Success":"Error"),[p,e,m?K:B]);i.fireWith(k,[p,l]);if(q){g.trigger("ajaxComplete",[p,e]);--h.active||h.event.trigger("ajaxStop")}}}if(typeof a==="object"){b=a;a=c}var b=b||{},e=h.ajaxSetup({},
b),k=e.context||e,g=k!==e&&(k.nodeType||k instanceof h)?h(k):h.event,f=h.Deferred(),i=h.Callbacks("once memory"),j=e.statusCode||{},v,t={},l={},n,m,o,r,K,s=0,q,P,p={readyState:0,setRequestHeader:function(a,b){if(!s){var c=a.toLowerCase(),a=l[c]=l[c]||a;t[a]=b}return this},getAllResponseHeaders:function(){return s===2?n:null},getResponseHeader:function(a){var b;if(s===2){if(!m)for(m={};b=ob.exec(n);)m[b[1].toLowerCase()]=b[2];b=m[a.toLowerCase()]}return b===c?null:b},overrideMimeType:function(a){if(!s)e.mimeType=
a;return this},abort:function(a){a=a||"abort";o&&o.abort(a);d(0,a);return this}};f.promise(p);p.success=p.done;p.error=p.fail;p.complete=i.add;p.statusCode=function(a){if(a){var b;if(s<2)for(b in a)j[b]=[j[b],a[b]];else{b=a[p.status];p.then(b,b)}}return this};e.url=((a||e.url)+"").replace(nb,"").replace(rb,da[1]+"//");e.dataTypes=h.trim(e.dataType||"*").toLowerCase().split(La);if(e.crossDomain==null){K=Qa.exec(e.url.toLowerCase());e.crossDomain=!(!K||!(K[1]!=da[1]||K[2]!=da[2]||(K[3]||(K[1]==="http:"?
80:443))!=(da[3]||(da[1]==="http:"?80:443))))}if(e.data&&e.processData&&typeof e.data!=="string")e.data=h.param(e.data,e.traditional);z(xa,e,b,p);if(s===2)return false;q=e.global;e.type=e.type.toUpperCase();e.hasContent=!qb.test(e.type);q&&h.active++===0&&h.event.trigger("ajaxStart");if(!e.hasContent){if(e.data){e.url=e.url+((Pa.test(e.url)?"&":"?")+e.data);delete e.data}v=e.url;if(e.cache===false){K=h.now();var x=e.url.replace(ub,"$1_="+K);e.url=x+(x===e.url?(Pa.test(e.url)?"&":"?")+"_="+K:"")}}(e.data&&
e.hasContent&&e.contentType!==false||b.contentType)&&p.setRequestHeader("Content-Type",e.contentType);if(e.ifModified){v=v||e.url;h.lastModified[v]&&p.setRequestHeader("If-Modified-Since",h.lastModified[v]);h.etag[v]&&p.setRequestHeader("If-None-Match",h.etag[v])}p.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+(e.dataTypes[0]!=="*"?", "+Ta+"; q=0.01":""):e.accepts["*"]);for(P in e.headers)p.setRequestHeader(P,e.headers[P]);if(e.beforeSend&&(e.beforeSend.call(k,
p,e)===false||s===2)){p.abort();return false}for(P in{success:1,error:1,complete:1})p[P](e[P]);if(o=z(Sa,e,b,p)){p.readyState=1;q&&g.trigger("ajaxSend",[p,e]);e.async&&e.timeout>0&&(r=setTimeout(function(){p.abort("timeout")},e.timeout));try{s=1;o.send(t,d)}catch(R){if(s<2)d(-1,R);else throw R;}}else d(-1,"No Transport");return p},param:function(a,b){var d=[],e=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(b===c)b=h.ajaxSettings.traditional;
if(h.isArray(a)||a.jquery&&!h.isPlainObject(a))h.each(a,function(){e(this.name,this.value)});else for(var k in a)y(k,a[k],b,e);return d.join("&").replace(mb,"+")}});h.extend({active:0,lastModified:{},etag:{}});var vb=h.now(),ra=/(\=)\?(&|$)|\?\?/i;h.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return h.expando+"_"+vb++}});h.ajaxPrefilter("json jsonp",function(b,c,d){c=typeof b.data==="string"&&/^application\/x\-www\-form\-urlencoded/.test(b.contentType);if(b.dataTypes[0]==="jsonp"||b.jsonp!==
...
"json";return"script"}});h.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/javascript|ecmascript/},converters:{"text script":function(a){h.globalEval(a);return a}}});h.ajaxPrefilter("script",function(a){if(a.cache===c)a.cache=false;if(a.crossDomain){a.type="GET";a.global=false}});h.ajaxTransport("script",function(a){if(a.crossDomain){var b,d=w.head||w.getElementsByTagName("head")[0]||w.documentElement;return{send:function(e,
k){b=w.createElement("script");b.async="async";if(a.scriptCharset)b.charset=a.scriptCharset;b.src=a.url;b.onload=b.onreadystatechange=function(a,e){if(e||!b.readyState||/loaded|complete/.test(b.readyState)){b.onload=b.onreadystatechange=null;d&&b.parentNode&&d.removeChild(b);b=c;e||k(200,"success")}};d.insertBefore(b,d.firstChild)},abort:function(){if(b)b.onload(0,1)}}}});var Da=a.ActiveXObject?function(){for(var a in ha)ha[a](0,1)}:!1,wb=0,ha;h.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=
...
g.overrideMimeType(b.mimeType);!b.crossDomain&&!e["X-Requested-With"]&&(e["X-Requested-With"]="XMLHttpRequest");try{for(i in e)g.setRequestHeader(i,e[i])}catch(j){}g.send(b.hasContent&&b.data||null);d=function(a,e){var i,j,v,t,l;try{if(d&&(e||g.readyState===4)){d=c;if(f){g.onreadystatechange=h.noop;Da&&delete ha[f]}if(e)g.readyState!==4&&g.abort();else{i=g.status;v=g.getAllResponseHeaders();t={};if((l=g.responseXML)&&l.documentElement)t.xml=l;try{t.text=g.responseText}catch(n){}try{j=g.statusText}catch(m){j=
""}!i&&b.isLocal&&!b.crossDomain?i=t.text?200:404:i===1223&&(i=204)}}}catch(o){e||k(-1,o)}t&&k(i,j,t,v)};if(!b.async||g.readyState===4)d();else{f=++wb;if(Da){if(!ha){ha={};h(a).unload(Da)}ha[f]=d}g.onreadystatechange=d}},abort:function(){d&&d(0,1)}}}});var ya={},Z,fa,xb=/^(?:toggle|show|hide)$/,yb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,sa,pa=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],oa;h.fn.extend({show:function(a,
b,c){if(a||a===0)return this.animate(G("show",3),a,b,c);for(var c=0,d=this.length;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(!h._data(a,"olddisplay")&&b==="none")b=a.style.display="";(b===""&&h.css(a,"display")==="none"||!h.contains(a.ownerDocument.documentElement,a))&&h._data(a,"olddisplay",O(a.nodeName))}}for(c=0;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(b===""||b==="none")a.style.display=h._data(a,"olddisplay")||""}}return this},hide:function(a,b,c){if(a||a===0)return this.animate(G("hide",
...
fadeTo:function(a,b,c,d){return this.filter(":hidden").css("opacity",0).show().end().animate({opacity:b},a,c,d)},animate:function(a,b,c,d){function e(){k.queue===false&&h._mark(this);var b=h.extend({},k),c=this.nodeType===1,d=c&&h(this).is(":hidden"),g,f,i,j,v;b.animatedProperties={};for(i in a){g=h.camelCase(i);if(i!==g){a[g]=a[i];delete a[i]}if((f=h.cssHooks[g])&&"expand"in f){j=f.expand(a[g]);delete a[g];for(i in j)i in a||(a[i]=j[i])}}for(g in a){f=a[g];if(h.isArray(f)){b.animatedProperties[g]=
...
for(i in a){c=new h.fx(this,b,i);f=a[i];if(xb.test(f))if(g=h._data(this,"toggle"+i)||(f==="toggle"?d?"show":"hide":0)){h._data(this,"toggle"+i,g==="show"?"hide":"show");c[g]()}else c[f]();else{g=yb.exec(f);j=c.cur();if(g){f=parseFloat(g[2]);v=g[3]||(h.cssNumber[i]?"":"px");if(v!=="px"){h.style(this,i,(f||1)+v);j=(f||1)/c.cur()*j;h.style(this,i,j+v)}g[1]&&(f=(g[1]==="-="?-1:1)*f+j);c.custom(j,f,v)}else c.custom(j,f,"")}}return true}var k=h.speed(b,c,d);if(h.isEmptyObject(a))return this.each(k.complete,
...
this&&(a==null||e[b].queue===a)){if(d)e[b](true);else e[b].saveState();c=true;e.splice(b,1)}(!d||!c)&&h.dequeue(this,a)})}});h.each({slideDown:G("show",1),slideUp:G("hide",1),slideToggle:G("toggle",1),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){h.fn[a]=function(a,c,d){return this.animate(b,a,c,d)}});h.extend({speed:function(a,b,c){var d=a&&typeof a==="object"?h.extend({},a):{complete:c||!c&&b||h.isFunction(a)&&a,duration:a,easing:c&&b||b&&!h.isFunction(b)&&
...
f=d.offset.left,b=f+e.helperProportions.width,j=d.offset.top,l=j+e.helperProportions.height,o=e.snapElements.length-1;0<=o;o--){var m=e.snapElements[o].left,n=m+e.snapElements[o].width,r=e.snapElements[o].top,s=r+e.snapElements[o].height;if(m-i<f&&f<n+i&&r-i<j&&j<s+i||m-i<f&&f<n+i&&r-i<l&&l<s+i||m-i<b&&b<n+i&&r-i<j&&j<s+i||m-i<b&&b<n+i&&r-i<l&&l<s+i){if("inner"!=g.snapMode){var q=Math.abs(r-l)<=i,p=Math.abs(s-j)<=i,z=Math.abs(m-b)<=i,x=Math.abs(n-f)<=i;q&&(d.position.top=e._convertPositionTo("relative",
{top:r-e.helperProportions.height,left:0}).top-e.margins.top);p&&(d.position.top=e._convertPositionTo("relative",{top:s,left:0}).top-e.margins.top);z&&(d.position.left=e._convertPositionTo("relative",{top:0,left:m-e.helperProportions.width}).left-e.margins.left);x&&(d.position.left=e._convertPositionTo("relative",{top:0,left:n}).left-e.margins.left)}var y=q||p||z||x;if("outer"!=g.snapMode&&(q=Math.abs(r-j)<=i,p=Math.abs(s-l)<=i,z=Math.abs(m-f)<=i,x=Math.abs(n-b)<=i,q&&(d.position.top=e._convertPositionTo("relative",
{top:r,left:0}).top-e.margins.top),p&&(d.position.top=e._convertPositionTo("relative",{top:s-e.helperProportions.height,left:0}).top-e.margins.top),z&&(d.position.left=e._convertPositionTo("relative",{top:0,left:m}).left-e.margins.left),x))d.position.left=e._convertPositionTo("relative",{top:0,left:n-e.helperProportions.width}).left-e.margins.left;!e.snapElements[o].snapping&&(q||p||z||x||y)&&e.options.snap.snap&&e.options.snap.snap.call(e.element,c,a.extend(e._uiHash(),{snapItem:e.snapElements[o].item}));
...
this._vBoundaries,i=this.axis,f=d(a.width)&&c.maxWidth&&c.maxWidth<a.width,b=d(a.height)&&c.maxHeight&&c.maxHeight<a.height,j=d(a.width)&&c.minWidth&&c.minWidth>a.width,l=d(a.height)&&c.minHeight&&c.minHeight>a.height;j&&(a.width=c.minWidth);l&&(a.height=c.minHeight);f&&(a.width=c.maxWidth);b&&(a.height=c.maxHeight);var o=this.originalPosition.left+this.originalSize.width,m=this.position.top+this.size.height,n=/sw|nw|w/.test(i),i=/nw|ne|n/.test(i);j&&n&&(a.left=o-c.minWidth);f&&n&&(a.left=o-c.maxWidth);
l&&i&&(a.top=m-c.minHeight);b&&i&&(a.top=m-c.maxHeight);(c=!a.width&&!a.height)&&!a.left&&a.top?a.top=null:c&&!a.top&&a.left&&(a.left=null);return a},_proportionallyResize:function(){if(this._proportionallyResizeElements.length)for(var c=this.helper||this.element,d=0;d<this._proportionallyResizeElements.length;d++){var i=this._proportionallyResizeElements[d];if(!this.borderDif){var f=[i.css("borderTopWidth"),i.css("borderRightWidth"),i.css("borderBottomWidth"),i.css("borderLeftWidth")],b=[i.css("paddingTop"),
...
" ",z=g(e.call(this)),x,y=j.attr("class")||"";a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});x=g(e.call(this));j.attr("class",y);j.animate(i(z,x),{queue:false,duration:c,easing:d,complete:function(){a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});if(typeof j.attr("style")=="object"){j.attr("style").cssText="";j.attr("style").cssText=o}else j.attr("style",o);f&&f.apply(this,arguments);a.dequeue(this)}})})};a.fn.extend({_addClass:a.fn.addClass,addClass:function(b,c,d,e){return c?a.effects.animateClass.apply(this,
...
3);"show"==g&&d.css("opacity",0).css(l,"pos"==i?-f:f);"hide"==g&&(f/=2*b);"hide"!=g&&b--;if("show"==g){var o={opacity:1};o[l]=("pos"==i?"+=":"-=")+f;d.animate(o,j/2,c.options.easing);f/=2;b--}for(o=0;o<b;o++){var m={},n={};m[l]=("pos"==i?"-=":"+=")+f;n[l]=("pos"==i?"+=":"-=")+f;d.animate(m,j/2,c.options.easing).animate(n,j/2,c.options.easing);f="hide"==g?2*f:f/2}"hide"==g?(o={opacity:0},o[l]=("pos"==i?"-=":"+=")+f,d.animate(o,j/2,c.options.easing,function(){d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);
c.callback&&c.callback.apply(this,arguments)})):(m={},n={},m[l]=("pos"==i?"-=":"+=")+f,n[l]=("pos"==i?"+=":"-=")+f,d.animate(m,j/2,c.options.easing).animate(n,j/2,c.options.easing,function(){a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)}));d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(jQuery);
...
(function(a){a.effects.fold=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],g=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.size||15,f=!!c.options.horizFirst,b=c.duration?c.duration/2:a.fx.speeds._default/2;a.effects.save(d,e);d.show();var j=a.effects.createWrapper(d).css({overflow:"hidden"}),l="show"==g!=f,o=l?["width","height"]:["height","width"],l=l?[j.width(),j.height()]:[j.height(),j.width()],m=/([0-9]+)%/.exec(i);m&&(i=parseInt(m[1],
10)/100*l["hide"==g?0:1]);"show"==g&&j.css(f?{height:0,width:i}:{height:i,width:0});f={};m={};f[o[0]]="show"==g?l[0]:i;m[o[1]]="show"==g?l[1]:0;j.animate(f,b,c.options.easing).animate(m,b,c.options.easing,function(){"hide"==g&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
...
c.options.mode||"effect"),o=c.options.restore||!1,m=c.options.scale||"both",n=c.options.origin,r={height:d.height(),width:d.width()};d.from=c.options.from||r;d.to=c.options.to||r;n&&(n=a.effects.getBaseline(n,r),d.from.top=(r.height-d.from.height)*n.y,d.from.left=(r.width-d.from.width)*n.x,d.to.top=(r.height-d.to.height)*n.y,d.to.left=(r.width-d.to.width)*n.x);var s=d.from.height/r.height,q=d.from.width/r.width,p=d.to.height/r.height,z=d.to.width/r.width;if("box"==m||"both"==m)if(s!=p&&(e=e.concat(b),
d.from=a.effects.setTransition(d,b,s,d.from),d.to=a.effects.setTransition(d,b,p,d.to)),q!=z)e=e.concat(j),d.from=a.effects.setTransition(d,j,q,d.from),d.to=a.effects.setTransition(d,j,z,d.to);if(("content"==m||"both"==m)&&s!=p)e=e.concat(f),d.from=a.effects.setTransition(d,f,s,d.from),d.to=a.effects.setTransition(d,f,p,d.to);a.effects.save(d,o?e:g);d.show();a.effects.createWrapper(d);d.css("overflow","hidden").css(d.from);if("content"==m||"both"==m)b=b.concat(["marginTop","marginBottom"]).concat(f),
j=j.concat(["marginLeft","marginRight"]),i=e.concat(b).concat(j),d.find("*[width]").each(function(){var d=a(this);o&&a.effects.save(d,i);var e=d.height(),f=d.width();d.from={height:e*s,width:f*q};d.to={height:e*p,width:f*z};if(s!=p){d.from=a.effects.setTransition(d,b,s,d.from);d.to=a.effects.setTransition(d,b,p,d.to)}if(q!=z){d.from=a.effects.setTransition(d,j,q,d.from);d.to=a.effects.setTransition(d,j,z,d.to)}d.css(d.from);d.animate(d.to,c.duration,c.options.easing,function(){o&&a.effects.restore(d,
...
(function(a){a.effects.shake=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"];a.effects.setMode(d,c.options.mode||"effect");var g=c.options.direction||"left",i=c.options.distance||20,f=c.options.times||3,b=c.duration||c.options.duration||140;a.effects.save(d,e);d.show();a.effects.createWrapper(d);var j="up"==g||"down"==g?"top":"left",l="up"==g||"left"==g?"pos":"neg",g={},o={},m={};g[j]=("pos"==l?"-=":"+=")+i;o[j]=("pos"==l?"+=":"-=")+2*i;m[j]=("pos"==
l?"-=":"+=")+2*i;d.animate(g,b,c.options.easing);for(i=1;i<f;i++)d.animate(o,b,c.options.easing).animate(m,b,c.options.easing);d.animate(o,b,c.options.easing).animate(g,b/2,c.options.easing,function(){a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)});d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(jQuery);
...
(i={},i[d]=e);if(f){this._curInst==f&&this._hideDatepicker();var n=this._getDateDatepicker(b,!0),r=this._getMinMaxDate(f,"min"),s=this._getMinMaxDate(f,"max");g(f.settings,i);null!==r&&i.dateFormat!==c&&i.minDate===c&&(f.settings.minDate=this._formatDate(f,r));null!==s&&i.dateFormat!==c&&i.maxDate===c&&(f.settings.maxDate=this._formatDate(f,s));this._attachments(a(b),f);this._autoSize(f);this._setDate(f,n);this._updateAlternate(f);this._updateDatepicker(f)}},_changeDatepicker:function(a,c,d){this._optionDatepicker(a,
...
e="string"!=typeof e?e:(new Date).getFullYear()%100+parseInt(e,10),f=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,g=(d?d.dayNames:null)||this._defaults.dayNames,i=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,s=(d?d.monthNames:null)||this._defaults.monthNames,q=d=-1,p=-1,z=-1,x=!1,y=function(a){(a=O+1<b.length&&b.charAt(O+1)==a)&&O++;return a},E=function(a){var b=y(a),a=c.substring(G).match(RegExp("^\\d{1,"+("@"==a?14:"!"==a?20:"y"==a&&b?4:"o"==a?3:2)+"}"));if(!a)throw"Missing number at position "+
G;G+=a[0].length;return parseInt(a[0],10)},A=function(b,d,e){var b=a.map(y(b)?e:d,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)}),f=-1;a.each(b,function(a,b){var d=b[1];if(c.substr(G,d.length).toLowerCase()==d.toLowerCase())return f=b[0],G+=d.length,!1});if(-1!=f)return f+1;throw"Unknown name at position "+G;},D=function(){if(c.charAt(G)!=b.charAt(O))throw"Unexpected literal at position "+G;G++},G=0,O=0;O<b.length;O++)if(x)"'"==b.charAt(O)&&!y("'")?x=!1:D();else switch(b.charAt(O)){case "d":p=
E("d");break;case "D":A("D",f,g);break;case "o":z=E("o");break;case "m":q=E("m");break;case "M":q=A("M",i,s);break;case "y":d=E("y");break;case "@":var C=new Date(E("@")),d=C.getFullYear(),q=C.getMonth()+1,p=C.getDate();break;case "!":C=new Date((E("!")-this._ticksTo1970)/1E4);d=C.getFullYear();q=C.getMonth()+1;p=C.getDate();break;case "'":y("'")?D():x=!0;break;default:D()}if(G<c.length)throw"Extra/unparsed characters found in date: "+c.substring(G);-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-
...
g=this._get(b,"navigationAsDateFormat"),r=this._getNumberOfMonths(b),s=this._get(b,"showCurrentAtPos"),q=this._get(b,"stepMonths"),p=1!=r[0]||1!=r[1],z=this._daylightSavingAdjust(!b.currentDay?new Date(9999,9,9):new Date(b.currentYear,b.currentMonth,b.currentDay)),x=this._getMinMaxDate(b,"min"),y=this._getMinMaxDate(b,"max"),s=b.drawMonth-s,E=b.drawYear;0>s&&(s+=12,E--);if(y)for(var A=this._daylightSavingAdjust(new Date(y.getFullYear(),y.getMonth()-r[0]*r[1]+1,y.getDate())),A=x&&A<x?x:A;this._daylightSavingAdjust(new Date(E,
s,1))>A;)s--,0>s&&(s=11,E--);b.drawMonth=s;b.drawYear=E;var A=this._get(b,"prevText"),A=!g?A:this.formatDate(A,this._daylightSavingAdjust(new Date(E,s-q,1)),this._getFormatConfig(b)),A=this._canAdjustMonth(b,-1,E,s)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', -"+q+", 'M');\" title=\""+A+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+A+"</span></a>":f?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+
A+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+A+"</span></a>",D=this._get(b,"nextText"),D=!g?D:this.formatDate(D,this._daylightSavingAdjust(new Date(E,s+q,1)),this._getFormatConfig(b)),f=this._canAdjustMonth(b,1,E,s)?'<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', +"+q+", 'M');\" title=\""+D+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+D+"</span></a>":f?"":'<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+
D+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+D+"</span></a>",q=this._get(b,"currentText"),D=this._get(b,"gotoCurrent")&&b.currentDay?z:c,q=!g?q:this.formatDate(q,D,this._getFormatConfig(b)),g=!b.inline?'<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_'+i+'.datepicker._hideDatepicker();">'+this._get(b,"closeText")+"</button>":"",e=e?'<div class="ui-datepicker-buttonpane ui-widget-content">'+(d?g:"")+(this._isInRange(b,
D)?'<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._gotoToday('#"+b.id+"');\">"+q+"</button>":"")+(d?"":g)+"</div>":"",g=parseInt(this._get(b,"firstDay"),10),g=isNaN(g)?0:g,q=this._get(b,"showWeek"),D=this._get(b,"dayNames");this._get(b,"dayNamesShort");var G=this._get(b,"dayNamesMin"),O=this._get(b,"monthNames"),C=this._get(b,"monthNamesShort"),w=this._get(b,"beforeShowDay"),S=this._get(b,"showOtherMonths"),
I=this._get(b,"selectOtherMonths");this._get(b,"calculateWeek");for(var h=this._getDefaultDate(b),T="",N=0;N<r[0];N++){var W="";this.maxRows=4;for(var L=0;L<r[1];L++){var u=this._daylightSavingAdjust(new Date(E,s,b.selectedDay)),H=" ui-corner-all",F="";if(p){F+='<div class="ui-datepicker-group';if(1<r[1])switch(L){case 0:F+=" ui-datepicker-group-first";H=" ui-corner-"+(d?"right":"left");break;case r[1]-1:F+=" ui-datepicker-group-last";H=" ui-corner-"+(d?"left":"right");break;default:F+=" ui-datepicker-group-middle",
H=""}F+='">'}for(var F=F+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+H+'">'+(/all|left/.test(H)&&0==N?d?f:A:"")+(/all|right/.test(H)&&0==N?d?A:f:"")+this._generateMonthYearHeader(b,s,E,x,y,0<N||0<L,O,C)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),M=q?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":"",H=0;7>H;H++)var J=(H+g)%7,M=M+("<th"+(5<=(H+g+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+D[J]+'">'+G[J]+"</span></th>");
F+=M+"</tr></thead><tbody>";M=this._getDaysInMonth(E,s);E==b.selectedYear&&s==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,M));H=(this._getFirstDayOfMonth(E,s)-g+7)%7;M=Math.ceil((H+M)/7);this.maxRows=M=p?this.maxRows>M?this.maxRows:M:M;for(var J=this._daylightSavingAdjust(new Date(E,s,1-H)),U=0;U<M;U++){for(var F=F+"<tr>",Y=!q?"":'<td class="ui-datepicker-week-col">'+this._get(b,"calculateWeek")(J)+"</td>",H=0;7>H;H++){var Q=w?w.apply(b.input?b.input[0]:null,[J]):[!0,""],k=J.getMonth()!=
s,v=k&&!I||!Q[0]||x&&J<x||y&&J>y,Y=Y+('<td class="'+(5<=(H+g+6)%7?" ui-datepicker-week-end":"")+(k?" ui-datepicker-other-month":"")+(J.getTime()==u.getTime()&&s==b.selectedMonth&&b._keyEvent||h.getTime()==J.getTime()&&h.getTime()==u.getTime()?" "+this._dayOverClass:"")+(v?" "+this._unselectableClass+" ui-state-disabled":"")+(k&&!S?"":" "+Q[1]+(J.getTime()==z.getTime()?" "+this._currentClass:"")+(J.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!k||S)&&Q[2]?' title="'+Q[2]+'"':"")+(v?"":
' onclick="DP_jQuery_'+i+".datepicker._selectDay('#"+b.id+"',"+J.getMonth()+","+J.getFullYear()+', this);return false;"')+">"+(k&&!S?"&#xa0;":v?'<span class="ui-state-default">'+J.getDate()+"</span>":'<a class="ui-state-default'+(J.getTime()==c.getTime()?" ui-state-highlight":"")+(J.getTime()==z.getTime()?" ui-state-active":"")+(k?" ui-priority-secondary":"")+'" href="#">'+J.getDate()+"</a>")+"</td>");J.setDate(J.getDate()+1);J=this._daylightSavingAdjust(J)}F+=Y+"</tr>"}s++;11<s&&(s=0,E++);F+="</tbody></table>"+
(p?"</div>"+(0<r[0]&&L==r[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");W+=F}T+=W}T+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return T},_generateMonthYearHeader:function(a,c,d,e,f,g,r,s){var q=this._get(a,"changeMonth"),p=this._get(a,"changeYear"),z=this._get(a,"showMonthAfterYear"),x='<div class="ui-datepicker-title">',y="";if(g||!q)y+='<span class="ui-datepicker-month">'+
r[c]+"</span>";else{for(var r=e&&e.getFullYear()==d,E=f&&f.getFullYear()==d,y=y+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),A=0;12>A;A++)if((!r||A>=e.getMonth())&&(!E||A<=f.getMonth()))y+='<option value="'+A+'"'+(A==c?' selected="selected"':"")+">"+s[A]+"</option>";y+="</select>"}z||(x+=y+(g||!q||!p?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",g||!p)x+='<span class="ui-datepicker-year">'+d+"</span>";else{var s=this._get(a,
"yearRange").split(":"),D=(new Date).getFullYear(),r=function(a){a=a.match(/c[+-].*/)?d+parseInt(a.substring(1),10):a.match(/[+-].*/)?D+parseInt(a,10):parseInt(a,10);return isNaN(a)?D:a},c=r(s[0]),s=Math.max(c,r(s[1]||"")),c=e?Math.max(c,e.getFullYear()):c,s=f?Math.min(s,f.getFullYear()):s;for(a.yearshtml+='<select class="ui-datepicker-year" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'Y');\" >";c<=s;c++)a.yearshtml+='<option value="'+c+'"'+(c==d?' selected="selected"':
...
m=a('<a href="#"></a>').addClass("ui-dialog-titlebar-close ui-corner-all").attr("role","button").hover(function(){m.addClass("ui-state-hover")},function(){m.removeClass("ui-state-hover")}).focus(function(){m.addClass("ui-state-focus")}).blur(function(){m.removeClass("ui-state-focus")}).click(function(a){c.close(a);return false}).appendTo(o);(c.uiDialogTitlebarCloseText=a("<span></span>")).addClass("ui-icon ui-icon-closethick").text(d.closeText).appendTo(m);a("<span></span>").addClass("ui-dialog-title").attr("id",
...
handle:".ui-dialog-titlebar",containment:"document",start:function(e,j){g="auto"===b.height?"auto":a(this).height();a(this).height(a(this).height()).addClass("ui-dialog-dragging");d._trigger("dragStart",e,c(j))},drag:function(a,b){d._trigger("drag",a,c(b))},stop:function(o,m){b.position=[m.position.left-e.scrollLeft(),m.position.top-e.scrollTop()];a(this).removeClass("ui-dialog-dragging").height(g);d._trigger("dragStop",o,c(m));a.ui.dialog.overlay.resize()}})},_makeResizable:function(d){function e(a){return{originalPosition:a.originalPosition,
...
(function(a){a.ui=a.ui||{};var c=/left|center|right/,d=/top|center|bottom/,e,g=a.fn.position,i=a.fn.offset;a.fn.position=function(f){if(!f||!f.of)return g.apply(this,arguments);var f=a.extend({},f),b=a(f.of),i=b[0],l=(f.collision||"flip").split(" "),o=f.offset?f.offset.split(" "):[0,0],m,n,r;9===i.nodeType?(m=b.width(),n=b.height(),r={top:0,left:0}):i.setTimeout?(m=b.width(),n=b.height(),r={top:b.scrollTop(),left:b.scrollLeft()}):i.preventDefault?(f.at="left top",m=n=0,r={top:f.of.pageY,left:f.of.pageX}):
(m=b.outerWidth(),n=b.outerHeight(),r=b.offset());a.each(["my","at"],function(){var a=(f[this]||"").split(" ");a.length===1&&(a=c.test(a[0])?a.concat(["center"]):d.test(a[0])?["center"].concat(a):["center","center"]);a[0]=c.test(a[0])?a[0]:"center";a[1]=d.test(a[1])?a[1]:"center";f[this]=a});1===l.length&&(l[1]=l[0]);o[0]=parseInt(o[0],10)||0;1===o.length&&(o[1]=o[0]);o[1]=parseInt(o[1],10)||0;"right"===f.at[0]?r.left+=m:"center"===f.at[0]&&(r.left+=m/2);"bottom"===f.at[1]?r.top+=n:"center"===f.at[1]&&
(r.top+=n/2);r.left+=o[0];r.top+=o[1];return this.each(function(){var b=a(this),c=b.outerWidth(),d=b.outerHeight(),g=parseInt(a.curCSS(this,"marginLeft",true))||0,i=parseInt(a.curCSS(this,"marginTop",true))||0,j=c+g+(parseInt(a.curCSS(this,"marginRight",true))||0),E=d+i+(parseInt(a.curCSS(this,"marginBottom",true))||0),A=a.extend({},r),D;if(f.my[0]==="right")A.left=A.left-c;else if(f.my[0]==="center")A.left=A.left-c/2;if(f.my[1]==="bottom")A.top=A.top-d;else if(f.my[1]==="center")A.top=A.top-d/2;
if(!e){A.left=Math.round(A.left);A.top=Math.round(A.top)}D={left:A.left-g,top:A.top-i};a.each(["left","top"],function(b,e){if(a.ui.position[l[b]])a.ui.position[l[b]][e](A,{targetWidth:m,targetHeight:n,elemWidth:c,elemHeight:d,collisionPosition:D,collisionWidth:j,collisionHeight:E,offset:o,my:f.my,at:f.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(A,{using:f.using}))})};a.ui.position={fit:{left:function(c,b){var d=a(window),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft();
...
function(){o("hover",a(this))});this.lis.bind("mouseout.tabs",function(){a(this).removeClass("ui-state-hover")});this.anchors.bind("focus.tabs",function(){o("focus",a(this).closest("li"))});this.anchors.bind("blur.tabs",function(){a(this).closest("li").removeClass("ui-state-focus")})}var m,n;b.fx&&(a.isArray(b.fx)?(m=b.fx[0],n=b.fx[1]):m=n=b.fx);var r=n?function(b,c){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");c.hide().removeClass("ui-tabs-hide").animate(n,n.duration||"normal",
function(){e(c,n);f._trigger("show",null,f._ui(b,c[0]))})}:function(b,c){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");c.removeClass("ui-tabs-hide");f._trigger("show",null,f._ui(b,c[0]))},s=m?function(a,b){b.animate(m,m.duration||"normal",function(){f.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");e(b,m);f.element.dequeue("tabs")})}:function(a,b){f.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");f.element.dequeue("tabs")};
...
(function(a,c,d,e){function g(a,b,c){M[a]=c;J[a]=b;F||(F=a)}function i(b){F!==b&&(F=b,a.ui.editor.eachInstance(function(){this.reinit()}))}function f(a,b){F&&M[F]&&M[F][a]&&(a=M[F][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function b(b){if(U===e){U=!0;if(Y=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(b.options.baseClass+"-ios"),Y&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height",
"-=1")},0)});a.browser.mozilla&&a("html").addClass(b.options.baseClass+"-ff");if(a.browser.msie&&9>a.browser.version){U=!1;var c=a("<div/>").addClass(b.options.baseClass+"-unsupported").html(b.getTemplate("unsupported")).appendTo("body");j(c);c.find("."+b.options.baseClass+"-unsupported-close").click(function(){c.remove()})}}return U}function j(b){var c=1;b.siblings().each(function(){var b=a(this).css("z-index");!isNaN(b)&&b>c&&(c=b+1)});b.css("z-index",c)}function l(a){return a.clone().wrap("<div/>").parent().html()}
function o(a){var b,a=document.createElement(a);b="getComputedStyle"in c;document.body.appendChild(a);b=(b?c.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return b}function m(b,c){return-1!==a.inArray(a(b)[0].tagName.toLowerCase(),c)}function n(b,c){for(var d="",e=0,f=b.childNodes.length;e<f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?g.nodeValue:l(a(g)))&&(d+=g)}c&&(d=a("<"+c+">"+d+"</"+c+">"),d.find("p").wrapInner("<"+c+"/>"),d.find("p > *").unwrap(),d=a("<div/>").html(d).html());
...
a)Q=d.saveSelection()}function z(){Q&&(d.restoreSelection(Q),Q=!1)}function x(){Q&&d.removeMarkers(Q);Q=!1}function y(a,b,c){for(var b=b||d.getSelection(),e,f=0;e=b.getAllRanges()[f++];)a.call(c,e)}function E(a,b){y(function(b){r(a,b)},b,this)}function A(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).focus().contents().each(function(){var a=d.createRange();a.selectNodeContents(this);c.addRange(a)})}function D(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();
a.selectNode(this);c.addRange(a)}).focus()}function G(b,c,e){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNodeContents(this);a.collapse(e);c.addRange(a)})}function O(a,b){G(a,b,!1)}function C(a,b){G(a,b,!0)}function w(a){a=a||d.getSelection();return a.toHtml()}function S(b){b=b||d.getSelection().getRangeAt(0);return a(3===b.commonAncestorContainer.nodeType?b.commonAncestorContainer.parentNode:b.commonAncestorContainer)}function I(a){var b=new jQuery;
y(function(a){b.push(S(a)[0])},a,this);return b}function h(){var b=d.getSelection();if(null===b.anchorNode)return null;if(b.isBackwards())return 3===b.focusNode.nodeType?a(b.focusNode.parentElement):a(b.focusNode);b.anchorNode||console.trace();return 3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode)}function T(){var b=d.getSelection();return null===b.anchorNode?null:b.isBackwards()?3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode):3===b.focusNode.nodeType?
a(b.focusNode.parentElement):a(b.focusNode)}function N(b,c){var c=c||{},e=d.createCssClassApplier(c.classes||"",{normalize:!0,elementTagName:b,elementProperties:c.attributes||{}});y(function(d){var f=d.cloneContents(),f=n(f);"string"===typeof f&&(f=f.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));a(f).is(":empty")?(f=a("<"+b+"/>").addClass(c.classes).attr(c.attributes||{}).append(n(d.cloneContents())),r(f,d)):e.toggleRange(d)},null,this)}function W(a,b,c){y(function(d){d=S(d);d.is(a)?d.attr(b):
N(a,{classes:c,attributes:b})},null,this)}function L(b,c){var c=c||d.getSelection(),e=c.getRangeAt(0),f=I()[0],g=d.createRange();g.setStartBefore(f);g.setEnd(e.startContainer,e.startOffset);var g=g.cloneContents(),h=d.createRange();h.setStart(e.endContainer,e.endOffset);h.setEndAfter(f);e=h.cloneContents();g=l(a(n(g)));g+=l(a(b));g+=l(a(n(e)));a(f).replaceWith(a(g))}function u(a,b,c){var c=c||d.getSelection(),e=h()[0],f=T()[0],g=I()[0],g=m(g,b),e=m(e,b),b=m(f,b);g&&e&&b?E(a):L(a,c)}function H(a,b){allowed=
[];for(var c=0;c<b.length;c++)b[c].match(/[a-z][a-z0-9]{0,}/g)&&allowed.push(b[c]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,b){return-1<allowed.indexOf(b.toLowerCase())?a:""})}var F=null,M={},J={};a(function(){d.initialized||d.init();a.isFunction(d.rangePrototype.insertNodeAtEnd)||(d.rangePrototype.insertNodeAtEnd=function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});a("html").click(function(){a(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});
...
!1),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,this.ready=!0,this.fire("ready"),this.options.autoEnable&&a(function(){c.enableEditing();c.showToolbar()}))},attach:function(){this.bind("change",this.historyPush);this.bind("selectionChange",this.updateTagTree);this.bind("show",this.updateTagTree);var b=a.proxy(this.checkChange,this);this.getElement().find("img").bind("click."+this.widgetName,a.proxy(function(a){D(a.target)},this));this.getElement().bind("mouseup."+
...
for(g=0;g<f.length;g++)c+=this.getTemplate("tag",{element:f[g][0].tagName.toLowerCase(),data:"["+e+","+g+"]"});e++},null,this);c||(c=this.getTemplate("root"));this.path.html(c).find("a").click(function(){var c=a(this).data("ui-editor-selection");c?(D(d[c[0]][c[1]]),b.updateTagTree()):D(b.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(b){return this.getElement()[0]===a(b)[0]},unify:function(b,c){!1!==c&&b(this);if(this.options.unify)for(var d=a.ui.editor.getInstances(),e=0;e<d.length;e++)d[e]!==
...
c){b.children().each(function(){var b=a.map(this.attributes,function(b){if(-1===a.inArray(b.name,c))return b.name}),d=a(this);a.each(b,function(a,b){d.removeAttr(b)});element.removeAttributes(a(this),c)});return b},elementBringToTop:j,elementOuterHtml:l,elementOuterText:function(a){return a.clone().wrap("<div/>").parent().text()},elementIsBlock:function(a){return"block"===o(a.tagName)},elementDefaultDisplay:o,elementIsValid:m,fragmentToHtml:n,fragmentInsertBefore:function(b,c,d){for(var e=0,f=b.childNodes.length;e<
f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?g.nodeValue:a(g).html())&&a("<"+d+"/>").html(a.trim(g)).insertBefore(c)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},rangeGetCommonAncestor:s,rangeIsEmpty:q,selectionSave:p,selectionRestore:z,selectionDestroy:x,selectionEachRange:y,selectionReplace:E,selectionSelectInner:A,selectionSelectOuter:D,selectionSelectEdge:G,selectionSelectEnd:O,selectionSelectStart:C,selectionGetHtml:w,selectionGetElements:I,
selectionToggleWrapper:N,selectionExists:function(a){var b=!1;y(function(a){q(a)||(b=!0)},a,this);return b},selectionReplaceSplittingSelectedElement:L,selectionReplaceWithinValidTags:u,stringStripTags:H,defaults:{plugins:{},ui:{},bind:{},domTools:{constrainSelection:function(b,c){var b=a(b)[0],c=c||d.getSelection(),e;a(c.getAllRanges()).each(function(d,f){e=3===this.commonAncestorContainer.nodeType?a(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;b!==e&&!a.contains(b,e)&&c.removeRange(f)})},
unwrapParentTag:function(b){I().each(function(){a(this).is(b)&&a(this).replaceWith(a(this).html())})},execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(d){}},insertTag:function(b,c){y(function(c){c.insertNode(a("<"+b+"/>")[0])},c,this)},insertTagAtEnd:function(b,c){y(function(c){c.insertNodeAtEnd(a("<"+b+"/>")[0])},c,this)},insertElement:function(b,c,d){y(function(d){a(b).each(function(){d.insertNode(!1===c?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(b,c,d){y(function(d){a(b).each(function(){d.insertNodeAtEnd(!1===
...
f.bind("click."+b.widgetName,e.edit);f.bind("mouseleave."+b.widgetName,e.buttonOut);b.getElement().bind("mouseenter."+b.widgetName,e.show);b.getElement().bind("mouseleave."+b.widgetName,e.hide)});b.bind("show",function(){f.button("destroy").remove();b.getElement().unbind("mouseenter."+b.widgetName,e.show);b.getElement().unbind("mouseleave."+b.widgetName,e.hide)})}});a.ui.editor.registerPlugin("dock",{enabled:!1,docked:!1,topSpacer:null,bottomSpacer:null,options:{docked:!1,dockToElement:!1,dockUnder:!1,
...
click:function(){E("<hr/>")}})}}});a.ui.editor.registerUi({i18n:{init:function(b){var c=this,d=this.persist("locale");d&&i(d);var d=a('<select autocomplete="off" name="i18n"/>'),e;for(e in M){var g=a('<option value="'+e+'" class="'+e+'"/>');g.html(J[e]);F===e&&g.attr("selected","selected");d.append(g)}return b.uiSelectMenu({title:f("Change Language"),select:d,change:function(a){i(c.persist("locale",a))}})}}});g("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.",
...
a.isArray(b)||(b=[b]);for(var c=0;c<b.length;c++)this.editor.getElement().find("img."+b[c]).removeClass(b[c])},manuallyResizeImage:function(b){this.removeToolsButtons();var c=this.editor.getElement().find("img."+this.options.manuallyResizingClass),d=a(c).innerWidth(),e=a(c).innerHeight(),g="#"+this.options.baseClass+"-width",h="#"+this.options.baseClass+"-height",i=this,j=function(b){b=Math.round(b||a(g).val())+"px";a(c).css({width:b})},l=a(this.editor.getTemplate("imageresize.manually-resize-image",
{width:d,height:e,baseClass:this.options.baseClass}));l.dialog({modal:!0,resizable:!1,title:f("Modify Image Size"),autoOpen:!0,buttons:[{text:f("Resize Image"),click:function(){j(a(this).find(g).val());a(this).dialog("close")}},{text:f("Cancel"),click:function(){j(d);a(this).dialog("close")}}],close:function(){i.editor.checkChange();a(l).remove()},open:function(){var b=a(this).find(g),c=a(this).find(h);b.keyup(function(){c.val(Math.round(Math.abs(e/d*a(this).val())));j()});c.keyup(function(){b.val(Math.round(Math.abs(d/
e*a(this).val())));j()})}});b.preventDefault();return!1},displayToolsButtonRelativeToImage:function(b){var c=a("<button>"+f("Click to edit the image")+"</button>").appendTo("body").addClass(this.options.resizeButtonClass).button({text:!1,icons:{primary:"ui-icon-tools"}});c.css({position:"absolute",left:a(b).position().left+a(b).innerWidth()-a(c).outerWidth()-10+"px",top:a(b).position().top+10+"px"}).attr("contenteditable",!1).click(a.proxy(this.manuallyResizeImage,this));c.addClass(this.editor.options.supplementaryClass).find("span").addClass(this.editor.options.supplementaryClass);
...
this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(c.classes).attr(d),this.editor.showConfirm(f("Updated link: {{link}}",{link:e}))):(W("a",a.extend(d,{id:this.editor.getUniqueId()}),c.classes),this.editor.showConfirm(f("Added link: {{link}}",{link:e})),this.selectedElement=a("#"+d.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",d.href);D(this.selectedElement);p();return!0},typeChange:function(b,
...
this.change,this);return a.uiButton({title:f("Insert Link"),click:function(){a.getPlugin("link").show()}})},change:function(){I().length?this.ui.enable():this.ui.disable()}},unlink:{hotkeys:{"ctrl+shift+l":{action:function(){this.ui.click()},restoreSelection:!1}},init:function(a){a.bind("selectionChange",this.change,this);a.bind("show",this.change,this);return a.uiButton({title:f("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){I().is("a")?this.ui.enable():this.ui.disable()}}});
a.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),toggleList:function(b){a(I()).is("li")&&a(I()).parent().is(b)?this.unwrapList():this.wrapList(b);this.editor.fire("selectionChange");
this.editor.fire("change")},unwrapList:function(){p();var b=[],c=[],d=h(),e=T();b.push(a(d).html());c.push(d);if(a(d)[0]!==a(e)[0]){var f=d;do f=a(f).next(),b.push(a(f).html()),c.push(f);while(a(f)[0]!==a(e)[0])}f=0===a(d).prev().length;e=0===a(e).next().length;d=a(d).parent();for(listElementsIndex=0;listElementsIndex<c.length;listElementsIndex++)a(c[listElementsIndex]).remove();for(c=0;c<b.length;c++)d.parent().is("li")||(b[c]="<p>"+b[c]+"</p>");f&&e?(d.replaceWith(b.join("")),z(),b=I()[0],D(b)):
(f?a(d).before(b.join("")):e?a(d).after(b.join("")):L(b.join("")),z(),this.editor.checkChange())},wrapList:function(b){this.editor.constrainSelection(this.editor.getElement());""===a.trim(w())&&A(I());var c=a("<div>").html(w()),d=[],e=this;a(c).contents().each(function(){var b;b="block"===o(this.tagName)?H(a(this).html(),e.validChildren):H(l(a(this)),e.validChildren);b=a("<li>"+b+"</li>");""!==a.trim(b.text())&&d.push(l(b))});c=this.options.baseClass+"-selection";b="<"+b+' class="'+c+'">'+d.join("")+
"</"+b+">";z();var f=a(I()[0]).parent(),g=this.editor.getElement()[0];f===g||I()[0]===g?E(b):u(b,this.validParents);c=a(this.editor.getElement().find("."+c).removeClass(c));A(c.find("li:first")[0]);this.editor.checkChange()},toggleButtonState:function(b,c){var d=function(a){c.button.toggleClass("ui-state-highlight",a).toggleClass("ui-state-default",!a)},e=h();if(null===e||!e.length)e=this.editor.getElement();var f=T();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(a(e).is(b)&&
a(f).is(b)&&e===f)return d(!0);var g=a(e).parentsUntil(i,b).first()&&a(f).parentsUntil(i,b).first(),i="#"+this.editor.getElement().attr("id"),j=a(e).is(b+" > li")||a(e).parentsUntil(i,b+" > li").length,l=a(f).is(b+" > li")||a(f).parentsUntil(i,b+" > li").length;if(j&&l&&g){g=a(s());g.is(b)||(g=a(g).parentsUntil(i,b).first());i=g.find("ul, ol");if(!i.length)return d(!0);for(g=0;g<i.length;g++)if(a.contains(i[g],e)&&a.contains(i[g],f))return d(!1);return d(!0)}return d(!1)}});a.ui.editor.registerUi({listUnordered:{init:function(a){var b=
...
g);u(e,this.options.enterValidTags);e=a("#"+g).removeAttr("id");b?c?C(e.next()):f?C(e):(C(e.next()),(b=e.prev())&&""!==a.trim(b.html())&&l(b)!==this.options.enter&&e.remove()):(C(e.next()),e.remove())},restoreSelection:!1},"return+shift":{action:function(){x();var b=this.options.baseClass+"-enter-break",c=a(breakHtml).attr("id",b).appendTo("body");this.options.shiftEnterValidTags?u(this.options.shiftEnter,this.options.shiftEnterValidTags):E(c);b=a("#"+b).removeAttr("id").next();C(b)},restoreSelection:!1}}});
...
dialogClass:d.baseClass+" "+d.dialogClass,buttons:[{text:f("Insert"),click:function(){var b=null,b=a(this).find(".ui-editor-paste-area:visible"),b=b.hasClass("ui-editor-paste-plain")||b.hasClass("ui-editor-paste-source")?b.val():b.html(),b=h.filterAttributes(b),b=h.filterChars(b);z();E(b);e=!1;a(this).dialog("close")}},{text:f("Cancel"),click:function(){z();e=!1;a(this).dialog("close")}}],open:function(){var b=a(this).find(".ui-editor-paste-panel-tabs");b.find("ul.ui-tabs-nav li").click(function(){b.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
...
init:function(b){b.bind("selectionChange",this.change,this);b.bind("show",this.change,this);return b.uiSelectMenu({name:"tagMenu",title:f("Change HTML tag of selected element"),select:a(b.getTemplate("tagmenu.menu")),change:function(c){if(!("undefined"===typeof c||"na"===c)){var d=b.getElement()[0],e=I();if(!w()||""===w()){if(a(e)[0]===a(d)[0])return;p();d=a("<"+c+">").html(e.html());e.replaceWith(d);z()}else{var e=a(I()[0]).parent(),f=this.options.baseClass+"-selection",c=a("<"+c+">").html(w()).addClass(f);
e===d||I()[0]===d?E(c):u(c,this.validParents);A(b.getElement().find("."+f).removeClass(f))}b.checkChange()}}})},change:function(){var b=I()[0];b?(b=b.tagName.toLowerCase(),this.ui.select.find("option[value="+b+"]").length?this.ui.val(b):this.ui.val("na"),a(this.ui.button).toggleClass("ui-state-disabled",this.editor.getElement()[0]===I()[0])):a(this.ui.button).toggleClass("ui-state-disabled",!0)}}});a.ui.editor.registerPlugin("toolbarTip",{init:function(){a.browser.msie||this.bind("show, tagTreeUpdated",
