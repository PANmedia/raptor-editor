/*! VERSION: 0.0.13 *//*
 ...
 Build date: 26 February 2012
*/
window.rangy=function(){function a(a,b){var c=typeof a[b];return c==l||!!(c==j&&a[b])||"unknown"==c}function c(a,b){return!!(typeof a[b]==j&&a[b])}function d(a,b){return typeof a[b]!=o}function e(a){return function(b,c){for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0}}function g(a){return a&&p(a,s)&&x(a,r)}function i(a){window.alert("Rangy not supported in your browser. Reason: "+a);w.initialized=!0;w.supported=!1}function f(){if(!w.initialized){var b,d=!1,e=!1;a(document,"createRange")&&
(b=document.createRange(),p(b,m)&&x(b,n)&&(d=!0),b.detach());if((b=c(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(b,"createTextRange"))b=b.createTextRange(),g(b)&&(e=!0);!d&&!e&&i("Neither Range nor TextRange are implemented");w.initialized=!0;w.features={implementsDomRange:d,implementsTextRange:e};d=E.concat(A);e=0;for(b=d.length;e<b;++e)try{d[e](w)}catch(j){c(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
j)}}}function b(a){this.name=a;this.supported=this.initialized=!1}var j="object",l="function",o="undefined",n="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer,START_TO_START,START_TO_END,END_TO_START,END_TO_END".split(","),m="setStart,setStartBefore,setStartAfter,setEnd,setEndBefore,setEndAfter,collapse,selectNode,selectNodeContents,compareBoundaryPoints,deleteContents,extractContents,cloneContents,insertNode,surroundContents,cloneRange,toString,detach".split(","),
r="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),s="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),p=e(a),q=e(c),x=e(d),w={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:a,isHostObject:c,isHostProperty:d,areHostMethods:p,areHostObjects:q,areHostProperties:x,isTextRange:g},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
w.fail=i;w.warn=function(a){a="Rangy warning: "+a;w.config.alertOnWarn?window.alert(a):typeof window.console!=o&&typeof window.console.log!=o&&window.console.log(a)};({}).hasOwnProperty?w.util.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])}:i("hasOwnProperty not supported");var A=[],E=[];w.init=f;w.addInitListener=function(a){w.initialized?a(w):A.push(a)};var z=[];w.addCreateMissingNativeApiListener=function(a){z.push(a)};w.createMissingNativeApi=function(a){a=a||window;f();
for(var b=0,c=z.length;b<c;++b)z[b](a)};b.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};b.prototype.warn=function(a){w.warn("Module "+this.name+": "+a)};b.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};w.createModule=function(a,c){var d=new b(a);w.modules[a]=d;E.push(function(a){c(a,d);d.initialized=!0;d.supported=!0})};w.requireModules=function(a){for(var c=0,d=a.length,g,e;c<
d;++c){e=a[c];g=w.modules[e];if(!g||!(g instanceof b))throw Error("Module '"+e+"' not found");if(!g.supported)throw Error("Module '"+e+"' not supported");}};var C=!1,q=function(){C||(C=!0,w.initialized||f())};if(typeof window==o)i("No window found");else if(typeof document==o)i("No document found");else return a(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",q,!1),a(window,"addEventListener")?window.addEventListener("load",q,!1):a(window,"attachEvent")?window.attachEvent("onload",
q):i("Window does not have required addEventListener or attachEvent method"),w}();
rangy.createModule("DomUtil",function(a,c){function d(a){for(var b=0;a=a.previousSibling;)b++;return b}function e(a,b){var c=[],d;for(d=a;d;d=d.parentNode)c.push(d);for(d=b;d;d=d.parentNode)if(p(c,d))return d;return null}function g(a,b,c){for(c=c?a:a.parentNode;c;){a=c.parentNode;if(a===b)return c;c=a}return null}function i(a){a=a.nodeType;return 3==a||4==a||8==a}function f(a,b){var c=b.nextSibling,d=b.parentNode;c?d.insertBefore(a,c):d.appendChild(a);return a}function b(a){if(9==a.nodeType)return a;
if(typeof a.ownerDocument!=m)return a.ownerDocument;if(typeof a.document!=m)return a.document;if(a.parentNode)return b(a.parentNode);throw Error("getDocument: no document found for node");}function j(a){return!a?"[No node]":i(a)?'"'+a.data+'"':1==a.nodeType?"<"+a.nodeName+(a.id?' id="'+a.id+'"':"")+">["+a.childNodes.length+"]":a.nodeName}function l(a){this._next=this.root=a}function o(a,b){this.node=a;this.offset=b}function n(a){this.code=this[a];this.codeName=a;this.message="DOMException: "+this.codeName}
var m="undefined",r=a.util;r.areHostMethods(document,["createDocumentFragment","createElement","createTextNode"])||c.fail("document missing a Node creation method");r.isHostMethod(document,"getElementsByTagName")||c.fail("document missing getElementsByTagName method");var s=document.createElement("div");r.areHostMethods(s,["insertBefore","appendChild","cloneNode"])||c.fail("Incomplete Element implementation");r.isHostProperty(s,"innerHTML")||c.fail("Element is missing innerHTML property");s=document.createTextNode("test");
...
null}};o.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+j(this.node)+":"+this.offset+")]"}};n.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};n.prototype.toString=function(){return this.message};a.dom={arrayContains:p,isHtmlNamespace:function(a){var b;return typeof a.namespaceURI==m||null===(b=a.namespaceURI)||"http://www.w3.org/1999/xhtml"==
b},parentElement:function(a){a=a.parentNode;return 1==a.nodeType?a:null},getNodeIndex:d,getNodeLength:function(a){var b;return i(a)?a.length:(b=a.childNodes)?b.length:0},getCommonAncestor:e,isAncestorOf:function(a,b,c){for(b=c?b:b.parentNode;b;){if(b===a)return!0;b=b.parentNode}return!1},getClosestAncestorIn:g,isCharacterDataNode:i,insertAfter:f,splitDataNode:function(a,b){var c=a.cloneNode(!1);c.deleteData(0,b);a.deleteData(b,a.length-b);f(c,a);return c},getDocument:b,getWindow:function(a){a=b(a);
if(typeof a.defaultView!=m)return a.defaultView;if(typeof a.parentWindow!=m)return a.parentWindow;throw Error("Cannot get a window object for node");},getIframeWindow:function(a){if(typeof a.contentWindow!=m)return a.contentWindow;if(typeof a.contentDocument!=m)return a.contentDocument.defaultView;throw Error("getIframeWindow: No Window object found for iframe element");},getIframeDocument:function(a){if(typeof a.contentDocument!=m)return a.contentDocument;if(typeof a.contentWindow!=m)return a.contentWindow.document;
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(a){return r.isHostObject(a,"body")?a.body:a.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var b;b=a.parentNode;)a=b;return a},comparePoints:function(a,b,c,j){var f;if(a==c)return b===j?0:b<j?-1:1;if(f=g(c,a,!0))return b<=d(f)?-1:1;if(f=g(a,c,!0))return d(f)<j?-1:1;b=e(a,c);a=a===b?b:g(a,b,!0);c=c===b?b:g(c,b,!0);if(a===c)throw Error("comparePoints got to case 4 and childA and childB are the same!");
for(b=b.firstChild;b;){if(b===a)return-1;if(b===c)return 1;b=b.nextSibling}throw Error("Should not be here!");},inspectNode:j,fragmentFromNodeChildren:function(a){for(var c=b(a).createDocumentFragment(),d;d=a.firstChild;)c.appendChild(d);return c},createIterator:function(a){return new l(a)},DomPosition:o};a.DOMException=n});
rangy.createModule("DomRange",function(a){function c(a,b){return 3!=a.nodeType&&(u.isAncestorOf(a,b.startContainer,!0)||u.isAncestorOf(a,b.endContainer,!0))}function d(a){return u.getDocument(a.startContainer)}function e(a,b,c){if(b=a._listeners[b])for(var d=0,h=b.length;d<h;++d)b[d].call(a,{target:a,args:c})}function g(a){return new I(a.parentNode,u.getNodeIndex(a))}function i(a){return new I(a.parentNode,u.getNodeIndex(a)+1)}function f(a,b,c){var d=11==a.nodeType?a.firstChild:a;u.isCharacterDataNode(b)?
c==b.length?u.insertAfter(a,b):b.parentNode.insertBefore(a,0==c?b:u.splitDataNode(b,c)):c>=b.childNodes.length?b.appendChild(a):b.insertBefore(a,b.childNodes[c]);return d}function b(a){for(var c,h,k=d(a.range).createDocumentFragment();h=a.next();){c=a.isPartiallySelectedSubtree();h=h.cloneNode(!c);c&&(c=a.getSubtreeIterator(),h.appendChild(b(c)),c.detach(!0));if(10==h.nodeType)throw new G("HIERARCHY_REQUEST_ERR");k.appendChild(h)}return k}function j(a,b,c){for(var d,h,c=c||{stop:!1};d=a.next();)if(a.isPartiallySelectedSubtree())if(!1===
b(d)){c.stop=!0;break}else{if(d=a.getSubtreeIterator(),j(d,b,c),d.detach(!0),c.stop)break}else for(d=u.createIterator(d);h=d.next();)if(!1===b(h)){c.stop=!0;return}}function l(a){for(var b;a.next();)a.isPartiallySelectedSubtree()?(b=a.getSubtreeIterator(),l(b),b.detach(!0)):a.remove()}function o(a){for(var b,c=d(a.range).createDocumentFragment(),h;b=a.next();){a.isPartiallySelectedSubtree()?(b=b.cloneNode(!1),h=a.getSubtreeIterator(),b.appendChild(o(h)),h.detach(!0)):a.remove();if(10==b.nodeType)throw new G("HIERARCHY_REQUEST_ERR");
c.appendChild(b)}return c}function n(a,b,c){var d=!(!b||!b.length),h,k=!!c;d&&(h=RegExp("^("+b.join("|")+")$"));var g=[];j(new r(a,!1),function(a){(!d||h.test(a.nodeType))&&(!k||c(a))&&g.push(a)});return g}function m(a){return"["+("undefined"==typeof a.getName?"Range":a.getName())+"("+u.inspectNode(a.startContainer)+":"+a.startOffset+", "+u.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function r(a,b){this.range=a;this.clonePartiallySelectedTextNodes=b;if(!a.collapsed){this.sc=a.startContainer;
...
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function p(a,b,c){this.nodes=n(a,b,c);this._next=this.nodes[0];this._position=0}function q(a){return function(b,c){for(var d,h=c?b:b.parentNode;h;){d=h.nodeType;if(u.arrayContains(a,d))return h;h=h.parentNode}return null}}function x(a,b){if(U(a,b))throw new s("INVALID_NODE_TYPE_ERR");}function w(a){if(!a.startContainer)throw new G("INVALID_STATE_ERR");}function A(a,b){if(!u.arrayContains(b,a.nodeType))throw new s("INVALID_NODE_TYPE_ERR");
}function E(a,b){if(0>b||b>(u.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new G("INDEX_SIZE_ERR");}function z(a,b){if(K(a,!0)!==K(b,!0))throw new G("WRONG_DOCUMENT_ERR");}function C(a){if(O(a,!0))throw new G("NO_MODIFICATION_ALLOWED_ERR");}function F(a,b){if(!a)throw new G(b);}function H(a){return!!a.startContainer&&!!a.endContainer&&!(!u.arrayContains(k,a.startContainer.nodeType)&&!K(a.startContainer,!0))&&!(!u.arrayContains(k,a.endContainer.nodeType)&&!K(a.endContainer,!0))&&a.startOffset<=
(u.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(u.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function D(a){w(a);if(!H(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function v(){}function N(a){a.START_TO_START=ga;a.START_TO_END=ha;a.END_TO_END=ua;a.END_TO_START=la;a.NODE_BEFORE=ia;a.NODE_AFTER=ma;a.NODE_BEFORE_AND_AFTER=na;a.NODE_INSIDE=
ja}function R(a){N(a);N(a.prototype)}function h(a,b){return function(){D(this);var c=this.startContainer,d=this.startOffset,h=this.commonAncestorContainer,k=new r(this,!0);c!==h&&(c=u.getClosestAncestorIn(c,h,!0),d=i(c),c=d.node,d=d.offset);j(k,C);k.reset();h=a(k);k.detach();b(this,c,d,c,d);return h}}function S(b,d,e){function j(a,b){return function(c){w(this);A(c,M);A(L(c),k);c=(a?g:i)(c);(b?f:y)(this,c.node,c.offset)}}function f(a,b,c){var h=a.endContainer,k=a.endOffset;if(b!==a.startContainer||
c!==a.startOffset){if(L(b)!=L(h)||1==u.comparePoints(b,c,h,k))h=b,k=c;d(a,b,c,h,k)}}function y(a,b,c){var h=a.startContainer,k=a.startOffset;if(b!==a.endContainer||c!==a.endOffset){if(L(b)!=L(h)||-1==u.comparePoints(b,c,h,k))h=b,k=c;d(a,h,k,b,c)}}b.prototype=new v;a.util.extend(b.prototype,{setStart:function(a,b){w(this);x(a,!0);E(a,b);f(this,a,b)},setEnd:function(a,b){w(this);x(a,!0);E(a,b);y(this,a,b)},setStartBefore:j(!0,!0),setStartAfter:j(!1,!0),setEndBefore:j(!0,!1),setEndAfter:j(!1,!1),collapse:function(a){D(this);
a?d(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):d(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){w(this);x(a,!0);d(this,a,0,a,u.getNodeLength(a))},selectNode:function(a){w(this);x(a,!1);A(a,M);var b=g(a),a=i(a);d(this,b.node,b.offset,a.node,a.offset)},extractContents:h(o,d),deleteContents:h(l,d),canSurroundContents:function(){D(this);C(this.startContainer);C(this.endContainer);var a=new r(this,!0),b=a._first&&
c(a._first,this)||a._last&&c(a._last,this);a.detach();return!b},detach:function(){e(this)},splitBoundaries:function(){D(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,h=this.endOffset,k=a===c;u.isCharacterDataNode(c)&&0<h&&h<c.length&&u.splitDataNode(c,h);u.isCharacterDataNode(a)&&0<b&&b<a.length&&(a=u.splitDataNode(a,b),k?(h-=b,c=a):c==a.parentNode&&h>=u.getNodeIndex(a)&&h++,b=0);d(this,a,b,c,h)},normalizeBoundaries:function(){D(this);var a=this.startContainer,b=this.startOffset,
c=this.endContainer,h=this.endOffset,k=function(a){var b=a.nextSibling;b&&b.nodeType==a.nodeType&&(c=a,h=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},g=function(d){var k=d.previousSibling;if(k&&k.nodeType==d.nodeType){a=d;var g=d.length;b=k.length;d.insertData(0,k.data);k.parentNode.removeChild(k);a==c?(h+=b,c=a):c==d.parentNode&&(k=u.getNodeIndex(d),h==k?(c=d,h=g):h>k&&h--)}},e=!0;u.isCharacterDataNode(c)?c.length==h&&k(c):(0<h&&(e=c.childNodes[h-1])&&u.isCharacterDataNode(e)&&k(e),
e=!this.collapsed);e?u.isCharacterDataNode(a)?0==b&&g(a):b<a.childNodes.length&&(k=a.childNodes[b])&&u.isCharacterDataNode(k)&&g(k):(a=c,b=h);d(this,a,b,c,h)},collapseToPoint:function(a,b){w(this);x(a,!0);E(a,b);(a!==this.startContainer||b!==this.startOffset||a!==this.endContainer||b!==this.endOffset)&&d(this,a,b,a,b)}});R(b)}function Q(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:u.getCommonAncestor(a.startContainer,
a.endContainer)}function P(a,b,c,d,h){var k=a.startContainer!==b||a.startOffset!==c,g=a.endContainer!==d||a.endOffset!==h;a.startContainer=b;a.startOffset=c;a.endContainer=d;a.endOffset=h;Q(a);e(a,"boundarychange",{startMoved:k,endMoved:g})}function J(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};Q(this)}a.requireModules(["DomUtil"]);var u=a.dom,I=u.DomPosition,G=a.DOMException;r.prototype={_current:null,_next:null,_first:null,
_last:null,isSingleCharacterDataNode:!1,reset:function(){this._current=null;this._next=this._first},hasNext:function(){return!!this._next},next:function(){var a=this._current=this._next;a&&(this._next=a!==this._last?a.nextSibling:null,u.isCharacterDataNode(a)&&this.clonePartiallySelectedTextNodes&&(a===this.ec&&(a=a.cloneNode(!0)).deleteData(this.eo,a.length-this.eo),this._current===this.sc&&(a=a.cloneNode(!0)).deleteData(0,this.so)));return a},remove:function(){var a=this._current,b,c;u.isCharacterDataNode(a)&&
(a===this.sc||a===this.ec)?(b=a===this.sc?this.so:0,c=a===this.ec?this.eo:a.length,b!=c&&a.deleteData(b,c-b)):a.parentNode&&a.parentNode.removeChild(a)},isPartiallySelectedSubtree:function(){return c(this._current,this.range)},getSubtreeIterator:function(){var a;if(this.isSingleCharacterDataNode)a=this.range.cloneRange(),a.collapse();else{a=new J(d(this.range));var b=this._current,c=b,h=0,k=b,g=u.getNodeLength(b);u.isAncestorOf(b,this.sc,!0)&&(c=this.sc,h=this.so);u.isAncestorOf(b,this.ec,!0)&&(k=
this.ec,g=this.eo);P(a,c,h,k,g)}return new r(a,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};s.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};s.prototype.toString=function(){return this.message};p.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
detach:function(){this._current=this._next=this.nodes=null}};var M=[1,3,4,5,7,8,10],k=[2,9,11],t=[1,3,4,5,7,8,10,11],y=[1,3,4,5,7,8],L=u.getRootContainer,K=q([9,11]),O=q([5,6,10,12]),U=q([6,10,12]),V=document.createElement("style"),ba=!1;try{V.innerHTML="<b>x</b>",ba=3==V.firstChild.nodeType}catch(Ja){}a.features.htmlParsingConforms=ba;var ka="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),ga=0,ha=1,ua=2,la=3,ia=0,ma=1,na=2,ja=3;v.prototype={attachListener:function(a,
b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){D(this);z(this.startContainer,b.startContainer);var c=a==la||a==ga?"start":"end",d=a==ha||a==ga?"start":"end";return u.comparePoints(this[c+"Container"],this[c+"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){D(this);A(a,t);C(this.startContainer);if(u.isAncestorOf(a,this.startContainer,!0))throw new G("HIERARCHY_REQUEST_ERR");this.setStartBefore(f(a,this.startContainer,this.startOffset))},cloneContents:function(){D(this);
var a,c;if(this.collapsed)return d(this).createDocumentFragment();if(this.startContainer===this.endContainer&&u.isCharacterDataNode(this.startContainer))return a=this.startContainer.cloneNode(!0),a.data=a.data.slice(this.startOffset,this.endOffset),c=d(this).createDocumentFragment(),c.appendChild(a),c;c=new r(this,!0);a=b(c);c.detach();return a},canSurroundContents:function(){D(this);C(this.startContainer);C(this.endContainer);var a=new r(this,!0),b=a._first&&c(a._first,this)||a._last&&c(a._last,
this);a.detach();return!b},surroundContents:function(a){A(a,y);if(!this.canSurroundContents())throw new s("BAD_BOUNDARYPOINTS_ERR");var b=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);f(a,this.startContainer,this.startOffset);a.appendChild(b);this.selectNode(a)},cloneRange:function(){D(this);for(var a=new J(d(this)),b=ka.length,c;b--;)c=ka[b],a[c]=this[c];return a},toString:function(){D(this);var a=this.startContainer;if(a===this.endContainer&&u.isCharacterDataNode(a))return 3==
a.nodeType||4==a.nodeType?a.data.slice(this.startOffset,this.endOffset):"";var b=[],a=new r(this,!0);j(a,function(a){(3==a.nodeType||4==a.nodeType)&&b.push(a.data)});a.detach();return b.join("")},compareNode:function(a){D(this);var b=a.parentNode,c=u.getNodeIndex(a);if(!b)throw new G("NOT_FOUND_ERR");a=this.comparePoint(b,c);b=this.comparePoint(b,c+1);return 0>a?0<b?na:ia:0<b?ma:ja},comparePoint:function(a,b){D(this);F(a,"HIERARCHY_REQUEST_ERR");z(a,this.startContainer);return 0>u.comparePoints(a,
b,this.startContainer,this.startOffset)?-1:0<u.comparePoints(a,b,this.endContainer,this.endOffset)?1:0},createContextualFragment:ba?function(a){var b=this.startContainer,c=u.getDocument(b);if(!b)throw new G("INVALID_STATE_ERR");var d=null;1==b.nodeType?d=b:u.isCharacterDataNode(b)&&(d=u.parentElement(b));d=null===d||"HTML"==d.nodeName&&u.isHtmlNamespace(u.getDocument(d).documentElement)&&u.isHtmlNamespace(d)?c.createElement("body"):d.cloneNode(!1);d.innerHTML=a;return u.fragmentFromNodeChildren(d)}:
function(a){w(this);var b=d(this).createElement("body");b.innerHTML=a;return u.fragmentFromNodeChildren(b)},toHtml:function(){D(this);var a=d(this).createElement("div");a.appendChild(this.cloneContents());return a.innerHTML},intersectsNode:function(a,b){D(this);F(a,"NOT_FOUND_ERR");if(u.getDocument(a)!==d(this))return!1;var c=a.parentNode,h=u.getNodeIndex(a);F(c,"NOT_FOUND_ERR");var k=u.comparePoints(c,h,this.endContainer,this.endOffset),c=u.comparePoints(c,h+1,this.startContainer,this.startOffset);
return b?0>=k&&0<=c:0>k&&0<c},isPointInRange:function(a,b){D(this);F(a,"HIERARCHY_REQUEST_ERR");z(a,this.startContainer);return 0<=u.comparePoints(a,b,this.startContainer,this.startOffset)&&0>=u.comparePoints(a,b,this.endContainer,this.endOffset)},intersectsRange:function(a,b){D(this);if(d(a)!=d(this))throw new G("WRONG_DOCUMENT_ERR");var c=u.comparePoints(this.startContainer,this.startOffset,a.endContainer,a.endOffset),h=u.comparePoints(this.endContainer,this.endOffset,a.startContainer,a.startOffset);
return b?0>=c&&0<=h:0>c&&0<h},intersection:function(a){if(this.intersectsRange(a)){var b=u.comparePoints(this.startContainer,this.startOffset,a.startContainer,a.startOffset),c=u.comparePoints(this.endContainer,this.endOffset,a.endContainer,a.endOffset),d=this.cloneRange();-1==b&&d.setStart(a.startContainer,a.startOffset);1==c&&d.setEnd(a.endContainer,a.endOffset);return d}return null},union:function(a){if(this.intersectsRange(a,!0)){var b=this.cloneRange();-1==u.comparePoints(a.startContainer,a.startOffset,
this.startContainer,this.startOffset)&&b.setStart(a.startContainer,a.startOffset);1==u.comparePoints(a.endContainer,a.endOffset,this.endContainer,this.endOffset)&&b.setEnd(a.endContainer,a.endOffset);return b}throw new s("Ranges do not intersect");},containsNode:function(a,b){return b?this.intersectsNode(a,!1):this.compareNode(a)==ja},containsNodeContents:function(a){return 0<=this.comparePoint(a,0)&&0>=this.comparePoint(a,u.getNodeLength(a))},containsRange:function(a){return this.intersection(a).equals(a)},
containsNodeText:function(a){var b=this.cloneRange();b.selectNode(a);var c=b.getNodes([3]);return 0<c.length?(b.setStart(c[0],0),a=c.pop(),b.setEnd(a,a.length),a=this.containsRange(b),b.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){D(this);return new p(this,a,b)},getNodes:function(a,b){D(this);return n(this,a,b)},getDocument:function(){return d(this)},collapseBefore:function(a){w(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){w(this);this.setStartAfter(a);
this.collapse(!0)},getName:function(){return"DomRange"},equals:function(a){return J.rangesEqual(this,a)},isValid:function(){return H(this)},inspect:function(){return m(this)}};S(J,P,function(a){w(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;e(a,"detach",null);a._listeners=null});a.rangePrototype=v.prototype;J.rangeProperties=ka;J.RangeIterator=r;J.copyComparisonConstants=R;J.createPrototypeRange=S;J.inspect=m;J.getRangeDocument=d;J.rangesEqual=
function(a,b){return a.startContainer===b.startContainer&&a.startOffset===b.startOffset&&a.endContainer===b.endContainer&&a.endOffset===b.endOffset};a.DomRange=J;a.RangeException=s});
rangy.createModule("WrappedRange",function(a){function c(a,b,c,d){var e=a.duplicate();e.collapse(c);var f=e.parentElement();g.isAncestorOf(b,f,!0)||(f=b);if(!f.canHaveHTML)return new i(f.parentNode,g.getNodeIndex(f));var b=g.getDocument(f).createElement("span"),s,p=c?"StartToStart":"StartToEnd";do f.insertBefore(b,b.previousSibling),e.moveToElementText(b);while(0<(s=e.compareEndPoints(p,a))&&b.previousSibling);p=b.nextSibling;if(-1==s&&p&&g.isCharacterDataNode(p)){e.setEndPoint(c?"EndToStart":"EndToEnd",
a);if(/[\r\n]/.test(p.data)){f=e.duplicate();c=f.text.replace(/\r\n/g,"\r").length;for(c=f.moveStart("character",c);-1==f.compareEndPoints("StartToEnd",f);)c++,f.moveStart("character",1)}else c=e.text.length;f=new i(p,c)}else p=(d||!c)&&b.previousSibling,f=(c=(d||c)&&b.nextSibling)&&g.isCharacterDataNode(c)?new i(c,0):p&&g.isCharacterDataNode(p)?new i(p,p.length):new i(f,g.getNodeIndex(b));b.parentNode.removeChild(b);return f}function d(a,b){var c,d,e=a.offset,f=g.getDocument(a.node),i=f.body.createTextRange(),
p=g.isCharacterDataNode(a.node);p?(c=a.node,d=c.parentNode):(c=a.node.childNodes,c=e<c.length?c[e]:null,d=a.node);f=f.createElement("span");f.innerHTML="&#feff;";c?d.insertBefore(f,c):d.appendChild(f);i.moveToElementText(f);i.collapse(!b);d.removeChild(f);if(p)i[b?"moveStart":"moveEnd"]("character",e);return i}a.requireModules(["DomUtil","DomRange"]);var e,g=a.dom,i=g.DomPosition,f=a.DomRange;if(a.features.implementsDomRange&&(!a.features.implementsTextRange||!a.config.preferTextRange))(function(){function b(a){for(var c=
d.length,g;c--;)g=d[c],a[g]=a.nativeRange[g]}var c,d=f.rangeProperties,i;e=function(a){if(!a)throw Error("Range must be specified");this.nativeRange=a;b(this)};f.createPrototypeRange(e,function(a,b,c,d,g){var e=a.endContainer!==d||a.endOffset!=g;if(a.startContainer!==b||a.startOffset!=c||e)a.setEnd(d,g),a.setStart(b,c)},function(a){a.nativeRange.detach();a.detached=!0;for(var b=d.length,c;b--;)c=d[b],a[c]=null});c=e.prototype;c.selectNode=function(a){this.nativeRange.selectNode(a);b(this)};c.deleteContents=
...
var m=document.createTextNode("test");g.getBody(document).appendChild(m);var r=document.createRange();r.setStart(m,0);r.setEnd(m,0);try{r.setStart(m,1),c.setStart=function(a,c){this.nativeRange.setStart(a,c);b(this)},c.setEnd=function(a,c){this.nativeRange.setEnd(a,c);b(this)},i=function(a){return function(c){this.nativeRange[a](c);b(this)}}}catch(s){c.setStart=function(a,c){try{this.nativeRange.setStart(a,c)}catch(d){this.nativeRange.setEnd(a,c),this.nativeRange.setStart(a,c)}b(this)},c.setEnd=function(a,
c){try{this.nativeRange.setEnd(a,c)}catch(d){this.nativeRange.setStart(a,c),this.nativeRange.setEnd(a,c)}b(this)},i=function(a,c){return function(d){try{this.nativeRange[a](d)}catch(g){this.nativeRange[c](d),this.nativeRange[a](d)}b(this)}}}c.setStartBefore=i("setStartBefore","setEndBefore");c.setStartAfter=i("setStartAfter","setEndAfter");c.setEndBefore=i("setEndBefore","setStartBefore");c.setEndAfter=i("setEndAfter","setStartAfter");r.selectNodeContents(m);c.selectNodeContents=r.startContainer==
m&&r.endContainer==m&&0==r.startOffset&&r.endOffset==m.length?function(a){this.nativeRange.selectNodeContents(a);b(this)}:function(a){this.setStart(a,0);this.setEnd(a,f.getEndOffset(a))};r.selectNodeContents(m);r.setEnd(m,3);i=document.createRange();i.selectNodeContents(m);i.setEnd(m,4);i.setStart(m,2);c.compareBoundaryPoints=-1==r.compareBoundaryPoints(r.START_TO_END,i)&1==r.compareBoundaryPoints(r.END_TO_START,i)?function(a,b){b=b.nativeRange||b;a==b.START_TO_END?a=b.END_TO_START:a==b.END_TO_START&&
(a=b.START_TO_END);return this.nativeRange.compareBoundaryPoints(a,b)}:function(a,b){return this.nativeRange.compareBoundaryPoints(a,b.nativeRange||b)};a.util.isHostMethod(r,"createContextualFragment")&&(c.createContextualFragment=function(a){return this.nativeRange.createContextualFragment(a)});g.getBody(document).removeChild(m);r.detach();i.detach()})(),a.createNativeRange=function(a){return(a||document).createRange()};else if(a.features.implementsTextRange){e=function(a){this.textRange=a;this.refresh()};
e.prototype=new f(document);e.prototype.refresh=function(){var a,b,d=this.textRange;a=d.parentElement();var e=d.duplicate();e.collapse(!0);b=e.parentElement();e=d.duplicate();e.collapse(!1);d=e.parentElement();b=b==d?b:g.getCommonAncestor(b,d);b=b==a?b:g.getCommonAncestor(a,b);0==this.textRange.compareEndPoints("StartToEnd",this.textRange)?b=a=c(this.textRange,b,!0,!0):(a=c(this.textRange,b,!0,!1),b=c(this.textRange,b,!1,!1));this.setStart(a.node,a.offset);this.setEnd(b.node,b.offset)};f.copyComparisonConstants(e);
var b=function(){return this}();"undefined"==typeof b.Range&&(b.Range=e);a.createNativeRange=function(a){return(a||document).body.createTextRange()}}a.features.implementsTextRange&&(e.rangeToTextRange=function(a){if(a.collapsed)return d(new i(a.startContainer,a.startOffset),!0);var b=d(new i(a.startContainer,a.startOffset),!0),c=d(new i(a.endContainer,a.endOffset),!1),a=g.getDocument(a.startContainer).body.createTextRange();a.setEndPoint("StartToStart",b);a.setEndPoint("EndToEnd",c);return a});e.prototype.getName=
function(){return"WrappedRange"};a.WrappedRange=e;a.createRange=function(b){return new e(a.createNativeRange(b||document))};a.createRangyRange=function(a){return new f(a||document)};a.createIframeRange=function(b){return a.createRange(g.getIframeDocument(b))};a.createIframeRangyRange=function(b){return a.createRangyRange(g.getIframeDocument(b))};a.addCreateMissingNativeApiListener(function(b){b=b.document;if(typeof b.createRange=="undefined")b.createRange=function(){return a.createRange(this)};b=
b=null})});
rangy.createModule("WrappedSelection",function(a,c){function d(a){return(a||window).getSelection()}function e(a){return(a||window).document.selection}function g(a,b,c){var d=c?"end":"start",c=c?"start":"end";a.anchorNode=b[d+"Container"];a.anchorOffset=b[d+"Offset"];a.focusNode=b[c+"Container"];a.focusOffset=b[c+"Offset"]}function i(a){a.anchorNode=a.focusNode=null;a.anchorOffset=a.focusOffset=0;a.rangeCount=0;a.isCollapsed=!0;a._ranges.length=0}function f(b){var c;b instanceof x?(c=b._selectionNativeRange,c||
(c=a.createNativeRange(p.getDocument(b.startContainer)),c.setEnd(b.endContainer,b.endOffset),c.setStart(b.startContainer,b.startOffset),b._selectionNativeRange=c,b.attachListener("detach",function(){this._selectionNativeRange=null}))):b instanceof w?c=b.nativeRange:a.features.implementsDomRange&&b instanceof p.getWindow(b.startContainer).Range&&(c=b);return c}function b(a){var b=a.getNodes(),c;a:if(!b.length||1!=b[0].nodeType)c=!1;else{c=1;for(var d=b.length;c<d;++c)if(!p.isAncestorOf(b[0],b[c])){c=
!1;break a}c=!0}if(!c)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function j(a,b){var c=new w(b);a._ranges=[c];g(a,c,!1);a.rangeCount=1;a.isCollapsed=c.collapsed}function l(b){b._ranges.length=0;if("None"==b.docSelection.type)i(b);else{var c=b.docSelection.createRange();if(c&&"undefined"!=typeof c.text)j(b,c);else{b.rangeCount=c.length;for(var d,h=p.getDocument(c.item(0)),k=0;k<b.rangeCount;++k)d=a.createRange(h),d.selectNode(c.item(k)),
b._ranges.push(d);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;g(b,b._ranges[b.rangeCount-1],!1)}}}function o(a,c){for(var d=a.docSelection.createRange(),h=b(c),k=p.getDocument(d.item(0)),k=p.getBody(k).createControlRange(),g=0,e=d.length;g<e;++g)k.add(d.item(g));try{k.add(h)}catch(f){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}k.select();l(a)}function n(a,b,c){this.nativeSelection=a;this.docSelection=b;this._ranges=
[];this.win=c;this.refresh()}function m(a,c){for(var d=p.getDocument(c[0].startContainer),d=p.getBody(d).createControlRange(),h=0,k;h<rangeCount;++h){k=b(c[h]);try{d.add(k)}catch(g){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();l(a)}function r(a,b){if(a.anchorNode&&p.getDocument(a.anchorNode)!==p.getDocument(b))throw new A("WRONG_DOCUMENT_ERR");}function s(a){var b=[],c=new E(a.anchorNode,a.anchorOffset),
d=new E(a.focusNode,a.focusOffset),h="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var k=0,g=a.rangeCount;k<g;++k)b[k]=x.inspect(a.getRangeAt(k));return"["+h+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var p=a.dom,q=a.util,x=a.DomRange,w=a.WrappedRange,A=a.DOMException,E=p.DomPosition,z,C,F=a.util.isHostMethod(window,"getSelection"),
H=a.util.isHostObject(document,"selection"),D=H&&(!F||a.config.preferTextRange);D?(z=e,a.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return"None"!=b.type||p.getDocument(b.createRange().parentElement())==a}):F?(z=d,a.isSelectionValid=function(){return!0}):c.fail("Neither document.selection or window.getSelection() detected.");a.getNativeSelection=z;var F=z(),v=a.createNativeRange(document),N=p.getBody(document),R=q.areHostObjects(F,q.areHostProperties(F,["anchorOffset","focusOffset"]));
a.features.selectionHasAnchorAndFocus=R;var h=q.isHostMethod(F,"extend");a.features.selectionHasExtend=h;var S="number"==typeof F.rangeCount;a.features.selectionHasRangeCount=S;var Q=!1,P=!0;q.areHostMethods(F,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof F.rangeCount&&a.features.implementsDomRange&&function(){var a=document.createElement("iframe");a.frameBorder=0;a.style.position="absolute";a.style.left="-10000px";N.appendChild(a);var b=p.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");
b.close();var c=p.getIframeWindow(a).getSelection(),d=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(d,1);b.collapse(true);c.addRange(b);P=c.rangeCount==1;c.removeAllRanges();var h=b.cloneRange();b.setStart(d,0);h.setEnd(d,2);c.addRange(b);c.addRange(h);Q=c.rangeCount==2;b.detach();h.detach();N.removeChild(a)}();a.features.selectionSupportsMultipleRanges=Q;a.features.collapsedNonEditableSelectionsSupported=P;var J=!1,u;N&&q.isHostMethod(N,"createControlRange")&&(u=N.createControlRange(),
q.areHostProperties(u,["item","add"])&&(J=!0));a.features.implementsControlRange=J;C=R?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:false};var I;q.isHostMethod(F,"getRangeAt")?I=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:R&&(I=function(b){var c=p.getDocument(b.anchorNode),c=a.createRange(c);c.setStart(b.anchorNode,b.anchorOffset);c.setEnd(b.focusNode,b.focusOffset);if(c.collapsed!==
this.isCollapsed){c.setStart(b.focusNode,b.focusOffset);c.setEnd(b.anchorNode,b.anchorOffset)}return c});a.getSelection=function(a){var a=a||window,b=a._rangySelection,c=z(a),d=H?e(a):null;if(b){b.nativeSelection=c;b.docSelection=d;b.refresh(a)}else{b=new n(c,d,a);a._rangySelection=b}return b};a.getIframeSelection=function(b){return a.getSelection(p.getIframeWindow(b))};u=n.prototype;if(!D&&R&&q.areHostMethods(F,["removeAllRanges","addRange"])){u.removeAllRanges=function(){this.nativeSelection.removeAllRanges();
i(this)};var G=function(b,c){var d=x.getRangeDocument(c),d=a.createRange(d);d.collapseToPoint(c.endContainer,c.endOffset);b.nativeSelection.addRange(f(d));b.nativeSelection.extend(c.startContainer,c.startOffset);b.refresh()};u.addRange=S?function(b,c){if(J&&H&&this.docSelection.type=="Control")o(this,b);else if(c&&h)G(this,b);else{var d;if(Q)d=this.rangeCount;else{this.removeAllRanges();d=0}this.nativeSelection.addRange(f(b));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==d+1){if(a.config.checkSelectionRanges)(d=
I(this.nativeSelection,this.rangeCount-1))&&!x.rangesEqual(d,b)&&(b=new w(d));this._ranges[this.rangeCount-1]=b;g(this,b,t(this.nativeSelection));this.isCollapsed=C(this)}else this.refresh()}}:function(a,b){if(b&&h)G(this,a);else{this.nativeSelection.addRange(f(a));this.refresh()}};u.setRanges=function(a){if(J&&a.length>1)m(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(q.isHostMethod(F,"empty")&&q.isHostMethod(v,"select")&&J&&D)u.removeAllRanges=
function(){try{this.docSelection.empty();if(this.docSelection.type!="None"){var a;if(this.anchorNode)a=p.getDocument(this.anchorNode);else if(this.docSelection.type=="Control"){var b=this.docSelection.createRange();b.length&&(a=p.getDocument(b.item(0)).body.createTextRange())}if(a){a.body.createTextRange().select();this.docSelection.empty()}}}catch(c){}i(this)},u.addRange=function(a){if(this.docSelection.type=="Control")o(this,a);else{w.rangeToTextRange(a).select();this._ranges[0]=a;this.rangeCount=
1;this.isCollapsed=this._ranges[0].collapsed;g(this,a,false)}},u.setRanges=function(a){this.removeAllRanges();var b=a.length;b>1?m(this,a):b&&this.addRange(a[0])};else return c.fail("No means of selecting a Range or TextRange was found"),!1;u.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new A("INDEX_SIZE_ERR");return this._ranges[a]};var M;if(D)M=function(b){var c;if(a.isSelectionValid(b.win))c=b.docSelection.createRange();else{c=p.getBody(b.win.document).createTextRange();c.collapse(true)}b.docSelection.type==
"Control"?l(b):c&&typeof c.text!="undefined"?j(b,c):i(b)};else if(q.isHostMethod(F,"getRangeAt")&&"number"==typeof F.rangeCount)M=function(b){if(J&&H&&b.docSelection.type=="Control")l(b);else{b._ranges.length=b.rangeCount=b.nativeSelection.rangeCount;if(b.rangeCount){for(var c=0,d=b.rangeCount;c<d;++c)b._ranges[c]=new a.WrappedRange(b.nativeSelection.getRangeAt(c));g(b,b._ranges[b.rangeCount-1],t(b.nativeSelection));b.isCollapsed=C(b)}else i(b)}};else if(R&&"boolean"==typeof F.isCollapsed&&"boolean"==
typeof v.collapsed&&a.features.implementsDomRange)M=function(a){var b;b=a.nativeSelection;if(b.anchorNode){b=I(b,0);a._ranges=[b];a.rangeCount=1;b=a.nativeSelection;a.anchorNode=b.anchorNode;a.anchorOffset=b.anchorOffset;a.focusNode=b.focusNode;a.focusOffset=b.focusOffset;a.isCollapsed=C(a)}else i(a)};else return c.fail("No means of obtaining a Range or TextRange from the user's selection was found"),!1;u.refresh=function(a){var b=a?this._ranges.slice(0):null;M(this);if(a){a=b.length;if(a!=this._ranges.length)return false;
for(;a--;)if(!x.rangesEqual(b[a],this._ranges[a]))return false;return true}};var k=function(a,b){var c=a.getAllRanges(),d=false;a.removeAllRanges();for(var h=0,k=c.length;h<k;++h)d||b!==c[h]?a.addRange(c[h]):d=true;a.rangeCount||i(a)};u.removeRange=J?function(a){if(this.docSelection.type=="Control"){for(var c=this.docSelection.createRange(),a=b(a),d=p.getDocument(c.item(0)),d=p.getBody(d).createControlRange(),h,g=false,e=0,f=c.length;e<f;++e){h=c.item(e);h!==a||g?d.add(c.item(e)):g=true}d.select();
l(this)}else k(this,a)}:function(a){k(this,a)};var t;!D&&R&&a.features.implementsDomRange?(t=function(a){var b=false;a.anchorNode&&(b=p.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset)==1);return b},u.isBackwards=function(){return t(this)}):t=u.isBackwards=function(){return false};u.toString=function(){for(var a=[],b=0,c=this.rangeCount;b<c;++b)a[b]=""+this._ranges[b];return a.join("")};u.collapse=function(b,c){r(this,b);var d=a.createRange(p.getDocument(b));d.collapseToPoint(b,
c);this.removeAllRanges();this.addRange(d);this.isCollapsed=true};u.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new A("INVALID_STATE_ERR");};u.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new A("INVALID_STATE_ERR");};u.selectAllChildren=function(b){r(this,b);var c=a.createRange(p.getDocument(b));c.selectNodeContents(b);this.removeAllRanges();
this.addRange(c)};u.deleteFromDocument=function(){if(J&&H&&this.docSelection.type=="Control"){for(var a=this.docSelection.createRange(),b;a.length;){b=a.item(0);a.remove(b);b.parentNode.removeChild(b)}this.refresh()}else if(this.rangeCount){a=this.getAllRanges();this.removeAllRanges();b=0;for(var c=a.length;b<c;++b)a[b].deleteContents();this.addRange(a[c-1])}};u.getAllRanges=function(){return this._ranges.slice(0)};u.setSingleRange=function(a){this.setRanges([a])};u.containsNode=function(a,b){for(var c=
...
s;a.Selection=n;a.selectionPrototype=u;a.addCreateMissingNativeApiListener(function(b){if(typeof b.getSelection=="undefined")b.getSelection=function(){return a.getSelection(this)};b=null})});
rangy.createModule("CssClassApplier",function(a,c){function d(a,b){return a.className&&RegExp("(?:^|\\s)"+b+"(?:\\s|$)").test(a.className)}function e(a,b){a.className?d(a,b)||(a.className+=" "+b):a.className=b}function g(a){return a.split(/\s+/).sort().join(" ")}function i(a,b){return g(a.className)==g(b.className)}function f(a){for(var b=a.parentNode;a.hasChildNodes();)b.insertBefore(a.firstChild,a);b.removeChild(a)}function b(a,b){var c=a.cloneRange();c.selectNodeContents(b);var d=c.intersection(a),
d=d?d.toString():"";c.detach();return""!=d}function j(a){return a.getNodes([3],function(c){return b(a,c)})}function l(a,b){if(a.attributes.length!=b.attributes.length)return!1;for(var c=0,d=a.attributes.length,g,e;c<d;++c)if(g=a.attributes[c],e=g.name,"class"!=e&&(e=b.attributes.getNamedItem(e),g.specified!=e.specified||g.specified&&g.nodeValue!==e.nodeValue))return!1;return!0}function o(a,b){for(var c=0,d=a.attributes.length,g;c<d;++c)if(g=a.attributes[c].name,(!b||!A.arrayContains(b,g))&&a.attributes[c].specified&&
"class"!=g)return!0;return!1}function n(a){var b;return a&&1==a.nodeType&&((b=a.parentNode)&&9==b.nodeType&&"on"==b.designMode||C(a)&&!C(a.parentNode))}function m(a){return(C(a)||1!=a.nodeType&&C(a.parentNode))&&!n(a)}function r(a){return a&&1==a.nodeType&&!F.test(z(a,"display"))}function s(a){if(0==a.data.length)return!0;if(H.test(a.data))return!1;switch(z(a.parentNode,"whiteSpace")){case "pre":case "pre-wrap":case "-moz-pre-wrap":return!1;case "pre-line":if(/[\r\n]/.test(a.data))return!1}return r(a.previousSibling)||
r(a.nextSibling)}function p(a,b,d,g){var e,f=0==d;if(A.isAncestorOf(b,a))return a;if(A.isCharacterDataNode(b))if(0==d)d=A.getNodeIndex(b),b=b.parentNode;else if(d==b.length)d=A.getNodeIndex(b)+1,b=b.parentNode;else throw c.createError("splitNodeAt should not be called with offset in the middle of a data node ("+d+" in "+b.data);if(A.isCharacterDataNode(b)?0==d?b.previousSibling:d==b.length?b.nextSibling:1:0<d&&d<b.childNodes.length){if(!e){e=b.cloneNode(!1);for(e.id&&e.removeAttribute("id");f=b.childNodes[d];)e.appendChild(f);
A.insertAfter(e,b)}return b==a?e:p(a,e.parentNode,A.getNodeIndex(e),g)}return a!=b?(e=b.parentNode,b=A.getNodeIndex(b),f||b++,p(a,e,b,g)):a}function q(a){var b=a?"nextSibling":"previousSibling";return function(c,d){var g=c.parentNode,e=c[b];if(e){if(e&&3==e.nodeType)return e}else if(d&&(e=g[b])&&1==e.nodeType&&g.tagName==e.tagName&&i(g,e)&&l(g,e))return e[a?"firstChild":"lastChild"];return null}}function x(a){this.firstTextNode=(this.isElementMerge=1==a.nodeType)?a.lastChild:a;this.textNodes=[this.firstTextNode]}
function w(a,b,c){this.cssClass=a;var d,e,f=null;if("object"==typeof b&&null!==b){c=b.tagNames;f=b.elementProperties;for(d=0;e=N[d++];)b.hasOwnProperty(e)&&(this[e]=b[e]);d=b.normalize}else d=b;this.normalize="undefined"==typeof d?!0:d;this.attrExceptions=[];d=document.createElement(this.elementTagName);this.elementProperties={};for(var i in f)f.hasOwnProperty(i)&&(R.hasOwnProperty(i)&&(i=R[i]),d[i]=f[i],this.elementProperties[i]=d[i],this.attrExceptions.push(i));this.elementSortedClassName=this.elementProperties.hasOwnProperty("className")?
g(this.elementProperties.className+" "+a):a;this.applyToAnyTagName=!1;a=typeof c;if("string"==a)"*"==c?this.applyToAnyTagName=!0:this.tagNames=c.toLowerCase().replace(/^\s\s*/,"").replace(/\s\s*$/,"").split(/\s*,\s*/);else if("object"==a&&"number"==typeof c.length){this.tagNames=[];d=0;for(a=c.length;d<a;++d)"*"==c[d]?this.applyToAnyTagName=!0:this.tagNames.push(c[d].toLowerCase())}else this.tagNames=[this.elementTagName]}a.requireModules(["WrappedSelection","WrappedRange"]);var A=a.dom,E=function(){function a(b,
c,d){return c&&d?" ":""}return function(b,c){b.className&&(b.className=b.className.replace(RegExp("(?:^|\\s)"+c+"(?:\\s|$)"),a))}}(),z;"undefined"!=typeof window.getComputedStyle?z=function(a,b){return A.getWindow(a).getComputedStyle(a,null)[b]}:"undefined"!=typeof document.documentElement.currentStyle?z=function(a,b){return a.currentStyle[b]}:c.fail("No means of obtaining computed style properties found");var C;(function(){C="boolean"==typeof document.createElement("div").isContentEditable?function(a){return a&&
1==a.nodeType&&a.isContentEditable}:function(a){return!a||1!=a.nodeType||"false"==a.contentEditable?!1:"true"==a.contentEditable||C(a.parentNode)}})();var F=/^inline(-block|-table)?$/i,H=/[^\r\n\t\f \u200B]/,D=q(!1),v=q(!0);x.prototype={doMerge:function(){for(var a=[],b,c,d=0,e=this.textNodes.length;d<e;++d)b=this.textNodes[d],c=b.parentNode,a[d]=b.data,d&&(c.removeChild(b),c.hasChildNodes()||c.parentNode.removeChild(c));return this.firstTextNode.data=a=a.join("")},getLength:function(){for(var a=
this.textNodes.length,b=0;a--;)b+=this.textNodes[a].length;return b},toString:function(){for(var a=[],b=0,c=this.textNodes.length;b<c;++b)a[b]="'"+this.textNodes[b].data+"'";return"[Merge("+a.join(",")+")]"}};var N=["elementTagName","ignoreWhiteSpace","applyToEditableOnly"],R={"class":"className"};w.prototype={elementTagName:"span",elementProperties:{},ignoreWhiteSpace:!0,applyToEditableOnly:!1,hasClass:function(a){return 1==a.nodeType&&A.arrayContains(this.tagNames,a.tagName.toLowerCase())&&d(a,
this.cssClass)},getSelfOrAncestorWithClass:function(a){for(;a;){if(this.hasClass(a,this.cssClass))return a;a=a.parentNode}return null},isModifiable:function(a){return!this.applyToEditableOnly||m(a)},isIgnorableWhiteSpaceNode:function(a){return this.ignoreWhiteSpace&&a&&3==a.nodeType&&s(a)},postApply:function(a,b,c){for(var d=a[0],e=a[a.length-1],g=[],f,i=d,j=e,k=0,t=e.length,l,m,n=0,r=a.length;n<r;++n)if(l=a[n],m=D(l,!c)){if(f||(f=new x(m),g.push(f)),f.textNodes.push(l),l===d&&(i=f.firstTextNode,
k=i.length),l===e)j=f.firstTextNode,t=f.getLength()}else f=null;if(a=v(e,!c))f||(f=new x(e),g.push(f)),f.textNodes.push(a);if(g.length){n=0;for(r=g.length;n<r;++n)g[n].doMerge();b.setStart(i,k);b.setEnd(j,t)}},createContainer:function(b){b=b.createElement(this.elementTagName);a.util.extend(b,this.elementProperties);e(b,this.cssClass);return b},applyToTextNode:function(a){var b=a.parentNode;1==b.childNodes.length&&A.arrayContains(this.tagNames,b.tagName.toLowerCase())?e(b,this.cssClass):(b=this.createContainer(A.getDocument(a)),
a.parentNode.insertBefore(b,a),b.appendChild(a))},isRemovable:function(a){var b;if(b=a.tagName.toLowerCase()==this.elementTagName)if(b=g(a.className)==this.elementSortedClassName){var c;a:{b=this.elementProperties;for(c in b)if(b.hasOwnProperty(c)&&a[c]!==b[c]){c=!1;break a}c=!0}b=c&&!o(a,this.attrExceptions)&&this.isModifiable(a)}return b},undoToTextNode:function(a,b,c){b.containsNode(c)||(a=b.cloneRange(),a.selectNode(c),a.isPointInRange(b.endContainer,b.endOffset)&&(p(c,b.endContainer,b.endOffset,
[b]),b.setEndAfter(c)),a.isPointInRange(b.startContainer,b.startOffset)&&(c=p(c,b.startContainer,b.startOffset,[b])));this.isRemovable(c)?f(c):E(c,this.cssClass)},applyToRange:function(a){a.splitBoundaries();var b=j(a);if(b.length){for(var c,d=0,e=b.length;d<e;++d)c=b[d],!this.isIgnorableWhiteSpaceNode(c)&&!this.getSelfOrAncestorWithClass(c)&&this.isModifiable(c)&&this.applyToTextNode(c);a.setStart(b[0],0);c=b[b.length-1];a.setEnd(c,c.length);this.normalize&&this.postApply(b,a,!1)}},applyToSelection:function(b){var b=
a.getSelection(b||window),c,d=b.getAllRanges();b.removeAllRanges();for(var e=d.length;e--;)c=d[e],this.applyToRange(c),b.addRange(c)},undoToRange:function(a){a.splitBoundaries();var b=j(a),c,d,e=b[b.length-1];if(b.length){for(var g=0,f=b.length;g<f;++g)c=b[g],(d=this.getSelfOrAncestorWithClass(c))&&this.isModifiable(c)&&this.undoToTextNode(c,a,d),a.setStart(b[0],0),a.setEnd(e,e.length);this.normalize&&this.postApply(b,a,!0)}},undoToSelection:function(b){var b=a.getSelection(b||window),c=b.getAllRanges(),
d;b.removeAllRanges();for(var e=0,g=c.length;e<g;++e)d=c[e],this.undoToRange(d),b.addRange(d)},getTextSelectedByRange:function(a,b){var c=b.cloneRange();c.selectNodeContents(a);var d=c.intersection(b),d=d?d.toString():"";c.detach();return d},isAppliedToRange:function(a){if(a.collapsed)return!!this.getSelfOrAncestorWithClass(a.commonAncestorContainer);for(var c=a.getNodes([3]),d=0,e;e=c[d++];)if(!this.isIgnorableWhiteSpaceNode(e)&&b(a,e)&&this.isModifiable(e)&&!this.getSelfOrAncestorWithClass(e))return!1;
return!0},isAppliedToSelection:function(b){for(var b=a.getSelection(b||window).getAllRanges(),c=b.length;c--;)if(!this.isAppliedToRange(b[c]))return!1;return!0},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)},toggleSelection:function(a){this.isAppliedToSelection(a)?this.undoToSelection(a):this.applyToSelection(a)},detach:function(){}};w.util={hasClass:d,addClass:e,removeClass:E,hasSameClasses:i,replaceWithOwnChildren:f,elementsHaveSameNonClassAttributes:l,
elementHasNonClassAttributes:o,splitNodeAt:p,isEditableElement:C,isEditingHost:n,isEditable:m};a.CssClassApplier=w;a.createCssClassApplier=function(a,b,c){return new w(a,b,c)}});
rangy.createModule("SaveRestore",function(a,c){function d(a,c){var d="selectionBoundary_"+ +new Date+"_"+(""+Math.random()).slice(2),e,g=f.getDocument(a.startContainer),i=a.cloneRange();i.collapse(c);e=g.createElement("span");e.id=d;e.style.lineHeight="0";e.style.display="none";e.className="rangySelectionBoundary";e.appendChild(g.createTextNode(b));i.insertNode(e);i.detach();return e}function e(a,b,d,e){(a=(a||document).getElementById(d))?(b[e?"setStartBefore":"setEndBefore"](a),a.parentNode.removeChild(a)):
c.warn("Marker element has been removed. Cannot restore selection.")}function g(a,b){return b.compareBoundaryPoints(a.START_TO_START,a)}function i(a,b){var c=(a||document).getElementById(b);c&&c.parentNode.removeChild(c)}a.requireModules(["DomUtil","DomRange","WrappedRange"]);var f=a.dom,b="\ufeff";a.saveSelection=function(b){var b=b||window,e=b.document;if(a.isSelectionValid(b)){var f=a.getSelection(b),i=f.getAllRanges(),m=[],r,s;i.sort(g);for(var p=0,q=i.length;p<q;++p)r=i[p],r.collapsed?(s=d(r,
!1),m.push({markerId:s.id,collapsed:!0})):(s=d(r,!1),r=d(r,!0),m[p]={startMarkerId:r.id,endMarkerId:s.id,collapsed:!1,backwards:1==i.length&&f.isBackwards()});for(p=q-1;0<=p;--p)r=i[p],r.collapsed?r.collapseBefore((e||document).getElementById(m[p].markerId)):(r.setEndBefore((e||document).getElementById(m[p].endMarkerId)),r.setStartAfter((e||document).getElementById(m[p].startMarkerId)));f.setRanges(i);return{win:b,doc:e,rangeInfos:m,restored:!1}}c.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
a.restoreSelection=function(b,d){if(!b.restored){for(var g=b.rangeInfos,f=a.getSelection(b.win),i=[],r=g.length,s=r-1,p,q;0<=s;--s){p=g[s];q=a.createRange(b.doc);if(p.collapsed)if(p=(b.doc||document).getElementById(p.markerId)){p.style.display="inline";var x=p.previousSibling;x&&3==x.nodeType?(p.parentNode.removeChild(p),q.collapseToPoint(x,x.length)):(q.collapseBefore(p),p.parentNode.removeChild(p))}else c.warn("Marker element has been removed. Cannot restore selection.");else e(b.doc,q,p.startMarkerId,
!0),e(b.doc,q,p.endMarkerId,!1);1==r&&q.normalizeBoundaries();i[s]=q}1==r&&d&&a.features.selectionHasExtend&&g[0].backwards?(f.removeAllRanges(),f.addRange(i[0],!0)):f.setRanges(i);b.restored=!0}};a.removeMarkerElement=i;a.removeMarkers=function(a){for(var b=a.rangeInfos,c=0,d=b.length,e;c<d;++c)e=b[c],e.collapsed?i(a.doc,e.markerId):(i(a.doc,e.startMarkerId),i(a.doc,e.endMarkerId))}});
rangy.createModule("Serializer",function(a,c){function d(a,b){var b=b||[],c=a.nodeType,e=a.childNodes,g=e.length,f=[c,a.nodeName,g].join(":"),i="",j="";switch(c){case 3:i=a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;");break;case 8:i="<\!--"+a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;")+"--\>";break;default:i="<"+f+">",j="</>"}i&&b.push(i);for(c=0;c<g;++c)d(e[c],b);j&&b.push(j);return b}function e(a){a=d(a).join("");return n(a).toString(16)}function g(a,b,c){for(var d=[],e=a,c=c||m.getDocument(a).documentElement;e&&
e!=c;)d.push(m.getNodeIndex(e,!0)),e=e.parentNode;return d.join("/")+":"+b}function i(a,b,d){b?d||m.getDocument(b):b=(d||document).documentElement;for(var a=a.split(":"),d=a[0]?a[0].split("/"):[],e=d.length,g;e--;)if(g=parseInt(d[e],10),g<b.childNodes.length)b=b.childNodes[parseInt(d[e],10)];else throw c.createError("deserializePosition failed: node "+m.inspectNode(b)+" has no child with index "+g+", "+e);return new m.DomPosition(b,parseInt(a[1],10))}function f(b,c,d){d=d||a.DomRange.getRangeDocument(b).documentElement;
if(!m.isAncestorOf(d,b.commonAncestorContainer,!0))throw Error("serializeRange: range is not wholly contained within specified root node");b=g(b.startContainer,b.startOffset,d)+","+g(b.endContainer,b.endOffset,d);c||(b+="{"+e(d)+"}");return b}function b(b,c,d){c?d=d||m.getDocument(c):(d=d||document,c=d.documentElement);var b=/^([^,]+),([^,\{]+)({([^}]+)})?$/.exec(b),g=b[4],f=e(c);if(g&&g!==e(c))throw Error("deserializeRange: checksums of serialized range root node ("+g+") and target root node ("+
f+") do not match");g=i(b[1],c,d);c=i(b[2],c,d);d=a.createRange(d);d.setStart(g.node,g.offset);d.setEnd(c.node,c.offset);return d}function j(a,b,c){b?c||m.getDocument(b):b=(c||document).documentElement;a=/^([^,]+),([^,]+)({([^}]+)})?$/.exec(a)[3];return!a||a===e(b)}function l(b,c,d){for(var b=b||a.getSelection(),b=b.getAllRanges(),e=[],g=0,i=b.length;g<i;++g)e[g]=f(b[g],c,d);return e.join("|")}function o(c,d,e){d?e=e||m.getWindow(d):(e=e||window,d=e.document.documentElement);for(var c=c.split("|"),
g=a.getSelection(e),f=[],i=0,j=c.length;i<j;++i)f[i]=b(c[i],d,e.document);g.setRanges(f);return g}a.requireModules(["WrappedSelection","WrappedRange"]);("undefined"==typeof encodeURIComponent||"undefined"==typeof decodeURIComponent)&&c.fail("Global object is missing encodeURIComponent and/or decodeURIComponent method");var n=function(){var a=null;return function(b){for(var c=[],d=0,e=b.length,g;d<e;++d)g=b.charCodeAt(d),128>g?c.push(g):2048>g?c.push(g>>6|192,g&63|128):c.push(g>>12|224,g>>6&63|128,
g&63|128);b=-1;if(!a){for(var d=[],e=0,f;256>e;++e){f=e;for(g=8;g--;)f=1==(f&1)?f>>>1^3988292384:f>>>1;d[e]=f>>>0}a=d}d=a;e=0;for(g=c.length;e<g;++e)f=(b^c[e])&255,b=b>>>8^d[f];return(b^-1)>>>0}}(),m=a.dom;a.serializePosition=g;a.deserializePosition=i;a.serializeRange=f;a.deserializeRange=b;a.canDeserializeRange=j;a.serializeSelection=l;a.deserializeSelection=o;a.canDeserializeSelection=function(a,b,c){var d;b?d=c?c.document:m.getDocument(b):b=(c||window).document.documentElement;for(var a=a.split("|"),
c=0,e=a.length;c<e;++c)if(!j(a[c],b,d))return!1;return!0};a.restoreSelectionFromCookie=function(a){var a=a||window,b;a:{b=a.document.cookie.split(/[;,]/);for(var c=0,d=b.length,e;c<d;++c)if(e=b[c].split("="),"rangySerializedSelection"==e[0].replace(/^\s+/,"")&&(e=e[1])){b=decodeURIComponent(e.replace(/\s+$/,""));break a}b=null}b&&o(b,a.doc)};a.saveSelectionCookie=function(b,c){var b=b||window,c="object"==typeof c?c:{},d=c.expires?";expires="+c.expires.toUTCString():"",e=c.path?";path="+c.path:"",
g=c.domain?";domain="+c.domain:"",f=c.secure?";secure":"",i=l(a.getSelection(b));b.document.cookie=encodeURIComponent("rangySerializedSelection")+"="+encodeURIComponent(i)+d+e+g+f};a.getElementChecksum=e});
(function(a,c){function d(a){var b=S[a]={},c,d,a=a.split(/\s+/);c=0;for(d=a.length;c<d;c++)b[a[c]]=!0;return b}function e(a,b,d){if(d===c&&1===a.nodeType)if(d="data-"+b.replace(J,"-$1").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:h.isNumeric(d)?+d:P.test(d)?h.parseJSON(d):d}catch(e){}h.data(a,b,d)}else d=c;return d}function g(a){for(var b in a)if(!("data"===b&&h.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function i(a,b,c){var d=
b+"defer",e=b+"queue",g=b+"mark",k=h._data(a,d);k&&("queue"===c||!h._data(a,e))&&("mark"===c||!h._data(a,g))&&setTimeout(function(){!h._data(a,e)&&!h._data(a,g)&&(h.removeData(a,d,!0),k.fire())},0)}function f(){return!1}function b(){return!0}function j(a,b,c){b=b||0;if(h.isFunction(b))return h.grep(a,function(a,d){return!!b.call(a,d,a)===c});if(b.nodeType)return h.grep(a,function(a){return a===b===c});if("string"===typeof b){var d=h.grep(a,function(a){return 1===a.nodeType});if(Wa.test(b))return h.filter(b,
d,!c);b=h.filter(b,d)}return h.grep(a,function(a){return 0<=h.inArray(a,b)===c})}function l(a){var b=Da.split("|"),a=a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());return a}function o(a,b){if(1===b.nodeType&&h.hasData(a)){var c,d,e;d=h._data(a);var g=h._data(b,d),k=d.events;if(k)for(c in delete g.handle,g.events={},k){d=0;for(e=k[c].length;d<e;d++)h.event.add(b,c,k[c][d])}g.data&&(g.data=h.extend({},g.data))}}function n(a,b){var c;if(1===b.nodeType){b.clearAttributes&&
...
function m(a){return"undefined"!==typeof a.getElementsByTagName?a.getElementsByTagName("*"):"undefined"!==typeof a.querySelectorAll?a.querySelectorAll("*"):[]}function r(a){if("checkbox"===a.type||"radio"===a.type)a.defaultChecked=a.checked}function s(a){var b=(a.nodeName||"").toLowerCase();"input"===b?r(a):"script"!==b&&"undefined"!==typeof a.getElementsByTagName&&h.grep(a.getElementsByTagName("input"),r)}function p(a,b,c){var d="width"===b?a.offsetWidth:a.offsetHeight,e="width"===b?1:0;if(0<d){if("border"!==
c)for(;4>e;e+=2)c||(d-=parseFloat(h.css(a,"padding"+Z[e]))||0),d="margin"===c?d+(parseFloat(h.css(a,c+Z[e]))||0):d-(parseFloat(h.css(a,"border"+Z[e]+"Width"))||0);return d+"px"}d=ca(a,b);if(0>d||null==d)d=a.style[b];if(va.test(d))return d;d=parseFloat(d)||0;if(c)for(;4>e;e+=2)d+=parseFloat(h.css(a,"padding"+Z[e]))||0,"padding"!==c&&(d+=parseFloat(h.css(a,"border"+Z[e]+"Width"))||0),"margin"===c&&(d+=parseFloat(h.css(a,c+Z[e]))||0);return d+"px"}function q(a){return function(b,c){"string"!==typeof b&&
(c=b,b="*");if(h.isFunction(c))for(var d=b.toLowerCase().split(Ka),e=0,g=d.length,k,f;e<g;e++)k=d[e],(f=/^\+/.test(k))&&(k=k.substr(1)||"*"),k=a[k]=a[k]||[],k[f?"unshift":"push"](c)}}function x(a,b,d,e,g,k){g=g||b.dataTypes[0];k=k||{};k[g]=!0;for(var g=a[g],f=0,i=g?g.length:0,h=a===wa,j;f<i&&(h||!j);f++)j=g[f](b,d,e),"string"===typeof j&&(!h||k[j]?j=c:(b.dataTypes.unshift(j),j=x(a,b,d,e,j,k)));if((h||!j)&&!k["*"])j=x(a,b,d,e,"*",k);return j}function w(a,b){var d,e,g=h.ajaxSettings.flatOptions||{};
for(d in b)b[d]!==c&&((g[d]?a:e||(e={}))[d]=b[d]);e&&h.extend(!0,a,e)}function A(a,b,c,d){if(h.isArray(b))h.each(b,function(b,e){c||db.test(a)?d(a,e):A(a+"["+("object"===typeof e?b:"")+"]",e,c,d)});else if(!c&&"object"===h.type(b))for(var e in b)A(a+"["+e+"]",b[e],c,d);else d(a,b)}function E(){try{return new a.XMLHttpRequest}catch(b){}}function z(){setTimeout(C,0);return oa=h.now()}function C(){oa=c}function F(a,b){var c={};h.each(pa.concat.apply([],pa.slice(0,b)),function(){c[this]=a});return c}
function H(a){if(!xa[a]){var b=v.body,c=h("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d){W||(W=v.createElement("iframe"),W.frameBorder=W.width=W.height=0);b.appendChild(W);if(!da||!W.createElement)da=(W.contentWindow||W.contentDocument).document,da.write((h.support.boxModel?"<!doctype html>":"")+"<html><body>"),da.close();c=da.createElement(a);da.body.appendChild(c);d=h.css(c,"display");b.removeChild(W)}xa[a]=d}return xa[a]}function D(a){return h.isWindow(a)?a:9===a.nodeType?
a.defaultView||a.parentWindow:!1}var v=a.document,N=a.navigator,R=a.location,h=function(){function b(){if(!d.isReady){try{v.documentElement.doScroll("left")}catch(a){setTimeout(b,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,k)},e=a.jQuery,g=a.$,k,f=/^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,i=/\S/,h=/^\s+/,j=/\s+$/,t=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,l=/^[\],:{}\s]*$/,m=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,y=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,n=/(?:^|:|,)(?:\s*\[)+/g,
o=/(webkit)[ \/]([\w.]+)/,r=/(opera)(?:.*version)?[ \/]([\w.]+)/,L=/(msie) ([\w.]+)/,s=/(mozilla)(?:.*? rv:([\w.]+))?/,p=/-([a-z]|[0-9])/ig,K=/^-ms-/,q=function(a,b){return(b+"").toUpperCase()},O=N.userAgent,qa,ea,eb=Object.prototype.toString,ya=Object.prototype.hasOwnProperty,w=Array.prototype.push,x=Array.prototype.slice,u=String.prototype.trim,La=Array.prototype.indexOf,U={};d.fn=d.prototype={constructor:d,init:function(a,b,e){var B;if(!a)return this;if(a.nodeType)return this.context=this[0]=a,
this.length=1,this;if("body"===a&&!b&&v.body)return this.context=v,this[0]=v.body,this.selector=a,this.length=1,this;if("string"===typeof a){if((B="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:f.exec(a))&&(B[1]||!b)){if(B[1])return e=(b=b instanceof d?b[0]:b)?b.ownerDocument||b:v,(a=t.exec(a))?d.isPlainObject(b)?(a=[v.createElement(a[1])],d.fn.attr.call(a,b,!0)):a=[e.createElement(a[1])]:(a=d.buildFragment([B[1]],[e]),a=(a.cacheable?d.clone(a.fragment):a.fragment).childNodes),
d.merge(this,a);if((b=v.getElementById(B[2]))&&b.parentNode){if(b.id!==B[2])return e.find(a);this.length=1;this[0]=b}this.context=v;this.selector=a;return this}return!b||b.jquery?(b||e).find(a):this.constructor(b).find(a)}if(d.isFunction(a))return e.ready(a);a.selector!==c&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,this)},selector:"",jquery:"1.7.2",length:0,size:function(){return this.length},toArray:function(){return x.call(this,0)},get:function(a){return null==a?this.toArray():
0>a?this[this.length+a]:this[a]},pushStack:function(a,b,c){var e=this.constructor();d.isArray(a)?w.apply(e,a):d.merge(e,a);e.prevObject=this;e.context=this.context;"find"===b?e.selector=this.selector+(this.selector?" ":"")+c:b&&(e.selector=this.selector+"."+b+"("+c+")");return e},each:function(a,b){return d.each(this,a,b)},ready:function(a){d.bindReady();qa.add(a);return this},eq:function(a){a=+a;return-1===a?this.slice(a):this.slice(a,a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},
slice:function(){return this.pushStack(x.apply(this,arguments),"slice",x.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:w,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,b,e,B,g,k=arguments[0]||{},f=1,i=arguments.length,h=!1;"boolean"===typeof k&&(h=k,k=arguments[1]||{},f=2);"object"!==typeof k&&!d.isFunction(k)&&(k=
{});i===f&&(k=this,--f);for(;f<i;f++)if(null!=(a=arguments[f]))for(b in a)e=k[b],B=a[b],k!==B&&(h&&B&&(d.isPlainObject(B)||(g=d.isArray(B)))?(g?(g=!1,e=e&&d.isArray(e)?e:[]):e=e&&d.isPlainObject(e)?e:{},k[b]=d.extend(h,e,B)):B!==c&&(k[b]=B));return k};d.extend({noConflict:function(b){a.$===d&&(a.$=g);b&&a.jQuery===d&&(a.jQuery=e);return d},isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!v.body)return setTimeout(d.ready,
1);d.isReady=!0;!0!==a&&0<--d.readyWait||(qa.fireWith(v,[d]),d.fn.trigger&&d(v).trigger("ready").off("ready"))}},bindReady:function(){if(!qa){qa=d.Callbacks("once memory");if("complete"===v.readyState)return setTimeout(d.ready,1);if(v.addEventListener)v.addEventListener("DOMContentLoaded",ea,!1),a.addEventListener("load",d.ready,!1);else if(v.attachEvent){v.attachEvent("onreadystatechange",ea);a.attachEvent("onload",d.ready);var c=!1;try{c=null==a.frameElement}catch(e){}v.documentElement.doScroll&&
c&&b()}}},isFunction:function(a){return"function"===d.type(a)},isArray:Array.isArray||function(a){return"array"===d.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!isNaN(parseFloat(a))&&isFinite(a)},type:function(a){return null==a?""+a:U[eb.call(a)]||"object"},isPlainObject:function(a){if(!a||"object"!==d.type(a)||a.nodeType||d.isWindow(a))return!1;try{if(a.constructor&&!ya.call(a,"constructor")&&!ya.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(b){return!1}for(var e in a);
return e===c||ya.call(a,e)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(l.test(b.replace(m,"@").replace(y,"]").replace(n,"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b){if("string"!==typeof b||!b)return null;var e,B;try{a.DOMParser?(B=new DOMParser,e=B.parseFromString(b,"text/xml")):
(e=new ActiveXObject("Microsoft.XMLDOM"),e.async="false",e.loadXML(b))}catch(k){e=c}(!e||!e.documentElement||e.getElementsByTagName("parsererror").length)&&d.error("Invalid XML: "+b);return e},noop:function(){},globalEval:function(b){b&&i.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(K,"ms-").replace(p,q)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,b,e){var B,k=0,g=a.length,f=g===c||d.isFunction(a);
if(e)if(f)for(B in a){if(!1===b.apply(a[B],e))break}else for(;k<g&&!1!==b.apply(a[k++],e););else if(f)for(B in a){if(!1===b.call(a[B],B,a[B]))break}else for(;k<g&&!1!==b.call(a[k],k,a[k++]););return a},trim:u?function(a){return null==a?"":u.call(a)}:function(a){return null==a?"":a.toString().replace(h,"").replace(j,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var e=d.type(a);null==a.length||"string"===e||"function"===e||"regexp"===e||d.isWindow(a)?w.call(c,a):d.merge(c,a)}return c},inArray:function(a,
b,c){var d;if(b){if(La)return La.call(b,a,c);d=b.length;for(c=c?0>c?Math.max(0,d+c):c:0;c<d;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,b){var d=a.length,e=0;if("number"===typeof b.length)for(var B=b.length;e<B;e++)a[d++]=b[e];else for(;b[e]!==c;)a[d++]=b[e++];a.length=d;return a},grep:function(a,b,c){for(var d=[],e,c=!!c,B=0,k=a.length;B<k;B++)e=!!b(a[B],B),c!==e&&d.push(a[B]);return d},map:function(a,b,e){var B,k,g=[],f=0,i=a.length;if(a instanceof d||i!==c&&"number"===typeof i&&
(0<i&&a[0]&&a[i-1]||0===i||d.isArray(a)))for(;f<i;f++)B=b(a[f],f,e),null!=B&&(g[g.length]=B);else for(k in a)B=b(a[k],k,e),null!=B&&(g[g.length]=B);return g.concat.apply([],g)},guid:1,proxy:function(a,b){if("string"===typeof b)var e=a[b],b=a,a=e;if(!d.isFunction(a))return c;var B=x.call(arguments,2),e=function(){return a.apply(b,B.concat(x.call(arguments)))};e.guid=a.guid=a.guid||e.guid||d.guid++;return e},access:function(a,b,e,B,k,g,f){var i,h=null==e,j=0,t=a.length;if(e&&"object"===typeof e){for(j in e)d.access(a,
b,j,e[j],1,g,B);k=1}else if(B!==c){i=f===c&&d.isFunction(B);h&&(i?(i=b,b=function(a,b,c){return i.call(d(a),c)}):(b.call(a,B),b=null));if(b)for(;j<t;j++)b(a[j],e,i?B.call(a[j],j,b(a[j],e)):B,f);k=1}return k?a:h?b.call(a):t?b(a[0],e):g},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=o.exec(a)||r.exec(a)||L.exec(a)||0>a.indexOf("compatible")&&s.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,
a,this);a.superclass=this;a.fn=a.prototype=this();a.fn.constructor=a;a.sub=this.sub;a.fn.init=function(c,e){e&&e instanceof d&&!(e instanceof a)&&(e=a(e));return d.fn.init.call(this,c,e,b)};a.fn.init.prototype=a.fn;var b=a(v);return a},browser:{}});d.each("Boolean,Number,String,Function,Array,Date,RegExp,Object".split(","),function(a,b){U["[object "+b+"]"]=b.toLowerCase()});O=d.uaMatch(O);O.browser&&(d.browser[O.browser]=!0,d.browser.version=O.version);d.browser.webkit&&(d.browser.safari=!0);i.test("\u00a0")&&
(h=/^[\s\xA0]+/,j=/[\s\xA0]+$/);k=d(v);v.addEventListener?ea=function(){v.removeEventListener("DOMContentLoaded",ea,false);d.ready()}:v.attachEvent&&(ea=function(){if(v.readyState==="complete"){v.detachEvent("onreadystatechange",ea);d.ready()}});return d}(),S={};h.Callbacks=function(a){var a=a?S[a]||d(a):{},b=[],e=[],k,g,f,i,j,t,l=function(c){var d,e,k,g;d=0;for(e=c.length;d<e;d++)k=c[d],g=h.type(k),"array"===g?l(k):"function"===g&&(!a.unique||!y.has(k))&&b.push(k)},m=function(c,d){d=d||[];k=!a.memory||
[c,d];f=g=!0;t=i||0;i=0;for(j=b.length;b&&t<j;t++)if(!1===b[t].apply(c,d)&&a.stopOnFalse){k=!0;break}f=!1;b&&(a.once?!0===k?y.disable():b=[]:e&&e.length&&(k=e.shift(),y.fireWith(k[0],k[1])))},y={add:function(){if(b){var a=b.length;l(arguments);f?j=b.length:k&&!0!==k&&(i=a,m(k[0],k[1]))}return this},remove:function(){if(b)for(var c=arguments,d=0,e=c.length;d<e;d++)for(var k=0;k<b.length&&!(c[d]===b[k]&&(f&&k<=j&&(j--,k<=t&&t--),b.splice(k--,1),a.unique));k++);return this},has:function(a){if(b)for(var c=
0,d=b.length;c<d;c++)if(a===b[c])return!0;return!1},empty:function(){b=[];return this},disable:function(){b=e=k=c;return this},disabled:function(){return!b},lock:function(){e=c;(!k||!0===k)&&y.disable();return this},locked:function(){return!e},fireWith:function(b,c){e&&(f?a.once||e.push([b,c]):(!a.once||!k)&&m(b,c));return this},fire:function(){y.fireWith(this,arguments);return this},fired:function(){return!!g}};return y};var Q=[].slice;h.extend({Deferred:function(a){var b=h.Callbacks("once memory"),
c=h.Callbacks("once memory"),d=h.Callbacks("memory"),e="pending",k={resolve:b,reject:c,notify:d},g={done:b.add,fail:c.add,progress:d.add,state:function(){return e},isResolved:b.fired,isRejected:c.fired,then:function(a,b,c){f.done(a).fail(b).progress(c);return this},always:function(){f.done.apply(f,arguments).fail.apply(f,arguments);return this},pipe:function(a,b,c){return h.Deferred(function(d){h.each({done:[a,"resolve"],fail:[b,"reject"],progress:[c,"notify"]},function(a,b){var c=b[0],e=b[1],B;if(h.isFunction(c))f[a](function(){if((B=
c.apply(this,arguments))&&h.isFunction(B.promise))B.promise().then(d.resolve,d.reject,d.notify);else d[e+"With"](this===f?d:this,[B])});else f[a](d[e])})}).promise()},promise:function(a){if(null==a)a=g;else for(var b in g)a[b]=g[b];return a}},f=g.promise({}),i;for(i in k)f[i]=k[i].fire,f[i+"With"]=k[i].fireWith;f.done(function(){e="resolved"},c.disable,d.lock).fail(function(){e="rejected"},b.disable,d.lock);a&&a.call(f,f);return f},when:function(a){function b(a){return function(b){d[a]=1<arguments.length?
Q.call(arguments,0):b;--f||i.resolveWith(i,d)}}function c(a){return function(b){g[a]=1<arguments.length?Q.call(arguments,0):b;i.notifyWith(j,g)}}var d=Q.call(arguments,0),e=0,k=d.length,g=Array(k),f=k,i=1>=k&&a&&h.isFunction(a.promise)?a:h.Deferred(),j=i.promise();if(1<k){for(;e<k;e++)d[e]&&d[e].promise&&h.isFunction(d[e].promise)?d[e].promise().then(b(e),i.reject,c(e)):--f;f||i.resolveWith(i,d)}else i!==a&&i.resolveWith(i,k?[a]:[]);return j}});h.support=function(){var b,c,d,e,k,g,f,i,j=v.createElement("div");
j.setAttribute("className","t");j.innerHTML="   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>";c=j.getElementsByTagName("*");d=j.getElementsByTagName("a")[0];if(!c||!c.length||!d)return{};e=v.createElement("select");k=e.appendChild(v.createElement("option"));c=j.getElementsByTagName("input")[0];b={leadingWhitespace:3===j.firstChild.nodeType,tbody:!j.getElementsByTagName("tbody").length,htmlSerialize:!!j.getElementsByTagName("link").length,
style:/top/.test(d.getAttribute("style")),hrefNormalized:"/a"===d.getAttribute("href"),opacity:/^0.55/.test(d.style.opacity),cssFloat:!!d.style.cssFloat,checkOn:"on"===c.value,optSelected:k.selected,getSetAttribute:"t"!==j.className,enctype:!!v.createElement("form").enctype,html5Clone:"<:nav></:nav>"!==v.createElement("nav").cloneNode(!0).outerHTML,submitBubbles:!0,changeBubbles:!0,focusinBubbles:!1,deleteExpando:!0,noCloneEvent:!0,inlineBlockNeedsLayout:!1,shrinkWrapBlocks:!1,reliableMarginRight:!0,
pixelMargin:!0};h.boxModel=b.boxModel="CSS1Compat"===v.compatMode;c.checked=!0;b.noCloneChecked=c.cloneNode(!0).checked;e.disabled=!0;b.optDisabled=!k.disabled;try{delete j.test}catch(t){b.deleteExpando=!1}!j.addEventListener&&j.attachEvent&&j.fireEvent&&(j.attachEvent("onclick",function(){b.noCloneEvent=!1}),j.cloneNode(!0).fireEvent("onclick"));c=v.createElement("input");c.value="t";c.setAttribute("type","radio");b.radioValue="t"===c.value;c.setAttribute("checked","checked");c.setAttribute("name",
"t");j.appendChild(c);d=v.createDocumentFragment();d.appendChild(j.lastChild);b.checkClone=d.cloneNode(!0).cloneNode(!0).lastChild.checked;b.appendChecked=c.checked;d.removeChild(c);d.appendChild(j);if(j.attachEvent)for(f in{submit:1,change:1,focusin:1})c="on"+f,i=c in j,i||(j.setAttribute(c,"return;"),i="function"===typeof j[c]),b[f+"Bubbles"]=i;d.removeChild(j);d=e=k=j=c=null;h(function(){var c,d,e,k,f=v.getElementsByTagName("body")[0];if(f){c=v.createElement("div");c.style.cssText="padding:0;margin:0;border:0;visibility:hidden;width:0;height:0;position:static;top:0;margin-top:1px";
f.insertBefore(c,f.firstChild);j=v.createElement("div");c.appendChild(j);j.innerHTML="<table><tr><td style='padding:0;margin:0;border:0;display:none'></td><td>t</td></tr></table>";g=j.getElementsByTagName("td");i=g[0].offsetHeight===0;g[0].style.display="";g[1].style.display="none";b.reliableHiddenOffsets=i&&g[0].offsetHeight===0;if(a.getComputedStyle){j.innerHTML="";d=v.createElement("div");d.style.width="0";d.style.marginRight="0";j.style.width="2px";j.appendChild(d);b.reliableMarginRight=(parseInt((a.getComputedStyle(d,
...
j.innerHTML="<div style='position:absolute;top:0;left:0;width:1px;height:1px;padding:0;margin:0;border:5px solid #000;display:block;'><div style='padding:0;margin:0;border:0;display:block;overflow:hidden;'></div></div><table style='position:absolute;top:0;left:0;width:1px;height:1px;padding:0;margin:0;border:5px solid #000;' cellpadding='0' cellspacing='0'><tr><td></td></tr></table>";d=j.firstChild;e=d.firstChild;k={doesNotAddBorder:e.offsetTop!==5,doesAddBorderForTableAndCells:d.nextSibling.firstChild.firstChild.offsetTop===
5};e.style.position="fixed";e.style.top="20px";k.fixedPosition=e.offsetTop===20||e.offsetTop===15;e.style.position=e.style.top="";d.style.overflow="hidden";d.style.position="relative";k.subtractsBorderForOverflowNotVisible=e.offsetTop===-5;k.doesNotIncludeMarginInBodyOffset=f.offsetTop!==1;if(a.getComputedStyle){j.style.marginTop="1%";b.pixelMargin=(a.getComputedStyle(j,null)||{marginTop:0}).marginTop!=="1%"}if(typeof c.style.zoom!=="undefined")c.style.zoom=1;f.removeChild(c);j=null;h.extend(b,k)}});
return b}();var P=/^(?:\{.*\}|\[.*\])$/,J=/([A-Z])/g;h.extend({cache:{},uuid:0,expando:"jQuery"+(h.fn.jquery+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(a){a=a.nodeType?h.cache[a[h.expando]]:a[h.expando];return!!a&&!g(a)},data:function(a,b,d,e){if(h.acceptData(a)){var k;k=h.expando;var g="string"===typeof b,f=a.nodeType,i=f?h.cache:a,j=f?a[k]:a[k]&&k,t="events"===b;if(j&&i[j]&&(t||e||i[j].data)||!(g&&d===c)){j||
(f?a[k]=j=++h.uuid:j=k);i[j]||(i[j]={},f||(i[j].toJSON=h.noop));if("object"===typeof b||"function"===typeof b)e?i[j]=h.extend(i[j],b):i[j].data=h.extend(i[j].data,b);k=a=i[j];e||(a.data||(a.data={}),a=a.data);d!==c&&(a[h.camelCase(b)]=d);if(t&&!a[b])return k.events;g?(d=a[b],null==d&&(d=a[h.camelCase(b)])):d=a;return d}}},removeData:function(a,b,c){if(h.acceptData(a)){var d,e,k,f=h.expando,i=a.nodeType,j=i?h.cache:a,t=i?a[f]:f;if(j[t]){if(b&&(d=c?j[t]:j[t].data)){h.isArray(b)||(b in d?b=[b]:(b=h.camelCase(b),
b=b in d?[b]:b.split(" ")));e=0;for(k=b.length;e<k;e++)delete d[b[e]];if(!(c?g:h.isEmptyObject)(d))return}if(!c&&(delete j[t].data,!g(j[t])))return;h.support.deleteExpando||!j.setInterval?delete j[t]:j[t]=null;i&&(h.support.deleteExpando?delete a[f]:a.removeAttribute?a.removeAttribute(f):a[f]=null)}}},_data:function(a,b,c){return h.data(a,b,c,!0)},acceptData:function(a){if(a.nodeName){var b=h.noData[a.nodeName.toLowerCase()];if(b)return!(!0===b||a.getAttribute("classid")!==b)}return!0}});h.fn.extend({data:function(a,
b){var d,k,g,f,i,j=this[0],t=0,l=null;if(a===c){if(this.length&&(l=h.data(j),1===j.nodeType&&!h._data(j,"parsedAttrs"))){g=j.attributes;for(i=g.length;t<i;t++)f=g[t].name,0===f.indexOf("data-")&&(f=h.camelCase(f.substring(5)),e(j,f,l[f]));h._data(j,"parsedAttrs",!0)}return l}if("object"===typeof a)return this.each(function(){h.data(this,a)});d=a.split(".",2);d[1]=d[1]?"."+d[1]:"";k=d[1]+"!";return h.access(this,function(b){if(b===c)return l=this.triggerHandler("getData"+k,[d[0]]),l===c&&j&&(l=h.data(j,
a),l=e(j,a,l)),l===c&&d[1]?this.data(d[0]):l;d[1]=b;this.each(function(){var c=h(this);c.triggerHandler("setData"+k,d);h.data(this,a,b);c.triggerHandler("changeData"+k,d)})},null,b,1<arguments.length,null,!1)},removeData:function(a){return this.each(function(){h.removeData(this,a)})}});h.extend({_mark:function(a,b){a&&(b=(b||"fx")+"mark",h._data(a,b,(h._data(a,b)||0)+1))},_unmark:function(a,b,c){!0!==a&&(c=b,b=a,a=!1);if(b){var c=c||"fx",d=c+"mark";(a=a?0:(h._data(b,d)||1)-1)?h._data(b,d,a):(h.removeData(b,
d,!0),i(b,c,"mark"))}},queue:function(a,b,c){var d;if(a)return b=(b||"fx")+"queue",d=h._data(a,b),c&&(!d||h.isArray(c)?d=h._data(a,b,h.makeArray(c)):d.push(c)),d||[]},dequeue:function(a,b){var b=b||"fx",c=h.queue(a,b),d=c.shift(),e={};"inprogress"===d&&(d=c.shift());d&&("fx"===b&&c.unshift("inprogress"),h._data(a,b+".run",e),d.call(a,function(){h.dequeue(a,b)},e));c.length||(h.removeData(a,b+"queue "+b+".run",!0),i(a,b,"queue"))}});h.fn.extend({queue:function(a,b){var d=2;"string"!==typeof a&&(b=
a,a="fx",d--);return arguments.length<d?h.queue(this[0],a):b===c?this:this.each(function(){var c=h.queue(this,a,b);a==="fx"&&c[0]!=="inprogress"&&h.dequeue(this,a)})},dequeue:function(a){return this.each(function(){h.dequeue(this,a)})},delay:function(a,b){a=h.fx?h.fx.speeds[a]||a:a;return this.queue(b||"fx",function(b,c){var d=setTimeout(b,a);c.stop=function(){clearTimeout(d)}})},clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,b){function d(){--f||e.resolveWith(k,[k])}"string"!==
typeof a&&(b=a,a=c);for(var a=a||"fx",e=h.Deferred(),k=this,g=k.length,f=1,i=a+"defer",j=a+"queue",t=a+"mark",l;g--;)if(l=h.data(k[g],i,c,!0)||(h.data(k[g],j,c,!0)||h.data(k[g],t,c,!0))&&h.data(k[g],i,h.Callbacks("once memory"),!0))f++,l.add(d);d();return e.promise(b)}});var u=/[\n\t\r]/g,I=/\s+/,G=/\r/g,M=/^(?:button|input)$/i,k=/^(?:button|input|object|select|textarea)$/i,t=/^a(?:rea)?$/i,y=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,
L=h.support.getSetAttribute,K,O,U;h.fn.extend({attr:function(a,b){return h.access(this,h.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){h.removeAttr(this,a)})},prop:function(a,b){return h.access(this,h.prop,a,b,1<arguments.length)},removeProp:function(a){a=h.propFix[a]||a;return this.each(function(){try{this[a]=c,delete this[a]}catch(b){}})},addClass:function(a){var b,c,d,e,k,g,f;if(h.isFunction(a))return this.each(function(b){h(this).addClass(a.call(this,b,this.className))});
if(a&&"string"===typeof a){b=a.split(I);c=0;for(d=this.length;c<d;c++)if(e=this[c],1===e.nodeType)if(!e.className&&1===b.length)e.className=a;else{k=" "+e.className+" ";g=0;for(f=b.length;g<f;g++)~k.indexOf(" "+b[g]+" ")||(k+=b[g]+" ");e.className=h.trim(k)}}return this},removeClass:function(a){var b,d,e,k,g,f,i;if(h.isFunction(a))return this.each(function(b){h(this).removeClass(a.call(this,b,this.className))});if(a&&"string"===typeof a||a===c){b=(a||"").split(I);d=0;for(e=this.length;d<e;d++)if(k=
this[d],1===k.nodeType&&k.className)if(a){g=(" "+k.className+" ").replace(u," ");f=0;for(i=b.length;f<i;f++)g=g.replace(" "+b[f]+" "," ");k.className=h.trim(g)}else k.className=""}return this},toggleClass:function(a,b){var c=typeof a,d="boolean"===typeof b;return h.isFunction(a)?this.each(function(c){h(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===c)for(var e,k=0,g=h(this),f=b,i=a.split(I);e=i[k++];)f=d?f:!g.hasClass(e),g[f?"addClass":"removeClass"](e);
else if("undefined"===c||"boolean"===c)this.className&&h._data(this,"__className__",this.className),this.className=this.className||!1===a?"":h._data(this,"__className__")||""})},hasClass:function(a){for(var a=" "+a+" ",b=0,c=this.length;b<c;b++)if(1===this[b].nodeType&&-1<(" "+this[b].className+" ").replace(u," ").indexOf(a))return!0;return!1},val:function(a){var b,d,e,k=this[0];if(arguments.length)return e=h.isFunction(a),this.each(function(d){var k=h(this);if(1===this.nodeType&&(d=e?a.call(this,
d,k.val()):a,null==d?d="":"number"===typeof d?d+="":h.isArray(d)&&(d=h.map(d,function(a){return a==null?"":a+""})),b=h.valHooks[this.type]||h.valHooks[this.nodeName.toLowerCase()],!b||!("set"in b)||b.set(this,d,"value")===c))this.value=d});if(k){if((b=h.valHooks[k.type]||h.valHooks[k.nodeName.toLowerCase()])&&"get"in b&&(d=b.get(k,"value"))!==c)return d;d=k.value;return"string"===typeof d?d.replace(G,""):null==d?"":d}}});h.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||
b.specified?a.value:a.text}},select:{get:function(a){var b,c,d=a.selectedIndex,e=[],k=a.options,g="select-one"===a.type;if(0>d)return null;a=g?d:0;for(c=g?d+1:k.length;a<c;a++)if(b=k[a],b.selected&&(h.support.optDisabled?!b.disabled:null===b.getAttribute("disabled"))&&(!b.parentNode.disabled||!h.nodeName(b.parentNode,"optgroup"))){b=h(b).val();if(g)return b;e.push(b)}return g&&!e.length&&k.length?h(k[d]).val():e},set:function(a,b){var c=h.makeArray(b);h(a).find("option").each(function(){this.selected=
0<=h.inArray(h(this).val(),c)});c.length||(a.selectedIndex=-1);return c}}},attrFn:{val:!0,css:!0,html:!0,text:!0,data:!0,width:!0,height:!0,offset:!0},attr:function(a,b,d,e){var k,g,f=a.nodeType;if(a&&!(3===f||8===f||2===f)){if(e&&b in h.attrFn)return h(a)[b](d);if("undefined"===typeof a.getAttribute)return h.prop(a,b,d);if(e=1!==f||!h.isXMLDoc(a))b=b.toLowerCase(),g=h.attrHooks[b]||(y.test(b)?O:K);if(d!==c)if(null===d)h.removeAttr(a,b);else{if(g&&"set"in g&&e&&(k=g.set(a,d,b))!==c)return k;a.setAttribute(b,
""+d);return d}else{if(g&&"get"in g&&e&&null!==(k=g.get(a,b)))return k;k=a.getAttribute(b);return null===k?c:k}}},removeAttr:function(a,b){var c,d,e,k,g,f=0;if(b&&1===a.nodeType){d=b.toLowerCase().split(I);for(k=d.length;f<k;f++)if(e=d[f])c=h.propFix[e]||e,(g=y.test(e))||h.attr(a,e,""),a.removeAttribute(L?e:c),g&&c in a&&(a[c]=!1)}},attrHooks:{type:{set:function(a,b){if(M.test(a.nodeName)&&a.parentNode)h.error("type property can't be changed");else if(!h.support.radioValue&&"radio"===b&&h.nodeName(a,
"input")){var c=a.value;a.setAttribute("type",b);c&&(a.value=c);return b}}},value:{get:function(a,b){return K&&h.nodeName(a,"button")?K.get(a,b):b in a?a.value:null},set:function(a,b,c){if(K&&h.nodeName(a,"button"))return K.set(a,b,c);a.value=b}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},
prop:function(a,b,d){var e,k,g=a.nodeType;if(a&&!(3===g||8===g||2===g)){if(1!==g||!h.isXMLDoc(a))b=h.propFix[b]||b,k=h.propHooks[b];return d!==c?k&&"set"in k&&(e=k.set(a,d,b))!==c?e:a[b]=d:k&&"get"in k&&null!==(e=k.get(a,b))?e:a[b]}},propHooks:{tabIndex:{get:function(a){var b=a.getAttributeNode("tabindex");return b&&b.specified?parseInt(b.value,10):k.test(a.nodeName)||t.test(a.nodeName)&&a.href?0:c}}}});h.attrHooks.tabindex=h.propHooks.tabIndex;O={get:function(a,b){var d,e=h.prop(a,b);return!0===
e||"boolean"!==typeof e&&(d=a.getAttributeNode(b))&&!1!==d.nodeValue?b.toLowerCase():c},set:function(a,b,c){!1===b?h.removeAttr(a,c):(b=h.propFix[c]||c,b in a&&(a[b]=!0),a.setAttribute(c,c.toLowerCase()));return c}};L||(U={name:!0,id:!0,coords:!0},K=h.valHooks.button={get:function(a,b){var d;return(d=a.getAttributeNode(b))&&(U[b]?""!==d.nodeValue:d.specified)?d.nodeValue:c},set:function(a,b,c){var d=a.getAttributeNode(c);d||(d=v.createAttribute(c),a.setAttributeNode(d));return d.nodeValue=b+""}},
h.attrHooks.tabindex.set=K.set,h.each(["width","height"],function(a,b){h.attrHooks[b]=h.extend(h.attrHooks[b],{set:function(a,c){if(""===c)return a.setAttribute(b,"auto"),c}})}),h.attrHooks.contenteditable={get:K.get,set:function(a,b,c){""===b&&(b="false");K.set(a,b,c)}});h.support.hrefNormalized||h.each(["href","src","width","height"],function(a,b){h.attrHooks[b]=h.extend(h.attrHooks[b],{get:function(a){a=a.getAttribute(b,2);return a===null?c:a}})});h.support.style||(h.attrHooks.style={get:function(a){return a.style.cssText.toLowerCase()||
c},set:function(a,b){return a.style.cssText=""+b}});h.support.optSelected||(h.propHooks.selected=h.extend(h.propHooks.selected,{get:function(a){if(a=a.parentNode){a.selectedIndex;a.parentNode&&a.parentNode.selectedIndex}return null}}));h.support.enctype||(h.propFix.enctype="encoding");h.support.checkOn||h.each(["radio","checkbox"],function(){h.valHooks[this]={get:function(a){return a.getAttribute("value")===null?"on":a.value}}});h.each(["radio","checkbox"],function(){h.valHooks[this]=h.extend(h.valHooks[this],
{set:function(a,b){if(h.isArray(b))return a.checked=h.inArray(h(a).val(),b)>=0}})});var V=/^(?:textarea|input|select)$/i,ba=/^([^\.]*)?(?:\.(.+))?$/,Ja=/(?:^|\s)hover(\.\S+)?\b/,ka=/^key/,ga=/^(?:mouse|contextmenu)|click/,ha=/^(?:focusinfocus|focusoutblur)$/,ua=/^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/,la=function(a){if(a=ua.exec(a)){a[1]=(a[1]||"").toLowerCase();a[3]=a[3]&&RegExp("(?:^|\\s)"+a[3]+"(?:\\s|$)")}return a},ia=function(a){return h.event.special.hover?a:a.replace(Ja,"mouseenter$1 mouseleave$1")};
h.event={add:function(a,b,d,e,k){var g,f,i,j,t,l,m,y,n;if(!(a.nodeType===3||a.nodeType===8||!b||!d||!(g=h._data(a)))){if(d.handler){m=d;d=m.handler;k=m.selector}if(!d.guid)d.guid=h.guid++;i=g.events;if(!i)g.events=i={};f=g.handle;if(!f){g.handle=f=function(a){return typeof h!=="undefined"&&(!a||h.event.triggered!==a.type)?h.event.dispatch.apply(f.elem,arguments):c};f.elem=a}b=h.trim(ia(b)).split(" ");for(g=0;g<b.length;g++){j=ba.exec(b[g])||[];t=j[1];l=(j[2]||"").split(".").sort();n=h.event.special[t]||
{};t=(k?n.delegateType:n.bindType)||t;n=h.event.special[t]||{};j=h.extend({type:t,origType:j[1],data:e,handler:d,guid:d.guid,selector:k,quick:k&&la(k),namespace:l.join(".")},m);y=i[t];if(!y){y=i[t]=[];y.delegateCount=0;if(!n.setup||n.setup.call(a,e,l,f)===false)a.addEventListener?a.addEventListener(t,f,false):a.attachEvent&&a.attachEvent("on"+t,f)}if(n.add){n.add.call(a,j);if(!j.handler.guid)j.handler.guid=d.guid}k?y.splice(y.delegateCount++,0,j):y.push(j);h.event.global[t]=true}a=null}},global:{},
remove:function(a,b,c,d,e){var k=h.hasData(a)&&h._data(a),g,f,i,j,t,l,y,m,n,o;if(k&&(y=k.events)){b=h.trim(ia(b||"")).split(" ");for(g=0;g<b.length;g++){f=ba.exec(b[g])||[];i=j=f[1];f=f[2];if(i){m=h.event.special[i]||{};i=(d?m.delegateType:m.bindType)||i;n=y[i]||[];t=n.length;f=f?RegExp("(^|\\.)"+f.split(".").sort().join("\\.(?:.*\\.)?")+"(\\.|$)"):null;for(l=0;l<n.length;l++){o=n[l];if((e||j===o.origType)&&(!c||c.guid===o.guid)&&(!f||f.test(o.namespace))&&(!d||d===o.selector||d==="**"&&o.selector)){n.splice(l--,
1);o.selector&&n.delegateCount--;m.remove&&m.remove.call(a,o)}}if(n.length===0&&t!==n.length){(!m.teardown||m.teardown.call(a,f)===false)&&h.removeEvent(a,i,k.handle);delete y[i]}}else for(i in y)h.event.remove(a,i+b[g],c,d,true)}if(h.isEmptyObject(y)){if(b=k.handle)b.elem=null;h.removeData(a,["events","handle"],true)}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(b,d,e,k){if(!e||!(e.nodeType===3||e.nodeType===8)){var g=b.type||b,f=[],i,j,t,l,m;if(!ha.test(g+h.event.triggered)){if(g.indexOf("!")>=
0){g=g.slice(0,-1);i=true}if(g.indexOf(".")>=0){f=g.split(".");g=f.shift();f.sort()}if(e&&!h.event.customEvent[g]||h.event.global[g]){b=typeof b==="object"?b[h.expando]?b:new h.Event(g,b):new h.Event(g);b.type=g;b.isTrigger=true;b.exclusive=i;b.namespace=f.join(".");b.namespace_re=b.namespace?RegExp("(^|\\.)"+f.join("\\.(?:.*\\.)?")+"(\\.|$)"):null;i=g.indexOf(":")<0?"on"+g:"";if(e){b.result=c;if(!b.target)b.target=e;d=d!=null?h.makeArray(d):[];d.unshift(b);t=h.event.special[g]||{};if(!(t.trigger&&
t.trigger.apply(e,d)===false)){m=[[e,t.bindType||g]];if(!k&&!t.noBubble&&!h.isWindow(e)){l=t.delegateType||g;f=ha.test(l+g)?e:e.parentNode;for(j=null;f;f=f.parentNode){m.push([f,l]);j=f}j&&j===e.ownerDocument&&m.push([j.defaultView||j.parentWindow||a,l])}for(j=0;j<m.length&&!b.isPropagationStopped();j++){f=m[j][0];b.type=m[j][1];(l=(h._data(f,"events")||{})[b.type]&&h._data(f,"handle"))&&l.apply(f,d);(l=i&&f[i])&&h.acceptData(f)&&l.apply(f,d)===false&&b.preventDefault()}b.type=g;if(!k&&!b.isDefaultPrevented()&&
(!t._default||t._default.apply(e.ownerDocument,d)===false)&&!(g==="click"&&h.nodeName(e,"a"))&&h.acceptData(e))if(i&&e[g]&&(g!=="focus"&&g!=="blur"||b.target.offsetWidth!==0)&&!h.isWindow(e)){(j=e[i])&&(e[i]=null);h.event.triggered=g;e[g]();h.event.triggered=c;j&&(e[i]=j)}return b.result}}else{e=h.cache;for(j in e)e[j].events&&e[j].events[g]&&h.event.trigger(b,d,e[j].handle.elem,true)}}}}},dispatch:function(b){var b=h.event.fix(b||a.event),d=(h._data(this,"events")||{})[b.type]||[],e=d.delegateCount,
k=[].slice.call(arguments,0),g=!b.exclusive&&!b.namespace,f=h.event.special[b.type]||{},i=[],j,t,l,m,y,n,o;k[0]=b;b.delegateTarget=this;if(!(f.preDispatch&&f.preDispatch.call(this,b)===false)){if(e&&!(b.button&&b.type==="click")){l=h(this);l.context=this.ownerDocument||this;for(t=b.target;t!=this;t=t.parentNode||this)if(t.disabled!==true){y={};n=[];l[0]=t;for(j=0;j<e;j++){m=d[j];o=m.selector;if(y[o]===c){var r=y,L=o,s;if(m.quick){s=m.quick;var p=t.attributes||{};s=(!s[1]||t.nodeName.toLowerCase()===
s[1])&&(!s[2]||(p.id||{}).value===s[2])&&(!s[3]||s[3].test((p["class"]||{}).value))}else s=l.is(o);r[L]=s}y[o]&&n.push(m)}n.length&&i.push({elem:t,matches:n})}}d.length>e&&i.push({elem:this,matches:d.slice(e)});for(j=0;j<i.length&&!b.isPropagationStopped();j++){e=i[j];b.currentTarget=e.elem;for(d=0;d<e.matches.length&&!b.isImmediatePropagationStopped();d++){m=e.matches[d];if(g||!b.namespace&&!m.namespace||b.namespace_re&&b.namespace_re.test(m.namespace)){b.data=m.data;b.handleObj=m;m=((h.event.special[m.origType]||
{}).handle||m.handler).apply(e.elem,k);if(m!==c){b.result=m;if(m===false){b.preventDefault();b.stopPropagation()}}}}}f.postDispatch&&f.postDispatch.call(this,b);return b.result}},props:"attrChange,attrName,relatedNode,srcElement,altKey,bubbles,cancelable,ctrlKey,currentTarget,eventPhase,metaKey,relatedTarget,shiftKey,target,timeStamp,view,which".split(","),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){if(a.which==null)a.which=b.charCode!=null?b.charCode:b.keyCode;
return a}},mouseHooks:{props:"button,buttons,clientX,clientY,fromElement,offsetX,offsetY,pageX,pageY,screenX,screenY,toElement".split(","),filter:function(a,b){var d,e,k=b.button,g=b.fromElement;if(a.pageX==null&&b.clientX!=null){d=a.target.ownerDocument||v;e=d.documentElement;d=d.body;a.pageX=b.clientX+(e&&e.scrollLeft||d&&d.scrollLeft||0)-(e&&e.clientLeft||d&&d.clientLeft||0);a.pageY=b.clientY+(e&&e.scrollTop||d&&d.scrollTop||0)-(e&&e.clientTop||d&&d.clientTop||0)}if(!a.relatedTarget&&g)a.relatedTarget=
g===a.target?b.toElement:g;if(!a.which&&k!==c)a.which=k&1?1:k&2?3:k&4?2:0;return a}},fix:function(a){if(a[h.expando])return a;var b,d,e=a,k=h.event.fixHooks[a.type]||{},g=k.props?this.props.concat(k.props):this.props,a=h.Event(e);for(b=g.length;b;){d=g[--b];a[d]=e[d]}if(!a.target)a.target=e.srcElement||v;if(a.target.nodeType===3)a.target=a.target.parentNode;if(a.metaKey===c)a.metaKey=a.ctrlKey;return k.filter?k.filter(a,e):a},special:{ready:{setup:h.bindReady},load:{noBubble:!0},focus:{delegateType:"focusin"},
...
c,false)}:function(a,b,c){a.detachEvent&&a.detachEvent("on"+b,c)};h.Event=function(a,c){if(!(this instanceof h.Event))return new h.Event(a,c);if(a&&a.type){this.originalEvent=a;this.type=a.type;this.isDefaultPrevented=a.defaultPrevented||a.returnValue===false||a.getPreventDefault&&a.getPreventDefault()?b:f}else this.type=a;c&&h.extend(this,c);this.timeStamp=a&&a.timeStamp||h.now();this[h.expando]=true};h.Event.prototype={preventDefault:function(){this.isDefaultPrevented=b;var a=this.originalEvent;
if(a)a.preventDefault?a.preventDefault():a.returnValue=false},stopPropagation:function(){this.isPropagationStopped=b;var a=this.originalEvent;if(a){a.stopPropagation&&a.stopPropagation();a.cancelBubble=true}},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=b;this.stopPropagation()},isDefaultPrevented:f,isPropagationStopped:f,isImmediatePropagationStopped:f};h.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(a,b){h.event.special[a]={delegateType:b,bindType:b,handle:function(a){var c=
...
postDispatch:function(a){if(a._submit_bubble){delete a._submit_bubble;this.parentNode&&!a.isTrigger&&h.event.simulate("submit",this.parentNode,a,true)}},teardown:function(){if(h.nodeName(this,"form"))return false;h.event.remove(this,"._submit")}});h.support.changeBubbles||(h.event.special.change={setup:function(){if(V.test(this.nodeName)){if(this.type==="checkbox"||this.type==="radio"){h.event.add(this,"propertychange._change",function(a){if(a.originalEvent.propertyName==="checked")this._just_changed=
true});h.event.add(this,"click._change",function(a){if(this._just_changed&&!a.isTrigger){this._just_changed=false;h.event.simulate("change",this,a,true)}})}return false}h.event.add(this,"beforeactivate._change",function(a){a=a.target;if(V.test(a.nodeName)&&!a._change_attached){h.event.add(a,"change._change",function(a){this.parentNode&&!a.isSimulated&&!a.isTrigger&&h.event.simulate("change",this.parentNode,a,true)});a._change_attached=true}})},handle:function(a){var b=a.target;if(this!==b||a.isSimulated||
a.isTrigger||b.type!=="radio"&&b.type!=="checkbox")return a.handleObj.handler.apply(this,arguments)},teardown:function(){h.event.remove(this,"._change");return V.test(this.nodeName)}});h.support.focusinBubbles||h.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){h.event.simulate(b,a.target,h.event.fix(a),true)};h.event.special[b]={setup:function(){c++===0&&v.addEventListener(a,d,true)},teardown:function(){--c===0&&v.removeEventListener(a,d,true)}}});h.fn.extend({on:function(a,
b,d,e,k){var g,i;if(typeof a==="object"){if(typeof b!=="string"){d=d||b;b=c}for(i in a)this.on(i,b,d,a[i],k);return this}if(d==null&&e==null){e=b;d=b=c}else if(e==null)if(typeof b==="string"){e=d;d=c}else{e=d;d=b;b=c}if(e===false)e=f;else if(!e)return this;if(k===1){g=e;e=function(a){h().off(a);return g.apply(this,arguments)};e.guid=g.guid||(g.guid=h.guid++)}return this.each(function(){h.event.add(this,a,e,d,b)})},one:function(a,b,c,d){return this.on(a,b,c,d,1)},off:function(a,b,d){if(a&&a.preventDefault&&
a.handleObj){var e=a.handleObj;h(a.delegateTarget).off(e.namespace?e.origType+"."+e.namespace:e.origType,e.selector,e.handler);return this}if(typeof a==="object"){for(e in a)this.off(e,b,a[e]);return this}if(b===false||typeof b==="function"){d=b;b=c}d===false&&(d=f);return this.each(function(){h.event.remove(this,a,d,b)})},bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,null,b)},live:function(a,b,c){h(this.context).on(a,this.selector,b,c);return this},die:function(a,
...
0?this.on(b,null,a,c):this.trigger(b)};h.attrFn&&(h.attrFn[b]=true);if(ka.test(b))h.event.fixHooks[b]=h.event.keyHooks;if(ga.test(b))h.event.fixHooks[b]=h.event.mouseHooks});(function(){function a(b,c,d,k,g,f){for(var g=0,i=k.length;g<i;g++){var j=k[g];if(j){for(var h=false,j=j[b];j;){if(j[e]===d){h=k[j.sizset];break}if(j.nodeType===1&&!f){j[e]=d;j.sizset=g}if(j.nodeName.toLowerCase()===c){h=j;break}j=j[b]}k[g]=h}}}function b(a,c,d,k,g,f){for(var g=0,i=k.length;g<i;g++){var j=k[g];if(j){for(var h=
false,j=j[a];j;){if(j[e]===d){h=k[j.sizset];break}if(j.nodeType===1){if(!f){j[e]=d;j.sizset=g}if(typeof c!=="string"){if(j===c){h=true;break}}else if(m.filter(c,[j]).length>0){h=j;break}}j=j[a]}k[g]=h}}}var d=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,e="sizcache"+(Math.random()+"").replace(".",""),k=0,g=Object.prototype.toString,f=false,i=true,j=/\\/g,t=/\r\n/g,l=/\W/;[0,0].sort(function(){i=false;return 0});
var m=function(a,b,c,e){var c=c||[],k=b=b||v;if(b.nodeType!==1&&b.nodeType!==9)return[];if(!a||typeof a!=="string")return c;var f,i,j,h,t,B=true,l=m.isXML(b),y=[],r=a;do{d.exec("");if(f=d.exec(r)){r=f[3];y.push(f[1]);if(f[2]){h=f[3];break}}}while(f);if(y.length>1&&o.exec(a))if(y.length===2&&n.relative[y[0]])i=O(y[0]+y[1],b,e);else for(i=n.relative[y[0]]?[b]:m(y.shift(),b);y.length;){a=y.shift();n.relative[a]&&(a=a+y.shift());i=O(a,i,e)}else{if(!e&&y.length>1&&b.nodeType===9&&!l&&n.match.ID.test(y[0])&&
!n.match.ID.test(y[y.length-1])){f=m.find(y.shift(),b,l);b=f.expr?m.filter(f.expr,f.set)[0]:f.set[0]}if(b){f=e?{expr:y.pop(),set:L(e)}:m.find(y.pop(),y.length===1&&(y[0]==="~"||y[0]==="+")&&b.parentNode?b.parentNode:b,l);i=f.expr?m.filter(f.expr,f.set):f.set;for(y.length>0?j=L(i):B=false;y.length;){f=t=y.pop();n.relative[t]?f=y.pop():t="";f==null&&(f=b);n.relative[t](j,f,l)}}else j=[]}j||(j=i);j||m.error(t||a);if(g.call(j)==="[object Array]")if(B)if(b&&b.nodeType===1)for(a=0;j[a]!=null;a++)j[a]&&
(j[a]===true||j[a].nodeType===1&&m.contains(b,j[a]))&&c.push(i[a]);else for(a=0;j[a]!=null;a++)j[a]&&j[a].nodeType===1&&c.push(i[a]);else c.push.apply(c,j);else L(j,c);if(h){m(h,k,c,e);m.uniqueSort(c)}return c};m.uniqueSort=function(a){if(K){f=i;a.sort(K);if(f)for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1)}return a};m.matches=function(a,b){return m(a,null,null,b)};m.matchesSelector=function(a,b){return m(b,null,null,[a]).length>0};m.find=function(a,b,c){var d,e,k,g,f,i;if(!a)return[];e=
0;for(k=n.order.length;e<k;e++){f=n.order[e];if(g=n.leftMatch[f].exec(a)){i=g[1];g.splice(1,1);if(i.substr(i.length-1)!=="\\"){g[1]=(g[1]||"").replace(j,"");d=n.find[f](g,b,c);if(d!=null){a=a.replace(n.match[f],"");break}}}}d||(d=typeof b.getElementsByTagName!=="undefined"?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};m.filter=function(a,b,d,e){for(var k,g,f,i,j,h,t,B,l=a,y=[],o=b,r=b&&b[0]&&m.isXML(b[0]);a&&b.length;){for(f in n.filter)if((k=n.leftMatch[f].exec(a))!=null&&k[2]){h=n.filter[f];
j=k[1];g=false;k.splice(1,1);if(j.substr(j.length-1)!=="\\"){o===y&&(y=[]);if(n.preFilter[f])if(k=n.preFilter[f](k,o,d,y,e,r)){if(k===true)continue}else g=i=true;if(k)for(t=0;(j=o[t])!=null;t++)if(j){i=h(j,k,t,o);B=e^i;if(d&&i!=null)B?g=true:o[t]=false;else if(B){y.push(j);g=true}}if(i!==c){d||(o=y);a=a.replace(n.match[f],"");if(!g)return[];break}}}if(a===l)if(g==null)m.error(a);else break;l=a}return o};m.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};var y=m.getText=
function(a){var b,c;b=a.nodeType;var d="";if(b)if(b===1||b===9||b===11){if(typeof a.textContent==="string")return a.textContent;if(typeof a.innerText==="string")return a.innerText.replace(t,"");for(a=a.firstChild;a;a=a.nextSibling)d=d+y(a)}else{if(b===3||b===4)return a.nodeValue}else for(b=0;c=a[b];b++)c.nodeType!==8&&(d=d+y(c));return d},n=m.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,
ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/,TAG:/^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/,CHILD:/:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/,POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/,PSEUDO:/:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/},leftMatch:{},attrMap:{"class":"className","for":"htmlFor"},attrHandle:{href:function(a){return a.getAttribute("href")},
type:function(a){return a.getAttribute("type")}},relative:{"+":function(a,b){var c=typeof b==="string",d=c&&!l.test(b),c=c&&!d;d&&(b=b.toLowerCase());for(var d=0,e=a.length,k;d<e;d++)if(k=a[d]){for(;(k=k.previousSibling)&&k.nodeType!==1;);a[d]=c||k&&k.nodeName.toLowerCase()===b?k||false:k===b}c&&m.filter(b,a,true)},">":function(a,b){var c,d=typeof b==="string",e=0,k=a.length;if(d&&!l.test(b))for(b=b.toLowerCase();e<k;e++){if(c=a[e]){c=c.parentNode;a[e]=c.nodeName.toLowerCase()===b?c:false}}else{for(;e<
k;e++)(c=a[e])&&(a[e]=d?c.parentNode:c.parentNode===b);d&&m.filter(b,a,true)}},"":function(c,d,e){var g,f=k++,i=b;if(typeof d==="string"&&!l.test(d)){g=d=d.toLowerCase();i=a}i("parentNode",d,f,c,g,e)},"~":function(c,d,e){var g,f=k++,i=b;if(typeof d==="string"&&!l.test(d)){g=d=d.toLowerCase();i=a}i("previousSibling",d,f,c,g,e)}},find:{ID:function(a,b,c){if(typeof b.getElementById!=="undefined"&&!c)return(a=b.getElementById(a[1]))&&a.parentNode?[a]:[]},NAME:function(a,b){if(typeof b.getElementsByName!==
"undefined"){for(var c=[],d=b.getElementsByName(a[1]),e=0,k=d.length;e<k;e++)d[e].getAttribute("name")===a[1]&&c.push(d[e]);return c.length===0?null:c}},TAG:function(a,b){if(typeof b.getElementsByTagName!=="undefined")return b.getElementsByTagName(a[1])}},preFilter:{CLASS:function(a,b,c,d,e,k){a=" "+a[1].replace(j,"")+" ";if(k)return a;for(var k=0,g;(g=b[k])!=null;k++)g&&(e^(g.className&&(" "+g.className+" ").replace(/[\t\n\r]/g," ").indexOf(a)>=0)?c||d.push(g):c&&(b[k]=false));return false},ID:function(a){return a[1].replace(j,
"")},TAG:function(a){return a[1].replace(j,"").toLowerCase()},CHILD:function(a){if(a[1]==="nth"){a[2]||m.error(a[0]);a[2]=a[2].replace(/^\+|\s*/g,"");var b=/(-?)(\d*)(?:n([+\-]?\d*))?/.exec(a[2]==="even"&&"2n"||a[2]==="odd"&&"2n+1"||!/\D/.test(a[2])&&"0n+"+a[2]||a[2]);a[2]=b[1]+(b[2]||1)-0;a[3]=b[3]-0}else a[2]&&m.error(a[0]);a[0]=k++;return a},ATTR:function(a,b,c,d,e,k){b=a[1]=a[1].replace(j,"");!k&&n.attrMap[b]&&(a[1]=n.attrMap[b]);a[4]=(a[4]||a[5]||"").replace(j,"");a[2]==="~="&&(a[4]=" "+a[4]+
" ");return a},PSEUDO:function(a,b,c,e,k){if(a[1]==="not")if((d.exec(a[3])||"").length>1||/^\w/.test(a[3]))a[3]=m(a[3],null,null,b);else{a=m.filter(a[3],b,c,1^k);c||e.push.apply(e,a);return false}else if(n.match.POS.test(a[0])||n.match.CHILD.test(a[0]))return true;return a},POS:function(a){a.unshift(true);return a}},filters:{enabled:function(a){return a.disabled===false&&a.type!=="hidden"},disabled:function(a){return a.disabled===true},checked:function(a){return a.checked===true},selected:function(a){a.parentNode&&
a.parentNode.selectedIndex;return a.selected===true},parent:function(a){return!!a.firstChild},empty:function(a){return!a.firstChild},has:function(a,b,c){return!!m(c[3],a).length},header:function(a){return/h\d/i.test(a.nodeName)},text:function(a){var b=a.getAttribute("type"),c=a.type;return a.nodeName.toLowerCase()==="input"&&"text"===c&&(b===c||b===null)},radio:function(a){return a.nodeName.toLowerCase()==="input"&&"radio"===a.type},checkbox:function(a){return a.nodeName.toLowerCase()==="input"&&
...
b,c,d){var e=b[1],k=n.filters[e];if(k)return k(a,c,b,d);if(e==="contains")return(a.textContent||a.innerText||y([a])||"").indexOf(b[3])>=0;if(e==="not"){b=b[3];c=0;for(d=b.length;c<d;c++)if(b[c]===a)return false;return true}m.error(e)},CHILD:function(a,b){var c,d,k,g,f,i;c=b[1];i=a;switch(c){case "only":case "first":for(;i=i.previousSibling;)if(i.nodeType===1)return false;if(c==="first")return true;i=a;case "last":for(;i=i.nextSibling;)if(i.nodeType===1)return false;return true;case "nth":c=b[2];d=
b[3];if(c===1&&d===0)return true;k=b[0];if((g=a.parentNode)&&(g[e]!==k||!a.nodeIndex)){f=0;for(i=g.firstChild;i;i=i.nextSibling)if(i.nodeType===1)i.nodeIndex=++f;g[e]=k}i=a.nodeIndex-d;return c===0?i===0:i%c===0&&i/c>=0}},ID:function(a,b){return a.nodeType===1&&a.getAttribute("id")===b},TAG:function(a,b){return b==="*"&&a.nodeType===1||!!a.nodeName&&a.nodeName.toLowerCase()===b},CLASS:function(a,b){return(" "+(a.className||a.getAttribute("class"))+" ").indexOf(b)>-1},ATTR:function(a,b){var c=b[1],
c=m.attr?m.attr(a,c):n.attrHandle[c]?n.attrHandle[c](a):a[c]!=null?a[c]:a.getAttribute(c),d=c+"",e=b[2],k=b[4];return c==null?e==="!=":!e&&m.attr?c!=null:e==="="?d===k:e==="*="?d.indexOf(k)>=0:e==="~="?(" "+d+" ").indexOf(k)>=0:!k?d&&c!==false:e==="!="?d!==k:e==="^="?d.indexOf(k)===0:e==="$="?d.substr(d.length-k.length)===k:e==="|="?d===k||d.substr(0,k.length+1)===k+"-":false},POS:function(a,b,c,d){var e=n.setFilters[b[2]];if(e)return e(a,c,b,d)}}},o=n.match.POS,r=function(a,b){return"\\"+(b-0+1)},
s;for(s in n.match){n.match[s]=RegExp(n.match[s].source+/(?![^\[]*\])(?![^\(]*\))/.source);n.leftMatch[s]=RegExp(/(^(?:.|\r|\n)*?)/.source+n.match[s].source.replace(/\\(\d+)/g,r))}n.match.globalPOS=o;var L=function(a,b){a=Array.prototype.slice.call(a,0);if(b){b.push.apply(b,a);return b}return a};try{Array.prototype.slice.call(v.documentElement.childNodes,0)[0].nodeType}catch(p){L=function(a,b){var c=0,d=b||[];if(g.call(a)==="[object Array]")Array.prototype.push.apply(d,a);else if(typeof a.length===
"number")for(var e=a.length;c<e;c++)d.push(a[c]);else for(;a[c];c++)d.push(a[c]);return d}}var K,q;if(v.documentElement.compareDocumentPosition)K=function(a,b){if(a===b){f=true;return 0}return!a.compareDocumentPosition||!b.compareDocumentPosition?a.compareDocumentPosition?-1:1:a.compareDocumentPosition(b)&4?-1:1};else{K=function(a,b){if(a===b){f=true;return 0}if(a.sourceIndex&&b.sourceIndex)return a.sourceIndex-b.sourceIndex;var c,d,e=[],k=[];c=a.parentNode;d=b.parentNode;var g=c;if(c===d)return q(a,
b);if(c){if(!d)return 1}else return-1;for(;g;){e.unshift(g);g=g.parentNode}for(g=d;g;){k.unshift(g);g=g.parentNode}c=e.length;d=k.length;for(g=0;g<c&&g<d;g++)if(e[g]!==k[g])return q(e[g],k[g]);return g===c?q(a,k[g],-1):q(e[g],b,1)};q=function(a,b,c){if(a===b)return c;for(a=a.nextSibling;a;){if(a===b)return-1;a=a.nextSibling}return 1}}(function(){var a=v.createElement("div"),b="script"+(new Date).getTime(),d=v.documentElement;a.innerHTML="<a name='"+b+"'/>";d.insertBefore(a,d.firstChild);if(v.getElementById(b)){n.find.ID=
function(a,b,d){if(typeof b.getElementById!=="undefined"&&!d)return(b=b.getElementById(a[1]))?b.id===a[1]||typeof b.getAttributeNode!=="undefined"&&b.getAttributeNode("id").nodeValue===a[1]?[b]:c:[]};n.filter.ID=function(a,b){var c=typeof a.getAttributeNode!=="undefined"&&a.getAttributeNode("id");return a.nodeType===1&&c&&c.nodeValue===b}}d.removeChild(a);d=a=null})();(function(){var a=v.createElement("div");a.appendChild(v.createComment(""));if(a.getElementsByTagName("*").length>0)n.find.TAG=function(a,
b){var c=b.getElementsByTagName(a[1]);if(a[1]==="*"){for(var d=[],e=0;c[e];e++)c[e].nodeType===1&&d.push(c[e]);c=d}return c};a.innerHTML="<a href='#'></a>";if(a.firstChild&&typeof a.firstChild.getAttribute!=="undefined"&&a.firstChild.getAttribute("href")!=="#")n.attrHandle.href=function(a){return a.getAttribute("href",2)};a=null})();v.querySelectorAll&&function(){var a=m,b=v.createElement("div");b.innerHTML="<p class='TEST'></p>";if(!(b.querySelectorAll&&b.querySelectorAll(".TEST").length===0)){m=
function(b,c,d,e){c=c||v;if(!e&&!m.isXML(c)){var k=/^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(b);if(k&&(c.nodeType===1||c.nodeType===9)){if(k[1])return L(c.getElementsByTagName(b),d);if(k[2]&&n.find.CLASS&&c.getElementsByClassName)return L(c.getElementsByClassName(k[2]),d)}if(c.nodeType===9){if(b==="body"&&c.body)return L([c.body],d);if(k&&k[3]){var g=c.getElementById(k[3]);if(g&&g.parentNode){if(g.id===k[3])return L([g],d)}else return L([],d)}try{return L(c.querySelectorAll(b),d)}catch(f){}}else if(c.nodeType===
1&&c.nodeName.toLowerCase()!=="object"){var k=c,i=(g=c.getAttribute("id"))||"__sizzle__",j=c.parentNode,h=/^\s*[+~]/.test(b);g?i=i.replace(/'/g,"\\$&"):c.setAttribute("id",i);if(h&&j)c=c.parentNode;try{if(!h||j)return L(c.querySelectorAll("[id='"+i+"'] "+b),d)}catch(t){}finally{g||k.removeAttribute("id")}}}return a(b,c,d,e)};for(var c in a)m[c]=a[c];b=null}}();(function(){var a=v.documentElement,b=a.matchesSelector||a.mozMatchesSelector||a.webkitMatchesSelector||a.msMatchesSelector;if(b){var c=!b.call(v.createElement("div"),
"div"),d=false;try{b.call(v.documentElement,"[test!='']:sizzle")}catch(e){d=true}m.matchesSelector=function(a,e){e=e.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!m.isXML(a))try{if(d||!n.match.PSEUDO.test(e)&&!/!=/.test(e)){var k=b.call(a,e);if(k||!c||a.document&&a.document.nodeType!==11)return k}}catch(g){}return m(e,null,null,[a]).length>0}}})();(function(){var a=v.createElement("div");a.innerHTML="<div class='test e'></div><div class='test'></div>";if(a.getElementsByClassName&&a.getElementsByClassName("e").length!==
0){a.lastChild.className="e";if(a.getElementsByClassName("e").length!==1){n.order.splice(1,0,"CLASS");n.find.CLASS=function(a,b,c){if(typeof b.getElementsByClassName!=="undefined"&&!c)return b.getElementsByClassName(a[1])};a=null}}})();m.contains=v.documentElement.contains?function(a,b){return a!==b&&(a.contains?a.contains(b):true)}:v.documentElement.compareDocumentPosition?function(a,b){return!!(a.compareDocumentPosition(b)&16)}:function(){return false};m.isXML=function(a){return(a=(a?a.ownerDocument||
a:0).documentElement)?a.nodeName!=="HTML":false};var O=function(a,b,c){for(var d,e=[],k="",b=b.nodeType?[b]:b;d=n.match.PSEUDO.exec(a);){k=k+d[0];a=a.replace(n.match.PSEUDO,"")}a=n.relative[a]?a+"*":a;d=0;for(var g=b.length;d<g;d++)m(a,b[d],e,c);return m.filter(k,e)};m.attr=h.attr;m.selectors.attrMap={};h.find=m;h.expr=m.selectors;h.expr[":"]=h.expr.filters;h.unique=m.uniqueSort;h.text=m.getText;h.isXMLDoc=m.isXML;h.contains=m.contains})();var ma=/Until$/,na=/^(?:parents|prevUntil|prevAll)/,ja=/,/,
Wa=/^.[^:#\[\.,]*$/,Xa=Array.prototype.slice,Ca=h.expr.match.globalPOS,Ya={children:!0,contents:!0,next:!0,prev:!0};h.fn.extend({find:function(a){var b=this,c,d;if(typeof a!=="string")return h(a).filter(function(){c=0;for(d=b.length;c<d;c++)if(h.contains(b[c],this))return true});var e=this.pushStack("","find",a),k,g,f;c=0;for(d=this.length;c<d;c++){k=e.length;h.find(a,this[c],e);if(c>0)for(g=k;g<e.length;g++)for(f=0;f<k;f++)if(e[f]===e[g]){e.splice(g--,1);break}}return e},has:function(a){var b=h(a);
return this.filter(function(){for(var a=0,c=b.length;a<c;a++)if(h.contains(this,b[a]))return true})},not:function(a){return this.pushStack(j(this,a,false),"not",a)},filter:function(a){return this.pushStack(j(this,a,true),"filter",a)},is:function(a){return!!a&&(typeof a==="string"?Ca.test(a)?h(a,this.context).index(this[0])>=0:h.filter(a,this).length>0:this.filter(a).length>0)},closest:function(a,b){var c=[],d,e,k=this[0];if(h.isArray(a)){for(e=1;k&&k.ownerDocument&&k!==b;){for(d=0;d<a.length;d++)h(k).is(a[d])&&
c.push({selector:a[d],elem:k,level:e});k=k.parentNode;e++}return c}var g=Ca.test(a)||typeof a!=="string"?h(a,b||this.context):0;d=0;for(e=this.length;d<e;d++)for(k=this[d];k;)if(g?g.index(k)>-1:h.find.matchesSelector(k,a)){c.push(k);break}else{k=k.parentNode;if(!k||!k.ownerDocument||k===b||k.nodeType===11)break}c=c.length>1?h.unique(c):c;return this.pushStack(c,"closest",a)},index:function(a){return!a?this[0]&&this[0].parentNode?this.prevAll().length:-1:typeof a==="string"?h.inArray(this[0],h(a)):
...
"iframe")?a.contentDocument||a.contentWindow.document:h.makeArray(a.childNodes)}},function(a,b){h.fn[a]=function(c,d){var e=h.map(this,b,c);ma.test(a)||(d=c);d&&typeof d==="string"&&(e=h.filter(d,e));e=this.length>1&&!Ya[a]?h.unique(e):e;if((this.length>1||ja.test(d))&&na.test(a))e=e.reverse();return this.pushStack(e,a,Xa.call(arguments).join(","))}});h.extend({filter:function(a,b,c){c&&(a=":not("+a+")");return b.length===1?h.find.matchesSelector(b[0],a)?[b[0]]:[]:h.find.matches(a,b)},dir:function(a,
b,d){for(var e=[],a=a[b];a&&a.nodeType!==9&&(d===c||a.nodeType!==1||!h(a).is(d));){a.nodeType===1&&e.push(a);a=a[b]}return e},nth:function(a,b,c){for(var b=b||1,d=0;a;a=a[c])if(a.nodeType===1&&++d===b)break;return a},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)a.nodeType===1&&a!==b&&c.push(a);return c}});var Da="abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",Za=/ jQuery\d+="(?:\d+|null)"/g,
ta=/^\s+/,Ea=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Fa=/<([\w:]+)/,$a=/<tbody/i,ab=/<|&#?\w+;/,bb=/<(?:script|style)/i,cb=/<(?:script|object|embed|option|style)/i,Ga=RegExp("<(?:"+Da+")[\\s/>]","i"),Ha=/checked\s*(?:[^=]|=\s*.checked.)/i,Ia=/\/(java|ecma)script/i,fb=/^\s*<!(?:\[CDATA\[|\-\-)/,T={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,
"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]},za=l(v);T.optgroup=T.option;T.tbody=T.tfoot=T.colgroup=T.caption=T.thead;T.th=T.td;h.support.htmlSerialize||(T._default=[1,"div<div>","</div>"]);h.fn.extend({text:function(a){return h.access(this,function(a){return a===c?h.text(this):this.empty().append((this[0]&&this[0].ownerDocument||v).createTextNode(a))},null,a,arguments.length)},wrapAll:function(a){if(h.isFunction(a))return this.each(function(b){h(this).wrapAll(a.call(this,
...
h.cleanData([d])}d.parentNode&&d.parentNode.removeChild(d)}return this},empty:function(){for(var a=0,b;(b=this[a])!=null;a++)for(b.nodeType===1&&h.cleanData(b.getElementsByTagName("*"));b.firstChild;)b.removeChild(b.firstChild);return this},clone:function(a,b){a=a==null?false:a;b=b==null?a:b;return this.map(function(){return h.clone(this,a,b)})},html:function(a){return h.access(this,function(a){var b=this[0]||{},d=0,e=this.length;if(a===c)return b.nodeType===1?b.innerHTML.replace(Za,""):null;if(typeof a===
"string"&&!bb.test(a)&&(h.support.leadingWhitespace||!ta.test(a))&&!T[(Fa.exec(a)||["",""])[1].toLowerCase()]){a=a.replace(Ea,"<$1></$2>");try{for(;d<e;d++){b=this[d]||{};if(b.nodeType===1){h.cleanData(b.getElementsByTagName("*"));b.innerHTML=a}}b=0}catch(k){}}b&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){if(this[0]&&this[0].parentNode){if(h.isFunction(a))return this.each(function(b){var c=h(this),d=c.html();c.replaceWith(a.call(this,b,d))});typeof a!=="string"&&(a=
h(a).detach());return this.each(function(){var b=this.nextSibling,c=this.parentNode;h(this).remove();b?h(b).before(a):h(c).append(a)})}return this.length?this.pushStack(h(h.isFunction(a)?a():a),"replaceWith",a):this},detach:function(a){return this.remove(a,true)},domManip:function(a,b,d){var e,k,g,f=a[0],i=[];if(!h.support.checkClone&&arguments.length===3&&typeof f==="string"&&Ha.test(f))return this.each(function(){h(this).domManip(a,b,d,true)});if(h.isFunction(f))return this.each(function(e){var k=
h(this);a[0]=f.call(this,e,b?k.html():c);k.domManip(a,b,d)});if(this[0]){e=f&&f.parentNode;e=h.support.parentNode&&e&&e.nodeType===11&&e.childNodes.length===this.length?{fragment:e}:h.buildFragment(a,this,i);g=e.fragment;if(k=g.childNodes.length===1?g=g.firstChild:g.firstChild){b=b&&h.nodeName(k,"tr");k=0;for(var j=this.length,t=j-1;k<j;k++)d.call(b?h.nodeName(this[k],"table")?this[k].getElementsByTagName("tbody")[0]||this[k].appendChild(this[k].ownerDocument.createElement("tbody")):this[k]:this[k],
e.cacheable||j>1&&k<t?h.clone(g,true,true):g)}i.length&&h.each(i,function(a,b){b.src?h.ajax({type:"GET",global:false,url:b.src,async:false,dataType:"script"}):h.globalEval((b.text||b.textContent||b.innerHTML||"").replace(fb,"/*$0*/"));b.parentNode&&b.parentNode.removeChild(b)})}return this}});h.buildFragment=function(a,b,c){var d,e,k,g,f=a[0];b&&b[0]&&(g=b[0].ownerDocument||b[0]);g.createDocumentFragment||(g=v);if(a.length===1&&typeof f==="string"&&f.length<512&&g===v&&f.charAt(0)==="<"&&!cb.test(f)&&
(h.support.checkClone||!Ha.test(f))&&(h.support.html5Clone||!Ga.test(f))){e=true;(k=h.fragments[f])&&k!==1&&(d=k)}if(!d){d=g.createDocumentFragment();h.clean(a,g,d,c)}e&&(h.fragments[f]=k?d:1);return{fragment:d,cacheable:e}};h.fragments={};h.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){h.fn[a]=function(c){var d=[],c=h(c),e=this.length===1&&this[0].parentNode;if(e&&e.nodeType===11&&e.childNodes.length===1&&c.length===
1){c[b](this[0]);return this}for(var e=0,k=c.length;e<k;e++){var g=(e>0?this.clone(true):this).get();h(c[e])[b](g);d=d.concat(g)}return this.pushStack(d,a,c.selector)}});h.extend({clone:function(a,b,c){var d,e,k;if(h.support.html5Clone||h.isXMLDoc(a)||!Ga.test("<"+a.nodeName+">"))d=a.cloneNode(true);else{d=v.createElement("div");za.appendChild(d);d.innerHTML=a.outerHTML;d=d.firstChild}var g=d;if((!h.support.noCloneEvent||!h.support.noCloneChecked)&&(a.nodeType===1||a.nodeType===11)&&!h.isXMLDoc(a)){n(a,
g);d=m(a);e=m(g);for(k=0;d[k];++k)e[k]&&n(d[k],e[k])}if(b){o(a,g);if(c){d=m(a);e=m(g);for(k=0;d[k];++k)o(d[k],e[k])}}return g},clean:function(a,b,c,d){var e,k=[],b=b||v;typeof b.createElement==="undefined"&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||v);for(var g=0,f;(f=a[g])!=null;g++){typeof f==="number"&&(f=f+"");if(f){if(typeof f==="string")if(ab.test(f)){f=f.replace(Ea,"<$1></$2>");e=(Fa.exec(f)||["",""])[1].toLowerCase();var i=T[e]||T._default,j=i[0],t=b.createElement("div"),m=za.childNodes;
b===v?za.appendChild(t):l(b).appendChild(t);for(t.innerHTML=i[1]+f+i[2];j--;)t=t.lastChild;if(!h.support.tbody){j=$a.test(f);i=e==="table"&&!j?t.firstChild&&t.firstChild.childNodes:i[1]==="<table>"&&!j?t.childNodes:[];for(e=i.length-1;e>=0;--e)h.nodeName(i[e],"tbody")&&!i[e].childNodes.length&&i[e].parentNode.removeChild(i[e])}!h.support.leadingWhitespace&&ta.test(f)&&t.insertBefore(b.createTextNode(ta.exec(f)[0]),t.firstChild);f=t.childNodes;if(t){t.parentNode.removeChild(t);if(m.length>0)(t=m[m.length-
1])&&t.parentNode&&t.parentNode.removeChild(t)}}else f=b.createTextNode(f);var y;if(!h.support.appendChecked)if(f[0]&&typeof(y=f.length)==="number")for(e=0;e<y;e++)s(f[e]);else s(f);f.nodeType?k.push(f):k=h.merge(k,f)}}if(c){a=function(a){return!a.type||Ia.test(a.type)};for(g=0;k[g];g++){b=k[g];if(d&&h.nodeName(b,"script")&&(!b.type||Ia.test(b.type)))d.push(b.parentNode?b.parentNode.removeChild(b):b);else{if(b.nodeType===1){f=h.grep(b.getElementsByTagName("script"),a);k.splice.apply(k,[g+1,0].concat(f))}c.appendChild(b)}}}return k},
cleanData:function(a){for(var b,c,d=h.cache,e=h.event.special,k=h.support.deleteExpando,g=0,f;(f=a[g])!=null;g++)if(!f.nodeName||!h.noData[f.nodeName.toLowerCase()])if(c=f[h.expando]){if((b=d[c])&&b.events){for(var i in b.events)e[i]?h.event.remove(f,i):h.removeEvent(f,i,b.handle);if(b.handle)b.handle.elem=null}k?delete f[h.expando]:f.removeAttribute&&f.removeAttribute(h.expando);delete d[c]}}});var Aa=/alpha\([^)]*\)/i,gb=/opacity=([^)]*)/,hb=/([A-Z]|^ms)/g,ib=/^[\-+]?(?:\d*\.)?\d+$/i,va=/^-?(?:\d*\.)?\d+(?!px)[^\d\s]+$/i,
jb=/^([\-+])=([\-+.\de]+)/,kb=/^margin/,lb={position:"absolute",visibility:"hidden",display:"block"},Z=["Top","Right","Bottom","Left"],ca,Ma,Na;h.fn.css=function(a,b){return h.access(this,function(a,b,d){return d!==c?h.style(a,b,d):h.css(a,b)},a,b,arguments.length>1)};h.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=ca(a,"opacity");return c===""?"1":c}return a.style.opacity}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":h.support.cssFloat?
"cssFloat":"styleFloat"},style:function(a,b,d,e){if(a&&!(a.nodeType===3||a.nodeType===8||!a.style)){var k,g=h.camelCase(b),f=a.style,i=h.cssHooks[g],b=h.cssProps[g]||g;if(d!==c){e=typeof d;if(e==="string"&&(k=jb.exec(d))){d=+(k[1]+1)*+k[2]+parseFloat(h.css(a,b));e="number"}if(!(d==null||e==="number"&&isNaN(d))){e==="number"&&!h.cssNumber[g]&&(d=d+"px");if(!i||!("set"in i)||(d=i.set(a,d))!==c)try{f[b]=d}catch(j){}}}else return i&&"get"in i&&(k=i.get(a,false,e))!==c?k:f[b]}},css:function(a,b,d){var e,
k,b=h.camelCase(b);k=h.cssHooks[b];b=h.cssProps[b]||b;b==="cssFloat"&&(b="float");if(k&&"get"in k&&(e=k.get(a,true,d))!==c)return e;if(ca)return ca(a,b)},swap:function(a,b,c){var d={},e;for(e in b){d[e]=a.style[e];a.style[e]=b[e]}c=c.call(a);for(e in b)a.style[e]=d[e];return c}});h.curCSS=h.css;v.defaultView&&v.defaultView.getComputedStyle&&(Ma=function(a,b){var c,d,e,k=a.style,b=b.replace(hb,"-$1").toLowerCase();if((d=a.ownerDocument.defaultView)&&(e=d.getComputedStyle(a,null))){c=e.getPropertyValue(b);
c===""&&!h.contains(a.ownerDocument.documentElement,a)&&(c=h.style(a,b))}if(!h.support.pixelMargin&&e&&kb.test(b)&&va.test(c)){d=k.width;k.width=c;c=e.width;k.width=d}return c});v.documentElement.currentStyle&&(Na=function(a,b){var c,d,e=a.currentStyle&&a.currentStyle[b],k=a.style;if(e==null&&k&&(c=k[b]))e=c;if(va.test(e)){c=k.left;if(d=a.runtimeStyle&&a.runtimeStyle.left)a.runtimeStyle.left=a.currentStyle.left;k.left=b==="fontSize"?"1em":e;e=k.pixelLeft+"px";k.left=c;if(d)a.runtimeStyle.left=d}return e===
""?"auto":e});ca=Ma||Na;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){if(c)return a.offsetWidth!==0?p(a,b,d):h.swap(a,lb,function(){return p(a,b,d)})},set:function(a,b){return ib.test(b)?b+"px":b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return gb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,e=h.isNumeric(b)?"alpha(opacity="+b*100+")":"",k=
d&&d.filter||c.filter||"";c.zoom=1;if(b>=1&&h.trim(k.replace(Aa,""))===""){c.removeAttribute("filter");if(d&&!d.filter)return}c.filter=Aa.test(k)?k.replace(Aa,e):k+" "+e}});h(function(){if(!h.support.reliableMarginRight)h.cssHooks.marginRight={get:function(a,b){return h.swap(a,{display:"inline-block"},function(){return b?ca(a,"margin-right"):a.style.marginRight})}}});h.expr&&h.expr.filters&&(h.expr.filters.hidden=function(a){var b=a.offsetHeight;return a.offsetWidth===0&&b===0||!h.support.reliableHiddenOffsets&&
(a.style&&a.style.display||h.css(a,"display"))==="none"},h.expr.filters.visible=function(a){return!h.expr.filters.hidden(a)});h.each({margin:"",padding:"",border:"Width"},function(a,b){h.cssHooks[a+b]={expand:function(c){for(var d=typeof c==="string"?c.split(" "):[c],e={},c=0;c<4;c++)e[a+Z[c]+b]=d[c]||d[c-2]||d[0];return e}}});var mb=/%20/g,db=/\[\]$/,Oa=/\r?\n/g,nb=/#.*$/,ob=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,pb=/^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
qb=/^(?:GET|HEAD)$/,rb=/^\/\//,Pa=/\?/,sb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,tb=/^(?:select|textarea)/i,Ka=/\s+/,ub=/([?&])_=[^&]*/,Qa=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Ra=h.fn.load,wa={},Sa={},$,aa,Ta=["*/"]+["*"];try{$=R.href}catch(Ab){$=v.createElement("a"),$.href="",$=$.href}aa=Qa.exec($.toLowerCase())||[];h.fn.extend({load:function(a,b,d){if(typeof a!=="string"&&Ra)return Ra.apply(this,arguments);if(!this.length)return this;var e=a.indexOf(" ");if(e>=0)var k=
a.slice(e,a.length),a=a.slice(0,e);e="GET";if(b)if(h.isFunction(b)){d=b;b=c}else if(typeof b==="object"){b=h.param(b,h.ajaxSettings.traditional);e="POST"}var g=this;h.ajax({url:a,type:e,dataType:"html",data:b,complete:function(a,b,c){c=a.responseText;if(a.isResolved()){a.done(function(a){c=a});g.html(k?h("<div>").append(c.replace(sb,"")).find(k):c)}d&&g.each(d,[c,b,a])}});return this},serialize:function(){return h.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?
h.makeArray(this.elements):this}).filter(function(){return this.name&&!this.disabled&&(this.checked||tb.test(this.nodeName)||pb.test(this.type))}).map(function(a,b){var c=h(this).val();return c==null?null:h.isArray(c)?h.map(c,function(a){return{name:b.name,value:a.replace(Oa,"\r\n")}}):{name:b.name,value:c.replace(Oa,"\r\n")}}).get()}});h.each("ajaxStart,ajaxStop,ajaxComplete,ajaxError,ajaxSuccess,ajaxSend".split(","),function(a,b){h.fn[b]=function(a){return this.on(b,a)}});h.each(["get","post"],
function(a,b){h[b]=function(a,d,e,k){if(h.isFunction(d)){k=k||e;e=d;d=c}return h.ajax({type:b,url:a,data:d,success:e,dataType:k})}});h.extend({getScript:function(a,b){return h.get(a,c,b,"script")},getJSON:function(a,b,c){return h.get(a,b,c,"json")},ajaxSetup:function(a,b){if(b)w(a,h.ajaxSettings);else{b=a;a=h.ajaxSettings}w(a,b);return a},ajaxSettings:{url:$,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/.test(aa[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",
processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Ta},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:q(wa),ajaxTransport:q(Sa),ajax:function(a,b){function d(a,b,m,l){if(L!==2){L=2;r&&clearTimeout(r);o=c;y=l||"";q.readyState=
a>0?4:0;var n,s,B,l=b;if(m){var K=e,O=q,w=K.contents,X=K.dataTypes,x=K.responseFields,u,v,Y,U;for(v in x)v in m&&(O[x[v]]=m[v]);for(;X[0]==="*";){X.shift();u===c&&(u=K.mimeType||O.getResponseHeader("content-type"))}if(u)for(v in w)if(w[v]&&w[v].test(u)){X.unshift(v);break}if(X[0]in m)Y=X[0];else{for(v in m){if(!X[0]||K.converters[v+" "+X[0]]){Y=v;break}U||(U=v)}Y=Y||U}if(Y){Y!==X[0]&&X.unshift(Y);m=m[Y]}else m=void 0}else m=c;if(a>=200&&a<300||a===304){if(e.ifModified){if(u=q.getResponseHeader("Last-Modified"))h.lastModified[t]=
u;if(u=q.getResponseHeader("Etag"))h.etag[t]=u}if(a===304){l="notmodified";n=true}else try{u=e;u.dataFilter&&(m=u.dataFilter(m,u.dataType));var A=u.dataTypes;v={};var z,E,F=A.length,V,C=A[0],D,H,G,I,J;for(z=1;z<F;z++){if(z===1)for(E in u.converters)typeof E==="string"&&(v[E.toLowerCase()]=u.converters[E]);D=C;C=A[z];if(C==="*")C=D;else if(D!=="*"&&D!==C){H=D+" "+C;G=v[H]||v["* "+C];if(!G){J=c;for(I in v){V=I.split(" ");if(V[0]===D||V[0]==="*")if(J=v[V[1]+" "+C]){I=v[I];I===true?G=J:J===true&&(G=I);
break}}}!G&&!J&&h.error("No conversion from "+H.replace(" "," to "));G!==true&&(m=G?G(m):J(I(m)))}}s=m;l="success";n=true}catch(M){l="parsererror";B=M}}else{B=l;if(!l||a){l="error";a<0&&(a=0)}}q.status=a;q.statusText=""+(b||l);n?f.resolveWith(k,[s,l,q]):f.rejectWith(k,[q,l,B]);q.statusCode(j);j=c;p&&g.trigger("ajax"+(n?"Success":"Error"),[q,e,n?s:B]);i.fireWith(k,[q,l]);if(p){g.trigger("ajaxComplete",[q,e]);--h.active||h.event.trigger("ajaxStop")}}}if(typeof a==="object"){b=a;a=c}var b=b||{},e=h.ajaxSetup({},
b),k=e.context||e,g=k!==e&&(k.nodeType||k instanceof h)?h(k):h.event,f=h.Deferred(),i=h.Callbacks("once memory"),j=e.statusCode||{},t,m={},l={},y,n,o,r,s,L=0,p,K,q={readyState:0,setRequestHeader:function(a,b){if(!L){var c=a.toLowerCase(),a=l[c]=l[c]||a;m[a]=b}return this},getAllResponseHeaders:function(){return L===2?y:null},getResponseHeader:function(a){var b;if(L===2){if(!n)for(n={};b=ob.exec(y);)n[b[1].toLowerCase()]=b[2];b=n[a.toLowerCase()]}return b===c?null:b},overrideMimeType:function(a){if(!L)e.mimeType=
a;return this},abort:function(a){a=a||"abort";o&&o.abort(a);d(0,a);return this}};f.promise(q);q.success=q.done;q.error=q.fail;q.complete=i.add;q.statusCode=function(a){if(a){var b;if(L<2)for(b in a)j[b]=[j[b],a[b]];else{b=a[q.status];q.then(b,b)}}return this};e.url=((a||e.url)+"").replace(nb,"").replace(rb,aa[1]+"//");e.dataTypes=h.trim(e.dataType||"*").toLowerCase().split(Ka);if(e.crossDomain==null){s=Qa.exec(e.url.toLowerCase());e.crossDomain=!(!s||!(s[1]!=aa[1]||s[2]!=aa[2]||(s[3]||(s[1]==="http:"?
80:443))!=(aa[3]||(aa[1]==="http:"?80:443))))}if(e.data&&e.processData&&typeof e.data!=="string")e.data=h.param(e.data,e.traditional);x(wa,e,b,q);if(L===2)return false;p=e.global;e.type=e.type.toUpperCase();e.hasContent=!qb.test(e.type);p&&h.active++===0&&h.event.trigger("ajaxStart");if(!e.hasContent){if(e.data){e.url=e.url+((Pa.test(e.url)?"&":"?")+e.data);delete e.data}t=e.url;if(e.cache===false){s=h.now();var O=e.url.replace(ub,"$1_="+s);e.url=O+(O===e.url?(Pa.test(e.url)?"&":"?")+"_="+s:"")}}(e.data&&
e.hasContent&&e.contentType!==false||b.contentType)&&q.setRequestHeader("Content-Type",e.contentType);if(e.ifModified){t=t||e.url;h.lastModified[t]&&q.setRequestHeader("If-Modified-Since",h.lastModified[t]);h.etag[t]&&q.setRequestHeader("If-None-Match",h.etag[t])}q.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+(e.dataTypes[0]!=="*"?", "+Ta+"; q=0.01":""):e.accepts["*"]);for(K in e.headers)q.setRequestHeader(K,e.headers[K]);if(e.beforeSend&&(e.beforeSend.call(k,
q,e)===false||L===2)){q.abort();return false}for(K in{success:1,error:1,complete:1})q[K](e[K]);if(o=x(Sa,e,b,q)){q.readyState=1;p&&g.trigger("ajaxSend",[q,e]);e.async&&e.timeout>0&&(r=setTimeout(function(){q.abort("timeout")},e.timeout));try{L=1;o.send(m,d)}catch(w){if(L<2)d(-1,w);else throw w;}}else d(-1,"No Transport");return q},param:function(a,b){var d=[],e=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(b===c)b=h.ajaxSettings.traditional;
if(h.isArray(a)||a.jquery&&!h.isPlainObject(a))h.each(a,function(){e(this.name,this.value)});else for(var k in a)A(k,a[k],b,e);return d.join("&").replace(mb,"+")}});h.extend({active:0,lastModified:{},etag:{}});var vb=h.now(),ra=/(\=)\?(&|$)|\?\?/i;h.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return h.expando+"_"+vb++}});h.ajaxPrefilter("json jsonp",function(b,c,d){c=typeof b.data==="string"&&/^application\/x\-www\-form\-urlencoded/.test(b.contentType);if(b.dataTypes[0]==="jsonp"||b.jsonp!==
false&&(ra.test(b.url)||c&&ra.test(b.data))){var e,k=b.jsonpCallback=h.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,g=a[k],f=b.url,i=b.data,j="$1"+k+"$2";if(b.jsonp!==false){f=f.replace(ra,j);if(b.url===f){c&&(i=i.replace(ra,j));b.data===i&&(f=f+((/\?/.test(f)?"&":"?")+b.jsonp+"="+k))}}b.url=f;b.data=i;a[k]=function(a){e=[a]};d.always(function(){a[k]=g;if(e&&h.isFunction(g))a[k](e[0])});b.converters["script json"]=function(){e||h.error(k+" was not called");return e[0]};b.dataTypes[0]=
"json";return"script"}});h.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/javascript|ecmascript/},converters:{"text script":function(a){h.globalEval(a);return a}}});h.ajaxPrefilter("script",function(a){if(a.cache===c)a.cache=false;if(a.crossDomain){a.type="GET";a.global=false}});h.ajaxTransport("script",function(a){if(a.crossDomain){var b,d=v.head||v.getElementsByTagName("head")[0]||v.documentElement;return{send:function(e,
k){b=v.createElement("script");b.async="async";if(a.scriptCharset)b.charset=a.scriptCharset;b.src=a.url;b.onload=b.onreadystatechange=function(a,e){if(e||!b.readyState||/loaded|complete/.test(b.readyState)){b.onload=b.onreadystatechange=null;d&&b.parentNode&&d.removeChild(b);b=c;e||k(200,"success")}};d.insertBefore(b,d.firstChild)},abort:function(){if(b)b.onload(0,1)}}}});var Ba=a.ActiveXObject?function(){for(var a in fa)fa[a](0,1)}:!1,wb=0,fa;h.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=
!this.isLocal&&E()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:E;(function(a){h.extend(h.support,{ajax:!!a,cors:!!a&&"withCredentials"in a})})(h.ajaxSettings.xhr());h.support.ajax&&h.ajaxTransport(function(b){if(!b.crossDomain||h.support.cors){var d;return{send:function(e,k){var g=b.xhr(),f,i;b.username?g.open(b.type,b.url,b.async,b.username,b.password):g.open(b.type,b.url,b.async);if(b.xhrFields)for(i in b.xhrFields)g[i]=b.xhrFields[i];b.mimeType&&g.overrideMimeType&&
g.overrideMimeType(b.mimeType);!b.crossDomain&&!e["X-Requested-With"]&&(e["X-Requested-With"]="XMLHttpRequest");try{for(i in e)g.setRequestHeader(i,e[i])}catch(j){}g.send(b.hasContent&&b.data||null);d=function(a,e){var i,j,t,m,l;try{if(d&&(e||g.readyState===4)){d=c;if(f){g.onreadystatechange=h.noop;Ba&&delete fa[f]}if(e)g.readyState!==4&&g.abort();else{i=g.status;t=g.getAllResponseHeaders();m={};if((l=g.responseXML)&&l.documentElement)m.xml=l;try{m.text=g.responseText}catch(y){}try{j=g.statusText}catch(n){j=
""}!i&&b.isLocal&&!b.crossDomain?i=m.text?200:404:i===1223&&(i=204)}}}catch(o){e||k(-1,o)}m&&k(i,j,m,t)};if(!b.async||g.readyState===4)d();else{f=++wb;if(Ba){if(!fa){fa={};h(a).unload(Ba)}fa[f]=d}g.onreadystatechange=d}},abort:function(){d&&d(0,1)}}}});var xa={},W,da,xb=/^(?:toggle|show|hide)$/,yb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,sa,pa=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],oa;h.fn.extend({show:function(a,
b,c){if(a||a===0)return this.animate(F("show",3),a,b,c);for(var c=0,d=this.length;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(!h._data(a,"olddisplay")&&b==="none")b=a.style.display="";(b===""&&h.css(a,"display")==="none"||!h.contains(a.ownerDocument.documentElement,a))&&h._data(a,"olddisplay",H(a.nodeName))}}for(c=0;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(b===""||b==="none")a.style.display=h._data(a,"olddisplay")||""}}return this},hide:function(a,b,c){if(a||a===0)return this.animate(F("hide",
...
fadeTo:function(a,b,c,d){return this.filter(":hidden").css("opacity",0).show().end().animate({opacity:b},a,c,d)},animate:function(a,b,c,d){function e(){k.queue===false&&h._mark(this);var b=h.extend({},k),c=this.nodeType===1,d=c&&h(this).is(":hidden"),g,f,i,j,t;b.animatedProperties={};for(i in a){g=h.camelCase(i);if(i!==g){a[g]=a[i];delete a[i]}if((f=h.cssHooks[g])&&"expand"in f){j=f.expand(a[g]);delete a[g];for(i in j)i in a||(a[i]=j[i])}}for(g in a){f=a[g];if(h.isArray(f)){b.animatedProperties[g]=
f[1];f=a[g]=f[0]}else b.animatedProperties[g]=b.specialEasing&&b.specialEasing[g]||b.easing||"swing";if(f==="hide"&&d||f==="show"&&!d)return b.complete.call(this);if(c&&(g==="height"||g==="width")){b.overflow=[this.style.overflow,this.style.overflowX,this.style.overflowY];if(h.css(this,"display")==="inline"&&h.css(this,"float")==="none")!h.support.inlineBlockNeedsLayout||H(this.nodeName)==="inline"?this.style.display="inline-block":this.style.zoom=1}}if(b.overflow!=null)this.style.overflow="hidden";
for(i in a){c=new h.fx(this,b,i);f=a[i];if(xb.test(f))if(g=h._data(this,"toggle"+i)||(f==="toggle"?d?"show":"hide":0)){h._data(this,"toggle"+i,g==="show"?"hide":"show");c[g]()}else c[f]();else{g=yb.exec(f);j=c.cur();if(g){f=parseFloat(g[2]);t=g[3]||(h.cssNumber[i]?"":"px");if(t!=="px"){h.style(this,i,(f||1)+t);j=(f||1)/c.cur()*j;h.style(this,i,j+t)}g[1]&&(f=(g[1]==="-="?-1:1)*f+j);c.custom(j,f,t)}else c.custom(j,f,"")}}return true}var k=h.speed(b,c,d);if(h.isEmptyObject(a))return this.each(k.complete,
[false]);a=h.extend({},a);return k.queue===false?this.each(e):this.queue(k.queue,e)},stop:function(a,b,d){if(typeof a!=="string"){d=b;b=a;a=c}b&&a!==false&&this.queue(a||"fx",[]);return this.each(function(){var b,c=false,e=h.timers,k=h._data(this);d||h._unmark(true,this);if(a==null)for(b in k){if(k[b]&&k[b].stop&&b.indexOf(".run")===b.length-4){var g=k[b];h.removeData(this,b,true);g.stop(d)}}else if(k[b=a+".run"]&&k[b].stop){k=k[b];h.removeData(this,b,true);k.stop(d)}for(b=e.length;b--;)if(e[b].elem===
this&&(a==null||e[b].queue===a)){if(d)e[b](true);else e[b].saveState();c=true;e.splice(b,1)}(!d||!c)&&h.dequeue(this,a)})}});h.each({slideDown:F("show",1),slideUp:F("hide",1),slideToggle:F("toggle",1),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){h.fn[a]=function(a,c,d){return this.animate(b,a,c,d)}});h.extend({speed:function(a,b,c){var d=a&&typeof a==="object"?h.extend({},a):{complete:c||!c&&b||h.isFunction(a)&&a,duration:a,easing:c&&b||b&&!h.isFunction(b)&&
...
{}}});h.fx.prototype={update:function(){this.options.step&&this.options.step.call(this.elem,this.now,this);(h.fx.step[this.prop]||h.fx.step._default)(this)},cur:function(){if(this.elem[this.prop]!=null&&(!this.elem.style||this.elem.style[this.prop]==null))return this.elem[this.prop];var a,b=h.css(this.elem,this.prop);return isNaN(a=parseFloat(b))?!b||b==="auto"?0:b:a},custom:function(a,b,d){function e(a){return k.step(a)}var k=this,g=h.fx;this.startTime=oa||z();this.end=b;this.now=this.start=a;this.pos=
this.state=0;this.unit=d||this.unit||(h.cssNumber[this.prop]?"":"px");e.queue=this.options.queue;e.elem=this.elem;e.saveState=function(){h._data(k.elem,"fxshow"+k.prop)===c&&(k.options.hide?h._data(k.elem,"fxshow"+k.prop,k.start):k.options.show&&h._data(k.elem,"fxshow"+k.prop,k.end))};e()&&h.timers.push(e)&&!sa&&(sa=setInterval(g.tick,g.interval))},show:function(){var a=h._data(this.elem,"fxshow"+this.prop);this.options.orig[this.prop]=a||h.style(this.elem,this.prop);this.options.show=true;a!==c?
this.custom(this.cur(),a):this.custom(this.prop==="width"||this.prop==="height"?1:0,this.cur());h(this.elem).show()},hide:function(){this.options.orig[this.prop]=h._data(this.elem,"fxshow"+this.prop)||h.style(this.elem,this.prop);this.options.hide=true;this.custom(this.cur(),0)},step:function(a){var b,c=oa||z(),d=true,e=this.elem,k=this.options;if(a||c>=k.duration+this.startTime){this.now=this.end;this.pos=this.state=1;this.update();k.animatedProperties[this.prop]=true;for(b in k.animatedProperties)k.animatedProperties[b]!==
true&&(d=false);if(d){k.overflow!=null&&!h.support.shrinkWrapBlocks&&h.each(["","X","Y"],function(a,b){e.style["overflow"+b]=k.overflow[a]});k.hide&&h(e).hide();if(k.hide||k.show)for(b in k.animatedProperties){h.style(e,b,k.orig[b]);h.removeData(e,"fxshow"+b,true);h.removeData(e,"toggle"+b,true)}if(a=k.complete){k.complete=false;a.call(e)}}return false}if(k.duration==Infinity)this.now=c;else{a=c-this.startTime;this.state=a/k.duration;this.pos=h.easing[k.animatedProperties[this.prop]](this.state,a,
0,1,k.duration);this.now=this.start+(this.end-this.start)*this.pos}this.update();return true}};h.extend(h.fx,{tick:function(){for(var a,b=h.timers,c=0;c<b.length;c++){a=b[c];!a()&&b[c]===a&&b.splice(c--,1)}b.length||h.fx.stop()},interval:13,stop:function(){clearInterval(sa);sa=null},speeds:{slow:600,fast:200,_default:400},step:{opacity:function(a){h.style(a.elem,"opacity",a.now)},_default:function(a){a.elem.style&&a.elem.style[a.prop]!=null?a.elem.style[a.prop]=a.now+a.unit:a.elem[a.prop]=a.now}}});
h.each(pa.concat.apply([],pa),function(a,b){b.indexOf("margin")&&(h.fx.step[b]=function(a){h.style(a.elem,b,Math.max(0,a.now)+a.unit)})});h.expr&&h.expr.filters&&(h.expr.filters.animated=function(a){return h.grep(h.timers,function(b){return a===b.elem}).length});var Ua,zb=/^t(?:able|d|h)$/i,Va=/^(?:body|html)$/i;Ua="getBoundingClientRect"in v.documentElement?function(a,b,c,d){try{d=a.getBoundingClientRect()}catch(e){}if(!d||!h.contains(c,a))return d?{top:d.top,left:d.left}:{top:0,left:0};a=b.body;
b=D(b);return{top:d.top+(b.pageYOffset||h.support.boxModel&&c.scrollTop||a.scrollTop)-(c.clientTop||a.clientTop||0),left:d.left+(b.pageXOffset||h.support.boxModel&&c.scrollLeft||a.scrollLeft)-(c.clientLeft||a.clientLeft||0)}}:function(a,b,c){var d,e=a.offsetParent,k=b.body;d=(b=b.defaultView)?b.getComputedStyle(a,null):a.currentStyle;for(var g=a.offsetTop,f=a.offsetLeft;(a=a.parentNode)&&a!==k&&a!==c;){if(h.support.fixedPosition&&d.position==="fixed")break;d=b?b.getComputedStyle(a,null):a.currentStyle;
g=g-a.scrollTop;f=f-a.scrollLeft;if(a===e){g=g+a.offsetTop;f=f+a.offsetLeft;if(h.support.doesNotAddBorder&&(!h.support.doesAddBorderForTableAndCells||!zb.test(a.nodeName))){g=g+(parseFloat(d.borderTopWidth)||0);f=f+(parseFloat(d.borderLeftWidth)||0)}e=a.offsetParent}if(h.support.subtractsBorderForOverflowNotVisible&&d.overflow!=="visible"){g=g+(parseFloat(d.borderTopWidth)||0);f=f+(parseFloat(d.borderLeftWidth)||0)}}if(d.position==="relative"||d.position==="static"){g=g+k.offsetTop;f=f+k.offsetLeft}if(h.support.fixedPosition&&
d.position==="fixed"){g=g+Math.max(c.scrollTop,k.scrollTop);f=f+Math.max(c.scrollLeft,k.scrollLeft)}return{top:g,left:f}};h.fn.offset=function(a){if(arguments.length)return a===c?this:this.each(function(b){h.offset.setOffset(this,a,b)});var b=this[0],d=b&&b.ownerDocument;return!d?null:b===d.body?h.offset.bodyOffset(b):Ua(b,d,d.documentElement)};h.offset={bodyOffset:function(a){var b=a.offsetTop,c=a.offsetLeft;if(h.support.doesNotIncludeMarginInBodyOffset){b=b+(parseFloat(h.css(a,"marginTop"))||0);
c=c+(parseFloat(h.css(a,"marginLeft"))||0)}return{top:b,left:c}},setOffset:function(a,b,c){var d=h.css(a,"position");if(d==="static")a.style.position="relative";var e=h(a),k=e.offset(),g=h.css(a,"top"),f=h.css(a,"left"),i={},j={};if((d==="absolute"||d==="fixed")&&h.inArray("auto",[g,f])>-1){j=e.position();d=j.top;f=j.left}else{d=parseFloat(g)||0;f=parseFloat(f)||0}h.isFunction(b)&&(b=b.call(a,c,k));if(b.top!=null)i.top=b.top-k.top+d;if(b.left!=null)i.left=b.left-k.left+f;"using"in b?b.using.call(a,
i):e.css(i)}};h.fn.extend({position:function(){if(!this[0])return null;var a=this[0],b=this.offsetParent(),c=this.offset(),d=Va.test(b[0].nodeName)?{top:0,left:0}:b.offset();c.top=c.top-(parseFloat(h.css(a,"marginTop"))||0);c.left=c.left-(parseFloat(h.css(a,"marginLeft"))||0);d.top=d.top+(parseFloat(h.css(b[0],"borderTopWidth"))||0);d.left=d.left+(parseFloat(h.css(b[0],"borderLeftWidth"))||0);return{top:c.top-d.top,left:c.left-d.left}},offsetParent:function(){return this.map(function(){for(var a=
this.offsetParent||v.body;a&&!Va.test(a.nodeName)&&h.css(a,"position")==="static";)a=a.offsetParent;return a})}});h.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(a,b){var d=/Y/.test(b);h.fn[a]=function(e){return h.access(this,function(a,e,k){var g=D(a);if(k===c)return g?b in g?g[b]:h.support.boxModel&&g.document.documentElement[e]||g.document.body[e]:a[e];g?g.scrollTo(!d?k:h(g).scrollLeft(),d?k:h(g).scrollTop()):a[e]=k},a,e,arguments.length,null)}});h.each({Height:"height",Width:"width"},
function(a,b){var d="client"+a,e="scroll"+a,k="offset"+a;h.fn["inner"+a]=function(){var a=this[0];return a?a.style?parseFloat(h.css(a,b,"padding")):this[b]():null};h.fn["outer"+a]=function(a){var c=this[0];return c?c.style?parseFloat(h.css(c,b,a?"margin":"border")):this[b]():null};h.fn[b]=function(a){return h.access(this,function(a,b,g){if(h.isWindow(a)){b=a.document;a=b.documentElement[d];return h.support.boxModel&&a||b.body&&b.body[d]||a}if(a.nodeType===9){b=a.documentElement;return b[d]>=b[e]?
b[d]:Math.max(a.body[e],b[e],a.body[k],b[k])}if(g===c){a=h.css(a,b);b=parseFloat(a);return h.isNumeric(b)?b:a}h(a).css(b,g)},b,a,arguments.length,null)}});a.jQuery=a.$=h;"function"===typeof define&&define.amd&&define.amd.jQuery&&define("jquery",[],function(){return h})})(window);
(function(a,c){function d(c,d){var f=c.nodeName.toLowerCase();if("area"===f){var f=c.parentNode,b=f.name;if(!c.href||!b||"map"!==f.nodeName.toLowerCase())return!1;f=a("img[usemap=#"+b+"]")[0];return!!f&&e(f)}return(/input|select|textarea|button|object/.test(f)?!c.disabled:"a"==f?c.href||d:d)&&e(c)}function e(c){return!a(c).parents().andSelf().filter(function(){return"hidden"===a.curCSS(this,"visibility")||a.expr.filters.hidden(this)}).length}a.ui=a.ui||{};a.ui.version||(a.extend(a.ui,{version:"1.8.20",
...
this;setTimeout(function(){a(e).focus();d&&d.call(e)},c)}):this._focus.apply(this,arguments)},scrollParent:function(){var c;c=a.browser.msie&&/(static|relative)/.test(this.css("position"))||/absolute/.test(this.css("position"))?this.parents().filter(function(){return/(relative|absolute|fixed)/.test(a.curCSS(this,"position",1))&&/(auto|scroll)/.test(a.curCSS(this,"overflow",1)+a.curCSS(this,"overflow-y",1)+a.curCSS(this,"overflow-x",1))}).eq(0):this.parents().filter(function(){return/(auto|scroll)/.test(a.curCSS(this,
"overflow",1)+a.curCSS(this,"overflow-y",1)+a.curCSS(this,"overflow-x",1))}).eq(0);return/fixed/.test(this.css("position"))||!c.length?a(document):c},zIndex:function(d){if(d!==c)return this.css("zIndex",d);if(this.length)for(var d=a(this[0]),e;d.length&&d[0]!==document;){e=d.css("position");if("absolute"===e||"relative"===e||"fixed"===e)if(e=parseInt(d.css("zIndex"),10),!isNaN(e)&&0!==e)return e;d=d.parent()}return 0},disableSelection:function(){return this.bind((a.support.selectstart?"selectstart":
"mousedown")+".ui-disableSelection",function(a){a.preventDefault()})},enableSelection:function(){return this.unbind(".ui-disableSelection")}}),a.each(["Width","Height"],function(d,e){function f(c,d,e,g){a.each(b,function(){d-=parseFloat(a.curCSS(c,"padding"+this,!0))||0;e&&(d-=parseFloat(a.curCSS(c,"border"+this+"Width",!0))||0);g&&(d-=parseFloat(a.curCSS(c,"margin"+this,!0))||0)});return d}var b="Width"===e?["Left","Right"]:["Top","Bottom"],j=e.toLowerCase(),l={innerWidth:a.fn.innerWidth,innerHeight:a.fn.innerHeight,
outerWidth:a.fn.outerWidth,outerHeight:a.fn.outerHeight};a.fn["inner"+e]=function(b){return b===c?l["inner"+e].call(this):this.each(function(){a(this).css(j,f(this,b)+"px")})};a.fn["outer"+e]=function(b,c){return"number"!==typeof b?l["outer"+e].call(this,b):this.each(function(){a(this).css(j,f(this,b,!0,c)+"px")})}}),a.extend(a.expr[":"],{data:function(c,d,e){return!!a.data(c,e[3])},focusable:function(c){return d(c,!isNaN(a.attr(c,"tabindex")))},tabbable:function(c){var e=a.attr(c,"tabindex"),f=isNaN(e);
return(f||0<=e)&&d(c,!f)}}),a(function(){var c=document.body,d=c.appendChild(d=document.createElement("div"));d.offsetHeight;a.extend(d.style,{minHeight:"100px",height:"auto",padding:0,borderWidth:0});a.support.minHeight=100===d.offsetHeight;a.support.selectstart="onselectstart"in d;c.removeChild(d).style.display="none"}),a.extend(a.ui,{plugin:{add:function(c,d,e){var c=a.ui[c].prototype,b;for(b in e)c.plugins[b]=c.plugins[b]||[],c.plugins[b].push([d,e[b]])},call:function(a,c,d){if((c=a.plugins[c])&&
a.element[0].parentNode)for(var b=0;b<c.length;b++)a.options[c[b][0]]&&c[b][1].apply(a.element,d)}},contains:function(a,c){return document.compareDocumentPosition?a.compareDocumentPosition(c)&16:a!==c&&a.contains(c)},hasScroll:function(c,d){if("hidden"===a(c).css("overflow"))return!1;var e=d&&"left"===d?"scrollLeft":"scrollTop",b=!1;if(0<c[e])return!0;c[e]=1;b=0<c[e];c[e]=0;return b},isOverAxis:function(a,c,d){return a>c&&a<c+d},isOver:function(c,d,e,b,j,l){return a.ui.isOverAxis(c,e,j)&&a.ui.isOverAxis(d,
b,l)}}))})(jQuery);
(function(a,c){if(a.cleanData){var d=a.cleanData;a.cleanData=function(c){for(var e=0,f;null!=(f=c[e]);e++)try{a(f).triggerHandler("remove")}catch(b){}d(c)}}else{var e=a.fn.remove;a.fn.remove=function(c,d){return this.each(function(){d||(!c||a.filter(c,[this]).length)&&a("*",this).add([this]).each(function(){try{a(this).triggerHandler("remove")}catch(c){}});return e.call(a(this),c,d)})}}a.widget=function(c,d,e){var b=c.split(".")[0],j,c=c.split(".")[1];j=b+"-"+c;e||(e=d,d=a.Widget);a.expr[":"][j]=
function(b){return!!a.data(b,c)};a[b]=a[b]||{};a[b][c]=function(a,b){arguments.length&&this._createWidget(a,b)};d=new d;d.options=a.extend(!0,{},d.options);a[b][c].prototype=a.extend(!0,d,{namespace:b,widgetName:c,widgetEventPrefix:a[b][c].prototype.widgetEventPrefix||c,widgetBaseClass:j},e);a.widget.bridge(c,a[b][c])};a.widget.bridge=function(d,e){a.fn[d]=function(f){var b="string"===typeof f,j=Array.prototype.slice.call(arguments,1),l=this,f=!b&&j.length?a.extend.apply(null,[!0,f].concat(j)):f;
if(b&&"_"===f.charAt(0))return l;b?this.each(function(){var b=a.data(this,d),e=b&&a.isFunction(b[f])?b[f].apply(b,j):b;if(e!==b&&e!==c)return l=e,!1}):this.each(function(){var b=a.data(this,d);b?b.option(f||{})._init():a.data(this,d,new e(f,this))});return l}};a.Widget=function(a,c){arguments.length&&this._createWidget(a,c)};a.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",options:{disabled:!1},_createWidget:function(c,d){a.data(d,this.widgetName,this);this.element=a(d);this.options=a.extend(!0,
...
"-disabled ui-state-disabled")},widget:function(){return this.element},option:function(d,e){var f=d;if(0===arguments.length)return a.extend({},this.options);if("string"===typeof d){if(e===c)return this.options[d];f={};f[d]=e}this._setOptions(f);return this},_setOptions:function(c){var d=this;a.each(c,function(a,b){d._setOption(a,b)});return this},_setOption:function(a,c){this.options[a]=c;"disabled"===a&&this.widget()[c?"addClass":"removeClass"](this.widgetBaseClass+"-disabled ui-state-disabled").attr("aria-disabled",
c);return this},enable:function(){return this._setOption("disabled",!1)},disable:function(){return this._setOption("disabled",!0)},_trigger:function(c,d,e){var b,j=this.options[c],e=e||{},d=a.Event(d);d.type=(c===this.widgetEventPrefix?c:this.widgetEventPrefix+c).toLowerCase();d.target=this.element[0];if(c=d.originalEvent)for(b in c)b in d||(d[b]=c[b]);this.element.trigger(d,e);return!(a.isFunction(j)&&!1===j.call(this.element[0],d,e)||d.isDefaultPrevented())}}})(jQuery);
...
a("document"==c.containment?document:window).width()-this.helperProportions.width-this.margins.left,("document"==c.containment?0:a(window).scrollTop())+(a("document"==c.containment?document:window).height()||document.body.parentNode.scrollHeight)-this.helperProportions.height-this.margins.top];if(!/^(document|window|parent)$/.test(c.containment)&&c.containment.constructor!=Array){var c=a(c.containment),d=c[0];if(d){c.offset();var e="hidden"!=a(d).css("overflow");this.containment=[(parseInt(a(d).css("borderLeftWidth"),
10)||0)+(parseInt(a(d).css("paddingLeft"),10)||0),(parseInt(a(d).css("borderTopWidth"),10)||0)+(parseInt(a(d).css("paddingTop"),10)||0),(e?Math.max(d.scrollWidth,d.offsetWidth):d.offsetWidth)-(parseInt(a(d).css("borderLeftWidth"),10)||0)-(parseInt(a(d).css("paddingRight"),10)||0)-this.helperProportions.width-this.margins.left-this.margins.right,(e?Math.max(d.scrollHeight,d.offsetHeight):d.offsetHeight)-(parseInt(a(d).css("borderTopWidth"),10)||0)-(parseInt(a(d).css("paddingBottom"),10)||0)-this.helperProportions.height-
this.margins.top-this.margins.bottom];this.relative_container=c}}else c.containment.constructor==Array&&(this.containment=c.containment)},_convertPositionTo:function(c,d){d||(d=this.position);var e="absolute"==c?1:-1,g="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,i=/(html|body)/i.test(g[0].tagName);return{top:d.top+this.offset.relative.top*e+this.offset.parent.top*e-(a.browser.safari&&
526>a.browser.version&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollTop():i?0:g.scrollTop())*e),left:d.left+this.offset.relative.left*e+this.offset.parent.left*e-(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollLeft():i?0:g.scrollLeft())*e)}},_generatePosition:function(c){var d=this.options,e="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],
this.offsetParent[0]))?this.offsetParent:this.scrollParent,g=/(html|body)/i.test(e[0].tagName),i=c.pageX,f=c.pageY;if(this.originalPosition){var b;this.containment&&(this.relative_container?(b=this.relative_container.offset(),b=[this.containment[0]+b.left,this.containment[1]+b.top,this.containment[2]+b.left,this.containment[3]+b.top]):b=this.containment,c.pageX-this.offset.click.left<b[0]&&(i=b[0]+this.offset.click.left),c.pageY-this.offset.click.top<b[1]&&(f=b[1]+this.offset.click.top),c.pageX-this.offset.click.left>
b[2]&&(i=b[2]+this.offset.click.left),c.pageY-this.offset.click.top>b[3]&&(f=b[3]+this.offset.click.top));d.grid&&(f=d.grid[1]?this.originalPageY+Math.round((f-this.originalPageY)/d.grid[1])*d.grid[1]:this.originalPageY,f=b?!(f-this.offset.click.top<b[1]||f-this.offset.click.top>b[3])?f:!(f-this.offset.click.top<b[1])?f-d.grid[1]:f+d.grid[1]:f,i=d.grid[0]?this.originalPageX+Math.round((i-this.originalPageX)/d.grid[0])*d.grid[0]:this.originalPageX,i=b?!(i-this.offset.click.left<b[0]||i-this.offset.click.left>
b[2])?i:!(i-this.offset.click.left<b[0])?i-d.grid[0]:i+d.grid[0]:i)}return{top:f-this.offset.click.top-this.offset.relative.top-this.offset.parent.top+(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?-this.scrollParent.scrollTop():g?0:e.scrollTop()),left:i-this.offset.click.left-this.offset.relative.left-this.offset.parent.left+(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?-this.scrollParent.scrollLeft():
g?0:e.scrollLeft())}},_clear:function(){this.helper.removeClass("ui-draggable-dragging");this.helper[0]!=this.element[0]&&!this.cancelHelperRemoval&&this.helper.remove();this.helper=null;this.cancelHelperRemoval=!1},_trigger:function(c,d,e){e=e||this._uiHash();a.ui.plugin.call(this,c,[d,e]);"drag"==c&&(this.positionAbs=this._convertPositionTo("absolute"));return a.Widget.prototype._trigger.call(this,c,d,e)},plugins:{},_uiHash:function(){return{helper:this.helper,position:this.position,originalPosition:this.originalPosition,
offset:this.positionAbs}}});a.extend(a.ui.draggable,{version:"1.8.20"});a.ui.plugin.add("draggable","connectToSortable",{start:function(c,d){var e=a(this).data("draggable"),g=e.options,i=a.extend({},d,{item:e.element});e.sortables=[];a(g.connectToSortable).each(function(){var d=a.data(this,"sortable");d&&!d.options.disabled&&(e.sortables.push({instance:d,shouldRevert:d.options.revert}),d.refreshPositions(),d._trigger("activate",c,i))})},stop:function(c,d){var e=a(this).data("draggable"),g=a.extend({},
d,{item:e.element});a.each(e.sortables,function(){this.instance.isOver?(this.instance.isOver=0,e.cancelHelperRemoval=!0,this.instance.cancelHelperRemoval=!1,this.shouldRevert&&(this.instance.options.revert=!0),this.instance._mouseStop(c),this.instance.options.helper=this.instance.options._helper,"original"==e.options.helper&&this.instance.currentItem.css({top:"auto",left:"auto"})):(this.instance.cancelHelperRemoval=!1,this.instance._trigger("deactivate",c,g))})},drag:function(c,d){var e=a(this).data("draggable"),
g=this;a.each(e.sortables,function(){this.instance.positionAbs=e.positionAbs;this.instance.helperProportions=e.helperProportions;this.instance.offset.click=e.offset.click;this.instance._intersectsWith(this.instance.containerCache)?(this.instance.isOver||(this.instance.isOver=1,this.instance.currentItem=a(g).clone().removeAttr("id").appendTo(this.instance.element).data("sortable-item",!0),this.instance.options._helper=this.instance.options.helper,this.instance.options.helper=function(){return d.helper[0]},
...
a("body"),d=a(this).data("draggable").options;c.css("cursor")&&(d._cursor=c.css("cursor"));c.css("cursor",d.cursor)},stop:function(){var c=a(this).data("draggable").options;c._cursor&&a("body").css("cursor",c._cursor)}});a.ui.plugin.add("draggable","opacity",{start:function(c,d){var e=a(d.helper),g=a(this).data("draggable").options;e.css("opacity")&&(g._opacity=e.css("opacity"));e.css("opacity",g.opacity)},stop:function(c,d){var e=a(this).data("draggable").options;e._opacity&&a(d.helper).css("opacity",
e._opacity)}});a.ui.plugin.add("draggable","scroll",{start:function(){var c=a(this).data("draggable");c.scrollParent[0]!=document&&"HTML"!=c.scrollParent[0].tagName&&(c.overflowOffset=c.scrollParent.offset())},drag:function(c){var d=a(this).data("draggable"),e=d.options,g=!1;if(d.scrollParent[0]!=document&&"HTML"!=d.scrollParent[0].tagName){if(!e.axis||"x"!=e.axis)d.overflowOffset.top+d.scrollParent[0].offsetHeight-c.pageY<e.scrollSensitivity?d.scrollParent[0].scrollTop=g=d.scrollParent[0].scrollTop+
e.scrollSpeed:c.pageY-d.overflowOffset.top<e.scrollSensitivity&&(d.scrollParent[0].scrollTop=g=d.scrollParent[0].scrollTop-e.scrollSpeed);if(!e.axis||"y"!=e.axis)d.overflowOffset.left+d.scrollParent[0].offsetWidth-c.pageX<e.scrollSensitivity?d.scrollParent[0].scrollLeft=g=d.scrollParent[0].scrollLeft+e.scrollSpeed:c.pageX-d.overflowOffset.left<e.scrollSensitivity&&(d.scrollParent[0].scrollLeft=g=d.scrollParent[0].scrollLeft-e.scrollSpeed)}else{if(!e.axis||"x"!=e.axis)c.pageY-a(document).scrollTop()<
e.scrollSensitivity?g=a(document).scrollTop(a(document).scrollTop()-e.scrollSpeed):a(window).height()-(c.pageY-a(document).scrollTop())<e.scrollSensitivity&&(g=a(document).scrollTop(a(document).scrollTop()+e.scrollSpeed));if(!e.axis||"y"!=e.axis)c.pageX-a(document).scrollLeft()<e.scrollSensitivity?g=a(document).scrollLeft(a(document).scrollLeft()-e.scrollSpeed):a(window).width()-(c.pageX-a(document).scrollLeft())<e.scrollSensitivity&&(g=a(document).scrollLeft(a(document).scrollLeft()+e.scrollSpeed))}!1!==
g&&a.ui.ddmanager&&!e.dropBehaviour&&a.ui.ddmanager.prepareOffsets(d,c)}});a.ui.plugin.add("draggable","snap",{start:function(){var c=a(this).data("draggable"),d=c.options;c.snapElements=[];a(d.snap.constructor!=String?d.snap.items||":data(draggable)":d.snap).each(function(){var d=a(this),g=d.offset();this!=c.element[0]&&c.snapElements.push({item:this,width:d.outerWidth(),height:d.outerHeight(),top:g.top,left:g.left})})},drag:function(c,d){for(var e=a(this).data("draggable"),g=e.options,i=g.snapTolerance,
f=d.offset.left,b=f+e.helperProportions.width,j=d.offset.top,l=j+e.helperProportions.height,o=e.snapElements.length-1;0<=o;o--){var n=e.snapElements[o].left,m=n+e.snapElements[o].width,r=e.snapElements[o].top,s=r+e.snapElements[o].height;if(n-i<f&&f<m+i&&r-i<j&&j<s+i||n-i<f&&f<m+i&&r-i<l&&l<s+i||n-i<b&&b<m+i&&r-i<j&&j<s+i||n-i<b&&b<m+i&&r-i<l&&l<s+i){if("inner"!=g.snapMode){var p=Math.abs(r-l)<=i,q=Math.abs(s-j)<=i,x=Math.abs(n-b)<=i,w=Math.abs(m-f)<=i;p&&(d.position.top=e._convertPositionTo("relative",
{top:r-e.helperProportions.height,left:0}).top-e.margins.top);q&&(d.position.top=e._convertPositionTo("relative",{top:s,left:0}).top-e.margins.top);x&&(d.position.left=e._convertPositionTo("relative",{top:0,left:n-e.helperProportions.width}).left-e.margins.left);w&&(d.position.left=e._convertPositionTo("relative",{top:0,left:m}).left-e.margins.left)}var A=p||q||x||w;if("outer"!=g.snapMode&&(p=Math.abs(r-j)<=i,q=Math.abs(s-l)<=i,x=Math.abs(n-f)<=i,w=Math.abs(m-b)<=i,p&&(d.position.top=e._convertPositionTo("relative",
{top:r,left:0}).top-e.margins.top),q&&(d.position.top=e._convertPositionTo("relative",{top:s-e.helperProportions.height,left:0}).top-e.margins.top),x&&(d.position.left=e._convertPositionTo("relative",{top:0,left:n}).left-e.margins.left),w))d.position.left=e._convertPositionTo("relative",{top:0,left:m-e.helperProportions.width}).left-e.margins.left;!e.snapElements[o].snapping&&(p||q||x||w||A)&&e.options.snap.snap&&e.options.snap.snap.call(e.element,c,a.extend(e._uiHash(),{snapItem:e.snapElements[o].item}));
e.snapElements[o].snapping=p||q||x||w||A}else e.snapElements[o].snapping&&e.options.snap.release&&e.options.snap.release.call(e.element,c,a.extend(e._uiHash(),{snapItem:e.snapElements[o].item})),e.snapElements[o].snapping=!1}}});a.ui.plugin.add("draggable","stack",{start:function(){var c=a(this).data("draggable").options,c=a.makeArray(a(c.stack)).sort(function(c,d){return(parseInt(a(c).css("zIndex"),10)||0)-(parseInt(a(d).css("zIndex"),10)||0)});if(c.length){var d=parseInt(c[0].style.zIndex)||0;a(c).each(function(a){this.style.zIndex=
d+a});this[0].style.zIndex=d+c.length}}});a.ui.plugin.add("draggable","zIndex",{start:function(c,d){var e=a(d.helper),g=a(this).data("draggable").options;e.css("zIndex")&&(g._zIndex=e.css("zIndex"));e.css("zIndex",g.zIndex)},stop:function(c,d){var e=a(this).data("draggable").options;e._zIndex&&a(d.helper).css("zIndex",e._zIndex)}})})(jQuery);
...
!1},ui:function(a){return{draggable:a.currentItem||a.element,helper:a.helper,position:a.position,offset:a.positionAbs}}});a.extend(a.ui.droppable,{version:"1.8.20"});a.ui.intersect=function(c,d,e){if(!d.offset)return!1;var g=(c.positionAbs||c.position.absolute).left,i=g+c.helperProportions.width,f=(c.positionAbs||c.position.absolute).top,b=f+c.helperProportions.height,j=d.offset.left,l=j+d.proportions.width,o=d.offset.top,n=o+d.proportions.height;switch(e){case "fit":return j<=g&&i<=l&&o<=f&&b<=n;
case "intersect":return j<g+c.helperProportions.width/2&&i-c.helperProportions.width/2<l&&o<f+c.helperProportions.height/2&&b-c.helperProportions.height/2<n;case "pointer":return a.ui.isOver((c.positionAbs||c.position.absolute).top+(c.clickOffset||c.offset.click).top,(c.positionAbs||c.position.absolute).left+(c.clickOffset||c.offset.click).left,o,j,d.proportions.height,d.proportions.width);case "touch":return(f>=o&&f<=n||b>=o&&b<=n||f<o&&b>n)&&(g>=j&&g<=l||i>=j&&i<=l||g<j&&i>l);default:return!1}};
a.ui.ddmanager={current:null,droppables:{"default":[]},prepareOffsets:function(c,d){var e=a.ui.ddmanager.droppables[c.options.scope]||[],g=d?d.type:null,i=(c.currentItem||c.element).find(":data(droppable)").andSelf(),f=0;a:for(;f<e.length;f++)if(!(e[f].options.disabled||c&&!e[f].accept.call(e[f].element[0],c.currentItem||c.element))){for(var b=0;b<i.length;b++)if(i[b]==e[f].element[0]){e[f].proportions.height=0;continue a}e[f].visible="none"!=e[f].element.css("display");e[f].visible&&("mousedown"==
g&&e[f]._activate.call(e[f],d),e[f].offset=e[f].element.offset(),e[f].proportions={width:e[f].element[0].offsetWidth,height:e[f].element[0].offsetHeight})}},drop:function(c,d){var e=!1;a.each(a.ui.ddmanager.droppables[c.options.scope]||[],function(){if(this.options&&(!this.options.disabled&&this.visible&&a.ui.intersect(c,this,this.options.tolerance)&&(e=this._drop.call(this,d)||e),!this.options.disabled&&this.visible&&this.accept.call(this.element[0],c.currentItem||c.element)))this.isout=1,this.isover=
0,this._deactivate.call(this,d)});return e},dragStart:function(c,d){c.element.parents(":not(body,html)").bind("scroll.droppable",function(){c.options.refreshPositions||a.ui.ddmanager.prepareOffsets(c,d)})},drag:function(c,d){c.options.refreshPositions&&a.ui.ddmanager.prepareOffsets(c,d);a.each(a.ui.ddmanager.droppables[c.options.scope]||[],function(){if(!this.options.disabled&&!this.greedyChild&&this.visible){var e=a.ui.intersect(c,this,this.options.tolerance);if(e=!e&&1==this.isover?"isout":e&&0==
this.isover?"isover":null){var g;if(this.options.greedy){var i=this.element.parents(":data(droppable):eq(0)");i.length&&(g=a.data(i[0],"droppable"),g.greedyChild="isover"==e?1:0)}g&&"isover"==e&&(g.isover=0,g.isout=1,g._out.call(g,d));this[e]=1;this["isout"==e?"isover":"isout"]=0;this["isover"==e?"_over":"_out"].call(this,d);g&&"isout"==e&&(g.isout=0,g.isover=1,g._over.call(g,d))}}})},dragStop:function(c,d){c.element.parents(":not(body,html)").unbind("scroll.droppable");c.options.refreshPositions||
...
if(this.elementIsWrapper){c(this.element);var d=this.element;d.after(this.originalElement.css({position:d.css("position"),width:d.outerWidth(),height:d.outerHeight(),top:d.css("top"),left:d.css("left")})).remove()}this.originalElement.css("resize",this.originalResizeStyle);c(this.originalElement);return this},_mouseCapture:function(c){var d=!1,i;for(i in this.handles)a(this.handles[i])[0]==c.target&&(d=!0);return!this.options.disabled&&d},_mouseStart:function(d){var g=this.options,i=this.element.position(),
f=this.element;this.resizing=!0;this.documentScroll={top:a(document).scrollTop(),left:a(document).scrollLeft()};(f.is(".ui-draggable")||/absolute/.test(f.css("position")))&&f.css({position:"absolute",top:i.top,left:i.left});this._renderProxy();var i=c(this.helper.css("left")),b=c(this.helper.css("top"));g.containment&&(i+=a(g.containment).scrollLeft()||0,b+=a(g.containment).scrollTop()||0);this.offset=this.helper.offset();this.position={left:i,top:b};this.size=this._helper?{width:f.outerWidth(),height:f.outerHeight()}:
{width:f.width(),height:f.height()};this.originalSize=this._helper?{width:f.outerWidth(),height:f.outerHeight()}:{width:f.width(),height:f.height()};this.originalPosition={left:i,top:b};this.sizeDiff={width:f.outerWidth()-f.width(),height:f.outerHeight()-f.height()};this.originalMousePosition={left:d.pageX,top:d.pageY};this.aspectRatio="number"==typeof g.aspectRatio?g.aspectRatio:this.originalSize.width/this.originalSize.height||1;g=a(".ui-resizable-"+this.axis).css("cursor");a("body").css("cursor",
"auto"==g?this.axis+"-resize":g);f.addClass("ui-resizable-resizing");this._propagate("start",d);return!0},_mouseDrag:function(a){var c=this.helper,d=this.originalMousePosition,f=this._change[this.axis];if(!f)return!1;d=f.apply(this,[a,a.pageX-d.left||0,a.pageY-d.top||0]);this._updateVirtualBoundaries(a.shiftKey);if(this._aspectRatio||a.shiftKey)d=this._updateRatio(d,a);d=this._respectSize(d,a);this._propagate("resize",a);c.css({top:this.position.top+"px",left:this.position.left+"px",width:this.size.width+
"px",height:this.size.height+"px"});!this._helper&&this._proportionallyResizeElements.length&&this._proportionallyResize();this._updateCache(d);this._trigger("resize",a,this.ui());return!1},_mouseStop:function(c){this.resizing=!1;var d=this.options;if(this._helper){var i=this._proportionallyResizeElements,f=i.length&&/textarea/i.test(i[0].nodeName),i=f&&a.ui.hasScroll(i[0],"left")?0:this.sizeDiff.height,f=f?0:this.sizeDiff.width,f={width:this.helper.width()-f,height:this.helper.height()-i},i=parseInt(this.element.css("left"),
10)+(this.position.left-this.originalPosition.left)||null,b=parseInt(this.element.css("top"),10)+(this.position.top-this.originalPosition.top)||null;d.animate||this.element.css(a.extend(f,{top:b,left:i}));this.helper.height(this.size.height);this.helper.width(this.size.width);this._helper&&!d.animate&&this._proportionallyResize()}a("body").css("cursor","auto");this.element.removeClass("ui-resizable-resizing");this._propagate("stop",c);this._helper&&this.helper.remove();return!1},_updateVirtualBoundaries:function(a){var c=
this.options,i,f,b,c={minWidth:d(c.minWidth)?c.minWidth:0,maxWidth:d(c.maxWidth)?c.maxWidth:Infinity,minHeight:d(c.minHeight)?c.minHeight:0,maxHeight:d(c.maxHeight)?c.maxHeight:Infinity};if(this._aspectRatio||a)if(a=c.minHeight*this.aspectRatio,f=c.minWidth/this.aspectRatio,i=c.maxHeight*this.aspectRatio,b=c.maxWidth/this.aspectRatio,a>c.minWidth&&(c.minWidth=a),f>c.minHeight&&(c.minHeight=f),i<c.maxWidth&&(c.maxWidth=i),b<c.maxHeight)c.maxHeight=b;this._vBoundaries=c},_updateCache:function(a){this.offset=
this.helper.offset();d(a.left)&&(this.position.left=a.left);d(a.top)&&(this.position.top=a.top);d(a.height)&&(this.size.height=a.height);d(a.width)&&(this.size.width=a.width)},_updateRatio:function(a){var c=this.position,i=this.size,f=this.axis;d(a.height)?a.width=a.height*this.aspectRatio:d(a.width)&&(a.height=a.width/this.aspectRatio);"sw"==f&&(a.left=c.left+(i.width-a.width),a.top=null);"nw"==f&&(a.top=c.top+(i.height-a.height),a.left=c.left+(i.width-a.width));return a},_respectSize:function(a){var c=
this._vBoundaries,i=this.axis,f=d(a.width)&&c.maxWidth&&c.maxWidth<a.width,b=d(a.height)&&c.maxHeight&&c.maxHeight<a.height,j=d(a.width)&&c.minWidth&&c.minWidth>a.width,l=d(a.height)&&c.minHeight&&c.minHeight>a.height;j&&(a.width=c.minWidth);l&&(a.height=c.minHeight);f&&(a.width=c.maxWidth);b&&(a.height=c.maxHeight);var o=this.originalPosition.left+this.originalSize.width,n=this.position.top+this.size.height,m=/sw|nw|w/.test(i),i=/nw|ne|n/.test(i);j&&m&&(a.left=o-c.minWidth);f&&m&&(a.left=o-c.maxWidth);
l&&i&&(a.top=n-c.minHeight);b&&i&&(a.top=n-c.maxHeight);(c=!a.width&&!a.height)&&!a.left&&a.top?a.top=null:c&&!a.top&&a.left&&(a.left=null);return a},_proportionallyResize:function(){if(this._proportionallyResizeElements.length)for(var c=this.helper||this.element,d=0;d<this._proportionallyResizeElements.length;d++){var i=this._proportionallyResizeElements[d];if(!this.borderDif){var f=[i.css("borderTopWidth"),i.css("borderRightWidth"),i.css("borderBottomWidth"),i.css("borderLeftWidth")],b=[i.css("paddingTop"),
i.css("paddingRight"),i.css("paddingBottom"),i.css("paddingLeft")];this.borderDif=a.map(f,function(a,c){var d=parseInt(a,10)||0,e=parseInt(b[c],10)||0;return d+e})}if(!a.browser.msie||!a(c).is(":hidden")&&!a(c).parents(":hidden").length)i.css({height:c.height()-this.borderDif[0]-this.borderDif[2]||0,width:c.width()-this.borderDif[1]-this.borderDif[3]||0})}},_renderProxy:function(){var c=this.options;this.elementOffset=this.element.offset();if(this._helper){this.helper=this.helper||a('<div style="overflow:hidden;"></div>');
...
c}},n:function(a,c,d){return{top:this.originalPosition.top+d,height:this.originalSize.height-d}},s:function(a,c,d){return{height:this.originalSize.height+d}},se:function(c,d,i){return a.extend(this._change.s.apply(this,arguments),this._change.e.apply(this,[c,d,i]))},sw:function(c,d,i){return a.extend(this._change.s.apply(this,arguments),this._change.w.apply(this,[c,d,i]))},ne:function(c,d,i){return a.extend(this._change.n.apply(this,arguments),this._change.e.apply(this,[c,d,i]))},nw:function(c,d,
i){return a.extend(this._change.n.apply(this,arguments),this._change.w.apply(this,[c,d,i]))}},_propagate:function(c,d){a.ui.plugin.call(this,c,[d,this.ui()]);"resize"!=c&&this._trigger(c,d,this.ui())},plugins:{},ui:function(){return{originalElement:this.originalElement,element:this.element,helper:this.helper,position:this.position,size:this.size,originalSize:this.originalSize,originalPosition:this.originalPosition}}});a.extend(a.ui.resizable,{version:"1.8.20"});a.ui.plugin.add("resizable","alsoResize",
{start:function(){var c=a(this).data("resizable").options,d=function(c){a(c).each(function(){var c=a(this);c.data("resizable-alsoresize",{width:parseInt(c.width(),10),height:parseInt(c.height(),10),left:parseInt(c.css("left"),10),top:parseInt(c.css("top"),10)})})};"object"==typeof c.alsoResize&&!c.alsoResize.parentNode?c.alsoResize.length?(c.alsoResize=c.alsoResize[0],d(c.alsoResize)):a.each(c.alsoResize,function(a){d(a)}):d(c.alsoResize)},resize:function(c,d){var i=a(this).data("resizable"),f=i.options,
b=i.originalSize,j=i.originalPosition,l={height:i.size.height-b.height||0,width:i.size.width-b.width||0,top:i.position.top-j.top||0,left:i.position.left-j.left||0},o=function(b,c){a(b).each(function(){var b=a(this),e=a(this).data("resizable-alsoresize"),f={},j=c&&c.length?c:b.parents(d.originalElement[0]).length?["width","height"]:["width","height","top","left"];a.each(j,function(a,b){var c=(e[b]||0)+(l[b]||0);c&&0<=c&&(f[b]=c||null)});b.css(f)})};"object"==typeof f.alsoResize&&!f.alsoResize.nodeType?
a.each(f.alsoResize,function(a,b){o(a,b)}):o(f.alsoResize)},stop:function(){a(this).removeData("resizable-alsoresize")}});a.ui.plugin.add("resizable","animate",{stop:function(c){var d=a(this).data("resizable"),i=d.options,f=d._proportionallyResizeElements,b=f.length&&/textarea/i.test(f[0].nodeName),j=b&&a.ui.hasScroll(f[0],"left")?0:d.sizeDiff.height,b={width:d.size.width-(b?0:d.sizeDiff.width),height:d.size.height-j},j=parseInt(d.element.css("left"),10)+(d.position.left-d.originalPosition.left)||
null,l=parseInt(d.element.css("top"),10)+(d.position.top-d.originalPosition.top)||null;d.element.animate(a.extend(b,l&&j?{top:l,left:j}:{}),{duration:i.animateDuration,easing:i.animateEasing,step:function(){var b={width:parseInt(d.element.css("width"),10),height:parseInt(d.element.css("height"),10),top:parseInt(d.element.css("top"),10),left:parseInt(d.element.css("left"),10)};f&&f.length&&a(f[0]).css({width:b.width,height:b.height});d._updateCache(b);d._propagate("resize",c)}})}});a.ui.plugin.add("resizable",
"containment",{start:function(){var d=a(this).data("resizable"),g=d.element,i=d.options.containment;if(g=i instanceof a?i.get(0):/parent/.test(i)?g.parent().get(0):i)if(d.containerElement=a(g),/document/.test(i)||i==document)d.containerOffset={left:0,top:0},d.containerPosition={left:0,top:0},d.parentData={element:a(document),left:0,top:0,width:a(document).width(),height:a(document).height()||document.body.parentNode.scrollHeight};else{var f=a(g),b=[];a(["Top","Right","Left","Bottom"]).each(function(a,
d){b[a]=c(f.css("padding"+d))});d.containerOffset=f.offset();d.containerPosition=f.position();d.containerSize={height:f.innerHeight()-b[3],width:f.innerWidth()-b[1]};var i=d.containerOffset,j=d.containerSize.height,l=d.containerSize.width,l=a.ui.hasScroll(g,"left")?g.scrollWidth:l,j=a.ui.hasScroll(g)?g.scrollHeight:j;d.parentData={element:g,left:i.left,top:i.top,width:l,height:j}}},resize:function(c){var d=a(this).data("resizable"),i=d.options,f=d.containerOffset,b=d.position,c=d._aspectRatio||c.shiftKey,
j={top:0,left:0},l=d.containerElement;l[0]!=document&&/static/.test(l.css("position"))&&(j=f);if(b.left<(d._helper?f.left:0))d.size.width+=d._helper?d.position.left-f.left:d.position.left-j.left,c&&(d.size.height=d.size.width/d.aspectRatio),d.position.left=i.helper?f.left:0;if(b.top<(d._helper?f.top:0))d.size.height+=d._helper?d.position.top-f.top:d.position.top,c&&(d.size.width=d.size.height*d.aspectRatio),d.position.top=d._helper?f.top:0;d.offset.left=d.parentData.left+d.position.left;d.offset.top=
d.parentData.top+d.position.top;i=Math.abs(d.offset.left-j.left+d.sizeDiff.width);f=Math.abs((d._helper?d.offset.top-j.top:d.offset.top-f.top)+d.sizeDiff.height);b=d.containerElement.get(0)==d.element.parent().get(0);j=/relative|absolute/.test(d.containerElement.css("position"));b&&j&&(i-=d.parentData.left);i+d.size.width>=d.parentData.width&&(d.size.width=d.parentData.width-i,c&&(d.size.height=d.size.width/d.aspectRatio));f+d.size.height>=d.parentData.height&&(d.size.height=d.parentData.height-f,
c&&(d.size.width=d.size.height*d.aspectRatio))},stop:function(){var c=a(this).data("resizable"),d=c.options,i=c.containerOffset,f=c.containerPosition,b=c.containerElement,j=a(c.helper),l=j.offset(),o=j.outerWidth()-c.sizeDiff.width,j=j.outerHeight()-c.sizeDiff.height;c._helper&&!d.animate&&/relative/.test(b.css("position"))&&a(this).css({left:l.left-f.left-i.left,width:o,height:j});c._helper&&!d.animate&&/static/.test(b.css("position"))&&a(this).css({left:l.left-f.left-i.left,width:o,height:j})}});
a.ui.plugin.add("resizable","ghost",{start:function(){var c=a(this).data("resizable"),d=c.options,i=c.size;c.ghost=c.originalElement.clone();c.ghost.css({opacity:0.25,display:"block",position:"relative",height:i.height,width:i.width,margin:0,left:0,top:0}).addClass("ui-resizable-ghost").addClass("string"==typeof d.ghost?d.ghost:"");c.ghost.appendTo(c.helper)},resize:function(){var c=a(this).data("resizable");c.ghost&&c.ghost.css({position:"relative",height:c.size.height,width:c.size.width})},stop:function(){var c=
a(this).data("resizable");c.ghost&&c.helper&&c.helper.get(0).removeChild(c.ghost.get(0))}});a.ui.plugin.add("resizable","grid",{resize:function(){var c=a(this).data("resizable"),d=c.options,i=c.size,f=c.originalSize,b=c.originalPosition,j=c.axis;d.grid="number"==typeof d.grid?[d.grid,d.grid]:d.grid;var l=Math.round((i.width-f.width)/(d.grid[0]||1))*(d.grid[0]||1),d=Math.round((i.height-f.height)/(d.grid[1]||1))*(d.grid[1]||1);/^(se|s|e)$/.test(j)?(c.size.width=f.width+l,c.size.height=f.height+d):
/^(ne)$/.test(j)?(c.size.width=f.width+l,c.size.height=f.height+d,c.position.top=b.top-d):(/^(sw)$/.test(j)?(c.size.width=f.width+l,c.size.height=f.height+d):(c.size.width=f.width+l,c.size.height=f.height+d,c.position.top=b.top-d),c.position.left=b.left-l)}});var c=function(a){return parseInt(a,10)||0},d=function(a){return!isNaN(parseInt(a,10))}})(jQuery);
...
e.unselecting=!0,d._trigger("unselecting",c,{unselecting:e.element}))});a(c.target).parents().andSelf().each(function(){var e=a.data(this,"selectable-item");if(e){var i=!c.metaKey&&!c.ctrlKey||!e.$element.hasClass("ui-selected");e.$element.removeClass(i?"ui-unselecting":"ui-selected").addClass(i?"ui-selecting":"ui-unselecting");e.unselecting=!i;e.selecting=i;(e.selected=i)?d._trigger("selecting",c,{selecting:e.element}):d._trigger("unselecting",c,{unselecting:e.element});return!1}})}},_mouseDrag:function(c){var d=
this;this.dragged=!0;if(!this.options.disabled){var e=this.options,g=this.opos[0],i=this.opos[1],f=c.pageX,b=c.pageY;if(g>f)var j=f,f=g,g=j;i>b&&(j=b,b=i,i=j);this.helper.css({left:g,top:i,width:f-g,height:b-i});this.selectees.each(function(){var j=a.data(this,"selectable-item");if(j&&j.element!=d.element[0]){var o=false;e.tolerance=="touch"?o=!(j.left>f||j.right<g||j.top>b||j.bottom<i):e.tolerance=="fit"&&(o=j.left>g&&j.right<f&&j.top>i&&j.bottom<b);if(o){if(j.selected){j.$element.removeClass("ui-selected");
...
!1;e.startselected=!1;d._trigger("unselected",c,{unselected:e.element})});a(".ui-selecting",this.element[0]).each(function(){var e=a.data(this,"selectable-item");e.$element.removeClass("ui-selecting").addClass("ui-selected");e.selecting=!1;e.selected=!0;e.startselected=!0;d._trigger("selected",c,{selected:e.element})});this._trigger("stop",c);this.helper.remove();return!1}});a.extend(a.ui.selectable,{version:"1.8.20"})})(jQuery);
...
return!0},_mouseDrag:function(c){this.position=this._generatePosition(c);this.positionAbs=this._convertPositionTo("absolute");this.lastPositionAbs||(this.lastPositionAbs=this.positionAbs);if(this.options.scroll){var d=this.options,e=!1;this.scrollParent[0]!=document&&"HTML"!=this.scrollParent[0].tagName?(this.overflowOffset.top+this.scrollParent[0].offsetHeight-c.pageY<d.scrollSensitivity?this.scrollParent[0].scrollTop=e=this.scrollParent[0].scrollTop+d.scrollSpeed:c.pageY-this.overflowOffset.top<
d.scrollSensitivity&&(this.scrollParent[0].scrollTop=e=this.scrollParent[0].scrollTop-d.scrollSpeed),this.overflowOffset.left+this.scrollParent[0].offsetWidth-c.pageX<d.scrollSensitivity)?this.scrollParent[0].scrollLeft=e=this.scrollParent[0].scrollLeft+d.scrollSpeed:c.pageX-this.overflowOffset.left<d.scrollSensitivity&&(this.scrollParent[0].scrollLeft=e=this.scrollParent[0].scrollLeft-d.scrollSpeed):(c.pageY-a(document).scrollTop()<d.scrollSensitivity?e=a(document).scrollTop(a(document).scrollTop()-
d.scrollSpeed):a(window).height()-(c.pageY-a(document).scrollTop())<d.scrollSensitivity&&(e=a(document).scrollTop(a(document).scrollTop()+d.scrollSpeed)),c.pageX-a(document).scrollLeft()<d.scrollSensitivity?e=a(document).scrollLeft(a(document).scrollLeft()-d.scrollSpeed):a(window).width()-(c.pageX-a(document).scrollLeft())<d.scrollSensitivity&&(e=a(document).scrollLeft(a(document).scrollLeft()+d.scrollSpeed)));!1!==e&&a.ui.ddmanager&&!d.dropBehaviour&&a.ui.ddmanager.prepareOffsets(this,c)}this.positionAbs=
this._convertPositionTo("absolute");if(!this.options.axis||"y"!=this.options.axis)this.helper[0].style.left=this.position.left+"px";if(!this.options.axis||"x"!=this.options.axis)this.helper[0].style.top=this.position.top+"px";for(d=this.items.length-1;0<=d;d--){var e=this.items[d],g=e.item[0],i=this._intersectsWithPointer(e);if(i&&g!=this.currentItem[0]&&this.placeholder[1==i?"next":"prev"]()[0]!=g&&!a.ui.contains(this.placeholder[0],g)&&("semi-dynamic"==this.options.type?!a.ui.contains(this.element[0],
g):1)){this.direction=1==i?"down":"up";if("pointer"==this.options.tolerance||this._intersectsWithSides(e))this._rearrange(c,e);else break;this._trigger("change",c,this._uiHash());break}}this._contactContainers(c);a.ui.ddmanager&&a.ui.ddmanager.drag(this,c);this._trigger("sort",c,this._uiHash());this.lastPositionAbs=this.positionAbs;return!1},_mouseStop:function(c,d){if(c){a.ui.ddmanager&&!this.options.dropBehaviour&&a.ui.ddmanager.drop(this,c);if(this.options.revert){var e=this,g=e.placeholder.offset();
e.reverting=!0;a(this.helper).animate({left:g.left-this.offset.parent.left-e.margins.left+(this.offsetParent[0]==document.body?0:this.offsetParent[0].scrollLeft),top:g.top-this.offset.parent.top-e.margins.top+(this.offsetParent[0]==document.body?0:this.offsetParent[0].scrollTop)},parseInt(this.options.revert,10)||500,function(){e._clear(c)})}else this._clear(c,d);return!1}},cancel:function(){if(this.dragging){this._mouseUp({target:null});"original"==this.options.helper?this.currentItem.css(this._storedCSS).removeClass("ui-sortable-helper"):
...
dragging:!1,reverting:!1,_noFinalSort:null}),this.domPosition.prev?a(this.domPosition.prev).after(this.currentItem):a(this.domPosition.parent).prepend(this.currentItem));return this},serialize:function(c){var d=this._getItemsAsjQuery(c&&c.connected),e=[],c=c||{};a(d).each(function(){var d=(a(c.item||this).attr(c.attribute||"id")||"").match(c.expression||/(.+)[-=_](.+)/);d&&e.push((c.key||d[1]+"[]")+"="+(c.key&&c.expression?d[1]:d[2]))});!e.length&&c.key&&e.push(c.key+"=");return e.join("&")},toArray:function(c){var d=
this._getItemsAsjQuery(c&&c.connected),e=[],c=c||{};d.each(function(){e.push(a(c.item||this).attr(c.attribute||"id")||"")});return e},_intersectsWith:function(a){var d=this.positionAbs.left,e=d+this.helperProportions.width,g=this.positionAbs.top,i=g+this.helperProportions.height,f=a.left,b=f+a.width,j=a.top,l=j+a.height,o=this.offset.click.top,n=this.offset.click.left;return"pointer"==this.options.tolerance||this.options.forcePointerForContainers||"pointer"!=this.options.tolerance&&this.helperProportions[this.floating?
"width":"height"]>a[this.floating?"width":"height"]?g+o>j&&g+o<l&&d+n>f&&d+n<b:f<d+this.helperProportions.width/2&&e-this.helperProportions.width/2<b&&j<g+this.helperProportions.height/2&&i-this.helperProportions.height/2<l},_intersectsWithPointer:function(c){var d="x"===this.options.axis||a.ui.isOverAxis(this.positionAbs.top+this.offset.click.top,c.top,c.height),c="y"===this.options.axis||a.ui.isOverAxis(this.positionAbs.left+this.offset.click.left,c.left,c.width),d=d&&c,c=this._getDragVerticalDirection(),
e=this._getDragHorizontalDirection();return!d?!1:this.floating?e&&"right"==e||"down"==c?2:1:c&&("down"==c?2:1)},_intersectsWithSides:function(c){var d=a.ui.isOverAxis(this.positionAbs.top+this.offset.click.top,c.top+c.height/2,c.height),c=a.ui.isOverAxis(this.positionAbs.left+this.offset.click.left,c.left+c.width/2,c.width),e=this._getDragVerticalDirection(),g=this._getDragHorizontalDirection();return this.floating&&g?"right"==g&&c||"left"==g&&!c:e&&("down"==e&&d||"up"==e&&!d)},_getDragVerticalDirection:function(){var a=
this.positionAbs.top-this.lastPositionAbs.top;return 0!=a&&(0<a?"down":"up")},_getDragHorizontalDirection:function(){var a=this.positionAbs.left-this.lastPositionAbs.left;return 0!=a&&(0<a?"right":"left")},refresh:function(a){this._refreshItems(a);this.refreshPositions();return this},_connectWith:function(){var a=this.options;return a.connectWith.constructor==String?[a.connectWith]:a.connectWith},_getItemsAsjQuery:function(c){var d=[],e=[],g=this._connectWith();if(g&&c)for(c=g.length-1;0<=c;c--)for(var i=
a(g[c]),f=i.length-1;0<=f;f--){var b=a.data(i[f],this.widgetName);b&&b!=this&&!b.options.disabled&&e.push([a.isFunction(b.options.items)?b.options.items.call(b.element):a(b.options.items,b.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),b])}e.push([a.isFunction(this.options.items)?this.options.items.call(this.element,null,{options:this.options,item:this.currentItem}):a(this.options.items,this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),this]);for(c=e.length-
1;0<=c;c--)e[c][0].each(function(){d.push(this)});return a(d)},_removeCurrentsFromItems:function(){for(var a=this.currentItem.find(":data("+this.widgetName+"-item)"),d=0;d<this.items.length;d++)for(var e=0;e<a.length;e++)a[e]==this.items[d].item[0]&&this.items.splice(d,1)},_refreshItems:function(c){this.items=[];this.containers=[this];var d=this.items,e=[[a.isFunction(this.options.items)?this.options.items.call(this.element[0],c,{item:this.currentItem}):a(this.options.items,this.element),this]],g=
this._connectWith();if(g&&this.ready)for(var i=g.length-1;0<=i;i--)for(var f=a(g[i]),b=f.length-1;0<=b;b--){var j=a.data(f[b],this.widgetName);j&&j!=this&&!j.options.disabled&&(e.push([a.isFunction(j.options.items)?j.options.items.call(j.element[0],c,{item:this.currentItem}):a(j.options.items,j.element),j]),this.containers.push(j))}for(i=e.length-1;0<=i;i--){c=e[i][1];g=e[i][0];b=0;for(f=g.length;b<f;b++)j=a(g[b]),j.data(this.widgetName+"-item",c),d.push({item:j,instance:c,width:0,height:0,left:0,
...
a(document.createElement(d.currentItem[0].nodeName)).addClass(g||d.currentItem[0].className+" ui-sortable-placeholder").removeClass("ui-sortable-helper")[0];g||(c.style.visibility="hidden");return c},update:function(a,c){if(!g||e.forcePlaceholderSize)c.height()||c.height(d.currentItem.innerHeight()-parseInt(d.currentItem.css("paddingTop")||0,10)-parseInt(d.currentItem.css("paddingBottom")||0,10)),c.width()||c.width(d.currentItem.innerWidth()-parseInt(d.currentItem.css("paddingLeft")||0,10)-parseInt(d.currentItem.css("paddingRight")||
0,10))}}}d.placeholder=a(e.placeholder.element.call(d.element,d.currentItem));d.currentItem.after(d.placeholder);e.placeholder.update(d,d.placeholder)},_contactContainers:function(c){for(var d=null,e=null,g=this.containers.length-1;0<=g;g--)if(!a.ui.contains(this.currentItem[0],this.containers[g].element[0]))if(this._intersectsWith(this.containers[g].containerCache)){if(!d||!a.ui.contains(this.containers[g].element[0],d.element[0]))d=this.containers[g],e=g}else this.containers[g].containerCache.over&&
(this.containers[g]._trigger("out",c,this._uiHash(this)),this.containers[g].containerCache.over=0);if(d)if(1===this.containers.length)this.containers[e]._trigger("over",c,this._uiHash(this)),this.containers[e].containerCache.over=1;else if(this.currentContainer!=this.containers[e]){for(var d=1E4,g=null,i=this.positionAbs[this.containers[e].floating?"left":"top"],f=this.items.length-1;0<=f;f--)if(a.ui.contains(this.containers[e].element[0],this.items[f].item[0])){var b=this.items[f][this.containers[e].floating?
"left":"top"];Math.abs(b-i)<d&&(d=Math.abs(b-i),g=this.items[f])}if(g||this.options.dropOnEmpty)this.currentContainer=this.containers[e],g?this._rearrange(c,g,null,!0):this._rearrange(c,null,this.containers[e].element,!0),this._trigger("change",c,this._uiHash()),this.containers[e]._trigger("change",c,this._uiHash(this)),this.options.placeholder.update(this.currentContainer,this.placeholder),this.containers[e]._trigger("over",c,this._uiHash(this)),this.containers[e].containerCache.over=1}},_createHelper:function(c){var d=
...
this.margins.top]}},_convertPositionTo:function(c,d){d||(d=this.position);var e="absolute"==c?1:-1,g="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,i=/(html|body)/i.test(g[0].tagName);return{top:d.top+this.offset.relative.top*e+this.offset.parent.top*e-(a.browser.safari&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollTop():i?0:g.scrollTop())*e),left:d.left+
this.offset.relative.left*e+this.offset.parent.left*e-(a.browser.safari&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollLeft():i?0:g.scrollLeft())*e)}},_generatePosition:function(c){var d=this.options,e="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,g=/(html|body)/i.test(e[0].tagName);"relative"==this.cssPosition&&!(this.scrollParent[0]!=document&&this.scrollParent[0]!=
this.offsetParent[0])&&(this.offset.relative=this._getRelativeOffset());var i=c.pageX,f=c.pageY;if(this.originalPosition&&(this.containment&&(c.pageX-this.offset.click.left<this.containment[0]&&(i=this.containment[0]+this.offset.click.left),c.pageY-this.offset.click.top<this.containment[1]&&(f=this.containment[1]+this.offset.click.top),c.pageX-this.offset.click.left>this.containment[2]&&(i=this.containment[2]+this.offset.click.left),c.pageY-this.offset.click.top>this.containment[3]&&(f=this.containment[3]+
...
this.containment[0])?i-d.grid[0]:i+d.grid[0]:i;return{top:f-this.offset.click.top-this.offset.relative.top-this.offset.parent.top+(a.browser.safari&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?-this.scrollParent.scrollTop():g?0:e.scrollTop()),left:i-this.offset.click.left-this.offset.relative.left-this.offset.parent.left+(a.browser.safari&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?-this.scrollParent.scrollLeft():g?0:e.scrollLeft())}},_rearrange:function(a,d,e,g){e?e[0].appendChild(this.placeholder[0]):
d.item[0].parentNode.insertBefore(this.placeholder[0],"down"==this.direction?d.item[0]:d.item[0].nextSibling);this.counter=this.counter?++this.counter:1;var i=this,f=this.counter;window.setTimeout(function(){f==i.counter&&i.refreshPositions(!g)},0)},_clear:function(c,d){this.reverting=!1;var e=[];!this._noFinalSort&&this.currentItem.parent().length&&this.placeholder.before(this.currentItem);this._noFinalSort=null;if(this.helper[0]==this.currentItem[0]){for(var g in this._storedCSS)if("auto"==this._storedCSS[g]||
"static"==this._storedCSS[g])this._storedCSS[g]="";this.currentItem.css(this._storedCSS).removeClass("ui-sortable-helper")}else this.currentItem.show();this.fromOutside&&!d&&e.push(function(a){this._trigger("receive",a,this._uiHash(this.fromOutside))});(this.fromOutside||this.domPosition.prev!=this.currentItem.prev().not(".ui-sortable-helper")[0]||this.domPosition.parent!=this.currentItem.parent()[0])&&!d&&e.push(function(a){this._trigger("update",a,this._uiHash())});if(!a.ui.contains(this.element[0],
this.currentItem[0])){d||e.push(function(a){this._trigger("remove",a,this._uiHash())});for(g=this.containers.length-1;0<=g;g--)a.ui.contains(this.containers[g].element[0],this.currentItem[0])&&!d&&(e.push(function(a){return function(c){a._trigger("receive",c,this._uiHash(this))}}.call(this,this.containers[g])),e.push(function(a){return function(c){a._trigger("update",c,this._uiHash(this))}}.call(this,this.containers[g])))}for(g=this.containers.length-1;0<=g;g--)d||e.push(function(a){return function(c){a._trigger("deactivate",
...
typeof a[c]&&(b[c]=a[c]);return b}function g(b){var c,d;for(c in b)d=b[c],(null==d||a.isFunction(d)||c in o||/scrollbar/.test(c)||!/color/i.test(c)&&isNaN(parseFloat(d)))&&delete b[c];return b}function i(a,b){var c={_:0},d;for(d in b)a[d]!=b[d]&&(c[d]=b[d]);return c}function f(b,c,d,e){"object"==typeof b&&(e=c,d=null,c=b,b=c.effect);a.isFunction(c)&&(e=c,d=null,c={});if("number"==typeof c||a.fx.speeds[c])e=d,d=c,c={};a.isFunction(d)&&(e=d,d=null);c=c||{};d=d||c.duration;d=a.fx.off?0:"number"==typeof d?
d:d in a.fx.speeds?a.fx.speeds[d]:a.fx.speeds._default;e=e||c.complete;return[b,c,d,e]}function b(b){return!b||"number"===typeof b||a.fx.speeds[b]||"string"===typeof b&&!a.effects[b]?!0:!1}a.effects={};a.each("backgroundColor,borderBottomColor,borderLeftColor,borderRightColor,borderTopColor,borderColor,color,outlineColor".split(","),function(b,c){a.fx.step[c]=function(b){if(!b.colorInit){var e;e=b.elem;var f=c,j;do{j=a.curCSS(e,f);if(j!=""&&j!="transparent"||a.nodeName(e,"body"))break;f="backgroundColor"}while(e=
e.parentNode);e=d(j);b.start=e;b.end=d(b.end);b.colorInit=true}b.elem.style[c]="rgb("+Math.max(Math.min(parseInt(b.pos*(b.end[0]-b.start[0])+b.start[0],10),255),0)+","+Math.max(Math.min(parseInt(b.pos*(b.end[1]-b.start[1])+b.start[1],10),255),0)+","+Math.max(Math.min(parseInt(b.pos*(b.end[2]-b.start[2])+b.start[2],10),255),0)+")"}});var j={aqua:[0,255,255],azure:[240,255,255],beige:[245,245,220],black:[0,0,0],blue:[0,0,255],brown:[165,42,42],cyan:[0,255,255],darkblue:[0,0,139],darkcyan:[0,139,139],
darkgrey:[169,169,169],darkgreen:[0,100,0],darkkhaki:[189,183,107],darkmagenta:[139,0,139],darkolivegreen:[85,107,47],darkorange:[255,140,0],darkorchid:[153,50,204],darkred:[139,0,0],darksalmon:[233,150,122],darkviolet:[148,0,211],fuchsia:[255,0,255],gold:[255,215,0],green:[0,128,0],indigo:[75,0,130],khaki:[240,230,140],lightblue:[173,216,230],lightcyan:[224,255,255],lightgreen:[144,238,144],lightgrey:[211,211,211],lightpink:[255,182,193],lightyellow:[255,255,224],lime:[0,255,0],magenta:[255,0,255],
maroon:[128,0,0],navy:[0,0,128],olive:[128,128,0],orange:[255,165,0],pink:[255,192,203],purple:[128,0,128],violet:[128,0,128],red:[255,0,0],silver:[192,192,192],white:[255,255,255],yellow:[255,255,0],transparent:[255,255,255]},l=["add","remove","toggle"],o={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};a.effects.animateClass=function(b,c,d,f){a.isFunction(d)&&(f=d,d=null);return this.queue(function(){var j=a(this),o=j.attr("style")||
" ",x=g(e.call(this)),w,A=j.attr("class")||"";a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});w=g(e.call(this));j.attr("class",A);j.animate(i(x,w),{queue:false,duration:c,easing:d,complete:function(){a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});if(typeof j.attr("style")=="object"){j.attr("style").cssText="";j.attr("style").cssText=o}else j.attr("style",o);f&&f.apply(this,arguments);a.dequeue(this)}})})};a.fn.extend({_addClass:a.fn.addClass,addClass:function(b,c,d,e){return c?a.effects.animateClass.apply(this,
[{add:b},c,d,e]):this._addClass(b)},_removeClass:a.fn.removeClass,removeClass:function(b,c,d,e){return c?a.effects.animateClass.apply(this,[{remove:b},c,d,e]):this._removeClass(b)},_toggleClass:a.fn.toggleClass,toggleClass:function(b,d,e,f,j){return"boolean"==typeof d||d===c?e?a.effects.animateClass.apply(this,[d?{add:b}:{remove:b},e,f,j]):this._toggleClass(b,d):a.effects.animateClass.apply(this,[{toggle:b},d,e,f])},switchClass:function(b,c,d,e,f){return a.effects.animateClass.apply(this,[{add:c,
remove:b},d,e,f])}});a.extend(a.effects,{version:"1.8.20",save:function(a,b){for(var c=0;c<b.length;c++)null!==b[c]&&a.data("ec.storage."+b[c],a[0].style[b[c]])},restore:function(a,b){for(var c=0;c<b.length;c++)null!==b[c]&&a.css(b[c],a.data("ec.storage."+b[c]))},setMode:function(a,b){"toggle"==b&&(b=a.is(":hidden")?"show":"hide");return b},getBaseline:function(a,b){var c,d;switch(a[0]){case "top":c=0;break;case "middle":c=0.5;break;case "bottom":c=1;break;default:c=a[0]/b.height}switch(a[1]){case "left":d=
...
c):b},setTransition:function(b,c,d,e){e=e||{};a.each(c,function(a,c){var f=b.cssUnit(c);0<f[0]&&(e[c]=f[0]*d+f[1])});return e}});a.fn.extend({effect:function(b,c,d,e){var j=f.apply(this,arguments),g={options:j[1],duration:j[2],callback:j[3]},j=g.options.mode,i=a.effects[b];return a.fx.off||!i?j?this[j](g.duration,g.callback):this.each(function(){g.callback&&g.callback.call(this)}):i.call(this,g)},_show:a.fn.show,show:function(a){if(b(a))return this._show.apply(this,arguments);var c=f.apply(this,arguments);
c[1].mode="show";return this.effect.apply(this,c)},_hide:a.fn.hide,hide:function(a){if(b(a))return this._hide.apply(this,arguments);var c=f.apply(this,arguments);c[1].mode="hide";return this.effect.apply(this,c)},__toggle:a.fn.toggle,toggle:function(c){if(b(c)||"boolean"===typeof c||a.isFunction(c))return this.__toggle.apply(this,arguments);var d=f.apply(this,arguments);d[1].mode="toggle";return this.effect.apply(this,d)},cssUnit:function(b){var c=this.css(b),d=[];a.each(["em","px","%","pt"],function(a,
...
f)+d+c},easeInBack:function(a,b,d,e,f,j){j==c&&(j=1.70158);return e*(b/=f)*b*((j+1)*b-j)+d},easeOutBack:function(a,b,d,e,f,j){j==c&&(j=1.70158);return e*((b=b/f-1)*b*((j+1)*b+j)+1)+d},easeInOutBack:function(a,b,d,e,f,j){j==c&&(j=1.70158);return 1>(b/=f/2)?e/2*b*b*(((j*=1.525)+1)*b-j)+d:e/2*((b-=2)*b*(((j*=1.525)+1)*b+j)+2)+d},easeInBounce:function(b,c,d,e,f){return e-a.easing.easeOutBounce(b,f-c,0,e,f)+d},easeOutBounce:function(a,b,c,d,e){return(b/=e)<1/2.75?d*7.5625*b*b+c:b<2/2.75?d*(7.5625*(b-=
1.5/2.75)*b+0.75)+c:b<2.5/2.75?d*(7.5625*(b-=2.25/2.75)*b+0.9375)+c:d*(7.5625*(b-=2.625/2.75)*b+0.984375)+c},easeInOutBounce:function(b,c,d,e,f){return c<f/2?0.5*a.easing.easeInBounce(b,2*c,0,e,f)+d:0.5*a.easing.easeOutBounce(b,2*c-f,0,e,f)+0.5*e+d}})}(jQuery);
(function(a){a.effects.blind=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],g=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.direction||"vertical";a.effects.save(d,e);d.show();var f=a.effects.createWrapper(d).css({overflow:"hidden"}),b="vertical"==i?"height":"width",i="vertical"==i?f.height():f.width();"show"==g&&f.css(b,0);var j={};j[b]="show"==g?i:0;f.animate(j,c.duration,c.options.easing,function(){"hide"==g&&d.hide();a.effects.restore(d,
e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
(function(a){a.effects.bounce=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],g=a.effects.setMode(d,c.options.mode||"effect"),i=c.options.direction||"up",f=c.options.distance||20,b=c.options.times||5,j=c.duration||250;/show|hide/.test(g)&&e.push("opacity");a.effects.save(d,e);d.show();a.effects.createWrapper(d);var l="up"==i||"down"==i?"top":"left",i="up"==i||"left"==i?"pos":"neg",f=c.options.distance||("top"==l?d.outerHeight({margin:!0})/3:d.outerWidth({margin:!0})/
3);"show"==g&&d.css("opacity",0).css(l,"pos"==i?-f:f);"hide"==g&&(f/=2*b);"hide"!=g&&b--;if("show"==g){var o={opacity:1};o[l]=("pos"==i?"+=":"-=")+f;d.animate(o,j/2,c.options.easing);f/=2;b--}for(o=0;o<b;o++){var n={},m={};n[l]=("pos"==i?"-=":"+=")+f;m[l]=("pos"==i?"+=":"-=")+f;d.animate(n,j/2,c.options.easing).animate(m,j/2,c.options.easing);f="hide"==g?2*f:f/2}"hide"==g?(o={opacity:0},o[l]=("pos"==i?"-=":"+=")+f,d.animate(o,j/2,c.options.easing,function(){d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);
c.callback&&c.callback.apply(this,arguments)})):(n={},m={},n[l]=("pos"==i?"-=":"+=")+f,m[l]=("pos"==i?"+=":"-=")+f,d.animate(n,j/2,c.options.easing).animate(m,j/2,c.options.easing,function(){a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)}));d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(jQuery);
(function(a){a.effects.clip=function(c){return this.queue(function(){var d=a(this),e="position,top,bottom,left,right,height,width".split(","),g=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.direction||"vertical";a.effects.save(d,e);d.show();var f=a.effects.createWrapper(d).css({overflow:"hidden"}),f="IMG"==d[0].tagName?f:d,b="vertical"==i?"height":"width",j="vertical"==i?"top":"left",i="vertical"==i?f.height():f.width();"show"==g&&(f.css(b,0),f.css(j,i/2));var l={};l[b]="show"==g?i:0;l[j]=
"show"==g?0:i/2;f.animate(l,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){g=="hide"&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.drop=function(c){return this.queue(function(){var d=a(this),e="position,top,bottom,left,right,opacity".split(","),g=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.direction||"left";a.effects.save(d,e);d.show();a.effects.createWrapper(d);var f="up"==i||"down"==i?"top":"left",i="up"==i||"left"==i?"pos":"neg",b=c.options.distance||("top"==f?d.outerHeight({margin:!0})/2:d.outerWidth({margin:!0})/2);"show"==g&&d.css("opacity",0).css(f,"pos"==i?-b:b);var j={opacity:"show"==
g?1:0};j[f]=("show"==g?"pos"==i?"+=":"-=":"pos"==i?"-=":"+=")+b;d.animate(j,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){"hide"==g&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.explode=function(c){return this.queue(function(){var d=c.options.pieces?Math.round(Math.sqrt(c.options.pieces)):3,e=c.options.pieces?Math.round(Math.sqrt(c.options.pieces)):3;c.options.mode="toggle"==c.options.mode?a(this).is(":visible")?"hide":"show":c.options.mode;var g=a(this).show().css("visibility","hidden"),i=g.offset();i.top-=parseInt(g.css("marginTop"),10)||0;i.left-=parseInt(g.css("marginLeft"),10)||0;for(var f=g.outerWidth(!0),b=g.outerHeight(!0),j=0;j<d;j++)for(var l=
0;l<e;l++)g.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-l*(f/e),top:-j*(b/d)}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:f/e,height:b/d,left:i.left+l*(f/e)+("show"==c.options.mode?(l-Math.floor(e/2))*(f/e):0),top:i.top+j*(b/d)+("show"==c.options.mode?(j-Math.floor(d/2))*(b/d):0),opacity:"show"==c.options.mode?0:1}).animate({left:i.left+l*(f/e)+("show"==c.options.mode?0:(l-Math.floor(e/2))*(f/e)),top:i.top+
j*(b/d)+("show"==c.options.mode?0:(j-Math.floor(d/2))*(b/d)),opacity:"show"==c.options.mode?1:0},c.duration||500);setTimeout(function(){"show"==c.options.mode?g.css({visibility:"visible"}):g.css({visibility:"visible"}).hide();c.callback&&c.callback.apply(g[0]);g.dequeue();a("div.ui-effects-explode").remove()},c.duration||500)})}})(jQuery);
...
(function(a){a.effects.fold=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],g=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.size||15,f=!!c.options.horizFirst,b=c.duration?c.duration/2:a.fx.speeds._default/2;a.effects.save(d,e);d.show();var j=a.effects.createWrapper(d).css({overflow:"hidden"}),l="show"==g!=f,o=l?["width","height"]:["height","width"],l=l?[j.width(),j.height()]:[j.height(),j.width()],n=/([0-9]+)%/.exec(i);n&&(i=parseInt(n[1],
10)/100*l["hide"==g?0:1]);"show"==g&&j.css(f?{height:0,width:i}:{height:i,width:0});f={};n={};f[o[0]]="show"==g?l[0]:i;n[o[1]]="show"==g?l[1]:0;j.animate(f,b,c.options.easing).animate(n,b,c.options.easing,function(){"hide"==g&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
(function(a){a.effects.highlight=function(c){return this.queue(function(){var d=a(this),e=["backgroundImage","backgroundColor","opacity"],g=a.effects.setMode(d,c.options.mode||"show"),i={backgroundColor:d.css("backgroundColor")};"hide"==g&&(i.opacity=0);a.effects.save(d,e);d.show().css({backgroundImage:"none",backgroundColor:c.options.color||"#ffff99"}).animate(i,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){g=="hide"&&d.hide();a.effects.restore(d,e);g=="show"&&!a.support.opacity&&
this.style.removeAttribute("filter");c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.pulsate=function(c){return this.queue(function(){var d=a(this),e=a.effects.setMode(d,c.options.mode||"show"),g=2*(c.options.times||5)-1,i=c.duration?c.duration/2:a.fx.speeds._default/2,f=d.is(":visible"),b=0;f||(d.css("opacity",0).show(),b=1);("hide"==e&&f||"show"==e&&!f)&&g--;for(e=0;e<g;e++)d.animate({opacity:b},i,c.options.easing),b=(b+1)%2;d.animate({opacity:b},i,c.options.easing,function(){b==0&&d.hide();c.callback&&c.callback.apply(this,arguments)});d.queue("fx",function(){d.dequeue()}).dequeue()})}})(jQuery);
(function(a){a.effects.puff=function(c){return this.queue(function(){var d=a(this),e=a.effects.setMode(d,c.options.mode||"hide"),g=parseInt(c.options.percent,10)||150,i=g/100,f={height:d.height(),width:d.width()};a.extend(c.options,{fade:!0,mode:e,percent:"hide"==e?g:100,from:"hide"==e?f:{height:f.height*i,width:f.width*i}});d.effect("scale",c.options,c.duration,c.callback);d.dequeue()})};a.effects.scale=function(c){return this.queue(function(){var d=a(this),e=a.extend(!0,{},c.options),g=a.effects.setMode(d,
c.options.mode||"effect"),i=parseInt(c.options.percent,10)||(0==parseInt(c.options.percent,10)?0:"hide"==g?0:100),f=c.options.direction||"both",b=c.options.origin;"effect"!=g&&(e.origin=b||["middle","center"],e.restore=!0);b={height:d.height(),width:d.width()};d.from=c.options.from||("show"==g?{height:0,width:0}:b);d.to={height:b.height*("horizontal"!=f?i/100:1),width:b.width*("vertical"!=f?i/100:1)};if(c.options.fade&&("show"==g&&(d.from.opacity=0,d.to.opacity=1),"hide"==g))d.from.opacity=1,d.to.opacity=
0;e.from=d.from;e.to=d.to;e.mode=g;d.effect("size",e,c.duration,c.callback);d.dequeue()})};a.effects.size=function(c){return this.queue(function(){var d=a(this),e="position,top,bottom,left,right,width,height,overflow,opacity".split(","),g="position,top,bottom,left,right,overflow,opacity".split(","),i=["width","height","overflow"],f=["fontSize"],b=["borderTopWidth","borderBottomWidth","paddingTop","paddingBottom"],j=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"],l=a.effects.setMode(d,
c.options.mode||"effect"),o=c.options.restore||!1,n=c.options.scale||"both",m=c.options.origin,r={height:d.height(),width:d.width()};d.from=c.options.from||r;d.to=c.options.to||r;m&&(m=a.effects.getBaseline(m,r),d.from.top=(r.height-d.from.height)*m.y,d.from.left=(r.width-d.from.width)*m.x,d.to.top=(r.height-d.to.height)*m.y,d.to.left=(r.width-d.to.width)*m.x);var s=d.from.height/r.height,p=d.from.width/r.width,q=d.to.height/r.height,x=d.to.width/r.width;if("box"==n||"both"==n)if(s!=q&&(e=e.concat(b),
d.from=a.effects.setTransition(d,b,s,d.from),d.to=a.effects.setTransition(d,b,q,d.to)),p!=x)e=e.concat(j),d.from=a.effects.setTransition(d,j,p,d.from),d.to=a.effects.setTransition(d,j,x,d.to);if(("content"==n||"both"==n)&&s!=q)e=e.concat(f),d.from=a.effects.setTransition(d,f,s,d.from),d.to=a.effects.setTransition(d,f,q,d.to);a.effects.save(d,o?e:g);d.show();a.effects.createWrapper(d);d.css("overflow","hidden").css(d.from);if("content"==n||"both"==n)b=b.concat(["marginTop","marginBottom"]).concat(f),
j=j.concat(["marginLeft","marginRight"]),i=e.concat(b).concat(j),d.find("*[width]").each(function(){var d=a(this);o&&a.effects.save(d,i);var e=d.height(),f=d.width();d.from={height:e*s,width:f*p};d.to={height:e*q,width:f*x};if(s!=q){d.from=a.effects.setTransition(d,b,s,d.from);d.to=a.effects.setTransition(d,b,q,d.to)}if(p!=x){d.from=a.effects.setTransition(d,j,p,d.from);d.to=a.effects.setTransition(d,j,x,d.to)}d.css(d.from);d.animate(d.to,c.duration,c.options.easing,function(){o&&a.effects.restore(d,
i)})});d.animate(d.to,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){d.to.opacity===0&&d.css("opacity",d.from.opacity);l=="hide"&&d.hide();a.effects.restore(d,o?e:g);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.shake=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"];a.effects.setMode(d,c.options.mode||"effect");var g=c.options.direction||"left",i=c.options.distance||20,f=c.options.times||3,b=c.duration||c.options.duration||140;a.effects.save(d,e);d.show();a.effects.createWrapper(d);var j="up"==g||"down"==g?"top":"left",l="up"==g||"left"==g?"pos":"neg",g={},o={},n={};g[j]=("pos"==l?"-=":"+=")+i;o[j]=("pos"==l?"+=":"-=")+2*i;n[j]=("pos"==
l?"-=":"+=")+2*i;d.animate(g,b,c.options.easing);for(i=1;i<f;i++)d.animate(o,b,c.options.easing).animate(n,b,c.options.easing);d.animate(o,b,c.options.easing).animate(g,b/2,c.options.easing,function(){a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)});d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(jQuery);
(function(a){a.effects.slide=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],g=a.effects.setMode(d,c.options.mode||"show"),i=c.options.direction||"left";a.effects.save(d,e);d.show();a.effects.createWrapper(d).css({overflow:"hidden"});var f="up"==i||"down"==i?"top":"left",i="up"==i||"left"==i?"pos":"neg",b=c.options.distance||("top"==f?d.outerHeight({margin:!0}):d.outerWidth({margin:!0}));"show"==g&&d.css(f,"pos"==i?isNaN(b)?"-"+b:-b:b);var j={};
j[f]=("show"==g?"pos"==i?"+=":"-=":"pos"==i?"-=":"+=")+b;d.animate(j,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){"hide"==g&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.transfer=function(c){return this.queue(function(){var d=a(this),e=a(c.options.to),g=e.offset(),e={top:g.top,left:g.left,height:e.innerHeight(),width:e.innerWidth()},g=d.offset(),i=a('<div class="ui-effects-transfer"></div>').appendTo(document.body).addClass(c.options.className).css({top:g.top,left:g.left,height:d.innerHeight(),width:d.innerWidth(),position:"absolute"}).animate(e,c.duration,c.options.easing,function(){i.remove();c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
...
if(d.navigation){var e=c.element.find("a").filter(d.navigationFilter).eq(0);if(e.length){var g=e.closest(".ui-accordion-header");c.active=g.length?g:e.closest(".ui-accordion-content").prev()}}c.active=c._findActive(c.active||d.active).addClass("ui-state-default ui-state-active").toggleClass("ui-corner-all").toggleClass("ui-corner-top");c.active.next().addClass("ui-accordion-content-active");c._createIcons();c.resize();c.element.attr("role","tablist");c.headers.attr("role","tab").bind("keydown.accordion",
...
d&&this._createIcons());if("disabled"==c)this.headers.add(this.headers.next())[d?"addClass":"removeClass"]("ui-accordion-disabled ui-state-disabled")},_keydown:function(c){if(!this.options.disabled&&!c.altKey&&!c.ctrlKey){var d=a.ui.keyCode,e=this.headers.length,g=this.headers.index(c.target),i=!1;switch(c.keyCode){case d.RIGHT:case d.DOWN:i=this.headers[(g+1)%e];break;case d.LEFT:case d.UP:i=this.headers[(g-1+e)%e];break;case d.SPACE:case d.ENTER:this._clickHandler({target:c.target},c.target),c.preventDefault()}return i?
(a(c.target).attr("tabIndex",-1),a(i).attr("tabIndex",0),i.focus(),!1):!0}},resize:function(){var c=this.options,d;if(c.fillSpace){if(a.browser.msie){var e=this.element.parent().css("overflow");this.element.parent().css("overflow","hidden")}d=this.element.parent().height();a.browser.msie&&this.element.parent().css("overflow",e);this.headers.each(function(){d-=a(this).outerHeight(!0)});this.headers.next().each(function(){a(this).height(Math.max(0,d-a(this).innerHeight()+a(this).height()))}).css("overflow",
...
d),i=g[0]===this.active[0];e.active=e.collapsible&&i?!1:this.headers.index(g);if(!(this.running||!e.collapsible&&i)){var f=this.active,b=g.next(),j=this.active.next(),l={options:e,newHeader:i&&e.collapsible?a([]):g,oldHeader:this.active,newContent:i&&e.collapsible?a([]):b,oldContent:j},o=this.headers.index(this.active[0])>this.headers.index(g[0]);this.active=i?a([]):g;this._toggle(b,j,l,i,o);f.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").children(".ui-icon").removeClass(e.icons.headerSelected).addClass(e.icons.header);
...
l={options:e,newHeader:a([]),oldHeader:e.active,newContent:a([]),oldContent:j},b=this.active=a([]);this._toggle(b,j,l)}},_toggle:function(c,d,e,g,i){var f=this,b=f.options;f.toShow=c;f.toHide=d;f.data=e;var j=function(){return!f?void 0:f._completed.apply(f,arguments)};f._trigger("changestart",null,f.data);f.running=0===d.size()?c.size():d.size();if(b.animated){e={};e=b.collapsible&&g?{toShow:a([]),toHide:d,complete:j,down:i,autoHeight:b.autoHeight||b.fillSpace}:{toShow:c,toHide:d,complete:j,down:i,
autoHeight:b.autoHeight||b.fillSpace};b.proxied||(b.proxied=b.animated);b.proxiedDuration||(b.proxiedDuration=b.duration);b.animated=a.isFunction(b.proxied)?b.proxied(e):b.proxied;b.duration=a.isFunction(b.proxiedDuration)?b.proxiedDuration(e):b.proxiedDuration;var g=a.ui.accordion.animations,l=b.duration,o=b.animated;o&&!g[o]&&!a.easing[o]&&(o="slide");g[o]||(g[o]=function(a){this.slide(a,{easing:o,duration:l||700})});g[o](e)}else b.collapsible&&g?c.toggle():(d.hide(),c.show()),j(!0);d.prev().attr({"aria-expanded":"false",
...
animations:{slide:function(c,d){c=a.extend({easing:"swing",duration:300},c,d);if(c.toHide.size())if(c.toShow.size()){var e=c.toShow.css("overflow"),g=0,i={},f={},b,j=c.toShow;b=j[0].style.width;j.width(j.parent().width()-parseFloat(j.css("paddingLeft"))-parseFloat(j.css("paddingRight"))-(parseFloat(j.css("borderLeftWidth"))||0)-(parseFloat(j.css("borderRightWidth"))||0));a.each(["height","paddingTop","paddingBottom"],function(b,d){f[d]="hide";var e=(""+a.css(c.toShow[0],d)).match(/^([\d+-.]+)(.*)$/);
i[d]={value:e[1],unit:e[2]||"px"}});c.toShow.css({height:0,overflow:"hidden"}).show();c.toHide.filter(":hidden").each(c.complete).end().filter(":visible").animate(f,{step:function(a,b){"height"==b.prop&&(g=0===b.end-b.start?0:(b.now-b.start)/(b.end-b.start));c.toShow[0].style[b.prop]=g*i[b.prop].value+i[b.prop].unit},duration:c.duration,easing:c.easing,complete:function(){c.autoHeight||c.toShow.css("height","");c.toShow.css({width:b,overflow:e});c.complete()}})}else c.toHide.animate({height:"hide",
...
(function(a){var c=0;a.widget("ui.autocomplete",{options:{appendTo:"body",autoFocus:!1,delay:300,minLength:1,position:{my:"left top",at:"left bottom",collision:"none"},source:null},pending:0,_create:function(){var c=this,e=this.element[0].ownerDocument,g;this.isMultiLine=this.element.is("textarea");this.element.addClass("ui-autocomplete-input").attr("autocomplete","off").attr({role:"textbox","aria-autocomplete":"list","aria-haspopup":"true"}).bind("keydown.autocomplete",function(e){if(!c.options.disabled&&
!c.element.propAttr("readOnly")){g=!1;var f=a.ui.keyCode;switch(e.keyCode){case f.PAGE_UP:c._move("previousPage",e);break;case f.PAGE_DOWN:c._move("nextPage",e);break;case f.UP:c._keyEvent("previous",e);break;case f.DOWN:c._keyEvent("next",e);break;case f.ENTER:case f.NUMPAD_ENTER:c.menu.active&&(g=!0,e.preventDefault());case f.TAB:if(!c.menu.active)break;c.menu.select(e);break;case f.ESCAPE:c.element.val(c.term);c.close(e);break;default:clearTimeout(c.searching),c.searching=setTimeout(function(){c.term!=
c.element.val()&&(c.selectedItem=null,c.search(null,e))},c.options.delay)}}}).bind("keypress.autocomplete",function(a){g&&(g=!1,a.preventDefault())}).bind("focus.autocomplete",function(){c.options.disabled||(c.selectedItem=null,c.previous=c.element.val())}).bind("blur.autocomplete",function(a){c.options.disabled||(clearTimeout(c.searching),c.closing=setTimeout(function(){c.close(a);c._change(a)},150))});this._initSource();this.menu=a("<ul></ul>").addClass("ui-autocomplete").appendTo(a(this.options.appendTo||
"body",e)[0]).mousedown(function(e){var f=c.menu.element[0];a(e.target).closest(".ui-menu-item").length||setTimeout(function(){a(document).one("mousedown",function(b){b.target!==c.element[0]&&b.target!==f&&!a.ui.contains(f,b.target)&&c.close()})},1);setTimeout(function(){clearTimeout(c.closing)},13)}).menu({focus:function(a,e){var b=e.item.data("item.autocomplete");!1!==c._trigger("focus",a,{item:b})&&/^key/.test(a.originalEvent.type)&&c.element.val(b.value)},selected:function(a,f){var b=f.item.data("item.autocomplete"),
j=c.previous;c.element[0]!==e.activeElement&&(c.element.focus(),c.previous=j,setTimeout(function(){c.previous=j;c.selectedItem=b},1));!1!==c._trigger("select",a,{item:b})&&c.element.val(b.value);c.term=c.element.val();c.close(a);c.selectedItem=b},blur:function(){c.menu.element.is(":visible")&&c.element.val()!==c.term&&c.element.val(c.term)}}).zIndex(this.element.zIndex()+1).css({top:0,left:0}).hide().data("menu");a.fn.bgiframe&&this.menu.element.bgiframe();c.beforeunloadHandler=function(){c.element.removeAttr("autocomplete")};
a(window).bind("beforeunload",c.beforeunloadHandler)},destroy:function(){this.element.removeClass("ui-autocomplete-input").removeAttr("autocomplete").removeAttr("role").removeAttr("aria-autocomplete").removeAttr("aria-haspopup");this.menu.element.remove();a(window).unbind("beforeunload",this.beforeunloadHandler);a.Widget.prototype.destroy.call(this)},_setOption:function(c,e){a.Widget.prototype._setOption.apply(this,arguments);"source"===c&&this._initSource();"appendTo"===c&&this.menu.element.appendTo(a(e||
"body",this.element[0].ownerDocument)[0]);"disabled"===c&&e&&this.xhr&&this.xhr.abort()},_initSource:function(){var c=this,e,g;a.isArray(this.options.source)?(e=this.options.source,this.source=function(c,d){d(a.ui.autocomplete.filter(e,c.term))}):"string"===typeof this.options.source?(g=this.options.source,this.source=function(e,f){c.xhr&&c.xhr.abort();c.xhr=a.ajax({url:g,data:e,dataType:"json",success:function(a){f(a)},error:function(){f([])}})}):this.source=this.options.source},search:function(a,
c){a=null!=a?a:this.element.val();this.term=this.element.val();if(a.length<this.options.minLength)return this.close(c);clearTimeout(this.closing);return!1===this._trigger("search",c)?void 0:this._search(a)},_search:function(a){this.pending++;this.element.addClass("ui-autocomplete-loading");this.source({term:a},this._response())},_response:function(){var a=this,e=++c;return function(g){e===c&&a.__response(g);a.pending--;a.pending||a.element.removeClass("ui-autocomplete-loading")}},__response:function(a){!this.options.disabled&&
...
c.value,value:c.value||c.label},c)})},_suggest:function(c){var e=this.menu.element.empty().zIndex(this.element.zIndex()+1);this._renderMenu(e,c);this.menu.deactivate();this.menu.refresh();e.show();this._resizeMenu();e.position(a.extend({of:this.element},this.options.position));this.options.autoFocus&&this.menu.next(new a.Event("mouseover"))},_resizeMenu:function(){var a=this.menu.element;a.outerWidth(Math.max(a.width("").outerWidth()+1,this.element.outerWidth()))},_renderMenu:function(c,e){var g=
this;a.each(e,function(a,e){g._renderItem(c,e)})},_renderItem:function(c,e){return a("<li></li>").data("item.autocomplete",e).append(a("<a></a>").text(e.label)).appendTo(c)},_move:function(a,c){if(this.menu.element.is(":visible"))if(this.menu.first()&&/^previous/.test(a)||this.menu.last()&&/^next/.test(a))this.element.val(this.term),this.menu.deactivate();else this.menu[a](c);else this.search(null,c)},widget:function(){return this.menu.element},_keyEvent:function(a,c){if(!this.isMultiLine||this.menu.element.is(":visible"))this._move(a,
c),c.preventDefault()}});a.extend(a.ui.autocomplete,{escapeRegex:function(a){return a.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,"\\$&")},filter:function(c,e){var g=RegExp(a.ui.autocomplete.escapeRegex(e),"i");return a.grep(c,function(a){return g.test(a.label||a.value||a)})}})})(jQuery);
...
-1).mouseenter(function(d){c.activate(d,a(this).parent())}).mouseleave(function(){c.deactivate()})},activate:function(a,d){this.deactivate();if(this.hasScroll()){var e=d.offset().top-this.element.offset().top,g=this.element.scrollTop(),i=this.element.height();0>e?this.element.scrollTop(g+e):e>=i&&this.element.scrollTop(g+e-i+d.height())}this.active=d.eq(0).children("a").addClass("ui-state-hover").attr("id","ui-active-menuitem").end();this._trigger("focus",a,{item:d})},deactivate:function(){this.active&&
...
a):this.activate(e,this.element.children(d))):this.activate(e,this.element.children(d))},nextPage:function(c){if(this.hasScroll())if(!this.active||this.last())this.activate(c,this.element.children(".ui-menu-item:first"));else{var d=this.active.offset().top,e=this.element.height(),g=this.element.children(".ui-menu-item").filter(function(){var c=a(this).offset().top-d-e+a(this).height();return 10>c&&-10<c});g.length||(g=this.element.children(".ui-menu-item:last"));this.activate(c,g)}else this.activate(c,
this.element.children(".ui-menu-item").filter(!this.active||this.last()?":first":":last"))},previousPage:function(c){if(this.hasScroll())if(!this.active||this.first())this.activate(c,this.element.children(".ui-menu-item:last"));else{var d=this.active.offset().top,e=this.element.height(),g=this.element.children(".ui-menu-item").filter(function(){var c=a(this).offset().top-d+e-a(this).height();return 10>c&&-10<c});g.length||(g=this.element.children(".ui-menu-item:first"));this.activate(c,g)}else this.activate(c,
...
(function(a){var c,d,e,g,i=function(){var b=a(this).find(":ui-button");setTimeout(function(){b.button("refresh")},1)},f=function(b){var c=b.name,d=b.form,e=a([]);c&&(e=d?a(d).find("[name='"+c+"']"):a("[name='"+c+"']",b.ownerDocument).filter(function(){return!this.form}));return e};a.widget("ui.button",{options:{disabled:null,text:!0,label:null,icons:{primary:null,secondary:null}},_create:function(){this.element.closest("form").unbind("reset.button").bind("reset.button",i);"boolean"!==typeof this.options.disabled?
this.options.disabled=!!this.element.propAttr("disabled"):this.element.propAttr("disabled",this.options.disabled);this._determineButtonType();this.hasTitle=!!this.buttonElement.attr("title");var b=this,j=this.options,l="checkbox"===this.type||"radio"===this.type,o="ui-state-hover"+(!l?" ui-state-active":"");null===j.label&&(j.label=this.buttonElement.html());this.buttonElement.addClass("ui-button ui-widget ui-state-default ui-corner-all").attr("role","button").bind("mouseenter.button",function(){if(!j.disabled){a(this).addClass("ui-state-hover");
this===c&&a(this).addClass("ui-state-active")}}).bind("mouseleave.button",function(){j.disabled||a(this).removeClass(o)}).bind("click.button",function(a){if(j.disabled){a.preventDefault();a.stopImmediatePropagation()}});this.element.bind("focus.button",function(){b.buttonElement.addClass("ui-state-focus")}).bind("blur.button",function(){b.buttonElement.removeClass("ui-state-focus")});l&&(this.element.bind("change.button",function(){g||b.refresh()}),this.buttonElement.bind("mousedown.button",function(a){if(!j.disabled){g=
false;d=a.pageX;e=a.pageY}}).bind("mouseup.button",function(a){if(!j.disabled&&(d!==a.pageX||e!==a.pageY))g=true}));"checkbox"===this.type?this.buttonElement.bind("click.button",function(){if(j.disabled||g)return false;a(this).toggleClass("ui-state-active");b.buttonElement.attr("aria-pressed",b.element[0].checked)}):"radio"===this.type?this.buttonElement.bind("click.button",function(){if(j.disabled||g)return false;a(this).addClass("ui-state-active");b.buttonElement.attr("aria-pressed","true");var c=
b.element[0];f(c).not(c).map(function(){return a(this).button("widget")[0]}).removeClass("ui-state-active").attr("aria-pressed","false")}):(this.buttonElement.bind("mousedown.button",function(){if(j.disabled)return false;a(this).addClass("ui-state-active");c=this;a(document).one("mouseup",function(){c=null})}).bind("mouseup.button",function(){if(j.disabled)return false;a(this).removeClass("ui-state-active")}).bind("keydown.button",function(b){if(j.disabled)return false;(b.keyCode==a.ui.keyCode.SPACE||
...
b.length&&b.removeClass("ui-state-hover ui-datepicker-prev-hover ui-datepicker-next-hover")}).bind("mouseover",function(c){c=a(c.target).closest("button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a");if(!a.datepicker._isDisabledDatepicker(f.inline?b.parent()[0]:f.input[0])&&c.length)c.parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),c.addClass("ui-state-hover"),c.hasClass("ui-datepicker-prev")&&c.addClass("ui-datepicker-prev-hover"),c.hasClass("ui-datepicker-next")&&
c.addClass("ui-datepicker-next-hover")})}function g(b,d){a.extend(b,d);for(var e in d)if(null==d[e]||d[e]==c)b[e]=d[e];return b}a.extend(a.ui,{datepicker:{version:"1.8.20"}});var i=(new Date).getTime(),f;a.extend(d.prototype,{markerClassName:"hasDatepicker",maxRows:4,log:function(){this.debug&&console.log.apply("",arguments)},_widgetDatepicker:function(){return this.dpDiv},setDefaults:function(a){g(this._defaults,a||{});return this},_attachDatepicker:function(b,c){var d=null,e;for(e in this._defaults){var f=
b.getAttribute("date:"+e);if(f){d=d||{};try{d[e]=eval(f)}catch(g){d[e]=f}}}e=b.nodeName.toLowerCase();f="div"==e||"span"==e;b.id||(this.uuid+=1,b.id="dp"+this.uuid);var i=this._newInst(a(b),f);i.settings=a.extend({},c||{},d||{});"input"==e?this._connectDatepicker(b,i):f&&this._inlineDatepicker(b,i)},_newInst:function(b,c){return{id:b[0].id.replace(/([^A-Za-z0-9_-])/g,"\\\\$1"),input:b,selectedDay:0,selectedMonth:0,selectedYear:0,drawMonth:0,drawYear:0,inline:c,dpDiv:!c?this.dpDiv:e(a('<div class="'+
...
b}},_isDisabledDatepicker:function(a){if(!a)return!1;for(var c=0;c<this._disabledInputs.length;c++)if(this._disabledInputs[c]==a)return!0;return!1},_getInst:function(b){try{return a.data(b,"datepicker")}catch(c){throw"Missing instance data for this datepicker";}},_optionDatepicker:function(b,d,e){var f=this._getInst(b);if(2==arguments.length&&"string"==typeof d)return"defaults"==d?a.extend({},a.datepicker._defaults):f?"all"==d?a.extend({},f.settings):this._get(f,d):null;var i=d||{};"string"==typeof d&&
(i={},i[d]=e);if(f){this._curInst==f&&this._hideDatepicker();var m=this._getDateDatepicker(b,!0),r=this._getMinMaxDate(f,"min"),s=this._getMinMaxDate(f,"max");g(f.settings,i);null!==r&&i.dateFormat!==c&&i.minDate===c&&(f.settings.minDate=this._formatDate(f,r));null!==s&&i.dateFormat!==c&&i.maxDate===c&&(f.settings.maxDate=this._formatDate(f,s));this._attachments(a(b),f);this._autoSize(f);this._setDate(f,m);this._updateAlternate(f);this._updateDatepicker(f)}},_changeDatepicker:function(a,c,d){this._optionDatepicker(a,
...
a.datepicker._curInst&&a.datepicker._curInst!=c&&(a.datepicker._curInst.dpDiv.stop(!0,!0),c&&a.datepicker._datepickerShowing&&a.datepicker._hideDatepicker(a.datepicker._curInst.input[0]));var d=a.datepicker._get(c,"beforeShow"),d=d?d.apply(b,[b,c]):{};if(!1!==d){g(c.settings,d);c.lastVal=null;a.datepicker._lastInput=b;a.datepicker._setDateFromField(c);a.datepicker._inDialog&&(b.value="");a.datepicker._pos||(a.datepicker._pos=a.datepicker._findPos(b),a.datepicker._pos[1]+=b.offsetHeight);var e=!1;
a(b).parents().each(function(){e=e|a(this).css("position")=="fixed";return!e});e&&a.browser.opera&&(a.datepicker._pos[0]-=document.documentElement.scrollLeft,a.datepicker._pos[1]-=document.documentElement.scrollTop);d={left:a.datepicker._pos[0],top:a.datepicker._pos[1]};a.datepicker._pos=null;c.dpDiv.empty();c.dpDiv.css({position:"absolute",display:"block",top:"-1000px"});a.datepicker._updateDatepicker(c);d=a.datepicker._checkOffset(c,d,e);c.dpDiv.css({position:a.datepicker._inDialog&&a.blockUI?"static":
e?"fixed":"absolute",display:"none",left:d.left+"px",top:d.top+"px"});if(!c.inline){var d=a.datepicker._get(c,"showAnim"),f=a.datepicker._get(c,"duration"),i=function(){var b=c.dpDiv.find("iframe.ui-datepicker-cover");if(b.length){var d=a.datepicker._getBorders(c.dpDiv);b.css({left:-d[0],top:-d[1],width:c.dpDiv.outerWidth(),height:c.dpDiv.outerHeight()})}};c.dpDiv.zIndex(a(b).zIndex()+1);a.datepicker._datepickerShowing=!0;if(a.effects&&a.effects[d])c.dpDiv.show(d,a.datepicker._get(c,"showOptions"),
f,i);else c.dpDiv[d||"show"](d?f:null,i);(!d||!f)&&i();c.input.is(":visible")&&!c.input.is(":disabled")&&c.input.focus();a.datepicker._curInst=c}}}},_updateDatepicker:function(b){this.maxRows=4;var c=a.datepicker._getBorders(b.dpDiv);f=b;b.dpDiv.empty().append(this._generateHTML(b));var d=b.dpDiv.find("iframe.ui-datepicker-cover");d.length&&d.css({left:-c[0],top:-c[1],width:b.dpDiv.outerWidth(),height:b.dpDiv.outerHeight()});b.dpDiv.find("."+this._dayOverClass+" a").mouseover();c=this._getNumberOfMonths(b);
...
b.yearshtml;setTimeout(function(){e===b.yearshtml&&b.yearshtml&&b.dpDiv.find("select.ui-datepicker-year:first").replaceWith(b.yearshtml);e=b.yearshtml=null},0)}},_getBorders:function(a){var c=function(a){return{thin:1,medium:2,thick:3}[a]||a};return[parseFloat(c(a.css("border-left-width"))),parseFloat(c(a.css("border-top-width")))]},_checkOffset:function(b,c,d){var e=b.dpDiv.outerWidth(),f=b.dpDiv.outerHeight(),g=b.input?b.input.outerWidth():0,i=b.input?b.input.outerHeight():0,s=document.documentElement.clientWidth+
a(document).scrollLeft(),p=document.documentElement.clientHeight+a(document).scrollTop();c.left-=this._get(b,"isRTL")?e-g:0;c.left-=d&&c.left==b.input.offset().left?a(document).scrollLeft():0;c.top-=d&&c.top==b.input.offset().top+i?a(document).scrollTop():0;c.left-=Math.min(c.left,c.left+e>s&&s>e?Math.abs(c.left+e-s):0);c.top-=Math.min(c.top,c.top+f>p&&p>f?Math.abs(f+i):0);return c},_findPos:function(b){for(var c=this._get(this._getInst(b),"isRTL");b&&("hidden"==b.type||1!=b.nodeType||a.expr.filters.hidden(b));)b=
...
e,this._getFormatConfig(b));a(c).each(function(){a(this).val(f)})}},noWeekends:function(a){a=a.getDay();return[0<a&&6>a,""]},iso8601Week:function(a){a=new Date(a.getTime());a.setDate(a.getDate()+4-(a.getDay()||7));var c=a.getTime();a.setMonth(0);a.setDate(1);return Math.floor(Math.round((c-a)/864E5)/7)+1},parseDate:function(b,c,d){if(null==b||null==c)throw"Invalid arguments";c="object"==typeof c?c.toString():c+"";if(""==c)return null;for(var e=(d?d.shortYearCutoff:null)||this._defaults.shortYearCutoff,
e="string"!=typeof e?e:(new Date).getFullYear()%100+parseInt(e,10),f=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,g=(d?d.dayNames:null)||this._defaults.dayNames,i=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,s=(d?d.monthNames:null)||this._defaults.monthNames,p=d=-1,q=-1,x=-1,w=!1,A=function(a){(a=H+1<b.length&&b.charAt(H+1)==a)&&H++;return a},E=function(a){var b=A(a),a=c.substring(F).match(RegExp("^\\d{1,"+("@"==a?14:"!"==a?20:"y"==a&&b?4:"o"==a?3:2)+"}"));if(!a)throw"Missing number at position "+
F;F+=a[0].length;return parseInt(a[0],10)},z=function(b,d,e){var b=a.map(A(b)?e:d,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)}),f=-1;a.each(b,function(a,b){var d=b[1];if(c.substr(F,d.length).toLowerCase()==d.toLowerCase())return f=b[0],F+=d.length,!1});if(-1!=f)return f+1;throw"Unknown name at position "+F;},C=function(){if(c.charAt(F)!=b.charAt(H))throw"Unexpected literal at position "+F;F++},F=0,H=0;H<b.length;H++)if(w)"'"==b.charAt(H)&&!A("'")?w=!1:C();else switch(b.charAt(H)){case "d":q=
E("d");break;case "D":z("D",f,g);break;case "o":x=E("o");break;case "m":p=E("m");break;case "M":p=z("M",i,s);break;case "y":d=E("y");break;case "@":var D=new Date(E("@")),d=D.getFullYear(),p=D.getMonth()+1,q=D.getDate();break;case "!":D=new Date((E("!")-this._ticksTo1970)/1E4);d=D.getFullYear();p=D.getMonth()+1;q=D.getDate();break;case "'":A("'")?C():w=!0;break;default:C()}if(F<c.length)throw"Extra/unparsed characters found in date: "+c.substring(F);-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-
(new Date).getFullYear()%100+(d<=e?0:-100));if(-1<x){p=1;q=x;do{e=this._getDaysInMonth(d,p-1);if(q<=e)break;p++;q-=e}while(1)}D=this._daylightSavingAdjust(new Date(d,p-1,q));if(D.getFullYear()!=d||D.getMonth()+1!=p||D.getDate()!=q)throw"Invalid date";return D},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:864E9*(718685+Math.floor(492.5)-
Math.floor(19.7)+Math.floor(4.925)),formatDate:function(a,c,d){if(!c)return"";var e=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,f=(d?d.dayNames:null)||this._defaults.dayNames,g=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,d=(d?d.monthNames:null)||this._defaults.monthNames,i=function(c){(c=w+1<a.length&&a.charAt(w+1)==c)&&w++;return c},s=function(a,b,c){b=""+b;if(i(a))for(;b.length<c;)b="0"+b;return b},p=function(a,b,c,d){return i(a)?d[b]:c[b]},q="",x=!1;if(c)for(var w=0;w<
a.length;w++)if(x)"'"==a.charAt(w)&&!i("'")?x=!1:q+=a.charAt(w);else switch(a.charAt(w)){case "d":q+=s("d",c.getDate(),2);break;case "D":q+=p("D",c.getDay(),e,f);break;case "o":q+=s("o",Math.round(((new Date(c.getFullYear(),c.getMonth(),c.getDate())).getTime()-(new Date(c.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":q+=s("m",c.getMonth()+1,2);break;case "M":q+=p("M",c.getMonth(),g,d);break;case "y":q+=i("y")?c.getFullYear():(10>c.getYear()%100?"0":"")+c.getYear()%100;break;case "@":q+=
c.getTime();break;case "!":q+=1E4*c.getTime()+this._ticksTo1970;break;case "'":i("'")?q+="'":x=!0;break;default:q+=a.charAt(w)}return q},_possibleChars:function(a){for(var c="",d=!1,e=function(c){(c=f+1<a.length&&a.charAt(f+1)==c)&&f++;return c},f=0;f<a.length;f++)if(d)"'"==a.charAt(f)&&!e("'")?d=!1:c+=a.charAt(f);else switch(a.charAt(f)){case "d":case "m":case "y":case "@":c+="0123456789";break;case "D":case "M":return null;case "'":e("'")?c+="'":d=!0;break;default:c+=a.charAt(f)}return c},_get:function(a,
d){return a.settings[d]!==c?a.settings[d]:this._defaults[d]},_setDateFromField:function(a,c){if(a.input.val()!=a.lastVal){var d=this._get(a,"dateFormat"),e=a.lastVal=a.input?a.input.val():null,f,g;f=g=this._getDefaultDate(a);var i=this._getFormatConfig(a);try{f=this.parseDate(d,e,i)||g}catch(s){this.log(s),e=c?"":e}a.selectedDay=f.getDate();a.drawMonth=a.selectedMonth=f.getMonth();a.drawYear=a.selectedYear=f.getFullYear();a.currentDay=e?f.getDate():0;a.currentMonth=e?f.getMonth():0;a.currentYear=
e?f.getFullYear():0;this._adjustInstDate(a)}},_getDefaultDate:function(a){return this._restrictMinMax(a,this._determineDate(a,this._get(a,"defaultDate"),new Date))},_determineDate:function(b,c,d){var e=function(a){var b=new Date;b.setDate(b.getDate()+a);return b};if(c=(c=null==c||""===c?d:"string"==typeof c?function(c){try{return a.datepicker.parseDate(a.datepicker._get(b,"dateFormat"),c,a.datepicker._getFormatConfig(b))}catch(d){}for(var e=(c.toLowerCase().match(/^c/)?a.datepicker._getDate(b):null)||
new Date,f=e.getFullYear(),g=e.getMonth(),e=e.getDate(),i=/([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g,j=i.exec(c);j;){switch(j[2]||"d"){case "d":case "D":e+=parseInt(j[1],10);break;case "w":case "W":e+=7*parseInt(j[1],10);break;case "m":case "M":g+=parseInt(j[1],10);e=Math.min(e,a.datepicker._getDaysInMonth(f,g));break;case "y":case "Y":f+=parseInt(j[1],10),e=Math.min(e,a.datepicker._getDaysInMonth(f,g))}j=i.exec(c)}return new Date(f,g,e)}(c):"number"==typeof c?isNaN(c)?d:e(c):new Date(c.getTime()))&&"Invalid Date"==
...
(f!=a.selectedMonth||g!=a.selectedYear)&&!d&&this._notifyChange(a);this._adjustInstDate(a);a.input&&a.input.val(e?"":this._formatDate(a))},_getDate:function(a){return!a.currentYear||a.input&&""==a.input.val()?null:this._daylightSavingAdjust(new Date(a.currentYear,a.currentMonth,a.currentDay))},_generateHTML:function(b){var c=new Date,c=this._daylightSavingAdjust(new Date(c.getFullYear(),c.getMonth(),c.getDate())),d=this._get(b,"isRTL"),e=this._get(b,"showButtonPanel"),f=this._get(b,"hideIfNoPrevNext"),
g=this._get(b,"navigationAsDateFormat"),r=this._getNumberOfMonths(b),s=this._get(b,"showCurrentAtPos"),p=this._get(b,"stepMonths"),q=1!=r[0]||1!=r[1],x=this._daylightSavingAdjust(!b.currentDay?new Date(9999,9,9):new Date(b.currentYear,b.currentMonth,b.currentDay)),w=this._getMinMaxDate(b,"min"),A=this._getMinMaxDate(b,"max"),s=b.drawMonth-s,E=b.drawYear;0>s&&(s+=12,E--);if(A)for(var z=this._daylightSavingAdjust(new Date(A.getFullYear(),A.getMonth()-r[0]*r[1]+1,A.getDate())),z=w&&z<w?w:z;this._daylightSavingAdjust(new Date(E,
s,1))>z;)s--,0>s&&(s=11,E--);b.drawMonth=s;b.drawYear=E;var z=this._get(b,"prevText"),z=!g?z:this.formatDate(z,this._daylightSavingAdjust(new Date(E,s-p,1)),this._getFormatConfig(b)),z=this._canAdjustMonth(b,-1,E,s)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', -"+p+", 'M');\" title=\""+z+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+z+"</span></a>":f?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+
z+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+z+"</span></a>",C=this._get(b,"nextText"),C=!g?C:this.formatDate(C,this._daylightSavingAdjust(new Date(E,s+p,1)),this._getFormatConfig(b)),f=this._canAdjustMonth(b,1,E,s)?'<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', +"+p+", 'M');\" title=\""+C+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+C+"</span></a>":f?"":'<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+
C+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+C+"</span></a>",p=this._get(b,"currentText"),C=this._get(b,"gotoCurrent")&&b.currentDay?x:c,p=!g?p:this.formatDate(p,C,this._getFormatConfig(b)),g=!b.inline?'<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_'+i+'.datepicker._hideDatepicker();">'+this._get(b,"closeText")+"</button>":"",e=e?'<div class="ui-datepicker-buttonpane ui-widget-content">'+(d?g:"")+(this._isInRange(b,
C)?'<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._gotoToday('#"+b.id+"');\">"+p+"</button>":"")+(d?"":g)+"</div>":"",g=parseInt(this._get(b,"firstDay"),10),g=isNaN(g)?0:g,p=this._get(b,"showWeek"),C=this._get(b,"dayNames");this._get(b,"dayNamesShort");var F=this._get(b,"dayNamesMin"),H=this._get(b,"monthNames"),D=this._get(b,"monthNamesShort"),v=this._get(b,"beforeShowDay"),N=this._get(b,"showOtherMonths"),
R=this._get(b,"selectOtherMonths");this._get(b,"calculateWeek");for(var h=this._getDefaultDate(b),S="",Q=0;Q<r[0];Q++){var P="";this.maxRows=4;for(var J=0;J<r[1];J++){var u=this._daylightSavingAdjust(new Date(E,s,b.selectedDay)),I=" ui-corner-all",G="";if(q){G+='<div class="ui-datepicker-group';if(1<r[1])switch(J){case 0:G+=" ui-datepicker-group-first";I=" ui-corner-"+(d?"right":"left");break;case r[1]-1:G+=" ui-datepicker-group-last";I=" ui-corner-"+(d?"left":"right");break;default:G+=" ui-datepicker-group-middle",
I=""}G+='">'}for(var G=G+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+I+'">'+(/all|left/.test(I)&&0==Q?d?f:z:"")+(/all|right/.test(I)&&0==Q?d?z:f:"")+this._generateMonthYearHeader(b,s,E,w,A,0<Q||0<J,H,D)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),M=p?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":"",I=0;7>I;I++)var k=(I+g)%7,M=M+("<th"+(5<=(I+g+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+C[k]+'">'+F[k]+"</span></th>");
G+=M+"</tr></thead><tbody>";M=this._getDaysInMonth(E,s);E==b.selectedYear&&s==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,M));I=(this._getFirstDayOfMonth(E,s)-g+7)%7;M=Math.ceil((I+M)/7);this.maxRows=M=q?this.maxRows>M?this.maxRows:M:M;for(var k=this._daylightSavingAdjust(new Date(E,s,1-I)),t=0;t<M;t++){for(var G=G+"<tr>",y=!p?"":'<td class="ui-datepicker-week-col">'+this._get(b,"calculateWeek")(k)+"</td>",I=0;7>I;I++){var L=v?v.apply(b.input?b.input[0]:null,[k]):[!0,""],K=k.getMonth()!=
s,O=K&&!R||!L[0]||w&&k<w||A&&k>A,y=y+('<td class="'+(5<=(I+g+6)%7?" ui-datepicker-week-end":"")+(K?" ui-datepicker-other-month":"")+(k.getTime()==u.getTime()&&s==b.selectedMonth&&b._keyEvent||h.getTime()==k.getTime()&&h.getTime()==u.getTime()?" "+this._dayOverClass:"")+(O?" "+this._unselectableClass+" ui-state-disabled":"")+(K&&!N?"":" "+L[1]+(k.getTime()==x.getTime()?" "+this._currentClass:"")+(k.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!K||N)&&L[2]?' title="'+L[2]+'"':"")+(O?"":
' onclick="DP_jQuery_'+i+".datepicker._selectDay('#"+b.id+"',"+k.getMonth()+","+k.getFullYear()+', this);return false;"')+">"+(K&&!N?"&#xa0;":O?'<span class="ui-state-default">'+k.getDate()+"</span>":'<a class="ui-state-default'+(k.getTime()==c.getTime()?" ui-state-highlight":"")+(k.getTime()==x.getTime()?" ui-state-active":"")+(K?" ui-priority-secondary":"")+'" href="#">'+k.getDate()+"</a>")+"</td>");k.setDate(k.getDate()+1);k=this._daylightSavingAdjust(k)}G+=y+"</tr>"}s++;11<s&&(s=0,E++);G+="</tbody></table>"+
(q?"</div>"+(0<r[0]&&J==r[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");P+=G}S+=P}S+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return S},_generateMonthYearHeader:function(a,c,d,e,f,g,r,s){var p=this._get(a,"changeMonth"),q=this._get(a,"changeYear"),x=this._get(a,"showMonthAfterYear"),w='<div class="ui-datepicker-title">',A="";if(g||!p)A+='<span class="ui-datepicker-month">'+
r[c]+"</span>";else{for(var r=e&&e.getFullYear()==d,E=f&&f.getFullYear()==d,A=A+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),z=0;12>z;z++)if((!r||z>=e.getMonth())&&(!E||z<=f.getMonth()))A+='<option value="'+z+'"'+(z==c?' selected="selected"':"")+">"+s[z]+"</option>";A+="</select>"}x||(w+=A+(g||!p||!q?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",g||!q)w+='<span class="ui-datepicker-year">'+d+"</span>";else{var s=this._get(a,
"yearRange").split(":"),C=(new Date).getFullYear(),r=function(a){a=a.match(/c[+-].*/)?d+parseInt(a.substring(1),10):a.match(/[+-].*/)?C+parseInt(a,10):parseInt(a,10);return isNaN(a)?C:a},c=r(s[0]),s=Math.max(c,r(s[1]||"")),c=e?Math.max(c,e.getFullYear()):c,s=f?Math.min(s,f.getFullYear()):s;for(a.yearshtml+='<select class="ui-datepicker-year" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'Y');\" >";c<=s;c++)a.yearshtml+='<option value="'+c+'"'+(c==d?' selected="selected"':
"")+">"+c+"</option>";a.yearshtml+="</select>";w+=a.yearshtml;a.yearshtml=null}w+=this._get(a,"yearSuffix");x&&(w+=(g||!p||!q?"&#xa0;":"")+A);return w+"</div>"},_adjustInstDate:function(a,c,d){var e=a.drawYear+("Y"==d?c:0),f=a.drawMonth+("M"==d?c:0),c=Math.min(a.selectedDay,this._getDaysInMonth(e,f))+("D"==d?c:0),e=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(e,f,c)));a.selectedDay=e.getDate();a.drawMonth=a.selectedMonth=e.getMonth();a.drawYear=a.selectedYear=e.getFullYear();("M"==d||
...
!1;if(b.target===d[0]&&b.shiftKey)return c.focus(1),!1}});a(this.element.find(":tabbable").get().concat(d.find(".ui-dialog-buttonpane :tabbable").get().concat(d.get()))).eq(0).focus();this._isOpen=!0;this._trigger("open");return this}},_createButtons:function(c){var d=this,b=!1,e=a("<div></div>").addClass("ui-dialog-buttonpane ui-widget-content ui-helper-clearfix"),l=a("<div></div>").addClass("ui-dialog-buttonset").appendTo(e);d.uiDialog.find(".ui-dialog-buttonpane").remove();"object"===typeof c&&
null!==c&&a.each(c,function(){return!(b=!0)});b&&(a.each(c,function(b,c){var c=a.isFunction(c)?{click:c,text:b}:c,e=a('<button type="button"></button>').click(function(){c.click.apply(d.element[0],arguments)}).appendTo(l);a.each(c,function(a,b){if("click"!==a)if(a in g)e[a](b);else e.attr(a,b)});a.fn.button&&e.button()}),e.appendTo(d.uiDialog))},_makeDraggable:function(){function c(a){return{position:a.position,offset:a.offset}}var d=this,b=d.options,e=a(document),g;d.uiDialog.draggable({cancel:".ui-dialog-content, .ui-dialog-titlebar-close",
handle:".ui-dialog-titlebar",containment:"document",start:function(e,j){g="auto"===b.height?"auto":a(this).height();a(this).height(a(this).height()).addClass("ui-dialog-dragging");d._trigger("dragStart",e,c(j))},drag:function(a,b){d._trigger("drag",a,c(b))},stop:function(o,n){b.position=[n.position.left-e.scrollLeft(),n.position.top-e.scrollTop()];a(this).removeClass("ui-dialog-dragging").height(g);d._trigger("dragStop",o,c(n));a.ui.dialog.overlay.resize()}})},_makeResizable:function(d){function e(a){return{originalPosition:a.originalPosition,
...
(function(a){a.ui=a.ui||{};var c=/left|center|right/,d=/top|center|bottom/,e,g=a.fn.position,i=a.fn.offset;a.fn.position=function(f){if(!f||!f.of)return g.apply(this,arguments);var f=a.extend({},f),b=a(f.of),i=b[0],l=(f.collision||"flip").split(" "),o=f.offset?f.offset.split(" "):[0,0],n,m,r;9===i.nodeType?(n=b.width(),m=b.height(),r={top:0,left:0}):i.setTimeout?(n=b.width(),m=b.height(),r={top:b.scrollTop(),left:b.scrollLeft()}):i.preventDefault?(f.at="left top",n=m=0,r={top:f.of.pageY,left:f.of.pageX}):
(n=b.outerWidth(),m=b.outerHeight(),r=b.offset());a.each(["my","at"],function(){var a=(f[this]||"").split(" ");a.length===1&&(a=c.test(a[0])?a.concat(["center"]):d.test(a[0])?["center"].concat(a):["center","center"]);a[0]=c.test(a[0])?a[0]:"center";a[1]=d.test(a[1])?a[1]:"center";f[this]=a});1===l.length&&(l[1]=l[0]);o[0]=parseInt(o[0],10)||0;1===o.length&&(o[1]=o[0]);o[1]=parseInt(o[1],10)||0;"right"===f.at[0]?r.left+=n:"center"===f.at[0]&&(r.left+=n/2);"bottom"===f.at[1]?r.top+=m:"center"===f.at[1]&&
(r.top+=m/2);r.left+=o[0];r.top+=o[1];return this.each(function(){var b=a(this),c=b.outerWidth(),d=b.outerHeight(),g=parseInt(a.curCSS(this,"marginLeft",true))||0,i=parseInt(a.curCSS(this,"marginTop",true))||0,j=c+g+(parseInt(a.curCSS(this,"marginRight",true))||0),E=d+i+(parseInt(a.curCSS(this,"marginBottom",true))||0),z=a.extend({},r),C;if(f.my[0]==="right")z.left=z.left-c;else if(f.my[0]==="center")z.left=z.left-c/2;if(f.my[1]==="bottom")z.top=z.top-d;else if(f.my[1]==="center")z.top=z.top-d/2;
if(!e){z.left=Math.round(z.left);z.top=Math.round(z.top)}C={left:z.left-g,top:z.top-i};a.each(["left","top"],function(b,e){if(a.ui.position[l[b]])a.ui.position[l[b]][e](z,{targetWidth:n,targetHeight:m,elemWidth:c,elemHeight:d,collisionPosition:C,collisionWidth:j,collisionHeight:E,offset:o,my:f.my,at:f.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(z,{using:f.using}))})};a.ui.position={fit:{left:function(c,b){var d=a(window),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft();
c.left=0<d?c.left-d:Math.max(c.left-b.collisionPosition.left,c.left)},top:function(c,b){var d=a(window),d=b.collisionPosition.top+b.collisionHeight-d.height()-d.scrollTop();c.top=0<d?c.top-d:Math.max(c.top-b.collisionPosition.top,c.top)}},flip:{left:function(c,b){if("center"!==b.at[0]){var d=a(window),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft(),e="left"===b.my[0]?-b.elemWidth:"right"===b.my[0]?b.elemWidth:0,g="left"===b.at[0]?b.targetWidth:-b.targetWidth,i=-2*b.offset[0];
c.left+=0>b.collisionPosition.left?e+g+i:0<d?e+g+i:0}},top:function(c,b){if("center"!==b.at[1]){var d=a(window),d=b.collisionPosition.top+b.collisionHeight-d.height()-d.scrollTop(),e="top"===b.my[1]?-b.elemHeight:"bottom"===b.my[1]?b.elemHeight:0,g="top"===b.at[1]?b.targetHeight:-b.targetHeight,i=-2*b.offset[1];c.top+=0>b.collisionPosition.top?e+g+i:0<d?e+g+i:0}}}};a.offset.setOffset||(a.offset.setOffset=function(c,b){/static/.test(a.curCSS(c,"position"))&&(c.style.position="relative");var d=a(c),
e=d.offset(),g=parseInt(a.curCSS(c,"top",!0),10)||0,i=parseInt(a.curCSS(c,"left",!0),10)||0,e={top:b.top-e.top+g,left:b.left-e.left+i};"using"in b?b.using.call(c,e):d.css(e)},a.fn.offset=function(c){var b=this[0];return!b||!b.ownerDocument?null:c?this.each(function(){a.offset.setOffset(this,c)}):i.call(this)});(function(){var c=document.getElementsByTagName("body")[0],b=document.createElement("div"),d,g;d=document.createElement(c?"div":"body");g={visibility:"hidden",width:0,height:0,border:0,margin:0,
background:"none"};c&&a.extend(g,{position:"absolute",left:"-1000px",top:"-1000px"});for(var i in g)d.style[i]=g[i];d.appendChild(b);g=c||document.documentElement;g.insertBefore(d,g.firstChild);b.style.cssText="position: absolute; left: 10.7432222px; top: 10.432325px; height: 30px; width: 201px;";b=a(b).offset(function(a,b){return b}).offset();d.innerHTML="";g.removeChild(d);c=b.top+b.left+(c?2E3:0);e=c>21&&c<22})()})(jQuery);
(function(a,c){a.widget("ui.progressbar",{options:{value:0,max:100},min:0,_create:function(){this.element.addClass("ui-progressbar ui-widget ui-widget-content ui-corner-all").attr({role:"progressbar","aria-valuemin":this.min,"aria-valuemax":this.options.max,"aria-valuenow":this._value()});this.valueDiv=a("<div class='ui-progressbar-value ui-widget-header ui-corner-left'></div>").appendTo(this.element);this.oldValue=this._value();this._refreshValue()},destroy:function(){this.element.removeClass("ui-progressbar ui-widget ui-widget-content ui-corner-all").removeAttr("role").removeAttr("aria-valuemin").removeAttr("aria-valuemax").removeAttr("aria-valuenow");
this.valueDiv.remove();a.Widget.prototype.destroy.apply(this,arguments)},value:function(a){if(a===c)return this._value();this._setOption("value",a);return this},_setOption:function(c,e){"value"===c&&(this.options.value=e,this._refreshValue(),this._value()===this.options.max&&this._trigger("complete"));a.Widget.prototype._setOption.apply(this,arguments)},_value:function(){var a=this.options.value;"number"!==typeof a&&(a=0);return Math.min(this.options.max,Math.max(this.min,a))},_percentage:function(){return 100*
...
this.orientation+" ui-widget ui-widget-content ui-corner-all"+(d.disabled?" ui-slider-disabled ui-disabled":""));this.range=a([]);if(d.range){if(!0===d.range&&(d.values||(d.values=[this._valueMin(),this._valueMin()]),d.values.length&&2!==d.values.length))d.values=[d.values[0],d.values[0]];this.range=a("<div></div>").appendTo(this.element).addClass("ui-slider-range ui-widget-header"+("min"===d.range||"max"===d.range?" ui-slider-range-"+d.range:""))}for(var f=e.length;f<g;f+=1)i.push("<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'></a>");
this.handles=e.add(a(i.join("")).appendTo(c.element));this.handle=this.handles.eq(0);this.handles.add(this.range).filter("a").click(function(a){a.preventDefault()}).hover(function(){d.disabled||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}).focus(function(){d.disabled?a(this).blur():(a(".ui-slider .ui-state-focus").removeClass("ui-state-focus"),a(this).addClass("ui-state-focus"))}).blur(function(){a(this).removeClass("ui-state-focus")});this.handles.each(function(b){a(this).data("index.ui-slider-handle",
...
_mouseCapture:function(c){var d=this.options,e,g,i,f,b;if(d.disabled)return!1;this.elementSize={width:this.element.outerWidth(),height:this.element.outerHeight()};this.elementOffset=this.element.offset();e=this._normValueFromMouse({x:c.pageX,y:c.pageY});g=this._valueMax()-this._valueMin()+1;f=this;this.handles.each(function(c){var d=Math.abs(e-f.values(c));g>d&&(g=d,i=a(this),b=c)});!0===d.range&&this.values(1)===d.min&&(b+=1,i=a(this.handles[b]));if(!1===this._start(c,b))return!1;this._mouseSliding=
!0;f._handleIndex=b;i.addClass("ui-state-active").focus();d=i.offset();this._clickOffset=!a(c.target).parents().andSelf().is(".ui-slider-handle")?{left:0,top:0}:{left:c.pageX-d.left-i.width()/2,top:c.pageY-d.top-i.height()/2-(parseInt(i.css("borderTopWidth"),10)||0)-(parseInt(i.css("borderBottomWidth"),10)||0)+(parseInt(i.css("marginTop"),10)||0)};this.handles.hasClass("ui-state-hover")||this._slide(c,b,e);return this._animateOff=!0},_mouseStart:function(){return!0},_mouseDrag:function(a){var d=this._normValueFromMouse({x:a.pageX,
...
_slide:function(a,d,e){var g;if(this.options.values&&this.options.values.length){g=this.values(d?0:1);if(2===this.options.values.length&&!0===this.options.range&&(0===d&&e>g||1===d&&e<g))e=g;e!==this.values(d)&&(g=this.values(),g[d]=e,a=this._trigger("slide",a,{handle:this.handles[d],value:e,values:g}),this.values(d?0:1),!1!==a&&this.values(d,e,!0))}else e!==this.value()&&(a=this._trigger("slide",a,{handle:this.handles[d],value:e}),!1!==a&&this.value(e))},_stop:function(a,d){var e={handle:this.handles[d],
...
0);else return this._value()},values:function(c,d){var e,g,i;if(1<arguments.length)this.options.values[c]=this._trimAlignValue(d),this._refreshValue(),this._change(null,c);else if(arguments.length)if(a.isArray(arguments[0])){e=this.options.values;g=arguments[0];for(i=0;i<e.length;i+=1)e[i]=this._trimAlignValue(g[i]),this._change(null,i);this._refreshValue()}else return this.options.values&&this.options.values.length?this._values(c):this.value();else return this._values()},_setOption:function(c,d){var e,
...
this.orientation);this._refreshValue();break;case "value":this._animateOff=!0;this._refreshValue();this._change(null,0);this._animateOff=!1;break;case "values":this._animateOff=!0;this._refreshValue();for(e=0;e<g;e+=1)this._change(null,e);this._animateOff=!1}},_value:function(){var a=this.options.value;return a=this._trimAlignValue(a)},_values:function(a){var d,e;if(arguments.length)return d=this.options.values[a],d=this._trimAlignValue(d);d=this.options.values.slice();for(e=0;e<d.length;e+=1)d[e]=
this._trimAlignValue(d[e]);return d},_trimAlignValue:function(a){if(a<=this._valueMin())return this._valueMin();if(a>=this._valueMax())return this._valueMax();var d=0<this.options.step?this.options.step:1,e=(a-this._valueMin())%d,a=a-e;2*Math.abs(e)>=d&&(a+=0<e?d:-d);return parseFloat(a.toFixed(5))},_valueMin:function(){return this.options.min},_valueMax:function(){return this.options.max},_refreshValue:function(){var c=this.options.range,d=this.options,e=this,g=!this._animateOff?d.animate:!1,i,f=
{},b,j,l,o;if(this.options.values&&this.options.values.length)this.handles.each(function(c){i=100*((e.values(c)-e._valueMin())/(e._valueMax()-e._valueMin()));f["horizontal"===e.orientation?"left":"bottom"]=i+"%";a(this).stop(1,1)[g?"animate":"css"](f,d.animate);if(!0===e.options.range)if("horizontal"===e.orientation){if(0===c)e.range.stop(1,1)[g?"animate":"css"]({left:i+"%"},d.animate);if(1===c)e.range[g?"animate":"css"]({width:i-b+"%"},{queue:!1,duration:d.animate})}else{if(0===c)e.range.stop(1,
1)[g?"animate":"css"]({bottom:i+"%"},d.animate);if(1===c)e.range[g?"animate":"css"]({height:i-b+"%"},{queue:!1,duration:d.animate})}b=i});else{j=this.value();l=this._valueMin();o=this._valueMax();i=o!==l?100*((j-l)/(o-l)):0;f["horizontal"===e.orientation?"left":"bottom"]=i+"%";this.handle.stop(1,1)[g?"animate":"css"](f,d.animate);if("min"===c&&"horizontal"===this.orientation)this.range.stop(1,1)[g?"animate":"css"]({width:i+"%"},d.animate);if("max"===c&&"horizontal"===this.orientation)this.range[g?
"animate":"css"]({width:100-i+"%"},{queue:!1,duration:d.animate});if("min"===c&&"vertical"===this.orientation)this.range.stop(1,1)[g?"animate":"css"]({height:i+"%"},d.animate);if("max"===c&&"vertical"===this.orientation)this.range[g?"animate":"css"]({height:100-i+"%"},{queue:!1,duration:d.animate})}}});a.extend(a.ui.slider,{version:"1.8.20"})})(jQuery);
(function(a,c){var d=0,e=0;a.widget("ui.tabs",{options:{add:null,ajaxOptions:null,cache:!1,cookie:null,collapsible:!1,disable:null,disabled:[],enable:null,event:"click",fx:null,idPrefix:"ui-tabs-",load:null,panelTemplate:"<div></div>",remove:null,select:null,show:null,spinner:"<em>Loading&#8230;</em>",tabTemplate:"<li><a href='#{href}'><span>#{label}</span></a></li>"},_create:function(){this._tabify(!0)},_setOption:function(a,c){"selected"==a?this.options.collapsible&&c==this.options.selected||this.select(c):
(this.options[a]=c,this._tabify())},_tabId:function(a){return a.title&&a.title.replace(/\s/g,"_").replace(/[^\w\u00c0-\uFFFF-]/g,"")||this.options.idPrefix+ ++d},_sanitizeSelector:function(a){return a.replace(/:/g,"\\:")},_cookie:function(){var c=this.cookie||(this.cookie=this.options.cookie.name||"ui-tabs-"+ ++e);return a.cookie.apply(null,[c].concat(a.makeArray(arguments)))},_ui:function(a,c){return{tab:a,panel:c,index:this.anchors.index(a)}},_cleanup:function(){this.lis.filter(".ui-state-processing").removeClass("ui-state-processing").find("span:data(label.tabs)").each(function(){var c=
a(this);c.html(c.data("label.tabs")).removeData("label.tabs")})},_tabify:function(d){function e(b,c){b.css("display","");!a.support.opacity&&c.opacity&&b[0].style.removeAttribute("filter")}var f=this,b=this.options,j=/^#.+/;this.list=this.element.find("ol,ul").eq(0);this.lis=a(" > li:has(a[href])",this.list);this.anchors=this.lis.map(function(){return a("a",this)[0]});this.panels=a([]);this.anchors.each(function(c,d){var e=a(d).attr("href"),g=e.split("#")[0],i;if(g&&(g===location.toString().split("#")[0]||
(i=a("base")[0])&&g===i.href))e=d.hash,d.href=e;j.test(e)?f.panels=f.panels.add(f.element.find(f._sanitizeSelector(e))):e&&"#"!==e?(a.data(d,"href.tabs",e),a.data(d,"load.tabs",e.replace(/#.*$/,"")),e=f._tabId(d),d.href="#"+e,g=f.element.find("#"+e),g.length||(g=a(b.panelTemplate).attr("id",e).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(f.panels[c-1]||f.list),g.data("destroy.tabs",!0)),f.panels=f.panels.add(g)):b.disabled.push(c)});d?(this.element.addClass("ui-tabs ui-widget ui-widget-content ui-corner-all"),
...
function(){o("hover",a(this))});this.lis.bind("mouseout.tabs",function(){a(this).removeClass("ui-state-hover")});this.anchors.bind("focus.tabs",function(){o("focus",a(this).closest("li"))});this.anchors.bind("blur.tabs",function(){a(this).closest("li").removeClass("ui-state-focus")})}var n,m;b.fx&&(a.isArray(b.fx)?(n=b.fx[0],m=b.fx[1]):n=m=b.fx);var r=m?function(b,c){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");c.hide().removeClass("ui-tabs-hide").animate(m,m.duration||"normal",
function(){e(c,m);f._trigger("show",null,f._ui(b,c[0]))})}:function(b,c){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");c.removeClass("ui-tabs-hide");f._trigger("show",null,f._ui(b,c[0]))},s=n?function(a,b){b.animate(n,n.duration||"normal",function(){f.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");e(b,n);f.element.dequeue("tabs")})}:function(a,b){f.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");f.element.dequeue("tabs")};
this.anchors.bind(b.event+".tabs",function(){var c=this,d=a(c).closest("li"),e=f.panels.filter(":not(.ui-tabs-hide)"),g=f.element.find(f._sanitizeSelector(c.hash));if(d.hasClass("ui-tabs-selected")&&!b.collapsible||d.hasClass("ui-state-disabled")||d.hasClass("ui-state-processing")||f.panels.filter(":animated").length||f._trigger("select",null,f._ui(this,g[0]))===false){this.blur();return false}b.selected=f.anchors.index(this);f.abort();if(b.collapsible){if(d.hasClass("ui-tabs-selected")){b.selected=
-1;b.cookie&&f._cookie(b.selected,b.cookie);f.element.queue("tabs",function(){s(c,e)}).dequeue("tabs");this.blur();return false}if(!e.length){b.cookie&&f._cookie(b.selected,b.cookie);f.element.queue("tabs",function(){r(c,g)});f.load(f.anchors.index(this));this.blur();return false}}b.cookie&&f._cookie(b.selected,b.cookie);if(g.length){e.length&&f.element.queue("tabs",function(){s(c,e)});f.element.queue("tabs",function(){r(c,g)});f.load(f.anchors.index(this))}else throw"jQuery UI Tabs: Mismatching fragment identifier.";
...
e,f){f===c&&(f=this.anchors.length);var b=this,j=this.options,e=a(j.tabTemplate.replace(/#\{href\}/g,d).replace(/#\{label\}/g,e)),d=!d.indexOf("#")?d.replace("#",""):this._tabId(a("a",e)[0]);e.addClass("ui-state-default ui-corner-top").data("destroy.tabs",!0);var l=b.element.find("#"+d);l.length||(l=a(j.panelTemplate).attr("id",d).data("destroy.tabs",!0));l.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide");f>=this.lis.length?(e.appendTo(this.list),l.appendTo(this.list[0].parentNode)):
(e.insertBefore(this.lis[f]),l.insertBefore(this.panels[f]));j.disabled=a.map(j.disabled,function(a){return a>=f?++a:a});this._tabify();1==this.anchors.length&&(j.selected=0,e.addClass("ui-tabs-selected ui-state-active"),l.removeClass("ui-tabs-hide"),this.element.queue("tabs",function(){b._trigger("show",null,b._ui(b.anchors[0],b.panels[0]))}),this.load(0));this._trigger("add",null,this._ui(this.anchors[f],this.panels[f]));return this},remove:function(c){var c=this._getIndex(c),d=this.options,e=this.lis.eq(c).remove(),
...
".tabs");return this},load:function(c){var c=this._getIndex(c),d=this,e=this.options,b=this.anchors.eq(c)[0],j=a.data(b,"load.tabs");this.abort();if(!j||0!==this.element.queue("tabs").length&&a.data(b,"cache.tabs"))this.element.dequeue("tabs");else{this.lis.eq(c).addClass("ui-state-processing");if(e.spinner){var l=a("span",b);l.data("label.tabs",l.html()).html(e.spinner)}this.xhr=a.ajax(a.extend({},e.ajaxOptions,{url:j,success:function(j,l){d.element.find(d._sanitizeSelector(b.hash)).html(j);d._cleanup();
e.cache&&a.data(b,"cache.tabs",!0);d._trigger("load",null,d._ui(d.anchors[c],d.panels[c]));try{e.ajaxOptions.success(j,l)}catch(m){}},error:function(a,j){d._cleanup();d._trigger("load",null,d._ui(d.anchors[c],d.panels[c]));try{e.ajaxOptions.error(a,j,c,b)}catch(l){}}}));d.element.dequeue("tabs");return this}},abort:function(){this.element.queue([]);this.panels.stop(!1,!0);this.element.queue("tabs",this.element.queue("tabs").splice(-2,2));this.xhr&&(this.xhr.abort(),delete this.xhr);this._cleanup();
return this},url:function(a,c){this.anchors.eq(a).removeData("cache.tabs").data("load.tabs",c);return this},length:function(){return this.anchors.length}});a.extend(a.ui.tabs,{version:"1.8.20"});a.extend(a.ui.tabs.prototype,{rotation:null,rotate:function(a,c){var d=this,b=this.options,e=d._rotate||(d._rotate=function(c){clearTimeout(d.rotation);d.rotation=setTimeout(function(){var a=b.selected;d.select(++a<d.anchors.length?a:0)},a);c&&c.stopPropagation()}),l=d._unrotate||(d._unrotate=!c?function(a){a.clientX&&
d.rotate(null)}:function(){e()});a?(this.element.bind("tabsshow",e),this.anchors.bind(b.event+".tabs",l),e()):(clearTimeout(d.rotation),this.element.unbind("tabsshow",e),this.anchors.unbind(b.event+".tabs",l),delete this._rotate,delete this._unrotate);return this}})})(jQuery);
(function(a){function c(c){if("string"===typeof c.data){var e=c.handler,g=c.data.toLowerCase().split(" ");c.handler=function(c){if(!(this!==c.target&&(/textarea|select/i.test(c.target.nodeName)||"text"===c.target.type))){var d="keypress"!==c.type&&a.hotkeys.specialKeys[c.which],b=String.fromCharCode(c.which).toLowerCase(),j="",l={};c.altKey&&"alt"!==d&&(j+="alt+");c.ctrlKey&&"ctrl"!==d&&(j+="ctrl+");c.metaKey&&!c.ctrlKey&&"meta"!==d&&(j+="meta+");c.shiftKey&&"shift"!==d&&(j+="shift+");d?l[j+d]=!0:
(l[j+b]=!0,l[j+a.hotkeys.shiftNums[b]]=!0,"shift+"===j&&(l[a.hotkeys.shiftNums[b]]=!0));d=0;for(b=g.length;d<b;d++)if(l[g[d]])return e.apply(this,arguments)}}}}a.hotkeys={version:"0.8",specialKeys:{8:"backspace",9:"tab",13:"return",16:"shift",17:"ctrl",18:"alt",19:"pause",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"insert",46:"del",96:"0",97:"1",98:"2",99:"3",100:"4",101:"5",102:"6",103:"7",104:"8",105:"9",106:"*",107:"+",
...
(function(a){a.fn.raptorize=function(c){c=a.extend({enterOn:"click",delayTime:5E3},c);return this.each(function(){function d(){i=!0;g&&document.getElementById("elRaptorShriek").play();f.animate({bottom:"0"},function(){a(this).animate({bottom:"-30px"},100,function(){var b=a(this).position().left+400;a(this).delay(300).animate({right:b},2200,function(){f=a("#elRaptor").css({bottom:"-700px",right:"0"});i=!1})})})}var e=a(this),g=!1;if(a.browser.mozilla&&"1.9.2"<=a.browser.version.substr(0,5)||a.browser.webkit)g=
...
var f=a("#elRaptor").css({position:"fixed",bottom:"-700px",right:"0",display:"block"});if("timer"==c.enterOn)setTimeout(d,c.delayTime);else if("click"==c.enterOn)e.bind("click",function(a){a.preventDefault();i||d()});else if("konami-code"==c.enterOn){var b=[];a(window).bind("keydown.raptorz",function(c){b.push(c.keyCode);0<=b.toString().indexOf("38,38,40,40,37,39,37,39,66,65")&&(d(),a(window).unbind("keydown.raptorz"))},!0)}})}})(jQuery);
(function(a,c,d,e){function g(a,b,c){J[a]=c;u[a]=b;P||(P=a)}function i(b){P!==b&&(P=b,a.ui.editor.eachInstance(function(){this.reinit()}))}function f(a,b){P&&J[P]&&J[P][a]&&(a=J[P][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function b(b){if(I===e){I=!0;if(G=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(b.options.baseClass+"-ios"),G&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height",
"-=1")},0)});a.browser.mozilla&&a("html").addClass(b.options.baseClass+"-ff");if(a.browser.msie&&9>a.browser.version){I=!1;var c=a("<div/>").addClass(b.options.baseClass+"-unsupported").html(b.getTemplate("unsupported")).appendTo("body");j(c);c.find("."+b.options.baseClass+"-unsupported-close").click(function(){c.remove()})}}return I}function j(b){var c=1;b.siblings().each(function(){var b=a(this).css("z-index");!isNaN(b)&&b>c&&(c=b+1)});b.css("z-index",c)}function l(a){return a.clone().wrap("<div/>").parent().html()}
function o(a){var b,a=document.createElement(a);b="getComputedStyle"in c;document.body.appendChild(a);b=(b?c.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return b}function n(b,c){return-1!==a.inArray(a(b)[0].tagName.toLowerCase(),c)}function m(b,c){for(var d="",e=0,f=b.childNodes.length;e<f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?g.nodeValue:l(a(g)))&&(d+=g)}c&&(d=a("<"+c+">"+d+"</"+c+">"),d.find("p").wrapInner("<"+c+"/>"),d.find("p > *").unwrap(),d=a("<div/>").html(d).html());
return d}function r(b,c){var d=a("<div/>").append(b)[0].childNodes;c.deleteContents();d.length===e||1===d.length?c.insertNode(d[0].cloneNode(!0)):a.each(d,function(a,b){c.insertNodeAtEnd(b.cloneNode(!0))})}function s(b){var b=b||d.getSelection(),c;a(b.getAllRanges()).each(function(b,d){c=3===this.commonAncestorContainer.nodeType?a(d.commonAncestorContainer).parent()[0]:d.commonAncestorContainer});return c}function p(a){if(!M||a)M=d.saveSelection()}function q(){M&&(d.restoreSelection(M),M=!1)}function x(a,
b,c){for(var b=b||d.getSelection(),e,f=0;e=b.getAllRanges()[f++];)a.call(c,e)}function w(a,b){x(function(b){r(a,b)},b,this)}function A(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).focus().contents().each(function(){var a=d.createRange();a.selectNodeContents(this);c.addRange(a)})}function E(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNode(this);c.addRange(a)}).focus()}function z(b,c,e){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=
d.createRange();a.selectNodeContents(this);a.collapse(e);c.addRange(a)})}function C(a){a=a||d.getSelection();return a.toHtml()}function F(b){b=b||d.getSelection().getRangeAt(0);return a(3===b.commonAncestorContainer.nodeType?b.commonAncestorContainer.parentNode:b.commonAncestorContainer)}function H(a){var b=new jQuery;x(function(a){b.push(F(a)[0])},a,this);return b}function D(){var b=d.getSelection();if(null===b.anchorNode)return null;if(b.isBackwards())return 3===b.focusNode.nodeType?a(b.focusNode.parentElement):
a(b.focusNode);b.anchorNode||console.trace();return 3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode)}function v(){var b=d.getSelection();return null===b.anchorNode?null:b.isBackwards()?3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode):3===b.focusNode.nodeType?a(b.focusNode.parentElement):a(b.focusNode)}function N(b,c){var c=c||{},e=d.createCssClassApplier(c.classes||"",{normalize:!0,elementTagName:b,elementProperties:c.attributes||{}});x(function(d){var f=
d.cloneContents(),f=m(f);"string"===typeof f&&(f=f.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));a(f).is(":empty")?(f=a("<"+b+"/>").addClass(c.classes).attr(c.attributes||{}).append(m(d.cloneContents())),r(f,d)):e.toggleRange(d)},null,this)}function R(a,b,c){x(function(d){d=F(d);d.is(a)?d.attr(b):N(a,{classes:c,attributes:b})},null,this)}function h(b,c){var c=c||d.getSelection(),e=c.getRangeAt(0),f=H()[0],g=d.createRange();g.setStartBefore(f);g.setEnd(e.startContainer,e.startOffset);var g=g.cloneContents(),
h=d.createRange();h.setStart(e.endContainer,e.endOffset);h.setEndAfter(f);e=h.cloneContents();g=l(a(m(g)));g+=l(a(b));g+=l(a(m(e)));a(f).replaceWith(a(g))}function S(a,b,c){var c=c||d.getSelection(),e=D()[0],f=v()[0],g=H()[0],g=n(g,b),e=n(e,b),b=n(f,b);g&&e&&b?w(a):h(a,c)}function Q(a,b){allowed=[];for(var c=0;c<b.length;c++)b[c].match(/[a-z][a-z0-9]{0,}/g)&&allowed.push(b[c]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,
b){return-1<allowed.indexOf(b.toLowerCase())?a:""})}var P=null,J={},u={};a(function(){d.initialized||d.init();a.isFunction(d.rangePrototype.insertNodeAtEnd)||(d.rangePrototype.insertNodeAtEnd=function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});a("html").click(function(){a(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});a.widget("ui.editor",{_init:function(){-1===a.inArray(this,a.ui.editor.instances)&&a.ui.editor.instances.push(this);
var c=this;a.ui.editor.eachInstance(function(a){c!=a&&c.element.closest(a.element).length&&handleError("Nesting editors is unsupported",c.element,a.element)});this.options=a.extend({},a.ui.editor.defaults,this.options);this.options.uiOrder=this.options.uiOrder||[["logo"],["save","cancel"],["dock","showGuides","clean"],["viewSource"],["undo","redo"],["alignLeft","alignCenter","alignJustify","alignRight"],["textBold","textItalic","textUnderline","textStrike"],["textSuper","textSub"],["listUnordered",
"listOrdered"],["hr","quoteBlock"],["fontSizeInc","fontSizeDec"],["colorPickerBasic"],["clearFormatting"],["link","unlink"],["embed"],["floatLeft","floatNone","floatRight"],["tagMenu"],["i18n"],["raptorize"],["length"],["debugReinit","debugDestroy"]];this.element.attr("id")||this.element.attr("id",this.getUniqueId());this.ready=!1;this.events={};this.ui={};this.plugins={};this.templates=a.extend({},a.ui.editor.templates);this.path=this.toolbarWrapper=this.toolbar=this.wrapper=null;this.visible=this.enabled=
!1;this.uiObjects={};this.hotkeys={};this.options.enableHotkeys&&this.registerHotkey(this.hotkeys);for(var d in this.options.bind)this.bind(d,this.options.bind[d]);this.history=[];this.present=0;this.historyEnabled=!0;b(this)&&(this.cloneDomTools(),this.setOriginalHtml(this.element.is(":input")?this.element.val():this.element.html()),this.options.replace&&(this.replaceOriginal(),this.options.replace=!1),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,
this.ready=!0,this.fire("ready"),this.options.autoEnable&&a(function(){c.enableEditing();c.showToolbar()}))},attach:function(){this.bind("change",this.historyPush);this.bind("selectionChange",this.updateTagTree);this.bind("show",this.updateTagTree);var b=a.proxy(this.checkChange,this);this.getElement().find("img").bind("click."+this.widgetName,a.proxy(function(a){E(a.target)},this));this.getElement().bind("mouseup."+this.widgetName,b);this.getElement().bind("keyup."+this.widgetName,b);a(c).bind("beforeunload",
a.proxy(a.ui.editor.unloadWarning,a.ui.editor))},reinit:function(){if(this.ready){var a=this.enabled,b=this.visible;this.destruct();this._init();a&&this.enableEditing();b&&this.showToolbar()}else{var c;c=function(){this.unbind("ready",c);this.reinit()};this.bind("ready",c)}},getElement:function(){return this.target?this.target:this.element},getOriginalElement:function(){return this.element},replaceOriginal:function(){if(!this.target){for(var b=a("<div/>").html(this.element.is(":input")?this.element.val():
this.element.html()).insertBefore(this.element).attr("id",this.getUniqueId()).addClass(this.element.attr("class")),c=this.options.domTools.getStyles(this.element),d=0;d<this.options.replaceStyle.length;d++)b.css(this.options.replaceStyle[d],c[this.options.replaceStyle[d]]);this.element.hide();this.bind("change",function(){this.element.is("input, textarea")?this.element.val(this.getHtml()):this.element.html(this.getHtml())});this.target=b}},cloneDomTools:function(){for(var a in this.options.domTools)this[a]||
(this[a]=function(a){return function(){this.options.domTools.constrainSelection(this.getElement());var b=this.getHtml(),c=this.options.domTools[a].apply(this.options.domTools,arguments);b!==this.getHtml()&&this.change();return c}}(a))},checkChange:function(){var a=d.serializeSelection();this.previousSelection!==a&&this.fire("selectionChange");this.previousSelection=a;var a=this.getCleanHtml(),b=this.dirty;this.dirty=this.getOriginalHtml()!==a;this.previousHtml!==a&&(this.previousHtml=a,this.change(),
...
this.loadToolbar();this.enabled||(this.enabled=!0,this.getElement().addClass(this.options.baseClass+"-editing"),this.options.partialEdit?this.getElement().find(this.options.partialEdit).attr("contenteditable",!0):this.getElement().attr("contenteditable",!0),this.execCommand("enableInlineTableEditing",!1,!1),this.execCommand("styleWithCSS",!0,!0),this.bindHotkeys(),this.fire("enabled"),this.fire("resize"))},disableEditing:function(){this.enabled&&(this.enabled=!1,this.getElement().attr("contenteditable",
!1).removeClass(this.options.baseClass+"-editing"),d.getSelection().removeAllRanges(),this.fire("disabled"))},isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var b=this,c="",d=[],e=0;x(function(f){var f=f.commonAncestorContainer,g;g=3===f.nodeType?a(f).parent():a(f);f=[];for(d.push(f);g[0]&&!b.isRoot(g)&&"body"!==g[0].tagName.toLowerCase();)f.push(g),g=g.parent();f.reverse();c&&(c+=" | ");c+=this.getTemplate("root");for(g=0;g<f.length;g++)c+=this.getTemplate("tag",
{element:f[g][0].tagName.toLowerCase(),data:"["+e+","+g+"]"});e++},null,this);c||(c=this.getTemplate("root"));this.path.html(c).find("a").click(function(){var c=a(this).data("ui-editor-selection");c?(E(d[c[0]][c[1]]),b.updateTagTree()):E(b.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(b){return this.getElement()[0]===a(b)[0]},unify:function(b,c){!1!==c&&b(this);if(this.options.unify)for(var d=a.ui.editor.getInstances(),e=0;e<d.length;e++)d[e]!==this&&d[e].options.unify&&b(d[e])},getUniqueId:function(){return a.ui.editor.getUniqueId()},
loadMessages:function(){this.messages=a(this.getTemplate("messages")).appendTo(this.wrapper)},showMessage:function(b,d,e){var e=a.extend({},this.options.message,e),f;f={timer:null,editor:this,show:function(){this.element.slideDown();this.timer=c.setTimeout(function(){this.timer=null;f.hide()},e.delay,this)},hide:function(){this.timer&&(c.clearTimeout(this.timer),this.timer=null);this.element.stop().slideUp(a.proxy(function(){a.isFunction(e.hide)&&e.hide.call(this);this.element.remove()},this))}};
f.element=a(this.getTemplate("message",{type:b,message:d})).hide().appendTo(this.messages).find(".ui-editor-message-close").click(function(){f.hide()}).end();f.show();return f},showLoading:function(a,b){return this.showMessage("clock",a,b)},showInfo:function(a,b){return this.showMessage("info",a,b)},showError:function(a,b){return this.showMessage("circle-close",a,b)},showConfirm:function(a,b){return this.showMessage("circle-check",a,b)},showWarning:function(a,b){return this.showMessage("alert",a,
b)},loadToolbar:function(){var b=this.toolbar=a("<div/>").addClass(this.options.baseClass+"-toolbar"),b=this.toolbarWrapper=a("<div/>").addClass(this.options.baseClass+"-toolbar-wrapper").addClass("ui-widget-content").append(b),d=this.path=a("<div/>").addClass(this.options.baseClass+"-path").addClass("ui-widget-header").html(this.getTemplate("root")),e=this.wrapper=a("<div/>").addClass(this.options.baseClass+"-wrapper").css("display","none").append(d).append(b);a.fn.draggable&&this.options.draggable&&
(e.draggable({cancel:"a, button",cursor:"move",handle:".ui-editor-path",stop:a.proxy(function(){var a=this.persist("position",[e.css("top"),e.css("left")]);e.css({top:Math.abs(a[0]),left:Math.abs(a[1])})},this)}),e.css("position",""),(b=this.persist("position")||this.options.dialogPosition)||(b=[10,10]),parseInt(b[0],10)+e.outerHeight()>a(c).height()&&(b[0]=a(c).height()-e.outerHeight()),parseInt(b[1],10)+e.outerWidth()>a(c).width()&&(b[1]=a(c).width()-e.outerWidth()),e.css({top:Math.abs(parseInt(b[0])),
left:Math.abs(parseInt(b[1]))}),this.loadMessages());a(function(){e.appendTo("body")});this.loadUi()},isToolbarLoaded:function(){return null!==this.wrapper},showToolbar:function(b){this.isToolbarLoaded()||this.loadToolbar();if(!this.visible){this.options.unify&&this.hideOtherToolbars(!0);this.visible=!0;this.wrapper.css("display","");this.fire("resize");"undefined"===typeof this.getElement().attr("tabindex")&&this.getElement().attr("tabindex",-1);if(b)if(b.select)b.select();else{var d=c.getSelection();
d.removeAllRanges();d.addRange(b)}var e=this;a(function(){e.fire("show");e.getElement().focus()})}},hideToolbar:function(){this.visible&&(this.visible=!1,this.wrapper.hide(),this.fire("hide"),this.fire("resize"))},hideOtherToolbars:function(a){this.unify(function(b){b.hideToolbar(a)},!1)},isVisible:function(){return this.visible},getTemplate:function(b,c){var d;d=this.templates[b]?this.templates[b]:a.ui.editor.getTemplate(b,this.options.urlPrefix);d=d.replace(/_\('(.*?)'\)/g,function(a,b){b=b.replace(/\\(.?)/g,
function(a,b){switch(b){case "\\":return"\\";case "0":return"\x00";case "":return"";default:return b}});return f(b)});c=a.extend({},this.options,c||{});c=this.getTemplateVars(c);return d=d.replace(/\{\{(.*?)\}\}/g,function(a,b){return c[b]})},getTemplateVars:function(a,b,c){b=b?b+".":"";c||(c=1);var d={},e;for(e in a)if("object"===typeof a[e]&&5>c){var f=this.getTemplateVars(a[e],b+e,++c),g;for(g in f)d[g]=f[g]}else d[b+e]=a[e];return d},historyPush:function(){this.historyEnabled&&this.getHtml()!==
this.historyPeak()&&(this.present!==this.history.length-1&&(this.history=this.history.splice(0,this.present+1)),this.history.push(this.getHtml()),this.present=this.history.length-1)},historyPeak:function(){return!this.history.length?null:this.history[this.present]},historyBack:function(){0<this.present&&(this.present--,this.setHtml(this.history[this.present]),this.historyEnabled=!1,this.change(),this.historyEnabled=!0)},historyForward:function(){this.present<this.history.length-1&&(this.present++,
this.setHtml(this.history[this.present]),this.historyEnabled=!1,this.change(),this.historyEnabled=!0)},registerHotkey:function(b,c,d){if("string"===typeof b)this.hotkeys[b]=a.extend({},{context:d,restoreSelection:!0},c);else for(var e in b)this.registerHotkey(e,b[e],d)},bindHotkeys:function(){for(keyCombination in this.hotkeys){var a=this,b=this.hotkeys[keyCombination].force||!1;(this.options.enableHotkeys||b)&&this.getElement().bind("keydown."+this.widgetName,keyCombination,function(b){p();var c=
a.hotkeys[b.data];!0!==c.action.call(c.context)&&b.preventDefault();c.restoreSelection&&q();a.checkChange()})}},uiEnabled:function(b){return!1===this.options.enableUi&&"undefined"===typeof this.options.ui[b]||!1===this.options.ui[b]||-1!==a.inArray(b,this.options.disabledUi)?!1:!0},getUi:function(a){return this.uiObjects[a]},loadUi:function(){for(var b=0,c=this.options.uiOrder.length;b<c;b++){for(var d=this.options.uiOrder[b],e=a("<div/>"),f=0,g=d.length;f<g;f++)if(this.uiEnabled(d[f])){var h=d[f].replace(/([A-Z])/g,
function(a){return"-"+a.toLowerCase()});if(a.ui.editor.ui[d[f]]){var i=a.extend({},a.ui.editor.ui[d[f]]),h=a.extend(!0,{},this.options,{baseClass:this.options.baseClass+"-ui-"+h},i.options,this.options.ui[d[f]]);i.editor=this;i.options=h;i.ui=i.init(this,h);i.hotkeys&&(this.registerHotkey(i.hotkeys,null,i),i.ui.title+=" ("+a.map(i.hotkeys,function(a,b){return b})[0]+")");i.ui.init(d[f],this,h,i).appendTo(e);this.uiObjects[d[f]]=i}}e.addClass("ui-buttonset").addClass(this.options.baseClass+"-buttonset");
0<e.children().length&&e.appendTo(this.toolbar)}a("<div/>").css("clear","both").appendTo(this.toolbar)},uiButton:function(b){return a.extend({button:null,options:{},init:function(b,c,d,e){var k=b.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}),d=a.extend({},c.options,{baseClass:c.options.baseClass+"-"+k+"-button"},this.options,c.options.ui[b]);this.title||(this.title=f("Unnamed Button"));this.button=a("<div/>").html(this.label||this.title).addClass(d.baseClass).attr("name",b).attr("title",
this.title).val(b);d.classes&&this.button.addClass(d.classes);this.button.bind("mousedown."+e.editor.widgetName,function(a){a.preventDefault()});var g=this;this.button.bind("mouseup."+e.editor.widgetName,function(a){a.preventDefault();g.click.apply(e,arguments)});c.bind("destroy",a.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+k},disabled:d.disabled?!0:!1,text:this.text||!1,label:this.label||null});this.ready.call(e);return this.button},
disable:function(){this.button.button("option","disabled",!0)},enable:function(){this.button.button("option","disabled",!1)},ready:function(){},click:function(){}},b)},uiSelectMenu:function(b){return a.extend({select:null,selectMenu:null,button:null,menu:null,options:{},init:function(b,c){var d=this,e=b.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});a.extend({},c.options,{baseClass:c.options.baseClass+e+"-select-menu"},d.options,c.options.ui[b]);d.title||(d.title=f("Unnamed Select Menu"));
d.wrapper=a('<div class="ui-editor-selectmenu-wrapper"/>').append(d.select.hide()).addClass(d.select.attr("class"));d.selectMenu=a('<div class="ui-editor-selectmenu"/>').appendTo(d.wrapper);d.menu=a('<div class="ui-editor-selectmenu-menu ui-widget-content ui-corner-bottom ui-corner-tr"/>').appendTo(d.wrapper);d.select.find("option, .ui-editor-selectmenu-option").each(function(){a("<div/>").addClass("ui-editor-selectmenu-menu-item").addClass("ui-corner-all").html(a(this).html()).appendTo(d.menu).bind("mouseenter."+
...
return false})});var e=a("<div/>").addClass("ui-editor-selectmenu-text"),k=a("<div/>").addClass("ui-icon ui-icon-triangle-1-s");d.button=a("<div/>").addClass("ui-editor-selectmenu-button ui-editor-selectmenu-button ui-button ui-state-default").attr("title",d.title).append(e).append(k).prependTo(d.selectMenu);d.button.bind("mousedown."+c.widgetName,function(){return false}).bind("click."+c.widgetName,function(){if(!a(this).hasClass("ui-state-disabled")){parseInt(d.menu.css("min-width"),10)<d.button.outerWidth()+
...
getOriginalHtml:function(){return this.originalHtml},save:function(){var a=this.getCleanHtml();this.fire("save");this.setOriginalHtml(a);this.fire("saved");this.fire("cleaned");return a},setOriginalHtml:function(a){this.originalHtml=a},bind:function(b,c,d){var e=this.events;a.each(b.split(","),function(b,k){k=a.trim(k);e[k]||(e[k]=[]);e[k].push({context:d,callback:c})})},unbind:function(a,b,c){for(var d=0,e=this.events[a].length;d<e;d++)this.events[a][d]&&this.events[a][d].callback===b&&this.events[a][d].context===
c&&this.events[a].splice(d,1)},fire:function(b,c,d){d||this.fire("before:"+b,c,!0);if(this.events[b])for(var e=0,f=this.events[b].length;e<f;e++){var g=this.events[b][e];"undefined"!==typeof g.callback&&g.callback.call(g.context||this)}!1!==c&&a.ui.editor.fire(b);d||this.fire("after:"+b,c,!0)}});a.extend(a.ui.editor,{defaults:{plugins:{},ui:{},bind:{},domTools:{constrainSelection:function(b,c){var b=a(b)[0],c=c||d.getSelection(),e;a(c.getAllRanges()).each(function(d,f){e=3===this.commonAncestorContainer.nodeType?
a(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;b!==e&&!a.contains(b,e)&&c.removeRange(f)})},unwrapParentTag:function(b){H().each(function(){a(this).is(b)&&a(this).replaceWith(a(this).html())})},execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(d){}},insertTag:function(b,c){x(function(c){c.insertNode(a("<"+b+"/>")[0])},c,this)},insertTagAtEnd:function(b,c){x(function(c){c.insertNodeAtEnd(a("<"+b+"/>")[0])},c,this)},insertElement:function(b,c,d){x(function(d){a(b).each(function(){d.insertNode(!1===
c?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(b,c,d){x(function(d){a(b).each(function(){d.insertNodeAtEnd(!1===c?this:this.cloneNode(!0))})},d,this)},toggleBlockStyle:function(b,c){x(function(d){for(d=a(d.commonAncestorContainer);d.length&&d[0]!==c[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===c[0]&&"inline"!==c.css("display")&&(this.wrapInner(c,"div"),d=c.children().first());this.toggleStyle(d,b)},null,this)},wrapInner:function(b,c){p();a(b).each(function(){var d=
a("<"+c+"/>").html(a(this).html());b.html(d)});q()},inverseWrapWithTagClass:function(b,c,e,f){p();var g="domTools"+Math.ceil(1E7*Math.random());x(function(a){var b=d.createCssClassApplier(f,{elementTagName:e});b.isAppliedToRange(a)?b.toggleSelection():d.createCssClassApplier(c,{elementTagName:g}).toggleSelection()},null,this);a(g).each(function(){a(this).replaceWith(a("<"+b+"/>").addClass(c).html(a(this).html()))});q()},toggleStyle:function(b,c){a.each(c,function(c,d){a(b).css(c)===d?a(b).css(c,""):
...
persist:function(a,b,c){a=c?c+"."+a:a;if(localStorage){c=localStorage.uiWidgetEditor?JSON.parse(localStorage.uiWidgetEditor):{};if(b===e)return c[a];c[a]=b;localStorage.uiWidgetEditor=JSON.stringify(c)}return b}});var I,G;a.ui.editor.registerUi({alignLeft:{init:function(a){return a.uiButton({title:f("Left Align"),click:function(){a.toggleBlockStyle({"text-align":"left"},a.getElement())}})}},alignJustify:{init:function(a){return a.uiButton({title:f("Justify"),click:function(){a.toggleBlockStyle({"text-align":"justify"},
a.getElement())}})}},alignCenter:{init:function(a){return a.uiButton({title:f("Center Align"),click:function(){a.toggleBlockStyle({"text-align":"center"},a.getElement())}})}},alignRight:{init:function(a){return a.uiButton({title:f("Right Align"),click:function(){a.toggleBlockStyle({"text-align":"right"},a.getElement())}})}}});a.ui.editor.registerUi({textBold:{hotkeys:{"ctrl+b":{action:function(){this.ui.click()}}},init:function(a,b){return this.editor.uiButton({title:f("Bold"),click:function(){N("strong",
{classes:b.classes||b.cssPrefix+"bold"})}})}},textItalic:{hotkeys:{"ctrl+i":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:f("Italic"),click:function(){N("em",{classes:b.classes||b.cssPrefix+"italic"})}})}},textUnderline:{hotkeys:{"ctrl+u":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:f("Underline"),click:function(){N("u",{classes:b.classes||b.cssPrefix+"underline"})}})}},textStrike:{hotkeys:{"ctrl+k":{action:function(){this.ui.click()}}},
init:function(a,b){return a.uiButton({title:f("Strikethrough"),click:function(){N("del",{classes:b.classes||b.cssPrefix+"strike"})}})}},textSub:{init:function(a,b){return a.uiButton({title:f("Sub script"),click:function(){N("sub",{classes:b.classes||b.cssPrefix+"sub"})}})}},textSuper:{init:function(a,b){return a.uiButton({title:f("Super script"),click:function(){N("sup",{classes:b.classes||b.cssPrefix+"super"})}})}}});a.ui.editor.registerUi({quoteBlock:{init:function(a,b){return a.uiButton({title:f("Blockquote"),
icon:"ui-icon-quote",click:function(){N("blockquote",{classes:b.classes||b.cssPrefix+"blockquote"})}})}}});a.ui.editor.registerUi({cancel:{hotkeys:{"ctrl+k":{action:function(){this.ui.click()}}},init:function(a){return a.uiButton({name:"cancel",title:f("Cancel"),icons:{primary:"ui-icon-cancel"},dialog:null,click:function(){this.confirm()}})},confirm:function(){var b=this.editor.getPlugin("cancel"),c=this.editor;c.isDirty()?(this.dialog||(this.dialog=a(c.getTemplate("cancel.dialog"))),this.dialog.dialog({modal:!0,
resizable:!1,title:f("Confirm Cancel Editing"),dialogClass:c.options.dialogClass+" "+c.options.baseClass,show:c.options.dialogShowAnimation,hide:c.options.dialogHideAnimation,buttons:[{text:f("OK"),click:function(){b.cancel();a(this).dialog("close")}},{text:f("Cancel"),click:function(){a(this).dialog("close")}}],open:function(){var b=a(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},
close:function(){a(this).dialog("destroy").remove()}})):b.cancel()}}});a.ui.editor.registerPlugin({cancel:{cancel:function(){this.editor.unify(function(a){a.fire("cancel");a.resetHtml();a.hideToolbar();a.disableEditing()})}}});a.ui.editor.registerPlugin("clean",{options:{stripAttrs:["_moz_dirty"],stripAttrContent:{type:"_moz"},stripEmptyTags:"span,h1,h2,h3,h4,h5,h6,p,b,i,u,strong,em,big,small,div".split(","),stripEmptyAttrs:["class","id","style"],stripDomains:[{selector:"a",attributes:["href"]},{selector:"img",
attributes:["src"]}]},init:function(a){a.bind("change",this.clean,this)},clean:function(){var b,d=this.editor;for(b=0;b<this.options.stripAttrs.length;b++)d.getElement().find("["+this.options.stripAttrs[b]+"]").removeAttr(this.options.stripAttrs[b]);for(b=0;b<this.options.stripAttrContent.length;b++)d.getElement().find("["+b+'="'+this.options.stripAttrs[b]+'"]').removeAttr(this.options.stripAttrs[b]);for(b=0;b<this.options.stripEmptyTags.length;b++)d.getElement().find(this.options.stripEmptyTags[b]).filter(function(){if(""===
a.trim(a(this).html())||a(this).hasClass("rangySelectionBoundary")&&!1===(!1!==M))return!0}).remove();for(b=0;b<this.options.stripEmptyAttrs.length;b++){var e=this.options.stripEmptyAttrs[b];d.getElement().find("["+this.options.stripEmptyAttrs[b]+"]").filter(function(){return""===a.trim(a(this).attr(e))}).removeAttr(this.options.stripEmptyAttrs[b])}var f=c.location.protocol+"//"+c.location.host,g="//"+c.location.host;for(b=0;b<this.options.stripDomains.length;b++){var h=this.options.stripDomains[b];
this.editor.getElement().find(h.selector).each(function(){for(var b=0;b<h.attributes.length;b++){var c=a(this).attr(h.attributes[b]);"undefined"!==typeof c&&(0===c.indexOf(f)?a(this).attr(h.attributes[b],c.substr(f.length)):0===c.indexOf(g)&&a(this).attr(h.attributes[b],c.substr(g.length)))}})}this.editor.getElement().find("ul, ol").each(function(){a(this).find(" > :not(li)").each(function(){o(a(this).attr("tag"))?a(this).replaceWith(a("<li>"+a(this).html()+"</li>").appendTo("body")):a(this).wrap(a("<li>"))})})}});
a.ui.editor.registerUi({clean:{init:function(a){return a.uiButton({title:f("Remove unnecessary markup from editor content"),click:function(){a.getPlugin("clean").clean()}})}}});a.ui.editor.registerUi({clearFormatting:{init:function(b){return this.editor.uiButton({title:f("Clear Formatting"),click:function(){var c=d.getSelection();if(0<c.rangeCount){var e=c.getRangeAt(0).cloneRange(),f=e.extractContents();""==m(f)&&(b.expandToParent(e),c.setSingleRange(e),f=e.extractContents());f=a("<div/>").append(m(f)).text();
for(c=e.commonAncestorContainer;c&&c.parentNode!=b.getElement().get(0);)c=c.parentNode;if(c){e.setEndAfter(c);var g=e.extractContents();e.collapseAfter(c);e.insertNode(g);e.collapseAfter(c)}e.insertNode(document.createTextNode(f))}b.checkChange()}})}}});a.ui.editor.registerPlugin("clickToEdit",{init:function(b,c){var d=this,e=a(b.getTemplate("clicktoedit.message",c)).appendTo("body"),c=a.extend({},{obscureLinks:!1,position:{at:"center center",of:b.getElement(),my:"center center",using:function(b){a(this).css({position:"absolute",
top:b.top,left:b.left})}}},c);this.selection=function(){var a;document.selection?a=document.selection.createRange():document.getSelection().rangeCount&&(a=document.getSelection().getRangeAt(0));return a};this.show=function(){b.isEditing()||(b.getElement().addClass(c.baseClass+"-highlight"),b.getElement().addClass(c.baseClass+"-hover"),e.position(c.position),e.addClass(c.baseClass+"-visible"))};this.hide=function(){b.getElement().removeClass(c.baseClass+"-highlight");b.getElement().removeClass(c.baseClass+
"-hover");e.removeClass(c.baseClass+"-visible")};this.edit=function(){d.hide();b.isEditing()||b.enableEditing();b.isVisible()||b.showToolbar(d.selection())};e.position(c.position);c.obscureLinks||(b.getElement().find("a").bind("mouseenter."+b.widgetName,d.hide),b.getElement().find("a").bind("mouseleave."+b.widgetName,d.show));b.getElement().bind("mouseenter."+b.widgetName,d.show);b.getElement().bind("mouseleave."+b.widgetName,d.hide);b.getElement().bind("click."+b.widgetName,function(b){(c.obscureLinks||
!a(b.target).is("a")&&!a(b.target).parents("a").length)&&d.edit()});b.bind("destroy",function(){e.remove();b.getElement().unbind("mouseenter."+b.widgetName,d.show);b.getElement().unbind("mouseleave."+b.widgetName,d.hide);b.getElement().unbind("click."+b.widgetName,d.edit)})}});a.ui.editor.registerPlugin("dock",{enabled:!1,docked:!1,topSpacer:null,bottomSpacer:null,options:{docked:!1,dockToElement:!1,dockUnder:!1,persist:!0,persistID:null},init:function(){this.bind("show",this.show);this.bind("hide",
this.hide);this.bind("disabled",this.disable);this.bind("destroy",this.destroy,this)},show:function(){this.enabled?this.isDocked()&&this.showSpacers():((this.loadState()||this.options.docked)&&this.dock(),this.enabled=!0)},hide:function(){this.hideSpacers();this.editor.toolbar.css("width","auto")},showSpacers:function(){!this.options.dockToElement&&this.editor.toolbar.is(":visible")&&(this.topSpacer=a("<div/>").addClass(this.options.baseClass+"-top-spacer").height(this.editor.toolbar.outerHeight()).prependTo("body"),
...
a(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:f("Paste Embed Code"),autoOpen:!0,dialogClass:b.options.baseClass+" "+b.options.dialogClass,buttons:[{text:f("Embed Object"),click:function(){q();w(a(this).find("textarea").val());a(this).dialog("close")}},{text:f("Close"),click:function(){b.hide()}}],open:function(){var b=a(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});
...
a.ui.editor.registerPlugin("emptyElement",{options:{tag:"<p/>"},init:function(){this.bind("change",this.change)},change:function(){var b=this;this.textNodes(this.editor.getElement()).each(function(){a(this).wrap(a(b.options.tag));z(this,void 0,!1)});this.editor.checkChange()},textNodes:function(b){return a(b).contents().filter(function(){return 3==this.nodeType&&a.trim(this.nodeValue).length})}});a(function(){a.ui.editor.registerUi({insertFile:{fileManager:null,imageTypes:["jpg","jpeg","png","gif"],
init:function(b,c){return b.uiButton({title:"Insert image or uploaded file",icon:"ui-icon-image",click:function(){var b=this;p();null===this.fileManager&&(this.fileManager=a.ui.filemanager.create({enablePlugins:!1,plugins:{datatables:!XMod.FileManager.Permissions.insert?!1:{ajaxSource:"/filemanager/admin/datatables",insertionCallback:function(d){q();if(!d.length)return true;var e=function(){b.editor.fire("change");return true};if(d.length===1){var f=d[0];if(b.isImage(f)){w(b.createImage(f,c.cssPrefix+
f.type));return e()}if(b.editor.selectionExists()){R("a",{href:f.url,className:b.options.cssPrefix+"file "+b.options.cssPrefix+f.type});return e()}w(b.createAnchor(f,b.options.cssPrefix+"file "+b.options.cssPrefix+f.type));return e()}for(var g=[],k=0;k<d.length;k++){f=d[k];b.isImage(f)?g.push(a("<div/>").html(b.createImage(f,c.cssPrefix+f.type)).html()):g.push(a("<div/>").html(b.createAnchor(f,b.options.cssPrefix+"file "+b.options.cssPrefix+f.type)).html())}w(g.join(", "));return e()}},plupload:!XMod.FileManager.Permissions.upload?
!1:{url:"/filemanager/admin/plupload"}}}));a(this.fileManager).filemanager("show")}})},isImage:function(b){return-1!==a.inArray(b.type.toLowerCase(),this.imageTypes)?!0:!1},createImage:function(b,c){return a("<img/>").attr({src:b.url,title:b.name,"class":c})},createAnchor:function(b,c){return a("<a/>").attr({href:b.url,title:b.name,"class":c}).html(b.name)}}})});a.ui.editor.registerUi({floatLeft:{init:function(b){return b.uiButton({title:f("Float Image Left"),click:function(){x(function(b){a(b.commonAncestorContainer).find("img").css("float",
"left")})}})}},floatRight:{init:function(b){return b.uiButton({title:f("Float Image Right"),click:function(){x(function(b){a(b.commonAncestorContainer).find("img").css("float","right")})}})}},floatNone:{init:function(b){return b.uiButton({title:f("Remove Image Float"),click:function(){x(function(b){a(b.commonAncestorContainer).find("img").css("float","none")})}})}}});a.ui.editor.registerUi({fontSizeInc:{init:function(a,b){return a.uiButton({title:f("Increase Font Size"),click:function(){a.inverseWrapWithTagClass("big",
...
"-visible")}}});a.ui.editor.registerUi({undo:{options:{disabled:!0},hotkeys:{"ctrl+z":{action:function(){this.editor.historyBack()}}},init:function(a){a.bind("change",this.change,this);return a.uiButton({title:f("Step Back"),click:function(){a.historyBack()}})},change:function(){0===this.editor.present?this.ui.disable():this.ui.enable()}},redo:{options:{disabled:!0},hotkeys:{"ctrl+shift+z":{action:function(){this.editor.historyForward()}},"ctrl+y":{action:function(){this.editor.historyForward()}}},
init:function(a){a.bind("change",this.change,this);return this.ui=a.uiButton({title:f("Step Forward"),click:function(){a.historyForward()}})},change:function(){this.editor.present===this.editor.history.length-1?this.ui.disable():this.ui.enable()}}});a.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:f("Insert Horizontal Rule"),click:function(){w("<hr/>")}})}}});a.ui.editor.registerUi({i18n:{init:function(b){var c=this,d=this.persist("locale");d&&i(d);var d=a('<select autocomplete="off" name="i18n"/>'),
e;for(e in J){var g=a('<option value="'+e+'" class="'+e+'"/>');g.html(u[e]);P===e&&g.attr("selected","selected");d.append(g)}return b.uiSelectMenu({title:f("Change Language"),select:d,change:function(a){i(c.persist("locale",a))}})}}});g("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"Apply Source","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",
...
"Left Align":"Alinear a la Izquierda","Link to a document or other file":"Enlazar a un documento o a otro archivo","Link to a page on this or another website":"Enlazar a una p\u00e1gina en esta u otra p\u00e1gina web","Link to an email address":"Enlazar a una direcci\u00f3n de correo electr\u00f3nico",Location:"Localizaci\u00f3n","Modify Image Size":"Cambiar Tama\u00f1o de Imagen","N/A":"N/A","New window":"Nueva ventana","No changes detected to save...":"No se detectaron cambios para guardar...",
"Not sure what to put in the box above?":"\u00bfNo est\u00e1 seguro de qu\u00e9 poner en la caja anterior?",OK:"Aceptar","Open the uploaded file in your browser":"Abra el archivo cargado en su navegador","Ordered List":"Lista Ordenada","Page on this or another website":"P\u00e1gina en \u00e9sta u otra p\u00e1gina web",Paragraph:"P\u00e1rrafo","Paste Embed Code":"Pegar C\u00f3digo Incrustado","Paste your embed code into the text area below.":"Pegue su c\u00f3digo incrustado en la caja de texto posterior.",
"Plain Text":"Texto Llano",Preview:"Previsualizar",Raptorize:"Raptorizar",Reinitialise:"Reinicializar","Remaining characters before the recommended character limit is reached":"Car\u00e1cteres restantes antes de que se alcance el l\u00edmite de c\u00e1racteres recomendado","Remove Image Float":"No Flotar Imagen","Remove Link":"Eliminar enlace","Remove unnecessary markup from editor content":"Eliminar marcado innecesario del editor de contenido","Resize Image":"Redimensionar Imagen","Right Align":"Alinear a la Derecha",
Save:"Guardar","Saved {{saved}} out of {{dirty}} content blocks.":"Guardados {{saved}} de {{dirty}} bloques de contenido.","Saving changes...":"Guardando cambios...","Select all editable content":"Seleccionar todo el contenido editable","Select {{element}} element":"Seleccionar el elemento {{element}}","Show Guides":"Mostrar Gu\u00edas","Source Code":"C\u00f3digo Fuente","Step Back":"Deshacer","Step Forward":"Rehacer",Strikethrough:"Tachado","Sub script":"Sub\u00edndice","Subject (optional)":"Sujeto (opcional)",
...
g("fr","Fran\u00e7ais",{"A preview of your embedded object is displayed below.":"Un aper\u00e7u de votre objet int\u00e9gr\u00e9 est affich\u00e9 ci-dessous.","Added link: {{link}}":"Lien ajout\u00e9 : {{link}}","All changes will be lost!":"Toutes les modifications seront perdues !","Apply Source":"Appliquer la source","Are you sure you want to stop editing?":"\u00cates-vous s\u00fbr(e) de vouloir arr\u00eater la modification ?",Blockquote:"Citation",Bold:"Gras",Cancel:"Annuler","Center Align":"Aligner au centre",
...
"Check this box to have the link open in a new browser window":"Check this box to have the link open in a new browser window","Choose a link type:":"Choose a link type:","Clear Formatting":"Clear Formatting","Click to begin editing":"Click to begin editing","Click to detach the toolbar":"Click to detach the toolbar","Click to dock the toolbar":"Click to dock the toolbar","Click to select all editable content":"Click to select all editable content","Click to select the contents of the '{{element}}' element":"Click to select the contents of the '{{element}}' element",
...
"Sub script":"Sub script","Subject (optional)":"Subject (optional)","Successfully saved {{saved}} content block(s).":"Successfully saved {{saved}} content block(s).","Super script":"Super script","The URL does not look well formed":"The URL does not look well formed","The email address does not look well formed":"The email address does not look well formed","The image '{{image}}' is too large for the element being edited.<br/>It will be replaced with a resized copy when your edits are saved.":"The image '{{image}}' is too large for the element being edited.<br/>It will be replaced with a resized copy when your edits are saved.",
...
"{{characters}} characters, {{charactersRemaining}} over the recommended limit":"{{characters}} characters, {{charactersRemaining}} over the recommended limit","{{characters}} characters, {{charactersRemaining}} remaining":"{{characters}} characters, {{charactersRemaining}} remaining","{{sentences}} sentences":"{{sentences}} sentences","{{words}} word":"{{words}} word","{{words}} words":"{{words}} words"});a.ui.editor.registerPlugin("imageResize",{options:{allowOversizeImages:!1,manuallyResizingClass:"",
resizeButtonClass:"",resizingClass:""},init:function(b){this.options=a.extend(this.options,{manuallyResizingClass:this.options.baseClass+"-manually-resize",resizeButtonClass:this.options.baseClass+"-resize-button",resizingClass:this.options.baseClass+"-in-progress"});b.bind("enabled",this.bind,this)},bind:function(){this.options.allowOversizeImages||(this.addImageListeners(),this.editor.bind("change",this.scanForOversizedImages,this),this.editor.bind("save",this.save,this));this.editor.bind("destroy",
...
this.removeToolsButtons();this.unbind()},showOversizeWarning:function(a,b){this.editor.showInfo(f("The image '{{image}}' is too large for the element being edited.<br/>It will be replaced with a resized copy when your edits are saved.",{image:a}),b)},removeClasses:function(b){b||(b=[this.options.resizingClass,this.options.manuallyResizingClass]);a.isArray(b)||(b=[b]);for(var c=0;c<b.length;c++)this.editor.getElement().find("img."+b[c]).removeClass(b[c])},manuallyResizeImage:function(){this.removeToolsButtons();
var b=this.editor.getElement().find("img."+this.options.manuallyResizingClass),c=a(b).innerWidth(),d=a(b).innerHeight(),e="#"+this.options.baseClass+"-width",g="#"+this.options.baseClass+"-height",h=this,i=function(c){c=Math.round(c||a(e).val())+"px";a(b).css({width:c})},j=a(this.editor.getTemplate("imageresize.manually-resize-image",{width:c,height:d,baseClass:this.options.baseClass}));j.dialog({modal:!0,resizable:!1,title:f("Modify Image Size"),autoOpen:!0,buttons:[{text:f("Resize Image"),click:function(){i();
a(this).dialog("close")}},{text:f("Cancel"),click:function(){a(this).dialog("close")}}],close:function(){i(c);h.editor.checkChange();a(j).remove()},open:function(){var b=a(this).find(e),f=a(this).find(g);b.keyup(function(){f.val(Math.round(Math.abs(d/c*a(this).val())));i()});f.keyup(function(){b.val(Math.round(Math.abs(c/d*a(this).val())));i()})}})},displayToolsButtonRelativeToImage:function(b){var c=a("<button/>").appendTo("body").addClass(this.options.resizeButtonClass).button({text:!1,icons:{primary:"ui-icon-tools"}});
c.css({position:"absolute",left:a(b).position().left+a(b).innerWidth()-a(c).outerWidth()-10+"px",marginTop:"10px"}).click(a.proxy(this.manuallyResizeImage,this));a(b).before(c)},removeToolsButtons:function(){this.editor.getElement().find("."+this.options.resizeButtonClass).each(function(){a(this).remove()})},imageMouseEnter:function(b){a(b.target).addClass(this.options.manuallyResizingClass);this.displayToolsButtonRelativeToImage(b.target)},imageMouseLeave:function(b){a(b.relatedTarget).hasClass(this.options.resizeButtonClass)||
(a(b.target).removeClass(this.options.manuallyResizingClass),this.removeToolsButtons())}});a.ui.editor.registerUi({length:{ui:null,options:{length:150},init:function(b){b.bind("show",a.proxy(this.updateCount,this));b.bind("change",a.proxy(this.updateCount,this));return this.ui=this.editor.uiButton({title:f("Remaining characters before the recommended character limit is reached"),label:f("Initializing"),text:!0,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var b=
this.options.length-a("<div/>").html(this.editor.getCleanHtml()).text().length,c=this.ui.button,d=null,d=0<=b?f("{{charactersRemaining}} characters remaining",{charactersRemaining:b}):f("{{charactersRemaining}} characters over limit",{charactersRemaining:-1*b});c.button("option","label",d);c.button("option","text",!0);0>b?c.addClass("ui-state-error"):0<=b&&15>=b?c.addClass("ui-state-highlight").removeClass("ui-state-error"):c.removeClass("ui-state-highlight ui-state-error")},showStatistics:function(){this.processTemplate().dialog({modal:!0,
resizable:!1,title:f("Content Statistics"),dialogClass:this.editor.options.dialogClass+" "+this.editor.options.baseClass,show:this.editor.options.dialogShowAnimation,hide:this.editor.options.dialogHideAnimation,buttons:[{text:f("OK"),click:function(){a(this).dialog("close")}}],open:function(){a(this).parent().find(".ui-dialog-buttonpane").find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}})},close:function(){a(this).dialog("destroy").remove()}})},processTemplate:function(){var b=
a("<div/>").html(this.editor.getCleanHtml()).text(),c=null,d=this.options.length-b.length,c=0>d?f("Content contains more than {{limit}} characters and may be truncated",{limit:this.options.length}):f("Content will not be truncated"),e=null,e=b.split(" ").length,e=1==e?f("{{words}} word",{words:e}):f("{{words}} words",{words:e}),g=null,g=b.split(". ").length,g=f("{{sentences}} sentences",{sentences:g}),h=null,h=0<=d?f("{{characters}} characters, {{charactersRemaining}} remaining",{characters:b.length,
charactersRemaining:d}):f("{{characters}} characters, {{charactersRemaining}} over the recommended limit",{characters:b.length,charactersRemaining:-1*d});return a(this.editor.getTemplate("length.dialog",{characters:h,words:e,sentences:g,truncation:c}))}}});a.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:f("Page on this or another website"),focusSelector:'input[name="location"]',init:function(){this.content=this.plugin.editor.getTemplate("link.external",
this.options);return this},show:function(a,b){var c=this;a.find('input[name="location"]').bind("keyup",function(){c.validate(a)});b&&(a.find('input[name="location"]').val(this.plugin.selectedElement.attr("href")).trigger("keyup"),"_blank"===this.plugin.selectedElement.attr("target")&&a.find('input[name="blank"]').attr("checked","checked"));return this},attributes:function(a){var b={href:a.find('input[name="location"]').val()};a.find('input[name="blank"]').is(":checked")&&(b.target="_blank");this.options.regexLink.test(b.href)||
this.plugin.editor.showWarning(f("The url for the link you inserted doesn't look well formed"));return b},validate:function(b){var c="."+this.options.baseClass+"-error-message-url",d=!0;this.options.regexLink.test(b.find('input[name="location"]').val())?b.find(c).has(":visible").hide():(b.find(c).size()||b.find('input[name="location"]').after(this.plugin.editor.getTemplate("link.error",a.extend({},this.options,{messageClass:this.options.baseClass+"-error-message-url",message:f("The URL does not look well formed")}))),
...
(b.find(c).size()||b.find('input[name="email"]').after(this.plugin.editor.getTemplate("link.error",a.extend({},this.options,{messageClass:this.options.baseClass+"-error-message-email",message:f("The email address does not look well formed")}))),b.find(c).not(":visible").show(),d=!1);return d}},{type:"fileUrl",title:f("Document or other file"),focusSelector:'input[name="location"]',init:function(){this.content=this.plugin.editor.getTemplate("link.file-url",this.options);return this},show:function(a,
b){var c=this;a.find('input[name="location"]').bind("keyup",function(){c.validate(a)});b&&(a.find('input[name="location"]').val(this.plugin.selectedElement.attr("href")).trigger("click"),"_blank"===this.plugin.selectedElement.attr("target")&&a.find('input[name="blank"]').attr("checked","checked"));return this},attributes:function(a){var b={href:a.find('input[name="location"]').val()};a.find('input[name="blank"]').is(":checked")&&(b.target="_blank");this.options.regexLink.test(b.href)||this.plugin.editor.showWarning(f("The url for the file you inserted doesn't look well formed"));
return b},validate:function(b){var c="."+this.options.baseClass+"-error-message-file-url",d=!0;this.options.regexLink.test(b.find('input[name="location"]').val())?b.find(c).has(":visible").hide():(b.find(c).size()||b.find('input[name="location"]').after(this.plugin.editor.getTemplate("link.error",a.extend({},this.options,{messageClass:this.options.baseClass+"-error-message-file-url",message:f("The URL does not look well formed")}))),b.find(c).not(":visible").show(),d=!1);return d}}],init:function(b,
...
this.options.customTypes),d,e=0;e<c.length;e++)d=a.extend({},b,c[e],{classes:this.options.baseClass+"-"+c[e].type}).init(),this.types[d.type]=d},show:function(){if(!this.visible){p();this.selectedElement=H().first();var b=this.selectedElement.is("a"),c=this.options,d=this,e=this.dialog=a(this.editor.getTemplate("link.dialog",c)).appendTo("body");this.initTypes();var g=this.dialog.find("fieldset"),h;for(h in this.types)a(this.editor.getTemplate("link.label",this.types[h])).appendTo(g);g.find('input[type="radio"]').bind("change."+
this.editor.widgetName,function(){d.typeChange(d.types[a(this).val()],b)});e.dialog({autoOpen:!1,modal:!0,resizable:!0,width:c.dialogWidth,minWidth:c.dialogMinWidth,height:c.dialogHeight,title:b?f("Edit Link"):f("Insert Link"),dialogClass:c.baseClass+" "+c.dialogClass,buttons:[{text:b?f("Update Link"):f("Insert Link"),click:function(){q();d.apply(b)&&a(this).dialog("close")}},{text:f("Cancel"),click:function(){a(this).dialog("close")}}],beforeopen:function(){d.dialog.find("."+d.options.baseClass+
...
b&&!g)&&d.typeChange(d.types[f.filter(":checked").val()],b);a(this).unbind("keyup."+d.editor.widgetName).bind("keyup."+d.editor.widgetName,function(b){13==b.keyCode&&(b=d.types[f.filter(":checked").val()],(!a.isFunction(b.validate)||b.validate(d.dialog.find("."+d.options.baseClass+"-content")))&&c.find("button:eq(0)").trigger("click"))})},close:function(){q();d.visible=!1;e.find("."+c.baseClass+"-content").hide();a(this).dialog("destroy")}}).dialog("open")}},apply:function(b){var c=this.types[this.dialog.find('input[type="radio"]:checked').val()],
d=c.attributes(this.dialog.find("."+this.options.baseClass+"-content"),b);if(!d)return!0;q();var e=l(a("<a>"+(d.title?d.title:d.href)+"</a>").attr(a.extend({},d,{target:"_blank"})));b?(this.selectedElement[0].className=this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(c.classes).attr(d),this.editor.showConfirm(f("Updated link: {{link}}",{link:e}))):(R("a",a.extend(d,{id:this.editor.getUniqueId()}),c.classes),this.editor.showConfirm(f("Added link: {{link}}",
{link:e})),this.selectedElement=a("#"+d.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",d.href);E(this.selectedElement);p();return!0},typeChange:function(b,c){var d=this.dialog.find("."+this.options.baseClass+"-content"),e=d.closest("."+this.options.baseClass+"-wrap"),f=b.ajaxUri&&!this.types[b.type].content;f&&e.addClass(this.options.baseClass+"-loading");var g=this;d.hide(this.options.panelAnimation,function(){f?a.ajax({url:b.ajaxUri,type:"get",success:function(f){d.html(f);
...
cancel:function(){this.dialog&&a(this.dialog.dialog("close"))}});a.ui.editor.registerUi({link:{hotkeys:{"ctrl+l":{action:function(){this.editor.getPlugin("link").show()},restoreSelection:!1}},init:function(a){a.bind("selectionChange",this.change,this);return a.uiButton({title:f("Insert Link"),click:function(){a.getPlugin("link").show()}})},change:function(){H().length?this.ui.enable():this.ui.disable()}},unlink:{hotkeys:{"ctrl+shift+l":{action:function(){this.ui.click()},restoreSelection:!1}},init:function(a){a.bind("selectionChange",
this.change,this);a.bind("show",this.change,this);return a.uiButton({title:f("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){H().is("a")?this.ui.enable():this.ui.disable()}}});a.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),
toggleList:function(b){a(H()).is("li")&&a(H()).parent().is(b)?this.unwrapList():this.wrapList(b);this.editor.fire("selectionChange");this.editor.fire("change")},unwrapList:function(){p();var b=[],c=[],d=D(),e=v();b.push(a(d).html());c.push(d);if(a(d)[0]!==a(e)[0]){var f=d;do f=a(f).next(),b.push(a(f).html()),c.push(f);while(a(f)[0]!==a(e)[0])}f=0===a(d).prev().length;e=0===a(e).next().length;d=a(d).parent();for(listElementsIndex=0;listElementsIndex<c.length;listElementsIndex++)a(c[listElementsIndex]).remove();
for(c=0;c<b.length;c++)d.parent().is("li")||(b[c]="<p>"+b[c]+"</p>");f&&e?(d.replaceWith(b.join("")),q(),b=H()[0],E(b)):(f?a(d).before(b.join("")):e?a(d).after(b.join("")):h(b.join("")),q(),this.editor.checkChange())},wrapList:function(b){this.editor.constrainSelection(this.editor.getElement());""===a.trim(C())&&A(H());var c=a("<div>").html(C()),d=[],e=this;a(c).contents().each(function(){var b;b="block"===o(this.tagName)?Q(a(this).html(),e.validChildren):Q(l(a(this)),e.validChildren);b=a("<li>"+
b+"</li>");""!==a.trim(b.text())&&d.push(l(b))});c=this.options.baseClass+"-selection";b="<"+b+' class="'+c+'">'+d.join("")+"</"+b+">";q();var f=a(H()[0]).parent(),g=this.editor.getElement()[0];f===g||H()[0]===g?w(b):S(b,this.validParents);c=a(this.editor.getElement().find("."+c).removeClass(c));A(c.find("li:first")[0]);this.editor.checkChange()},toggleButtonState:function(b,c){var d=function(a){c.button.toggleClass("ui-state-highlight",a).toggleClass("ui-state-default",!a)},e=D();if(null===e||!e.length)e=
this.editor.getElement();var f=v();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(a(e).is(b)&&a(f).is(b)&&e===f)return d(!0);var g=a(e).parentsUntil(h,b).first()&&a(f).parentsUntil(h,b).first(),h="#"+this.editor.getElement().attr("id"),i=a(e).is(b+" > li")||a(e).parentsUntil(h,b+" > li").length,j=a(f).is(b+" > li")||a(f).parentsUntil(h,b+" > li").length;if(i&&j&&g){g=a(s());g.is(b)||(g=a(g).parentsUntil(h,b).first());h=g.find("ul, ol");if(!h.length)return d(!0);for(g=0;g<h.length;g++)if(a.contains(h[g],
e)&&a.contains(h[g],f))return d(!1);return d(!0)}return d(!1)}});a.ui.editor.registerUi({listUnordered:{init:function(a){var b=a.uiButton({title:f("Unordered List"),click:function(){a.getPlugin("list").toggleList("ul")}});a.bind("selectionChange",function(){a.getPlugin("list").toggleButtonState("ul",b)});return b}},listOrdered:{init:function(a){var b=a.uiButton({title:f("Ordered List"),click:function(){a.getPlugin("list").toggleList("ol")}});a.bind("selectionChange",function(){a.getPlugin("list").toggleButtonState("ol",
b)});return b}}});a.ui.editor.registerUi({logo:{ui:null,init:function(){return this.ui=this.editor.uiButton({title:f("Learn More About the Raptor WYSIWYG Editor"),click:function(){c.open("http://www.jquery-raptor.com/about/editors/","_blank")},ready:function(){var b=function(c){var d=typeof c;if("object"!=d||null===c)return"string"==d&&(c='"'+c+'"'),""+c;var e=[],f=c&&a.isArray(c);a.each(c,function(a,c){d=typeof c;"string"==d?c='"'+c+'"':"object"==d&null!==c&&(c=b(c));e.push((f?"":'"'+a+'":')+(""+
c))});return(f?"[":"{")+(""+e)+(f?"]":"}")},c={enableUi:this.options.enableUi,enablePlugins:this.options.enablePlugins,disabledPlugins:b(this.options.disabledPlugins),ui:b(this.options.ui),t:(new Date).getTime()},d=[],e;for(e in c)d.push(e+"="+encodeURIComponent(c[e]));this.ui.button.find(".ui-button-icon-primary").css({"background-image":"url(http://www.jquery-raptor.com/logo/0.0.13?"+d.join("&")+")"})}})}}});a.ui.editor.registerPlugin("normaliseLineBreaks",{options:{enter:"<p><br/></p>",enterValidTags:"address,blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),
shiftEnter:"<br/>",shiftEnterValidTags:"a,abbr,acronym,address,applet,b,bdo,big,blockquote,body,button,caption,center,cite,code,dd,del,dfn,div,dt,em,fieldset,font,form,h1,h2,h3,h4,h5,h6,i,iframe,ins,kbd,label,legend,li,noframes,noscript,object,p,pres,q,s,samp,small,span,strike,strong,sub,sup,td,th,tt,u,var".split(",")},hotkeys:{"return":{action:function(){this.insertBreak(this.options.enter,this.options.enterValidTags)},restoreSelection:!1},"return+shift":{action:function(){this.insertBreak(this.options.shiftEnter,
this.options.shiftEnterValidTags)},restoreSelection:!1}},insertBreak:function(b,c){M=!1;var d=this.options.baseClass+"-enter-break",e=a(b).attr("id",d).appendTo("body");c?S(e,c):w(e);d=a("#"+d).removeAttr("id").next();z(d,void 0,!0)}});a.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span,hr,br".split(","),allowedAttributes:["href","title"],allowedEmptyTags:["hr","br"]},init:function(b,d){var e=!1,g=!1,h=this;b.getElement().bind("paste."+b.widgetName,
a.proxy(function(){if(e)return!1;e=!0;p();a(".uiWidgetEditorPasteBin").length&&a(".uiWidgetEditorPasteBin").remove();a('<div class="uiWidgetEditorPasteBin" contenteditable="true" style="width: 1px; height: 1px; overflow: hidden; position: fixed; top: -1px;" />').appendTo("body");a(".uiWidgetEditorPasteBin").focus();c.setTimeout(function(){var c=a(".uiWidgetEditorPasteBin").html(),c=h.filterAttributes(c),c=h.filterChars(c),c=h.stripEmpty(c),c=h.stripAttributes(c),c=Q(c,h.options.allowedTags),c={plain:a("<div/>").html(a(".uiWidgetEditorPasteBin").html()).text(),
markup:c,html:a(".uiWidgetEditorPasteBin").html()};g=a(b.getTemplate("paste.dialog",c));g.find(".ui-editor-paste-area").bind("keyup."+b.widgetname,function(){h.updateAreas(this,g)});a(g).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:d.dialogShowAnimation,hide:d.dialogHideAnimation,dialogClass:d.baseClass+" "+d.dialogClass,buttons:[{text:f("Insert"),click:function(){var b=null,b=a(this).find(".ui-editor-paste-area:visible"),b=b.hasClass("ui-editor-paste-plain")||
b.hasClass("ui-editor-paste-source")?b.val():b.html(),b=h.filterAttributes(b),b=h.filterChars(b);q();w(b);e=!1;a(this).dialog("close")}},{text:f("Cancel"),click:function(){q();e=!1;a(this).dialog("close")}}],open:function(){var b=a(this).find(".ui-editor-paste-panel-tabs");b.find("ul.ui-tabs-nav li").click(function(){b.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");a(this).addClass("ui-state-active").addClass("ui-tabs-selected");b.children("div").hide().eq(a(this).index()).show()});
