/*! VERSION: 0.0.11 *//*
 ...
 Build date: 26 February 2012
*/
window.rangy=function(){function a(a,b){var c=typeof a[b];return c==l||!!(c==j&&a[b])||"unknown"==c}function c(a,b){return!!(typeof a[b]==j&&a[b])}function d(a,b){return typeof a[b]!=p}function e(a){return function(b,c){for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0}}function f(a){return a&&o(a,s)&&y(a,r)}function i(a){window.alert("Rangy not supported in your browser. Reason: "+a);w.initialized=!0;w.supported=!1}function g(){if(!w.initialized){var b,d=!1,e=!1;a(document,"createRange")&&
(b=document.createRange(),o(b,m)&&y(b,n)&&(d=!0),b.detach());if((b=c(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(b,"createTextRange"))b=b.createTextRange(),f(b)&&(e=!0);!d&&!e&&i("Neither Range nor TextRange are implemented");w.initialized=!0;w.features={implementsDomRange:d,implementsTextRange:e};d=E.concat(A);e=0;for(b=d.length;e<b;++e)try{d[e](w)}catch(j){c(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
j)}}}function b(a){this.name=a;this.supported=this.initialized=!1}var j="object",l="function",p="undefined",n="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer,START_TO_START,START_TO_END,END_TO_START,END_TO_END".split(","),m="setStart,setStartBefore,setStartAfter,setEnd,setEndBefore,setEndAfter,collapse,selectNode,selectNodeContents,compareBoundaryPoints,deleteContents,extractContents,cloneContents,insertNode,surroundContents,cloneRange,toString,detach".split(","),
r="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),s="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),o=e(a),q=e(c),y=e(d),w={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:a,isHostObject:c,isHostProperty:d,areHostMethods:o,areHostObjects:q,areHostProperties:y,isTextRange:f},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
w.fail=i;w.warn=function(a){a="Rangy warning: "+a;w.config.alertOnWarn?window.alert(a):typeof window.console!=p&&typeof window.console.log!=p&&window.console.log(a)};({}).hasOwnProperty?w.util.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])}:i("hasOwnProperty not supported");var A=[],E=[];w.init=g;w.addInitListener=function(a){w.initialized?a(w):A.push(a)};var z=[];w.addCreateMissingNativeApiListener=function(a){z.push(a)};w.createMissingNativeApi=function(a){a=a||window;g();
for(var b=0,c=z.length;b<c;++b)z[b](a)};b.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};b.prototype.warn=function(a){w.warn("Module "+this.name+": "+a)};b.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};w.createModule=function(a,c){var d=new b(a);w.modules[a]=d;E.push(function(a){c(a,d);d.initialized=!0;d.supported=!0})};w.requireModules=function(a){for(var c=0,d=a.length,f,e;c<
d;++c){e=a[c];f=w.modules[e];if(!f||!(f instanceof b))throw Error("Module '"+e+"' not found");if(!f.supported)throw Error("Module '"+e+"' not supported");}};var C=!1,q=function(){C||(C=!0,w.initialized||g())};if(typeof window==p)i("No window found");else if(typeof document==p)i("No document found");else return a(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",q,!1),a(window,"addEventListener")?window.addEventListener("load",q,!1):a(window,"attachEvent")?window.attachEvent("onload",
...
null}};p.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+j(this.node)+":"+this.offset+")]"}};n.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};n.prototype.toString=function(){return this.message};a.dom={arrayContains:o,isHtmlNamespace:function(a){var b;return typeof a.namespaceURI==m||null===(b=a.namespaceURI)||"http://www.w3.org/1999/xhtml"==
b},parentElement:function(a){a=a.parentNode;return 1==a.nodeType?a:null},getNodeIndex:d,getNodeLength:function(a){var b;return i(a)?a.length:(b=a.childNodes)?b.length:0},getCommonAncestor:e,isAncestorOf:function(a,b,c){for(b=c?b:b.parentNode;b;){if(b===a)return!0;b=b.parentNode}return!1},getClosestAncestorIn:f,isCharacterDataNode:i,insertAfter:g,splitDataNode:function(a,b){var c=a.cloneNode(!1);c.deleteData(0,b);a.deleteData(b,a.length-b);g(c,a);return c},getDocument:b,getWindow:function(a){a=b(a);
...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(a){return r.isHostObject(a,"body")?a.body:a.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var b;b=a.parentNode;)a=b;return a},comparePoints:function(a,b,c,j){var g;if(a==c)return b===j?0:b<j?-1:1;if(g=f(c,a,!0))return b<=d(g)?-1:1;if(g=f(a,c,!0))return d(g)<j?-1:1;b=e(a,c);a=a===b?b:f(a,b,!0);c=c===b?b:f(c,b,!0);if(a===c)throw Error("comparePoints got to case 4 and childA and childB are the same!");
for(b=b.firstChild;b;){if(b===a)return-1;if(b===c)return 1;b=b.nextSibling}throw Error("Should not be here!");},inspectNode:j,fragmentFromNodeChildren:function(a){for(var c=b(a).createDocumentFragment(),d;d=a.firstChild;)c.appendChild(d);return c},createIterator:function(a){return new l(a)},DomPosition:p};a.DOMException=n});
rangy.createModule("DomRange",function(a){function c(a,b){return 3!=a.nodeType&&(u.isAncestorOf(a,b.startContainer,!0)||u.isAncestorOf(a,b.endContainer,!0))}function d(a){return u.getDocument(a.startContainer)}function e(a,b,c){if(b=a._listeners[b])for(var d=0,h=b.length;d<h;++d)b[d].call(a,{target:a,args:c})}function f(a){return new I(a.parentNode,u.getNodeIndex(a))}function i(a){return new I(a.parentNode,u.getNodeIndex(a)+1)}function g(a,b,c){var d=11==a.nodeType?a.firstChild:a;u.isCharacterDataNode(b)?
...
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function o(a,b,c){this.nodes=n(a,b,c);this._next=this.nodes[0];this._position=0}function q(a){return function(b,c){for(var d,h=c?b:b.parentNode;h;){d=h.nodeType;if(u.arrayContains(a,d))return h;h=h.parentNode}return null}}function y(a,b){if(V(a,b))throw new s("INVALID_NODE_TYPE_ERR");}function w(a){if(!a.startContainer)throw new G("INVALID_STATE_ERR");}function A(a,b){if(!u.arrayContains(b,a.nodeType))throw new s("INVALID_NODE_TYPE_ERR");
}function E(a,b){if(0>b||b>(u.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new G("INDEX_SIZE_ERR");}function z(a,b){if(K(a,!0)!==K(b,!0))throw new G("WRONG_DOCUMENT_ERR");}function C(a){if(N(a,!0))throw new G("NO_MODIFICATION_ALLOWED_ERR");}function F(a,b){if(!a)throw new G(b);}function H(a){return!!a.startContainer&&!!a.endContainer&&!(!u.arrayContains(k,a.startContainer.nodeType)&&!K(a.startContainer,!0))&&!(!u.arrayContains(k,a.endContainer.nodeType)&&!K(a.endContainer,!0))&&a.startOffset<=
(u.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(u.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function D(a){w(a);if(!H(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function v(){}function M(a){a.START_TO_START=fa;a.START_TO_END=ga;a.END_TO_END=ta;a.END_TO_START=ka;a.NODE_BEFORE=ha;a.NODE_AFTER=la;a.NODE_BEFORE_AND_AFTER=ma;a.NODE_INSIDE=
ia}function R(a){M(a);M(a.prototype)}function h(a,b){return function(){D(this);var c=this.startContainer,d=this.startOffset,h=this.commonAncestorContainer,k=new r(this,!0);c!==h&&(c=u.getClosestAncestorIn(c,h,!0),d=i(c),c=d.node,d=d.offset);j(k,C);k.reset();h=a(k);k.detach();b(this,c,d,c,d);return h}}function S(b,d,e){function j(a,b){return function(c){w(this);A(c,L);A(O(c),k);c=(a?f:i)(c);(b?g:x)(this,c.node,c.offset)}}function g(a,b,c){var h=a.endContainer,k=a.endOffset;if(b!==a.startContainer||
c!==a.startOffset){if(O(b)!=O(h)||1==u.comparePoints(b,c,h,k))h=b,k=c;d(a,b,c,h,k)}}function x(a,b,c){var h=a.startContainer,k=a.startOffset;if(b!==a.endContainer||c!==a.endOffset){if(O(b)!=O(h)||-1==u.comparePoints(b,c,h,k))h=b,k=c;d(a,h,k,b,c)}}b.prototype=new v;a.util.extend(b.prototype,{setStart:function(a,b){w(this);y(a,!0);E(a,b);g(this,a,b)},setEnd:function(a,b){w(this);y(a,!0);E(a,b);x(this,a,b)},setStartBefore:j(!0,!0),setStartAfter:j(!1,!0),setEndBefore:j(!0,!1),setEndAfter:j(!1,!1),collapse:function(a){D(this);
a?d(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):d(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){w(this);y(a,!0);d(this,a,0,a,u.getNodeLength(a))},selectNode:function(a){w(this);y(a,!1);A(a,L);var b=f(a),a=i(a);d(this,b.node,b.offset,a.node,a.offset)},extractContents:h(p,d),deleteContents:h(l,d),canSurroundContents:function(){D(this);C(this.startContainer);C(this.endContainer);var a=new r(this,!0),b=a._first&&
...
c=this.endContainer,h=this.endOffset,k=function(a){var b=a.nextSibling;b&&b.nodeType==a.nodeType&&(c=a,h=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},f=function(d){var k=d.previousSibling;if(k&&k.nodeType==d.nodeType){a=d;var f=d.length;b=k.length;d.insertData(0,k.data);k.parentNode.removeChild(k);a==c?(h+=b,c=a):c==d.parentNode&&(k=u.getNodeIndex(d),h==k?(c=d,h=f):h>k&&h--)}},e=!0;u.isCharacterDataNode(c)?c.length==h&&k(c):(0<h&&(e=c.childNodes[h-1])&&u.isCharacterDataNode(e)&&k(e),
e=!this.collapsed);e?u.isCharacterDataNode(a)?0==b&&f(a):b<a.childNodes.length&&(k=a.childNodes[b])&&u.isCharacterDataNode(k)&&f(k):(a=c,b=h);d(this,a,b,c,h)},collapseToPoint:function(a,b){w(this);y(a,!0);E(a,b);(a!==this.startContainer||b!==this.startOffset||a!==this.endContainer||b!==this.endOffset)&&d(this,a,b,a,b)}});R(b)}function Q(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:u.getCommonAncestor(a.startContainer,
a.endContainer)}function P(a,b,c,d,h){var k=a.startContainer!==b||a.startOffset!==c,f=a.endContainer!==d||a.endOffset!==h;a.startContainer=b;a.startOffset=c;a.endContainer=d;a.endOffset=h;Q(a);e(a,"boundarychange",{startMoved:k,endMoved:f})}function J(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};Q(this)}a.requireModules(["DomUtil"]);var u=a.dom,I=u.DomPosition,G=a.DOMException;r.prototype={_current:null,_next:null,_first:null,
...
(a===this.sc||a===this.ec)?(b=a===this.sc?this.so:0,c=a===this.ec?this.eo:a.length,b!=c&&a.deleteData(b,c-b)):a.parentNode&&a.parentNode.removeChild(a)},isPartiallySelectedSubtree:function(){return c(this._current,this.range)},getSubtreeIterator:function(){var a;if(this.isSingleCharacterDataNode)a=this.range.cloneRange(),a.collapse();else{a=new J(d(this.range));var b=this._current,c=b,h=0,k=b,f=u.getNodeLength(b);u.isAncestorOf(b,this.sc,!0)&&(c=this.sc,h=this.so);u.isAncestorOf(b,this.ec,!0)&&(k=
this.ec,f=this.eo);P(a,c,h,k,f)}return new r(a,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};s.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};s.prototype.toString=function(){return this.message};o.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
detach:function(){this._current=this._next=this.nodes=null}};var L=[1,3,4,5,7,8,10],k=[2,9,11],t=[1,3,4,5,7,8,10,11],x=[1,3,4,5,7,8],O=u.getRootContainer,K=q([9,11]),N=q([5,6,10,12]),V=q([6,10,12]),T=document.createElement("style"),aa=!1;try{T.innerHTML="<b>x</b>",aa=3==T.firstChild.nodeType}catch(Ka){}a.features.htmlParsingConforms=aa;var ja="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),fa=0,ga=1,ta=2,ka=3,ha=0,la=1,ma=2,ia=3;v.prototype={attachListener:function(a,
b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){D(this);z(this.startContainer,b.startContainer);var c=a==ka||a==fa?"start":"end",d=a==ga||a==fa?"start":"end";return u.comparePoints(this[c+"Container"],this[c+"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){D(this);A(a,t);C(this.startContainer);if(u.isAncestorOf(a,this.startContainer,!0))throw new G("HIERARCHY_REQUEST_ERR");this.setStartBefore(g(a,this.startContainer,this.startOffset))},cloneContents:function(){D(this);
...
this);a.detach();return!b},surroundContents:function(a){A(a,x);if(!this.canSurroundContents())throw new s("BAD_BOUNDARYPOINTS_ERR");var b=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);g(a,this.startContainer,this.startOffset);a.appendChild(b);this.selectNode(a)},cloneRange:function(){D(this);for(var a=new J(d(this)),b=ja.length,c;b--;)c=ja[b],a[c]=this[c];return a},toString:function(){D(this);var a=this.startContainer;if(a===this.endContainer&&u.isCharacterDataNode(a))return 3==
a.nodeType||4==a.nodeType?a.data.slice(this.startOffset,this.endOffset):"";var b=[],a=new r(this,!0);j(a,function(a){(3==a.nodeType||4==a.nodeType)&&b.push(a.data)});a.detach();return b.join("")},compareNode:function(a){D(this);var b=a.parentNode,c=u.getNodeIndex(a);if(!b)throw new G("NOT_FOUND_ERR");a=this.comparePoint(b,c);b=this.comparePoint(b,c+1);return 0>a?0<b?ma:ha:0<b?la:ia},comparePoint:function(a,b){D(this);F(a,"HIERARCHY_REQUEST_ERR");z(a,this.startContainer);return 0>u.comparePoints(a,
...
containsNodeText:function(a){var b=this.cloneRange();b.selectNode(a);var c=b.getNodes([3]);return 0<c.length?(b.setStart(c[0],0),a=c.pop(),b.setEnd(a,a.length),a=this.containsRange(b),b.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){D(this);return new o(this,a,b)},getNodes:function(a,b){D(this);return n(this,a,b)},getDocument:function(){return d(this)},collapseBefore:function(a){w(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){w(this);this.setStartAfter(a);
this.collapse(!0)},getName:function(){return"DomRange"},equals:function(a){return J.rangesEqual(this,a)},isValid:function(){return H(this)},inspect:function(){return m(this)}};S(J,P,function(a){w(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;e(a,"detach",null);a._listeners=null});a.rangePrototype=v.prototype;J.rangeProperties=ja;J.RangeIterator=r;J.copyComparisonConstants=R;J.createPrototypeRange=S;J.inspect=m;J.getRangeDocument=d;J.rangesEqual=
...
rangy.createModule("WrappedRange",function(a){function c(a,b,c,d){var e=a.duplicate();e.collapse(c);var g=e.parentElement();f.isAncestorOf(b,g,!0)||(g=b);if(!g.canHaveHTML)return new i(g.parentNode,f.getNodeIndex(g));var b=f.getDocument(g).createElement("span"),s,o=c?"StartToStart":"StartToEnd";do g.insertBefore(b,b.previousSibling),e.moveToElementText(b);while(0<(s=e.compareEndPoints(o,a))&&b.previousSibling);o=b.nextSibling;if(-1==s&&o&&f.isCharacterDataNode(o)){e.setEndPoint(c?"EndToStart":"EndToEnd",
a);if(/[\r\n]/.test(o.data)){g=e.duplicate();c=g.text.replace(/\r\n/g,"\r").length;for(c=g.moveStart("character",c);-1==g.compareEndPoints("StartToEnd",g);)c++,g.moveStart("character",1)}else c=e.text.length;g=new i(o,c)}else o=(d||!c)&&b.previousSibling,g=(c=(d||c)&&b.nextSibling)&&f.isCharacterDataNode(c)?new i(c,0):o&&f.isCharacterDataNode(o)?new i(o,o.length):new i(g,f.getNodeIndex(b));b.parentNode.removeChild(b);return g}function d(a,b){var c,d,e=a.offset,g=f.getDocument(a.node),i=g.body.createTextRange(),
o=f.isCharacterDataNode(a.node);o?(c=a.node,d=c.parentNode):(c=a.node.childNodes,c=e<c.length?c[e]:null,d=a.node);g=g.createElement("span");g.innerHTML="&#feff;";c?d.insertBefore(g,c):d.appendChild(g);i.moveToElementText(g);i.collapse(!b);d.removeChild(g);if(o)i[b?"moveStart":"moveEnd"]("character",e);return i}a.requireModules(["DomUtil","DomRange"]);var e,f=a.dom,i=f.DomPosition,g=a.DomRange;if(a.features.implementsDomRange&&(!a.features.implementsTextRange||!a.config.preferTextRange))(function(){function b(a){for(var c=
d.length,f;c--;)f=d[c],a[f]=a.nativeRange[f]}var c,d=g.rangeProperties,i;e=function(a){if(!a)throw Error("Range must be specified");this.nativeRange=a;b(this)};g.createPrototypeRange(e,function(a,b,c,d,f){var e=a.endContainer!==d||a.endOffset!=f;if(a.startContainer!==b||a.startOffset!=c||e)a.setEnd(d,f),a.setStart(b,c)},function(a){a.nativeRange.detach();a.detached=!0;for(var b=d.length,c;b--;)c=d[b],a[c]=null});c=e.prototype;c.selectNode=function(a){this.nativeRange.selectNode(a);b(this)};c.deleteContents=
...
b=null})});
rangy.createModule("WrappedSelection",function(a,c){function d(a){return(a||window).getSelection()}function e(a){return(a||window).document.selection}function f(a,b,c){var d=c?"end":"start",c=c?"start":"end";a.anchorNode=b[d+"Container"];a.anchorOffset=b[d+"Offset"];a.focusNode=b[c+"Container"];a.focusOffset=b[c+"Offset"]}function i(a){a.anchorNode=a.focusNode=null;a.anchorOffset=a.focusOffset=0;a.rangeCount=0;a.isCollapsed=!0;a._ranges.length=0}function g(b){var c;b instanceof y?(c=b._selectionNativeRange,c||
(c=a.createNativeRange(o.getDocument(b.startContainer)),c.setEnd(b.endContainer,b.endOffset),c.setStart(b.startContainer,b.startOffset),b._selectionNativeRange=c,b.attachListener("detach",function(){this._selectionNativeRange=null}))):b instanceof w?c=b.nativeRange:a.features.implementsDomRange&&b instanceof o.getWindow(b.startContainer).Range&&(c=b);return c}function b(a){var b=a.getNodes(),c;a:if(!b.length||1!=b[0].nodeType)c=!1;else{c=1;for(var d=b.length;c<d;++c)if(!o.isAncestorOf(b[0],b[c])){c=
!1;break a}c=!0}if(!c)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function j(a,b){var c=new w(b);a._ranges=[c];f(a,c,!1);a.rangeCount=1;a.isCollapsed=c.collapsed}function l(b){b._ranges.length=0;if("None"==b.docSelection.type)i(b);else{var c=b.docSelection.createRange();if(c&&"undefined"!=typeof c.text)j(b,c);else{b.rangeCount=c.length;for(var d,h=o.getDocument(c.item(0)),k=0;k<b.rangeCount;++k)d=a.createRange(h),d.selectNode(c.item(k)),
b._ranges.push(d);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;f(b,b._ranges[b.rangeCount-1],!1)}}}function p(a,c){for(var d=a.docSelection.createRange(),h=b(c),k=o.getDocument(d.item(0)),k=o.getBody(k).createControlRange(),f=0,e=d.length;f<e;++f)k.add(d.item(f));try{k.add(h)}catch(g){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}k.select();l(a)}function n(a,b,c){this.nativeSelection=a;this.docSelection=b;this._ranges=
[];this.win=c;this.refresh()}function m(a,c){for(var d=o.getDocument(c[0].startContainer),d=o.getBody(d).createControlRange(),h=0,k;h<rangeCount;++h){k=b(c[h]);try{d.add(k)}catch(f){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();l(a)}function r(a,b){if(a.anchorNode&&o.getDocument(a.anchorNode)!==o.getDocument(b))throw new A("WRONG_DOCUMENT_ERR");}function s(a){var b=[],c=new E(a.anchorNode,a.anchorOffset),
d=new E(a.focusNode,a.focusOffset),h="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var k=0,f=a.rangeCount;k<f;++k)b[k]=y.inspect(a.getRangeAt(k));return"["+h+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var o=a.dom,q=a.util,y=a.DomRange,w=a.WrappedRange,A=a.DOMException,E=o.DomPosition,z,C,F=a.util.isHostMethod(window,"getSelection"),
H=a.util.isHostObject(document,"selection"),D=H&&(!F||a.config.preferTextRange);D?(z=e,a.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return"None"!=b.type||o.getDocument(b.createRange().parentElement())==a}):F?(z=d,a.isSelectionValid=function(){return!0}):c.fail("Neither document.selection or window.getSelection() detected.");a.getNativeSelection=z;var F=z(),v=a.createNativeRange(document),M=o.getBody(document),R=q.areHostObjects(F,q.areHostProperties(F,["anchorOffset","focusOffset"]));
a.features.selectionHasAnchorAndFocus=R;var h=q.isHostMethod(F,"extend");a.features.selectionHasExtend=h;var S="number"==typeof F.rangeCount;a.features.selectionHasRangeCount=S;var Q=!1,P=!0;q.areHostMethods(F,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof F.rangeCount&&a.features.implementsDomRange&&function(){var a=document.createElement("iframe");a.frameBorder=0;a.style.position="absolute";a.style.left="-10000px";M.appendChild(a);var b=o.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");
b.close();var c=o.getIframeWindow(a).getSelection(),d=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(d,1);b.collapse(true);c.addRange(b);P=c.rangeCount==1;c.removeAllRanges();var h=b.cloneRange();b.setStart(d,0);h.setEnd(d,2);c.addRange(b);c.addRange(h);Q=c.rangeCount==2;b.detach();h.detach();M.removeChild(a)}();a.features.selectionSupportsMultipleRanges=Q;a.features.collapsedNonEditableSelectionsSupported=P;var J=!1,u;M&&q.isHostMethod(M,"createControlRange")&&(u=M.createControlRange(),
q.areHostProperties(u,["item","add"])&&(J=!0));a.features.implementsControlRange=J;C=R?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:false};var I;q.isHostMethod(F,"getRangeAt")?I=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:R&&(I=function(b){var c=o.getDocument(b.anchorNode),c=a.createRange(c);c.setStart(b.anchorNode,b.anchorOffset);c.setEnd(b.focusNode,b.focusOffset);if(c.collapsed!==
this.isCollapsed){c.setStart(b.focusNode,b.focusOffset);c.setEnd(b.anchorNode,b.anchorOffset)}return c});a.getSelection=function(a){var a=a||window,b=a._rangySelection,c=z(a),d=H?e(a):null;if(b){b.nativeSelection=c;b.docSelection=d;b.refresh(a)}else{b=new n(c,d,a);a._rangySelection=b}return b};a.getIframeSelection=function(b){return a.getSelection(o.getIframeWindow(b))};u=n.prototype;if(!D&&R&&q.areHostMethods(F,["removeAllRanges","addRange"])){u.removeAllRanges=function(){this.nativeSelection.removeAllRanges();
i(this)};var G=function(b,c){var d=y.getRangeDocument(c),d=a.createRange(d);d.collapseToPoint(c.endContainer,c.endOffset);b.nativeSelection.addRange(g(d));b.nativeSelection.extend(c.startContainer,c.startOffset);b.refresh()};u.addRange=S?function(b,c){if(J&&H&&this.docSelection.type=="Control")p(this,b);else if(c&&h)G(this,b);else{var d;if(Q)d=this.rangeCount;else{this.removeAllRanges();d=0}this.nativeSelection.addRange(g(b));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==d+1){if(a.config.checkSelectionRanges)(d=
I(this.nativeSelection,this.rangeCount-1))&&!y.rangesEqual(d,b)&&(b=new w(d));this._ranges[this.rangeCount-1]=b;f(this,b,t(this.nativeSelection));this.isCollapsed=C(this)}else this.refresh()}}:function(a,b){if(b&&h)G(this,a);else{this.nativeSelection.addRange(g(a));this.refresh()}};u.setRanges=function(a){if(J&&a.length>1)m(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(q.isHostMethod(F,"empty")&&q.isHostMethod(v,"select")&&J&&D)u.removeAllRanges=
function(){try{this.docSelection.empty();if(this.docSelection.type!="None"){var a;if(this.anchorNode)a=o.getDocument(this.anchorNode);else if(this.docSelection.type=="Control"){var b=this.docSelection.createRange();b.length&&(a=o.getDocument(b.item(0)).body.createTextRange())}if(a){a.body.createTextRange().select();this.docSelection.empty()}}}catch(c){}i(this)},u.addRange=function(a){if(this.docSelection.type=="Control")p(this,a);else{w.rangeToTextRange(a).select();this._ranges[0]=a;this.rangeCount=
1;this.isCollapsed=this._ranges[0].collapsed;f(this,a,false)}},u.setRanges=function(a){this.removeAllRanges();var b=a.length;b>1?m(this,a):b&&this.addRange(a[0])};else return c.fail("No means of selecting a Range or TextRange was found"),!1;u.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new A("INDEX_SIZE_ERR");return this._ranges[a]};var L;if(D)L=function(b){var c;if(a.isSelectionValid(b.win))c=b.docSelection.createRange();else{c=o.getBody(b.win.document).createTextRange();c.collapse(true)}b.docSelection.type==
"Control"?l(b):c&&typeof c.text!="undefined"?j(b,c):i(b)};else if(q.isHostMethod(F,"getRangeAt")&&"number"==typeof F.rangeCount)L=function(b){if(J&&H&&b.docSelection.type=="Control")l(b);else{b._ranges.length=b.rangeCount=b.nativeSelection.rangeCount;if(b.rangeCount){for(var c=0,d=b.rangeCount;c<d;++c)b._ranges[c]=new a.WrappedRange(b.nativeSelection.getRangeAt(c));f(b,b._ranges[b.rangeCount-1],t(b.nativeSelection));b.isCollapsed=C(b)}else i(b)}};else if(R&&"boolean"==typeof F.isCollapsed&&"boolean"==
typeof v.collapsed&&a.features.implementsDomRange)L=function(a){var b;b=a.nativeSelection;if(b.anchorNode){b=I(b,0);a._ranges=[b];a.rangeCount=1;b=a.nativeSelection;a.anchorNode=b.anchorNode;a.anchorOffset=b.anchorOffset;a.focusNode=b.focusNode;a.focusOffset=b.focusOffset;a.isCollapsed=C(a)}else i(a)};else return c.fail("No means of obtaining a Range or TextRange from the user's selection was found"),!1;u.refresh=function(a){var b=a?this._ranges.slice(0):null;L(this);if(a){a=b.length;if(a!=this._ranges.length)return false;
for(;a--;)if(!y.rangesEqual(b[a],this._ranges[a]))return false;return true}};var k=function(a,b){var c=a.getAllRanges(),d=false;a.removeAllRanges();for(var h=0,k=c.length;h<k;++h)d||b!==c[h]?a.addRange(c[h]):d=true;a.rangeCount||i(a)};u.removeRange=J?function(a){if(this.docSelection.type=="Control"){for(var c=this.docSelection.createRange(),a=b(a),d=o.getDocument(c.item(0)),d=o.getBody(d).createControlRange(),h,f=false,e=0,g=c.length;e<g;++e){h=c.item(e);h!==a||f?d.add(c.item(e)):f=true}d.select();
l(this)}else k(this,a)}:function(a){k(this,a)};var t;!D&&R&&a.features.implementsDomRange?(t=function(a){var b=false;a.anchorNode&&(b=o.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset)==1);return b},u.isBackwards=function(){return t(this)}):t=u.isBackwards=function(){return false};u.toString=function(){for(var a=[],b=0,c=this.rangeCount;b<c;++b)a[b]=""+this._ranges[b];return a.join("")};u.collapse=function(b,c){r(this,b);var d=a.createRange(o.getDocument(b));d.collapseToPoint(b,
c);this.removeAllRanges();this.addRange(d);this.isCollapsed=true};u.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new A("INVALID_STATE_ERR");};u.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new A("INVALID_STATE_ERR");};u.selectAllChildren=function(b){r(this,b);var c=a.createRange(o.getDocument(b));c.selectNodeContents(b);this.removeAllRanges();
...
0,d=this._ranges.length;c<d;++c)if(this._ranges[c].containsNode(a,b))return true;return false};u.toHtml=function(){var a="";if(this.rangeCount){for(var a=y.getRangeDocument(this._ranges[0]).createElement("div"),b=0,c=this._ranges.length;b<c;++b)a.appendChild(this._ranges[b].cloneContents());a=a.innerHTML}return a};u.getName=function(){return"WrappedSelection"};u.inspect=function(){return s(this)};u.detach=function(){this.win=this.anchorNode=this.focusNode=this.win._rangySelection=null};n.inspect=
...
rangy.createModule("CssClassApplier",function(a,c){function d(a,b){return a.className&&RegExp("(?:^|\\s)"+b+"(?:\\s|$)").test(a.className)}function e(a,b){a.className?d(a,b)||(a.className+=" "+b):a.className=b}function f(a){return a.split(/\s+/).sort().join(" ")}function i(a,b){return f(a.className)==f(b.className)}function g(a){for(var b=a.parentNode;a.hasChildNodes();)b.insertBefore(a.firstChild,a);b.removeChild(a)}function b(a,b){var c=a.cloneRange();c.selectNodeContents(b);var d=c.intersection(a),
d=d?d.toString():"";c.detach();return""!=d}function j(a){return a.getNodes([3],function(c){return b(a,c)})}function l(a,b){if(a.attributes.length!=b.attributes.length)return!1;for(var c=0,d=a.attributes.length,f,e;c<d;++c)if(f=a.attributes[c],e=f.name,"class"!=e&&(e=b.attributes.getNamedItem(e),f.specified!=e.specified||f.specified&&f.nodeValue!==e.nodeValue))return!1;return!0}function p(a,b){for(var c=0,d=a.attributes.length,f;c<d;++c)if(f=a.attributes[c].name,(!b||!A.arrayContains(b,f))&&a.attributes[c].specified&&
...
r(a.nextSibling)}function o(a,b,d,f){var e,g=0==d;if(A.isAncestorOf(b,a))return a;if(A.isCharacterDataNode(b))if(0==d)d=A.getNodeIndex(b),b=b.parentNode;else if(d==b.length)d=A.getNodeIndex(b)+1,b=b.parentNode;else throw c.createError("splitNodeAt should not be called with offset in the middle of a data node ("+d+" in "+b.data);if(A.isCharacterDataNode(b)?0==d?b.previousSibling:d==b.length?b.nextSibling:1:0<d&&d<b.childNodes.length){if(!e){e=b.cloneNode(!1);for(e.id&&e.removeAttribute("id");g=b.childNodes[d];)e.appendChild(g);
A.insertAfter(e,b)}return b==a?e:o(a,e.parentNode,A.getNodeIndex(e),f)}return a!=b?(e=b.parentNode,b=A.getNodeIndex(b),g||b++,o(a,e,b,f)):a}function q(a){var b=a?"nextSibling":"previousSibling";return function(c,d){var f=c.parentNode,e=c[b];if(e){if(e&&3==e.nodeType)return e}else if(d&&(e=f[b])&&1==e.nodeType&&f.tagName==e.tagName&&i(f,e)&&l(f,e))return e[a?"firstChild":"lastChild"];return null}}function y(a){this.firstTextNode=(this.isElementMerge=1==a.nodeType)?a.lastChild:a;this.textNodes=[this.firstTextNode]}
function w(a,b,c){this.cssClass=a;var d,e,g=null;if("object"==typeof b&&null!==b){c=b.tagNames;g=b.elementProperties;for(d=0;e=M[d++];)b.hasOwnProperty(e)&&(this[e]=b[e]);d=b.normalize}else d=b;this.normalize="undefined"==typeof d?!0:d;this.attrExceptions=[];d=document.createElement(this.elementTagName);this.elementProperties={};for(var i in g)g.hasOwnProperty(i)&&(R.hasOwnProperty(i)&&(i=R[i]),d[i]=g[i],this.elementProperties[i]=d[i],this.attrExceptions.push(i));this.elementSortedClassName=this.elementProperties.hasOwnProperty("className")?
...
d;b.removeAllRanges();for(var e=0,f=c.length;e<f;++e)d=c[e],this.undoToRange(d),b.addRange(d)},getTextSelectedByRange:function(a,b){var c=b.cloneRange();c.selectNodeContents(a);var d=c.intersection(b),d=d?d.toString():"";c.detach();return d},isAppliedToRange:function(a){if(a.collapsed)return!!this.getSelfOrAncestorWithClass(a.commonAncestorContainer);for(var c=a.getNodes([3]),d=0,e;e=c[d++];)if(!this.isIgnorableWhiteSpaceNode(e)&&b(a,e)&&this.isModifiable(e)&&!this.getSelfOrAncestorWithClass(e))return!1;
return!0},isAppliedToSelection:function(b){for(var b=a.getSelection(b||window).getAllRanges(),c=b.length;c--;)if(!this.isAppliedToRange(b[c]))return!1;return!0},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)},toggleSelection:function(a){this.isAppliedToSelection(a)?this.undoToSelection(a):this.applyToSelection(a)},detach:function(){}};w.util={hasClass:d,addClass:e,removeClass:E,hasSameClasses:i,replaceWithOwnChildren:g,elementsHaveSameNonClassAttributes:l,
elementHasNonClassAttributes:p,splitNodeAt:o,isEditableElement:C,isEditingHost:n,isEditable:m};a.CssClassApplier=w;a.createCssClassApplier=function(a,b,c){return new w(a,b,c)}});
rangy.createModule("SaveRestore",function(a,c){function d(a,c){var d="selectionBoundary_"+ +new Date+"_"+(""+Math.random()).slice(2),e,f=g.getDocument(a.startContainer),i=a.cloneRange();i.collapse(c);e=f.createElement("span");e.id=d;e.style.lineHeight="0";e.style.display="none";e.className="rangySelectionBoundary";e.appendChild(f.createTextNode(b));i.insertNode(e);i.detach();return e}function e(a,b,d,e){(a=(a||document).getElementById(d))?(b[e?"setStartBefore":"setEndBefore"](a),a.parentNode.removeChild(a)):
c.warn("Marker element has been removed. Cannot restore selection.")}function f(a,b){return b.compareBoundaryPoints(a.START_TO_START,a)}function i(a,b){var c=(a||document).getElementById(b);c&&c.parentNode.removeChild(c)}a.requireModules(["DomUtil","DomRange","WrappedRange"]);var g=a.dom,b="\ufeff";a.saveSelection=function(b){var b=b||window,e=b.document;if(a.isSelectionValid(b)){var g=a.getSelection(b),i=g.getAllRanges(),m=[],r,s;i.sort(f);for(var o=0,q=i.length;o<q;++o)r=i[o],r.collapsed?(s=d(r,
!1),m.push({markerId:s.id,collapsed:!0})):(s=d(r,!1),r=d(r,!0),m[o]={startMarkerId:r.id,endMarkerId:s.id,collapsed:!1,backwards:1==i.length&&g.isBackwards()});for(o=q-1;0<=o;--o)r=i[o],r.collapsed?r.collapseBefore((e||document).getElementById(m[o].markerId)):(r.setEndBefore((e||document).getElementById(m[o].endMarkerId)),r.setStartAfter((e||document).getElementById(m[o].startMarkerId)));g.setRanges(i);return{win:b,doc:e,rangeInfos:m,restored:!1}}c.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
a.restoreSelection=function(b,d){if(!b.restored){for(var f=b.rangeInfos,g=a.getSelection(b.win),i=[],r=f.length,s=r-1,o,q;0<=s;--s){o=f[s];q=a.createRange(b.doc);if(o.collapsed)if(o=(b.doc||document).getElementById(o.markerId)){o.style.display="inline";var y=o.previousSibling;y&&3==y.nodeType?(o.parentNode.removeChild(o),q.collapseToPoint(y,y.length)):(q.collapseBefore(o),o.parentNode.removeChild(o))}else c.warn("Marker element has been removed. Cannot restore selection.");else e(b.doc,q,o.startMarkerId,
!0),e(b.doc,q,o.endMarkerId,!1);1==r&&q.normalizeBoundaries();i[s]=q}1==r&&d&&a.features.selectionHasExtend&&f[0].backwards?(g.removeAllRanges(),g.addRange(i[0],!0)):g.setRanges(i);b.restored=!0}};a.removeMarkerElement=i;a.removeMarkers=function(a){for(var b=a.rangeInfos,c=0,d=b.length,e;c<d;++c)e=b[c],e.collapsed?i(a.doc,e.markerId):(i(a.doc,e.startMarkerId),i(a.doc,e.endMarkerId))}});
rangy.createModule("Serializer",function(a,c){function d(a,b){var b=b||[],c=a.nodeType,e=a.childNodes,f=e.length,g=[c,a.nodeName,f].join(":"),i="",j="";switch(c){case 3:i=a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;");break;case 8:i="<\!--"+a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;")+"--\>";break;default:i="<"+g+">",j="</>"}i&&b.push(i);for(c=0;c<f;++c)d(e[c],b);j&&b.push(j);return b}function e(a){a=d(a).join("");return n(a).toString(16)}function f(a,b,c){for(var d=[],e=a,c=c||m.getDocument(a).documentElement;e&&
e!=c;)d.push(m.getNodeIndex(e,!0)),e=e.parentNode;return d.join("/")+":"+b}function i(a,b,d){b?d||m.getDocument(b):b=(d||document).documentElement;for(var a=a.split(":"),d=a[0]?a[0].split("/"):[],e=d.length,f;e--;)if(f=parseInt(d[e],10),f<b.childNodes.length)b=b.childNodes[parseInt(d[e],10)];else throw c.createError("deserializePosition failed: node "+m.inspectNode(b)+" has no child with index "+f+", "+e);return new m.DomPosition(b,parseInt(a[1],10))}function g(b,c,d){d=d||a.DomRange.getRangeDocument(b).documentElement;
...
f=c.domain?";domain="+c.domain:"",g=c.secure?";secure":"",i=l(a.getSelection(b));b.document.cookie=encodeURIComponent("rangySerializedSelection")+"="+encodeURIComponent(i)+d+e+f+g};a.getElementChecksum=e});
(function(a,c){function d(a){var b=S[a]={},c,d,a=a.split(/\s+/);c=0;for(d=a.length;c<d;c++)b[a[c]]=!0;return b}function e(a,b,d){if(d===c&&1===a.nodeType)if(d="data-"+b.replace(J,"-$1").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:h.isNumeric(d)?+d:P.test(d)?h.parseJSON(d):d}catch(e){}h.data(a,b,d)}else d=c;return d}function f(a){for(var b in a)if(!("data"===b&&h.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function i(a,b,c){var d=
b+"defer",e=b+"queue",f=b+"mark",k=h._data(a,d);k&&("queue"===c||!h._data(a,e))&&("mark"===c||!h._data(a,f))&&setTimeout(function(){!h._data(a,e)&&!h._data(a,f)&&(h.removeData(a,d,!0),k.fire())},0)}function g(){return!1}function b(){return!0}function j(a,b,c){b=b||0;if(h.isFunction(b))return h.grep(a,function(a,d){return!!b.call(a,d,a)===c});if(b.nodeType)return h.grep(a,function(a){return a===b===c});if("string"===typeof b){var d=h.grep(a,function(a){return 1===a.nodeType});if(Wa.test(b))return h.filter(b,
d,!c);b=h.filter(b,d)}return h.grep(a,function(a){return 0<=h.inArray(a,b)===c})}function l(a){var b=Ea.split("|"),a=a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());return a}function p(a,b){if(1===b.nodeType&&h.hasData(a)){var c,d,e;d=h._data(a);var f=h._data(b,d),k=d.events;if(k)for(c in delete f.handle,f.events={},k){d=0;for(e=k[c].length;d<e;d++)h.event.add(b,c,k[c][d])}f.data&&(f.data=h.extend({},f.data))}}function n(a,b){var c;if(1===b.nodeType){b.clearAttributes&&
...
function m(a){return"undefined"!==typeof a.getElementsByTagName?a.getElementsByTagName("*"):"undefined"!==typeof a.querySelectorAll?a.querySelectorAll("*"):[]}function r(a){if("checkbox"===a.type||"radio"===a.type)a.defaultChecked=a.checked}function s(a){var b=(a.nodeName||"").toLowerCase();"input"===b?r(a):"script"!==b&&"undefined"!==typeof a.getElementsByTagName&&h.grep(a.getElementsByTagName("input"),r)}function o(a,b,c){var d="width"===b?a.offsetWidth:a.offsetHeight,e="width"===b?1:0;if(0<d){if("border"!==
c)for(;4>e;e+=2)c||(d-=parseFloat(h.css(a,"padding"+Y[e]))||0),d="margin"===c?d+(parseFloat(h.css(a,c+Y[e]))||0):d-(parseFloat(h.css(a,"border"+Y[e]+"Width"))||0);return d+"px"}d=ba(a,b);if(0>d||null==d)d=a.style[b];if(va.test(d))return d;d=parseFloat(d)||0;if(c)for(;4>e;e+=2)d+=parseFloat(h.css(a,"padding"+Y[e]))||0,"padding"!==c&&(d+=parseFloat(h.css(a,"border"+Y[e]+"Width"))||0),"margin"===c&&(d+=parseFloat(h.css(a,c+Y[e]))||0);return d+"px"}function q(a){return function(b,c){"string"!==typeof b&&
(c=b,b="*");if(h.isFunction(c))for(var d=b.toLowerCase().split(La),e=0,f=d.length,k,g;e<f;e++)k=d[e],(g=/^\+/.test(k))&&(k=k.substr(1)||"*"),k=a[k]=a[k]||[],k[g?"unshift":"push"](c)}}function y(a,b,d,e,f,k){f=f||b.dataTypes[0];k=k||{};k[f]=!0;for(var f=a[f],g=0,i=f?f.length:0,h=a===wa,j;g<i&&(h||!j);g++)j=f[g](b,d,e),"string"===typeof j&&(!h||k[j]?j=c:(b.dataTypes.unshift(j),j=y(a,b,d,e,j,k)));if((h||!j)&&!k["*"])j=y(a,b,d,e,"*",k);return j}function w(a,b){var d,e,f=h.ajaxSettings.flatOptions||{};
for(d in b)b[d]!==c&&((f[d]?a:e||(e={}))[d]=b[d]);e&&h.extend(!0,a,e)}function A(a,b,c,d){if(h.isArray(b))h.each(b,function(b,e){c||db.test(a)?d(a,e):A(a+"["+("object"===typeof e?b:"")+"]",e,c,d)});else if(!c&&"object"===h.type(b))for(var e in b)A(a+"["+e+"]",b[e],c,d);else d(a,b)}function E(){try{return new a.XMLHttpRequest}catch(b){}}function z(){setTimeout(C,0);return na=h.now()}function C(){na=c}function F(a,b){var c={};h.each(oa.concat.apply([],oa.slice(0,b)),function(){c[this]=a});return c}
function H(a){if(!xa[a]){var b=v.body,c=h("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d){X||(X=v.createElement("iframe"),X.frameBorder=X.width=X.height=0);b.appendChild(X);if(!ca||!X.createElement)ca=(X.contentWindow||X.contentDocument).document,ca.write((h.support.boxModel?"<!doctype html>":"")+"<html><body>"),ca.close();c=ca.createElement(a);ca.body.appendChild(c);d=h.css(c,"display");b.removeChild(X)}xa[a]=d}return xa[a]}function D(a){return h.isWindow(a)?a:9===a.nodeType?
a.defaultView||a.parentWindow:!1}var v=a.document,M=a.navigator,R=a.location,h=function(){function b(){if(!d.isReady){try{v.documentElement.doScroll("left")}catch(a){setTimeout(b,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,k)},e=a.jQuery,f=a.$,k,g=/^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,i=/\S/,h=/^\s+/,j=/\s+$/,t=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,l=/^[\],:{}\s]*$/,m=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,n=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,x=/(?:^|:|,)(?:\s*\[)+/g,
p=/(webkit)[ \/]([\w.]+)/,r=/(opera)(?:.*version)?[ \/]([\w.]+)/,s=/(msie) ([\w.]+)/,o=/(mozilla)(?:.*? rv:([\w.]+))?/,O=/-([a-z]|[0-9])/ig,K=/^-ms-/,q=function(a,b){return(b+"").toUpperCase()},w=M.userAgent,pa,da,eb=Object.prototype.toString,ya=Object.prototype.hasOwnProperty,za=Array.prototype.push,N=Array.prototype.slice,y=String.prototype.trim,u=Array.prototype.indexOf,V={};d.fn=d.prototype={constructor:d,init:function(a,b,e){var B;if(!a)return this;if(a.nodeType)return this.context=this[0]=a,
...
d.merge(this,a);if((b=v.getElementById(B[2]))&&b.parentNode){if(b.id!==B[2])return e.find(a);this.length=1;this[0]=b}this.context=v;this.selector=a;return this}return!b||b.jquery?(b||e).find(a):this.constructor(b).find(a)}if(d.isFunction(a))return e.ready(a);a.selector!==c&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,this)},selector:"",jquery:"1.7.2",length:0,size:function(){return this.length},toArray:function(){return N.call(this,0)},get:function(a){return null==a?this.toArray():
0>a?this[this.length+a]:this[a]},pushStack:function(a,b,c){var e=this.constructor();d.isArray(a)?za.apply(e,a):d.merge(e,a);e.prevObject=this;e.context=this.context;"find"===b?e.selector=this.selector+(this.selector?" ":"")+c:b&&(e.selector=this.selector+"."+b+"("+c+")");return e},each:function(a,b){return d.each(this,a,b)},ready:function(a){d.bindReady();pa.add(a);return this},eq:function(a){a=+a;return-1===a?this.slice(a):this.slice(a,a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},
slice:function(){return this.pushStack(N.apply(this,arguments),"slice",N.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:za,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,b,e,B,f,k=arguments[0]||{},g=1,i=arguments.length,h=!1;"boolean"===typeof k&&(h=k,k=arguments[1]||{},g=2);"object"!==typeof k&&!d.isFunction(k)&&(k=
{});i===g&&(k=this,--g);for(;g<i;g++)if(null!=(a=arguments[g]))for(b in a)e=k[b],B=a[b],k!==B&&(h&&B&&(d.isPlainObject(B)||(f=d.isArray(B)))?(f?(f=!1,e=e&&d.isArray(e)?e:[]):e=e&&d.isPlainObject(e)?e:{},k[b]=d.extend(h,e,B)):B!==c&&(k[b]=B));return k};d.extend({noConflict:function(b){a.$===d&&(a.$=f);b&&a.jQuery===d&&(a.jQuery=e);return d},isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!v.body)return setTimeout(d.ready,
1);d.isReady=!0;!0!==a&&0<--d.readyWait||(pa.fireWith(v,[d]),d.fn.trigger&&d(v).trigger("ready").off("ready"))}},bindReady:function(){if(!pa){pa=d.Callbacks("once memory");if("complete"===v.readyState)return setTimeout(d.ready,1);if(v.addEventListener)v.addEventListener("DOMContentLoaded",da,!1),a.addEventListener("load",d.ready,!1);else if(v.attachEvent){v.attachEvent("onreadystatechange",da);a.attachEvent("onload",d.ready);var c=!1;try{c=null==a.frameElement}catch(e){}v.documentElement.doScroll&&
c&&b()}}},isFunction:function(a){return"function"===d.type(a)},isArray:Array.isArray||function(a){return"array"===d.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!isNaN(parseFloat(a))&&isFinite(a)},type:function(a){return null==a?""+a:V[eb.call(a)]||"object"},isPlainObject:function(a){if(!a||"object"!==d.type(a)||a.nodeType||d.isWindow(a))return!1;try{if(a.constructor&&!ya.call(a,"constructor")&&!ya.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(b){return!1}for(var e in a);
return e===c||ya.call(a,e)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(l.test(b.replace(m,"@").replace(n,"]").replace(x,"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b){if("string"!==typeof b||!b)return null;var e,B;try{a.DOMParser?(B=new DOMParser,e=B.parseFromString(b,"text/xml")):
(e=new ActiveXObject("Microsoft.XMLDOM"),e.async="false",e.loadXML(b))}catch(f){e=c}(!e||!e.documentElement||e.getElementsByTagName("parsererror").length)&&d.error("Invalid XML: "+b);return e},noop:function(){},globalEval:function(b){b&&i.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(K,"ms-").replace(O,q)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,b,e){var B,f=0,k=a.length,g=k===c||d.isFunction(a);
if(e)if(g)for(B in a){if(!1===b.apply(a[B],e))break}else for(;f<k&&!1!==b.apply(a[f++],e););else if(g)for(B in a){if(!1===b.call(a[B],B,a[B]))break}else for(;f<k&&!1!==b.call(a[f],f,a[f++]););return a},trim:y?function(a){return null==a?"":y.call(a)}:function(a){return null==a?"":a.toString().replace(h,"").replace(j,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var e=d.type(a);null==a.length||"string"===e||"function"===e||"regexp"===e||d.isWindow(a)?za.call(c,a):d.merge(c,a)}return c},inArray:function(a,
b,c){var d;if(b){if(u)return u.call(b,a,c);d=b.length;for(c=c?0>c?Math.max(0,d+c):c:0;c<d;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,b){var d=a.length,e=0;if("number"===typeof b.length)for(var B=b.length;e<B;e++)a[d++]=b[e];else for(;b[e]!==c;)a[d++]=b[e++];a.length=d;return a},grep:function(a,b,c){for(var d=[],e,c=!!c,B=0,f=a.length;B<f;B++)e=!!b(a[B],B),c!==e&&d.push(a[B]);return d},map:function(a,b,e){var B,f,k=[],g=0,i=a.length;if(a instanceof d||i!==c&&"number"===typeof i&&(0<
i&&a[0]&&a[i-1]||0===i||d.isArray(a)))for(;g<i;g++)B=b(a[g],g,e),null!=B&&(k[k.length]=B);else for(f in a)B=b(a[f],f,e),null!=B&&(k[k.length]=B);return k.concat.apply([],k)},guid:1,proxy:function(a,b){if("string"===typeof b)var e=a[b],b=a,a=e;if(!d.isFunction(a))return c;var B=N.call(arguments,2),e=function(){return a.apply(b,B.concat(N.call(arguments)))};e.guid=a.guid=a.guid||e.guid||d.guid++;return e},access:function(a,b,e,B,f,k,g){var i,h=null==e,j=0,W=a.length;if(e&&"object"===typeof e){for(j in e)d.access(a,
b,j,e[j],1,k,B);f=1}else if(B!==c){i=g===c&&d.isFunction(B);h&&(i?(i=b,b=function(a,b,c){return i.call(d(a),c)}):(b.call(a,B),b=null));if(b)for(;j<W;j++)b(a[j],e,i?B.call(a[j],j,b(a[j],e)):B,g);f=1}return f?a:h?b.call(a):W?b(a[0],e):k},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=p.exec(a)||r.exec(a)||s.exec(a)||0>a.indexOf("compatible")&&o.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,
a,this);a.superclass=this;a.fn=a.prototype=this();a.fn.constructor=a;a.sub=this.sub;a.fn.init=function(c,e){e&&e instanceof d&&!(e instanceof a)&&(e=a(e));return d.fn.init.call(this,c,e,b)};a.fn.init.prototype=a.fn;var b=a(v);return a},browser:{}});d.each("Boolean,Number,String,Function,Array,Date,RegExp,Object".split(","),function(a,b){V["[object "+b+"]"]=b.toLowerCase()});w=d.uaMatch(w);w.browser&&(d.browser[w.browser]=!0,d.browser.version=w.version);d.browser.webkit&&(d.browser.safari=!0);i.test("\u00a0")&&
(h=/^[\s\xA0]+/,j=/[\s\xA0]+$/);k=d(v);v.addEventListener?da=function(){v.removeEventListener("DOMContentLoaded",da,false);d.ready()}:v.attachEvent&&(da=function(){if(v.readyState==="complete"){v.detachEvent("onreadystatechange",da);d.ready()}});return d}(),S={};h.Callbacks=function(a){var a=a?S[a]||d(a):{},b=[],e=[],f,k,g,i,j,t,l=function(c){var d,e,f,k;d=0;for(e=c.length;d<e;d++)f=c[d],k=h.type(f),"array"===k?l(f):"function"===k&&(!a.unique||!n.has(f))&&b.push(f)},m=function(c,d){d=d||[];f=!a.memory||
[c,d];g=k=!0;t=i||0;i=0;for(j=b.length;b&&t<j;t++)if(!1===b[t].apply(c,d)&&a.stopOnFalse){f=!0;break}g=!1;b&&(a.once?!0===f?n.disable():b=[]:e&&e.length&&(f=e.shift(),n.fireWith(f[0],f[1])))},n={add:function(){if(b){var a=b.length;l(arguments);g?j=b.length:f&&!0!==f&&(i=a,m(f[0],f[1]))}return this},remove:function(){if(b)for(var c=arguments,d=0,e=c.length;d<e;d++)for(var f=0;f<b.length&&!(c[d]===b[f]&&(g&&f<=j&&(j--,f<=t&&t--),b.splice(f--,1),a.unique));f++);return this},has:function(a){if(b)for(var c=
0,d=b.length;c<d;c++)if(a===b[c])return!0;return!1},empty:function(){b=[];return this},disable:function(){b=e=f=c;return this},disabled:function(){return!b},lock:function(){e=c;(!f||!0===f)&&n.disable();return this},locked:function(){return!e},fireWith:function(b,c){e&&(g?a.once||e.push([b,c]):(!a.once||!f)&&m(b,c));return this},fire:function(){n.fireWith(this,arguments);return this},fired:function(){return!!k}};return n};var Q=[].slice;h.extend({Deferred:function(a){var b=h.Callbacks("once memory"),
c=h.Callbacks("once memory"),d=h.Callbacks("memory"),e="pending",f={resolve:b,reject:c,notify:d},k={done:b.add,fail:c.add,progress:d.add,state:function(){return e},isResolved:b.fired,isRejected:c.fired,then:function(a,b,c){g.done(a).fail(b).progress(c);return this},always:function(){g.done.apply(g,arguments).fail.apply(g,arguments);return this},pipe:function(a,b,c){return h.Deferred(function(d){h.each({done:[a,"resolve"],fail:[b,"reject"],progress:[c,"notify"]},function(a,b){var c=b[0],e=b[1],B;if(h.isFunction(c))g[a](function(){if((B=
c.apply(this,arguments))&&h.isFunction(B.promise))B.promise().then(d.resolve,d.reject,d.notify);else d[e+"With"](this===g?d:this,[B])});else g[a](d[e])})}).promise()},promise:function(a){if(null==a)a=k;else for(var b in k)a[b]=k[b];return a}},g=k.promise({}),i;for(i in f)g[i]=f[i].fire,g[i+"With"]=f[i].fireWith;g.done(function(){e="resolved"},c.disable,d.lock).fail(function(){e="rejected"},b.disable,d.lock);a&&a.call(g,g);return g},when:function(a){function b(a){return function(b){d[a]=1<arguments.length?
Q.call(arguments,0):b;--g||i.resolveWith(i,d)}}function c(a){return function(b){k[a]=1<arguments.length?Q.call(arguments,0):b;i.notifyWith(j,k)}}var d=Q.call(arguments,0),e=0,f=d.length,k=Array(f),g=f,i=1>=f&&a&&h.isFunction(a.promise)?a:h.Deferred(),j=i.promise();if(1<f){for(;e<f;e++)d[e]&&d[e].promise&&h.isFunction(d[e].promise)?d[e].promise().then(b(e),i.reject,c(e)):--g;g||i.resolveWith(i,d)}else i!==a&&i.resolveWith(i,f?[a]:[]);return j}});h.support=function(){var b,c,d,e,f,k,g,i,j=v.createElement("div");
j.setAttribute("className","t");j.innerHTML="   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>";c=j.getElementsByTagName("*");d=j.getElementsByTagName("a")[0];if(!c||!c.length||!d)return{};e=v.createElement("select");f=e.appendChild(v.createElement("option"));c=j.getElementsByTagName("input")[0];b={leadingWhitespace:3===j.firstChild.nodeType,tbody:!j.getElementsByTagName("tbody").length,htmlSerialize:!!j.getElementsByTagName("link").length,
...
pixelMargin:!0};h.boxModel=b.boxModel="CSS1Compat"===v.compatMode;c.checked=!0;b.noCloneChecked=c.cloneNode(!0).checked;e.disabled=!0;b.optDisabled=!f.disabled;try{delete j.test}catch(t){b.deleteExpando=!1}!j.addEventListener&&j.attachEvent&&j.fireEvent&&(j.attachEvent("onclick",function(){b.noCloneEvent=!1}),j.cloneNode(!0).fireEvent("onclick"));c=v.createElement("input");c.value="t";c.setAttribute("type","radio");b.radioValue="t"===c.value;c.setAttribute("checked","checked");c.setAttribute("name",
"t");j.appendChild(c);d=v.createDocumentFragment();d.appendChild(j.lastChild);b.checkClone=d.cloneNode(!0).cloneNode(!0).lastChild.checked;b.appendChecked=c.checked;d.removeChild(c);d.appendChild(j);if(j.attachEvent)for(g in{submit:1,change:1,focusin:1})c="on"+g,i=c in j,i||(j.setAttribute(c,"return;"),i="function"===typeof j[c]),b[g+"Bubbles"]=i;d.removeChild(j);d=e=f=j=c=null;h(function(){var c,d,e,f,g=v.getElementsByTagName("body")[0];if(g){c=v.createElement("div");c.style.cssText="padding:0;margin:0;border:0;visibility:hidden;width:0;height:0;position:static;top:0;margin-top:1px";
g.insertBefore(c,g.firstChild);j=v.createElement("div");c.appendChild(j);j.innerHTML="<table><tr><td style='padding:0;margin:0;border:0;display:none'></td><td>t</td></tr></table>";k=j.getElementsByTagName("td");i=k[0].offsetHeight===0;k[0].style.display="";k[1].style.display="none";b.reliableHiddenOffsets=i&&k[0].offsetHeight===0;if(a.getComputedStyle){j.innerHTML="";d=v.createElement("div");d.style.width="0";d.style.marginRight="0";j.style.width="2px";j.appendChild(d);b.reliableMarginRight=(parseInt((a.getComputedStyle(d,
...
5};e.style.position="fixed";e.style.top="20px";f.fixedPosition=e.offsetTop===20||e.offsetTop===15;e.style.position=e.style.top="";d.style.overflow="hidden";d.style.position="relative";f.subtractsBorderForOverflowNotVisible=e.offsetTop===-5;f.doesNotIncludeMarginInBodyOffset=g.offsetTop!==1;if(a.getComputedStyle){j.style.marginTop="1%";b.pixelMargin=(a.getComputedStyle(j,null)||{marginTop:0}).marginTop!=="1%"}if(typeof c.style.zoom!=="undefined")c.style.zoom=1;g.removeChild(c);j=null;h.extend(b,f)}});
return b}();var P=/^(?:\{.*\}|\[.*\])$/,J=/([A-Z])/g;h.extend({cache:{},uuid:0,expando:"jQuery"+(h.fn.jquery+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(a){a=a.nodeType?h.cache[a[h.expando]]:a[h.expando];return!!a&&!f(a)},data:function(a,b,d,e){if(h.acceptData(a)){var f;f=h.expando;var k="string"===typeof b,g=a.nodeType,i=g?h.cache:a,j=g?a[f]:a[f]&&f,t="events"===b;if(j&&i[j]&&(t||e||i[j].data)||!(k&&d===c)){j||
(g?a[f]=j=++h.uuid:j=f);i[j]||(i[j]={},g||(i[j].toJSON=h.noop));if("object"===typeof b||"function"===typeof b)e?i[j]=h.extend(i[j],b):i[j].data=h.extend(i[j].data,b);f=a=i[j];e||(a.data||(a.data={}),a=a.data);d!==c&&(a[h.camelCase(b)]=d);if(t&&!a[b])return f.events;k?(d=a[b],null==d&&(d=a[h.camelCase(b)])):d=a;return d}}},removeData:function(a,b,c){if(h.acceptData(a)){var d,e,k,g=h.expando,i=a.nodeType,j=i?h.cache:a,t=i?a[g]:g;if(j[t]){if(b&&(d=c?j[t]:j[t].data)){h.isArray(b)||(b in d?b=[b]:(b=h.camelCase(b),
b=b in d?[b]:b.split(" ")));e=0;for(k=b.length;e<k;e++)delete d[b[e]];if(!(c?f:h.isEmptyObject)(d))return}if(!c&&(delete j[t].data,!f(j[t])))return;h.support.deleteExpando||!j.setInterval?delete j[t]:j[t]=null;i&&(h.support.deleteExpando?delete a[g]:a.removeAttribute?a.removeAttribute(g):a[g]=null)}}},_data:function(a,b,c){return h.data(a,b,c,!0)},acceptData:function(a){if(a.nodeName){var b=h.noData[a.nodeName.toLowerCase()];if(b)return!(!0===b||a.getAttribute("classid")!==b)}return!0}});h.fn.extend({data:function(a,
b){var d,f,k,g,i,j=this[0],t=0,l=null;if(a===c){if(this.length&&(l=h.data(j),1===j.nodeType&&!h._data(j,"parsedAttrs"))){k=j.attributes;for(i=k.length;t<i;t++)g=k[t].name,0===g.indexOf("data-")&&(g=h.camelCase(g.substring(5)),e(j,g,l[g]));h._data(j,"parsedAttrs",!0)}return l}if("object"===typeof a)return this.each(function(){h.data(this,a)});d=a.split(".",2);d[1]=d[1]?"."+d[1]:"";f=d[1]+"!";return h.access(this,function(b){if(b===c)return l=this.triggerHandler("getData"+f,[d[0]]),l===c&&j&&(l=h.data(j,
a),l=e(j,a,l)),l===c&&d[1]?this.data(d[0]):l;d[1]=b;this.each(function(){var c=h(this);c.triggerHandler("setData"+f,d);h.data(this,a,b);c.triggerHandler("changeData"+f,d)})},null,b,1<arguments.length,null,!1)},removeData:function(a){return this.each(function(){h.removeData(this,a)})}});h.extend({_mark:function(a,b){a&&(b=(b||"fx")+"mark",h._data(a,b,(h._data(a,b)||0)+1))},_unmark:function(a,b,c){!0!==a&&(c=b,b=a,a=!1);if(b){var c=c||"fx",d=c+"mark";(a=a?0:(h._data(b,d)||1)-1)?h._data(b,d,a):(h.removeData(b,
...
a,a="fx",d--);return arguments.length<d?h.queue(this[0],a):b===c?this:this.each(function(){var c=h.queue(this,a,b);a==="fx"&&c[0]!=="inprogress"&&h.dequeue(this,a)})},dequeue:function(a){return this.each(function(){h.dequeue(this,a)})},delay:function(a,b){a=h.fx?h.fx.speeds[a]||a:a;return this.queue(b||"fx",function(b,c){var d=setTimeout(b,a);c.stop=function(){clearTimeout(d)}})},clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,b){function d(){--g||e.resolveWith(f,[f])}"string"!==
typeof a&&(b=a,a=c);for(var a=a||"fx",e=h.Deferred(),f=this,k=f.length,g=1,i=a+"defer",j=a+"queue",t=a+"mark",l;k--;)if(l=h.data(f[k],i,c,!0)||(h.data(f[k],j,c,!0)||h.data(f[k],t,c,!0))&&h.data(f[k],i,h.Callbacks("once memory"),!0))g++,l.add(d);d();return e.promise(b)}});var u=/[\n\t\r]/g,I=/\s+/,G=/\r/g,L=/^(?:button|input)$/i,k=/^(?:button|input|object|select|textarea)$/i,t=/^a(?:rea)?$/i,x=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,
O=h.support.getSetAttribute,K,N,V;h.fn.extend({attr:function(a,b){return h.access(this,h.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){h.removeAttr(this,a)})},prop:function(a,b){return h.access(this,h.prop,a,b,1<arguments.length)},removeProp:function(a){a=h.propFix[a]||a;return this.each(function(){try{this[a]=c,delete this[a]}catch(b){}})},addClass:function(a){var b,c,d,e,f,k,g;if(h.isFunction(a))return this.each(function(b){h(this).addClass(a.call(this,b,this.className))});
if(a&&"string"===typeof a){b=a.split(I);c=0;for(d=this.length;c<d;c++)if(e=this[c],1===e.nodeType)if(!e.className&&1===b.length)e.className=a;else{f=" "+e.className+" ";k=0;for(g=b.length;k<g;k++)~f.indexOf(" "+b[k]+" ")||(f+=b[k]+" ");e.className=h.trim(f)}}return this},removeClass:function(a){var b,d,e,f,k,g,i;if(h.isFunction(a))return this.each(function(b){h(this).removeClass(a.call(this,b,this.className))});if(a&&"string"===typeof a||a===c){b=(a||"").split(I);d=0;for(e=this.length;d<e;d++)if(f=
this[d],1===f.nodeType&&f.className)if(a){k=(" "+f.className+" ").replace(u," ");g=0;for(i=b.length;g<i;g++)k=k.replace(" "+b[g]+" "," ");f.className=h.trim(k)}else f.className=""}return this},toggleClass:function(a,b){var c=typeof a,d="boolean"===typeof b;return h.isFunction(a)?this.each(function(c){h(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===c)for(var e,f=0,k=h(this),g=b,i=a.split(I);e=i[f++];)g=d?g:!k.hasClass(e),k[g?"addClass":"removeClass"](e);
else if("undefined"===c||"boolean"===c)this.className&&h._data(this,"__className__",this.className),this.className=this.className||!1===a?"":h._data(this,"__className__")||""})},hasClass:function(a){for(var a=" "+a+" ",b=0,c=this.length;b<c;b++)if(1===this[b].nodeType&&-1<(" "+this[b].className+" ").replace(u," ").indexOf(a))return!0;return!1},val:function(a){var b,d,e,f=this[0];if(arguments.length)return e=h.isFunction(a),this.each(function(d){var f=h(this);if(1===this.nodeType&&(d=e?a.call(this,
d,f.val()):a,null==d?d="":"number"===typeof d?d+="":h.isArray(d)&&(d=h.map(d,function(a){return a==null?"":a+""})),b=h.valHooks[this.type]||h.valHooks[this.nodeName.toLowerCase()],!b||!("set"in b)||b.set(this,d,"value")===c))this.value=d});if(f){if((b=h.valHooks[f.type]||h.valHooks[f.nodeName.toLowerCase()])&&"get"in b&&(d=b.get(f,"value"))!==c)return d;d=f.value;return"string"===typeof d?d.replace(G,""):null==d?"":d}}});h.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||
b.specified?a.value:a.text}},select:{get:function(a){var b,c,d=a.selectedIndex,e=[],f=a.options,k="select-one"===a.type;if(0>d)return null;a=k?d:0;for(c=k?d+1:f.length;a<c;a++)if(b=f[a],b.selected&&(h.support.optDisabled?!b.disabled:null===b.getAttribute("disabled"))&&(!b.parentNode.disabled||!h.nodeName(b.parentNode,"optgroup"))){b=h(b).val();if(k)return b;e.push(b)}return k&&!e.length&&f.length?h(f[d]).val():e},set:function(a,b){var c=h.makeArray(b);h(a).find("option").each(function(){this.selected=
0<=h.inArray(h(this).val(),c)});c.length||(a.selectedIndex=-1);return c}}},attrFn:{val:!0,css:!0,html:!0,text:!0,data:!0,width:!0,height:!0,offset:!0},attr:function(a,b,d,e){var f,k,g=a.nodeType;if(a&&!(3===g||8===g||2===g)){if(e&&b in h.attrFn)return h(a)[b](d);if("undefined"===typeof a.getAttribute)return h.prop(a,b,d);if(e=1!==g||!h.isXMLDoc(a))b=b.toLowerCase(),k=h.attrHooks[b]||(x.test(b)?N:K);if(d!==c)if(null===d)h.removeAttr(a,b);else{if(k&&"set"in k&&e&&(f=k.set(a,d,b))!==c)return f;a.setAttribute(b,
""+d);return d}else{if(k&&"get"in k&&e&&null!==(f=k.get(a,b)))return f;f=a.getAttribute(b);return null===f?c:f}}},removeAttr:function(a,b){var c,d,e,f,k,g=0;if(b&&1===a.nodeType){d=b.toLowerCase().split(I);for(f=d.length;g<f;g++)if(e=d[g])c=h.propFix[e]||e,(k=x.test(e))||h.attr(a,e,""),a.removeAttribute(O?e:c),k&&c in a&&(a[c]=!1)}},attrHooks:{type:{set:function(a,b){if(L.test(a.nodeName)&&a.parentNode)h.error("type property can't be changed");else if(!h.support.radioValue&&"radio"===b&&h.nodeName(a,
...
prop:function(a,b,d){var e,f,k=a.nodeType;if(a&&!(3===k||8===k||2===k)){if(1!==k||!h.isXMLDoc(a))b=h.propFix[b]||b,f=h.propHooks[b];return d!==c?f&&"set"in f&&(e=f.set(a,d,b))!==c?e:a[b]=d:f&&"get"in f&&null!==(e=f.get(a,b))?e:a[b]}},propHooks:{tabIndex:{get:function(a){var b=a.getAttributeNode("tabindex");return b&&b.specified?parseInt(b.value,10):k.test(a.nodeName)||t.test(a.nodeName)&&a.href?0:c}}}});h.attrHooks.tabindex=h.propHooks.tabIndex;N={get:function(a,b){var d,e=h.prop(a,b);return!0===
e||"boolean"!==typeof e&&(d=a.getAttributeNode(b))&&!1!==d.nodeValue?b.toLowerCase():c},set:function(a,b,c){!1===b?h.removeAttr(a,c):(b=h.propFix[c]||c,b in a&&(a[b]=!0),a.setAttribute(c,c.toLowerCase()));return c}};O||(V={name:!0,id:!0,coords:!0},K=h.valHooks.button={get:function(a,b){var d;return(d=a.getAttributeNode(b))&&(V[b]?""!==d.nodeValue:d.specified)?d.nodeValue:c},set:function(a,b,c){var d=a.getAttributeNode(c);d||(d=v.createAttribute(c),a.setAttributeNode(d));return d.nodeValue=b+""}},
...
{set:function(a,b){if(h.isArray(b))return a.checked=h.inArray(h(a).val(),b)>=0}})});var T=/^(?:textarea|input|select)$/i,aa=/^([^\.]*)?(?:\.(.+))?$/,Ka=/(?:^|\s)hover(\.\S+)?\b/,ja=/^key/,fa=/^(?:mouse|contextmenu)|click/,ga=/^(?:focusinfocus|focusoutblur)$/,ta=/^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/,ka=function(a){if(a=ta.exec(a)){a[1]=(a[1]||"").toLowerCase();a[3]=a[3]&&RegExp("(?:^|\\s)"+a[3]+"(?:\\s|$)")}return a},ha=function(a){return h.event.special.hover?a:a.replace(Ka,"mouseenter$1 mouseleave$1")};
h.event={add:function(a,b,d,e,f){var k,g,i,j,t,l,m,n,x;if(!(a.nodeType===3||a.nodeType===8||!b||!d||!(k=h._data(a)))){if(d.handler){m=d;d=m.handler;f=m.selector}if(!d.guid)d.guid=h.guid++;i=k.events;if(!i)k.events=i={};g=k.handle;if(!g){k.handle=g=function(a){return typeof h!=="undefined"&&(!a||h.event.triggered!==a.type)?h.event.dispatch.apply(g.elem,arguments):c};g.elem=a}b=h.trim(ha(b)).split(" ");for(k=0;k<b.length;k++){j=aa.exec(b[k])||[];t=j[1];l=(j[2]||"").split(".").sort();x=h.event.special[t]||
{};t=(f?x.delegateType:x.bindType)||t;x=h.event.special[t]||{};j=h.extend({type:t,origType:j[1],data:e,handler:d,guid:d.guid,selector:f,quick:f&&ka(f),namespace:l.join(".")},m);n=i[t];if(!n){n=i[t]=[];n.delegateCount=0;if(!x.setup||x.setup.call(a,e,l,g)===false)a.addEventListener?a.addEventListener(t,g,false):a.attachEvent&&a.attachEvent("on"+t,g)}if(x.add){x.add.call(a,j);if(!j.handler.guid)j.handler.guid=d.guid}f?n.splice(n.delegateCount++,0,j):n.push(j);h.event.global[t]=true}a=null}},global:{},
remove:function(a,b,c,d,e){var f=h.hasData(a)&&h._data(a),k,g,i,j,t,l,m,n,x,p;if(f&&(m=f.events)){b=h.trim(ha(b||"")).split(" ");for(k=0;k<b.length;k++){g=aa.exec(b[k])||[];i=j=g[1];g=g[2];if(i){n=h.event.special[i]||{};i=(d?n.delegateType:n.bindType)||i;x=m[i]||[];t=x.length;g=g?RegExp("(^|\\.)"+g.split(".").sort().join("\\.(?:.*\\.)?")+"(\\.|$)"):null;for(l=0;l<x.length;l++){p=x[l];if((e||j===p.origType)&&(!c||c.guid===p.guid)&&(!g||g.test(p.namespace))&&(!d||d===p.selector||d==="**"&&p.selector)){x.splice(l--,
1);p.selector&&x.delegateCount--;n.remove&&n.remove.call(a,p)}}if(x.length===0&&t!==x.length){(!n.teardown||n.teardown.call(a,g)===false)&&h.removeEvent(a,i,f.handle);delete m[i]}}else for(i in m)h.event.remove(a,i+b[k],c,d,true)}if(h.isEmptyObject(m)){if(b=f.handle)b.elem=null;h.removeData(a,["events","handle"],true)}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(b,d,e,f){if(!e||!(e.nodeType===3||e.nodeType===8)){var k=b.type||b,g=[],i,j,t,l,m;if(!ga.test(k+h.event.triggered)){if(k.indexOf("!")>=
0){k=k.slice(0,-1);i=true}if(k.indexOf(".")>=0){g=k.split(".");k=g.shift();g.sort()}if(e&&!h.event.customEvent[k]||h.event.global[k]){b=typeof b==="object"?b[h.expando]?b:new h.Event(k,b):new h.Event(k);b.type=k;b.isTrigger=true;b.exclusive=i;b.namespace=g.join(".");b.namespace_re=b.namespace?RegExp("(^|\\.)"+g.join("\\.(?:.*\\.)?")+"(\\.|$)"):null;i=k.indexOf(":")<0?"on"+k:"";if(e){b.result=c;if(!b.target)b.target=e;d=d!=null?h.makeArray(d):[];d.unshift(b);t=h.event.special[k]||{};if(!(t.trigger&&
t.trigger.apply(e,d)===false)){m=[[e,t.bindType||k]];if(!f&&!t.noBubble&&!h.isWindow(e)){l=t.delegateType||k;g=ga.test(l+k)?e:e.parentNode;for(j=null;g;g=g.parentNode){m.push([g,l]);j=g}j&&j===e.ownerDocument&&m.push([j.defaultView||j.parentWindow||a,l])}for(j=0;j<m.length&&!b.isPropagationStopped();j++){g=m[j][0];b.type=m[j][1];(l=(h._data(g,"events")||{})[b.type]&&h._data(g,"handle"))&&l.apply(g,d);(l=i&&g[i])&&h.acceptData(g)&&l.apply(g,d)===false&&b.preventDefault()}b.type=k;if(!f&&!b.isDefaultPrevented()&&
(!t._default||t._default.apply(e.ownerDocument,d)===false)&&!(k==="click"&&h.nodeName(e,"a"))&&h.acceptData(e))if(i&&e[k]&&(k!=="focus"&&k!=="blur"||b.target.offsetWidth!==0)&&!h.isWindow(e)){(j=e[i])&&(e[i]=null);h.event.triggered=k;e[k]();h.event.triggered=c;j&&(e[i]=j)}return b.result}}else{e=h.cache;for(j in e)e[j].events&&e[j].events[k]&&h.event.trigger(b,d,e[j].handle.elem,true)}}}}},dispatch:function(b){var b=h.event.fix(b||a.event),d=(h._data(this,"events")||{})[b.type]||[],e=d.delegateCount,
f=[].slice.call(arguments,0),k=!b.exclusive&&!b.namespace,g=h.event.special[b.type]||{},i=[],j,t,l,m,n,x,p;f[0]=b;b.delegateTarget=this;if(!(g.preDispatch&&g.preDispatch.call(this,b)===false)){if(e&&!(b.button&&b.type==="click")){l=h(this);l.context=this.ownerDocument||this;for(t=b.target;t!=this;t=t.parentNode||this)if(t.disabled!==true){n={};x=[];l[0]=t;for(j=0;j<e;j++){m=d[j];p=m.selector;if(n[p]===c){var r=n,s=p,o;if(m.quick){o=m.quick;var O=t.attributes||{};o=(!o[1]||t.nodeName.toLowerCase()===
o[1])&&(!o[2]||(O.id||{}).value===o[2])&&(!o[3]||o[3].test((O["class"]||{}).value))}else o=l.is(p);r[s]=o}n[p]&&x.push(m)}x.length&&i.push({elem:t,matches:x})}}d.length>e&&i.push({elem:this,matches:d.slice(e)});for(j=0;j<i.length&&!b.isPropagationStopped();j++){e=i[j];b.currentTarget=e.elem;for(d=0;d<e.matches.length&&!b.isImmediatePropagationStopped();d++){m=e.matches[d];if(k||!b.namespace&&!m.namespace||b.namespace_re&&b.namespace_re.test(m.namespace)){b.data=m.data;b.handleObj=m;m=((h.event.special[m.origType]||
{}).handle||m.handler).apply(e.elem,f);if(m!==c){b.result=m;if(m===false){b.preventDefault();b.stopPropagation()}}}}}g.postDispatch&&g.postDispatch.call(this,b);return b.result}},props:"attrChange,attrName,relatedNode,srcElement,altKey,bubbles,cancelable,ctrlKey,currentTarget,eventPhase,metaKey,relatedTarget,shiftKey,target,timeStamp,view,which".split(","),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){if(a.which==null)a.which=b.charCode!=null?b.charCode:b.keyCode;
return a}},mouseHooks:{props:"button,buttons,clientX,clientY,fromElement,offsetX,offsetY,pageX,pageY,screenX,screenY,toElement".split(","),filter:function(a,b){var d,e,f=b.button,k=b.fromElement;if(a.pageX==null&&b.clientX!=null){d=a.target.ownerDocument||v;e=d.documentElement;d=d.body;a.pageX=b.clientX+(e&&e.scrollLeft||d&&d.scrollLeft||0)-(e&&e.clientLeft||d&&d.clientLeft||0);a.pageY=b.clientY+(e&&e.scrollTop||d&&d.scrollTop||0)-(e&&e.clientTop||d&&d.clientTop||0)}if(!a.relatedTarget&&k)a.relatedTarget=
k===a.target?b.toElement:k;if(!a.which&&f!==c)a.which=f&1?1:f&2?3:f&4?2:0;return a}},fix:function(a){if(a[h.expando])return a;var b,d,e=a,f=h.event.fixHooks[a.type]||{},k=f.props?this.props.concat(f.props):this.props,a=h.Event(e);for(b=k.length;b;){d=k[--b];a[d]=e[d]}if(!a.target)a.target=e.srcElement||v;if(a.target.nodeType===3)a.target=a.target.parentNode;if(a.metaKey===c)a.metaKey=a.ctrlKey;return f.filter?f.filter(a,e):a},special:{ready:{setup:h.bindReady},load:{noBubble:!0},focus:{delegateType:"focusin"},
...
postDispatch:function(a){if(a._submit_bubble){delete a._submit_bubble;this.parentNode&&!a.isTrigger&&h.event.simulate("submit",this.parentNode,a,true)}},teardown:function(){if(h.nodeName(this,"form"))return false;h.event.remove(this,"._submit")}});h.support.changeBubbles||(h.event.special.change={setup:function(){if(T.test(this.nodeName)){if(this.type==="checkbox"||this.type==="radio"){h.event.add(this,"propertychange._change",function(a){if(a.originalEvent.propertyName==="checked")this._just_changed=
true});h.event.add(this,"click._change",function(a){if(this._just_changed&&!a.isTrigger){this._just_changed=false;h.event.simulate("change",this,a,true)}})}return false}h.event.add(this,"beforeactivate._change",function(a){a=a.target;if(T.test(a.nodeName)&&!a._change_attached){h.event.add(a,"change._change",function(a){this.parentNode&&!a.isSimulated&&!a.isTrigger&&h.event.simulate("change",this.parentNode,a,true)});a._change_attached=true}})},handle:function(a){var b=a.target;if(this!==b||a.isSimulated||
a.isTrigger||b.type!=="radio"&&b.type!=="checkbox")return a.handleObj.handler.apply(this,arguments)},teardown:function(){h.event.remove(this,"._change");return T.test(this.nodeName)}});h.support.focusinBubbles||h.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){h.event.simulate(b,a.target,h.event.fix(a),true)};h.event.special[b]={setup:function(){c++===0&&v.addEventListener(a,d,true)},teardown:function(){--c===0&&v.removeEventListener(a,d,true)}}});h.fn.extend({on:function(a,
b,d,e,f){var k,i;if(typeof a==="object"){if(typeof b!=="string"){d=d||b;b=c}for(i in a)this.on(i,b,d,a[i],f);return this}if(d==null&&e==null){e=b;d=b=c}else if(e==null)if(typeof b==="string"){e=d;d=c}else{e=d;d=b;b=c}if(e===false)e=g;else if(!e)return this;if(f===1){k=e;e=function(a){h().off(a);return k.apply(this,arguments)};e.guid=k.guid||(k.guid=h.guid++)}return this.each(function(){h.event.add(this,a,e,d,b)})},one:function(a,b,c,d){return this.on(a,b,c,d,1)},off:function(a,b,d){if(a&&a.preventDefault&&
...
0?this.on(b,null,a,c):this.trigger(b)};h.attrFn&&(h.attrFn[b]=true);if(ja.test(b))h.event.fixHooks[b]=h.event.keyHooks;if(fa.test(b))h.event.fixHooks[b]=h.event.mouseHooks});(function(){function a(b,c,d,f,k,g){for(var k=0,i=f.length;k<i;k++){var j=f[k];if(j){for(var h=false,j=j[b];j;){if(j[e]===d){h=f[j.sizset];break}if(j.nodeType===1&&!g){j[e]=d;j.sizset=k}if(j.nodeName.toLowerCase()===c){h=j;break}j=j[b]}f[k]=h}}}function b(a,c,d,f,k,g){for(var k=0,i=f.length;k<i;k++){var j=f[k];if(j){for(var h=
false,j=j[a];j;){if(j[e]===d){h=f[j.sizset];break}if(j.nodeType===1){if(!g){j[e]=d;j.sizset=k}if(typeof c!=="string"){if(j===c){h=true;break}}else if(m.filter(c,[j]).length>0){h=j;break}}j=j[a]}f[k]=h}}}var d=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,e="sizcache"+(Math.random()+"").replace(".",""),f=0,k=Object.prototype.toString,g=false,i=true,j=/\\/g,t=/\r\n/g,l=/\W/;[0,0].sort(function(){i=false;return 0});
var m=function(a,b,c,e){var c=c||[],f=b=b||v;if(b.nodeType!==1&&b.nodeType!==9)return[];if(!a||typeof a!=="string")return c;var g,i,j,h,t,B=true,l=m.isXML(b),n=[],r=a;do{d.exec("");if(g=d.exec(r)){r=g[3];n.push(g[1]);if(g[2]){h=g[3];break}}}while(g);if(n.length>1&&p.exec(a))if(n.length===2&&x.relative[n[0]])i=w(n[0]+n[1],b,e);else for(i=x.relative[n[0]]?[b]:m(n.shift(),b);n.length;){a=n.shift();x.relative[a]&&(a=a+n.shift());i=w(a,i,e)}else{if(!e&&n.length>1&&b.nodeType===9&&!l&&x.match.ID.test(n[0])&&
!x.match.ID.test(n[n.length-1])){g=m.find(n.shift(),b,l);b=g.expr?m.filter(g.expr,g.set)[0]:g.set[0]}if(b){g=e?{expr:n.pop(),set:s(e)}:m.find(n.pop(),n.length===1&&(n[0]==="~"||n[0]==="+")&&b.parentNode?b.parentNode:b,l);i=g.expr?m.filter(g.expr,g.set):g.set;for(n.length>0?j=s(i):B=false;n.length;){g=t=n.pop();x.relative[t]?g=n.pop():t="";g==null&&(g=b);x.relative[t](j,g,l)}}else j=[]}j||(j=i);j||m.error(t||a);if(k.call(j)==="[object Array]")if(B)if(b&&b.nodeType===1)for(a=0;j[a]!=null;a++)j[a]&&
(j[a]===true||j[a].nodeType===1&&m.contains(b,j[a]))&&c.push(i[a]);else for(a=0;j[a]!=null;a++)j[a]&&j[a].nodeType===1&&c.push(i[a]);else c.push.apply(c,j);else s(j,c);if(h){m(h,f,c,e);m.uniqueSort(c)}return c};m.uniqueSort=function(a){if(K){g=i;a.sort(K);if(g)for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1)}return a};m.matches=function(a,b){return m(a,null,null,b)};m.matchesSelector=function(a,b){return m(b,null,null,[a]).length>0};m.find=function(a,b,c){var d,e,f,k,g,i;if(!a)return[];e=
0;for(f=x.order.length;e<f;e++){g=x.order[e];if(k=x.leftMatch[g].exec(a)){i=k[1];k.splice(1,1);if(i.substr(i.length-1)!=="\\"){k[1]=(k[1]||"").replace(j,"");d=x.find[g](k,b,c);if(d!=null){a=a.replace(x.match[g],"");break}}}}d||(d=typeof b.getElementsByTagName!=="undefined"?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};m.filter=function(a,b,d,e){for(var f,k,g,i,j,h,t,B,l=a,n=[],p=b,r=b&&b[0]&&m.isXML(b[0]);a&&b.length;){for(g in x.filter)if((f=x.leftMatch[g].exec(a))!=null&&f[2]){h=x.filter[g];
j=f[1];k=false;f.splice(1,1);if(j.substr(j.length-1)!=="\\"){p===n&&(n=[]);if(x.preFilter[g])if(f=x.preFilter[g](f,p,d,n,e,r)){if(f===true)continue}else k=i=true;if(f)for(t=0;(j=p[t])!=null;t++)if(j){i=h(j,f,t,p);B=e^i;if(d&&i!=null)B?k=true:p[t]=false;else if(B){n.push(j);k=true}}if(i!==c){d||(p=n);a=a.replace(x.match[g],"");if(!k)return[];break}}}if(a===l)if(k==null)m.error(a);else break;l=a}return p};m.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};var n=m.getText=
function(a){var b,c;b=a.nodeType;var d="";if(b)if(b===1||b===9||b===11){if(typeof a.textContent==="string")return a.textContent;if(typeof a.innerText==="string")return a.innerText.replace(t,"");for(a=a.firstChild;a;a=a.nextSibling)d=d+n(a)}else{if(b===3||b===4)return a.nodeValue}else for(b=0;c=a[b];b++)c.nodeType!==8&&(d=d+n(c));return d},x=m.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,
ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/,TAG:/^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/,CHILD:/:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/,POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/,PSEUDO:/:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/},leftMatch:{},attrMap:{"class":"className","for":"htmlFor"},attrHandle:{href:function(a){return a.getAttribute("href")},
type:function(a){return a.getAttribute("type")}},relative:{"+":function(a,b){var c=typeof b==="string",d=c&&!l.test(b),c=c&&!d;d&&(b=b.toLowerCase());for(var d=0,e=a.length,f;d<e;d++)if(f=a[d]){for(;(f=f.previousSibling)&&f.nodeType!==1;);a[d]=c||f&&f.nodeName.toLowerCase()===b?f||false:f===b}c&&m.filter(b,a,true)},">":function(a,b){var c,d=typeof b==="string",e=0,f=a.length;if(d&&!l.test(b))for(b=b.toLowerCase();e<f;e++){if(c=a[e]){c=c.parentNode;a[e]=c.nodeName.toLowerCase()===b?c:false}}else{for(;e<
f;e++)(c=a[e])&&(a[e]=d?c.parentNode:c.parentNode===b);d&&m.filter(b,a,true)}},"":function(c,d,e){var k,g=f++,i=b;if(typeof d==="string"&&!l.test(d)){k=d=d.toLowerCase();i=a}i("parentNode",d,g,c,k,e)},"~":function(c,d,e){var k,g=f++,i=b;if(typeof d==="string"&&!l.test(d)){k=d=d.toLowerCase();i=a}i("previousSibling",d,g,c,k,e)}},find:{ID:function(a,b,c){if(typeof b.getElementById!=="undefined"&&!c)return(a=b.getElementById(a[1]))&&a.parentNode?[a]:[]},NAME:function(a,b){if(typeof b.getElementsByName!==
"undefined"){for(var c=[],d=b.getElementsByName(a[1]),e=0,f=d.length;e<f;e++)d[e].getAttribute("name")===a[1]&&c.push(d[e]);return c.length===0?null:c}},TAG:function(a,b){if(typeof b.getElementsByTagName!=="undefined")return b.getElementsByTagName(a[1])}},preFilter:{CLASS:function(a,b,c,d,e,f){a=" "+a[1].replace(j,"")+" ";if(f)return a;for(var f=0,k;(k=b[f])!=null;f++)k&&(e^(k.className&&(" "+k.className+" ").replace(/[\t\n\r]/g," ").indexOf(a)>=0)?c||d.push(k):c&&(b[f]=false));return false},ID:function(a){return a[1].replace(j,
"")},TAG:function(a){return a[1].replace(j,"").toLowerCase()},CHILD:function(a){if(a[1]==="nth"){a[2]||m.error(a[0]);a[2]=a[2].replace(/^\+|\s*/g,"");var b=/(-?)(\d*)(?:n([+\-]?\d*))?/.exec(a[2]==="even"&&"2n"||a[2]==="odd"&&"2n+1"||!/\D/.test(a[2])&&"0n+"+a[2]||a[2]);a[2]=b[1]+(b[2]||1)-0;a[3]=b[3]-0}else a[2]&&m.error(a[0]);a[0]=f++;return a},ATTR:function(a,b,c,d,e,f){b=a[1]=a[1].replace(j,"");!f&&x.attrMap[b]&&(a[1]=x.attrMap[b]);a[4]=(a[4]||a[5]||"").replace(j,"");a[2]==="~="&&(a[4]=" "+a[4]+
" ");return a},PSEUDO:function(a,b,c,e,f){if(a[1]==="not")if((d.exec(a[3])||"").length>1||/^\w/.test(a[3]))a[3]=m(a[3],null,null,b);else{a=m.filter(a[3],b,c,1^f);c||e.push.apply(e,a);return false}else if(x.match.POS.test(a[0])||x.match.CHILD.test(a[0]))return true;return a},POS:function(a){a.unshift(true);return a}},filters:{enabled:function(a){return a.disabled===false&&a.type!=="hidden"},disabled:function(a){return a.disabled===true},checked:function(a){return a.checked===true},selected:function(a){a.parentNode&&
...
b,c,d){var e=b[1],f=x.filters[e];if(f)return f(a,c,b,d);if(e==="contains")return(a.textContent||a.innerText||n([a])||"").indexOf(b[3])>=0;if(e==="not"){b=b[3];c=0;for(d=b.length;c<d;c++)if(b[c]===a)return false;return true}m.error(e)},CHILD:function(a,b){var c,d,f,k,g,i;c=b[1];i=a;switch(c){case "only":case "first":for(;i=i.previousSibling;)if(i.nodeType===1)return false;if(c==="first")return true;i=a;case "last":for(;i=i.nextSibling;)if(i.nodeType===1)return false;return true;case "nth":c=b[2];d=
b[3];if(c===1&&d===0)return true;f=b[0];if((k=a.parentNode)&&(k[e]!==f||!a.nodeIndex)){g=0;for(i=k.firstChild;i;i=i.nextSibling)if(i.nodeType===1)i.nodeIndex=++g;k[e]=f}i=a.nodeIndex-d;return c===0?i===0:i%c===0&&i/c>=0}},ID:function(a,b){return a.nodeType===1&&a.getAttribute("id")===b},TAG:function(a,b){return b==="*"&&a.nodeType===1||!!a.nodeName&&a.nodeName.toLowerCase()===b},CLASS:function(a,b){return(" "+(a.className||a.getAttribute("class"))+" ").indexOf(b)>-1},ATTR:function(a,b){var c=b[1],
c=m.attr?m.attr(a,c):x.attrHandle[c]?x.attrHandle[c](a):a[c]!=null?a[c]:a.getAttribute(c),d=c+"",e=b[2],f=b[4];return c==null?e==="!=":!e&&m.attr?c!=null:e==="="?d===f:e==="*="?d.indexOf(f)>=0:e==="~="?(" "+d+" ").indexOf(f)>=0:!f?d&&c!==false:e==="!="?d!==f:e==="^="?d.indexOf(f)===0:e==="$="?d.substr(d.length-f.length)===f:e==="|="?d===f||d.substr(0,f.length+1)===f+"-":false},POS:function(a,b,c,d){var e=x.setFilters[b[2]];if(e)return e(a,c,b,d)}}},p=x.match.POS,r=function(a,b){return"\\"+(b-0+1)},
o;for(o in x.match){x.match[o]=RegExp(x.match[o].source+/(?![^\[]*\])(?![^\(]*\))/.source);x.leftMatch[o]=RegExp(/(^(?:.|\r|\n)*?)/.source+x.match[o].source.replace(/\\(\d+)/g,r))}x.match.globalPOS=p;var s=function(a,b){a=Array.prototype.slice.call(a,0);if(b){b.push.apply(b,a);return b}return a};try{Array.prototype.slice.call(v.documentElement.childNodes,0)[0].nodeType}catch(O){s=function(a,b){var c=0,d=b||[];if(k.call(a)==="[object Array]")Array.prototype.push.apply(d,a);else if(typeof a.length===
"number")for(var e=a.length;c<e;c++)d.push(a[c]);else for(;a[c];c++)d.push(a[c]);return d}}var K,q;if(v.documentElement.compareDocumentPosition)K=function(a,b){if(a===b){g=true;return 0}return!a.compareDocumentPosition||!b.compareDocumentPosition?a.compareDocumentPosition?-1:1:a.compareDocumentPosition(b)&4?-1:1};else{K=function(a,b){if(a===b){g=true;return 0}if(a.sourceIndex&&b.sourceIndex)return a.sourceIndex-b.sourceIndex;var c,d,e=[],f=[];c=a.parentNode;d=b.parentNode;var k=c;if(c===d)return q(a,
b);if(c){if(!d)return 1}else return-1;for(;k;){e.unshift(k);k=k.parentNode}for(k=d;k;){f.unshift(k);k=k.parentNode}c=e.length;d=f.length;for(k=0;k<c&&k<d;k++)if(e[k]!==f[k])return q(e[k],f[k]);return k===c?q(a,f[k],-1):q(e[k],b,1)};q=function(a,b,c){if(a===b)return c;for(a=a.nextSibling;a;){if(a===b)return-1;a=a.nextSibling}return 1}}(function(){var a=v.createElement("div"),b="script"+(new Date).getTime(),d=v.documentElement;a.innerHTML="<a name='"+b+"'/>";d.insertBefore(a,d.firstChild);if(v.getElementById(b)){x.find.ID=
function(a,b,d){if(typeof b.getElementById!=="undefined"&&!d)return(b=b.getElementById(a[1]))?b.id===a[1]||typeof b.getAttributeNode!=="undefined"&&b.getAttributeNode("id").nodeValue===a[1]?[b]:c:[]};x.filter.ID=function(a,b){var c=typeof a.getAttributeNode!=="undefined"&&a.getAttributeNode("id");return a.nodeType===1&&c&&c.nodeValue===b}}d.removeChild(a);d=a=null})();(function(){var a=v.createElement("div");a.appendChild(v.createComment(""));if(a.getElementsByTagName("*").length>0)x.find.TAG=function(a,
b){var c=b.getElementsByTagName(a[1]);if(a[1]==="*"){for(var d=[],e=0;c[e];e++)c[e].nodeType===1&&d.push(c[e]);c=d}return c};a.innerHTML="<a href='#'></a>";if(a.firstChild&&typeof a.firstChild.getAttribute!=="undefined"&&a.firstChild.getAttribute("href")!=="#")x.attrHandle.href=function(a){return a.getAttribute("href",2)};a=null})();v.querySelectorAll&&function(){var a=m,b=v.createElement("div");b.innerHTML="<p class='TEST'></p>";if(!(b.querySelectorAll&&b.querySelectorAll(".TEST").length===0)){m=
function(b,c,d,e){c=c||v;if(!e&&!m.isXML(c)){var f=/^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(b);if(f&&(c.nodeType===1||c.nodeType===9)){if(f[1])return s(c.getElementsByTagName(b),d);if(f[2]&&x.find.CLASS&&c.getElementsByClassName)return s(c.getElementsByClassName(f[2]),d)}if(c.nodeType===9){if(b==="body"&&c.body)return s([c.body],d);if(f&&f[3]){var k=c.getElementById(f[3]);if(k&&k.parentNode){if(k.id===f[3])return s([k],d)}else return s([],d)}try{return s(c.querySelectorAll(b),d)}catch(g){}}else if(c.nodeType===
1&&c.nodeName.toLowerCase()!=="object"){var f=c,i=(k=c.getAttribute("id"))||"__sizzle__",j=c.parentNode,h=/^\s*[+~]/.test(b);k?i=i.replace(/'/g,"\\$&"):c.setAttribute("id",i);if(h&&j)c=c.parentNode;try{if(!h||j)return s(c.querySelectorAll("[id='"+i+"'] "+b),d)}catch(t){}finally{k||f.removeAttribute("id")}}}return a(b,c,d,e)};for(var c in a)m[c]=a[c];b=null}}();(function(){var a=v.documentElement,b=a.matchesSelector||a.mozMatchesSelector||a.webkitMatchesSelector||a.msMatchesSelector;if(b){var c=!b.call(v.createElement("div"),
"div"),d=false;try{b.call(v.documentElement,"[test!='']:sizzle")}catch(e){d=true}m.matchesSelector=function(a,e){e=e.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!m.isXML(a))try{if(d||!x.match.PSEUDO.test(e)&&!/!=/.test(e)){var f=b.call(a,e);if(f||!c||a.document&&a.document.nodeType!==11)return f}}catch(k){}return m(e,null,null,[a]).length>0}}})();(function(){var a=v.createElement("div");a.innerHTML="<div class='test e'></div><div class='test'></div>";if(a.getElementsByClassName&&a.getElementsByClassName("e").length!==
0){a.lastChild.className="e";if(a.getElementsByClassName("e").length!==1){x.order.splice(1,0,"CLASS");x.find.CLASS=function(a,b,c){if(typeof b.getElementsByClassName!=="undefined"&&!c)return b.getElementsByClassName(a[1])};a=null}}})();m.contains=v.documentElement.contains?function(a,b){return a!==b&&(a.contains?a.contains(b):true)}:v.documentElement.compareDocumentPosition?function(a,b){return!!(a.compareDocumentPosition(b)&16)}:function(){return false};m.isXML=function(a){return(a=(a?a.ownerDocument||
a:0).documentElement)?a.nodeName!=="HTML":false};var w=function(a,b,c){for(var d,e=[],f="",b=b.nodeType?[b]:b;d=x.match.PSEUDO.exec(a);){f=f+d[0];a=a.replace(x.match.PSEUDO,"")}a=x.relative[a]?a+"*":a;d=0;for(var k=b.length;d<k;d++)m(a,b[d],e,c);return m.filter(f,e)};m.attr=h.attr;m.selectors.attrMap={};h.find=m;h.expr=m.selectors;h.expr[":"]=h.expr.filters;h.unique=m.uniqueSort;h.text=m.getText;h.isXMLDoc=m.isXML;h.contains=m.contains})();var la=/Until$/,ma=/^(?:parents|prevUntil|prevAll)/,ia=/,/,
Wa=/^.[^:#\[\.,]*$/,Xa=Array.prototype.slice,Da=h.expr.match.globalPOS,Ya={children:!0,contents:!0,next:!0,prev:!0};h.fn.extend({find:function(a){var b=this,c,d;if(typeof a!=="string")return h(a).filter(function(){c=0;for(d=b.length;c<d;c++)if(h.contains(b[c],this))return true});var e=this.pushStack("","find",a),f,k,g;c=0;for(d=this.length;c<d;c++){f=e.length;h.find(a,this[c],e);if(c>0)for(k=f;k<e.length;k++)for(g=0;g<f;g++)if(e[g]===e[k]){e.splice(k--,1);break}}return e},has:function(a){var b=h(a);
return this.filter(function(){for(var a=0,c=b.length;a<c;a++)if(h.contains(this,b[a]))return true})},not:function(a){return this.pushStack(j(this,a,false),"not",a)},filter:function(a){return this.pushStack(j(this,a,true),"filter",a)},is:function(a){return!!a&&(typeof a==="string"?Da.test(a)?h(a,this.context).index(this[0])>=0:h.filter(a,this).length>0:this.filter(a).length>0)},closest:function(a,b){var c=[],d,e,f=this[0];if(h.isArray(a)){for(e=1;f&&f.ownerDocument&&f!==b;){for(d=0;d<a.length;d++)h(f).is(a[d])&&
c.push({selector:a[d],elem:f,level:e});f=f.parentNode;e++}return c}var k=Da.test(a)||typeof a!=="string"?h(a,b||this.context):0;d=0;for(e=this.length;d<e;d++)for(f=this[d];f;)if(k?k.index(f)>-1:h.find.matchesSelector(f,a)){c.push(f);break}else{f=f.parentNode;if(!f||!f.ownerDocument||f===b||f.nodeType===11)break}c=c.length>1?h.unique(c):c;return this.pushStack(c,"closest",a)},index:function(a){return!a?this[0]&&this[0].parentNode?this.prevAll().length:-1:typeof a==="string"?h.inArray(this[0],h(a)):
...
"iframe")?a.contentDocument||a.contentWindow.document:h.makeArray(a.childNodes)}},function(a,b){h.fn[a]=function(c,d){var e=h.map(this,b,c);la.test(a)||(d=c);d&&typeof d==="string"&&(e=h.filter(d,e));e=this.length>1&&!Ya[a]?h.unique(e):e;if((this.length>1||ia.test(d))&&ma.test(a))e=e.reverse();return this.pushStack(e,a,Xa.call(arguments).join(","))}});h.extend({filter:function(a,b,c){c&&(a=":not("+a+")");return b.length===1?h.find.matchesSelector(b[0],a)?[b[0]]:[]:h.find.matches(a,b)},dir:function(a,
b,d){for(var e=[],a=a[b];a&&a.nodeType!==9&&(d===c||a.nodeType!==1||!h(a).is(d));){a.nodeType===1&&e.push(a);a=a[b]}return e},nth:function(a,b,c){for(var b=b||1,d=0;a;a=a[c])if(a.nodeType===1&&++d===b)break;return a},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)a.nodeType===1&&a!==b&&c.push(a);return c}});var Ea="abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",Za=/ jQuery\d+="(?:\d+|null)"/g,
sa=/^\s+/,Fa=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Ga=/<([\w:]+)/,$a=/<tbody/i,ab=/<|&#?\w+;/,bb=/<(?:script|style)/i,cb=/<(?:script|object|embed|option|style)/i,Ha=RegExp("<(?:"+Ea+")[\\s/>]","i"),Ia=/checked\s*(?:[^=]|=\s*.checked.)/i,Ja=/\/(java|ecma)script/i,fb=/^\s*<!(?:\[CDATA\[|\-\-)/,U={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,
"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]},Aa=l(v);U.optgroup=U.option;U.tbody=U.tfoot=U.colgroup=U.caption=U.thead;U.th=U.td;h.support.htmlSerialize||(U._default=[1,"div<div>","</div>"]);h.fn.extend({text:function(a){return h.access(this,function(a){return a===c?h.text(this):this.empty().append((this[0]&&this[0].ownerDocument||v).createTextNode(a))},null,a,arguments.length)},wrapAll:function(a){if(h.isFunction(a))return this.each(function(b){h(this).wrapAll(a.call(this,
...
"string"&&!bb.test(a)&&(h.support.leadingWhitespace||!sa.test(a))&&!U[(Ga.exec(a)||["",""])[1].toLowerCase()]){a=a.replace(Fa,"<$1></$2>");try{for(;d<e;d++){b=this[d]||{};if(b.nodeType===1){h.cleanData(b.getElementsByTagName("*"));b.innerHTML=a}}b=0}catch(f){}}b&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){if(this[0]&&this[0].parentNode){if(h.isFunction(a))return this.each(function(b){var c=h(this),d=c.html();c.replaceWith(a.call(this,b,d))});typeof a!=="string"&&(a=
h(a).detach());return this.each(function(){var b=this.nextSibling,c=this.parentNode;h(this).remove();b?h(b).before(a):h(c).append(a)})}return this.length?this.pushStack(h(h.isFunction(a)?a():a),"replaceWith",a):this},detach:function(a){return this.remove(a,true)},domManip:function(a,b,d){var e,f,k,g=a[0],i=[];if(!h.support.checkClone&&arguments.length===3&&typeof g==="string"&&Ia.test(g))return this.each(function(){h(this).domManip(a,b,d,true)});if(h.isFunction(g))return this.each(function(e){var f=
h(this);a[0]=g.call(this,e,b?f.html():c);f.domManip(a,b,d)});if(this[0]){e=g&&g.parentNode;e=h.support.parentNode&&e&&e.nodeType===11&&e.childNodes.length===this.length?{fragment:e}:h.buildFragment(a,this,i);k=e.fragment;if(f=k.childNodes.length===1?k=k.firstChild:k.firstChild){b=b&&h.nodeName(f,"tr");f=0;for(var j=this.length,t=j-1;f<j;f++)d.call(b?h.nodeName(this[f],"table")?this[f].getElementsByTagName("tbody")[0]||this[f].appendChild(this[f].ownerDocument.createElement("tbody")):this[f]:this[f],
e.cacheable||j>1&&f<t?h.clone(k,true,true):k)}i.length&&h.each(i,function(a,b){b.src?h.ajax({type:"GET",global:false,url:b.src,async:false,dataType:"script"}):h.globalEval((b.text||b.textContent||b.innerHTML||"").replace(fb,"/*$0*/"));b.parentNode&&b.parentNode.removeChild(b)})}return this}});h.buildFragment=function(a,b,c){var d,e,f,k,g=a[0];b&&b[0]&&(k=b[0].ownerDocument||b[0]);k.createDocumentFragment||(k=v);if(a.length===1&&typeof g==="string"&&g.length<512&&k===v&&g.charAt(0)==="<"&&!cb.test(g)&&
(h.support.checkClone||!Ia.test(g))&&(h.support.html5Clone||!Ha.test(g))){e=true;(f=h.fragments[g])&&f!==1&&(d=f)}if(!d){d=k.createDocumentFragment();h.clean(a,k,d,c)}e&&(h.fragments[g]=f?d:1);return{fragment:d,cacheable:e}};h.fragments={};h.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){h.fn[a]=function(c){var d=[],c=h(c),e=this.length===1&&this[0].parentNode;if(e&&e.nodeType===11&&e.childNodes.length===1&&c.length===
1){c[b](this[0]);return this}for(var e=0,f=c.length;e<f;e++){var k=(e>0?this.clone(true):this).get();h(c[e])[b](k);d=d.concat(k)}return this.pushStack(d,a,c.selector)}});h.extend({clone:function(a,b,c){var d,e,f;if(h.support.html5Clone||h.isXMLDoc(a)||!Ha.test("<"+a.nodeName+">"))d=a.cloneNode(true);else{d=v.createElement("div");Aa.appendChild(d);d.innerHTML=a.outerHTML;d=d.firstChild}var k=d;if((!h.support.noCloneEvent||!h.support.noCloneChecked)&&(a.nodeType===1||a.nodeType===11)&&!h.isXMLDoc(a)){n(a,
k);d=m(a);e=m(k);for(f=0;d[f];++f)e[f]&&n(d[f],e[f])}if(b){p(a,k);if(c){d=m(a);e=m(k);for(f=0;d[f];++f)p(d[f],e[f])}}return k},clean:function(a,b,c,d){var e,f=[],b=b||v;typeof b.createElement==="undefined"&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||v);for(var k=0,g;(g=a[k])!=null;k++){typeof g==="number"&&(g=g+"");if(g){if(typeof g==="string")if(ab.test(g)){g=g.replace(Fa,"<$1></$2>");e=(Ga.exec(g)||["",""])[1].toLowerCase();var i=U[e]||U._default,j=i[0],t=b.createElement("div"),m=Aa.childNodes;
b===v?Aa.appendChild(t):l(b).appendChild(t);for(t.innerHTML=i[1]+g+i[2];j--;)t=t.lastChild;if(!h.support.tbody){j=$a.test(g);i=e==="table"&&!j?t.firstChild&&t.firstChild.childNodes:i[1]==="<table>"&&!j?t.childNodes:[];for(e=i.length-1;e>=0;--e)h.nodeName(i[e],"tbody")&&!i[e].childNodes.length&&i[e].parentNode.removeChild(i[e])}!h.support.leadingWhitespace&&sa.test(g)&&t.insertBefore(b.createTextNode(sa.exec(g)[0]),t.firstChild);g=t.childNodes;if(t){t.parentNode.removeChild(t);if(m.length>0)(t=m[m.length-
1])&&t.parentNode&&t.parentNode.removeChild(t)}}else g=b.createTextNode(g);var x;if(!h.support.appendChecked)if(g[0]&&typeof(x=g.length)==="number")for(e=0;e<x;e++)s(g[e]);else s(g);g.nodeType?f.push(g):f=h.merge(f,g)}}if(c){a=function(a){return!a.type||Ja.test(a.type)};for(k=0;f[k];k++){b=f[k];if(d&&h.nodeName(b,"script")&&(!b.type||Ja.test(b.type)))d.push(b.parentNode?b.parentNode.removeChild(b):b);else{if(b.nodeType===1){g=h.grep(b.getElementsByTagName("script"),a);f.splice.apply(f,[k+1,0].concat(g))}c.appendChild(b)}}}return f},
cleanData:function(a){for(var b,c,d=h.cache,e=h.event.special,f=h.support.deleteExpando,k=0,g;(g=a[k])!=null;k++)if(!g.nodeName||!h.noData[g.nodeName.toLowerCase()])if(c=g[h.expando]){if((b=d[c])&&b.events){for(var i in b.events)e[i]?h.event.remove(g,i):h.removeEvent(g,i,b.handle);if(b.handle)b.handle.elem=null}f?delete g[h.expando]:g.removeAttribute&&g.removeAttribute(h.expando);delete d[c]}}});var Ba=/alpha\([^)]*\)/i,gb=/opacity=([^)]*)/,hb=/([A-Z]|^ms)/g,ib=/^[\-+]?(?:\d*\.)?\d+$/i,va=/^-?(?:\d*\.)?\d+(?!px)[^\d\s]+$/i,
jb=/^([\-+])=([\-+.\de]+)/,kb=/^margin/,lb={position:"absolute",visibility:"hidden",display:"block"},Y=["Top","Right","Bottom","Left"],ba,Ma,Na;h.fn.css=function(a,b){return h.access(this,function(a,b,d){return d!==c?h.style(a,b,d):h.css(a,b)},a,b,arguments.length>1)};h.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=ba(a,"opacity");return c===""?"1":c}return a.style.opacity}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":h.support.cssFloat?
"cssFloat":"styleFloat"},style:function(a,b,d,e){if(a&&!(a.nodeType===3||a.nodeType===8||!a.style)){var f,k=h.camelCase(b),g=a.style,i=h.cssHooks[k],b=h.cssProps[k]||k;if(d!==c){e=typeof d;if(e==="string"&&(f=jb.exec(d))){d=+(f[1]+1)*+f[2]+parseFloat(h.css(a,b));e="number"}if(!(d==null||e==="number"&&isNaN(d))){e==="number"&&!h.cssNumber[k]&&(d=d+"px");if(!i||!("set"in i)||(d=i.set(a,d))!==c)try{g[b]=d}catch(j){}}}else return i&&"get"in i&&(f=i.get(a,false,e))!==c?f:g[b]}},css:function(a,b,d){var e,
f,b=h.camelCase(b);f=h.cssHooks[b];b=h.cssProps[b]||b;b==="cssFloat"&&(b="float");if(f&&"get"in f&&(e=f.get(a,true,d))!==c)return e;if(ba)return ba(a,b)},swap:function(a,b,c){var d={},e;for(e in b){d[e]=a.style[e];a.style[e]=b[e]}c=c.call(a);for(e in b)a.style[e]=d[e];return c}});h.curCSS=h.css;v.defaultView&&v.defaultView.getComputedStyle&&(Ma=function(a,b){var c,d,e,f=a.style,b=b.replace(hb,"-$1").toLowerCase();if((d=a.ownerDocument.defaultView)&&(e=d.getComputedStyle(a,null))){c=e.getPropertyValue(b);
c===""&&!h.contains(a.ownerDocument.documentElement,a)&&(c=h.style(a,b))}if(!h.support.pixelMargin&&e&&kb.test(b)&&va.test(c)){d=f.width;f.width=c;c=e.width;f.width=d}return c});v.documentElement.currentStyle&&(Na=function(a,b){var c,d,e=a.currentStyle&&a.currentStyle[b],f=a.style;if(e==null&&f&&(c=f[b]))e=c;if(va.test(e)){c=f.left;if(d=a.runtimeStyle&&a.runtimeStyle.left)a.runtimeStyle.left=a.currentStyle.left;f.left=b==="fontSize"?"1em":e;e=f.pixelLeft+"px";f.left=c;if(d)a.runtimeStyle.left=d}return e===
""?"auto":e});ba=Ma||Na;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){if(c)return a.offsetWidth!==0?o(a,b,d):h.swap(a,lb,function(){return o(a,b,d)})},set:function(a,b){return ib.test(b)?b+"px":b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return gb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,e=h.isNumeric(b)?"alpha(opacity="+b*100+")":"",f=
d&&d.filter||c.filter||"";c.zoom=1;if(b>=1&&h.trim(f.replace(Ba,""))===""){c.removeAttribute("filter");if(d&&!d.filter)return}c.filter=Ba.test(f)?f.replace(Ba,e):f+" "+e}});h(function(){if(!h.support.reliableMarginRight)h.cssHooks.marginRight={get:function(a,b){return h.swap(a,{display:"inline-block"},function(){return b?ba(a,"margin-right"):a.style.marginRight})}}});h.expr&&h.expr.filters&&(h.expr.filters.hidden=function(a){var b=a.offsetHeight;return a.offsetWidth===0&&b===0||!h.support.reliableHiddenOffsets&&
(a.style&&a.style.display||h.css(a,"display"))==="none"},h.expr.filters.visible=function(a){return!h.expr.filters.hidden(a)});h.each({margin:"",padding:"",border:"Width"},function(a,b){h.cssHooks[a+b]={expand:function(c){for(var d=typeof c==="string"?c.split(" "):[c],e={},c=0;c<4;c++)e[a+Y[c]+b]=d[c]||d[c-2]||d[0];return e}}});var mb=/%20/g,db=/\[\]$/,Oa=/\r?\n/g,nb=/#.*$/,ob=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,pb=/^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
qb=/^(?:GET|HEAD)$/,rb=/^\/\//,Pa=/\?/,sb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,tb=/^(?:select|textarea)/i,La=/\s+/,ub=/([?&])_=[^&]*/,Qa=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Ra=h.fn.load,wa={},Sa={},Z,$,Ta=["*/"]+["*"];try{Z=R.href}catch(Ab){Z=v.createElement("a"),Z.href="",Z=Z.href}$=Qa.exec(Z.toLowerCase())||[];h.fn.extend({load:function(a,b,d){if(typeof a!=="string"&&Ra)return Ra.apply(this,arguments);if(!this.length)return this;var e=a.indexOf(" ");if(e>=0)var f=a.slice(e,
a.length),a=a.slice(0,e);e="GET";if(b)if(h.isFunction(b)){d=b;b=c}else if(typeof b==="object"){b=h.param(b,h.ajaxSettings.traditional);e="POST"}var k=this;h.ajax({url:a,type:e,dataType:"html",data:b,complete:function(a,b,c){c=a.responseText;if(a.isResolved()){a.done(function(a){c=a});k.html(f?h("<div>").append(c.replace(sb,"")).find(f):c)}d&&k.each(d,[c,b,a])}});return this},serialize:function(){return h.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?
...
function(a,b){h[b]=function(a,d,e,f){if(h.isFunction(d)){f=f||e;e=d;d=c}return h.ajax({type:b,url:a,data:d,success:e,dataType:f})}});h.extend({getScript:function(a,b){return h.get(a,c,b,"script")},getJSON:function(a,b,c){return h.get(a,b,c,"json")},ajaxSetup:function(a,b){if(b)w(a,h.ajaxSettings);else{b=a;a=h.ajaxSettings}w(a,b);return a},ajaxSettings:{url:Z,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/.test($[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",
processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Ta},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:q(wa),ajaxTransport:q(Sa),ajax:function(a,b){function d(a,b,m,l){if(o!==2){o=2;r&&clearTimeout(r);p=c;x=l||"";q.readyState=
a>0?4:0;var n,s,B,l=b;if(m){var K=e,w=q,ua=K.contents,N=K.dataTypes,y=K.responseFields,u,v,W,V;for(v in y)v in m&&(w[y[v]]=m[v]);for(;N[0]==="*";){N.shift();u===c&&(u=K.mimeType||w.getResponseHeader("content-type"))}if(u)for(v in ua)if(ua[v]&&ua[v].test(u)){N.unshift(v);break}if(N[0]in m)W=N[0];else{for(v in m){if(!N[0]||K.converters[v+" "+N[0]]){W=v;break}V||(V=v)}W=W||V}if(W){W!==N[0]&&N.unshift(W);m=m[W]}else m=void 0}else m=c;if(a>=200&&a<300||a===304){if(e.ifModified){if(u=q.getResponseHeader("Last-Modified"))h.lastModified[t]=
u;if(u=q.getResponseHeader("Etag"))h.etag[t]=u}if(a===304){l="notmodified";n=true}else try{u=e;u.dataFilter&&(m=u.dataFilter(m,u.dataType));var A=u.dataTypes;v={};var z,E,F=A.length,C,T=A[0],D,H,G,I,J;for(z=1;z<F;z++){if(z===1)for(E in u.converters)typeof E==="string"&&(v[E.toLowerCase()]=u.converters[E]);D=T;T=A[z];if(T==="*")T=D;else if(D!=="*"&&D!==T){H=D+" "+T;G=v[H]||v["* "+T];if(!G){J=c;for(I in v){C=I.split(" ");if(C[0]===D||C[0]==="*")if(J=v[C[1]+" "+T]){I=v[I];I===true?G=J:J===true&&(G=I);
break}}}!G&&!J&&h.error("No conversion from "+H.replace(" "," to "));G!==true&&(m=G?G(m):J(I(m)))}}s=m;l="success";n=true}catch(M){l="parsererror";B=M}}else{B=l;if(!l||a){l="error";a<0&&(a=0)}}q.status=a;q.statusText=""+(b||l);n?g.resolveWith(f,[s,l,q]):g.rejectWith(f,[q,l,B]);q.statusCode(j);j=c;O&&k.trigger("ajax"+(n?"Success":"Error"),[q,e,n?s:B]);i.fireWith(f,[q,l]);if(O){k.trigger("ajaxComplete",[q,e]);--h.active||h.event.trigger("ajaxStop")}}}if(typeof a==="object"){b=a;a=c}var b=b||{},e=h.ajaxSetup({},
b),f=e.context||e,k=f!==e&&(f.nodeType||f instanceof h)?h(f):h.event,g=h.Deferred(),i=h.Callbacks("once memory"),j=e.statusCode||{},t,m={},l={},x,n,p,r,s,o=0,O,K,q={readyState:0,setRequestHeader:function(a,b){if(!o){var c=a.toLowerCase(),a=l[c]=l[c]||a;m[a]=b}return this},getAllResponseHeaders:function(){return o===2?x:null},getResponseHeader:function(a){var b;if(o===2){if(!n)for(n={};b=ob.exec(x);)n[b[1].toLowerCase()]=b[2];b=n[a.toLowerCase()]}return b===c?null:b},overrideMimeType:function(a){if(!o)e.mimeType=
a;return this},abort:function(a){a=a||"abort";p&&p.abort(a);d(0,a);return this}};g.promise(q);q.success=q.done;q.error=q.fail;q.complete=i.add;q.statusCode=function(a){if(a){var b;if(o<2)for(b in a)j[b]=[j[b],a[b]];else{b=a[q.status];q.then(b,b)}}return this};e.url=((a||e.url)+"").replace(nb,"").replace(rb,$[1]+"//");e.dataTypes=h.trim(e.dataType||"*").toLowerCase().split(La);if(e.crossDomain==null){s=Qa.exec(e.url.toLowerCase());e.crossDomain=!(!s||!(s[1]!=$[1]||s[2]!=$[2]||(s[3]||(s[1]==="http:"?
80:443))!=($[3]||($[1]==="http:"?80:443))))}if(e.data&&e.processData&&typeof e.data!=="string")e.data=h.param(e.data,e.traditional);y(wa,e,b,q);if(o===2)return false;O=e.global;e.type=e.type.toUpperCase();e.hasContent=!qb.test(e.type);O&&h.active++===0&&h.event.trigger("ajaxStart");if(!e.hasContent){if(e.data){e.url=e.url+((Pa.test(e.url)?"&":"?")+e.data);delete e.data}t=e.url;if(e.cache===false){s=h.now();var w=e.url.replace(ub,"$1_="+s);e.url=w+(w===e.url?(Pa.test(e.url)?"&":"?")+"_="+s:"")}}(e.data&&
e.hasContent&&e.contentType!==false||b.contentType)&&q.setRequestHeader("Content-Type",e.contentType);if(e.ifModified){t=t||e.url;h.lastModified[t]&&q.setRequestHeader("If-Modified-Since",h.lastModified[t]);h.etag[t]&&q.setRequestHeader("If-None-Match",h.etag[t])}q.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+(e.dataTypes[0]!=="*"?", "+Ta+"; q=0.01":""):e.accepts["*"]);for(K in e.headers)q.setRequestHeader(K,e.headers[K]);if(e.beforeSend&&(e.beforeSend.call(f,
q,e)===false||o===2)){q.abort();return false}for(K in{success:1,error:1,complete:1})q[K](e[K]);if(p=y(Sa,e,b,q)){q.readyState=1;O&&k.trigger("ajaxSend",[q,e]);e.async&&e.timeout>0&&(r=setTimeout(function(){q.abort("timeout")},e.timeout));try{o=1;p.send(m,d)}catch(N){if(o<2)d(-1,N);else throw N;}}else d(-1,"No Transport");return q},param:function(a,b){var d=[],e=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(b===c)b=h.ajaxSettings.traditional;
if(h.isArray(a)||a.jquery&&!h.isPlainObject(a))h.each(a,function(){e(this.name,this.value)});else for(var f in a)A(f,a[f],b,e);return d.join("&").replace(mb,"+")}});h.extend({active:0,lastModified:{},etag:{}});var vb=h.now(),qa=/(\=)\?(&|$)|\?\?/i;h.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return h.expando+"_"+vb++}});h.ajaxPrefilter("json jsonp",function(b,c,d){c=typeof b.data==="string"&&/^application\/x\-www\-form\-urlencoded/.test(b.contentType);if(b.dataTypes[0]==="jsonp"||b.jsonp!==
false&&(qa.test(b.url)||c&&qa.test(b.data))){var e,f=b.jsonpCallback=h.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,k=a[f],g=b.url,i=b.data,j="$1"+f+"$2";if(b.jsonp!==false){g=g.replace(qa,j);if(b.url===g){c&&(i=i.replace(qa,j));b.data===i&&(g=g+((/\?/.test(g)?"&":"?")+b.jsonp+"="+f))}}b.url=g;b.data=i;a[f]=function(a){e=[a]};d.always(function(){a[f]=k;if(e&&h.isFunction(k))a[f](e[0])});b.converters["script json"]=function(){e||h.error(f+" was not called");return e[0]};b.dataTypes[0]=
...
f){b=v.createElement("script");b.async="async";if(a.scriptCharset)b.charset=a.scriptCharset;b.src=a.url;b.onload=b.onreadystatechange=function(a,e){if(e||!b.readyState||/loaded|complete/.test(b.readyState)){b.onload=b.onreadystatechange=null;d&&b.parentNode&&d.removeChild(b);b=c;e||f(200,"success")}};d.insertBefore(b,d.firstChild)},abort:function(){if(b)b.onload(0,1)}}}});var Ca=a.ActiveXObject?function(){for(var a in ea)ea[a](0,1)}:!1,wb=0,ea;h.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=
!this.isLocal&&E()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:E;(function(a){h.extend(h.support,{ajax:!!a,cors:!!a&&"withCredentials"in a})})(h.ajaxSettings.xhr());h.support.ajax&&h.ajaxTransport(function(b){if(!b.crossDomain||h.support.cors){var d;return{send:function(e,f){var k=b.xhr(),g,i;b.username?k.open(b.type,b.url,b.async,b.username,b.password):k.open(b.type,b.url,b.async);if(b.xhrFields)for(i in b.xhrFields)k[i]=b.xhrFields[i];b.mimeType&&k.overrideMimeType&&
k.overrideMimeType(b.mimeType);!b.crossDomain&&!e["X-Requested-With"]&&(e["X-Requested-With"]="XMLHttpRequest");try{for(i in e)k.setRequestHeader(i,e[i])}catch(j){}k.send(b.hasContent&&b.data||null);d=function(a,e){var i,j,t,m,l;try{if(d&&(e||k.readyState===4)){d=c;if(g){k.onreadystatechange=h.noop;Ca&&delete ea[g]}if(e)k.readyState!==4&&k.abort();else{i=k.status;t=k.getAllResponseHeaders();m={};if((l=k.responseXML)&&l.documentElement)m.xml=l;try{m.text=k.responseText}catch(n){}try{j=k.statusText}catch(x){j=
""}!i&&b.isLocal&&!b.crossDomain?i=m.text?200:404:i===1223&&(i=204)}}}catch(p){e||f(-1,p)}m&&f(i,j,m,t)};if(!b.async||k.readyState===4)d();else{g=++wb;if(Ca){if(!ea){ea={};h(a).unload(Ca)}ea[g]=d}k.onreadystatechange=d}},abort:function(){d&&d(0,1)}}}});var xa={},X,ca,xb=/^(?:toggle|show|hide)$/,yb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,ra,oa=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],na;h.fn.extend({show:function(a,
...
fadeTo:function(a,b,c,d){return this.filter(":hidden").css("opacity",0).show().end().animate({opacity:b},a,c,d)},animate:function(a,b,c,d){function e(){f.queue===false&&h._mark(this);var b=h.extend({},f),c=this.nodeType===1,d=c&&h(this).is(":hidden"),k,g,i,j,t;b.animatedProperties={};for(i in a){k=h.camelCase(i);if(i!==k){a[k]=a[i];delete a[i]}if((g=h.cssHooks[k])&&"expand"in g){j=g.expand(a[k]);delete a[k];for(i in j)i in a||(a[i]=j[i])}}for(k in a){g=a[k];if(h.isArray(g)){b.animatedProperties[k]=
...
for(i in a){c=new h.fx(this,b,i);g=a[i];if(xb.test(g))if(k=h._data(this,"toggle"+i)||(g==="toggle"?d?"show":"hide":0)){h._data(this,"toggle"+i,k==="show"?"hide":"show");c[k]()}else c[g]();else{k=yb.exec(g);j=c.cur();if(k){g=parseFloat(k[2]);t=k[3]||(h.cssNumber[i]?"":"px");if(t!=="px"){h.style(this,i,(g||1)+t);j=(g||1)/c.cur()*j;h.style(this,i,j+t)}k[1]&&(g=(k[1]==="-="?-1:1)*g+j);c.custom(j,g,t)}else c.custom(j,g,"")}}return true}var f=h.speed(b,c,d);if(h.isEmptyObject(a))return this.each(f.complete,
[false]);a=h.extend({},a);return f.queue===false?this.each(e):this.queue(f.queue,e)},stop:function(a,b,d){if(typeof a!=="string"){d=b;b=a;a=c}b&&a!==false&&this.queue(a||"fx",[]);return this.each(function(){var b,c=false,e=h.timers,f=h._data(this);d||h._unmark(true,this);if(a==null)for(b in f){if(f[b]&&f[b].stop&&b.indexOf(".run")===b.length-4){var k=f[b];h.removeData(this,b,true);k.stop(d)}}else if(f[b=a+".run"]&&f[b].stop){f=f[b];h.removeData(this,b,true);f.stop(d)}for(b=e.length;b--;)if(e[b].elem===
...
this.offsetParent||v.body;a&&!Va.test(a.nodeName)&&h.css(a,"position")==="static";)a=a.offsetParent;return a})}});h.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(a,b){var d=/Y/.test(b);h.fn[a]=function(e){return h.access(this,function(a,e,f){var k=D(a);if(f===c)return k?b in k?k[b]:h.support.boxModel&&k.document.documentElement[e]||k.document.body[e]:a[e];k?k.scrollTo(!d?f:h(k).scrollLeft(),d?f:h(k).scrollTop()):a[e]=f},a,e,arguments.length,null)}});h.each({Height:"height",Width:"width"},
function(a,b){var d="client"+a,e="scroll"+a,f="offset"+a;h.fn["inner"+a]=function(){var a=this[0];return a?a.style?parseFloat(h.css(a,b,"padding")):this[b]():null};h.fn["outer"+a]=function(a){var c=this[0];return c?c.style?parseFloat(h.css(c,b,a?"margin":"border")):this[b]():null};h.fn[b]=function(a){return h.access(this,function(a,b,k){if(h.isWindow(a)){b=a.document;a=b.documentElement[d];return h.support.boxModel&&a||b.body&&b.body[d]||a}if(a.nodeType===9){b=a.documentElement;return b[d]>=b[e]?
b[d]:Math.max(a.body[e],b[e],a.body[f],b[f])}if(k===c){a=h.css(a,b);b=parseFloat(a);return h.isNumeric(b)?b:a}h(a).css(b,k)},b,a,arguments.length,null)}});a.jQuery=a.$=h;"function"===typeof define&&define.amd&&define.amd.jQuery&&define("jquery",[],function(){return h})})(window);
...
"mousedown")+".ui-disableSelection",function(a){a.preventDefault()})},enableSelection:function(){return this.unbind(".ui-disableSelection")}}),a.each(["Width","Height"],function(d,e){function g(c,d,e,f){a.each(b,function(){d-=parseFloat(a.curCSS(c,"padding"+this,!0))||0;e&&(d-=parseFloat(a.curCSS(c,"border"+this+"Width",!0))||0);f&&(d-=parseFloat(a.curCSS(c,"margin"+this,!0))||0)});return d}var b="Width"===e?["Left","Right"]:["Top","Bottom"],j=e.toLowerCase(),l={innerWidth:a.fn.innerWidth,innerHeight:a.fn.innerHeight,
outerWidth:a.fn.outerWidth,outerHeight:a.fn.outerHeight};a.fn["inner"+e]=function(b){return b===c?l["inner"+e].call(this):this.each(function(){a(this).css(j,g(this,b)+"px")})};a.fn["outer"+e]=function(b,c){return"number"!==typeof b?l["outer"+e].call(this,b):this.each(function(){a(this).css(j,g(this,b,!0,c)+"px")})}}),a.extend(a.expr[":"],{data:function(c,d,e){return!!a.data(c,e[3])},focusable:function(c){return d(c,!isNaN(a.attr(c,"tabindex")))},tabbable:function(c){var e=a.attr(c,"tabindex"),g=isNaN(e);
...
this.margins.top-this.margins.bottom];this.relative_container=c}}else c.containment.constructor==Array&&(this.containment=c.containment)},_convertPositionTo:function(c,d){d||(d=this.position);var e="absolute"==c?1:-1,f="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,i=/(html|body)/i.test(f[0].tagName);return{top:d.top+this.offset.relative.top*e+this.offset.parent.top*e-(a.browser.safari&&
526>a.browser.version&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollTop():i?0:f.scrollTop())*e),left:d.left+this.offset.relative.left*e+this.offset.parent.left*e-(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollLeft():i?0:f.scrollLeft())*e)}},_generatePosition:function(c){var d=this.options,e="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],
this.offsetParent[0]))?this.offsetParent:this.scrollParent,f=/(html|body)/i.test(e[0].tagName),i=c.pageX,g=c.pageY;if(this.originalPosition){var b;this.containment&&(this.relative_container?(b=this.relative_container.offset(),b=[this.containment[0]+b.left,this.containment[1]+b.top,this.containment[2]+b.left,this.containment[3]+b.top]):b=this.containment,c.pageX-this.offset.click.left<b[0]&&(i=b[0]+this.offset.click.left),c.pageY-this.offset.click.top<b[1]&&(g=b[1]+this.offset.click.top),c.pageX-this.offset.click.left>
b[2]&&(i=b[2]+this.offset.click.left),c.pageY-this.offset.click.top>b[3]&&(g=b[3]+this.offset.click.top));d.grid&&(g=d.grid[1]?this.originalPageY+Math.round((g-this.originalPageY)/d.grid[1])*d.grid[1]:this.originalPageY,g=b?!(g-this.offset.click.top<b[1]||g-this.offset.click.top>b[3])?g:!(g-this.offset.click.top<b[1])?g-d.grid[1]:g+d.grid[1]:g,i=d.grid[0]?this.originalPageX+Math.round((i-this.originalPageX)/d.grid[0])*d.grid[0]:this.originalPageX,i=b?!(i-this.offset.click.left<b[0]||i-this.offset.click.left>
b[2])?i:!(i-this.offset.click.left<b[0])?i-d.grid[0]:i+d.grid[0]:i)}return{top:g-this.offset.click.top-this.offset.relative.top-this.offset.parent.top+(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?-this.scrollParent.scrollTop():f?0:e.scrollTop()),left:i-this.offset.click.left-this.offset.relative.left-this.offset.parent.left+(a.browser.safari&&526>a.browser.version&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?-this.scrollParent.scrollLeft():
...
f&&a.ui.ddmanager&&!e.dropBehaviour&&a.ui.ddmanager.prepareOffsets(d,c)}});a.ui.plugin.add("draggable","snap",{start:function(){var c=a(this).data("draggable"),d=c.options;c.snapElements=[];a(d.snap.constructor!=String?d.snap.items||":data(draggable)":d.snap).each(function(){var d=a(this),f=d.offset();this!=c.element[0]&&c.snapElements.push({item:this,width:d.outerWidth(),height:d.outerHeight(),top:f.top,left:f.left})})},drag:function(c,d){for(var e=a(this).data("draggable"),f=e.options,i=f.snapTolerance,
g=d.offset.left,b=g+e.helperProportions.width,j=d.offset.top,l=j+e.helperProportions.height,p=e.snapElements.length-1;0<=p;p--){var n=e.snapElements[p].left,m=n+e.snapElements[p].width,r=e.snapElements[p].top,s=r+e.snapElements[p].height;if(n-i<g&&g<m+i&&r-i<j&&j<s+i||n-i<g&&g<m+i&&r-i<l&&l<s+i||n-i<b&&b<m+i&&r-i<j&&j<s+i||n-i<b&&b<m+i&&r-i<l&&l<s+i){if("inner"!=f.snapMode){var o=Math.abs(r-l)<=i,q=Math.abs(s-j)<=i,y=Math.abs(n-b)<=i,w=Math.abs(m-g)<=i;o&&(d.position.top=e._convertPositionTo("relative",
{top:r-e.helperProportions.height,left:0}).top-e.margins.top);q&&(d.position.top=e._convertPositionTo("relative",{top:s,left:0}).top-e.margins.top);y&&(d.position.left=e._convertPositionTo("relative",{top:0,left:n-e.helperProportions.width}).left-e.margins.left);w&&(d.position.left=e._convertPositionTo("relative",{top:0,left:m}).left-e.margins.left)}var A=o||q||y||w;if("outer"!=f.snapMode&&(o=Math.abs(r-j)<=i,q=Math.abs(s-l)<=i,y=Math.abs(n-g)<=i,w=Math.abs(m-b)<=i,o&&(d.position.top=e._convertPositionTo("relative",
{top:r,left:0}).top-e.margins.top),q&&(d.position.top=e._convertPositionTo("relative",{top:s-e.helperProportions.height,left:0}).top-e.margins.top),y&&(d.position.left=e._convertPositionTo("relative",{top:0,left:n}).left-e.margins.left),w))d.position.left=e._convertPositionTo("relative",{top:0,left:m-e.helperProportions.width}).left-e.margins.left;!e.snapElements[p].snapping&&(o||q||y||w||A)&&e.options.snap.snap&&e.options.snap.snap.call(e.element,c,a.extend(e._uiHash(),{snapItem:e.snapElements[p].item}));
e.snapElements[p].snapping=o||q||y||w||A}else e.snapElements[p].snapping&&e.options.snap.release&&e.options.snap.release.call(e.element,c,a.extend(e._uiHash(),{snapItem:e.snapElements[p].item})),e.snapElements[p].snapping=!1}}});a.ui.plugin.add("draggable","stack",{start:function(){var c=a(this).data("draggable").options,c=a.makeArray(a(c.stack)).sort(function(c,d){return(parseInt(a(c).css("zIndex"),10)||0)-(parseInt(a(d).css("zIndex"),10)||0)});if(c.length){var d=parseInt(c[0].style.zIndex)||0;a(c).each(function(a){this.style.zIndex=
...
!1},ui:function(a){return{draggable:a.currentItem||a.element,helper:a.helper,position:a.position,offset:a.positionAbs}}});a.extend(a.ui.droppable,{version:"1.8.20"});a.ui.intersect=function(c,d,e){if(!d.offset)return!1;var f=(c.positionAbs||c.position.absolute).left,i=f+c.helperProportions.width,g=(c.positionAbs||c.position.absolute).top,b=g+c.helperProportions.height,j=d.offset.left,l=j+d.proportions.width,p=d.offset.top,n=p+d.proportions.height;switch(e){case "fit":return j<=f&&i<=l&&p<=g&&b<=n;
case "intersect":return j<f+c.helperProportions.width/2&&i-c.helperProportions.width/2<l&&p<g+c.helperProportions.height/2&&b-c.helperProportions.height/2<n;case "pointer":return a.ui.isOver((c.positionAbs||c.position.absolute).top+(c.clickOffset||c.offset.click).top,(c.positionAbs||c.position.absolute).left+(c.clickOffset||c.offset.click).left,p,j,d.proportions.height,d.proportions.width);case "touch":return(g>=p&&g<=n||b>=p&&b<=n||g<p&&b>n)&&(f>=j&&f<=l||i>=j&&i<=l||f<j&&i>l);default:return!1}};
a.ui.ddmanager={current:null,droppables:{"default":[]},prepareOffsets:function(c,d){var e=a.ui.ddmanager.droppables[c.options.scope]||[],f=d?d.type:null,i=(c.currentItem||c.element).find(":data(droppable)").andSelf(),g=0;a:for(;g<e.length;g++)if(!(e[g].options.disabled||c&&!e[g].accept.call(e[g].element[0],c.currentItem||c.element))){for(var b=0;b<i.length;b++)if(i[b]==e[g].element[0]){e[g].proportions.height=0;continue a}e[g].visible="none"!=e[g].element.css("display");e[g].visible&&("mousedown"==
...
"px",height:this.size.height+"px"});!this._helper&&this._proportionallyResizeElements.length&&this._proportionallyResize();this._updateCache(d);this._trigger("resize",a,this.ui());return!1},_mouseStop:function(c){this.resizing=!1;var d=this.options;if(this._helper){var i=this._proportionallyResizeElements,g=i.length&&/textarea/i.test(i[0].nodeName),i=g&&a.ui.hasScroll(i[0],"left")?0:this.sizeDiff.height,g=g?0:this.sizeDiff.width,g={width:this.helper.width()-g,height:this.helper.height()-i},i=parseInt(this.element.css("left"),
10)+(this.position.left-this.originalPosition.left)||null,b=parseInt(this.element.css("top"),10)+(this.position.top-this.originalPosition.top)||null;d.animate||this.element.css(a.extend(g,{top:b,left:i}));this.helper.height(this.size.height);this.helper.width(this.size.width);this._helper&&!d.animate&&this._proportionallyResize()}a("body").css("cursor","auto");this.element.removeClass("ui-resizable-resizing");this._propagate("stop",c);this._helper&&this.helper.remove();return!1},_updateVirtualBoundaries:function(a){var c=
this.options,i,g,b,c={minWidth:d(c.minWidth)?c.minWidth:0,maxWidth:d(c.maxWidth)?c.maxWidth:Infinity,minHeight:d(c.minHeight)?c.minHeight:0,maxHeight:d(c.maxHeight)?c.maxHeight:Infinity};if(this._aspectRatio||a)if(a=c.minHeight*this.aspectRatio,g=c.minWidth/this.aspectRatio,i=c.maxHeight*this.aspectRatio,b=c.maxWidth/this.aspectRatio,a>c.minWidth&&(c.minWidth=a),g>c.minHeight&&(c.minHeight=g),i<c.maxWidth&&(c.maxWidth=i),b<c.maxHeight)c.maxHeight=b;this._vBoundaries=c},_updateCache:function(a){this.offset=
this.helper.offset();d(a.left)&&(this.position.left=a.left);d(a.top)&&(this.position.top=a.top);d(a.height)&&(this.size.height=a.height);d(a.width)&&(this.size.width=a.width)},_updateRatio:function(a){var c=this.position,i=this.size,g=this.axis;d(a.height)?a.width=a.height*this.aspectRatio:d(a.width)&&(a.height=a.width/this.aspectRatio);"sw"==g&&(a.left=c.left+(i.width-a.width),a.top=null);"nw"==g&&(a.top=c.top+(i.height-a.height),a.left=c.left+(i.width-a.width));return a},_respectSize:function(a){var c=
this._vBoundaries,i=this.axis,g=d(a.width)&&c.maxWidth&&c.maxWidth<a.width,b=d(a.height)&&c.maxHeight&&c.maxHeight<a.height,j=d(a.width)&&c.minWidth&&c.minWidth>a.width,l=d(a.height)&&c.minHeight&&c.minHeight>a.height;j&&(a.width=c.minWidth);l&&(a.height=c.minHeight);g&&(a.width=c.maxWidth);b&&(a.height=c.maxHeight);var p=this.originalPosition.left+this.originalSize.width,n=this.position.top+this.size.height,m=/sw|nw|w/.test(i),i=/nw|ne|n/.test(i);j&&m&&(a.left=p-c.minWidth);g&&m&&(a.left=p-c.maxWidth);
l&&i&&(a.top=n-c.minHeight);b&&i&&(a.top=n-c.maxHeight);(c=!a.width&&!a.height)&&!a.left&&a.top?a.top=null:c&&!a.top&&a.left&&(a.left=null);return a},_proportionallyResize:function(){if(this._proportionallyResizeElements.length)for(var c=this.helper||this.element,d=0;d<this._proportionallyResizeElements.length;d++){var i=this._proportionallyResizeElements[d];if(!this.borderDif){var g=[i.css("borderTopWidth"),i.css("borderRightWidth"),i.css("borderBottomWidth"),i.css("borderLeftWidth")],b=[i.css("paddingTop"),
i.css("paddingRight"),i.css("paddingBottom"),i.css("paddingLeft")];this.borderDif=a.map(g,function(a,c){var d=parseInt(a,10)||0,e=parseInt(b[c],10)||0;return d+e})}if(!a.browser.msie||!a(c).is(":hidden")&&!a(c).parents(":hidden").length)i.css({height:c.height()-this.borderDif[0]-this.borderDif[2]||0,width:c.width()-this.borderDif[1]-this.borderDif[3]||0})}},_renderProxy:function(){var c=this.options;this.elementOffset=this.element.offset();if(this._helper){this.helper=this.helper||a('<div style="overflow:hidden;"></div>');
...
"containment",{start:function(){var d=a(this).data("resizable"),f=d.element,i=d.options.containment;if(f=i instanceof a?i.get(0):/parent/.test(i)?f.parent().get(0):i)if(d.containerElement=a(f),/document/.test(i)||i==document)d.containerOffset={left:0,top:0},d.containerPosition={left:0,top:0},d.parentData={element:a(document),left:0,top:0,width:a(document).width(),height:a(document).height()||document.body.parentNode.scrollHeight};else{var g=a(f),b=[];a(["Top","Right","Left","Bottom"]).each(function(a,
d){b[a]=c(g.css("padding"+d))});d.containerOffset=g.offset();d.containerPosition=g.position();d.containerSize={height:g.innerHeight()-b[3],width:g.innerWidth()-b[1]};var i=d.containerOffset,j=d.containerSize.height,l=d.containerSize.width,l=a.ui.hasScroll(f,"left")?f.scrollWidth:l,j=a.ui.hasScroll(f)?f.scrollHeight:j;d.parentData={element:f,left:i.left,top:i.top,width:l,height:j}}},resize:function(c){var d=a(this).data("resizable"),i=d.options,g=d.containerOffset,b=d.position,c=d._aspectRatio||c.shiftKey,
j={top:0,left:0},l=d.containerElement;l[0]!=document&&/static/.test(l.css("position"))&&(j=g);if(b.left<(d._helper?g.left:0))d.size.width+=d._helper?d.position.left-g.left:d.position.left-j.left,c&&(d.size.height=d.size.width/d.aspectRatio),d.position.left=i.helper?g.left:0;if(b.top<(d._helper?g.top:0))d.size.height+=d._helper?d.position.top-g.top:d.position.top,c&&(d.size.width=d.size.height*d.aspectRatio),d.position.top=d._helper?g.top:0;d.offset.left=d.parentData.left+d.position.left;d.offset.top=
d.parentData.top+d.position.top;i=Math.abs(d.offset.left-j.left+d.sizeDiff.width);g=Math.abs((d._helper?d.offset.top-j.top:d.offset.top-g.top)+d.sizeDiff.height);b=d.containerElement.get(0)==d.element.parent().get(0);j=/relative|absolute/.test(d.containerElement.css("position"));b&&j&&(i-=d.parentData.left);i+d.size.width>=d.parentData.width&&(d.size.width=d.parentData.width-i,c&&(d.size.height=d.size.width/d.aspectRatio));g+d.size.height>=d.parentData.height&&(d.size.height=d.parentData.height-g,
c&&(d.size.width=d.size.height*d.aspectRatio))},stop:function(){var c=a(this).data("resizable"),d=c.options,i=c.containerOffset,g=c.containerPosition,b=c.containerElement,j=a(c.helper),l=j.offset(),p=j.outerWidth()-c.sizeDiff.width,j=j.outerHeight()-c.sizeDiff.height;c._helper&&!d.animate&&/relative/.test(b.css("position"))&&a(this).css({left:l.left-g.left-i.left,width:p,height:j});c._helper&&!d.animate&&/static/.test(b.css("position"))&&a(this).css({left:l.left-g.left-i.left,width:p,height:j})}});
...
a(this).data("resizable");c.ghost&&c.helper&&c.helper.get(0).removeChild(c.ghost.get(0))}});a.ui.plugin.add("resizable","grid",{resize:function(){var c=a(this).data("resizable"),d=c.options,i=c.size,g=c.originalSize,b=c.originalPosition,j=c.axis;d.grid="number"==typeof d.grid?[d.grid,d.grid]:d.grid;var l=Math.round((i.width-g.width)/(d.grid[0]||1))*(d.grid[0]||1),d=Math.round((i.height-g.height)/(d.grid[1]||1))*(d.grid[1]||1);/^(se|s|e)$/.test(j)?(c.size.width=g.width+l,c.size.height=g.height+d):
/^(ne)$/.test(j)?(c.size.width=g.width+l,c.size.height=g.height+d,c.position.top=b.top-d):(/^(sw)$/.test(j)?(c.size.width=g.width+l,c.size.height=g.height+d):(c.size.width=g.width+l,c.size.height=g.height+d,c.position.top=b.top-d),c.position.left=b.left-l)}});var c=function(a){return parseInt(a,10)||0},d=function(a){return!isNaN(parseInt(a,10))}})(jQuery);
...
this;this.dragged=!0;if(!this.options.disabled){var e=this.options,f=this.opos[0],i=this.opos[1],g=c.pageX,b=c.pageY;if(f>g)var j=g,g=f,f=j;i>b&&(j=b,b=i,i=j);this.helper.css({left:f,top:i,width:g-f,height:b-i});this.selectees.each(function(){var j=a.data(this,"selectable-item");if(j&&j.element!=d.element[0]){var p=false;e.tolerance=="touch"?p=!(j.left>g||j.right<f||j.top>b||j.bottom<i):e.tolerance=="fit"&&(p=j.left>f&&j.right<g&&j.top>i&&j.bottom<b);if(p){if(j.selected){j.$element.removeClass("ui-selected");
...
this._convertPositionTo("absolute");if(!this.options.axis||"y"!=this.options.axis)this.helper[0].style.left=this.position.left+"px";if(!this.options.axis||"x"!=this.options.axis)this.helper[0].style.top=this.position.top+"px";for(d=this.items.length-1;0<=d;d--){var e=this.items[d],f=e.item[0],i=this._intersectsWithPointer(e);if(i&&f!=this.currentItem[0]&&this.placeholder[1==i?"next":"prev"]()[0]!=f&&!a.ui.contains(this.placeholder[0],f)&&("semi-dynamic"==this.options.type?!a.ui.contains(this.element[0],
...
this._getItemsAsjQuery(c&&c.connected),e=[],c=c||{};d.each(function(){e.push(a(c.item||this).attr(c.attribute||"id")||"")});return e},_intersectsWith:function(a){var d=this.positionAbs.left,e=d+this.helperProportions.width,f=this.positionAbs.top,i=f+this.helperProportions.height,g=a.left,b=g+a.width,j=a.top,l=j+a.height,p=this.offset.click.top,n=this.offset.click.left;return"pointer"==this.options.tolerance||this.options.forcePointerForContainers||"pointer"!=this.options.tolerance&&this.helperProportions[this.floating?
"width":"height"]>a[this.floating?"width":"height"]?f+p>j&&f+p<l&&d+n>g&&d+n<b:g<d+this.helperProportions.width/2&&e-this.helperProportions.width/2<b&&j<f+this.helperProportions.height/2&&i-this.helperProportions.height/2<l},_intersectsWithPointer:function(c){var d="x"===this.options.axis||a.ui.isOverAxis(this.positionAbs.top+this.offset.click.top,c.top,c.height),c="y"===this.options.axis||a.ui.isOverAxis(this.positionAbs.left+this.offset.click.left,c.left,c.width),d=d&&c,c=this._getDragVerticalDirection(),
...
this.margins.top]}},_convertPositionTo:function(c,d){d||(d=this.position);var e="absolute"==c?1:-1,f="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,i=/(html|body)/i.test(f[0].tagName);return{top:d.top+this.offset.relative.top*e+this.offset.parent.top*e-(a.browser.safari&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollTop():i?0:f.scrollTop())*e),left:d.left+
this.offset.relative.left*e+this.offset.parent.left*e-(a.browser.safari&&"fixed"==this.cssPosition?0:("fixed"==this.cssPosition?-this.scrollParent.scrollLeft():i?0:f.scrollLeft())*e)}},_generatePosition:function(c){var d=this.options,e="absolute"==this.cssPosition&&!(this.scrollParent[0]!=document&&a.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,f=/(html|body)/i.test(e[0].tagName);"relative"==this.cssPosition&&!(this.scrollParent[0]!=document&&this.scrollParent[0]!=
this.offsetParent[0])&&(this.offset.relative=this._getRelativeOffset());var i=c.pageX,g=c.pageY;if(this.originalPosition&&(this.containment&&(c.pageX-this.offset.click.left<this.containment[0]&&(i=this.containment[0]+this.offset.click.left),c.pageY-this.offset.click.top<this.containment[1]&&(g=this.containment[1]+this.offset.click.top),c.pageX-this.offset.click.left>this.containment[2]&&(i=this.containment[2]+this.offset.click.left),c.pageY-this.offset.click.top>this.containment[3]&&(g=this.containment[3]+
this.offset.click.top)),d.grid))g=this.originalPageY+Math.round((g-this.originalPageY)/d.grid[1])*d.grid[1],g=this.containment?!(g-this.offset.click.top<this.containment[1]||g-this.offset.click.top>this.containment[3])?g:!(g-this.offset.click.top<this.containment[1])?g-d.grid[1]:g+d.grid[1]:g,i=this.originalPageX+Math.round((i-this.originalPageX)/d.grid[0])*d.grid[0],i=this.containment?!(i-this.offset.click.left<this.containment[0]||i-this.offset.click.left>this.containment[2])?i:!(i-this.offset.click.left<
this.containment[0])?i-d.grid[0]:i+d.grid[0]:i;return{top:g-this.offset.click.top-this.offset.relative.top-this.offset.parent.top+(a.browser.safari&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?-this.scrollParent.scrollTop():f?0:e.scrollTop()),left:i-this.offset.click.left-this.offset.relative.left-this.offset.parent.left+(a.browser.safari&&"fixed"==this.cssPosition?0:"fixed"==this.cssPosition?-this.scrollParent.scrollLeft():f?0:e.scrollLeft())}},_rearrange:function(a,d,e,f){e?e[0].appendChild(this.placeholder[0]):
d.item[0].parentNode.insertBefore(this.placeholder[0],"down"==this.direction?d.item[0]:d.item[0].nextSibling);this.counter=this.counter?++this.counter:1;var i=this,g=this.counter;window.setTimeout(function(){g==i.counter&&i.refreshPositions(!f)},0)},_clear:function(c,d){this.reverting=!1;var e=[];!this._noFinalSort&&this.currentItem.parent().length&&this.placeholder.before(this.currentItem);this._noFinalSort=null;if(this.helper[0]==this.currentItem[0]){for(var f in this._storedCSS)if("auto"==this._storedCSS[f]||
...
typeof a[c]&&(b[c]=a[c]);return b}function f(b){var c,d;for(c in b)d=b[c],(null==d||a.isFunction(d)||c in p||/scrollbar/.test(c)||!/color/i.test(c)&&isNaN(parseFloat(d)))&&delete b[c];return b}function i(a,b){var c={_:0},d;for(d in b)a[d]!=b[d]&&(c[d]=b[d]);return c}function g(b,c,d,e){"object"==typeof b&&(e=c,d=null,c=b,b=c.effect);a.isFunction(c)&&(e=c,d=null,c={});if("number"==typeof c||a.fx.speeds[c])e=d,d=c,c={};a.isFunction(d)&&(e=d,d=null);c=c||{};d=d||c.duration;d=a.fx.off?0:"number"==typeof d?
d:d in a.fx.speeds?a.fx.speeds[d]:a.fx.speeds._default;e=e||c.complete;return[b,c,d,e]}function b(b){return!b||"number"===typeof b||a.fx.speeds[b]||"string"===typeof b&&!a.effects[b]?!0:!1}a.effects={};a.each("backgroundColor,borderBottomColor,borderLeftColor,borderRightColor,borderTopColor,borderColor,color,outlineColor".split(","),function(b,c){a.fx.step[c]=function(b){if(!b.colorInit){var e;e=b.elem;var g=c,f;do{f=a.curCSS(e,g);if(f!=""&&f!="transparent"||a.nodeName(e,"body"))break;g="backgroundColor"}while(e=
e.parentNode);e=d(f);b.start=e;b.end=d(b.end);b.colorInit=true}b.elem.style[c]="rgb("+Math.max(Math.min(parseInt(b.pos*(b.end[0]-b.start[0])+b.start[0],10),255),0)+","+Math.max(Math.min(parseInt(b.pos*(b.end[1]-b.start[1])+b.start[1],10),255),0)+","+Math.max(Math.min(parseInt(b.pos*(b.end[2]-b.start[2])+b.start[2],10),255),0)+")"}});var j={aqua:[0,255,255],azure:[240,255,255],beige:[245,245,220],black:[0,0,0],blue:[0,0,255],brown:[165,42,42],cyan:[0,255,255],darkblue:[0,0,139],darkcyan:[0,139,139],
darkgrey:[169,169,169],darkgreen:[0,100,0],darkkhaki:[189,183,107],darkmagenta:[139,0,139],darkolivegreen:[85,107,47],darkorange:[255,140,0],darkorchid:[153,50,204],darkred:[139,0,0],darksalmon:[233,150,122],darkviolet:[148,0,211],fuchsia:[255,0,255],gold:[255,215,0],green:[0,128,0],indigo:[75,0,130],khaki:[240,230,140],lightblue:[173,216,230],lightcyan:[224,255,255],lightgreen:[144,238,144],lightgrey:[211,211,211],lightpink:[255,182,193],lightyellow:[255,255,224],lime:[0,255,0],magenta:[255,0,255],
maroon:[128,0,0],navy:[0,0,128],olive:[128,128,0],orange:[255,165,0],pink:[255,192,203],purple:[128,0,128],violet:[128,0,128],red:[255,0,0],silver:[192,192,192],white:[255,255,255],yellow:[255,255,0],transparent:[255,255,255]},l=["add","remove","toggle"],p={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};a.effects.animateClass=function(b,c,d,g){a.isFunction(d)&&(g=d,d=null);return this.queue(function(){var j=a(this),p=j.attr("style")||
" ",y=f(e.call(this)),w,A=j.attr("class")||"";a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});w=f(e.call(this));j.attr("class",A);j.animate(i(y,w),{queue:false,duration:c,easing:d,complete:function(){a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});if(typeof j.attr("style")=="object"){j.attr("style").cssText="";j.attr("style").cssText=p}else j.attr("style",p);g&&g.apply(this,arguments);a.dequeue(this)}})})};a.fn.extend({_addClass:a.fn.addClass,addClass:function(b,c,d,e){return c?a.effects.animateClass.apply(this,
[{add:b},c,d,e]):this._addClass(b)},_removeClass:a.fn.removeClass,removeClass:function(b,c,d,e){return c?a.effects.animateClass.apply(this,[{remove:b},c,d,e]):this._removeClass(b)},_toggleClass:a.fn.toggleClass,toggleClass:function(b,d,e,g,f){return"boolean"==typeof d||d===c?e?a.effects.animateClass.apply(this,[d?{add:b}:{remove:b},e,g,f]):this._toggleClass(b,d):a.effects.animateClass.apply(this,[{toggle:b},d,e,g])},switchClass:function(b,c,d,e,g){return a.effects.animateClass.apply(this,[{add:c,
...
c):b},setTransition:function(b,c,d,e){e=e||{};a.each(c,function(a,c){var g=b.cssUnit(c);0<g[0]&&(e[c]=g[0]*d+g[1])});return e}});a.fn.extend({effect:function(b,c,d,e){var f=g.apply(this,arguments),j={options:f[1],duration:f[2],callback:f[3]},f=j.options.mode,i=a.effects[b];return a.fx.off||!i?f?this[f](j.duration,j.callback):this.each(function(){j.callback&&j.callback.call(this)}):i.call(this,j)},_show:a.fn.show,show:function(a){if(b(a))return this._show.apply(this,arguments);var c=g.apply(this,arguments);
...
g)+d+c},easeInBack:function(a,b,d,e,g,f){f==c&&(f=1.70158);return e*(b/=g)*b*((f+1)*b-f)+d},easeOutBack:function(a,b,d,e,g,f){f==c&&(f=1.70158);return e*((b=b/g-1)*b*((f+1)*b+f)+1)+d},easeInOutBack:function(a,b,d,e,g,f){f==c&&(f=1.70158);return 1>(b/=g/2)?e/2*b*b*(((f*=1.525)+1)*b-f)+d:e/2*((b-=2)*b*(((f*=1.525)+1)*b+f)+2)+d},easeInBounce:function(b,c,d,e,g){return e-a.easing.easeOutBounce(b,g-c,0,e,g)+d},easeOutBounce:function(a,b,c,d,e){return(b/=e)<1/2.75?d*7.5625*b*b+c:b<2/2.75?d*(7.5625*(b-=
...
(function(a){a.effects.blind=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],f=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.direction||"vertical";a.effects.save(d,e);d.show();var g=a.effects.createWrapper(d).css({overflow:"hidden"}),b="vertical"==i?"height":"width",i="vertical"==i?g.height():g.width();"show"==f&&g.css(b,0);var j={};j[b]="show"==f?i:0;g.animate(j,c.duration,c.options.easing,function(){"hide"==f&&d.hide();a.effects.restore(d,
e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
(function(a){a.effects.bounce=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],f=a.effects.setMode(d,c.options.mode||"effect"),i=c.options.direction||"up",g=c.options.distance||20,b=c.options.times||5,j=c.duration||250;/show|hide/.test(f)&&e.push("opacity");a.effects.save(d,e);d.show();a.effects.createWrapper(d);var l="up"==i||"down"==i?"top":"left",i="up"==i||"left"==i?"pos":"neg",g=c.options.distance||("top"==l?d.outerHeight({margin:!0})/3:d.outerWidth({margin:!0})/
3);"show"==f&&d.css("opacity",0).css(l,"pos"==i?-g:g);"hide"==f&&(g/=2*b);"hide"!=f&&b--;if("show"==f){var p={opacity:1};p[l]=("pos"==i?"+=":"-=")+g;d.animate(p,j/2,c.options.easing);g/=2;b--}for(p=0;p<b;p++){var n={},m={};n[l]=("pos"==i?"-=":"+=")+g;m[l]=("pos"==i?"+=":"-=")+g;d.animate(n,j/2,c.options.easing).animate(m,j/2,c.options.easing);g="hide"==f?2*g:g/2}"hide"==f?(p={opacity:0},p[l]=("pos"==i?"-=":"+=")+g,d.animate(p,j/2,c.options.easing,function(){d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);
c.callback&&c.callback.apply(this,arguments)})):(n={},m={},n[l]=("pos"==i?"-=":"+=")+g,m[l]=("pos"==i?"+=":"-=")+g,d.animate(n,j/2,c.options.easing).animate(m,j/2,c.options.easing,function(){a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)}));d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(jQuery);
(function(a){a.effects.clip=function(c){return this.queue(function(){var d=a(this),e="position,top,bottom,left,right,height,width".split(","),f=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.direction||"vertical";a.effects.save(d,e);d.show();var g=a.effects.createWrapper(d).css({overflow:"hidden"}),g="IMG"==d[0].tagName?g:d,b="vertical"==i?"height":"width",j="vertical"==i?"top":"left",i="vertical"==i?g.height():g.width();"show"==f&&(g.css(b,0),g.css(j,i/2));var l={};l[b]="show"==f?i:0;l[j]=
"show"==f?0:i/2;g.animate(l,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){f=="hide"&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.drop=function(c){return this.queue(function(){var d=a(this),e="position,top,bottom,left,right,opacity".split(","),f=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.direction||"left";a.effects.save(d,e);d.show();a.effects.createWrapper(d);var g="up"==i||"down"==i?"top":"left",i="up"==i||"left"==i?"pos":"neg",b=c.options.distance||("top"==g?d.outerHeight({margin:!0})/2:d.outerWidth({margin:!0})/2);"show"==f&&d.css("opacity",0).css(g,"pos"==i?-b:b);var j={opacity:"show"==
f?1:0};j[g]=("show"==f?"pos"==i?"+=":"-=":"pos"==i?"-=":"+=")+b;d.animate(j,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){"hide"==f&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.explode=function(c){return this.queue(function(){var d=c.options.pieces?Math.round(Math.sqrt(c.options.pieces)):3,e=c.options.pieces?Math.round(Math.sqrt(c.options.pieces)):3;c.options.mode="toggle"==c.options.mode?a(this).is(":visible")?"hide":"show":c.options.mode;var f=a(this).show().css("visibility","hidden"),i=f.offset();i.top-=parseInt(f.css("marginTop"),10)||0;i.left-=parseInt(f.css("marginLeft"),10)||0;for(var g=f.outerWidth(!0),b=f.outerHeight(!0),j=0;j<d;j++)for(var l=
0;l<e;l++)f.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-l*(g/e),top:-j*(b/d)}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:g/e,height:b/d,left:i.left+l*(g/e)+("show"==c.options.mode?(l-Math.floor(e/2))*(g/e):0),top:i.top+j*(b/d)+("show"==c.options.mode?(j-Math.floor(d/2))*(b/d):0),opacity:"show"==c.options.mode?0:1}).animate({left:i.left+l*(g/e)+("show"==c.options.mode?0:(l-Math.floor(e/2))*(g/e)),top:i.top+
j*(b/d)+("show"==c.options.mode?0:(j-Math.floor(d/2))*(b/d)),opacity:"show"==c.options.mode?1:0},c.duration||500);setTimeout(function(){"show"==c.options.mode?f.css({visibility:"visible"}):f.css({visibility:"visible"}).hide();c.callback&&c.callback.apply(f[0]);f.dequeue();a("div.ui-effects-explode").remove()},c.duration||500)})}})(jQuery);
...
(function(a){a.effects.fold=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],f=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.size||15,g=!!c.options.horizFirst,b=c.duration?c.duration/2:a.fx.speeds._default/2;a.effects.save(d,e);d.show();var j=a.effects.createWrapper(d).css({overflow:"hidden"}),l="show"==f!=g,p=l?["width","height"]:["height","width"],l=l?[j.width(),j.height()]:[j.height(),j.width()],n=/([0-9]+)%/.exec(i);n&&(i=parseInt(n[1],
10)/100*l["hide"==f?0:1]);"show"==f&&j.css(g?{height:0,width:i}:{height:i,width:0});g={};n={};g[p[0]]="show"==f?l[0]:i;n[p[1]]="show"==f?l[1]:0;j.animate(g,b,c.options.easing).animate(n,b,c.options.easing,function(){"hide"==f&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
(function(a){a.effects.highlight=function(c){return this.queue(function(){var d=a(this),e=["backgroundImage","backgroundColor","opacity"],f=a.effects.setMode(d,c.options.mode||"show"),i={backgroundColor:d.css("backgroundColor")};"hide"==f&&(i.opacity=0);a.effects.save(d,e);d.show().css({backgroundImage:"none",backgroundColor:c.options.color||"#ffff99"}).animate(i,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){f=="hide"&&d.hide();a.effects.restore(d,e);f=="show"&&!a.support.opacity&&
this.style.removeAttribute("filter");c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.pulsate=function(c){return this.queue(function(){var d=a(this),e=a.effects.setMode(d,c.options.mode||"show"),f=2*(c.options.times||5)-1,i=c.duration?c.duration/2:a.fx.speeds._default/2,g=d.is(":visible"),b=0;g||(d.css("opacity",0).show(),b=1);("hide"==e&&g||"show"==e&&!g)&&f--;for(e=0;e<f;e++)d.animate({opacity:b},i,c.options.easing),b=(b+1)%2;d.animate({opacity:b},i,c.options.easing,function(){b==0&&d.hide();c.callback&&c.callback.apply(this,arguments)});d.queue("fx",function(){d.dequeue()}).dequeue()})}})(jQuery);
(function(a){a.effects.puff=function(c){return this.queue(function(){var d=a(this),e=a.effects.setMode(d,c.options.mode||"hide"),f=parseInt(c.options.percent,10)||150,i=f/100,g={height:d.height(),width:d.width()};a.extend(c.options,{fade:!0,mode:e,percent:"hide"==e?f:100,from:"hide"==e?g:{height:g.height*i,width:g.width*i}});d.effect("scale",c.options,c.duration,c.callback);d.dequeue()})};a.effects.scale=function(c){return this.queue(function(){var d=a(this),e=a.extend(!0,{},c.options),f=a.effects.setMode(d,
c.options.mode||"effect"),i=parseInt(c.options.percent,10)||(0==parseInt(c.options.percent,10)?0:"hide"==f?0:100),g=c.options.direction||"both",b=c.options.origin;"effect"!=f&&(e.origin=b||["middle","center"],e.restore=!0);b={height:d.height(),width:d.width()};d.from=c.options.from||("show"==f?{height:0,width:0}:b);d.to={height:b.height*("horizontal"!=g?i/100:1),width:b.width*("vertical"!=g?i/100:1)};if(c.options.fade&&("show"==f&&(d.from.opacity=0,d.to.opacity=1),"hide"==f))d.from.opacity=1,d.to.opacity=
0;e.from=d.from;e.to=d.to;e.mode=f;d.effect("size",e,c.duration,c.callback);d.dequeue()})};a.effects.size=function(c){return this.queue(function(){var d=a(this),e="position,top,bottom,left,right,width,height,overflow,opacity".split(","),f="position,top,bottom,left,right,overflow,opacity".split(","),i=["width","height","overflow"],g=["fontSize"],b=["borderTopWidth","borderBottomWidth","paddingTop","paddingBottom"],j=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"],l=a.effects.setMode(d,
c.options.mode||"effect"),p=c.options.restore||!1,n=c.options.scale||"both",m=c.options.origin,r={height:d.height(),width:d.width()};d.from=c.options.from||r;d.to=c.options.to||r;m&&(m=a.effects.getBaseline(m,r),d.from.top=(r.height-d.from.height)*m.y,d.from.left=(r.width-d.from.width)*m.x,d.to.top=(r.height-d.to.height)*m.y,d.to.left=(r.width-d.to.width)*m.x);var s=d.from.height/r.height,o=d.from.width/r.width,q=d.to.height/r.height,y=d.to.width/r.width;if("box"==n||"both"==n)if(s!=q&&(e=e.concat(b),
d.from=a.effects.setTransition(d,b,s,d.from),d.to=a.effects.setTransition(d,b,q,d.to)),o!=y)e=e.concat(j),d.from=a.effects.setTransition(d,j,o,d.from),d.to=a.effects.setTransition(d,j,y,d.to);if(("content"==n||"both"==n)&&s!=q)e=e.concat(g),d.from=a.effects.setTransition(d,g,s,d.from),d.to=a.effects.setTransition(d,g,q,d.to);a.effects.save(d,p?e:f);d.show();a.effects.createWrapper(d);d.css("overflow","hidden").css(d.from);if("content"==n||"both"==n)b=b.concat(["marginTop","marginBottom"]).concat(g),
j=j.concat(["marginLeft","marginRight"]),i=e.concat(b).concat(j),d.find("*[width]").each(function(){var d=a(this);p&&a.effects.save(d,i);var e=d.height(),g=d.width();d.from={height:e*s,width:g*o};d.to={height:e*q,width:g*y};if(s!=q){d.from=a.effects.setTransition(d,b,s,d.from);d.to=a.effects.setTransition(d,b,q,d.to)}if(o!=y){d.from=a.effects.setTransition(d,j,o,d.from);d.to=a.effects.setTransition(d,j,y,d.to)}d.css(d.from);d.animate(d.to,c.duration,c.options.easing,function(){p&&a.effects.restore(d,
i)})});d.animate(d.to,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){d.to.opacity===0&&d.css("opacity",d.from.opacity);l=="hide"&&d.hide();a.effects.restore(d,p?e:f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.shake=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"];a.effects.setMode(d,c.options.mode||"effect");var f=c.options.direction||"left",i=c.options.distance||20,g=c.options.times||3,b=c.duration||c.options.duration||140;a.effects.save(d,e);d.show();a.effects.createWrapper(d);var j="up"==f||"down"==f?"top":"left",l="up"==f||"left"==f?"pos":"neg",f={},p={},n={};f[j]=("pos"==l?"-=":"+=")+i;p[j]=("pos"==l?"+=":"-=")+2*i;n[j]=("pos"==
l?"-=":"+=")+2*i;d.animate(f,b,c.options.easing);for(i=1;i<g;i++)d.animate(p,b,c.options.easing).animate(n,b,c.options.easing);d.animate(p,b,c.options.easing).animate(f,b/2,c.options.easing,function(){a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)});d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(jQuery);
(function(a){a.effects.slide=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],f=a.effects.setMode(d,c.options.mode||"show"),i=c.options.direction||"left";a.effects.save(d,e);d.show();a.effects.createWrapper(d).css({overflow:"hidden"});var g="up"==i||"down"==i?"top":"left",i="up"==i||"left"==i?"pos":"neg",b=c.options.distance||("top"==g?d.outerHeight({margin:!0}):d.outerWidth({margin:!0}));"show"==f&&d.css(g,"pos"==i?isNaN(b)?"-"+b:-b:b);var j={};
j[g]=("show"==f?"pos"==i?"+=":"-=":"pos"==i?"-=":"+=")+b;d.animate(j,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){"hide"==f&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.transfer=function(c){return this.queue(function(){var d=a(this),e=a(c.options.to),f=e.offset(),e={top:f.top,left:f.left,height:e.innerHeight(),width:e.innerWidth()},f=d.offset(),i=a('<div class="ui-effects-transfer"></div>').appendTo(document.body).addClass(c.options.className).css({top:f.top,left:f.left,height:d.innerHeight(),width:d.innerWidth(),position:"absolute"}).animate(e,c.duration,c.options.easing,function(){i.remove();c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
...
d),i=f[0]===this.active[0];e.active=e.collapsible&&i?!1:this.headers.index(f);if(!(this.running||!e.collapsible&&i)){var g=this.active,b=f.next(),j=this.active.next(),l={options:e,newHeader:i&&e.collapsible?a([]):f,oldHeader:this.active,newContent:i&&e.collapsible?a([]):b,oldContent:j},p=this.headers.index(this.active[0])>this.headers.index(f[0]);this.active=i?a([]):f;this._toggle(b,j,l,i,p);g.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").children(".ui-icon").removeClass(e.icons.headerSelected).addClass(e.icons.header);
...
l={options:e,newHeader:a([]),oldHeader:e.active,newContent:a([]),oldContent:j},b=this.active=a([]);this._toggle(b,j,l)}},_toggle:function(c,d,e,f,i){var g=this,b=g.options;g.toShow=c;g.toHide=d;g.data=e;var j=function(){return!g?void 0:g._completed.apply(g,arguments)};g._trigger("changestart",null,g.data);g.running=0===d.size()?c.size():d.size();if(b.animated){e={};e=b.collapsible&&f?{toShow:a([]),toHide:d,complete:j,down:i,autoHeight:b.autoHeight||b.fillSpace}:{toShow:c,toHide:d,complete:j,down:i,
...
animations:{slide:function(c,d){c=a.extend({easing:"swing",duration:300},c,d);if(c.toHide.size())if(c.toShow.size()){var e=c.toShow.css("overflow"),f=0,i={},g={},b,j=c.toShow;b=j[0].style.width;j.width(j.parent().width()-parseFloat(j.css("paddingLeft"))-parseFloat(j.css("paddingRight"))-(parseFloat(j.css("borderLeftWidth"))||0)-(parseFloat(j.css("borderRightWidth"))||0));a.each(["height","paddingTop","paddingBottom"],function(b,d){g[d]="hide";var e=(""+a.css(c.toShow[0],d)).match(/^([\d+-.]+)(.*)$/);
i[d]={value:e[1],unit:e[2]||"px"}});c.toShow.css({height:0,overflow:"hidden"}).show();c.toHide.filter(":hidden").each(c.complete).end().filter(":visible").animate(g,{step:function(a,b){"height"==b.prop&&(f=0===b.end-b.start?0:(b.now-b.start)/(b.end-b.start));c.toShow[0].style[b.prop]=f*i[b.prop].value+i[b.prop].unit},duration:c.duration,easing:c.easing,complete:function(){c.autoHeight||c.toShow.css("height","");c.toShow.css({width:b,overflow:e});c.complete()}})}else c.toHide.animate({height:"hide",
...
-1).mouseenter(function(d){c.activate(d,a(this).parent())}).mouseleave(function(){c.deactivate()})},activate:function(a,d){this.deactivate();if(this.hasScroll()){var e=d.offset().top-this.element.offset().top,f=this.element.scrollTop(),i=this.element.height();0>e?this.element.scrollTop(f+e):e>=i&&this.element.scrollTop(f+e-i+d.height())}this.active=d.eq(0).children("a").addClass("ui-state-hover").attr("id","ui-active-menuitem").end();this._trigger("focus",a,{item:d})},deactivate:function(){this.active&&
...
(function(a){var c,d,e,f,i=function(){var b=a(this).find(":ui-button");setTimeout(function(){b.button("refresh")},1)},g=function(b){var c=b.name,d=b.form,e=a([]);c&&(e=d?a(d).find("[name='"+c+"']"):a("[name='"+c+"']",b.ownerDocument).filter(function(){return!this.form}));return e};a.widget("ui.button",{options:{disabled:null,text:!0,label:null,icons:{primary:null,secondary:null}},_create:function(){this.element.closest("form").unbind("reset.button").bind("reset.button",i);"boolean"!==typeof this.options.disabled?
this.options.disabled=!!this.element.propAttr("disabled"):this.element.propAttr("disabled",this.options.disabled);this._determineButtonType();this.hasTitle=!!this.buttonElement.attr("title");var b=this,j=this.options,l="checkbox"===this.type||"radio"===this.type,p="ui-state-hover"+(!l?" ui-state-active":"");null===j.label&&(j.label=this.buttonElement.html());this.buttonElement.addClass("ui-button ui-widget ui-state-default ui-corner-all").attr("role","button").bind("mouseenter.button",function(){if(!j.disabled){a(this).addClass("ui-state-hover");
this===c&&a(this).addClass("ui-state-active")}}).bind("mouseleave.button",function(){j.disabled||a(this).removeClass(p)}).bind("click.button",function(a){if(j.disabled){a.preventDefault();a.stopImmediatePropagation()}});this.element.bind("focus.button",function(){b.buttonElement.addClass("ui-state-focus")}).bind("blur.button",function(){b.buttonElement.removeClass("ui-state-focus")});l&&(this.element.bind("change.button",function(){f||b.refresh()}),this.buttonElement.bind("mousedown.button",function(a){if(!j.disabled){f=
false;d=a.pageX;e=a.pageY}}).bind("mouseup.button",function(a){if(!j.disabled&&(d!==a.pageX||e!==a.pageY))f=true}));"checkbox"===this.type?this.buttonElement.bind("click.button",function(){if(j.disabled||f)return false;a(this).toggleClass("ui-state-active");b.buttonElement.attr("aria-pressed",b.element[0].checked)}):"radio"===this.type?this.buttonElement.bind("click.button",function(){if(j.disabled||f)return false;a(this).addClass("ui-state-active");b.buttonElement.attr("aria-pressed","true");var c=
b.element[0];g(c).not(c).map(function(){return a(this).button("widget")[0]}).removeClass("ui-state-active").attr("aria-pressed","false")}):(this.buttonElement.bind("mousedown.button",function(){if(j.disabled)return false;a(this).addClass("ui-state-active");c=this;a(document).one("mouseup",function(){c=null})}).bind("mouseup.button",function(){if(j.disabled)return false;a(this).removeClass("ui-state-active")}).bind("keydown.button",function(b){if(j.disabled)return false;(b.keyCode==a.ui.keyCode.SPACE||
...
c.addClass("ui-datepicker-next-hover")})}function f(b,d){a.extend(b,d);for(var e in d)if(null==d[e]||d[e]==c)b[e]=d[e];return b}a.extend(a.ui,{datepicker:{version:"1.8.20"}});var i=(new Date).getTime(),g;a.extend(d.prototype,{markerClassName:"hasDatepicker",maxRows:4,log:function(){this.debug&&console.log.apply("",arguments)},_widgetDatepicker:function(){return this.dpDiv},setDefaults:function(a){f(this._defaults,a||{});return this},_attachDatepicker:function(b,c){var d=null,e;for(e in this._defaults){var g=
b.getAttribute("date:"+e);if(g){d=d||{};try{d[e]=eval(g)}catch(f){d[e]=g}}}e=b.nodeName.toLowerCase();g="div"==e||"span"==e;b.id||(this.uuid+=1,b.id="dp"+this.uuid);var i=this._newInst(a(b),g);i.settings=a.extend({},c||{},d||{});"input"==e?this._connectDatepicker(b,i):g&&this._inlineDatepicker(b,i)},_newInst:function(b,c){return{id:b[0].id.replace(/([^A-Za-z0-9_-])/g,"\\\\$1"),input:b,selectedDay:0,selectedMonth:0,selectedYear:0,drawMonth:0,drawYear:0,inline:c,dpDiv:!c?this.dpDiv:e(a('<div class="'+
...
b}},_isDisabledDatepicker:function(a){if(!a)return!1;for(var c=0;c<this._disabledInputs.length;c++)if(this._disabledInputs[c]==a)return!0;return!1},_getInst:function(b){try{return a.data(b,"datepicker")}catch(c){throw"Missing instance data for this datepicker";}},_optionDatepicker:function(b,d,e){var g=this._getInst(b);if(2==arguments.length&&"string"==typeof d)return"defaults"==d?a.extend({},a.datepicker._defaults):g?"all"==d?a.extend({},g.settings):this._get(g,d):null;var i=d||{};"string"==typeof d&&
(i={},i[d]=e);if(g){this._curInst==g&&this._hideDatepicker();var m=this._getDateDatepicker(b,!0),r=this._getMinMaxDate(g,"min"),s=this._getMinMaxDate(g,"max");f(g.settings,i);null!==r&&i.dateFormat!==c&&i.minDate===c&&(g.settings.minDate=this._formatDate(g,r));null!==s&&i.dateFormat!==c&&i.maxDate===c&&(g.settings.maxDate=this._formatDate(g,s));this._attachments(a(b),g);this._autoSize(g);this._setDate(g,m);this._updateAlternate(g);this._updateDatepicker(g)}},_changeDatepicker:function(a,c,d){this._optionDatepicker(a,
...
e?"fixed":"absolute",display:"none",left:d.left+"px",top:d.top+"px"});if(!c.inline){var d=a.datepicker._get(c,"showAnim"),g=a.datepicker._get(c,"duration"),i=function(){var b=c.dpDiv.find("iframe.ui-datepicker-cover");if(b.length){var d=a.datepicker._getBorders(c.dpDiv);b.css({left:-d[0],top:-d[1],width:c.dpDiv.outerWidth(),height:c.dpDiv.outerHeight()})}};c.dpDiv.zIndex(a(b).zIndex()+1);a.datepicker._datepickerShowing=!0;if(a.effects&&a.effects[d])c.dpDiv.show(d,a.datepicker._get(c,"showOptions"),
g,i);else c.dpDiv[d||"show"](d?g:null,i);(!d||!g)&&i();c.input.is(":visible")&&!c.input.is(":disabled")&&c.input.focus();a.datepicker._curInst=c}}}},_updateDatepicker:function(b){this.maxRows=4;var c=a.datepicker._getBorders(b.dpDiv);g=b;b.dpDiv.empty().append(this._generateHTML(b));var d=b.dpDiv.find("iframe.ui-datepicker-cover");d.length&&d.css({left:-c[0],top:-c[1],width:b.dpDiv.outerWidth(),height:b.dpDiv.outerHeight()});b.dpDiv.find("."+this._dayOverClass+" a").mouseover();c=this._getNumberOfMonths(b);
...
b.yearshtml;setTimeout(function(){e===b.yearshtml&&b.yearshtml&&b.dpDiv.find("select.ui-datepicker-year:first").replaceWith(b.yearshtml);e=b.yearshtml=null},0)}},_getBorders:function(a){var c=function(a){return{thin:1,medium:2,thick:3}[a]||a};return[parseFloat(c(a.css("border-left-width"))),parseFloat(c(a.css("border-top-width")))]},_checkOffset:function(b,c,d){var e=b.dpDiv.outerWidth(),g=b.dpDiv.outerHeight(),f=b.input?b.input.outerWidth():0,i=b.input?b.input.outerHeight():0,s=document.documentElement.clientWidth+
a(document).scrollLeft(),o=document.documentElement.clientHeight+a(document).scrollTop();c.left-=this._get(b,"isRTL")?e-f:0;c.left-=d&&c.left==b.input.offset().left?a(document).scrollLeft():0;c.top-=d&&c.top==b.input.offset().top+i?a(document).scrollTop():0;c.left-=Math.min(c.left,c.left+e>s&&s>e?Math.abs(c.left+e-s):0);c.top-=Math.min(c.top,c.top+g>o&&o>g?Math.abs(g+i):0);return c},_findPos:function(b){for(var c=this._get(this._getInst(b),"isRTL");b&&("hidden"==b.type||1!=b.nodeType||a.expr.filters.hidden(b));)b=
...
e="string"!=typeof e?e:(new Date).getFullYear()%100+parseInt(e,10),g=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,f=(d?d.dayNames:null)||this._defaults.dayNames,i=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,s=(d?d.monthNames:null)||this._defaults.monthNames,o=d=-1,q=-1,y=-1,w=!1,A=function(a){(a=H+1<b.length&&b.charAt(H+1)==a)&&H++;return a},E=function(a){var b=A(a),a=c.substring(F).match(RegExp("^\\d{1,"+("@"==a?14:"!"==a?20:"y"==a&&b?4:"o"==a?3:2)+"}"));if(!a)throw"Missing number at position "+
F;F+=a[0].length;return parseInt(a[0],10)},z=function(b,d,e){var b=a.map(A(b)?e:d,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)}),g=-1;a.each(b,function(a,b){var d=b[1];if(c.substr(F,d.length).toLowerCase()==d.toLowerCase())return g=b[0],F+=d.length,!1});if(-1!=g)return g+1;throw"Unknown name at position "+F;},C=function(){if(c.charAt(F)!=b.charAt(H))throw"Unexpected literal at position "+F;F++},F=0,H=0;H<b.length;H++)if(w)"'"==b.charAt(H)&&!A("'")?w=!1:C();else switch(b.charAt(H)){case "d":q=
E("d");break;case "D":z("D",g,f);break;case "o":y=E("o");break;case "m":o=E("m");break;case "M":o=z("M",i,s);break;case "y":d=E("y");break;case "@":var D=new Date(E("@")),d=D.getFullYear(),o=D.getMonth()+1,q=D.getDate();break;case "!":D=new Date((E("!")-this._ticksTo1970)/1E4);d=D.getFullYear();o=D.getMonth()+1;q=D.getDate();break;case "'":A("'")?C():w=!0;break;default:C()}if(F<c.length)throw"Extra/unparsed characters found in date: "+c.substring(F);-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-
(new Date).getFullYear()%100+(d<=e?0:-100));if(-1<y){o=1;q=y;do{e=this._getDaysInMonth(d,o-1);if(q<=e)break;o++;q-=e}while(1)}D=this._daylightSavingAdjust(new Date(d,o-1,q));if(D.getFullYear()!=d||D.getMonth()+1!=o||D.getDate()!=q)throw"Invalid date";return D},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:864E9*(718685+Math.floor(492.5)-
Math.floor(19.7)+Math.floor(4.925)),formatDate:function(a,c,d){if(!c)return"";var e=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,g=(d?d.dayNames:null)||this._defaults.dayNames,f=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,d=(d?d.monthNames:null)||this._defaults.monthNames,i=function(c){(c=w+1<a.length&&a.charAt(w+1)==c)&&w++;return c},s=function(a,b,c){b=""+b;if(i(a))for(;b.length<c;)b="0"+b;return b},o=function(a,b,c,d){return i(a)?d[b]:c[b]},q="",y=!1;if(c)for(var w=0;w<
a.length;w++)if(y)"'"==a.charAt(w)&&!i("'")?y=!1:q+=a.charAt(w);else switch(a.charAt(w)){case "d":q+=s("d",c.getDate(),2);break;case "D":q+=o("D",c.getDay(),e,g);break;case "o":q+=s("o",Math.round(((new Date(c.getFullYear(),c.getMonth(),c.getDate())).getTime()-(new Date(c.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":q+=s("m",c.getMonth()+1,2);break;case "M":q+=o("M",c.getMonth(),f,d);break;case "y":q+=i("y")?c.getFullYear():(10>c.getYear()%100?"0":"")+c.getYear()%100;break;case "@":q+=
c.getTime();break;case "!":q+=1E4*c.getTime()+this._ticksTo1970;break;case "'":i("'")?q+="'":y=!0;break;default:q+=a.charAt(w)}return q},_possibleChars:function(a){for(var c="",d=!1,e=function(c){(c=g+1<a.length&&a.charAt(g+1)==c)&&g++;return c},g=0;g<a.length;g++)if(d)"'"==a.charAt(g)&&!e("'")?d=!1:c+=a.charAt(g);else switch(a.charAt(g)){case "d":case "m":case "y":case "@":c+="0123456789";break;case "D":case "M":return null;case "'":e("'")?c+="'":d=!0;break;default:c+=a.charAt(g)}return c},_get:function(a,
d){return a.settings[d]!==c?a.settings[d]:this._defaults[d]},_setDateFromField:function(a,c){if(a.input.val()!=a.lastVal){var d=this._get(a,"dateFormat"),e=a.lastVal=a.input?a.input.val():null,g,f;g=f=this._getDefaultDate(a);var i=this._getFormatConfig(a);try{g=this.parseDate(d,e,i)||f}catch(s){this.log(s),e=c?"":e}a.selectedDay=g.getDate();a.drawMonth=a.selectedMonth=g.getMonth();a.drawYear=a.selectedYear=g.getFullYear();a.currentDay=e?g.getDate():0;a.currentMonth=e?g.getMonth():0;a.currentYear=
...
I=""}G+='">'}for(var G=G+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+I+'">'+(/all|left/.test(I)&&0==Q?d?g:z:"")+(/all|right/.test(I)&&0==Q?d?z:g:"")+this._generateMonthYearHeader(b,s,E,w,A,0<Q||0<J,H,D)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),L=o?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":"",I=0;7>I;I++)var k=(I+f)%7,L=L+("<th"+(5<=(I+f+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+C[k]+'">'+F[k]+"</span></th>");
G+=L+"</tr></thead><tbody>";L=this._getDaysInMonth(E,s);E==b.selectedYear&&s==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,L));I=(this._getFirstDayOfMonth(E,s)-f+7)%7;L=Math.ceil((I+L)/7);this.maxRows=L=q?this.maxRows>L?this.maxRows:L:L;for(var k=this._daylightSavingAdjust(new Date(E,s,1-I)),t=0;t<L;t++){for(var G=G+"<tr>",x=!o?"":'<td class="ui-datepicker-week-col">'+this._get(b,"calculateWeek")(k)+"</td>",I=0;7>I;I++){var O=v?v.apply(b.input?b.input[0]:null,[k]):[!0,""],K=k.getMonth()!=
s,N=K&&!R||!O[0]||w&&k<w||A&&k>A,x=x+('<td class="'+(5<=(I+f+6)%7?" ui-datepicker-week-end":"")+(K?" ui-datepicker-other-month":"")+(k.getTime()==u.getTime()&&s==b.selectedMonth&&b._keyEvent||h.getTime()==k.getTime()&&h.getTime()==u.getTime()?" "+this._dayOverClass:"")+(N?" "+this._unselectableClass+" ui-state-disabled":"")+(K&&!M?"":" "+O[1]+(k.getTime()==y.getTime()?" "+this._currentClass:"")+(k.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!K||M)&&O[2]?' title="'+O[2]+'"':"")+(N?"":
' onclick="DP_jQuery_'+i+".datepicker._selectDay('#"+b.id+"',"+k.getMonth()+","+k.getFullYear()+', this);return false;"')+">"+(K&&!M?"&#xa0;":N?'<span class="ui-state-default">'+k.getDate()+"</span>":'<a class="ui-state-default'+(k.getTime()==c.getTime()?" ui-state-highlight":"")+(k.getTime()==y.getTime()?" ui-state-active":"")+(K?" ui-priority-secondary":"")+'" href="#">'+k.getDate()+"</a>")+"</td>");k.setDate(k.getDate()+1);k=this._daylightSavingAdjust(k)}G+=x+"</tr>"}s++;11<s&&(s=0,E++);G+="</tbody></table>"+
(q?"</div>"+(0<r[0]&&J==r[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");P+=G}S+=P}S+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return S},_generateMonthYearHeader:function(a,c,d,e,g,f,r,s){var o=this._get(a,"changeMonth"),q=this._get(a,"changeYear"),y=this._get(a,"showMonthAfterYear"),w='<div class="ui-datepicker-title">',A="";if(f||!o)A+='<span class="ui-datepicker-month">'+
r[c]+"</span>";else{for(var r=e&&e.getFullYear()==d,E=g&&g.getFullYear()==d,A=A+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),z=0;12>z;z++)if((!r||z>=e.getMonth())&&(!E||z<=g.getMonth()))A+='<option value="'+z+'"'+(z==c?' selected="selected"':"")+">"+s[z]+"</option>";A+="</select>"}y||(w+=A+(f||!o||!q?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",f||!q)w+='<span class="ui-datepicker-year">'+d+"</span>";else{var s=this._get(a,
"yearRange").split(":"),C=(new Date).getFullYear(),r=function(a){a=a.match(/c[+-].*/)?d+parseInt(a.substring(1),10):a.match(/[+-].*/)?C+parseInt(a,10):parseInt(a,10);return isNaN(a)?C:a},c=r(s[0]),s=Math.max(c,r(s[1]||"")),c=e?Math.max(c,e.getFullYear()):c,s=g?Math.min(s,g.getFullYear()):s;for(a.yearshtml+='<select class="ui-datepicker-year" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'Y');\" >";c<=s;c++)a.yearshtml+='<option value="'+c+'"'+(c==d?' selected="selected"':
"")+">"+c+"</option>";a.yearshtml+="</select>";w+=a.yearshtml;a.yearshtml=null}w+=this._get(a,"yearSuffix");y&&(w+=(f||!o||!q?"&#xa0;":"")+A);return w+"</div>"},_adjustInstDate:function(a,c,d){var e=a.drawYear+("Y"==d?c:0),g=a.drawMonth+("M"==d?c:0),c=Math.min(a.selectedDay,this._getDaysInMonth(e,g))+("D"==d?c:0),e=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(e,g,c)));a.selectedDay=e.getDate();a.drawMonth=a.selectedMonth=e.getMonth();a.drawYear=a.selectedYear=e.getFullYear();("M"==d||
...
n=a('<a href="#"></a>').addClass("ui-dialog-titlebar-close ui-corner-all").attr("role","button").hover(function(){n.addClass("ui-state-hover")},function(){n.removeClass("ui-state-hover")}).focus(function(){n.addClass("ui-state-focus")}).blur(function(){n.removeClass("ui-state-focus")}).click(function(a){c.close(a);return false}).appendTo(p);(c.uiDialogTitlebarCloseText=a("<span></span>")).addClass("ui-icon ui-icon-closethick").text(d.closeText).appendTo(n);a("<span></span>").addClass("ui-dialog-title").attr("id",
...
handle:".ui-dialog-titlebar",containment:"document",start:function(e,j){f="auto"===b.height?"auto":a(this).height();a(this).height(a(this).height()).addClass("ui-dialog-dragging");d._trigger("dragStart",e,c(j))},drag:function(a,b){d._trigger("drag",a,c(b))},stop:function(p,n){b.position=[n.position.left-e.scrollLeft(),n.position.top-e.scrollTop()];a(this).removeClass("ui-dialog-dragging").height(f);d._trigger("dragStop",p,c(n));a.ui.dialog.overlay.resize()}})},_makeResizable:function(d){function e(a){return{originalPosition:a.originalPosition,
...
(function(a){a.ui=a.ui||{};var c=/left|center|right/,d=/top|center|bottom/,e,f=a.fn.position,i=a.fn.offset;a.fn.position=function(g){if(!g||!g.of)return f.apply(this,arguments);var g=a.extend({},g),b=a(g.of),i=b[0],l=(g.collision||"flip").split(" "),p=g.offset?g.offset.split(" "):[0,0],n,m,r;9===i.nodeType?(n=b.width(),m=b.height(),r={top:0,left:0}):i.setTimeout?(n=b.width(),m=b.height(),r={top:b.scrollTop(),left:b.scrollLeft()}):i.preventDefault?(g.at="left top",n=m=0,r={top:g.of.pageY,left:g.of.pageX}):
(n=b.outerWidth(),m=b.outerHeight(),r=b.offset());a.each(["my","at"],function(){var a=(g[this]||"").split(" ");a.length===1&&(a=c.test(a[0])?a.concat(["center"]):d.test(a[0])?["center"].concat(a):["center","center"]);a[0]=c.test(a[0])?a[0]:"center";a[1]=d.test(a[1])?a[1]:"center";g[this]=a});1===l.length&&(l[1]=l[0]);p[0]=parseInt(p[0],10)||0;1===p.length&&(p[1]=p[0]);p[1]=parseInt(p[1],10)||0;"right"===g.at[0]?r.left+=n:"center"===g.at[0]&&(r.left+=n/2);"bottom"===g.at[1]?r.top+=m:"center"===g.at[1]&&
(r.top+=m/2);r.left+=p[0];r.top+=p[1];return this.each(function(){var b=a(this),c=b.outerWidth(),d=b.outerHeight(),f=parseInt(a.curCSS(this,"marginLeft",true))||0,i=parseInt(a.curCSS(this,"marginTop",true))||0,j=c+f+(parseInt(a.curCSS(this,"marginRight",true))||0),E=d+i+(parseInt(a.curCSS(this,"marginBottom",true))||0),z=a.extend({},r),C;if(g.my[0]==="right")z.left=z.left-c;else if(g.my[0]==="center")z.left=z.left-c/2;if(g.my[1]==="bottom")z.top=z.top-d;else if(g.my[1]==="center")z.top=z.top-d/2;
if(!e){z.left=Math.round(z.left);z.top=Math.round(z.top)}C={left:z.left-f,top:z.top-i};a.each(["left","top"],function(b,e){if(a.ui.position[l[b]])a.ui.position[l[b]][e](z,{targetWidth:n,targetHeight:m,elemWidth:c,elemHeight:d,collisionPosition:C,collisionWidth:j,collisionHeight:E,offset:p,my:g.my,at:g.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(z,{using:g.using}))})};a.ui.position={fit:{left:function(c,b){var d=a(window),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft();
c.left=0<d?c.left-d:Math.max(c.left-b.collisionPosition.left,c.left)},top:function(c,b){var d=a(window),d=b.collisionPosition.top+b.collisionHeight-d.height()-d.scrollTop();c.top=0<d?c.top-d:Math.max(c.top-b.collisionPosition.top,c.top)}},flip:{left:function(c,b){if("center"!==b.at[0]){var d=a(window),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft(),e="left"===b.my[0]?-b.elemWidth:"right"===b.my[0]?b.elemWidth:0,f="left"===b.at[0]?b.targetWidth:-b.targetWidth,i=-2*b.offset[0];
c.left+=0>b.collisionPosition.left?e+f+i:0<d?e+f+i:0}},top:function(c,b){if("center"!==b.at[1]){var d=a(window),d=b.collisionPosition.top+b.collisionHeight-d.height()-d.scrollTop(),e="top"===b.my[1]?-b.elemHeight:"bottom"===b.my[1]?b.elemHeight:0,f="top"===b.at[1]?b.targetHeight:-b.targetHeight,i=-2*b.offset[1];c.top+=0>b.collisionPosition.top?e+f+i:0<d?e+f+i:0}}}};a.offset.setOffset||(a.offset.setOffset=function(c,b){/static/.test(a.curCSS(c,"position"))&&(c.style.position="relative");var d=a(c),
e=d.offset(),f=parseInt(a.curCSS(c,"top",!0),10)||0,i=parseInt(a.curCSS(c,"left",!0),10)||0,e={top:b.top-e.top+f,left:b.left-e.left+i};"using"in b?b.using.call(c,e):d.css(e)},a.fn.offset=function(c){var b=this[0];return!b||!b.ownerDocument?null:c?this.each(function(){a.offset.setOffset(this,c)}):i.call(this)});(function(){var c=document.getElementsByTagName("body")[0],b=document.createElement("div"),d,f;d=document.createElement(c?"div":"body");f={visibility:"hidden",width:0,height:0,border:0,margin:0,
background:"none"};c&&a.extend(f,{position:"absolute",left:"-1000px",top:"-1000px"});for(var i in f)d.style[i]=f[i];d.appendChild(b);f=c||document.documentElement;f.insertBefore(d,f.firstChild);b.style.cssText="position: absolute; left: 10.7432222px; top: 10.432325px; height: 30px; width: 201px;";b=a(b).offset(function(a,b){return b}).offset();d.innerHTML="";f.removeChild(d);c=b.top+b.left+(c?2E3:0);e=c>21&&c<22})()})(jQuery);
...
this.orientation+" ui-widget ui-widget-content ui-corner-all"+(d.disabled?" ui-slider-disabled ui-disabled":""));this.range=a([]);if(d.range){if(!0===d.range&&(d.values||(d.values=[this._valueMin(),this._valueMin()]),d.values.length&&2!==d.values.length))d.values=[d.values[0],d.values[0]];this.range=a("<div></div>").appendTo(this.element).addClass("ui-slider-range ui-widget-header"+("min"===d.range||"max"===d.range?" ui-slider-range-"+d.range:""))}for(var g=e.length;g<f;g+=1)i.push("<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'></a>");
...
_mouseCapture:function(c){var d=this.options,e,f,i,g,b;if(d.disabled)return!1;this.elementSize={width:this.element.outerWidth(),height:this.element.outerHeight()};this.elementOffset=this.element.offset();e=this._normValueFromMouse({x:c.pageX,y:c.pageY});f=this._valueMax()-this._valueMin()+1;g=this;this.handles.each(function(c){var d=Math.abs(e-g.values(c));f>d&&(f=d,i=a(this),b=c)});!0===d.range&&this.values(1)===d.min&&(b+=1,i=a(this.handles[b]));if(!1===this._start(c,b))return!1;this._mouseSliding=
!0;g._handleIndex=b;i.addClass("ui-state-active").focus();d=i.offset();this._clickOffset=!a(c.target).parents().andSelf().is(".ui-slider-handle")?{left:0,top:0}:{left:c.pageX-d.left-i.width()/2,top:c.pageY-d.top-i.height()/2-(parseInt(i.css("borderTopWidth"),10)||0)-(parseInt(i.css("borderBottomWidth"),10)||0)+(parseInt(i.css("marginTop"),10)||0)};this.handles.hasClass("ui-state-hover")||this._slide(c,b,e);return this._animateOff=!0},_mouseStart:function(){return!0},_mouseDrag:function(a){var d=this._normValueFromMouse({x:a.pageX,
...
0);else return this._value()},values:function(c,d){var e,f,i;if(1<arguments.length)this.options.values[c]=this._trimAlignValue(d),this._refreshValue(),this._change(null,c);else if(arguments.length)if(a.isArray(arguments[0])){e=this.options.values;f=arguments[0];for(i=0;i<e.length;i+=1)e[i]=this._trimAlignValue(f[i]),this._change(null,i);this._refreshValue()}else return this.options.values&&this.options.values.length?this._values(c):this.value();else return this._values()},_setOption:function(c,d){var e,
...
this._trimAlignValue(d[e]);return d},_trimAlignValue:function(a){if(a<=this._valueMin())return this._valueMin();if(a>=this._valueMax())return this._valueMax();var d=0<this.options.step?this.options.step:1,e=(a-this._valueMin())%d,a=a-e;2*Math.abs(e)>=d&&(a+=0<e?d:-d);return parseFloat(a.toFixed(5))},_valueMin:function(){return this.options.min},_valueMax:function(){return this.options.max},_refreshValue:function(){var c=this.options.range,d=this.options,e=this,f=!this._animateOff?d.animate:!1,i,g=
{},b,j,l,p;if(this.options.values&&this.options.values.length)this.handles.each(function(c){i=100*((e.values(c)-e._valueMin())/(e._valueMax()-e._valueMin()));g["horizontal"===e.orientation?"left":"bottom"]=i+"%";a(this).stop(1,1)[f?"animate":"css"](g,d.animate);if(!0===e.options.range)if("horizontal"===e.orientation){if(0===c)e.range.stop(1,1)[f?"animate":"css"]({left:i+"%"},d.animate);if(1===c)e.range[f?"animate":"css"]({width:i-b+"%"},{queue:!1,duration:d.animate})}else{if(0===c)e.range.stop(1,
1)[f?"animate":"css"]({bottom:i+"%"},d.animate);if(1===c)e.range[f?"animate":"css"]({height:i-b+"%"},{queue:!1,duration:d.animate})}b=i});else{j=this.value();l=this._valueMin();p=this._valueMax();i=p!==l?100*((j-l)/(p-l)):0;g["horizontal"===e.orientation?"left":"bottom"]=i+"%";this.handle.stop(1,1)[f?"animate":"css"](g,d.animate);if("min"===c&&"horizontal"===this.orientation)this.range.stop(1,1)[f?"animate":"css"]({width:i+"%"},d.animate);if("max"===c&&"horizontal"===this.orientation)this.range[f?
"animate":"css"]({width:100-i+"%"},{queue:!1,duration:d.animate});if("min"===c&&"vertical"===this.orientation)this.range.stop(1,1)[f?"animate":"css"]({height:i+"%"},d.animate);if("max"===c&&"vertical"===this.orientation)this.range[f?"animate":"css"]({height:100-i+"%"},{queue:!1,duration:d.animate})}}});a.extend(a.ui.slider,{version:"1.8.20"})})(jQuery);
...
function(){p("hover",a(this))});this.lis.bind("mouseout.tabs",function(){a(this).removeClass("ui-state-hover")});this.anchors.bind("focus.tabs",function(){p("focus",a(this).closest("li"))});this.anchors.bind("blur.tabs",function(){a(this).closest("li").removeClass("ui-state-focus")})}var n,m;b.fx&&(a.isArray(b.fx)?(n=b.fx[0],m=b.fx[1]):n=m=b.fx);var r=m?function(b,c){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");c.hide().removeClass("ui-tabs-hide").animate(m,m.duration||"normal",
function(){e(c,m);g._trigger("show",null,g._ui(b,c[0]))})}:function(b,c){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");c.removeClass("ui-tabs-hide");g._trigger("show",null,g._ui(b,c[0]))},s=n?function(a,b){b.animate(n,n.duration||"normal",function(){g.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");e(b,n);g.element.dequeue("tabs")})}:function(a,b){g.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");g.element.dequeue("tabs")};
...
(e.insertBefore(this.lis[g]),l.insertBefore(this.panels[g]));j.disabled=a.map(j.disabled,function(a){return a>=g?++a:a});this._tabify();1==this.anchors.length&&(j.selected=0,e.addClass("ui-tabs-selected ui-state-active"),l.removeClass("ui-tabs-hide"),this.element.queue("tabs",function(){b._trigger("show",null,b._ui(b.anchors[0],b.panels[0]))}),this.load(0));this._trigger("add",null,this._ui(this.anchors[g],this.panels[g]));return this},remove:function(c){var c=this._getIndex(c),d=this.options,e=this.lis.eq(c).remove(),
...
(l[j+b]=!0,l[j+a.hotkeys.shiftNums[b]]=!0,"shift+"===j&&(l[a.hotkeys.shiftNums[b]]=!0));d=0;for(b=f.length;d<b;d++)if(l[f[d]])return e.apply(this,arguments)}}}}a.hotkeys={version:"0.8",specialKeys:{8:"backspace",9:"tab",13:"return",16:"shift",17:"ctrl",18:"alt",19:"pause",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"insert",46:"del",96:"0",97:"1",98:"2",99:"3",100:"4",101:"5",102:"6",103:"7",104:"8",105:"9",106:"*",107:"+",
...
(function(a){a.fn.raptorize=function(c){c=a.extend({enterOn:"click",delayTime:5E3},c);return this.each(function(){function d(){i=!0;f&&document.getElementById("elRaptorShriek").play();g.animate({bottom:"0"},function(){a(this).animate({bottom:"-30px"},100,function(){var b=a(this).position().left+400;a(this).delay(300).animate({right:b},2200,function(){g=a("#elRaptor").css({bottom:"-700px",right:"0"});i=!1})})})}var e=a(this),f=!1;if(a.browser.mozilla&&"1.9.2"<=a.browser.version.substr(0,5)||a.browser.webkit)f=
...
(function(a,c,d,e){function f(a,b,c){J[a]=c;u[a]=b;P||(P=a)}function i(b){P!==b&&(P=b,a.ui.editor.eachInstance(function(){this.reinit()}))}function g(a,b){P&&J[P]&&J[P][a]&&(a=J[P][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function b(b){if(I===e){I=!0;if(G=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(b.options.baseClass+"-ios"),G&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height",
...
return d}function r(b,c){var d=a("<div/>").append(b)[0].childNodes;c.deleteContents();d.length===e||1===d.length?c.insertNode(d[0].cloneNode(!0)):a.each(d,function(a,b){c.insertNodeAtEnd(b.cloneNode(!0))})}function s(b){var b=b||d.getSelection(),c;a(b.getAllRanges()).each(function(b,d){c=3===this.commonAncestorContainer.nodeType?a(d.commonAncestorContainer).parent()[0]:d.commonAncestorContainer});return c}function o(a){if(!L||a)L=d.saveSelection()}function q(){L&&(d.restoreSelection(L),L=!1)}function y(a,
b,c){for(var b=b||d.getSelection(),e,f=0;e=b.getAllRanges()[f++];)a.call(c,e)}function w(a,b){y(function(b){r(a,b)},b,this)}function A(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).focus().contents().each(function(){var a=d.createRange();a.selectNodeContents(this);c.addRange(a)})}function E(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNode(this);c.addRange(a)}).focus()}function z(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=
d.createRange();a.selectNodeContents(this);a.collapse();c.addRange(a)})}function C(a){a=a||d.getSelection();return a.toHtml()}function F(b){b=b||d.getSelection().getRangeAt(0);return a(3===b.commonAncestorContainer.nodeType?b.commonAncestorContainer.parentNode:b.commonAncestorContainer)}function H(a){var b=new jQuery;y(function(a){b.push(F(a)[0])},a,this);return b}function D(){var b=d.getSelection();if(null===b.anchorNode)return null;if(b.isBackwards())return 3===b.focusNode.nodeType?a(b.focusNode.parentElement):
a(b.focusNode);b.anchorNode||console.trace();return 3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode)}function v(){var b=d.getSelection();return null===b.anchorNode?null:b.isBackwards()?3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode):3===b.focusNode.nodeType?a(b.focusNode.parentElement):a(b.focusNode)}function M(b,c){var c=c||{},e=d.createCssClassApplier(c.classes||"",{normalize:!0,elementTagName:b,elementProperties:c.attributes||{}});y(function(d){var f=
d.cloneContents(),f=m(f);"string"===typeof f&&(f=f.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));a(f).is(":empty")?(f=a("<"+b+"/>").addClass(c.classes).attr(c.attributes||{}).append(m(d.cloneContents())),r(f,d)):e.toggleRange(d)},null,this)}function R(a,b,c){y(function(d){d=F(d);d.is(a)?d.attr(b):M(a,{classes:c,attributes:b})},null,this)}function h(b,c){var c=c||d.getSelection(),e=c.getRangeAt(0),f=H()[0],g=d.createRange();g.setStartBefore(f);g.setEnd(e.startContainer,e.startOffset);var g=g.cloneContents(),
...
!1).removeClass(this.options.baseClass+"-editing"),d.getSelection().removeAllRanges(),this.fire("disabled"))},isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var b=this,c="",d=[],e=0;y(function(f){var f=f.commonAncestorContainer,g;g=3===f.nodeType?a(f).parent():a(f);f=[];for(d.push(f);g[0]&&!b.isRoot(g)&&"body"!==g[0].tagName.toLowerCase();)f.push(g),g=g.parent();f.reverse();c&&(c+=" | ");c+=this.getTemplate("root");for(g=0;g<f.length;g++)c+=this.getTemplate("tag",
...
this.title).val(b);d.classes&&this.button.addClass(d.classes);this.button.bind("mousedown."+e.editor.widgetName,function(a){a.preventDefault()});var k=this;this.button.bind("mouseup."+e.editor.widgetName,function(a){a.preventDefault();k.click.apply(e,arguments)});c.bind("destroy",a.proxy(function(){this.button.button("destroy").remove()},this));this.button.button({icons:{primary:this.icon||"ui-icon-"+f},disabled:d.disabled?!0:!1,text:this.text||!1,label:this.label||null});this.ready.call(e);return this.button},
...
a.getElement())}})}},alignCenter:{init:function(a){return a.uiButton({title:g("Center Align"),click:function(){a.toggleBlockStyle({"text-align":"center"},a.getElement())}})}},alignRight:{init:function(a){return a.uiButton({title:g("Right Align"),click:function(){a.toggleBlockStyle({"text-align":"right"},a.getElement())}})}}});a.ui.editor.registerUi({textBold:{hotkeys:{"ctrl+b":{action:function(){this.ui.click()}}},init:function(a,b){return this.editor.uiButton({title:g("Bold"),click:function(){M("strong",
{classes:b.classes||b.cssPrefix+"bold"})}})}},textItalic:{hotkeys:{"ctrl+i":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:g("Italic"),click:function(){M("em",{classes:b.classes||b.cssPrefix+"italic"})}})}},textUnderline:{hotkeys:{"ctrl+u":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:g("Underline"),click:function(){M("u",{classes:b.classes||b.cssPrefix+"underline"})}})}},textStrike:{hotkeys:{"ctrl+k":{action:function(){this.ui.click()}}},
init:function(a,b){return a.uiButton({title:g("Strikethrough"),click:function(){M("del",{classes:b.classes||b.cssPrefix+"strike"})}})}},textSub:{init:function(a,b){return a.uiButton({title:g("Sub script"),click:function(){M("sub",{classes:b.classes||b.cssPrefix+"sub"})}})}},textSuper:{init:function(a,b){return a.uiButton({title:g("Super script"),click:function(){M("sup",{classes:b.classes||b.cssPrefix+"super"})}})}}});a.ui.editor.registerUi({quoteBlock:{init:function(a,b){return a.uiButton({title:g("Blockquote"),
...
a(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:g("Paste Embed Code"),autoOpen:!0,dialogClass:b.options.baseClass+" "+b.options.dialogClass,buttons:[{text:g("Embed Object"),click:function(){q();w(a(this).find("textarea").val());a(this).dialog("close")}},{text:g("Close"),click:function(){b.hide()}}],open:function(){var b=a(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});
...
a.ui.editor.registerPlugin("emptyElement",{options:{tag:"<p/>"},init:function(){this.bind("change",this.change)},change:function(){var b=this;this.textNodes(this.editor.getElement()).each(function(){a(this).wrap(a(b.options.tag));z(this)});this.editor.checkChange()},textNodes:function(b){return a(b).contents().filter(function(){return 3==this.nodeType&&a.trim(this.nodeValue).length})}});a.ui.editor.registerUi({floatLeft:{init:function(b){return b.uiButton({title:g("Float Image Left"),click:function(){y(function(b){a(b.commonAncestorContainer).find("img").css("float",
"left")})}})}},floatRight:{init:function(b){return b.uiButton({title:g("Float Image Right"),click:function(){y(function(b){a(b.commonAncestorContainer).find("img").css("float","right")})}})}},floatNone:{init:function(b){return b.uiButton({title:g("Remove Image Float"),click:function(){y(function(b){a(b.commonAncestorContainer).find("img").css("float","none")})}})}}});a.ui.editor.registerUi({fontSizeInc:{init:function(a,b){return a.uiButton({title:g("Increase Font Size"),click:function(){a.inverseWrapWithTagClass("big",
...
init:function(a){a.bind("change",this.change,this);return this.ui=a.uiButton({title:g("Step Forward"),click:function(){a.historyForward()}})},change:function(){this.editor.present===this.editor.history.length-1?this.ui.disable():this.ui.enable()}}});a.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:g("Insert Horizontal Rule"),click:function(){w("<hr/>")}})}}});a.ui.editor.registerUi({i18n:{init:function(b){var c=this,d=this.persist("locale");d&&i(d);var d=a('<select autocomplete="off" name="i18n"/>'),
e;for(e in J){var f=a('<option value="'+e+'" class="'+e+'"/>');f.html(u[e]);P===e&&f.attr("selected","selected");d.append(f)}return b.uiSelectMenu({title:g("Change Language"),select:d,change:function(a){i(c.persist("locale",a))}})}}});f("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"Apply Source","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",
...
this.options.manuallyResizingClass]);a.isArray(b)||(b=[b]);for(var c=0;c<b.length;c++)this.editor.getElement().find("img."+b[c]).removeClass(b[c])},manuallyResizeImage:function(){this.removeToolsButtons();var b=this.editor.getElement().find("img."+this.options.manuallyResizingClass),c=a(b).innerWidth(),d=a(b).innerHeight(),e="#"+this.options.baseClass+"-width",f="#"+this.options.baseClass+"-height",h=this,i=function(c){c=Math.round(c||a(e).val())+"px";a(b).css({width:c})},j=a(this.editor.getTemplate("imageresize.manually-resize-image",
{width:c,height:d,baseClass:this.options.baseClass}));j.dialog({modal:!0,resizable:!1,title:g("Modify Image Size"),autoOpen:!0,buttons:[{text:g("Resize Image"),click:function(){i();a(this).dialog("close")}},{text:g("Cancel"),click:function(){a(this).dialog("close")}}],close:function(){i(c);h.editor.checkChange();a(j).remove()},open:function(){var b=a(this).find(e),g=a(this).find(f);b.keyup(function(){g.val(Math.round(Math.abs(d/c*a(this).val())));i()});g.keyup(function(){b.val(Math.round(Math.abs(c/
d*a(this).val())));i()})}})},displayToolsButtonRelativeToImage:function(b){var c=a("<button/>").appendTo("body").addClass(this.options.resizeButtonClass).button({text:!1,icons:{primary:"ui-icon-tools"}});c.css({position:"absolute",left:a(b).position().left+a(b).innerWidth()-a(c).outerWidth()-10+"px",marginTop:"10px"}).click(a.proxy(this.manuallyResizeImage,this));a(b).before(c)},removeToolsButtons:function(){this.editor.getElement().find("."+this.options.resizeButtonClass).each(function(){a(this).remove()})},
...
this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(c.classes).attr(d),this.editor.showConfirm(g("Updated link: {{link}}",{link:e}))):(R("a",a.extend(d,{id:this.editor.getUniqueId()}),c.classes),this.editor.showConfirm(g("Added link: {{link}}",{link:e})),this.selectedElement=a("#"+d.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",d.href);E(this.selectedElement);o();return!0},typeChange:function(b,
...
this.change,this);return a.uiButton({title:g("Insert Link"),click:function(){a.getPlugin("link").show()}})},change:function(){H().length?this.ui.enable():this.ui.disable()}},unlink:{hotkeys:{"ctrl+shift+l":{action:function(){this.ui.click()},restoreSelection:!1}},init:function(a){a.bind("selectionChange",this.change,this);a.bind("show",this.change,this);return a.uiButton({title:g("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){H().is("a")?this.ui.enable():this.ui.disable()}}});
a.ui.editor.registerPlugin("list",{options:{},validParents:"blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),validChildren:"a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,dfn,em,font,i,iframe,img,input,kbd,label,map,object,p,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var".split(","),toggleList:function(b){a(H()).is("li")&&a(H()).parent().is(b)?this.unwrapList():this.wrapList(b);this.editor.fire("selectionChange");
this.editor.fire("change")},unwrapList:function(){o();var b=[],c=[],d=D(),e=v();b.push(a(d).html());c.push(d);if(a(d)[0]!==a(e)[0]){var f=d;do f=a(f).next(),b.push(a(f).html()),c.push(f);while(a(f)[0]!==a(e)[0])}f=0===a(d).prev().length;e=0===a(e).next().length;d=a(d).parent();for(listElementsIndex=0;listElementsIndex<c.length;listElementsIndex++)a(c[listElementsIndex]).remove();for(c=0;c<b.length;c++)d.parent().is("li")||(b[c]="<p>"+b[c]+"</p>");f&&e?(d.replaceWith(b.join("")),q(),b=H()[0],E(b)):
(f?a(d).before(b.join("")):e?a(d).after(b.join("")):h(b.join("")),q(),this.editor.checkChange())},wrapList:function(b){this.editor.constrainSelection(this.editor.getElement());""===a.trim(C())&&A(H());var c=a("<div>").html(C()),d=[],e=this;a(c).contents().each(function(){var b;b="block"===p(this.tagName)?Q(a(this).html(),e.validChildren):Q(l(a(this)),e.validChildren);b=a("<li>"+b+"</li>");""!==a.trim(b.text())&&d.push(l(b))});c=this.options.baseClass+"-selection";b="<"+b+' class="'+c+'">'+d.join("")+
"</"+b+">";q();var f=a(H()[0]).parent(),g=this.editor.getElement()[0];f===g||H()[0]===g?w(b):S(b,this.validParents);c=a(this.editor.getElement().find("."+c).removeClass(c));A(c.find("li:first")[0]);this.editor.checkChange()},toggleButtonState:function(b,c){var d=function(a){c.button.toggleClass("ui-state-highlight",a).toggleClass("ui-state-default",!a)},e=D();if(null===e||!e.length)e=this.editor.getElement();var f=v();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(a(e).is(b)&&
a(f).is(b)&&e===f)return d(!0);var g=a(e).parentsUntil(h,b).first()&&a(f).parentsUntil(h,b).first(),h="#"+this.editor.getElement().attr("id"),i=a(e).is(b+" > li")||a(e).parentsUntil(h,b+" > li").length,j=a(f).is(b+" > li")||a(f).parentsUntil(h,b+" > li").length;if(i&&j&&g){g=a(s());g.is(b)||(g=a(g).parentsUntil(h,b).first());h=g.find("ul, ol");if(!h.length)return d(!0);for(g=0;g<h.length;g++)if(a.contains(h[g],e)&&a.contains(h[g],f))return d(!1);return d(!0)}return d(!1)}});a.ui.editor.registerUi({listUnordered:{init:function(a){var b=
a.uiButton({title:g("Unordered List"),click:function(){a.getPlugin("list").toggleList("ul")}});a.bind("selectionChange",function(){a.getPlugin("list").toggleButtonState("ul",b)});return b}},listOrdered:{init:function(a){var b=a.uiButton({title:g("Ordered List"),click:function(){a.getPlugin("list").toggleList("ol")}});a.bind("selectionChange",function(){a.getPlugin("list").toggleButtonState("ol",b)});return b}}});a.ui.editor.registerUi({logo:{ui:null,init:function(){return this.ui=this.editor.uiButton({title:g("Learn More About the Raptor WYSIWYG Editor"),
...
ui:b(this.options.ui),t:(new Date).getTime()},d=[],e;for(e in c)d.push(e+"="+encodeURIComponent(c[e]));this.ui.button.find(".ui-button-icon-primary").css({"background-image":"url(http://www.jquery-raptor.com/logo/0.0.11?"+d.join("&")+")"})}})}}});a.ui.editor.registerPlugin("normaliseLineBreaks",{options:{"return":"<p><br/></p>",returnValidTags:"address,blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),shiftReturn:"<br/>",shiftReturnValidTags:"a,abbr,acronym,address,applet,b,bdo,big,blockquote,body,button,caption,center,cite,code,dd,del,dfn,div,dt,em,fieldset,font,form,h1,h2,h3,h4,h5,h6,i,iframe,ins,kbd,label,legend,li,noframes,noscript,object,p,pres,q,s,samp,small,span,strike,strong,sub,sup,td,th,tt,u,var".split(",")},
hotkeys:{"return":{action:function(){this.insertBreak(this.options["return"],this.options.returnValidTags)},restoreSelection:!1},"return+shift":{action:function(){this.insertBreak(this.options.shiftReturn,this.options.shiftReturnValidTags)},restoreSelection:!1}},insertBreak:function(b,c){var d=this.options.widgetName+"-return-break",e=a(b).attr("id",d);S(e,c);z(a("#"+d).removeAttr("id"))}});a.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span,hr,br".split(","),
allowedAttributes:["href","title"],allowedEmptyTags:["hr","br"]},init:function(b,d){var e=!1,f=!1,h=this;b.getElement().bind("paste."+b.widgetName,a.proxy(function(){if(e)return!1;e=!0;o();a(".uiWidgetEditorPasteBin").length&&a(".uiWidgetEditorPasteBin").remove();a('<div class="uiWidgetEditorPasteBin" contenteditable="true" style="width: 1px; height: 1px; overflow: hidden; position: fixed; top: -1px;" />').appendTo("body");a(".uiWidgetEditorPasteBin").focus();c.setTimeout(function(){var c=a(".uiWidgetEditorPasteBin").html(),
c=h.filterAttributes(c),c=h.filterChars(c),c=h.stripEmpty(c),c=h.stripAttributes(c),c=Q(c,h.options.allowedTags),c={plain:a("<div/>").html(a(".uiWidgetEditorPasteBin").html()).text(),markup:c,html:a(".uiWidgetEditorPasteBin").html()};f=a(b.getTemplate("paste.dialog",c));f.find(".ui-editor-paste-area").bind("keyup."+b.widgetname,function(){h.updateAreas(this,f)});a(f).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:d.dialogShowAnimation,hide:d.dialogHideAnimation,
dialogClass:d.baseClass+" "+d.dialogClass,buttons:[{text:g("Insert"),click:function(){var b=null,b=a(this).find(".ui-editor-paste-area:visible"),b=b.hasClass("ui-editor-paste-plain")||b.hasClass("ui-editor-paste-source")?b.val():b.html(),b=h.filterAttributes(b),b=h.filterChars(b);q();w(b);e=!1;a(this).dialog("close")}},{text:g("Cancel"),click:function(){q();e=!1;a(this).dialog("close")}}],open:function(){var b=a(this).find(".ui-editor-paste-panel-tabs");b.find("ul.ui-tabs-nav li").click(function(){b.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
...
b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){a(this).dialog("destroy").remove();a(d).button("option","disabled",!1);b.editor.checkChange()}})}}});var L=!1})(jQuery,window,rangy);
