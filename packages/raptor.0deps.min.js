...
*/
window.rangy=function(){function a(a,b){var c=typeof a[b];return c==l||!!(c==j&&a[b])||"unknown"==c}function c(a,b){return!!(typeof a[b]==j&&a[b])}function d(a,b){return typeof a[b]!=o}function f(a){return function(b,c){for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0}}function e(a){return a&&q(a,s)&&y(a,p)}function i(a){window.alert("Rangy not supported in your browser. Reason: "+a);v.initialized=!0;v.supported=!1}function g(){if(!v.initialized){var b,d=!1,f=!1;a(document,"createRange")&&
(b=document.createRange(),q(b,m)&&y(b,n)&&(d=!0),b.detach());if((b=c(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(b,"createTextRange"))b=b.createTextRange(),e(b)&&(f=!0);!d&&!f&&i("Neither Range nor TextRange are implemented");v.initialized=!0;v.features={implementsDomRange:d,implementsTextRange:f};d=C.concat(A);f=0;for(b=d.length;f<b;++f)try{d[f](v)}catch(j){c(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
...
p="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),s="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),q=f(a),r=f(c),y=f(d),v={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:a,isHostObject:c,isHostProperty:d,areHostMethods:q,areHostObjects:r,areHostProperties:y,isTextRange:e},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
v.fail=i;v.warn=function(a){a="Rangy warning: "+a;v.config.alertOnWarn?window.alert(a):typeof window.console!=o&&typeof window.console.log!=o&&window.console.log(a)};({}).hasOwnProperty?v.util.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])}:i("hasOwnProperty not supported");var A=[],C=[];v.init=g;v.addInitListener=function(a){v.initialized?a(v):A.push(a)};var x=[];v.addCreateMissingNativeApiListener=function(a){x.push(a)};v.createMissingNativeApi=function(a){a=a||window;g();
for(var b=0,c=x.length;b<c;++b)x[b](a)};b.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};b.prototype.warn=function(a){v.warn("Module "+this.name+": "+a)};b.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};v.createModule=function(a,c){var d=new b(a);v.modules[a]=d;C.push(function(a){c(a,d);d.initialized=!0;d.supported=!0})};v.requireModules=function(a){for(var c=0,d=a.length,e,f;c<
d;++c){f=a[c];e=v.modules[f];if(!e||!(e instanceof b))throw Error("Module '"+f+"' not found");if(!e.supported)throw Error("Module '"+f+"' not supported");}};var D=!1,r=function(){D||(D=!0,v.initialized||g())};if(typeof window==o)i("No window found");else if(typeof document==o)i("No document found");else return a(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",r,!1),a(window,"addEventListener")?window.addEventListener("load",r,!1):a(window,"attachEvent")?window.attachEvent("onload",
r):i("Window does not have required addEventListener or attachEvent method"),v}();
...
rangy.createModule("DomRange",function(a){function c(a,b){return 3!=a.nodeType&&(t.isAncestorOf(a,b.startContainer,!0)||t.isAncestorOf(a,b.endContainer,!0))}function d(a){return t.getDocument(a.startContainer)}function f(a,b,c){if(b=a._listeners[b])for(var d=0,k=b.length;d<k;++d)b[d].call(a,{target:a,args:c})}function e(a){return new H(a.parentNode,t.getNodeIndex(a))}function i(a){return new H(a.parentNode,t.getNodeIndex(a)+1)}function g(a,b,c){var d=11==a.nodeType?a.firstChild:a;t.isCharacterDataNode(b)?
c==b.length?t.insertAfter(a,b):b.parentNode.insertBefore(a,0==c?b:t.splitDataNode(b,c)):c>=b.childNodes.length?b.appendChild(a):b.insertBefore(a,b.childNodes[c]);return d}function b(a){for(var c,k,h=d(a.range).createDocumentFragment();k=a.next();){c=a.isPartiallySelectedSubtree();k=k.cloneNode(!c);c&&(c=a.getSubtreeIterator(),k.appendChild(b(c)),c.detach(!0));if(10==k.nodeType)throw new G("HIERARCHY_REQUEST_ERR");h.appendChild(k)}return h}function j(a,b,c){for(var d,k,c=c||{stop:!1};d=a.next();)if(a.isPartiallySelectedSubtree())if(!1===
...
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function q(a,b,c){this.nodes=n(a,b,c);this._next=this.nodes[0];this._position=0}function r(a){return function(b,c){for(var d,k=c?b:b.parentNode;k;){d=k.nodeType;if(t.arrayContains(a,d))return k;k=k.parentNode}return null}}function y(a,b){if(u(a,b))throw new s("INVALID_NODE_TYPE_ERR");}function v(a){if(!a.startContainer)throw new G("INVALID_STATE_ERR");}function A(a,b){if(!t.arrayContains(b,a.nodeType))throw new s("INVALID_NODE_TYPE_ERR");
}function C(a,b){if(0>b||b>(t.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new G("INDEX_SIZE_ERR");}function x(a,b){if(L(a,!0)!==L(b,!0))throw new G("WRONG_DOCUMENT_ERR");}function D(a){if(k(a,!0))throw new G("NO_MODIFICATION_ALLOWED_ERR");}function F(a,b){if(!a)throw new G(b);}function N(a){return!!a.startContainer&&!!a.endContainer&&!(!t.arrayContains(I,a.startContainer.nodeType)&&!L(a.startContainer,!0))&&!(!t.arrayContains(I,a.endContainer.nodeType)&&!L(a.endContainer,!0))&&a.startOffset<=
(t.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(t.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function E(a){v(a);if(!N(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function w(){}function O(a){a.START_TO_START=$;a.START_TO_END=X;a.END_TO_END=wa;a.END_TO_START=na;a.NODE_BEFORE=ka;a.NODE_AFTER=oa;a.NODE_BEFORE_AND_AFTER=pa;a.NODE_INSIDE=
la}function S(a){O(a);O(a.prototype)}function h(a,b){return function(){E(this);var c=this.startContainer,d=this.startOffset,k=this.commonAncestorContainer,h=new p(this,!0);c!==k&&(c=t.getClosestAncestorIn(c,k,!0),d=i(c),c=d.node,d=d.offset);j(h,D);h.reset();k=a(h);h.detach();b(this,c,d,c,d);return k}}function T(b,d,k){function f(a,b){return function(c){v(this);A(c,J);A(U(c),I);c=(a?e:i)(c);(b?j:g)(this,c.node,c.offset)}}function j(a,b,c){var k=a.endContainer,h=a.endOffset;if(b!==a.startContainer||
c!==a.startOffset){if(U(b)!=U(k)||1==t.comparePoints(b,c,k,h))k=b,h=c;d(a,b,c,k,h)}}function g(a,b,c){var k=a.startContainer,h=a.startOffset;if(b!==a.endContainer||c!==a.endOffset){if(U(b)!=U(k)||-1==t.comparePoints(b,c,k,h))k=b,h=c;d(a,k,h,b,c)}}b.prototype=new w;a.util.extend(b.prototype,{setStart:function(a,b){v(this);y(a,!0);C(a,b);j(this,a,b)},setEnd:function(a,b){v(this);y(a,!0);C(a,b);g(this,a,b)},setStartBefore:f(!0,!0),setStartAfter:f(!1,!0),setEndBefore:f(!0,!1),setEndAfter:f(!1,!1),collapse:function(a){E(this);
a?d(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):d(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){v(this);y(a,!0);d(this,a,0,a,t.getNodeLength(a))},selectNode:function(a){v(this);y(a,!1);A(a,J);var b=e(a),a=i(a);d(this,b.node,b.offset,a.node,a.offset)},extractContents:h(o,d),deleteContents:h(l,d),canSurroundContents:function(){E(this);D(this.startContainer);D(this.endContainer);var a=new p(this,!0),b=a._first&&
c(a._first,this)||a._last&&c(a._last,this);a.detach();return!b},detach:function(){k(this)},splitBoundaries:function(){E(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,k=this.endOffset,h=a===c;t.isCharacterDataNode(c)&&0<k&&k<c.length&&t.splitDataNode(c,k);t.isCharacterDataNode(a)&&0<b&&b<a.length&&(a=t.splitDataNode(a,b),h?(k-=b,c=a):c==a.parentNode&&k>=t.getNodeIndex(a)&&k++,b=0);d(this,a,b,c,k)},normalizeBoundaries:function(){E(this);var a=this.startContainer,b=this.startOffset,
c=this.endContainer,k=this.endOffset,h=function(a){var b=a.nextSibling;b&&b.nodeType==a.nodeType&&(c=a,k=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},e=function(d){var h=d.previousSibling;if(h&&h.nodeType==d.nodeType){a=d;var e=d.length;b=h.length;d.insertData(0,h.data);h.parentNode.removeChild(h);a==c?(k+=b,c=a):c==d.parentNode&&(h=t.getNodeIndex(d),k==h?(c=d,k=e):k>h&&k--)}},f=!0;t.isCharacterDataNode(c)?c.length==k&&h(c):(0<k&&(f=c.childNodes[k-1])&&t.isCharacterDataNode(f)&&h(f),
f=!this.collapsed);f?t.isCharacterDataNode(a)?0==b&&e(a):b<a.childNodes.length&&(h=a.childNodes[b])&&t.isCharacterDataNode(h)&&e(h):(a=c,b=k);d(this,a,b,c,k)},collapseToPoint:function(a,b){v(this);y(a,!0);C(a,b);(a!==this.startContainer||b!==this.startOffset||a!==this.endContainer||b!==this.endOffset)&&d(this,a,b,a,b)}});S(b)}function R(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:t.getCommonAncestor(a.startContainer,
a.endContainer)}function Q(a,b,c,d,k){var h=a.startContainer!==b||a.startOffset!==c,e=a.endContainer!==d||a.endOffset!==k;a.startContainer=b;a.startOffset=c;a.endContainer=d;a.endOffset=k;R(a);f(a,"boundarychange",{startMoved:h,endMoved:e})}function M(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};R(this)}a.requireModules(["DomUtil"]);var t=a.dom,H=t.DomPosition,G=a.DOMException;p.prototype={_current:null,_next:null,_first:null,
...
(a===this.sc||a===this.ec)?(b=a===this.sc?this.so:0,c=a===this.ec?this.eo:a.length,b!=c&&a.deleteData(b,c-b)):a.parentNode&&a.parentNode.removeChild(a)},isPartiallySelectedSubtree:function(){return c(this._current,this.range)},getSubtreeIterator:function(){var a;if(this.isSingleCharacterDataNode)a=this.range.cloneRange(),a.collapse();else{a=new M(d(this.range));var b=this._current,c=b,k=0,h=b,e=t.getNodeLength(b);t.isAncestorOf(b,this.sc,!0)&&(c=this.sc,k=this.so);t.isAncestorOf(b,this.ec,!0)&&(h=
this.ec,e=this.eo);Q(a,c,k,h,e)}return new p(a,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};s.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};s.prototype.toString=function(){return this.message};q.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
detach:function(){this._current=this._next=this.nodes=null}};var J=[1,3,4,5,7,8,10],I=[2,9,11],W=[1,3,4,5,7,8,10,11],Y=[1,3,4,5,7,8],U=t.getRootContainer,L=r([9,11]),k=r([5,6,10,12]),u=r([6,10,12]),z=document.createElement("style"),K=!1;try{z.innerHTML="<b>x</b>",K=3==z.firstChild.nodeType}catch(P){}a.features.htmlParsingConforms=K;var V="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),$=0,X=1,wa=2,na=3,ka=0,oa=1,pa=2,la=3;w.prototype={attachListener:function(a,
b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){E(this);x(this.startContainer,b.startContainer);var c=a==na||a==$?"start":"end",d=a==X||a==$?"start":"end";return t.comparePoints(this[c+"Container"],this[c+"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){E(this);A(a,W);D(this.startContainer);if(t.isAncestorOf(a,this.startContainer,!0))throw new G("HIERARCHY_REQUEST_ERR");this.setStartBefore(g(a,this.startContainer,this.startOffset))},cloneContents:function(){E(this);
...
this);a.detach();return!b},surroundContents:function(a){A(a,Y);if(!this.canSurroundContents())throw new s("BAD_BOUNDARYPOINTS_ERR");var b=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);g(a,this.startContainer,this.startOffset);a.appendChild(b);this.selectNode(a)},cloneRange:function(){E(this);for(var a=new M(d(this)),b=V.length,c;b--;)c=V[b],a[c]=this[c];return a},toString:function(){E(this);var a=this.startContainer;if(a===this.endContainer&&t.isCharacterDataNode(a))return 3==
a.nodeType||4==a.nodeType?a.data.slice(this.startOffset,this.endOffset):"";var b=[],a=new p(this,!0);j(a,function(a){(3==a.nodeType||4==a.nodeType)&&b.push(a.data)});a.detach();return b.join("")},compareNode:function(a){E(this);var b=a.parentNode,c=t.getNodeIndex(a);if(!b)throw new G("NOT_FOUND_ERR");a=this.comparePoint(b,c);b=this.comparePoint(b,c+1);return 0>a?0<b?pa:ka:0<b?oa:la},comparePoint:function(a,b){E(this);F(a,"HIERARCHY_REQUEST_ERR");x(a,this.startContainer);return 0>t.comparePoints(a,
b,this.startContainer,this.startOffset)?-1:0<t.comparePoints(a,b,this.endContainer,this.endOffset)?1:0},createContextualFragment:K?function(a){var b=this.startContainer,c=t.getDocument(b);if(!b)throw new G("INVALID_STATE_ERR");var d=null;1==b.nodeType?d=b:t.isCharacterDataNode(b)&&(d=t.parentElement(b));d=null===d||"HTML"==d.nodeName&&t.isHtmlNamespace(t.getDocument(d).documentElement)&&t.isHtmlNamespace(d)?c.createElement("body"):d.cloneNode(!1);d.innerHTML=a;return t.fragmentFromNodeChildren(d)}:
function(a){v(this);var b=d(this).createElement("body");b.innerHTML=a;return t.fragmentFromNodeChildren(b)},toHtml:function(){E(this);var a=d(this).createElement("div");a.appendChild(this.cloneContents());return a.innerHTML},intersectsNode:function(a,b){E(this);F(a,"NOT_FOUND_ERR");if(t.getDocument(a)!==d(this))return!1;var c=a.parentNode,k=t.getNodeIndex(a);F(c,"NOT_FOUND_ERR");var h=t.comparePoints(c,k,this.endContainer,this.endOffset),c=t.comparePoints(c,k+1,this.startContainer,this.startOffset);
return b?0>=h&&0<=c:0>h&&0<c},isPointInRange:function(a,b){E(this);F(a,"HIERARCHY_REQUEST_ERR");x(a,this.startContainer);return 0<=t.comparePoints(a,b,this.startContainer,this.startOffset)&&0>=t.comparePoints(a,b,this.endContainer,this.endOffset)},intersectsRange:function(a,b){E(this);if(d(a)!=d(this))throw new G("WRONG_DOCUMENT_ERR");var c=t.comparePoints(this.startContainer,this.startOffset,a.endContainer,a.endOffset),k=t.comparePoints(this.endContainer,this.endOffset,a.startContainer,a.startOffset);
...
containsNodeText:function(a){var b=this.cloneRange();b.selectNode(a);var c=b.getNodes([3]);return 0<c.length?(b.setStart(c[0],0),a=c.pop(),b.setEnd(a,a.length),a=this.containsRange(b),b.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){E(this);return new q(this,a,b)},getNodes:function(a,b){E(this);return n(this,a,b)},getDocument:function(){return d(this)},collapseBefore:function(a){v(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){v(this);this.setStartAfter(a);
this.collapse(!0)},getName:function(){return"DomRange"},equals:function(a){return M.rangesEqual(this,a)},isValid:function(){return N(this)},inspect:function(){return m(this)}};T(M,Q,function(a){v(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;f(a,"detach",null);a._listeners=null});a.rangePrototype=w.prototype;M.rangeProperties=V;M.RangeIterator=p;M.copyComparisonConstants=S;M.createPrototypeRange=T;M.inspect=m;M.getRangeDocument=d;M.rangesEqual=
function(a,b){return a.startContainer===b.startContainer&&a.startOffset===b.startOffset&&a.endContainer===b.endContainer&&a.endOffset===b.endOffset};a.DomRange=M;a.RangeException=s});
rangy.createModule("WrappedRange",function(a){function c(a,b,c,d){var f=a.duplicate();f.collapse(c);var g=f.parentElement();e.isAncestorOf(b,g,!0)||(g=b);if(!g.canHaveHTML)return new i(g.parentNode,e.getNodeIndex(g));var b=e.getDocument(g).createElement("span"),s,q=c?"StartToStart":"StartToEnd";do g.insertBefore(b,b.previousSibling),f.moveToElementText(b);while(0<(s=f.compareEndPoints(q,a))&&b.previousSibling);q=b.nextSibling;if(-1==s&&q&&e.isCharacterDataNode(q)){f.setEndPoint(c?"EndToStart":"EndToEnd",
...
!1;break a}c=!0}if(!c)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function j(a,b){var c=new v(b);a._ranges=[c];e(a,c,!1);a.rangeCount=1;a.isCollapsed=c.collapsed}function l(b){b._ranges.length=0;if("None"==b.docSelection.type)i(b);else{var c=b.docSelection.createRange();if(c&&"undefined"!=typeof c.text)j(b,c);else{b.rangeCount=c.length;for(var d,k=q.getDocument(c.item(0)),h=0;h<b.rangeCount;++h)d=a.createRange(k),d.selectNode(c.item(h)),
b._ranges.push(d);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;e(b,b._ranges[b.rangeCount-1],!1)}}}function o(a,c){for(var d=a.docSelection.createRange(),k=b(c),h=q.getDocument(d.item(0)),h=q.getBody(h).createControlRange(),e=0,f=d.length;e<f;++e)h.add(d.item(e));try{h.add(k)}catch(g){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}h.select();l(a)}function n(a,b,c){this.nativeSelection=a;this.docSelection=b;this._ranges=
[];this.win=c;this.refresh()}function m(a,c){for(var d=q.getDocument(c[0].startContainer),d=q.getBody(d).createControlRange(),k=0,h;k<rangeCount;++k){h=b(c[k]);try{d.add(h)}catch(e){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();l(a)}function p(a,b){if(a.anchorNode&&q.getDocument(a.anchorNode)!==q.getDocument(b))throw new A("WRONG_DOCUMENT_ERR");}function s(a){var b=[],c=new C(a.anchorNode,a.anchorOffset),
d=new C(a.focusNode,a.focusOffset),h="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var e=0,f=a.rangeCount;e<f;++e)b[e]=y.inspect(a.getRangeAt(e));return"["+h+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var q=a.dom,r=a.util,y=a.DomRange,v=a.WrappedRange,A=a.DOMException,C=q.DomPosition,x,D,F=a.util.isHostMethod(window,"getSelection"),
N=a.util.isHostObject(document,"selection"),E=N&&(!F||a.config.preferTextRange);E?(x=f,a.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return"None"!=b.type||q.getDocument(b.createRange().parentElement())==a}):F?(x=d,a.isSelectionValid=function(){return!0}):c.fail("Neither document.selection or window.getSelection() detected.");a.getNativeSelection=x;var F=x(),w=a.createNativeRange(document),O=q.getBody(document),S=r.areHostObjects(F,r.areHostProperties(F,["anchorOffset","focusOffset"]));
a.features.selectionHasAnchorAndFocus=S;var h=r.isHostMethod(F,"extend");a.features.selectionHasExtend=h;var T="number"==typeof F.rangeCount;a.features.selectionHasRangeCount=T;var R=!1,Q=!0;r.areHostMethods(F,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof F.rangeCount&&a.features.implementsDomRange&&function(){var a=document.createElement("iframe");a.frameBorder=0;a.style.position="absolute";a.style.left="-10000px";O.appendChild(a);var b=q.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");
b.close();var c=q.getIframeWindow(a).getSelection(),d=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(d,1);b.collapse(true);c.addRange(b);Q=c.rangeCount==1;c.removeAllRanges();var h=b.cloneRange();b.setStart(d,0);h.setEnd(d,2);c.addRange(b);c.addRange(h);R=c.rangeCount==2;b.detach();h.detach();O.removeChild(a)}();a.features.selectionSupportsMultipleRanges=R;a.features.collapsedNonEditableSelectionsSupported=Q;var M=!1,t;O&&r.isHostMethod(O,"createControlRange")&&(t=O.createControlRange(),
r.areHostProperties(t,["item","add"])&&(M=!0));a.features.implementsControlRange=M;D=S?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:false};var H;r.isHostMethod(F,"getRangeAt")?H=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:S&&(H=function(b){var c=q.getDocument(b.anchorNode),c=a.createRange(c);c.setStart(b.anchorNode,b.anchorOffset);c.setEnd(b.focusNode,b.focusOffset);if(c.collapsed!==
this.isCollapsed){c.setStart(b.focusNode,b.focusOffset);c.setEnd(b.anchorNode,b.anchorOffset)}return c});a.getSelection=function(a){var a=a||window,b=a._rangySelection,c=x(a),d=N?f(a):null;if(b){b.nativeSelection=c;b.docSelection=d;b.refresh(a)}else{b=new n(c,d,a);a._rangySelection=b}return b};a.getIframeSelection=function(b){return a.getSelection(q.getIframeWindow(b))};t=n.prototype;if(!E&&S&&r.areHostMethods(F,["removeAllRanges","addRange"])){t.removeAllRanges=function(){this.nativeSelection.removeAllRanges();
i(this)};var G=function(b,c){var d=y.getRangeDocument(c),d=a.createRange(d);d.collapseToPoint(c.endContainer,c.endOffset);b.nativeSelection.addRange(g(d));b.nativeSelection.extend(c.startContainer,c.startOffset);b.refresh()};t.addRange=T?function(b,c){if(M&&N&&this.docSelection.type=="Control")o(this,b);else if(c&&h)G(this,b);else{var d;if(R)d=this.rangeCount;else{this.removeAllRanges();d=0}this.nativeSelection.addRange(g(b));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==d+1){if(a.config.checkSelectionRanges)(d=
H(this.nativeSelection,this.rangeCount-1))&&!y.rangesEqual(d,b)&&(b=new v(d));this._ranges[this.rangeCount-1]=b;e(this,b,W(this.nativeSelection));this.isCollapsed=D(this)}else this.refresh()}}:function(a,b){if(b&&h)G(this,a);else{this.nativeSelection.addRange(g(a));this.refresh()}};t.setRanges=function(a){if(M&&a.length>1)m(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(r.isHostMethod(F,"empty")&&r.isHostMethod(w,"select")&&M&&E)t.removeAllRanges=
function(){try{this.docSelection.empty();if(this.docSelection.type!="None"){var a;if(this.anchorNode)a=q.getDocument(this.anchorNode);else if(this.docSelection.type=="Control"){var b=this.docSelection.createRange();b.length&&(a=q.getDocument(b.item(0)).body.createTextRange())}if(a){a.body.createTextRange().select();this.docSelection.empty()}}}catch(c){}i(this)},t.addRange=function(a){if(this.docSelection.type=="Control")o(this,a);else{v.rangeToTextRange(a).select();this._ranges[0]=a;this.rangeCount=
1;this.isCollapsed=this._ranges[0].collapsed;e(this,a,false)}},t.setRanges=function(a){this.removeAllRanges();var b=a.length;b>1?m(this,a):b&&this.addRange(a[0])};else return c.fail("No means of selecting a Range or TextRange was found"),!1;t.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new A("INDEX_SIZE_ERR");return this._ranges[a]};var J;if(E)J=function(b){var c;if(a.isSelectionValid(b.win))c=b.docSelection.createRange();else{c=q.getBody(b.win.document).createTextRange();c.collapse(true)}b.docSelection.type==
"Control"?l(b):c&&typeof c.text!="undefined"?j(b,c):i(b)};else if(r.isHostMethod(F,"getRangeAt")&&"number"==typeof F.rangeCount)J=function(b){if(M&&N&&b.docSelection.type=="Control")l(b);else{b._ranges.length=b.rangeCount=b.nativeSelection.rangeCount;if(b.rangeCount){for(var c=0,d=b.rangeCount;c<d;++c)b._ranges[c]=new a.WrappedRange(b.nativeSelection.getRangeAt(c));e(b,b._ranges[b.rangeCount-1],W(b.nativeSelection));b.isCollapsed=D(b)}else i(b)}};else if(S&&"boolean"==typeof F.isCollapsed&&"boolean"==
typeof w.collapsed&&a.features.implementsDomRange)J=function(a){var b;b=a.nativeSelection;if(b.anchorNode){b=H(b,0);a._ranges=[b];a.rangeCount=1;b=a.nativeSelection;a.anchorNode=b.anchorNode;a.anchorOffset=b.anchorOffset;a.focusNode=b.focusNode;a.focusOffset=b.focusOffset;a.isCollapsed=D(a)}else i(a)};else return c.fail("No means of obtaining a Range or TextRange from the user's selection was found"),!1;t.refresh=function(a){var b=a?this._ranges.slice(0):null;J(this);if(a){a=b.length;if(a!=this._ranges.length)return false;
for(;a--;)if(!y.rangesEqual(b[a],this._ranges[a]))return false;return true}};var I=function(a,b){var c=a.getAllRanges(),d=false;a.removeAllRanges();for(var h=0,e=c.length;h<e;++h)d||b!==c[h]?a.addRange(c[h]):d=true;a.rangeCount||i(a)};t.removeRange=M?function(a){if(this.docSelection.type=="Control"){for(var c=this.docSelection.createRange(),a=b(a),d=q.getDocument(c.item(0)),d=q.getBody(d).createControlRange(),h,e=false,f=0,g=c.length;f<g;++f){h=c.item(f);h!==a||e?d.add(c.item(f)):e=true}d.select();
l(this)}else I(this,a)}:function(a){I(this,a)};var W;!E&&S&&a.features.implementsDomRange?(W=function(a){var b=false;a.anchorNode&&(b=q.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset)==1);return b},t.isBackwards=function(){return W(this)}):W=t.isBackwards=function(){return false};t.toString=function(){for(var a=[],b=0,c=this.rangeCount;b<c;++b)a[b]=""+this._ranges[b];return a.join("")};t.collapse=function(b,c){p(this,b);var d=a.createRange(q.getDocument(b));d.collapseToPoint(b,
c);this.removeAllRanges();this.addRange(d);this.isCollapsed=true};t.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new A("INVALID_STATE_ERR");};t.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new A("INVALID_STATE_ERR");};t.selectAllChildren=function(b){p(this,b);var c=a.createRange(q.getDocument(b));c.selectNodeContents(b);this.removeAllRanges();
this.addRange(c)};t.deleteFromDocument=function(){if(M&&N&&this.docSelection.type=="Control"){for(var a=this.docSelection.createRange(),b;a.length;){b=a.item(0);a.remove(b);b.parentNode.removeChild(b)}this.refresh()}else if(this.rangeCount){a=this.getAllRanges();this.removeAllRanges();b=0;for(var c=a.length;b<c;++b)a[b].deleteContents();this.addRange(a[c-1])}};t.getAllRanges=function(){return this._ranges.slice(0)};t.setSingleRange=function(a){this.setRanges([a])};t.containsNode=function(a,b){for(var c=
...
return!0},isAppliedToSelection:function(b){for(var b=a.getSelection(b||window).getAllRanges(),c=b.length;c--;)if(!this.isAppliedToRange(b[c]))return!1;return!0},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)},toggleSelection:function(a){this.isAppliedToSelection(a)?this.undoToSelection(a):this.applyToSelection(a)},detach:function(){}};v.util={hasClass:d,addClass:f,removeClass:C,hasSameClasses:i,replaceWithOwnChildren:g,elementsHaveSameNonClassAttributes:l,
elementHasNonClassAttributes:o,splitNodeAt:q,isEditableElement:D,isEditingHost:n,isEditable:m};a.CssClassApplier=v;a.createCssClassApplier=function(a,b,c){return new v(a,b,c)}});
...
function m(a){return"undefined"!==typeof a.getElementsByTagName?a.getElementsByTagName("*"):"undefined"!==typeof a.querySelectorAll?a.querySelectorAll("*"):[]}function p(a){if("checkbox"===a.type||"radio"===a.type)a.defaultChecked=a.checked}function s(a){var b=(a.nodeName||"").toLowerCase();"input"===b?p(a):"script"!==b&&"undefined"!==typeof a.getElementsByTagName&&h.grep(a.getElementsByTagName("input"),p)}function q(a,b,c){var d="width"===b?a.offsetWidth:a.offsetHeight,e="width"===b?1:0;if(0<d){if("border"!==
c)for(;4>e;e+=2)c||(d-=parseFloat(h.css(a,"padding"+da[e]))||0),d="margin"===c?d+(parseFloat(h.css(a,c+da[e]))||0):d-(parseFloat(h.css(a,"border"+da[e]+"Width"))||0);return d+"px"}d=ga(a,b);if(0>d||null==d)d=a.style[b];if(xa.test(d))return d;d=parseFloat(d)||0;if(c)for(;4>e;e+=2)d+=parseFloat(h.css(a,"padding"+da[e]))||0,"padding"!==c&&(d+=parseFloat(h.css(a,"border"+da[e]+"Width"))||0),"margin"===c&&(d+=parseFloat(h.css(a,c+da[e]))||0);return d+"px"}function r(a){return function(b,c){"string"!==
typeof b&&(c=b,b="*");if(h.isFunction(c))for(var d=b.toLowerCase().split(La),e=0,k=d.length,f,g;e<k;e++)f=d[e],(g=/^\+/.test(f))&&(f=f.substr(1)||"*"),f=a[f]=a[f]||[],f[g?"unshift":"push"](c)}}function y(a,b,d,e,k,f){k=k||b.dataTypes[0];f=f||{};f[k]=!0;for(var k=a[k],g=0,i=k?k.length:0,h=a===ya,j;g<i&&(h||!j);g++)j=k[g](b,d,e),"string"===typeof j&&(!h||f[j]?j=c:(b.dataTypes.unshift(j),j=y(a,b,d,e,j,f)));if((h||!j)&&!f["*"])j=y(a,b,d,e,"*",f);return j}function v(a,b){var d,e,k=h.ajaxSettings.flatOptions||
{};for(d in b)b[d]!==c&&((k[d]?a:e||(e={}))[d]=b[d]);e&&h.extend(!0,a,e)}function A(a,b,c,d){if(h.isArray(b))h.each(b,function(b,e){c||db.test(a)?d(a,e):A(a+"["+("object"===typeof e?b:"")+"]",e,c,d)});else if(!c&&"object"===h.type(b))for(var e in b)A(a+"["+e+"]",b[e],c,d);else d(a,b)}function C(){try{return new a.XMLHttpRequest}catch(b){}}function x(){setTimeout(D,0);return qa=h.now()}function D(){qa=c}function F(a,b){var c={};h.each(ra.concat.apply([],ra.slice(0,b)),function(){c[this]=a});return c}
function N(a){if(!za[a]){var b=w.body,c=h("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d){aa||(aa=w.createElement("iframe"),aa.frameBorder=aa.width=aa.height=0);b.appendChild(aa);if(!ha||!aa.createElement)ha=(aa.contentWindow||aa.contentDocument).document,ha.write((h.support.boxModel?"<!doctype html>":"")+"<html><body>"),ha.close();c=ha.createElement(a);ha.body.appendChild(c);d=h.css(c,"display");b.removeChild(aa)}za[a]=d}return za[a]}function E(a){return h.isWindow(a)?
a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var w=a.document,O=a.navigator,S=a.location,h=function(){function b(){if(!d.isReady){try{w.documentElement.doScroll("left")}catch(a){setTimeout(b,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,f)},e=a.jQuery,k=a.$,f,g=/^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,i=/\S/,h=/^\s+/,j=/\s+$/,u=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,l=/^[\],:{}\s]*$/,z=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,m=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
n=/(?:^|:|,)(?:\s*\[)+/g,o=/(webkit)[ \/]([\w.]+)/,p=/(opera)(?:.*version)?[ \/]([\w.]+)/,s=/(msie) ([\w.]+)/,K=/(mozilla)(?:.*? rv:([\w.]+))?/,q=/-([a-z]|[0-9])/ig,P=/^-ms-/,r=function(a,b){return(b+"").toUpperCase()},v=O.userAgent,sa,ia,eb=Object.prototype.toString,Aa=Object.prototype.hasOwnProperty,V=Array.prototype.push,ma=Array.prototype.slice,y=String.prototype.trim,t=Array.prototype.indexOf,$={};d.fn=d.prototype={constructor:d,init:function(a,b,e){var B;if(!a)return this;if(a.nodeType)return this.context=
...
d.merge(this,a);if((b=w.getElementById(B[2]))&&b.parentNode){if(b.id!==B[2])return e.find(a);this.length=1;this[0]=b}this.context=w;this.selector=a;return this}return!b||b.jquery?(b||e).find(a):this.constructor(b).find(a)}if(d.isFunction(a))return e.ready(a);a.selector!==c&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,this)},selector:"",jquery:"1.7.2",length:0,size:function(){return this.length},toArray:function(){return ma.call(this,0)},get:function(a){return null==a?this.toArray():
0>a?this[this.length+a]:this[a]},pushStack:function(a,b,c){var e=this.constructor();d.isArray(a)?V.apply(e,a):d.merge(e,a);e.prevObject=this;e.context=this.context;"find"===b?e.selector=this.selector+(this.selector?" ":"")+c:b&&(e.selector=this.selector+"."+b+"("+c+")");return e},each:function(a,b){return d.each(this,a,b)},ready:function(a){d.bindReady();sa.add(a);return this},eq:function(a){a=+a;return-1===a?this.slice(a):this.slice(a,a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},
slice:function(){return this.pushStack(ma.apply(this,arguments),"slice",ma.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:V,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,b,e,B,k,f=arguments[0]||{},g=1,i=arguments.length,h=!1;"boolean"===typeof f&&(h=f,f=arguments[1]||{},g=2);"object"!==typeof f&&!d.isFunction(f)&&(f=
{});i===g&&(f=this,--g);for(;g<i;g++)if(null!=(a=arguments[g]))for(b in a)e=f[b],B=a[b],f!==B&&(h&&B&&(d.isPlainObject(B)||(k=d.isArray(B)))?(k?(k=!1,e=e&&d.isArray(e)?e:[]):e=e&&d.isPlainObject(e)?e:{},f[b]=d.extend(h,e,B)):B!==c&&(f[b]=B));return f};d.extend({noConflict:function(b){a.$===d&&(a.$=k);b&&a.jQuery===d&&(a.jQuery=e);return d},isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!w.body)return setTimeout(d.ready,
1);d.isReady=!0;!0!==a&&0<--d.readyWait||(sa.fireWith(w,[d]),d.fn.trigger&&d(w).trigger("ready").off("ready"))}},bindReady:function(){if(!sa){sa=d.Callbacks("once memory");if("complete"===w.readyState)return setTimeout(d.ready,1);if(w.addEventListener)w.addEventListener("DOMContentLoaded",ia,!1),a.addEventListener("load",d.ready,!1);else if(w.attachEvent){w.attachEvent("onreadystatechange",ia);a.attachEvent("onload",d.ready);var c=!1;try{c=null==a.frameElement}catch(e){}w.documentElement.doScroll&&
c&&b()}}},isFunction:function(a){return"function"===d.type(a)},isArray:Array.isArray||function(a){return"array"===d.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!isNaN(parseFloat(a))&&isFinite(a)},type:function(a){return null==a?""+a:$[eb.call(a)]||"object"},isPlainObject:function(a){if(!a||"object"!==d.type(a)||a.nodeType||d.isWindow(a))return!1;try{if(a.constructor&&!Aa.call(a,"constructor")&&!Aa.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(b){return!1}for(var e in a);
return e===c||Aa.call(a,e)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(l.test(b.replace(z,"@").replace(m,"]").replace(n,"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b){if("string"!==typeof b||!b)return null;var e,B;try{a.DOMParser?(B=new DOMParser,e=B.parseFromString(b,"text/xml")):
(e=new ActiveXObject("Microsoft.XMLDOM"),e.async="false",e.loadXML(b))}catch(f){e=c}(!e||!e.documentElement||e.getElementsByTagName("parsererror").length)&&d.error("Invalid XML: "+b);return e},noop:function(){},globalEval:function(b){b&&i.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(P,"ms-").replace(q,r)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,b,e){var B,f=0,k=a.length,g=k===c||d.isFunction(a);
if(e)if(g)for(B in a){if(!1===b.apply(a[B],e))break}else for(;f<k&&!1!==b.apply(a[f++],e););else if(g)for(B in a){if(!1===b.call(a[B],B,a[B]))break}else for(;f<k&&!1!==b.call(a[f],f,a[f++]););return a},trim:y?function(a){return null==a?"":y.call(a)}:function(a){return null==a?"":a.toString().replace(h,"").replace(j,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var e=d.type(a);null==a.length||"string"===e||"function"===e||"regexp"===e||d.isWindow(a)?V.call(c,a):d.merge(c,a)}return c},inArray:function(a,
...
i&&a[0]&&a[i-1]||0===i||d.isArray(a)))for(;g<i;g++)B=b(a[g],g,e),null!=B&&(k[k.length]=B);else for(f in a)B=b(a[f],f,e),null!=B&&(k[k.length]=B);return k.concat.apply([],k)},guid:1,proxy:function(a,b){if("string"===typeof b)var e=a[b],b=a,a=e;if(!d.isFunction(a))return c;var B=ma.call(arguments,2),e=function(){return a.apply(b,B.concat(ma.call(arguments)))};e.guid=a.guid=a.guid||e.guid||d.guid++;return e},access:function(a,b,e,B,f,k,g){var i,h=null==e,j=0,u=a.length;if(e&&"object"===typeof e){for(j in e)d.access(a,
b,j,e[j],1,k,B);f=1}else if(B!==c){i=g===c&&d.isFunction(B);h&&(i?(i=b,b=function(a,b,c){return i.call(d(a),c)}):(b.call(a,B),b=null));if(b)for(;j<u;j++)b(a[j],e,i?B.call(a[j],j,b(a[j],e)):B,g);f=1}return f?a:h?b.call(a):u?b(a[0],e):k},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=o.exec(a)||p.exec(a)||s.exec(a)||0>a.indexOf("compatible")&&K.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,
...
{set:function(a,b){if(h.isArray(b))return a.checked=h.inArray(h(a).val(),b)>=0}})});var z=/^(?:textarea|input|select)$/i,K=/^([^\.]*)?(?:\.(.+))?$/,P=/(?:^|\s)hover(\.\S+)?\b/,V=/^key/,$=/^(?:mouse|contextmenu)|click/,X=/^(?:focusinfocus|focusoutblur)$/,wa=/^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/,na=function(a){if(a=wa.exec(a)){a[1]=(a[1]||"").toLowerCase();a[3]=a[3]&&RegExp("(?:^|\\s)"+a[3]+"(?:\\s|$)")}return a},ka=function(a){return h.event.special.hover?a:a.replace(P,"mouseenter$1 mouseleave$1")};
h.event={add:function(a,b,d,e,f){var k,g,i,j,u,l,z,m,n;if(!(a.nodeType===3||a.nodeType===8||!b||!d||!(k=h._data(a)))){if(d.handler){z=d;d=z.handler;f=z.selector}if(!d.guid)d.guid=h.guid++;i=k.events;if(!i)k.events=i={};g=k.handle;if(!g){k.handle=g=function(a){return typeof h!=="undefined"&&(!a||h.event.triggered!==a.type)?h.event.dispatch.apply(g.elem,arguments):c};g.elem=a}b=h.trim(ka(b)).split(" ");for(k=0;k<b.length;k++){j=K.exec(b[k])||[];u=j[1];l=(j[2]||"").split(".").sort();n=h.event.special[u]||
{};u=(f?n.delegateType:n.bindType)||u;n=h.event.special[u]||{};j=h.extend({type:u,origType:j[1],data:e,handler:d,guid:d.guid,selector:f,quick:f&&na(f),namespace:l.join(".")},z);m=i[u];if(!m){m=i[u]=[];m.delegateCount=0;if(!n.setup||n.setup.call(a,e,l,g)===false)a.addEventListener?a.addEventListener(u,g,false):a.attachEvent&&a.attachEvent("on"+u,g)}if(n.add){n.add.call(a,j);if(!j.handler.guid)j.handler.guid=d.guid}f?m.splice(m.delegateCount++,0,j):m.push(j);h.event.global[u]=true}a=null}},global:{},
remove:function(a,b,c,d,e){var f=h.hasData(a)&&h._data(a),k,g,i,j,u,l,m,z,n,o;if(f&&(m=f.events)){b=h.trim(ka(b||"")).split(" ");for(k=0;k<b.length;k++){g=K.exec(b[k])||[];i=j=g[1];g=g[2];if(i){z=h.event.special[i]||{};i=(d?z.delegateType:z.bindType)||i;n=m[i]||[];u=n.length;g=g?RegExp("(^|\\.)"+g.split(".").sort().join("\\.(?:.*\\.)?")+"(\\.|$)"):null;for(l=0;l<n.length;l++){o=n[l];if((e||j===o.origType)&&(!c||c.guid===o.guid)&&(!g||g.test(o.namespace))&&(!d||d===o.selector||d==="**"&&o.selector)){n.splice(l--,
1);o.selector&&n.delegateCount--;z.remove&&z.remove.call(a,o)}}if(n.length===0&&u!==n.length){(!z.teardown||z.teardown.call(a,g)===false)&&h.removeEvent(a,i,f.handle);delete m[i]}}else for(i in m)h.event.remove(a,i+b[k],c,d,true)}if(h.isEmptyObject(m)){if(b=f.handle)b.elem=null;h.removeData(a,["events","handle"],true)}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(b,d,e,f){if(!e||!(e.nodeType===3||e.nodeType===8)){var k=b.type||b,g=[],i,j,u,l,m;if(!X.test(k+h.event.triggered)){if(k.indexOf("!")>=
...
u.trigger.apply(e,d)===false)){m=[[e,u.bindType||k]];if(!f&&!u.noBubble&&!h.isWindow(e)){l=u.delegateType||k;g=X.test(l+k)?e:e.parentNode;for(j=null;g;g=g.parentNode){m.push([g,l]);j=g}j&&j===e.ownerDocument&&m.push([j.defaultView||j.parentWindow||a,l])}for(j=0;j<m.length&&!b.isPropagationStopped();j++){g=m[j][0];b.type=m[j][1];(l=(h._data(g,"events")||{})[b.type]&&h._data(g,"handle"))&&l.apply(g,d);(l=i&&g[i])&&h.acceptData(g)&&l.apply(g,d)===false&&b.preventDefault()}b.type=k;if(!f&&!b.isDefaultPrevented()&&
...
f=[].slice.call(arguments,0),k=!b.exclusive&&!b.namespace,g=h.event.special[b.type]||{},i=[],j,u,l,m,z,n,o;f[0]=b;b.delegateTarget=this;if(!(g.preDispatch&&g.preDispatch.call(this,b)===false)){if(e&&!(b.button&&b.type==="click")){l=h(this);l.context=this.ownerDocument||this;for(u=b.target;u!=this;u=u.parentNode||this)if(u.disabled!==true){z={};n=[];l[0]=u;for(j=0;j<e;j++){m=d[j];o=m.selector;if(z[o]===c){var p=z,s=o,K;if(m.quick){K=m.quick;var q=u.attributes||{};K=(!K[1]||u.nodeName.toLowerCase()===
K[1])&&(!K[2]||(q.id||{}).value===K[2])&&(!K[3]||K[3].test((q["class"]||{}).value))}else K=l.is(o);p[s]=K}z[o]&&n.push(m)}n.length&&i.push({elem:u,matches:n})}}d.length>e&&i.push({elem:this,matches:d.slice(e)});for(j=0;j<i.length&&!b.isPropagationStopped();j++){e=i[j];b.currentTarget=e.elem;for(d=0;d<e.matches.length&&!b.isImmediatePropagationStopped();d++){m=e.matches[d];if(k||!b.namespace&&!m.namespace||b.namespace_re&&b.namespace_re.test(m.namespace)){b.data=m.data;b.handleObj=m;m=((h.event.special[m.origType]||
...
postDispatch:function(a){if(a._submit_bubble){delete a._submit_bubble;this.parentNode&&!a.isTrigger&&h.event.simulate("submit",this.parentNode,a,true)}},teardown:function(){if(h.nodeName(this,"form"))return false;h.event.remove(this,"._submit")}});h.support.changeBubbles||(h.event.special.change={setup:function(){if(z.test(this.nodeName)){if(this.type==="checkbox"||this.type==="radio"){h.event.add(this,"propertychange._change",function(a){if(a.originalEvent.propertyName==="checked")this._just_changed=
true});h.event.add(this,"click._change",function(a){if(this._just_changed&&!a.isTrigger){this._just_changed=false;h.event.simulate("change",this,a,true)}})}return false}h.event.add(this,"beforeactivate._change",function(a){a=a.target;if(z.test(a.nodeName)&&!a._change_attached){h.event.add(a,"change._change",function(a){this.parentNode&&!a.isSimulated&&!a.isTrigger&&h.event.simulate("change",this.parentNode,a,true)});a._change_attached=true}})},handle:function(a){var b=a.target;if(this!==b||a.isSimulated||
a.isTrigger||b.type!=="radio"&&b.type!=="checkbox")return a.handleObj.handler.apply(this,arguments)},teardown:function(){h.event.remove(this,"._change");return z.test(this.nodeName)}});h.support.focusinBubbles||h.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){h.event.simulate(b,a.target,h.event.fix(a),true)};h.event.special[b]={setup:function(){c++===0&&w.addEventListener(a,d,true)},teardown:function(){--c===0&&w.removeEventListener(a,d,true)}}});h.fn.extend({on:function(a,
...
function(a,b,c,e){var c=c||[],f=b=b||w;if(b.nodeType!==1&&b.nodeType!==9)return[];if(!a||typeof a!=="string")return c;var g,i,j,h,u,B=true,l=m.isXML(b),z=[],p=a;do{d.exec("");if(g=d.exec(p)){p=g[3];z.push(g[1]);if(g[2]){h=g[3];break}}}while(g);if(z.length>1&&o.exec(a))if(z.length===2&&n.relative[z[0]])i=v(z[0]+z[1],b,e);else for(i=n.relative[z[0]]?[b]:m(z.shift(),b);z.length;){a=z.shift();n.relative[a]&&(a=a+z.shift());i=v(a,i,e)}else{if(!e&&z.length>1&&b.nodeType===9&&!l&&n.match.ID.test(z[0])&&
!n.match.ID.test(z[z.length-1])){g=m.find(z.shift(),b,l);b=g.expr?m.filter(g.expr,g.set)[0]:g.set[0]}if(b){g=e?{expr:z.pop(),set:s(e)}:m.find(z.pop(),z.length===1&&(z[0]==="~"||z[0]==="+")&&b.parentNode?b.parentNode:b,l);i=g.expr?m.filter(g.expr,g.set):g.set;for(z.length>0?j=s(i):B=false;z.length;){g=u=z.pop();n.relative[u]?g=z.pop():u="";g==null&&(g=b);n.relative[u](j,g,l)}}else j=[]}j||(j=i);j||m.error(u||a);if(k.call(j)==="[object Array]")if(B)if(b&&b.nodeType===1)for(a=0;j[a]!=null;a++)j[a]&&
(j[a]===true||j[a].nodeType===1&&m.contains(b,j[a]))&&c.push(i[a]);else for(a=0;j[a]!=null;a++)j[a]&&j[a].nodeType===1&&c.push(i[a]);else c.push.apply(c,j);else s(j,c);if(h){m(h,f,c,e);m.uniqueSort(c)}return c};m.uniqueSort=function(a){if(P){g=i;a.sort(P);if(g)for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1)}return a};m.matches=function(a,b){return m(a,null,null,b)};m.matchesSelector=function(a,b){return m(b,null,null,[a]).length>0};m.find=function(a,b,c){var d,e,f,k,g,i;if(!a)return[];e=
0;for(f=n.order.length;e<f;e++){g=n.order[e];if(k=n.leftMatch[g].exec(a)){i=k[1];k.splice(1,1);if(i.substr(i.length-1)!=="\\"){k[1]=(k[1]||"").replace(j,"");d=n.find[g](k,b,c);if(d!=null){a=a.replace(n.match[g],"");break}}}}d||(d=typeof b.getElementsByTagName!=="undefined"?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};m.filter=function(a,b,d,e){for(var f,k,g,i,j,h,u,B,l=a,z=[],o=b,p=b&&b[0]&&m.isXML(b[0]);a&&b.length;){for(g in n.filter)if((f=n.leftMatch[g].exec(a))!=null&&f[2]){h=n.filter[g];
j=f[1];k=false;f.splice(1,1);if(j.substr(j.length-1)!=="\\"){o===z&&(z=[]);if(n.preFilter[g])if(f=n.preFilter[g](f,o,d,z,e,p)){if(f===true)continue}else k=i=true;if(f)for(u=0;(j=o[u])!=null;u++)if(j){i=h(j,f,u,o);B=e^i;if(d&&i!=null)B?k=true:o[u]=false;else if(B){z.push(j);k=true}}if(i!==c){d||(o=z);a=a.replace(n.match[g],"");if(!k)return[];break}}}if(a===l)if(k==null)m.error(a);else break;l=a}return o};m.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};var z=m.getText=
function(a){var b,c;b=a.nodeType;var d="";if(b)if(b===1||b===9||b===11){if(typeof a.textContent==="string")return a.textContent;if(typeof a.innerText==="string")return a.innerText.replace(u,"");for(a=a.firstChild;a;a=a.nextSibling)d=d+z(a)}else{if(b===3||b===4)return a.nodeValue}else for(b=0;c=a[b];b++)c.nodeType!==8&&(d=d+z(c));return d},n=m.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,
...
c=m.attr?m.attr(a,c):n.attrHandle[c]?n.attrHandle[c](a):a[c]!=null?a[c]:a.getAttribute(c),d=c+"",e=b[2],f=b[4];return c==null?e==="!=":!e&&m.attr?c!=null:e==="="?d===f:e==="*="?d.indexOf(f)>=0:e==="~="?(" "+d+" ").indexOf(f)>=0:!f?d&&c!==false:e==="!="?d!==f:e==="^="?d.indexOf(f)===0:e==="$="?d.substr(d.length-f.length)===f:e==="|="?d===f||d.substr(0,f.length+1)===f+"-":false},POS:function(a,b,c,d){var e=n.setFilters[b[2]];if(e)return e(a,c,b,d)}}},o=n.match.POS,p=function(a,b){return"\\"+(b-0+1)},
K;for(K in n.match){n.match[K]=RegExp(n.match[K].source+/(?![^\[]*\])(?![^\(]*\))/.source);n.leftMatch[K]=RegExp(/(^(?:.|\r|\n)*?)/.source+n.match[K].source.replace(/\\(\d+)/g,p))}n.match.globalPOS=o;var s=function(a,b){a=Array.prototype.slice.call(a,0);if(b){b.push.apply(b,a);return b}return a};try{Array.prototype.slice.call(w.documentElement.childNodes,0)[0].nodeType}catch(q){s=function(a,b){var c=0,d=b||[];if(k.call(a)==="[object Array]")Array.prototype.push.apply(d,a);else if(typeof a.length===
"number")for(var e=a.length;c<e;c++)d.push(a[c]);else for(;a[c];c++)d.push(a[c]);return d}}var P,r;if(w.documentElement.compareDocumentPosition)P=function(a,b){if(a===b){g=true;return 0}return!a.compareDocumentPosition||!b.compareDocumentPosition?a.compareDocumentPosition?-1:1:a.compareDocumentPosition(b)&4?-1:1};else{P=function(a,b){if(a===b){g=true;return 0}if(a.sourceIndex&&b.sourceIndex)return a.sourceIndex-b.sourceIndex;var c,d,e=[],f=[];c=a.parentNode;d=b.parentNode;var k=c;if(c===d)return r(a,
b);if(c){if(!d)return 1}else return-1;for(;k;){e.unshift(k);k=k.parentNode}for(k=d;k;){f.unshift(k);k=k.parentNode}c=e.length;d=f.length;for(k=0;k<c&&k<d;k++)if(e[k]!==f[k])return r(e[k],f[k]);return k===c?r(a,f[k],-1):r(e[k],b,1)};r=function(a,b,c){if(a===b)return c;for(a=a.nextSibling;a;){if(a===b)return-1;a=a.nextSibling}return 1}}(function(){var a=w.createElement("div"),b="script"+(new Date).getTime(),d=w.documentElement;a.innerHTML="<a name='"+b+"'/>";d.insertBefore(a,d.firstChild);if(w.getElementById(b)){n.find.ID=
...
0){a.lastChild.className="e";if(a.getElementsByClassName("e").length!==1){n.order.splice(1,0,"CLASS");n.find.CLASS=function(a,b,c){if(typeof b.getElementsByClassName!=="undefined"&&!c)return b.getElementsByClassName(a[1])};a=null}}})();m.contains=w.documentElement.contains?function(a,b){return a!==b&&(a.contains?a.contains(b):true)}:w.documentElement.compareDocumentPosition?function(a,b){return!!(a.compareDocumentPosition(b)&16)}:function(){return false};m.isXML=function(a){return(a=(a?a.ownerDocument||
a:0).documentElement)?a.nodeName!=="HTML":false};var v=function(a,b,c){for(var d,e=[],f="",b=b.nodeType?[b]:b;d=n.match.PSEUDO.exec(a);){f=f+d[0];a=a.replace(n.match.PSEUDO,"")}a=n.relative[a]?a+"*":a;d=0;for(var k=b.length;d<k;d++)m(a,b[d],e,c);return m.filter(f,e)};m.attr=h.attr;m.selectors.attrMap={};h.find=m;h.expr=m.selectors;h.expr[":"]=h.expr.filters;h.unique=m.uniqueSort;h.text=m.getText;h.isXMLDoc=m.isXML;h.contains=m.contains})();var oa=/Until$/,pa=/^(?:parents|prevUntil|prevAll)/,la=/,/,
...
"iframe")?a.contentDocument||a.contentWindow.document:h.makeArray(a.childNodes)}},function(a,b){h.fn[a]=function(c,d){var e=h.map(this,b,c);oa.test(a)||(d=c);d&&typeof d==="string"&&(e=h.filter(d,e));e=this.length>1&&!Ya[a]?h.unique(e):e;if((this.length>1||la.test(d))&&pa.test(a))e=e.reverse();return this.pushStack(e,a,Xa.call(arguments).join(","))}});h.extend({filter:function(a,b,c){c&&(a=":not("+a+")");return b.length===1?h.find.matchesSelector(b[0],a)?[b[0]]:[]:h.find.matches(a,b)},dir:function(a,
...
va=/^\s+/,Ga=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Ha=/<([\w:]+)/,$a=/<tbody/i,ab=/<|&#?\w+;/,bb=/<(?:script|style)/i,cb=/<(?:script|object|embed|option|style)/i,Ia=RegExp("<(?:"+Fa+")[\\s/>]","i"),Ja=/checked\s*(?:[^=]|=\s*.checked.)/i,Ka=/\/(java|ecma)script/i,fb=/^\s*<!(?:\[CDATA\[|\-\-)/,Z={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,
"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]},Ba=l(w);Z.optgroup=Z.option;Z.tbody=Z.tfoot=Z.colgroup=Z.caption=Z.thead;Z.th=Z.td;h.support.htmlSerialize||(Z._default=[1,"div<div>","</div>"]);h.fn.extend({text:function(a){return h.access(this,function(a){return a===c?h.text(this):this.empty().append((this[0]&&this[0].ownerDocument||w).createTextNode(a))},null,a,arguments.length)},wrapAll:function(a){if(h.isFunction(a))return this.each(function(b){h(this).wrapAll(a.call(this,
...
k);d=m(a);e=m(k);for(f=0;d[f];++f)e[f]&&n(d[f],e[f])}if(b){o(a,k);if(c){d=m(a);e=m(k);for(f=0;d[f];++f)o(d[f],e[f])}}return k},clean:function(a,b,c,d){var e,f=[],b=b||w;typeof b.createElement==="undefined"&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||w);for(var k=0,g;(g=a[k])!=null;k++){typeof g==="number"&&(g=g+"");if(g){if(typeof g==="string")if(ab.test(g)){g=g.replace(Ga,"<$1></$2>");e=(Ha.exec(g)||["",""])[1].toLowerCase();var i=Z[e]||Z._default,j=i[0],u=b.createElement("div"),m=Ba.childNodes;
b===w?Ba.appendChild(u):l(b).appendChild(u);for(u.innerHTML=i[1]+g+i[2];j--;)u=u.lastChild;if(!h.support.tbody){j=$a.test(g);i=e==="table"&&!j?u.firstChild&&u.firstChild.childNodes:i[1]==="<table>"&&!j?u.childNodes:[];for(e=i.length-1;e>=0;--e)h.nodeName(i[e],"tbody")&&!i[e].childNodes.length&&i[e].parentNode.removeChild(i[e])}!h.support.leadingWhitespace&&va.test(g)&&u.insertBefore(b.createTextNode(va.exec(g)[0]),u.firstChild);g=u.childNodes;if(u){u.parentNode.removeChild(u);if(m.length>0)(u=m[m.length-
1])&&u.parentNode&&u.parentNode.removeChild(u)}}else g=b.createTextNode(g);var z;if(!h.support.appendChecked)if(g[0]&&typeof(z=g.length)==="number")for(e=0;e<z;e++)s(g[e]);else s(g);g.nodeType?f.push(g):f=h.merge(f,g)}}if(c){a=function(a){return!a.type||Ka.test(a.type)};for(k=0;f[k];k++){b=f[k];if(d&&h.nodeName(b,"script")&&(!b.type||Ka.test(b.type)))d.push(b.parentNode?b.parentNode.removeChild(b):b);else{if(b.nodeType===1){g=h.grep(b.getElementsByTagName("script"),a);f.splice.apply(f,[k+1,0].concat(g))}c.appendChild(b)}}}return f},
...
jb=/^([\-+])=([\-+.\de]+)/,kb=/^margin/,lb={position:"absolute",visibility:"hidden",display:"block"},da=["Top","Right","Bottom","Left"],ga,Ma,Na;h.fn.css=function(a,b){return h.access(this,function(a,b,d){return d!==c?h.style(a,b,d):h.css(a,b)},a,b,arguments.length>1)};h.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=ga(a,"opacity");return c===""?"1":c}return a.style.opacity}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":h.support.cssFloat?
...
""?"auto":e});ga=Ma||Na;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){if(c)return a.offsetWidth!==0?q(a,b,d):h.swap(a,lb,function(){return q(a,b,d)})},set:function(a,b){return ib.test(b)?b+"px":b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return gb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,e=h.isNumeric(b)?"alpha(opacity="+b*100+")":"",f=
d&&d.filter||c.filter||"";c.zoom=1;if(b>=1&&h.trim(f.replace(Ca,""))===""){c.removeAttribute("filter");if(d&&!d.filter)return}c.filter=Ca.test(f)?f.replace(Ca,e):f+" "+e}});h(function(){if(!h.support.reliableMarginRight)h.cssHooks.marginRight={get:function(a,b){return h.swap(a,{display:"inline-block"},function(){return b?ga(a,"margin-right"):a.style.marginRight})}}});h.expr&&h.expr.filters&&(h.expr.filters.hidden=function(a){var b=a.offsetHeight;return a.offsetWidth===0&&b===0||!h.support.reliableHiddenOffsets&&
(a.style&&a.style.display||h.css(a,"display"))==="none"},h.expr.filters.visible=function(a){return!h.expr.filters.hidden(a)});h.each({margin:"",padding:"",border:"Width"},function(a,b){h.cssHooks[a+b]={expand:function(c){for(var d=typeof c==="string"?c.split(" "):[c],e={},c=0;c<4;c++)e[a+da[c]+b]=d[c]||d[c-2]||d[0];return e}}});var mb=/%20/g,db=/\[\]$/,Oa=/\r?\n/g,nb=/#.*$/,ob=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,pb=/^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
qb=/^(?:GET|HEAD)$/,rb=/^\/\//,Pa=/\?/,sb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,tb=/^(?:select|textarea)/i,La=/\s+/,ub=/([?&])_=[^&]*/,Qa=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Ra=h.fn.load,ya={},Sa={},ea,fa,Ta=["*/"]+["*"];try{ea=S.href}catch(Ab){ea=w.createElement("a"),ea.href="",ea=ea.href}fa=Qa.exec(ea.toLowerCase())||[];h.fn.extend({load:function(a,b,d){if(typeof a!=="string"&&Ra)return Ra.apply(this,arguments);if(!this.length)return this;var e=a.indexOf(" ");if(e>=
...
function(a,b){h[b]=function(a,d,e,f){if(h.isFunction(d)){f=f||e;e=d;d=c}return h.ajax({type:b,url:a,data:d,success:e,dataType:f})}});h.extend({getScript:function(a,b){return h.get(a,c,b,"script")},getJSON:function(a,b,c){return h.get(a,b,c,"json")},ajaxSetup:function(a,b){if(b)v(a,h.ajaxSettings);else{b=a;a=h.ajaxSettings}v(a,b);return a},ajaxSettings:{url:ea,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/.test(fa[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",
processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Ta},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:r(ya),ajaxTransport:r(Sa),ajax:function(a,b){function d(a,b,m,l){if(s!==2){s=2;p&&clearTimeout(p);o=c;z=l||"";r.readyState=
a>0?4:0;var n,K,B,l=b;if(m){var P=e,v=r,V=P.contents,ba=P.dataTypes,y=P.responseFields,w,t,ca,$;for(t in y)t in m&&(v[y[t]]=m[t]);for(;ba[0]==="*";){ba.shift();w===c&&(w=P.mimeType||v.getResponseHeader("content-type"))}if(w)for(t in V)if(V[t]&&V[t].test(w)){ba.unshift(t);break}if(ba[0]in m)ca=ba[0];else{for(t in m){if(!ba[0]||P.converters[t+" "+ba[0]]){ca=t;break}$||($=t)}ca=ca||$}if(ca){ca!==ba[0]&&ba.unshift(ca);m=m[ca]}else m=void 0}else m=c;if(a>=200&&a<300||a===304){if(e.ifModified){if(w=r.getResponseHeader("Last-Modified"))h.lastModified[u]=
w;if(w=r.getResponseHeader("Etag"))h.etag[u]=w}if(a===304){l="notmodified";n=true}else try{w=e;w.dataFilter&&(m=w.dataFilter(m,w.dataType));var x=w.dataTypes;t={};var A,C,F=x.length,D,X=x[0],E,G,H,I,J;for(A=1;A<F;A++){if(A===1)for(C in w.converters)typeof C==="string"&&(t[C.toLowerCase()]=w.converters[C]);E=X;X=x[A];if(X==="*")X=E;else if(E!=="*"&&E!==X){G=E+" "+X;H=t[G]||t["* "+X];if(!H){J=c;for(I in t){D=I.split(" ");if(D[0]===E||D[0]==="*")if(J=t[D[1]+" "+X]){I=t[I];I===true?H=J:J===true&&(H=I);
break}}}!H&&!J&&h.error("No conversion from "+G.replace(" "," to "));H!==true&&(m=H?H(m):J(I(m)))}}K=m;l="success";n=true}catch(L){l="parsererror";B=L}}else{B=l;if(!l||a){l="error";a<0&&(a=0)}}r.status=a;r.statusText=""+(b||l);n?g.resolveWith(f,[K,l,r]):g.rejectWith(f,[r,l,B]);r.statusCode(j);j=c;q&&k.trigger("ajax"+(n?"Success":"Error"),[r,e,n?K:B]);i.fireWith(f,[r,l]);if(q){k.trigger("ajaxComplete",[r,e]);--h.active||h.event.trigger("ajaxStop")}}}if(typeof a==="object"){b=a;a=c}var b=b||{},e=h.ajaxSetup({},
b),f=e.context||e,k=f!==e&&(f.nodeType||f instanceof h)?h(f):h.event,g=h.Deferred(),i=h.Callbacks("once memory"),j=e.statusCode||{},u,m={},l={},z,n,o,p,K,s=0,q,P,r={readyState:0,setRequestHeader:function(a,b){if(!s){var c=a.toLowerCase(),a=l[c]=l[c]||a;m[a]=b}return this},getAllResponseHeaders:function(){return s===2?z:null},getResponseHeader:function(a){var b;if(s===2){if(!n)for(n={};b=ob.exec(z);)n[b[1].toLowerCase()]=b[2];b=n[a.toLowerCase()]}return b===c?null:b},overrideMimeType:function(a){if(!s)e.mimeType=
a;return this},abort:function(a){a=a||"abort";o&&o.abort(a);d(0,a);return this}};g.promise(r);r.success=r.done;r.error=r.fail;r.complete=i.add;r.statusCode=function(a){if(a){var b;if(s<2)for(b in a)j[b]=[j[b],a[b]];else{b=a[r.status];r.then(b,b)}}return this};e.url=((a||e.url)+"").replace(nb,"").replace(rb,fa[1]+"//");e.dataTypes=h.trim(e.dataType||"*").toLowerCase().split(La);if(e.crossDomain==null){K=Qa.exec(e.url.toLowerCase());e.crossDomain=!(!K||!(K[1]!=fa[1]||K[2]!=fa[2]||(K[3]||(K[1]==="http:"?
80:443))!=(fa[3]||(fa[1]==="http:"?80:443))))}if(e.data&&e.processData&&typeof e.data!=="string")e.data=h.param(e.data,e.traditional);y(ya,e,b,r);if(s===2)return false;q=e.global;e.type=e.type.toUpperCase();e.hasContent=!qb.test(e.type);q&&h.active++===0&&h.event.trigger("ajaxStart");if(!e.hasContent){if(e.data){e.url=e.url+((Pa.test(e.url)?"&":"?")+e.data);delete e.data}u=e.url;if(e.cache===false){K=h.now();var v=e.url.replace(ub,"$1_="+K);e.url=v+(v===e.url?(Pa.test(e.url)?"&":"?")+"_="+K:"")}}(e.data&&
e.hasContent&&e.contentType!==false||b.contentType)&&r.setRequestHeader("Content-Type",e.contentType);if(e.ifModified){u=u||e.url;h.lastModified[u]&&r.setRequestHeader("If-Modified-Since",h.lastModified[u]);h.etag[u]&&r.setRequestHeader("If-None-Match",h.etag[u])}r.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+(e.dataTypes[0]!=="*"?", "+Ta+"; q=0.01":""):e.accepts["*"]);for(P in e.headers)r.setRequestHeader(P,e.headers[P]);if(e.beforeSend&&(e.beforeSend.call(f,
r,e)===false||s===2)){r.abort();return false}for(P in{success:1,error:1,complete:1})r[P](e[P]);if(o=y(Sa,e,b,r)){r.readyState=1;q&&k.trigger("ajaxSend",[r,e]);e.async&&e.timeout>0&&(p=setTimeout(function(){r.abort("timeout")},e.timeout));try{s=1;o.send(m,d)}catch(V){if(s<2)d(-1,V);else throw V;}}else d(-1,"No Transport");return r},param:function(a,b){var d=[],e=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(b===c)b=h.ajaxSettings.traditional;
if(h.isArray(a)||a.jquery&&!h.isPlainObject(a))h.each(a,function(){e(this.name,this.value)});else for(var f in a)A(f,a[f],b,e);return d.join("&").replace(mb,"+")}});h.extend({active:0,lastModified:{},etag:{}});var vb=h.now(),ta=/(\=)\?(&|$)|\?\?/i;h.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return h.expando+"_"+vb++}});h.ajaxPrefilter("json jsonp",function(b,c,d){c=typeof b.data==="string"&&/^application\/x\-www\-form\-urlencoded/.test(b.contentType);if(b.dataTypes[0]==="jsonp"||b.jsonp!==
false&&(ta.test(b.url)||c&&ta.test(b.data))){var e,f=b.jsonpCallback=h.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,k=a[f],g=b.url,i=b.data,j="$1"+f+"$2";if(b.jsonp!==false){g=g.replace(ta,j);if(b.url===g){c&&(i=i.replace(ta,j));b.data===i&&(g=g+((/\?/.test(g)?"&":"?")+b.jsonp+"="+f))}}b.url=g;b.data=i;a[f]=function(a){e=[a]};d.always(function(){a[f]=k;if(e&&h.isFunction(k))a[f](e[0])});b.converters["script json"]=function(){e||h.error(f+" was not called");return e[0]};b.dataTypes[0]=
...
f){b=w.createElement("script");b.async="async";if(a.scriptCharset)b.charset=a.scriptCharset;b.src=a.url;b.onload=b.onreadystatechange=function(a,e){if(e||!b.readyState||/loaded|complete/.test(b.readyState)){b.onload=b.onreadystatechange=null;d&&b.parentNode&&d.removeChild(b);b=c;e||f(200,"success")}};d.insertBefore(b,d.firstChild)},abort:function(){if(b)b.onload(0,1)}}}});var Da=a.ActiveXObject?function(){for(var a in ja)ja[a](0,1)}:!1,wb=0,ja;h.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=
!this.isLocal&&C()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:C;(function(a){h.extend(h.support,{ajax:!!a,cors:!!a&&"withCredentials"in a})})(h.ajaxSettings.xhr());h.support.ajax&&h.ajaxTransport(function(b){if(!b.crossDomain||h.support.cors){var d;return{send:function(e,f){var k=b.xhr(),g,i;b.username?k.open(b.type,b.url,b.async,b.username,b.password):k.open(b.type,b.url,b.async);if(b.xhrFields)for(i in b.xhrFields)k[i]=b.xhrFields[i];b.mimeType&&k.overrideMimeType&&
k.overrideMimeType(b.mimeType);!b.crossDomain&&!e["X-Requested-With"]&&(e["X-Requested-With"]="XMLHttpRequest");try{for(i in e)k.setRequestHeader(i,e[i])}catch(j){}k.send(b.hasContent&&b.data||null);d=function(a,e){var i,j,u,m,l;try{if(d&&(e||k.readyState===4)){d=c;if(g){k.onreadystatechange=h.noop;Da&&delete ja[g]}if(e)k.readyState!==4&&k.abort();else{i=k.status;u=k.getAllResponseHeaders();m={};if((l=k.responseXML)&&l.documentElement)m.xml=l;try{m.text=k.responseText}catch(z){}try{j=k.statusText}catch(n){j=
""}!i&&b.isLocal&&!b.crossDomain?i=m.text?200:404:i===1223&&(i=204)}}}catch(o){e||f(-1,o)}m&&f(i,j,m,u)};if(!b.async||k.readyState===4)d();else{g=++wb;if(Da){if(!ja){ja={};h(a).unload(Da)}ja[g]=d}k.onreadystatechange=d}},abort:function(){d&&d(0,1)}}}});var za={},aa,ha,xb=/^(?:toggle|show|hide)$/,yb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,ua,ra=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],qa;h.fn.extend({show:function(a,
b,c){if(a||a===0)return this.animate(F("show",3),a,b,c);for(var c=0,d=this.length;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(!h._data(a,"olddisplay")&&b==="none")b=a.style.display="";(b===""&&h.css(a,"display")==="none"||!h.contains(a.ownerDocument.documentElement,a))&&h._data(a,"olddisplay",N(a.nodeName))}}for(c=0;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(b===""||b==="none")a.style.display=h._data(a,"olddisplay")||""}}return this},hide:function(a,b,c){if(a||a===0)return this.animate(F("hide",
...
g[1];g=a[k]=g[0]}else b.animatedProperties[k]=b.specialEasing&&b.specialEasing[k]||b.easing||"swing";if(g==="hide"&&d||g==="show"&&!d)return b.complete.call(this);if(c&&(k==="height"||k==="width")){b.overflow=[this.style.overflow,this.style.overflowX,this.style.overflowY];if(h.css(this,"display")==="inline"&&h.css(this,"float")==="none")!h.support.inlineBlockNeedsLayout||N(this.nodeName)==="inline"?this.style.display="inline-block":this.style.zoom=1}}if(b.overflow!=null)this.style.overflow="hidden";
...
g=d.offset.left,b=g+f.helperProportions.width,j=d.offset.top,l=j+f.helperProportions.height,o=f.snapElements.length-1;0<=o;o--){var n=f.snapElements[o].left,m=n+f.snapElements[o].width,p=f.snapElements[o].top,s=p+f.snapElements[o].height;if(n-i<g&&g<m+i&&p-i<j&&j<s+i||n-i<g&&g<m+i&&p-i<l&&l<s+i||n-i<b&&b<m+i&&p-i<j&&j<s+i||n-i<b&&b<m+i&&p-i<l&&l<s+i){if("inner"!=e.snapMode){var q=Math.abs(p-l)<=i,r=Math.abs(s-j)<=i,y=Math.abs(n-b)<=i,v=Math.abs(m-g)<=i;q&&(d.position.top=f._convertPositionTo("relative",
{top:p-f.helperProportions.height,left:0}).top-f.margins.top);r&&(d.position.top=f._convertPositionTo("relative",{top:s,left:0}).top-f.margins.top);y&&(d.position.left=f._convertPositionTo("relative",{top:0,left:n-f.helperProportions.width}).left-f.margins.left);v&&(d.position.left=f._convertPositionTo("relative",{top:0,left:m}).left-f.margins.left)}var A=q||r||y||v;if("outer"!=e.snapMode&&(q=Math.abs(p-j)<=i,r=Math.abs(s-l)<=i,y=Math.abs(n-g)<=i,v=Math.abs(m-b)<=i,q&&(d.position.top=f._convertPositionTo("relative",
{top:p,left:0}).top-f.margins.top),r&&(d.position.top=f._convertPositionTo("relative",{top:s-f.helperProportions.height,left:0}).top-f.margins.top),y&&(d.position.left=f._convertPositionTo("relative",{top:0,left:n}).left-f.margins.left),v))d.position.left=f._convertPositionTo("relative",{top:0,left:m-f.helperProportions.width}).left-f.margins.left;!f.snapElements[o].snapping&&(q||r||y||v||A)&&f.options.snap.snap&&f.options.snap.snap.call(f.element,c,a.extend(f._uiHash(),{snapItem:f.snapElements[o].item}));
f.snapElements[o].snapping=q||r||y||v||A}else f.snapElements[o].snapping&&f.options.snap.release&&f.options.snap.release.call(f.element,c,a.extend(f._uiHash(),{snapItem:f.snapElements[o].item})),f.snapElements[o].snapping=!1}}});a.ui.plugin.add("draggable","stack",{start:function(){var c=a(this).data("draggable").options,c=a.makeArray(a(c.stack)).sort(function(c,d){return(parseInt(a(c).css("zIndex"),10)||0)-(parseInt(a(d).css("zIndex"),10)||0)});if(c.length){var d=parseInt(c[0].style.zIndex)||0;a(c).each(function(a){this.style.zIndex=
...
this;this.dragged=!0;if(!this.options.disabled){var f=this.options,e=this.opos[0],i=this.opos[1],g=c.pageX,b=c.pageY;if(e>g)var j=g,g=e,e=j;i>b&&(j=b,b=i,i=j);this.helper.css({left:e,top:i,width:g-e,height:b-i});this.selectees.each(function(){var j=a.data(this,"selectable-item");if(j&&j.element!=d.element[0]){var o=false;f.tolerance=="touch"?o=!(j.left>g||j.right<e||j.top>b||j.bottom<i):f.tolerance=="fit"&&(o=j.left>e&&j.right<g&&j.top>i&&j.bottom<b);if(o){if(j.selected){j.$element.removeClass("ui-selected");
...
" ",y=e(f.call(this)),v,A=j.attr("class")||"";a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});v=e(f.call(this));j.attr("class",A);j.animate(i(y,v),{queue:false,duration:c,easing:d,complete:function(){a.each(l,function(a,c){if(b[c])j[c+"Class"](b[c])});if(typeof j.attr("style")=="object"){j.attr("style").cssText="";j.attr("style").cssText=o}else j.attr("style",o);g&&g.apply(this,arguments);a.dequeue(this)}})})};a.fn.extend({_addClass:a.fn.addClass,addClass:function(b,c,d,e){return c?a.effects.animateClass.apply(this,
...
3);"show"==e&&d.css("opacity",0).css(l,"pos"==i?-g:g);"hide"==e&&(g/=2*b);"hide"!=e&&b--;if("show"==e){var o={opacity:1};o[l]=("pos"==i?"+=":"-=")+g;d.animate(o,j/2,c.options.easing);g/=2;b--}for(o=0;o<b;o++){var n={},m={};n[l]=("pos"==i?"-=":"+=")+g;m[l]=("pos"==i?"+=":"-=")+g;d.animate(n,j/2,c.options.easing).animate(m,j/2,c.options.easing);g="hide"==e?2*g:g/2}"hide"==e?(o={opacity:0},o[l]=("pos"==i?"-=":"+=")+g,d.animate(o,j/2,c.options.easing,function(){d.hide();a.effects.restore(d,f);a.effects.removeWrapper(d);
c.callback&&c.callback.apply(this,arguments)})):(n={},m={},n[l]=("pos"==i?"-=":"+=")+g,m[l]=("pos"==i?"+=":"-=")+g,d.animate(n,j/2,c.options.easing).animate(m,j/2,c.options.easing,function(){a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)}));d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(jQuery);
...
(function(a){a.effects.fold=function(c){return this.queue(function(){var d=a(this),f=["position","top","bottom","left","right"],e=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.size||15,g=!!c.options.horizFirst,b=c.duration?c.duration/2:a.fx.speeds._default/2;a.effects.save(d,f);d.show();var j=a.effects.createWrapper(d).css({overflow:"hidden"}),l="show"==e!=g,o=l?["width","height"]:["height","width"],l=l?[j.width(),j.height()]:[j.height(),j.width()],n=/([0-9]+)%/.exec(i);n&&(i=parseInt(n[1],
10)/100*l["hide"==e?0:1]);"show"==e&&j.css(g?{height:0,width:i}:{height:i,width:0});g={};n={};g[o[0]]="show"==e?l[0]:i;n[o[1]]="show"==e?l[1]:0;j.animate(g,b,c.options.easing).animate(n,b,c.options.easing,function(){"hide"==e&&d.hide();a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
...
c.options.mode||"effect"),o=c.options.restore||!1,n=c.options.scale||"both",m=c.options.origin,p={height:d.height(),width:d.width()};d.from=c.options.from||p;d.to=c.options.to||p;m&&(m=a.effects.getBaseline(m,p),d.from.top=(p.height-d.from.height)*m.y,d.from.left=(p.width-d.from.width)*m.x,d.to.top=(p.height-d.to.height)*m.y,d.to.left=(p.width-d.to.width)*m.x);var s=d.from.height/p.height,q=d.from.width/p.width,r=d.to.height/p.height,y=d.to.width/p.width;if("box"==n||"both"==n)if(s!=r&&(f=f.concat(b),
d.from=a.effects.setTransition(d,b,s,d.from),d.to=a.effects.setTransition(d,b,r,d.to)),q!=y)f=f.concat(j),d.from=a.effects.setTransition(d,j,q,d.from),d.to=a.effects.setTransition(d,j,y,d.to);if(("content"==n||"both"==n)&&s!=r)f=f.concat(g),d.from=a.effects.setTransition(d,g,s,d.from),d.to=a.effects.setTransition(d,g,r,d.to);a.effects.save(d,o?f:e);d.show();a.effects.createWrapper(d);d.css("overflow","hidden").css(d.from);if("content"==n||"both"==n)b=b.concat(["marginTop","marginBottom"]).concat(g),
j=j.concat(["marginLeft","marginRight"]),i=f.concat(b).concat(j),d.find("*[width]").each(function(){var d=a(this);o&&a.effects.save(d,i);var e=d.height(),f=d.width();d.from={height:e*s,width:f*q};d.to={height:e*r,width:f*y};if(s!=r){d.from=a.effects.setTransition(d,b,s,d.from);d.to=a.effects.setTransition(d,b,r,d.to)}if(q!=y){d.from=a.effects.setTransition(d,j,q,d.from);d.to=a.effects.setTransition(d,j,y,d.to)}d.css(d.from);d.animate(d.to,c.duration,c.options.easing,function(){o&&a.effects.restore(d,
i)})});d.animate(d.to,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){d.to.opacity===0&&d.css("opacity",d.from.opacity);l=="hide"&&d.hide();a.effects.restore(d,o?f:e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.shake=function(c){return this.queue(function(){var d=a(this),f=["position","top","bottom","left","right"];a.effects.setMode(d,c.options.mode||"effect");var e=c.options.direction||"left",i=c.options.distance||20,g=c.options.times||3,b=c.duration||c.options.duration||140;a.effects.save(d,f);d.show();a.effects.createWrapper(d);var j="up"==e||"down"==e?"top":"left",l="up"==e||"left"==e?"pos":"neg",e={},o={},n={};e[j]=("pos"==l?"-=":"+=")+i;o[j]=("pos"==l?"+=":"-=")+2*i;n[j]=("pos"==
l?"-=":"+=")+2*i;d.animate(e,b,c.options.easing);for(i=1;i<g;i++)d.animate(o,b,c.options.easing).animate(n,b,c.options.easing);d.animate(o,b,c.options.easing).animate(e,b/2,c.options.easing,function(){a.effects.restore(d,f);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)});d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(jQuery);
...
d),i=e[0]===this.active[0];f.active=f.collapsible&&i?!1:this.headers.index(e);if(!(this.running||!f.collapsible&&i)){var g=this.active,b=e.next(),j=this.active.next(),l={options:f,newHeader:i&&f.collapsible?a([]):e,oldHeader:this.active,newContent:i&&f.collapsible?a([]):b,oldContent:j},o=this.headers.index(this.active[0])>this.headers.index(e[0]);this.active=i?a([]):e;this._toggle(b,j,l,i,o);g.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").children(".ui-icon").removeClass(f.icons.headerSelected).addClass(f.icons.header);
...
(i={},i[d]=f);if(g){this._curInst==g&&this._hideDatepicker();var m=this._getDateDatepicker(b,!0),p=this._getMinMaxDate(g,"min"),s=this._getMinMaxDate(g,"max");e(g.settings,i);null!==p&&i.dateFormat!==c&&i.minDate===c&&(g.settings.minDate=this._formatDate(g,p));null!==s&&i.dateFormat!==c&&i.maxDate===c&&(g.settings.maxDate=this._formatDate(g,s));this._attachments(a(b),g);this._autoSize(g);this._setDate(g,m);this._updateAlternate(g);this._updateDatepicker(g)}},_changeDatepicker:function(a,c,d){this._optionDatepicker(a,
...
e="string"!=typeof e?e:(new Date).getFullYear()%100+parseInt(e,10),f=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,g=(d?d.dayNames:null)||this._defaults.dayNames,i=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,s=(d?d.monthNames:null)||this._defaults.monthNames,q=d=-1,r=-1,y=-1,v=!1,A=function(a){(a=N+1<b.length&&b.charAt(N+1)==a)&&N++;return a},C=function(a){var b=A(a),a=c.substring(F).match(RegExp("^\\d{1,"+("@"==a?14:"!"==a?20:"y"==a&&b?4:"o"==a?3:2)+"}"));if(!a)throw"Missing number at position "+
F;F+=a[0].length;return parseInt(a[0],10)},x=function(b,d,e){var b=a.map(A(b)?e:d,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)}),f=-1;a.each(b,function(a,b){var d=b[1];if(c.substr(F,d.length).toLowerCase()==d.toLowerCase())return f=b[0],F+=d.length,!1});if(-1!=f)return f+1;throw"Unknown name at position "+F;},D=function(){if(c.charAt(F)!=b.charAt(N))throw"Unexpected literal at position "+F;F++},F=0,N=0;N<b.length;N++)if(v)"'"==b.charAt(N)&&!A("'")?v=!1:D();else switch(b.charAt(N)){case "d":r=
C("d");break;case "D":x("D",f,g);break;case "o":y=C("o");break;case "m":q=C("m");break;case "M":q=x("M",i,s);break;case "y":d=C("y");break;case "@":var E=new Date(C("@")),d=E.getFullYear(),q=E.getMonth()+1,r=E.getDate();break;case "!":E=new Date((C("!")-this._ticksTo1970)/1E4);d=E.getFullYear();q=E.getMonth()+1;r=E.getDate();break;case "'":A("'")?D():v=!0;break;default:D()}if(F<c.length)throw"Extra/unparsed characters found in date: "+c.substring(F);-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-
(new Date).getFullYear()%100+(d<=e?0:-100));if(-1<y){q=1;r=y;do{e=this._getDaysInMonth(d,q-1);if(r<=e)break;q++;r-=e}while(1)}E=this._daylightSavingAdjust(new Date(d,q-1,r));if(E.getFullYear()!=d||E.getMonth()+1!=q||E.getDate()!=r)throw"Invalid date";return E},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:864E9*(718685+Math.floor(492.5)-
Math.floor(19.7)+Math.floor(4.925)),formatDate:function(a,c,d){if(!c)return"";var e=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,f=(d?d.dayNames:null)||this._defaults.dayNames,g=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,d=(d?d.monthNames:null)||this._defaults.monthNames,i=function(c){(c=v+1<a.length&&a.charAt(v+1)==c)&&v++;return c},s=function(a,b,c){b=""+b;if(i(a))for(;b.length<c;)b="0"+b;return b},q=function(a,b,c,d){return i(a)?d[b]:c[b]},r="",y=!1;if(c)for(var v=0;v<
a.length;v++)if(y)"'"==a.charAt(v)&&!i("'")?y=!1:r+=a.charAt(v);else switch(a.charAt(v)){case "d":r+=s("d",c.getDate(),2);break;case "D":r+=q("D",c.getDay(),e,f);break;case "o":r+=s("o",Math.round(((new Date(c.getFullYear(),c.getMonth(),c.getDate())).getTime()-(new Date(c.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":r+=s("m",c.getMonth()+1,2);break;case "M":r+=q("M",c.getMonth(),g,d);break;case "y":r+=i("y")?c.getFullYear():(10>c.getYear()%100?"0":"")+c.getYear()%100;break;case "@":r+=
c.getTime();break;case "!":r+=1E4*c.getTime()+this._ticksTo1970;break;case "'":i("'")?r+="'":y=!0;break;default:r+=a.charAt(v)}return r},_possibleChars:function(a){for(var c="",d=!1,e=function(c){(c=f+1<a.length&&a.charAt(f+1)==c)&&f++;return c},f=0;f<a.length;f++)if(d)"'"==a.charAt(f)&&!e("'")?d=!1:c+=a.charAt(f);else switch(a.charAt(f)){case "d":case "m":case "y":case "@":c+="0123456789";break;case "D":case "M":return null;case "'":e("'")?c+="'":d=!0;break;default:c+=a.charAt(f)}return c},_get:function(a,
...
g=this._get(b,"navigationAsDateFormat"),p=this._getNumberOfMonths(b),s=this._get(b,"showCurrentAtPos"),q=this._get(b,"stepMonths"),r=1!=p[0]||1!=p[1],y=this._daylightSavingAdjust(!b.currentDay?new Date(9999,9,9):new Date(b.currentYear,b.currentMonth,b.currentDay)),v=this._getMinMaxDate(b,"min"),A=this._getMinMaxDate(b,"max"),s=b.drawMonth-s,C=b.drawYear;0>s&&(s+=12,C--);if(A)for(var x=this._daylightSavingAdjust(new Date(A.getFullYear(),A.getMonth()-p[0]*p[1]+1,A.getDate())),x=v&&x<v?v:x;this._daylightSavingAdjust(new Date(C,
s,1))>x;)s--,0>s&&(s=11,C--);b.drawMonth=s;b.drawYear=C;var x=this._get(b,"prevText"),x=!g?x:this.formatDate(x,this._daylightSavingAdjust(new Date(C,s-q,1)),this._getFormatConfig(b)),x=this._canAdjustMonth(b,-1,C,s)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', -"+q+", 'M');\" title=\""+x+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+x+"</span></a>":f?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+
x+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+x+"</span></a>",D=this._get(b,"nextText"),D=!g?D:this.formatDate(D,this._daylightSavingAdjust(new Date(C,s+q,1)),this._getFormatConfig(b)),f=this._canAdjustMonth(b,1,C,s)?'<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', +"+q+", 'M');\" title=\""+D+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+D+"</span></a>":f?"":'<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+
...
D)?'<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._gotoToday('#"+b.id+"');\">"+q+"</button>":"")+(d?"":g)+"</div>":"",g=parseInt(this._get(b,"firstDay"),10),g=isNaN(g)?0:g,q=this._get(b,"showWeek"),D=this._get(b,"dayNames");this._get(b,"dayNamesShort");var F=this._get(b,"dayNamesMin"),N=this._get(b,"monthNames"),E=this._get(b,"monthNamesShort"),w=this._get(b,"beforeShowDay"),O=this._get(b,"showOtherMonths"),
S=this._get(b,"selectOtherMonths");this._get(b,"calculateWeek");for(var h=this._getDefaultDate(b),T="",R=0;R<p[0];R++){var Q="";this.maxRows=4;for(var M=0;M<p[1];M++){var t=this._daylightSavingAdjust(new Date(C,s,b.selectedDay)),H=" ui-corner-all",G="";if(r){G+='<div class="ui-datepicker-group';if(1<p[1])switch(M){case 0:G+=" ui-datepicker-group-first";H=" ui-corner-"+(d?"right":"left");break;case p[1]-1:G+=" ui-datepicker-group-last";H=" ui-corner-"+(d?"left":"right");break;default:G+=" ui-datepicker-group-middle",
H=""}G+='">'}for(var G=G+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+H+'">'+(/all|left/.test(H)&&0==R?d?f:x:"")+(/all|right/.test(H)&&0==R?d?x:f:"")+this._generateMonthYearHeader(b,s,C,v,A,0<R||0<M,N,E)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),J=q?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":"",H=0;7>H;H++)var I=(H+g)%7,J=J+("<th"+(5<=(H+g+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+D[I]+'">'+F[I]+"</span></th>");
G+=J+"</tr></thead><tbody>";J=this._getDaysInMonth(C,s);C==b.selectedYear&&s==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,J));H=(this._getFirstDayOfMonth(C,s)-g+7)%7;J=Math.ceil((H+J)/7);this.maxRows=J=r?this.maxRows>J?this.maxRows:J:J;for(var I=this._daylightSavingAdjust(new Date(C,s,1-H)),W=0;W<J;W++){for(var G=G+"<tr>",Y=!q?"":'<td class="ui-datepicker-week-col">'+this._get(b,"calculateWeek")(I)+"</td>",H=0;7>H;H++){var U=w?w.apply(b.input?b.input[0]:null,[I]):[!0,""],L=I.getMonth()!=
s,k=L&&!S||!U[0]||v&&I<v||A&&I>A,Y=Y+('<td class="'+(5<=(H+g+6)%7?" ui-datepicker-week-end":"")+(L?" ui-datepicker-other-month":"")+(I.getTime()==t.getTime()&&s==b.selectedMonth&&b._keyEvent||h.getTime()==I.getTime()&&h.getTime()==t.getTime()?" "+this._dayOverClass:"")+(k?" "+this._unselectableClass+" ui-state-disabled":"")+(L&&!O?"":" "+U[1]+(I.getTime()==y.getTime()?" "+this._currentClass:"")+(I.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!L||O)&&U[2]?' title="'+U[2]+'"':"")+(k?"":
' onclick="DP_jQuery_'+i+".datepicker._selectDay('#"+b.id+"',"+I.getMonth()+","+I.getFullYear()+', this);return false;"')+">"+(L&&!O?"&#xa0;":k?'<span class="ui-state-default">'+I.getDate()+"</span>":'<a class="ui-state-default'+(I.getTime()==c.getTime()?" ui-state-highlight":"")+(I.getTime()==y.getTime()?" ui-state-active":"")+(L?" ui-priority-secondary":"")+'" href="#">'+I.getDate()+"</a>")+"</td>");I.setDate(I.getDate()+1);I=this._daylightSavingAdjust(I)}G+=Y+"</tr>"}s++;11<s&&(s=0,C++);G+="</tbody></table>"+
(r?"</div>"+(0<p[0]&&M==p[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");Q+=G}T+=Q}T+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return T},_generateMonthYearHeader:function(a,c,d,e,f,g,p,s){var q=this._get(a,"changeMonth"),r=this._get(a,"changeYear"),y=this._get(a,"showMonthAfterYear"),v='<div class="ui-datepicker-title">',A="";if(g||!q)A+='<span class="ui-datepicker-month">'+
p[c]+"</span>";else{for(var p=e&&e.getFullYear()==d,C=f&&f.getFullYear()==d,A=A+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),x=0;12>x;x++)if((!p||x>=e.getMonth())&&(!C||x<=f.getMonth()))A+='<option value="'+x+'"'+(x==c?' selected="selected"':"")+">"+s[x]+"</option>";A+="</select>"}y||(v+=A+(g||!q||!r?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",g||!r)v+='<span class="ui-datepicker-year">'+d+"</span>";else{var s=this._get(a,
"yearRange").split(":"),D=(new Date).getFullYear(),p=function(a){a=a.match(/c[+-].*/)?d+parseInt(a.substring(1),10):a.match(/[+-].*/)?D+parseInt(a,10):parseInt(a,10);return isNaN(a)?D:a},c=p(s[0]),s=Math.max(c,p(s[1]||"")),c=e?Math.max(c,e.getFullYear()):c,s=f?Math.min(s,f.getFullYear()):s;for(a.yearshtml+='<select class="ui-datepicker-year" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'Y');\" >";c<=s;c++)a.yearshtml+='<option value="'+c+'"'+(c==d?' selected="selected"':
"")+">"+c+"</option>";a.yearshtml+="</select>";v+=a.yearshtml;a.yearshtml=null}v+=this._get(a,"yearSuffix");y&&(v+=(g||!q||!r?"&#xa0;":"")+A);return v+"</div>"},_adjustInstDate:function(a,c,d){var e=a.drawYear+("Y"==d?c:0),f=a.drawMonth+("M"==d?c:0),c=Math.min(a.selectedDay,this._getDaysInMonth(e,f))+("D"==d?c:0),e=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(e,f,c)));a.selectedDay=e.getDate();a.drawMonth=a.selectedMonth=e.getMonth();a.drawYear=a.selectedYear=e.getFullYear();("M"==d||
...
(function(a){a.ui=a.ui||{};var c=/left|center|right/,d=/top|center|bottom/,f,e=a.fn.position,i=a.fn.offset;a.fn.position=function(g){if(!g||!g.of)return e.apply(this,arguments);var g=a.extend({},g),b=a(g.of),i=b[0],l=(g.collision||"flip").split(" "),o=g.offset?g.offset.split(" "):[0,0],n,m,p;9===i.nodeType?(n=b.width(),m=b.height(),p={top:0,left:0}):i.setTimeout?(n=b.width(),m=b.height(),p={top:b.scrollTop(),left:b.scrollLeft()}):i.preventDefault?(g.at="left top",n=m=0,p={top:g.of.pageY,left:g.of.pageX}):
(n=b.outerWidth(),m=b.outerHeight(),p=b.offset());a.each(["my","at"],function(){var a=(g[this]||"").split(" ");a.length===1&&(a=c.test(a[0])?a.concat(["center"]):d.test(a[0])?["center"].concat(a):["center","center"]);a[0]=c.test(a[0])?a[0]:"center";a[1]=d.test(a[1])?a[1]:"center";g[this]=a});1===l.length&&(l[1]=l[0]);o[0]=parseInt(o[0],10)||0;1===o.length&&(o[1]=o[0]);o[1]=parseInt(o[1],10)||0;"right"===g.at[0]?p.left+=n:"center"===g.at[0]&&(p.left+=n/2);"bottom"===g.at[1]?p.top+=m:"center"===g.at[1]&&
(p.top+=m/2);p.left+=o[0];p.top+=o[1];return this.each(function(){var b=a(this),c=b.outerWidth(),d=b.outerHeight(),e=parseInt(a.curCSS(this,"marginLeft",true))||0,i=parseInt(a.curCSS(this,"marginTop",true))||0,j=c+e+(parseInt(a.curCSS(this,"marginRight",true))||0),C=d+i+(parseInt(a.curCSS(this,"marginBottom",true))||0),x=a.extend({},p),D;if(g.my[0]==="right")x.left=x.left-c;else if(g.my[0]==="center")x.left=x.left-c/2;if(g.my[1]==="bottom")x.top=x.top-d;else if(g.my[1]==="center")x.top=x.top-d/2;
if(!f){x.left=Math.round(x.left);x.top=Math.round(x.top)}D={left:x.left-e,top:x.top-i};a.each(["left","top"],function(b,e){if(a.ui.position[l[b]])a.ui.position[l[b]][e](x,{targetWidth:n,targetHeight:m,elemWidth:c,elemHeight:d,collisionPosition:D,collisionWidth:j,collisionHeight:C,offset:o,my:g.my,at:g.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(x,{using:g.using}))})};a.ui.position={fit:{left:function(c,b){var d=a(window),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft();
...
{},b,j,l,o;if(this.options.values&&this.options.values.length)this.handles.each(function(c){i=100*((f.values(c)-f._valueMin())/(f._valueMax()-f._valueMin()));g["horizontal"===f.orientation?"left":"bottom"]=i+"%";a(this).stop(1,1)[e?"animate":"css"](g,d.animate);if(!0===f.options.range)if("horizontal"===f.orientation){if(0===c)f.range.stop(1,1)[e?"animate":"css"]({left:i+"%"},d.animate);if(1===c)f.range[e?"animate":"css"]({width:i-b+"%"},{queue:!1,duration:d.animate})}else{if(0===c)f.range.stop(1,
1)[e?"animate":"css"]({bottom:i+"%"},d.animate);if(1===c)f.range[e?"animate":"css"]({height:i-b+"%"},{queue:!1,duration:d.animate})}b=i});else{j=this.value();l=this._valueMin();o=this._valueMax();i=o!==l?100*((j-l)/(o-l)):0;g["horizontal"===f.orientation?"left":"bottom"]=i+"%";this.handle.stop(1,1)[e?"animate":"css"](g,d.animate);if("min"===c&&"horizontal"===this.orientation)this.range.stop(1,1)[e?"animate":"css"]({width:i+"%"},d.animate);if("max"===c&&"horizontal"===this.orientation)this.range[e?
...
-1;b.cookie&&g._cookie(b.selected,b.cookie);g.element.queue("tabs",function(){s(c,e)}).dequeue("tabs");this.blur();return false}if(!e.length){b.cookie&&g._cookie(b.selected,b.cookie);g.element.queue("tabs",function(){p(c,f)});g.load(g.anchors.index(this));this.blur();return false}}b.cookie&&g._cookie(b.selected,b.cookie);if(f.length){e.length&&g.element.queue("tabs",function(){s(c,e)});g.element.queue("tabs",function(){p(c,f)});g.load(g.anchors.index(this))}else throw"jQuery UI Tabs: Mismatching fragment identifier.";
...
(function(a,c,d,f){function e(a,b,c){I[a]=c;W[a]=b;J||(J=a)}function i(b){J!==b&&(J=b,a.ui.editor.eachInstance(function(){this.reinit()}))}function g(a,b){J&&I[J]&&I[J][a]&&(a=I[J][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function b(b){if(Y===f){Y=!0;if(U=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(b.options.baseClass+"-ios"),U&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height",
"-=1")},0)});a.browser.mozilla&&a("html").addClass(b.options.baseClass+"-ff");if(a.browser.msie&&9>a.browser.version){Y=!1;var c=a("<div/>").addClass(b.options.baseClass+"-unsupported").html(b.getTemplate("unsupported")).appendTo("body");j(c);c.find("."+b.options.baseClass+"-unsupported-close").click(function(){c.remove()})}}return Y}function j(b){var c=1;b.siblings().each(function(){var b=a(this).css("z-index");!isNaN(b)&&b>c&&(c=b+1)});b.css("z-index",c)}function l(a){return a.clone().wrap("<div/>").parent().html()}
function o(a){var b,a=document.createElement(a);b="getComputedStyle"in c;document.body.appendChild(a);b=(b?c.getComputedStyle(a,""):a.currentStyle).display;document.body.removeChild(a);return b}function n(b,c){return-1!==a.inArray(a(b)[0].tagName.toLowerCase(),c)}function m(a){for(var b={},a=c.getComputedStyle(a[0],null),d=0;d<a.length;d++)b[a.item(d)]=a.getPropertyValue(a.item(d));return b}function p(b,c){for(var d="",e=0,f=b.childNodes.length;e<f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?
g.nodeValue:l(a(g)))&&(d+=g)}c&&(d=a("<"+c+">"+d+"</"+c+">"),d.find("p").wrapInner("<"+c+"/>"),d.find("p > *").unwrap(),d=a("<div/>").html(d).html());return d}function s(b,c){var d=a("<div/>").append(b)[0].childNodes;c.deleteContents();d.length===f||1===d.length?c.insertNode(d[0].cloneNode(!0)):a.each(d,function(a,b){c.insertNodeAtEnd(b.cloneNode(!0))})}function q(b){var b=b||d.getSelection(),c;a(b.getAllRanges()).each(function(b,d){c=3===this.commonAncestorContainer.nodeType?a(d.commonAncestorContainer).parent()[0]:
d.commonAncestorContainer});return c}function r(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer}function y(a){if(!L||a)L=d.saveSelection()}function v(){L&&(d.restoreSelection(L),L=!1)}function A(){L&&d.removeMarkers(L);L=!1}function C(a,b,c){for(var b=b||d.getSelection(),e,f=0;e=b.getAllRanges()[f++];)a.call(c,e)}function x(a,b){C(function(b){s(a,b)},b,this)}function D(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).focus().contents().each(function(){var a=d.createRange();
a.selectNodeContents(this);c.addRange(a)})}function F(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNode(this);c.addRange(a)}).focus()}function N(b,c,e){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNodeContents(this);a.collapse(e);c.addRange(a)})}function E(a,b){N(a,b,!1)}function w(a,b){N(a,b,!0)}function O(a){a=a||d.getSelection();return a.toHtml()}function S(b){b=b||d.getSelection().getRangeAt(0);
return a(3===b.commonAncestorContainer.nodeType?b.commonAncestorContainer.parentNode:b.commonAncestorContainer)}function h(a){var b=new jQuery;C(function(a){b.push(S(a)[0])},a,this);return b}function T(){var b=d.getSelection();if(null===b.anchorNode)return null;if(b.isBackwards())return 3===b.focusNode.nodeType?a(b.focusNode.parentElement):a(b.focusNode);b.anchorNode||console.trace();return 3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode)}function R(){var b=d.getSelection();
...
{}).append(p(d.cloneContents())),s(f,d)):e.toggleRange(d)},null,this)}function M(a,b,c){C(function(d){d=S(d);d.is(a)?d.attr(b):Q(a,{classes:c,attributes:b})},null,this)}function t(b,c){var c=c||d.getSelection(),e=c.getRangeAt(0),f=h()[0],g=d.createRange();g.setStartBefore(f);g.setEnd(e.startContainer,e.startOffset);var g=g.cloneContents(),i=d.createRange();i.setStart(e.endContainer,e.endOffset);i.setEndAfter(f);e=i.cloneContents();g=l(a(p(g)));g+=l(a(b));g+=l(a(p(e)));a(f).replaceWith(a(g))}function H(a,
b,c){var c=c||d.getSelection(),e=T()[0],f=R()[0],g=h()[0],g=n(g,b),e=n(e,b),b=n(f,b);g&&e&&b?x(a):t(a,c)}function G(a,b){allowed=[];for(var c=0;c<b.length;c++)b[c].match(/[a-z][a-z0-9]{0,}/g)&&allowed.push(b[c]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,b){return-1<allowed.indexOf(b.toLowerCase())?a:""})}var J=null,I={},W={};a(function(){d.initialized||d.init();a.isFunction(d.rangePrototype.insertNodeAtEnd)||(d.rangePrototype.insertNodeAtEnd=
function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});a("html").click(function(){a(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});a.widget("ui.editor",{_init:function(){-1===a.inArray(this,a.ui.editor.instances)&&a.ui.editor.instances.push(this);var c=this;this.options=a.extend({},a.ui.editor.defaults,this.options);this.options.uiOrder=this.options.uiOrder||[["logo"],["save","cancel"],["dock","showGuides","clean"],["viewSource"],
["undo","redo"],["alignLeft","alignCenter","alignJustify","alignRight"],["textBold","textItalic","textUnderline","textStrike"],["textSuper","textSub"],["listUnordered","listOrdered"],["hr","quoteBlock"],["fontSizeInc","fontSizeDec"],["colorPickerBasic"],["clearFormatting"],["link","unlink"],["embed"],["floatLeft","floatNone","floatRight"],["tagMenu"],["i18n"],["raptorize"],["statistics"],["debugReinit","debugDestroy"]];this.element.attr("id")||this.element.attr("id",this.getUniqueId());this.ready=
!1;this.events={};this.ui={};this.plugins={};this.templates=a.extend({},a.ui.editor.templates);this.path=this.toolbarWrapper=this.toolbar=this.wrapper=null;this.visible=this.enabled=!1;this.uiObjects={};this.hotkeys={};this.options.enableHotkeys&&this.registerHotkey(this.hotkeys);for(var d in this.options.bind)this.bind(d,this.options.bind[d]);this.history=[];this.present=0;this.historyEnabled=!0;b(this)&&(this.cloneDomTools(),this.setOriginalHtml(this.element.is(":input")?this.element.val():this.element.html()),
this.element.is("textarea, input")&&this.replaceOriginal(),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,this.ready=!0,this.fire("ready"),this.options.autoEnable&&a(function(){c.enableEditing();c.showToolbar()}))},attach:function(){this.bind("change",this.historyPush);this.bind("selectionChange",this.updateTagTree);this.bind("show",this.updateTagTree);var b=a.proxy(this.checkChange,this);this.getElement().find("img").bind("click."+this.widgetName,
a.proxy(function(a){F(a.target)},this));this.getElement().bind("mouseup."+this.widgetName,b);this.getElement().bind("keyup."+this.widgetName,b);a(c).bind("beforeunload",a.proxy(a.ui.editor.unloadWarning,a.ui.editor))},reinit:function(){if(this.ready){var a=this.enabled,b=this.visible;this.destruct(!0);this._init();a&&this.enableEditing();b&&this.showToolbar()}else{var c;c=function(){this.unbind("ready",c);this.reinit()};this.bind("ready",c)}},getElement:function(){return this.target?this.target:this.element},
getOriginalElement:function(){return this.element},replaceOriginal:function(){if(!this.target){for(var b=a("<div/>").html(this.element.is(":input")?this.element.val():this.element.html()).insertBefore(this.element).attr("id",this.getUniqueId()).addClass(this.element.attr("class")),c=m(this.element),d=0;d<this.options.replaceStyle.length;d++)b.css(this.options.replaceStyle[d],c[this.options.replaceStyle[d]]);this.element.hide();this.bind("change",function(){this.element.is("input, textarea")?this.element.val(this.getHtml()):
...
c){b.children().each(function(){var b=a.map(this.attributes,function(b){if(-1===a.inArray(b.name,c))return b.name}),d=a(this);a.each(b,function(a,b){d.removeAttr(b)});element.removeAttributes(a(this),c)});return b},elementBringToTop:j,elementOuterHtml:l,elementOuterText:function(a){return a.clone().wrap("<div/>").parent().text()},elementIsBlock:function(a){return"block"===o(a.tagName)},elementDefaultDisplay:o,elementIsValid:n,elementGetStyles:m,fragmentToHtml:p,fragmentInsertBefore:function(b,c,d){for(var e=
0,f=b.childNodes.length;e<f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?g.nodeValue:a(g).html())&&a("<"+d+"/>").html(a.trim(g)).insertBefore(c)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},rangeGetCommonAncestor:q,rangeIsEmpty:r,selectionSave:y,selectionRestore:v,selectionDestroy:A,selectionEachRange:C,selectionReplace:x,selectionSelectInner:D,selectionSelectOuter:F,selectionSelectEdge:N,selectionSelectEnd:E,selectionSelectStart:w,selectionGetHtml:O,
selectionGetElements:h,selectionToggleWrapper:Q,selectionExists:function(a){var b=!1;C(function(a){r(a)||(b=!0)},a,this);return b},selectionReplaceSplittingSelectedElement:t,selectionReplaceWithinValidTags:H,stringStripTags:G,defaults:{plugins:{},ui:{},bind:{},domTools:{constrainSelection:function(b,c){var b=a(b)[0],c=c||d.getSelection(),e;a(c.getAllRanges()).each(function(d,f){e=3===this.commonAncestorContainer.nodeType?a(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;b!==e&&!a.contains(b,
e)&&c.removeRange(f)})},unwrapParentTag:function(b){h().each(function(){a(this).is(b)&&a(this).replaceWith(a(this).html())})},execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(d){}},insertTag:function(b,c){C(function(c){c.insertNode(a("<"+b+"/>")[0])},c,this)},insertTagAtEnd:function(b,c){C(function(c){c.insertNodeAtEnd(a("<"+b+"/>")[0])},c,this)},insertElement:function(b,c,d){C(function(d){a(b).each(function(){d.insertNode(!1===c?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(b,
c,d){C(function(d){a(b).each(function(){d.insertNodeAtEnd(!1===c?this:this.cloneNode(!0))})},d,this)},toggleBlockStyle:function(b,c){C(function(d){for(d=a(d.commonAncestorContainer);d.length&&d[0]!==c[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===c[0]&&"inline"!==c.css("display")&&(this.wrapInner(c,"div"),d=c.children().first());this.toggleStyle(d,b)},null,this)},wrapInner:function(b,c){y();a(b).each(function(){var d=a("<"+c+"/>").html(a(this).html());b.html(d)});v()},
inverseWrapWithTagClass:function(b,c,e,f){y();var g="domTools"+Math.ceil(1E7*Math.random());C(function(a){var b=d.createCssClassApplier(f,{elementTagName:e});b.isAppliedToRange(a)?b.toggleSelection():d.createCssClassApplier(c,{elementTagName:g}).toggleSelection()},null,this);a(g).each(function(){a(this).replaceWith(a("<"+b+"/>").addClass(c).html(a(this).html()))});v()},toggleStyle:function(b,c){a.each(c,function(c,d){a(b).css(c)===d?a(b).css(c,""):a(b).css(c,d)})},swapStyles:function(a,b,c){for(var d in c)a.css(d,
...
click:function(){C(function(b){a(b.commonAncestorContainer).find("img").css("float","left")})}})}},floatRight:{init:function(b){return b.uiButton({title:g("Float Image Right"),click:function(){C(function(b){a(b.commonAncestorContainer).find("img").css("float","right")})}})}},floatNone:{init:function(b){return b.uiButton({title:g("Remove Image Float"),click:function(){C(function(b){a(b.commonAncestorContainer).find("img").css("float","none")})}})}}});a.ui.editor.registerUi({fontSizeInc:{init:function(a,
...
click:function(){x("<hr/>")}})}}});a.ui.editor.registerUi({i18n:{init:function(b){var c=this,d=this.persist("locale");d&&i(d);var d=a('<select autocomplete="off" name="i18n"/>'),e;for(e in I){var f=a('<option value="'+e+'" class="'+e+'"/>');f.html(W[e]);J===e&&f.attr("selected","selected");d.append(f)}return b.uiSelectMenu({title:g("Change Language"),select:d,change:function(a){i(c.persist("locale",a))}})}}});e("de","Deutsch",{"A preview of your embedded object is displayed below.":"Eine Vorschau ihres eingebundenen Objekts wird unterhalb angezeigt.",
"Added link: {{link}}":"Link hinzugef\u00fcgt: {{link}}","All changes will be lost!":"Alle \u00c4nderungen gehen verloren!","Apply Source":"Quellcode anwenden","Are you sure you want to stop editing?":"Wollen Sie wirklich mit der Bearbeitung aufh\u00f6ren?",Blockquote:"Zitat",Bold:"Fett",Cancel:"Abbrechen","Center Align":"Zentrieren","Change HTML tag of selected element":"HTML Tag des selektierten Elements \u00e4ndern","Change Language":"Sprache wechseln","Change the color of the selected text.":"Farbe des gew\u00e4hlten Texts \u00e4ndern.",
"Check this box to have the file open in a new browser window":"Markieren Sie diese Box um die Datei in einem neuen Browser zu \u00f6ffnen","Check this box to have the link open in a new browser window":"Markieren Sie diese Box um den Link in einem neuen Browser zu \u00f6ffnen","Choose a link type:":"W\u00e4hlen Sie einen Link Typ:","Clear Formatting":"Formatierung l\u00f6schen","Click to begin editing":"Zum Bearbeiten klicken","Click to detach the toolbar":"Zum L\u00f6sen der Werkzeugleiste klicken",
"Click to dock the toolbar":"Zum Befestigen der Werkzeugleiste klicken","Click to edit the image":"Um das Bild zu bearbeiten klicken","Click to select all editable content":"Um alle bearbeitbaren Elemente zu selektieren klicken","Click to select the contents of the '{{element}}' element":"Um den Inhalt des '{{element}}' Element zu selektieren klicken",Close:"Schliessen","Confirm Cancel Editing":"Bearbeitung abbrechen best\u00e4tigen","Content Statistics":"Inhaltsstatistik","Content contains more than {{limit}} characters and may be truncated":"Der Inhalt hat mehr als {{limit}} Zeichen und kann gek\u00fcrzt werden",
"Content will not be truncated":"Der Inhalt wird nicht gek\u00fcrzt","Copy the file's URL from your browser's address bar and paste it into the box above":"Kopieren Sie die URL der Datei von der Adressleiste ihres Browser und f\u00fcgen Sie diese in der Box oberhalb ein","Copy the web address from your browser's address bar and paste it into the box above":"Kopieren Sie die Web Adresse von der Adressleiste ihres Browser und f\u00fcgen Sie diese in der Box oberhalb ein","Decrease Font Size":"Schriftgr\u00f6sse verkleinern",
Destroy:"L\u00f6schen",Divider:"Trennzeichen","Document or other file":"Dokument oder andere Datei","Edit Link":"Link bearbeiten",Email:"E-Mail","Email address":"E-Mail Adresse","Embed Code":"Quellcode einbinden","Embed Object":"Objekt einbinden","Embed object":"Objekt einbinden","Ensure the file has been uploaded to your website":"Stellen Sie sicher, dass die Datei auf ihre Webseite hochgeladen wurde","Enter email address":"E-Mail Adresse eingeben","Enter subject":"Betreff eingeben","Enter your URL":"Ihre URL eingeben",
"Failed to save {{failed}} content block(s).":"{{failed}} Inhaltsbl\u00f6cke konnten nicht gespeichert werden.","Find the page on the web you want to link to":"Finden Sie die Seite im Web welche Sie verlinken wollen","Float Image Left":"Bild nach links stellen","Float Image Right":"Bild nach rechts stellen","Formatted &amp; Cleaned":"Formatiert &amp; Bereinigt","Formatted Unclean":"Formatiert &amp; Unbereinigt","Heading&nbsp;1":"Titel&nbsp;1","Heading&nbsp;2":"Titel&nbsp;2","Heading&nbsp;3":"Titel&nbsp;3",
"Image height":"Bildh\u00f6he","Image width":"Bildbreite","Increase Font Size":"Schriftgr\u00f6sse vergr\u00f6ssern",Initializing:"Initialisieren",Insert:"Einf\u00fcgen","Insert Horizontal Rule":"Horizontale Trennlinie einf\u00fcgen","Insert Link":"Link einf\u00fcgen","Insert Snippet":"Schnipsel einf\u00fcgen",Italic:"Kursiv",Justify:"B\u00fcndig","Learn More About the Raptor WYSIWYG Editor":"Erfahren Sie mehr \u00fcber dem Raptor WYSIWYG Editor","Left Align":"Links ausrichten","Link to a document or other file":"Ein Dokument oder eine Datei verlinken",
"Link to a page on this or another website":"Eine Seite auf dieser oder einer anderen Webseite verlinken","Link to an email address":"Eine E-Mail Adresse verlinken",Location:"Ort","Modify Image Size":"Bildgr\u00f6sse \u00e4ndern","N/A":"k.A.","New window":"Neues Fenster","No changes detected to save...":"Keine \u00c4nderungen zum Speichern erkannt...","Not sure what to put in the box above?":"Nicht sicher was in die Box oberhalb geh\u00f6rt?",OK:!1,"Open the uploaded file in your browser":"Die hochgeladene Datei in ihrem Browser \u00f6ffnen",
"Ordered List":"Geordnete Liste","Page on this or another website":"Seite auf dieser oder einer anderen Webseite",Paragraph:"Paragraph","Paste Embed Code":"Quellcode einf\u00fcgen","Paste your embed code into the text area below.":"F\u00fcgen Sie ihren Quellcode zum Einbetten in das Textfeld unterhalb ein.","Plain Text":"Einfacher Text",Preview:"Vorschau",Raptorize:!1,Reinitialise:"Reinitialisieren","Remaining characters before the recommended character limit is reached":"Verbleibende Zeichen bis die empfohlene Limite erreicht ist",
"Remove Image Float":"Bildausrichtung entfernen","Remove Link":"Link entfernen","Remove unnecessary markup from editor content":"Unn\u00f6tige Markierungselemente im Inhalt entfernen","Resize Image":"Bildgr\u00f6sse anpassen","Right Align":"Rechts ausrichten",Save:"Speichern","Saved {{saved}} out of {{dirty}} content blocks.":"{{saved}} von {{dirty}} Inhaltsbl\u00f6cken gespeichert.","Saving changes...":"\u00c4nderungen speichern...","Select all editable content":"Alle editierbaren Inhalte ausw\u00e4hlen",
...
"The email address does not look well formed":"Die E-Mail Adresse scheint nicht g\u00fcltig zu sein","The image '{{image}}' is too wide for the element being edited.<br/>It will be resized to fit.":"Das Bild '{{image}}' ist zu breit f\u00fcr das gerade editierte Element.<br/>Es wird so ge\u00e4ndert, dass es passt.","The url for the file you inserted doesn't look well formed":"Die URL der Datei scheint nicht g\u00fcltig zu sein","The url for the link you inserted doesn't look well formed":"Die URL des Links scheint nicht g\u00fcltig zu sein",
...
root:"","{{charactersRemaining}} characters over limit":"{{charactersRemaining}} Zeichen \u00fcber der Limite","{{charactersRemaining}} characters remaining":"{{charactersRemaining}} Zeichen verbleibend","{{characters}} characters, {{charactersRemaining}} over the recommended limit":"{{characters}} Zeichen, {{charactersRemaining}} \u00fcber der empfohlenen Limite","{{characters}} characters, {{charactersRemaining}} remaining":"{{characters}} Zeichen, {{charactersRemaining}} verbleibend","{{sentences}} sentences":"{{sentences}} S\u00e4tze",
"{{words}} word":"{{words}} Wort","{{words}} words":"{{words}} W\u00f6rter"});e("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"Apply Source","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",Blockquote:"Blockquote",Bold:"Bold",Cancel:"Cancel","Center Align":"Center Align",
"Change HTML tag of selected element":"Change HTML tag of selected element","Change Language":"Change Language","Change the color of the selected text.":"Change the color of the selected text.","Check this box to have the file open in a new browser window":"Check this box to have the file open in a new browser window","Check this box to have the link open in a new browser window":"Check this box to have the link open in a new browser window","Choose a link type:":"Choose a link type:","Clear Formatting":"Clear Formatting",
...
c.anchorOffset)?c=!1:(c=e.previousSibling,c=!c||""===a(c).html()?!0:!1);var f;e=d.getSelection();f=e.isBackwards()?e.anchorNode:e.focusNode;(e.isBackwards()?e.focusOffset:e.anchorOffset)!==f.textContent.length?f=!1:(e=f.nextSibling,f=!e||""===a(e).html()?!0:!1);var g=this.options.baseClass+"-enter-break",e=a(this.options.enter).attr("id",g);H(e,this.options.enterValidTags);e=a("#"+g).removeAttr("id");b?c?w(e.next()):f?w(e):(w(e.next()),(b=e.prev())&&""!==a.trim(b.html())&&l(b)!==this.options.enter&&
e.remove()):(w(e.next()),e.remove())},restoreSelection:!1},"return+shift":{action:function(){A();var b=this.options.baseClass+"-enter-break",c=a(this.shiftEnter).attr("id",b).appendTo("body");this.options.shiftEnterValidTags?H(this.options.shiftEnter,this.options.shiftEnterValidTags):x(c);b=a("#"+b).removeAttr("id").next();w(b)},restoreSelection:!1}}});a.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span,hr,br".split(","),allowedAttributes:["href",
...
c=h.filterAttributes(c),c=h.filterChars(c),c=h.stripEmpty(c),c=h.stripAttributes(c),c=G(c,h.options.allowedTags),c={plain:a("<div/>").html(a(".uiWidgetEditorPasteBin").html()).text(),markup:c,html:a(".uiWidgetEditorPasteBin").html()};f=a(b.getTemplate("paste.dialog",c));a(f).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:d.dialogShowAnimation,hide:d.dialogHideAnimation,dialogClass:d.baseClass+" "+d.dialogClass,buttons:[{text:g("Insert"),click:function(){var c=
...
change:function(c){if(!("undefined"===typeof c||"na"===c)){var d=b.getElement()[0],e=h();if(!O()||""===O()){if(a(e)[0]===a(d)[0])return;y();d=a("<"+c+">").html(e.html());e.replaceWith(d);v()}else{var e=a(h()[0]).parent(),f=this.options.baseClass+"-selection",c=a("<"+c+">").html(O()).addClass(f);e===d||h()[0]===d?x(c):H(c,this.validParents);D(b.getElement().find("."+f).removeClass(f))}b.checkChange()}}})},change:function(){var b=h()[0];b?(b=b.tagName.toLowerCase(),this.ui.select.find("option[value="+
...
a(d).button("option","disabled",!1);b.editor.checkChange()}})}}});var L=!1})(jQuery,window,rangy);
