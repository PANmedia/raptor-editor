...
*/
window.rangy=function(){function a(a,b){var c=typeof a[b];return c==l||!!(c==k&&a[b])||"unknown"==c}function c(a,b){return!!(typeof a[b]==k&&a[b])}function d(a,b){return typeof a[b]!=o}function e(a){return function(b,c){for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0}}function g(a){return a&&q(a,s)&&z(a,r)}function i(a){window.alert("Rangy not supported in your browser. Reason: "+a);x.initialized=!0;x.supported=!1}function f(){if(!x.initialized){var b,d=!1,e=!1;a(document,"createRange")&&
(b=document.createRange(),q(b,m)&&z(b,n)&&(d=!0),b.detach());if((b=c(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(b,"createTextRange"))b=b.createTextRange(),g(b)&&(e=!0);!d&&!e&&i("Neither Range nor TextRange are implemented");x.initialized=!0;x.features={implementsDomRange:d,implementsTextRange:e};d=D.concat(y);e=0;for(b=d.length;e<b;++e)try{d[e](x)}catch(k){c(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
k)}}}function b(a){this.name=a;this.supported=this.initialized=!1}var k="object",l="function",o="undefined",n="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer,START_TO_START,START_TO_END,END_TO_START,END_TO_END".split(","),m="setStart,setStartBefore,setStartAfter,setEnd,setEndBefore,setEndAfter,collapse,selectNode,selectNodeContents,compareBoundaryPoints,deleteContents,extractContents,cloneContents,insertNode,surroundContents,cloneRange,toString,detach".split(","),
r="boundingHeight,boundingLeft,boundingTop,boundingWidth,htmlText,text".split(","),s="collapse,compareEndPoints,duplicate,getBookmark,moveToBookmark,moveToElementText,parentElement,pasteHTML,select,setEndPoint,getBoundingClientRect".split(","),q=e(a),p=e(c),z=e(d),x={version:"1.2.3",initialized:!1,supported:!0,util:{isHostMethod:a,isHostObject:c,isHostProperty:d,areHostMethods:q,areHostObjects:p,areHostProperties:z,isTextRange:g},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
x.fail=i;x.warn=function(a){a="Rangy warning: "+a;x.config.alertOnWarn?window.alert(a):typeof window.console!=o&&typeof window.console.log!=o&&window.console.log(a)};({}).hasOwnProperty?x.util.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])}:i("hasOwnProperty not supported");var y=[],D=[];x.init=f;x.addInitListener=function(a){x.initialized?a(x):y.push(a)};var A=[];x.addCreateMissingNativeApiListener=function(a){A.push(a)};x.createMissingNativeApi=function(a){a=a||window;f();
for(var b=0,c=A.length;b<c;++b)A[b](a)};b.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};b.prototype.warn=function(a){x.warn("Module "+this.name+": "+a)};b.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};x.createModule=function(a,c){var d=new b(a);x.modules[a]=d;D.push(function(a){c(a,d);d.initialized=!0;d.supported=!0})};x.requireModules=function(a){for(var c=0,d=a.length,g,e;c<
d;++c){e=a[c];g=x.modules[e];if(!g||!(g instanceof b))throw Error("Module '"+e+"' not found");if(!g.supported)throw Error("Module '"+e+"' not supported");}};var B=!1,p=function(){B||(B=!0,x.initialized||f())};if(typeof window==o)i("No window found");else if(typeof document==o)i("No document found");else return a(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",p,!1),a(window,"addEventListener")?window.addEventListener("load",p,!1):a(window,"attachEvent")?window.attachEvent("onload",
p):i("Window does not have required addEventListener or attachEvent method"),x}();
...
null}};o.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+k(this.node)+":"+this.offset+")]"}};n.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};n.prototype.toString=function(){return this.message};a.dom={arrayContains:q,isHtmlNamespace:function(a){var b;return typeof a.namespaceURI==m||null===(b=a.namespaceURI)||"http://www.w3.org/1999/xhtml"==
...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(a){return r.isHostObject(a,"body")?a.body:a.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var b;b=a.parentNode;)a=b;return a},comparePoints:function(a,b,c,k){var f;if(a==c)return b===k?0:b<k?-1:1;if(f=g(c,a,!0))return b<=d(f)?-1:1;if(f=g(a,c,!0))return d(f)<k?-1:1;b=e(a,c);a=a===b?b:g(a,b,!0);c=c===b?b:g(c,b,!0);if(a===c)throw Error("comparePoints got to case 4 and childA and childB are the same!");
for(b=b.firstChild;b;){if(b===a)return-1;if(b===c)return 1;b=b.nextSibling}throw Error("Should not be here!");},inspectNode:k,fragmentFromNodeChildren:function(a){for(var c=b(a).createDocumentFragment(),d;d=a.firstChild;)c.appendChild(d);return c},createIterator:function(a){return new l(a)},DomPosition:o};a.DOMException=n});
rangy.createModule("DomRange",function(a){function c(a,b){return 3!=a.nodeType&&(t.isAncestorOf(a,b.startContainer,!0)||t.isAncestorOf(a,b.endContainer,!0))}function d(a){return t.getDocument(a.startContainer)}function e(a,b,c){if(b=a._listeners[b])for(var j=0,d=b.length;j<d;++j)b[j].call(a,{target:a,args:c})}function g(a){return new H(a.parentNode,t.getNodeIndex(a))}function i(a){return new H(a.parentNode,t.getNodeIndex(a)+1)}function f(a,b,c){var j=11==a.nodeType?a.firstChild:a;t.isCharacterDataNode(b)?
c==b.length?t.insertAfter(a,b):b.parentNode.insertBefore(a,0==c?b:t.splitDataNode(b,c)):c>=b.childNodes.length?b.appendChild(a):b.insertBefore(a,b.childNodes[c]);return j}function b(a){for(var c,j,h=d(a.range).createDocumentFragment();j=a.next();){c=a.isPartiallySelectedSubtree();j=j.cloneNode(!c);c&&(c=a.getSubtreeIterator(),j.appendChild(b(c)),c.detach(!0));if(10==j.nodeType)throw new E("HIERARCHY_REQUEST_ERR");h.appendChild(j)}return h}function k(a,b,c){for(var j,d,c=c||{stop:!1};j=a.next();)if(a.isPartiallySelectedSubtree())if(!1===
b(j)){c.stop=!0;break}else{if(j=a.getSubtreeIterator(),k(j,b,c),j.detach(!0),c.stop)break}else for(j=t.createIterator(j);d=j.next();)if(!1===b(d)){c.stop=!0;return}}function l(a){for(var b;a.next();)a.isPartiallySelectedSubtree()?(b=a.getSubtreeIterator(),l(b),b.detach(!0)):a.remove()}function o(a){for(var b,c=d(a.range).createDocumentFragment(),j;b=a.next();){a.isPartiallySelectedSubtree()?(b=b.cloneNode(!1),j=a.getSubtreeIterator(),b.appendChild(o(j)),j.detach(!0)):a.remove();if(10==b.nodeType)throw new E("HIERARCHY_REQUEST_ERR");
c.appendChild(b)}return c}function n(a,b,c){var j=!(!b||!b.length),d,h=!!c;j&&(d=RegExp("^("+b.join("|")+")$"));var g=[];k(new r(a,!1),function(a){(!j||d.test(a.nodeType))&&(!h||c(a))&&g.push(a)});return g}function m(a){return"["+("undefined"==typeof a.getName?"Range":a.getName())+"("+t.inspectNode(a.startContainer)+":"+a.startOffset+", "+t.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function r(a,b){this.range=a;this.clonePartiallySelectedTextNodes=b;if(!a.collapsed){this.sc=a.startContainer;
...
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function q(a,b,c){this.nodes=n(a,b,c);this._next=this.nodes[0];this._position=0}function p(a){return function(b,c){for(var j,d=c?b:b.parentNode;d;){j=d.nodeType;if(t.arrayContains(a,j))return d;d=d.parentNode}return null}}function z(a,b){if(v(a,b))throw new s("INVALID_NODE_TYPE_ERR");}function x(a){if(!a.startContainer)throw new E("INVALID_STATE_ERR");}function y(a,b){if(!t.arrayContains(b,a.nodeType))throw new s("INVALID_NODE_TYPE_ERR");
}function D(a,b){if(0>b||b>(t.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new E("INDEX_SIZE_ERR");}function A(a,b){if(j(a,!0)!==j(b,!0))throw new E("WRONG_DOCUMENT_ERR");}function B(a){if(u(a,!0))throw new E("NO_MODIFICATION_ALLOWED_ERR");}function F(a,b){if(!a)throw new E(b);}function O(a){return!!a.startContainer&&!!a.endContainer&&!(!t.arrayContains(I,a.startContainer.nodeType)&&!j(a.startContainer,!0))&&!(!t.arrayContains(I,a.endContainer.nodeType)&&!j(a.endContainer,!0))&&a.startOffset<=
(t.isCharacterDataNode(a.startContainer)?a.startContainer.length:a.startContainer.childNodes.length)&&a.endOffset<=(t.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)}function C(a){x(a);if(!O(a))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function w(){}function R(a){a.START_TO_START=Y;a.START_TO_END=ja;a.END_TO_END=va;a.END_TO_START=ma;a.NODE_BEFORE=ka;a.NODE_AFTER=na;a.NODE_BEFORE_AND_AFTER=oa;a.NODE_INSIDE=
la}function G(a){R(a);R(a.prototype)}function h(a,b){return function(){C(this);var c=this.startContainer,j=this.startOffset,d=this.commonAncestorContainer,h=new r(this,!0);c!==d&&(c=t.getClosestAncestorIn(c,d,!0),j=i(c),c=j.node,j=j.offset);k(h,B);h.reset();d=a(h);h.detach();b(this,c,j,c,j);return d}}function S(b,j,d){function e(a,b){return function(c){x(this);y(c,N);y(Q(c),I);c=(a?g:i)(c);(b?k:f)(this,c.node,c.offset)}}function k(a,b,c){var d=a.endContainer,h=a.endOffset;if(b!==a.startContainer||
c!==a.startOffset){if(Q(b)!=Q(d)||1==t.comparePoints(b,c,d,h))d=b,h=c;j(a,b,c,d,h)}}function f(a,b,c){var d=a.startContainer,h=a.startOffset;if(b!==a.endContainer||c!==a.endOffset){if(Q(b)!=Q(d)||-1==t.comparePoints(b,c,d,h))d=b,h=c;j(a,d,h,b,c)}}b.prototype=new w;a.util.extend(b.prototype,{setStart:function(a,b){x(this);z(a,!0);D(a,b);k(this,a,b)},setEnd:function(a,b){x(this);z(a,!0);D(a,b);f(this,a,b)},setStartBefore:e(!0,!0),setStartAfter:e(!1,!0),setEndBefore:e(!0,!1),setEndAfter:e(!1,!1),collapse:function(a){C(this);
a?j(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):j(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){x(this);z(a,!0);j(this,a,0,a,t.getNodeLength(a))},selectNode:function(a){x(this);z(a,!1);y(a,N);var b=g(a),a=i(a);j(this,b.node,b.offset,a.node,a.offset)},extractContents:h(o,j),deleteContents:h(l,j),canSurroundContents:function(){C(this);B(this.startContainer);B(this.endContainer);var a=new r(this,!0),b=a._first&&
c(a._first,this)||a._last&&c(a._last,this);a.detach();return!b},detach:function(){d(this)},splitBoundaries:function(){C(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,d=this.endOffset,h=a===c;t.isCharacterDataNode(c)&&0<d&&d<c.length&&t.splitDataNode(c,d);t.isCharacterDataNode(a)&&0<b&&b<a.length&&(a=t.splitDataNode(a,b),h?(d-=b,c=a):c==a.parentNode&&d>=t.getNodeIndex(a)&&d++,b=0);j(this,a,b,c,d)},normalizeBoundaries:function(){C(this);var a=this.startContainer,b=this.startOffset,
c=this.endContainer,d=this.endOffset,h=function(a){var b=a.nextSibling;b&&b.nodeType==a.nodeType&&(c=a,d=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},g=function(j){var h=j.previousSibling;if(h&&h.nodeType==j.nodeType){a=j;var g=j.length;b=h.length;j.insertData(0,h.data);h.parentNode.removeChild(h);a==c?(d+=b,c=a):c==j.parentNode&&(h=t.getNodeIndex(j),d==h?(c=j,d=g):d>h&&d--)}},e=!0;t.isCharacterDataNode(c)?c.length==d&&h(c):(0<d&&(e=c.childNodes[d-1])&&t.isCharacterDataNode(e)&&h(e),
e=!this.collapsed);e?t.isCharacterDataNode(a)?0==b&&g(a):b<a.childNodes.length&&(h=a.childNodes[b])&&t.isCharacterDataNode(h)&&g(h):(a=c,b=d);j(this,a,b,c,d)},collapseToPoint:function(a,b){x(this);z(a,!0);D(a,b);(a!==this.startContainer||b!==this.startOffset||a!==this.endContainer||b!==this.endOffset)&&j(this,a,b,a,b)}});G(b)}function M(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:t.getCommonAncestor(a.startContainer,
a.endContainer)}function V(a,b,c,j,d){var h=a.startContainer!==b||a.startOffset!==c,g=a.endContainer!==j||a.endOffset!==d;a.startContainer=b;a.startOffset=c;a.endContainer=j;a.endOffset=d;M(a);e(a,"boundarychange",{startMoved:h,endMoved:g})}function L(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};M(this)}a.requireModules(["DomUtil"]);var t=a.dom,H=t.DomPosition,E=a.DOMException;r.prototype={_current:null,_next:null,_first:null,
...
(a===this.sc||a===this.ec)?(b=a===this.sc?this.so:0,c=a===this.ec?this.eo:a.length,b!=c&&a.deleteData(b,c-b)):a.parentNode&&a.parentNode.removeChild(a)},isPartiallySelectedSubtree:function(){return c(this._current,this.range)},getSubtreeIterator:function(){var a;if(this.isSingleCharacterDataNode)a=this.range.cloneRange(),a.collapse();else{a=new L(d(this.range));var b=this._current,c=b,j=0,h=b,g=t.getNodeLength(b);t.isAncestorOf(b,this.sc,!0)&&(c=this.sc,j=this.so);t.isAncestorOf(b,this.ec,!0)&&(h=
this.ec,g=this.eo);V(a,c,j,h,g)}return new r(a,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=null}};s.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};s.prototype.toString=function(){return this.message};q.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},
detach:function(){this._current=this._next=this.nodes=null}};var N=[1,3,4,5,7,8,10],I=[2,9,11],T=[1,3,4,5,7,8,10,11],X=[1,3,4,5,7,8],Q=t.getRootContainer,j=p([9,11]),u=p([5,6,10,12]),v=p([6,10,12]),J=document.createElement("style"),P=!1;try{J.innerHTML="<b>x</b>",P=3==J.firstChild.nodeType}catch(U){}a.features.htmlParsingConforms=P;var $="startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer".split(","),Y=0,ja=1,va=2,ma=3,ka=0,na=1,oa=2,la=3;w.prototype={attachListener:function(a,
b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){C(this);A(this.startContainer,b.startContainer);var c=a==ma||a==Y?"start":"end",j=a==ja||a==Y?"start":"end";return t.comparePoints(this[c+"Container"],this[c+"Offset"],b[j+"Container"],b[j+"Offset"])},insertNode:function(a){C(this);y(a,T);B(this.startContainer);if(t.isAncestorOf(a,this.startContainer,!0))throw new E("HIERARCHY_REQUEST_ERR");this.setStartBefore(f(a,this.startContainer,this.startOffset))},cloneContents:function(){C(this);
var a,c;if(this.collapsed)return d(this).createDocumentFragment();if(this.startContainer===this.endContainer&&t.isCharacterDataNode(this.startContainer))return a=this.startContainer.cloneNode(!0),a.data=a.data.slice(this.startOffset,this.endOffset),c=d(this).createDocumentFragment(),c.appendChild(a),c;c=new r(this,!0);a=b(c);c.detach();return a},canSurroundContents:function(){C(this);B(this.startContainer);B(this.endContainer);var a=new r(this,!0),b=a._first&&c(a._first,this)||a._last&&c(a._last,
this);a.detach();return!b},surroundContents:function(a){y(a,X);if(!this.canSurroundContents())throw new s("BAD_BOUNDARYPOINTS_ERR");var b=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);f(a,this.startContainer,this.startOffset);a.appendChild(b);this.selectNode(a)},cloneRange:function(){C(this);for(var a=new L(d(this)),b=$.length,c;b--;)c=$[b],a[c]=this[c];return a},toString:function(){C(this);var a=this.startContainer;if(a===this.endContainer&&t.isCharacterDataNode(a))return 3==
a.nodeType||4==a.nodeType?a.data.slice(this.startOffset,this.endOffset):"";var b=[],a=new r(this,!0);k(a,function(a){(3==a.nodeType||4==a.nodeType)&&b.push(a.data)});a.detach();return b.join("")},compareNode:function(a){C(this);var b=a.parentNode,c=t.getNodeIndex(a);if(!b)throw new E("NOT_FOUND_ERR");a=this.comparePoint(b,c);b=this.comparePoint(b,c+1);return 0>a?0<b?oa:ka:0<b?na:la},comparePoint:function(a,b){C(this);F(a,"HIERARCHY_REQUEST_ERR");A(a,this.startContainer);return 0>t.comparePoints(a,
b,this.startContainer,this.startOffset)?-1:0<t.comparePoints(a,b,this.endContainer,this.endOffset)?1:0},createContextualFragment:P?function(a){var b=this.startContainer,c=t.getDocument(b);if(!b)throw new E("INVALID_STATE_ERR");var j=null;1==b.nodeType?j=b:t.isCharacterDataNode(b)&&(j=t.parentElement(b));j=null===j||"HTML"==j.nodeName&&t.isHtmlNamespace(t.getDocument(j).documentElement)&&t.isHtmlNamespace(j)?c.createElement("body"):j.cloneNode(!1);j.innerHTML=a;return t.fragmentFromNodeChildren(j)}:
function(a){x(this);var b=d(this).createElement("body");b.innerHTML=a;return t.fragmentFromNodeChildren(b)},toHtml:function(){C(this);var a=d(this).createElement("div");a.appendChild(this.cloneContents());return a.innerHTML},intersectsNode:function(a,b){C(this);F(a,"NOT_FOUND_ERR");if(t.getDocument(a)!==d(this))return!1;var c=a.parentNode,j=t.getNodeIndex(a);F(c,"NOT_FOUND_ERR");var h=t.comparePoints(c,j,this.endContainer,this.endOffset),c=t.comparePoints(c,j+1,this.startContainer,this.startOffset);
return b?0>=h&&0<=c:0>h&&0<c},isPointInRange:function(a,b){C(this);F(a,"HIERARCHY_REQUEST_ERR");A(a,this.startContainer);return 0<=t.comparePoints(a,b,this.startContainer,this.startOffset)&&0>=t.comparePoints(a,b,this.endContainer,this.endOffset)},intersectsRange:function(a,b){C(this);if(d(a)!=d(this))throw new E("WRONG_DOCUMENT_ERR");var c=t.comparePoints(this.startContainer,this.startOffset,a.endContainer,a.endOffset),j=t.comparePoints(this.endContainer,this.endOffset,a.startContainer,a.startOffset);
return b?0>=c&&0<=j:0>c&&0<j},intersection:function(a){if(this.intersectsRange(a)){var b=t.comparePoints(this.startContainer,this.startOffset,a.startContainer,a.startOffset),c=t.comparePoints(this.endContainer,this.endOffset,a.endContainer,a.endOffset),j=this.cloneRange();-1==b&&j.setStart(a.startContainer,a.startOffset);1==c&&j.setEnd(a.endContainer,a.endOffset);return j}return null},union:function(a){if(this.intersectsRange(a,!0)){var b=this.cloneRange();-1==t.comparePoints(a.startContainer,a.startOffset,
this.startContainer,this.startOffset)&&b.setStart(a.startContainer,a.startOffset);1==t.comparePoints(a.endContainer,a.endOffset,this.endContainer,this.endOffset)&&b.setEnd(a.endContainer,a.endOffset);return b}throw new s("Ranges do not intersect");},containsNode:function(a,b){return b?this.intersectsNode(a,!1):this.compareNode(a)==la},containsNodeContents:function(a){return 0<=this.comparePoint(a,0)&&0>=this.comparePoint(a,t.getNodeLength(a))},containsRange:function(a){return this.intersection(a).equals(a)},
containsNodeText:function(a){var b=this.cloneRange();b.selectNode(a);var c=b.getNodes([3]);return 0<c.length?(b.setStart(c[0],0),a=c.pop(),b.setEnd(a,a.length),a=this.containsRange(b),b.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){C(this);return new q(this,a,b)},getNodes:function(a,b){C(this);return n(this,a,b)},getDocument:function(){return d(this)},collapseBefore:function(a){x(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){x(this);this.setStartAfter(a);
this.collapse(!0)},getName:function(){return"DomRange"},equals:function(a){return L.rangesEqual(this,a)},isValid:function(){return O(this)},inspect:function(){return m(this)}};S(L,V,function(a){x(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;e(a,"detach",null);a._listeners=null});a.rangePrototype=w.prototype;L.rangeProperties=$;L.RangeIterator=r;L.copyComparisonConstants=G;L.createPrototypeRange=S;L.inspect=m;L.getRangeDocument=d;L.rangesEqual=
function(a,b){return a.startContainer===b.startContainer&&a.startOffset===b.startOffset&&a.endContainer===b.endContainer&&a.endOffset===b.endOffset};a.DomRange=L;a.RangeException=s});
rangy.createModule("WrappedRange",function(a){function c(a,b,c,d){var e=a.duplicate();e.collapse(c);var f=e.parentElement();g.isAncestorOf(b,f,!0)||(f=b);if(!f.canHaveHTML)return new i(f.parentNode,g.getNodeIndex(f));var b=g.getDocument(f).createElement("span"),s,q=c?"StartToStart":"StartToEnd";do f.insertBefore(b,b.previousSibling),e.moveToElementText(b);while(0<(s=e.compareEndPoints(q,a))&&b.previousSibling);q=b.nextSibling;if(-1==s&&q&&g.isCharacterDataNode(q)){e.setEndPoint(c?"EndToStart":"EndToEnd",
a);if(/[\r\n]/.test(q.data)){f=e.duplicate();c=f.text.replace(/\r\n/g,"\r").length;for(c=f.moveStart("character",c);-1==f.compareEndPoints("StartToEnd",f);)c++,f.moveStart("character",1)}else c=e.text.length;f=new i(q,c)}else q=(d||!c)&&b.previousSibling,f=(c=(d||c)&&b.nextSibling)&&g.isCharacterDataNode(c)?new i(c,0):q&&g.isCharacterDataNode(q)?new i(q,q.length):new i(f,g.getNodeIndex(b));b.parentNode.removeChild(b);return f}function d(a,b){var c,d,e=a.offset,f=g.getDocument(a.node),i=f.body.createTextRange(),
q=g.isCharacterDataNode(a.node);q?(c=a.node,d=c.parentNode):(c=a.node.childNodes,c=e<c.length?c[e]:null,d=a.node);f=f.createElement("span");f.innerHTML="&#feff;";c?d.insertBefore(f,c):d.appendChild(f);i.moveToElementText(f);i.collapse(!b);d.removeChild(f);if(q)i[b?"moveStart":"moveEnd"]("character",e);return i}a.requireModules(["DomUtil","DomRange"]);var e,g=a.dom,i=g.DomPosition,f=a.DomRange;if(a.features.implementsDomRange&&(!a.features.implementsTextRange||!a.config.preferTextRange))(function(){function b(a){for(var c=
...
b=null})});
rangy.createModule("WrappedSelection",function(a,c){function d(a){return(a||window).getSelection()}function e(a){return(a||window).document.selection}function g(a,b,c){var d=c?"end":"start",c=c?"start":"end";a.anchorNode=b[d+"Container"];a.anchorOffset=b[d+"Offset"];a.focusNode=b[c+"Container"];a.focusOffset=b[c+"Offset"]}function i(a){a.anchorNode=a.focusNode=null;a.anchorOffset=a.focusOffset=0;a.rangeCount=0;a.isCollapsed=!0;a._ranges.length=0}function f(b){var c;b instanceof z?(c=b._selectionNativeRange,c||
(c=a.createNativeRange(q.getDocument(b.startContainer)),c.setEnd(b.endContainer,b.endOffset),c.setStart(b.startContainer,b.startOffset),b._selectionNativeRange=c,b.attachListener("detach",function(){this._selectionNativeRange=null}))):b instanceof x?c=b.nativeRange:a.features.implementsDomRange&&b instanceof q.getWindow(b.startContainer).Range&&(c=b);return c}function b(a){var b=a.getNodes(),c;a:if(!b.length||1!=b[0].nodeType)c=!1;else{c=1;for(var d=b.length;c<d;++c)if(!q.isAncestorOf(b[0],b[c])){c=
!1;break a}c=!0}if(!c)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function k(a,b){var c=new x(b);a._ranges=[c];g(a,c,!1);a.rangeCount=1;a.isCollapsed=c.collapsed}function l(b){b._ranges.length=0;if("None"==b.docSelection.type)i(b);else{var c=b.docSelection.createRange();if(c&&"undefined"!=typeof c.text)k(b,c);else{b.rangeCount=c.length;for(var d,h=q.getDocument(c.item(0)),e=0;e<b.rangeCount;++e)d=a.createRange(h),d.selectNode(c.item(e)),
b._ranges.push(d);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;g(b,b._ranges[b.rangeCount-1],!1)}}}function o(a,c){for(var d=a.docSelection.createRange(),h=b(c),g=q.getDocument(d.item(0)),g=q.getBody(g).createControlRange(),e=0,f=d.length;e<f;++e)g.add(d.item(e));try{g.add(h)}catch(i){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}g.select();l(a)}function n(a,b,c){this.nativeSelection=a;this.docSelection=b;this._ranges=
[];this.win=c;this.refresh()}function m(a,c){for(var d=q.getDocument(c[0].startContainer),d=q.getBody(d).createControlRange(),h=0,g;h<rangeCount;++h){g=b(c[h]);try{d.add(g)}catch(e){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();l(a)}function r(a,b){if(a.anchorNode&&q.getDocument(a.anchorNode)!==q.getDocument(b))throw new y("WRONG_DOCUMENT_ERR");}function s(a){var b=[],c=new D(a.anchorNode,a.anchorOffset),
d=new D(a.focusNode,a.focusOffset),h="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var g=0,e=a.rangeCount;g<e;++g)b[g]=z.inspect(a.getRangeAt(g));return"["+h+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var q=a.dom,p=a.util,z=a.DomRange,x=a.WrappedRange,y=a.DOMException,D=q.DomPosition,A,B,F=a.util.isHostMethod(window,"getSelection"),
O=a.util.isHostObject(document,"selection"),C=O&&(!F||a.config.preferTextRange);C?(A=e,a.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return"None"!=b.type||q.getDocument(b.createRange().parentElement())==a}):F?(A=d,a.isSelectionValid=function(){return!0}):c.fail("Neither document.selection or window.getSelection() detected.");a.getNativeSelection=A;var F=A(),w=a.createNativeRange(document),R=q.getBody(document),G=p.areHostObjects(F,p.areHostProperties(F,["anchorOffset","focusOffset"]));
a.features.selectionHasAnchorAndFocus=G;var h=p.isHostMethod(F,"extend");a.features.selectionHasExtend=h;var S="number"==typeof F.rangeCount;a.features.selectionHasRangeCount=S;var M=!1,V=!0;p.areHostMethods(F,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof F.rangeCount&&a.features.implementsDomRange&&function(){var a=document.createElement("iframe");a.frameBorder=0;a.style.position="absolute";a.style.left="-10000px";R.appendChild(a);var b=q.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");
b.close();var c=q.getIframeWindow(a).getSelection(),d=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(d,1);b.collapse(true);c.addRange(b);V=c.rangeCount==1;c.removeAllRanges();var h=b.cloneRange();b.setStart(d,0);h.setEnd(d,2);c.addRange(b);c.addRange(h);M=c.rangeCount==2;b.detach();h.detach();R.removeChild(a)}();a.features.selectionSupportsMultipleRanges=M;a.features.collapsedNonEditableSelectionsSupported=V;var L=!1,t;R&&p.isHostMethod(R,"createControlRange")&&(t=R.createControlRange(),
p.areHostProperties(t,["item","add"])&&(L=!0));a.features.implementsControlRange=L;B=G?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:false};var H;p.isHostMethod(F,"getRangeAt")?H=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:G&&(H=function(b){var c=q.getDocument(b.anchorNode),c=a.createRange(c);c.setStart(b.anchorNode,b.anchorOffset);c.setEnd(b.focusNode,b.focusOffset);if(c.collapsed!==
this.isCollapsed){c.setStart(b.focusNode,b.focusOffset);c.setEnd(b.anchorNode,b.anchorOffset)}return c});a.getSelection=function(a){var a=a||window,b=a._rangySelection,c=A(a),d=O?e(a):null;if(b){b.nativeSelection=c;b.docSelection=d;b.refresh(a)}else{b=new n(c,d,a);a._rangySelection=b}return b};a.getIframeSelection=function(b){return a.getSelection(q.getIframeWindow(b))};t=n.prototype;if(!C&&G&&p.areHostMethods(F,["removeAllRanges","addRange"])){t.removeAllRanges=function(){this.nativeSelection.removeAllRanges();
i(this)};var E=function(b,c){var d=z.getRangeDocument(c),d=a.createRange(d);d.collapseToPoint(c.endContainer,c.endOffset);b.nativeSelection.addRange(f(d));b.nativeSelection.extend(c.startContainer,c.startOffset);b.refresh()};t.addRange=S?function(b,c){if(L&&O&&this.docSelection.type=="Control")o(this,b);else if(c&&h)E(this,b);else{var d;if(M)d=this.rangeCount;else{this.removeAllRanges();d=0}this.nativeSelection.addRange(f(b));this.rangeCount=this.nativeSelection.rangeCount;if(this.rangeCount==d+1){if(a.config.checkSelectionRanges)(d=
H(this.nativeSelection,this.rangeCount-1))&&!z.rangesEqual(d,b)&&(b=new x(d));this._ranges[this.rangeCount-1]=b;g(this,b,T(this.nativeSelection));this.isCollapsed=B(this)}else this.refresh()}}:function(a,b){if(b&&h)E(this,a);else{this.nativeSelection.addRange(f(a));this.refresh()}};t.setRanges=function(a){if(L&&a.length>1)m(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(p.isHostMethod(F,"empty")&&p.isHostMethod(w,"select")&&L&&C)t.removeAllRanges=
function(){try{this.docSelection.empty();if(this.docSelection.type!="None"){var a;if(this.anchorNode)a=q.getDocument(this.anchorNode);else if(this.docSelection.type=="Control"){var b=this.docSelection.createRange();b.length&&(a=q.getDocument(b.item(0)).body.createTextRange())}if(a){a.body.createTextRange().select();this.docSelection.empty()}}}catch(c){}i(this)},t.addRange=function(a){if(this.docSelection.type=="Control")o(this,a);else{x.rangeToTextRange(a).select();this._ranges[0]=a;this.rangeCount=
1;this.isCollapsed=this._ranges[0].collapsed;g(this,a,false)}},t.setRanges=function(a){this.removeAllRanges();var b=a.length;b>1?m(this,a):b&&this.addRange(a[0])};else return c.fail("No means of selecting a Range or TextRange was found"),!1;t.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new y("INDEX_SIZE_ERR");return this._ranges[a]};var N;if(C)N=function(b){var c;if(a.isSelectionValid(b.win))c=b.docSelection.createRange();else{c=q.getBody(b.win.document).createTextRange();c.collapse(true)}b.docSelection.type==
"Control"?l(b):c&&typeof c.text!="undefined"?k(b,c):i(b)};else if(p.isHostMethod(F,"getRangeAt")&&"number"==typeof F.rangeCount)N=function(b){if(L&&O&&b.docSelection.type=="Control")l(b);else{b._ranges.length=b.rangeCount=b.nativeSelection.rangeCount;if(b.rangeCount){for(var c=0,d=b.rangeCount;c<d;++c)b._ranges[c]=new a.WrappedRange(b.nativeSelection.getRangeAt(c));g(b,b._ranges[b.rangeCount-1],T(b.nativeSelection));b.isCollapsed=B(b)}else i(b)}};else if(G&&"boolean"==typeof F.isCollapsed&&"boolean"==
typeof w.collapsed&&a.features.implementsDomRange)N=function(a){var b;b=a.nativeSelection;if(b.anchorNode){b=H(b,0);a._ranges=[b];a.rangeCount=1;b=a.nativeSelection;a.anchorNode=b.anchorNode;a.anchorOffset=b.anchorOffset;a.focusNode=b.focusNode;a.focusOffset=b.focusOffset;a.isCollapsed=B(a)}else i(a)};else return c.fail("No means of obtaining a Range or TextRange from the user's selection was found"),!1;t.refresh=function(a){var b=a?this._ranges.slice(0):null;N(this);if(a){a=b.length;if(a!=this._ranges.length)return false;
for(;a--;)if(!z.rangesEqual(b[a],this._ranges[a]))return false;return true}};var I=function(a,b){var c=a.getAllRanges(),d=false;a.removeAllRanges();for(var h=0,g=c.length;h<g;++h)d||b!==c[h]?a.addRange(c[h]):d=true;a.rangeCount||i(a)};t.removeRange=L?function(a){if(this.docSelection.type=="Control"){for(var c=this.docSelection.createRange(),a=b(a),d=q.getDocument(c.item(0)),d=q.getBody(d).createControlRange(),h,g=false,e=0,f=c.length;e<f;++e){h=c.item(e);h!==a||g?d.add(c.item(e)):g=true}d.select();
l(this)}else I(this,a)}:function(a){I(this,a)};var T;!C&&G&&a.features.implementsDomRange?(T=function(a){var b=false;a.anchorNode&&(b=q.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset)==1);return b},t.isBackwards=function(){return T(this)}):T=t.isBackwards=function(){return false};t.toString=function(){for(var a=[],b=0,c=this.rangeCount;b<c;++b)a[b]=""+this._ranges[b];return a.join("")};t.collapse=function(b,c){r(this,b);var d=a.createRange(q.getDocument(b));d.collapseToPoint(b,
c);this.removeAllRanges();this.addRange(d);this.isCollapsed=true};t.collapseToStart=function(){if(this.rangeCount){var a=this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new y("INVALID_STATE_ERR");};t.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new y("INVALID_STATE_ERR");};t.selectAllChildren=function(b){r(this,b);var c=a.createRange(q.getDocument(b));c.selectNodeContents(b);this.removeAllRanges();
this.addRange(c)};t.deleteFromDocument=function(){if(L&&O&&this.docSelection.type=="Control"){for(var a=this.docSelection.createRange(),b;a.length;){b=a.item(0);a.remove(b);b.parentNode.removeChild(b)}this.refresh()}else if(this.rangeCount){a=this.getAllRanges();this.removeAllRanges();b=0;for(var c=a.length;b<c;++b)a[b].deleteContents();this.addRange(a[c-1])}};t.getAllRanges=function(){return this._ranges.slice(0)};t.setSingleRange=function(a){this.setRanges([a])};t.containsNode=function(a,b){for(var c=
0,d=this._ranges.length;c<d;++c)if(this._ranges[c].containsNode(a,b))return true;return false};t.toHtml=function(){var a="";if(this.rangeCount){for(var a=z.getRangeDocument(this._ranges[0]).createElement("div"),b=0,c=this._ranges.length;b<c;++b)a.appendChild(this._ranges[b].cloneContents());a=a.innerHTML}return a};t.getName=function(){return"WrappedSelection"};t.inspect=function(){return s(this)};t.detach=function(){this.win=this.anchorNode=this.focusNode=this.win._rangySelection=null};n.inspect=
s;a.Selection=n;a.selectionPrototype=t;a.addCreateMissingNativeApiListener(function(b){if(typeof b.getSelection=="undefined")b.getSelection=function(){return a.getSelection(this)};b=null})});
...
d=d?d.toString():"";c.detach();return""!=d}function k(a){return a.getNodes([3],function(c){return b(a,c)})}function l(a,b){if(a.attributes.length!=b.attributes.length)return!1;for(var c=0,d=a.attributes.length,g,e;c<d;++c)if(g=a.attributes[c],e=g.name,"class"!=e&&(e=b.attributes.getNamedItem(e),g.specified!=e.specified||g.specified&&g.nodeValue!==e.nodeValue))return!1;return!0}function o(a,b){for(var c=0,d=a.attributes.length,g;c<d;++c)if(g=a.attributes[c].name,(!b||!y.arrayContains(b,g))&&a.attributes[c].specified&&
"class"!=g)return!0;return!1}function n(a){var b;return a&&1==a.nodeType&&((b=a.parentNode)&&9==b.nodeType&&"on"==b.designMode||B(a)&&!B(a.parentNode))}function m(a){return(B(a)||1!=a.nodeType&&B(a.parentNode))&&!n(a)}function r(a){return a&&1==a.nodeType&&!F.test(A(a,"display"))}function s(a){if(0==a.data.length)return!0;if(O.test(a.data))return!1;switch(A(a.parentNode,"whiteSpace")){case "pre":case "pre-wrap":case "-moz-pre-wrap":return!1;case "pre-line":if(/[\r\n]/.test(a.data))return!1}return r(a.previousSibling)||
r(a.nextSibling)}function q(a,b,d,g){var e,f=0==d;if(y.isAncestorOf(b,a))return a;if(y.isCharacterDataNode(b))if(0==d)d=y.getNodeIndex(b),b=b.parentNode;else if(d==b.length)d=y.getNodeIndex(b)+1,b=b.parentNode;else throw c.createError("splitNodeAt should not be called with offset in the middle of a data node ("+d+" in "+b.data);if(y.isCharacterDataNode(b)?0==d?b.previousSibling:d==b.length?b.nextSibling:1:0<d&&d<b.childNodes.length){if(!e){e=b.cloneNode(!1);for(e.id&&e.removeAttribute("id");f=b.childNodes[d];)e.appendChild(f);
y.insertAfter(e,b)}return b==a?e:q(a,e.parentNode,y.getNodeIndex(e),g)}return a!=b?(e=b.parentNode,b=y.getNodeIndex(b),f||b++,q(a,e,b,g)):a}function p(a){var b=a?"nextSibling":"previousSibling";return function(c,d){var g=c.parentNode,e=c[b];if(e){if(e&&3==e.nodeType)return e}else if(d&&(e=g[b])&&1==e.nodeType&&g.tagName==e.tagName&&i(g,e)&&l(g,e))return e[a?"firstChild":"lastChild"];return null}}function z(a){this.firstTextNode=(this.isElementMerge=1==a.nodeType)?a.lastChild:a;this.textNodes=[this.firstTextNode]}
function x(a,b,c){this.cssClass=a;var d,e,f=null;if("object"==typeof b&&null!==b){c=b.tagNames;f=b.elementProperties;for(d=0;e=R[d++];)b.hasOwnProperty(e)&&(this[e]=b[e]);d=b.normalize}else d=b;this.normalize="undefined"==typeof d?!0:d;this.attrExceptions=[];d=document.createElement(this.elementTagName);this.elementProperties={};for(var i in f)f.hasOwnProperty(i)&&(G.hasOwnProperty(i)&&(i=G[i]),d[i]=f[i],this.elementProperties[i]=d[i],this.attrExceptions.push(i));this.elementSortedClassName=this.elementProperties.hasOwnProperty("className")?
g(this.elementProperties.className+" "+a):a;this.applyToAnyTagName=!1;a=typeof c;if("string"==a)"*"==c?this.applyToAnyTagName=!0:this.tagNames=c.toLowerCase().replace(/^\s\s*/,"").replace(/\s\s*$/,"").split(/\s*,\s*/);else if("object"==a&&"number"==typeof c.length){this.tagNames=[];d=0;for(a=c.length;d<a;++d)"*"==c[d]?this.applyToAnyTagName=!0:this.tagNames.push(c[d].toLowerCase())}else this.tagNames=[this.elementTagName]}a.requireModules(["WrappedSelection","WrappedRange"]);var y=a.dom,D=function(){function a(b,
c,d){return c&&d?" ":""}return function(b,c){b.className&&(b.className=b.className.replace(RegExp("(?:^|\\s)"+c+"(?:\\s|$)"),a))}}(),A;"undefined"!=typeof window.getComputedStyle?A=function(a,b){return y.getWindow(a).getComputedStyle(a,null)[b]}:"undefined"!=typeof document.documentElement.currentStyle?A=function(a,b){return a.currentStyle[b]}:c.fail("No means of obtaining computed style properties found");var B;(function(){B="boolean"==typeof document.createElement("div").isContentEditable?function(a){return a&&
1==a.nodeType&&a.isContentEditable}:function(a){return!a||1!=a.nodeType||"false"==a.contentEditable?!1:"true"==a.contentEditable||B(a.parentNode)}})();var F=/^inline(-block|-table)?$/i,O=/[^\r\n\t\f \u200B]/,C=p(!1),w=p(!0);z.prototype={doMerge:function(){for(var a=[],b,c,d=0,e=this.textNodes.length;d<e;++d)b=this.textNodes[d],c=b.parentNode,a[d]=b.data,d&&(c.removeChild(b),c.hasChildNodes()||c.parentNode.removeChild(c));return this.firstTextNode.data=a=a.join("")},getLength:function(){for(var a=
this.textNodes.length,b=0;a--;)b+=this.textNodes[a].length;return b},toString:function(){for(var a=[],b=0,c=this.textNodes.length;b<c;++b)a[b]="'"+this.textNodes[b].data+"'";return"[Merge("+a.join(",")+")]"}};var R=["elementTagName","ignoreWhiteSpace","applyToEditableOnly"],G={"class":"className"};x.prototype={elementTagName:"span",elementProperties:{},ignoreWhiteSpace:!0,applyToEditableOnly:!1,hasClass:function(a){return 1==a.nodeType&&y.arrayContains(this.tagNames,a.tagName.toLowerCase())&&d(a,
this.cssClass)},getSelfOrAncestorWithClass:function(a){for(;a;){if(this.hasClass(a,this.cssClass))return a;a=a.parentNode}return null},isModifiable:function(a){return!this.applyToEditableOnly||m(a)},isIgnorableWhiteSpaceNode:function(a){return this.ignoreWhiteSpace&&a&&3==a.nodeType&&s(a)},postApply:function(a,b,c){for(var d=a[0],e=a[a.length-1],g=[],f,i=d,k=e,l=0,m=e.length,n,r,j=0,u=a.length;j<u;++j)if(n=a[j],r=C(n,!c)){if(f||(f=new z(r),g.push(f)),f.textNodes.push(n),n===d&&(i=f.firstTextNode,
l=i.length),n===e)k=f.firstTextNode,m=f.getLength()}else f=null;if(a=w(e,!c))f||(f=new z(e),g.push(f)),f.textNodes.push(a);if(g.length){j=0;for(u=g.length;j<u;++j)g[j].doMerge();b.setStart(i,l);b.setEnd(k,m)}},createContainer:function(b){b=b.createElement(this.elementTagName);a.util.extend(b,this.elementProperties);e(b,this.cssClass);return b},applyToTextNode:function(a){var b=a.parentNode;1==b.childNodes.length&&y.arrayContains(this.tagNames,b.tagName.toLowerCase())?e(b,this.cssClass):(b=this.createContainer(y.getDocument(a)),
...
return!0},isAppliedToSelection:function(b){for(var b=a.getSelection(b||window).getAllRanges(),c=b.length;c--;)if(!this.isAppliedToRange(b[c]))return!1;return!0},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)},toggleSelection:function(a){this.isAppliedToSelection(a)?this.undoToSelection(a):this.applyToSelection(a)},detach:function(){}};x.util={hasClass:d,addClass:e,removeClass:D,hasSameClasses:i,replaceWithOwnChildren:f,elementsHaveSameNonClassAttributes:l,
elementHasNonClassAttributes:o,splitNodeAt:q,isEditableElement:B,isEditingHost:n,isEditable:m};a.CssClassApplier=x;a.createCssClassApplier=function(a,b,c){return new x(a,b,c)}});
...
c.warn("Marker element has been removed. Cannot restore selection.")}function g(a,b){return b.compareBoundaryPoints(a.START_TO_START,a)}function i(a,b){var c=(a||document).getElementById(b);c&&c.parentNode.removeChild(c)}a.requireModules(["DomUtil","DomRange","WrappedRange"]);var f=a.dom,b="\ufeff";a.saveSelection=function(b){var b=b||window,e=b.document;if(a.isSelectionValid(b)){var f=a.getSelection(b),i=f.getAllRanges(),m=[],r,s;i.sort(g);for(var q=0,p=i.length;q<p;++q)r=i[q],r.collapsed?(s=d(r,
!1),m.push({markerId:s.id,collapsed:!0})):(s=d(r,!1),r=d(r,!0),m[q]={startMarkerId:r.id,endMarkerId:s.id,collapsed:!1,backwards:1==i.length&&f.isBackwards()});for(q=p-1;0<=q;--q)r=i[q],r.collapsed?r.collapseBefore((e||document).getElementById(m[q].markerId)):(r.setEndBefore((e||document).getElementById(m[q].endMarkerId)),r.setStartAfter((e||document).getElementById(m[q].startMarkerId)));f.setRanges(i);return{win:b,doc:e,rangeInfos:m,restored:!1}}c.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
a.restoreSelection=function(b,d){if(!b.restored){for(var g=b.rangeInfos,f=a.getSelection(b.win),i=[],r=g.length,s=r-1,q,p;0<=s;--s){q=g[s];p=a.createRange(b.doc);if(q.collapsed)if(q=(b.doc||document).getElementById(q.markerId)){q.style.display="inline";var z=q.previousSibling;z&&3==z.nodeType?(q.parentNode.removeChild(q),p.collapseToPoint(z,z.length)):(p.collapseBefore(q),q.parentNode.removeChild(q))}else c.warn("Marker element has been removed. Cannot restore selection.");else e(b.doc,p,q.startMarkerId,
!0),e(b.doc,p,q.endMarkerId,!1);1==r&&p.normalizeBoundaries();i[s]=p}1==r&&d&&a.features.selectionHasExtend&&g[0].backwards?(f.removeAllRanges(),f.addRange(i[0],!0)):f.setRanges(i);b.restored=!0}};a.removeMarkerElement=i;a.removeMarkers=function(a){for(var b=a.rangeInfos,c=0,d=b.length,e;c<d;++c)e=b[c],e.collapsed?i(a.doc,e.markerId):(i(a.doc,e.startMarkerId),i(a.doc,e.endMarkerId))}});
rangy.createModule("Serializer",function(a,c){function d(a,b){var b=b||[],c=a.nodeType,e=a.childNodes,g=e.length,f=[c,a.nodeName,g].join(":"),i="",k="";switch(c){case 3:i=a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;");break;case 8:i="<\!--"+a.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;")+"--\>";break;default:i="<"+f+">",k="</>"}i&&b.push(i);for(c=0;c<g;++c)d(e[c],b);k&&b.push(k);return b}function e(a){a=d(a).join("");return n(a).toString(16)}function g(a,b,c){for(var d=[],e=a,c=c||m.getDocument(a).documentElement;e&&
...
(function(a,c){function d(a){var b=S[a]={},c,d,a=a.split(/\s+/);c=0;for(d=a.length;c<d;c++)b[a[c]]=!0;return b}function e(a,b,d){if(d===c&&1===a.nodeType)if(d="data-"+b.replace(L,"-$1").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:h.isNumeric(d)?+d:V.test(d)?h.parseJSON(d):d}catch(j){}h.data(a,b,d)}else d=c;return d}function g(a){for(var b in a)if(!("data"===b&&h.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function i(a,b,c){var d=
b+"defer",j=b+"queue",e=b+"mark",g=h._data(a,d);g&&("queue"===c||!h._data(a,j))&&("mark"===c||!h._data(a,e))&&setTimeout(function(){!h._data(a,j)&&!h._data(a,e)&&(h.removeData(a,d,!0),g.fire())},0)}function f(){return!1}function b(){return!0}function k(a,b,c){b=b||0;if(h.isFunction(b))return h.grep(a,function(a,d){return!!b.call(a,d,a)===c});if(b.nodeType)return h.grep(a,function(a){return a===b===c});if("string"===typeof b){var d=h.grep(a,function(a){return 1===a.nodeType});if(Wa.test(b))return h.filter(b,
d,!c);b=h.filter(b,d)}return h.grep(a,function(a){return 0<=h.inArray(a,b)===c})}function l(a){var b=Fa.split("|"),a=a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());return a}function o(a,b){if(1===b.nodeType&&h.hasData(a)){var c,d,j;d=h._data(a);var e=h._data(b,d),g=d.events;if(g)for(c in delete e.handle,e.events={},g){d=0;for(j=g[c].length;d<j;d++)h.event.add(b,c,g[c][d])}e.data&&(e.data=h.extend({},e.data))}}function n(a,b){var c;if(1===b.nodeType){b.clearAttributes&&
...
function m(a){return"undefined"!==typeof a.getElementsByTagName?a.getElementsByTagName("*"):"undefined"!==typeof a.querySelectorAll?a.querySelectorAll("*"):[]}function r(a){if("checkbox"===a.type||"radio"===a.type)a.defaultChecked=a.checked}function s(a){var b=(a.nodeName||"").toLowerCase();"input"===b?r(a):"script"!==b&&"undefined"!==typeof a.getElementsByTagName&&h.grep(a.getElementsByTagName("input"),r)}function q(a,b,c){var d="width"===b?a.offsetWidth:a.offsetHeight,j="width"===b?1:0;if(0<d){if("border"!==
c)for(;4>j;j+=2)c||(d-=parseFloat(h.css(a,"padding"+ca[j]))||0),d="margin"===c?d+(parseFloat(h.css(a,c+ca[j]))||0):d-(parseFloat(h.css(a,"border"+ca[j]+"Width"))||0);return d+"px"}d=fa(a,b);if(0>d||null==d)d=a.style[b];if(wa.test(d))return d;d=parseFloat(d)||0;if(c)for(;4>j;j+=2)d+=parseFloat(h.css(a,"padding"+ca[j]))||0,"padding"!==c&&(d+=parseFloat(h.css(a,"border"+ca[j]+"Width"))||0),"margin"===c&&(d+=parseFloat(h.css(a,c+ca[j]))||0);return d+"px"}function p(a){return function(b,c){"string"!==
typeof b&&(c=b,b="*");if(h.isFunction(c))for(var d=b.toLowerCase().split(La),j=0,e=d.length,g,f;j<e;j++)g=d[j],(f=/^\+/.test(g))&&(g=g.substr(1)||"*"),g=a[g]=a[g]||[],g[f?"unshift":"push"](c)}}function z(a,b,d,j,e,g){e=e||b.dataTypes[0];g=g||{};g[e]=!0;for(var e=a[e],f=0,i=e?e.length:0,h=a===xa,k;f<i&&(h||!k);f++)k=e[f](b,d,j),"string"===typeof k&&(!h||g[k]?k=c:(b.dataTypes.unshift(k),k=z(a,b,d,j,k,g)));if((h||!k)&&!g["*"])k=z(a,b,d,j,"*",g);return k}function x(a,b){var d,j,e=h.ajaxSettings.flatOptions||
{};for(d in b)b[d]!==c&&((e[d]?a:j||(j={}))[d]=b[d]);j&&h.extend(!0,a,j)}function y(a,b,c,d){if(h.isArray(b))h.each(b,function(b,j){c||db.test(a)?d(a,j):y(a+"["+("object"===typeof j?b:"")+"]",j,c,d)});else if(!c&&"object"===h.type(b))for(var j in b)y(a+"["+j+"]",b[j],c,d);else d(a,b)}function D(){try{return new a.XMLHttpRequest}catch(b){}}function A(){setTimeout(B,0);return pa=h.now()}function B(){pa=c}function F(a,b){var c={};h.each(qa.concat.apply([],qa.slice(0,b)),function(){c[this]=a});return c}
function O(a){if(!ya[a]){var b=w.body,c=h("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d){Z||(Z=w.createElement("iframe"),Z.frameBorder=Z.width=Z.height=0);b.appendChild(Z);if(!ga||!Z.createElement)ga=(Z.contentWindow||Z.contentDocument).document,ga.write((h.support.boxModel?"<!doctype html>":"")+"<html><body>"),ga.close();c=ga.createElement(a);ga.body.appendChild(c);d=h.css(c,"display");b.removeChild(Z)}ya[a]=d}return ya[a]}function C(a){return h.isWindow(a)?a:9===a.nodeType?
a.defaultView||a.parentWindow:!1}var w=a.document,R=a.navigator,G=a.location,h=function(){function b(){if(!d.isReady){try{w.documentElement.doScroll("left")}catch(a){setTimeout(b,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,g)},j=a.jQuery,e=a.$,g,f=/^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,i=/\S/,h=/^\s+/,k=/\s+$/,u=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,l=/^[\],:{}\s]*$/,v=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,m=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,n=/(?:^|:|,)(?:\s*\[)+/g,
o=/(webkit)[ \/]([\w.]+)/,r=/(opera)(?:.*version)?[ \/]([\w.]+)/,J=/(msie) ([\w.]+)/,s=/(mozilla)(?:.*? rv:([\w.]+))?/,q=/-([a-z]|[0-9])/ig,P=/^-ms-/,p=function(a,b){return(b+"").toUpperCase()},U=R.userAgent,ra,ha,eb=Object.prototype.toString,za=Object.prototype.hasOwnProperty,Aa=Array.prototype.push,x=Array.prototype.slice,z=String.prototype.trim,t=Array.prototype.indexOf,y={};d.fn=d.prototype={constructor:d,init:function(a,b,j){var e;if(!a)return this;if(a.nodeType)return this.context=this[0]=a,
this.length=1,this;if("body"===a&&!b&&w.body)return this.context=w,this[0]=w.body,this.selector=a,this.length=1,this;if("string"===typeof a){if((e="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:f.exec(a))&&(e[1]||!b)){if(e[1])return j=(b=b instanceof d?b[0]:b)?b.ownerDocument||b:w,(a=u.exec(a))?d.isPlainObject(b)?(a=[w.createElement(a[1])],d.fn.attr.call(a,b,!0)):a=[j.createElement(a[1])]:(a=d.buildFragment([e[1]],[j]),a=(a.cacheable?d.clone(a.fragment):a.fragment).childNodes),
d.merge(this,a);if((b=w.getElementById(e[2]))&&b.parentNode){if(b.id!==e[2])return j.find(a);this.length=1;this[0]=b}this.context=w;this.selector=a;return this}return!b||b.jquery?(b||j).find(a):this.constructor(b).find(a)}if(d.isFunction(a))return j.ready(a);a.selector!==c&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,this)},selector:"",jquery:"1.7.2",length:0,size:function(){return this.length},toArray:function(){return x.call(this,0)},get:function(a){return null==a?this.toArray():
0>a?this[this.length+a]:this[a]},pushStack:function(a,b,c){var j=this.constructor();d.isArray(a)?Aa.apply(j,a):d.merge(j,a);j.prevObject=this;j.context=this.context;"find"===b?j.selector=this.selector+(this.selector?" ":"")+c:b&&(j.selector=this.selector+"."+b+"("+c+")");return j},each:function(a,b){return d.each(this,a,b)},ready:function(a){d.bindReady();ra.add(a);return this},eq:function(a){a=+a;return-1===a?this.slice(a):this.slice(a,a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},
slice:function(){return this.pushStack(x.apply(this,arguments),"slice",x.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:Aa,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,b,j,e,K,g=arguments[0]||{},f=1,i=arguments.length,h=!1;"boolean"===typeof g&&(h=g,g=arguments[1]||{},f=2);"object"!==typeof g&&!d.isFunction(g)&&(g=
{});i===f&&(g=this,--f);for(;f<i;f++)if(null!=(a=arguments[f]))for(b in a)j=g[b],e=a[b],g!==e&&(h&&e&&(d.isPlainObject(e)||(K=d.isArray(e)))?(K?(K=!1,j=j&&d.isArray(j)?j:[]):j=j&&d.isPlainObject(j)?j:{},g[b]=d.extend(h,j,e)):e!==c&&(g[b]=e));return g};d.extend({noConflict:function(b){a.$===d&&(a.$=e);b&&a.jQuery===d&&(a.jQuery=j);return d},isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!w.body)return setTimeout(d.ready,
1);d.isReady=!0;!0!==a&&0<--d.readyWait||(ra.fireWith(w,[d]),d.fn.trigger&&d(w).trigger("ready").off("ready"))}},bindReady:function(){if(!ra){ra=d.Callbacks("once memory");if("complete"===w.readyState)return setTimeout(d.ready,1);if(w.addEventListener)w.addEventListener("DOMContentLoaded",ha,!1),a.addEventListener("load",d.ready,!1);else if(w.attachEvent){w.attachEvent("onreadystatechange",ha);a.attachEvent("onload",d.ready);var c=!1;try{c=null==a.frameElement}catch(j){}w.documentElement.doScroll&&
c&&b()}}},isFunction:function(a){return"function"===d.type(a)},isArray:Array.isArray||function(a){return"array"===d.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!isNaN(parseFloat(a))&&isFinite(a)},type:function(a){return null==a?""+a:y[eb.call(a)]||"object"},isPlainObject:function(a){if(!a||"object"!==d.type(a)||a.nodeType||d.isWindow(a))return!1;try{if(a.constructor&&!za.call(a,"constructor")&&!za.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(b){return!1}for(var j in a);
return j===c||za.call(a,j)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(l.test(b.replace(v,"@").replace(m,"]").replace(n,"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b){if("string"!==typeof b||!b)return null;var j,e;try{a.DOMParser?(e=new DOMParser,j=e.parseFromString(b,"text/xml")):
(j=new ActiveXObject("Microsoft.XMLDOM"),j.async="false",j.loadXML(b))}catch(K){j=c}(!j||!j.documentElement||j.getElementsByTagName("parsererror").length)&&d.error("Invalid XML: "+b);return j},noop:function(){},globalEval:function(b){b&&i.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(P,"ms-").replace(q,p)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,b,j){var e,K=0,g=a.length,f=g===c||d.isFunction(a);
if(j)if(f)for(e in a){if(!1===b.apply(a[e],j))break}else for(;K<g&&!1!==b.apply(a[K++],j););else if(f)for(e in a){if(!1===b.call(a[e],e,a[e]))break}else for(;K<g&&!1!==b.call(a[K],K,a[K++]););return a},trim:z?function(a){return null==a?"":z.call(a)}:function(a){return null==a?"":a.toString().replace(h,"").replace(k,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var j=d.type(a);null==a.length||"string"===j||"function"===j||"regexp"===j||d.isWindow(a)?Aa.call(c,a):d.merge(c,a)}return c},inArray:function(a,
b,c){var d;if(b){if(t)return t.call(b,a,c);d=b.length;for(c=c?0>c?Math.max(0,d+c):c:0;c<d;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,b){var d=a.length,j=0;if("number"===typeof b.length)for(var e=b.length;j<e;j++)a[d++]=b[j];else for(;b[j]!==c;)a[d++]=b[j++];a.length=d;return a},grep:function(a,b,c){for(var d=[],j,c=!!c,e=0,K=a.length;e<K;e++)j=!!b(a[e],e),c!==j&&d.push(a[e]);return d},map:function(a,b,j){var e,K,g=[],f=0,i=a.length;if(a instanceof d||i!==c&&"number"===typeof i&&(0<
i&&a[0]&&a[i-1]||0===i||d.isArray(a)))for(;f<i;f++)e=b(a[f],f,j),null!=e&&(g[g.length]=e);else for(K in a)e=b(a[K],K,j),null!=e&&(g[g.length]=e);return g.concat.apply([],g)},guid:1,proxy:function(a,b){if("string"===typeof b)var j=a[b],b=a,a=j;if(!d.isFunction(a))return c;var e=x.call(arguments,2),j=function(){return a.apply(b,e.concat(x.call(arguments)))};j.guid=a.guid=a.guid||j.guid||d.guid++;return j},access:function(a,b,j,e,K,g,f){var i,h=null==j,k=0,u=a.length;if(j&&"object"===typeof j){for(k in j)d.access(a,
b,k,j[k],1,g,e);K=1}else if(e!==c){i=f===c&&d.isFunction(e);h&&(i?(i=b,b=function(a,b,c){return i.call(d(a),c)}):(b.call(a,e),b=null));if(b)for(;k<u;k++)b(a[k],j,i?e.call(a[k],k,b(a[k],j)):e,f);K=1}return K?a:h?b.call(a):u?b(a[0],j):g},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();a=o.exec(a)||r.exec(a)||J.exec(a)||0>a.indexOf("compatible")&&s.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,
a,this);a.superclass=this;a.fn=a.prototype=this();a.fn.constructor=a;a.sub=this.sub;a.fn.init=function(c,j){j&&j instanceof d&&!(j instanceof a)&&(j=a(j));return d.fn.init.call(this,c,j,b)};a.fn.init.prototype=a.fn;var b=a(w);return a},browser:{}});d.each("Boolean,Number,String,Function,Array,Date,RegExp,Object".split(","),function(a,b){y["[object "+b+"]"]=b.toLowerCase()});U=d.uaMatch(U);U.browser&&(d.browser[U.browser]=!0,d.browser.version=U.version);d.browser.webkit&&(d.browser.safari=!0);i.test("\u00a0")&&
(h=/^[\s\xA0]+/,k=/[\s\xA0]+$/);g=d(w);w.addEventListener?ha=function(){w.removeEventListener("DOMContentLoaded",ha,false);d.ready()}:w.attachEvent&&(ha=function(){if(w.readyState==="complete"){w.detachEvent("onreadystatechange",ha);d.ready()}});return d}(),S={};h.Callbacks=function(a){var a=a?S[a]||d(a):{},b=[],j=[],e,g,f,i,k,u,l=function(c){var d,j,e,g;d=0;for(j=c.length;d<j;d++)e=c[d],g=h.type(e),"array"===g?l(e):"function"===g&&(!a.unique||!m.has(e))&&b.push(e)},v=function(c,d){d=d||[];e=!a.memory||
[c,d];f=g=!0;u=i||0;i=0;for(k=b.length;b&&u<k;u++)if(!1===b[u].apply(c,d)&&a.stopOnFalse){e=!0;break}f=!1;b&&(a.once?!0===e?m.disable():b=[]:j&&j.length&&(e=j.shift(),m.fireWith(e[0],e[1])))},m={add:function(){if(b){var a=b.length;l(arguments);f?k=b.length:e&&!0!==e&&(i=a,v(e[0],e[1]))}return this},remove:function(){if(b)for(var c=arguments,d=0,j=c.length;d<j;d++)for(var e=0;e<b.length&&!(c[d]===b[e]&&(f&&e<=k&&(k--,e<=u&&u--),b.splice(e--,1),a.unique));e++);return this},has:function(a){if(b)for(var c=
0,d=b.length;c<d;c++)if(a===b[c])return!0;return!1},empty:function(){b=[];return this},disable:function(){b=j=e=c;return this},disabled:function(){return!b},lock:function(){j=c;(!e||!0===e)&&m.disable();return this},locked:function(){return!j},fireWith:function(b,c){j&&(f?a.once||j.push([b,c]):(!a.once||!e)&&v(b,c));return this},fire:function(){m.fireWith(this,arguments);return this},fired:function(){return!!g}};return m};var M=[].slice;h.extend({Deferred:function(a){var b=h.Callbacks("once memory"),
c=h.Callbacks("once memory"),d=h.Callbacks("memory"),j="pending",e={resolve:b,reject:c,notify:d},g={done:b.add,fail:c.add,progress:d.add,state:function(){return j},isResolved:b.fired,isRejected:c.fired,then:function(a,b,c){f.done(a).fail(b).progress(c);return this},always:function(){f.done.apply(f,arguments).fail.apply(f,arguments);return this},pipe:function(a,b,c){return h.Deferred(function(d){h.each({done:[a,"resolve"],fail:[b,"reject"],progress:[c,"notify"]},function(a,b){var c=b[0],j=b[1],e;if(h.isFunction(c))f[a](function(){if((e=
c.apply(this,arguments))&&h.isFunction(e.promise))e.promise().then(d.resolve,d.reject,d.notify);else d[j+"With"](this===f?d:this,[e])});else f[a](d[j])})}).promise()},promise:function(a){if(null==a)a=g;else for(var b in g)a[b]=g[b];return a}},f=g.promise({}),i;for(i in e)f[i]=e[i].fire,f[i+"With"]=e[i].fireWith;f.done(function(){j="resolved"},c.disable,d.lock).fail(function(){j="rejected"},b.disable,d.lock);a&&a.call(f,f);return f},when:function(a){function b(a){return function(b){d[a]=1<arguments.length?
M.call(arguments,0):b;--f||i.resolveWith(i,d)}}function c(a){return function(b){g[a]=1<arguments.length?M.call(arguments,0):b;i.notifyWith(k,g)}}var d=M.call(arguments,0),j=0,e=d.length,g=Array(e),f=e,i=1>=e&&a&&h.isFunction(a.promise)?a:h.Deferred(),k=i.promise();if(1<e){for(;j<e;j++)d[j]&&d[j].promise&&h.isFunction(d[j].promise)?d[j].promise().then(b(j),i.reject,c(j)):--f;f||i.resolveWith(i,d)}else i!==a&&i.resolveWith(i,e?[a]:[]);return k}});h.support=function(){var b,c,d,j,e,g,f,i,k=w.createElement("div");
k.setAttribute("className","t");k.innerHTML="   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>";c=k.getElementsByTagName("*");d=k.getElementsByTagName("a")[0];if(!c||!c.length||!d)return{};j=w.createElement("select");e=j.appendChild(w.createElement("option"));c=k.getElementsByTagName("input")[0];b={leadingWhitespace:3===k.firstChild.nodeType,tbody:!k.getElementsByTagName("tbody").length,htmlSerialize:!!k.getElementsByTagName("link").length,
...
pixelMargin:!0};h.boxModel=b.boxModel="CSS1Compat"===w.compatMode;c.checked=!0;b.noCloneChecked=c.cloneNode(!0).checked;j.disabled=!0;b.optDisabled=!e.disabled;try{delete k.test}catch(u){b.deleteExpando=!1}!k.addEventListener&&k.attachEvent&&k.fireEvent&&(k.attachEvent("onclick",function(){b.noCloneEvent=!1}),k.cloneNode(!0).fireEvent("onclick"));c=w.createElement("input");c.value="t";c.setAttribute("type","radio");b.radioValue="t"===c.value;c.setAttribute("checked","checked");c.setAttribute("name",
"t");k.appendChild(c);d=w.createDocumentFragment();d.appendChild(k.lastChild);b.checkClone=d.cloneNode(!0).cloneNode(!0).lastChild.checked;b.appendChecked=c.checked;d.removeChild(c);d.appendChild(k);if(k.attachEvent)for(f in{submit:1,change:1,focusin:1})c="on"+f,i=c in k,i||(k.setAttribute(c,"return;"),i="function"===typeof k[c]),b[f+"Bubbles"]=i;d.removeChild(k);d=j=e=k=c=null;h(function(){var c,d,j,e,f=w.getElementsByTagName("body")[0];if(f){c=w.createElement("div");c.style.cssText="padding:0;margin:0;border:0;visibility:hidden;width:0;height:0;position:static;top:0;margin-top:1px";
f.insertBefore(c,f.firstChild);k=w.createElement("div");c.appendChild(k);k.innerHTML="<table><tr><td style='padding:0;margin:0;border:0;display:none'></td><td>t</td></tr></table>";g=k.getElementsByTagName("td");i=g[0].offsetHeight===0;g[0].style.display="";g[1].style.display="none";b.reliableHiddenOffsets=i&&g[0].offsetHeight===0;if(a.getComputedStyle){k.innerHTML="";d=w.createElement("div");d.style.width="0";d.style.marginRight="0";k.style.width="2px";k.appendChild(d);b.reliableMarginRight=(parseInt((a.getComputedStyle(d,
...
k.innerHTML="<div style='position:absolute;top:0;left:0;width:1px;height:1px;padding:0;margin:0;border:5px solid #000;display:block;'><div style='padding:0;margin:0;border:0;display:block;overflow:hidden;'></div></div><table style='position:absolute;top:0;left:0;width:1px;height:1px;padding:0;margin:0;border:5px solid #000;' cellpadding='0' cellspacing='0'><tr><td></td></tr></table>";d=k.firstChild;j=d.firstChild;e={doesNotAddBorder:j.offsetTop!==5,doesAddBorderForTableAndCells:d.nextSibling.firstChild.firstChild.offsetTop===
5};j.style.position="fixed";j.style.top="20px";e.fixedPosition=j.offsetTop===20||j.offsetTop===15;j.style.position=j.style.top="";d.style.overflow="hidden";d.style.position="relative";e.subtractsBorderForOverflowNotVisible=j.offsetTop===-5;e.doesNotIncludeMarginInBodyOffset=f.offsetTop!==1;if(a.getComputedStyle){k.style.marginTop="1%";b.pixelMargin=(a.getComputedStyle(k,null)||{marginTop:0}).marginTop!=="1%"}if(typeof c.style.zoom!=="undefined")c.style.zoom=1;f.removeChild(c);k=null;h.extend(b,e)}});
return b}();var V=/^(?:\{.*\}|\[.*\])$/,L=/([A-Z])/g;h.extend({cache:{},uuid:0,expando:"jQuery"+(h.fn.jquery+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(a){a=a.nodeType?h.cache[a[h.expando]]:a[h.expando];return!!a&&!g(a)},data:function(a,b,d,j){if(h.acceptData(a)){var e;e=h.expando;var g="string"===typeof b,f=a.nodeType,i=f?h.cache:a,k=f?a[e]:a[e]&&e,u="events"===b;if(k&&i[k]&&(u||j||i[k].data)||!(g&&d===c)){k||
(f?a[e]=k=++h.uuid:k=e);i[k]||(i[k]={},f||(i[k].toJSON=h.noop));if("object"===typeof b||"function"===typeof b)j?i[k]=h.extend(i[k],b):i[k].data=h.extend(i[k].data,b);e=a=i[k];j||(a.data||(a.data={}),a=a.data);d!==c&&(a[h.camelCase(b)]=d);if(u&&!a[b])return e.events;g?(d=a[b],null==d&&(d=a[h.camelCase(b)])):d=a;return d}}},removeData:function(a,b,c){if(h.acceptData(a)){var d,j,e,f=h.expando,i=a.nodeType,k=i?h.cache:a,u=i?a[f]:f;if(k[u]){if(b&&(d=c?k[u]:k[u].data)){h.isArray(b)||(b in d?b=[b]:(b=h.camelCase(b),
b=b in d?[b]:b.split(" ")));j=0;for(e=b.length;j<e;j++)delete d[b[j]];if(!(c?g:h.isEmptyObject)(d))return}if(!c&&(delete k[u].data,!g(k[u])))return;h.support.deleteExpando||!k.setInterval?delete k[u]:k[u]=null;i&&(h.support.deleteExpando?delete a[f]:a.removeAttribute?a.removeAttribute(f):a[f]=null)}}},_data:function(a,b,c){return h.data(a,b,c,!0)},acceptData:function(a){if(a.nodeName){var b=h.noData[a.nodeName.toLowerCase()];if(b)return!(!0===b||a.getAttribute("classid")!==b)}return!0}});h.fn.extend({data:function(a,
b){var d,j,g,f,i,k=this[0],u=0,l=null;if(a===c){if(this.length&&(l=h.data(k),1===k.nodeType&&!h._data(k,"parsedAttrs"))){g=k.attributes;for(i=g.length;u<i;u++)f=g[u].name,0===f.indexOf("data-")&&(f=h.camelCase(f.substring(5)),e(k,f,l[f]));h._data(k,"parsedAttrs",!0)}return l}if("object"===typeof a)return this.each(function(){h.data(this,a)});d=a.split(".",2);d[1]=d[1]?"."+d[1]:"";j=d[1]+"!";return h.access(this,function(b){if(b===c)return l=this.triggerHandler("getData"+j,[d[0]]),l===c&&k&&(l=h.data(k,
a),l=e(k,a,l)),l===c&&d[1]?this.data(d[0]):l;d[1]=b;this.each(function(){var c=h(this);c.triggerHandler("setData"+j,d);h.data(this,a,b);c.triggerHandler("changeData"+j,d)})},null,b,1<arguments.length,null,!1)},removeData:function(a){return this.each(function(){h.removeData(this,a)})}});h.extend({_mark:function(a,b){a&&(b=(b||"fx")+"mark",h._data(a,b,(h._data(a,b)||0)+1))},_unmark:function(a,b,c){!0!==a&&(c=b,b=a,a=!1);if(b){var c=c||"fx",d=c+"mark";(a=a?0:(h._data(b,d)||1)-1)?h._data(b,d,a):(h.removeData(b,
d,!0),i(b,c,"mark"))}},queue:function(a,b,c){var d;if(a)return b=(b||"fx")+"queue",d=h._data(a,b),c&&(!d||h.isArray(c)?d=h._data(a,b,h.makeArray(c)):d.push(c)),d||[]},dequeue:function(a,b){var b=b||"fx",c=h.queue(a,b),d=c.shift(),j={};"inprogress"===d&&(d=c.shift());d&&("fx"===b&&c.unshift("inprogress"),h._data(a,b+".run",j),d.call(a,function(){h.dequeue(a,b)},j));c.length||(h.removeData(a,b+"queue "+b+".run",!0),i(a,b,"queue"))}});h.fn.extend({queue:function(a,b){var d=2;"string"!==typeof a&&(b=
a,a="fx",d--);return arguments.length<d?h.queue(this[0],a):b===c?this:this.each(function(){var c=h.queue(this,a,b);a==="fx"&&c[0]!=="inprogress"&&h.dequeue(this,a)})},dequeue:function(a){return this.each(function(){h.dequeue(this,a)})},delay:function(a,b){a=h.fx?h.fx.speeds[a]||a:a;return this.queue(b||"fx",function(b,c){var d=setTimeout(b,a);c.stop=function(){clearTimeout(d)}})},clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,b){function d(){--f||j.resolveWith(e,[e])}"string"!==
typeof a&&(b=a,a=c);for(var a=a||"fx",j=h.Deferred(),e=this,g=e.length,f=1,i=a+"defer",k=a+"queue",u=a+"mark",l;g--;)if(l=h.data(e[g],i,c,!0)||(h.data(e[g],k,c,!0)||h.data(e[g],u,c,!0))&&h.data(e[g],i,h.Callbacks("once memory"),!0))f++,l.add(d);d();return j.promise(b)}});var t=/[\n\t\r]/g,H=/\s+/,E=/\r/g,N=/^(?:button|input)$/i,I=/^(?:button|input|object|select|textarea)$/i,T=/^a(?:rea)?$/i,X=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,
Q=h.support.getSetAttribute,j,u,v;h.fn.extend({attr:function(a,b){return h.access(this,h.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){h.removeAttr(this,a)})},prop:function(a,b){return h.access(this,h.prop,a,b,1<arguments.length)},removeProp:function(a){a=h.propFix[a]||a;return this.each(function(){try{this[a]=c,delete this[a]}catch(b){}})},addClass:function(a){var b,c,d,j,e,g,f;if(h.isFunction(a))return this.each(function(b){h(this).addClass(a.call(this,b,this.className))});
if(a&&"string"===typeof a){b=a.split(H);c=0;for(d=this.length;c<d;c++)if(j=this[c],1===j.nodeType)if(!j.className&&1===b.length)j.className=a;else{e=" "+j.className+" ";g=0;for(f=b.length;g<f;g++)~e.indexOf(" "+b[g]+" ")||(e+=b[g]+" ");j.className=h.trim(e)}}return this},removeClass:function(a){var b,d,j,e,g,f,i;if(h.isFunction(a))return this.each(function(b){h(this).removeClass(a.call(this,b,this.className))});if(a&&"string"===typeof a||a===c){b=(a||"").split(H);d=0;for(j=this.length;d<j;d++)if(e=
this[d],1===e.nodeType&&e.className)if(a){g=(" "+e.className+" ").replace(t," ");f=0;for(i=b.length;f<i;f++)g=g.replace(" "+b[f]+" "," ");e.className=h.trim(g)}else e.className=""}return this},toggleClass:function(a,b){var c=typeof a,d="boolean"===typeof b;return h.isFunction(a)?this.each(function(c){h(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===c)for(var j,e=0,g=h(this),f=b,i=a.split(H);j=i[e++];)f=d?f:!g.hasClass(j),g[f?"addClass":"removeClass"](j);
else if("undefined"===c||"boolean"===c)this.className&&h._data(this,"__className__",this.className),this.className=this.className||!1===a?"":h._data(this,"__className__")||""})},hasClass:function(a){for(var a=" "+a+" ",b=0,c=this.length;b<c;b++)if(1===this[b].nodeType&&-1<(" "+this[b].className+" ").replace(t," ").indexOf(a))return!0;return!1},val:function(a){var b,d,j,e=this[0];if(arguments.length)return j=h.isFunction(a),this.each(function(d){var e=h(this);if(1===this.nodeType&&(d=j?a.call(this,
d,e.val()):a,null==d?d="":"number"===typeof d?d+="":h.isArray(d)&&(d=h.map(d,function(a){return a==null?"":a+""})),b=h.valHooks[this.type]||h.valHooks[this.nodeName.toLowerCase()],!b||!("set"in b)||b.set(this,d,"value")===c))this.value=d});if(e){if((b=h.valHooks[e.type]||h.valHooks[e.nodeName.toLowerCase()])&&"get"in b&&(d=b.get(e,"value"))!==c)return d;d=e.value;return"string"===typeof d?d.replace(E,""):null==d?"":d}}});h.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||
b.specified?a.value:a.text}},select:{get:function(a){var b,c,d=a.selectedIndex,j=[],e=a.options,g="select-one"===a.type;if(0>d)return null;a=g?d:0;for(c=g?d+1:e.length;a<c;a++)if(b=e[a],b.selected&&(h.support.optDisabled?!b.disabled:null===b.getAttribute("disabled"))&&(!b.parentNode.disabled||!h.nodeName(b.parentNode,"optgroup"))){b=h(b).val();if(g)return b;j.push(b)}return g&&!j.length&&e.length?h(e[d]).val():j},set:function(a,b){var c=h.makeArray(b);h(a).find("option").each(function(){this.selected=
0<=h.inArray(h(this).val(),c)});c.length||(a.selectedIndex=-1);return c}}},attrFn:{val:!0,css:!0,html:!0,text:!0,data:!0,width:!0,height:!0,offset:!0},attr:function(a,b,d,e){var g,f,i=a.nodeType;if(a&&!(3===i||8===i||2===i)){if(e&&b in h.attrFn)return h(a)[b](d);if("undefined"===typeof a.getAttribute)return h.prop(a,b,d);if(e=1!==i||!h.isXMLDoc(a))b=b.toLowerCase(),f=h.attrHooks[b]||(X.test(b)?u:j);if(d!==c)if(null===d)h.removeAttr(a,b);else{if(f&&"set"in f&&e&&(g=f.set(a,d,b))!==c)return g;a.setAttribute(b,
""+d);return d}else{if(f&&"get"in f&&e&&null!==(g=f.get(a,b)))return g;g=a.getAttribute(b);return null===g?c:g}}},removeAttr:function(a,b){var c,d,j,e,g,f=0;if(b&&1===a.nodeType){d=b.toLowerCase().split(H);for(e=d.length;f<e;f++)if(j=d[f])c=h.propFix[j]||j,(g=X.test(j))||h.attr(a,j,""),a.removeAttribute(Q?j:c),g&&c in a&&(a[c]=!1)}},attrHooks:{type:{set:function(a,b){if(N.test(a.nodeName)&&a.parentNode)h.error("type property can't be changed");else if(!h.support.radioValue&&"radio"===b&&h.nodeName(a,
"input")){var c=a.value;a.setAttribute("type",b);c&&(a.value=c);return b}}},value:{get:function(a,b){return j&&h.nodeName(a,"button")?j.get(a,b):b in a?a.value:null},set:function(a,b,c){if(j&&h.nodeName(a,"button"))return j.set(a,b,c);a.value=b}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},
prop:function(a,b,d){var j,e,g=a.nodeType;if(a&&!(3===g||8===g||2===g)){if(1!==g||!h.isXMLDoc(a))b=h.propFix[b]||b,e=h.propHooks[b];return d!==c?e&&"set"in e&&(j=e.set(a,d,b))!==c?j:a[b]=d:e&&"get"in e&&null!==(j=e.get(a,b))?j:a[b]}},propHooks:{tabIndex:{get:function(a){var b=a.getAttributeNode("tabindex");return b&&b.specified?parseInt(b.value,10):I.test(a.nodeName)||T.test(a.nodeName)&&a.href?0:c}}}});h.attrHooks.tabindex=h.propHooks.tabIndex;u={get:function(a,b){var d,j=h.prop(a,b);return!0===
j||"boolean"!==typeof j&&(d=a.getAttributeNode(b))&&!1!==d.nodeValue?b.toLowerCase():c},set:function(a,b,c){!1===b?h.removeAttr(a,c):(b=h.propFix[c]||c,b in a&&(a[b]=!0),a.setAttribute(c,c.toLowerCase()));return c}};Q||(v={name:!0,id:!0,coords:!0},j=h.valHooks.button={get:function(a,b){var d;return(d=a.getAttributeNode(b))&&(v[b]?""!==d.nodeValue:d.specified)?d.nodeValue:c},set:function(a,b,c){var d=a.getAttributeNode(c);d||(d=w.createAttribute(c),a.setAttributeNode(d));return d.nodeValue=b+""}},
h.attrHooks.tabindex.set=j.set,h.each(["width","height"],function(a,b){h.attrHooks[b]=h.extend(h.attrHooks[b],{set:function(a,c){if(""===c)return a.setAttribute(b,"auto"),c}})}),h.attrHooks.contenteditable={get:j.get,set:function(a,b,c){""===b&&(b="false");j.set(a,b,c)}});h.support.hrefNormalized||h.each(["href","src","width","height"],function(a,b){h.attrHooks[b]=h.extend(h.attrHooks[b],{get:function(a){a=a.getAttribute(b,2);return a===null?c:a}})});h.support.style||(h.attrHooks.style={get:function(a){return a.style.cssText.toLowerCase()||
...
{set:function(a,b){if(h.isArray(b))return a.checked=h.inArray(h(a).val(),b)>=0}})});var J=/^(?:textarea|input|select)$/i,P=/^([^\.]*)?(?:\.(.+))?$/,U=/(?:^|\s)hover(\.\S+)?\b/,$=/^key/,Y=/^(?:mouse|contextmenu)|click/,ja=/^(?:focusinfocus|focusoutblur)$/,va=/^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/,ma=function(a){if(a=va.exec(a)){a[1]=(a[1]||"").toLowerCase();a[3]=a[3]&&RegExp("(?:^|\\s)"+a[3]+"(?:\\s|$)")}return a},ka=function(a){return h.event.special.hover?a:a.replace(U,"mouseenter$1 mouseleave$1")};
h.event={add:function(a,b,d,j,e){var g,f,i,k,u,l,v,m,n;if(!(a.nodeType===3||a.nodeType===8||!b||!d||!(g=h._data(a)))){if(d.handler){v=d;d=v.handler;e=v.selector}if(!d.guid)d.guid=h.guid++;i=g.events;if(!i)g.events=i={};f=g.handle;if(!f){g.handle=f=function(a){return typeof h!=="undefined"&&(!a||h.event.triggered!==a.type)?h.event.dispatch.apply(f.elem,arguments):c};f.elem=a}b=h.trim(ka(b)).split(" ");for(g=0;g<b.length;g++){k=P.exec(b[g])||[];u=k[1];l=(k[2]||"").split(".").sort();n=h.event.special[u]||
{};u=(e?n.delegateType:n.bindType)||u;n=h.event.special[u]||{};k=h.extend({type:u,origType:k[1],data:j,handler:d,guid:d.guid,selector:e,quick:e&&ma(e),namespace:l.join(".")},v);m=i[u];if(!m){m=i[u]=[];m.delegateCount=0;if(!n.setup||n.setup.call(a,j,l,f)===false)a.addEventListener?a.addEventListener(u,f,false):a.attachEvent&&a.attachEvent("on"+u,f)}if(n.add){n.add.call(a,k);if(!k.handler.guid)k.handler.guid=d.guid}e?m.splice(m.delegateCount++,0,k):m.push(k);h.event.global[u]=true}a=null}},global:{},
remove:function(a,b,c,d,j){var e=h.hasData(a)&&h._data(a),g,f,i,k,u,l,v,m,n,o;if(e&&(v=e.events)){b=h.trim(ka(b||"")).split(" ");for(g=0;g<b.length;g++){f=P.exec(b[g])||[];i=k=f[1];f=f[2];if(i){m=h.event.special[i]||{};i=(d?m.delegateType:m.bindType)||i;n=v[i]||[];u=n.length;f=f?RegExp("(^|\\.)"+f.split(".").sort().join("\\.(?:.*\\.)?")+"(\\.|$)"):null;for(l=0;l<n.length;l++){o=n[l];if((j||k===o.origType)&&(!c||c.guid===o.guid)&&(!f||f.test(o.namespace))&&(!d||d===o.selector||d==="**"&&o.selector)){n.splice(l--,
1);o.selector&&n.delegateCount--;m.remove&&m.remove.call(a,o)}}if(n.length===0&&u!==n.length){(!m.teardown||m.teardown.call(a,f)===false)&&h.removeEvent(a,i,e.handle);delete v[i]}}else for(i in v)h.event.remove(a,i+b[g],c,d,true)}if(h.isEmptyObject(v)){if(b=e.handle)b.elem=null;h.removeData(a,["events","handle"],true)}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(b,d,j,e){if(!j||!(j.nodeType===3||j.nodeType===8)){var g=b.type||b,f=[],i,k,u,l,v;if(!ja.test(g+h.event.triggered)){if(g.indexOf("!")>=
0){g=g.slice(0,-1);i=true}if(g.indexOf(".")>=0){f=g.split(".");g=f.shift();f.sort()}if(j&&!h.event.customEvent[g]||h.event.global[g]){b=typeof b==="object"?b[h.expando]?b:new h.Event(g,b):new h.Event(g);b.type=g;b.isTrigger=true;b.exclusive=i;b.namespace=f.join(".");b.namespace_re=b.namespace?RegExp("(^|\\.)"+f.join("\\.(?:.*\\.)?")+"(\\.|$)"):null;i=g.indexOf(":")<0?"on"+g:"";if(j){b.result=c;if(!b.target)b.target=j;d=d!=null?h.makeArray(d):[];d.unshift(b);u=h.event.special[g]||{};if(!(u.trigger&&
u.trigger.apply(j,d)===false)){v=[[j,u.bindType||g]];if(!e&&!u.noBubble&&!h.isWindow(j)){l=u.delegateType||g;f=ja.test(l+g)?j:j.parentNode;for(k=null;f;f=f.parentNode){v.push([f,l]);k=f}k&&k===j.ownerDocument&&v.push([k.defaultView||k.parentWindow||a,l])}for(k=0;k<v.length&&!b.isPropagationStopped();k++){f=v[k][0];b.type=v[k][1];(l=(h._data(f,"events")||{})[b.type]&&h._data(f,"handle"))&&l.apply(f,d);(l=i&&f[i])&&h.acceptData(f)&&l.apply(f,d)===false&&b.preventDefault()}b.type=g;if(!e&&!b.isDefaultPrevented()&&
(!u._default||u._default.apply(j.ownerDocument,d)===false)&&!(g==="click"&&h.nodeName(j,"a"))&&h.acceptData(j))if(i&&j[g]&&(g!=="focus"&&g!=="blur"||b.target.offsetWidth!==0)&&!h.isWindow(j)){(k=j[i])&&(j[i]=null);h.event.triggered=g;j[g]();h.event.triggered=c;k&&(j[i]=k)}return b.result}}else{j=h.cache;for(k in j)j[k].events&&j[k].events[g]&&h.event.trigger(b,d,j[k].handle.elem,true)}}}}},dispatch:function(b){var b=h.event.fix(b||a.event),d=(h._data(this,"events")||{})[b.type]||[],j=d.delegateCount,
e=[].slice.call(arguments,0),g=!b.exclusive&&!b.namespace,f=h.event.special[b.type]||{},i=[],k,u,l,v,m,n,o;e[0]=b;b.delegateTarget=this;if(!(f.preDispatch&&f.preDispatch.call(this,b)===false)){if(j&&!(b.button&&b.type==="click")){l=h(this);l.context=this.ownerDocument||this;for(u=b.target;u!=this;u=u.parentNode||this)if(u.disabled!==true){m={};n=[];l[0]=u;for(k=0;k<j;k++){v=d[k];o=v.selector;if(m[o]===c){var r=m,J=o,s;if(v.quick){s=v.quick;var q=u.attributes||{};s=(!s[1]||u.nodeName.toLowerCase()===
s[1])&&(!s[2]||(q.id||{}).value===s[2])&&(!s[3]||s[3].test((q["class"]||{}).value))}else s=l.is(o);r[J]=s}m[o]&&n.push(v)}n.length&&i.push({elem:u,matches:n})}}d.length>j&&i.push({elem:this,matches:d.slice(j)});for(k=0;k<i.length&&!b.isPropagationStopped();k++){j=i[k];b.currentTarget=j.elem;for(d=0;d<j.matches.length&&!b.isImmediatePropagationStopped();d++){v=j.matches[d];if(g||!b.namespace&&!v.namespace||b.namespace_re&&b.namespace_re.test(v.namespace)){b.data=v.data;b.handleObj=v;v=((h.event.special[v.origType]||
{}).handle||v.handler).apply(j.elem,e);if(v!==c){b.result=v;if(v===false){b.preventDefault();b.stopPropagation()}}}}}f.postDispatch&&f.postDispatch.call(this,b);return b.result}},props:"attrChange,attrName,relatedNode,srcElement,altKey,bubbles,cancelable,ctrlKey,currentTarget,eventPhase,metaKey,relatedTarget,shiftKey,target,timeStamp,view,which".split(","),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){if(a.which==null)a.which=b.charCode!=null?b.charCode:b.keyCode;
return a}},mouseHooks:{props:"button,buttons,clientX,clientY,fromElement,offsetX,offsetY,pageX,pageY,screenX,screenY,toElement".split(","),filter:function(a,b){var d,j,e=b.button,g=b.fromElement;if(a.pageX==null&&b.clientX!=null){d=a.target.ownerDocument||w;j=d.documentElement;d=d.body;a.pageX=b.clientX+(j&&j.scrollLeft||d&&d.scrollLeft||0)-(j&&j.clientLeft||d&&d.clientLeft||0);a.pageY=b.clientY+(j&&j.scrollTop||d&&d.scrollTop||0)-(j&&j.clientTop||d&&d.clientTop||0)}if(!a.relatedTarget&&g)a.relatedTarget=
g===a.target?b.toElement:g;if(!a.which&&e!==c)a.which=e&1?1:e&2?3:e&4?2:0;return a}},fix:function(a){if(a[h.expando])return a;var b,d,j=a,e=h.event.fixHooks[a.type]||{},g=e.props?this.props.concat(e.props):this.props,a=h.Event(j);for(b=g.length;b;){d=g[--b];a[d]=j[d]}if(!a.target)a.target=j.srcElement||w;if(a.target.nodeType===3)a.target=a.target.parentNode;if(a.metaKey===c)a.metaKey=a.ctrlKey;return e.filter?e.filter(a,j):a},special:{ready:{setup:h.bindReady},load:{noBubble:!0},focus:{delegateType:"focusin"},
...
a.relatedTarget,d=a.handleObj,j;if(!c||c!==this&&!h.contains(this,c)){a.type=d.origType;j=d.handler.apply(this,arguments);a.type=b}return j}}});h.support.submitBubbles||(h.event.special.submit={setup:function(){if(h.nodeName(this,"form"))return false;h.event.add(this,"click._submit keypress._submit",function(a){a=a.target;if((a=h.nodeName(a,"input")||h.nodeName(a,"button")?a.form:c)&&!a._submit_attached){h.event.add(a,"submit._submit",function(a){a._submit_bubble=true});a._submit_attached=true}})},
postDispatch:function(a){if(a._submit_bubble){delete a._submit_bubble;this.parentNode&&!a.isTrigger&&h.event.simulate("submit",this.parentNode,a,true)}},teardown:function(){if(h.nodeName(this,"form"))return false;h.event.remove(this,"._submit")}});h.support.changeBubbles||(h.event.special.change={setup:function(){if(J.test(this.nodeName)){if(this.type==="checkbox"||this.type==="radio"){h.event.add(this,"propertychange._change",function(a){if(a.originalEvent.propertyName==="checked")this._just_changed=
true});h.event.add(this,"click._change",function(a){if(this._just_changed&&!a.isTrigger){this._just_changed=false;h.event.simulate("change",this,a,true)}})}return false}h.event.add(this,"beforeactivate._change",function(a){a=a.target;if(J.test(a.nodeName)&&!a._change_attached){h.event.add(a,"change._change",function(a){this.parentNode&&!a.isSimulated&&!a.isTrigger&&h.event.simulate("change",this.parentNode,a,true)});a._change_attached=true}})},handle:function(a){var b=a.target;if(this!==b||a.isSimulated||
a.isTrigger||b.type!=="radio"&&b.type!=="checkbox")return a.handleObj.handler.apply(this,arguments)},teardown:function(){h.event.remove(this,"._change");return J.test(this.nodeName)}});h.support.focusinBubbles||h.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){h.event.simulate(b,a.target,h.event.fix(a),true)};h.event.special[b]={setup:function(){c++===0&&w.addEventListener(a,d,true)},teardown:function(){--c===0&&w.removeEventListener(a,d,true)}}});h.fn.extend({on:function(a,
b,d,j,e){var g,i;if(typeof a==="object"){if(typeof b!=="string"){d=d||b;b=c}for(i in a)this.on(i,b,d,a[i],e);return this}if(d==null&&j==null){j=b;d=b=c}else if(j==null)if(typeof b==="string"){j=d;d=c}else{j=d;d=b;b=c}if(j===false)j=f;else if(!j)return this;if(e===1){g=j;j=function(a){h().off(a);return g.apply(this,arguments)};j.guid=g.guid||(g.guid=h.guid++)}return this.each(function(){h.event.add(this,a,j,d,b)})},one:function(a,b,c,d){return this.on(a,b,c,d,1)},off:function(a,b,d){if(a&&a.preventDefault&&
a.handleObj){var j=a.handleObj;h(a.delegateTarget).off(j.namespace?j.origType+"."+j.namespace:j.origType,j.selector,j.handler);return this}if(typeof a==="object"){for(j in a)this.off(j,b,a[j]);return this}if(b===false||typeof b==="function"){d=b;b=c}d===false&&(d=f);return this.each(function(){h.event.remove(this,a,d,b)})},bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,null,b)},live:function(a,b,c){h(this.context).on(a,this.selector,b,c);return this},die:function(a,
b){h(this.context).off(a,this.selector||"**",b);return this},delegate:function(a,b,c,d){return this.on(b,a,c,d)},undelegate:function(a,b,c){return arguments.length==1?this.off(a,"**"):this.off(b,a,c)},trigger:function(a,b){return this.each(function(){h.event.trigger(a,b,this)})},triggerHandler:function(a,b){if(this[0])return h.event.trigger(a,b,this[0],true)},toggle:function(a){var b=arguments,c=a.guid||h.guid++,d=0,j=function(c){var j=(h._data(this,"lastToggle"+a.guid)||0)%d;h._data(this,"lastToggle"+
a.guid,j+1);c.preventDefault();return b[j].apply(this,arguments)||false};for(j.guid=c;d<b.length;)b[d++].guid=c;return this.click(j)},hover:function(a,b){return this.mouseenter(a).mouseleave(b||a)}});h.each("blur,focus,focusin,focusout,load,resize,scroll,unload,click,dblclick,mousedown,mouseup,mousemove,mouseover,mouseout,mouseenter,mouseleave,change,select,submit,keydown,keypress,keyup,error,contextmenu".split(","),function(a,b){h.fn[b]=function(a,c){if(c==null){c=a;a=null}return arguments.length>
0?this.on(b,null,a,c):this.trigger(b)};h.attrFn&&(h.attrFn[b]=true);if($.test(b))h.event.fixHooks[b]=h.event.keyHooks;if(Y.test(b))h.event.fixHooks[b]=h.event.mouseHooks});(function(){function a(b,c,d,e,g,f){for(var g=0,i=e.length;g<i;g++){var k=e[g];if(k){for(var h=false,k=k[b];k;){if(k[j]===d){h=e[k.sizset];break}if(k.nodeType===1&&!f){k[j]=d;k.sizset=g}if(k.nodeName.toLowerCase()===c){h=k;break}k=k[b]}e[g]=h}}}function b(a,c,d,e,g,f){for(var g=0,i=e.length;g<i;g++){var k=e[g];if(k){for(var h=false,
k=k[a];k;){if(k[j]===d){h=e[k.sizset];break}if(k.nodeType===1){if(!f){k[j]=d;k.sizset=g}if(typeof c!=="string"){if(k===c){h=true;break}}else if(v.filter(c,[k]).length>0){h=k;break}}k=k[a]}e[g]=h}}}var d=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,j="sizcache"+(Math.random()+"").replace(".",""),e=0,g=Object.prototype.toString,f=false,i=true,k=/\\/g,u=/\r\n/g,l=/\W/;[0,0].sort(function(){i=false;return 0});var v=
function(a,b,c,j){var c=c||[],e=b=b||w;if(b.nodeType!==1&&b.nodeType!==9)return[];if(!a||typeof a!=="string")return c;var f,i,k,h,u,l=true,K=v.isXML(b),m=[],r=a;do{d.exec("");if(f=d.exec(r)){r=f[3];m.push(f[1]);if(f[2]){h=f[3];break}}}while(f);if(m.length>1&&o.exec(a))if(m.length===2&&n.relative[m[0]])i=U(m[0]+m[1],b,j);else for(i=n.relative[m[0]]?[b]:v(m.shift(),b);m.length;){a=m.shift();n.relative[a]&&(a=a+m.shift());i=U(a,i,j)}else{if(!j&&m.length>1&&b.nodeType===9&&!K&&n.match.ID.test(m[0])&&
!n.match.ID.test(m[m.length-1])){f=v.find(m.shift(),b,K);b=f.expr?v.filter(f.expr,f.set)[0]:f.set[0]}if(b){f=j?{expr:m.pop(),set:J(j)}:v.find(m.pop(),m.length===1&&(m[0]==="~"||m[0]==="+")&&b.parentNode?b.parentNode:b,K);i=f.expr?v.filter(f.expr,f.set):f.set;for(m.length>0?k=J(i):l=false;m.length;){f=u=m.pop();n.relative[u]?f=m.pop():u="";f==null&&(f=b);n.relative[u](k,f,K)}}else k=[]}k||(k=i);k||v.error(u||a);if(g.call(k)==="[object Array]")if(l)if(b&&b.nodeType===1)for(a=0;k[a]!=null;a++)k[a]&&
(k[a]===true||k[a].nodeType===1&&v.contains(b,k[a]))&&c.push(i[a]);else for(a=0;k[a]!=null;a++)k[a]&&k[a].nodeType===1&&c.push(i[a]);else c.push.apply(c,k);else J(k,c);if(h){v(h,e,c,j);v.uniqueSort(c)}return c};v.uniqueSort=function(a){if(P){f=i;a.sort(P);if(f)for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1)}return a};v.matches=function(a,b){return v(a,null,null,b)};v.matchesSelector=function(a,b){return v(b,null,null,[a]).length>0};v.find=function(a,b,c){var d,j,e,g,f,i;if(!a)return[];j=
0;for(e=n.order.length;j<e;j++){f=n.order[j];if(g=n.leftMatch[f].exec(a)){i=g[1];g.splice(1,1);if(i.substr(i.length-1)!=="\\"){g[1]=(g[1]||"").replace(k,"");d=n.find[f](g,b,c);if(d!=null){a=a.replace(n.match[f],"");break}}}}d||(d=typeof b.getElementsByTagName!=="undefined"?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};v.filter=function(a,b,d,j){for(var e,g,f,i,k,h,u,l,K=a,m=[],o=b,r=b&&b[0]&&v.isXML(b[0]);a&&b.length;){for(f in n.filter)if((e=n.leftMatch[f].exec(a))!=null&&e[2]){h=n.filter[f];
k=e[1];g=false;e.splice(1,1);if(k.substr(k.length-1)!=="\\"){o===m&&(m=[]);if(n.preFilter[f])if(e=n.preFilter[f](e,o,d,m,j,r)){if(e===true)continue}else g=i=true;if(e)for(u=0;(k=o[u])!=null;u++)if(k){i=h(k,e,u,o);l=j^i;if(d&&i!=null)l?g=true:o[u]=false;else if(l){m.push(k);g=true}}if(i!==c){d||(o=m);a=a.replace(n.match[f],"");if(!g)return[];break}}}if(a===K)if(g==null)v.error(a);else break;K=a}return o};v.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};var m=v.getText=
function(a){var b,c;b=a.nodeType;var d="";if(b)if(b===1||b===9||b===11){if(typeof a.textContent==="string")return a.textContent;if(typeof a.innerText==="string")return a.innerText.replace(u,"");for(a=a.firstChild;a;a=a.nextSibling)d=d+m(a)}else{if(b===3||b===4)return a.nodeValue}else for(b=0;c=a[b];b++)c.nodeType!==8&&(d=d+m(c));return d},n=v.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,
ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/,TAG:/^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/,CHILD:/:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/,POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/,PSEUDO:/:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/},leftMatch:{},attrMap:{"class":"className","for":"htmlFor"},attrHandle:{href:function(a){return a.getAttribute("href")},
type:function(a){return a.getAttribute("type")}},relative:{"+":function(a,b){var c=typeof b==="string",d=c&&!l.test(b),c=c&&!d;d&&(b=b.toLowerCase());for(var d=0,j=a.length,e;d<j;d++)if(e=a[d]){for(;(e=e.previousSibling)&&e.nodeType!==1;);a[d]=c||e&&e.nodeName.toLowerCase()===b?e||false:e===b}c&&v.filter(b,a,true)},">":function(a,b){var c,d=typeof b==="string",j=0,e=a.length;if(d&&!l.test(b))for(b=b.toLowerCase();j<e;j++){if(c=a[j]){c=c.parentNode;a[j]=c.nodeName.toLowerCase()===b?c:false}}else{for(;j<
e;j++)(c=a[j])&&(a[j]=d?c.parentNode:c.parentNode===b);d&&v.filter(b,a,true)}},"":function(c,d,j){var g,f=e++,i=b;if(typeof d==="string"&&!l.test(d)){g=d=d.toLowerCase();i=a}i("parentNode",d,f,c,g,j)},"~":function(c,d,j){var g,f=e++,i=b;if(typeof d==="string"&&!l.test(d)){g=d=d.toLowerCase();i=a}i("previousSibling",d,f,c,g,j)}},find:{ID:function(a,b,c){if(typeof b.getElementById!=="undefined"&&!c)return(a=b.getElementById(a[1]))&&a.parentNode?[a]:[]},NAME:function(a,b){if(typeof b.getElementsByName!==
"undefined"){for(var c=[],d=b.getElementsByName(a[1]),j=0,e=d.length;j<e;j++)d[j].getAttribute("name")===a[1]&&c.push(d[j]);return c.length===0?null:c}},TAG:function(a,b){if(typeof b.getElementsByTagName!=="undefined")return b.getElementsByTagName(a[1])}},preFilter:{CLASS:function(a,b,c,d,j,e){a=" "+a[1].replace(k,"")+" ";if(e)return a;for(var e=0,g;(g=b[e])!=null;e++)g&&(j^(g.className&&(" "+g.className+" ").replace(/[\t\n\r]/g," ").indexOf(a)>=0)?c||d.push(g):c&&(b[e]=false));return false},ID:function(a){return a[1].replace(k,
"")},TAG:function(a){return a[1].replace(k,"").toLowerCase()},CHILD:function(a){if(a[1]==="nth"){a[2]||v.error(a[0]);a[2]=a[2].replace(/^\+|\s*/g,"");var b=/(-?)(\d*)(?:n([+\-]?\d*))?/.exec(a[2]==="even"&&"2n"||a[2]==="odd"&&"2n+1"||!/\D/.test(a[2])&&"0n+"+a[2]||a[2]);a[2]=b[1]+(b[2]||1)-0;a[3]=b[3]-0}else a[2]&&v.error(a[0]);a[0]=e++;return a},ATTR:function(a,b,c,d,j,e){b=a[1]=a[1].replace(k,"");!e&&n.attrMap[b]&&(a[1]=n.attrMap[b]);a[4]=(a[4]||a[5]||"").replace(k,"");a[2]==="~="&&(a[4]=" "+a[4]+
" ");return a},PSEUDO:function(a,b,c,j,e){if(a[1]==="not")if((d.exec(a[3])||"").length>1||/^\w/.test(a[3]))a[3]=v(a[3],null,null,b);else{a=v.filter(a[3],b,c,1^e);c||j.push.apply(j,a);return false}else if(n.match.POS.test(a[0])||n.match.CHILD.test(a[0]))return true;return a},POS:function(a){a.unshift(true);return a}},filters:{enabled:function(a){return a.disabled===false&&a.type!=="hidden"},disabled:function(a){return a.disabled===true},checked:function(a){return a.checked===true},selected:function(a){a.parentNode&&
a.parentNode.selectedIndex;return a.selected===true},parent:function(a){return!!a.firstChild},empty:function(a){return!a.firstChild},has:function(a,b,c){return!!v(c[3],a).length},header:function(a){return/h\d/i.test(a.nodeName)},text:function(a){var b=a.getAttribute("type"),c=a.type;return a.nodeName.toLowerCase()==="input"&&"text"===c&&(b===c||b===null)},radio:function(a){return a.nodeName.toLowerCase()==="input"&&"radio"===a.type},checkbox:function(a){return a.nodeName.toLowerCase()==="input"&&
...
b,c,d){var j=b[1],e=n.filters[j];if(e)return e(a,c,b,d);if(j==="contains")return(a.textContent||a.innerText||m([a])||"").indexOf(b[3])>=0;if(j==="not"){b=b[3];c=0;for(d=b.length;c<d;c++)if(b[c]===a)return false;return true}v.error(j)},CHILD:function(a,b){var c,d,e,g,f,i;c=b[1];i=a;switch(c){case "only":case "first":for(;i=i.previousSibling;)if(i.nodeType===1)return false;if(c==="first")return true;i=a;case "last":for(;i=i.nextSibling;)if(i.nodeType===1)return false;return true;case "nth":c=b[2];d=
b[3];if(c===1&&d===0)return true;e=b[0];if((g=a.parentNode)&&(g[j]!==e||!a.nodeIndex)){f=0;for(i=g.firstChild;i;i=i.nextSibling)if(i.nodeType===1)i.nodeIndex=++f;g[j]=e}i=a.nodeIndex-d;return c===0?i===0:i%c===0&&i/c>=0}},ID:function(a,b){return a.nodeType===1&&a.getAttribute("id")===b},TAG:function(a,b){return b==="*"&&a.nodeType===1||!!a.nodeName&&a.nodeName.toLowerCase()===b},CLASS:function(a,b){return(" "+(a.className||a.getAttribute("class"))+" ").indexOf(b)>-1},ATTR:function(a,b){var c=b[1],
c=v.attr?v.attr(a,c):n.attrHandle[c]?n.attrHandle[c](a):a[c]!=null?a[c]:a.getAttribute(c),d=c+"",j=b[2],e=b[4];return c==null?j==="!=":!j&&v.attr?c!=null:j==="="?d===e:j==="*="?d.indexOf(e)>=0:j==="~="?(" "+d+" ").indexOf(e)>=0:!e?d&&c!==false:j==="!="?d!==e:j==="^="?d.indexOf(e)===0:j==="$="?d.substr(d.length-e.length)===e:j==="|="?d===e||d.substr(0,e.length+1)===e+"-":false},POS:function(a,b,c,d){var j=n.setFilters[b[2]];if(j)return j(a,c,b,d)}}},o=n.match.POS,r=function(a,b){return"\\"+(b-0+1)},
s;for(s in n.match){n.match[s]=RegExp(n.match[s].source+/(?![^\[]*\])(?![^\(]*\))/.source);n.leftMatch[s]=RegExp(/(^(?:.|\r|\n)*?)/.source+n.match[s].source.replace(/\\(\d+)/g,r))}n.match.globalPOS=o;var J=function(a,b){a=Array.prototype.slice.call(a,0);if(b){b.push.apply(b,a);return b}return a};try{Array.prototype.slice.call(w.documentElement.childNodes,0)[0].nodeType}catch(q){J=function(a,b){var c=0,d=b||[];if(g.call(a)==="[object Array]")Array.prototype.push.apply(d,a);else if(typeof a.length===
"number")for(var j=a.length;c<j;c++)d.push(a[c]);else for(;a[c];c++)d.push(a[c]);return d}}var P,p;if(w.documentElement.compareDocumentPosition)P=function(a,b){if(a===b){f=true;return 0}return!a.compareDocumentPosition||!b.compareDocumentPosition?a.compareDocumentPosition?-1:1:a.compareDocumentPosition(b)&4?-1:1};else{P=function(a,b){if(a===b){f=true;return 0}if(a.sourceIndex&&b.sourceIndex)return a.sourceIndex-b.sourceIndex;var c,d,j=[],e=[];c=a.parentNode;d=b.parentNode;var g=c;if(c===d)return p(a,
b);if(c){if(!d)return 1}else return-1;for(;g;){j.unshift(g);g=g.parentNode}for(g=d;g;){e.unshift(g);g=g.parentNode}c=j.length;d=e.length;for(g=0;g<c&&g<d;g++)if(j[g]!==e[g])return p(j[g],e[g]);return g===c?p(a,e[g],-1):p(j[g],b,1)};p=function(a,b,c){if(a===b)return c;for(a=a.nextSibling;a;){if(a===b)return-1;a=a.nextSibling}return 1}}(function(){var a=w.createElement("div"),b="script"+(new Date).getTime(),d=w.documentElement;a.innerHTML="<a name='"+b+"'/>";d.insertBefore(a,d.firstChild);if(w.getElementById(b)){n.find.ID=
function(a,b,d){if(typeof b.getElementById!=="undefined"&&!d)return(b=b.getElementById(a[1]))?b.id===a[1]||typeof b.getAttributeNode!=="undefined"&&b.getAttributeNode("id").nodeValue===a[1]?[b]:c:[]};n.filter.ID=function(a,b){var c=typeof a.getAttributeNode!=="undefined"&&a.getAttributeNode("id");return a.nodeType===1&&c&&c.nodeValue===b}}d.removeChild(a);d=a=null})();(function(){var a=w.createElement("div");a.appendChild(w.createComment(""));if(a.getElementsByTagName("*").length>0)n.find.TAG=function(a,
b){var c=b.getElementsByTagName(a[1]);if(a[1]==="*"){for(var d=[],j=0;c[j];j++)c[j].nodeType===1&&d.push(c[j]);c=d}return c};a.innerHTML="<a href='#'></a>";if(a.firstChild&&typeof a.firstChild.getAttribute!=="undefined"&&a.firstChild.getAttribute("href")!=="#")n.attrHandle.href=function(a){return a.getAttribute("href",2)};a=null})();w.querySelectorAll&&function(){var a=v,b=w.createElement("div");b.innerHTML="<p class='TEST'></p>";if(!(b.querySelectorAll&&b.querySelectorAll(".TEST").length===0)){v=
function(b,c,d,j){c=c||w;if(!j&&!v.isXML(c)){var e=/^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(b);if(e&&(c.nodeType===1||c.nodeType===9)){if(e[1])return J(c.getElementsByTagName(b),d);if(e[2]&&n.find.CLASS&&c.getElementsByClassName)return J(c.getElementsByClassName(e[2]),d)}if(c.nodeType===9){if(b==="body"&&c.body)return J([c.body],d);if(e&&e[3]){var g=c.getElementById(e[3]);if(g&&g.parentNode){if(g.id===e[3])return J([g],d)}else return J([],d)}try{return J(c.querySelectorAll(b),d)}catch(f){}}else if(c.nodeType===
1&&c.nodeName.toLowerCase()!=="object"){var e=c,i=(g=c.getAttribute("id"))||"__sizzle__",k=c.parentNode,h=/^\s*[+~]/.test(b);g?i=i.replace(/'/g,"\\$&"):c.setAttribute("id",i);if(h&&k)c=c.parentNode;try{if(!h||k)return J(c.querySelectorAll("[id='"+i+"'] "+b),d)}catch(u){}finally{g||e.removeAttribute("id")}}}return a(b,c,d,j)};for(var c in a)v[c]=a[c];b=null}}();(function(){var a=w.documentElement,b=a.matchesSelector||a.mozMatchesSelector||a.webkitMatchesSelector||a.msMatchesSelector;if(b){var c=!b.call(w.createElement("div"),
"div"),d=false;try{b.call(w.documentElement,"[test!='']:sizzle")}catch(j){d=true}v.matchesSelector=function(a,j){j=j.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!v.isXML(a))try{if(d||!n.match.PSEUDO.test(j)&&!/!=/.test(j)){var e=b.call(a,j);if(e||!c||a.document&&a.document.nodeType!==11)return e}}catch(g){}return v(j,null,null,[a]).length>0}}})();(function(){var a=w.createElement("div");a.innerHTML="<div class='test e'></div><div class='test'></div>";if(a.getElementsByClassName&&a.getElementsByClassName("e").length!==
0){a.lastChild.className="e";if(a.getElementsByClassName("e").length!==1){n.order.splice(1,0,"CLASS");n.find.CLASS=function(a,b,c){if(typeof b.getElementsByClassName!=="undefined"&&!c)return b.getElementsByClassName(a[1])};a=null}}})();v.contains=w.documentElement.contains?function(a,b){return a!==b&&(a.contains?a.contains(b):true)}:w.documentElement.compareDocumentPosition?function(a,b){return!!(a.compareDocumentPosition(b)&16)}:function(){return false};v.isXML=function(a){return(a=(a?a.ownerDocument||
a:0).documentElement)?a.nodeName!=="HTML":false};var U=function(a,b,c){for(var d,j=[],e="",b=b.nodeType?[b]:b;d=n.match.PSEUDO.exec(a);){e=e+d[0];a=a.replace(n.match.PSEUDO,"")}a=n.relative[a]?a+"*":a;d=0;for(var g=b.length;d<g;d++)v(a,b[d],j,c);return v.filter(e,j)};v.attr=h.attr;v.selectors.attrMap={};h.find=v;h.expr=v.selectors;h.expr[":"]=h.expr.filters;h.unique=v.uniqueSort;h.text=v.getText;h.isXMLDoc=v.isXML;h.contains=v.contains})();var na=/Until$/,oa=/^(?:parents|prevUntil|prevAll)/,la=/,/,
Wa=/^.[^:#\[\.,]*$/,Xa=Array.prototype.slice,Ea=h.expr.match.globalPOS,Ya={children:!0,contents:!0,next:!0,prev:!0};h.fn.extend({find:function(a){var b=this,c,d;if(typeof a!=="string")return h(a).filter(function(){c=0;for(d=b.length;c<d;c++)if(h.contains(b[c],this))return true});var j=this.pushStack("","find",a),e,g,f;c=0;for(d=this.length;c<d;c++){e=j.length;h.find(a,this[c],j);if(c>0)for(g=e;g<j.length;g++)for(f=0;f<e;f++)if(j[f]===j[g]){j.splice(g--,1);break}}return j},has:function(a){var b=h(a);
return this.filter(function(){for(var a=0,c=b.length;a<c;a++)if(h.contains(this,b[a]))return true})},not:function(a){return this.pushStack(k(this,a,false),"not",a)},filter:function(a){return this.pushStack(k(this,a,true),"filter",a)},is:function(a){return!!a&&(typeof a==="string"?Ea.test(a)?h(a,this.context).index(this[0])>=0:h.filter(a,this).length>0:this.filter(a).length>0)},closest:function(a,b){var c=[],d,j,e=this[0];if(h.isArray(a)){for(j=1;e&&e.ownerDocument&&e!==b;){for(d=0;d<a.length;d++)h(e).is(a[d])&&
c.push({selector:a[d],elem:e,level:j});e=e.parentNode;j++}return c}var g=Ea.test(a)||typeof a!=="string"?h(a,b||this.context):0;d=0;for(j=this.length;d<j;d++)for(e=this[d];e;)if(g?g.index(e)>-1:h.find.matchesSelector(e,a)){c.push(e);break}else{e=e.parentNode;if(!e||!e.ownerDocument||e===b||e.nodeType===11)break}c=c.length>1?h.unique(c):c;return this.pushStack(c,"closest",a)},index:function(a){return!a?this[0]&&this[0].parentNode?this.prevAll().length:-1:typeof a==="string"?h.inArray(this[0],h(a)):
...
"iframe")?a.contentDocument||a.contentWindow.document:h.makeArray(a.childNodes)}},function(a,b){h.fn[a]=function(c,d){var j=h.map(this,b,c);na.test(a)||(d=c);d&&typeof d==="string"&&(j=h.filter(d,j));j=this.length>1&&!Ya[a]?h.unique(j):j;if((this.length>1||la.test(d))&&oa.test(a))j=j.reverse();return this.pushStack(j,a,Xa.call(arguments).join(","))}});h.extend({filter:function(a,b,c){c&&(a=":not("+a+")");return b.length===1?h.find.matchesSelector(b[0],a)?[b[0]]:[]:h.find.matches(a,b)},dir:function(a,
b,d){for(var j=[],a=a[b];a&&a.nodeType!==9&&(d===c||a.nodeType!==1||!h(a).is(d));){a.nodeType===1&&j.push(a);a=a[b]}return j},nth:function(a,b,c){for(var b=b||1,d=0;a;a=a[c])if(a.nodeType===1&&++d===b)break;return a},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)a.nodeType===1&&a!==b&&c.push(a);return c}});var Fa="abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",Za=/ jQuery\d+="(?:\d+|null)"/g,
ua=/^\s+/,Ga=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Ha=/<([\w:]+)/,$a=/<tbody/i,ab=/<|&#?\w+;/,bb=/<(?:script|style)/i,cb=/<(?:script|object|embed|option|style)/i,Ia=RegExp("<(?:"+Fa+")[\\s/>]","i"),Ja=/checked\s*(?:[^=]|=\s*.checked.)/i,Ka=/\/(java|ecma)script/i,fb=/^\s*<!(?:\[CDATA\[|\-\-)/,W={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,
"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]},Ba=l(w);W.optgroup=W.option;W.tbody=W.tfoot=W.colgroup=W.caption=W.thead;W.th=W.td;h.support.htmlSerialize||(W._default=[1,"div<div>","</div>"]);h.fn.extend({text:function(a){return h.access(this,function(a){return a===c?h.text(this):this.empty().append((this[0]&&this[0].ownerDocument||w).createTextNode(a))},null,a,arguments.length)},wrapAll:function(a){if(h.isFunction(a))return this.each(function(b){h(this).wrapAll(a.call(this,
...
h.cleanData([d])}d.parentNode&&d.parentNode.removeChild(d)}return this},empty:function(){for(var a=0,b;(b=this[a])!=null;a++)for(b.nodeType===1&&h.cleanData(b.getElementsByTagName("*"));b.firstChild;)b.removeChild(b.firstChild);return this},clone:function(a,b){a=a==null?false:a;b=b==null?a:b;return this.map(function(){return h.clone(this,a,b)})},html:function(a){return h.access(this,function(a){var b=this[0]||{},d=0,j=this.length;if(a===c)return b.nodeType===1?b.innerHTML.replace(Za,""):null;if(typeof a===
"string"&&!bb.test(a)&&(h.support.leadingWhitespace||!ua.test(a))&&!W[(Ha.exec(a)||["",""])[1].toLowerCase()]){a=a.replace(Ga,"<$1></$2>");try{for(;d<j;d++){b=this[d]||{};if(b.nodeType===1){h.cleanData(b.getElementsByTagName("*"));b.innerHTML=a}}b=0}catch(e){}}b&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){if(this[0]&&this[0].parentNode){if(h.isFunction(a))return this.each(function(b){var c=h(this),d=c.html();c.replaceWith(a.call(this,b,d))});typeof a!=="string"&&(a=
h(a).detach());return this.each(function(){var b=this.nextSibling,c=this.parentNode;h(this).remove();b?h(b).before(a):h(c).append(a)})}return this.length?this.pushStack(h(h.isFunction(a)?a():a),"replaceWith",a):this},detach:function(a){return this.remove(a,true)},domManip:function(a,b,d){var j,e,g,f=a[0],i=[];if(!h.support.checkClone&&arguments.length===3&&typeof f==="string"&&Ja.test(f))return this.each(function(){h(this).domManip(a,b,d,true)});if(h.isFunction(f))return this.each(function(j){var e=
h(this);a[0]=f.call(this,j,b?e.html():c);e.domManip(a,b,d)});if(this[0]){j=f&&f.parentNode;j=h.support.parentNode&&j&&j.nodeType===11&&j.childNodes.length===this.length?{fragment:j}:h.buildFragment(a,this,i);g=j.fragment;if(e=g.childNodes.length===1?g=g.firstChild:g.firstChild){b=b&&h.nodeName(e,"tr");e=0;for(var k=this.length,u=k-1;e<k;e++)d.call(b?h.nodeName(this[e],"table")?this[e].getElementsByTagName("tbody")[0]||this[e].appendChild(this[e].ownerDocument.createElement("tbody")):this[e]:this[e],
j.cacheable||k>1&&e<u?h.clone(g,true,true):g)}i.length&&h.each(i,function(a,b){b.src?h.ajax({type:"GET",global:false,url:b.src,async:false,dataType:"script"}):h.globalEval((b.text||b.textContent||b.innerHTML||"").replace(fb,"/*$0*/"));b.parentNode&&b.parentNode.removeChild(b)})}return this}});h.buildFragment=function(a,b,c){var d,j,e,g,f=a[0];b&&b[0]&&(g=b[0].ownerDocument||b[0]);g.createDocumentFragment||(g=w);if(a.length===1&&typeof f==="string"&&f.length<512&&g===w&&f.charAt(0)==="<"&&!cb.test(f)&&
(h.support.checkClone||!Ja.test(f))&&(h.support.html5Clone||!Ia.test(f))){j=true;(e=h.fragments[f])&&e!==1&&(d=e)}if(!d){d=g.createDocumentFragment();h.clean(a,g,d,c)}j&&(h.fragments[f]=e?d:1);return{fragment:d,cacheable:j}};h.fragments={};h.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){h.fn[a]=function(c){var d=[],c=h(c),j=this.length===1&&this[0].parentNode;if(j&&j.nodeType===11&&j.childNodes.length===1&&c.length===
1){c[b](this[0]);return this}for(var j=0,e=c.length;j<e;j++){var g=(j>0?this.clone(true):this).get();h(c[j])[b](g);d=d.concat(g)}return this.pushStack(d,a,c.selector)}});h.extend({clone:function(a,b,c){var d,j,e;if(h.support.html5Clone||h.isXMLDoc(a)||!Ia.test("<"+a.nodeName+">"))d=a.cloneNode(true);else{d=w.createElement("div");Ba.appendChild(d);d.innerHTML=a.outerHTML;d=d.firstChild}var g=d;if((!h.support.noCloneEvent||!h.support.noCloneChecked)&&(a.nodeType===1||a.nodeType===11)&&!h.isXMLDoc(a)){n(a,
g);d=m(a);j=m(g);for(e=0;d[e];++e)j[e]&&n(d[e],j[e])}if(b){o(a,g);if(c){d=m(a);j=m(g);for(e=0;d[e];++e)o(d[e],j[e])}}return g},clean:function(a,b,c,d){var j,e=[],b=b||w;typeof b.createElement==="undefined"&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||w);for(var g=0,f;(f=a[g])!=null;g++){typeof f==="number"&&(f=f+"");if(f){if(typeof f==="string")if(ab.test(f)){f=f.replace(Ga,"<$1></$2>");j=(Ha.exec(f)||["",""])[1].toLowerCase();var i=W[j]||W._default,k=i[0],u=b.createElement("div"),v=Ba.childNodes;
b===w?Ba.appendChild(u):l(b).appendChild(u);for(u.innerHTML=i[1]+f+i[2];k--;)u=u.lastChild;if(!h.support.tbody){k=$a.test(f);i=j==="table"&&!k?u.firstChild&&u.firstChild.childNodes:i[1]==="<table>"&&!k?u.childNodes:[];for(j=i.length-1;j>=0;--j)h.nodeName(i[j],"tbody")&&!i[j].childNodes.length&&i[j].parentNode.removeChild(i[j])}!h.support.leadingWhitespace&&ua.test(f)&&u.insertBefore(b.createTextNode(ua.exec(f)[0]),u.firstChild);f=u.childNodes;if(u){u.parentNode.removeChild(u);if(v.length>0)(u=v[v.length-
1])&&u.parentNode&&u.parentNode.removeChild(u)}}else f=b.createTextNode(f);var m;if(!h.support.appendChecked)if(f[0]&&typeof(m=f.length)==="number")for(j=0;j<m;j++)s(f[j]);else s(f);f.nodeType?e.push(f):e=h.merge(e,f)}}if(c){a=function(a){return!a.type||Ka.test(a.type)};for(g=0;e[g];g++){b=e[g];if(d&&h.nodeName(b,"script")&&(!b.type||Ka.test(b.type)))d.push(b.parentNode?b.parentNode.removeChild(b):b);else{if(b.nodeType===1){f=h.grep(b.getElementsByTagName("script"),a);e.splice.apply(e,[g+1,0].concat(f))}c.appendChild(b)}}}return e},
cleanData:function(a){for(var b,c,d=h.cache,j=h.event.special,e=h.support.deleteExpando,g=0,f;(f=a[g])!=null;g++)if(!f.nodeName||!h.noData[f.nodeName.toLowerCase()])if(c=f[h.expando]){if((b=d[c])&&b.events){for(var i in b.events)j[i]?h.event.remove(f,i):h.removeEvent(f,i,b.handle);if(b.handle)b.handle.elem=null}e?delete f[h.expando]:f.removeAttribute&&f.removeAttribute(h.expando);delete d[c]}}});var Ca=/alpha\([^)]*\)/i,gb=/opacity=([^)]*)/,hb=/([A-Z]|^ms)/g,ib=/^[\-+]?(?:\d*\.)?\d+$/i,wa=/^-?(?:\d*\.)?\d+(?!px)[^\d\s]+$/i,
jb=/^([\-+])=([\-+.\de]+)/,kb=/^margin/,lb={position:"absolute",visibility:"hidden",display:"block"},ca=["Top","Right","Bottom","Left"],fa,Ma,Na;h.fn.css=function(a,b){return h.access(this,function(a,b,d){return d!==c?h.style(a,b,d):h.css(a,b)},a,b,arguments.length>1)};h.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=fa(a,"opacity");return c===""?"1":c}return a.style.opacity}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":h.support.cssFloat?
"cssFloat":"styleFloat"},style:function(a,b,d,j){if(a&&!(a.nodeType===3||a.nodeType===8||!a.style)){var e,g=h.camelCase(b),f=a.style,i=h.cssHooks[g],b=h.cssProps[g]||g;if(d!==c){j=typeof d;if(j==="string"&&(e=jb.exec(d))){d=+(e[1]+1)*+e[2]+parseFloat(h.css(a,b));j="number"}if(!(d==null||j==="number"&&isNaN(d))){j==="number"&&!h.cssNumber[g]&&(d=d+"px");if(!i||!("set"in i)||(d=i.set(a,d))!==c)try{f[b]=d}catch(k){}}}else return i&&"get"in i&&(e=i.get(a,false,j))!==c?e:f[b]}},css:function(a,b,d){var j,
e,b=h.camelCase(b);e=h.cssHooks[b];b=h.cssProps[b]||b;b==="cssFloat"&&(b="float");if(e&&"get"in e&&(j=e.get(a,true,d))!==c)return j;if(fa)return fa(a,b)},swap:function(a,b,c){var d={},j;for(j in b){d[j]=a.style[j];a.style[j]=b[j]}c=c.call(a);for(j in b)a.style[j]=d[j];return c}});h.curCSS=h.css;w.defaultView&&w.defaultView.getComputedStyle&&(Ma=function(a,b){var c,d,j,e=a.style,b=b.replace(hb,"-$1").toLowerCase();if((d=a.ownerDocument.defaultView)&&(j=d.getComputedStyle(a,null))){c=j.getPropertyValue(b);
c===""&&!h.contains(a.ownerDocument.documentElement,a)&&(c=h.style(a,b))}if(!h.support.pixelMargin&&j&&kb.test(b)&&wa.test(c)){d=e.width;e.width=c;c=j.width;e.width=d}return c});w.documentElement.currentStyle&&(Na=function(a,b){var c,d,j=a.currentStyle&&a.currentStyle[b],e=a.style;if(j==null&&e&&(c=e[b]))j=c;if(wa.test(j)){c=e.left;if(d=a.runtimeStyle&&a.runtimeStyle.left)a.runtimeStyle.left=a.currentStyle.left;e.left=b==="fontSize"?"1em":j;j=e.pixelLeft+"px";e.left=c;if(d)a.runtimeStyle.left=d}return j===
""?"auto":j});fa=Ma||Na;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){if(c)return a.offsetWidth!==0?q(a,b,d):h.swap(a,lb,function(){return q(a,b,d)})},set:function(a,b){return ib.test(b)?b+"px":b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return gb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,j=h.isNumeric(b)?"alpha(opacity="+b*100+")":"",e=
d&&d.filter||c.filter||"";c.zoom=1;if(b>=1&&h.trim(e.replace(Ca,""))===""){c.removeAttribute("filter");if(d&&!d.filter)return}c.filter=Ca.test(e)?e.replace(Ca,j):e+" "+j}});h(function(){if(!h.support.reliableMarginRight)h.cssHooks.marginRight={get:function(a,b){return h.swap(a,{display:"inline-block"},function(){return b?fa(a,"margin-right"):a.style.marginRight})}}});h.expr&&h.expr.filters&&(h.expr.filters.hidden=function(a){var b=a.offsetHeight;return a.offsetWidth===0&&b===0||!h.support.reliableHiddenOffsets&&
(a.style&&a.style.display||h.css(a,"display"))==="none"},h.expr.filters.visible=function(a){return!h.expr.filters.hidden(a)});h.each({margin:"",padding:"",border:"Width"},function(a,b){h.cssHooks[a+b]={expand:function(c){for(var d=typeof c==="string"?c.split(" "):[c],j={},c=0;c<4;c++)j[a+ca[c]+b]=d[c]||d[c-2]||d[0];return j}}});var mb=/%20/g,db=/\[\]$/,Oa=/\r?\n/g,nb=/#.*$/,ob=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,pb=/^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
qb=/^(?:GET|HEAD)$/,rb=/^\/\//,Pa=/\?/,sb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,tb=/^(?:select|textarea)/i,La=/\s+/,ub=/([?&])_=[^&]*/,Qa=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Ra=h.fn.load,xa={},Sa={},da,ea,Ta=["*/"]+["*"];try{da=G.href}catch(Ab){da=w.createElement("a"),da.href="",da=da.href}ea=Qa.exec(da.toLowerCase())||[];h.fn.extend({load:function(a,b,d){if(typeof a!=="string"&&Ra)return Ra.apply(this,arguments);if(!this.length)return this;var j=a.indexOf(" ");if(j>=
0)var e=a.slice(j,a.length),a=a.slice(0,j);j="GET";if(b)if(h.isFunction(b)){d=b;b=c}else if(typeof b==="object"){b=h.param(b,h.ajaxSettings.traditional);j="POST"}var g=this;h.ajax({url:a,type:j,dataType:"html",data:b,complete:function(a,b,c){c=a.responseText;if(a.isResolved()){a.done(function(a){c=a});g.html(e?h("<div>").append(c.replace(sb,"")).find(e):c)}d&&g.each(d,[c,b,a])}});return this},serialize:function(){return h.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?
...
function(a,b){h[b]=function(a,d,j,e){if(h.isFunction(d)){e=e||j;j=d;d=c}return h.ajax({type:b,url:a,data:d,success:j,dataType:e})}});h.extend({getScript:function(a,b){return h.get(a,c,b,"script")},getJSON:function(a,b,c){return h.get(a,b,c,"json")},ajaxSetup:function(a,b){if(b)x(a,h.ajaxSettings);else{b=a;a=h.ajaxSettings}x(a,b);return a},ajaxSettings:{url:da,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/.test(ea[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",
processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":Ta},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:p(xa),ajaxTransport:p(Sa),ajax:function(a,b){function d(a,b,v,l){if(s!==2){s=2;r&&clearTimeout(r);o=c;m=l||"";p.readyState=
a>0?4:0;var n,J,K,l=b;if(v){var P=j,U=p,x=P.contents,aa=P.dataTypes,z=P.responseFields,t,w,ba,y;for(w in z)w in v&&(U[z[w]]=v[w]);for(;aa[0]==="*";){aa.shift();t===c&&(t=P.mimeType||U.getResponseHeader("content-type"))}if(t)for(w in x)if(x[w]&&x[w].test(t)){aa.unshift(w);break}if(aa[0]in v)ba=aa[0];else{for(w in v){if(!aa[0]||P.converters[w+" "+aa[0]]){ba=w;break}y||(y=w)}ba=ba||y}if(ba){ba!==aa[0]&&aa.unshift(ba);v=v[ba]}else v=void 0}else v=c;if(a>=200&&a<300||a===304){if(j.ifModified){if(t=p.getResponseHeader("Last-Modified"))h.lastModified[u]=
t;if(t=p.getResponseHeader("Etag"))h.etag[u]=t}if(a===304){l="notmodified";n=true}else try{t=j;t.dataFilter&&(v=t.dataFilter(v,t.dataType));var $=t.dataTypes;w={};var A,D,F=$.length,Y,B=$[0],C,E,G,H,I;for(A=1;A<F;A++){if(A===1)for(D in t.converters)typeof D==="string"&&(w[D.toLowerCase()]=t.converters[D]);C=B;B=$[A];if(B==="*")B=C;else if(C!=="*"&&C!==B){E=C+" "+B;G=w[E]||w["* "+B];if(!G){I=c;for(H in w){Y=H.split(" ");if(Y[0]===C||Y[0]==="*")if(I=w[Y[1]+" "+B]){H=w[H];H===true?G=I:I===true&&(G=H);
break}}}!G&&!I&&h.error("No conversion from "+E.replace(" "," to "));G!==true&&(v=G?G(v):I(H(v)))}}J=v;l="success";n=true}catch(M){l="parsererror";K=M}}else{K=l;if(!l||a){l="error";a<0&&(a=0)}}p.status=a;p.statusText=""+(b||l);n?f.resolveWith(e,[J,l,p]):f.rejectWith(e,[p,l,K]);p.statusCode(k);k=c;q&&g.trigger("ajax"+(n?"Success":"Error"),[p,j,n?J:K]);i.fireWith(e,[p,l]);if(q){g.trigger("ajaxComplete",[p,j]);--h.active||h.event.trigger("ajaxStop")}}}if(typeof a==="object"){b=a;a=c}var b=b||{},j=h.ajaxSetup({},
b),e=j.context||j,g=e!==j&&(e.nodeType||e instanceof h)?h(e):h.event,f=h.Deferred(),i=h.Callbacks("once memory"),k=j.statusCode||{},u,v={},l={},m,n,o,r,J,s=0,q,P,p={readyState:0,setRequestHeader:function(a,b){if(!s){var c=a.toLowerCase(),a=l[c]=l[c]||a;v[a]=b}return this},getAllResponseHeaders:function(){return s===2?m:null},getResponseHeader:function(a){var b;if(s===2){if(!n)for(n={};b=ob.exec(m);)n[b[1].toLowerCase()]=b[2];b=n[a.toLowerCase()]}return b===c?null:b},overrideMimeType:function(a){if(!s)j.mimeType=
a;return this},abort:function(a){a=a||"abort";o&&o.abort(a);d(0,a);return this}};f.promise(p);p.success=p.done;p.error=p.fail;p.complete=i.add;p.statusCode=function(a){if(a){var b;if(s<2)for(b in a)k[b]=[k[b],a[b]];else{b=a[p.status];p.then(b,b)}}return this};j.url=((a||j.url)+"").replace(nb,"").replace(rb,ea[1]+"//");j.dataTypes=h.trim(j.dataType||"*").toLowerCase().split(La);if(j.crossDomain==null){J=Qa.exec(j.url.toLowerCase());j.crossDomain=!(!J||!(J[1]!=ea[1]||J[2]!=ea[2]||(J[3]||(J[1]==="http:"?
80:443))!=(ea[3]||(ea[1]==="http:"?80:443))))}if(j.data&&j.processData&&typeof j.data!=="string")j.data=h.param(j.data,j.traditional);z(xa,j,b,p);if(s===2)return false;q=j.global;j.type=j.type.toUpperCase();j.hasContent=!qb.test(j.type);q&&h.active++===0&&h.event.trigger("ajaxStart");if(!j.hasContent){if(j.data){j.url=j.url+((Pa.test(j.url)?"&":"?")+j.data);delete j.data}u=j.url;if(j.cache===false){J=h.now();var U=j.url.replace(ub,"$1_="+J);j.url=U+(U===j.url?(Pa.test(j.url)?"&":"?")+"_="+J:"")}}(j.data&&
j.hasContent&&j.contentType!==false||b.contentType)&&p.setRequestHeader("Content-Type",j.contentType);if(j.ifModified){u=u||j.url;h.lastModified[u]&&p.setRequestHeader("If-Modified-Since",h.lastModified[u]);h.etag[u]&&p.setRequestHeader("If-None-Match",h.etag[u])}p.setRequestHeader("Accept",j.dataTypes[0]&&j.accepts[j.dataTypes[0]]?j.accepts[j.dataTypes[0]]+(j.dataTypes[0]!=="*"?", "+Ta+"; q=0.01":""):j.accepts["*"]);for(P in j.headers)p.setRequestHeader(P,j.headers[P]);if(j.beforeSend&&(j.beforeSend.call(e,
p,j)===false||s===2)){p.abort();return false}for(P in{success:1,error:1,complete:1})p[P](j[P]);if(o=z(Sa,j,b,p)){p.readyState=1;q&&g.trigger("ajaxSend",[p,j]);j.async&&j.timeout>0&&(r=setTimeout(function(){p.abort("timeout")},j.timeout));try{s=1;o.send(v,d)}catch(x){if(s<2)d(-1,x);else throw x;}}else d(-1,"No Transport");return p},param:function(a,b){var d=[],j=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(b===c)b=h.ajaxSettings.traditional;
if(h.isArray(a)||a.jquery&&!h.isPlainObject(a))h.each(a,function(){j(this.name,this.value)});else for(var e in a)y(e,a[e],b,j);return d.join("&").replace(mb,"+")}});h.extend({active:0,lastModified:{},etag:{}});var vb=h.now(),sa=/(\=)\?(&|$)|\?\?/i;h.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return h.expando+"_"+vb++}});h.ajaxPrefilter("json jsonp",function(b,c,d){c=typeof b.data==="string"&&/^application\/x\-www\-form\-urlencoded/.test(b.contentType);if(b.dataTypes[0]==="jsonp"||b.jsonp!==
false&&(sa.test(b.url)||c&&sa.test(b.data))){var j,e=b.jsonpCallback=h.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,g=a[e],f=b.url,i=b.data,k="$1"+e+"$2";if(b.jsonp!==false){f=f.replace(sa,k);if(b.url===f){c&&(i=i.replace(sa,k));b.data===i&&(f=f+((/\?/.test(f)?"&":"?")+b.jsonp+"="+e))}}b.url=f;b.data=i;a[e]=function(a){j=[a]};d.always(function(){a[e]=g;if(j&&h.isFunction(g))a[e](j[0])});b.converters["script json"]=function(){j||h.error(e+" was not called");return j[0]};b.dataTypes[0]=
"json";return"script"}});h.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/javascript|ecmascript/},converters:{"text script":function(a){h.globalEval(a);return a}}});h.ajaxPrefilter("script",function(a){if(a.cache===c)a.cache=false;if(a.crossDomain){a.type="GET";a.global=false}});h.ajaxTransport("script",function(a){if(a.crossDomain){var b,d=w.head||w.getElementsByTagName("head")[0]||w.documentElement;return{send:function(j,
e){b=w.createElement("script");b.async="async";if(a.scriptCharset)b.charset=a.scriptCharset;b.src=a.url;b.onload=b.onreadystatechange=function(a,j){if(j||!b.readyState||/loaded|complete/.test(b.readyState)){b.onload=b.onreadystatechange=null;d&&b.parentNode&&d.removeChild(b);b=c;j||e(200,"success")}};d.insertBefore(b,d.firstChild)},abort:function(){if(b)b.onload(0,1)}}}});var Da=a.ActiveXObject?function(){for(var a in ia)ia[a](0,1)}:!1,wb=0,ia;h.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=
!this.isLocal&&D()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:D;(function(a){h.extend(h.support,{ajax:!!a,cors:!!a&&"withCredentials"in a})})(h.ajaxSettings.xhr());h.support.ajax&&h.ajaxTransport(function(b){if(!b.crossDomain||h.support.cors){var d;return{send:function(j,e){var g=b.xhr(),f,i;b.username?g.open(b.type,b.url,b.async,b.username,b.password):g.open(b.type,b.url,b.async);if(b.xhrFields)for(i in b.xhrFields)g[i]=b.xhrFields[i];b.mimeType&&g.overrideMimeType&&
g.overrideMimeType(b.mimeType);!b.crossDomain&&!j["X-Requested-With"]&&(j["X-Requested-With"]="XMLHttpRequest");try{for(i in j)g.setRequestHeader(i,j[i])}catch(k){}g.send(b.hasContent&&b.data||null);d=function(a,j){var i,k,u,v,l;try{if(d&&(j||g.readyState===4)){d=c;if(f){g.onreadystatechange=h.noop;Da&&delete ia[f]}if(j)g.readyState!==4&&g.abort();else{i=g.status;u=g.getAllResponseHeaders();v={};if((l=g.responseXML)&&l.documentElement)v.xml=l;try{v.text=g.responseText}catch(m){}try{k=g.statusText}catch(n){k=
""}!i&&b.isLocal&&!b.crossDomain?i=v.text?200:404:i===1223&&(i=204)}}}catch(o){j||e(-1,o)}v&&e(i,k,v,u)};if(!b.async||g.readyState===4)d();else{f=++wb;if(Da){if(!ia){ia={};h(a).unload(Da)}ia[f]=d}g.onreadystatechange=d}},abort:function(){d&&d(0,1)}}}});var ya={},Z,ga,xb=/^(?:toggle|show|hide)$/,yb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,ta,qa=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],pa;h.fn.extend({show:function(a,
b,c){if(a||a===0)return this.animate(F("show",3),a,b,c);for(var c=0,d=this.length;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(!h._data(a,"olddisplay")&&b==="none")b=a.style.display="";(b===""&&h.css(a,"display")==="none"||!h.contains(a.ownerDocument.documentElement,a))&&h._data(a,"olddisplay",O(a.nodeName))}}for(c=0;c<d;c++){a=this[c];if(a.style){b=a.style.display;if(b===""||b==="none")a.style.display=h._data(a,"olddisplay")||""}}return this},hide:function(a,b,c){if(a||a===0)return this.animate(F("hide",
...
fadeTo:function(a,b,c,d){return this.filter(":hidden").css("opacity",0).show().end().animate({opacity:b},a,c,d)},animate:function(a,b,c,d){function j(){e.queue===false&&h._mark(this);var b=h.extend({},e),c=this.nodeType===1,d=c&&h(this).is(":hidden"),g,f,i,k,u;b.animatedProperties={};for(i in a){g=h.camelCase(i);if(i!==g){a[g]=a[i];delete a[i]}if((f=h.cssHooks[g])&&"expand"in f){k=f.expand(a[g]);delete a[g];for(i in k)i in a||(a[i]=k[i])}}for(g in a){f=a[g];if(h.isArray(f)){b.animatedProperties[g]=
f[1];f=a[g]=f[0]}else b.animatedProperties[g]=b.specialEasing&&b.specialEasing[g]||b.easing||"swing";if(f==="hide"&&d||f==="show"&&!d)return b.complete.call(this);if(c&&(g==="height"||g==="width")){b.overflow=[this.style.overflow,this.style.overflowX,this.style.overflowY];if(h.css(this,"display")==="inline"&&h.css(this,"float")==="none")!h.support.inlineBlockNeedsLayout||O(this.nodeName)==="inline"?this.style.display="inline-block":this.style.zoom=1}}if(b.overflow!=null)this.style.overflow="hidden";
for(i in a){c=new h.fx(this,b,i);f=a[i];if(xb.test(f))if(g=h._data(this,"toggle"+i)||(f==="toggle"?d?"show":"hide":0)){h._data(this,"toggle"+i,g==="show"?"hide":"show");c[g]()}else c[f]();else{g=yb.exec(f);k=c.cur();if(g){f=parseFloat(g[2]);u=g[3]||(h.cssNumber[i]?"":"px");if(u!=="px"){h.style(this,i,(f||1)+u);k=(f||1)/c.cur()*k;h.style(this,i,k+u)}g[1]&&(f=(g[1]==="-="?-1:1)*f+k);c.custom(k,f,u)}else c.custom(k,f,"")}}return true}var e=h.speed(b,c,d);if(h.isEmptyObject(a))return this.each(e.complete,
[false]);a=h.extend({},a);return e.queue===false?this.each(j):this.queue(e.queue,j)},stop:function(a,b,d){if(typeof a!=="string"){d=b;b=a;a=c}b&&a!==false&&this.queue(a||"fx",[]);return this.each(function(){var b,c=false,j=h.timers,e=h._data(this);d||h._unmark(true,this);if(a==null)for(b in e){if(e[b]&&e[b].stop&&b.indexOf(".run")===b.length-4){var g=e[b];h.removeData(this,b,true);g.stop(d)}}else if(e[b=a+".run"]&&e[b].stop){e=e[b];h.removeData(this,b,true);e.stop(d)}for(b=j.length;b--;)if(j[b].elem===
this&&(a==null||j[b].queue===a)){if(d)j[b](true);else j[b].saveState();c=true;j.splice(b,1)}(!d||!c)&&h.dequeue(this,a)})}});h.each({slideDown:F("show",1),slideUp:F("hide",1),slideToggle:F("toggle",1),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){h.fn[a]=function(a,c,d){return this.animate(b,a,c,d)}});h.extend({speed:function(a,b,c){var d=a&&typeof a==="object"?h.extend({},a):{complete:c||!c&&b||h.isFunction(a)&&a,duration:a,easing:c&&b||b&&!h.isFunction(b)&&
...
{}}});h.fx.prototype={update:function(){this.options.step&&this.options.step.call(this.elem,this.now,this);(h.fx.step[this.prop]||h.fx.step._default)(this)},cur:function(){if(this.elem[this.prop]!=null&&(!this.elem.style||this.elem.style[this.prop]==null))return this.elem[this.prop];var a,b=h.css(this.elem,this.prop);return isNaN(a=parseFloat(b))?!b||b==="auto"?0:b:a},custom:function(a,b,d){function j(a){return e.step(a)}var e=this,g=h.fx;this.startTime=pa||A();this.end=b;this.now=this.start=a;this.pos=
this.state=0;this.unit=d||this.unit||(h.cssNumber[this.prop]?"":"px");j.queue=this.options.queue;j.elem=this.elem;j.saveState=function(){h._data(e.elem,"fxshow"+e.prop)===c&&(e.options.hide?h._data(e.elem,"fxshow"+e.prop,e.start):e.options.show&&h._data(e.elem,"fxshow"+e.prop,e.end))};j()&&h.timers.push(j)&&!ta&&(ta=setInterval(g.tick,g.interval))},show:function(){var a=h._data(this.elem,"fxshow"+this.prop);this.options.orig[this.prop]=a||h.style(this.elem,this.prop);this.options.show=true;a!==c?
this.custom(this.cur(),a):this.custom(this.prop==="width"||this.prop==="height"?1:0,this.cur());h(this.elem).show()},hide:function(){this.options.orig[this.prop]=h._data(this.elem,"fxshow"+this.prop)||h.style(this.elem,this.prop);this.options.hide=true;this.custom(this.cur(),0)},step:function(a){var b,c=pa||A(),d=true,j=this.elem,e=this.options;if(a||c>=e.duration+this.startTime){this.now=this.end;this.pos=this.state=1;this.update();e.animatedProperties[this.prop]=true;for(b in e.animatedProperties)e.animatedProperties[b]!==
true&&(d=false);if(d){e.overflow!=null&&!h.support.shrinkWrapBlocks&&h.each(["","X","Y"],function(a,b){j.style["overflow"+b]=e.overflow[a]});e.hide&&h(j).hide();if(e.hide||e.show)for(b in e.animatedProperties){h.style(j,b,e.orig[b]);h.removeData(j,"fxshow"+b,true);h.removeData(j,"toggle"+b,true)}if(a=e.complete){e.complete=false;a.call(j)}}return false}if(e.duration==Infinity)this.now=c;else{a=c-this.startTime;this.state=a/e.duration;this.pos=h.easing[e.animatedProperties[this.prop]](this.state,a,
...
h.each(qa.concat.apply([],qa),function(a,b){b.indexOf("margin")&&(h.fx.step[b]=function(a){h.style(a.elem,b,Math.max(0,a.now)+a.unit)})});h.expr&&h.expr.filters&&(h.expr.filters.animated=function(a){return h.grep(h.timers,function(b){return a===b.elem}).length});var Ua,zb=/^t(?:able|d|h)$/i,Va=/^(?:body|html)$/i;Ua="getBoundingClientRect"in w.documentElement?function(a,b,c,d){try{d=a.getBoundingClientRect()}catch(j){}if(!d||!h.contains(c,a))return d?{top:d.top,left:d.left}:{top:0,left:0};a=b.body;
b=C(b);return{top:d.top+(b.pageYOffset||h.support.boxModel&&c.scrollTop||a.scrollTop)-(c.clientTop||a.clientTop||0),left:d.left+(b.pageXOffset||h.support.boxModel&&c.scrollLeft||a.scrollLeft)-(c.clientLeft||a.clientLeft||0)}}:function(a,b,c){var d,j=a.offsetParent,e=b.body;d=(b=b.defaultView)?b.getComputedStyle(a,null):a.currentStyle;for(var g=a.offsetTop,f=a.offsetLeft;(a=a.parentNode)&&a!==e&&a!==c;){if(h.support.fixedPosition&&d.position==="fixed")break;d=b?b.getComputedStyle(a,null):a.currentStyle;
g=g-a.scrollTop;f=f-a.scrollLeft;if(a===j){g=g+a.offsetTop;f=f+a.offsetLeft;if(h.support.doesNotAddBorder&&(!h.support.doesAddBorderForTableAndCells||!zb.test(a.nodeName))){g=g+(parseFloat(d.borderTopWidth)||0);f=f+(parseFloat(d.borderLeftWidth)||0)}j=a.offsetParent}if(h.support.subtractsBorderForOverflowNotVisible&&d.overflow!=="visible"){g=g+(parseFloat(d.borderTopWidth)||0);f=f+(parseFloat(d.borderLeftWidth)||0)}}if(d.position==="relative"||d.position==="static"){g=g+e.offsetTop;f=f+e.offsetLeft}if(h.support.fixedPosition&&
d.position==="fixed"){g=g+Math.max(c.scrollTop,e.scrollTop);f=f+Math.max(c.scrollLeft,e.scrollLeft)}return{top:g,left:f}};h.fn.offset=function(a){if(arguments.length)return a===c?this:this.each(function(b){h.offset.setOffset(this,a,b)});var b=this[0],d=b&&b.ownerDocument;return!d?null:b===d.body?h.offset.bodyOffset(b):Ua(b,d,d.documentElement)};h.offset={bodyOffset:function(a){var b=a.offsetTop,c=a.offsetLeft;if(h.support.doesNotIncludeMarginInBodyOffset){b=b+(parseFloat(h.css(a,"marginTop"))||0);
c=c+(parseFloat(h.css(a,"marginLeft"))||0)}return{top:b,left:c}},setOffset:function(a,b,c){var d=h.css(a,"position");if(d==="static")a.style.position="relative";var j=h(a),e=j.offset(),g=h.css(a,"top"),f=h.css(a,"left"),i={},k={};if((d==="absolute"||d==="fixed")&&h.inArray("auto",[g,f])>-1){k=j.position();d=k.top;f=k.left}else{d=parseFloat(g)||0;f=parseFloat(f)||0}h.isFunction(b)&&(b=b.call(a,c,e));if(b.top!=null)i.top=b.top-e.top+d;if(b.left!=null)i.left=b.left-e.left+f;"using"in b?b.using.call(a,
i):j.css(i)}};h.fn.extend({position:function(){if(!this[0])return null;var a=this[0],b=this.offsetParent(),c=this.offset(),d=Va.test(b[0].nodeName)?{top:0,left:0}:b.offset();c.top=c.top-(parseFloat(h.css(a,"marginTop"))||0);c.left=c.left-(parseFloat(h.css(a,"marginLeft"))||0);d.top=d.top+(parseFloat(h.css(b[0],"borderTopWidth"))||0);d.left=d.left+(parseFloat(h.css(b[0],"borderLeftWidth"))||0);return{top:c.top-d.top,left:c.left-d.left}},offsetParent:function(){return this.map(function(){for(var a=
this.offsetParent||w.body;a&&!Va.test(a.nodeName)&&h.css(a,"position")==="static";)a=a.offsetParent;return a})}});h.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(a,b){var d=/Y/.test(b);h.fn[a]=function(j){return h.access(this,function(a,j,e){var g=C(a);if(e===c)return g?b in g?g[b]:h.support.boxModel&&g.document.documentElement[j]||g.document.body[j]:a[j];g?g.scrollTo(!d?e:h(g).scrollLeft(),d?e:h(g).scrollTop()):a[j]=e},a,j,arguments.length,null)}});h.each({Height:"height",Width:"width"},
function(a,b){var d="client"+a,j="scroll"+a,e="offset"+a;h.fn["inner"+a]=function(){var a=this[0];return a?a.style?parseFloat(h.css(a,b,"padding")):this[b]():null};h.fn["outer"+a]=function(a){var c=this[0];return c?c.style?parseFloat(h.css(c,b,a?"margin":"border")):this[b]():null};h.fn[b]=function(a){return h.access(this,function(a,b,g){if(h.isWindow(a)){b=a.document;a=b.documentElement[d];return h.support.boxModel&&a||b.body&&b.body[d]||a}if(a.nodeType===9){b=a.documentElement;return b[d]>=b[j]?
b[d]:Math.max(a.body[j],b[j],a.body[e],b[e])}if(g===c){a=h.css(a,b);b=parseFloat(a);return h.isNumeric(b)?b:a}h(a).css(b,g)},b,a,arguments.length,null)}});a.jQuery=a.$=h;"function"===typeof define&&define.amd&&define.amd.jQuery&&define("jquery",[],function(){return h})})(window);
...
"mousedown")+".ui-disableSelection",function(a){a.preventDefault()})},enableSelection:function(){return this.unbind(".ui-disableSelection")}}),a.each(["Width","Height"],function(d,e){function f(c,d,e,g){a.each(b,function(){d-=parseFloat(a.curCSS(c,"padding"+this,!0))||0;e&&(d-=parseFloat(a.curCSS(c,"border"+this+"Width",!0))||0);g&&(d-=parseFloat(a.curCSS(c,"margin"+this,!0))||0)});return d}var b="Width"===e?["Left","Right"]:["Top","Bottom"],k=e.toLowerCase(),l={innerWidth:a.fn.innerWidth,innerHeight:a.fn.innerHeight,
outerWidth:a.fn.outerWidth,outerHeight:a.fn.outerHeight};a.fn["inner"+e]=function(b){return b===c?l["inner"+e].call(this):this.each(function(){a(this).css(k,f(this,b)+"px")})};a.fn["outer"+e]=function(b,c){return"number"!==typeof b?l["outer"+e].call(this,b):this.each(function(){a(this).css(k,f(this,b,!0,c)+"px")})}}),a.extend(a.expr[":"],{data:function(c,d,e){return!!a.data(c,e[3])},focusable:function(c){return d(c,!isNaN(a.attr(c,"tabindex")))},tabbable:function(c){var e=a.attr(c,"tabindex"),f=isNaN(e);
...
f=d.offset.left,b=f+e.helperProportions.width,k=d.offset.top,l=k+e.helperProportions.height,o=e.snapElements.length-1;0<=o;o--){var n=e.snapElements[o].left,m=n+e.snapElements[o].width,r=e.snapElements[o].top,s=r+e.snapElements[o].height;if(n-i<f&&f<m+i&&r-i<k&&k<s+i||n-i<f&&f<m+i&&r-i<l&&l<s+i||n-i<b&&b<m+i&&r-i<k&&k<s+i||n-i<b&&b<m+i&&r-i<l&&l<s+i){if("inner"!=g.snapMode){var q=Math.abs(r-l)<=i,p=Math.abs(s-k)<=i,z=Math.abs(n-b)<=i,x=Math.abs(m-f)<=i;q&&(d.position.top=e._convertPositionTo("relative",
{top:r-e.helperProportions.height,left:0}).top-e.margins.top);p&&(d.position.top=e._convertPositionTo("relative",{top:s,left:0}).top-e.margins.top);z&&(d.position.left=e._convertPositionTo("relative",{top:0,left:n-e.helperProportions.width}).left-e.margins.left);x&&(d.position.left=e._convertPositionTo("relative",{top:0,left:m}).left-e.margins.left)}var y=q||p||z||x;if("outer"!=g.snapMode&&(q=Math.abs(r-k)<=i,p=Math.abs(s-l)<=i,z=Math.abs(n-f)<=i,x=Math.abs(m-b)<=i,q&&(d.position.top=e._convertPositionTo("relative",
{top:r,left:0}).top-e.margins.top),p&&(d.position.top=e._convertPositionTo("relative",{top:s-e.helperProportions.height,left:0}).top-e.margins.top),z&&(d.position.left=e._convertPositionTo("relative",{top:0,left:n}).left-e.margins.left),x))d.position.left=e._convertPositionTo("relative",{top:0,left:m-e.helperProportions.width}).left-e.margins.left;!e.snapElements[o].snapping&&(q||p||z||x||y)&&e.options.snap.snap&&e.options.snap.snap.call(e.element,c,a.extend(e._uiHash(),{snapItem:e.snapElements[o].item}));
e.snapElements[o].snapping=q||p||z||x||y}else e.snapElements[o].snapping&&e.options.snap.release&&e.options.snap.release.call(e.element,c,a.extend(e._uiHash(),{snapItem:e.snapElements[o].item})),e.snapElements[o].snapping=!1}}});a.ui.plugin.add("draggable","stack",{start:function(){var c=a(this).data("draggable").options,c=a.makeArray(a(c.stack)).sort(function(c,d){return(parseInt(a(c).css("zIndex"),10)||0)-(parseInt(a(d).css("zIndex"),10)||0)});if(c.length){var d=parseInt(c[0].style.zIndex)||0;a(c).each(function(a){this.style.zIndex=
...
!1},ui:function(a){return{draggable:a.currentItem||a.element,helper:a.helper,position:a.position,offset:a.positionAbs}}});a.extend(a.ui.droppable,{version:"1.8.20"});a.ui.intersect=function(c,d,e){if(!d.offset)return!1;var g=(c.positionAbs||c.position.absolute).left,i=g+c.helperProportions.width,f=(c.positionAbs||c.position.absolute).top,b=f+c.helperProportions.height,k=d.offset.left,l=k+d.proportions.width,o=d.offset.top,n=o+d.proportions.height;switch(e){case "fit":return k<=g&&i<=l&&o<=f&&b<=n;
case "intersect":return k<g+c.helperProportions.width/2&&i-c.helperProportions.width/2<l&&o<f+c.helperProportions.height/2&&b-c.helperProportions.height/2<n;case "pointer":return a.ui.isOver((c.positionAbs||c.position.absolute).top+(c.clickOffset||c.offset.click).top,(c.positionAbs||c.position.absolute).left+(c.clickOffset||c.offset.click).left,o,k,d.proportions.height,d.proportions.width);case "touch":return(f>=o&&f<=n||b>=o&&b<=n||f<o&&b>n)&&(g>=k&&g<=l||i>=k&&i<=l||g<k&&i>l);default:return!1}};
...
this._vBoundaries,i=this.axis,f=d(a.width)&&c.maxWidth&&c.maxWidth<a.width,b=d(a.height)&&c.maxHeight&&c.maxHeight<a.height,k=d(a.width)&&c.minWidth&&c.minWidth>a.width,l=d(a.height)&&c.minHeight&&c.minHeight>a.height;k&&(a.width=c.minWidth);l&&(a.height=c.minHeight);f&&(a.width=c.maxWidth);b&&(a.height=c.maxHeight);var o=this.originalPosition.left+this.originalSize.width,n=this.position.top+this.size.height,m=/sw|nw|w/.test(i),i=/nw|ne|n/.test(i);k&&m&&(a.left=o-c.minWidth);f&&m&&(a.left=o-c.maxWidth);
...
d){b[a]=c(f.css("padding"+d))});d.containerOffset=f.offset();d.containerPosition=f.position();d.containerSize={height:f.innerHeight()-b[3],width:f.innerWidth()-b[1]};var i=d.containerOffset,k=d.containerSize.height,l=d.containerSize.width,l=a.ui.hasScroll(g,"left")?g.scrollWidth:l,k=a.ui.hasScroll(g)?g.scrollHeight:k;d.parentData={element:g,left:i.left,top:i.top,width:l,height:k}}},resize:function(c){var d=a(this).data("resizable"),i=d.options,f=d.containerOffset,b=d.position,c=d._aspectRatio||c.shiftKey,
k={top:0,left:0},l=d.containerElement;l[0]!=document&&/static/.test(l.css("position"))&&(k=f);if(b.left<(d._helper?f.left:0))d.size.width+=d._helper?d.position.left-f.left:d.position.left-k.left,c&&(d.size.height=d.size.width/d.aspectRatio),d.position.left=i.helper?f.left:0;if(b.top<(d._helper?f.top:0))d.size.height+=d._helper?d.position.top-f.top:d.position.top,c&&(d.size.width=d.size.height*d.aspectRatio),d.position.top=d._helper?f.top:0;d.offset.left=d.parentData.left+d.position.left;d.offset.top=
d.parentData.top+d.position.top;i=Math.abs(d.offset.left-k.left+d.sizeDiff.width);f=Math.abs((d._helper?d.offset.top-k.top:d.offset.top-f.top)+d.sizeDiff.height);b=d.containerElement.get(0)==d.element.parent().get(0);k=/relative|absolute/.test(d.containerElement.css("position"));b&&k&&(i-=d.parentData.left);i+d.size.width>=d.parentData.width&&(d.size.width=d.parentData.width-i,c&&(d.size.height=d.size.width/d.aspectRatio));f+d.size.height>=d.parentData.height&&(d.size.height=d.parentData.height-f,
c&&(d.size.width=d.size.height*d.aspectRatio))},stop:function(){var c=a(this).data("resizable"),d=c.options,i=c.containerOffset,f=c.containerPosition,b=c.containerElement,k=a(c.helper),l=k.offset(),o=k.outerWidth()-c.sizeDiff.width,k=k.outerHeight()-c.sizeDiff.height;c._helper&&!d.animate&&/relative/.test(b.css("position"))&&a(this).css({left:l.left-f.left-i.left,width:o,height:k});c._helper&&!d.animate&&/static/.test(b.css("position"))&&a(this).css({left:l.left-f.left-i.left,width:o,height:k})}});
...
this;this.dragged=!0;if(!this.options.disabled){var e=this.options,g=this.opos[0],i=this.opos[1],f=c.pageX,b=c.pageY;if(g>f)var k=f,f=g,g=k;i>b&&(k=b,b=i,i=k);this.helper.css({left:g,top:i,width:f-g,height:b-i});this.selectees.each(function(){var k=a.data(this,"selectable-item");if(k&&k.element!=d.element[0]){var o=false;e.tolerance=="touch"?o=!(k.left>f||k.right<g||k.top>b||k.bottom<i):e.tolerance=="fit"&&(o=k.left>g&&k.right<f&&k.top>i&&k.bottom<b);if(o){if(k.selected){k.$element.removeClass("ui-selected");
...
this._getItemsAsjQuery(c&&c.connected),e=[],c=c||{};d.each(function(){e.push(a(c.item||this).attr(c.attribute||"id")||"")});return e},_intersectsWith:function(a){var d=this.positionAbs.left,e=d+this.helperProportions.width,g=this.positionAbs.top,i=g+this.helperProportions.height,f=a.left,b=f+a.width,k=a.top,l=k+a.height,o=this.offset.click.top,n=this.offset.click.left;return"pointer"==this.options.tolerance||this.options.forcePointerForContainers||"pointer"!=this.options.tolerance&&this.helperProportions[this.floating?
"width":"height"]>a[this.floating?"width":"height"]?g+o>k&&g+o<l&&d+n>f&&d+n<b:f<d+this.helperProportions.width/2&&e-this.helperProportions.width/2<b&&k<g+this.helperProportions.height/2&&i-this.helperProportions.height/2<l},_intersectsWithPointer:function(c){var d="x"===this.options.axis||a.ui.isOverAxis(this.positionAbs.top+this.offset.click.top,c.top,c.height),c="y"===this.options.axis||a.ui.isOverAxis(this.positionAbs.left+this.offset.click.left,c.left,c.width),d=d&&c,c=this._getDragVerticalDirection(),
...
this._connectWith();if(g&&this.ready)for(var i=g.length-1;0<=i;i--)for(var f=a(g[i]),b=f.length-1;0<=b;b--){var k=a.data(f[b],this.widgetName);k&&k!=this&&!k.options.disabled&&(e.push([a.isFunction(k.options.items)?k.options.items.call(k.element[0],c,{item:this.currentItem}):a(k.options.items,k.element),k]),this.containers.push(k))}for(i=e.length-1;0<=i;i--){c=e[i][1];g=e[i][0];b=0;for(f=g.length;b<f;b++)k=a(g[b]),k.data(this.widgetName+"-item",c),d.push({item:k,instance:c,width:0,height:0,left:0,
...
d:d in a.fx.speeds?a.fx.speeds[d]:a.fx.speeds._default;e=e||c.complete;return[b,c,d,e]}function b(b){return!b||"number"===typeof b||a.fx.speeds[b]||"string"===typeof b&&!a.effects[b]?!0:!1}a.effects={};a.each("backgroundColor,borderBottomColor,borderLeftColor,borderRightColor,borderTopColor,borderColor,color,outlineColor".split(","),function(b,c){a.fx.step[c]=function(b){if(!b.colorInit){var e;e=b.elem;var f=c,k;do{k=a.curCSS(e,f);if(k!=""&&k!="transparent"||a.nodeName(e,"body"))break;f="backgroundColor"}while(e=
e.parentNode);e=d(k);b.start=e;b.end=d(b.end);b.colorInit=true}b.elem.style[c]="rgb("+Math.max(Math.min(parseInt(b.pos*(b.end[0]-b.start[0])+b.start[0],10),255),0)+","+Math.max(Math.min(parseInt(b.pos*(b.end[1]-b.start[1])+b.start[1],10),255),0)+","+Math.max(Math.min(parseInt(b.pos*(b.end[2]-b.start[2])+b.start[2],10),255),0)+")"}});var k={aqua:[0,255,255],azure:[240,255,255],beige:[245,245,220],black:[0,0,0],blue:[0,0,255],brown:[165,42,42],cyan:[0,255,255],darkblue:[0,0,139],darkcyan:[0,139,139],
darkgrey:[169,169,169],darkgreen:[0,100,0],darkkhaki:[189,183,107],darkmagenta:[139,0,139],darkolivegreen:[85,107,47],darkorange:[255,140,0],darkorchid:[153,50,204],darkred:[139,0,0],darksalmon:[233,150,122],darkviolet:[148,0,211],fuchsia:[255,0,255],gold:[255,215,0],green:[0,128,0],indigo:[75,0,130],khaki:[240,230,140],lightblue:[173,216,230],lightcyan:[224,255,255],lightgreen:[144,238,144],lightgrey:[211,211,211],lightpink:[255,182,193],lightyellow:[255,255,224],lime:[0,255,0],magenta:[255,0,255],
maroon:[128,0,0],navy:[0,0,128],olive:[128,128,0],orange:[255,165,0],pink:[255,192,203],purple:[128,0,128],violet:[128,0,128],red:[255,0,0],silver:[192,192,192],white:[255,255,255],yellow:[255,255,0],transparent:[255,255,255]},l=["add","remove","toggle"],o={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};a.effects.animateClass=function(b,c,d,f){a.isFunction(d)&&(f=d,d=null);return this.queue(function(){var k=a(this),o=k.attr("style")||
" ",z=g(e.call(this)),x,y=k.attr("class")||"";a.each(l,function(a,c){if(b[c])k[c+"Class"](b[c])});x=g(e.call(this));k.attr("class",y);k.animate(i(z,x),{queue:false,duration:c,easing:d,complete:function(){a.each(l,function(a,c){if(b[c])k[c+"Class"](b[c])});if(typeof k.attr("style")=="object"){k.attr("style").cssText="";k.attr("style").cssText=o}else k.attr("style",o);f&&f.apply(this,arguments);a.dequeue(this)}})})};a.fn.extend({_addClass:a.fn.addClass,addClass:function(b,c,d,e){return c?a.effects.animateClass.apply(this,
[{add:b},c,d,e]):this._addClass(b)},_removeClass:a.fn.removeClass,removeClass:function(b,c,d,e){return c?a.effects.animateClass.apply(this,[{remove:b},c,d,e]):this._removeClass(b)},_toggleClass:a.fn.toggleClass,toggleClass:function(b,d,e,f,k){return"boolean"==typeof d||d===c?e?a.effects.animateClass.apply(this,[d?{add:b}:{remove:b},e,f,k]):this._toggleClass(b,d):a.effects.animateClass.apply(this,[{toggle:b},d,e,f])},switchClass:function(b,c,d,e,f){return a.effects.animateClass.apply(this,[{add:c,
...
c):b},setTransition:function(b,c,d,e){e=e||{};a.each(c,function(a,c){var f=b.cssUnit(c);0<f[0]&&(e[c]=f[0]*d+f[1])});return e}});a.fn.extend({effect:function(b,c,d,e){var k=f.apply(this,arguments),g={options:k[1],duration:k[2],callback:k[3]},k=g.options.mode,i=a.effects[b];return a.fx.off||!i?k?this[k](g.duration,g.callback):this.each(function(){g.callback&&g.callback.call(this)}):i.call(this,g)},_show:a.fn.show,show:function(a){if(b(a))return this._show.apply(this,arguments);var c=f.apply(this,arguments);
...
2)+c},easeInCirc:function(a,b,c,d,e){return-d*(Math.sqrt(1-(b/=e)*b)-1)+c},easeOutCirc:function(a,b,c,d,e){return d*Math.sqrt(1-(b=b/e-1)*b)+c},easeInOutCirc:function(a,b,c,d,e){return 1>(b/=e/2)?-d/2*(Math.sqrt(1-b*b)-1)+c:d/2*(Math.sqrt(1-(b-=2)*b)+1)+c},easeInElastic:function(a,b,c,d,e){var a=1.70158,f=0,k=d;if(0==b)return c;if(1==(b/=e))return c+d;f||(f=0.3*e);k<Math.abs(d)?(k=d,a=f/4):a=f/(2*Math.PI)*Math.asin(d/k);return-(k*Math.pow(2,10*(b-=1))*Math.sin((b*e-a)*2*Math.PI/f))+c},easeOutElastic:function(a,
b,c,d,e){var a=1.70158,f=0,k=d;if(0==b)return c;if(1==(b/=e))return c+d;f||(f=0.3*e);k<Math.abs(d)?(k=d,a=f/4):a=f/(2*Math.PI)*Math.asin(d/k);return k*Math.pow(2,-10*b)*Math.sin((b*e-a)*2*Math.PI/f)+d+c},easeInOutElastic:function(a,b,c,d,e){var a=1.70158,f=0,k=d;if(0==b)return c;if(2==(b/=e/2))return c+d;f||(f=e*0.3*1.5);k<Math.abs(d)?(k=d,a=f/4):a=f/(2*Math.PI)*Math.asin(d/k);return 1>b?-0.5*k*Math.pow(2,10*(b-=1))*Math.sin((b*e-a)*2*Math.PI/f)+c:0.5*k*Math.pow(2,-10*(b-=1))*Math.sin((b*e-a)*2*Math.PI/
f)+d+c},easeInBack:function(a,b,d,e,f,k){k==c&&(k=1.70158);return e*(b/=f)*b*((k+1)*b-k)+d},easeOutBack:function(a,b,d,e,f,k){k==c&&(k=1.70158);return e*((b=b/f-1)*b*((k+1)*b+k)+1)+d},easeInOutBack:function(a,b,d,e,f,k){k==c&&(k=1.70158);return 1>(b/=f/2)?e/2*b*b*(((k*=1.525)+1)*b-k)+d:e/2*((b-=2)*b*(((k*=1.525)+1)*b+k)+2)+d},easeInBounce:function(b,c,d,e,f){return e-a.easing.easeOutBounce(b,f-c,0,e,f)+d},easeOutBounce:function(a,b,c,d,e){return(b/=e)<1/2.75?d*7.5625*b*b+c:b<2/2.75?d*(7.5625*(b-=
...
(function(a){a.effects.blind=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],g=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.direction||"vertical";a.effects.save(d,e);d.show();var f=a.effects.createWrapper(d).css({overflow:"hidden"}),b="vertical"==i?"height":"width",i="vertical"==i?f.height():f.width();"show"==g&&f.css(b,0);var k={};k[b]="show"==g?i:0;f.animate(k,c.duration,c.options.easing,function(){"hide"==g&&d.hide();a.effects.restore(d,
e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
(function(a){a.effects.bounce=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],g=a.effects.setMode(d,c.options.mode||"effect"),i=c.options.direction||"up",f=c.options.distance||20,b=c.options.times||5,k=c.duration||250;/show|hide/.test(g)&&e.push("opacity");a.effects.save(d,e);d.show();a.effects.createWrapper(d);var l="up"==i||"down"==i?"top":"left",i="up"==i||"left"==i?"pos":"neg",f=c.options.distance||("top"==l?d.outerHeight({margin:!0})/3:d.outerWidth({margin:!0})/
3);"show"==g&&d.css("opacity",0).css(l,"pos"==i?-f:f);"hide"==g&&(f/=2*b);"hide"!=g&&b--;if("show"==g){var o={opacity:1};o[l]=("pos"==i?"+=":"-=")+f;d.animate(o,k/2,c.options.easing);f/=2;b--}for(o=0;o<b;o++){var n={},m={};n[l]=("pos"==i?"-=":"+=")+f;m[l]=("pos"==i?"+=":"-=")+f;d.animate(n,k/2,c.options.easing).animate(m,k/2,c.options.easing);f="hide"==g?2*f:f/2}"hide"==g?(o={opacity:0},o[l]=("pos"==i?"-=":"+=")+f,d.animate(o,k/2,c.options.easing,function(){d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);
c.callback&&c.callback.apply(this,arguments)})):(n={},m={},n[l]=("pos"==i?"-=":"+=")+f,m[l]=("pos"==i?"+=":"-=")+f,d.animate(n,k/2,c.options.easing).animate(m,k/2,c.options.easing,function(){a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments)}));d.queue("fx",function(){d.dequeue()});d.dequeue()})}})(jQuery);
(function(a){a.effects.clip=function(c){return this.queue(function(){var d=a(this),e="position,top,bottom,left,right,height,width".split(","),g=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.direction||"vertical";a.effects.save(d,e);d.show();var f=a.effects.createWrapper(d).css({overflow:"hidden"}),f="IMG"==d[0].tagName?f:d,b="vertical"==i?"height":"width",k="vertical"==i?"top":"left",i="vertical"==i?f.height():f.width();"show"==g&&(f.css(b,0),f.css(k,i/2));var l={};l[b]="show"==g?i:0;l[k]=
...
(function(a){a.effects.drop=function(c){return this.queue(function(){var d=a(this),e="position,top,bottom,left,right,opacity".split(","),g=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.direction||"left";a.effects.save(d,e);d.show();a.effects.createWrapper(d);var f="up"==i||"down"==i?"top":"left",i="up"==i||"left"==i?"pos":"neg",b=c.options.distance||("top"==f?d.outerHeight({margin:!0})/2:d.outerWidth({margin:!0})/2);"show"==g&&d.css("opacity",0).css(f,"pos"==i?-b:b);var k={opacity:"show"==
g?1:0};k[f]=("show"==g?"pos"==i?"+=":"-=":"pos"==i?"-=":"+=")+b;d.animate(k,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){"hide"==g&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
(function(a){a.effects.explode=function(c){return this.queue(function(){var d=c.options.pieces?Math.round(Math.sqrt(c.options.pieces)):3,e=c.options.pieces?Math.round(Math.sqrt(c.options.pieces)):3;c.options.mode="toggle"==c.options.mode?a(this).is(":visible")?"hide":"show":c.options.mode;var g=a(this).show().css("visibility","hidden"),i=g.offset();i.top-=parseInt(g.css("marginTop"),10)||0;i.left-=parseInt(g.css("marginLeft"),10)||0;for(var f=g.outerWidth(!0),b=g.outerHeight(!0),k=0;k<d;k++)for(var l=
0;l<e;l++)g.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-l*(f/e),top:-k*(b/d)}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:f/e,height:b/d,left:i.left+l*(f/e)+("show"==c.options.mode?(l-Math.floor(e/2))*(f/e):0),top:i.top+k*(b/d)+("show"==c.options.mode?(k-Math.floor(d/2))*(b/d):0),opacity:"show"==c.options.mode?0:1}).animate({left:i.left+l*(f/e)+("show"==c.options.mode?0:(l-Math.floor(e/2))*(f/e)),top:i.top+
k*(b/d)+("show"==c.options.mode?0:(k-Math.floor(d/2))*(b/d)),opacity:"show"==c.options.mode?1:0},c.duration||500);setTimeout(function(){"show"==c.options.mode?g.css({visibility:"visible"}):g.css({visibility:"visible"}).hide();c.callback&&c.callback.apply(g[0]);g.dequeue();a("div.ui-effects-explode").remove()},c.duration||500)})}})(jQuery);
...
(function(a){a.effects.fold=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],g=a.effects.setMode(d,c.options.mode||"hide"),i=c.options.size||15,f=!!c.options.horizFirst,b=c.duration?c.duration/2:a.fx.speeds._default/2;a.effects.save(d,e);d.show();var k=a.effects.createWrapper(d).css({overflow:"hidden"}),l="show"==g!=f,o=l?["width","height"]:["height","width"],l=l?[k.width(),k.height()]:[k.height(),k.width()],n=/([0-9]+)%/.exec(i);n&&(i=parseInt(n[1],
10)/100*l["hide"==g?0:1]);"show"==g&&k.css(f?{height:0,width:i}:{height:i,width:0});f={};n={};f[o[0]]="show"==g?l[0]:i;n[o[1]]="show"==g?l[1]:0;k.animate(f,b,c.options.easing).animate(n,b,c.options.easing,function(){"hide"==g&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(d[0],arguments);d.dequeue()})})}})(jQuery);
...
c.options.mode||"effect"),o=c.options.restore||!1,n=c.options.scale||"both",m=c.options.origin,r={height:d.height(),width:d.width()};d.from=c.options.from||r;d.to=c.options.to||r;m&&(m=a.effects.getBaseline(m,r),d.from.top=(r.height-d.from.height)*m.y,d.from.left=(r.width-d.from.width)*m.x,d.to.top=(r.height-d.to.height)*m.y,d.to.left=(r.width-d.to.width)*m.x);var s=d.from.height/r.height,q=d.from.width/r.width,p=d.to.height/r.height,z=d.to.width/r.width;if("box"==n||"both"==n)if(s!=p&&(e=e.concat(b),
d.from=a.effects.setTransition(d,b,s,d.from),d.to=a.effects.setTransition(d,b,p,d.to)),q!=z)e=e.concat(k),d.from=a.effects.setTransition(d,k,q,d.from),d.to=a.effects.setTransition(d,k,z,d.to);if(("content"==n||"both"==n)&&s!=p)e=e.concat(f),d.from=a.effects.setTransition(d,f,s,d.from),d.to=a.effects.setTransition(d,f,p,d.to);a.effects.save(d,o?e:g);d.show();a.effects.createWrapper(d);d.css("overflow","hidden").css(d.from);if("content"==n||"both"==n)b=b.concat(["marginTop","marginBottom"]).concat(f),
k=k.concat(["marginLeft","marginRight"]),i=e.concat(b).concat(k),d.find("*[width]").each(function(){var d=a(this);o&&a.effects.save(d,i);var e=d.height(),f=d.width();d.from={height:e*s,width:f*q};d.to={height:e*p,width:f*z};if(s!=p){d.from=a.effects.setTransition(d,b,s,d.from);d.to=a.effects.setTransition(d,b,p,d.to)}if(q!=z){d.from=a.effects.setTransition(d,k,q,d.from);d.to=a.effects.setTransition(d,k,z,d.to)}d.css(d.from);d.animate(d.to,c.duration,c.options.easing,function(){o&&a.effects.restore(d,
...
(function(a){a.effects.slide=function(c){return this.queue(function(){var d=a(this),e=["position","top","bottom","left","right"],g=a.effects.setMode(d,c.options.mode||"show"),i=c.options.direction||"left";a.effects.save(d,e);d.show();a.effects.createWrapper(d).css({overflow:"hidden"});var f="up"==i||"down"==i?"top":"left",i="up"==i||"left"==i?"pos":"neg",b=c.options.distance||("top"==f?d.outerHeight({margin:!0}):d.outerWidth({margin:!0}));"show"==g&&d.css(f,"pos"==i?isNaN(b)?"-"+b:-b:b);var k={};
k[f]=("show"==g?"pos"==i?"+=":"-=":"pos"==i?"-=":"+=")+b;d.animate(k,{queue:!1,duration:c.duration,easing:c.options.easing,complete:function(){"hide"==g&&d.hide();a.effects.restore(d,e);a.effects.removeWrapper(d);c.callback&&c.callback.apply(this,arguments);d.dequeue()}})})}})(jQuery);
...
d),i=g[0]===this.active[0];e.active=e.collapsible&&i?!1:this.headers.index(g);if(!(this.running||!e.collapsible&&i)){var f=this.active,b=g.next(),k=this.active.next(),l={options:e,newHeader:i&&e.collapsible?a([]):g,oldHeader:this.active,newContent:i&&e.collapsible?a([]):b,oldContent:k},o=this.headers.index(this.active[0])>this.headers.index(g[0]);this.active=i?a([]):g;this._toggle(b,k,l,i,o);f.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").children(".ui-icon").removeClass(e.icons.headerSelected).addClass(e.icons.header);
...
animations:{slide:function(c,d){c=a.extend({easing:"swing",duration:300},c,d);if(c.toHide.size())if(c.toShow.size()){var e=c.toShow.css("overflow"),g=0,i={},f={},b,k=c.toShow;b=k[0].style.width;k.width(k.parent().width()-parseFloat(k.css("paddingLeft"))-parseFloat(k.css("paddingRight"))-(parseFloat(k.css("borderLeftWidth"))||0)-(parseFloat(k.css("borderRightWidth"))||0));a.each(["height","paddingTop","paddingBottom"],function(b,d){f[d]="hide";var e=(""+a.css(c.toShow[0],d)).match(/^([\d+-.]+)(.*)$/);
...
this.options.disabled=!!this.element.propAttr("disabled"):this.element.propAttr("disabled",this.options.disabled);this._determineButtonType();this.hasTitle=!!this.buttonElement.attr("title");var b=this,k=this.options,l="checkbox"===this.type||"radio"===this.type,o="ui-state-hover"+(!l?" ui-state-active":"");null===k.label&&(k.label=this.buttonElement.html());this.buttonElement.addClass("ui-button ui-widget ui-state-default ui-corner-all").attr("role","button").bind("mouseenter.button",function(){if(!k.disabled){a(this).addClass("ui-state-hover");
this===c&&a(this).addClass("ui-state-active")}}).bind("mouseleave.button",function(){k.disabled||a(this).removeClass(o)}).bind("click.button",function(a){if(k.disabled){a.preventDefault();a.stopImmediatePropagation()}});this.element.bind("focus.button",function(){b.buttonElement.addClass("ui-state-focus")}).bind("blur.button",function(){b.buttonElement.removeClass("ui-state-focus")});l&&(this.element.bind("change.button",function(){g||b.refresh()}),this.buttonElement.bind("mousedown.button",function(a){if(!k.disabled){g=
false;d=a.pageX;e=a.pageY}}).bind("mouseup.button",function(a){if(!k.disabled&&(d!==a.pageX||e!==a.pageY))g=true}));"checkbox"===this.type?this.buttonElement.bind("click.button",function(){if(k.disabled||g)return false;a(this).toggleClass("ui-state-active");b.buttonElement.attr("aria-pressed",b.element[0].checked)}):"radio"===this.type?this.buttonElement.bind("click.button",function(){if(k.disabled||g)return false;a(this).addClass("ui-state-active");b.buttonElement.attr("aria-pressed","true");var c=
b.element[0];f(c).not(c).map(function(){return a(this).button("widget")[0]}).removeClass("ui-state-active").attr("aria-pressed","false")}):(this.buttonElement.bind("mousedown.button",function(){if(k.disabled)return false;a(this).addClass("ui-state-active");c=this;a(document).one("mouseup",function(){c=null})}).bind("mouseup.button",function(){if(k.disabled)return false;a(this).removeClass("ui-state-active")}).bind("keydown.button",function(b){if(k.disabled)return false;(b.keyCode==a.ui.keyCode.SPACE||
...
a(document).scrollLeft(),q=document.documentElement.clientHeight+a(document).scrollTop();c.left-=this._get(b,"isRTL")?e-g:0;c.left-=d&&c.left==b.input.offset().left?a(document).scrollLeft():0;c.top-=d&&c.top==b.input.offset().top+i?a(document).scrollTop():0;c.left-=Math.min(c.left,c.left+e>s&&s>e?Math.abs(c.left+e-s):0);c.top-=Math.min(c.top,c.top+f>q&&q>f?Math.abs(f+i):0);return c},_findPos:function(b){for(var c=this._get(this._getInst(b),"isRTL");b&&("hidden"==b.type||1!=b.nodeType||a.expr.filters.hidden(b));)b=
...
e="string"!=typeof e?e:(new Date).getFullYear()%100+parseInt(e,10),f=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,g=(d?d.dayNames:null)||this._defaults.dayNames,i=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,s=(d?d.monthNames:null)||this._defaults.monthNames,q=d=-1,p=-1,z=-1,x=!1,y=function(a){(a=O+1<b.length&&b.charAt(O+1)==a)&&O++;return a},D=function(a){var b=y(a),a=c.substring(F).match(RegExp("^\\d{1,"+("@"==a?14:"!"==a?20:"y"==a&&b?4:"o"==a?3:2)+"}"));if(!a)throw"Missing number at position "+
F;F+=a[0].length;return parseInt(a[0],10)},A=function(b,d,e){var b=a.map(y(b)?e:d,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)}),f=-1;a.each(b,function(a,b){var d=b[1];if(c.substr(F,d.length).toLowerCase()==d.toLowerCase())return f=b[0],F+=d.length,!1});if(-1!=f)return f+1;throw"Unknown name at position "+F;},B=function(){if(c.charAt(F)!=b.charAt(O))throw"Unexpected literal at position "+F;F++},F=0,O=0;O<b.length;O++)if(x)"'"==b.charAt(O)&&!y("'")?x=!1:B();else switch(b.charAt(O)){case "d":p=
D("d");break;case "D":A("D",f,g);break;case "o":z=D("o");break;case "m":q=D("m");break;case "M":q=A("M",i,s);break;case "y":d=D("y");break;case "@":var C=new Date(D("@")),d=C.getFullYear(),q=C.getMonth()+1,p=C.getDate();break;case "!":C=new Date((D("!")-this._ticksTo1970)/1E4);d=C.getFullYear();q=C.getMonth()+1;p=C.getDate();break;case "'":y("'")?B():x=!0;break;default:B()}if(F<c.length)throw"Extra/unparsed characters found in date: "+c.substring(F);-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-
(new Date).getFullYear()%100+(d<=e?0:-100));if(-1<z){q=1;p=z;do{e=this._getDaysInMonth(d,q-1);if(p<=e)break;q++;p-=e}while(1)}C=this._daylightSavingAdjust(new Date(d,q-1,p));if(C.getFullYear()!=d||C.getMonth()+1!=q||C.getDate()!=p)throw"Invalid date";return C},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:864E9*(718685+Math.floor(492.5)-
Math.floor(19.7)+Math.floor(4.925)),formatDate:function(a,c,d){if(!c)return"";var e=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,f=(d?d.dayNames:null)||this._defaults.dayNames,g=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,d=(d?d.monthNames:null)||this._defaults.monthNames,i=function(c){(c=x+1<a.length&&a.charAt(x+1)==c)&&x++;return c},s=function(a,b,c){b=""+b;if(i(a))for(;b.length<c;)b="0"+b;return b},q=function(a,b,c,d){return i(a)?d[b]:c[b]},p="",z=!1;if(c)for(var x=0;x<
a.length;x++)if(z)"'"==a.charAt(x)&&!i("'")?z=!1:p+=a.charAt(x);else switch(a.charAt(x)){case "d":p+=s("d",c.getDate(),2);break;case "D":p+=q("D",c.getDay(),e,f);break;case "o":p+=s("o",Math.round(((new Date(c.getFullYear(),c.getMonth(),c.getDate())).getTime()-(new Date(c.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":p+=s("m",c.getMonth()+1,2);break;case "M":p+=q("M",c.getMonth(),g,d);break;case "y":p+=i("y")?c.getFullYear():(10>c.getYear()%100?"0":"")+c.getYear()%100;break;case "@":p+=
c.getTime();break;case "!":p+=1E4*c.getTime()+this._ticksTo1970;break;case "'":i("'")?p+="'":z=!0;break;default:p+=a.charAt(x)}return p},_possibleChars:function(a){for(var c="",d=!1,e=function(c){(c=f+1<a.length&&a.charAt(f+1)==c)&&f++;return c},f=0;f<a.length;f++)if(d)"'"==a.charAt(f)&&!e("'")?d=!1:c+=a.charAt(f);else switch(a.charAt(f)){case "d":case "m":case "y":case "@":c+="0123456789";break;case "D":case "M":return null;case "'":e("'")?c+="'":d=!0;break;default:c+=a.charAt(f)}return c},_get:function(a,
...
new Date,f=e.getFullYear(),g=e.getMonth(),e=e.getDate(),i=/([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g,k=i.exec(c);k;){switch(k[2]||"d"){case "d":case "D":e+=parseInt(k[1],10);break;case "w":case "W":e+=7*parseInt(k[1],10);break;case "m":case "M":g+=parseInt(k[1],10);e=Math.min(e,a.datepicker._getDaysInMonth(f,g));break;case "y":case "Y":f+=parseInt(k[1],10),e=Math.min(e,a.datepicker._getDaysInMonth(f,g))}k=i.exec(c)}return new Date(f,g,e)}(c):"number"==typeof c?isNaN(c)?d:e(c):new Date(c.getTime()))&&"Invalid Date"==
...
g=this._get(b,"navigationAsDateFormat"),r=this._getNumberOfMonths(b),s=this._get(b,"showCurrentAtPos"),q=this._get(b,"stepMonths"),p=1!=r[0]||1!=r[1],z=this._daylightSavingAdjust(!b.currentDay?new Date(9999,9,9):new Date(b.currentYear,b.currentMonth,b.currentDay)),x=this._getMinMaxDate(b,"min"),y=this._getMinMaxDate(b,"max"),s=b.drawMonth-s,D=b.drawYear;0>s&&(s+=12,D--);if(y)for(var A=this._daylightSavingAdjust(new Date(y.getFullYear(),y.getMonth()-r[0]*r[1]+1,y.getDate())),A=x&&A<x?x:A;this._daylightSavingAdjust(new Date(D,
s,1))>A;)s--,0>s&&(s=11,D--);b.drawMonth=s;b.drawYear=D;var A=this._get(b,"prevText"),A=!g?A:this.formatDate(A,this._daylightSavingAdjust(new Date(D,s-q,1)),this._getFormatConfig(b)),A=this._canAdjustMonth(b,-1,D,s)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', -"+q+", 'M');\" title=\""+A+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+A+"</span></a>":f?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+
A+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+A+"</span></a>",B=this._get(b,"nextText"),B=!g?B:this.formatDate(B,this._daylightSavingAdjust(new Date(D,s+q,1)),this._getFormatConfig(b)),f=this._canAdjustMonth(b,1,D,s)?'<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._adjustDate('#"+b.id+"', +"+q+", 'M');\" title=\""+B+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+B+"</span></a>":f?"":'<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+
B+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+B+"</span></a>",q=this._get(b,"currentText"),B=this._get(b,"gotoCurrent")&&b.currentDay?z:c,q=!g?q:this.formatDate(q,B,this._getFormatConfig(b)),g=!b.inline?'<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_'+i+'.datepicker._hideDatepicker();">'+this._get(b,"closeText")+"</button>":"",e=e?'<div class="ui-datepicker-buttonpane ui-widget-content">'+(d?g:"")+(this._isInRange(b,
B)?'<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_'+i+".datepicker._gotoToday('#"+b.id+"');\">"+q+"</button>":"")+(d?"":g)+"</div>":"",g=parseInt(this._get(b,"firstDay"),10),g=isNaN(g)?0:g,q=this._get(b,"showWeek"),B=this._get(b,"dayNames");this._get(b,"dayNamesShort");var F=this._get(b,"dayNamesMin"),O=this._get(b,"monthNames"),C=this._get(b,"monthNamesShort"),w=this._get(b,"beforeShowDay"),R=this._get(b,"showOtherMonths"),
G=this._get(b,"selectOtherMonths");this._get(b,"calculateWeek");for(var h=this._getDefaultDate(b),S="",M=0;M<r[0];M++){var V="";this.maxRows=4;for(var L=0;L<r[1];L++){var t=this._daylightSavingAdjust(new Date(D,s,b.selectedDay)),H=" ui-corner-all",E="";if(p){E+='<div class="ui-datepicker-group';if(1<r[1])switch(L){case 0:E+=" ui-datepicker-group-first";H=" ui-corner-"+(d?"right":"left");break;case r[1]-1:E+=" ui-datepicker-group-last";H=" ui-corner-"+(d?"left":"right");break;default:E+=" ui-datepicker-group-middle",
H=""}E+='">'}for(var E=E+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+H+'">'+(/all|left/.test(H)&&0==M?d?f:A:"")+(/all|right/.test(H)&&0==M?d?A:f:"")+this._generateMonthYearHeader(b,s,D,x,y,0<M||0<L,O,C)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),N=q?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":"",H=0;7>H;H++)var I=(H+g)%7,N=N+("<th"+(5<=(H+g+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+B[I]+'">'+F[I]+"</span></th>");
E+=N+"</tr></thead><tbody>";N=this._getDaysInMonth(D,s);D==b.selectedYear&&s==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,N));H=(this._getFirstDayOfMonth(D,s)-g+7)%7;N=Math.ceil((H+N)/7);this.maxRows=N=p?this.maxRows>N?this.maxRows:N:N;for(var I=this._daylightSavingAdjust(new Date(D,s,1-H)),T=0;T<N;T++){for(var E=E+"<tr>",X=!q?"":'<td class="ui-datepicker-week-col">'+this._get(b,"calculateWeek")(I)+"</td>",H=0;7>H;H++){var Q=w?w.apply(b.input?b.input[0]:null,[I]):[!0,""],j=I.getMonth()!=
s,u=j&&!G||!Q[0]||x&&I<x||y&&I>y,X=X+('<td class="'+(5<=(H+g+6)%7?" ui-datepicker-week-end":"")+(j?" ui-datepicker-other-month":"")+(I.getTime()==t.getTime()&&s==b.selectedMonth&&b._keyEvent||h.getTime()==I.getTime()&&h.getTime()==t.getTime()?" "+this._dayOverClass:"")+(u?" "+this._unselectableClass+" ui-state-disabled":"")+(j&&!R?"":" "+Q[1]+(I.getTime()==z.getTime()?" "+this._currentClass:"")+(I.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!j||R)&&Q[2]?' title="'+Q[2]+'"':"")+(u?"":
' onclick="DP_jQuery_'+i+".datepicker._selectDay('#"+b.id+"',"+I.getMonth()+","+I.getFullYear()+', this);return false;"')+">"+(j&&!R?"&#xa0;":u?'<span class="ui-state-default">'+I.getDate()+"</span>":'<a class="ui-state-default'+(I.getTime()==c.getTime()?" ui-state-highlight":"")+(I.getTime()==z.getTime()?" ui-state-active":"")+(j?" ui-priority-secondary":"")+'" href="#">'+I.getDate()+"</a>")+"</td>");I.setDate(I.getDate()+1);I=this._daylightSavingAdjust(I)}E+=X+"</tr>"}s++;11<s&&(s=0,D++);E+="</tbody></table>"+
(p?"</div>"+(0<r[0]&&L==r[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");V+=E}S+=V}S+=e+(a.browser.msie&&7>parseInt(a.browser.version,10)&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");b._keyEvent=!1;return S},_generateMonthYearHeader:function(a,c,d,e,f,g,r,s){var q=this._get(a,"changeMonth"),p=this._get(a,"changeYear"),z=this._get(a,"showMonthAfterYear"),x='<div class="ui-datepicker-title">',y="";if(g||!q)y+='<span class="ui-datepicker-month">'+
r[c]+"</span>";else{for(var r=e&&e.getFullYear()==d,D=f&&f.getFullYear()==d,y=y+('<select class="ui-datepicker-month" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'M');\" >"),A=0;12>A;A++)if((!r||A>=e.getMonth())&&(!D||A<=f.getMonth()))y+='<option value="'+A+'"'+(A==c?' selected="selected"':"")+">"+s[A]+"</option>";y+="</select>"}z||(x+=y+(g||!q||!p?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",g||!p)x+='<span class="ui-datepicker-year">'+d+"</span>";else{var s=this._get(a,
"yearRange").split(":"),B=(new Date).getFullYear(),r=function(a){a=a.match(/c[+-].*/)?d+parseInt(a.substring(1),10):a.match(/[+-].*/)?B+parseInt(a,10):parseInt(a,10);return isNaN(a)?B:a},c=r(s[0]),s=Math.max(c,r(s[1]||"")),c=e?Math.max(c,e.getFullYear()):c,s=f?Math.min(s,f.getFullYear()):s;for(a.yearshtml+='<select class="ui-datepicker-year" onchange="DP_jQuery_'+i+".datepicker._selectMonthYear('#"+a.id+"', this, 'Y');\" >";c<=s;c++)a.yearshtml+='<option value="'+c+'"'+(c==d?' selected="selected"':
"")+">"+c+"</option>";a.yearshtml+="</select>";x+=a.yearshtml;a.yearshtml=null}x+=this._get(a,"yearSuffix");z&&(x+=(g||!q||!p?"&#xa0;":"")+y);return x+"</div>"},_adjustInstDate:function(a,c,d){var e=a.drawYear+("Y"==d?c:0),f=a.drawMonth+("M"==d?c:0),c=Math.min(a.selectedDay,this._getDaysInMonth(e,f))+("D"==d?c:0),e=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(e,f,c)));a.selectedDay=e.getDate();a.drawMonth=a.selectedMonth=e.getMonth();a.drawYear=a.selectedYear=e.getFullYear();("M"==d||
...
handle:".ui-dialog-titlebar",containment:"document",start:function(e,k){g="auto"===b.height?"auto":a(this).height();a(this).height(a(this).height()).addClass("ui-dialog-dragging");d._trigger("dragStart",e,c(k))},drag:function(a,b){d._trigger("drag",a,c(b))},stop:function(o,n){b.position=[n.position.left-e.scrollLeft(),n.position.top-e.scrollTop()];a(this).removeClass("ui-dialog-dragging").height(g);d._trigger("dragStop",o,c(n));a.ui.dialog.overlay.resize()}})},_makeResizable:function(d){function e(a){return{originalPosition:a.originalPosition,
...
(r.top+=m/2);r.left+=o[0];r.top+=o[1];return this.each(function(){var b=a(this),c=b.outerWidth(),d=b.outerHeight(),g=parseInt(a.curCSS(this,"marginLeft",true))||0,i=parseInt(a.curCSS(this,"marginTop",true))||0,k=c+g+(parseInt(a.curCSS(this,"marginRight",true))||0),D=d+i+(parseInt(a.curCSS(this,"marginBottom",true))||0),A=a.extend({},r),B;if(f.my[0]==="right")A.left=A.left-c;else if(f.my[0]==="center")A.left=A.left-c/2;if(f.my[1]==="bottom")A.top=A.top-d;else if(f.my[1]==="center")A.top=A.top-d/2;
if(!e){A.left=Math.round(A.left);A.top=Math.round(A.top)}B={left:A.left-g,top:A.top-i};a.each(["left","top"],function(b,e){if(a.ui.position[l[b]])a.ui.position[l[b]][e](A,{targetWidth:n,targetHeight:m,elemWidth:c,elemHeight:d,collisionPosition:B,collisionWidth:k,collisionHeight:D,offset:o,my:f.my,at:f.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(A,{using:f.using}))})};a.ui.position={fit:{left:function(c,b){var d=a(window),d=b.collisionPosition.left+b.collisionWidth-d.width()-d.scrollLeft();
...
(i=a("base")[0])&&g===i.href))e=d.hash,d.href=e;k.test(e)?f.panels=f.panels.add(f.element.find(f._sanitizeSelector(e))):e&&"#"!==e?(a.data(d,"href.tabs",e),a.data(d,"load.tabs",e.replace(/#.*$/,"")),e=f._tabId(d),d.href="#"+e,g=f.element.find("#"+e),g.length||(g=a(b.panelTemplate).attr("id",e).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(f.panels[c-1]||f.list),g.data("destroy.tabs",!0)),f.panels=f.panels.add(g)):b.disabled.push(c)});d?(this.element.addClass("ui-tabs ui-widget ui-widget-content ui-corner-all"),
...
(e.insertBefore(this.lis[f]),l.insertBefore(this.panels[f]));k.disabled=a.map(k.disabled,function(a){return a>=f?++a:a});this._tabify();1==this.anchors.length&&(k.selected=0,e.addClass("ui-tabs-selected ui-state-active"),l.removeClass("ui-tabs-hide"),this.element.queue("tabs",function(){b._trigger("show",null,b._ui(b.anchors[0],b.panels[0]))}),this.load(0));this._trigger("add",null,this._ui(this.anchors[f],this.panels[f]));return this},remove:function(c){var c=this._getIndex(c),d=this.options,e=this.lis.eq(c).remove(),
...
(l[k+b]=!0,l[k+a.hotkeys.shiftNums[b]]=!0,"shift+"===k&&(l[a.hotkeys.shiftNums[b]]=!0));d=0;for(b=g.length;d<b;d++)if(l[g[d]])return e.apply(this,arguments)}}}}a.hotkeys={version:"0.8",specialKeys:{8:"backspace",9:"tab",13:"return",16:"shift",17:"ctrl",18:"alt",19:"pause",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"insert",46:"del",96:"0",97:"1",98:"2",99:"3",100:"4",101:"5",102:"6",103:"7",104:"8",105:"9",106:"*",107:"+",
...
(function(a,c,d,e){function g(a,b,c){N[a]=c;I[a]=b;E||(E=a)}function i(b){E!==b&&(E=b,a.ui.editor.eachInstance(function(){this.reinit()}))}function f(a,b){E&&N[E]&&N[E][a]&&(a=N[E][a]);if(!b)return a;for(var c in b)a=a.replace("{{"+c+"}}",b[c]);return a}function b(b){if(T===e){T=!0;if(X=/(iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent))a("html").addClass(b.options.baseClass+"-ios"),X&&a(document).bind("scroll",function(){setInterval(function(){a("body").css("height","+=1").css("height",
"-=1")},0)});a.browser.mozilla&&a("html").addClass(b.options.baseClass+"-ff");if(a.browser.msie&&9>a.browser.version){T=!1;var c=a("<div/>").addClass(b.options.baseClass+"-unsupported").html(b.getTemplate("unsupported")).appendTo("body");k(c);c.find("."+b.options.baseClass+"-unsupported-close").click(function(){c.remove()})}}return T}function k(b){var c=1;b.siblings().each(function(){var b=a(this).css("z-index");!isNaN(b)&&b>c&&(c=b+1)});b.css("z-index",c)}function l(a){return a.clone().wrap("<div/>").parent().html()}
...
return d}function r(b,c){var d=a("<div/>").append(b)[0].childNodes;c.deleteContents();d.length===e||1===d.length?c.insertNode(d[0].cloneNode(!0)):a.each(d,function(a,b){c.insertNodeAtEnd(b.cloneNode(!0))})}function s(b){var b=b||d.getSelection(),c;a(b.getAllRanges()).each(function(b,d){c=3===this.commonAncestorContainer.nodeType?a(d.commonAncestorContainer).parent()[0]:d.commonAncestorContainer});return c}function q(a){return a.startOffset===a.endOffset&&a.startContainer===a.endContainer}function p(a){if(!Q||
a)Q=d.saveSelection()}function z(){Q&&(d.restoreSelection(Q),Q=!1)}function x(){Q&&d.removeMarkers(Q);Q=!1}function y(a,b,c){for(var b=b||d.getSelection(),e,f=0;e=b.getAllRanges()[f++];)a.call(c,e)}function D(a,b){y(function(b){r(a,b)},b,this)}function A(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).focus().contents().each(function(){var a=d.createRange();a.selectNodeContents(this);c.addRange(a)})}function B(b,c){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();
a.selectNode(this);c.addRange(a)}).focus()}function F(b,c,e){c=c||d.getSelection();c.removeAllRanges();a(b).each(function(){var a=d.createRange();a.selectNodeContents(this);a.collapse(e);c.addRange(a)})}function O(a,b){F(a,b,!1)}function C(a,b){F(a,b,!0)}function w(a){a=a||d.getSelection();return a.toHtml()}function R(b){b=b||d.getSelection().getRangeAt(0);return a(3===b.commonAncestorContainer.nodeType?b.commonAncestorContainer.parentNode:b.commonAncestorContainer)}function G(a){var b=new jQuery;
y(function(a){b.push(R(a)[0])},a,this);return b}function h(){var b=d.getSelection();if(null===b.anchorNode)return null;if(b.isBackwards())return 3===b.focusNode.nodeType?a(b.focusNode.parentElement):a(b.focusNode);b.anchorNode||console.trace();return 3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode)}function S(){var b=d.getSelection();return null===b.anchorNode?null:b.isBackwards()?3===b.anchorNode.nodeType?a(b.anchorNode.parentElement):a(b.anchorNode):3===b.focusNode.nodeType?
a(b.focusNode.parentElement):a(b.focusNode)}function M(b,c){var c=c||{},e=d.createCssClassApplier(c.classes||"",{normalize:!0,elementTagName:b,elementProperties:c.attributes||{}});y(function(d){var f=d.cloneContents(),f=m(f);"string"===typeof f&&(f=f.replace(/([ #;&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1"));a(f).is(":empty")?(f=a("<"+b+"/>").addClass(c.classes).attr(c.attributes||{}).append(m(d.cloneContents())),r(f,d)):e.toggleRange(d)},null,this)}function V(a,b,c){y(function(d){d=R(d);d.is(a)?d.attr(b):
M(a,{classes:c,attributes:b})},null,this)}function L(b,c){var c=c||d.getSelection(),e=c.getRangeAt(0),f=G()[0],g=d.createRange();g.setStartBefore(f);g.setEnd(e.startContainer,e.startOffset);var g=g.cloneContents(),h=d.createRange();h.setStart(e.endContainer,e.endOffset);h.setEndAfter(f);e=h.cloneContents();g=l(a(m(g)));g+=l(a(b));g+=l(a(m(e)));a(f).replaceWith(a(g))}function t(a,b,c){var c=c||d.getSelection(),e=h()[0],f=S()[0],g=G()[0],g=n(g,b),e=n(e,b),b=n(f,b);g&&e&&b?D(a):L(a,c)}function H(a,b){allowed=
[];for(var c=0;c<b.length;c++)b[c].match(/[a-z][a-z0-9]{0,}/g)&&allowed.push(b[c]);return a.replace(/<\!--[\s\S]*?--\>|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*\/?>/gi,function(a,b){return-1<allowed.indexOf(b.toLowerCase())?a:""})}var E=null,N={},I={};a(function(){d.initialized||d.init();a.isFunction(d.rangePrototype.insertNodeAtEnd)||(d.rangePrototype.insertNodeAtEnd=function(a){var b=this.cloneRange();b.collapse(!1);b.insertNode(a);b.detach();this.setEndAfter(a)})});a("html").click(function(){a(".ui-editor-selectmenu-visible").removeClass("ui-editor-selectmenu-visible")});
...
"alignRight"],["textBold","textItalic","textUnderline","textStrike"],["textSuper","textSub"],["listUnordered","listOrdered"],["hr","quoteBlock"],["fontSizeInc","fontSizeDec"],["colorPickerBasic"],["clearFormatting"],["link","unlink"],["embed"],["floatLeft","floatNone","floatRight"],["tagMenu"],["i18n"],["raptorize"],["length"],["debugReinit","debugDestroy"]];this.element.attr("id")||this.element.attr("id",this.getUniqueId());this.ready=!1;this.events={};this.ui={};this.plugins={};this.templates=a.extend({},
a.ui.editor.templates);this.path=this.toolbarWrapper=this.toolbar=this.wrapper=null;this.visible=this.enabled=!1;this.uiObjects={};this.hotkeys={};this.options.enableHotkeys&&this.registerHotkey(this.hotkeys);for(var d in this.options.bind)this.bind(d,this.options.bind[d]);this.history=[];this.present=0;this.historyEnabled=!0;b(this)&&(this.cloneDomTools(),this.setOriginalHtml(this.element.is(":input")?this.element.val():this.element.html()),this.options.replace&&(this.replaceOriginal(),this.options.replace=
!1),this.attach(),this.loadPlugins(),this.dirty=!1,this.previousSelection=this.previousContent=null,this.ready=!0,this.fire("ready"),this.options.autoEnable&&a(function(){c.enableEditing();c.showToolbar()}))},attach:function(){this.bind("change",this.historyPush);this.bind("selectionChange",this.updateTagTree);this.bind("show",this.updateTagTree);var b=a.proxy(this.checkChange,this);this.getElement().find("img").bind("click."+this.widgetName,a.proxy(function(a){B(a.target)},this));this.getElement().bind("mouseup."+
...
(this.enabled=!1,this.getElement().attr("contenteditable",!1).removeClass(this.options.baseClass+"-editing"),d.getSelection().removeAllRanges(),this.fire("disabled"))},isEditing:function(){return this.enabled},updateTagTree:function(){if(this.isEditing()){var b=this,c="",d=[],e=0;y(function(f){var f=f.commonAncestorContainer,g;g=3===f.nodeType?a(f).parent():a(f);f=[];for(d.push(f);g[0]&&!b.isRoot(g)&&"body"!==g[0].tagName.toLowerCase();)f.push(g),g=g.parent();f.reverse();c&&(c+=" | ");c+=this.getTemplate("root");
for(g=0;g<f.length;g++)c+=this.getTemplate("tag",{element:f[g][0].tagName.toLowerCase(),data:"["+e+","+g+"]"});e++},null,this);c||(c=this.getTemplate("root"));this.path.html(c).find("a").click(function(){var c=a(this).data("ui-editor-selection");c?(B(d[c[0]][c[1]]),b.updateTagTree()):B(b.getElement())});this.fire("tagTreeUpdated")}},isRoot:function(b){return this.getElement()[0]===a(b)[0]},unify:function(b,c){!1!==c&&b(this);if(this.options.unify)for(var d=a.ui.editor.getInstances(),e=0;e<d.length;e++)d[e]!==
...
return false})});var e=a("<div/>").addClass("ui-editor-selectmenu-text"),j=a("<div/>").addClass("ui-icon ui-icon-triangle-1-s");d.button=a("<div/>").addClass("ui-editor-selectmenu-button ui-editor-selectmenu-button ui-button ui-state-default").attr("title",d.title).append(e).append(j).prependTo(d.selectMenu);d.button.bind("mousedown."+c.widgetName,function(){return false}).bind("click."+c.widgetName,function(){if(!a(this).hasClass("ui-state-disabled")){parseInt(d.menu.css("min-width"),10)<d.button.outerWidth()+
...
c){b.children().each(function(){var b=a.map(this.attributes,function(b){if(-1===a.inArray(b.name,c))return b.name}),d=a(this);a.each(b,function(a,b){d.removeAttr(b)});element.removeAttributes(a(this),c)});return b},elementBringToTop:k,elementOuterHtml:l,elementOuterText:function(a){return a.clone().wrap("<div/>").parent().text()},elementIsBlock:function(a){return"block"===o(a.tagName)},elementDefaultDisplay:o,elementIsValid:n,fragmentToHtml:m,fragmentInsertBefore:function(b,c,d){for(var e=0,f=b.childNodes.length;e<
f;e++){var g=b.childNodes.item(e);(g=3===g.nodeType?g.nodeValue:a(g).html())&&a("<"+d+"/>").html(a.trim(g)).insertBefore(c)}},rangeExpandToParent:function(a){a.setStartBefore(a.startContainer);a.setEndAfter(a.endContainer)},rangeGetCommonAncestor:s,rangeIsEmpty:q,selectionSave:p,selectionRestore:z,selectionDestroy:x,selectionEachRange:y,selectionReplace:D,selectionSelectInner:A,selectionSelectOuter:B,selectionSelectEdge:F,selectionSelectEnd:O,selectionSelectStart:C,selectionGetHtml:w,selectionGetElements:G,
selectionToggleWrapper:M,selectionExists:function(a){var b=!1;y(function(a){q(a)||(b=!0)},a,this);return b},selectionReplaceSplittingSelectedElement:L,selectionReplaceWithinValidTags:t,stringStripTags:H,defaults:{plugins:{},ui:{},bind:{},domTools:{constrainSelection:function(b,c){var b=a(b)[0],c=c||d.getSelection(),e;a(c.getAllRanges()).each(function(d,f){e=3===this.commonAncestorContainer.nodeType?a(f.commonAncestorContainer).parent()[0]:f.commonAncestorContainer;b!==e&&!a.contains(b,e)&&c.removeRange(f)})},
unwrapParentTag:function(b){G().each(function(){a(this).is(b)&&a(this).replaceWith(a(this).html())})},execCommand:function(a,b,c){try{document.execCommand(a,b,c)}catch(d){}},insertTag:function(b,c){y(function(c){c.insertNode(a("<"+b+"/>")[0])},c,this)},insertTagAtEnd:function(b,c){y(function(c){c.insertNodeAtEnd(a("<"+b+"/>")[0])},c,this)},insertElement:function(b,c,d){y(function(d){a(b).each(function(){d.insertNode(!1===c?this:this.cloneNode(!0))})},d,this)},insertElementAtEnd:function(b,c,d){y(function(d){a(b).each(function(){d.insertNodeAtEnd(!1===
c?this:this.cloneNode(!0))})},d,this)},toggleBlockStyle:function(b,c){y(function(d){for(d=a(d.commonAncestorContainer);d.length&&d[0]!==c[0]&&(3===d[0].nodeType||"inline"===d.css("display"));)d=d.parent();d[0]===c[0]&&"inline"!==c.css("display")&&(this.wrapInner(c,"div"),d=c.children().first());this.toggleStyle(d,b)},null,this)},wrapInner:function(b,c){p();a(b).each(function(){var d=a("<"+c+"/>").html(a(this).html());b.html(d)});z()},inverseWrapWithTagClass:function(b,c,e,f){p();var g="domTools"+
Math.ceil(1E7*Math.random());y(function(a){var b=d.createCssClassApplier(f,{elementTagName:e});b.isAppliedToRange(a)?b.toggleSelection():d.createCssClassApplier(c,{elementTagName:g}).toggleSelection()},null,this);a(g).each(function(){a(this).replaceWith(a("<"+b+"/>").addClass(c).html(a(this).html()))});z()},toggleStyle:function(b,c){a.each(c,function(c,d){a(b).css(c)===d?a(b).css(c,""):a(b).css(c,d)})},getStyles:function(a){for(var b={},a=c.getComputedStyle(a[0],null),d=0;d<a.length;d++)b[a.item(d)]=
...
persist:function(a,b,c){a=c?c+"."+a:a;if(localStorage){c=localStorage.uiWidgetEditor?JSON.parse(localStorage.uiWidgetEditor):{};if(b===e)return c[a];c[a]=b;localStorage.uiWidgetEditor=JSON.stringify(c)}return b}});var T,X;a.ui.editor.registerUi({alignLeft:{init:function(a){return a.uiButton({title:f("Left Align"),click:function(){a.toggleBlockStyle({"text-align":"left"},a.getElement())}})}},alignJustify:{init:function(a){return a.uiButton({title:f("Justify"),click:function(){a.toggleBlockStyle({"text-align":"justify"},
a.getElement())}})}},alignCenter:{init:function(a){return a.uiButton({title:f("Center Align"),click:function(){a.toggleBlockStyle({"text-align":"center"},a.getElement())}})}},alignRight:{init:function(a){return a.uiButton({title:f("Right Align"),click:function(){a.toggleBlockStyle({"text-align":"right"},a.getElement())}})}}});a.ui.editor.registerUi({textBold:{hotkeys:{"ctrl+b":{action:function(){this.ui.click()}}},init:function(a,b){return this.editor.uiButton({title:f("Bold"),click:function(){M("strong",
{classes:b.classes||b.cssPrefix+"bold"})}})}},textItalic:{hotkeys:{"ctrl+i":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:f("Italic"),click:function(){M("em",{classes:b.classes||b.cssPrefix+"italic"})}})}},textUnderline:{hotkeys:{"ctrl+u":{action:function(){this.ui.click()}}},init:function(a,b){return a.uiButton({title:f("Underline"),click:function(){M("u",{classes:b.classes||b.cssPrefix+"underline"})}})}},textStrike:{hotkeys:{"ctrl+k":{action:function(){this.ui.click()}}},
init:function(a,b){return a.uiButton({title:f("Strikethrough"),click:function(){M("del",{classes:b.classes||b.cssPrefix+"strike"})}})}},textSub:{init:function(a,b){return a.uiButton({title:f("Sub script"),click:function(){M("sub",{classes:b.classes||b.cssPrefix+"sub"})}})}},textSuper:{init:function(a,b){return a.uiButton({title:f("Super script"),click:function(){M("sup",{classes:b.classes||b.cssPrefix+"super"})}})}}});a.ui.editor.registerUi({quoteBlock:{init:function(a,b){return a.uiButton({title:f("Blockquote"),
icon:"ui-icon-quote",click:function(){M("blockquote",{classes:b.classes||b.cssPrefix+"blockquote"})}})}}});a.ui.editor.registerUi({cancel:{hotkeys:{esc:{action:function(){this.confirm()}}},init:function(a){return a.uiButton({name:"cancel",title:f("Cancel"),icons:{primary:"ui-icon-cancel"},dialog:null,click:function(){this.confirm()}})},confirm:function(){var b=this.editor.getPlugin("cancel"),c=this.editor;c.isDirty()?(this.dialog||(this.dialog=a(c.getTemplate("cancel.dialog"))),this.dialog.dialog({modal:!0,
...
for(c=e.commonAncestorContainer;c&&c.parentNode!=b.getElement().get(0);)c=c.parentNode;if(c){e.setEndAfter(c);var g=e.extractContents();e.collapseAfter(c);e.insertNode(g);e.collapseAfter(c)}e.insertNode(document.createTextNode(f))}b.checkChange()}})}}});a.ui.editor.registerPlugin("clickButtonToEdit",{hovering:!1,options:{button:{text:!0,icons:{primary:"ui-icon-pencil"}}},init:function(b,d){var e=this,f=!1,d=a.extend(!0,{},{position:{at:"center center",of:b.getElement(),my:"center center",using:function(b){a(this).css({position:"absolute",
top:b.top,left:b.left})}}},d);this.selection=function(){var a;document.selection?a=document.selection.createRange():document.getSelection().rangeCount&&(a=document.getSelection().getRangeAt(0));return a};this.show=function(){b.isEditing()||(b.getElement().addClass(d.baseClass+"-highlight"),b.getElement().addClass(d.baseClass+"-hover"),f.button(d.button),f.position(d.position),f.addClass(d.baseClass+"-visible"))};this.hide=function(c){if(!c||!(c.relatedTarget===f.get(0)||f.get(0)===a(c.relatedTarget).parent().get(0)))b.getElement().removeClass(d.baseClass+
"-highlight"),b.getElement().removeClass(d.baseClass+"-hover"),f.removeClass(d.baseClass+"-visible")};this.edit=function(){e.hide();b.isEditing()||b.enableEditing();b.isVisible()||b.showToolbar(e.selection())};this.buttonOut=function(){f.hasClass(d.baseClass+"-visible")||(c.clearTimeout(e.timeoutId),e.timeoutId=c.setTimeout(e.hide,350))};b.bind("ready, hide, cancel",function(){f=a(b.getTemplate("clickbuttontoedit.edit-button",d)).appendTo("body").removeClass(d.baseClass+"-visible");f.position(d.position);
f.bind("click."+b.widgetName,e.edit);f.bind("mouseleave."+b.widgetName,e.buttonOut);b.getElement().bind("mouseenter."+b.widgetName,e.show);b.getElement().bind("mouseleave."+b.widgetName,e.hide)});b.bind("show",function(){f.button("destroy").remove();b.getElement().unbind("mouseenter."+b.widgetName,e.show);b.getElement().unbind("mouseleave."+b.widgetName,e.hide)})}});a.ui.editor.registerUi("colorPickerBasic",{init:function(b){b.bind("selectionChange",this.change,this);b.bind("show",this.change,this);
var c=this;return b.uiSelectMenu({name:"colorPickerBasic",title:f("Change the color of the selected text."),select:a(b.getTemplate("color-picker-basic.menu")),change:function(b){"automatic"===b?G().parents("."+c.options.cssPrefix+"color").andSelf().each(function(){var b=a(this),c=a(this).attr("class").match(/(cms-(.*?))( |$)/ig);a.each(c,function(c,d){d=a.trim(d);b.removeClass(d)})}):M("span",{classes:c.options.classes||c.options.cssPrefix+"color "+c.options.cssPrefix+b})}})},change:function(){this.ui.val("automatic");
var b=G()[0];if(b&&(b=a(b).closest("."+this.options.cssPrefix+"color"))){var c=b.attr("class");c&&(c=b.attr("class").replace(RegExp(this.options.cssPrefix+"color","g"),""),b=c.match(/cms-(.*?)( |$)/i)[1],this.ui.select.find(".ui-editor-selectmenu-option[value="+b+"]").length&&this.ui.val(b))}}});a.ui.editor.registerPlugin("dock",{enabled:!1,docked:!1,topSpacer:null,bottomSpacer:null,options:{docked:!1,dockToElement:!1,dockUnder:!1,persist:!0,persistID:null},init:function(){this.bind("show",this.show);
...
a(this.editor.getTemplate("embed.dialog"));this.dialog.dialog({modal:!1,width:600,height:400,resizable:!0,title:f("Paste Embed Code"),autoOpen:!0,dialogClass:b.options.baseClass+" "+b.options.dialogClass,buttons:[{text:f("Embed Object"),click:function(){z();D(a(this).find("textarea").val());a(this).dialog("close")}},{text:f("Close"),click:function(){b.hide()}}],open:function(){var b=a(this).parent().find(".ui-dialog-buttonpane");b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});
...
a.ui.editor.registerPlugin("emptyElement",{options:{tag:"<p/>"},init:function(){this.bind("change",this.change)},change:function(){var b=this;this.textNodes(this.editor.getElement()).each(function(){a(this).wrap(a(b.options.tag));O(this)});this.editor.checkChange()},textNodes:function(b){return a(b).contents().filter(function(){return 3==this.nodeType&&a.trim(this.nodeValue).length})}});a(function(){a.ui.editor.registerUi({insertFile:{fileManager:null,imageTypes:["jpg","jpeg","png","gif"],init:function(b,
c){return b.uiButton({title:"Insert image or uploaded file",icon:"ui-icon-image",click:function(){var b=this;p();null===this.fileManager&&(this.fileManager=a.ui.filemanager.create({enablePlugins:!1,plugins:{datatables:!XMod.FileManager.Permissions.insert?!1:{ajaxSource:"/filemanager/admin/datatables",insertionCallback:function(d){z();if(!d.length)return true;var e=function(){b.editor.fire("change");return true};if(d.length===1){var f=d[0];if(b.isImage(f)){D(b.createImage(f,c.cssPrefix+f.type));return e()}if(b.editor.selectionExists()){V("a",
{href:f.url,className:b.options.cssPrefix+"file "+b.options.cssPrefix+f.type});return e()}D(b.createAnchor(f,b.options.cssPrefix+"file "+b.options.cssPrefix+f.type));return e()}for(var j=[],g=0;g<d.length;g++){f=d[g];b.isImage(f)?j.push(a("<div/>").html(b.createImage(f,c.cssPrefix+f.type)).html()):j.push(a("<div/>").html(b.createAnchor(f,b.options.cssPrefix+"file "+b.options.cssPrefix+f.type)).html())}D(j.join(", "));return e()}},plupload:!XMod.FileManager.Permissions.upload?!1:{url:"/filemanager/admin/plupload"}}}));
a(this.fileManager).filemanager("show")}})},isImage:function(b){return-1!==a.inArray(b.type.toLowerCase(),this.imageTypes)?!0:!1},createImage:function(b,c){return a("<img/>").attr({src:b.url,title:b.name,"class":c})},createAnchor:function(b,c){return a("<a/>").attr({href:b.url,title:b.name,"class":c}).html(b.name)}}})});a.ui.editor.registerUi({floatLeft:{init:function(b){return b.uiButton({title:f("Float Image Left"),click:function(){y(function(b){a(b.commonAncestorContainer).find("img").css("float",
"left")})}})}},floatRight:{init:function(b){return b.uiButton({title:f("Float Image Right"),click:function(){y(function(b){a(b.commonAncestorContainer).find("img").css("float","right")})}})}},floatNone:{init:function(b){return b.uiButton({title:f("Remove Image Float"),click:function(){y(function(b){a(b.commonAncestorContainer).find("img").css("float","none")})}})}}});a.ui.editor.registerUi({fontSizeInc:{init:function(a,b){return a.uiButton({title:f("Increase Font Size"),click:function(){a.inverseWrapWithTagClass("big",
...
init:function(a){a.bind("change",this.change,this);return this.ui=a.uiButton({title:f("Step Forward"),click:function(){a.historyForward()}})},change:function(){this.editor.present===this.editor.history.length-1?this.ui.disable():this.ui.enable()}}});a.ui.editor.registerUi({hr:{init:function(a){return a.uiButton({title:f("Insert Horizontal Rule"),click:function(){D("<hr/>")}})}}});a.ui.editor.registerUi({i18n:{init:function(b){var c=this,d=this.persist("locale");d&&i(d);var d=a('<select autocomplete="off" name="i18n"/>'),
e;for(e in N){var g=a('<option value="'+e+'" class="'+e+'"/>');g.html(I[e]);E===e&&g.attr("selected","selected");d.append(g)}return b.uiSelectMenu({title:f("Change Language"),select:d,change:function(a){i(c.persist("locale",a))}})}}});g("en","English",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"Apply Source","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",
...
"{{words}} word":"{{words}} woord","{{words}} words":"{{words}} woorden"});g("zh-CN","\u7b80\u4f53\u4e2d\u6587",{"A preview of your embedded object is displayed below.":"A preview of your embedded object is displayed below.","Added link: {{link}}":"Added link: {{link}}","All changes will be lost!":"All changes will be lost!","Apply Source":"\u5e94\u7528\u6e90\u4ee3\u7801","Are you sure you want to stop editing?":"Are you sure you want to stop editing?",Blockquote:"\u5927\u6bb5\u5f15\u7528",Bold:"\u7c97\u4f53",
...
c.push(a(this))});c.length&&this.resizeOversizedImages(c,b.width())},resizeOversizedImages:function(b,c){for(var d=a("<a>",{href:"",target:"_blank"}),e=0;e<b.length;e++){var f=b[e],g=f.outerWidth();f.outerHeight();var h=Math.min(c/g),g=Math.round(Math.abs(h*(g-(f.outerWidth()-f.width()))));f.addClass(this.options.resizingClass);d=d.html(f.attr("title")||f.attr("src").substr(f.attr("src").lastIndexOf("/")+1)).attr("href",f.attr("src"));a(f).css({width:g});var i=this;this.showOversizeWarning(l(a(d)),
{hide:function(){f.removeClass(i.options.resizingClass)}})}},cancel:function(){this.removeClasses();this.removeToolsButtons();this.unbind()},save:function(){this.removeClasses(this.options.resizingClass);this.removeToolsButtons();this.unbind()},showOversizeWarning:function(a,b){this.editor.showInfo(f("The image '{{image}}' is too wide for the element being edited.<br/>It will be resized to fit.",{image:a}),b)},removeClasses:function(b){b||(b=[this.options.resizingClass,this.options.manuallyResizingClass]);
a.isArray(b)||(b=[b]);for(var c=0;c<b.length;c++)this.editor.getElement().find("img."+b[c]).removeClass(b[c])},manuallyResizeImage:function(b){this.removeToolsButtons();var c=this.editor.getElement().find("img."+this.options.manuallyResizingClass),d=a(c).innerWidth(),e=a(c).innerHeight(),g="#"+this.options.baseClass+"-width",h="#"+this.options.baseClass+"-height",i=this,k=function(b){b=Math.round(b||a(g).val())+"px";a(c).css({width:b})},l=a(this.editor.getTemplate("imageresize.manually-resize-image",
{width:d,height:e,baseClass:this.options.baseClass}));l.dialog({modal:!0,resizable:!1,title:f("Modify Image Size"),autoOpen:!0,buttons:[{text:f("Resize Image"),click:function(){k(a(this).find(g).val());a(this).dialog("close")}},{text:f("Cancel"),click:function(){k(d);a(this).dialog("close")}}],close:function(){i.editor.checkChange();a(l).remove()},open:function(){var b=a(this).find(g),c=a(this).find(h);b.keyup(function(){c.val(Math.round(Math.abs(e/d*a(this).val())));k()});c.keyup(function(){b.val(Math.round(Math.abs(d/
e*a(this).val())));k()})}});b.preventDefault();return!1},displayToolsButtonRelativeToImage:function(b){var c=a("<button>"+f("Click to edit the image")+"</button>").appendTo("body").addClass(this.options.resizeButtonClass+" "+this.options.supplementaryClass).button({text:!1,icons:{primary:"ui-icon-tools"}});c.css({position:"absolute",left:a(b).position().left+a(b).innerWidth()-a(c).outerWidth()-10+"px",top:a(b).position().top+10+"px"}).attr("contenteditable",!1).click(a.proxy(this.manuallyResizeImage,
...
options:{length:150},init:function(b){b.bind("show",a.proxy(this.updateCount,this));b.bind("change",a.proxy(this.updateCount,this));return this.ui=this.editor.uiButton({title:f("Remaining characters before the recommended character limit is reached"),label:f("Initializing"),text:!0,icon:"ui-icon-dashboard",click:function(){this.showStatistics()}})},updateCount:function(){var b=this.options.length-a("<div/>").html(this.editor.getCleanHtml()).text().length,c=this.ui.button,d=null,d=0<=b?f("{{charactersRemaining}} characters remaining",
{charactersRemaining:b}):f("{{charactersRemaining}} characters over limit",{charactersRemaining:-1*b});c.button("option","label",d);c.button("option","text",!0);0>b?c.addClass("ui-state-error"):0<=b&&15>=b?c.addClass("ui-state-highlight").removeClass("ui-state-error"):c.removeClass("ui-state-highlight ui-state-error")},showStatistics:function(){this.processTemplate().dialog({modal:!0,resizable:!1,title:f("Content Statistics"),dialogClass:this.editor.options.dialogClass+" "+this.editor.options.baseClass,
show:this.editor.options.dialogShowAnimation,hide:this.editor.options.dialogHideAnimation,buttons:[{text:f("OK"),click:function(){a(this).dialog("close")}}],open:function(){a(this).parent().find(".ui-dialog-buttonpane").find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}})},close:function(){a(this).dialog("destroy").remove()}})},processTemplate:function(){var b=a("<div/>").html(this.editor.getCleanHtml()).text(),c=null,d=this.options.length-b.length,c=0>d?f("Content contains more than {{limit}} characters and may be truncated",
{limit:this.options.length}):f("Content will not be truncated"),e=null,e=b.split(" ").length,e=1==e?f("{{words}} word",{words:e}):f("{{words}} words",{words:e}),g=null,g=b.split(". ").length,g=f("{{sentences}} sentences",{sentences:g}),h=null,h=0<=d?f("{{characters}} characters, {{charactersRemaining}} remaining",{characters:b.length,charactersRemaining:d}):f("{{characters}} characters, {{charactersRemaining}} over the recommended limit",{characters:b.length,charactersRemaining:-1*d});return a(this.editor.getTemplate("length.dialog",
{characters:h,words:e,sentences:g,truncation:c}))}}});a.ui.editor.registerPlugin("link",{visible:null,dialog:null,types:{},defaultLinkTypes:[{type:"external",title:f("Page on this or another website"),focusSelector:'input[name="location"]',init:function(){this.content=this.plugin.editor.getTemplate("link.external",this.options);return this},show:function(a,b){var c=this;a.find('input[name="location"]').bind("keyup",function(){c.validate(a)});b&&(a.find('input[name="location"]').val(this.plugin.selectedElement.attr("href")).trigger("keyup"),
...
"checked"));return this},attributes:function(a){var b={href:a.find('input[name="location"]').val()};a.find('input[name="blank"]').is(":checked")&&(b.target="_blank");this.options.regexLink.test(b.href)||this.plugin.editor.showWarning(f("The url for the file you inserted doesn't look well formed"));return b},validate:function(b){var c="."+this.options.baseClass+"-error-message-file-url",d=!0;this.options.regexLink.test(b.find('input[name="location"]').val())?b.find(c).has(":visible").hide():(b.find(c).size()||
...
d.options.baseClass+"-content")))&&c.find("button:eq(0)").trigger("click"))})},close:function(){z();d.visible=!1;e.find("."+c.baseClass+"-content").hide();a(this).dialog("destroy")}}).dialog("open")}},apply:function(b){var c=this.types[this.dialog.find('input[type="radio"]:checked').val()],d=c.attributes(this.dialog.find("."+this.options.baseClass+"-content"),b);if(!d)return!0;z();var e=l(a("<a>"+(d.title?d.title:d.href)+"</a>").attr(a.extend({},d,{target:"_blank"})));b?(this.selectedElement[0].className=
this.selectedElement[0].className.replace(RegExp(this.options.baseClass+"-[a-zA-Z]+","g"),""),this.selectedElement.addClass(c.classes).attr(d),this.editor.showConfirm(f("Updated link: {{link}}",{link:e}))):(V("a",a.extend(d,{id:this.editor.getUniqueId()}),c.classes),this.editor.showConfirm(f("Added link: {{link}}",{link:e})),this.selectedElement=a("#"+d.id).removeAttr("id"));this.selectedElement.data(this.options.baseClass+"-href",d.href);B(this.selectedElement);p();return!0},typeChange:function(b,
...
this.change,this);return a.uiButton({title:f("Insert Link"),click:function(){a.getPlugin("link").show()}})},change:function(){G().length?this.ui.enable():this.ui.disable()}},unlink:{hotkeys:{"ctrl+shift+l":{action:function(){this.ui.click()},restoreSelection:!1}},init:function(a){a.bind("selectionChange",this.change,this);a.bind("show",this.change,this);return a.uiButton({title:f("Remove Link"),click:function(){a.getPlugin("link").remove()}})},change:function(){G().is("a")?this.ui.enable():this.ui.disable()}}});
...
this.editor.fire("change")},unwrapList:function(){p();var b=[],c=[],d=h(),e=S();b.push(a(d).html());c.push(d);if(a(d)[0]!==a(e)[0]){var f=d;do f=a(f).next(),b.push(a(f).html()),c.push(f);while(a(f)[0]!==a(e)[0])}f=0===a(d).prev().length;e=0===a(e).next().length;d=a(d).parent();for(listElementsIndex=0;listElementsIndex<c.length;listElementsIndex++)a(c[listElementsIndex]).remove();for(c=0;c<b.length;c++)d.parent().is("li")||(b[c]="<p>"+b[c]+"</p>");f&&e?(d.replaceWith(b.join("")),z(),b=G()[0],B(b)):
(f?a(d).before(b.join("")):e?a(d).after(b.join("")):L(b.join("")),z(),this.editor.checkChange())},wrapList:function(b){this.editor.constrainSelection(this.editor.getElement());""===a.trim(w())&&A(G());var c=a("<div>").html(w()),d=[],e=this;a(c).contents().each(function(){var b;b="block"===o(this.tagName)?H(a(this).html(),e.validChildren):H(l(a(this)),e.validChildren);b=a("<li>"+b+"</li>");""!==a.trim(b.text())&&d.push(l(b))});c=this.options.baseClass+"-selection";b="<"+b+' class="'+c+'">'+d.join("")+
"</"+b+">";z();var f=a(G()[0]).parent(),g=this.editor.getElement()[0];f===g||G()[0]===g?D(b):t(b,this.validParents);c=a(this.editor.getElement().find("."+c).removeClass(c));A(c.find("li:first")[0]);this.editor.checkChange()},toggleButtonState:function(b,c){var d=function(a){c.button.toggleClass("ui-state-highlight",a).toggleClass("ui-state-default",!a)},e=h();if(null===e||!e.length)e=this.editor.getElement();var f=S();if(null===f||!f.length)f=this.editor.getElement();e=e[0];f=f[0];if(a(e).is(b)&&
a(f).is(b)&&e===f)return d(!0);var g=a(e).parentsUntil(i,b).first()&&a(f).parentsUntil(i,b).first(),i="#"+this.editor.getElement().attr("id"),k=a(e).is(b+" > li")||a(e).parentsUntil(i,b+" > li").length,l=a(f).is(b+" > li")||a(f).parentsUntil(i,b+" > li").length;if(k&&l&&g){g=a(s());g.is(b)||(g=a(g).parentsUntil(i,b).first());i=g.find("ul, ol");if(!i.length)return d(!0);for(g=0;g<i.length;g++)if(a.contains(i[g],e)&&a.contains(i[g],f))return d(!1);return d(!0)}return d(!1)}});a.ui.editor.registerUi({listUnordered:{init:function(a){var b=
a.uiButton({title:f("Unordered List"),click:function(){a.getPlugin("list").toggleList("ul")}});a.bind("selectionChange",function(){a.getPlugin("list").toggleButtonState("ul",b)});return b}},listOrdered:{init:function(a){var b=a.uiButton({title:f("Ordered List"),click:function(){a.getPlugin("list").toggleList("ol")}});a.bind("selectionChange",function(){a.getPlugin("list").toggleButtonState("ol",b)});return b}}});a.ui.editor.registerUi({logo:{ui:null,init:function(){return this.ui=this.editor.uiButton({title:f("Learn More About the Raptor WYSIWYG Editor"),
click:function(){c.open("http://www.jquery-raptor.com/about/editors/","_blank")},ready:function(){var b=function(c){var d=typeof c;if("object"!=d||null===c)return"string"==d&&(c='"'+c+'"'),""+c;var e=[],f=c&&a.isArray(c);a.each(c,function(a,c){d=typeof c;"string"==d?c='"'+c+'"':"object"==d&null!==c&&(c=b(c));e.push((f?"":'"'+a+'":')+(""+c))});return(f?"[":"{")+(""+e)+(f?"]":"}")},c={enableUi:this.options.enableUi,enablePlugins:this.options.enablePlugins,disabledPlugins:b(this.options.disabledPlugins),
ui:b(this.options.ui),t:(new Date).getTime()},d=[],e;for(e in c)d.push(e+"="+encodeURIComponent(c[e]));this.ui.button.find(".ui-button-icon-primary").css({"background-image":"url(http://www.jquery-raptor.com/logo/0.0.17?"+d.join("&")+")"})}})}}});a.ui.editor.registerPlugin("normaliseLineBreaks",{options:{enter:"<p><br/></p>",enterValidTags:"address,blockquote,body,button,center,dd,div,fieldset,form,iframe,li,noframes,noscript,object,td,th".split(","),shiftEnter:"<br/>",shiftEnterValidTags:"a,abbr,acronym,address,applet,b,bdo,big,blockquote,body,button,caption,center,cite,code,dd,del,dfn,div,dt,em,fieldset,font,form,h1,h2,h3,h4,h5,h6,i,iframe,ins,kbd,label,legend,li,noframes,noscript,object,p,pres,q,s,samp,small,span,strike,strong,sub,sup,td,th,tt,u,var".split(",")},
hotkeys:{"return":{action:function(){x();var b=""===d.getSelection().toHtml(),c;c=d.getSelection();var e=c.isBackwards()?c.focusNode:c.anchorNode;(c.isBackwards()?c.focusOffset:0!==c.anchorOffset)?c=!1:(c=e.previousSibling,c=!c||""===a(c).html()?!0:!1);var f;e=d.getSelection();f=e.isBackwards()?e.anchorNode:e.focusNode;(e.isBackwards()?e.focusOffset:e.anchorOffset)!==f.textContent.length?f=!1:(e=f.nextSibling,f=!e||""===a(e).html()?!0:!1);var g=this.options.baseClass+"-enter-break",e=a(this.options.enter).attr("id",
g);t(e,this.options.enterValidTags);e=a("#"+g).removeAttr("id");b?c?C(e.next()):f?C(e):(C(e.next()),(b=e.prev())&&""!==a.trim(b.html())&&l(b)!==this.options.enter&&e.remove()):(C(e.next()),e.remove())},restoreSelection:!1},"return+shift":{action:function(){x();var b=this.options.baseClass+"-enter-break",c=a(breakHtml).attr("id",b).appendTo("body");this.options.shiftEnterValidTags?t(this.options.shiftEnter,this.options.shiftEnterValidTags):D(c);b=a("#"+b).removeAttr("id").next();C(b)},restoreSelection:!1}}});
a.ui.editor.registerPlugin("paste",{options:{allowedTags:"h1,h2,h3,h4,h5,h6,div,ul,ol,li,blockquote,p,a,span,hr,br".split(","),allowedAttributes:["href","title"],allowedEmptyTags:["hr","br"]},init:function(b,d){var e=!1,g=!1,h=this;b.getElement().bind("paste."+b.widgetName,a.proxy(function(){if(e)return!1;e=!0;p();a(".uiWidgetEditorPasteBin").length&&a(".uiWidgetEditorPasteBin").remove();a('<div class="uiWidgetEditorPasteBin" contenteditable="true" style="width: 1px; height: 1px; overflow: hidden; position: fixed; top: -1px;" />').appendTo("body");
a(".uiWidgetEditorPasteBin").focus();c.setTimeout(function(){var c=a(".uiWidgetEditorPasteBin").html(),c=h.filterAttributes(c),c=h.filterChars(c),c=h.stripEmpty(c),c=h.stripAttributes(c),c=H(c,h.options.allowedTags),c={plain:a("<div/>").html(a(".uiWidgetEditorPasteBin").html()).text(),markup:c,html:a(".uiWidgetEditorPasteBin").html()};g=a(b.getTemplate("paste.dialog",c));a(g).dialog({modal:!0,width:650,height:500,resizable:!0,title:"Paste",position:"center",show:d.dialogShowAnimation,hide:d.dialogHideAnimation,
dialogClass:d.baseClass+" "+d.dialogClass,buttons:[{text:f("Insert"),click:function(){var b=null,b=a(this).find(".ui-editor-paste-area:visible"),b=b.hasClass("ui-editor-paste-plain")||b.hasClass("ui-editor-paste-source")?b.val():b.html(),b=h.filterAttributes(b),b=h.filterChars(b);z();D(b);e=!1;a(this).dialog("close")}},{text:f("Cancel"),click:function(){z();e=!1;a(this).dialog("close")}}],open:function(){var b=a(this).find(".ui-editor-paste-panel-tabs");b.find("ul.ui-tabs-nav li").click(function(){b.find("ul.ui-tabs-nav li").removeClass("ui-state-active").removeClass("ui-tabs-selected");
...
b.ajax(c)}});this.dirty=a;0===a&&(this.message.hide(),this.editor.showInfo(f("No changes detected to save...")))},done:function(a){this.options.multiple?this.saved++:this.saved=this.dirty;this.options.showResponse&&this.editor.showConfirm(a,{delay:1E3,hide:function(){this.editor.unify(function(a){a.disableEditing();a.hideToolbar()})}})},fail:function(a){this.options.multiple?this.failed++:this.failed=this.dirty;this.options.showResponse&&this.editor.showError(a.responseText)},always:function(){this.dirty===
...
b.find("button:eq(0)").button({icons:{primary:"ui-icon-circle-check"}});b.find("button:eq(1)").button({icons:{primary:"ui-icon-circle-close"}})},close:function(){a(this).dialog("destroy").remove();a(d).button("option","disabled",!1);b.editor.checkChange()}})}}});var Q=!1})(jQuery,window,rangy);
